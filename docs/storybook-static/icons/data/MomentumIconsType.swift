...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .receiveVoiceBold: return "\u{fa2a}"
        case .receiveVoiceFilled: return "\u{fa2b}"
        case .receiveVoiceLight: return "\u{fa2c}"
        case .receiveVoiceRegular: return "\u{fa2d}"
        case .recentsBold: return "\u{fa2e}"
        case .recentsFilled: return "\u{fa2f}"
        case .recentsLight: return "\u{fa30}"
        case .recentsPresenceBadgeFilled: return "\u{fa31}"
        case .recentsPresenceBold: return "\u{fa32}"
        case .recentsPresenceFilled: return "\u{fa33}"
        case .recentsPresenceLight: return "\u{fa34}"
        case .recentsPresenceRegular: return "\u{fa35}"
        case .recentsRegular: return "\u{fa36}"
        case .recordActiveBadgeFilled: return "\u{fa37}"
        case .recordActiveBold: return "\u{fa38}"
        case .recordActiveFilled: return "\u{fa39}"
        case .recordActiveLight: return "\u{fa3a}"
        case .recordActiveRegular: return "\u{fa3b}"
        case .recordBold: return "\u{fa3c}"
        case .recordFilled: return "\u{fa3d}"
        case .recordLight: return "\u{fa3e}"
        case .recordPausedBadgeFilled: return "\u{fa3f}"
        case .recordPausedBold: return "\u{fa40}"
        case .recordPausedFilled: return "\u{fa41}"
        case .recordPausedLight: return "\u{fa42}"
        case .recordPausedRegular: return "\u{fa43}"
        case .recordRegular: return "\u{fa44}"
        case .recurringBold: return "\u{fa45}"
        case .recurringLight: return "\u{fa46}"
        case .recurringOffBold: return "\u{fa47}"
        case .recurringOffLight: return "\u{fa48}"
        case .recurringOffRegular: return "\u{fa49}"
        case .recurringRegular: return "\u{fa4a}"
        case .redoBold: return "\u{fa4b}"
        case .redoLight: return "\u{fa4c}"
        case .redoRegular: return "\u{fa4d}"
        case .refreshBold: return "\u{fa4e}"
        case .refreshLight: return "\u{fa4f}"
        case .refreshRegular: return "\u{fa50}"
        case .remoteDesktopControlBold: return "\u{fa51}"
        case .remoteDesktopControlFilled: return "\u{fa52}"
        case .remoteDesktopControlLight: return "\u{fa53}"
        case .remoteDesktopControlRegular: return "\u{fa54}"
        case .removeBold: return "\u{fa55}"
        case .removeFilled: return "\u{fa56}"
        case .removeLight: return "\u{fa57}"
        case .removeRegular: return "\u{fa58}"
        case .replyBold: return "\u{fa59}"
        case .replyFilled: return "\u{fa5a}"
        case .replyLight: return "\u{fa5b}"
        case .replyListBold: return "\u{fa5c}"
        case .replyListFilled: return "\u{fa5d}"
        case .replyListLight: return "\u{fa5e}"
        case .replyListRegular: return "\u{fa5f}"
        case .replyPrivatelyBold: return "\u{fa60}"
        case .replyPrivatelyLight: return "\u{fa61}"
        case .replyPrivatelyRegular: return "\u{fa62}"
        case .replyRegular: return "\u{fa63}"
        case .resetBold: return "\u{fa64}"
        case .resetLight: return "\u{fa65}"
        case .resetRegular: return "\u{fa66}"
        case .resizeCornerBold: return "\u{fa67}"
        case .resizeCornerLight: return "\u{fa68}"
        case .resizeCornerRegular: return "\u{fa69}"
        case .responsiveMobileBold: return "\u{fa6a}"
        case .responsiveMobileLight: return "\u{fa6b}"
        case .responsiveMobileRegular: return "\u{fa6c}"
        case .restartBold: return "\u{fa6d}"
        case .restartLight: return "\u{fa6e}"
        case .restartRegular: return "\u{fa6f}"
        case .resumeInteractionBold: return "\u{fa70}"
        case .resumeInteractionFilled: return "\u{fa71}"
        case .resumeInteractionLight: return "\u{fa72}"
        case .resumeInteractionRegular: return "\u{fa73}"
        case .retrieveCallBold: return "\u{fa74}"
        case .retrieveCallFilled: return "\u{fa75}"
        case .retrieveCallLight: return "\u{fa76}"
        case .retrieveCallRegular: return "\u{fa77}"
        case .returnBold: return "\u{fa78}"
        case .returnLight: return "\u{fa79}"
        case .returnRegular: return "\u{fa7a}"
        case .rewindTenSecBold: return "\u{fa7b}"
        case .rewindTenSecLight: return "\u{fa7c}"
        case .rewindTenSecRegular: return "\u{fa7d}"
        case .ringtoneBold: return "\u{fa7e}"
        case .ringtoneLight: return "\u{fa7f}"
        case .ringtoneRegular: return "\u{fa80}"
        case .roomCalendarBold: return "\u{fa81}"
        case .roomCalendarLight: return "\u{fa82}"
        case .roomCalendarRegular: return "\u{fa83}"
        case .roomLightsBold: return "\u{fa84}"
        case .roomLightsFilled: return "\u{fa85}"
        case .roomLightsLight: return "\u{fa86}"
        case .roomLightsRegular: return "\u{fa87}"
        case .rotateContentBold: return "\u{fa88}"
        case .rotateContentFilled: return "\u{fa89}"
        case .rotateContentLight: return "\u{fa8a}"
        case .rotateContentRegular: return "\u{fa8b}"
        case .rssBold: return "\u{fa8c}"
        case .rssFilled: return "\u{fa8d}"
        case .rssLight: return "\u{fa8e}"
        case .rssRegular: return "\u{fa8f}"
        case .ruleBasedBold: return "\u{fa90}"
        case .ruleBasedFilled: return "\u{fa91}"
        case .ruleBasedLight: return "\u{fa92}"
        case .ruleBasedRegular: return "\u{fa93}"
        case .rulerBold: return "\u{fa94}"
        case .rulerFilled: return "\u{fa95}"
        case .rulerLight: return "\u{fa96}"
        case .rulerRegular: return "\u{fa97}"
        case .runningApplicationBold: return "\u{fa98}"
        case .runningApplicationFilled: return "\u{fa99}"
        case .runningApplicationLight: return "\u{fa9a}"
        case .runningApplicationRegular: return "\u{fa9b}"
        case .saveBold: return "\u{fa9c}"
        case .saveLight: return "\u{fa9d}"
        case .saveRegular: return "\u{fa9e}"
        case .saveTranscriptBold: return "\u{fa9f}"
        case .saveTranscriptFilled: return "\u{faa0}"
        case .saveTranscriptLight: return "\u{faa1}"
        case .saveTranscriptRegular: return "\u{faa2}"
        case .scanBold: return "\u{faa3}"
        case .scanLight: return "\u{faa4}"
        case .scanRegular: return "\u{faa5}"
        case .scheduleAiBold: return "\u{faa6}"
        case .scheduleAiLight: return "\u{faa7}"
        case .scheduleAiRegular: return "\u{faa8}"
        case .scheduleSendBold: return "\u{faa9}"
        case .scheduleSendFilled: return "\u{faaa}"
        case .scheduleSendLight: return "\u{faab}"
        case .scheduleSendRegular: return "\u{faac}"
        case .scheduleWinnerBold: return "\u{faad}"
        case .scheduleWinnerFilled: return "\u{faae}"
        case .scheduleWinnerLight: return "\u{faaf}"
        case .scheduleWinnerRegular: return "\u{fab0}"
        case .schedulerAvailableBold: return "\u{fab1}"
        case .schedulerAvailableLight: return "\u{fab2}"
        case .schedulerAvailableRegular: return "\u{fab3}"
        case .schedulerNotWorkingHoursBold: return "\u{fab4}"
        case .schedulerNotWorkingHoursLight: return "\u{fab5}"
        case .schedulerNotWorkingHoursRegular: return "\u{fab6}"
        case .schedulerUnavailableBold: return "\u{fab7}"
        case .schedulerUnavailableLight: return "\u{fab8}"
        case .schedulerUnavailableRegular: return "\u{fab9}"
        case .schedulerUnknownBold: return "\u{faba}"
        case .schedulerUnknownLight: return "\u{fabb}"
        case .schedulerUnknownRegular: return "\u{fabc}"
        case .screenshotBold: return "\u{fabd}"
        case .screenshotDocBold: return "\u{fabe}"
        case .screenshotDocFilled: return "\u{fabf}"
        case .screenshotDocLight: return "\u{fac0}"
        case .screenshotDocRegular: return "\u{fac1}"
        case .screenshotLight: return "\u{fac2}"
        case .screenshotRegular: return "\u{fac3}"
        case .searchAiBold: return "\u{fac4}"
        case .searchAiLight: return "\u{fac5}"
        case .searchAiRegular: return "\u{fac6}"
        case .searchBold: return "\u{fac7}"
        case .searchFilled: return "\u{fac8}"
        case .searchLight: return "\u{fac9}"
        case .searchRegular: return "\u{faca}"
        case .secondaryArrowBold: return "\u{facb}"
        case .secondaryArrowLight: return "\u{facc}"
        case .secondaryArrowRegular: return "\u{facd}"
        case .secureCallLockBold: return "\u{face}"
        case .secureCallLockFilled: return "\u{facf}"
        case .secureCallLockLight: return "\u{fad0}"
        case .secureCallLockRegular: return "\u{fad1}"
        case .secureCallShieldBold: return "\u{fad2}"
        case .secureCallShieldFilled: return "\u{fad3}"
        case .secureCallShieldLight: return "\u{fad4}"
        case .secureCallShieldRegular: return "\u{fad5}"
        case .secureCircleBold: return "\u{fad6}"
        case .secureCircleFilled: return "\u{fad7}"
        case .secureCircleLight: return "\u{fad8}"
        case .secureCircleRegular: return "\u{fad9}"
        case .secureLockBold: return "\u{fada}"
        case .secureLockFilled: return "\u{fadb}"
        case .secureLockLight: return "\u{fadc}"
        case .secureLockRegular: return "\u{fadd}"
        case .segmentExcludeFilled: return "\u{fade}"
        case .segmentFilterFilled: return "\u{fadf}"
        case .segmentIncludeFilled: return "\u{fae0}"
        case .selectAllBold: return "\u{fae1}"
        case .selectAllFilled: return "\u{fae2}"
        case .selectAllLight: return "\u{fae3}"
        case .selectAllRegular: return "\u{fae4}"
        case .selectionBold: return "\u{fae5}"
        case .selectionFilled: return "\u{fae6}"
        case .selectionLight: return "\u{fae7}"
        case .selectionRegular: return "\u{fae8}"
        case .sendBold: return "\u{fae9}"
        case .sendDigitsBold: return "\u{faea}"
        case .sendDigitsFilled: return "\u{faeb}"
        case .sendDigitsLight: return "\u{faec}"
        case .sendDigitsRegular: return "\u{faed}"
        case .sendFilled: return "\u{faee}"
        case .sendLight: return "\u{faef}"
        case .sendRegular: return "\u{faf0}"
        case .sendVoiceBold: return "\u{faf1}"
        case .sendVoiceFilled: return "\u{faf2}"
        case .sendVoiceLight: return "\u{faf3}"
        case .sendVoiceRegular: return "\u{faf4}"
        case .serverBold: return "\u{faf5}"
        case .serverErrorBold: return "\u{faf6}"
        case .serverErrorLight: return "\u{faf7}"
        case .serverErrorRegular: return "\u{faf8}"
        case .serverLight: return "\u{faf9}"
        case .serverRegular: return "\u{fafa}"
        case .servicesBold: return "\u{fafb}"
        case .servicesLight: return "\u{fafc}"
        case .servicesRegular: return "\u{fafd}"
        case .setVariableBold: return "\u{fafe}"
        case .setVariableLight: return "\u{faff}"
        case .setVariableRegular: return "\u{fb00}"
        case .settingsBold: return "\u{fb01}"
        case .settingsFilled: return "\u{fb02}"
        case .settingsLight: return "\u{fb03}"
        case .settingsRegular: return "\u{fb04}"
        case .setupAssistantBold: return "\u{fb05}"
        case .setupAssistantLight: return "\u{fb06}"
        case .setupAssistantRegular: return "\u{fb07}"
        case .sftpBold: return "\u{fb08}"
        case .sftpLight: return "\u{fb09}"
        case .sftpRegular: return "\u{fb0a}"
        case .shapeCircleBold: return "\u{fb0b}"
        case .shapeCircleFilled: return "\u{fb0c}"
        case .shapeCircleLight: return "\u{fb0d}"
        case .shapeCircleMdFilled: return "\u{fb0e}"
        case .shapeCircleRegular: return "\u{fb0f}"
        case .shapeCircleSmFilled: return "\u{fb10}"
        case .shapeDiagonalLineBold: return "\u{fb11}"
        case .shapeDiagonalLineLight: return "\u{fb12}"
        case .shapeDiagonalLineRegular: return "\u{fb13}"
        case .shapeDiamondBold: return "\u{fb14}"
        case .shapeDiamondFilled: return "\u{fb15}"
        case .shapeDiamondLight: return "\u{fb16}"
        case .shapeDiamondRegular: return "\u{fb17}"
        case .shapeOvalBold: return "\u{fb18}"
        case .shapeOvalLight: return "\u{fb19}"
        case .shapeOvalRegular: return "\u{fb1a}"
        case .shapeSquareBold: return "\u{fb1b}"
        case .shapeSquareFilled: return "\u{fb1c}"
        case .shapeSquareLight: return "\u{fb1d}"
        case .shapeSquareRegular: return "\u{fb1e}"
        case .shapeTriangleBold: return "\u{fb1f}"
        case .shapeTriangleFilled: return "\u{fb20}"
        case .shapeTriangleLight: return "\u{fb21}"
        case .shapeTriangleRegular: return "\u{fb22}"
        case .shapesBold: return "\u{fb23}"
        case .shapesFilled: return "\u{fb24}"
        case .shapesLight: return "\u{fb25}"
        case .shapesRegular: return "\u{fb26}"
        case .shareCNativeAdrBold: return "\u{fb27}"
        case .shareCNativeAdrFilled: return "\u{fb28}"
        case .shareCNativeAdrLight: return "\u{fb29}"
        case .shareCNativeAdrRegular: return "\u{fb2a}"
        case .shareCNativeIphBold: return "\u{fb2b}"
        case .shareCNativeIphLight: return "\u{fb2c}"
        case .shareCNativeIphRegular: return "\u{fb2d}"
        case .shareContentOnDeviceBold: return "\u{fb2e}"
        case .shareContentOnDeviceLight: return "\u{fb2f}"
        case .shareContentOnDeviceRegular: return "\u{fb30}"
        case .shareScreenAddBold: return "\u{fb31}"
        case .shareScreenAddLight: return "\u{fb32}"
        case .shareScreenAddRegular: return "\u{fb33}"
        case .shareScreenBadgeFilled: return "\u{fb34}"
        case .shareScreenBold: return "\u{fb35}"
        case .shareScreenFilled: return "\u{fb36}"
        case .shareScreenLight: return "\u{fb37}"
        case .shareScreenRegular: return "\u{fb38}"
        case .shareSpaceBold: return "\u{fb39}"
        case .shareSpaceLight: return "\u{fb3a}"
        case .shareSpaceRegular: return "\u{fb3b}"
        case .shieldBold: return "\u{fb3c}"
        case .shieldLight: return "\u{fb3d}"
        case .shieldRegular: return "\u{fb3e}"
        case .shoppingCartBold: return "\u{fb3f}"
        case .shoppingCartFilled: return "\u{fb40}"
        case .shoppingCartLight: return "\u{fb41}"
        case .shoppingCartRegular: return "\u{fb42}"
        case .shortTextBoxBold: return "\u{fb43}"
        case .shortTextBoxLight: return "\u{fb44}"
        case .shortTextBoxRegular: return "\u{fb45}"
        case .showBold: return "\u{fb46}"
        case .showFilled: return "\u{fb47}"
        case .showLight: return "\u{fb48}"
        case .showRegular: return "\u{fb49}"
        case .sidePanelBold: return "\u{fb4a}"
        case .sidePanelFilled: return "\u{fb4b}"
        case .sidePanelLight: return "\u{fb4c}"
        case .sidePanelRegular: return "\u{fb4d}"
        case .signInBold: return "\u{fb4e}"
        case .signInFilled: return "\u{fb4f}"
        case .signInForcedBold: return "\u{fb50}"
        case .signInForcedLight: return "\u{fb51}"
        case .signInForcedRegular: return "\u{fb52}"
        case .signInLight: return "\u{fb53}"
        case .signInRegular: return "\u{fb54}"
        case .signLangIntBold: return "\u{fb55}"
        case .signLangIntLight: return "\u{fb56}"
        case .signLangIntRegular: return "\u{fb57}"
        case .signOutBold: return "\u{fb58}"
        case .signOutLight: return "\u{fb59}"
        case .signOutRegular: return "\u{fb5a}"
        case .signalFourBold: return "\u{fb5b}"
        case .signalFourLight: return "\u{fb5c}"
        case .signalFourRegular: return "\u{fb5d}"
        case .signalOneBold: return "\u{fb5e}"
        case .signalOneLight: return "\u{fb5f}"
        case .signalOneRegular: return "\u{fb60}"
        case .signalThreeBold: return "\u{fb61}"
        case .signalThreeLight: return "\u{fb62}"
        case .signalThreeRegular: return "\u{fb63}"
        case .signalTwoBold: return "\u{fb64}"
        case .signalTwoLight: return "\u{fb65}"
        case .signalTwoRegular: return "\u{fb66}"
        case .signalZeroBold: return "\u{fb67}"
        case .signalZeroLight: return "\u{fb68}"
        case .signalZeroRegular: return "\u{fb69}"
        case .simplePromotionBold: return "\u{fb6a}"
        case .simplePromotionLight: return "\u{fb6b}"
        case .simplePromotionRegular: return "\u{fb6c}"
        case .singleNumberReachBold: return "\u{fb6d}"
        case .singleNumberReachLight: return "\u{fb6e}"
        case .singleNumberReachRegular: return "\u{fb6f}"
        case .sipRegistrationInProgressBold: return "\u{fb70}"
        case .sipRegistrationInProgressFilled: return "\u{fb71}"
        case .sipRegistrationInProgressLight: return "\u{fb72}"
        case .sipRegistrationInProgressRegular: return "\u{fb73}"
        case .skipBold: return "\u{fb74}"
        case .skipBwBold: return "\u{fb75}"
        case .skipBwFilled: return "\u{fb76}"
        case .skipBwLight: return "\u{fb77}"
        case .skipBwRegular: return "\u{fb78}"
        case .skipFwBold: return "\u{fb79}"
        case .skipFwFilled: return "\u{fb7a}"
        case .skipFwLight: return "\u{fb7b}"
        case .skipFwRegular: return "\u{fb7c}"
        case .skipLight: return "\u{fb7d}"
        case .skipRegular: return "\u{fb7e}"
        case .smartAudioBold: return "\u{fb7f}"
        case .smartAudioLight: return "\u{fb80}"
        case .smartAudioRegular: return "\u{fb81}"
        case .smartReplyBold: return "\u{fb82}"
        case .smartReplyLight: return "\u{fb83}"
        case .smartReplyRegular: return "\u{fb84}"
        case .smsFilled: return "\u{fb85}"
        case .smsInboundBold: return "\u{fb86}"
        case .smsInboundLight: return "\u{fb87}"
        case .smsInboundRegular: return "\u{fb88}"
        case .smsMessageBold: return "\u{fb89}"
        case .smsMessageFilled: return "\u{fb8a}"
        case .smsMessageLight: return "\u{fb8b}"
        case .smsMessageOutgoingBold: return "\u{fb8c}"
        case .smsMessageOutgoingFilled: return "\u{fb8d}"
        case .smsMessageOutgoingLight: return "\u{fb8e}"
        case .smsMessageOutgoingRegular: return "\u{fb8f}"
        case .smsMessageRegular: return "\u{fb90}"
        case .smsMessageStartBold: return "\u{fb91}"
        case .smsMessageStartFilled: return "\u{fb92}"
        case .smsMessageStartLight: return "\u{fb93}"
        case .smsMessageStartRegular: return "\u{fb94}"
        case .smsOutgoingFilled: return "\u{fb95}"
        case .smsUnreadBold: return "\u{fb96}"
        case .smsUnreadLight: return "\u{fb97}"
        case .smsUnreadRegular: return "\u{fb98}"
        case .sortAscendingBold: return "\u{fb99}"
        case .sortAscendingLight: return "\u{fb9a}"
        case .sortAscendingRegular: return "\u{fb9b}"
        case .sortDescendingBold: return "\u{fb9c}"
        case .sortDescendingLight: return "\u{fb9d}"
        case .sortDescendingRegular: return "\u{fb9e}"
        case .soundDefaultBold: return "\u{fb9f}"
        case .soundDefaultLight: return "\u{fba0}"
        case .soundDefaultRegular: return "\u{fba1}"
        case .sparkleBold: return "\u{fba2}"
        case .sparkleFilled: return "\u{fba3}"
        case .sparkleLight: return "\u{fba4}"
        case .sparkleRegular: return "\u{fba5}"
        case .speakerBold: return "\u{fba6}"
        case .speakerDisconnectedBold: return "\u{fba7}"
        case .speakerDisconnectedFilled: return "\u{fba8}"
        case .speakerDisconnectedLight: return "\u{fba9}"
        case .speakerDisconnectedRegular: return "\u{fbaa}"
        case .speakerFilled: return "\u{fbab}"
        case .speakerLight: return "\u{fbac}"
        case .speakerMutedBold: return "\u{fbad}"
        case .speakerMutedFilled: return "\u{fbae}"
        case .speakerMutedLight: return "\u{fbaf}"
        case .speakerMutedRegular: return "\u{fbb0}"
        case .speakerOffBold: return "\u{fbb1}"
        case .speakerOffFilled: return "\u{fbb2}"
        case .speakerOffLight: return "\u{fbb3}"
        case .speakerOffRegular: return "\u{fbb4}"
        case .speakerOnBold: return "\u{fbb5}"
        case .speakerOnLight: return "\u{fbb6}"
        case .speakerOnRegular: return "\u{fbb7}"
        case .speakerRegular: return "\u{fbb8}"
        case .speakerTurnDownBold: return "\u{fbb9}"
        case .speakerTurnDownFilled: return "\u{fbba}"
        case .speakerTurnDownLight: return "\u{fbbb}"
        case .speakerTurnDownRegular: return "\u{fbbc}"
        case .speakerTurnUpBold: return "\u{fbbd}"
        case .speakerTurnUpFilled: return "\u{fbbe}"
        case .speakerTurnUpLight: return "\u{fbbf}"
        case .speakerTurnUpRegular: return "\u{fbc0}"
        case .speechAiBold: return "\u{fbc1}"
        case .speechAiFilled: return "\u{fbc2}"
        case .speechAiLight: return "\u{fbc3}"
        case .speechAiRegular: return "\u{fbc4}"
        case .speedDialBold: return "\u{fbc5}"
        case .speedDialFilled: return "\u{fbc6}"
        case .speedDialLight: return "\u{fbc7}"
        case .speedDialRegular: return "\u{fbc8}"
        case .spellCheckerBold: return "\u{fbc9}"
        case .spellCheckerLight: return "\u{fbca}"
        case .spellCheckerRegular: return "\u{fbcb}"
        case .splitViewBold: return "\u{fbcc}"
        case .splitViewLight: return "\u{fbcd}"
        case .splitViewRegular: return "\u{fbce}"
        case .stackedAreaChartBold: return "\u{fbcf}"
        case .stackedAreaChartFilled: return "\u{fbd0}"
        case .stackedAreaChartFullBold: return "\u{fbd1}"
        case .stackedAreaChartFullFilled: return "\u{fbd2}"
        case .stackedAreaChartFullLight: return "\u{fbd3}"
        case .stackedAreaChartFullRegular: return "\u{fbd4}"
        case .stackedAreaChartLight: return "\u{fbd5}"
        case .stackedAreaChartRegular: return "\u{fbd6}"
        case .stackedBarChartBold: return "\u{fbd7}"
        case .stackedBarChartFilled: return "\u{fbd8}"
        case .stackedBarChartFullBold: return "\u{fbd9}"
        case .stackedBarChartFullFilled: return "\u{fbda}"
        case .stackedBarChartFullLight: return "\u{fbdb}"
        case .stackedBarChartFullRegular: return "\u{fbdc}"
        case .stackedBarChartLight: return "\u{fbdd}"
        case .stackedBarChartRegular: return "\u{fbde}"
        case .startChatBold: return "\u{fbdf}"
        case .startChatLight: return "\u{fbe0}"
        case .startChatRegular: return "\u{fbe1}"
        case .stethoscopeBold: return "\u{fbe2}"
        case .stethoscopeLight: return "\u{fbe3}"
        case .stethoscopeRegular: return "\u{fbe4}"
        case .stickersBold: return "\u{fbe5}"
        case .stickersLight: return "\u{fbe6}"
        case .stickersRegular: return "\u{fbe7}"
        case .stickiesBold: return "\u{fbe8}"
        case .stickiesLight: return "\u{fbe9}"
        case .stickiesRegular: return "\u{fbea}"
        case .stopBold: return "\u{fbeb}"
        case .stopCircleBold: return "\u{fbec}"
        case .stopCircleFilled: return "\u{fbed}"
        case .stopCircleLight: return "\u{fbee}"
        case .stopCircleRegular: return "\u{fbef}"
        case .stopContentShareBold: return "\u{fbf0}"
        case .stopContentShareLight: return "\u{fbf1}"
        case .stopContentShareRegular: return "\u{fbf2}"
        case .stopFilled: return "\u{fbf3}"
        case .stopLight: return "\u{fbf4}"
        case .stopRegular: return "\u{fbf5}"
        case .storedInfoBold: return "\u{fbf6}"
        case .storedInfoFilled: return "\u{fbf7}"
        case .storedInfoLight: return "\u{fbf8}"
        case .storedInfoRegular: return "\u{fbf9}"
        case .streamingBold: return "\u{fbfa}"
        case .streamingLight: return "\u{fbfb}"
        case .streamingRegular: return "\u{fbfc}"
        case .strikethroughBold: return "\u{fbfd}"
        case .strikethroughFilled: return "\u{fbfe}"
        case .strikethroughLight: return "\u{fbff}"
        case .strikethroughRegular: return "\u{fc00}"
        case .studioModeBold: return "\u{fc01}"
        case .studioModeLight: return "\u{fc02}"
        case .studioModeRegular: return "\u{fc03}"
        case .subscriptBold: return "\u{fc04}"
        case .subscriptLight: return "\u{fc05}"
        case .subscriptRegular: return "\u{fc06}"
        case .summarizeAiBold: return "\u{fc07}"
        case .summarizeAiLight: return "\u{fc08}"
        case .summarizeAiRegular: return "\u{fc09}"
        case .superscriptBold: return "\u{fc0a}"
        case .superscriptLight: return "\u{fc0b}"
        case .superscriptRegular: return "\u{fc0c}"
        case .surveyBold: return "\u{fc0d}"
        case .surveyFilled: return "\u{fc0e}"
        case .surveyLight: return "\u{fc0f}"
        case .surveyRegular: return "\u{fc10}"
        case .sxEightyCodecBold: return "\u{fc11}"
        case .sxEightyCodecLight: return "\u{fc12}"
        case .sxEightyCodecRegular: return "\u{fc13}"
        case .sxTenBold: return "\u{fc14}"
        case .sxTenLight: return "\u{fc15}"
        case .sxTenRegular: return "\u{fc16}"
        case .sxTwentyBold: return "\u{fc17}"
        case .sxTwentyLight: return "\u{fc18}"
        case .sxTwentyRegular: return "\u{fc19}"
        case .tableBold: return "\u{fc1a}"
        case .tableExtenderBold: return "\u{fc1b}"
        case .tableExtenderFilled: return "\u{fc1c}"
        case .tableExtenderLight: return "\u{fc1d}"
        case .tableExtenderRegular: return "\u{fc1e}"
        case .tableLight: return "\u{fc1f}"
        case .tableRegular: return "\u{fc20}"
        case .tabletBold: return "\u{fc21}"
        case .tabletLight: return "\u{fc22}"
        case .tabletRegular: return "\u{fc23}"
        case .tabsBold: return "\u{fc24}"
        case .tabsLight: return "\u{fc25}"
        case .tabsRegular: return "\u{fc26}"
        case .tagBold: return "\u{fc27}"
        case .tagLight: return "\u{fc28}"
        case .tagRegular: return "\u{fc29}"
        case .tapBold: return "\u{fc2a}"
        case .tapFilled: return "\u{fc2b}"
        case .tapLight: return "\u{fc2c}"
        case .tapRegular: return "\u{fc2d}"
        case .telepresenceAlertBold: return "\u{fc2e}"
        case .telepresenceAlertLight: return "\u{fc2f}"
        case .telepresenceAlertMutedBold: return "\u{fc30}"
        case .telepresenceAlertMutedLight: return "\u{fc31}"
        case .telepresenceAlertMutedRegular: return "\u{fc32}"
        case .telepresenceAlertRegular: return "\u{fc33}"
        case .telepresenceBold: return "\u{fc34}"
        case .telepresenceIxFiveThousandBold: return "\u{fc35}"
        case .telepresenceIxFiveThousandLight: return "\u{fc36}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc37}"
        case .telepresenceLight: return "\u{fc38}"
        case .telepresenceMutedBold: return "\u{fc39}"
        case .telepresenceMutedLight: return "\u{fc3a}"
        case .telepresenceMutedRegular: return "\u{fc3b}"
        case .telepresencePrivateBold: return "\u{fc3c}"
        case .telepresencePrivateLight: return "\u{fc3d}"
        case .telepresencePrivateRegular: return "\u{fc3e}"
        case .telepresenceRegular: return "\u{fc3f}"
        case .temperatureBold: return "\u{fc40}"
        case .temperatureLight: return "\u{fc41}"
        case .temperatureRegular: return "\u{fc42}"
        case .tenantBold: return "\u{fc43}"
        case .tenantFilled: return "\u{fc44}"
        case .tenantLight: return "\u{fc45}"
        case .tenantRegular: return "\u{fc46}"
        case .testTubeBold: return "\u{fc47}"
        case .testTubeFilled: return "\u{fc48}"
        case .testTubeLight: return "\u{fc49}"
        case .testTubeRegular: return "\u{fc4a}"
        case .textAlignCenterBold: return "\u{fc4b}"
        case .textAlignCenterFilled: return "\u{fc4c}"
        case .textAlignCenterLight: return "\u{fc4d}"
        case .textAlignCenterRegular: return "\u{fc4e}"
        case .textAlignLeftBold: return "\u{fc4f}"
        case .textAlignLeftFilled: return "\u{fc50}"
        case .textAlignLeftLight: return "\u{fc51}"
        case .textAlignLeftRegular: return "\u{fc52}"
        case .textAlignRightBold: return "\u{fc53}"
        case .textAlignRightFilled: return "\u{fc54}"
        case .textAlignRightLight: return "\u{fc55}"
        case .textAlignRightRegular: return "\u{fc56}"
        case .textBold: return "\u{fc57}"
        case .textBoxCursorLight: return "\u{fc58}"
        case .textCodeBlockBold: return "\u{fc59}"
        case .textCodeBlockLight: return "\u{fc5a}"
        case .textCodeBlockRegular: return "\u{fc5b}"
        case .textHighlightBold: return "\u{fc5c}"
        case .textHighlightFilled: return "\u{fc5d}"
        case .textHighlightLight: return "\u{fc5e}"
        case .textHighlightRegular: return "\u{fc5f}"
        case .textLight: return "\u{fc60}"
        case .textRegular: return "\u{fc61}"
        case .textShortBold: return "\u{fc62}"
        case .textShortLight: return "\u{fc63}"
        case .textShortRegular: return "\u{fc64}"
        case .threeColumnBold: return "\u{fc65}"
        case .threeColumnLight: return "\u{fc66}"
        case .threeColumnRegular: return "\u{fc67}"
        case .threeDObjectBold: return "\u{fc68}"
        case .threeDObjectLight: return "\u{fc69}"
        case .threeDObjectRegular: return "\u{fc6a}"
        case .timeExclusionBold: return "\u{fc6b}"
        case .timeExclusionLight: return "\u{fc6c}"
        case .timeExclusionRegular: return "\u{fc6d}"
        case .timezoneBold: return "\u{fc6e}"
        case .timezoneFilled: return "\u{fc6f}"
        case .timezoneLight: return "\u{fc70}"
        case .timezoneRegular: return "\u{fc71}"
        case .tooFastBold: return "\u{fc72}"
        case .tooFastLight: return "\u{fc73}"
        case .tooFastRegular: return "\u{fc74}"
        case .tooSlowBold: return "\u{fc75}"
        case .tooSlowLight: return "\u{fc76}"
        case .tooSlowRegular: return "\u{fc77}"
        case .toolsBold: return "\u{fc78}"
        case .toolsFilled: return "\u{fc79}"
        case .toolsLight: return "\u{fc7a}"
        case .toolsRegular: return "\u{fc7b}"
        case .touchTenBold: return "\u{fc7c}"
        case .touchTenLight: return "\u{fc7d}"
        case .touchTenRegular: return "\u{fc7e}"
        case .trackingBold: return "\u{fc7f}"
        case .trackingFilled: return "\u{fc80}"
        case .trackingLight: return "\u{fc81}"
        case .trackingRegular: return "\u{fc82}"
        case .transcriptBold: return "\u{fc83}"
        case .transcriptFilled: return "\u{fc84}"
        case .transcriptLight: return "\u{fc85}"
        case .transcriptRegular: return "\u{fc86}"
        case .translateBold: return "\u{fc87}"
        case .translateLight: return "\u{fc88}"
        case .translateRegular: return "\u{fc89}"
        case .translateUndoBold: return "\u{fc8a}"
        case .translateUndoLight: return "\u{fc8b}"
        case .translateUndoRegular: return "\u{fc8c}"
        case .trendingBold: return "\u{fc8d}"
        case .trendingDownBold: return "\u{fc8e}"
        case .trendingDownFilled: return "\u{fc8f}"
        case .trendingDownLight: return "\u{fc90}"
        case .trendingDownRegular: return "\u{fc91}"
        case .trendingFilled: return "\u{fc92}"
        case .trendingLight: return "\u{fc93}"
        case .trendingRegular: return "\u{fc94}"
        case .trimBold: return "\u{fc95}"
        case .trimLight: return "\u{fc96}"
        case .trimRegular: return "\u{fc97}"
        case .twoColumnBold: return "\u{fc98}"
        case .twoColumnLight: return "\u{fc99}"
        case .twoColumnRegular: return "\u{fc9a}"
        case .twoWayVoiceStreamBold: return "\u{fc9b}"
        case .twoWayVoiceStreamFilled: return "\u{fc9c}"
        case .twoWayVoiceStreamLight: return "\u{fc9d}"
        case .twoWayVoiceStreamRegular: return "\u{fc9e}"
        case .ucmCloudBold: return "\u{fc9f}"
        case .ucmCloudLight: return "\u{fca0}"
        case .ucmCloudRegular: return "\u{fca1}"
        case .unblockBold: return "\u{fca2}"
        case .unblockFilled: return "\u{fca3}"
        case .unblockLight: return "\u{fca4}"
        case .unblockRegular: return "\u{fca5}"
        case .underlineBold: return "\u{fca6}"
        case .underlineFilled: return "\u{fca7}"
        case .underlineLight: return "\u{fca8}"
        case .underlineRegular: return "\u{fca9}"
        case .undoBold: return "\u{fcaa}"
        case .undoLight: return "\u{fcab}"
        case .undoRegular: return "\u{fcac}"
        case .unlinkBold: return "\u{fcad}"
        case .unlinkLight: return "\u{fcae}"
        case .unlinkRegular: return "\u{fcaf}"
        case .unreadBold: return "\u{fcb0}"
        case .unreadFilled: return "\u{fcb1}"
        case .unreadLight: return "\u{fcb2}"
        case .unreadRegular: return "\u{fcb3}"
        case .unsecureUnlockedBold: return "\u{fcb4}"
        case .unsecureUnlockedFilled: return "\u{fcb5}"
        case .unsecureUnlockedLight: return "\u{fcb6}"
        case .unsecureUnlockedRegular: return "\u{fcb7}"
        case .unsortedBold: return "\u{fcb8}"
        case .unsortedLight: return "\u{fcb9}"
        case .unsortedRegular: return "\u{fcba}"
        case .updateFileShareBold: return "\u{fcbb}"
        case .updateFileShareLight: return "\u{fcbc}"
        case .updateFileShareRegular: return "\u{fcbd}"
        case .uploadBold: return "\u{fcbe}"
        case .uploadImageBold: return "\u{fcbf}"
        case .uploadImageLight: return "\u{fcc0}"
        case .uploadImageRegular: return "\u{fcc1}"
        case .uploadLight: return "\u{fcc2}"
        case .uploadRegular: return "\u{fcc3}"
        case .urgentVoicemailBold: return "\u{fcc4}"
        case .urgentVoicemailFilled: return "\u{fcc5}"
        case .usbBold: return "\u{fcc6}"
        case .usbHeadsetBold: return "\u{fcc7}"
        case .usbHeadsetLight: return "\u{fcc8}"
        case .usbHeadsetMutedBold: return "\u{fcc9}"
        case .usbHeadsetMutedLight: return "\u{fcca}"
        case .usbHeadsetMutedRegular: return "\u{fccb}"
        case .usbHeadsetRegular: return "\u{fccc}"
        case .usbLight: return "\u{fccd}"
        case .usbRegular: return "\u{fcce}"
        case .userBold: return "\u{fccf}"
        case .userDeactivateBold: return "\u{fcd0}"
        case .userDeactivateLight: return "\u{fcd1}"
        case .userDeactivateRegular: return "\u{fcd2}"
        case .userFilled: return "\u{fcd3}"
        case .userLight: return "\u{fcd4}"
        case .userRegular: return "\u{fcd5}"
        case .userSecurityStatusBold: return "\u{fcd6}"
        case .userSecurityStatusFilled: return "\u{fcd7}"
        case .userSecurityStatusLight: return "\u{fcd8}"
        case .userSecurityStatusRegular: return "\u{fcd9}"
        case .videoBlurBold: return "\u{fcda}"
        case .videoBlurFilled: return "\u{fcdb}"
        case .videoBlurLight: return "\u{fcdc}"
        case .videoBlurRegular: return "\u{fcdd}"
        case .videoBold: return "\u{fcde}"
        case .videoEffectBold: return "\u{fcdf}"
        case .videoEffectFilled: return "\u{fce0}"
        case .videoEffectLight: return "\u{fce1}"
        case .videoEffectRegular: return "\u{fce2}"
        case .videoFilled: return "\u{fce3}"
        case .videoLayoutBold: return "\u{fce4}"
        case .videoLayoutCustomBold: return "\u{fce5}"
        case .videoLayoutCustomFilled: return "\u{fce6}"
        case .videoLayoutCustomLight: return "\u{fce7}"
        case .videoLayoutCustomRegular: return "\u{fce8}"
        case .videoLayoutEqualBold: return "\u{fce9}"
        case .videoLayoutEqualDualBold: return "\u{fcea}"
        case .videoLayoutEqualDualLight: return "\u{fceb}"
        case .videoLayoutEqualDualRegular: return "\u{fcec}"
        case .videoLayoutEqualFilled: return "\u{fced}"
        case .videoLayoutEqualLight: return "\u{fcee}"
        case .videoLayoutEqualRegular: return "\u{fcef}"
        case .videoLayoutFilled: return "\u{fcf0}"
        case .videoLayoutLight: return "\u{fcf1}"
        case .videoLayoutOverlayBold: return "\u{fcf2}"
        case .videoLayoutOverlayFilled: return "\u{fcf3}"
        case .videoLayoutOverlayLight: return "\u{fcf4}"
        case .videoLayoutOverlayRegular: return "\u{fcf5}"
        case .videoLayoutPresentationBold: return "\u{fcf6}"
        case .videoLayoutPresentationFilled: return "\u{fcf7}"
        case .videoLayoutPresentationLight: return "\u{fcf8}"
        case .videoLayoutPresentationRegular: return "\u{fcf9}"
        case .videoLayoutPresenterDominantBold: return "\u{fcfa}"
        case .videoLayoutPresenterDominantLight: return "\u{fcfb}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcfc}"
        case .videoLayoutProminentBold: return "\u{fcfd}"
        case .videoLayoutProminentFilled: return "\u{fcfe}"
        case .videoLayoutProminentLight: return "\u{fcff}"
        case .videoLayoutProminentRegular: return "\u{fd00}"
        case .videoLayoutRegular: return "\u{fd01}"
        case .videoLayoutShareDominantBold: return "\u{fd02}"
        case .videoLayoutShareDominantLight: return "\u{fd03}"
        case .videoLayoutShareDominantRegular: return "\u{fd04}"
        case .videoLayoutSingleBold: return "\u{fd05}"
        case .videoLayoutSingleFilled: return "\u{fd06}"
        case .videoLayoutSingleLight: return "\u{fd07}"
        case .videoLayoutSingleRegular: return "\u{fd08}"
        case .videoLayoutSpeakerBold: return "\u{fd09}"
        case .videoLayoutSpeakerFilled: return "\u{fd0a}"
        case .videoLayoutSpeakerLight: return "\u{fd0b}"
        case .videoLayoutSpeakerRegular: return "\u{fd0c}"
        case .videoLayoutStackBold: return "\u{fd0d}"
        case .videoLayoutStackFilled: return "\u{fd0e}"
        case .videoLayoutStackLight: return "\u{fd0f}"
        case .videoLayoutStackRegular: return "\u{fd10}"
        case .videoLayoutVideoDominantBold: return "\u{fd11}"
        case .videoLayoutVideoDominantFilled: return "\u{fd12}"
        case .videoLayoutVideoDominantLight: return "\u{fd13}"
        case .videoLayoutVideoDominantRegular: return "\u{fd14}"
        case .videoLight: return "\u{fd15}"
        case .videoPlusBold: return "\u{fd16}"
        case .videoPlusFilled: return "\u{fd17}"
        case .videoPlusLight: return "\u{fd18}"
        case .videoPlusRegular: return "\u{fd19}"
        case .videoRegular: return "\u{fd1a}"
        case .videoSpeakerTrackBold: return "\u{fd1b}"
        case .videoSpeakerTrackFilled: return "\u{fd1c}"
        case .videoSpeakerTrackLight: return "\u{fd1d}"
        case .videoSpeakerTrackRegular: return "\u{fd1e}"
        case .viewAllBold: return "\u{fd1f}"
        case .viewAllLight: return "\u{fd20}"
        case .viewAllRegular: return "\u{fd21}"
        case .viewListBold: return "\u{fd22}"
        case .viewListFilled: return "\u{fd23}"
        case .viewListLight: return "\u{fd24}"
        case .viewListRegular: return "\u{fd25}"
        case .viewStackedBold: return "\u{fd26}"
        case .viewStackedFilled: return "\u{fd27}"
        case .viewStackedLight: return "\u{fd28}"
        case .viewStackedRegular: return "\u{fd29}"
        case .viewThumbnailBold: return "\u{fd2a}"
        case .viewThumbnailFilled: return "\u{fd2b}"
        case .viewThumbnailLight: return "\u{fd2c}"
        case .viewThumbnailRegular: return "\u{fd2d}"
        case .visionproBold: return "\u{fd2e}"
        case .visionproFilled: return "\u{fd2f}"
        case .visionproLight: return "\u{fd30}"
        case .visionproMoveCallInBold: return "\u{fd31}"
        case .visionproMoveCallInFilled: return "\u{fd32}"
        case .visionproMoveCallInLight: return "\u{fd33}"
        case .visionproMoveCallInOutBold: return "\u{fd34}"
        case .visionproMoveCallInOutFilled: return "\u{fd35}"
        case .visionproMoveCallInOutLight: return "\u{fd36}"
        case .visionproMoveCallInOutRegular: return "\u{fd37}"
        case .visionproMoveCallInRegular: return "\u{fd38}"
        case .visionproMoveCallOutBold: return "\u{fd39}"
        case .visionproMoveCallOutFilled: return "\u{fd3a}"
        case .visionproMoveCallOutLight: return "\u{fd3b}"
        case .visionproMoveCallOutRegular: return "\u{fd3c}"
        case .visionproRegular: return "\u{fd3d}"
        case .voiceClipBold: return "\u{fd3e}"
        case .voiceClipFilled: return "\u{fd3f}"
        case .voiceClipLight: return "\u{fd40}"
        case .voiceClipRegular: return "\u{fd41}"
        case .voicemailBold: return "\u{fd42}"
        case .voicemailFilled: return "\u{fd43}"
        case .voicemailLight: return "\u{fd44}"
        case .voicemailRegular: return "\u{fd45}"
        case .vpnBold: return "\u{fd46}"
        case .vpnFilled: return "\u{fd47}"
        case .vpnLight: return "\u{fd48}"
        case .vpnRegular: return "\u{fd49}"
        case .vscBold: return "\u{fd4a}"
        case .vscLight: return "\u{fd4b}"
        case .vscRegular: return "\u{fd4c}"
        case .waffleMenuBold: return "\u{fd4d}"
        case .waffleMenuLight: return "\u{fd4e}"
        case .waffleMenuRegular: return "\u{fd4f}"
        case .waitingRoomBold: return "\u{fd50}"
        case .waitingRoomFilled: return "\u{fd51}"
        case .waitingRoomLight: return "\u{fd52}"
        case .waitingRoomRegular: return "\u{fd53}"
        case .wallpaperBold: return "\u{fd54}"
        case .wallpaperLight: return "\u{fd55}"
        case .wallpaperRegular: return "\u{fd56}"
        case .warningBadgeFilled: return "\u{fd57}"
        case .warningBold: return "\u{fd58}"
        case .warningFilled: return "\u{fd59}"
        case .warningLight: return "\u{fd5a}"
        case .warningRegular: return "\u{fd5b}"
        case .webexBoardBold: return "\u{fd5c}"
        case .webexBoardLight: return "\u{fd5d}"
        case .webexBoardRegular: return "\u{fd5e}"
        case .webexCodecPlusBold: return "\u{fd5f}"
        case .webexCodecPlusLight: return "\u{fd60}"
        case .webexCodecPlusRegular: return "\u{fd61}"
        case .webexDeskCameraBold: return "\u{fd62}"
        case .webexDeskCameraLight: return "\u{fd63}"
        case .webexDeskCameraRegular: return "\u{fd64}"
        case .webexHelixBold: return "\u{fd65}"
        case .webexHelixLight: return "\u{fd66}"
        case .webexHelixRegular: return "\u{fd67}"
        case .webexMeetingsBold: return "\u{fd68}"
        case .webexMeetingsFilled: return "\u{fd69}"
        case .webexMeetingsLight: return "\u{fd6a}"
        case .webexMeetingsRegular: return "\u{fd6b}"
        case .webexQuadCameraBold: return "\u{fd6c}"
        case .webexQuadCameraLight: return "\u{fd6d}"
        case .webexQuadCameraRegular: return "\u{fd6e}"
        case .webexRoomKitBold: return "\u{fd6f}"
        case .webexRoomKitLight: return "\u{fd70}"
        case .webexRoomKitPlusBold: return "\u{fd71}"
        case .webexRoomKitPlusLight: return "\u{fd72}"
        case .webexRoomKitPlusRegular: return "\u{fd73}"
        case .webexRoomKitRegular: return "\u{fd74}"
        case .webexShareBold: return "\u{fd75}"
        case .webexShareLight: return "\u{fd76}"
        case .webexShareRegular: return "\u{fd77}"
        case .webexTeamsBold: return "\u{fd78}"
        case .webexTeamsFilled: return "\u{fd79}"
        case .webexTeamsLight: return "\u{fd7a}"
        case .webexTeamsNewBold: return "\u{fd7b}"
        case .webexTeamsNewFilled: return "\u{fd7c}"
        case .webexTeamsNewLight: return "\u{fd7d}"
        case .webexTeamsNewRegular: return "\u{fd7e}"
        case .webexTeamsRegular: return "\u{fd7f}"
        case .webexTeamsRemoveBold: return "\u{fd80}"
        case .webexTeamsRemoveLight: return "\u{fd81}"
        case .webexTeamsRemoveRegular: return "\u{fd82}"
        case .webhookBold: return "\u{fd83}"
        case .webhookLight: return "\u{fd84}"
        case .webhookRegular: return "\u{fd85}"
        case .webinarBold: return "\u{fd86}"
        case .webinarFilled: return "\u{fd87}"
        case .webinarLight: return "\u{fd88}"
        case .webinarRegular: return "\u{fd89}"
        case .weeklyRecurringScheduleBold: return "\u{fd8a}"
        case .weeklyRecurringScheduleLight: return "\u{fd8b}"
        case .weeklyRecurringScheduleRegular: return "\u{fd8c}"
        case .whisperAnnouncementBold: return "\u{fd8d}"
        case .whisperAnnouncementFilled: return "\u{fd8e}"
        case .whisperAnnouncementLight: return "\u{fd8f}"
        case .whisperAnnouncementRegular: return "\u{fd90}"
        case .whisperCoachBold: return "\u{fd91}"
        case .whisperCoachFilled: return "\u{fd92}"
        case .whisperCoachLight: return "\u{fd93}"
        case .whisperCoachRegular: return "\u{fd94}"
        case .whiteboardBold: return "\u{fd95}"
        case .whiteboardContentBold: return "\u{fd96}"
        case .whiteboardContentFilled: return "\u{fd97}"
        case .whiteboardContentLight: return "\u{fd98}"
        case .whiteboardContentRegular: return "\u{fd99}"
        case .whiteboardFilled: return "\u{fd9a}"
        case .whiteboardLight: return "\u{fd9b}"
        case .whiteboardRegular: return "\u{fd9c}"
        case .widgetBold: return "\u{fd9d}"
        case .widgetFilled: return "\u{fd9e}"
        case .widgetLight: return "\u{fd9f}"
        case .widgetRegular: return "\u{fda0}"
        case .wifiBold: return "\u{fda1}"
        case .wifiErrorBold: return "\u{fda2}"
        case .wifiErrorLight: return "\u{fda3}"
        case .wifiErrorRegular: return "\u{fda4}"
        case .wifiLight: return "\u{fda5}"
        case .wifiRegular: return "\u{fda6}"
        case .wifiSignalGoodBold: return "\u{fda7}"
        case .wifiSignalGoodLight: return "\u{fda8}"
        case .wifiSignalGoodRegular: return "\u{fda9}"
        case .wifiSignalPoorBold: return "\u{fdaa}"
        case .wifiSignalPoorLight: return "\u{fdab}"
        case .wifiSignalPoorRegular: return "\u{fdac}"
        case .wifiSignalUnstableBold: return "\u{fdad}"
        case .wifiSignalUnstableLight: return "\u{fdae}"
        case .wifiSignalUnstableRegular: return "\u{fdaf}"
        case .windowCornerScrubBold: return "\u{fdb0}"
        case .windowCornerScrubLight: return "\u{fdb1}"
        case .windowCornerScrubRegular: return "\u{fdb2}"
        case .windowRightCornerScrubBold: return "\u{fdb3}"
        case .windowRightCornerScrubLight: return "\u{fdb4}"
        case .windowRightCornerScrubRegular: return "\u{fdb5}"
        case .windowVerticalScrubBold: return "\u{fdb6}"
        case .windowVerticalScrubLight: return "\u{fdb7}"
        case .windowVerticalScrubRegular: return "\u{fdb8}"
        case .workflowDeploymentsBold: return "\u{fdb9}"
        case .workflowDeploymentsFilled: return "\u{fdba}"
        case .workflowDeploymentsLight: return "\u{fdbb}"
        case .workflowDeploymentsRegular: return "\u{fdbc}"
        case .workphoneBold: return "\u{fdbd}"
        case .workphoneLight: return "\u{fdbe}"
        case .workphoneRegular: return "\u{fdbf}"
        case .zoomInBold: return "\u{fdc0}"
        case .zoomInLight: return "\u{fdc1}"
        case .zoomInRegular: return "\u{fdc2}"
        case .zoomOutBold: return "\u{fdc3}"
        case .zoomOutLight: return "\u{fdc4}"
        case .zoomOutRegular: return "\u{fdc5}"
