...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .customTaskBold: return "\u{f3cf}"
        case .customTaskFilled: return "\u{f3d0}"
        case .customTaskLight: return "\u{f3d1}"
        case .customTaskRegular: return "\u{f3d2}"
        case .dailyRecurringScheduleBold: return "\u{f3d3}"
        case .dailyRecurringScheduleLight: return "\u{f3d4}"
        case .dailyRecurringScheduleRegular: return "\u{f3d5}"
        case .dashboardBold: return "\u{f3d6}"
        case .dashboardFilled: return "\u{f3d7}"
        case .dashboardLight: return "\u{f3d8}"
        case .dashboardRegular: return "\u{f3d9}"
        case .dataManagementBold: return "\u{f3da}"
        case .dataManagementFilled: return "\u{f3db}"
        case .dataManagementLight: return "\u{f3dc}"
        case .dataManagementRegular: return "\u{f3dd}"
        case .dataRangeSelectionBold: return "\u{f3de}"
        case .dataRangeSelectionFilled: return "\u{f3df}"
        case .dataRangeSelectionLight: return "\u{f3e0}"
        case .dataRangeSelectionRegular: return "\u{f3e1}"
        case .declineBold: return "\u{f3e2}"
        case .declineFilled: return "\u{f3e3}"
        case .declineLight: return "\u{f3e4}"
        case .declineRegular: return "\u{f3e5}"
        case .dectHandsetBold: return "\u{f3e6}"
        case .dectHandsetFilled: return "\u{f3e7}"
        case .dectHandsetLight: return "\u{f3e8}"
        case .dectHandsetRegular: return "\u{f3e9}"
        case .deleteBold: return "\u{f3ea}"
        case .deleteFilled: return "\u{f3eb}"
        case .deleteLight: return "\u{f3ec}"
        case .deleteRegular: return "\u{f3ed}"
        case .deploymentEvaluationProgressBold: return "\u{f3ee}"
        case .deploymentEvaluationProgressLight: return "\u{f3ef}"
        case .deploymentEvaluationProgressRegular: return "\u{f3f0}"
        case .deploymentProgressBold: return "\u{f3f1}"
        case .deploymentProgressLight: return "\u{f3f2}"
        case .deploymentProgressRegular: return "\u{f3f3}"
        case .deploymentRecurringBold: return "\u{f3f4}"
        case .deploymentRecurringLight: return "\u{f3f5}"
        case .deploymentRecurringRegular: return "\u{f3f6}"
        case .deploymentWinnerPendingBold: return "\u{f3f7}"
        case .deploymentWinnerPendingLight: return "\u{f3f8}"
        case .deploymentWinnerPendingRegular: return "\u{f3f9}"
        case .deskPhoneBold: return "\u{f3fa}"
        case .deskPhoneFilled: return "\u{f3fb}"
        case .deskPhoneLight: return "\u{f3fc}"
        case .deskPhoneRegular: return "\u{f3fd}"
        case .deskPhoneWarningBold: return "\u{f3fe}"
        case .deskPhoneWarningLight: return "\u{f3ff}"
        case .deskPhoneWarningRegular: return "\u{f400}"
        case .deviceConnectionBold: return "\u{f401}"
        case .deviceConnectionFilled: return "\u{f402}"
        case .deviceConnectionLight: return "\u{f403}"
        case .deviceConnectionRegular: return "\u{f404}"
        case .deviceInRoomBold: return "\u{f405}"
        case .deviceInRoomEndBold: return "\u{f406}"
        case .deviceInRoomEndLight: return "\u{f407}"
        case .deviceInRoomEndRegular: return "\u{f408}"
        case .deviceInRoomFilled: return "\u{f409}"
        case .deviceInRoomLight: return "\u{f40a}"
        case .deviceInRoomRegular: return "\u{f40b}"
        case .deviceMutedBold: return "\u{f40c}"
        case .deviceMutedLight: return "\u{f40d}"
        case .deviceMutedRegular: return "\u{f40e}"
        case .devicePolicyControllerBold: return "\u{f40f}"
        case .devicePolicyControllerLight: return "\u{f410}"
        case .devicePolicyControllerRegular: return "\u{f411}"
        case .devicesBold: return "\u{f412}"
        case .devicesFilled: return "\u{f413}"
        case .devicesLight: return "\u{f414}"
        case .devicesRegular: return "\u{f415}"
        case .diagnosticsBold: return "\u{f416}"
        case .diagnosticsLight: return "\u{f417}"
        case .diagnosticsRegular: return "\u{f418}"
        case .dialpadBold: return "\u{f419}"
        case .dialpadLight: return "\u{f41a}"
        case .dialpadRegular: return "\u{f41b}"
        case .directionalPadBold: return "\u{f41c}"
        case .directionalPadFilled: return "\u{f41d}"
        case .directionalPadLight: return "\u{f41e}"
        case .directionalPadRegular: return "\u{f41f}"
        case .directoryBold: return "\u{f420}"
        case .directoryLight: return "\u{f421}"
        case .directoryRegular: return "\u{f422}"
        case .disappearingPenBold: return "\u{f423}"
        case .disappearingPenLight: return "\u{f424}"
        case .disappearingPenRegular: return "\u{f425}"
        case .discBold: return "\u{f426}"
        case .discConnectedBold: return "\u{f427}"
        case .discConnectedLight: return "\u{f428}"
        case .discConnectedRegular: return "\u{f429}"
        case .discLight: return "\u{f42a}"
        case .discRegular: return "\u{f42b}"
        case .disconnectBold: return "\u{f42c}"
        case .disconnectFilled: return "\u{f42d}"
        case .disconnectLight: return "\u{f42e}"
        case .disconnectRegular: return "\u{f42f}"
        case .dislikeBold: return "\u{f430}"
        case .dislikeFilled: return "\u{f431}"
        case .dislikeLight: return "\u{f432}"
        case .dislikeRegular: return "\u{f433}"
        case .displayBold: return "\u{f434}"
        case .displayInputBold: return "\u{f435}"
        case .displayInputLight: return "\u{f436}"
        case .displayInputRegular: return "\u{f437}"
        case .displayLight: return "\u{f438}"
        case .displayRegular: return "\u{f439}"
        case .displayWarningBold: return "\u{f43a}"
        case .displayWarningLight: return "\u{f43b}"
        case .displayWarningRegular: return "\u{f43c}"
        case .distributeHorizontalBold: return "\u{f43d}"
        case .distributeHorizontalFilled: return "\u{f43e}"
        case .distributeHorizontalLight: return "\u{f43f}"
        case .distributeHorizontalRegular: return "\u{f440}"
        case .distributeVerticallyBold: return "\u{f441}"
        case .distributeVerticallyFilled: return "\u{f442}"
        case .distributeVerticallyLight: return "\u{f443}"
        case .distributeVerticallyRegular: return "\u{f444}"
        case .divideBold: return "\u{f445}"
        case .divideFilled: return "\u{f446}"
        case .divideLight: return "\u{f447}"
        case .divideRegular: return "\u{f448}"
        case .dndPresenceBadgeFilled: return "\u{f449}"
        case .dndPresenceBold: return "\u{f44a}"
        case .dndPresenceFilled: return "\u{f44b}"
        case .dndPresenceLight: return "\u{f44c}"
        case .dndPresenceRegular: return "\u{f44d}"
        case .dockWindowBold: return "\u{f44e}"
        case .dockWindowLight: return "\u{f44f}"
        case .dockWindowRegular: return "\u{f450}"
        case .documentBold: return "\u{f451}"
        case .documentCameraBold: return "\u{f452}"
        case .documentCameraDisconnectedBold: return "\u{f453}"
        case .documentCameraDisconnectedLight: return "\u{f454}"
        case .documentCameraDisconnectedRegular: return "\u{f455}"
        case .documentCameraLight: return "\u{f456}"
        case .documentCameraRegular: return "\u{f457}"
        case .documentCreateBold: return "\u{f458}"
        case .documentCreateFilled: return "\u{f459}"
        case .documentCreateLight: return "\u{f45a}"
        case .documentCreateRegular: return "\u{f45b}"
        case .documentFilled: return "\u{f45c}"
        case .documentLight: return "\u{f45d}"
        case .documentMoveBold: return "\u{f45e}"
        case .documentMoveFilled: return "\u{f45f}"
        case .documentMoveLight: return "\u{f460}"
        case .documentMoveRegular: return "\u{f461}"
        case .documentRegular: return "\u{f462}"
        case .documentShareBold: return "\u{f463}"
        case .documentShareFilled: return "\u{f464}"
        case .documentShareLight: return "\u{f465}"
        case .documentShareRegular: return "\u{f466}"
        case .doneAllBold: return "\u{f467}"
        case .doneAllLight: return "\u{f468}"
        case .doneAllRegular: return "\u{f469}"
        case .donutChartBold: return "\u{f46a}"
        case .donutChartFilled: return "\u{f46b}"
        case .donutChartLight: return "\u{f46c}"
        case .donutChartRegular: return "\u{f46d}"
        case .downloadBold: return "\u{f46e}"
        case .downloadFilled: return "\u{f46f}"
        case .downloadLight: return "\u{f470}"
        case .downloadRegular: return "\u{f471}"
        case .draftBold: return "\u{f472}"
        case .draftFilled: return "\u{f473}"
        case .draftIndicatorBold: return "\u{f474}"
        case .draftIndicatorSmallFilled: return "\u{f475}"
        case .draftLight: return "\u{f476}"
        case .draftRegular: return "\u{f477}"
        case .dragBold: return "\u{f478}"
        case .dragLight: return "\u{f479}"
        case .dragRegular: return "\u{f47a}"
        case .draggerHorizontalBold: return "\u{f47b}"
        case .draggerHorizontalLight: return "\u{f47c}"
        case .draggerHorizontalRegular: return "\u{f47d}"
        case .draggerVerticalBold: return "\u{f47e}"
        case .draggerVerticalLight: return "\u{f47f}"
        case .draggerVerticalRegular: return "\u{f480}"
        case .driveModeBold: return "\u{f481}"
        case .driveModeLight: return "\u{f482}"
        case .driveModeRegular: return "\u{f483}"
        case .dropdownBold: return "\u{f484}"
        case .dropdownLight: return "\u{f485}"
        case .dropdownRegular: return "\u{f486}"
        case .dxEightyBold: return "\u{f487}"
        case .dxEightyFilled: return "\u{f488}"
        case .dxEightyLight: return "\u{f489}"
        case .dxEightyRegular: return "\u{f48a}"
        case .dxSeventyBold: return "\u{f48b}"
        case .dxSeventyLight: return "\u{f48c}"
        case .dxSeventyRegular: return "\u{f48d}"
        case .editBold: return "\u{f48e}"
        case .editFilled: return "\u{f48f}"
        case .editLight: return "\u{f490}"
        case .editRegular: return "\u{f491}"
        case .editablePartialBold: return "\u{f492}"
        case .editablePartialLight: return "\u{f493}"
        case .editablePartialRegular: return "\u{f494}"
        case .educationBold: return "\u{f495}"
        case .educationFilled: return "\u{f496}"
        case .educationLight: return "\u{f497}"
        case .educationRegular: return "\u{f498}"
        case .emailBold: return "\u{f499}"
        case .emailDeliveredBold: return "\u{f49a}"
        case .emailDeliveredLight: return "\u{f49b}"
        case .emailDeliveredRegular: return "\u{f49c}"
        case .emailFailureBold: return "\u{f49d}"
        case .emailFailureLight: return "\u{f49e}"
        case .emailFailureRegular: return "\u{f49f}"
        case .emailFilled: return "\u{f4a0}"
        case .emailInviteBold: return "\u{f4a1}"
        case .emailInviteLight: return "\u{f4a2}"
        case .emailInviteRegular: return "\u{f4a3}"
        case .emailLight: return "\u{f4a4}"
        case .emailOutgoingBold: return "\u{f4a5}"
        case .emailOutgoingFilled: return "\u{f4a6}"
        case .emailOutgoingLight: return "\u{f4a7}"
        case .emailOutgoingRegular: return "\u{f4a8}"
        case .emailReadBold: return "\u{f4a9}"
        case .emailReadFilled: return "\u{f4aa}"
        case .emailReadLight: return "\u{f4ab}"
        case .emailReadRegular: return "\u{f4ac}"
        case .emailRegular: return "\u{f4ad}"
        case .emojiExcitedBold: return "\u{f4ae}"
        case .emojiExcitedFilled: return "\u{f4af}"
        case .emojiExcitedLight: return "\u{f4b0}"
        case .emojiExcitedRegular: return "\u{f4b1}"
        case .emojiHappyBold: return "\u{f4b2}"
        case .emojiHappyFilled: return "\u{f4b3}"
        case .emojiHappyLight: return "\u{f4b4}"
        case .emojiHappyRegular: return "\u{f4b5}"
        case .emojiPassiveBold: return "\u{f4b6}"
        case .emojiPassiveFilled: return "\u{f4b7}"
        case .emojiPassiveLight: return "\u{f4b8}"
        case .emojiPassiveRegular: return "\u{f4b9}"
        case .emojiSadBold: return "\u{f4ba}"
        case .emojiSadFilled: return "\u{f4bb}"
        case .emojiSadLight: return "\u{f4bc}"
        case .emojiSadRegular: return "\u{f4bd}"
        case .emojiUnhappyBold: return "\u{f4be}"
        case .emojiUnhappyFilled: return "\u{f4bf}"
        case .emojiUnhappyLight: return "\u{f4c0}"
        case .emojiUnhappyRegular: return "\u{f4c1}"
        case .encryptionCircleFilled: return "\u{f4c2}"
        case .encryptionFilled: return "\u{f4c3}"
        case .endRemoteDesktopControlBold: return "\u{f4c4}"
        case .endRemoteDesktopControlLight: return "\u{f4c5}"
        case .endRemoteDesktopControlRegular: return "\u{f4c6}"
        case .endToEndEncryptionCircleFilled: return "\u{f4c7}"
        case .endToEndEncryptionFilled: return "\u{f4c8}"
        case .endpointBlockedBold: return "\u{f4c9}"
        case .endpointBlockedLight: return "\u{f4ca}"
        case .endpointBlockedRegular: return "\u{f4cb}"
        case .endpointBold: return "\u{f4cc}"
        case .endpointGTwoBold: return "\u{f4cd}"
        case .endpointGTwoLight: return "\u{f4ce}"
        case .endpointGTwoRegular: return "\u{f4cf}"
        case .endpointGTwoSeventyBold: return "\u{f4d0}"
        case .endpointGTwoSeventyDualBold: return "\u{f4d1}"
        case .endpointGTwoSeventyDualLight: return "\u{f4d2}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4d3}"
        case .endpointGTwoSeventyLight: return "\u{f4d4}"
        case .endpointGTwoSeventyRegular: return "\u{f4d5}"
        case .endpointGTwoStandBold: return "\u{f4d6}"
        case .endpointGTwoStandLight: return "\u{f4d7}"
        case .endpointGTwoStandRegular: return "\u{f4d8}"
        case .endpointLight: return "\u{f4d9}"
        case .endpointMxEightHundredBold: return "\u{f4da}"
        case .endpointMxEightHundredDualBold: return "\u{f4db}"
        case .endpointMxEightHundredDualLight: return "\u{f4dc}"
        case .endpointMxEightHundredDualRegular: return "\u{f4dd}"
        case .endpointMxEightHundredLight: return "\u{f4de}"
        case .endpointMxEightHundredRegular: return "\u{f4df}"
        case .endpointRegular: return "\u{f4e0}"
        case .endpointStandBold: return "\u{f4e1}"
        case .endpointStandFilled: return "\u{f4e2}"
        case .endpointStandLight: return "\u{f4e3}"
        case .endpointStandRegular: return "\u{f4e4}"
        case .endpointWarningBold: return "\u{f4e5}"
        case .endpointWarningLight: return "\u{f4e6}"
        case .endpointWarningRegular: return "\u{f4e7}"
        case .enterBold: return "\u{f4e8}"
        case .enterLight: return "\u{f4e9}"
        case .enterRegular: return "\u{f4ea}"
        case .enterRoomBold: return "\u{f4eb}"
        case .enterRoomFilled: return "\u{f4ec}"
        case .enterRoomLight: return "\u{f4ed}"
        case .enterRoomRegular: return "\u{f4ee}"
        case .eraserBold: return "\u{f4ef}"
        case .eraserFilled: return "\u{f4f0}"
        case .eraserLight: return "\u{f4f1}"
        case .eraserRegular: return "\u{f4f2}"
        case .errorLegacyBadgeFilled: return "\u{f4f3}"
        case .errorLegacyBold: return "\u{f4f4}"
        case .errorLegacyFilled: return "\u{f4f5}"
        case .errorLegacyLight: return "\u{f4f6}"
        case .errorLegacyRegular: return "\u{f4f7}"
        case .ethernetBold: return "\u{f4f8}"
        case .ethernetFilled: return "\u{f4f9}"
        case .ethernetLight: return "\u{f4fa}"
        case .ethernetRegular: return "\u{f4fb}"
        case .exchangeBold: return "\u{f4fc}"
        case .exchangeLight: return "\u{f4fd}"
        case .exchangeRegular: return "\u{f4fe}"
        case .exclamationBold: return "\u{f4ff}"
        case .exclamationLight: return "\u{f500}"
        case .exclamationRegular: return "\u{f501}"
        case .excludeBold: return "\u{f502}"
        case .excludeLight: return "\u{f503}"
        case .excludeRegular: return "\u{f504}"
        case .existingTargetGroupBold: return "\u{f505}"
        case .existingTargetGroupLight: return "\u{f506}"
        case .existingTargetGroupRegular: return "\u{f507}"
        case .exitRoomBold: return "\u{f508}"
        case .exitRoomLight: return "\u{f509}"
        case .exitRoomRegular: return "\u{f50a}"
        case .exploreBold: return "\u{f50b}"
        case .exploreLight: return "\u{f50c}"
        case .exploreRegular: return "\u{f50d}"
        case .exportBold: return "\u{f50e}"
        case .exportLight: return "\u{f50f}"
        case .exportRegular: return "\u{f510}"
        case .extensionMobilityBold: return "\u{f511}"
        case .extensionMobilityLight: return "\u{f512}"
        case .extensionMobilityRegular: return "\u{f513}"
        case .externalMessageBold: return "\u{f514}"
        case .externalMessageLight: return "\u{f515}"
        case .externalMessageRegular: return "\u{f516}"
        case .externalUserBold: return "\u{f517}"
        case .externalUserLight: return "\u{f518}"
        case .externalUserRegular: return "\u{f519}"
        case .familyFontBold: return "\u{f51a}"
        case .familyFontLight: return "\u{f51b}"
        case .familyFontRegular: return "\u{f51c}"
        case .fastForwardBold: return "\u{f51d}"
        case .fastForwardLight: return "\u{f51e}"
        case .fastForwardRegular: return "\u{f51f}"
        case .favoriteBold: return "\u{f520}"
        case .favoriteFilled: return "\u{f521}"
        case .favoriteLight: return "\u{f522}"
        case .favoriteRegular: return "\u{f523}"
        case .favoritesBold: return "\u{f524}"
        case .favoritesFilled: return "\u{f525}"
        case .favoritesLight: return "\u{f526}"
        case .favoritesRegular: return "\u{f527}"
        case .fbwBold: return "\u{f528}"
        case .fbwFilled: return "\u{f529}"
        case .fbwLight: return "\u{f52a}"
        case .fbwRegular: return "\u{f52b}"
        case .ffwBold: return "\u{f52c}"
        case .ffwFilled: return "\u{f52d}"
        case .ffwLight: return "\u{f52e}"
        case .ffwRegular: return "\u{f52f}"
        case .fileAnalysisBold: return "\u{f530}"
        case .fileAnalysisFilled: return "\u{f531}"
        case .fileAnalysisLight: return "\u{f532}"
        case .fileAnalysisRegular: return "\u{f533}"
        case .fileAnnotationBold: return "\u{f534}"
        case .fileAnnotationFilled: return "\u{f535}"
        case .fileAnnotationLight: return "\u{f536}"
        case .fileAnnotationRegular: return "\u{f537}"
        case .fileAudioBold: return "\u{f538}"
        case .fileAudioFilled: return "\u{f539}"
        case .fileAudioLight: return "\u{f53a}"
        case .fileAudioRegular: return "\u{f53b}"
        case .fileBugBold: return "\u{f53c}"
        case .fileBugFilled: return "\u{f53d}"
        case .fileBugLight: return "\u{f53e}"
        case .fileBugRegular: return "\u{f53f}"
        case .fileCodeBold: return "\u{f540}"
        case .fileCodeFilled: return "\u{f541}"
        case .fileCodeLight: return "\u{f542}"
        case .fileCodeRegular: return "\u{f543}"
        case .fileDashboardBold: return "\u{f544}"
        case .fileDashboardFilled: return "\u{f545}"
        case .fileDashboardLight: return "\u{f546}"
        case .fileDashboardRegular: return "\u{f547}"
        case .fileExcelBold: return "\u{f548}"
        case .fileExcelFilled: return "\u{f549}"
        case .fileExcelLight: return "\u{f54a}"
        case .fileExcelRegular: return "\u{f54b}"
        case .fileGraphBold: return "\u{f54c}"
        case .fileGraphFilled: return "\u{f54d}"
        case .fileGraphLight: return "\u{f54e}"
        case .fileGraphRegular: return "\u{f54f}"
        case .fileImageBold: return "\u{f550}"
        case .fileImageFilled: return "\u{f551}"
        case .fileImageLight: return "\u{f552}"
        case .fileImageNoneBold: return "\u{f553}"
        case .fileImageNoneLight: return "\u{f554}"
        case .fileImageNoneRegular: return "\u{f555}"
        case .fileImageRegular: return "\u{f556}"
        case .fileJsBold: return "\u{f557}"
        case .fileJsFilled: return "\u{f558}"
        case .fileJsLight: return "\u{f559}"
        case .fileJsRegular: return "\u{f55a}"
        case .fileKeynoteBold: return "\u{f55b}"
        case .fileKeynoteFilled: return "\u{f55c}"
        case .fileKeynoteLight: return "\u{f55d}"
        case .fileKeynoteRegular: return "\u{f55e}"
        case .fileLockedBold: return "\u{f55f}"
        case .fileLockedFilled: return "\u{f560}"
        case .fileLockedLight: return "\u{f561}"
        case .fileLockedRegular: return "\u{f562}"
        case .fileMissingBold: return "\u{f563}"
        case .fileMissingFilled: return "\u{f564}"
        case .fileMissingLight: return "\u{f565}"
        case .fileMissingRegular: return "\u{f566}"
        case .fileMusicBold: return "\u{f567}"
        case .fileMusicFilled: return "\u{f568}"
        case .fileMusicLight: return "\u{f569}"
        case .fileMusicRegular: return "\u{f56a}"
        case .fileOnenoteBold: return "\u{f56b}"
        case .fileOnenoteFilled: return "\u{f56c}"
        case .fileOnenoteLight: return "\u{f56d}"
        case .fileOnenoteRegular: return "\u{f56e}"
        case .filePdfBold: return "\u{f56f}"
        case .filePdfFilled: return "\u{f570}"
        case .filePdfLight: return "\u{f571}"
        case .filePdfRegular: return "\u{f572}"
        case .filePowerpointBold: return "\u{f573}"
        case .filePowerpointFilled: return "\u{f574}"
        case .filePowerpointLight: return "\u{f575}"
        case .filePowerpointRegular: return "\u{f576}"
        case .fileSpreadsheetBold: return "\u{f577}"
        case .fileSpreadsheetFilled: return "\u{f578}"
        case .fileSpreadsheetLight: return "\u{f579}"
        case .fileSpreadsheetRegular: return "\u{f57a}"
        case .fileTextBold: return "\u{f57b}"
        case .fileTextFilled: return "\u{f57c}"
        case .fileTextLight: return "\u{f57d}"
        case .fileTextRegular: return "\u{f57e}"
        case .fileThreeDBold: return "\u{f57f}"
        case .fileThreeDFilled: return "\u{f580}"
        case .fileThreeDLight: return "\u{f581}"
        case .fileThreeDRegular: return "\u{f582}"
        case .fileVectorBold: return "\u{f583}"
        case .fileVectorFilled: return "\u{f584}"
        case .fileVectorLight: return "\u{f585}"
        case .fileVectorRegular: return "\u{f586}"
        case .fileVideoBold: return "\u{f587}"
        case .fileVideoFilled: return "\u{f588}"
        case .fileVideoLight: return "\u{f589}"
        case .fileVideoRegular: return "\u{f58a}"
        case .fileWordBold: return "\u{f58b}"
        case .fileWordFilled: return "\u{f58c}"
        case .fileWordLight: return "\u{f58d}"
        case .fileWordRegular: return "\u{f58e}"
        case .fileXmlBold: return "\u{f58f}"
        case .fileXmlFilled: return "\u{f590}"
        case .fileXmlLight: return "\u{f591}"
        case .fileXmlRegular: return "\u{f592}"
        case .fileZipBold: return "\u{f593}"
        case .fileZipFilled: return "\u{f594}"
        case .fileZipLight: return "\u{f595}"
        case .fileZipRegular: return "\u{f596}"
        case .filesBold: return "\u{f597}"
        case .filesFilled: return "\u{f598}"
        case .filesLight: return "\u{f599}"
        case .filesRegular: return "\u{f59a}"
        case .fillColourBold: return "\u{f59b}"
        case .fillColourFilled: return "\u{f59c}"
        case .fillColourLight: return "\u{f59d}"
        case .fillColourRegular: return "\u{f59e}"
        case .filterBold: return "\u{f59f}"
        case .filterCircleBold: return "\u{f5a0}"
        case .filterCircleFilled: return "\u{f5a1}"
        case .filterCircleLight: return "\u{f5a2}"
        case .filterCircleRegular: return "\u{f5a3}"
        case .filterLight: return "\u{f5a4}"
        case .filterRegular: return "\u{f5a5}"
        case .fitToWidthBold: return "\u{f5a6}"
        case .fitToWidthLight: return "\u{f5a7}"
        case .fitToWidthRegular: return "\u{f5a8}"
        case .fitToWindowExpandBold: return "\u{f5a9}"
        case .fitToWindowExpandLight: return "\u{f5aa}"
        case .fitToWindowExpandRegular: return "\u{f5ab}"
        case .fitToWindowShrinkBold: return "\u{f5ac}"
        case .fitToWindowShrinkLight: return "\u{f5ad}"
        case .fitToWindowShrinkRegular: return "\u{f5ae}"
        case .flagBold: return "\u{f5af}"
        case .flagCircleBold: return "\u{f5b0}"
        case .flagCircleFilled: return "\u{f5b1}"
        case .flagCircleLight: return "\u{f5b2}"
        case .flagCircleRegular: return "\u{f5b3}"
        case .flagFilled: return "\u{f5b4}"
        case .flagLight: return "\u{f5b5}"
        case .flagRegular: return "\u{f5b6}"
        case .folderBold: return "\u{f5b7}"
        case .folderEditBold: return "\u{f5b8}"
        case .folderEditLight: return "\u{f5b9}"
        case .folderEditRegular: return "\u{f5ba}"
        case .folderLight: return "\u{f5bb}"
        case .folderLockBold: return "\u{f5bc}"
        case .folderLockLight: return "\u{f5bd}"
        case .folderLockRegular: return "\u{f5be}"
        case .folderRegular: return "\u{f5bf}"
        case .folderViewBold: return "\u{f5c0}"
        case .folderViewLight: return "\u{f5c1}"
        case .folderViewRegular: return "\u{f5c2}"
        case .followUpBold: return "\u{f5c3}"
        case .followUpLight: return "\u{f5c4}"
        case .followUpRegular: return "\u{f5c5}"
        case .foodBold: return "\u{f5c6}"
        case .foodFilled: return "\u{f5c7}"
        case .foodLight: return "\u{f5c8}"
        case .foodRegular: return "\u{f5c9}"
        case .formatBold: return "\u{f5ca}"
        case .formatDefaultAppBold: return "\u{f5cb}"
        case .formatDefaultAppFilled: return "\u{f5cc}"
        case .formatDefaultAppLight: return "\u{f5cd}"
        case .formatDefaultAppRegular: return "\u{f5ce}"
        case .formatLight: return "\u{f5cf}"
        case .formatPanelControlBarBold: return "\u{f5d0}"
        case .formatPanelControlBarLight: return "\u{f5d1}"
        case .formatPanelControlBarRegular: return "\u{f5d2}"
        case .formatPanelControlDownBold: return "\u{f5d3}"
        case .formatPanelControlDownLight: return "\u{f5d4}"
        case .formatPanelControlDownRegular: return "\u{f5d5}"
        case .formatPanelControlLeftBold: return "\u{f5d6}"
        case .formatPanelControlLeftLight: return "\u{f5d7}"
        case .formatPanelControlLeftRegular: return "\u{f5d8}"
        case .formatPanelControlRightBold: return "\u{f5d9}"
        case .formatPanelControlRightLight: return "\u{f5da}"
        case .formatPanelControlRightRegular: return "\u{f5db}"
        case .formatPanelControlUpBold: return "\u{f5dc}"
        case .formatPanelControlUpDownBold: return "\u{f5dd}"
        case .formatPanelControlUpDownLight: return "\u{f5de}"
        case .formatPanelControlUpDownRegular: return "\u{f5df}"
        case .formatPanelControlUpLight: return "\u{f5e0}"
        case .formatPanelControlUpRegular: return "\u{f5e1}"
        case .formatRegular: return "\u{f5e2}"
        case .formatViewMixedBold: return "\u{f5e3}"
        case .formatViewMixedLight: return "\u{f5e4}"
        case .formatViewMixedRegular: return "\u{f5e5}"
        case .formulaBold: return "\u{f5e6}"
        case .formulaFilled: return "\u{f5e7}"
        case .formulaLight: return "\u{f5e8}"
        case .formulaRegular: return "\u{f5e9}"
        case .forwardMessageBold: return "\u{f5ea}"
        case .forwardMessageFilled: return "\u{f5eb}"
        case .forwardMessageLight: return "\u{f5ec}"
        case .forwardMessageRegular: return "\u{f5ed}"
        case .forwardTenSecBold: return "\u{f5ee}"
        case .forwardTenSecLight: return "\u{f5ef}"
        case .forwardTenSecRegular: return "\u{f5f0}"
        case .fourColumnBold: return "\u{f5f1}"
        case .fourColumnLight: return "\u{f5f2}"
        case .fourColumnRegular: return "\u{f5f3}"
        case .fourWayNavigationBold: return "\u{f5f4}"
        case .fourWayNavigationLight: return "\u{f5f5}"
        case .fourWayNavigationRegular: return "\u{f5f6}"
        case .frequencyCappingBold: return "\u{f5f7}"
        case .frequencyCappingLight: return "\u{f5f8}"
        case .frequencyCappingRegular: return "\u{f5f9}"
        case .fulfillmentBold: return "\u{f5fa}"
        case .fulfillmentLight: return "\u{f5fb}"
        case .fulfillmentRegular: return "\u{f5fc}"
        case .fullscreenBold: return "\u{f5fd}"
        case .fullscreenExitBold: return "\u{f5fe}"
        case .fullscreenExitLight: return "\u{f5ff}"
        case .fullscreenExitRegular: return "\u{f600}"
        case .fullscreenLight: return "\u{f601}"
        case .fullscreenRegular: return "\u{f602}"
        case .genericDeviceVideoBadgeFilled: return "\u{f603}"
        case .genericDeviceVideoBold: return "\u{f604}"
        case .genericDeviceVideoFilled: return "\u{f605}"
        case .genericDeviceVideoLight: return "\u{f606}"
        case .genericDeviceVideoRegular: return "\u{f607}"
        case .gifBold: return "\u{f608}"
        case .gifFilled: return "\u{f609}"
        case .gifHorizontalBold: return "\u{f60a}"
        case .gifHorizontalFilled: return "\u{f60b}"
        case .gifHorizontalLight: return "\u{f60c}"
        case .gifHorizontalRegular: return "\u{f60d}"
        case .gifLight: return "\u{f60e}"
        case .gifRegular: return "\u{f60f}"
        case .giftBold: return "\u{f610}"
        case .giftFilled: return "\u{f611}"
        case .giftLight: return "\u{f612}"
        case .giftRegular: return "\u{f613}"
        case .greenLeafBold: return "\u{f614}"
        case .greenLeafFilled: return "\u{f615}"
        case .greenLeafLight: return "\u{f616}"
        case .greenLeafRegular: return "\u{f617}"
        case .greenRoomBold: return "\u{f618}"
        case .greenRoomFilled: return "\u{f619}"
        case .greenRoomLight: return "\u{f61a}"
        case .greenRoomRegular: return "\u{f61b}"
        case .guestIssuerBold: return "\u{f61c}"
        case .guestIssuerLight: return "\u{f61d}"
        case .guestIssuerRegular: return "\u{f61e}"
        case .guideBold: return "\u{f61f}"
        case .guideLight: return "\u{f620}"
        case .guideRegular: return "\u{f621}"
        case .handPointerBold: return "\u{f622}"
        case .handPointerLight: return "\u{f623}"
        case .handPointerRegular: return "\u{f624}"
        case .handlerBold: return "\u{f625}"
        case .handlerHorizontalBold: return "\u{f626}"
        case .handlerHorizontalLight: return "\u{f627}"
        case .handlerHorizontalRegular: return "\u{f628}"
        case .handlerLight: return "\u{f629}"
        case .handlerRegular: return "\u{f62a}"
        case .handsetAlertBold: return "\u{f62b}"
        case .handsetAlertFilled: return "\u{f62c}"
        case .handsetAlertLight: return "\u{f62d}"
        case .handsetAlertRegular: return "\u{f62e}"
        case .handsetBold: return "\u{f62f}"
        case .handsetDownSlashBold: return "\u{f630}"
        case .handsetDownSlashFilled: return "\u{f631}"
        case .handsetDownSlashLight: return "\u{f632}"
        case .handsetDownSlashRegular: return "\u{f633}"
        case .handsetFilled: return "\u{f634}"
        case .handsetLight: return "\u{f635}"
        case .handsetMutedBold: return "\u{f636}"
        case .handsetMutedFilled: return "\u{f637}"
        case .handsetMutedLight: return "\u{f638}"
        case .handsetMutedRegular: return "\u{f639}"
        case .handsetRegular: return "\u{f63a}"
        case .handsetsArrowLeftBold: return "\u{f63b}"
        case .handsetsArrowLeftLight: return "\u{f63c}"
        case .handsetsArrowLeftRegular: return "\u{f63d}"
        case .handshakeBold: return "\u{f63e}"
        case .handshakeLight: return "\u{f63f}"
        case .handshakeRegular: return "\u{f640}"
        case .headingOneBold: return "\u{f641}"
        case .headingOneLight: return "\u{f642}"
        case .headingOneRegular: return "\u{f643}"
        case .headingThreeBold: return "\u{f644}"
        case .headingThreeLight: return "\u{f645}"
        case .headingThreeRegular: return "\u{f646}"
        case .headingTwoBold: return "\u{f647}"
        case .headingTwoLight: return "\u{f648}"
        case .headingTwoRegular: return "\u{f649}"
        case .headphonesBold: return "\u{f64a}"
        case .headphonesFilled: return "\u{f64b}"
        case .headphonesLight: return "\u{f64c}"
        case .headphonesMutedBold: return "\u{f64d}"
        case .headphonesMutedFilled: return "\u{f64e}"
        case .headphonesMutedLight: return "\u{f64f}"
        case .headphonesMutedRegular: return "\u{f650}"
        case .headphonesRegular: return "\u{f651}"
        case .headsetAlertBold: return "\u{f652}"
        case .headsetAlertLight: return "\u{f653}"
        case .headsetAlertRegular: return "\u{f654}"
        case .headsetArrowDownBold: return "\u{f655}"
        case .headsetArrowDownFilled: return "\u{f656}"
        case .headsetArrowDownLight: return "\u{f657}"
        case .headsetArrowDownRegular: return "\u{f658}"
        case .headsetBluetoothBold: return "\u{f659}"
        case .headsetBluetoothLight: return "\u{f65a}"
        case .headsetBluetoothRegular: return "\u{f65b}"
        case .headsetBold: return "\u{f65c}"
        case .headsetFilled: return "\u{f65d}"
        case .headsetLight: return "\u{f65e}"
        case .headsetMutedBold: return "\u{f65f}"
        case .headsetMutedLight: return "\u{f660}"
        case .headsetMutedRegular: return "\u{f661}"
        case .headsetPrivateBold: return "\u{f662}"
        case .headsetPrivateLight: return "\u{f663}"
        case .headsetPrivateRegular: return "\u{f664}"
        case .headsetRegular: return "\u{f665}"
        case .hearingBold: return "\u{f666}"
        case .hearingImpairedBold: return "\u{f667}"
        case .hearingImpairedLight: return "\u{f668}"
        case .hearingImpairedRegular: return "\u{f669}"
        case .hearingLight: return "\u{f66a}"
        case .hearingRegular: return "\u{f66b}"
        case .helpBold: return "\u{f66c}"
        case .helpCircleBold: return "\u{f66d}"
        case .helpCircleFilled: return "\u{f66e}"
        case .helpCircleLight: return "\u{f66f}"
        case .helpCircleRegular: return "\u{f670}"
        case .helpLight: return "\u{f671}"
        case .helpRegular: return "\u{f672}"
        case .helpdeskBold: return "\u{f673}"
        case .helpdeskFilled: return "\u{f674}"
        case .helpdeskLight: return "\u{f675}"
        case .helpdeskRegular: return "\u{f676}"
        case .hideBold: return "\u{f677}"
        case .hideFilled: return "\u{f678}"
        case .hideLight: return "\u{f679}"
        case .hideRegular: return "\u{f67a}"
        case .homeBold: return "\u{f67b}"
        case .homeFilled: return "\u{f67c}"
        case .homeLight: return "\u{f67d}"
        case .homeRegular: return "\u{f67e}"
        case .horizontalLineBold: return "\u{f67f}"
        case .horizontalLineLight: return "\u{f680}"
        case .horizontalLineRegular: return "\u{f681}"
        case .hotelingBold: return "\u{f682}"
        case .hotelingFilled: return "\u{f683}"
        case .hotelingLight: return "\u{f684}"
        case .hotelingRegular: return "\u{f685}"
        case .humidityBold: return "\u{f686}"
        case .humidityLight: return "\u{f687}"
        case .humidityRegular: return "\u{f688}"
        case .huntGroupBold: return "\u{f689}"
        case .huntGroupFilled: return "\u{f68a}"
        case .huntGroupLight: return "\u{f68b}"
        case .huntGroupRegular: return "\u{f68c}"
        case .idleBold: return "\u{f68d}"
        case .idleFilled: return "\u{f68e}"
        case .idleLight: return "\u{f68f}"
        case .idleRegular: return "\u{f690}"
        case .immediateBold: return "\u{f691}"
        case .immediateFilled: return "\u{f692}"
        case .immediateLight: return "\u{f693}"
        case .immediateRegular: return "\u{f694}"
        case .importBold: return "\u{f695}"
        case .importLight: return "\u{f696}"
        case .importRegular: return "\u{f697}"
        case .inCommonBold: return "\u{f698}"
        case .inCommonLight: return "\u{f699}"
        case .inCommonRegular: return "\u{f69a}"
        case .inboxBold: return "\u{f69b}"
        case .inboxFilled: return "\u{f69c}"
        case .inboxLight: return "\u{f69d}"
        case .inboxRegular: return "\u{f69e}"
        case .includeBold: return "\u{f69f}"
        case .includeLight: return "\u{f6a0}"
        case .includeRegular: return "\u{f6a1}"
        case .incognitoBold: return "\u{f6a2}"
        case .incognitoFilled: return "\u{f6a3}"
        case .incognitoLight: return "\u{f6a4}"
        case .incognitoRegular: return "\u{f6a5}"
        case .incomingCallLegacyBold: return "\u{f6a6}"
        case .incomingCallLegacyFilled: return "\u{f6a7}"
        case .incomingCallLegacyLight: return "\u{f6a8}"
        case .incomingCallLegacyRegular: return "\u{f6a9}"
        case .indentDecreaseBold: return "\u{f6aa}"
        case .indentDecreaseLight: return "\u{f6ab}"
        case .indentDecreaseRegular: return "\u{f6ac}"
        case .indentIncreaseBold: return "\u{f6ad}"
        case .indentIncreaseLight: return "\u{f6ae}"
        case .indentIncreaseRegular: return "\u{f6af}"
        case .infoBadgeFilled: return "\u{f6b0}"
        case .infoCircleBold: return "\u{f6b1}"
        case .infoCircleFilled: return "\u{f6b2}"
        case .infoCircleLight: return "\u{f6b3}"
        case .infoCircleRegular: return "\u{f6b4}"
        case .infoCircleTwoBold: return "\u{f6b5}"
        case .infoCircleTwoFilled: return "\u{f6b6}"
        case .infoCircleTwoLight: return "\u{f6b7}"
        case .infoCircleTwoRegular: return "\u{f6b8}"
        case .inputBold: return "\u{f6b9}"
        case .inputDisconnectedBold: return "\u{f6ba}"
        case .inputDisconnectedLight: return "\u{f6bb}"
        case .inputDisconnectedRegular: return "\u{f6bc}"
        case .inputLight: return "\u{f6bd}"
        case .inputRegular: return "\u{f6be}"
        case .instantScheduleBold: return "\u{f6bf}"
        case .instantScheduleFilled: return "\u{f6c0}"
        case .instantScheduleLight: return "\u{f6c1}"
        case .instantScheduleRegular: return "\u{f6c2}"
        case .integerBold: return "\u{f6c3}"
        case .integerFilled: return "\u{f6c4}"
        case .integerLight: return "\u{f6c5}"
        case .integerRegular: return "\u{f6c6}"
        case .integrationsBold: return "\u{f6c7}"
        case .integrationsLight: return "\u{f6c8}"
        case .integrationsRegular: return "\u{f6c9}"
        case .intelligentRoutingBold: return "\u{f6ca}"
        case .intelligentRoutingLight: return "\u{f6cb}"
        case .intelligentRoutingRegular: return "\u{f6cc}"
        case .interactionBold: return "\u{f6cd}"
        case .interactionFilled: return "\u{f6ce}"
        case .interactionLight: return "\u{f6cf}"
        case .interactionRegular: return "\u{f6d0}"
        case .invitedUserBold: return "\u{f6d1}"
        case .invitedUserLight: return "\u{f6d2}"
        case .invitedUserRegular: return "\u{f6d3}"
        case .italicBold: return "\u{f6d4}"
        case .italicFilled: return "\u{f6d5}"
        case .italicLight: return "\u{f6d6}"
        case .italicRegular: return "\u{f6d7}"
        case .joinAudioBold: return "\u{f6d8}"
        case .joinAudioFilled: return "\u{f6d9}"
        case .joinAudioLight: return "\u{f6da}"
        case .joinAudioRegular: return "\u{f6db}"
        case .keepInTouchBold: return "\u{f6dc}"
        case .keepInTouchFilled: return "\u{f6dd}"
        case .keepInTouchLight: return "\u{f6de}"
        case .keepInTouchRegular: return "\u{f6df}"
        case .keyboardBold: return "\u{f6e0}"
        case .keyboardCloseBold: return "\u{f6e1}"
        case .keyboardCloseLight: return "\u{f6e2}"
        case .keyboardCloseRegular: return "\u{f6e3}"
        case .keyboardLight: return "\u{f6e4}"
        case .keyboardRegular: return "\u{f6e5}"
        case .languageBold: return "\u{f6e6}"
        case .languageFilled: return "\u{f6e7}"
        case .languageLight: return "\u{f6e8}"
        case .languageRegular: return "\u{f6e9}"
        case .laptopBold: return "\u{f6ea}"
        case .laptopDisconnectedBold: return "\u{f6eb}"
        case .laptopDisconnectedLight: return "\u{f6ec}"
        case .laptopDisconnectedRegular: return "\u{f6ed}"
        case .laptopFilled: return "\u{f6ee}"
        case .laptopLight: return "\u{f6ef}"
        case .laptopRegular: return "\u{f6f0}"
        case .laserPointerBold: return "\u{f6f1}"
        case .laserPointerCursorBlackLight: return "\u{f6f2}"
        case .laserPointerCursorBlueLight: return "\u{f6f3}"
        case .laserPointerCursorGreenLight: return "\u{f6f4}"
        case .laserPointerCursorPurpleLight: return "\u{f6f5}"
        case .laserPointerCursorRedLight: return "\u{f6f6}"
        case .laserPointerCursorWhiteLight: return "\u{f6f7}"
        case .laserPointerCursorYellowLight: return "\u{f6f8}"
        case .laserPointerFilled: return "\u{f6f9}"
        case .laserPointerLight: return "\u{f6fa}"
        case .laserPointerRegular: return "\u{f6fb}"
        case .launchBold: return "\u{f6fc}"
        case .launchLight: return "\u{f6fd}"
        case .launchRegular: return "\u{f6fe}"
        case .layoutSideBySideVerticalBold: return "\u{f6ff}"
        case .layoutSideBySideVerticalFilled: return "\u{f700}"
        case .layoutSideBySideVerticalLight: return "\u{f701}"
        case .layoutSideBySideVerticalRegular: return "\u{f702}"
        case .leaveBreakoutSessionBold: return "\u{f703}"
        case .leaveBreakoutSessionLight: return "\u{f704}"
        case .leaveBreakoutSessionRegular: return "\u{f705}"
        case .leaveDeviceBold: return "\u{f706}"
        case .leaveDeviceLight: return "\u{f707}"
        case .leaveDeviceRegular: return "\u{f708}"
        case .likeBold: return "\u{f709}"
        case .likeFilled: return "\u{f70a}"
        case .likeLight: return "\u{f70b}"
        case .likeRegular: return "\u{f70c}"
        case .linkBold: return "\u{f70d}"
        case .linkLight: return "\u{f70e}"
        case .linkRegular: return "\u{f70f}"
        case .listBulletedBold: return "\u{f710}"
        case .listBulletedLight: return "\u{f711}"
        case .listBulletedRegular: return "\u{f712}"
        case .listMenuBold: return "\u{f713}"
        case .listMenuLight: return "\u{f714}"
        case .listMenuRegular: return "\u{f715}"
        case .listNumberedBold: return "\u{f716}"
        case .listNumberedLight: return "\u{f717}"
        case .listNumberedRegular: return "\u{f718}"
        case .liveBold: return "\u{f719}"
        case .liveFilled: return "\u{f71a}"
        case .liveLight: return "\u{f71b}"
        case .liveRegular: return "\u{f71c}"
        case .locationBold: return "\u{f71d}"
        case .locationFilled: return "\u{f71e}"
        case .locationLight: return "\u{f71f}"
        case .locationRegular: return "\u{f720}"
        case .longTextBoxBold: return "\u{f721}"
        case .longTextBoxLight: return "\u{f722}"
        case .longTextBoxRegular: return "\u{f723}"
        case .lowerHandBold: return "\u{f724}"
        case .lowerHandLight: return "\u{f725}"
        case .lowerHandRegular: return "\u{f726}"
        case .magicPenBold: return "\u{f727}"
        case .magicPenFilled: return "\u{f728}"
        case .magicPenLight: return "\u{f729}"
        case .magicPenRegular: return "\u{f72a}"
        case .markAsUnreadBold: return "\u{f72b}"
        case .markAsUnreadLight: return "\u{f72c}"
        case .markAsUnreadRegular: return "\u{f72d}"
        case .markdownBold: return "\u{f72e}"
        case .markdownFilled: return "\u{f72f}"
        case .markdownLight: return "\u{f730}"
        case .markdownRegular: return "\u{f731}"
        case .markerBold: return "\u{f732}"
        case .markerFilled: return "\u{f733}"
        case .markerLight: return "\u{f734}"
        case .markerRegular: return "\u{f735}"
        case .maximizeBold: return "\u{f736}"
        case .maximizeLight: return "\u{f737}"
        case .maximizeRegular: return "\u{f738}"
        case .mediaPlayerBold: return "\u{f739}"
        case .mediaPlayerLight: return "\u{f73a}"
        case .mediaPlayerRegular: return "\u{f73b}"
        case .mediaQualityGoodBold: return "\u{f73c}"
        case .mediaQualityGoodFilled: return "\u{f73d}"
        case .mediaQualityGoodLight: return "\u{f73e}"
        case .mediaQualityGoodRegular: return "\u{f73f}"
        case .mediaQualityPoorBold: return "\u{f740}"
        case .mediaQualityPoorColoredBold: return "\u{f741}"
        case .mediaQualityPoorFilled: return "\u{f742}"
        case .mediaQualityPoorLight: return "\u{f743}"
        case .mediaQualityPoorRegular: return "\u{f744}"
        case .mediaQualityUnstableBold: return "\u{f745}"
        case .mediaQualityUnstableColoredBold: return "\u{f746}"
        case .mediaQualityUnstableFilled: return "\u{f747}"
        case .mediaQualityUnstableLight: return "\u{f748}"
        case .mediaQualityUnstableRegular: return "\u{f749}"
        case .meetBold: return "\u{f74a}"
        case .meetEndBold: return "\u{f74b}"
        case .meetEndLight: return "\u{f74c}"
        case .meetEndRegular: return "\u{f74d}"
        case .meetFilled: return "\u{f74e}"
        case .meetLight: return "\u{f74f}"
        case .meetRegular: return "\u{f750}"
        case .meetingSummaryBold: return "\u{f751}"
        case .meetingSummaryFilled: return "\u{f752}"
        case .meetingSummaryLight: return "\u{f753}"
        case .meetingSummaryRegular: return "\u{f754}"
        case .meetingsBold: return "\u{f755}"
        case .meetingsFilled: return "\u{f756}"
        case .meetingsFocusMonthBold: return "\u{f757}"
        case .meetingsFocusMonthLight: return "\u{f758}"
        case .meetingsFocusMonthRegular: return "\u{f759}"
        case .meetingsFocusOneDayBold: return "\u{f75a}"
        case .meetingsFocusOneDayLight: return "\u{f75b}"
        case .meetingsFocusOneDayRegular: return "\u{f75c}"
        case .meetingsFocusThreeDayBold: return "\u{f75d}"
        case .meetingsFocusThreeDayLight: return "\u{f75e}"
        case .meetingsFocusThreeDayRegular: return "\u{f75f}"
        case .meetingsFocusUpcomingBold: return "\u{f760}"
        case .meetingsFocusUpcomingLight: return "\u{f761}"
        case .meetingsFocusUpcomingRegular: return "\u{f762}"
        case .meetingsLight: return "\u{f763}"
        case .meetingsPresenceBadgeFilled: return "\u{f764}"
        case .meetingsPresenceBold: return "\u{f765}"
        case .meetingsPresenceFilled: return "\u{f766}"
        case .meetingsPresenceLight: return "\u{f767}"
        case .meetingsPresenceRegular: return "\u{f768}"
        case .meetingsRegular: return "\u{f769}"
        case .meetingsTeamBold: return "\u{f76a}"
        case .meetingsTeamFilled: return "\u{f76b}"
        case .meetingsTeamLight: return "\u{f76c}"
        case .meetingsTeamNewBold: return "\u{f76d}"
        case .meetingsTeamNewLight: return "\u{f76e}"
        case .meetingsTeamNewRegular: return "\u{f76f}"
        case .meetingsTeamRegular: return "\u{f770}"
        case .mentionBold: return "\u{f771}"
        case .mentionLight: return "\u{f772}"
        case .mentionRegular: return "\u{f773}"
        case .messageQueingBold: return "\u{f774}"
        case .messageQueingLight: return "\u{f775}"
        case .messageQueingRegular: return "\u{f776}"
        case .microphoneBold: return "\u{f777}"
        case .microphoneFilled: return "\u{f778}"
        case .microphoneHardMutedBold: return "\u{f779}"
        case .microphoneHardMutedCircleFilled: return "\u{f77a}"
        case .microphoneHardMutedLight: return "\u{f77b}"
        case .microphoneHardMutedRegular: return "\u{f77c}"
        case .microphoneLight: return "\u{f77d}"
        case .microphoneMusicModeBold: return "\u{f77e}"
        case .microphoneMusicModeLight: return "\u{f77f}"
        case .microphoneMusicModeOnBold: return "\u{f780}"
        case .microphoneMusicModeOnLight: return "\u{f781}"
        case .microphoneMusicModeOnRegular: return "\u{f782}"
        case .microphoneMusicModeRegular: return "\u{f783}"
        case .microphoneMutedBold: return "\u{f784}"
        case .microphoneMutedCircleFilled: return "\u{f785}"
        case .microphoneMutedFilled: return "\u{f786}"
        case .microphoneMutedLight: return "\u{f787}"
        case .microphoneMutedRegular: return "\u{f788}"
        case .microphoneOnBold: return "\u{f789}"
        case .microphoneOnLight: return "\u{f78a}"
        case .microphoneOnRegular: return "\u{f78b}"
        case .microphoneOptAllBold: return "\u{f78c}"
        case .microphoneOptAllLight: return "\u{f78d}"
        case .microphoneOptAllMutedBold: return "\u{f78e}"
        case .microphoneOptAllMutedLight: return "\u{f78f}"
        case .microphoneOptAllMutedRegular: return "\u{f790}"
        case .microphoneOptAllOnBold: return "\u{f791}"
        case .microphoneOptAllOnLight: return "\u{f792}"
        case .microphoneOptAllOnRegular: return "\u{f793}"
        case .microphoneOptAllRegular: return "\u{f794}"
        case .microphoneOptMeBold: return "\u{f795}"
        case .microphoneOptMeLight: return "\u{f796}"
        case .microphoneOptMeMutedBold: return "\u{f797}"
        case .microphoneOptMeMutedLight: return "\u{f798}"
        case .microphoneOptMeMutedRegular: return "\u{f799}"
        case .microphoneOptMeOnBold: return "\u{f79a}"
        case .microphoneOptMeOnLight: return "\u{f79b}"
        case .microphoneOptMeOnRegular: return "\u{f79c}"
        case .microphoneOptMeRegular: return "\u{f79d}"
        case .microphoneRegular: return "\u{f79e}"
        case .mindMapBold: return "\u{f79f}"
        case .mindMapLight: return "\u{f7a0}"
        case .mindMapRegular: return "\u{f7a1}"
        case .minimizeBold: return "\u{f7a2}"
        case .minimizeLight: return "\u{f7a3}"
        case .minimizeRegular: return "\u{f7a4}"
        case .minusBold: return "\u{f7a5}"
        case .minusLight: return "\u{f7a6}"
        case .minusRegular: return "\u{f7a7}"
        case .mirrorBold: return "\u{f7a8}"
        case .mirrorFilled: return "\u{f7a9}"
        case .mirrorLight: return "\u{f7aa}"
        case .mirrorRegular: return "\u{f7ab}"
        case .mmsFilled: return "\u{f7ac}"
        case .moderatorBold: return "\u{f7ad}"
        case .moderatorLight: return "\u{f7ae}"
        case .moderatorRegular: return "\u{f7af}"
        case .monitoringBold: return "\u{f7b0}"
        case .monitoringLight: return "\u{f7b1}"
        case .monitoringRegular: return "\u{f7b2}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7b3}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7b4}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7b5}"
        case .moreAdrBold: return "\u{f7b6}"
        case .moreAdrLight: return "\u{f7b7}"
        case .moreAdrRegular: return "\u{f7b8}"
        case .moreBold: return "\u{f7b9}"
        case .moreCircleBold: return "\u{f7ba}"
        case .moreCircleFilled: return "\u{f7bb}"
        case .moreCircleLight: return "\u{f7bc}"
        case .moreCircleRegular: return "\u{f7bd}"
        case .moreLight: return "\u{f7be}"
        case .moreRegular: return "\u{f7bf}"
        case .mouseCursorBold: return "\u{f7c0}"
        case .mouseCursorLight: return "\u{f7c1}"
        case .mouseCursorRegular: return "\u{f7c2}"
        case .moveCallInAdrBold: return "\u{f7c3}"
        case .moveCallInAdrLight: return "\u{f7c4}"
        case .moveCallInAdrRegular: return "\u{f7c5}"
        case .moveCallInIphBold: return "\u{f7c6}"
        case .moveCallInIphLight: return "\u{f7c7}"
        case .moveCallInIphRegular: return "\u{f7c8}"
        case .moveCallInLaptopBold: return "\u{f7c9}"
        case .moveCallInLaptopLight: return "\u{f7ca}"
        case .moveCallInLaptopRegular: return "\u{f7cb}"
        case .moveCallInOutAdrBold: return "\u{f7cc}"
        case .moveCallInOutAdrLight: return "\u{f7cd}"
        case .moveCallInOutAdrRegular: return "\u{f7ce}"
        case .moveCallInOutIphBold: return "\u{f7cf}"
        case .moveCallInOutIphLight: return "\u{f7d0}"
        case .moveCallInOutIphRegular: return "\u{f7d1}"
        case .moveCallInTabletBold: return "\u{f7d2}"
        case .moveCallInTabletLight: return "\u{f7d3}"
        case .moveCallInTabletRegular: return "\u{f7d4}"
        case .moveCallOutAdrBold: return "\u{f7d5}"
        case .moveCallOutAdrLight: return "\u{f7d6}"
        case .moveCallOutAdrRegular: return "\u{f7d7}"
        case .moveCallOutIphBold: return "\u{f7d8}"
        case .moveCallOutIphLight: return "\u{f7d9}"
        case .moveCallOutIphRegular: return "\u{f7da}"
        case .moveCallOutLaptopBold: return "\u{f7db}"
        case .moveCallOutLaptopLight: return "\u{f7dc}"
        case .moveCallOutLaptopRegular: return "\u{f7dd}"
        case .moveCallOutTabletBold: return "\u{f7de}"
        case .moveCallOutTabletLight: return "\u{f7df}"
        case .moveCallOutTabletRegular: return "\u{f7e0}"
        case .moveToScreenBold: return "\u{f7e1}"
        case .moveToScreenLight: return "\u{f7e2}"
        case .moveToScreenRegular: return "\u{f7e3}"
        case .multilineChartBold: return "\u{f7e4}"
        case .multilineChartFilled: return "\u{f7e5}"
        case .multilineChartLight: return "\u{f7e6}"
        case .multilineChartRegular: return "\u{f7e7}"
        case .multimediaBold: return "\u{f7e8}"
        case .multimediaFilled: return "\u{f7e9}"
        case .multimediaLight: return "\u{f7ea}"
        case .multimediaRegular: return "\u{f7eb}"
        case .multipledDevicesBold: return "\u{f7ec}"
        case .multipledDevicesLight: return "\u{f7ed}"
        case .multipledDevicesRegular: return "\u{f7ee}"
        case .musicModeCircleBold: return "\u{f7ef}"
        case .musicModeCircleFilled: return "\u{f7f0}"
        case .musicModeCircleLight: return "\u{f7f1}"
        case .musicModeCircleRegular: return "\u{f7f2}"
        case .musicNoteBold: return "\u{f7f3}"
        case .musicNoteFilled: return "\u{f7f4}"
        case .musicNoteLight: return "\u{f7f5}"
        case .musicNoteRegular: return "\u{f7f6}"
        case .muteOnEntryBold: return "\u{f7f7}"
        case .muteOnEntryFilled: return "\u{f7f8}"
        case .muteOnEntryLight: return "\u{f7f9}"
        case .muteOnEntryRegular: return "\u{f7fa}"
        case .newManagerBold: return "\u{f7fb}"
        case .newManagerLight: return "\u{f7fc}"
        case .newManagerRegular: return "\u{f7fd}"
        case .newTitleBold: return "\u{f7fe}"
        case .newTitleLight: return "\u{f7ff}"
        case .newTitleRegular: return "\u{f800}"
        case .newVoicemailBold: return "\u{f801}"
        case .newVoicemailLight: return "\u{f802}"
        case .newVoicemailRegular: return "\u{f803}"
        case .newWhiteboardBold: return "\u{f804}"
        case .newWhiteboardLight: return "\u{f805}"
        case .newWhiteboardRegular: return "\u{f806}"
        case .nextBold: return "\u{f807}"
        case .nextLight: return "\u{f808}"
        case .nextRegular: return "\u{f809}"
        case .noDevicesBold: return "\u{f80a}"
        case .noDevicesLight: return "\u{f80b}"
        case .noDevicesRegular: return "\u{f80c}"
        case .noiseDetectedCanceledFilled: return "\u{f80d}"
        case .noiseDetectedFilled: return "\u{f80e}"
        case .noiseNoneCanceledFilled: return "\u{f80f}"
        case .noiseNoneFilled: return "\u{f810}"
        case .noiseRemovalBold: return "\u{f811}"
        case .noiseRemovalLight: return "\u{f812}"
        case .noiseRemovalRegular: return "\u{f813}"
        case .noteBold: return "\u{f814}"
        case .noteLight: return "\u{f815}"
        case .notePptBold: return "\u{f816}"
        case .notePptLight: return "\u{f817}"
        case .notePptRegular: return "\u{f818}"
        case .noteRegular: return "\u{f819}"
        case .notesBold: return "\u{f81a}"
        case .notesFilled: return "\u{f81b}"
        case .notesLight: return "\u{f81c}"
        case .notesRegular: return "\u{f81d}"
        case .numberBold: return "\u{f81e}"
        case .numberLight: return "\u{f81f}"
        case .numberRegular: return "\u{f820}"
        case .oldRemoteBold: return "\u{f821}"
        case .oldRemoteLight: return "\u{f822}"
        case .oldRemoteRegular: return "\u{f823}"
        case .oldTouchBold: return "\u{f824}"
        case .oldTouchLight: return "\u{f825}"
        case .oldTouchRegular: return "\u{f826}"
        case .oneColumnBold: return "\u{f827}"
        case .oneColumnLight: return "\u{f828}"
        case .oneColumnRegular: return "\u{f829}"
        case .oneTimeBold: return "\u{f82a}"
        case .oneTimeLight: return "\u{f82b}"
        case .oneTimeRegular: return "\u{f82c}"
        case .openInFolderBold: return "\u{f82d}"
        case .openInFolderLight: return "\u{f82e}"
        case .openInFolderRegular: return "\u{f82f}"
        case .openPagesBold: return "\u{f830}"
        case .openPagesLight: return "\u{f831}"
        case .openPagesRegular: return "\u{f832}"
        case .otherNumberBold: return "\u{f833}"
        case .otherNumberFilled: return "\u{f834}"
        case .otherNumberLight: return "\u{f835}"
        case .otherNumberRegular: return "\u{f836}"
        case .otherNumberWarningBold: return "\u{f837}"
        case .otherNumberWarningLight: return "\u{f838}"
        case .otherNumberWarningRegular: return "\u{f839}"
        case .outgoingCallLegacyBold: return "\u{f83a}"
        case .outgoingCallLegacyFilled: return "\u{f83b}"
        case .outgoingCallLegacyLight: return "\u{f83c}"
        case .outgoingCallLegacyRegular: return "\u{f83d}"
        case .overflowLeftBold: return "\u{f83e}"
        case .overflowLeftLight: return "\u{f83f}"
        case .overflowLeftRegular: return "\u{f840}"
        case .overflowRightBold: return "\u{f841}"
        case .overflowRightLight: return "\u{f842}"
        case .overflowRightRegular: return "\u{f843}"
        case .pairedCameraBold: return "\u{f844}"
        case .pairedCameraLight: return "\u{f845}"
        case .pairedCameraRegular: return "\u{f846}"
        case .pairedDeviceBold: return "\u{f847}"
        case .pairedDeviceLight: return "\u{f848}"
        case .pairedDeviceRegular: return "\u{f849}"
        case .pairedHandsetBold: return "\u{f84a}"
        case .pairedHandsetLight: return "\u{f84b}"
        case .pairedHandsetRegular: return "\u{f84c}"
        case .pairingBold: return "\u{f84d}"
        case .pairingLight: return "\u{f84e}"
        case .pairingRegular: return "\u{f84f}"
        case .parenthesisBold: return "\u{f850}"
        case .parenthesisFilled: return "\u{f851}"
        case .parenthesisLight: return "\u{f852}"
        case .parenthesisRegular: return "\u{f853}"
        case .parkedBold: return "\u{f854}"
        case .parkedFilled: return "\u{f855}"
        case .parkedLight: return "\u{f856}"
        case .parkedRegular: return "\u{f857}"
        case .parseBold: return "\u{f858}"
        case .parseLight: return "\u{f859}"
        case .parseRegular: return "\u{f85a}"
        case .partialBold: return "\u{f85b}"
        case .partialLight: return "\u{f85c}"
        case .partialRegular: return "\u{f85d}"
        case .participantAddBold: return "\u{f85e}"
        case .participantAddLight: return "\u{f85f}"
        case .participantAddRegular: return "\u{f860}"
        case .participantBlockedBold: return "\u{f861}"
        case .participantBlockedLight: return "\u{f862}"
        case .participantBlockedRegular: return "\u{f863}"
        case .participantBold: return "\u{f864}"
        case .participantFilled: return "\u{f865}"
        case .participantLight: return "\u{f866}"
        case .participantListBold: return "\u{f867}"
        case .participantListFilled: return "\u{f868}"
        case .participantListLight: return "\u{f869}"
        case .participantListRegular: return "\u{f86a}"
        case .participantRegular: return "\u{f86b}"
        case .participantRemoveBold: return "\u{f86c}"
        case .participantRemoveLight: return "\u{f86d}"
        case .participantRemoveRegular: return "\u{f86e}"
        case .participantUnknownBold: return "\u{f86f}"
        case .participantUnknownLight: return "\u{f870}"
        case .participantUnknownRegular: return "\u{f871}"
        case .passMouseBold: return "\u{f872}"
        case .passMouseLight: return "\u{f873}"
        case .passMouseRegular: return "\u{f874}"
        case .pauseBadgeFilled: return "\u{f875}"
        case .pauseBold: return "\u{f876}"
        case .pauseFilled: return "\u{f877}"
        case .pauseLight: return "\u{f878}"
        case .pauseRegular: return "\u{f879}"
        case .peopleAddBold: return "\u{f87a}"
        case .peopleAddFilled: return "\u{f87b}"
        case .peopleAddLight: return "\u{f87c}"
        case .peopleAddRegular: return "\u{f87d}"
        case .peopleBold: return "\u{f87e}"
        case .peopleCircleBold: return "\u{f87f}"
        case .peopleCircleFilled: return "\u{f880}"
        case .peopleCircleLight: return "\u{f881}"
        case .peopleCircleRegular: return "\u{f882}"
        case .peopleFilled: return "\u{f883}"
        case .peopleInsightsBold: return "\u{f884}"
        case .peopleInsightsFilled: return "\u{f885}"
        case .peopleInsightsLight: return "\u{f886}"
        case .peopleInsightsRegular: return "\u{f887}"
        case .peopleLight: return "\u{f888}"
        case .peopleManageBold: return "\u{f889}"
        case .peopleManageFilled: return "\u{f88a}"
        case .peopleManageLight: return "\u{f88b}"
        case .peopleManageRegular: return "\u{f88c}"
        case .peopleRegular: return "\u{f88d}"
        case .phoneAlertBold: return "\u{f88e}"
        case .phoneAlertLight: return "\u{f88f}"
        case .phoneAlertRegular: return "\u{f890}"
        case .phoneBadgeFilled: return "\u{f891}"
        case .phoneBold: return "\u{f892}"
        case .phoneFilled: return "\u{f893}"
        case .phoneLight: return "\u{f894}"
        case .phoneMutedBold: return "\u{f895}"
        case .phoneMutedLight: return "\u{f896}"
        case .phoneMutedRegular: return "\u{f897}"
        case .phonePrivateBold: return "\u{f898}"
        case .phonePrivateLight: return "\u{f899}"
        case .phonePrivateRegular: return "\u{f89a}"
        case .phoneRegular: return "\u{f89b}"
        case .phoneReplyAllBold: return "\u{f89c}"
        case .phoneReplyAllLight: return "\u{f89d}"
        case .phoneReplyAllRegular: return "\u{f89e}"
        case .phoneReplyBold: return "\u{f89f}"
        case .phoneReplyLight: return "\u{f8a0}"
        case .phoneReplyRegular: return "\u{f8a1}"
        case .pickerBold: return "\u{f8a2}"
        case .pickerLight: return "\u{f8a3}"
        case .pickerRegular: return "\u{f8a4}"
        case .pieChartBold: return "\u{f8a5}"
        case .pieChartFilled: return "\u{f8a6}"
        case .pieChartLight: return "\u{f8a7}"
        case .pieChartRegular: return "\u{f8a8}"
        case .pinBold: return "\u{f8a9}"
        case .pinFilled: return "\u{f8aa}"
        case .pinLight: return "\u{f8ab}"
        case .pinListActivityBold: return "\u{f8ac}"
        case .pinListActivityLight: return "\u{f8ad}"
        case .pinListActivityRegular: return "\u{f8ae}"
        case .pinListBold: return "\u{f8af}"
        case .pinListLight: return "\u{f8b0}"
        case .pinListRegular: return "\u{f8b1}"
        case .pinMutedBold: return "\u{f8b2}"
        case .pinMutedFilled: return "\u{f8b3}"
        case .pinMutedLight: return "\u{f8b4}"
        case .pinMutedRegular: return "\u{f8b5}"
        case .pinRegular: return "\u{f8b6}"
        case .pipBold: return "\u{f8b7}"
        case .pipEnterBold: return "\u{f8b8}"
        case .pipEnterLight: return "\u{f8b9}"
        case .pipEnterRegular: return "\u{f8ba}"
        case .pipExitBold: return "\u{f8bb}"
        case .pipExitLight: return "\u{f8bc}"
        case .pipExitRegular: return "\u{f8bd}"
        case .pipFilled: return "\u{f8be}"
        case .pipLight: return "\u{f8bf}"
        case .pipRegular: return "\u{f8c0}"
        case .placeholderBold: return "\u{f8c1}"
        case .placeholderFilled: return "\u{f8c2}"
        case .placeholderLight: return "\u{f8c3}"
        case .placeholderRegular: return "\u{f8c4}"
        case .playBold: return "\u{f8c5}"
        case .playCircleBold: return "\u{f8c6}"
        case .playCircleFilled: return "\u{f8c7}"
        case .playCircleLight: return "\u{f8c8}"
        case .playCircleRegular: return "\u{f8c9}"
        case .playFilled: return "\u{f8ca}"
        case .playLight: return "\u{f8cb}"
        case .playRegular: return "\u{f8cc}"
        case .plugAcBold: return "\u{f8cd}"
        case .plugAcLight: return "\u{f8ce}"
        case .plugAcRegular: return "\u{f8cf}"
        case .plusBold: return "\u{f8d0}"
        case .plusCircleBold: return "\u{f8d1}"
        case .plusCircleFilled: return "\u{f8d2}"
        case .plusCircleLight: return "\u{f8d3}"
        case .plusCircleRegular: return "\u{f8d4}"
        case .plusLight: return "\u{f8d5}"
        case .plusRegular: return "\u{f8d6}"
        case .pmrBold: return "\u{f8d7}"
        case .pmrFilled: return "\u{f8d8}"
        case .pmrLight: return "\u{f8d9}"
        case .pmrRegular: return "\u{f8da}"
        case .pollBold: return "\u{f8db}"
        case .pollFilled: return "\u{f8dc}"
        case .pollLight: return "\u{f8dd}"
        case .pollRegular: return "\u{f8de}"
        case .popInBold: return "\u{f8df}"
        case .popInLight: return "\u{f8e0}"
        case .popInRegular: return "\u{f8e1}"
        case .popOutBold: return "\u{f8e2}"
        case .popOutLight: return "\u{f8e3}"
        case .popOutRegular: return "\u{f8e4}"
        case .popUpBold: return "\u{f8e5}"
        case .popUpLight: return "\u{f8e6}"
        case .popUpRegular: return "\u{f8e7}"
        case .portraitLandscapeBold: return "\u{f8e8}"
        case .portraitLandscapeLight: return "\u{f8e9}"
        case .portraitLandscapeRegular: return "\u{f8ea}"
        case .potentialFraudBold: return "\u{f8eb}"
        case .potentialFraudFilled: return "\u{f8ec}"
        case .potentialFraudLight: return "\u{f8ed}"
        case .potentialFraudRegular: return "\u{f8ee}"
        case .powerAcBold: return "\u{f8ef}"
        case .powerAcLight: return "\u{f8f0}"
        case .powerAcRegular: return "\u{f8f1}"
        case .powerBold: return "\u{f8f2}"
        case .powerLight: return "\u{f8f3}"
        case .powerRegular: return "\u{f8f4}"
        case .preHeaderBold: return "\u{f8f5}"
        case .preHeaderLight: return "\u{f8f6}"
        case .preHeaderRegular: return "\u{f8f7}"
        case .premiumBold: return "\u{f8f8}"
        case .premiumLight: return "\u{f8f9}"
        case .premiumRegular: return "\u{f8fa}"
        case .presentationBold: return "\u{f8fb}"
        case .presentationLight: return "\u{f8fc}"
        case .presentationRegular: return "\u{f8fd}"
        case .preventDownloadBold: return "\u{f8fe}"
        case .preventDownloadFilled: return "\u{f8ff}"
        case .preventDownloadLight: return "\u{f900}"
        case .preventDownloadRegular: return "\u{f901}"
        case .primaryParticipantBold: return "\u{f902}"
        case .primaryParticipantFilled: return "\u{f903}"
        case .primaryParticipantLight: return "\u{f904}"
        case .primaryParticipantRegular: return "\u{f905}"
        case .printBold: return "\u{f906}"
        case .printLight: return "\u{f907}"
        case .printRegular: return "\u{f908}"
        case .priorityBadgeFilled: return "\u{f909}"
        case .priorityCircleBold: return "\u{f90a}"
        case .priorityCircleFilled: return "\u{f90b}"
        case .priorityCircleLight: return "\u{f90c}"
        case .priorityCircleRegular: return "\u{f90d}"
        case .priorityCircleTwoBold: return "\u{f90e}"
        case .priorityCircleTwoFilled: return "\u{f90f}"
        case .priorityCircleTwoLight: return "\u{f910}"
        case .priorityCircleTwoRegular: return "\u{f911}"
        case .priorityWaveBold: return "\u{f912}"
        case .priorityWaveLight: return "\u{f913}"
        case .priorityWaveRegular: return "\u{f914}"
        case .privacyCircleBold: return "\u{f915}"
        case .privacyCircleFilled: return "\u{f916}"
        case .privacyCircleLight: return "\u{f917}"
        case .privacyCircleRegular: return "\u{f918}"
        case .privateBold: return "\u{f919}"
        case .privateCircleBold: return "\u{f91a}"
        case .privateCircleFilled: return "\u{f91b}"
        case .privateCircleLight: return "\u{f91c}"
        case .privateCircleRegular: return "\u{f91d}"
        case .privateLight: return "\u{f91e}"
        case .privateMeetingBold: return "\u{f91f}"
        case .privateMeetingLight: return "\u{f920}"
        case .privateMeetingRegular: return "\u{f921}"
        case .privateRegular: return "\u{f922}"
        case .productDemoBold: return "\u{f923}"
        case .productDemoLight: return "\u{f924}"
        case .productDemoRegular: return "\u{f925}"
        case .promptsAiBold: return "\u{f926}"
        case .promptsAiLight: return "\u{f927}"
        case .promptsAiRegular: return "\u{f928}"
        case .proximityBold: return "\u{f929}"
        case .proximityLight: return "\u{f92a}"
        case .proximityMutedBold: return "\u{f92b}"
        case .proximityMutedLight: return "\u{f92c}"
        case .proximityMutedRegular: return "\u{f92d}"
        case .proximityRegular: return "\u{f92e}"
        case .proximityVideoBold: return "\u{f92f}"
        case .proximityVideoLight: return "\u{f930}"
        case .proximityVideoRegular: return "\u{f931}"
        case .ptoPresenceBold: return "\u{f932}"
        case .ptoPresenceFilled: return "\u{f933}"
        case .ptoPresenceLight: return "\u{f934}"
        case .ptoPresenceRegular: return "\u{f935}"
        case .pullCallBold: return "\u{f936}"
        case .pullCallFilled: return "\u{f937}"
        case .pullCallLight: return "\u{f938}"
        case .pullCallRegular: return "\u{f939}"
        case .qABold: return "\u{f93a}"
        case .qAFilled: return "\u{f93b}"
        case .qALight: return "\u{f93c}"
        case .qARegular: return "\u{f93d}"
        case .qrCodeBold: return "\u{f93e}"
        case .qrCodeLight: return "\u{f93f}"
        case .qrCodeRegular: return "\u{f940}"
        case .qrCodeScanBold: return "\u{f941}"
        case .qrCodeScanLight: return "\u{f942}"
        case .qrCodeScanRegular: return "\u{f943}"
        case .qualityBold: return "\u{f944}"
        case .qualityLight: return "\u{f945}"
        case .qualityRegular: return "\u{f946}"
        case .queueContactBold: return "\u{f947}"
        case .queueContactFilled: return "\u{f948}"
        case .queueContactLight: return "\u{f949}"
        case .queueContactRegular: return "\u{f94a}"
        case .quietBold: return "\u{f94b}"
        case .quietHoursPresenceBold: return "\u{f94c}"
        case .quietHoursPresenceFilled: return "\u{f94d}"
        case .quietHoursPresenceLight: return "\u{f94e}"
        case .quietHoursPresenceRegular: return "\u{f94f}"
        case .quietLight: return "\u{f950}"
        case .quietRegular: return "\u{f951}"
        case .radioButtonGroupBold: return "\u{f952}"
        case .radioButtonGroupLight: return "\u{f953}"
        case .radioButtonGroupRegular: return "\u{f954}"
        case .raiseHandBold: return "\u{f955}"
        case .raiseHandCircleFilled: return "\u{f956}"
        case .raiseHandFilled: return "\u{f957}"
        case .raiseHandLight: return "\u{f958}"
        case .raiseHandRegular: return "\u{f959}"
        case .ramBold: return "\u{f95a}"
        case .ramLight: return "\u{f95b}"
        case .ramRegular: return "\u{f95c}"
        case .reactionsBold: return "\u{f95d}"
        case .reactionsFilled: return "\u{f95e}"
        case .reactionsLight: return "\u{f95f}"
        case .reactionsRegular: return "\u{f960}"
        case .reactivateBold: return "\u{f961}"
        case .reactivateLight: return "\u{f962}"
        case .reactivateRegular: return "\u{f963}"
        case .receiveVoiceBold: return "\u{f964}"
        case .receiveVoiceFilled: return "\u{f965}"
        case .receiveVoiceLight: return "\u{f966}"
        case .receiveVoiceRegular: return "\u{f967}"
        case .recentsBold: return "\u{f968}"
        case .recentsFilled: return "\u{f969}"
        case .recentsLight: return "\u{f96a}"
        case .recentsPresenceBadgeFilled: return "\u{f96b}"
        case .recentsPresenceBold: return "\u{f96c}"
        case .recentsPresenceFilled: return "\u{f96d}"
        case .recentsPresenceLight: return "\u{f96e}"
        case .recentsPresenceRegular: return "\u{f96f}"
        case .recentsRegular: return "\u{f970}"
        case .recordActiveBadgeFilled: return "\u{f971}"
        case .recordActiveBold: return "\u{f972}"
        case .recordActiveFilled: return "\u{f973}"
        case .recordActiveLight: return "\u{f974}"
        case .recordActiveRegular: return "\u{f975}"
        case .recordBold: return "\u{f976}"
        case .recordFilled: return "\u{f977}"
        case .recordLight: return "\u{f978}"
        case .recordPausedBadgeFilled: return "\u{f979}"
        case .recordPausedBold: return "\u{f97a}"
        case .recordPausedFilled: return "\u{f97b}"
        case .recordPausedLight: return "\u{f97c}"
        case .recordPausedRegular: return "\u{f97d}"
        case .recordRegular: return "\u{f97e}"
        case .recurringBold: return "\u{f97f}"
        case .recurringLight: return "\u{f980}"
        case .recurringOffBold: return "\u{f981}"
        case .recurringOffLight: return "\u{f982}"
        case .recurringOffRegular: return "\u{f983}"
        case .recurringRegular: return "\u{f984}"
        case .redoBold: return "\u{f985}"
        case .redoLight: return "\u{f986}"
        case .redoRegular: return "\u{f987}"
        case .refreshBold: return "\u{f988}"
        case .refreshLight: return "\u{f989}"
        case .refreshRegular: return "\u{f98a}"
        case .remoteDesktopControlBold: return "\u{f98b}"
        case .remoteDesktopControlFilled: return "\u{f98c}"
        case .remoteDesktopControlLight: return "\u{f98d}"
        case .remoteDesktopControlRegular: return "\u{f98e}"
        case .removeBold: return "\u{f98f}"
        case .removeFilled: return "\u{f990}"
        case .removeLight: return "\u{f991}"
        case .removeRegular: return "\u{f992}"
        case .replyBold: return "\u{f993}"
        case .replyFilled: return "\u{f994}"
        case .replyLight: return "\u{f995}"
        case .replyListBold: return "\u{f996}"
        case .replyListLight: return "\u{f997}"
        case .replyListRegular: return "\u{f998}"
        case .replyPrivatelyBold: return "\u{f999}"
        case .replyPrivatelyLight: return "\u{f99a}"
        case .replyPrivatelyRegular: return "\u{f99b}"
        case .replyRegular: return "\u{f99c}"
        case .resetBold: return "\u{f99d}"
        case .resetLight: return "\u{f99e}"
        case .resetRegular: return "\u{f99f}"
        case .resizeCornerBold: return "\u{f9a0}"
        case .resizeCornerLight: return "\u{f9a1}"
        case .resizeCornerRegular: return "\u{f9a2}"
        case .responsiveMobileBold: return "\u{f9a3}"
        case .responsiveMobileLight: return "\u{f9a4}"
        case .responsiveMobileRegular: return "\u{f9a5}"
        case .restartBold: return "\u{f9a6}"
        case .restartLight: return "\u{f9a7}"
        case .restartRegular: return "\u{f9a8}"
        case .retrieveCallBold: return "\u{f9a9}"
        case .retrieveCallFilled: return "\u{f9aa}"
        case .retrieveCallLight: return "\u{f9ab}"
        case .retrieveCallRegular: return "\u{f9ac}"
        case .returnBold: return "\u{f9ad}"
        case .returnLight: return "\u{f9ae}"
        case .returnRegular: return "\u{f9af}"
        case .rewindTenSecBold: return "\u{f9b0}"
        case .rewindTenSecLight: return "\u{f9b1}"
        case .rewindTenSecRegular: return "\u{f9b2}"
        case .ringtoneBold: return "\u{f9b3}"
        case .ringtoneLight: return "\u{f9b4}"
        case .ringtoneRegular: return "\u{f9b5}"
        case .roomCalendarBold: return "\u{f9b6}"
        case .roomCalendarLight: return "\u{f9b7}"
        case .roomCalendarRegular: return "\u{f9b8}"
        case .roomLightsBold: return "\u{f9b9}"
        case .roomLightsFilled: return "\u{f9ba}"
        case .roomLightsLight: return "\u{f9bb}"
        case .roomLightsRegular: return "\u{f9bc}"
        case .rotateContentBold: return "\u{f9bd}"
        case .rotateContentFilled: return "\u{f9be}"
        case .rotateContentLight: return "\u{f9bf}"
        case .rotateContentRegular: return "\u{f9c0}"
        case .rssBold: return "\u{f9c1}"
        case .rssFilled: return "\u{f9c2}"
        case .rssLight: return "\u{f9c3}"
        case .rssRegular: return "\u{f9c4}"
        case .ruleBasedBold: return "\u{f9c5}"
        case .ruleBasedLight: return "\u{f9c6}"
        case .ruleBasedRegular: return "\u{f9c7}"
        case .rulerBold: return "\u{f9c8}"
        case .rulerFilled: return "\u{f9c9}"
        case .rulerLight: return "\u{f9ca}"
        case .rulerRegular: return "\u{f9cb}"
        case .runningApplicationBold: return "\u{f9cc}"
        case .runningApplicationFilled: return "\u{f9cd}"
        case .runningApplicationLight: return "\u{f9ce}"
        case .runningApplicationRegular: return "\u{f9cf}"
        case .saveBold: return "\u{f9d0}"
        case .saveLight: return "\u{f9d1}"
        case .saveRegular: return "\u{f9d2}"
        case .saveTranscriptBold: return "\u{f9d3}"
        case .saveTranscriptFilled: return "\u{f9d4}"
        case .saveTranscriptLight: return "\u{f9d5}"
        case .saveTranscriptRegular: return "\u{f9d6}"
        case .scanBold: return "\u{f9d7}"
        case .scanLight: return "\u{f9d8}"
        case .scanRegular: return "\u{f9d9}"
        case .scheduleAiBold: return "\u{f9da}"
        case .scheduleAiLight: return "\u{f9db}"
        case .scheduleAiRegular: return "\u{f9dc}"
        case .scheduleSendBold: return "\u{f9dd}"
        case .scheduleSendFilled: return "\u{f9de}"
        case .scheduleSendLight: return "\u{f9df}"
        case .scheduleSendRegular: return "\u{f9e0}"
        case .scheduleWinnerBold: return "\u{f9e1}"
        case .scheduleWinnerFilled: return "\u{f9e2}"
        case .scheduleWinnerLight: return "\u{f9e3}"
        case .scheduleWinnerRegular: return "\u{f9e4}"
        case .schedulerAvailableBold: return "\u{f9e5}"
        case .schedulerAvailableLight: return "\u{f9e6}"
        case .schedulerAvailableRegular: return "\u{f9e7}"
        case .schedulerNotWorkingHoursBold: return "\u{f9e8}"
        case .schedulerNotWorkingHoursLight: return "\u{f9e9}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9ea}"
        case .schedulerUnavailableBold: return "\u{f9eb}"
        case .schedulerUnavailableLight: return "\u{f9ec}"
        case .schedulerUnavailableRegular: return "\u{f9ed}"
        case .schedulerUnknownBold: return "\u{f9ee}"
        case .schedulerUnknownLight: return "\u{f9ef}"
        case .schedulerUnknownRegular: return "\u{f9f0}"
        case .screenshotBold: return "\u{f9f1}"
        case .screenshotDocBold: return "\u{f9f2}"
        case .screenshotDocFilled: return "\u{f9f3}"
        case .screenshotDocLight: return "\u{f9f4}"
        case .screenshotDocRegular: return "\u{f9f5}"
        case .screenshotLight: return "\u{f9f6}"
        case .screenshotRegular: return "\u{f9f7}"
        case .searchAiBold: return "\u{f9f8}"
        case .searchAiLight: return "\u{f9f9}"
        case .searchAiRegular: return "\u{f9fa}"
        case .searchBold: return "\u{f9fb}"
        case .searchFilled: return "\u{f9fc}"
        case .searchLight: return "\u{f9fd}"
        case .searchRegular: return "\u{f9fe}"
        case .secondaryArrowBold: return "\u{f9ff}"
        case .secondaryArrowLight: return "\u{fa00}"
        case .secondaryArrowRegular: return "\u{fa01}"
        case .secureCallLockBold: return "\u{fa02}"
        case .secureCallLockFilled: return "\u{fa03}"
        case .secureCallLockLight: return "\u{fa04}"
        case .secureCallLockRegular: return "\u{fa05}"
        case .secureCallShieldBold: return "\u{fa06}"
        case .secureCallShieldFilled: return "\u{fa07}"
        case .secureCallShieldLight: return "\u{fa08}"
        case .secureCallShieldRegular: return "\u{fa09}"
        case .secureCircleBold: return "\u{fa0a}"
        case .secureCircleFilled: return "\u{fa0b}"
        case .secureCircleLight: return "\u{fa0c}"
        case .secureCircleRegular: return "\u{fa0d}"
        case .secureLockBold: return "\u{fa0e}"
        case .secureLockFilled: return "\u{fa0f}"
        case .secureLockLight: return "\u{fa10}"
        case .secureLockRegular: return "\u{fa11}"
        case .segmentExcludeFilled: return "\u{fa12}"
        case .segmentFilterFilled: return "\u{fa13}"
        case .segmentIncludeFilled: return "\u{fa14}"
        case .selectAllBold: return "\u{fa15}"
        case .selectAllFilled: return "\u{fa16}"
        case .selectAllLight: return "\u{fa17}"
        case .selectAllRegular: return "\u{fa18}"
        case .selectionBold: return "\u{fa19}"
        case .selectionFilled: return "\u{fa1a}"
        case .selectionLight: return "\u{fa1b}"
        case .selectionRegular: return "\u{fa1c}"
        case .sendBold: return "\u{fa1d}"
        case .sendDigitsBold: return "\u{fa1e}"
        case .sendDigitsFilled: return "\u{fa1f}"
        case .sendDigitsLight: return "\u{fa20}"
        case .sendDigitsRegular: return "\u{fa21}"
        case .sendFilled: return "\u{fa22}"
        case .sendLight: return "\u{fa23}"
        case .sendRegular: return "\u{fa24}"
        case .sendVoiceBold: return "\u{fa25}"
        case .sendVoiceFilled: return "\u{fa26}"
        case .sendVoiceLight: return "\u{fa27}"
        case .sendVoiceRegular: return "\u{fa28}"
        case .serverBold: return "\u{fa29}"
        case .serverErrorBold: return "\u{fa2a}"
        case .serverErrorLight: return "\u{fa2b}"
        case .serverErrorRegular: return "\u{fa2c}"
        case .serverLight: return "\u{fa2d}"
        case .serverRegular: return "\u{fa2e}"
        case .servicesBold: return "\u{fa2f}"
        case .servicesLight: return "\u{fa30}"
        case .servicesRegular: return "\u{fa31}"
        case .setVariableBold: return "\u{fa32}"
        case .setVariableLight: return "\u{fa33}"
        case .setVariableRegular: return "\u{fa34}"
        case .settingsBold: return "\u{fa35}"
        case .settingsFilled: return "\u{fa36}"
        case .settingsLight: return "\u{fa37}"
        case .settingsRegular: return "\u{fa38}"
        case .setupAssistantBold: return "\u{fa39}"
        case .setupAssistantLight: return "\u{fa3a}"
        case .setupAssistantRegular: return "\u{fa3b}"
        case .sftpBold: return "\u{fa3c}"
        case .sftpLight: return "\u{fa3d}"
        case .sftpRegular: return "\u{fa3e}"
        case .shapeCircleBold: return "\u{fa3f}"
        case .shapeCircleFilled: return "\u{fa40}"
        case .shapeCircleLight: return "\u{fa41}"
        case .shapeCircleMdFilled: return "\u{fa42}"
        case .shapeCircleRegular: return "\u{fa43}"
        case .shapeCircleSmFilled: return "\u{fa44}"
        case .shapeDiagonalLineBold: return "\u{fa45}"
        case .shapeDiagonalLineLight: return "\u{fa46}"
        case .shapeDiagonalLineRegular: return "\u{fa47}"
        case .shapeDiamondBold: return "\u{fa48}"
        case .shapeDiamondFilled: return "\u{fa49}"
        case .shapeDiamondLight: return "\u{fa4a}"
        case .shapeDiamondRegular: return "\u{fa4b}"
        case .shapeOvalBold: return "\u{fa4c}"
        case .shapeOvalLight: return "\u{fa4d}"
        case .shapeOvalRegular: return "\u{fa4e}"
        case .shapeSquareBold: return "\u{fa4f}"
        case .shapeSquareFilled: return "\u{fa50}"
        case .shapeSquareLight: return "\u{fa51}"
        case .shapeSquareRegular: return "\u{fa52}"
        case .shapeTriangleBold: return "\u{fa53}"
        case .shapeTriangleFilled: return "\u{fa54}"
        case .shapeTriangleLight: return "\u{fa55}"
        case .shapeTriangleRegular: return "\u{fa56}"
        case .shapesBold: return "\u{fa57}"
        case .shapesFilled: return "\u{fa58}"
        case .shapesLight: return "\u{fa59}"
        case .shapesRegular: return "\u{fa5a}"
        case .shareCNativeAdrBold: return "\u{fa5b}"
        case .shareCNativeAdrFilled: return "\u{fa5c}"
        case .shareCNativeAdrLight: return "\u{fa5d}"
        case .shareCNativeAdrRegular: return "\u{fa5e}"
        case .shareCNativeIphBold: return "\u{fa5f}"
        case .shareCNativeIphLight: return "\u{fa60}"
        case .shareCNativeIphRegular: return "\u{fa61}"
        case .shareContentOnDeviceBold: return "\u{fa62}"
        case .shareContentOnDeviceLight: return "\u{fa63}"
        case .shareContentOnDeviceRegular: return "\u{fa64}"
        case .shareScreenAddBold: return "\u{fa65}"
        case .shareScreenAddLight: return "\u{fa66}"
        case .shareScreenAddRegular: return "\u{fa67}"
        case .shareScreenBadgeFilled: return "\u{fa68}"
        case .shareScreenBold: return "\u{fa69}"
        case .shareScreenFilled: return "\u{fa6a}"
        case .shareScreenLight: return "\u{fa6b}"
        case .shareScreenRegular: return "\u{fa6c}"
        case .shareSpaceBold: return "\u{fa6d}"
        case .shareSpaceLight: return "\u{fa6e}"
        case .shareSpaceRegular: return "\u{fa6f}"
        case .shieldBold: return "\u{fa70}"
        case .shieldLight: return "\u{fa71}"
        case .shieldRegular: return "\u{fa72}"
        case .shoppingCartBold: return "\u{fa73}"
        case .shoppingCartFilled: return "\u{fa74}"
        case .shoppingCartLight: return "\u{fa75}"
        case .shoppingCartRegular: return "\u{fa76}"
        case .shortTextBoxBold: return "\u{fa77}"
        case .shortTextBoxLight: return "\u{fa78}"
        case .shortTextBoxRegular: return "\u{fa79}"
        case .showBold: return "\u{fa7a}"
        case .showFilled: return "\u{fa7b}"
        case .showLight: return "\u{fa7c}"
        case .showRegular: return "\u{fa7d}"
        case .sidePanelBold: return "\u{fa7e}"
        case .sidePanelFilled: return "\u{fa7f}"
        case .sidePanelLight: return "\u{fa80}"
        case .sidePanelRegular: return "\u{fa81}"
        case .signInBold: return "\u{fa82}"
        case .signInFilled: return "\u{fa83}"
        case .signInForcedBold: return "\u{fa84}"
        case .signInForcedLight: return "\u{fa85}"
        case .signInForcedRegular: return "\u{fa86}"
        case .signInLight: return "\u{fa87}"
        case .signInRegular: return "\u{fa88}"
        case .signLangIntBold: return "\u{fa89}"
        case .signLangIntLight: return "\u{fa8a}"
        case .signLangIntRegular: return "\u{fa8b}"
        case .signOutBold: return "\u{fa8c}"
        case .signOutLight: return "\u{fa8d}"
        case .signOutRegular: return "\u{fa8e}"
        case .signalFourBold: return "\u{fa8f}"
        case .signalFourLight: return "\u{fa90}"
        case .signalFourRegular: return "\u{fa91}"
        case .signalOneBold: return "\u{fa92}"
        case .signalOneLight: return "\u{fa93}"
        case .signalOneRegular: return "\u{fa94}"
        case .signalThreeBold: return "\u{fa95}"
        case .signalThreeLight: return "\u{fa96}"
        case .signalThreeRegular: return "\u{fa97}"
        case .signalTwoBold: return "\u{fa98}"
        case .signalTwoLight: return "\u{fa99}"
        case .signalTwoRegular: return "\u{fa9a}"
        case .signalZeroBold: return "\u{fa9b}"
        case .signalZeroLight: return "\u{fa9c}"
        case .signalZeroRegular: return "\u{fa9d}"
        case .simplePromotionBold: return "\u{fa9e}"
        case .simplePromotionLight: return "\u{fa9f}"
        case .simplePromotionRegular: return "\u{faa0}"
        case .singleNumberReachBold: return "\u{faa1}"
        case .singleNumberReachLight: return "\u{faa2}"
        case .singleNumberReachRegular: return "\u{faa3}"
        case .sipRegistrationInProgressBold: return "\u{faa4}"
        case .sipRegistrationInProgressFilled: return "\u{faa5}"
        case .sipRegistrationInProgressLight: return "\u{faa6}"
        case .sipRegistrationInProgressRegular: return "\u{faa7}"
        case .skipBold: return "\u{faa8}"
        case .skipBwBold: return "\u{faa9}"
        case .skipBwFilled: return "\u{faaa}"
        case .skipBwLight: return "\u{faab}"
        case .skipBwRegular: return "\u{faac}"
        case .skipFwBold: return "\u{faad}"
        case .skipFwFilled: return "\u{faae}"
        case .skipFwLight: return "\u{faaf}"
        case .skipFwRegular: return "\u{fab0}"
        case .skipLight: return "\u{fab1}"
        case .skipRegular: return "\u{fab2}"
        case .smartAudioBold: return "\u{fab3}"
        case .smartAudioLight: return "\u{fab4}"
        case .smartAudioRegular: return "\u{fab5}"
        case .smsFilled: return "\u{fab6}"
        case .smsInboundBold: return "\u{fab7}"
        case .smsInboundLight: return "\u{fab8}"
        case .smsInboundRegular: return "\u{fab9}"
        case .smsMessageBold: return "\u{faba}"
        case .smsMessageFilled: return "\u{fabb}"
        case .smsMessageLight: return "\u{fabc}"
        case .smsMessageRegular: return "\u{fabd}"
        case .smsOutgoingFilled: return "\u{fabe}"
        case .smsUnreadBold: return "\u{fabf}"
        case .smsUnreadLight: return "\u{fac0}"
        case .smsUnreadRegular: return "\u{fac1}"
        case .sortAscendingBold: return "\u{fac2}"
        case .sortAscendingLight: return "\u{fac3}"
        case .sortAscendingRegular: return "\u{fac4}"
        case .sortDescendingBold: return "\u{fac5}"
        case .sortDescendingLight: return "\u{fac6}"
        case .sortDescendingRegular: return "\u{fac7}"
        case .soundDefaultBold: return "\u{fac8}"
        case .soundDefaultLight: return "\u{fac9}"
        case .soundDefaultRegular: return "\u{faca}"
        case .sparkleBold: return "\u{facb}"
        case .sparkleFilled: return "\u{facc}"
        case .sparkleLight: return "\u{facd}"
        case .sparkleRegular: return "\u{face}"
        case .speakerBold: return "\u{facf}"
        case .speakerDisconnectedBold: return "\u{fad0}"
        case .speakerDisconnectedFilled: return "\u{fad1}"
        case .speakerDisconnectedLight: return "\u{fad2}"
        case .speakerDisconnectedRegular: return "\u{fad3}"
        case .speakerFilled: return "\u{fad4}"
        case .speakerLight: return "\u{fad5}"
        case .speakerMutedBold: return "\u{fad6}"
        case .speakerMutedFilled: return "\u{fad7}"
        case .speakerMutedLight: return "\u{fad8}"
        case .speakerMutedRegular: return "\u{fad9}"
        case .speakerOffBold: return "\u{fada}"
        case .speakerOffFilled: return "\u{fadb}"
        case .speakerOffLight: return "\u{fadc}"
        case .speakerOffRegular: return "\u{fadd}"
        case .speakerOnBold: return "\u{fade}"
        case .speakerOnLight: return "\u{fadf}"
        case .speakerOnRegular: return "\u{fae0}"
        case .speakerRegular: return "\u{fae1}"
        case .speakerTurnDownBold: return "\u{fae2}"
        case .speakerTurnDownFilled: return "\u{fae3}"
        case .speakerTurnDownLight: return "\u{fae4}"
        case .speakerTurnDownRegular: return "\u{fae5}"
        case .speakerTurnUpBold: return "\u{fae6}"
        case .speakerTurnUpFilled: return "\u{fae7}"
        case .speakerTurnUpLight: return "\u{fae8}"
        case .speakerTurnUpRegular: return "\u{fae9}"
        case .speedDialBold: return "\u{faea}"
        case .speedDialFilled: return "\u{faeb}"
        case .speedDialLight: return "\u{faec}"
        case .speedDialRegular: return "\u{faed}"
        case .spellCheckerBold: return "\u{faee}"
        case .spellCheckerLight: return "\u{faef}"
        case .spellCheckerRegular: return "\u{faf0}"
        case .splitViewBold: return "\u{faf1}"
        case .splitViewLight: return "\u{faf2}"
        case .splitViewRegular: return "\u{faf3}"
        case .stackedAreaChartBold: return "\u{faf4}"
        case .stackedAreaChartFilled: return "\u{faf5}"
        case .stackedAreaChartFullBold: return "\u{faf6}"
        case .stackedAreaChartFullFilled: return "\u{faf7}"
        case .stackedAreaChartFullLight: return "\u{faf8}"
        case .stackedAreaChartFullRegular: return "\u{faf9}"
        case .stackedAreaChartLight: return "\u{fafa}"
        case .stackedAreaChartRegular: return "\u{fafb}"
        case .stackedBarChartBold: return "\u{fafc}"
        case .stackedBarChartFilled: return "\u{fafd}"
        case .stackedBarChartFullBold: return "\u{fafe}"
        case .stackedBarChartFullFilled: return "\u{faff}"
        case .stackedBarChartFullLight: return "\u{fb00}"
        case .stackedBarChartFullRegular: return "\u{fb01}"
        case .stackedBarChartLight: return "\u{fb02}"
        case .stackedBarChartRegular: return "\u{fb03}"
        case .startChatBold: return "\u{fb04}"
        case .startChatLight: return "\u{fb05}"
        case .startChatRegular: return "\u{fb06}"
        case .stethoscopeBold: return "\u{fb07}"
        case .stethoscopeLight: return "\u{fb08}"
        case .stethoscopeRegular: return "\u{fb09}"
        case .stickersBold: return "\u{fb0a}"
        case .stickersLight: return "\u{fb0b}"
        case .stickersRegular: return "\u{fb0c}"
        case .stickiesBold: return "\u{fb0d}"
        case .stickiesLight: return "\u{fb0e}"
        case .stickiesRegular: return "\u{fb0f}"
        case .stopBold: return "\u{fb10}"
        case .stopCircleBold: return "\u{fb11}"
        case .stopCircleFilled: return "\u{fb12}"
        case .stopCircleLight: return "\u{fb13}"
        case .stopCircleRegular: return "\u{fb14}"
        case .stopContentShareBold: return "\u{fb15}"
        case .stopContentShareLight: return "\u{fb16}"
        case .stopContentShareRegular: return "\u{fb17}"
        case .stopFilled: return "\u{fb18}"
        case .stopLight: return "\u{fb19}"
        case .stopRegular: return "\u{fb1a}"
        case .storedInfoBold: return "\u{fb1b}"
        case .storedInfoFilled: return "\u{fb1c}"
        case .storedInfoLight: return "\u{fb1d}"
        case .storedInfoRegular: return "\u{fb1e}"
        case .streamingBold: return "\u{fb1f}"
        case .streamingLight: return "\u{fb20}"
        case .streamingRegular: return "\u{fb21}"
        case .strikethroughBold: return "\u{fb22}"
        case .strikethroughFilled: return "\u{fb23}"
        case .strikethroughLight: return "\u{fb24}"
        case .strikethroughRegular: return "\u{fb25}"
        case .studioModeBold: return "\u{fb26}"
        case .studioModeLight: return "\u{fb27}"
        case .studioModeRegular: return "\u{fb28}"
        case .subscriptBold: return "\u{fb29}"
        case .subscriptLight: return "\u{fb2a}"
        case .subscriptRegular: return "\u{fb2b}"
        case .summarizeAiBold: return "\u{fb2c}"
        case .summarizeAiLight: return "\u{fb2d}"
        case .summarizeAiRegular: return "\u{fb2e}"
        case .superscriptBold: return "\u{fb2f}"
        case .superscriptLight: return "\u{fb30}"
        case .superscriptRegular: return "\u{fb31}"
        case .surveyBold: return "\u{fb32}"
        case .surveyFilled: return "\u{fb33}"
        case .surveyLight: return "\u{fb34}"
        case .surveyRegular: return "\u{fb35}"
        case .sxEightyCodecBold: return "\u{fb36}"
        case .sxEightyCodecLight: return "\u{fb37}"
        case .sxEightyCodecRegular: return "\u{fb38}"
        case .sxTenBold: return "\u{fb39}"
        case .sxTenLight: return "\u{fb3a}"
        case .sxTenRegular: return "\u{fb3b}"
        case .sxTwentyBold: return "\u{fb3c}"
        case .sxTwentyLight: return "\u{fb3d}"
        case .sxTwentyRegular: return "\u{fb3e}"
        case .tableBold: return "\u{fb3f}"
        case .tableLight: return "\u{fb40}"
        case .tableRegular: return "\u{fb41}"
        case .tabletBold: return "\u{fb42}"
        case .tabletLight: return "\u{fb43}"
        case .tabletRegular: return "\u{fb44}"
        case .tabsBold: return "\u{fb45}"
        case .tabsLight: return "\u{fb46}"
        case .tabsRegular: return "\u{fb47}"
        case .tagBold: return "\u{fb48}"
        case .tagLight: return "\u{fb49}"
        case .tagRegular: return "\u{fb4a}"
        case .tapBold: return "\u{fb4b}"
        case .tapFilled: return "\u{fb4c}"
        case .tapLight: return "\u{fb4d}"
        case .tapRegular: return "\u{fb4e}"
        case .telepresenceAlertBold: return "\u{fb4f}"
        case .telepresenceAlertLight: return "\u{fb50}"
        case .telepresenceAlertMutedBold: return "\u{fb51}"
        case .telepresenceAlertMutedLight: return "\u{fb52}"
        case .telepresenceAlertMutedRegular: return "\u{fb53}"
        case .telepresenceAlertRegular: return "\u{fb54}"
        case .telepresenceBold: return "\u{fb55}"
        case .telepresenceIxFiveThousandBold: return "\u{fb56}"
        case .telepresenceIxFiveThousandLight: return "\u{fb57}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb58}"
        case .telepresenceLight: return "\u{fb59}"
        case .telepresenceMutedBold: return "\u{fb5a}"
        case .telepresenceMutedLight: return "\u{fb5b}"
        case .telepresenceMutedRegular: return "\u{fb5c}"
        case .telepresencePrivateBold: return "\u{fb5d}"
        case .telepresencePrivateLight: return "\u{fb5e}"
        case .telepresencePrivateRegular: return "\u{fb5f}"
        case .telepresenceRegular: return "\u{fb60}"
        case .temperatureBold: return "\u{fb61}"
        case .temperatureLight: return "\u{fb62}"
        case .temperatureRegular: return "\u{fb63}"
        case .testTubeBold: return "\u{fb64}"
        case .testTubeFilled: return "\u{fb65}"
        case .testTubeLight: return "\u{fb66}"
        case .testTubeRegular: return "\u{fb67}"
        case .textAlignCenterBold: return "\u{fb68}"
        case .textAlignCenterFilled: return "\u{fb69}"
        case .textAlignCenterLight: return "\u{fb6a}"
        case .textAlignCenterRegular: return "\u{fb6b}"
        case .textAlignLeftBold: return "\u{fb6c}"
        case .textAlignLeftFilled: return "\u{fb6d}"
        case .textAlignLeftLight: return "\u{fb6e}"
        case .textAlignLeftRegular: return "\u{fb6f}"
        case .textAlignRightBold: return "\u{fb70}"
        case .textAlignRightFilled: return "\u{fb71}"
        case .textAlignRightLight: return "\u{fb72}"
        case .textAlignRightRegular: return "\u{fb73}"
        case .textBold: return "\u{fb74}"
        case .textBoxCursorLight: return "\u{fb75}"
        case .textCodeBlockBold: return "\u{fb76}"
        case .textCodeBlockLight: return "\u{fb77}"
        case .textCodeBlockRegular: return "\u{fb78}"
        case .textHighlightBold: return "\u{fb79}"
        case .textHighlightFilled: return "\u{fb7a}"
        case .textHighlightLight: return "\u{fb7b}"
        case .textHighlightRegular: return "\u{fb7c}"
        case .textLight: return "\u{fb7d}"
        case .textRegular: return "\u{fb7e}"
        case .threeColumnBold: return "\u{fb7f}"
        case .threeColumnLight: return "\u{fb80}"
        case .threeColumnRegular: return "\u{fb81}"
        case .threeDObjectBold: return "\u{fb82}"
        case .threeDObjectLight: return "\u{fb83}"
        case .threeDObjectRegular: return "\u{fb84}"
        case .timeExclusionBold: return "\u{fb85}"
        case .timeExclusionLight: return "\u{fb86}"
        case .timeExclusionRegular: return "\u{fb87}"
        case .timezoneBold: return "\u{fb88}"
        case .timezoneFilled: return "\u{fb89}"
        case .timezoneLight: return "\u{fb8a}"
        case .timezoneRegular: return "\u{fb8b}"
        case .tooFastBold: return "\u{fb8c}"
        case .tooFastLight: return "\u{fb8d}"
        case .tooFastRegular: return "\u{fb8e}"
        case .tooSlowBold: return "\u{fb8f}"
        case .tooSlowLight: return "\u{fb90}"
        case .tooSlowRegular: return "\u{fb91}"
        case .toolsBold: return "\u{fb92}"
        case .toolsFilled: return "\u{fb93}"
        case .toolsLight: return "\u{fb94}"
        case .toolsRegular: return "\u{fb95}"
        case .touchTenBold: return "\u{fb96}"
        case .touchTenLight: return "\u{fb97}"
        case .touchTenRegular: return "\u{fb98}"
        case .transcriptBold: return "\u{fb99}"
        case .transcriptFilled: return "\u{fb9a}"
        case .transcriptLight: return "\u{fb9b}"
        case .transcriptRegular: return "\u{fb9c}"
        case .translateBold: return "\u{fb9d}"
        case .translateLight: return "\u{fb9e}"
        case .translateRegular: return "\u{fb9f}"
        case .translateUndoBold: return "\u{fba0}"
        case .translateUndoLight: return "\u{fba1}"
        case .translateUndoRegular: return "\u{fba2}"
        case .trendingBold: return "\u{fba3}"
        case .trendingDownBold: return "\u{fba4}"
        case .trendingDownFilled: return "\u{fba5}"
        case .trendingDownLight: return "\u{fba6}"
        case .trendingDownRegular: return "\u{fba7}"
        case .trendingFilled: return "\u{fba8}"
        case .trendingLight: return "\u{fba9}"
        case .trendingRegular: return "\u{fbaa}"
        case .trimBold: return "\u{fbab}"
        case .trimLight: return "\u{fbac}"
        case .trimRegular: return "\u{fbad}"
        case .twoColumnBold: return "\u{fbae}"
        case .twoColumnLight: return "\u{fbaf}"
        case .twoColumnRegular: return "\u{fbb0}"
        case .twoWayVoiceStreamBold: return "\u{fbb1}"
        case .twoWayVoiceStreamFilled: return "\u{fbb2}"
        case .twoWayVoiceStreamLight: return "\u{fbb3}"
        case .twoWayVoiceStreamRegular: return "\u{fbb4}"
        case .ucmCloudBold: return "\u{fbb5}"
        case .ucmCloudLight: return "\u{fbb6}"
        case .ucmCloudRegular: return "\u{fbb7}"
        case .unblockBold: return "\u{fbb8}"
        case .unblockFilled: return "\u{fbb9}"
        case .unblockLight: return "\u{fbba}"
        case .unblockRegular: return "\u{fbbb}"
        case .underlineBold: return "\u{fbbc}"
        case .underlineFilled: return "\u{fbbd}"
        case .underlineLight: return "\u{fbbe}"
        case .underlineRegular: return "\u{fbbf}"
        case .undoBold: return "\u{fbc0}"
        case .undoLight: return "\u{fbc1}"
        case .undoRegular: return "\u{fbc2}"
        case .unlinkBold: return "\u{fbc3}"
        case .unlinkLight: return "\u{fbc4}"
        case .unlinkRegular: return "\u{fbc5}"
        case .unreadBold: return "\u{fbc6}"
        case .unreadFilled: return "\u{fbc7}"
        case .unreadLight: return "\u{fbc8}"
        case .unreadRegular: return "\u{fbc9}"
        case .unsecureUnlockedBold: return "\u{fbca}"
        case .unsecureUnlockedFilled: return "\u{fbcb}"
        case .unsecureUnlockedLight: return "\u{fbcc}"
        case .unsecureUnlockedRegular: return "\u{fbcd}"
        case .unsortedBold: return "\u{fbce}"
        case .unsortedLight: return "\u{fbcf}"
        case .unsortedRegular: return "\u{fbd0}"
        case .updateFileShareBold: return "\u{fbd1}"
        case .updateFileShareLight: return "\u{fbd2}"
        case .updateFileShareRegular: return "\u{fbd3}"
        case .uploadBold: return "\u{fbd4}"
        case .uploadImageBold: return "\u{fbd5}"
        case .uploadImageLight: return "\u{fbd6}"
        case .uploadImageRegular: return "\u{fbd7}"
        case .uploadLight: return "\u{fbd8}"
        case .uploadRegular: return "\u{fbd9}"
        case .urgentVoicemailBold: return "\u{fbda}"
        case .urgentVoicemailFilled: return "\u{fbdb}"
        case .usbBold: return "\u{fbdc}"
        case .usbHeadsetBold: return "\u{fbdd}"
        case .usbHeadsetLight: return "\u{fbde}"
        case .usbHeadsetMutedBold: return "\u{fbdf}"
        case .usbHeadsetMutedLight: return "\u{fbe0}"
        case .usbHeadsetMutedRegular: return "\u{fbe1}"
        case .usbHeadsetRegular: return "\u{fbe2}"
        case .usbLight: return "\u{fbe3}"
        case .usbRegular: return "\u{fbe4}"
        case .userBold: return "\u{fbe5}"
        case .userDeactivateBold: return "\u{fbe6}"
        case .userDeactivateLight: return "\u{fbe7}"
        case .userDeactivateRegular: return "\u{fbe8}"
        case .userLight: return "\u{fbe9}"
        case .userRegular: return "\u{fbea}"
        case .videoBlurBold: return "\u{fbeb}"
        case .videoBlurFilled: return "\u{fbec}"
        case .videoBlurLight: return "\u{fbed}"
        case .videoBlurRegular: return "\u{fbee}"
        case .videoBold: return "\u{fbef}"
        case .videoEffectBold: return "\u{fbf0}"
        case .videoEffectFilled: return "\u{fbf1}"
        case .videoEffectLight: return "\u{fbf2}"
        case .videoEffectRegular: return "\u{fbf3}"
        case .videoFilled: return "\u{fbf4}"
        case .videoLayoutBold: return "\u{fbf5}"
        case .videoLayoutCustomBold: return "\u{fbf6}"
        case .videoLayoutCustomFilled: return "\u{fbf7}"
        case .videoLayoutCustomLight: return "\u{fbf8}"
        case .videoLayoutCustomRegular: return "\u{fbf9}"
        case .videoLayoutEqualBold: return "\u{fbfa}"
        case .videoLayoutEqualDualBold: return "\u{fbfb}"
        case .videoLayoutEqualDualLight: return "\u{fbfc}"
        case .videoLayoutEqualDualRegular: return "\u{fbfd}"
        case .videoLayoutEqualFilled: return "\u{fbfe}"
        case .videoLayoutEqualLight: return "\u{fbff}"
        case .videoLayoutEqualRegular: return "\u{fc00}"
        case .videoLayoutFilled: return "\u{fc01}"
        case .videoLayoutLight: return "\u{fc02}"
        case .videoLayoutOverlayBold: return "\u{fc03}"
        case .videoLayoutOverlayFilled: return "\u{fc04}"
        case .videoLayoutOverlayLight: return "\u{fc05}"
        case .videoLayoutOverlayRegular: return "\u{fc06}"
        case .videoLayoutPresentationBold: return "\u{fc07}"
        case .videoLayoutPresentationFilled: return "\u{fc08}"
        case .videoLayoutPresentationLight: return "\u{fc09}"
        case .videoLayoutPresentationRegular: return "\u{fc0a}"
        case .videoLayoutPresenterDominantBold: return "\u{fc0b}"
        case .videoLayoutPresenterDominantLight: return "\u{fc0c}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc0d}"
        case .videoLayoutProminentBold: return "\u{fc0e}"
        case .videoLayoutProminentFilled: return "\u{fc0f}"
        case .videoLayoutProminentLight: return "\u{fc10}"
        case .videoLayoutProminentRegular: return "\u{fc11}"
        case .videoLayoutRegular: return "\u{fc12}"
        case .videoLayoutShareDominantBold: return "\u{fc13}"
        case .videoLayoutShareDominantLight: return "\u{fc14}"
        case .videoLayoutShareDominantRegular: return "\u{fc15}"
        case .videoLayoutSingleBold: return "\u{fc16}"
        case .videoLayoutSingleFilled: return "\u{fc17}"
        case .videoLayoutSingleLight: return "\u{fc18}"
        case .videoLayoutSingleRegular: return "\u{fc19}"
        case .videoLayoutSpeakerBold: return "\u{fc1a}"
        case .videoLayoutSpeakerFilled: return "\u{fc1b}"
        case .videoLayoutSpeakerLight: return "\u{fc1c}"
        case .videoLayoutSpeakerRegular: return "\u{fc1d}"
        case .videoLayoutStackBold: return "\u{fc1e}"
        case .videoLayoutStackFilled: return "\u{fc1f}"
        case .videoLayoutStackLight: return "\u{fc20}"
        case .videoLayoutStackRegular: return "\u{fc21}"
        case .videoLayoutVideoDominantBold: return "\u{fc22}"
        case .videoLayoutVideoDominantFilled: return "\u{fc23}"
        case .videoLayoutVideoDominantLight: return "\u{fc24}"
        case .videoLayoutVideoDominantRegular: return "\u{fc25}"
        case .videoLight: return "\u{fc26}"
        case .videoPlusBold: return "\u{fc27}"
        case .videoPlusFilled: return "\u{fc28}"
        case .videoPlusLight: return "\u{fc29}"
        case .videoPlusRegular: return "\u{fc2a}"
        case .videoRegular: return "\u{fc2b}"
        case .videoSpeakerTrackBold: return "\u{fc2c}"
        case .videoSpeakerTrackFilled: return "\u{fc2d}"
        case .videoSpeakerTrackLight: return "\u{fc2e}"
        case .videoSpeakerTrackRegular: return "\u{fc2f}"
        case .viewAllBold: return "\u{fc30}"
        case .viewAllLight: return "\u{fc31}"
        case .viewAllRegular: return "\u{fc32}"
        case .viewListBold: return "\u{fc33}"
        case .viewListFilled: return "\u{fc34}"
        case .viewListLight: return "\u{fc35}"
        case .viewListRegular: return "\u{fc36}"
        case .viewStackedBold: return "\u{fc37}"
        case .viewStackedFilled: return "\u{fc38}"
        case .viewStackedLight: return "\u{fc39}"
        case .viewStackedRegular: return "\u{fc3a}"
        case .viewThumbnailBold: return "\u{fc3b}"
        case .viewThumbnailFilled: return "\u{fc3c}"
        case .viewThumbnailLight: return "\u{fc3d}"
        case .viewThumbnailRegular: return "\u{fc3e}"
        case .visionproBold: return "\u{fc3f}"
        case .visionproFilled: return "\u{fc40}"
        case .visionproLight: return "\u{fc41}"
        case .visionproMoveCallInBold: return "\u{fc42}"
        case .visionproMoveCallInFilled: return "\u{fc43}"
        case .visionproMoveCallInLight: return "\u{fc44}"
        case .visionproMoveCallInOutBold: return "\u{fc45}"
        case .visionproMoveCallInOutFilled: return "\u{fc46}"
        case .visionproMoveCallInOutLight: return "\u{fc47}"
        case .visionproMoveCallInOutRegular: return "\u{fc48}"
        case .visionproMoveCallInRegular: return "\u{fc49}"
        case .visionproMoveCallOutBold: return "\u{fc4a}"
        case .visionproMoveCallOutFilled: return "\u{fc4b}"
        case .visionproMoveCallOutLight: return "\u{fc4c}"
        case .visionproMoveCallOutRegular: return "\u{fc4d}"
        case .visionproRegular: return "\u{fc4e}"
        case .voicemailBold: return "\u{fc4f}"
        case .voicemailFilled: return "\u{fc50}"
        case .voicemailLight: return "\u{fc51}"
        case .voicemailRegular: return "\u{fc52}"
        case .vpnBold: return "\u{fc53}"
        case .vpnFilled: return "\u{fc54}"
        case .vpnLight: return "\u{fc55}"
        case .vpnRegular: return "\u{fc56}"
        case .vscBold: return "\u{fc57}"
        case .vscLight: return "\u{fc58}"
        case .vscRegular: return "\u{fc59}"
        case .waffleMenuBold: return "\u{fc5a}"
        case .waffleMenuLight: return "\u{fc5b}"
        case .waffleMenuRegular: return "\u{fc5c}"
        case .waitingRoomBold: return "\u{fc5d}"
        case .waitingRoomLight: return "\u{fc5e}"
        case .waitingRoomRegular: return "\u{fc5f}"
        case .wallpaperBold: return "\u{fc60}"
        case .wallpaperLight: return "\u{fc61}"
        case .wallpaperRegular: return "\u{fc62}"
        case .warningBadgeFilled: return "\u{fc63}"
        case .warningBold: return "\u{fc64}"
        case .warningFilled: return "\u{fc65}"
        case .warningLight: return "\u{fc66}"
        case .warningRegular: return "\u{fc67}"
        case .webexBoardBold: return "\u{fc68}"
        case .webexBoardLight: return "\u{fc69}"
        case .webexBoardRegular: return "\u{fc6a}"
        case .webexCodecPlusBold: return "\u{fc6b}"
        case .webexCodecPlusLight: return "\u{fc6c}"
        case .webexCodecPlusRegular: return "\u{fc6d}"
        case .webexDeskCameraBold: return "\u{fc6e}"
        case .webexDeskCameraLight: return "\u{fc6f}"
        case .webexDeskCameraRegular: return "\u{fc70}"
        case .webexHelixBold: return "\u{fc71}"
        case .webexHelixLight: return "\u{fc72}"
        case .webexHelixRegular: return "\u{fc73}"
        case .webexMeetingsBold: return "\u{fc74}"
        case .webexMeetingsFilled: return "\u{fc75}"
        case .webexMeetingsLight: return "\u{fc76}"
        case .webexMeetingsRegular: return "\u{fc77}"
        case .webexQuadCameraBold: return "\u{fc78}"
        case .webexQuadCameraLight: return "\u{fc79}"
        case .webexQuadCameraRegular: return "\u{fc7a}"
        case .webexRoomKitBold: return "\u{fc7b}"
        case .webexRoomKitLight: return "\u{fc7c}"
        case .webexRoomKitPlusBold: return "\u{fc7d}"
        case .webexRoomKitPlusLight: return "\u{fc7e}"
        case .webexRoomKitPlusRegular: return "\u{fc7f}"
        case .webexRoomKitRegular: return "\u{fc80}"
        case .webexShareBold: return "\u{fc81}"
        case .webexShareLight: return "\u{fc82}"
        case .webexShareRegular: return "\u{fc83}"
        case .webexTeamsBold: return "\u{fc84}"
        case .webexTeamsFilled: return "\u{fc85}"
        case .webexTeamsLight: return "\u{fc86}"
        case .webexTeamsNewBold: return "\u{fc87}"
        case .webexTeamsNewFilled: return "\u{fc88}"
        case .webexTeamsNewLight: return "\u{fc89}"
        case .webexTeamsNewRegular: return "\u{fc8a}"
        case .webexTeamsRegular: return "\u{fc8b}"
        case .webexTeamsRemoveBold: return "\u{fc8c}"
        case .webexTeamsRemoveLight: return "\u{fc8d}"
        case .webexTeamsRemoveRegular: return "\u{fc8e}"
        case .webhookBold: return "\u{fc8f}"
        case .webhookLight: return "\u{fc90}"
        case .webhookRegular: return "\u{fc91}"
        case .webinarBold: return "\u{fc92}"
        case .webinarFilled: return "\u{fc93}"
        case .webinarLight: return "\u{fc94}"
        case .webinarRegular: return "\u{fc95}"
        case .weeklyRecurringScheduleBold: return "\u{fc96}"
        case .weeklyRecurringScheduleLight: return "\u{fc97}"
        case .weeklyRecurringScheduleRegular: return "\u{fc98}"
        case .whisperAnnouncementBold: return "\u{fc99}"
        case .whisperAnnouncementFilled: return "\u{fc9a}"
        case .whisperAnnouncementLight: return "\u{fc9b}"
        case .whisperAnnouncementRegular: return "\u{fc9c}"
        case .whisperCoachBold: return "\u{fc9d}"
        case .whisperCoachFilled: return "\u{fc9e}"
        case .whisperCoachLight: return "\u{fc9f}"
        case .whisperCoachRegular: return "\u{fca0}"
        case .whiteboardBold: return "\u{fca1}"
        case .whiteboardContentBold: return "\u{fca2}"
        case .whiteboardContentFilled: return "\u{fca3}"
        case .whiteboardContentLight: return "\u{fca4}"
        case .whiteboardContentRegular: return "\u{fca5}"
        case .whiteboardFilled: return "\u{fca6}"
        case .whiteboardLight: return "\u{fca7}"
        case .whiteboardRegular: return "\u{fca8}"
        case .widgetBold: return "\u{fca9}"
        case .widgetFilled: return "\u{fcaa}"
        case .widgetLight: return "\u{fcab}"
        case .widgetRegular: return "\u{fcac}"
        case .wifiBold: return "\u{fcad}"
        case .wifiErrorBold: return "\u{fcae}"
        case .wifiErrorLight: return "\u{fcaf}"
        case .wifiErrorRegular: return "\u{fcb0}"
        case .wifiLight: return "\u{fcb1}"
        case .wifiRegular: return "\u{fcb2}"
        case .wifiSignalGoodBold: return "\u{fcb3}"
        case .wifiSignalGoodLight: return "\u{fcb4}"
        case .wifiSignalGoodRegular: return "\u{fcb5}"
        case .wifiSignalPoorBold: return "\u{fcb6}"
        case .wifiSignalPoorLight: return "\u{fcb7}"
        case .wifiSignalPoorRegular: return "\u{fcb8}"
        case .wifiSignalUnstableBold: return "\u{fcb9}"
        case .wifiSignalUnstableLight: return "\u{fcba}"
        case .wifiSignalUnstableRegular: return "\u{fcbb}"
        case .windowCornerScrubBold: return "\u{fcbc}"
        case .windowCornerScrubLight: return "\u{fcbd}"
        case .windowCornerScrubRegular: return "\u{fcbe}"
        case .windowRightCornerScrubBold: return "\u{fcbf}"
        case .windowRightCornerScrubLight: return "\u{fcc0}"
        case .windowRightCornerScrubRegular: return "\u{fcc1}"
        case .windowVerticalScrubBold: return "\u{fcc2}"
        case .windowVerticalScrubLight: return "\u{fcc3}"
        case .windowVerticalScrubRegular: return "\u{fcc4}"
        case .workflowDeploymentsBold: return "\u{fcc5}"
        case .workflowDeploymentsFilled: return "\u{fcc6}"
        case .workflowDeploymentsLight: return "\u{fcc7}"
        case .workflowDeploymentsRegular: return "\u{fcc8}"
        case .workphoneBold: return "\u{fcc9}"
        case .workphoneLight: return "\u{fcca}"
        case .workphoneRegular: return "\u{fccb}"
        case .zoomInBold: return "\u{fccc}"
        case .zoomInLight: return "\u{fccd}"
        case .zoomInRegular: return "\u{fcce}"
        case .zoomOutBold: return "\u{fccf}"
        case .zoomOutLight: return "\u{fcd0}"
        case .zoomOutRegular: return "\u{fcd1}"
