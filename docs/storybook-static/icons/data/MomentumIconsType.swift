...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .testTubeBold: return "\u{fc1b}"
        case .testTubeFilled: return "\u{fc1c}"
        case .testTubeLight: return "\u{fc1d}"
        case .testTubeRegular: return "\u{fc1e}"
        case .textAlignCenterBold: return "\u{fc1f}"
        case .textAlignCenterFilled: return "\u{fc20}"
        case .textAlignCenterLight: return "\u{fc21}"
        case .textAlignCenterRegular: return "\u{fc22}"
        case .textAlignLeftBold: return "\u{fc23}"
        case .textAlignLeftFilled: return "\u{fc24}"
        case .textAlignLeftLight: return "\u{fc25}"
        case .textAlignLeftRegular: return "\u{fc26}"
        case .textAlignRightBold: return "\u{fc27}"
        case .textAlignRightFilled: return "\u{fc28}"
        case .textAlignRightLight: return "\u{fc29}"
        case .textAlignRightRegular: return "\u{fc2a}"
        case .textBold: return "\u{fc2b}"
        case .textBoxCursorLight: return "\u{fc2c}"
        case .textCodeBlockBold: return "\u{fc2d}"
        case .textCodeBlockLight: return "\u{fc2e}"
        case .textCodeBlockRegular: return "\u{fc2f}"
        case .textHighlightBold: return "\u{fc30}"
        case .textHighlightFilled: return "\u{fc31}"
        case .textHighlightLight: return "\u{fc32}"
        case .textHighlightRegular: return "\u{fc33}"
        case .textLight: return "\u{fc34}"
        case .textRegular: return "\u{fc35}"
        case .textShortBold: return "\u{fc36}"
        case .textShortLight: return "\u{fc37}"
        case .textShortRegular: return "\u{fc38}"
        case .threeColumnBold: return "\u{fc39}"
        case .threeColumnLight: return "\u{fc3a}"
        case .threeColumnRegular: return "\u{fc3b}"
        case .threeDObjectBold: return "\u{fc3c}"
        case .threeDObjectLight: return "\u{fc3d}"
        case .threeDObjectRegular: return "\u{fc3e}"
        case .timeExclusionBold: return "\u{fc3f}"
        case .timeExclusionLight: return "\u{fc40}"
        case .timeExclusionRegular: return "\u{fc41}"
        case .timezoneBold: return "\u{fc42}"
        case .timezoneFilled: return "\u{fc43}"
        case .timezoneLight: return "\u{fc44}"
        case .timezoneRegular: return "\u{fc45}"
        case .tooFastBold: return "\u{fc46}"
        case .tooFastLight: return "\u{fc47}"
        case .tooFastRegular: return "\u{fc48}"
        case .tooSlowBold: return "\u{fc49}"
        case .tooSlowLight: return "\u{fc4a}"
        case .tooSlowRegular: return "\u{fc4b}"
        case .toolsBold: return "\u{fc4c}"
        case .toolsFilled: return "\u{fc4d}"
        case .toolsLight: return "\u{fc4e}"
        case .toolsRegular: return "\u{fc4f}"
        case .touchTenBold: return "\u{fc50}"
        case .touchTenLight: return "\u{fc51}"
        case .touchTenRegular: return "\u{fc52}"
        case .trackingBold: return "\u{fc53}"
        case .trackingFilled: return "\u{fc54}"
        case .trackingLight: return "\u{fc55}"
        case .trackingRegular: return "\u{fc56}"
        case .transcriptBold: return "\u{fc57}"
        case .transcriptFilled: return "\u{fc58}"
        case .transcriptLight: return "\u{fc59}"
        case .transcriptRegular: return "\u{fc5a}"
        case .translateBold: return "\u{fc5b}"
        case .translateLight: return "\u{fc5c}"
        case .translateRegular: return "\u{fc5d}"
        case .translateUndoBold: return "\u{fc5e}"
        case .translateUndoLight: return "\u{fc5f}"
        case .translateUndoRegular: return "\u{fc60}"
        case .trendingBold: return "\u{fc61}"
        case .trendingDownBold: return "\u{fc62}"
        case .trendingDownFilled: return "\u{fc63}"
        case .trendingDownLight: return "\u{fc64}"
        case .trendingDownRegular: return "\u{fc65}"
        case .trendingFilled: return "\u{fc66}"
        case .trendingLight: return "\u{fc67}"
        case .trendingRegular: return "\u{fc68}"
        case .trimBold: return "\u{fc69}"
        case .trimLight: return "\u{fc6a}"
        case .trimRegular: return "\u{fc6b}"
        case .twoColumnBold: return "\u{fc6c}"
        case .twoColumnLight: return "\u{fc6d}"
        case .twoColumnRegular: return "\u{fc6e}"
        case .twoWayVoiceStreamBold: return "\u{fc6f}"
        case .twoWayVoiceStreamFilled: return "\u{fc70}"
        case .twoWayVoiceStreamLight: return "\u{fc71}"
        case .twoWayVoiceStreamRegular: return "\u{fc72}"
        case .ucmCloudBold: return "\u{fc73}"
        case .ucmCloudLight: return "\u{fc74}"
        case .ucmCloudRegular: return "\u{fc75}"
        case .unblockBold: return "\u{fc76}"
        case .unblockFilled: return "\u{fc77}"
        case .unblockLight: return "\u{fc78}"
        case .unblockRegular: return "\u{fc79}"
        case .underlineBold: return "\u{fc7a}"
        case .underlineFilled: return "\u{fc7b}"
        case .underlineLight: return "\u{fc7c}"
        case .underlineRegular: return "\u{fc7d}"
        case .undoBold: return "\u{fc7e}"
        case .undoLight: return "\u{fc7f}"
        case .undoRegular: return "\u{fc80}"
        case .unlinkBold: return "\u{fc81}"
        case .unlinkLight: return "\u{fc82}"
        case .unlinkRegular: return "\u{fc83}"
        case .unreadBold: return "\u{fc84}"
        case .unreadFilled: return "\u{fc85}"
        case .unreadLight: return "\u{fc86}"
        case .unreadRegular: return "\u{fc87}"
        case .unsecureUnlockedBold: return "\u{fc88}"
        case .unsecureUnlockedFilled: return "\u{fc89}"
        case .unsecureUnlockedLight: return "\u{fc8a}"
        case .unsecureUnlockedRegular: return "\u{fc8b}"
        case .unsortedBold: return "\u{fc8c}"
        case .unsortedLight: return "\u{fc8d}"
        case .unsortedRegular: return "\u{fc8e}"
        case .updateFileShareBold: return "\u{fc8f}"
        case .updateFileShareLight: return "\u{fc90}"
        case .updateFileShareRegular: return "\u{fc91}"
        case .uploadBold: return "\u{fc92}"
        case .uploadImageBold: return "\u{fc93}"
        case .uploadImageLight: return "\u{fc94}"
        case .uploadImageRegular: return "\u{fc95}"
        case .uploadLight: return "\u{fc96}"
        case .uploadRegular: return "\u{fc97}"
        case .urgentVoicemailBold: return "\u{fc98}"
        case .urgentVoicemailFilled: return "\u{fc99}"
        case .usbBold: return "\u{fc9a}"
        case .usbHeadsetBold: return "\u{fc9b}"
        case .usbHeadsetLight: return "\u{fc9c}"
        case .usbHeadsetMutedBold: return "\u{fc9d}"
        case .usbHeadsetMutedLight: return "\u{fc9e}"
        case .usbHeadsetMutedRegular: return "\u{fc9f}"
        case .usbHeadsetRegular: return "\u{fca0}"
        case .usbLight: return "\u{fca1}"
        case .usbRegular: return "\u{fca2}"
        case .userBold: return "\u{fca3}"
        case .userDeactivateBold: return "\u{fca4}"
        case .userDeactivateLight: return "\u{fca5}"
        case .userDeactivateRegular: return "\u{fca6}"
        case .userFilled: return "\u{fca7}"
        case .userLight: return "\u{fca8}"
        case .userRegular: return "\u{fca9}"
        case .userSecurityStatusBold: return "\u{fcaa}"
        case .userSecurityStatusFilled: return "\u{fcab}"
        case .userSecurityStatusLight: return "\u{fcac}"
        case .userSecurityStatusRegular: return "\u{fcad}"
        case .videoBlurBold: return "\u{fcae}"
        case .videoBlurFilled: return "\u{fcaf}"
        case .videoBlurLight: return "\u{fcb0}"
        case .videoBlurRegular: return "\u{fcb1}"
        case .videoBold: return "\u{fcb2}"
        case .videoEffectBold: return "\u{fcb3}"
        case .videoEffectFilled: return "\u{fcb4}"
        case .videoEffectLight: return "\u{fcb5}"
        case .videoEffectRegular: return "\u{fcb6}"
        case .videoFilled: return "\u{fcb7}"
        case .videoLayoutBold: return "\u{fcb8}"
        case .videoLayoutCustomBold: return "\u{fcb9}"
        case .videoLayoutCustomFilled: return "\u{fcba}"
        case .videoLayoutCustomLight: return "\u{fcbb}"
        case .videoLayoutCustomRegular: return "\u{fcbc}"
        case .videoLayoutEqualBold: return "\u{fcbd}"
        case .videoLayoutEqualDualBold: return "\u{fcbe}"
        case .videoLayoutEqualDualLight: return "\u{fcbf}"
        case .videoLayoutEqualDualRegular: return "\u{fcc0}"
        case .videoLayoutEqualFilled: return "\u{fcc1}"
        case .videoLayoutEqualLight: return "\u{fcc2}"
        case .videoLayoutEqualRegular: return "\u{fcc3}"
        case .videoLayoutFilled: return "\u{fcc4}"
        case .videoLayoutLight: return "\u{fcc5}"
        case .videoLayoutOverlayBold: return "\u{fcc6}"
        case .videoLayoutOverlayFilled: return "\u{fcc7}"
        case .videoLayoutOverlayLight: return "\u{fcc8}"
        case .videoLayoutOverlayRegular: return "\u{fcc9}"
        case .videoLayoutPresentationBold: return "\u{fcca}"
        case .videoLayoutPresentationFilled: return "\u{fccb}"
        case .videoLayoutPresentationLight: return "\u{fccc}"
        case .videoLayoutPresentationRegular: return "\u{fccd}"
        case .videoLayoutPresenterDominantBold: return "\u{fcce}"
        case .videoLayoutPresenterDominantLight: return "\u{fccf}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcd0}"
        case .videoLayoutProminentBold: return "\u{fcd1}"
        case .videoLayoutProminentFilled: return "\u{fcd2}"
        case .videoLayoutProminentLight: return "\u{fcd3}"
        case .videoLayoutProminentRegular: return "\u{fcd4}"
        case .videoLayoutRegular: return "\u{fcd5}"
        case .videoLayoutShareDominantBold: return "\u{fcd6}"
        case .videoLayoutShareDominantLight: return "\u{fcd7}"
        case .videoLayoutShareDominantRegular: return "\u{fcd8}"
        case .videoLayoutSingleBold: return "\u{fcd9}"
        case .videoLayoutSingleFilled: return "\u{fcda}"
        case .videoLayoutSingleLight: return "\u{fcdb}"
        case .videoLayoutSingleRegular: return "\u{fcdc}"
        case .videoLayoutSpeakerBold: return "\u{fcdd}"
        case .videoLayoutSpeakerFilled: return "\u{fcde}"
        case .videoLayoutSpeakerLight: return "\u{fcdf}"
        case .videoLayoutSpeakerRegular: return "\u{fce0}"
        case .videoLayoutStackBold: return "\u{fce1}"
        case .videoLayoutStackFilled: return "\u{fce2}"
        case .videoLayoutStackLight: return "\u{fce3}"
        case .videoLayoutStackRegular: return "\u{fce4}"
        case .videoLayoutVideoDominantBold: return "\u{fce5}"
        case .videoLayoutVideoDominantFilled: return "\u{fce6}"
        case .videoLayoutVideoDominantLight: return "\u{fce7}"
        case .videoLayoutVideoDominantRegular: return "\u{fce8}"
        case .videoLight: return "\u{fce9}"
        case .videoPlusBold: return "\u{fcea}"
        case .videoPlusFilled: return "\u{fceb}"
        case .videoPlusLight: return "\u{fcec}"
        case .videoPlusRegular: return "\u{fced}"
        case .videoRegular: return "\u{fcee}"
        case .videoSpeakerTrackBold: return "\u{fcef}"
        case .videoSpeakerTrackFilled: return "\u{fcf0}"
        case .videoSpeakerTrackLight: return "\u{fcf1}"
        case .videoSpeakerTrackRegular: return "\u{fcf2}"
        case .viewAllBold: return "\u{fcf3}"
        case .viewAllLight: return "\u{fcf4}"
        case .viewAllRegular: return "\u{fcf5}"
        case .viewListBold: return "\u{fcf6}"
        case .viewListFilled: return "\u{fcf7}"
        case .viewListLight: return "\u{fcf8}"
        case .viewListRegular: return "\u{fcf9}"
        case .viewStackedBold: return "\u{fcfa}"
        case .viewStackedFilled: return "\u{fcfb}"
        case .viewStackedLight: return "\u{fcfc}"
        case .viewStackedRegular: return "\u{fcfd}"
        case .viewThumbnailBold: return "\u{fcfe}"
        case .viewThumbnailFilled: return "\u{fcff}"
        case .viewThumbnailLight: return "\u{fd00}"
        case .viewThumbnailRegular: return "\u{fd01}"
        case .visionproBold: return "\u{fd02}"
        case .visionproFilled: return "\u{fd03}"
        case .visionproLight: return "\u{fd04}"
        case .visionproMoveCallInBold: return "\u{fd05}"
        case .visionproMoveCallInFilled: return "\u{fd06}"
        case .visionproMoveCallInLight: return "\u{fd07}"
        case .visionproMoveCallInOutBold: return "\u{fd08}"
        case .visionproMoveCallInOutFilled: return "\u{fd09}"
        case .visionproMoveCallInOutLight: return "\u{fd0a}"
        case .visionproMoveCallInOutRegular: return "\u{fd0b}"
        case .visionproMoveCallInRegular: return "\u{fd0c}"
        case .visionproMoveCallOutBold: return "\u{fd0d}"
        case .visionproMoveCallOutFilled: return "\u{fd0e}"
        case .visionproMoveCallOutLight: return "\u{fd0f}"
        case .visionproMoveCallOutRegular: return "\u{fd10}"
        case .visionproRegular: return "\u{fd11}"
        case .voicemailBold: return "\u{fd12}"
        case .voicemailFilled: return "\u{fd13}"
        case .voicemailLight: return "\u{fd14}"
        case .voicemailRegular: return "\u{fd15}"
        case .vpnBold: return "\u{fd16}"
        case .vpnFilled: return "\u{fd17}"
        case .vpnLight: return "\u{fd18}"
        case .vpnRegular: return "\u{fd19}"
        case .vscBold: return "\u{fd1a}"
        case .vscLight: return "\u{fd1b}"
        case .vscRegular: return "\u{fd1c}"
        case .waffleMenuBold: return "\u{fd1d}"
        case .waffleMenuLight: return "\u{fd1e}"
        case .waffleMenuRegular: return "\u{fd1f}"
        case .waitingRoomBold: return "\u{fd20}"
        case .waitingRoomFilled: return "\u{fd21}"
        case .waitingRoomLight: return "\u{fd22}"
        case .waitingRoomRegular: return "\u{fd23}"
        case .wallpaperBold: return "\u{fd24}"
        case .wallpaperLight: return "\u{fd25}"
        case .wallpaperRegular: return "\u{fd26}"
        case .warningBadgeFilled: return "\u{fd27}"
        case .warningBold: return "\u{fd28}"
        case .warningFilled: return "\u{fd29}"
        case .warningLight: return "\u{fd2a}"
        case .warningRegular: return "\u{fd2b}"
        case .webexBoardBold: return "\u{fd2c}"
        case .webexBoardLight: return "\u{fd2d}"
        case .webexBoardRegular: return "\u{fd2e}"
        case .webexCodecPlusBold: return "\u{fd2f}"
        case .webexCodecPlusLight: return "\u{fd30}"
        case .webexCodecPlusRegular: return "\u{fd31}"
        case .webexDeskCameraBold: return "\u{fd32}"
        case .webexDeskCameraLight: return "\u{fd33}"
        case .webexDeskCameraRegular: return "\u{fd34}"
        case .webexHelixBold: return "\u{fd35}"
        case .webexHelixLight: return "\u{fd36}"
        case .webexHelixRegular: return "\u{fd37}"
        case .webexMeetingsBold: return "\u{fd38}"
        case .webexMeetingsFilled: return "\u{fd39}"
        case .webexMeetingsLight: return "\u{fd3a}"
        case .webexMeetingsRegular: return "\u{fd3b}"
        case .webexQuadCameraBold: return "\u{fd3c}"
        case .webexQuadCameraLight: return "\u{fd3d}"
        case .webexQuadCameraRegular: return "\u{fd3e}"
        case .webexRoomKitBold: return "\u{fd3f}"
        case .webexRoomKitLight: return "\u{fd40}"
        case .webexRoomKitPlusBold: return "\u{fd41}"
        case .webexRoomKitPlusLight: return "\u{fd42}"
        case .webexRoomKitPlusRegular: return "\u{fd43}"
        case .webexRoomKitRegular: return "\u{fd44}"
        case .webexShareBold: return "\u{fd45}"
        case .webexShareLight: return "\u{fd46}"
        case .webexShareRegular: return "\u{fd47}"
        case .webexTeamsBold: return "\u{fd48}"
        case .webexTeamsFilled: return "\u{fd49}"
        case .webexTeamsLight: return "\u{fd4a}"
        case .webexTeamsNewBold: return "\u{fd4b}"
        case .webexTeamsNewFilled: return "\u{fd4c}"
        case .webexTeamsNewLight: return "\u{fd4d}"
        case .webexTeamsNewRegular: return "\u{fd4e}"
        case .webexTeamsRegular: return "\u{fd4f}"
        case .webexTeamsRemoveBold: return "\u{fd50}"
        case .webexTeamsRemoveLight: return "\u{fd51}"
        case .webexTeamsRemoveRegular: return "\u{fd52}"
        case .webhookBold: return "\u{fd53}"
        case .webhookLight: return "\u{fd54}"
        case .webhookRegular: return "\u{fd55}"
        case .webinarBold: return "\u{fd56}"
        case .webinarFilled: return "\u{fd57}"
        case .webinarLight: return "\u{fd58}"
        case .webinarRegular: return "\u{fd59}"
        case .weeklyRecurringScheduleBold: return "\u{fd5a}"
        case .weeklyRecurringScheduleLight: return "\u{fd5b}"
        case .weeklyRecurringScheduleRegular: return "\u{fd5c}"
        case .whisperAnnouncementBold: return "\u{fd5d}"
        case .whisperAnnouncementFilled: return "\u{fd5e}"
        case .whisperAnnouncementLight: return "\u{fd5f}"
        case .whisperAnnouncementRegular: return "\u{fd60}"
        case .whisperCoachBold: return "\u{fd61}"
        case .whisperCoachFilled: return "\u{fd62}"
        case .whisperCoachLight: return "\u{fd63}"
        case .whisperCoachRegular: return "\u{fd64}"
        case .whiteboardBold: return "\u{fd65}"
        case .whiteboardContentBold: return "\u{fd66}"
        case .whiteboardContentFilled: return "\u{fd67}"
        case .whiteboardContentLight: return "\u{fd68}"
        case .whiteboardContentRegular: return "\u{fd69}"
        case .whiteboardFilled: return "\u{fd6a}"
        case .whiteboardLight: return "\u{fd6b}"
        case .whiteboardRegular: return "\u{fd6c}"
        case .widgetBold: return "\u{fd6d}"
        case .widgetFilled: return "\u{fd6e}"
        case .widgetLight: return "\u{fd6f}"
        case .widgetRegular: return "\u{fd70}"
        case .wifiBold: return "\u{fd71}"
        case .wifiErrorBold: return "\u{fd72}"
        case .wifiErrorLight: return "\u{fd73}"
        case .wifiErrorRegular: return "\u{fd74}"
        case .wifiLight: return "\u{fd75}"
        case .wifiRegular: return "\u{fd76}"
        case .wifiSignalGoodBold: return "\u{fd77}"
        case .wifiSignalGoodLight: return "\u{fd78}"
        case .wifiSignalGoodRegular: return "\u{fd79}"
        case .wifiSignalPoorBold: return "\u{fd7a}"
        case .wifiSignalPoorLight: return "\u{fd7b}"
        case .wifiSignalPoorRegular: return "\u{fd7c}"
        case .wifiSignalUnstableBold: return "\u{fd7d}"
        case .wifiSignalUnstableLight: return "\u{fd7e}"
        case .wifiSignalUnstableRegular: return "\u{fd7f}"
        case .windowCornerScrubBold: return "\u{fd80}"
        case .windowCornerScrubLight: return "\u{fd81}"
        case .windowCornerScrubRegular: return "\u{fd82}"
        case .windowRightCornerScrubBold: return "\u{fd83}"
        case .windowRightCornerScrubLight: return "\u{fd84}"
        case .windowRightCornerScrubRegular: return "\u{fd85}"
        case .windowVerticalScrubBold: return "\u{fd86}"
        case .windowVerticalScrubLight: return "\u{fd87}"
        case .windowVerticalScrubRegular: return "\u{fd88}"
        case .workflowDeploymentsBold: return "\u{fd89}"
        case .workflowDeploymentsFilled: return "\u{fd8a}"
        case .workflowDeploymentsLight: return "\u{fd8b}"
        case .workflowDeploymentsRegular: return "\u{fd8c}"
        case .workphoneBold: return "\u{fd8d}"
        case .workphoneLight: return "\u{fd8e}"
        case .workphoneRegular: return "\u{fd8f}"
        case .zoomInBold: return "\u{fd90}"
        case .zoomInLight: return "\u{fd91}"
        case .zoomInRegular: return "\u{fd92}"
        case .zoomOutBold: return "\u{fd93}"
        case .zoomOutLight: return "\u{fd94}"
        case .zoomOutRegular: return "\u{fd95}"
