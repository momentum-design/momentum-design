...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .numberLight: return "\u{f89b}"
        case .numberRegular: return "\u{f89c}"
        case .oldRemoteBold: return "\u{f89d}"
        case .oldRemoteLight: return "\u{f89e}"
        case .oldRemoteRegular: return "\u{f89f}"
        case .oldTouchBold: return "\u{f8a0}"
        case .oldTouchLight: return "\u{f8a1}"
        case .oldTouchRegular: return "\u{f8a2}"
        case .oneColumnBold: return "\u{f8a3}"
        case .oneColumnLight: return "\u{f8a4}"
        case .oneColumnRegular: return "\u{f8a5}"
        case .oneTimeBold: return "\u{f8a6}"
        case .oneTimeLight: return "\u{f8a7}"
        case .oneTimeRegular: return "\u{f8a8}"
        case .openInFolderBold: return "\u{f8a9}"
        case .openInFolderFilled: return "\u{f8aa}"
        case .openInFolderLight: return "\u{f8ab}"
        case .openInFolderRegular: return "\u{f8ac}"
        case .openPagesBold: return "\u{f8ad}"
        case .openPagesLight: return "\u{f8ae}"
        case .openPagesRegular: return "\u{f8af}"
        case .otherNumberBold: return "\u{f8b0}"
        case .otherNumberFilled: return "\u{f8b1}"
        case .otherNumberLight: return "\u{f8b2}"
        case .otherNumberRegular: return "\u{f8b3}"
        case .otherNumberWarningBold: return "\u{f8b4}"
        case .otherNumberWarningLight: return "\u{f8b5}"
        case .otherNumberWarningRegular: return "\u{f8b6}"
        case .outgoingCallLegacyBold: return "\u{f8b7}"
        case .outgoingCallLegacyFilled: return "\u{f8b8}"
        case .outgoingCallLegacyLight: return "\u{f8b9}"
        case .outgoingCallLegacyRegular: return "\u{f8ba}"
        case .overflowLeftBold: return "\u{f8bb}"
        case .overflowLeftLight: return "\u{f8bc}"
        case .overflowLeftRegular: return "\u{f8bd}"
        case .overflowRightBold: return "\u{f8be}"
        case .overflowRightLight: return "\u{f8bf}"
        case .overflowRightRegular: return "\u{f8c0}"
        case .pairedCameraBold: return "\u{f8c1}"
        case .pairedCameraLight: return "\u{f8c2}"
        case .pairedCameraRegular: return "\u{f8c3}"
        case .pairedDeviceBold: return "\u{f8c4}"
        case .pairedDeviceLight: return "\u{f8c5}"
        case .pairedDeviceRegular: return "\u{f8c6}"
        case .pairedHandsetBold: return "\u{f8c7}"
        case .pairedHandsetLight: return "\u{f8c8}"
        case .pairedHandsetRegular: return "\u{f8c9}"
        case .pairingBold: return "\u{f8ca}"
        case .pairingLight: return "\u{f8cb}"
        case .pairingRegular: return "\u{f8cc}"
        case .parenthesisBold: return "\u{f8cd}"
        case .parenthesisFilled: return "\u{f8ce}"
        case .parenthesisLight: return "\u{f8cf}"
        case .parenthesisRegular: return "\u{f8d0}"
        case .parkedBold: return "\u{f8d1}"
        case .parkedFilled: return "\u{f8d2}"
        case .parkedLight: return "\u{f8d3}"
        case .parkedRegular: return "\u{f8d4}"
        case .parseBold: return "\u{f8d5}"
        case .parseLight: return "\u{f8d6}"
        case .parseRegular: return "\u{f8d7}"
        case .partialBold: return "\u{f8d8}"
        case .partialLight: return "\u{f8d9}"
        case .partialRegular: return "\u{f8da}"
        case .participantAddBold: return "\u{f8db}"
        case .participantAddLight: return "\u{f8dc}"
        case .participantAddRegular: return "\u{f8dd}"
        case .participantBlockedBold: return "\u{f8de}"
        case .participantBlockedLight: return "\u{f8df}"
        case .participantBlockedRegular: return "\u{f8e0}"
        case .participantBold: return "\u{f8e1}"
        case .participantFilled: return "\u{f8e2}"
        case .participantLight: return "\u{f8e3}"
        case .participantListBold: return "\u{f8e4}"
        case .participantListFilled: return "\u{f8e5}"
        case .participantListLight: return "\u{f8e6}"
        case .participantListRegular: return "\u{f8e7}"
        case .participantRegular: return "\u{f8e8}"
        case .participantRemoveBold: return "\u{f8e9}"
        case .participantRemoveLight: return "\u{f8ea}"
        case .participantRemoveRegular: return "\u{f8eb}"
        case .participantSpeakerBold: return "\u{f8ec}"
        case .participantSpeakerFilled: return "\u{f8ed}"
        case .participantSpeakerLight: return "\u{f8ee}"
        case .participantSpeakerRegular: return "\u{f8ef}"
        case .participantUnknownBold: return "\u{f8f0}"
        case .participantUnknownLight: return "\u{f8f1}"
        case .participantUnknownRegular: return "\u{f8f2}"
        case .passMouseBold: return "\u{f8f3}"
        case .passMouseLight: return "\u{f8f4}"
        case .passMouseRegular: return "\u{f8f5}"
        case .pauseBadgeFilled: return "\u{f8f6}"
        case .pauseBold: return "\u{f8f7}"
        case .pauseFilled: return "\u{f8f8}"
        case .pauseInteractionBold: return "\u{f8f9}"
        case .pauseInteractionFilled: return "\u{f8fa}"
        case .pauseInteractionLight: return "\u{f8fb}"
        case .pauseInteractionRegular: return "\u{f8fc}"
        case .pauseLight: return "\u{f8fd}"
        case .pauseRegular: return "\u{f8fe}"
        case .peopleAddBold: return "\u{f8ff}"
        case .peopleAddFilled: return "\u{f900}"
        case .peopleAddLight: return "\u{f901}"
        case .peopleAddRegular: return "\u{f902}"
        case .peopleBold: return "\u{f903}"
        case .peopleCircleBold: return "\u{f904}"
        case .peopleCircleFilled: return "\u{f905}"
        case .peopleCircleLight: return "\u{f906}"
        case .peopleCircleRegular: return "\u{f907}"
        case .peopleFilled: return "\u{f908}"
        case .peopleInsightsBold: return "\u{f909}"
        case .peopleInsightsFilled: return "\u{f90a}"
        case .peopleInsightsLight: return "\u{f90b}"
        case .peopleInsightsRegular: return "\u{f90c}"
        case .peopleLight: return "\u{f90d}"
        case .peopleManageBold: return "\u{f90e}"
        case .peopleManageFilled: return "\u{f90f}"
        case .peopleManageLight: return "\u{f910}"
        case .peopleManageRegular: return "\u{f911}"
        case .peopleRegular: return "\u{f912}"
        case .phoneAlertBold: return "\u{f913}"
        case .phoneAlertLight: return "\u{f914}"
        case .phoneAlertRegular: return "\u{f915}"
        case .phoneBadgeFilled: return "\u{f916}"
        case .phoneBold: return "\u{f917}"
        case .phoneFilled: return "\u{f918}"
        case .phoneLight: return "\u{f919}"
        case .phoneMutedBold: return "\u{f91a}"
        case .phoneMutedLight: return "\u{f91b}"
        case .phoneMutedRegular: return "\u{f91c}"
        case .phonePrivateBold: return "\u{f91d}"
        case .phonePrivateLight: return "\u{f91e}"
        case .phonePrivateRegular: return "\u{f91f}"
        case .phoneRegular: return "\u{f920}"
        case .phoneReplyAllBold: return "\u{f921}"
        case .phoneReplyAllLight: return "\u{f922}"
        case .phoneReplyAllRegular: return "\u{f923}"
        case .phoneReplyBold: return "\u{f924}"
        case .phoneReplyLight: return "\u{f925}"
        case .phoneReplyRegular: return "\u{f926}"
        case .pickerBold: return "\u{f927}"
        case .pickerLight: return "\u{f928}"
        case .pickerRegular: return "\u{f929}"
        case .pieChartBold: return "\u{f92a}"
        case .pieChartFilled: return "\u{f92b}"
        case .pieChartLight: return "\u{f92c}"
        case .pieChartRegular: return "\u{f92d}"
        case .pinBold: return "\u{f92e}"
        case .pinFilled: return "\u{f92f}"
        case .pinLight: return "\u{f930}"
        case .pinListActivityBold: return "\u{f931}"
        case .pinListActivityLight: return "\u{f932}"
        case .pinListActivityRegular: return "\u{f933}"
        case .pinListBold: return "\u{f934}"
        case .pinListLight: return "\u{f935}"
        case .pinListRegular: return "\u{f936}"
        case .pinMutedBold: return "\u{f937}"
        case .pinMutedFilled: return "\u{f938}"
        case .pinMutedLight: return "\u{f939}"
        case .pinMutedRegular: return "\u{f93a}"
        case .pinRegular: return "\u{f93b}"
        case .pipBold: return "\u{f93c}"
        case .pipEnterBold: return "\u{f93d}"
        case .pipEnterLight: return "\u{f93e}"
        case .pipEnterRegular: return "\u{f93f}"
        case .pipExitBold: return "\u{f940}"
        case .pipExitLight: return "\u{f941}"
        case .pipExitRegular: return "\u{f942}"
        case .pipFilled: return "\u{f943}"
        case .pipLight: return "\u{f944}"
        case .pipRegular: return "\u{f945}"
        case .placeholderBold: return "\u{f946}"
        case .placeholderFilled: return "\u{f947}"
        case .placeholderLight: return "\u{f948}"
        case .placeholderRegular: return "\u{f949}"
        case .playBold: return "\u{f94a}"
        case .playCircleBold: return "\u{f94b}"
        case .playCircleFilled: return "\u{f94c}"
        case .playCircleLight: return "\u{f94d}"
        case .playCircleRegular: return "\u{f94e}"
        case .playFilled: return "\u{f94f}"
        case .playLight: return "\u{f950}"
        case .playRegular: return "\u{f951}"
        case .plugAcBold: return "\u{f952}"
        case .plugAcLight: return "\u{f953}"
        case .plugAcRegular: return "\u{f954}"
        case .plusBold: return "\u{f955}"
        case .plusCircleBold: return "\u{f956}"
        case .plusCircleFilled: return "\u{f957}"
        case .plusCircleLight: return "\u{f958}"
        case .plusCircleRegular: return "\u{f959}"
        case .plusLight: return "\u{f95a}"
        case .plusRegular: return "\u{f95b}"
        case .pmrBold: return "\u{f95c}"
        case .pmrFilled: return "\u{f95d}"
        case .pmrLight: return "\u{f95e}"
        case .pmrRegular: return "\u{f95f}"
        case .pollBold: return "\u{f960}"
        case .pollFilled: return "\u{f961}"
        case .pollLight: return "\u{f962}"
        case .pollRegular: return "\u{f963}"
        case .popInBold: return "\u{f964}"
        case .popInLight: return "\u{f965}"
        case .popInRegular: return "\u{f966}"
        case .popOutBold: return "\u{f967}"
        case .popOutLight: return "\u{f968}"
        case .popOutRegular: return "\u{f969}"
        case .popUpBold: return "\u{f96a}"
        case .popUpLight: return "\u{f96b}"
        case .popUpRegular: return "\u{f96c}"
        case .portraitLandscapeBold: return "\u{f96d}"
        case .portraitLandscapeLight: return "\u{f96e}"
        case .portraitLandscapeRegular: return "\u{f96f}"
        case .potentialFraudBold: return "\u{f970}"
        case .potentialFraudFilled: return "\u{f971}"
        case .potentialFraudLight: return "\u{f972}"
        case .potentialFraudRegular: return "\u{f973}"
        case .powerAcBold: return "\u{f974}"
        case .powerAcLight: return "\u{f975}"
        case .powerAcRegular: return "\u{f976}"
        case .powerBold: return "\u{f977}"
        case .powerLight: return "\u{f978}"
        case .powerRegular: return "\u{f979}"
        case .preHeaderBold: return "\u{f97a}"
        case .preHeaderLight: return "\u{f97b}"
        case .preHeaderRegular: return "\u{f97c}"
        case .premiumBold: return "\u{f97d}"
        case .premiumLight: return "\u{f97e}"
        case .premiumRegular: return "\u{f97f}"
        case .presentationBold: return "\u{f980}"
        case .presentationLight: return "\u{f981}"
        case .presentationRegular: return "\u{f982}"
        case .preventDownloadBold: return "\u{f983}"
        case .preventDownloadFilled: return "\u{f984}"
        case .preventDownloadLight: return "\u{f985}"
        case .preventDownloadRegular: return "\u{f986}"
        case .primaryParticipantBold: return "\u{f987}"
        case .primaryParticipantFilled: return "\u{f988}"
        case .primaryParticipantLight: return "\u{f989}"
        case .primaryParticipantRegular: return "\u{f98a}"
        case .printBold: return "\u{f98b}"
        case .printLight: return "\u{f98c}"
        case .printRegular: return "\u{f98d}"
        case .priorityBadgeFilled: return "\u{f98e}"
        case .priorityCircleBold: return "\u{f98f}"
        case .priorityCircleFilled: return "\u{f990}"
        case .priorityCircleLight: return "\u{f991}"
        case .priorityCircleRegular: return "\u{f992}"
        case .priorityCircleTwoBold: return "\u{f993}"
        case .priorityCircleTwoFilled: return "\u{f994}"
        case .priorityCircleTwoLight: return "\u{f995}"
        case .priorityCircleTwoRegular: return "\u{f996}"
        case .priorityWaveBold: return "\u{f997}"
        case .priorityWaveLight: return "\u{f998}"
        case .priorityWaveRegular: return "\u{f999}"
        case .privacyCircleBold: return "\u{f99a}"
        case .privacyCircleFilled: return "\u{f99b}"
        case .privacyCircleLight: return "\u{f99c}"
        case .privacyCircleRegular: return "\u{f99d}"
        case .privateBold: return "\u{f99e}"
        case .privateCircleBold: return "\u{f99f}"
        case .privateCircleFilled: return "\u{f9a0}"
        case .privateCircleLight: return "\u{f9a1}"
        case .privateCircleRegular: return "\u{f9a2}"
        case .privateLight: return "\u{f9a3}"
        case .privateMeetingBold: return "\u{f9a4}"
        case .privateMeetingLight: return "\u{f9a5}"
        case .privateMeetingRegular: return "\u{f9a6}"
        case .privateRegular: return "\u{f9a7}"
        case .productDemoBold: return "\u{f9a8}"
        case .productDemoLight: return "\u{f9a9}"
        case .productDemoRegular: return "\u{f9aa}"
        case .promptsAiBold: return "\u{f9ab}"
        case .promptsAiLight: return "\u{f9ac}"
        case .promptsAiRegular: return "\u{f9ad}"
        case .proximityBold: return "\u{f9ae}"
        case .proximityLight: return "\u{f9af}"
        case .proximityMutedBold: return "\u{f9b0}"
        case .proximityMutedLight: return "\u{f9b1}"
        case .proximityMutedRegular: return "\u{f9b2}"
        case .proximityRegular: return "\u{f9b3}"
        case .proximityVideoBold: return "\u{f9b4}"
        case .proximityVideoLight: return "\u{f9b5}"
        case .proximityVideoRegular: return "\u{f9b6}"
        case .ptoPresenceBold: return "\u{f9b7}"
        case .ptoPresenceFilled: return "\u{f9b8}"
        case .ptoPresenceLight: return "\u{f9b9}"
        case .ptoPresenceRegular: return "\u{f9ba}"
        case .pullCallBold: return "\u{f9bb}"
        case .pullCallFilled: return "\u{f9bc}"
        case .pullCallLight: return "\u{f9bd}"
        case .pullCallRegular: return "\u{f9be}"
        case .purchaseOrderBold: return "\u{f9bf}"
        case .purchaseOrderFilled: return "\u{f9c0}"
        case .purchaseOrderLight: return "\u{f9c1}"
        case .purchaseOrderRegular: return "\u{f9c2}"
        case .qABold: return "\u{f9c3}"
        case .qAFilled: return "\u{f9c4}"
        case .qALight: return "\u{f9c5}"
        case .qARegular: return "\u{f9c6}"
        case .qrCodeBold: return "\u{f9c7}"
        case .qrCodeLight: return "\u{f9c8}"
        case .qrCodeRegular: return "\u{f9c9}"
        case .qrCodeScanBold: return "\u{f9ca}"
        case .qrCodeScanLight: return "\u{f9cb}"
        case .qrCodeScanRegular: return "\u{f9cc}"
        case .qualityBold: return "\u{f9cd}"
        case .qualityLight: return "\u{f9ce}"
        case .qualityRegular: return "\u{f9cf}"
        case .queueContactBold: return "\u{f9d0}"
        case .queueContactFilled: return "\u{f9d1}"
        case .queueContactLight: return "\u{f9d2}"
        case .queueContactRegular: return "\u{f9d3}"
        case .queuedInteractionBold: return "\u{f9d4}"
        case .queuedInteractionFilled: return "\u{f9d5}"
        case .queuedInteractionLight: return "\u{f9d6}"
        case .queuedInteractionRegular: return "\u{f9d7}"
        case .quietBold: return "\u{f9d8}"
        case .quietHoursPresenceBold: return "\u{f9d9}"
        case .quietHoursPresenceFilled: return "\u{f9da}"
        case .quietHoursPresenceLight: return "\u{f9db}"
        case .quietHoursPresenceRegular: return "\u{f9dc}"
        case .quietLight: return "\u{f9dd}"
        case .quietRegular: return "\u{f9de}"
        case .radioButtonGroupBold: return "\u{f9df}"
        case .radioButtonGroupLight: return "\u{f9e0}"
        case .radioButtonGroupRegular: return "\u{f9e1}"
        case .raiseHandBold: return "\u{f9e2}"
        case .raiseHandCircleFilled: return "\u{f9e3}"
        case .raiseHandFilled: return "\u{f9e4}"
        case .raiseHandLight: return "\u{f9e5}"
        case .raiseHandRegular: return "\u{f9e6}"
        case .ramBold: return "\u{f9e7}"
        case .ramLight: return "\u{f9e8}"
        case .ramRegular: return "\u{f9e9}"
        case .reactionsBold: return "\u{f9ea}"
        case .reactionsFilled: return "\u{f9eb}"
        case .reactionsLight: return "\u{f9ec}"
        case .reactionsRegular: return "\u{f9ed}"
        case .reactivateBold: return "\u{f9ee}"
        case .reactivateLight: return "\u{f9ef}"
        case .reactivateRegular: return "\u{f9f0}"
        case .receiveVoiceBold: return "\u{f9f1}"
        case .receiveVoiceFilled: return "\u{f9f2}"
        case .receiveVoiceLight: return "\u{f9f3}"
        case .receiveVoiceRegular: return "\u{f9f4}"
        case .recentsBold: return "\u{f9f5}"
        case .recentsFilled: return "\u{f9f6}"
        case .recentsLight: return "\u{f9f7}"
        case .recentsPresenceBadgeFilled: return "\u{f9f8}"
        case .recentsPresenceBold: return "\u{f9f9}"
        case .recentsPresenceFilled: return "\u{f9fa}"
        case .recentsPresenceLight: return "\u{f9fb}"
        case .recentsPresenceRegular: return "\u{f9fc}"
        case .recentsRegular: return "\u{f9fd}"
        case .recordActiveBadgeFilled: return "\u{f9fe}"
        case .recordActiveBold: return "\u{f9ff}"
        case .recordActiveFilled: return "\u{fa00}"
        case .recordActiveLight: return "\u{fa01}"
        case .recordActiveRegular: return "\u{fa02}"
        case .recordBold: return "\u{fa03}"
        case .recordFilled: return "\u{fa04}"
        case .recordLight: return "\u{fa05}"
        case .recordPausedBadgeFilled: return "\u{fa06}"
        case .recordPausedBold: return "\u{fa07}"
        case .recordPausedFilled: return "\u{fa08}"
        case .recordPausedLight: return "\u{fa09}"
        case .recordPausedRegular: return "\u{fa0a}"
        case .recordRegular: return "\u{fa0b}"
        case .recurringBold: return "\u{fa0c}"
        case .recurringLight: return "\u{fa0d}"
        case .recurringOffBold: return "\u{fa0e}"
        case .recurringOffLight: return "\u{fa0f}"
        case .recurringOffRegular: return "\u{fa10}"
        case .recurringRegular: return "\u{fa11}"
        case .redoBold: return "\u{fa12}"
        case .redoLight: return "\u{fa13}"
        case .redoRegular: return "\u{fa14}"
        case .refreshBold: return "\u{fa15}"
        case .refreshLight: return "\u{fa16}"
        case .refreshRegular: return "\u{fa17}"
        case .remoteDesktopControlBold: return "\u{fa18}"
        case .remoteDesktopControlFilled: return "\u{fa19}"
        case .remoteDesktopControlLight: return "\u{fa1a}"
        case .remoteDesktopControlRegular: return "\u{fa1b}"
        case .removeBold: return "\u{fa1c}"
        case .removeFilled: return "\u{fa1d}"
        case .removeLight: return "\u{fa1e}"
        case .removeRegular: return "\u{fa1f}"
        case .replyBold: return "\u{fa20}"
        case .replyFilled: return "\u{fa21}"
        case .replyLight: return "\u{fa22}"
        case .replyListBold: return "\u{fa23}"
        case .replyListFilled: return "\u{fa24}"
        case .replyListLight: return "\u{fa25}"
        case .replyListRegular: return "\u{fa26}"
        case .replyPrivatelyBold: return "\u{fa27}"
        case .replyPrivatelyLight: return "\u{fa28}"
        case .replyPrivatelyRegular: return "\u{fa29}"
        case .replyRegular: return "\u{fa2a}"
        case .resetBold: return "\u{fa2b}"
        case .resetLight: return "\u{fa2c}"
        case .resetRegular: return "\u{fa2d}"
        case .resizeCornerBold: return "\u{fa2e}"
        case .resizeCornerLight: return "\u{fa2f}"
        case .resizeCornerRegular: return "\u{fa30}"
        case .responsiveMobileBold: return "\u{fa31}"
        case .responsiveMobileLight: return "\u{fa32}"
        case .responsiveMobileRegular: return "\u{fa33}"
        case .restartBold: return "\u{fa34}"
        case .restartLight: return "\u{fa35}"
        case .restartRegular: return "\u{fa36}"
        case .resumeInteractionBold: return "\u{fa37}"
        case .resumeInteractionFilled: return "\u{fa38}"
        case .resumeInteractionLight: return "\u{fa39}"
        case .resumeInteractionRegular: return "\u{fa3a}"
        case .retrieveCallBold: return "\u{fa3b}"
        case .retrieveCallFilled: return "\u{fa3c}"
        case .retrieveCallLight: return "\u{fa3d}"
        case .retrieveCallRegular: return "\u{fa3e}"
        case .returnBold: return "\u{fa3f}"
        case .returnLight: return "\u{fa40}"
        case .returnRegular: return "\u{fa41}"
        case .rewindTenSecBold: return "\u{fa42}"
        case .rewindTenSecLight: return "\u{fa43}"
        case .rewindTenSecRegular: return "\u{fa44}"
        case .ringtoneBold: return "\u{fa45}"
        case .ringtoneLight: return "\u{fa46}"
        case .ringtoneRegular: return "\u{fa47}"
        case .roomCalendarBold: return "\u{fa48}"
        case .roomCalendarLight: return "\u{fa49}"
        case .roomCalendarRegular: return "\u{fa4a}"
        case .roomLightsBold: return "\u{fa4b}"
        case .roomLightsFilled: return "\u{fa4c}"
        case .roomLightsLight: return "\u{fa4d}"
        case .roomLightsRegular: return "\u{fa4e}"
        case .rotateContentBold: return "\u{fa4f}"
        case .rotateContentFilled: return "\u{fa50}"
        case .rotateContentLight: return "\u{fa51}"
        case .rotateContentRegular: return "\u{fa52}"
        case .rssBold: return "\u{fa53}"
        case .rssFilled: return "\u{fa54}"
        case .rssLight: return "\u{fa55}"
        case .rssRegular: return "\u{fa56}"
        case .ruleBasedBold: return "\u{fa57}"
        case .ruleBasedFilled: return "\u{fa58}"
        case .ruleBasedLight: return "\u{fa59}"
        case .ruleBasedRegular: return "\u{fa5a}"
        case .rulerBold: return "\u{fa5b}"
        case .rulerFilled: return "\u{fa5c}"
        case .rulerLight: return "\u{fa5d}"
        case .rulerRegular: return "\u{fa5e}"
        case .runningApplicationBold: return "\u{fa5f}"
        case .runningApplicationFilled: return "\u{fa60}"
        case .runningApplicationLight: return "\u{fa61}"
        case .runningApplicationRegular: return "\u{fa62}"
        case .saveBold: return "\u{fa63}"
        case .saveLight: return "\u{fa64}"
        case .saveRegular: return "\u{fa65}"
        case .saveTranscriptBold: return "\u{fa66}"
        case .saveTranscriptFilled: return "\u{fa67}"
        case .saveTranscriptLight: return "\u{fa68}"
        case .saveTranscriptRegular: return "\u{fa69}"
        case .scanBold: return "\u{fa6a}"
        case .scanLight: return "\u{fa6b}"
        case .scanRegular: return "\u{fa6c}"
        case .scheduleAiBold: return "\u{fa6d}"
        case .scheduleAiLight: return "\u{fa6e}"
        case .scheduleAiRegular: return "\u{fa6f}"
        case .scheduleSendBold: return "\u{fa70}"
        case .scheduleSendFilled: return "\u{fa71}"
        case .scheduleSendLight: return "\u{fa72}"
        case .scheduleSendRegular: return "\u{fa73}"
        case .scheduleWinnerBold: return "\u{fa74}"
        case .scheduleWinnerFilled: return "\u{fa75}"
        case .scheduleWinnerLight: return "\u{fa76}"
        case .scheduleWinnerRegular: return "\u{fa77}"
        case .schedulerAvailableBold: return "\u{fa78}"
        case .schedulerAvailableLight: return "\u{fa79}"
        case .schedulerAvailableRegular: return "\u{fa7a}"
        case .schedulerNotWorkingHoursBold: return "\u{fa7b}"
        case .schedulerNotWorkingHoursLight: return "\u{fa7c}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa7d}"
        case .schedulerUnavailableBold: return "\u{fa7e}"
        case .schedulerUnavailableLight: return "\u{fa7f}"
        case .schedulerUnavailableRegular: return "\u{fa80}"
        case .schedulerUnknownBold: return "\u{fa81}"
        case .schedulerUnknownLight: return "\u{fa82}"
        case .schedulerUnknownRegular: return "\u{fa83}"
        case .screenshotBold: return "\u{fa84}"
        case .screenshotDocBold: return "\u{fa85}"
        case .screenshotDocFilled: return "\u{fa86}"
        case .screenshotDocLight: return "\u{fa87}"
        case .screenshotDocRegular: return "\u{fa88}"
        case .screenshotLight: return "\u{fa89}"
        case .screenshotRegular: return "\u{fa8a}"
        case .searchAiBold: return "\u{fa8b}"
        case .searchAiLight: return "\u{fa8c}"
        case .searchAiRegular: return "\u{fa8d}"
        case .searchBold: return "\u{fa8e}"
        case .searchFilled: return "\u{fa8f}"
        case .searchLight: return "\u{fa90}"
        case .searchRegular: return "\u{fa91}"
        case .secondaryArrowBold: return "\u{fa92}"
        case .secondaryArrowLight: return "\u{fa93}"
        case .secondaryArrowRegular: return "\u{fa94}"
        case .secureCallLockBold: return "\u{fa95}"
        case .secureCallLockFilled: return "\u{fa96}"
        case .secureCallLockLight: return "\u{fa97}"
        case .secureCallLockRegular: return "\u{fa98}"
        case .secureCallShieldBold: return "\u{fa99}"
        case .secureCallShieldFilled: return "\u{fa9a}"
        case .secureCallShieldLight: return "\u{fa9b}"
        case .secureCallShieldRegular: return "\u{fa9c}"
        case .secureCircleBold: return "\u{fa9d}"
        case .secureCircleFilled: return "\u{fa9e}"
        case .secureCircleLight: return "\u{fa9f}"
        case .secureCircleRegular: return "\u{faa0}"
        case .secureLockBold: return "\u{faa1}"
        case .secureLockFilled: return "\u{faa2}"
        case .secureLockLight: return "\u{faa3}"
        case .secureLockRegular: return "\u{faa4}"
        case .segmentExcludeFilled: return "\u{faa5}"
        case .segmentFilterFilled: return "\u{faa6}"
        case .segmentIncludeFilled: return "\u{faa7}"
        case .selectAllBold: return "\u{faa8}"
        case .selectAllFilled: return "\u{faa9}"
        case .selectAllLight: return "\u{faaa}"
        case .selectAllRegular: return "\u{faab}"
        case .selectionBold: return "\u{faac}"
        case .selectionFilled: return "\u{faad}"
        case .selectionLight: return "\u{faae}"
        case .selectionRegular: return "\u{faaf}"
        case .sendBold: return "\u{fab0}"
        case .sendDigitsBold: return "\u{fab1}"
        case .sendDigitsFilled: return "\u{fab2}"
        case .sendDigitsLight: return "\u{fab3}"
        case .sendDigitsRegular: return "\u{fab4}"
        case .sendFilled: return "\u{fab5}"
        case .sendLight: return "\u{fab6}"
        case .sendRegular: return "\u{fab7}"
        case .sendVoiceBold: return "\u{fab8}"
        case .sendVoiceFilled: return "\u{fab9}"
        case .sendVoiceLight: return "\u{faba}"
        case .sendVoiceRegular: return "\u{fabb}"
        case .serverBold: return "\u{fabc}"
        case .serverErrorBold: return "\u{fabd}"
        case .serverErrorLight: return "\u{fabe}"
        case .serverErrorRegular: return "\u{fabf}"
        case .serverLight: return "\u{fac0}"
        case .serverRegular: return "\u{fac1}"
        case .servicesBold: return "\u{fac2}"
        case .servicesLight: return "\u{fac3}"
        case .servicesRegular: return "\u{fac4}"
        case .setVariableBold: return "\u{fac5}"
        case .setVariableLight: return "\u{fac6}"
        case .setVariableRegular: return "\u{fac7}"
        case .settingsBold: return "\u{fac8}"
        case .settingsFilled: return "\u{fac9}"
        case .settingsLight: return "\u{faca}"
        case .settingsRegular: return "\u{facb}"
        case .setupAssistantBold: return "\u{facc}"
        case .setupAssistantLight: return "\u{facd}"
        case .setupAssistantRegular: return "\u{face}"
        case .sftpBold: return "\u{facf}"
        case .sftpLight: return "\u{fad0}"
        case .sftpRegular: return "\u{fad1}"
        case .shapeCircleBold: return "\u{fad2}"
        case .shapeCircleFilled: return "\u{fad3}"
        case .shapeCircleLight: return "\u{fad4}"
        case .shapeCircleMdFilled: return "\u{fad5}"
        case .shapeCircleRegular: return "\u{fad6}"
        case .shapeCircleSmFilled: return "\u{fad7}"
        case .shapeDiagonalLineBold: return "\u{fad8}"
        case .shapeDiagonalLineLight: return "\u{fad9}"
        case .shapeDiagonalLineRegular: return "\u{fada}"
        case .shapeDiamondBold: return "\u{fadb}"
        case .shapeDiamondFilled: return "\u{fadc}"
        case .shapeDiamondLight: return "\u{fadd}"
        case .shapeDiamondRegular: return "\u{fade}"
        case .shapeOvalBold: return "\u{fadf}"
        case .shapeOvalLight: return "\u{fae0}"
        case .shapeOvalRegular: return "\u{fae1}"
        case .shapeSquareBold: return "\u{fae2}"
        case .shapeSquareFilled: return "\u{fae3}"
        case .shapeSquareLight: return "\u{fae4}"
        case .shapeSquareRegular: return "\u{fae5}"
        case .shapeTriangleBold: return "\u{fae6}"
        case .shapeTriangleFilled: return "\u{fae7}"
        case .shapeTriangleLight: return "\u{fae8}"
        case .shapeTriangleRegular: return "\u{fae9}"
        case .shapesBold: return "\u{faea}"
        case .shapesFilled: return "\u{faeb}"
        case .shapesLight: return "\u{faec}"
        case .shapesRegular: return "\u{faed}"
        case .shareCNativeAdrBold: return "\u{faee}"
        case .shareCNativeAdrFilled: return "\u{faef}"
        case .shareCNativeAdrLight: return "\u{faf0}"
        case .shareCNativeAdrRegular: return "\u{faf1}"
        case .shareCNativeIphBold: return "\u{faf2}"
        case .shareCNativeIphLight: return "\u{faf3}"
        case .shareCNativeIphRegular: return "\u{faf4}"
        case .shareContentOnDeviceBold: return "\u{faf5}"
        case .shareContentOnDeviceLight: return "\u{faf6}"
        case .shareContentOnDeviceRegular: return "\u{faf7}"
        case .shareScreenAddBold: return "\u{faf8}"
        case .shareScreenAddLight: return "\u{faf9}"
        case .shareScreenAddRegular: return "\u{fafa}"
        case .shareScreenBadgeFilled: return "\u{fafb}"
        case .shareScreenBold: return "\u{fafc}"
        case .shareScreenFilled: return "\u{fafd}"
        case .shareScreenLight: return "\u{fafe}"
        case .shareScreenRegular: return "\u{faff}"
        case .shareSpaceBold: return "\u{fb00}"
        case .shareSpaceLight: return "\u{fb01}"
        case .shareSpaceRegular: return "\u{fb02}"
        case .shieldBold: return "\u{fb03}"
        case .shieldLight: return "\u{fb04}"
        case .shieldRegular: return "\u{fb05}"
        case .shoppingCartBold: return "\u{fb06}"
        case .shoppingCartFilled: return "\u{fb07}"
        case .shoppingCartLight: return "\u{fb08}"
        case .shoppingCartRegular: return "\u{fb09}"
        case .shortTextBoxBold: return "\u{fb0a}"
        case .shortTextBoxLight: return "\u{fb0b}"
        case .shortTextBoxRegular: return "\u{fb0c}"
        case .showBold: return "\u{fb0d}"
        case .showFilled: return "\u{fb0e}"
        case .showLight: return "\u{fb0f}"
        case .showRegular: return "\u{fb10}"
        case .sidePanelBold: return "\u{fb11}"
        case .sidePanelFilled: return "\u{fb12}"
        case .sidePanelLight: return "\u{fb13}"
        case .sidePanelRegular: return "\u{fb14}"
        case .signInBold: return "\u{fb15}"
        case .signInFilled: return "\u{fb16}"
        case .signInForcedBold: return "\u{fb17}"
        case .signInForcedLight: return "\u{fb18}"
        case .signInForcedRegular: return "\u{fb19}"
        case .signInLight: return "\u{fb1a}"
        case .signInRegular: return "\u{fb1b}"
        case .signLangIntBold: return "\u{fb1c}"
        case .signLangIntLight: return "\u{fb1d}"
        case .signLangIntRegular: return "\u{fb1e}"
        case .signOutBold: return "\u{fb1f}"
        case .signOutLight: return "\u{fb20}"
        case .signOutRegular: return "\u{fb21}"
        case .signalFourBold: return "\u{fb22}"
        case .signalFourLight: return "\u{fb23}"
        case .signalFourRegular: return "\u{fb24}"
        case .signalOneBold: return "\u{fb25}"
        case .signalOneLight: return "\u{fb26}"
        case .signalOneRegular: return "\u{fb27}"
        case .signalThreeBold: return "\u{fb28}"
        case .signalThreeLight: return "\u{fb29}"
        case .signalThreeRegular: return "\u{fb2a}"
        case .signalTwoBold: return "\u{fb2b}"
        case .signalTwoLight: return "\u{fb2c}"
        case .signalTwoRegular: return "\u{fb2d}"
        case .signalZeroBold: return "\u{fb2e}"
        case .signalZeroLight: return "\u{fb2f}"
        case .signalZeroRegular: return "\u{fb30}"
        case .simplePromotionBold: return "\u{fb31}"
        case .simplePromotionLight: return "\u{fb32}"
        case .simplePromotionRegular: return "\u{fb33}"
        case .singleNumberReachBold: return "\u{fb34}"
        case .singleNumberReachLight: return "\u{fb35}"
        case .singleNumberReachRegular: return "\u{fb36}"
        case .sipRegistrationInProgressBold: return "\u{fb37}"
        case .sipRegistrationInProgressFilled: return "\u{fb38}"
        case .sipRegistrationInProgressLight: return "\u{fb39}"
        case .sipRegistrationInProgressRegular: return "\u{fb3a}"
        case .skipBold: return "\u{fb3b}"
        case .skipBwBold: return "\u{fb3c}"
        case .skipBwFilled: return "\u{fb3d}"
        case .skipBwLight: return "\u{fb3e}"
        case .skipBwRegular: return "\u{fb3f}"
        case .skipFwBold: return "\u{fb40}"
        case .skipFwFilled: return "\u{fb41}"
        case .skipFwLight: return "\u{fb42}"
        case .skipFwRegular: return "\u{fb43}"
        case .skipLight: return "\u{fb44}"
        case .skipRegular: return "\u{fb45}"
        case .smartAudioBold: return "\u{fb46}"
        case .smartAudioLight: return "\u{fb47}"
        case .smartAudioRegular: return "\u{fb48}"
        case .smartReplyBold: return "\u{fb49}"
        case .smartReplyLight: return "\u{fb4a}"
        case .smartReplyRegular: return "\u{fb4b}"
        case .smsFilled: return "\u{fb4c}"
        case .smsInboundBold: return "\u{fb4d}"
        case .smsInboundLight: return "\u{fb4e}"
        case .smsInboundRegular: return "\u{fb4f}"
        case .smsMessageBold: return "\u{fb50}"
        case .smsMessageFilled: return "\u{fb51}"
        case .smsMessageLight: return "\u{fb52}"
        case .smsMessageOutgoingBold: return "\u{fb53}"
        case .smsMessageOutgoingFilled: return "\u{fb54}"
        case .smsMessageOutgoingLight: return "\u{fb55}"
        case .smsMessageOutgoingRegular: return "\u{fb56}"
        case .smsMessageRegular: return "\u{fb57}"
        case .smsMessageStartBold: return "\u{fb58}"
        case .smsMessageStartFilled: return "\u{fb59}"
        case .smsMessageStartLight: return "\u{fb5a}"
        case .smsMessageStartRegular: return "\u{fb5b}"
        case .smsOutgoingFilled: return "\u{fb5c}"
        case .smsUnreadBold: return "\u{fb5d}"
        case .smsUnreadLight: return "\u{fb5e}"
        case .smsUnreadRegular: return "\u{fb5f}"
        case .sortAscendingBold: return "\u{fb60}"
        case .sortAscendingLight: return "\u{fb61}"
        case .sortAscendingRegular: return "\u{fb62}"
        case .sortDescendingBold: return "\u{fb63}"
        case .sortDescendingLight: return "\u{fb64}"
        case .sortDescendingRegular: return "\u{fb65}"
        case .soundDefaultBold: return "\u{fb66}"
        case .soundDefaultLight: return "\u{fb67}"
        case .soundDefaultRegular: return "\u{fb68}"
        case .sparkleBold: return "\u{fb69}"
        case .sparkleFilled: return "\u{fb6a}"
        case .sparkleLight: return "\u{fb6b}"
        case .sparkleRegular: return "\u{fb6c}"
        case .speakerBold: return "\u{fb6d}"
        case .speakerDisconnectedBold: return "\u{fb6e}"
        case .speakerDisconnectedFilled: return "\u{fb6f}"
        case .speakerDisconnectedLight: return "\u{fb70}"
        case .speakerDisconnectedRegular: return "\u{fb71}"
        case .speakerFilled: return "\u{fb72}"
        case .speakerLight: return "\u{fb73}"
        case .speakerMutedBold: return "\u{fb74}"
        case .speakerMutedFilled: return "\u{fb75}"
        case .speakerMutedLight: return "\u{fb76}"
        case .speakerMutedRegular: return "\u{fb77}"
        case .speakerOffBold: return "\u{fb78}"
        case .speakerOffFilled: return "\u{fb79}"
        case .speakerOffLight: return "\u{fb7a}"
        case .speakerOffRegular: return "\u{fb7b}"
        case .speakerOnBold: return "\u{fb7c}"
        case .speakerOnLight: return "\u{fb7d}"
        case .speakerOnRegular: return "\u{fb7e}"
        case .speakerRegular: return "\u{fb7f}"
        case .speakerTurnDownBold: return "\u{fb80}"
        case .speakerTurnDownFilled: return "\u{fb81}"
        case .speakerTurnDownLight: return "\u{fb82}"
        case .speakerTurnDownRegular: return "\u{fb83}"
        case .speakerTurnUpBold: return "\u{fb84}"
        case .speakerTurnUpFilled: return "\u{fb85}"
        case .speakerTurnUpLight: return "\u{fb86}"
        case .speakerTurnUpRegular: return "\u{fb87}"
        case .speedDialBold: return "\u{fb88}"
        case .speedDialFilled: return "\u{fb89}"
        case .speedDialLight: return "\u{fb8a}"
        case .speedDialRegular: return "\u{fb8b}"
        case .spellCheckerBold: return "\u{fb8c}"
        case .spellCheckerLight: return "\u{fb8d}"
        case .spellCheckerRegular: return "\u{fb8e}"
        case .splitViewBold: return "\u{fb8f}"
        case .splitViewLight: return "\u{fb90}"
        case .splitViewRegular: return "\u{fb91}"
        case .stackedAreaChartBold: return "\u{fb92}"
        case .stackedAreaChartFilled: return "\u{fb93}"
        case .stackedAreaChartFullBold: return "\u{fb94}"
        case .stackedAreaChartFullFilled: return "\u{fb95}"
        case .stackedAreaChartFullLight: return "\u{fb96}"
        case .stackedAreaChartFullRegular: return "\u{fb97}"
        case .stackedAreaChartLight: return "\u{fb98}"
        case .stackedAreaChartRegular: return "\u{fb99}"
        case .stackedBarChartBold: return "\u{fb9a}"
        case .stackedBarChartFilled: return "\u{fb9b}"
        case .stackedBarChartFullBold: return "\u{fb9c}"
        case .stackedBarChartFullFilled: return "\u{fb9d}"
        case .stackedBarChartFullLight: return "\u{fb9e}"
        case .stackedBarChartFullRegular: return "\u{fb9f}"
        case .stackedBarChartLight: return "\u{fba0}"
        case .stackedBarChartRegular: return "\u{fba1}"
        case .startChatBold: return "\u{fba2}"
        case .startChatLight: return "\u{fba3}"
        case .startChatRegular: return "\u{fba4}"
        case .stethoscopeBold: return "\u{fba5}"
        case .stethoscopeLight: return "\u{fba6}"
        case .stethoscopeRegular: return "\u{fba7}"
        case .stickersBold: return "\u{fba8}"
        case .stickersLight: return "\u{fba9}"
        case .stickersRegular: return "\u{fbaa}"
        case .stickiesBold: return "\u{fbab}"
        case .stickiesLight: return "\u{fbac}"
        case .stickiesRegular: return "\u{fbad}"
        case .stopBold: return "\u{fbae}"
        case .stopCircleBold: return "\u{fbaf}"
        case .stopCircleFilled: return "\u{fbb0}"
        case .stopCircleLight: return "\u{fbb1}"
        case .stopCircleRegular: return "\u{fbb2}"
        case .stopContentShareBold: return "\u{fbb3}"
        case .stopContentShareLight: return "\u{fbb4}"
        case .stopContentShareRegular: return "\u{fbb5}"
        case .stopFilled: return "\u{fbb6}"
        case .stopLight: return "\u{fbb7}"
        case .stopRegular: return "\u{fbb8}"
        case .storedInfoBold: return "\u{fbb9}"
        case .storedInfoFilled: return "\u{fbba}"
        case .storedInfoLight: return "\u{fbbb}"
        case .storedInfoRegular: return "\u{fbbc}"
        case .streamingBold: return "\u{fbbd}"
        case .streamingLight: return "\u{fbbe}"
        case .streamingRegular: return "\u{fbbf}"
        case .strikethroughBold: return "\u{fbc0}"
        case .strikethroughFilled: return "\u{fbc1}"
        case .strikethroughLight: return "\u{fbc2}"
        case .strikethroughRegular: return "\u{fbc3}"
        case .studioModeBold: return "\u{fbc4}"
        case .studioModeLight: return "\u{fbc5}"
        case .studioModeRegular: return "\u{fbc6}"
        case .subscriptBold: return "\u{fbc7}"
        case .subscriptLight: return "\u{fbc8}"
        case .subscriptRegular: return "\u{fbc9}"
        case .summarizeAiBold: return "\u{fbca}"
        case .summarizeAiLight: return "\u{fbcb}"
        case .summarizeAiRegular: return "\u{fbcc}"
        case .superscriptBold: return "\u{fbcd}"
        case .superscriptLight: return "\u{fbce}"
        case .superscriptRegular: return "\u{fbcf}"
        case .surveyBold: return "\u{fbd0}"
        case .surveyFilled: return "\u{fbd1}"
        case .surveyLight: return "\u{fbd2}"
        case .surveyRegular: return "\u{fbd3}"
        case .sxEightyCodecBold: return "\u{fbd4}"
        case .sxEightyCodecLight: return "\u{fbd5}"
        case .sxEightyCodecRegular: return "\u{fbd6}"
        case .sxTenBold: return "\u{fbd7}"
        case .sxTenLight: return "\u{fbd8}"
        case .sxTenRegular: return "\u{fbd9}"
        case .sxTwentyBold: return "\u{fbda}"
        case .sxTwentyLight: return "\u{fbdb}"
        case .sxTwentyRegular: return "\u{fbdc}"
        case .tableBold: return "\u{fbdd}"
        case .tableExtenderBold: return "\u{fbde}"
        case .tableExtenderFilled: return "\u{fbdf}"
        case .tableExtenderLight: return "\u{fbe0}"
        case .tableExtenderRegular: return "\u{fbe1}"
        case .tableLight: return "\u{fbe2}"
        case .tableRegular: return "\u{fbe3}"
        case .tabletBold: return "\u{fbe4}"
        case .tabletLight: return "\u{fbe5}"
        case .tabletRegular: return "\u{fbe6}"
        case .tabsBold: return "\u{fbe7}"
        case .tabsLight: return "\u{fbe8}"
        case .tabsRegular: return "\u{fbe9}"
        case .tagBold: return "\u{fbea}"
        case .tagLight: return "\u{fbeb}"
        case .tagRegular: return "\u{fbec}"
        case .tapBold: return "\u{fbed}"
        case .tapFilled: return "\u{fbee}"
        case .tapLight: return "\u{fbef}"
        case .tapRegular: return "\u{fbf0}"
        case .telepresenceAlertBold: return "\u{fbf1}"
        case .telepresenceAlertLight: return "\u{fbf2}"
        case .telepresenceAlertMutedBold: return "\u{fbf3}"
        case .telepresenceAlertMutedLight: return "\u{fbf4}"
        case .telepresenceAlertMutedRegular: return "\u{fbf5}"
        case .telepresenceAlertRegular: return "\u{fbf6}"
        case .telepresenceBold: return "\u{fbf7}"
        case .telepresenceIxFiveThousandBold: return "\u{fbf8}"
        case .telepresenceIxFiveThousandLight: return "\u{fbf9}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbfa}"
        case .telepresenceLight: return "\u{fbfb}"
        case .telepresenceMutedBold: return "\u{fbfc}"
        case .telepresenceMutedLight: return "\u{fbfd}"
        case .telepresenceMutedRegular: return "\u{fbfe}"
        case .telepresencePrivateBold: return "\u{fbff}"
        case .telepresencePrivateLight: return "\u{fc00}"
        case .telepresencePrivateRegular: return "\u{fc01}"
        case .telepresenceRegular: return "\u{fc02}"
        case .temperatureBold: return "\u{fc03}"
        case .temperatureLight: return "\u{fc04}"
        case .temperatureRegular: return "\u{fc05}"
        case .testTubeBold: return "\u{fc06}"
        case .testTubeFilled: return "\u{fc07}"
        case .testTubeLight: return "\u{fc08}"
        case .testTubeRegular: return "\u{fc09}"
        case .textAlignCenterBold: return "\u{fc0a}"
        case .textAlignCenterFilled: return "\u{fc0b}"
        case .textAlignCenterLight: return "\u{fc0c}"
        case .textAlignCenterRegular: return "\u{fc0d}"
        case .textAlignLeftBold: return "\u{fc0e}"
        case .textAlignLeftFilled: return "\u{fc0f}"
        case .textAlignLeftLight: return "\u{fc10}"
        case .textAlignLeftRegular: return "\u{fc11}"
        case .textAlignRightBold: return "\u{fc12}"
        case .textAlignRightFilled: return "\u{fc13}"
        case .textAlignRightLight: return "\u{fc14}"
        case .textAlignRightRegular: return "\u{fc15}"
        case .textBold: return "\u{fc16}"
        case .textBoxCursorLight: return "\u{fc17}"
        case .textCodeBlockBold: return "\u{fc18}"
        case .textCodeBlockLight: return "\u{fc19}"
        case .textCodeBlockRegular: return "\u{fc1a}"
        case .textHighlightBold: return "\u{fc1b}"
        case .textHighlightFilled: return "\u{fc1c}"
        case .textHighlightLight: return "\u{fc1d}"
        case .textHighlightRegular: return "\u{fc1e}"
        case .textLight: return "\u{fc1f}"
        case .textRegular: return "\u{fc20}"
        case .threeColumnBold: return "\u{fc21}"
        case .threeColumnLight: return "\u{fc22}"
        case .threeColumnRegular: return "\u{fc23}"
        case .threeDObjectBold: return "\u{fc24}"
        case .threeDObjectLight: return "\u{fc25}"
        case .threeDObjectRegular: return "\u{fc26}"
        case .timeExclusionBold: return "\u{fc27}"
        case .timeExclusionLight: return "\u{fc28}"
        case .timeExclusionRegular: return "\u{fc29}"
        case .timezoneBold: return "\u{fc2a}"
        case .timezoneFilled: return "\u{fc2b}"
        case .timezoneLight: return "\u{fc2c}"
        case .timezoneRegular: return "\u{fc2d}"
        case .tooFastBold: return "\u{fc2e}"
        case .tooFastLight: return "\u{fc2f}"
        case .tooFastRegular: return "\u{fc30}"
        case .tooSlowBold: return "\u{fc31}"
        case .tooSlowLight: return "\u{fc32}"
        case .tooSlowRegular: return "\u{fc33}"
        case .toolsBold: return "\u{fc34}"
        case .toolsFilled: return "\u{fc35}"
        case .toolsLight: return "\u{fc36}"
        case .toolsRegular: return "\u{fc37}"
        case .touchTenBold: return "\u{fc38}"
        case .touchTenLight: return "\u{fc39}"
        case .touchTenRegular: return "\u{fc3a}"
        case .transcriptBold: return "\u{fc3b}"
        case .transcriptFilled: return "\u{fc3c}"
        case .transcriptLight: return "\u{fc3d}"
        case .transcriptRegular: return "\u{fc3e}"
        case .translateBold: return "\u{fc3f}"
        case .translateLight: return "\u{fc40}"
        case .translateRegular: return "\u{fc41}"
        case .translateUndoBold: return "\u{fc42}"
        case .translateUndoLight: return "\u{fc43}"
        case .translateUndoRegular: return "\u{fc44}"
        case .trendingBold: return "\u{fc45}"
        case .trendingDownBold: return "\u{fc46}"
        case .trendingDownFilled: return "\u{fc47}"
        case .trendingDownLight: return "\u{fc48}"
        case .trendingDownRegular: return "\u{fc49}"
        case .trendingFilled: return "\u{fc4a}"
        case .trendingLight: return "\u{fc4b}"
        case .trendingRegular: return "\u{fc4c}"
        case .trimBold: return "\u{fc4d}"
        case .trimLight: return "\u{fc4e}"
        case .trimRegular: return "\u{fc4f}"
        case .twoColumnBold: return "\u{fc50}"
        case .twoColumnLight: return "\u{fc51}"
        case .twoColumnRegular: return "\u{fc52}"
        case .twoWayVoiceStreamBold: return "\u{fc53}"
        case .twoWayVoiceStreamFilled: return "\u{fc54}"
        case .twoWayVoiceStreamLight: return "\u{fc55}"
        case .twoWayVoiceStreamRegular: return "\u{fc56}"
        case .ucmCloudBold: return "\u{fc57}"
        case .ucmCloudLight: return "\u{fc58}"
        case .ucmCloudRegular: return "\u{fc59}"
        case .unblockBold: return "\u{fc5a}"
        case .unblockFilled: return "\u{fc5b}"
        case .unblockLight: return "\u{fc5c}"
        case .unblockRegular: return "\u{fc5d}"
        case .underlineBold: return "\u{fc5e}"
        case .underlineFilled: return "\u{fc5f}"
        case .underlineLight: return "\u{fc60}"
        case .underlineRegular: return "\u{fc61}"
        case .undoBold: return "\u{fc62}"
        case .undoLight: return "\u{fc63}"
        case .undoRegular: return "\u{fc64}"
        case .unlinkBold: return "\u{fc65}"
        case .unlinkLight: return "\u{fc66}"
        case .unlinkRegular: return "\u{fc67}"
        case .unreadBold: return "\u{fc68}"
        case .unreadFilled: return "\u{fc69}"
        case .unreadLight: return "\u{fc6a}"
        case .unreadRegular: return "\u{fc6b}"
        case .unsecureUnlockedBold: return "\u{fc6c}"
        case .unsecureUnlockedFilled: return "\u{fc6d}"
        case .unsecureUnlockedLight: return "\u{fc6e}"
        case .unsecureUnlockedRegular: return "\u{fc6f}"
        case .unsortedBold: return "\u{fc70}"
        case .unsortedLight: return "\u{fc71}"
        case .unsortedRegular: return "\u{fc72}"
        case .updateFileShareBold: return "\u{fc73}"
        case .updateFileShareLight: return "\u{fc74}"
        case .updateFileShareRegular: return "\u{fc75}"
        case .uploadBold: return "\u{fc76}"
        case .uploadImageBold: return "\u{fc77}"
        case .uploadImageLight: return "\u{fc78}"
        case .uploadImageRegular: return "\u{fc79}"
        case .uploadLight: return "\u{fc7a}"
        case .uploadRegular: return "\u{fc7b}"
        case .urgentVoicemailBold: return "\u{fc7c}"
        case .urgentVoicemailFilled: return "\u{fc7d}"
        case .usbBold: return "\u{fc7e}"
        case .usbHeadsetBold: return "\u{fc7f}"
        case .usbHeadsetLight: return "\u{fc80}"
        case .usbHeadsetMutedBold: return "\u{fc81}"
        case .usbHeadsetMutedLight: return "\u{fc82}"
        case .usbHeadsetMutedRegular: return "\u{fc83}"
        case .usbHeadsetRegular: return "\u{fc84}"
        case .usbLight: return "\u{fc85}"
        case .usbRegular: return "\u{fc86}"
        case .userBold: return "\u{fc87}"
        case .userDeactivateBold: return "\u{fc88}"
        case .userDeactivateLight: return "\u{fc89}"
        case .userDeactivateRegular: return "\u{fc8a}"
        case .userFilled: return "\u{fc8b}"
        case .userLight: return "\u{fc8c}"
        case .userRegular: return "\u{fc8d}"
        case .videoBlurBold: return "\u{fc8e}"
        case .videoBlurFilled: return "\u{fc8f}"
        case .videoBlurLight: return "\u{fc90}"
        case .videoBlurRegular: return "\u{fc91}"
        case .videoBold: return "\u{fc92}"
        case .videoEffectBold: return "\u{fc93}"
        case .videoEffectFilled: return "\u{fc94}"
        case .videoEffectLight: return "\u{fc95}"
        case .videoEffectRegular: return "\u{fc96}"
        case .videoFilled: return "\u{fc97}"
        case .videoLayoutBold: return "\u{fc98}"
        case .videoLayoutCustomBold: return "\u{fc99}"
        case .videoLayoutCustomFilled: return "\u{fc9a}"
        case .videoLayoutCustomLight: return "\u{fc9b}"
        case .videoLayoutCustomRegular: return "\u{fc9c}"
        case .videoLayoutEqualBold: return "\u{fc9d}"
        case .videoLayoutEqualDualBold: return "\u{fc9e}"
        case .videoLayoutEqualDualLight: return "\u{fc9f}"
        case .videoLayoutEqualDualRegular: return "\u{fca0}"
        case .videoLayoutEqualFilled: return "\u{fca1}"
        case .videoLayoutEqualLight: return "\u{fca2}"
        case .videoLayoutEqualRegular: return "\u{fca3}"
        case .videoLayoutFilled: return "\u{fca4}"
        case .videoLayoutLight: return "\u{fca5}"
        case .videoLayoutOverlayBold: return "\u{fca6}"
        case .videoLayoutOverlayFilled: return "\u{fca7}"
        case .videoLayoutOverlayLight: return "\u{fca8}"
        case .videoLayoutOverlayRegular: return "\u{fca9}"
        case .videoLayoutPresentationBold: return "\u{fcaa}"
        case .videoLayoutPresentationFilled: return "\u{fcab}"
        case .videoLayoutPresentationLight: return "\u{fcac}"
        case .videoLayoutPresentationRegular: return "\u{fcad}"
        case .videoLayoutPresenterDominantBold: return "\u{fcae}"
        case .videoLayoutPresenterDominantLight: return "\u{fcaf}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcb0}"
        case .videoLayoutProminentBold: return "\u{fcb1}"
        case .videoLayoutProminentFilled: return "\u{fcb2}"
        case .videoLayoutProminentLight: return "\u{fcb3}"
        case .videoLayoutProminentRegular: return "\u{fcb4}"
        case .videoLayoutRegular: return "\u{fcb5}"
        case .videoLayoutShareDominantBold: return "\u{fcb6}"
        case .videoLayoutShareDominantLight: return "\u{fcb7}"
        case .videoLayoutShareDominantRegular: return "\u{fcb8}"
        case .videoLayoutSingleBold: return "\u{fcb9}"
        case .videoLayoutSingleFilled: return "\u{fcba}"
        case .videoLayoutSingleLight: return "\u{fcbb}"
        case .videoLayoutSingleRegular: return "\u{fcbc}"
        case .videoLayoutSpeakerBold: return "\u{fcbd}"
        case .videoLayoutSpeakerFilled: return "\u{fcbe}"
        case .videoLayoutSpeakerLight: return "\u{fcbf}"
        case .videoLayoutSpeakerRegular: return "\u{fcc0}"
        case .videoLayoutStackBold: return "\u{fcc1}"
        case .videoLayoutStackFilled: return "\u{fcc2}"
        case .videoLayoutStackLight: return "\u{fcc3}"
        case .videoLayoutStackRegular: return "\u{fcc4}"
        case .videoLayoutVideoDominantBold: return "\u{fcc5}"
        case .videoLayoutVideoDominantFilled: return "\u{fcc6}"
        case .videoLayoutVideoDominantLight: return "\u{fcc7}"
        case .videoLayoutVideoDominantRegular: return "\u{fcc8}"
        case .videoLight: return "\u{fcc9}"
        case .videoPlusBold: return "\u{fcca}"
        case .videoPlusFilled: return "\u{fccb}"
        case .videoPlusLight: return "\u{fccc}"
        case .videoPlusRegular: return "\u{fccd}"
        case .videoRegular: return "\u{fcce}"
        case .videoSpeakerTrackBold: return "\u{fccf}"
        case .videoSpeakerTrackFilled: return "\u{fcd0}"
        case .videoSpeakerTrackLight: return "\u{fcd1}"
        case .videoSpeakerTrackRegular: return "\u{fcd2}"
        case .viewAllBold: return "\u{fcd3}"
        case .viewAllLight: return "\u{fcd4}"
        case .viewAllRegular: return "\u{fcd5}"
        case .viewListBold: return "\u{fcd6}"
        case .viewListFilled: return "\u{fcd7}"
        case .viewListLight: return "\u{fcd8}"
        case .viewListRegular: return "\u{fcd9}"
        case .viewStackedBold: return "\u{fcda}"
        case .viewStackedFilled: return "\u{fcdb}"
        case .viewStackedLight: return "\u{fcdc}"
        case .viewStackedRegular: return "\u{fcdd}"
        case .viewThumbnailBold: return "\u{fcde}"
        case .viewThumbnailFilled: return "\u{fcdf}"
        case .viewThumbnailLight: return "\u{fce0}"
        case .viewThumbnailRegular: return "\u{fce1}"
        case .visionproBold: return "\u{fce2}"
        case .visionproFilled: return "\u{fce3}"
        case .visionproLight: return "\u{fce4}"
        case .visionproMoveCallInBold: return "\u{fce5}"
        case .visionproMoveCallInFilled: return "\u{fce6}"
        case .visionproMoveCallInLight: return "\u{fce7}"
        case .visionproMoveCallInOutBold: return "\u{fce8}"
        case .visionproMoveCallInOutFilled: return "\u{fce9}"
        case .visionproMoveCallInOutLight: return "\u{fcea}"
        case .visionproMoveCallInOutRegular: return "\u{fceb}"
        case .visionproMoveCallInRegular: return "\u{fcec}"
        case .visionproMoveCallOutBold: return "\u{fced}"
        case .visionproMoveCallOutFilled: return "\u{fcee}"
        case .visionproMoveCallOutLight: return "\u{fcef}"
        case .visionproMoveCallOutRegular: return "\u{fcf0}"
        case .visionproRegular: return "\u{fcf1}"
        case .voicemailBold: return "\u{fcf2}"
        case .voicemailFilled: return "\u{fcf3}"
        case .voicemailLight: return "\u{fcf4}"
        case .voicemailRegular: return "\u{fcf5}"
        case .vpnBold: return "\u{fcf6}"
        case .vpnFilled: return "\u{fcf7}"
        case .vpnLight: return "\u{fcf8}"
        case .vpnRegular: return "\u{fcf9}"
        case .vscBold: return "\u{fcfa}"
        case .vscLight: return "\u{fcfb}"
        case .vscRegular: return "\u{fcfc}"
        case .waffleMenuBold: return "\u{fcfd}"
        case .waffleMenuLight: return "\u{fcfe}"
        case .waffleMenuRegular: return "\u{fcff}"
        case .waitingRoomBold: return "\u{fd00}"
        case .waitingRoomFilled: return "\u{fd01}"
        case .waitingRoomLight: return "\u{fd02}"
        case .waitingRoomRegular: return "\u{fd03}"
        case .wallpaperBold: return "\u{fd04}"
        case .wallpaperLight: return "\u{fd05}"
        case .wallpaperRegular: return "\u{fd06}"
        case .warningBadgeFilled: return "\u{fd07}"
        case .warningBold: return "\u{fd08}"
        case .warningFilled: return "\u{fd09}"
        case .warningLight: return "\u{fd0a}"
        case .warningRegular: return "\u{fd0b}"
        case .webexBoardBold: return "\u{fd0c}"
        case .webexBoardLight: return "\u{fd0d}"
        case .webexBoardRegular: return "\u{fd0e}"
        case .webexCodecPlusBold: return "\u{fd0f}"
        case .webexCodecPlusLight: return "\u{fd10}"
        case .webexCodecPlusRegular: return "\u{fd11}"
        case .webexDeskCameraBold: return "\u{fd12}"
        case .webexDeskCameraLight: return "\u{fd13}"
        case .webexDeskCameraRegular: return "\u{fd14}"
        case .webexHelixBold: return "\u{fd15}"
        case .webexHelixLight: return "\u{fd16}"
        case .webexHelixRegular: return "\u{fd17}"
        case .webexMeetingsBold: return "\u{fd18}"
        case .webexMeetingsFilled: return "\u{fd19}"
        case .webexMeetingsLight: return "\u{fd1a}"
        case .webexMeetingsRegular: return "\u{fd1b}"
        case .webexQuadCameraBold: return "\u{fd1c}"
        case .webexQuadCameraLight: return "\u{fd1d}"
        case .webexQuadCameraRegular: return "\u{fd1e}"
        case .webexRoomKitBold: return "\u{fd1f}"
        case .webexRoomKitLight: return "\u{fd20}"
        case .webexRoomKitPlusBold: return "\u{fd21}"
        case .webexRoomKitPlusLight: return "\u{fd22}"
        case .webexRoomKitPlusRegular: return "\u{fd23}"
        case .webexRoomKitRegular: return "\u{fd24}"
        case .webexShareBold: return "\u{fd25}"
        case .webexShareLight: return "\u{fd26}"
        case .webexShareRegular: return "\u{fd27}"
        case .webexTeamsBold: return "\u{fd28}"
        case .webexTeamsFilled: return "\u{fd29}"
        case .webexTeamsLight: return "\u{fd2a}"
        case .webexTeamsNewBold: return "\u{fd2b}"
        case .webexTeamsNewFilled: return "\u{fd2c}"
        case .webexTeamsNewLight: return "\u{fd2d}"
        case .webexTeamsNewRegular: return "\u{fd2e}"
        case .webexTeamsRegular: return "\u{fd2f}"
        case .webexTeamsRemoveBold: return "\u{fd30}"
        case .webexTeamsRemoveLight: return "\u{fd31}"
        case .webexTeamsRemoveRegular: return "\u{fd32}"
        case .webhookBold: return "\u{fd33}"
        case .webhookLight: return "\u{fd34}"
        case .webhookRegular: return "\u{fd35}"
        case .webinarBold: return "\u{fd36}"
        case .webinarFilled: return "\u{fd37}"
        case .webinarLight: return "\u{fd38}"
        case .webinarRegular: return "\u{fd39}"
        case .weeklyRecurringScheduleBold: return "\u{fd3a}"
        case .weeklyRecurringScheduleLight: return "\u{fd3b}"
        case .weeklyRecurringScheduleRegular: return "\u{fd3c}"
        case .whisperAnnouncementBold: return "\u{fd3d}"
        case .whisperAnnouncementFilled: return "\u{fd3e}"
        case .whisperAnnouncementLight: return "\u{fd3f}"
        case .whisperAnnouncementRegular: return "\u{fd40}"
        case .whisperCoachBold: return "\u{fd41}"
        case .whisperCoachFilled: return "\u{fd42}"
        case .whisperCoachLight: return "\u{fd43}"
        case .whisperCoachRegular: return "\u{fd44}"
        case .whiteboardBold: return "\u{fd45}"
        case .whiteboardContentBold: return "\u{fd46}"
        case .whiteboardContentFilled: return "\u{fd47}"
        case .whiteboardContentLight: return "\u{fd48}"
        case .whiteboardContentRegular: return "\u{fd49}"
        case .whiteboardFilled: return "\u{fd4a}"
        case .whiteboardLight: return "\u{fd4b}"
        case .whiteboardRegular: return "\u{fd4c}"
        case .widgetBold: return "\u{fd4d}"
        case .widgetFilled: return "\u{fd4e}"
        case .widgetLight: return "\u{fd4f}"
        case .widgetRegular: return "\u{fd50}"
        case .wifiBold: return "\u{fd51}"
        case .wifiErrorBold: return "\u{fd52}"
        case .wifiErrorLight: return "\u{fd53}"
        case .wifiErrorRegular: return "\u{fd54}"
        case .wifiLight: return "\u{fd55}"
        case .wifiRegular: return "\u{fd56}"
        case .wifiSignalGoodBold: return "\u{fd57}"
        case .wifiSignalGoodLight: return "\u{fd58}"
        case .wifiSignalGoodRegular: return "\u{fd59}"
        case .wifiSignalPoorBold: return "\u{fd5a}"
        case .wifiSignalPoorLight: return "\u{fd5b}"
        case .wifiSignalPoorRegular: return "\u{fd5c}"
        case .wifiSignalUnstableBold: return "\u{fd5d}"
        case .wifiSignalUnstableLight: return "\u{fd5e}"
        case .wifiSignalUnstableRegular: return "\u{fd5f}"
        case .windowCornerScrubBold: return "\u{fd60}"
        case .windowCornerScrubLight: return "\u{fd61}"
        case .windowCornerScrubRegular: return "\u{fd62}"
        case .windowRightCornerScrubBold: return "\u{fd63}"
        case .windowRightCornerScrubLight: return "\u{fd64}"
        case .windowRightCornerScrubRegular: return "\u{fd65}"
        case .windowVerticalScrubBold: return "\u{fd66}"
        case .windowVerticalScrubLight: return "\u{fd67}"
        case .windowVerticalScrubRegular: return "\u{fd68}"
        case .workflowDeploymentsBold: return "\u{fd69}"
        case .workflowDeploymentsFilled: return "\u{fd6a}"
        case .workflowDeploymentsLight: return "\u{fd6b}"
        case .workflowDeploymentsRegular: return "\u{fd6c}"
        case .workphoneBold: return "\u{fd6d}"
        case .workphoneLight: return "\u{fd6e}"
        case .workphoneRegular: return "\u{fd6f}"
        case .zoomInBold: return "\u{fd70}"
        case .zoomInLight: return "\u{fd71}"
        case .zoomInRegular: return "\u{fd72}"
        case .zoomOutBold: return "\u{fd73}"
        case .zoomOutLight: return "\u{fd74}"
        case .zoomOutRegular: return "\u{fd75}"
