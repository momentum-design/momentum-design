...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .scheduleSendBold: return "\u{f9a6}"
        case .scheduleSendFilled: return "\u{f9a7}"
        case .scheduleSendLight: return "\u{f9a8}"
        case .scheduleSendRegular: return "\u{f9a9}"
        case .scheduleWinnerBold: return "\u{f9aa}"
        case .scheduleWinnerFilled: return "\u{f9ab}"
        case .scheduleWinnerLight: return "\u{f9ac}"
        case .scheduleWinnerRegular: return "\u{f9ad}"
        case .schedulerAvailableBold: return "\u{f9ae}"
        case .schedulerAvailableLight: return "\u{f9af}"
        case .schedulerAvailableRegular: return "\u{f9b0}"
        case .schedulerNotWorkingHoursBold: return "\u{f9b1}"
        case .schedulerNotWorkingHoursLight: return "\u{f9b2}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9b3}"
        case .schedulerUnavailableBold: return "\u{f9b4}"
        case .schedulerUnavailableLight: return "\u{f9b5}"
        case .schedulerUnavailableRegular: return "\u{f9b6}"
        case .schedulerUnknownBold: return "\u{f9b7}"
        case .schedulerUnknownLight: return "\u{f9b8}"
        case .schedulerUnknownRegular: return "\u{f9b9}"
        case .screenshotBold: return "\u{f9ba}"
        case .screenshotDocBold: return "\u{f9bb}"
        case .screenshotDocFilled: return "\u{f9bc}"
        case .screenshotDocLight: return "\u{f9bd}"
        case .screenshotDocRegular: return "\u{f9be}"
        case .screenshotLight: return "\u{f9bf}"
        case .screenshotRegular: return "\u{f9c0}"
        case .searchBold: return "\u{f9c1}"
        case .searchFilled: return "\u{f9c2}"
        case .searchLight: return "\u{f9c3}"
        case .searchRegular: return "\u{f9c4}"
        case .secondaryArrowBold: return "\u{f9c5}"
        case .secondaryArrowLight: return "\u{f9c6}"
        case .secondaryArrowRegular: return "\u{f9c7}"
        case .secureCallLockBold: return "\u{f9c8}"
        case .secureCallLockFilled: return "\u{f9c9}"
        case .secureCallLockLight: return "\u{f9ca}"
        case .secureCallLockRegular: return "\u{f9cb}"
        case .secureCallShieldBold: return "\u{f9cc}"
        case .secureCallShieldFilled: return "\u{f9cd}"
        case .secureCallShieldLight: return "\u{f9ce}"
        case .secureCallShieldRegular: return "\u{f9cf}"
        case .secureCircleBold: return "\u{f9d0}"
        case .secureCircleFilled: return "\u{f9d1}"
        case .secureCircleLight: return "\u{f9d2}"
        case .secureCircleRegular: return "\u{f9d3}"
        case .secureLockBold: return "\u{f9d4}"
        case .secureLockFilled: return "\u{f9d5}"
        case .secureLockLight: return "\u{f9d6}"
        case .secureLockRegular: return "\u{f9d7}"
        case .segmentExcludeFilled: return "\u{f9d8}"
        case .segmentFilterFilled: return "\u{f9d9}"
        case .segmentIncludeFilled: return "\u{f9da}"
        case .selectAllBold: return "\u{f9db}"
        case .selectAllFilled: return "\u{f9dc}"
        case .selectAllLight: return "\u{f9dd}"
        case .selectAllRegular: return "\u{f9de}"
        case .selectionBold: return "\u{f9df}"
        case .selectionFilled: return "\u{f9e0}"
        case .selectionLight: return "\u{f9e1}"
        case .selectionRegular: return "\u{f9e2}"
        case .sendBold: return "\u{f9e3}"
        case .sendDigitsBold: return "\u{f9e4}"
        case .sendDigitsFilled: return "\u{f9e5}"
        case .sendDigitsLight: return "\u{f9e6}"
        case .sendDigitsRegular: return "\u{f9e7}"
        case .sendFilled: return "\u{f9e8}"
        case .sendLight: return "\u{f9e9}"
        case .sendRegular: return "\u{f9ea}"
        case .sendVoiceBold: return "\u{f9eb}"
        case .sendVoiceFilled: return "\u{f9ec}"
        case .sendVoiceLight: return "\u{f9ed}"
        case .sendVoiceRegular: return "\u{f9ee}"
        case .serverBold: return "\u{f9ef}"
        case .serverErrorBold: return "\u{f9f0}"
        case .serverErrorLight: return "\u{f9f1}"
        case .serverErrorRegular: return "\u{f9f2}"
        case .serverLight: return "\u{f9f3}"
        case .serverRegular: return "\u{f9f4}"
        case .servicesBold: return "\u{f9f5}"
        case .servicesLight: return "\u{f9f6}"
        case .servicesRegular: return "\u{f9f7}"
        case .setVariableBold: return "\u{f9f8}"
        case .setVariableLight: return "\u{f9f9}"
        case .setVariableRegular: return "\u{f9fa}"
        case .settingsBold: return "\u{f9fb}"
        case .settingsFilled: return "\u{f9fc}"
        case .settingsLight: return "\u{f9fd}"
        case .settingsRegular: return "\u{f9fe}"
        case .setupAssistantBold: return "\u{f9ff}"
        case .setupAssistantLight: return "\u{fa00}"
        case .setupAssistantRegular: return "\u{fa01}"
        case .sftpBold: return "\u{fa02}"
        case .sftpLight: return "\u{fa03}"
        case .sftpRegular: return "\u{fa04}"
        case .shapeCircleBold: return "\u{fa05}"
        case .shapeCircleFilled: return "\u{fa06}"
        case .shapeCircleLight: return "\u{fa07}"
        case .shapeCircleMdFilled: return "\u{fa08}"
        case .shapeCircleRegular: return "\u{fa09}"
        case .shapeCircleSmFilled: return "\u{fa0a}"
        case .shapeDiagonalLineBold: return "\u{fa0b}"
        case .shapeDiagonalLineLight: return "\u{fa0c}"
        case .shapeDiagonalLineRegular: return "\u{fa0d}"
        case .shapeDiamondBold: return "\u{fa0e}"
        case .shapeDiamondFilled: return "\u{fa0f}"
        case .shapeDiamondLight: return "\u{fa10}"
        case .shapeDiamondRegular: return "\u{fa11}"
        case .shapeOvalBold: return "\u{fa12}"
        case .shapeOvalLight: return "\u{fa13}"
        case .shapeOvalRegular: return "\u{fa14}"
        case .shapeSquareBold: return "\u{fa15}"
        case .shapeSquareFilled: return "\u{fa16}"
        case .shapeSquareLight: return "\u{fa17}"
        case .shapeSquareRegular: return "\u{fa18}"
        case .shapeTriangleBold: return "\u{fa19}"
        case .shapeTriangleFilled: return "\u{fa1a}"
        case .shapeTriangleLight: return "\u{fa1b}"
        case .shapeTriangleRegular: return "\u{fa1c}"
        case .shapesBold: return "\u{fa1d}"
        case .shapesFilled: return "\u{fa1e}"
        case .shapesLight: return "\u{fa1f}"
        case .shapesRegular: return "\u{fa20}"
        case .shareCNativeAdrBold: return "\u{fa21}"
        case .shareCNativeAdrFilled: return "\u{fa22}"
        case .shareCNativeAdrLight: return "\u{fa23}"
        case .shareCNativeAdrRegular: return "\u{fa24}"
        case .shareCNativeIphBold: return "\u{fa25}"
        case .shareCNativeIphLight: return "\u{fa26}"
        case .shareCNativeIphRegular: return "\u{fa27}"
        case .shareContentOnDeviceBold: return "\u{fa28}"
        case .shareContentOnDeviceLight: return "\u{fa29}"
        case .shareContentOnDeviceRegular: return "\u{fa2a}"
        case .shareScreenAddBold: return "\u{fa2b}"
        case .shareScreenAddLight: return "\u{fa2c}"
        case .shareScreenAddRegular: return "\u{fa2d}"
        case .shareScreenBadgeFilled: return "\u{fa2e}"
        case .shareScreenBold: return "\u{fa2f}"
        case .shareScreenFilled: return "\u{fa30}"
        case .shareScreenLight: return "\u{fa31}"
        case .shareScreenRegular: return "\u{fa32}"
        case .shareSpaceBold: return "\u{fa33}"
        case .shareSpaceLight: return "\u{fa34}"
        case .shareSpaceRegular: return "\u{fa35}"
        case .shieldBold: return "\u{fa36}"
        case .shieldLight: return "\u{fa37}"
        case .shieldRegular: return "\u{fa38}"
        case .shoppingCartBold: return "\u{fa39}"
        case .shoppingCartFilled: return "\u{fa3a}"
        case .shoppingCartLight: return "\u{fa3b}"
        case .shoppingCartRegular: return "\u{fa3c}"
        case .shortTextBoxBold: return "\u{fa3d}"
        case .shortTextBoxLight: return "\u{fa3e}"
        case .shortTextBoxRegular: return "\u{fa3f}"
        case .showBold: return "\u{fa40}"
        case .showFilled: return "\u{fa41}"
        case .showLight: return "\u{fa42}"
        case .showRegular: return "\u{fa43}"
        case .signInBold: return "\u{fa44}"
        case .signInFilled: return "\u{fa45}"
        case .signInForcedBold: return "\u{fa46}"
        case .signInForcedLight: return "\u{fa47}"
        case .signInForcedRegular: return "\u{fa48}"
        case .signInLight: return "\u{fa49}"
        case .signInRegular: return "\u{fa4a}"
        case .signLangIntBold: return "\u{fa4b}"
        case .signLangIntLight: return "\u{fa4c}"
        case .signLangIntRegular: return "\u{fa4d}"
        case .signOutBold: return "\u{fa4e}"
        case .signOutLight: return "\u{fa4f}"
        case .signOutRegular: return "\u{fa50}"
        case .signalFourBold: return "\u{fa51}"
        case .signalFourLight: return "\u{fa52}"
        case .signalFourRegular: return "\u{fa53}"
        case .signalOneBold: return "\u{fa54}"
        case .signalOneLight: return "\u{fa55}"
        case .signalOneRegular: return "\u{fa56}"
        case .signalThreeBold: return "\u{fa57}"
        case .signalThreeLight: return "\u{fa58}"
        case .signalThreeRegular: return "\u{fa59}"
        case .signalTwoBold: return "\u{fa5a}"
        case .signalTwoLight: return "\u{fa5b}"
        case .signalTwoRegular: return "\u{fa5c}"
        case .signalZeroBold: return "\u{fa5d}"
        case .signalZeroLight: return "\u{fa5e}"
        case .signalZeroRegular: return "\u{fa5f}"
        case .simplePromotionBold: return "\u{fa60}"
        case .simplePromotionLight: return "\u{fa61}"
        case .simplePromotionRegular: return "\u{fa62}"
        case .singleNumberReachBold: return "\u{fa63}"
        case .singleNumberReachLight: return "\u{fa64}"
        case .singleNumberReachRegular: return "\u{fa65}"
        case .sipRegistrationInProgressBold: return "\u{fa66}"
        case .sipRegistrationInProgressFilled: return "\u{fa67}"
        case .sipRegistrationInProgressLight: return "\u{fa68}"
        case .sipRegistrationInProgressRegular: return "\u{fa69}"
        case .skipBold: return "\u{fa6a}"
        case .skipBwBold: return "\u{fa6b}"
        case .skipBwFilled: return "\u{fa6c}"
        case .skipBwLight: return "\u{fa6d}"
        case .skipBwRegular: return "\u{fa6e}"
        case .skipFwBold: return "\u{fa6f}"
        case .skipFwFilled: return "\u{fa70}"
        case .skipFwLight: return "\u{fa71}"
        case .skipFwRegular: return "\u{fa72}"
        case .skipLight: return "\u{fa73}"
        case .skipRegular: return "\u{fa74}"
        case .smartAudioBold: return "\u{fa75}"
        case .smartAudioLight: return "\u{fa76}"
        case .smartAudioRegular: return "\u{fa77}"
        case .smsFilled: return "\u{fa78}"
        case .smsInboundBold: return "\u{fa79}"
        case .smsInboundLight: return "\u{fa7a}"
        case .smsInboundRegular: return "\u{fa7b}"
        case .smsMessageBold: return "\u{fa7c}"
        case .smsMessageFilled: return "\u{fa7d}"
        case .smsMessageLight: return "\u{fa7e}"
        case .smsMessageRegular: return "\u{fa7f}"
        case .smsOutgoingFilled: return "\u{fa80}"
        case .smsUnreadBold: return "\u{fa81}"
        case .smsUnreadLight: return "\u{fa82}"
        case .smsUnreadRegular: return "\u{fa83}"
        case .sortAscendingBold: return "\u{fa84}"
        case .sortAscendingLight: return "\u{fa85}"
        case .sortAscendingRegular: return "\u{fa86}"
        case .sortDescendingBold: return "\u{fa87}"
        case .sortDescendingLight: return "\u{fa88}"
        case .sortDescendingRegular: return "\u{fa89}"
        case .soundDefaultBold: return "\u{fa8a}"
        case .soundDefaultLight: return "\u{fa8b}"
        case .soundDefaultRegular: return "\u{fa8c}"
        case .sparkleBold: return "\u{fa8d}"
        case .sparkleFilled: return "\u{fa8e}"
        case .sparkleLight: return "\u{fa8f}"
        case .sparkleRegular: return "\u{fa90}"
        case .speakerBold: return "\u{fa91}"
        case .speakerDisconnectedBold: return "\u{fa92}"
        case .speakerDisconnectedFilled: return "\u{fa93}"
        case .speakerDisconnectedLight: return "\u{fa94}"
        case .speakerDisconnectedRegular: return "\u{fa95}"
        case .speakerFilled: return "\u{fa96}"
        case .speakerLight: return "\u{fa97}"
        case .speakerMutedBold: return "\u{fa98}"
        case .speakerMutedFilled: return "\u{fa99}"
        case .speakerMutedLight: return "\u{fa9a}"
        case .speakerMutedRegular: return "\u{fa9b}"
        case .speakerOffBold: return "\u{fa9c}"
        case .speakerOffFilled: return "\u{fa9d}"
        case .speakerOffLight: return "\u{fa9e}"
        case .speakerOffRegular: return "\u{fa9f}"
        case .speakerOnBold: return "\u{faa0}"
        case .speakerOnLight: return "\u{faa1}"
        case .speakerOnRegular: return "\u{faa2}"
        case .speakerRegular: return "\u{faa3}"
        case .speakerTurnDownBold: return "\u{faa4}"
        case .speakerTurnDownFilled: return "\u{faa5}"
        case .speakerTurnDownLight: return "\u{faa6}"
        case .speakerTurnDownRegular: return "\u{faa7}"
        case .speakerTurnUpBold: return "\u{faa8}"
        case .speakerTurnUpFilled: return "\u{faa9}"
        case .speakerTurnUpLight: return "\u{faaa}"
        case .speakerTurnUpRegular: return "\u{faab}"
        case .speedDialBold: return "\u{faac}"
        case .speedDialFilled: return "\u{faad}"
        case .speedDialLight: return "\u{faae}"
        case .speedDialRegular: return "\u{faaf}"
        case .spellCheckerBold: return "\u{fab0}"
        case .spellCheckerLight: return "\u{fab1}"
        case .spellCheckerRegular: return "\u{fab2}"
        case .splitViewBold: return "\u{fab3}"
        case .splitViewLight: return "\u{fab4}"
        case .splitViewRegular: return "\u{fab5}"
        case .stackedAreaChartBold: return "\u{fab6}"
        case .stackedAreaChartFilled: return "\u{fab7}"
        case .stackedAreaChartFullBold: return "\u{fab8}"
        case .stackedAreaChartFullFilled: return "\u{fab9}"
        case .stackedAreaChartFullLight: return "\u{faba}"
        case .stackedAreaChartFullRegular: return "\u{fabb}"
        case .stackedAreaChartLight: return "\u{fabc}"
        case .stackedAreaChartRegular: return "\u{fabd}"
        case .stackedBarChartBold: return "\u{fabe}"
        case .stackedBarChartFilled: return "\u{fabf}"
        case .stackedBarChartFullBold: return "\u{fac0}"
        case .stackedBarChartFullFilled: return "\u{fac1}"
        case .stackedBarChartFullLight: return "\u{fac2}"
        case .stackedBarChartFullRegular: return "\u{fac3}"
        case .stackedBarChartLight: return "\u{fac4}"
        case .stackedBarChartRegular: return "\u{fac5}"
        case .startChatBold: return "\u{fac6}"
        case .startChatLight: return "\u{fac7}"
        case .startChatRegular: return "\u{fac8}"
        case .stethoscopeBold: return "\u{fac9}"
        case .stethoscopeLight: return "\u{faca}"
        case .stethoscopeRegular: return "\u{facb}"
        case .stickersBold: return "\u{facc}"
        case .stickersLight: return "\u{facd}"
        case .stickersRegular: return "\u{face}"
        case .stickiesBold: return "\u{facf}"
        case .stickiesLight: return "\u{fad0}"
        case .stickiesRegular: return "\u{fad1}"
        case .stopBold: return "\u{fad2}"
        case .stopCircleBold: return "\u{fad3}"
        case .stopCircleFilled: return "\u{fad4}"
        case .stopCircleLight: return "\u{fad5}"
        case .stopCircleRegular: return "\u{fad6}"
        case .stopContentShareBold: return "\u{fad7}"
        case .stopContentShareLight: return "\u{fad8}"
        case .stopContentShareRegular: return "\u{fad9}"
        case .stopFilled: return "\u{fada}"
        case .stopLight: return "\u{fadb}"
        case .stopRegular: return "\u{fadc}"
        case .storedInfoBold: return "\u{fadd}"
        case .storedInfoFilled: return "\u{fade}"
        case .storedInfoLight: return "\u{fadf}"
        case .storedInfoRegular: return "\u{fae0}"
        case .streamingBold: return "\u{fae1}"
        case .streamingLight: return "\u{fae2}"
        case .streamingRegular: return "\u{fae3}"
        case .strikethroughBold: return "\u{fae4}"
        case .strikethroughFilled: return "\u{fae5}"
        case .strikethroughLight: return "\u{fae6}"
        case .strikethroughRegular: return "\u{fae7}"
        case .studioModeBold: return "\u{fae8}"
        case .studioModeLight: return "\u{fae9}"
        case .studioModeRegular: return "\u{faea}"
        case .subscriptBold: return "\u{faeb}"
        case .subscriptLight: return "\u{faec}"
        case .subscriptRegular: return "\u{faed}"
        case .superscriptBold: return "\u{faee}"
        case .superscriptLight: return "\u{faef}"
        case .superscriptRegular: return "\u{faf0}"
        case .surveyBold: return "\u{faf1}"
        case .surveyFilled: return "\u{faf2}"
        case .surveyLight: return "\u{faf3}"
        case .surveyRegular: return "\u{faf4}"
        case .sxEightyCodecBold: return "\u{faf5}"
        case .sxEightyCodecLight: return "\u{faf6}"
        case .sxEightyCodecRegular: return "\u{faf7}"
        case .sxTenBold: return "\u{faf8}"
        case .sxTenLight: return "\u{faf9}"
        case .sxTenRegular: return "\u{fafa}"
        case .sxTwentyBold: return "\u{fafb}"
        case .sxTwentyLight: return "\u{fafc}"
        case .sxTwentyRegular: return "\u{fafd}"
        case .tableBold: return "\u{fafe}"
        case .tableLight: return "\u{faff}"
        case .tableRegular: return "\u{fb00}"
        case .tabletBold: return "\u{fb01}"
        case .tabletLight: return "\u{fb02}"
        case .tabletRegular: return "\u{fb03}"
        case .tabsBold: return "\u{fb04}"
        case .tabsLight: return "\u{fb05}"
        case .tabsRegular: return "\u{fb06}"
        case .tagBold: return "\u{fb07}"
        case .tagLight: return "\u{fb08}"
        case .tagRegular: return "\u{fb09}"
        case .tapBold: return "\u{fb0a}"
        case .tapFilled: return "\u{fb0b}"
        case .tapLight: return "\u{fb0c}"
        case .tapRegular: return "\u{fb0d}"
        case .telepresenceAlertBold: return "\u{fb0e}"
        case .telepresenceAlertLight: return "\u{fb0f}"
        case .telepresenceAlertMutedBold: return "\u{fb10}"
        case .telepresenceAlertMutedLight: return "\u{fb11}"
        case .telepresenceAlertMutedRegular: return "\u{fb12}"
        case .telepresenceAlertRegular: return "\u{fb13}"
        case .telepresenceBold: return "\u{fb14}"
        case .telepresenceIxFiveThousandBold: return "\u{fb15}"
        case .telepresenceIxFiveThousandLight: return "\u{fb16}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb17}"
        case .telepresenceLight: return "\u{fb18}"
        case .telepresenceMutedBold: return "\u{fb19}"
        case .telepresenceMutedLight: return "\u{fb1a}"
        case .telepresenceMutedRegular: return "\u{fb1b}"
        case .telepresencePrivateBold: return "\u{fb1c}"
        case .telepresencePrivateLight: return "\u{fb1d}"
        case .telepresencePrivateRegular: return "\u{fb1e}"
        case .telepresenceRegular: return "\u{fb1f}"
        case .temperatureBold: return "\u{fb20}"
        case .temperatureLight: return "\u{fb21}"
        case .temperatureRegular: return "\u{fb22}"
        case .testTubeBold: return "\u{fb23}"
        case .testTubeFilled: return "\u{fb24}"
        case .testTubeLight: return "\u{fb25}"
        case .testTubeRegular: return "\u{fb26}"
        case .textAlignCenterBold: return "\u{fb27}"
        case .textAlignCenterFilled: return "\u{fb28}"
        case .textAlignCenterLight: return "\u{fb29}"
        case .textAlignCenterRegular: return "\u{fb2a}"
        case .textAlignLeftBold: return "\u{fb2b}"
        case .textAlignLeftFilled: return "\u{fb2c}"
        case .textAlignLeftLight: return "\u{fb2d}"
        case .textAlignLeftRegular: return "\u{fb2e}"
        case .textAlignRightBold: return "\u{fb2f}"
        case .textAlignRightFilled: return "\u{fb30}"
        case .textAlignRightLight: return "\u{fb31}"
        case .textAlignRightRegular: return "\u{fb32}"
        case .textBold: return "\u{fb33}"
        case .textBoxCursorLight: return "\u{fb34}"
        case .textCodeBlockBold: return "\u{fb35}"
        case .textCodeBlockLight: return "\u{fb36}"
        case .textCodeBlockRegular: return "\u{fb37}"
        case .textHighlightBold: return "\u{fb38}"
        case .textHighlightFilled: return "\u{fb39}"
        case .textHighlightLight: return "\u{fb3a}"
        case .textHighlightRegular: return "\u{fb3b}"
        case .textLight: return "\u{fb3c}"
        case .textRegular: return "\u{fb3d}"
        case .threeColumnBold: return "\u{fb3e}"
        case .threeColumnLight: return "\u{fb3f}"
        case .threeColumnRegular: return "\u{fb40}"
        case .threeDObjectBold: return "\u{fb41}"
        case .threeDObjectLight: return "\u{fb42}"
        case .threeDObjectRegular: return "\u{fb43}"
        case .timeExclusionBold: return "\u{fb44}"
        case .timeExclusionLight: return "\u{fb45}"
        case .timeExclusionRegular: return "\u{fb46}"
        case .tooFastBold: return "\u{fb47}"
        case .tooFastLight: return "\u{fb48}"
        case .tooFastRegular: return "\u{fb49}"
        case .tooSlowBold: return "\u{fb4a}"
        case .tooSlowLight: return "\u{fb4b}"
        case .tooSlowRegular: return "\u{fb4c}"
        case .toolsBold: return "\u{fb4d}"
        case .toolsFilled: return "\u{fb4e}"
        case .toolsLight: return "\u{fb4f}"
        case .toolsRegular: return "\u{fb50}"
        case .touchTenBold: return "\u{fb51}"
        case .touchTenLight: return "\u{fb52}"
        case .touchTenRegular: return "\u{fb53}"
        case .transcriptBold: return "\u{fb54}"
        case .transcriptFilled: return "\u{fb55}"
        case .transcriptLight: return "\u{fb56}"
        case .transcriptRegular: return "\u{fb57}"
        case .translateBold: return "\u{fb58}"
        case .translateLight: return "\u{fb59}"
        case .translateRegular: return "\u{fb5a}"
        case .translateUndoBold: return "\u{fb5b}"
        case .translateUndoLight: return "\u{fb5c}"
        case .translateUndoRegular: return "\u{fb5d}"
        case .trendingBold: return "\u{fb5e}"
        case .trendingDownBold: return "\u{fb5f}"
        case .trendingDownFilled: return "\u{fb60}"
        case .trendingDownLight: return "\u{fb61}"
        case .trendingDownRegular: return "\u{fb62}"
        case .trendingFilled: return "\u{fb63}"
        case .trendingLight: return "\u{fb64}"
        case .trendingRegular: return "\u{fb65}"
        case .trimBold: return "\u{fb66}"
        case .trimLight: return "\u{fb67}"
        case .trimRegular: return "\u{fb68}"
        case .twoColumnBold: return "\u{fb69}"
        case .twoColumnLight: return "\u{fb6a}"
        case .twoColumnRegular: return "\u{fb6b}"
        case .twoWayVoiceStreamBold: return "\u{fb6c}"
        case .twoWayVoiceStreamFilled: return "\u{fb6d}"
        case .twoWayVoiceStreamLight: return "\u{fb6e}"
        case .twoWayVoiceStreamRegular: return "\u{fb6f}"
        case .ucmCloudBold: return "\u{fb70}"
        case .ucmCloudLight: return "\u{fb71}"
        case .ucmCloudRegular: return "\u{fb72}"
        case .unblockBold: return "\u{fb73}"
        case .unblockFilled: return "\u{fb74}"
        case .unblockLight: return "\u{fb75}"
        case .unblockRegular: return "\u{fb76}"
        case .underlineBold: return "\u{fb77}"
        case .underlineFilled: return "\u{fb78}"
        case .underlineLight: return "\u{fb79}"
        case .underlineRegular: return "\u{fb7a}"
        case .undoBold: return "\u{fb7b}"
        case .undoLight: return "\u{fb7c}"
        case .undoRegular: return "\u{fb7d}"
        case .unlinkBold: return "\u{fb7e}"
        case .unlinkLight: return "\u{fb7f}"
        case .unlinkRegular: return "\u{fb80}"
        case .unreadBold: return "\u{fb81}"
        case .unreadFilled: return "\u{fb82}"
        case .unreadLight: return "\u{fb83}"
        case .unreadRegular: return "\u{fb84}"
        case .unsecureUnlockedBold: return "\u{fb85}"
        case .unsecureUnlockedFilled: return "\u{fb86}"
        case .unsecureUnlockedLight: return "\u{fb87}"
        case .unsecureUnlockedRegular: return "\u{fb88}"
        case .unsortedBold: return "\u{fb89}"
        case .unsortedLight: return "\u{fb8a}"
        case .unsortedRegular: return "\u{fb8b}"
        case .updateFileShareBold: return "\u{fb8c}"
        case .updateFileShareLight: return "\u{fb8d}"
        case .updateFileShareRegular: return "\u{fb8e}"
        case .uploadBold: return "\u{fb8f}"
        case .uploadImageBold: return "\u{fb90}"
        case .uploadImageLight: return "\u{fb91}"
        case .uploadImageRegular: return "\u{fb92}"
        case .uploadLight: return "\u{fb93}"
        case .uploadRegular: return "\u{fb94}"
        case .urgentVoicemailBold: return "\u{fb95}"
        case .urgentVoicemailFilled: return "\u{fb96}"
        case .usbBold: return "\u{fb97}"
        case .usbHeadsetBold: return "\u{fb98}"
        case .usbHeadsetLight: return "\u{fb99}"
        case .usbHeadsetMutedBold: return "\u{fb9a}"
        case .usbHeadsetMutedLight: return "\u{fb9b}"
        case .usbHeadsetMutedRegular: return "\u{fb9c}"
        case .usbHeadsetRegular: return "\u{fb9d}"
        case .usbLight: return "\u{fb9e}"
        case .usbRegular: return "\u{fb9f}"
        case .userBold: return "\u{fba0}"
        case .userDeactivateBold: return "\u{fba1}"
        case .userDeactivateLight: return "\u{fba2}"
        case .userDeactivateRegular: return "\u{fba3}"
        case .userLight: return "\u{fba4}"
        case .userRegular: return "\u{fba5}"
        case .videoBlurBold: return "\u{fba6}"
        case .videoBlurFilled: return "\u{fba7}"
        case .videoBlurLight: return "\u{fba8}"
        case .videoBlurRegular: return "\u{fba9}"
        case .videoBold: return "\u{fbaa}"
        case .videoEffectBold: return "\u{fbab}"
        case .videoEffectFilled: return "\u{fbac}"
        case .videoEffectLight: return "\u{fbad}"
        case .videoEffectRegular: return "\u{fbae}"
        case .videoFilled: return "\u{fbaf}"
        case .videoLayoutBold: return "\u{fbb0}"
        case .videoLayoutEqualBold: return "\u{fbb1}"
        case .videoLayoutEqualDualBold: return "\u{fbb2}"
        case .videoLayoutEqualDualLight: return "\u{fbb3}"
        case .videoLayoutEqualDualRegular: return "\u{fbb4}"
        case .videoLayoutEqualFilled: return "\u{fbb5}"
        case .videoLayoutEqualLight: return "\u{fbb6}"
        case .videoLayoutEqualRegular: return "\u{fbb7}"
        case .videoLayoutFilled: return "\u{fbb8}"
        case .videoLayoutLight: return "\u{fbb9}"
        case .videoLayoutOverlayBold: return "\u{fbba}"
        case .videoLayoutOverlayFilled: return "\u{fbbb}"
        case .videoLayoutOverlayLight: return "\u{fbbc}"
        case .videoLayoutOverlayRegular: return "\u{fbbd}"
        case .videoLayoutPresenterDominantBold: return "\u{fbbe}"
        case .videoLayoutPresenterDominantLight: return "\u{fbbf}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbc0}"
        case .videoLayoutProminentBold: return "\u{fbc1}"
        case .videoLayoutProminentFilled: return "\u{fbc2}"
        case .videoLayoutProminentLight: return "\u{fbc3}"
        case .videoLayoutProminentRegular: return "\u{fbc4}"
        case .videoLayoutRegular: return "\u{fbc5}"
        case .videoLayoutShareDominantBold: return "\u{fbc6}"
        case .videoLayoutShareDominantLight: return "\u{fbc7}"
        case .videoLayoutShareDominantRegular: return "\u{fbc8}"
        case .videoLayoutSingleBold: return "\u{fbc9}"
        case .videoLayoutSingleFilled: return "\u{fbca}"
        case .videoLayoutSingleLight: return "\u{fbcb}"
        case .videoLayoutSingleRegular: return "\u{fbcc}"
        case .videoLayoutStackBold: return "\u{fbcd}"
        case .videoLayoutStackFilled: return "\u{fbce}"
        case .videoLayoutStackLight: return "\u{fbcf}"
        case .videoLayoutStackRegular: return "\u{fbd0}"
        case .videoLayoutVideoDominantBold: return "\u{fbd1}"
        case .videoLayoutVideoDominantFilled: return "\u{fbd2}"
        case .videoLayoutVideoDominantLight: return "\u{fbd3}"
        case .videoLayoutVideoDominantRegular: return "\u{fbd4}"
        case .videoLight: return "\u{fbd5}"
        case .videoPlusBold: return "\u{fbd6}"
        case .videoPlusFilled: return "\u{fbd7}"
        case .videoPlusLight: return "\u{fbd8}"
        case .videoPlusRegular: return "\u{fbd9}"
        case .videoRegular: return "\u{fbda}"
        case .videoSpeakerTrackBold: return "\u{fbdb}"
        case .videoSpeakerTrackFilled: return "\u{fbdc}"
        case .videoSpeakerTrackLight: return "\u{fbdd}"
        case .videoSpeakerTrackRegular: return "\u{fbde}"
        case .viewAllBold: return "\u{fbdf}"
        case .viewAllLight: return "\u{fbe0}"
        case .viewAllRegular: return "\u{fbe1}"
        case .viewListBold: return "\u{fbe2}"
        case .viewListFilled: return "\u{fbe3}"
        case .viewListLight: return "\u{fbe4}"
        case .viewListRegular: return "\u{fbe5}"
        case .viewStackedBold: return "\u{fbe6}"
        case .viewStackedFilled: return "\u{fbe7}"
        case .viewStackedLight: return "\u{fbe8}"
        case .viewStackedRegular: return "\u{fbe9}"
        case .viewThumbnailBold: return "\u{fbea}"
        case .viewThumbnailFilled: return "\u{fbeb}"
        case .viewThumbnailLight: return "\u{fbec}"
        case .viewThumbnailRegular: return "\u{fbed}"
        case .visionproBold: return "\u{fbee}"
        case .visionproFilled: return "\u{fbef}"
        case .visionproLight: return "\u{fbf0}"
        case .visionproMoveCallInBold: return "\u{fbf1}"
        case .visionproMoveCallInFilled: return "\u{fbf2}"
        case .visionproMoveCallInLight: return "\u{fbf3}"
        case .visionproMoveCallInOutBold: return "\u{fbf4}"
        case .visionproMoveCallInOutFilled: return "\u{fbf5}"
        case .visionproMoveCallInOutLight: return "\u{fbf6}"
        case .visionproMoveCallInOutRegular: return "\u{fbf7}"
        case .visionproMoveCallInRegular: return "\u{fbf8}"
        case .visionproMoveCallOutBold: return "\u{fbf9}"
        case .visionproMoveCallOutFilled: return "\u{fbfa}"
        case .visionproMoveCallOutLight: return "\u{fbfb}"
        case .visionproMoveCallOutRegular: return "\u{fbfc}"
        case .visionproRegular: return "\u{fbfd}"
        case .voicemailBold: return "\u{fbfe}"
        case .voicemailFilled: return "\u{fbff}"
        case .voicemailLight: return "\u{fc00}"
        case .voicemailRegular: return "\u{fc01}"
        case .vpnBold: return "\u{fc02}"
        case .vpnFilled: return "\u{fc03}"
        case .vpnLight: return "\u{fc04}"
        case .vpnRegular: return "\u{fc05}"
        case .vscBold: return "\u{fc06}"
        case .vscLight: return "\u{fc07}"
        case .vscRegular: return "\u{fc08}"
        case .waffleMenuBold: return "\u{fc09}"
        case .waffleMenuLight: return "\u{fc0a}"
        case .waffleMenuRegular: return "\u{fc0b}"
        case .waitingRoomBold: return "\u{fc0c}"
        case .waitingRoomLight: return "\u{fc0d}"
        case .waitingRoomRegular: return "\u{fc0e}"
        case .wallpaperBold: return "\u{fc0f}"
        case .wallpaperLight: return "\u{fc10}"
        case .wallpaperRegular: return "\u{fc11}"
        case .warningBadgeFilled: return "\u{fc12}"
        case .warningBold: return "\u{fc13}"
        case .warningFilled: return "\u{fc14}"
        case .warningLight: return "\u{fc15}"
        case .warningRegular: return "\u{fc16}"
        case .webexBoardBold: return "\u{fc17}"
        case .webexBoardLight: return "\u{fc18}"
        case .webexBoardRegular: return "\u{fc19}"
        case .webexCodecPlusBold: return "\u{fc1a}"
        case .webexCodecPlusLight: return "\u{fc1b}"
        case .webexCodecPlusRegular: return "\u{fc1c}"
        case .webexDeskCameraBold: return "\u{fc1d}"
        case .webexDeskCameraLight: return "\u{fc1e}"
        case .webexDeskCameraRegular: return "\u{fc1f}"
        case .webexMeetingsBold: return "\u{fc20}"
        case .webexMeetingsFilled: return "\u{fc21}"
        case .webexMeetingsLight: return "\u{fc22}"
        case .webexMeetingsRegular: return "\u{fc23}"
        case .webexQuadCameraBold: return "\u{fc24}"
        case .webexQuadCameraLight: return "\u{fc25}"
        case .webexQuadCameraRegular: return "\u{fc26}"
        case .webexRoomKitBold: return "\u{fc27}"
        case .webexRoomKitLight: return "\u{fc28}"
        case .webexRoomKitPlusBold: return "\u{fc29}"
        case .webexRoomKitPlusLight: return "\u{fc2a}"
        case .webexRoomKitPlusRegular: return "\u{fc2b}"
        case .webexRoomKitRegular: return "\u{fc2c}"
        case .webexShareBold: return "\u{fc2d}"
        case .webexShareLight: return "\u{fc2e}"
        case .webexShareRegular: return "\u{fc2f}"
        case .webexTeamsBold: return "\u{fc30}"
        case .webexTeamsFilled: return "\u{fc31}"
        case .webexTeamsLight: return "\u{fc32}"
        case .webexTeamsNewBold: return "\u{fc33}"
        case .webexTeamsNewFilled: return "\u{fc34}"
        case .webexTeamsNewLight: return "\u{fc35}"
        case .webexTeamsNewRegular: return "\u{fc36}"
        case .webexTeamsRegular: return "\u{fc37}"
        case .webexTeamsRemoveBold: return "\u{fc38}"
        case .webexTeamsRemoveLight: return "\u{fc39}"
        case .webexTeamsRemoveRegular: return "\u{fc3a}"
        case .webinarBold: return "\u{fc3b}"
        case .webinarFilled: return "\u{fc3c}"
        case .webinarLight: return "\u{fc3d}"
        case .webinarRegular: return "\u{fc3e}"
        case .weeklyRecurringScheduleBold: return "\u{fc3f}"
        case .weeklyRecurringScheduleLight: return "\u{fc40}"
        case .weeklyRecurringScheduleRegular: return "\u{fc41}"
        case .whisperAnnouncementBold: return "\u{fc42}"
        case .whisperAnnouncementFilled: return "\u{fc43}"
        case .whisperAnnouncementLight: return "\u{fc44}"
        case .whisperAnnouncementRegular: return "\u{fc45}"
        case .whisperCoachBold: return "\u{fc46}"
        case .whisperCoachFilled: return "\u{fc47}"
        case .whisperCoachLight: return "\u{fc48}"
        case .whisperCoachRegular: return "\u{fc49}"
        case .whiteboardBold: return "\u{fc4a}"
        case .whiteboardContentBold: return "\u{fc4b}"
        case .whiteboardContentFilled: return "\u{fc4c}"
        case .whiteboardContentLight: return "\u{fc4d}"
        case .whiteboardContentRegular: return "\u{fc4e}"
        case .whiteboardFilled: return "\u{fc4f}"
        case .whiteboardLight: return "\u{fc50}"
        case .whiteboardRegular: return "\u{fc51}"
        case .widgetBold: return "\u{fc52}"
        case .widgetFilled: return "\u{fc53}"
        case .widgetLight: return "\u{fc54}"
        case .widgetRegular: return "\u{fc55}"
        case .wifiBold: return "\u{fc56}"
        case .wifiErrorBold: return "\u{fc57}"
        case .wifiErrorLight: return "\u{fc58}"
        case .wifiErrorRegular: return "\u{fc59}"
        case .wifiLight: return "\u{fc5a}"
        case .wifiRegular: return "\u{fc5b}"
        case .wifiSignalGoodBold: return "\u{fc5c}"
        case .wifiSignalGoodLight: return "\u{fc5d}"
        case .wifiSignalGoodRegular: return "\u{fc5e}"
        case .wifiSignalPoorBold: return "\u{fc5f}"
        case .wifiSignalPoorLight: return "\u{fc60}"
        case .wifiSignalPoorRegular: return "\u{fc61}"
        case .wifiSignalUnstableBold: return "\u{fc62}"
        case .wifiSignalUnstableLight: return "\u{fc63}"
        case .wifiSignalUnstableRegular: return "\u{fc64}"
        case .windowCornerScrubBold: return "\u{fc65}"
        case .windowCornerScrubLight: return "\u{fc66}"
        case .windowCornerScrubRegular: return "\u{fc67}"
        case .windowRightCornerScrubBold: return "\u{fc68}"
        case .windowRightCornerScrubLight: return "\u{fc69}"
        case .windowRightCornerScrubRegular: return "\u{fc6a}"
        case .windowVerticalScrubBold: return "\u{fc6b}"
        case .windowVerticalScrubLight: return "\u{fc6c}"
        case .windowVerticalScrubRegular: return "\u{fc6d}"
        case .workflowDeploymentsBold: return "\u{fc6e}"
        case .workflowDeploymentsFilled: return "\u{fc6f}"
        case .workflowDeploymentsLight: return "\u{fc70}"
        case .workflowDeploymentsRegular: return "\u{fc71}"
        case .workphoneBold: return "\u{fc72}"
        case .workphoneLight: return "\u{fc73}"
        case .workphoneRegular: return "\u{fc74}"
        case .zoomInBold: return "\u{fc75}"
        case .zoomInLight: return "\u{fc76}"
        case .zoomInRegular: return "\u{fc77}"
        case .zoomOutBold: return "\u{fc78}"
        case .zoomOutLight: return "\u{fc79}"
        case .zoomOutRegular: return "\u{fc7a}"
