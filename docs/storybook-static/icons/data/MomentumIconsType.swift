...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .peopleRegular: return "\u{f885}"
        case .phoneAlertBold: return "\u{f886}"
        case .phoneAlertLight: return "\u{f887}"
        case .phoneAlertRegular: return "\u{f888}"
        case .phoneBadgeFilled: return "\u{f889}"
        case .phoneBold: return "\u{f88a}"
        case .phoneFilled: return "\u{f88b}"
        case .phoneLight: return "\u{f88c}"
        case .phoneMutedBold: return "\u{f88d}"
        case .phoneMutedLight: return "\u{f88e}"
        case .phoneMutedRegular: return "\u{f88f}"
        case .phonePrivateBold: return "\u{f890}"
        case .phonePrivateLight: return "\u{f891}"
        case .phonePrivateRegular: return "\u{f892}"
        case .phoneRegular: return "\u{f893}"
        case .phoneReplyAllBold: return "\u{f894}"
        case .phoneReplyAllLight: return "\u{f895}"
        case .phoneReplyAllRegular: return "\u{f896}"
        case .phoneReplyBold: return "\u{f897}"
        case .phoneReplyLight: return "\u{f898}"
        case .phoneReplyRegular: return "\u{f899}"
        case .pickerBold: return "\u{f89a}"
        case .pickerLight: return "\u{f89b}"
        case .pickerRegular: return "\u{f89c}"
        case .pieChartBold: return "\u{f89d}"
        case .pieChartFilled: return "\u{f89e}"
        case .pieChartLight: return "\u{f89f}"
        case .pieChartRegular: return "\u{f8a0}"
        case .pinBold: return "\u{f8a1}"
        case .pinFilled: return "\u{f8a2}"
        case .pinLight: return "\u{f8a3}"
        case .pinListActivityBold: return "\u{f8a4}"
        case .pinListActivityLight: return "\u{f8a5}"
        case .pinListActivityRegular: return "\u{f8a6}"
        case .pinListBold: return "\u{f8a7}"
        case .pinListLight: return "\u{f8a8}"
        case .pinListRegular: return "\u{f8a9}"
        case .pinMutedBold: return "\u{f8aa}"
        case .pinMutedFilled: return "\u{f8ab}"
        case .pinMutedLight: return "\u{f8ac}"
        case .pinMutedRegular: return "\u{f8ad}"
        case .pinRegular: return "\u{f8ae}"
        case .pipBold: return "\u{f8af}"
        case .pipEnterBold: return "\u{f8b0}"
        case .pipEnterLight: return "\u{f8b1}"
        case .pipEnterRegular: return "\u{f8b2}"
        case .pipExitBold: return "\u{f8b3}"
        case .pipExitLight: return "\u{f8b4}"
        case .pipExitRegular: return "\u{f8b5}"
        case .pipFilled: return "\u{f8b6}"
        case .pipLight: return "\u{f8b7}"
        case .pipRegular: return "\u{f8b8}"
        case .placeholderBold: return "\u{f8b9}"
        case .placeholderFilled: return "\u{f8ba}"
        case .placeholderLight: return "\u{f8bb}"
        case .placeholderRegular: return "\u{f8bc}"
        case .playBold: return "\u{f8bd}"
        case .playCircleBold: return "\u{f8be}"
        case .playCircleFilled: return "\u{f8bf}"
        case .playCircleLight: return "\u{f8c0}"
        case .playCircleRegular: return "\u{f8c1}"
        case .playFilled: return "\u{f8c2}"
        case .playLight: return "\u{f8c3}"
        case .playRegular: return "\u{f8c4}"
        case .plugAcBold: return "\u{f8c5}"
        case .plugAcLight: return "\u{f8c6}"
        case .plugAcRegular: return "\u{f8c7}"
        case .plusBold: return "\u{f8c8}"
        case .plusCircleBold: return "\u{f8c9}"
        case .plusCircleFilled: return "\u{f8ca}"
        case .plusCircleLight: return "\u{f8cb}"
        case .plusCircleRegular: return "\u{f8cc}"
        case .plusLight: return "\u{f8cd}"
        case .plusRegular: return "\u{f8ce}"
        case .pmrBold: return "\u{f8cf}"
        case .pmrFilled: return "\u{f8d0}"
        case .pmrLight: return "\u{f8d1}"
        case .pmrRegular: return "\u{f8d2}"
        case .pollBold: return "\u{f8d3}"
        case .pollFilled: return "\u{f8d4}"
        case .pollLight: return "\u{f8d5}"
        case .pollRegular: return "\u{f8d6}"
        case .popInBold: return "\u{f8d7}"
        case .popInLight: return "\u{f8d8}"
        case .popInRegular: return "\u{f8d9}"
        case .popOutBold: return "\u{f8da}"
        case .popOutLight: return "\u{f8db}"
        case .popOutRegular: return "\u{f8dc}"
        case .popUpBold: return "\u{f8dd}"
        case .popUpLight: return "\u{f8de}"
        case .popUpRegular: return "\u{f8df}"
        case .portraitLandscapeBold: return "\u{f8e0}"
        case .portraitLandscapeLight: return "\u{f8e1}"
        case .portraitLandscapeRegular: return "\u{f8e2}"
        case .potentialFraudBold: return "\u{f8e3}"
        case .potentialFraudFilled: return "\u{f8e4}"
        case .potentialFraudLight: return "\u{f8e5}"
        case .potentialFraudRegular: return "\u{f8e6}"
        case .powerAcBold: return "\u{f8e7}"
        case .powerAcLight: return "\u{f8e8}"
        case .powerAcRegular: return "\u{f8e9}"
        case .powerBold: return "\u{f8ea}"
        case .powerLight: return "\u{f8eb}"
        case .powerRegular: return "\u{f8ec}"
        case .preHeaderBold: return "\u{f8ed}"
        case .preHeaderLight: return "\u{f8ee}"
        case .preHeaderRegular: return "\u{f8ef}"
        case .premiumBold: return "\u{f8f0}"
        case .premiumLight: return "\u{f8f1}"
        case .premiumRegular: return "\u{f8f2}"
        case .presentationBold: return "\u{f8f3}"
        case .presentationLight: return "\u{f8f4}"
        case .presentationRegular: return "\u{f8f5}"
        case .preventDownloadBold: return "\u{f8f6}"
        case .preventDownloadFilled: return "\u{f8f7}"
        case .preventDownloadLight: return "\u{f8f8}"
        case .preventDownloadRegular: return "\u{f8f9}"
        case .primaryParticipantBold: return "\u{f8fa}"
        case .primaryParticipantFilled: return "\u{f8fb}"
        case .primaryParticipantLight: return "\u{f8fc}"
        case .primaryParticipantRegular: return "\u{f8fd}"
        case .printBold: return "\u{f8fe}"
        case .printLight: return "\u{f8ff}"
        case .printRegular: return "\u{f900}"
        case .priorityBadgeFilled: return "\u{f901}"
        case .priorityCircleBold: return "\u{f902}"
        case .priorityCircleFilled: return "\u{f903}"
        case .priorityCircleLight: return "\u{f904}"
        case .priorityCircleRegular: return "\u{f905}"
        case .priorityCircleTwoBold: return "\u{f906}"
        case .priorityCircleTwoFilled: return "\u{f907}"
        case .priorityCircleTwoLight: return "\u{f908}"
        case .priorityCircleTwoRegular: return "\u{f909}"
        case .priorityWaveBold: return "\u{f90a}"
        case .priorityWaveLight: return "\u{f90b}"
        case .priorityWaveRegular: return "\u{f90c}"
        case .privacyCircleBold: return "\u{f90d}"
        case .privacyCircleFilled: return "\u{f90e}"
        case .privacyCircleLight: return "\u{f90f}"
        case .privacyCircleRegular: return "\u{f910}"
        case .privateBold: return "\u{f911}"
        case .privateCircleBold: return "\u{f912}"
        case .privateCircleFilled: return "\u{f913}"
        case .privateCircleLight: return "\u{f914}"
        case .privateCircleRegular: return "\u{f915}"
        case .privateLight: return "\u{f916}"
        case .privateMeetingBold: return "\u{f917}"
        case .privateMeetingLight: return "\u{f918}"
        case .privateMeetingRegular: return "\u{f919}"
        case .privateRegular: return "\u{f91a}"
        case .productDemoBold: return "\u{f91b}"
        case .productDemoLight: return "\u{f91c}"
        case .productDemoRegular: return "\u{f91d}"
        case .promptsAiBold: return "\u{f91e}"
        case .promptsAiLight: return "\u{f91f}"
        case .promptsAiRegular: return "\u{f920}"
        case .proximityBold: return "\u{f921}"
        case .proximityLight: return "\u{f922}"
        case .proximityMutedBold: return "\u{f923}"
        case .proximityMutedLight: return "\u{f924}"
        case .proximityMutedRegular: return "\u{f925}"
        case .proximityRegular: return "\u{f926}"
        case .proximityVideoBold: return "\u{f927}"
        case .proximityVideoLight: return "\u{f928}"
        case .proximityVideoRegular: return "\u{f929}"
        case .ptoPresenceBold: return "\u{f92a}"
        case .ptoPresenceFilled: return "\u{f92b}"
        case .ptoPresenceLight: return "\u{f92c}"
        case .ptoPresenceRegular: return "\u{f92d}"
        case .pullCallBold: return "\u{f92e}"
        case .pullCallFilled: return "\u{f92f}"
        case .pullCallLight: return "\u{f930}"
        case .pullCallRegular: return "\u{f931}"
        case .qABold: return "\u{f932}"
        case .qAFilled: return "\u{f933}"
        case .qALight: return "\u{f934}"
        case .qARegular: return "\u{f935}"
        case .qrCodeBold: return "\u{f936}"
        case .qrCodeLight: return "\u{f937}"
        case .qrCodeRegular: return "\u{f938}"
        case .qrCodeScanBold: return "\u{f939}"
        case .qrCodeScanLight: return "\u{f93a}"
        case .qrCodeScanRegular: return "\u{f93b}"
        case .qualityBold: return "\u{f93c}"
        case .qualityLight: return "\u{f93d}"
        case .qualityRegular: return "\u{f93e}"
        case .queueContactBold: return "\u{f93f}"
        case .queueContactFilled: return "\u{f940}"
        case .queueContactLight: return "\u{f941}"
        case .queueContactRegular: return "\u{f942}"
        case .quietBold: return "\u{f943}"
        case .quietHoursPresenceBold: return "\u{f944}"
        case .quietHoursPresenceFilled: return "\u{f945}"
        case .quietHoursPresenceLight: return "\u{f946}"
        case .quietHoursPresenceRegular: return "\u{f947}"
        case .quietLight: return "\u{f948}"
        case .quietRegular: return "\u{f949}"
        case .radioButtonGroupBold: return "\u{f94a}"
        case .radioButtonGroupLight: return "\u{f94b}"
        case .radioButtonGroupRegular: return "\u{f94c}"
        case .raiseHandBold: return "\u{f94d}"
        case .raiseHandCircleFilled: return "\u{f94e}"
        case .raiseHandFilled: return "\u{f94f}"
        case .raiseHandLight: return "\u{f950}"
        case .raiseHandRegular: return "\u{f951}"
        case .ramBold: return "\u{f952}"
        case .ramLight: return "\u{f953}"
        case .ramRegular: return "\u{f954}"
        case .reactionsBold: return "\u{f955}"
        case .reactionsFilled: return "\u{f956}"
        case .reactionsLight: return "\u{f957}"
        case .reactionsRegular: return "\u{f958}"
        case .reactivateBold: return "\u{f959}"
        case .reactivateLight: return "\u{f95a}"
        case .reactivateRegular: return "\u{f95b}"
        case .receiveVoiceBold: return "\u{f95c}"
        case .receiveVoiceFilled: return "\u{f95d}"
        case .receiveVoiceLight: return "\u{f95e}"
        case .receiveVoiceRegular: return "\u{f95f}"
        case .recentsBold: return "\u{f960}"
        case .recentsFilled: return "\u{f961}"
        case .recentsLight: return "\u{f962}"
        case .recentsPresenceBadgeFilled: return "\u{f963}"
        case .recentsPresenceBold: return "\u{f964}"
        case .recentsPresenceFilled: return "\u{f965}"
        case .recentsPresenceLight: return "\u{f966}"
        case .recentsPresenceRegular: return "\u{f967}"
        case .recentsRegular: return "\u{f968}"
        case .recordActiveBadgeFilled: return "\u{f969}"
        case .recordActiveBold: return "\u{f96a}"
        case .recordActiveFilled: return "\u{f96b}"
        case .recordActiveLight: return "\u{f96c}"
        case .recordActiveRegular: return "\u{f96d}"
        case .recordBold: return "\u{f96e}"
        case .recordFilled: return "\u{f96f}"
        case .recordLight: return "\u{f970}"
        case .recordPausedBadgeFilled: return "\u{f971}"
        case .recordPausedBold: return "\u{f972}"
        case .recordPausedFilled: return "\u{f973}"
        case .recordPausedLight: return "\u{f974}"
        case .recordPausedRegular: return "\u{f975}"
        case .recordRegular: return "\u{f976}"
        case .recurringBold: return "\u{f977}"
        case .recurringLight: return "\u{f978}"
        case .recurringOffBold: return "\u{f979}"
        case .recurringOffLight: return "\u{f97a}"
        case .recurringOffRegular: return "\u{f97b}"
        case .recurringRegular: return "\u{f97c}"
        case .redoBold: return "\u{f97d}"
        case .redoLight: return "\u{f97e}"
        case .redoRegular: return "\u{f97f}"
        case .refreshBold: return "\u{f980}"
        case .refreshLight: return "\u{f981}"
        case .refreshRegular: return "\u{f982}"
        case .remoteDesktopControlBold: return "\u{f983}"
        case .remoteDesktopControlFilled: return "\u{f984}"
        case .remoteDesktopControlLight: return "\u{f985}"
        case .remoteDesktopControlRegular: return "\u{f986}"
        case .removeBold: return "\u{f987}"
        case .removeFilled: return "\u{f988}"
        case .removeLight: return "\u{f989}"
        case .removeRegular: return "\u{f98a}"
        case .replyBold: return "\u{f98b}"
        case .replyFilled: return "\u{f98c}"
        case .replyLight: return "\u{f98d}"
        case .replyListBold: return "\u{f98e}"
        case .replyListLight: return "\u{f98f}"
        case .replyListRegular: return "\u{f990}"
        case .replyPrivatelyBold: return "\u{f991}"
        case .replyPrivatelyLight: return "\u{f992}"
        case .replyPrivatelyRegular: return "\u{f993}"
        case .replyRegular: return "\u{f994}"
        case .resetBold: return "\u{f995}"
        case .resetLight: return "\u{f996}"
        case .resetRegular: return "\u{f997}"
        case .resizeCornerBold: return "\u{f998}"
        case .resizeCornerLight: return "\u{f999}"
        case .resizeCornerRegular: return "\u{f99a}"
        case .responsiveMobileBold: return "\u{f99b}"
        case .responsiveMobileLight: return "\u{f99c}"
        case .responsiveMobileRegular: return "\u{f99d}"
        case .restartBold: return "\u{f99e}"
        case .restartLight: return "\u{f99f}"
        case .restartRegular: return "\u{f9a0}"
        case .retrieveCallBold: return "\u{f9a1}"
        case .retrieveCallFilled: return "\u{f9a2}"
        case .retrieveCallLight: return "\u{f9a3}"
        case .retrieveCallRegular: return "\u{f9a4}"
        case .returnBold: return "\u{f9a5}"
        case .returnLight: return "\u{f9a6}"
        case .returnRegular: return "\u{f9a7}"
        case .rewindTenSecBold: return "\u{f9a8}"
        case .rewindTenSecLight: return "\u{f9a9}"
        case .rewindTenSecRegular: return "\u{f9aa}"
        case .ringtoneBold: return "\u{f9ab}"
        case .ringtoneLight: return "\u{f9ac}"
        case .ringtoneRegular: return "\u{f9ad}"
        case .roomCalendarBold: return "\u{f9ae}"
        case .roomCalendarLight: return "\u{f9af}"
        case .roomCalendarRegular: return "\u{f9b0}"
        case .roomLightsBold: return "\u{f9b1}"
        case .roomLightsFilled: return "\u{f9b2}"
        case .roomLightsLight: return "\u{f9b3}"
        case .roomLightsRegular: return "\u{f9b4}"
        case .rotateContentBold: return "\u{f9b5}"
        case .rotateContentFilled: return "\u{f9b6}"
        case .rotateContentLight: return "\u{f9b7}"
        case .rotateContentRegular: return "\u{f9b8}"
        case .rssBold: return "\u{f9b9}"
        case .rssFilled: return "\u{f9ba}"
        case .rssLight: return "\u{f9bb}"
        case .rssRegular: return "\u{f9bc}"
        case .ruleBasedBold: return "\u{f9bd}"
        case .ruleBasedLight: return "\u{f9be}"
        case .ruleBasedRegular: return "\u{f9bf}"
        case .runningApplicationBold: return "\u{f9c0}"
        case .runningApplicationFilled: return "\u{f9c1}"
        case .runningApplicationLight: return "\u{f9c2}"
        case .runningApplicationRegular: return "\u{f9c3}"
        case .saveBold: return "\u{f9c4}"
        case .saveLight: return "\u{f9c5}"
        case .saveRegular: return "\u{f9c6}"
        case .saveTranscriptBold: return "\u{f9c7}"
        case .saveTranscriptFilled: return "\u{f9c8}"
        case .saveTranscriptLight: return "\u{f9c9}"
        case .saveTranscriptRegular: return "\u{f9ca}"
        case .scanBold: return "\u{f9cb}"
        case .scanLight: return "\u{f9cc}"
        case .scanRegular: return "\u{f9cd}"
        case .scheduleAiBold: return "\u{f9ce}"
        case .scheduleAiLight: return "\u{f9cf}"
        case .scheduleAiRegular: return "\u{f9d0}"
        case .scheduleSendBold: return "\u{f9d1}"
        case .scheduleSendFilled: return "\u{f9d2}"
        case .scheduleSendLight: return "\u{f9d3}"
        case .scheduleSendRegular: return "\u{f9d4}"
        case .scheduleWinnerBold: return "\u{f9d5}"
        case .scheduleWinnerFilled: return "\u{f9d6}"
        case .scheduleWinnerLight: return "\u{f9d7}"
        case .scheduleWinnerRegular: return "\u{f9d8}"
        case .schedulerAvailableBold: return "\u{f9d9}"
        case .schedulerAvailableLight: return "\u{f9da}"
        case .schedulerAvailableRegular: return "\u{f9db}"
        case .schedulerNotWorkingHoursBold: return "\u{f9dc}"
        case .schedulerNotWorkingHoursLight: return "\u{f9dd}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9de}"
        case .schedulerUnavailableBold: return "\u{f9df}"
        case .schedulerUnavailableLight: return "\u{f9e0}"
        case .schedulerUnavailableRegular: return "\u{f9e1}"
        case .schedulerUnknownBold: return "\u{f9e2}"
        case .schedulerUnknownLight: return "\u{f9e3}"
        case .schedulerUnknownRegular: return "\u{f9e4}"
        case .screenshotBold: return "\u{f9e5}"
        case .screenshotDocBold: return "\u{f9e6}"
        case .screenshotDocFilled: return "\u{f9e7}"
        case .screenshotDocLight: return "\u{f9e8}"
        case .screenshotDocRegular: return "\u{f9e9}"
        case .screenshotLight: return "\u{f9ea}"
        case .screenshotRegular: return "\u{f9eb}"
        case .searchAiBold: return "\u{f9ec}"
        case .searchAiLight: return "\u{f9ed}"
        case .searchAiRegular: return "\u{f9ee}"
        case .searchBold: return "\u{f9ef}"
        case .searchFilled: return "\u{f9f0}"
        case .searchLight: return "\u{f9f1}"
        case .searchRegular: return "\u{f9f2}"
        case .secondaryArrowBold: return "\u{f9f3}"
        case .secondaryArrowLight: return "\u{f9f4}"
        case .secondaryArrowRegular: return "\u{f9f5}"
        case .secureCallLockBold: return "\u{f9f6}"
        case .secureCallLockFilled: return "\u{f9f7}"
        case .secureCallLockLight: return "\u{f9f8}"
        case .secureCallLockRegular: return "\u{f9f9}"
        case .secureCallShieldBold: return "\u{f9fa}"
        case .secureCallShieldFilled: return "\u{f9fb}"
        case .secureCallShieldLight: return "\u{f9fc}"
        case .secureCallShieldRegular: return "\u{f9fd}"
        case .secureCircleBold: return "\u{f9fe}"
        case .secureCircleFilled: return "\u{f9ff}"
        case .secureCircleLight: return "\u{fa00}"
        case .secureCircleRegular: return "\u{fa01}"
        case .secureLockBold: return "\u{fa02}"
        case .secureLockFilled: return "\u{fa03}"
        case .secureLockLight: return "\u{fa04}"
        case .secureLockRegular: return "\u{fa05}"
        case .segmentExcludeFilled: return "\u{fa06}"
        case .segmentFilterFilled: return "\u{fa07}"
        case .segmentIncludeFilled: return "\u{fa08}"
        case .selectAllBold: return "\u{fa09}"
        case .selectAllFilled: return "\u{fa0a}"
        case .selectAllLight: return "\u{fa0b}"
        case .selectAllRegular: return "\u{fa0c}"
        case .selectionBold: return "\u{fa0d}"
        case .selectionFilled: return "\u{fa0e}"
        case .selectionLight: return "\u{fa0f}"
        case .selectionRegular: return "\u{fa10}"
        case .sendBold: return "\u{fa11}"
        case .sendDigitsBold: return "\u{fa12}"
        case .sendDigitsFilled: return "\u{fa13}"
        case .sendDigitsLight: return "\u{fa14}"
        case .sendDigitsRegular: return "\u{fa15}"
        case .sendFilled: return "\u{fa16}"
        case .sendLight: return "\u{fa17}"
        case .sendRegular: return "\u{fa18}"
        case .sendVoiceBold: return "\u{fa19}"
        case .sendVoiceFilled: return "\u{fa1a}"
        case .sendVoiceLight: return "\u{fa1b}"
        case .sendVoiceRegular: return "\u{fa1c}"
        case .serverBold: return "\u{fa1d}"
        case .serverErrorBold: return "\u{fa1e}"
        case .serverErrorLight: return "\u{fa1f}"
        case .serverErrorRegular: return "\u{fa20}"
        case .serverLight: return "\u{fa21}"
        case .serverRegular: return "\u{fa22}"
        case .servicesBold: return "\u{fa23}"
        case .servicesLight: return "\u{fa24}"
        case .servicesRegular: return "\u{fa25}"
        case .setVariableBold: return "\u{fa26}"
        case .setVariableLight: return "\u{fa27}"
        case .setVariableRegular: return "\u{fa28}"
        case .settingsBold: return "\u{fa29}"
        case .settingsFilled: return "\u{fa2a}"
        case .settingsLight: return "\u{fa2b}"
        case .settingsRegular: return "\u{fa2c}"
        case .setupAssistantBold: return "\u{fa2d}"
        case .setupAssistantLight: return "\u{fa2e}"
        case .setupAssistantRegular: return "\u{fa2f}"
        case .sftpBold: return "\u{fa30}"
        case .sftpLight: return "\u{fa31}"
        case .sftpRegular: return "\u{fa32}"
        case .shapeCircleBold: return "\u{fa33}"
        case .shapeCircleFilled: return "\u{fa34}"
        case .shapeCircleLight: return "\u{fa35}"
        case .shapeCircleMdFilled: return "\u{fa36}"
        case .shapeCircleRegular: return "\u{fa37}"
        case .shapeCircleSmFilled: return "\u{fa38}"
        case .shapeDiagonalLineBold: return "\u{fa39}"
        case .shapeDiagonalLineLight: return "\u{fa3a}"
        case .shapeDiagonalLineRegular: return "\u{fa3b}"
        case .shapeDiamondBold: return "\u{fa3c}"
        case .shapeDiamondFilled: return "\u{fa3d}"
        case .shapeDiamondLight: return "\u{fa3e}"
        case .shapeDiamondRegular: return "\u{fa3f}"
        case .shapeOvalBold: return "\u{fa40}"
        case .shapeOvalLight: return "\u{fa41}"
        case .shapeOvalRegular: return "\u{fa42}"
        case .shapeSquareBold: return "\u{fa43}"
        case .shapeSquareFilled: return "\u{fa44}"
        case .shapeSquareLight: return "\u{fa45}"
        case .shapeSquareRegular: return "\u{fa46}"
        case .shapeTriangleBold: return "\u{fa47}"
        case .shapeTriangleFilled: return "\u{fa48}"
        case .shapeTriangleLight: return "\u{fa49}"
        case .shapeTriangleRegular: return "\u{fa4a}"
        case .shapesBold: return "\u{fa4b}"
        case .shapesFilled: return "\u{fa4c}"
        case .shapesLight: return "\u{fa4d}"
        case .shapesRegular: return "\u{fa4e}"
        case .shareCNativeAdrBold: return "\u{fa4f}"
        case .shareCNativeAdrFilled: return "\u{fa50}"
        case .shareCNativeAdrLight: return "\u{fa51}"
        case .shareCNativeAdrRegular: return "\u{fa52}"
        case .shareCNativeIphBold: return "\u{fa53}"
        case .shareCNativeIphLight: return "\u{fa54}"
        case .shareCNativeIphRegular: return "\u{fa55}"
        case .shareContentOnDeviceBold: return "\u{fa56}"
        case .shareContentOnDeviceLight: return "\u{fa57}"
        case .shareContentOnDeviceRegular: return "\u{fa58}"
        case .shareScreenAddBold: return "\u{fa59}"
        case .shareScreenAddLight: return "\u{fa5a}"
        case .shareScreenAddRegular: return "\u{fa5b}"
        case .shareScreenBadgeFilled: return "\u{fa5c}"
        case .shareScreenBold: return "\u{fa5d}"
        case .shareScreenFilled: return "\u{fa5e}"
        case .shareScreenLight: return "\u{fa5f}"
        case .shareScreenRegular: return "\u{fa60}"
        case .shareSpaceBold: return "\u{fa61}"
        case .shareSpaceLight: return "\u{fa62}"
        case .shareSpaceRegular: return "\u{fa63}"
        case .shieldBold: return "\u{fa64}"
        case .shieldLight: return "\u{fa65}"
        case .shieldRegular: return "\u{fa66}"
        case .shoppingCartBold: return "\u{fa67}"
        case .shoppingCartFilled: return "\u{fa68}"
        case .shoppingCartLight: return "\u{fa69}"
        case .shoppingCartRegular: return "\u{fa6a}"
        case .shortTextBoxBold: return "\u{fa6b}"
        case .shortTextBoxLight: return "\u{fa6c}"
        case .shortTextBoxRegular: return "\u{fa6d}"
        case .showBold: return "\u{fa6e}"
        case .showFilled: return "\u{fa6f}"
        case .showLight: return "\u{fa70}"
        case .showRegular: return "\u{fa71}"
        case .sidePanelBold: return "\u{fa72}"
        case .sidePanelFilled: return "\u{fa73}"
        case .sidePanelLight: return "\u{fa74}"
        case .sidePanelRegular: return "\u{fa75}"
        case .signInBold: return "\u{fa76}"
        case .signInFilled: return "\u{fa77}"
        case .signInForcedBold: return "\u{fa78}"
        case .signInForcedLight: return "\u{fa79}"
        case .signInForcedRegular: return "\u{fa7a}"
        case .signInLight: return "\u{fa7b}"
        case .signInRegular: return "\u{fa7c}"
        case .signLangIntBold: return "\u{fa7d}"
        case .signLangIntLight: return "\u{fa7e}"
        case .signLangIntRegular: return "\u{fa7f}"
        case .signOutBold: return "\u{fa80}"
        case .signOutLight: return "\u{fa81}"
        case .signOutRegular: return "\u{fa82}"
        case .signalFourBold: return "\u{fa83}"
        case .signalFourLight: return "\u{fa84}"
        case .signalFourRegular: return "\u{fa85}"
        case .signalOneBold: return "\u{fa86}"
        case .signalOneLight: return "\u{fa87}"
        case .signalOneRegular: return "\u{fa88}"
        case .signalThreeBold: return "\u{fa89}"
        case .signalThreeLight: return "\u{fa8a}"
        case .signalThreeRegular: return "\u{fa8b}"
        case .signalTwoBold: return "\u{fa8c}"
        case .signalTwoLight: return "\u{fa8d}"
        case .signalTwoRegular: return "\u{fa8e}"
        case .signalZeroBold: return "\u{fa8f}"
        case .signalZeroLight: return "\u{fa90}"
        case .signalZeroRegular: return "\u{fa91}"
        case .simplePromotionBold: return "\u{fa92}"
        case .simplePromotionLight: return "\u{fa93}"
        case .simplePromotionRegular: return "\u{fa94}"
        case .singleNumberReachBold: return "\u{fa95}"
        case .singleNumberReachLight: return "\u{fa96}"
        case .singleNumberReachRegular: return "\u{fa97}"
        case .sipRegistrationInProgressBold: return "\u{fa98}"
        case .sipRegistrationInProgressFilled: return "\u{fa99}"
        case .sipRegistrationInProgressLight: return "\u{fa9a}"
        case .sipRegistrationInProgressRegular: return "\u{fa9b}"
        case .skipBold: return "\u{fa9c}"
        case .skipBwBold: return "\u{fa9d}"
        case .skipBwFilled: return "\u{fa9e}"
        case .skipBwLight: return "\u{fa9f}"
        case .skipBwRegular: return "\u{faa0}"
        case .skipFwBold: return "\u{faa1}"
        case .skipFwFilled: return "\u{faa2}"
        case .skipFwLight: return "\u{faa3}"
        case .skipFwRegular: return "\u{faa4}"
        case .skipLight: return "\u{faa5}"
        case .skipRegular: return "\u{faa6}"
        case .smartAudioBold: return "\u{faa7}"
        case .smartAudioLight: return "\u{faa8}"
        case .smartAudioRegular: return "\u{faa9}"
        case .smsFilled: return "\u{faaa}"
        case .smsInboundBold: return "\u{faab}"
        case .smsInboundLight: return "\u{faac}"
        case .smsInboundRegular: return "\u{faad}"
        case .smsMessageBold: return "\u{faae}"
        case .smsMessageFilled: return "\u{faaf}"
        case .smsMessageLight: return "\u{fab0}"
        case .smsMessageRegular: return "\u{fab1}"
        case .smsOutgoingFilled: return "\u{fab2}"
        case .smsUnreadBold: return "\u{fab3}"
        case .smsUnreadLight: return "\u{fab4}"
        case .smsUnreadRegular: return "\u{fab5}"
        case .sortAscendingBold: return "\u{fab6}"
        case .sortAscendingLight: return "\u{fab7}"
        case .sortAscendingRegular: return "\u{fab8}"
        case .sortDescendingBold: return "\u{fab9}"
        case .sortDescendingLight: return "\u{faba}"
        case .sortDescendingRegular: return "\u{fabb}"
        case .soundDefaultBold: return "\u{fabc}"
        case .soundDefaultLight: return "\u{fabd}"
        case .soundDefaultRegular: return "\u{fabe}"
        case .sparkleBold: return "\u{fabf}"
        case .sparkleFilled: return "\u{fac0}"
        case .sparkleLight: return "\u{fac1}"
        case .sparkleRegular: return "\u{fac2}"
        case .speakerBold: return "\u{fac3}"
        case .speakerDisconnectedBold: return "\u{fac4}"
        case .speakerDisconnectedFilled: return "\u{fac5}"
        case .speakerDisconnectedLight: return "\u{fac6}"
        case .speakerDisconnectedRegular: return "\u{fac7}"
        case .speakerFilled: return "\u{fac8}"
        case .speakerLight: return "\u{fac9}"
        case .speakerMutedBold: return "\u{faca}"
        case .speakerMutedFilled: return "\u{facb}"
        case .speakerMutedLight: return "\u{facc}"
        case .speakerMutedRegular: return "\u{facd}"
        case .speakerOffBold: return "\u{face}"
        case .speakerOffFilled: return "\u{facf}"
        case .speakerOffLight: return "\u{fad0}"
        case .speakerOffRegular: return "\u{fad1}"
        case .speakerOnBold: return "\u{fad2}"
        case .speakerOnLight: return "\u{fad3}"
        case .speakerOnRegular: return "\u{fad4}"
        case .speakerRegular: return "\u{fad5}"
        case .speakerTurnDownBold: return "\u{fad6}"
        case .speakerTurnDownFilled: return "\u{fad7}"
        case .speakerTurnDownLight: return "\u{fad8}"
        case .speakerTurnDownRegular: return "\u{fad9}"
        case .speakerTurnUpBold: return "\u{fada}"
        case .speakerTurnUpFilled: return "\u{fadb}"
        case .speakerTurnUpLight: return "\u{fadc}"
        case .speakerTurnUpRegular: return "\u{fadd}"
        case .speedDialBold: return "\u{fade}"
        case .speedDialFilled: return "\u{fadf}"
        case .speedDialLight: return "\u{fae0}"
        case .speedDialRegular: return "\u{fae1}"
        case .spellCheckerBold: return "\u{fae2}"
        case .spellCheckerLight: return "\u{fae3}"
        case .spellCheckerRegular: return "\u{fae4}"
        case .splitViewBold: return "\u{fae5}"
        case .splitViewLight: return "\u{fae6}"
        case .splitViewRegular: return "\u{fae7}"
        case .stackedAreaChartBold: return "\u{fae8}"
        case .stackedAreaChartFilled: return "\u{fae9}"
        case .stackedAreaChartFullBold: return "\u{faea}"
        case .stackedAreaChartFullFilled: return "\u{faeb}"
        case .stackedAreaChartFullLight: return "\u{faec}"
        case .stackedAreaChartFullRegular: return "\u{faed}"
        case .stackedAreaChartLight: return "\u{faee}"
        case .stackedAreaChartRegular: return "\u{faef}"
        case .stackedBarChartBold: return "\u{faf0}"
        case .stackedBarChartFilled: return "\u{faf1}"
        case .stackedBarChartFullBold: return "\u{faf2}"
        case .stackedBarChartFullFilled: return "\u{faf3}"
        case .stackedBarChartFullLight: return "\u{faf4}"
        case .stackedBarChartFullRegular: return "\u{faf5}"
        case .stackedBarChartLight: return "\u{faf6}"
        case .stackedBarChartRegular: return "\u{faf7}"
        case .startChatBold: return "\u{faf8}"
        case .startChatLight: return "\u{faf9}"
        case .startChatRegular: return "\u{fafa}"
        case .stethoscopeBold: return "\u{fafb}"
        case .stethoscopeLight: return "\u{fafc}"
        case .stethoscopeRegular: return "\u{fafd}"
        case .stickersBold: return "\u{fafe}"
        case .stickersLight: return "\u{faff}"
        case .stickersRegular: return "\u{fb00}"
        case .stickiesBold: return "\u{fb01}"
        case .stickiesLight: return "\u{fb02}"
        case .stickiesRegular: return "\u{fb03}"
        case .stopBold: return "\u{fb04}"
        case .stopCircleBold: return "\u{fb05}"
        case .stopCircleFilled: return "\u{fb06}"
        case .stopCircleLight: return "\u{fb07}"
        case .stopCircleRegular: return "\u{fb08}"
        case .stopContentShareBold: return "\u{fb09}"
        case .stopContentShareLight: return "\u{fb0a}"
        case .stopContentShareRegular: return "\u{fb0b}"
        case .stopFilled: return "\u{fb0c}"
        case .stopLight: return "\u{fb0d}"
        case .stopRegular: return "\u{fb0e}"
        case .storedInfoBold: return "\u{fb0f}"
        case .storedInfoFilled: return "\u{fb10}"
        case .storedInfoLight: return "\u{fb11}"
        case .storedInfoRegular: return "\u{fb12}"
        case .streamingBold: return "\u{fb13}"
        case .streamingLight: return "\u{fb14}"
        case .streamingRegular: return "\u{fb15}"
        case .strikethroughBold: return "\u{fb16}"
        case .strikethroughFilled: return "\u{fb17}"
        case .strikethroughLight: return "\u{fb18}"
        case .strikethroughRegular: return "\u{fb19}"
        case .studioModeBold: return "\u{fb1a}"
        case .studioModeLight: return "\u{fb1b}"
        case .studioModeRegular: return "\u{fb1c}"
        case .subscriptBold: return "\u{fb1d}"
        case .subscriptLight: return "\u{fb1e}"
        case .subscriptRegular: return "\u{fb1f}"
        case .summarizeAiBold: return "\u{fb20}"
        case .summarizeAiLight: return "\u{fb21}"
        case .summarizeAiRegular: return "\u{fb22}"
        case .superscriptBold: return "\u{fb23}"
        case .superscriptLight: return "\u{fb24}"
        case .superscriptRegular: return "\u{fb25}"
        case .surveyBold: return "\u{fb26}"
        case .surveyFilled: return "\u{fb27}"
        case .surveyLight: return "\u{fb28}"
        case .surveyRegular: return "\u{fb29}"
        case .sxEightyCodecBold: return "\u{fb2a}"
        case .sxEightyCodecLight: return "\u{fb2b}"
        case .sxEightyCodecRegular: return "\u{fb2c}"
        case .sxTenBold: return "\u{fb2d}"
        case .sxTenLight: return "\u{fb2e}"
        case .sxTenRegular: return "\u{fb2f}"
        case .sxTwentyBold: return "\u{fb30}"
        case .sxTwentyLight: return "\u{fb31}"
        case .sxTwentyRegular: return "\u{fb32}"
        case .tableBold: return "\u{fb33}"
        case .tableLight: return "\u{fb34}"
        case .tableRegular: return "\u{fb35}"
        case .tabletBold: return "\u{fb36}"
        case .tabletLight: return "\u{fb37}"
        case .tabletRegular: return "\u{fb38}"
        case .tabsBold: return "\u{fb39}"
        case .tabsLight: return "\u{fb3a}"
        case .tabsRegular: return "\u{fb3b}"
        case .tagBold: return "\u{fb3c}"
        case .tagLight: return "\u{fb3d}"
        case .tagRegular: return "\u{fb3e}"
        case .tapBold: return "\u{fb3f}"
        case .tapFilled: return "\u{fb40}"
        case .tapLight: return "\u{fb41}"
        case .tapRegular: return "\u{fb42}"
        case .telepresenceAlertBold: return "\u{fb43}"
        case .telepresenceAlertLight: return "\u{fb44}"
        case .telepresenceAlertMutedBold: return "\u{fb45}"
        case .telepresenceAlertMutedLight: return "\u{fb46}"
        case .telepresenceAlertMutedRegular: return "\u{fb47}"
        case .telepresenceAlertRegular: return "\u{fb48}"
        case .telepresenceBold: return "\u{fb49}"
        case .telepresenceIxFiveThousandBold: return "\u{fb4a}"
        case .telepresenceIxFiveThousandLight: return "\u{fb4b}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb4c}"
        case .telepresenceLight: return "\u{fb4d}"
        case .telepresenceMutedBold: return "\u{fb4e}"
        case .telepresenceMutedLight: return "\u{fb4f}"
        case .telepresenceMutedRegular: return "\u{fb50}"
        case .telepresencePrivateBold: return "\u{fb51}"
        case .telepresencePrivateLight: return "\u{fb52}"
        case .telepresencePrivateRegular: return "\u{fb53}"
        case .telepresenceRegular: return "\u{fb54}"
        case .temperatureBold: return "\u{fb55}"
        case .temperatureLight: return "\u{fb56}"
        case .temperatureRegular: return "\u{fb57}"
        case .testTubeBold: return "\u{fb58}"
        case .testTubeFilled: return "\u{fb59}"
        case .testTubeLight: return "\u{fb5a}"
        case .testTubeRegular: return "\u{fb5b}"
        case .textAlignCenterBold: return "\u{fb5c}"
        case .textAlignCenterFilled: return "\u{fb5d}"
        case .textAlignCenterLight: return "\u{fb5e}"
        case .textAlignCenterRegular: return "\u{fb5f}"
        case .textAlignLeftBold: return "\u{fb60}"
        case .textAlignLeftFilled: return "\u{fb61}"
        case .textAlignLeftLight: return "\u{fb62}"
        case .textAlignLeftRegular: return "\u{fb63}"
        case .textAlignRightBold: return "\u{fb64}"
        case .textAlignRightFilled: return "\u{fb65}"
        case .textAlignRightLight: return "\u{fb66}"
        case .textAlignRightRegular: return "\u{fb67}"
        case .textBold: return "\u{fb68}"
        case .textBoxCursorLight: return "\u{fb69}"
        case .textCodeBlockBold: return "\u{fb6a}"
        case .textCodeBlockLight: return "\u{fb6b}"
        case .textCodeBlockRegular: return "\u{fb6c}"
        case .textHighlightBold: return "\u{fb6d}"
        case .textHighlightFilled: return "\u{fb6e}"
        case .textHighlightLight: return "\u{fb6f}"
        case .textHighlightRegular: return "\u{fb70}"
        case .textLight: return "\u{fb71}"
        case .textRegular: return "\u{fb72}"
        case .threeColumnBold: return "\u{fb73}"
        case .threeColumnLight: return "\u{fb74}"
        case .threeColumnRegular: return "\u{fb75}"
        case .threeDObjectBold: return "\u{fb76}"
        case .threeDObjectLight: return "\u{fb77}"
        case .threeDObjectRegular: return "\u{fb78}"
        case .timeExclusionBold: return "\u{fb79}"
        case .timeExclusionLight: return "\u{fb7a}"
        case .timeExclusionRegular: return "\u{fb7b}"
        case .tooFastBold: return "\u{fb7c}"
        case .tooFastLight: return "\u{fb7d}"
        case .tooFastRegular: return "\u{fb7e}"
        case .tooSlowBold: return "\u{fb7f}"
        case .tooSlowLight: return "\u{fb80}"
        case .tooSlowRegular: return "\u{fb81}"
        case .toolsBold: return "\u{fb82}"
        case .toolsFilled: return "\u{fb83}"
        case .toolsLight: return "\u{fb84}"
        case .toolsRegular: return "\u{fb85}"
        case .touchTenBold: return "\u{fb86}"
        case .touchTenLight: return "\u{fb87}"
        case .touchTenRegular: return "\u{fb88}"
        case .transcriptBold: return "\u{fb89}"
        case .transcriptFilled: return "\u{fb8a}"
        case .transcriptLight: return "\u{fb8b}"
        case .transcriptRegular: return "\u{fb8c}"
        case .translateBold: return "\u{fb8d}"
        case .translateLight: return "\u{fb8e}"
        case .translateRegular: return "\u{fb8f}"
        case .translateUndoBold: return "\u{fb90}"
        case .translateUndoLight: return "\u{fb91}"
        case .translateUndoRegular: return "\u{fb92}"
        case .trendingBold: return "\u{fb93}"
        case .trendingDownBold: return "\u{fb94}"
        case .trendingDownFilled: return "\u{fb95}"
        case .trendingDownLight: return "\u{fb96}"
        case .trendingDownRegular: return "\u{fb97}"
        case .trendingFilled: return "\u{fb98}"
        case .trendingLight: return "\u{fb99}"
        case .trendingRegular: return "\u{fb9a}"
        case .trimBold: return "\u{fb9b}"
        case .trimLight: return "\u{fb9c}"
        case .trimRegular: return "\u{fb9d}"
        case .twoColumnBold: return "\u{fb9e}"
        case .twoColumnLight: return "\u{fb9f}"
        case .twoColumnRegular: return "\u{fba0}"
        case .twoWayVoiceStreamBold: return "\u{fba1}"
        case .twoWayVoiceStreamFilled: return "\u{fba2}"
        case .twoWayVoiceStreamLight: return "\u{fba3}"
        case .twoWayVoiceStreamRegular: return "\u{fba4}"
        case .ucmCloudBold: return "\u{fba5}"
        case .ucmCloudLight: return "\u{fba6}"
        case .ucmCloudRegular: return "\u{fba7}"
        case .unblockBold: return "\u{fba8}"
        case .unblockFilled: return "\u{fba9}"
        case .unblockLight: return "\u{fbaa}"
        case .unblockRegular: return "\u{fbab}"
        case .underlineBold: return "\u{fbac}"
        case .underlineFilled: return "\u{fbad}"
        case .underlineLight: return "\u{fbae}"
        case .underlineRegular: return "\u{fbaf}"
        case .undoBold: return "\u{fbb0}"
        case .undoLight: return "\u{fbb1}"
        case .undoRegular: return "\u{fbb2}"
        case .unlinkBold: return "\u{fbb3}"
        case .unlinkLight: return "\u{fbb4}"
        case .unlinkRegular: return "\u{fbb5}"
        case .unreadBold: return "\u{fbb6}"
        case .unreadFilled: return "\u{fbb7}"
        case .unreadLight: return "\u{fbb8}"
        case .unreadRegular: return "\u{fbb9}"
        case .unsecureUnlockedBold: return "\u{fbba}"
        case .unsecureUnlockedFilled: return "\u{fbbb}"
        case .unsecureUnlockedLight: return "\u{fbbc}"
        case .unsecureUnlockedRegular: return "\u{fbbd}"
        case .unsortedBold: return "\u{fbbe}"
        case .unsortedLight: return "\u{fbbf}"
        case .unsortedRegular: return "\u{fbc0}"
        case .updateFileShareBold: return "\u{fbc1}"
        case .updateFileShareLight: return "\u{fbc2}"
        case .updateFileShareRegular: return "\u{fbc3}"
        case .uploadBold: return "\u{fbc4}"
        case .uploadImageBold: return "\u{fbc5}"
        case .uploadImageLight: return "\u{fbc6}"
        case .uploadImageRegular: return "\u{fbc7}"
        case .uploadLight: return "\u{fbc8}"
        case .uploadRegular: return "\u{fbc9}"
        case .urgentVoicemailBold: return "\u{fbca}"
        case .urgentVoicemailFilled: return "\u{fbcb}"
        case .usbBold: return "\u{fbcc}"
        case .usbHeadsetBold: return "\u{fbcd}"
        case .usbHeadsetLight: return "\u{fbce}"
        case .usbHeadsetMutedBold: return "\u{fbcf}"
        case .usbHeadsetMutedLight: return "\u{fbd0}"
        case .usbHeadsetMutedRegular: return "\u{fbd1}"
        case .usbHeadsetRegular: return "\u{fbd2}"
        case .usbLight: return "\u{fbd3}"
        case .usbRegular: return "\u{fbd4}"
        case .userBold: return "\u{fbd5}"
        case .userDeactivateBold: return "\u{fbd6}"
        case .userDeactivateLight: return "\u{fbd7}"
        case .userDeactivateRegular: return "\u{fbd8}"
        case .userLight: return "\u{fbd9}"
        case .userRegular: return "\u{fbda}"
        case .videoBlurBold: return "\u{fbdb}"
        case .videoBlurFilled: return "\u{fbdc}"
        case .videoBlurLight: return "\u{fbdd}"
        case .videoBlurRegular: return "\u{fbde}"
        case .videoBold: return "\u{fbdf}"
        case .videoEffectBold: return "\u{fbe0}"
        case .videoEffectFilled: return "\u{fbe1}"
        case .videoEffectLight: return "\u{fbe2}"
        case .videoEffectRegular: return "\u{fbe3}"
        case .videoFilled: return "\u{fbe4}"
        case .videoLayoutBold: return "\u{fbe5}"
        case .videoLayoutCustomBold: return "\u{fbe6}"
        case .videoLayoutCustomFilled: return "\u{fbe7}"
        case .videoLayoutCustomLight: return "\u{fbe8}"
        case .videoLayoutCustomRegular: return "\u{fbe9}"
        case .videoLayoutEqualBold: return "\u{fbea}"
        case .videoLayoutEqualDualBold: return "\u{fbeb}"
        case .videoLayoutEqualDualLight: return "\u{fbec}"
        case .videoLayoutEqualDualRegular: return "\u{fbed}"
        case .videoLayoutEqualFilled: return "\u{fbee}"
        case .videoLayoutEqualLight: return "\u{fbef}"
        case .videoLayoutEqualRegular: return "\u{fbf0}"
        case .videoLayoutFilled: return "\u{fbf1}"
        case .videoLayoutLight: return "\u{fbf2}"
        case .videoLayoutOverlayBold: return "\u{fbf3}"
        case .videoLayoutOverlayFilled: return "\u{fbf4}"
        case .videoLayoutOverlayLight: return "\u{fbf5}"
        case .videoLayoutOverlayRegular: return "\u{fbf6}"
        case .videoLayoutPresentationBold: return "\u{fbf7}"
        case .videoLayoutPresentationFilled: return "\u{fbf8}"
        case .videoLayoutPresentationLight: return "\u{fbf9}"
        case .videoLayoutPresentationRegular: return "\u{fbfa}"
        case .videoLayoutPresenterDominantBold: return "\u{fbfb}"
        case .videoLayoutPresenterDominantLight: return "\u{fbfc}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbfd}"
        case .videoLayoutProminentBold: return "\u{fbfe}"
        case .videoLayoutProminentFilled: return "\u{fbff}"
        case .videoLayoutProminentLight: return "\u{fc00}"
        case .videoLayoutProminentRegular: return "\u{fc01}"
        case .videoLayoutRegular: return "\u{fc02}"
        case .videoLayoutShareDominantBold: return "\u{fc03}"
        case .videoLayoutShareDominantLight: return "\u{fc04}"
        case .videoLayoutShareDominantRegular: return "\u{fc05}"
        case .videoLayoutSingleBold: return "\u{fc06}"
        case .videoLayoutSingleFilled: return "\u{fc07}"
        case .videoLayoutSingleLight: return "\u{fc08}"
        case .videoLayoutSingleRegular: return "\u{fc09}"
        case .videoLayoutSpeakerBold: return "\u{fc0a}"
        case .videoLayoutSpeakerFilled: return "\u{fc0b}"
        case .videoLayoutSpeakerLight: return "\u{fc0c}"
        case .videoLayoutSpeakerRegular: return "\u{fc0d}"
        case .videoLayoutStackBold: return "\u{fc0e}"
        case .videoLayoutStackFilled: return "\u{fc0f}"
        case .videoLayoutStackLight: return "\u{fc10}"
        case .videoLayoutStackRegular: return "\u{fc11}"
        case .videoLayoutVideoDominantBold: return "\u{fc12}"
        case .videoLayoutVideoDominantFilled: return "\u{fc13}"
        case .videoLayoutVideoDominantLight: return "\u{fc14}"
        case .videoLayoutVideoDominantRegular: return "\u{fc15}"
        case .videoLight: return "\u{fc16}"
        case .videoPlusBold: return "\u{fc17}"
        case .videoPlusFilled: return "\u{fc18}"
        case .videoPlusLight: return "\u{fc19}"
        case .videoPlusRegular: return "\u{fc1a}"
        case .videoRegular: return "\u{fc1b}"
        case .videoSpeakerTrackBold: return "\u{fc1c}"
        case .videoSpeakerTrackFilled: return "\u{fc1d}"
        case .videoSpeakerTrackLight: return "\u{fc1e}"
        case .videoSpeakerTrackRegular: return "\u{fc1f}"
        case .viewAllBold: return "\u{fc20}"
        case .viewAllLight: return "\u{fc21}"
        case .viewAllRegular: return "\u{fc22}"
        case .viewListBold: return "\u{fc23}"
        case .viewListFilled: return "\u{fc24}"
        case .viewListLight: return "\u{fc25}"
        case .viewListRegular: return "\u{fc26}"
        case .viewStackedBold: return "\u{fc27}"
        case .viewStackedFilled: return "\u{fc28}"
        case .viewStackedLight: return "\u{fc29}"
        case .viewStackedRegular: return "\u{fc2a}"
        case .viewThumbnailBold: return "\u{fc2b}"
        case .viewThumbnailFilled: return "\u{fc2c}"
        case .viewThumbnailLight: return "\u{fc2d}"
        case .viewThumbnailRegular: return "\u{fc2e}"
        case .visionproBold: return "\u{fc2f}"
        case .visionproFilled: return "\u{fc30}"
        case .visionproLight: return "\u{fc31}"
        case .visionproMoveCallInBold: return "\u{fc32}"
        case .visionproMoveCallInFilled: return "\u{fc33}"
        case .visionproMoveCallInLight: return "\u{fc34}"
        case .visionproMoveCallInOutBold: return "\u{fc35}"
        case .visionproMoveCallInOutFilled: return "\u{fc36}"
        case .visionproMoveCallInOutLight: return "\u{fc37}"
        case .visionproMoveCallInOutRegular: return "\u{fc38}"
        case .visionproMoveCallInRegular: return "\u{fc39}"
        case .visionproMoveCallOutBold: return "\u{fc3a}"
        case .visionproMoveCallOutFilled: return "\u{fc3b}"
        case .visionproMoveCallOutLight: return "\u{fc3c}"
        case .visionproMoveCallOutRegular: return "\u{fc3d}"
        case .visionproRegular: return "\u{fc3e}"
        case .voicemailBold: return "\u{fc3f}"
        case .voicemailFilled: return "\u{fc40}"
        case .voicemailLight: return "\u{fc41}"
        case .voicemailRegular: return "\u{fc42}"
        case .vpnBold: return "\u{fc43}"
        case .vpnFilled: return "\u{fc44}"
        case .vpnLight: return "\u{fc45}"
        case .vpnRegular: return "\u{fc46}"
        case .vscBold: return "\u{fc47}"
        case .vscLight: return "\u{fc48}"
        case .vscRegular: return "\u{fc49}"
        case .waffleMenuBold: return "\u{fc4a}"
        case .waffleMenuLight: return "\u{fc4b}"
        case .waffleMenuRegular: return "\u{fc4c}"
        case .waitingRoomBold: return "\u{fc4d}"
        case .waitingRoomLight: return "\u{fc4e}"
        case .waitingRoomRegular: return "\u{fc4f}"
        case .wallpaperBold: return "\u{fc50}"
        case .wallpaperLight: return "\u{fc51}"
        case .wallpaperRegular: return "\u{fc52}"
        case .warningBadgeFilled: return "\u{fc53}"
        case .warningBold: return "\u{fc54}"
        case .warningFilled: return "\u{fc55}"
        case .warningLight: return "\u{fc56}"
        case .warningRegular: return "\u{fc57}"
        case .webexBoardBold: return "\u{fc58}"
        case .webexBoardLight: return "\u{fc59}"
        case .webexBoardRegular: return "\u{fc5a}"
        case .webexCodecPlusBold: return "\u{fc5b}"
        case .webexCodecPlusLight: return "\u{fc5c}"
        case .webexCodecPlusRegular: return "\u{fc5d}"
        case .webexDeskCameraBold: return "\u{fc5e}"
        case .webexDeskCameraLight: return "\u{fc5f}"
        case .webexDeskCameraRegular: return "\u{fc60}"
        case .webexHelixBold: return "\u{fc61}"
        case .webexHelixLight: return "\u{fc62}"
        case .webexHelixRegular: return "\u{fc63}"
        case .webexMeetingsBold: return "\u{fc64}"
        case .webexMeetingsFilled: return "\u{fc65}"
        case .webexMeetingsLight: return "\u{fc66}"
        case .webexMeetingsRegular: return "\u{fc67}"
        case .webexQuadCameraBold: return "\u{fc68}"
        case .webexQuadCameraLight: return "\u{fc69}"
        case .webexQuadCameraRegular: return "\u{fc6a}"
        case .webexRoomKitBold: return "\u{fc6b}"
        case .webexRoomKitLight: return "\u{fc6c}"
        case .webexRoomKitPlusBold: return "\u{fc6d}"
        case .webexRoomKitPlusLight: return "\u{fc6e}"
        case .webexRoomKitPlusRegular: return "\u{fc6f}"
        case .webexRoomKitRegular: return "\u{fc70}"
        case .webexShareBold: return "\u{fc71}"
        case .webexShareLight: return "\u{fc72}"
        case .webexShareRegular: return "\u{fc73}"
        case .webexTeamsBold: return "\u{fc74}"
        case .webexTeamsFilled: return "\u{fc75}"
        case .webexTeamsLight: return "\u{fc76}"
        case .webexTeamsNewBold: return "\u{fc77}"
        case .webexTeamsNewFilled: return "\u{fc78}"
        case .webexTeamsNewLight: return "\u{fc79}"
        case .webexTeamsNewRegular: return "\u{fc7a}"
        case .webexTeamsRegular: return "\u{fc7b}"
        case .webexTeamsRemoveBold: return "\u{fc7c}"
        case .webexTeamsRemoveLight: return "\u{fc7d}"
        case .webexTeamsRemoveRegular: return "\u{fc7e}"
        case .webhookBold: return "\u{fc7f}"
        case .webhookLight: return "\u{fc80}"
        case .webhookRegular: return "\u{fc81}"
        case .webinarBold: return "\u{fc82}"
        case .webinarFilled: return "\u{fc83}"
        case .webinarLight: return "\u{fc84}"
        case .webinarRegular: return "\u{fc85}"
        case .weeklyRecurringScheduleBold: return "\u{fc86}"
        case .weeklyRecurringScheduleLight: return "\u{fc87}"
        case .weeklyRecurringScheduleRegular: return "\u{fc88}"
        case .whisperAnnouncementBold: return "\u{fc89}"
        case .whisperAnnouncementFilled: return "\u{fc8a}"
        case .whisperAnnouncementLight: return "\u{fc8b}"
        case .whisperAnnouncementRegular: return "\u{fc8c}"
        case .whisperCoachBold: return "\u{fc8d}"
        case .whisperCoachFilled: return "\u{fc8e}"
        case .whisperCoachLight: return "\u{fc8f}"
        case .whisperCoachRegular: return "\u{fc90}"
        case .whiteboardBold: return "\u{fc91}"
        case .whiteboardContentBold: return "\u{fc92}"
        case .whiteboardContentFilled: return "\u{fc93}"
        case .whiteboardContentLight: return "\u{fc94}"
        case .whiteboardContentRegular: return "\u{fc95}"
        case .whiteboardFilled: return "\u{fc96}"
        case .whiteboardLight: return "\u{fc97}"
        case .whiteboardRegular: return "\u{fc98}"
        case .widgetBold: return "\u{fc99}"
        case .widgetFilled: return "\u{fc9a}"
        case .widgetLight: return "\u{fc9b}"
        case .widgetRegular: return "\u{fc9c}"
        case .wifiBold: return "\u{fc9d}"
        case .wifiErrorBold: return "\u{fc9e}"
        case .wifiErrorLight: return "\u{fc9f}"
        case .wifiErrorRegular: return "\u{fca0}"
        case .wifiLight: return "\u{fca1}"
        case .wifiRegular: return "\u{fca2}"
        case .wifiSignalGoodBold: return "\u{fca3}"
        case .wifiSignalGoodLight: return "\u{fca4}"
        case .wifiSignalGoodRegular: return "\u{fca5}"
        case .wifiSignalPoorBold: return "\u{fca6}"
        case .wifiSignalPoorLight: return "\u{fca7}"
        case .wifiSignalPoorRegular: return "\u{fca8}"
        case .wifiSignalUnstableBold: return "\u{fca9}"
        case .wifiSignalUnstableLight: return "\u{fcaa}"
        case .wifiSignalUnstableRegular: return "\u{fcab}"
        case .windowCornerScrubBold: return "\u{fcac}"
        case .windowCornerScrubLight: return "\u{fcad}"
        case .windowCornerScrubRegular: return "\u{fcae}"
        case .windowRightCornerScrubBold: return "\u{fcaf}"
        case .windowRightCornerScrubLight: return "\u{fcb0}"
        case .windowRightCornerScrubRegular: return "\u{fcb1}"
        case .windowVerticalScrubBold: return "\u{fcb2}"
        case .windowVerticalScrubLight: return "\u{fcb3}"
        case .windowVerticalScrubRegular: return "\u{fcb4}"
        case .workflowDeploymentsBold: return "\u{fcb5}"
        case .workflowDeploymentsFilled: return "\u{fcb6}"
        case .workflowDeploymentsLight: return "\u{fcb7}"
        case .workflowDeploymentsRegular: return "\u{fcb8}"
        case .workphoneBold: return "\u{fcb9}"
        case .workphoneLight: return "\u{fcba}"
        case .workphoneRegular: return "\u{fcbb}"
        case .zoomInBold: return "\u{fcbc}"
        case .zoomInLight: return "\u{fcbd}"
        case .zoomInRegular: return "\u{fcbe}"
        case .zoomOutBold: return "\u{fcbf}"
        case .zoomOutLight: return "\u{fcc0}"
        case .zoomOutRegular: return "\u{fcc1}"
