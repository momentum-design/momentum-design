...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .dialpadFilled: return "\u{f44d}"
        case .dialpadLight: return "\u{f44e}"
        case .dialpadRegular: return "\u{f44f}"
        case .diamondBold: return "\u{f450}"
        case .diamondFilled: return "\u{f451}"
        case .diamondLight: return "\u{f452}"
        case .diamondRegular: return "\u{f453}"
        case .directionalPadBold: return "\u{f454}"
        case .directionalPadFilled: return "\u{f455}"
        case .directionalPadLight: return "\u{f456}"
        case .directionalPadRegular: return "\u{f457}"
        case .directoryBold: return "\u{f458}"
        case .directoryLight: return "\u{f459}"
        case .directoryRegular: return "\u{f45a}"
        case .disappearingPenBold: return "\u{f45b}"
        case .disappearingPenLight: return "\u{f45c}"
        case .disappearingPenRegular: return "\u{f45d}"
        case .discBold: return "\u{f45e}"
        case .discConnectedBold: return "\u{f45f}"
        case .discConnectedLight: return "\u{f460}"
        case .discConnectedRegular: return "\u{f461}"
        case .discLight: return "\u{f462}"
        case .discRegular: return "\u{f463}"
        case .disconnectBold: return "\u{f464}"
        case .disconnectFilled: return "\u{f465}"
        case .disconnectLight: return "\u{f466}"
        case .disconnectRegular: return "\u{f467}"
        case .dislikeBold: return "\u{f468}"
        case .dislikeFilled: return "\u{f469}"
        case .dislikeLight: return "\u{f46a}"
        case .dislikeRegular: return "\u{f46b}"
        case .displayBold: return "\u{f46c}"
        case .displayInputBold: return "\u{f46d}"
        case .displayInputLight: return "\u{f46e}"
        case .displayInputRegular: return "\u{f46f}"
        case .displayLight: return "\u{f470}"
        case .displayRegular: return "\u{f471}"
        case .displayWarningBold: return "\u{f472}"
        case .displayWarningLight: return "\u{f473}"
        case .displayWarningRegular: return "\u{f474}"
        case .distributeHorizontalBold: return "\u{f475}"
        case .distributeHorizontalFilled: return "\u{f476}"
        case .distributeHorizontalLight: return "\u{f477}"
        case .distributeHorizontalRegular: return "\u{f478}"
        case .distributeVerticallyBold: return "\u{f479}"
        case .distributeVerticallyFilled: return "\u{f47a}"
        case .distributeVerticallyLight: return "\u{f47b}"
        case .distributeVerticallyRegular: return "\u{f47c}"
        case .divideBold: return "\u{f47d}"
        case .divideFilled: return "\u{f47e}"
        case .divideLight: return "\u{f47f}"
        case .divideRegular: return "\u{f480}"
        case .dndPresenceBadgeFilled: return "\u{f481}"
        case .dndPresenceBold: return "\u{f482}"
        case .dndPresenceFilled: return "\u{f483}"
        case .dndPresenceLight: return "\u{f484}"
        case .dndPresenceRegular: return "\u{f485}"
        case .dockWindowBold: return "\u{f486}"
        case .dockWindowLight: return "\u{f487}"
        case .dockWindowRegular: return "\u{f488}"
        case .documentBold: return "\u{f489}"
        case .documentCameraBold: return "\u{f48a}"
        case .documentCameraDisconnectedBold: return "\u{f48b}"
        case .documentCameraDisconnectedLight: return "\u{f48c}"
        case .documentCameraDisconnectedRegular: return "\u{f48d}"
        case .documentCameraLight: return "\u{f48e}"
        case .documentCameraRegular: return "\u{f48f}"
        case .documentCreateBold: return "\u{f490}"
        case .documentCreateFilled: return "\u{f491}"
        case .documentCreateLight: return "\u{f492}"
        case .documentCreateRegular: return "\u{f493}"
        case .documentFilled: return "\u{f494}"
        case .documentLight: return "\u{f495}"
        case .documentMoveBold: return "\u{f496}"
        case .documentMoveFilled: return "\u{f497}"
        case .documentMoveLight: return "\u{f498}"
        case .documentMoveRegular: return "\u{f499}"
        case .documentRegular: return "\u{f49a}"
        case .documentShareBold: return "\u{f49b}"
        case .documentShareFilled: return "\u{f49c}"
        case .documentShareLight: return "\u{f49d}"
        case .documentShareRegular: return "\u{f49e}"
        case .doneAllBold: return "\u{f49f}"
        case .doneAllLight: return "\u{f4a0}"
        case .doneAllRegular: return "\u{f4a1}"
        case .donutChartBold: return "\u{f4a2}"
        case .donutChartFilled: return "\u{f4a3}"
        case .donutChartLight: return "\u{f4a4}"
        case .donutChartRegular: return "\u{f4a5}"
        case .downloadBold: return "\u{f4a6}"
        case .downloadFilled: return "\u{f4a7}"
        case .downloadLight: return "\u{f4a8}"
        case .downloadRegular: return "\u{f4a9}"
        case .draftBold: return "\u{f4aa}"
        case .draftFilled: return "\u{f4ab}"
        case .draftIndicatorBold: return "\u{f4ac}"
        case .draftIndicatorSmallFilled: return "\u{f4ad}"
        case .draftLight: return "\u{f4ae}"
        case .draftRegular: return "\u{f4af}"
        case .dragBold: return "\u{f4b0}"
        case .dragLight: return "\u{f4b1}"
        case .dragRegular: return "\u{f4b2}"
        case .draggerHorizontalBold: return "\u{f4b3}"
        case .draggerHorizontalLight: return "\u{f4b4}"
        case .draggerHorizontalRegular: return "\u{f4b5}"
        case .draggerVerticalBold: return "\u{f4b6}"
        case .draggerVerticalLight: return "\u{f4b7}"
        case .draggerVerticalRegular: return "\u{f4b8}"
        case .driveModeBold: return "\u{f4b9}"
        case .driveModeLight: return "\u{f4ba}"
        case .driveModeRegular: return "\u{f4bb}"
        case .dropdownBold: return "\u{f4bc}"
        case .dropdownLight: return "\u{f4bd}"
        case .dropdownRegular: return "\u{f4be}"
        case .dxEightyBold: return "\u{f4bf}"
        case .dxEightyFilled: return "\u{f4c0}"
        case .dxEightyLight: return "\u{f4c1}"
        case .dxEightyRegular: return "\u{f4c2}"
        case .dxSeventyBold: return "\u{f4c3}"
        case .dxSeventyLight: return "\u{f4c4}"
        case .dxSeventyRegular: return "\u{f4c5}"
        case .editBold: return "\u{f4c6}"
        case .editFilled: return "\u{f4c7}"
        case .editLight: return "\u{f4c8}"
        case .editRegular: return "\u{f4c9}"
        case .editablePartialBold: return "\u{f4ca}"
        case .editablePartialLight: return "\u{f4cb}"
        case .editablePartialRegular: return "\u{f4cc}"
        case .educationBold: return "\u{f4cd}"
        case .educationFilled: return "\u{f4ce}"
        case .educationLight: return "\u{f4cf}"
        case .educationRegular: return "\u{f4d0}"
        case .emailBold: return "\u{f4d1}"
        case .emailDeliveredBold: return "\u{f4d2}"
        case .emailDeliveredLight: return "\u{f4d3}"
        case .emailDeliveredRegular: return "\u{f4d4}"
        case .emailFailureBold: return "\u{f4d5}"
        case .emailFailureLight: return "\u{f4d6}"
        case .emailFailureRegular: return "\u{f4d7}"
        case .emailFilled: return "\u{f4d8}"
        case .emailInviteBold: return "\u{f4d9}"
        case .emailInviteLight: return "\u{f4da}"
        case .emailInviteRegular: return "\u{f4db}"
        case .emailLight: return "\u{f4dc}"
        case .emailOutgoingBold: return "\u{f4dd}"
        case .emailOutgoingFilled: return "\u{f4de}"
        case .emailOutgoingLight: return "\u{f4df}"
        case .emailOutgoingRegular: return "\u{f4e0}"
        case .emailReadBold: return "\u{f4e1}"
        case .emailReadFilled: return "\u{f4e2}"
        case .emailReadLight: return "\u{f4e3}"
        case .emailReadRegular: return "\u{f4e4}"
        case .emailRegular: return "\u{f4e5}"
        case .emergencyCallbackNumberBold: return "\u{f4e6}"
        case .emergencyCallbackNumberFilled: return "\u{f4e7}"
        case .emergencyCallbackNumberLight: return "\u{f4e8}"
        case .emergencyCallbackNumberRegular: return "\u{f4e9}"
        case .emojiExcitedBold: return "\u{f4ea}"
        case .emojiExcitedFilled: return "\u{f4eb}"
        case .emojiExcitedLight: return "\u{f4ec}"
        case .emojiExcitedRegular: return "\u{f4ed}"
        case .emojiHappyBold: return "\u{f4ee}"
        case .emojiHappyFilled: return "\u{f4ef}"
        case .emojiHappyLight: return "\u{f4f0}"
        case .emojiHappyRegular: return "\u{f4f1}"
        case .emojiPassiveBold: return "\u{f4f2}"
        case .emojiPassiveFilled: return "\u{f4f3}"
        case .emojiPassiveLight: return "\u{f4f4}"
        case .emojiPassiveRegular: return "\u{f4f5}"
        case .emojiSadBold: return "\u{f4f6}"
        case .emojiSadFilled: return "\u{f4f7}"
        case .emojiSadLight: return "\u{f4f8}"
        case .emojiSadRegular: return "\u{f4f9}"
        case .emojiUnhappyBold: return "\u{f4fa}"
        case .emojiUnhappyFilled: return "\u{f4fb}"
        case .emojiUnhappyLight: return "\u{f4fc}"
        case .emojiUnhappyRegular: return "\u{f4fd}"
        case .encryptionCircleFilled: return "\u{f4fe}"
        case .encryptionFilled: return "\u{f4ff}"
        case .endRemoteDesktopControlBold: return "\u{f500}"
        case .endRemoteDesktopControlLight: return "\u{f501}"
        case .endRemoteDesktopControlRegular: return "\u{f502}"
        case .endToEndEncryptionCircleFilled: return "\u{f503}"
        case .endToEndEncryptionFilled: return "\u{f504}"
        case .endpointBlockedBold: return "\u{f505}"
        case .endpointBlockedLight: return "\u{f506}"
        case .endpointBlockedRegular: return "\u{f507}"
        case .endpointBold: return "\u{f508}"
        case .endpointGTwoBold: return "\u{f509}"
        case .endpointGTwoLight: return "\u{f50a}"
        case .endpointGTwoRegular: return "\u{f50b}"
        case .endpointGTwoSeventyBold: return "\u{f50c}"
        case .endpointGTwoSeventyDualBold: return "\u{f50d}"
        case .endpointGTwoSeventyDualLight: return "\u{f50e}"
        case .endpointGTwoSeventyDualRegular: return "\u{f50f}"
        case .endpointGTwoSeventyLight: return "\u{f510}"
        case .endpointGTwoSeventyRegular: return "\u{f511}"
        case .endpointGTwoStandBold: return "\u{f512}"
        case .endpointGTwoStandLight: return "\u{f513}"
        case .endpointGTwoStandRegular: return "\u{f514}"
        case .endpointLight: return "\u{f515}"
        case .endpointMxEightHundredBold: return "\u{f516}"
        case .endpointMxEightHundredDualBold: return "\u{f517}"
        case .endpointMxEightHundredDualLight: return "\u{f518}"
        case .endpointMxEightHundredDualRegular: return "\u{f519}"
        case .endpointMxEightHundredLight: return "\u{f51a}"
        case .endpointMxEightHundredRegular: return "\u{f51b}"
        case .endpointRegular: return "\u{f51c}"
        case .endpointStandBold: return "\u{f51d}"
        case .endpointStandFilled: return "\u{f51e}"
        case .endpointStandLight: return "\u{f51f}"
        case .endpointStandRegular: return "\u{f520}"
        case .endpointWarningBold: return "\u{f521}"
        case .endpointWarningLight: return "\u{f522}"
        case .endpointWarningRegular: return "\u{f523}"
        case .enterBold: return "\u{f524}"
        case .enterLight: return "\u{f525}"
        case .enterRegular: return "\u{f526}"
        case .enterRoomBold: return "\u{f527}"
        case .enterRoomFilled: return "\u{f528}"
        case .enterRoomLight: return "\u{f529}"
        case .enterRoomRegular: return "\u{f52a}"
        case .eraserBold: return "\u{f52b}"
        case .eraserFilled: return "\u{f52c}"
        case .eraserLight: return "\u{f52d}"
        case .eraserRegular: return "\u{f52e}"
        case .errorLegacyBadgeFilled: return "\u{f52f}"
        case .errorLegacyBold: return "\u{f530}"
        case .errorLegacyFilled: return "\u{f531}"
        case .errorLegacyLight: return "\u{f532}"
        case .errorLegacyRegular: return "\u{f533}"
        case .ethernetBold: return "\u{f534}"
        case .ethernetFilled: return "\u{f535}"
        case .ethernetLight: return "\u{f536}"
        case .ethernetRegular: return "\u{f537}"
        case .exchangeBold: return "\u{f538}"
        case .exchangeLight: return "\u{f539}"
        case .exchangeRegular: return "\u{f53a}"
        case .exclamationBold: return "\u{f53b}"
        case .exclamationLight: return "\u{f53c}"
        case .exclamationRegular: return "\u{f53d}"
        case .excludeBold: return "\u{f53e}"
        case .excludeLight: return "\u{f53f}"
        case .excludeRegular: return "\u{f540}"
        case .existingTargetGroupBold: return "\u{f541}"
        case .existingTargetGroupLight: return "\u{f542}"
        case .existingTargetGroupRegular: return "\u{f543}"
        case .exitRoomBold: return "\u{f544}"
        case .exitRoomLight: return "\u{f545}"
        case .exitRoomRegular: return "\u{f546}"
        case .exploreBold: return "\u{f547}"
        case .exploreLight: return "\u{f548}"
        case .exploreRegular: return "\u{f549}"
        case .exportBold: return "\u{f54a}"
        case .exportLight: return "\u{f54b}"
        case .exportRegular: return "\u{f54c}"
        case .extensionMobilityBold: return "\u{f54d}"
        case .extensionMobilityLight: return "\u{f54e}"
        case .extensionMobilityRegular: return "\u{f54f}"
        case .externalMessageBold: return "\u{f550}"
        case .externalMessageLight: return "\u{f551}"
        case .externalMessageRegular: return "\u{f552}"
        case .externalUserBold: return "\u{f553}"
        case .externalUserLight: return "\u{f554}"
        case .externalUserRegular: return "\u{f555}"
        case .familyFontBold: return "\u{f556}"
        case .familyFontLight: return "\u{f557}"
        case .familyFontRegular: return "\u{f558}"
        case .fastForwardBold: return "\u{f559}"
        case .fastForwardLight: return "\u{f55a}"
        case .fastForwardRegular: return "\u{f55b}"
        case .favoriteBold: return "\u{f55c}"
        case .favoriteFilled: return "\u{f55d}"
        case .favoriteLight: return "\u{f55e}"
        case .favoriteRegular: return "\u{f55f}"
        case .favoritesBold: return "\u{f560}"
        case .favoritesFilled: return "\u{f561}"
        case .favoritesLight: return "\u{f562}"
        case .favoritesRegular: return "\u{f563}"
        case .fbwBold: return "\u{f564}"
        case .fbwFilled: return "\u{f565}"
        case .fbwLight: return "\u{f566}"
        case .fbwRegular: return "\u{f567}"
        case .ffwBold: return "\u{f568}"
        case .ffwFilled: return "\u{f569}"
        case .ffwLight: return "\u{f56a}"
        case .ffwRegular: return "\u{f56b}"
        case .fileAnalysisBold: return "\u{f56c}"
        case .fileAnalysisFilled: return "\u{f56d}"
        case .fileAnalysisLight: return "\u{f56e}"
        case .fileAnalysisRegular: return "\u{f56f}"
        case .fileAnnotationBold: return "\u{f570}"
        case .fileAnnotationFilled: return "\u{f571}"
        case .fileAnnotationLight: return "\u{f572}"
        case .fileAnnotationRegular: return "\u{f573}"
        case .fileAudioBold: return "\u{f574}"
        case .fileAudioFilled: return "\u{f575}"
        case .fileAudioLight: return "\u{f576}"
        case .fileAudioRegular: return "\u{f577}"
        case .fileBugBold: return "\u{f578}"
        case .fileBugFilled: return "\u{f579}"
        case .fileBugLight: return "\u{f57a}"
        case .fileBugRegular: return "\u{f57b}"
        case .fileCodeBold: return "\u{f57c}"
        case .fileCodeFilled: return "\u{f57d}"
        case .fileCodeLight: return "\u{f57e}"
        case .fileCodeRegular: return "\u{f57f}"
        case .fileDashboardBold: return "\u{f580}"
        case .fileDashboardFilled: return "\u{f581}"
        case .fileDashboardLight: return "\u{f582}"
        case .fileDashboardRegular: return "\u{f583}"
        case .fileExcelBold: return "\u{f584}"
        case .fileExcelFilled: return "\u{f585}"
        case .fileExcelLight: return "\u{f586}"
        case .fileExcelRegular: return "\u{f587}"
        case .fileGraphBold: return "\u{f588}"
        case .fileGraphFilled: return "\u{f589}"
        case .fileGraphLight: return "\u{f58a}"
        case .fileGraphRegular: return "\u{f58b}"
        case .fileImageBold: return "\u{f58c}"
        case .fileImageFilled: return "\u{f58d}"
        case .fileImageLight: return "\u{f58e}"
        case .fileImageNoneBold: return "\u{f58f}"
        case .fileImageNoneLight: return "\u{f590}"
        case .fileImageNoneRegular: return "\u{f591}"
        case .fileImageRegular: return "\u{f592}"
        case .fileJsBold: return "\u{f593}"
        case .fileJsFilled: return "\u{f594}"
        case .fileJsLight: return "\u{f595}"
        case .fileJsRegular: return "\u{f596}"
        case .fileKeynoteBold: return "\u{f597}"
        case .fileKeynoteFilled: return "\u{f598}"
        case .fileKeynoteLight: return "\u{f599}"
        case .fileKeynoteRegular: return "\u{f59a}"
        case .fileLockedBold: return "\u{f59b}"
        case .fileLockedFilled: return "\u{f59c}"
        case .fileLockedLight: return "\u{f59d}"
        case .fileLockedRegular: return "\u{f59e}"
        case .fileMissingBold: return "\u{f59f}"
        case .fileMissingFilled: return "\u{f5a0}"
        case .fileMissingLight: return "\u{f5a1}"
        case .fileMissingRegular: return "\u{f5a2}"
        case .fileMusicBold: return "\u{f5a3}"
        case .fileMusicFilled: return "\u{f5a4}"
        case .fileMusicLight: return "\u{f5a5}"
        case .fileMusicRegular: return "\u{f5a6}"
        case .fileOnenoteBold: return "\u{f5a7}"
        case .fileOnenoteFilled: return "\u{f5a8}"
        case .fileOnenoteLight: return "\u{f5a9}"
        case .fileOnenoteRegular: return "\u{f5aa}"
        case .filePdfBold: return "\u{f5ab}"
        case .filePdfFilled: return "\u{f5ac}"
        case .filePdfLight: return "\u{f5ad}"
        case .filePdfRegular: return "\u{f5ae}"
        case .filePowerpointBold: return "\u{f5af}"
        case .filePowerpointFilled: return "\u{f5b0}"
        case .filePowerpointLight: return "\u{f5b1}"
        case .filePowerpointRegular: return "\u{f5b2}"
        case .fileSpreadsheetBold: return "\u{f5b3}"
        case .fileSpreadsheetFilled: return "\u{f5b4}"
        case .fileSpreadsheetLight: return "\u{f5b5}"
        case .fileSpreadsheetRegular: return "\u{f5b6}"
        case .fileTextBold: return "\u{f5b7}"
        case .fileTextFilled: return "\u{f5b8}"
        case .fileTextLight: return "\u{f5b9}"
        case .fileTextRegular: return "\u{f5ba}"
        case .fileThreeDBold: return "\u{f5bb}"
        case .fileThreeDFilled: return "\u{f5bc}"
        case .fileThreeDLight: return "\u{f5bd}"
        case .fileThreeDRegular: return "\u{f5be}"
        case .fileVectorBold: return "\u{f5bf}"
        case .fileVectorFilled: return "\u{f5c0}"
        case .fileVectorLight: return "\u{f5c1}"
        case .fileVectorRegular: return "\u{f5c2}"
        case .fileVideoBold: return "\u{f5c3}"
        case .fileVideoFilled: return "\u{f5c4}"
        case .fileVideoLight: return "\u{f5c5}"
        case .fileVideoRegular: return "\u{f5c6}"
        case .fileWordBold: return "\u{f5c7}"
        case .fileWordFilled: return "\u{f5c8}"
        case .fileWordLight: return "\u{f5c9}"
        case .fileWordRegular: return "\u{f5ca}"
        case .fileXmlBold: return "\u{f5cb}"
        case .fileXmlFilled: return "\u{f5cc}"
        case .fileXmlLight: return "\u{f5cd}"
        case .fileXmlRegular: return "\u{f5ce}"
        case .fileZipBold: return "\u{f5cf}"
        case .fileZipFilled: return "\u{f5d0}"
        case .fileZipLight: return "\u{f5d1}"
        case .fileZipRegular: return "\u{f5d2}"
        case .filesBold: return "\u{f5d3}"
        case .filesFilled: return "\u{f5d4}"
        case .filesLight: return "\u{f5d5}"
        case .filesRegular: return "\u{f5d6}"
        case .fillColourBold: return "\u{f5d7}"
        case .fillColourFilled: return "\u{f5d8}"
        case .fillColourLight: return "\u{f5d9}"
        case .fillColourRegular: return "\u{f5da}"
        case .filterBold: return "\u{f5db}"
        case .filterCircleBold: return "\u{f5dc}"
        case .filterCircleFilled: return "\u{f5dd}"
        case .filterCircleLight: return "\u{f5de}"
        case .filterCircleRegular: return "\u{f5df}"
        case .filterLight: return "\u{f5e0}"
        case .filterRegular: return "\u{f5e1}"
        case .fitToWidthBold: return "\u{f5e2}"
        case .fitToWidthLight: return "\u{f5e3}"
        case .fitToWidthRegular: return "\u{f5e4}"
        case .fitToWindowExpandBold: return "\u{f5e5}"
        case .fitToWindowExpandLight: return "\u{f5e6}"
        case .fitToWindowExpandRegular: return "\u{f5e7}"
        case .fitToWindowShrinkBold: return "\u{f5e8}"
        case .fitToWindowShrinkLight: return "\u{f5e9}"
        case .fitToWindowShrinkRegular: return "\u{f5ea}"
        case .flagBold: return "\u{f5eb}"
        case .flagCircleBold: return "\u{f5ec}"
        case .flagCircleFilled: return "\u{f5ed}"
        case .flagCircleLight: return "\u{f5ee}"
        case .flagCircleRegular: return "\u{f5ef}"
        case .flagFilled: return "\u{f5f0}"
        case .flagLight: return "\u{f5f1}"
        case .flagRegular: return "\u{f5f2}"
        case .folderBold: return "\u{f5f3}"
        case .folderEditBold: return "\u{f5f4}"
        case .folderEditLight: return "\u{f5f5}"
        case .folderEditRegular: return "\u{f5f6}"
        case .folderFilled: return "\u{f5f7}"
        case .folderLight: return "\u{f5f8}"
        case .folderLockBold: return "\u{f5f9}"
        case .folderLockLight: return "\u{f5fa}"
        case .folderLockRegular: return "\u{f5fb}"
        case .folderRegular: return "\u{f5fc}"
        case .folderViewBold: return "\u{f5fd}"
        case .folderViewLight: return "\u{f5fe}"
        case .folderViewRegular: return "\u{f5ff}"
        case .followUpBold: return "\u{f600}"
        case .followUpLight: return "\u{f601}"
        case .followUpRegular: return "\u{f602}"
        case .foodBold: return "\u{f603}"
        case .foodFilled: return "\u{f604}"
        case .foodLight: return "\u{f605}"
        case .foodRegular: return "\u{f606}"
        case .forecastBold: return "\u{f607}"
        case .forecastFilled: return "\u{f608}"
        case .forecastLight: return "\u{f609}"
        case .forecastRegular: return "\u{f60a}"
        case .formatBold: return "\u{f60b}"
        case .formatDefaultAppBold: return "\u{f60c}"
        case .formatDefaultAppFilled: return "\u{f60d}"
        case .formatDefaultAppLight: return "\u{f60e}"
        case .formatDefaultAppRegular: return "\u{f60f}"
        case .formatLight: return "\u{f610}"
        case .formatPanelControlBarBold: return "\u{f611}"
        case .formatPanelControlBarLight: return "\u{f612}"
        case .formatPanelControlBarRegular: return "\u{f613}"
        case .formatPanelControlDownBold: return "\u{f614}"
        case .formatPanelControlDownLight: return "\u{f615}"
        case .formatPanelControlDownRegular: return "\u{f616}"
        case .formatPanelControlLeftBold: return "\u{f617}"
        case .formatPanelControlLeftLight: return "\u{f618}"
        case .formatPanelControlLeftRegular: return "\u{f619}"
        case .formatPanelControlRightBold: return "\u{f61a}"
        case .formatPanelControlRightLight: return "\u{f61b}"
        case .formatPanelControlRightRegular: return "\u{f61c}"
        case .formatPanelControlUpBold: return "\u{f61d}"
        case .formatPanelControlUpDownBold: return "\u{f61e}"
        case .formatPanelControlUpDownLight: return "\u{f61f}"
        case .formatPanelControlUpDownRegular: return "\u{f620}"
        case .formatPanelControlUpLight: return "\u{f621}"
        case .formatPanelControlUpRegular: return "\u{f622}"
        case .formatRegular: return "\u{f623}"
        case .formatViewMixedBold: return "\u{f624}"
        case .formatViewMixedLight: return "\u{f625}"
        case .formatViewMixedRegular: return "\u{f626}"
        case .formulaBold: return "\u{f627}"
        case .formulaFilled: return "\u{f628}"
        case .formulaLight: return "\u{f629}"
        case .formulaRegular: return "\u{f62a}"
        case .forwardMessageBold: return "\u{f62b}"
        case .forwardMessageFilled: return "\u{f62c}"
        case .forwardMessageLight: return "\u{f62d}"
        case .forwardMessageRegular: return "\u{f62e}"
        case .forwardTenSecBold: return "\u{f62f}"
        case .forwardTenSecLight: return "\u{f630}"
        case .forwardTenSecRegular: return "\u{f631}"
        case .fourColumnBold: return "\u{f632}"
        case .fourColumnLight: return "\u{f633}"
        case .fourColumnRegular: return "\u{f634}"
        case .fourWayNavigationBold: return "\u{f635}"
        case .fourWayNavigationLight: return "\u{f636}"
        case .fourWayNavigationRegular: return "\u{f637}"
        case .frequencyCappingBold: return "\u{f638}"
        case .frequencyCappingLight: return "\u{f639}"
        case .frequencyCappingRegular: return "\u{f63a}"
        case .fulfillmentBold: return "\u{f63b}"
        case .fulfillmentLight: return "\u{f63c}"
        case .fulfillmentRegular: return "\u{f63d}"
        case .fullscreenBold: return "\u{f63e}"
        case .fullscreenExitBold: return "\u{f63f}"
        case .fullscreenExitLight: return "\u{f640}"
        case .fullscreenExitRegular: return "\u{f641}"
        case .fullscreenLight: return "\u{f642}"
        case .fullscreenRegular: return "\u{f643}"
        case .genericDeviceVideoBadgeFilled: return "\u{f644}"
        case .genericDeviceVideoBold: return "\u{f645}"
        case .genericDeviceVideoFilled: return "\u{f646}"
        case .genericDeviceVideoLight: return "\u{f647}"
        case .genericDeviceVideoRegular: return "\u{f648}"
        case .gifBold: return "\u{f649}"
        case .gifFilled: return "\u{f64a}"
        case .gifHorizontalBold: return "\u{f64b}"
        case .gifHorizontalFilled: return "\u{f64c}"
        case .gifHorizontalLight: return "\u{f64d}"
        case .gifHorizontalRegular: return "\u{f64e}"
        case .gifLight: return "\u{f64f}"
        case .gifRegular: return "\u{f650}"
        case .giftBold: return "\u{f651}"
        case .giftFilled: return "\u{f652}"
        case .giftLight: return "\u{f653}"
        case .giftRegular: return "\u{f654}"
        case .greenLeafBold: return "\u{f655}"
        case .greenLeafFilled: return "\u{f656}"
        case .greenLeafLight: return "\u{f657}"
        case .greenLeafRegular: return "\u{f658}"
        case .greenRoomBold: return "\u{f659}"
        case .greenRoomFilled: return "\u{f65a}"
        case .greenRoomLight: return "\u{f65b}"
        case .greenRoomRegular: return "\u{f65c}"
        case .guestIssuerBold: return "\u{f65d}"
        case .guestIssuerLight: return "\u{f65e}"
        case .guestIssuerRegular: return "\u{f65f}"
        case .guideBold: return "\u{f660}"
        case .guideLight: return "\u{f661}"
        case .guideRegular: return "\u{f662}"
        case .handPointerBold: return "\u{f663}"
        case .handPointerLight: return "\u{f664}"
        case .handPointerRegular: return "\u{f665}"
        case .handlerBold: return "\u{f666}"
        case .handlerHorizontalBold: return "\u{f667}"
        case .handlerHorizontalLight: return "\u{f668}"
        case .handlerHorizontalRegular: return "\u{f669}"
        case .handlerLight: return "\u{f66a}"
        case .handlerRegular: return "\u{f66b}"
        case .handsetAlertBold: return "\u{f66c}"
        case .handsetAlertFilled: return "\u{f66d}"
        case .handsetAlertLight: return "\u{f66e}"
        case .handsetAlertRegular: return "\u{f66f}"
        case .handsetBold: return "\u{f670}"
        case .handsetDownSlashBold: return "\u{f671}"
        case .handsetDownSlashFilled: return "\u{f672}"
        case .handsetDownSlashLight: return "\u{f673}"
        case .handsetDownSlashRegular: return "\u{f674}"
        case .handsetFilled: return "\u{f675}"
        case .handsetLight: return "\u{f676}"
        case .handsetMutedBold: return "\u{f677}"
        case .handsetMutedFilled: return "\u{f678}"
        case .handsetMutedLight: return "\u{f679}"
        case .handsetMutedRegular: return "\u{f67a}"
        case .handsetRegular: return "\u{f67b}"
        case .handsetsArrowLeftBold: return "\u{f67c}"
        case .handsetsArrowLeftLight: return "\u{f67d}"
        case .handsetsArrowLeftRegular: return "\u{f67e}"
        case .handshakeBold: return "\u{f67f}"
        case .handshakeLight: return "\u{f680}"
        case .handshakeRegular: return "\u{f681}"
        case .headingOneBold: return "\u{f682}"
        case .headingOneLight: return "\u{f683}"
        case .headingOneRegular: return "\u{f684}"
        case .headingThreeBold: return "\u{f685}"
        case .headingThreeLight: return "\u{f686}"
        case .headingThreeRegular: return "\u{f687}"
        case .headingTwoBold: return "\u{f688}"
        case .headingTwoLight: return "\u{f689}"
        case .headingTwoRegular: return "\u{f68a}"
        case .headphonesBold: return "\u{f68b}"
        case .headphonesFilled: return "\u{f68c}"
        case .headphonesLight: return "\u{f68d}"
        case .headphonesMutedBold: return "\u{f68e}"
        case .headphonesMutedFilled: return "\u{f68f}"
        case .headphonesMutedLight: return "\u{f690}"
        case .headphonesMutedRegular: return "\u{f691}"
        case .headphonesRegular: return "\u{f692}"
        case .headsetAlertBold: return "\u{f693}"
        case .headsetAlertLight: return "\u{f694}"
        case .headsetAlertRegular: return "\u{f695}"
        case .headsetArrowDownBold: return "\u{f696}"
        case .headsetArrowDownFilled: return "\u{f697}"
        case .headsetArrowDownLight: return "\u{f698}"
        case .headsetArrowDownRegular: return "\u{f699}"
        case .headsetBluetoothBold: return "\u{f69a}"
        case .headsetBluetoothLight: return "\u{f69b}"
        case .headsetBluetoothRegular: return "\u{f69c}"
        case .headsetBold: return "\u{f69d}"
        case .headsetFilled: return "\u{f69e}"
        case .headsetLight: return "\u{f69f}"
        case .headsetMutedBold: return "\u{f6a0}"
        case .headsetMutedLight: return "\u{f6a1}"
        case .headsetMutedRegular: return "\u{f6a2}"
        case .headsetPrivateBold: return "\u{f6a3}"
        case .headsetPrivateLight: return "\u{f6a4}"
        case .headsetPrivateRegular: return "\u{f6a5}"
        case .headsetRegular: return "\u{f6a6}"
        case .hearingBold: return "\u{f6a7}"
        case .hearingImpairedBold: return "\u{f6a8}"
        case .hearingImpairedLight: return "\u{f6a9}"
        case .hearingImpairedRegular: return "\u{f6aa}"
        case .hearingLight: return "\u{f6ab}"
        case .hearingRegular: return "\u{f6ac}"
        case .helpBold: return "\u{f6ad}"
        case .helpCircleBold: return "\u{f6ae}"
        case .helpCircleFilled: return "\u{f6af}"
        case .helpCircleLight: return "\u{f6b0}"
        case .helpCircleRegular: return "\u{f6b1}"
        case .helpLight: return "\u{f6b2}"
        case .helpRegular: return "\u{f6b3}"
        case .helpdeskBold: return "\u{f6b4}"
        case .helpdeskFilled: return "\u{f6b5}"
        case .helpdeskLight: return "\u{f6b6}"
        case .helpdeskRegular: return "\u{f6b7}"
        case .hideBold: return "\u{f6b8}"
        case .hideFilled: return "\u{f6b9}"
        case .hideLight: return "\u{f6ba}"
        case .hideRegular: return "\u{f6bb}"
        case .homeBold: return "\u{f6bc}"
        case .homeFilled: return "\u{f6bd}"
        case .homeLight: return "\u{f6be}"
        case .homeRegular: return "\u{f6bf}"
        case .horizontalLineBold: return "\u{f6c0}"
        case .horizontalLineLight: return "\u{f6c1}"
        case .horizontalLineRegular: return "\u{f6c2}"
        case .hotelingBold: return "\u{f6c3}"
        case .hotelingFilled: return "\u{f6c4}"
        case .hotelingLight: return "\u{f6c5}"
        case .hotelingRegular: return "\u{f6c6}"
        case .humidityBold: return "\u{f6c7}"
        case .humidityLight: return "\u{f6c8}"
        case .humidityRegular: return "\u{f6c9}"
        case .huntGroupBold: return "\u{f6ca}"
        case .huntGroupFilled: return "\u{f6cb}"
        case .huntGroupLight: return "\u{f6cc}"
        case .huntGroupRegular: return "\u{f6cd}"
        case .idleBold: return "\u{f6ce}"
        case .idleFilled: return "\u{f6cf}"
        case .idleLight: return "\u{f6d0}"
        case .idleRegular: return "\u{f6d1}"
        case .immediateBold: return "\u{f6d2}"
        case .immediateFilled: return "\u{f6d3}"
        case .immediateLight: return "\u{f6d4}"
        case .immediateRegular: return "\u{f6d5}"
        case .importBold: return "\u{f6d6}"
        case .importLight: return "\u{f6d7}"
        case .importRegular: return "\u{f6d8}"
        case .inCommonBold: return "\u{f6d9}"
        case .inCommonLight: return "\u{f6da}"
        case .inCommonRegular: return "\u{f6db}"
        case .inboxBold: return "\u{f6dc}"
        case .inboxFilled: return "\u{f6dd}"
        case .inboxLight: return "\u{f6de}"
        case .inboxRegular: return "\u{f6df}"
        case .includeBold: return "\u{f6e0}"
        case .includeLight: return "\u{f6e1}"
        case .includeRegular: return "\u{f6e2}"
        case .incognitoBold: return "\u{f6e3}"
        case .incognitoFilled: return "\u{f6e4}"
        case .incognitoLight: return "\u{f6e5}"
        case .incognitoRegular: return "\u{f6e6}"
        case .incomingCallLegacyBold: return "\u{f6e7}"
        case .incomingCallLegacyFilled: return "\u{f6e8}"
        case .incomingCallLegacyLight: return "\u{f6e9}"
        case .incomingCallLegacyRegular: return "\u{f6ea}"
        case .indentDecreaseBold: return "\u{f6eb}"
        case .indentDecreaseLight: return "\u{f6ec}"
        case .indentDecreaseRegular: return "\u{f6ed}"
        case .indentIncreaseBold: return "\u{f6ee}"
        case .indentIncreaseLight: return "\u{f6ef}"
        case .indentIncreaseRegular: return "\u{f6f0}"
        case .infoBadgeFilled: return "\u{f6f1}"
        case .infoCircleBold: return "\u{f6f2}"
        case .infoCircleFilled: return "\u{f6f3}"
        case .infoCircleLight: return "\u{f6f4}"
        case .infoCircleRegular: return "\u{f6f5}"
        case .infoCircleTwoBold: return "\u{f6f6}"
        case .infoCircleTwoFilled: return "\u{f6f7}"
        case .infoCircleTwoLight: return "\u{f6f8}"
        case .infoCircleTwoRegular: return "\u{f6f9}"
        case .inputBold: return "\u{f6fa}"
        case .inputDisconnectedBold: return "\u{f6fb}"
        case .inputDisconnectedLight: return "\u{f6fc}"
        case .inputDisconnectedRegular: return "\u{f6fd}"
        case .inputLight: return "\u{f6fe}"
        case .inputRegular: return "\u{f6ff}"
        case .instantScheduleBold: return "\u{f700}"
        case .instantScheduleFilled: return "\u{f701}"
        case .instantScheduleLight: return "\u{f702}"
        case .instantScheduleRegular: return "\u{f703}"
        case .integerBold: return "\u{f704}"
        case .integerFilled: return "\u{f705}"
        case .integerLight: return "\u{f706}"
        case .integerRegular: return "\u{f707}"
        case .integrationsBold: return "\u{f708}"
        case .integrationsFilled: return "\u{f709}"
        case .integrationsLight: return "\u{f70a}"
        case .integrationsRegular: return "\u{f70b}"
        case .intelligentRoutingBold: return "\u{f70c}"
        case .intelligentRoutingLight: return "\u{f70d}"
        case .intelligentRoutingRegular: return "\u{f70e}"
        case .interactionBold: return "\u{f70f}"
        case .interactionFilled: return "\u{f710}"
        case .interactionLight: return "\u{f711}"
        case .interactionRegular: return "\u{f712}"
        case .invitedUserBold: return "\u{f713}"
        case .invitedUserLight: return "\u{f714}"
        case .invitedUserRegular: return "\u{f715}"
        case .italicBold: return "\u{f716}"
        case .italicFilled: return "\u{f717}"
        case .italicLight: return "\u{f718}"
        case .italicRegular: return "\u{f719}"
        case .joinAudioBold: return "\u{f71a}"
        case .joinAudioFilled: return "\u{f71b}"
        case .joinAudioLight: return "\u{f71c}"
        case .joinAudioRegular: return "\u{f71d}"
        case .keepInTouchBold: return "\u{f71e}"
        case .keepInTouchFilled: return "\u{f71f}"
        case .keepInTouchLight: return "\u{f720}"
        case .keepInTouchRegular: return "\u{f721}"
        case .keyboardBold: return "\u{f722}"
        case .keyboardCloseBold: return "\u{f723}"
        case .keyboardCloseLight: return "\u{f724}"
        case .keyboardCloseRegular: return "\u{f725}"
        case .keyboardLight: return "\u{f726}"
        case .keyboardRegular: return "\u{f727}"
        case .languageBold: return "\u{f728}"
        case .languageFilled: return "\u{f729}"
        case .languageLight: return "\u{f72a}"
        case .languageRegular: return "\u{f72b}"
        case .laptopBold: return "\u{f72c}"
        case .laptopDisconnectedBold: return "\u{f72d}"
        case .laptopDisconnectedLight: return "\u{f72e}"
        case .laptopDisconnectedRegular: return "\u{f72f}"
        case .laptopFilled: return "\u{f730}"
        case .laptopLight: return "\u{f731}"
        case .laptopRegular: return "\u{f732}"
        case .laserPointerBold: return "\u{f733}"
        case .laserPointerCursorBlackLight: return "\u{f734}"
        case .laserPointerCursorBlueLight: return "\u{f735}"
        case .laserPointerCursorGreenLight: return "\u{f736}"
        case .laserPointerCursorPurpleLight: return "\u{f737}"
        case .laserPointerCursorRedLight: return "\u{f738}"
        case .laserPointerCursorWhiteLight: return "\u{f739}"
        case .laserPointerCursorYellowLight: return "\u{f73a}"
        case .laserPointerFilled: return "\u{f73b}"
        case .laserPointerLight: return "\u{f73c}"
        case .laserPointerRegular: return "\u{f73d}"
        case .launchBold: return "\u{f73e}"
        case .launchFilled: return "\u{f73f}"
        case .launchLight: return "\u{f740}"
        case .launchRegular: return "\u{f741}"
        case .layoutSideBySideVerticalBold: return "\u{f742}"
        case .layoutSideBySideVerticalFilled: return "\u{f743}"
        case .layoutSideBySideVerticalLight: return "\u{f744}"
        case .layoutSideBySideVerticalRegular: return "\u{f745}"
        case .leaveBreakoutSessionBold: return "\u{f746}"
        case .leaveBreakoutSessionLight: return "\u{f747}"
        case .leaveBreakoutSessionRegular: return "\u{f748}"
        case .leaveDeviceBold: return "\u{f749}"
        case .leaveDeviceLight: return "\u{f74a}"
        case .leaveDeviceRegular: return "\u{f74b}"
        case .likeBold: return "\u{f74c}"
        case .likeFilled: return "\u{f74d}"
        case .likeLight: return "\u{f74e}"
        case .likeRegular: return "\u{f74f}"
        case .linkBold: return "\u{f750}"
        case .linkLight: return "\u{f751}"
        case .linkRegular: return "\u{f752}"
        case .listBulletedBold: return "\u{f753}"
        case .listBulletedLight: return "\u{f754}"
        case .listBulletedRegular: return "\u{f755}"
        case .listMenuBold: return "\u{f756}"
        case .listMenuLight: return "\u{f757}"
        case .listMenuRegular: return "\u{f758}"
        case .listNumberedBold: return "\u{f759}"
        case .listNumberedLight: return "\u{f75a}"
        case .listNumberedRegular: return "\u{f75b}"
        case .liveBold: return "\u{f75c}"
        case .liveFilled: return "\u{f75d}"
        case .liveLight: return "\u{f75e}"
        case .liveRegular: return "\u{f75f}"
        case .locationBold: return "\u{f760}"
        case .locationFilled: return "\u{f761}"
        case .locationLight: return "\u{f762}"
        case .locationRegular: return "\u{f763}"
        case .longTextBoxBold: return "\u{f764}"
        case .longTextBoxLight: return "\u{f765}"
        case .longTextBoxRegular: return "\u{f766}"
        case .lowerHandBold: return "\u{f767}"
        case .lowerHandLight: return "\u{f768}"
        case .lowerHandRegular: return "\u{f769}"
        case .magicPenBold: return "\u{f76a}"
        case .magicPenFilled: return "\u{f76b}"
        case .magicPenLight: return "\u{f76c}"
        case .magicPenRegular: return "\u{f76d}"
        case .markAsUnreadBold: return "\u{f76e}"
        case .markAsUnreadFilled: return "\u{f76f}"
        case .markAsUnreadLight: return "\u{f770}"
        case .markAsUnreadRegular: return "\u{f771}"
        case .markdownBold: return "\u{f772}"
        case .markdownFilled: return "\u{f773}"
        case .markdownLight: return "\u{f774}"
        case .markdownRegular: return "\u{f775}"
        case .markerBold: return "\u{f776}"
        case .markerFilled: return "\u{f777}"
        case .markerLight: return "\u{f778}"
        case .markerRegular: return "\u{f779}"
        case .maximizeBold: return "\u{f77a}"
        case .maximizeLight: return "\u{f77b}"
        case .maximizeRegular: return "\u{f77c}"
        case .mcpBold: return "\u{f77d}"
        case .mcpFilled: return "\u{f77e}"
        case .mcpLight: return "\u{f77f}"
        case .mcpRegular: return "\u{f780}"
        case .mediaPlayerBold: return "\u{f781}"
        case .mediaPlayerLight: return "\u{f782}"
        case .mediaPlayerRegular: return "\u{f783}"
        case .mediaQualityGoodBold: return "\u{f784}"
        case .mediaQualityGoodFilled: return "\u{f785}"
        case .mediaQualityGoodLight: return "\u{f786}"
        case .mediaQualityGoodRegular: return "\u{f787}"
        case .mediaQualityPoorBold: return "\u{f788}"
        case .mediaQualityPoorColoredBold: return "\u{f789}"
        case .mediaQualityPoorFilled: return "\u{f78a}"
        case .mediaQualityPoorLight: return "\u{f78b}"
        case .mediaQualityPoorRegular: return "\u{f78c}"
        case .mediaQualityUnstableBold: return "\u{f78d}"
        case .mediaQualityUnstableColoredBold: return "\u{f78e}"
        case .mediaQualityUnstableFilled: return "\u{f78f}"
        case .mediaQualityUnstableLight: return "\u{f790}"
        case .mediaQualityUnstableRegular: return "\u{f791}"
        case .meetBold: return "\u{f792}"
        case .meetEndBold: return "\u{f793}"
        case .meetEndLight: return "\u{f794}"
        case .meetEndRegular: return "\u{f795}"
        case .meetFilled: return "\u{f796}"
        case .meetLight: return "\u{f797}"
        case .meetRegular: return "\u{f798}"
        case .meetingSummaryBold: return "\u{f799}"
        case .meetingSummaryFilled: return "\u{f79a}"
        case .meetingSummaryLight: return "\u{f79b}"
        case .meetingSummaryRegular: return "\u{f79c}"
        case .meetingsBold: return "\u{f79d}"
        case .meetingsFilled: return "\u{f79e}"
        case .meetingsFocusMonthBold: return "\u{f79f}"
        case .meetingsFocusMonthLight: return "\u{f7a0}"
        case .meetingsFocusMonthRegular: return "\u{f7a1}"
        case .meetingsFocusOneDayBold: return "\u{f7a2}"
        case .meetingsFocusOneDayLight: return "\u{f7a3}"
        case .meetingsFocusOneDayRegular: return "\u{f7a4}"
        case .meetingsFocusThreeDayBold: return "\u{f7a5}"
        case .meetingsFocusThreeDayLight: return "\u{f7a6}"
        case .meetingsFocusThreeDayRegular: return "\u{f7a7}"
        case .meetingsFocusUpcomingBold: return "\u{f7a8}"
        case .meetingsFocusUpcomingLight: return "\u{f7a9}"
        case .meetingsFocusUpcomingRegular: return "\u{f7aa}"
        case .meetingsLight: return "\u{f7ab}"
        case .meetingsPresenceBadgeFilled: return "\u{f7ac}"
        case .meetingsPresenceBold: return "\u{f7ad}"
        case .meetingsPresenceFilled: return "\u{f7ae}"
        case .meetingsPresenceLight: return "\u{f7af}"
        case .meetingsPresenceRegular: return "\u{f7b0}"
        case .meetingsRegular: return "\u{f7b1}"
        case .meetingsTeamBold: return "\u{f7b2}"
        case .meetingsTeamFilled: return "\u{f7b3}"
        case .meetingsTeamLight: return "\u{f7b4}"
        case .meetingsTeamNewBold: return "\u{f7b5}"
        case .meetingsTeamNewLight: return "\u{f7b6}"
        case .meetingsTeamNewRegular: return "\u{f7b7}"
        case .meetingsTeamRegular: return "\u{f7b8}"
        case .mentionBold: return "\u{f7b9}"
        case .mentionFilled: return "\u{f7ba}"
        case .mentionLight: return "\u{f7bb}"
        case .mentionRegular: return "\u{f7bc}"
        case .messageQueingBold: return "\u{f7bd}"
        case .messageQueingLight: return "\u{f7be}"
        case .messageQueingRegular: return "\u{f7bf}"
        case .microphoneBold: return "\u{f7c0}"
        case .microphoneFilled: return "\u{f7c1}"
        case .microphoneHardMutedBold: return "\u{f7c2}"
        case .microphoneHardMutedCircleFilled: return "\u{f7c3}"
        case .microphoneHardMutedLight: return "\u{f7c4}"
        case .microphoneHardMutedRegular: return "\u{f7c5}"
        case .microphoneLight: return "\u{f7c6}"
        case .microphoneMusicModeBold: return "\u{f7c7}"
        case .microphoneMusicModeLight: return "\u{f7c8}"
        case .microphoneMusicModeOnBold: return "\u{f7c9}"
        case .microphoneMusicModeOnLight: return "\u{f7ca}"
        case .microphoneMusicModeOnRegular: return "\u{f7cb}"
        case .microphoneMusicModeRegular: return "\u{f7cc}"
        case .microphoneMutedBold: return "\u{f7cd}"
        case .microphoneMutedCircleFilled: return "\u{f7ce}"
        case .microphoneMutedFilled: return "\u{f7cf}"
        case .microphoneMutedLight: return "\u{f7d0}"
        case .microphoneMutedRegular: return "\u{f7d1}"
        case .microphoneOnBold: return "\u{f7d2}"
        case .microphoneOnLight: return "\u{f7d3}"
        case .microphoneOnRegular: return "\u{f7d4}"
        case .microphoneOptAllBold: return "\u{f7d5}"
        case .microphoneOptAllLight: return "\u{f7d6}"
        case .microphoneOptAllMutedBold: return "\u{f7d7}"
        case .microphoneOptAllMutedLight: return "\u{f7d8}"
        case .microphoneOptAllMutedRegular: return "\u{f7d9}"
        case .microphoneOptAllOnBold: return "\u{f7da}"
        case .microphoneOptAllOnLight: return "\u{f7db}"
        case .microphoneOptAllOnRegular: return "\u{f7dc}"
        case .microphoneOptAllRegular: return "\u{f7dd}"
        case .microphoneOptMeBold: return "\u{f7de}"
        case .microphoneOptMeLight: return "\u{f7df}"
        case .microphoneOptMeMutedBold: return "\u{f7e0}"
        case .microphoneOptMeMutedLight: return "\u{f7e1}"
        case .microphoneOptMeMutedRegular: return "\u{f7e2}"
        case .microphoneOptMeOnBold: return "\u{f7e3}"
        case .microphoneOptMeOnLight: return "\u{f7e4}"
        case .microphoneOptMeOnRegular: return "\u{f7e5}"
        case .microphoneOptMeRegular: return "\u{f7e6}"
        case .microphoneRegular: return "\u{f7e7}"
        case .mindMapBold: return "\u{f7e8}"
        case .mindMapLight: return "\u{f7e9}"
        case .mindMapRegular: return "\u{f7ea}"
        case .minimizeBold: return "\u{f7eb}"
        case .minimizeLight: return "\u{f7ec}"
        case .minimizeRegular: return "\u{f7ed}"
        case .minusBold: return "\u{f7ee}"
        case .minusFilled: return "\u{f7ef}"
        case .minusLight: return "\u{f7f0}"
        case .minusRegular: return "\u{f7f1}"
        case .mirrorBold: return "\u{f7f2}"
        case .mirrorFilled: return "\u{f7f3}"
        case .mirrorLight: return "\u{f7f4}"
        case .mirrorRegular: return "\u{f7f5}"
        case .mmsFilled: return "\u{f7f6}"
        case .moderatorBold: return "\u{f7f7}"
        case .moderatorLight: return "\u{f7f8}"
        case .moderatorRegular: return "\u{f7f9}"
        case .monitoringBold: return "\u{f7fa}"
        case .monitoringLight: return "\u{f7fb}"
        case .monitoringRegular: return "\u{f7fc}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7fd}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7fe}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7ff}"
        case .moreAdrBold: return "\u{f800}"
        case .moreAdrLight: return "\u{f801}"
        case .moreAdrRegular: return "\u{f802}"
        case .moreBold: return "\u{f803}"
        case .moreCircleBold: return "\u{f804}"
        case .moreCircleFilled: return "\u{f805}"
        case .moreCircleLight: return "\u{f806}"
        case .moreCircleRegular: return "\u{f807}"
        case .moreLight: return "\u{f808}"
        case .moreRegular: return "\u{f809}"
        case .mouseCursorBold: return "\u{f80a}"
        case .mouseCursorLight: return "\u{f80b}"
        case .mouseCursorRegular: return "\u{f80c}"
        case .moveCallInAdrBold: return "\u{f80d}"
        case .moveCallInAdrLight: return "\u{f80e}"
        case .moveCallInAdrRegular: return "\u{f80f}"
        case .moveCallInIphBold: return "\u{f810}"
        case .moveCallInIphLight: return "\u{f811}"
        case .moveCallInIphRegular: return "\u{f812}"
        case .moveCallInLaptopBold: return "\u{f813}"
        case .moveCallInLaptopLight: return "\u{f814}"
        case .moveCallInLaptopRegular: return "\u{f815}"
        case .moveCallInOutAdrBold: return "\u{f816}"
        case .moveCallInOutAdrLight: return "\u{f817}"
        case .moveCallInOutAdrRegular: return "\u{f818}"
        case .moveCallInOutIphBold: return "\u{f819}"
        case .moveCallInOutIphLight: return "\u{f81a}"
        case .moveCallInOutIphRegular: return "\u{f81b}"
        case .moveCallInTabletBold: return "\u{f81c}"
        case .moveCallInTabletLight: return "\u{f81d}"
        case .moveCallInTabletRegular: return "\u{f81e}"
        case .moveCallOutAdrBold: return "\u{f81f}"
        case .moveCallOutAdrLight: return "\u{f820}"
        case .moveCallOutAdrRegular: return "\u{f821}"
        case .moveCallOutIphBold: return "\u{f822}"
        case .moveCallOutIphLight: return "\u{f823}"
        case .moveCallOutIphRegular: return "\u{f824}"
        case .moveCallOutLaptopBold: return "\u{f825}"
        case .moveCallOutLaptopLight: return "\u{f826}"
        case .moveCallOutLaptopRegular: return "\u{f827}"
        case .moveCallOutTabletBold: return "\u{f828}"
        case .moveCallOutTabletLight: return "\u{f829}"
        case .moveCallOutTabletRegular: return "\u{f82a}"
        case .moveToBottomBold: return "\u{f82b}"
        case .moveToBottomFilled: return "\u{f82c}"
        case .moveToBottomLight: return "\u{f82d}"
        case .moveToBottomRegular: return "\u{f82e}"
        case .moveToScreenBold: return "\u{f82f}"
        case .moveToScreenLight: return "\u{f830}"
        case .moveToScreenRegular: return "\u{f831}"
        case .moveToTopBold: return "\u{f832}"
        case .moveToTopFilled: return "\u{f833}"
        case .moveToTopLight: return "\u{f834}"
        case .moveToTopRegular: return "\u{f835}"
        case .multilineChartBold: return "\u{f836}"
        case .multilineChartFilled: return "\u{f837}"
        case .multilineChartLight: return "\u{f838}"
        case .multilineChartRegular: return "\u{f839}"
        case .multimediaBold: return "\u{f83a}"
        case .multimediaFilled: return "\u{f83b}"
        case .multimediaLight: return "\u{f83c}"
        case .multimediaRegular: return "\u{f83d}"
        case .multipledDevicesBold: return "\u{f83e}"
        case .multipledDevicesLight: return "\u{f83f}"
        case .multipledDevicesRegular: return "\u{f840}"
        case .musicModeCircleBold: return "\u{f841}"
        case .musicModeCircleFilled: return "\u{f842}"
        case .musicModeCircleLight: return "\u{f843}"
        case .musicModeCircleRegular: return "\u{f844}"
        case .musicNoteBold: return "\u{f845}"
        case .musicNoteFilled: return "\u{f846}"
        case .musicNoteLight: return "\u{f847}"
        case .musicNoteRegular: return "\u{f848}"
        case .muteOnEntryBold: return "\u{f849}"
        case .muteOnEntryFilled: return "\u{f84a}"
        case .muteOnEntryLight: return "\u{f84b}"
        case .muteOnEntryRegular: return "\u{f84c}"
        case .networkSwitchBold: return "\u{f84d}"
        case .networkSwitchFilled: return "\u{f84e}"
        case .networkSwitchLight: return "\u{f84f}"
        case .networkSwitchRegular: return "\u{f850}"
        case .newManagerBold: return "\u{f851}"
        case .newManagerFilled: return "\u{f852}"
        case .newManagerLight: return "\u{f853}"
        case .newManagerRegular: return "\u{f854}"
        case .newTitleBold: return "\u{f855}"
        case .newTitleLight: return "\u{f856}"
        case .newTitleRegular: return "\u{f857}"
        case .newVoicemailBold: return "\u{f858}"
        case .newVoicemailLight: return "\u{f859}"
        case .newVoicemailRegular: return "\u{f85a}"
        case .newWhiteboardBold: return "\u{f85b}"
        case .newWhiteboardLight: return "\u{f85c}"
        case .newWhiteboardRegular: return "\u{f85d}"
        case .nextBold: return "\u{f85e}"
        case .nextLight: return "\u{f85f}"
        case .nextRegular: return "\u{f860}"
        case .noDevicesBold: return "\u{f861}"
        case .noDevicesLight: return "\u{f862}"
        case .noDevicesRegular: return "\u{f863}"
        case .noiseDetectedCanceledFilled: return "\u{f864}"
        case .noiseDetectedFilled: return "\u{f865}"
        case .noiseNoneCanceledFilled: return "\u{f866}"
        case .noiseNoneFilled: return "\u{f867}"
        case .noiseRemovalBold: return "\u{f868}"
        case .noiseRemovalLight: return "\u{f869}"
        case .noiseRemovalRegular: return "\u{f86a}"
        case .noteBold: return "\u{f86b}"
        case .noteFilled: return "\u{f86c}"
        case .noteLight: return "\u{f86d}"
        case .notePptBold: return "\u{f86e}"
        case .notePptLight: return "\u{f86f}"
        case .notePptRegular: return "\u{f870}"
        case .noteRegular: return "\u{f871}"
        case .notesBold: return "\u{f872}"
        case .notesFilled: return "\u{f873}"
        case .notesLight: return "\u{f874}"
        case .notesRegular: return "\u{f875}"
        case .numberBold: return "\u{f876}"
        case .numberLight: return "\u{f877}"
        case .numberRegular: return "\u{f878}"
        case .oldRemoteBold: return "\u{f879}"
        case .oldRemoteLight: return "\u{f87a}"
        case .oldRemoteRegular: return "\u{f87b}"
        case .oldTouchBold: return "\u{f87c}"
        case .oldTouchLight: return "\u{f87d}"
        case .oldTouchRegular: return "\u{f87e}"
        case .oneColumnBold: return "\u{f87f}"
        case .oneColumnLight: return "\u{f880}"
        case .oneColumnRegular: return "\u{f881}"
        case .oneTimeBold: return "\u{f882}"
        case .oneTimeLight: return "\u{f883}"
        case .oneTimeRegular: return "\u{f884}"
        case .openInFolderBold: return "\u{f885}"
        case .openInFolderFilled: return "\u{f886}"
        case .openInFolderLight: return "\u{f887}"
        case .openInFolderRegular: return "\u{f888}"
        case .openPagesBold: return "\u{f889}"
        case .openPagesLight: return "\u{f88a}"
        case .openPagesRegular: return "\u{f88b}"
        case .otherNumberBold: return "\u{f88c}"
        case .otherNumberFilled: return "\u{f88d}"
        case .otherNumberLight: return "\u{f88e}"
        case .otherNumberRegular: return "\u{f88f}"
        case .otherNumberWarningBold: return "\u{f890}"
        case .otherNumberWarningLight: return "\u{f891}"
        case .otherNumberWarningRegular: return "\u{f892}"
        case .outgoingCallLegacyBold: return "\u{f893}"
        case .outgoingCallLegacyFilled: return "\u{f894}"
        case .outgoingCallLegacyLight: return "\u{f895}"
        case .outgoingCallLegacyRegular: return "\u{f896}"
        case .overflowLeftBold: return "\u{f897}"
        case .overflowLeftLight: return "\u{f898}"
        case .overflowLeftRegular: return "\u{f899}"
        case .overflowRightBold: return "\u{f89a}"
        case .overflowRightLight: return "\u{f89b}"
        case .overflowRightRegular: return "\u{f89c}"
        case .pairedCameraBold: return "\u{f89d}"
        case .pairedCameraLight: return "\u{f89e}"
        case .pairedCameraRegular: return "\u{f89f}"
        case .pairedDeviceBold: return "\u{f8a0}"
        case .pairedDeviceLight: return "\u{f8a1}"
        case .pairedDeviceRegular: return "\u{f8a2}"
        case .pairedHandsetBold: return "\u{f8a3}"
        case .pairedHandsetLight: return "\u{f8a4}"
        case .pairedHandsetRegular: return "\u{f8a5}"
        case .pairingBold: return "\u{f8a6}"
        case .pairingLight: return "\u{f8a7}"
        case .pairingRegular: return "\u{f8a8}"
        case .parenthesisBold: return "\u{f8a9}"
        case .parenthesisFilled: return "\u{f8aa}"
        case .parenthesisLight: return "\u{f8ab}"
        case .parenthesisRegular: return "\u{f8ac}"
        case .parkedBold: return "\u{f8ad}"
        case .parkedFilled: return "\u{f8ae}"
        case .parkedLight: return "\u{f8af}"
        case .parkedRegular: return "\u{f8b0}"
        case .parseBold: return "\u{f8b1}"
        case .parseLight: return "\u{f8b2}"
        case .parseRegular: return "\u{f8b3}"
        case .partialBold: return "\u{f8b4}"
        case .partialLight: return "\u{f8b5}"
        case .partialRegular: return "\u{f8b6}"
        case .participantAddBold: return "\u{f8b7}"
        case .participantAddLight: return "\u{f8b8}"
        case .participantAddRegular: return "\u{f8b9}"
        case .participantBlockedBold: return "\u{f8ba}"
        case .participantBlockedLight: return "\u{f8bb}"
        case .participantBlockedRegular: return "\u{f8bc}"
        case .participantBold: return "\u{f8bd}"
        case .participantFilled: return "\u{f8be}"
        case .participantLight: return "\u{f8bf}"
        case .participantListBold: return "\u{f8c0}"
        case .participantListFilled: return "\u{f8c1}"
        case .participantListLight: return "\u{f8c2}"
        case .participantListRegular: return "\u{f8c3}"
        case .participantRegular: return "\u{f8c4}"
        case .participantRemoveBold: return "\u{f8c5}"
        case .participantRemoveLight: return "\u{f8c6}"
        case .participantRemoveRegular: return "\u{f8c7}"
        case .participantSpeakerBold: return "\u{f8c8}"
        case .participantSpeakerFilled: return "\u{f8c9}"
        case .participantSpeakerLight: return "\u{f8ca}"
        case .participantSpeakerRegular: return "\u{f8cb}"
        case .participantUnknownBold: return "\u{f8cc}"
        case .participantUnknownLight: return "\u{f8cd}"
        case .participantUnknownRegular: return "\u{f8ce}"
        case .passMouseBold: return "\u{f8cf}"
        case .passMouseLight: return "\u{f8d0}"
        case .passMouseRegular: return "\u{f8d1}"
        case .pauseBadgeFilled: return "\u{f8d2}"
        case .pauseBold: return "\u{f8d3}"
        case .pauseFilled: return "\u{f8d4}"
        case .pauseInteractionBold: return "\u{f8d5}"
        case .pauseInteractionFilled: return "\u{f8d6}"
        case .pauseInteractionLight: return "\u{f8d7}"
        case .pauseInteractionRegular: return "\u{f8d8}"
        case .pauseLight: return "\u{f8d9}"
        case .pauseRegular: return "\u{f8da}"
        case .peopleAddBold: return "\u{f8db}"
        case .peopleAddFilled: return "\u{f8dc}"
        case .peopleAddLight: return "\u{f8dd}"
        case .peopleAddRegular: return "\u{f8de}"
        case .peopleBold: return "\u{f8df}"
        case .peopleCircleBold: return "\u{f8e0}"
        case .peopleCircleFilled: return "\u{f8e1}"
        case .peopleCircleLight: return "\u{f8e2}"
        case .peopleCircleRegular: return "\u{f8e3}"
        case .peopleFilled: return "\u{f8e4}"
        case .peopleInsightsBold: return "\u{f8e5}"
        case .peopleInsightsFilled: return "\u{f8e6}"
        case .peopleInsightsLight: return "\u{f8e7}"
        case .peopleInsightsRegular: return "\u{f8e8}"
        case .peopleLight: return "\u{f8e9}"
        case .peopleManageBold: return "\u{f8ea}"
        case .peopleManageFilled: return "\u{f8eb}"
        case .peopleManageLight: return "\u{f8ec}"
        case .peopleManageRegular: return "\u{f8ed}"
        case .peopleRegular: return "\u{f8ee}"
        case .phoneAlertBold: return "\u{f8ef}"
        case .phoneAlertLight: return "\u{f8f0}"
        case .phoneAlertRegular: return "\u{f8f1}"
        case .phoneBadgeFilled: return "\u{f8f2}"
        case .phoneBold: return "\u{f8f3}"
        case .phoneFilled: return "\u{f8f4}"
        case .phoneLight: return "\u{f8f5}"
        case .phoneMutedBold: return "\u{f8f6}"
        case .phoneMutedLight: return "\u{f8f7}"
        case .phoneMutedRegular: return "\u{f8f8}"
        case .phonePrivateBold: return "\u{f8f9}"
        case .phonePrivateLight: return "\u{f8fa}"
        case .phonePrivateRegular: return "\u{f8fb}"
        case .phoneRegular: return "\u{f8fc}"
        case .phoneReplyAllBold: return "\u{f8fd}"
        case .phoneReplyAllLight: return "\u{f8fe}"
        case .phoneReplyAllRegular: return "\u{f8ff}"
        case .phoneReplyBold: return "\u{f900}"
        case .phoneReplyLight: return "\u{f901}"
        case .phoneReplyRegular: return "\u{f902}"
        case .pickerBold: return "\u{f903}"
        case .pickerLight: return "\u{f904}"
        case .pickerRegular: return "\u{f905}"
        case .pieChartBold: return "\u{f906}"
        case .pieChartFilled: return "\u{f907}"
        case .pieChartLight: return "\u{f908}"
        case .pieChartRegular: return "\u{f909}"
        case .pinBold: return "\u{f90a}"
        case .pinFilled: return "\u{f90b}"
        case .pinLight: return "\u{f90c}"
        case .pinListActivityBold: return "\u{f90d}"
        case .pinListActivityLight: return "\u{f90e}"
        case .pinListActivityRegular: return "\u{f90f}"
        case .pinListBold: return "\u{f910}"
        case .pinListLight: return "\u{f911}"
        case .pinListRegular: return "\u{f912}"
        case .pinMutedBold: return "\u{f913}"
        case .pinMutedFilled: return "\u{f914}"
        case .pinMutedLight: return "\u{f915}"
        case .pinMutedRegular: return "\u{f916}"
        case .pinRegular: return "\u{f917}"
        case .pipBold: return "\u{f918}"
        case .pipEnterBold: return "\u{f919}"
        case .pipEnterLight: return "\u{f91a}"
        case .pipEnterRegular: return "\u{f91b}"
        case .pipExitBold: return "\u{f91c}"
        case .pipExitLight: return "\u{f91d}"
        case .pipExitRegular: return "\u{f91e}"
        case .pipFilled: return "\u{f91f}"
        case .pipLight: return "\u{f920}"
        case .pipRegular: return "\u{f921}"
        case .placeholderBold: return "\u{f922}"
        case .placeholderFilled: return "\u{f923}"
        case .placeholderLight: return "\u{f924}"
        case .placeholderRegular: return "\u{f925}"
        case .playBold: return "\u{f926}"
        case .playCircleBold: return "\u{f927}"
        case .playCircleFilled: return "\u{f928}"
        case .playCircleLight: return "\u{f929}"
        case .playCircleRegular: return "\u{f92a}"
        case .playFilled: return "\u{f92b}"
        case .playLight: return "\u{f92c}"
        case .playRegular: return "\u{f92d}"
        case .plugAcBold: return "\u{f92e}"
        case .plugAcLight: return "\u{f92f}"
        case .plugAcRegular: return "\u{f930}"
        case .plusBold: return "\u{f931}"
        case .plusCircleBold: return "\u{f932}"
        case .plusCircleFilled: return "\u{f933}"
        case .plusCircleLight: return "\u{f934}"
        case .plusCircleRegular: return "\u{f935}"
        case .plusLight: return "\u{f936}"
        case .plusRegular: return "\u{f937}"
        case .pmrBold: return "\u{f938}"
        case .pmrFilled: return "\u{f939}"
        case .pmrLight: return "\u{f93a}"
        case .pmrRegular: return "\u{f93b}"
        case .pollBold: return "\u{f93c}"
        case .pollFilled: return "\u{f93d}"
        case .pollLight: return "\u{f93e}"
        case .pollRegular: return "\u{f93f}"
        case .popInBold: return "\u{f940}"
        case .popInLight: return "\u{f941}"
        case .popInRegular: return "\u{f942}"
        case .popOutBold: return "\u{f943}"
        case .popOutLight: return "\u{f944}"
        case .popOutRegular: return "\u{f945}"
        case .popUpBold: return "\u{f946}"
        case .popUpLight: return "\u{f947}"
        case .popUpRegular: return "\u{f948}"
        case .portraitLandscapeBold: return "\u{f949}"
        case .portraitLandscapeLight: return "\u{f94a}"
        case .portraitLandscapeRegular: return "\u{f94b}"
        case .potentialFraudBold: return "\u{f94c}"
        case .potentialFraudFilled: return "\u{f94d}"
        case .potentialFraudLight: return "\u{f94e}"
        case .potentialFraudRegular: return "\u{f94f}"
        case .powerAcBold: return "\u{f950}"
        case .powerAcLight: return "\u{f951}"
        case .powerAcRegular: return "\u{f952}"
        case .powerBold: return "\u{f953}"
        case .powerLight: return "\u{f954}"
        case .powerRegular: return "\u{f955}"
        case .preHeaderBold: return "\u{f956}"
        case .preHeaderLight: return "\u{f957}"
        case .preHeaderRegular: return "\u{f958}"
        case .premiumBold: return "\u{f959}"
        case .premiumLight: return "\u{f95a}"
        case .premiumRegular: return "\u{f95b}"
        case .presentationBold: return "\u{f95c}"
        case .presentationLight: return "\u{f95d}"
        case .presentationRegular: return "\u{f95e}"
        case .preventDownloadBold: return "\u{f95f}"
        case .preventDownloadFilled: return "\u{f960}"
        case .preventDownloadLight: return "\u{f961}"
        case .preventDownloadRegular: return "\u{f962}"
        case .primaryParticipantBold: return "\u{f963}"
        case .primaryParticipantFilled: return "\u{f964}"
        case .primaryParticipantLight: return "\u{f965}"
        case .primaryParticipantRegular: return "\u{f966}"
        case .printBold: return "\u{f967}"
        case .printLight: return "\u{f968}"
        case .printRegular: return "\u{f969}"
        case .priorityBadgeFilled: return "\u{f96a}"
        case .priorityCircleBold: return "\u{f96b}"
        case .priorityCircleFilled: return "\u{f96c}"
        case .priorityCircleLight: return "\u{f96d}"
        case .priorityCircleRegular: return "\u{f96e}"
        case .priorityCircleTwoBold: return "\u{f96f}"
        case .priorityCircleTwoFilled: return "\u{f970}"
        case .priorityCircleTwoLight: return "\u{f971}"
        case .priorityCircleTwoRegular: return "\u{f972}"
        case .priorityWaveBold: return "\u{f973}"
        case .priorityWaveLight: return "\u{f974}"
        case .priorityWaveRegular: return "\u{f975}"
        case .privacyCircleBold: return "\u{f976}"
        case .privacyCircleFilled: return "\u{f977}"
        case .privacyCircleLight: return "\u{f978}"
        case .privacyCircleRegular: return "\u{f979}"
        case .privateBold: return "\u{f97a}"
        case .privateCircleBold: return "\u{f97b}"
        case .privateCircleFilled: return "\u{f97c}"
        case .privateCircleLight: return "\u{f97d}"
        case .privateCircleRegular: return "\u{f97e}"
        case .privateLight: return "\u{f97f}"
        case .privateMeetingBold: return "\u{f980}"
        case .privateMeetingLight: return "\u{f981}"
        case .privateMeetingRegular: return "\u{f982}"
        case .privateRegular: return "\u{f983}"
        case .productDemoBold: return "\u{f984}"
        case .productDemoLight: return "\u{f985}"
        case .productDemoRegular: return "\u{f986}"
        case .promptsAiBold: return "\u{f987}"
        case .promptsAiLight: return "\u{f988}"
        case .promptsAiRegular: return "\u{f989}"
        case .proximityBold: return "\u{f98a}"
        case .proximityLight: return "\u{f98b}"
        case .proximityMutedBold: return "\u{f98c}"
        case .proximityMutedLight: return "\u{f98d}"
        case .proximityMutedRegular: return "\u{f98e}"
        case .proximityRegular: return "\u{f98f}"
        case .proximityVideoBold: return "\u{f990}"
        case .proximityVideoLight: return "\u{f991}"
        case .proximityVideoRegular: return "\u{f992}"
        case .ptoPresenceBold: return "\u{f993}"
        case .ptoPresenceFilled: return "\u{f994}"
        case .ptoPresenceLight: return "\u{f995}"
        case .ptoPresenceRegular: return "\u{f996}"
        case .pullCallBold: return "\u{f997}"
        case .pullCallFilled: return "\u{f998}"
        case .pullCallLight: return "\u{f999}"
        case .pullCallRegular: return "\u{f99a}"
        case .purchaseOrderBold: return "\u{f99b}"
        case .purchaseOrderFilled: return "\u{f99c}"
        case .purchaseOrderLight: return "\u{f99d}"
        case .purchaseOrderRegular: return "\u{f99e}"
        case .qABold: return "\u{f99f}"
        case .qAFilled: return "\u{f9a0}"
        case .qALight: return "\u{f9a1}"
        case .qARegular: return "\u{f9a2}"
        case .qrCodeBold: return "\u{f9a3}"
        case .qrCodeLight: return "\u{f9a4}"
        case .qrCodeRegular: return "\u{f9a5}"
        case .qrCodeScanBold: return "\u{f9a6}"
        case .qrCodeScanLight: return "\u{f9a7}"
        case .qrCodeScanRegular: return "\u{f9a8}"
        case .qualityBold: return "\u{f9a9}"
        case .qualityLight: return "\u{f9aa}"
        case .qualityRegular: return "\u{f9ab}"
        case .queueContactBold: return "\u{f9ac}"
        case .queueContactFilled: return "\u{f9ad}"
        case .queueContactLight: return "\u{f9ae}"
        case .queueContactRegular: return "\u{f9af}"
        case .queuedInteractionBold: return "\u{f9b0}"
        case .queuedInteractionFilled: return "\u{f9b1}"
        case .queuedInteractionLight: return "\u{f9b2}"
        case .queuedInteractionRegular: return "\u{f9b3}"
        case .quietBold: return "\u{f9b4}"
        case .quietHoursPresenceBold: return "\u{f9b5}"
        case .quietHoursPresenceFilled: return "\u{f9b6}"
        case .quietHoursPresenceLight: return "\u{f9b7}"
        case .quietHoursPresenceRegular: return "\u{f9b8}"
        case .quietLight: return "\u{f9b9}"
        case .quietRegular: return "\u{f9ba}"
        case .radioButtonGroupBold: return "\u{f9bb}"
        case .radioButtonGroupLight: return "\u{f9bc}"
        case .radioButtonGroupRegular: return "\u{f9bd}"
        case .raiseHandBold: return "\u{f9be}"
        case .raiseHandCircleFilled: return "\u{f9bf}"
        case .raiseHandFilled: return "\u{f9c0}"
        case .raiseHandLight: return "\u{f9c1}"
        case .raiseHandRegular: return "\u{f9c2}"
        case .ramBold: return "\u{f9c3}"
        case .ramLight: return "\u{f9c4}"
        case .ramRegular: return "\u{f9c5}"
        case .reactionsBold: return "\u{f9c6}"
        case .reactionsFilled: return "\u{f9c7}"
        case .reactionsLight: return "\u{f9c8}"
        case .reactionsRegular: return "\u{f9c9}"
        case .reactivateBold: return "\u{f9ca}"
        case .reactivateLight: return "\u{f9cb}"
        case .reactivateRegular: return "\u{f9cc}"
        case .receiveVoiceBold: return "\u{f9cd}"
        case .receiveVoiceFilled: return "\u{f9ce}"
        case .receiveVoiceLight: return "\u{f9cf}"
        case .receiveVoiceRegular: return "\u{f9d0}"
        case .recentsBold: return "\u{f9d1}"
        case .recentsFilled: return "\u{f9d2}"
        case .recentsLight: return "\u{f9d3}"
        case .recentsPresenceBadgeFilled: return "\u{f9d4}"
        case .recentsPresenceBold: return "\u{f9d5}"
        case .recentsPresenceFilled: return "\u{f9d6}"
        case .recentsPresenceLight: return "\u{f9d7}"
        case .recentsPresenceRegular: return "\u{f9d8}"
        case .recentsRegular: return "\u{f9d9}"
        case .recordActiveBadgeFilled: return "\u{f9da}"
        case .recordActiveBold: return "\u{f9db}"
        case .recordActiveFilled: return "\u{f9dc}"
        case .recordActiveLight: return "\u{f9dd}"
        case .recordActiveRegular: return "\u{f9de}"
        case .recordBold: return "\u{f9df}"
        case .recordFilled: return "\u{f9e0}"
        case .recordLight: return "\u{f9e1}"
        case .recordPausedBadgeFilled: return "\u{f9e2}"
        case .recordPausedBold: return "\u{f9e3}"
        case .recordPausedFilled: return "\u{f9e4}"
        case .recordPausedLight: return "\u{f9e5}"
        case .recordPausedRegular: return "\u{f9e6}"
        case .recordRegular: return "\u{f9e7}"
        case .recurringBold: return "\u{f9e8}"
        case .recurringLight: return "\u{f9e9}"
        case .recurringOffBold: return "\u{f9ea}"
        case .recurringOffLight: return "\u{f9eb}"
        case .recurringOffRegular: return "\u{f9ec}"
        case .recurringRegular: return "\u{f9ed}"
        case .redoBold: return "\u{f9ee}"
        case .redoLight: return "\u{f9ef}"
        case .redoRegular: return "\u{f9f0}"
        case .refreshBold: return "\u{f9f1}"
        case .refreshLight: return "\u{f9f2}"
        case .refreshRegular: return "\u{f9f3}"
        case .remoteDesktopControlBold: return "\u{f9f4}"
        case .remoteDesktopControlFilled: return "\u{f9f5}"
        case .remoteDesktopControlLight: return "\u{f9f6}"
        case .remoteDesktopControlRegular: return "\u{f9f7}"
        case .removeBold: return "\u{f9f8}"
        case .removeFilled: return "\u{f9f9}"
        case .removeLight: return "\u{f9fa}"
        case .removeRegular: return "\u{f9fb}"
        case .replyBold: return "\u{f9fc}"
        case .replyFilled: return "\u{f9fd}"
        case .replyLight: return "\u{f9fe}"
        case .replyListBold: return "\u{f9ff}"
        case .replyListFilled: return "\u{fa00}"
        case .replyListLight: return "\u{fa01}"
        case .replyListRegular: return "\u{fa02}"
        case .replyPrivatelyBold: return "\u{fa03}"
        case .replyPrivatelyLight: return "\u{fa04}"
        case .replyPrivatelyRegular: return "\u{fa05}"
        case .replyRegular: return "\u{fa06}"
        case .resetBold: return "\u{fa07}"
        case .resetLight: return "\u{fa08}"
        case .resetRegular: return "\u{fa09}"
        case .resizeCornerBold: return "\u{fa0a}"
        case .resizeCornerLight: return "\u{fa0b}"
        case .resizeCornerRegular: return "\u{fa0c}"
        case .responsiveMobileBold: return "\u{fa0d}"
        case .responsiveMobileLight: return "\u{fa0e}"
        case .responsiveMobileRegular: return "\u{fa0f}"
        case .restartBold: return "\u{fa10}"
        case .restartLight: return "\u{fa11}"
        case .restartRegular: return "\u{fa12}"
        case .resumeInteractionBold: return "\u{fa13}"
        case .resumeInteractionFilled: return "\u{fa14}"
        case .resumeInteractionLight: return "\u{fa15}"
        case .resumeInteractionRegular: return "\u{fa16}"
        case .retrieveCallBold: return "\u{fa17}"
        case .retrieveCallFilled: return "\u{fa18}"
        case .retrieveCallLight: return "\u{fa19}"
        case .retrieveCallRegular: return "\u{fa1a}"
        case .returnBold: return "\u{fa1b}"
        case .returnLight: return "\u{fa1c}"
        case .returnRegular: return "\u{fa1d}"
        case .rewindTenSecBold: return "\u{fa1e}"
        case .rewindTenSecLight: return "\u{fa1f}"
        case .rewindTenSecRegular: return "\u{fa20}"
        case .ringtoneBold: return "\u{fa21}"
        case .ringtoneLight: return "\u{fa22}"
        case .ringtoneRegular: return "\u{fa23}"
        case .roomCalendarBold: return "\u{fa24}"
        case .roomCalendarLight: return "\u{fa25}"
        case .roomCalendarRegular: return "\u{fa26}"
        case .roomLightsBold: return "\u{fa27}"
        case .roomLightsFilled: return "\u{fa28}"
        case .roomLightsLight: return "\u{fa29}"
        case .roomLightsRegular: return "\u{fa2a}"
        case .rotateContentBold: return "\u{fa2b}"
        case .rotateContentFilled: return "\u{fa2c}"
        case .rotateContentLight: return "\u{fa2d}"
        case .rotateContentRegular: return "\u{fa2e}"
        case .rssBold: return "\u{fa2f}"
        case .rssFilled: return "\u{fa30}"
        case .rssLight: return "\u{fa31}"
        case .rssRegular: return "\u{fa32}"
        case .ruleBasedBold: return "\u{fa33}"
        case .ruleBasedLight: return "\u{fa34}"
        case .ruleBasedRegular: return "\u{fa35}"
        case .rulerBold: return "\u{fa36}"
        case .rulerFilled: return "\u{fa37}"
        case .rulerLight: return "\u{fa38}"
        case .rulerRegular: return "\u{fa39}"
        case .runningApplicationBold: return "\u{fa3a}"
        case .runningApplicationFilled: return "\u{fa3b}"
        case .runningApplicationLight: return "\u{fa3c}"
        case .runningApplicationRegular: return "\u{fa3d}"
        case .saveBold: return "\u{fa3e}"
        case .saveLight: return "\u{fa3f}"
        case .saveRegular: return "\u{fa40}"
        case .saveTranscriptBold: return "\u{fa41}"
        case .saveTranscriptFilled: return "\u{fa42}"
        case .saveTranscriptLight: return "\u{fa43}"
        case .saveTranscriptRegular: return "\u{fa44}"
        case .scanBold: return "\u{fa45}"
        case .scanLight: return "\u{fa46}"
        case .scanRegular: return "\u{fa47}"
        case .scheduleAiBold: return "\u{fa48}"
        case .scheduleAiLight: return "\u{fa49}"
        case .scheduleAiRegular: return "\u{fa4a}"
        case .scheduleSendBold: return "\u{fa4b}"
        case .scheduleSendFilled: return "\u{fa4c}"
        case .scheduleSendLight: return "\u{fa4d}"
        case .scheduleSendRegular: return "\u{fa4e}"
        case .scheduleWinnerBold: return "\u{fa4f}"
        case .scheduleWinnerFilled: return "\u{fa50}"
        case .scheduleWinnerLight: return "\u{fa51}"
        case .scheduleWinnerRegular: return "\u{fa52}"
        case .schedulerAvailableBold: return "\u{fa53}"
        case .schedulerAvailableLight: return "\u{fa54}"
        case .schedulerAvailableRegular: return "\u{fa55}"
        case .schedulerNotWorkingHoursBold: return "\u{fa56}"
        case .schedulerNotWorkingHoursLight: return "\u{fa57}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa58}"
        case .schedulerUnavailableBold: return "\u{fa59}"
        case .schedulerUnavailableLight: return "\u{fa5a}"
        case .schedulerUnavailableRegular: return "\u{fa5b}"
        case .schedulerUnknownBold: return "\u{fa5c}"
        case .schedulerUnknownLight: return "\u{fa5d}"
        case .schedulerUnknownRegular: return "\u{fa5e}"
        case .screenshotBold: return "\u{fa5f}"
        case .screenshotDocBold: return "\u{fa60}"
        case .screenshotDocFilled: return "\u{fa61}"
        case .screenshotDocLight: return "\u{fa62}"
        case .screenshotDocRegular: return "\u{fa63}"
        case .screenshotLight: return "\u{fa64}"
        case .screenshotRegular: return "\u{fa65}"
        case .searchAiBold: return "\u{fa66}"
        case .searchAiLight: return "\u{fa67}"
        case .searchAiRegular: return "\u{fa68}"
        case .searchBold: return "\u{fa69}"
        case .searchFilled: return "\u{fa6a}"
        case .searchLight: return "\u{fa6b}"
        case .searchRegular: return "\u{fa6c}"
        case .secondaryArrowBold: return "\u{fa6d}"
        case .secondaryArrowLight: return "\u{fa6e}"
        case .secondaryArrowRegular: return "\u{fa6f}"
        case .secureCallLockBold: return "\u{fa70}"
        case .secureCallLockFilled: return "\u{fa71}"
        case .secureCallLockLight: return "\u{fa72}"
        case .secureCallLockRegular: return "\u{fa73}"
        case .secureCallShieldBold: return "\u{fa74}"
        case .secureCallShieldFilled: return "\u{fa75}"
        case .secureCallShieldLight: return "\u{fa76}"
        case .secureCallShieldRegular: return "\u{fa77}"
        case .secureCircleBold: return "\u{fa78}"
        case .secureCircleFilled: return "\u{fa79}"
        case .secureCircleLight: return "\u{fa7a}"
        case .secureCircleRegular: return "\u{fa7b}"
        case .secureLockBold: return "\u{fa7c}"
        case .secureLockFilled: return "\u{fa7d}"
        case .secureLockLight: return "\u{fa7e}"
        case .secureLockRegular: return "\u{fa7f}"
        case .segmentExcludeFilled: return "\u{fa80}"
        case .segmentFilterFilled: return "\u{fa81}"
        case .segmentIncludeFilled: return "\u{fa82}"
        case .selectAllBold: return "\u{fa83}"
        case .selectAllFilled: return "\u{fa84}"
        case .selectAllLight: return "\u{fa85}"
        case .selectAllRegular: return "\u{fa86}"
        case .selectionBold: return "\u{fa87}"
        case .selectionFilled: return "\u{fa88}"
        case .selectionLight: return "\u{fa89}"
        case .selectionRegular: return "\u{fa8a}"
        case .sendBold: return "\u{fa8b}"
        case .sendDigitsBold: return "\u{fa8c}"
        case .sendDigitsFilled: return "\u{fa8d}"
        case .sendDigitsLight: return "\u{fa8e}"
        case .sendDigitsRegular: return "\u{fa8f}"
        case .sendFilled: return "\u{fa90}"
        case .sendLight: return "\u{fa91}"
        case .sendRegular: return "\u{fa92}"
        case .sendVoiceBold: return "\u{fa93}"
        case .sendVoiceFilled: return "\u{fa94}"
        case .sendVoiceLight: return "\u{fa95}"
        case .sendVoiceRegular: return "\u{fa96}"
        case .serverBold: return "\u{fa97}"
        case .serverErrorBold: return "\u{fa98}"
        case .serverErrorLight: return "\u{fa99}"
        case .serverErrorRegular: return "\u{fa9a}"
        case .serverLight: return "\u{fa9b}"
        case .serverRegular: return "\u{fa9c}"
        case .servicesBold: return "\u{fa9d}"
        case .servicesLight: return "\u{fa9e}"
        case .servicesRegular: return "\u{fa9f}"
        case .setVariableBold: return "\u{faa0}"
        case .setVariableLight: return "\u{faa1}"
        case .setVariableRegular: return "\u{faa2}"
        case .settingsBold: return "\u{faa3}"
        case .settingsFilled: return "\u{faa4}"
        case .settingsLight: return "\u{faa5}"
        case .settingsRegular: return "\u{faa6}"
        case .setupAssistantBold: return "\u{faa7}"
        case .setupAssistantLight: return "\u{faa8}"
        case .setupAssistantRegular: return "\u{faa9}"
        case .sftpBold: return "\u{faaa}"
        case .sftpLight: return "\u{faab}"
        case .sftpRegular: return "\u{faac}"
        case .shapeCircleBold: return "\u{faad}"
        case .shapeCircleFilled: return "\u{faae}"
        case .shapeCircleLight: return "\u{faaf}"
        case .shapeCircleMdFilled: return "\u{fab0}"
        case .shapeCircleRegular: return "\u{fab1}"
        case .shapeCircleSmFilled: return "\u{fab2}"
        case .shapeDiagonalLineBold: return "\u{fab3}"
        case .shapeDiagonalLineLight: return "\u{fab4}"
        case .shapeDiagonalLineRegular: return "\u{fab5}"
        case .shapeDiamondBold: return "\u{fab6}"
        case .shapeDiamondFilled: return "\u{fab7}"
        case .shapeDiamondLight: return "\u{fab8}"
        case .shapeDiamondRegular: return "\u{fab9}"
        case .shapeOvalBold: return "\u{faba}"
        case .shapeOvalLight: return "\u{fabb}"
        case .shapeOvalRegular: return "\u{fabc}"
        case .shapeSquareBold: return "\u{fabd}"
        case .shapeSquareFilled: return "\u{fabe}"
        case .shapeSquareLight: return "\u{fabf}"
        case .shapeSquareRegular: return "\u{fac0}"
        case .shapeTriangleBold: return "\u{fac1}"
        case .shapeTriangleFilled: return "\u{fac2}"
        case .shapeTriangleLight: return "\u{fac3}"
        case .shapeTriangleRegular: return "\u{fac4}"
        case .shapesBold: return "\u{fac5}"
        case .shapesFilled: return "\u{fac6}"
        case .shapesLight: return "\u{fac7}"
        case .shapesRegular: return "\u{fac8}"
        case .shareCNativeAdrBold: return "\u{fac9}"
        case .shareCNativeAdrFilled: return "\u{faca}"
        case .shareCNativeAdrLight: return "\u{facb}"
        case .shareCNativeAdrRegular: return "\u{facc}"
        case .shareCNativeIphBold: return "\u{facd}"
        case .shareCNativeIphLight: return "\u{face}"
        case .shareCNativeIphRegular: return "\u{facf}"
        case .shareContentOnDeviceBold: return "\u{fad0}"
        case .shareContentOnDeviceLight: return "\u{fad1}"
        case .shareContentOnDeviceRegular: return "\u{fad2}"
        case .shareScreenAddBold: return "\u{fad3}"
        case .shareScreenAddLight: return "\u{fad4}"
        case .shareScreenAddRegular: return "\u{fad5}"
        case .shareScreenBadgeFilled: return "\u{fad6}"
        case .shareScreenBold: return "\u{fad7}"
        case .shareScreenFilled: return "\u{fad8}"
        case .shareScreenLight: return "\u{fad9}"
        case .shareScreenRegular: return "\u{fada}"
        case .shareSpaceBold: return "\u{fadb}"
        case .shareSpaceLight: return "\u{fadc}"
        case .shareSpaceRegular: return "\u{fadd}"
        case .shieldBold: return "\u{fade}"
        case .shieldLight: return "\u{fadf}"
        case .shieldRegular: return "\u{fae0}"
        case .shoppingCartBold: return "\u{fae1}"
        case .shoppingCartFilled: return "\u{fae2}"
        case .shoppingCartLight: return "\u{fae3}"
        case .shoppingCartRegular: return "\u{fae4}"
        case .shortTextBoxBold: return "\u{fae5}"
        case .shortTextBoxLight: return "\u{fae6}"
        case .shortTextBoxRegular: return "\u{fae7}"
        case .showBold: return "\u{fae8}"
        case .showFilled: return "\u{fae9}"
        case .showLight: return "\u{faea}"
        case .showRegular: return "\u{faeb}"
        case .sidePanelBold: return "\u{faec}"
        case .sidePanelFilled: return "\u{faed}"
        case .sidePanelLight: return "\u{faee}"
        case .sidePanelRegular: return "\u{faef}"
        case .signInBold: return "\u{faf0}"
        case .signInFilled: return "\u{faf1}"
        case .signInForcedBold: return "\u{faf2}"
        case .signInForcedLight: return "\u{faf3}"
        case .signInForcedRegular: return "\u{faf4}"
        case .signInLight: return "\u{faf5}"
        case .signInRegular: return "\u{faf6}"
        case .signLangIntBold: return "\u{faf7}"
        case .signLangIntLight: return "\u{faf8}"
        case .signLangIntRegular: return "\u{faf9}"
        case .signOutBold: return "\u{fafa}"
        case .signOutLight: return "\u{fafb}"
        case .signOutRegular: return "\u{fafc}"
        case .signalFourBold: return "\u{fafd}"
        case .signalFourLight: return "\u{fafe}"
        case .signalFourRegular: return "\u{faff}"
        case .signalOneBold: return "\u{fb00}"
        case .signalOneLight: return "\u{fb01}"
        case .signalOneRegular: return "\u{fb02}"
        case .signalThreeBold: return "\u{fb03}"
        case .signalThreeLight: return "\u{fb04}"
        case .signalThreeRegular: return "\u{fb05}"
        case .signalTwoBold: return "\u{fb06}"
        case .signalTwoLight: return "\u{fb07}"
        case .signalTwoRegular: return "\u{fb08}"
        case .signalZeroBold: return "\u{fb09}"
        case .signalZeroLight: return "\u{fb0a}"
        case .signalZeroRegular: return "\u{fb0b}"
        case .simplePromotionBold: return "\u{fb0c}"
        case .simplePromotionLight: return "\u{fb0d}"
        case .simplePromotionRegular: return "\u{fb0e}"
        case .singleNumberReachBold: return "\u{fb0f}"
        case .singleNumberReachLight: return "\u{fb10}"
        case .singleNumberReachRegular: return "\u{fb11}"
        case .sipRegistrationInProgressBold: return "\u{fb12}"
        case .sipRegistrationInProgressFilled: return "\u{fb13}"
        case .sipRegistrationInProgressLight: return "\u{fb14}"
        case .sipRegistrationInProgressRegular: return "\u{fb15}"
        case .skipBold: return "\u{fb16}"
        case .skipBwBold: return "\u{fb17}"
        case .skipBwFilled: return "\u{fb18}"
        case .skipBwLight: return "\u{fb19}"
        case .skipBwRegular: return "\u{fb1a}"
        case .skipFwBold: return "\u{fb1b}"
        case .skipFwFilled: return "\u{fb1c}"
        case .skipFwLight: return "\u{fb1d}"
        case .skipFwRegular: return "\u{fb1e}"
        case .skipLight: return "\u{fb1f}"
        case .skipRegular: return "\u{fb20}"
        case .smartAudioBold: return "\u{fb21}"
        case .smartAudioLight: return "\u{fb22}"
        case .smartAudioRegular: return "\u{fb23}"
        case .smartReplyBold: return "\u{fb24}"
        case .smartReplyLight: return "\u{fb25}"
        case .smartReplyRegular: return "\u{fb26}"
        case .smsFilled: return "\u{fb27}"
        case .smsInboundBold: return "\u{fb28}"
        case .smsInboundLight: return "\u{fb29}"
        case .smsInboundRegular: return "\u{fb2a}"
        case .smsMessageBold: return "\u{fb2b}"
        case .smsMessageFilled: return "\u{fb2c}"
        case .smsMessageLight: return "\u{fb2d}"
        case .smsMessageOutgoingBold: return "\u{fb2e}"
        case .smsMessageOutgoingFilled: return "\u{fb2f}"
        case .smsMessageOutgoingLight: return "\u{fb30}"
        case .smsMessageOutgoingRegular: return "\u{fb31}"
        case .smsMessageRegular: return "\u{fb32}"
        case .smsMessageStartBold: return "\u{fb33}"
        case .smsMessageStartFilled: return "\u{fb34}"
        case .smsMessageStartLight: return "\u{fb35}"
        case .smsMessageStartRegular: return "\u{fb36}"
        case .smsOutgoingFilled: return "\u{fb37}"
        case .smsUnreadBold: return "\u{fb38}"
        case .smsUnreadLight: return "\u{fb39}"
        case .smsUnreadRegular: return "\u{fb3a}"
        case .sortAscendingBold: return "\u{fb3b}"
        case .sortAscendingLight: return "\u{fb3c}"
        case .sortAscendingRegular: return "\u{fb3d}"
        case .sortDescendingBold: return "\u{fb3e}"
        case .sortDescendingLight: return "\u{fb3f}"
        case .sortDescendingRegular: return "\u{fb40}"
        case .soundDefaultBold: return "\u{fb41}"
        case .soundDefaultLight: return "\u{fb42}"
        case .soundDefaultRegular: return "\u{fb43}"
        case .sparkleBold: return "\u{fb44}"
        case .sparkleFilled: return "\u{fb45}"
        case .sparkleLight: return "\u{fb46}"
        case .sparkleRegular: return "\u{fb47}"
        case .speakerBold: return "\u{fb48}"
        case .speakerDisconnectedBold: return "\u{fb49}"
        case .speakerDisconnectedFilled: return "\u{fb4a}"
        case .speakerDisconnectedLight: return "\u{fb4b}"
        case .speakerDisconnectedRegular: return "\u{fb4c}"
        case .speakerFilled: return "\u{fb4d}"
        case .speakerLight: return "\u{fb4e}"
        case .speakerMutedBold: return "\u{fb4f}"
        case .speakerMutedFilled: return "\u{fb50}"
        case .speakerMutedLight: return "\u{fb51}"
        case .speakerMutedRegular: return "\u{fb52}"
        case .speakerOffBold: return "\u{fb53}"
        case .speakerOffFilled: return "\u{fb54}"
        case .speakerOffLight: return "\u{fb55}"
        case .speakerOffRegular: return "\u{fb56}"
        case .speakerOnBold: return "\u{fb57}"
        case .speakerOnLight: return "\u{fb58}"
        case .speakerOnRegular: return "\u{fb59}"
        case .speakerRegular: return "\u{fb5a}"
        case .speakerTurnDownBold: return "\u{fb5b}"
        case .speakerTurnDownFilled: return "\u{fb5c}"
        case .speakerTurnDownLight: return "\u{fb5d}"
        case .speakerTurnDownRegular: return "\u{fb5e}"
        case .speakerTurnUpBold: return "\u{fb5f}"
        case .speakerTurnUpFilled: return "\u{fb60}"
        case .speakerTurnUpLight: return "\u{fb61}"
        case .speakerTurnUpRegular: return "\u{fb62}"
        case .speedDialBold: return "\u{fb63}"
        case .speedDialFilled: return "\u{fb64}"
        case .speedDialLight: return "\u{fb65}"
        case .speedDialRegular: return "\u{fb66}"
        case .spellCheckerBold: return "\u{fb67}"
        case .spellCheckerLight: return "\u{fb68}"
        case .spellCheckerRegular: return "\u{fb69}"
        case .splitViewBold: return "\u{fb6a}"
        case .splitViewLight: return "\u{fb6b}"
        case .splitViewRegular: return "\u{fb6c}"
        case .stackedAreaChartBold: return "\u{fb6d}"
        case .stackedAreaChartFilled: return "\u{fb6e}"
        case .stackedAreaChartFullBold: return "\u{fb6f}"
        case .stackedAreaChartFullFilled: return "\u{fb70}"
        case .stackedAreaChartFullLight: return "\u{fb71}"
        case .stackedAreaChartFullRegular: return "\u{fb72}"
        case .stackedAreaChartLight: return "\u{fb73}"
        case .stackedAreaChartRegular: return "\u{fb74}"
        case .stackedBarChartBold: return "\u{fb75}"
        case .stackedBarChartFilled: return "\u{fb76}"
        case .stackedBarChartFullBold: return "\u{fb77}"
        case .stackedBarChartFullFilled: return "\u{fb78}"
        case .stackedBarChartFullLight: return "\u{fb79}"
        case .stackedBarChartFullRegular: return "\u{fb7a}"
        case .stackedBarChartLight: return "\u{fb7b}"
        case .stackedBarChartRegular: return "\u{fb7c}"
        case .startChatBold: return "\u{fb7d}"
        case .startChatLight: return "\u{fb7e}"
        case .startChatRegular: return "\u{fb7f}"
        case .stethoscopeBold: return "\u{fb80}"
        case .stethoscopeLight: return "\u{fb81}"
        case .stethoscopeRegular: return "\u{fb82}"
        case .stickersBold: return "\u{fb83}"
        case .stickersLight: return "\u{fb84}"
        case .stickersRegular: return "\u{fb85}"
        case .stickiesBold: return "\u{fb86}"
        case .stickiesLight: return "\u{fb87}"
        case .stickiesRegular: return "\u{fb88}"
        case .stopBold: return "\u{fb89}"
        case .stopCircleBold: return "\u{fb8a}"
        case .stopCircleFilled: return "\u{fb8b}"
        case .stopCircleLight: return "\u{fb8c}"
        case .stopCircleRegular: return "\u{fb8d}"
        case .stopContentShareBold: return "\u{fb8e}"
        case .stopContentShareLight: return "\u{fb8f}"
        case .stopContentShareRegular: return "\u{fb90}"
        case .stopFilled: return "\u{fb91}"
        case .stopLight: return "\u{fb92}"
        case .stopRegular: return "\u{fb93}"
        case .storedInfoBold: return "\u{fb94}"
        case .storedInfoFilled: return "\u{fb95}"
        case .storedInfoLight: return "\u{fb96}"
        case .storedInfoRegular: return "\u{fb97}"
        case .streamingBold: return "\u{fb98}"
        case .streamingLight: return "\u{fb99}"
        case .streamingRegular: return "\u{fb9a}"
        case .strikethroughBold: return "\u{fb9b}"
        case .strikethroughFilled: return "\u{fb9c}"
        case .strikethroughLight: return "\u{fb9d}"
        case .strikethroughRegular: return "\u{fb9e}"
        case .studioModeBold: return "\u{fb9f}"
        case .studioModeLight: return "\u{fba0}"
        case .studioModeRegular: return "\u{fba1}"
        case .subscriptBold: return "\u{fba2}"
        case .subscriptLight: return "\u{fba3}"
        case .subscriptRegular: return "\u{fba4}"
        case .summarizeAiBold: return "\u{fba5}"
        case .summarizeAiLight: return "\u{fba6}"
        case .summarizeAiRegular: return "\u{fba7}"
        case .superscriptBold: return "\u{fba8}"
        case .superscriptLight: return "\u{fba9}"
        case .superscriptRegular: return "\u{fbaa}"
        case .surveyBold: return "\u{fbab}"
        case .surveyFilled: return "\u{fbac}"
        case .surveyLight: return "\u{fbad}"
        case .surveyRegular: return "\u{fbae}"
        case .sxEightyCodecBold: return "\u{fbaf}"
        case .sxEightyCodecLight: return "\u{fbb0}"
        case .sxEightyCodecRegular: return "\u{fbb1}"
        case .sxTenBold: return "\u{fbb2}"
        case .sxTenLight: return "\u{fbb3}"
        case .sxTenRegular: return "\u{fbb4}"
        case .sxTwentyBold: return "\u{fbb5}"
        case .sxTwentyLight: return "\u{fbb6}"
        case .sxTwentyRegular: return "\u{fbb7}"
        case .tableBold: return "\u{fbb8}"
        case .tableExtenderBold: return "\u{fbb9}"
        case .tableExtenderFilled: return "\u{fbba}"
        case .tableExtenderLight: return "\u{fbbb}"
        case .tableExtenderRegular: return "\u{fbbc}"
        case .tableLight: return "\u{fbbd}"
        case .tableRegular: return "\u{fbbe}"
        case .tabletBold: return "\u{fbbf}"
        case .tabletLight: return "\u{fbc0}"
        case .tabletRegular: return "\u{fbc1}"
        case .tabsBold: return "\u{fbc2}"
        case .tabsLight: return "\u{fbc3}"
        case .tabsRegular: return "\u{fbc4}"
        case .tagBold: return "\u{fbc5}"
        case .tagLight: return "\u{fbc6}"
        case .tagRegular: return "\u{fbc7}"
        case .tapBold: return "\u{fbc8}"
        case .tapFilled: return "\u{fbc9}"
        case .tapLight: return "\u{fbca}"
        case .tapRegular: return "\u{fbcb}"
        case .telepresenceAlertBold: return "\u{fbcc}"
        case .telepresenceAlertLight: return "\u{fbcd}"
        case .telepresenceAlertMutedBold: return "\u{fbce}"
        case .telepresenceAlertMutedLight: return "\u{fbcf}"
        case .telepresenceAlertMutedRegular: return "\u{fbd0}"
        case .telepresenceAlertRegular: return "\u{fbd1}"
        case .telepresenceBold: return "\u{fbd2}"
        case .telepresenceIxFiveThousandBold: return "\u{fbd3}"
        case .telepresenceIxFiveThousandLight: return "\u{fbd4}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbd5}"
        case .telepresenceLight: return "\u{fbd6}"
        case .telepresenceMutedBold: return "\u{fbd7}"
        case .telepresenceMutedLight: return "\u{fbd8}"
        case .telepresenceMutedRegular: return "\u{fbd9}"
        case .telepresencePrivateBold: return "\u{fbda}"
        case .telepresencePrivateLight: return "\u{fbdb}"
        case .telepresencePrivateRegular: return "\u{fbdc}"
        case .telepresenceRegular: return "\u{fbdd}"
        case .temperatureBold: return "\u{fbde}"
        case .temperatureLight: return "\u{fbdf}"
        case .temperatureRegular: return "\u{fbe0}"
        case .testTubeBold: return "\u{fbe1}"
        case .testTubeFilled: return "\u{fbe2}"
        case .testTubeLight: return "\u{fbe3}"
        case .testTubeRegular: return "\u{fbe4}"
        case .textAlignCenterBold: return "\u{fbe5}"
        case .textAlignCenterFilled: return "\u{fbe6}"
        case .textAlignCenterLight: return "\u{fbe7}"
        case .textAlignCenterRegular: return "\u{fbe8}"
        case .textAlignLeftBold: return "\u{fbe9}"
        case .textAlignLeftFilled: return "\u{fbea}"
        case .textAlignLeftLight: return "\u{fbeb}"
        case .textAlignLeftRegular: return "\u{fbec}"
        case .textAlignRightBold: return "\u{fbed}"
        case .textAlignRightFilled: return "\u{fbee}"
        case .textAlignRightLight: return "\u{fbef}"
        case .textAlignRightRegular: return "\u{fbf0}"
        case .textBold: return "\u{fbf1}"
        case .textBoxCursorLight: return "\u{fbf2}"
        case .textCodeBlockBold: return "\u{fbf3}"
        case .textCodeBlockLight: return "\u{fbf4}"
        case .textCodeBlockRegular: return "\u{fbf5}"
        case .textHighlightBold: return "\u{fbf6}"
        case .textHighlightFilled: return "\u{fbf7}"
        case .textHighlightLight: return "\u{fbf8}"
        case .textHighlightRegular: return "\u{fbf9}"
        case .textLight: return "\u{fbfa}"
        case .textRegular: return "\u{fbfb}"
        case .threeColumnBold: return "\u{fbfc}"
        case .threeColumnLight: return "\u{fbfd}"
        case .threeColumnRegular: return "\u{fbfe}"
        case .threeDObjectBold: return "\u{fbff}"
        case .threeDObjectLight: return "\u{fc00}"
        case .threeDObjectRegular: return "\u{fc01}"
        case .timeExclusionBold: return "\u{fc02}"
        case .timeExclusionLight: return "\u{fc03}"
        case .timeExclusionRegular: return "\u{fc04}"
        case .timezoneBold: return "\u{fc05}"
        case .timezoneFilled: return "\u{fc06}"
        case .timezoneLight: return "\u{fc07}"
        case .timezoneRegular: return "\u{fc08}"
        case .tooFastBold: return "\u{fc09}"
        case .tooFastLight: return "\u{fc0a}"
        case .tooFastRegular: return "\u{fc0b}"
        case .tooSlowBold: return "\u{fc0c}"
        case .tooSlowLight: return "\u{fc0d}"
        case .tooSlowRegular: return "\u{fc0e}"
        case .toolsBold: return "\u{fc0f}"
        case .toolsFilled: return "\u{fc10}"
        case .toolsLight: return "\u{fc11}"
        case .toolsRegular: return "\u{fc12}"
        case .touchTenBold: return "\u{fc13}"
        case .touchTenLight: return "\u{fc14}"
        case .touchTenRegular: return "\u{fc15}"
        case .transcriptBold: return "\u{fc16}"
        case .transcriptFilled: return "\u{fc17}"
        case .transcriptLight: return "\u{fc18}"
        case .transcriptRegular: return "\u{fc19}"
        case .translateBold: return "\u{fc1a}"
        case .translateLight: return "\u{fc1b}"
        case .translateRegular: return "\u{fc1c}"
        case .translateUndoBold: return "\u{fc1d}"
        case .translateUndoLight: return "\u{fc1e}"
        case .translateUndoRegular: return "\u{fc1f}"
        case .trendingBold: return "\u{fc20}"
        case .trendingDownBold: return "\u{fc21}"
        case .trendingDownFilled: return "\u{fc22}"
        case .trendingDownLight: return "\u{fc23}"
        case .trendingDownRegular: return "\u{fc24}"
        case .trendingFilled: return "\u{fc25}"
        case .trendingLight: return "\u{fc26}"
        case .trendingRegular: return "\u{fc27}"
        case .trimBold: return "\u{fc28}"
        case .trimLight: return "\u{fc29}"
        case .trimRegular: return "\u{fc2a}"
        case .twoColumnBold: return "\u{fc2b}"
        case .twoColumnLight: return "\u{fc2c}"
        case .twoColumnRegular: return "\u{fc2d}"
        case .twoWayVoiceStreamBold: return "\u{fc2e}"
        case .twoWayVoiceStreamFilled: return "\u{fc2f}"
        case .twoWayVoiceStreamLight: return "\u{fc30}"
        case .twoWayVoiceStreamRegular: return "\u{fc31}"
        case .ucmCloudBold: return "\u{fc32}"
        case .ucmCloudLight: return "\u{fc33}"
        case .ucmCloudRegular: return "\u{fc34}"
        case .unblockBold: return "\u{fc35}"
        case .unblockFilled: return "\u{fc36}"
        case .unblockLight: return "\u{fc37}"
        case .unblockRegular: return "\u{fc38}"
        case .underlineBold: return "\u{fc39}"
        case .underlineFilled: return "\u{fc3a}"
        case .underlineLight: return "\u{fc3b}"
        case .underlineRegular: return "\u{fc3c}"
        case .undoBold: return "\u{fc3d}"
        case .undoLight: return "\u{fc3e}"
        case .undoRegular: return "\u{fc3f}"
        case .unlinkBold: return "\u{fc40}"
        case .unlinkLight: return "\u{fc41}"
        case .unlinkRegular: return "\u{fc42}"
        case .unreadBold: return "\u{fc43}"
        case .unreadFilled: return "\u{fc44}"
        case .unreadLight: return "\u{fc45}"
        case .unreadRegular: return "\u{fc46}"
        case .unsecureUnlockedBold: return "\u{fc47}"
        case .unsecureUnlockedFilled: return "\u{fc48}"
        case .unsecureUnlockedLight: return "\u{fc49}"
        case .unsecureUnlockedRegular: return "\u{fc4a}"
        case .unsortedBold: return "\u{fc4b}"
        case .unsortedLight: return "\u{fc4c}"
        case .unsortedRegular: return "\u{fc4d}"
        case .updateFileShareBold: return "\u{fc4e}"
        case .updateFileShareLight: return "\u{fc4f}"
        case .updateFileShareRegular: return "\u{fc50}"
        case .uploadBold: return "\u{fc51}"
        case .uploadImageBold: return "\u{fc52}"
        case .uploadImageLight: return "\u{fc53}"
        case .uploadImageRegular: return "\u{fc54}"
        case .uploadLight: return "\u{fc55}"
        case .uploadRegular: return "\u{fc56}"
        case .urgentVoicemailBold: return "\u{fc57}"
        case .urgentVoicemailFilled: return "\u{fc58}"
        case .usbBold: return "\u{fc59}"
        case .usbHeadsetBold: return "\u{fc5a}"
        case .usbHeadsetLight: return "\u{fc5b}"
        case .usbHeadsetMutedBold: return "\u{fc5c}"
        case .usbHeadsetMutedLight: return "\u{fc5d}"
        case .usbHeadsetMutedRegular: return "\u{fc5e}"
        case .usbHeadsetRegular: return "\u{fc5f}"
        case .usbLight: return "\u{fc60}"
        case .usbRegular: return "\u{fc61}"
        case .userBold: return "\u{fc62}"
        case .userDeactivateBold: return "\u{fc63}"
        case .userDeactivateLight: return "\u{fc64}"
        case .userDeactivateRegular: return "\u{fc65}"
        case .userFilled: return "\u{fc66}"
        case .userLight: return "\u{fc67}"
        case .userRegular: return "\u{fc68}"
        case .videoBlurBold: return "\u{fc69}"
        case .videoBlurFilled: return "\u{fc6a}"
        case .videoBlurLight: return "\u{fc6b}"
        case .videoBlurRegular: return "\u{fc6c}"
        case .videoBold: return "\u{fc6d}"
        case .videoEffectBold: return "\u{fc6e}"
        case .videoEffectFilled: return "\u{fc6f}"
        case .videoEffectLight: return "\u{fc70}"
        case .videoEffectRegular: return "\u{fc71}"
        case .videoFilled: return "\u{fc72}"
        case .videoLayoutBold: return "\u{fc73}"
        case .videoLayoutCustomBold: return "\u{fc74}"
        case .videoLayoutCustomFilled: return "\u{fc75}"
        case .videoLayoutCustomLight: return "\u{fc76}"
        case .videoLayoutCustomRegular: return "\u{fc77}"
        case .videoLayoutEqualBold: return "\u{fc78}"
        case .videoLayoutEqualDualBold: return "\u{fc79}"
        case .videoLayoutEqualDualLight: return "\u{fc7a}"
        case .videoLayoutEqualDualRegular: return "\u{fc7b}"
        case .videoLayoutEqualFilled: return "\u{fc7c}"
        case .videoLayoutEqualLight: return "\u{fc7d}"
        case .videoLayoutEqualRegular: return "\u{fc7e}"
        case .videoLayoutFilled: return "\u{fc7f}"
        case .videoLayoutLight: return "\u{fc80}"
        case .videoLayoutOverlayBold: return "\u{fc81}"
        case .videoLayoutOverlayFilled: return "\u{fc82}"
        case .videoLayoutOverlayLight: return "\u{fc83}"
        case .videoLayoutOverlayRegular: return "\u{fc84}"
        case .videoLayoutPresentationBold: return "\u{fc85}"
        case .videoLayoutPresentationFilled: return "\u{fc86}"
        case .videoLayoutPresentationLight: return "\u{fc87}"
        case .videoLayoutPresentationRegular: return "\u{fc88}"
        case .videoLayoutPresenterDominantBold: return "\u{fc89}"
        case .videoLayoutPresenterDominantLight: return "\u{fc8a}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc8b}"
        case .videoLayoutProminentBold: return "\u{fc8c}"
        case .videoLayoutProminentFilled: return "\u{fc8d}"
        case .videoLayoutProminentLight: return "\u{fc8e}"
        case .videoLayoutProminentRegular: return "\u{fc8f}"
        case .videoLayoutRegular: return "\u{fc90}"
        case .videoLayoutShareDominantBold: return "\u{fc91}"
        case .videoLayoutShareDominantLight: return "\u{fc92}"
        case .videoLayoutShareDominantRegular: return "\u{fc93}"
        case .videoLayoutSingleBold: return "\u{fc94}"
        case .videoLayoutSingleFilled: return "\u{fc95}"
        case .videoLayoutSingleLight: return "\u{fc96}"
        case .videoLayoutSingleRegular: return "\u{fc97}"
        case .videoLayoutSpeakerBold: return "\u{fc98}"
        case .videoLayoutSpeakerFilled: return "\u{fc99}"
        case .videoLayoutSpeakerLight: return "\u{fc9a}"
        case .videoLayoutSpeakerRegular: return "\u{fc9b}"
        case .videoLayoutStackBold: return "\u{fc9c}"
        case .videoLayoutStackFilled: return "\u{fc9d}"
        case .videoLayoutStackLight: return "\u{fc9e}"
        case .videoLayoutStackRegular: return "\u{fc9f}"
        case .videoLayoutVideoDominantBold: return "\u{fca0}"
        case .videoLayoutVideoDominantFilled: return "\u{fca1}"
        case .videoLayoutVideoDominantLight: return "\u{fca2}"
        case .videoLayoutVideoDominantRegular: return "\u{fca3}"
        case .videoLight: return "\u{fca4}"
        case .videoPlusBold: return "\u{fca5}"
        case .videoPlusFilled: return "\u{fca6}"
        case .videoPlusLight: return "\u{fca7}"
        case .videoPlusRegular: return "\u{fca8}"
        case .videoRegular: return "\u{fca9}"
        case .videoSpeakerTrackBold: return "\u{fcaa}"
        case .videoSpeakerTrackFilled: return "\u{fcab}"
        case .videoSpeakerTrackLight: return "\u{fcac}"
        case .videoSpeakerTrackRegular: return "\u{fcad}"
        case .viewAllBold: return "\u{fcae}"
        case .viewAllLight: return "\u{fcaf}"
        case .viewAllRegular: return "\u{fcb0}"
        case .viewListBold: return "\u{fcb1}"
        case .viewListFilled: return "\u{fcb2}"
        case .viewListLight: return "\u{fcb3}"
        case .viewListRegular: return "\u{fcb4}"
        case .viewStackedBold: return "\u{fcb5}"
        case .viewStackedFilled: return "\u{fcb6}"
        case .viewStackedLight: return "\u{fcb7}"
        case .viewStackedRegular: return "\u{fcb8}"
        case .viewThumbnailBold: return "\u{fcb9}"
        case .viewThumbnailFilled: return "\u{fcba}"
        case .viewThumbnailLight: return "\u{fcbb}"
        case .viewThumbnailRegular: return "\u{fcbc}"
        case .visionproBold: return "\u{fcbd}"
        case .visionproFilled: return "\u{fcbe}"
        case .visionproLight: return "\u{fcbf}"
        case .visionproMoveCallInBold: return "\u{fcc0}"
        case .visionproMoveCallInFilled: return "\u{fcc1}"
        case .visionproMoveCallInLight: return "\u{fcc2}"
        case .visionproMoveCallInOutBold: return "\u{fcc3}"
        case .visionproMoveCallInOutFilled: return "\u{fcc4}"
        case .visionproMoveCallInOutLight: return "\u{fcc5}"
        case .visionproMoveCallInOutRegular: return "\u{fcc6}"
        case .visionproMoveCallInRegular: return "\u{fcc7}"
        case .visionproMoveCallOutBold: return "\u{fcc8}"
        case .visionproMoveCallOutFilled: return "\u{fcc9}"
        case .visionproMoveCallOutLight: return "\u{fcca}"
        case .visionproMoveCallOutRegular: return "\u{fccb}"
        case .visionproRegular: return "\u{fccc}"
        case .voicemailBold: return "\u{fccd}"
        case .voicemailFilled: return "\u{fcce}"
        case .voicemailLight: return "\u{fccf}"
        case .voicemailRegular: return "\u{fcd0}"
        case .vpnBold: return "\u{fcd1}"
        case .vpnFilled: return "\u{fcd2}"
        case .vpnLight: return "\u{fcd3}"
        case .vpnRegular: return "\u{fcd4}"
        case .vscBold: return "\u{fcd5}"
        case .vscLight: return "\u{fcd6}"
        case .vscRegular: return "\u{fcd7}"
        case .waffleMenuBold: return "\u{fcd8}"
        case .waffleMenuLight: return "\u{fcd9}"
        case .waffleMenuRegular: return "\u{fcda}"
        case .waitingRoomBold: return "\u{fcdb}"
        case .waitingRoomLight: return "\u{fcdc}"
        case .waitingRoomRegular: return "\u{fcdd}"
        case .wallpaperBold: return "\u{fcde}"
        case .wallpaperLight: return "\u{fcdf}"
        case .wallpaperRegular: return "\u{fce0}"
        case .warningBadgeFilled: return "\u{fce1}"
        case .warningBold: return "\u{fce2}"
        case .warningFilled: return "\u{fce3}"
        case .warningLight: return "\u{fce4}"
        case .warningRegular: return "\u{fce5}"
        case .webexBoardBold: return "\u{fce6}"
        case .webexBoardLight: return "\u{fce7}"
        case .webexBoardRegular: return "\u{fce8}"
        case .webexCodecPlusBold: return "\u{fce9}"
        case .webexCodecPlusLight: return "\u{fcea}"
        case .webexCodecPlusRegular: return "\u{fceb}"
        case .webexDeskCameraBold: return "\u{fcec}"
        case .webexDeskCameraLight: return "\u{fced}"
        case .webexDeskCameraRegular: return "\u{fcee}"
        case .webexHelixBold: return "\u{fcef}"
        case .webexHelixLight: return "\u{fcf0}"
        case .webexHelixRegular: return "\u{fcf1}"
        case .webexMeetingsBold: return "\u{fcf2}"
        case .webexMeetingsFilled: return "\u{fcf3}"
        case .webexMeetingsLight: return "\u{fcf4}"
        case .webexMeetingsRegular: return "\u{fcf5}"
        case .webexQuadCameraBold: return "\u{fcf6}"
        case .webexQuadCameraLight: return "\u{fcf7}"
        case .webexQuadCameraRegular: return "\u{fcf8}"
        case .webexRoomKitBold: return "\u{fcf9}"
        case .webexRoomKitLight: return "\u{fcfa}"
        case .webexRoomKitPlusBold: return "\u{fcfb}"
        case .webexRoomKitPlusLight: return "\u{fcfc}"
        case .webexRoomKitPlusRegular: return "\u{fcfd}"
        case .webexRoomKitRegular: return "\u{fcfe}"
        case .webexShareBold: return "\u{fcff}"
        case .webexShareLight: return "\u{fd00}"
        case .webexShareRegular: return "\u{fd01}"
        case .webexTeamsBold: return "\u{fd02}"
        case .webexTeamsFilled: return "\u{fd03}"
        case .webexTeamsLight: return "\u{fd04}"
        case .webexTeamsNewBold: return "\u{fd05}"
        case .webexTeamsNewFilled: return "\u{fd06}"
        case .webexTeamsNewLight: return "\u{fd07}"
        case .webexTeamsNewRegular: return "\u{fd08}"
        case .webexTeamsRegular: return "\u{fd09}"
        case .webexTeamsRemoveBold: return "\u{fd0a}"
        case .webexTeamsRemoveLight: return "\u{fd0b}"
        case .webexTeamsRemoveRegular: return "\u{fd0c}"
        case .webhookBold: return "\u{fd0d}"
        case .webhookLight: return "\u{fd0e}"
        case .webhookRegular: return "\u{fd0f}"
        case .webinarBold: return "\u{fd10}"
        case .webinarFilled: return "\u{fd11}"
        case .webinarLight: return "\u{fd12}"
        case .webinarRegular: return "\u{fd13}"
        case .weeklyRecurringScheduleBold: return "\u{fd14}"
        case .weeklyRecurringScheduleLight: return "\u{fd15}"
        case .weeklyRecurringScheduleRegular: return "\u{fd16}"
        case .whisperAnnouncementBold: return "\u{fd17}"
        case .whisperAnnouncementFilled: return "\u{fd18}"
        case .whisperAnnouncementLight: return "\u{fd19}"
        case .whisperAnnouncementRegular: return "\u{fd1a}"
        case .whisperCoachBold: return "\u{fd1b}"
        case .whisperCoachFilled: return "\u{fd1c}"
        case .whisperCoachLight: return "\u{fd1d}"
        case .whisperCoachRegular: return "\u{fd1e}"
        case .whiteboardBold: return "\u{fd1f}"
        case .whiteboardContentBold: return "\u{fd20}"
        case .whiteboardContentFilled: return "\u{fd21}"
        case .whiteboardContentLight: return "\u{fd22}"
        case .whiteboardContentRegular: return "\u{fd23}"
        case .whiteboardFilled: return "\u{fd24}"
        case .whiteboardLight: return "\u{fd25}"
        case .whiteboardRegular: return "\u{fd26}"
        case .widgetBold: return "\u{fd27}"
        case .widgetFilled: return "\u{fd28}"
        case .widgetLight: return "\u{fd29}"
        case .widgetRegular: return "\u{fd2a}"
        case .wifiBold: return "\u{fd2b}"
        case .wifiErrorBold: return "\u{fd2c}"
        case .wifiErrorLight: return "\u{fd2d}"
        case .wifiErrorRegular: return "\u{fd2e}"
        case .wifiLight: return "\u{fd2f}"
        case .wifiRegular: return "\u{fd30}"
        case .wifiSignalGoodBold: return "\u{fd31}"
        case .wifiSignalGoodLight: return "\u{fd32}"
        case .wifiSignalGoodRegular: return "\u{fd33}"
        case .wifiSignalPoorBold: return "\u{fd34}"
        case .wifiSignalPoorLight: return "\u{fd35}"
        case .wifiSignalPoorRegular: return "\u{fd36}"
        case .wifiSignalUnstableBold: return "\u{fd37}"
        case .wifiSignalUnstableLight: return "\u{fd38}"
        case .wifiSignalUnstableRegular: return "\u{fd39}"
        case .windowCornerScrubBold: return "\u{fd3a}"
        case .windowCornerScrubLight: return "\u{fd3b}"
        case .windowCornerScrubRegular: return "\u{fd3c}"
        case .windowRightCornerScrubBold: return "\u{fd3d}"
        case .windowRightCornerScrubLight: return "\u{fd3e}"
        case .windowRightCornerScrubRegular: return "\u{fd3f}"
        case .windowVerticalScrubBold: return "\u{fd40}"
        case .windowVerticalScrubLight: return "\u{fd41}"
        case .windowVerticalScrubRegular: return "\u{fd42}"
        case .workflowDeploymentsBold: return "\u{fd43}"
        case .workflowDeploymentsFilled: return "\u{fd44}"
        case .workflowDeploymentsLight: return "\u{fd45}"
        case .workflowDeploymentsRegular: return "\u{fd46}"
        case .workphoneBold: return "\u{fd47}"
        case .workphoneLight: return "\u{fd48}"
        case .workphoneRegular: return "\u{fd49}"
        case .zoomInBold: return "\u{fd4a}"
        case .zoomInLight: return "\u{fd4b}"
        case .zoomInRegular: return "\u{fd4c}"
        case .zoomOutBold: return "\u{fd4d}"
        case .zoomOutLight: return "\u{fd4e}"
        case .zoomOutRegular: return "\u{fd4f}"
