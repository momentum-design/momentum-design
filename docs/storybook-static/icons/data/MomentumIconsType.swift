...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .potentialFraudBold: return "\u{f8a5}"
        case .potentialFraudFilled: return "\u{f8a6}"
        case .potentialFraudLight: return "\u{f8a7}"
        case .potentialFraudRegular: return "\u{f8a8}"
        case .powerAcBold: return "\u{f8a9}"
        case .powerAcLight: return "\u{f8aa}"
        case .powerAcRegular: return "\u{f8ab}"
        case .powerBold: return "\u{f8ac}"
        case .powerLight: return "\u{f8ad}"
        case .powerRegular: return "\u{f8ae}"
        case .preHeaderBold: return "\u{f8af}"
        case .preHeaderLight: return "\u{f8b0}"
        case .preHeaderRegular: return "\u{f8b1}"
        case .premiumBold: return "\u{f8b2}"
        case .premiumLight: return "\u{f8b3}"
        case .premiumRegular: return "\u{f8b4}"
        case .presentationBold: return "\u{f8b5}"
        case .presentationLight: return "\u{f8b6}"
        case .presentationRegular: return "\u{f8b7}"
        case .preventDownloadBold: return "\u{f8b8}"
        case .preventDownloadFilled: return "\u{f8b9}"
        case .preventDownloadLight: return "\u{f8ba}"
        case .preventDownloadRegular: return "\u{f8bb}"
        case .primaryParticipantBold: return "\u{f8bc}"
        case .primaryParticipantLight: return "\u{f8bd}"
        case .primaryParticipantRegular: return "\u{f8be}"
        case .printBold: return "\u{f8bf}"
        case .printLight: return "\u{f8c0}"
        case .printRegular: return "\u{f8c1}"
        case .priorityBadgeFilled: return "\u{f8c2}"
        case .priorityCircleBold: return "\u{f8c3}"
        case .priorityCircleFilled: return "\u{f8c4}"
        case .priorityCircleLight: return "\u{f8c5}"
        case .priorityCircleRegular: return "\u{f8c6}"
        case .priorityCircleTwoBold: return "\u{f8c7}"
        case .priorityCircleTwoFilled: return "\u{f8c8}"
        case .priorityCircleTwoLight: return "\u{f8c9}"
        case .priorityCircleTwoRegular: return "\u{f8ca}"
        case .priorityWaveBold: return "\u{f8cb}"
        case .priorityWaveLight: return "\u{f8cc}"
        case .priorityWaveRegular: return "\u{f8cd}"
        case .privacyCircleBold: return "\u{f8ce}"
        case .privacyCircleFilled: return "\u{f8cf}"
        case .privacyCircleLight: return "\u{f8d0}"
        case .privacyCircleRegular: return "\u{f8d1}"
        case .privateBold: return "\u{f8d2}"
        case .privateCircleBold: return "\u{f8d3}"
        case .privateCircleFilled: return "\u{f8d4}"
        case .privateCircleLight: return "\u{f8d5}"
        case .privateCircleRegular: return "\u{f8d6}"
        case .privateLight: return "\u{f8d7}"
        case .privateMeetingBold: return "\u{f8d8}"
        case .privateMeetingLight: return "\u{f8d9}"
        case .privateMeetingRegular: return "\u{f8da}"
        case .privateRegular: return "\u{f8db}"
        case .productDemoBold: return "\u{f8dc}"
        case .productDemoLight: return "\u{f8dd}"
        case .productDemoRegular: return "\u{f8de}"
        case .proximityBold: return "\u{f8df}"
        case .proximityLight: return "\u{f8e0}"
        case .proximityMutedBold: return "\u{f8e1}"
        case .proximityMutedLight: return "\u{f8e2}"
        case .proximityMutedRegular: return "\u{f8e3}"
        case .proximityRegular: return "\u{f8e4}"
        case .proximityVideoBold: return "\u{f8e5}"
        case .proximityVideoLight: return "\u{f8e6}"
        case .proximityVideoRegular: return "\u{f8e7}"
        case .ptoPresenceBold: return "\u{f8e8}"
        case .ptoPresenceFilled: return "\u{f8e9}"
        case .ptoPresenceLight: return "\u{f8ea}"
        case .ptoPresenceRegular: return "\u{f8eb}"
        case .pullCallBold: return "\u{f8ec}"
        case .pullCallFilled: return "\u{f8ed}"
        case .pullCallLight: return "\u{f8ee}"
        case .pullCallRegular: return "\u{f8ef}"
        case .qABold: return "\u{f8f0}"
        case .qALight: return "\u{f8f1}"
        case .qARegular: return "\u{f8f2}"
        case .qrCodeBold: return "\u{f8f3}"
        case .qrCodeLight: return "\u{f8f4}"
        case .qrCodeRegular: return "\u{f8f5}"
        case .qrCodeScanBold: return "\u{f8f6}"
        case .qrCodeScanLight: return "\u{f8f7}"
        case .qrCodeScanRegular: return "\u{f8f8}"
        case .qualityBold: return "\u{f8f9}"
        case .qualityLight: return "\u{f8fa}"
        case .qualityRegular: return "\u{f8fb}"
        case .queueContactBold: return "\u{f8fc}"
        case .queueContactFilled: return "\u{f8fd}"
        case .queueContactLight: return "\u{f8fe}"
        case .queueContactRegular: return "\u{f8ff}"
        case .quietBold: return "\u{f900}"
        case .quietHoursPresenceBold: return "\u{f901}"
        case .quietHoursPresenceFilled: return "\u{f902}"
        case .quietHoursPresenceLight: return "\u{f903}"
        case .quietHoursPresenceRegular: return "\u{f904}"
        case .quietLight: return "\u{f905}"
        case .quietRegular: return "\u{f906}"
        case .radioButtonGroupBold: return "\u{f907}"
        case .radioButtonGroupLight: return "\u{f908}"
        case .radioButtonGroupRegular: return "\u{f909}"
        case .raiseHandBold: return "\u{f90a}"
        case .raiseHandCircleFilled: return "\u{f90b}"
        case .raiseHandFilled: return "\u{f90c}"
        case .raiseHandLight: return "\u{f90d}"
        case .raiseHandRegular: return "\u{f90e}"
        case .ramBold: return "\u{f90f}"
        case .ramLight: return "\u{f910}"
        case .ramRegular: return "\u{f911}"
        case .reactionsBold: return "\u{f912}"
        case .reactionsFilled: return "\u{f913}"
        case .reactionsLight: return "\u{f914}"
        case .reactionsRegular: return "\u{f915}"
        case .reactivateBold: return "\u{f916}"
        case .reactivateLight: return "\u{f917}"
        case .reactivateRegular: return "\u{f918}"
        case .receiveVoiceBold: return "\u{f919}"
        case .receiveVoiceFilled: return "\u{f91a}"
        case .receiveVoiceLight: return "\u{f91b}"
        case .receiveVoiceRegular: return "\u{f91c}"
        case .recentsBold: return "\u{f91d}"
        case .recentsFilled: return "\u{f91e}"
        case .recentsLight: return "\u{f91f}"
        case .recentsPresenceBadgeFilled: return "\u{f920}"
        case .recentsPresenceBold: return "\u{f921}"
        case .recentsPresenceFilled: return "\u{f922}"
        case .recentsPresenceLight: return "\u{f923}"
        case .recentsPresenceRegular: return "\u{f924}"
        case .recentsRegular: return "\u{f925}"
        case .recordActiveBadgeFilled: return "\u{f926}"
        case .recordActiveBold: return "\u{f927}"
        case .recordActiveFilled: return "\u{f928}"
        case .recordActiveLight: return "\u{f929}"
        case .recordActiveRegular: return "\u{f92a}"
        case .recordBold: return "\u{f92b}"
        case .recordFilled: return "\u{f92c}"
        case .recordLight: return "\u{f92d}"
        case .recordPausedBadgeFilled: return "\u{f92e}"
        case .recordPausedBold: return "\u{f92f}"
        case .recordPausedFilled: return "\u{f930}"
        case .recordPausedLight: return "\u{f931}"
        case .recordPausedRegular: return "\u{f932}"
        case .recordRegular: return "\u{f933}"
        case .recurringBold: return "\u{f934}"
        case .recurringLight: return "\u{f935}"
        case .recurringOffBold: return "\u{f936}"
        case .recurringOffLight: return "\u{f937}"
        case .recurringOffRegular: return "\u{f938}"
        case .recurringRegular: return "\u{f939}"
        case .redoBold: return "\u{f93a}"
        case .redoLight: return "\u{f93b}"
        case .redoRegular: return "\u{f93c}"
        case .refreshBold: return "\u{f93d}"
        case .refreshLight: return "\u{f93e}"
        case .refreshRegular: return "\u{f93f}"
        case .remoteDesktopControlBold: return "\u{f940}"
        case .remoteDesktopControlFilled: return "\u{f941}"
        case .remoteDesktopControlLight: return "\u{f942}"
        case .remoteDesktopControlRegular: return "\u{f943}"
        case .removeBold: return "\u{f944}"
        case .removeFilled: return "\u{f945}"
        case .removeLight: return "\u{f946}"
        case .removeRegular: return "\u{f947}"
        case .replyBold: return "\u{f948}"
        case .replyFilled: return "\u{f949}"
        case .replyLight: return "\u{f94a}"
        case .replyListBold: return "\u{f94b}"
        case .replyListLight: return "\u{f94c}"
        case .replyListRegular: return "\u{f94d}"
        case .replyPrivatelyBold: return "\u{f94e}"
        case .replyPrivatelyLight: return "\u{f94f}"
        case .replyPrivatelyRegular: return "\u{f950}"
        case .replyRegular: return "\u{f951}"
        case .resetBold: return "\u{f952}"
        case .resetLight: return "\u{f953}"
        case .resetRegular: return "\u{f954}"
        case .resizeCornerBold: return "\u{f955}"
        case .resizeCornerLight: return "\u{f956}"
        case .resizeCornerRegular: return "\u{f957}"
        case .responsiveMobileBold: return "\u{f958}"
        case .responsiveMobileLight: return "\u{f959}"
        case .responsiveMobileRegular: return "\u{f95a}"
        case .restartBold: return "\u{f95b}"
        case .restartLight: return "\u{f95c}"
        case .restartRegular: return "\u{f95d}"
        case .retrieveCallBold: return "\u{f95e}"
        case .retrieveCallFilled: return "\u{f95f}"
        case .retrieveCallLight: return "\u{f960}"
        case .retrieveCallRegular: return "\u{f961}"
        case .returnBold: return "\u{f962}"
        case .returnLight: return "\u{f963}"
        case .returnRegular: return "\u{f964}"
        case .rewindTenSecBold: return "\u{f965}"
        case .rewindTenSecLight: return "\u{f966}"
        case .rewindTenSecRegular: return "\u{f967}"
        case .ringtoneBold: return "\u{f968}"
        case .ringtoneLight: return "\u{f969}"
        case .ringtoneRegular: return "\u{f96a}"
        case .roomCalendarBold: return "\u{f96b}"
        case .roomCalendarLight: return "\u{f96c}"
        case .roomCalendarRegular: return "\u{f96d}"
        case .roomLightsBold: return "\u{f96e}"
        case .roomLightsFilled: return "\u{f96f}"
        case .roomLightsLight: return "\u{f970}"
        case .roomLightsRegular: return "\u{f971}"
        case .rotateContentBold: return "\u{f972}"
        case .rotateContentFilled: return "\u{f973}"
        case .rotateContentLight: return "\u{f974}"
        case .rotateContentRegular: return "\u{f975}"
        case .rssBold: return "\u{f976}"
        case .rssFilled: return "\u{f977}"
        case .rssLight: return "\u{f978}"
        case .rssRegular: return "\u{f979}"
        case .ruleBasedBold: return "\u{f97a}"
        case .ruleBasedLight: return "\u{f97b}"
        case .ruleBasedRegular: return "\u{f97c}"
        case .runningApplicationBold: return "\u{f97d}"
        case .runningApplicationFilled: return "\u{f97e}"
        case .runningApplicationLight: return "\u{f97f}"
        case .runningApplicationRegular: return "\u{f980}"
        case .saveBold: return "\u{f981}"
        case .saveLight: return "\u{f982}"
        case .saveRegular: return "\u{f983}"
        case .saveTranscriptBold: return "\u{f984}"
        case .saveTranscriptFilled: return "\u{f985}"
        case .saveTranscriptLight: return "\u{f986}"
        case .saveTranscriptRegular: return "\u{f987}"
        case .scanBold: return "\u{f988}"
        case .scanLight: return "\u{f989}"
        case .scanRegular: return "\u{f98a}"
        case .scheduleSendBold: return "\u{f98b}"
        case .scheduleSendFilled: return "\u{f98c}"
        case .scheduleSendLight: return "\u{f98d}"
        case .scheduleSendRegular: return "\u{f98e}"
        case .scheduleWinnerBold: return "\u{f98f}"
        case .scheduleWinnerFilled: return "\u{f990}"
        case .scheduleWinnerLight: return "\u{f991}"
        case .scheduleWinnerRegular: return "\u{f992}"
        case .schedulerAvailableBold: return "\u{f993}"
        case .schedulerAvailableLight: return "\u{f994}"
        case .schedulerAvailableRegular: return "\u{f995}"
        case .schedulerNotWorkingHoursBold: return "\u{f996}"
        case .schedulerNotWorkingHoursLight: return "\u{f997}"
        case .schedulerNotWorkingHoursRegular: return "\u{f998}"
        case .schedulerUnavailableBold: return "\u{f999}"
        case .schedulerUnavailableLight: return "\u{f99a}"
        case .schedulerUnavailableRegular: return "\u{f99b}"
        case .schedulerUnknownBold: return "\u{f99c}"
        case .schedulerUnknownLight: return "\u{f99d}"
        case .schedulerUnknownRegular: return "\u{f99e}"
        case .screenshotBold: return "\u{f99f}"
        case .screenshotDocBold: return "\u{f9a0}"
        case .screenshotDocFilled: return "\u{f9a1}"
        case .screenshotDocLight: return "\u{f9a2}"
        case .screenshotDocRegular: return "\u{f9a3}"
        case .screenshotLight: return "\u{f9a4}"
        case .screenshotRegular: return "\u{f9a5}"
        case .searchBold: return "\u{f9a6}"
        case .searchFilled: return "\u{f9a7}"
        case .searchLight: return "\u{f9a8}"
        case .searchRegular: return "\u{f9a9}"
        case .secondaryArrowBold: return "\u{f9aa}"
        case .secondaryArrowLight: return "\u{f9ab}"
        case .secondaryArrowRegular: return "\u{f9ac}"
        case .secureCallLockBold: return "\u{f9ad}"
        case .secureCallLockFilled: return "\u{f9ae}"
        case .secureCallLockLight: return "\u{f9af}"
        case .secureCallLockRegular: return "\u{f9b0}"
        case .secureCallShieldBold: return "\u{f9b1}"
        case .secureCallShieldFilled: return "\u{f9b2}"
        case .secureCallShieldLight: return "\u{f9b3}"
        case .secureCallShieldRegular: return "\u{f9b4}"
        case .secureCircleBold: return "\u{f9b5}"
        case .secureCircleFilled: return "\u{f9b6}"
        case .secureCircleLight: return "\u{f9b7}"
        case .secureCircleRegular: return "\u{f9b8}"
        case .secureLockBold: return "\u{f9b9}"
        case .secureLockFilled: return "\u{f9ba}"
        case .secureLockLight: return "\u{f9bb}"
        case .secureLockRegular: return "\u{f9bc}"
        case .segmentExcludeFilled: return "\u{f9bd}"
        case .segmentFilterFilled: return "\u{f9be}"
        case .segmentIncludeFilled: return "\u{f9bf}"
        case .selectAllBold: return "\u{f9c0}"
        case .selectAllFilled: return "\u{f9c1}"
        case .selectAllLight: return "\u{f9c2}"
        case .selectAllRegular: return "\u{f9c3}"
        case .selectionBold: return "\u{f9c4}"
        case .selectionFilled: return "\u{f9c5}"
        case .selectionLight: return "\u{f9c6}"
        case .selectionRegular: return "\u{f9c7}"
        case .sendBold: return "\u{f9c8}"
        case .sendDigitsBold: return "\u{f9c9}"
        case .sendDigitsFilled: return "\u{f9ca}"
        case .sendDigitsLight: return "\u{f9cb}"
        case .sendDigitsRegular: return "\u{f9cc}"
        case .sendFilled: return "\u{f9cd}"
        case .sendLight: return "\u{f9ce}"
        case .sendRegular: return "\u{f9cf}"
        case .sendVoiceBold: return "\u{f9d0}"
        case .sendVoiceFilled: return "\u{f9d1}"
        case .sendVoiceLight: return "\u{f9d2}"
        case .sendVoiceRegular: return "\u{f9d3}"
        case .serverBold: return "\u{f9d4}"
        case .serverErrorBold: return "\u{f9d5}"
        case .serverErrorLight: return "\u{f9d6}"
        case .serverErrorRegular: return "\u{f9d7}"
        case .serverLight: return "\u{f9d8}"
        case .serverRegular: return "\u{f9d9}"
        case .servicesBold: return "\u{f9da}"
        case .servicesLight: return "\u{f9db}"
        case .servicesRegular: return "\u{f9dc}"
        case .setVariableBold: return "\u{f9dd}"
        case .setVariableLight: return "\u{f9de}"
        case .setVariableRegular: return "\u{f9df}"
        case .settingsBold: return "\u{f9e0}"
        case .settingsFilled: return "\u{f9e1}"
        case .settingsLight: return "\u{f9e2}"
        case .settingsRegular: return "\u{f9e3}"
        case .setupAssistantBold: return "\u{f9e4}"
        case .setupAssistantLight: return "\u{f9e5}"
        case .setupAssistantRegular: return "\u{f9e6}"
        case .sftpBold: return "\u{f9e7}"
        case .sftpLight: return "\u{f9e8}"
        case .sftpRegular: return "\u{f9e9}"
        case .shapeCircleBold: return "\u{f9ea}"
        case .shapeCircleFilled: return "\u{f9eb}"
        case .shapeCircleLight: return "\u{f9ec}"
        case .shapeCircleMdFilled: return "\u{f9ed}"
        case .shapeCircleRegular: return "\u{f9ee}"
        case .shapeCircleSmFilled: return "\u{f9ef}"
        case .shapeDiagonalLineBold: return "\u{f9f0}"
        case .shapeDiagonalLineLight: return "\u{f9f1}"
        case .shapeDiagonalLineRegular: return "\u{f9f2}"
        case .shapeDiamondBold: return "\u{f9f3}"
        case .shapeDiamondFilled: return "\u{f9f4}"
        case .shapeDiamondLight: return "\u{f9f5}"
        case .shapeDiamondRegular: return "\u{f9f6}"
        case .shapeOvalBold: return "\u{f9f7}"
        case .shapeOvalLight: return "\u{f9f8}"
        case .shapeOvalRegular: return "\u{f9f9}"
        case .shapeSquareBold: return "\u{f9fa}"
        case .shapeSquareFilled: return "\u{f9fb}"
        case .shapeSquareLight: return "\u{f9fc}"
        case .shapeSquareRegular: return "\u{f9fd}"
        case .shapeTriangleBold: return "\u{f9fe}"
        case .shapeTriangleFilled: return "\u{f9ff}"
        case .shapeTriangleLight: return "\u{fa00}"
        case .shapeTriangleRegular: return "\u{fa01}"
        case .shapesBold: return "\u{fa02}"
        case .shapesFilled: return "\u{fa03}"
        case .shapesLight: return "\u{fa04}"
        case .shapesRegular: return "\u{fa05}"
        case .shareCNativeAdrBold: return "\u{fa06}"
        case .shareCNativeAdrFilled: return "\u{fa07}"
        case .shareCNativeAdrLight: return "\u{fa08}"
        case .shareCNativeAdrRegular: return "\u{fa09}"
        case .shareCNativeIphBold: return "\u{fa0a}"
        case .shareCNativeIphLight: return "\u{fa0b}"
        case .shareCNativeIphRegular: return "\u{fa0c}"
        case .shareContentOnDeviceBold: return "\u{fa0d}"
        case .shareContentOnDeviceLight: return "\u{fa0e}"
        case .shareContentOnDeviceRegular: return "\u{fa0f}"
        case .shareScreenAddBold: return "\u{fa10}"
        case .shareScreenAddLight: return "\u{fa11}"
        case .shareScreenAddRegular: return "\u{fa12}"
        case .shareScreenBadgeFilled: return "\u{fa13}"
        case .shareScreenBold: return "\u{fa14}"
        case .shareScreenFilled: return "\u{fa15}"
        case .shareScreenLight: return "\u{fa16}"
        case .shareScreenRegular: return "\u{fa17}"
        case .shareSpaceBold: return "\u{fa18}"
        case .shareSpaceLight: return "\u{fa19}"
        case .shareSpaceRegular: return "\u{fa1a}"
        case .shieldBold: return "\u{fa1b}"
        case .shieldLight: return "\u{fa1c}"
        case .shieldRegular: return "\u{fa1d}"
        case .shoppingCartBold: return "\u{fa1e}"
        case .shoppingCartFilled: return "\u{fa1f}"
        case .shoppingCartLight: return "\u{fa20}"
        case .shoppingCartRegular: return "\u{fa21}"
        case .shortTextBoxBold: return "\u{fa22}"
        case .shortTextBoxLight: return "\u{fa23}"
        case .shortTextBoxRegular: return "\u{fa24}"
        case .showBold: return "\u{fa25}"
        case .showFilled: return "\u{fa26}"
        case .showLight: return "\u{fa27}"
        case .showRegular: return "\u{fa28}"
        case .signInBold: return "\u{fa29}"
        case .signInFilled: return "\u{fa2a}"
        case .signInForcedBold: return "\u{fa2b}"
        case .signInForcedLight: return "\u{fa2c}"
        case .signInForcedRegular: return "\u{fa2d}"
        case .signInLight: return "\u{fa2e}"
        case .signInRegular: return "\u{fa2f}"
        case .signLangIntBold: return "\u{fa30}"
        case .signLangIntLight: return "\u{fa31}"
        case .signLangIntRegular: return "\u{fa32}"
        case .signOutBold: return "\u{fa33}"
        case .signOutLight: return "\u{fa34}"
        case .signOutRegular: return "\u{fa35}"
        case .signalFourBold: return "\u{fa36}"
        case .signalFourLight: return "\u{fa37}"
        case .signalFourRegular: return "\u{fa38}"
        case .signalOneBold: return "\u{fa39}"
        case .signalOneLight: return "\u{fa3a}"
        case .signalOneRegular: return "\u{fa3b}"
        case .signalThreeBold: return "\u{fa3c}"
        case .signalThreeLight: return "\u{fa3d}"
        case .signalThreeRegular: return "\u{fa3e}"
        case .signalTwoBold: return "\u{fa3f}"
        case .signalTwoLight: return "\u{fa40}"
        case .signalTwoRegular: return "\u{fa41}"
        case .signalZeroBold: return "\u{fa42}"
        case .signalZeroLight: return "\u{fa43}"
        case .signalZeroRegular: return "\u{fa44}"
        case .simplePromotionBold: return "\u{fa45}"
        case .simplePromotionLight: return "\u{fa46}"
        case .simplePromotionRegular: return "\u{fa47}"
        case .singleNumberReachBold: return "\u{fa48}"
        case .singleNumberReachLight: return "\u{fa49}"
        case .singleNumberReachRegular: return "\u{fa4a}"
        case .sipRegistrationInProgressBold: return "\u{fa4b}"
        case .sipRegistrationInProgressFilled: return "\u{fa4c}"
        case .sipRegistrationInProgressLight: return "\u{fa4d}"
        case .sipRegistrationInProgressRegular: return "\u{fa4e}"
        case .skipBold: return "\u{fa4f}"
        case .skipBwBold: return "\u{fa50}"
        case .skipBwFilled: return "\u{fa51}"
        case .skipBwLight: return "\u{fa52}"
        case .skipBwRegular: return "\u{fa53}"
        case .skipFwBold: return "\u{fa54}"
        case .skipFwFilled: return "\u{fa55}"
        case .skipFwLight: return "\u{fa56}"
        case .skipFwRegular: return "\u{fa57}"
        case .skipLight: return "\u{fa58}"
        case .skipRegular: return "\u{fa59}"
        case .smartAudioBold: return "\u{fa5a}"
        case .smartAudioLight: return "\u{fa5b}"
        case .smartAudioRegular: return "\u{fa5c}"
        case .smsFilled: return "\u{fa5d}"
        case .smsInboundBold: return "\u{fa5e}"
        case .smsInboundLight: return "\u{fa5f}"
        case .smsInboundRegular: return "\u{fa60}"
        case .smsMessageBold: return "\u{fa61}"
        case .smsMessageFilled: return "\u{fa62}"
        case .smsMessageLight: return "\u{fa63}"
        case .smsMessageRegular: return "\u{fa64}"
        case .smsOutgoingFilled: return "\u{fa65}"
        case .smsUnreadBold: return "\u{fa66}"
        case .smsUnreadLight: return "\u{fa67}"
        case .smsUnreadRegular: return "\u{fa68}"
        case .sortAscendingBold: return "\u{fa69}"
        case .sortAscendingLight: return "\u{fa6a}"
        case .sortAscendingRegular: return "\u{fa6b}"
        case .sortDescendingBold: return "\u{fa6c}"
        case .sortDescendingLight: return "\u{fa6d}"
        case .sortDescendingRegular: return "\u{fa6e}"
        case .soundDefaultBold: return "\u{fa6f}"
        case .soundDefaultLight: return "\u{fa70}"
        case .soundDefaultRegular: return "\u{fa71}"
        case .sparkleBold: return "\u{fa72}"
        case .sparkleFilled: return "\u{fa73}"
        case .sparkleLight: return "\u{fa74}"
        case .sparkleRegular: return "\u{fa75}"
        case .speakerBold: return "\u{fa76}"
        case .speakerDisconnectedBold: return "\u{fa77}"
        case .speakerDisconnectedFilled: return "\u{fa78}"
        case .speakerDisconnectedLight: return "\u{fa79}"
        case .speakerDisconnectedRegular: return "\u{fa7a}"
        case .speakerFilled: return "\u{fa7b}"
        case .speakerLight: return "\u{fa7c}"
        case .speakerMutedBold: return "\u{fa7d}"
        case .speakerMutedFilled: return "\u{fa7e}"
        case .speakerMutedLight: return "\u{fa7f}"
        case .speakerMutedRegular: return "\u{fa80}"
        case .speakerOffBold: return "\u{fa81}"
        case .speakerOffFilled: return "\u{fa82}"
        case .speakerOffLight: return "\u{fa83}"
        case .speakerOffRegular: return "\u{fa84}"
        case .speakerOnBold: return "\u{fa85}"
        case .speakerOnLight: return "\u{fa86}"
        case .speakerOnRegular: return "\u{fa87}"
        case .speakerRegular: return "\u{fa88}"
        case .speakerTurnDownBold: return "\u{fa89}"
        case .speakerTurnDownFilled: return "\u{fa8a}"
        case .speakerTurnDownLight: return "\u{fa8b}"
        case .speakerTurnDownRegular: return "\u{fa8c}"
        case .speakerTurnUpBold: return "\u{fa8d}"
        case .speakerTurnUpFilled: return "\u{fa8e}"
        case .speakerTurnUpLight: return "\u{fa8f}"
        case .speakerTurnUpRegular: return "\u{fa90}"
        case .speedDialBold: return "\u{fa91}"
        case .speedDialFilled: return "\u{fa92}"
        case .speedDialLight: return "\u{fa93}"
        case .speedDialRegular: return "\u{fa94}"
        case .spellCheckerBold: return "\u{fa95}"
        case .spellCheckerLight: return "\u{fa96}"
        case .spellCheckerRegular: return "\u{fa97}"
        case .spinnerBold: return "\u{fa98}"
        case .spinnerInProgressBold: return "\u{fa99}"
        case .spinnerInProgressLight: return "\u{fa9a}"
        case .spinnerInProgressRegular: return "\u{fa9b}"
        case .spinnerLight: return "\u{fa9c}"
        case .spinnerRegular: return "\u{fa9d}"
        case .splitViewBold: return "\u{fa9e}"
        case .splitViewLight: return "\u{fa9f}"
        case .splitViewRegular: return "\u{faa0}"
        case .stackedAreaChartBold: return "\u{faa1}"
        case .stackedAreaChartFilled: return "\u{faa2}"
        case .stackedAreaChartFullBold: return "\u{faa3}"
        case .stackedAreaChartFullFilled: return "\u{faa4}"
        case .stackedAreaChartFullLight: return "\u{faa5}"
        case .stackedAreaChartFullRegular: return "\u{faa6}"
        case .stackedAreaChartLight: return "\u{faa7}"
        case .stackedAreaChartRegular: return "\u{faa8}"
        case .stackedBarChartBold: return "\u{faa9}"
        case .stackedBarChartFilled: return "\u{faaa}"
        case .stackedBarChartFullBold: return "\u{faab}"
        case .stackedBarChartFullFilled: return "\u{faac}"
        case .stackedBarChartFullLight: return "\u{faad}"
        case .stackedBarChartFullRegular: return "\u{faae}"
        case .stackedBarChartLight: return "\u{faaf}"
        case .stackedBarChartRegular: return "\u{fab0}"
        case .startChatBold: return "\u{fab1}"
        case .startChatLight: return "\u{fab2}"
        case .startChatRegular: return "\u{fab3}"
        case .stethoscopeBold: return "\u{fab4}"
        case .stethoscopeLight: return "\u{fab5}"
        case .stethoscopeRegular: return "\u{fab6}"
        case .stickersBold: return "\u{fab7}"
        case .stickersLight: return "\u{fab8}"
        case .stickersRegular: return "\u{fab9}"
        case .stickiesBold: return "\u{faba}"
        case .stickiesLight: return "\u{fabb}"
        case .stickiesRegular: return "\u{fabc}"
        case .stopBold: return "\u{fabd}"
        case .stopCircleBold: return "\u{fabe}"
        case .stopCircleFilled: return "\u{fabf}"
        case .stopCircleLight: return "\u{fac0}"
        case .stopCircleRegular: return "\u{fac1}"
        case .stopContentShareBold: return "\u{fac2}"
        case .stopContentShareLight: return "\u{fac3}"
        case .stopContentShareRegular: return "\u{fac4}"
        case .stopFilled: return "\u{fac5}"
        case .stopLight: return "\u{fac6}"
        case .stopRegular: return "\u{fac7}"
        case .storedInfoBold: return "\u{fac8}"
        case .storedInfoFilled: return "\u{fac9}"
        case .storedInfoLight: return "\u{faca}"
        case .storedInfoRegular: return "\u{facb}"
        case .streamingBold: return "\u{facc}"
        case .streamingLight: return "\u{facd}"
        case .streamingRegular: return "\u{face}"
        case .strikethroughBold: return "\u{facf}"
        case .strikethroughFilled: return "\u{fad0}"
        case .strikethroughLight: return "\u{fad1}"
        case .strikethroughRegular: return "\u{fad2}"
        case .studioModeBold: return "\u{fad3}"
        case .studioModeLight: return "\u{fad4}"
        case .studioModeRegular: return "\u{fad5}"
        case .subscriptBold: return "\u{fad6}"
        case .subscriptLight: return "\u{fad7}"
        case .subscriptRegular: return "\u{fad8}"
        case .superscriptBold: return "\u{fad9}"
        case .superscriptLight: return "\u{fada}"
        case .superscriptRegular: return "\u{fadb}"
        case .surveyBold: return "\u{fadc}"
        case .surveyFilled: return "\u{fadd}"
        case .surveyLight: return "\u{fade}"
        case .surveyRegular: return "\u{fadf}"
        case .sxEightyCodecBold: return "\u{fae0}"
        case .sxEightyCodecLight: return "\u{fae1}"
        case .sxEightyCodecRegular: return "\u{fae2}"
        case .sxTenBold: return "\u{fae3}"
        case .sxTenLight: return "\u{fae4}"
        case .sxTenRegular: return "\u{fae5}"
        case .sxTwentyBold: return "\u{fae6}"
        case .sxTwentyLight: return "\u{fae7}"
        case .sxTwentyRegular: return "\u{fae8}"
        case .tableBold: return "\u{fae9}"
        case .tableLight: return "\u{faea}"
        case .tableRegular: return "\u{faeb}"
        case .tabletBold: return "\u{faec}"
        case .tabletLight: return "\u{faed}"
        case .tabletRegular: return "\u{faee}"
        case .tabsBold: return "\u{faef}"
        case .tabsLight: return "\u{faf0}"
        case .tabsRegular: return "\u{faf1}"
        case .tagBold: return "\u{faf2}"
        case .tagLight: return "\u{faf3}"
        case .tagRegular: return "\u{faf4}"
        case .tapBold: return "\u{faf5}"
        case .tapFilled: return "\u{faf6}"
        case .tapLight: return "\u{faf7}"
        case .tapRegular: return "\u{faf8}"
        case .telepresenceAlertBold: return "\u{faf9}"
        case .telepresenceAlertLight: return "\u{fafa}"
        case .telepresenceAlertMutedBold: return "\u{fafb}"
        case .telepresenceAlertMutedLight: return "\u{fafc}"
        case .telepresenceAlertMutedRegular: return "\u{fafd}"
        case .telepresenceAlertRegular: return "\u{fafe}"
        case .telepresenceBold: return "\u{faff}"
        case .telepresenceIxFiveThousandBold: return "\u{fb00}"
        case .telepresenceIxFiveThousandLight: return "\u{fb01}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb02}"
        case .telepresenceLight: return "\u{fb03}"
        case .telepresenceMutedBold: return "\u{fb04}"
        case .telepresenceMutedLight: return "\u{fb05}"
        case .telepresenceMutedRegular: return "\u{fb06}"
        case .telepresencePrivateBold: return "\u{fb07}"
        case .telepresencePrivateLight: return "\u{fb08}"
        case .telepresencePrivateRegular: return "\u{fb09}"
        case .telepresenceRegular: return "\u{fb0a}"
        case .temperatureBold: return "\u{fb0b}"
        case .temperatureLight: return "\u{fb0c}"
        case .temperatureRegular: return "\u{fb0d}"
        case .testTubeBold: return "\u{fb0e}"
        case .testTubeFilled: return "\u{fb0f}"
        case .testTubeLight: return "\u{fb10}"
        case .testTubeRegular: return "\u{fb11}"
        case .textAlignCenterBold: return "\u{fb12}"
        case .textAlignCenterFilled: return "\u{fb13}"
        case .textAlignCenterLight: return "\u{fb14}"
        case .textAlignCenterRegular: return "\u{fb15}"
        case .textAlignLeftBold: return "\u{fb16}"
        case .textAlignLeftFilled: return "\u{fb17}"
        case .textAlignLeftLight: return "\u{fb18}"
        case .textAlignLeftRegular: return "\u{fb19}"
        case .textAlignRightBold: return "\u{fb1a}"
        case .textAlignRightFilled: return "\u{fb1b}"
        case .textAlignRightLight: return "\u{fb1c}"
        case .textAlignRightRegular: return "\u{fb1d}"
        case .textBold: return "\u{fb1e}"
        case .textBoxCursorLight: return "\u{fb1f}"
        case .textCodeBlockBold: return "\u{fb20}"
        case .textCodeBlockLight: return "\u{fb21}"
        case .textCodeBlockRegular: return "\u{fb22}"
        case .textHighlightBold: return "\u{fb23}"
        case .textHighlightFilled: return "\u{fb24}"
        case .textHighlightLight: return "\u{fb25}"
        case .textHighlightRegular: return "\u{fb26}"
        case .textLight: return "\u{fb27}"
        case .textRegular: return "\u{fb28}"
        case .threeColumnBold: return "\u{fb29}"
        case .threeColumnLight: return "\u{fb2a}"
        case .threeColumnRegular: return "\u{fb2b}"
        case .threeDObjectBold: return "\u{fb2c}"
        case .threeDObjectLight: return "\u{fb2d}"
        case .threeDObjectRegular: return "\u{fb2e}"
        case .timeExclusionBold: return "\u{fb2f}"
        case .timeExclusionLight: return "\u{fb30}"
        case .timeExclusionRegular: return "\u{fb31}"
        case .tooFastBold: return "\u{fb32}"
        case .tooFastLight: return "\u{fb33}"
        case .tooFastRegular: return "\u{fb34}"
        case .tooSlowBold: return "\u{fb35}"
        case .tooSlowLight: return "\u{fb36}"
        case .tooSlowRegular: return "\u{fb37}"
        case .toolsBold: return "\u{fb38}"
        case .toolsFilled: return "\u{fb39}"
        case .toolsLight: return "\u{fb3a}"
        case .toolsRegular: return "\u{fb3b}"
        case .touchTenBold: return "\u{fb3c}"
        case .touchTenLight: return "\u{fb3d}"
        case .touchTenRegular: return "\u{fb3e}"
        case .transcriptBold: return "\u{fb3f}"
        case .transcriptFilled: return "\u{fb40}"
        case .transcriptLight: return "\u{fb41}"
        case .transcriptRegular: return "\u{fb42}"
        case .translateBold: return "\u{fb43}"
        case .translateLight: return "\u{fb44}"
        case .translateRegular: return "\u{fb45}"
        case .translateUndoBold: return "\u{fb46}"
        case .translateUndoLight: return "\u{fb47}"
        case .translateUndoRegular: return "\u{fb48}"
        case .trendingBold: return "\u{fb49}"
        case .trendingDownBold: return "\u{fb4a}"
        case .trendingDownFilled: return "\u{fb4b}"
        case .trendingDownLight: return "\u{fb4c}"
        case .trendingDownRegular: return "\u{fb4d}"
        case .trendingFilled: return "\u{fb4e}"
        case .trendingLight: return "\u{fb4f}"
        case .trendingRegular: return "\u{fb50}"
        case .trimBold: return "\u{fb51}"
        case .trimLight: return "\u{fb52}"
        case .trimRegular: return "\u{fb53}"
        case .twoColumnBold: return "\u{fb54}"
        case .twoColumnLight: return "\u{fb55}"
        case .twoColumnRegular: return "\u{fb56}"
        case .twoWayVoiceStreamBold: return "\u{fb57}"
        case .twoWayVoiceStreamFilled: return "\u{fb58}"
        case .twoWayVoiceStreamLight: return "\u{fb59}"
        case .twoWayVoiceStreamRegular: return "\u{fb5a}"
        case .ucmCloudBold: return "\u{fb5b}"
        case .ucmCloudLight: return "\u{fb5c}"
        case .ucmCloudRegular: return "\u{fb5d}"
        case .unblockBold: return "\u{fb5e}"
        case .unblockFilled: return "\u{fb5f}"
        case .unblockLight: return "\u{fb60}"
        case .unblockRegular: return "\u{fb61}"
        case .underlineBold: return "\u{fb62}"
        case .underlineFilled: return "\u{fb63}"
        case .underlineLight: return "\u{fb64}"
        case .underlineRegular: return "\u{fb65}"
        case .undoBold: return "\u{fb66}"
        case .undoLight: return "\u{fb67}"
        case .undoRegular: return "\u{fb68}"
        case .unlinkBold: return "\u{fb69}"
        case .unlinkLight: return "\u{fb6a}"
        case .unlinkRegular: return "\u{fb6b}"
        case .unreadBold: return "\u{fb6c}"
        case .unreadFilled: return "\u{fb6d}"
        case .unreadLight: return "\u{fb6e}"
        case .unreadRegular: return "\u{fb6f}"
        case .unsecureUnlockedBold: return "\u{fb70}"
        case .unsecureUnlockedFilled: return "\u{fb71}"
        case .unsecureUnlockedLight: return "\u{fb72}"
        case .unsecureUnlockedRegular: return "\u{fb73}"
        case .unsortedBold: return "\u{fb74}"
        case .unsortedLight: return "\u{fb75}"
        case .unsortedRegular: return "\u{fb76}"
        case .updateFileShareBold: return "\u{fb77}"
        case .updateFileShareLight: return "\u{fb78}"
        case .updateFileShareRegular: return "\u{fb79}"
        case .uploadBold: return "\u{fb7a}"
        case .uploadImageBold: return "\u{fb7b}"
        case .uploadImageLight: return "\u{fb7c}"
        case .uploadImageRegular: return "\u{fb7d}"
        case .uploadLight: return "\u{fb7e}"
        case .uploadRegular: return "\u{fb7f}"
        case .urgentVoicemailBold: return "\u{fb80}"
        case .urgentVoicemailFilled: return "\u{fb81}"
        case .usbBold: return "\u{fb82}"
        case .usbHeadsetBold: return "\u{fb83}"
        case .usbHeadsetLight: return "\u{fb84}"
        case .usbHeadsetMutedBold: return "\u{fb85}"
        case .usbHeadsetMutedLight: return "\u{fb86}"
        case .usbHeadsetMutedRegular: return "\u{fb87}"
        case .usbHeadsetRegular: return "\u{fb88}"
        case .usbLight: return "\u{fb89}"
        case .usbRegular: return "\u{fb8a}"
        case .userBold: return "\u{fb8b}"
        case .userDeactivateBold: return "\u{fb8c}"
        case .userDeactivateLight: return "\u{fb8d}"
        case .userDeactivateRegular: return "\u{fb8e}"
        case .userLight: return "\u{fb8f}"
        case .userRegular: return "\u{fb90}"
        case .videoBlurBold: return "\u{fb91}"
        case .videoBlurFilled: return "\u{fb92}"
        case .videoBlurLight: return "\u{fb93}"
        case .videoBlurRegular: return "\u{fb94}"
        case .videoBold: return "\u{fb95}"
        case .videoEffectBold: return "\u{fb96}"
        case .videoEffectFilled: return "\u{fb97}"
        case .videoEffectLight: return "\u{fb98}"
        case .videoEffectRegular: return "\u{fb99}"
        case .videoFilled: return "\u{fb9a}"
        case .videoLayoutBold: return "\u{fb9b}"
        case .videoLayoutEqualBold: return "\u{fb9c}"
        case .videoLayoutEqualDualBold: return "\u{fb9d}"
        case .videoLayoutEqualDualLight: return "\u{fb9e}"
        case .videoLayoutEqualDualRegular: return "\u{fb9f}"
        case .videoLayoutEqualFilled: return "\u{fba0}"
        case .videoLayoutEqualLight: return "\u{fba1}"
        case .videoLayoutEqualRegular: return "\u{fba2}"
        case .videoLayoutFilled: return "\u{fba3}"
        case .videoLayoutLight: return "\u{fba4}"
        case .videoLayoutOverlayBold: return "\u{fba5}"
        case .videoLayoutOverlayFilled: return "\u{fba6}"
        case .videoLayoutOverlayLight: return "\u{fba7}"
        case .videoLayoutOverlayRegular: return "\u{fba8}"
        case .videoLayoutPresenterDominantBold: return "\u{fba9}"
        case .videoLayoutPresenterDominantLight: return "\u{fbaa}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbab}"
        case .videoLayoutProminentBold: return "\u{fbac}"
        case .videoLayoutProminentFilled: return "\u{fbad}"
        case .videoLayoutProminentLight: return "\u{fbae}"
        case .videoLayoutProminentRegular: return "\u{fbaf}"
        case .videoLayoutRegular: return "\u{fbb0}"
        case .videoLayoutShareDominantBold: return "\u{fbb1}"
        case .videoLayoutShareDominantLight: return "\u{fbb2}"
        case .videoLayoutShareDominantRegular: return "\u{fbb3}"
        case .videoLayoutSingleBold: return "\u{fbb4}"
        case .videoLayoutSingleFilled: return "\u{fbb5}"
        case .videoLayoutSingleLight: return "\u{fbb6}"
        case .videoLayoutSingleRegular: return "\u{fbb7}"
        case .videoLayoutStackBold: return "\u{fbb8}"
        case .videoLayoutStackFilled: return "\u{fbb9}"
        case .videoLayoutStackLight: return "\u{fbba}"
        case .videoLayoutStackRegular: return "\u{fbbb}"
        case .videoLayoutVideoDominantBold: return "\u{fbbc}"
        case .videoLayoutVideoDominantFilled: return "\u{fbbd}"
        case .videoLayoutVideoDominantLight: return "\u{fbbe}"
        case .videoLayoutVideoDominantRegular: return "\u{fbbf}"
        case .videoLight: return "\u{fbc0}"
        case .videoPlusBold: return "\u{fbc1}"
        case .videoPlusFilled: return "\u{fbc2}"
        case .videoPlusLight: return "\u{fbc3}"
        case .videoPlusRegular: return "\u{fbc4}"
        case .videoRegular: return "\u{fbc5}"
        case .videoSpeakerTrackBold: return "\u{fbc6}"
        case .videoSpeakerTrackFilled: return "\u{fbc7}"
        case .videoSpeakerTrackLight: return "\u{fbc8}"
        case .videoSpeakerTrackRegular: return "\u{fbc9}"
        case .viewAllBold: return "\u{fbca}"
        case .viewAllLight: return "\u{fbcb}"
        case .viewAllRegular: return "\u{fbcc}"
        case .viewListBold: return "\u{fbcd}"
        case .viewListFilled: return "\u{fbce}"
        case .viewListLight: return "\u{fbcf}"
        case .viewListRegular: return "\u{fbd0}"
        case .viewStackedBold: return "\u{fbd1}"
        case .viewStackedFilled: return "\u{fbd2}"
        case .viewStackedLight: return "\u{fbd3}"
        case .viewStackedRegular: return "\u{fbd4}"
        case .viewThumbnailBold: return "\u{fbd5}"
        case .viewThumbnailFilled: return "\u{fbd6}"
        case .viewThumbnailLight: return "\u{fbd7}"
        case .viewThumbnailRegular: return "\u{fbd8}"
        case .visionproBold: return "\u{fbd9}"
        case .visionproFilled: return "\u{fbda}"
        case .visionproLight: return "\u{fbdb}"
        case .visionproMoveCallInBold: return "\u{fbdc}"
        case .visionproMoveCallInFilled: return "\u{fbdd}"
        case .visionproMoveCallInLight: return "\u{fbde}"
        case .visionproMoveCallInOutBold: return "\u{fbdf}"
        case .visionproMoveCallInOutFilled: return "\u{fbe0}"
        case .visionproMoveCallInOutLight: return "\u{fbe1}"
        case .visionproMoveCallInOutRegular: return "\u{fbe2}"
        case .visionproMoveCallInRegular: return "\u{fbe3}"
        case .visionproMoveCallOutBold: return "\u{fbe4}"
        case .visionproMoveCallOutFilled: return "\u{fbe5}"
        case .visionproMoveCallOutLight: return "\u{fbe6}"
        case .visionproMoveCallOutRegular: return "\u{fbe7}"
        case .visionproRegular: return "\u{fbe8}"
        case .voicemailBold: return "\u{fbe9}"
        case .voicemailFilled: return "\u{fbea}"
        case .voicemailLight: return "\u{fbeb}"
        case .voicemailRegular: return "\u{fbec}"
        case .vpnBold: return "\u{fbed}"
        case .vpnFilled: return "\u{fbee}"
        case .vpnLight: return "\u{fbef}"
        case .vpnRegular: return "\u{fbf0}"
        case .vscBold: return "\u{fbf1}"
        case .vscLight: return "\u{fbf2}"
        case .vscRegular: return "\u{fbf3}"
        case .waffleMenuBold: return "\u{fbf4}"
        case .waffleMenuLight: return "\u{fbf5}"
        case .waffleMenuRegular: return "\u{fbf6}"
        case .waitingRoomBold: return "\u{fbf7}"
        case .waitingRoomLight: return "\u{fbf8}"
        case .waitingRoomRegular: return "\u{fbf9}"
        case .wallpaperBold: return "\u{fbfa}"
        case .wallpaperLight: return "\u{fbfb}"
        case .wallpaperRegular: return "\u{fbfc}"
        case .warningBadgeFilled: return "\u{fbfd}"
        case .warningBold: return "\u{fbfe}"
        case .warningFilled: return "\u{fbff}"
        case .warningLight: return "\u{fc00}"
        case .warningRegular: return "\u{fc01}"
        case .webexBoardBold: return "\u{fc02}"
        case .webexBoardLight: return "\u{fc03}"
        case .webexBoardRegular: return "\u{fc04}"
        case .webexCodecPlusBold: return "\u{fc05}"
        case .webexCodecPlusLight: return "\u{fc06}"
        case .webexCodecPlusRegular: return "\u{fc07}"
        case .webexDeskCameraBold: return "\u{fc08}"
        case .webexDeskCameraLight: return "\u{fc09}"
        case .webexDeskCameraRegular: return "\u{fc0a}"
        case .webexHelixBold: return "\u{fc0b}"
        case .webexHelixLight: return "\u{fc0c}"
        case .webexHelixRegular: return "\u{fc0d}"
        case .webexMeetingsBold: return "\u{fc0e}"
        case .webexMeetingsFilled: return "\u{fc0f}"
        case .webexMeetingsLight: return "\u{fc10}"
        case .webexMeetingsRegular: return "\u{fc11}"
        case .webexQuadCameraBold: return "\u{fc12}"
        case .webexQuadCameraLight: return "\u{fc13}"
        case .webexQuadCameraRegular: return "\u{fc14}"
        case .webexRoomKitBold: return "\u{fc15}"
        case .webexRoomKitLight: return "\u{fc16}"
        case .webexRoomKitPlusBold: return "\u{fc17}"
        case .webexRoomKitPlusLight: return "\u{fc18}"
        case .webexRoomKitPlusRegular: return "\u{fc19}"
        case .webexRoomKitRegular: return "\u{fc1a}"
        case .webexShareBold: return "\u{fc1b}"
        case .webexShareLight: return "\u{fc1c}"
        case .webexShareRegular: return "\u{fc1d}"
        case .webexTeamsBold: return "\u{fc1e}"
        case .webexTeamsFilled: return "\u{fc1f}"
        case .webexTeamsLight: return "\u{fc20}"
        case .webexTeamsNewBold: return "\u{fc21}"
        case .webexTeamsNewFilled: return "\u{fc22}"
        case .webexTeamsNewLight: return "\u{fc23}"
        case .webexTeamsNewRegular: return "\u{fc24}"
        case .webexTeamsRegular: return "\u{fc25}"
        case .webexTeamsRemoveBold: return "\u{fc26}"
        case .webexTeamsRemoveLight: return "\u{fc27}"
        case .webexTeamsRemoveRegular: return "\u{fc28}"
        case .webinarBold: return "\u{fc29}"
        case .webinarFilled: return "\u{fc2a}"
        case .webinarLight: return "\u{fc2b}"
        case .webinarRegular: return "\u{fc2c}"
        case .weeklyRecurringScheduleBold: return "\u{fc2d}"
        case .weeklyRecurringScheduleLight: return "\u{fc2e}"
        case .weeklyRecurringScheduleRegular: return "\u{fc2f}"
        case .whisperAnnouncementBold: return "\u{fc30}"
        case .whisperAnnouncementFilled: return "\u{fc31}"
        case .whisperAnnouncementLight: return "\u{fc32}"
        case .whisperAnnouncementRegular: return "\u{fc33}"
        case .whisperCoachBold: return "\u{fc34}"
        case .whisperCoachFilled: return "\u{fc35}"
        case .whisperCoachLight: return "\u{fc36}"
        case .whisperCoachRegular: return "\u{fc37}"
        case .whiteboardBold: return "\u{fc38}"
        case .whiteboardContentBold: return "\u{fc39}"
        case .whiteboardContentFilled: return "\u{fc3a}"
        case .whiteboardContentLight: return "\u{fc3b}"
        case .whiteboardContentRegular: return "\u{fc3c}"
        case .whiteboardFilled: return "\u{fc3d}"
        case .whiteboardLight: return "\u{fc3e}"
        case .whiteboardRegular: return "\u{fc3f}"
        case .widgetBold: return "\u{fc40}"
        case .widgetFilled: return "\u{fc41}"
        case .widgetLight: return "\u{fc42}"
        case .widgetRegular: return "\u{fc43}"
        case .wifiBold: return "\u{fc44}"
        case .wifiErrorBold: return "\u{fc45}"
        case .wifiErrorLight: return "\u{fc46}"
        case .wifiErrorRegular: return "\u{fc47}"
        case .wifiLight: return "\u{fc48}"
        case .wifiRegular: return "\u{fc49}"
        case .wifiSignalGoodBold: return "\u{fc4a}"
        case .wifiSignalGoodLight: return "\u{fc4b}"
        case .wifiSignalGoodRegular: return "\u{fc4c}"
        case .wifiSignalPoorBold: return "\u{fc4d}"
        case .wifiSignalPoorLight: return "\u{fc4e}"
        case .wifiSignalPoorRegular: return "\u{fc4f}"
        case .wifiSignalUnstableBold: return "\u{fc50}"
        case .wifiSignalUnstableLight: return "\u{fc51}"
        case .wifiSignalUnstableRegular: return "\u{fc52}"
        case .windowCornerScrubBold: return "\u{fc53}"
        case .windowCornerScrubLight: return "\u{fc54}"
        case .windowCornerScrubRegular: return "\u{fc55}"
        case .windowRightCornerScrubBold: return "\u{fc56}"
        case .windowRightCornerScrubLight: return "\u{fc57}"
        case .windowRightCornerScrubRegular: return "\u{fc58}"
        case .windowVerticalScrubBold: return "\u{fc59}"
        case .windowVerticalScrubLight: return "\u{fc5a}"
        case .windowVerticalScrubRegular: return "\u{fc5b}"
        case .workflowDeploymentsBold: return "\u{fc5c}"
        case .workflowDeploymentsFilled: return "\u{fc5d}"
        case .workflowDeploymentsLight: return "\u{fc5e}"
        case .workflowDeploymentsRegular: return "\u{fc5f}"
        case .workphoneBold: return "\u{fc60}"
        case .workphoneLight: return "\u{fc61}"
        case .workphoneRegular: return "\u{fc62}"
        case .zoomInBold: return "\u{fc63}"
        case .zoomInLight: return "\u{fc64}"
        case .zoomInRegular: return "\u{fc65}"
        case .zoomOutBold: return "\u{fc66}"
        case .zoomOutLight: return "\u{fc67}"
        case .zoomOutRegular: return "\u{fc68}"
