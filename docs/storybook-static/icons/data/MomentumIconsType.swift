...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .moderatorBold: return "\u{f74f}"
        case .moderatorLight: return "\u{f750}"
        case .moderatorRegular: return "\u{f751}"
        case .monitoringBold: return "\u{f752}"
        case .monitoringLight: return "\u{f753}"
        case .monitoringRegular: return "\u{f754}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f755}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f756}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f757}"
        case .moreAdrBold: return "\u{f758}"
        case .moreAdrLight: return "\u{f759}"
        case .moreAdrRegular: return "\u{f75a}"
        case .moreBold: return "\u{f75b}"
        case .moreCircleBold: return "\u{f75c}"
        case .moreCircleFilled: return "\u{f75d}"
        case .moreCircleLight: return "\u{f75e}"
        case .moreCircleRegular: return "\u{f75f}"
        case .moreLight: return "\u{f760}"
        case .moreRegular: return "\u{f761}"
        case .mouseCursorBold: return "\u{f762}"
        case .mouseCursorLight: return "\u{f763}"
        case .mouseCursorRegular: return "\u{f764}"
        case .moveCallInAdrBold: return "\u{f765}"
        case .moveCallInAdrLight: return "\u{f766}"
        case .moveCallInAdrRegular: return "\u{f767}"
        case .moveCallInIphBold: return "\u{f768}"
        case .moveCallInIphLight: return "\u{f769}"
        case .moveCallInIphRegular: return "\u{f76a}"
        case .moveCallInLaptopBold: return "\u{f76b}"
        case .moveCallInLaptopLight: return "\u{f76c}"
        case .moveCallInLaptopRegular: return "\u{f76d}"
        case .moveCallInOutAdrBold: return "\u{f76e}"
        case .moveCallInOutAdrLight: return "\u{f76f}"
        case .moveCallInOutAdrRegular: return "\u{f770}"
        case .moveCallInOutIphBold: return "\u{f771}"
        case .moveCallInOutIphLight: return "\u{f772}"
        case .moveCallInOutIphRegular: return "\u{f773}"
        case .moveCallInTabletBold: return "\u{f774}"
        case .moveCallInTabletLight: return "\u{f775}"
        case .moveCallInTabletRegular: return "\u{f776}"
        case .moveCallOutAdrBold: return "\u{f777}"
        case .moveCallOutAdrLight: return "\u{f778}"
        case .moveCallOutAdrRegular: return "\u{f779}"
        case .moveCallOutIphBold: return "\u{f77a}"
        case .moveCallOutIphLight: return "\u{f77b}"
        case .moveCallOutIphRegular: return "\u{f77c}"
        case .moveCallOutLaptopBold: return "\u{f77d}"
        case .moveCallOutLaptopLight: return "\u{f77e}"
        case .moveCallOutLaptopRegular: return "\u{f77f}"
        case .moveCallOutTabletBold: return "\u{f780}"
        case .moveCallOutTabletLight: return "\u{f781}"
        case .moveCallOutTabletRegular: return "\u{f782}"
        case .moveToScreenBold: return "\u{f783}"
        case .moveToScreenLight: return "\u{f784}"
        case .moveToScreenRegular: return "\u{f785}"
        case .msTeamsColored: return "\u{f786}"
        ...
        case .penBold: return "\u{f819}"
        case .penFilled: return "\u{f81a}"
        case .penLight: return "\u{f81b}"
        case .penRegular: return "\u{f81c}"
        case .peopleAddBold: return "\u{f81d}"
        case .peopleAddFilled: return "\u{f81e}"
        case .peopleAddLight: return "\u{f81f}"
        case .peopleAddRegular: return "\u{f820}"
        case .peopleBold: return "\u{f821}"
        case .peopleCircleBold: return "\u{f822}"
        case .peopleCircleFilled: return "\u{f823}"
        case .peopleCircleLight: return "\u{f824}"
        case .peopleCircleRegular: return "\u{f825}"
        case .peopleFilled: return "\u{f826}"
        case .peopleInsightsBold: return "\u{f827}"
        case .peopleInsightsFilled: return "\u{f828}"
        case .peopleInsightsLight: return "\u{f829}"
        case .peopleInsightsRegular: return "\u{f82a}"
        case .peopleLight: return "\u{f82b}"
        case .peopleRegular: return "\u{f82c}"
        case .phoneAlertBold: return "\u{f82d}"
        case .phoneAlertLight: return "\u{f82e}"
        case .phoneAlertRegular: return "\u{f82f}"
        case .phoneBadgeFilled: return "\u{f830}"
        case .phoneBold: return "\u{f831}"
        case .phoneFilled: return "\u{f832}"
        case .phoneLight: return "\u{f833}"
        case .phoneMutedBold: return "\u{f834}"
        case .phoneMutedLight: return "\u{f835}"
        case .phoneMutedRegular: return "\u{f836}"
        case .phonePrivateBold: return "\u{f837}"
        case .phonePrivateLight: return "\u{f838}"
        case .phonePrivateRegular: return "\u{f839}"
        case .phoneRegular: return "\u{f83a}"
        case .phoneReplyAllBold: return "\u{f83b}"
        case .phoneReplyAllLight: return "\u{f83c}"
        case .phoneReplyAllRegular: return "\u{f83d}"
        case .phoneReplyBold: return "\u{f83e}"
        case .phoneReplyLight: return "\u{f83f}"
        case .phoneReplyRegular: return "\u{f840}"
        case .pickerBold: return "\u{f841}"
        case .pickerLight: return "\u{f842}"
        case .pickerRegular: return "\u{f843}"
        case .pieChartBold: return "\u{f844}"
        case .pieChartFilled: return "\u{f845}"
        case .pieChartLight: return "\u{f846}"
        case .pieChartRegular: return "\u{f847}"
        case .pinBold: return "\u{f848}"
        case .pinFilled: return "\u{f849}"
        case .pinLight: return "\u{f84a}"
        case .pinListActivityBold: return "\u{f84b}"
        case .pinListActivityLight: return "\u{f84c}"
        case .pinListActivityRegular: return "\u{f84d}"
        case .pinListBold: return "\u{f84e}"
        case .pinListLight: return "\u{f84f}"
        case .pinListRegular: return "\u{f850}"
        case .pinMutedBold: return "\u{f851}"
        case .pinMutedFilled: return "\u{f852}"
        case .pinMutedLight: return "\u{f853}"
        case .pinMutedRegular: return "\u{f854}"
        case .pinRegular: return "\u{f855}"
        case .pipBold: return "\u{f856}"
        case .pipEnterBold: return "\u{f857}"
        case .pipEnterLight: return "\u{f858}"
        case .pipEnterRegular: return "\u{f859}"
        case .pipExitBold: return "\u{f85a}"
        case .pipExitLight: return "\u{f85b}"
        case .pipExitRegular: return "\u{f85c}"
        case .pipFilled: return "\u{f85d}"
        case .pipLight: return "\u{f85e}"
        case .pipRegular: return "\u{f85f}"
        case .placeholderBold: return "\u{f860}"
        case .placeholderFilled: return "\u{f861}"
        case .placeholderLight: return "\u{f862}"
        case .placeholderRegular: return "\u{f863}"
        case .playBold: return "\u{f864}"
        case .playCircleBold: return "\u{f865}"
        case .playCircleFilled: return "\u{f866}"
        case .playCircleLight: return "\u{f867}"
        case .playCircleRegular: return "\u{f868}"
        case .playFilled: return "\u{f869}"
        case .playLight: return "\u{f86a}"
        case .playRegular: return "\u{f86b}"
        case .plugAcBold: return "\u{f86c}"
        case .plugAcLight: return "\u{f86d}"
        case .plugAcRegular: return "\u{f86e}"
        case .plusBold: return "\u{f86f}"
        case .plusCircleBold: return "\u{f870}"
        case .plusCircleFilled: return "\u{f871}"
        case .plusCircleLight: return "\u{f872}"
        case .plusCircleRegular: return "\u{f873}"
        case .plusLight: return "\u{f874}"
        case .plusRegular: return "\u{f875}"
        case .pmrBold: return "\u{f876}"
        case .pmrFilled: return "\u{f877}"
        case .pmrLight: return "\u{f878}"
        case .pmrRegular: return "\u{f879}"
        case .pollBold: return "\u{f87a}"
        case .pollFilled: return "\u{f87b}"
        case .pollLight: return "\u{f87c}"
        case .pollRegular: return "\u{f87d}"
        case .popInBold: return "\u{f87e}"
        case .popInLight: return "\u{f87f}"
        case .popInRegular: return "\u{f880}"
        case .popOutBold: return "\u{f881}"
        case .popOutLight: return "\u{f882}"
        case .popOutRegular: return "\u{f883}"
        case .popUpBold: return "\u{f884}"
        case .popUpLight: return "\u{f885}"
        case .popUpRegular: return "\u{f886}"
        case .portraitLandscapeBold: return "\u{f887}"
        case .portraitLandscapeLight: return "\u{f888}"
        case .portraitLandscapeRegular: return "\u{f889}"
        case .powerAcBold: return "\u{f88a}"
        case .powerAcLight: return "\u{f88b}"
        case .powerAcRegular: return "\u{f88c}"
        case .powerBold: return "\u{f88d}"
        case .powerLight: return "\u{f88e}"
        case .powerRegular: return "\u{f88f}"
        case .preHeaderBold: return "\u{f890}"
        case .preHeaderLight: return "\u{f891}"
        case .preHeaderRegular: return "\u{f892}"
        case .premiumBold: return "\u{f893}"
        case .premiumLight: return "\u{f894}"
        case .premiumRegular: return "\u{f895}"
        case .presentationBold: return "\u{f896}"
        case .presentationLight: return "\u{f897}"
        case .presentationRegular: return "\u{f898}"
        case .preventDownloadBold: return "\u{f899}"
        case .preventDownloadFilled: return "\u{f89a}"
        case .preventDownloadLight: return "\u{f89b}"
        case .preventDownloadRegular: return "\u{f89c}"
        case .primaryParticipantBold: return "\u{f89d}"
        case .primaryParticipantLight: return "\u{f89e}"
        case .primaryParticipantRegular: return "\u{f89f}"
        case .printBold: return "\u{f8a0}"
        case .printLight: return "\u{f8a1}"
        case .printRegular: return "\u{f8a2}"
        case .priorityBadgeFilled: return "\u{f8a3}"
        case .priorityCircleBold: return "\u{f8a4}"
        case .priorityCircleFilled: return "\u{f8a5}"
        case .priorityCircleLight: return "\u{f8a6}"
        case .priorityCircleRegular: return "\u{f8a7}"
        case .priorityCircleTwoBold: return "\u{f8a8}"
        case .priorityCircleTwoFilled: return "\u{f8a9}"
        case .priorityCircleTwoLight: return "\u{f8aa}"
        case .priorityCircleTwoRegular: return "\u{f8ab}"
        case .privacyCircleBold: return "\u{f8ac}"
        case .privacyCircleFilled: return "\u{f8ad}"
        case .privacyCircleLight: return "\u{f8ae}"
        case .privacyCircleRegular: return "\u{f8af}"
        case .privateBold: return "\u{f8b0}"
        case .privateCircleBold: return "\u{f8b1}"
        case .privateCircleFilled: return "\u{f8b2}"
        case .privateCircleLight: return "\u{f8b3}"
        case .privateCircleRegular: return "\u{f8b4}"
        case .privateLight: return "\u{f8b5}"
        case .privateMeetingBold: return "\u{f8b6}"
        case .privateMeetingLight: return "\u{f8b7}"
        case .privateMeetingRegular: return "\u{f8b8}"
        case .privateRegular: return "\u{f8b9}"
        case .productDemoBold: return "\u{f8ba}"
        case .productDemoLight: return "\u{f8bb}"
        case .productDemoRegular: return "\u{f8bc}"
        case .proximityBold: return "\u{f8bd}"
        case .proximityLight: return "\u{f8be}"
        case .proximityMutedBold: return "\u{f8bf}"
        case .proximityMutedLight: return "\u{f8c0}"
        case .proximityMutedRegular: return "\u{f8c1}"
        case .proximityRegular: return "\u{f8c2}"
        case .proximityVideoBold: return "\u{f8c3}"
        case .proximityVideoLight: return "\u{f8c4}"
        case .proximityVideoRegular: return "\u{f8c5}"
        case .ptoPresenceBold: return "\u{f8c6}"
        case .ptoPresenceFilled: return "\u{f8c7}"
        case .ptoPresenceLight: return "\u{f8c8}"
        case .ptoPresenceRegular: return "\u{f8c9}"
        case .pullCallBold: return "\u{f8ca}"
        case .pullCallFilled: return "\u{f8cb}"
        case .pullCallLight: return "\u{f8cc}"
        case .pullCallRegular: return "\u{f8cd}"
        case .qABold: return "\u{f8ce}"
        case .qALight: return "\u{f8cf}"
        case .qARegular: return "\u{f8d0}"
        case .qrCodeBold: return "\u{f8d1}"
        case .qrCodeLight: return "\u{f8d2}"
        case .qrCodeRegular: return "\u{f8d3}"
        case .qrCodeScanBold: return "\u{f8d4}"
        case .qrCodeScanLight: return "\u{f8d5}"
        case .qrCodeScanRegular: return "\u{f8d6}"
        case .qualityBold: return "\u{f8d7}"
        case .qualityLight: return "\u{f8d8}"
        case .qualityRegular: return "\u{f8d9}"
        case .queueContactBold: return "\u{f8da}"
        case .queueContactFilled: return "\u{f8db}"
        case .queueContactLight: return "\u{f8dc}"
        case .queueContactRegular: return "\u{f8dd}"
        case .quietBold: return "\u{f8de}"
        case .quietHoursPresenceBold: return "\u{f8df}"
        case .quietHoursPresenceFilled: return "\u{f8e0}"
        case .quietHoursPresenceLight: return "\u{f8e1}"
        case .quietHoursPresenceRegular: return "\u{f8e2}"
        case .quietLight: return "\u{f8e3}"
        case .quietRegular: return "\u{f8e4}"
        case .radioButtonGroupBold: return "\u{f8e5}"
        case .radioButtonGroupLight: return "\u{f8e6}"
        case .radioButtonGroupRegular: return "\u{f8e7}"
        case .raiseHandBold: return "\u{f8e8}"
        case .raiseHandCircleFilled: return "\u{f8e9}"
        case .raiseHandFilled: return "\u{f8ea}"
        case .raiseHandLight: return "\u{f8eb}"
        case .raiseHandRegular: return "\u{f8ec}"
        case .ramBold: return "\u{f8ed}"
        case .ramLight: return "\u{f8ee}"
        case .ramRegular: return "\u{f8ef}"
        case .reactionsBold: return "\u{f8f0}"
        case .reactionsFilled: return "\u{f8f1}"
        case .reactionsLight: return "\u{f8f2}"
        case .reactionsRegular: return "\u{f8f3}"
        case .reactivateBold: return "\u{f8f4}"
        case .reactivateLight: return "\u{f8f5}"
        case .reactivateRegular: return "\u{f8f6}"
        case .receiveVoiceBold: return "\u{f8f7}"
        case .receiveVoiceFilled: return "\u{f8f8}"
        case .receiveVoiceLight: return "\u{f8f9}"
        case .receiveVoiceRegular: return "\u{f8fa}"
        case .recentsBold: return "\u{f8fb}"
        case .recentsFilled: return "\u{f8fc}"
        case .recentsLight: return "\u{f8fd}"
        case .recentsPresenceBadgeFilled: return "\u{f8fe}"
        case .recentsPresenceBold: return "\u{f8ff}"
        case .recentsPresenceFilled: return "\u{f900}"
        case .recentsPresenceLight: return "\u{f901}"
        case .recentsPresenceRegular: return "\u{f902}"
        case .recentsRegular: return "\u{f903}"
        case .recordActiveBold: return "\u{f904}"
        case .recordActiveFilled: return "\u{f905}"
        case .recordActiveLight: return "\u{f906}"
        case .recordActiveRegular: return "\u{f907}"
        case .recordBold: return "\u{f908}"
        case .recordFilled: return "\u{f909}"
        case .recordLight: return "\u{f90a}"
        case .recordPausedBold: return "\u{f90b}"
        case .recordPausedFilled: return "\u{f90c}"
        case .recordPausedLight: return "\u{f90d}"
        case .recordPausedRegular: return "\u{f90e}"
        case .recordRegular: return "\u{f90f}"
        case .recurringBold: return "\u{f910}"
        case .recurringLight: return "\u{f911}"
        case .recurringOffBold: return "\u{f912}"
        case .recurringOffLight: return "\u{f913}"
        case .recurringOffRegular: return "\u{f914}"
        case .recurringRegular: return "\u{f915}"
        case .redialBold: return "\u{f916}"
        case .redialLight: return "\u{f917}"
        case .redialRegular: return "\u{f918}"
        case .redoBold: return "\u{f919}"
        case .redoLight: return "\u{f91a}"
        case .redoRegular: return "\u{f91b}"
        case .refreshBold: return "\u{f91c}"
        case .refreshLight: return "\u{f91d}"
        case .refreshRegular: return "\u{f91e}"
        case .remoteDesktopControlBold: return "\u{f91f}"
        case .remoteDesktopControlFilled: return "\u{f920}"
        case .remoteDesktopControlLight: return "\u{f921}"
        case .remoteDesktopControlRegular: return "\u{f922}"
        case .removeBold: return "\u{f923}"
        case .removeFilled: return "\u{f924}"
        case .removeLight: return "\u{f925}"
        case .removeRegular: return "\u{f926}"
        case .replyBold: return "\u{f927}"
        case .replyFilled: return "\u{f928}"
        case .replyLight: return "\u{f929}"
        case .replyListBold: return "\u{f92a}"
        case .replyListLight: return "\u{f92b}"
        case .replyListRegular: return "\u{f92c}"
        case .replyPrivatelyBold: return "\u{f92d}"
        case .replyPrivatelyLight: return "\u{f92e}"
        case .replyPrivatelyRegular: return "\u{f92f}"
        case .replyRegular: return "\u{f930}"
        case .resetBold: return "\u{f931}"
        case .resetLight: return "\u{f932}"
        case .resetRegular: return "\u{f933}"
        case .resizeCornerBold: return "\u{f934}"
        case .resizeCornerLight: return "\u{f935}"
        case .resizeCornerRegular: return "\u{f936}"
        case .responsiveMobileBold: return "\u{f937}"
        case .responsiveMobileLight: return "\u{f938}"
        case .responsiveMobileRegular: return "\u{f939}"
        case .restartBold: return "\u{f93a}"
        case .restartLight: return "\u{f93b}"
        case .restartRegular: return "\u{f93c}"
        case .retrieveCallBold: return "\u{f93d}"
        case .retrieveCallFilled: return "\u{f93e}"
        case .retrieveCallLight: return "\u{f93f}"
        case .retrieveCallRegular: return "\u{f940}"
        case .returnBold: return "\u{f941}"
        case .returnLight: return "\u{f942}"
        case .returnRegular: return "\u{f943}"
        case .rewindTenSecBold: return "\u{f944}"
        case .rewindTenSecLight: return "\u{f945}"
        case .rewindTenSecRegular: return "\u{f946}"
        case .ringtoneBold: return "\u{f947}"
        case .ringtoneLight: return "\u{f948}"
        case .ringtoneRegular: return "\u{f949}"
        case .roomCalendarBold: return "\u{f94a}"
        case .roomCalendarLight: return "\u{f94b}"
        case .roomCalendarRegular: return "\u{f94c}"
        case .roomLightsBold: return "\u{f94d}"
        case .roomLightsFilled: return "\u{f94e}"
        case .roomLightsLight: return "\u{f94f}"
        case .roomLightsRegular: return "\u{f950}"
        case .rotateContentBold: return "\u{f951}"
        case .rotateContentFilled: return "\u{f952}"
        case .rotateContentLight: return "\u{f953}"
        case .rotateContentRegular: return "\u{f954}"
        case .rssBold: return "\u{f955}"
        case .rssFilled: return "\u{f956}"
        case .rssLight: return "\u{f957}"
        case .rssRegular: return "\u{f958}"
        case .ruleBasedBold: return "\u{f959}"
        case .ruleBasedLight: return "\u{f95a}"
        case .ruleBasedRegular: return "\u{f95b}"
        case .runningApplicationBold: return "\u{f95c}"
        case .runningApplicationFilled: return "\u{f95d}"
        case .runningApplicationLight: return "\u{f95e}"
        case .runningApplicationRegular: return "\u{f95f}"
        case .saveBold: return "\u{f960}"
        case .saveLight: return "\u{f961}"
        case .saveRegular: return "\u{f962}"
        case .saveTranscriptBold: return "\u{f963}"
        case .saveTranscriptFilled: return "\u{f964}"
        case .saveTranscriptLight: return "\u{f965}"
        case .saveTranscriptRegular: return "\u{f966}"
        case .scanBold: return "\u{f967}"
        case .scanLight: return "\u{f968}"
        case .scanRegular: return "\u{f969}"
        case .scheduleSendBold: return "\u{f96a}"
        case .scheduleSendFilled: return "\u{f96b}"
        case .scheduleSendLight: return "\u{f96c}"
        case .scheduleSendRegular: return "\u{f96d}"
        case .scheduleWinnerBold: return "\u{f96e}"
        case .scheduleWinnerFilled: return "\u{f96f}"
        case .scheduleWinnerLight: return "\u{f970}"
        case .scheduleWinnerRegular: return "\u{f971}"
        case .schedulerAvailableBold: return "\u{f972}"
        case .schedulerAvailableLight: return "\u{f973}"
        case .schedulerAvailableRegular: return "\u{f974}"
        case .schedulerNotWorkingHoursBold: return "\u{f975}"
        case .schedulerNotWorkingHoursLight: return "\u{f976}"
        case .schedulerNotWorkingHoursRegular: return "\u{f977}"
        case .schedulerUnavailableBold: return "\u{f978}"
        case .schedulerUnavailableLight: return "\u{f979}"
        case .schedulerUnavailableRegular: return "\u{f97a}"
        case .schedulerUnknownBold: return "\u{f97b}"
        case .schedulerUnknownLight: return "\u{f97c}"
        case .schedulerUnknownRegular: return "\u{f97d}"
        case .screenshotBold: return "\u{f97e}"
        case .screenshotDocBold: return "\u{f97f}"
        case .screenshotDocFilled: return "\u{f980}"
        case .screenshotDocLight: return "\u{f981}"
        case .screenshotDocRegular: return "\u{f982}"
        case .screenshotLight: return "\u{f983}"
        case .screenshotRegular: return "\u{f984}"
        case .searchBold: return "\u{f985}"
        case .searchFilled: return "\u{f986}"
        case .searchLight: return "\u{f987}"
        case .searchRegular: return "\u{f988}"
        case .secondaryArrowBold: return "\u{f989}"
        case .secondaryArrowLight: return "\u{f98a}"
        case .secondaryArrowRegular: return "\u{f98b}"
        case .secureCallLockBold: return "\u{f98c}"
        case .secureCallLockFilled: return "\u{f98d}"
        case .secureCallLockLight: return "\u{f98e}"
        case .secureCallLockRegular: return "\u{f98f}"
        case .secureCallShieldBold: return "\u{f990}"
        case .secureCallShieldFilled: return "\u{f991}"
        case .secureCallShieldLight: return "\u{f992}"
        case .secureCallShieldRegular: return "\u{f993}"
        case .secureCircleBold: return "\u{f994}"
        case .secureCircleFilled: return "\u{f995}"
        case .secureCircleLight: return "\u{f996}"
        case .secureCircleRegular: return "\u{f997}"
        case .secureLockBold: return "\u{f998}"
        case .secureLockFilled: return "\u{f999}"
        case .secureLockLight: return "\u{f99a}"
        case .secureLockRegular: return "\u{f99b}"
        case .segmentExcludeFilled: return "\u{f99c}"
        case .segmentFilterFilled: return "\u{f99d}"
        case .segmentIncludeFilled: return "\u{f99e}"
        case .selectAllBold: return "\u{f99f}"
        case .selectAllFilled: return "\u{f9a0}"
        case .selectAllLight: return "\u{f9a1}"
        case .selectAllRegular: return "\u{f9a2}"
        case .selectionBold: return "\u{f9a3}"
        case .selectionLight: return "\u{f9a4}"
        case .selectionRegular: return "\u{f9a5}"
        case .sendBold: return "\u{f9a6}"
        case .sendFilled: return "\u{f9a7}"
        case .sendLight: return "\u{f9a8}"
        case .sendRegular: return "\u{f9a9}"
        case .sendVoiceBold: return "\u{f9aa}"
        case .sendVoiceFilled: return "\u{f9ab}"
        case .sendVoiceLight: return "\u{f9ac}"
        case .sendVoiceRegular: return "\u{f9ad}"
        case .serverBold: return "\u{f9ae}"
        case .serverErrorBold: return "\u{f9af}"
        case .serverErrorLight: return "\u{f9b0}"
        case .serverErrorRegular: return "\u{f9b1}"
        case .serverLight: return "\u{f9b2}"
        case .serverRegular: return "\u{f9b3}"
        case .servicesBold: return "\u{f9b4}"
        case .servicesLight: return "\u{f9b5}"
        case .servicesRegular: return "\u{f9b6}"
        case .setVariableBold: return "\u{f9b7}"
        case .setVariableLight: return "\u{f9b8}"
        case .setVariableRegular: return "\u{f9b9}"
        case .settingsBold: return "\u{f9ba}"
        case .settingsFilled: return "\u{f9bb}"
        case .settingsLight: return "\u{f9bc}"
        case .settingsRegular: return "\u{f9bd}"
        case .setupAssistantBold: return "\u{f9be}"
        case .setupAssistantLight: return "\u{f9bf}"
        case .setupAssistantRegular: return "\u{f9c0}"
        case .sftpBold: return "\u{f9c1}"
        case .sftpLight: return "\u{f9c2}"
        case .sftpRegular: return "\u{f9c3}"
        case .shapeCircleBold: return "\u{f9c4}"
        case .shapeCircleFilled: return "\u{f9c5}"
        case .shapeCircleLight: return "\u{f9c6}"
        case .shapeCircleMdFilled: return "\u{f9c7}"
        case .shapeCircleRegular: return "\u{f9c8}"
        case .shapeCircleSmFilled: return "\u{f9c9}"
        case .shapeDiagonalLineBold: return "\u{f9ca}"
        case .shapeDiagonalLineLight: return "\u{f9cb}"
        case .shapeDiagonalLineRegular: return "\u{f9cc}"
        case .shapeDiamondBold: return "\u{f9cd}"
        case .shapeDiamondFilled: return "\u{f9ce}"
        case .shapeDiamondLight: return "\u{f9cf}"
        case .shapeDiamondRegular: return "\u{f9d0}"
        case .shapeOvalBold: return "\u{f9d1}"
        case .shapeOvalLight: return "\u{f9d2}"
        case .shapeOvalRegular: return "\u{f9d3}"
        case .shapeSquareBold: return "\u{f9d4}"
        case .shapeSquareFilled: return "\u{f9d5}"
        case .shapeSquareLight: return "\u{f9d6}"
        case .shapeSquareRegular: return "\u{f9d7}"
        case .shapeTriangleBold: return "\u{f9d8}"
        case .shapeTriangleFilled: return "\u{f9d9}"
        case .shapeTriangleLight: return "\u{f9da}"
        case .shapeTriangleRegular: return "\u{f9db}"
        case .shapesBold: return "\u{f9dc}"
        case .shapesLight: return "\u{f9dd}"
        case .shapesRegular: return "\u{f9de}"
        case .shareCNativeAdrBold: return "\u{f9df}"
        case .shareCNativeAdrFilled: return "\u{f9e0}"
        case .shareCNativeAdrLight: return "\u{f9e1}"
        case .shareCNativeAdrRegular: return "\u{f9e2}"
        case .shareCNativeIphBold: return "\u{f9e3}"
        case .shareCNativeIphLight: return "\u{f9e4}"
        case .shareCNativeIphRegular: return "\u{f9e5}"
        case .shareContentOnDeviceBold: return "\u{f9e6}"
        case .shareContentOnDeviceLight: return "\u{f9e7}"
        case .shareContentOnDeviceRegular: return "\u{f9e8}"
        case .shareScreenAddBold: return "\u{f9e9}"
        case .shareScreenAddLight: return "\u{f9ea}"
        case .shareScreenAddRegular: return "\u{f9eb}"
        case .shareScreenBadgeFilled: return "\u{f9ec}"
        case .shareScreenBold: return "\u{f9ed}"
        case .shareScreenFilled: return "\u{f9ee}"
        case .shareScreenLight: return "\u{f9ef}"
        case .shareScreenRegular: return "\u{f9f0}"
        case .shareSpaceBold: return "\u{f9f1}"
        case .shareSpaceLight: return "\u{f9f2}"
        case .shareSpaceRegular: return "\u{f9f3}"
        case .shieldBold: return "\u{f9f4}"
        case .shieldLight: return "\u{f9f5}"
        case .shieldRegular: return "\u{f9f6}"
        case .shoppingCartBold: return "\u{f9f7}"
        case .shoppingCartFilled: return "\u{f9f8}"
        case .shoppingCartLight: return "\u{f9f9}"
        case .shoppingCartRegular: return "\u{f9fa}"
        case .shortTextBoxBold: return "\u{f9fb}"
        case .shortTextBoxLight: return "\u{f9fc}"
        case .shortTextBoxRegular: return "\u{f9fd}"
        case .showBold: return "\u{f9fe}"
        case .showFilled: return "\u{f9ff}"
        case .showLight: return "\u{fa00}"
        case .showRegular: return "\u{fa01}"
        case .signInBold: return "\u{fa02}"
        case .signInFilled: return "\u{fa03}"
        case .signInForcedBold: return "\u{fa04}"
        case .signInForcedLight: return "\u{fa05}"
        case .signInForcedRegular: return "\u{fa06}"
        case .signInLight: return "\u{fa07}"
        case .signInRegular: return "\u{fa08}"
        case .signLangIntBold: return "\u{fa09}"
        case .signLangIntLight: return "\u{fa0a}"
        case .signLangIntRegular: return "\u{fa0b}"
        case .signOutBold: return "\u{fa0c}"
        case .signOutLight: return "\u{fa0d}"
        case .signOutRegular: return "\u{fa0e}"
        case .signalFourBold: return "\u{fa0f}"
        case .signalFourLight: return "\u{fa10}"
        case .signalFourRegular: return "\u{fa11}"
        case .signalOneBold: return "\u{fa12}"
        case .signalOneLight: return "\u{fa13}"
        case .signalOneRegular: return "\u{fa14}"
        case .signalThreeBold: return "\u{fa15}"
        case .signalThreeLight: return "\u{fa16}"
        case .signalThreeRegular: return "\u{fa17}"
        case .signalTwoBold: return "\u{fa18}"
        case .signalTwoLight: return "\u{fa19}"
        case .signalTwoRegular: return "\u{fa1a}"
        case .signalZeroBold: return "\u{fa1b}"
        case .signalZeroLight: return "\u{fa1c}"
        case .signalZeroRegular: return "\u{fa1d}"
        case .simplePromotionBold: return "\u{fa1e}"
        case .simplePromotionLight: return "\u{fa1f}"
        case .simplePromotionRegular: return "\u{fa20}"
        case .singleNumberReachBold: return "\u{fa21}"
        case .singleNumberReachLight: return "\u{fa22}"
        case .singleNumberReachRegular: return "\u{fa23}"
        case .sipRegistrationInProgressBold: return "\u{fa24}"
        case .sipRegistrationInProgressFilled: return "\u{fa25}"
        case .sipRegistrationInProgressLight: return "\u{fa26}"
        case .sipRegistrationInProgressRegular: return "\u{fa27}"
        case .skipBold: return "\u{fa28}"
        case .skipBwBold: return "\u{fa29}"
        case .skipBwFilled: return "\u{fa2a}"
        case .skipBwLight: return "\u{fa2b}"
        case .skipBwRegular: return "\u{fa2c}"
        case .skipFwBold: return "\u{fa2d}"
        case .skipFwFilled: return "\u{fa2e}"
        case .skipFwLight: return "\u{fa2f}"
        case .skipFwRegular: return "\u{fa30}"
        case .skipLight: return "\u{fa31}"
        case .skipRegular: return "\u{fa32}"
        case .slidoColored: return "\u{fa33}"
        case .smsInboundBold: return "\u{fa34}"
        case .smsInboundLight: return "\u{fa35}"
        case .smsInboundRegular: return "\u{fa36}"
        case .smsMessageBold: return "\u{fa37}"
        case .smsMessageFilled: return "\u{fa38}"
        case .smsMessageLight: return "\u{fa39}"
        case .smsMessageRegular: return "\u{fa3a}"
        case .smsUnreadBold: return "\u{fa3b}"
        case .smsUnreadLight: return "\u{fa3c}"
        case .smsUnreadRegular: return "\u{fa3d}"
        case .socialAlexaColored: return "\u{fa3e}"
        case .socialAlexa: return "\u{fa3f}"
        case .socialFacebookColored: return "\u{fa40}"
        case .socialFacebook: return "\u{fa41}"
        case .socialFbmessengerColored: return "\u{fa42}"
        case .socialFbmessenger: return "\u{fa43}"
        case .socialInstagram: return "\u{fa44}"
        case .socialLineColored: return "\u{fa45}"
        case .socialLine: return "\u{fa46}"
        case .socialMicrosoftColored: return "\u{fa47}"
        case .socialMicrosoft: return "\u{fa48}"
        case .socialMmsColoredGold: return "\u{fa49}"
        case .socialMms: return "\u{fa4a}"
        case .socialRcsColored: return "\u{fa4b}"
        case .socialRcs: return "\u{fa4c}"
        case .socialSmsColoredMint: return "\u{fa4d}"
        case .socialSmsOutgoing: return "\u{fa4e}"
        case .socialSms: return "\u{fa4f}"
        case .socialTelegramColored: return "\u{fa50}"
        case .socialTelegram: return "\u{fa51}"
        case .socialViberColored: return "\u{fa52}"
        case .socialViber: return "\u{fa53}"
        case .socialWechatColored: return "\u{fa54}"
        case .socialWechat: return "\u{fa55}"
        case .socialWhatsappColored: return "\u{fa56}"
        case .socialWhatsapp: return "\u{fa57}"
        case .socialX: return "\u{fa58}"
        case .sortAscendingBold: return "\u{fa59}"
        case .sortAscendingLight: return "\u{fa5a}"
        case .sortAscendingRegular: return "\u{fa5b}"
        case .sortDescendingBold: return "\u{fa5c}"
        case .sortDescendingLight: return "\u{fa5d}"
        case .sortDescendingRegular: return "\u{fa5e}"
        case .soundDefaultBold: return "\u{fa5f}"
        case .soundDefaultLight: return "\u{fa60}"
        case .soundDefaultRegular: return "\u{fa61}"
        case .sparkleBold: return "\u{fa62}"
        case .sparkleFilled: return "\u{fa63}"
        case .sparkleLight: return "\u{fa64}"
        case .sparkleRegular: return "\u{fa65}"
        case .speakerBold: return "\u{fa66}"
        case .speakerDisconnectedBold: return "\u{fa67}"
        case .speakerDisconnectedFilled: return "\u{fa68}"
        case .speakerDisconnectedLight: return "\u{fa69}"
        case .speakerDisconnectedRegular: return "\u{fa6a}"
        case .speakerFilled: return "\u{fa6b}"
        case .speakerLight: return "\u{fa6c}"
        case .speakerMutedBold: return "\u{fa6d}"
        case .speakerMutedFilled: return "\u{fa6e}"
        case .speakerMutedLight: return "\u{fa6f}"
        case .speakerMutedRegular: return "\u{fa70}"
        case .speakerOffBold: return "\u{fa71}"
        case .speakerOffFilled: return "\u{fa72}"
        case .speakerOffLight: return "\u{fa73}"
        case .speakerOffRegular: return "\u{fa74}"
        case .speakerOnBold: return "\u{fa75}"
        case .speakerOnLight: return "\u{fa76}"
        case .speakerOnRegular: return "\u{fa77}"
        case .speakerRegular: return "\u{fa78}"
        case .speakerTurnDownBold: return "\u{fa79}"
        case .speakerTurnDownFilled: return "\u{fa7a}"
        case .speakerTurnDownLight: return "\u{fa7b}"
        case .speakerTurnDownRegular: return "\u{fa7c}"
        case .speakerTurnUpBold: return "\u{fa7d}"
        case .speakerTurnUpFilled: return "\u{fa7e}"
        case .speakerTurnUpLight: return "\u{fa7f}"
        case .speakerTurnUpRegular: return "\u{fa80}"
        case .speedDialBold: return "\u{fa81}"
        case .speedDialFilled: return "\u{fa82}"
        case .speedDialLight: return "\u{fa83}"
        case .speedDialRegular: return "\u{fa84}"
        case .spellCheckerBold: return "\u{fa85}"
        case .spellCheckerLight: return "\u{fa86}"
        case .spellCheckerRegular: return "\u{fa87}"
        case .spinnerBold: return "\u{fa88}"
        case .spinnerInProgressBold: return "\u{fa89}"
        case .spinnerInProgressLight: return "\u{fa8a}"
        case .spinnerInProgressRegular: return "\u{fa8b}"
        case .spinnerLight: return "\u{fa8c}"
        case .spinnerRegular: return "\u{fa8d}"
        case .splitViewBold: return "\u{fa8e}"
        case .splitViewLight: return "\u{fa8f}"
        case .splitViewRegular: return "\u{fa90}"
        case .stackedAreaChartBold: return "\u{fa91}"
        case .stackedAreaChartFilled: return "\u{fa92}"
        case .stackedAreaChartFullBold: return "\u{fa93}"
        case .stackedAreaChartFullFilled: return "\u{fa94}"
        case .stackedAreaChartFullLight: return "\u{fa95}"
        case .stackedAreaChartFullRegular: return "\u{fa96}"
        case .stackedAreaChartLight: return "\u{fa97}"
        case .stackedAreaChartRegular: return "\u{fa98}"
        case .stackedBarChartBold: return "\u{fa99}"
        case .stackedBarChartFilled: return "\u{fa9a}"
        case .stackedBarChartFullBold: return "\u{fa9b}"
        case .stackedBarChartFullFilled: return "\u{fa9c}"
        case .stackedBarChartFullLight: return "\u{fa9d}"
        case .stackedBarChartFullRegular: return "\u{fa9e}"
        case .stackedBarChartLight: return "\u{fa9f}"
        case .stackedBarChartRegular: return "\u{faa0}"
        case .startChatBold: return "\u{faa1}"
        case .startChatLight: return "\u{faa2}"
        case .startChatRegular: return "\u{faa3}"
        case .stethoscopeBold: return "\u{faa4}"
        case .stethoscopeLight: return "\u{faa5}"
        case .stethoscopeRegular: return "\u{faa6}"
        case .stickersBold: return "\u{faa7}"
        case .stickersLight: return "\u{faa8}"
        case .stickersRegular: return "\u{faa9}"
        case .stickiesBold: return "\u{faaa}"
        case .stickiesLight: return "\u{faab}"
        case .stickiesRegular: return "\u{faac}"
        case .stopBold: return "\u{faad}"
        case .stopCircleBold: return "\u{faae}"
        case .stopCircleFilled: return "\u{faaf}"
        case .stopCircleLight: return "\u{fab0}"
        case .stopCircleRegular: return "\u{fab1}"
        case .stopContentShareBold: return "\u{fab2}"
        case .stopContentShareLight: return "\u{fab3}"
        case .stopContentShareRegular: return "\u{fab4}"
        case .stopFilled: return "\u{fab5}"
        case .stopLight: return "\u{fab6}"
        case .stopRegular: return "\u{fab7}"
        case .storedInfoBold: return "\u{fab8}"
        case .storedInfoFilled: return "\u{fab9}"
        case .storedInfoLight: return "\u{faba}"
        case .storedInfoRegular: return "\u{fabb}"
        case .streamingBold: return "\u{fabc}"
        case .streamingLight: return "\u{fabd}"
        case .streamingRegular: return "\u{fabe}"
        case .strikethroughBold: return "\u{fabf}"
        case .strikethroughFilled: return "\u{fac0}"
        case .strikethroughLight: return "\u{fac1}"
        case .strikethroughRegular: return "\u{fac2}"
        case .studioModeBold: return "\u{fac3}"
        case .studioModeLight: return "\u{fac4}"
        case .studioModeRegular: return "\u{fac5}"
        case .subscriptBold: return "\u{fac6}"
        case .subscriptLight: return "\u{fac7}"
        case .subscriptRegular: return "\u{fac8}"
        case .superscriptBold: return "\u{fac9}"
        case .superscriptLight: return "\u{faca}"
        case .superscriptRegular: return "\u{facb}"
        case .surveyBold: return "\u{facc}"
        case .surveyFilled: return "\u{facd}"
        case .surveyLight: return "\u{face}"
        case .surveyRegular: return "\u{facf}"
        case .swiftmatchColored: return "\u{fad0}"
        case .swiftmatch: return "\u{fad1}"
        case .sxEightyCodecBold: return "\u{fad2}"
        case .sxEightyCodecLight: return "\u{fad3}"
        case .sxEightyCodecRegular: return "\u{fad4}"
        case .sxTenBold: return "\u{fad5}"
        case .sxTenLight: return "\u{fad6}"
        case .sxTenRegular: return "\u{fad7}"
        case .sxTwentyBold: return "\u{fad8}"
        case .sxTwentyLight: return "\u{fad9}"
        case .sxTwentyRegular: return "\u{fada}"
        case .tableBold: return "\u{fadb}"
        case .tableLight: return "\u{fadc}"
        case .tableRegular: return "\u{fadd}"
        case .tabletBold: return "\u{fade}"
        case .tabletLight: return "\u{fadf}"
        case .tabletRegular: return "\u{fae0}"
        case .tabsBold: return "\u{fae1}"
        case .tabsLight: return "\u{fae2}"
        case .tabsRegular: return "\u{fae3}"
        case .tagBold: return "\u{fae4}"
        case .tagLight: return "\u{fae5}"
        case .tagRegular: return "\u{fae6}"
        case .tapBold: return "\u{fae7}"
        case .tapFilled: return "\u{fae8}"
        case .tapLight: return "\u{fae9}"
        case .tapRegular: return "\u{faea}"
        case .telepresenceAlertBold: return "\u{faeb}"
        case .telepresenceAlertLight: return "\u{faec}"
        case .telepresenceAlertMutedBold: return "\u{faed}"
        case .telepresenceAlertMutedLight: return "\u{faee}"
        case .telepresenceAlertMutedRegular: return "\u{faef}"
        case .telepresenceAlertRegular: return "\u{faf0}"
        case .telepresenceBold: return "\u{faf1}"
        case .telepresenceIxFiveThousandBold: return "\u{faf2}"
        case .telepresenceIxFiveThousandLight: return "\u{faf3}"
        case .telepresenceIxFiveThousandRegular: return "\u{faf4}"
        case .telepresenceLight: return "\u{faf5}"
        case .telepresenceMutedBold: return "\u{faf6}"
        case .telepresenceMutedLight: return "\u{faf7}"
        case .telepresenceMutedRegular: return "\u{faf8}"
        case .telepresencePrivateBold: return "\u{faf9}"
        case .telepresencePrivateLight: return "\u{fafa}"
        case .telepresencePrivateRegular: return "\u{fafb}"
        case .telepresenceRegular: return "\u{fafc}"
        case .temperatureBold: return "\u{fafd}"
        case .temperatureLight: return "\u{fafe}"
        case .temperatureRegular: return "\u{faff}"
        case .testTubeBold: return "\u{fb00}"
        case .testTubeFilled: return "\u{fb01}"
        case .testTubeLight: return "\u{fb02}"
        case .testTubeRegular: return "\u{fb03}"
        case .textAlignCenterBold: return "\u{fb04}"
        case .textAlignCenterFilled: return "\u{fb05}"
        case .textAlignCenterLight: return "\u{fb06}"
        case .textAlignCenterRegular: return "\u{fb07}"
        case .textAlignLeftBold: return "\u{fb08}"
        case .textAlignLeftFilled: return "\u{fb09}"
        case .textAlignLeftLight: return "\u{fb0a}"
        case .textAlignLeftRegular: return "\u{fb0b}"
        case .textAlignRightBold: return "\u{fb0c}"
        case .textAlignRightFilled: return "\u{fb0d}"
        case .textAlignRightLight: return "\u{fb0e}"
        case .textAlignRightRegular: return "\u{fb0f}"
        case .textBold: return "\u{fb10}"
        case .textBoxCursorLight: return "\u{fb11}"
        case .textCodeBlockBold: return "\u{fb12}"
        case .textCodeBlockLight: return "\u{fb13}"
        case .textCodeBlockRegular: return "\u{fb14}"
        case .textHighlightBold: return "\u{fb15}"
        case .textHighlightFilled: return "\u{fb16}"
        case .textHighlightLight: return "\u{fb17}"
        case .textHighlightRegular: return "\u{fb18}"
        case .textLight: return "\u{fb19}"
        case .textRegular: return "\u{fb1a}"
        case .threeColumnBold: return "\u{fb1b}"
        case .threeColumnLight: return "\u{fb1c}"
        case .threeColumnRegular: return "\u{fb1d}"
        case .threeDObjectBold: return "\u{fb1e}"
        case .threeDObjectLight: return "\u{fb1f}"
        case .threeDObjectRegular: return "\u{fb20}"
        case .timeExclusionBold: return "\u{fb21}"
        case .timeExclusionLight: return "\u{fb22}"
        case .timeExclusionRegular: return "\u{fb23}"
        case .tooFastBold: return "\u{fb24}"
        case .tooFastLight: return "\u{fb25}"
        case .tooFastRegular: return "\u{fb26}"
        case .tooSlowBold: return "\u{fb27}"
        case .tooSlowLight: return "\u{fb28}"
        case .tooSlowRegular: return "\u{fb29}"
        case .toolsBold: return "\u{fb2a}"
        case .toolsFilled: return "\u{fb2b}"
        case .toolsLight: return "\u{fb2c}"
        case .toolsRegular: return "\u{fb2d}"
        case .touchTenBold: return "\u{fb2e}"
        case .touchTenLight: return "\u{fb2f}"
        case .touchTenRegular: return "\u{fb30}"
        case .transcriptBold: return "\u{fb31}"
        case .transcriptFilled: return "\u{fb32}"
        case .transcriptLight: return "\u{fb33}"
        case .transcriptRegular: return "\u{fb34}"
        case .translateBold: return "\u{fb35}"
        case .translateLight: return "\u{fb36}"
        case .translateRegular: return "\u{fb37}"
        case .trendingBold: return "\u{fb38}"
        case .trendingLight: return "\u{fb39}"
        case .trendingRegular: return "\u{fb3a}"
        case .trimBold: return "\u{fb3b}"
        case .trimLight: return "\u{fb3c}"
        case .trimRegular: return "\u{fb3d}"
        case .twoColumnBold: return "\u{fb3e}"
        case .twoColumnLight: return "\u{fb3f}"
        case .twoColumnRegular: return "\u{fb40}"
        case .twoWayVoiceStreamBold: return "\u{fb41}"
        case .twoWayVoiceStreamFilled: return "\u{fb42}"
        case .twoWayVoiceStreamLight: return "\u{fb43}"
        case .twoWayVoiceStreamRegular: return "\u{fb44}"
        case .ucmCloudBold: return "\u{fb45}"
        case .ucmCloudLight: return "\u{fb46}"
        case .ucmCloudRegular: return "\u{fb47}"
        case .underlineBold: return "\u{fb48}"
        case .underlineFilled: return "\u{fb49}"
        case .underlineLight: return "\u{fb4a}"
        case .underlineRegular: return "\u{fb4b}"
        case .undoBold: return "\u{fb4c}"
        case .undoLight: return "\u{fb4d}"
        case .undoRegular: return "\u{fb4e}"
        case .unlinkBold: return "\u{fb4f}"
        case .unlinkLight: return "\u{fb50}"
        case .unlinkRegular: return "\u{fb51}"
        case .unreadBold: return "\u{fb52}"
        case .unreadFilled: return "\u{fb53}"
        case .unreadLight: return "\u{fb54}"
        case .unreadRegular: return "\u{fb55}"
        case .unsecureUnlockedBold: return "\u{fb56}"
        case .unsecureUnlockedFilled: return "\u{fb57}"
        case .unsecureUnlockedLight: return "\u{fb58}"
        case .unsecureUnlockedRegular: return "\u{fb59}"
        case .unsortedBold: return "\u{fb5a}"
        case .unsortedLight: return "\u{fb5b}"
        case .unsortedRegular: return "\u{fb5c}"
        case .updateFileShareBold: return "\u{fb5d}"
        case .updateFileShareLight: return "\u{fb5e}"
        case .updateFileShareRegular: return "\u{fb5f}"
        case .uploadBold: return "\u{fb60}"
        case .uploadImageBold: return "\u{fb61}"
        case .uploadImageLight: return "\u{fb62}"
        case .uploadImageRegular: return "\u{fb63}"
        case .uploadLight: return "\u{fb64}"
        case .uploadRegular: return "\u{fb65}"
        case .urgentVoicemailBold: return "\u{fb66}"
        case .urgentVoicemailFilled: return "\u{fb67}"
        case .usbBold: return "\u{fb68}"
        case .usbHeadsetBold: return "\u{fb69}"
        case .usbHeadsetLight: return "\u{fb6a}"
        case .usbHeadsetMutedBold: return "\u{fb6b}"
        case .usbHeadsetMutedLight: return "\u{fb6c}"
        case .usbHeadsetMutedRegular: return "\u{fb6d}"
        case .usbHeadsetRegular: return "\u{fb6e}"
        case .usbLight: return "\u{fb6f}"
        case .usbRegular: return "\u{fb70}"
        case .userBold: return "\u{fb71}"
        case .userDeactivateBold: return "\u{fb72}"
        case .userDeactivateLight: return "\u{fb73}"
        case .userDeactivateRegular: return "\u{fb74}"
        case .userLight: return "\u{fb75}"
        case .userRegular: return "\u{fb76}"
        case .videoBlurBold: return "\u{fb77}"
        case .videoBlurFilled: return "\u{fb78}"
        case .videoBlurLight: return "\u{fb79}"
        case .videoBlurRegular: return "\u{fb7a}"
        case .videoBold: return "\u{fb7b}"
        case .videoEffectBold: return "\u{fb7c}"
        case .videoEffectFilled: return "\u{fb7d}"
        case .videoEffectLight: return "\u{fb7e}"
        case .videoEffectRegular: return "\u{fb7f}"
        case .videoFilled: return "\u{fb80}"
        case .videoLayoutBold: return "\u{fb81}"
        case .videoLayoutEqualBold: return "\u{fb82}"
        case .videoLayoutEqualDualBold: return "\u{fb83}"
        case .videoLayoutEqualDualLight: return "\u{fb84}"
        case .videoLayoutEqualDualRegular: return "\u{fb85}"
        case .videoLayoutEqualFilled: return "\u{fb86}"
        case .videoLayoutEqualLight: return "\u{fb87}"
        case .videoLayoutEqualRegular: return "\u{fb88}"
        case .videoLayoutFilled: return "\u{fb89}"
        case .videoLayoutLight: return "\u{fb8a}"
        case .videoLayoutOverlayBold: return "\u{fb8b}"
        case .videoLayoutOverlayFilled: return "\u{fb8c}"
        case .videoLayoutOverlayLight: return "\u{fb8d}"
        case .videoLayoutOverlayRegular: return "\u{fb8e}"
        case .videoLayoutPresenterDominantBold: return "\u{fb8f}"
        case .videoLayoutPresenterDominantLight: return "\u{fb90}"
        case .videoLayoutPresenterDominantRegular: return "\u{fb91}"
        case .videoLayoutProminentBold: return "\u{fb92}"
        case .videoLayoutProminentFilled: return "\u{fb93}"
        case .videoLayoutProminentLight: return "\u{fb94}"
        case .videoLayoutProminentRegular: return "\u{fb95}"
        case .videoLayoutRegular: return "\u{fb96}"
        case .videoLayoutShareDominantBold: return "\u{fb97}"
        case .videoLayoutShareDominantLight: return "\u{fb98}"
        case .videoLayoutShareDominantRegular: return "\u{fb99}"
        case .videoLayoutSingleBold: return "\u{fb9a}"
        case .videoLayoutSingleFilled: return "\u{fb9b}"
        case .videoLayoutSingleLight: return "\u{fb9c}"
        case .videoLayoutSingleRegular: return "\u{fb9d}"
        case .videoLayoutStackBold: return "\u{fb9e}"
        case .videoLayoutStackFilled: return "\u{fb9f}"
        case .videoLayoutStackLight: return "\u{fba0}"
        case .videoLayoutStackRegular: return "\u{fba1}"
        case .videoLayoutVideoDominantBold: return "\u{fba2}"
        case .videoLayoutVideoDominantFilled: return "\u{fba3}"
        case .videoLayoutVideoDominantLight: return "\u{fba4}"
        case .videoLayoutVideoDominantRegular: return "\u{fba5}"
        case .videoLight: return "\u{fba6}"
        case .videoPlusBold: return "\u{fba7}"
        case .videoPlusFilled: return "\u{fba8}"
        case .videoPlusLight: return "\u{fba9}"
        case .videoPlusRegular: return "\u{fbaa}"
        case .videoRegular: return "\u{fbab}"
        case .videoSpeakerTrackBold: return "\u{fbac}"
        case .videoSpeakerTrackFilled: return "\u{fbad}"
        case .videoSpeakerTrackLight: return "\u{fbae}"
        case .videoSpeakerTrackRegular: return "\u{fbaf}"
        case .videotronColored: return "\u{fbb0}"
        case .videotronHorizontal: return "\u{fbb1}"
        ...
        case .viewListLight: return "\u{fbb6}"
        case .viewListRegular: return "\u{fbb7}"
        case .viewStackedBold: return "\u{fbb8}"
        case .viewStackedFilled: return "\u{fbb9}"
        case .viewStackedLight: return "\u{fbba}"
        case .viewStackedRegular: return "\u{fbbb}"
        case .viewThumbnailBold: return "\u{fbbc}"
        case .viewThumbnailFilled: return "\u{fbbd}"
        case .viewThumbnailLight: return "\u{fbbe}"
        case .viewThumbnailRegular: return "\u{fbbf}"
        case .visionproBold: return "\u{fbc0}"
        case .visionproFilled: return "\u{fbc1}"
        case .visionproLight: return "\u{fbc2}"
        case .visionproMoveCallInBold: return "\u{fbc3}"
        case .visionproMoveCallInFilled: return "\u{fbc4}"
        case .visionproMoveCallInLight: return "\u{fbc5}"
        case .visionproMoveCallInOutBold: return "\u{fbc6}"
        case .visionproMoveCallInOutFilled: return "\u{fbc7}"
        case .visionproMoveCallInOutLight: return "\u{fbc8}"
        case .visionproMoveCallInOutRegular: return "\u{fbc9}"
        case .visionproMoveCallInRegular: return "\u{fbca}"
        case .visionproMoveCallOutBold: return "\u{fbcb}"
        case .visionproMoveCallOutFilled: return "\u{fbcc}"
        case .visionproMoveCallOutLight: return "\u{fbcd}"
        case .visionproMoveCallOutRegular: return "\u{fbce}"
        case .visionproRegular: return "\u{fbcf}"
        case .voicemailBold: return "\u{fbd0}"
        case .voicemailFilled: return "\u{fbd1}"
        case .voicemailLight: return "\u{fbd2}"
        case .voicemailRegular: return "\u{fbd3}"
        case .vscBold: return "\u{fbd4}"
        case .vscLight: return "\u{fbd5}"
        case .vscRegular: return "\u{fbd6}"
        case .waffleMenuBold: return "\u{fbd7}"
        case .waffleMenuLight: return "\u{fbd8}"
        case .waffleMenuRegular: return "\u{fbd9}"
        case .waitingRoomBold: return "\u{fbda}"
        case .waitingRoomLight: return "\u{fbdb}"
        case .waitingRoomRegular: return "\u{fbdc}"
        case .wallpaperBold: return "\u{fbdd}"
        case .wallpaperLight: return "\u{fbde}"
        case .wallpaperRegular: return "\u{fbdf}"
        case .warningBadgeFilled: return "\u{fbe0}"
        case .warningBold: return "\u{fbe1}"
        case .warningFilled: return "\u{fbe2}"
        case .warningLight: return "\u{fbe3}"
        case .warningRegular: return "\u{fbe4}"
        case .webexBoardBold: return "\u{fbe5}"
        case .webexBoardLight: return "\u{fbe6}"
        case .webexBoardRegular: return "\u{fbe7}"
        case .webexCodecPlusBold: return "\u{fbe8}"
        case .webexCodecPlusLight: return "\u{fbe9}"
        case .webexCodecPlusRegular: return "\u{fbea}"
        case .webexDeskCameraBold: return "\u{fbeb}"
        case .webexDeskCameraLight: return "\u{fbec}"
        case .webexDeskCameraRegular: return "\u{fbed}"
        case .webexHelixBold: return "\u{fbee}"
        case .webexHelixLight: return "\u{fbef}"
        case .webexHelixRegular: return "\u{fbf0}"
        case .webexMeetingsBold: return "\u{fbf1}"
        case .webexMeetingsFilled: return "\u{fbf2}"
        case .webexMeetingsLight: return "\u{fbf3}"
        case .webexMeetingsRegular: return "\u{fbf4}"
        case .webexQuadCameraBold: return "\u{fbf5}"
        case .webexQuadCameraLight: return "\u{fbf6}"
        case .webexQuadCameraRegular: return "\u{fbf7}"
        case .webexRoomKitBold: return "\u{fbf8}"
        case .webexRoomKitLight: return "\u{fbf9}"
        case .webexRoomKitPlusBold: return "\u{fbfa}"
        case .webexRoomKitPlusLight: return "\u{fbfb}"
        case .webexRoomKitPlusRegular: return "\u{fbfc}"
        case .webexRoomKitRegular: return "\u{fbfd}"
        case .webexShareBold: return "\u{fbfe}"
        case .webexShareLight: return "\u{fbff}"
        case .webexShareRegular: return "\u{fc00}"
        case .webexTeamsBold: return "\u{fc01}"
        case .webexTeamsFilled: return "\u{fc02}"
        case .webexTeamsLight: return "\u{fc03}"
        case .webexTeamsNewBold: return "\u{fc04}"
        case .webexTeamsNewFilled: return "\u{fc05}"
        case .webexTeamsNewLight: return "\u{fc06}"
        case .webexTeamsNewRegular: return "\u{fc07}"
        case .webexTeamsRegular: return "\u{fc08}"
        case .webexTeamsRemoveBold: return "\u{fc09}"
        case .webexTeamsRemoveLight: return "\u{fc0a}"
        case .webexTeamsRemoveRegular: return "\u{fc0b}"
        case .webinarBold: return "\u{fc0c}"
        case .webinarFilled: return "\u{fc0d}"
        case .webinarLight: return "\u{fc0e}"
        case .webinarRegular: return "\u{fc0f}"
        case .weeklyRecurringScheduleBold: return "\u{fc10}"
        case .weeklyRecurringScheduleLight: return "\u{fc11}"
        case .weeklyRecurringScheduleRegular: return "\u{fc12}"
        case .whisperCoachBold: return "\u{fc13}"
        case .whisperCoachFilled: return "\u{fc14}"
        case .whisperCoachLight: return "\u{fc15}"
        case .whisperCoachRegular: return "\u{fc16}"
        case .whiteboardBold: return "\u{fc17}"
        case .whiteboardContentBold: return "\u{fc18}"
        case .whiteboardContentFilled: return "\u{fc19}"
        case .whiteboardContentLight: return "\u{fc1a}"
        case .whiteboardContentRegular: return "\u{fc1b}"
        case .whiteboardFilled: return "\u{fc1c}"
        case .whiteboardLight: return "\u{fc1d}"
        case .whiteboardRegular: return "\u{fc1e}"
        case .widgetBold: return "\u{fc1f}"
        case .widgetFilled: return "\u{fc20}"
        case .widgetLight: return "\u{fc21}"
        case .widgetRegular: return "\u{fc22}"
        case .wifiBold: return "\u{fc23}"
        case .wifiErrorBold: return "\u{fc24}"
        case .wifiErrorLight: return "\u{fc25}"
        case .wifiErrorRegular: return "\u{fc26}"
        case .wifiLight: return "\u{fc27}"
        case .wifiRegular: return "\u{fc28}"
        case .wifiSignalGoodBold: return "\u{fc29}"
        case .wifiSignalGoodLight: return "\u{fc2a}"
        case .wifiSignalGoodRegular: return "\u{fc2b}"
        case .wifiSignalPoorBold: return "\u{fc2c}"
        case .wifiSignalPoorLight: return "\u{fc2d}"
        case .wifiSignalPoorRegular: return "\u{fc2e}"
        case .wifiSignalUnstableBold: return "\u{fc2f}"
        case .wifiSignalUnstableLight: return "\u{fc30}"
        case .wifiSignalUnstableRegular: return "\u{fc31}"
        case .windowCornerScrubBold: return "\u{fc32}"
        case .windowCornerScrubLight: return "\u{fc33}"
        case .windowCornerScrubRegular: return "\u{fc34}"
        case .windowRightCornerScrubBold: return "\u{fc35}"
        case .windowRightCornerScrubLight: return "\u{fc36}"
        case .windowRightCornerScrubRegular: return "\u{fc37}"
        case .windowVerticalScrubBold: return "\u{fc38}"
        case .windowVerticalScrubLight: return "\u{fc39}"
        case .windowVerticalScrubRegular: return "\u{fc3a}"
        case .workflowDeploymentsBold: return "\u{fc3b}"
        case .workflowDeploymentsFilled: return "\u{fc3c}"
        case .workflowDeploymentsLight: return "\u{fc3d}"
        case .workflowDeploymentsRegular: return "\u{fc3e}"
        case .workphoneBold: return "\u{fc3f}"
        case .workphoneLight: return "\u{fc40}"
        case .workphoneRegular: return "\u{fc41}"
        case .zoomColored: return "\u{fc42}"
        case .zoomInBold: return "\u{fc43}"
        case .zoomInLight: return "\u{fc44}"
        case .zoomInRegular: return "\u{fc45}"
        case .zoomOutBold: return "\u{fc46}"
        case .zoomOutLight: return "\u{fc47}"
        case .zoomOutRegular: return "\u{fc48}"
