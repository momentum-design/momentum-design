...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .invitedUserBold: return "\u{f6aa}"
        case .invitedUserLight: return "\u{f6ab}"
        case .invitedUserRegular: return "\u{f6ac}"
        case .italicBold: return "\u{f6ad}"
        case .italicFilled: return "\u{f6ae}"
        case .italicLight: return "\u{f6af}"
        case .italicRegular: return "\u{f6b0}"
        case .joinAudioBold: return "\u{f6b1}"
        case .joinAudioFilled: return "\u{f6b2}"
        case .joinAudioLight: return "\u{f6b3}"
        case .joinAudioRegular: return "\u{f6b4}"
        case .keepInTouchBold: return "\u{f6b5}"
        case .keepInTouchFilled: return "\u{f6b6}"
        case .keepInTouchLight: return "\u{f6b7}"
        case .keepInTouchRegular: return "\u{f6b8}"
        case .keyboardBold: return "\u{f6b9}"
        case .keyboardCloseBold: return "\u{f6ba}"
        case .keyboardCloseLight: return "\u{f6bb}"
        case .keyboardCloseRegular: return "\u{f6bc}"
        case .keyboardLight: return "\u{f6bd}"
        case .keyboardRegular: return "\u{f6be}"
        case .languageBold: return "\u{f6bf}"
        case .languageFilled: return "\u{f6c0}"
        case .languageLight: return "\u{f6c1}"
        case .languageRegular: return "\u{f6c2}"
        case .laptopBold: return "\u{f6c3}"
        case .laptopDisconnectedBold: return "\u{f6c4}"
        case .laptopDisconnectedLight: return "\u{f6c5}"
        case .laptopDisconnectedRegular: return "\u{f6c6}"
        case .laptopFilled: return "\u{f6c7}"
        case .laptopLight: return "\u{f6c8}"
        case .laptopRegular: return "\u{f6c9}"
        case .laserPointerBold: return "\u{f6ca}"
        case .laserPointerFilled: return "\u{f6cb}"
        case .laserPointerLight: return "\u{f6cc}"
        case .laserPointerRegular: return "\u{f6cd}"
        case .launchBold: return "\u{f6ce}"
        case .launchLight: return "\u{f6cf}"
        case .launchRegular: return "\u{f6d0}"
        case .layoutSideBySideVerticalBold: return "\u{f6d1}"
        case .layoutSideBySideVerticalFilled: return "\u{f6d2}"
        case .layoutSideBySideVerticalLight: return "\u{f6d3}"
        case .layoutSideBySideVerticalRegular: return "\u{f6d4}"
        case .leaveBreakoutSessionBold: return "\u{f6d5}"
        case .leaveBreakoutSessionLight: return "\u{f6d6}"
        case .leaveBreakoutSessionRegular: return "\u{f6d7}"
        case .leaveDeviceBold: return "\u{f6d8}"
        case .leaveDeviceLight: return "\u{f6d9}"
        case .leaveDeviceRegular: return "\u{f6da}"
        case .likeBold: return "\u{f6db}"
        case .likeFilled: return "\u{f6dc}"
        case .likeLight: return "\u{f6dd}"
        case .likeRegular: return "\u{f6de}"
        case .linkBold: return "\u{f6df}"
        case .linkLight: return "\u{f6e0}"
        case .linkRegular: return "\u{f6e1}"
        case .listBulletedBold: return "\u{f6e2}"
        case .listBulletedLight: return "\u{f6e3}"
        case .listBulletedRegular: return "\u{f6e4}"
        case .listMenuBold: return "\u{f6e5}"
        case .listMenuLight: return "\u{f6e6}"
        case .listMenuRegular: return "\u{f6e7}"
        case .listNumberedBold: return "\u{f6e8}"
        case .listNumberedLight: return "\u{f6e9}"
        case .listNumberedRegular: return "\u{f6ea}"
        case .liveBold: return "\u{f6eb}"
        case .liveFilled: return "\u{f6ec}"
        case .liveLight: return "\u{f6ed}"
        case .liveRegular: return "\u{f6ee}"
        case .locationBold: return "\u{f6ef}"
        case .locationFilled: return "\u{f6f0}"
        case .locationLight: return "\u{f6f1}"
        case .locationRegular: return "\u{f6f2}"
        case .longTextBoxBold: return "\u{f6f3}"
        case .longTextBoxLight: return "\u{f6f4}"
        case .longTextBoxRegular: return "\u{f6f5}"
        case .lowerHandBold: return "\u{f6f6}"
        case .lowerHandLight: return "\u{f6f7}"
        case .lowerHandRegular: return "\u{f6f8}"
        case .magicPenBold: return "\u{f6f9}"
        case .magicPenFilled: return "\u{f6fa}"
        case .magicPenLight: return "\u{f6fb}"
        case .magicPenRegular: return "\u{f6fc}"
        case .markAsUnreadBold: return "\u{f6fd}"
        case .markAsUnreadLight: return "\u{f6fe}"
        case .markAsUnreadRegular: return "\u{f6ff}"
        case .markdownBold: return "\u{f700}"
        case .markdownLight: return "\u{f701}"
        case .markdownRegular: return "\u{f702}"
        case .markerBold: return "\u{f703}"
        case .markerFilled: return "\u{f704}"
        case .markerLight: return "\u{f705}"
        case .markerRegular: return "\u{f706}"
        case .maximizeBold: return "\u{f707}"
        case .maximizeLight: return "\u{f708}"
        case .maximizeRegular: return "\u{f709}"
        case .mediaPlayerBold: return "\u{f70a}"
        case .mediaPlayerLight: return "\u{f70b}"
        case .mediaPlayerRegular: return "\u{f70c}"
        case .mediaQualityGoodBold: return "\u{f70d}"
        case .mediaQualityGoodFilled: return "\u{f70e}"
        case .mediaQualityGoodLight: return "\u{f70f}"
        case .mediaQualityGoodRegular: return "\u{f710}"
        case .mediaQualityPoorBold: return "\u{f711}"
        case .mediaQualityPoorFilled: return "\u{f712}"
        case .mediaQualityPoorLight: return "\u{f713}"
        case .mediaQualityPoorRegular: return "\u{f714}"
        case .mediaQualityUnstableBold: return "\u{f715}"
        case .mediaQualityUnstableFilled: return "\u{f716}"
        case .mediaQualityUnstableLight: return "\u{f717}"
        case .mediaQualityUnstableRegular: return "\u{f718}"
        case .meetBold: return "\u{f719}"
        case .meetEndBold: return "\u{f71a}"
        case .meetEndLight: return "\u{f71b}"
        case .meetEndRegular: return "\u{f71c}"
        case .meetFilled: return "\u{f71d}"
        case .meetLight: return "\u{f71e}"
        case .meetRegular: return "\u{f71f}"
        case .meetingSummaryBold: return "\u{f720}"
        case .meetingSummaryFilled: return "\u{f721}"
        case .meetingSummaryLight: return "\u{f722}"
        case .meetingSummaryRegular: return "\u{f723}"
        case .meetingsBold: return "\u{f724}"
        case .meetingsFilled: return "\u{f725}"
        case .meetingsFocusMonthBold: return "\u{f726}"
        case .meetingsFocusMonthLight: return "\u{f727}"
        case .meetingsFocusMonthRegular: return "\u{f728}"
        case .meetingsFocusOneDayBold: return "\u{f729}"
        case .meetingsFocusOneDayLight: return "\u{f72a}"
        case .meetingsFocusOneDayRegular: return "\u{f72b}"
        case .meetingsFocusThreeDayBold: return "\u{f72c}"
        case .meetingsFocusThreeDayLight: return "\u{f72d}"
        case .meetingsFocusThreeDayRegular: return "\u{f72e}"
        case .meetingsFocusUpcomingBold: return "\u{f72f}"
        case .meetingsFocusUpcomingLight: return "\u{f730}"
        case .meetingsFocusUpcomingRegular: return "\u{f731}"
        case .meetingsLight: return "\u{f732}"
        case .meetingsPresenceBadgeFilled: return "\u{f733}"
        case .meetingsPresenceBold: return "\u{f734}"
        case .meetingsPresenceFilled: return "\u{f735}"
        case .meetingsPresenceLight: return "\u{f736}"
        case .meetingsPresenceRegular: return "\u{f737}"
        case .meetingsRegular: return "\u{f738}"
        case .meetingsTeamBold: return "\u{f739}"
        case .meetingsTeamFilled: return "\u{f73a}"
        case .meetingsTeamLight: return "\u{f73b}"
        case .meetingsTeamNewBold: return "\u{f73c}"
        case .meetingsTeamNewLight: return "\u{f73d}"
        case .meetingsTeamNewRegular: return "\u{f73e}"
        case .meetingsTeamRegular: return "\u{f73f}"
        case .mentionBold: return "\u{f740}"
        case .mentionLight: return "\u{f741}"
        case .mentionRegular: return "\u{f742}"
        case .messageQueingBold: return "\u{f743}"
        case .messageQueingLight: return "\u{f744}"
        case .messageQueingRegular: return "\u{f745}"
        case .microphoneBold: return "\u{f746}"
        case .microphoneFilled: return "\u{f747}"
        case .microphoneHardMutedBold: return "\u{f748}"
        case .microphoneHardMutedCircleFilled: return "\u{f749}"
        case .microphoneHardMutedLight: return "\u{f74a}"
        case .microphoneHardMutedRegular: return "\u{f74b}"
        case .microphoneLight: return "\u{f74c}"
        case .microphoneMusicModeBold: return "\u{f74d}"
        case .microphoneMusicModeLight: return "\u{f74e}"
        case .microphoneMusicModeOnBold: return "\u{f74f}"
        case .microphoneMusicModeOnLight: return "\u{f750}"
        case .microphoneMusicModeOnRegular: return "\u{f751}"
        case .microphoneMusicModeRegular: return "\u{f752}"
        case .microphoneMutedBold: return "\u{f753}"
        case .microphoneMutedCircleFilled: return "\u{f754}"
        case .microphoneMutedFilled: return "\u{f755}"
        case .microphoneMutedLight: return "\u{f756}"
        case .microphoneMutedRegular: return "\u{f757}"
        case .microphoneOnBold: return "\u{f758}"
        case .microphoneOnLight: return "\u{f759}"
        case .microphoneOnRegular: return "\u{f75a}"
        case .microphoneOptAllBold: return "\u{f75b}"
        case .microphoneOptAllLight: return "\u{f75c}"
        case .microphoneOptAllMutedBold: return "\u{f75d}"
        case .microphoneOptAllMutedLight: return "\u{f75e}"
        case .microphoneOptAllMutedRegular: return "\u{f75f}"
        case .microphoneOptAllOnBold: return "\u{f760}"
        case .microphoneOptAllOnLight: return "\u{f761}"
        case .microphoneOptAllOnRegular: return "\u{f762}"
        case .microphoneOptAllRegular: return "\u{f763}"
        case .microphoneOptMeBold: return "\u{f764}"
        case .microphoneOptMeLight: return "\u{f765}"
        case .microphoneOptMeMutedBold: return "\u{f766}"
        case .microphoneOptMeMutedLight: return "\u{f767}"
        case .microphoneOptMeMutedRegular: return "\u{f768}"
        case .microphoneOptMeOnBold: return "\u{f769}"
        case .microphoneOptMeOnLight: return "\u{f76a}"
        case .microphoneOptMeOnRegular: return "\u{f76b}"
        case .microphoneOptMeRegular: return "\u{f76c}"
        case .microphoneRegular: return "\u{f76d}"
        case .mindMapBold: return "\u{f76e}"
        case .mindMapLight: return "\u{f76f}"
        case .mindMapRegular: return "\u{f770}"
        case .minimizeBold: return "\u{f771}"
        case .minimizeLight: return "\u{f772}"
        case .minimizeRegular: return "\u{f773}"
        case .minusBold: return "\u{f774}"
        case .minusLight: return "\u{f775}"
        case .minusRegular: return "\u{f776}"
        case .mirrorBold: return "\u{f777}"
        case .mirrorFilled: return "\u{f778}"
        case .mirrorLight: return "\u{f779}"
        case .mirrorRegular: return "\u{f77a}"
        case .mmsFilled: return "\u{f77b}"
        case .moderatorBold: return "\u{f77c}"
        case .moderatorLight: return "\u{f77d}"
        case .moderatorRegular: return "\u{f77e}"
        case .monitoringBold: return "\u{f77f}"
        case .monitoringLight: return "\u{f780}"
        case .monitoringRegular: return "\u{f781}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f782}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f783}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f784}"
        case .moreAdrBold: return "\u{f785}"
        case .moreAdrLight: return "\u{f786}"
        case .moreAdrRegular: return "\u{f787}"
        case .moreBold: return "\u{f788}"
        case .moreCircleBold: return "\u{f789}"
        case .moreCircleFilled: return "\u{f78a}"
        case .moreCircleLight: return "\u{f78b}"
        case .moreCircleRegular: return "\u{f78c}"
        case .moreLight: return "\u{f78d}"
        case .moreRegular: return "\u{f78e}"
        case .mouseCursorBold: return "\u{f78f}"
        case .mouseCursorLight: return "\u{f790}"
        case .mouseCursorRegular: return "\u{f791}"
        case .moveCallInAdrBold: return "\u{f792}"
        case .moveCallInAdrLight: return "\u{f793}"
        case .moveCallInAdrRegular: return "\u{f794}"
        case .moveCallInIphBold: return "\u{f795}"
        case .moveCallInIphLight: return "\u{f796}"
        case .moveCallInIphRegular: return "\u{f797}"
        case .moveCallInLaptopBold: return "\u{f798}"
        case .moveCallInLaptopLight: return "\u{f799}"
        case .moveCallInLaptopRegular: return "\u{f79a}"
        case .moveCallInOutAdrBold: return "\u{f79b}"
        case .moveCallInOutAdrLight: return "\u{f79c}"
        case .moveCallInOutAdrRegular: return "\u{f79d}"
        case .moveCallInOutIphBold: return "\u{f79e}"
        case .moveCallInOutIphLight: return "\u{f79f}"
        case .moveCallInOutIphRegular: return "\u{f7a0}"
        case .moveCallInTabletBold: return "\u{f7a1}"
        case .moveCallInTabletLight: return "\u{f7a2}"
        case .moveCallInTabletRegular: return "\u{f7a3}"
        case .moveCallOutAdrBold: return "\u{f7a4}"
        case .moveCallOutAdrLight: return "\u{f7a5}"
        case .moveCallOutAdrRegular: return "\u{f7a6}"
        case .moveCallOutIphBold: return "\u{f7a7}"
        case .moveCallOutIphLight: return "\u{f7a8}"
        case .moveCallOutIphRegular: return "\u{f7a9}"
        case .moveCallOutLaptopBold: return "\u{f7aa}"
        case .moveCallOutLaptopLight: return "\u{f7ab}"
        case .moveCallOutLaptopRegular: return "\u{f7ac}"
        case .moveCallOutTabletBold: return "\u{f7ad}"
        case .moveCallOutTabletLight: return "\u{f7ae}"
        case .moveCallOutTabletRegular: return "\u{f7af}"
        case .moveToScreenBold: return "\u{f7b0}"
        case .moveToScreenLight: return "\u{f7b1}"
        case .moveToScreenRegular: return "\u{f7b2}"
        case .multilineChartBold: return "\u{f7b3}"
        case .multilineChartFilled: return "\u{f7b4}"
        case .multilineChartLight: return "\u{f7b5}"
        case .multilineChartRegular: return "\u{f7b6}"
        case .multimediaBold: return "\u{f7b7}"
        case .multimediaFilled: return "\u{f7b8}"
        case .multimediaLight: return "\u{f7b9}"
        case .multimediaRegular: return "\u{f7ba}"
        case .multipledDevicesBold: return "\u{f7bb}"
        case .multipledDevicesLight: return "\u{f7bc}"
        case .multipledDevicesRegular: return "\u{f7bd}"
        case .musicModeCircleBold: return "\u{f7be}"
        case .musicModeCircleFilled: return "\u{f7bf}"
        case .musicModeCircleLight: return "\u{f7c0}"
        case .musicModeCircleRegular: return "\u{f7c1}"
        case .musicNoteBold: return "\u{f7c2}"
        case .musicNoteFilled: return "\u{f7c3}"
        case .musicNoteLight: return "\u{f7c4}"
        case .musicNoteRegular: return "\u{f7c5}"
        case .muteOnEntryBold: return "\u{f7c6}"
        case .muteOnEntryFilled: return "\u{f7c7}"
        case .muteOnEntryLight: return "\u{f7c8}"
        case .muteOnEntryRegular: return "\u{f7c9}"
        case .newManagerBold: return "\u{f7ca}"
        case .newManagerLight: return "\u{f7cb}"
        case .newManagerRegular: return "\u{f7cc}"
        case .newTitleBold: return "\u{f7cd}"
        case .newTitleLight: return "\u{f7ce}"
        case .newTitleRegular: return "\u{f7cf}"
        case .newVoicemailBold: return "\u{f7d0}"
        case .newVoicemailLight: return "\u{f7d1}"
        case .newVoicemailRegular: return "\u{f7d2}"
        case .newWhiteboardBold: return "\u{f7d3}"
        case .newWhiteboardLight: return "\u{f7d4}"
        case .newWhiteboardRegular: return "\u{f7d5}"
        case .nextBold: return "\u{f7d6}"
        case .nextLight: return "\u{f7d7}"
        case .nextRegular: return "\u{f7d8}"
        case .noDevicesBold: return "\u{f7d9}"
        case .noDevicesLight: return "\u{f7da}"
        case .noDevicesRegular: return "\u{f7db}"
        case .noiseDetectedCanceledFilled: return "\u{f7dc}"
        case .noiseDetectedFilled: return "\u{f7dd}"
        case .noiseNoneCanceledFilled: return "\u{f7de}"
        case .noiseNoneFilled: return "\u{f7df}"
        case .noiseRemovalBold: return "\u{f7e0}"
        case .noiseRemovalLight: return "\u{f7e1}"
        case .noiseRemovalRegular: return "\u{f7e2}"
        case .noteBold: return "\u{f7e3}"
        case .noteLight: return "\u{f7e4}"
        case .notePptBold: return "\u{f7e5}"
        case .notePptLight: return "\u{f7e6}"
        case .notePptRegular: return "\u{f7e7}"
        case .noteRegular: return "\u{f7e8}"
        case .notesBold: return "\u{f7e9}"
        case .notesFilled: return "\u{f7ea}"
        case .notesLight: return "\u{f7eb}"
        case .notesRegular: return "\u{f7ec}"
        case .numberBold: return "\u{f7ed}"
        case .numberLight: return "\u{f7ee}"
        case .numberRegular: return "\u{f7ef}"
        case .oldRemoteBold: return "\u{f7f0}"
        case .oldRemoteLight: return "\u{f7f1}"
        case .oldRemoteRegular: return "\u{f7f2}"
        case .oldTouchBold: return "\u{f7f3}"
        case .oldTouchLight: return "\u{f7f4}"
        case .oldTouchRegular: return "\u{f7f5}"
        case .oneColumnBold: return "\u{f7f6}"
        case .oneColumnLight: return "\u{f7f7}"
        case .oneColumnRegular: return "\u{f7f8}"
        case .oneTimeBold: return "\u{f7f9}"
        case .oneTimeLight: return "\u{f7fa}"
        case .oneTimeRegular: return "\u{f7fb}"
        case .openInFolderBold: return "\u{f7fc}"
        case .openInFolderLight: return "\u{f7fd}"
        case .openInFolderRegular: return "\u{f7fe}"
        case .openPagesBold: return "\u{f7ff}"
        case .openPagesLight: return "\u{f800}"
        case .openPagesRegular: return "\u{f801}"
        case .otherNumberBold: return "\u{f802}"
        case .otherNumberFilled: return "\u{f803}"
        case .otherNumberLight: return "\u{f804}"
        case .otherNumberRegular: return "\u{f805}"
        case .otherNumberWarningBold: return "\u{f806}"
        case .otherNumberWarningLight: return "\u{f807}"
        case .otherNumberWarningRegular: return "\u{f808}"
        case .outgoingCallLegacyBold: return "\u{f809}"
        case .outgoingCallLegacyFilled: return "\u{f80a}"
        case .outgoingCallLegacyLight: return "\u{f80b}"
        case .outgoingCallLegacyRegular: return "\u{f80c}"
        case .overflowLeftBold: return "\u{f80d}"
        case .overflowLeftLight: return "\u{f80e}"
        case .overflowLeftRegular: return "\u{f80f}"
        case .overflowRightBold: return "\u{f810}"
        case .overflowRightLight: return "\u{f811}"
        case .overflowRightRegular: return "\u{f812}"
        case .pairedCameraBold: return "\u{f813}"
        case .pairedCameraLight: return "\u{f814}"
        case .pairedCameraRegular: return "\u{f815}"
        case .pairedDeviceBold: return "\u{f816}"
        case .pairedDeviceLight: return "\u{f817}"
        case .pairedDeviceRegular: return "\u{f818}"
        case .pairedHandsetBold: return "\u{f819}"
        case .pairedHandsetLight: return "\u{f81a}"
        case .pairedHandsetRegular: return "\u{f81b}"
        case .pairingBold: return "\u{f81c}"
        case .pairingLight: return "\u{f81d}"
        case .pairingRegular: return "\u{f81e}"
        case .parkedBold: return "\u{f81f}"
        case .parkedFilled: return "\u{f820}"
        case .parkedLight: return "\u{f821}"
        case .parkedRegular: return "\u{f822}"
        case .parseBold: return "\u{f823}"
        case .parseLight: return "\u{f824}"
        case .parseRegular: return "\u{f825}"
        case .partialBold: return "\u{f826}"
        case .partialLight: return "\u{f827}"
        case .partialRegular: return "\u{f828}"
        case .participantAddBold: return "\u{f829}"
        case .participantAddLight: return "\u{f82a}"
        case .participantAddRegular: return "\u{f82b}"
        case .participantBlockedBold: return "\u{f82c}"
        case .participantBlockedLight: return "\u{f82d}"
        case .participantBlockedRegular: return "\u{f82e}"
        case .participantBold: return "\u{f82f}"
        case .participantFilled: return "\u{f830}"
        case .participantLight: return "\u{f831}"
        case .participantListBold: return "\u{f832}"
        case .participantListFilled: return "\u{f833}"
        case .participantListLight: return "\u{f834}"
        case .participantListRegular: return "\u{f835}"
        case .participantRegular: return "\u{f836}"
        case .participantRemoveBold: return "\u{f837}"
        case .participantRemoveLight: return "\u{f838}"
        case .participantRemoveRegular: return "\u{f839}"
        case .participantUnknownBold: return "\u{f83a}"
        case .participantUnknownLight: return "\u{f83b}"
        case .participantUnknownRegular: return "\u{f83c}"
        case .passMouseBold: return "\u{f83d}"
        case .passMouseLight: return "\u{f83e}"
        case .passMouseRegular: return "\u{f83f}"
        case .pauseBadgeFilled: return "\u{f840}"
        case .pauseBold: return "\u{f841}"
        case .pauseFilled: return "\u{f842}"
        case .pauseLight: return "\u{f843}"
        case .pauseRegular: return "\u{f844}"
        case .peopleAddBold: return "\u{f845}"
        case .peopleAddFilled: return "\u{f846}"
        case .peopleAddLight: return "\u{f847}"
        case .peopleAddRegular: return "\u{f848}"
        case .peopleBold: return "\u{f849}"
        case .peopleCircleBold: return "\u{f84a}"
        case .peopleCircleFilled: return "\u{f84b}"
        case .peopleCircleLight: return "\u{f84c}"
        case .peopleCircleRegular: return "\u{f84d}"
        case .peopleFilled: return "\u{f84e}"
        case .peopleInsightsBold: return "\u{f84f}"
        case .peopleInsightsFilled: return "\u{f850}"
        case .peopleInsightsLight: return "\u{f851}"
        case .peopleInsightsRegular: return "\u{f852}"
        case .peopleLight: return "\u{f853}"
        case .peopleRegular: return "\u{f854}"
        case .phoneAlertBold: return "\u{f855}"
        case .phoneAlertLight: return "\u{f856}"
        case .phoneAlertRegular: return "\u{f857}"
        case .phoneBadgeFilled: return "\u{f858}"
        case .phoneBold: return "\u{f859}"
        case .phoneFilled: return "\u{f85a}"
        case .phoneLight: return "\u{f85b}"
        case .phoneMutedBold: return "\u{f85c}"
        case .phoneMutedLight: return "\u{f85d}"
        case .phoneMutedRegular: return "\u{f85e}"
        case .phonePrivateBold: return "\u{f85f}"
        case .phonePrivateLight: return "\u{f860}"
        case .phonePrivateRegular: return "\u{f861}"
        case .phoneRegular: return "\u{f862}"
        case .phoneReplyAllBold: return "\u{f863}"
        case .phoneReplyAllLight: return "\u{f864}"
        case .phoneReplyAllRegular: return "\u{f865}"
        case .phoneReplyBold: return "\u{f866}"
        case .phoneReplyLight: return "\u{f867}"
        case .phoneReplyRegular: return "\u{f868}"
        case .pickerBold: return "\u{f869}"
        case .pickerLight: return "\u{f86a}"
        case .pickerRegular: return "\u{f86b}"
        case .pieChartBold: return "\u{f86c}"
        case .pieChartFilled: return "\u{f86d}"
        case .pieChartLight: return "\u{f86e}"
        case .pieChartRegular: return "\u{f86f}"
        case .pinBold: return "\u{f870}"
        case .pinFilled: return "\u{f871}"
        case .pinLight: return "\u{f872}"
        case .pinListActivityBold: return "\u{f873}"
        case .pinListActivityLight: return "\u{f874}"
        case .pinListActivityRegular: return "\u{f875}"
        case .pinListBold: return "\u{f876}"
        case .pinListLight: return "\u{f877}"
        case .pinListRegular: return "\u{f878}"
        case .pinMutedBold: return "\u{f879}"
        case .pinMutedFilled: return "\u{f87a}"
        case .pinMutedLight: return "\u{f87b}"
        case .pinMutedRegular: return "\u{f87c}"
        case .pinRegular: return "\u{f87d}"
        case .pipBold: return "\u{f87e}"
        case .pipEnterBold: return "\u{f87f}"
        case .pipEnterLight: return "\u{f880}"
        case .pipEnterRegular: return "\u{f881}"
        case .pipExitBold: return "\u{f882}"
        case .pipExitLight: return "\u{f883}"
        case .pipExitRegular: return "\u{f884}"
        case .pipFilled: return "\u{f885}"
        case .pipLight: return "\u{f886}"
        case .pipRegular: return "\u{f887}"
        case .placeholderBold: return "\u{f888}"
        case .placeholderFilled: return "\u{f889}"
        case .placeholderLight: return "\u{f88a}"
        case .placeholderRegular: return "\u{f88b}"
        case .playBold: return "\u{f88c}"
        case .playCircleBold: return "\u{f88d}"
        case .playCircleFilled: return "\u{f88e}"
        case .playCircleLight: return "\u{f88f}"
        case .playCircleRegular: return "\u{f890}"
        case .playFilled: return "\u{f891}"
        case .playLight: return "\u{f892}"
        case .playRegular: return "\u{f893}"
        case .plugAcBold: return "\u{f894}"
        case .plugAcLight: return "\u{f895}"
        case .plugAcRegular: return "\u{f896}"
        case .plusBold: return "\u{f897}"
        case .plusCircleBold: return "\u{f898}"
        case .plusCircleFilled: return "\u{f899}"
        case .plusCircleLight: return "\u{f89a}"
        case .plusCircleRegular: return "\u{f89b}"
        case .plusLight: return "\u{f89c}"
        case .plusRegular: return "\u{f89d}"
        case .pmrBold: return "\u{f89e}"
        case .pmrFilled: return "\u{f89f}"
        case .pmrLight: return "\u{f8a0}"
        case .pmrRegular: return "\u{f8a1}"
        case .pollBold: return "\u{f8a2}"
        case .pollFilled: return "\u{f8a3}"
        case .pollLight: return "\u{f8a4}"
        case .pollRegular: return "\u{f8a5}"
        case .popInBold: return "\u{f8a6}"
        case .popInLight: return "\u{f8a7}"
        case .popInRegular: return "\u{f8a8}"
        case .popOutBold: return "\u{f8a9}"
        case .popOutLight: return "\u{f8aa}"
        case .popOutRegular: return "\u{f8ab}"
        case .popUpBold: return "\u{f8ac}"
        case .popUpLight: return "\u{f8ad}"
        case .popUpRegular: return "\u{f8ae}"
        case .portraitLandscapeBold: return "\u{f8af}"
        case .portraitLandscapeLight: return "\u{f8b0}"
        case .portraitLandscapeRegular: return "\u{f8b1}"
        case .potentialFraudBold: return "\u{f8b2}"
        case .potentialFraudFilled: return "\u{f8b3}"
        case .potentialFraudLight: return "\u{f8b4}"
        case .potentialFraudRegular: return "\u{f8b5}"
        case .powerAcBold: return "\u{f8b6}"
        case .powerAcLight: return "\u{f8b7}"
        case .powerAcRegular: return "\u{f8b8}"
        case .powerBold: return "\u{f8b9}"
        case .powerLight: return "\u{f8ba}"
        case .powerRegular: return "\u{f8bb}"
        case .preHeaderBold: return "\u{f8bc}"
        case .preHeaderLight: return "\u{f8bd}"
        case .preHeaderRegular: return "\u{f8be}"
        case .premiumBold: return "\u{f8bf}"
        case .premiumLight: return "\u{f8c0}"
        case .premiumRegular: return "\u{f8c1}"
        case .presentationBold: return "\u{f8c2}"
        case .presentationLight: return "\u{f8c3}"
        case .presentationRegular: return "\u{f8c4}"
        case .preventDownloadBold: return "\u{f8c5}"
        case .preventDownloadFilled: return "\u{f8c6}"
        case .preventDownloadLight: return "\u{f8c7}"
        case .preventDownloadRegular: return "\u{f8c8}"
        case .primaryParticipantBold: return "\u{f8c9}"
        case .primaryParticipantLight: return "\u{f8ca}"
        case .primaryParticipantRegular: return "\u{f8cb}"
        case .printBold: return "\u{f8cc}"
        case .printLight: return "\u{f8cd}"
        case .printRegular: return "\u{f8ce}"
        case .priorityBadgeFilled: return "\u{f8cf}"
        case .priorityCircleBold: return "\u{f8d0}"
        case .priorityCircleFilled: return "\u{f8d1}"
        case .priorityCircleLight: return "\u{f8d2}"
        case .priorityCircleRegular: return "\u{f8d3}"
        case .priorityCircleTwoBold: return "\u{f8d4}"
        case .priorityCircleTwoFilled: return "\u{f8d5}"
        case .priorityCircleTwoLight: return "\u{f8d6}"
        case .priorityCircleTwoRegular: return "\u{f8d7}"
        case .priorityWaveBold: return "\u{f8d8}"
        case .priorityWaveLight: return "\u{f8d9}"
        case .priorityWaveRegular: return "\u{f8da}"
        case .privacyCircleBold: return "\u{f8db}"
        case .privacyCircleFilled: return "\u{f8dc}"
        case .privacyCircleLight: return "\u{f8dd}"
        case .privacyCircleRegular: return "\u{f8de}"
        case .privateBold: return "\u{f8df}"
        case .privateCircleBold: return "\u{f8e0}"
        case .privateCircleFilled: return "\u{f8e1}"
        case .privateCircleLight: return "\u{f8e2}"
        case .privateCircleRegular: return "\u{f8e3}"
        case .privateLight: return "\u{f8e4}"
        case .privateMeetingBold: return "\u{f8e5}"
        case .privateMeetingLight: return "\u{f8e6}"
        case .privateMeetingRegular: return "\u{f8e7}"
        case .privateRegular: return "\u{f8e8}"
        case .productDemoBold: return "\u{f8e9}"
        case .productDemoLight: return "\u{f8ea}"
        case .productDemoRegular: return "\u{f8eb}"
        case .proximityBold: return "\u{f8ec}"
        case .proximityLight: return "\u{f8ed}"
        case .proximityMutedBold: return "\u{f8ee}"
        case .proximityMutedLight: return "\u{f8ef}"
        case .proximityMutedRegular: return "\u{f8f0}"
        case .proximityRegular: return "\u{f8f1}"
        case .proximityVideoBold: return "\u{f8f2}"
        case .proximityVideoLight: return "\u{f8f3}"
        case .proximityVideoRegular: return "\u{f8f4}"
        case .ptoPresenceBold: return "\u{f8f5}"
        case .ptoPresenceFilled: return "\u{f8f6}"
        case .ptoPresenceLight: return "\u{f8f7}"
        case .ptoPresenceRegular: return "\u{f8f8}"
        case .pullCallBold: return "\u{f8f9}"
        case .pullCallFilled: return "\u{f8fa}"
        case .pullCallLight: return "\u{f8fb}"
        case .pullCallRegular: return "\u{f8fc}"
        case .qABold: return "\u{f8fd}"
        case .qALight: return "\u{f8fe}"
        case .qARegular: return "\u{f8ff}"
        case .qrCodeBold: return "\u{f900}"
        case .qrCodeLight: return "\u{f901}"
        case .qrCodeRegular: return "\u{f902}"
        case .qrCodeScanBold: return "\u{f903}"
        case .qrCodeScanLight: return "\u{f904}"
        case .qrCodeScanRegular: return "\u{f905}"
        case .qualityBold: return "\u{f906}"
        case .qualityLight: return "\u{f907}"
        case .qualityRegular: return "\u{f908}"
        case .queueContactBold: return "\u{f909}"
        case .queueContactFilled: return "\u{f90a}"
        case .queueContactLight: return "\u{f90b}"
        case .queueContactRegular: return "\u{f90c}"
        case .quietBold: return "\u{f90d}"
        case .quietHoursPresenceBold: return "\u{f90e}"
        case .quietHoursPresenceFilled: return "\u{f90f}"
        case .quietHoursPresenceLight: return "\u{f910}"
        case .quietHoursPresenceRegular: return "\u{f911}"
        case .quietLight: return "\u{f912}"
        case .quietRegular: return "\u{f913}"
        case .radioButtonGroupBold: return "\u{f914}"
        case .radioButtonGroupLight: return "\u{f915}"
        case .radioButtonGroupRegular: return "\u{f916}"
        case .raiseHandBold: return "\u{f917}"
        case .raiseHandCircleFilled: return "\u{f918}"
        case .raiseHandFilled: return "\u{f919}"
        case .raiseHandLight: return "\u{f91a}"
        case .raiseHandRegular: return "\u{f91b}"
        case .ramBold: return "\u{f91c}"
        case .ramLight: return "\u{f91d}"
        case .ramRegular: return "\u{f91e}"
        case .reactionsBold: return "\u{f91f}"
        case .reactionsFilled: return "\u{f920}"
        case .reactionsLight: return "\u{f921}"
        case .reactionsRegular: return "\u{f922}"
        case .reactivateBold: return "\u{f923}"
        case .reactivateLight: return "\u{f924}"
        case .reactivateRegular: return "\u{f925}"
        case .receiveVoiceBold: return "\u{f926}"
        case .receiveVoiceFilled: return "\u{f927}"
        case .receiveVoiceLight: return "\u{f928}"
        case .receiveVoiceRegular: return "\u{f929}"
        case .recentsBold: return "\u{f92a}"
        case .recentsFilled: return "\u{f92b}"
        case .recentsLight: return "\u{f92c}"
        case .recentsPresenceBadgeFilled: return "\u{f92d}"
        case .recentsPresenceBold: return "\u{f92e}"
        case .recentsPresenceFilled: return "\u{f92f}"
        case .recentsPresenceLight: return "\u{f930}"
        case .recentsPresenceRegular: return "\u{f931}"
        case .recentsRegular: return "\u{f932}"
        case .recordActiveBadgeFilled: return "\u{f933}"
        case .recordActiveBold: return "\u{f934}"
        case .recordActiveFilled: return "\u{f935}"
        case .recordActiveLight: return "\u{f936}"
        case .recordActiveRegular: return "\u{f937}"
        case .recordBold: return "\u{f938}"
        case .recordFilled: return "\u{f939}"
        case .recordLight: return "\u{f93a}"
        case .recordPausedBadgeFilled: return "\u{f93b}"
        case .recordPausedBold: return "\u{f93c}"
        case .recordPausedFilled: return "\u{f93d}"
        case .recordPausedLight: return "\u{f93e}"
        case .recordPausedRegular: return "\u{f93f}"
        case .recordRegular: return "\u{f940}"
        case .recurringBold: return "\u{f941}"
        case .recurringLight: return "\u{f942}"
        case .recurringOffBold: return "\u{f943}"
        case .recurringOffLight: return "\u{f944}"
        case .recurringOffRegular: return "\u{f945}"
        case .recurringRegular: return "\u{f946}"
        case .redoBold: return "\u{f947}"
        case .redoLight: return "\u{f948}"
        case .redoRegular: return "\u{f949}"
        case .refreshBold: return "\u{f94a}"
        case .refreshLight: return "\u{f94b}"
        case .refreshRegular: return "\u{f94c}"
        case .remoteDesktopControlBold: return "\u{f94d}"
        case .remoteDesktopControlFilled: return "\u{f94e}"
        case .remoteDesktopControlLight: return "\u{f94f}"
        case .remoteDesktopControlRegular: return "\u{f950}"
        case .removeBold: return "\u{f951}"
        case .removeFilled: return "\u{f952}"
        case .removeLight: return "\u{f953}"
        case .removeRegular: return "\u{f954}"
        case .replyBold: return "\u{f955}"
        case .replyFilled: return "\u{f956}"
        case .replyLight: return "\u{f957}"
        case .replyListBold: return "\u{f958}"
        case .replyListLight: return "\u{f959}"
        case .replyListRegular: return "\u{f95a}"
        case .replyPrivatelyBold: return "\u{f95b}"
        case .replyPrivatelyLight: return "\u{f95c}"
        case .replyPrivatelyRegular: return "\u{f95d}"
        case .replyRegular: return "\u{f95e}"
        case .resetBold: return "\u{f95f}"
        case .resetLight: return "\u{f960}"
        case .resetRegular: return "\u{f961}"
        case .resizeCornerBold: return "\u{f962}"
        case .resizeCornerLight: return "\u{f963}"
        case .resizeCornerRegular: return "\u{f964}"
        case .responsiveMobileBold: return "\u{f965}"
        case .responsiveMobileLight: return "\u{f966}"
        case .responsiveMobileRegular: return "\u{f967}"
        case .restartBold: return "\u{f968}"
        case .restartLight: return "\u{f969}"
        case .restartRegular: return "\u{f96a}"
        case .retrieveCallBold: return "\u{f96b}"
        case .retrieveCallFilled: return "\u{f96c}"
        case .retrieveCallLight: return "\u{f96d}"
        case .retrieveCallRegular: return "\u{f96e}"
        case .returnBold: return "\u{f96f}"
        case .returnLight: return "\u{f970}"
        case .returnRegular: return "\u{f971}"
        case .rewindTenSecBold: return "\u{f972}"
        case .rewindTenSecLight: return "\u{f973}"
        case .rewindTenSecRegular: return "\u{f974}"
        case .ringtoneBold: return "\u{f975}"
        case .ringtoneLight: return "\u{f976}"
        case .ringtoneRegular: return "\u{f977}"
        case .roomCalendarBold: return "\u{f978}"
        case .roomCalendarLight: return "\u{f979}"
        case .roomCalendarRegular: return "\u{f97a}"
        case .roomLightsBold: return "\u{f97b}"
        case .roomLightsFilled: return "\u{f97c}"
        case .roomLightsLight: return "\u{f97d}"
        case .roomLightsRegular: return "\u{f97e}"
        case .rotateContentBold: return "\u{f97f}"
        case .rotateContentFilled: return "\u{f980}"
        case .rotateContentLight: return "\u{f981}"
        case .rotateContentRegular: return "\u{f982}"
        case .rssBold: return "\u{f983}"
        case .rssFilled: return "\u{f984}"
        case .rssLight: return "\u{f985}"
        case .rssRegular: return "\u{f986}"
        case .ruleBasedBold: return "\u{f987}"
        case .ruleBasedLight: return "\u{f988}"
        case .ruleBasedRegular: return "\u{f989}"
        case .runningApplicationBold: return "\u{f98a}"
        case .runningApplicationFilled: return "\u{f98b}"
        case .runningApplicationLight: return "\u{f98c}"
        case .runningApplicationRegular: return "\u{f98d}"
        case .saveBold: return "\u{f98e}"
        case .saveLight: return "\u{f98f}"
        case .saveRegular: return "\u{f990}"
        case .saveTranscriptBold: return "\u{f991}"
        case .saveTranscriptFilled: return "\u{f992}"
        case .saveTranscriptLight: return "\u{f993}"
        case .saveTranscriptRegular: return "\u{f994}"
        case .scanBold: return "\u{f995}"
        case .scanLight: return "\u{f996}"
        case .scanRegular: return "\u{f997}"
        case .scheduleSendBold: return "\u{f998}"
        case .scheduleSendFilled: return "\u{f999}"
        case .scheduleSendLight: return "\u{f99a}"
        case .scheduleSendRegular: return "\u{f99b}"
        case .scheduleWinnerBold: return "\u{f99c}"
        case .scheduleWinnerFilled: return "\u{f99d}"
        case .scheduleWinnerLight: return "\u{f99e}"
        case .scheduleWinnerRegular: return "\u{f99f}"
        case .schedulerAvailableBold: return "\u{f9a0}"
        case .schedulerAvailableLight: return "\u{f9a1}"
        case .schedulerAvailableRegular: return "\u{f9a2}"
        case .schedulerNotWorkingHoursBold: return "\u{f9a3}"
        case .schedulerNotWorkingHoursLight: return "\u{f9a4}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9a5}"
        case .schedulerUnavailableBold: return "\u{f9a6}"
        case .schedulerUnavailableLight: return "\u{f9a7}"
        case .schedulerUnavailableRegular: return "\u{f9a8}"
        case .schedulerUnknownBold: return "\u{f9a9}"
        case .schedulerUnknownLight: return "\u{f9aa}"
        case .schedulerUnknownRegular: return "\u{f9ab}"
        case .screenshotBold: return "\u{f9ac}"
        case .screenshotDocBold: return "\u{f9ad}"
        case .screenshotDocFilled: return "\u{f9ae}"
        case .screenshotDocLight: return "\u{f9af}"
        case .screenshotDocRegular: return "\u{f9b0}"
        case .screenshotLight: return "\u{f9b1}"
        case .screenshotRegular: return "\u{f9b2}"
        case .searchBold: return "\u{f9b3}"
        case .searchFilled: return "\u{f9b4}"
        case .searchLight: return "\u{f9b5}"
        case .searchRegular: return "\u{f9b6}"
        case .secondaryArrowBold: return "\u{f9b7}"
        case .secondaryArrowLight: return "\u{f9b8}"
        case .secondaryArrowRegular: return "\u{f9b9}"
        case .secureCallLockBold: return "\u{f9ba}"
        case .secureCallLockFilled: return "\u{f9bb}"
        case .secureCallLockLight: return "\u{f9bc}"
        case .secureCallLockRegular: return "\u{f9bd}"
        case .secureCallShieldBold: return "\u{f9be}"
        case .secureCallShieldFilled: return "\u{f9bf}"
        case .secureCallShieldLight: return "\u{f9c0}"
        case .secureCallShieldRegular: return "\u{f9c1}"
        case .secureCircleBold: return "\u{f9c2}"
        case .secureCircleFilled: return "\u{f9c3}"
        case .secureCircleLight: return "\u{f9c4}"
        case .secureCircleRegular: return "\u{f9c5}"
        case .secureLockBold: return "\u{f9c6}"
        case .secureLockFilled: return "\u{f9c7}"
        case .secureLockLight: return "\u{f9c8}"
        case .secureLockRegular: return "\u{f9c9}"
        case .segmentExcludeFilled: return "\u{f9ca}"
        case .segmentFilterFilled: return "\u{f9cb}"
        case .segmentIncludeFilled: return "\u{f9cc}"
        case .selectAllBold: return "\u{f9cd}"
        case .selectAllFilled: return "\u{f9ce}"
        case .selectAllLight: return "\u{f9cf}"
        case .selectAllRegular: return "\u{f9d0}"
        case .selectionBold: return "\u{f9d1}"
        case .selectionFilled: return "\u{f9d2}"
        case .selectionLight: return "\u{f9d3}"
        case .selectionRegular: return "\u{f9d4}"
        case .sendBold: return "\u{f9d5}"
        case .sendDigitsBold: return "\u{f9d6}"
        case .sendDigitsFilled: return "\u{f9d7}"
        case .sendDigitsLight: return "\u{f9d8}"
        case .sendDigitsRegular: return "\u{f9d9}"
        case .sendFilled: return "\u{f9da}"
        case .sendLight: return "\u{f9db}"
        case .sendRegular: return "\u{f9dc}"
        case .sendVoiceBold: return "\u{f9dd}"
        case .sendVoiceFilled: return "\u{f9de}"
        case .sendVoiceLight: return "\u{f9df}"
        case .sendVoiceRegular: return "\u{f9e0}"
        case .serverBold: return "\u{f9e1}"
        case .serverErrorBold: return "\u{f9e2}"
        case .serverErrorLight: return "\u{f9e3}"
        case .serverErrorRegular: return "\u{f9e4}"
        case .serverLight: return "\u{f9e5}"
        case .serverRegular: return "\u{f9e6}"
        case .servicesBold: return "\u{f9e7}"
        case .servicesLight: return "\u{f9e8}"
        case .servicesRegular: return "\u{f9e9}"
        case .setVariableBold: return "\u{f9ea}"
        case .setVariableLight: return "\u{f9eb}"
        case .setVariableRegular: return "\u{f9ec}"
        case .settingsBold: return "\u{f9ed}"
        case .settingsFilled: return "\u{f9ee}"
        case .settingsLight: return "\u{f9ef}"
        case .settingsRegular: return "\u{f9f0}"
        case .setupAssistantBold: return "\u{f9f1}"
        case .setupAssistantLight: return "\u{f9f2}"
        case .setupAssistantRegular: return "\u{f9f3}"
        case .sftpBold: return "\u{f9f4}"
        case .sftpLight: return "\u{f9f5}"
        case .sftpRegular: return "\u{f9f6}"
        case .shapeCircleBold: return "\u{f9f7}"
        case .shapeCircleFilled: return "\u{f9f8}"
        case .shapeCircleLight: return "\u{f9f9}"
        case .shapeCircleMdFilled: return "\u{f9fa}"
        case .shapeCircleRegular: return "\u{f9fb}"
        case .shapeCircleSmFilled: return "\u{f9fc}"
        case .shapeDiagonalLineBold: return "\u{f9fd}"
        case .shapeDiagonalLineLight: return "\u{f9fe}"
        case .shapeDiagonalLineRegular: return "\u{f9ff}"
        case .shapeDiamondBold: return "\u{fa00}"
        case .shapeDiamondFilled: return "\u{fa01}"
        case .shapeDiamondLight: return "\u{fa02}"
        case .shapeDiamondRegular: return "\u{fa03}"
        case .shapeOvalBold: return "\u{fa04}"
        case .shapeOvalLight: return "\u{fa05}"
        case .shapeOvalRegular: return "\u{fa06}"
        case .shapeSquareBold: return "\u{fa07}"
        case .shapeSquareFilled: return "\u{fa08}"
        case .shapeSquareLight: return "\u{fa09}"
        case .shapeSquareRegular: return "\u{fa0a}"
        case .shapeTriangleBold: return "\u{fa0b}"
        case .shapeTriangleFilled: return "\u{fa0c}"
        case .shapeTriangleLight: return "\u{fa0d}"
        case .shapeTriangleRegular: return "\u{fa0e}"
        case .shapesBold: return "\u{fa0f}"
        case .shapesFilled: return "\u{fa10}"
        case .shapesLight: return "\u{fa11}"
        case .shapesRegular: return "\u{fa12}"
        case .shareCNativeAdrBold: return "\u{fa13}"
        case .shareCNativeAdrFilled: return "\u{fa14}"
        case .shareCNativeAdrLight: return "\u{fa15}"
        case .shareCNativeAdrRegular: return "\u{fa16}"
        case .shareCNativeIphBold: return "\u{fa17}"
        case .shareCNativeIphLight: return "\u{fa18}"
        case .shareCNativeIphRegular: return "\u{fa19}"
        case .shareContentOnDeviceBold: return "\u{fa1a}"
        case .shareContentOnDeviceLight: return "\u{fa1b}"
        case .shareContentOnDeviceRegular: return "\u{fa1c}"
        case .shareScreenAddBold: return "\u{fa1d}"
        case .shareScreenAddLight: return "\u{fa1e}"
        case .shareScreenAddRegular: return "\u{fa1f}"
        case .shareScreenBadgeFilled: return "\u{fa20}"
        case .shareScreenBold: return "\u{fa21}"
        case .shareScreenFilled: return "\u{fa22}"
        case .shareScreenLight: return "\u{fa23}"
        case .shareScreenRegular: return "\u{fa24}"
        case .shareSpaceBold: return "\u{fa25}"
        case .shareSpaceLight: return "\u{fa26}"
        case .shareSpaceRegular: return "\u{fa27}"
        case .shieldBold: return "\u{fa28}"
        case .shieldLight: return "\u{fa29}"
        case .shieldRegular: return "\u{fa2a}"
        case .shoppingCartBold: return "\u{fa2b}"
        case .shoppingCartFilled: return "\u{fa2c}"
        case .shoppingCartLight: return "\u{fa2d}"
        case .shoppingCartRegular: return "\u{fa2e}"
        case .shortTextBoxBold: return "\u{fa2f}"
        case .shortTextBoxLight: return "\u{fa30}"
        case .shortTextBoxRegular: return "\u{fa31}"
        case .showBold: return "\u{fa32}"
        case .showFilled: return "\u{fa33}"
        case .showLight: return "\u{fa34}"
        case .showRegular: return "\u{fa35}"
        case .signInBold: return "\u{fa36}"
        case .signInFilled: return "\u{fa37}"
        case .signInForcedBold: return "\u{fa38}"
        case .signInForcedLight: return "\u{fa39}"
        case .signInForcedRegular: return "\u{fa3a}"
        case .signInLight: return "\u{fa3b}"
        case .signInRegular: return "\u{fa3c}"
        case .signLangIntBold: return "\u{fa3d}"
        case .signLangIntLight: return "\u{fa3e}"
        case .signLangIntRegular: return "\u{fa3f}"
        case .signOutBold: return "\u{fa40}"
        case .signOutLight: return "\u{fa41}"
        case .signOutRegular: return "\u{fa42}"
        case .signalFourBold: return "\u{fa43}"
        case .signalFourLight: return "\u{fa44}"
        case .signalFourRegular: return "\u{fa45}"
        case .signalOneBold: return "\u{fa46}"
        case .signalOneLight: return "\u{fa47}"
        case .signalOneRegular: return "\u{fa48}"
        case .signalThreeBold: return "\u{fa49}"
        case .signalThreeLight: return "\u{fa4a}"
        case .signalThreeRegular: return "\u{fa4b}"
        case .signalTwoBold: return "\u{fa4c}"
        case .signalTwoLight: return "\u{fa4d}"
        case .signalTwoRegular: return "\u{fa4e}"
        case .signalZeroBold: return "\u{fa4f}"
        case .signalZeroLight: return "\u{fa50}"
        case .signalZeroRegular: return "\u{fa51}"
        case .simplePromotionBold: return "\u{fa52}"
        case .simplePromotionLight: return "\u{fa53}"
        case .simplePromotionRegular: return "\u{fa54}"
        case .singleNumberReachBold: return "\u{fa55}"
        case .singleNumberReachLight: return "\u{fa56}"
        case .singleNumberReachRegular: return "\u{fa57}"
        case .sipRegistrationInProgressBold: return "\u{fa58}"
        case .sipRegistrationInProgressFilled: return "\u{fa59}"
        case .sipRegistrationInProgressLight: return "\u{fa5a}"
        case .sipRegistrationInProgressRegular: return "\u{fa5b}"
        case .skipBold: return "\u{fa5c}"
        case .skipBwBold: return "\u{fa5d}"
        case .skipBwFilled: return "\u{fa5e}"
        case .skipBwLight: return "\u{fa5f}"
        case .skipBwRegular: return "\u{fa60}"
        case .skipFwBold: return "\u{fa61}"
        case .skipFwFilled: return "\u{fa62}"
        case .skipFwLight: return "\u{fa63}"
        case .skipFwRegular: return "\u{fa64}"
        case .skipLight: return "\u{fa65}"
        case .skipRegular: return "\u{fa66}"
        case .smartAudioBold: return "\u{fa67}"
        case .smartAudioLight: return "\u{fa68}"
        case .smartAudioRegular: return "\u{fa69}"
        case .smsFilled: return "\u{fa6a}"
        case .smsInboundBold: return "\u{fa6b}"
        case .smsInboundLight: return "\u{fa6c}"
        case .smsInboundRegular: return "\u{fa6d}"
        case .smsMessageBold: return "\u{fa6e}"
        case .smsMessageFilled: return "\u{fa6f}"
        case .smsMessageLight: return "\u{fa70}"
        case .smsMessageRegular: return "\u{fa71}"
        case .smsOutgoingFilled: return "\u{fa72}"
        case .smsUnreadBold: return "\u{fa73}"
        case .smsUnreadLight: return "\u{fa74}"
        case .smsUnreadRegular: return "\u{fa75}"
        case .sortAscendingBold: return "\u{fa76}"
        case .sortAscendingLight: return "\u{fa77}"
        case .sortAscendingRegular: return "\u{fa78}"
        case .sortDescendingBold: return "\u{fa79}"
        case .sortDescendingLight: return "\u{fa7a}"
        case .sortDescendingRegular: return "\u{fa7b}"
        case .soundDefaultBold: return "\u{fa7c}"
        case .soundDefaultLight: return "\u{fa7d}"
        case .soundDefaultRegular: return "\u{fa7e}"
        case .sparkleBold: return "\u{fa7f}"
        case .sparkleFilled: return "\u{fa80}"
        case .sparkleLight: return "\u{fa81}"
        case .sparkleRegular: return "\u{fa82}"
        case .speakerBold: return "\u{fa83}"
        case .speakerDisconnectedBold: return "\u{fa84}"
        case .speakerDisconnectedFilled: return "\u{fa85}"
        case .speakerDisconnectedLight: return "\u{fa86}"
        case .speakerDisconnectedRegular: return "\u{fa87}"
        case .speakerFilled: return "\u{fa88}"
        case .speakerLight: return "\u{fa89}"
        case .speakerMutedBold: return "\u{fa8a}"
        case .speakerMutedFilled: return "\u{fa8b}"
        case .speakerMutedLight: return "\u{fa8c}"
        case .speakerMutedRegular: return "\u{fa8d}"
        case .speakerOffBold: return "\u{fa8e}"
        case .speakerOffFilled: return "\u{fa8f}"
        case .speakerOffLight: return "\u{fa90}"
        case .speakerOffRegular: return "\u{fa91}"
        case .speakerOnBold: return "\u{fa92}"
        case .speakerOnLight: return "\u{fa93}"
        case .speakerOnRegular: return "\u{fa94}"
        case .speakerRegular: return "\u{fa95}"
        case .speakerTurnDownBold: return "\u{fa96}"
        case .speakerTurnDownFilled: return "\u{fa97}"
        case .speakerTurnDownLight: return "\u{fa98}"
        case .speakerTurnDownRegular: return "\u{fa99}"
        case .speakerTurnUpBold: return "\u{fa9a}"
        case .speakerTurnUpFilled: return "\u{fa9b}"
        case .speakerTurnUpLight: return "\u{fa9c}"
        case .speakerTurnUpRegular: return "\u{fa9d}"
        case .speedDialBold: return "\u{fa9e}"
        case .speedDialFilled: return "\u{fa9f}"
        case .speedDialLight: return "\u{faa0}"
        case .speedDialRegular: return "\u{faa1}"
        case .spellCheckerBold: return "\u{faa2}"
        case .spellCheckerLight: return "\u{faa3}"
        case .spellCheckerRegular: return "\u{faa4}"
        case .spinnerBold: return "\u{faa5}"
        case .spinnerInProgressBold: return "\u{faa6}"
        case .spinnerInProgressLight: return "\u{faa7}"
        case .spinnerInProgressRegular: return "\u{faa8}"
        case .spinnerLight: return "\u{faa9}"
        case .spinnerRegular: return "\u{faaa}"
        case .splitViewBold: return "\u{faab}"
        case .splitViewLight: return "\u{faac}"
        case .splitViewRegular: return "\u{faad}"
        case .stackedAreaChartBold: return "\u{faae}"
        case .stackedAreaChartFilled: return "\u{faaf}"
        case .stackedAreaChartFullBold: return "\u{fab0}"
        case .stackedAreaChartFullFilled: return "\u{fab1}"
        case .stackedAreaChartFullLight: return "\u{fab2}"
        case .stackedAreaChartFullRegular: return "\u{fab3}"
        case .stackedAreaChartLight: return "\u{fab4}"
        case .stackedAreaChartRegular: return "\u{fab5}"
        case .stackedBarChartBold: return "\u{fab6}"
        case .stackedBarChartFilled: return "\u{fab7}"
        case .stackedBarChartFullBold: return "\u{fab8}"
        case .stackedBarChartFullFilled: return "\u{fab9}"
        case .stackedBarChartFullLight: return "\u{faba}"
        case .stackedBarChartFullRegular: return "\u{fabb}"
        case .stackedBarChartLight: return "\u{fabc}"
        case .stackedBarChartRegular: return "\u{fabd}"
        case .startChatBold: return "\u{fabe}"
        case .startChatLight: return "\u{fabf}"
        case .startChatRegular: return "\u{fac0}"
        case .stethoscopeBold: return "\u{fac1}"
        case .stethoscopeLight: return "\u{fac2}"
        case .stethoscopeRegular: return "\u{fac3}"
        case .stickersBold: return "\u{fac4}"
        case .stickersLight: return "\u{fac5}"
        case .stickersRegular: return "\u{fac6}"
        case .stickiesBold: return "\u{fac7}"
        case .stickiesLight: return "\u{fac8}"
        case .stickiesRegular: return "\u{fac9}"
        case .stopBold: return "\u{faca}"
        case .stopCircleBold: return "\u{facb}"
        case .stopCircleFilled: return "\u{facc}"
        case .stopCircleLight: return "\u{facd}"
        case .stopCircleRegular: return "\u{face}"
        case .stopContentShareBold: return "\u{facf}"
        case .stopContentShareLight: return "\u{fad0}"
        case .stopContentShareRegular: return "\u{fad1}"
        case .stopFilled: return "\u{fad2}"
        case .stopLight: return "\u{fad3}"
        case .stopRegular: return "\u{fad4}"
        case .storedInfoBold: return "\u{fad5}"
        case .storedInfoFilled: return "\u{fad6}"
        case .storedInfoLight: return "\u{fad7}"
        case .storedInfoRegular: return "\u{fad8}"
        case .streamingBold: return "\u{fad9}"
        case .streamingLight: return "\u{fada}"
        case .streamingRegular: return "\u{fadb}"
        case .strikethroughBold: return "\u{fadc}"
        case .strikethroughFilled: return "\u{fadd}"
        case .strikethroughLight: return "\u{fade}"
        case .strikethroughRegular: return "\u{fadf}"
        case .studioModeBold: return "\u{fae0}"
        case .studioModeLight: return "\u{fae1}"
        case .studioModeRegular: return "\u{fae2}"
        case .subscriptBold: return "\u{fae3}"
        case .subscriptLight: return "\u{fae4}"
        case .subscriptRegular: return "\u{fae5}"
        case .superscriptBold: return "\u{fae6}"
        case .superscriptLight: return "\u{fae7}"
        case .superscriptRegular: return "\u{fae8}"
        case .surveyBold: return "\u{fae9}"
        case .surveyFilled: return "\u{faea}"
        case .surveyLight: return "\u{faeb}"
        case .surveyRegular: return "\u{faec}"
        case .sxEightyCodecBold: return "\u{faed}"
        case .sxEightyCodecLight: return "\u{faee}"
        case .sxEightyCodecRegular: return "\u{faef}"
        case .sxTenBold: return "\u{faf0}"
        case .sxTenLight: return "\u{faf1}"
        case .sxTenRegular: return "\u{faf2}"
        case .sxTwentyBold: return "\u{faf3}"
        case .sxTwentyLight: return "\u{faf4}"
        case .sxTwentyRegular: return "\u{faf5}"
        case .tableBold: return "\u{faf6}"
        case .tableLight: return "\u{faf7}"
        case .tableRegular: return "\u{faf8}"
        case .tabletBold: return "\u{faf9}"
        case .tabletLight: return "\u{fafa}"
        case .tabletRegular: return "\u{fafb}"
        case .tabsBold: return "\u{fafc}"
        case .tabsLight: return "\u{fafd}"
        case .tabsRegular: return "\u{fafe}"
        case .tagBold: return "\u{faff}"
        case .tagLight: return "\u{fb00}"
        case .tagRegular: return "\u{fb01}"
        case .tapBold: return "\u{fb02}"
        case .tapFilled: return "\u{fb03}"
        case .tapLight: return "\u{fb04}"
        case .tapRegular: return "\u{fb05}"
        case .telepresenceAlertBold: return "\u{fb06}"
        case .telepresenceAlertLight: return "\u{fb07}"
        case .telepresenceAlertMutedBold: return "\u{fb08}"
        case .telepresenceAlertMutedLight: return "\u{fb09}"
        case .telepresenceAlertMutedRegular: return "\u{fb0a}"
        case .telepresenceAlertRegular: return "\u{fb0b}"
        case .telepresenceBold: return "\u{fb0c}"
        case .telepresenceIxFiveThousandBold: return "\u{fb0d}"
        case .telepresenceIxFiveThousandLight: return "\u{fb0e}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb0f}"
        case .telepresenceLight: return "\u{fb10}"
        case .telepresenceMutedBold: return "\u{fb11}"
        case .telepresenceMutedLight: return "\u{fb12}"
        case .telepresenceMutedRegular: return "\u{fb13}"
        case .telepresencePrivateBold: return "\u{fb14}"
        case .telepresencePrivateLight: return "\u{fb15}"
        case .telepresencePrivateRegular: return "\u{fb16}"
        case .telepresenceRegular: return "\u{fb17}"
        case .temperatureBold: return "\u{fb18}"
        case .temperatureLight: return "\u{fb19}"
        case .temperatureRegular: return "\u{fb1a}"
        case .testTubeBold: return "\u{fb1b}"
        case .testTubeFilled: return "\u{fb1c}"
        case .testTubeLight: return "\u{fb1d}"
        case .testTubeRegular: return "\u{fb1e}"
        case .textAlignCenterBold: return "\u{fb1f}"
        case .textAlignCenterFilled: return "\u{fb20}"
        case .textAlignCenterLight: return "\u{fb21}"
        case .textAlignCenterRegular: return "\u{fb22}"
        case .textAlignLeftBold: return "\u{fb23}"
        case .textAlignLeftFilled: return "\u{fb24}"
        case .textAlignLeftLight: return "\u{fb25}"
        case .textAlignLeftRegular: return "\u{fb26}"
        case .textAlignRightBold: return "\u{fb27}"
        case .textAlignRightFilled: return "\u{fb28}"
        case .textAlignRightLight: return "\u{fb29}"
        case .textAlignRightRegular: return "\u{fb2a}"
        case .textBold: return "\u{fb2b}"
        case .textBoxCursorLight: return "\u{fb2c}"
        case .textCodeBlockBold: return "\u{fb2d}"
        case .textCodeBlockLight: return "\u{fb2e}"
        case .textCodeBlockRegular: return "\u{fb2f}"
        case .textHighlightBold: return "\u{fb30}"
        case .textHighlightFilled: return "\u{fb31}"
        case .textHighlightLight: return "\u{fb32}"
        case .textHighlightRegular: return "\u{fb33}"
        case .textLight: return "\u{fb34}"
        case .textRegular: return "\u{fb35}"
        case .threeColumnBold: return "\u{fb36}"
        case .threeColumnLight: return "\u{fb37}"
        case .threeColumnRegular: return "\u{fb38}"
        case .threeDObjectBold: return "\u{fb39}"
        case .threeDObjectLight: return "\u{fb3a}"
        case .threeDObjectRegular: return "\u{fb3b}"
        case .timeExclusionBold: return "\u{fb3c}"
        case .timeExclusionLight: return "\u{fb3d}"
        case .timeExclusionRegular: return "\u{fb3e}"
        case .tooFastBold: return "\u{fb3f}"
        case .tooFastLight: return "\u{fb40}"
        case .tooFastRegular: return "\u{fb41}"
        case .tooSlowBold: return "\u{fb42}"
        case .tooSlowLight: return "\u{fb43}"
        case .tooSlowRegular: return "\u{fb44}"
        case .toolsBold: return "\u{fb45}"
        case .toolsFilled: return "\u{fb46}"
        case .toolsLight: return "\u{fb47}"
        case .toolsRegular: return "\u{fb48}"
        case .touchTenBold: return "\u{fb49}"
        case .touchTenLight: return "\u{fb4a}"
        case .touchTenRegular: return "\u{fb4b}"
        case .transcriptBold: return "\u{fb4c}"
        case .transcriptFilled: return "\u{fb4d}"
        case .transcriptLight: return "\u{fb4e}"
        case .transcriptRegular: return "\u{fb4f}"
        case .translateBold: return "\u{fb50}"
        case .translateLight: return "\u{fb51}"
        case .translateRegular: return "\u{fb52}"
        case .translateUndoBold: return "\u{fb53}"
        case .translateUndoLight: return "\u{fb54}"
        case .translateUndoRegular: return "\u{fb55}"
        case .trendingBold: return "\u{fb56}"
        case .trendingDownBold: return "\u{fb57}"
        case .trendingDownFilled: return "\u{fb58}"
        case .trendingDownLight: return "\u{fb59}"
        case .trendingDownRegular: return "\u{fb5a}"
        case .trendingFilled: return "\u{fb5b}"
        case .trendingLight: return "\u{fb5c}"
        case .trendingRegular: return "\u{fb5d}"
        case .trimBold: return "\u{fb5e}"
        case .trimLight: return "\u{fb5f}"
        case .trimRegular: return "\u{fb60}"
        case .twoColumnBold: return "\u{fb61}"
        case .twoColumnLight: return "\u{fb62}"
        case .twoColumnRegular: return "\u{fb63}"
        case .twoWayVoiceStreamBold: return "\u{fb64}"
        case .twoWayVoiceStreamFilled: return "\u{fb65}"
        case .twoWayVoiceStreamLight: return "\u{fb66}"
        case .twoWayVoiceStreamRegular: return "\u{fb67}"
        case .ucmCloudBold: return "\u{fb68}"
        case .ucmCloudLight: return "\u{fb69}"
        case .ucmCloudRegular: return "\u{fb6a}"
        case .unblockBold: return "\u{fb6b}"
        case .unblockFilled: return "\u{fb6c}"
        case .unblockLight: return "\u{fb6d}"
        case .unblockRegular: return "\u{fb6e}"
        case .underlineBold: return "\u{fb6f}"
        case .underlineFilled: return "\u{fb70}"
        case .underlineLight: return "\u{fb71}"
        case .underlineRegular: return "\u{fb72}"
        case .undoBold: return "\u{fb73}"
        case .undoLight: return "\u{fb74}"
        case .undoRegular: return "\u{fb75}"
        case .unlinkBold: return "\u{fb76}"
        case .unlinkLight: return "\u{fb77}"
        case .unlinkRegular: return "\u{fb78}"
        case .unreadBold: return "\u{fb79}"
        case .unreadFilled: return "\u{fb7a}"
        case .unreadLight: return "\u{fb7b}"
        case .unreadRegular: return "\u{fb7c}"
        case .unsecureUnlockedBold: return "\u{fb7d}"
        case .unsecureUnlockedFilled: return "\u{fb7e}"
        case .unsecureUnlockedLight: return "\u{fb7f}"
        case .unsecureUnlockedRegular: return "\u{fb80}"
        case .unsortedBold: return "\u{fb81}"
        case .unsortedLight: return "\u{fb82}"
        case .unsortedRegular: return "\u{fb83}"
        case .updateFileShareBold: return "\u{fb84}"
        case .updateFileShareLight: return "\u{fb85}"
        case .updateFileShareRegular: return "\u{fb86}"
        case .uploadBold: return "\u{fb87}"
        case .uploadImageBold: return "\u{fb88}"
        case .uploadImageLight: return "\u{fb89}"
        case .uploadImageRegular: return "\u{fb8a}"
        case .uploadLight: return "\u{fb8b}"
        case .uploadRegular: return "\u{fb8c}"
        case .urgentVoicemailBold: return "\u{fb8d}"
        case .urgentVoicemailFilled: return "\u{fb8e}"
        case .usbBold: return "\u{fb8f}"
        case .usbHeadsetBold: return "\u{fb90}"
        case .usbHeadsetLight: return "\u{fb91}"
        case .usbHeadsetMutedBold: return "\u{fb92}"
        case .usbHeadsetMutedLight: return "\u{fb93}"
        case .usbHeadsetMutedRegular: return "\u{fb94}"
        case .usbHeadsetRegular: return "\u{fb95}"
        case .usbLight: return "\u{fb96}"
        case .usbRegular: return "\u{fb97}"
        case .userBold: return "\u{fb98}"
        case .userDeactivateBold: return "\u{fb99}"
        case .userDeactivateLight: return "\u{fb9a}"
        case .userDeactivateRegular: return "\u{fb9b}"
        case .userLight: return "\u{fb9c}"
        case .userRegular: return "\u{fb9d}"
        case .videoBlurBold: return "\u{fb9e}"
        case .videoBlurFilled: return "\u{fb9f}"
        case .videoBlurLight: return "\u{fba0}"
        case .videoBlurRegular: return "\u{fba1}"
        case .videoBold: return "\u{fba2}"
        case .videoEffectBold: return "\u{fba3}"
        case .videoEffectFilled: return "\u{fba4}"
        case .videoEffectLight: return "\u{fba5}"
        case .videoEffectRegular: return "\u{fba6}"
        case .videoFilled: return "\u{fba7}"
        case .videoLayoutBold: return "\u{fba8}"
        case .videoLayoutEqualBold: return "\u{fba9}"
        case .videoLayoutEqualDualBold: return "\u{fbaa}"
        case .videoLayoutEqualDualLight: return "\u{fbab}"
        case .videoLayoutEqualDualRegular: return "\u{fbac}"
        case .videoLayoutEqualFilled: return "\u{fbad}"
        case .videoLayoutEqualLight: return "\u{fbae}"
        case .videoLayoutEqualRegular: return "\u{fbaf}"
        case .videoLayoutFilled: return "\u{fbb0}"
        case .videoLayoutLight: return "\u{fbb1}"
        case .videoLayoutOverlayBold: return "\u{fbb2}"
        case .videoLayoutOverlayFilled: return "\u{fbb3}"
        case .videoLayoutOverlayLight: return "\u{fbb4}"
        case .videoLayoutOverlayRegular: return "\u{fbb5}"
        case .videoLayoutPresenterDominantBold: return "\u{fbb6}"
        case .videoLayoutPresenterDominantLight: return "\u{fbb7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbb8}"
        case .videoLayoutProminentBold: return "\u{fbb9}"
        case .videoLayoutProminentFilled: return "\u{fbba}"
        case .videoLayoutProminentLight: return "\u{fbbb}"
        case .videoLayoutProminentRegular: return "\u{fbbc}"
        case .videoLayoutRegular: return "\u{fbbd}"
        case .videoLayoutShareDominantBold: return "\u{fbbe}"
        case .videoLayoutShareDominantLight: return "\u{fbbf}"
        case .videoLayoutShareDominantRegular: return "\u{fbc0}"
        case .videoLayoutSingleBold: return "\u{fbc1}"
        case .videoLayoutSingleFilled: return "\u{fbc2}"
        case .videoLayoutSingleLight: return "\u{fbc3}"
        case .videoLayoutSingleRegular: return "\u{fbc4}"
        case .videoLayoutStackBold: return "\u{fbc5}"
        case .videoLayoutStackFilled: return "\u{fbc6}"
        case .videoLayoutStackLight: return "\u{fbc7}"
        case .videoLayoutStackRegular: return "\u{fbc8}"
        case .videoLayoutVideoDominantBold: return "\u{fbc9}"
        case .videoLayoutVideoDominantFilled: return "\u{fbca}"
        case .videoLayoutVideoDominantLight: return "\u{fbcb}"
        case .videoLayoutVideoDominantRegular: return "\u{fbcc}"
        case .videoLight: return "\u{fbcd}"
        case .videoPlusBold: return "\u{fbce}"
        case .videoPlusFilled: return "\u{fbcf}"
        case .videoPlusLight: return "\u{fbd0}"
        case .videoPlusRegular: return "\u{fbd1}"
        case .videoRegular: return "\u{fbd2}"
        case .videoSpeakerTrackBold: return "\u{fbd3}"
        case .videoSpeakerTrackFilled: return "\u{fbd4}"
        case .videoSpeakerTrackLight: return "\u{fbd5}"
        case .videoSpeakerTrackRegular: return "\u{fbd6}"
        case .viewAllBold: return "\u{fbd7}"
        case .viewAllLight: return "\u{fbd8}"
        case .viewAllRegular: return "\u{fbd9}"
        case .viewListBold: return "\u{fbda}"
        case .viewListFilled: return "\u{fbdb}"
        case .viewListLight: return "\u{fbdc}"
        case .viewListRegular: return "\u{fbdd}"
        case .viewStackedBold: return "\u{fbde}"
        case .viewStackedFilled: return "\u{fbdf}"
        case .viewStackedLight: return "\u{fbe0}"
        case .viewStackedRegular: return "\u{fbe1}"
        case .viewThumbnailBold: return "\u{fbe2}"
        case .viewThumbnailFilled: return "\u{fbe3}"
        case .viewThumbnailLight: return "\u{fbe4}"
        case .viewThumbnailRegular: return "\u{fbe5}"
        case .visionproBold: return "\u{fbe6}"
        case .visionproFilled: return "\u{fbe7}"
        case .visionproLight: return "\u{fbe8}"
        case .visionproMoveCallInBold: return "\u{fbe9}"
        case .visionproMoveCallInFilled: return "\u{fbea}"
        case .visionproMoveCallInLight: return "\u{fbeb}"
        case .visionproMoveCallInOutBold: return "\u{fbec}"
        case .visionproMoveCallInOutFilled: return "\u{fbed}"
        case .visionproMoveCallInOutLight: return "\u{fbee}"
        case .visionproMoveCallInOutRegular: return "\u{fbef}"
        case .visionproMoveCallInRegular: return "\u{fbf0}"
        case .visionproMoveCallOutBold: return "\u{fbf1}"
        case .visionproMoveCallOutFilled: return "\u{fbf2}"
        case .visionproMoveCallOutLight: return "\u{fbf3}"
        case .visionproMoveCallOutRegular: return "\u{fbf4}"
        case .visionproRegular: return "\u{fbf5}"
        case .voicemailBold: return "\u{fbf6}"
        case .voicemailFilled: return "\u{fbf7}"
        case .voicemailLight: return "\u{fbf8}"
        case .voicemailRegular: return "\u{fbf9}"
        case .vpnBold: return "\u{fbfa}"
        case .vpnFilled: return "\u{fbfb}"
        case .vpnLight: return "\u{fbfc}"
        case .vpnRegular: return "\u{fbfd}"
        case .vscBold: return "\u{fbfe}"
        case .vscLight: return "\u{fbff}"
        case .vscRegular: return "\u{fc00}"
        case .waffleMenuBold: return "\u{fc01}"
        case .waffleMenuLight: return "\u{fc02}"
        case .waffleMenuRegular: return "\u{fc03}"
        case .waitingRoomBold: return "\u{fc04}"
        case .waitingRoomLight: return "\u{fc05}"
        case .waitingRoomRegular: return "\u{fc06}"
        case .wallpaperBold: return "\u{fc07}"
        case .wallpaperLight: return "\u{fc08}"
        case .wallpaperRegular: return "\u{fc09}"
        case .warningBadgeFilled: return "\u{fc0a}"
        case .warningBold: return "\u{fc0b}"
        case .warningFilled: return "\u{fc0c}"
        case .warningLight: return "\u{fc0d}"
        case .warningRegular: return "\u{fc0e}"
        case .webexBoardBold: return "\u{fc0f}"
        case .webexBoardLight: return "\u{fc10}"
        case .webexBoardRegular: return "\u{fc11}"
        case .webexCodecPlusBold: return "\u{fc12}"
        case .webexCodecPlusLight: return "\u{fc13}"
        case .webexCodecPlusRegular: return "\u{fc14}"
        case .webexDeskCameraBold: return "\u{fc15}"
        case .webexDeskCameraLight: return "\u{fc16}"
        case .webexDeskCameraRegular: return "\u{fc17}"
        case .webexHelixBold: return "\u{fc18}"
        case .webexHelixLight: return "\u{fc19}"
        case .webexHelixRegular: return "\u{fc1a}"
        case .webexMeetingsBold: return "\u{fc1b}"
        case .webexMeetingsFilled: return "\u{fc1c}"
        case .webexMeetingsLight: return "\u{fc1d}"
        case .webexMeetingsRegular: return "\u{fc1e}"
        case .webexQuadCameraBold: return "\u{fc1f}"
        case .webexQuadCameraLight: return "\u{fc20}"
        case .webexQuadCameraRegular: return "\u{fc21}"
        case .webexRoomKitBold: return "\u{fc22}"
        case .webexRoomKitLight: return "\u{fc23}"
        case .webexRoomKitPlusBold: return "\u{fc24}"
        case .webexRoomKitPlusLight: return "\u{fc25}"
        case .webexRoomKitPlusRegular: return "\u{fc26}"
        case .webexRoomKitRegular: return "\u{fc27}"
        case .webexShareBold: return "\u{fc28}"
        case .webexShareLight: return "\u{fc29}"
        case .webexShareRegular: return "\u{fc2a}"
        case .webexTeamsBold: return "\u{fc2b}"
        case .webexTeamsFilled: return "\u{fc2c}"
        case .webexTeamsLight: return "\u{fc2d}"
        case .webexTeamsNewBold: return "\u{fc2e}"
        case .webexTeamsNewFilled: return "\u{fc2f}"
        case .webexTeamsNewLight: return "\u{fc30}"
        case .webexTeamsNewRegular: return "\u{fc31}"
        case .webexTeamsRegular: return "\u{fc32}"
        case .webexTeamsRemoveBold: return "\u{fc33}"
        case .webexTeamsRemoveLight: return "\u{fc34}"
        case .webexTeamsRemoveRegular: return "\u{fc35}"
        case .webinarBold: return "\u{fc36}"
        case .webinarFilled: return "\u{fc37}"
        case .webinarLight: return "\u{fc38}"
        case .webinarRegular: return "\u{fc39}"
        case .weeklyRecurringScheduleBold: return "\u{fc3a}"
        case .weeklyRecurringScheduleLight: return "\u{fc3b}"
        case .weeklyRecurringScheduleRegular: return "\u{fc3c}"
        case .whisperAnnouncementBold: return "\u{fc3d}"
        case .whisperAnnouncementFilled: return "\u{fc3e}"
        case .whisperAnnouncementLight: return "\u{fc3f}"
        case .whisperAnnouncementRegular: return "\u{fc40}"
        case .whisperCoachBold: return "\u{fc41}"
        case .whisperCoachFilled: return "\u{fc42}"
        case .whisperCoachLight: return "\u{fc43}"
        case .whisperCoachRegular: return "\u{fc44}"
        case .whiteboardBold: return "\u{fc45}"
        case .whiteboardContentBold: return "\u{fc46}"
        case .whiteboardContentFilled: return "\u{fc47}"
        case .whiteboardContentLight: return "\u{fc48}"
        case .whiteboardContentRegular: return "\u{fc49}"
        case .whiteboardFilled: return "\u{fc4a}"
        case .whiteboardLight: return "\u{fc4b}"
        case .whiteboardRegular: return "\u{fc4c}"
        case .widgetBold: return "\u{fc4d}"
        case .widgetFilled: return "\u{fc4e}"
        case .widgetLight: return "\u{fc4f}"
        case .widgetRegular: return "\u{fc50}"
        case .wifiBold: return "\u{fc51}"
        case .wifiErrorBold: return "\u{fc52}"
        case .wifiErrorLight: return "\u{fc53}"
        case .wifiErrorRegular: return "\u{fc54}"
        case .wifiLight: return "\u{fc55}"
        case .wifiRegular: return "\u{fc56}"
        case .wifiSignalGoodBold: return "\u{fc57}"
        case .wifiSignalGoodLight: return "\u{fc58}"
        case .wifiSignalGoodRegular: return "\u{fc59}"
        case .wifiSignalPoorBold: return "\u{fc5a}"
        case .wifiSignalPoorLight: return "\u{fc5b}"
        case .wifiSignalPoorRegular: return "\u{fc5c}"
        case .wifiSignalUnstableBold: return "\u{fc5d}"
        case .wifiSignalUnstableLight: return "\u{fc5e}"
        case .wifiSignalUnstableRegular: return "\u{fc5f}"
        case .windowCornerScrubBold: return "\u{fc60}"
        case .windowCornerScrubLight: return "\u{fc61}"
        case .windowCornerScrubRegular: return "\u{fc62}"
        case .windowRightCornerScrubBold: return "\u{fc63}"
        case .windowRightCornerScrubLight: return "\u{fc64}"
        case .windowRightCornerScrubRegular: return "\u{fc65}"
        case .windowVerticalScrubBold: return "\u{fc66}"
        case .windowVerticalScrubLight: return "\u{fc67}"
        case .windowVerticalScrubRegular: return "\u{fc68}"
        case .workflowDeploymentsBold: return "\u{fc69}"
        case .workflowDeploymentsFilled: return "\u{fc6a}"
        case .workflowDeploymentsLight: return "\u{fc6b}"
        case .workflowDeploymentsRegular: return "\u{fc6c}"
        case .workphoneBold: return "\u{fc6d}"
        case .workphoneLight: return "\u{fc6e}"
        case .workphoneRegular: return "\u{fc6f}"
        case .zoomInBold: return "\u{fc70}"
        case .zoomInLight: return "\u{fc71}"
        case .zoomInRegular: return "\u{fc72}"
        case .zoomOutBold: return "\u{fc73}"
        case .zoomOutLight: return "\u{fc74}"
        case .zoomOutRegular: return "\u{fc75}"
