...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .speedDialBold: return "\u{fb99}"
        case .speedDialFilled: return "\u{fb9a}"
        case .speedDialLight: return "\u{fb9b}"
        case .speedDialRegular: return "\u{fb9c}"
        case .spellCheckerBold: return "\u{fb9d}"
        case .spellCheckerLight: return "\u{fb9e}"
        case .spellCheckerRegular: return "\u{fb9f}"
        case .splitViewBold: return "\u{fba0}"
        case .splitViewLight: return "\u{fba1}"
        case .splitViewRegular: return "\u{fba2}"
        case .stackedAreaChartBold: return "\u{fba3}"
        case .stackedAreaChartFilled: return "\u{fba4}"
        case .stackedAreaChartFullBold: return "\u{fba5}"
        case .stackedAreaChartFullFilled: return "\u{fba6}"
        case .stackedAreaChartFullLight: return "\u{fba7}"
        case .stackedAreaChartFullRegular: return "\u{fba8}"
        case .stackedAreaChartLight: return "\u{fba9}"
        case .stackedAreaChartRegular: return "\u{fbaa}"
        case .stackedBarChartBold: return "\u{fbab}"
        case .stackedBarChartFilled: return "\u{fbac}"
        case .stackedBarChartFullBold: return "\u{fbad}"
        case .stackedBarChartFullFilled: return "\u{fbae}"
        case .stackedBarChartFullLight: return "\u{fbaf}"
        case .stackedBarChartFullRegular: return "\u{fbb0}"
        case .stackedBarChartLight: return "\u{fbb1}"
        case .stackedBarChartRegular: return "\u{fbb2}"
        case .startChatBold: return "\u{fbb3}"
        case .startChatLight: return "\u{fbb4}"
        case .startChatRegular: return "\u{fbb5}"
        case .stethoscopeBold: return "\u{fbb6}"
        case .stethoscopeLight: return "\u{fbb7}"
        case .stethoscopeRegular: return "\u{fbb8}"
        case .stickersBold: return "\u{fbb9}"
        case .stickersLight: return "\u{fbba}"
        case .stickersRegular: return "\u{fbbb}"
        case .stickiesBold: return "\u{fbbc}"
        case .stickiesLight: return "\u{fbbd}"
        case .stickiesRegular: return "\u{fbbe}"
        case .stopBold: return "\u{fbbf}"
        case .stopCircleBold: return "\u{fbc0}"
        case .stopCircleFilled: return "\u{fbc1}"
        case .stopCircleLight: return "\u{fbc2}"
        case .stopCircleRegular: return "\u{fbc3}"
        case .stopContentShareBold: return "\u{fbc4}"
        case .stopContentShareLight: return "\u{fbc5}"
        case .stopContentShareRegular: return "\u{fbc6}"
        case .stopFilled: return "\u{fbc7}"
        case .stopLight: return "\u{fbc8}"
        case .stopRegular: return "\u{fbc9}"
        case .storedInfoBold: return "\u{fbca}"
        case .storedInfoFilled: return "\u{fbcb}"
        case .storedInfoLight: return "\u{fbcc}"
        case .storedInfoRegular: return "\u{fbcd}"
        case .streamingBold: return "\u{fbce}"
        case .streamingLight: return "\u{fbcf}"
        case .streamingRegular: return "\u{fbd0}"
        case .strikethroughBold: return "\u{fbd1}"
        case .strikethroughFilled: return "\u{fbd2}"
        case .strikethroughLight: return "\u{fbd3}"
        case .strikethroughRegular: return "\u{fbd4}"
        case .studioModeBold: return "\u{fbd5}"
        case .studioModeLight: return "\u{fbd6}"
        case .studioModeRegular: return "\u{fbd7}"
        case .subscriptBold: return "\u{fbd8}"
        case .subscriptLight: return "\u{fbd9}"
        case .subscriptRegular: return "\u{fbda}"
        case .summarizeAiBold: return "\u{fbdb}"
        case .summarizeAiLight: return "\u{fbdc}"
        case .summarizeAiRegular: return "\u{fbdd}"
        case .superscriptBold: return "\u{fbde}"
        case .superscriptLight: return "\u{fbdf}"
        case .superscriptRegular: return "\u{fbe0}"
        case .surveyBold: return "\u{fbe1}"
        case .surveyFilled: return "\u{fbe2}"
        case .surveyLight: return "\u{fbe3}"
        case .surveyRegular: return "\u{fbe4}"
        case .sxEightyCodecBold: return "\u{fbe5}"
        case .sxEightyCodecLight: return "\u{fbe6}"
        case .sxEightyCodecRegular: return "\u{fbe7}"
        case .sxTenBold: return "\u{fbe8}"
        case .sxTenLight: return "\u{fbe9}"
        case .sxTenRegular: return "\u{fbea}"
        case .sxTwentyBold: return "\u{fbeb}"
        case .sxTwentyLight: return "\u{fbec}"
        case .sxTwentyRegular: return "\u{fbed}"
        case .tableBold: return "\u{fbee}"
        case .tableExtenderBold: return "\u{fbef}"
        case .tableExtenderFilled: return "\u{fbf0}"
        case .tableExtenderLight: return "\u{fbf1}"
        case .tableExtenderRegular: return "\u{fbf2}"
        case .tableLight: return "\u{fbf3}"
        case .tableRegular: return "\u{fbf4}"
        case .tabletBold: return "\u{fbf5}"
        case .tabletLight: return "\u{fbf6}"
        case .tabletRegular: return "\u{fbf7}"
        case .tabsBold: return "\u{fbf8}"
        case .tabsLight: return "\u{fbf9}"
        case .tabsRegular: return "\u{fbfa}"
        case .tagBold: return "\u{fbfb}"
        case .tagLight: return "\u{fbfc}"
        case .tagRegular: return "\u{fbfd}"
        case .tapBold: return "\u{fbfe}"
        case .tapFilled: return "\u{fbff}"
        case .tapLight: return "\u{fc00}"
        case .tapRegular: return "\u{fc01}"
        case .telepresenceAlertBold: return "\u{fc02}"
        case .telepresenceAlertLight: return "\u{fc03}"
        case .telepresenceAlertMutedBold: return "\u{fc04}"
        case .telepresenceAlertMutedLight: return "\u{fc05}"
        case .telepresenceAlertMutedRegular: return "\u{fc06}"
        case .telepresenceAlertRegular: return "\u{fc07}"
        case .telepresenceBold: return "\u{fc08}"
        case .telepresenceIxFiveThousandBold: return "\u{fc09}"
        case .telepresenceIxFiveThousandLight: return "\u{fc0a}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc0b}"
        case .telepresenceLight: return "\u{fc0c}"
        case .telepresenceMutedBold: return "\u{fc0d}"
        case .telepresenceMutedLight: return "\u{fc0e}"
        case .telepresenceMutedRegular: return "\u{fc0f}"
        case .telepresencePrivateBold: return "\u{fc10}"
        case .telepresencePrivateLight: return "\u{fc11}"
        case .telepresencePrivateRegular: return "\u{fc12}"
        case .telepresenceRegular: return "\u{fc13}"
        case .temperatureBold: return "\u{fc14}"
        case .temperatureLight: return "\u{fc15}"
        case .temperatureRegular: return "\u{fc16}"
        case .testTubeBold: return "\u{fc17}"
        case .testTubeFilled: return "\u{fc18}"
        case .testTubeLight: return "\u{fc19}"
        case .testTubeRegular: return "\u{fc1a}"
        case .textAlignCenterBold: return "\u{fc1b}"
        case .textAlignCenterFilled: return "\u{fc1c}"
        case .textAlignCenterLight: return "\u{fc1d}"
        case .textAlignCenterRegular: return "\u{fc1e}"
        case .textAlignLeftBold: return "\u{fc1f}"
        case .textAlignLeftFilled: return "\u{fc20}"
        case .textAlignLeftLight: return "\u{fc21}"
        case .textAlignLeftRegular: return "\u{fc22}"
        case .textAlignRightBold: return "\u{fc23}"
        case .textAlignRightFilled: return "\u{fc24}"
        case .textAlignRightLight: return "\u{fc25}"
        case .textAlignRightRegular: return "\u{fc26}"
        case .textBold: return "\u{fc27}"
        case .textBoxCursorLight: return "\u{fc28}"
        case .textCodeBlockBold: return "\u{fc29}"
        case .textCodeBlockLight: return "\u{fc2a}"
        case .textCodeBlockRegular: return "\u{fc2b}"
        case .textHighlightBold: return "\u{fc2c}"
        case .textHighlightFilled: return "\u{fc2d}"
        case .textHighlightLight: return "\u{fc2e}"
        case .textHighlightRegular: return "\u{fc2f}"
        case .textLight: return "\u{fc30}"
        case .textRegular: return "\u{fc31}"
        case .textShortBold: return "\u{fc32}"
        case .textShortLight: return "\u{fc33}"
        case .textShortRegular: return "\u{fc34}"
        case .threeColumnBold: return "\u{fc35}"
        case .threeColumnLight: return "\u{fc36}"
        case .threeColumnRegular: return "\u{fc37}"
        case .threeDObjectBold: return "\u{fc38}"
        case .threeDObjectLight: return "\u{fc39}"
        case .threeDObjectRegular: return "\u{fc3a}"
        case .timeExclusionBold: return "\u{fc3b}"
        case .timeExclusionLight: return "\u{fc3c}"
        case .timeExclusionRegular: return "\u{fc3d}"
        case .timezoneBold: return "\u{fc3e}"
        case .timezoneFilled: return "\u{fc3f}"
        case .timezoneLight: return "\u{fc40}"
        case .timezoneRegular: return "\u{fc41}"
        case .tooFastBold: return "\u{fc42}"
        case .tooFastLight: return "\u{fc43}"
        case .tooFastRegular: return "\u{fc44}"
        case .tooSlowBold: return "\u{fc45}"
        case .tooSlowLight: return "\u{fc46}"
        case .tooSlowRegular: return "\u{fc47}"
        case .toolsBold: return "\u{fc48}"
        case .toolsFilled: return "\u{fc49}"
        case .toolsLight: return "\u{fc4a}"
        case .toolsRegular: return "\u{fc4b}"
        case .touchTenBold: return "\u{fc4c}"
        case .touchTenLight: return "\u{fc4d}"
        case .touchTenRegular: return "\u{fc4e}"
        case .trackingBold: return "\u{fc4f}"
        case .trackingFilled: return "\u{fc50}"
        case .trackingLight: return "\u{fc51}"
        case .trackingRegular: return "\u{fc52}"
        case .transcriptBold: return "\u{fc53}"
        case .transcriptFilled: return "\u{fc54}"
        case .transcriptLight: return "\u{fc55}"
        case .transcriptRegular: return "\u{fc56}"
        case .translateBold: return "\u{fc57}"
        case .translateLight: return "\u{fc58}"
        case .translateRegular: return "\u{fc59}"
        case .translateUndoBold: return "\u{fc5a}"
        case .translateUndoLight: return "\u{fc5b}"
        case .translateUndoRegular: return "\u{fc5c}"
        case .trendingBold: return "\u{fc5d}"
        case .trendingDownBold: return "\u{fc5e}"
        case .trendingDownFilled: return "\u{fc5f}"
        case .trendingDownLight: return "\u{fc60}"
        case .trendingDownRegular: return "\u{fc61}"
        case .trendingFilled: return "\u{fc62}"
        case .trendingLight: return "\u{fc63}"
        case .trendingRegular: return "\u{fc64}"
        case .trimBold: return "\u{fc65}"
        case .trimLight: return "\u{fc66}"
        case .trimRegular: return "\u{fc67}"
        case .twoColumnBold: return "\u{fc68}"
        case .twoColumnLight: return "\u{fc69}"
        case .twoColumnRegular: return "\u{fc6a}"
        case .twoWayVoiceStreamBold: return "\u{fc6b}"
        case .twoWayVoiceStreamFilled: return "\u{fc6c}"
        case .twoWayVoiceStreamLight: return "\u{fc6d}"
        case .twoWayVoiceStreamRegular: return "\u{fc6e}"
        case .ucmCloudBold: return "\u{fc6f}"
        case .ucmCloudLight: return "\u{fc70}"
        case .ucmCloudRegular: return "\u{fc71}"
        case .unblockBold: return "\u{fc72}"
        case .unblockFilled: return "\u{fc73}"
        case .unblockLight: return "\u{fc74}"
        case .unblockRegular: return "\u{fc75}"
        case .underlineBold: return "\u{fc76}"
        case .underlineFilled: return "\u{fc77}"
        case .underlineLight: return "\u{fc78}"
        case .underlineRegular: return "\u{fc79}"
        case .undoBold: return "\u{fc7a}"
        case .undoLight: return "\u{fc7b}"
        case .undoRegular: return "\u{fc7c}"
        case .unlinkBold: return "\u{fc7d}"
        case .unlinkLight: return "\u{fc7e}"
        case .unlinkRegular: return "\u{fc7f}"
        case .unreadBold: return "\u{fc80}"
        case .unreadFilled: return "\u{fc81}"
        case .unreadLight: return "\u{fc82}"
        case .unreadRegular: return "\u{fc83}"
        case .unsecureUnlockedBold: return "\u{fc84}"
        case .unsecureUnlockedFilled: return "\u{fc85}"
        case .unsecureUnlockedLight: return "\u{fc86}"
        case .unsecureUnlockedRegular: return "\u{fc87}"
        case .unsortedBold: return "\u{fc88}"
        case .unsortedLight: return "\u{fc89}"
        case .unsortedRegular: return "\u{fc8a}"
        case .updateFileShareBold: return "\u{fc8b}"
        case .updateFileShareLight: return "\u{fc8c}"
        case .updateFileShareRegular: return "\u{fc8d}"
        case .uploadBold: return "\u{fc8e}"
        case .uploadImageBold: return "\u{fc8f}"
        case .uploadImageLight: return "\u{fc90}"
        case .uploadImageRegular: return "\u{fc91}"
        case .uploadLight: return "\u{fc92}"
        case .uploadRegular: return "\u{fc93}"
        case .urgentVoicemailBold: return "\u{fc94}"
        case .urgentVoicemailFilled: return "\u{fc95}"
        case .usbBold: return "\u{fc96}"
        case .usbHeadsetBold: return "\u{fc97}"
        case .usbHeadsetLight: return "\u{fc98}"
        case .usbHeadsetMutedBold: return "\u{fc99}"
        case .usbHeadsetMutedLight: return "\u{fc9a}"
        case .usbHeadsetMutedRegular: return "\u{fc9b}"
        case .usbHeadsetRegular: return "\u{fc9c}"
        case .usbLight: return "\u{fc9d}"
        case .usbRegular: return "\u{fc9e}"
        case .userBold: return "\u{fc9f}"
        case .userDeactivateBold: return "\u{fca0}"
        case .userDeactivateLight: return "\u{fca1}"
        case .userDeactivateRegular: return "\u{fca2}"
        case .userFilled: return "\u{fca3}"
        case .userLight: return "\u{fca4}"
        case .userRegular: return "\u{fca5}"
        case .userSecurityStatusBold: return "\u{fca6}"
        case .userSecurityStatusFilled: return "\u{fca7}"
        case .userSecurityStatusLight: return "\u{fca8}"
        case .userSecurityStatusRegular: return "\u{fca9}"
        case .videoBlurBold: return "\u{fcaa}"
        case .videoBlurFilled: return "\u{fcab}"
        case .videoBlurLight: return "\u{fcac}"
        case .videoBlurRegular: return "\u{fcad}"
        case .videoBold: return "\u{fcae}"
        case .videoEffectBold: return "\u{fcaf}"
        case .videoEffectFilled: return "\u{fcb0}"
        case .videoEffectLight: return "\u{fcb1}"
        case .videoEffectRegular: return "\u{fcb2}"
        case .videoFilled: return "\u{fcb3}"
        case .videoLayoutBold: return "\u{fcb4}"
        case .videoLayoutCustomBold: return "\u{fcb5}"
        case .videoLayoutCustomFilled: return "\u{fcb6}"
        case .videoLayoutCustomLight: return "\u{fcb7}"
        case .videoLayoutCustomRegular: return "\u{fcb8}"
        case .videoLayoutEqualBold: return "\u{fcb9}"
        case .videoLayoutEqualDualBold: return "\u{fcba}"
        case .videoLayoutEqualDualLight: return "\u{fcbb}"
        case .videoLayoutEqualDualRegular: return "\u{fcbc}"
        case .videoLayoutEqualFilled: return "\u{fcbd}"
        case .videoLayoutEqualLight: return "\u{fcbe}"
        case .videoLayoutEqualRegular: return "\u{fcbf}"
        case .videoLayoutFilled: return "\u{fcc0}"
        case .videoLayoutLight: return "\u{fcc1}"
        case .videoLayoutOverlayBold: return "\u{fcc2}"
        case .videoLayoutOverlayFilled: return "\u{fcc3}"
        case .videoLayoutOverlayLight: return "\u{fcc4}"
        case .videoLayoutOverlayRegular: return "\u{fcc5}"
        case .videoLayoutPresentationBold: return "\u{fcc6}"
        case .videoLayoutPresentationFilled: return "\u{fcc7}"
        case .videoLayoutPresentationLight: return "\u{fcc8}"
        case .videoLayoutPresentationRegular: return "\u{fcc9}"
        case .videoLayoutPresenterDominantBold: return "\u{fcca}"
        case .videoLayoutPresenterDominantLight: return "\u{fccb}"
        case .videoLayoutPresenterDominantRegular: return "\u{fccc}"
        case .videoLayoutProminentBold: return "\u{fccd}"
        case .videoLayoutProminentFilled: return "\u{fcce}"
        case .videoLayoutProminentLight: return "\u{fccf}"
        case .videoLayoutProminentRegular: return "\u{fcd0}"
        case .videoLayoutRegular: return "\u{fcd1}"
        case .videoLayoutShareDominantBold: return "\u{fcd2}"
        case .videoLayoutShareDominantLight: return "\u{fcd3}"
        case .videoLayoutShareDominantRegular: return "\u{fcd4}"
        case .videoLayoutSingleBold: return "\u{fcd5}"
        case .videoLayoutSingleFilled: return "\u{fcd6}"
        case .videoLayoutSingleLight: return "\u{fcd7}"
        case .videoLayoutSingleRegular: return "\u{fcd8}"
        case .videoLayoutSpeakerBold: return "\u{fcd9}"
        case .videoLayoutSpeakerFilled: return "\u{fcda}"
        case .videoLayoutSpeakerLight: return "\u{fcdb}"
        case .videoLayoutSpeakerRegular: return "\u{fcdc}"
        case .videoLayoutStackBold: return "\u{fcdd}"
        case .videoLayoutStackFilled: return "\u{fcde}"
        case .videoLayoutStackLight: return "\u{fcdf}"
        case .videoLayoutStackRegular: return "\u{fce0}"
        case .videoLayoutVideoDominantBold: return "\u{fce1}"
        case .videoLayoutVideoDominantFilled: return "\u{fce2}"
        case .videoLayoutVideoDominantLight: return "\u{fce3}"
        case .videoLayoutVideoDominantRegular: return "\u{fce4}"
        case .videoLight: return "\u{fce5}"
        case .videoPlusBold: return "\u{fce6}"
        case .videoPlusFilled: return "\u{fce7}"
        case .videoPlusLight: return "\u{fce8}"
        case .videoPlusRegular: return "\u{fce9}"
        case .videoRegular: return "\u{fcea}"
        case .videoSpeakerTrackBold: return "\u{fceb}"
        case .videoSpeakerTrackFilled: return "\u{fcec}"
        case .videoSpeakerTrackLight: return "\u{fced}"
        case .videoSpeakerTrackRegular: return "\u{fcee}"
        case .viewAllBold: return "\u{fcef}"
        case .viewAllLight: return "\u{fcf0}"
        case .viewAllRegular: return "\u{fcf1}"
        case .viewListBold: return "\u{fcf2}"
        case .viewListFilled: return "\u{fcf3}"
        case .viewListLight: return "\u{fcf4}"
        case .viewListRegular: return "\u{fcf5}"
        case .viewStackedBold: return "\u{fcf6}"
        case .viewStackedFilled: return "\u{fcf7}"
        case .viewStackedLight: return "\u{fcf8}"
        case .viewStackedRegular: return "\u{fcf9}"
        case .viewThumbnailBold: return "\u{fcfa}"
        case .viewThumbnailFilled: return "\u{fcfb}"
        case .viewThumbnailLight: return "\u{fcfc}"
        case .viewThumbnailRegular: return "\u{fcfd}"
        case .visionproBold: return "\u{fcfe}"
        case .visionproFilled: return "\u{fcff}"
        case .visionproLight: return "\u{fd00}"
        case .visionproMoveCallInBold: return "\u{fd01}"
        case .visionproMoveCallInFilled: return "\u{fd02}"
        case .visionproMoveCallInLight: return "\u{fd03}"
        case .visionproMoveCallInOutBold: return "\u{fd04}"
        case .visionproMoveCallInOutFilled: return "\u{fd05}"
        case .visionproMoveCallInOutLight: return "\u{fd06}"
        case .visionproMoveCallInOutRegular: return "\u{fd07}"
        case .visionproMoveCallInRegular: return "\u{fd08}"
        case .visionproMoveCallOutBold: return "\u{fd09}"
        case .visionproMoveCallOutFilled: return "\u{fd0a}"
        case .visionproMoveCallOutLight: return "\u{fd0b}"
        case .visionproMoveCallOutRegular: return "\u{fd0c}"
        case .visionproRegular: return "\u{fd0d}"
        case .voicemailBold: return "\u{fd0e}"
        case .voicemailFilled: return "\u{fd0f}"
        case .voicemailLight: return "\u{fd10}"
        case .voicemailRegular: return "\u{fd11}"
        case .vpnBold: return "\u{fd12}"
        case .vpnFilled: return "\u{fd13}"
        case .vpnLight: return "\u{fd14}"
        case .vpnRegular: return "\u{fd15}"
        case .vscBold: return "\u{fd16}"
        case .vscLight: return "\u{fd17}"
        case .vscRegular: return "\u{fd18}"
        case .waffleMenuBold: return "\u{fd19}"
        case .waffleMenuLight: return "\u{fd1a}"
        case .waffleMenuRegular: return "\u{fd1b}"
        case .waitingRoomBold: return "\u{fd1c}"
        case .waitingRoomFilled: return "\u{fd1d}"
        case .waitingRoomLight: return "\u{fd1e}"
        case .waitingRoomRegular: return "\u{fd1f}"
        case .wallpaperBold: return "\u{fd20}"
        case .wallpaperLight: return "\u{fd21}"
        case .wallpaperRegular: return "\u{fd22}"
        case .warningBadgeFilled: return "\u{fd23}"
        case .warningBold: return "\u{fd24}"
        case .warningFilled: return "\u{fd25}"
        case .warningLight: return "\u{fd26}"
        case .warningRegular: return "\u{fd27}"
        case .webexBoardBold: return "\u{fd28}"
        case .webexBoardLight: return "\u{fd29}"
        case .webexBoardRegular: return "\u{fd2a}"
        case .webexCodecPlusBold: return "\u{fd2b}"
        case .webexCodecPlusLight: return "\u{fd2c}"
        case .webexCodecPlusRegular: return "\u{fd2d}"
        case .webexDeskCameraBold: return "\u{fd2e}"
        case .webexDeskCameraLight: return "\u{fd2f}"
        case .webexDeskCameraRegular: return "\u{fd30}"
        case .webexHelixBold: return "\u{fd31}"
        case .webexHelixLight: return "\u{fd32}"
        case .webexHelixRegular: return "\u{fd33}"
        case .webexMeetingsBold: return "\u{fd34}"
        case .webexMeetingsFilled: return "\u{fd35}"
        case .webexMeetingsLight: return "\u{fd36}"
        case .webexMeetingsRegular: return "\u{fd37}"
        case .webexQuadCameraBold: return "\u{fd38}"
        case .webexQuadCameraLight: return "\u{fd39}"
        case .webexQuadCameraRegular: return "\u{fd3a}"
        case .webexRoomKitBold: return "\u{fd3b}"
        case .webexRoomKitLight: return "\u{fd3c}"
        case .webexRoomKitPlusBold: return "\u{fd3d}"
        case .webexRoomKitPlusLight: return "\u{fd3e}"
        case .webexRoomKitPlusRegular: return "\u{fd3f}"
        case .webexRoomKitRegular: return "\u{fd40}"
        case .webexShareBold: return "\u{fd41}"
        case .webexShareLight: return "\u{fd42}"
        case .webexShareRegular: return "\u{fd43}"
        case .webexTeamsBold: return "\u{fd44}"
        case .webexTeamsFilled: return "\u{fd45}"
        case .webexTeamsLight: return "\u{fd46}"
        case .webexTeamsNewBold: return "\u{fd47}"
        case .webexTeamsNewFilled: return "\u{fd48}"
        case .webexTeamsNewLight: return "\u{fd49}"
        case .webexTeamsNewRegular: return "\u{fd4a}"
        case .webexTeamsRegular: return "\u{fd4b}"
        case .webexTeamsRemoveBold: return "\u{fd4c}"
        case .webexTeamsRemoveLight: return "\u{fd4d}"
        case .webexTeamsRemoveRegular: return "\u{fd4e}"
        case .webhookBold: return "\u{fd4f}"
        case .webhookLight: return "\u{fd50}"
        case .webhookRegular: return "\u{fd51}"
        case .webinarBold: return "\u{fd52}"
        case .webinarFilled: return "\u{fd53}"
        case .webinarLight: return "\u{fd54}"
        case .webinarRegular: return "\u{fd55}"
        case .weeklyRecurringScheduleBold: return "\u{fd56}"
        case .weeklyRecurringScheduleLight: return "\u{fd57}"
        case .weeklyRecurringScheduleRegular: return "\u{fd58}"
        case .whisperAnnouncementBold: return "\u{fd59}"
        case .whisperAnnouncementFilled: return "\u{fd5a}"
        case .whisperAnnouncementLight: return "\u{fd5b}"
        case .whisperAnnouncementRegular: return "\u{fd5c}"
        case .whisperCoachBold: return "\u{fd5d}"
        case .whisperCoachFilled: return "\u{fd5e}"
        case .whisperCoachLight: return "\u{fd5f}"
        case .whisperCoachRegular: return "\u{fd60}"
        case .whiteboardBold: return "\u{fd61}"
        case .whiteboardContentBold: return "\u{fd62}"
        case .whiteboardContentFilled: return "\u{fd63}"
        case .whiteboardContentLight: return "\u{fd64}"
        case .whiteboardContentRegular: return "\u{fd65}"
        case .whiteboardFilled: return "\u{fd66}"
        case .whiteboardLight: return "\u{fd67}"
        case .whiteboardRegular: return "\u{fd68}"
        case .widgetBold: return "\u{fd69}"
        case .widgetFilled: return "\u{fd6a}"
        case .widgetLight: return "\u{fd6b}"
        case .widgetRegular: return "\u{fd6c}"
        case .wifiBold: return "\u{fd6d}"
        case .wifiErrorBold: return "\u{fd6e}"
        case .wifiErrorLight: return "\u{fd6f}"
        case .wifiErrorRegular: return "\u{fd70}"
        case .wifiLight: return "\u{fd71}"
        case .wifiRegular: return "\u{fd72}"
        case .wifiSignalGoodBold: return "\u{fd73}"
        case .wifiSignalGoodLight: return "\u{fd74}"
        case .wifiSignalGoodRegular: return "\u{fd75}"
        case .wifiSignalPoorBold: return "\u{fd76}"
        case .wifiSignalPoorLight: return "\u{fd77}"
        case .wifiSignalPoorRegular: return "\u{fd78}"
        case .wifiSignalUnstableBold: return "\u{fd79}"
        case .wifiSignalUnstableLight: return "\u{fd7a}"
        case .wifiSignalUnstableRegular: return "\u{fd7b}"
        case .windowCornerScrubBold: return "\u{fd7c}"
        case .windowCornerScrubLight: return "\u{fd7d}"
        case .windowCornerScrubRegular: return "\u{fd7e}"
        case .windowRightCornerScrubBold: return "\u{fd7f}"
        case .windowRightCornerScrubLight: return "\u{fd80}"
        case .windowRightCornerScrubRegular: return "\u{fd81}"
        case .windowVerticalScrubBold: return "\u{fd82}"
        case .windowVerticalScrubLight: return "\u{fd83}"
        case .windowVerticalScrubRegular: return "\u{fd84}"
        case .workflowDeploymentsBold: return "\u{fd85}"
        case .workflowDeploymentsFilled: return "\u{fd86}"
        case .workflowDeploymentsLight: return "\u{fd87}"
        case .workflowDeploymentsRegular: return "\u{fd88}"
        case .workphoneBold: return "\u{fd89}"
        case .workphoneLight: return "\u{fd8a}"
        case .workphoneRegular: return "\u{fd8b}"
        case .zoomInBold: return "\u{fd8c}"
        case .zoomInLight: return "\u{fd8d}"
        case .zoomInRegular: return "\u{fd8e}"
        case .zoomOutBold: return "\u{fd8f}"
        case .zoomOutLight: return "\u{fd90}"
        case .zoomOutRegular: return "\u{fd91}"
