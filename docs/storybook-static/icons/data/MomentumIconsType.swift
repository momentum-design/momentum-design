...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .primaryParticipantLight: return "\u{f8f9}"
        case .primaryParticipantRegular: return "\u{f8fa}"
        case .printBold: return "\u{f8fb}"
        case .printLight: return "\u{f8fc}"
        case .printRegular: return "\u{f8fd}"
        case .priorityBadgeFilled: return "\u{f8fe}"
        case .priorityCircleBold: return "\u{f8ff}"
        case .priorityCircleFilled: return "\u{f900}"
        case .priorityCircleLight: return "\u{f901}"
        case .priorityCircleRegular: return "\u{f902}"
        case .priorityCircleTwoBold: return "\u{f903}"
        case .priorityCircleTwoFilled: return "\u{f904}"
        case .priorityCircleTwoLight: return "\u{f905}"
        case .priorityCircleTwoRegular: return "\u{f906}"
        case .priorityWaveBold: return "\u{f907}"
        case .priorityWaveLight: return "\u{f908}"
        case .priorityWaveRegular: return "\u{f909}"
        case .privacyCircleBold: return "\u{f90a}"
        case .privacyCircleFilled: return "\u{f90b}"
        case .privacyCircleLight: return "\u{f90c}"
        case .privacyCircleRegular: return "\u{f90d}"
        case .privateBold: return "\u{f90e}"
        case .privateCircleBold: return "\u{f90f}"
        case .privateCircleFilled: return "\u{f910}"
        case .privateCircleLight: return "\u{f911}"
        case .privateCircleRegular: return "\u{f912}"
        case .privateLight: return "\u{f913}"
        case .privateMeetingBold: return "\u{f914}"
        case .privateMeetingLight: return "\u{f915}"
        case .privateMeetingRegular: return "\u{f916}"
        case .privateRegular: return "\u{f917}"
        case .productDemoBold: return "\u{f918}"
        case .productDemoLight: return "\u{f919}"
        case .productDemoRegular: return "\u{f91a}"
        case .promptsAiBold: return "\u{f91b}"
        case .promptsAiLight: return "\u{f91c}"
        case .promptsAiRegular: return "\u{f91d}"
        case .proximityBold: return "\u{f91e}"
        case .proximityLight: return "\u{f91f}"
        case .proximityMutedBold: return "\u{f920}"
        case .proximityMutedLight: return "\u{f921}"
        case .proximityMutedRegular: return "\u{f922}"
        case .proximityRegular: return "\u{f923}"
        case .proximityVideoBold: return "\u{f924}"
        case .proximityVideoLight: return "\u{f925}"
        case .proximityVideoRegular: return "\u{f926}"
        case .ptoPresenceBold: return "\u{f927}"
        case .ptoPresenceFilled: return "\u{f928}"
        case .ptoPresenceLight: return "\u{f929}"
        case .ptoPresenceRegular: return "\u{f92a}"
        case .pullCallBold: return "\u{f92b}"
        case .pullCallFilled: return "\u{f92c}"
        case .pullCallLight: return "\u{f92d}"
        case .pullCallRegular: return "\u{f92e}"
        case .qABold: return "\u{f92f}"
        case .qAFilled: return "\u{f930}"
        case .qALight: return "\u{f931}"
        case .qARegular: return "\u{f932}"
        case .qrCodeBold: return "\u{f933}"
        case .qrCodeLight: return "\u{f934}"
        case .qrCodeRegular: return "\u{f935}"
        case .qrCodeScanBold: return "\u{f936}"
        case .qrCodeScanLight: return "\u{f937}"
        case .qrCodeScanRegular: return "\u{f938}"
        case .qualityBold: return "\u{f939}"
        case .qualityLight: return "\u{f93a}"
        case .qualityRegular: return "\u{f93b}"
        case .queueContactBold: return "\u{f93c}"
        case .queueContactFilled: return "\u{f93d}"
        case .queueContactLight: return "\u{f93e}"
        case .queueContactRegular: return "\u{f93f}"
        case .quietBold: return "\u{f940}"
        case .quietHoursPresenceBold: return "\u{f941}"
        case .quietHoursPresenceFilled: return "\u{f942}"
        case .quietHoursPresenceLight: return "\u{f943}"
        case .quietHoursPresenceRegular: return "\u{f944}"
        case .quietLight: return "\u{f945}"
        case .quietRegular: return "\u{f946}"
        case .radioButtonGroupBold: return "\u{f947}"
        case .radioButtonGroupLight: return "\u{f948}"
        case .radioButtonGroupRegular: return "\u{f949}"
        case .raiseHandBold: return "\u{f94a}"
        case .raiseHandCircleFilled: return "\u{f94b}"
        case .raiseHandFilled: return "\u{f94c}"
        case .raiseHandLight: return "\u{f94d}"
        case .raiseHandRegular: return "\u{f94e}"
        case .ramBold: return "\u{f94f}"
        case .ramLight: return "\u{f950}"
        case .ramRegular: return "\u{f951}"
        case .reactionsBold: return "\u{f952}"
        case .reactionsFilled: return "\u{f953}"
        case .reactionsLight: return "\u{f954}"
        case .reactionsRegular: return "\u{f955}"
        case .reactivateBold: return "\u{f956}"
        case .reactivateLight: return "\u{f957}"
        case .reactivateRegular: return "\u{f958}"
        case .receiveVoiceBold: return "\u{f959}"
        case .receiveVoiceFilled: return "\u{f95a}"
        case .receiveVoiceLight: return "\u{f95b}"
        case .receiveVoiceRegular: return "\u{f95c}"
        case .recentsBold: return "\u{f95d}"
        case .recentsFilled: return "\u{f95e}"
        case .recentsLight: return "\u{f95f}"
        case .recentsPresenceBadgeFilled: return "\u{f960}"
        case .recentsPresenceBold: return "\u{f961}"
        case .recentsPresenceFilled: return "\u{f962}"
        case .recentsPresenceLight: return "\u{f963}"
        case .recentsPresenceRegular: return "\u{f964}"
        case .recentsRegular: return "\u{f965}"
        case .recordActiveBadgeFilled: return "\u{f966}"
        case .recordActiveBold: return "\u{f967}"
        case .recordActiveFilled: return "\u{f968}"
        case .recordActiveLight: return "\u{f969}"
        case .recordActiveRegular: return "\u{f96a}"
        case .recordBold: return "\u{f96b}"
        case .recordFilled: return "\u{f96c}"
        case .recordLight: return "\u{f96d}"
        case .recordPausedBadgeFilled: return "\u{f96e}"
        case .recordPausedBold: return "\u{f96f}"
        case .recordPausedFilled: return "\u{f970}"
        case .recordPausedLight: return "\u{f971}"
        case .recordPausedRegular: return "\u{f972}"
        case .recordRegular: return "\u{f973}"
        case .recurringBold: return "\u{f974}"
        case .recurringLight: return "\u{f975}"
        case .recurringOffBold: return "\u{f976}"
        case .recurringOffLight: return "\u{f977}"
        case .recurringOffRegular: return "\u{f978}"
        case .recurringRegular: return "\u{f979}"
        case .redoBold: return "\u{f97a}"
        case .redoLight: return "\u{f97b}"
        case .redoRegular: return "\u{f97c}"
        case .refreshBold: return "\u{f97d}"
        case .refreshLight: return "\u{f97e}"
        case .refreshRegular: return "\u{f97f}"
        case .remoteDesktopControlBold: return "\u{f980}"
        case .remoteDesktopControlFilled: return "\u{f981}"
        case .remoteDesktopControlLight: return "\u{f982}"
        case .remoteDesktopControlRegular: return "\u{f983}"
        case .removeBold: return "\u{f984}"
        case .removeFilled: return "\u{f985}"
        case .removeLight: return "\u{f986}"
        case .removeRegular: return "\u{f987}"
        case .replyBold: return "\u{f988}"
        case .replyFilled: return "\u{f989}"
        case .replyLight: return "\u{f98a}"
        case .replyListBold: return "\u{f98b}"
        case .replyListLight: return "\u{f98c}"
        case .replyListRegular: return "\u{f98d}"
        case .replyPrivatelyBold: return "\u{f98e}"
        case .replyPrivatelyLight: return "\u{f98f}"
        case .replyPrivatelyRegular: return "\u{f990}"
        case .replyRegular: return "\u{f991}"
        case .resetBold: return "\u{f992}"
        case .resetLight: return "\u{f993}"
        case .resetRegular: return "\u{f994}"
        case .resizeCornerBold: return "\u{f995}"
        case .resizeCornerLight: return "\u{f996}"
        case .resizeCornerRegular: return "\u{f997}"
        case .responsiveMobileBold: return "\u{f998}"
        case .responsiveMobileLight: return "\u{f999}"
        case .responsiveMobileRegular: return "\u{f99a}"
        case .restartBold: return "\u{f99b}"
        case .restartLight: return "\u{f99c}"
        case .restartRegular: return "\u{f99d}"
        case .retrieveCallBold: return "\u{f99e}"
        case .retrieveCallFilled: return "\u{f99f}"
        case .retrieveCallLight: return "\u{f9a0}"
        case .retrieveCallRegular: return "\u{f9a1}"
        case .returnBold: return "\u{f9a2}"
        case .returnLight: return "\u{f9a3}"
        case .returnRegular: return "\u{f9a4}"
        case .rewindTenSecBold: return "\u{f9a5}"
        case .rewindTenSecLight: return "\u{f9a6}"
        case .rewindTenSecRegular: return "\u{f9a7}"
        case .ringtoneBold: return "\u{f9a8}"
        case .ringtoneLight: return "\u{f9a9}"
        case .ringtoneRegular: return "\u{f9aa}"
        case .roomCalendarBold: return "\u{f9ab}"
        case .roomCalendarLight: return "\u{f9ac}"
        case .roomCalendarRegular: return "\u{f9ad}"
        case .roomLightsBold: return "\u{f9ae}"
        case .roomLightsFilled: return "\u{f9af}"
        case .roomLightsLight: return "\u{f9b0}"
        case .roomLightsRegular: return "\u{f9b1}"
        case .rotateContentBold: return "\u{f9b2}"
        case .rotateContentFilled: return "\u{f9b3}"
        case .rotateContentLight: return "\u{f9b4}"
        case .rotateContentRegular: return "\u{f9b5}"
        case .rssBold: return "\u{f9b6}"
        case .rssFilled: return "\u{f9b7}"
        case .rssLight: return "\u{f9b8}"
        case .rssRegular: return "\u{f9b9}"
        case .ruleBasedBold: return "\u{f9ba}"
        case .ruleBasedLight: return "\u{f9bb}"
        case .ruleBasedRegular: return "\u{f9bc}"
        case .runningApplicationBold: return "\u{f9bd}"
        case .runningApplicationFilled: return "\u{f9be}"
        case .runningApplicationLight: return "\u{f9bf}"
        case .runningApplicationRegular: return "\u{f9c0}"
        case .saveBold: return "\u{f9c1}"
        case .saveLight: return "\u{f9c2}"
        case .saveRegular: return "\u{f9c3}"
        case .saveTranscriptBold: return "\u{f9c4}"
        case .saveTranscriptFilled: return "\u{f9c5}"
        case .saveTranscriptLight: return "\u{f9c6}"
        case .saveTranscriptRegular: return "\u{f9c7}"
        case .scanBold: return "\u{f9c8}"
        case .scanLight: return "\u{f9c9}"
        case .scanRegular: return "\u{f9ca}"
        case .scheduleAiBold: return "\u{f9cb}"
        case .scheduleAiLight: return "\u{f9cc}"
        case .scheduleAiRegular: return "\u{f9cd}"
        case .scheduleSendBold: return "\u{f9ce}"
        case .scheduleSendFilled: return "\u{f9cf}"
        case .scheduleSendLight: return "\u{f9d0}"
        case .scheduleSendRegular: return "\u{f9d1}"
        case .scheduleWinnerBold: return "\u{f9d2}"
        case .scheduleWinnerFilled: return "\u{f9d3}"
        case .scheduleWinnerLight: return "\u{f9d4}"
        case .scheduleWinnerRegular: return "\u{f9d5}"
        case .schedulerAvailableBold: return "\u{f9d6}"
        case .schedulerAvailableLight: return "\u{f9d7}"
        case .schedulerAvailableRegular: return "\u{f9d8}"
        case .schedulerNotWorkingHoursBold: return "\u{f9d9}"
        case .schedulerNotWorkingHoursLight: return "\u{f9da}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9db}"
        case .schedulerUnavailableBold: return "\u{f9dc}"
        case .schedulerUnavailableLight: return "\u{f9dd}"
        case .schedulerUnavailableRegular: return "\u{f9de}"
        case .schedulerUnknownBold: return "\u{f9df}"
        case .schedulerUnknownLight: return "\u{f9e0}"
        case .schedulerUnknownRegular: return "\u{f9e1}"
        case .screenshotBold: return "\u{f9e2}"
        case .screenshotDocBold: return "\u{f9e3}"
        case .screenshotDocFilled: return "\u{f9e4}"
        case .screenshotDocLight: return "\u{f9e5}"
        case .screenshotDocRegular: return "\u{f9e6}"
        case .screenshotLight: return "\u{f9e7}"
        case .screenshotRegular: return "\u{f9e8}"
        case .searchAiBold: return "\u{f9e9}"
        case .searchAiLight: return "\u{f9ea}"
        case .searchAiRegular: return "\u{f9eb}"
        case .searchBold: return "\u{f9ec}"
        case .searchFilled: return "\u{f9ed}"
        case .searchLight: return "\u{f9ee}"
        case .searchRegular: return "\u{f9ef}"
        case .secondaryArrowBold: return "\u{f9f0}"
        case .secondaryArrowLight: return "\u{f9f1}"
        case .secondaryArrowRegular: return "\u{f9f2}"
        case .secureCallLockBold: return "\u{f9f3}"
        case .secureCallLockFilled: return "\u{f9f4}"
        case .secureCallLockLight: return "\u{f9f5}"
        case .secureCallLockRegular: return "\u{f9f6}"
        case .secureCallShieldBold: return "\u{f9f7}"
        case .secureCallShieldFilled: return "\u{f9f8}"
        case .secureCallShieldLight: return "\u{f9f9}"
        case .secureCallShieldRegular: return "\u{f9fa}"
        case .secureCircleBold: return "\u{f9fb}"
        case .secureCircleFilled: return "\u{f9fc}"
        case .secureCircleLight: return "\u{f9fd}"
        case .secureCircleRegular: return "\u{f9fe}"
        case .secureLockBold: return "\u{f9ff}"
        case .secureLockFilled: return "\u{fa00}"
        case .secureLockLight: return "\u{fa01}"
        case .secureLockRegular: return "\u{fa02}"
        case .segmentExcludeFilled: return "\u{fa03}"
        case .segmentFilterFilled: return "\u{fa04}"
        case .segmentIncludeFilled: return "\u{fa05}"
        case .selectAllBold: return "\u{fa06}"
        case .selectAllFilled: return "\u{fa07}"
        case .selectAllLight: return "\u{fa08}"
        case .selectAllRegular: return "\u{fa09}"
        case .selectionBold: return "\u{fa0a}"
        case .selectionFilled: return "\u{fa0b}"
        case .selectionLight: return "\u{fa0c}"
        case .selectionRegular: return "\u{fa0d}"
        case .sendBold: return "\u{fa0e}"
        case .sendDigitsBold: return "\u{fa0f}"
        case .sendDigitsFilled: return "\u{fa10}"
        case .sendDigitsLight: return "\u{fa11}"
        case .sendDigitsRegular: return "\u{fa12}"
        case .sendFilled: return "\u{fa13}"
        case .sendLight: return "\u{fa14}"
        case .sendRegular: return "\u{fa15}"
        case .sendVoiceBold: return "\u{fa16}"
        case .sendVoiceFilled: return "\u{fa17}"
        case .sendVoiceLight: return "\u{fa18}"
        case .sendVoiceRegular: return "\u{fa19}"
        case .serverBold: return "\u{fa1a}"
        case .serverErrorBold: return "\u{fa1b}"
        case .serverErrorLight: return "\u{fa1c}"
        case .serverErrorRegular: return "\u{fa1d}"
        case .serverLight: return "\u{fa1e}"
        case .serverRegular: return "\u{fa1f}"
        case .servicesBold: return "\u{fa20}"
        case .servicesLight: return "\u{fa21}"
        case .servicesRegular: return "\u{fa22}"
        case .setVariableBold: return "\u{fa23}"
        case .setVariableLight: return "\u{fa24}"
        case .setVariableRegular: return "\u{fa25}"
        case .settingsBold: return "\u{fa26}"
        case .settingsFilled: return "\u{fa27}"
        case .settingsLight: return "\u{fa28}"
        case .settingsRegular: return "\u{fa29}"
        case .setupAssistantBold: return "\u{fa2a}"
        case .setupAssistantLight: return "\u{fa2b}"
        case .setupAssistantRegular: return "\u{fa2c}"
        case .sftpBold: return "\u{fa2d}"
        case .sftpLight: return "\u{fa2e}"
        case .sftpRegular: return "\u{fa2f}"
        case .shapeCircleBold: return "\u{fa30}"
        case .shapeCircleFilled: return "\u{fa31}"
        case .shapeCircleLight: return "\u{fa32}"
        case .shapeCircleMdFilled: return "\u{fa33}"
        case .shapeCircleRegular: return "\u{fa34}"
        case .shapeCircleSmFilled: return "\u{fa35}"
        case .shapeDiagonalLineBold: return "\u{fa36}"
        case .shapeDiagonalLineLight: return "\u{fa37}"
        case .shapeDiagonalLineRegular: return "\u{fa38}"
        case .shapeDiamondBold: return "\u{fa39}"
        case .shapeDiamondFilled: return "\u{fa3a}"
        case .shapeDiamondLight: return "\u{fa3b}"
        case .shapeDiamondRegular: return "\u{fa3c}"
        case .shapeOvalBold: return "\u{fa3d}"
        case .shapeOvalLight: return "\u{fa3e}"
        case .shapeOvalRegular: return "\u{fa3f}"
        case .shapeSquareBold: return "\u{fa40}"
        case .shapeSquareFilled: return "\u{fa41}"
        case .shapeSquareLight: return "\u{fa42}"
        case .shapeSquareRegular: return "\u{fa43}"
        case .shapeTriangleBold: return "\u{fa44}"
        case .shapeTriangleFilled: return "\u{fa45}"
        case .shapeTriangleLight: return "\u{fa46}"
        case .shapeTriangleRegular: return "\u{fa47}"
        case .shapesBold: return "\u{fa48}"
        case .shapesFilled: return "\u{fa49}"
        case .shapesLight: return "\u{fa4a}"
        case .shapesRegular: return "\u{fa4b}"
        case .shareCNativeAdrBold: return "\u{fa4c}"
        case .shareCNativeAdrFilled: return "\u{fa4d}"
        case .shareCNativeAdrLight: return "\u{fa4e}"
        case .shareCNativeAdrRegular: return "\u{fa4f}"
        case .shareCNativeIphBold: return "\u{fa50}"
        case .shareCNativeIphLight: return "\u{fa51}"
        case .shareCNativeIphRegular: return "\u{fa52}"
        case .shareContentOnDeviceBold: return "\u{fa53}"
        case .shareContentOnDeviceLight: return "\u{fa54}"
        case .shareContentOnDeviceRegular: return "\u{fa55}"
        case .shareScreenAddBold: return "\u{fa56}"
        case .shareScreenAddLight: return "\u{fa57}"
        case .shareScreenAddRegular: return "\u{fa58}"
        case .shareScreenBadgeFilled: return "\u{fa59}"
        case .shareScreenBold: return "\u{fa5a}"
        case .shareScreenFilled: return "\u{fa5b}"
        case .shareScreenLight: return "\u{fa5c}"
        case .shareScreenRegular: return "\u{fa5d}"
        case .shareSpaceBold: return "\u{fa5e}"
        case .shareSpaceLight: return "\u{fa5f}"
        case .shareSpaceRegular: return "\u{fa60}"
        case .shieldBold: return "\u{fa61}"
        case .shieldLight: return "\u{fa62}"
        case .shieldRegular: return "\u{fa63}"
        case .shoppingCartBold: return "\u{fa64}"
        case .shoppingCartFilled: return "\u{fa65}"
        case .shoppingCartLight: return "\u{fa66}"
        case .shoppingCartRegular: return "\u{fa67}"
        case .shortTextBoxBold: return "\u{fa68}"
        case .shortTextBoxLight: return "\u{fa69}"
        case .shortTextBoxRegular: return "\u{fa6a}"
        case .showBold: return "\u{fa6b}"
        case .showFilled: return "\u{fa6c}"
        case .showLight: return "\u{fa6d}"
        case .showRegular: return "\u{fa6e}"
        case .sidePanelBold: return "\u{fa6f}"
        case .sidePanelFilled: return "\u{fa70}"
        case .sidePanelLight: return "\u{fa71}"
        case .sidePanelRegular: return "\u{fa72}"
        case .signInBold: return "\u{fa73}"
        case .signInFilled: return "\u{fa74}"
        case .signInForcedBold: return "\u{fa75}"
        case .signInForcedLight: return "\u{fa76}"
        case .signInForcedRegular: return "\u{fa77}"
        case .signInLight: return "\u{fa78}"
        case .signInRegular: return "\u{fa79}"
        case .signLangIntBold: return "\u{fa7a}"
        case .signLangIntLight: return "\u{fa7b}"
        case .signLangIntRegular: return "\u{fa7c}"
        case .signOutBold: return "\u{fa7d}"
        case .signOutLight: return "\u{fa7e}"
        case .signOutRegular: return "\u{fa7f}"
        case .signalFourBold: return "\u{fa80}"
        case .signalFourLight: return "\u{fa81}"
        case .signalFourRegular: return "\u{fa82}"
        case .signalOneBold: return "\u{fa83}"
        case .signalOneLight: return "\u{fa84}"
        case .signalOneRegular: return "\u{fa85}"
        case .signalThreeBold: return "\u{fa86}"
        case .signalThreeLight: return "\u{fa87}"
        case .signalThreeRegular: return "\u{fa88}"
        case .signalTwoBold: return "\u{fa89}"
        case .signalTwoLight: return "\u{fa8a}"
        case .signalTwoRegular: return "\u{fa8b}"
        case .signalZeroBold: return "\u{fa8c}"
        case .signalZeroLight: return "\u{fa8d}"
        case .signalZeroRegular: return "\u{fa8e}"
        case .simplePromotionBold: return "\u{fa8f}"
        case .simplePromotionLight: return "\u{fa90}"
        case .simplePromotionRegular: return "\u{fa91}"
        case .singleNumberReachBold: return "\u{fa92}"
        case .singleNumberReachLight: return "\u{fa93}"
        case .singleNumberReachRegular: return "\u{fa94}"
        case .sipRegistrationInProgressBold: return "\u{fa95}"
        case .sipRegistrationInProgressFilled: return "\u{fa96}"
        case .sipRegistrationInProgressLight: return "\u{fa97}"
        case .sipRegistrationInProgressRegular: return "\u{fa98}"
        case .skipBold: return "\u{fa99}"
        case .skipBwBold: return "\u{fa9a}"
        case .skipBwFilled: return "\u{fa9b}"
        case .skipBwLight: return "\u{fa9c}"
        case .skipBwRegular: return "\u{fa9d}"
        case .skipFwBold: return "\u{fa9e}"
        case .skipFwFilled: return "\u{fa9f}"
        case .skipFwLight: return "\u{faa0}"
        case .skipFwRegular: return "\u{faa1}"
        case .skipLight: return "\u{faa2}"
        case .skipRegular: return "\u{faa3}"
        case .smartAudioBold: return "\u{faa4}"
        case .smartAudioLight: return "\u{faa5}"
        case .smartAudioRegular: return "\u{faa6}"
        case .smsFilled: return "\u{faa7}"
        case .smsInboundBold: return "\u{faa8}"
        case .smsInboundLight: return "\u{faa9}"
        case .smsInboundRegular: return "\u{faaa}"
        case .smsMessageBold: return "\u{faab}"
        case .smsMessageFilled: return "\u{faac}"
        case .smsMessageLight: return "\u{faad}"
        case .smsMessageRegular: return "\u{faae}"
        case .smsOutgoingFilled: return "\u{faaf}"
        case .smsUnreadBold: return "\u{fab0}"
        case .smsUnreadLight: return "\u{fab1}"
        case .smsUnreadRegular: return "\u{fab2}"
        case .sortAscendingBold: return "\u{fab3}"
        case .sortAscendingLight: return "\u{fab4}"
        case .sortAscendingRegular: return "\u{fab5}"
        case .sortDescendingBold: return "\u{fab6}"
        case .sortDescendingLight: return "\u{fab7}"
        case .sortDescendingRegular: return "\u{fab8}"
        case .soundDefaultBold: return "\u{fab9}"
        case .soundDefaultLight: return "\u{faba}"
        case .soundDefaultRegular: return "\u{fabb}"
        case .sparkleBold: return "\u{fabc}"
        case .sparkleFilled: return "\u{fabd}"
        case .sparkleLight: return "\u{fabe}"
        case .sparkleRegular: return "\u{fabf}"
        case .speakerBold: return "\u{fac0}"
        case .speakerDisconnectedBold: return "\u{fac1}"
        case .speakerDisconnectedFilled: return "\u{fac2}"
        case .speakerDisconnectedLight: return "\u{fac3}"
        case .speakerDisconnectedRegular: return "\u{fac4}"
        case .speakerFilled: return "\u{fac5}"
        case .speakerLight: return "\u{fac6}"
        case .speakerMutedBold: return "\u{fac7}"
        case .speakerMutedFilled: return "\u{fac8}"
        case .speakerMutedLight: return "\u{fac9}"
        case .speakerMutedRegular: return "\u{faca}"
        case .speakerOffBold: return "\u{facb}"
        case .speakerOffFilled: return "\u{facc}"
        case .speakerOffLight: return "\u{facd}"
        case .speakerOffRegular: return "\u{face}"
        case .speakerOnBold: return "\u{facf}"
        case .speakerOnLight: return "\u{fad0}"
        case .speakerOnRegular: return "\u{fad1}"
        case .speakerRegular: return "\u{fad2}"
        case .speakerTurnDownBold: return "\u{fad3}"
        case .speakerTurnDownFilled: return "\u{fad4}"
        case .speakerTurnDownLight: return "\u{fad5}"
        case .speakerTurnDownRegular: return "\u{fad6}"
        case .speakerTurnUpBold: return "\u{fad7}"
        case .speakerTurnUpFilled: return "\u{fad8}"
        case .speakerTurnUpLight: return "\u{fad9}"
        case .speakerTurnUpRegular: return "\u{fada}"
        case .speedDialBold: return "\u{fadb}"
        case .speedDialFilled: return "\u{fadc}"
        case .speedDialLight: return "\u{fadd}"
        case .speedDialRegular: return "\u{fade}"
        case .spellCheckerBold: return "\u{fadf}"
        case .spellCheckerLight: return "\u{fae0}"
        case .spellCheckerRegular: return "\u{fae1}"
        case .splitViewBold: return "\u{fae2}"
        case .splitViewLight: return "\u{fae3}"
        case .splitViewRegular: return "\u{fae4}"
        case .stackedAreaChartBold: return "\u{fae5}"
        case .stackedAreaChartFilled: return "\u{fae6}"
        case .stackedAreaChartFullBold: return "\u{fae7}"
        case .stackedAreaChartFullFilled: return "\u{fae8}"
        case .stackedAreaChartFullLight: return "\u{fae9}"
        case .stackedAreaChartFullRegular: return "\u{faea}"
        case .stackedAreaChartLight: return "\u{faeb}"
        case .stackedAreaChartRegular: return "\u{faec}"
        case .stackedBarChartBold: return "\u{faed}"
        case .stackedBarChartFilled: return "\u{faee}"
        case .stackedBarChartFullBold: return "\u{faef}"
        case .stackedBarChartFullFilled: return "\u{faf0}"
        case .stackedBarChartFullLight: return "\u{faf1}"
        case .stackedBarChartFullRegular: return "\u{faf2}"
        case .stackedBarChartLight: return "\u{faf3}"
        case .stackedBarChartRegular: return "\u{faf4}"
        case .startChatBold: return "\u{faf5}"
        case .startChatLight: return "\u{faf6}"
        case .startChatRegular: return "\u{faf7}"
        case .stethoscopeBold: return "\u{faf8}"
        case .stethoscopeLight: return "\u{faf9}"
        case .stethoscopeRegular: return "\u{fafa}"
        case .stickersBold: return "\u{fafb}"
        case .stickersLight: return "\u{fafc}"
        case .stickersRegular: return "\u{fafd}"
        case .stickiesBold: return "\u{fafe}"
        case .stickiesLight: return "\u{faff}"
        case .stickiesRegular: return "\u{fb00}"
        case .stopBold: return "\u{fb01}"
        case .stopCircleBold: return "\u{fb02}"
        case .stopCircleFilled: return "\u{fb03}"
        case .stopCircleLight: return "\u{fb04}"
        case .stopCircleRegular: return "\u{fb05}"
        case .stopContentShareBold: return "\u{fb06}"
        case .stopContentShareLight: return "\u{fb07}"
        case .stopContentShareRegular: return "\u{fb08}"
        case .stopFilled: return "\u{fb09}"
        case .stopLight: return "\u{fb0a}"
        case .stopRegular: return "\u{fb0b}"
        case .storedInfoBold: return "\u{fb0c}"
        case .storedInfoFilled: return "\u{fb0d}"
        case .storedInfoLight: return "\u{fb0e}"
        case .storedInfoRegular: return "\u{fb0f}"
        case .streamingBold: return "\u{fb10}"
        case .streamingLight: return "\u{fb11}"
        case .streamingRegular: return "\u{fb12}"
        case .strikethroughBold: return "\u{fb13}"
        case .strikethroughFilled: return "\u{fb14}"
        case .strikethroughLight: return "\u{fb15}"
        case .strikethroughRegular: return "\u{fb16}"
        case .studioModeBold: return "\u{fb17}"
        case .studioModeLight: return "\u{fb18}"
        case .studioModeRegular: return "\u{fb19}"
        case .subscriptBold: return "\u{fb1a}"
        case .subscriptLight: return "\u{fb1b}"
        case .subscriptRegular: return "\u{fb1c}"
        case .summarizeAiBold: return "\u{fb1d}"
        case .summarizeAiLight: return "\u{fb1e}"
        case .summarizeAiRegular: return "\u{fb1f}"
        case .superscriptBold: return "\u{fb20}"
        case .superscriptLight: return "\u{fb21}"
        case .superscriptRegular: return "\u{fb22}"
        case .surveyBold: return "\u{fb23}"
        case .surveyFilled: return "\u{fb24}"
        case .surveyLight: return "\u{fb25}"
        case .surveyRegular: return "\u{fb26}"
        case .sxEightyCodecBold: return "\u{fb27}"
        case .sxEightyCodecLight: return "\u{fb28}"
        case .sxEightyCodecRegular: return "\u{fb29}"
        case .sxTenBold: return "\u{fb2a}"
        case .sxTenLight: return "\u{fb2b}"
        case .sxTenRegular: return "\u{fb2c}"
        case .sxTwentyBold: return "\u{fb2d}"
        case .sxTwentyLight: return "\u{fb2e}"
        case .sxTwentyRegular: return "\u{fb2f}"
        case .tableBold: return "\u{fb30}"
        case .tableLight: return "\u{fb31}"
        case .tableRegular: return "\u{fb32}"
        case .tabletBold: return "\u{fb33}"
        case .tabletLight: return "\u{fb34}"
        case .tabletRegular: return "\u{fb35}"
        case .tabsBold: return "\u{fb36}"
        case .tabsLight: return "\u{fb37}"
        case .tabsRegular: return "\u{fb38}"
        case .tagBold: return "\u{fb39}"
        case .tagLight: return "\u{fb3a}"
        case .tagRegular: return "\u{fb3b}"
        case .tapBold: return "\u{fb3c}"
        case .tapFilled: return "\u{fb3d}"
        case .tapLight: return "\u{fb3e}"
        case .tapRegular: return "\u{fb3f}"
        case .telepresenceAlertBold: return "\u{fb40}"
        case .telepresenceAlertLight: return "\u{fb41}"
        case .telepresenceAlertMutedBold: return "\u{fb42}"
        case .telepresenceAlertMutedLight: return "\u{fb43}"
        case .telepresenceAlertMutedRegular: return "\u{fb44}"
        case .telepresenceAlertRegular: return "\u{fb45}"
        case .telepresenceBold: return "\u{fb46}"
        case .telepresenceIxFiveThousandBold: return "\u{fb47}"
        case .telepresenceIxFiveThousandLight: return "\u{fb48}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb49}"
        case .telepresenceLight: return "\u{fb4a}"
        case .telepresenceMutedBold: return "\u{fb4b}"
        case .telepresenceMutedLight: return "\u{fb4c}"
        case .telepresenceMutedRegular: return "\u{fb4d}"
        case .telepresencePrivateBold: return "\u{fb4e}"
        case .telepresencePrivateLight: return "\u{fb4f}"
        case .telepresencePrivateRegular: return "\u{fb50}"
        case .telepresenceRegular: return "\u{fb51}"
        case .temperatureBold: return "\u{fb52}"
        case .temperatureLight: return "\u{fb53}"
        case .temperatureRegular: return "\u{fb54}"
        case .testTubeBold: return "\u{fb55}"
        case .testTubeFilled: return "\u{fb56}"
        case .testTubeLight: return "\u{fb57}"
        case .testTubeRegular: return "\u{fb58}"
        case .textAlignCenterBold: return "\u{fb59}"
        case .textAlignCenterFilled: return "\u{fb5a}"
        case .textAlignCenterLight: return "\u{fb5b}"
        case .textAlignCenterRegular: return "\u{fb5c}"
        case .textAlignLeftBold: return "\u{fb5d}"
        case .textAlignLeftFilled: return "\u{fb5e}"
        case .textAlignLeftLight: return "\u{fb5f}"
        case .textAlignLeftRegular: return "\u{fb60}"
        case .textAlignRightBold: return "\u{fb61}"
        case .textAlignRightFilled: return "\u{fb62}"
        case .textAlignRightLight: return "\u{fb63}"
        case .textAlignRightRegular: return "\u{fb64}"
        case .textBold: return "\u{fb65}"
        case .textBoxCursorLight: return "\u{fb66}"
        case .textCodeBlockBold: return "\u{fb67}"
        case .textCodeBlockLight: return "\u{fb68}"
        case .textCodeBlockRegular: return "\u{fb69}"
        case .textHighlightBold: return "\u{fb6a}"
        case .textHighlightFilled: return "\u{fb6b}"
        case .textHighlightLight: return "\u{fb6c}"
        case .textHighlightRegular: return "\u{fb6d}"
        case .textLight: return "\u{fb6e}"
        case .textRegular: return "\u{fb6f}"
        case .threeColumnBold: return "\u{fb70}"
        case .threeColumnLight: return "\u{fb71}"
        case .threeColumnRegular: return "\u{fb72}"
        case .threeDObjectBold: return "\u{fb73}"
        case .threeDObjectLight: return "\u{fb74}"
        case .threeDObjectRegular: return "\u{fb75}"
        case .timeExclusionBold: return "\u{fb76}"
        case .timeExclusionLight: return "\u{fb77}"
        case .timeExclusionRegular: return "\u{fb78}"
        case .tooFastBold: return "\u{fb79}"
        case .tooFastLight: return "\u{fb7a}"
        case .tooFastRegular: return "\u{fb7b}"
        case .tooSlowBold: return "\u{fb7c}"
        case .tooSlowLight: return "\u{fb7d}"
        case .tooSlowRegular: return "\u{fb7e}"
        case .toolsBold: return "\u{fb7f}"
        case .toolsFilled: return "\u{fb80}"
        case .toolsLight: return "\u{fb81}"
        case .toolsRegular: return "\u{fb82}"
        case .touchTenBold: return "\u{fb83}"
        case .touchTenLight: return "\u{fb84}"
        case .touchTenRegular: return "\u{fb85}"
        case .transcriptBold: return "\u{fb86}"
        case .transcriptFilled: return "\u{fb87}"
        case .transcriptLight: return "\u{fb88}"
        case .transcriptRegular: return "\u{fb89}"
        case .translateBold: return "\u{fb8a}"
        case .translateLight: return "\u{fb8b}"
        case .translateRegular: return "\u{fb8c}"
        case .translateUndoBold: return "\u{fb8d}"
        case .translateUndoLight: return "\u{fb8e}"
        case .translateUndoRegular: return "\u{fb8f}"
        case .trendingBold: return "\u{fb90}"
        case .trendingDownBold: return "\u{fb91}"
        case .trendingDownFilled: return "\u{fb92}"
        case .trendingDownLight: return "\u{fb93}"
        case .trendingDownRegular: return "\u{fb94}"
        case .trendingFilled: return "\u{fb95}"
        case .trendingLight: return "\u{fb96}"
        case .trendingRegular: return "\u{fb97}"
        case .trimBold: return "\u{fb98}"
        case .trimLight: return "\u{fb99}"
        case .trimRegular: return "\u{fb9a}"
        case .twoColumnBold: return "\u{fb9b}"
        case .twoColumnLight: return "\u{fb9c}"
        case .twoColumnRegular: return "\u{fb9d}"
        case .twoWayVoiceStreamBold: return "\u{fb9e}"
        case .twoWayVoiceStreamFilled: return "\u{fb9f}"
        case .twoWayVoiceStreamLight: return "\u{fba0}"
        case .twoWayVoiceStreamRegular: return "\u{fba1}"
        case .ucmCloudBold: return "\u{fba2}"
        case .ucmCloudLight: return "\u{fba3}"
        case .ucmCloudRegular: return "\u{fba4}"
        case .unblockBold: return "\u{fba5}"
        case .unblockFilled: return "\u{fba6}"
        case .unblockLight: return "\u{fba7}"
        case .unblockRegular: return "\u{fba8}"
        case .underlineBold: return "\u{fba9}"
        case .underlineFilled: return "\u{fbaa}"
        case .underlineLight: return "\u{fbab}"
        case .underlineRegular: return "\u{fbac}"
        case .undoBold: return "\u{fbad}"
        case .undoLight: return "\u{fbae}"
        case .undoRegular: return "\u{fbaf}"
        case .unlinkBold: return "\u{fbb0}"
        case .unlinkLight: return "\u{fbb1}"
        case .unlinkRegular: return "\u{fbb2}"
        case .unreadBold: return "\u{fbb3}"
        case .unreadFilled: return "\u{fbb4}"
        case .unreadLight: return "\u{fbb5}"
        case .unreadRegular: return "\u{fbb6}"
        case .unsecureUnlockedBold: return "\u{fbb7}"
        case .unsecureUnlockedFilled: return "\u{fbb8}"
        case .unsecureUnlockedLight: return "\u{fbb9}"
        case .unsecureUnlockedRegular: return "\u{fbba}"
        case .unsortedBold: return "\u{fbbb}"
        case .unsortedLight: return "\u{fbbc}"
        case .unsortedRegular: return "\u{fbbd}"
        case .updateFileShareBold: return "\u{fbbe}"
        case .updateFileShareLight: return "\u{fbbf}"
        case .updateFileShareRegular: return "\u{fbc0}"
        case .uploadBold: return "\u{fbc1}"
        case .uploadImageBold: return "\u{fbc2}"
        case .uploadImageLight: return "\u{fbc3}"
        case .uploadImageRegular: return "\u{fbc4}"
        case .uploadLight: return "\u{fbc5}"
        case .uploadRegular: return "\u{fbc6}"
        case .urgentVoicemailBold: return "\u{fbc7}"
        case .urgentVoicemailFilled: return "\u{fbc8}"
        case .usbBold: return "\u{fbc9}"
        case .usbHeadsetBold: return "\u{fbca}"
        case .usbHeadsetLight: return "\u{fbcb}"
        case .usbHeadsetMutedBold: return "\u{fbcc}"
        case .usbHeadsetMutedLight: return "\u{fbcd}"
        case .usbHeadsetMutedRegular: return "\u{fbce}"
        case .usbHeadsetRegular: return "\u{fbcf}"
        case .usbLight: return "\u{fbd0}"
        case .usbRegular: return "\u{fbd1}"
        case .userBold: return "\u{fbd2}"
        case .userDeactivateBold: return "\u{fbd3}"
        case .userDeactivateLight: return "\u{fbd4}"
        case .userDeactivateRegular: return "\u{fbd5}"
        case .userLight: return "\u{fbd6}"
        case .userRegular: return "\u{fbd7}"
        case .videoBlurBold: return "\u{fbd8}"
        case .videoBlurFilled: return "\u{fbd9}"
        case .videoBlurLight: return "\u{fbda}"
        case .videoBlurRegular: return "\u{fbdb}"
        case .videoBold: return "\u{fbdc}"
        case .videoEffectBold: return "\u{fbdd}"
        case .videoEffectFilled: return "\u{fbde}"
        case .videoEffectLight: return "\u{fbdf}"
        case .videoEffectRegular: return "\u{fbe0}"
        case .videoFilled: return "\u{fbe1}"
        case .videoLayoutBold: return "\u{fbe2}"
        case .videoLayoutCustomBold: return "\u{fbe3}"
        case .videoLayoutCustomFilled: return "\u{fbe4}"
        case .videoLayoutCustomLight: return "\u{fbe5}"
        case .videoLayoutCustomRegular: return "\u{fbe6}"
        case .videoLayoutEqualBold: return "\u{fbe7}"
        case .videoLayoutEqualDualBold: return "\u{fbe8}"
        case .videoLayoutEqualDualLight: return "\u{fbe9}"
        case .videoLayoutEqualDualRegular: return "\u{fbea}"
        case .videoLayoutEqualFilled: return "\u{fbeb}"
        case .videoLayoutEqualLight: return "\u{fbec}"
        case .videoLayoutEqualRegular: return "\u{fbed}"
        case .videoLayoutFilled: return "\u{fbee}"
        case .videoLayoutLight: return "\u{fbef}"
        case .videoLayoutOverlayBold: return "\u{fbf0}"
        case .videoLayoutOverlayFilled: return "\u{fbf1}"
        case .videoLayoutOverlayLight: return "\u{fbf2}"
        case .videoLayoutOverlayRegular: return "\u{fbf3}"
        case .videoLayoutPresentationBold: return "\u{fbf4}"
        case .videoLayoutPresentationFilled: return "\u{fbf5}"
        case .videoLayoutPresentationLight: return "\u{fbf6}"
        case .videoLayoutPresentationRegular: return "\u{fbf7}"
        case .videoLayoutPresenterDominantBold: return "\u{fbf8}"
        case .videoLayoutPresenterDominantLight: return "\u{fbf9}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbfa}"
        case .videoLayoutProminentBold: return "\u{fbfb}"
        case .videoLayoutProminentFilled: return "\u{fbfc}"
        case .videoLayoutProminentLight: return "\u{fbfd}"
        case .videoLayoutProminentRegular: return "\u{fbfe}"
        case .videoLayoutRegular: return "\u{fbff}"
        case .videoLayoutShareDominantBold: return "\u{fc00}"
        case .videoLayoutShareDominantLight: return "\u{fc01}"
        case .videoLayoutShareDominantRegular: return "\u{fc02}"
        case .videoLayoutSingleBold: return "\u{fc03}"
        case .videoLayoutSingleFilled: return "\u{fc04}"
        case .videoLayoutSingleLight: return "\u{fc05}"
        case .videoLayoutSingleRegular: return "\u{fc06}"
        case .videoLayoutSpeakerBold: return "\u{fc07}"
        case .videoLayoutSpeakerFilled: return "\u{fc08}"
        case .videoLayoutSpeakerLight: return "\u{fc09}"
        case .videoLayoutSpeakerRegular: return "\u{fc0a}"
        case .videoLayoutStackBold: return "\u{fc0b}"
        case .videoLayoutStackFilled: return "\u{fc0c}"
        case .videoLayoutStackLight: return "\u{fc0d}"
        case .videoLayoutStackRegular: return "\u{fc0e}"
        case .videoLayoutVideoDominantBold: return "\u{fc0f}"
        case .videoLayoutVideoDominantFilled: return "\u{fc10}"
        case .videoLayoutVideoDominantLight: return "\u{fc11}"
        case .videoLayoutVideoDominantRegular: return "\u{fc12}"
        case .videoLight: return "\u{fc13}"
        case .videoPlusBold: return "\u{fc14}"
        case .videoPlusFilled: return "\u{fc15}"
        case .videoPlusLight: return "\u{fc16}"
        case .videoPlusRegular: return "\u{fc17}"
        case .videoRegular: return "\u{fc18}"
        case .videoSpeakerTrackBold: return "\u{fc19}"
        case .videoSpeakerTrackFilled: return "\u{fc1a}"
        case .videoSpeakerTrackLight: return "\u{fc1b}"
        case .videoSpeakerTrackRegular: return "\u{fc1c}"
        case .viewAllBold: return "\u{fc1d}"
        case .viewAllLight: return "\u{fc1e}"
        case .viewAllRegular: return "\u{fc1f}"
        case .viewListBold: return "\u{fc20}"
        case .viewListFilled: return "\u{fc21}"
        case .viewListLight: return "\u{fc22}"
        case .viewListRegular: return "\u{fc23}"
        case .viewStackedBold: return "\u{fc24}"
        case .viewStackedFilled: return "\u{fc25}"
        case .viewStackedLight: return "\u{fc26}"
        case .viewStackedRegular: return "\u{fc27}"
        case .viewThumbnailBold: return "\u{fc28}"
        case .viewThumbnailFilled: return "\u{fc29}"
        case .viewThumbnailLight: return "\u{fc2a}"
        case .viewThumbnailRegular: return "\u{fc2b}"
        case .visionproBold: return "\u{fc2c}"
        case .visionproFilled: return "\u{fc2d}"
        case .visionproLight: return "\u{fc2e}"
        case .visionproMoveCallInBold: return "\u{fc2f}"
        case .visionproMoveCallInFilled: return "\u{fc30}"
        case .visionproMoveCallInLight: return "\u{fc31}"
        case .visionproMoveCallInOutBold: return "\u{fc32}"
        case .visionproMoveCallInOutFilled: return "\u{fc33}"
        case .visionproMoveCallInOutLight: return "\u{fc34}"
        case .visionproMoveCallInOutRegular: return "\u{fc35}"
        case .visionproMoveCallInRegular: return "\u{fc36}"
        case .visionproMoveCallOutBold: return "\u{fc37}"
        case .visionproMoveCallOutFilled: return "\u{fc38}"
        case .visionproMoveCallOutLight: return "\u{fc39}"
        case .visionproMoveCallOutRegular: return "\u{fc3a}"
        case .visionproRegular: return "\u{fc3b}"
        case .voicemailBold: return "\u{fc3c}"
        case .voicemailFilled: return "\u{fc3d}"
        case .voicemailLight: return "\u{fc3e}"
        case .voicemailRegular: return "\u{fc3f}"
        case .vpnBold: return "\u{fc40}"
        case .vpnFilled: return "\u{fc41}"
        case .vpnLight: return "\u{fc42}"
        case .vpnRegular: return "\u{fc43}"
        case .vscBold: return "\u{fc44}"
        case .vscLight: return "\u{fc45}"
        case .vscRegular: return "\u{fc46}"
        case .waffleMenuBold: return "\u{fc47}"
        case .waffleMenuLight: return "\u{fc48}"
        case .waffleMenuRegular: return "\u{fc49}"
        case .waitingRoomBold: return "\u{fc4a}"
        case .waitingRoomLight: return "\u{fc4b}"
        case .waitingRoomRegular: return "\u{fc4c}"
        case .wallpaperBold: return "\u{fc4d}"
        case .wallpaperLight: return "\u{fc4e}"
        case .wallpaperRegular: return "\u{fc4f}"
        case .warningBadgeFilled: return "\u{fc50}"
        case .warningBold: return "\u{fc51}"
        case .warningFilled: return "\u{fc52}"
        case .warningLight: return "\u{fc53}"
        case .warningRegular: return "\u{fc54}"
        case .webexBoardBold: return "\u{fc55}"
        case .webexBoardLight: return "\u{fc56}"
        case .webexBoardRegular: return "\u{fc57}"
        case .webexCodecPlusBold: return "\u{fc58}"
        case .webexCodecPlusLight: return "\u{fc59}"
        case .webexCodecPlusRegular: return "\u{fc5a}"
        case .webexDeskCameraBold: return "\u{fc5b}"
        case .webexDeskCameraLight: return "\u{fc5c}"
        case .webexDeskCameraRegular: return "\u{fc5d}"
        case .webexHelixBold: return "\u{fc5e}"
        case .webexHelixLight: return "\u{fc5f}"
        case .webexHelixRegular: return "\u{fc60}"
        case .webexMeetingsBold: return "\u{fc61}"
        case .webexMeetingsFilled: return "\u{fc62}"
        case .webexMeetingsLight: return "\u{fc63}"
        case .webexMeetingsRegular: return "\u{fc64}"
        case .webexQuadCameraBold: return "\u{fc65}"
        case .webexQuadCameraLight: return "\u{fc66}"
        case .webexQuadCameraRegular: return "\u{fc67}"
        case .webexRoomKitBold: return "\u{fc68}"
        case .webexRoomKitLight: return "\u{fc69}"
        case .webexRoomKitPlusBold: return "\u{fc6a}"
        case .webexRoomKitPlusLight: return "\u{fc6b}"
        case .webexRoomKitPlusRegular: return "\u{fc6c}"
        case .webexRoomKitRegular: return "\u{fc6d}"
        case .webexShareBold: return "\u{fc6e}"
        case .webexShareLight: return "\u{fc6f}"
        case .webexShareRegular: return "\u{fc70}"
        case .webexTeamsBold: return "\u{fc71}"
        case .webexTeamsFilled: return "\u{fc72}"
        case .webexTeamsLight: return "\u{fc73}"
        case .webexTeamsNewBold: return "\u{fc74}"
        case .webexTeamsNewFilled: return "\u{fc75}"
        case .webexTeamsNewLight: return "\u{fc76}"
        case .webexTeamsNewRegular: return "\u{fc77}"
        case .webexTeamsRegular: return "\u{fc78}"
        case .webexTeamsRemoveBold: return "\u{fc79}"
        case .webexTeamsRemoveLight: return "\u{fc7a}"
        case .webexTeamsRemoveRegular: return "\u{fc7b}"
        case .webhookBold: return "\u{fc7c}"
        case .webhookLight: return "\u{fc7d}"
        case .webhookRegular: return "\u{fc7e}"
        case .webinarBold: return "\u{fc7f}"
        case .webinarFilled: return "\u{fc80}"
        case .webinarLight: return "\u{fc81}"
        case .webinarRegular: return "\u{fc82}"
        case .weeklyRecurringScheduleBold: return "\u{fc83}"
        case .weeklyRecurringScheduleLight: return "\u{fc84}"
        case .weeklyRecurringScheduleRegular: return "\u{fc85}"
        case .whisperAnnouncementBold: return "\u{fc86}"
        case .whisperAnnouncementFilled: return "\u{fc87}"
        case .whisperAnnouncementLight: return "\u{fc88}"
        case .whisperAnnouncementRegular: return "\u{fc89}"
        case .whisperCoachBold: return "\u{fc8a}"
        case .whisperCoachFilled: return "\u{fc8b}"
        case .whisperCoachLight: return "\u{fc8c}"
        case .whisperCoachRegular: return "\u{fc8d}"
        case .whiteboardBold: return "\u{fc8e}"
        case .whiteboardContentBold: return "\u{fc8f}"
        case .whiteboardContentFilled: return "\u{fc90}"
        case .whiteboardContentLight: return "\u{fc91}"
        case .whiteboardContentRegular: return "\u{fc92}"
        case .whiteboardFilled: return "\u{fc93}"
        case .whiteboardLight: return "\u{fc94}"
        case .whiteboardRegular: return "\u{fc95}"
        case .widgetBold: return "\u{fc96}"
        case .widgetFilled: return "\u{fc97}"
        case .widgetLight: return "\u{fc98}"
        case .widgetRegular: return "\u{fc99}"
        case .wifiBold: return "\u{fc9a}"
        case .wifiErrorBold: return "\u{fc9b}"
        case .wifiErrorLight: return "\u{fc9c}"
        case .wifiErrorRegular: return "\u{fc9d}"
        case .wifiLight: return "\u{fc9e}"
        case .wifiRegular: return "\u{fc9f}"
        case .wifiSignalGoodBold: return "\u{fca0}"
        case .wifiSignalGoodLight: return "\u{fca1}"
        case .wifiSignalGoodRegular: return "\u{fca2}"
        case .wifiSignalPoorBold: return "\u{fca3}"
        case .wifiSignalPoorLight: return "\u{fca4}"
        case .wifiSignalPoorRegular: return "\u{fca5}"
        case .wifiSignalUnstableBold: return "\u{fca6}"
        case .wifiSignalUnstableLight: return "\u{fca7}"
        case .wifiSignalUnstableRegular: return "\u{fca8}"
        case .windowCornerScrubBold: return "\u{fca9}"
        case .windowCornerScrubLight: return "\u{fcaa}"
        case .windowCornerScrubRegular: return "\u{fcab}"
        case .windowRightCornerScrubBold: return "\u{fcac}"
        case .windowRightCornerScrubLight: return "\u{fcad}"
        case .windowRightCornerScrubRegular: return "\u{fcae}"
        case .windowVerticalScrubBold: return "\u{fcaf}"
        case .windowVerticalScrubLight: return "\u{fcb0}"
        case .windowVerticalScrubRegular: return "\u{fcb1}"
        case .workflowDeploymentsBold: return "\u{fcb2}"
        case .workflowDeploymentsFilled: return "\u{fcb3}"
        case .workflowDeploymentsLight: return "\u{fcb4}"
        case .workflowDeploymentsRegular: return "\u{fcb5}"
        case .workphoneBold: return "\u{fcb6}"
        case .workphoneLight: return "\u{fcb7}"
        case .workphoneRegular: return "\u{fcb8}"
        case .zoomInBold: return "\u{fcb9}"
        case .zoomInLight: return "\u{fcba}"
        case .zoomInRegular: return "\u{fcbb}"
        case .zoomOutBold: return "\u{fcbc}"
        case .zoomOutLight: return "\u{fcbd}"
        case .zoomOutRegular: return "\u{fcbe}"
