...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .laserPointerFilled: return "\u{f6bf}"
        case .laserPointerLight: return "\u{f6c0}"
        case .laserPointerRegular: return "\u{f6c1}"
        case .launchBold: return "\u{f6c2}"
        case .launchLight: return "\u{f6c3}"
        case .launchRegular: return "\u{f6c4}"
        case .layoutSideBySideVerticalBold: return "\u{f6c5}"
        case .layoutSideBySideVerticalFilled: return "\u{f6c6}"
        case .layoutSideBySideVerticalLight: return "\u{f6c7}"
        case .layoutSideBySideVerticalRegular: return "\u{f6c8}"
        case .leaveBreakoutSessionBold: return "\u{f6c9}"
        case .leaveBreakoutSessionLight: return "\u{f6ca}"
        case .leaveBreakoutSessionRegular: return "\u{f6cb}"
        case .leaveDeviceBold: return "\u{f6cc}"
        case .leaveDeviceLight: return "\u{f6cd}"
        case .leaveDeviceRegular: return "\u{f6ce}"
        case .likeBold: return "\u{f6cf}"
        case .likeFilled: return "\u{f6d0}"
        case .likeLight: return "\u{f6d1}"
        case .likeRegular: return "\u{f6d2}"
        case .linkBold: return "\u{f6d3}"
        case .linkLight: return "\u{f6d4}"
        case .linkRegular: return "\u{f6d5}"
        case .listBulletedBold: return "\u{f6d6}"
        case .listBulletedLight: return "\u{f6d7}"
        case .listBulletedRegular: return "\u{f6d8}"
        case .listMenuBold: return "\u{f6d9}"
        case .listMenuLight: return "\u{f6da}"
        case .listMenuRegular: return "\u{f6db}"
        case .listNumberedBold: return "\u{f6dc}"
        case .listNumberedLight: return "\u{f6dd}"
        case .listNumberedRegular: return "\u{f6de}"
        case .liveBold: return "\u{f6df}"
        case .liveFilled: return "\u{f6e0}"
        case .liveLight: return "\u{f6e1}"
        case .liveRegular: return "\u{f6e2}"
        case .locationBold: return "\u{f6e3}"
        case .locationFilled: return "\u{f6e4}"
        case .locationLight: return "\u{f6e5}"
        case .locationRegular: return "\u{f6e6}"
        case .longTextBoxBold: return "\u{f6e7}"
        case .longTextBoxLight: return "\u{f6e8}"
        case .longTextBoxRegular: return "\u{f6e9}"
        case .lowerHandBold: return "\u{f6ea}"
        case .lowerHandLight: return "\u{f6eb}"
        case .lowerHandRegular: return "\u{f6ec}"
        case .magicPenBold: return "\u{f6ed}"
        case .magicPenFilled: return "\u{f6ee}"
        case .magicPenLight: return "\u{f6ef}"
        case .magicPenRegular: return "\u{f6f0}"
        case .markAsUnreadBold: return "\u{f6f1}"
        case .markAsUnreadLight: return "\u{f6f2}"
        case .markAsUnreadRegular: return "\u{f6f3}"
        case .markdownBold: return "\u{f6f4}"
        case .markdownLight: return "\u{f6f5}"
        case .markdownRegular: return "\u{f6f6}"
        case .markerBold: return "\u{f6f7}"
        case .markerFilled: return "\u{f6f8}"
        case .markerLight: return "\u{f6f9}"
        case .markerRegular: return "\u{f6fa}"
        case .maximizeBold: return "\u{f6fb}"
        case .maximizeLight: return "\u{f6fc}"
        case .maximizeRegular: return "\u{f6fd}"
        case .mediaPlayerBold: return "\u{f6fe}"
        case .mediaPlayerLight: return "\u{f6ff}"
        case .mediaPlayerRegular: return "\u{f700}"
        case .mediaQualityGoodBold: return "\u{f701}"
        case .mediaQualityGoodFilled: return "\u{f702}"
        case .mediaQualityGoodLight: return "\u{f703}"
        case .mediaQualityGoodRegular: return "\u{f704}"
        case .mediaQualityPoorBold: return "\u{f705}"
        case .mediaQualityPoorFilled: return "\u{f706}"
        case .mediaQualityPoorLight: return "\u{f707}"
        case .mediaQualityPoorRegular: return "\u{f708}"
        case .mediaQualityUnstableBold: return "\u{f709}"
        case .mediaQualityUnstableFilled: return "\u{f70a}"
        case .mediaQualityUnstableLight: return "\u{f70b}"
        case .mediaQualityUnstableRegular: return "\u{f70c}"
        case .meetBold: return "\u{f70d}"
        case .meetEndBold: return "\u{f70e}"
        case .meetEndLight: return "\u{f70f}"
        case .meetEndRegular: return "\u{f710}"
        case .meetFilled: return "\u{f711}"
        case .meetLight: return "\u{f712}"
        case .meetRegular: return "\u{f713}"
        case .meetingSummaryBold: return "\u{f714}"
        case .meetingSummaryFilled: return "\u{f715}"
        case .meetingSummaryLight: return "\u{f716}"
        case .meetingSummaryRegular: return "\u{f717}"
        case .meetingsBold: return "\u{f718}"
        case .meetingsFilled: return "\u{f719}"
        case .meetingsFocusMonthBold: return "\u{f71a}"
        case .meetingsFocusMonthLight: return "\u{f71b}"
        case .meetingsFocusMonthRegular: return "\u{f71c}"
        case .meetingsFocusOneDayBold: return "\u{f71d}"
        case .meetingsFocusOneDayLight: return "\u{f71e}"
        case .meetingsFocusOneDayRegular: return "\u{f71f}"
        case .meetingsFocusThreeDayBold: return "\u{f720}"
        case .meetingsFocusThreeDayLight: return "\u{f721}"
        case .meetingsFocusThreeDayRegular: return "\u{f722}"
        case .meetingsFocusUpcomingBold: return "\u{f723}"
        case .meetingsFocusUpcomingLight: return "\u{f724}"
        case .meetingsFocusUpcomingRegular: return "\u{f725}"
        case .meetingsLight: return "\u{f726}"
        case .meetingsPresenceBadgeFilled: return "\u{f727}"
        case .meetingsPresenceBold: return "\u{f728}"
        case .meetingsPresenceFilled: return "\u{f729}"
        case .meetingsPresenceLight: return "\u{f72a}"
        case .meetingsPresenceRegular: return "\u{f72b}"
        case .meetingsRegular: return "\u{f72c}"
        case .meetingsTeamBold: return "\u{f72d}"
        case .meetingsTeamFilled: return "\u{f72e}"
        case .meetingsTeamLight: return "\u{f72f}"
        case .meetingsTeamNewBold: return "\u{f730}"
        case .meetingsTeamNewLight: return "\u{f731}"
        case .meetingsTeamNewRegular: return "\u{f732}"
        case .meetingsTeamRegular: return "\u{f733}"
        case .mentionBold: return "\u{f734}"
        case .mentionLight: return "\u{f735}"
        case .mentionRegular: return "\u{f736}"
        case .messageQueingBold: return "\u{f737}"
        case .messageQueingLight: return "\u{f738}"
        case .messageQueingRegular: return "\u{f739}"
        case .microphoneBold: return "\u{f73a}"
        case .microphoneFilled: return "\u{f73b}"
        case .microphoneHardMutedBold: return "\u{f73c}"
        case .microphoneHardMutedCircleFilled: return "\u{f73d}"
        case .microphoneHardMutedLight: return "\u{f73e}"
        case .microphoneHardMutedRegular: return "\u{f73f}"
        case .microphoneLight: return "\u{f740}"
        case .microphoneMusicModeBold: return "\u{f741}"
        case .microphoneMusicModeLight: return "\u{f742}"
        case .microphoneMusicModeOnBold: return "\u{f743}"
        case .microphoneMusicModeOnLight: return "\u{f744}"
        case .microphoneMusicModeOnRegular: return "\u{f745}"
        case .microphoneMusicModeRegular: return "\u{f746}"
        case .microphoneMutedBold: return "\u{f747}"
        case .microphoneMutedCircleFilled: return "\u{f748}"
        case .microphoneMutedFilled: return "\u{f749}"
        case .microphoneMutedLight: return "\u{f74a}"
        case .microphoneMutedRegular: return "\u{f74b}"
        case .microphoneOnBold: return "\u{f74c}"
        case .microphoneOnLight: return "\u{f74d}"
        case .microphoneOnRegular: return "\u{f74e}"
        case .microphoneOptAllBold: return "\u{f74f}"
        case .microphoneOptAllLight: return "\u{f750}"
        case .microphoneOptAllMutedBold: return "\u{f751}"
        case .microphoneOptAllMutedLight: return "\u{f752}"
        case .microphoneOptAllMutedRegular: return "\u{f753}"
        case .microphoneOptAllOnBold: return "\u{f754}"
        case .microphoneOptAllOnLight: return "\u{f755}"
        case .microphoneOptAllOnRegular: return "\u{f756}"
        case .microphoneOptAllRegular: return "\u{f757}"
        case .microphoneOptMeBold: return "\u{f758}"
        case .microphoneOptMeLight: return "\u{f759}"
        case .microphoneOptMeMutedBold: return "\u{f75a}"
        case .microphoneOptMeMutedLight: return "\u{f75b}"
        case .microphoneOptMeMutedRegular: return "\u{f75c}"
        case .microphoneOptMeOnBold: return "\u{f75d}"
        case .microphoneOptMeOnLight: return "\u{f75e}"
        case .microphoneOptMeOnRegular: return "\u{f75f}"
        case .microphoneOptMeRegular: return "\u{f760}"
        case .microphoneRegular: return "\u{f761}"
        case .mindMapBold: return "\u{f762}"
        case .mindMapLight: return "\u{f763}"
        case .mindMapRegular: return "\u{f764}"
        case .minimizeBold: return "\u{f765}"
        case .minimizeLight: return "\u{f766}"
        case .minimizeRegular: return "\u{f767}"
        case .minusBold: return "\u{f768}"
        case .minusLight: return "\u{f769}"
        case .minusRegular: return "\u{f76a}"
        case .mirrorBold: return "\u{f76b}"
        case .mirrorFilled: return "\u{f76c}"
        case .mirrorLight: return "\u{f76d}"
        case .mirrorRegular: return "\u{f76e}"
        case .mmsFilled: return "\u{f76f}"
        case .moderatorBold: return "\u{f770}"
        case .moderatorLight: return "\u{f771}"
        case .moderatorRegular: return "\u{f772}"
        case .monitoringBold: return "\u{f773}"
        case .monitoringLight: return "\u{f774}"
        case .monitoringRegular: return "\u{f775}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f776}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f777}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f778}"
        case .moreAdrBold: return "\u{f779}"
        case .moreAdrLight: return "\u{f77a}"
        case .moreAdrRegular: return "\u{f77b}"
        case .moreBold: return "\u{f77c}"
        case .moreCircleBold: return "\u{f77d}"
        case .moreCircleFilled: return "\u{f77e}"
        case .moreCircleLight: return "\u{f77f}"
        case .moreCircleRegular: return "\u{f780}"
        case .moreLight: return "\u{f781}"
        case .moreRegular: return "\u{f782}"
        case .mouseCursorBold: return "\u{f783}"
        case .mouseCursorLight: return "\u{f784}"
        case .mouseCursorRegular: return "\u{f785}"
        case .moveCallInAdrBold: return "\u{f786}"
        case .moveCallInAdrLight: return "\u{f787}"
        case .moveCallInAdrRegular: return "\u{f788}"
        case .moveCallInIphBold: return "\u{f789}"
        case .moveCallInIphLight: return "\u{f78a}"
        case .moveCallInIphRegular: return "\u{f78b}"
        case .moveCallInLaptopBold: return "\u{f78c}"
        case .moveCallInLaptopLight: return "\u{f78d}"
        case .moveCallInLaptopRegular: return "\u{f78e}"
        case .moveCallInOutAdrBold: return "\u{f78f}"
        case .moveCallInOutAdrLight: return "\u{f790}"
        case .moveCallInOutAdrRegular: return "\u{f791}"
        case .moveCallInOutIphBold: return "\u{f792}"
        case .moveCallInOutIphLight: return "\u{f793}"
        case .moveCallInOutIphRegular: return "\u{f794}"
        case .moveCallInTabletBold: return "\u{f795}"
        case .moveCallInTabletLight: return "\u{f796}"
        case .moveCallInTabletRegular: return "\u{f797}"
        case .moveCallOutAdrBold: return "\u{f798}"
        case .moveCallOutAdrLight: return "\u{f799}"
        case .moveCallOutAdrRegular: return "\u{f79a}"
        case .moveCallOutIphBold: return "\u{f79b}"
        case .moveCallOutIphLight: return "\u{f79c}"
        case .moveCallOutIphRegular: return "\u{f79d}"
        case .moveCallOutLaptopBold: return "\u{f79e}"
        case .moveCallOutLaptopLight: return "\u{f79f}"
        case .moveCallOutLaptopRegular: return "\u{f7a0}"
        case .moveCallOutTabletBold: return "\u{f7a1}"
        case .moveCallOutTabletLight: return "\u{f7a2}"
        case .moveCallOutTabletRegular: return "\u{f7a3}"
        case .moveToScreenBold: return "\u{f7a4}"
        case .moveToScreenLight: return "\u{f7a5}"
        case .moveToScreenRegular: return "\u{f7a6}"
        case .multilineChartBold: return "\u{f7a7}"
        case .multilineChartFilled: return "\u{f7a8}"
        case .multilineChartLight: return "\u{f7a9}"
        case .multilineChartRegular: return "\u{f7aa}"
        case .multimediaBold: return "\u{f7ab}"
        case .multimediaFilled: return "\u{f7ac}"
        case .multimediaLight: return "\u{f7ad}"
        case .multimediaRegular: return "\u{f7ae}"
        case .multipledDevicesBold: return "\u{f7af}"
        case .multipledDevicesLight: return "\u{f7b0}"
        case .multipledDevicesRegular: return "\u{f7b1}"
        case .musicModeCircleBold: return "\u{f7b2}"
        case .musicModeCircleFilled: return "\u{f7b3}"
        case .musicModeCircleLight: return "\u{f7b4}"
        case .musicModeCircleRegular: return "\u{f7b5}"
        case .musicNoteBold: return "\u{f7b6}"
        case .musicNoteFilled: return "\u{f7b7}"
        case .musicNoteLight: return "\u{f7b8}"
        case .musicNoteRegular: return "\u{f7b9}"
        case .muteOnEntryBold: return "\u{f7ba}"
        case .muteOnEntryFilled: return "\u{f7bb}"
        case .muteOnEntryLight: return "\u{f7bc}"
        case .muteOnEntryRegular: return "\u{f7bd}"
        case .newManagerBold: return "\u{f7be}"
        case .newManagerLight: return "\u{f7bf}"
        case .newManagerRegular: return "\u{f7c0}"
        case .newTitleBold: return "\u{f7c1}"
        case .newTitleLight: return "\u{f7c2}"
        case .newTitleRegular: return "\u{f7c3}"
        case .newVoicemailBold: return "\u{f7c4}"
        case .newVoicemailLight: return "\u{f7c5}"
        case .newVoicemailRegular: return "\u{f7c6}"
        case .newWhiteboardBold: return "\u{f7c7}"
        case .newWhiteboardLight: return "\u{f7c8}"
        case .newWhiteboardRegular: return "\u{f7c9}"
        case .nextBold: return "\u{f7ca}"
        case .nextLight: return "\u{f7cb}"
        case .nextRegular: return "\u{f7cc}"
        case .noDevicesBold: return "\u{f7cd}"
        case .noDevicesLight: return "\u{f7ce}"
        case .noDevicesRegular: return "\u{f7cf}"
        case .noiseDetectedCanceledFilled: return "\u{f7d0}"
        case .noiseDetectedFilled: return "\u{f7d1}"
        case .noiseNoneCanceledFilled: return "\u{f7d2}"
        case .noiseNoneFilled: return "\u{f7d3}"
        case .noiseRemovalBold: return "\u{f7d4}"
        case .noiseRemovalLight: return "\u{f7d5}"
        case .noiseRemovalRegular: return "\u{f7d6}"
        case .noteBold: return "\u{f7d7}"
        case .noteLight: return "\u{f7d8}"
        case .notePptBold: return "\u{f7d9}"
        case .notePptLight: return "\u{f7da}"
        case .notePptRegular: return "\u{f7db}"
        case .noteRegular: return "\u{f7dc}"
        case .notesBold: return "\u{f7dd}"
        case .notesFilled: return "\u{f7de}"
        case .notesLight: return "\u{f7df}"
        case .notesRegular: return "\u{f7e0}"
        case .numberBold: return "\u{f7e1}"
        case .numberLight: return "\u{f7e2}"
        case .numberRegular: return "\u{f7e3}"
        case .oldRemoteBold: return "\u{f7e4}"
        case .oldRemoteLight: return "\u{f7e5}"
        case .oldRemoteRegular: return "\u{f7e6}"
        case .oldTouchBold: return "\u{f7e7}"
        case .oldTouchLight: return "\u{f7e8}"
        case .oldTouchRegular: return "\u{f7e9}"
        case .oneColumnBold: return "\u{f7ea}"
        case .oneColumnLight: return "\u{f7eb}"
        case .oneColumnRegular: return "\u{f7ec}"
        case .oneTimeBold: return "\u{f7ed}"
        case .oneTimeLight: return "\u{f7ee}"
        case .oneTimeRegular: return "\u{f7ef}"
        case .openInFolderBold: return "\u{f7f0}"
        case .openInFolderLight: return "\u{f7f1}"
        case .openInFolderRegular: return "\u{f7f2}"
        case .openPagesBold: return "\u{f7f3}"
        case .openPagesLight: return "\u{f7f4}"
        case .openPagesRegular: return "\u{f7f5}"
        case .otherNumberBold: return "\u{f7f6}"
        case .otherNumberFilled: return "\u{f7f7}"
        case .otherNumberLight: return "\u{f7f8}"
        case .otherNumberRegular: return "\u{f7f9}"
        case .otherNumberWarningBold: return "\u{f7fa}"
        case .otherNumberWarningLight: return "\u{f7fb}"
        case .otherNumberWarningRegular: return "\u{f7fc}"
        case .outgoingCallLegacyBold: return "\u{f7fd}"
        case .outgoingCallLegacyFilled: return "\u{f7fe}"
        case .outgoingCallLegacyLight: return "\u{f7ff}"
        case .outgoingCallLegacyRegular: return "\u{f800}"
        case .overflowLeftBold: return "\u{f801}"
        case .overflowLeftLight: return "\u{f802}"
        case .overflowLeftRegular: return "\u{f803}"
        case .overflowRightBold: return "\u{f804}"
        case .overflowRightLight: return "\u{f805}"
        case .overflowRightRegular: return "\u{f806}"
        case .pairedCameraBold: return "\u{f807}"
        case .pairedCameraLight: return "\u{f808}"
        case .pairedCameraRegular: return "\u{f809}"
        case .pairedDeviceBold: return "\u{f80a}"
        case .pairedDeviceLight: return "\u{f80b}"
        case .pairedDeviceRegular: return "\u{f80c}"
        case .pairedHandsetBold: return "\u{f80d}"
        case .pairedHandsetLight: return "\u{f80e}"
        case .pairedHandsetRegular: return "\u{f80f}"
        case .pairingBold: return "\u{f810}"
        case .pairingLight: return "\u{f811}"
        case .pairingRegular: return "\u{f812}"
        case .parkedBold: return "\u{f813}"
        case .parkedFilled: return "\u{f814}"
        case .parkedLight: return "\u{f815}"
        case .parkedRegular: return "\u{f816}"
        case .parseBold: return "\u{f817}"
        case .parseLight: return "\u{f818}"
        case .parseRegular: return "\u{f819}"
        case .partialBold: return "\u{f81a}"
        case .partialLight: return "\u{f81b}"
        case .partialRegular: return "\u{f81c}"
        case .participantAddBold: return "\u{f81d}"
        case .participantAddLight: return "\u{f81e}"
        case .participantAddRegular: return "\u{f81f}"
        case .participantBlockedBold: return "\u{f820}"
        case .participantBlockedLight: return "\u{f821}"
        case .participantBlockedRegular: return "\u{f822}"
        case .participantBold: return "\u{f823}"
        case .participantFilled: return "\u{f824}"
        case .participantLight: return "\u{f825}"
        case .participantListBold: return "\u{f826}"
        case .participantListFilled: return "\u{f827}"
        case .participantListLight: return "\u{f828}"
        case .participantListRegular: return "\u{f829}"
        case .participantRegular: return "\u{f82a}"
        case .participantRemoveBold: return "\u{f82b}"
        case .participantRemoveLight: return "\u{f82c}"
        case .participantRemoveRegular: return "\u{f82d}"
        case .participantUnknownBold: return "\u{f82e}"
        case .participantUnknownLight: return "\u{f82f}"
        case .participantUnknownRegular: return "\u{f830}"
        case .passMouseBold: return "\u{f831}"
        case .passMouseLight: return "\u{f832}"
        case .passMouseRegular: return "\u{f833}"
        case .pauseBadgeFilled: return "\u{f834}"
        case .pauseBold: return "\u{f835}"
        case .pauseFilled: return "\u{f836}"
        case .pauseLight: return "\u{f837}"
        case .pauseRegular: return "\u{f838}"
        case .peopleAddBold: return "\u{f839}"
        case .peopleAddFilled: return "\u{f83a}"
        case .peopleAddLight: return "\u{f83b}"
        case .peopleAddRegular: return "\u{f83c}"
        case .peopleBold: return "\u{f83d}"
        case .peopleCircleBold: return "\u{f83e}"
        case .peopleCircleFilled: return "\u{f83f}"
        case .peopleCircleLight: return "\u{f840}"
        case .peopleCircleRegular: return "\u{f841}"
        case .peopleFilled: return "\u{f842}"
        case .peopleInsightsBold: return "\u{f843}"
        case .peopleInsightsFilled: return "\u{f844}"
        case .peopleInsightsLight: return "\u{f845}"
        case .peopleInsightsRegular: return "\u{f846}"
        case .peopleLight: return "\u{f847}"
        case .peopleRegular: return "\u{f848}"
        case .phoneAlertBold: return "\u{f849}"
        case .phoneAlertLight: return "\u{f84a}"
        case .phoneAlertRegular: return "\u{f84b}"
        case .phoneBadgeFilled: return "\u{f84c}"
        case .phoneBold: return "\u{f84d}"
        case .phoneFilled: return "\u{f84e}"
        case .phoneLight: return "\u{f84f}"
        case .phoneMutedBold: return "\u{f850}"
        case .phoneMutedLight: return "\u{f851}"
        case .phoneMutedRegular: return "\u{f852}"
        case .phonePrivateBold: return "\u{f853}"
        case .phonePrivateLight: return "\u{f854}"
        case .phonePrivateRegular: return "\u{f855}"
        case .phoneRegular: return "\u{f856}"
        case .phoneReplyAllBold: return "\u{f857}"
        case .phoneReplyAllLight: return "\u{f858}"
        case .phoneReplyAllRegular: return "\u{f859}"
        case .phoneReplyBold: return "\u{f85a}"
        case .phoneReplyLight: return "\u{f85b}"
        case .phoneReplyRegular: return "\u{f85c}"
        case .pickerBold: return "\u{f85d}"
        case .pickerLight: return "\u{f85e}"
        case .pickerRegular: return "\u{f85f}"
        case .pieChartBold: return "\u{f860}"
        case .pieChartFilled: return "\u{f861}"
        case .pieChartLight: return "\u{f862}"
        case .pieChartRegular: return "\u{f863}"
        case .pinBold: return "\u{f864}"
        case .pinFilled: return "\u{f865}"
        case .pinLight: return "\u{f866}"
        case .pinListActivityBold: return "\u{f867}"
        case .pinListActivityLight: return "\u{f868}"
        case .pinListActivityRegular: return "\u{f869}"
        case .pinListBold: return "\u{f86a}"
        case .pinListLight: return "\u{f86b}"
        case .pinListRegular: return "\u{f86c}"
        case .pinMutedBold: return "\u{f86d}"
        case .pinMutedFilled: return "\u{f86e}"
        case .pinMutedLight: return "\u{f86f}"
        case .pinMutedRegular: return "\u{f870}"
        case .pinRegular: return "\u{f871}"
        case .pipBold: return "\u{f872}"
        case .pipEnterBold: return "\u{f873}"
        case .pipEnterLight: return "\u{f874}"
        case .pipEnterRegular: return "\u{f875}"
        case .pipExitBold: return "\u{f876}"
        case .pipExitLight: return "\u{f877}"
        case .pipExitRegular: return "\u{f878}"
        case .pipFilled: return "\u{f879}"
        case .pipLight: return "\u{f87a}"
        case .pipRegular: return "\u{f87b}"
        case .placeholderBold: return "\u{f87c}"
        case .placeholderFilled: return "\u{f87d}"
        case .placeholderLight: return "\u{f87e}"
        case .placeholderRegular: return "\u{f87f}"
        case .playBold: return "\u{f880}"
        case .playCircleBold: return "\u{f881}"
        case .playCircleFilled: return "\u{f882}"
        case .playCircleLight: return "\u{f883}"
        case .playCircleRegular: return "\u{f884}"
        case .playFilled: return "\u{f885}"
        case .playLight: return "\u{f886}"
        case .playRegular: return "\u{f887}"
        case .plugAcBold: return "\u{f888}"
        case .plugAcLight: return "\u{f889}"
        case .plugAcRegular: return "\u{f88a}"
        case .plusBold: return "\u{f88b}"
        case .plusCircleBold: return "\u{f88c}"
        case .plusCircleFilled: return "\u{f88d}"
        case .plusCircleLight: return "\u{f88e}"
        case .plusCircleRegular: return "\u{f88f}"
        case .plusLight: return "\u{f890}"
        case .plusRegular: return "\u{f891}"
        case .pmrBold: return "\u{f892}"
        case .pmrFilled: return "\u{f893}"
        case .pmrLight: return "\u{f894}"
        case .pmrRegular: return "\u{f895}"
        case .pollBold: return "\u{f896}"
        case .pollFilled: return "\u{f897}"
        case .pollLight: return "\u{f898}"
        case .pollRegular: return "\u{f899}"
        case .popInBold: return "\u{f89a}"
        case .popInLight: return "\u{f89b}"
        case .popInRegular: return "\u{f89c}"
        case .popOutBold: return "\u{f89d}"
        case .popOutLight: return "\u{f89e}"
        case .popOutRegular: return "\u{f89f}"
        case .popUpBold: return "\u{f8a0}"
        case .popUpLight: return "\u{f8a1}"
        case .popUpRegular: return "\u{f8a2}"
        case .portraitLandscapeBold: return "\u{f8a3}"
        case .portraitLandscapeLight: return "\u{f8a4}"
        case .portraitLandscapeRegular: return "\u{f8a5}"
        case .potentialFraudBold: return "\u{f8a6}"
        case .potentialFraudFilled: return "\u{f8a7}"
        case .potentialFraudLight: return "\u{f8a8}"
        case .potentialFraudRegular: return "\u{f8a9}"
        case .powerAcBold: return "\u{f8aa}"
        case .powerAcLight: return "\u{f8ab}"
        case .powerAcRegular: return "\u{f8ac}"
        case .powerBold: return "\u{f8ad}"
        case .powerLight: return "\u{f8ae}"
        case .powerRegular: return "\u{f8af}"
        case .preHeaderBold: return "\u{f8b0}"
        case .preHeaderLight: return "\u{f8b1}"
        case .preHeaderRegular: return "\u{f8b2}"
        case .premiumBold: return "\u{f8b3}"
        case .premiumLight: return "\u{f8b4}"
        case .premiumRegular: return "\u{f8b5}"
        case .presentationBold: return "\u{f8b6}"
        case .presentationLight: return "\u{f8b7}"
        case .presentationRegular: return "\u{f8b8}"
        case .preventDownloadBold: return "\u{f8b9}"
        case .preventDownloadFilled: return "\u{f8ba}"
        case .preventDownloadLight: return "\u{f8bb}"
        case .preventDownloadRegular: return "\u{f8bc}"
        case .primaryParticipantBold: return "\u{f8bd}"
        case .primaryParticipantLight: return "\u{f8be}"
        case .primaryParticipantRegular: return "\u{f8bf}"
        case .printBold: return "\u{f8c0}"
        case .printLight: return "\u{f8c1}"
        case .printRegular: return "\u{f8c2}"
        case .priorityBadgeFilled: return "\u{f8c3}"
        case .priorityCircleBold: return "\u{f8c4}"
        case .priorityCircleFilled: return "\u{f8c5}"
        case .priorityCircleLight: return "\u{f8c6}"
        case .priorityCircleRegular: return "\u{f8c7}"
        case .priorityCircleTwoBold: return "\u{f8c8}"
        case .priorityCircleTwoFilled: return "\u{f8c9}"
        case .priorityCircleTwoLight: return "\u{f8ca}"
        case .priorityCircleTwoRegular: return "\u{f8cb}"
        case .priorityWaveBold: return "\u{f8cc}"
        case .priorityWaveLight: return "\u{f8cd}"
        case .priorityWaveRegular: return "\u{f8ce}"
        case .privacyCircleBold: return "\u{f8cf}"
        case .privacyCircleFilled: return "\u{f8d0}"
        case .privacyCircleLight: return "\u{f8d1}"
        case .privacyCircleRegular: return "\u{f8d2}"
        case .privateBold: return "\u{f8d3}"
        case .privateCircleBold: return "\u{f8d4}"
        case .privateCircleFilled: return "\u{f8d5}"
        case .privateCircleLight: return "\u{f8d6}"
        case .privateCircleRegular: return "\u{f8d7}"
        case .privateLight: return "\u{f8d8}"
        case .privateMeetingBold: return "\u{f8d9}"
        case .privateMeetingLight: return "\u{f8da}"
        case .privateMeetingRegular: return "\u{f8db}"
        case .privateRegular: return "\u{f8dc}"
        case .productDemoBold: return "\u{f8dd}"
        case .productDemoLight: return "\u{f8de}"
        case .productDemoRegular: return "\u{f8df}"
        case .proximityBold: return "\u{f8e0}"
        case .proximityLight: return "\u{f8e1}"
        case .proximityMutedBold: return "\u{f8e2}"
        case .proximityMutedLight: return "\u{f8e3}"
        case .proximityMutedRegular: return "\u{f8e4}"
        case .proximityRegular: return "\u{f8e5}"
        case .proximityVideoBold: return "\u{f8e6}"
        case .proximityVideoLight: return "\u{f8e7}"
        case .proximityVideoRegular: return "\u{f8e8}"
        case .ptoPresenceBold: return "\u{f8e9}"
        case .ptoPresenceFilled: return "\u{f8ea}"
        case .ptoPresenceLight: return "\u{f8eb}"
        case .ptoPresenceRegular: return "\u{f8ec}"
        case .pullCallBold: return "\u{f8ed}"
        case .pullCallFilled: return "\u{f8ee}"
        case .pullCallLight: return "\u{f8ef}"
        case .pullCallRegular: return "\u{f8f0}"
        case .qABold: return "\u{f8f1}"
        case .qALight: return "\u{f8f2}"
        case .qARegular: return "\u{f8f3}"
        case .qrCodeBold: return "\u{f8f4}"
        case .qrCodeLight: return "\u{f8f5}"
        case .qrCodeRegular: return "\u{f8f6}"
        case .qrCodeScanBold: return "\u{f8f7}"
        case .qrCodeScanLight: return "\u{f8f8}"
        case .qrCodeScanRegular: return "\u{f8f9}"
        case .qualityBold: return "\u{f8fa}"
        case .qualityLight: return "\u{f8fb}"
        case .qualityRegular: return "\u{f8fc}"
        case .queueContactBold: return "\u{f8fd}"
        case .queueContactFilled: return "\u{f8fe}"
        case .queueContactLight: return "\u{f8ff}"
        case .queueContactRegular: return "\u{f900}"
        case .quietBold: return "\u{f901}"
        case .quietHoursPresenceBold: return "\u{f902}"
        case .quietHoursPresenceFilled: return "\u{f903}"
        case .quietHoursPresenceLight: return "\u{f904}"
        case .quietHoursPresenceRegular: return "\u{f905}"
        case .quietLight: return "\u{f906}"
        case .quietRegular: return "\u{f907}"
        case .radioButtonGroupBold: return "\u{f908}"
        case .radioButtonGroupLight: return "\u{f909}"
        case .radioButtonGroupRegular: return "\u{f90a}"
        case .raiseHandBold: return "\u{f90b}"
        case .raiseHandCircleFilled: return "\u{f90c}"
        case .raiseHandFilled: return "\u{f90d}"
        case .raiseHandLight: return "\u{f90e}"
        case .raiseHandRegular: return "\u{f90f}"
        case .ramBold: return "\u{f910}"
        case .ramLight: return "\u{f911}"
        case .ramRegular: return "\u{f912}"
        case .reactionsBold: return "\u{f913}"
        case .reactionsFilled: return "\u{f914}"
        case .reactionsLight: return "\u{f915}"
        case .reactionsRegular: return "\u{f916}"
        case .reactivateBold: return "\u{f917}"
        case .reactivateLight: return "\u{f918}"
        case .reactivateRegular: return "\u{f919}"
        case .receiveVoiceBold: return "\u{f91a}"
        case .receiveVoiceFilled: return "\u{f91b}"
        case .receiveVoiceLight: return "\u{f91c}"
        case .receiveVoiceRegular: return "\u{f91d}"
        case .recentsBold: return "\u{f91e}"
        case .recentsFilled: return "\u{f91f}"
        case .recentsLight: return "\u{f920}"
        case .recentsPresenceBadgeFilled: return "\u{f921}"
        case .recentsPresenceBold: return "\u{f922}"
        case .recentsPresenceFilled: return "\u{f923}"
        case .recentsPresenceLight: return "\u{f924}"
        case .recentsPresenceRegular: return "\u{f925}"
        case .recentsRegular: return "\u{f926}"
        case .recordActiveBadgeFilled: return "\u{f927}"
        case .recordActiveBold: return "\u{f928}"
        case .recordActiveFilled: return "\u{f929}"
        case .recordActiveLight: return "\u{f92a}"
        case .recordActiveRegular: return "\u{f92b}"
        case .recordBold: return "\u{f92c}"
        case .recordFilled: return "\u{f92d}"
        case .recordLight: return "\u{f92e}"
        case .recordPausedBadgeFilled: return "\u{f92f}"
        case .recordPausedBold: return "\u{f930}"
        case .recordPausedFilled: return "\u{f931}"
        case .recordPausedLight: return "\u{f932}"
        case .recordPausedRegular: return "\u{f933}"
        case .recordRegular: return "\u{f934}"
        case .recurringBold: return "\u{f935}"
        case .recurringLight: return "\u{f936}"
        case .recurringOffBold: return "\u{f937}"
        case .recurringOffLight: return "\u{f938}"
        case .recurringOffRegular: return "\u{f939}"
        case .recurringRegular: return "\u{f93a}"
        case .redoBold: return "\u{f93b}"
        case .redoLight: return "\u{f93c}"
        case .redoRegular: return "\u{f93d}"
        case .refreshBold: return "\u{f93e}"
        case .refreshLight: return "\u{f93f}"
        case .refreshRegular: return "\u{f940}"
        case .remoteDesktopControlBold: return "\u{f941}"
        case .remoteDesktopControlFilled: return "\u{f942}"
        case .remoteDesktopControlLight: return "\u{f943}"
        case .remoteDesktopControlRegular: return "\u{f944}"
        case .removeBold: return "\u{f945}"
        case .removeFilled: return "\u{f946}"
        case .removeLight: return "\u{f947}"
        case .removeRegular: return "\u{f948}"
        case .replyBold: return "\u{f949}"
        case .replyFilled: return "\u{f94a}"
        case .replyLight: return "\u{f94b}"
        case .replyListBold: return "\u{f94c}"
        case .replyListLight: return "\u{f94d}"
        case .replyListRegular: return "\u{f94e}"
        case .replyPrivatelyBold: return "\u{f94f}"
        case .replyPrivatelyLight: return "\u{f950}"
        case .replyPrivatelyRegular: return "\u{f951}"
        case .replyRegular: return "\u{f952}"
        case .resetBold: return "\u{f953}"
        case .resetLight: return "\u{f954}"
        case .resetRegular: return "\u{f955}"
        case .resizeCornerBold: return "\u{f956}"
        case .resizeCornerLight: return "\u{f957}"
        case .resizeCornerRegular: return "\u{f958}"
        case .responsiveMobileBold: return "\u{f959}"
        case .responsiveMobileLight: return "\u{f95a}"
        case .responsiveMobileRegular: return "\u{f95b}"
        case .restartBold: return "\u{f95c}"
        case .restartLight: return "\u{f95d}"
        case .restartRegular: return "\u{f95e}"
        case .retrieveCallBold: return "\u{f95f}"
        case .retrieveCallFilled: return "\u{f960}"
        case .retrieveCallLight: return "\u{f961}"
        case .retrieveCallRegular: return "\u{f962}"
        case .returnBold: return "\u{f963}"
        case .returnLight: return "\u{f964}"
        case .returnRegular: return "\u{f965}"
        case .rewindTenSecBold: return "\u{f966}"
        case .rewindTenSecLight: return "\u{f967}"
        case .rewindTenSecRegular: return "\u{f968}"
        case .ringtoneBold: return "\u{f969}"
        case .ringtoneLight: return "\u{f96a}"
        case .ringtoneRegular: return "\u{f96b}"
        case .roomCalendarBold: return "\u{f96c}"
        case .roomCalendarLight: return "\u{f96d}"
        case .roomCalendarRegular: return "\u{f96e}"
        case .roomLightsBold: return "\u{f96f}"
        case .roomLightsFilled: return "\u{f970}"
        case .roomLightsLight: return "\u{f971}"
        case .roomLightsRegular: return "\u{f972}"
        case .rotateContentBold: return "\u{f973}"
        case .rotateContentFilled: return "\u{f974}"
        case .rotateContentLight: return "\u{f975}"
        case .rotateContentRegular: return "\u{f976}"
        case .rssBold: return "\u{f977}"
        case .rssFilled: return "\u{f978}"
        case .rssLight: return "\u{f979}"
        case .rssRegular: return "\u{f97a}"
        case .ruleBasedBold: return "\u{f97b}"
        case .ruleBasedLight: return "\u{f97c}"
        case .ruleBasedRegular: return "\u{f97d}"
        case .runningApplicationBold: return "\u{f97e}"
        case .runningApplicationFilled: return "\u{f97f}"
        case .runningApplicationLight: return "\u{f980}"
        case .runningApplicationRegular: return "\u{f981}"
        case .saveBold: return "\u{f982}"
        case .saveLight: return "\u{f983}"
        case .saveRegular: return "\u{f984}"
        case .saveTranscriptBold: return "\u{f985}"
        case .saveTranscriptFilled: return "\u{f986}"
        case .saveTranscriptLight: return "\u{f987}"
        case .saveTranscriptRegular: return "\u{f988}"
        case .scanBold: return "\u{f989}"
        case .scanLight: return "\u{f98a}"
        case .scanRegular: return "\u{f98b}"
        case .scheduleSendBold: return "\u{f98c}"
        case .scheduleSendFilled: return "\u{f98d}"
        case .scheduleSendLight: return "\u{f98e}"
        case .scheduleSendRegular: return "\u{f98f}"
        case .scheduleWinnerBold: return "\u{f990}"
        case .scheduleWinnerFilled: return "\u{f991}"
        case .scheduleWinnerLight: return "\u{f992}"
        case .scheduleWinnerRegular: return "\u{f993}"
        case .schedulerAvailableBold: return "\u{f994}"
        case .schedulerAvailableLight: return "\u{f995}"
        case .schedulerAvailableRegular: return "\u{f996}"
        case .schedulerNotWorkingHoursBold: return "\u{f997}"
        case .schedulerNotWorkingHoursLight: return "\u{f998}"
        case .schedulerNotWorkingHoursRegular: return "\u{f999}"
        case .schedulerUnavailableBold: return "\u{f99a}"
        case .schedulerUnavailableLight: return "\u{f99b}"
        case .schedulerUnavailableRegular: return "\u{f99c}"
        case .schedulerUnknownBold: return "\u{f99d}"
        case .schedulerUnknownLight: return "\u{f99e}"
        case .schedulerUnknownRegular: return "\u{f99f}"
        case .screenshotBold: return "\u{f9a0}"
        case .screenshotDocBold: return "\u{f9a1}"
        case .screenshotDocFilled: return "\u{f9a2}"
        case .screenshotDocLight: return "\u{f9a3}"
        case .screenshotDocRegular: return "\u{f9a4}"
        case .screenshotLight: return "\u{f9a5}"
        case .screenshotRegular: return "\u{f9a6}"
        case .searchBold: return "\u{f9a7}"
        case .searchFilled: return "\u{f9a8}"
        case .searchLight: return "\u{f9a9}"
        case .searchRegular: return "\u{f9aa}"
        case .secondaryArrowBold: return "\u{f9ab}"
        case .secondaryArrowLight: return "\u{f9ac}"
        case .secondaryArrowRegular: return "\u{f9ad}"
        case .secureCallLockBold: return "\u{f9ae}"
        case .secureCallLockFilled: return "\u{f9af}"
        case .secureCallLockLight: return "\u{f9b0}"
        case .secureCallLockRegular: return "\u{f9b1}"
        case .secureCallShieldBold: return "\u{f9b2}"
        case .secureCallShieldFilled: return "\u{f9b3}"
        case .secureCallShieldLight: return "\u{f9b4}"
        case .secureCallShieldRegular: return "\u{f9b5}"
        case .secureCircleBold: return "\u{f9b6}"
        case .secureCircleFilled: return "\u{f9b7}"
        case .secureCircleLight: return "\u{f9b8}"
        case .secureCircleRegular: return "\u{f9b9}"
        case .secureLockBold: return "\u{f9ba}"
        case .secureLockFilled: return "\u{f9bb}"
        case .secureLockLight: return "\u{f9bc}"
        case .secureLockRegular: return "\u{f9bd}"
        case .segmentExcludeFilled: return "\u{f9be}"
        case .segmentFilterFilled: return "\u{f9bf}"
        case .segmentIncludeFilled: return "\u{f9c0}"
        case .selectAllBold: return "\u{f9c1}"
        case .selectAllFilled: return "\u{f9c2}"
        case .selectAllLight: return "\u{f9c3}"
        case .selectAllRegular: return "\u{f9c4}"
        case .selectionBold: return "\u{f9c5}"
        case .selectionFilled: return "\u{f9c6}"
        case .selectionLight: return "\u{f9c7}"
        case .selectionRegular: return "\u{f9c8}"
        case .sendBold: return "\u{f9c9}"
        case .sendDigitsBold: return "\u{f9ca}"
        case .sendDigitsFilled: return "\u{f9cb}"
        case .sendDigitsLight: return "\u{f9cc}"
        case .sendDigitsRegular: return "\u{f9cd}"
        case .sendFilled: return "\u{f9ce}"
        case .sendLight: return "\u{f9cf}"
        case .sendRegular: return "\u{f9d0}"
        case .sendVoiceBold: return "\u{f9d1}"
        case .sendVoiceFilled: return "\u{f9d2}"
        case .sendVoiceLight: return "\u{f9d3}"
        case .sendVoiceRegular: return "\u{f9d4}"
        case .serverBold: return "\u{f9d5}"
        case .serverErrorBold: return "\u{f9d6}"
        case .serverErrorLight: return "\u{f9d7}"
        case .serverErrorRegular: return "\u{f9d8}"
        case .serverLight: return "\u{f9d9}"
        case .serverRegular: return "\u{f9da}"
        case .servicesBold: return "\u{f9db}"
        case .servicesLight: return "\u{f9dc}"
        case .servicesRegular: return "\u{f9dd}"
        case .setVariableBold: return "\u{f9de}"
        case .setVariableLight: return "\u{f9df}"
        case .setVariableRegular: return "\u{f9e0}"
        case .settingsBold: return "\u{f9e1}"
        case .settingsFilled: return "\u{f9e2}"
        case .settingsLight: return "\u{f9e3}"
        case .settingsRegular: return "\u{f9e4}"
        case .setupAssistantBold: return "\u{f9e5}"
        case .setupAssistantLight: return "\u{f9e6}"
        case .setupAssistantRegular: return "\u{f9e7}"
        case .sftpBold: return "\u{f9e8}"
        case .sftpLight: return "\u{f9e9}"
        case .sftpRegular: return "\u{f9ea}"
        case .shapeCircleBold: return "\u{f9eb}"
        case .shapeCircleFilled: return "\u{f9ec}"
        case .shapeCircleLight: return "\u{f9ed}"
        case .shapeCircleMdFilled: return "\u{f9ee}"
        case .shapeCircleRegular: return "\u{f9ef}"
        case .shapeCircleSmFilled: return "\u{f9f0}"
        case .shapeDiagonalLineBold: return "\u{f9f1}"
        case .shapeDiagonalLineLight: return "\u{f9f2}"
        case .shapeDiagonalLineRegular: return "\u{f9f3}"
        case .shapeDiamondBold: return "\u{f9f4}"
        case .shapeDiamondFilled: return "\u{f9f5}"
        case .shapeDiamondLight: return "\u{f9f6}"
        case .shapeDiamondRegular: return "\u{f9f7}"
        case .shapeOvalBold: return "\u{f9f8}"
        case .shapeOvalLight: return "\u{f9f9}"
        case .shapeOvalRegular: return "\u{f9fa}"
        case .shapeSquareBold: return "\u{f9fb}"
        case .shapeSquareFilled: return "\u{f9fc}"
        case .shapeSquareLight: return "\u{f9fd}"
        case .shapeSquareRegular: return "\u{f9fe}"
        case .shapeTriangleBold: return "\u{f9ff}"
        case .shapeTriangleFilled: return "\u{fa00}"
        case .shapeTriangleLight: return "\u{fa01}"
        case .shapeTriangleRegular: return "\u{fa02}"
        case .shapesBold: return "\u{fa03}"
        case .shapesFilled: return "\u{fa04}"
        case .shapesLight: return "\u{fa05}"
        case .shapesRegular: return "\u{fa06}"
        case .shareCNativeAdrBold: return "\u{fa07}"
        case .shareCNativeAdrFilled: return "\u{fa08}"
        case .shareCNativeAdrLight: return "\u{fa09}"
        case .shareCNativeAdrRegular: return "\u{fa0a}"
        case .shareCNativeIphBold: return "\u{fa0b}"
        case .shareCNativeIphLight: return "\u{fa0c}"
        case .shareCNativeIphRegular: return "\u{fa0d}"
        case .shareContentOnDeviceBold: return "\u{fa0e}"
        case .shareContentOnDeviceLight: return "\u{fa0f}"
        case .shareContentOnDeviceRegular: return "\u{fa10}"
        case .shareScreenAddBold: return "\u{fa11}"
        case .shareScreenAddLight: return "\u{fa12}"
        case .shareScreenAddRegular: return "\u{fa13}"
        case .shareScreenBadgeFilled: return "\u{fa14}"
        case .shareScreenBold: return "\u{fa15}"
        case .shareScreenFilled: return "\u{fa16}"
        case .shareScreenLight: return "\u{fa17}"
        case .shareScreenRegular: return "\u{fa18}"
        case .shareSpaceBold: return "\u{fa19}"
        case .shareSpaceLight: return "\u{fa1a}"
        case .shareSpaceRegular: return "\u{fa1b}"
        case .shieldBold: return "\u{fa1c}"
        case .shieldLight: return "\u{fa1d}"
        case .shieldRegular: return "\u{fa1e}"
        case .shoppingCartBold: return "\u{fa1f}"
        case .shoppingCartFilled: return "\u{fa20}"
        case .shoppingCartLight: return "\u{fa21}"
        case .shoppingCartRegular: return "\u{fa22}"
        case .shortTextBoxBold: return "\u{fa23}"
        case .shortTextBoxLight: return "\u{fa24}"
        case .shortTextBoxRegular: return "\u{fa25}"
        case .showBold: return "\u{fa26}"
        case .showFilled: return "\u{fa27}"
        case .showLight: return "\u{fa28}"
        case .showRegular: return "\u{fa29}"
        case .signInBold: return "\u{fa2a}"
        case .signInFilled: return "\u{fa2b}"
        case .signInForcedBold: return "\u{fa2c}"
        case .signInForcedLight: return "\u{fa2d}"
        case .signInForcedRegular: return "\u{fa2e}"
        case .signInLight: return "\u{fa2f}"
        case .signInRegular: return "\u{fa30}"
        case .signLangIntBold: return "\u{fa31}"
        case .signLangIntLight: return "\u{fa32}"
        case .signLangIntRegular: return "\u{fa33}"
        case .signOutBold: return "\u{fa34}"
        case .signOutLight: return "\u{fa35}"
        case .signOutRegular: return "\u{fa36}"
        case .signalFourBold: return "\u{fa37}"
        case .signalFourLight: return "\u{fa38}"
        case .signalFourRegular: return "\u{fa39}"
        case .signalOneBold: return "\u{fa3a}"
        case .signalOneLight: return "\u{fa3b}"
        case .signalOneRegular: return "\u{fa3c}"
        case .signalThreeBold: return "\u{fa3d}"
        case .signalThreeLight: return "\u{fa3e}"
        case .signalThreeRegular: return "\u{fa3f}"
        case .signalTwoBold: return "\u{fa40}"
        case .signalTwoLight: return "\u{fa41}"
        case .signalTwoRegular: return "\u{fa42}"
        case .signalZeroBold: return "\u{fa43}"
        case .signalZeroLight: return "\u{fa44}"
        case .signalZeroRegular: return "\u{fa45}"
        case .simplePromotionBold: return "\u{fa46}"
        case .simplePromotionLight: return "\u{fa47}"
        case .simplePromotionRegular: return "\u{fa48}"
        case .singleNumberReachBold: return "\u{fa49}"
        case .singleNumberReachLight: return "\u{fa4a}"
        case .singleNumberReachRegular: return "\u{fa4b}"
        case .sipRegistrationInProgressBold: return "\u{fa4c}"
        case .sipRegistrationInProgressFilled: return "\u{fa4d}"
        case .sipRegistrationInProgressLight: return "\u{fa4e}"
        case .sipRegistrationInProgressRegular: return "\u{fa4f}"
        case .skipBold: return "\u{fa50}"
        case .skipBwBold: return "\u{fa51}"
        case .skipBwFilled: return "\u{fa52}"
        case .skipBwLight: return "\u{fa53}"
        case .skipBwRegular: return "\u{fa54}"
        case .skipFwBold: return "\u{fa55}"
        case .skipFwFilled: return "\u{fa56}"
        case .skipFwLight: return "\u{fa57}"
        case .skipFwRegular: return "\u{fa58}"
        case .skipLight: return "\u{fa59}"
        case .skipRegular: return "\u{fa5a}"
        case .smartAudioBold: return "\u{fa5b}"
        case .smartAudioLight: return "\u{fa5c}"
        case .smartAudioRegular: return "\u{fa5d}"
        case .smsFilled: return "\u{fa5e}"
        case .smsInboundBold: return "\u{fa5f}"
        case .smsInboundLight: return "\u{fa60}"
        case .smsInboundRegular: return "\u{fa61}"
        case .smsMessageBold: return "\u{fa62}"
        case .smsMessageFilled: return "\u{fa63}"
        case .smsMessageLight: return "\u{fa64}"
        case .smsMessageRegular: return "\u{fa65}"
        case .smsOutgoingFilled: return "\u{fa66}"
        case .smsUnreadBold: return "\u{fa67}"
        case .smsUnreadLight: return "\u{fa68}"
        case .smsUnreadRegular: return "\u{fa69}"
        case .sortAscendingBold: return "\u{fa6a}"
        case .sortAscendingLight: return "\u{fa6b}"
        case .sortAscendingRegular: return "\u{fa6c}"
        case .sortDescendingBold: return "\u{fa6d}"
        case .sortDescendingLight: return "\u{fa6e}"
        case .sortDescendingRegular: return "\u{fa6f}"
        case .soundDefaultBold: return "\u{fa70}"
        case .soundDefaultLight: return "\u{fa71}"
        case .soundDefaultRegular: return "\u{fa72}"
        case .sparkleBold: return "\u{fa73}"
        case .sparkleFilled: return "\u{fa74}"
        case .sparkleLight: return "\u{fa75}"
        case .sparkleRegular: return "\u{fa76}"
        case .speakerBold: return "\u{fa77}"
        case .speakerDisconnectedBold: return "\u{fa78}"
        case .speakerDisconnectedFilled: return "\u{fa79}"
        case .speakerDisconnectedLight: return "\u{fa7a}"
        case .speakerDisconnectedRegular: return "\u{fa7b}"
        case .speakerFilled: return "\u{fa7c}"
        case .speakerLight: return "\u{fa7d}"
        case .speakerMutedBold: return "\u{fa7e}"
        case .speakerMutedFilled: return "\u{fa7f}"
        case .speakerMutedLight: return "\u{fa80}"
        case .speakerMutedRegular: return "\u{fa81}"
        case .speakerOffBold: return "\u{fa82}"
        case .speakerOffFilled: return "\u{fa83}"
        case .speakerOffLight: return "\u{fa84}"
        case .speakerOffRegular: return "\u{fa85}"
        case .speakerOnBold: return "\u{fa86}"
        case .speakerOnLight: return "\u{fa87}"
        case .speakerOnRegular: return "\u{fa88}"
        case .speakerRegular: return "\u{fa89}"
        case .speakerTurnDownBold: return "\u{fa8a}"
        case .speakerTurnDownFilled: return "\u{fa8b}"
        case .speakerTurnDownLight: return "\u{fa8c}"
        case .speakerTurnDownRegular: return "\u{fa8d}"
        case .speakerTurnUpBold: return "\u{fa8e}"
        case .speakerTurnUpFilled: return "\u{fa8f}"
        case .speakerTurnUpLight: return "\u{fa90}"
        case .speakerTurnUpRegular: return "\u{fa91}"
        case .speedDialBold: return "\u{fa92}"
        case .speedDialFilled: return "\u{fa93}"
        case .speedDialLight: return "\u{fa94}"
        case .speedDialRegular: return "\u{fa95}"
        case .spellCheckerBold: return "\u{fa96}"
        case .spellCheckerLight: return "\u{fa97}"
        case .spellCheckerRegular: return "\u{fa98}"
        case .spinnerBold: return "\u{fa99}"
        case .spinnerInProgressBold: return "\u{fa9a}"
        case .spinnerInProgressLight: return "\u{fa9b}"
        case .spinnerInProgressRegular: return "\u{fa9c}"
        case .spinnerLight: return "\u{fa9d}"
        case .spinnerRegular: return "\u{fa9e}"
        case .splitViewBold: return "\u{fa9f}"
        case .splitViewLight: return "\u{faa0}"
        case .splitViewRegular: return "\u{faa1}"
        case .stackedAreaChartBold: return "\u{faa2}"
        case .stackedAreaChartFilled: return "\u{faa3}"
        case .stackedAreaChartFullBold: return "\u{faa4}"
        case .stackedAreaChartFullFilled: return "\u{faa5}"
        case .stackedAreaChartFullLight: return "\u{faa6}"
        case .stackedAreaChartFullRegular: return "\u{faa7}"
        case .stackedAreaChartLight: return "\u{faa8}"
        case .stackedAreaChartRegular: return "\u{faa9}"
        case .stackedBarChartBold: return "\u{faaa}"
        case .stackedBarChartFilled: return "\u{faab}"
        case .stackedBarChartFullBold: return "\u{faac}"
        case .stackedBarChartFullFilled: return "\u{faad}"
        case .stackedBarChartFullLight: return "\u{faae}"
        case .stackedBarChartFullRegular: return "\u{faaf}"
        case .stackedBarChartLight: return "\u{fab0}"
        case .stackedBarChartRegular: return "\u{fab1}"
        case .startChatBold: return "\u{fab2}"
        case .startChatLight: return "\u{fab3}"
        case .startChatRegular: return "\u{fab4}"
        case .stethoscopeBold: return "\u{fab5}"
        case .stethoscopeLight: return "\u{fab6}"
        case .stethoscopeRegular: return "\u{fab7}"
        case .stickersBold: return "\u{fab8}"
        case .stickersLight: return "\u{fab9}"
        case .stickersRegular: return "\u{faba}"
        case .stickiesBold: return "\u{fabb}"
        case .stickiesLight: return "\u{fabc}"
        case .stickiesRegular: return "\u{fabd}"
        case .stopBold: return "\u{fabe}"
        case .stopCircleBold: return "\u{fabf}"
        case .stopCircleFilled: return "\u{fac0}"
        case .stopCircleLight: return "\u{fac1}"
        case .stopCircleRegular: return "\u{fac2}"
        case .stopContentShareBold: return "\u{fac3}"
        case .stopContentShareLight: return "\u{fac4}"
        case .stopContentShareRegular: return "\u{fac5}"
        case .stopFilled: return "\u{fac6}"
        case .stopLight: return "\u{fac7}"
        case .stopRegular: return "\u{fac8}"
        case .storedInfoBold: return "\u{fac9}"
        case .storedInfoFilled: return "\u{faca}"
        case .storedInfoLight: return "\u{facb}"
        case .storedInfoRegular: return "\u{facc}"
        case .streamingBold: return "\u{facd}"
        case .streamingLight: return "\u{face}"
        case .streamingRegular: return "\u{facf}"
        case .strikethroughBold: return "\u{fad0}"
        case .strikethroughFilled: return "\u{fad1}"
        case .strikethroughLight: return "\u{fad2}"
        case .strikethroughRegular: return "\u{fad3}"
        case .studioModeBold: return "\u{fad4}"
        case .studioModeLight: return "\u{fad5}"
        case .studioModeRegular: return "\u{fad6}"
        case .subscriptBold: return "\u{fad7}"
        case .subscriptLight: return "\u{fad8}"
        case .subscriptRegular: return "\u{fad9}"
        case .superscriptBold: return "\u{fada}"
        case .superscriptLight: return "\u{fadb}"
        case .superscriptRegular: return "\u{fadc}"
        case .surveyBold: return "\u{fadd}"
        case .surveyFilled: return "\u{fade}"
        case .surveyLight: return "\u{fadf}"
        case .surveyRegular: return "\u{fae0}"
        case .sxEightyCodecBold: return "\u{fae1}"
        case .sxEightyCodecLight: return "\u{fae2}"
        case .sxEightyCodecRegular: return "\u{fae3}"
        case .sxTenBold: return "\u{fae4}"
        case .sxTenLight: return "\u{fae5}"
        case .sxTenRegular: return "\u{fae6}"
        case .sxTwentyBold: return "\u{fae7}"
        case .sxTwentyLight: return "\u{fae8}"
        case .sxTwentyRegular: return "\u{fae9}"
        case .tableBold: return "\u{faea}"
        case .tableLight: return "\u{faeb}"
        case .tableRegular: return "\u{faec}"
        case .tabletBold: return "\u{faed}"
        case .tabletLight: return "\u{faee}"
        case .tabletRegular: return "\u{faef}"
        case .tabsBold: return "\u{faf0}"
        case .tabsLight: return "\u{faf1}"
        case .tabsRegular: return "\u{faf2}"
        case .tagBold: return "\u{faf3}"
        case .tagLight: return "\u{faf4}"
        case .tagRegular: return "\u{faf5}"
        case .tapBold: return "\u{faf6}"
        case .tapFilled: return "\u{faf7}"
        case .tapLight: return "\u{faf8}"
        case .tapRegular: return "\u{faf9}"
        case .telepresenceAlertBold: return "\u{fafa}"
        case .telepresenceAlertLight: return "\u{fafb}"
        case .telepresenceAlertMutedBold: return "\u{fafc}"
        case .telepresenceAlertMutedLight: return "\u{fafd}"
        case .telepresenceAlertMutedRegular: return "\u{fafe}"
        case .telepresenceAlertRegular: return "\u{faff}"
        case .telepresenceBold: return "\u{fb00}"
        case .telepresenceIxFiveThousandBold: return "\u{fb01}"
        case .telepresenceIxFiveThousandLight: return "\u{fb02}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb03}"
        case .telepresenceLight: return "\u{fb04}"
        case .telepresenceMutedBold: return "\u{fb05}"
        case .telepresenceMutedLight: return "\u{fb06}"
        case .telepresenceMutedRegular: return "\u{fb07}"
        case .telepresencePrivateBold: return "\u{fb08}"
        case .telepresencePrivateLight: return "\u{fb09}"
        case .telepresencePrivateRegular: return "\u{fb0a}"
        case .telepresenceRegular: return "\u{fb0b}"
        case .temperatureBold: return "\u{fb0c}"
        case .temperatureLight: return "\u{fb0d}"
        case .temperatureRegular: return "\u{fb0e}"
        case .testTubeBold: return "\u{fb0f}"
        case .testTubeFilled: return "\u{fb10}"
        case .testTubeLight: return "\u{fb11}"
        case .testTubeRegular: return "\u{fb12}"
        case .textAlignCenterBold: return "\u{fb13}"
        case .textAlignCenterFilled: return "\u{fb14}"
        case .textAlignCenterLight: return "\u{fb15}"
        case .textAlignCenterRegular: return "\u{fb16}"
        case .textAlignLeftBold: return "\u{fb17}"
        case .textAlignLeftFilled: return "\u{fb18}"
        case .textAlignLeftLight: return "\u{fb19}"
        case .textAlignLeftRegular: return "\u{fb1a}"
        case .textAlignRightBold: return "\u{fb1b}"
        case .textAlignRightFilled: return "\u{fb1c}"
        case .textAlignRightLight: return "\u{fb1d}"
        case .textAlignRightRegular: return "\u{fb1e}"
        case .textBold: return "\u{fb1f}"
        case .textBoxCursorLight: return "\u{fb20}"
        case .textCodeBlockBold: return "\u{fb21}"
        case .textCodeBlockLight: return "\u{fb22}"
        case .textCodeBlockRegular: return "\u{fb23}"
        case .textHighlightBold: return "\u{fb24}"
        case .textHighlightFilled: return "\u{fb25}"
        case .textHighlightLight: return "\u{fb26}"
        case .textHighlightRegular: return "\u{fb27}"
        case .textLight: return "\u{fb28}"
        case .textRegular: return "\u{fb29}"
        case .threeColumnBold: return "\u{fb2a}"
        case .threeColumnLight: return "\u{fb2b}"
        case .threeColumnRegular: return "\u{fb2c}"
        case .threeDObjectBold: return "\u{fb2d}"
        case .threeDObjectLight: return "\u{fb2e}"
        case .threeDObjectRegular: return "\u{fb2f}"
        case .timeExclusionBold: return "\u{fb30}"
        case .timeExclusionLight: return "\u{fb31}"
        case .timeExclusionRegular: return "\u{fb32}"
        case .tooFastBold: return "\u{fb33}"
        case .tooFastLight: return "\u{fb34}"
        case .tooFastRegular: return "\u{fb35}"
        case .tooSlowBold: return "\u{fb36}"
        case .tooSlowLight: return "\u{fb37}"
        case .tooSlowRegular: return "\u{fb38}"
        case .toolsBold: return "\u{fb39}"
        case .toolsFilled: return "\u{fb3a}"
        case .toolsLight: return "\u{fb3b}"
        case .toolsRegular: return "\u{fb3c}"
        case .touchTenBold: return "\u{fb3d}"
        case .touchTenLight: return "\u{fb3e}"
        case .touchTenRegular: return "\u{fb3f}"
        case .transcriptBold: return "\u{fb40}"
        case .transcriptFilled: return "\u{fb41}"
        case .transcriptLight: return "\u{fb42}"
        case .transcriptRegular: return "\u{fb43}"
        case .translateBold: return "\u{fb44}"
        case .translateLight: return "\u{fb45}"
        case .translateRegular: return "\u{fb46}"
        case .translateUndoBold: return "\u{fb47}"
        case .translateUndoLight: return "\u{fb48}"
        case .translateUndoRegular: return "\u{fb49}"
        case .trendingBold: return "\u{fb4a}"
        case .trendingDownBold: return "\u{fb4b}"
        case .trendingDownFilled: return "\u{fb4c}"
        case .trendingDownLight: return "\u{fb4d}"
        case .trendingDownRegular: return "\u{fb4e}"
        case .trendingFilled: return "\u{fb4f}"
        case .trendingLight: return "\u{fb50}"
        case .trendingRegular: return "\u{fb51}"
        case .trimBold: return "\u{fb52}"
        case .trimLight: return "\u{fb53}"
        case .trimRegular: return "\u{fb54}"
        case .twoColumnBold: return "\u{fb55}"
        case .twoColumnLight: return "\u{fb56}"
        case .twoColumnRegular: return "\u{fb57}"
        case .twoWayVoiceStreamBold: return "\u{fb58}"
        case .twoWayVoiceStreamFilled: return "\u{fb59}"
        case .twoWayVoiceStreamLight: return "\u{fb5a}"
        case .twoWayVoiceStreamRegular: return "\u{fb5b}"
        case .ucmCloudBold: return "\u{fb5c}"
        case .ucmCloudLight: return "\u{fb5d}"
        case .ucmCloudRegular: return "\u{fb5e}"
        case .unblockBold: return "\u{fb5f}"
        case .unblockFilled: return "\u{fb60}"
        case .unblockLight: return "\u{fb61}"
        case .unblockRegular: return "\u{fb62}"
        case .underlineBold: return "\u{fb63}"
        case .underlineFilled: return "\u{fb64}"
        case .underlineLight: return "\u{fb65}"
        case .underlineRegular: return "\u{fb66}"
        case .undoBold: return "\u{fb67}"
        case .undoLight: return "\u{fb68}"
        case .undoRegular: return "\u{fb69}"
        case .unlinkBold: return "\u{fb6a}"
        case .unlinkLight: return "\u{fb6b}"
        case .unlinkRegular: return "\u{fb6c}"
        case .unreadBold: return "\u{fb6d}"
        case .unreadFilled: return "\u{fb6e}"
        case .unreadLight: return "\u{fb6f}"
        case .unreadRegular: return "\u{fb70}"
        case .unsecureUnlockedBold: return "\u{fb71}"
        case .unsecureUnlockedFilled: return "\u{fb72}"
        case .unsecureUnlockedLight: return "\u{fb73}"
        case .unsecureUnlockedRegular: return "\u{fb74}"
        case .unsortedBold: return "\u{fb75}"
        case .unsortedLight: return "\u{fb76}"
        case .unsortedRegular: return "\u{fb77}"
        case .updateFileShareBold: return "\u{fb78}"
        case .updateFileShareLight: return "\u{fb79}"
        case .updateFileShareRegular: return "\u{fb7a}"
        case .uploadBold: return "\u{fb7b}"
        case .uploadImageBold: return "\u{fb7c}"
        case .uploadImageLight: return "\u{fb7d}"
        case .uploadImageRegular: return "\u{fb7e}"
        case .uploadLight: return "\u{fb7f}"
        case .uploadRegular: return "\u{fb80}"
        case .urgentVoicemailBold: return "\u{fb81}"
        case .urgentVoicemailFilled: return "\u{fb82}"
        case .usbBold: return "\u{fb83}"
        case .usbHeadsetBold: return "\u{fb84}"
        case .usbHeadsetLight: return "\u{fb85}"
        case .usbHeadsetMutedBold: return "\u{fb86}"
        case .usbHeadsetMutedLight: return "\u{fb87}"
        case .usbHeadsetMutedRegular: return "\u{fb88}"
        case .usbHeadsetRegular: return "\u{fb89}"
        case .usbLight: return "\u{fb8a}"
        case .usbRegular: return "\u{fb8b}"
        case .userBold: return "\u{fb8c}"
        case .userDeactivateBold: return "\u{fb8d}"
        case .userDeactivateLight: return "\u{fb8e}"
        case .userDeactivateRegular: return "\u{fb8f}"
        case .userLight: return "\u{fb90}"
        case .userRegular: return "\u{fb91}"
        case .videoBlurBold: return "\u{fb92}"
        case .videoBlurFilled: return "\u{fb93}"
        case .videoBlurLight: return "\u{fb94}"
        case .videoBlurRegular: return "\u{fb95}"
        case .videoBold: return "\u{fb96}"
        case .videoEffectBold: return "\u{fb97}"
        case .videoEffectFilled: return "\u{fb98}"
        case .videoEffectLight: return "\u{fb99}"
        case .videoEffectRegular: return "\u{fb9a}"
        case .videoFilled: return "\u{fb9b}"
        case .videoLayoutBold: return "\u{fb9c}"
        case .videoLayoutEqualBold: return "\u{fb9d}"
        case .videoLayoutEqualDualBold: return "\u{fb9e}"
        case .videoLayoutEqualDualLight: return "\u{fb9f}"
        case .videoLayoutEqualDualRegular: return "\u{fba0}"
        case .videoLayoutEqualFilled: return "\u{fba1}"
        case .videoLayoutEqualLight: return "\u{fba2}"
        case .videoLayoutEqualRegular: return "\u{fba3}"
        case .videoLayoutFilled: return "\u{fba4}"
        case .videoLayoutLight: return "\u{fba5}"
        case .videoLayoutOverlayBold: return "\u{fba6}"
        case .videoLayoutOverlayFilled: return "\u{fba7}"
        case .videoLayoutOverlayLight: return "\u{fba8}"
        case .videoLayoutOverlayRegular: return "\u{fba9}"
        case .videoLayoutPresenterDominantBold: return "\u{fbaa}"
        case .videoLayoutPresenterDominantLight: return "\u{fbab}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbac}"
        case .videoLayoutProminentBold: return "\u{fbad}"
        case .videoLayoutProminentFilled: return "\u{fbae}"
        case .videoLayoutProminentLight: return "\u{fbaf}"
        case .videoLayoutProminentRegular: return "\u{fbb0}"
        case .videoLayoutRegular: return "\u{fbb1}"
        case .videoLayoutShareDominantBold: return "\u{fbb2}"
        case .videoLayoutShareDominantLight: return "\u{fbb3}"
        case .videoLayoutShareDominantRegular: return "\u{fbb4}"
        case .videoLayoutSingleBold: return "\u{fbb5}"
        case .videoLayoutSingleFilled: return "\u{fbb6}"
        case .videoLayoutSingleLight: return "\u{fbb7}"
        case .videoLayoutSingleRegular: return "\u{fbb8}"
        case .videoLayoutStackBold: return "\u{fbb9}"
        case .videoLayoutStackFilled: return "\u{fbba}"
        case .videoLayoutStackLight: return "\u{fbbb}"
        case .videoLayoutStackRegular: return "\u{fbbc}"
        case .videoLayoutVideoDominantBold: return "\u{fbbd}"
        case .videoLayoutVideoDominantFilled: return "\u{fbbe}"
        case .videoLayoutVideoDominantLight: return "\u{fbbf}"
        case .videoLayoutVideoDominantRegular: return "\u{fbc0}"
        case .videoLight: return "\u{fbc1}"
        case .videoPlusBold: return "\u{fbc2}"
        case .videoPlusFilled: return "\u{fbc3}"
        case .videoPlusLight: return "\u{fbc4}"
        case .videoPlusRegular: return "\u{fbc5}"
        case .videoRegular: return "\u{fbc6}"
        case .videoSpeakerTrackBold: return "\u{fbc7}"
        case .videoSpeakerTrackFilled: return "\u{fbc8}"
        case .videoSpeakerTrackLight: return "\u{fbc9}"
        case .videoSpeakerTrackRegular: return "\u{fbca}"
        case .viewAllBold: return "\u{fbcb}"
        case .viewAllLight: return "\u{fbcc}"
        case .viewAllRegular: return "\u{fbcd}"
        case .viewListBold: return "\u{fbce}"
        case .viewListFilled: return "\u{fbcf}"
        case .viewListLight: return "\u{fbd0}"
        case .viewListRegular: return "\u{fbd1}"
        case .viewStackedBold: return "\u{fbd2}"
        case .viewStackedFilled: return "\u{fbd3}"
        case .viewStackedLight: return "\u{fbd4}"
        case .viewStackedRegular: return "\u{fbd5}"
        case .viewThumbnailBold: return "\u{fbd6}"
        case .viewThumbnailFilled: return "\u{fbd7}"
        case .viewThumbnailLight: return "\u{fbd8}"
        case .viewThumbnailRegular: return "\u{fbd9}"
        case .visionproBold: return "\u{fbda}"
        case .visionproFilled: return "\u{fbdb}"
        case .visionproLight: return "\u{fbdc}"
        case .visionproMoveCallInBold: return "\u{fbdd}"
        case .visionproMoveCallInFilled: return "\u{fbde}"
        case .visionproMoveCallInLight: return "\u{fbdf}"
        case .visionproMoveCallInOutBold: return "\u{fbe0}"
        case .visionproMoveCallInOutFilled: return "\u{fbe1}"
        case .visionproMoveCallInOutLight: return "\u{fbe2}"
        case .visionproMoveCallInOutRegular: return "\u{fbe3}"
        case .visionproMoveCallInRegular: return "\u{fbe4}"
        case .visionproMoveCallOutBold: return "\u{fbe5}"
        case .visionproMoveCallOutFilled: return "\u{fbe6}"
        case .visionproMoveCallOutLight: return "\u{fbe7}"
        case .visionproMoveCallOutRegular: return "\u{fbe8}"
        case .visionproRegular: return "\u{fbe9}"
        case .voicemailBold: return "\u{fbea}"
        case .voicemailFilled: return "\u{fbeb}"
        case .voicemailLight: return "\u{fbec}"
        case .voicemailRegular: return "\u{fbed}"
        case .vpnBold: return "\u{fbee}"
        case .vpnFilled: return "\u{fbef}"
        case .vpnLight: return "\u{fbf0}"
        case .vpnRegular: return "\u{fbf1}"
        case .vscBold: return "\u{fbf2}"
        case .vscLight: return "\u{fbf3}"
        case .vscRegular: return "\u{fbf4}"
        case .waffleMenuBold: return "\u{fbf5}"
        case .waffleMenuLight: return "\u{fbf6}"
        case .waffleMenuRegular: return "\u{fbf7}"
        case .waitingRoomBold: return "\u{fbf8}"
        case .waitingRoomLight: return "\u{fbf9}"
        case .waitingRoomRegular: return "\u{fbfa}"
        case .wallpaperBold: return "\u{fbfb}"
        case .wallpaperLight: return "\u{fbfc}"
        case .wallpaperRegular: return "\u{fbfd}"
        case .warningBadgeFilled: return "\u{fbfe}"
        case .warningBold: return "\u{fbff}"
        case .warningFilled: return "\u{fc00}"
        case .warningLight: return "\u{fc01}"
        case .warningRegular: return "\u{fc02}"
        case .webexBoardBold: return "\u{fc03}"
        case .webexBoardLight: return "\u{fc04}"
        case .webexBoardRegular: return "\u{fc05}"
        case .webexCodecPlusBold: return "\u{fc06}"
        case .webexCodecPlusLight: return "\u{fc07}"
        case .webexCodecPlusRegular: return "\u{fc08}"
        case .webexDeskCameraBold: return "\u{fc09}"
        case .webexDeskCameraLight: return "\u{fc0a}"
        case .webexDeskCameraRegular: return "\u{fc0b}"
        case .webexHelixBold: return "\u{fc0c}"
        case .webexHelixLight: return "\u{fc0d}"
        case .webexHelixRegular: return "\u{fc0e}"
        case .webexMeetingsBold: return "\u{fc0f}"
        case .webexMeetingsFilled: return "\u{fc10}"
        case .webexMeetingsLight: return "\u{fc11}"
        case .webexMeetingsRegular: return "\u{fc12}"
        case .webexQuadCameraBold: return "\u{fc13}"
        case .webexQuadCameraLight: return "\u{fc14}"
        case .webexQuadCameraRegular: return "\u{fc15}"
        case .webexRoomKitBold: return "\u{fc16}"
        case .webexRoomKitLight: return "\u{fc17}"
        case .webexRoomKitPlusBold: return "\u{fc18}"
        case .webexRoomKitPlusLight: return "\u{fc19}"
        case .webexRoomKitPlusRegular: return "\u{fc1a}"
        case .webexRoomKitRegular: return "\u{fc1b}"
        case .webexShareBold: return "\u{fc1c}"
        case .webexShareLight: return "\u{fc1d}"
        case .webexShareRegular: return "\u{fc1e}"
        case .webexTeamsBold: return "\u{fc1f}"
        case .webexTeamsFilled: return "\u{fc20}"
        case .webexTeamsLight: return "\u{fc21}"
        case .webexTeamsNewBold: return "\u{fc22}"
        case .webexTeamsNewFilled: return "\u{fc23}"
        case .webexTeamsNewLight: return "\u{fc24}"
        case .webexTeamsNewRegular: return "\u{fc25}"
        case .webexTeamsRegular: return "\u{fc26}"
        case .webexTeamsRemoveBold: return "\u{fc27}"
        case .webexTeamsRemoveLight: return "\u{fc28}"
        case .webexTeamsRemoveRegular: return "\u{fc29}"
        case .webinarBold: return "\u{fc2a}"
        case .webinarFilled: return "\u{fc2b}"
        case .webinarLight: return "\u{fc2c}"
        case .webinarRegular: return "\u{fc2d}"
        case .weeklyRecurringScheduleBold: return "\u{fc2e}"
        case .weeklyRecurringScheduleLight: return "\u{fc2f}"
        case .weeklyRecurringScheduleRegular: return "\u{fc30}"
        case .whisperAnnouncementBold: return "\u{fc31}"
        case .whisperAnnouncementFilled: return "\u{fc32}"
        case .whisperAnnouncementLight: return "\u{fc33}"
        case .whisperAnnouncementRegular: return "\u{fc34}"
        case .whisperCoachBold: return "\u{fc35}"
        case .whisperCoachFilled: return "\u{fc36}"
        case .whisperCoachLight: return "\u{fc37}"
        case .whisperCoachRegular: return "\u{fc38}"
        case .whiteboardBold: return "\u{fc39}"
        case .whiteboardContentBold: return "\u{fc3a}"
        case .whiteboardContentFilled: return "\u{fc3b}"
        case .whiteboardContentLight: return "\u{fc3c}"
        case .whiteboardContentRegular: return "\u{fc3d}"
        case .whiteboardFilled: return "\u{fc3e}"
        case .whiteboardLight: return "\u{fc3f}"
        case .whiteboardRegular: return "\u{fc40}"
        case .widgetBold: return "\u{fc41}"
        case .widgetFilled: return "\u{fc42}"
        case .widgetLight: return "\u{fc43}"
        case .widgetRegular: return "\u{fc44}"
        case .wifiBold: return "\u{fc45}"
        case .wifiErrorBold: return "\u{fc46}"
        case .wifiErrorLight: return "\u{fc47}"
        case .wifiErrorRegular: return "\u{fc48}"
        case .wifiLight: return "\u{fc49}"
        case .wifiRegular: return "\u{fc4a}"
        case .wifiSignalGoodBold: return "\u{fc4b}"
        case .wifiSignalGoodLight: return "\u{fc4c}"
        case .wifiSignalGoodRegular: return "\u{fc4d}"
        case .wifiSignalPoorBold: return "\u{fc4e}"
        case .wifiSignalPoorLight: return "\u{fc4f}"
        case .wifiSignalPoorRegular: return "\u{fc50}"
        case .wifiSignalUnstableBold: return "\u{fc51}"
        case .wifiSignalUnstableLight: return "\u{fc52}"
        case .wifiSignalUnstableRegular: return "\u{fc53}"
        case .windowCornerScrubBold: return "\u{fc54}"
        case .windowCornerScrubLight: return "\u{fc55}"
        case .windowCornerScrubRegular: return "\u{fc56}"
        case .windowRightCornerScrubBold: return "\u{fc57}"
        case .windowRightCornerScrubLight: return "\u{fc58}"
        case .windowRightCornerScrubRegular: return "\u{fc59}"
        case .windowVerticalScrubBold: return "\u{fc5a}"
        case .windowVerticalScrubLight: return "\u{fc5b}"
        case .windowVerticalScrubRegular: return "\u{fc5c}"
        case .workflowDeploymentsBold: return "\u{fc5d}"
        case .workflowDeploymentsFilled: return "\u{fc5e}"
        case .workflowDeploymentsLight: return "\u{fc5f}"
        case .workflowDeploymentsRegular: return "\u{fc60}"
        case .workphoneBold: return "\u{fc61}"
        case .workphoneLight: return "\u{fc62}"
        case .workphoneRegular: return "\u{fc63}"
        case .zoomInBold: return "\u{fc64}"
        case .zoomInLight: return "\u{fc65}"
        case .zoomInRegular: return "\u{fc66}"
        case .zoomOutBold: return "\u{fc67}"
        case .zoomOutLight: return "\u{fc68}"
        case .zoomOutRegular: return "\u{fc69}"
