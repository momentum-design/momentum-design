...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .selectionFilled: return "\u{f9b7}"
        case .selectionLight: return "\u{f9b8}"
        case .selectionRegular: return "\u{f9b9}"
        case .sendBold: return "\u{f9ba}"
        case .sendFilled: return "\u{f9bb}"
        case .sendLight: return "\u{f9bc}"
        case .sendRegular: return "\u{f9bd}"
        case .sendVoiceBold: return "\u{f9be}"
        case .sendVoiceFilled: return "\u{f9bf}"
        case .sendVoiceLight: return "\u{f9c0}"
        case .sendVoiceRegular: return "\u{f9c1}"
        case .serverBold: return "\u{f9c2}"
        case .serverErrorBold: return "\u{f9c3}"
        case .serverErrorLight: return "\u{f9c4}"
        case .serverErrorRegular: return "\u{f9c5}"
        case .serverLight: return "\u{f9c6}"
        case .serverRegular: return "\u{f9c7}"
        case .servicesBold: return "\u{f9c8}"
        case .servicesLight: return "\u{f9c9}"
        case .servicesRegular: return "\u{f9ca}"
        case .setVariableBold: return "\u{f9cb}"
        case .setVariableLight: return "\u{f9cc}"
        case .setVariableRegular: return "\u{f9cd}"
        case .settingsBold: return "\u{f9ce}"
        case .settingsFilled: return "\u{f9cf}"
        case .settingsLight: return "\u{f9d0}"
        case .settingsRegular: return "\u{f9d1}"
        case .setupAssistantBold: return "\u{f9d2}"
        case .setupAssistantLight: return "\u{f9d3}"
        case .setupAssistantRegular: return "\u{f9d4}"
        case .sftpBold: return "\u{f9d5}"
        case .sftpLight: return "\u{f9d6}"
        case .sftpRegular: return "\u{f9d7}"
        case .shapeCircleBold: return "\u{f9d8}"
        case .shapeCircleFilled: return "\u{f9d9}"
        case .shapeCircleLight: return "\u{f9da}"
        case .shapeCircleMdFilled: return "\u{f9db}"
        case .shapeCircleRegular: return "\u{f9dc}"
        case .shapeCircleSmFilled: return "\u{f9dd}"
        case .shapeDiagonalLineBold: return "\u{f9de}"
        case .shapeDiagonalLineLight: return "\u{f9df}"
        case .shapeDiagonalLineRegular: return "\u{f9e0}"
        case .shapeDiamondBold: return "\u{f9e1}"
        case .shapeDiamondFilled: return "\u{f9e2}"
        case .shapeDiamondLight: return "\u{f9e3}"
        case .shapeDiamondRegular: return "\u{f9e4}"
        case .shapeOvalBold: return "\u{f9e5}"
        case .shapeOvalLight: return "\u{f9e6}"
        case .shapeOvalRegular: return "\u{f9e7}"
        case .shapeSquareBold: return "\u{f9e8}"
        case .shapeSquareFilled: return "\u{f9e9}"
        case .shapeSquareLight: return "\u{f9ea}"
        case .shapeSquareRegular: return "\u{f9eb}"
        case .shapeTriangleBold: return "\u{f9ec}"
        case .shapeTriangleFilled: return "\u{f9ed}"
        case .shapeTriangleLight: return "\u{f9ee}"
        case .shapeTriangleRegular: return "\u{f9ef}"
        case .shapesBold: return "\u{f9f0}"
        case .shapesFilled: return "\u{f9f1}"
        case .shapesLight: return "\u{f9f2}"
        case .shapesRegular: return "\u{f9f3}"
        case .shareCNativeAdrBold: return "\u{f9f4}"
        case .shareCNativeAdrFilled: return "\u{f9f5}"
        case .shareCNativeAdrLight: return "\u{f9f6}"
        case .shareCNativeAdrRegular: return "\u{f9f7}"
        case .shareCNativeIphBold: return "\u{f9f8}"
        case .shareCNativeIphLight: return "\u{f9f9}"
        case .shareCNativeIphRegular: return "\u{f9fa}"
        case .shareContentOnDeviceBold: return "\u{f9fb}"
        case .shareContentOnDeviceLight: return "\u{f9fc}"
        case .shareContentOnDeviceRegular: return "\u{f9fd}"
        case .shareScreenAddBold: return "\u{f9fe}"
        case .shareScreenAddLight: return "\u{f9ff}"
        case .shareScreenAddRegular: return "\u{fa00}"
        case .shareScreenBadgeFilled: return "\u{fa01}"
        case .shareScreenBold: return "\u{fa02}"
        case .shareScreenFilled: return "\u{fa03}"
        case .shareScreenLight: return "\u{fa04}"
        case .shareScreenRegular: return "\u{fa05}"
        case .shareSpaceBold: return "\u{fa06}"
        case .shareSpaceLight: return "\u{fa07}"
        case .shareSpaceRegular: return "\u{fa08}"
        case .shieldBold: return "\u{fa09}"
        case .shieldLight: return "\u{fa0a}"
        case .shieldRegular: return "\u{fa0b}"
        case .shoppingCartBold: return "\u{fa0c}"
        case .shoppingCartFilled: return "\u{fa0d}"
        case .shoppingCartLight: return "\u{fa0e}"
        case .shoppingCartRegular: return "\u{fa0f}"
        case .shortTextBoxBold: return "\u{fa10}"
        case .shortTextBoxLight: return "\u{fa11}"
        case .shortTextBoxRegular: return "\u{fa12}"
        case .showBold: return "\u{fa13}"
        case .showFilled: return "\u{fa14}"
        case .showLight: return "\u{fa15}"
        case .showRegular: return "\u{fa16}"
        case .signInBold: return "\u{fa17}"
        case .signInFilled: return "\u{fa18}"
        case .signInForcedBold: return "\u{fa19}"
        case .signInForcedLight: return "\u{fa1a}"
        case .signInForcedRegular: return "\u{fa1b}"
        case .signInLight: return "\u{fa1c}"
        case .signInRegular: return "\u{fa1d}"
        case .signLangIntBold: return "\u{fa1e}"
        case .signLangIntLight: return "\u{fa1f}"
        case .signLangIntRegular: return "\u{fa20}"
        case .signOutBold: return "\u{fa21}"
        case .signOutLight: return "\u{fa22}"
        case .signOutRegular: return "\u{fa23}"
        case .signalFourBold: return "\u{fa24}"
        case .signalFourLight: return "\u{fa25}"
        case .signalFourRegular: return "\u{fa26}"
        case .signalOneBold: return "\u{fa27}"
        case .signalOneLight: return "\u{fa28}"
        case .signalOneRegular: return "\u{fa29}"
        case .signalThreeBold: return "\u{fa2a}"
        case .signalThreeLight: return "\u{fa2b}"
        case .signalThreeRegular: return "\u{fa2c}"
        case .signalTwoBold: return "\u{fa2d}"
        case .signalTwoLight: return "\u{fa2e}"
        case .signalTwoRegular: return "\u{fa2f}"
        case .signalZeroBold: return "\u{fa30}"
        case .signalZeroLight: return "\u{fa31}"
        case .signalZeroRegular: return "\u{fa32}"
        case .simplePromotionBold: return "\u{fa33}"
        case .simplePromotionLight: return "\u{fa34}"
        case .simplePromotionRegular: return "\u{fa35}"
        case .singleNumberReachBold: return "\u{fa36}"
        case .singleNumberReachLight: return "\u{fa37}"
        case .singleNumberReachRegular: return "\u{fa38}"
        case .sipRegistrationInProgressBold: return "\u{fa39}"
        case .sipRegistrationInProgressFilled: return "\u{fa3a}"
        case .sipRegistrationInProgressLight: return "\u{fa3b}"
        case .sipRegistrationInProgressRegular: return "\u{fa3c}"
        case .skipBold: return "\u{fa3d}"
        case .skipBwBold: return "\u{fa3e}"
        case .skipBwFilled: return "\u{fa3f}"
        case .skipBwLight: return "\u{fa40}"
        case .skipBwRegular: return "\u{fa41}"
        case .skipFwBold: return "\u{fa42}"
        case .skipFwFilled: return "\u{fa43}"
        case .skipFwLight: return "\u{fa44}"
        case .skipFwRegular: return "\u{fa45}"
        case .skipLight: return "\u{fa46}"
        case .skipRegular: return "\u{fa47}"
        case .smartAudioBold: return "\u{fa48}"
        case .smartAudioLight: return "\u{fa49}"
        case .smartAudioRegular: return "\u{fa4a}"
        case .smsFilled: return "\u{fa4b}"
        case .smsInboundBold: return "\u{fa4c}"
        case .smsInboundLight: return "\u{fa4d}"
        case .smsInboundRegular: return "\u{fa4e}"
        case .smsMessageBold: return "\u{fa4f}"
        case .smsMessageFilled: return "\u{fa50}"
        case .smsMessageLight: return "\u{fa51}"
        case .smsMessageRegular: return "\u{fa52}"
        case .smsOutgoingFilled: return "\u{fa53}"
        case .smsUnreadBold: return "\u{fa54}"
        case .smsUnreadLight: return "\u{fa55}"
        case .smsUnreadRegular: return "\u{fa56}"
        case .sortAscendingBold: return "\u{fa57}"
        case .sortAscendingLight: return "\u{fa58}"
        case .sortAscendingRegular: return "\u{fa59}"
        case .sortDescendingBold: return "\u{fa5a}"
        case .sortDescendingLight: return "\u{fa5b}"
        case .sortDescendingRegular: return "\u{fa5c}"
        case .soundDefaultBold: return "\u{fa5d}"
        case .soundDefaultLight: return "\u{fa5e}"
        case .soundDefaultRegular: return "\u{fa5f}"
        case .sparkleBold: return "\u{fa60}"
        case .sparkleFilled: return "\u{fa61}"
        case .sparkleLight: return "\u{fa62}"
        case .sparkleRegular: return "\u{fa63}"
        case .speakerBold: return "\u{fa64}"
        case .speakerDisconnectedBold: return "\u{fa65}"
        case .speakerDisconnectedFilled: return "\u{fa66}"
        case .speakerDisconnectedLight: return "\u{fa67}"
        case .speakerDisconnectedRegular: return "\u{fa68}"
        case .speakerFilled: return "\u{fa69}"
        case .speakerLight: return "\u{fa6a}"
        case .speakerMutedBold: return "\u{fa6b}"
        case .speakerMutedFilled: return "\u{fa6c}"
        case .speakerMutedLight: return "\u{fa6d}"
        case .speakerMutedRegular: return "\u{fa6e}"
        case .speakerOffBold: return "\u{fa6f}"
        case .speakerOffFilled: return "\u{fa70}"
        case .speakerOffLight: return "\u{fa71}"
        case .speakerOffRegular: return "\u{fa72}"
        case .speakerOnBold: return "\u{fa73}"
        case .speakerOnLight: return "\u{fa74}"
        case .speakerOnRegular: return "\u{fa75}"
        case .speakerRegular: return "\u{fa76}"
        case .speakerTurnDownBold: return "\u{fa77}"
        case .speakerTurnDownFilled: return "\u{fa78}"
        case .speakerTurnDownLight: return "\u{fa79}"
        case .speakerTurnDownRegular: return "\u{fa7a}"
        case .speakerTurnUpBold: return "\u{fa7b}"
        case .speakerTurnUpFilled: return "\u{fa7c}"
        case .speakerTurnUpLight: return "\u{fa7d}"
        case .speakerTurnUpRegular: return "\u{fa7e}"
        case .speedDialBold: return "\u{fa7f}"
        case .speedDialFilled: return "\u{fa80}"
        case .speedDialLight: return "\u{fa81}"
        case .speedDialRegular: return "\u{fa82}"
        case .spellCheckerBold: return "\u{fa83}"
        case .spellCheckerLight: return "\u{fa84}"
        case .spellCheckerRegular: return "\u{fa85}"
        case .spinnerBold: return "\u{fa86}"
        case .spinnerInProgressBold: return "\u{fa87}"
        case .spinnerInProgressLight: return "\u{fa88}"
        case .spinnerInProgressRegular: return "\u{fa89}"
        case .spinnerLight: return "\u{fa8a}"
        case .spinnerRegular: return "\u{fa8b}"
        case .splitViewBold: return "\u{fa8c}"
        case .splitViewLight: return "\u{fa8d}"
        case .splitViewRegular: return "\u{fa8e}"
        case .stackedAreaChartBold: return "\u{fa8f}"
        case .stackedAreaChartFilled: return "\u{fa90}"
        case .stackedAreaChartFullBold: return "\u{fa91}"
        case .stackedAreaChartFullFilled: return "\u{fa92}"
        case .stackedAreaChartFullLight: return "\u{fa93}"
        case .stackedAreaChartFullRegular: return "\u{fa94}"
        case .stackedAreaChartLight: return "\u{fa95}"
        case .stackedAreaChartRegular: return "\u{fa96}"
        case .stackedBarChartBold: return "\u{fa97}"
        case .stackedBarChartFilled: return "\u{fa98}"
        case .stackedBarChartFullBold: return "\u{fa99}"
        case .stackedBarChartFullFilled: return "\u{fa9a}"
        case .stackedBarChartFullLight: return "\u{fa9b}"
        case .stackedBarChartFullRegular: return "\u{fa9c}"
        case .stackedBarChartLight: return "\u{fa9d}"
        case .stackedBarChartRegular: return "\u{fa9e}"
        case .startChatBold: return "\u{fa9f}"
        case .startChatLight: return "\u{faa0}"
        case .startChatRegular: return "\u{faa1}"
        case .stethoscopeBold: return "\u{faa2}"
        case .stethoscopeLight: return "\u{faa3}"
        case .stethoscopeRegular: return "\u{faa4}"
        case .stickersBold: return "\u{faa5}"
        case .stickersLight: return "\u{faa6}"
        case .stickersRegular: return "\u{faa7}"
        case .stickiesBold: return "\u{faa8}"
        case .stickiesLight: return "\u{faa9}"
        case .stickiesRegular: return "\u{faaa}"
        case .stopBold: return "\u{faab}"
        case .stopCircleBold: return "\u{faac}"
        case .stopCircleFilled: return "\u{faad}"
        case .stopCircleLight: return "\u{faae}"
        case .stopCircleRegular: return "\u{faaf}"
        case .stopContentShareBold: return "\u{fab0}"
        case .stopContentShareLight: return "\u{fab1}"
        case .stopContentShareRegular: return "\u{fab2}"
        case .stopFilled: return "\u{fab3}"
        case .stopLight: return "\u{fab4}"
        case .stopRegular: return "\u{fab5}"
        case .storedInfoBold: return "\u{fab6}"
        case .storedInfoFilled: return "\u{fab7}"
        case .storedInfoLight: return "\u{fab8}"
        case .storedInfoRegular: return "\u{fab9}"
        case .streamingBold: return "\u{faba}"
        case .streamingLight: return "\u{fabb}"
        case .streamingRegular: return "\u{fabc}"
        case .strikethroughBold: return "\u{fabd}"
        case .strikethroughFilled: return "\u{fabe}"
        case .strikethroughLight: return "\u{fabf}"
        case .strikethroughRegular: return "\u{fac0}"
        case .studioModeBold: return "\u{fac1}"
        case .studioModeLight: return "\u{fac2}"
        case .studioModeRegular: return "\u{fac3}"
        case .subscriptBold: return "\u{fac4}"
        case .subscriptLight: return "\u{fac5}"
        case .subscriptRegular: return "\u{fac6}"
        case .superscriptBold: return "\u{fac7}"
        case .superscriptLight: return "\u{fac8}"
        case .superscriptRegular: return "\u{fac9}"
        case .surveyBold: return "\u{faca}"
        case .surveyFilled: return "\u{facb}"
        case .surveyLight: return "\u{facc}"
        case .surveyRegular: return "\u{facd}"
        case .sxEightyCodecBold: return "\u{face}"
        case .sxEightyCodecLight: return "\u{facf}"
        case .sxEightyCodecRegular: return "\u{fad0}"
        case .sxTenBold: return "\u{fad1}"
        case .sxTenLight: return "\u{fad2}"
        case .sxTenRegular: return "\u{fad3}"
        case .sxTwentyBold: return "\u{fad4}"
        case .sxTwentyLight: return "\u{fad5}"
        case .sxTwentyRegular: return "\u{fad6}"
        case .tableBold: return "\u{fad7}"
        case .tableLight: return "\u{fad8}"
        case .tableRegular: return "\u{fad9}"
        case .tabletBold: return "\u{fada}"
        case .tabletLight: return "\u{fadb}"
        case .tabletRegular: return "\u{fadc}"
        case .tabsBold: return "\u{fadd}"
        case .tabsLight: return "\u{fade}"
        case .tabsRegular: return "\u{fadf}"
        case .tagBold: return "\u{fae0}"
        case .tagLight: return "\u{fae1}"
        case .tagRegular: return "\u{fae2}"
        case .tapBold: return "\u{fae3}"
        case .tapFilled: return "\u{fae4}"
        case .tapLight: return "\u{fae5}"
        case .tapRegular: return "\u{fae6}"
        case .telepresenceAlertBold: return "\u{fae7}"
        case .telepresenceAlertLight: return "\u{fae8}"
        case .telepresenceAlertMutedBold: return "\u{fae9}"
        case .telepresenceAlertMutedLight: return "\u{faea}"
        case .telepresenceAlertMutedRegular: return "\u{faeb}"
        case .telepresenceAlertRegular: return "\u{faec}"
        case .telepresenceBold: return "\u{faed}"
        case .telepresenceIxFiveThousandBold: return "\u{faee}"
        case .telepresenceIxFiveThousandLight: return "\u{faef}"
        case .telepresenceIxFiveThousandRegular: return "\u{faf0}"
        case .telepresenceLight: return "\u{faf1}"
        case .telepresenceMutedBold: return "\u{faf2}"
        case .telepresenceMutedLight: return "\u{faf3}"
        case .telepresenceMutedRegular: return "\u{faf4}"
        case .telepresencePrivateBold: return "\u{faf5}"
        case .telepresencePrivateLight: return "\u{faf6}"
        case .telepresencePrivateRegular: return "\u{faf7}"
        case .telepresenceRegular: return "\u{faf8}"
        case .temperatureBold: return "\u{faf9}"
        case .temperatureLight: return "\u{fafa}"
        case .temperatureRegular: return "\u{fafb}"
        case .testTubeBold: return "\u{fafc}"
        case .testTubeFilled: return "\u{fafd}"
        case .testTubeLight: return "\u{fafe}"
        case .testTubeRegular: return "\u{faff}"
        case .textAlignCenterBold: return "\u{fb00}"
        case .textAlignCenterFilled: return "\u{fb01}"
        case .textAlignCenterLight: return "\u{fb02}"
        case .textAlignCenterRegular: return "\u{fb03}"
        case .textAlignLeftBold: return "\u{fb04}"
        case .textAlignLeftFilled: return "\u{fb05}"
        case .textAlignLeftLight: return "\u{fb06}"
        case .textAlignLeftRegular: return "\u{fb07}"
        case .textAlignRightBold: return "\u{fb08}"
        case .textAlignRightFilled: return "\u{fb09}"
        case .textAlignRightLight: return "\u{fb0a}"
        case .textAlignRightRegular: return "\u{fb0b}"
        case .textBold: return "\u{fb0c}"
        case .textBoxCursorLight: return "\u{fb0d}"
        case .textCodeBlockBold: return "\u{fb0e}"
        case .textCodeBlockLight: return "\u{fb0f}"
        case .textCodeBlockRegular: return "\u{fb10}"
        case .textHighlightBold: return "\u{fb11}"
        case .textHighlightFilled: return "\u{fb12}"
        case .textHighlightLight: return "\u{fb13}"
        case .textHighlightRegular: return "\u{fb14}"
        case .textLight: return "\u{fb15}"
        case .textRegular: return "\u{fb16}"
        case .threeColumnBold: return "\u{fb17}"
        case .threeColumnLight: return "\u{fb18}"
        case .threeColumnRegular: return "\u{fb19}"
        case .threeDObjectBold: return "\u{fb1a}"
        case .threeDObjectLight: return "\u{fb1b}"
        case .threeDObjectRegular: return "\u{fb1c}"
        case .timeExclusionBold: return "\u{fb1d}"
        case .timeExclusionLight: return "\u{fb1e}"
        case .timeExclusionRegular: return "\u{fb1f}"
        case .tooFastBold: return "\u{fb20}"
        case .tooFastLight: return "\u{fb21}"
        case .tooFastRegular: return "\u{fb22}"
        case .tooSlowBold: return "\u{fb23}"
        case .tooSlowLight: return "\u{fb24}"
        case .tooSlowRegular: return "\u{fb25}"
        case .toolsBold: return "\u{fb26}"
        case .toolsFilled: return "\u{fb27}"
        case .toolsLight: return "\u{fb28}"
        case .toolsRegular: return "\u{fb29}"
        case .touchTenBold: return "\u{fb2a}"
        case .touchTenLight: return "\u{fb2b}"
        case .touchTenRegular: return "\u{fb2c}"
        case .transcriptBold: return "\u{fb2d}"
        case .transcriptFilled: return "\u{fb2e}"
        case .transcriptLight: return "\u{fb2f}"
        case .transcriptRegular: return "\u{fb30}"
        case .translateBold: return "\u{fb31}"
        case .translateLight: return "\u{fb32}"
        case .translateRegular: return "\u{fb33}"
        case .translateUndoBold: return "\u{fb34}"
        case .translateUndoLight: return "\u{fb35}"
        case .translateUndoRegular: return "\u{fb36}"
        case .trendingBold: return "\u{fb37}"
        case .trendingDownBold: return "\u{fb38}"
        case .trendingDownFilled: return "\u{fb39}"
        case .trendingDownLight: return "\u{fb3a}"
        case .trendingDownRegular: return "\u{fb3b}"
        case .trendingFilled: return "\u{fb3c}"
        case .trendingLight: return "\u{fb3d}"
        case .trendingRegular: return "\u{fb3e}"
        case .trimBold: return "\u{fb3f}"
        case .trimLight: return "\u{fb40}"
        case .trimRegular: return "\u{fb41}"
        case .twoColumnBold: return "\u{fb42}"
        case .twoColumnLight: return "\u{fb43}"
        case .twoColumnRegular: return "\u{fb44}"
        case .twoWayVoiceStreamBold: return "\u{fb45}"
        case .twoWayVoiceStreamFilled: return "\u{fb46}"
        case .twoWayVoiceStreamLight: return "\u{fb47}"
        case .twoWayVoiceStreamRegular: return "\u{fb48}"
        case .ucmCloudBold: return "\u{fb49}"
        case .ucmCloudLight: return "\u{fb4a}"
        case .ucmCloudRegular: return "\u{fb4b}"
        case .underlineBold: return "\u{fb4c}"
        case .underlineFilled: return "\u{fb4d}"
        case .underlineLight: return "\u{fb4e}"
        case .underlineRegular: return "\u{fb4f}"
        case .undoBold: return "\u{fb50}"
        case .undoLight: return "\u{fb51}"
        case .undoRegular: return "\u{fb52}"
        case .unlinkBold: return "\u{fb53}"
        case .unlinkLight: return "\u{fb54}"
        case .unlinkRegular: return "\u{fb55}"
        case .unreadBold: return "\u{fb56}"
        case .unreadFilled: return "\u{fb57}"
        case .unreadLight: return "\u{fb58}"
        case .unreadRegular: return "\u{fb59}"
        case .unsecureUnlockedBold: return "\u{fb5a}"
        case .unsecureUnlockedFilled: return "\u{fb5b}"
        case .unsecureUnlockedLight: return "\u{fb5c}"
        case .unsecureUnlockedRegular: return "\u{fb5d}"
        case .unsortedBold: return "\u{fb5e}"
        case .unsortedLight: return "\u{fb5f}"
        case .unsortedRegular: return "\u{fb60}"
        case .updateFileShareBold: return "\u{fb61}"
        case .updateFileShareLight: return "\u{fb62}"
        case .updateFileShareRegular: return "\u{fb63}"
        case .uploadBold: return "\u{fb64}"
        case .uploadImageBold: return "\u{fb65}"
        case .uploadImageLight: return "\u{fb66}"
        case .uploadImageRegular: return "\u{fb67}"
        case .uploadLight: return "\u{fb68}"
        case .uploadRegular: return "\u{fb69}"
        case .urgentVoicemailBold: return "\u{fb6a}"
        case .urgentVoicemailFilled: return "\u{fb6b}"
        case .usbBold: return "\u{fb6c}"
        case .usbHeadsetBold: return "\u{fb6d}"
        case .usbHeadsetLight: return "\u{fb6e}"
        case .usbHeadsetMutedBold: return "\u{fb6f}"
        case .usbHeadsetMutedLight: return "\u{fb70}"
        case .usbHeadsetMutedRegular: return "\u{fb71}"
        case .usbHeadsetRegular: return "\u{fb72}"
        case .usbLight: return "\u{fb73}"
        case .usbRegular: return "\u{fb74}"
        case .userBold: return "\u{fb75}"
        case .userDeactivateBold: return "\u{fb76}"
        case .userDeactivateLight: return "\u{fb77}"
        case .userDeactivateRegular: return "\u{fb78}"
        case .userLight: return "\u{fb79}"
        case .userRegular: return "\u{fb7a}"
        case .videoBlurBold: return "\u{fb7b}"
        case .videoBlurFilled: return "\u{fb7c}"
        case .videoBlurLight: return "\u{fb7d}"
        case .videoBlurRegular: return "\u{fb7e}"
        case .videoBold: return "\u{fb7f}"
        case .videoEffectBold: return "\u{fb80}"
        case .videoEffectFilled: return "\u{fb81}"
        case .videoEffectLight: return "\u{fb82}"
        case .videoEffectRegular: return "\u{fb83}"
        case .videoFilled: return "\u{fb84}"
        case .videoLayoutBold: return "\u{fb85}"
        case .videoLayoutEqualBold: return "\u{fb86}"
        case .videoLayoutEqualDualBold: return "\u{fb87}"
        case .videoLayoutEqualDualLight: return "\u{fb88}"
        case .videoLayoutEqualDualRegular: return "\u{fb89}"
        case .videoLayoutEqualFilled: return "\u{fb8a}"
        case .videoLayoutEqualLight: return "\u{fb8b}"
        case .videoLayoutEqualRegular: return "\u{fb8c}"
        case .videoLayoutFilled: return "\u{fb8d}"
        case .videoLayoutLight: return "\u{fb8e}"
        case .videoLayoutOverlayBold: return "\u{fb8f}"
        case .videoLayoutOverlayFilled: return "\u{fb90}"
        case .videoLayoutOverlayLight: return "\u{fb91}"
        case .videoLayoutOverlayRegular: return "\u{fb92}"
        case .videoLayoutPresenterDominantBold: return "\u{fb93}"
        case .videoLayoutPresenterDominantLight: return "\u{fb94}"
        case .videoLayoutPresenterDominantRegular: return "\u{fb95}"
        case .videoLayoutProminentBold: return "\u{fb96}"
        case .videoLayoutProminentFilled: return "\u{fb97}"
        case .videoLayoutProminentLight: return "\u{fb98}"
        case .videoLayoutProminentRegular: return "\u{fb99}"
        case .videoLayoutRegular: return "\u{fb9a}"
        case .videoLayoutShareDominantBold: return "\u{fb9b}"
        case .videoLayoutShareDominantLight: return "\u{fb9c}"
        case .videoLayoutShareDominantRegular: return "\u{fb9d}"
        case .videoLayoutSingleBold: return "\u{fb9e}"
        case .videoLayoutSingleFilled: return "\u{fb9f}"
        case .videoLayoutSingleLight: return "\u{fba0}"
        case .videoLayoutSingleRegular: return "\u{fba1}"
        case .videoLayoutStackBold: return "\u{fba2}"
        case .videoLayoutStackFilled: return "\u{fba3}"
        case .videoLayoutStackLight: return "\u{fba4}"
        case .videoLayoutStackRegular: return "\u{fba5}"
        case .videoLayoutVideoDominantBold: return "\u{fba6}"
        case .videoLayoutVideoDominantFilled: return "\u{fba7}"
        case .videoLayoutVideoDominantLight: return "\u{fba8}"
        case .videoLayoutVideoDominantRegular: return "\u{fba9}"
        case .videoLight: return "\u{fbaa}"
        case .videoPlusBold: return "\u{fbab}"
        case .videoPlusFilled: return "\u{fbac}"
        case .videoPlusLight: return "\u{fbad}"
        case .videoPlusRegular: return "\u{fbae}"
        case .videoRegular: return "\u{fbaf}"
        case .videoSpeakerTrackBold: return "\u{fbb0}"
        case .videoSpeakerTrackFilled: return "\u{fbb1}"
        case .videoSpeakerTrackLight: return "\u{fbb2}"
        case .videoSpeakerTrackRegular: return "\u{fbb3}"
        case .viewAllBold: return "\u{fbb4}"
        case .viewAllLight: return "\u{fbb5}"
        case .viewAllRegular: return "\u{fbb6}"
        case .viewListBold: return "\u{fbb7}"
        case .viewListFilled: return "\u{fbb8}"
        ...
        case .vpnBold: return "\u{fbd7}"
        case .vpnFilled: return "\u{fbd8}"
        case .vpnLight: return "\u{fbd9}"
        case .vpnRegular: return "\u{fbda}"
        case .vscBold: return "\u{fbdb}"
        case .vscLight: return "\u{fbdc}"
        case .vscRegular: return "\u{fbdd}"
        case .waffleMenuBold: return "\u{fbde}"
        case .waffleMenuLight: return "\u{fbdf}"
        case .waffleMenuRegular: return "\u{fbe0}"
        case .waitingRoomBold: return "\u{fbe1}"
        case .waitingRoomLight: return "\u{fbe2}"
        case .waitingRoomRegular: return "\u{fbe3}"
        case .wallpaperBold: return "\u{fbe4}"
        case .wallpaperLight: return "\u{fbe5}"
        case .wallpaperRegular: return "\u{fbe6}"
        case .warningBadgeFilled: return "\u{fbe7}"
        case .warningBold: return "\u{fbe8}"
        case .warningFilled: return "\u{fbe9}"
        case .warningLight: return "\u{fbea}"
        case .warningRegular: return "\u{fbeb}"
        case .webexBoardBold: return "\u{fbec}"
        case .webexBoardLight: return "\u{fbed}"
        case .webexBoardRegular: return "\u{fbee}"
        case .webexCodecPlusBold: return "\u{fbef}"
        case .webexCodecPlusLight: return "\u{fbf0}"
        case .webexCodecPlusRegular: return "\u{fbf1}"
        case .webexDeskCameraBold: return "\u{fbf2}"
        case .webexDeskCameraLight: return "\u{fbf3}"
        case .webexDeskCameraRegular: return "\u{fbf4}"
        case .webexHelixBold: return "\u{fbf5}"
        case .webexHelixLight: return "\u{fbf6}"
        case .webexHelixRegular: return "\u{fbf7}"
        case .webexMeetingsBold: return "\u{fbf8}"
        case .webexMeetingsFilled: return "\u{fbf9}"
        case .webexMeetingsLight: return "\u{fbfa}"
        case .webexMeetingsRegular: return "\u{fbfb}"
        case .webexQuadCameraBold: return "\u{fbfc}"
        case .webexQuadCameraLight: return "\u{fbfd}"
        case .webexQuadCameraRegular: return "\u{fbfe}"
        case .webexRoomKitBold: return "\u{fbff}"
        case .webexRoomKitLight: return "\u{fc00}"
        case .webexRoomKitPlusBold: return "\u{fc01}"
        case .webexRoomKitPlusLight: return "\u{fc02}"
        case .webexRoomKitPlusRegular: return "\u{fc03}"
        case .webexRoomKitRegular: return "\u{fc04}"
        case .webexShareBold: return "\u{fc05}"
        case .webexShareLight: return "\u{fc06}"
        case .webexShareRegular: return "\u{fc07}"
        case .webexTeamsBold: return "\u{fc08}"
        case .webexTeamsFilled: return "\u{fc09}"
        case .webexTeamsLight: return "\u{fc0a}"
        case .webexTeamsNewBold: return "\u{fc0b}"
        case .webexTeamsNewFilled: return "\u{fc0c}"
        case .webexTeamsNewLight: return "\u{fc0d}"
        case .webexTeamsNewRegular: return "\u{fc0e}"
        case .webexTeamsRegular: return "\u{fc0f}"
        case .webexTeamsRemoveBold: return "\u{fc10}"
        case .webexTeamsRemoveLight: return "\u{fc11}"
        case .webexTeamsRemoveRegular: return "\u{fc12}"
        case .webinarBold: return "\u{fc13}"
        case .webinarFilled: return "\u{fc14}"
        case .webinarLight: return "\u{fc15}"
        case .webinarRegular: return "\u{fc16}"
        case .weeklyRecurringScheduleBold: return "\u{fc17}"
        case .weeklyRecurringScheduleLight: return "\u{fc18}"
        case .weeklyRecurringScheduleRegular: return "\u{fc19}"
        case .whisperCoachBold: return "\u{fc1a}"
        case .whisperCoachFilled: return "\u{fc1b}"
        case .whisperCoachLight: return "\u{fc1c}"
        case .whisperCoachRegular: return "\u{fc1d}"
        case .whiteboardBold: return "\u{fc1e}"
        case .whiteboardContentBold: return "\u{fc1f}"
        case .whiteboardContentFilled: return "\u{fc20}"
        case .whiteboardContentLight: return "\u{fc21}"
        case .whiteboardContentRegular: return "\u{fc22}"
        case .whiteboardFilled: return "\u{fc23}"
        case .whiteboardLight: return "\u{fc24}"
        case .whiteboardRegular: return "\u{fc25}"
        case .widgetBold: return "\u{fc26}"
        case .widgetFilled: return "\u{fc27}"
        case .widgetLight: return "\u{fc28}"
        case .widgetRegular: return "\u{fc29}"
        case .wifiBold: return "\u{fc2a}"
        case .wifiErrorBold: return "\u{fc2b}"
        case .wifiErrorLight: return "\u{fc2c}"
        case .wifiErrorRegular: return "\u{fc2d}"
        case .wifiLight: return "\u{fc2e}"
        case .wifiRegular: return "\u{fc2f}"
        case .wifiSignalGoodBold: return "\u{fc30}"
        case .wifiSignalGoodLight: return "\u{fc31}"
        case .wifiSignalGoodRegular: return "\u{fc32}"
        case .wifiSignalPoorBold: return "\u{fc33}"
        case .wifiSignalPoorLight: return "\u{fc34}"
        case .wifiSignalPoorRegular: return "\u{fc35}"
        case .wifiSignalUnstableBold: return "\u{fc36}"
        case .wifiSignalUnstableLight: return "\u{fc37}"
        case .wifiSignalUnstableRegular: return "\u{fc38}"
        case .windowCornerScrubBold: return "\u{fc39}"
        case .windowCornerScrubLight: return "\u{fc3a}"
        case .windowCornerScrubRegular: return "\u{fc3b}"
        case .windowRightCornerScrubBold: return "\u{fc3c}"
        case .windowRightCornerScrubLight: return "\u{fc3d}"
        case .windowRightCornerScrubRegular: return "\u{fc3e}"
        case .windowVerticalScrubBold: return "\u{fc3f}"
        case .windowVerticalScrubLight: return "\u{fc40}"
        case .windowVerticalScrubRegular: return "\u{fc41}"
        case .workflowDeploymentsBold: return "\u{fc42}"
        case .workflowDeploymentsFilled: return "\u{fc43}"
        case .workflowDeploymentsLight: return "\u{fc44}"
        case .workflowDeploymentsRegular: return "\u{fc45}"
        case .workphoneBold: return "\u{fc46}"
        case .workphoneLight: return "\u{fc47}"
        case .workphoneRegular: return "\u{fc48}"
