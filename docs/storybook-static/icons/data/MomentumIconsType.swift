...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .smsFilled: return "\u{fb24}"
        case .smsInboundBold: return "\u{fb25}"
        case .smsInboundLight: return "\u{fb26}"
        case .smsInboundRegular: return "\u{fb27}"
        case .smsMessageBold: return "\u{fb28}"
        case .smsMessageFilled: return "\u{fb29}"
        case .smsMessageLight: return "\u{fb2a}"
        case .smsMessageOutgoingBold: return "\u{fb2b}"
        case .smsMessageOutgoingFilled: return "\u{fb2c}"
        case .smsMessageOutgoingLight: return "\u{fb2d}"
        case .smsMessageOutgoingRegular: return "\u{fb2e}"
        case .smsMessageRegular: return "\u{fb2f}"
        case .smsMessageStartBold: return "\u{fb30}"
        case .smsMessageStartFilled: return "\u{fb31}"
        case .smsMessageStartLight: return "\u{fb32}"
        case .smsMessageStartRegular: return "\u{fb33}"
        case .smsOutgoingFilled: return "\u{fb34}"
        case .smsUnreadBold: return "\u{fb35}"
        case .smsUnreadLight: return "\u{fb36}"
        case .smsUnreadRegular: return "\u{fb37}"
        case .sortAscendingBold: return "\u{fb38}"
        case .sortAscendingLight: return "\u{fb39}"
        case .sortAscendingRegular: return "\u{fb3a}"
        case .sortDescendingBold: return "\u{fb3b}"
        case .sortDescendingLight: return "\u{fb3c}"
        case .sortDescendingRegular: return "\u{fb3d}"
        case .soundDefaultBold: return "\u{fb3e}"
        case .soundDefaultLight: return "\u{fb3f}"
        case .soundDefaultRegular: return "\u{fb40}"
        case .sparkleBold: return "\u{fb41}"
        case .sparkleFilled: return "\u{fb42}"
        case .sparkleLight: return "\u{fb43}"
        case .sparkleRegular: return "\u{fb44}"
        case .speakerBold: return "\u{fb45}"
        case .speakerDisconnectedBold: return "\u{fb46}"
        case .speakerDisconnectedFilled: return "\u{fb47}"
        case .speakerDisconnectedLight: return "\u{fb48}"
        case .speakerDisconnectedRegular: return "\u{fb49}"
        case .speakerFilled: return "\u{fb4a}"
        case .speakerLight: return "\u{fb4b}"
        case .speakerMutedBold: return "\u{fb4c}"
        case .speakerMutedFilled: return "\u{fb4d}"
        case .speakerMutedLight: return "\u{fb4e}"
        case .speakerMutedRegular: return "\u{fb4f}"
        case .speakerOffBold: return "\u{fb50}"
        case .speakerOffFilled: return "\u{fb51}"
        case .speakerOffLight: return "\u{fb52}"
        case .speakerOffRegular: return "\u{fb53}"
        case .speakerOnBold: return "\u{fb54}"
        case .speakerOnLight: return "\u{fb55}"
        case .speakerOnRegular: return "\u{fb56}"
        case .speakerRegular: return "\u{fb57}"
        case .speakerTurnDownBold: return "\u{fb58}"
        case .speakerTurnDownFilled: return "\u{fb59}"
        case .speakerTurnDownLight: return "\u{fb5a}"
        case .speakerTurnDownRegular: return "\u{fb5b}"
        case .speakerTurnUpBold: return "\u{fb5c}"
        case .speakerTurnUpFilled: return "\u{fb5d}"
        case .speakerTurnUpLight: return "\u{fb5e}"
        case .speakerTurnUpRegular: return "\u{fb5f}"
        case .speedDialBold: return "\u{fb60}"
        case .speedDialFilled: return "\u{fb61}"
        case .speedDialLight: return "\u{fb62}"
        case .speedDialRegular: return "\u{fb63}"
        case .spellCheckerBold: return "\u{fb64}"
        case .spellCheckerLight: return "\u{fb65}"
        case .spellCheckerRegular: return "\u{fb66}"
        case .splitViewBold: return "\u{fb67}"
        case .splitViewLight: return "\u{fb68}"
        case .splitViewRegular: return "\u{fb69}"
        case .stackedAreaChartBold: return "\u{fb6a}"
        case .stackedAreaChartFilled: return "\u{fb6b}"
        case .stackedAreaChartFullBold: return "\u{fb6c}"
        case .stackedAreaChartFullFilled: return "\u{fb6d}"
        case .stackedAreaChartFullLight: return "\u{fb6e}"
        case .stackedAreaChartFullRegular: return "\u{fb6f}"
        case .stackedAreaChartLight: return "\u{fb70}"
        case .stackedAreaChartRegular: return "\u{fb71}"
        case .stackedBarChartBold: return "\u{fb72}"
        case .stackedBarChartFilled: return "\u{fb73}"
        case .stackedBarChartFullBold: return "\u{fb74}"
        case .stackedBarChartFullFilled: return "\u{fb75}"
        case .stackedBarChartFullLight: return "\u{fb76}"
        case .stackedBarChartFullRegular: return "\u{fb77}"
        case .stackedBarChartLight: return "\u{fb78}"
        case .stackedBarChartRegular: return "\u{fb79}"
        case .startChatBold: return "\u{fb7a}"
        case .startChatLight: return "\u{fb7b}"
        case .startChatRegular: return "\u{fb7c}"
        case .stethoscopeBold: return "\u{fb7d}"
        case .stethoscopeLight: return "\u{fb7e}"
        case .stethoscopeRegular: return "\u{fb7f}"
        case .stickersBold: return "\u{fb80}"
        case .stickersLight: return "\u{fb81}"
        case .stickersRegular: return "\u{fb82}"
        case .stickiesBold: return "\u{fb83}"
        case .stickiesLight: return "\u{fb84}"
        case .stickiesRegular: return "\u{fb85}"
        case .stopBold: return "\u{fb86}"
        case .stopCircleBold: return "\u{fb87}"
        case .stopCircleFilled: return "\u{fb88}"
        case .stopCircleLight: return "\u{fb89}"
        case .stopCircleRegular: return "\u{fb8a}"
        case .stopContentShareBold: return "\u{fb8b}"
        case .stopContentShareLight: return "\u{fb8c}"
        case .stopContentShareRegular: return "\u{fb8d}"
        case .stopFilled: return "\u{fb8e}"
        case .stopLight: return "\u{fb8f}"
        case .stopRegular: return "\u{fb90}"
        case .storedInfoBold: return "\u{fb91}"
        case .storedInfoFilled: return "\u{fb92}"
        case .storedInfoLight: return "\u{fb93}"
        case .storedInfoRegular: return "\u{fb94}"
        case .streamingBold: return "\u{fb95}"
        case .streamingLight: return "\u{fb96}"
        case .streamingRegular: return "\u{fb97}"
        case .strikethroughBold: return "\u{fb98}"
        case .strikethroughFilled: return "\u{fb99}"
        case .strikethroughLight: return "\u{fb9a}"
        case .strikethroughRegular: return "\u{fb9b}"
        case .studioModeBold: return "\u{fb9c}"
        case .studioModeLight: return "\u{fb9d}"
        case .studioModeRegular: return "\u{fb9e}"
        case .subscriptBold: return "\u{fb9f}"
        case .subscriptLight: return "\u{fba0}"
        case .subscriptRegular: return "\u{fba1}"
        case .summarizeAiBold: return "\u{fba2}"
        case .summarizeAiLight: return "\u{fba3}"
        case .summarizeAiRegular: return "\u{fba4}"
        case .superscriptBold: return "\u{fba5}"
        case .superscriptLight: return "\u{fba6}"
        case .superscriptRegular: return "\u{fba7}"
        case .surveyBold: return "\u{fba8}"
        case .surveyFilled: return "\u{fba9}"
        case .surveyLight: return "\u{fbaa}"
        case .surveyRegular: return "\u{fbab}"
        case .sxEightyCodecBold: return "\u{fbac}"
        case .sxEightyCodecLight: return "\u{fbad}"
        case .sxEightyCodecRegular: return "\u{fbae}"
        case .sxTenBold: return "\u{fbaf}"
        case .sxTenLight: return "\u{fbb0}"
        case .sxTenRegular: return "\u{fbb1}"
        case .sxTwentyBold: return "\u{fbb2}"
        case .sxTwentyLight: return "\u{fbb3}"
        case .sxTwentyRegular: return "\u{fbb4}"
        case .tableBold: return "\u{fbb5}"
        case .tableExtenderBold: return "\u{fbb6}"
        case .tableExtenderFilled: return "\u{fbb7}"
        case .tableExtenderLight: return "\u{fbb8}"
        case .tableExtenderRegular: return "\u{fbb9}"
        case .tableLight: return "\u{fbba}"
        case .tableRegular: return "\u{fbbb}"
        case .tabletBold: return "\u{fbbc}"
        case .tabletLight: return "\u{fbbd}"
        case .tabletRegular: return "\u{fbbe}"
        case .tabsBold: return "\u{fbbf}"
        case .tabsLight: return "\u{fbc0}"
        case .tabsRegular: return "\u{fbc1}"
        case .tagBold: return "\u{fbc2}"
        case .tagLight: return "\u{fbc3}"
        case .tagRegular: return "\u{fbc4}"
        case .tapBold: return "\u{fbc5}"
        case .tapFilled: return "\u{fbc6}"
        case .tapLight: return "\u{fbc7}"
        case .tapRegular: return "\u{fbc8}"
        case .telepresenceAlertBold: return "\u{fbc9}"
        case .telepresenceAlertLight: return "\u{fbca}"
        case .telepresenceAlertMutedBold: return "\u{fbcb}"
        case .telepresenceAlertMutedLight: return "\u{fbcc}"
        case .telepresenceAlertMutedRegular: return "\u{fbcd}"
        case .telepresenceAlertRegular: return "\u{fbce}"
        case .telepresenceBold: return "\u{fbcf}"
        case .telepresenceIxFiveThousandBold: return "\u{fbd0}"
        case .telepresenceIxFiveThousandLight: return "\u{fbd1}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbd2}"
        case .telepresenceLight: return "\u{fbd3}"
        case .telepresenceMutedBold: return "\u{fbd4}"
        case .telepresenceMutedLight: return "\u{fbd5}"
        case .telepresenceMutedRegular: return "\u{fbd6}"
        case .telepresencePrivateBold: return "\u{fbd7}"
        case .telepresencePrivateLight: return "\u{fbd8}"
        case .telepresencePrivateRegular: return "\u{fbd9}"
        case .telepresenceRegular: return "\u{fbda}"
        case .temperatureBold: return "\u{fbdb}"
        case .temperatureLight: return "\u{fbdc}"
        case .temperatureRegular: return "\u{fbdd}"
        case .testTubeBold: return "\u{fbde}"
        case .testTubeFilled: return "\u{fbdf}"
        case .testTubeLight: return "\u{fbe0}"
        case .testTubeRegular: return "\u{fbe1}"
        case .textAlignCenterBold: return "\u{fbe2}"
        case .textAlignCenterFilled: return "\u{fbe3}"
        case .textAlignCenterLight: return "\u{fbe4}"
        case .textAlignCenterRegular: return "\u{fbe5}"
        case .textAlignLeftBold: return "\u{fbe6}"
        case .textAlignLeftFilled: return "\u{fbe7}"
        case .textAlignLeftLight: return "\u{fbe8}"
        case .textAlignLeftRegular: return "\u{fbe9}"
        case .textAlignRightBold: return "\u{fbea}"
        case .textAlignRightFilled: return "\u{fbeb}"
        case .textAlignRightLight: return "\u{fbec}"
        case .textAlignRightRegular: return "\u{fbed}"
        case .textBold: return "\u{fbee}"
        case .textBoxCursorLight: return "\u{fbef}"
        case .textCodeBlockBold: return "\u{fbf0}"
        case .textCodeBlockLight: return "\u{fbf1}"
        case .textCodeBlockRegular: return "\u{fbf2}"
        case .textHighlightBold: return "\u{fbf3}"
        case .textHighlightFilled: return "\u{fbf4}"
        case .textHighlightLight: return "\u{fbf5}"
        case .textHighlightRegular: return "\u{fbf6}"
        case .textLight: return "\u{fbf7}"
        case .textRegular: return "\u{fbf8}"
        case .threeColumnBold: return "\u{fbf9}"
        case .threeColumnLight: return "\u{fbfa}"
        case .threeColumnRegular: return "\u{fbfb}"
        case .threeDObjectBold: return "\u{fbfc}"
        case .threeDObjectLight: return "\u{fbfd}"
        case .threeDObjectRegular: return "\u{fbfe}"
        case .timeExclusionBold: return "\u{fbff}"
        case .timeExclusionLight: return "\u{fc00}"
        case .timeExclusionRegular: return "\u{fc01}"
        case .timezoneBold: return "\u{fc02}"
        case .timezoneFilled: return "\u{fc03}"
        case .timezoneLight: return "\u{fc04}"
        case .timezoneRegular: return "\u{fc05}"
        case .tooFastBold: return "\u{fc06}"
        case .tooFastLight: return "\u{fc07}"
        case .tooFastRegular: return "\u{fc08}"
        case .tooSlowBold: return "\u{fc09}"
        case .tooSlowLight: return "\u{fc0a}"
        case .tooSlowRegular: return "\u{fc0b}"
        case .toolsBold: return "\u{fc0c}"
        case .toolsFilled: return "\u{fc0d}"
        case .toolsLight: return "\u{fc0e}"
        case .toolsRegular: return "\u{fc0f}"
        case .touchTenBold: return "\u{fc10}"
        case .touchTenLight: return "\u{fc11}"
        case .touchTenRegular: return "\u{fc12}"
        case .transcriptBold: return "\u{fc13}"
        case .transcriptFilled: return "\u{fc14}"
        case .transcriptLight: return "\u{fc15}"
        case .transcriptRegular: return "\u{fc16}"
        case .translateBold: return "\u{fc17}"
        case .translateLight: return "\u{fc18}"
        case .translateRegular: return "\u{fc19}"
        case .translateUndoBold: return "\u{fc1a}"
        case .translateUndoLight: return "\u{fc1b}"
        case .translateUndoRegular: return "\u{fc1c}"
        case .trendingBold: return "\u{fc1d}"
        case .trendingDownBold: return "\u{fc1e}"
        case .trendingDownFilled: return "\u{fc1f}"
        case .trendingDownLight: return "\u{fc20}"
        case .trendingDownRegular: return "\u{fc21}"
        case .trendingFilled: return "\u{fc22}"
        case .trendingLight: return "\u{fc23}"
        case .trendingRegular: return "\u{fc24}"
        case .trimBold: return "\u{fc25}"
        case .trimLight: return "\u{fc26}"
        case .trimRegular: return "\u{fc27}"
        case .twoColumnBold: return "\u{fc28}"
        case .twoColumnLight: return "\u{fc29}"
        case .twoColumnRegular: return "\u{fc2a}"
        case .twoWayVoiceStreamBold: return "\u{fc2b}"
        case .twoWayVoiceStreamFilled: return "\u{fc2c}"
        case .twoWayVoiceStreamLight: return "\u{fc2d}"
        case .twoWayVoiceStreamRegular: return "\u{fc2e}"
        case .ucmCloudBold: return "\u{fc2f}"
        case .ucmCloudLight: return "\u{fc30}"
        case .ucmCloudRegular: return "\u{fc31}"
        case .unblockBold: return "\u{fc32}"
        case .unblockFilled: return "\u{fc33}"
        case .unblockLight: return "\u{fc34}"
        case .unblockRegular: return "\u{fc35}"
        case .underlineBold: return "\u{fc36}"
        case .underlineFilled: return "\u{fc37}"
        case .underlineLight: return "\u{fc38}"
        case .underlineRegular: return "\u{fc39}"
        case .undoBold: return "\u{fc3a}"
        case .undoLight: return "\u{fc3b}"
        case .undoRegular: return "\u{fc3c}"
        case .unlinkBold: return "\u{fc3d}"
        case .unlinkLight: return "\u{fc3e}"
        case .unlinkRegular: return "\u{fc3f}"
        case .unreadBold: return "\u{fc40}"
        case .unreadFilled: return "\u{fc41}"
        case .unreadLight: return "\u{fc42}"
        case .unreadRegular: return "\u{fc43}"
        case .unsecureUnlockedBold: return "\u{fc44}"
        case .unsecureUnlockedFilled: return "\u{fc45}"
        case .unsecureUnlockedLight: return "\u{fc46}"
        case .unsecureUnlockedRegular: return "\u{fc47}"
        case .unsortedBold: return "\u{fc48}"
        case .unsortedLight: return "\u{fc49}"
        case .unsortedRegular: return "\u{fc4a}"
        case .updateFileShareBold: return "\u{fc4b}"
        case .updateFileShareLight: return "\u{fc4c}"
        case .updateFileShareRegular: return "\u{fc4d}"
        case .uploadBold: return "\u{fc4e}"
        case .uploadImageBold: return "\u{fc4f}"
        case .uploadImageLight: return "\u{fc50}"
        case .uploadImageRegular: return "\u{fc51}"
        case .uploadLight: return "\u{fc52}"
        case .uploadRegular: return "\u{fc53}"
        case .urgentVoicemailBold: return "\u{fc54}"
        case .urgentVoicemailFilled: return "\u{fc55}"
        case .usbBold: return "\u{fc56}"
        case .usbHeadsetBold: return "\u{fc57}"
        case .usbHeadsetLight: return "\u{fc58}"
        case .usbHeadsetMutedBold: return "\u{fc59}"
        case .usbHeadsetMutedLight: return "\u{fc5a}"
        case .usbHeadsetMutedRegular: return "\u{fc5b}"
        case .usbHeadsetRegular: return "\u{fc5c}"
        case .usbLight: return "\u{fc5d}"
        case .usbRegular: return "\u{fc5e}"
        case .userBold: return "\u{fc5f}"
        case .userDeactivateBold: return "\u{fc60}"
        case .userDeactivateLight: return "\u{fc61}"
        case .userDeactivateRegular: return "\u{fc62}"
        case .userFilled: return "\u{fc63}"
        case .userLight: return "\u{fc64}"
        case .userRegular: return "\u{fc65}"
        case .videoBlurBold: return "\u{fc66}"
        case .videoBlurFilled: return "\u{fc67}"
        case .videoBlurLight: return "\u{fc68}"
        case .videoBlurRegular: return "\u{fc69}"
        case .videoBold: return "\u{fc6a}"
        case .videoEffectBold: return "\u{fc6b}"
        case .videoEffectFilled: return "\u{fc6c}"
        case .videoEffectLight: return "\u{fc6d}"
        case .videoEffectRegular: return "\u{fc6e}"
        case .videoFilled: return "\u{fc6f}"
        case .videoLayoutBold: return "\u{fc70}"
        case .videoLayoutCustomBold: return "\u{fc71}"
        case .videoLayoutCustomFilled: return "\u{fc72}"
        case .videoLayoutCustomLight: return "\u{fc73}"
        case .videoLayoutCustomRegular: return "\u{fc74}"
        case .videoLayoutEqualBold: return "\u{fc75}"
        case .videoLayoutEqualDualBold: return "\u{fc76}"
        case .videoLayoutEqualDualLight: return "\u{fc77}"
        case .videoLayoutEqualDualRegular: return "\u{fc78}"
        case .videoLayoutEqualFilled: return "\u{fc79}"
        case .videoLayoutEqualLight: return "\u{fc7a}"
        case .videoLayoutEqualRegular: return "\u{fc7b}"
        case .videoLayoutFilled: return "\u{fc7c}"
        case .videoLayoutLight: return "\u{fc7d}"
        case .videoLayoutOverlayBold: return "\u{fc7e}"
        case .videoLayoutOverlayFilled: return "\u{fc7f}"
        case .videoLayoutOverlayLight: return "\u{fc80}"
        case .videoLayoutOverlayRegular: return "\u{fc81}"
        case .videoLayoutPresentationBold: return "\u{fc82}"
        case .videoLayoutPresentationFilled: return "\u{fc83}"
        case .videoLayoutPresentationLight: return "\u{fc84}"
        case .videoLayoutPresentationRegular: return "\u{fc85}"
        case .videoLayoutPresenterDominantBold: return "\u{fc86}"
        case .videoLayoutPresenterDominantLight: return "\u{fc87}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc88}"
        case .videoLayoutProminentBold: return "\u{fc89}"
        case .videoLayoutProminentFilled: return "\u{fc8a}"
        case .videoLayoutProminentLight: return "\u{fc8b}"
        case .videoLayoutProminentRegular: return "\u{fc8c}"
        case .videoLayoutRegular: return "\u{fc8d}"
        case .videoLayoutShareDominantBold: return "\u{fc8e}"
        case .videoLayoutShareDominantLight: return "\u{fc8f}"
        case .videoLayoutShareDominantRegular: return "\u{fc90}"
        case .videoLayoutSingleBold: return "\u{fc91}"
        case .videoLayoutSingleFilled: return "\u{fc92}"
        case .videoLayoutSingleLight: return "\u{fc93}"
        case .videoLayoutSingleRegular: return "\u{fc94}"
        case .videoLayoutSpeakerBold: return "\u{fc95}"
        case .videoLayoutSpeakerFilled: return "\u{fc96}"
        case .videoLayoutSpeakerLight: return "\u{fc97}"
        case .videoLayoutSpeakerRegular: return "\u{fc98}"
        case .videoLayoutStackBold: return "\u{fc99}"
        case .videoLayoutStackFilled: return "\u{fc9a}"
        case .videoLayoutStackLight: return "\u{fc9b}"
        case .videoLayoutStackRegular: return "\u{fc9c}"
        case .videoLayoutVideoDominantBold: return "\u{fc9d}"
        case .videoLayoutVideoDominantFilled: return "\u{fc9e}"
        case .videoLayoutVideoDominantLight: return "\u{fc9f}"
        case .videoLayoutVideoDominantRegular: return "\u{fca0}"
        case .videoLight: return "\u{fca1}"
        case .videoPlusBold: return "\u{fca2}"
        case .videoPlusFilled: return "\u{fca3}"
        case .videoPlusLight: return "\u{fca4}"
        case .videoPlusRegular: return "\u{fca5}"
        case .videoRegular: return "\u{fca6}"
        case .videoSpeakerTrackBold: return "\u{fca7}"
        case .videoSpeakerTrackFilled: return "\u{fca8}"
        case .videoSpeakerTrackLight: return "\u{fca9}"
        case .videoSpeakerTrackRegular: return "\u{fcaa}"
        case .viewAllBold: return "\u{fcab}"
        case .viewAllLight: return "\u{fcac}"
        case .viewAllRegular: return "\u{fcad}"
        case .viewListBold: return "\u{fcae}"
        case .viewListFilled: return "\u{fcaf}"
        case .viewListLight: return "\u{fcb0}"
        case .viewListRegular: return "\u{fcb1}"
        case .viewStackedBold: return "\u{fcb2}"
        case .viewStackedFilled: return "\u{fcb3}"
        case .viewStackedLight: return "\u{fcb4}"
        case .viewStackedRegular: return "\u{fcb5}"
        case .viewThumbnailBold: return "\u{fcb6}"
        case .viewThumbnailFilled: return "\u{fcb7}"
        case .viewThumbnailLight: return "\u{fcb8}"
        case .viewThumbnailRegular: return "\u{fcb9}"
        case .visionproBold: return "\u{fcba}"
        case .visionproFilled: return "\u{fcbb}"
        case .visionproLight: return "\u{fcbc}"
        case .visionproMoveCallInBold: return "\u{fcbd}"
        case .visionproMoveCallInFilled: return "\u{fcbe}"
        case .visionproMoveCallInLight: return "\u{fcbf}"
        case .visionproMoveCallInOutBold: return "\u{fcc0}"
        case .visionproMoveCallInOutFilled: return "\u{fcc1}"
        case .visionproMoveCallInOutLight: return "\u{fcc2}"
        case .visionproMoveCallInOutRegular: return "\u{fcc3}"
        case .visionproMoveCallInRegular: return "\u{fcc4}"
        case .visionproMoveCallOutBold: return "\u{fcc5}"
        case .visionproMoveCallOutFilled: return "\u{fcc6}"
        case .visionproMoveCallOutLight: return "\u{fcc7}"
        case .visionproMoveCallOutRegular: return "\u{fcc8}"
        case .visionproRegular: return "\u{fcc9}"
        case .voicemailBold: return "\u{fcca}"
        case .voicemailFilled: return "\u{fccb}"
        case .voicemailLight: return "\u{fccc}"
        case .voicemailRegular: return "\u{fccd}"
        case .vpnBold: return "\u{fcce}"
        case .vpnFilled: return "\u{fccf}"
        case .vpnLight: return "\u{fcd0}"
        case .vpnRegular: return "\u{fcd1}"
        case .vscBold: return "\u{fcd2}"
        case .vscLight: return "\u{fcd3}"
        case .vscRegular: return "\u{fcd4}"
        case .waffleMenuBold: return "\u{fcd5}"
        case .waffleMenuLight: return "\u{fcd6}"
        case .waffleMenuRegular: return "\u{fcd7}"
        case .waitingRoomBold: return "\u{fcd8}"
        case .waitingRoomLight: return "\u{fcd9}"
        case .waitingRoomRegular: return "\u{fcda}"
        case .wallpaperBold: return "\u{fcdb}"
        case .wallpaperLight: return "\u{fcdc}"
        case .wallpaperRegular: return "\u{fcdd}"
        case .warningBadgeFilled: return "\u{fcde}"
        case .warningBold: return "\u{fcdf}"
        case .warningFilled: return "\u{fce0}"
        case .warningLight: return "\u{fce1}"
        case .warningRegular: return "\u{fce2}"
        case .webexBoardBold: return "\u{fce3}"
        case .webexBoardLight: return "\u{fce4}"
        case .webexBoardRegular: return "\u{fce5}"
        case .webexCodecPlusBold: return "\u{fce6}"
        case .webexCodecPlusLight: return "\u{fce7}"
        case .webexCodecPlusRegular: return "\u{fce8}"
        case .webexDeskCameraBold: return "\u{fce9}"
        case .webexDeskCameraLight: return "\u{fcea}"
        case .webexDeskCameraRegular: return "\u{fceb}"
        case .webexHelixBold: return "\u{fcec}"
        case .webexHelixLight: return "\u{fced}"
        case .webexHelixRegular: return "\u{fcee}"
        case .webexMeetingsBold: return "\u{fcef}"
        case .webexMeetingsFilled: return "\u{fcf0}"
        case .webexMeetingsLight: return "\u{fcf1}"
        case .webexMeetingsRegular: return "\u{fcf2}"
        case .webexQuadCameraBold: return "\u{fcf3}"
        case .webexQuadCameraLight: return "\u{fcf4}"
        case .webexQuadCameraRegular: return "\u{fcf5}"
        case .webexRoomKitBold: return "\u{fcf6}"
        case .webexRoomKitLight: return "\u{fcf7}"
        case .webexRoomKitPlusBold: return "\u{fcf8}"
        case .webexRoomKitPlusLight: return "\u{fcf9}"
        case .webexRoomKitPlusRegular: return "\u{fcfa}"
        case .webexRoomKitRegular: return "\u{fcfb}"
        case .webexShareBold: return "\u{fcfc}"
        case .webexShareLight: return "\u{fcfd}"
        case .webexShareRegular: return "\u{fcfe}"
        case .webexTeamsBold: return "\u{fcff}"
        case .webexTeamsFilled: return "\u{fd00}"
        case .webexTeamsLight: return "\u{fd01}"
        case .webexTeamsNewBold: return "\u{fd02}"
        case .webexTeamsNewFilled: return "\u{fd03}"
        case .webexTeamsNewLight: return "\u{fd04}"
        case .webexTeamsNewRegular: return "\u{fd05}"
        case .webexTeamsRegular: return "\u{fd06}"
        case .webexTeamsRemoveBold: return "\u{fd07}"
        case .webexTeamsRemoveLight: return "\u{fd08}"
        case .webexTeamsRemoveRegular: return "\u{fd09}"
        case .webhookBold: return "\u{fd0a}"
        case .webhookLight: return "\u{fd0b}"
        case .webhookRegular: return "\u{fd0c}"
        case .webinarBold: return "\u{fd0d}"
        case .webinarFilled: return "\u{fd0e}"
        case .webinarLight: return "\u{fd0f}"
        case .webinarRegular: return "\u{fd10}"
        case .weeklyRecurringScheduleBold: return "\u{fd11}"
        case .weeklyRecurringScheduleLight: return "\u{fd12}"
        case .weeklyRecurringScheduleRegular: return "\u{fd13}"
        case .whisperAnnouncementBold: return "\u{fd14}"
        case .whisperAnnouncementFilled: return "\u{fd15}"
        case .whisperAnnouncementLight: return "\u{fd16}"
        case .whisperAnnouncementRegular: return "\u{fd17}"
        case .whisperCoachBold: return "\u{fd18}"
        case .whisperCoachFilled: return "\u{fd19}"
        case .whisperCoachLight: return "\u{fd1a}"
        case .whisperCoachRegular: return "\u{fd1b}"
        case .whiteboardBold: return "\u{fd1c}"
        case .whiteboardContentBold: return "\u{fd1d}"
        case .whiteboardContentFilled: return "\u{fd1e}"
        case .whiteboardContentLight: return "\u{fd1f}"
        case .whiteboardContentRegular: return "\u{fd20}"
        case .whiteboardFilled: return "\u{fd21}"
        case .whiteboardLight: return "\u{fd22}"
        case .whiteboardRegular: return "\u{fd23}"
        case .widgetBold: return "\u{fd24}"
        case .widgetFilled: return "\u{fd25}"
        case .widgetLight: return "\u{fd26}"
        case .widgetRegular: return "\u{fd27}"
        case .wifiBold: return "\u{fd28}"
        case .wifiErrorBold: return "\u{fd29}"
        case .wifiErrorLight: return "\u{fd2a}"
        case .wifiErrorRegular: return "\u{fd2b}"
        case .wifiLight: return "\u{fd2c}"
        case .wifiRegular: return "\u{fd2d}"
        case .wifiSignalGoodBold: return "\u{fd2e}"
        case .wifiSignalGoodLight: return "\u{fd2f}"
        case .wifiSignalGoodRegular: return "\u{fd30}"
        case .wifiSignalPoorBold: return "\u{fd31}"
        case .wifiSignalPoorLight: return "\u{fd32}"
        case .wifiSignalPoorRegular: return "\u{fd33}"
        case .wifiSignalUnstableBold: return "\u{fd34}"
        case .wifiSignalUnstableLight: return "\u{fd35}"
        case .wifiSignalUnstableRegular: return "\u{fd36}"
        case .windowCornerScrubBold: return "\u{fd37}"
        case .windowCornerScrubLight: return "\u{fd38}"
        case .windowCornerScrubRegular: return "\u{fd39}"
        case .windowRightCornerScrubBold: return "\u{fd3a}"
        case .windowRightCornerScrubLight: return "\u{fd3b}"
        case .windowRightCornerScrubRegular: return "\u{fd3c}"
        case .windowVerticalScrubBold: return "\u{fd3d}"
        case .windowVerticalScrubLight: return "\u{fd3e}"
        case .windowVerticalScrubRegular: return "\u{fd3f}"
        case .workflowDeploymentsBold: return "\u{fd40}"
        case .workflowDeploymentsFilled: return "\u{fd41}"
        case .workflowDeploymentsLight: return "\u{fd42}"
        case .workflowDeploymentsRegular: return "\u{fd43}"
        case .workphoneBold: return "\u{fd44}"
        case .workphoneLight: return "\u{fd45}"
        case .workphoneRegular: return "\u{fd46}"
        case .zoomInBold: return "\u{fd47}"
        case .zoomInLight: return "\u{fd48}"
        case .zoomInRegular: return "\u{fd49}"
        case .zoomOutBold: return "\u{fd4a}"
        case .zoomOutLight: return "\u{fd4b}"
        case .zoomOutRegular: return "\u{fd4c}"
