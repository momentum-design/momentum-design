...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .threeColumnBold: return "\u{fc29}"
        case .threeColumnLight: return "\u{fc2a}"
        case .threeColumnRegular: return "\u{fc2b}"
        case .threeDObjectBold: return "\u{fc2c}"
        case .threeDObjectLight: return "\u{fc2d}"
        case .threeDObjectRegular: return "\u{fc2e}"
        case .timeExclusionBold: return "\u{fc2f}"
        case .timeExclusionLight: return "\u{fc30}"
        case .timeExclusionRegular: return "\u{fc31}"
        case .timezoneBold: return "\u{fc32}"
        case .timezoneFilled: return "\u{fc33}"
        case .timezoneLight: return "\u{fc34}"
        case .timezoneRegular: return "\u{fc35}"
        case .tooFastBold: return "\u{fc36}"
        case .tooFastLight: return "\u{fc37}"
        case .tooFastRegular: return "\u{fc38}"
        case .tooSlowBold: return "\u{fc39}"
        case .tooSlowLight: return "\u{fc3a}"
        case .tooSlowRegular: return "\u{fc3b}"
        case .toolsBold: return "\u{fc3c}"
        case .toolsFilled: return "\u{fc3d}"
        case .toolsLight: return "\u{fc3e}"
        case .toolsRegular: return "\u{fc3f}"
        case .touchTenBold: return "\u{fc40}"
        case .touchTenLight: return "\u{fc41}"
        case .touchTenRegular: return "\u{fc42}"
        case .transcriptBold: return "\u{fc43}"
        case .transcriptFilled: return "\u{fc44}"
        case .transcriptLight: return "\u{fc45}"
        case .transcriptRegular: return "\u{fc46}"
        case .translateBold: return "\u{fc47}"
        case .translateLight: return "\u{fc48}"
        case .translateRegular: return "\u{fc49}"
        case .translateUndoBold: return "\u{fc4a}"
        case .translateUndoLight: return "\u{fc4b}"
        case .translateUndoRegular: return "\u{fc4c}"
        case .trendingBold: return "\u{fc4d}"
        case .trendingDownBold: return "\u{fc4e}"
        case .trendingDownFilled: return "\u{fc4f}"
        case .trendingDownLight: return "\u{fc50}"
        case .trendingDownRegular: return "\u{fc51}"
        case .trendingFilled: return "\u{fc52}"
        case .trendingLight: return "\u{fc53}"
        case .trendingRegular: return "\u{fc54}"
        case .trimBold: return "\u{fc55}"
        case .trimLight: return "\u{fc56}"
        case .trimRegular: return "\u{fc57}"
        case .twoColumnBold: return "\u{fc58}"
        case .twoColumnLight: return "\u{fc59}"
        case .twoColumnRegular: return "\u{fc5a}"
        case .twoWayVoiceStreamBold: return "\u{fc5b}"
        case .twoWayVoiceStreamFilled: return "\u{fc5c}"
        case .twoWayVoiceStreamLight: return "\u{fc5d}"
        case .twoWayVoiceStreamRegular: return "\u{fc5e}"
        case .ucmCloudBold: return "\u{fc5f}"
        case .ucmCloudLight: return "\u{fc60}"
        case .ucmCloudRegular: return "\u{fc61}"
        case .unblockBold: return "\u{fc62}"
        case .unblockFilled: return "\u{fc63}"
        case .unblockLight: return "\u{fc64}"
        case .unblockRegular: return "\u{fc65}"
        case .underlineBold: return "\u{fc66}"
        case .underlineFilled: return "\u{fc67}"
        case .underlineLight: return "\u{fc68}"
        case .underlineRegular: return "\u{fc69}"
        case .undoBold: return "\u{fc6a}"
        case .undoLight: return "\u{fc6b}"
        case .undoRegular: return "\u{fc6c}"
        case .unlinkBold: return "\u{fc6d}"
        case .unlinkLight: return "\u{fc6e}"
        case .unlinkRegular: return "\u{fc6f}"
        case .unreadBold: return "\u{fc70}"
        case .unreadFilled: return "\u{fc71}"
        case .unreadLight: return "\u{fc72}"
        case .unreadRegular: return "\u{fc73}"
        case .unsecureUnlockedBold: return "\u{fc74}"
        case .unsecureUnlockedFilled: return "\u{fc75}"
        case .unsecureUnlockedLight: return "\u{fc76}"
        case .unsecureUnlockedRegular: return "\u{fc77}"
        case .unsortedBold: return "\u{fc78}"
        case .unsortedLight: return "\u{fc79}"
        case .unsortedRegular: return "\u{fc7a}"
        case .updateFileShareBold: return "\u{fc7b}"
        case .updateFileShareLight: return "\u{fc7c}"
        case .updateFileShareRegular: return "\u{fc7d}"
        case .uploadBold: return "\u{fc7e}"
        case .uploadImageBold: return "\u{fc7f}"
        case .uploadImageLight: return "\u{fc80}"
        case .uploadImageRegular: return "\u{fc81}"
        case .uploadLight: return "\u{fc82}"
        case .uploadRegular: return "\u{fc83}"
        case .urgentVoicemailBold: return "\u{fc84}"
        case .urgentVoicemailFilled: return "\u{fc85}"
        case .usbBold: return "\u{fc86}"
        case .usbHeadsetBold: return "\u{fc87}"
        case .usbHeadsetLight: return "\u{fc88}"
        case .usbHeadsetMutedBold: return "\u{fc89}"
        case .usbHeadsetMutedLight: return "\u{fc8a}"
        case .usbHeadsetMutedRegular: return "\u{fc8b}"
        case .usbHeadsetRegular: return "\u{fc8c}"
        case .usbLight: return "\u{fc8d}"
        case .usbRegular: return "\u{fc8e}"
        case .userBold: return "\u{fc8f}"
        case .userDeactivateBold: return "\u{fc90}"
        case .userDeactivateLight: return "\u{fc91}"
        case .userDeactivateRegular: return "\u{fc92}"
        case .userFilled: return "\u{fc93}"
        case .userLight: return "\u{fc94}"
        case .userRegular: return "\u{fc95}"
        case .videoBlurBold: return "\u{fc96}"
        case .videoBlurFilled: return "\u{fc97}"
        case .videoBlurLight: return "\u{fc98}"
        case .videoBlurRegular: return "\u{fc99}"
        case .videoBold: return "\u{fc9a}"
        case .videoEffectBold: return "\u{fc9b}"
        case .videoEffectFilled: return "\u{fc9c}"
        case .videoEffectLight: return "\u{fc9d}"
        case .videoEffectRegular: return "\u{fc9e}"
        case .videoFilled: return "\u{fc9f}"
        case .videoLayoutBold: return "\u{fca0}"
        case .videoLayoutCustomBold: return "\u{fca1}"
        case .videoLayoutCustomFilled: return "\u{fca2}"
        case .videoLayoutCustomLight: return "\u{fca3}"
        case .videoLayoutCustomRegular: return "\u{fca4}"
        case .videoLayoutEqualBold: return "\u{fca5}"
        case .videoLayoutEqualDualBold: return "\u{fca6}"
        case .videoLayoutEqualDualLight: return "\u{fca7}"
        case .videoLayoutEqualDualRegular: return "\u{fca8}"
        case .videoLayoutEqualFilled: return "\u{fca9}"
        case .videoLayoutEqualLight: return "\u{fcaa}"
        case .videoLayoutEqualRegular: return "\u{fcab}"
        case .videoLayoutFilled: return "\u{fcac}"
        case .videoLayoutLight: return "\u{fcad}"
        case .videoLayoutOverlayBold: return "\u{fcae}"
        case .videoLayoutOverlayFilled: return "\u{fcaf}"
        case .videoLayoutOverlayLight: return "\u{fcb0}"
        case .videoLayoutOverlayRegular: return "\u{fcb1}"
        case .videoLayoutPresentationBold: return "\u{fcb2}"
        case .videoLayoutPresentationFilled: return "\u{fcb3}"
        case .videoLayoutPresentationLight: return "\u{fcb4}"
        case .videoLayoutPresentationRegular: return "\u{fcb5}"
        case .videoLayoutPresenterDominantBold: return "\u{fcb6}"
        case .videoLayoutPresenterDominantLight: return "\u{fcb7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcb8}"
        case .videoLayoutProminentBold: return "\u{fcb9}"
        case .videoLayoutProminentFilled: return "\u{fcba}"
        case .videoLayoutProminentLight: return "\u{fcbb}"
        case .videoLayoutProminentRegular: return "\u{fcbc}"
        case .videoLayoutRegular: return "\u{fcbd}"
        case .videoLayoutShareDominantBold: return "\u{fcbe}"
        case .videoLayoutShareDominantLight: return "\u{fcbf}"
        case .videoLayoutShareDominantRegular: return "\u{fcc0}"
        case .videoLayoutSingleBold: return "\u{fcc1}"
        case .videoLayoutSingleFilled: return "\u{fcc2}"
        case .videoLayoutSingleLight: return "\u{fcc3}"
        case .videoLayoutSingleRegular: return "\u{fcc4}"
        case .videoLayoutSpeakerBold: return "\u{fcc5}"
        case .videoLayoutSpeakerFilled: return "\u{fcc6}"
        case .videoLayoutSpeakerLight: return "\u{fcc7}"
        case .videoLayoutSpeakerRegular: return "\u{fcc8}"
        case .videoLayoutStackBold: return "\u{fcc9}"
        case .videoLayoutStackFilled: return "\u{fcca}"
        case .videoLayoutStackLight: return "\u{fccb}"
        case .videoLayoutStackRegular: return "\u{fccc}"
        case .videoLayoutVideoDominantBold: return "\u{fccd}"
        case .videoLayoutVideoDominantFilled: return "\u{fcce}"
        case .videoLayoutVideoDominantLight: return "\u{fccf}"
        case .videoLayoutVideoDominantRegular: return "\u{fcd0}"
        case .videoLight: return "\u{fcd1}"
        case .videoPlusBold: return "\u{fcd2}"
        case .videoPlusFilled: return "\u{fcd3}"
        case .videoPlusLight: return "\u{fcd4}"
        case .videoPlusRegular: return "\u{fcd5}"
        case .videoRegular: return "\u{fcd6}"
        case .videoSpeakerTrackBold: return "\u{fcd7}"
        case .videoSpeakerTrackFilled: return "\u{fcd8}"
        case .videoSpeakerTrackLight: return "\u{fcd9}"
        case .videoSpeakerTrackRegular: return "\u{fcda}"
        case .viewAllBold: return "\u{fcdb}"
        case .viewAllLight: return "\u{fcdc}"
        case .viewAllRegular: return "\u{fcdd}"
        case .viewListBold: return "\u{fcde}"
        case .viewListFilled: return "\u{fcdf}"
        case .viewListLight: return "\u{fce0}"
        case .viewListRegular: return "\u{fce1}"
        case .viewStackedBold: return "\u{fce2}"
        case .viewStackedFilled: return "\u{fce3}"
        case .viewStackedLight: return "\u{fce4}"
        case .viewStackedRegular: return "\u{fce5}"
        case .viewThumbnailBold: return "\u{fce6}"
        case .viewThumbnailFilled: return "\u{fce7}"
        case .viewThumbnailLight: return "\u{fce8}"
        case .viewThumbnailRegular: return "\u{fce9}"
        case .visionproBold: return "\u{fcea}"
        case .visionproFilled: return "\u{fceb}"
        case .visionproLight: return "\u{fcec}"
        case .visionproMoveCallInBold: return "\u{fced}"
        case .visionproMoveCallInFilled: return "\u{fcee}"
        case .visionproMoveCallInLight: return "\u{fcef}"
        case .visionproMoveCallInOutBold: return "\u{fcf0}"
        case .visionproMoveCallInOutFilled: return "\u{fcf1}"
        case .visionproMoveCallInOutLight: return "\u{fcf2}"
        case .visionproMoveCallInOutRegular: return "\u{fcf3}"
        case .visionproMoveCallInRegular: return "\u{fcf4}"
        case .visionproMoveCallOutBold: return "\u{fcf5}"
        case .visionproMoveCallOutFilled: return "\u{fcf6}"
        case .visionproMoveCallOutLight: return "\u{fcf7}"
        case .visionproMoveCallOutRegular: return "\u{fcf8}"
        case .visionproRegular: return "\u{fcf9}"
        case .voicemailBold: return "\u{fcfa}"
        case .voicemailFilled: return "\u{fcfb}"
        case .voicemailLight: return "\u{fcfc}"
        case .voicemailRegular: return "\u{fcfd}"
        case .vpnBold: return "\u{fcfe}"
        case .vpnFilled: return "\u{fcff}"
        case .vpnLight: return "\u{fd00}"
        case .vpnRegular: return "\u{fd01}"
        case .vscBold: return "\u{fd02}"
        case .vscLight: return "\u{fd03}"
        case .vscRegular: return "\u{fd04}"
        case .waffleMenuBold: return "\u{fd05}"
        case .waffleMenuLight: return "\u{fd06}"
        case .waffleMenuRegular: return "\u{fd07}"
        case .waitingRoomBold: return "\u{fd08}"
        case .waitingRoomFilled: return "\u{fd09}"
        case .waitingRoomLight: return "\u{fd0a}"
        case .waitingRoomRegular: return "\u{fd0b}"
        case .wallpaperBold: return "\u{fd0c}"
        case .wallpaperLight: return "\u{fd0d}"
        case .wallpaperRegular: return "\u{fd0e}"
        case .warningBadgeFilled: return "\u{fd0f}"
        case .warningBold: return "\u{fd10}"
        case .warningFilled: return "\u{fd11}"
        case .warningLight: return "\u{fd12}"
        case .warningRegular: return "\u{fd13}"
        case .webexBoardBold: return "\u{fd14}"
        case .webexBoardLight: return "\u{fd15}"
        case .webexBoardRegular: return "\u{fd16}"
        case .webexCodecPlusBold: return "\u{fd17}"
        case .webexCodecPlusLight: return "\u{fd18}"
        case .webexCodecPlusRegular: return "\u{fd19}"
        case .webexDeskCameraBold: return "\u{fd1a}"
        case .webexDeskCameraLight: return "\u{fd1b}"
        case .webexDeskCameraRegular: return "\u{fd1c}"
        case .webexHelixBold: return "\u{fd1d}"
        case .webexHelixLight: return "\u{fd1e}"
        case .webexHelixRegular: return "\u{fd1f}"
        case .webexMeetingsBold: return "\u{fd20}"
        case .webexMeetingsFilled: return "\u{fd21}"
        case .webexMeetingsLight: return "\u{fd22}"
        case .webexMeetingsRegular: return "\u{fd23}"
        case .webexQuadCameraBold: return "\u{fd24}"
        case .webexQuadCameraLight: return "\u{fd25}"
        case .webexQuadCameraRegular: return "\u{fd26}"
        case .webexRoomKitBold: return "\u{fd27}"
        case .webexRoomKitLight: return "\u{fd28}"
        case .webexRoomKitPlusBold: return "\u{fd29}"
        case .webexRoomKitPlusLight: return "\u{fd2a}"
        case .webexRoomKitPlusRegular: return "\u{fd2b}"
        case .webexRoomKitRegular: return "\u{fd2c}"
        case .webexShareBold: return "\u{fd2d}"
        case .webexShareLight: return "\u{fd2e}"
        case .webexShareRegular: return "\u{fd2f}"
        case .webexTeamsBold: return "\u{fd30}"
        case .webexTeamsFilled: return "\u{fd31}"
        case .webexTeamsLight: return "\u{fd32}"
        case .webexTeamsNewBold: return "\u{fd33}"
        case .webexTeamsNewFilled: return "\u{fd34}"
        case .webexTeamsNewLight: return "\u{fd35}"
        case .webexTeamsNewRegular: return "\u{fd36}"
        case .webexTeamsRegular: return "\u{fd37}"
        case .webexTeamsRemoveBold: return "\u{fd38}"
        case .webexTeamsRemoveLight: return "\u{fd39}"
        case .webexTeamsRemoveRegular: return "\u{fd3a}"
        case .webhookBold: return "\u{fd3b}"
        case .webhookLight: return "\u{fd3c}"
        case .webhookRegular: return "\u{fd3d}"
        case .webinarBold: return "\u{fd3e}"
        case .webinarFilled: return "\u{fd3f}"
        case .webinarLight: return "\u{fd40}"
        case .webinarRegular: return "\u{fd41}"
        case .weeklyRecurringScheduleBold: return "\u{fd42}"
        case .weeklyRecurringScheduleLight: return "\u{fd43}"
        case .weeklyRecurringScheduleRegular: return "\u{fd44}"
        case .whisperAnnouncementBold: return "\u{fd45}"
        case .whisperAnnouncementFilled: return "\u{fd46}"
        case .whisperAnnouncementLight: return "\u{fd47}"
        case .whisperAnnouncementRegular: return "\u{fd48}"
        case .whisperCoachBold: return "\u{fd49}"
        case .whisperCoachFilled: return "\u{fd4a}"
        case .whisperCoachLight: return "\u{fd4b}"
        case .whisperCoachRegular: return "\u{fd4c}"
        case .whiteboardBold: return "\u{fd4d}"
        case .whiteboardContentBold: return "\u{fd4e}"
        case .whiteboardContentFilled: return "\u{fd4f}"
        case .whiteboardContentLight: return "\u{fd50}"
        case .whiteboardContentRegular: return "\u{fd51}"
        case .whiteboardFilled: return "\u{fd52}"
        case .whiteboardLight: return "\u{fd53}"
        case .whiteboardRegular: return "\u{fd54}"
        case .widgetBold: return "\u{fd55}"
        case .widgetFilled: return "\u{fd56}"
        case .widgetLight: return "\u{fd57}"
        case .widgetRegular: return "\u{fd58}"
        case .wifiBold: return "\u{fd59}"
        case .wifiErrorBold: return "\u{fd5a}"
        case .wifiErrorLight: return "\u{fd5b}"
        case .wifiErrorRegular: return "\u{fd5c}"
        case .wifiLight: return "\u{fd5d}"
        case .wifiRegular: return "\u{fd5e}"
        case .wifiSignalGoodBold: return "\u{fd5f}"
        case .wifiSignalGoodLight: return "\u{fd60}"
        case .wifiSignalGoodRegular: return "\u{fd61}"
        case .wifiSignalPoorBold: return "\u{fd62}"
        case .wifiSignalPoorLight: return "\u{fd63}"
        case .wifiSignalPoorRegular: return "\u{fd64}"
        case .wifiSignalUnstableBold: return "\u{fd65}"
        case .wifiSignalUnstableLight: return "\u{fd66}"
        case .wifiSignalUnstableRegular: return "\u{fd67}"
        case .windowCornerScrubBold: return "\u{fd68}"
        case .windowCornerScrubLight: return "\u{fd69}"
        case .windowCornerScrubRegular: return "\u{fd6a}"
        case .windowRightCornerScrubBold: return "\u{fd6b}"
        case .windowRightCornerScrubLight: return "\u{fd6c}"
        case .windowRightCornerScrubRegular: return "\u{fd6d}"
        case .windowVerticalScrubBold: return "\u{fd6e}"
        case .windowVerticalScrubLight: return "\u{fd6f}"
        case .windowVerticalScrubRegular: return "\u{fd70}"
        case .workflowDeploymentsBold: return "\u{fd71}"
        case .workflowDeploymentsFilled: return "\u{fd72}"
        case .workflowDeploymentsLight: return "\u{fd73}"
        case .workflowDeploymentsRegular: return "\u{fd74}"
        case .workphoneBold: return "\u{fd75}"
        case .workphoneLight: return "\u{fd76}"
        case .workphoneRegular: return "\u{fd77}"
        case .zoomInBold: return "\u{fd78}"
        case .zoomInLight: return "\u{fd79}"
        case .zoomInRegular: return "\u{fd7a}"
        case .zoomOutBold: return "\u{fd7b}"
        case .zoomOutLight: return "\u{fd7c}"
        case .zoomOutRegular: return "\u{fd7d}"
