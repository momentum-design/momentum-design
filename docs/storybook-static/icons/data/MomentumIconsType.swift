...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .handsetFilled: return "\u{f5fe}"
        case .handsetLight: return "\u{f5ff}"
        case .handsetMutedBold: return "\u{f600}"
        case .handsetMutedFilled: return "\u{f601}"
        case .handsetMutedLight: return "\u{f602}"
        case .handsetMutedRegular: return "\u{f603}"
        case .handsetRegular: return "\u{f604}"
        case .handshakeBold: return "\u{f605}"
        case .handshakeLight: return "\u{f606}"
        case .handshakeRegular: return "\u{f607}"
        case .headingOneBold: return "\u{f608}"
        case .headingOneLight: return "\u{f609}"
        case .headingOneRegular: return "\u{f60a}"
        case .headingThreeBold: return "\u{f60b}"
        case .headingThreeLight: return "\u{f60c}"
        case .headingThreeRegular: return "\u{f60d}"
        case .headingTwoBold: return "\u{f60e}"
        case .headingTwoLight: return "\u{f60f}"
        case .headingTwoRegular: return "\u{f610}"
        case .headphonesBold: return "\u{f611}"
        case .headphonesFilled: return "\u{f612}"
        case .headphonesLight: return "\u{f613}"
        case .headphonesMutedBold: return "\u{f614}"
        case .headphonesMutedFilled: return "\u{f615}"
        case .headphonesMutedLight: return "\u{f616}"
        case .headphonesMutedRegular: return "\u{f617}"
        case .headphonesRegular: return "\u{f618}"
        case .headsetAlertBold: return "\u{f619}"
        case .headsetAlertLight: return "\u{f61a}"
        case .headsetAlertRegular: return "\u{f61b}"
        case .headsetBold: return "\u{f61c}"
        case .headsetFilled: return "\u{f61d}"
        case .headsetLight: return "\u{f61e}"
        case .headsetMutedBold: return "\u{f61f}"
        case .headsetMutedLight: return "\u{f620}"
        case .headsetMutedRegular: return "\u{f621}"
        case .headsetPrivateBold: return "\u{f622}"
        case .headsetPrivateLight: return "\u{f623}"
        case .headsetPrivateRegular: return "\u{f624}"
        case .headsetRegular: return "\u{f625}"
        case .hearingBold: return "\u{f626}"
        case .hearingImpairedBold: return "\u{f627}"
        case .hearingImpairedLight: return "\u{f628}"
        case .hearingImpairedRegular: return "\u{f629}"
        case .hearingLight: return "\u{f62a}"
        case .hearingRegular: return "\u{f62b}"
        case .helpBold: return "\u{f62c}"
        case .helpCircleBold: return "\u{f62d}"
        case .helpCircleFilled: return "\u{f62e}"
        case .helpCircleLight: return "\u{f62f}"
        case .helpCircleRegular: return "\u{f630}"
        case .helpLight: return "\u{f631}"
        case .helpRegular: return "\u{f632}"
        case .helpdeskBold: return "\u{f633}"
        case .helpdeskFilled: return "\u{f634}"
        case .helpdeskLight: return "\u{f635}"
        case .helpdeskRegular: return "\u{f636}"
        case .hideBold: return "\u{f637}"
        case .hideFilled: return "\u{f638}"
        case .hideLight: return "\u{f639}"
        case .hideRegular: return "\u{f63a}"
        case .homeBold: return "\u{f63b}"
        case .homeFilled: return "\u{f63c}"
        case .homeLight: return "\u{f63d}"
        case .homeRegular: return "\u{f63e}"
        case .horizontalLineBold: return "\u{f63f}"
        case .horizontalLineLight: return "\u{f640}"
        case .horizontalLineRegular: return "\u{f641}"
        case .hotelingBold: return "\u{f642}"
        case .hotelingFilled: return "\u{f643}"
        case .hotelingLight: return "\u{f644}"
        case .hotelingRegular: return "\u{f645}"
        case .humidityBold: return "\u{f646}"
        case .humidityLight: return "\u{f647}"
        case .humidityRegular: return "\u{f648}"
        case .huntGroupBold: return "\u{f649}"
        case .huntGroupFilled: return "\u{f64a}"
        case .huntGroupLight: return "\u{f64b}"
        case .huntGroupRegular: return "\u{f64c}"
        case .idleBold: return "\u{f64d}"
        case .idleFilled: return "\u{f64e}"
        case .idleLight: return "\u{f64f}"
        case .idleRegular: return "\u{f650}"
        case .immediateBold: return "\u{f651}"
        case .immediateFilled: return "\u{f652}"
        case .immediateLight: return "\u{f653}"
        case .immediateRegular: return "\u{f654}"
        case .importBold: return "\u{f655}"
        case .importLight: return "\u{f656}"
        case .importRegular: return "\u{f657}"
        case .inCommonBold: return "\u{f658}"
        case .inCommonLight: return "\u{f659}"
        case .inCommonRegular: return "\u{f65a}"
        case .includeBold: return "\u{f65b}"
        case .includeLight: return "\u{f65c}"
        case .includeRegular: return "\u{f65d}"
        case .incognitoBold: return "\u{f65e}"
        case .incognitoFilled: return "\u{f65f}"
        case .incognitoLight: return "\u{f660}"
        case .incognitoRegular: return "\u{f661}"
        case .incomingCallLegacyBold: return "\u{f662}"
        case .incomingCallLegacyFilled: return "\u{f663}"
        case .incomingCallLegacyLight: return "\u{f664}"
        case .incomingCallLegacyRegular: return "\u{f665}"
        case .indentDecreaseBold: return "\u{f666}"
        case .indentDecreaseLight: return "\u{f667}"
        case .indentDecreaseRegular: return "\u{f668}"
        case .indentIncreaseBold: return "\u{f669}"
        case .indentIncreaseLight: return "\u{f66a}"
        case .indentIncreaseRegular: return "\u{f66b}"
        case .infoBadgeFilled: return "\u{f66c}"
        case .infoCircleBold: return "\u{f66d}"
        case .infoCircleFilled: return "\u{f66e}"
        case .infoCircleLight: return "\u{f66f}"
        case .infoCircleRegular: return "\u{f670}"
        case .infoCircleTwoBold: return "\u{f671}"
        case .infoCircleTwoFilled: return "\u{f672}"
        case .infoCircleTwoLight: return "\u{f673}"
        case .infoCircleTwoRegular: return "\u{f674}"
        case .inputBold: return "\u{f675}"
        case .inputDisconnectedBold: return "\u{f676}"
        case .inputDisconnectedLight: return "\u{f677}"
        case .inputDisconnectedRegular: return "\u{f678}"
        case .inputLight: return "\u{f679}"
        case .inputRegular: return "\u{f67a}"
        case .instantScheduleBold: return "\u{f67b}"
        case .instantScheduleFilled: return "\u{f67c}"
        case .instantScheduleLight: return "\u{f67d}"
        case .instantScheduleRegular: return "\u{f67e}"
        case .integrationsBold: return "\u{f67f}"
        case .integrationsLight: return "\u{f680}"
        case .integrationsRegular: return "\u{f681}"
        case .intelligentRoutingBold: return "\u{f682}"
        case .intelligentRoutingLight: return "\u{f683}"
        case .intelligentRoutingRegular: return "\u{f684}"
        case .invitedUserBold: return "\u{f685}"
        case .invitedUserLight: return "\u{f686}"
        case .invitedUserRegular: return "\u{f687}"
        case .italicBold: return "\u{f688}"
        case .italicFilled: return "\u{f689}"
        case .italicLight: return "\u{f68a}"
        case .italicRegular: return "\u{f68b}"
        case .joinAudioBold: return "\u{f68c}"
        case .joinAudioFilled: return "\u{f68d}"
        case .joinAudioLight: return "\u{f68e}"
        case .joinAudioRegular: return "\u{f68f}"
        case .keepInTouchBold: return "\u{f690}"
        case .keepInTouchFilled: return "\u{f691}"
        case .keepInTouchLight: return "\u{f692}"
        case .keepInTouchRegular: return "\u{f693}"
        case .keyboardBold: return "\u{f694}"
        case .keyboardCloseBold: return "\u{f695}"
        case .keyboardCloseLight: return "\u{f696}"
        case .keyboardCloseRegular: return "\u{f697}"
        case .keyboardLight: return "\u{f698}"
        case .keyboardRegular: return "\u{f699}"
        case .languageBold: return "\u{f69a}"
        case .languageFilled: return "\u{f69b}"
        case .languageLight: return "\u{f69c}"
        case .languageRegular: return "\u{f69d}"
        case .laptopBold: return "\u{f69e}"
        case .laptopDisconnectedBold: return "\u{f69f}"
        case .laptopDisconnectedLight: return "\u{f6a0}"
        case .laptopDisconnectedRegular: return "\u{f6a1}"
        case .laptopFilled: return "\u{f6a2}"
        case .laptopLight: return "\u{f6a3}"
        case .laptopRegular: return "\u{f6a4}"
        case .laserPointerBold: return "\u{f6a5}"
        case .laserPointerLight: return "\u{f6a6}"
        case .laserPointerRegular: return "\u{f6a7}"
        case .launchBold: return "\u{f6a8}"
        case .launchLight: return "\u{f6a9}"
        case .launchRegular: return "\u{f6aa}"
        case .layoutSideBySideVerticalBold: return "\u{f6ab}"
        case .layoutSideBySideVerticalFilled: return "\u{f6ac}"
        case .layoutSideBySideVerticalLight: return "\u{f6ad}"
        case .layoutSideBySideVerticalRegular: return "\u{f6ae}"
        case .leaveBreakoutSessionBold: return "\u{f6af}"
        case .leaveBreakoutSessionLight: return "\u{f6b0}"
        case .leaveBreakoutSessionRegular: return "\u{f6b1}"
        case .leaveDeviceBold: return "\u{f6b2}"
        case .leaveDeviceLight: return "\u{f6b3}"
        case .leaveDeviceRegular: return "\u{f6b4}"
        case .likeBold: return "\u{f6b5}"
        case .likeFilled: return "\u{f6b6}"
        case .likeLight: return "\u{f6b7}"
        case .likeRegular: return "\u{f6b8}"
        case .linkBold: return "\u{f6b9}"
        case .linkLight: return "\u{f6ba}"
        case .linkRegular: return "\u{f6bb}"
        case .listBulletedBold: return "\u{f6bc}"
        case .listBulletedLight: return "\u{f6bd}"
        case .listBulletedRegular: return "\u{f6be}"
        case .listMenuBold: return "\u{f6bf}"
        case .listMenuLight: return "\u{f6c0}"
        case .listMenuRegular: return "\u{f6c1}"
        case .listNumberedBold: return "\u{f6c2}"
        case .listNumberedLight: return "\u{f6c3}"
        case .listNumberedRegular: return "\u{f6c4}"
        case .liveBold: return "\u{f6c5}"
        case .liveFilled: return "\u{f6c6}"
        case .liveLight: return "\u{f6c7}"
        case .liveRegular: return "\u{f6c8}"
        case .locationBold: return "\u{f6c9}"
        case .locationFilled: return "\u{f6ca}"
        case .locationLight: return "\u{f6cb}"
        case .locationRegular: return "\u{f6cc}"
        case .longTextBoxBold: return "\u{f6cd}"
        case .longTextBoxLight: return "\u{f6ce}"
        case .longTextBoxRegular: return "\u{f6cf}"
        case .lowerHandBold: return "\u{f6d0}"
        case .lowerHandLight: return "\u{f6d1}"
        case .lowerHandRegular: return "\u{f6d2}"
        case .magicPenBold: return "\u{f6d3}"
        case .magicPenFilled: return "\u{f6d4}"
        case .magicPenLight: return "\u{f6d5}"
        case .magicPenRegular: return "\u{f6d6}"
        case .markAsUnreadBold: return "\u{f6d7}"
        case .markAsUnreadLight: return "\u{f6d8}"
        case .markAsUnreadRegular: return "\u{f6d9}"
        case .markdownBold: return "\u{f6da}"
        case .markdownLight: return "\u{f6db}"
        case .markdownRegular: return "\u{f6dc}"
        case .markerBold: return "\u{f6dd}"
        case .markerFilled: return "\u{f6de}"
        case .markerLight: return "\u{f6df}"
        case .markerRegular: return "\u{f6e0}"
        case .maximizeBold: return "\u{f6e1}"
        case .maximizeLight: return "\u{f6e2}"
        case .maximizeRegular: return "\u{f6e3}"
        case .mediaPlayerBold: return "\u{f6e4}"
        case .mediaPlayerLight: return "\u{f6e5}"
        case .mediaPlayerRegular: return "\u{f6e6}"
        case .mediaQualityGoodBold: return "\u{f6e7}"
        case .mediaQualityGoodFilled: return "\u{f6e8}"
        case .mediaQualityGoodLight: return "\u{f6e9}"
        case .mediaQualityGoodRegular: return "\u{f6ea}"
        case .mediaQualityPoorBold: return "\u{f6eb}"
        case .mediaQualityPoorFilled: return "\u{f6ec}"
        case .mediaQualityPoorLight: return "\u{f6ed}"
        case .mediaQualityPoorRegular: return "\u{f6ee}"
        case .mediaQualityUnstableBold: return "\u{f6ef}"
        case .mediaQualityUnstableFilled: return "\u{f6f0}"
        case .mediaQualityUnstableLight: return "\u{f6f1}"
        case .mediaQualityUnstableRegular: return "\u{f6f2}"
        case .meetBold: return "\u{f6f3}"
        case .meetEndBold: return "\u{f6f4}"
        case .meetEndLight: return "\u{f6f5}"
        case .meetEndRegular: return "\u{f6f6}"
        case .meetFilled: return "\u{f6f7}"
        case .meetLight: return "\u{f6f8}"
        case .meetRegular: return "\u{f6f9}"
        case .meetingSummaryBold: return "\u{f6fa}"
        case .meetingSummaryFilled: return "\u{f6fb}"
        case .meetingSummaryLight: return "\u{f6fc}"
        case .meetingSummaryRegular: return "\u{f6fd}"
        case .meetingsBold: return "\u{f6fe}"
        case .meetingsFilled: return "\u{f6ff}"
        case .meetingsFocusMonthBold: return "\u{f700}"
        case .meetingsFocusMonthLight: return "\u{f701}"
        case .meetingsFocusMonthRegular: return "\u{f702}"
        case .meetingsFocusOneDayBold: return "\u{f703}"
        case .meetingsFocusOneDayLight: return "\u{f704}"
        case .meetingsFocusOneDayRegular: return "\u{f705}"
        case .meetingsFocusThreeDayBold: return "\u{f706}"
        case .meetingsFocusThreeDayLight: return "\u{f707}"
        case .meetingsFocusThreeDayRegular: return "\u{f708}"
        case .meetingsFocusUpcomingBold: return "\u{f709}"
        case .meetingsFocusUpcomingLight: return "\u{f70a}"
        case .meetingsFocusUpcomingRegular: return "\u{f70b}"
        case .meetingsLight: return "\u{f70c}"
        case .meetingsPresenceBadgeFilled: return "\u{f70d}"
        case .meetingsPresenceBold: return "\u{f70e}"
        case .meetingsPresenceFilled: return "\u{f70f}"
        case .meetingsPresenceLight: return "\u{f710}"
        case .meetingsPresenceRegular: return "\u{f711}"
        case .meetingsRegular: return "\u{f712}"
        case .meetingsTeamBold: return "\u{f713}"
        case .meetingsTeamFilled: return "\u{f714}"
        case .meetingsTeamLight: return "\u{f715}"
        case .meetingsTeamNewBold: return "\u{f716}"
        case .meetingsTeamNewLight: return "\u{f717}"
        case .meetingsTeamNewRegular: return "\u{f718}"
        case .meetingsTeamRegular: return "\u{f719}"
        case .mentionBold: return "\u{f71a}"
        case .mentionLight: return "\u{f71b}"
        case .mentionRegular: return "\u{f71c}"
        case .messageQueingBold: return "\u{f71d}"
        case .messageQueingLight: return "\u{f71e}"
        case .messageQueingRegular: return "\u{f71f}"
        case .microphoneBold: return "\u{f720}"
        case .microphoneFilled: return "\u{f721}"
        case .microphoneHardMutedBold: return "\u{f722}"
        case .microphoneHardMutedCircleFilled: return "\u{f723}"
        case .microphoneHardMutedLight: return "\u{f724}"
        case .microphoneHardMutedRegular: return "\u{f725}"
        case .microphoneLight: return "\u{f726}"
        case .microphoneMusicModeBold: return "\u{f727}"
        case .microphoneMusicModeLight: return "\u{f728}"
        case .microphoneMusicModeOnBold: return "\u{f729}"
        case .microphoneMusicModeOnLight: return "\u{f72a}"
        case .microphoneMusicModeOnRegular: return "\u{f72b}"
        case .microphoneMusicModeRegular: return "\u{f72c}"
        case .microphoneMutedBold: return "\u{f72d}"
        case .microphoneMutedCircleFilled: return "\u{f72e}"
        case .microphoneMutedFilled: return "\u{f72f}"
        case .microphoneMutedLight: return "\u{f730}"
        case .microphoneMutedRegular: return "\u{f731}"
        case .microphoneOnBold: return "\u{f732}"
        case .microphoneOnLight: return "\u{f733}"
        case .microphoneOnRegular: return "\u{f734}"
        case .microphoneOptAllBold: return "\u{f735}"
        case .microphoneOptAllLight: return "\u{f736}"
        case .microphoneOptAllMutedBold: return "\u{f737}"
        case .microphoneOptAllMutedLight: return "\u{f738}"
        case .microphoneOptAllMutedRegular: return "\u{f739}"
        case .microphoneOptAllOnBold: return "\u{f73a}"
        case .microphoneOptAllOnLight: return "\u{f73b}"
        case .microphoneOptAllOnRegular: return "\u{f73c}"
        case .microphoneOptAllRegular: return "\u{f73d}"
        case .microphoneOptMeBold: return "\u{f73e}"
        case .microphoneOptMeLight: return "\u{f73f}"
        case .microphoneOptMeMutedBold: return "\u{f740}"
        case .microphoneOptMeMutedLight: return "\u{f741}"
        case .microphoneOptMeMutedRegular: return "\u{f742}"
        case .microphoneOptMeOnBold: return "\u{f743}"
        case .microphoneOptMeOnLight: return "\u{f744}"
        case .microphoneOptMeOnRegular: return "\u{f745}"
        case .microphoneOptMeRegular: return "\u{f746}"
        case .microphoneRegular: return "\u{f747}"
        case .mindMapBold: return "\u{f748}"
        case .mindMapLight: return "\u{f749}"
        case .mindMapRegular: return "\u{f74a}"
        case .minimizeBold: return "\u{f74b}"
        case .minimizeLight: return "\u{f74c}"
        case .minimizeRegular: return "\u{f74d}"
        case .minusBold: return "\u{f74e}"
        case .minusLight: return "\u{f74f}"
        case .minusRegular: return "\u{f750}"
        case .mirrorBold: return "\u{f751}"
        case .mirrorFilled: return "\u{f752}"
        case .mirrorLight: return "\u{f753}"
        case .mirrorRegular: return "\u{f754}"
        case .mmsFilled: return "\u{f755}"
        case .moderatorBold: return "\u{f756}"
        case .moderatorLight: return "\u{f757}"
        case .moderatorRegular: return "\u{f758}"
        case .monitoringBold: return "\u{f759}"
        case .monitoringLight: return "\u{f75a}"
        case .monitoringRegular: return "\u{f75b}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f75c}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f75d}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f75e}"
        case .moreAdrBold: return "\u{f75f}"
        case .moreAdrLight: return "\u{f760}"
        case .moreAdrRegular: return "\u{f761}"
        case .moreBold: return "\u{f762}"
        case .moreCircleBold: return "\u{f763}"
        case .moreCircleFilled: return "\u{f764}"
        case .moreCircleLight: return "\u{f765}"
        case .moreCircleRegular: return "\u{f766}"
        case .moreLight: return "\u{f767}"
        case .moreRegular: return "\u{f768}"
        case .mouseCursorBold: return "\u{f769}"
        case .mouseCursorLight: return "\u{f76a}"
        case .mouseCursorRegular: return "\u{f76b}"
        case .moveCallInAdrBold: return "\u{f76c}"
        case .moveCallInAdrLight: return "\u{f76d}"
        case .moveCallInAdrRegular: return "\u{f76e}"
        case .moveCallInIphBold: return "\u{f76f}"
        case .moveCallInIphLight: return "\u{f770}"
        case .moveCallInIphRegular: return "\u{f771}"
        case .moveCallInLaptopBold: return "\u{f772}"
        case .moveCallInLaptopLight: return "\u{f773}"
        case .moveCallInLaptopRegular: return "\u{f774}"
        case .moveCallInOutAdrBold: return "\u{f775}"
        case .moveCallInOutAdrLight: return "\u{f776}"
        case .moveCallInOutAdrRegular: return "\u{f777}"
        case .moveCallInOutIphBold: return "\u{f778}"
        case .moveCallInOutIphLight: return "\u{f779}"
        case .moveCallInOutIphRegular: return "\u{f77a}"
        case .moveCallInTabletBold: return "\u{f77b}"
        case .moveCallInTabletLight: return "\u{f77c}"
        case .moveCallInTabletRegular: return "\u{f77d}"
        case .moveCallOutAdrBold: return "\u{f77e}"
        case .moveCallOutAdrLight: return "\u{f77f}"
        case .moveCallOutAdrRegular: return "\u{f780}"
        case .moveCallOutIphBold: return "\u{f781}"
        case .moveCallOutIphLight: return "\u{f782}"
        case .moveCallOutIphRegular: return "\u{f783}"
        case .moveCallOutLaptopBold: return "\u{f784}"
        case .moveCallOutLaptopLight: return "\u{f785}"
        case .moveCallOutLaptopRegular: return "\u{f786}"
        case .moveCallOutTabletBold: return "\u{f787}"
        case .moveCallOutTabletLight: return "\u{f788}"
        case .moveCallOutTabletRegular: return "\u{f789}"
        case .moveToScreenBold: return "\u{f78a}"
        case .moveToScreenLight: return "\u{f78b}"
        case .moveToScreenRegular: return "\u{f78c}"
        case .multilineChartBold: return "\u{f78d}"
        case .multilineChartFilled: return "\u{f78e}"
        case .multilineChartLight: return "\u{f78f}"
        case .multilineChartRegular: return "\u{f790}"
        case .multimediaBold: return "\u{f791}"
        case .multimediaFilled: return "\u{f792}"
        case .multimediaLight: return "\u{f793}"
        case .multimediaRegular: return "\u{f794}"
        case .multipledDevicesBold: return "\u{f795}"
        case .multipledDevicesLight: return "\u{f796}"
        case .multipledDevicesRegular: return "\u{f797}"
        case .musicModeCircleBold: return "\u{f798}"
        case .musicModeCircleFilled: return "\u{f799}"
        case .musicModeCircleLight: return "\u{f79a}"
        case .musicModeCircleRegular: return "\u{f79b}"
        case .musicNoteBold: return "\u{f79c}"
        case .musicNoteFilled: return "\u{f79d}"
        case .musicNoteLight: return "\u{f79e}"
        case .musicNoteRegular: return "\u{f79f}"
        case .muteOnEntryBold: return "\u{f7a0}"
        case .muteOnEntryFilled: return "\u{f7a1}"
        case .muteOnEntryLight: return "\u{f7a2}"
        case .muteOnEntryRegular: return "\u{f7a3}"
        case .newManagerBold: return "\u{f7a4}"
        case .newManagerLight: return "\u{f7a5}"
        case .newManagerRegular: return "\u{f7a6}"
        case .newTitleBold: return "\u{f7a7}"
        case .newTitleLight: return "\u{f7a8}"
        case .newTitleRegular: return "\u{f7a9}"
        case .newVoicemailBold: return "\u{f7aa}"
        case .newVoicemailLight: return "\u{f7ab}"
        case .newVoicemailRegular: return "\u{f7ac}"
        case .newWhiteboardBold: return "\u{f7ad}"
        case .newWhiteboardLight: return "\u{f7ae}"
        case .newWhiteboardRegular: return "\u{f7af}"
        case .nextBold: return "\u{f7b0}"
        case .nextLight: return "\u{f7b1}"
        case .nextRegular: return "\u{f7b2}"
        case .noDevicesBold: return "\u{f7b3}"
        case .noDevicesLight: return "\u{f7b4}"
        case .noDevicesRegular: return "\u{f7b5}"
        case .noiseDetectedCanceledFilled: return "\u{f7b6}"
        case .noiseDetectedFilled: return "\u{f7b7}"
        case .noiseNoneCanceledFilled: return "\u{f7b8}"
        case .noiseNoneFilled: return "\u{f7b9}"
        case .noiseRemovalBold: return "\u{f7ba}"
        case .noiseRemovalLight: return "\u{f7bb}"
        case .noiseRemovalRegular: return "\u{f7bc}"
        case .noteBold: return "\u{f7bd}"
        case .noteLight: return "\u{f7be}"
        case .notePptBold: return "\u{f7bf}"
        case .notePptLight: return "\u{f7c0}"
        case .notePptRegular: return "\u{f7c1}"
        case .noteRegular: return "\u{f7c2}"
        case .notesBold: return "\u{f7c3}"
        case .notesFilled: return "\u{f7c4}"
        case .notesLight: return "\u{f7c5}"
        case .notesRegular: return "\u{f7c6}"
        case .numberBold: return "\u{f7c7}"
        case .numberLight: return "\u{f7c8}"
        case .numberRegular: return "\u{f7c9}"
        case .oldRemoteBold: return "\u{f7ca}"
        case .oldRemoteLight: return "\u{f7cb}"
        case .oldRemoteRegular: return "\u{f7cc}"
        case .oldTouchBold: return "\u{f7cd}"
        case .oldTouchLight: return "\u{f7ce}"
        case .oldTouchRegular: return "\u{f7cf}"
        case .oneColumnBold: return "\u{f7d0}"
        case .oneColumnLight: return "\u{f7d1}"
        case .oneColumnRegular: return "\u{f7d2}"
        case .oneTimeBold: return "\u{f7d3}"
        case .oneTimeLight: return "\u{f7d4}"
        case .oneTimeRegular: return "\u{f7d5}"
        case .openInFolderBold: return "\u{f7d6}"
        case .openInFolderLight: return "\u{f7d7}"
        case .openInFolderRegular: return "\u{f7d8}"
        case .openPagesBold: return "\u{f7d9}"
        case .openPagesLight: return "\u{f7da}"
        case .openPagesRegular: return "\u{f7db}"
        case .otherNumberBold: return "\u{f7dc}"
        case .otherNumberFilled: return "\u{f7dd}"
        case .otherNumberLight: return "\u{f7de}"
        case .otherNumberRegular: return "\u{f7df}"
        case .otherNumberWarningBold: return "\u{f7e0}"
        case .otherNumberWarningLight: return "\u{f7e1}"
        case .otherNumberWarningRegular: return "\u{f7e2}"
        case .outgoingCallLegacyBold: return "\u{f7e3}"
        case .outgoingCallLegacyFilled: return "\u{f7e4}"
        case .outgoingCallLegacyLight: return "\u{f7e5}"
        case .outgoingCallLegacyRegular: return "\u{f7e6}"
        case .overflowLeftBold: return "\u{f7e7}"
        case .overflowLeftLight: return "\u{f7e8}"
        case .overflowLeftRegular: return "\u{f7e9}"
        case .overflowRightBold: return "\u{f7ea}"
        case .overflowRightLight: return "\u{f7eb}"
        case .overflowRightRegular: return "\u{f7ec}"
        case .pairedCameraBold: return "\u{f7ed}"
        case .pairedCameraLight: return "\u{f7ee}"
        case .pairedCameraRegular: return "\u{f7ef}"
        case .pairedDeviceBold: return "\u{f7f0}"
        case .pairedDeviceLight: return "\u{f7f1}"
        case .pairedDeviceRegular: return "\u{f7f2}"
        case .pairedHandsetBold: return "\u{f7f3}"
        case .pairedHandsetLight: return "\u{f7f4}"
        case .pairedHandsetRegular: return "\u{f7f5}"
        case .pairingBold: return "\u{f7f6}"
        case .pairingLight: return "\u{f7f7}"
        case .pairingRegular: return "\u{f7f8}"
        case .parkedBold: return "\u{f7f9}"
        case .parkedFilled: return "\u{f7fa}"
        case .parkedLight: return "\u{f7fb}"
        case .parkedRegular: return "\u{f7fc}"
        case .parseBold: return "\u{f7fd}"
        case .parseLight: return "\u{f7fe}"
        case .parseRegular: return "\u{f7ff}"
        case .partialBold: return "\u{f800}"
        case .partialLight: return "\u{f801}"
        case .partialRegular: return "\u{f802}"
        case .participantAddBold: return "\u{f803}"
        case .participantAddLight: return "\u{f804}"
        case .participantAddRegular: return "\u{f805}"
        case .participantBlockedBold: return "\u{f806}"
        case .participantBlockedLight: return "\u{f807}"
        case .participantBlockedRegular: return "\u{f808}"
        case .participantBold: return "\u{f809}"
        case .participantFilled: return "\u{f80a}"
        case .participantLight: return "\u{f80b}"
        case .participantListBold: return "\u{f80c}"
        case .participantListFilled: return "\u{f80d}"
        case .participantListLight: return "\u{f80e}"
        case .participantListRegular: return "\u{f80f}"
        case .participantRegular: return "\u{f810}"
        case .participantRemoveBold: return "\u{f811}"
        case .participantRemoveLight: return "\u{f812}"
        case .participantRemoveRegular: return "\u{f813}"
        case .participantUnknownBold: return "\u{f814}"
        case .participantUnknownLight: return "\u{f815}"
        case .participantUnknownRegular: return "\u{f816}"
        case .passMouseBold: return "\u{f817}"
        case .passMouseLight: return "\u{f818}"
        case .passMouseRegular: return "\u{f819}"
        case .pauseBadgeFilled: return "\u{f81a}"
        case .pauseBold: return "\u{f81b}"
        case .pauseFilled: return "\u{f81c}"
        case .pauseLight: return "\u{f81d}"
        case .pauseRegular: return "\u{f81e}"
        case .peopleAddBold: return "\u{f81f}"
        case .peopleAddFilled: return "\u{f820}"
        case .peopleAddLight: return "\u{f821}"
        case .peopleAddRegular: return "\u{f822}"
        case .peopleBold: return "\u{f823}"
        case .peopleCircleBold: return "\u{f824}"
        case .peopleCircleFilled: return "\u{f825}"
        case .peopleCircleLight: return "\u{f826}"
        case .peopleCircleRegular: return "\u{f827}"
        case .peopleFilled: return "\u{f828}"
        case .peopleInsightsBold: return "\u{f829}"
        case .peopleInsightsFilled: return "\u{f82a}"
        case .peopleInsightsLight: return "\u{f82b}"
        case .peopleInsightsRegular: return "\u{f82c}"
        case .peopleLight: return "\u{f82d}"
        case .peopleRegular: return "\u{f82e}"
        case .phoneAlertBold: return "\u{f82f}"
        case .phoneAlertLight: return "\u{f830}"
        case .phoneAlertRegular: return "\u{f831}"
        case .phoneBadgeFilled: return "\u{f832}"
        case .phoneBold: return "\u{f833}"
        case .phoneFilled: return "\u{f834}"
        case .phoneLight: return "\u{f835}"
        case .phoneMutedBold: return "\u{f836}"
        case .phoneMutedLight: return "\u{f837}"
        case .phoneMutedRegular: return "\u{f838}"
        case .phonePrivateBold: return "\u{f839}"
        case .phonePrivateLight: return "\u{f83a}"
        case .phonePrivateRegular: return "\u{f83b}"
        case .phoneRegular: return "\u{f83c}"
        case .phoneReplyAllBold: return "\u{f83d}"
        case .phoneReplyAllLight: return "\u{f83e}"
        case .phoneReplyAllRegular: return "\u{f83f}"
        case .phoneReplyBold: return "\u{f840}"
        case .phoneReplyLight: return "\u{f841}"
        case .phoneReplyRegular: return "\u{f842}"
        case .pickerBold: return "\u{f843}"
        case .pickerLight: return "\u{f844}"
        case .pickerRegular: return "\u{f845}"
        case .pieChartBold: return "\u{f846}"
        case .pieChartFilled: return "\u{f847}"
        case .pieChartLight: return "\u{f848}"
        case .pieChartRegular: return "\u{f849}"
        case .pinBold: return "\u{f84a}"
        case .pinFilled: return "\u{f84b}"
        case .pinLight: return "\u{f84c}"
        case .pinListActivityBold: return "\u{f84d}"
        case .pinListActivityLight: return "\u{f84e}"
        case .pinListActivityRegular: return "\u{f84f}"
        case .pinListBold: return "\u{f850}"
        case .pinListLight: return "\u{f851}"
        case .pinListRegular: return "\u{f852}"
        case .pinMutedBold: return "\u{f853}"
        case .pinMutedFilled: return "\u{f854}"
        case .pinMutedLight: return "\u{f855}"
        case .pinMutedRegular: return "\u{f856}"
        case .pinRegular: return "\u{f857}"
        case .pipBold: return "\u{f858}"
        case .pipEnterBold: return "\u{f859}"
        case .pipEnterLight: return "\u{f85a}"
        case .pipEnterRegular: return "\u{f85b}"
        case .pipExitBold: return "\u{f85c}"
        case .pipExitLight: return "\u{f85d}"
        case .pipExitRegular: return "\u{f85e}"
        case .pipFilled: return "\u{f85f}"
        case .pipLight: return "\u{f860}"
        case .pipRegular: return "\u{f861}"
        case .placeholderBold: return "\u{f862}"
        case .placeholderFilled: return "\u{f863}"
        case .placeholderLight: return "\u{f864}"
        case .placeholderRegular: return "\u{f865}"
        case .playBold: return "\u{f866}"
        case .playCircleBold: return "\u{f867}"
        case .playCircleFilled: return "\u{f868}"
        case .playCircleLight: return "\u{f869}"
        case .playCircleRegular: return "\u{f86a}"
        case .playFilled: return "\u{f86b}"
        case .playLight: return "\u{f86c}"
        case .playRegular: return "\u{f86d}"
        case .plugAcBold: return "\u{f86e}"
        case .plugAcLight: return "\u{f86f}"
        case .plugAcRegular: return "\u{f870}"
        case .plusBold: return "\u{f871}"
        case .plusCircleBold: return "\u{f872}"
        case .plusCircleFilled: return "\u{f873}"
        case .plusCircleLight: return "\u{f874}"
        case .plusCircleRegular: return "\u{f875}"
        case .plusLight: return "\u{f876}"
        case .plusRegular: return "\u{f877}"
        case .pmrBold: return "\u{f878}"
        case .pmrFilled: return "\u{f879}"
        case .pmrLight: return "\u{f87a}"
        case .pmrRegular: return "\u{f87b}"
        case .pollBold: return "\u{f87c}"
        case .pollFilled: return "\u{f87d}"
        case .pollLight: return "\u{f87e}"
        case .pollRegular: return "\u{f87f}"
        case .popInBold: return "\u{f880}"
        case .popInLight: return "\u{f881}"
        case .popInRegular: return "\u{f882}"
        case .popOutBold: return "\u{f883}"
        case .popOutLight: return "\u{f884}"
        case .popOutRegular: return "\u{f885}"
        case .popUpBold: return "\u{f886}"
        case .popUpLight: return "\u{f887}"
        case .popUpRegular: return "\u{f888}"
        case .portraitLandscapeBold: return "\u{f889}"
        case .portraitLandscapeLight: return "\u{f88a}"
        case .portraitLandscapeRegular: return "\u{f88b}"
        case .powerAcBold: return "\u{f88c}"
        case .powerAcLight: return "\u{f88d}"
        case .powerAcRegular: return "\u{f88e}"
        case .powerBold: return "\u{f88f}"
        case .powerLight: return "\u{f890}"
        case .powerRegular: return "\u{f891}"
        case .preHeaderBold: return "\u{f892}"
        case .preHeaderLight: return "\u{f893}"
        case .preHeaderRegular: return "\u{f894}"
        case .premiumBold: return "\u{f895}"
        case .premiumLight: return "\u{f896}"
        case .premiumRegular: return "\u{f897}"
        case .presentationBold: return "\u{f898}"
        case .presentationLight: return "\u{f899}"
        case .presentationRegular: return "\u{f89a}"
        case .preventDownloadBold: return "\u{f89b}"
        case .preventDownloadFilled: return "\u{f89c}"
        case .preventDownloadLight: return "\u{f89d}"
        case .preventDownloadRegular: return "\u{f89e}"
        case .primaryParticipantBold: return "\u{f89f}"
        case .primaryParticipantLight: return "\u{f8a0}"
        case .primaryParticipantRegular: return "\u{f8a1}"
        case .printBold: return "\u{f8a2}"
        case .printLight: return "\u{f8a3}"
        case .printRegular: return "\u{f8a4}"
        case .priorityBadgeFilled: return "\u{f8a5}"
        case .priorityCircleBold: return "\u{f8a6}"
        case .priorityCircleFilled: return "\u{f8a7}"
        case .priorityCircleLight: return "\u{f8a8}"
        case .priorityCircleRegular: return "\u{f8a9}"
        case .priorityCircleTwoBold: return "\u{f8aa}"
        case .priorityCircleTwoFilled: return "\u{f8ab}"
        case .priorityCircleTwoLight: return "\u{f8ac}"
        case .priorityCircleTwoRegular: return "\u{f8ad}"
        case .priorityWaveBold: return "\u{f8ae}"
        case .priorityWaveLight: return "\u{f8af}"
        case .priorityWaveRegular: return "\u{f8b0}"
        case .privacyCircleBold: return "\u{f8b1}"
        case .privacyCircleFilled: return "\u{f8b2}"
        case .privacyCircleLight: return "\u{f8b3}"
        case .privacyCircleRegular: return "\u{f8b4}"
        case .privateBold: return "\u{f8b5}"
        case .privateCircleBold: return "\u{f8b6}"
        case .privateCircleFilled: return "\u{f8b7}"
        case .privateCircleLight: return "\u{f8b8}"
        case .privateCircleRegular: return "\u{f8b9}"
        case .privateLight: return "\u{f8ba}"
        case .privateMeetingBold: return "\u{f8bb}"
        case .privateMeetingLight: return "\u{f8bc}"
        case .privateMeetingRegular: return "\u{f8bd}"
        case .privateRegular: return "\u{f8be}"
        case .productDemoBold: return "\u{f8bf}"
        case .productDemoLight: return "\u{f8c0}"
        case .productDemoRegular: return "\u{f8c1}"
        case .proximityBold: return "\u{f8c2}"
        case .proximityLight: return "\u{f8c3}"
        case .proximityMutedBold: return "\u{f8c4}"
        case .proximityMutedLight: return "\u{f8c5}"
        case .proximityMutedRegular: return "\u{f8c6}"
        case .proximityRegular: return "\u{f8c7}"
        case .proximityVideoBold: return "\u{f8c8}"
        case .proximityVideoLight: return "\u{f8c9}"
        case .proximityVideoRegular: return "\u{f8ca}"
        case .ptoPresenceBold: return "\u{f8cb}"
        case .ptoPresenceFilled: return "\u{f8cc}"
        case .ptoPresenceLight: return "\u{f8cd}"
        case .ptoPresenceRegular: return "\u{f8ce}"
        case .pullCallBold: return "\u{f8cf}"
        case .pullCallFilled: return "\u{f8d0}"
        case .pullCallLight: return "\u{f8d1}"
        case .pullCallRegular: return "\u{f8d2}"
        case .qABold: return "\u{f8d3}"
        case .qALight: return "\u{f8d4}"
        case .qARegular: return "\u{f8d5}"
        case .qrCodeBold: return "\u{f8d6}"
        case .qrCodeLight: return "\u{f8d7}"
        case .qrCodeRegular: return "\u{f8d8}"
        case .qrCodeScanBold: return "\u{f8d9}"
        case .qrCodeScanLight: return "\u{f8da}"
        case .qrCodeScanRegular: return "\u{f8db}"
        case .qualityBold: return "\u{f8dc}"
        case .qualityLight: return "\u{f8dd}"
        case .qualityRegular: return "\u{f8de}"
        case .queueContactBold: return "\u{f8df}"
        case .queueContactFilled: return "\u{f8e0}"
        case .queueContactLight: return "\u{f8e1}"
        case .queueContactRegular: return "\u{f8e2}"
        case .quietBold: return "\u{f8e3}"
        case .quietHoursPresenceBold: return "\u{f8e4}"
        case .quietHoursPresenceFilled: return "\u{f8e5}"
        case .quietHoursPresenceLight: return "\u{f8e6}"
        case .quietHoursPresenceRegular: return "\u{f8e7}"
        case .quietLight: return "\u{f8e8}"
        case .quietRegular: return "\u{f8e9}"
        case .radioButtonGroupBold: return "\u{f8ea}"
        case .radioButtonGroupLight: return "\u{f8eb}"
        case .radioButtonGroupRegular: return "\u{f8ec}"
        case .raiseHandBold: return "\u{f8ed}"
        case .raiseHandCircleFilled: return "\u{f8ee}"
        case .raiseHandFilled: return "\u{f8ef}"
        case .raiseHandLight: return "\u{f8f0}"
        case .raiseHandRegular: return "\u{f8f1}"
        case .ramBold: return "\u{f8f2}"
        case .ramLight: return "\u{f8f3}"
        case .ramRegular: return "\u{f8f4}"
        case .reactionsBold: return "\u{f8f5}"
        case .reactionsFilled: return "\u{f8f6}"
        case .reactionsLight: return "\u{f8f7}"
        case .reactionsRegular: return "\u{f8f8}"
        case .reactivateBold: return "\u{f8f9}"
        case .reactivateLight: return "\u{f8fa}"
        case .reactivateRegular: return "\u{f8fb}"
        case .receiveVoiceBold: return "\u{f8fc}"
        case .receiveVoiceFilled: return "\u{f8fd}"
        case .receiveVoiceLight: return "\u{f8fe}"
        case .receiveVoiceRegular: return "\u{f8ff}"
        case .recentsBold: return "\u{f900}"
        case .recentsFilled: return "\u{f901}"
        case .recentsLight: return "\u{f902}"
        case .recentsPresenceBadgeFilled: return "\u{f903}"
        case .recentsPresenceBold: return "\u{f904}"
        case .recentsPresenceFilled: return "\u{f905}"
        case .recentsPresenceLight: return "\u{f906}"
        case .recentsPresenceRegular: return "\u{f907}"
        case .recentsRegular: return "\u{f908}"
        case .recordActiveBadgeFilled: return "\u{f909}"
        case .recordActiveBold: return "\u{f90a}"
        case .recordActiveFilled: return "\u{f90b}"
        case .recordActiveLight: return "\u{f90c}"
        case .recordActiveRegular: return "\u{f90d}"
        case .recordBold: return "\u{f90e}"
        case .recordFilled: return "\u{f90f}"
        case .recordLight: return "\u{f910}"
        case .recordPausedBadgeFilled: return "\u{f911}"
        case .recordPausedBold: return "\u{f912}"
        case .recordPausedFilled: return "\u{f913}"
        case .recordPausedLight: return "\u{f914}"
        case .recordPausedRegular: return "\u{f915}"
        case .recordRegular: return "\u{f916}"
        case .recurringBold: return "\u{f917}"
        case .recurringLight: return "\u{f918}"
        case .recurringOffBold: return "\u{f919}"
        case .recurringOffLight: return "\u{f91a}"
        case .recurringOffRegular: return "\u{f91b}"
        case .recurringRegular: return "\u{f91c}"
        ...
        case .smartAudioBold: return "\u{fa37}"
        case .smartAudioLight: return "\u{fa38}"
        case .smartAudioRegular: return "\u{fa39}"
        case .smsFilled: return "\u{fa3a}"
        case .smsInboundBold: return "\u{fa3b}"
        case .smsInboundLight: return "\u{fa3c}"
        case .smsInboundRegular: return "\u{fa3d}"
        case .smsMessageBold: return "\u{fa3e}"
        case .smsMessageFilled: return "\u{fa3f}"
        case .smsMessageLight: return "\u{fa40}"
        case .smsMessageRegular: return "\u{fa41}"
        case .smsOutgoingFilled: return "\u{fa42}"
        case .smsUnreadBold: return "\u{fa43}"
        case .smsUnreadLight: return "\u{fa44}"
        case .smsUnreadRegular: return "\u{fa45}"
        case .sortAscendingBold: return "\u{fa46}"
        case .sortAscendingLight: return "\u{fa47}"
        case .sortAscendingRegular: return "\u{fa48}"
        case .sortDescendingBold: return "\u{fa49}"
        case .sortDescendingLight: return "\u{fa4a}"
        case .sortDescendingRegular: return "\u{fa4b}"
        case .soundDefaultBold: return "\u{fa4c}"
        case .soundDefaultLight: return "\u{fa4d}"
        case .soundDefaultRegular: return "\u{fa4e}"
        case .sparkleBold: return "\u{fa4f}"
        case .sparkleFilled: return "\u{fa50}"
        case .sparkleLight: return "\u{fa51}"
        case .sparkleRegular: return "\u{fa52}"
        case .speakerBold: return "\u{fa53}"
        case .speakerDisconnectedBold: return "\u{fa54}"
        case .speakerDisconnectedFilled: return "\u{fa55}"
        case .speakerDisconnectedLight: return "\u{fa56}"
        case .speakerDisconnectedRegular: return "\u{fa57}"
        case .speakerFilled: return "\u{fa58}"
        case .speakerLight: return "\u{fa59}"
        case .speakerMutedBold: return "\u{fa5a}"
        case .speakerMutedFilled: return "\u{fa5b}"
        case .speakerMutedLight: return "\u{fa5c}"
        case .speakerMutedRegular: return "\u{fa5d}"
        case .speakerOffBold: return "\u{fa5e}"
        case .speakerOffFilled: return "\u{fa5f}"
        case .speakerOffLight: return "\u{fa60}"
        case .speakerOffRegular: return "\u{fa61}"
        case .speakerOnBold: return "\u{fa62}"
        case .speakerOnLight: return "\u{fa63}"
        case .speakerOnRegular: return "\u{fa64}"
        case .speakerRegular: return "\u{fa65}"
        case .speakerTurnDownBold: return "\u{fa66}"
        case .speakerTurnDownFilled: return "\u{fa67}"
        case .speakerTurnDownLight: return "\u{fa68}"
        case .speakerTurnDownRegular: return "\u{fa69}"
        case .speakerTurnUpBold: return "\u{fa6a}"
        case .speakerTurnUpFilled: return "\u{fa6b}"
        case .speakerTurnUpLight: return "\u{fa6c}"
        case .speakerTurnUpRegular: return "\u{fa6d}"
        case .speedDialBold: return "\u{fa6e}"
        case .speedDialFilled: return "\u{fa6f}"
        case .speedDialLight: return "\u{fa70}"
        case .speedDialRegular: return "\u{fa71}"
        case .spellCheckerBold: return "\u{fa72}"
        case .spellCheckerLight: return "\u{fa73}"
        case .spellCheckerRegular: return "\u{fa74}"
        case .spinnerBold: return "\u{fa75}"
        case .spinnerInProgressBold: return "\u{fa76}"
        case .spinnerInProgressLight: return "\u{fa77}"
        case .spinnerInProgressRegular: return "\u{fa78}"
        case .spinnerLight: return "\u{fa79}"
        case .spinnerRegular: return "\u{fa7a}"
        case .splitViewBold: return "\u{fa7b}"
        case .splitViewLight: return "\u{fa7c}"
        case .splitViewRegular: return "\u{fa7d}"
        case .stackedAreaChartBold: return "\u{fa7e}"
        case .stackedAreaChartFilled: return "\u{fa7f}"
        case .stackedAreaChartFullBold: return "\u{fa80}"
        case .stackedAreaChartFullFilled: return "\u{fa81}"
        case .stackedAreaChartFullLight: return "\u{fa82}"
        case .stackedAreaChartFullRegular: return "\u{fa83}"
        case .stackedAreaChartLight: return "\u{fa84}"
        case .stackedAreaChartRegular: return "\u{fa85}"
        case .stackedBarChartBold: return "\u{fa86}"
        case .stackedBarChartFilled: return "\u{fa87}"
        case .stackedBarChartFullBold: return "\u{fa88}"
        case .stackedBarChartFullFilled: return "\u{fa89}"
        case .stackedBarChartFullLight: return "\u{fa8a}"
        case .stackedBarChartFullRegular: return "\u{fa8b}"
        case .stackedBarChartLight: return "\u{fa8c}"
        case .stackedBarChartRegular: return "\u{fa8d}"
        case .startChatBold: return "\u{fa8e}"
        case .startChatLight: return "\u{fa8f}"
        case .startChatRegular: return "\u{fa90}"
        case .stethoscopeBold: return "\u{fa91}"
        case .stethoscopeLight: return "\u{fa92}"
        case .stethoscopeRegular: return "\u{fa93}"
        case .stickersBold: return "\u{fa94}"
        case .stickersLight: return "\u{fa95}"
        case .stickersRegular: return "\u{fa96}"
        case .stickiesBold: return "\u{fa97}"
        case .stickiesLight: return "\u{fa98}"
        case .stickiesRegular: return "\u{fa99}"
        case .stopBold: return "\u{fa9a}"
        case .stopCircleBold: return "\u{fa9b}"
        case .stopCircleFilled: return "\u{fa9c}"
        case .stopCircleLight: return "\u{fa9d}"
        case .stopCircleRegular: return "\u{fa9e}"
        case .stopContentShareBold: return "\u{fa9f}"
        case .stopContentShareLight: return "\u{faa0}"
        case .stopContentShareRegular: return "\u{faa1}"
        case .stopFilled: return "\u{faa2}"
        case .stopLight: return "\u{faa3}"
        case .stopRegular: return "\u{faa4}"
        case .storedInfoBold: return "\u{faa5}"
        case .storedInfoFilled: return "\u{faa6}"
        case .storedInfoLight: return "\u{faa7}"
        case .storedInfoRegular: return "\u{faa8}"
        case .streamingBold: return "\u{faa9}"
        case .streamingLight: return "\u{faaa}"
        case .streamingRegular: return "\u{faab}"
        case .strikethroughBold: return "\u{faac}"
        case .strikethroughFilled: return "\u{faad}"
        case .strikethroughLight: return "\u{faae}"
        case .strikethroughRegular: return "\u{faaf}"
        case .studioModeBold: return "\u{fab0}"
        case .studioModeLight: return "\u{fab1}"
        case .studioModeRegular: return "\u{fab2}"
        case .subscriptBold: return "\u{fab3}"
        case .subscriptLight: return "\u{fab4}"
        case .subscriptRegular: return "\u{fab5}"
        case .superscriptBold: return "\u{fab6}"
        case .superscriptLight: return "\u{fab7}"
        case .superscriptRegular: return "\u{fab8}"
        case .surveyBold: return "\u{fab9}"
        case .surveyFilled: return "\u{faba}"
        case .surveyLight: return "\u{fabb}"
        case .surveyRegular: return "\u{fabc}"
        case .sxEightyCodecBold: return "\u{fabd}"
        case .sxEightyCodecLight: return "\u{fabe}"
        case .sxEightyCodecRegular: return "\u{fabf}"
        case .sxTenBold: return "\u{fac0}"
        case .sxTenLight: return "\u{fac1}"
        case .sxTenRegular: return "\u{fac2}"
        case .sxTwentyBold: return "\u{fac3}"
        case .sxTwentyLight: return "\u{fac4}"
        case .sxTwentyRegular: return "\u{fac5}"
        case .tableBold: return "\u{fac6}"
        case .tableLight: return "\u{fac7}"
        case .tableRegular: return "\u{fac8}"
        case .tabletBold: return "\u{fac9}"
        case .tabletLight: return "\u{faca}"
        case .tabletRegular: return "\u{facb}"
        case .tabsBold: return "\u{facc}"
        case .tabsLight: return "\u{facd}"
        case .tabsRegular: return "\u{face}"
        case .tagBold: return "\u{facf}"
        case .tagLight: return "\u{fad0}"
        case .tagRegular: return "\u{fad1}"
        case .tapBold: return "\u{fad2}"
        case .tapFilled: return "\u{fad3}"
        case .tapLight: return "\u{fad4}"
        case .tapRegular: return "\u{fad5}"
        case .telepresenceAlertBold: return "\u{fad6}"
        case .telepresenceAlertLight: return "\u{fad7}"
        case .telepresenceAlertMutedBold: return "\u{fad8}"
        case .telepresenceAlertMutedLight: return "\u{fad9}"
        case .telepresenceAlertMutedRegular: return "\u{fada}"
        case .telepresenceAlertRegular: return "\u{fadb}"
        case .telepresenceBold: return "\u{fadc}"
        case .telepresenceIxFiveThousandBold: return "\u{fadd}"
        case .telepresenceIxFiveThousandLight: return "\u{fade}"
        case .telepresenceIxFiveThousandRegular: return "\u{fadf}"
        case .telepresenceLight: return "\u{fae0}"
        case .telepresenceMutedBold: return "\u{fae1}"
        case .telepresenceMutedLight: return "\u{fae2}"
        case .telepresenceMutedRegular: return "\u{fae3}"
        case .telepresencePrivateBold: return "\u{fae4}"
        case .telepresencePrivateLight: return "\u{fae5}"
        case .telepresencePrivateRegular: return "\u{fae6}"
        case .telepresenceRegular: return "\u{fae7}"
        case .temperatureBold: return "\u{fae8}"
        case .temperatureLight: return "\u{fae9}"
        case .temperatureRegular: return "\u{faea}"
        case .testTubeBold: return "\u{faeb}"
        case .testTubeFilled: return "\u{faec}"
        case .testTubeLight: return "\u{faed}"
        case .testTubeRegular: return "\u{faee}"
        case .textAlignCenterBold: return "\u{faef}"
        case .textAlignCenterFilled: return "\u{faf0}"
        case .textAlignCenterLight: return "\u{faf1}"
        case .textAlignCenterRegular: return "\u{faf2}"
        case .textAlignLeftBold: return "\u{faf3}"
        case .textAlignLeftFilled: return "\u{faf4}"
        case .textAlignLeftLight: return "\u{faf5}"
        case .textAlignLeftRegular: return "\u{faf6}"
        case .textAlignRightBold: return "\u{faf7}"
        case .textAlignRightFilled: return "\u{faf8}"
        case .textAlignRightLight: return "\u{faf9}"
        case .textAlignRightRegular: return "\u{fafa}"
        case .textBold: return "\u{fafb}"
        case .textBoxCursorLight: return "\u{fafc}"
        case .textCodeBlockBold: return "\u{fafd}"
        case .textCodeBlockLight: return "\u{fafe}"
        case .textCodeBlockRegular: return "\u{faff}"
        case .textHighlightBold: return "\u{fb00}"
        case .textHighlightFilled: return "\u{fb01}"
        case .textHighlightLight: return "\u{fb02}"
        case .textHighlightRegular: return "\u{fb03}"
        case .textLight: return "\u{fb04}"
        case .textRegular: return "\u{fb05}"
        case .threeColumnBold: return "\u{fb06}"
        case .threeColumnLight: return "\u{fb07}"
        case .threeColumnRegular: return "\u{fb08}"
        case .threeDObjectBold: return "\u{fb09}"
        case .threeDObjectLight: return "\u{fb0a}"
        case .threeDObjectRegular: return "\u{fb0b}"
        case .timeExclusionBold: return "\u{fb0c}"
        case .timeExclusionLight: return "\u{fb0d}"
        case .timeExclusionRegular: return "\u{fb0e}"
        case .tooFastBold: return "\u{fb0f}"
        case .tooFastLight: return "\u{fb10}"
        case .tooFastRegular: return "\u{fb11}"
        case .tooSlowBold: return "\u{fb12}"
        case .tooSlowLight: return "\u{fb13}"
        case .tooSlowRegular: return "\u{fb14}"
        case .toolsBold: return "\u{fb15}"
        case .toolsFilled: return "\u{fb16}"
        case .toolsLight: return "\u{fb17}"
        case .toolsRegular: return "\u{fb18}"
        case .touchTenBold: return "\u{fb19}"
        case .touchTenLight: return "\u{fb1a}"
        case .touchTenRegular: return "\u{fb1b}"
        case .transcriptBold: return "\u{fb1c}"
        case .transcriptFilled: return "\u{fb1d}"
        case .transcriptLight: return "\u{fb1e}"
        case .transcriptRegular: return "\u{fb1f}"
        case .translateBold: return "\u{fb20}"
        case .translateLight: return "\u{fb21}"
        case .translateRegular: return "\u{fb22}"
        case .translateUndoBold: return "\u{fb23}"
        case .translateUndoLight: return "\u{fb24}"
        case .translateUndoRegular: return "\u{fb25}"
        case .trendingBold: return "\u{fb26}"
        case .trendingDownBold: return "\u{fb27}"
        case .trendingDownFilled: return "\u{fb28}"
        case .trendingDownLight: return "\u{fb29}"
        case .trendingDownRegular: return "\u{fb2a}"
        case .trendingFilled: return "\u{fb2b}"
        case .trendingLight: return "\u{fb2c}"
        case .trendingRegular: return "\u{fb2d}"
        case .trimBold: return "\u{fb2e}"
        case .trimLight: return "\u{fb2f}"
        case .trimRegular: return "\u{fb30}"
        case .twoColumnBold: return "\u{fb31}"
        case .twoColumnLight: return "\u{fb32}"
        case .twoColumnRegular: return "\u{fb33}"
        case .twoWayVoiceStreamBold: return "\u{fb34}"
        case .twoWayVoiceStreamFilled: return "\u{fb35}"
        case .twoWayVoiceStreamLight: return "\u{fb36}"
        case .twoWayVoiceStreamRegular: return "\u{fb37}"
        case .ucmCloudBold: return "\u{fb38}"
        case .ucmCloudLight: return "\u{fb39}"
        case .ucmCloudRegular: return "\u{fb3a}"
        case .underlineBold: return "\u{fb3b}"
        case .underlineFilled: return "\u{fb3c}"
        case .underlineLight: return "\u{fb3d}"
        case .underlineRegular: return "\u{fb3e}"
        case .undoBold: return "\u{fb3f}"
        case .undoLight: return "\u{fb40}"
        case .undoRegular: return "\u{fb41}"
        case .unlinkBold: return "\u{fb42}"
        case .unlinkLight: return "\u{fb43}"
        case .unlinkRegular: return "\u{fb44}"
        case .unreadBold: return "\u{fb45}"
        case .unreadFilled: return "\u{fb46}"
        case .unreadLight: return "\u{fb47}"
        case .unreadRegular: return "\u{fb48}"
        case .unsecureUnlockedBold: return "\u{fb49}"
        case .unsecureUnlockedFilled: return "\u{fb4a}"
        case .unsecureUnlockedLight: return "\u{fb4b}"
        case .unsecureUnlockedRegular: return "\u{fb4c}"
        case .unsortedBold: return "\u{fb4d}"
        case .unsortedLight: return "\u{fb4e}"
        case .unsortedRegular: return "\u{fb4f}"
        case .updateFileShareBold: return "\u{fb50}"
        case .updateFileShareLight: return "\u{fb51}"
        case .updateFileShareRegular: return "\u{fb52}"
        case .uploadBold: return "\u{fb53}"
        case .uploadImageBold: return "\u{fb54}"
        case .uploadImageLight: return "\u{fb55}"
        case .uploadImageRegular: return "\u{fb56}"
        case .uploadLight: return "\u{fb57}"
        case .uploadRegular: return "\u{fb58}"
        case .urgentVoicemailBold: return "\u{fb59}"
        case .urgentVoicemailFilled: return "\u{fb5a}"
        case .usbBold: return "\u{fb5b}"
        case .usbHeadsetBold: return "\u{fb5c}"
        case .usbHeadsetLight: return "\u{fb5d}"
        case .usbHeadsetMutedBold: return "\u{fb5e}"
        case .usbHeadsetMutedLight: return "\u{fb5f}"
        case .usbHeadsetMutedRegular: return "\u{fb60}"
        case .usbHeadsetRegular: return "\u{fb61}"
        case .usbLight: return "\u{fb62}"
        case .usbRegular: return "\u{fb63}"
        case .userBold: return "\u{fb64}"
        case .userDeactivateBold: return "\u{fb65}"
        case .userDeactivateLight: return "\u{fb66}"
        case .userDeactivateRegular: return "\u{fb67}"
        case .userLight: return "\u{fb68}"
        case .userRegular: return "\u{fb69}"
        case .videoBlurBold: return "\u{fb6a}"
        case .videoBlurFilled: return "\u{fb6b}"
        case .videoBlurLight: return "\u{fb6c}"
        case .videoBlurRegular: return "\u{fb6d}"
        case .videoBold: return "\u{fb6e}"
        case .videoEffectBold: return "\u{fb6f}"
        case .videoEffectFilled: return "\u{fb70}"
        case .videoEffectLight: return "\u{fb71}"
        case .videoEffectRegular: return "\u{fb72}"
        case .videoFilled: return "\u{fb73}"
        case .videoLayoutBold: return "\u{fb74}"
        case .videoLayoutEqualBold: return "\u{fb75}"
        case .videoLayoutEqualDualBold: return "\u{fb76}"
        case .videoLayoutEqualDualLight: return "\u{fb77}"
        case .videoLayoutEqualDualRegular: return "\u{fb78}"
        case .videoLayoutEqualFilled: return "\u{fb79}"
        case .videoLayoutEqualLight: return "\u{fb7a}"
        case .videoLayoutEqualRegular: return "\u{fb7b}"
        case .videoLayoutFilled: return "\u{fb7c}"
        case .videoLayoutLight: return "\u{fb7d}"
        case .videoLayoutOverlayBold: return "\u{fb7e}"
        case .videoLayoutOverlayFilled: return "\u{fb7f}"
        case .videoLayoutOverlayLight: return "\u{fb80}"
        case .videoLayoutOverlayRegular: return "\u{fb81}"
        case .videoLayoutPresenterDominantBold: return "\u{fb82}"
        case .videoLayoutPresenterDominantLight: return "\u{fb83}"
        case .videoLayoutPresenterDominantRegular: return "\u{fb84}"
        case .videoLayoutProminentBold: return "\u{fb85}"
        case .videoLayoutProminentFilled: return "\u{fb86}"
        case .videoLayoutProminentLight: return "\u{fb87}"
        case .videoLayoutProminentRegular: return "\u{fb88}"
        case .videoLayoutRegular: return "\u{fb89}"
        case .videoLayoutShareDominantBold: return "\u{fb8a}"
        case .videoLayoutShareDominantLight: return "\u{fb8b}"
        case .videoLayoutShareDominantRegular: return "\u{fb8c}"
        case .videoLayoutSingleBold: return "\u{fb8d}"
        case .videoLayoutSingleFilled: return "\u{fb8e}"
        case .videoLayoutSingleLight: return "\u{fb8f}"
        case .videoLayoutSingleRegular: return "\u{fb90}"
        case .videoLayoutStackBold: return "\u{fb91}"
        case .videoLayoutStackFilled: return "\u{fb92}"
        case .videoLayoutStackLight: return "\u{fb93}"
        case .videoLayoutStackRegular: return "\u{fb94}"
        case .videoLayoutVideoDominantBold: return "\u{fb95}"
        case .videoLayoutVideoDominantFilled: return "\u{fb96}"
        case .videoLayoutVideoDominantLight: return "\u{fb97}"
        case .videoLayoutVideoDominantRegular: return "\u{fb98}"
        case .videoLight: return "\u{fb99}"
        case .videoPlusBold: return "\u{fb9a}"
        case .videoPlusFilled: return "\u{fb9b}"
        case .videoPlusLight: return "\u{fb9c}"
        case .videoPlusRegular: return "\u{fb9d}"
        case .videoRegular: return "\u{fb9e}"
        case .videoSpeakerTrackBold: return "\u{fb9f}"
        case .videoSpeakerTrackFilled: return "\u{fba0}"
        case .videoSpeakerTrackLight: return "\u{fba1}"
        case .videoSpeakerTrackRegular: return "\u{fba2}"
        case .viewAllBold: return "\u{fba3}"
        case .viewAllLight: return "\u{fba4}"
        case .viewAllRegular: return "\u{fba5}"
        case .viewListBold: return "\u{fba6}"
        case .viewListFilled: return "\u{fba7}"
        case .viewListLight: return "\u{fba8}"
        case .viewListRegular: return "\u{fba9}"
        case .viewStackedBold: return "\u{fbaa}"
        case .viewStackedFilled: return "\u{fbab}"
        case .viewStackedLight: return "\u{fbac}"
        case .viewStackedRegular: return "\u{fbad}"
        case .viewThumbnailBold: return "\u{fbae}"
        case .viewThumbnailFilled: return "\u{fbaf}"
        case .viewThumbnailLight: return "\u{fbb0}"
        case .viewThumbnailRegular: return "\u{fbb1}"
        case .visionproBold: return "\u{fbb2}"
        case .visionproFilled: return "\u{fbb3}"
        case .visionproLight: return "\u{fbb4}"
        case .visionproMoveCallInBold: return "\u{fbb5}"
        case .visionproMoveCallInFilled: return "\u{fbb6}"
        case .visionproMoveCallInLight: return "\u{fbb7}"
        case .visionproMoveCallInOutBold: return "\u{fbb8}"
        case .visionproMoveCallInOutFilled: return "\u{fbb9}"
        case .visionproMoveCallInOutLight: return "\u{fbba}"
        case .visionproMoveCallInOutRegular: return "\u{fbbb}"
        case .visionproMoveCallInRegular: return "\u{fbbc}"
        case .visionproMoveCallOutBold: return "\u{fbbd}"
        case .visionproMoveCallOutFilled: return "\u{fbbe}"
        case .visionproMoveCallOutLight: return "\u{fbbf}"
        case .visionproMoveCallOutRegular: return "\u{fbc0}"
        case .visionproRegular: return "\u{fbc1}"
        case .voicemailBold: return "\u{fbc2}"
        case .voicemailFilled: return "\u{fbc3}"
        case .voicemailLight: return "\u{fbc4}"
        case .voicemailRegular: return "\u{fbc5}"
        case .vpnBold: return "\u{fbc6}"
        case .vpnFilled: return "\u{fbc7}"
        case .vpnLight: return "\u{fbc8}"
        case .vpnRegular: return "\u{fbc9}"
        case .vscBold: return "\u{fbca}"
        case .vscLight: return "\u{fbcb}"
        case .vscRegular: return "\u{fbcc}"
        case .waffleMenuBold: return "\u{fbcd}"
        case .waffleMenuLight: return "\u{fbce}"
        case .waffleMenuRegular: return "\u{fbcf}"
        case .waitingRoomBold: return "\u{fbd0}"
        case .waitingRoomLight: return "\u{fbd1}"
        case .waitingRoomRegular: return "\u{fbd2}"
        case .wallpaperBold: return "\u{fbd3}"
        case .wallpaperLight: return "\u{fbd4}"
        case .wallpaperRegular: return "\u{fbd5}"
        case .warningBadgeFilled: return "\u{fbd6}"
        case .warningBold: return "\u{fbd7}"
        case .warningFilled: return "\u{fbd8}"
        case .warningLight: return "\u{fbd9}"
        case .warningRegular: return "\u{fbda}"
        case .webexBoardBold: return "\u{fbdb}"
        case .webexBoardLight: return "\u{fbdc}"
        case .webexBoardRegular: return "\u{fbdd}"
        case .webexCodecPlusBold: return "\u{fbde}"
        case .webexCodecPlusLight: return "\u{fbdf}"
        case .webexCodecPlusRegular: return "\u{fbe0}"
        case .webexDeskCameraBold: return "\u{fbe1}"
        case .webexDeskCameraLight: return "\u{fbe2}"
        case .webexDeskCameraRegular: return "\u{fbe3}"
        case .webexHelixBold: return "\u{fbe4}"
        case .webexHelixLight: return "\u{fbe5}"
        case .webexHelixRegular: return "\u{fbe6}"
        case .webexMeetingsBold: return "\u{fbe7}"
        case .webexMeetingsFilled: return "\u{fbe8}"
        case .webexMeetingsLight: return "\u{fbe9}"
        case .webexMeetingsRegular: return "\u{fbea}"
        case .webexQuadCameraBold: return "\u{fbeb}"
        case .webexQuadCameraLight: return "\u{fbec}"
        case .webexQuadCameraRegular: return "\u{fbed}"
        case .webexRoomKitBold: return "\u{fbee}"
        case .webexRoomKitLight: return "\u{fbef}"
        case .webexRoomKitPlusBold: return "\u{fbf0}"
        case .webexRoomKitPlusLight: return "\u{fbf1}"
        case .webexRoomKitPlusRegular: return "\u{fbf2}"
        case .webexRoomKitRegular: return "\u{fbf3}"
        case .webexShareBold: return "\u{fbf4}"
        case .webexShareLight: return "\u{fbf5}"
        case .webexShareRegular: return "\u{fbf6}"
        case .webexTeamsBold: return "\u{fbf7}"
        case .webexTeamsFilled: return "\u{fbf8}"
        case .webexTeamsLight: return "\u{fbf9}"
        case .webexTeamsNewBold: return "\u{fbfa}"
        case .webexTeamsNewFilled: return "\u{fbfb}"
        case .webexTeamsNewLight: return "\u{fbfc}"
        case .webexTeamsNewRegular: return "\u{fbfd}"
        case .webexTeamsRegular: return "\u{fbfe}"
        case .webexTeamsRemoveBold: return "\u{fbff}"
        case .webexTeamsRemoveLight: return "\u{fc00}"
        case .webexTeamsRemoveRegular: return "\u{fc01}"
        case .webinarBold: return "\u{fc02}"
        case .webinarFilled: return "\u{fc03}"
        case .webinarLight: return "\u{fc04}"
        case .webinarRegular: return "\u{fc05}"
        case .weeklyRecurringScheduleBold: return "\u{fc06}"
        case .weeklyRecurringScheduleLight: return "\u{fc07}"
        case .weeklyRecurringScheduleRegular: return "\u{fc08}"
        case .whisperCoachBold: return "\u{fc09}"
        case .whisperCoachFilled: return "\u{fc0a}"
        case .whisperCoachLight: return "\u{fc0b}"
        case .whisperCoachRegular: return "\u{fc0c}"
        case .whiteboardBold: return "\u{fc0d}"
        case .whiteboardContentBold: return "\u{fc0e}"
        case .whiteboardContentFilled: return "\u{fc0f}"
        case .whiteboardContentLight: return "\u{fc10}"
        case .whiteboardContentRegular: return "\u{fc11}"
        case .whiteboardFilled: return "\u{fc12}"
        case .whiteboardLight: return "\u{fc13}"
        case .whiteboardRegular: return "\u{fc14}"
        case .widgetBold: return "\u{fc15}"
        case .widgetFilled: return "\u{fc16}"
        case .widgetLight: return "\u{fc17}"
        case .widgetRegular: return "\u{fc18}"
        case .wifiBold: return "\u{fc19}"
        case .wifiErrorBold: return "\u{fc1a}"
        case .wifiErrorLight: return "\u{fc1b}"
        case .wifiErrorRegular: return "\u{fc1c}"
        case .wifiLight: return "\u{fc1d}"
        case .wifiRegular: return "\u{fc1e}"
        case .wifiSignalGoodBold: return "\u{fc1f}"
        case .wifiSignalGoodLight: return "\u{fc20}"
        case .wifiSignalGoodRegular: return "\u{fc21}"
        case .wifiSignalPoorBold: return "\u{fc22}"
        case .wifiSignalPoorLight: return "\u{fc23}"
        case .wifiSignalPoorRegular: return "\u{fc24}"
        case .wifiSignalUnstableBold: return "\u{fc25}"
        case .wifiSignalUnstableLight: return "\u{fc26}"
        case .wifiSignalUnstableRegular: return "\u{fc27}"
        case .windowCornerScrubBold: return "\u{fc28}"
        case .windowCornerScrubLight: return "\u{fc29}"
        case .windowCornerScrubRegular: return "\u{fc2a}"
        case .windowRightCornerScrubBold: return "\u{fc2b}"
        case .windowRightCornerScrubLight: return "\u{fc2c}"
        case .windowRightCornerScrubRegular: return "\u{fc2d}"
        case .windowVerticalScrubBold: return "\u{fc2e}"
        case .windowVerticalScrubLight: return "\u{fc2f}"
        case .windowVerticalScrubRegular: return "\u{fc30}"
        case .workflowDeploymentsBold: return "\u{fc31}"
        case .workflowDeploymentsFilled: return "\u{fc32}"
        case .workflowDeploymentsLight: return "\u{fc33}"
        case .workflowDeploymentsRegular: return "\u{fc34}"
        case .workphoneBold: return "\u{fc35}"
        case .workphoneLight: return "\u{fc36}"
        case .workphoneRegular: return "\u{fc37}"
        case .zoomInBold: return "\u{fc38}"
        case .zoomInLight: return "\u{fc39}"
        case .zoomInRegular: return "\u{fc3a}"
        case .zoomOutBold: return "\u{fc3b}"
        case .zoomOutLight: return "\u{fc3c}"
        case .zoomOutRegular: return "\u{fc3d}"
