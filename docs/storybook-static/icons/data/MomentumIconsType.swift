...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .checkboxGroupLight: return "\u{f35a}"
        case .checkboxGroupRegular: return "\u{f35b}"
        case .cleanUpBold: return "\u{f35c}"
        case .cleanUpLight: return "\u{f35d}"
        case .cleanUpRegular: return "\u{f35e}"
        case .clearBadgeFilled: return "\u{f35f}"
        case .clearBold: return "\u{f360}"
        case .clearFilled: return "\u{f361}"
        case .clearLight: return "\u{f362}"
        case .clearRegular: return "\u{f363}"
        case .closeSpaceBold: return "\u{f364}"
        case .closeSpaceLight: return "\u{f365}"
        case .closeSpaceRegular: return "\u{f366}"
        case .closedCaptionBadgeBold: return "\u{f367}"
        case .closedCaptionBadgeFilled: return "\u{f368}"
        case .closedCaptionBadgeLight: return "\u{f369}"
        case .closedCaptionBadgeRegular: return "\u{f36a}"
        case .closedCaptionsBold: return "\u{f36b}"
        case .closedCaptionsFilled: return "\u{f36c}"
        case .closedCaptionsLight: return "\u{f36d}"
        case .closedCaptionsRegular: return "\u{f36e}"
        case .cloudBold: return "\u{f36f}"
        case .cloudDownloadBold: return "\u{f370}"
        case .cloudDownloadLight: return "\u{f371}"
        case .cloudDownloadRegular: return "\u{f372}"
        case .cloudFilled: return "\u{f373}"
        case .cloudFrameBold: return "\u{f374}"
        case .cloudFrameFilled: return "\u{f375}"
        case .cloudFrameLight: return "\u{f376}"
        case .cloudFrameRegular: return "\u{f377}"
        case .cloudLight: return "\u{f378}"
        case .cloudMutedBold: return "\u{f379}"
        case .cloudMutedFilled: return "\u{f37a}"
        case .cloudMutedLight: return "\u{f37b}"
        case .cloudMutedRegular: return "\u{f37c}"
        case .cloudRegular: return "\u{f37d}"
        case .cloudUploadBold: return "\u{f37e}"
        case .cloudUploadLight: return "\u{f37f}"
        case .cloudUploadRegular: return "\u{f380}"
        case .codeBlockBold: return "\u{f381}"
        case .codeBlockLight: return "\u{f382}"
        case .codeBlockRegular: return "\u{f383}"
        case .coffeeBold: return "\u{f384}"
        case .coffeeLight: return "\u{f385}"
        case .coffeeRegular: return "\u{f386}"
        case .colorBold: return "\u{f387}"
        case .colorFilled: return "\u{f388}"
        case .colorLight: return "\u{f389}"
        case .colorRegular: return "\u{f38a}"
        case .colourPaletteBold: return "\u{f38b}"
        case .colourPaletteFilled: return "\u{f38c}"
        case .colourPaletteLight: return "\u{f38d}"
        case .colourPaletteRegular: return "\u{f38e}"
        case .commentingBold: return "\u{f38f}"
        case .commentingFilled: return "\u{f390}"
        case .commentingLight: return "\u{f391}"
        case .commentingRegular: return "\u{f392}"
        case .companyBold: return "\u{f393}"
        case .companyLight: return "\u{f394}"
        case .companyRegular: return "\u{f395}"
        case .completedByBaseBold: return "\u{f396}"
        case .completedByBaseLight: return "\u{f397}"
        case .completedByBaseRegular: return "\u{f398}"
        case .completedByTimeBold: return "\u{f399}"
        case .completedByTimeLight: return "\u{f39a}"
        case .completedByTimeRegular: return "\u{f39b}"
        case .computerBold: return "\u{f39c}"
        case .computerLight: return "\u{f39d}"
        case .computerRegular: return "\u{f39e}"
        case .conciergeBold: return "\u{f39f}"
        case .conciergeLight: return "\u{f3a0}"
        case .conciergeRegular: return "\u{f3a1}"
        case .conditionalBlockBold: return "\u{f3a2}"
        case .conditionalBlockLight: return "\u{f3a3}"
        case .conditionalBlockRegular: return "\u{f3a4}"
        case .connectBold: return "\u{f3a5}"
        case .connectLight: return "\u{f3a6}"
        case .connectRegular: return "\u{f3a7}"
        case .contactCardBold: return "\u{f3a8}"
        case .contactCardFilled: return "\u{f3a9}"
        case .contactCardLight: return "\u{f3aa}"
        case .contactCardRegular: return "\u{f3ab}"
        case .contactsBold: return "\u{f3ac}"
        case .contactsFilled: return "\u{f3ad}"
        case .contactsLight: return "\u{f3ae}"
        case .contactsRegular: return "\u{f3af}"
        case .contentDownloadBold: return "\u{f3b0}"
        case .contentDownloadFilled: return "\u{f3b1}"
        case .contentDownloadLight: return "\u{f3b2}"
        case .contentDownloadRegular: return "\u{f3b3}"
        case .contentShareBold: return "\u{f3b4}"
        case .contentShareLight: return "\u{f3b5}"
        case .contentShareRegular: return "\u{f3b6}"
        case .contrastBold: return "\u{f3b7}"
        case .contrastLight: return "\u{f3b8}"
        case .contrastRegular: return "\u{f3b9}"
        case .copyBold: return "\u{f3ba}"
        case .copyLight: return "\u{f3bb}"
        case .copyRegular: return "\u{f3bc}"
        case .cpuBold: return "\u{f3bd}"
        case .cpuLight: return "\u{f3be}"
        case .cpuRegular: return "\u{f3bf}"
        case .createAGroupBold: return "\u{f3c0}"
        case .createAGroupFilled: return "\u{f3c1}"
        case .createAGroupLight: return "\u{f3c2}"
        case .createAGroupRegular: return "\u{f3c3}"
        case .cropBold: return "\u{f3c4}"
        case .cropLight: return "\u{f3c5}"
        case .cropRegular: return "\u{f3c6}"
        case .cucmConnectionBold: return "\u{f3c7}"
        case .cucmConnectionLight: return "\u{f3c8}"
        case .cucmConnectionRegular: return "\u{f3c9}"
        case .customCodeEditorBold: return "\u{f3ca}"
        case .customCodeEditorLight: return "\u{f3cb}"
        case .customCodeEditorRegular: return "\u{f3cc}"
        case .dailyRecurringScheduleBold: return "\u{f3cd}"
        case .dailyRecurringScheduleLight: return "\u{f3ce}"
        case .dailyRecurringScheduleRegular: return "\u{f3cf}"
        case .dashboardBold: return "\u{f3d0}"
        case .dashboardFilled: return "\u{f3d1}"
        case .dashboardLight: return "\u{f3d2}"
        case .dashboardRegular: return "\u{f3d3}"
        case .dataManagementBold: return "\u{f3d4}"
        case .dataManagementFilled: return "\u{f3d5}"
        case .dataManagementLight: return "\u{f3d6}"
        case .dataManagementRegular: return "\u{f3d7}"
        case .dataRangeSelectionBold: return "\u{f3d8}"
        case .dataRangeSelectionFilled: return "\u{f3d9}"
        case .dataRangeSelectionLight: return "\u{f3da}"
        case .dataRangeSelectionRegular: return "\u{f3db}"
        case .declineBold: return "\u{f3dc}"
        case .declineFilled: return "\u{f3dd}"
        case .declineLight: return "\u{f3de}"
        case .declineRegular: return "\u{f3df}"
        case .dectHandsetBold: return "\u{f3e0}"
        case .dectHandsetFilled: return "\u{f3e1}"
        case .dectHandsetLight: return "\u{f3e2}"
        case .dectHandsetRegular: return "\u{f3e3}"
        case .deleteBold: return "\u{f3e4}"
        case .deleteFilled: return "\u{f3e5}"
        case .deleteLight: return "\u{f3e6}"
        case .deleteRegular: return "\u{f3e7}"
        case .deploymentEvaluationProgressBold: return "\u{f3e8}"
        case .deploymentEvaluationProgressLight: return "\u{f3e9}"
        case .deploymentEvaluationProgressRegular: return "\u{f3ea}"
        case .deploymentProgressBold: return "\u{f3eb}"
        case .deploymentProgressLight: return "\u{f3ec}"
        case .deploymentProgressRegular: return "\u{f3ed}"
        case .deploymentRecurringBold: return "\u{f3ee}"
        case .deploymentRecurringLight: return "\u{f3ef}"
        case .deploymentRecurringRegular: return "\u{f3f0}"
        case .deploymentWinnerPendingBold: return "\u{f3f1}"
        case .deploymentWinnerPendingLight: return "\u{f3f2}"
        case .deploymentWinnerPendingRegular: return "\u{f3f3}"
        case .deskPhoneBold: return "\u{f3f4}"
        case .deskPhoneFilled: return "\u{f3f5}"
        case .deskPhoneLight: return "\u{f3f6}"
        case .deskPhoneRegular: return "\u{f3f7}"
        case .deskPhoneWarningBold: return "\u{f3f8}"
        case .deskPhoneWarningLight: return "\u{f3f9}"
        case .deskPhoneWarningRegular: return "\u{f3fa}"
        case .deviceConnectionBold: return "\u{f3fb}"
        case .deviceConnectionFilled: return "\u{f3fc}"
        case .deviceConnectionLight: return "\u{f3fd}"
        case .deviceConnectionRegular: return "\u{f3fe}"
        case .deviceInRoomBold: return "\u{f3ff}"
        case .deviceInRoomEndBold: return "\u{f400}"
        case .deviceInRoomEndLight: return "\u{f401}"
        case .deviceInRoomEndRegular: return "\u{f402}"
        case .deviceInRoomFilled: return "\u{f403}"
        case .deviceInRoomLight: return "\u{f404}"
        case .deviceInRoomRegular: return "\u{f405}"
        case .deviceMutedBold: return "\u{f406}"
        case .deviceMutedLight: return "\u{f407}"
        case .deviceMutedRegular: return "\u{f408}"
        case .devicePolicyControllerBold: return "\u{f409}"
        case .devicePolicyControllerLight: return "\u{f40a}"
        case .devicePolicyControllerRegular: return "\u{f40b}"
        case .devicesBold: return "\u{f40c}"
        case .devicesFilled: return "\u{f40d}"
        case .devicesLight: return "\u{f40e}"
        case .devicesRegular: return "\u{f40f}"
        case .diagnosticsBold: return "\u{f410}"
        case .diagnosticsLight: return "\u{f411}"
        case .diagnosticsRegular: return "\u{f412}"
        case .dialpadBold: return "\u{f413}"
        case .dialpadLight: return "\u{f414}"
        case .dialpadRegular: return "\u{f415}"
        case .directionalPadBold: return "\u{f416}"
        case .directionalPadFilled: return "\u{f417}"
        case .directionalPadLight: return "\u{f418}"
        case .directionalPadRegular: return "\u{f419}"
        case .directoryBold: return "\u{f41a}"
        case .directoryLight: return "\u{f41b}"
        case .directoryRegular: return "\u{f41c}"
        case .disappearingPenBold: return "\u{f41d}"
        case .disappearingPenLight: return "\u{f41e}"
        case .disappearingPenRegular: return "\u{f41f}"
        case .discBold: return "\u{f420}"
        case .discConnectedBold: return "\u{f421}"
        case .discConnectedLight: return "\u{f422}"
        case .discConnectedRegular: return "\u{f423}"
        case .discLight: return "\u{f424}"
        case .discRegular: return "\u{f425}"
        case .disconnectBold: return "\u{f426}"
        case .disconnectFilled: return "\u{f427}"
        case .disconnectLight: return "\u{f428}"
        case .disconnectRegular: return "\u{f429}"
        case .dislikeBold: return "\u{f42a}"
        case .dislikeFilled: return "\u{f42b}"
        case .dislikeLight: return "\u{f42c}"
        case .dislikeRegular: return "\u{f42d}"
        case .displayBold: return "\u{f42e}"
        case .displayInputBold: return "\u{f42f}"
        case .displayInputLight: return "\u{f430}"
        case .displayInputRegular: return "\u{f431}"
        case .displayLight: return "\u{f432}"
        case .displayRegular: return "\u{f433}"
        case .displayWarningBold: return "\u{f434}"
        case .displayWarningLight: return "\u{f435}"
        case .displayWarningRegular: return "\u{f436}"
        case .distributeHorizontalBold: return "\u{f437}"
        case .distributeHorizontalFilled: return "\u{f438}"
        case .distributeHorizontalLight: return "\u{f439}"
        case .distributeHorizontalRegular: return "\u{f43a}"
        case .distributeVerticallyBold: return "\u{f43b}"
        case .distributeVerticallyFilled: return "\u{f43c}"
        case .distributeVerticallyLight: return "\u{f43d}"
        case .distributeVerticallyRegular: return "\u{f43e}"
        case .divideBold: return "\u{f43f}"
        case .divideFilled: return "\u{f440}"
        case .divideLight: return "\u{f441}"
        case .divideRegular: return "\u{f442}"
        case .dndPresenceBadgeFilled: return "\u{f443}"
        case .dndPresenceBold: return "\u{f444}"
        case .dndPresenceFilled: return "\u{f445}"
        case .dndPresenceLight: return "\u{f446}"
        case .dndPresenceRegular: return "\u{f447}"
        case .dockWindowBold: return "\u{f448}"
        case .dockWindowLight: return "\u{f449}"
        case .dockWindowRegular: return "\u{f44a}"
        case .documentBold: return "\u{f44b}"
        case .documentCameraBold: return "\u{f44c}"
        case .documentCameraDisconnectedBold: return "\u{f44d}"
        case .documentCameraDisconnectedLight: return "\u{f44e}"
        case .documentCameraDisconnectedRegular: return "\u{f44f}"
        case .documentCameraLight: return "\u{f450}"
        case .documentCameraRegular: return "\u{f451}"
        case .documentCreateBold: return "\u{f452}"
        case .documentCreateFilled: return "\u{f453}"
        case .documentCreateLight: return "\u{f454}"
        case .documentCreateRegular: return "\u{f455}"
        case .documentFilled: return "\u{f456}"
        case .documentLight: return "\u{f457}"
        case .documentMoveBold: return "\u{f458}"
        case .documentMoveFilled: return "\u{f459}"
        case .documentMoveLight: return "\u{f45a}"
        case .documentMoveRegular: return "\u{f45b}"
        case .documentRegular: return "\u{f45c}"
        case .documentShareBold: return "\u{f45d}"
        case .documentShareFilled: return "\u{f45e}"
        case .documentShareLight: return "\u{f45f}"
        case .documentShareRegular: return "\u{f460}"
        case .doneAllBold: return "\u{f461}"
        case .doneAllLight: return "\u{f462}"
        case .doneAllRegular: return "\u{f463}"
        case .donutChartBold: return "\u{f464}"
        case .donutChartFilled: return "\u{f465}"
        case .donutChartLight: return "\u{f466}"
        case .donutChartRegular: return "\u{f467}"
        case .downloadBold: return "\u{f468}"
        case .downloadFilled: return "\u{f469}"
        case .downloadLight: return "\u{f46a}"
        case .downloadRegular: return "\u{f46b}"
        case .draftBold: return "\u{f46c}"
        case .draftFilled: return "\u{f46d}"
        case .draftIndicatorBold: return "\u{f46e}"
        case .draftIndicatorSmallFilled: return "\u{f46f}"
        case .draftLight: return "\u{f470}"
        case .draftRegular: return "\u{f471}"
        case .dragBold: return "\u{f472}"
        case .dragLight: return "\u{f473}"
        case .dragRegular: return "\u{f474}"
        case .draggerHorizontalBold: return "\u{f475}"
        case .draggerHorizontalLight: return "\u{f476}"
        case .draggerHorizontalRegular: return "\u{f477}"
        case .draggerVerticalBold: return "\u{f478}"
        case .draggerVerticalLight: return "\u{f479}"
        case .draggerVerticalRegular: return "\u{f47a}"
        case .driveModeBold: return "\u{f47b}"
        case .driveModeLight: return "\u{f47c}"
        case .driveModeRegular: return "\u{f47d}"
        case .dropdownBold: return "\u{f47e}"
        case .dropdownLight: return "\u{f47f}"
        case .dropdownRegular: return "\u{f480}"
        case .dxEightyBold: return "\u{f481}"
        case .dxEightyFilled: return "\u{f482}"
        case .dxEightyLight: return "\u{f483}"
        case .dxEightyRegular: return "\u{f484}"
        case .dxSeventyBold: return "\u{f485}"
        case .dxSeventyLight: return "\u{f486}"
        case .dxSeventyRegular: return "\u{f487}"
        case .editBold: return "\u{f488}"
        case .editFilled: return "\u{f489}"
        case .editLight: return "\u{f48a}"
        case .editRegular: return "\u{f48b}"
        case .editablePartialBold: return "\u{f48c}"
        case .editablePartialLight: return "\u{f48d}"
        case .editablePartialRegular: return "\u{f48e}"
        case .educationBold: return "\u{f48f}"
        case .educationFilled: return "\u{f490}"
        case .educationLight: return "\u{f491}"
        case .educationRegular: return "\u{f492}"
        case .emailBold: return "\u{f493}"
        case .emailDeliveredBold: return "\u{f494}"
        case .emailDeliveredLight: return "\u{f495}"
        case .emailDeliveredRegular: return "\u{f496}"
        case .emailFailureBold: return "\u{f497}"
        case .emailFailureLight: return "\u{f498}"
        case .emailFailureRegular: return "\u{f499}"
        case .emailFilled: return "\u{f49a}"
        case .emailInviteBold: return "\u{f49b}"
        case .emailInviteLight: return "\u{f49c}"
        case .emailInviteRegular: return "\u{f49d}"
        case .emailLight: return "\u{f49e}"
        case .emailOutgoingBold: return "\u{f49f}"
        case .emailOutgoingFilled: return "\u{f4a0}"
        case .emailOutgoingLight: return "\u{f4a1}"
        case .emailOutgoingRegular: return "\u{f4a2}"
        case .emailReadBold: return "\u{f4a3}"
        case .emailReadFilled: return "\u{f4a4}"
        case .emailReadLight: return "\u{f4a5}"
        case .emailReadRegular: return "\u{f4a6}"
        case .emailRegular: return "\u{f4a7}"
        case .emojiExcitedBold: return "\u{f4a8}"
        case .emojiExcitedFilled: return "\u{f4a9}"
        case .emojiExcitedLight: return "\u{f4aa}"
        case .emojiExcitedRegular: return "\u{f4ab}"
        case .emojiHappyBold: return "\u{f4ac}"
        case .emojiHappyFilled: return "\u{f4ad}"
        case .emojiHappyLight: return "\u{f4ae}"
        case .emojiHappyRegular: return "\u{f4af}"
        case .emojiPassiveBold: return "\u{f4b0}"
        case .emojiPassiveFilled: return "\u{f4b1}"
        case .emojiPassiveLight: return "\u{f4b2}"
        case .emojiPassiveRegular: return "\u{f4b3}"
        case .emojiSadBold: return "\u{f4b4}"
        case .emojiSadFilled: return "\u{f4b5}"
        case .emojiSadLight: return "\u{f4b6}"
        case .emojiSadRegular: return "\u{f4b7}"
        case .emojiUnhappyBold: return "\u{f4b8}"
        case .emojiUnhappyFilled: return "\u{f4b9}"
        case .emojiUnhappyLight: return "\u{f4ba}"
        case .emojiUnhappyRegular: return "\u{f4bb}"
        case .encryptionCircleFilled: return "\u{f4bc}"
        case .encryptionFilled: return "\u{f4bd}"
        case .endRemoteDesktopControlBold: return "\u{f4be}"
        case .endRemoteDesktopControlLight: return "\u{f4bf}"
        case .endRemoteDesktopControlRegular: return "\u{f4c0}"
        case .endToEndEncryptionCircleFilled: return "\u{f4c1}"
        case .endToEndEncryptionFilled: return "\u{f4c2}"
        case .endpointBlockedBold: return "\u{f4c3}"
        case .endpointBlockedLight: return "\u{f4c4}"
        case .endpointBlockedRegular: return "\u{f4c5}"
        case .endpointBold: return "\u{f4c6}"
        case .endpointGTwoBold: return "\u{f4c7}"
        case .endpointGTwoLight: return "\u{f4c8}"
        case .endpointGTwoRegular: return "\u{f4c9}"
        case .endpointGTwoSeventyBold: return "\u{f4ca}"
        case .endpointGTwoSeventyDualBold: return "\u{f4cb}"
        case .endpointGTwoSeventyDualLight: return "\u{f4cc}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4cd}"
        case .endpointGTwoSeventyLight: return "\u{f4ce}"
        case .endpointGTwoSeventyRegular: return "\u{f4cf}"
        case .endpointGTwoStandBold: return "\u{f4d0}"
        case .endpointGTwoStandLight: return "\u{f4d1}"
        case .endpointGTwoStandRegular: return "\u{f4d2}"
        case .endpointLight: return "\u{f4d3}"
        case .endpointMxEightHundredBold: return "\u{f4d4}"
        case .endpointMxEightHundredDualBold: return "\u{f4d5}"
        case .endpointMxEightHundredDualLight: return "\u{f4d6}"
        case .endpointMxEightHundredDualRegular: return "\u{f4d7}"
        case .endpointMxEightHundredLight: return "\u{f4d8}"
        case .endpointMxEightHundredRegular: return "\u{f4d9}"
        case .endpointRegular: return "\u{f4da}"
        case .endpointStandBold: return "\u{f4db}"
        case .endpointStandFilled: return "\u{f4dc}"
        case .endpointStandLight: return "\u{f4dd}"
        case .endpointStandRegular: return "\u{f4de}"
        case .endpointWarningBold: return "\u{f4df}"
        case .endpointWarningLight: return "\u{f4e0}"
        case .endpointWarningRegular: return "\u{f4e1}"
        case .enterBold: return "\u{f4e2}"
        case .enterLight: return "\u{f4e3}"
        case .enterRegular: return "\u{f4e4}"
        case .enterRoomBold: return "\u{f4e5}"
        case .enterRoomFilled: return "\u{f4e6}"
        case .enterRoomLight: return "\u{f4e7}"
        case .enterRoomRegular: return "\u{f4e8}"
        case .eraserBold: return "\u{f4e9}"
        case .eraserFilled: return "\u{f4ea}"
        case .eraserLight: return "\u{f4eb}"
        case .eraserRegular: return "\u{f4ec}"
        case .errorLegacyBadgeFilled: return "\u{f4ed}"
        case .errorLegacyBold: return "\u{f4ee}"
        case .errorLegacyFilled: return "\u{f4ef}"
        case .errorLegacyLight: return "\u{f4f0}"
        case .errorLegacyRegular: return "\u{f4f1}"
        case .ethernetBold: return "\u{f4f2}"
        case .ethernetFilled: return "\u{f4f3}"
        case .ethernetLight: return "\u{f4f4}"
        case .ethernetRegular: return "\u{f4f5}"
        case .exchangeBold: return "\u{f4f6}"
        case .exchangeLight: return "\u{f4f7}"
        case .exchangeRegular: return "\u{f4f8}"
        case .exclamationBold: return "\u{f4f9}"
        case .exclamationLight: return "\u{f4fa}"
        case .exclamationRegular: return "\u{f4fb}"
        case .excludeBold: return "\u{f4fc}"
        case .excludeLight: return "\u{f4fd}"
        case .excludeRegular: return "\u{f4fe}"
        case .existingTargetGroupBold: return "\u{f4ff}"
        case .existingTargetGroupLight: return "\u{f500}"
        case .existingTargetGroupRegular: return "\u{f501}"
        case .exitRoomBold: return "\u{f502}"
        case .exitRoomLight: return "\u{f503}"
        case .exitRoomRegular: return "\u{f504}"
        case .exploreBold: return "\u{f505}"
        case .exploreLight: return "\u{f506}"
        case .exploreRegular: return "\u{f507}"
        case .exportBold: return "\u{f508}"
        case .exportLight: return "\u{f509}"
        case .exportRegular: return "\u{f50a}"
        case .extensionMobilityBold: return "\u{f50b}"
        case .extensionMobilityLight: return "\u{f50c}"
        case .extensionMobilityRegular: return "\u{f50d}"
        case .externalMessageBold: return "\u{f50e}"
        case .externalMessageLight: return "\u{f50f}"
        case .externalMessageRegular: return "\u{f510}"
        case .externalUserBold: return "\u{f511}"
        case .externalUserLight: return "\u{f512}"
        case .externalUserRegular: return "\u{f513}"
        case .familyFontBold: return "\u{f514}"
        case .familyFontLight: return "\u{f515}"
        case .familyFontRegular: return "\u{f516}"
        case .fastForwardBold: return "\u{f517}"
        case .fastForwardLight: return "\u{f518}"
        case .fastForwardRegular: return "\u{f519}"
        case .favoriteBold: return "\u{f51a}"
        case .favoriteFilled: return "\u{f51b}"
        case .favoriteLight: return "\u{f51c}"
        case .favoriteRegular: return "\u{f51d}"
        case .favoritesBold: return "\u{f51e}"
        case .favoritesFilled: return "\u{f51f}"
        case .favoritesLight: return "\u{f520}"
        case .favoritesRegular: return "\u{f521}"
        case .fbwBold: return "\u{f522}"
        case .fbwFilled: return "\u{f523}"
        case .fbwLight: return "\u{f524}"
        case .fbwRegular: return "\u{f525}"
        case .ffwBold: return "\u{f526}"
        case .ffwFilled: return "\u{f527}"
        case .ffwLight: return "\u{f528}"
        case .ffwRegular: return "\u{f529}"
        case .fileAnalysisBold: return "\u{f52a}"
        case .fileAnalysisFilled: return "\u{f52b}"
        case .fileAnalysisLight: return "\u{f52c}"
        case .fileAnalysisRegular: return "\u{f52d}"
        case .fileAnnotationBold: return "\u{f52e}"
        case .fileAnnotationFilled: return "\u{f52f}"
        case .fileAnnotationLight: return "\u{f530}"
        case .fileAnnotationRegular: return "\u{f531}"
        case .fileAudioBold: return "\u{f532}"
        case .fileAudioFilled: return "\u{f533}"
        case .fileAudioLight: return "\u{f534}"
        case .fileAudioRegular: return "\u{f535}"
        case .fileBugBold: return "\u{f536}"
        case .fileBugFilled: return "\u{f537}"
        case .fileBugLight: return "\u{f538}"
        case .fileBugRegular: return "\u{f539}"
        case .fileCodeBold: return "\u{f53a}"
        case .fileCodeFilled: return "\u{f53b}"
        case .fileCodeLight: return "\u{f53c}"
        case .fileCodeRegular: return "\u{f53d}"
        case .fileDashboardBold: return "\u{f53e}"
        case .fileDashboardFilled: return "\u{f53f}"
        case .fileDashboardLight: return "\u{f540}"
        case .fileDashboardRegular: return "\u{f541}"
        case .fileExcelBold: return "\u{f542}"
        case .fileExcelFilled: return "\u{f543}"
        case .fileExcelLight: return "\u{f544}"
        case .fileExcelRegular: return "\u{f545}"
        case .fileGraphBold: return "\u{f546}"
        case .fileGraphFilled: return "\u{f547}"
        case .fileGraphLight: return "\u{f548}"
        case .fileGraphRegular: return "\u{f549}"
        case .fileImageBold: return "\u{f54a}"
        case .fileImageFilled: return "\u{f54b}"
        case .fileImageLight: return "\u{f54c}"
        case .fileImageNoneBold: return "\u{f54d}"
        case .fileImageNoneLight: return "\u{f54e}"
        case .fileImageNoneRegular: return "\u{f54f}"
        case .fileImageRegular: return "\u{f550}"
        case .fileJsBold: return "\u{f551}"
        case .fileJsFilled: return "\u{f552}"
        case .fileJsLight: return "\u{f553}"
        case .fileJsRegular: return "\u{f554}"
        case .fileKeynoteBold: return "\u{f555}"
        case .fileKeynoteFilled: return "\u{f556}"
        case .fileKeynoteLight: return "\u{f557}"
        case .fileKeynoteRegular: return "\u{f558}"
        case .fileLockedBold: return "\u{f559}"
        case .fileLockedFilled: return "\u{f55a}"
        case .fileLockedLight: return "\u{f55b}"
        case .fileLockedRegular: return "\u{f55c}"
        case .fileMissingBold: return "\u{f55d}"
        case .fileMissingFilled: return "\u{f55e}"
        case .fileMissingLight: return "\u{f55f}"
        case .fileMissingRegular: return "\u{f560}"
        case .fileMusicBold: return "\u{f561}"
        case .fileMusicFilled: return "\u{f562}"
        case .fileMusicLight: return "\u{f563}"
        case .fileMusicRegular: return "\u{f564}"
        case .fileOnenoteBold: return "\u{f565}"
        case .fileOnenoteFilled: return "\u{f566}"
        case .fileOnenoteLight: return "\u{f567}"
        case .fileOnenoteRegular: return "\u{f568}"
        case .filePdfBold: return "\u{f569}"
        case .filePdfFilled: return "\u{f56a}"
        case .filePdfLight: return "\u{f56b}"
        case .filePdfRegular: return "\u{f56c}"
        case .filePowerpointBold: return "\u{f56d}"
        case .filePowerpointFilled: return "\u{f56e}"
        case .filePowerpointLight: return "\u{f56f}"
        case .filePowerpointRegular: return "\u{f570}"
        case .fileSpreadsheetBold: return "\u{f571}"
        case .fileSpreadsheetFilled: return "\u{f572}"
        case .fileSpreadsheetLight: return "\u{f573}"
        case .fileSpreadsheetRegular: return "\u{f574}"
        case .fileTextBold: return "\u{f575}"
        case .fileTextFilled: return "\u{f576}"
        case .fileTextLight: return "\u{f577}"
        case .fileTextRegular: return "\u{f578}"
        case .fileThreeDBold: return "\u{f579}"
        case .fileThreeDFilled: return "\u{f57a}"
        case .fileThreeDLight: return "\u{f57b}"
        case .fileThreeDRegular: return "\u{f57c}"
        case .fileVectorBold: return "\u{f57d}"
        case .fileVectorFilled: return "\u{f57e}"
        case .fileVectorLight: return "\u{f57f}"
        case .fileVectorRegular: return "\u{f580}"
        case .fileVideoBold: return "\u{f581}"
        case .fileVideoFilled: return "\u{f582}"
        case .fileVideoLight: return "\u{f583}"
        case .fileVideoRegular: return "\u{f584}"
        case .fileWordBold: return "\u{f585}"
        case .fileWordFilled: return "\u{f586}"
        case .fileWordLight: return "\u{f587}"
        case .fileWordRegular: return "\u{f588}"
        case .fileXmlBold: return "\u{f589}"
        case .fileXmlFilled: return "\u{f58a}"
        case .fileXmlLight: return "\u{f58b}"
        case .fileXmlRegular: return "\u{f58c}"
        case .fileZipBold: return "\u{f58d}"
        case .fileZipFilled: return "\u{f58e}"
        case .fileZipLight: return "\u{f58f}"
        case .fileZipRegular: return "\u{f590}"
        case .filesBold: return "\u{f591}"
        case .filesFilled: return "\u{f592}"
        case .filesLight: return "\u{f593}"
        case .filesRegular: return "\u{f594}"
        case .fillColourBold: return "\u{f595}"
        case .fillColourFilled: return "\u{f596}"
        case .fillColourLight: return "\u{f597}"
        case .fillColourRegular: return "\u{f598}"
        case .filterBold: return "\u{f599}"
        case .filterCircleBold: return "\u{f59a}"
        case .filterCircleFilled: return "\u{f59b}"
        case .filterCircleLight: return "\u{f59c}"
        case .filterCircleRegular: return "\u{f59d}"
        case .filterLight: return "\u{f59e}"
        case .filterRegular: return "\u{f59f}"
        case .fitToWidthBold: return "\u{f5a0}"
        case .fitToWidthLight: return "\u{f5a1}"
        case .fitToWidthRegular: return "\u{f5a2}"
        case .fitToWindowExpandBold: return "\u{f5a3}"
        case .fitToWindowExpandLight: return "\u{f5a4}"
        case .fitToWindowExpandRegular: return "\u{f5a5}"
        case .fitToWindowShrinkBold: return "\u{f5a6}"
        case .fitToWindowShrinkLight: return "\u{f5a7}"
        case .fitToWindowShrinkRegular: return "\u{f5a8}"
        case .flagBold: return "\u{f5a9}"
        case .flagCircleBold: return "\u{f5aa}"
        case .flagCircleFilled: return "\u{f5ab}"
        case .flagCircleLight: return "\u{f5ac}"
        case .flagCircleRegular: return "\u{f5ad}"
        case .flagFilled: return "\u{f5ae}"
        case .flagLight: return "\u{f5af}"
        case .flagRegular: return "\u{f5b0}"
        case .folderBold: return "\u{f5b1}"
        case .folderEditBold: return "\u{f5b2}"
        case .folderEditLight: return "\u{f5b3}"
        case .folderEditRegular: return "\u{f5b4}"
        case .folderLight: return "\u{f5b5}"
        case .folderLockBold: return "\u{f5b6}"
        case .folderLockLight: return "\u{f5b7}"
        case .folderLockRegular: return "\u{f5b8}"
        case .folderRegular: return "\u{f5b9}"
        case .folderViewBold: return "\u{f5ba}"
        case .folderViewLight: return "\u{f5bb}"
        case .folderViewRegular: return "\u{f5bc}"
        case .followUpBold: return "\u{f5bd}"
        case .followUpLight: return "\u{f5be}"
        case .followUpRegular: return "\u{f5bf}"
        case .foodBold: return "\u{f5c0}"
        case .foodFilled: return "\u{f5c1}"
        case .foodLight: return "\u{f5c2}"
        case .foodRegular: return "\u{f5c3}"
        case .formatBold: return "\u{f5c4}"
        case .formatDefaultAppBold: return "\u{f5c5}"
        case .formatDefaultAppFilled: return "\u{f5c6}"
        case .formatDefaultAppLight: return "\u{f5c7}"
        case .formatDefaultAppRegular: return "\u{f5c8}"
        case .formatLight: return "\u{f5c9}"
        case .formatPanelControlBarBold: return "\u{f5ca}"
        case .formatPanelControlBarLight: return "\u{f5cb}"
        case .formatPanelControlBarRegular: return "\u{f5cc}"
        case .formatPanelControlDownBold: return "\u{f5cd}"
        case .formatPanelControlDownLight: return "\u{f5ce}"
        case .formatPanelControlDownRegular: return "\u{f5cf}"
        case .formatPanelControlLeftBold: return "\u{f5d0}"
        case .formatPanelControlLeftLight: return "\u{f5d1}"
        case .formatPanelControlLeftRegular: return "\u{f5d2}"
        case .formatPanelControlRightBold: return "\u{f5d3}"
        case .formatPanelControlRightLight: return "\u{f5d4}"
        case .formatPanelControlRightRegular: return "\u{f5d5}"
        case .formatPanelControlUpBold: return "\u{f5d6}"
        case .formatPanelControlUpDownBold: return "\u{f5d7}"
        case .formatPanelControlUpDownLight: return "\u{f5d8}"
        case .formatPanelControlUpDownRegular: return "\u{f5d9}"
        case .formatPanelControlUpLight: return "\u{f5da}"
        case .formatPanelControlUpRegular: return "\u{f5db}"
        case .formatRegular: return "\u{f5dc}"
        case .formatViewMixedBold: return "\u{f5dd}"
        case .formatViewMixedLight: return "\u{f5de}"
        case .formatViewMixedRegular: return "\u{f5df}"
        case .formulaBold: return "\u{f5e0}"
        case .formulaFilled: return "\u{f5e1}"
        case .formulaLight: return "\u{f5e2}"
        case .formulaRegular: return "\u{f5e3}"
        case .forwardMessageBold: return "\u{f5e4}"
        case .forwardMessageFilled: return "\u{f5e5}"
        case .forwardMessageLight: return "\u{f5e6}"
        case .forwardMessageRegular: return "\u{f5e7}"
        case .forwardTenSecBold: return "\u{f5e8}"
        case .forwardTenSecLight: return "\u{f5e9}"
        case .forwardTenSecRegular: return "\u{f5ea}"
        case .fourColumnBold: return "\u{f5eb}"
        case .fourColumnLight: return "\u{f5ec}"
        case .fourColumnRegular: return "\u{f5ed}"
        case .fourWayNavigationBold: return "\u{f5ee}"
        case .fourWayNavigationLight: return "\u{f5ef}"
        case .fourWayNavigationRegular: return "\u{f5f0}"
        case .frequencyCappingBold: return "\u{f5f1}"
        case .frequencyCappingLight: return "\u{f5f2}"
        case .frequencyCappingRegular: return "\u{f5f3}"
        case .fulfillmentBold: return "\u{f5f4}"
        case .fulfillmentLight: return "\u{f5f5}"
        case .fulfillmentRegular: return "\u{f5f6}"
        case .fullscreenBold: return "\u{f5f7}"
        case .fullscreenExitBold: return "\u{f5f8}"
        case .fullscreenExitLight: return "\u{f5f9}"
        case .fullscreenExitRegular: return "\u{f5fa}"
        case .fullscreenLight: return "\u{f5fb}"
        case .fullscreenRegular: return "\u{f5fc}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5fd}"
        case .genericDeviceVideoBold: return "\u{f5fe}"
        case .genericDeviceVideoFilled: return "\u{f5ff}"
        case .genericDeviceVideoLight: return "\u{f600}"
        case .genericDeviceVideoRegular: return "\u{f601}"
        case .gifBold: return "\u{f602}"
        case .gifFilled: return "\u{f603}"
        case .gifHorizontalBold: return "\u{f604}"
        case .gifHorizontalFilled: return "\u{f605}"
        case .gifHorizontalLight: return "\u{f606}"
        case .gifHorizontalRegular: return "\u{f607}"
        case .gifLight: return "\u{f608}"
        case .gifRegular: return "\u{f609}"
        case .giftBold: return "\u{f60a}"
        case .giftFilled: return "\u{f60b}"
        case .giftLight: return "\u{f60c}"
        case .giftRegular: return "\u{f60d}"
        case .greenLeafBold: return "\u{f60e}"
        case .greenLeafFilled: return "\u{f60f}"
        case .greenLeafLight: return "\u{f610}"
        case .greenLeafRegular: return "\u{f611}"
        case .greenRoomBold: return "\u{f612}"
        case .greenRoomFilled: return "\u{f613}"
        case .greenRoomLight: return "\u{f614}"
        case .greenRoomRegular: return "\u{f615}"
        case .guestIssuerBold: return "\u{f616}"
        case .guestIssuerLight: return "\u{f617}"
        case .guestIssuerRegular: return "\u{f618}"
        case .guideBold: return "\u{f619}"
        case .guideLight: return "\u{f61a}"
        case .guideRegular: return "\u{f61b}"
        case .handPointerBold: return "\u{f61c}"
        case .handPointerLight: return "\u{f61d}"
        case .handPointerRegular: return "\u{f61e}"
        case .handlerBold: return "\u{f61f}"
        case .handlerHorizontalBold: return "\u{f620}"
        case .handlerHorizontalLight: return "\u{f621}"
        case .handlerHorizontalRegular: return "\u{f622}"
        case .handlerLight: return "\u{f623}"
        case .handlerRegular: return "\u{f624}"
        case .handsetAlertBold: return "\u{f625}"
        case .handsetAlertFilled: return "\u{f626}"
        case .handsetAlertLight: return "\u{f627}"
        case .handsetAlertRegular: return "\u{f628}"
        case .handsetBold: return "\u{f629}"
        case .handsetDownSlashBold: return "\u{f62a}"
        case .handsetDownSlashFilled: return "\u{f62b}"
        case .handsetDownSlashLight: return "\u{f62c}"
        case .handsetDownSlashRegular: return "\u{f62d}"
        case .handsetFilled: return "\u{f62e}"
        case .handsetLight: return "\u{f62f}"
        case .handsetMutedBold: return "\u{f630}"
        case .handsetMutedFilled: return "\u{f631}"
        case .handsetMutedLight: return "\u{f632}"
        case .handsetMutedRegular: return "\u{f633}"
        case .handsetRegular: return "\u{f634}"
        case .handsetsArrowLeftBold: return "\u{f635}"
        case .handsetsArrowLeftLight: return "\u{f636}"
        case .handsetsArrowLeftRegular: return "\u{f637}"
        case .handshakeBold: return "\u{f638}"
        case .handshakeLight: return "\u{f639}"
        case .handshakeRegular: return "\u{f63a}"
        case .headingOneBold: return "\u{f63b}"
        case .headingOneLight: return "\u{f63c}"
        case .headingOneRegular: return "\u{f63d}"
        case .headingThreeBold: return "\u{f63e}"
        case .headingThreeLight: return "\u{f63f}"
        case .headingThreeRegular: return "\u{f640}"
        case .headingTwoBold: return "\u{f641}"
        case .headingTwoLight: return "\u{f642}"
        case .headingTwoRegular: return "\u{f643}"
        case .headphonesBold: return "\u{f644}"
        case .headphonesFilled: return "\u{f645}"
        case .headphonesLight: return "\u{f646}"
        case .headphonesMutedBold: return "\u{f647}"
        case .headphonesMutedFilled: return "\u{f648}"
        case .headphonesMutedLight: return "\u{f649}"
        case .headphonesMutedRegular: return "\u{f64a}"
        case .headphonesRegular: return "\u{f64b}"
        case .headsetAlertBold: return "\u{f64c}"
        case .headsetAlertLight: return "\u{f64d}"
        case .headsetAlertRegular: return "\u{f64e}"
        case .headsetArrowDownBold: return "\u{f64f}"
        case .headsetArrowDownFilled: return "\u{f650}"
        case .headsetArrowDownLight: return "\u{f651}"
        case .headsetArrowDownRegular: return "\u{f652}"
        case .headsetBluetoothBold: return "\u{f653}"
        case .headsetBluetoothLight: return "\u{f654}"
        case .headsetBluetoothRegular: return "\u{f655}"
        case .headsetBold: return "\u{f656}"
        case .headsetFilled: return "\u{f657}"
        case .headsetLight: return "\u{f658}"
        case .headsetMutedBold: return "\u{f659}"
        case .headsetMutedLight: return "\u{f65a}"
        case .headsetMutedRegular: return "\u{f65b}"
        case .headsetPrivateBold: return "\u{f65c}"
        case .headsetPrivateLight: return "\u{f65d}"
        case .headsetPrivateRegular: return "\u{f65e}"
        case .headsetRegular: return "\u{f65f}"
        case .hearingBold: return "\u{f660}"
        case .hearingImpairedBold: return "\u{f661}"
        case .hearingImpairedLight: return "\u{f662}"
        case .hearingImpairedRegular: return "\u{f663}"
        case .hearingLight: return "\u{f664}"
        case .hearingRegular: return "\u{f665}"
        case .helpBold: return "\u{f666}"
        case .helpCircleBold: return "\u{f667}"
        case .helpCircleFilled: return "\u{f668}"
        case .helpCircleLight: return "\u{f669}"
        case .helpCircleRegular: return "\u{f66a}"
        case .helpLight: return "\u{f66b}"
        case .helpRegular: return "\u{f66c}"
        case .helpdeskBold: return "\u{f66d}"
        case .helpdeskFilled: return "\u{f66e}"
        case .helpdeskLight: return "\u{f66f}"
        case .helpdeskRegular: return "\u{f670}"
        case .hideBold: return "\u{f671}"
        case .hideFilled: return "\u{f672}"
        case .hideLight: return "\u{f673}"
        case .hideRegular: return "\u{f674}"
        case .homeBold: return "\u{f675}"
        case .homeFilled: return "\u{f676}"
        case .homeLight: return "\u{f677}"
        case .homeRegular: return "\u{f678}"
        case .horizontalLineBold: return "\u{f679}"
        case .horizontalLineLight: return "\u{f67a}"
        case .horizontalLineRegular: return "\u{f67b}"
        case .hotelingBold: return "\u{f67c}"
        case .hotelingFilled: return "\u{f67d}"
        case .hotelingLight: return "\u{f67e}"
        case .hotelingRegular: return "\u{f67f}"
        case .humidityBold: return "\u{f680}"
        case .humidityLight: return "\u{f681}"
        case .humidityRegular: return "\u{f682}"
        case .huntGroupBold: return "\u{f683}"
        case .huntGroupFilled: return "\u{f684}"
        case .huntGroupLight: return "\u{f685}"
        case .huntGroupRegular: return "\u{f686}"
        case .idleBold: return "\u{f687}"
        case .idleFilled: return "\u{f688}"
        case .idleLight: return "\u{f689}"
        case .idleRegular: return "\u{f68a}"
        case .immediateBold: return "\u{f68b}"
        case .immediateFilled: return "\u{f68c}"
        case .immediateLight: return "\u{f68d}"
        case .immediateRegular: return "\u{f68e}"
        case .importBold: return "\u{f68f}"
        case .importLight: return "\u{f690}"
        case .importRegular: return "\u{f691}"
        case .inCommonBold: return "\u{f692}"
        case .inCommonLight: return "\u{f693}"
        case .inCommonRegular: return "\u{f694}"
        case .inboxBold: return "\u{f695}"
        case .inboxFilled: return "\u{f696}"
        case .inboxLight: return "\u{f697}"
        case .inboxRegular: return "\u{f698}"
        case .includeBold: return "\u{f699}"
        case .includeLight: return "\u{f69a}"
        case .includeRegular: return "\u{f69b}"
        case .incognitoBold: return "\u{f69c}"
        case .incognitoFilled: return "\u{f69d}"
        case .incognitoLight: return "\u{f69e}"
        case .incognitoRegular: return "\u{f69f}"
        case .incomingCallLegacyBold: return "\u{f6a0}"
        case .incomingCallLegacyFilled: return "\u{f6a1}"
        case .incomingCallLegacyLight: return "\u{f6a2}"
        case .incomingCallLegacyRegular: return "\u{f6a3}"
        case .indentDecreaseBold: return "\u{f6a4}"
        case .indentDecreaseLight: return "\u{f6a5}"
        case .indentDecreaseRegular: return "\u{f6a6}"
        case .indentIncreaseBold: return "\u{f6a7}"
        case .indentIncreaseLight: return "\u{f6a8}"
        case .indentIncreaseRegular: return "\u{f6a9}"
        case .infoBadgeFilled: return "\u{f6aa}"
        case .infoCircleBold: return "\u{f6ab}"
        case .infoCircleFilled: return "\u{f6ac}"
        case .infoCircleLight: return "\u{f6ad}"
        case .infoCircleRegular: return "\u{f6ae}"
        case .infoCircleTwoBold: return "\u{f6af}"
        case .infoCircleTwoFilled: return "\u{f6b0}"
        case .infoCircleTwoLight: return "\u{f6b1}"
        case .infoCircleTwoRegular: return "\u{f6b2}"
        case .inputBold: return "\u{f6b3}"
        case .inputDisconnectedBold: return "\u{f6b4}"
        case .inputDisconnectedLight: return "\u{f6b5}"
        case .inputDisconnectedRegular: return "\u{f6b6}"
        case .inputLight: return "\u{f6b7}"
        case .inputRegular: return "\u{f6b8}"
        case .instantScheduleBold: return "\u{f6b9}"
        case .instantScheduleFilled: return "\u{f6ba}"
        case .instantScheduleLight: return "\u{f6bb}"
        case .instantScheduleRegular: return "\u{f6bc}"
        case .integerBold: return "\u{f6bd}"
        case .integerFilled: return "\u{f6be}"
        case .integerLight: return "\u{f6bf}"
        case .integerRegular: return "\u{f6c0}"
        case .integrationsBold: return "\u{f6c1}"
        case .integrationsLight: return "\u{f6c2}"
        case .integrationsRegular: return "\u{f6c3}"
        case .intelligentRoutingBold: return "\u{f6c4}"
        case .intelligentRoutingLight: return "\u{f6c5}"
        case .intelligentRoutingRegular: return "\u{f6c6}"
        case .interactionBold: return "\u{f6c7}"
        case .interactionFilled: return "\u{f6c8}"
        case .interactionLight: return "\u{f6c9}"
        case .interactionRegular: return "\u{f6ca}"
        case .invitedUserBold: return "\u{f6cb}"
        case .invitedUserLight: return "\u{f6cc}"
        case .invitedUserRegular: return "\u{f6cd}"
        case .italicBold: return "\u{f6ce}"
        case .italicFilled: return "\u{f6cf}"
        case .italicLight: return "\u{f6d0}"
        case .italicRegular: return "\u{f6d1}"
        case .joinAudioBold: return "\u{f6d2}"
        case .joinAudioFilled: return "\u{f6d3}"
        case .joinAudioLight: return "\u{f6d4}"
        case .joinAudioRegular: return "\u{f6d5}"
        case .keepInTouchBold: return "\u{f6d6}"
        case .keepInTouchFilled: return "\u{f6d7}"
        case .keepInTouchLight: return "\u{f6d8}"
        case .keepInTouchRegular: return "\u{f6d9}"
        case .keyboardBold: return "\u{f6da}"
        case .keyboardCloseBold: return "\u{f6db}"
        case .keyboardCloseLight: return "\u{f6dc}"
        case .keyboardCloseRegular: return "\u{f6dd}"
        case .keyboardLight: return "\u{f6de}"
        case .keyboardRegular: return "\u{f6df}"
        case .languageBold: return "\u{f6e0}"
        case .languageFilled: return "\u{f6e1}"
        case .languageLight: return "\u{f6e2}"
        case .languageRegular: return "\u{f6e3}"
        case .laptopBold: return "\u{f6e4}"
        case .laptopDisconnectedBold: return "\u{f6e5}"
        case .laptopDisconnectedLight: return "\u{f6e6}"
        case .laptopDisconnectedRegular: return "\u{f6e7}"
        case .laptopFilled: return "\u{f6e8}"
        case .laptopLight: return "\u{f6e9}"
        case .laptopRegular: return "\u{f6ea}"
        case .laserPointerBold: return "\u{f6eb}"
        case .laserPointerCursorBlackLight: return "\u{f6ec}"
        case .laserPointerCursorBlueLight: return "\u{f6ed}"
        case .laserPointerCursorGreenLight: return "\u{f6ee}"
        case .laserPointerCursorPurpleLight: return "\u{f6ef}"
        case .laserPointerCursorRedLight: return "\u{f6f0}"
        case .laserPointerCursorWhiteLight: return "\u{f6f1}"
        case .laserPointerCursorYellowLight: return "\u{f6f2}"
        case .laserPointerFilled: return "\u{f6f3}"
        case .laserPointerLight: return "\u{f6f4}"
        case .laserPointerRegular: return "\u{f6f5}"
        case .launchBold: return "\u{f6f6}"
        case .launchLight: return "\u{f6f7}"
        case .launchRegular: return "\u{f6f8}"
        case .layoutSideBySideVerticalBold: return "\u{f6f9}"
        case .layoutSideBySideVerticalFilled: return "\u{f6fa}"
        case .layoutSideBySideVerticalLight: return "\u{f6fb}"
        case .layoutSideBySideVerticalRegular: return "\u{f6fc}"
        case .leaveBreakoutSessionBold: return "\u{f6fd}"
        case .leaveBreakoutSessionLight: return "\u{f6fe}"
        case .leaveBreakoutSessionRegular: return "\u{f6ff}"
        case .leaveDeviceBold: return "\u{f700}"
        case .leaveDeviceLight: return "\u{f701}"
        case .leaveDeviceRegular: return "\u{f702}"
        case .likeBold: return "\u{f703}"
        case .likeFilled: return "\u{f704}"
        case .likeLight: return "\u{f705}"
        case .likeRegular: return "\u{f706}"
        case .linkBold: return "\u{f707}"
        case .linkLight: return "\u{f708}"
        case .linkRegular: return "\u{f709}"
        case .listBulletedBold: return "\u{f70a}"
        case .listBulletedLight: return "\u{f70b}"
        case .listBulletedRegular: return "\u{f70c}"
        case .listMenuBold: return "\u{f70d}"
        case .listMenuLight: return "\u{f70e}"
        case .listMenuRegular: return "\u{f70f}"
        case .listNumberedBold: return "\u{f710}"
        case .listNumberedLight: return "\u{f711}"
        case .listNumberedRegular: return "\u{f712}"
        case .liveBold: return "\u{f713}"
        case .liveFilled: return "\u{f714}"
        case .liveLight: return "\u{f715}"
        case .liveRegular: return "\u{f716}"
        case .locationBold: return "\u{f717}"
        case .locationFilled: return "\u{f718}"
        case .locationLight: return "\u{f719}"
        case .locationRegular: return "\u{f71a}"
        case .longTextBoxBold: return "\u{f71b}"
        case .longTextBoxLight: return "\u{f71c}"
        case .longTextBoxRegular: return "\u{f71d}"
        case .lowerHandBold: return "\u{f71e}"
        case .lowerHandLight: return "\u{f71f}"
        case .lowerHandRegular: return "\u{f720}"
        case .magicPenBold: return "\u{f721}"
        case .magicPenFilled: return "\u{f722}"
        case .magicPenLight: return "\u{f723}"
        case .magicPenRegular: return "\u{f724}"
        case .markAsUnreadBold: return "\u{f725}"
        case .markAsUnreadLight: return "\u{f726}"
        case .markAsUnreadRegular: return "\u{f727}"
        case .markdownBold: return "\u{f728}"
        case .markdownFilled: return "\u{f729}"
        case .markdownLight: return "\u{f72a}"
        case .markdownRegular: return "\u{f72b}"
        case .markerBold: return "\u{f72c}"
        case .markerFilled: return "\u{f72d}"
        case .markerLight: return "\u{f72e}"
        case .markerRegular: return "\u{f72f}"
        case .maximizeBold: return "\u{f730}"
        case .maximizeLight: return "\u{f731}"
        case .maximizeRegular: return "\u{f732}"
        case .mediaPlayerBold: return "\u{f733}"
        case .mediaPlayerLight: return "\u{f734}"
        case .mediaPlayerRegular: return "\u{f735}"
        case .mediaQualityGoodBold: return "\u{f736}"
        case .mediaQualityGoodFilled: return "\u{f737}"
        case .mediaQualityGoodLight: return "\u{f738}"
        case .mediaQualityGoodRegular: return "\u{f739}"
        case .mediaQualityPoorBold: return "\u{f73a}"
        case .mediaQualityPoorFilled: return "\u{f73b}"
        case .mediaQualityPoorLight: return "\u{f73c}"
        case .mediaQualityPoorRegular: return "\u{f73d}"
        case .mediaQualityUnstableBold: return "\u{f73e}"
        case .mediaQualityUnstableFilled: return "\u{f73f}"
        case .mediaQualityUnstableLight: return "\u{f740}"
        case .mediaQualityUnstableRegular: return "\u{f741}"
        case .meetBold: return "\u{f742}"
        case .meetEndBold: return "\u{f743}"
        case .meetEndLight: return "\u{f744}"
        case .meetEndRegular: return "\u{f745}"
        case .meetFilled: return "\u{f746}"
        case .meetLight: return "\u{f747}"
        case .meetRegular: return "\u{f748}"
        case .meetingSummaryBold: return "\u{f749}"
        case .meetingSummaryFilled: return "\u{f74a}"
        case .meetingSummaryLight: return "\u{f74b}"
        case .meetingSummaryRegular: return "\u{f74c}"
        case .meetingsBold: return "\u{f74d}"
        case .meetingsFilled: return "\u{f74e}"
        case .meetingsFocusMonthBold: return "\u{f74f}"
        case .meetingsFocusMonthLight: return "\u{f750}"
        case .meetingsFocusMonthRegular: return "\u{f751}"
        case .meetingsFocusOneDayBold: return "\u{f752}"
        case .meetingsFocusOneDayLight: return "\u{f753}"
        case .meetingsFocusOneDayRegular: return "\u{f754}"
        case .meetingsFocusThreeDayBold: return "\u{f755}"
        case .meetingsFocusThreeDayLight: return "\u{f756}"
        case .meetingsFocusThreeDayRegular: return "\u{f757}"
        case .meetingsFocusUpcomingBold: return "\u{f758}"
        case .meetingsFocusUpcomingLight: return "\u{f759}"
        case .meetingsFocusUpcomingRegular: return "\u{f75a}"
        case .meetingsLight: return "\u{f75b}"
        case .meetingsPresenceBadgeFilled: return "\u{f75c}"
        case .meetingsPresenceBold: return "\u{f75d}"
        case .meetingsPresenceFilled: return "\u{f75e}"
        case .meetingsPresenceLight: return "\u{f75f}"
        case .meetingsPresenceRegular: return "\u{f760}"
        case .meetingsRegular: return "\u{f761}"
        case .meetingsTeamBold: return "\u{f762}"
        case .meetingsTeamFilled: return "\u{f763}"
        case .meetingsTeamLight: return "\u{f764}"
        case .meetingsTeamNewBold: return "\u{f765}"
        case .meetingsTeamNewLight: return "\u{f766}"
        case .meetingsTeamNewRegular: return "\u{f767}"
        case .meetingsTeamRegular: return "\u{f768}"
        case .mentionBold: return "\u{f769}"
        case .mentionLight: return "\u{f76a}"
        case .mentionRegular: return "\u{f76b}"
        case .messageQueingBold: return "\u{f76c}"
        case .messageQueingLight: return "\u{f76d}"
        case .messageQueingRegular: return "\u{f76e}"
        case .microphoneBold: return "\u{f76f}"
        case .microphoneFilled: return "\u{f770}"
        case .microphoneHardMutedBold: return "\u{f771}"
        case .microphoneHardMutedCircleFilled: return "\u{f772}"
        case .microphoneHardMutedLight: return "\u{f773}"
        case .microphoneHardMutedRegular: return "\u{f774}"
        case .microphoneLight: return "\u{f775}"
        case .microphoneMusicModeBold: return "\u{f776}"
        case .microphoneMusicModeLight: return "\u{f777}"
        case .microphoneMusicModeOnBold: return "\u{f778}"
        case .microphoneMusicModeOnLight: return "\u{f779}"
        case .microphoneMusicModeOnRegular: return "\u{f77a}"
        case .microphoneMusicModeRegular: return "\u{f77b}"
        case .microphoneMutedBold: return "\u{f77c}"
        case .microphoneMutedCircleFilled: return "\u{f77d}"
        case .microphoneMutedFilled: return "\u{f77e}"
        case .microphoneMutedLight: return "\u{f77f}"
        case .microphoneMutedRegular: return "\u{f780}"
        case .microphoneOnBold: return "\u{f781}"
        case .microphoneOnLight: return "\u{f782}"
        case .microphoneOnRegular: return "\u{f783}"
        case .microphoneOptAllBold: return "\u{f784}"
        case .microphoneOptAllLight: return "\u{f785}"
        case .microphoneOptAllMutedBold: return "\u{f786}"
        case .microphoneOptAllMutedLight: return "\u{f787}"
        case .microphoneOptAllMutedRegular: return "\u{f788}"
        case .microphoneOptAllOnBold: return "\u{f789}"
        case .microphoneOptAllOnLight: return "\u{f78a}"
        case .microphoneOptAllOnRegular: return "\u{f78b}"
        case .microphoneOptAllRegular: return "\u{f78c}"
        case .microphoneOptMeBold: return "\u{f78d}"
        case .microphoneOptMeLight: return "\u{f78e}"
        case .microphoneOptMeMutedBold: return "\u{f78f}"
        case .microphoneOptMeMutedLight: return "\u{f790}"
        case .microphoneOptMeMutedRegular: return "\u{f791}"
        case .microphoneOptMeOnBold: return "\u{f792}"
        case .microphoneOptMeOnLight: return "\u{f793}"
        case .microphoneOptMeOnRegular: return "\u{f794}"
        case .microphoneOptMeRegular: return "\u{f795}"
        case .microphoneRegular: return "\u{f796}"
        case .mindMapBold: return "\u{f797}"
        case .mindMapLight: return "\u{f798}"
        case .mindMapRegular: return "\u{f799}"
        case .minimizeBold: return "\u{f79a}"
        case .minimizeLight: return "\u{f79b}"
        case .minimizeRegular: return "\u{f79c}"
        case .minusBold: return "\u{f79d}"
        case .minusLight: return "\u{f79e}"
        case .minusRegular: return "\u{f79f}"
        case .mirrorBold: return "\u{f7a0}"
        case .mirrorFilled: return "\u{f7a1}"
        case .mirrorLight: return "\u{f7a2}"
        case .mirrorRegular: return "\u{f7a3}"
        case .mmsFilled: return "\u{f7a4}"
        case .moderatorBold: return "\u{f7a5}"
        case .moderatorLight: return "\u{f7a6}"
        case .moderatorRegular: return "\u{f7a7}"
        case .monitoringBold: return "\u{f7a8}"
        case .monitoringLight: return "\u{f7a9}"
        case .monitoringRegular: return "\u{f7aa}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7ab}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7ac}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7ad}"
        case .moreAdrBold: return "\u{f7ae}"
        case .moreAdrLight: return "\u{f7af}"
        case .moreAdrRegular: return "\u{f7b0}"
        case .moreBold: return "\u{f7b1}"
        case .moreCircleBold: return "\u{f7b2}"
        case .moreCircleFilled: return "\u{f7b3}"
        case .moreCircleLight: return "\u{f7b4}"
        case .moreCircleRegular: return "\u{f7b5}"
        case .moreLight: return "\u{f7b6}"
        case .moreRegular: return "\u{f7b7}"
        case .mouseCursorBold: return "\u{f7b8}"
        case .mouseCursorLight: return "\u{f7b9}"
        case .mouseCursorRegular: return "\u{f7ba}"
        case .moveCallInAdrBold: return "\u{f7bb}"
        case .moveCallInAdrLight: return "\u{f7bc}"
        case .moveCallInAdrRegular: return "\u{f7bd}"
        case .moveCallInIphBold: return "\u{f7be}"
        case .moveCallInIphLight: return "\u{f7bf}"
        case .moveCallInIphRegular: return "\u{f7c0}"
        case .moveCallInLaptopBold: return "\u{f7c1}"
        case .moveCallInLaptopLight: return "\u{f7c2}"
        case .moveCallInLaptopRegular: return "\u{f7c3}"
        case .moveCallInOutAdrBold: return "\u{f7c4}"
        case .moveCallInOutAdrLight: return "\u{f7c5}"
        case .moveCallInOutAdrRegular: return "\u{f7c6}"
        case .moveCallInOutIphBold: return "\u{f7c7}"
        case .moveCallInOutIphLight: return "\u{f7c8}"
        case .moveCallInOutIphRegular: return "\u{f7c9}"
        case .moveCallInTabletBold: return "\u{f7ca}"
        case .moveCallInTabletLight: return "\u{f7cb}"
        case .moveCallInTabletRegular: return "\u{f7cc}"
        case .moveCallOutAdrBold: return "\u{f7cd}"
        case .moveCallOutAdrLight: return "\u{f7ce}"
        case .moveCallOutAdrRegular: return "\u{f7cf}"
        case .moveCallOutIphBold: return "\u{f7d0}"
        case .moveCallOutIphLight: return "\u{f7d1}"
        case .moveCallOutIphRegular: return "\u{f7d2}"
        case .moveCallOutLaptopBold: return "\u{f7d3}"
        case .moveCallOutLaptopLight: return "\u{f7d4}"
        case .moveCallOutLaptopRegular: return "\u{f7d5}"
        case .moveCallOutTabletBold: return "\u{f7d6}"
        case .moveCallOutTabletLight: return "\u{f7d7}"
        case .moveCallOutTabletRegular: return "\u{f7d8}"
        case .moveToScreenBold: return "\u{f7d9}"
        case .moveToScreenLight: return "\u{f7da}"
        case .moveToScreenRegular: return "\u{f7db}"
        case .multilineChartBold: return "\u{f7dc}"
        case .multilineChartFilled: return "\u{f7dd}"
        case .multilineChartLight: return "\u{f7de}"
        case .multilineChartRegular: return "\u{f7df}"
        case .multimediaBold: return "\u{f7e0}"
        case .multimediaFilled: return "\u{f7e1}"
        case .multimediaLight: return "\u{f7e2}"
        case .multimediaRegular: return "\u{f7e3}"
        case .multipledDevicesBold: return "\u{f7e4}"
        case .multipledDevicesLight: return "\u{f7e5}"
        case .multipledDevicesRegular: return "\u{f7e6}"
        case .musicModeCircleBold: return "\u{f7e7}"
        case .musicModeCircleFilled: return "\u{f7e8}"
        case .musicModeCircleLight: return "\u{f7e9}"
        case .musicModeCircleRegular: return "\u{f7ea}"
        case .musicNoteBold: return "\u{f7eb}"
        case .musicNoteFilled: return "\u{f7ec}"
        case .musicNoteLight: return "\u{f7ed}"
        case .musicNoteRegular: return "\u{f7ee}"
        case .muteOnEntryBold: return "\u{f7ef}"
        case .muteOnEntryFilled: return "\u{f7f0}"
        case .muteOnEntryLight: return "\u{f7f1}"
        case .muteOnEntryRegular: return "\u{f7f2}"
        case .newManagerBold: return "\u{f7f3}"
        case .newManagerLight: return "\u{f7f4}"
        case .newManagerRegular: return "\u{f7f5}"
        case .newTitleBold: return "\u{f7f6}"
        case .newTitleLight: return "\u{f7f7}"
        case .newTitleRegular: return "\u{f7f8}"
        case .newVoicemailBold: return "\u{f7f9}"
        case .newVoicemailLight: return "\u{f7fa}"
        case .newVoicemailRegular: return "\u{f7fb}"
        case .newWhiteboardBold: return "\u{f7fc}"
        case .newWhiteboardLight: return "\u{f7fd}"
        case .newWhiteboardRegular: return "\u{f7fe}"
        case .nextBold: return "\u{f7ff}"
        case .nextLight: return "\u{f800}"
        case .nextRegular: return "\u{f801}"
        case .noDevicesBold: return "\u{f802}"
        case .noDevicesLight: return "\u{f803}"
        case .noDevicesRegular: return "\u{f804}"
        case .noiseDetectedCanceledFilled: return "\u{f805}"
        case .noiseDetectedFilled: return "\u{f806}"
        case .noiseNoneCanceledFilled: return "\u{f807}"
        case .noiseNoneFilled: return "\u{f808}"
        case .noiseRemovalBold: return "\u{f809}"
        case .noiseRemovalLight: return "\u{f80a}"
        case .noiseRemovalRegular: return "\u{f80b}"
        case .noteBold: return "\u{f80c}"
        case .noteLight: return "\u{f80d}"
        case .notePptBold: return "\u{f80e}"
        case .notePptLight: return "\u{f80f}"
        case .notePptRegular: return "\u{f810}"
        case .noteRegular: return "\u{f811}"
        case .notesBold: return "\u{f812}"
        case .notesFilled: return "\u{f813}"
        case .notesLight: return "\u{f814}"
        case .notesRegular: return "\u{f815}"
        case .numberBold: return "\u{f816}"
        case .numberLight: return "\u{f817}"
        case .numberRegular: return "\u{f818}"
        case .oldRemoteBold: return "\u{f819}"
        case .oldRemoteLight: return "\u{f81a}"
        case .oldRemoteRegular: return "\u{f81b}"
        case .oldTouchBold: return "\u{f81c}"
        case .oldTouchLight: return "\u{f81d}"
        case .oldTouchRegular: return "\u{f81e}"
        case .oneColumnBold: return "\u{f81f}"
        case .oneColumnLight: return "\u{f820}"
        case .oneColumnRegular: return "\u{f821}"
        case .oneTimeBold: return "\u{f822}"
        case .oneTimeLight: return "\u{f823}"
        case .oneTimeRegular: return "\u{f824}"
        case .openInFolderBold: return "\u{f825}"
        case .openInFolderLight: return "\u{f826}"
        case .openInFolderRegular: return "\u{f827}"
        case .openPagesBold: return "\u{f828}"
        case .openPagesLight: return "\u{f829}"
        case .openPagesRegular: return "\u{f82a}"
        case .otherNumberBold: return "\u{f82b}"
        case .otherNumberFilled: return "\u{f82c}"
        case .otherNumberLight: return "\u{f82d}"
        case .otherNumberRegular: return "\u{f82e}"
        case .otherNumberWarningBold: return "\u{f82f}"
        case .otherNumberWarningLight: return "\u{f830}"
        case .otherNumberWarningRegular: return "\u{f831}"
        case .outgoingCallLegacyBold: return "\u{f832}"
        case .outgoingCallLegacyFilled: return "\u{f833}"
        case .outgoingCallLegacyLight: return "\u{f834}"
        case .outgoingCallLegacyRegular: return "\u{f835}"
        case .overflowLeftBold: return "\u{f836}"
        case .overflowLeftLight: return "\u{f837}"
        case .overflowLeftRegular: return "\u{f838}"
        case .overflowRightBold: return "\u{f839}"
        case .overflowRightLight: return "\u{f83a}"
        case .overflowRightRegular: return "\u{f83b}"
        case .pairedCameraBold: return "\u{f83c}"
        case .pairedCameraLight: return "\u{f83d}"
        case .pairedCameraRegular: return "\u{f83e}"
        case .pairedDeviceBold: return "\u{f83f}"
        case .pairedDeviceLight: return "\u{f840}"
        case .pairedDeviceRegular: return "\u{f841}"
        case .pairedHandsetBold: return "\u{f842}"
        case .pairedHandsetLight: return "\u{f843}"
        case .pairedHandsetRegular: return "\u{f844}"
        case .pairingBold: return "\u{f845}"
        case .pairingLight: return "\u{f846}"
        case .pairingRegular: return "\u{f847}"
        case .parenthesisBold: return "\u{f848}"
        case .parenthesisFilled: return "\u{f849}"
        case .parenthesisLight: return "\u{f84a}"
        case .parenthesisRegular: return "\u{f84b}"
        case .parkedBold: return "\u{f84c}"
        case .parkedFilled: return "\u{f84d}"
        case .parkedLight: return "\u{f84e}"
        case .parkedRegular: return "\u{f84f}"
        case .parseBold: return "\u{f850}"
        case .parseLight: return "\u{f851}"
        case .parseRegular: return "\u{f852}"
        case .partialBold: return "\u{f853}"
        case .partialLight: return "\u{f854}"
        case .partialRegular: return "\u{f855}"
        case .participantAddBold: return "\u{f856}"
        case .participantAddLight: return "\u{f857}"
        case .participantAddRegular: return "\u{f858}"
        case .participantBlockedBold: return "\u{f859}"
        case .participantBlockedLight: return "\u{f85a}"
        case .participantBlockedRegular: return "\u{f85b}"
        case .participantBold: return "\u{f85c}"
        case .participantFilled: return "\u{f85d}"
        case .participantLight: return "\u{f85e}"
        case .participantListBold: return "\u{f85f}"
        case .participantListFilled: return "\u{f860}"
        case .participantListLight: return "\u{f861}"
        case .participantListRegular: return "\u{f862}"
        case .participantRegular: return "\u{f863}"
        case .participantRemoveBold: return "\u{f864}"
        case .participantRemoveLight: return "\u{f865}"
        case .participantRemoveRegular: return "\u{f866}"
        case .participantUnknownBold: return "\u{f867}"
        case .participantUnknownLight: return "\u{f868}"
        case .participantUnknownRegular: return "\u{f869}"
        case .passMouseBold: return "\u{f86a}"
        case .passMouseLight: return "\u{f86b}"
        case .passMouseRegular: return "\u{f86c}"
        case .pauseBadgeFilled: return "\u{f86d}"
        case .pauseBold: return "\u{f86e}"
        case .pauseFilled: return "\u{f86f}"
        case .pauseLight: return "\u{f870}"
        case .pauseRegular: return "\u{f871}"
        case .peopleAddBold: return "\u{f872}"
        case .peopleAddFilled: return "\u{f873}"
        case .peopleAddLight: return "\u{f874}"
        case .peopleAddRegular: return "\u{f875}"
        case .peopleBold: return "\u{f876}"
        case .peopleCircleBold: return "\u{f877}"
        case .peopleCircleFilled: return "\u{f878}"
        case .peopleCircleLight: return "\u{f879}"
        case .peopleCircleRegular: return "\u{f87a}"
        case .peopleFilled: return "\u{f87b}"
        case .peopleInsightsBold: return "\u{f87c}"
        case .peopleInsightsFilled: return "\u{f87d}"
        case .peopleInsightsLight: return "\u{f87e}"
        case .peopleInsightsRegular: return "\u{f87f}"
        case .peopleLight: return "\u{f880}"
        case .peopleRegular: return "\u{f881}"
        case .phoneAlertBold: return "\u{f882}"
        case .phoneAlertLight: return "\u{f883}"
        case .phoneAlertRegular: return "\u{f884}"
        case .phoneBadgeFilled: return "\u{f885}"
        case .phoneBold: return "\u{f886}"
        case .phoneFilled: return "\u{f887}"
        case .phoneLight: return "\u{f888}"
        case .phoneMutedBold: return "\u{f889}"
        case .phoneMutedLight: return "\u{f88a}"
        case .phoneMutedRegular: return "\u{f88b}"
        case .phonePrivateBold: return "\u{f88c}"
        case .phonePrivateLight: return "\u{f88d}"
        case .phonePrivateRegular: return "\u{f88e}"
        case .phoneRegular: return "\u{f88f}"
        case .phoneReplyAllBold: return "\u{f890}"
        case .phoneReplyAllLight: return "\u{f891}"
        case .phoneReplyAllRegular: return "\u{f892}"
        case .phoneReplyBold: return "\u{f893}"
        case .phoneReplyLight: return "\u{f894}"
        case .phoneReplyRegular: return "\u{f895}"
        case .pickerBold: return "\u{f896}"
        case .pickerLight: return "\u{f897}"
        case .pickerRegular: return "\u{f898}"
        case .pieChartBold: return "\u{f899}"
        case .pieChartFilled: return "\u{f89a}"
        case .pieChartLight: return "\u{f89b}"
        case .pieChartRegular: return "\u{f89c}"
        case .pinBold: return "\u{f89d}"
        case .pinFilled: return "\u{f89e}"
        case .pinLight: return "\u{f89f}"
        case .pinListActivityBold: return "\u{f8a0}"
        case .pinListActivityLight: return "\u{f8a1}"
        case .pinListActivityRegular: return "\u{f8a2}"
        case .pinListBold: return "\u{f8a3}"
        case .pinListLight: return "\u{f8a4}"
        case .pinListRegular: return "\u{f8a5}"
        case .pinMutedBold: return "\u{f8a6}"
        case .pinMutedFilled: return "\u{f8a7}"
        case .pinMutedLight: return "\u{f8a8}"
        case .pinMutedRegular: return "\u{f8a9}"
        case .pinRegular: return "\u{f8aa}"
        case .pipBold: return "\u{f8ab}"
        case .pipEnterBold: return "\u{f8ac}"
        case .pipEnterLight: return "\u{f8ad}"
        case .pipEnterRegular: return "\u{f8ae}"
        case .pipExitBold: return "\u{f8af}"
        case .pipExitLight: return "\u{f8b0}"
        case .pipExitRegular: return "\u{f8b1}"
        case .pipFilled: return "\u{f8b2}"
        case .pipLight: return "\u{f8b3}"
        case .pipRegular: return "\u{f8b4}"
        case .placeholderBold: return "\u{f8b5}"
        case .placeholderFilled: return "\u{f8b6}"
        case .placeholderLight: return "\u{f8b7}"
        case .placeholderRegular: return "\u{f8b8}"
        case .playBold: return "\u{f8b9}"
        case .playCircleBold: return "\u{f8ba}"
        case .playCircleFilled: return "\u{f8bb}"
        case .playCircleLight: return "\u{f8bc}"
        case .playCircleRegular: return "\u{f8bd}"
        case .playFilled: return "\u{f8be}"
        case .playLight: return "\u{f8bf}"
        case .playRegular: return "\u{f8c0}"
        case .plugAcBold: return "\u{f8c1}"
        case .plugAcLight: return "\u{f8c2}"
        case .plugAcRegular: return "\u{f8c3}"
        case .plusBold: return "\u{f8c4}"
        case .plusCircleBold: return "\u{f8c5}"
        case .plusCircleFilled: return "\u{f8c6}"
        case .plusCircleLight: return "\u{f8c7}"
        case .plusCircleRegular: return "\u{f8c8}"
        case .plusLight: return "\u{f8c9}"
        case .plusRegular: return "\u{f8ca}"
        case .pmrBold: return "\u{f8cb}"
        case .pmrFilled: return "\u{f8cc}"
        case .pmrLight: return "\u{f8cd}"
        case .pmrRegular: return "\u{f8ce}"
        case .pollBold: return "\u{f8cf}"
        case .pollFilled: return "\u{f8d0}"
        case .pollLight: return "\u{f8d1}"
        case .pollRegular: return "\u{f8d2}"
        case .popInBold: return "\u{f8d3}"
        case .popInLight: return "\u{f8d4}"
        case .popInRegular: return "\u{f8d5}"
        case .popOutBold: return "\u{f8d6}"
        case .popOutLight: return "\u{f8d7}"
        case .popOutRegular: return "\u{f8d8}"
        case .popUpBold: return "\u{f8d9}"
        case .popUpLight: return "\u{f8da}"
        case .popUpRegular: return "\u{f8db}"
        case .portraitLandscapeBold: return "\u{f8dc}"
        case .portraitLandscapeLight: return "\u{f8dd}"
        case .portraitLandscapeRegular: return "\u{f8de}"
        case .potentialFraudBold: return "\u{f8df}"
        case .potentialFraudFilled: return "\u{f8e0}"
        case .potentialFraudLight: return "\u{f8e1}"
        case .potentialFraudRegular: return "\u{f8e2}"
        case .powerAcBold: return "\u{f8e3}"
        case .powerAcLight: return "\u{f8e4}"
        case .powerAcRegular: return "\u{f8e5}"
        case .powerBold: return "\u{f8e6}"
        case .powerLight: return "\u{f8e7}"
        case .powerRegular: return "\u{f8e8}"
        case .preHeaderBold: return "\u{f8e9}"
        case .preHeaderLight: return "\u{f8ea}"
        case .preHeaderRegular: return "\u{f8eb}"
        case .premiumBold: return "\u{f8ec}"
        case .premiumLight: return "\u{f8ed}"
        case .premiumRegular: return "\u{f8ee}"
        case .presentationBold: return "\u{f8ef}"
        case .presentationLight: return "\u{f8f0}"
        case .presentationRegular: return "\u{f8f1}"
        case .preventDownloadBold: return "\u{f8f2}"
        case .preventDownloadFilled: return "\u{f8f3}"
        case .preventDownloadLight: return "\u{f8f4}"
        case .preventDownloadRegular: return "\u{f8f5}"
        case .primaryParticipantBold: return "\u{f8f6}"
        case .primaryParticipantLight: return "\u{f8f7}"
        case .primaryParticipantRegular: return "\u{f8f8}"
        case .printBold: return "\u{f8f9}"
        case .printLight: return "\u{f8fa}"
        case .printRegular: return "\u{f8fb}"
        case .priorityBadgeFilled: return "\u{f8fc}"
        case .priorityCircleBold: return "\u{f8fd}"
        case .priorityCircleFilled: return "\u{f8fe}"
        case .priorityCircleLight: return "\u{f8ff}"
        case .priorityCircleRegular: return "\u{f900}"
        case .priorityCircleTwoBold: return "\u{f901}"
        case .priorityCircleTwoFilled: return "\u{f902}"
        case .priorityCircleTwoLight: return "\u{f903}"
        case .priorityCircleTwoRegular: return "\u{f904}"
        case .priorityWaveBold: return "\u{f905}"
        case .priorityWaveLight: return "\u{f906}"
        case .priorityWaveRegular: return "\u{f907}"
        case .privacyCircleBold: return "\u{f908}"
        case .privacyCircleFilled: return "\u{f909}"
        case .privacyCircleLight: return "\u{f90a}"
        case .privacyCircleRegular: return "\u{f90b}"
        case .privateBold: return "\u{f90c}"
        case .privateCircleBold: return "\u{f90d}"
        case .privateCircleFilled: return "\u{f90e}"
        case .privateCircleLight: return "\u{f90f}"
        case .privateCircleRegular: return "\u{f910}"
        case .privateLight: return "\u{f911}"
        case .privateMeetingBold: return "\u{f912}"
        case .privateMeetingLight: return "\u{f913}"
        case .privateMeetingRegular: return "\u{f914}"
        case .privateRegular: return "\u{f915}"
        case .productDemoBold: return "\u{f916}"
        case .productDemoLight: return "\u{f917}"
        case .productDemoRegular: return "\u{f918}"
        case .promptsAiBold: return "\u{f919}"
        case .promptsAiLight: return "\u{f91a}"
        case .promptsAiRegular: return "\u{f91b}"
        case .proximityBold: return "\u{f91c}"
        case .proximityLight: return "\u{f91d}"
        case .proximityMutedBold: return "\u{f91e}"
        case .proximityMutedLight: return "\u{f91f}"
        case .proximityMutedRegular: return "\u{f920}"
        case .proximityRegular: return "\u{f921}"
        case .proximityVideoBold: return "\u{f922}"
        case .proximityVideoLight: return "\u{f923}"
        case .proximityVideoRegular: return "\u{f924}"
        case .ptoPresenceBold: return "\u{f925}"
        case .ptoPresenceFilled: return "\u{f926}"
        case .ptoPresenceLight: return "\u{f927}"
        case .ptoPresenceRegular: return "\u{f928}"
        case .pullCallBold: return "\u{f929}"
        case .pullCallFilled: return "\u{f92a}"
        case .pullCallLight: return "\u{f92b}"
        case .pullCallRegular: return "\u{f92c}"
        case .qABold: return "\u{f92d}"
        case .qAFilled: return "\u{f92e}"
        case .qALight: return "\u{f92f}"
        case .qARegular: return "\u{f930}"
        case .qrCodeBold: return "\u{f931}"
        case .qrCodeLight: return "\u{f932}"
        case .qrCodeRegular: return "\u{f933}"
        case .qrCodeScanBold: return "\u{f934}"
        case .qrCodeScanLight: return "\u{f935}"
        case .qrCodeScanRegular: return "\u{f936}"
        case .qualityBold: return "\u{f937}"
        case .qualityLight: return "\u{f938}"
        case .qualityRegular: return "\u{f939}"
        case .queueContactBold: return "\u{f93a}"
        case .queueContactFilled: return "\u{f93b}"
        case .queueContactLight: return "\u{f93c}"
        case .queueContactRegular: return "\u{f93d}"
        case .quietBold: return "\u{f93e}"
        case .quietHoursPresenceBold: return "\u{f93f}"
        case .quietHoursPresenceFilled: return "\u{f940}"
        case .quietHoursPresenceLight: return "\u{f941}"
        case .quietHoursPresenceRegular: return "\u{f942}"
        case .quietLight: return "\u{f943}"
        case .quietRegular: return "\u{f944}"
        case .radioButtonGroupBold: return "\u{f945}"
        case .radioButtonGroupLight: return "\u{f946}"
        case .radioButtonGroupRegular: return "\u{f947}"
        case .raiseHandBold: return "\u{f948}"
        case .raiseHandCircleFilled: return "\u{f949}"
        case .raiseHandFilled: return "\u{f94a}"
        case .raiseHandLight: return "\u{f94b}"
        case .raiseHandRegular: return "\u{f94c}"
        case .ramBold: return "\u{f94d}"
        case .ramLight: return "\u{f94e}"
        case .ramRegular: return "\u{f94f}"
        case .reactionsBold: return "\u{f950}"
        case .reactionsFilled: return "\u{f951}"
        case .reactionsLight: return "\u{f952}"
        case .reactionsRegular: return "\u{f953}"
        case .reactivateBold: return "\u{f954}"
        case .reactivateLight: return "\u{f955}"
        case .reactivateRegular: return "\u{f956}"
        case .receiveVoiceBold: return "\u{f957}"
        case .receiveVoiceFilled: return "\u{f958}"
        case .receiveVoiceLight: return "\u{f959}"
        case .receiveVoiceRegular: return "\u{f95a}"
        case .recentsBold: return "\u{f95b}"
        case .recentsFilled: return "\u{f95c}"
        case .recentsLight: return "\u{f95d}"
        case .recentsPresenceBadgeFilled: return "\u{f95e}"
        case .recentsPresenceBold: return "\u{f95f}"
        case .recentsPresenceFilled: return "\u{f960}"
        case .recentsPresenceLight: return "\u{f961}"
        case .recentsPresenceRegular: return "\u{f962}"
        case .recentsRegular: return "\u{f963}"
        case .recordActiveBadgeFilled: return "\u{f964}"
        case .recordActiveBold: return "\u{f965}"
        case .recordActiveFilled: return "\u{f966}"
        case .recordActiveLight: return "\u{f967}"
        case .recordActiveRegular: return "\u{f968}"
        case .recordBold: return "\u{f969}"
        case .recordFilled: return "\u{f96a}"
        case .recordLight: return "\u{f96b}"
        case .recordPausedBadgeFilled: return "\u{f96c}"
        case .recordPausedBold: return "\u{f96d}"
        case .recordPausedFilled: return "\u{f96e}"
        case .recordPausedLight: return "\u{f96f}"
        case .recordPausedRegular: return "\u{f970}"
        case .recordRegular: return "\u{f971}"
        case .recurringBold: return "\u{f972}"
        case .recurringLight: return "\u{f973}"
        case .recurringOffBold: return "\u{f974}"
        case .recurringOffLight: return "\u{f975}"
        case .recurringOffRegular: return "\u{f976}"
        case .recurringRegular: return "\u{f977}"
        case .redoBold: return "\u{f978}"
        case .redoLight: return "\u{f979}"
        case .redoRegular: return "\u{f97a}"
        case .refreshBold: return "\u{f97b}"
        case .refreshLight: return "\u{f97c}"
        case .refreshRegular: return "\u{f97d}"
        case .remoteDesktopControlBold: return "\u{f97e}"
        case .remoteDesktopControlFilled: return "\u{f97f}"
        case .remoteDesktopControlLight: return "\u{f980}"
        case .remoteDesktopControlRegular: return "\u{f981}"
        case .removeBold: return "\u{f982}"
        case .removeFilled: return "\u{f983}"
        case .removeLight: return "\u{f984}"
        case .removeRegular: return "\u{f985}"
        case .replyBold: return "\u{f986}"
        case .replyFilled: return "\u{f987}"
        case .replyLight: return "\u{f988}"
        case .replyListBold: return "\u{f989}"
        case .replyListLight: return "\u{f98a}"
        case .replyListRegular: return "\u{f98b}"
        case .replyPrivatelyBold: return "\u{f98c}"
        case .replyPrivatelyLight: return "\u{f98d}"
        case .replyPrivatelyRegular: return "\u{f98e}"
        case .replyRegular: return "\u{f98f}"
        case .resetBold: return "\u{f990}"
        case .resetLight: return "\u{f991}"
        case .resetRegular: return "\u{f992}"
        case .resizeCornerBold: return "\u{f993}"
        case .resizeCornerLight: return "\u{f994}"
        case .resizeCornerRegular: return "\u{f995}"
        case .responsiveMobileBold: return "\u{f996}"
        case .responsiveMobileLight: return "\u{f997}"
        case .responsiveMobileRegular: return "\u{f998}"
        case .restartBold: return "\u{f999}"
        case .restartLight: return "\u{f99a}"
        case .restartRegular: return "\u{f99b}"
        case .retrieveCallBold: return "\u{f99c}"
        case .retrieveCallFilled: return "\u{f99d}"
        case .retrieveCallLight: return "\u{f99e}"
        case .retrieveCallRegular: return "\u{f99f}"
        case .returnBold: return "\u{f9a0}"
        case .returnLight: return "\u{f9a1}"
        case .returnRegular: return "\u{f9a2}"
        case .rewindTenSecBold: return "\u{f9a3}"
        case .rewindTenSecLight: return "\u{f9a4}"
        case .rewindTenSecRegular: return "\u{f9a5}"
        case .ringtoneBold: return "\u{f9a6}"
        case .ringtoneLight: return "\u{f9a7}"
        case .ringtoneRegular: return "\u{f9a8}"
        case .roomCalendarBold: return "\u{f9a9}"
        case .roomCalendarLight: return "\u{f9aa}"
        case .roomCalendarRegular: return "\u{f9ab}"
        case .roomLightsBold: return "\u{f9ac}"
        case .roomLightsFilled: return "\u{f9ad}"
        case .roomLightsLight: return "\u{f9ae}"
        case .roomLightsRegular: return "\u{f9af}"
        case .rotateContentBold: return "\u{f9b0}"
        case .rotateContentFilled: return "\u{f9b1}"
        case .rotateContentLight: return "\u{f9b2}"
        case .rotateContentRegular: return "\u{f9b3}"
        case .rssBold: return "\u{f9b4}"
        case .rssFilled: return "\u{f9b5}"
        case .rssLight: return "\u{f9b6}"
        case .rssRegular: return "\u{f9b7}"
        case .ruleBasedBold: return "\u{f9b8}"
        case .ruleBasedLight: return "\u{f9b9}"
        case .ruleBasedRegular: return "\u{f9ba}"
        case .runningApplicationBold: return "\u{f9bb}"
        case .runningApplicationFilled: return "\u{f9bc}"
        case .runningApplicationLight: return "\u{f9bd}"
        case .runningApplicationRegular: return "\u{f9be}"
        case .saveBold: return "\u{f9bf}"
        case .saveLight: return "\u{f9c0}"
        case .saveRegular: return "\u{f9c1}"
        case .saveTranscriptBold: return "\u{f9c2}"
        case .saveTranscriptFilled: return "\u{f9c3}"
        case .saveTranscriptLight: return "\u{f9c4}"
        case .saveTranscriptRegular: return "\u{f9c5}"
        case .scanBold: return "\u{f9c6}"
        case .scanLight: return "\u{f9c7}"
        case .scanRegular: return "\u{f9c8}"
        case .scheduleAiBold: return "\u{f9c9}"
        case .scheduleAiLight: return "\u{f9ca}"
        case .scheduleAiRegular: return "\u{f9cb}"
        case .scheduleSendBold: return "\u{f9cc}"
        case .scheduleSendFilled: return "\u{f9cd}"
        case .scheduleSendLight: return "\u{f9ce}"
        case .scheduleSendRegular: return "\u{f9cf}"
        case .scheduleWinnerBold: return "\u{f9d0}"
        case .scheduleWinnerFilled: return "\u{f9d1}"
        case .scheduleWinnerLight: return "\u{f9d2}"
        case .scheduleWinnerRegular: return "\u{f9d3}"
        case .schedulerAvailableBold: return "\u{f9d4}"
        case .schedulerAvailableLight: return "\u{f9d5}"
        case .schedulerAvailableRegular: return "\u{f9d6}"
        case .schedulerNotWorkingHoursBold: return "\u{f9d7}"
        case .schedulerNotWorkingHoursLight: return "\u{f9d8}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9d9}"
        case .schedulerUnavailableBold: return "\u{f9da}"
        case .schedulerUnavailableLight: return "\u{f9db}"
        case .schedulerUnavailableRegular: return "\u{f9dc}"
        case .schedulerUnknownBold: return "\u{f9dd}"
        case .schedulerUnknownLight: return "\u{f9de}"
        case .schedulerUnknownRegular: return "\u{f9df}"
        case .screenshotBold: return "\u{f9e0}"
        case .screenshotDocBold: return "\u{f9e1}"
        case .screenshotDocFilled: return "\u{f9e2}"
        case .screenshotDocLight: return "\u{f9e3}"
        case .screenshotDocRegular: return "\u{f9e4}"
        case .screenshotLight: return "\u{f9e5}"
        case .screenshotRegular: return "\u{f9e6}"
        case .searchAiBold: return "\u{f9e7}"
        case .searchAiLight: return "\u{f9e8}"
        case .searchAiRegular: return "\u{f9e9}"
        case .searchBold: return "\u{f9ea}"
        case .searchFilled: return "\u{f9eb}"
        case .searchLight: return "\u{f9ec}"
        case .searchRegular: return "\u{f9ed}"
        case .secondaryArrowBold: return "\u{f9ee}"
        case .secondaryArrowLight: return "\u{f9ef}"
        case .secondaryArrowRegular: return "\u{f9f0}"
        case .secureCallLockBold: return "\u{f9f1}"
        case .secureCallLockFilled: return "\u{f9f2}"
        case .secureCallLockLight: return "\u{f9f3}"
        case .secureCallLockRegular: return "\u{f9f4}"
        case .secureCallShieldBold: return "\u{f9f5}"
        case .secureCallShieldFilled: return "\u{f9f6}"
        case .secureCallShieldLight: return "\u{f9f7}"
        case .secureCallShieldRegular: return "\u{f9f8}"
        case .secureCircleBold: return "\u{f9f9}"
        case .secureCircleFilled: return "\u{f9fa}"
        case .secureCircleLight: return "\u{f9fb}"
        case .secureCircleRegular: return "\u{f9fc}"
        case .secureLockBold: return "\u{f9fd}"
        case .secureLockFilled: return "\u{f9fe}"
        case .secureLockLight: return "\u{f9ff}"
        case .secureLockRegular: return "\u{fa00}"
        case .segmentExcludeFilled: return "\u{fa01}"
        case .segmentFilterFilled: return "\u{fa02}"
        case .segmentIncludeFilled: return "\u{fa03}"
        case .selectAllBold: return "\u{fa04}"
        case .selectAllFilled: return "\u{fa05}"
        case .selectAllLight: return "\u{fa06}"
        case .selectAllRegular: return "\u{fa07}"
        case .selectionBold: return "\u{fa08}"
        case .selectionFilled: return "\u{fa09}"
        case .selectionLight: return "\u{fa0a}"
        case .selectionRegular: return "\u{fa0b}"
        case .sendBold: return "\u{fa0c}"
        case .sendDigitsBold: return "\u{fa0d}"
        case .sendDigitsFilled: return "\u{fa0e}"
        case .sendDigitsLight: return "\u{fa0f}"
        case .sendDigitsRegular: return "\u{fa10}"
        case .sendFilled: return "\u{fa11}"
        case .sendLight: return "\u{fa12}"
        case .sendRegular: return "\u{fa13}"
        case .sendVoiceBold: return "\u{fa14}"
        case .sendVoiceFilled: return "\u{fa15}"
        case .sendVoiceLight: return "\u{fa16}"
        case .sendVoiceRegular: return "\u{fa17}"
        case .serverBold: return "\u{fa18}"
        case .serverErrorBold: return "\u{fa19}"
        case .serverErrorLight: return "\u{fa1a}"
        case .serverErrorRegular: return "\u{fa1b}"
        case .serverLight: return "\u{fa1c}"
        case .serverRegular: return "\u{fa1d}"
        case .servicesBold: return "\u{fa1e}"
        case .servicesLight: return "\u{fa1f}"
        case .servicesRegular: return "\u{fa20}"
        case .setVariableBold: return "\u{fa21}"
        case .setVariableLight: return "\u{fa22}"
        case .setVariableRegular: return "\u{fa23}"
        case .settingsBold: return "\u{fa24}"
        case .settingsFilled: return "\u{fa25}"
        case .settingsLight: return "\u{fa26}"
        case .settingsRegular: return "\u{fa27}"
        case .setupAssistantBold: return "\u{fa28}"
        case .setupAssistantLight: return "\u{fa29}"
        case .setupAssistantRegular: return "\u{fa2a}"
        case .sftpBold: return "\u{fa2b}"
        case .sftpLight: return "\u{fa2c}"
        case .sftpRegular: return "\u{fa2d}"
        case .shapeCircleBold: return "\u{fa2e}"
        case .shapeCircleFilled: return "\u{fa2f}"
        case .shapeCircleLight: return "\u{fa30}"
        case .shapeCircleMdFilled: return "\u{fa31}"
        case .shapeCircleRegular: return "\u{fa32}"
        case .shapeCircleSmFilled: return "\u{fa33}"
        case .shapeDiagonalLineBold: return "\u{fa34}"
        case .shapeDiagonalLineLight: return "\u{fa35}"
        case .shapeDiagonalLineRegular: return "\u{fa36}"
        case .shapeDiamondBold: return "\u{fa37}"
        case .shapeDiamondFilled: return "\u{fa38}"
        case .shapeDiamondLight: return "\u{fa39}"
        case .shapeDiamondRegular: return "\u{fa3a}"
        case .shapeOvalBold: return "\u{fa3b}"
        case .shapeOvalLight: return "\u{fa3c}"
        case .shapeOvalRegular: return "\u{fa3d}"
        case .shapeSquareBold: return "\u{fa3e}"
        case .shapeSquareFilled: return "\u{fa3f}"
        case .shapeSquareLight: return "\u{fa40}"
        case .shapeSquareRegular: return "\u{fa41}"
        case .shapeTriangleBold: return "\u{fa42}"
        case .shapeTriangleFilled: return "\u{fa43}"
        case .shapeTriangleLight: return "\u{fa44}"
        case .shapeTriangleRegular: return "\u{fa45}"
        case .shapesBold: return "\u{fa46}"
        case .shapesFilled: return "\u{fa47}"
        case .shapesLight: return "\u{fa48}"
        case .shapesRegular: return "\u{fa49}"
        case .shareCNativeAdrBold: return "\u{fa4a}"
        case .shareCNativeAdrFilled: return "\u{fa4b}"
        case .shareCNativeAdrLight: return "\u{fa4c}"
        case .shareCNativeAdrRegular: return "\u{fa4d}"
        case .shareCNativeIphBold: return "\u{fa4e}"
        case .shareCNativeIphLight: return "\u{fa4f}"
        case .shareCNativeIphRegular: return "\u{fa50}"
        case .shareContentOnDeviceBold: return "\u{fa51}"
        case .shareContentOnDeviceLight: return "\u{fa52}"
        case .shareContentOnDeviceRegular: return "\u{fa53}"
        case .shareScreenAddBold: return "\u{fa54}"
        case .shareScreenAddLight: return "\u{fa55}"
        case .shareScreenAddRegular: return "\u{fa56}"
        case .shareScreenBadgeFilled: return "\u{fa57}"
        case .shareScreenBold: return "\u{fa58}"
        case .shareScreenFilled: return "\u{fa59}"
        case .shareScreenLight: return "\u{fa5a}"
        case .shareScreenRegular: return "\u{fa5b}"
        case .shareSpaceBold: return "\u{fa5c}"
        case .shareSpaceLight: return "\u{fa5d}"
        case .shareSpaceRegular: return "\u{fa5e}"
        case .shieldBold: return "\u{fa5f}"
        case .shieldLight: return "\u{fa60}"
        case .shieldRegular: return "\u{fa61}"
        case .shoppingCartBold: return "\u{fa62}"
        case .shoppingCartFilled: return "\u{fa63}"
        case .shoppingCartLight: return "\u{fa64}"
        case .shoppingCartRegular: return "\u{fa65}"
        case .shortTextBoxBold: return "\u{fa66}"
        case .shortTextBoxLight: return "\u{fa67}"
        case .shortTextBoxRegular: return "\u{fa68}"
        case .showBold: return "\u{fa69}"
        case .showFilled: return "\u{fa6a}"
        case .showLight: return "\u{fa6b}"
        case .showRegular: return "\u{fa6c}"
        case .sidePanelBold: return "\u{fa6d}"
        case .sidePanelFilled: return "\u{fa6e}"
        case .sidePanelLight: return "\u{fa6f}"
        case .sidePanelRegular: return "\u{fa70}"
        case .signInBold: return "\u{fa71}"
        case .signInFilled: return "\u{fa72}"
        case .signInForcedBold: return "\u{fa73}"
        case .signInForcedLight: return "\u{fa74}"
        case .signInForcedRegular: return "\u{fa75}"
        case .signInLight: return "\u{fa76}"
        case .signInRegular: return "\u{fa77}"
        case .signLangIntBold: return "\u{fa78}"
        case .signLangIntLight: return "\u{fa79}"
        case .signLangIntRegular: return "\u{fa7a}"
        case .signOutBold: return "\u{fa7b}"
        case .signOutLight: return "\u{fa7c}"
        case .signOutRegular: return "\u{fa7d}"
        case .signalFourBold: return "\u{fa7e}"
        case .signalFourLight: return "\u{fa7f}"
        case .signalFourRegular: return "\u{fa80}"
        case .signalOneBold: return "\u{fa81}"
        case .signalOneLight: return "\u{fa82}"
        case .signalOneRegular: return "\u{fa83}"
        case .signalThreeBold: return "\u{fa84}"
        case .signalThreeLight: return "\u{fa85}"
        case .signalThreeRegular: return "\u{fa86}"
        case .signalTwoBold: return "\u{fa87}"
        case .signalTwoLight: return "\u{fa88}"
        case .signalTwoRegular: return "\u{fa89}"
        case .signalZeroBold: return "\u{fa8a}"
        case .signalZeroLight: return "\u{fa8b}"
        case .signalZeroRegular: return "\u{fa8c}"
        case .simplePromotionBold: return "\u{fa8d}"
        case .simplePromotionLight: return "\u{fa8e}"
        case .simplePromotionRegular: return "\u{fa8f}"
        case .singleNumberReachBold: return "\u{fa90}"
        case .singleNumberReachLight: return "\u{fa91}"
        case .singleNumberReachRegular: return "\u{fa92}"
        case .sipRegistrationInProgressBold: return "\u{fa93}"
        case .sipRegistrationInProgressFilled: return "\u{fa94}"
        case .sipRegistrationInProgressLight: return "\u{fa95}"
        case .sipRegistrationInProgressRegular: return "\u{fa96}"
        case .skipBold: return "\u{fa97}"
        case .skipBwBold: return "\u{fa98}"
        case .skipBwFilled: return "\u{fa99}"
        case .skipBwLight: return "\u{fa9a}"
        case .skipBwRegular: return "\u{fa9b}"
        case .skipFwBold: return "\u{fa9c}"
        case .skipFwFilled: return "\u{fa9d}"
        case .skipFwLight: return "\u{fa9e}"
        case .skipFwRegular: return "\u{fa9f}"
        case .skipLight: return "\u{faa0}"
        case .skipRegular: return "\u{faa1}"
        case .smartAudioBold: return "\u{faa2}"
        case .smartAudioLight: return "\u{faa3}"
        case .smartAudioRegular: return "\u{faa4}"
        case .smsFilled: return "\u{faa5}"
        case .smsInboundBold: return "\u{faa6}"
        case .smsInboundLight: return "\u{faa7}"
        case .smsInboundRegular: return "\u{faa8}"
        case .smsMessageBold: return "\u{faa9}"
        case .smsMessageFilled: return "\u{faaa}"
        case .smsMessageLight: return "\u{faab}"
        case .smsMessageRegular: return "\u{faac}"
        case .smsOutgoingFilled: return "\u{faad}"
        case .smsUnreadBold: return "\u{faae}"
        case .smsUnreadLight: return "\u{faaf}"
        case .smsUnreadRegular: return "\u{fab0}"
        case .sortAscendingBold: return "\u{fab1}"
        case .sortAscendingLight: return "\u{fab2}"
        case .sortAscendingRegular: return "\u{fab3}"
        case .sortDescendingBold: return "\u{fab4}"
        case .sortDescendingLight: return "\u{fab5}"
        case .sortDescendingRegular: return "\u{fab6}"
        case .soundDefaultBold: return "\u{fab7}"
        case .soundDefaultLight: return "\u{fab8}"
        case .soundDefaultRegular: return "\u{fab9}"
        case .sparkleBold: return "\u{faba}"
        case .sparkleFilled: return "\u{fabb}"
        case .sparkleLight: return "\u{fabc}"
        case .sparkleRegular: return "\u{fabd}"
        case .speakerBold: return "\u{fabe}"
        case .speakerDisconnectedBold: return "\u{fabf}"
        case .speakerDisconnectedFilled: return "\u{fac0}"
        case .speakerDisconnectedLight: return "\u{fac1}"
        case .speakerDisconnectedRegular: return "\u{fac2}"
        case .speakerFilled: return "\u{fac3}"
        case .speakerLight: return "\u{fac4}"
        case .speakerMutedBold: return "\u{fac5}"
        case .speakerMutedFilled: return "\u{fac6}"
        case .speakerMutedLight: return "\u{fac7}"
        case .speakerMutedRegular: return "\u{fac8}"
        case .speakerOffBold: return "\u{fac9}"
        case .speakerOffFilled: return "\u{faca}"
        case .speakerOffLight: return "\u{facb}"
        case .speakerOffRegular: return "\u{facc}"
        case .speakerOnBold: return "\u{facd}"
        case .speakerOnLight: return "\u{face}"
        case .speakerOnRegular: return "\u{facf}"
        case .speakerRegular: return "\u{fad0}"
        case .speakerTurnDownBold: return "\u{fad1}"
        case .speakerTurnDownFilled: return "\u{fad2}"
        case .speakerTurnDownLight: return "\u{fad3}"
        case .speakerTurnDownRegular: return "\u{fad4}"
        case .speakerTurnUpBold: return "\u{fad5}"
        case .speakerTurnUpFilled: return "\u{fad6}"
        case .speakerTurnUpLight: return "\u{fad7}"
        case .speakerTurnUpRegular: return "\u{fad8}"
        case .speedDialBold: return "\u{fad9}"
        case .speedDialFilled: return "\u{fada}"
        case .speedDialLight: return "\u{fadb}"
        case .speedDialRegular: return "\u{fadc}"
        case .spellCheckerBold: return "\u{fadd}"
        case .spellCheckerLight: return "\u{fade}"
        case .spellCheckerRegular: return "\u{fadf}"
        case .splitViewBold: return "\u{fae0}"
        case .splitViewLight: return "\u{fae1}"
        case .splitViewRegular: return "\u{fae2}"
        case .stackedAreaChartBold: return "\u{fae3}"
        case .stackedAreaChartFilled: return "\u{fae4}"
        case .stackedAreaChartFullBold: return "\u{fae5}"
        case .stackedAreaChartFullFilled: return "\u{fae6}"
        case .stackedAreaChartFullLight: return "\u{fae7}"
        case .stackedAreaChartFullRegular: return "\u{fae8}"
        case .stackedAreaChartLight: return "\u{fae9}"
        case .stackedAreaChartRegular: return "\u{faea}"
        case .stackedBarChartBold: return "\u{faeb}"
        case .stackedBarChartFilled: return "\u{faec}"
        case .stackedBarChartFullBold: return "\u{faed}"
        case .stackedBarChartFullFilled: return "\u{faee}"
        case .stackedBarChartFullLight: return "\u{faef}"
        case .stackedBarChartFullRegular: return "\u{faf0}"
        case .stackedBarChartLight: return "\u{faf1}"
        case .stackedBarChartRegular: return "\u{faf2}"
        case .startChatBold: return "\u{faf3}"
        case .startChatLight: return "\u{faf4}"
        case .startChatRegular: return "\u{faf5}"
        case .stethoscopeBold: return "\u{faf6}"
        case .stethoscopeLight: return "\u{faf7}"
        case .stethoscopeRegular: return "\u{faf8}"
        case .stickersBold: return "\u{faf9}"
        case .stickersLight: return "\u{fafa}"
        case .stickersRegular: return "\u{fafb}"
        case .stickiesBold: return "\u{fafc}"
        case .stickiesLight: return "\u{fafd}"
        case .stickiesRegular: return "\u{fafe}"
        case .stopBold: return "\u{faff}"
        case .stopCircleBold: return "\u{fb00}"
        case .stopCircleFilled: return "\u{fb01}"
        case .stopCircleLight: return "\u{fb02}"
        case .stopCircleRegular: return "\u{fb03}"
        case .stopContentShareBold: return "\u{fb04}"
        case .stopContentShareLight: return "\u{fb05}"
        case .stopContentShareRegular: return "\u{fb06}"
        case .stopFilled: return "\u{fb07}"
        case .stopLight: return "\u{fb08}"
        case .stopRegular: return "\u{fb09}"
        case .storedInfoBold: return "\u{fb0a}"
        case .storedInfoFilled: return "\u{fb0b}"
        case .storedInfoLight: return "\u{fb0c}"
        case .storedInfoRegular: return "\u{fb0d}"
        case .streamingBold: return "\u{fb0e}"
        case .streamingLight: return "\u{fb0f}"
        case .streamingRegular: return "\u{fb10}"
        case .strikethroughBold: return "\u{fb11}"
        case .strikethroughFilled: return "\u{fb12}"
        case .strikethroughLight: return "\u{fb13}"
        case .strikethroughRegular: return "\u{fb14}"
        case .studioModeBold: return "\u{fb15}"
        case .studioModeLight: return "\u{fb16}"
        case .studioModeRegular: return "\u{fb17}"
        case .subscriptBold: return "\u{fb18}"
        case .subscriptLight: return "\u{fb19}"
        case .subscriptRegular: return "\u{fb1a}"
        case .summarizeAiBold: return "\u{fb1b}"
        case .summarizeAiLight: return "\u{fb1c}"
        case .summarizeAiRegular: return "\u{fb1d}"
        case .superscriptBold: return "\u{fb1e}"
        case .superscriptLight: return "\u{fb1f}"
        case .superscriptRegular: return "\u{fb20}"
        case .surveyBold: return "\u{fb21}"
        case .surveyFilled: return "\u{fb22}"
        case .surveyLight: return "\u{fb23}"
        case .surveyRegular: return "\u{fb24}"
        case .sxEightyCodecBold: return "\u{fb25}"
        case .sxEightyCodecLight: return "\u{fb26}"
        case .sxEightyCodecRegular: return "\u{fb27}"
        case .sxTenBold: return "\u{fb28}"
        case .sxTenLight: return "\u{fb29}"
        case .sxTenRegular: return "\u{fb2a}"
        case .sxTwentyBold: return "\u{fb2b}"
        case .sxTwentyLight: return "\u{fb2c}"
        case .sxTwentyRegular: return "\u{fb2d}"
        case .tableBold: return "\u{fb2e}"
        case .tableLight: return "\u{fb2f}"
        case .tableRegular: return "\u{fb30}"
        case .tabletBold: return "\u{fb31}"
        case .tabletLight: return "\u{fb32}"
        case .tabletRegular: return "\u{fb33}"
        case .tabsBold: return "\u{fb34}"
        case .tabsLight: return "\u{fb35}"
        case .tabsRegular: return "\u{fb36}"
        case .tagBold: return "\u{fb37}"
        case .tagLight: return "\u{fb38}"
        case .tagRegular: return "\u{fb39}"
        case .tapBold: return "\u{fb3a}"
        case .tapFilled: return "\u{fb3b}"
        case .tapLight: return "\u{fb3c}"
        case .tapRegular: return "\u{fb3d}"
        case .telepresenceAlertBold: return "\u{fb3e}"
        case .telepresenceAlertLight: return "\u{fb3f}"
        case .telepresenceAlertMutedBold: return "\u{fb40}"
        case .telepresenceAlertMutedLight: return "\u{fb41}"
        case .telepresenceAlertMutedRegular: return "\u{fb42}"
        case .telepresenceAlertRegular: return "\u{fb43}"
        case .telepresenceBold: return "\u{fb44}"
        case .telepresenceIxFiveThousandBold: return "\u{fb45}"
        case .telepresenceIxFiveThousandLight: return "\u{fb46}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb47}"
        case .telepresenceLight: return "\u{fb48}"
        case .telepresenceMutedBold: return "\u{fb49}"
        case .telepresenceMutedLight: return "\u{fb4a}"
        case .telepresenceMutedRegular: return "\u{fb4b}"
        case .telepresencePrivateBold: return "\u{fb4c}"
        case .telepresencePrivateLight: return "\u{fb4d}"
        case .telepresencePrivateRegular: return "\u{fb4e}"
        case .telepresenceRegular: return "\u{fb4f}"
        case .temperatureBold: return "\u{fb50}"
        case .temperatureLight: return "\u{fb51}"
        case .temperatureRegular: return "\u{fb52}"
        case .testTubeBold: return "\u{fb53}"
        case .testTubeFilled: return "\u{fb54}"
        case .testTubeLight: return "\u{fb55}"
        case .testTubeRegular: return "\u{fb56}"
        case .textAlignCenterBold: return "\u{fb57}"
        case .textAlignCenterFilled: return "\u{fb58}"
        case .textAlignCenterLight: return "\u{fb59}"
        case .textAlignCenterRegular: return "\u{fb5a}"
        case .textAlignLeftBold: return "\u{fb5b}"
        case .textAlignLeftFilled: return "\u{fb5c}"
        case .textAlignLeftLight: return "\u{fb5d}"
        case .textAlignLeftRegular: return "\u{fb5e}"
        case .textAlignRightBold: return "\u{fb5f}"
        case .textAlignRightFilled: return "\u{fb60}"
        case .textAlignRightLight: return "\u{fb61}"
        case .textAlignRightRegular: return "\u{fb62}"
        case .textBold: return "\u{fb63}"
        case .textBoxCursorLight: return "\u{fb64}"
        case .textCodeBlockBold: return "\u{fb65}"
        case .textCodeBlockLight: return "\u{fb66}"
        case .textCodeBlockRegular: return "\u{fb67}"
        case .textHighlightBold: return "\u{fb68}"
        case .textHighlightFilled: return "\u{fb69}"
        case .textHighlightLight: return "\u{fb6a}"
        case .textHighlightRegular: return "\u{fb6b}"
        case .textLight: return "\u{fb6c}"
        case .textRegular: return "\u{fb6d}"
        case .threeColumnBold: return "\u{fb6e}"
        case .threeColumnLight: return "\u{fb6f}"
        case .threeColumnRegular: return "\u{fb70}"
        case .threeDObjectBold: return "\u{fb71}"
        case .threeDObjectLight: return "\u{fb72}"
        case .threeDObjectRegular: return "\u{fb73}"
        case .timeExclusionBold: return "\u{fb74}"
        case .timeExclusionLight: return "\u{fb75}"
        case .timeExclusionRegular: return "\u{fb76}"
        case .tooFastBold: return "\u{fb77}"
        case .tooFastLight: return "\u{fb78}"
        case .tooFastRegular: return "\u{fb79}"
        case .tooSlowBold: return "\u{fb7a}"
        case .tooSlowLight: return "\u{fb7b}"
        case .tooSlowRegular: return "\u{fb7c}"
        case .toolsBold: return "\u{fb7d}"
        case .toolsFilled: return "\u{fb7e}"
        case .toolsLight: return "\u{fb7f}"
        case .toolsRegular: return "\u{fb80}"
        case .touchTenBold: return "\u{fb81}"
        case .touchTenLight: return "\u{fb82}"
        case .touchTenRegular: return "\u{fb83}"
        case .transcriptBold: return "\u{fb84}"
        case .transcriptFilled: return "\u{fb85}"
        case .transcriptLight: return "\u{fb86}"
        case .transcriptRegular: return "\u{fb87}"
        case .translateBold: return "\u{fb88}"
        case .translateLight: return "\u{fb89}"
        case .translateRegular: return "\u{fb8a}"
        case .translateUndoBold: return "\u{fb8b}"
        case .translateUndoLight: return "\u{fb8c}"
        case .translateUndoRegular: return "\u{fb8d}"
        case .trendingBold: return "\u{fb8e}"
        case .trendingDownBold: return "\u{fb8f}"
        case .trendingDownFilled: return "\u{fb90}"
        case .trendingDownLight: return "\u{fb91}"
        case .trendingDownRegular: return "\u{fb92}"
        case .trendingFilled: return "\u{fb93}"
        case .trendingLight: return "\u{fb94}"
        case .trendingRegular: return "\u{fb95}"
        case .trimBold: return "\u{fb96}"
        case .trimLight: return "\u{fb97}"
        case .trimRegular: return "\u{fb98}"
        case .twoColumnBold: return "\u{fb99}"
        case .twoColumnLight: return "\u{fb9a}"
        case .twoColumnRegular: return "\u{fb9b}"
        case .twoWayVoiceStreamBold: return "\u{fb9c}"
        case .twoWayVoiceStreamFilled: return "\u{fb9d}"
        case .twoWayVoiceStreamLight: return "\u{fb9e}"
        case .twoWayVoiceStreamRegular: return "\u{fb9f}"
        case .ucmCloudBold: return "\u{fba0}"
        case .ucmCloudLight: return "\u{fba1}"
        case .ucmCloudRegular: return "\u{fba2}"
        case .unblockBold: return "\u{fba3}"
        case .unblockFilled: return "\u{fba4}"
        case .unblockLight: return "\u{fba5}"
        case .unblockRegular: return "\u{fba6}"
        case .underlineBold: return "\u{fba7}"
        case .underlineFilled: return "\u{fba8}"
        case .underlineLight: return "\u{fba9}"
        case .underlineRegular: return "\u{fbaa}"
        case .undoBold: return "\u{fbab}"
        case .undoLight: return "\u{fbac}"
        case .undoRegular: return "\u{fbad}"
        case .unlinkBold: return "\u{fbae}"
        case .unlinkLight: return "\u{fbaf}"
        case .unlinkRegular: return "\u{fbb0}"
        case .unreadBold: return "\u{fbb1}"
        case .unreadFilled: return "\u{fbb2}"
        case .unreadLight: return "\u{fbb3}"
        case .unreadRegular: return "\u{fbb4}"
        case .unsecureUnlockedBold: return "\u{fbb5}"
        case .unsecureUnlockedFilled: return "\u{fbb6}"
        case .unsecureUnlockedLight: return "\u{fbb7}"
        case .unsecureUnlockedRegular: return "\u{fbb8}"
        case .unsortedBold: return "\u{fbb9}"
        case .unsortedLight: return "\u{fbba}"
        case .unsortedRegular: return "\u{fbbb}"
        case .updateFileShareBold: return "\u{fbbc}"
        case .updateFileShareLight: return "\u{fbbd}"
        case .updateFileShareRegular: return "\u{fbbe}"
        case .uploadBold: return "\u{fbbf}"
        case .uploadImageBold: return "\u{fbc0}"
        case .uploadImageLight: return "\u{fbc1}"
        case .uploadImageRegular: return "\u{fbc2}"
        case .uploadLight: return "\u{fbc3}"
        case .uploadRegular: return "\u{fbc4}"
        case .urgentVoicemailBold: return "\u{fbc5}"
        case .urgentVoicemailFilled: return "\u{fbc6}"
        case .usbBold: return "\u{fbc7}"
        case .usbHeadsetBold: return "\u{fbc8}"
        case .usbHeadsetLight: return "\u{fbc9}"
        case .usbHeadsetMutedBold: return "\u{fbca}"
        case .usbHeadsetMutedLight: return "\u{fbcb}"
        case .usbHeadsetMutedRegular: return "\u{fbcc}"
        case .usbHeadsetRegular: return "\u{fbcd}"
        case .usbLight: return "\u{fbce}"
        case .usbRegular: return "\u{fbcf}"
        case .userBold: return "\u{fbd0}"
        case .userDeactivateBold: return "\u{fbd1}"
        case .userDeactivateLight: return "\u{fbd2}"
        case .userDeactivateRegular: return "\u{fbd3}"
        case .userLight: return "\u{fbd4}"
        case .userRegular: return "\u{fbd5}"
        case .videoBlurBold: return "\u{fbd6}"
        case .videoBlurFilled: return "\u{fbd7}"
        case .videoBlurLight: return "\u{fbd8}"
        case .videoBlurRegular: return "\u{fbd9}"
        case .videoBold: return "\u{fbda}"
        case .videoEffectBold: return "\u{fbdb}"
        case .videoEffectFilled: return "\u{fbdc}"
        case .videoEffectLight: return "\u{fbdd}"
        case .videoEffectRegular: return "\u{fbde}"
        case .videoFilled: return "\u{fbdf}"
        case .videoLayoutBold: return "\u{fbe0}"
        case .videoLayoutCustomBold: return "\u{fbe1}"
        case .videoLayoutCustomFilled: return "\u{fbe2}"
        case .videoLayoutCustomLight: return "\u{fbe3}"
        case .videoLayoutCustomRegular: return "\u{fbe4}"
        case .videoLayoutEqualBold: return "\u{fbe5}"
        case .videoLayoutEqualDualBold: return "\u{fbe6}"
        case .videoLayoutEqualDualLight: return "\u{fbe7}"
        case .videoLayoutEqualDualRegular: return "\u{fbe8}"
        case .videoLayoutEqualFilled: return "\u{fbe9}"
        case .videoLayoutEqualLight: return "\u{fbea}"
        case .videoLayoutEqualRegular: return "\u{fbeb}"
        case .videoLayoutFilled: return "\u{fbec}"
        case .videoLayoutLight: return "\u{fbed}"
        case .videoLayoutOverlayBold: return "\u{fbee}"
        case .videoLayoutOverlayFilled: return "\u{fbef}"
        case .videoLayoutOverlayLight: return "\u{fbf0}"
        case .videoLayoutOverlayRegular: return "\u{fbf1}"
        case .videoLayoutPresentationBold: return "\u{fbf2}"
        case .videoLayoutPresentationFilled: return "\u{fbf3}"
        case .videoLayoutPresentationLight: return "\u{fbf4}"
        case .videoLayoutPresentationRegular: return "\u{fbf5}"
        case .videoLayoutPresenterDominantBold: return "\u{fbf6}"
        case .videoLayoutPresenterDominantLight: return "\u{fbf7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbf8}"
        case .videoLayoutProminentBold: return "\u{fbf9}"
        case .videoLayoutProminentFilled: return "\u{fbfa}"
        case .videoLayoutProminentLight: return "\u{fbfb}"
        case .videoLayoutProminentRegular: return "\u{fbfc}"
        case .videoLayoutRegular: return "\u{fbfd}"
        case .videoLayoutShareDominantBold: return "\u{fbfe}"
        case .videoLayoutShareDominantLight: return "\u{fbff}"
        case .videoLayoutShareDominantRegular: return "\u{fc00}"
        case .videoLayoutSingleBold: return "\u{fc01}"
        case .videoLayoutSingleFilled: return "\u{fc02}"
        case .videoLayoutSingleLight: return "\u{fc03}"
        case .videoLayoutSingleRegular: return "\u{fc04}"
        case .videoLayoutStackBold: return "\u{fc05}"
        case .videoLayoutStackFilled: return "\u{fc06}"
        case .videoLayoutStackLight: return "\u{fc07}"
        case .videoLayoutStackRegular: return "\u{fc08}"
        case .videoLayoutVideoDominantBold: return "\u{fc09}"
        case .videoLayoutVideoDominantFilled: return "\u{fc0a}"
        case .videoLayoutVideoDominantLight: return "\u{fc0b}"
        case .videoLayoutVideoDominantRegular: return "\u{fc0c}"
        case .videoLight: return "\u{fc0d}"
        case .videoPlusBold: return "\u{fc0e}"
        case .videoPlusFilled: return "\u{fc0f}"
        case .videoPlusLight: return "\u{fc10}"
        case .videoPlusRegular: return "\u{fc11}"
        case .videoRegular: return "\u{fc12}"
        case .videoSpeakerTrackBold: return "\u{fc13}"
        case .videoSpeakerTrackFilled: return "\u{fc14}"
        case .videoSpeakerTrackLight: return "\u{fc15}"
        case .videoSpeakerTrackRegular: return "\u{fc16}"
        case .viewAllBold: return "\u{fc17}"
        case .viewAllLight: return "\u{fc18}"
        case .viewAllRegular: return "\u{fc19}"
        case .viewListBold: return "\u{fc1a}"
        case .viewListFilled: return "\u{fc1b}"
        case .viewListLight: return "\u{fc1c}"
        case .viewListRegular: return "\u{fc1d}"
        case .viewStackedBold: return "\u{fc1e}"
        case .viewStackedFilled: return "\u{fc1f}"
        case .viewStackedLight: return "\u{fc20}"
        case .viewStackedRegular: return "\u{fc21}"
        case .viewThumbnailBold: return "\u{fc22}"
        case .viewThumbnailFilled: return "\u{fc23}"
        case .viewThumbnailLight: return "\u{fc24}"
        case .viewThumbnailRegular: return "\u{fc25}"
        case .visionproBold: return "\u{fc26}"
        case .visionproFilled: return "\u{fc27}"
        case .visionproLight: return "\u{fc28}"
        case .visionproMoveCallInBold: return "\u{fc29}"
        case .visionproMoveCallInFilled: return "\u{fc2a}"
        case .visionproMoveCallInLight: return "\u{fc2b}"
        case .visionproMoveCallInOutBold: return "\u{fc2c}"
        case .visionproMoveCallInOutFilled: return "\u{fc2d}"
        case .visionproMoveCallInOutLight: return "\u{fc2e}"
        case .visionproMoveCallInOutRegular: return "\u{fc2f}"
        case .visionproMoveCallInRegular: return "\u{fc30}"
        case .visionproMoveCallOutBold: return "\u{fc31}"
        case .visionproMoveCallOutFilled: return "\u{fc32}"
        case .visionproMoveCallOutLight: return "\u{fc33}"
        case .visionproMoveCallOutRegular: return "\u{fc34}"
        case .visionproRegular: return "\u{fc35}"
        case .voicemailBold: return "\u{fc36}"
        case .voicemailFilled: return "\u{fc37}"
        case .voicemailLight: return "\u{fc38}"
        case .voicemailRegular: return "\u{fc39}"
        case .vpnBold: return "\u{fc3a}"
        case .vpnFilled: return "\u{fc3b}"
        case .vpnLight: return "\u{fc3c}"
        case .vpnRegular: return "\u{fc3d}"
        case .vscBold: return "\u{fc3e}"
        case .vscLight: return "\u{fc3f}"
        case .vscRegular: return "\u{fc40}"
        case .waffleMenuBold: return "\u{fc41}"
        case .waffleMenuLight: return "\u{fc42}"
        case .waffleMenuRegular: return "\u{fc43}"
        case .waitingRoomBold: return "\u{fc44}"
        case .waitingRoomLight: return "\u{fc45}"
        case .waitingRoomRegular: return "\u{fc46}"
        case .wallpaperBold: return "\u{fc47}"
        case .wallpaperLight: return "\u{fc48}"
        case .wallpaperRegular: return "\u{fc49}"
        case .warningBadgeFilled: return "\u{fc4a}"
        case .warningBold: return "\u{fc4b}"
        case .warningFilled: return "\u{fc4c}"
        case .warningLight: return "\u{fc4d}"
        case .warningRegular: return "\u{fc4e}"
        case .webexBoardBold: return "\u{fc4f}"
        case .webexBoardLight: return "\u{fc50}"
        case .webexBoardRegular: return "\u{fc51}"
        case .webexCodecPlusBold: return "\u{fc52}"
        case .webexCodecPlusLight: return "\u{fc53}"
        case .webexCodecPlusRegular: return "\u{fc54}"
        case .webexDeskCameraBold: return "\u{fc55}"
        case .webexDeskCameraLight: return "\u{fc56}"
        case .webexDeskCameraRegular: return "\u{fc57}"
        case .webexHelixBold: return "\u{fc58}"
        case .webexHelixLight: return "\u{fc59}"
        case .webexHelixRegular: return "\u{fc5a}"
        case .webexMeetingsBold: return "\u{fc5b}"
        case .webexMeetingsFilled: return "\u{fc5c}"
        case .webexMeetingsLight: return "\u{fc5d}"
        case .webexMeetingsRegular: return "\u{fc5e}"
        case .webexQuadCameraBold: return "\u{fc5f}"
        case .webexQuadCameraLight: return "\u{fc60}"
        case .webexQuadCameraRegular: return "\u{fc61}"
        case .webexRoomKitBold: return "\u{fc62}"
        case .webexRoomKitLight: return "\u{fc63}"
        case .webexRoomKitPlusBold: return "\u{fc64}"
        case .webexRoomKitPlusLight: return "\u{fc65}"
        case .webexRoomKitPlusRegular: return "\u{fc66}"
        case .webexRoomKitRegular: return "\u{fc67}"
        case .webexShareBold: return "\u{fc68}"
        case .webexShareLight: return "\u{fc69}"
        case .webexShareRegular: return "\u{fc6a}"
        case .webexTeamsBold: return "\u{fc6b}"
        case .webexTeamsFilled: return "\u{fc6c}"
        case .webexTeamsLight: return "\u{fc6d}"
        case .webexTeamsNewBold: return "\u{fc6e}"
        case .webexTeamsNewFilled: return "\u{fc6f}"
        case .webexTeamsNewLight: return "\u{fc70}"
        case .webexTeamsNewRegular: return "\u{fc71}"
        case .webexTeamsRegular: return "\u{fc72}"
        case .webexTeamsRemoveBold: return "\u{fc73}"
        case .webexTeamsRemoveLight: return "\u{fc74}"
        case .webexTeamsRemoveRegular: return "\u{fc75}"
        case .webhookBold: return "\u{fc76}"
        case .webhookLight: return "\u{fc77}"
        case .webhookRegular: return "\u{fc78}"
        case .webinarBold: return "\u{fc79}"
        case .webinarFilled: return "\u{fc7a}"
        case .webinarLight: return "\u{fc7b}"
        case .webinarRegular: return "\u{fc7c}"
        case .weeklyRecurringScheduleBold: return "\u{fc7d}"
        case .weeklyRecurringScheduleLight: return "\u{fc7e}"
        case .weeklyRecurringScheduleRegular: return "\u{fc7f}"
        case .whisperAnnouncementBold: return "\u{fc80}"
        case .whisperAnnouncementFilled: return "\u{fc81}"
        case .whisperAnnouncementLight: return "\u{fc82}"
        case .whisperAnnouncementRegular: return "\u{fc83}"
        case .whisperCoachBold: return "\u{fc84}"
        case .whisperCoachFilled: return "\u{fc85}"
        case .whisperCoachLight: return "\u{fc86}"
        case .whisperCoachRegular: return "\u{fc87}"
        case .whiteboardBold: return "\u{fc88}"
        case .whiteboardContentBold: return "\u{fc89}"
        case .whiteboardContentFilled: return "\u{fc8a}"
        case .whiteboardContentLight: return "\u{fc8b}"
        case .whiteboardContentRegular: return "\u{fc8c}"
        case .whiteboardFilled: return "\u{fc8d}"
        case .whiteboardLight: return "\u{fc8e}"
        case .whiteboardRegular: return "\u{fc8f}"
        case .widgetBold: return "\u{fc90}"
        case .widgetFilled: return "\u{fc91}"
        case .widgetLight: return "\u{fc92}"
        case .widgetRegular: return "\u{fc93}"
        case .wifiBold: return "\u{fc94}"
        case .wifiErrorBold: return "\u{fc95}"
        case .wifiErrorLight: return "\u{fc96}"
        case .wifiErrorRegular: return "\u{fc97}"
        case .wifiLight: return "\u{fc98}"
        case .wifiRegular: return "\u{fc99}"
        case .wifiSignalGoodBold: return "\u{fc9a}"
        case .wifiSignalGoodLight: return "\u{fc9b}"
        case .wifiSignalGoodRegular: return "\u{fc9c}"
        case .wifiSignalPoorBold: return "\u{fc9d}"
        case .wifiSignalPoorLight: return "\u{fc9e}"
        case .wifiSignalPoorRegular: return "\u{fc9f}"
        case .wifiSignalUnstableBold: return "\u{fca0}"
        case .wifiSignalUnstableLight: return "\u{fca1}"
        case .wifiSignalUnstableRegular: return "\u{fca2}"
        case .windowCornerScrubBold: return "\u{fca3}"
        case .windowCornerScrubLight: return "\u{fca4}"
        case .windowCornerScrubRegular: return "\u{fca5}"
        case .windowRightCornerScrubBold: return "\u{fca6}"
        case .windowRightCornerScrubLight: return "\u{fca7}"
        case .windowRightCornerScrubRegular: return "\u{fca8}"
        case .windowVerticalScrubBold: return "\u{fca9}"
        case .windowVerticalScrubLight: return "\u{fcaa}"
        case .windowVerticalScrubRegular: return "\u{fcab}"
        case .workflowDeploymentsBold: return "\u{fcac}"
        case .workflowDeploymentsFilled: return "\u{fcad}"
        case .workflowDeploymentsLight: return "\u{fcae}"
        case .workflowDeploymentsRegular: return "\u{fcaf}"
        case .workphoneBold: return "\u{fcb0}"
        case .workphoneLight: return "\u{fcb1}"
        case .workphoneRegular: return "\u{fcb2}"
        case .zoomInBold: return "\u{fcb3}"
        case .zoomInLight: return "\u{fcb4}"
        case .zoomInRegular: return "\u{fcb5}"
        case .zoomOutBold: return "\u{fcb6}"
        case .zoomOutLight: return "\u{fcb7}"
        case .zoomOutRegular: return "\u{fcb8}"
