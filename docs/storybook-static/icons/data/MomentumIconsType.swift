...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .diagnosticsBold: return "\u{f40c}"
        case .diagnosticsLight: return "\u{f40d}"
        case .diagnosticsRegular: return "\u{f40e}"
        case .dialpadBold: return "\u{f40f}"
        case .dialpadLight: return "\u{f410}"
        case .dialpadRegular: return "\u{f411}"
        case .directionalPadBold: return "\u{f412}"
        case .directionalPadFilled: return "\u{f413}"
        case .directionalPadLight: return "\u{f414}"
        case .directionalPadRegular: return "\u{f415}"
        case .directoryBold: return "\u{f416}"
        case .directoryLight: return "\u{f417}"
        case .directoryRegular: return "\u{f418}"
        case .disappearingPenBold: return "\u{f419}"
        case .disappearingPenLight: return "\u{f41a}"
        case .disappearingPenRegular: return "\u{f41b}"
        case .discBold: return "\u{f41c}"
        case .discConnectedBold: return "\u{f41d}"
        case .discConnectedLight: return "\u{f41e}"
        case .discConnectedRegular: return "\u{f41f}"
        case .discLight: return "\u{f420}"
        case .discRegular: return "\u{f421}"
        case .disconnectBold: return "\u{f422}"
        case .disconnectFilled: return "\u{f423}"
        case .disconnectLight: return "\u{f424}"
        case .disconnectRegular: return "\u{f425}"
        case .dislikeBold: return "\u{f426}"
        case .dislikeFilled: return "\u{f427}"
        case .dislikeLight: return "\u{f428}"
        case .dislikeRegular: return "\u{f429}"
        case .displayBold: return "\u{f42a}"
        case .displayInputBold: return "\u{f42b}"
        case .displayInputLight: return "\u{f42c}"
        case .displayInputRegular: return "\u{f42d}"
        case .displayLight: return "\u{f42e}"
        case .displayRegular: return "\u{f42f}"
        case .displayWarningBold: return "\u{f430}"
        case .displayWarningLight: return "\u{f431}"
        case .displayWarningRegular: return "\u{f432}"
        case .distributeHorizontalBold: return "\u{f433}"
        case .distributeHorizontalFilled: return "\u{f434}"
        case .distributeHorizontalLight: return "\u{f435}"
        case .distributeHorizontalRegular: return "\u{f436}"
        case .distributeVerticallyBold: return "\u{f437}"
        case .distributeVerticallyFilled: return "\u{f438}"
        case .distributeVerticallyLight: return "\u{f439}"
        case .distributeVerticallyRegular: return "\u{f43a}"
        case .divideBold: return "\u{f43b}"
        case .divideFilled: return "\u{f43c}"
        case .divideLight: return "\u{f43d}"
        case .divideRegular: return "\u{f43e}"
        case .dndPresenceBadgeFilled: return "\u{f43f}"
        case .dndPresenceBold: return "\u{f440}"
        case .dndPresenceFilled: return "\u{f441}"
        case .dndPresenceLight: return "\u{f442}"
        case .dndPresenceRegular: return "\u{f443}"
        case .dockWindowBold: return "\u{f444}"
        case .dockWindowLight: return "\u{f445}"
        case .dockWindowRegular: return "\u{f446}"
        case .documentBold: return "\u{f447}"
        case .documentCameraBold: return "\u{f448}"
        case .documentCameraDisconnectedBold: return "\u{f449}"
        case .documentCameraDisconnectedLight: return "\u{f44a}"
        case .documentCameraDisconnectedRegular: return "\u{f44b}"
        case .documentCameraLight: return "\u{f44c}"
        case .documentCameraRegular: return "\u{f44d}"
        case .documentCreateBold: return "\u{f44e}"
        case .documentCreateFilled: return "\u{f44f}"
        case .documentCreateLight: return "\u{f450}"
        case .documentCreateRegular: return "\u{f451}"
        case .documentFilled: return "\u{f452}"
        case .documentLight: return "\u{f453}"
        case .documentMoveBold: return "\u{f454}"
        case .documentMoveFilled: return "\u{f455}"
        case .documentMoveLight: return "\u{f456}"
        case .documentMoveRegular: return "\u{f457}"
        case .documentRegular: return "\u{f458}"
        case .documentShareBold: return "\u{f459}"
        case .documentShareFilled: return "\u{f45a}"
        case .documentShareLight: return "\u{f45b}"
        case .documentShareRegular: return "\u{f45c}"
        case .doneAllBold: return "\u{f45d}"
        case .doneAllLight: return "\u{f45e}"
        case .doneAllRegular: return "\u{f45f}"
        case .donutChartBold: return "\u{f460}"
        case .donutChartFilled: return "\u{f461}"
        case .donutChartLight: return "\u{f462}"
        case .donutChartRegular: return "\u{f463}"
        case .downloadBold: return "\u{f464}"
        case .downloadFilled: return "\u{f465}"
        case .downloadLight: return "\u{f466}"
        case .downloadRegular: return "\u{f467}"
        case .draftBold: return "\u{f468}"
        case .draftFilled: return "\u{f469}"
        case .draftIndicatorBold: return "\u{f46a}"
        case .draftIndicatorSmallFilled: return "\u{f46b}"
        case .draftLight: return "\u{f46c}"
        case .draftRegular: return "\u{f46d}"
        case .dragBold: return "\u{f46e}"
        case .dragLight: return "\u{f46f}"
        case .dragRegular: return "\u{f470}"
        case .draggerHorizontalBold: return "\u{f471}"
        case .draggerHorizontalLight: return "\u{f472}"
        case .draggerHorizontalRegular: return "\u{f473}"
        case .draggerVerticalBold: return "\u{f474}"
        case .draggerVerticalLight: return "\u{f475}"
        case .draggerVerticalRegular: return "\u{f476}"
        case .driveModeBold: return "\u{f477}"
        case .driveModeLight: return "\u{f478}"
        case .driveModeRegular: return "\u{f479}"
        case .dropdownBold: return "\u{f47a}"
        case .dropdownLight: return "\u{f47b}"
        case .dropdownRegular: return "\u{f47c}"
        case .dxEightyBold: return "\u{f47d}"
        case .dxEightyFilled: return "\u{f47e}"
        case .dxEightyLight: return "\u{f47f}"
        case .dxEightyRegular: return "\u{f480}"
        case .dxSeventyBold: return "\u{f481}"
        case .dxSeventyLight: return "\u{f482}"
        case .dxSeventyRegular: return "\u{f483}"
        case .editBold: return "\u{f484}"
        case .editFilled: return "\u{f485}"
        case .editLight: return "\u{f486}"
        case .editRegular: return "\u{f487}"
        case .editablePartialBold: return "\u{f488}"
        case .editablePartialLight: return "\u{f489}"
        case .editablePartialRegular: return "\u{f48a}"
        case .educationBold: return "\u{f48b}"
        case .educationFilled: return "\u{f48c}"
        case .educationLight: return "\u{f48d}"
        case .educationRegular: return "\u{f48e}"
        case .emailBold: return "\u{f48f}"
        case .emailDeliveredBold: return "\u{f490}"
        case .emailDeliveredLight: return "\u{f491}"
        case .emailDeliveredRegular: return "\u{f492}"
        case .emailFailureBold: return "\u{f493}"
        case .emailFailureLight: return "\u{f494}"
        case .emailFailureRegular: return "\u{f495}"
        case .emailFilled: return "\u{f496}"
        case .emailInviteBold: return "\u{f497}"
        case .emailInviteLight: return "\u{f498}"
        case .emailInviteRegular: return "\u{f499}"
        case .emailLight: return "\u{f49a}"
        case .emailOutgoingBold: return "\u{f49b}"
        case .emailOutgoingFilled: return "\u{f49c}"
        case .emailOutgoingLight: return "\u{f49d}"
        case .emailOutgoingRegular: return "\u{f49e}"
        case .emailReadBold: return "\u{f49f}"
        case .emailReadFilled: return "\u{f4a0}"
        case .emailReadLight: return "\u{f4a1}"
        case .emailReadRegular: return "\u{f4a2}"
        case .emailRegular: return "\u{f4a3}"
        case .emojiExcitedBold: return "\u{f4a4}"
        case .emojiExcitedFilled: return "\u{f4a5}"
        case .emojiExcitedLight: return "\u{f4a6}"
        case .emojiExcitedRegular: return "\u{f4a7}"
        case .emojiHappyBold: return "\u{f4a8}"
        case .emojiHappyFilled: return "\u{f4a9}"
        case .emojiHappyLight: return "\u{f4aa}"
        case .emojiHappyRegular: return "\u{f4ab}"
        case .emojiPassiveBold: return "\u{f4ac}"
        case .emojiPassiveFilled: return "\u{f4ad}"
        case .emojiPassiveLight: return "\u{f4ae}"
        case .emojiPassiveRegular: return "\u{f4af}"
        case .emojiSadBold: return "\u{f4b0}"
        case .emojiSadFilled: return "\u{f4b1}"
        case .emojiSadLight: return "\u{f4b2}"
        case .emojiSadRegular: return "\u{f4b3}"
        case .emojiUnhappyBold: return "\u{f4b4}"
        case .emojiUnhappyFilled: return "\u{f4b5}"
        case .emojiUnhappyLight: return "\u{f4b6}"
        case .emojiUnhappyRegular: return "\u{f4b7}"
        case .encryptionCircleFilled: return "\u{f4b8}"
        case .encryptionFilled: return "\u{f4b9}"
        case .endRemoteDesktopControlBold: return "\u{f4ba}"
        case .endRemoteDesktopControlLight: return "\u{f4bb}"
        case .endRemoteDesktopControlRegular: return "\u{f4bc}"
        case .endToEndEncryptionCircleFilled: return "\u{f4bd}"
        case .endToEndEncryptionFilled: return "\u{f4be}"
        case .endpointBlockedBold: return "\u{f4bf}"
        case .endpointBlockedLight: return "\u{f4c0}"
        case .endpointBlockedRegular: return "\u{f4c1}"
        case .endpointBold: return "\u{f4c2}"
        case .endpointGTwoBold: return "\u{f4c3}"
        case .endpointGTwoLight: return "\u{f4c4}"
        case .endpointGTwoRegular: return "\u{f4c5}"
        case .endpointGTwoSeventyBold: return "\u{f4c6}"
        case .endpointGTwoSeventyDualBold: return "\u{f4c7}"
        case .endpointGTwoSeventyDualLight: return "\u{f4c8}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4c9}"
        case .endpointGTwoSeventyLight: return "\u{f4ca}"
        case .endpointGTwoSeventyRegular: return "\u{f4cb}"
        case .endpointGTwoStandBold: return "\u{f4cc}"
        case .endpointGTwoStandLight: return "\u{f4cd}"
        case .endpointGTwoStandRegular: return "\u{f4ce}"
        case .endpointLight: return "\u{f4cf}"
        case .endpointMxEightHundredBold: return "\u{f4d0}"
        case .endpointMxEightHundredDualBold: return "\u{f4d1}"
        case .endpointMxEightHundredDualLight: return "\u{f4d2}"
        case .endpointMxEightHundredDualRegular: return "\u{f4d3}"
        case .endpointMxEightHundredLight: return "\u{f4d4}"
        case .endpointMxEightHundredRegular: return "\u{f4d5}"
        case .endpointRegular: return "\u{f4d6}"
        case .endpointStandBold: return "\u{f4d7}"
        case .endpointStandFilled: return "\u{f4d8}"
        case .endpointStandLight: return "\u{f4d9}"
        case .endpointStandRegular: return "\u{f4da}"
        case .endpointWarningBold: return "\u{f4db}"
        case .endpointWarningLight: return "\u{f4dc}"
        case .endpointWarningRegular: return "\u{f4dd}"
        case .enterBold: return "\u{f4de}"
        case .enterLight: return "\u{f4df}"
        case .enterRegular: return "\u{f4e0}"
        case .enterRoomBold: return "\u{f4e1}"
        case .enterRoomFilled: return "\u{f4e2}"
        case .enterRoomLight: return "\u{f4e3}"
        case .enterRoomRegular: return "\u{f4e4}"
        case .eraserBold: return "\u{f4e5}"
        case .eraserFilled: return "\u{f4e6}"
        case .eraserLight: return "\u{f4e7}"
        case .eraserRegular: return "\u{f4e8}"
        case .errorLegacyBadgeFilled: return "\u{f4e9}"
        case .errorLegacyBold: return "\u{f4ea}"
        case .errorLegacyFilled: return "\u{f4eb}"
        case .errorLegacyLight: return "\u{f4ec}"
        case .errorLegacyRegular: return "\u{f4ed}"
        case .ethernetBold: return "\u{f4ee}"
        case .ethernetFilled: return "\u{f4ef}"
        case .ethernetLight: return "\u{f4f0}"
        case .ethernetRegular: return "\u{f4f1}"
        case .exchangeBold: return "\u{f4f2}"
        case .exchangeLight: return "\u{f4f3}"
        case .exchangeRegular: return "\u{f4f4}"
        case .exclamationBold: return "\u{f4f5}"
        case .exclamationLight: return "\u{f4f6}"
        case .exclamationRegular: return "\u{f4f7}"
        case .excludeBold: return "\u{f4f8}"
        case .excludeLight: return "\u{f4f9}"
        case .excludeRegular: return "\u{f4fa}"
        case .existingTargetGroupBold: return "\u{f4fb}"
        case .existingTargetGroupLight: return "\u{f4fc}"
        case .existingTargetGroupRegular: return "\u{f4fd}"
        case .exitRoomBold: return "\u{f4fe}"
        case .exitRoomLight: return "\u{f4ff}"
        case .exitRoomRegular: return "\u{f500}"
        case .exploreBold: return "\u{f501}"
        case .exploreLight: return "\u{f502}"
        case .exploreRegular: return "\u{f503}"
        case .exportBold: return "\u{f504}"
        case .exportLight: return "\u{f505}"
        case .exportRegular: return "\u{f506}"
        case .extensionMobilityBold: return "\u{f507}"
        case .extensionMobilityLight: return "\u{f508}"
        case .extensionMobilityRegular: return "\u{f509}"
        case .externalMessageBold: return "\u{f50a}"
        case .externalMessageLight: return "\u{f50b}"
        case .externalMessageRegular: return "\u{f50c}"
        case .externalUserBold: return "\u{f50d}"
        case .externalUserLight: return "\u{f50e}"
        case .externalUserRegular: return "\u{f50f}"
        case .familyFontBold: return "\u{f510}"
        case .familyFontLight: return "\u{f511}"
        case .familyFontRegular: return "\u{f512}"
        case .fastForwardBold: return "\u{f513}"
        case .fastForwardLight: return "\u{f514}"
        case .fastForwardRegular: return "\u{f515}"
        case .favoriteBold: return "\u{f516}"
        case .favoriteFilled: return "\u{f517}"
        case .favoriteLight: return "\u{f518}"
        case .favoriteRegular: return "\u{f519}"
        case .favoritesBold: return "\u{f51a}"
        case .favoritesFilled: return "\u{f51b}"
        case .favoritesLight: return "\u{f51c}"
        case .favoritesRegular: return "\u{f51d}"
        case .fbwBold: return "\u{f51e}"
        case .fbwFilled: return "\u{f51f}"
        case .fbwLight: return "\u{f520}"
        case .fbwRegular: return "\u{f521}"
        case .ffwBold: return "\u{f522}"
        case .ffwFilled: return "\u{f523}"
        case .ffwLight: return "\u{f524}"
        case .ffwRegular: return "\u{f525}"
        case .fileAnalysisBold: return "\u{f526}"
        case .fileAnalysisFilled: return "\u{f527}"
        case .fileAnalysisLight: return "\u{f528}"
        case .fileAnalysisRegular: return "\u{f529}"
        case .fileAnnotationBold: return "\u{f52a}"
        case .fileAnnotationFilled: return "\u{f52b}"
        case .fileAnnotationLight: return "\u{f52c}"
        case .fileAnnotationRegular: return "\u{f52d}"
        case .fileAudioBold: return "\u{f52e}"
        case .fileAudioFilled: return "\u{f52f}"
        case .fileAudioLight: return "\u{f530}"
        case .fileAudioRegular: return "\u{f531}"
        case .fileBugBold: return "\u{f532}"
        case .fileBugFilled: return "\u{f533}"
        case .fileBugLight: return "\u{f534}"
        case .fileBugRegular: return "\u{f535}"
        case .fileCodeBold: return "\u{f536}"
        case .fileCodeFilled: return "\u{f537}"
        case .fileCodeLight: return "\u{f538}"
        case .fileCodeRegular: return "\u{f539}"
        case .fileDashboardBold: return "\u{f53a}"
        case .fileDashboardFilled: return "\u{f53b}"
        case .fileDashboardLight: return "\u{f53c}"
        case .fileDashboardRegular: return "\u{f53d}"
        case .fileExcelBold: return "\u{f53e}"
        case .fileExcelFilled: return "\u{f53f}"
        case .fileExcelLight: return "\u{f540}"
        case .fileExcelRegular: return "\u{f541}"
        case .fileGraphBold: return "\u{f542}"
        case .fileGraphFilled: return "\u{f543}"
        case .fileGraphLight: return "\u{f544}"
        case .fileGraphRegular: return "\u{f545}"
        case .fileImageBold: return "\u{f546}"
        case .fileImageFilled: return "\u{f547}"
        case .fileImageLight: return "\u{f548}"
        case .fileImageNoneBold: return "\u{f549}"
        case .fileImageNoneLight: return "\u{f54a}"
        case .fileImageNoneRegular: return "\u{f54b}"
        case .fileImageRegular: return "\u{f54c}"
        case .fileJsBold: return "\u{f54d}"
        case .fileJsFilled: return "\u{f54e}"
        case .fileJsLight: return "\u{f54f}"
        case .fileJsRegular: return "\u{f550}"
        case .fileKeynoteBold: return "\u{f551}"
        case .fileKeynoteFilled: return "\u{f552}"
        case .fileKeynoteLight: return "\u{f553}"
        case .fileKeynoteRegular: return "\u{f554}"
        case .fileLockedBold: return "\u{f555}"
        case .fileLockedFilled: return "\u{f556}"
        case .fileLockedLight: return "\u{f557}"
        case .fileLockedRegular: return "\u{f558}"
        case .fileMissingBold: return "\u{f559}"
        case .fileMissingFilled: return "\u{f55a}"
        case .fileMissingLight: return "\u{f55b}"
        case .fileMissingRegular: return "\u{f55c}"
        case .fileMusicBold: return "\u{f55d}"
        case .fileMusicFilled: return "\u{f55e}"
        case .fileMusicLight: return "\u{f55f}"
        case .fileMusicRegular: return "\u{f560}"
        case .fileOnenoteBold: return "\u{f561}"
        case .fileOnenoteFilled: return "\u{f562}"
        case .fileOnenoteLight: return "\u{f563}"
        case .fileOnenoteRegular: return "\u{f564}"
        case .filePdfBold: return "\u{f565}"
        case .filePdfFilled: return "\u{f566}"
        case .filePdfLight: return "\u{f567}"
        case .filePdfRegular: return "\u{f568}"
        case .filePowerpointBold: return "\u{f569}"
        case .filePowerpointFilled: return "\u{f56a}"
        case .filePowerpointLight: return "\u{f56b}"
        case .filePowerpointRegular: return "\u{f56c}"
        case .fileSpreadsheetBold: return "\u{f56d}"
        case .fileSpreadsheetFilled: return "\u{f56e}"
        case .fileSpreadsheetLight: return "\u{f56f}"
        case .fileSpreadsheetRegular: return "\u{f570}"
        case .fileTextBold: return "\u{f571}"
        case .fileTextFilled: return "\u{f572}"
        case .fileTextLight: return "\u{f573}"
        case .fileTextRegular: return "\u{f574}"
        case .fileThreeDBold: return "\u{f575}"
        case .fileThreeDFilled: return "\u{f576}"
        case .fileThreeDLight: return "\u{f577}"
        case .fileThreeDRegular: return "\u{f578}"
        case .fileVectorBold: return "\u{f579}"
        case .fileVectorFilled: return "\u{f57a}"
        case .fileVectorLight: return "\u{f57b}"
        case .fileVectorRegular: return "\u{f57c}"
        case .fileVideoBold: return "\u{f57d}"
        case .fileVideoFilled: return "\u{f57e}"
        case .fileVideoLight: return "\u{f57f}"
        case .fileVideoRegular: return "\u{f580}"
        case .fileWordBold: return "\u{f581}"
        case .fileWordFilled: return "\u{f582}"
        case .fileWordLight: return "\u{f583}"
        case .fileWordRegular: return "\u{f584}"
        case .fileXmlBold: return "\u{f585}"
        case .fileXmlFilled: return "\u{f586}"
        case .fileXmlLight: return "\u{f587}"
        case .fileXmlRegular: return "\u{f588}"
        case .fileZipBold: return "\u{f589}"
        case .fileZipFilled: return "\u{f58a}"
        case .fileZipLight: return "\u{f58b}"
        case .fileZipRegular: return "\u{f58c}"
        case .filesBold: return "\u{f58d}"
        case .filesFilled: return "\u{f58e}"
        case .filesLight: return "\u{f58f}"
        case .filesRegular: return "\u{f590}"
        case .fillColourBold: return "\u{f591}"
        case .fillColourFilled: return "\u{f592}"
        case .fillColourLight: return "\u{f593}"
        case .fillColourRegular: return "\u{f594}"
        case .filterBold: return "\u{f595}"
        case .filterCircleBold: return "\u{f596}"
        case .filterCircleFilled: return "\u{f597}"
        case .filterCircleLight: return "\u{f598}"
        case .filterCircleRegular: return "\u{f599}"
        case .filterLight: return "\u{f59a}"
        case .filterRegular: return "\u{f59b}"
        case .fitToWidthBold: return "\u{f59c}"
        case .fitToWidthLight: return "\u{f59d}"
        case .fitToWidthRegular: return "\u{f59e}"
        case .fitToWindowExpandBold: return "\u{f59f}"
        case .fitToWindowExpandLight: return "\u{f5a0}"
        case .fitToWindowExpandRegular: return "\u{f5a1}"
        case .fitToWindowShrinkBold: return "\u{f5a2}"
        case .fitToWindowShrinkLight: return "\u{f5a3}"
        case .fitToWindowShrinkRegular: return "\u{f5a4}"
        case .flagBold: return "\u{f5a5}"
        case .flagCircleBold: return "\u{f5a6}"
        case .flagCircleFilled: return "\u{f5a7}"
        case .flagCircleLight: return "\u{f5a8}"
        case .flagCircleRegular: return "\u{f5a9}"
        case .flagFilled: return "\u{f5aa}"
        case .flagLight: return "\u{f5ab}"
        case .flagRegular: return "\u{f5ac}"
        case .folderBold: return "\u{f5ad}"
        case .folderEditBold: return "\u{f5ae}"
        case .folderEditLight: return "\u{f5af}"
        case .folderEditRegular: return "\u{f5b0}"
        case .folderLight: return "\u{f5b1}"
        case .folderLockBold: return "\u{f5b2}"
        case .folderLockLight: return "\u{f5b3}"
        case .folderLockRegular: return "\u{f5b4}"
        case .folderRegular: return "\u{f5b5}"
        case .folderViewBold: return "\u{f5b6}"
        case .folderViewLight: return "\u{f5b7}"
        case .folderViewRegular: return "\u{f5b8}"
        case .followUpBold: return "\u{f5b9}"
        case .followUpLight: return "\u{f5ba}"
        case .followUpRegular: return "\u{f5bb}"
        case .foodBold: return "\u{f5bc}"
        case .foodFilled: return "\u{f5bd}"
        case .foodLight: return "\u{f5be}"
        case .foodRegular: return "\u{f5bf}"
        case .formatBold: return "\u{f5c0}"
        case .formatDefaultAppBold: return "\u{f5c1}"
        case .formatDefaultAppFilled: return "\u{f5c2}"
        case .formatDefaultAppLight: return "\u{f5c3}"
        case .formatDefaultAppRegular: return "\u{f5c4}"
        case .formatLight: return "\u{f5c5}"
        case .formatPanelControlBarBold: return "\u{f5c6}"
        case .formatPanelControlBarLight: return "\u{f5c7}"
        case .formatPanelControlBarRegular: return "\u{f5c8}"
        case .formatPanelControlDownBold: return "\u{f5c9}"
        case .formatPanelControlDownLight: return "\u{f5ca}"
        case .formatPanelControlDownRegular: return "\u{f5cb}"
        case .formatPanelControlLeftBold: return "\u{f5cc}"
        case .formatPanelControlLeftLight: return "\u{f5cd}"
        case .formatPanelControlLeftRegular: return "\u{f5ce}"
        case .formatPanelControlRightBold: return "\u{f5cf}"
        case .formatPanelControlRightLight: return "\u{f5d0}"
        case .formatPanelControlRightRegular: return "\u{f5d1}"
        case .formatPanelControlUpBold: return "\u{f5d2}"
        case .formatPanelControlUpDownBold: return "\u{f5d3}"
        case .formatPanelControlUpDownLight: return "\u{f5d4}"
        case .formatPanelControlUpDownRegular: return "\u{f5d5}"
        case .formatPanelControlUpLight: return "\u{f5d6}"
        case .formatPanelControlUpRegular: return "\u{f5d7}"
        case .formatRegular: return "\u{f5d8}"
        case .formatViewMixedBold: return "\u{f5d9}"
        case .formatViewMixedLight: return "\u{f5da}"
        case .formatViewMixedRegular: return "\u{f5db}"
        case .formulaBold: return "\u{f5dc}"
        case .formulaFilled: return "\u{f5dd}"
        case .formulaLight: return "\u{f5de}"
        case .formulaRegular: return "\u{f5df}"
        case .forwardMessageBold: return "\u{f5e0}"
        case .forwardMessageFilled: return "\u{f5e1}"
        case .forwardMessageLight: return "\u{f5e2}"
        case .forwardMessageRegular: return "\u{f5e3}"
        case .forwardTenSecBold: return "\u{f5e4}"
        case .forwardTenSecLight: return "\u{f5e5}"
        case .forwardTenSecRegular: return "\u{f5e6}"
        case .fourColumnBold: return "\u{f5e7}"
        case .fourColumnLight: return "\u{f5e8}"
        case .fourColumnRegular: return "\u{f5e9}"
        case .fourWayNavigationBold: return "\u{f5ea}"
        case .fourWayNavigationLight: return "\u{f5eb}"
        case .fourWayNavigationRegular: return "\u{f5ec}"
        case .frequencyCappingBold: return "\u{f5ed}"
        case .frequencyCappingLight: return "\u{f5ee}"
        case .frequencyCappingRegular: return "\u{f5ef}"
        case .fulfillmentBold: return "\u{f5f0}"
        case .fulfillmentLight: return "\u{f5f1}"
        case .fulfillmentRegular: return "\u{f5f2}"
        case .fullscreenBold: return "\u{f5f3}"
        case .fullscreenExitBold: return "\u{f5f4}"
        case .fullscreenExitLight: return "\u{f5f5}"
        case .fullscreenExitRegular: return "\u{f5f6}"
        case .fullscreenLight: return "\u{f5f7}"
        case .fullscreenRegular: return "\u{f5f8}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5f9}"
        case .genericDeviceVideoBold: return "\u{f5fa}"
        case .genericDeviceVideoFilled: return "\u{f5fb}"
        case .genericDeviceVideoLight: return "\u{f5fc}"
        case .genericDeviceVideoRegular: return "\u{f5fd}"
        case .gifBold: return "\u{f5fe}"
        case .gifFilled: return "\u{f5ff}"
        case .gifHorizontalBold: return "\u{f600}"
        case .gifHorizontalFilled: return "\u{f601}"
        case .gifHorizontalLight: return "\u{f602}"
        case .gifHorizontalRegular: return "\u{f603}"
        case .gifLight: return "\u{f604}"
        case .gifRegular: return "\u{f605}"
        case .giftBold: return "\u{f606}"
        case .giftFilled: return "\u{f607}"
        case .giftLight: return "\u{f608}"
        case .giftRegular: return "\u{f609}"
        case .greenLeafBold: return "\u{f60a}"
        case .greenLeafFilled: return "\u{f60b}"
        case .greenLeafLight: return "\u{f60c}"
        case .greenLeafRegular: return "\u{f60d}"
        case .greenRoomBold: return "\u{f60e}"
        case .greenRoomFilled: return "\u{f60f}"
        case .greenRoomLight: return "\u{f610}"
        case .greenRoomRegular: return "\u{f611}"
        case .guestIssuerBold: return "\u{f612}"
        case .guestIssuerLight: return "\u{f613}"
        case .guestIssuerRegular: return "\u{f614}"
        case .guideBold: return "\u{f615}"
        case .guideLight: return "\u{f616}"
        case .guideRegular: return "\u{f617}"
        case .handPointerBold: return "\u{f618}"
        case .handPointerLight: return "\u{f619}"
        case .handPointerRegular: return "\u{f61a}"
        case .handlerBold: return "\u{f61b}"
        case .handlerHorizontalBold: return "\u{f61c}"
        case .handlerHorizontalLight: return "\u{f61d}"
        case .handlerHorizontalRegular: return "\u{f61e}"
        case .handlerLight: return "\u{f61f}"
        case .handlerRegular: return "\u{f620}"
        case .handsetAlertBold: return "\u{f621}"
        case .handsetAlertFilled: return "\u{f622}"
        case .handsetAlertLight: return "\u{f623}"
        case .handsetAlertRegular: return "\u{f624}"
        case .handsetBold: return "\u{f625}"
        case .handsetDownSlashBold: return "\u{f626}"
        case .handsetDownSlashFilled: return "\u{f627}"
        case .handsetDownSlashLight: return "\u{f628}"
        case .handsetDownSlashRegular: return "\u{f629}"
        case .handsetFilled: return "\u{f62a}"
        case .handsetLight: return "\u{f62b}"
        case .handsetMutedBold: return "\u{f62c}"
        case .handsetMutedFilled: return "\u{f62d}"
        case .handsetMutedLight: return "\u{f62e}"
        case .handsetMutedRegular: return "\u{f62f}"
        case .handsetRegular: return "\u{f630}"
        case .handsetsArrowLeftBold: return "\u{f631}"
        case .handsetsArrowLeftLight: return "\u{f632}"
        case .handsetsArrowLeftRegular: return "\u{f633}"
        case .handshakeBold: return "\u{f634}"
        case .handshakeLight: return "\u{f635}"
        case .handshakeRegular: return "\u{f636}"
        case .headingOneBold: return "\u{f637}"
        case .headingOneLight: return "\u{f638}"
        case .headingOneRegular: return "\u{f639}"
        case .headingThreeBold: return "\u{f63a}"
        case .headingThreeLight: return "\u{f63b}"
        case .headingThreeRegular: return "\u{f63c}"
        case .headingTwoBold: return "\u{f63d}"
        case .headingTwoLight: return "\u{f63e}"
        case .headingTwoRegular: return "\u{f63f}"
        case .headphonesBold: return "\u{f640}"
        case .headphonesFilled: return "\u{f641}"
        case .headphonesLight: return "\u{f642}"
        case .headphonesMutedBold: return "\u{f643}"
        case .headphonesMutedFilled: return "\u{f644}"
        case .headphonesMutedLight: return "\u{f645}"
        case .headphonesMutedRegular: return "\u{f646}"
        case .headphonesRegular: return "\u{f647}"
        case .headsetAlertBold: return "\u{f648}"
        case .headsetAlertLight: return "\u{f649}"
        case .headsetAlertRegular: return "\u{f64a}"
        case .headsetArrowDownBold: return "\u{f64b}"
        case .headsetArrowDownFilled: return "\u{f64c}"
        case .headsetArrowDownLight: return "\u{f64d}"
        case .headsetArrowDownRegular: return "\u{f64e}"
        case .headsetBluetoothBold: return "\u{f64f}"
        case .headsetBluetoothLight: return "\u{f650}"
        case .headsetBluetoothRegular: return "\u{f651}"
        case .headsetBold: return "\u{f652}"
        case .headsetFilled: return "\u{f653}"
        case .headsetLight: return "\u{f654}"
        case .headsetMutedBold: return "\u{f655}"
        case .headsetMutedLight: return "\u{f656}"
        case .headsetMutedRegular: return "\u{f657}"
        case .headsetPrivateBold: return "\u{f658}"
        case .headsetPrivateLight: return "\u{f659}"
        case .headsetPrivateRegular: return "\u{f65a}"
        case .headsetRegular: return "\u{f65b}"
        case .hearingBold: return "\u{f65c}"
        case .hearingImpairedBold: return "\u{f65d}"
        case .hearingImpairedLight: return "\u{f65e}"
        case .hearingImpairedRegular: return "\u{f65f}"
        case .hearingLight: return "\u{f660}"
        case .hearingRegular: return "\u{f661}"
        case .helpBold: return "\u{f662}"
        case .helpCircleBold: return "\u{f663}"
        case .helpCircleFilled: return "\u{f664}"
        case .helpCircleLight: return "\u{f665}"
        case .helpCircleRegular: return "\u{f666}"
        case .helpLight: return "\u{f667}"
        case .helpRegular: return "\u{f668}"
        case .helpdeskBold: return "\u{f669}"
        case .helpdeskFilled: return "\u{f66a}"
        case .helpdeskLight: return "\u{f66b}"
        case .helpdeskRegular: return "\u{f66c}"
        case .hideBold: return "\u{f66d}"
        case .hideFilled: return "\u{f66e}"
        case .hideLight: return "\u{f66f}"
        case .hideRegular: return "\u{f670}"
        case .homeBold: return "\u{f671}"
        case .homeFilled: return "\u{f672}"
        case .homeLight: return "\u{f673}"
        case .homeRegular: return "\u{f674}"
        case .horizontalLineBold: return "\u{f675}"
        case .horizontalLineLight: return "\u{f676}"
        case .horizontalLineRegular: return "\u{f677}"
        case .hotelingBold: return "\u{f678}"
        case .hotelingFilled: return "\u{f679}"
        case .hotelingLight: return "\u{f67a}"
        case .hotelingRegular: return "\u{f67b}"
        case .humidityBold: return "\u{f67c}"
        case .humidityLight: return "\u{f67d}"
        case .humidityRegular: return "\u{f67e}"
        case .huntGroupBold: return "\u{f67f}"
        case .huntGroupFilled: return "\u{f680}"
        case .huntGroupLight: return "\u{f681}"
        case .huntGroupRegular: return "\u{f682}"
        case .idleBold: return "\u{f683}"
        case .idleFilled: return "\u{f684}"
        case .idleLight: return "\u{f685}"
        case .idleRegular: return "\u{f686}"
        case .immediateBold: return "\u{f687}"
        case .immediateFilled: return "\u{f688}"
        case .immediateLight: return "\u{f689}"
        case .immediateRegular: return "\u{f68a}"
        case .importBold: return "\u{f68b}"
        case .importLight: return "\u{f68c}"
        case .importRegular: return "\u{f68d}"
        case .inCommonBold: return "\u{f68e}"
        case .inCommonLight: return "\u{f68f}"
        case .inCommonRegular: return "\u{f690}"
        case .inboxBold: return "\u{f691}"
        case .inboxFilled: return "\u{f692}"
        case .inboxLight: return "\u{f693}"
        case .inboxRegular: return "\u{f694}"
        case .includeBold: return "\u{f695}"
        case .includeLight: return "\u{f696}"
        case .includeRegular: return "\u{f697}"
        case .incognitoBold: return "\u{f698}"
        case .incognitoFilled: return "\u{f699}"
        case .incognitoLight: return "\u{f69a}"
        case .incognitoRegular: return "\u{f69b}"
        case .incomingCallLegacyBold: return "\u{f69c}"
        case .incomingCallLegacyFilled: return "\u{f69d}"
        case .incomingCallLegacyLight: return "\u{f69e}"
        case .incomingCallLegacyRegular: return "\u{f69f}"
        case .indentDecreaseBold: return "\u{f6a0}"
        case .indentDecreaseLight: return "\u{f6a1}"
        case .indentDecreaseRegular: return "\u{f6a2}"
        case .indentIncreaseBold: return "\u{f6a3}"
        case .indentIncreaseLight: return "\u{f6a4}"
        case .indentIncreaseRegular: return "\u{f6a5}"
        case .infoBadgeFilled: return "\u{f6a6}"
        case .infoCircleBold: return "\u{f6a7}"
        case .infoCircleFilled: return "\u{f6a8}"
        case .infoCircleLight: return "\u{f6a9}"
        case .infoCircleRegular: return "\u{f6aa}"
        case .infoCircleTwoBold: return "\u{f6ab}"
        case .infoCircleTwoFilled: return "\u{f6ac}"
        case .infoCircleTwoLight: return "\u{f6ad}"
        case .infoCircleTwoRegular: return "\u{f6ae}"
        case .inputBold: return "\u{f6af}"
        case .inputDisconnectedBold: return "\u{f6b0}"
        case .inputDisconnectedLight: return "\u{f6b1}"
        case .inputDisconnectedRegular: return "\u{f6b2}"
        case .inputLight: return "\u{f6b3}"
        case .inputRegular: return "\u{f6b4}"
        case .instantScheduleBold: return "\u{f6b5}"
        case .instantScheduleFilled: return "\u{f6b6}"
        case .instantScheduleLight: return "\u{f6b7}"
        case .instantScheduleRegular: return "\u{f6b8}"
        case .integerBold: return "\u{f6b9}"
        case .integerFilled: return "\u{f6ba}"
        case .integerLight: return "\u{f6bb}"
        case .integerRegular: return "\u{f6bc}"
        case .integrationsBold: return "\u{f6bd}"
        case .integrationsLight: return "\u{f6be}"
        case .integrationsRegular: return "\u{f6bf}"
        case .intelligentRoutingBold: return "\u{f6c0}"
        case .intelligentRoutingLight: return "\u{f6c1}"
        case .intelligentRoutingRegular: return "\u{f6c2}"
        case .interactionBold: return "\u{f6c3}"
        case .interactionFilled: return "\u{f6c4}"
        case .interactionLight: return "\u{f6c5}"
        case .interactionRegular: return "\u{f6c6}"
        case .invitedUserBold: return "\u{f6c7}"
        case .invitedUserLight: return "\u{f6c8}"
        case .invitedUserRegular: return "\u{f6c9}"
        case .italicBold: return "\u{f6ca}"
        case .italicFilled: return "\u{f6cb}"
        case .italicLight: return "\u{f6cc}"
        case .italicRegular: return "\u{f6cd}"
        case .joinAudioBold: return "\u{f6ce}"
        case .joinAudioFilled: return "\u{f6cf}"
        case .joinAudioLight: return "\u{f6d0}"
        case .joinAudioRegular: return "\u{f6d1}"
        case .keepInTouchBold: return "\u{f6d2}"
        case .keepInTouchFilled: return "\u{f6d3}"
        case .keepInTouchLight: return "\u{f6d4}"
        case .keepInTouchRegular: return "\u{f6d5}"
        case .keyboardBold: return "\u{f6d6}"
        case .keyboardCloseBold: return "\u{f6d7}"
        case .keyboardCloseLight: return "\u{f6d8}"
        case .keyboardCloseRegular: return "\u{f6d9}"
        case .keyboardLight: return "\u{f6da}"
        case .keyboardRegular: return "\u{f6db}"
        case .languageBold: return "\u{f6dc}"
        case .languageFilled: return "\u{f6dd}"
        case .languageLight: return "\u{f6de}"
        case .languageRegular: return "\u{f6df}"
        case .laptopBold: return "\u{f6e0}"
        case .laptopDisconnectedBold: return "\u{f6e1}"
        case .laptopDisconnectedLight: return "\u{f6e2}"
        case .laptopDisconnectedRegular: return "\u{f6e3}"
        case .laptopFilled: return "\u{f6e4}"
        case .laptopLight: return "\u{f6e5}"
        case .laptopRegular: return "\u{f6e6}"
        case .laserPointerBold: return "\u{f6e7}"
        case .laserPointerCursorBlackLight: return "\u{f6e8}"
        case .laserPointerCursorBlueLight: return "\u{f6e9}"
        case .laserPointerCursorGreenLight: return "\u{f6ea}"
        case .laserPointerCursorPurpleLight: return "\u{f6eb}"
        case .laserPointerCursorRedLight: return "\u{f6ec}"
        case .laserPointerCursorWhiteLight: return "\u{f6ed}"
        case .laserPointerCursorYellowLight: return "\u{f6ee}"
        case .laserPointerFilled: return "\u{f6ef}"
        case .laserPointerLight: return "\u{f6f0}"
        case .laserPointerRegular: return "\u{f6f1}"
        case .launchBold: return "\u{f6f2}"
        case .launchLight: return "\u{f6f3}"
        case .launchRegular: return "\u{f6f4}"
        case .layoutSideBySideVerticalBold: return "\u{f6f5}"
        case .layoutSideBySideVerticalFilled: return "\u{f6f6}"
        case .layoutSideBySideVerticalLight: return "\u{f6f7}"
        case .layoutSideBySideVerticalRegular: return "\u{f6f8}"
        case .leaveBreakoutSessionBold: return "\u{f6f9}"
        case .leaveBreakoutSessionLight: return "\u{f6fa}"
        case .leaveBreakoutSessionRegular: return "\u{f6fb}"
        case .leaveDeviceBold: return "\u{f6fc}"
        case .leaveDeviceLight: return "\u{f6fd}"
        case .leaveDeviceRegular: return "\u{f6fe}"
        case .likeBold: return "\u{f6ff}"
        case .likeFilled: return "\u{f700}"
        case .likeLight: return "\u{f701}"
        case .likeRegular: return "\u{f702}"
        case .linkBold: return "\u{f703}"
        case .linkLight: return "\u{f704}"
        case .linkRegular: return "\u{f705}"
        case .listBulletedBold: return "\u{f706}"
        case .listBulletedLight: return "\u{f707}"
        case .listBulletedRegular: return "\u{f708}"
        case .listMenuBold: return "\u{f709}"
        case .listMenuLight: return "\u{f70a}"
        case .listMenuRegular: return "\u{f70b}"
        case .listNumberedBold: return "\u{f70c}"
        case .listNumberedLight: return "\u{f70d}"
        case .listNumberedRegular: return "\u{f70e}"
        case .liveBold: return "\u{f70f}"
        case .liveFilled: return "\u{f710}"
        case .liveLight: return "\u{f711}"
        case .liveRegular: return "\u{f712}"
        case .locationBold: return "\u{f713}"
        case .locationFilled: return "\u{f714}"
        case .locationLight: return "\u{f715}"
        case .locationRegular: return "\u{f716}"
        case .longTextBoxBold: return "\u{f717}"
        case .longTextBoxLight: return "\u{f718}"
        case .longTextBoxRegular: return "\u{f719}"
        case .lowerHandBold: return "\u{f71a}"
        case .lowerHandLight: return "\u{f71b}"
        case .lowerHandRegular: return "\u{f71c}"
        case .magicPenBold: return "\u{f71d}"
        case .magicPenFilled: return "\u{f71e}"
        case .magicPenLight: return "\u{f71f}"
        case .magicPenRegular: return "\u{f720}"
        case .markAsUnreadBold: return "\u{f721}"
        case .markAsUnreadLight: return "\u{f722}"
        case .markAsUnreadRegular: return "\u{f723}"
        case .markdownBold: return "\u{f724}"
        case .markdownFilled: return "\u{f725}"
        case .markdownLight: return "\u{f726}"
        case .markdownRegular: return "\u{f727}"
        case .markerBold: return "\u{f728}"
        case .markerFilled: return "\u{f729}"
        case .markerLight: return "\u{f72a}"
        case .markerRegular: return "\u{f72b}"
        case .maximizeBold: return "\u{f72c}"
        case .maximizeLight: return "\u{f72d}"
        case .maximizeRegular: return "\u{f72e}"
        case .mediaPlayerBold: return "\u{f72f}"
        case .mediaPlayerLight: return "\u{f730}"
        case .mediaPlayerRegular: return "\u{f731}"
        case .mediaQualityGoodBold: return "\u{f732}"
        case .mediaQualityGoodFilled: return "\u{f733}"
        case .mediaQualityGoodLight: return "\u{f734}"
        case .mediaQualityGoodRegular: return "\u{f735}"
        case .mediaQualityPoorBold: return "\u{f736}"
        case .mediaQualityPoorFilled: return "\u{f737}"
        case .mediaQualityPoorLight: return "\u{f738}"
        case .mediaQualityPoorRegular: return "\u{f739}"
        case .mediaQualityUnstableBold: return "\u{f73a}"
        case .mediaQualityUnstableFilled: return "\u{f73b}"
        case .mediaQualityUnstableLight: return "\u{f73c}"
        case .mediaQualityUnstableRegular: return "\u{f73d}"
        case .meetBold: return "\u{f73e}"
        case .meetEndBold: return "\u{f73f}"
        case .meetEndLight: return "\u{f740}"
        case .meetEndRegular: return "\u{f741}"
        case .meetFilled: return "\u{f742}"
        case .meetLight: return "\u{f743}"
        case .meetRegular: return "\u{f744}"
        case .meetingSummaryBold: return "\u{f745}"
        case .meetingSummaryFilled: return "\u{f746}"
        case .meetingSummaryLight: return "\u{f747}"
        case .meetingSummaryRegular: return "\u{f748}"
        case .meetingsBold: return "\u{f749}"
        case .meetingsFilled: return "\u{f74a}"
        case .meetingsFocusMonthBold: return "\u{f74b}"
        case .meetingsFocusMonthLight: return "\u{f74c}"
        case .meetingsFocusMonthRegular: return "\u{f74d}"
        case .meetingsFocusOneDayBold: return "\u{f74e}"
        case .meetingsFocusOneDayLight: return "\u{f74f}"
        case .meetingsFocusOneDayRegular: return "\u{f750}"
        case .meetingsFocusThreeDayBold: return "\u{f751}"
        case .meetingsFocusThreeDayLight: return "\u{f752}"
        case .meetingsFocusThreeDayRegular: return "\u{f753}"
        case .meetingsFocusUpcomingBold: return "\u{f754}"
        case .meetingsFocusUpcomingLight: return "\u{f755}"
        case .meetingsFocusUpcomingRegular: return "\u{f756}"
        case .meetingsLight: return "\u{f757}"
        case .meetingsPresenceBadgeFilled: return "\u{f758}"
        case .meetingsPresenceBold: return "\u{f759}"
        case .meetingsPresenceFilled: return "\u{f75a}"
        case .meetingsPresenceLight: return "\u{f75b}"
        case .meetingsPresenceRegular: return "\u{f75c}"
        case .meetingsRegular: return "\u{f75d}"
        case .meetingsTeamBold: return "\u{f75e}"
        case .meetingsTeamFilled: return "\u{f75f}"
        case .meetingsTeamLight: return "\u{f760}"
        case .meetingsTeamNewBold: return "\u{f761}"
        case .meetingsTeamNewLight: return "\u{f762}"
        case .meetingsTeamNewRegular: return "\u{f763}"
        case .meetingsTeamRegular: return "\u{f764}"
        case .mentionBold: return "\u{f765}"
        case .mentionLight: return "\u{f766}"
        case .mentionRegular: return "\u{f767}"
        case .messageQueingBold: return "\u{f768}"
        case .messageQueingLight: return "\u{f769}"
        case .messageQueingRegular: return "\u{f76a}"
        case .microphoneBold: return "\u{f76b}"
        case .microphoneFilled: return "\u{f76c}"
        case .microphoneHardMutedBold: return "\u{f76d}"
        case .microphoneHardMutedCircleFilled: return "\u{f76e}"
        case .microphoneHardMutedLight: return "\u{f76f}"
        case .microphoneHardMutedRegular: return "\u{f770}"
        case .microphoneLight: return "\u{f771}"
        case .microphoneMusicModeBold: return "\u{f772}"
        case .microphoneMusicModeLight: return "\u{f773}"
        case .microphoneMusicModeOnBold: return "\u{f774}"
        case .microphoneMusicModeOnLight: return "\u{f775}"
        case .microphoneMusicModeOnRegular: return "\u{f776}"
        case .microphoneMusicModeRegular: return "\u{f777}"
        case .microphoneMutedBold: return "\u{f778}"
        case .microphoneMutedCircleFilled: return "\u{f779}"
        case .microphoneMutedFilled: return "\u{f77a}"
        case .microphoneMutedLight: return "\u{f77b}"
        case .microphoneMutedRegular: return "\u{f77c}"
        case .microphoneOnBold: return "\u{f77d}"
        case .microphoneOnLight: return "\u{f77e}"
        case .microphoneOnRegular: return "\u{f77f}"
        case .microphoneOptAllBold: return "\u{f780}"
        case .microphoneOptAllLight: return "\u{f781}"
        case .microphoneOptAllMutedBold: return "\u{f782}"
        case .microphoneOptAllMutedLight: return "\u{f783}"
        case .microphoneOptAllMutedRegular: return "\u{f784}"
        case .microphoneOptAllOnBold: return "\u{f785}"
        case .microphoneOptAllOnLight: return "\u{f786}"
        case .microphoneOptAllOnRegular: return "\u{f787}"
        case .microphoneOptAllRegular: return "\u{f788}"
        case .microphoneOptMeBold: return "\u{f789}"
        case .microphoneOptMeLight: return "\u{f78a}"
        case .microphoneOptMeMutedBold: return "\u{f78b}"
        case .microphoneOptMeMutedLight: return "\u{f78c}"
        case .microphoneOptMeMutedRegular: return "\u{f78d}"
        case .microphoneOptMeOnBold: return "\u{f78e}"
        case .microphoneOptMeOnLight: return "\u{f78f}"
        case .microphoneOptMeOnRegular: return "\u{f790}"
        case .microphoneOptMeRegular: return "\u{f791}"
        case .microphoneRegular: return "\u{f792}"
        case .mindMapBold: return "\u{f793}"
        case .mindMapLight: return "\u{f794}"
        case .mindMapRegular: return "\u{f795}"
        case .minimizeBold: return "\u{f796}"
        case .minimizeLight: return "\u{f797}"
        case .minimizeRegular: return "\u{f798}"
        case .minusBold: return "\u{f799}"
        case .minusLight: return "\u{f79a}"
        case .minusRegular: return "\u{f79b}"
        case .mirrorBold: return "\u{f79c}"
        case .mirrorFilled: return "\u{f79d}"
        case .mirrorLight: return "\u{f79e}"
        case .mirrorRegular: return "\u{f79f}"
        case .mmsFilled: return "\u{f7a0}"
        case .moderatorBold: return "\u{f7a1}"
        case .moderatorLight: return "\u{f7a2}"
        case .moderatorRegular: return "\u{f7a3}"
        case .monitoringBold: return "\u{f7a4}"
        case .monitoringLight: return "\u{f7a5}"
        case .monitoringRegular: return "\u{f7a6}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7a7}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7a8}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7a9}"
        case .moreAdrBold: return "\u{f7aa}"
        case .moreAdrLight: return "\u{f7ab}"
        case .moreAdrRegular: return "\u{f7ac}"
        case .moreBold: return "\u{f7ad}"
        case .moreCircleBold: return "\u{f7ae}"
        case .moreCircleFilled: return "\u{f7af}"
        case .moreCircleLight: return "\u{f7b0}"
        case .moreCircleRegular: return "\u{f7b1}"
        case .moreLight: return "\u{f7b2}"
        case .moreRegular: return "\u{f7b3}"
        case .mouseCursorBold: return "\u{f7b4}"
        case .mouseCursorLight: return "\u{f7b5}"
        case .mouseCursorRegular: return "\u{f7b6}"
        case .moveCallInAdrBold: return "\u{f7b7}"
        case .moveCallInAdrLight: return "\u{f7b8}"
        case .moveCallInAdrRegular: return "\u{f7b9}"
        case .moveCallInIphBold: return "\u{f7ba}"
        case .moveCallInIphLight: return "\u{f7bb}"
        case .moveCallInIphRegular: return "\u{f7bc}"
        case .moveCallInLaptopBold: return "\u{f7bd}"
        case .moveCallInLaptopLight: return "\u{f7be}"
        case .moveCallInLaptopRegular: return "\u{f7bf}"
        case .moveCallInOutAdrBold: return "\u{f7c0}"
        case .moveCallInOutAdrLight: return "\u{f7c1}"
        case .moveCallInOutAdrRegular: return "\u{f7c2}"
        case .moveCallInOutIphBold: return "\u{f7c3}"
        case .moveCallInOutIphLight: return "\u{f7c4}"
        case .moveCallInOutIphRegular: return "\u{f7c5}"
        case .moveCallInTabletBold: return "\u{f7c6}"
        case .moveCallInTabletLight: return "\u{f7c7}"
        case .moveCallInTabletRegular: return "\u{f7c8}"
        case .moveCallOutAdrBold: return "\u{f7c9}"
        case .moveCallOutAdrLight: return "\u{f7ca}"
        case .moveCallOutAdrRegular: return "\u{f7cb}"
        case .moveCallOutIphBold: return "\u{f7cc}"
        case .moveCallOutIphLight: return "\u{f7cd}"
        case .moveCallOutIphRegular: return "\u{f7ce}"
        case .moveCallOutLaptopBold: return "\u{f7cf}"
        case .moveCallOutLaptopLight: return "\u{f7d0}"
        case .moveCallOutLaptopRegular: return "\u{f7d1}"
        case .moveCallOutTabletBold: return "\u{f7d2}"
        case .moveCallOutTabletLight: return "\u{f7d3}"
        case .moveCallOutTabletRegular: return "\u{f7d4}"
        case .moveToScreenBold: return "\u{f7d5}"
        case .moveToScreenLight: return "\u{f7d6}"
        case .moveToScreenRegular: return "\u{f7d7}"
        case .multilineChartBold: return "\u{f7d8}"
        case .multilineChartFilled: return "\u{f7d9}"
        case .multilineChartLight: return "\u{f7da}"
        case .multilineChartRegular: return "\u{f7db}"
        case .multimediaBold: return "\u{f7dc}"
        case .multimediaFilled: return "\u{f7dd}"
        case .multimediaLight: return "\u{f7de}"
        case .multimediaRegular: return "\u{f7df}"
        case .multipledDevicesBold: return "\u{f7e0}"
        case .multipledDevicesLight: return "\u{f7e1}"
        case .multipledDevicesRegular: return "\u{f7e2}"
        case .musicModeCircleBold: return "\u{f7e3}"
        case .musicModeCircleFilled: return "\u{f7e4}"
        case .musicModeCircleLight: return "\u{f7e5}"
        case .musicModeCircleRegular: return "\u{f7e6}"
        case .musicNoteBold: return "\u{f7e7}"
        case .musicNoteFilled: return "\u{f7e8}"
        case .musicNoteLight: return "\u{f7e9}"
        case .musicNoteRegular: return "\u{f7ea}"
        case .muteOnEntryBold: return "\u{f7eb}"
        case .muteOnEntryFilled: return "\u{f7ec}"
        case .muteOnEntryLight: return "\u{f7ed}"
        case .muteOnEntryRegular: return "\u{f7ee}"
        case .newManagerBold: return "\u{f7ef}"
        case .newManagerLight: return "\u{f7f0}"
        case .newManagerRegular: return "\u{f7f1}"
        case .newTitleBold: return "\u{f7f2}"
        case .newTitleLight: return "\u{f7f3}"
        case .newTitleRegular: return "\u{f7f4}"
        case .newVoicemailBold: return "\u{f7f5}"
        case .newVoicemailLight: return "\u{f7f6}"
        case .newVoicemailRegular: return "\u{f7f7}"
        case .newWhiteboardBold: return "\u{f7f8}"
        case .newWhiteboardLight: return "\u{f7f9}"
        case .newWhiteboardRegular: return "\u{f7fa}"
        case .nextBold: return "\u{f7fb}"
        case .nextLight: return "\u{f7fc}"
        case .nextRegular: return "\u{f7fd}"
        case .noDevicesBold: return "\u{f7fe}"
        case .noDevicesLight: return "\u{f7ff}"
        case .noDevicesRegular: return "\u{f800}"
        case .noiseDetectedCanceledFilled: return "\u{f801}"
        case .noiseDetectedFilled: return "\u{f802}"
        case .noiseNoneCanceledFilled: return "\u{f803}"
        case .noiseNoneFilled: return "\u{f804}"
        case .noiseRemovalBold: return "\u{f805}"
        case .noiseRemovalLight: return "\u{f806}"
        case .noiseRemovalRegular: return "\u{f807}"
        case .noteBold: return "\u{f808}"
        case .noteLight: return "\u{f809}"
        case .notePptBold: return "\u{f80a}"
        case .notePptLight: return "\u{f80b}"
        case .notePptRegular: return "\u{f80c}"
        case .noteRegular: return "\u{f80d}"
        case .notesBold: return "\u{f80e}"
        case .notesFilled: return "\u{f80f}"
        case .notesLight: return "\u{f810}"
        case .notesRegular: return "\u{f811}"
        case .numberBold: return "\u{f812}"
        case .numberLight: return "\u{f813}"
        case .numberRegular: return "\u{f814}"
        case .oldRemoteBold: return "\u{f815}"
        case .oldRemoteLight: return "\u{f816}"
        case .oldRemoteRegular: return "\u{f817}"
        case .oldTouchBold: return "\u{f818}"
        case .oldTouchLight: return "\u{f819}"
        case .oldTouchRegular: return "\u{f81a}"
        case .oneColumnBold: return "\u{f81b}"
        case .oneColumnLight: return "\u{f81c}"
        case .oneColumnRegular: return "\u{f81d}"
        case .oneTimeBold: return "\u{f81e}"
        case .oneTimeLight: return "\u{f81f}"
        case .oneTimeRegular: return "\u{f820}"
        case .openInFolderBold: return "\u{f821}"
        case .openInFolderLight: return "\u{f822}"
        case .openInFolderRegular: return "\u{f823}"
        case .openPagesBold: return "\u{f824}"
        case .openPagesLight: return "\u{f825}"
        case .openPagesRegular: return "\u{f826}"
        case .otherNumberBold: return "\u{f827}"
        case .otherNumberFilled: return "\u{f828}"
        case .otherNumberLight: return "\u{f829}"
        case .otherNumberRegular: return "\u{f82a}"
        case .otherNumberWarningBold: return "\u{f82b}"
        case .otherNumberWarningLight: return "\u{f82c}"
        case .otherNumberWarningRegular: return "\u{f82d}"
        case .outgoingCallLegacyBold: return "\u{f82e}"
        case .outgoingCallLegacyFilled: return "\u{f82f}"
        case .outgoingCallLegacyLight: return "\u{f830}"
        case .outgoingCallLegacyRegular: return "\u{f831}"
        case .overflowLeftBold: return "\u{f832}"
        case .overflowLeftLight: return "\u{f833}"
        case .overflowLeftRegular: return "\u{f834}"
        case .overflowRightBold: return "\u{f835}"
        case .overflowRightLight: return "\u{f836}"
        case .overflowRightRegular: return "\u{f837}"
        case .pairedCameraBold: return "\u{f838}"
        case .pairedCameraLight: return "\u{f839}"
        case .pairedCameraRegular: return "\u{f83a}"
        case .pairedDeviceBold: return "\u{f83b}"
        case .pairedDeviceLight: return "\u{f83c}"
        case .pairedDeviceRegular: return "\u{f83d}"
        case .pairedHandsetBold: return "\u{f83e}"
        case .pairedHandsetLight: return "\u{f83f}"
        case .pairedHandsetRegular: return "\u{f840}"
        case .pairingBold: return "\u{f841}"
        case .pairingLight: return "\u{f842}"
        case .pairingRegular: return "\u{f843}"
        case .parenthesisBold: return "\u{f844}"
        case .parenthesisFilled: return "\u{f845}"
        case .parenthesisLight: return "\u{f846}"
        case .parenthesisRegular: return "\u{f847}"
        case .parkedBold: return "\u{f848}"
        case .parkedFilled: return "\u{f849}"
        case .parkedLight: return "\u{f84a}"
        case .parkedRegular: return "\u{f84b}"
        case .parseBold: return "\u{f84c}"
        case .parseLight: return "\u{f84d}"
        case .parseRegular: return "\u{f84e}"
        case .partialBold: return "\u{f84f}"
        case .partialLight: return "\u{f850}"
        case .partialRegular: return "\u{f851}"
        case .participantAddBold: return "\u{f852}"
        case .participantAddLight: return "\u{f853}"
        case .participantAddRegular: return "\u{f854}"
        case .participantBlockedBold: return "\u{f855}"
        case .participantBlockedLight: return "\u{f856}"
        case .participantBlockedRegular: return "\u{f857}"
        case .participantBold: return "\u{f858}"
        case .participantFilled: return "\u{f859}"
        case .participantLight: return "\u{f85a}"
        case .participantListBold: return "\u{f85b}"
        case .participantListFilled: return "\u{f85c}"
        case .participantListLight: return "\u{f85d}"
        case .participantListRegular: return "\u{f85e}"
        case .participantRegular: return "\u{f85f}"
        case .participantRemoveBold: return "\u{f860}"
        case .participantRemoveLight: return "\u{f861}"
        case .participantRemoveRegular: return "\u{f862}"
        case .participantUnknownBold: return "\u{f863}"
        case .participantUnknownLight: return "\u{f864}"
        case .participantUnknownRegular: return "\u{f865}"
        case .passMouseBold: return "\u{f866}"
        case .passMouseLight: return "\u{f867}"
        case .passMouseRegular: return "\u{f868}"
        case .pauseBadgeFilled: return "\u{f869}"
        case .pauseBold: return "\u{f86a}"
        case .pauseFilled: return "\u{f86b}"
        case .pauseLight: return "\u{f86c}"
        case .pauseRegular: return "\u{f86d}"
        case .peopleAddBold: return "\u{f86e}"
        case .peopleAddFilled: return "\u{f86f}"
        case .peopleAddLight: return "\u{f870}"
        case .peopleAddRegular: return "\u{f871}"
        case .peopleBold: return "\u{f872}"
        case .peopleCircleBold: return "\u{f873}"
        case .peopleCircleFilled: return "\u{f874}"
        case .peopleCircleLight: return "\u{f875}"
        case .peopleCircleRegular: return "\u{f876}"
        case .peopleFilled: return "\u{f877}"
        case .peopleInsightsBold: return "\u{f878}"
        case .peopleInsightsFilled: return "\u{f879}"
        case .peopleInsightsLight: return "\u{f87a}"
        case .peopleInsightsRegular: return "\u{f87b}"
        case .peopleLight: return "\u{f87c}"
        case .peopleRegular: return "\u{f87d}"
        case .phoneAlertBold: return "\u{f87e}"
        case .phoneAlertLight: return "\u{f87f}"
        case .phoneAlertRegular: return "\u{f880}"
        case .phoneBadgeFilled: return "\u{f881}"
        case .phoneBold: return "\u{f882}"
        case .phoneFilled: return "\u{f883}"
        case .phoneLight: return "\u{f884}"
        case .phoneMutedBold: return "\u{f885}"
        case .phoneMutedLight: return "\u{f886}"
        case .phoneMutedRegular: return "\u{f887}"
        case .phonePrivateBold: return "\u{f888}"
        case .phonePrivateLight: return "\u{f889}"
        case .phonePrivateRegular: return "\u{f88a}"
        case .phoneRegular: return "\u{f88b}"
        case .phoneReplyAllBold: return "\u{f88c}"
        case .phoneReplyAllLight: return "\u{f88d}"
        case .phoneReplyAllRegular: return "\u{f88e}"
        case .phoneReplyBold: return "\u{f88f}"
        case .phoneReplyLight: return "\u{f890}"
        case .phoneReplyRegular: return "\u{f891}"
        case .pickerBold: return "\u{f892}"
        case .pickerLight: return "\u{f893}"
        case .pickerRegular: return "\u{f894}"
        case .pieChartBold: return "\u{f895}"
        case .pieChartFilled: return "\u{f896}"
        case .pieChartLight: return "\u{f897}"
        case .pieChartRegular: return "\u{f898}"
        case .pinBold: return "\u{f899}"
        case .pinFilled: return "\u{f89a}"
        case .pinLight: return "\u{f89b}"
        case .pinListActivityBold: return "\u{f89c}"
        case .pinListActivityLight: return "\u{f89d}"
        case .pinListActivityRegular: return "\u{f89e}"
        case .pinListBold: return "\u{f89f}"
        case .pinListLight: return "\u{f8a0}"
        case .pinListRegular: return "\u{f8a1}"
        case .pinMutedBold: return "\u{f8a2}"
        case .pinMutedFilled: return "\u{f8a3}"
        case .pinMutedLight: return "\u{f8a4}"
        case .pinMutedRegular: return "\u{f8a5}"
        case .pinRegular: return "\u{f8a6}"
        case .pipBold: return "\u{f8a7}"
        case .pipEnterBold: return "\u{f8a8}"
        case .pipEnterLight: return "\u{f8a9}"
        case .pipEnterRegular: return "\u{f8aa}"
        case .pipExitBold: return "\u{f8ab}"
        case .pipExitLight: return "\u{f8ac}"
        case .pipExitRegular: return "\u{f8ad}"
        case .pipFilled: return "\u{f8ae}"
        case .pipLight: return "\u{f8af}"
        case .pipRegular: return "\u{f8b0}"
        case .placeholderBold: return "\u{f8b1}"
        case .placeholderFilled: return "\u{f8b2}"
        case .placeholderLight: return "\u{f8b3}"
        case .placeholderRegular: return "\u{f8b4}"
        case .playBold: return "\u{f8b5}"
        case .playCircleBold: return "\u{f8b6}"
        case .playCircleFilled: return "\u{f8b7}"
        case .playCircleLight: return "\u{f8b8}"
        case .playCircleRegular: return "\u{f8b9}"
        case .playFilled: return "\u{f8ba}"
        case .playLight: return "\u{f8bb}"
        case .playRegular: return "\u{f8bc}"
        case .plugAcBold: return "\u{f8bd}"
        case .plugAcLight: return "\u{f8be}"
        case .plugAcRegular: return "\u{f8bf}"
        case .plusBold: return "\u{f8c0}"
        case .plusCircleBold: return "\u{f8c1}"
        case .plusCircleFilled: return "\u{f8c2}"
        case .plusCircleLight: return "\u{f8c3}"
        case .plusCircleRegular: return "\u{f8c4}"
        case .plusLight: return "\u{f8c5}"
        case .plusRegular: return "\u{f8c6}"
        case .pmrBold: return "\u{f8c7}"
        case .pmrFilled: return "\u{f8c8}"
        case .pmrLight: return "\u{f8c9}"
        case .pmrRegular: return "\u{f8ca}"
        case .pollBold: return "\u{f8cb}"
        case .pollFilled: return "\u{f8cc}"
        case .pollLight: return "\u{f8cd}"
        case .pollRegular: return "\u{f8ce}"
        case .popInBold: return "\u{f8cf}"
        case .popInLight: return "\u{f8d0}"
        case .popInRegular: return "\u{f8d1}"
        case .popOutBold: return "\u{f8d2}"
        case .popOutLight: return "\u{f8d3}"
        case .popOutRegular: return "\u{f8d4}"
        case .popUpBold: return "\u{f8d5}"
        case .popUpLight: return "\u{f8d6}"
        case .popUpRegular: return "\u{f8d7}"
        case .portraitLandscapeBold: return "\u{f8d8}"
        case .portraitLandscapeLight: return "\u{f8d9}"
        case .portraitLandscapeRegular: return "\u{f8da}"
        case .potentialFraudBold: return "\u{f8db}"
        case .potentialFraudFilled: return "\u{f8dc}"
        case .potentialFraudLight: return "\u{f8dd}"
        case .potentialFraudRegular: return "\u{f8de}"
        case .powerAcBold: return "\u{f8df}"
        case .powerAcLight: return "\u{f8e0}"
        case .powerAcRegular: return "\u{f8e1}"
        case .powerBold: return "\u{f8e2}"
        case .powerLight: return "\u{f8e3}"
        case .powerRegular: return "\u{f8e4}"
        case .preHeaderBold: return "\u{f8e5}"
        case .preHeaderLight: return "\u{f8e6}"
        case .preHeaderRegular: return "\u{f8e7}"
        case .premiumBold: return "\u{f8e8}"
        case .premiumLight: return "\u{f8e9}"
        case .premiumRegular: return "\u{f8ea}"
        case .presentationBold: return "\u{f8eb}"
        case .presentationLight: return "\u{f8ec}"
        case .presentationRegular: return "\u{f8ed}"
        case .preventDownloadBold: return "\u{f8ee}"
        case .preventDownloadFilled: return "\u{f8ef}"
        case .preventDownloadLight: return "\u{f8f0}"
        case .preventDownloadRegular: return "\u{f8f1}"
        case .primaryParticipantBold: return "\u{f8f2}"
        case .primaryParticipantLight: return "\u{f8f3}"
        case .primaryParticipantRegular: return "\u{f8f4}"
        case .printBold: return "\u{f8f5}"
        case .printLight: return "\u{f8f6}"
        case .printRegular: return "\u{f8f7}"
        case .priorityBadgeFilled: return "\u{f8f8}"
        case .priorityCircleBold: return "\u{f8f9}"
        case .priorityCircleFilled: return "\u{f8fa}"
        case .priorityCircleLight: return "\u{f8fb}"
        case .priorityCircleRegular: return "\u{f8fc}"
        case .priorityCircleTwoBold: return "\u{f8fd}"
        case .priorityCircleTwoFilled: return "\u{f8fe}"
        case .priorityCircleTwoLight: return "\u{f8ff}"
        case .priorityCircleTwoRegular: return "\u{f900}"
        case .priorityWaveBold: return "\u{f901}"
        case .priorityWaveLight: return "\u{f902}"
        case .priorityWaveRegular: return "\u{f903}"
        case .privacyCircleBold: return "\u{f904}"
        case .privacyCircleFilled: return "\u{f905}"
        case .privacyCircleLight: return "\u{f906}"
        case .privacyCircleRegular: return "\u{f907}"
        case .privateBold: return "\u{f908}"
        case .privateCircleBold: return "\u{f909}"
        case .privateCircleFilled: return "\u{f90a}"
        case .privateCircleLight: return "\u{f90b}"
        case .privateCircleRegular: return "\u{f90c}"
        case .privateLight: return "\u{f90d}"
        case .privateMeetingBold: return "\u{f90e}"
        case .privateMeetingLight: return "\u{f90f}"
        case .privateMeetingRegular: return "\u{f910}"
        case .privateRegular: return "\u{f911}"
        case .productDemoBold: return "\u{f912}"
        case .productDemoLight: return "\u{f913}"
        case .productDemoRegular: return "\u{f914}"
        case .promptsAiBold: return "\u{f915}"
        case .promptsAiLight: return "\u{f916}"
        case .promptsAiRegular: return "\u{f917}"
        case .proximityBold: return "\u{f918}"
        case .proximityLight: return "\u{f919}"
        case .proximityMutedBold: return "\u{f91a}"
        case .proximityMutedLight: return "\u{f91b}"
        case .proximityMutedRegular: return "\u{f91c}"
        case .proximityRegular: return "\u{f91d}"
        case .proximityVideoBold: return "\u{f91e}"
        case .proximityVideoLight: return "\u{f91f}"
        case .proximityVideoRegular: return "\u{f920}"
        case .ptoPresenceBold: return "\u{f921}"
        case .ptoPresenceFilled: return "\u{f922}"
        case .ptoPresenceLight: return "\u{f923}"
        case .ptoPresenceRegular: return "\u{f924}"
        case .pullCallBold: return "\u{f925}"
        case .pullCallFilled: return "\u{f926}"
        case .pullCallLight: return "\u{f927}"
        case .pullCallRegular: return "\u{f928}"
        case .qABold: return "\u{f929}"
        case .qAFilled: return "\u{f92a}"
        case .qALight: return "\u{f92b}"
        case .qARegular: return "\u{f92c}"
        case .qrCodeBold: return "\u{f92d}"
        case .qrCodeLight: return "\u{f92e}"
        case .qrCodeRegular: return "\u{f92f}"
        case .qrCodeScanBold: return "\u{f930}"
        case .qrCodeScanLight: return "\u{f931}"
        case .qrCodeScanRegular: return "\u{f932}"
        case .qualityBold: return "\u{f933}"
        case .qualityLight: return "\u{f934}"
        case .qualityRegular: return "\u{f935}"
        case .queueContactBold: return "\u{f936}"
        case .queueContactFilled: return "\u{f937}"
        case .queueContactLight: return "\u{f938}"
        case .queueContactRegular: return "\u{f939}"
        case .quietBold: return "\u{f93a}"
        case .quietHoursPresenceBold: return "\u{f93b}"
        case .quietHoursPresenceFilled: return "\u{f93c}"
        case .quietHoursPresenceLight: return "\u{f93d}"
        case .quietHoursPresenceRegular: return "\u{f93e}"
        case .quietLight: return "\u{f93f}"
        case .quietRegular: return "\u{f940}"
        case .radioButtonGroupBold: return "\u{f941}"
        case .radioButtonGroupLight: return "\u{f942}"
        case .radioButtonGroupRegular: return "\u{f943}"
        case .raiseHandBold: return "\u{f944}"
        case .raiseHandCircleFilled: return "\u{f945}"
        case .raiseHandFilled: return "\u{f946}"
        case .raiseHandLight: return "\u{f947}"
        case .raiseHandRegular: return "\u{f948}"
        case .ramBold: return "\u{f949}"
        case .ramLight: return "\u{f94a}"
        case .ramRegular: return "\u{f94b}"
        case .reactionsBold: return "\u{f94c}"
        case .reactionsFilled: return "\u{f94d}"
        case .reactionsLight: return "\u{f94e}"
        case .reactionsRegular: return "\u{f94f}"
        case .reactivateBold: return "\u{f950}"
        case .reactivateLight: return "\u{f951}"
        case .reactivateRegular: return "\u{f952}"
        case .receiveVoiceBold: return "\u{f953}"
        case .receiveVoiceFilled: return "\u{f954}"
        case .receiveVoiceLight: return "\u{f955}"
        case .receiveVoiceRegular: return "\u{f956}"
        case .recentsBold: return "\u{f957}"
        case .recentsFilled: return "\u{f958}"
        case .recentsLight: return "\u{f959}"
        case .recentsPresenceBadgeFilled: return "\u{f95a}"
        case .recentsPresenceBold: return "\u{f95b}"
        case .recentsPresenceFilled: return "\u{f95c}"
        case .recentsPresenceLight: return "\u{f95d}"
        case .recentsPresenceRegular: return "\u{f95e}"
        case .recentsRegular: return "\u{f95f}"
        case .recordActiveBadgeFilled: return "\u{f960}"
        case .recordActiveBold: return "\u{f961}"
        case .recordActiveFilled: return "\u{f962}"
        case .recordActiveLight: return "\u{f963}"
        case .recordActiveRegular: return "\u{f964}"
        case .recordBold: return "\u{f965}"
        case .recordFilled: return "\u{f966}"
        case .recordLight: return "\u{f967}"
        case .recordPausedBadgeFilled: return "\u{f968}"
        case .recordPausedBold: return "\u{f969}"
        case .recordPausedFilled: return "\u{f96a}"
        case .recordPausedLight: return "\u{f96b}"
        case .recordPausedRegular: return "\u{f96c}"
        case .recordRegular: return "\u{f96d}"
        case .recurringBold: return "\u{f96e}"
        case .recurringLight: return "\u{f96f}"
        case .recurringOffBold: return "\u{f970}"
        case .recurringOffLight: return "\u{f971}"
        case .recurringOffRegular: return "\u{f972}"
        case .recurringRegular: return "\u{f973}"
        case .redoBold: return "\u{f974}"
        case .redoLight: return "\u{f975}"
        case .redoRegular: return "\u{f976}"
        case .refreshBold: return "\u{f977}"
        case .refreshLight: return "\u{f978}"
        case .refreshRegular: return "\u{f979}"
        case .remoteDesktopControlBold: return "\u{f97a}"
        case .remoteDesktopControlFilled: return "\u{f97b}"
        case .remoteDesktopControlLight: return "\u{f97c}"
        case .remoteDesktopControlRegular: return "\u{f97d}"
        case .removeBold: return "\u{f97e}"
        case .removeFilled: return "\u{f97f}"
        case .removeLight: return "\u{f980}"
        case .removeRegular: return "\u{f981}"
        case .replyBold: return "\u{f982}"
        case .replyFilled: return "\u{f983}"
        case .replyLight: return "\u{f984}"
        case .replyListBold: return "\u{f985}"
        case .replyListLight: return "\u{f986}"
        case .replyListRegular: return "\u{f987}"
        case .replyPrivatelyBold: return "\u{f988}"
        case .replyPrivatelyLight: return "\u{f989}"
        case .replyPrivatelyRegular: return "\u{f98a}"
        case .replyRegular: return "\u{f98b}"
        case .resetBold: return "\u{f98c}"
        case .resetLight: return "\u{f98d}"
        case .resetRegular: return "\u{f98e}"
        case .resizeCornerBold: return "\u{f98f}"
        case .resizeCornerLight: return "\u{f990}"
        case .resizeCornerRegular: return "\u{f991}"
        case .responsiveMobileBold: return "\u{f992}"
        case .responsiveMobileLight: return "\u{f993}"
        case .responsiveMobileRegular: return "\u{f994}"
        case .restartBold: return "\u{f995}"
        case .restartLight: return "\u{f996}"
        case .restartRegular: return "\u{f997}"
        case .retrieveCallBold: return "\u{f998}"
        case .retrieveCallFilled: return "\u{f999}"
        case .retrieveCallLight: return "\u{f99a}"
        case .retrieveCallRegular: return "\u{f99b}"
        case .returnBold: return "\u{f99c}"
        case .returnLight: return "\u{f99d}"
        case .returnRegular: return "\u{f99e}"
        case .rewindTenSecBold: return "\u{f99f}"
        case .rewindTenSecLight: return "\u{f9a0}"
        case .rewindTenSecRegular: return "\u{f9a1}"
        case .ringtoneBold: return "\u{f9a2}"
        case .ringtoneLight: return "\u{f9a3}"
        case .ringtoneRegular: return "\u{f9a4}"
        case .roomCalendarBold: return "\u{f9a5}"
        case .roomCalendarLight: return "\u{f9a6}"
        case .roomCalendarRegular: return "\u{f9a7}"
        case .roomLightsBold: return "\u{f9a8}"
        case .roomLightsFilled: return "\u{f9a9}"
        case .roomLightsLight: return "\u{f9aa}"
        case .roomLightsRegular: return "\u{f9ab}"
        case .rotateContentBold: return "\u{f9ac}"
        case .rotateContentFilled: return "\u{f9ad}"
        case .rotateContentLight: return "\u{f9ae}"
        case .rotateContentRegular: return "\u{f9af}"
        case .rssBold: return "\u{f9b0}"
        case .rssFilled: return "\u{f9b1}"
        case .rssLight: return "\u{f9b2}"
        case .rssRegular: return "\u{f9b3}"
        case .ruleBasedBold: return "\u{f9b4}"
        case .ruleBasedLight: return "\u{f9b5}"
        case .ruleBasedRegular: return "\u{f9b6}"
        case .runningApplicationBold: return "\u{f9b7}"
        case .runningApplicationFilled: return "\u{f9b8}"
        case .runningApplicationLight: return "\u{f9b9}"
        case .runningApplicationRegular: return "\u{f9ba}"
        case .saveBold: return "\u{f9bb}"
        case .saveLight: return "\u{f9bc}"
        case .saveRegular: return "\u{f9bd}"
        case .saveTranscriptBold: return "\u{f9be}"
        case .saveTranscriptFilled: return "\u{f9bf}"
        case .saveTranscriptLight: return "\u{f9c0}"
        case .saveTranscriptRegular: return "\u{f9c1}"
        case .scanBold: return "\u{f9c2}"
        case .scanLight: return "\u{f9c3}"
        case .scanRegular: return "\u{f9c4}"
        case .scheduleAiBold: return "\u{f9c5}"
        case .scheduleAiLight: return "\u{f9c6}"
        case .scheduleAiRegular: return "\u{f9c7}"
        case .scheduleSendBold: return "\u{f9c8}"
        case .scheduleSendFilled: return "\u{f9c9}"
        case .scheduleSendLight: return "\u{f9ca}"
        case .scheduleSendRegular: return "\u{f9cb}"
        case .scheduleWinnerBold: return "\u{f9cc}"
        case .scheduleWinnerFilled: return "\u{f9cd}"
        case .scheduleWinnerLight: return "\u{f9ce}"
        case .scheduleWinnerRegular: return "\u{f9cf}"
        case .schedulerAvailableBold: return "\u{f9d0}"
        case .schedulerAvailableLight: return "\u{f9d1}"
        case .schedulerAvailableRegular: return "\u{f9d2}"
        case .schedulerNotWorkingHoursBold: return "\u{f9d3}"
        case .schedulerNotWorkingHoursLight: return "\u{f9d4}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9d5}"
        case .schedulerUnavailableBold: return "\u{f9d6}"
        case .schedulerUnavailableLight: return "\u{f9d7}"
        case .schedulerUnavailableRegular: return "\u{f9d8}"
        case .schedulerUnknownBold: return "\u{f9d9}"
        case .schedulerUnknownLight: return "\u{f9da}"
        case .schedulerUnknownRegular: return "\u{f9db}"
        case .screenshotBold: return "\u{f9dc}"
        case .screenshotDocBold: return "\u{f9dd}"
        case .screenshotDocFilled: return "\u{f9de}"
        case .screenshotDocLight: return "\u{f9df}"
        case .screenshotDocRegular: return "\u{f9e0}"
        case .screenshotLight: return "\u{f9e1}"
        case .screenshotRegular: return "\u{f9e2}"
        case .searchAiBold: return "\u{f9e3}"
        case .searchAiLight: return "\u{f9e4}"
        case .searchAiRegular: return "\u{f9e5}"
        case .searchBold: return "\u{f9e6}"
        case .searchFilled: return "\u{f9e7}"
        case .searchLight: return "\u{f9e8}"
        case .searchRegular: return "\u{f9e9}"
        case .secondaryArrowBold: return "\u{f9ea}"
        case .secondaryArrowLight: return "\u{f9eb}"
        case .secondaryArrowRegular: return "\u{f9ec}"
        case .secureCallLockBold: return "\u{f9ed}"
        case .secureCallLockFilled: return "\u{f9ee}"
        case .secureCallLockLight: return "\u{f9ef}"
        case .secureCallLockRegular: return "\u{f9f0}"
        case .secureCallShieldBold: return "\u{f9f1}"
        case .secureCallShieldFilled: return "\u{f9f2}"
        case .secureCallShieldLight: return "\u{f9f3}"
        case .secureCallShieldRegular: return "\u{f9f4}"
        case .secureCircleBold: return "\u{f9f5}"
        case .secureCircleFilled: return "\u{f9f6}"
        case .secureCircleLight: return "\u{f9f7}"
        case .secureCircleRegular: return "\u{f9f8}"
        case .secureLockBold: return "\u{f9f9}"
        case .secureLockFilled: return "\u{f9fa}"
        case .secureLockLight: return "\u{f9fb}"
        case .secureLockRegular: return "\u{f9fc}"
        case .segmentExcludeFilled: return "\u{f9fd}"
        case .segmentFilterFilled: return "\u{f9fe}"
        case .segmentIncludeFilled: return "\u{f9ff}"
        case .selectAllBold: return "\u{fa00}"
        case .selectAllFilled: return "\u{fa01}"
        case .selectAllLight: return "\u{fa02}"
        case .selectAllRegular: return "\u{fa03}"
        case .selectionBold: return "\u{fa04}"
        case .selectionFilled: return "\u{fa05}"
        case .selectionLight: return "\u{fa06}"
        case .selectionRegular: return "\u{fa07}"
        case .sendBold: return "\u{fa08}"
        case .sendDigitsBold: return "\u{fa09}"
        case .sendDigitsFilled: return "\u{fa0a}"
        case .sendDigitsLight: return "\u{fa0b}"
        case .sendDigitsRegular: return "\u{fa0c}"
        case .sendFilled: return "\u{fa0d}"
        case .sendLight: return "\u{fa0e}"
        case .sendRegular: return "\u{fa0f}"
        case .sendVoiceBold: return "\u{fa10}"
        case .sendVoiceFilled: return "\u{fa11}"
        case .sendVoiceLight: return "\u{fa12}"
        case .sendVoiceRegular: return "\u{fa13}"
        case .serverBold: return "\u{fa14}"
        case .serverErrorBold: return "\u{fa15}"
        case .serverErrorLight: return "\u{fa16}"
        case .serverErrorRegular: return "\u{fa17}"
        case .serverLight: return "\u{fa18}"
        case .serverRegular: return "\u{fa19}"
        case .servicesBold: return "\u{fa1a}"
        case .servicesLight: return "\u{fa1b}"
        case .servicesRegular: return "\u{fa1c}"
        case .setVariableBold: return "\u{fa1d}"
        case .setVariableLight: return "\u{fa1e}"
        case .setVariableRegular: return "\u{fa1f}"
        case .settingsBold: return "\u{fa20}"
        case .settingsFilled: return "\u{fa21}"
        case .settingsLight: return "\u{fa22}"
        case .settingsRegular: return "\u{fa23}"
        case .setupAssistantBold: return "\u{fa24}"
        case .setupAssistantLight: return "\u{fa25}"
        case .setupAssistantRegular: return "\u{fa26}"
        case .sftpBold: return "\u{fa27}"
        case .sftpLight: return "\u{fa28}"
        case .sftpRegular: return "\u{fa29}"
        case .shapeCircleBold: return "\u{fa2a}"
        case .shapeCircleFilled: return "\u{fa2b}"
        case .shapeCircleLight: return "\u{fa2c}"
        case .shapeCircleMdFilled: return "\u{fa2d}"
        case .shapeCircleRegular: return "\u{fa2e}"
        case .shapeCircleSmFilled: return "\u{fa2f}"
        case .shapeDiagonalLineBold: return "\u{fa30}"
        case .shapeDiagonalLineLight: return "\u{fa31}"
        case .shapeDiagonalLineRegular: return "\u{fa32}"
        case .shapeDiamondBold: return "\u{fa33}"
        case .shapeDiamondFilled: return "\u{fa34}"
        case .shapeDiamondLight: return "\u{fa35}"
        case .shapeDiamondRegular: return "\u{fa36}"
        case .shapeOvalBold: return "\u{fa37}"
        case .shapeOvalLight: return "\u{fa38}"
        case .shapeOvalRegular: return "\u{fa39}"
        case .shapeSquareBold: return "\u{fa3a}"
        case .shapeSquareFilled: return "\u{fa3b}"
        case .shapeSquareLight: return "\u{fa3c}"
        case .shapeSquareRegular: return "\u{fa3d}"
        case .shapeTriangleBold: return "\u{fa3e}"
        case .shapeTriangleFilled: return "\u{fa3f}"
        case .shapeTriangleLight: return "\u{fa40}"
        case .shapeTriangleRegular: return "\u{fa41}"
        case .shapesBold: return "\u{fa42}"
        case .shapesFilled: return "\u{fa43}"
        case .shapesLight: return "\u{fa44}"
        case .shapesRegular: return "\u{fa45}"
        case .shareCNativeAdrBold: return "\u{fa46}"
        case .shareCNativeAdrFilled: return "\u{fa47}"
        case .shareCNativeAdrLight: return "\u{fa48}"
        case .shareCNativeAdrRegular: return "\u{fa49}"
        case .shareCNativeIphBold: return "\u{fa4a}"
        case .shareCNativeIphLight: return "\u{fa4b}"
        case .shareCNativeIphRegular: return "\u{fa4c}"
        case .shareContentOnDeviceBold: return "\u{fa4d}"
        case .shareContentOnDeviceLight: return "\u{fa4e}"
        case .shareContentOnDeviceRegular: return "\u{fa4f}"
        case .shareScreenAddBold: return "\u{fa50}"
        case .shareScreenAddLight: return "\u{fa51}"
        case .shareScreenAddRegular: return "\u{fa52}"
        case .shareScreenBadgeFilled: return "\u{fa53}"
        case .shareScreenBold: return "\u{fa54}"
        case .shareScreenFilled: return "\u{fa55}"
        case .shareScreenLight: return "\u{fa56}"
        case .shareScreenRegular: return "\u{fa57}"
        case .shareSpaceBold: return "\u{fa58}"
        case .shareSpaceLight: return "\u{fa59}"
        case .shareSpaceRegular: return "\u{fa5a}"
        case .shieldBold: return "\u{fa5b}"
        case .shieldLight: return "\u{fa5c}"
        case .shieldRegular: return "\u{fa5d}"
        case .shoppingCartBold: return "\u{fa5e}"
        case .shoppingCartFilled: return "\u{fa5f}"
        case .shoppingCartLight: return "\u{fa60}"
        case .shoppingCartRegular: return "\u{fa61}"
        case .shortTextBoxBold: return "\u{fa62}"
        case .shortTextBoxLight: return "\u{fa63}"
        case .shortTextBoxRegular: return "\u{fa64}"
        case .showBold: return "\u{fa65}"
        case .showFilled: return "\u{fa66}"
        case .showLight: return "\u{fa67}"
        case .showRegular: return "\u{fa68}"
        case .sidePanelBold: return "\u{fa69}"
        case .sidePanelFilled: return "\u{fa6a}"
        case .sidePanelLight: return "\u{fa6b}"
        case .sidePanelRegular: return "\u{fa6c}"
        case .signInBold: return "\u{fa6d}"
        case .signInFilled: return "\u{fa6e}"
        case .signInForcedBold: return "\u{fa6f}"
        case .signInForcedLight: return "\u{fa70}"
        case .signInForcedRegular: return "\u{fa71}"
        case .signInLight: return "\u{fa72}"
        case .signInRegular: return "\u{fa73}"
        case .signLangIntBold: return "\u{fa74}"
        case .signLangIntLight: return "\u{fa75}"
        case .signLangIntRegular: return "\u{fa76}"
        case .signOutBold: return "\u{fa77}"
        case .signOutLight: return "\u{fa78}"
        case .signOutRegular: return "\u{fa79}"
        case .signalFourBold: return "\u{fa7a}"
        case .signalFourLight: return "\u{fa7b}"
        case .signalFourRegular: return "\u{fa7c}"
        case .signalOneBold: return "\u{fa7d}"
        case .signalOneLight: return "\u{fa7e}"
        case .signalOneRegular: return "\u{fa7f}"
        case .signalThreeBold: return "\u{fa80}"
        case .signalThreeLight: return "\u{fa81}"
        case .signalThreeRegular: return "\u{fa82}"
        case .signalTwoBold: return "\u{fa83}"
        case .signalTwoLight: return "\u{fa84}"
        case .signalTwoRegular: return "\u{fa85}"
        case .signalZeroBold: return "\u{fa86}"
        case .signalZeroLight: return "\u{fa87}"
        case .signalZeroRegular: return "\u{fa88}"
        case .simplePromotionBold: return "\u{fa89}"
        case .simplePromotionLight: return "\u{fa8a}"
        case .simplePromotionRegular: return "\u{fa8b}"
        case .singleNumberReachBold: return "\u{fa8c}"
        case .singleNumberReachLight: return "\u{fa8d}"
        case .singleNumberReachRegular: return "\u{fa8e}"
        case .sipRegistrationInProgressBold: return "\u{fa8f}"
        case .sipRegistrationInProgressFilled: return "\u{fa90}"
        case .sipRegistrationInProgressLight: return "\u{fa91}"
        case .sipRegistrationInProgressRegular: return "\u{fa92}"
        case .skipBold: return "\u{fa93}"
        case .skipBwBold: return "\u{fa94}"
        case .skipBwFilled: return "\u{fa95}"
        case .skipBwLight: return "\u{fa96}"
        case .skipBwRegular: return "\u{fa97}"
        case .skipFwBold: return "\u{fa98}"
        case .skipFwFilled: return "\u{fa99}"
        case .skipFwLight: return "\u{fa9a}"
        case .skipFwRegular: return "\u{fa9b}"
        case .skipLight: return "\u{fa9c}"
        case .skipRegular: return "\u{fa9d}"
        case .smartAudioBold: return "\u{fa9e}"
        case .smartAudioLight: return "\u{fa9f}"
        case .smartAudioRegular: return "\u{faa0}"
        case .smsFilled: return "\u{faa1}"
        case .smsInboundBold: return "\u{faa2}"
        case .smsInboundLight: return "\u{faa3}"
        case .smsInboundRegular: return "\u{faa4}"
        case .smsMessageBold: return "\u{faa5}"
        case .smsMessageFilled: return "\u{faa6}"
        case .smsMessageLight: return "\u{faa7}"
        case .smsMessageRegular: return "\u{faa8}"
        case .smsOutgoingFilled: return "\u{faa9}"
        case .smsUnreadBold: return "\u{faaa}"
        case .smsUnreadLight: return "\u{faab}"
        case .smsUnreadRegular: return "\u{faac}"
        case .sortAscendingBold: return "\u{faad}"
        case .sortAscendingLight: return "\u{faae}"
        case .sortAscendingRegular: return "\u{faaf}"
        case .sortDescendingBold: return "\u{fab0}"
        case .sortDescendingLight: return "\u{fab1}"
        case .sortDescendingRegular: return "\u{fab2}"
        case .soundDefaultBold: return "\u{fab3}"
        case .soundDefaultLight: return "\u{fab4}"
        case .soundDefaultRegular: return "\u{fab5}"
        case .sparkleBold: return "\u{fab6}"
        case .sparkleFilled: return "\u{fab7}"
        case .sparkleLight: return "\u{fab8}"
        case .sparkleRegular: return "\u{fab9}"
        case .speakerBold: return "\u{faba}"
        case .speakerDisconnectedBold: return "\u{fabb}"
        case .speakerDisconnectedFilled: return "\u{fabc}"
        case .speakerDisconnectedLight: return "\u{fabd}"
        case .speakerDisconnectedRegular: return "\u{fabe}"
        case .speakerFilled: return "\u{fabf}"
        case .speakerLight: return "\u{fac0}"
        case .speakerMutedBold: return "\u{fac1}"
        case .speakerMutedFilled: return "\u{fac2}"
        case .speakerMutedLight: return "\u{fac3}"
        case .speakerMutedRegular: return "\u{fac4}"
        case .speakerOffBold: return "\u{fac5}"
        case .speakerOffFilled: return "\u{fac6}"
        case .speakerOffLight: return "\u{fac7}"
        case .speakerOffRegular: return "\u{fac8}"
        case .speakerOnBold: return "\u{fac9}"
        case .speakerOnLight: return "\u{faca}"
        case .speakerOnRegular: return "\u{facb}"
        case .speakerRegular: return "\u{facc}"
        case .speakerTurnDownBold: return "\u{facd}"
        case .speakerTurnDownFilled: return "\u{face}"
        case .speakerTurnDownLight: return "\u{facf}"
        case .speakerTurnDownRegular: return "\u{fad0}"
        case .speakerTurnUpBold: return "\u{fad1}"
        case .speakerTurnUpFilled: return "\u{fad2}"
        case .speakerTurnUpLight: return "\u{fad3}"
        case .speakerTurnUpRegular: return "\u{fad4}"
        case .speedDialBold: return "\u{fad5}"
        case .speedDialFilled: return "\u{fad6}"
        case .speedDialLight: return "\u{fad7}"
        case .speedDialRegular: return "\u{fad8}"
        case .spellCheckerBold: return "\u{fad9}"
        case .spellCheckerLight: return "\u{fada}"
        case .spellCheckerRegular: return "\u{fadb}"
        case .splitViewBold: return "\u{fadc}"
        case .splitViewLight: return "\u{fadd}"
        case .splitViewRegular: return "\u{fade}"
        case .stackedAreaChartBold: return "\u{fadf}"
        case .stackedAreaChartFilled: return "\u{fae0}"
        case .stackedAreaChartFullBold: return "\u{fae1}"
        case .stackedAreaChartFullFilled: return "\u{fae2}"
        case .stackedAreaChartFullLight: return "\u{fae3}"
        case .stackedAreaChartFullRegular: return "\u{fae4}"
        case .stackedAreaChartLight: return "\u{fae5}"
        case .stackedAreaChartRegular: return "\u{fae6}"
        case .stackedBarChartBold: return "\u{fae7}"
        case .stackedBarChartFilled: return "\u{fae8}"
        case .stackedBarChartFullBold: return "\u{fae9}"
        case .stackedBarChartFullFilled: return "\u{faea}"
        case .stackedBarChartFullLight: return "\u{faeb}"
        case .stackedBarChartFullRegular: return "\u{faec}"
        case .stackedBarChartLight: return "\u{faed}"
        case .stackedBarChartRegular: return "\u{faee}"
        case .startChatBold: return "\u{faef}"
        case .startChatLight: return "\u{faf0}"
        case .startChatRegular: return "\u{faf1}"
        case .stethoscopeBold: return "\u{faf2}"
        case .stethoscopeLight: return "\u{faf3}"
        case .stethoscopeRegular: return "\u{faf4}"
        case .stickersBold: return "\u{faf5}"
        case .stickersLight: return "\u{faf6}"
        case .stickersRegular: return "\u{faf7}"
        case .stickiesBold: return "\u{faf8}"
        case .stickiesLight: return "\u{faf9}"
        case .stickiesRegular: return "\u{fafa}"
        case .stopBold: return "\u{fafb}"
        case .stopCircleBold: return "\u{fafc}"
        case .stopCircleFilled: return "\u{fafd}"
        case .stopCircleLight: return "\u{fafe}"
        case .stopCircleRegular: return "\u{faff}"
        case .stopContentShareBold: return "\u{fb00}"
        case .stopContentShareLight: return "\u{fb01}"
        case .stopContentShareRegular: return "\u{fb02}"
        case .stopFilled: return "\u{fb03}"
        case .stopLight: return "\u{fb04}"
        case .stopRegular: return "\u{fb05}"
        case .storedInfoBold: return "\u{fb06}"
        case .storedInfoFilled: return "\u{fb07}"
        case .storedInfoLight: return "\u{fb08}"
        case .storedInfoRegular: return "\u{fb09}"
        case .streamingBold: return "\u{fb0a}"
        case .streamingLight: return "\u{fb0b}"
        case .streamingRegular: return "\u{fb0c}"
        case .strikethroughBold: return "\u{fb0d}"
        case .strikethroughFilled: return "\u{fb0e}"
        case .strikethroughLight: return "\u{fb0f}"
        case .strikethroughRegular: return "\u{fb10}"
        case .studioModeBold: return "\u{fb11}"
        case .studioModeLight: return "\u{fb12}"
        case .studioModeRegular: return "\u{fb13}"
        case .subscriptBold: return "\u{fb14}"
        case .subscriptLight: return "\u{fb15}"
        case .subscriptRegular: return "\u{fb16}"
        case .summarizeAiBold: return "\u{fb17}"
        case .summarizeAiLight: return "\u{fb18}"
        case .summarizeAiRegular: return "\u{fb19}"
        case .superscriptBold: return "\u{fb1a}"
        case .superscriptLight: return "\u{fb1b}"
        case .superscriptRegular: return "\u{fb1c}"
        case .surveyBold: return "\u{fb1d}"
        case .surveyFilled: return "\u{fb1e}"
        case .surveyLight: return "\u{fb1f}"
        case .surveyRegular: return "\u{fb20}"
        case .sxEightyCodecBold: return "\u{fb21}"
        case .sxEightyCodecLight: return "\u{fb22}"
        case .sxEightyCodecRegular: return "\u{fb23}"
        case .sxTenBold: return "\u{fb24}"
        case .sxTenLight: return "\u{fb25}"
        case .sxTenRegular: return "\u{fb26}"
        case .sxTwentyBold: return "\u{fb27}"
        case .sxTwentyLight: return "\u{fb28}"
        case .sxTwentyRegular: return "\u{fb29}"
        case .tableBold: return "\u{fb2a}"
        case .tableLight: return "\u{fb2b}"
        case .tableRegular: return "\u{fb2c}"
        case .tabletBold: return "\u{fb2d}"
        case .tabletLight: return "\u{fb2e}"
        case .tabletRegular: return "\u{fb2f}"
        case .tabsBold: return "\u{fb30}"
        case .tabsLight: return "\u{fb31}"
        case .tabsRegular: return "\u{fb32}"
        case .tagBold: return "\u{fb33}"
        case .tagLight: return "\u{fb34}"
        case .tagRegular: return "\u{fb35}"
        case .tapBold: return "\u{fb36}"
        case .tapFilled: return "\u{fb37}"
        case .tapLight: return "\u{fb38}"
        case .tapRegular: return "\u{fb39}"
        case .telepresenceAlertBold: return "\u{fb3a}"
        case .telepresenceAlertLight: return "\u{fb3b}"
        case .telepresenceAlertMutedBold: return "\u{fb3c}"
        case .telepresenceAlertMutedLight: return "\u{fb3d}"
        case .telepresenceAlertMutedRegular: return "\u{fb3e}"
        case .telepresenceAlertRegular: return "\u{fb3f}"
        case .telepresenceBold: return "\u{fb40}"
        case .telepresenceIxFiveThousandBold: return "\u{fb41}"
        case .telepresenceIxFiveThousandLight: return "\u{fb42}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb43}"
        case .telepresenceLight: return "\u{fb44}"
        case .telepresenceMutedBold: return "\u{fb45}"
        case .telepresenceMutedLight: return "\u{fb46}"
        case .telepresenceMutedRegular: return "\u{fb47}"
        case .telepresencePrivateBold: return "\u{fb48}"
        case .telepresencePrivateLight: return "\u{fb49}"
        case .telepresencePrivateRegular: return "\u{fb4a}"
        case .telepresenceRegular: return "\u{fb4b}"
        case .temperatureBold: return "\u{fb4c}"
        case .temperatureLight: return "\u{fb4d}"
        case .temperatureRegular: return "\u{fb4e}"
        case .testTubeBold: return "\u{fb4f}"
        case .testTubeFilled: return "\u{fb50}"
        case .testTubeLight: return "\u{fb51}"
        case .testTubeRegular: return "\u{fb52}"
        case .textAlignCenterBold: return "\u{fb53}"
        case .textAlignCenterFilled: return "\u{fb54}"
        case .textAlignCenterLight: return "\u{fb55}"
        case .textAlignCenterRegular: return "\u{fb56}"
        case .textAlignLeftBold: return "\u{fb57}"
        case .textAlignLeftFilled: return "\u{fb58}"
        case .textAlignLeftLight: return "\u{fb59}"
        case .textAlignLeftRegular: return "\u{fb5a}"
        case .textAlignRightBold: return "\u{fb5b}"
        case .textAlignRightFilled: return "\u{fb5c}"
        case .textAlignRightLight: return "\u{fb5d}"
        case .textAlignRightRegular: return "\u{fb5e}"
        case .textBold: return "\u{fb5f}"
        case .textBoxCursorLight: return "\u{fb60}"
        case .textCodeBlockBold: return "\u{fb61}"
        case .textCodeBlockLight: return "\u{fb62}"
        case .textCodeBlockRegular: return "\u{fb63}"
        case .textHighlightBold: return "\u{fb64}"
        case .textHighlightFilled: return "\u{fb65}"
        case .textHighlightLight: return "\u{fb66}"
        case .textHighlightRegular: return "\u{fb67}"
        case .textLight: return "\u{fb68}"
        case .textRegular: return "\u{fb69}"
        case .threeColumnBold: return "\u{fb6a}"
        case .threeColumnLight: return "\u{fb6b}"
        case .threeColumnRegular: return "\u{fb6c}"
        case .threeDObjectBold: return "\u{fb6d}"
        case .threeDObjectLight: return "\u{fb6e}"
        case .threeDObjectRegular: return "\u{fb6f}"
        case .timeExclusionBold: return "\u{fb70}"
        case .timeExclusionLight: return "\u{fb71}"
        case .timeExclusionRegular: return "\u{fb72}"
        case .tooFastBold: return "\u{fb73}"
        case .tooFastLight: return "\u{fb74}"
        case .tooFastRegular: return "\u{fb75}"
        case .tooSlowBold: return "\u{fb76}"
        case .tooSlowLight: return "\u{fb77}"
        case .tooSlowRegular: return "\u{fb78}"
        case .toolsBold: return "\u{fb79}"
        case .toolsFilled: return "\u{fb7a}"
        case .toolsLight: return "\u{fb7b}"
        case .toolsRegular: return "\u{fb7c}"
        case .touchTenBold: return "\u{fb7d}"
        case .touchTenLight: return "\u{fb7e}"
        case .touchTenRegular: return "\u{fb7f}"
        case .transcriptBold: return "\u{fb80}"
        case .transcriptFilled: return "\u{fb81}"
        case .transcriptLight: return "\u{fb82}"
        case .transcriptRegular: return "\u{fb83}"
        case .translateBold: return "\u{fb84}"
        case .translateLight: return "\u{fb85}"
        case .translateRegular: return "\u{fb86}"
        case .translateUndoBold: return "\u{fb87}"
        case .translateUndoLight: return "\u{fb88}"
        case .translateUndoRegular: return "\u{fb89}"
        case .trendingBold: return "\u{fb8a}"
        case .trendingDownBold: return "\u{fb8b}"
        case .trendingDownFilled: return "\u{fb8c}"
        case .trendingDownLight: return "\u{fb8d}"
        case .trendingDownRegular: return "\u{fb8e}"
        case .trendingFilled: return "\u{fb8f}"
        case .trendingLight: return "\u{fb90}"
        case .trendingRegular: return "\u{fb91}"
        case .trimBold: return "\u{fb92}"
        case .trimLight: return "\u{fb93}"
        case .trimRegular: return "\u{fb94}"
        case .twoColumnBold: return "\u{fb95}"
        case .twoColumnLight: return "\u{fb96}"
        case .twoColumnRegular: return "\u{fb97}"
        case .twoWayVoiceStreamBold: return "\u{fb98}"
        case .twoWayVoiceStreamFilled: return "\u{fb99}"
        case .twoWayVoiceStreamLight: return "\u{fb9a}"
        case .twoWayVoiceStreamRegular: return "\u{fb9b}"
        case .ucmCloudBold: return "\u{fb9c}"
        case .ucmCloudLight: return "\u{fb9d}"
        case .ucmCloudRegular: return "\u{fb9e}"
        case .unblockBold: return "\u{fb9f}"
        case .unblockFilled: return "\u{fba0}"
        case .unblockLight: return "\u{fba1}"
        case .unblockRegular: return "\u{fba2}"
        case .underlineBold: return "\u{fba3}"
        case .underlineFilled: return "\u{fba4}"
        case .underlineLight: return "\u{fba5}"
        case .underlineRegular: return "\u{fba6}"
        case .undoBold: return "\u{fba7}"
        case .undoLight: return "\u{fba8}"
        case .undoRegular: return "\u{fba9}"
        case .unlinkBold: return "\u{fbaa}"
        case .unlinkLight: return "\u{fbab}"
        case .unlinkRegular: return "\u{fbac}"
        case .unreadBold: return "\u{fbad}"
        case .unreadFilled: return "\u{fbae}"
        case .unreadLight: return "\u{fbaf}"
        case .unreadRegular: return "\u{fbb0}"
        case .unsecureUnlockedBold: return "\u{fbb1}"
        case .unsecureUnlockedFilled: return "\u{fbb2}"
        case .unsecureUnlockedLight: return "\u{fbb3}"
        case .unsecureUnlockedRegular: return "\u{fbb4}"
        case .unsortedBold: return "\u{fbb5}"
        case .unsortedLight: return "\u{fbb6}"
        case .unsortedRegular: return "\u{fbb7}"
        case .updateFileShareBold: return "\u{fbb8}"
        case .updateFileShareLight: return "\u{fbb9}"
        case .updateFileShareRegular: return "\u{fbba}"
        case .uploadBold: return "\u{fbbb}"
        case .uploadImageBold: return "\u{fbbc}"
        case .uploadImageLight: return "\u{fbbd}"
        case .uploadImageRegular: return "\u{fbbe}"
        case .uploadLight: return "\u{fbbf}"
        case .uploadRegular: return "\u{fbc0}"
        case .urgentVoicemailBold: return "\u{fbc1}"
        case .urgentVoicemailFilled: return "\u{fbc2}"
        case .usbBold: return "\u{fbc3}"
        case .usbHeadsetBold: return "\u{fbc4}"
        case .usbHeadsetLight: return "\u{fbc5}"
        case .usbHeadsetMutedBold: return "\u{fbc6}"
        case .usbHeadsetMutedLight: return "\u{fbc7}"
        case .usbHeadsetMutedRegular: return "\u{fbc8}"
        case .usbHeadsetRegular: return "\u{fbc9}"
        case .usbLight: return "\u{fbca}"
        case .usbRegular: return "\u{fbcb}"
        case .userBold: return "\u{fbcc}"
        case .userDeactivateBold: return "\u{fbcd}"
        case .userDeactivateLight: return "\u{fbce}"
        case .userDeactivateRegular: return "\u{fbcf}"
        case .userLight: return "\u{fbd0}"
        case .userRegular: return "\u{fbd1}"
        case .videoBlurBold: return "\u{fbd2}"
        case .videoBlurFilled: return "\u{fbd3}"
        case .videoBlurLight: return "\u{fbd4}"
        case .videoBlurRegular: return "\u{fbd5}"
        case .videoBold: return "\u{fbd6}"
        case .videoEffectBold: return "\u{fbd7}"
        case .videoEffectFilled: return "\u{fbd8}"
        case .videoEffectLight: return "\u{fbd9}"
        case .videoEffectRegular: return "\u{fbda}"
        case .videoFilled: return "\u{fbdb}"
        case .videoLayoutBold: return "\u{fbdc}"
        case .videoLayoutEqualBold: return "\u{fbdd}"
        case .videoLayoutEqualDualBold: return "\u{fbde}"
        case .videoLayoutEqualDualLight: return "\u{fbdf}"
        case .videoLayoutEqualDualRegular: return "\u{fbe0}"
        case .videoLayoutEqualFilled: return "\u{fbe1}"
        case .videoLayoutEqualLight: return "\u{fbe2}"
        case .videoLayoutEqualRegular: return "\u{fbe3}"
        case .videoLayoutFilled: return "\u{fbe4}"
        case .videoLayoutLight: return "\u{fbe5}"
        case .videoLayoutOverlayBold: return "\u{fbe6}"
        case .videoLayoutOverlayFilled: return "\u{fbe7}"
        case .videoLayoutOverlayLight: return "\u{fbe8}"
        case .videoLayoutOverlayRegular: return "\u{fbe9}"
        case .videoLayoutPresenterDominantBold: return "\u{fbea}"
        case .videoLayoutPresenterDominantLight: return "\u{fbeb}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbec}"
        case .videoLayoutProminentBold: return "\u{fbed}"
        case .videoLayoutProminentFilled: return "\u{fbee}"
        case .videoLayoutProminentLight: return "\u{fbef}"
        case .videoLayoutProminentRegular: return "\u{fbf0}"
        case .videoLayoutRegular: return "\u{fbf1}"
        case .videoLayoutShareDominantBold: return "\u{fbf2}"
        case .videoLayoutShareDominantLight: return "\u{fbf3}"
        case .videoLayoutShareDominantRegular: return "\u{fbf4}"
        case .videoLayoutSingleBold: return "\u{fbf5}"
        case .videoLayoutSingleFilled: return "\u{fbf6}"
        case .videoLayoutSingleLight: return "\u{fbf7}"
        case .videoLayoutSingleRegular: return "\u{fbf8}"
        case .videoLayoutStackBold: return "\u{fbf9}"
        case .videoLayoutStackFilled: return "\u{fbfa}"
        case .videoLayoutStackLight: return "\u{fbfb}"
        case .videoLayoutStackRegular: return "\u{fbfc}"
        case .videoLayoutVideoDominantBold: return "\u{fbfd}"
        case .videoLayoutVideoDominantFilled: return "\u{fbfe}"
        case .videoLayoutVideoDominantLight: return "\u{fbff}"
        case .videoLayoutVideoDominantRegular: return "\u{fc00}"
        case .videoLight: return "\u{fc01}"
        case .videoPlusBold: return "\u{fc02}"
        case .videoPlusFilled: return "\u{fc03}"
        case .videoPlusLight: return "\u{fc04}"
        case .videoPlusRegular: return "\u{fc05}"
        case .videoRegular: return "\u{fc06}"
        case .videoSpeakerTrackBold: return "\u{fc07}"
        case .videoSpeakerTrackFilled: return "\u{fc08}"
        case .videoSpeakerTrackLight: return "\u{fc09}"
        case .videoSpeakerTrackRegular: return "\u{fc0a}"
        case .viewAllBold: return "\u{fc0b}"
        case .viewAllLight: return "\u{fc0c}"
        case .viewAllRegular: return "\u{fc0d}"
        case .viewListBold: return "\u{fc0e}"
        case .viewListFilled: return "\u{fc0f}"
        case .viewListLight: return "\u{fc10}"
        case .viewListRegular: return "\u{fc11}"
        case .viewStackedBold: return "\u{fc12}"
        case .viewStackedFilled: return "\u{fc13}"
        case .viewStackedLight: return "\u{fc14}"
        case .viewStackedRegular: return "\u{fc15}"
        case .viewThumbnailBold: return "\u{fc16}"
        case .viewThumbnailFilled: return "\u{fc17}"
        case .viewThumbnailLight: return "\u{fc18}"
        case .viewThumbnailRegular: return "\u{fc19}"
        case .visionproBold: return "\u{fc1a}"
        case .visionproFilled: return "\u{fc1b}"
        case .visionproLight: return "\u{fc1c}"
        case .visionproMoveCallInBold: return "\u{fc1d}"
        case .visionproMoveCallInFilled: return "\u{fc1e}"
        case .visionproMoveCallInLight: return "\u{fc1f}"
        case .visionproMoveCallInOutBold: return "\u{fc20}"
        case .visionproMoveCallInOutFilled: return "\u{fc21}"
        case .visionproMoveCallInOutLight: return "\u{fc22}"
        case .visionproMoveCallInOutRegular: return "\u{fc23}"
        case .visionproMoveCallInRegular: return "\u{fc24}"
        case .visionproMoveCallOutBold: return "\u{fc25}"
        case .visionproMoveCallOutFilled: return "\u{fc26}"
        case .visionproMoveCallOutLight: return "\u{fc27}"
        case .visionproMoveCallOutRegular: return "\u{fc28}"
        case .visionproRegular: return "\u{fc29}"
        case .voicemailBold: return "\u{fc2a}"
        case .voicemailFilled: return "\u{fc2b}"
        case .voicemailLight: return "\u{fc2c}"
        case .voicemailRegular: return "\u{fc2d}"
        case .vpnBold: return "\u{fc2e}"
        case .vpnFilled: return "\u{fc2f}"
        case .vpnLight: return "\u{fc30}"
        case .vpnRegular: return "\u{fc31}"
        case .vscBold: return "\u{fc32}"
        case .vscLight: return "\u{fc33}"
        case .vscRegular: return "\u{fc34}"
        case .waffleMenuBold: return "\u{fc35}"
        case .waffleMenuLight: return "\u{fc36}"
        case .waffleMenuRegular: return "\u{fc37}"
        case .waitingRoomBold: return "\u{fc38}"
        case .waitingRoomLight: return "\u{fc39}"
        case .waitingRoomRegular: return "\u{fc3a}"
        case .wallpaperBold: return "\u{fc3b}"
        case .wallpaperLight: return "\u{fc3c}"
        case .wallpaperRegular: return "\u{fc3d}"
        case .warningBadgeFilled: return "\u{fc3e}"
        case .warningBold: return "\u{fc3f}"
        case .warningFilled: return "\u{fc40}"
        case .warningLight: return "\u{fc41}"
        case .warningRegular: return "\u{fc42}"
        case .webexBoardBold: return "\u{fc43}"
        case .webexBoardLight: return "\u{fc44}"
        case .webexBoardRegular: return "\u{fc45}"
        case .webexCodecPlusBold: return "\u{fc46}"
        case .webexCodecPlusLight: return "\u{fc47}"
        case .webexCodecPlusRegular: return "\u{fc48}"
        case .webexDeskCameraBold: return "\u{fc49}"
        case .webexDeskCameraLight: return "\u{fc4a}"
        case .webexDeskCameraRegular: return "\u{fc4b}"
        case .webexHelixBold: return "\u{fc4c}"
        case .webexHelixLight: return "\u{fc4d}"
        case .webexHelixRegular: return "\u{fc4e}"
        case .webexMeetingsBold: return "\u{fc4f}"
        case .webexMeetingsFilled: return "\u{fc50}"
        case .webexMeetingsLight: return "\u{fc51}"
        case .webexMeetingsRegular: return "\u{fc52}"
        case .webexQuadCameraBold: return "\u{fc53}"
        case .webexQuadCameraLight: return "\u{fc54}"
        case .webexQuadCameraRegular: return "\u{fc55}"
        case .webexRoomKitBold: return "\u{fc56}"
        case .webexRoomKitLight: return "\u{fc57}"
        case .webexRoomKitPlusBold: return "\u{fc58}"
        case .webexRoomKitPlusLight: return "\u{fc59}"
        case .webexRoomKitPlusRegular: return "\u{fc5a}"
        case .webexRoomKitRegular: return "\u{fc5b}"
        case .webexShareBold: return "\u{fc5c}"
        case .webexShareLight: return "\u{fc5d}"
        case .webexShareRegular: return "\u{fc5e}"
        case .webexTeamsBold: return "\u{fc5f}"
        case .webexTeamsFilled: return "\u{fc60}"
        case .webexTeamsLight: return "\u{fc61}"
        case .webexTeamsNewBold: return "\u{fc62}"
        case .webexTeamsNewFilled: return "\u{fc63}"
        case .webexTeamsNewLight: return "\u{fc64}"
        case .webexTeamsNewRegular: return "\u{fc65}"
        case .webexTeamsRegular: return "\u{fc66}"
        case .webexTeamsRemoveBold: return "\u{fc67}"
        case .webexTeamsRemoveLight: return "\u{fc68}"
        case .webexTeamsRemoveRegular: return "\u{fc69}"
        case .webhookBold: return "\u{fc6a}"
        case .webhookLight: return "\u{fc6b}"
        case .webhookRegular: return "\u{fc6c}"
        case .webinarBold: return "\u{fc6d}"
        case .webinarFilled: return "\u{fc6e}"
        case .webinarLight: return "\u{fc6f}"
        case .webinarRegular: return "\u{fc70}"
        case .weeklyRecurringScheduleBold: return "\u{fc71}"
        case .weeklyRecurringScheduleLight: return "\u{fc72}"
        case .weeklyRecurringScheduleRegular: return "\u{fc73}"
        case .whisperAnnouncementBold: return "\u{fc74}"
        case .whisperAnnouncementFilled: return "\u{fc75}"
        case .whisperAnnouncementLight: return "\u{fc76}"
        case .whisperAnnouncementRegular: return "\u{fc77}"
        case .whisperCoachBold: return "\u{fc78}"
        case .whisperCoachFilled: return "\u{fc79}"
        case .whisperCoachLight: return "\u{fc7a}"
        case .whisperCoachRegular: return "\u{fc7b}"
        case .whiteboardBold: return "\u{fc7c}"
        case .whiteboardContentBold: return "\u{fc7d}"
        case .whiteboardContentFilled: return "\u{fc7e}"
        case .whiteboardContentLight: return "\u{fc7f}"
        case .whiteboardContentRegular: return "\u{fc80}"
        case .whiteboardFilled: return "\u{fc81}"
        case .whiteboardLight: return "\u{fc82}"
        case .whiteboardRegular: return "\u{fc83}"
        case .widgetBold: return "\u{fc84}"
        case .widgetFilled: return "\u{fc85}"
        case .widgetLight: return "\u{fc86}"
        case .widgetRegular: return "\u{fc87}"
        case .wifiBold: return "\u{fc88}"
        case .wifiErrorBold: return "\u{fc89}"
        case .wifiErrorLight: return "\u{fc8a}"
        case .wifiErrorRegular: return "\u{fc8b}"
        case .wifiLight: return "\u{fc8c}"
        case .wifiRegular: return "\u{fc8d}"
        case .wifiSignalGoodBold: return "\u{fc8e}"
        case .wifiSignalGoodLight: return "\u{fc8f}"
        case .wifiSignalGoodRegular: return "\u{fc90}"
        case .wifiSignalPoorBold: return "\u{fc91}"
        case .wifiSignalPoorLight: return "\u{fc92}"
        case .wifiSignalPoorRegular: return "\u{fc93}"
        case .wifiSignalUnstableBold: return "\u{fc94}"
        case .wifiSignalUnstableLight: return "\u{fc95}"
        case .wifiSignalUnstableRegular: return "\u{fc96}"
        case .windowCornerScrubBold: return "\u{fc97}"
        case .windowCornerScrubLight: return "\u{fc98}"
        case .windowCornerScrubRegular: return "\u{fc99}"
        case .windowRightCornerScrubBold: return "\u{fc9a}"
        case .windowRightCornerScrubLight: return "\u{fc9b}"
        case .windowRightCornerScrubRegular: return "\u{fc9c}"
        case .windowVerticalScrubBold: return "\u{fc9d}"
        case .windowVerticalScrubLight: return "\u{fc9e}"
        case .windowVerticalScrubRegular: return "\u{fc9f}"
        case .workflowDeploymentsBold: return "\u{fca0}"
        case .workflowDeploymentsFilled: return "\u{fca1}"
        case .workflowDeploymentsLight: return "\u{fca2}"
        case .workflowDeploymentsRegular: return "\u{fca3}"
        case .workphoneBold: return "\u{fca4}"
        case .workphoneLight: return "\u{fca5}"
        case .workphoneRegular: return "\u{fca6}"
        case .zoomInBold: return "\u{fca7}"
        case .zoomInLight: return "\u{fca8}"
        case .zoomInRegular: return "\u{fca9}"
        case .zoomOutBold: return "\u{fcaa}"
        case .zoomOutLight: return "\u{fcab}"
        case .zoomOutRegular: return "\u{fcac}"
