...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .markdownLight: return "\u{f705}"
        case .markdownRegular: return "\u{f706}"
        case .markerBold: return "\u{f707}"
        case .markerFilled: return "\u{f708}"
        case .markerLight: return "\u{f709}"
        case .markerRegular: return "\u{f70a}"
        case .maximizeBold: return "\u{f70b}"
        case .maximizeLight: return "\u{f70c}"
        case .maximizeRegular: return "\u{f70d}"
        case .mediaPlayerBold: return "\u{f70e}"
        case .mediaPlayerLight: return "\u{f70f}"
        case .mediaPlayerRegular: return "\u{f710}"
        case .mediaQualityGoodBold: return "\u{f711}"
        case .mediaQualityGoodFilled: return "\u{f712}"
        case .mediaQualityGoodLight: return "\u{f713}"
        case .mediaQualityGoodRegular: return "\u{f714}"
        case .mediaQualityPoorBold: return "\u{f715}"
        case .mediaQualityPoorFilled: return "\u{f716}"
        case .mediaQualityPoorLight: return "\u{f717}"
        case .mediaQualityPoorRegular: return "\u{f718}"
        case .mediaQualityUnstableBold: return "\u{f719}"
        case .mediaQualityUnstableFilled: return "\u{f71a}"
        case .mediaQualityUnstableLight: return "\u{f71b}"
        case .mediaQualityUnstableRegular: return "\u{f71c}"
        case .meetBold: return "\u{f71d}"
        case .meetEndBold: return "\u{f71e}"
        case .meetEndLight: return "\u{f71f}"
        case .meetEndRegular: return "\u{f720}"
        case .meetFilled: return "\u{f721}"
        case .meetLight: return "\u{f722}"
        case .meetRegular: return "\u{f723}"
        case .meetingSummaryBold: return "\u{f724}"
        case .meetingSummaryFilled: return "\u{f725}"
        case .meetingSummaryLight: return "\u{f726}"
        case .meetingSummaryRegular: return "\u{f727}"
        case .meetingsBold: return "\u{f728}"
        case .meetingsFilled: return "\u{f729}"
        case .meetingsFocusMonthBold: return "\u{f72a}"
        case .meetingsFocusMonthLight: return "\u{f72b}"
        case .meetingsFocusMonthRegular: return "\u{f72c}"
        case .meetingsFocusOneDayBold: return "\u{f72d}"
        case .meetingsFocusOneDayLight: return "\u{f72e}"
        case .meetingsFocusOneDayRegular: return "\u{f72f}"
        case .meetingsFocusThreeDayBold: return "\u{f730}"
        case .meetingsFocusThreeDayLight: return "\u{f731}"
        case .meetingsFocusThreeDayRegular: return "\u{f732}"
        case .meetingsFocusUpcomingBold: return "\u{f733}"
        case .meetingsFocusUpcomingLight: return "\u{f734}"
        case .meetingsFocusUpcomingRegular: return "\u{f735}"
        case .meetingsLight: return "\u{f736}"
        case .meetingsPresenceBadgeFilled: return "\u{f737}"
        case .meetingsPresenceBold: return "\u{f738}"
        case .meetingsPresenceFilled: return "\u{f739}"
        case .meetingsPresenceLight: return "\u{f73a}"
        case .meetingsPresenceRegular: return "\u{f73b}"
        case .meetingsRegular: return "\u{f73c}"
        case .meetingsTeamBold: return "\u{f73d}"
        case .meetingsTeamFilled: return "\u{f73e}"
        case .meetingsTeamLight: return "\u{f73f}"
        case .meetingsTeamNewBold: return "\u{f740}"
        case .meetingsTeamNewLight: return "\u{f741}"
        case .meetingsTeamNewRegular: return "\u{f742}"
        case .meetingsTeamRegular: return "\u{f743}"
        case .mentionBold: return "\u{f744}"
        case .mentionLight: return "\u{f745}"
        case .mentionRegular: return "\u{f746}"
        case .messageQueingBold: return "\u{f747}"
        case .messageQueingLight: return "\u{f748}"
        case .messageQueingRegular: return "\u{f749}"
        case .microphoneBold: return "\u{f74a}"
        case .microphoneFilled: return "\u{f74b}"
        case .microphoneHardMutedBold: return "\u{f74c}"
        case .microphoneHardMutedCircleFilled: return "\u{f74d}"
        case .microphoneHardMutedLight: return "\u{f74e}"
        case .microphoneHardMutedRegular: return "\u{f74f}"
        case .microphoneLight: return "\u{f750}"
        case .microphoneMusicModeBold: return "\u{f751}"
        case .microphoneMusicModeLight: return "\u{f752}"
        case .microphoneMusicModeOnBold: return "\u{f753}"
        case .microphoneMusicModeOnLight: return "\u{f754}"
        case .microphoneMusicModeOnRegular: return "\u{f755}"
        case .microphoneMusicModeRegular: return "\u{f756}"
        case .microphoneMutedBold: return "\u{f757}"
        case .microphoneMutedCircleFilled: return "\u{f758}"
        case .microphoneMutedFilled: return "\u{f759}"
        case .microphoneMutedLight: return "\u{f75a}"
        case .microphoneMutedRegular: return "\u{f75b}"
        case .microphoneOnBold: return "\u{f75c}"
        case .microphoneOnLight: return "\u{f75d}"
        case .microphoneOnRegular: return "\u{f75e}"
        case .microphoneOptAllBold: return "\u{f75f}"
        case .microphoneOptAllLight: return "\u{f760}"
        case .microphoneOptAllMutedBold: return "\u{f761}"
        case .microphoneOptAllMutedLight: return "\u{f762}"
        case .microphoneOptAllMutedRegular: return "\u{f763}"
        case .microphoneOptAllOnBold: return "\u{f764}"
        case .microphoneOptAllOnLight: return "\u{f765}"
        case .microphoneOptAllOnRegular: return "\u{f766}"
        case .microphoneOptAllRegular: return "\u{f767}"
        case .microphoneOptMeBold: return "\u{f768}"
        case .microphoneOptMeLight: return "\u{f769}"
        case .microphoneOptMeMutedBold: return "\u{f76a}"
        case .microphoneOptMeMutedLight: return "\u{f76b}"
        case .microphoneOptMeMutedRegular: return "\u{f76c}"
        case .microphoneOptMeOnBold: return "\u{f76d}"
        case .microphoneOptMeOnLight: return "\u{f76e}"
        case .microphoneOptMeOnRegular: return "\u{f76f}"
        case .microphoneOptMeRegular: return "\u{f770}"
        case .microphoneRegular: return "\u{f771}"
        case .mindMapBold: return "\u{f772}"
        case .mindMapLight: return "\u{f773}"
        case .mindMapRegular: return "\u{f774}"
        case .minimizeBold: return "\u{f775}"
        case .minimizeLight: return "\u{f776}"
        case .minimizeRegular: return "\u{f777}"
        case .minusBold: return "\u{f778}"
        case .minusLight: return "\u{f779}"
        case .minusRegular: return "\u{f77a}"
        case .mirrorBold: return "\u{f77b}"
        case .mirrorFilled: return "\u{f77c}"
        case .mirrorLight: return "\u{f77d}"
        case .mirrorRegular: return "\u{f77e}"
        case .mmsFilled: return "\u{f77f}"
        case .moderatorBold: return "\u{f780}"
        case .moderatorLight: return "\u{f781}"
        case .moderatorRegular: return "\u{f782}"
        case .monitoringBold: return "\u{f783}"
        case .monitoringLight: return "\u{f784}"
        case .monitoringRegular: return "\u{f785}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f786}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f787}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f788}"
        case .moreAdrBold: return "\u{f789}"
        case .moreAdrLight: return "\u{f78a}"
        case .moreAdrRegular: return "\u{f78b}"
        case .moreBold: return "\u{f78c}"
        case .moreCircleBold: return "\u{f78d}"
        case .moreCircleFilled: return "\u{f78e}"
        case .moreCircleLight: return "\u{f78f}"
        case .moreCircleRegular: return "\u{f790}"
        case .moreLight: return "\u{f791}"
        case .moreRegular: return "\u{f792}"
        case .mouseCursorBold: return "\u{f793}"
        case .mouseCursorLight: return "\u{f794}"
        case .mouseCursorRegular: return "\u{f795}"
        case .moveCallInAdrBold: return "\u{f796}"
        case .moveCallInAdrLight: return "\u{f797}"
        case .moveCallInAdrRegular: return "\u{f798}"
        case .moveCallInIphBold: return "\u{f799}"
        case .moveCallInIphLight: return "\u{f79a}"
        case .moveCallInIphRegular: return "\u{f79b}"
        case .moveCallInLaptopBold: return "\u{f79c}"
        case .moveCallInLaptopLight: return "\u{f79d}"
        case .moveCallInLaptopRegular: return "\u{f79e}"
        case .moveCallInOutAdrBold: return "\u{f79f}"
        case .moveCallInOutAdrLight: return "\u{f7a0}"
        case .moveCallInOutAdrRegular: return "\u{f7a1}"
        case .moveCallInOutIphBold: return "\u{f7a2}"
        case .moveCallInOutIphLight: return "\u{f7a3}"
        case .moveCallInOutIphRegular: return "\u{f7a4}"
        case .moveCallInTabletBold: return "\u{f7a5}"
        case .moveCallInTabletLight: return "\u{f7a6}"
        case .moveCallInTabletRegular: return "\u{f7a7}"
        case .moveCallOutAdrBold: return "\u{f7a8}"
        case .moveCallOutAdrLight: return "\u{f7a9}"
        case .moveCallOutAdrRegular: return "\u{f7aa}"
        case .moveCallOutIphBold: return "\u{f7ab}"
        case .moveCallOutIphLight: return "\u{f7ac}"
        case .moveCallOutIphRegular: return "\u{f7ad}"
        case .moveCallOutLaptopBold: return "\u{f7ae}"
        case .moveCallOutLaptopLight: return "\u{f7af}"
        case .moveCallOutLaptopRegular: return "\u{f7b0}"
        case .moveCallOutTabletBold: return "\u{f7b1}"
        case .moveCallOutTabletLight: return "\u{f7b2}"
        case .moveCallOutTabletRegular: return "\u{f7b3}"
        case .moveToScreenBold: return "\u{f7b4}"
        case .moveToScreenLight: return "\u{f7b5}"
        case .moveToScreenRegular: return "\u{f7b6}"
        case .multilineChartBold: return "\u{f7b7}"
        case .multilineChartFilled: return "\u{f7b8}"
        case .multilineChartLight: return "\u{f7b9}"
        case .multilineChartRegular: return "\u{f7ba}"
        case .multimediaBold: return "\u{f7bb}"
        case .multimediaFilled: return "\u{f7bc}"
        case .multimediaLight: return "\u{f7bd}"
        case .multimediaRegular: return "\u{f7be}"
        case .multipledDevicesBold: return "\u{f7bf}"
        case .multipledDevicesLight: return "\u{f7c0}"
        case .multipledDevicesRegular: return "\u{f7c1}"
        case .musicModeCircleBold: return "\u{f7c2}"
        case .musicModeCircleFilled: return "\u{f7c3}"
        case .musicModeCircleLight: return "\u{f7c4}"
        case .musicModeCircleRegular: return "\u{f7c5}"
        case .musicNoteBold: return "\u{f7c6}"
        case .musicNoteFilled: return "\u{f7c7}"
        case .musicNoteLight: return "\u{f7c8}"
        case .musicNoteRegular: return "\u{f7c9}"
        case .muteOnEntryBold: return "\u{f7ca}"
        case .muteOnEntryFilled: return "\u{f7cb}"
        case .muteOnEntryLight: return "\u{f7cc}"
        case .muteOnEntryRegular: return "\u{f7cd}"
        case .newManagerBold: return "\u{f7ce}"
        case .newManagerLight: return "\u{f7cf}"
        case .newManagerRegular: return "\u{f7d0}"
        case .newTitleBold: return "\u{f7d1}"
        case .newTitleLight: return "\u{f7d2}"
        case .newTitleRegular: return "\u{f7d3}"
        case .newVoicemailBold: return "\u{f7d4}"
        case .newVoicemailLight: return "\u{f7d5}"
        case .newVoicemailRegular: return "\u{f7d6}"
        case .newWhiteboardBold: return "\u{f7d7}"
        case .newWhiteboardLight: return "\u{f7d8}"
        case .newWhiteboardRegular: return "\u{f7d9}"
        case .nextBold: return "\u{f7da}"
        case .nextLight: return "\u{f7db}"
        case .nextRegular: return "\u{f7dc}"
        case .noDevicesBold: return "\u{f7dd}"
        case .noDevicesLight: return "\u{f7de}"
        case .noDevicesRegular: return "\u{f7df}"
        case .noiseDetectedCanceledFilled: return "\u{f7e0}"
        case .noiseDetectedFilled: return "\u{f7e1}"
        case .noiseNoneCanceledFilled: return "\u{f7e2}"
        case .noiseNoneFilled: return "\u{f7e3}"
        case .noiseRemovalBold: return "\u{f7e4}"
        case .noiseRemovalLight: return "\u{f7e5}"
        case .noiseRemovalRegular: return "\u{f7e6}"
        case .noteBold: return "\u{f7e7}"
        case .noteLight: return "\u{f7e8}"
        case .notePptBold: return "\u{f7e9}"
        case .notePptLight: return "\u{f7ea}"
        case .notePptRegular: return "\u{f7eb}"
        case .noteRegular: return "\u{f7ec}"
        case .notesBold: return "\u{f7ed}"
        case .notesFilled: return "\u{f7ee}"
        case .notesLight: return "\u{f7ef}"
        case .notesRegular: return "\u{f7f0}"
        case .numberBold: return "\u{f7f1}"
        case .numberLight: return "\u{f7f2}"
        case .numberRegular: return "\u{f7f3}"
        case .oldRemoteBold: return "\u{f7f4}"
        case .oldRemoteLight: return "\u{f7f5}"
        case .oldRemoteRegular: return "\u{f7f6}"
        case .oldTouchBold: return "\u{f7f7}"
        case .oldTouchLight: return "\u{f7f8}"
        case .oldTouchRegular: return "\u{f7f9}"
        case .oneColumnBold: return "\u{f7fa}"
        case .oneColumnLight: return "\u{f7fb}"
        case .oneColumnRegular: return "\u{f7fc}"
        case .oneTimeBold: return "\u{f7fd}"
        case .oneTimeLight: return "\u{f7fe}"
        case .oneTimeRegular: return "\u{f7ff}"
        case .openInFolderBold: return "\u{f800}"
        case .openInFolderLight: return "\u{f801}"
        case .openInFolderRegular: return "\u{f802}"
        case .openPagesBold: return "\u{f803}"
        case .openPagesLight: return "\u{f804}"
        case .openPagesRegular: return "\u{f805}"
        case .otherNumberBold: return "\u{f806}"
        case .otherNumberFilled: return "\u{f807}"
        case .otherNumberLight: return "\u{f808}"
        case .otherNumberRegular: return "\u{f809}"
        case .otherNumberWarningBold: return "\u{f80a}"
        case .otherNumberWarningLight: return "\u{f80b}"
        case .otherNumberWarningRegular: return "\u{f80c}"
        case .outgoingCallLegacyBold: return "\u{f80d}"
        case .outgoingCallLegacyFilled: return "\u{f80e}"
        case .outgoingCallLegacyLight: return "\u{f80f}"
        case .outgoingCallLegacyRegular: return "\u{f810}"
        case .overflowLeftBold: return "\u{f811}"
        case .overflowLeftLight: return "\u{f812}"
        case .overflowLeftRegular: return "\u{f813}"
        case .overflowRightBold: return "\u{f814}"
        case .overflowRightLight: return "\u{f815}"
        case .overflowRightRegular: return "\u{f816}"
        case .pairedCameraBold: return "\u{f817}"
        case .pairedCameraLight: return "\u{f818}"
        case .pairedCameraRegular: return "\u{f819}"
        case .pairedDeviceBold: return "\u{f81a}"
        case .pairedDeviceLight: return "\u{f81b}"
        case .pairedDeviceRegular: return "\u{f81c}"
        case .pairedHandsetBold: return "\u{f81d}"
        case .pairedHandsetLight: return "\u{f81e}"
        case .pairedHandsetRegular: return "\u{f81f}"
        case .pairingBold: return "\u{f820}"
        case .pairingLight: return "\u{f821}"
        case .pairingRegular: return "\u{f822}"
        case .parkedBold: return "\u{f823}"
        case .parkedFilled: return "\u{f824}"
        case .parkedLight: return "\u{f825}"
        case .parkedRegular: return "\u{f826}"
        case .parseBold: return "\u{f827}"
        case .parseLight: return "\u{f828}"
        case .parseRegular: return "\u{f829}"
        case .partialBold: return "\u{f82a}"
        case .partialLight: return "\u{f82b}"
        case .partialRegular: return "\u{f82c}"
        case .participantAddBold: return "\u{f82d}"
        case .participantAddLight: return "\u{f82e}"
        case .participantAddRegular: return "\u{f82f}"
        case .participantBlockedBold: return "\u{f830}"
        case .participantBlockedLight: return "\u{f831}"
        case .participantBlockedRegular: return "\u{f832}"
        case .participantBold: return "\u{f833}"
        case .participantFilled: return "\u{f834}"
        case .participantLight: return "\u{f835}"
        case .participantListBold: return "\u{f836}"
        case .participantListFilled: return "\u{f837}"
        case .participantListLight: return "\u{f838}"
        case .participantListRegular: return "\u{f839}"
        case .participantRegular: return "\u{f83a}"
        case .participantRemoveBold: return "\u{f83b}"
        case .participantRemoveLight: return "\u{f83c}"
        case .participantRemoveRegular: return "\u{f83d}"
        case .participantUnknownBold: return "\u{f83e}"
        case .participantUnknownLight: return "\u{f83f}"
        case .participantUnknownRegular: return "\u{f840}"
        case .passMouseBold: return "\u{f841}"
        case .passMouseLight: return "\u{f842}"
        case .passMouseRegular: return "\u{f843}"
        case .pauseBadgeFilled: return "\u{f844}"
        case .pauseBold: return "\u{f845}"
        case .pauseFilled: return "\u{f846}"
        case .pauseLight: return "\u{f847}"
        case .pauseRegular: return "\u{f848}"
        case .peopleAddBold: return "\u{f849}"
        case .peopleAddFilled: return "\u{f84a}"
        case .peopleAddLight: return "\u{f84b}"
        case .peopleAddRegular: return "\u{f84c}"
        case .peopleBold: return "\u{f84d}"
        case .peopleCircleBold: return "\u{f84e}"
        case .peopleCircleFilled: return "\u{f84f}"
        case .peopleCircleLight: return "\u{f850}"
        case .peopleCircleRegular: return "\u{f851}"
        case .peopleFilled: return "\u{f852}"
        case .peopleInsightsBold: return "\u{f853}"
        case .peopleInsightsFilled: return "\u{f854}"
        case .peopleInsightsLight: return "\u{f855}"
        case .peopleInsightsRegular: return "\u{f856}"
        case .peopleLight: return "\u{f857}"
        case .peopleRegular: return "\u{f858}"
        case .phoneAlertBold: return "\u{f859}"
        case .phoneAlertLight: return "\u{f85a}"
        case .phoneAlertRegular: return "\u{f85b}"
        case .phoneBadgeFilled: return "\u{f85c}"
        case .phoneBold: return "\u{f85d}"
        case .phoneFilled: return "\u{f85e}"
        case .phoneLight: return "\u{f85f}"
        case .phoneMutedBold: return "\u{f860}"
        case .phoneMutedLight: return "\u{f861}"
        case .phoneMutedRegular: return "\u{f862}"
        case .phonePrivateBold: return "\u{f863}"
        case .phonePrivateLight: return "\u{f864}"
        case .phonePrivateRegular: return "\u{f865}"
        case .phoneRegular: return "\u{f866}"
        case .phoneReplyAllBold: return "\u{f867}"
        case .phoneReplyAllLight: return "\u{f868}"
        case .phoneReplyAllRegular: return "\u{f869}"
        case .phoneReplyBold: return "\u{f86a}"
        case .phoneReplyLight: return "\u{f86b}"
        case .phoneReplyRegular: return "\u{f86c}"
        case .pickerBold: return "\u{f86d}"
        case .pickerLight: return "\u{f86e}"
        case .pickerRegular: return "\u{f86f}"
        case .pieChartBold: return "\u{f870}"
        case .pieChartFilled: return "\u{f871}"
        case .pieChartLight: return "\u{f872}"
        case .pieChartRegular: return "\u{f873}"
        case .pinBold: return "\u{f874}"
        case .pinFilled: return "\u{f875}"
        case .pinLight: return "\u{f876}"
        case .pinListActivityBold: return "\u{f877}"
        case .pinListActivityLight: return "\u{f878}"
        case .pinListActivityRegular: return "\u{f879}"
        case .pinListBold: return "\u{f87a}"
        case .pinListLight: return "\u{f87b}"
        case .pinListRegular: return "\u{f87c}"
        case .pinMutedBold: return "\u{f87d}"
        case .pinMutedFilled: return "\u{f87e}"
        case .pinMutedLight: return "\u{f87f}"
        case .pinMutedRegular: return "\u{f880}"
        case .pinRegular: return "\u{f881}"
        case .pipBold: return "\u{f882}"
        case .pipEnterBold: return "\u{f883}"
        case .pipEnterLight: return "\u{f884}"
        case .pipEnterRegular: return "\u{f885}"
        case .pipExitBold: return "\u{f886}"
        case .pipExitLight: return "\u{f887}"
        case .pipExitRegular: return "\u{f888}"
        case .pipFilled: return "\u{f889}"
        case .pipLight: return "\u{f88a}"
        case .pipRegular: return "\u{f88b}"
        case .placeholderBold: return "\u{f88c}"
        case .placeholderFilled: return "\u{f88d}"
        case .placeholderLight: return "\u{f88e}"
        case .placeholderRegular: return "\u{f88f}"
        case .playBold: return "\u{f890}"
        case .playCircleBold: return "\u{f891}"
        case .playCircleFilled: return "\u{f892}"
        case .playCircleLight: return "\u{f893}"
        case .playCircleRegular: return "\u{f894}"
        case .playFilled: return "\u{f895}"
        case .playLight: return "\u{f896}"
        case .playRegular: return "\u{f897}"
        case .plugAcBold: return "\u{f898}"
        case .plugAcLight: return "\u{f899}"
        case .plugAcRegular: return "\u{f89a}"
        case .plusBold: return "\u{f89b}"
        case .plusCircleBold: return "\u{f89c}"
        case .plusCircleFilled: return "\u{f89d}"
        case .plusCircleLight: return "\u{f89e}"
        case .plusCircleRegular: return "\u{f89f}"
        case .plusLight: return "\u{f8a0}"
        case .plusRegular: return "\u{f8a1}"
        case .pmrBold: return "\u{f8a2}"
        case .pmrFilled: return "\u{f8a3}"
        case .pmrLight: return "\u{f8a4}"
        case .pmrRegular: return "\u{f8a5}"
        case .pollBold: return "\u{f8a6}"
        case .pollFilled: return "\u{f8a7}"
        case .pollLight: return "\u{f8a8}"
        case .pollRegular: return "\u{f8a9}"
        case .popInBold: return "\u{f8aa}"
        case .popInLight: return "\u{f8ab}"
        case .popInRegular: return "\u{f8ac}"
        case .popOutBold: return "\u{f8ad}"
        case .popOutLight: return "\u{f8ae}"
        case .popOutRegular: return "\u{f8af}"
        case .popUpBold: return "\u{f8b0}"
        case .popUpLight: return "\u{f8b1}"
        case .popUpRegular: return "\u{f8b2}"
        case .portraitLandscapeBold: return "\u{f8b3}"
        case .portraitLandscapeLight: return "\u{f8b4}"
        case .portraitLandscapeRegular: return "\u{f8b5}"
        case .potentialFraudBold: return "\u{f8b6}"
        case .potentialFraudFilled: return "\u{f8b7}"
        case .potentialFraudLight: return "\u{f8b8}"
        case .potentialFraudRegular: return "\u{f8b9}"
        case .powerAcBold: return "\u{f8ba}"
        case .powerAcLight: return "\u{f8bb}"
        case .powerAcRegular: return "\u{f8bc}"
        case .powerBold: return "\u{f8bd}"
        case .powerLight: return "\u{f8be}"
        case .powerRegular: return "\u{f8bf}"
        case .preHeaderBold: return "\u{f8c0}"
        case .preHeaderLight: return "\u{f8c1}"
        case .preHeaderRegular: return "\u{f8c2}"
        case .premiumBold: return "\u{f8c3}"
        case .premiumLight: return "\u{f8c4}"
        case .premiumRegular: return "\u{f8c5}"
        case .presentationBold: return "\u{f8c6}"
        case .presentationLight: return "\u{f8c7}"
        case .presentationRegular: return "\u{f8c8}"
        case .preventDownloadBold: return "\u{f8c9}"
        case .preventDownloadFilled: return "\u{f8ca}"
        case .preventDownloadLight: return "\u{f8cb}"
        case .preventDownloadRegular: return "\u{f8cc}"
        case .primaryParticipantBold: return "\u{f8cd}"
        case .primaryParticipantLight: return "\u{f8ce}"
        case .primaryParticipantRegular: return "\u{f8cf}"
        case .printBold: return "\u{f8d0}"
        case .printLight: return "\u{f8d1}"
        case .printRegular: return "\u{f8d2}"
        case .priorityBadgeFilled: return "\u{f8d3}"
        case .priorityCircleBold: return "\u{f8d4}"
        case .priorityCircleFilled: return "\u{f8d5}"
        case .priorityCircleLight: return "\u{f8d6}"
        case .priorityCircleRegular: return "\u{f8d7}"
        case .priorityCircleTwoBold: return "\u{f8d8}"
        case .priorityCircleTwoFilled: return "\u{f8d9}"
        case .priorityCircleTwoLight: return "\u{f8da}"
        case .priorityCircleTwoRegular: return "\u{f8db}"
        case .priorityWaveBold: return "\u{f8dc}"
        case .priorityWaveLight: return "\u{f8dd}"
        case .priorityWaveRegular: return "\u{f8de}"
        case .privacyCircleBold: return "\u{f8df}"
        case .privacyCircleFilled: return "\u{f8e0}"
        case .privacyCircleLight: return "\u{f8e1}"
        case .privacyCircleRegular: return "\u{f8e2}"
        case .privateBold: return "\u{f8e3}"
        case .privateCircleBold: return "\u{f8e4}"
        case .privateCircleFilled: return "\u{f8e5}"
        case .privateCircleLight: return "\u{f8e6}"
        case .privateCircleRegular: return "\u{f8e7}"
        case .privateLight: return "\u{f8e8}"
        case .privateMeetingBold: return "\u{f8e9}"
        case .privateMeetingLight: return "\u{f8ea}"
        case .privateMeetingRegular: return "\u{f8eb}"
        case .privateRegular: return "\u{f8ec}"
        case .productDemoBold: return "\u{f8ed}"
        case .productDemoLight: return "\u{f8ee}"
        case .productDemoRegular: return "\u{f8ef}"
        case .proximityBold: return "\u{f8f0}"
        case .proximityLight: return "\u{f8f1}"
        case .proximityMutedBold: return "\u{f8f2}"
        case .proximityMutedLight: return "\u{f8f3}"
        case .proximityMutedRegular: return "\u{f8f4}"
        case .proximityRegular: return "\u{f8f5}"
        case .proximityVideoBold: return "\u{f8f6}"
        case .proximityVideoLight: return "\u{f8f7}"
        case .proximityVideoRegular: return "\u{f8f8}"
        case .ptoPresenceBold: return "\u{f8f9}"
        case .ptoPresenceFilled: return "\u{f8fa}"
        case .ptoPresenceLight: return "\u{f8fb}"
        case .ptoPresenceRegular: return "\u{f8fc}"
        case .pullCallBold: return "\u{f8fd}"
        case .pullCallFilled: return "\u{f8fe}"
        case .pullCallLight: return "\u{f8ff}"
        case .pullCallRegular: return "\u{f900}"
        case .qABold: return "\u{f901}"
        case .qALight: return "\u{f902}"
        case .qARegular: return "\u{f903}"
        case .qrCodeBold: return "\u{f904}"
        case .qrCodeLight: return "\u{f905}"
        case .qrCodeRegular: return "\u{f906}"
        case .qrCodeScanBold: return "\u{f907}"
        case .qrCodeScanLight: return "\u{f908}"
        case .qrCodeScanRegular: return "\u{f909}"
        case .qualityBold: return "\u{f90a}"
        case .qualityLight: return "\u{f90b}"
        case .qualityRegular: return "\u{f90c}"
        case .queueContactBold: return "\u{f90d}"
        case .queueContactFilled: return "\u{f90e}"
        case .queueContactLight: return "\u{f90f}"
        case .queueContactRegular: return "\u{f910}"
        case .quietBold: return "\u{f911}"
        case .quietHoursPresenceBold: return "\u{f912}"
        case .quietHoursPresenceFilled: return "\u{f913}"
        case .quietHoursPresenceLight: return "\u{f914}"
        case .quietHoursPresenceRegular: return "\u{f915}"
        case .quietLight: return "\u{f916}"
        case .quietRegular: return "\u{f917}"
        case .radioButtonGroupBold: return "\u{f918}"
        case .radioButtonGroupLight: return "\u{f919}"
        case .radioButtonGroupRegular: return "\u{f91a}"
        case .raiseHandBold: return "\u{f91b}"
        case .raiseHandCircleFilled: return "\u{f91c}"
        case .raiseHandFilled: return "\u{f91d}"
        case .raiseHandLight: return "\u{f91e}"
        case .raiseHandRegular: return "\u{f91f}"
        case .ramBold: return "\u{f920}"
        case .ramLight: return "\u{f921}"
        case .ramRegular: return "\u{f922}"
        case .reactionsBold: return "\u{f923}"
        case .reactionsFilled: return "\u{f924}"
        case .reactionsLight: return "\u{f925}"
        case .reactionsRegular: return "\u{f926}"
        case .reactivateBold: return "\u{f927}"
        case .reactivateLight: return "\u{f928}"
        case .reactivateRegular: return "\u{f929}"
        case .receiveVoiceBold: return "\u{f92a}"
        case .receiveVoiceFilled: return "\u{f92b}"
        case .receiveVoiceLight: return "\u{f92c}"
        case .receiveVoiceRegular: return "\u{f92d}"
        case .recentsBold: return "\u{f92e}"
        case .recentsFilled: return "\u{f92f}"
        case .recentsLight: return "\u{f930}"
        case .recentsPresenceBadgeFilled: return "\u{f931}"
        case .recentsPresenceBold: return "\u{f932}"
        case .recentsPresenceFilled: return "\u{f933}"
        case .recentsPresenceLight: return "\u{f934}"
        case .recentsPresenceRegular: return "\u{f935}"
        case .recentsRegular: return "\u{f936}"
        case .recordActiveBadgeFilled: return "\u{f937}"
        case .recordActiveBold: return "\u{f938}"
        case .recordActiveFilled: return "\u{f939}"
        case .recordActiveLight: return "\u{f93a}"
        case .recordActiveRegular: return "\u{f93b}"
        case .recordBold: return "\u{f93c}"
        case .recordFilled: return "\u{f93d}"
        case .recordLight: return "\u{f93e}"
        case .recordPausedBadgeFilled: return "\u{f93f}"
        case .recordPausedBold: return "\u{f940}"
        case .recordPausedFilled: return "\u{f941}"
        case .recordPausedLight: return "\u{f942}"
        case .recordPausedRegular: return "\u{f943}"
        case .recordRegular: return "\u{f944}"
        case .recurringBold: return "\u{f945}"
        case .recurringLight: return "\u{f946}"
        case .recurringOffBold: return "\u{f947}"
        case .recurringOffLight: return "\u{f948}"
        case .recurringOffRegular: return "\u{f949}"
        case .recurringRegular: return "\u{f94a}"
        case .redoBold: return "\u{f94b}"
        case .redoLight: return "\u{f94c}"
        case .redoRegular: return "\u{f94d}"
        case .refreshBold: return "\u{f94e}"
        case .refreshLight: return "\u{f94f}"
        case .refreshRegular: return "\u{f950}"
        case .remoteDesktopControlBold: return "\u{f951}"
        case .remoteDesktopControlFilled: return "\u{f952}"
        case .remoteDesktopControlLight: return "\u{f953}"
        case .remoteDesktopControlRegular: return "\u{f954}"
        case .removeBold: return "\u{f955}"
        case .removeFilled: return "\u{f956}"
        case .removeLight: return "\u{f957}"
        case .removeRegular: return "\u{f958}"
        case .replyBold: return "\u{f959}"
        case .replyFilled: return "\u{f95a}"
        case .replyLight: return "\u{f95b}"
        case .replyListBold: return "\u{f95c}"
        case .replyListLight: return "\u{f95d}"
        case .replyListRegular: return "\u{f95e}"
        case .replyPrivatelyBold: return "\u{f95f}"
        case .replyPrivatelyLight: return "\u{f960}"
        case .replyPrivatelyRegular: return "\u{f961}"
        case .replyRegular: return "\u{f962}"
        case .resetBold: return "\u{f963}"
        case .resetLight: return "\u{f964}"
        case .resetRegular: return "\u{f965}"
        case .resizeCornerBold: return "\u{f966}"
        case .resizeCornerLight: return "\u{f967}"
        case .resizeCornerRegular: return "\u{f968}"
        case .responsiveMobileBold: return "\u{f969}"
        case .responsiveMobileLight: return "\u{f96a}"
        case .responsiveMobileRegular: return "\u{f96b}"
        case .restartBold: return "\u{f96c}"
        case .restartLight: return "\u{f96d}"
        case .restartRegular: return "\u{f96e}"
        case .retrieveCallBold: return "\u{f96f}"
        case .retrieveCallFilled: return "\u{f970}"
        case .retrieveCallLight: return "\u{f971}"
        case .retrieveCallRegular: return "\u{f972}"
        case .returnBold: return "\u{f973}"
        case .returnLight: return "\u{f974}"
        case .returnRegular: return "\u{f975}"
        case .rewindTenSecBold: return "\u{f976}"
        case .rewindTenSecLight: return "\u{f977}"
        case .rewindTenSecRegular: return "\u{f978}"
        case .ringtoneBold: return "\u{f979}"
        case .ringtoneLight: return "\u{f97a}"
        case .ringtoneRegular: return "\u{f97b}"
        case .roomCalendarBold: return "\u{f97c}"
        case .roomCalendarLight: return "\u{f97d}"
        case .roomCalendarRegular: return "\u{f97e}"
        case .roomLightsBold: return "\u{f97f}"
        case .roomLightsFilled: return "\u{f980}"
        case .roomLightsLight: return "\u{f981}"
        case .roomLightsRegular: return "\u{f982}"
        case .rotateContentBold: return "\u{f983}"
        case .rotateContentFilled: return "\u{f984}"
        case .rotateContentLight: return "\u{f985}"
        case .rotateContentRegular: return "\u{f986}"
        case .rssBold: return "\u{f987}"
        case .rssFilled: return "\u{f988}"
        case .rssLight: return "\u{f989}"
        case .rssRegular: return "\u{f98a}"
        case .ruleBasedBold: return "\u{f98b}"
        case .ruleBasedLight: return "\u{f98c}"
        case .ruleBasedRegular: return "\u{f98d}"
        case .runningApplicationBold: return "\u{f98e}"
        case .runningApplicationFilled: return "\u{f98f}"
        case .runningApplicationLight: return "\u{f990}"
        case .runningApplicationRegular: return "\u{f991}"
        case .saveBold: return "\u{f992}"
        case .saveLight: return "\u{f993}"
        case .saveRegular: return "\u{f994}"
        case .saveTranscriptBold: return "\u{f995}"
        case .saveTranscriptFilled: return "\u{f996}"
        case .saveTranscriptLight: return "\u{f997}"
        case .saveTranscriptRegular: return "\u{f998}"
        case .scanBold: return "\u{f999}"
        case .scanLight: return "\u{f99a}"
        case .scanRegular: return "\u{f99b}"
        case .scheduleSendBold: return "\u{f99c}"
        case .scheduleSendFilled: return "\u{f99d}"
        case .scheduleSendLight: return "\u{f99e}"
        case .scheduleSendRegular: return "\u{f99f}"
        case .scheduleWinnerBold: return "\u{f9a0}"
        case .scheduleWinnerFilled: return "\u{f9a1}"
        case .scheduleWinnerLight: return "\u{f9a2}"
        case .scheduleWinnerRegular: return "\u{f9a3}"
        case .schedulerAvailableBold: return "\u{f9a4}"
        case .schedulerAvailableLight: return "\u{f9a5}"
        case .schedulerAvailableRegular: return "\u{f9a6}"
        case .schedulerNotWorkingHoursBold: return "\u{f9a7}"
        case .schedulerNotWorkingHoursLight: return "\u{f9a8}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9a9}"
        case .schedulerUnavailableBold: return "\u{f9aa}"
        case .schedulerUnavailableLight: return "\u{f9ab}"
        case .schedulerUnavailableRegular: return "\u{f9ac}"
        case .schedulerUnknownBold: return "\u{f9ad}"
        case .schedulerUnknownLight: return "\u{f9ae}"
        case .schedulerUnknownRegular: return "\u{f9af}"
        case .screenshotBold: return "\u{f9b0}"
        case .screenshotDocBold: return "\u{f9b1}"
        case .screenshotDocFilled: return "\u{f9b2}"
        case .screenshotDocLight: return "\u{f9b3}"
        case .screenshotDocRegular: return "\u{f9b4}"
        case .screenshotLight: return "\u{f9b5}"
        case .screenshotRegular: return "\u{f9b6}"
        case .searchBold: return "\u{f9b7}"
        case .searchFilled: return "\u{f9b8}"
        case .searchLight: return "\u{f9b9}"
        case .searchRegular: return "\u{f9ba}"
        case .secondaryArrowBold: return "\u{f9bb}"
        case .secondaryArrowLight: return "\u{f9bc}"
        case .secondaryArrowRegular: return "\u{f9bd}"
        case .secureCallLockBold: return "\u{f9be}"
        case .secureCallLockFilled: return "\u{f9bf}"
        case .secureCallLockLight: return "\u{f9c0}"
        case .secureCallLockRegular: return "\u{f9c1}"
        case .secureCallShieldBold: return "\u{f9c2}"
        case .secureCallShieldFilled: return "\u{f9c3}"
        case .secureCallShieldLight: return "\u{f9c4}"
        case .secureCallShieldRegular: return "\u{f9c5}"
        case .secureCircleBold: return "\u{f9c6}"
        case .secureCircleFilled: return "\u{f9c7}"
        case .secureCircleLight: return "\u{f9c8}"
        case .secureCircleRegular: return "\u{f9c9}"
        case .secureLockBold: return "\u{f9ca}"
        case .secureLockFilled: return "\u{f9cb}"
        case .secureLockLight: return "\u{f9cc}"
        case .secureLockRegular: return "\u{f9cd}"
        case .segmentExcludeFilled: return "\u{f9ce}"
        case .segmentFilterFilled: return "\u{f9cf}"
        case .segmentIncludeFilled: return "\u{f9d0}"
        case .selectAllBold: return "\u{f9d1}"
        case .selectAllFilled: return "\u{f9d2}"
        case .selectAllLight: return "\u{f9d3}"
        case .selectAllRegular: return "\u{f9d4}"
        case .selectionBold: return "\u{f9d5}"
        case .selectionFilled: return "\u{f9d6}"
        case .selectionLight: return "\u{f9d7}"
        case .selectionRegular: return "\u{f9d8}"
        case .sendBold: return "\u{f9d9}"
        case .sendDigitsBold: return "\u{f9da}"
        case .sendDigitsFilled: return "\u{f9db}"
        case .sendDigitsLight: return "\u{f9dc}"
        case .sendDigitsRegular: return "\u{f9dd}"
        case .sendFilled: return "\u{f9de}"
        case .sendLight: return "\u{f9df}"
        case .sendRegular: return "\u{f9e0}"
        case .sendVoiceBold: return "\u{f9e1}"
        case .sendVoiceFilled: return "\u{f9e2}"
        case .sendVoiceLight: return "\u{f9e3}"
        case .sendVoiceRegular: return "\u{f9e4}"
        case .serverBold: return "\u{f9e5}"
        case .serverErrorBold: return "\u{f9e6}"
        case .serverErrorLight: return "\u{f9e7}"
        case .serverErrorRegular: return "\u{f9e8}"
        case .serverLight: return "\u{f9e9}"
        case .serverRegular: return "\u{f9ea}"
        case .servicesBold: return "\u{f9eb}"
        case .servicesLight: return "\u{f9ec}"
        case .servicesRegular: return "\u{f9ed}"
        case .setVariableBold: return "\u{f9ee}"
        case .setVariableLight: return "\u{f9ef}"
        case .setVariableRegular: return "\u{f9f0}"
        case .settingsBold: return "\u{f9f1}"
        case .settingsFilled: return "\u{f9f2}"
        case .settingsLight: return "\u{f9f3}"
        case .settingsRegular: return "\u{f9f4}"
        case .setupAssistantBold: return "\u{f9f5}"
        case .setupAssistantLight: return "\u{f9f6}"
        case .setupAssistantRegular: return "\u{f9f7}"
        case .sftpBold: return "\u{f9f8}"
        case .sftpLight: return "\u{f9f9}"
        case .sftpRegular: return "\u{f9fa}"
        case .shapeCircleBold: return "\u{f9fb}"
        case .shapeCircleFilled: return "\u{f9fc}"
        case .shapeCircleLight: return "\u{f9fd}"
        case .shapeCircleMdFilled: return "\u{f9fe}"
        case .shapeCircleRegular: return "\u{f9ff}"
        case .shapeCircleSmFilled: return "\u{fa00}"
        case .shapeDiagonalLineBold: return "\u{fa01}"
        case .shapeDiagonalLineLight: return "\u{fa02}"
        case .shapeDiagonalLineRegular: return "\u{fa03}"
        case .shapeDiamondBold: return "\u{fa04}"
        case .shapeDiamondFilled: return "\u{fa05}"
        case .shapeDiamondLight: return "\u{fa06}"
        case .shapeDiamondRegular: return "\u{fa07}"
        case .shapeOvalBold: return "\u{fa08}"
        case .shapeOvalLight: return "\u{fa09}"
        case .shapeOvalRegular: return "\u{fa0a}"
        case .shapeSquareBold: return "\u{fa0b}"
        case .shapeSquareFilled: return "\u{fa0c}"
        case .shapeSquareLight: return "\u{fa0d}"
        case .shapeSquareRegular: return "\u{fa0e}"
        case .shapeTriangleBold: return "\u{fa0f}"
        case .shapeTriangleFilled: return "\u{fa10}"
        case .shapeTriangleLight: return "\u{fa11}"
        case .shapeTriangleRegular: return "\u{fa12}"
        case .shapesBold: return "\u{fa13}"
        case .shapesFilled: return "\u{fa14}"
        case .shapesLight: return "\u{fa15}"
        case .shapesRegular: return "\u{fa16}"
        case .shareCNativeAdrBold: return "\u{fa17}"
        case .shareCNativeAdrFilled: return "\u{fa18}"
        case .shareCNativeAdrLight: return "\u{fa19}"
        case .shareCNativeAdrRegular: return "\u{fa1a}"
        case .shareCNativeIphBold: return "\u{fa1b}"
        case .shareCNativeIphLight: return "\u{fa1c}"
        case .shareCNativeIphRegular: return "\u{fa1d}"
        case .shareContentOnDeviceBold: return "\u{fa1e}"
        case .shareContentOnDeviceLight: return "\u{fa1f}"
        case .shareContentOnDeviceRegular: return "\u{fa20}"
        case .shareScreenAddBold: return "\u{fa21}"
        case .shareScreenAddLight: return "\u{fa22}"
        case .shareScreenAddRegular: return "\u{fa23}"
        case .shareScreenBadgeFilled: return "\u{fa24}"
        case .shareScreenBold: return "\u{fa25}"
        case .shareScreenFilled: return "\u{fa26}"
        case .shareScreenLight: return "\u{fa27}"
        case .shareScreenRegular: return "\u{fa28}"
        case .shareSpaceBold: return "\u{fa29}"
        case .shareSpaceLight: return "\u{fa2a}"
        case .shareSpaceRegular: return "\u{fa2b}"
        case .shieldBold: return "\u{fa2c}"
        case .shieldLight: return "\u{fa2d}"
        case .shieldRegular: return "\u{fa2e}"
        case .shoppingCartBold: return "\u{fa2f}"
        case .shoppingCartFilled: return "\u{fa30}"
        case .shoppingCartLight: return "\u{fa31}"
        case .shoppingCartRegular: return "\u{fa32}"
        case .shortTextBoxBold: return "\u{fa33}"
        case .shortTextBoxLight: return "\u{fa34}"
        case .shortTextBoxRegular: return "\u{fa35}"
        case .showBold: return "\u{fa36}"
        case .showFilled: return "\u{fa37}"
        case .showLight: return "\u{fa38}"
        case .showRegular: return "\u{fa39}"
        case .signInBold: return "\u{fa3a}"
        case .signInFilled: return "\u{fa3b}"
        case .signInForcedBold: return "\u{fa3c}"
        case .signInForcedLight: return "\u{fa3d}"
        case .signInForcedRegular: return "\u{fa3e}"
        case .signInLight: return "\u{fa3f}"
        case .signInRegular: return "\u{fa40}"
        case .signLangIntBold: return "\u{fa41}"
        case .signLangIntLight: return "\u{fa42}"
        case .signLangIntRegular: return "\u{fa43}"
        case .signOutBold: return "\u{fa44}"
        case .signOutLight: return "\u{fa45}"
        case .signOutRegular: return "\u{fa46}"
        case .signalFourBold: return "\u{fa47}"
        case .signalFourLight: return "\u{fa48}"
        case .signalFourRegular: return "\u{fa49}"
        case .signalOneBold: return "\u{fa4a}"
        case .signalOneLight: return "\u{fa4b}"
        case .signalOneRegular: return "\u{fa4c}"
        case .signalThreeBold: return "\u{fa4d}"
        case .signalThreeLight: return "\u{fa4e}"
        case .signalThreeRegular: return "\u{fa4f}"
        case .signalTwoBold: return "\u{fa50}"
        case .signalTwoLight: return "\u{fa51}"
        case .signalTwoRegular: return "\u{fa52}"
        case .signalZeroBold: return "\u{fa53}"
        case .signalZeroLight: return "\u{fa54}"
        case .signalZeroRegular: return "\u{fa55}"
        case .simplePromotionBold: return "\u{fa56}"
        case .simplePromotionLight: return "\u{fa57}"
        case .simplePromotionRegular: return "\u{fa58}"
        case .singleNumberReachBold: return "\u{fa59}"
        case .singleNumberReachLight: return "\u{fa5a}"
        case .singleNumberReachRegular: return "\u{fa5b}"
        case .sipRegistrationInProgressBold: return "\u{fa5c}"
        case .sipRegistrationInProgressFilled: return "\u{fa5d}"
        case .sipRegistrationInProgressLight: return "\u{fa5e}"
        case .sipRegistrationInProgressRegular: return "\u{fa5f}"
        case .skipBold: return "\u{fa60}"
        case .skipBwBold: return "\u{fa61}"
        case .skipBwFilled: return "\u{fa62}"
        case .skipBwLight: return "\u{fa63}"
        case .skipBwRegular: return "\u{fa64}"
        case .skipFwBold: return "\u{fa65}"
        case .skipFwFilled: return "\u{fa66}"
        case .skipFwLight: return "\u{fa67}"
        case .skipFwRegular: return "\u{fa68}"
        case .skipLight: return "\u{fa69}"
        case .skipRegular: return "\u{fa6a}"
        case .smartAudioBold: return "\u{fa6b}"
        case .smartAudioLight: return "\u{fa6c}"
        case .smartAudioRegular: return "\u{fa6d}"
        case .smsFilled: return "\u{fa6e}"
        case .smsInboundBold: return "\u{fa6f}"
        case .smsInboundLight: return "\u{fa70}"
        case .smsInboundRegular: return "\u{fa71}"
        case .smsMessageBold: return "\u{fa72}"
        case .smsMessageFilled: return "\u{fa73}"
        case .smsMessageLight: return "\u{fa74}"
        case .smsMessageRegular: return "\u{fa75}"
        case .smsOutgoingFilled: return "\u{fa76}"
        case .smsUnreadBold: return "\u{fa77}"
        case .smsUnreadLight: return "\u{fa78}"
        case .smsUnreadRegular: return "\u{fa79}"
        case .sortAscendingBold: return "\u{fa7a}"
        case .sortAscendingLight: return "\u{fa7b}"
        case .sortAscendingRegular: return "\u{fa7c}"
        case .sortDescendingBold: return "\u{fa7d}"
        case .sortDescendingLight: return "\u{fa7e}"
        case .sortDescendingRegular: return "\u{fa7f}"
        case .soundDefaultBold: return "\u{fa80}"
        case .soundDefaultLight: return "\u{fa81}"
        case .soundDefaultRegular: return "\u{fa82}"
        case .sparkleBold: return "\u{fa83}"
        case .sparkleFilled: return "\u{fa84}"
        case .sparkleLight: return "\u{fa85}"
        case .sparkleRegular: return "\u{fa86}"
        case .speakerBold: return "\u{fa87}"
        case .speakerDisconnectedBold: return "\u{fa88}"
        case .speakerDisconnectedFilled: return "\u{fa89}"
        case .speakerDisconnectedLight: return "\u{fa8a}"
        case .speakerDisconnectedRegular: return "\u{fa8b}"
        case .speakerFilled: return "\u{fa8c}"
        case .speakerLight: return "\u{fa8d}"
        case .speakerMutedBold: return "\u{fa8e}"
        case .speakerMutedFilled: return "\u{fa8f}"
        case .speakerMutedLight: return "\u{fa90}"
        case .speakerMutedRegular: return "\u{fa91}"
        case .speakerOffBold: return "\u{fa92}"
        case .speakerOffFilled: return "\u{fa93}"
        case .speakerOffLight: return "\u{fa94}"
        case .speakerOffRegular: return "\u{fa95}"
        case .speakerOnBold: return "\u{fa96}"
        case .speakerOnLight: return "\u{fa97}"
        case .speakerOnRegular: return "\u{fa98}"
        case .speakerRegular: return "\u{fa99}"
        case .speakerTurnDownBold: return "\u{fa9a}"
        case .speakerTurnDownFilled: return "\u{fa9b}"
        case .speakerTurnDownLight: return "\u{fa9c}"
        case .speakerTurnDownRegular: return "\u{fa9d}"
        case .speakerTurnUpBold: return "\u{fa9e}"
        case .speakerTurnUpFilled: return "\u{fa9f}"
        case .speakerTurnUpLight: return "\u{faa0}"
        case .speakerTurnUpRegular: return "\u{faa1}"
        case .speedDialBold: return "\u{faa2}"
        case .speedDialFilled: return "\u{faa3}"
        case .speedDialLight: return "\u{faa4}"
        case .speedDialRegular: return "\u{faa5}"
        case .spellCheckerBold: return "\u{faa6}"
        case .spellCheckerLight: return "\u{faa7}"
        case .spellCheckerRegular: return "\u{faa8}"
        case .splitViewBold: return "\u{faa9}"
        case .splitViewLight: return "\u{faaa}"
        case .splitViewRegular: return "\u{faab}"
        case .stackedAreaChartBold: return "\u{faac}"
        case .stackedAreaChartFilled: return "\u{faad}"
        case .stackedAreaChartFullBold: return "\u{faae}"
        case .stackedAreaChartFullFilled: return "\u{faaf}"
        case .stackedAreaChartFullLight: return "\u{fab0}"
        case .stackedAreaChartFullRegular: return "\u{fab1}"
        case .stackedAreaChartLight: return "\u{fab2}"
        case .stackedAreaChartRegular: return "\u{fab3}"
        case .stackedBarChartBold: return "\u{fab4}"
        case .stackedBarChartFilled: return "\u{fab5}"
        case .stackedBarChartFullBold: return "\u{fab6}"
        case .stackedBarChartFullFilled: return "\u{fab7}"
        case .stackedBarChartFullLight: return "\u{fab8}"
        case .stackedBarChartFullRegular: return "\u{fab9}"
        case .stackedBarChartLight: return "\u{faba}"
        case .stackedBarChartRegular: return "\u{fabb}"
        case .startChatBold: return "\u{fabc}"
        case .startChatLight: return "\u{fabd}"
        case .startChatRegular: return "\u{fabe}"
        case .stethoscopeBold: return "\u{fabf}"
        case .stethoscopeLight: return "\u{fac0}"
        case .stethoscopeRegular: return "\u{fac1}"
        case .stickersBold: return "\u{fac2}"
        case .stickersLight: return "\u{fac3}"
        case .stickersRegular: return "\u{fac4}"
        case .stickiesBold: return "\u{fac5}"
        case .stickiesLight: return "\u{fac6}"
        case .stickiesRegular: return "\u{fac7}"
        case .stopBold: return "\u{fac8}"
        case .stopCircleBold: return "\u{fac9}"
        case .stopCircleFilled: return "\u{faca}"
        case .stopCircleLight: return "\u{facb}"
        case .stopCircleRegular: return "\u{facc}"
        case .stopContentShareBold: return "\u{facd}"
        case .stopContentShareLight: return "\u{face}"
        case .stopContentShareRegular: return "\u{facf}"
        case .stopFilled: return "\u{fad0}"
        case .stopLight: return "\u{fad1}"
        case .stopRegular: return "\u{fad2}"
        case .storedInfoBold: return "\u{fad3}"
        case .storedInfoFilled: return "\u{fad4}"
        case .storedInfoLight: return "\u{fad5}"
        case .storedInfoRegular: return "\u{fad6}"
        case .streamingBold: return "\u{fad7}"
        case .streamingLight: return "\u{fad8}"
        case .streamingRegular: return "\u{fad9}"
        case .strikethroughBold: return "\u{fada}"
        case .strikethroughFilled: return "\u{fadb}"
        case .strikethroughLight: return "\u{fadc}"
        case .strikethroughRegular: return "\u{fadd}"
        case .studioModeBold: return "\u{fade}"
        case .studioModeLight: return "\u{fadf}"
        case .studioModeRegular: return "\u{fae0}"
        case .subscriptBold: return "\u{fae1}"
        case .subscriptLight: return "\u{fae2}"
        case .subscriptRegular: return "\u{fae3}"
        case .superscriptBold: return "\u{fae4}"
        case .superscriptLight: return "\u{fae5}"
        case .superscriptRegular: return "\u{fae6}"
        case .surveyBold: return "\u{fae7}"
        case .surveyFilled: return "\u{fae8}"
        case .surveyLight: return "\u{fae9}"
        case .surveyRegular: return "\u{faea}"
        case .sxEightyCodecBold: return "\u{faeb}"
        case .sxEightyCodecLight: return "\u{faec}"
        case .sxEightyCodecRegular: return "\u{faed}"
        case .sxTenBold: return "\u{faee}"
        case .sxTenLight: return "\u{faef}"
        case .sxTenRegular: return "\u{faf0}"
        case .sxTwentyBold: return "\u{faf1}"
        case .sxTwentyLight: return "\u{faf2}"
        case .sxTwentyRegular: return "\u{faf3}"
        case .tableBold: return "\u{faf4}"
        case .tableLight: return "\u{faf5}"
        case .tableRegular: return "\u{faf6}"
        case .tabletBold: return "\u{faf7}"
        case .tabletLight: return "\u{faf8}"
        case .tabletRegular: return "\u{faf9}"
        case .tabsBold: return "\u{fafa}"
        case .tabsLight: return "\u{fafb}"
        case .tabsRegular: return "\u{fafc}"
        case .tagBold: return "\u{fafd}"
        case .tagLight: return "\u{fafe}"
        case .tagRegular: return "\u{faff}"
        case .tapBold: return "\u{fb00}"
        case .tapFilled: return "\u{fb01}"
        case .tapLight: return "\u{fb02}"
        case .tapRegular: return "\u{fb03}"
        case .telepresenceAlertBold: return "\u{fb04}"
        case .telepresenceAlertLight: return "\u{fb05}"
        case .telepresenceAlertMutedBold: return "\u{fb06}"
        case .telepresenceAlertMutedLight: return "\u{fb07}"
        case .telepresenceAlertMutedRegular: return "\u{fb08}"
        case .telepresenceAlertRegular: return "\u{fb09}"
        case .telepresenceBold: return "\u{fb0a}"
        case .telepresenceIxFiveThousandBold: return "\u{fb0b}"
        case .telepresenceIxFiveThousandLight: return "\u{fb0c}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb0d}"
        case .telepresenceLight: return "\u{fb0e}"
        case .telepresenceMutedBold: return "\u{fb0f}"
        case .telepresenceMutedLight: return "\u{fb10}"
        case .telepresenceMutedRegular: return "\u{fb11}"
        case .telepresencePrivateBold: return "\u{fb12}"
        case .telepresencePrivateLight: return "\u{fb13}"
        case .telepresencePrivateRegular: return "\u{fb14}"
        case .telepresenceRegular: return "\u{fb15}"
        case .temperatureBold: return "\u{fb16}"
        case .temperatureLight: return "\u{fb17}"
        case .temperatureRegular: return "\u{fb18}"
        case .testTubeBold: return "\u{fb19}"
        case .testTubeFilled: return "\u{fb1a}"
        case .testTubeLight: return "\u{fb1b}"
        case .testTubeRegular: return "\u{fb1c}"
        case .textAlignCenterBold: return "\u{fb1d}"
        case .textAlignCenterFilled: return "\u{fb1e}"
        case .textAlignCenterLight: return "\u{fb1f}"
        case .textAlignCenterRegular: return "\u{fb20}"
        case .textAlignLeftBold: return "\u{fb21}"
        case .textAlignLeftFilled: return "\u{fb22}"
        case .textAlignLeftLight: return "\u{fb23}"
        case .textAlignLeftRegular: return "\u{fb24}"
        case .textAlignRightBold: return "\u{fb25}"
        case .textAlignRightFilled: return "\u{fb26}"
        case .textAlignRightLight: return "\u{fb27}"
        case .textAlignRightRegular: return "\u{fb28}"
        case .textBold: return "\u{fb29}"
        case .textBoxCursorLight: return "\u{fb2a}"
        case .textCodeBlockBold: return "\u{fb2b}"
        case .textCodeBlockLight: return "\u{fb2c}"
        case .textCodeBlockRegular: return "\u{fb2d}"
        case .textHighlightBold: return "\u{fb2e}"
        case .textHighlightFilled: return "\u{fb2f}"
        case .textHighlightLight: return "\u{fb30}"
        case .textHighlightRegular: return "\u{fb31}"
        case .textLight: return "\u{fb32}"
        case .textRegular: return "\u{fb33}"
        case .threeColumnBold: return "\u{fb34}"
        case .threeColumnLight: return "\u{fb35}"
        case .threeColumnRegular: return "\u{fb36}"
        case .threeDObjectBold: return "\u{fb37}"
        case .threeDObjectLight: return "\u{fb38}"
        case .threeDObjectRegular: return "\u{fb39}"
        case .timeExclusionBold: return "\u{fb3a}"
        case .timeExclusionLight: return "\u{fb3b}"
        case .timeExclusionRegular: return "\u{fb3c}"
        case .tooFastBold: return "\u{fb3d}"
        case .tooFastLight: return "\u{fb3e}"
        case .tooFastRegular: return "\u{fb3f}"
        case .tooSlowBold: return "\u{fb40}"
        case .tooSlowLight: return "\u{fb41}"
        case .tooSlowRegular: return "\u{fb42}"
        case .toolsBold: return "\u{fb43}"
        case .toolsFilled: return "\u{fb44}"
        case .toolsLight: return "\u{fb45}"
        case .toolsRegular: return "\u{fb46}"
        case .touchTenBold: return "\u{fb47}"
        case .touchTenLight: return "\u{fb48}"
        case .touchTenRegular: return "\u{fb49}"
        case .transcriptBold: return "\u{fb4a}"
        case .transcriptFilled: return "\u{fb4b}"
        case .transcriptLight: return "\u{fb4c}"
        case .transcriptRegular: return "\u{fb4d}"
        case .translateBold: return "\u{fb4e}"
        case .translateLight: return "\u{fb4f}"
        case .translateRegular: return "\u{fb50}"
        case .translateUndoBold: return "\u{fb51}"
        case .translateUndoLight: return "\u{fb52}"
        case .translateUndoRegular: return "\u{fb53}"
        case .trendingBold: return "\u{fb54}"
        case .trendingDownBold: return "\u{fb55}"
        case .trendingDownFilled: return "\u{fb56}"
        case .trendingDownLight: return "\u{fb57}"
        case .trendingDownRegular: return "\u{fb58}"
        case .trendingFilled: return "\u{fb59}"
        case .trendingLight: return "\u{fb5a}"
        case .trendingRegular: return "\u{fb5b}"
        case .trimBold: return "\u{fb5c}"
        case .trimLight: return "\u{fb5d}"
        case .trimRegular: return "\u{fb5e}"
        case .twoColumnBold: return "\u{fb5f}"
        case .twoColumnLight: return "\u{fb60}"
        case .twoColumnRegular: return "\u{fb61}"
        case .twoWayVoiceStreamBold: return "\u{fb62}"
        case .twoWayVoiceStreamFilled: return "\u{fb63}"
        case .twoWayVoiceStreamLight: return "\u{fb64}"
        case .twoWayVoiceStreamRegular: return "\u{fb65}"
        case .ucmCloudBold: return "\u{fb66}"
        case .ucmCloudLight: return "\u{fb67}"
        case .ucmCloudRegular: return "\u{fb68}"
        case .unblockBold: return "\u{fb69}"
        case .unblockFilled: return "\u{fb6a}"
        case .unblockLight: return "\u{fb6b}"
        case .unblockRegular: return "\u{fb6c}"
        case .underlineBold: return "\u{fb6d}"
        case .underlineFilled: return "\u{fb6e}"
        case .underlineLight: return "\u{fb6f}"
        case .underlineRegular: return "\u{fb70}"
        case .undoBold: return "\u{fb71}"
        case .undoLight: return "\u{fb72}"
        case .undoRegular: return "\u{fb73}"
        case .unlinkBold: return "\u{fb74}"
        case .unlinkLight: return "\u{fb75}"
        case .unlinkRegular: return "\u{fb76}"
        case .unreadBold: return "\u{fb77}"
        case .unreadFilled: return "\u{fb78}"
        case .unreadLight: return "\u{fb79}"
        case .unreadRegular: return "\u{fb7a}"
        case .unsecureUnlockedBold: return "\u{fb7b}"
        case .unsecureUnlockedFilled: return "\u{fb7c}"
        case .unsecureUnlockedLight: return "\u{fb7d}"
        case .unsecureUnlockedRegular: return "\u{fb7e}"
        case .unsortedBold: return "\u{fb7f}"
        case .unsortedLight: return "\u{fb80}"
        case .unsortedRegular: return "\u{fb81}"
        case .updateFileShareBold: return "\u{fb82}"
        case .updateFileShareLight: return "\u{fb83}"
        case .updateFileShareRegular: return "\u{fb84}"
        case .uploadBold: return "\u{fb85}"
        case .uploadImageBold: return "\u{fb86}"
        case .uploadImageLight: return "\u{fb87}"
        case .uploadImageRegular: return "\u{fb88}"
        case .uploadLight: return "\u{fb89}"
        case .uploadRegular: return "\u{fb8a}"
        case .urgentVoicemailBold: return "\u{fb8b}"
        case .urgentVoicemailFilled: return "\u{fb8c}"
        case .usbBold: return "\u{fb8d}"
        case .usbHeadsetBold: return "\u{fb8e}"
        case .usbHeadsetLight: return "\u{fb8f}"
        case .usbHeadsetMutedBold: return "\u{fb90}"
        case .usbHeadsetMutedLight: return "\u{fb91}"
        case .usbHeadsetMutedRegular: return "\u{fb92}"
        case .usbHeadsetRegular: return "\u{fb93}"
        case .usbLight: return "\u{fb94}"
        case .usbRegular: return "\u{fb95}"
        case .userBold: return "\u{fb96}"
        case .userDeactivateBold: return "\u{fb97}"
        case .userDeactivateLight: return "\u{fb98}"
        case .userDeactivateRegular: return "\u{fb99}"
        case .userLight: return "\u{fb9a}"
        case .userRegular: return "\u{fb9b}"
        case .videoBlurBold: return "\u{fb9c}"
        case .videoBlurFilled: return "\u{fb9d}"
        case .videoBlurLight: return "\u{fb9e}"
        case .videoBlurRegular: return "\u{fb9f}"
        case .videoBold: return "\u{fba0}"
        case .videoEffectBold: return "\u{fba1}"
        case .videoEffectFilled: return "\u{fba2}"
        case .videoEffectLight: return "\u{fba3}"
        case .videoEffectRegular: return "\u{fba4}"
        case .videoFilled: return "\u{fba5}"
        case .videoLayoutBold: return "\u{fba6}"
        case .videoLayoutEqualBold: return "\u{fba7}"
        case .videoLayoutEqualDualBold: return "\u{fba8}"
        case .videoLayoutEqualDualLight: return "\u{fba9}"
        case .videoLayoutEqualDualRegular: return "\u{fbaa}"
        case .videoLayoutEqualFilled: return "\u{fbab}"
        case .videoLayoutEqualLight: return "\u{fbac}"
        case .videoLayoutEqualRegular: return "\u{fbad}"
        case .videoLayoutFilled: return "\u{fbae}"
        case .videoLayoutLight: return "\u{fbaf}"
        case .videoLayoutOverlayBold: return "\u{fbb0}"
        case .videoLayoutOverlayFilled: return "\u{fbb1}"
        case .videoLayoutOverlayLight: return "\u{fbb2}"
        case .videoLayoutOverlayRegular: return "\u{fbb3}"
        case .videoLayoutPresenterDominantBold: return "\u{fbb4}"
        case .videoLayoutPresenterDominantLight: return "\u{fbb5}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbb6}"
        case .videoLayoutProminentBold: return "\u{fbb7}"
        case .videoLayoutProminentFilled: return "\u{fbb8}"
        case .videoLayoutProminentLight: return "\u{fbb9}"
        case .videoLayoutProminentRegular: return "\u{fbba}"
        case .videoLayoutRegular: return "\u{fbbb}"
        case .videoLayoutShareDominantBold: return "\u{fbbc}"
        case .videoLayoutShareDominantLight: return "\u{fbbd}"
        case .videoLayoutShareDominantRegular: return "\u{fbbe}"
        case .videoLayoutSingleBold: return "\u{fbbf}"
        case .videoLayoutSingleFilled: return "\u{fbc0}"
        case .videoLayoutSingleLight: return "\u{fbc1}"
        case .videoLayoutSingleRegular: return "\u{fbc2}"
        case .videoLayoutStackBold: return "\u{fbc3}"
        case .videoLayoutStackFilled: return "\u{fbc4}"
        case .videoLayoutStackLight: return "\u{fbc5}"
        case .videoLayoutStackRegular: return "\u{fbc6}"
        case .videoLayoutVideoDominantBold: return "\u{fbc7}"
        case .videoLayoutVideoDominantFilled: return "\u{fbc8}"
        case .videoLayoutVideoDominantLight: return "\u{fbc9}"
        case .videoLayoutVideoDominantRegular: return "\u{fbca}"
        case .videoLight: return "\u{fbcb}"
        case .videoPlusBold: return "\u{fbcc}"
        case .videoPlusFilled: return "\u{fbcd}"
        case .videoPlusLight: return "\u{fbce}"
        case .videoPlusRegular: return "\u{fbcf}"
        case .videoRegular: return "\u{fbd0}"
        case .videoSpeakerTrackBold: return "\u{fbd1}"
        case .videoSpeakerTrackFilled: return "\u{fbd2}"
        case .videoSpeakerTrackLight: return "\u{fbd3}"
        case .videoSpeakerTrackRegular: return "\u{fbd4}"
        case .viewAllBold: return "\u{fbd5}"
        case .viewAllLight: return "\u{fbd6}"
        case .viewAllRegular: return "\u{fbd7}"
        case .viewListBold: return "\u{fbd8}"
        case .viewListFilled: return "\u{fbd9}"
        case .viewListLight: return "\u{fbda}"
        case .viewListRegular: return "\u{fbdb}"
        case .viewStackedBold: return "\u{fbdc}"
        case .viewStackedFilled: return "\u{fbdd}"
        case .viewStackedLight: return "\u{fbde}"
        case .viewStackedRegular: return "\u{fbdf}"
        case .viewThumbnailBold: return "\u{fbe0}"
        case .viewThumbnailFilled: return "\u{fbe1}"
        case .viewThumbnailLight: return "\u{fbe2}"
        case .viewThumbnailRegular: return "\u{fbe3}"
        case .visionproBold: return "\u{fbe4}"
        case .visionproFilled: return "\u{fbe5}"
        case .visionproLight: return "\u{fbe6}"
        case .visionproMoveCallInBold: return "\u{fbe7}"
        case .visionproMoveCallInFilled: return "\u{fbe8}"
        case .visionproMoveCallInLight: return "\u{fbe9}"
        case .visionproMoveCallInOutBold: return "\u{fbea}"
        case .visionproMoveCallInOutFilled: return "\u{fbeb}"
        case .visionproMoveCallInOutLight: return "\u{fbec}"
        case .visionproMoveCallInOutRegular: return "\u{fbed}"
        case .visionproMoveCallInRegular: return "\u{fbee}"
        case .visionproMoveCallOutBold: return "\u{fbef}"
        case .visionproMoveCallOutFilled: return "\u{fbf0}"
        case .visionproMoveCallOutLight: return "\u{fbf1}"
        case .visionproMoveCallOutRegular: return "\u{fbf2}"
        case .visionproRegular: return "\u{fbf3}"
        case .voicemailBold: return "\u{fbf4}"
        case .voicemailFilled: return "\u{fbf5}"
        case .voicemailLight: return "\u{fbf6}"
        case .voicemailRegular: return "\u{fbf7}"
        case .vpnBold: return "\u{fbf8}"
        case .vpnFilled: return "\u{fbf9}"
        case .vpnLight: return "\u{fbfa}"
        case .vpnRegular: return "\u{fbfb}"
        case .vscBold: return "\u{fbfc}"
        case .vscLight: return "\u{fbfd}"
        case .vscRegular: return "\u{fbfe}"
        case .waffleMenuBold: return "\u{fbff}"
        case .waffleMenuLight: return "\u{fc00}"
        case .waffleMenuRegular: return "\u{fc01}"
        case .waitingRoomBold: return "\u{fc02}"
        case .waitingRoomLight: return "\u{fc03}"
        case .waitingRoomRegular: return "\u{fc04}"
        case .wallpaperBold: return "\u{fc05}"
        case .wallpaperLight: return "\u{fc06}"
        case .wallpaperRegular: return "\u{fc07}"
        case .warningBadgeFilled: return "\u{fc08}"
        case .warningBold: return "\u{fc09}"
        case .warningFilled: return "\u{fc0a}"
        case .warningLight: return "\u{fc0b}"
        case .warningRegular: return "\u{fc0c}"
        case .webexBoardBold: return "\u{fc0d}"
        case .webexBoardLight: return "\u{fc0e}"
        case .webexBoardRegular: return "\u{fc0f}"
        case .webexCodecPlusBold: return "\u{fc10}"
        case .webexCodecPlusLight: return "\u{fc11}"
        case .webexCodecPlusRegular: return "\u{fc12}"
        case .webexDeskCameraBold: return "\u{fc13}"
        case .webexDeskCameraLight: return "\u{fc14}"
        case .webexDeskCameraRegular: return "\u{fc15}"
        case .webexMeetingsBold: return "\u{fc16}"
        case .webexMeetingsFilled: return "\u{fc17}"
        case .webexMeetingsLight: return "\u{fc18}"
        case .webexMeetingsRegular: return "\u{fc19}"
        case .webexQuadCameraBold: return "\u{fc1a}"
        case .webexQuadCameraLight: return "\u{fc1b}"
        case .webexQuadCameraRegular: return "\u{fc1c}"
        case .webexRoomKitBold: return "\u{fc1d}"
        case .webexRoomKitLight: return "\u{fc1e}"
        case .webexRoomKitPlusBold: return "\u{fc1f}"
        case .webexRoomKitPlusLight: return "\u{fc20}"
        case .webexRoomKitPlusRegular: return "\u{fc21}"
        case .webexRoomKitRegular: return "\u{fc22}"
        case .webexShareBold: return "\u{fc23}"
        case .webexShareLight: return "\u{fc24}"
        case .webexShareRegular: return "\u{fc25}"
        case .webexTeamsBold: return "\u{fc26}"
        case .webexTeamsFilled: return "\u{fc27}"
        case .webexTeamsLight: return "\u{fc28}"
        case .webexTeamsNewBold: return "\u{fc29}"
        case .webexTeamsNewFilled: return "\u{fc2a}"
        case .webexTeamsNewLight: return "\u{fc2b}"
        case .webexTeamsNewRegular: return "\u{fc2c}"
        case .webexTeamsRegular: return "\u{fc2d}"
        case .webexTeamsRemoveBold: return "\u{fc2e}"
        case .webexTeamsRemoveLight: return "\u{fc2f}"
        case .webexTeamsRemoveRegular: return "\u{fc30}"
        case .webinarBold: return "\u{fc31}"
        case .webinarFilled: return "\u{fc32}"
        case .webinarLight: return "\u{fc33}"
        case .webinarRegular: return "\u{fc34}"
        case .weeklyRecurringScheduleBold: return "\u{fc35}"
        case .weeklyRecurringScheduleLight: return "\u{fc36}"
        case .weeklyRecurringScheduleRegular: return "\u{fc37}"
        case .whisperAnnouncementBold: return "\u{fc38}"
        case .whisperAnnouncementFilled: return "\u{fc39}"
        case .whisperAnnouncementLight: return "\u{fc3a}"
        case .whisperAnnouncementRegular: return "\u{fc3b}"
        case .whisperCoachBold: return "\u{fc3c}"
        case .whisperCoachFilled: return "\u{fc3d}"
        case .whisperCoachLight: return "\u{fc3e}"
        case .whisperCoachRegular: return "\u{fc3f}"
        case .whiteboardBold: return "\u{fc40}"
        case .whiteboardContentBold: return "\u{fc41}"
        case .whiteboardContentFilled: return "\u{fc42}"
        case .whiteboardContentLight: return "\u{fc43}"
        case .whiteboardContentRegular: return "\u{fc44}"
        case .whiteboardFilled: return "\u{fc45}"
        case .whiteboardLight: return "\u{fc46}"
        case .whiteboardRegular: return "\u{fc47}"
        case .widgetBold: return "\u{fc48}"
        case .widgetFilled: return "\u{fc49}"
        case .widgetLight: return "\u{fc4a}"
        case .widgetRegular: return "\u{fc4b}"
        case .wifiBold: return "\u{fc4c}"
        case .wifiErrorBold: return "\u{fc4d}"
        case .wifiErrorLight: return "\u{fc4e}"
        case .wifiErrorRegular: return "\u{fc4f}"
        case .wifiLight: return "\u{fc50}"
        case .wifiRegular: return "\u{fc51}"
        case .wifiSignalGoodBold: return "\u{fc52}"
        case .wifiSignalGoodLight: return "\u{fc53}"
        case .wifiSignalGoodRegular: return "\u{fc54}"
        case .wifiSignalPoorBold: return "\u{fc55}"
        case .wifiSignalPoorLight: return "\u{fc56}"
        case .wifiSignalPoorRegular: return "\u{fc57}"
        case .wifiSignalUnstableBold: return "\u{fc58}"
        case .wifiSignalUnstableLight: return "\u{fc59}"
        case .wifiSignalUnstableRegular: return "\u{fc5a}"
        case .windowCornerScrubBold: return "\u{fc5b}"
        case .windowCornerScrubLight: return "\u{fc5c}"
        case .windowCornerScrubRegular: return "\u{fc5d}"
        case .windowRightCornerScrubBold: return "\u{fc5e}"
        case .windowRightCornerScrubLight: return "\u{fc5f}"
        case .windowRightCornerScrubRegular: return "\u{fc60}"
        case .windowVerticalScrubBold: return "\u{fc61}"
        case .windowVerticalScrubLight: return "\u{fc62}"
        case .windowVerticalScrubRegular: return "\u{fc63}"
        case .workflowDeploymentsBold: return "\u{fc64}"
        case .workflowDeploymentsFilled: return "\u{fc65}"
        case .workflowDeploymentsLight: return "\u{fc66}"
        case .workflowDeploymentsRegular: return "\u{fc67}"
        case .workphoneBold: return "\u{fc68}"
        case .workphoneLight: return "\u{fc69}"
        case .workphoneRegular: return "\u{fc6a}"
        case .zoomInBold: return "\u{fc6b}"
        case .zoomInLight: return "\u{fc6c}"
        case .zoomInRegular: return "\u{fc6d}"
        case .zoomOutBold: return "\u{fc6e}"
        case .zoomOutLight: return "\u{fc6f}"
        case .zoomOutRegular: return "\u{fc70}"
