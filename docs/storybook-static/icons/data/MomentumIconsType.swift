...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .mediaPlayerBold: return "\u{f766}"
        case .mediaPlayerLight: return "\u{f767}"
        case .mediaPlayerRegular: return "\u{f768}"
        case .mediaQualityGoodBold: return "\u{f769}"
        case .mediaQualityGoodFilled: return "\u{f76a}"
        case .mediaQualityGoodLight: return "\u{f76b}"
        case .mediaQualityGoodRegular: return "\u{f76c}"
        case .mediaQualityPoorBold: return "\u{f76d}"
        case .mediaQualityPoorColoredBold: return "\u{f76e}"
        case .mediaQualityPoorFilled: return "\u{f76f}"
        case .mediaQualityPoorLight: return "\u{f770}"
        case .mediaQualityPoorRegular: return "\u{f771}"
        case .mediaQualityUnstableBold: return "\u{f772}"
        case .mediaQualityUnstableColoredBold: return "\u{f773}"
        case .mediaQualityUnstableFilled: return "\u{f774}"
        case .mediaQualityUnstableLight: return "\u{f775}"
        case .mediaQualityUnstableRegular: return "\u{f776}"
        case .meetBold: return "\u{f777}"
        case .meetEndBold: return "\u{f778}"
        case .meetEndLight: return "\u{f779}"
        case .meetEndRegular: return "\u{f77a}"
        case .meetFilled: return "\u{f77b}"
        case .meetLight: return "\u{f77c}"
        case .meetRegular: return "\u{f77d}"
        case .meetingSummaryBold: return "\u{f77e}"
        case .meetingSummaryFilled: return "\u{f77f}"
        case .meetingSummaryLight: return "\u{f780}"
        case .meetingSummaryRegular: return "\u{f781}"
        case .meetingsBold: return "\u{f782}"
        case .meetingsFilled: return "\u{f783}"
        case .meetingsFocusMonthBold: return "\u{f784}"
        case .meetingsFocusMonthLight: return "\u{f785}"
        case .meetingsFocusMonthRegular: return "\u{f786}"
        case .meetingsFocusOneDayBold: return "\u{f787}"
        case .meetingsFocusOneDayLight: return "\u{f788}"
        case .meetingsFocusOneDayRegular: return "\u{f789}"
        case .meetingsFocusThreeDayBold: return "\u{f78a}"
        case .meetingsFocusThreeDayLight: return "\u{f78b}"
        case .meetingsFocusThreeDayRegular: return "\u{f78c}"
        case .meetingsFocusUpcomingBold: return "\u{f78d}"
        case .meetingsFocusUpcomingLight: return "\u{f78e}"
        case .meetingsFocusUpcomingRegular: return "\u{f78f}"
        case .meetingsLight: return "\u{f790}"
        case .meetingsPresenceBadgeFilled: return "\u{f791}"
        case .meetingsPresenceBold: return "\u{f792}"
        case .meetingsPresenceFilled: return "\u{f793}"
        case .meetingsPresenceLight: return "\u{f794}"
        case .meetingsPresenceRegular: return "\u{f795}"
        case .meetingsRegular: return "\u{f796}"
        case .meetingsTeamBold: return "\u{f797}"
        case .meetingsTeamFilled: return "\u{f798}"
        case .meetingsTeamLight: return "\u{f799}"
        case .meetingsTeamNewBold: return "\u{f79a}"
        case .meetingsTeamNewLight: return "\u{f79b}"
        case .meetingsTeamNewRegular: return "\u{f79c}"
        case .meetingsTeamRegular: return "\u{f79d}"
        case .mentionBold: return "\u{f79e}"
        case .mentionFilled: return "\u{f79f}"
        case .mentionLight: return "\u{f7a0}"
        case .mentionRegular: return "\u{f7a1}"
        case .messageQueingBold: return "\u{f7a2}"
        case .messageQueingLight: return "\u{f7a3}"
        case .messageQueingRegular: return "\u{f7a4}"
        case .microphoneBold: return "\u{f7a5}"
        case .microphoneFilled: return "\u{f7a6}"
        case .microphoneHardMutedBold: return "\u{f7a7}"
        case .microphoneHardMutedCircleFilled: return "\u{f7a8}"
        case .microphoneHardMutedLight: return "\u{f7a9}"
        case .microphoneHardMutedRegular: return "\u{f7aa}"
        case .microphoneLight: return "\u{f7ab}"
        case .microphoneMusicModeBold: return "\u{f7ac}"
        case .microphoneMusicModeLight: return "\u{f7ad}"
        case .microphoneMusicModeOnBold: return "\u{f7ae}"
        case .microphoneMusicModeOnLight: return "\u{f7af}"
        case .microphoneMusicModeOnRegular: return "\u{f7b0}"
        case .microphoneMusicModeRegular: return "\u{f7b1}"
        case .microphoneMutedBold: return "\u{f7b2}"
        case .microphoneMutedCircleFilled: return "\u{f7b3}"
        case .microphoneMutedFilled: return "\u{f7b4}"
        case .microphoneMutedLight: return "\u{f7b5}"
        case .microphoneMutedRegular: return "\u{f7b6}"
        case .microphoneOnBold: return "\u{f7b7}"
        case .microphoneOnLight: return "\u{f7b8}"
        case .microphoneOnRegular: return "\u{f7b9}"
        case .microphoneOptAllBold: return "\u{f7ba}"
        case .microphoneOptAllLight: return "\u{f7bb}"
        case .microphoneOptAllMutedBold: return "\u{f7bc}"
        case .microphoneOptAllMutedLight: return "\u{f7bd}"
        case .microphoneOptAllMutedRegular: return "\u{f7be}"
        case .microphoneOptAllOnBold: return "\u{f7bf}"
        case .microphoneOptAllOnLight: return "\u{f7c0}"
        case .microphoneOptAllOnRegular: return "\u{f7c1}"
        case .microphoneOptAllRegular: return "\u{f7c2}"
        case .microphoneOptMeBold: return "\u{f7c3}"
        case .microphoneOptMeLight: return "\u{f7c4}"
        case .microphoneOptMeMutedBold: return "\u{f7c5}"
        case .microphoneOptMeMutedLight: return "\u{f7c6}"
        case .microphoneOptMeMutedRegular: return "\u{f7c7}"
        case .microphoneOptMeOnBold: return "\u{f7c8}"
        case .microphoneOptMeOnLight: return "\u{f7c9}"
        case .microphoneOptMeOnRegular: return "\u{f7ca}"
        case .microphoneOptMeRegular: return "\u{f7cb}"
        case .microphoneRegular: return "\u{f7cc}"
        case .mindMapBold: return "\u{f7cd}"
        case .mindMapLight: return "\u{f7ce}"
        case .mindMapRegular: return "\u{f7cf}"
        case .minimizeBold: return "\u{f7d0}"
        case .minimizeLight: return "\u{f7d1}"
        case .minimizeRegular: return "\u{f7d2}"
        case .minusBold: return "\u{f7d3}"
        case .minusFilled: return "\u{f7d4}"
        case .minusLight: return "\u{f7d5}"
        case .minusRegular: return "\u{f7d6}"
        case .mirrorBold: return "\u{f7d7}"
        case .mirrorFilled: return "\u{f7d8}"
        case .mirrorLight: return "\u{f7d9}"
        case .mirrorRegular: return "\u{f7da}"
        case .mmsFilled: return "\u{f7db}"
        case .moderatorBold: return "\u{f7dc}"
        case .moderatorLight: return "\u{f7dd}"
        case .moderatorRegular: return "\u{f7de}"
        case .monitoringBold: return "\u{f7df}"
        case .monitoringLight: return "\u{f7e0}"
        case .monitoringRegular: return "\u{f7e1}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7e2}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7e3}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7e4}"
        case .moreAdrBold: return "\u{f7e5}"
        case .moreAdrLight: return "\u{f7e6}"
        case .moreAdrRegular: return "\u{f7e7}"
        case .moreBold: return "\u{f7e8}"
        case .moreCircleBold: return "\u{f7e9}"
        case .moreCircleFilled: return "\u{f7ea}"
        case .moreCircleLight: return "\u{f7eb}"
        case .moreCircleRegular: return "\u{f7ec}"
        case .moreLight: return "\u{f7ed}"
        case .moreRegular: return "\u{f7ee}"
        case .mouseCursorBold: return "\u{f7ef}"
        case .mouseCursorLight: return "\u{f7f0}"
        case .mouseCursorRegular: return "\u{f7f1}"
        case .moveCallInAdrBold: return "\u{f7f2}"
        case .moveCallInAdrLight: return "\u{f7f3}"
        case .moveCallInAdrRegular: return "\u{f7f4}"
        case .moveCallInIphBold: return "\u{f7f5}"
        case .moveCallInIphLight: return "\u{f7f6}"
        case .moveCallInIphRegular: return "\u{f7f7}"
        case .moveCallInLaptopBold: return "\u{f7f8}"
        case .moveCallInLaptopLight: return "\u{f7f9}"
        case .moveCallInLaptopRegular: return "\u{f7fa}"
        case .moveCallInOutAdrBold: return "\u{f7fb}"
        case .moveCallInOutAdrLight: return "\u{f7fc}"
        case .moveCallInOutAdrRegular: return "\u{f7fd}"
        case .moveCallInOutIphBold: return "\u{f7fe}"
        case .moveCallInOutIphLight: return "\u{f7ff}"
        case .moveCallInOutIphRegular: return "\u{f800}"
        case .moveCallInTabletBold: return "\u{f801}"
        case .moveCallInTabletLight: return "\u{f802}"
        case .moveCallInTabletRegular: return "\u{f803}"
        case .moveCallOutAdrBold: return "\u{f804}"
        case .moveCallOutAdrLight: return "\u{f805}"
        case .moveCallOutAdrRegular: return "\u{f806}"
        case .moveCallOutIphBold: return "\u{f807}"
        case .moveCallOutIphLight: return "\u{f808}"
        case .moveCallOutIphRegular: return "\u{f809}"
        case .moveCallOutLaptopBold: return "\u{f80a}"
        case .moveCallOutLaptopLight: return "\u{f80b}"
        case .moveCallOutLaptopRegular: return "\u{f80c}"
        case .moveCallOutTabletBold: return "\u{f80d}"
        case .moveCallOutTabletLight: return "\u{f80e}"
        case .moveCallOutTabletRegular: return "\u{f80f}"
        case .moveToScreenBold: return "\u{f810}"
        case .moveToScreenLight: return "\u{f811}"
        case .moveToScreenRegular: return "\u{f812}"
        case .multilineChartBold: return "\u{f813}"
        case .multilineChartFilled: return "\u{f814}"
        case .multilineChartLight: return "\u{f815}"
        case .multilineChartRegular: return "\u{f816}"
        case .multimediaBold: return "\u{f817}"
        case .multimediaFilled: return "\u{f818}"
        case .multimediaLight: return "\u{f819}"
        case .multimediaRegular: return "\u{f81a}"
        case .multipledDevicesBold: return "\u{f81b}"
        case .multipledDevicesLight: return "\u{f81c}"
        case .multipledDevicesRegular: return "\u{f81d}"
        case .musicModeCircleBold: return "\u{f81e}"
        case .musicModeCircleFilled: return "\u{f81f}"
        case .musicModeCircleLight: return "\u{f820}"
        case .musicModeCircleRegular: return "\u{f821}"
        case .musicNoteBold: return "\u{f822}"
        case .musicNoteFilled: return "\u{f823}"
        case .musicNoteLight: return "\u{f824}"
        case .musicNoteRegular: return "\u{f825}"
        case .muteOnEntryBold: return "\u{f826}"
        case .muteOnEntryFilled: return "\u{f827}"
        case .muteOnEntryLight: return "\u{f828}"
        case .muteOnEntryRegular: return "\u{f829}"
        case .networkSwitchBold: return "\u{f82a}"
        case .networkSwitchFilled: return "\u{f82b}"
        case .networkSwitchLight: return "\u{f82c}"
        case .networkSwitchRegular: return "\u{f82d}"
        case .newManagerBold: return "\u{f82e}"
        case .newManagerFilled: return "\u{f82f}"
        case .newManagerLight: return "\u{f830}"
        case .newManagerRegular: return "\u{f831}"
        case .newTitleBold: return "\u{f832}"
        case .newTitleLight: return "\u{f833}"
        case .newTitleRegular: return "\u{f834}"
        case .newVoicemailBold: return "\u{f835}"
        case .newVoicemailLight: return "\u{f836}"
        case .newVoicemailRegular: return "\u{f837}"
        case .newWhiteboardBold: return "\u{f838}"
        case .newWhiteboardLight: return "\u{f839}"
        case .newWhiteboardRegular: return "\u{f83a}"
        case .nextBold: return "\u{f83b}"
        case .nextLight: return "\u{f83c}"
        case .nextRegular: return "\u{f83d}"
        case .noDevicesBold: return "\u{f83e}"
        case .noDevicesLight: return "\u{f83f}"
        case .noDevicesRegular: return "\u{f840}"
        case .noiseDetectedCanceledFilled: return "\u{f841}"
        case .noiseDetectedFilled: return "\u{f842}"
        case .noiseNoneCanceledFilled: return "\u{f843}"
        case .noiseNoneFilled: return "\u{f844}"
        case .noiseRemovalBold: return "\u{f845}"
        case .noiseRemovalLight: return "\u{f846}"
        case .noiseRemovalRegular: return "\u{f847}"
        case .noteBold: return "\u{f848}"
        case .noteFilled: return "\u{f849}"
        case .noteLight: return "\u{f84a}"
        case .notePptBold: return "\u{f84b}"
        case .notePptLight: return "\u{f84c}"
        case .notePptRegular: return "\u{f84d}"
        case .noteRegular: return "\u{f84e}"
        case .notesBold: return "\u{f84f}"
        case .notesFilled: return "\u{f850}"
        case .notesLight: return "\u{f851}"
        case .notesRegular: return "\u{f852}"
        case .numberBold: return "\u{f853}"
        case .numberLight: return "\u{f854}"
        case .numberRegular: return "\u{f855}"
        case .oldRemoteBold: return "\u{f856}"
        case .oldRemoteLight: return "\u{f857}"
        case .oldRemoteRegular: return "\u{f858}"
        case .oldTouchBold: return "\u{f859}"
        case .oldTouchLight: return "\u{f85a}"
        case .oldTouchRegular: return "\u{f85b}"
        case .oneColumnBold: return "\u{f85c}"
        case .oneColumnLight: return "\u{f85d}"
        case .oneColumnRegular: return "\u{f85e}"
        case .oneTimeBold: return "\u{f85f}"
        case .oneTimeLight: return "\u{f860}"
        case .oneTimeRegular: return "\u{f861}"
        case .openInFolderBold: return "\u{f862}"
        case .openInFolderFilled: return "\u{f863}"
        case .openInFolderLight: return "\u{f864}"
        case .openInFolderRegular: return "\u{f865}"
        case .openPagesBold: return "\u{f866}"
        case .openPagesLight: return "\u{f867}"
        case .openPagesRegular: return "\u{f868}"
        case .otherNumberBold: return "\u{f869}"
        case .otherNumberFilled: return "\u{f86a}"
        case .otherNumberLight: return "\u{f86b}"
        case .otherNumberRegular: return "\u{f86c}"
        case .otherNumberWarningBold: return "\u{f86d}"
        case .otherNumberWarningLight: return "\u{f86e}"
        case .otherNumberWarningRegular: return "\u{f86f}"
        case .outgoingCallLegacyBold: return "\u{f870}"
        case .outgoingCallLegacyFilled: return "\u{f871}"
        case .outgoingCallLegacyLight: return "\u{f872}"
        case .outgoingCallLegacyRegular: return "\u{f873}"
        case .overflowLeftBold: return "\u{f874}"
        case .overflowLeftLight: return "\u{f875}"
        case .overflowLeftRegular: return "\u{f876}"
        case .overflowRightBold: return "\u{f877}"
        case .overflowRightLight: return "\u{f878}"
        case .overflowRightRegular: return "\u{f879}"
        case .pairedCameraBold: return "\u{f87a}"
        case .pairedCameraLight: return "\u{f87b}"
        case .pairedCameraRegular: return "\u{f87c}"
        case .pairedDeviceBold: return "\u{f87d}"
        case .pairedDeviceLight: return "\u{f87e}"
        case .pairedDeviceRegular: return "\u{f87f}"
        case .pairedHandsetBold: return "\u{f880}"
        case .pairedHandsetLight: return "\u{f881}"
        case .pairedHandsetRegular: return "\u{f882}"
        case .pairingBold: return "\u{f883}"
        case .pairingLight: return "\u{f884}"
        case .pairingRegular: return "\u{f885}"
        case .parenthesisBold: return "\u{f886}"
        case .parenthesisFilled: return "\u{f887}"
        case .parenthesisLight: return "\u{f888}"
        case .parenthesisRegular: return "\u{f889}"
        case .parkedBold: return "\u{f88a}"
        case .parkedFilled: return "\u{f88b}"
        case .parkedLight: return "\u{f88c}"
        case .parkedRegular: return "\u{f88d}"
        case .parseBold: return "\u{f88e}"
        case .parseLight: return "\u{f88f}"
        case .parseRegular: return "\u{f890}"
        case .partialBold: return "\u{f891}"
        case .partialLight: return "\u{f892}"
        case .partialRegular: return "\u{f893}"
        case .participantAddBold: return "\u{f894}"
        case .participantAddLight: return "\u{f895}"
        case .participantAddRegular: return "\u{f896}"
        case .participantBlockedBold: return "\u{f897}"
        case .participantBlockedLight: return "\u{f898}"
        case .participantBlockedRegular: return "\u{f899}"
        case .participantBold: return "\u{f89a}"
        case .participantFilled: return "\u{f89b}"
        case .participantLight: return "\u{f89c}"
        case .participantListBold: return "\u{f89d}"
        case .participantListFilled: return "\u{f89e}"
        case .participantListLight: return "\u{f89f}"
        case .participantListRegular: return "\u{f8a0}"
        case .participantRegular: return "\u{f8a1}"
        case .participantRemoveBold: return "\u{f8a2}"
        case .participantRemoveLight: return "\u{f8a3}"
        case .participantRemoveRegular: return "\u{f8a4}"
        case .participantUnknownBold: return "\u{f8a5}"
        case .participantUnknownLight: return "\u{f8a6}"
        case .participantUnknownRegular: return "\u{f8a7}"
        case .passMouseBold: return "\u{f8a8}"
        case .passMouseLight: return "\u{f8a9}"
        case .passMouseRegular: return "\u{f8aa}"
        case .pauseBadgeFilled: return "\u{f8ab}"
        case .pauseBold: return "\u{f8ac}"
        case .pauseFilled: return "\u{f8ad}"
        case .pauseInteractionBold: return "\u{f8ae}"
        case .pauseInteractionFilled: return "\u{f8af}"
        case .pauseInteractionLight: return "\u{f8b0}"
        case .pauseInteractionRegular: return "\u{f8b1}"
        case .pauseLight: return "\u{f8b2}"
        case .pauseRegular: return "\u{f8b3}"
        case .peopleAddBold: return "\u{f8b4}"
        case .peopleAddFilled: return "\u{f8b5}"
        case .peopleAddLight: return "\u{f8b6}"
        case .peopleAddRegular: return "\u{f8b7}"
        case .peopleBold: return "\u{f8b8}"
        case .peopleCircleBold: return "\u{f8b9}"
        case .peopleCircleFilled: return "\u{f8ba}"
        case .peopleCircleLight: return "\u{f8bb}"
        case .peopleCircleRegular: return "\u{f8bc}"
        case .peopleFilled: return "\u{f8bd}"
        case .peopleInsightsBold: return "\u{f8be}"
        case .peopleInsightsFilled: return "\u{f8bf}"
        case .peopleInsightsLight: return "\u{f8c0}"
        case .peopleInsightsRegular: return "\u{f8c1}"
        case .peopleLight: return "\u{f8c2}"
        case .peopleManageBold: return "\u{f8c3}"
        case .peopleManageFilled: return "\u{f8c4}"
        case .peopleManageLight: return "\u{f8c5}"
        case .peopleManageRegular: return "\u{f8c6}"
        case .peopleRegular: return "\u{f8c7}"
        case .phoneAlertBold: return "\u{f8c8}"
        case .phoneAlertLight: return "\u{f8c9}"
        case .phoneAlertRegular: return "\u{f8ca}"
        case .phoneBadgeFilled: return "\u{f8cb}"
        case .phoneBold: return "\u{f8cc}"
        case .phoneFilled: return "\u{f8cd}"
        case .phoneLight: return "\u{f8ce}"
        case .phoneMutedBold: return "\u{f8cf}"
        case .phoneMutedLight: return "\u{f8d0}"
        case .phoneMutedRegular: return "\u{f8d1}"
        case .phonePrivateBold: return "\u{f8d2}"
        case .phonePrivateLight: return "\u{f8d3}"
        case .phonePrivateRegular: return "\u{f8d4}"
        case .phoneRegular: return "\u{f8d5}"
        case .phoneReplyAllBold: return "\u{f8d6}"
        case .phoneReplyAllLight: return "\u{f8d7}"
        case .phoneReplyAllRegular: return "\u{f8d8}"
        case .phoneReplyBold: return "\u{f8d9}"
        case .phoneReplyLight: return "\u{f8da}"
        case .phoneReplyRegular: return "\u{f8db}"
        case .pickerBold: return "\u{f8dc}"
        case .pickerLight: return "\u{f8dd}"
        case .pickerRegular: return "\u{f8de}"
        case .pieChartBold: return "\u{f8df}"
        case .pieChartFilled: return "\u{f8e0}"
        case .pieChartLight: return "\u{f8e1}"
        case .pieChartRegular: return "\u{f8e2}"
        case .pinBold: return "\u{f8e3}"
        case .pinFilled: return "\u{f8e4}"
        case .pinLight: return "\u{f8e5}"
        case .pinListActivityBold: return "\u{f8e6}"
        case .pinListActivityLight: return "\u{f8e7}"
        case .pinListActivityRegular: return "\u{f8e8}"
        case .pinListBold: return "\u{f8e9}"
        case .pinListLight: return "\u{f8ea}"
        case .pinListRegular: return "\u{f8eb}"
        case .pinMutedBold: return "\u{f8ec}"
        case .pinMutedFilled: return "\u{f8ed}"
        case .pinMutedLight: return "\u{f8ee}"
        case .pinMutedRegular: return "\u{f8ef}"
        case .pinRegular: return "\u{f8f0}"
        case .pipBold: return "\u{f8f1}"
        case .pipEnterBold: return "\u{f8f2}"
        case .pipEnterLight: return "\u{f8f3}"
        case .pipEnterRegular: return "\u{f8f4}"
        case .pipExitBold: return "\u{f8f5}"
        case .pipExitLight: return "\u{f8f6}"
        case .pipExitRegular: return "\u{f8f7}"
        case .pipFilled: return "\u{f8f8}"
        case .pipLight: return "\u{f8f9}"
        case .pipRegular: return "\u{f8fa}"
        case .placeholderBold: return "\u{f8fb}"
        case .placeholderFilled: return "\u{f8fc}"
        case .placeholderLight: return "\u{f8fd}"
        case .placeholderRegular: return "\u{f8fe}"
        case .playBold: return "\u{f8ff}"
        case .playCircleBold: return "\u{f900}"
        case .playCircleFilled: return "\u{f901}"
        case .playCircleLight: return "\u{f902}"
        case .playCircleRegular: return "\u{f903}"
        case .playFilled: return "\u{f904}"
        case .playLight: return "\u{f905}"
        case .playRegular: return "\u{f906}"
        case .plugAcBold: return "\u{f907}"
        case .plugAcLight: return "\u{f908}"
        case .plugAcRegular: return "\u{f909}"
        case .plusBold: return "\u{f90a}"
        case .plusCircleBold: return "\u{f90b}"
        case .plusCircleFilled: return "\u{f90c}"
        case .plusCircleLight: return "\u{f90d}"
        case .plusCircleRegular: return "\u{f90e}"
        case .plusLight: return "\u{f90f}"
        case .plusRegular: return "\u{f910}"
        case .pmrBold: return "\u{f911}"
        case .pmrFilled: return "\u{f912}"
        case .pmrLight: return "\u{f913}"
        case .pmrRegular: return "\u{f914}"
        case .pollBold: return "\u{f915}"
        case .pollFilled: return "\u{f916}"
        case .pollLight: return "\u{f917}"
        case .pollRegular: return "\u{f918}"
        case .popInBold: return "\u{f919}"
        case .popInLight: return "\u{f91a}"
        case .popInRegular: return "\u{f91b}"
        case .popOutBold: return "\u{f91c}"
        case .popOutLight: return "\u{f91d}"
        case .popOutRegular: return "\u{f91e}"
        case .popUpBold: return "\u{f91f}"
        case .popUpLight: return "\u{f920}"
        case .popUpRegular: return "\u{f921}"
        case .portraitLandscapeBold: return "\u{f922}"
        case .portraitLandscapeLight: return "\u{f923}"
        case .portraitLandscapeRegular: return "\u{f924}"
        case .potentialFraudBold: return "\u{f925}"
        case .potentialFraudFilled: return "\u{f926}"
        case .potentialFraudLight: return "\u{f927}"
        case .potentialFraudRegular: return "\u{f928}"
        case .powerAcBold: return "\u{f929}"
        case .powerAcLight: return "\u{f92a}"
        case .powerAcRegular: return "\u{f92b}"
        case .powerBold: return "\u{f92c}"
        case .powerLight: return "\u{f92d}"
        case .powerRegular: return "\u{f92e}"
        case .preHeaderBold: return "\u{f92f}"
        case .preHeaderLight: return "\u{f930}"
        case .preHeaderRegular: return "\u{f931}"
        case .premiumBold: return "\u{f932}"
        case .premiumLight: return "\u{f933}"
        case .premiumRegular: return "\u{f934}"
        case .presentationBold: return "\u{f935}"
        case .presentationLight: return "\u{f936}"
        case .presentationRegular: return "\u{f937}"
        case .preventDownloadBold: return "\u{f938}"
        case .preventDownloadFilled: return "\u{f939}"
        case .preventDownloadLight: return "\u{f93a}"
        case .preventDownloadRegular: return "\u{f93b}"
        case .primaryParticipantBold: return "\u{f93c}"
        case .primaryParticipantFilled: return "\u{f93d}"
        case .primaryParticipantLight: return "\u{f93e}"
        case .primaryParticipantRegular: return "\u{f93f}"
        case .printBold: return "\u{f940}"
        case .printLight: return "\u{f941}"
        case .printRegular: return "\u{f942}"
        case .priorityBadgeFilled: return "\u{f943}"
        case .priorityCircleBold: return "\u{f944}"
        case .priorityCircleFilled: return "\u{f945}"
        case .priorityCircleLight: return "\u{f946}"
        case .priorityCircleRegular: return "\u{f947}"
        case .priorityCircleTwoBold: return "\u{f948}"
        case .priorityCircleTwoFilled: return "\u{f949}"
        case .priorityCircleTwoLight: return "\u{f94a}"
        case .priorityCircleTwoRegular: return "\u{f94b}"
        case .priorityWaveBold: return "\u{f94c}"
        case .priorityWaveLight: return "\u{f94d}"
        case .priorityWaveRegular: return "\u{f94e}"
        case .privacyCircleBold: return "\u{f94f}"
        case .privacyCircleFilled: return "\u{f950}"
        case .privacyCircleLight: return "\u{f951}"
        case .privacyCircleRegular: return "\u{f952}"
        case .privateBold: return "\u{f953}"
        case .privateCircleBold: return "\u{f954}"
        case .privateCircleFilled: return "\u{f955}"
        case .privateCircleLight: return "\u{f956}"
        case .privateCircleRegular: return "\u{f957}"
        case .privateLight: return "\u{f958}"
        case .privateMeetingBold: return "\u{f959}"
        case .privateMeetingLight: return "\u{f95a}"
        case .privateMeetingRegular: return "\u{f95b}"
        case .privateRegular: return "\u{f95c}"
        case .productDemoBold: return "\u{f95d}"
        case .productDemoLight: return "\u{f95e}"
        case .productDemoRegular: return "\u{f95f}"
        case .promptsAiBold: return "\u{f960}"
        case .promptsAiLight: return "\u{f961}"
        case .promptsAiRegular: return "\u{f962}"
        case .proximityBold: return "\u{f963}"
        case .proximityLight: return "\u{f964}"
        case .proximityMutedBold: return "\u{f965}"
        case .proximityMutedLight: return "\u{f966}"
        case .proximityMutedRegular: return "\u{f967}"
        case .proximityRegular: return "\u{f968}"
        case .proximityVideoBold: return "\u{f969}"
        case .proximityVideoLight: return "\u{f96a}"
        case .proximityVideoRegular: return "\u{f96b}"
        case .ptoPresenceBold: return "\u{f96c}"
        case .ptoPresenceFilled: return "\u{f96d}"
        case .ptoPresenceLight: return "\u{f96e}"
        case .ptoPresenceRegular: return "\u{f96f}"
        case .pullCallBold: return "\u{f970}"
        case .pullCallFilled: return "\u{f971}"
        case .pullCallLight: return "\u{f972}"
        case .pullCallRegular: return "\u{f973}"
        case .purchaseOrderBold: return "\u{f974}"
        case .purchaseOrderFilled: return "\u{f975}"
        case .purchaseOrderLight: return "\u{f976}"
        case .purchaseOrderRegular: return "\u{f977}"
        case .qABold: return "\u{f978}"
        case .qAFilled: return "\u{f979}"
        case .qALight: return "\u{f97a}"
        case .qARegular: return "\u{f97b}"
        case .qrCodeBold: return "\u{f97c}"
        case .qrCodeLight: return "\u{f97d}"
        case .qrCodeRegular: return "\u{f97e}"
        case .qrCodeScanBold: return "\u{f97f}"
        case .qrCodeScanLight: return "\u{f980}"
        case .qrCodeScanRegular: return "\u{f981}"
        case .qualityBold: return "\u{f982}"
        case .qualityLight: return "\u{f983}"
        case .qualityRegular: return "\u{f984}"
        case .queueContactBold: return "\u{f985}"
        case .queueContactFilled: return "\u{f986}"
        case .queueContactLight: return "\u{f987}"
        case .queueContactRegular: return "\u{f988}"
        case .queuedInteractionBold: return "\u{f989}"
        case .queuedInteractionFilled: return "\u{f98a}"
        case .queuedInteractionLight: return "\u{f98b}"
        case .queuedInteractionRegular: return "\u{f98c}"
        case .quietBold: return "\u{f98d}"
        case .quietHoursPresenceBold: return "\u{f98e}"
        case .quietHoursPresenceFilled: return "\u{f98f}"
        case .quietHoursPresenceLight: return "\u{f990}"
        case .quietHoursPresenceRegular: return "\u{f991}"
        case .quietLight: return "\u{f992}"
        case .quietRegular: return "\u{f993}"
        case .radioButtonGroupBold: return "\u{f994}"
        case .radioButtonGroupLight: return "\u{f995}"
        case .radioButtonGroupRegular: return "\u{f996}"
        case .raiseHandBold: return "\u{f997}"
        case .raiseHandCircleFilled: return "\u{f998}"
        case .raiseHandFilled: return "\u{f999}"
        case .raiseHandLight: return "\u{f99a}"
        case .raiseHandRegular: return "\u{f99b}"
        case .ramBold: return "\u{f99c}"
        case .ramLight: return "\u{f99d}"
        case .ramRegular: return "\u{f99e}"
        case .reactionsBold: return "\u{f99f}"
        case .reactionsFilled: return "\u{f9a0}"
        case .reactionsLight: return "\u{f9a1}"
        case .reactionsRegular: return "\u{f9a2}"
        case .reactivateBold: return "\u{f9a3}"
        case .reactivateLight: return "\u{f9a4}"
        case .reactivateRegular: return "\u{f9a5}"
        case .receiveVoiceBold: return "\u{f9a6}"
        case .receiveVoiceFilled: return "\u{f9a7}"
        case .receiveVoiceLight: return "\u{f9a8}"
        case .receiveVoiceRegular: return "\u{f9a9}"
        case .recentsBold: return "\u{f9aa}"
        case .recentsFilled: return "\u{f9ab}"
        case .recentsLight: return "\u{f9ac}"
        case .recentsPresenceBadgeFilled: return "\u{f9ad}"
        case .recentsPresenceBold: return "\u{f9ae}"
        case .recentsPresenceFilled: return "\u{f9af}"
        case .recentsPresenceLight: return "\u{f9b0}"
        case .recentsPresenceRegular: return "\u{f9b1}"
        case .recentsRegular: return "\u{f9b2}"
        case .recordActiveBadgeFilled: return "\u{f9b3}"
        case .recordActiveBold: return "\u{f9b4}"
        case .recordActiveFilled: return "\u{f9b5}"
        case .recordActiveLight: return "\u{f9b6}"
        case .recordActiveRegular: return "\u{f9b7}"
        case .recordBold: return "\u{f9b8}"
        case .recordFilled: return "\u{f9b9}"
        case .recordLight: return "\u{f9ba}"
        case .recordPausedBadgeFilled: return "\u{f9bb}"
        case .recordPausedBold: return "\u{f9bc}"
        case .recordPausedFilled: return "\u{f9bd}"
        case .recordPausedLight: return "\u{f9be}"
        case .recordPausedRegular: return "\u{f9bf}"
        case .recordRegular: return "\u{f9c0}"
        case .recurringBold: return "\u{f9c1}"
        case .recurringLight: return "\u{f9c2}"
        case .recurringOffBold: return "\u{f9c3}"
        case .recurringOffLight: return "\u{f9c4}"
        case .recurringOffRegular: return "\u{f9c5}"
        case .recurringRegular: return "\u{f9c6}"
        case .redoBold: return "\u{f9c7}"
        case .redoLight: return "\u{f9c8}"
        case .redoRegular: return "\u{f9c9}"
        case .refreshBold: return "\u{f9ca}"
        case .refreshLight: return "\u{f9cb}"
        case .refreshRegular: return "\u{f9cc}"
        case .remoteDesktopControlBold: return "\u{f9cd}"
        case .remoteDesktopControlFilled: return "\u{f9ce}"
        case .remoteDesktopControlLight: return "\u{f9cf}"
        case .remoteDesktopControlRegular: return "\u{f9d0}"
        case .removeBold: return "\u{f9d1}"
        case .removeFilled: return "\u{f9d2}"
        case .removeLight: return "\u{f9d3}"
        case .removeRegular: return "\u{f9d4}"
        case .replyBold: return "\u{f9d5}"
        case .replyFilled: return "\u{f9d6}"
        case .replyLight: return "\u{f9d7}"
        case .replyListBold: return "\u{f9d8}"
        case .replyListFilled: return "\u{f9d9}"
        case .replyListLight: return "\u{f9da}"
        case .replyListRegular: return "\u{f9db}"
        case .replyPrivatelyBold: return "\u{f9dc}"
        case .replyPrivatelyLight: return "\u{f9dd}"
        case .replyPrivatelyRegular: return "\u{f9de}"
        case .replyRegular: return "\u{f9df}"
        case .resetBold: return "\u{f9e0}"
        case .resetLight: return "\u{f9e1}"
        case .resetRegular: return "\u{f9e2}"
        case .resizeCornerBold: return "\u{f9e3}"
        case .resizeCornerLight: return "\u{f9e4}"
        case .resizeCornerRegular: return "\u{f9e5}"
        case .responsiveMobileBold: return "\u{f9e6}"
        case .responsiveMobileLight: return "\u{f9e7}"
        case .responsiveMobileRegular: return "\u{f9e8}"
        case .restartBold: return "\u{f9e9}"
        case .restartLight: return "\u{f9ea}"
        case .restartRegular: return "\u{f9eb}"
        case .resumeInteractionBold: return "\u{f9ec}"
        case .resumeInteractionFilled: return "\u{f9ed}"
        case .resumeInteractionLight: return "\u{f9ee}"
        case .resumeInteractionRegular: return "\u{f9ef}"
        case .retrieveCallBold: return "\u{f9f0}"
        case .retrieveCallFilled: return "\u{f9f1}"
        case .retrieveCallLight: return "\u{f9f2}"
        case .retrieveCallRegular: return "\u{f9f3}"
        case .returnBold: return "\u{f9f4}"
        case .returnLight: return "\u{f9f5}"
        case .returnRegular: return "\u{f9f6}"
        case .rewindTenSecBold: return "\u{f9f7}"
        case .rewindTenSecLight: return "\u{f9f8}"
        case .rewindTenSecRegular: return "\u{f9f9}"
        case .ringtoneBold: return "\u{f9fa}"
        case .ringtoneLight: return "\u{f9fb}"
        case .ringtoneRegular: return "\u{f9fc}"
        case .roomCalendarBold: return "\u{f9fd}"
        case .roomCalendarLight: return "\u{f9fe}"
        case .roomCalendarRegular: return "\u{f9ff}"
        case .roomLightsBold: return "\u{fa00}"
        case .roomLightsFilled: return "\u{fa01}"
        case .roomLightsLight: return "\u{fa02}"
        case .roomLightsRegular: return "\u{fa03}"
        case .rotateContentBold: return "\u{fa04}"
        case .rotateContentFilled: return "\u{fa05}"
        case .rotateContentLight: return "\u{fa06}"
        case .rotateContentRegular: return "\u{fa07}"
        case .rssBold: return "\u{fa08}"
        case .rssFilled: return "\u{fa09}"
        case .rssLight: return "\u{fa0a}"
        case .rssRegular: return "\u{fa0b}"
        case .ruleBasedBold: return "\u{fa0c}"
        case .ruleBasedLight: return "\u{fa0d}"
        case .ruleBasedRegular: return "\u{fa0e}"
        case .rulerBold: return "\u{fa0f}"
        case .rulerFilled: return "\u{fa10}"
        case .rulerLight: return "\u{fa11}"
        case .rulerRegular: return "\u{fa12}"
        case .runningApplicationBold: return "\u{fa13}"
        case .runningApplicationFilled: return "\u{fa14}"
        case .runningApplicationLight: return "\u{fa15}"
        case .runningApplicationRegular: return "\u{fa16}"
        case .saveBold: return "\u{fa17}"
        case .saveLight: return "\u{fa18}"
        case .saveRegular: return "\u{fa19}"
        case .saveTranscriptBold: return "\u{fa1a}"
        case .saveTranscriptFilled: return "\u{fa1b}"
        case .saveTranscriptLight: return "\u{fa1c}"
        case .saveTranscriptRegular: return "\u{fa1d}"
        case .scanBold: return "\u{fa1e}"
        case .scanLight: return "\u{fa1f}"
        case .scanRegular: return "\u{fa20}"
        case .scheduleAiBold: return "\u{fa21}"
        case .scheduleAiLight: return "\u{fa22}"
        case .scheduleAiRegular: return "\u{fa23}"
        case .scheduleSendBold: return "\u{fa24}"
        case .scheduleSendFilled: return "\u{fa25}"
        case .scheduleSendLight: return "\u{fa26}"
        case .scheduleSendRegular: return "\u{fa27}"
        case .scheduleWinnerBold: return "\u{fa28}"
        case .scheduleWinnerFilled: return "\u{fa29}"
        case .scheduleWinnerLight: return "\u{fa2a}"
        case .scheduleWinnerRegular: return "\u{fa2b}"
        case .schedulerAvailableBold: return "\u{fa2c}"
        case .schedulerAvailableLight: return "\u{fa2d}"
        case .schedulerAvailableRegular: return "\u{fa2e}"
        case .schedulerNotWorkingHoursBold: return "\u{fa2f}"
        case .schedulerNotWorkingHoursLight: return "\u{fa30}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa31}"
        case .schedulerUnavailableBold: return "\u{fa32}"
        case .schedulerUnavailableLight: return "\u{fa33}"
        case .schedulerUnavailableRegular: return "\u{fa34}"
        case .schedulerUnknownBold: return "\u{fa35}"
        case .schedulerUnknownLight: return "\u{fa36}"
        case .schedulerUnknownRegular: return "\u{fa37}"
        case .screenshotBold: return "\u{fa38}"
        case .screenshotDocBold: return "\u{fa39}"
        case .screenshotDocFilled: return "\u{fa3a}"
        case .screenshotDocLight: return "\u{fa3b}"
        case .screenshotDocRegular: return "\u{fa3c}"
        case .screenshotLight: return "\u{fa3d}"
        case .screenshotRegular: return "\u{fa3e}"
        case .searchAiBold: return "\u{fa3f}"
        case .searchAiLight: return "\u{fa40}"
        case .searchAiRegular: return "\u{fa41}"
        case .searchBold: return "\u{fa42}"
        case .searchFilled: return "\u{fa43}"
        case .searchLight: return "\u{fa44}"
        case .searchRegular: return "\u{fa45}"
        case .secondaryArrowBold: return "\u{fa46}"
        case .secondaryArrowLight: return "\u{fa47}"
        case .secondaryArrowRegular: return "\u{fa48}"
        case .secureCallLockBold: return "\u{fa49}"
        case .secureCallLockFilled: return "\u{fa4a}"
        case .secureCallLockLight: return "\u{fa4b}"
        case .secureCallLockRegular: return "\u{fa4c}"
        case .secureCallShieldBold: return "\u{fa4d}"
        case .secureCallShieldFilled: return "\u{fa4e}"
        case .secureCallShieldLight: return "\u{fa4f}"
        case .secureCallShieldRegular: return "\u{fa50}"
        case .secureCircleBold: return "\u{fa51}"
        case .secureCircleFilled: return "\u{fa52}"
        case .secureCircleLight: return "\u{fa53}"
        case .secureCircleRegular: return "\u{fa54}"
        case .secureLockBold: return "\u{fa55}"
        case .secureLockFilled: return "\u{fa56}"
        case .secureLockLight: return "\u{fa57}"
        case .secureLockRegular: return "\u{fa58}"
        case .segmentExcludeFilled: return "\u{fa59}"
        case .segmentFilterFilled: return "\u{fa5a}"
        case .segmentIncludeFilled: return "\u{fa5b}"
        case .selectAllBold: return "\u{fa5c}"
        case .selectAllFilled: return "\u{fa5d}"
        case .selectAllLight: return "\u{fa5e}"
        case .selectAllRegular: return "\u{fa5f}"
        case .selectionBold: return "\u{fa60}"
        case .selectionFilled: return "\u{fa61}"
        case .selectionLight: return "\u{fa62}"
        case .selectionRegular: return "\u{fa63}"
        case .sendBold: return "\u{fa64}"
        case .sendDigitsBold: return "\u{fa65}"
        case .sendDigitsFilled: return "\u{fa66}"
        case .sendDigitsLight: return "\u{fa67}"
        case .sendDigitsRegular: return "\u{fa68}"
        case .sendFilled: return "\u{fa69}"
        case .sendLight: return "\u{fa6a}"
        case .sendRegular: return "\u{fa6b}"
        case .sendVoiceBold: return "\u{fa6c}"
        case .sendVoiceFilled: return "\u{fa6d}"
        case .sendVoiceLight: return "\u{fa6e}"
        case .sendVoiceRegular: return "\u{fa6f}"
        case .serverBold: return "\u{fa70}"
        case .serverErrorBold: return "\u{fa71}"
        case .serverErrorLight: return "\u{fa72}"
        case .serverErrorRegular: return "\u{fa73}"
        case .serverLight: return "\u{fa74}"
        case .serverRegular: return "\u{fa75}"
        case .servicesBold: return "\u{fa76}"
        case .servicesLight: return "\u{fa77}"
        case .servicesRegular: return "\u{fa78}"
        case .setVariableBold: return "\u{fa79}"
        case .setVariableLight: return "\u{fa7a}"
        case .setVariableRegular: return "\u{fa7b}"
        case .settingsBold: return "\u{fa7c}"
        case .settingsFilled: return "\u{fa7d}"
        case .settingsLight: return "\u{fa7e}"
        case .settingsRegular: return "\u{fa7f}"
        case .setupAssistantBold: return "\u{fa80}"
        case .setupAssistantLight: return "\u{fa81}"
        case .setupAssistantRegular: return "\u{fa82}"
        case .sftpBold: return "\u{fa83}"
        case .sftpLight: return "\u{fa84}"
        case .sftpRegular: return "\u{fa85}"
        case .shapeCircleBold: return "\u{fa86}"
        case .shapeCircleFilled: return "\u{fa87}"
        case .shapeCircleLight: return "\u{fa88}"
        case .shapeCircleMdFilled: return "\u{fa89}"
        case .shapeCircleRegular: return "\u{fa8a}"
        case .shapeCircleSmFilled: return "\u{fa8b}"
        case .shapeDiagonalLineBold: return "\u{fa8c}"
        case .shapeDiagonalLineLight: return "\u{fa8d}"
        case .shapeDiagonalLineRegular: return "\u{fa8e}"
        case .shapeDiamondBold: return "\u{fa8f}"
        case .shapeDiamondFilled: return "\u{fa90}"
        case .shapeDiamondLight: return "\u{fa91}"
        case .shapeDiamondRegular: return "\u{fa92}"
        case .shapeOvalBold: return "\u{fa93}"
        case .shapeOvalLight: return "\u{fa94}"
        case .shapeOvalRegular: return "\u{fa95}"
        case .shapeSquareBold: return "\u{fa96}"
        case .shapeSquareFilled: return "\u{fa97}"
        case .shapeSquareLight: return "\u{fa98}"
        case .shapeSquareRegular: return "\u{fa99}"
        case .shapeTriangleBold: return "\u{fa9a}"
        case .shapeTriangleFilled: return "\u{fa9b}"
        case .shapeTriangleLight: return "\u{fa9c}"
        case .shapeTriangleRegular: return "\u{fa9d}"
        case .shapesBold: return "\u{fa9e}"
        case .shapesFilled: return "\u{fa9f}"
        case .shapesLight: return "\u{faa0}"
        case .shapesRegular: return "\u{faa1}"
        case .shareCNativeAdrBold: return "\u{faa2}"
        case .shareCNativeAdrFilled: return "\u{faa3}"
        case .shareCNativeAdrLight: return "\u{faa4}"
        case .shareCNativeAdrRegular: return "\u{faa5}"
        case .shareCNativeIphBold: return "\u{faa6}"
        case .shareCNativeIphLight: return "\u{faa7}"
        case .shareCNativeIphRegular: return "\u{faa8}"
        case .shareContentOnDeviceBold: return "\u{faa9}"
        case .shareContentOnDeviceLight: return "\u{faaa}"
        case .shareContentOnDeviceRegular: return "\u{faab}"
        case .shareScreenAddBold: return "\u{faac}"
        case .shareScreenAddLight: return "\u{faad}"
        case .shareScreenAddRegular: return "\u{faae}"
        case .shareScreenBadgeFilled: return "\u{faaf}"
        case .shareScreenBold: return "\u{fab0}"
        case .shareScreenFilled: return "\u{fab1}"
        case .shareScreenLight: return "\u{fab2}"
        case .shareScreenRegular: return "\u{fab3}"
        case .shareSpaceBold: return "\u{fab4}"
        case .shareSpaceLight: return "\u{fab5}"
        case .shareSpaceRegular: return "\u{fab6}"
        case .shieldBold: return "\u{fab7}"
        case .shieldLight: return "\u{fab8}"
        case .shieldRegular: return "\u{fab9}"
        case .shoppingCartBold: return "\u{faba}"
        case .shoppingCartFilled: return "\u{fabb}"
        case .shoppingCartLight: return "\u{fabc}"
        case .shoppingCartRegular: return "\u{fabd}"
        case .shortTextBoxBold: return "\u{fabe}"
        case .shortTextBoxLight: return "\u{fabf}"
        case .shortTextBoxRegular: return "\u{fac0}"
        case .showBold: return "\u{fac1}"
        case .showFilled: return "\u{fac2}"
        case .showLight: return "\u{fac3}"
        case .showRegular: return "\u{fac4}"
        case .sidePanelBold: return "\u{fac5}"
        case .sidePanelFilled: return "\u{fac6}"
        case .sidePanelLight: return "\u{fac7}"
        case .sidePanelRegular: return "\u{fac8}"
        case .signInBold: return "\u{fac9}"
        case .signInFilled: return "\u{faca}"
        case .signInForcedBold: return "\u{facb}"
        case .signInForcedLight: return "\u{facc}"
        case .signInForcedRegular: return "\u{facd}"
        case .signInLight: return "\u{face}"
        case .signInRegular: return "\u{facf}"
        case .signLangIntBold: return "\u{fad0}"
        case .signLangIntLight: return "\u{fad1}"
        case .signLangIntRegular: return "\u{fad2}"
        case .signOutBold: return "\u{fad3}"
        case .signOutLight: return "\u{fad4}"
        case .signOutRegular: return "\u{fad5}"
        case .signalFourBold: return "\u{fad6}"
        case .signalFourLight: return "\u{fad7}"
        case .signalFourRegular: return "\u{fad8}"
        case .signalOneBold: return "\u{fad9}"
        case .signalOneLight: return "\u{fada}"
        case .signalOneRegular: return "\u{fadb}"
        case .signalThreeBold: return "\u{fadc}"
        case .signalThreeLight: return "\u{fadd}"
        case .signalThreeRegular: return "\u{fade}"
        case .signalTwoBold: return "\u{fadf}"
        case .signalTwoLight: return "\u{fae0}"
        case .signalTwoRegular: return "\u{fae1}"
        case .signalZeroBold: return "\u{fae2}"
        case .signalZeroLight: return "\u{fae3}"
        case .signalZeroRegular: return "\u{fae4}"
        case .simplePromotionBold: return "\u{fae5}"
        case .simplePromotionLight: return "\u{fae6}"
        case .simplePromotionRegular: return "\u{fae7}"
        case .singleNumberReachBold: return "\u{fae8}"
        case .singleNumberReachLight: return "\u{fae9}"
        case .singleNumberReachRegular: return "\u{faea}"
        case .sipRegistrationInProgressBold: return "\u{faeb}"
        case .sipRegistrationInProgressFilled: return "\u{faec}"
        case .sipRegistrationInProgressLight: return "\u{faed}"
        case .sipRegistrationInProgressRegular: return "\u{faee}"
        case .skipBold: return "\u{faef}"
        case .skipBwBold: return "\u{faf0}"
        case .skipBwFilled: return "\u{faf1}"
        case .skipBwLight: return "\u{faf2}"
        case .skipBwRegular: return "\u{faf3}"
        case .skipFwBold: return "\u{faf4}"
        case .skipFwFilled: return "\u{faf5}"
        case .skipFwLight: return "\u{faf6}"
        case .skipFwRegular: return "\u{faf7}"
        case .skipLight: return "\u{faf8}"
        case .skipRegular: return "\u{faf9}"
        case .smartAudioBold: return "\u{fafa}"
        case .smartAudioLight: return "\u{fafb}"
        case .smartAudioRegular: return "\u{fafc}"
        case .smsFilled: return "\u{fafd}"
        case .smsInboundBold: return "\u{fafe}"
        case .smsInboundLight: return "\u{faff}"
        case .smsInboundRegular: return "\u{fb00}"
        case .smsMessageBold: return "\u{fb01}"
        case .smsMessageFilled: return "\u{fb02}"
        case .smsMessageLight: return "\u{fb03}"
        case .smsMessageOutgoingBold: return "\u{fb04}"
        case .smsMessageOutgoingFilled: return "\u{fb05}"
        case .smsMessageOutgoingLight: return "\u{fb06}"
        case .smsMessageOutgoingRegular: return "\u{fb07}"
        case .smsMessageRegular: return "\u{fb08}"
        case .smsMessageStartBold: return "\u{fb09}"
        case .smsMessageStartFilled: return "\u{fb0a}"
        case .smsMessageStartLight: return "\u{fb0b}"
        case .smsMessageStartRegular: return "\u{fb0c}"
        case .smsOutgoingFilled: return "\u{fb0d}"
        case .smsUnreadBold: return "\u{fb0e}"
        case .smsUnreadLight: return "\u{fb0f}"
        case .smsUnreadRegular: return "\u{fb10}"
        case .sortAscendingBold: return "\u{fb11}"
        case .sortAscendingLight: return "\u{fb12}"
        case .sortAscendingRegular: return "\u{fb13}"
        case .sortDescendingBold: return "\u{fb14}"
        case .sortDescendingLight: return "\u{fb15}"
        case .sortDescendingRegular: return "\u{fb16}"
        case .soundDefaultBold: return "\u{fb17}"
        case .soundDefaultLight: return "\u{fb18}"
        case .soundDefaultRegular: return "\u{fb19}"
        case .sparkleBold: return "\u{fb1a}"
        case .sparkleFilled: return "\u{fb1b}"
        case .sparkleLight: return "\u{fb1c}"
        case .sparkleRegular: return "\u{fb1d}"
        case .speakerBold: return "\u{fb1e}"
        case .speakerDisconnectedBold: return "\u{fb1f}"
        case .speakerDisconnectedFilled: return "\u{fb20}"
        case .speakerDisconnectedLight: return "\u{fb21}"
        case .speakerDisconnectedRegular: return "\u{fb22}"
        case .speakerFilled: return "\u{fb23}"
        case .speakerLight: return "\u{fb24}"
        case .speakerMutedBold: return "\u{fb25}"
        case .speakerMutedFilled: return "\u{fb26}"
        case .speakerMutedLight: return "\u{fb27}"
        case .speakerMutedRegular: return "\u{fb28}"
        case .speakerOffBold: return "\u{fb29}"
        case .speakerOffFilled: return "\u{fb2a}"
        case .speakerOffLight: return "\u{fb2b}"
        case .speakerOffRegular: return "\u{fb2c}"
        case .speakerOnBold: return "\u{fb2d}"
        case .speakerOnLight: return "\u{fb2e}"
        case .speakerOnRegular: return "\u{fb2f}"
        case .speakerRegular: return "\u{fb30}"
        case .speakerTurnDownBold: return "\u{fb31}"
        case .speakerTurnDownFilled: return "\u{fb32}"
        case .speakerTurnDownLight: return "\u{fb33}"
        case .speakerTurnDownRegular: return "\u{fb34}"
        case .speakerTurnUpBold: return "\u{fb35}"
        case .speakerTurnUpFilled: return "\u{fb36}"
        case .speakerTurnUpLight: return "\u{fb37}"
        case .speakerTurnUpRegular: return "\u{fb38}"
        case .speedDialBold: return "\u{fb39}"
        case .speedDialFilled: return "\u{fb3a}"
        case .speedDialLight: return "\u{fb3b}"
        case .speedDialRegular: return "\u{fb3c}"
        case .spellCheckerBold: return "\u{fb3d}"
        case .spellCheckerLight: return "\u{fb3e}"
        case .spellCheckerRegular: return "\u{fb3f}"
        case .splitViewBold: return "\u{fb40}"
        case .splitViewLight: return "\u{fb41}"
        case .splitViewRegular: return "\u{fb42}"
        case .stackedAreaChartBold: return "\u{fb43}"
        case .stackedAreaChartFilled: return "\u{fb44}"
        case .stackedAreaChartFullBold: return "\u{fb45}"
        case .stackedAreaChartFullFilled: return "\u{fb46}"
        case .stackedAreaChartFullLight: return "\u{fb47}"
        case .stackedAreaChartFullRegular: return "\u{fb48}"
        case .stackedAreaChartLight: return "\u{fb49}"
        case .stackedAreaChartRegular: return "\u{fb4a}"
        case .stackedBarChartBold: return "\u{fb4b}"
        case .stackedBarChartFilled: return "\u{fb4c}"
        case .stackedBarChartFullBold: return "\u{fb4d}"
        case .stackedBarChartFullFilled: return "\u{fb4e}"
        case .stackedBarChartFullLight: return "\u{fb4f}"
        case .stackedBarChartFullRegular: return "\u{fb50}"
        case .stackedBarChartLight: return "\u{fb51}"
        case .stackedBarChartRegular: return "\u{fb52}"
        case .startChatBold: return "\u{fb53}"
        case .startChatLight: return "\u{fb54}"
        case .startChatRegular: return "\u{fb55}"
        case .stethoscopeBold: return "\u{fb56}"
        case .stethoscopeLight: return "\u{fb57}"
        case .stethoscopeRegular: return "\u{fb58}"
        case .stickersBold: return "\u{fb59}"
        case .stickersLight: return "\u{fb5a}"
        case .stickersRegular: return "\u{fb5b}"
        case .stickiesBold: return "\u{fb5c}"
        case .stickiesLight: return "\u{fb5d}"
        case .stickiesRegular: return "\u{fb5e}"
        case .stopBold: return "\u{fb5f}"
        case .stopCircleBold: return "\u{fb60}"
        case .stopCircleFilled: return "\u{fb61}"
        case .stopCircleLight: return "\u{fb62}"
        case .stopCircleRegular: return "\u{fb63}"
        case .stopContentShareBold: return "\u{fb64}"
        case .stopContentShareLight: return "\u{fb65}"
        case .stopContentShareRegular: return "\u{fb66}"
        case .stopFilled: return "\u{fb67}"
        case .stopLight: return "\u{fb68}"
        case .stopRegular: return "\u{fb69}"
        case .storedInfoBold: return "\u{fb6a}"
        case .storedInfoFilled: return "\u{fb6b}"
        case .storedInfoLight: return "\u{fb6c}"
        case .storedInfoRegular: return "\u{fb6d}"
        case .streamingBold: return "\u{fb6e}"
        case .streamingLight: return "\u{fb6f}"
        case .streamingRegular: return "\u{fb70}"
        case .strikethroughBold: return "\u{fb71}"
        case .strikethroughFilled: return "\u{fb72}"
        case .strikethroughLight: return "\u{fb73}"
        case .strikethroughRegular: return "\u{fb74}"
        case .studioModeBold: return "\u{fb75}"
        case .studioModeLight: return "\u{fb76}"
        case .studioModeRegular: return "\u{fb77}"
        case .subscriptBold: return "\u{fb78}"
        case .subscriptLight: return "\u{fb79}"
        case .subscriptRegular: return "\u{fb7a}"
        case .summarizeAiBold: return "\u{fb7b}"
        case .summarizeAiLight: return "\u{fb7c}"
        case .summarizeAiRegular: return "\u{fb7d}"
        case .superscriptBold: return "\u{fb7e}"
        case .superscriptLight: return "\u{fb7f}"
        case .superscriptRegular: return "\u{fb80}"
        case .surveyBold: return "\u{fb81}"
        case .surveyFilled: return "\u{fb82}"
        case .surveyLight: return "\u{fb83}"
        case .surveyRegular: return "\u{fb84}"
        case .sxEightyCodecBold: return "\u{fb85}"
        case .sxEightyCodecLight: return "\u{fb86}"
        case .sxEightyCodecRegular: return "\u{fb87}"
        case .sxTenBold: return "\u{fb88}"
        case .sxTenLight: return "\u{fb89}"
        case .sxTenRegular: return "\u{fb8a}"
        case .sxTwentyBold: return "\u{fb8b}"
        case .sxTwentyLight: return "\u{fb8c}"
        case .sxTwentyRegular: return "\u{fb8d}"
        case .tableBold: return "\u{fb8e}"
        case .tableExtenderBold: return "\u{fb8f}"
        case .tableExtenderFilled: return "\u{fb90}"
        case .tableExtenderLight: return "\u{fb91}"
        case .tableExtenderRegular: return "\u{fb92}"
        case .tableLight: return "\u{fb93}"
        case .tableRegular: return "\u{fb94}"
        case .tabletBold: return "\u{fb95}"
        case .tabletLight: return "\u{fb96}"
        case .tabletRegular: return "\u{fb97}"
        case .tabsBold: return "\u{fb98}"
        case .tabsLight: return "\u{fb99}"
        case .tabsRegular: return "\u{fb9a}"
        case .tagBold: return "\u{fb9b}"
        case .tagLight: return "\u{fb9c}"
        case .tagRegular: return "\u{fb9d}"
        case .tapBold: return "\u{fb9e}"
        case .tapFilled: return "\u{fb9f}"
        case .tapLight: return "\u{fba0}"
        case .tapRegular: return "\u{fba1}"
        case .telepresenceAlertBold: return "\u{fba2}"
        case .telepresenceAlertLight: return "\u{fba3}"
        case .telepresenceAlertMutedBold: return "\u{fba4}"
        case .telepresenceAlertMutedLight: return "\u{fba5}"
        case .telepresenceAlertMutedRegular: return "\u{fba6}"
        case .telepresenceAlertRegular: return "\u{fba7}"
        case .telepresenceBold: return "\u{fba8}"
        case .telepresenceIxFiveThousandBold: return "\u{fba9}"
        case .telepresenceIxFiveThousandLight: return "\u{fbaa}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbab}"
        case .telepresenceLight: return "\u{fbac}"
        case .telepresenceMutedBold: return "\u{fbad}"
        case .telepresenceMutedLight: return "\u{fbae}"
        case .telepresenceMutedRegular: return "\u{fbaf}"
        case .telepresencePrivateBold: return "\u{fbb0}"
        case .telepresencePrivateLight: return "\u{fbb1}"
        case .telepresencePrivateRegular: return "\u{fbb2}"
        case .telepresenceRegular: return "\u{fbb3}"
        case .temperatureBold: return "\u{fbb4}"
        case .temperatureLight: return "\u{fbb5}"
        case .temperatureRegular: return "\u{fbb6}"
        case .testTubeBold: return "\u{fbb7}"
        case .testTubeFilled: return "\u{fbb8}"
        case .testTubeLight: return "\u{fbb9}"
        case .testTubeRegular: return "\u{fbba}"
        case .textAlignCenterBold: return "\u{fbbb}"
        case .textAlignCenterFilled: return "\u{fbbc}"
        case .textAlignCenterLight: return "\u{fbbd}"
        case .textAlignCenterRegular: return "\u{fbbe}"
        case .textAlignLeftBold: return "\u{fbbf}"
        case .textAlignLeftFilled: return "\u{fbc0}"
        case .textAlignLeftLight: return "\u{fbc1}"
        case .textAlignLeftRegular: return "\u{fbc2}"
        case .textAlignRightBold: return "\u{fbc3}"
        case .textAlignRightFilled: return "\u{fbc4}"
        case .textAlignRightLight: return "\u{fbc5}"
        case .textAlignRightRegular: return "\u{fbc6}"
        case .textBold: return "\u{fbc7}"
        case .textBoxCursorLight: return "\u{fbc8}"
        case .textCodeBlockBold: return "\u{fbc9}"
        case .textCodeBlockLight: return "\u{fbca}"
        case .textCodeBlockRegular: return "\u{fbcb}"
        case .textHighlightBold: return "\u{fbcc}"
        case .textHighlightFilled: return "\u{fbcd}"
        case .textHighlightLight: return "\u{fbce}"
        case .textHighlightRegular: return "\u{fbcf}"
        case .textLight: return "\u{fbd0}"
        case .textRegular: return "\u{fbd1}"
        case .threeColumnBold: return "\u{fbd2}"
        case .threeColumnLight: return "\u{fbd3}"
        case .threeColumnRegular: return "\u{fbd4}"
        case .threeDObjectBold: return "\u{fbd5}"
        case .threeDObjectLight: return "\u{fbd6}"
        case .threeDObjectRegular: return "\u{fbd7}"
        case .timeExclusionBold: return "\u{fbd8}"
        case .timeExclusionLight: return "\u{fbd9}"
        case .timeExclusionRegular: return "\u{fbda}"
        case .timezoneBold: return "\u{fbdb}"
        case .timezoneFilled: return "\u{fbdc}"
        case .timezoneLight: return "\u{fbdd}"
        case .timezoneRegular: return "\u{fbde}"
        case .tooFastBold: return "\u{fbdf}"
        case .tooFastLight: return "\u{fbe0}"
        case .tooFastRegular: return "\u{fbe1}"
        case .tooSlowBold: return "\u{fbe2}"
        case .tooSlowLight: return "\u{fbe3}"
        case .tooSlowRegular: return "\u{fbe4}"
        case .toolsBold: return "\u{fbe5}"
        case .toolsFilled: return "\u{fbe6}"
        case .toolsLight: return "\u{fbe7}"
        case .toolsRegular: return "\u{fbe8}"
        case .touchTenBold: return "\u{fbe9}"
        case .touchTenLight: return "\u{fbea}"
        case .touchTenRegular: return "\u{fbeb}"
        case .transcriptBold: return "\u{fbec}"
        case .transcriptFilled: return "\u{fbed}"
        case .transcriptLight: return "\u{fbee}"
        case .transcriptRegular: return "\u{fbef}"
        case .translateBold: return "\u{fbf0}"
        case .translateLight: return "\u{fbf1}"
        case .translateRegular: return "\u{fbf2}"
        case .translateUndoBold: return "\u{fbf3}"
        case .translateUndoLight: return "\u{fbf4}"
        case .translateUndoRegular: return "\u{fbf5}"
        case .trendingBold: return "\u{fbf6}"
        case .trendingDownBold: return "\u{fbf7}"
        case .trendingDownFilled: return "\u{fbf8}"
        case .trendingDownLight: return "\u{fbf9}"
        case .trendingDownRegular: return "\u{fbfa}"
        case .trendingFilled: return "\u{fbfb}"
        case .trendingLight: return "\u{fbfc}"
        case .trendingRegular: return "\u{fbfd}"
        case .trimBold: return "\u{fbfe}"
        case .trimLight: return "\u{fbff}"
        case .trimRegular: return "\u{fc00}"
        case .twoColumnBold: return "\u{fc01}"
        case .twoColumnLight: return "\u{fc02}"
        case .twoColumnRegular: return "\u{fc03}"
        case .twoWayVoiceStreamBold: return "\u{fc04}"
        case .twoWayVoiceStreamFilled: return "\u{fc05}"
        case .twoWayVoiceStreamLight: return "\u{fc06}"
        case .twoWayVoiceStreamRegular: return "\u{fc07}"
        case .ucmCloudBold: return "\u{fc08}"
        case .ucmCloudLight: return "\u{fc09}"
        case .ucmCloudRegular: return "\u{fc0a}"
        case .unblockBold: return "\u{fc0b}"
        case .unblockFilled: return "\u{fc0c}"
        case .unblockLight: return "\u{fc0d}"
        case .unblockRegular: return "\u{fc0e}"
        case .underlineBold: return "\u{fc0f}"
        case .underlineFilled: return "\u{fc10}"
        case .underlineLight: return "\u{fc11}"
        case .underlineRegular: return "\u{fc12}"
        case .undoBold: return "\u{fc13}"
        case .undoLight: return "\u{fc14}"
        case .undoRegular: return "\u{fc15}"
        case .unlinkBold: return "\u{fc16}"
        case .unlinkLight: return "\u{fc17}"
        case .unlinkRegular: return "\u{fc18}"
        case .unreadBold: return "\u{fc19}"
        case .unreadFilled: return "\u{fc1a}"
        case .unreadLight: return "\u{fc1b}"
        case .unreadRegular: return "\u{fc1c}"
        case .unsecureUnlockedBold: return "\u{fc1d}"
        case .unsecureUnlockedFilled: return "\u{fc1e}"
        case .unsecureUnlockedLight: return "\u{fc1f}"
        case .unsecureUnlockedRegular: return "\u{fc20}"
        case .unsortedBold: return "\u{fc21}"
        case .unsortedLight: return "\u{fc22}"
        case .unsortedRegular: return "\u{fc23}"
        case .updateFileShareBold: return "\u{fc24}"
        case .updateFileShareLight: return "\u{fc25}"
        case .updateFileShareRegular: return "\u{fc26}"
        case .uploadBold: return "\u{fc27}"
        case .uploadImageBold: return "\u{fc28}"
        case .uploadImageLight: return "\u{fc29}"
        case .uploadImageRegular: return "\u{fc2a}"
        case .uploadLight: return "\u{fc2b}"
        case .uploadRegular: return "\u{fc2c}"
        case .urgentVoicemailBold: return "\u{fc2d}"
        case .urgentVoicemailFilled: return "\u{fc2e}"
        case .usbBold: return "\u{fc2f}"
        case .usbHeadsetBold: return "\u{fc30}"
        case .usbHeadsetLight: return "\u{fc31}"
        case .usbHeadsetMutedBold: return "\u{fc32}"
        case .usbHeadsetMutedLight: return "\u{fc33}"
        case .usbHeadsetMutedRegular: return "\u{fc34}"
        case .usbHeadsetRegular: return "\u{fc35}"
        case .usbLight: return "\u{fc36}"
        case .usbRegular: return "\u{fc37}"
        case .userBold: return "\u{fc38}"
        case .userDeactivateBold: return "\u{fc39}"
        case .userDeactivateLight: return "\u{fc3a}"
        case .userDeactivateRegular: return "\u{fc3b}"
        case .userLight: return "\u{fc3c}"
        case .userRegular: return "\u{fc3d}"
        case .videoBlurBold: return "\u{fc3e}"
        case .videoBlurFilled: return "\u{fc3f}"
        case .videoBlurLight: return "\u{fc40}"
        case .videoBlurRegular: return "\u{fc41}"
        case .videoBold: return "\u{fc42}"
        case .videoEffectBold: return "\u{fc43}"
        case .videoEffectFilled: return "\u{fc44}"
        case .videoEffectLight: return "\u{fc45}"
        case .videoEffectRegular: return "\u{fc46}"
        case .videoFilled: return "\u{fc47}"
        case .videoLayoutBold: return "\u{fc48}"
        case .videoLayoutCustomBold: return "\u{fc49}"
        case .videoLayoutCustomFilled: return "\u{fc4a}"
        case .videoLayoutCustomLight: return "\u{fc4b}"
        case .videoLayoutCustomRegular: return "\u{fc4c}"
        case .videoLayoutEqualBold: return "\u{fc4d}"
        case .videoLayoutEqualDualBold: return "\u{fc4e}"
        case .videoLayoutEqualDualLight: return "\u{fc4f}"
        case .videoLayoutEqualDualRegular: return "\u{fc50}"
        case .videoLayoutEqualFilled: return "\u{fc51}"
        case .videoLayoutEqualLight: return "\u{fc52}"
        case .videoLayoutEqualRegular: return "\u{fc53}"
        case .videoLayoutFilled: return "\u{fc54}"
        case .videoLayoutLight: return "\u{fc55}"
        case .videoLayoutOverlayBold: return "\u{fc56}"
        case .videoLayoutOverlayFilled: return "\u{fc57}"
        case .videoLayoutOverlayLight: return "\u{fc58}"
        case .videoLayoutOverlayRegular: return "\u{fc59}"
        case .videoLayoutPresentationBold: return "\u{fc5a}"
        case .videoLayoutPresentationFilled: return "\u{fc5b}"
        case .videoLayoutPresentationLight: return "\u{fc5c}"
        case .videoLayoutPresentationRegular: return "\u{fc5d}"
        case .videoLayoutPresenterDominantBold: return "\u{fc5e}"
        case .videoLayoutPresenterDominantLight: return "\u{fc5f}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc60}"
        case .videoLayoutProminentBold: return "\u{fc61}"
        case .videoLayoutProminentFilled: return "\u{fc62}"
        case .videoLayoutProminentLight: return "\u{fc63}"
        case .videoLayoutProminentRegular: return "\u{fc64}"
        case .videoLayoutRegular: return "\u{fc65}"
        case .videoLayoutShareDominantBold: return "\u{fc66}"
        case .videoLayoutShareDominantLight: return "\u{fc67}"
        case .videoLayoutShareDominantRegular: return "\u{fc68}"
        case .videoLayoutSingleBold: return "\u{fc69}"
        case .videoLayoutSingleFilled: return "\u{fc6a}"
        case .videoLayoutSingleLight: return "\u{fc6b}"
        case .videoLayoutSingleRegular: return "\u{fc6c}"
        case .videoLayoutSpeakerBold: return "\u{fc6d}"
        case .videoLayoutSpeakerFilled: return "\u{fc6e}"
        case .videoLayoutSpeakerLight: return "\u{fc6f}"
        case .videoLayoutSpeakerRegular: return "\u{fc70}"
        case .videoLayoutStackBold: return "\u{fc71}"
        case .videoLayoutStackFilled: return "\u{fc72}"
        case .videoLayoutStackLight: return "\u{fc73}"
        case .videoLayoutStackRegular: return "\u{fc74}"
        case .videoLayoutVideoDominantBold: return "\u{fc75}"
        case .videoLayoutVideoDominantFilled: return "\u{fc76}"
        case .videoLayoutVideoDominantLight: return "\u{fc77}"
        case .videoLayoutVideoDominantRegular: return "\u{fc78}"
        case .videoLight: return "\u{fc79}"
        case .videoPlusBold: return "\u{fc7a}"
        case .videoPlusFilled: return "\u{fc7b}"
        case .videoPlusLight: return "\u{fc7c}"
        case .videoPlusRegular: return "\u{fc7d}"
        case .videoRegular: return "\u{fc7e}"
        case .videoSpeakerTrackBold: return "\u{fc7f}"
        case .videoSpeakerTrackFilled: return "\u{fc80}"
        case .videoSpeakerTrackLight: return "\u{fc81}"
        case .videoSpeakerTrackRegular: return "\u{fc82}"
        case .viewAllBold: return "\u{fc83}"
        case .viewAllLight: return "\u{fc84}"
        case .viewAllRegular: return "\u{fc85}"
        case .viewListBold: return "\u{fc86}"
        case .viewListFilled: return "\u{fc87}"
        case .viewListLight: return "\u{fc88}"
        case .viewListRegular: return "\u{fc89}"
        case .viewStackedBold: return "\u{fc8a}"
        case .viewStackedFilled: return "\u{fc8b}"
        case .viewStackedLight: return "\u{fc8c}"
        case .viewStackedRegular: return "\u{fc8d}"
        case .viewThumbnailBold: return "\u{fc8e}"
        case .viewThumbnailFilled: return "\u{fc8f}"
        case .viewThumbnailLight: return "\u{fc90}"
        case .viewThumbnailRegular: return "\u{fc91}"
        case .visionproBold: return "\u{fc92}"
        case .visionproFilled: return "\u{fc93}"
        case .visionproLight: return "\u{fc94}"
        case .visionproMoveCallInBold: return "\u{fc95}"
        case .visionproMoveCallInFilled: return "\u{fc96}"
        case .visionproMoveCallInLight: return "\u{fc97}"
        case .visionproMoveCallInOutBold: return "\u{fc98}"
        case .visionproMoveCallInOutFilled: return "\u{fc99}"
        case .visionproMoveCallInOutLight: return "\u{fc9a}"
        case .visionproMoveCallInOutRegular: return "\u{fc9b}"
        case .visionproMoveCallInRegular: return "\u{fc9c}"
        case .visionproMoveCallOutBold: return "\u{fc9d}"
        case .visionproMoveCallOutFilled: return "\u{fc9e}"
        case .visionproMoveCallOutLight: return "\u{fc9f}"
        case .visionproMoveCallOutRegular: return "\u{fca0}"
        case .visionproRegular: return "\u{fca1}"
        case .voicemailBold: return "\u{fca2}"
        case .voicemailFilled: return "\u{fca3}"
        case .voicemailLight: return "\u{fca4}"
        case .voicemailRegular: return "\u{fca5}"
        case .vpnBold: return "\u{fca6}"
        case .vpnFilled: return "\u{fca7}"
        case .vpnLight: return "\u{fca8}"
        case .vpnRegular: return "\u{fca9}"
        case .vscBold: return "\u{fcaa}"
        case .vscLight: return "\u{fcab}"
        case .vscRegular: return "\u{fcac}"
        case .waffleMenuBold: return "\u{fcad}"
        case .waffleMenuLight: return "\u{fcae}"
        case .waffleMenuRegular: return "\u{fcaf}"
        case .waitingRoomBold: return "\u{fcb0}"
        case .waitingRoomLight: return "\u{fcb1}"
        case .waitingRoomRegular: return "\u{fcb2}"
        case .wallpaperBold: return "\u{fcb3}"
        case .wallpaperLight: return "\u{fcb4}"
        case .wallpaperRegular: return "\u{fcb5}"
        case .warningBadgeFilled: return "\u{fcb6}"
        case .warningBold: return "\u{fcb7}"
        case .warningFilled: return "\u{fcb8}"
        case .warningLight: return "\u{fcb9}"
        case .warningRegular: return "\u{fcba}"
        case .webexBoardBold: return "\u{fcbb}"
        case .webexBoardLight: return "\u{fcbc}"
        case .webexBoardRegular: return "\u{fcbd}"
        case .webexCodecPlusBold: return "\u{fcbe}"
        case .webexCodecPlusLight: return "\u{fcbf}"
        case .webexCodecPlusRegular: return "\u{fcc0}"
        case .webexDeskCameraBold: return "\u{fcc1}"
        case .webexDeskCameraLight: return "\u{fcc2}"
        case .webexDeskCameraRegular: return "\u{fcc3}"
        case .webexHelixBold: return "\u{fcc4}"
        case .webexHelixLight: return "\u{fcc5}"
        case .webexHelixRegular: return "\u{fcc6}"
        case .webexMeetingsBold: return "\u{fcc7}"
        case .webexMeetingsFilled: return "\u{fcc8}"
        case .webexMeetingsLight: return "\u{fcc9}"
        case .webexMeetingsRegular: return "\u{fcca}"
        case .webexQuadCameraBold: return "\u{fccb}"
        case .webexQuadCameraLight: return "\u{fccc}"
        case .webexQuadCameraRegular: return "\u{fccd}"
        case .webexRoomKitBold: return "\u{fcce}"
        case .webexRoomKitLight: return "\u{fccf}"
        case .webexRoomKitPlusBold: return "\u{fcd0}"
        case .webexRoomKitPlusLight: return "\u{fcd1}"
        case .webexRoomKitPlusRegular: return "\u{fcd2}"
        case .webexRoomKitRegular: return "\u{fcd3}"
        case .webexShareBold: return "\u{fcd4}"
        case .webexShareLight: return "\u{fcd5}"
        case .webexShareRegular: return "\u{fcd6}"
        case .webexTeamsBold: return "\u{fcd7}"
        case .webexTeamsFilled: return "\u{fcd8}"
        case .webexTeamsLight: return "\u{fcd9}"
        case .webexTeamsNewBold: return "\u{fcda}"
        case .webexTeamsNewFilled: return "\u{fcdb}"
        case .webexTeamsNewLight: return "\u{fcdc}"
        case .webexTeamsNewRegular: return "\u{fcdd}"
        case .webexTeamsRegular: return "\u{fcde}"
        case .webexTeamsRemoveBold: return "\u{fcdf}"
        case .webexTeamsRemoveLight: return "\u{fce0}"
        case .webexTeamsRemoveRegular: return "\u{fce1}"
        case .webhookBold: return "\u{fce2}"
        case .webhookLight: return "\u{fce3}"
        case .webhookRegular: return "\u{fce4}"
        case .webinarBold: return "\u{fce5}"
        case .webinarFilled: return "\u{fce6}"
        case .webinarLight: return "\u{fce7}"
        case .webinarRegular: return "\u{fce8}"
        case .weeklyRecurringScheduleBold: return "\u{fce9}"
        case .weeklyRecurringScheduleLight: return "\u{fcea}"
        case .weeklyRecurringScheduleRegular: return "\u{fceb}"
        case .whisperAnnouncementBold: return "\u{fcec}"
        case .whisperAnnouncementFilled: return "\u{fced}"
        case .whisperAnnouncementLight: return "\u{fcee}"
        case .whisperAnnouncementRegular: return "\u{fcef}"
        case .whisperCoachBold: return "\u{fcf0}"
        case .whisperCoachFilled: return "\u{fcf1}"
        case .whisperCoachLight: return "\u{fcf2}"
        case .whisperCoachRegular: return "\u{fcf3}"
        case .whiteboardBold: return "\u{fcf4}"
        case .whiteboardContentBold: return "\u{fcf5}"
        case .whiteboardContentFilled: return "\u{fcf6}"
        case .whiteboardContentLight: return "\u{fcf7}"
        case .whiteboardContentRegular: return "\u{fcf8}"
        case .whiteboardFilled: return "\u{fcf9}"
        case .whiteboardLight: return "\u{fcfa}"
        case .whiteboardRegular: return "\u{fcfb}"
        case .widgetBold: return "\u{fcfc}"
        case .widgetFilled: return "\u{fcfd}"
        case .widgetLight: return "\u{fcfe}"
        case .widgetRegular: return "\u{fcff}"
        case .wifiBold: return "\u{fd00}"
        case .wifiErrorBold: return "\u{fd01}"
        case .wifiErrorLight: return "\u{fd02}"
        case .wifiErrorRegular: return "\u{fd03}"
        case .wifiLight: return "\u{fd04}"
        case .wifiRegular: return "\u{fd05}"
        case .wifiSignalGoodBold: return "\u{fd06}"
        case .wifiSignalGoodLight: return "\u{fd07}"
        case .wifiSignalGoodRegular: return "\u{fd08}"
        case .wifiSignalPoorBold: return "\u{fd09}"
        case .wifiSignalPoorLight: return "\u{fd0a}"
        case .wifiSignalPoorRegular: return "\u{fd0b}"
        case .wifiSignalUnstableBold: return "\u{fd0c}"
        case .wifiSignalUnstableLight: return "\u{fd0d}"
        case .wifiSignalUnstableRegular: return "\u{fd0e}"
        case .windowCornerScrubBold: return "\u{fd0f}"
        case .windowCornerScrubLight: return "\u{fd10}"
        case .windowCornerScrubRegular: return "\u{fd11}"
        case .windowRightCornerScrubBold: return "\u{fd12}"
        case .windowRightCornerScrubLight: return "\u{fd13}"
        case .windowRightCornerScrubRegular: return "\u{fd14}"
        case .windowVerticalScrubBold: return "\u{fd15}"
        case .windowVerticalScrubLight: return "\u{fd16}"
        case .windowVerticalScrubRegular: return "\u{fd17}"
        case .workflowDeploymentsBold: return "\u{fd18}"
        case .workflowDeploymentsFilled: return "\u{fd19}"
        case .workflowDeploymentsLight: return "\u{fd1a}"
        case .workflowDeploymentsRegular: return "\u{fd1b}"
        case .workphoneBold: return "\u{fd1c}"
        case .workphoneLight: return "\u{fd1d}"
        case .workphoneRegular: return "\u{fd1e}"
        case .zoomInBold: return "\u{fd1f}"
        case .zoomInLight: return "\u{fd20}"
        case .zoomInRegular: return "\u{fd21}"
        case .zoomOutBold: return "\u{fd22}"
        case .zoomOutLight: return "\u{fd23}"
        case .zoomOutRegular: return "\u{fd24}"
