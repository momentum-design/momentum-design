...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .blueLight: return "\u{f244}"
        case .bluetoothBold: return "\u{f245}"
        case .bluetoothFilled: return "\u{f246}"
        case .bluetoothLight: return "\u{f247}"
        case .bluetoothMutedBold: return "\u{f248}"
        case .bluetoothMutedLight: return "\u{f249}"
        case .bluetoothMutedRegular: return "\u{f24a}"
        case .bluetoothRegular: return "\u{f24b}"
        case .boldBold: return "\u{f24c}"
        case .boldFilled: return "\u{f24d}"
        case .boldLight: return "\u{f24e}"
        case .boldRegular: return "\u{f24f}"
        case .bookmarkBold: return "\u{f250}"
        case .bookmarkLight: return "\u{f251}"
        case .bookmarkRegular: return "\u{f252}"
        case .botBold: return "\u{f253}"
        case .botCustomerAssistantBold: return "\u{f254}"
        case .botCustomerAssistantLight: return "\u{f255}"
        case .botCustomerAssistantRegular: return "\u{f256}"
        case .botExpertAssistantBold: return "\u{f257}"
        case .botExpertAssistantLight: return "\u{f258}"
        case .botExpertAssistantRegular: return "\u{f259}"
        case .botLight: return "\u{f25a}"
        case .botRegular: return "\u{f25b}"
        case .boxBold: return "\u{f25c}"
        case .boxLight: return "\u{f25d}"
        case .boxRegular: return "\u{f25e}"
        case .breakoutSessionBold: return "\u{f25f}"
        case .breakoutSessionFilled: return "\u{f260}"
        case .breakoutSessionLight: return "\u{f261}"
        case .breakoutSessionRegular: return "\u{f262}"
        case .brightnessAutoBold: return "\u{f263}"
        case .brightnessAutoLight: return "\u{f264}"
        case .brightnessAutoRegular: return "\u{f265}"
        case .brightnessBold: return "\u{f266}"
        case .brightnessHighBold: return "\u{f267}"
        case .brightnessHighLight: return "\u{f268}"
        case .brightnessHighRegular: return "\u{f269}"
        case .brightnessLight: return "\u{f26a}"
        case .brightnessLowBold: return "\u{f26b}"
        case .brightnessLowLight: return "\u{f26c}"
        case .brightnessLowRegular: return "\u{f26d}"
        case .brightnessRegular: return "\u{f26e}"
        case .brokenFileBold: return "\u{f26f}"
        case .brokenFileFilled: return "\u{f270}"
        case .brokenFileLight: return "\u{f271}"
        case .brokenFileRegular: return "\u{f272}"
        case .browserBold: return "\u{f273}"
        case .browserLight: return "\u{f274}"
        case .browserRegular: return "\u{f275}"
        case .busyPresenceBold: return "\u{f276}"
        case .busyPresenceLight: return "\u{f277}"
        case .busyPresenceRegular: return "\u{f278}"
        case .buttonCursorBold: return "\u{f279}"
        case .buttonCursorLight: return "\u{f27a}"
        case .buttonCursorRegular: return "\u{f27b}"
        case .calendarAddBold: return "\u{f27c}"
        case .calendarAddFilled: return "\u{f27d}"
        case .calendarAddLight: return "\u{f27e}"
        case .calendarAddRegular: return "\u{f27f}"
        case .calendarDayBold: return "\u{f280}"
        case .calendarDayFilled: return "\u{f281}"
        case .calendarDayLight: return "\u{f282}"
        case .calendarDayRegular: return "\u{f283}"
        case .calendarEmptyBold: return "\u{f284}"
        case .calendarEmptyFilled: return "\u{f285}"
        case .calendarEmptyLight: return "\u{f286}"
        case .calendarEmptyRegular: return "\u{f287}"
        case .calendarExternalBold: return "\u{f288}"
        case .calendarExternalLight: return "\u{f289}"
        case .calendarExternalRegular: return "\u{f28a}"
        case .calendarFilterBold: return "\u{f28b}"
        case .calendarFilterLight: return "\u{f28c}"
        case .calendarFilterRegular: return "\u{f28d}"
        case .calendarMonthBold: return "\u{f28e}"
        case .calendarMonthFilled: return "\u{f28f}"
        case .calendarMonthLight: return "\u{f290}"
        case .calendarMonthMoreBold: return "\u{f291}"
        case .calendarMonthMoreLight: return "\u{f292}"
        case .calendarMonthMoreRegular: return "\u{f293}"
        case .calendarMonthRegular: return "\u{f294}"
        case .calendarTodayBold: return "\u{f295}"
        case .calendarTodayLight: return "\u{f296}"
        case .calendarTodayRegular: return "\u{f297}"
        case .calendarWeekBold: return "\u{f298}"
        case .calendarWeekFilled: return "\u{f299}"
        case .calendarWeekLight: return "\u{f29a}"
        case .calendarWeekRegular: return "\u{f29b}"
        case .calendarWeekViewBold: return "\u{f29c}"
        case .calendarWeekViewFilled: return "\u{f29d}"
        case .calendarWeekViewLight: return "\u{f29e}"
        case .calendarWeekViewRegular: return "\u{f29f}"
        case .calendarWorkWeekBold: return "\u{f2a0}"
        case .calendarWorkWeekFilled: return "\u{f2a1}"
        case .calendarWorkWeekLight: return "\u{f2a2}"
        case .calendarWorkWeekRegular: return "\u{f2a3}"
        case .callBargeBold: return "\u{f2a4}"
        case .callBargeFilled: return "\u{f2a5}"
        case .callBargeLight: return "\u{f2a6}"
        case .callBargeRegular: return "\u{f2a7}"
        case .callBargeSilentBold: return "\u{f2a8}"
        case .callBargeSilentLight: return "\u{f2a9}"
        case .callBargeSilentRegular: return "\u{f2aa}"
        case .callForwardSettingsBold: return "\u{f2ab}"
        case .callForwardSettingsFilled: return "\u{f2ac}"
        case .callForwardSettingsLight: return "\u{f2ad}"
        case .callForwardSettingsRegular: return "\u{f2ae}"
        case .callGroupPickupBold: return "\u{f2af}"
        case .callGroupPickupFilled: return "\u{f2b0}"
        case .callGroupPickupLight: return "\u{f2b1}"
        case .callGroupPickupRegular: return "\u{f2b2}"
        case .callHandlingBold: return "\u{f2b3}"
        case .callHandlingLight: return "\u{f2b4}"
        case .callHandlingRegular: return "\u{f2b5}"
        case .callHoldBold: return "\u{f2b6}"
        case .callHoldFilled: return "\u{f2b7}"
        case .callHoldLight: return "\u{f2b8}"
        case .callHoldRegular: return "\u{f2b9}"
        case .callIncomingBold: return "\u{f2ba}"
        case .callIncomingLight: return "\u{f2bb}"
        case .callIncomingRegular: return "\u{f2bc}"
        case .callListBold: return "\u{f2bd}"
        case .callListLight: return "\u{f2be}"
        case .callListRegular: return "\u{f2bf}"
        case .callMergeBold: return "\u{f2c0}"
        case .callMergeLight: return "\u{f2c1}"
        case .callMergeRegular: return "\u{f2c2}"
        case .callMissedBold: return "\u{f2c3}"
        case .callMissedFilled: return "\u{f2c4}"
        case .callMissedLight: return "\u{f2c5}"
        case .callMissedRegular: return "\u{f2c6}"
        case .callMoreBold: return "\u{f2c7}"
        case .callMoreLight: return "\u{f2c8}"
        case .callMoreRegular: return "\u{f2c9}"
        case .callOutgoingBold: return "\u{f2ca}"
        case .callOutgoingLight: return "\u{f2cb}"
        case .callOutgoingRegular: return "\u{f2cc}"
        case .callPickupBold: return "\u{f2cd}"
        case .callPickupFilled: return "\u{f2ce}"
        case .callPickupLight: return "\u{f2cf}"
        case .callPickupOtherBold: return "\u{f2d0}"
        case .callPickupOtherFilled: return "\u{f2d1}"
        case .callPickupOtherLight: return "\u{f2d2}"
        case .callPickupOtherRegular: return "\u{f2d3}"
        case .callPickupRegular: return "\u{f2d4}"
        case .callPrivateBold: return "\u{f2d5}"
        case .callPrivateFilled: return "\u{f2d6}"
        case .callPrivateLight: return "\u{f2d7}"
        case .callPrivateRegular: return "\u{f2d8}"
        case .callRemoteBold: return "\u{f2d9}"
        case .callRemoteFilled: return "\u{f2da}"
        case .callRemoteLight: return "\u{f2db}"
        case .callRemoteRegular: return "\u{f2dc}"
        case .callRequestBold: return "\u{f2dd}"
        case .callRequestFilled: return "\u{f2de}"
        case .callRequestLight: return "\u{f2df}"
        case .callRequestRegular: return "\u{f2e0}"
        case .callReturnBold: return "\u{f2e1}"
        case .callReturnFilled: return "\u{f2e2}"
        case .callReturnLight: return "\u{f2e3}"
        case .callReturnRegular: return "\u{f2e4}"
        case .callRoomBold: return "\u{f2e5}"
        case .callRoomLight: return "\u{f2e6}"
        case .callRoomRegular: return "\u{f2e7}"
        case .callSettingsBold: return "\u{f2e8}"
        case .callSettingsLight: return "\u{f2e9}"
        case .callSettingsRegular: return "\u{f2ea}"
        case .callSplitBold: return "\u{f2eb}"
        case .callSplitLight: return "\u{f2ec}"
        case .callSplitRegular: return "\u{f2ed}"
        case .callSwapBold: return "\u{f2ee}"
        case .callSwapLight: return "\u{f2ef}"
        case .callSwapRegular: return "\u{f2f0}"
        case .callVoicemailBold: return "\u{f2f1}"
        case .callVoicemailLight: return "\u{f2f2}"
        case .callVoicemailRegular: return "\u{f2f3}"
        case .callrateBold: return "\u{f2f4}"
        case .callrateLight: return "\u{f2f5}"
        case .callrateRegular: return "\u{f2f6}"
        case .cameraAuxBold: return "\u{f2f7}"
        case .cameraAuxFilled: return "\u{f2f8}"
        case .cameraAuxLight: return "\u{f2f9}"
        case .cameraAuxRegular: return "\u{f2fa}"
        case .cameraBold: return "\u{f2fb}"
        case .cameraFilled: return "\u{f2fc}"
        case .cameraLight: return "\u{f2fd}"
        case .cameraMutedBold: return "\u{f2fe}"
        case .cameraMutedCircleFilled: return "\u{f2ff}"
        case .cameraMutedFilled: return "\u{f300}"
        case .cameraMutedLight: return "\u{f301}"
        case .cameraMutedRegular: return "\u{f302}"
        case .cameraOnBold: return "\u{f303}"
        case .cameraOnFilled: return "\u{f304}"
        case .cameraOnLight: return "\u{f305}"
        case .cameraOnRegular: return "\u{f306}"
        case .cameraPhotoBold: return "\u{f307}"
        case .cameraPhotoFilled: return "\u{f308}"
        case .cameraPhotoLight: return "\u{f309}"
        case .cameraPhotoRegular: return "\u{f30a}"
        case .cameraPresenceBold: return "\u{f30b}"
        case .cameraPresenceFilled: return "\u{f30c}"
        case .cameraPresenceLight: return "\u{f30d}"
        case .cameraPresenceRegular: return "\u{f30e}"
        case .cameraRegular: return "\u{f30f}"
        case .cameraSwapBold: return "\u{f310}"
        case .cameraSwapLight: return "\u{f311}"
        case .cameraSwapRegular: return "\u{f312}"
        case .campaignManagementBold: return "\u{f313}"
        case .campaignManagementLight: return "\u{f314}"
        case .campaignManagementRegular: return "\u{f315}"
        case .cancelBold: return "\u{f316}"
        case .cancelLight: return "\u{f317}"
        case .cancelRegular: return "\u{f318}"
        case .capsLockBold: return "\u{f319}"
        case .capsLockLight: return "\u{f31a}"
        case .capsLockRegular: return "\u{f31b}"
        case .captureRewindBold: return "\u{f31c}"
        case .captureRewindLight: return "\u{f31d}"
        case .captureRewindRegular: return "\u{f31e}"
        case .caroselBold: return "\u{f31f}"
        case .caroselLight: return "\u{f320}"
        case .caroselRegular: return "\u{f321}"
        case .carouselTextBold: return "\u{f322}"
        case .carouselTextLight: return "\u{f323}"
        case .carouselTextRegular: return "\u{f324}"
        case .cellularBold: return "\u{f325}"
        case .cellularLight: return "\u{f326}"
        case .cellularRegular: return "\u{f327}"
        case .centerAlignedBold: return "\u{f328}"
        case .centerAlignedLight: return "\u{f329}"
        case .centerAlignedRegular: return "\u{f32a}"
        case .centerBold: return "\u{f32b}"
        case .centerLight: return "\u{f32c}"
        case .centerRegular: return "\u{f32d}"
        case .certificateBold: return "\u{f32e}"
        case .certificateInvalidBold: return "\u{f32f}"
        case .certificateInvalidLight: return "\u{f330}"
        case .certificateInvalidRegular: return "\u{f331}"
        case .certificateLight: return "\u{f332}"
        case .certificateRegular: return "\u{f333}"
        case .certifiedBold: return "\u{f334}"
        case .certifiedLight: return "\u{f335}"
        case .certifiedRegular: return "\u{f336}"
        case .chPSearchBold: return "\u{f337}"
        case .chPSearchLight: return "\u{f338}"
        case .chPSearchRegular: return "\u{f339}"
        case .channelUssdBold: return "\u{f33a}"
        case .channelUssdLight: return "\u{f33b}"
        case .channelUssdRegular: return "\u{f33c}"
        case .chatBold: return "\u{f33d}"
        case .chatFilled: return "\u{f33e}"
        case .chatGroupBold: return "\u{f33f}"
        case .chatGroupFilled: return "\u{f340}"
        case .chatGroupLight: return "\u{f341}"
        case .chatGroupRegular: return "\u{f342}"
        case .chatLight: return "\u{f343}"
        case .chatMuteBold: return "\u{f344}"
        case .chatMuteLight: return "\u{f345}"
        case .chatMuteRegular: return "\u{f346}"
        case .chatOutboundFilled: return "\u{f347}"
        case .chatRegular: return "\u{f348}"
        case .checkBold: return "\u{f349}"
        case .checkCircleBadgeFilled: return "\u{f34a}"
        case .checkCircleBold: return "\u{f34b}"
        case .checkCircleFilled: return "\u{f34c}"
        case .checkCircleLight: return "\u{f34d}"
        case .checkCircleRegular: return "\u{f34e}"
        case .checkLight: return "\u{f34f}"
        case .checkRegular: return "\u{f350}"
        case .checkboxGroupBold: return "\u{f351}"
        case .checkboxGroupLight: return "\u{f352}"
        case .checkboxGroupRegular: return "\u{f353}"
        case .cleanUpBold: return "\u{f354}"
        case .cleanUpLight: return "\u{f355}"
        case .cleanUpRegular: return "\u{f356}"
        case .clearBadgeFilled: return "\u{f357}"
        case .clearBold: return "\u{f358}"
        case .clearFilled: return "\u{f359}"
        case .clearLight: return "\u{f35a}"
        case .clearRegular: return "\u{f35b}"
        case .closeSpaceBold: return "\u{f35c}"
        case .closeSpaceLight: return "\u{f35d}"
        case .closeSpaceRegular: return "\u{f35e}"
        case .closedCaptionBadgeBold: return "\u{f35f}"
        case .closedCaptionBadgeFilled: return "\u{f360}"
        case .closedCaptionBadgeLight: return "\u{f361}"
        case .closedCaptionBadgeRegular: return "\u{f362}"
        case .closedCaptionsBold: return "\u{f363}"
        case .closedCaptionsFilled: return "\u{f364}"
        case .closedCaptionsLight: return "\u{f365}"
        case .closedCaptionsRegular: return "\u{f366}"
        case .cloudBold: return "\u{f367}"
        case .cloudDownloadBold: return "\u{f368}"
        case .cloudDownloadLight: return "\u{f369}"
        case .cloudDownloadRegular: return "\u{f36a}"
        case .cloudFilled: return "\u{f36b}"
        case .cloudFrameBold: return "\u{f36c}"
        case .cloudFrameFilled: return "\u{f36d}"
        case .cloudFrameLight: return "\u{f36e}"
        case .cloudFrameRegular: return "\u{f36f}"
        case .cloudLight: return "\u{f370}"
        case .cloudMutedBold: return "\u{f371}"
        case .cloudMutedFilled: return "\u{f372}"
        case .cloudMutedLight: return "\u{f373}"
        case .cloudMutedRegular: return "\u{f374}"
        case .cloudRegular: return "\u{f375}"
        case .cloudUploadBold: return "\u{f376}"
        case .cloudUploadLight: return "\u{f377}"
        case .cloudUploadRegular: return "\u{f378}"
        case .codeBlockBold: return "\u{f379}"
        case .codeBlockLight: return "\u{f37a}"
        case .codeBlockRegular: return "\u{f37b}"
        case .coffeeBold: return "\u{f37c}"
        case .coffeeLight: return "\u{f37d}"
        case .coffeeRegular: return "\u{f37e}"
        case .colorBold: return "\u{f37f}"
        case .colorFilled: return "\u{f380}"
        case .colorLight: return "\u{f381}"
        case .colorRegular: return "\u{f382}"
        case .colourPaletteBold: return "\u{f383}"
        case .colourPaletteFilled: return "\u{f384}"
        case .colourPaletteLight: return "\u{f385}"
        case .colourPaletteRegular: return "\u{f386}"
        case .commentingBold: return "\u{f387}"
        case .commentingFilled: return "\u{f388}"
        case .commentingLight: return "\u{f389}"
        case .commentingRegular: return "\u{f38a}"
        case .companyBold: return "\u{f38b}"
        case .companyLight: return "\u{f38c}"
        case .companyRegular: return "\u{f38d}"
        case .completedByBaseBold: return "\u{f38e}"
        case .completedByBaseLight: return "\u{f38f}"
        case .completedByBaseRegular: return "\u{f390}"
        case .completedByTimeBold: return "\u{f391}"
        case .completedByTimeLight: return "\u{f392}"
        case .completedByTimeRegular: return "\u{f393}"
        case .computerBold: return "\u{f394}"
        case .computerLight: return "\u{f395}"
        case .computerRegular: return "\u{f396}"
        case .conciergeBold: return "\u{f397}"
        case .conciergeLight: return "\u{f398}"
        case .conciergeRegular: return "\u{f399}"
        case .conditionalBlockBold: return "\u{f39a}"
        case .conditionalBlockLight: return "\u{f39b}"
        case .conditionalBlockRegular: return "\u{f39c}"
        case .connectBold: return "\u{f39d}"
        case .connectLight: return "\u{f39e}"
        case .connectRegular: return "\u{f39f}"
        case .contactCardBold: return "\u{f3a0}"
        case .contactCardFilled: return "\u{f3a1}"
        case .contactCardLight: return "\u{f3a2}"
        case .contactCardRegular: return "\u{f3a3}"
        case .contactsBold: return "\u{f3a4}"
        case .contactsFilled: return "\u{f3a5}"
        case .contactsLight: return "\u{f3a6}"
        case .contactsRegular: return "\u{f3a7}"
        case .contentDownloadBold: return "\u{f3a8}"
        case .contentDownloadFilled: return "\u{f3a9}"
        case .contentDownloadLight: return "\u{f3aa}"
        case .contentDownloadRegular: return "\u{f3ab}"
        case .contentShareBold: return "\u{f3ac}"
        case .contentShareLight: return "\u{f3ad}"
        case .contentShareRegular: return "\u{f3ae}"
        case .contrastBold: return "\u{f3af}"
        case .contrastLight: return "\u{f3b0}"
        case .contrastRegular: return "\u{f3b1}"
        case .copyBold: return "\u{f3b2}"
        case .copyLight: return "\u{f3b3}"
        case .copyRegular: return "\u{f3b4}"
        case .cpuBold: return "\u{f3b5}"
        case .cpuLight: return "\u{f3b6}"
        case .cpuRegular: return "\u{f3b7}"
        case .createAGroupBold: return "\u{f3b8}"
        case .createAGroupFilled: return "\u{f3b9}"
        case .createAGroupLight: return "\u{f3ba}"
        case .createAGroupRegular: return "\u{f3bb}"
        case .cropBold: return "\u{f3bc}"
        case .cropLight: return "\u{f3bd}"
        case .cropRegular: return "\u{f3be}"
        case .cucmConnectionBold: return "\u{f3bf}"
        case .cucmConnectionLight: return "\u{f3c0}"
        case .cucmConnectionRegular: return "\u{f3c1}"
        case .customCodeEditorBold: return "\u{f3c2}"
        case .customCodeEditorLight: return "\u{f3c3}"
        case .customCodeEditorRegular: return "\u{f3c4}"
        case .dailyRecurringScheduleBold: return "\u{f3c5}"
        case .dailyRecurringScheduleLight: return "\u{f3c6}"
        case .dailyRecurringScheduleRegular: return "\u{f3c7}"
        case .dashboardBold: return "\u{f3c8}"
        case .dashboardFilled: return "\u{f3c9}"
        case .dashboardLight: return "\u{f3ca}"
        case .dashboardRegular: return "\u{f3cb}"
        case .dataManagementBold: return "\u{f3cc}"
        case .dataManagementFilled: return "\u{f3cd}"
        case .dataManagementLight: return "\u{f3ce}"
        case .dataManagementRegular: return "\u{f3cf}"
        case .dataRangeSelectionBold: return "\u{f3d0}"
        case .dataRangeSelectionFilled: return "\u{f3d1}"
        case .dataRangeSelectionLight: return "\u{f3d2}"
        case .dataRangeSelectionRegular: return "\u{f3d3}"
        case .declineBold: return "\u{f3d4}"
        case .declineFilled: return "\u{f3d5}"
        case .declineLight: return "\u{f3d6}"
        case .declineRegular: return "\u{f3d7}"
        case .dectHandsetBold: return "\u{f3d8}"
        case .dectHandsetFilled: return "\u{f3d9}"
        case .dectHandsetLight: return "\u{f3da}"
        case .dectHandsetRegular: return "\u{f3db}"
        case .deleteBold: return "\u{f3dc}"
        case .deleteFilled: return "\u{f3dd}"
        case .deleteLight: return "\u{f3de}"
        case .deleteRegular: return "\u{f3df}"
        case .deploymentEvaluationProgressBold: return "\u{f3e0}"
        case .deploymentEvaluationProgressLight: return "\u{f3e1}"
        case .deploymentEvaluationProgressRegular: return "\u{f3e2}"
        case .deploymentProgressBold: return "\u{f3e3}"
        case .deploymentProgressLight: return "\u{f3e4}"
        case .deploymentProgressRegular: return "\u{f3e5}"
        case .deploymentRecurringBold: return "\u{f3e6}"
        case .deploymentRecurringLight: return "\u{f3e7}"
        case .deploymentRecurringRegular: return "\u{f3e8}"
        case .deploymentWinnerPendingBold: return "\u{f3e9}"
        case .deploymentWinnerPendingLight: return "\u{f3ea}"
        case .deploymentWinnerPendingRegular: return "\u{f3eb}"
        case .deskPhoneBold: return "\u{f3ec}"
        case .deskPhoneFilled: return "\u{f3ed}"
        case .deskPhoneLight: return "\u{f3ee}"
        case .deskPhoneRegular: return "\u{f3ef}"
        case .deskPhoneWarningBold: return "\u{f3f0}"
        case .deskPhoneWarningLight: return "\u{f3f1}"
        case .deskPhoneWarningRegular: return "\u{f3f2}"
        case .deviceConnectionBold: return "\u{f3f3}"
        case .deviceConnectionFilled: return "\u{f3f4}"
        case .deviceConnectionLight: return "\u{f3f5}"
        case .deviceConnectionRegular: return "\u{f3f6}"
        case .deviceInRoomBold: return "\u{f3f7}"
        case .deviceInRoomEndBold: return "\u{f3f8}"
        case .deviceInRoomEndLight: return "\u{f3f9}"
        case .deviceInRoomEndRegular: return "\u{f3fa}"
        case .deviceInRoomFilled: return "\u{f3fb}"
        case .deviceInRoomLight: return "\u{f3fc}"
        case .deviceInRoomRegular: return "\u{f3fd}"
        case .deviceMutedBold: return "\u{f3fe}"
        case .deviceMutedLight: return "\u{f3ff}"
        case .deviceMutedRegular: return "\u{f400}"
        case .devicePolicyControllerBold: return "\u{f401}"
        case .devicePolicyControllerLight: return "\u{f402}"
        case .devicePolicyControllerRegular: return "\u{f403}"
        case .diagnosticsBold: return "\u{f404}"
        case .diagnosticsLight: return "\u{f405}"
        case .diagnosticsRegular: return "\u{f406}"
        case .dialpadBold: return "\u{f407}"
        case .dialpadLight: return "\u{f408}"
        case .dialpadRegular: return "\u{f409}"
        case .directionalPadBold: return "\u{f40a}"
        case .directionalPadFilled: return "\u{f40b}"
        case .directionalPadLight: return "\u{f40c}"
        case .directionalPadRegular: return "\u{f40d}"
        case .directoryBold: return "\u{f40e}"
        case .directoryLight: return "\u{f40f}"
        case .directoryRegular: return "\u{f410}"
        case .disappearingPenBold: return "\u{f411}"
        case .disappearingPenLight: return "\u{f412}"
        case .disappearingPenRegular: return "\u{f413}"
        case .discBold: return "\u{f414}"
        case .discConnectedBold: return "\u{f415}"
        case .discConnectedLight: return "\u{f416}"
        case .discConnectedRegular: return "\u{f417}"
        case .discLight: return "\u{f418}"
        case .discRegular: return "\u{f419}"
        case .disconnectBold: return "\u{f41a}"
        case .disconnectFilled: return "\u{f41b}"
        case .disconnectLight: return "\u{f41c}"
        case .disconnectRegular: return "\u{f41d}"
        case .dislikeBold: return "\u{f41e}"
        case .dislikeFilled: return "\u{f41f}"
        case .dislikeLight: return "\u{f420}"
        case .dislikeRegular: return "\u{f421}"
        case .displayBold: return "\u{f422}"
        case .displayInputBold: return "\u{f423}"
        case .displayInputLight: return "\u{f424}"
        case .displayInputRegular: return "\u{f425}"
        case .displayLight: return "\u{f426}"
        case .displayRegular: return "\u{f427}"
        case .displayWarningBold: return "\u{f428}"
        case .displayWarningLight: return "\u{f429}"
        case .displayWarningRegular: return "\u{f42a}"
        case .distributeHorizontalBold: return "\u{f42b}"
        case .distributeHorizontalFilled: return "\u{f42c}"
        case .distributeHorizontalLight: return "\u{f42d}"
        case .distributeHorizontalRegular: return "\u{f42e}"
        case .distributeVerticallyBold: return "\u{f42f}"
        case .distributeVerticallyFilled: return "\u{f430}"
        case .distributeVerticallyLight: return "\u{f431}"
        case .distributeVerticallyRegular: return "\u{f432}"
        case .dndPresenceBadgeFilled: return "\u{f433}"
        case .dndPresenceBold: return "\u{f434}"
        case .dndPresenceFilled: return "\u{f435}"
        case .dndPresenceLight: return "\u{f436}"
        case .dndPresenceRegular: return "\u{f437}"
        case .dockWindowBold: return "\u{f438}"
        case .dockWindowLight: return "\u{f439}"
        case .dockWindowRegular: return "\u{f43a}"
        case .documentBold: return "\u{f43b}"
        case .documentCameraBold: return "\u{f43c}"
        case .documentCameraDisconnectedBold: return "\u{f43d}"
        case .documentCameraDisconnectedLight: return "\u{f43e}"
        case .documentCameraDisconnectedRegular: return "\u{f43f}"
        case .documentCameraLight: return "\u{f440}"
        case .documentCameraRegular: return "\u{f441}"
        case .documentCreateBold: return "\u{f442}"
        case .documentCreateFilled: return "\u{f443}"
        case .documentCreateLight: return "\u{f444}"
        case .documentCreateRegular: return "\u{f445}"
        case .documentFilled: return "\u{f446}"
        case .documentLight: return "\u{f447}"
        case .documentMoveBold: return "\u{f448}"
        case .documentMoveFilled: return "\u{f449}"
        case .documentMoveLight: return "\u{f44a}"
        case .documentMoveRegular: return "\u{f44b}"
        case .documentRegular: return "\u{f44c}"
        case .documentShareBold: return "\u{f44d}"
        case .documentShareFilled: return "\u{f44e}"
        case .documentShareLight: return "\u{f44f}"
        case .documentShareRegular: return "\u{f450}"
        case .doneAllBold: return "\u{f451}"
        case .doneAllLight: return "\u{f452}"
        case .doneAllRegular: return "\u{f453}"
        case .donutChartBold: return "\u{f454}"
        case .donutChartFilled: return "\u{f455}"
        case .donutChartLight: return "\u{f456}"
        case .donutChartRegular: return "\u{f457}"
        case .downloadBold: return "\u{f458}"
        case .downloadFilled: return "\u{f459}"
        case .downloadLight: return "\u{f45a}"
        case .downloadRegular: return "\u{f45b}"
        case .draftBold: return "\u{f45c}"
        case .draftFilled: return "\u{f45d}"
        case .draftIndicatorBold: return "\u{f45e}"
        case .draftIndicatorSmallFilled: return "\u{f45f}"
        case .draftLight: return "\u{f460}"
        case .draftRegular: return "\u{f461}"
        case .dragBold: return "\u{f462}"
        case .dragLight: return "\u{f463}"
        case .dragRegular: return "\u{f464}"
        case .draggerHorizontalBold: return "\u{f465}"
        case .draggerHorizontalLight: return "\u{f466}"
        case .draggerHorizontalRegular: return "\u{f467}"
        case .draggerVerticalBold: return "\u{f468}"
        case .draggerVerticalLight: return "\u{f469}"
        case .draggerVerticalRegular: return "\u{f46a}"
        case .driveModeBold: return "\u{f46b}"
        case .driveModeLight: return "\u{f46c}"
        case .driveModeRegular: return "\u{f46d}"
        case .dropdownBold: return "\u{f46e}"
        case .dropdownLight: return "\u{f46f}"
        case .dropdownRegular: return "\u{f470}"
        case .dxEightyBold: return "\u{f471}"
        case .dxEightyFilled: return "\u{f472}"
        case .dxEightyLight: return "\u{f473}"
        case .dxEightyRegular: return "\u{f474}"
        case .dxSeventyBold: return "\u{f475}"
        case .dxSeventyLight: return "\u{f476}"
        case .dxSeventyRegular: return "\u{f477}"
        case .editBold: return "\u{f478}"
        case .editFilled: return "\u{f479}"
        case .editLight: return "\u{f47a}"
        case .editRegular: return "\u{f47b}"
        case .editablePartialBold: return "\u{f47c}"
        case .editablePartialLight: return "\u{f47d}"
        case .editablePartialRegular: return "\u{f47e}"
        case .educationBold: return "\u{f47f}"
        case .educationFilled: return "\u{f480}"
        case .educationLight: return "\u{f481}"
        case .educationRegular: return "\u{f482}"
        case .emailBold: return "\u{f483}"
        case .emailDeliveredBold: return "\u{f484}"
        case .emailDeliveredLight: return "\u{f485}"
        case .emailDeliveredRegular: return "\u{f486}"
        case .emailFailureBold: return "\u{f487}"
        case .emailFailureLight: return "\u{f488}"
        case .emailFailureRegular: return "\u{f489}"
        case .emailFilled: return "\u{f48a}"
        case .emailInviteBold: return "\u{f48b}"
        case .emailInviteLight: return "\u{f48c}"
        case .emailInviteRegular: return "\u{f48d}"
        case .emailLight: return "\u{f48e}"
        case .emailOutgoingBold: return "\u{f48f}"
        case .emailOutgoingFilled: return "\u{f490}"
        case .emailOutgoingLight: return "\u{f491}"
        case .emailOutgoingRegular: return "\u{f492}"
        case .emailReadBold: return "\u{f493}"
        case .emailReadFilled: return "\u{f494}"
        case .emailReadLight: return "\u{f495}"
        case .emailReadRegular: return "\u{f496}"
        case .emailRegular: return "\u{f497}"
        case .emojiExcitedBold: return "\u{f498}"
        case .emojiExcitedFilled: return "\u{f499}"
        case .emojiExcitedLight: return "\u{f49a}"
        case .emojiExcitedRegular: return "\u{f49b}"
        case .emojiHappyBold: return "\u{f49c}"
        case .emojiHappyFilled: return "\u{f49d}"
        case .emojiHappyLight: return "\u{f49e}"
        case .emojiHappyRegular: return "\u{f49f}"
        case .emojiPassiveBold: return "\u{f4a0}"
        case .emojiPassiveFilled: return "\u{f4a1}"
        case .emojiPassiveLight: return "\u{f4a2}"
        case .emojiPassiveRegular: return "\u{f4a3}"
        case .emojiSadBold: return "\u{f4a4}"
        case .emojiSadFilled: return "\u{f4a5}"
        case .emojiSadLight: return "\u{f4a6}"
        case .emojiSadRegular: return "\u{f4a7}"
        case .emojiUnhappyBold: return "\u{f4a8}"
        case .emojiUnhappyFilled: return "\u{f4a9}"
        case .emojiUnhappyLight: return "\u{f4aa}"
        case .emojiUnhappyRegular: return "\u{f4ab}"
        case .encryptionCircleFilled: return "\u{f4ac}"
        case .encryptionFilled: return "\u{f4ad}"
        case .endRemoteDesktopControlBold: return "\u{f4ae}"
        case .endRemoteDesktopControlLight: return "\u{f4af}"
        case .endRemoteDesktopControlRegular: return "\u{f4b0}"
        case .endToEndEncryptionCircleFilled: return "\u{f4b1}"
        case .endToEndEncryptionFilled: return "\u{f4b2}"
        case .endpointBlockedBold: return "\u{f4b3}"
        case .endpointBlockedLight: return "\u{f4b4}"
        case .endpointBlockedRegular: return "\u{f4b5}"
        case .endpointBold: return "\u{f4b6}"
        case .endpointGTwoBold: return "\u{f4b7}"
        case .endpointGTwoLight: return "\u{f4b8}"
        case .endpointGTwoRegular: return "\u{f4b9}"
        case .endpointGTwoSeventyBold: return "\u{f4ba}"
        case .endpointGTwoSeventyDualBold: return "\u{f4bb}"
        case .endpointGTwoSeventyDualLight: return "\u{f4bc}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4bd}"
        case .endpointGTwoSeventyLight: return "\u{f4be}"
        case .endpointGTwoSeventyRegular: return "\u{f4bf}"
        case .endpointGTwoStandBold: return "\u{f4c0}"
        case .endpointGTwoStandLight: return "\u{f4c1}"
        case .endpointGTwoStandRegular: return "\u{f4c2}"
        case .endpointLight: return "\u{f4c3}"
        case .endpointMxEightHundredBold: return "\u{f4c4}"
        case .endpointMxEightHundredDualBold: return "\u{f4c5}"
        case .endpointMxEightHundredDualLight: return "\u{f4c6}"
        case .endpointMxEightHundredDualRegular: return "\u{f4c7}"
        case .endpointMxEightHundredLight: return "\u{f4c8}"
        case .endpointMxEightHundredRegular: return "\u{f4c9}"
        case .endpointRegular: return "\u{f4ca}"
        case .endpointStandBold: return "\u{f4cb}"
        case .endpointStandFilled: return "\u{f4cc}"
        case .endpointStandLight: return "\u{f4cd}"
        case .endpointStandRegular: return "\u{f4ce}"
        case .endpointWarningBold: return "\u{f4cf}"
        case .endpointWarningLight: return "\u{f4d0}"
        case .endpointWarningRegular: return "\u{f4d1}"
        case .enterBold: return "\u{f4d2}"
        case .enterLight: return "\u{f4d3}"
        case .enterRegular: return "\u{f4d4}"
        case .enterRoomBold: return "\u{f4d5}"
        case .enterRoomFilled: return "\u{f4d6}"
        case .enterRoomLight: return "\u{f4d7}"
        case .enterRoomRegular: return "\u{f4d8}"
        case .eraserBold: return "\u{f4d9}"
        case .eraserFilled: return "\u{f4da}"
        case .eraserLight: return "\u{f4db}"
        case .eraserRegular: return "\u{f4dc}"
        case .errorLegacyBadgeFilled: return "\u{f4dd}"
        case .errorLegacyBold: return "\u{f4de}"
        case .errorLegacyFilled: return "\u{f4df}"
        case .errorLegacyLight: return "\u{f4e0}"
        case .errorLegacyRegular: return "\u{f4e1}"
        case .ethernetBold: return "\u{f4e2}"
        case .ethernetFilled: return "\u{f4e3}"
        case .ethernetLight: return "\u{f4e4}"
        case .ethernetRegular: return "\u{f4e5}"
        case .exchangeBold: return "\u{f4e6}"
        case .exchangeLight: return "\u{f4e7}"
        case .exchangeRegular: return "\u{f4e8}"
        case .exclamationBold: return "\u{f4e9}"
        case .exclamationLight: return "\u{f4ea}"
        case .exclamationRegular: return "\u{f4eb}"
        case .excludeBold: return "\u{f4ec}"
        case .excludeLight: return "\u{f4ed}"
        case .excludeRegular: return "\u{f4ee}"
        case .existingTargetGroupBold: return "\u{f4ef}"
        case .existingTargetGroupLight: return "\u{f4f0}"
        case .existingTargetGroupRegular: return "\u{f4f1}"
        case .exitRoomBold: return "\u{f4f2}"
        case .exitRoomLight: return "\u{f4f3}"
        case .exitRoomRegular: return "\u{f4f4}"
        case .exploreBold: return "\u{f4f5}"
        case .exploreLight: return "\u{f4f6}"
        case .exploreRegular: return "\u{f4f7}"
        case .exportBold: return "\u{f4f8}"
        case .exportLight: return "\u{f4f9}"
        case .exportRegular: return "\u{f4fa}"
        case .extensionMobilityBold: return "\u{f4fb}"
        case .extensionMobilityLight: return "\u{f4fc}"
        case .extensionMobilityRegular: return "\u{f4fd}"
        case .externalMessageBold: return "\u{f4fe}"
        case .externalMessageLight: return "\u{f4ff}"
        case .externalMessageRegular: return "\u{f500}"
        case .externalUserBold: return "\u{f501}"
        case .externalUserLight: return "\u{f502}"
        case .externalUserRegular: return "\u{f503}"
        case .familyFontBold: return "\u{f504}"
        case .familyFontLight: return "\u{f505}"
        case .familyFontRegular: return "\u{f506}"
        case .fastForwardBold: return "\u{f507}"
        case .fastForwardLight: return "\u{f508}"
        case .fastForwardRegular: return "\u{f509}"
        case .favoriteBold: return "\u{f50a}"
        case .favoriteFilled: return "\u{f50b}"
        case .favoriteLight: return "\u{f50c}"
        case .favoriteRegular: return "\u{f50d}"
        case .favoritesBold: return "\u{f50e}"
        case .favoritesFilled: return "\u{f50f}"
        case .favoritesLight: return "\u{f510}"
        case .favoritesRegular: return "\u{f511}"
        case .fbwBold: return "\u{f512}"
        case .fbwFilled: return "\u{f513}"
        case .fbwLight: return "\u{f514}"
        case .fbwRegular: return "\u{f515}"
        case .ffwBold: return "\u{f516}"
        case .ffwFilled: return "\u{f517}"
        case .ffwLight: return "\u{f518}"
        case .ffwRegular: return "\u{f519}"
        case .fileAnalysisBold: return "\u{f51a}"
        case .fileAnalysisFilled: return "\u{f51b}"
        case .fileAnalysisLight: return "\u{f51c}"
        case .fileAnalysisRegular: return "\u{f51d}"
        case .fileAnnotationBold: return "\u{f51e}"
        case .fileAnnotationFilled: return "\u{f51f}"
        case .fileAnnotationLight: return "\u{f520}"
        case .fileAnnotationRegular: return "\u{f521}"
        case .fileAudioBold: return "\u{f522}"
        case .fileAudioFilled: return "\u{f523}"
        case .fileAudioLight: return "\u{f524}"
        case .fileAudioRegular: return "\u{f525}"
        case .fileBugBold: return "\u{f526}"
        case .fileBugFilled: return "\u{f527}"
        case .fileBugLight: return "\u{f528}"
        case .fileBugRegular: return "\u{f529}"
        case .fileCodeBold: return "\u{f52a}"
        case .fileCodeFilled: return "\u{f52b}"
        case .fileCodeLight: return "\u{f52c}"
        case .fileCodeRegular: return "\u{f52d}"
        case .fileDashboardBold: return "\u{f52e}"
        case .fileDashboardFilled: return "\u{f52f}"
        case .fileDashboardLight: return "\u{f530}"
        case .fileDashboardRegular: return "\u{f531}"
        case .fileExcelBold: return "\u{f532}"
        case .fileExcelFilled: return "\u{f533}"
        case .fileExcelLight: return "\u{f534}"
        case .fileExcelRegular: return "\u{f535}"
        case .fileGraphBold: return "\u{f536}"
        case .fileGraphFilled: return "\u{f537}"
        case .fileGraphLight: return "\u{f538}"
        case .fileGraphRegular: return "\u{f539}"
        case .fileImageBold: return "\u{f53a}"
        case .fileImageFilled: return "\u{f53b}"
        case .fileImageLight: return "\u{f53c}"
        case .fileImageNoneBold: return "\u{f53d}"
        case .fileImageNoneLight: return "\u{f53e}"
        case .fileImageNoneRegular: return "\u{f53f}"
        case .fileImageRegular: return "\u{f540}"
        case .fileJsBold: return "\u{f541}"
        case .fileJsFilled: return "\u{f542}"
        case .fileJsLight: return "\u{f543}"
        case .fileJsRegular: return "\u{f544}"
        case .fileKeynoteBold: return "\u{f545}"
        case .fileKeynoteFilled: return "\u{f546}"
        case .fileKeynoteLight: return "\u{f547}"
        case .fileKeynoteRegular: return "\u{f548}"
        case .fileLockedBold: return "\u{f549}"
        case .fileLockedFilled: return "\u{f54a}"
        case .fileLockedLight: return "\u{f54b}"
        case .fileLockedRegular: return "\u{f54c}"
        case .fileMissingBold: return "\u{f54d}"
        case .fileMissingFilled: return "\u{f54e}"
        case .fileMissingLight: return "\u{f54f}"
        case .fileMissingRegular: return "\u{f550}"
        case .fileMusicBold: return "\u{f551}"
        case .fileMusicFilled: return "\u{f552}"
        case .fileMusicLight: return "\u{f553}"
        case .fileMusicRegular: return "\u{f554}"
        case .fileOnenoteBold: return "\u{f555}"
        case .fileOnenoteFilled: return "\u{f556}"
        case .fileOnenoteLight: return "\u{f557}"
        case .fileOnenoteRegular: return "\u{f558}"
        case .filePdfBold: return "\u{f559}"
        case .filePdfFilled: return "\u{f55a}"
        case .filePdfLight: return "\u{f55b}"
        case .filePdfRegular: return "\u{f55c}"
        case .filePowerpointBold: return "\u{f55d}"
        case .filePowerpointFilled: return "\u{f55e}"
        case .filePowerpointLight: return "\u{f55f}"
        case .filePowerpointRegular: return "\u{f560}"
        case .fileSpreadsheetBold: return "\u{f561}"
        case .fileSpreadsheetFilled: return "\u{f562}"
        case .fileSpreadsheetLight: return "\u{f563}"
        case .fileSpreadsheetRegular: return "\u{f564}"
        case .fileTextBold: return "\u{f565}"
        case .fileTextFilled: return "\u{f566}"
        case .fileTextLight: return "\u{f567}"
        case .fileTextRegular: return "\u{f568}"
        case .fileThreeDBold: return "\u{f569}"
        case .fileThreeDFilled: return "\u{f56a}"
        case .fileThreeDLight: return "\u{f56b}"
        case .fileThreeDRegular: return "\u{f56c}"
        case .fileVectorBold: return "\u{f56d}"
        case .fileVectorFilled: return "\u{f56e}"
        case .fileVectorLight: return "\u{f56f}"
        case .fileVectorRegular: return "\u{f570}"
        case .fileVideoBold: return "\u{f571}"
        case .fileVideoFilled: return "\u{f572}"
        case .fileVideoLight: return "\u{f573}"
        case .fileVideoRegular: return "\u{f574}"
        case .fileWordBold: return "\u{f575}"
        case .fileWordFilled: return "\u{f576}"
        case .fileWordLight: return "\u{f577}"
        case .fileWordRegular: return "\u{f578}"
        case .fileXmlBold: return "\u{f579}"
        case .fileXmlFilled: return "\u{f57a}"
        case .fileXmlLight: return "\u{f57b}"
        case .fileXmlRegular: return "\u{f57c}"
        case .fileZipBold: return "\u{f57d}"
        case .fileZipFilled: return "\u{f57e}"
        case .fileZipLight: return "\u{f57f}"
        case .fileZipRegular: return "\u{f580}"
        case .filesBold: return "\u{f581}"
        case .filesFilled: return "\u{f582}"
        case .filesLight: return "\u{f583}"
        case .filesRegular: return "\u{f584}"
        case .fillColourBold: return "\u{f585}"
        case .fillColourFilled: return "\u{f586}"
        case .fillColourLight: return "\u{f587}"
        case .fillColourRegular: return "\u{f588}"
        case .filterBold: return "\u{f589}"
        case .filterCircleBold: return "\u{f58a}"
        case .filterCircleFilled: return "\u{f58b}"
        case .filterCircleLight: return "\u{f58c}"
        case .filterCircleRegular: return "\u{f58d}"
        case .filterLight: return "\u{f58e}"
        case .filterRegular: return "\u{f58f}"
        case .fitToWidthBold: return "\u{f590}"
        case .fitToWidthLight: return "\u{f591}"
        case .fitToWidthRegular: return "\u{f592}"
        case .fitToWindowExpandBold: return "\u{f593}"
        case .fitToWindowExpandLight: return "\u{f594}"
        case .fitToWindowExpandRegular: return "\u{f595}"
        case .fitToWindowShrinkBold: return "\u{f596}"
        case .fitToWindowShrinkLight: return "\u{f597}"
        case .fitToWindowShrinkRegular: return "\u{f598}"
        case .flagBold: return "\u{f599}"
        case .flagCircleBold: return "\u{f59a}"
        case .flagCircleFilled: return "\u{f59b}"
        case .flagCircleLight: return "\u{f59c}"
        case .flagCircleRegular: return "\u{f59d}"
        case .flagFilled: return "\u{f59e}"
        case .flagLight: return "\u{f59f}"
        case .flagRegular: return "\u{f5a0}"
        case .folderBold: return "\u{f5a1}"
        case .folderEditBold: return "\u{f5a2}"
        case .folderEditLight: return "\u{f5a3}"
        case .folderEditRegular: return "\u{f5a4}"
        case .folderLight: return "\u{f5a5}"
        case .folderLockBold: return "\u{f5a6}"
        case .folderLockLight: return "\u{f5a7}"
        case .folderLockRegular: return "\u{f5a8}"
        case .folderRegular: return "\u{f5a9}"
        case .folderViewBold: return "\u{f5aa}"
        case .folderViewLight: return "\u{f5ab}"
        case .folderViewRegular: return "\u{f5ac}"
        case .followUpBold: return "\u{f5ad}"
        case .followUpLight: return "\u{f5ae}"
        case .followUpRegular: return "\u{f5af}"
        case .foodBold: return "\u{f5b0}"
        case .foodFilled: return "\u{f5b1}"
        case .foodLight: return "\u{f5b2}"
        case .foodRegular: return "\u{f5b3}"
        case .formatBold: return "\u{f5b4}"
        case .formatDefaultAppBold: return "\u{f5b5}"
        case .formatDefaultAppFilled: return "\u{f5b6}"
        case .formatDefaultAppLight: return "\u{f5b7}"
        case .formatDefaultAppRegular: return "\u{f5b8}"
        case .formatLight: return "\u{f5b9}"
        case .formatPanelControlBarBold: return "\u{f5ba}"
        case .formatPanelControlBarLight: return "\u{f5bb}"
        case .formatPanelControlBarRegular: return "\u{f5bc}"
        case .formatPanelControlDownBold: return "\u{f5bd}"
        case .formatPanelControlDownLight: return "\u{f5be}"
        case .formatPanelControlDownRegular: return "\u{f5bf}"
        case .formatPanelControlLeftBold: return "\u{f5c0}"
        case .formatPanelControlLeftLight: return "\u{f5c1}"
        case .formatPanelControlLeftRegular: return "\u{f5c2}"
        case .formatPanelControlRightBold: return "\u{f5c3}"
        case .formatPanelControlRightLight: return "\u{f5c4}"
        case .formatPanelControlRightRegular: return "\u{f5c5}"
        case .formatPanelControlUpBold: return "\u{f5c6}"
        case .formatPanelControlUpDownBold: return "\u{f5c7}"
        case .formatPanelControlUpDownLight: return "\u{f5c8}"
        case .formatPanelControlUpDownRegular: return "\u{f5c9}"
        case .formatPanelControlUpLight: return "\u{f5ca}"
        case .formatPanelControlUpRegular: return "\u{f5cb}"
        case .formatRegular: return "\u{f5cc}"
        case .formatViewMixedBold: return "\u{f5cd}"
        case .formatViewMixedLight: return "\u{f5ce}"
        case .formatViewMixedRegular: return "\u{f5cf}"
        case .forwardMessageBold: return "\u{f5d0}"
        case .forwardMessageFilled: return "\u{f5d1}"
        case .forwardMessageLight: return "\u{f5d2}"
        case .forwardMessageRegular: return "\u{f5d3}"
        case .forwardTenSecBold: return "\u{f5d4}"
        case .forwardTenSecLight: return "\u{f5d5}"
        case .forwardTenSecRegular: return "\u{f5d6}"
        case .fourColumnBold: return "\u{f5d7}"
        case .fourColumnLight: return "\u{f5d8}"
        case .fourColumnRegular: return "\u{f5d9}"
        case .fourWayNavigationBold: return "\u{f5da}"
        case .fourWayNavigationLight: return "\u{f5db}"
        case .fourWayNavigationRegular: return "\u{f5dc}"
        case .frequencyCappingBold: return "\u{f5dd}"
        case .frequencyCappingLight: return "\u{f5de}"
        case .frequencyCappingRegular: return "\u{f5df}"
        case .fulfillmentBold: return "\u{f5e0}"
        case .fulfillmentLight: return "\u{f5e1}"
        case .fulfillmentRegular: return "\u{f5e2}"
        case .fullscreenBold: return "\u{f5e3}"
        case .fullscreenExitBold: return "\u{f5e4}"
        case .fullscreenExitLight: return "\u{f5e5}"
        case .fullscreenExitRegular: return "\u{f5e6}"
        case .fullscreenLight: return "\u{f5e7}"
        case .fullscreenRegular: return "\u{f5e8}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5e9}"
        case .genericDeviceVideoBold: return "\u{f5ea}"
        case .genericDeviceVideoFilled: return "\u{f5eb}"
        case .genericDeviceVideoLight: return "\u{f5ec}"
        case .genericDeviceVideoRegular: return "\u{f5ed}"
        case .gifBold: return "\u{f5ee}"
        case .gifFilled: return "\u{f5ef}"
        case .gifHorizontalBold: return "\u{f5f0}"
        case .gifHorizontalFilled: return "\u{f5f1}"
        case .gifHorizontalLight: return "\u{f5f2}"
        case .gifHorizontalRegular: return "\u{f5f3}"
        case .gifLight: return "\u{f5f4}"
        case .gifRegular: return "\u{f5f5}"
        case .giftBold: return "\u{f5f6}"
        case .giftFilled: return "\u{f5f7}"
        case .giftLight: return "\u{f5f8}"
        case .giftRegular: return "\u{f5f9}"
        case .greenLeafBold: return "\u{f5fa}"
        case .greenLeafFilled: return "\u{f5fb}"
        case .greenLeafLight: return "\u{f5fc}"
        case .greenLeafRegular: return "\u{f5fd}"
        case .greenLight: return "\u{f5fe}"
        case .greenRoomBold: return "\u{f5ff}"
        case .greenRoomFilled: return "\u{f600}"
        case .greenRoomLight: return "\u{f601}"
        case .greenRoomRegular: return "\u{f602}"
        case .guestIssuerBold: return "\u{f603}"
        case .guestIssuerLight: return "\u{f604}"
        case .guestIssuerRegular: return "\u{f605}"
        case .guideBold: return "\u{f606}"
        case .guideLight: return "\u{f607}"
        case .guideRegular: return "\u{f608}"
        case .handPointerBold: return "\u{f609}"
        case .handPointerLight: return "\u{f60a}"
        case .handPointerRegular: return "\u{f60b}"
        case .handlerBold: return "\u{f60c}"
        case .handlerHorizontalBold: return "\u{f60d}"
        case .handlerHorizontalLight: return "\u{f60e}"
        case .handlerHorizontalRegular: return "\u{f60f}"
        case .handlerLight: return "\u{f610}"
        case .handlerRegular: return "\u{f611}"
        case .handsetAlertBold: return "\u{f612}"
        case .handsetAlertFilled: return "\u{f613}"
        case .handsetAlertLight: return "\u{f614}"
        case .handsetAlertRegular: return "\u{f615}"
        case .handsetBold: return "\u{f616}"
        case .handsetDownSlashBold: return "\u{f617}"
        case .handsetDownSlashFilled: return "\u{f618}"
        case .handsetDownSlashLight: return "\u{f619}"
        case .handsetDownSlashRegular: return "\u{f61a}"
        case .handsetFilled: return "\u{f61b}"
        case .handsetLight: return "\u{f61c}"
        case .handsetMutedBold: return "\u{f61d}"
        case .handsetMutedFilled: return "\u{f61e}"
        case .handsetMutedLight: return "\u{f61f}"
        case .handsetMutedRegular: return "\u{f620}"
        case .handsetRegular: return "\u{f621}"
        case .handsetsArrowLeftBold: return "\u{f622}"
        case .handsetsArrowLeftLight: return "\u{f623}"
        case .handsetsArrowLeftRegular: return "\u{f624}"
        case .handshakeBold: return "\u{f625}"
        case .handshakeLight: return "\u{f626}"
        case .handshakeRegular: return "\u{f627}"
        case .headingOneBold: return "\u{f628}"
        case .headingOneLight: return "\u{f629}"
        case .headingOneRegular: return "\u{f62a}"
        case .headingThreeBold: return "\u{f62b}"
        case .headingThreeLight: return "\u{f62c}"
        case .headingThreeRegular: return "\u{f62d}"
        case .headingTwoBold: return "\u{f62e}"
        case .headingTwoLight: return "\u{f62f}"
        case .headingTwoRegular: return "\u{f630}"
        case .headphonesBold: return "\u{f631}"
        case .headphonesFilled: return "\u{f632}"
        case .headphonesLight: return "\u{f633}"
        case .headphonesMutedBold: return "\u{f634}"
        case .headphonesMutedFilled: return "\u{f635}"
        case .headphonesMutedLight: return "\u{f636}"
        case .headphonesMutedRegular: return "\u{f637}"
        case .headphonesRegular: return "\u{f638}"
        case .headsetAlertBold: return "\u{f639}"
        case .headsetAlertLight: return "\u{f63a}"
        case .headsetAlertRegular: return "\u{f63b}"
        case .headsetArrowDownBold: return "\u{f63c}"
        case .headsetArrowDownFilled: return "\u{f63d}"
        case .headsetArrowDownLight: return "\u{f63e}"
        case .headsetArrowDownRegular: return "\u{f63f}"
        case .headsetBold: return "\u{f640}"
        case .headsetFilled: return "\u{f641}"
        case .headsetLight: return "\u{f642}"
        case .headsetMutedBold: return "\u{f643}"
        case .headsetMutedLight: return "\u{f644}"
        case .headsetMutedRegular: return "\u{f645}"
        case .headsetPrivateBold: return "\u{f646}"
        case .headsetPrivateLight: return "\u{f647}"
        case .headsetPrivateRegular: return "\u{f648}"
        case .headsetRegular: return "\u{f649}"
        case .hearingBold: return "\u{f64a}"
        case .hearingImpairedBold: return "\u{f64b}"
        case .hearingImpairedLight: return "\u{f64c}"
        case .hearingImpairedRegular: return "\u{f64d}"
        case .hearingLight: return "\u{f64e}"
        case .hearingRegular: return "\u{f64f}"
        case .helpBold: return "\u{f650}"
        case .helpCircleBold: return "\u{f651}"
        case .helpCircleFilled: return "\u{f652}"
        case .helpCircleLight: return "\u{f653}"
        case .helpCircleRegular: return "\u{f654}"
        case .helpLight: return "\u{f655}"
        case .helpRegular: return "\u{f656}"
        case .helpdeskBold: return "\u{f657}"
        case .helpdeskFilled: return "\u{f658}"
        case .helpdeskLight: return "\u{f659}"
        case .helpdeskRegular: return "\u{f65a}"
        case .hideBold: return "\u{f65b}"
        case .hideFilled: return "\u{f65c}"
        case .hideLight: return "\u{f65d}"
        case .hideRegular: return "\u{f65e}"
        case .homeBold: return "\u{f65f}"
        case .homeFilled: return "\u{f660}"
        case .homeLight: return "\u{f661}"
        case .homeRegular: return "\u{f662}"
        case .horizontalLineBold: return "\u{f663}"
        case .horizontalLineLight: return "\u{f664}"
        case .horizontalLineRegular: return "\u{f665}"
        case .hotelingBold: return "\u{f666}"
        case .hotelingFilled: return "\u{f667}"
        case .hotelingLight: return "\u{f668}"
        case .hotelingRegular: return "\u{f669}"
        case .humidityBold: return "\u{f66a}"
        case .humidityLight: return "\u{f66b}"
        case .humidityRegular: return "\u{f66c}"
        case .huntGroupBold: return "\u{f66d}"
        case .huntGroupFilled: return "\u{f66e}"
        case .huntGroupLight: return "\u{f66f}"
        case .huntGroupRegular: return "\u{f670}"
        case .idleBold: return "\u{f671}"
        case .idleFilled: return "\u{f672}"
        case .idleLight: return "\u{f673}"
        case .idleRegular: return "\u{f674}"
        case .immediateBold: return "\u{f675}"
        case .immediateFilled: return "\u{f676}"
        case .immediateLight: return "\u{f677}"
        case .immediateRegular: return "\u{f678}"
        case .importBold: return "\u{f679}"
        case .importLight: return "\u{f67a}"
        case .importRegular: return "\u{f67b}"
        case .inCommonBold: return "\u{f67c}"
        case .inCommonLight: return "\u{f67d}"
        case .inCommonRegular: return "\u{f67e}"
        case .inboxBold: return "\u{f67f}"
        case .inboxFilled: return "\u{f680}"
        case .inboxLight: return "\u{f681}"
        case .inboxRegular: return "\u{f682}"
        case .includeBold: return "\u{f683}"
        case .includeLight: return "\u{f684}"
        case .includeRegular: return "\u{f685}"
        case .incognitoBold: return "\u{f686}"
        case .incognitoFilled: return "\u{f687}"
        case .incognitoLight: return "\u{f688}"
        case .incognitoRegular: return "\u{f689}"
        case .incomingCallLegacyBold: return "\u{f68a}"
        case .incomingCallLegacyFilled: return "\u{f68b}"
        case .incomingCallLegacyLight: return "\u{f68c}"
        case .incomingCallLegacyRegular: return "\u{f68d}"
        case .indentDecreaseBold: return "\u{f68e}"
        case .indentDecreaseLight: return "\u{f68f}"
        case .indentDecreaseRegular: return "\u{f690}"
        case .indentIncreaseBold: return "\u{f691}"
        case .indentIncreaseLight: return "\u{f692}"
        case .indentIncreaseRegular: return "\u{f693}"
        case .infoBadgeFilled: return "\u{f694}"
        case .infoCircleBold: return "\u{f695}"
        case .infoCircleFilled: return "\u{f696}"
        case .infoCircleLight: return "\u{f697}"
        case .infoCircleRegular: return "\u{f698}"
        case .infoCircleTwoBold: return "\u{f699}"
        case .infoCircleTwoFilled: return "\u{f69a}"
        case .infoCircleTwoLight: return "\u{f69b}"
        case .infoCircleTwoRegular: return "\u{f69c}"
        case .inputBold: return "\u{f69d}"
        case .inputDisconnectedBold: return "\u{f69e}"
        case .inputDisconnectedLight: return "\u{f69f}"
        case .inputDisconnectedRegular: return "\u{f6a0}"
        case .inputLight: return "\u{f6a1}"
        case .inputRegular: return "\u{f6a2}"
        case .instantScheduleBold: return "\u{f6a3}"
        case .instantScheduleFilled: return "\u{f6a4}"
        case .instantScheduleLight: return "\u{f6a5}"
        case .instantScheduleRegular: return "\u{f6a6}"
        case .integrationsBold: return "\u{f6a7}"
        case .integrationsLight: return "\u{f6a8}"
        case .integrationsRegular: return "\u{f6a9}"
        case .intelligentRoutingBold: return "\u{f6aa}"
        case .intelligentRoutingLight: return "\u{f6ab}"
        case .intelligentRoutingRegular: return "\u{f6ac}"
        case .interactionBold: return "\u{f6ad}"
        case .interactionFilled: return "\u{f6ae}"
        case .interactionLight: return "\u{f6af}"
        case .interactionRegular: return "\u{f6b0}"
        case .invitedUserBold: return "\u{f6b1}"
        case .invitedUserLight: return "\u{f6b2}"
        case .invitedUserRegular: return "\u{f6b3}"
        case .italicBold: return "\u{f6b4}"
        case .italicFilled: return "\u{f6b5}"
        case .italicLight: return "\u{f6b6}"
        case .italicRegular: return "\u{f6b7}"
        case .joinAudioBold: return "\u{f6b8}"
        case .joinAudioFilled: return "\u{f6b9}"
        case .joinAudioLight: return "\u{f6ba}"
        case .joinAudioRegular: return "\u{f6bb}"
        case .keepInTouchBold: return "\u{f6bc}"
        case .keepInTouchFilled: return "\u{f6bd}"
        case .keepInTouchLight: return "\u{f6be}"
        case .keepInTouchRegular: return "\u{f6bf}"
        case .keyboardBold: return "\u{f6c0}"
        case .keyboardCloseBold: return "\u{f6c1}"
        case .keyboardCloseLight: return "\u{f6c2}"
        case .keyboardCloseRegular: return "\u{f6c3}"
        case .keyboardLight: return "\u{f6c4}"
        case .keyboardRegular: return "\u{f6c5}"
        case .languageBold: return "\u{f6c6}"
        case .languageFilled: return "\u{f6c7}"
        case .languageLight: return "\u{f6c8}"
        case .languageRegular: return "\u{f6c9}"
        case .laptopBold: return "\u{f6ca}"
        case .laptopDisconnectedBold: return "\u{f6cb}"
        case .laptopDisconnectedLight: return "\u{f6cc}"
        case .laptopDisconnectedRegular: return "\u{f6cd}"
        case .laptopFilled: return "\u{f6ce}"
        case .laptopLight: return "\u{f6cf}"
        case .laptopRegular: return "\u{f6d0}"
        case .laserPointerBold: return "\u{f6d1}"
        case .laserPointerFilled: return "\u{f6d2}"
        case .laserPointerLight: return "\u{f6d3}"
        case .laserPointerRegular: return "\u{f6d4}"
        case .launchBold: return "\u{f6d5}"
        case .launchLight: return "\u{f6d6}"
        case .launchRegular: return "\u{f6d7}"
        case .layoutSideBySideVerticalBold: return "\u{f6d8}"
        case .layoutSideBySideVerticalFilled: return "\u{f6d9}"
        case .layoutSideBySideVerticalLight: return "\u{f6da}"
        case .layoutSideBySideVerticalRegular: return "\u{f6db}"
        case .leaveBreakoutSessionBold: return "\u{f6dc}"
        case .leaveBreakoutSessionLight: return "\u{f6dd}"
        case .leaveBreakoutSessionRegular: return "\u{f6de}"
        case .leaveDeviceBold: return "\u{f6df}"
        case .leaveDeviceLight: return "\u{f6e0}"
        case .leaveDeviceRegular: return "\u{f6e1}"
        case .likeBold: return "\u{f6e2}"
        case .likeFilled: return "\u{f6e3}"
        case .likeLight: return "\u{f6e4}"
        case .likeRegular: return "\u{f6e5}"
        case .linkBold: return "\u{f6e6}"
        case .linkLight: return "\u{f6e7}"
        case .linkRegular: return "\u{f6e8}"
        case .listBulletedBold: return "\u{f6e9}"
        case .listBulletedLight: return "\u{f6ea}"
        case .listBulletedRegular: return "\u{f6eb}"
        case .listMenuBold: return "\u{f6ec}"
        case .listMenuLight: return "\u{f6ed}"
        case .listMenuRegular: return "\u{f6ee}"
        case .listNumberedBold: return "\u{f6ef}"
        case .listNumberedLight: return "\u{f6f0}"
        case .listNumberedRegular: return "\u{f6f1}"
        case .liveBold: return "\u{f6f2}"
        case .liveFilled: return "\u{f6f3}"
        case .liveLight: return "\u{f6f4}"
        case .liveRegular: return "\u{f6f5}"
        case .locationBold: return "\u{f6f6}"
        case .locationFilled: return "\u{f6f7}"
        case .locationLight: return "\u{f6f8}"
        case .locationRegular: return "\u{f6f9}"
        case .longTextBoxBold: return "\u{f6fa}"
        case .longTextBoxLight: return "\u{f6fb}"
        case .longTextBoxRegular: return "\u{f6fc}"
        case .lowerHandBold: return "\u{f6fd}"
        case .lowerHandLight: return "\u{f6fe}"
        case .lowerHandRegular: return "\u{f6ff}"
        case .magicPenBold: return "\u{f700}"
        case .magicPenFilled: return "\u{f701}"
        case .magicPenLight: return "\u{f702}"
        case .magicPenRegular: return "\u{f703}"
        case .markAsUnreadBold: return "\u{f704}"
        case .markAsUnreadLight: return "\u{f705}"
        case .markAsUnreadRegular: return "\u{f706}"
        case .markdownBold: return "\u{f707}"
        case .markdownFilled: return "\u{f708}"
        case .markdownLight: return "\u{f709}"
        case .markdownRegular: return "\u{f70a}"
        case .markerBold: return "\u{f70b}"
        case .markerFilled: return "\u{f70c}"
        case .markerLight: return "\u{f70d}"
        case .markerRegular: return "\u{f70e}"
        case .maximizeBold: return "\u{f70f}"
        case .maximizeLight: return "\u{f710}"
        case .maximizeRegular: return "\u{f711}"
        case .mediaPlayerBold: return "\u{f712}"
        case .mediaPlayerLight: return "\u{f713}"
        case .mediaPlayerRegular: return "\u{f714}"
        case .mediaQualityGoodBold: return "\u{f715}"
        case .mediaQualityGoodFilled: return "\u{f716}"
        case .mediaQualityGoodLight: return "\u{f717}"
        case .mediaQualityGoodRegular: return "\u{f718}"
        case .mediaQualityPoorBold: return "\u{f719}"
        case .mediaQualityPoorFilled: return "\u{f71a}"
        case .mediaQualityPoorLight: return "\u{f71b}"
        case .mediaQualityPoorRegular: return "\u{f71c}"
        case .mediaQualityUnstableBold: return "\u{f71d}"
        case .mediaQualityUnstableFilled: return "\u{f71e}"
        case .mediaQualityUnstableLight: return "\u{f71f}"
        case .mediaQualityUnstableRegular: return "\u{f720}"
        case .meetBold: return "\u{f721}"
        case .meetEndBold: return "\u{f722}"
        case .meetEndLight: return "\u{f723}"
        case .meetEndRegular: return "\u{f724}"
        case .meetFilled: return "\u{f725}"
        case .meetLight: return "\u{f726}"
        case .meetRegular: return "\u{f727}"
        case .meetingSummaryBold: return "\u{f728}"
        case .meetingSummaryFilled: return "\u{f729}"
        case .meetingSummaryLight: return "\u{f72a}"
        case .meetingSummaryRegular: return "\u{f72b}"
        case .meetingsBold: return "\u{f72c}"
        case .meetingsFilled: return "\u{f72d}"
        case .meetingsFocusMonthBold: return "\u{f72e}"
        case .meetingsFocusMonthLight: return "\u{f72f}"
        case .meetingsFocusMonthRegular: return "\u{f730}"
        case .meetingsFocusOneDayBold: return "\u{f731}"
        case .meetingsFocusOneDayLight: return "\u{f732}"
        case .meetingsFocusOneDayRegular: return "\u{f733}"
        case .meetingsFocusThreeDayBold: return "\u{f734}"
        case .meetingsFocusThreeDayLight: return "\u{f735}"
        case .meetingsFocusThreeDayRegular: return "\u{f736}"
        case .meetingsFocusUpcomingBold: return "\u{f737}"
        case .meetingsFocusUpcomingLight: return "\u{f738}"
        case .meetingsFocusUpcomingRegular: return "\u{f739}"
        case .meetingsLight: return "\u{f73a}"
        case .meetingsPresenceBadgeFilled: return "\u{f73b}"
        case .meetingsPresenceBold: return "\u{f73c}"
        case .meetingsPresenceFilled: return "\u{f73d}"
        case .meetingsPresenceLight: return "\u{f73e}"
        case .meetingsPresenceRegular: return "\u{f73f}"
        case .meetingsRegular: return "\u{f740}"
        case .meetingsTeamBold: return "\u{f741}"
        case .meetingsTeamFilled: return "\u{f742}"
        case .meetingsTeamLight: return "\u{f743}"
        case .meetingsTeamNewBold: return "\u{f744}"
        case .meetingsTeamNewLight: return "\u{f745}"
        case .meetingsTeamNewRegular: return "\u{f746}"
        case .meetingsTeamRegular: return "\u{f747}"
        case .mentionBold: return "\u{f748}"
        case .mentionLight: return "\u{f749}"
        case .mentionRegular: return "\u{f74a}"
        case .messageQueingBold: return "\u{f74b}"
        case .messageQueingLight: return "\u{f74c}"
        case .messageQueingRegular: return "\u{f74d}"
        case .microphoneBold: return "\u{f74e}"
        case .microphoneFilled: return "\u{f74f}"
        case .microphoneHardMutedBold: return "\u{f750}"
        case .microphoneHardMutedCircleFilled: return "\u{f751}"
        case .microphoneHardMutedLight: return "\u{f752}"
        case .microphoneHardMutedRegular: return "\u{f753}"
        case .microphoneLight: return "\u{f754}"
        case .microphoneMusicModeBold: return "\u{f755}"
        case .microphoneMusicModeLight: return "\u{f756}"
        case .microphoneMusicModeOnBold: return "\u{f757}"
        case .microphoneMusicModeOnLight: return "\u{f758}"
        case .microphoneMusicModeOnRegular: return "\u{f759}"
        case .microphoneMusicModeRegular: return "\u{f75a}"
        case .microphoneMutedBold: return "\u{f75b}"
        case .microphoneMutedCircleFilled: return "\u{f75c}"
        case .microphoneMutedFilled: return "\u{f75d}"
        case .microphoneMutedLight: return "\u{f75e}"
        case .microphoneMutedRegular: return "\u{f75f}"
        case .microphoneOnBold: return "\u{f760}"
        case .microphoneOnLight: return "\u{f761}"
        case .microphoneOnRegular: return "\u{f762}"
        case .microphoneOptAllBold: return "\u{f763}"
        case .microphoneOptAllLight: return "\u{f764}"
        case .microphoneOptAllMutedBold: return "\u{f765}"
        case .microphoneOptAllMutedLight: return "\u{f766}"
        case .microphoneOptAllMutedRegular: return "\u{f767}"
        case .microphoneOptAllOnBold: return "\u{f768}"
        case .microphoneOptAllOnLight: return "\u{f769}"
        case .microphoneOptAllOnRegular: return "\u{f76a}"
        case .microphoneOptAllRegular: return "\u{f76b}"
        case .microphoneOptMeBold: return "\u{f76c}"
        case .microphoneOptMeLight: return "\u{f76d}"
        case .microphoneOptMeMutedBold: return "\u{f76e}"
        case .microphoneOptMeMutedLight: return "\u{f76f}"
        case .microphoneOptMeMutedRegular: return "\u{f770}"
        case .microphoneOptMeOnBold: return "\u{f771}"
        case .microphoneOptMeOnLight: return "\u{f772}"
        case .microphoneOptMeOnRegular: return "\u{f773}"
        case .microphoneOptMeRegular: return "\u{f774}"
        case .microphoneRegular: return "\u{f775}"
        case .mindMapBold: return "\u{f776}"
        case .mindMapLight: return "\u{f777}"
        case .mindMapRegular: return "\u{f778}"
        case .minimizeBold: return "\u{f779}"
        case .minimizeLight: return "\u{f77a}"
        case .minimizeRegular: return "\u{f77b}"
        case .minusBold: return "\u{f77c}"
        case .minusLight: return "\u{f77d}"
        case .minusRegular: return "\u{f77e}"
        case .mirrorBold: return "\u{f77f}"
        case .mirrorFilled: return "\u{f780}"
        case .mirrorLight: return "\u{f781}"
        case .mirrorRegular: return "\u{f782}"
        case .mmsFilled: return "\u{f783}"
        case .moderatorBold: return "\u{f784}"
        case .moderatorLight: return "\u{f785}"
        case .moderatorRegular: return "\u{f786}"
        case .monitoringBold: return "\u{f787}"
        case .monitoringLight: return "\u{f788}"
        case .monitoringRegular: return "\u{f789}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f78a}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f78b}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f78c}"
        case .moreAdrBold: return "\u{f78d}"
        case .moreAdrLight: return "\u{f78e}"
        case .moreAdrRegular: return "\u{f78f}"
        case .moreBold: return "\u{f790}"
        case .moreCircleBold: return "\u{f791}"
        case .moreCircleFilled: return "\u{f792}"
        case .moreCircleLight: return "\u{f793}"
        case .moreCircleRegular: return "\u{f794}"
        case .moreLight: return "\u{f795}"
        case .moreRegular: return "\u{f796}"
        case .mouseCursorBold: return "\u{f797}"
        case .mouseCursorLight: return "\u{f798}"
        case .mouseCursorRegular: return "\u{f799}"
        case .moveCallInAdrBold: return "\u{f79a}"
        case .moveCallInAdrLight: return "\u{f79b}"
        case .moveCallInAdrRegular: return "\u{f79c}"
        case .moveCallInIphBold: return "\u{f79d}"
        case .moveCallInIphLight: return "\u{f79e}"
        case .moveCallInIphRegular: return "\u{f79f}"
        case .moveCallInLaptopBold: return "\u{f7a0}"
        case .moveCallInLaptopLight: return "\u{f7a1}"
        case .moveCallInLaptopRegular: return "\u{f7a2}"
        case .moveCallInOutAdrBold: return "\u{f7a3}"
        case .moveCallInOutAdrLight: return "\u{f7a4}"
        case .moveCallInOutAdrRegular: return "\u{f7a5}"
        case .moveCallInOutIphBold: return "\u{f7a6}"
        case .moveCallInOutIphLight: return "\u{f7a7}"
        case .moveCallInOutIphRegular: return "\u{f7a8}"
        case .moveCallInTabletBold: return "\u{f7a9}"
        case .moveCallInTabletLight: return "\u{f7aa}"
        case .moveCallInTabletRegular: return "\u{f7ab}"
        case .moveCallOutAdrBold: return "\u{f7ac}"
        case .moveCallOutAdrLight: return "\u{f7ad}"
        case .moveCallOutAdrRegular: return "\u{f7ae}"
        case .moveCallOutIphBold: return "\u{f7af}"
        case .moveCallOutIphLight: return "\u{f7b0}"
        case .moveCallOutIphRegular: return "\u{f7b1}"
        case .moveCallOutLaptopBold: return "\u{f7b2}"
        case .moveCallOutLaptopLight: return "\u{f7b3}"
        case .moveCallOutLaptopRegular: return "\u{f7b4}"
        case .moveCallOutTabletBold: return "\u{f7b5}"
        case .moveCallOutTabletLight: return "\u{f7b6}"
        case .moveCallOutTabletRegular: return "\u{f7b7}"
        case .moveToScreenBold: return "\u{f7b8}"
        case .moveToScreenLight: return "\u{f7b9}"
        case .moveToScreenRegular: return "\u{f7ba}"
        case .multilineChartBold: return "\u{f7bb}"
        case .multilineChartFilled: return "\u{f7bc}"
        case .multilineChartLight: return "\u{f7bd}"
        case .multilineChartRegular: return "\u{f7be}"
        case .multimediaBold: return "\u{f7bf}"
        case .multimediaFilled: return "\u{f7c0}"
        case .multimediaLight: return "\u{f7c1}"
        case .multimediaRegular: return "\u{f7c2}"
        case .multipledDevicesBold: return "\u{f7c3}"
        case .multipledDevicesLight: return "\u{f7c4}"
        case .multipledDevicesRegular: return "\u{f7c5}"
        case .musicModeCircleBold: return "\u{f7c6}"
        case .musicModeCircleFilled: return "\u{f7c7}"
        case .musicModeCircleLight: return "\u{f7c8}"
        case .musicModeCircleRegular: return "\u{f7c9}"
        case .musicNoteBold: return "\u{f7ca}"
        case .musicNoteFilled: return "\u{f7cb}"
        case .musicNoteLight: return "\u{f7cc}"
        case .musicNoteRegular: return "\u{f7cd}"
        case .muteOnEntryBold: return "\u{f7ce}"
        case .muteOnEntryFilled: return "\u{f7cf}"
        case .muteOnEntryLight: return "\u{f7d0}"
        case .muteOnEntryRegular: return "\u{f7d1}"
        case .newManagerBold: return "\u{f7d2}"
        case .newManagerLight: return "\u{f7d3}"
        case .newManagerRegular: return "\u{f7d4}"
        case .newTitleBold: return "\u{f7d5}"
        case .newTitleLight: return "\u{f7d6}"
        case .newTitleRegular: return "\u{f7d7}"
        case .newVoicemailBold: return "\u{f7d8}"
        case .newVoicemailLight: return "\u{f7d9}"
        case .newVoicemailRegular: return "\u{f7da}"
        case .newWhiteboardBold: return "\u{f7db}"
        case .newWhiteboardLight: return "\u{f7dc}"
        case .newWhiteboardRegular: return "\u{f7dd}"
        case .nextBold: return "\u{f7de}"
        case .nextLight: return "\u{f7df}"
        case .nextRegular: return "\u{f7e0}"
        case .noDevicesBold: return "\u{f7e1}"
        case .noDevicesLight: return "\u{f7e2}"
        case .noDevicesRegular: return "\u{f7e3}"
        case .noiseDetectedCanceledFilled: return "\u{f7e4}"
        case .noiseDetectedFilled: return "\u{f7e5}"
        case .noiseNoneCanceledFilled: return "\u{f7e6}"
        case .noiseNoneFilled: return "\u{f7e7}"
        case .noiseRemovalBold: return "\u{f7e8}"
        case .noiseRemovalLight: return "\u{f7e9}"
        case .noiseRemovalRegular: return "\u{f7ea}"
        case .noteBold: return "\u{f7eb}"
        case .noteLight: return "\u{f7ec}"
        case .notePptBold: return "\u{f7ed}"
        case .notePptLight: return "\u{f7ee}"
        case .notePptRegular: return "\u{f7ef}"
        case .noteRegular: return "\u{f7f0}"
        case .notesBold: return "\u{f7f1}"
        case .notesFilled: return "\u{f7f2}"
        case .notesLight: return "\u{f7f3}"
        case .notesRegular: return "\u{f7f4}"
        case .numberBold: return "\u{f7f5}"
        case .numberLight: return "\u{f7f6}"
        case .numberRegular: return "\u{f7f7}"
        case .oldRemoteBold: return "\u{f7f8}"
        case .oldRemoteLight: return "\u{f7f9}"
        case .oldRemoteRegular: return "\u{f7fa}"
        case .oldTouchBold: return "\u{f7fb}"
        case .oldTouchLight: return "\u{f7fc}"
        case .oldTouchRegular: return "\u{f7fd}"
        case .oneColumnBold: return "\u{f7fe}"
        case .oneColumnLight: return "\u{f7ff}"
        case .oneColumnRegular: return "\u{f800}"
        case .oneTimeBold: return "\u{f801}"
        case .oneTimeLight: return "\u{f802}"
        case .oneTimeRegular: return "\u{f803}"
        case .openInFolderBold: return "\u{f804}"
        case .openInFolderLight: return "\u{f805}"
        case .openInFolderRegular: return "\u{f806}"
        case .openPagesBold: return "\u{f807}"
        case .openPagesLight: return "\u{f808}"
        case .openPagesRegular: return "\u{f809}"
        case .otherNumberBold: return "\u{f80a}"
        case .otherNumberFilled: return "\u{f80b}"
        case .otherNumberLight: return "\u{f80c}"
        case .otherNumberRegular: return "\u{f80d}"
        case .otherNumberWarningBold: return "\u{f80e}"
        case .otherNumberWarningLight: return "\u{f80f}"
        case .otherNumberWarningRegular: return "\u{f810}"
        case .outgoingCallLegacyBold: return "\u{f811}"
        case .outgoingCallLegacyFilled: return "\u{f812}"
        case .outgoingCallLegacyLight: return "\u{f813}"
        case .outgoingCallLegacyRegular: return "\u{f814}"
        case .overflowLeftBold: return "\u{f815}"
        case .overflowLeftLight: return "\u{f816}"
        case .overflowLeftRegular: return "\u{f817}"
        case .overflowRightBold: return "\u{f818}"
        case .overflowRightLight: return "\u{f819}"
        case .overflowRightRegular: return "\u{f81a}"
        case .pairedCameraBold: return "\u{f81b}"
        case .pairedCameraLight: return "\u{f81c}"
        case .pairedCameraRegular: return "\u{f81d}"
        case .pairedDeviceBold: return "\u{f81e}"
        case .pairedDeviceLight: return "\u{f81f}"
        case .pairedDeviceRegular: return "\u{f820}"
        case .pairedHandsetBold: return "\u{f821}"
        case .pairedHandsetLight: return "\u{f822}"
        case .pairedHandsetRegular: return "\u{f823}"
        case .pairingBold: return "\u{f824}"
        case .pairingLight: return "\u{f825}"
        case .pairingRegular: return "\u{f826}"
        case .parkedBold: return "\u{f827}"
        case .parkedFilled: return "\u{f828}"
        case .parkedLight: return "\u{f829}"
        case .parkedRegular: return "\u{f82a}"
        case .parseBold: return "\u{f82b}"
        case .parseLight: return "\u{f82c}"
        case .parseRegular: return "\u{f82d}"
        case .partialBold: return "\u{f82e}"
        case .partialLight: return "\u{f82f}"
        case .partialRegular: return "\u{f830}"
        case .participantAddBold: return "\u{f831}"
        case .participantAddLight: return "\u{f832}"
        case .participantAddRegular: return "\u{f833}"
        case .participantBlockedBold: return "\u{f834}"
        case .participantBlockedLight: return "\u{f835}"
        case .participantBlockedRegular: return "\u{f836}"
        case .participantBold: return "\u{f837}"
        case .participantFilled: return "\u{f838}"
        case .participantLight: return "\u{f839}"
        case .participantListBold: return "\u{f83a}"
        case .participantListFilled: return "\u{f83b}"
        case .participantListLight: return "\u{f83c}"
        case .participantListRegular: return "\u{f83d}"
        case .participantRegular: return "\u{f83e}"
        case .participantRemoveBold: return "\u{f83f}"
        case .participantRemoveLight: return "\u{f840}"
        case .participantRemoveRegular: return "\u{f841}"
        case .participantUnknownBold: return "\u{f842}"
        case .participantUnknownLight: return "\u{f843}"
        case .participantUnknownRegular: return "\u{f844}"
        case .passMouseBold: return "\u{f845}"
        case .passMouseLight: return "\u{f846}"
        case .passMouseRegular: return "\u{f847}"
        case .pauseBadgeFilled: return "\u{f848}"
        case .pauseBold: return "\u{f849}"
        case .pauseFilled: return "\u{f84a}"
        case .pauseLight: return "\u{f84b}"
        case .pauseRegular: return "\u{f84c}"
        case .peopleAddBold: return "\u{f84d}"
        case .peopleAddFilled: return "\u{f84e}"
        case .peopleAddLight: return "\u{f84f}"
        case .peopleAddRegular: return "\u{f850}"
        case .peopleBold: return "\u{f851}"
        case .peopleCircleBold: return "\u{f852}"
        case .peopleCircleFilled: return "\u{f853}"
        case .peopleCircleLight: return "\u{f854}"
        case .peopleCircleRegular: return "\u{f855}"
        case .peopleFilled: return "\u{f856}"
        case .peopleInsightsBold: return "\u{f857}"
        case .peopleInsightsFilled: return "\u{f858}"
        case .peopleInsightsLight: return "\u{f859}"
        case .peopleInsightsRegular: return "\u{f85a}"
        case .peopleLight: return "\u{f85b}"
        case .peopleRegular: return "\u{f85c}"
        case .phoneAlertBold: return "\u{f85d}"
        case .phoneAlertLight: return "\u{f85e}"
        case .phoneAlertRegular: return "\u{f85f}"
        case .phoneBadgeFilled: return "\u{f860}"
        case .phoneBold: return "\u{f861}"
        case .phoneFilled: return "\u{f862}"
        case .phoneLight: return "\u{f863}"
        case .phoneMutedBold: return "\u{f864}"
        case .phoneMutedLight: return "\u{f865}"
        case .phoneMutedRegular: return "\u{f866}"
        case .phonePrivateBold: return "\u{f867}"
        case .phonePrivateLight: return "\u{f868}"
        case .phonePrivateRegular: return "\u{f869}"
        case .phoneRegular: return "\u{f86a}"
        case .phoneReplyAllBold: return "\u{f86b}"
        case .phoneReplyAllLight: return "\u{f86c}"
        case .phoneReplyAllRegular: return "\u{f86d}"
        case .phoneReplyBold: return "\u{f86e}"
        case .phoneReplyLight: return "\u{f86f}"
        case .phoneReplyRegular: return "\u{f870}"
        case .pickerBold: return "\u{f871}"
        case .pickerLight: return "\u{f872}"
        case .pickerRegular: return "\u{f873}"
        case .pieChartBold: return "\u{f874}"
        case .pieChartFilled: return "\u{f875}"
        case .pieChartLight: return "\u{f876}"
        case .pieChartRegular: return "\u{f877}"
        case .pinBold: return "\u{f878}"
        case .pinFilled: return "\u{f879}"
        case .pinLight: return "\u{f87a}"
        case .pinListActivityBold: return "\u{f87b}"
        case .pinListActivityLight: return "\u{f87c}"
        case .pinListActivityRegular: return "\u{f87d}"
        case .pinListBold: return "\u{f87e}"
        case .pinListLight: return "\u{f87f}"
        case .pinListRegular: return "\u{f880}"
        case .pinMutedBold: return "\u{f881}"
        case .pinMutedFilled: return "\u{f882}"
        case .pinMutedLight: return "\u{f883}"
        case .pinMutedRegular: return "\u{f884}"
        case .pinRegular: return "\u{f885}"
        case .pipBold: return "\u{f886}"
        case .pipEnterBold: return "\u{f887}"
        case .pipEnterLight: return "\u{f888}"
        case .pipEnterRegular: return "\u{f889}"
        case .pipExitBold: return "\u{f88a}"
        case .pipExitLight: return "\u{f88b}"
        case .pipExitRegular: return "\u{f88c}"
        case .pipFilled: return "\u{f88d}"
        case .pipLight: return "\u{f88e}"
        case .pipRegular: return "\u{f88f}"
        case .placeholderBold: return "\u{f890}"
        case .placeholderFilled: return "\u{f891}"
        case .placeholderLight: return "\u{f892}"
        case .placeholderRegular: return "\u{f893}"
        case .playBold: return "\u{f894}"
        case .playCircleBold: return "\u{f895}"
        case .playCircleFilled: return "\u{f896}"
        case .playCircleLight: return "\u{f897}"
        case .playCircleRegular: return "\u{f898}"
        case .playFilled: return "\u{f899}"
        case .playLight: return "\u{f89a}"
        case .playRegular: return "\u{f89b}"
        case .plugAcBold: return "\u{f89c}"
        case .plugAcLight: return "\u{f89d}"
        case .plugAcRegular: return "\u{f89e}"
        case .plusBold: return "\u{f89f}"
        case .plusCircleBold: return "\u{f8a0}"
        case .plusCircleFilled: return "\u{f8a1}"
        case .plusCircleLight: return "\u{f8a2}"
        case .plusCircleRegular: return "\u{f8a3}"
        case .plusLight: return "\u{f8a4}"
        case .plusRegular: return "\u{f8a5}"
        case .pmrBold: return "\u{f8a6}"
        case .pmrFilled: return "\u{f8a7}"
        case .pmrLight: return "\u{f8a8}"
        case .pmrRegular: return "\u{f8a9}"
        case .pollBold: return "\u{f8aa}"
        case .pollFilled: return "\u{f8ab}"
        case .pollLight: return "\u{f8ac}"
        case .pollRegular: return "\u{f8ad}"
        case .popInBold: return "\u{f8ae}"
        case .popInLight: return "\u{f8af}"
        case .popInRegular: return "\u{f8b0}"
        case .popOutBold: return "\u{f8b1}"
        case .popOutLight: return "\u{f8b2}"
        case .popOutRegular: return "\u{f8b3}"
        case .popUpBold: return "\u{f8b4}"
        case .popUpLight: return "\u{f8b5}"
        case .popUpRegular: return "\u{f8b6}"
        case .portraitLandscapeBold: return "\u{f8b7}"
        case .portraitLandscapeLight: return "\u{f8b8}"
        case .portraitLandscapeRegular: return "\u{f8b9}"
        case .potentialFraudBold: return "\u{f8ba}"
        case .potentialFraudFilled: return "\u{f8bb}"
        case .potentialFraudLight: return "\u{f8bc}"
        case .potentialFraudRegular: return "\u{f8bd}"
        case .powerAcBold: return "\u{f8be}"
        case .powerAcLight: return "\u{f8bf}"
        case .powerAcRegular: return "\u{f8c0}"
        case .powerBold: return "\u{f8c1}"
        case .powerLight: return "\u{f8c2}"
        case .powerRegular: return "\u{f8c3}"
        case .preHeaderBold: return "\u{f8c4}"
        case .preHeaderLight: return "\u{f8c5}"
        case .preHeaderRegular: return "\u{f8c6}"
        case .premiumBold: return "\u{f8c7}"
        case .premiumLight: return "\u{f8c8}"
        case .premiumRegular: return "\u{f8c9}"
        case .presentationBold: return "\u{f8ca}"
        case .presentationLight: return "\u{f8cb}"
        case .presentationRegular: return "\u{f8cc}"
        case .preventDownloadBold: return "\u{f8cd}"
        case .preventDownloadFilled: return "\u{f8ce}"
        case .preventDownloadLight: return "\u{f8cf}"
        case .preventDownloadRegular: return "\u{f8d0}"
        case .primaryParticipantBold: return "\u{f8d1}"
        case .primaryParticipantLight: return "\u{f8d2}"
        case .primaryParticipantRegular: return "\u{f8d3}"
        case .printBold: return "\u{f8d4}"
        case .printLight: return "\u{f8d5}"
        case .printRegular: return "\u{f8d6}"
        case .priorityBadgeFilled: return "\u{f8d7}"
        case .priorityCircleBold: return "\u{f8d8}"
        case .priorityCircleFilled: return "\u{f8d9}"
        case .priorityCircleLight: return "\u{f8da}"
        case .priorityCircleRegular: return "\u{f8db}"
        case .priorityCircleTwoBold: return "\u{f8dc}"
        case .priorityCircleTwoFilled: return "\u{f8dd}"
        case .priorityCircleTwoLight: return "\u{f8de}"
        case .priorityCircleTwoRegular: return "\u{f8df}"
        case .priorityWaveBold: return "\u{f8e0}"
        case .priorityWaveLight: return "\u{f8e1}"
        case .priorityWaveRegular: return "\u{f8e2}"
        case .privacyCircleBold: return "\u{f8e3}"
        case .privacyCircleFilled: return "\u{f8e4}"
        case .privacyCircleLight: return "\u{f8e5}"
        case .privacyCircleRegular: return "\u{f8e6}"
        case .privateBold: return "\u{f8e7}"
        case .privateCircleBold: return "\u{f8e8}"
        case .privateCircleFilled: return "\u{f8e9}"
        case .privateCircleLight: return "\u{f8ea}"
        case .privateCircleRegular: return "\u{f8eb}"
        case .privateLight: return "\u{f8ec}"
        case .privateMeetingBold: return "\u{f8ed}"
        case .privateMeetingLight: return "\u{f8ee}"
        case .privateMeetingRegular: return "\u{f8ef}"
        case .privateRegular: return "\u{f8f0}"
        case .productDemoBold: return "\u{f8f1}"
        case .productDemoLight: return "\u{f8f2}"
        case .productDemoRegular: return "\u{f8f3}"
        case .proximityBold: return "\u{f8f4}"
        case .proximityLight: return "\u{f8f5}"
        case .proximityMutedBold: return "\u{f8f6}"
        case .proximityMutedLight: return "\u{f8f7}"
        case .proximityMutedRegular: return "\u{f8f8}"
        case .proximityRegular: return "\u{f8f9}"
        case .proximityVideoBold: return "\u{f8fa}"
        case .proximityVideoLight: return "\u{f8fb}"
        case .proximityVideoRegular: return "\u{f8fc}"
        case .ptoPresenceBold: return "\u{f8fd}"
        case .ptoPresenceFilled: return "\u{f8fe}"
        case .ptoPresenceLight: return "\u{f8ff}"
        case .ptoPresenceRegular: return "\u{f900}"
        case .pullCallBold: return "\u{f901}"
        case .pullCallFilled: return "\u{f902}"
        case .pullCallLight: return "\u{f903}"
        case .pullCallRegular: return "\u{f904}"
        case .purpleLight: return "\u{f905}"
        case .qABold: return "\u{f906}"
        case .qALight: return "\u{f907}"
        case .qARegular: return "\u{f908}"
        case .qrCodeBold: return "\u{f909}"
        case .qrCodeLight: return "\u{f90a}"
        case .qrCodeRegular: return "\u{f90b}"
        case .qrCodeScanBold: return "\u{f90c}"
        case .qrCodeScanLight: return "\u{f90d}"
        case .qrCodeScanRegular: return "\u{f90e}"
        case .qualityBold: return "\u{f90f}"
        case .qualityLight: return "\u{f910}"
        case .qualityRegular: return "\u{f911}"
        case .queueContactBold: return "\u{f912}"
        case .queueContactFilled: return "\u{f913}"
        case .queueContactLight: return "\u{f914}"
        case .queueContactRegular: return "\u{f915}"
        case .quietBold: return "\u{f916}"
        case .quietHoursPresenceBold: return "\u{f917}"
        case .quietHoursPresenceFilled: return "\u{f918}"
        case .quietHoursPresenceLight: return "\u{f919}"
        case .quietHoursPresenceRegular: return "\u{f91a}"
        case .quietLight: return "\u{f91b}"
        case .quietRegular: return "\u{f91c}"
        case .radioButtonGroupBold: return "\u{f91d}"
        case .radioButtonGroupLight: return "\u{f91e}"
        case .radioButtonGroupRegular: return "\u{f91f}"
        case .raiseHandBold: return "\u{f920}"
        case .raiseHandCircleFilled: return "\u{f921}"
        case .raiseHandFilled: return "\u{f922}"
        case .raiseHandLight: return "\u{f923}"
        case .raiseHandRegular: return "\u{f924}"
        case .ramBold: return "\u{f925}"
        case .ramLight: return "\u{f926}"
        case .ramRegular: return "\u{f927}"
        case .reactionsBold: return "\u{f928}"
        case .reactionsFilled: return "\u{f929}"
        case .reactionsLight: return "\u{f92a}"
        case .reactionsRegular: return "\u{f92b}"
        case .reactivateBold: return "\u{f92c}"
        case .reactivateLight: return "\u{f92d}"
        case .reactivateRegular: return "\u{f92e}"
        case .receiveVoiceBold: return "\u{f92f}"
        case .receiveVoiceFilled: return "\u{f930}"
        case .receiveVoiceLight: return "\u{f931}"
        case .receiveVoiceRegular: return "\u{f932}"
        case .recentsBold: return "\u{f933}"
        case .recentsFilled: return "\u{f934}"
        case .recentsLight: return "\u{f935}"
        case .recentsPresenceBadgeFilled: return "\u{f936}"
        case .recentsPresenceBold: return "\u{f937}"
        case .recentsPresenceFilled: return "\u{f938}"
        case .recentsPresenceLight: return "\u{f939}"
        case .recentsPresenceRegular: return "\u{f93a}"
        case .recentsRegular: return "\u{f93b}"
        case .recordActiveBadgeFilled: return "\u{f93c}"
        case .recordActiveBold: return "\u{f93d}"
        case .recordActiveFilled: return "\u{f93e}"
        case .recordActiveLight: return "\u{f93f}"
        case .recordActiveRegular: return "\u{f940}"
        case .recordBold: return "\u{f941}"
        case .recordFilled: return "\u{f942}"
        case .recordLight: return "\u{f943}"
        case .recordPausedBadgeFilled: return "\u{f944}"
        case .recordPausedBold: return "\u{f945}"
        case .recordPausedFilled: return "\u{f946}"
        case .recordPausedLight: return "\u{f947}"
        case .recordPausedRegular: return "\u{f948}"
        case .recordRegular: return "\u{f949}"
        case .recurringBold: return "\u{f94a}"
        case .recurringLight: return "\u{f94b}"
        case .recurringOffBold: return "\u{f94c}"
        case .recurringOffLight: return "\u{f94d}"
        case .recurringOffRegular: return "\u{f94e}"
        case .recurringRegular: return "\u{f94f}"
        case .redLight: return "\u{f950}"
        case .redoBold: return "\u{f951}"
        case .redoLight: return "\u{f952}"
        case .redoRegular: return "\u{f953}"
        case .refreshBold: return "\u{f954}"
        case .refreshLight: return "\u{f955}"
        case .refreshRegular: return "\u{f956}"
        case .remoteDesktopControlBold: return "\u{f957}"
        case .remoteDesktopControlFilled: return "\u{f958}"
        case .remoteDesktopControlLight: return "\u{f959}"
        case .remoteDesktopControlRegular: return "\u{f95a}"
        case .removeBold: return "\u{f95b}"
        case .removeFilled: return "\u{f95c}"
        case .removeLight: return "\u{f95d}"
        case .removeRegular: return "\u{f95e}"
        case .replyBold: return "\u{f95f}"
        case .replyFilled: return "\u{f960}"
        case .replyLight: return "\u{f961}"
        case .replyListBold: return "\u{f962}"
        case .replyListLight: return "\u{f963}"
        case .replyListRegular: return "\u{f964}"
        case .replyPrivatelyBold: return "\u{f965}"
        case .replyPrivatelyLight: return "\u{f966}"
        case .replyPrivatelyRegular: return "\u{f967}"
        case .replyRegular: return "\u{f968}"
        case .resetBold: return "\u{f969}"
        case .resetLight: return "\u{f96a}"
        case .resetRegular: return "\u{f96b}"
        case .resizeCornerBold: return "\u{f96c}"
        case .resizeCornerLight: return "\u{f96d}"
        case .resizeCornerRegular: return "\u{f96e}"
        case .responsiveMobileBold: return "\u{f96f}"
        case .responsiveMobileLight: return "\u{f970}"
        case .responsiveMobileRegular: return "\u{f971}"
        case .restartBold: return "\u{f972}"
        case .restartLight: return "\u{f973}"
        case .restartRegular: return "\u{f974}"
        case .retrieveCallBold: return "\u{f975}"
        case .retrieveCallFilled: return "\u{f976}"
        case .retrieveCallLight: return "\u{f977}"
        case .retrieveCallRegular: return "\u{f978}"
        case .returnBold: return "\u{f979}"
        case .returnLight: return "\u{f97a}"
        case .returnRegular: return "\u{f97b}"
        case .rewindTenSecBold: return "\u{f97c}"
        case .rewindTenSecLight: return "\u{f97d}"
        case .rewindTenSecRegular: return "\u{f97e}"
        case .ringtoneBold: return "\u{f97f}"
        case .ringtoneLight: return "\u{f980}"
        case .ringtoneRegular: return "\u{f981}"
        case .roomCalendarBold: return "\u{f982}"
        case .roomCalendarLight: return "\u{f983}"
        case .roomCalendarRegular: return "\u{f984}"
        case .roomLightsBold: return "\u{f985}"
        case .roomLightsFilled: return "\u{f986}"
        case .roomLightsLight: return "\u{f987}"
        case .roomLightsRegular: return "\u{f988}"
        case .rotateContentBold: return "\u{f989}"
        case .rotateContentFilled: return "\u{f98a}"
        case .rotateContentLight: return "\u{f98b}"
        case .rotateContentRegular: return "\u{f98c}"
        case .rssBold: return "\u{f98d}"
        case .rssFilled: return "\u{f98e}"
        case .rssLight: return "\u{f98f}"
        case .rssRegular: return "\u{f990}"
        case .ruleBasedBold: return "\u{f991}"
        case .ruleBasedLight: return "\u{f992}"
        case .ruleBasedRegular: return "\u{f993}"
        case .runningApplicationBold: return "\u{f994}"
        case .runningApplicationFilled: return "\u{f995}"
        case .runningApplicationLight: return "\u{f996}"
        case .runningApplicationRegular: return "\u{f997}"
        case .saveBold: return "\u{f998}"
        case .saveLight: return "\u{f999}"
        case .saveRegular: return "\u{f99a}"
        case .saveTranscriptBold: return "\u{f99b}"
        case .saveTranscriptFilled: return "\u{f99c}"
        case .saveTranscriptLight: return "\u{f99d}"
        case .saveTranscriptRegular: return "\u{f99e}"
        case .scanBold: return "\u{f99f}"
        case .scanLight: return "\u{f9a0}"
        case .scanRegular: return "\u{f9a1}"
        case .scheduleSendBold: return "\u{f9a2}"
        case .scheduleSendFilled: return "\u{f9a3}"
        case .scheduleSendLight: return "\u{f9a4}"
        case .scheduleSendRegular: return "\u{f9a5}"
        case .scheduleWinnerBold: return "\u{f9a6}"
        case .scheduleWinnerFilled: return "\u{f9a7}"
        case .scheduleWinnerLight: return "\u{f9a8}"
        case .scheduleWinnerRegular: return "\u{f9a9}"
        case .schedulerAvailableBold: return "\u{f9aa}"
        case .schedulerAvailableLight: return "\u{f9ab}"
        case .schedulerAvailableRegular: return "\u{f9ac}"
        case .schedulerNotWorkingHoursBold: return "\u{f9ad}"
        case .schedulerNotWorkingHoursLight: return "\u{f9ae}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9af}"
        case .schedulerUnavailableBold: return "\u{f9b0}"
        case .schedulerUnavailableLight: return "\u{f9b1}"
        case .schedulerUnavailableRegular: return "\u{f9b2}"
        case .schedulerUnknownBold: return "\u{f9b3}"
        case .schedulerUnknownLight: return "\u{f9b4}"
        case .schedulerUnknownRegular: return "\u{f9b5}"
        case .screenshotBold: return "\u{f9b6}"
        case .screenshotDocBold: return "\u{f9b7}"
        case .screenshotDocFilled: return "\u{f9b8}"
        case .screenshotDocLight: return "\u{f9b9}"
        case .screenshotDocRegular: return "\u{f9ba}"
        case .screenshotLight: return "\u{f9bb}"
        case .screenshotRegular: return "\u{f9bc}"
        case .searchBold: return "\u{f9bd}"
        case .searchFilled: return "\u{f9be}"
        case .searchLight: return "\u{f9bf}"
        case .searchRegular: return "\u{f9c0}"
        case .secondaryArrowBold: return "\u{f9c1}"
        case .secondaryArrowLight: return "\u{f9c2}"
        case .secondaryArrowRegular: return "\u{f9c3}"
        case .secureCallLockBold: return "\u{f9c4}"
        case .secureCallLockFilled: return "\u{f9c5}"
        case .secureCallLockLight: return "\u{f9c6}"
        case .secureCallLockRegular: return "\u{f9c7}"
        case .secureCallShieldBold: return "\u{f9c8}"
        case .secureCallShieldFilled: return "\u{f9c9}"
        case .secureCallShieldLight: return "\u{f9ca}"
        case .secureCallShieldRegular: return "\u{f9cb}"
        case .secureCircleBold: return "\u{f9cc}"
        case .secureCircleFilled: return "\u{f9cd}"
        case .secureCircleLight: return "\u{f9ce}"
        case .secureCircleRegular: return "\u{f9cf}"
        case .secureLockBold: return "\u{f9d0}"
        case .secureLockFilled: return "\u{f9d1}"
        case .secureLockLight: return "\u{f9d2}"
        case .secureLockRegular: return "\u{f9d3}"
        case .segmentExcludeFilled: return "\u{f9d4}"
        case .segmentFilterFilled: return "\u{f9d5}"
        case .segmentIncludeFilled: return "\u{f9d6}"
        case .selectAllBold: return "\u{f9d7}"
        case .selectAllFilled: return "\u{f9d8}"
        case .selectAllLight: return "\u{f9d9}"
        case .selectAllRegular: return "\u{f9da}"
        case .selectionBold: return "\u{f9db}"
        case .selectionFilled: return "\u{f9dc}"
        case .selectionLight: return "\u{f9dd}"
        case .selectionRegular: return "\u{f9de}"
        case .sendBold: return "\u{f9df}"
        case .sendDigitsBold: return "\u{f9e0}"
        case .sendDigitsFilled: return "\u{f9e1}"
        case .sendDigitsLight: return "\u{f9e2}"
        case .sendDigitsRegular: return "\u{f9e3}"
        case .sendFilled: return "\u{f9e4}"
        case .sendLight: return "\u{f9e5}"
        case .sendRegular: return "\u{f9e6}"
        case .sendVoiceBold: return "\u{f9e7}"
        case .sendVoiceFilled: return "\u{f9e8}"
        case .sendVoiceLight: return "\u{f9e9}"
        case .sendVoiceRegular: return "\u{f9ea}"
        case .serverBold: return "\u{f9eb}"
        case .serverErrorBold: return "\u{f9ec}"
        case .serverErrorLight: return "\u{f9ed}"
        case .serverErrorRegular: return "\u{f9ee}"
        case .serverLight: return "\u{f9ef}"
        case .serverRegular: return "\u{f9f0}"
        case .servicesBold: return "\u{f9f1}"
        case .servicesLight: return "\u{f9f2}"
        case .servicesRegular: return "\u{f9f3}"
        case .setVariableBold: return "\u{f9f4}"
        case .setVariableLight: return "\u{f9f5}"
        case .setVariableRegular: return "\u{f9f6}"
        case .settingsBold: return "\u{f9f7}"
        case .settingsFilled: return "\u{f9f8}"
        case .settingsLight: return "\u{f9f9}"
        case .settingsRegular: return "\u{f9fa}"
        case .setupAssistantBold: return "\u{f9fb}"
        case .setupAssistantLight: return "\u{f9fc}"
        case .setupAssistantRegular: return "\u{f9fd}"
        case .sftpBold: return "\u{f9fe}"
        case .sftpLight: return "\u{f9ff}"
        case .sftpRegular: return "\u{fa00}"
        case .shapeCircleBold: return "\u{fa01}"
        case .shapeCircleFilled: return "\u{fa02}"
        case .shapeCircleLight: return "\u{fa03}"
        case .shapeCircleMdFilled: return "\u{fa04}"
        case .shapeCircleRegular: return "\u{fa05}"
        case .shapeCircleSmFilled: return "\u{fa06}"
        case .shapeDiagonalLineBold: return "\u{fa07}"
        case .shapeDiagonalLineLight: return "\u{fa08}"
        case .shapeDiagonalLineRegular: return "\u{fa09}"
        case .shapeDiamondBold: return "\u{fa0a}"
        case .shapeDiamondFilled: return "\u{fa0b}"
        case .shapeDiamondLight: return "\u{fa0c}"
        case .shapeDiamondRegular: return "\u{fa0d}"
        case .shapeOvalBold: return "\u{fa0e}"
        case .shapeOvalLight: return "\u{fa0f}"
        case .shapeOvalRegular: return "\u{fa10}"
        case .shapeSquareBold: return "\u{fa11}"
        case .shapeSquareFilled: return "\u{fa12}"
        case .shapeSquareLight: return "\u{fa13}"
        case .shapeSquareRegular: return "\u{fa14}"
        case .shapeTriangleBold: return "\u{fa15}"
        case .shapeTriangleFilled: return "\u{fa16}"
        case .shapeTriangleLight: return "\u{fa17}"
        case .shapeTriangleRegular: return "\u{fa18}"
        case .shapesBold: return "\u{fa19}"
        case .shapesFilled: return "\u{fa1a}"
        case .shapesLight: return "\u{fa1b}"
        case .shapesRegular: return "\u{fa1c}"
        case .shareCNativeAdrBold: return "\u{fa1d}"
        case .shareCNativeAdrFilled: return "\u{fa1e}"
        case .shareCNativeAdrLight: return "\u{fa1f}"
        case .shareCNativeAdrRegular: return "\u{fa20}"
        case .shareCNativeIphBold: return "\u{fa21}"
        case .shareCNativeIphLight: return "\u{fa22}"
        case .shareCNativeIphRegular: return "\u{fa23}"
        case .shareContentOnDeviceBold: return "\u{fa24}"
        case .shareContentOnDeviceLight: return "\u{fa25}"
        case .shareContentOnDeviceRegular: return "\u{fa26}"
        case .shareScreenAddBold: return "\u{fa27}"
        case .shareScreenAddLight: return "\u{fa28}"
        case .shareScreenAddRegular: return "\u{fa29}"
        case .shareScreenBadgeFilled: return "\u{fa2a}"
        case .shareScreenBold: return "\u{fa2b}"
        case .shareScreenFilled: return "\u{fa2c}"
        case .shareScreenLight: return "\u{fa2d}"
        case .shareScreenRegular: return "\u{fa2e}"
        case .shareSpaceBold: return "\u{fa2f}"
        case .shareSpaceLight: return "\u{fa30}"
        case .shareSpaceRegular: return "\u{fa31}"
        case .shieldBold: return "\u{fa32}"
        case .shieldLight: return "\u{fa33}"
        case .shieldRegular: return "\u{fa34}"
        case .shoppingCartBold: return "\u{fa35}"
        case .shoppingCartFilled: return "\u{fa36}"
        case .shoppingCartLight: return "\u{fa37}"
        case .shoppingCartRegular: return "\u{fa38}"
        case .shortTextBoxBold: return "\u{fa39}"
        case .shortTextBoxLight: return "\u{fa3a}"
        case .shortTextBoxRegular: return "\u{fa3b}"
        case .showBold: return "\u{fa3c}"
        case .showFilled: return "\u{fa3d}"
        case .showLight: return "\u{fa3e}"
        case .showRegular: return "\u{fa3f}"
        case .signInBold: return "\u{fa40}"
        case .signInFilled: return "\u{fa41}"
        case .signInForcedBold: return "\u{fa42}"
        case .signInForcedLight: return "\u{fa43}"
        case .signInForcedRegular: return "\u{fa44}"
        case .signInLight: return "\u{fa45}"
        case .signInRegular: return "\u{fa46}"
        case .signLangIntBold: return "\u{fa47}"
        case .signLangIntLight: return "\u{fa48}"
        case .signLangIntRegular: return "\u{fa49}"
        case .signOutBold: return "\u{fa4a}"
        case .signOutLight: return "\u{fa4b}"
        case .signOutRegular: return "\u{fa4c}"
        case .signalFourBold: return "\u{fa4d}"
        case .signalFourLight: return "\u{fa4e}"
        case .signalFourRegular: return "\u{fa4f}"
        case .signalOneBold: return "\u{fa50}"
        case .signalOneLight: return "\u{fa51}"
        case .signalOneRegular: return "\u{fa52}"
        case .signalThreeBold: return "\u{fa53}"
        case .signalThreeLight: return "\u{fa54}"
        case .signalThreeRegular: return "\u{fa55}"
        case .signalTwoBold: return "\u{fa56}"
        case .signalTwoLight: return "\u{fa57}"
        case .signalTwoRegular: return "\u{fa58}"
        case .signalZeroBold: return "\u{fa59}"
        case .signalZeroLight: return "\u{fa5a}"
        case .signalZeroRegular: return "\u{fa5b}"
        case .simplePromotionBold: return "\u{fa5c}"
        case .simplePromotionLight: return "\u{fa5d}"
        case .simplePromotionRegular: return "\u{fa5e}"
        case .singleNumberReachBold: return "\u{fa5f}"
        case .singleNumberReachLight: return "\u{fa60}"
        case .singleNumberReachRegular: return "\u{fa61}"
        case .sipRegistrationInProgressBold: return "\u{fa62}"
        case .sipRegistrationInProgressFilled: return "\u{fa63}"
        case .sipRegistrationInProgressLight: return "\u{fa64}"
        case .sipRegistrationInProgressRegular: return "\u{fa65}"
        case .skipBold: return "\u{fa66}"
        case .skipBwBold: return "\u{fa67}"
        case .skipBwFilled: return "\u{fa68}"
        case .skipBwLight: return "\u{fa69}"
        case .skipBwRegular: return "\u{fa6a}"
        case .skipFwBold: return "\u{fa6b}"
        case .skipFwFilled: return "\u{fa6c}"
        case .skipFwLight: return "\u{fa6d}"
        case .skipFwRegular: return "\u{fa6e}"
        case .skipLight: return "\u{fa6f}"
        case .skipRegular: return "\u{fa70}"
        case .smartAudioBold: return "\u{fa71}"
        case .smartAudioLight: return "\u{fa72}"
        case .smartAudioRegular: return "\u{fa73}"
        case .smsFilled: return "\u{fa74}"
        case .smsInboundBold: return "\u{fa75}"
        case .smsInboundLight: return "\u{fa76}"
        case .smsInboundRegular: return "\u{fa77}"
        case .smsMessageBold: return "\u{fa78}"
        case .smsMessageFilled: return "\u{fa79}"
        case .smsMessageLight: return "\u{fa7a}"
        case .smsMessageRegular: return "\u{fa7b}"
        case .smsOutgoingFilled: return "\u{fa7c}"
        case .smsUnreadBold: return "\u{fa7d}"
        case .smsUnreadLight: return "\u{fa7e}"
        case .smsUnreadRegular: return "\u{fa7f}"
        case .sortAscendingBold: return "\u{fa80}"
        case .sortAscendingLight: return "\u{fa81}"
        case .sortAscendingRegular: return "\u{fa82}"
        case .sortDescendingBold: return "\u{fa83}"
        case .sortDescendingLight: return "\u{fa84}"
        case .sortDescendingRegular: return "\u{fa85}"
        case .soundDefaultBold: return "\u{fa86}"
        case .soundDefaultLight: return "\u{fa87}"
        case .soundDefaultRegular: return "\u{fa88}"
        case .sparkleBold: return "\u{fa89}"
        case .sparkleFilled: return "\u{fa8a}"
        case .sparkleLight: return "\u{fa8b}"
        case .sparkleRegular: return "\u{fa8c}"
        case .speakerBold: return "\u{fa8d}"
        case .speakerDisconnectedBold: return "\u{fa8e}"
        case .speakerDisconnectedFilled: return "\u{fa8f}"
        case .speakerDisconnectedLight: return "\u{fa90}"
        case .speakerDisconnectedRegular: return "\u{fa91}"
        case .speakerFilled: return "\u{fa92}"
        case .speakerLight: return "\u{fa93}"
        case .speakerMutedBold: return "\u{fa94}"
        case .speakerMutedFilled: return "\u{fa95}"
        case .speakerMutedLight: return "\u{fa96}"
        case .speakerMutedRegular: return "\u{fa97}"
        case .speakerOffBold: return "\u{fa98}"
        case .speakerOffFilled: return "\u{fa99}"
        case .speakerOffLight: return "\u{fa9a}"
        case .speakerOffRegular: return "\u{fa9b}"
        case .speakerOnBold: return "\u{fa9c}"
        case .speakerOnLight: return "\u{fa9d}"
        case .speakerOnRegular: return "\u{fa9e}"
        case .speakerRegular: return "\u{fa9f}"
        case .speakerTurnDownBold: return "\u{faa0}"
        case .speakerTurnDownFilled: return "\u{faa1}"
        case .speakerTurnDownLight: return "\u{faa2}"
        case .speakerTurnDownRegular: return "\u{faa3}"
        case .speakerTurnUpBold: return "\u{faa4}"
        case .speakerTurnUpFilled: return "\u{faa5}"
        case .speakerTurnUpLight: return "\u{faa6}"
        case .speakerTurnUpRegular: return "\u{faa7}"
        case .speedDialBold: return "\u{faa8}"
        case .speedDialFilled: return "\u{faa9}"
        case .speedDialLight: return "\u{faaa}"
        case .speedDialRegular: return "\u{faab}"
        case .spellCheckerBold: return "\u{faac}"
        case .spellCheckerLight: return "\u{faad}"
        case .spellCheckerRegular: return "\u{faae}"
        case .splitViewBold: return "\u{faaf}"
        case .splitViewLight: return "\u{fab0}"
        case .splitViewRegular: return "\u{fab1}"
        case .stackedAreaChartBold: return "\u{fab2}"
        case .stackedAreaChartFilled: return "\u{fab3}"
        case .stackedAreaChartFullBold: return "\u{fab4}"
        case .stackedAreaChartFullFilled: return "\u{fab5}"
        case .stackedAreaChartFullLight: return "\u{fab6}"
        case .stackedAreaChartFullRegular: return "\u{fab7}"
        case .stackedAreaChartLight: return "\u{fab8}"
        case .stackedAreaChartRegular: return "\u{fab9}"
        case .stackedBarChartBold: return "\u{faba}"
        case .stackedBarChartFilled: return "\u{fabb}"
        case .stackedBarChartFullBold: return "\u{fabc}"
        case .stackedBarChartFullFilled: return "\u{fabd}"
        case .stackedBarChartFullLight: return "\u{fabe}"
        case .stackedBarChartFullRegular: return "\u{fabf}"
        case .stackedBarChartLight: return "\u{fac0}"
        case .stackedBarChartRegular: return "\u{fac1}"
        case .startChatBold: return "\u{fac2}"
        case .startChatLight: return "\u{fac3}"
        case .startChatRegular: return "\u{fac4}"
        case .stethoscopeBold: return "\u{fac5}"
        case .stethoscopeLight: return "\u{fac6}"
        case .stethoscopeRegular: return "\u{fac7}"
        case .stickersBold: return "\u{fac8}"
        case .stickersLight: return "\u{fac9}"
        case .stickersRegular: return "\u{faca}"
        case .stickiesBold: return "\u{facb}"
        case .stickiesLight: return "\u{facc}"
        case .stickiesRegular: return "\u{facd}"
        case .stopBold: return "\u{face}"
        case .stopCircleBold: return "\u{facf}"
        case .stopCircleFilled: return "\u{fad0}"
        case .stopCircleLight: return "\u{fad1}"
        case .stopCircleRegular: return "\u{fad2}"
        case .stopContentShareBold: return "\u{fad3}"
        case .stopContentShareLight: return "\u{fad4}"
        case .stopContentShareRegular: return "\u{fad5}"
        case .stopFilled: return "\u{fad6}"
        case .stopLight: return "\u{fad7}"
        case .stopRegular: return "\u{fad8}"
        case .storedInfoBold: return "\u{fad9}"
        case .storedInfoFilled: return "\u{fada}"
        case .storedInfoLight: return "\u{fadb}"
        case .storedInfoRegular: return "\u{fadc}"
        case .streamingBold: return "\u{fadd}"
        case .streamingLight: return "\u{fade}"
        case .streamingRegular: return "\u{fadf}"
        case .strikethroughBold: return "\u{fae0}"
        case .strikethroughFilled: return "\u{fae1}"
        case .strikethroughLight: return "\u{fae2}"
        case .strikethroughRegular: return "\u{fae3}"
        case .studioModeBold: return "\u{fae4}"
        case .studioModeLight: return "\u{fae5}"
        case .studioModeRegular: return "\u{fae6}"
        case .subscriptBold: return "\u{fae7}"
        case .subscriptLight: return "\u{fae8}"
        case .subscriptRegular: return "\u{fae9}"
        case .superscriptBold: return "\u{faea}"
        case .superscriptLight: return "\u{faeb}"
        case .superscriptRegular: return "\u{faec}"
        case .surveyBold: return "\u{faed}"
        case .surveyFilled: return "\u{faee}"
        case .surveyLight: return "\u{faef}"
        case .surveyRegular: return "\u{faf0}"
        case .sxEightyCodecBold: return "\u{faf1}"
        case .sxEightyCodecLight: return "\u{faf2}"
        case .sxEightyCodecRegular: return "\u{faf3}"
        case .sxTenBold: return "\u{faf4}"
        case .sxTenLight: return "\u{faf5}"
        case .sxTenRegular: return "\u{faf6}"
        case .sxTwentyBold: return "\u{faf7}"
        case .sxTwentyLight: return "\u{faf8}"
        case .sxTwentyRegular: return "\u{faf9}"
        case .tableBold: return "\u{fafa}"
        case .tableLight: return "\u{fafb}"
        case .tableRegular: return "\u{fafc}"
        case .tabletBold: return "\u{fafd}"
        case .tabletLight: return "\u{fafe}"
        case .tabletRegular: return "\u{faff}"
        case .tabsBold: return "\u{fb00}"
        case .tabsLight: return "\u{fb01}"
        case .tabsRegular: return "\u{fb02}"
        case .tagBold: return "\u{fb03}"
        case .tagLight: return "\u{fb04}"
        case .tagRegular: return "\u{fb05}"
        case .tapBold: return "\u{fb06}"
        case .tapFilled: return "\u{fb07}"
        case .tapLight: return "\u{fb08}"
        case .tapRegular: return "\u{fb09}"
        case .telepresenceAlertBold: return "\u{fb0a}"
        case .telepresenceAlertLight: return "\u{fb0b}"
        case .telepresenceAlertMutedBold: return "\u{fb0c}"
        case .telepresenceAlertMutedLight: return "\u{fb0d}"
        case .telepresenceAlertMutedRegular: return "\u{fb0e}"
        case .telepresenceAlertRegular: return "\u{fb0f}"
        case .telepresenceBold: return "\u{fb10}"
        case .telepresenceIxFiveThousandBold: return "\u{fb11}"
        case .telepresenceIxFiveThousandLight: return "\u{fb12}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb13}"
        case .telepresenceLight: return "\u{fb14}"
        case .telepresenceMutedBold: return "\u{fb15}"
        case .telepresenceMutedLight: return "\u{fb16}"
        case .telepresenceMutedRegular: return "\u{fb17}"
        case .telepresencePrivateBold: return "\u{fb18}"
        case .telepresencePrivateLight: return "\u{fb19}"
        case .telepresencePrivateRegular: return "\u{fb1a}"
        case .telepresenceRegular: return "\u{fb1b}"
        case .temperatureBold: return "\u{fb1c}"
        case .temperatureLight: return "\u{fb1d}"
        case .temperatureRegular: return "\u{fb1e}"
        case .testTubeBold: return "\u{fb1f}"
        case .testTubeFilled: return "\u{fb20}"
        case .testTubeLight: return "\u{fb21}"
        case .testTubeRegular: return "\u{fb22}"
        case .textAlignCenterBold: return "\u{fb23}"
        case .textAlignCenterFilled: return "\u{fb24}"
        case .textAlignCenterLight: return "\u{fb25}"
        case .textAlignCenterRegular: return "\u{fb26}"
        case .textAlignLeftBold: return "\u{fb27}"
        case .textAlignLeftFilled: return "\u{fb28}"
        case .textAlignLeftLight: return "\u{fb29}"
        case .textAlignLeftRegular: return "\u{fb2a}"
        case .textAlignRightBold: return "\u{fb2b}"
        case .textAlignRightFilled: return "\u{fb2c}"
        case .textAlignRightLight: return "\u{fb2d}"
        case .textAlignRightRegular: return "\u{fb2e}"
        case .textBold: return "\u{fb2f}"
        case .textBoxCursorLight: return "\u{fb30}"
        case .textCodeBlockBold: return "\u{fb31}"
        case .textCodeBlockLight: return "\u{fb32}"
        case .textCodeBlockRegular: return "\u{fb33}"
        case .textHighlightBold: return "\u{fb34}"
        case .textHighlightFilled: return "\u{fb35}"
        case .textHighlightLight: return "\u{fb36}"
        case .textHighlightRegular: return "\u{fb37}"
        case .textLight: return "\u{fb38}"
        case .textRegular: return "\u{fb39}"
        case .threeColumnBold: return "\u{fb3a}"
        case .threeColumnLight: return "\u{fb3b}"
        case .threeColumnRegular: return "\u{fb3c}"
        case .threeDObjectBold: return "\u{fb3d}"
        case .threeDObjectLight: return "\u{fb3e}"
        case .threeDObjectRegular: return "\u{fb3f}"
        case .timeExclusionBold: return "\u{fb40}"
        case .timeExclusionLight: return "\u{fb41}"
        case .timeExclusionRegular: return "\u{fb42}"
        case .tooFastBold: return "\u{fb43}"
        case .tooFastLight: return "\u{fb44}"
        case .tooFastRegular: return "\u{fb45}"
        case .tooSlowBold: return "\u{fb46}"
        case .tooSlowLight: return "\u{fb47}"
        case .tooSlowRegular: return "\u{fb48}"
        case .toolsBold: return "\u{fb49}"
        case .toolsFilled: return "\u{fb4a}"
        case .toolsLight: return "\u{fb4b}"
        case .toolsRegular: return "\u{fb4c}"
        case .touchTenBold: return "\u{fb4d}"
        case .touchTenLight: return "\u{fb4e}"
        case .touchTenRegular: return "\u{fb4f}"
        case .transcriptBold: return "\u{fb50}"
        case .transcriptFilled: return "\u{fb51}"
        case .transcriptLight: return "\u{fb52}"
        case .transcriptRegular: return "\u{fb53}"
        case .translateBold: return "\u{fb54}"
        case .translateLight: return "\u{fb55}"
        case .translateRegular: return "\u{fb56}"
        case .translateUndoBold: return "\u{fb57}"
        case .translateUndoLight: return "\u{fb58}"
        case .translateUndoRegular: return "\u{fb59}"
        case .trendingBold: return "\u{fb5a}"
        case .trendingDownBold: return "\u{fb5b}"
        case .trendingDownFilled: return "\u{fb5c}"
        case .trendingDownLight: return "\u{fb5d}"
        case .trendingDownRegular: return "\u{fb5e}"
        case .trendingFilled: return "\u{fb5f}"
        case .trendingLight: return "\u{fb60}"
        case .trendingRegular: return "\u{fb61}"
        case .trimBold: return "\u{fb62}"
        case .trimLight: return "\u{fb63}"
        case .trimRegular: return "\u{fb64}"
        case .twoColumnBold: return "\u{fb65}"
        case .twoColumnLight: return "\u{fb66}"
        case .twoColumnRegular: return "\u{fb67}"
        case .twoWayVoiceStreamBold: return "\u{fb68}"
        case .twoWayVoiceStreamFilled: return "\u{fb69}"
        case .twoWayVoiceStreamLight: return "\u{fb6a}"
        case .twoWayVoiceStreamRegular: return "\u{fb6b}"
        case .ucmCloudBold: return "\u{fb6c}"
        case .ucmCloudLight: return "\u{fb6d}"
        case .ucmCloudRegular: return "\u{fb6e}"
        case .unblockBold: return "\u{fb6f}"
        case .unblockFilled: return "\u{fb70}"
        case .unblockLight: return "\u{fb71}"
        case .unblockRegular: return "\u{fb72}"
        case .underlineBold: return "\u{fb73}"
        case .underlineFilled: return "\u{fb74}"
        case .underlineLight: return "\u{fb75}"
        case .underlineRegular: return "\u{fb76}"
        case .undoBold: return "\u{fb77}"
        case .undoLight: return "\u{fb78}"
        case .undoRegular: return "\u{fb79}"
        case .unlinkBold: return "\u{fb7a}"
        case .unlinkLight: return "\u{fb7b}"
        case .unlinkRegular: return "\u{fb7c}"
        case .unreadBold: return "\u{fb7d}"
        case .unreadFilled: return "\u{fb7e}"
        case .unreadLight: return "\u{fb7f}"
        case .unreadRegular: return "\u{fb80}"
        case .unsecureUnlockedBold: return "\u{fb81}"
        case .unsecureUnlockedFilled: return "\u{fb82}"
        case .unsecureUnlockedLight: return "\u{fb83}"
        case .unsecureUnlockedRegular: return "\u{fb84}"
        case .unsortedBold: return "\u{fb85}"
        case .unsortedLight: return "\u{fb86}"
        case .unsortedRegular: return "\u{fb87}"
        case .updateFileShareBold: return "\u{fb88}"
        case .updateFileShareLight: return "\u{fb89}"
        case .updateFileShareRegular: return "\u{fb8a}"
        case .uploadBold: return "\u{fb8b}"
        case .uploadImageBold: return "\u{fb8c}"
        case .uploadImageLight: return "\u{fb8d}"
        case .uploadImageRegular: return "\u{fb8e}"
        case .uploadLight: return "\u{fb8f}"
        case .uploadRegular: return "\u{fb90}"
        case .urgentVoicemailBold: return "\u{fb91}"
        case .urgentVoicemailFilled: return "\u{fb92}"
        case .usbBold: return "\u{fb93}"
        case .usbHeadsetBold: return "\u{fb94}"
        case .usbHeadsetLight: return "\u{fb95}"
        case .usbHeadsetMutedBold: return "\u{fb96}"
        case .usbHeadsetMutedLight: return "\u{fb97}"
        case .usbHeadsetMutedRegular: return "\u{fb98}"
        case .usbHeadsetRegular: return "\u{fb99}"
        case .usbLight: return "\u{fb9a}"
        case .usbRegular: return "\u{fb9b}"
        case .userBold: return "\u{fb9c}"
        case .userDeactivateBold: return "\u{fb9d}"
        case .userDeactivateLight: return "\u{fb9e}"
        case .userDeactivateRegular: return "\u{fb9f}"
        case .userLight: return "\u{fba0}"
        case .userRegular: return "\u{fba1}"
        case .videoBlurBold: return "\u{fba2}"
        case .videoBlurFilled: return "\u{fba3}"
        case .videoBlurLight: return "\u{fba4}"
        case .videoBlurRegular: return "\u{fba5}"
        case .videoBold: return "\u{fba6}"
        case .videoEffectBold: return "\u{fba7}"
        case .videoEffectFilled: return "\u{fba8}"
        case .videoEffectLight: return "\u{fba9}"
        case .videoEffectRegular: return "\u{fbaa}"
        case .videoFilled: return "\u{fbab}"
        case .videoLayoutBold: return "\u{fbac}"
        case .videoLayoutEqualBold: return "\u{fbad}"
        case .videoLayoutEqualDualBold: return "\u{fbae}"
        case .videoLayoutEqualDualLight: return "\u{fbaf}"
        case .videoLayoutEqualDualRegular: return "\u{fbb0}"
        case .videoLayoutEqualFilled: return "\u{fbb1}"
        case .videoLayoutEqualLight: return "\u{fbb2}"
        case .videoLayoutEqualRegular: return "\u{fbb3}"
        case .videoLayoutFilled: return "\u{fbb4}"
        case .videoLayoutLight: return "\u{fbb5}"
        case .videoLayoutOverlayBold: return "\u{fbb6}"
        case .videoLayoutOverlayFilled: return "\u{fbb7}"
        case .videoLayoutOverlayLight: return "\u{fbb8}"
        case .videoLayoutOverlayRegular: return "\u{fbb9}"
        case .videoLayoutPresenterDominantBold: return "\u{fbba}"
        case .videoLayoutPresenterDominantLight: return "\u{fbbb}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbbc}"
        case .videoLayoutProminentBold: return "\u{fbbd}"
        case .videoLayoutProminentFilled: return "\u{fbbe}"
        case .videoLayoutProminentLight: return "\u{fbbf}"
        case .videoLayoutProminentRegular: return "\u{fbc0}"
        case .videoLayoutRegular: return "\u{fbc1}"
        case .videoLayoutShareDominantBold: return "\u{fbc2}"
        case .videoLayoutShareDominantLight: return "\u{fbc3}"
        case .videoLayoutShareDominantRegular: return "\u{fbc4}"
        case .videoLayoutSingleBold: return "\u{fbc5}"
        case .videoLayoutSingleFilled: return "\u{fbc6}"
        case .videoLayoutSingleLight: return "\u{fbc7}"
        case .videoLayoutSingleRegular: return "\u{fbc8}"
        case .videoLayoutStackBold: return "\u{fbc9}"
        case .videoLayoutStackFilled: return "\u{fbca}"
        case .videoLayoutStackLight: return "\u{fbcb}"
        case .videoLayoutStackRegular: return "\u{fbcc}"
        case .videoLayoutVideoDominantBold: return "\u{fbcd}"
        case .videoLayoutVideoDominantFilled: return "\u{fbce}"
        case .videoLayoutVideoDominantLight: return "\u{fbcf}"
        case .videoLayoutVideoDominantRegular: return "\u{fbd0}"
        case .videoLight: return "\u{fbd1}"
        case .videoPlusBold: return "\u{fbd2}"
        case .videoPlusFilled: return "\u{fbd3}"
        case .videoPlusLight: return "\u{fbd4}"
        case .videoPlusRegular: return "\u{fbd5}"
        case .videoRegular: return "\u{fbd6}"
        case .videoSpeakerTrackBold: return "\u{fbd7}"
        case .videoSpeakerTrackFilled: return "\u{fbd8}"
        case .videoSpeakerTrackLight: return "\u{fbd9}"
        case .videoSpeakerTrackRegular: return "\u{fbda}"
        case .viewAllBold: return "\u{fbdb}"
        case .viewAllLight: return "\u{fbdc}"
        case .viewAllRegular: return "\u{fbdd}"
        case .viewListBold: return "\u{fbde}"
        case .viewListFilled: return "\u{fbdf}"
        case .viewListLight: return "\u{fbe0}"
        case .viewListRegular: return "\u{fbe1}"
        case .viewStackedBold: return "\u{fbe2}"
        case .viewStackedFilled: return "\u{fbe3}"
        case .viewStackedLight: return "\u{fbe4}"
        case .viewStackedRegular: return "\u{fbe5}"
        case .viewThumbnailBold: return "\u{fbe6}"
        case .viewThumbnailFilled: return "\u{fbe7}"
        case .viewThumbnailLight: return "\u{fbe8}"
        case .viewThumbnailRegular: return "\u{fbe9}"
        case .visionproBold: return "\u{fbea}"
        case .visionproFilled: return "\u{fbeb}"
        case .visionproLight: return "\u{fbec}"
        case .visionproMoveCallInBold: return "\u{fbed}"
        case .visionproMoveCallInFilled: return "\u{fbee}"
        case .visionproMoveCallInLight: return "\u{fbef}"
        case .visionproMoveCallInOutBold: return "\u{fbf0}"
        case .visionproMoveCallInOutFilled: return "\u{fbf1}"
        case .visionproMoveCallInOutLight: return "\u{fbf2}"
        case .visionproMoveCallInOutRegular: return "\u{fbf3}"
        case .visionproMoveCallInRegular: return "\u{fbf4}"
        case .visionproMoveCallOutBold: return "\u{fbf5}"
        case .visionproMoveCallOutFilled: return "\u{fbf6}"
        case .visionproMoveCallOutLight: return "\u{fbf7}"
        case .visionproMoveCallOutRegular: return "\u{fbf8}"
        case .visionproRegular: return "\u{fbf9}"
        case .voicemailBold: return "\u{fbfa}"
        case .voicemailFilled: return "\u{fbfb}"
        case .voicemailLight: return "\u{fbfc}"
        case .voicemailRegular: return "\u{fbfd}"
        case .vpnBold: return "\u{fbfe}"
        case .vpnFilled: return "\u{fbff}"
        case .vpnLight: return "\u{fc00}"
        case .vpnRegular: return "\u{fc01}"
        case .vscBold: return "\u{fc02}"
        case .vscLight: return "\u{fc03}"
        case .vscRegular: return "\u{fc04}"
        case .waffleMenuBold: return "\u{fc05}"
        case .waffleMenuLight: return "\u{fc06}"
        case .waffleMenuRegular: return "\u{fc07}"
        case .waitingRoomBold: return "\u{fc08}"
        case .waitingRoomLight: return "\u{fc09}"
        case .waitingRoomRegular: return "\u{fc0a}"
        case .wallpaperBold: return "\u{fc0b}"
        case .wallpaperLight: return "\u{fc0c}"
        case .wallpaperRegular: return "\u{fc0d}"
        case .warningBadgeFilled: return "\u{fc0e}"
        case .warningBold: return "\u{fc0f}"
        case .warningFilled: return "\u{fc10}"
        case .warningLight: return "\u{fc11}"
        case .warningRegular: return "\u{fc12}"
        case .webexBoardBold: return "\u{fc13}"
        case .webexBoardLight: return "\u{fc14}"
        case .webexBoardRegular: return "\u{fc15}"
        case .webexCodecPlusBold: return "\u{fc16}"
        case .webexCodecPlusLight: return "\u{fc17}"
        case .webexCodecPlusRegular: return "\u{fc18}"
        case .webexDeskCameraBold: return "\u{fc19}"
        case .webexDeskCameraLight: return "\u{fc1a}"
        case .webexDeskCameraRegular: return "\u{fc1b}"
        case .webexMeetingsBold: return "\u{fc1c}"
        case .webexMeetingsFilled: return "\u{fc1d}"
        case .webexMeetingsLight: return "\u{fc1e}"
        case .webexMeetingsRegular: return "\u{fc1f}"
        case .webexQuadCameraBold: return "\u{fc20}"
        case .webexQuadCameraLight: return "\u{fc21}"
        case .webexQuadCameraRegular: return "\u{fc22}"
        case .webexRoomKitBold: return "\u{fc23}"
        case .webexRoomKitLight: return "\u{fc24}"
        case .webexRoomKitPlusBold: return "\u{fc25}"
        case .webexRoomKitPlusLight: return "\u{fc26}"
        case .webexRoomKitPlusRegular: return "\u{fc27}"
        case .webexRoomKitRegular: return "\u{fc28}"
        case .webexShareBold: return "\u{fc29}"
        case .webexShareLight: return "\u{fc2a}"
        case .webexShareRegular: return "\u{fc2b}"
        case .webexTeamsBold: return "\u{fc2c}"
        case .webexTeamsFilled: return "\u{fc2d}"
        case .webexTeamsLight: return "\u{fc2e}"
        case .webexTeamsNewBold: return "\u{fc2f}"
        case .webexTeamsNewFilled: return "\u{fc30}"
        case .webexTeamsNewLight: return "\u{fc31}"
        case .webexTeamsNewRegular: return "\u{fc32}"
        case .webexTeamsRegular: return "\u{fc33}"
        case .webexTeamsRemoveBold: return "\u{fc34}"
        case .webexTeamsRemoveLight: return "\u{fc35}"
        case .webexTeamsRemoveRegular: return "\u{fc36}"
        case .webinarBold: return "\u{fc37}"
        case .webinarFilled: return "\u{fc38}"
        case .webinarLight: return "\u{fc39}"
        case .webinarRegular: return "\u{fc3a}"
        case .weeklyRecurringScheduleBold: return "\u{fc3b}"
        case .weeklyRecurringScheduleLight: return "\u{fc3c}"
        case .weeklyRecurringScheduleRegular: return "\u{fc3d}"
        case .whisperAnnouncementBold: return "\u{fc3e}"
        case .whisperAnnouncementFilled: return "\u{fc3f}"
        case .whisperAnnouncementLight: return "\u{fc40}"
        case .whisperAnnouncementRegular: return "\u{fc41}"
        case .whisperCoachBold: return "\u{fc42}"
        case .whisperCoachFilled: return "\u{fc43}"
        case .whisperCoachLight: return "\u{fc44}"
        case .whisperCoachRegular: return "\u{fc45}"
        case .whiteboardBold: return "\u{fc46}"
        case .whiteboardContentBold: return "\u{fc47}"
        case .whiteboardContentFilled: return "\u{fc48}"
        case .whiteboardContentLight: return "\u{fc49}"
        case .whiteboardContentRegular: return "\u{fc4a}"
        case .whiteboardFilled: return "\u{fc4b}"
        case .whiteboardLight: return "\u{fc4c}"
        case .whiteboardRegular: return "\u{fc4d}"
        case .widgetBold: return "\u{fc4e}"
        case .widgetFilled: return "\u{fc4f}"
        case .widgetLight: return "\u{fc50}"
        case .widgetRegular: return "\u{fc51}"
        case .wifiBold: return "\u{fc52}"
        case .wifiErrorBold: return "\u{fc53}"
        case .wifiErrorLight: return "\u{fc54}"
        case .wifiErrorRegular: return "\u{fc55}"
        case .wifiLight: return "\u{fc56}"
        case .wifiRegular: return "\u{fc57}"
        case .wifiSignalGoodBold: return "\u{fc58}"
        case .wifiSignalGoodLight: return "\u{fc59}"
        case .wifiSignalGoodRegular: return "\u{fc5a}"
        case .wifiSignalPoorBold: return "\u{fc5b}"
        case .wifiSignalPoorLight: return "\u{fc5c}"
        case .wifiSignalPoorRegular: return "\u{fc5d}"
        case .wifiSignalUnstableBold: return "\u{fc5e}"
        case .wifiSignalUnstableLight: return "\u{fc5f}"
        case .wifiSignalUnstableRegular: return "\u{fc60}"
        case .windowCornerScrubBold: return "\u{fc61}"
        case .windowCornerScrubLight: return "\u{fc62}"
        case .windowCornerScrubRegular: return "\u{fc63}"
        case .windowRightCornerScrubBold: return "\u{fc64}"
        case .windowRightCornerScrubLight: return "\u{fc65}"
        case .windowRightCornerScrubRegular: return "\u{fc66}"
        case .windowVerticalScrubBold: return "\u{fc67}"
        case .windowVerticalScrubLight: return "\u{fc68}"
        case .windowVerticalScrubRegular: return "\u{fc69}"
        case .workflowDeploymentsBold: return "\u{fc6a}"
        case .workflowDeploymentsFilled: return "\u{fc6b}"
        case .workflowDeploymentsLight: return "\u{fc6c}"
        case .workflowDeploymentsRegular: return "\u{fc6d}"
        case .workphoneBold: return "\u{fc6e}"
        case .workphoneLight: return "\u{fc6f}"
        case .workphoneRegular: return "\u{fc70}"
        case .yellowLight: return "\u{fc71}"
        case .zoomInBold: return "\u{fc72}"
        case .zoomInLight: return "\u{fc73}"
        case .zoomInRegular: return "\u{fc74}"
        case .zoomOutBold: return "\u{fc75}"
        case .zoomOutLight: return "\u{fc76}"
        case .zoomOutRegular: return "\u{fc77}"
    ...
    public var filename: String {
        ...
        case .purpleLight: return "purple-light"
