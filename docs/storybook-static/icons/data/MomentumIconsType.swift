...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .archiveLight: return "\u{f1a3}"
        case .archiveRegular: return "\u{f1a4}"
        case .areaChartBold: return "\u{f1a5}"
        case .areaChartFilled: return "\u{f1a6}"
        case .areaChartLight: return "\u{f1a7}"
        case .areaChartRegular: return "\u{f1a8}"
        case .areaSelectorBold: return "\u{f1a9}"
        case .areaSelectorLight: return "\u{f1aa}"
        case .areaSelectorRegular: return "\u{f1ab}"
        case .arrowCircleDownBold: return "\u{f1ac}"
        case .arrowCircleDownFilled: return "\u{f1ad}"
        case .arrowCircleDownLight: return "\u{f1ae}"
        case .arrowCircleDownRegular: return "\u{f1af}"
        case .arrowCircleLeftBold: return "\u{f1b0}"
        case .arrowCircleLeftFilled: return "\u{f1b1}"
        case .arrowCircleLeftLight: return "\u{f1b2}"
        case .arrowCircleLeftRegular: return "\u{f1b3}"
        case .arrowCircleRightBold: return "\u{f1b4}"
        case .arrowCircleRightFilled: return "\u{f1b5}"
        case .arrowCircleRightLight: return "\u{f1b6}"
        case .arrowCircleRightRegular: return "\u{f1b7}"
        case .arrowCircleUpBold: return "\u{f1b8}"
        case .arrowCircleUpFilled: return "\u{f1b9}"
        case .arrowCircleUpLight: return "\u{f1ba}"
        case .arrowCircleUpRegular: return "\u{f1bb}"
        case .arrowDownBold: return "\u{f1bc}"
        case .arrowDownFilled: return "\u{f1bd}"
        case .arrowDownLight: return "\u{f1be}"
        case .arrowDownRegular: return "\u{f1bf}"
        case .arrowLeftBold: return "\u{f1c0}"
        case .arrowLeftFilled: return "\u{f1c1}"
        case .arrowLeftLight: return "\u{f1c2}"
        case .arrowLeftRegular: return "\u{f1c3}"
        case .arrowRightBold: return "\u{f1c4}"
        case .arrowRightFilled: return "\u{f1c5}"
        case .arrowRightLight: return "\u{f1c6}"
        case .arrowRightRegular: return "\u{f1c7}"
        case .arrowTailDownBold: return "\u{f1c8}"
        case .arrowTailDownLight: return "\u{f1c9}"
        case .arrowTailDownRegular: return "\u{f1ca}"
        case .arrowTailUpBold: return "\u{f1cb}"
        case .arrowTailUpLight: return "\u{f1cc}"
        case .arrowTailUpRegular: return "\u{f1cd}"
        case .arrowUpBold: return "\u{f1ce}"
        case .arrowUpFilled: return "\u{f1cf}"
        case .arrowUpLight: return "\u{f1d0}"
        case .arrowUpRegular: return "\u{f1d1}"
        case .askForHelpBold: return "\u{f1d2}"
        case .askForHelpFilled: return "\u{f1d3}"
        case .askForHelpLight: return "\u{f1d4}"
        case .askForHelpRegular: return "\u{f1d5}"
        case .assetsBold: return "\u{f1d6}"
        case .assetsFilled: return "\u{f1d7}"
        case .assetsLight: return "\u{f1d8}"
        case .assetsRegular: return "\u{f1d9}"
        case .assignHostBold: return "\u{f1da}"
        case .assignHostLight: return "\u{f1db}"
        case .assignHostRegular: return "\u{f1dc}"
        case .assignPrivilegeBold: return "\u{f1dd}"
        case .assignPrivilegeFilled: return "\u{f1de}"
        case .assignPrivilegeLight: return "\u{f1df}"
        case .assignPrivilegeRegular: return "\u{f1e0}"
        case .attachmentBold: return "\u{f1e1}"
        case .attachmentLight: return "\u{f1e2}"
        case .attachmentRegular: return "\u{f1e3}"
        case .attendantConsoleBold: return "\u{f1e4}"
        case .attendantConsoleFilled: return "\u{f1e5}"
        case .attendantConsoleLight: return "\u{f1e6}"
        case .attendantConsoleRegular: return "\u{f1e7}"
        case .audioBroadcastBold: return "\u{f1e8}"
        case .audioBroadcastLight: return "\u{f1e9}"
        case .audioBroadcastRegular: return "\u{f1ea}"
        case .audioCallBold: return "\u{f1eb}"
        case .audioCallFilled: return "\u{f1ec}"
        case .audioCallLight: return "\u{f1ed}"
        case .audioCallRegular: return "\u{f1ee}"
        case .audioEnhancementBold: return "\u{f1ef}"
        case .audioEnhancementFilled: return "\u{f1f0}"
        case .audioEnhancementLight: return "\u{f1f1}"
        case .audioEnhancementRegular: return "\u{f1f2}"
        case .audioOnlyBold: return "\u{f1f3}"
        case .audioOnlyLight: return "\u{f1f4}"
        case .audioOnlyRegular: return "\u{f1f5}"
        case .audioOptAllBold: return "\u{f1f6}"
        case .audioOptAllLight: return "\u{f1f7}"
        case .audioOptAllRegular: return "\u{f1f8}"
        case .audioOptionsBold: return "\u{f1f9}"
        case .audioOptionsFilled: return "\u{f1fa}"
        case .audioOptionsLight: return "\u{f1fb}"
        case .audioOptionsRegular: return "\u{f1fc}"
        case .autoDetectionBold: return "\u{f1fd}"
        case .autoDetectionLight: return "\u{f1fe}"
        case .autoDetectionRegular: return "\u{f1ff}"
        case .automationBold: return "\u{f200}"
        case .automationLight: return "\u{f201}"
        case .automationRegular: return "\u{f202}"
        case .awayCallingPresenceBold: return "\u{f203}"
        case .awayCallingPresenceFilled: return "\u{f204}"
        case .awayCallingPresenceLight: return "\u{f205}"
        case .awayCallingPresenceRegular: return "\u{f206}"
        case .backBold: return "\u{f207}"
        case .backLight: return "\u{f208}"
        case .backRegular: return "\u{f209}"
        case .backToFullScreenBold: return "\u{f20a}"
        case .backToFullScreenLight: return "\u{f20b}"
        case .backToFullScreenRegular: return "\u{f20c}"
        case .backToTopBold: return "\u{f20d}"
        case .backToTopLight: return "\u{f20e}"
        case .backToTopRegular: return "\u{f20f}"
        case .backlightBold: return "\u{f210}"
        case .backlightLight: return "\u{f211}"
        case .backlightRegular: return "\u{f212}"
        case .backspaceBold: return "\u{f213}"
        case .backspaceLight: return "\u{f214}"
        case .backspaceRegular: return "\u{f215}"
        case .backupDataBold: return "\u{f216}"
        case .backupDataLight: return "\u{f217}"
        case .backupDataRegular: return "\u{f218}"
        case .barcodeBold: return "\u{f219}"
        case .barcodeLight: return "\u{f21a}"
        case .barcodeRegular: return "\u{f21b}"
        case .batteryChargingBold: return "\u{f21c}"
        case .batteryChargingLight: return "\u{f21d}"
        case .batteryChargingRegular: return "\u{f21e}"
        case .batteryEmptyBold: return "\u{f21f}"
        case .batteryEmptyLight: return "\u{f220}"
        case .batteryEmptyRegular: return "\u{f221}"
        case .batteryHighBold: return "\u{f222}"
        case .batteryHighLight: return "\u{f223}"
        case .batteryHighRegular: return "\u{f224}"
        case .batteryLowBold: return "\u{f225}"
        case .batteryLowLight: return "\u{f226}"
        case .batteryLowRegular: return "\u{f227}"
        case .batteryMediumBold: return "\u{f228}"
        case .batteryMediumLight: return "\u{f229}"
        case .batteryMediumRegular: return "\u{f22a}"
        case .bitmojiConnectBold: return "\u{f22b}"
        case .bitmojiConnectLight: return "\u{f22c}"
        case .bitmojiConnectRegular: return "\u{f22d}"
        case .bitmojiConnectedBold: return "\u{f22e}"
        case .bitmojiConnectedFilled: return "\u{f22f}"
        case .bitmojiConnectedLight: return "\u{f230}"
        case .bitmojiConnectedRegular: return "\u{f231}"
        case .blindTransferBold: return "\u{f232}"
        case .blindTransferLight: return "\u{f233}"
        case .blindTransferRegular: return "\u{f234}"
        case .blockQuoteBold: return "\u{f235}"
        case .blockQuoteLight: return "\u{f236}"
        case .blockQuoteRegular: return "\u{f237}"
        case .blockedBold: return "\u{f238}"
        case .blockedLight: return "\u{f239}"
        case .blockedRegular: return "\u{f23a}"
        case .bluetoothBold: return "\u{f23b}"
        case .bluetoothFilled: return "\u{f23c}"
        case .bluetoothLight: return "\u{f23d}"
        case .bluetoothMutedBold: return "\u{f23e}"
        case .bluetoothMutedLight: return "\u{f23f}"
        case .bluetoothMutedRegular: return "\u{f240}"
        case .bluetoothRegular: return "\u{f241}"
        case .boldBold: return "\u{f242}"
        case .boldFilled: return "\u{f243}"
        case .boldLight: return "\u{f244}"
        case .boldRegular: return "\u{f245}"
        case .bookmarkBold: return "\u{f246}"
        case .bookmarkLight: return "\u{f247}"
        case .bookmarkRegular: return "\u{f248}"
        case .botBold: return "\u{f249}"
        case .botCustomerAssistantBold: return "\u{f24a}"
        case .botCustomerAssistantLight: return "\u{f24b}"
        case .botCustomerAssistantRegular: return "\u{f24c}"
        case .botExpertAssistantBold: return "\u{f24d}"
        case .botExpertAssistantLight: return "\u{f24e}"
        case .botExpertAssistantRegular: return "\u{f24f}"
        case .botLight: return "\u{f250}"
        case .botRegular: return "\u{f251}"
        case .boxBold: return "\u{f252}"
        case .boxLight: return "\u{f253}"
        case .boxRegular: return "\u{f254}"
        case .breakoutSessionBold: return "\u{f255}"
        case .breakoutSessionFilled: return "\u{f256}"
        case .breakoutSessionLight: return "\u{f257}"
        case .breakoutSessionRegular: return "\u{f258}"
        case .brightnessBold: return "\u{f259}"
        case .brightnessHighBold: return "\u{f25a}"
        case .brightnessHighLight: return "\u{f25b}"
        case .brightnessHighRegular: return "\u{f25c}"
        case .brightnessLight: return "\u{f25d}"
        case .brightnessRegular: return "\u{f25e}"
        case .brokenFileBold: return "\u{f25f}"
        case .brokenFileFilled: return "\u{f260}"
        case .brokenFileLight: return "\u{f261}"
        case .brokenFileRegular: return "\u{f262}"
        case .browserBold: return "\u{f263}"
        case .browserLight: return "\u{f264}"
        case .browserRegular: return "\u{f265}"
        case .busyPresenceBold: return "\u{f266}"
        case .busyPresenceLight: return "\u{f267}"
        case .busyPresenceRegular: return "\u{f268}"
        case .buttonCursorBold: return "\u{f269}"
        case .buttonCursorLight: return "\u{f26a}"
        case .buttonCursorRegular: return "\u{f26b}"
        case .calendarAddBold: return "\u{f26c}"
        case .calendarAddFilled: return "\u{f26d}"
        case .calendarAddLight: return "\u{f26e}"
        case .calendarAddRegular: return "\u{f26f}"
        case .calendarDayBold: return "\u{f270}"
        case .calendarDayFilled: return "\u{f271}"
        case .calendarDayLight: return "\u{f272}"
        case .calendarDayRegular: return "\u{f273}"
        case .calendarEmptyBold: return "\u{f274}"
        case .calendarEmptyFilled: return "\u{f275}"
        case .calendarEmptyLight: return "\u{f276}"
        case .calendarEmptyRegular: return "\u{f277}"
        case .calendarExternalBold: return "\u{f278}"
        case .calendarExternalLight: return "\u{f279}"
        case .calendarExternalRegular: return "\u{f27a}"
        case .calendarFilterBold: return "\u{f27b}"
        case .calendarFilterLight: return "\u{f27c}"
        case .calendarFilterRegular: return "\u{f27d}"
        case .calendarMonthBold: return "\u{f27e}"
        case .calendarMonthFilled: return "\u{f27f}"
        case .calendarMonthLight: return "\u{f280}"
        case .calendarMonthMoreBold: return "\u{f281}"
        case .calendarMonthMoreLight: return "\u{f282}"
        case .calendarMonthMoreRegular: return "\u{f283}"
        case .calendarMonthRegular: return "\u{f284}"
        case .calendarTodayBold: return "\u{f285}"
        case .calendarTodayLight: return "\u{f286}"
        case .calendarTodayRegular: return "\u{f287}"
        case .calendarWeekBold: return "\u{f288}"
        case .calendarWeekFilled: return "\u{f289}"
        case .calendarWeekLight: return "\u{f28a}"
        case .calendarWeekRegular: return "\u{f28b}"
        case .calendarWeekViewBold: return "\u{f28c}"
        case .calendarWeekViewFilled: return "\u{f28d}"
        case .calendarWeekViewLight: return "\u{f28e}"
        case .calendarWeekViewRegular: return "\u{f28f}"
        case .calendarWorkWeekBold: return "\u{f290}"
        case .calendarWorkWeekFilled: return "\u{f291}"
        case .calendarWorkWeekLight: return "\u{f292}"
        case .calendarWorkWeekRegular: return "\u{f293}"
        case .callBargeBold: return "\u{f294}"
        case .callBargeFilled: return "\u{f295}"
        case .callBargeLight: return "\u{f296}"
        case .callBargeRegular: return "\u{f297}"
        case .callBargeSilentBold: return "\u{f298}"
        case .callBargeSilentLight: return "\u{f299}"
        case .callBargeSilentRegular: return "\u{f29a}"
        case .callForwardSettingsBold: return "\u{f29b}"
        case .callForwardSettingsFilled: return "\u{f29c}"
        case .callForwardSettingsLight: return "\u{f29d}"
        case .callForwardSettingsRegular: return "\u{f29e}"
        case .callGroupPickupBold: return "\u{f29f}"
        case .callGroupPickupFilled: return "\u{f2a0}"
        case .callGroupPickupLight: return "\u{f2a1}"
        case .callGroupPickupRegular: return "\u{f2a2}"
        case .callHandlingBold: return "\u{f2a3}"
        case .callHandlingLight: return "\u{f2a4}"
        case .callHandlingRegular: return "\u{f2a5}"
        case .callHoldBold: return "\u{f2a6}"
        case .callHoldFilled: return "\u{f2a7}"
        case .callHoldLight: return "\u{f2a8}"
        case .callHoldRegular: return "\u{f2a9}"
        case .callIncomingBold: return "\u{f2aa}"
        case .callIncomingLight: return "\u{f2ab}"
        case .callIncomingRegular: return "\u{f2ac}"
        case .callListBold: return "\u{f2ad}"
        case .callListLight: return "\u{f2ae}"
        case .callListRegular: return "\u{f2af}"
        case .callMergeBold: return "\u{f2b0}"
        case .callMergeLight: return "\u{f2b1}"
        case .callMergeRegular: return "\u{f2b2}"
        case .callMissedBold: return "\u{f2b3}"
        case .callMissedFilled: return "\u{f2b4}"
        case .callMissedLight: return "\u{f2b5}"
        case .callMissedRegular: return "\u{f2b6}"
        case .callMoreBold: return "\u{f2b7}"
        case .callMoreLight: return "\u{f2b8}"
        case .callMoreRegular: return "\u{f2b9}"
        case .callOutgoingBold: return "\u{f2ba}"
        case .callOutgoingLight: return "\u{f2bb}"
        case .callOutgoingRegular: return "\u{f2bc}"
        case .callPickupBold: return "\u{f2bd}"
        case .callPickupFilled: return "\u{f2be}"
        case .callPickupLight: return "\u{f2bf}"
        case .callPickupOtherBold: return "\u{f2c0}"
        case .callPickupOtherFilled: return "\u{f2c1}"
        case .callPickupOtherLight: return "\u{f2c2}"
        case .callPickupOtherRegular: return "\u{f2c3}"
        case .callPickupRegular: return "\u{f2c4}"
        case .callPrivateBold: return "\u{f2c5}"
        case .callPrivateFilled: return "\u{f2c6}"
        case .callPrivateLight: return "\u{f2c7}"
        case .callPrivateRegular: return "\u{f2c8}"
        case .callRemoteBold: return "\u{f2c9}"
        case .callRemoteFilled: return "\u{f2ca}"
        case .callRemoteLight: return "\u{f2cb}"
        case .callRemoteRegular: return "\u{f2cc}"
        case .callRequestBold: return "\u{f2cd}"
        case .callRequestFilled: return "\u{f2ce}"
        case .callRequestLight: return "\u{f2cf}"
        case .callRequestRegular: return "\u{f2d0}"
        case .callReturnBold: return "\u{f2d1}"
        case .callReturnFilled: return "\u{f2d2}"
        case .callReturnLight: return "\u{f2d3}"
        case .callReturnRegular: return "\u{f2d4}"
        case .callRoomBold: return "\u{f2d5}"
        case .callRoomLight: return "\u{f2d6}"
        case .callRoomRegular: return "\u{f2d7}"
        case .callSettingsBold: return "\u{f2d8}"
        case .callSettingsLight: return "\u{f2d9}"
        case .callSettingsRegular: return "\u{f2da}"
        case .callSplitBold: return "\u{f2db}"
        case .callSplitLight: return "\u{f2dc}"
        case .callSplitRegular: return "\u{f2dd}"
        case .callSwapBold: return "\u{f2de}"
        case .callSwapLight: return "\u{f2df}"
        case .callSwapRegular: return "\u{f2e0}"
        case .callVoicemailBold: return "\u{f2e1}"
        case .callVoicemailLight: return "\u{f2e2}"
        case .callVoicemailRegular: return "\u{f2e3}"
        case .callrateBold: return "\u{f2e4}"
        case .callrateLight: return "\u{f2e5}"
        case .callrateRegular: return "\u{f2e6}"
        case .cameraAuxBold: return "\u{f2e7}"
        case .cameraAuxFilled: return "\u{f2e8}"
        case .cameraAuxLight: return "\u{f2e9}"
        case .cameraAuxRegular: return "\u{f2ea}"
        case .cameraBold: return "\u{f2eb}"
        case .cameraFilled: return "\u{f2ec}"
        case .cameraLight: return "\u{f2ed}"
        case .cameraMutedBold: return "\u{f2ee}"
        case .cameraMutedCircleFilled: return "\u{f2ef}"
        case .cameraMutedFilled: return "\u{f2f0}"
        case .cameraMutedLight: return "\u{f2f1}"
        case .cameraMutedRegular: return "\u{f2f2}"
        case .cameraOnBold: return "\u{f2f3}"
        case .cameraOnFilled: return "\u{f2f4}"
        case .cameraOnLight: return "\u{f2f5}"
        case .cameraOnRegular: return "\u{f2f6}"
        case .cameraPhotoBold: return "\u{f2f7}"
        case .cameraPhotoFilled: return "\u{f2f8}"
        case .cameraPhotoLight: return "\u{f2f9}"
        case .cameraPhotoRegular: return "\u{f2fa}"
        case .cameraPresenceBold: return "\u{f2fb}"
        case .cameraPresenceFilled: return "\u{f2fc}"
        case .cameraPresenceLight: return "\u{f2fd}"
        case .cameraPresenceRegular: return "\u{f2fe}"
        case .cameraRegular: return "\u{f2ff}"
        case .cameraSwapBold: return "\u{f300}"
        case .cameraSwapLight: return "\u{f301}"
        case .cameraSwapRegular: return "\u{f302}"
        case .campaignManagementBold: return "\u{f303}"
        case .campaignManagementLight: return "\u{f304}"
        case .campaignManagementRegular: return "\u{f305}"
        case .cancelBold: return "\u{f306}"
        case .cancelLight: return "\u{f307}"
        case .cancelRegular: return "\u{f308}"
        case .capsLockBold: return "\u{f309}"
        case .capsLockLight: return "\u{f30a}"
        case .capsLockRegular: return "\u{f30b}"
        case .captureRewindBold: return "\u{f30c}"
        case .captureRewindLight: return "\u{f30d}"
        case .captureRewindRegular: return "\u{f30e}"
        case .caroselBold: return "\u{f30f}"
        case .caroselLight: return "\u{f310}"
        case .caroselRegular: return "\u{f311}"
        case .carouselTextBold: return "\u{f312}"
        case .carouselTextLight: return "\u{f313}"
        case .carouselTextRegular: return "\u{f314}"
        case .cellularBold: return "\u{f315}"
        case .cellularLight: return "\u{f316}"
        case .cellularRegular: return "\u{f317}"
        case .centerAlignedBold: return "\u{f318}"
        case .centerAlignedLight: return "\u{f319}"
        case .centerAlignedRegular: return "\u{f31a}"
        case .centerBold: return "\u{f31b}"
        case .centerLight: return "\u{f31c}"
        case .centerRegular: return "\u{f31d}"
        case .certificateBold: return "\u{f31e}"
        case .certificateInvalidBold: return "\u{f31f}"
        case .certificateInvalidLight: return "\u{f320}"
        case .certificateInvalidRegular: return "\u{f321}"
        case .certificateLight: return "\u{f322}"
        case .certificateRegular: return "\u{f323}"
        case .certifiedBold: return "\u{f324}"
        case .certifiedLight: return "\u{f325}"
        case .certifiedRegular: return "\u{f326}"
        case .chPSearchBold: return "\u{f327}"
        case .chPSearchLight: return "\u{f328}"
        case .chPSearchRegular: return "\u{f329}"
        case .channelUssdBold: return "\u{f32a}"
        case .channelUssdLight: return "\u{f32b}"
        case .channelUssdRegular: return "\u{f32c}"
        case .chatBold: return "\u{f32d}"
        case .chatFilled: return "\u{f32e}"
        case .chatGroupBold: return "\u{f32f}"
        case .chatGroupFilled: return "\u{f330}"
        case .chatGroupLight: return "\u{f331}"
        case .chatGroupRegular: return "\u{f332}"
        case .chatLight: return "\u{f333}"
        case .chatMuteBold: return "\u{f334}"
        case .chatMuteLight: return "\u{f335}"
        case .chatMuteRegular: return "\u{f336}"
        case .chatRegular: return "\u{f337}"
        case .checkBold: return "\u{f338}"
        case .checkCircleBadgeFilled: return "\u{f339}"
        case .checkCircleBold: return "\u{f33a}"
        case .checkCircleFilled: return "\u{f33b}"
        case .checkCircleLight: return "\u{f33c}"
        case .checkCircleRegular: return "\u{f33d}"
        case .checkLight: return "\u{f33e}"
        case .checkRegular: return "\u{f33f}"
        case .checkboxGroupBold: return "\u{f340}"
        case .checkboxGroupLight: return "\u{f341}"
        case .checkboxGroupRegular: return "\u{f342}"
        case .ciscoAiAssistantSolidBold: return "\u{f343}"
        case .cleanUpBold: return "\u{f344}"
        case .cleanUpLight: return "\u{f345}"
        case .cleanUpRegular: return "\u{f346}"
        case .clearBadgeFilled: return "\u{f347}"
        case .clearBold: return "\u{f348}"
        case .clearFilled: return "\u{f349}"
        case .clearLight: return "\u{f34a}"
        case .clearRegular: return "\u{f34b}"
        case .closeSpaceBold: return "\u{f34c}"
        case .closeSpaceLight: return "\u{f34d}"
        case .closeSpaceRegular: return "\u{f34e}"
        case .closedCaptionBadgeBold: return "\u{f34f}"
        case .closedCaptionBadgeFilled: return "\u{f350}"
        case .closedCaptionBadgeLight: return "\u{f351}"
        case .closedCaptionBadgeRegular: return "\u{f352}"
        case .closedCaptionsBold: return "\u{f353}"
        case .closedCaptionsFilled: return "\u{f354}"
        case .closedCaptionsLight: return "\u{f355}"
        case .closedCaptionsRegular: return "\u{f356}"
        case .cloudBold: return "\u{f357}"
        case .cloudDownloadBold: return "\u{f358}"
        case .cloudDownloadLight: return "\u{f359}"
        case .cloudDownloadRegular: return "\u{f35a}"
        case .cloudFilled: return "\u{f35b}"
        case .cloudFrameBold: return "\u{f35c}"
        case .cloudFrameFilled: return "\u{f35d}"
        case .cloudFrameLight: return "\u{f35e}"
        case .cloudFrameRegular: return "\u{f35f}"
        case .cloudLight: return "\u{f360}"
        case .cloudMutedBold: return "\u{f361}"
        case .cloudMutedFilled: return "\u{f362}"
        case .cloudMutedLight: return "\u{f363}"
        case .cloudMutedRegular: return "\u{f364}"
        case .cloudRegular: return "\u{f365}"
        case .cloudUploadBold: return "\u{f366}"
        case .cloudUploadLight: return "\u{f367}"
        case .cloudUploadRegular: return "\u{f368}"
        case .codeBlockBold: return "\u{f369}"
        case .codeBlockLight: return "\u{f36a}"
        case .codeBlockRegular: return "\u{f36b}"
        case .coffeeBold: return "\u{f36c}"
        case .coffeeLight: return "\u{f36d}"
        case .coffeeRegular: return "\u{f36e}"
        case .colorBold: return "\u{f36f}"
        case .colorFilled: return "\u{f370}"
        case .colorLight: return "\u{f371}"
        case .colorRegular: return "\u{f372}"
        case .colourPaletteBold: return "\u{f373}"
        case .colourPaletteFilled: return "\u{f374}"
        case .colourPaletteLight: return "\u{f375}"
        case .colourPaletteRegular: return "\u{f376}"
        case .commentingBold: return "\u{f377}"
        case .commentingFilled: return "\u{f378}"
        case .commentingLight: return "\u{f379}"
        case .commentingRegular: return "\u{f37a}"
        case .companyBold: return "\u{f37b}"
        case .companyLight: return "\u{f37c}"
        case .companyRegular: return "\u{f37d}"
        case .completedByBaseBold: return "\u{f37e}"
        case .completedByBaseLight: return "\u{f37f}"
        case .completedByBaseRegular: return "\u{f380}"
        case .completedByTimeBold: return "\u{f381}"
        case .completedByTimeLight: return "\u{f382}"
        case .completedByTimeRegular: return "\u{f383}"
        case .computerBold: return "\u{f384}"
        case .computerLight: return "\u{f385}"
        case .computerRegular: return "\u{f386}"
        case .conciergeBold: return "\u{f387}"
        case .conciergeLight: return "\u{f388}"
        case .conciergeRegular: return "\u{f389}"
        case .conditionalBlockBold: return "\u{f38a}"
        case .conditionalBlockLight: return "\u{f38b}"
        case .conditionalBlockRegular: return "\u{f38c}"
        case .connectBold: return "\u{f38d}"
        case .connectLight: return "\u{f38e}"
        case .connectRegular: return "\u{f38f}"
        case .contactCardBold: return "\u{f390}"
        case .contactCardFilled: return "\u{f391}"
        case .contactCardLight: return "\u{f392}"
        case .contactCardRegular: return "\u{f393}"
        case .contactsBold: return "\u{f394}"
        case .contactsFilled: return "\u{f395}"
        case .contactsLight: return "\u{f396}"
        case .contactsRegular: return "\u{f397}"
        case .contentDownloadBold: return "\u{f398}"
        case .contentDownloadFilled: return "\u{f399}"
        case .contentDownloadLight: return "\u{f39a}"
        case .contentDownloadRegular: return "\u{f39b}"
        case .contentShareBold: return "\u{f39c}"
        case .contentShareLight: return "\u{f39d}"
        case .contentShareRegular: return "\u{f39e}"
        case .contrastBold: return "\u{f39f}"
        case .contrastLight: return "\u{f3a0}"
        case .contrastRegular: return "\u{f3a1}"
        case .copyBold: return "\u{f3a2}"
        case .copyLight: return "\u{f3a3}"
        case .copyRegular: return "\u{f3a4}"
        case .cpuBold: return "\u{f3a5}"
        case .cpuLight: return "\u{f3a6}"
        case .cpuRegular: return "\u{f3a7}"
        case .createAGroupBold: return "\u{f3a8}"
        case .createAGroupFilled: return "\u{f3a9}"
        case .createAGroupLight: return "\u{f3aa}"
        case .createAGroupRegular: return "\u{f3ab}"
        case .cropBold: return "\u{f3ac}"
        case .cropLight: return "\u{f3ad}"
        case .cropRegular: return "\u{f3ae}"
        case .cucmConnectionBold: return "\u{f3af}"
        case .cucmConnectionLight: return "\u{f3b0}"
        case .cucmConnectionRegular: return "\u{f3b1}"
        case .customCodeEditorBold: return "\u{f3b2}"
        case .customCodeEditorLight: return "\u{f3b3}"
        case .customCodeEditorRegular: return "\u{f3b4}"
        case .dailyRecurringScheduleBold: return "\u{f3b5}"
        case .dailyRecurringScheduleLight: return "\u{f3b6}"
        case .dailyRecurringScheduleRegular: return "\u{f3b7}"
        case .dashboardBold: return "\u{f3b8}"
        case .dashboardFilled: return "\u{f3b9}"
        case .dashboardLight: return "\u{f3ba}"
        case .dashboardRegular: return "\u{f3bb}"
        case .dataManagementBold: return "\u{f3bc}"
        case .dataManagementFilled: return "\u{f3bd}"
        case .dataManagementLight: return "\u{f3be}"
        case .dataManagementRegular: return "\u{f3bf}"
        case .dataRangeSelectionBold: return "\u{f3c0}"
        case .dataRangeSelectionFilled: return "\u{f3c1}"
        case .dataRangeSelectionLight: return "\u{f3c2}"
        case .dataRangeSelectionRegular: return "\u{f3c3}"
        case .declineBold: return "\u{f3c4}"
        case .declineFilled: return "\u{f3c5}"
        case .declineLight: return "\u{f3c6}"
        case .declineRegular: return "\u{f3c7}"
        case .deleteBold: return "\u{f3c8}"
        case .deleteFilled: return "\u{f3c9}"
        case .deleteLight: return "\u{f3ca}"
        case .deleteRegular: return "\u{f3cb}"
        case .deploymentEvaluationProgressBold: return "\u{f3cc}"
        case .deploymentEvaluationProgressLight: return "\u{f3cd}"
        case .deploymentEvaluationProgressRegular: return "\u{f3ce}"
        case .deploymentProgressBold: return "\u{f3cf}"
        case .deploymentProgressLight: return "\u{f3d0}"
        case .deploymentProgressRegular: return "\u{f3d1}"
        case .deploymentRecurringBold: return "\u{f3d2}"
        case .deploymentRecurringLight: return "\u{f3d3}"
        case .deploymentRecurringRegular: return "\u{f3d4}"
        case .deploymentWinnerPendingBold: return "\u{f3d5}"
        case .deploymentWinnerPendingLight: return "\u{f3d6}"
        case .deploymentWinnerPendingRegular: return "\u{f3d7}"
        case .deskPhoneBold: return "\u{f3d8}"
        case .deskPhoneFilled: return "\u{f3d9}"
        case .deskPhoneLight: return "\u{f3da}"
        case .deskPhoneRegular: return "\u{f3db}"
        case .deskPhoneWarningBold: return "\u{f3dc}"
        case .deskPhoneWarningLight: return "\u{f3dd}"
        case .deskPhoneWarningRegular: return "\u{f3de}"
        case .deviceConnectionBold: return "\u{f3df}"
        case .deviceConnectionFilled: return "\u{f3e0}"
        case .deviceConnectionLight: return "\u{f3e1}"
        case .deviceConnectionRegular: return "\u{f3e2}"
        case .deviceInRoomBold: return "\u{f3e3}"
        case .deviceInRoomEndBold: return "\u{f3e4}"
        case .deviceInRoomEndLight: return "\u{f3e5}"
        case .deviceInRoomEndRegular: return "\u{f3e6}"
        case .deviceInRoomFilled: return "\u{f3e7}"
        case .deviceInRoomLight: return "\u{f3e8}"
        case .deviceInRoomRegular: return "\u{f3e9}"
        case .deviceMutedBold: return "\u{f3ea}"
        case .deviceMutedLight: return "\u{f3eb}"
        case .deviceMutedRegular: return "\u{f3ec}"
        case .devicePolicyControllerBold: return "\u{f3ed}"
        case .devicePolicyControllerLight: return "\u{f3ee}"
        case .devicePolicyControllerRegular: return "\u{f3ef}"
        case .diagnosticsBold: return "\u{f3f0}"
        case .diagnosticsLight: return "\u{f3f1}"
        case .diagnosticsRegular: return "\u{f3f2}"
        case .dialpadBold: return "\u{f3f3}"
        case .dialpadLight: return "\u{f3f4}"
        case .dialpadRegular: return "\u{f3f5}"
        case .directionalPadBold: return "\u{f3f6}"
        case .directionalPadFilled: return "\u{f3f7}"
        case .directionalPadLight: return "\u{f3f8}"
        case .directionalPadRegular: return "\u{f3f9}"
        case .directoryBold: return "\u{f3fa}"
        case .directoryLight: return "\u{f3fb}"
        case .directoryRegular: return "\u{f3fc}"
        case .disappearingPenBold: return "\u{f3fd}"
        case .disappearingPenLight: return "\u{f3fe}"
        case .disappearingPenRegular: return "\u{f3ff}"
        case .discBold: return "\u{f400}"
        case .discConnectedBold: return "\u{f401}"
        case .discConnectedLight: return "\u{f402}"
        case .discConnectedRegular: return "\u{f403}"
        case .discLight: return "\u{f404}"
        case .discRegular: return "\u{f405}"
        case .disconnectBold: return "\u{f406}"
        case .disconnectFilled: return "\u{f407}"
        case .disconnectLight: return "\u{f408}"
        case .disconnectRegular: return "\u{f409}"
        case .dislikeBold: return "\u{f40a}"
        case .dislikeFilled: return "\u{f40b}"
        case .dislikeLight: return "\u{f40c}"
        case .dislikeRegular: return "\u{f40d}"
        case .displayBold: return "\u{f40e}"
        case .displayInputBold: return "\u{f40f}"
        case .displayInputLight: return "\u{f410}"
        case .displayInputRegular: return "\u{f411}"
        case .displayLight: return "\u{f412}"
        case .displayRegular: return "\u{f413}"
        case .displayWarningBold: return "\u{f414}"
        case .displayWarningLight: return "\u{f415}"
        case .displayWarningRegular: return "\u{f416}"
        case .distributeHorizontalBold: return "\u{f417}"
        case .distributeHorizontalFilled: return "\u{f418}"
        case .distributeHorizontalLight: return "\u{f419}"
        case .distributeHorizontalRegular: return "\u{f41a}"
        case .distributeVerticallyBold: return "\u{f41b}"
        case .distributeVerticallyFilled: return "\u{f41c}"
        case .distributeVerticallyLight: return "\u{f41d}"
        case .distributeVerticallyRegular: return "\u{f41e}"
        case .dndPresenceBadgeFilled: return "\u{f41f}"
        case .dndPresenceBold: return "\u{f420}"
        case .dndPresenceFilled: return "\u{f421}"
        case .dndPresenceLight: return "\u{f422}"
        case .dndPresenceRegular: return "\u{f423}"
        case .documentBold: return "\u{f424}"
        case .documentCameraBold: return "\u{f425}"
        case .documentCameraDisconnectedBold: return "\u{f426}"
        case .documentCameraDisconnectedLight: return "\u{f427}"
        case .documentCameraDisconnectedRegular: return "\u{f428}"
        case .documentCameraLight: return "\u{f429}"
        case .documentCameraRegular: return "\u{f42a}"
        case .documentCreateBold: return "\u{f42b}"
        case .documentCreateFilled: return "\u{f42c}"
        case .documentCreateLight: return "\u{f42d}"
        case .documentCreateRegular: return "\u{f42e}"
        case .documentFilled: return "\u{f42f}"
        case .documentLight: return "\u{f430}"
        case .documentMoveBold: return "\u{f431}"
        case .documentMoveFilled: return "\u{f432}"
        case .documentMoveLight: return "\u{f433}"
        case .documentMoveRegular: return "\u{f434}"
        case .documentRegular: return "\u{f435}"
        case .documentShareBold: return "\u{f436}"
        case .documentShareFilled: return "\u{f437}"
        case .documentShareLight: return "\u{f438}"
        case .documentShareRegular: return "\u{f439}"
        case .doneAllBold: return "\u{f43a}"
        case .doneAllLight: return "\u{f43b}"
        case .doneAllRegular: return "\u{f43c}"
        case .donutChartBold: return "\u{f43d}"
        case .donutChartFilled: return "\u{f43e}"
        case .donutChartLight: return "\u{f43f}"
        case .donutChartRegular: return "\u{f440}"
        case .downloadBold: return "\u{f441}"
        case .downloadFilled: return "\u{f442}"
        case .downloadLight: return "\u{f443}"
        case .downloadRegular: return "\u{f444}"
        case .draftBold: return "\u{f445}"
        case .draftFilled: return "\u{f446}"
        case .draftIndicatorBold: return "\u{f447}"
        case .draftIndicatorSmallFilled: return "\u{f448}"
        case .draftLight: return "\u{f449}"
        case .draftRegular: return "\u{f44a}"
        case .dragBold: return "\u{f44b}"
        case .dragLight: return "\u{f44c}"
        case .dragRegular: return "\u{f44d}"
        case .draggerHorizontalBold: return "\u{f44e}"
        case .draggerHorizontalLight: return "\u{f44f}"
        case .draggerHorizontalRegular: return "\u{f450}"
        case .draggerVerticalBold: return "\u{f451}"
        case .draggerVerticalLight: return "\u{f452}"
        case .draggerVerticalRegular: return "\u{f453}"
        case .driveModeBold: return "\u{f454}"
        case .driveModeLight: return "\u{f455}"
        case .driveModeRegular: return "\u{f456}"
        case .dropdownBold: return "\u{f457}"
        case .dropdownLight: return "\u{f458}"
        case .dropdownRegular: return "\u{f459}"
        case .dxEightyBold: return "\u{f45a}"
        case .dxEightyFilled: return "\u{f45b}"
        case .dxEightyLight: return "\u{f45c}"
        case .dxEightyRegular: return "\u{f45d}"
        case .dxSeventyBold: return "\u{f45e}"
        case .dxSeventyLight: return "\u{f45f}"
        case .dxSeventyRegular: return "\u{f460}"
        case .editBold: return "\u{f461}"
        case .editFilled: return "\u{f462}"
        case .editLight: return "\u{f463}"
        case .editRegular: return "\u{f464}"
        case .editablePartialBold: return "\u{f465}"
        case .editablePartialLight: return "\u{f466}"
        case .editablePartialRegular: return "\u{f467}"
        case .educationBold: return "\u{f468}"
        case .educationFilled: return "\u{f469}"
        case .educationLight: return "\u{f46a}"
        case .educationRegular: return "\u{f46b}"
        case .emailBold: return "\u{f46c}"
        case .emailDeliveredBold: return "\u{f46d}"
        case .emailDeliveredLight: return "\u{f46e}"
        case .emailDeliveredRegular: return "\u{f46f}"
        case .emailFailureBold: return "\u{f470}"
        case .emailFailureLight: return "\u{f471}"
        case .emailFailureRegular: return "\u{f472}"
        case .emailFilled: return "\u{f473}"
        case .emailInviteBold: return "\u{f474}"
        case .emailInviteLight: return "\u{f475}"
        case .emailInviteRegular: return "\u{f476}"
        case .emailLight: return "\u{f477}"
        case .emailOutgoingBold: return "\u{f478}"
        case .emailOutgoingFilled: return "\u{f479}"
        case .emailOutgoingLight: return "\u{f47a}"
        case .emailOutgoingRegular: return "\u{f47b}"
        case .emailReadBold: return "\u{f47c}"
        case .emailReadFilled: return "\u{f47d}"
        case .emailReadLight: return "\u{f47e}"
        case .emailReadRegular: return "\u{f47f}"
        case .emailRegular: return "\u{f480}"
        case .emojiExcitedBold: return "\u{f481}"
        case .emojiExcitedFilled: return "\u{f482}"
        case .emojiExcitedLight: return "\u{f483}"
        case .emojiExcitedRegular: return "\u{f484}"
        case .emojiHappyBold: return "\u{f485}"
        case .emojiHappyFilled: return "\u{f486}"
        case .emojiHappyLight: return "\u{f487}"
        case .emojiHappyRegular: return "\u{f488}"
        case .emojiPassiveBold: return "\u{f489}"
        case .emojiPassiveFilled: return "\u{f48a}"
        case .emojiPassiveLight: return "\u{f48b}"
        case .emojiPassiveRegular: return "\u{f48c}"
        case .emojiSadBold: return "\u{f48d}"
        case .emojiSadFilled: return "\u{f48e}"
        case .emojiSadLight: return "\u{f48f}"
        case .emojiSadRegular: return "\u{f490}"
        case .emojiUnhappyBold: return "\u{f491}"
        case .emojiUnhappyFilled: return "\u{f492}"
        case .emojiUnhappyLight: return "\u{f493}"
        case .emojiUnhappyRegular: return "\u{f494}"
        case .encryptionCircleFilled: return "\u{f495}"
        case .encryptionFilled: return "\u{f496}"
        case .endRemoteDesktopControlBold: return "\u{f497}"
        case .endRemoteDesktopControlLight: return "\u{f498}"
        case .endRemoteDesktopControlRegular: return "\u{f499}"
        case .endToEndEncryptionCircleFilled: return "\u{f49a}"
        case .endToEndEncryptionFilled: return "\u{f49b}"
        case .endpointBlockedBold: return "\u{f49c}"
        case .endpointBlockedLight: return "\u{f49d}"
        case .endpointBlockedRegular: return "\u{f49e}"
        case .endpointBold: return "\u{f49f}"
        case .endpointGTwoBold: return "\u{f4a0}"
        case .endpointGTwoLight: return "\u{f4a1}"
        case .endpointGTwoRegular: return "\u{f4a2}"
        case .endpointGTwoSeventyBold: return "\u{f4a3}"
        case .endpointGTwoSeventyDualBold: return "\u{f4a4}"
        case .endpointGTwoSeventyDualLight: return "\u{f4a5}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4a6}"
        case .endpointGTwoSeventyLight: return "\u{f4a7}"
        case .endpointGTwoSeventyRegular: return "\u{f4a8}"
        case .endpointGTwoStandBold: return "\u{f4a9}"
        case .endpointGTwoStandLight: return "\u{f4aa}"
        case .endpointGTwoStandRegular: return "\u{f4ab}"
        case .endpointLight: return "\u{f4ac}"
        case .endpointMxEightHundredBold: return "\u{f4ad}"
        case .endpointMxEightHundredDualBold: return "\u{f4ae}"
        case .endpointMxEightHundredDualLight: return "\u{f4af}"
        case .endpointMxEightHundredDualRegular: return "\u{f4b0}"
        case .endpointMxEightHundredLight: return "\u{f4b1}"
        case .endpointMxEightHundredRegular: return "\u{f4b2}"
        case .endpointRegular: return "\u{f4b3}"
        case .endpointStandBold: return "\u{f4b4}"
        case .endpointStandFilled: return "\u{f4b5}"
        case .endpointStandLight: return "\u{f4b6}"
        case .endpointStandRegular: return "\u{f4b7}"
        case .endpointWarningBold: return "\u{f4b8}"
        case .endpointWarningLight: return "\u{f4b9}"
        case .endpointWarningRegular: return "\u{f4ba}"
        case .enterBold: return "\u{f4bb}"
        case .enterLight: return "\u{f4bc}"
        case .enterRegular: return "\u{f4bd}"
        case .enterRoomBold: return "\u{f4be}"
        case .enterRoomFilled: return "\u{f4bf}"
        case .enterRoomLight: return "\u{f4c0}"
        case .enterRoomRegular: return "\u{f4c1}"
        case .eraserBold: return "\u{f4c2}"
        case .eraserFilled: return "\u{f4c3}"
        case .eraserLight: return "\u{f4c4}"
        case .eraserRegular: return "\u{f4c5}"
        case .errorLegacyBadgeFilled: return "\u{f4c6}"
        case .errorLegacyBold: return "\u{f4c7}"
        case .errorLegacyFilled: return "\u{f4c8}"
        case .errorLegacyLight: return "\u{f4c9}"
        case .errorLegacyRegular: return "\u{f4ca}"
        case .ethernetBold: return "\u{f4cb}"
        case .ethernetFilled: return "\u{f4cc}"
        case .ethernetLight: return "\u{f4cd}"
        case .ethernetRegular: return "\u{f4ce}"
        case .exchangeBold: return "\u{f4cf}"
        case .exchangeLight: return "\u{f4d0}"
        case .exchangeRegular: return "\u{f4d1}"
        case .exclamationBold: return "\u{f4d2}"
        case .exclamationLight: return "\u{f4d3}"
        case .exclamationRegular: return "\u{f4d4}"
        case .excludeBold: return "\u{f4d5}"
        case .excludeLight: return "\u{f4d6}"
        case .excludeRegular: return "\u{f4d7}"
        case .existingTargetGroupBold: return "\u{f4d8}"
        case .existingTargetGroupLight: return "\u{f4d9}"
        case .existingTargetGroupRegular: return "\u{f4da}"
        case .exitRoomBold: return "\u{f4db}"
        case .exitRoomLight: return "\u{f4dc}"
        case .exitRoomRegular: return "\u{f4dd}"
        case .exploreBold: return "\u{f4de}"
        case .exploreLight: return "\u{f4df}"
        case .exploreRegular: return "\u{f4e0}"
        case .exportBold: return "\u{f4e1}"
        case .exportLight: return "\u{f4e2}"
        case .exportRegular: return "\u{f4e3}"
        case .extensionMobilityBold: return "\u{f4e4}"
        case .extensionMobilityLight: return "\u{f4e5}"
        case .extensionMobilityRegular: return "\u{f4e6}"
        case .externalMessageBold: return "\u{f4e7}"
        case .externalMessageLight: return "\u{f4e8}"
        case .externalMessageRegular: return "\u{f4e9}"
        case .externalUserBold: return "\u{f4ea}"
        case .externalUserLight: return "\u{f4eb}"
        case .externalUserRegular: return "\u{f4ec}"
        case .familyFontBold: return "\u{f4ed}"
        case .familyFontLight: return "\u{f4ee}"
        case .familyFontRegular: return "\u{f4ef}"
        case .fastForwardBold: return "\u{f4f0}"
        case .fastForwardLight: return "\u{f4f1}"
        case .fastForwardRegular: return "\u{f4f2}"
        case .favoriteBold: return "\u{f4f3}"
        case .favoriteFilled: return "\u{f4f4}"
        case .favoriteLight: return "\u{f4f5}"
        case .favoriteRegular: return "\u{f4f6}"
        case .favoritesBold: return "\u{f4f7}"
        case .favoritesFilled: return "\u{f4f8}"
        case .favoritesLight: return "\u{f4f9}"
        case .favoritesRegular: return "\u{f4fa}"
        case .fbwBold: return "\u{f4fb}"
        case .fbwFilled: return "\u{f4fc}"
        case .fbwLight: return "\u{f4fd}"
        case .fbwRegular: return "\u{f4fe}"
        case .ffwBold: return "\u{f4ff}"
        case .ffwFilled: return "\u{f500}"
        case .ffwLight: return "\u{f501}"
        case .ffwRegular: return "\u{f502}"
        case .fileAnalysisBold: return "\u{f503}"
        case .fileAnalysisFilled: return "\u{f504}"
        case .fileAnalysisLight: return "\u{f505}"
        case .fileAnalysisRegular: return "\u{f506}"
        case .fileAnnotationBold: return "\u{f507}"
        case .fileAnnotationFilled: return "\u{f508}"
        case .fileAnnotationLight: return "\u{f509}"
        case .fileAnnotationRegular: return "\u{f50a}"
        case .fileAudioBold: return "\u{f50b}"
        case .fileAudioFilled: return "\u{f50c}"
        case .fileAudioLight: return "\u{f50d}"
        case .fileAudioRegular: return "\u{f50e}"
        case .fileBugBold: return "\u{f50f}"
        case .fileBugFilled: return "\u{f510}"
        case .fileBugLight: return "\u{f511}"
        case .fileBugRegular: return "\u{f512}"
        case .fileCodeBold: return "\u{f513}"
        case .fileCodeFilled: return "\u{f514}"
        case .fileCodeLight: return "\u{f515}"
        case .fileCodeRegular: return "\u{f516}"
        case .fileDashboardBold: return "\u{f517}"
        case .fileDashboardFilled: return "\u{f518}"
        case .fileDashboardLight: return "\u{f519}"
        case .fileDashboardRegular: return "\u{f51a}"
        case .fileExcelBold: return "\u{f51b}"
        case .fileExcelFilled: return "\u{f51c}"
        case .fileExcelLight: return "\u{f51d}"
        case .fileExcelRegular: return "\u{f51e}"
        case .fileGraphBold: return "\u{f51f}"
        case .fileGraphFilled: return "\u{f520}"
        case .fileGraphLight: return "\u{f521}"
        case .fileGraphRegular: return "\u{f522}"
        case .fileImageBold: return "\u{f523}"
        case .fileImageFilled: return "\u{f524}"
        case .fileImageLight: return "\u{f525}"
        case .fileImageNoneBold: return "\u{f526}"
        case .fileImageNoneLight: return "\u{f527}"
        case .fileImageNoneRegular: return "\u{f528}"
        case .fileImageRegular: return "\u{f529}"
        case .fileKeynoteBold: return "\u{f52a}"
        case .fileKeynoteFilled: return "\u{f52b}"
        case .fileKeynoteLight: return "\u{f52c}"
        case .fileKeynoteRegular: return "\u{f52d}"
        case .fileLockedBold: return "\u{f52e}"
        case .fileLockedFilled: return "\u{f52f}"
        case .fileLockedLight: return "\u{f530}"
        case .fileLockedRegular: return "\u{f531}"
        case .fileMissingBold: return "\u{f532}"
        case .fileMissingFilled: return "\u{f533}"
        case .fileMissingLight: return "\u{f534}"
        case .fileMissingRegular: return "\u{f535}"
        case .fileMusicBold: return "\u{f536}"
        case .fileMusicFilled: return "\u{f537}"
        case .fileMusicLight: return "\u{f538}"
        case .fileMusicRegular: return "\u{f539}"
        case .fileOnenoteBold: return "\u{f53a}"
        case .fileOnenoteFilled: return "\u{f53b}"
        case .fileOnenoteLight: return "\u{f53c}"
        case .fileOnenoteRegular: return "\u{f53d}"
        case .filePdfBold: return "\u{f53e}"
        case .filePdfFilled: return "\u{f53f}"
        case .filePdfLight: return "\u{f540}"
        case .filePdfRegular: return "\u{f541}"
        case .filePowerpointBold: return "\u{f542}"
        case .filePowerpointFilled: return "\u{f543}"
        case .filePowerpointLight: return "\u{f544}"
        case .filePowerpointRegular: return "\u{f545}"
        case .fileSpreadsheetBold: return "\u{f546}"
        case .fileSpreadsheetFilled: return "\u{f547}"
        case .fileSpreadsheetLight: return "\u{f548}"
        case .fileSpreadsheetRegular: return "\u{f549}"
        case .fileTextBold: return "\u{f54a}"
        case .fileTextFilled: return "\u{f54b}"
        case .fileTextLight: return "\u{f54c}"
        case .fileTextRegular: return "\u{f54d}"
        case .fileThreeDBold: return "\u{f54e}"
        case .fileThreeDFilled: return "\u{f54f}"
        case .fileThreeDLight: return "\u{f550}"
        case .fileThreeDRegular: return "\u{f551}"
        case .fileVectorBold: return "\u{f552}"
        case .fileVectorFilled: return "\u{f553}"
        case .fileVectorLight: return "\u{f554}"
        case .fileVectorRegular: return "\u{f555}"
        case .fileVideoBold: return "\u{f556}"
        case .fileVideoFilled: return "\u{f557}"
        case .fileVideoLight: return "\u{f558}"
        case .fileVideoRegular: return "\u{f559}"
        case .fileWordBold: return "\u{f55a}"
        case .fileWordFilled: return "\u{f55b}"
        case .fileWordLight: return "\u{f55c}"
        case .fileWordRegular: return "\u{f55d}"
        case .fileZipBold: return "\u{f55e}"
        case .fileZipFilled: return "\u{f55f}"
        case .fileZipLight: return "\u{f560}"
        case .fileZipRegular: return "\u{f561}"
        case .filesBold: return "\u{f562}"
        case .filesFilled: return "\u{f563}"
        case .filesLight: return "\u{f564}"
        case .filesRegular: return "\u{f565}"
        case .fillColourBold: return "\u{f566}"
        case .fillColourFilled: return "\u{f567}"
        case .fillColourLight: return "\u{f568}"
        case .fillColourRegular: return "\u{f569}"
        case .filterBold: return "\u{f56a}"
        case .filterCircleBold: return "\u{f56b}"
        case .filterCircleFilled: return "\u{f56c}"
        case .filterCircleLight: return "\u{f56d}"
        case .filterCircleRegular: return "\u{f56e}"
        case .filterLight: return "\u{f56f}"
        case .filterRegular: return "\u{f570}"
        case .fitToWidthBold: return "\u{f571}"
        case .fitToWidthLight: return "\u{f572}"
        case .fitToWidthRegular: return "\u{f573}"
        case .fitToWindowExpandBold: return "\u{f574}"
        case .fitToWindowExpandLight: return "\u{f575}"
        case .fitToWindowExpandRegular: return "\u{f576}"
        case .fitToWindowShrinkBold: return "\u{f577}"
        case .fitToWindowShrinkLight: return "\u{f578}"
        case .fitToWindowShrinkRegular: return "\u{f579}"
        case .flagBold: return "\u{f57a}"
        case .flagCircleBold: return "\u{f57b}"
        case .flagCircleFilled: return "\u{f57c}"
        case .flagCircleLight: return "\u{f57d}"
        case .flagCircleRegular: return "\u{f57e}"
        case .flagFilled: return "\u{f57f}"
        case .flagLight: return "\u{f580}"
        case .flagRegular: return "\u{f581}"
        case .folderBold: return "\u{f582}"
        case .folderEditBold: return "\u{f583}"
        case .folderEditLight: return "\u{f584}"
        case .folderEditRegular: return "\u{f585}"
        case .folderLight: return "\u{f586}"
        case .folderLockBold: return "\u{f587}"
        case .folderLockLight: return "\u{f588}"
        case .folderLockRegular: return "\u{f589}"
        case .folderRegular: return "\u{f58a}"
        case .folderViewBold: return "\u{f58b}"
        case .folderViewLight: return "\u{f58c}"
        case .folderViewRegular: return "\u{f58d}"
        case .followUpBold: return "\u{f58e}"
        case .followUpLight: return "\u{f58f}"
        case .followUpRegular: return "\u{f590}"
        case .foodBold: return "\u{f591}"
        case .foodLight: return "\u{f592}"
        case .foodRegular: return "\u{f593}"
        case .formatBold: return "\u{f594}"
        case .formatDefaultAppBold: return "\u{f595}"
        case .formatDefaultAppFilled: return "\u{f596}"
        case .formatDefaultAppLight: return "\u{f597}"
        case .formatDefaultAppRegular: return "\u{f598}"
        case .formatLight: return "\u{f599}"
        case .formatPanelControlBarBold: return "\u{f59a}"
        case .formatPanelControlBarLight: return "\u{f59b}"
        case .formatPanelControlBarRegular: return "\u{f59c}"
        case .formatPanelControlDownBold: return "\u{f59d}"
        case .formatPanelControlDownLight: return "\u{f59e}"
        case .formatPanelControlDownRegular: return "\u{f59f}"
        case .formatPanelControlLeftBold: return "\u{f5a0}"
        case .formatPanelControlLeftLight: return "\u{f5a1}"
        case .formatPanelControlLeftRegular: return "\u{f5a2}"
        case .formatPanelControlRightBold: return "\u{f5a3}"
        case .formatPanelControlRightLight: return "\u{f5a4}"
        case .formatPanelControlRightRegular: return "\u{f5a5}"
        case .formatPanelControlUpBold: return "\u{f5a6}"
        case .formatPanelControlUpDownBold: return "\u{f5a7}"
        case .formatPanelControlUpDownLight: return "\u{f5a8}"
        case .formatPanelControlUpDownRegular: return "\u{f5a9}"
        case .formatPanelControlUpLight: return "\u{f5aa}"
        case .formatPanelControlUpRegular: return "\u{f5ab}"
        case .formatRegular: return "\u{f5ac}"
        case .formatViewMixedBold: return "\u{f5ad}"
        case .formatViewMixedLight: return "\u{f5ae}"
        case .formatViewMixedRegular: return "\u{f5af}"
        case .forwardMessageBold: return "\u{f5b0}"
        case .forwardMessageFilled: return "\u{f5b1}"
        case .forwardMessageLight: return "\u{f5b2}"
        case .forwardMessageRegular: return "\u{f5b3}"
        case .forwardTenSecBold: return "\u{f5b4}"
        case .forwardTenSecLight: return "\u{f5b5}"
        case .forwardTenSecRegular: return "\u{f5b6}"
        case .fourColumnBold: return "\u{f5b7}"
        case .fourColumnLight: return "\u{f5b8}"
        case .fourColumnRegular: return "\u{f5b9}"
        case .fourWayNavigationBold: return "\u{f5ba}"
        case .fourWayNavigationLight: return "\u{f5bb}"
        case .fourWayNavigationRegular: return "\u{f5bc}"
        case .frequencyCappingBold: return "\u{f5bd}"
        case .frequencyCappingLight: return "\u{f5be}"
        case .frequencyCappingRegular: return "\u{f5bf}"
        case .fulfillmentBold: return "\u{f5c0}"
        case .fulfillmentLight: return "\u{f5c1}"
        case .fulfillmentRegular: return "\u{f5c2}"
        case .fullscreenBold: return "\u{f5c3}"
        case .fullscreenExitBold: return "\u{f5c4}"
        case .fullscreenExitLight: return "\u{f5c5}"
        case .fullscreenExitRegular: return "\u{f5c6}"
        case .fullscreenLight: return "\u{f5c7}"
        case .fullscreenRegular: return "\u{f5c8}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5c9}"
        case .genericDeviceVideoBold: return "\u{f5ca}"
        case .genericDeviceVideoFilled: return "\u{f5cb}"
        case .genericDeviceVideoLight: return "\u{f5cc}"
        case .genericDeviceVideoRegular: return "\u{f5cd}"
        case .gifBold: return "\u{f5ce}"
        case .gifFilled: return "\u{f5cf}"
        case .gifHorizontalBold: return "\u{f5d0}"
        case .gifHorizontalFilled: return "\u{f5d1}"
        case .gifHorizontalLight: return "\u{f5d2}"
        case .gifHorizontalRegular: return "\u{f5d3}"
        case .gifLight: return "\u{f5d4}"
        case .gifRegular: return "\u{f5d5}"
        case .giftBold: return "\u{f5d6}"
        case .giftFilled: return "\u{f5d7}"
        case .giftLight: return "\u{f5d8}"
        case .giftRegular: return "\u{f5d9}"
        case .greenLeafBold: return "\u{f5da}"
        case .greenLeafFilled: return "\u{f5db}"
        case .greenLeafLight: return "\u{f5dc}"
        case .greenLeafRegular: return "\u{f5dd}"
        case .greenRoomBold: return "\u{f5de}"
        case .greenRoomFilled: return "\u{f5df}"
        case .greenRoomLight: return "\u{f5e0}"
        case .greenRoomRegular: return "\u{f5e1}"
        case .guestIssuerBold: return "\u{f5e2}"
        case .guestIssuerLight: return "\u{f5e3}"
        case .guestIssuerRegular: return "\u{f5e4}"
        case .guideBold: return "\u{f5e5}"
        case .guideLight: return "\u{f5e6}"
        case .guideRegular: return "\u{f5e7}"
        case .handPointerBold: return "\u{f5e8}"
        case .handPointerLight: return "\u{f5e9}"
        case .handPointerRegular: return "\u{f5ea}"
        case .handlerBold: return "\u{f5eb}"
        case .handlerHorizontalBold: return "\u{f5ec}"
        case .handlerHorizontalLight: return "\u{f5ed}"
        case .handlerHorizontalRegular: return "\u{f5ee}"
        case .handlerLight: return "\u{f5ef}"
        case .handlerRegular: return "\u{f5f0}"
        case .handsetAlertBold: return "\u{f5f1}"
        case .handsetAlertFilled: return "\u{f5f2}"
        case .handsetAlertLight: return "\u{f5f3}"
        case .handsetAlertRegular: return "\u{f5f4}"
        case .handsetBold: return "\u{f5f5}"
        case .handsetFilled: return "\u{f5f6}"
        case .handsetLight: return "\u{f5f7}"
        case .handsetMutedBold: return "\u{f5f8}"
        case .handsetMutedFilled: return "\u{f5f9}"
        case .handsetMutedLight: return "\u{f5fa}"
        case .handsetMutedRegular: return "\u{f5fb}"
        case .handsetRegular: return "\u{f5fc}"
        case .handshakeBold: return "\u{f5fd}"
        case .handshakeLight: return "\u{f5fe}"
        case .handshakeRegular: return "\u{f5ff}"
        case .headingOneBold: return "\u{f600}"
        case .headingOneLight: return "\u{f601}"
        case .headingOneRegular: return "\u{f602}"
        case .headingThreeBold: return "\u{f603}"
        case .headingThreeLight: return "\u{f604}"
        case .headingThreeRegular: return "\u{f605}"
        case .headingTwoBold: return "\u{f606}"
        case .headingTwoLight: return "\u{f607}"
        case .headingTwoRegular: return "\u{f608}"
        case .headphonesBold: return "\u{f609}"
        case .headphonesFilled: return "\u{f60a}"
        case .headphonesLight: return "\u{f60b}"
        case .headphonesMutedBold: return "\u{f60c}"
        case .headphonesMutedFilled: return "\u{f60d}"
        case .headphonesMutedLight: return "\u{f60e}"
        case .headphonesMutedRegular: return "\u{f60f}"
        case .headphonesRegular: return "\u{f610}"
        case .headsetAlertBold: return "\u{f611}"
        case .headsetAlertLight: return "\u{f612}"
        case .headsetAlertRegular: return "\u{f613}"
        case .headsetBold: return "\u{f614}"
        case .headsetFilled: return "\u{f615}"
        case .headsetLight: return "\u{f616}"
        case .headsetMutedBold: return "\u{f617}"
        case .headsetMutedLight: return "\u{f618}"
        case .headsetMutedRegular: return "\u{f619}"
        case .headsetPrivateBold: return "\u{f61a}"
        case .headsetPrivateLight: return "\u{f61b}"
        case .headsetPrivateRegular: return "\u{f61c}"
        case .headsetRegular: return "\u{f61d}"
        case .hearingBold: return "\u{f61e}"
        case .hearingImpairedBold: return "\u{f61f}"
        case .hearingImpairedLight: return "\u{f620}"
        case .hearingImpairedRegular: return "\u{f621}"
        case .hearingLight: return "\u{f622}"
        case .hearingRegular: return "\u{f623}"
        case .helpBold: return "\u{f624}"
        case .helpCircleBold: return "\u{f625}"
        case .helpCircleFilled: return "\u{f626}"
        case .helpCircleLight: return "\u{f627}"
        case .helpCircleRegular: return "\u{f628}"
        case .helpLight: return "\u{f629}"
        case .helpRegular: return "\u{f62a}"
        case .helpdeskBold: return "\u{f62b}"
        case .helpdeskFilled: return "\u{f62c}"
        case .helpdeskLight: return "\u{f62d}"
        case .helpdeskRegular: return "\u{f62e}"
        case .hideBold: return "\u{f62f}"
        case .hideFilled: return "\u{f630}"
        case .hideLight: return "\u{f631}"
        case .hideRegular: return "\u{f632}"
        case .homeBold: return "\u{f633}"
        case .homeFilled: return "\u{f634}"
        case .homeLight: return "\u{f635}"
        case .homeRegular: return "\u{f636}"
        case .horizontalLineBold: return "\u{f637}"
        case .horizontalLineLight: return "\u{f638}"
        case .horizontalLineRegular: return "\u{f639}"
        case .hotelingBold: return "\u{f63a}"
        case .hotelingFilled: return "\u{f63b}"
        case .hotelingLight: return "\u{f63c}"
        case .hotelingRegular: return "\u{f63d}"
        case .humidityBold: return "\u{f63e}"
        case .humidityLight: return "\u{f63f}"
        case .humidityRegular: return "\u{f640}"
        case .huntGroupBold: return "\u{f641}"
        case .huntGroupFilled: return "\u{f642}"
        case .huntGroupLight: return "\u{f643}"
        case .huntGroupRegular: return "\u{f644}"
        case .idleBold: return "\u{f645}"
        case .idleFilled: return "\u{f646}"
        case .idleLight: return "\u{f647}"
        case .idleRegular: return "\u{f648}"
        case .immediateBold: return "\u{f649}"
        case .immediateFilled: return "\u{f64a}"
        case .immediateLight: return "\u{f64b}"
        case .immediateRegular: return "\u{f64c}"
        case .importBold: return "\u{f64d}"
        case .importLight: return "\u{f64e}"
        case .importRegular: return "\u{f64f}"
        case .inCommonBold: return "\u{f650}"
        case .inCommonLight: return "\u{f651}"
        case .inCommonRegular: return "\u{f652}"
        case .includeBold: return "\u{f653}"
        case .includeLight: return "\u{f654}"
        case .includeRegular: return "\u{f655}"
        case .incognitoBold: return "\u{f656}"
        case .incognitoFilled: return "\u{f657}"
        case .incognitoLight: return "\u{f658}"
        case .incognitoRegular: return "\u{f659}"
        case .incomingCallLegacyBold: return "\u{f65a}"
        case .incomingCallLegacyFilled: return "\u{f65b}"
        case .incomingCallLegacyLight: return "\u{f65c}"
        case .incomingCallLegacyRegular: return "\u{f65d}"
        case .indentDecreaseBold: return "\u{f65e}"
        case .indentDecreaseLight: return "\u{f65f}"
        case .indentDecreaseRegular: return "\u{f660}"
        case .indentIncreaseBold: return "\u{f661}"
        case .indentIncreaseLight: return "\u{f662}"
        case .indentIncreaseRegular: return "\u{f663}"
        case .infoBadgeFilled: return "\u{f664}"
        case .infoCircleBold: return "\u{f665}"
        case .infoCircleFilled: return "\u{f666}"
        case .infoCircleLight: return "\u{f667}"
        case .infoCircleRegular: return "\u{f668}"
        case .infoCircleTwoBold: return "\u{f669}"
        case .infoCircleTwoFilled: return "\u{f66a}"
        case .infoCircleTwoLight: return "\u{f66b}"
        case .infoCircleTwoRegular: return "\u{f66c}"
        case .inputBold: return "\u{f66d}"
        case .inputDisconnectedBold: return "\u{f66e}"
        case .inputDisconnectedLight: return "\u{f66f}"
        case .inputDisconnectedRegular: return "\u{f670}"
        case .inputLight: return "\u{f671}"
        case .inputRegular: return "\u{f672}"
        case .instantScheduleBold: return "\u{f673}"
        case .instantScheduleFilled: return "\u{f674}"
        case .instantScheduleLight: return "\u{f675}"
        case .instantScheduleRegular: return "\u{f676}"
        case .integrationsBold: return "\u{f677}"
        case .integrationsLight: return "\u{f678}"
        case .integrationsRegular: return "\u{f679}"
        case .intelligentRoutingBold: return "\u{f67a}"
        case .intelligentRoutingLight: return "\u{f67b}"
        case .intelligentRoutingRegular: return "\u{f67c}"
        case .invitedUserBold: return "\u{f67d}"
        case .invitedUserLight: return "\u{f67e}"
        case .invitedUserRegular: return "\u{f67f}"
        case .italicBold: return "\u{f680}"
        case .italicFilled: return "\u{f681}"
        case .italicLight: return "\u{f682}"
        case .italicRegular: return "\u{f683}"
        case .joinAudioBold: return "\u{f684}"
        case .joinAudioFilled: return "\u{f685}"
        case .joinAudioLight: return "\u{f686}"
        case .joinAudioRegular: return "\u{f687}"
        case .keepInTouchBold: return "\u{f688}"
        case .keepInTouchFilled: return "\u{f689}"
        case .keepInTouchLight: return "\u{f68a}"
        case .keepInTouchRegular: return "\u{f68b}"
        case .keyboardBold: return "\u{f68c}"
        case .keyboardCloseBold: return "\u{f68d}"
        case .keyboardCloseLight: return "\u{f68e}"
        case .keyboardCloseRegular: return "\u{f68f}"
        case .keyboardLight: return "\u{f690}"
        case .keyboardRegular: return "\u{f691}"
        case .languageBold: return "\u{f692}"
        case .languageFilled: return "\u{f693}"
        case .languageLight: return "\u{f694}"
        case .languageRegular: return "\u{f695}"
        case .laptopBold: return "\u{f696}"
        case .laptopDisconnectedBold: return "\u{f697}"
        case .laptopDisconnectedLight: return "\u{f698}"
        case .laptopDisconnectedRegular: return "\u{f699}"
        case .laptopFilled: return "\u{f69a}"
        case .laptopLight: return "\u{f69b}"
        case .laptopRegular: return "\u{f69c}"
        case .laserPointerBold: return "\u{f69d}"
        case .laserPointerLight: return "\u{f69e}"
        case .laserPointerRegular: return "\u{f69f}"
        case .launchBold: return "\u{f6a0}"
        case .launchLight: return "\u{f6a1}"
        case .launchRegular: return "\u{f6a2}"
        case .layoutSideBySideVerticalBold: return "\u{f6a3}"
        case .layoutSideBySideVerticalFilled: return "\u{f6a4}"
        case .layoutSideBySideVerticalLight: return "\u{f6a5}"
        case .layoutSideBySideVerticalRegular: return "\u{f6a6}"
        case .leaveBreakoutSessionBold: return "\u{f6a7}"
        case .leaveBreakoutSessionLight: return "\u{f6a8}"
        case .leaveBreakoutSessionRegular: return "\u{f6a9}"
        case .leaveDeviceBold: return "\u{f6aa}"
        case .leaveDeviceLight: return "\u{f6ab}"
        case .leaveDeviceRegular: return "\u{f6ac}"
        case .likeBold: return "\u{f6ad}"
        case .likeFilled: return "\u{f6ae}"
        case .likeLight: return "\u{f6af}"
        case .likeRegular: return "\u{f6b0}"
        case .linkBold: return "\u{f6b1}"
        case .linkLight: return "\u{f6b2}"
        case .linkRegular: return "\u{f6b3}"
        case .listBulletedBold: return "\u{f6b4}"
        case .listBulletedLight: return "\u{f6b5}"
        case .listBulletedRegular: return "\u{f6b6}"
        case .listMenuBold: return "\u{f6b7}"
        case .listMenuLight: return "\u{f6b8}"
        case .listMenuRegular: return "\u{f6b9}"
        case .listNumberedBold: return "\u{f6ba}"
        case .listNumberedLight: return "\u{f6bb}"
        case .listNumberedRegular: return "\u{f6bc}"
        case .liveBold: return "\u{f6bd}"
        case .liveFilled: return "\u{f6be}"
        case .liveLight: return "\u{f6bf}"
        case .liveRegular: return "\u{f6c0}"
        case .locationBold: return "\u{f6c1}"
        case .locationFilled: return "\u{f6c2}"
        case .locationLight: return "\u{f6c3}"
        case .locationRegular: return "\u{f6c4}"
        case .longTextBoxBold: return "\u{f6c5}"
        case .longTextBoxLight: return "\u{f6c6}"
        case .longTextBoxRegular: return "\u{f6c7}"
        case .lowerHandBold: return "\u{f6c8}"
        case .lowerHandLight: return "\u{f6c9}"
        case .lowerHandRegular: return "\u{f6ca}"
        case .magicPenBold: return "\u{f6cb}"
        case .magicPenFilled: return "\u{f6cc}"
        case .magicPenLight: return "\u{f6cd}"
        case .magicPenRegular: return "\u{f6ce}"
        case .markAsUnreadBold: return "\u{f6cf}"
        case .markAsUnreadLight: return "\u{f6d0}"
        case .markAsUnreadRegular: return "\u{f6d1}"
        case .markdownBold: return "\u{f6d2}"
        case .markdownLight: return "\u{f6d3}"
        case .markdownRegular: return "\u{f6d4}"
        case .markerBold: return "\u{f6d5}"
        case .markerFilled: return "\u{f6d6}"
        case .markerLight: return "\u{f6d7}"
        case .markerRegular: return "\u{f6d8}"
        case .maximizeBold: return "\u{f6d9}"
        case .maximizeLight: return "\u{f6da}"
        case .maximizeRegular: return "\u{f6db}"
        case .mediaPlayerBold: return "\u{f6dc}"
        case .mediaPlayerLight: return "\u{f6dd}"
        case .mediaPlayerRegular: return "\u{f6de}"
        case .mediaQualityGoodBold: return "\u{f6df}"
        case .mediaQualityGoodFilled: return "\u{f6e0}"
        case .mediaQualityGoodLight: return "\u{f6e1}"
        case .mediaQualityGoodRegular: return "\u{f6e2}"
        case .mediaQualityPoorBold: return "\u{f6e3}"
        case .mediaQualityPoorFilled: return "\u{f6e4}"
        case .mediaQualityPoorLight: return "\u{f6e5}"
        case .mediaQualityPoorRegular: return "\u{f6e6}"
        case .mediaQualityUnstableBold: return "\u{f6e7}"
        case .mediaQualityUnstableFilled: return "\u{f6e8}"
        case .mediaQualityUnstableLight: return "\u{f6e9}"
        case .mediaQualityUnstableRegular: return "\u{f6ea}"
        case .meetBold: return "\u{f6eb}"
        case .meetEndBold: return "\u{f6ec}"
        case .meetEndLight: return "\u{f6ed}"
        case .meetEndRegular: return "\u{f6ee}"
        case .meetFilled: return "\u{f6ef}"
        case .meetLight: return "\u{f6f0}"
        case .meetRegular: return "\u{f6f1}"
        case .meetingSummaryBold: return "\u{f6f2}"
        case .meetingSummaryFilled: return "\u{f6f3}"
        case .meetingSummaryLight: return "\u{f6f4}"
        case .meetingSummaryRegular: return "\u{f6f5}"
        case .meetingsBold: return "\u{f6f6}"
        case .meetingsFilled: return "\u{f6f7}"
        case .meetingsFocusMonthBold: return "\u{f6f8}"
        case .meetingsFocusMonthLight: return "\u{f6f9}"
        case .meetingsFocusMonthRegular: return "\u{f6fa}"
        case .meetingsFocusOneDayBold: return "\u{f6fb}"
        case .meetingsFocusOneDayLight: return "\u{f6fc}"
        case .meetingsFocusOneDayRegular: return "\u{f6fd}"
        case .meetingsFocusThreeDayBold: return "\u{f6fe}"
        case .meetingsFocusThreeDayLight: return "\u{f6ff}"
        case .meetingsFocusThreeDayRegular: return "\u{f700}"
        case .meetingsFocusUpcomingBold: return "\u{f701}"
        case .meetingsFocusUpcomingLight: return "\u{f702}"
        case .meetingsFocusUpcomingRegular: return "\u{f703}"
        case .meetingsLight: return "\u{f704}"
        case .meetingsPresenceBadgeFilled: return "\u{f705}"
        case .meetingsPresenceBold: return "\u{f706}"
        case .meetingsPresenceFilled: return "\u{f707}"
        case .meetingsPresenceLight: return "\u{f708}"
        case .meetingsPresenceRegular: return "\u{f709}"
        case .meetingsRegular: return "\u{f70a}"
        case .meetingsTeamBold: return "\u{f70b}"
        case .meetingsTeamFilled: return "\u{f70c}"
        case .meetingsTeamLight: return "\u{f70d}"
        case .meetingsTeamNewBold: return "\u{f70e}"
        case .meetingsTeamNewLight: return "\u{f70f}"
        case .meetingsTeamNewRegular: return "\u{f710}"
        case .meetingsTeamRegular: return "\u{f711}"
        case .mentionBold: return "\u{f712}"
        case .mentionLight: return "\u{f713}"
        case .mentionRegular: return "\u{f714}"
        case .messageQueingBold: return "\u{f715}"
        case .messageQueingLight: return "\u{f716}"
        case .messageQueingRegular: return "\u{f717}"
        case .microphoneBold: return "\u{f718}"
        case .microphoneFilled: return "\u{f719}"
        case .microphoneHardMutedBold: return "\u{f71a}"
        case .microphoneHardMutedCircleFilled: return "\u{f71b}"
        case .microphoneHardMutedLight: return "\u{f71c}"
        case .microphoneHardMutedRegular: return "\u{f71d}"
        case .microphoneLight: return "\u{f71e}"
        case .microphoneMusicModeBold: return "\u{f71f}"
        case .microphoneMusicModeLight: return "\u{f720}"
        case .microphoneMusicModeOnBold: return "\u{f721}"
        case .microphoneMusicModeOnLight: return "\u{f722}"
        case .microphoneMusicModeOnRegular: return "\u{f723}"
        case .microphoneMusicModeRegular: return "\u{f724}"
        case .microphoneMutedBold: return "\u{f725}"
        case .microphoneMutedCircleFilled: return "\u{f726}"
        case .microphoneMutedFilled: return "\u{f727}"
        case .microphoneMutedLight: return "\u{f728}"
        case .microphoneMutedRegular: return "\u{f729}"
        case .microphoneOnBold: return "\u{f72a}"
        case .microphoneOnLight: return "\u{f72b}"
        case .microphoneOnRegular: return "\u{f72c}"
        case .microphoneOptAllBold: return "\u{f72d}"
        case .microphoneOptAllLight: return "\u{f72e}"
        case .microphoneOptAllMutedBold: return "\u{f72f}"
        case .microphoneOptAllMutedLight: return "\u{f730}"
        case .microphoneOptAllMutedRegular: return "\u{f731}"
        case .microphoneOptAllOnBold: return "\u{f732}"
        case .microphoneOptAllOnLight: return "\u{f733}"
        case .microphoneOptAllOnRegular: return "\u{f734}"
        case .microphoneOptAllRegular: return "\u{f735}"
        case .microphoneOptMeBold: return "\u{f736}"
        case .microphoneOptMeLight: return "\u{f737}"
        case .microphoneOptMeMutedBold: return "\u{f738}"
        case .microphoneOptMeMutedLight: return "\u{f739}"
        case .microphoneOptMeMutedRegular: return "\u{f73a}"
        case .microphoneOptMeOnBold: return "\u{f73b}"
        case .microphoneOptMeOnLight: return "\u{f73c}"
        case .microphoneOptMeOnRegular: return "\u{f73d}"
        case .microphoneOptMeRegular: return "\u{f73e}"
        case .microphoneRegular: return "\u{f73f}"
        case .mindMapBold: return "\u{f740}"
        case .mindMapLight: return "\u{f741}"
        case .mindMapRegular: return "\u{f742}"
        case .minimizeBold: return "\u{f743}"
        case .minimizeLight: return "\u{f744}"
        case .minimizeRegular: return "\u{f745}"
        case .minusBold: return "\u{f746}"
        case .minusLight: return "\u{f747}"
        case .minusRegular: return "\u{f748}"
        case .mirrorBold: return "\u{f749}"
        case .mirrorFilled: return "\u{f74a}"
        case .mirrorLight: return "\u{f74b}"
        case .mirrorRegular: return "\u{f74c}"
        case .mmsFilled: return "\u{f74d}"
        case .moderatorBold: return "\u{f74e}"
        case .moderatorLight: return "\u{f74f}"
        case .moderatorRegular: return "\u{f750}"
        case .monitoringBold: return "\u{f751}"
        case .monitoringLight: return "\u{f752}"
        case .monitoringRegular: return "\u{f753}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f754}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f755}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f756}"
        case .moreAdrBold: return "\u{f757}"
        case .moreAdrLight: return "\u{f758}"
        case .moreAdrRegular: return "\u{f759}"
        case .moreBold: return "\u{f75a}"
        case .moreCircleBold: return "\u{f75b}"
        case .moreCircleFilled: return "\u{f75c}"
        case .moreCircleLight: return "\u{f75d}"
        case .moreCircleRegular: return "\u{f75e}"
        case .moreLight: return "\u{f75f}"
        case .moreRegular: return "\u{f760}"
        case .mouseCursorBold: return "\u{f761}"
        case .mouseCursorLight: return "\u{f762}"
        case .mouseCursorRegular: return "\u{f763}"
        case .moveCallInAdrBold: return "\u{f764}"
        case .moveCallInAdrLight: return "\u{f765}"
        case .moveCallInAdrRegular: return "\u{f766}"
        case .moveCallInIphBold: return "\u{f767}"
        case .moveCallInIphLight: return "\u{f768}"
        case .moveCallInIphRegular: return "\u{f769}"
        case .moveCallInLaptopBold: return "\u{f76a}"
        case .moveCallInLaptopLight: return "\u{f76b}"
        case .moveCallInLaptopRegular: return "\u{f76c}"
        case .moveCallInOutAdrBold: return "\u{f76d}"
        case .moveCallInOutAdrLight: return "\u{f76e}"
        case .moveCallInOutAdrRegular: return "\u{f76f}"
        case .moveCallInOutIphBold: return "\u{f770}"
        case .moveCallInOutIphLight: return "\u{f771}"
        case .moveCallInOutIphRegular: return "\u{f772}"
        case .moveCallInTabletBold: return "\u{f773}"
        case .moveCallInTabletLight: return "\u{f774}"
        case .moveCallInTabletRegular: return "\u{f775}"
        case .moveCallOutAdrBold: return "\u{f776}"
        case .moveCallOutAdrLight: return "\u{f777}"
        case .moveCallOutAdrRegular: return "\u{f778}"
        case .moveCallOutIphBold: return "\u{f779}"
        case .moveCallOutIphLight: return "\u{f77a}"
        case .moveCallOutIphRegular: return "\u{f77b}"
        case .moveCallOutLaptopBold: return "\u{f77c}"
        case .moveCallOutLaptopLight: return "\u{f77d}"
        case .moveCallOutLaptopRegular: return "\u{f77e}"
        case .moveCallOutTabletBold: return "\u{f77f}"
        case .moveCallOutTabletLight: return "\u{f780}"
        case .moveCallOutTabletRegular: return "\u{f781}"
        case .moveToScreenBold: return "\u{f782}"
        case .moveToScreenLight: return "\u{f783}"
        case .moveToScreenRegular: return "\u{f784}"
        case .multilineChartBold: return "\u{f785}"
        case .multilineChartFilled: return "\u{f786}"
        case .multilineChartLight: return "\u{f787}"
        case .multilineChartRegular: return "\u{f788}"
        case .multimediaBold: return "\u{f789}"
        case .multimediaFilled: return "\u{f78a}"
        case .multimediaLight: return "\u{f78b}"
        case .multimediaRegular: return "\u{f78c}"
        case .multipledDevicesBold: return "\u{f78d}"
        case .multipledDevicesLight: return "\u{f78e}"
        case .multipledDevicesRegular: return "\u{f78f}"
        case .musicModeCircleBold: return "\u{f790}"
        case .musicModeCircleFilled: return "\u{f791}"
        case .musicModeCircleLight: return "\u{f792}"
        case .musicModeCircleRegular: return "\u{f793}"
        case .musicNoteBold: return "\u{f794}"
        case .musicNoteFilled: return "\u{f795}"
        case .musicNoteLight: return "\u{f796}"
        case .musicNoteRegular: return "\u{f797}"
        case .muteOnEntryBold: return "\u{f798}"
        case .muteOnEntryFilled: return "\u{f799}"
        case .muteOnEntryLight: return "\u{f79a}"
        case .muteOnEntryRegular: return "\u{f79b}"
        case .newManagerBold: return "\u{f79c}"
        case .newManagerLight: return "\u{f79d}"
        case .newManagerRegular: return "\u{f79e}"
        case .newTitleBold: return "\u{f79f}"
        case .newTitleLight: return "\u{f7a0}"
        case .newTitleRegular: return "\u{f7a1}"
        case .newVoicemailBold: return "\u{f7a2}"
        case .newVoicemailLight: return "\u{f7a3}"
        case .newVoicemailRegular: return "\u{f7a4}"
        case .newWhiteboardBold: return "\u{f7a5}"
        case .newWhiteboardLight: return "\u{f7a6}"
        case .newWhiteboardRegular: return "\u{f7a7}"
        case .nextBold: return "\u{f7a8}"
        case .nextLight: return "\u{f7a9}"
        case .nextRegular: return "\u{f7aa}"
        case .noDevicesBold: return "\u{f7ab}"
        case .noDevicesLight: return "\u{f7ac}"
        case .noDevicesRegular: return "\u{f7ad}"
        case .noiseDetectedCanceledFilled: return "\u{f7ae}"
        case .noiseDetectedFilled: return "\u{f7af}"
        case .noiseNoneCanceledFilled: return "\u{f7b0}"
        case .noiseNoneFilled: return "\u{f7b1}"
        case .noiseRemovalBold: return "\u{f7b2}"
        case .noiseRemovalLight: return "\u{f7b3}"
        case .noiseRemovalRegular: return "\u{f7b4}"
        case .noteBold: return "\u{f7b5}"
        case .noteLight: return "\u{f7b6}"
        case .notePptBold: return "\u{f7b7}"
        case .notePptLight: return "\u{f7b8}"
        case .notePptRegular: return "\u{f7b9}"
        case .noteRegular: return "\u{f7ba}"
        case .notesBold: return "\u{f7bb}"
        case .notesFilled: return "\u{f7bc}"
        case .notesLight: return "\u{f7bd}"
        case .notesRegular: return "\u{f7be}"
        case .numberBold: return "\u{f7bf}"
        case .numberLight: return "\u{f7c0}"
        case .numberRegular: return "\u{f7c1}"
        case .oldRemoteBold: return "\u{f7c2}"
        case .oldRemoteLight: return "\u{f7c3}"
        case .oldRemoteRegular: return "\u{f7c4}"
        case .oldTouchBold: return "\u{f7c5}"
        case .oldTouchLight: return "\u{f7c6}"
        case .oldTouchRegular: return "\u{f7c7}"
        case .oneColumnBold: return "\u{f7c8}"
        case .oneColumnLight: return "\u{f7c9}"
        case .oneColumnRegular: return "\u{f7ca}"
        case .oneTimeBold: return "\u{f7cb}"
        case .oneTimeLight: return "\u{f7cc}"
        case .oneTimeRegular: return "\u{f7cd}"
        case .openInFolderBold: return "\u{f7ce}"
        case .openInFolderLight: return "\u{f7cf}"
        case .openInFolderRegular: return "\u{f7d0}"
        case .openPagesBold: return "\u{f7d1}"
        case .openPagesLight: return "\u{f7d2}"
        case .openPagesRegular: return "\u{f7d3}"
        case .otherNumberBold: return "\u{f7d4}"
        case .otherNumberFilled: return "\u{f7d5}"
        case .otherNumberLight: return "\u{f7d6}"
        case .otherNumberRegular: return "\u{f7d7}"
        case .otherNumberWarningBold: return "\u{f7d8}"
        case .otherNumberWarningLight: return "\u{f7d9}"
        case .otherNumberWarningRegular: return "\u{f7da}"
        case .outgoingCallLegacyBold: return "\u{f7db}"
        case .outgoingCallLegacyFilled: return "\u{f7dc}"
        case .outgoingCallLegacyLight: return "\u{f7dd}"
        case .outgoingCallLegacyRegular: return "\u{f7de}"
        case .overflowLeftBold: return "\u{f7df}"
        case .overflowLeftLight: return "\u{f7e0}"
        case .overflowLeftRegular: return "\u{f7e1}"
        case .overflowRightBold: return "\u{f7e2}"
        case .overflowRightLight: return "\u{f7e3}"
        case .overflowRightRegular: return "\u{f7e4}"
        case .pairedCameraBold: return "\u{f7e5}"
        case .pairedCameraLight: return "\u{f7e6}"
        case .pairedCameraRegular: return "\u{f7e7}"
        case .pairedDeviceBold: return "\u{f7e8}"
        case .pairedDeviceLight: return "\u{f7e9}"
        case .pairedDeviceRegular: return "\u{f7ea}"
        case .pairedHandsetBold: return "\u{f7eb}"
        case .pairedHandsetLight: return "\u{f7ec}"
        case .pairedHandsetRegular: return "\u{f7ed}"
        case .pairingBold: return "\u{f7ee}"
        case .pairingLight: return "\u{f7ef}"
        case .pairingRegular: return "\u{f7f0}"
        case .parkedBold: return "\u{f7f1}"
        case .parkedFilled: return "\u{f7f2}"
        case .parkedLight: return "\u{f7f3}"
        case .parkedRegular: return "\u{f7f4}"
        case .parseBold: return "\u{f7f5}"
        case .parseLight: return "\u{f7f6}"
        case .parseRegular: return "\u{f7f7}"
        case .partialBold: return "\u{f7f8}"
        case .partialLight: return "\u{f7f9}"
        case .partialRegular: return "\u{f7fa}"
        case .participantAddBold: return "\u{f7fb}"
        case .participantAddLight: return "\u{f7fc}"
        case .participantAddRegular: return "\u{f7fd}"
        case .participantBlockedBold: return "\u{f7fe}"
        case .participantBlockedLight: return "\u{f7ff}"
        case .participantBlockedRegular: return "\u{f800}"
        case .participantBold: return "\u{f801}"
        case .participantFilled: return "\u{f802}"
        case .participantLight: return "\u{f803}"
        case .participantListBold: return "\u{f804}"
        case .participantListFilled: return "\u{f805}"
        case .participantListLight: return "\u{f806}"
        case .participantListRegular: return "\u{f807}"
        case .participantRegular: return "\u{f808}"
        case .participantRemoveBold: return "\u{f809}"
        case .participantRemoveLight: return "\u{f80a}"
        case .participantRemoveRegular: return "\u{f80b}"
        case .participantUnknownBold: return "\u{f80c}"
        case .participantUnknownLight: return "\u{f80d}"
        case .participantUnknownRegular: return "\u{f80e}"
        case .passMouseBold: return "\u{f80f}"
        case .passMouseLight: return "\u{f810}"
        case .passMouseRegular: return "\u{f811}"
        case .pauseBadgeFilled: return "\u{f812}"
        case .pauseBold: return "\u{f813}"
        case .pauseFilled: return "\u{f814}"
        case .pauseLight: return "\u{f815}"
        case .pauseRegular: return "\u{f816}"
        case .penBold: return "\u{f817}"
        case .penFilled: return "\u{f818}"
        case .penLight: return "\u{f819}"
        case .penRegular: return "\u{f81a}"
        case .peopleAddBold: return "\u{f81b}"
        case .peopleAddFilled: return "\u{f81c}"
        case .peopleAddLight: return "\u{f81d}"
        case .peopleAddRegular: return "\u{f81e}"
        case .peopleBold: return "\u{f81f}"
        case .peopleCircleBold: return "\u{f820}"
        case .peopleCircleFilled: return "\u{f821}"
        case .peopleCircleLight: return "\u{f822}"
        case .peopleCircleRegular: return "\u{f823}"
        case .peopleFilled: return "\u{f824}"
        case .peopleInsightsBold: return "\u{f825}"
        case .peopleInsightsFilled: return "\u{f826}"
        case .peopleInsightsLight: return "\u{f827}"
        case .peopleInsightsRegular: return "\u{f828}"
        case .peopleLight: return "\u{f829}"
        case .peopleRegular: return "\u{f82a}"
        case .phoneAlertBold: return "\u{f82b}"
        case .phoneAlertLight: return "\u{f82c}"
        case .phoneAlertRegular: return "\u{f82d}"
        case .phoneBadgeFilled: return "\u{f82e}"
        case .phoneBold: return "\u{f82f}"
        case .phoneFilled: return "\u{f830}"
        case .phoneLight: return "\u{f831}"
        case .phoneMutedBold: return "\u{f832}"
        case .phoneMutedLight: return "\u{f833}"
        case .phoneMutedRegular: return "\u{f834}"
        case .phonePrivateBold: return "\u{f835}"
        case .phonePrivateLight: return "\u{f836}"
        case .phonePrivateRegular: return "\u{f837}"
        case .phoneRegular: return "\u{f838}"
        case .phoneReplyAllBold: return "\u{f839}"
        case .phoneReplyAllLight: return "\u{f83a}"
        case .phoneReplyAllRegular: return "\u{f83b}"
        case .phoneReplyBold: return "\u{f83c}"
        case .phoneReplyLight: return "\u{f83d}"
        case .phoneReplyRegular: return "\u{f83e}"
        case .pickerBold: return "\u{f83f}"
        case .pickerLight: return "\u{f840}"
        case .pickerRegular: return "\u{f841}"
        case .pieChartBold: return "\u{f842}"
        case .pieChartFilled: return "\u{f843}"
        case .pieChartLight: return "\u{f844}"
        case .pieChartRegular: return "\u{f845}"
        case .pinBold: return "\u{f846}"
        case .pinFilled: return "\u{f847}"
        case .pinLight: return "\u{f848}"
        case .pinListActivityBold: return "\u{f849}"
        case .pinListActivityLight: return "\u{f84a}"
        case .pinListActivityRegular: return "\u{f84b}"
        case .pinListBold: return "\u{f84c}"
        case .pinListLight: return "\u{f84d}"
        case .pinListRegular: return "\u{f84e}"
        case .pinMutedBold: return "\u{f84f}"
        case .pinMutedFilled: return "\u{f850}"
        case .pinMutedLight: return "\u{f851}"
        case .pinMutedRegular: return "\u{f852}"
        case .pinRegular: return "\u{f853}"
        case .pipBold: return "\u{f854}"
        case .pipEnterBold: return "\u{f855}"
        case .pipEnterLight: return "\u{f856}"
        case .pipEnterRegular: return "\u{f857}"
        case .pipExitBold: return "\u{f858}"
        case .pipExitLight: return "\u{f859}"
        case .pipExitRegular: return "\u{f85a}"
        case .pipFilled: return "\u{f85b}"
        case .pipLight: return "\u{f85c}"
        case .pipRegular: return "\u{f85d}"
        case .placeholderBold: return "\u{f85e}"
        case .placeholderFilled: return "\u{f85f}"
        case .placeholderLight: return "\u{f860}"
        case .placeholderRegular: return "\u{f861}"
        case .playBold: return "\u{f862}"
        case .playCircleBold: return "\u{f863}"
        case .playCircleFilled: return "\u{f864}"
        case .playCircleLight: return "\u{f865}"
        case .playCircleRegular: return "\u{f866}"
        case .playFilled: return "\u{f867}"
        case .playLight: return "\u{f868}"
        case .playRegular: return "\u{f869}"
        case .plugAcBold: return "\u{f86a}"
        case .plugAcLight: return "\u{f86b}"
        case .plugAcRegular: return "\u{f86c}"
        case .plusBold: return "\u{f86d}"
        case .plusCircleBold: return "\u{f86e}"
        case .plusCircleFilled: return "\u{f86f}"
        case .plusCircleLight: return "\u{f870}"
        case .plusCircleRegular: return "\u{f871}"
        case .plusLight: return "\u{f872}"
        case .plusRegular: return "\u{f873}"
        case .pmrBold: return "\u{f874}"
        case .pmrFilled: return "\u{f875}"
        case .pmrLight: return "\u{f876}"
        case .pmrRegular: return "\u{f877}"
        case .pollBold: return "\u{f878}"
        case .pollFilled: return "\u{f879}"
        case .pollLight: return "\u{f87a}"
        case .pollRegular: return "\u{f87b}"
        case .popInBold: return "\u{f87c}"
        case .popInLight: return "\u{f87d}"
        case .popInRegular: return "\u{f87e}"
        case .popOutBold: return "\u{f87f}"
        case .popOutLight: return "\u{f880}"
        case .popOutRegular: return "\u{f881}"
        case .popUpBold: return "\u{f882}"
        case .popUpLight: return "\u{f883}"
        case .popUpRegular: return "\u{f884}"
        case .portraitLandscapeBold: return "\u{f885}"
        case .portraitLandscapeLight: return "\u{f886}"
        case .portraitLandscapeRegular: return "\u{f887}"
        case .powerAcBold: return "\u{f888}"
        case .powerAcLight: return "\u{f889}"
        case .powerAcRegular: return "\u{f88a}"
        case .powerBold: return "\u{f88b}"
        case .powerLight: return "\u{f88c}"
        case .powerRegular: return "\u{f88d}"
        case .preHeaderBold: return "\u{f88e}"
        case .preHeaderLight: return "\u{f88f}"
        case .preHeaderRegular: return "\u{f890}"
        case .premiumBold: return "\u{f891}"
        case .premiumLight: return "\u{f892}"
        case .premiumRegular: return "\u{f893}"
        case .presentationBold: return "\u{f894}"
        case .presentationLight: return "\u{f895}"
        case .presentationRegular: return "\u{f896}"
        case .preventDownloadBold: return "\u{f897}"
        case .preventDownloadFilled: return "\u{f898}"
        case .preventDownloadLight: return "\u{f899}"
        case .preventDownloadRegular: return "\u{f89a}"
        case .primaryParticipantBold: return "\u{f89b}"
        case .primaryParticipantLight: return "\u{f89c}"
        case .primaryParticipantRegular: return "\u{f89d}"
        case .printBold: return "\u{f89e}"
        case .printLight: return "\u{f89f}"
        case .printRegular: return "\u{f8a0}"
        case .priorityBadgeFilled: return "\u{f8a1}"
        case .priorityCircleBold: return "\u{f8a2}"
        case .priorityCircleFilled: return "\u{f8a3}"
        case .priorityCircleLight: return "\u{f8a4}"
        case .priorityCircleRegular: return "\u{f8a5}"
        case .priorityCircleTwoBold: return "\u{f8a6}"
        case .priorityCircleTwoFilled: return "\u{f8a7}"
        case .priorityCircleTwoLight: return "\u{f8a8}"
        case .priorityCircleTwoRegular: return "\u{f8a9}"
        case .privacyCircleBold: return "\u{f8aa}"
        case .privacyCircleFilled: return "\u{f8ab}"
        case .privacyCircleLight: return "\u{f8ac}"
        case .privacyCircleRegular: return "\u{f8ad}"
        case .privateBold: return "\u{f8ae}"
        case .privateCircleBold: return "\u{f8af}"
        case .privateCircleFilled: return "\u{f8b0}"
        case .privateCircleLight: return "\u{f8b1}"
        case .privateCircleRegular: return "\u{f8b2}"
        case .privateLight: return "\u{f8b3}"
        case .privateMeetingBold: return "\u{f8b4}"
        case .privateMeetingLight: return "\u{f8b5}"
        case .privateMeetingRegular: return "\u{f8b6}"
        case .privateRegular: return "\u{f8b7}"
        case .productDemoBold: return "\u{f8b8}"
        case .productDemoLight: return "\u{f8b9}"
        case .productDemoRegular: return "\u{f8ba}"
        case .proximityBold: return "\u{f8bb}"
        case .proximityLight: return "\u{f8bc}"
        case .proximityMutedBold: return "\u{f8bd}"
        case .proximityMutedLight: return "\u{f8be}"
        case .proximityMutedRegular: return "\u{f8bf}"
        case .proximityRegular: return "\u{f8c0}"
        case .proximityVideoBold: return "\u{f8c1}"
        case .proximityVideoLight: return "\u{f8c2}"
        case .proximityVideoRegular: return "\u{f8c3}"
        case .ptoPresenceBold: return "\u{f8c4}"
        case .ptoPresenceFilled: return "\u{f8c5}"
        case .ptoPresenceLight: return "\u{f8c6}"
        case .ptoPresenceRegular: return "\u{f8c7}"
        case .pullCallBold: return "\u{f8c8}"
        case .pullCallFilled: return "\u{f8c9}"
        case .pullCallLight: return "\u{f8ca}"
        case .pullCallRegular: return "\u{f8cb}"
        case .qABold: return "\u{f8cc}"
        case .qALight: return "\u{f8cd}"
        case .qARegular: return "\u{f8ce}"
        case .qrCodeBold: return "\u{f8cf}"
        case .qrCodeLight: return "\u{f8d0}"
        case .qrCodeRegular: return "\u{f8d1}"
        case .qrCodeScanBold: return "\u{f8d2}"
        case .qrCodeScanLight: return "\u{f8d3}"
        case .qrCodeScanRegular: return "\u{f8d4}"
        case .qualityBold: return "\u{f8d5}"
        case .qualityLight: return "\u{f8d6}"
        case .qualityRegular: return "\u{f8d7}"
        case .queueContactBold: return "\u{f8d8}"
        case .queueContactFilled: return "\u{f8d9}"
        case .queueContactLight: return "\u{f8da}"
        case .queueContactRegular: return "\u{f8db}"
        case .quietBold: return "\u{f8dc}"
        case .quietHoursPresenceBold: return "\u{f8dd}"
        case .quietHoursPresenceFilled: return "\u{f8de}"
        case .quietHoursPresenceLight: return "\u{f8df}"
        case .quietHoursPresenceRegular: return "\u{f8e0}"
        case .quietLight: return "\u{f8e1}"
        case .quietRegular: return "\u{f8e2}"
        case .radioButtonGroupBold: return "\u{f8e3}"
        case .radioButtonGroupLight: return "\u{f8e4}"
        case .radioButtonGroupRegular: return "\u{f8e5}"
        case .raiseHandBold: return "\u{f8e6}"
        case .raiseHandCircleFilled: return "\u{f8e7}"
        case .raiseHandFilled: return "\u{f8e8}"
        case .raiseHandLight: return "\u{f8e9}"
        case .raiseHandRegular: return "\u{f8ea}"
        case .ramBold: return "\u{f8eb}"
        case .ramLight: return "\u{f8ec}"
        case .ramRegular: return "\u{f8ed}"
        case .reactionsBold: return "\u{f8ee}"
        case .reactionsFilled: return "\u{f8ef}"
        case .reactionsLight: return "\u{f8f0}"
        case .reactionsRegular: return "\u{f8f1}"
        case .reactivateBold: return "\u{f8f2}"
        case .reactivateLight: return "\u{f8f3}"
        case .reactivateRegular: return "\u{f8f4}"
        case .receiveVoiceBold: return "\u{f8f5}"
        case .receiveVoiceFilled: return "\u{f8f6}"
        case .receiveVoiceLight: return "\u{f8f7}"
        case .receiveVoiceRegular: return "\u{f8f8}"
        case .recentsBold: return "\u{f8f9}"
        case .recentsFilled: return "\u{f8fa}"
        case .recentsLight: return "\u{f8fb}"
        case .recentsPresenceBadgeFilled: return "\u{f8fc}"
        case .recentsPresenceBold: return "\u{f8fd}"
        case .recentsPresenceFilled: return "\u{f8fe}"
        case .recentsPresenceLight: return "\u{f8ff}"
        case .recentsPresenceRegular: return "\u{f900}"
        case .recentsRegular: return "\u{f901}"
        case .recordActiveBold: return "\u{f902}"
        case .recordActiveFilled: return "\u{f903}"
        case .recordActiveLight: return "\u{f904}"
        case .recordActiveRegular: return "\u{f905}"
        case .recordBold: return "\u{f906}"
        case .recordFilled: return "\u{f907}"
        case .recordLight: return "\u{f908}"
        ...
        case .redialBold: return "\u{f914}"
        case .redialLight: return "\u{f915}"
        case .redialRegular: return "\u{f916}"
        case .redoBold: return "\u{f917}"
        case .redoLight: return "\u{f918}"
        case .redoRegular: return "\u{f919}"
        case .refreshBold: return "\u{f91a}"
        case .refreshLight: return "\u{f91b}"
        case .refreshRegular: return "\u{f91c}"
        case .remoteDesktopControlBold: return "\u{f91d}"
        case .remoteDesktopControlFilled: return "\u{f91e}"
        case .remoteDesktopControlLight: return "\u{f91f}"
        case .remoteDesktopControlRegular: return "\u{f920}"
        case .removeBold: return "\u{f921}"
        case .removeFilled: return "\u{f922}"
        case .removeLight: return "\u{f923}"
        case .removeRegular: return "\u{f924}"
        case .replyBold: return "\u{f925}"
        case .replyFilled: return "\u{f926}"
        case .replyLight: return "\u{f927}"
        case .replyListBold: return "\u{f928}"
        case .replyListLight: return "\u{f929}"
        case .replyListRegular: return "\u{f92a}"
        case .replyPrivatelyBold: return "\u{f92b}"
        case .replyPrivatelyLight: return "\u{f92c}"
        case .replyPrivatelyRegular: return "\u{f92d}"
        case .replyRegular: return "\u{f92e}"
        case .resetBold: return "\u{f92f}"
        case .resetLight: return "\u{f930}"
        case .resetRegular: return "\u{f931}"
        case .resizeCornerBold: return "\u{f932}"
        case .resizeCornerLight: return "\u{f933}"
        case .resizeCornerRegular: return "\u{f934}"
        case .responsiveMobileBold: return "\u{f935}"
        case .responsiveMobileLight: return "\u{f936}"
        case .responsiveMobileRegular: return "\u{f937}"
        case .restartBold: return "\u{f938}"
        case .restartLight: return "\u{f939}"
        case .restartRegular: return "\u{f93a}"
        case .retrieveCallBold: return "\u{f93b}"
        case .retrieveCallFilled: return "\u{f93c}"
        case .retrieveCallLight: return "\u{f93d}"
        case .retrieveCallRegular: return "\u{f93e}"
        case .returnBold: return "\u{f93f}"
        case .returnLight: return "\u{f940}"
        case .returnRegular: return "\u{f941}"
        case .rewindTenSecBold: return "\u{f942}"
        case .rewindTenSecLight: return "\u{f943}"
        case .rewindTenSecRegular: return "\u{f944}"
        case .ringtoneBold: return "\u{f945}"
        case .ringtoneLight: return "\u{f946}"
        case .ringtoneRegular: return "\u{f947}"
        case .roomCalendarBold: return "\u{f948}"
        case .roomCalendarLight: return "\u{f949}"
        case .roomCalendarRegular: return "\u{f94a}"
        case .roomLightsBold: return "\u{f94b}"
        case .roomLightsFilled: return "\u{f94c}"
        case .roomLightsLight: return "\u{f94d}"
        case .roomLightsRegular: return "\u{f94e}"
        case .rotateContentBold: return "\u{f94f}"
        case .rotateContentFilled: return "\u{f950}"
        case .rotateContentLight: return "\u{f951}"
        case .rotateContentRegular: return "\u{f952}"
        case .rssBold: return "\u{f953}"
        case .rssFilled: return "\u{f954}"
        case .rssLight: return "\u{f955}"
        case .rssRegular: return "\u{f956}"
        case .ruleBasedBold: return "\u{f957}"
        case .ruleBasedLight: return "\u{f958}"
        case .ruleBasedRegular: return "\u{f959}"
        case .runningApplicationBold: return "\u{f95a}"
        case .runningApplicationFilled: return "\u{f95b}"
        case .runningApplicationLight: return "\u{f95c}"
        case .runningApplicationRegular: return "\u{f95d}"
        case .saveBold: return "\u{f95e}"
        case .saveLight: return "\u{f95f}"
        case .saveRegular: return "\u{f960}"
        case .saveTranscriptBold: return "\u{f961}"
        case .saveTranscriptFilled: return "\u{f962}"
        case .saveTranscriptLight: return "\u{f963}"
        case .saveTranscriptRegular: return "\u{f964}"
        case .scanBold: return "\u{f965}"
        case .scanLight: return "\u{f966}"
        case .scanRegular: return "\u{f967}"
        case .scheduleSendBold: return "\u{f968}"
        case .scheduleSendFilled: return "\u{f969}"
        case .scheduleSendLight: return "\u{f96a}"
        case .scheduleSendRegular: return "\u{f96b}"
        case .scheduleWinnerBold: return "\u{f96c}"
        case .scheduleWinnerFilled: return "\u{f96d}"
        case .scheduleWinnerLight: return "\u{f96e}"
        case .scheduleWinnerRegular: return "\u{f96f}"
        case .schedulerAvailableBold: return "\u{f970}"
        case .schedulerAvailableLight: return "\u{f971}"
        case .schedulerAvailableRegular: return "\u{f972}"
        case .schedulerNotWorkingHoursBold: return "\u{f973}"
        case .schedulerNotWorkingHoursLight: return "\u{f974}"
        case .schedulerNotWorkingHoursRegular: return "\u{f975}"
        case .schedulerUnavailableBold: return "\u{f976}"
        case .schedulerUnavailableLight: return "\u{f977}"
        case .schedulerUnavailableRegular: return "\u{f978}"
        case .schedulerUnknownBold: return "\u{f979}"
        case .schedulerUnknownLight: return "\u{f97a}"
        case .schedulerUnknownRegular: return "\u{f97b}"
        case .screenshotBold: return "\u{f97c}"
        case .screenshotDocBold: return "\u{f97d}"
        case .screenshotDocFilled: return "\u{f97e}"
        case .screenshotDocLight: return "\u{f97f}"
        case .screenshotDocRegular: return "\u{f980}"
        case .screenshotLight: return "\u{f981}"
        case .screenshotRegular: return "\u{f982}"
        case .searchBold: return "\u{f983}"
        case .searchFilled: return "\u{f984}"
        case .searchLight: return "\u{f985}"
        case .searchRegular: return "\u{f986}"
        case .secondaryArrowBold: return "\u{f987}"
        case .secondaryArrowLight: return "\u{f988}"
        case .secondaryArrowRegular: return "\u{f989}"
        case .secureCallLockBold: return "\u{f98a}"
        case .secureCallLockFilled: return "\u{f98b}"
        case .secureCallLockLight: return "\u{f98c}"
        case .secureCallLockRegular: return "\u{f98d}"
        case .secureCallShieldBold: return "\u{f98e}"
        case .secureCallShieldFilled: return "\u{f98f}"
        case .secureCallShieldLight: return "\u{f990}"
        case .secureCallShieldRegular: return "\u{f991}"
        case .secureCircleBold: return "\u{f992}"
        case .secureCircleFilled: return "\u{f993}"
        case .secureCircleLight: return "\u{f994}"
        case .secureCircleRegular: return "\u{f995}"
        case .secureLockBold: return "\u{f996}"
        case .secureLockFilled: return "\u{f997}"
        case .secureLockLight: return "\u{f998}"
        case .secureLockRegular: return "\u{f999}"
        case .segmentExcludeFilled: return "\u{f99a}"
        case .segmentFilterFilled: return "\u{f99b}"
        case .segmentIncludeFilled: return "\u{f99c}"
        case .selectAllBold: return "\u{f99d}"
        case .selectAllFilled: return "\u{f99e}"
        case .selectAllLight: return "\u{f99f}"
        case .selectAllRegular: return "\u{f9a0}"
        case .selectionBold: return "\u{f9a1}"
        case .selectionLight: return "\u{f9a2}"
        case .selectionRegular: return "\u{f9a3}"
        case .sendBold: return "\u{f9a4}"
        case .sendFilled: return "\u{f9a5}"
        case .sendLight: return "\u{f9a6}"
        case .sendRegular: return "\u{f9a7}"
        case .sendVoiceBold: return "\u{f9a8}"
        case .sendVoiceFilled: return "\u{f9a9}"
        case .sendVoiceLight: return "\u{f9aa}"
        case .sendVoiceRegular: return "\u{f9ab}"
        case .serverBold: return "\u{f9ac}"
        case .serverErrorBold: return "\u{f9ad}"
        case .serverErrorLight: return "\u{f9ae}"
        case .serverErrorRegular: return "\u{f9af}"
        case .serverLight: return "\u{f9b0}"
        case .serverRegular: return "\u{f9b1}"
        case .servicesBold: return "\u{f9b2}"
        case .servicesLight: return "\u{f9b3}"
        case .servicesRegular: return "\u{f9b4}"
        case .setVariableBold: return "\u{f9b5}"
        case .setVariableLight: return "\u{f9b6}"
        case .setVariableRegular: return "\u{f9b7}"
        case .settingsBold: return "\u{f9b8}"
        case .settingsFilled: return "\u{f9b9}"
        case .settingsLight: return "\u{f9ba}"
        case .settingsRegular: return "\u{f9bb}"
        case .setupAssistantBold: return "\u{f9bc}"
        case .setupAssistantLight: return "\u{f9bd}"
        case .setupAssistantRegular: return "\u{f9be}"
        case .sftpBold: return "\u{f9bf}"
        case .sftpLight: return "\u{f9c0}"
        case .sftpRegular: return "\u{f9c1}"
        case .shapeCircleBold: return "\u{f9c2}"
        case .shapeCircleFilled: return "\u{f9c3}"
        case .shapeCircleLight: return "\u{f9c4}"
        case .shapeCircleMdFilled: return "\u{f9c5}"
        case .shapeCircleRegular: return "\u{f9c6}"
        case .shapeCircleSmFilled: return "\u{f9c7}"
        case .shapeDiagonalLineBold: return "\u{f9c8}"
        case .shapeDiagonalLineLight: return "\u{f9c9}"
        case .shapeDiagonalLineRegular: return "\u{f9ca}"
        case .shapeDiamondBold: return "\u{f9cb}"
        case .shapeDiamondFilled: return "\u{f9cc}"
        case .shapeDiamondLight: return "\u{f9cd}"
        case .shapeDiamondRegular: return "\u{f9ce}"
        case .shapeOvalBold: return "\u{f9cf}"
        case .shapeOvalLight: return "\u{f9d0}"
        case .shapeOvalRegular: return "\u{f9d1}"
        case .shapeSquareBold: return "\u{f9d2}"
        case .shapeSquareFilled: return "\u{f9d3}"
        case .shapeSquareLight: return "\u{f9d4}"
        case .shapeSquareRegular: return "\u{f9d5}"
        case .shapeTriangleBold: return "\u{f9d6}"
        case .shapeTriangleFilled: return "\u{f9d7}"
        case .shapeTriangleLight: return "\u{f9d8}"
        case .shapeTriangleRegular: return "\u{f9d9}"
        case .shapesBold: return "\u{f9da}"
        case .shapesLight: return "\u{f9db}"
        case .shapesRegular: return "\u{f9dc}"
        case .shareCNativeAdrBold: return "\u{f9dd}"
        case .shareCNativeAdrFilled: return "\u{f9de}"
        case .shareCNativeAdrLight: return "\u{f9df}"
        case .shareCNativeAdrRegular: return "\u{f9e0}"
        case .shareCNativeIphBold: return "\u{f9e1}"
        case .shareCNativeIphLight: return "\u{f9e2}"
        case .shareCNativeIphRegular: return "\u{f9e3}"
        case .shareContentOnDeviceBold: return "\u{f9e4}"
        case .shareContentOnDeviceLight: return "\u{f9e5}"
        case .shareContentOnDeviceRegular: return "\u{f9e6}"
        case .shareScreenAddBold: return "\u{f9e7}"
        case .shareScreenAddLight: return "\u{f9e8}"
        case .shareScreenAddRegular: return "\u{f9e9}"
        case .shareScreenBadgeFilled: return "\u{f9ea}"
        case .shareScreenBold: return "\u{f9eb}"
        case .shareScreenFilled: return "\u{f9ec}"
        case .shareScreenLight: return "\u{f9ed}"
        case .shareScreenRegular: return "\u{f9ee}"
        case .shareSpaceBold: return "\u{f9ef}"
        case .shareSpaceLight: return "\u{f9f0}"
        case .shareSpaceRegular: return "\u{f9f1}"
        case .shieldBold: return "\u{f9f2}"
        case .shieldLight: return "\u{f9f3}"
        case .shieldRegular: return "\u{f9f4}"
        case .shoppingCartBold: return "\u{f9f5}"
        case .shoppingCartFilled: return "\u{f9f6}"
        case .shoppingCartLight: return "\u{f9f7}"
        case .shoppingCartRegular: return "\u{f9f8}"
        case .shortTextBoxBold: return "\u{f9f9}"
        case .shortTextBoxLight: return "\u{f9fa}"
        case .shortTextBoxRegular: return "\u{f9fb}"
        case .showBold: return "\u{f9fc}"
        case .showFilled: return "\u{f9fd}"
        case .showLight: return "\u{f9fe}"
        case .showRegular: return "\u{f9ff}"
        case .signInBold: return "\u{fa00}"
        case .signInFilled: return "\u{fa01}"
        case .signInForcedBold: return "\u{fa02}"
        case .signInForcedLight: return "\u{fa03}"
        case .signInForcedRegular: return "\u{fa04}"
        case .signInLight: return "\u{fa05}"
        case .signInRegular: return "\u{fa06}"
        case .signLangIntBold: return "\u{fa07}"
        case .signLangIntLight: return "\u{fa08}"
        case .signLangIntRegular: return "\u{fa09}"
        case .signOutBold: return "\u{fa0a}"
        case .signOutLight: return "\u{fa0b}"
        case .signOutRegular: return "\u{fa0c}"
        case .signalFourBold: return "\u{fa0d}"
        case .signalFourLight: return "\u{fa0e}"
        case .signalFourRegular: return "\u{fa0f}"
        case .signalOneBold: return "\u{fa10}"
        case .signalOneLight: return "\u{fa11}"
        case .signalOneRegular: return "\u{fa12}"
        case .signalThreeBold: return "\u{fa13}"
        case .signalThreeLight: return "\u{fa14}"
        case .signalThreeRegular: return "\u{fa15}"
        case .signalTwoBold: return "\u{fa16}"
        case .signalTwoLight: return "\u{fa17}"
        case .signalTwoRegular: return "\u{fa18}"
        case .signalZeroBold: return "\u{fa19}"
        case .signalZeroLight: return "\u{fa1a}"
        case .signalZeroRegular: return "\u{fa1b}"
        case .simplePromotionBold: return "\u{fa1c}"
        case .simplePromotionLight: return "\u{fa1d}"
        case .simplePromotionRegular: return "\u{fa1e}"
        case .singleNumberReachBold: return "\u{fa1f}"
        case .singleNumberReachLight: return "\u{fa20}"
        case .singleNumberReachRegular: return "\u{fa21}"
        case .sipRegistrationInProgressBold: return "\u{fa22}"
        case .sipRegistrationInProgressFilled: return "\u{fa23}"
        case .sipRegistrationInProgressLight: return "\u{fa24}"
        case .sipRegistrationInProgressRegular: return "\u{fa25}"
        case .skipBold: return "\u{fa26}"
        case .skipBwBold: return "\u{fa27}"
        case .skipBwFilled: return "\u{fa28}"
        case .skipBwLight: return "\u{fa29}"
        case .skipBwRegular: return "\u{fa2a}"
        case .skipFwBold: return "\u{fa2b}"
        case .skipFwFilled: return "\u{fa2c}"
        case .skipFwLight: return "\u{fa2d}"
        case .skipFwRegular: return "\u{fa2e}"
        case .skipLight: return "\u{fa2f}"
        case .skipRegular: return "\u{fa30}"
        case .smsFilled: return "\u{fa31}"
        case .smsInboundBold: return "\u{fa32}"
        case .smsInboundLight: return "\u{fa33}"
        case .smsInboundRegular: return "\u{fa34}"
        case .smsMessageBold: return "\u{fa35}"
        case .smsMessageFilled: return "\u{fa36}"
        case .smsMessageLight: return "\u{fa37}"
        case .smsMessageRegular: return "\u{fa38}"
        case .smsOutgoingFilled: return "\u{fa39}"
        case .smsUnreadBold: return "\u{fa3a}"
        case .smsUnreadLight: return "\u{fa3b}"
        case .smsUnreadRegular: return "\u{fa3c}"
        case .socialMmsColoredGold: return "\u{fa3d}"
        case .socialMms: return "\u{fa3e}"
        case .socialSmsColoredMint: return "\u{fa3f}"
        case .socialSmsOutgoing: return "\u{fa40}"
        case .socialSms: return "\u{fa41}"
        case .sortAscendingBold: return "\u{fa42}"
        case .sortAscendingLight: return "\u{fa43}"
        case .sortAscendingRegular: return "\u{fa44}"
        case .sortDescendingBold: return "\u{fa45}"
        case .sortDescendingLight: return "\u{fa46}"
        case .sortDescendingRegular: return "\u{fa47}"
        case .soundDefaultBold: return "\u{fa48}"
        case .soundDefaultLight: return "\u{fa49}"
        case .soundDefaultRegular: return "\u{fa4a}"
        case .sparkleBold: return "\u{fa4b}"
        case .sparkleFilled: return "\u{fa4c}"
        case .sparkleLight: return "\u{fa4d}"
        case .sparkleRegular: return "\u{fa4e}"
        case .speakerBold: return "\u{fa4f}"
        case .speakerDisconnectedBold: return "\u{fa50}"
        case .speakerDisconnectedFilled: return "\u{fa51}"
        case .speakerDisconnectedLight: return "\u{fa52}"
        case .speakerDisconnectedRegular: return "\u{fa53}"
        case .speakerFilled: return "\u{fa54}"
        case .speakerLight: return "\u{fa55}"
        case .speakerMutedBold: return "\u{fa56}"
        case .speakerMutedFilled: return "\u{fa57}"
        case .speakerMutedLight: return "\u{fa58}"
        case .speakerMutedRegular: return "\u{fa59}"
        case .speakerOffBold: return "\u{fa5a}"
        case .speakerOffFilled: return "\u{fa5b}"
        case .speakerOffLight: return "\u{fa5c}"
        case .speakerOffRegular: return "\u{fa5d}"
        case .speakerOnBold: return "\u{fa5e}"
        case .speakerOnLight: return "\u{fa5f}"
        case .speakerOnRegular: return "\u{fa60}"
        case .speakerRegular: return "\u{fa61}"
        case .speakerTurnDownBold: return "\u{fa62}"
        case .speakerTurnDownFilled: return "\u{fa63}"
        case .speakerTurnDownLight: return "\u{fa64}"
        case .speakerTurnDownRegular: return "\u{fa65}"
        case .speakerTurnUpBold: return "\u{fa66}"
        case .speakerTurnUpFilled: return "\u{fa67}"
        case .speakerTurnUpLight: return "\u{fa68}"
        case .speakerTurnUpRegular: return "\u{fa69}"
        case .speedDialBold: return "\u{fa6a}"
        case .speedDialFilled: return "\u{fa6b}"
        case .speedDialLight: return "\u{fa6c}"
        case .speedDialRegular: return "\u{fa6d}"
        case .spellCheckerBold: return "\u{fa6e}"
        case .spellCheckerLight: return "\u{fa6f}"
        case .spellCheckerRegular: return "\u{fa70}"
        case .spinnerBold: return "\u{fa71}"
        case .spinnerInProgressBold: return "\u{fa72}"
        case .spinnerInProgressLight: return "\u{fa73}"
        case .spinnerInProgressRegular: return "\u{fa74}"
        case .spinnerLight: return "\u{fa75}"
        case .spinnerRegular: return "\u{fa76}"
        case .splitViewBold: return "\u{fa77}"
        case .splitViewLight: return "\u{fa78}"
        case .splitViewRegular: return "\u{fa79}"
        case .stackedAreaChartBold: return "\u{fa7a}"
        case .stackedAreaChartFilled: return "\u{fa7b}"
        case .stackedAreaChartFullBold: return "\u{fa7c}"
        case .stackedAreaChartFullFilled: return "\u{fa7d}"
        case .stackedAreaChartFullLight: return "\u{fa7e}"
        case .stackedAreaChartFullRegular: return "\u{fa7f}"
        case .stackedAreaChartLight: return "\u{fa80}"
        case .stackedAreaChartRegular: return "\u{fa81}"
        case .stackedBarChartBold: return "\u{fa82}"
        case .stackedBarChartFilled: return "\u{fa83}"
        case .stackedBarChartFullBold: return "\u{fa84}"
        case .stackedBarChartFullFilled: return "\u{fa85}"
        case .stackedBarChartFullLight: return "\u{fa86}"
        case .stackedBarChartFullRegular: return "\u{fa87}"
        case .stackedBarChartLight: return "\u{fa88}"
        case .stackedBarChartRegular: return "\u{fa89}"
        case .startChatBold: return "\u{fa8a}"
        case .startChatLight: return "\u{fa8b}"
        case .startChatRegular: return "\u{fa8c}"
        case .stethoscopeBold: return "\u{fa8d}"
        case .stethoscopeLight: return "\u{fa8e}"
        case .stethoscopeRegular: return "\u{fa8f}"
        case .stickersBold: return "\u{fa90}"
        case .stickersLight: return "\u{fa91}"
        case .stickersRegular: return "\u{fa92}"
        case .stickiesBold: return "\u{fa93}"
        case .stickiesLight: return "\u{fa94}"
        case .stickiesRegular: return "\u{fa95}"
        case .stopBold: return "\u{fa96}"
        case .stopCircleBold: return "\u{fa97}"
        case .stopCircleFilled: return "\u{fa98}"
        case .stopCircleLight: return "\u{fa99}"
        case .stopCircleRegular: return "\u{fa9a}"
        case .stopContentShareBold: return "\u{fa9b}"
        case .stopContentShareLight: return "\u{fa9c}"
        case .stopContentShareRegular: return "\u{fa9d}"
        case .stopFilled: return "\u{fa9e}"
        case .stopLight: return "\u{fa9f}"
        case .stopRegular: return "\u{faa0}"
        case .storedInfoBold: return "\u{faa1}"
        case .storedInfoFilled: return "\u{faa2}"
        case .storedInfoLight: return "\u{faa3}"
        case .storedInfoRegular: return "\u{faa4}"
        case .streamingBold: return "\u{faa5}"
        case .streamingLight: return "\u{faa6}"
        case .streamingRegular: return "\u{faa7}"
        case .strikethroughBold: return "\u{faa8}"
        case .strikethroughFilled: return "\u{faa9}"
        case .strikethroughLight: return "\u{faaa}"
        case .strikethroughRegular: return "\u{faab}"
        case .studioModeBold: return "\u{faac}"
        case .studioModeLight: return "\u{faad}"
        case .studioModeRegular: return "\u{faae}"
        case .subscriptBold: return "\u{faaf}"
        case .subscriptLight: return "\u{fab0}"
        case .subscriptRegular: return "\u{fab1}"
        case .superscriptBold: return "\u{fab2}"
        case .superscriptLight: return "\u{fab3}"
        case .superscriptRegular: return "\u{fab4}"
        case .surveyBold: return "\u{fab5}"
        case .surveyFilled: return "\u{fab6}"
        case .surveyLight: return "\u{fab7}"
        case .surveyRegular: return "\u{fab8}"
        case .sxEightyCodecBold: return "\u{fab9}"
        case .sxEightyCodecLight: return "\u{faba}"
        case .sxEightyCodecRegular: return "\u{fabb}"
        case .sxTenBold: return "\u{fabc}"
        case .sxTenLight: return "\u{fabd}"
        case .sxTenRegular: return "\u{fabe}"
        case .sxTwentyBold: return "\u{fabf}"
        case .sxTwentyLight: return "\u{fac0}"
        case .sxTwentyRegular: return "\u{fac1}"
        case .tableBold: return "\u{fac2}"
        case .tableLight: return "\u{fac3}"
        case .tableRegular: return "\u{fac4}"
        case .tabletBold: return "\u{fac5}"
        case .tabletLight: return "\u{fac6}"
        case .tabletRegular: return "\u{fac7}"
        case .tabsBold: return "\u{fac8}"
        case .tabsLight: return "\u{fac9}"
        case .tabsRegular: return "\u{faca}"
        case .tagBold: return "\u{facb}"
        case .tagLight: return "\u{facc}"
        case .tagRegular: return "\u{facd}"
        case .tapBold: return "\u{face}"
        case .tapFilled: return "\u{facf}"
        case .tapLight: return "\u{fad0}"
        case .tapRegular: return "\u{fad1}"
        case .telepresenceAlertBold: return "\u{fad2}"
        case .telepresenceAlertLight: return "\u{fad3}"
        case .telepresenceAlertMutedBold: return "\u{fad4}"
        case .telepresenceAlertMutedLight: return "\u{fad5}"
        case .telepresenceAlertMutedRegular: return "\u{fad6}"
        case .telepresenceAlertRegular: return "\u{fad7}"
        case .telepresenceBold: return "\u{fad8}"
        case .telepresenceIxFiveThousandBold: return "\u{fad9}"
        case .telepresenceIxFiveThousandLight: return "\u{fada}"
        case .telepresenceIxFiveThousandRegular: return "\u{fadb}"
        case .telepresenceLight: return "\u{fadc}"
        case .telepresenceMutedBold: return "\u{fadd}"
        case .telepresenceMutedLight: return "\u{fade}"
        case .telepresenceMutedRegular: return "\u{fadf}"
        case .telepresencePrivateBold: return "\u{fae0}"
        case .telepresencePrivateLight: return "\u{fae1}"
        case .telepresencePrivateRegular: return "\u{fae2}"
        case .telepresenceRegular: return "\u{fae3}"
        case .temperatureBold: return "\u{fae4}"
        case .temperatureLight: return "\u{fae5}"
        case .temperatureRegular: return "\u{fae6}"
        case .testTubeBold: return "\u{fae7}"
        case .testTubeFilled: return "\u{fae8}"
        case .testTubeLight: return "\u{fae9}"
        case .testTubeRegular: return "\u{faea}"
        case .textAlignCenterBold: return "\u{faeb}"
        case .textAlignCenterFilled: return "\u{faec}"
        case .textAlignCenterLight: return "\u{faed}"
        case .textAlignCenterRegular: return "\u{faee}"
        case .textAlignLeftBold: return "\u{faef}"
        case .textAlignLeftFilled: return "\u{faf0}"
        case .textAlignLeftLight: return "\u{faf1}"
        case .textAlignLeftRegular: return "\u{faf2}"
        case .textAlignRightBold: return "\u{faf3}"
        case .textAlignRightFilled: return "\u{faf4}"
        case .textAlignRightLight: return "\u{faf5}"
        case .textAlignRightRegular: return "\u{faf6}"
        case .textBold: return "\u{faf7}"
        case .textBoxCursorLight: return "\u{faf8}"
        case .textCodeBlockBold: return "\u{faf9}"
        case .textCodeBlockLight: return "\u{fafa}"
        case .textCodeBlockRegular: return "\u{fafb}"
        case .textHighlightBold: return "\u{fafc}"
        case .textHighlightFilled: return "\u{fafd}"
        case .textHighlightLight: return "\u{fafe}"
        case .textHighlightRegular: return "\u{faff}"
        case .textLight: return "\u{fb00}"
        case .textRegular: return "\u{fb01}"
        case .threeColumnBold: return "\u{fb02}"
        case .threeColumnLight: return "\u{fb03}"
        case .threeColumnRegular: return "\u{fb04}"
        case .threeDObjectBold: return "\u{fb05}"
        case .threeDObjectLight: return "\u{fb06}"
        case .threeDObjectRegular: return "\u{fb07}"
        case .timeExclusionBold: return "\u{fb08}"
        case .timeExclusionLight: return "\u{fb09}"
        case .timeExclusionRegular: return "\u{fb0a}"
        case .tooFastBold: return "\u{fb0b}"
        case .tooFastLight: return "\u{fb0c}"
        case .tooFastRegular: return "\u{fb0d}"
        case .tooSlowBold: return "\u{fb0e}"
        case .tooSlowLight: return "\u{fb0f}"
        case .tooSlowRegular: return "\u{fb10}"
        case .toolsBold: return "\u{fb11}"
        case .toolsFilled: return "\u{fb12}"
        case .toolsLight: return "\u{fb13}"
        case .toolsRegular: return "\u{fb14}"
        case .touchTenBold: return "\u{fb15}"
        case .touchTenLight: return "\u{fb16}"
        case .touchTenRegular: return "\u{fb17}"
        case .transcriptBold: return "\u{fb18}"
        case .transcriptFilled: return "\u{fb19}"
        case .transcriptLight: return "\u{fb1a}"
        case .transcriptRegular: return "\u{fb1b}"
        case .translateBold: return "\u{fb1c}"
        case .translateLight: return "\u{fb1d}"
        case .translateRegular: return "\u{fb1e}"
        case .trendingBold: return "\u{fb1f}"
        ...
        case .viewListLight: return "\u{fb9b}"
        case .viewListRegular: return "\u{fb9c}"
        case .viewStackedBold: return "\u{fb9d}"
        case .viewStackedFilled: return "\u{fb9e}"
        case .viewStackedLight: return "\u{fb9f}"
        case .viewStackedRegular: return "\u{fba0}"
        case .viewThumbnailBold: return "\u{fba1}"
        case .viewThumbnailFilled: return "\u{fba2}"
        case .viewThumbnailLight: return "\u{fba3}"
        case .viewThumbnailRegular: return "\u{fba4}"
        case .visionproBold: return "\u{fba5}"
        case .visionproFilled: return "\u{fba6}"
        case .visionproLight: return "\u{fba7}"
        case .visionproMoveCallInBold: return "\u{fba8}"
        case .visionproMoveCallInFilled: return "\u{fba9}"
        case .visionproMoveCallInLight: return "\u{fbaa}"
        case .visionproMoveCallInOutBold: return "\u{fbab}"
        case .visionproMoveCallInOutFilled: return "\u{fbac}"
        case .visionproMoveCallInOutLight: return "\u{fbad}"
        case .visionproMoveCallInOutRegular: return "\u{fbae}"
        case .visionproMoveCallInRegular: return "\u{fbaf}"
        case .visionproMoveCallOutBold: return "\u{fbb0}"
        case .visionproMoveCallOutFilled: return "\u{fbb1}"
        case .visionproMoveCallOutLight: return "\u{fbb2}"
        case .visionproMoveCallOutRegular: return "\u{fbb3}"
        case .visionproRegular: return "\u{fbb4}"
        case .voicemailBold: return "\u{fbb5}"
        case .voicemailFilled: return "\u{fbb6}"
        case .voicemailLight: return "\u{fbb7}"
        case .voicemailRegular: return "\u{fbb8}"
        case .vscBold: return "\u{fbb9}"
        case .vscLight: return "\u{fbba}"
        case .vscRegular: return "\u{fbbb}"
        case .waffleMenuBold: return "\u{fbbc}"
        case .waffleMenuLight: return "\u{fbbd}"
        case .waffleMenuRegular: return "\u{fbbe}"
        case .waitingRoomBold: return "\u{fbbf}"
        case .waitingRoomLight: return "\u{fbc0}"
        case .waitingRoomRegular: return "\u{fbc1}"
        case .wallpaperBold: return "\u{fbc2}"
        case .wallpaperLight: return "\u{fbc3}"
        case .wallpaperRegular: return "\u{fbc4}"
        case .warningBadgeFilled: return "\u{fbc5}"
        case .warningBold: return "\u{fbc6}"
        case .warningFilled: return "\u{fbc7}"
        case .warningLight: return "\u{fbc8}"
        case .warningRegular: return "\u{fbc9}"
        case .webexBoardBold: return "\u{fbca}"
        case .webexBoardLight: return "\u{fbcb}"
        case .webexBoardRegular: return "\u{fbcc}"
        case .webexCodecPlusBold: return "\u{fbcd}"
        case .webexCodecPlusLight: return "\u{fbce}"
        case .webexCodecPlusRegular: return "\u{fbcf}"
        case .webexDeskCameraBold: return "\u{fbd0}"
        case .webexDeskCameraLight: return "\u{fbd1}"
        case .webexDeskCameraRegular: return "\u{fbd2}"
        case .webexHelixBold: return "\u{fbd3}"
        case .webexHelixLight: return "\u{fbd4}"
        case .webexHelixRegular: return "\u{fbd5}"
        case .webexMeetingsBold: return "\u{fbd6}"
        case .webexMeetingsFilled: return "\u{fbd7}"
        case .webexMeetingsLight: return "\u{fbd8}"
        case .webexMeetingsRegular: return "\u{fbd9}"
        case .webexQuadCameraBold: return "\u{fbda}"
        case .webexQuadCameraLight: return "\u{fbdb}"
        case .webexQuadCameraRegular: return "\u{fbdc}"
        case .webexRoomKitBold: return "\u{fbdd}"
        case .webexRoomKitLight: return "\u{fbde}"
        case .webexRoomKitPlusBold: return "\u{fbdf}"
        case .webexRoomKitPlusLight: return "\u{fbe0}"
        case .webexRoomKitPlusRegular: return "\u{fbe1}"
        case .webexRoomKitRegular: return "\u{fbe2}"
        case .webexShareBold: return "\u{fbe3}"
        case .webexShareLight: return "\u{fbe4}"
        case .webexShareRegular: return "\u{fbe5}"
        case .webexTeamsBold: return "\u{fbe6}"
        case .webexTeamsFilled: return "\u{fbe7}"
        case .webexTeamsLight: return "\u{fbe8}"
        case .webexTeamsNewBold: return "\u{fbe9}"
        case .webexTeamsNewFilled: return "\u{fbea}"
        case .webexTeamsNewLight: return "\u{fbeb}"
        case .webexTeamsNewRegular: return "\u{fbec}"
        case .webexTeamsRegular: return "\u{fbed}"
        case .webexTeamsRemoveBold: return "\u{fbee}"
        case .webexTeamsRemoveLight: return "\u{fbef}"
        case .webexTeamsRemoveRegular: return "\u{fbf0}"
        case .webinarBold: return "\u{fbf1}"
        case .webinarFilled: return "\u{fbf2}"
        case .webinarLight: return "\u{fbf3}"
        case .webinarRegular: return "\u{fbf4}"
        case .weeklyRecurringScheduleBold: return "\u{fbf5}"
        case .weeklyRecurringScheduleLight: return "\u{fbf6}"
        case .weeklyRecurringScheduleRegular: return "\u{fbf7}"
        case .whisperCoachBold: return "\u{fbf8}"
        case .whisperCoachFilled: return "\u{fbf9}"
        case .whisperCoachLight: return "\u{fbfa}"
        case .whisperCoachRegular: return "\u{fbfb}"
        case .whiteboardBold: return "\u{fbfc}"
        case .whiteboardContentBold: return "\u{fbfd}"
        case .whiteboardContentFilled: return "\u{fbfe}"
        case .whiteboardContentLight: return "\u{fbff}"
        case .whiteboardContentRegular: return "\u{fc00}"
        case .whiteboardFilled: return "\u{fc01}"
        case .whiteboardLight: return "\u{fc02}"
        case .whiteboardRegular: return "\u{fc03}"
        case .widgetBold: return "\u{fc04}"
        case .widgetFilled: return "\u{fc05}"
        case .widgetLight: return "\u{fc06}"
        case .widgetRegular: return "\u{fc07}"
        case .wifiBold: return "\u{fc08}"
        case .wifiErrorBold: return "\u{fc09}"
        case .wifiErrorLight: return "\u{fc0a}"
        case .wifiErrorRegular: return "\u{fc0b}"
        case .wifiLight: return "\u{fc0c}"
        case .wifiRegular: return "\u{fc0d}"
        case .wifiSignalGoodBold: return "\u{fc0e}"
        case .wifiSignalGoodLight: return "\u{fc0f}"
        case .wifiSignalGoodRegular: return "\u{fc10}"
        case .wifiSignalPoorBold: return "\u{fc11}"
        case .wifiSignalPoorLight: return "\u{fc12}"
        case .wifiSignalPoorRegular: return "\u{fc13}"
        case .wifiSignalUnstableBold: return "\u{fc14}"
        case .wifiSignalUnstableLight: return "\u{fc15}"
        case .wifiSignalUnstableRegular: return "\u{fc16}"
        case .windowCornerScrubBold: return "\u{fc17}"
        case .windowCornerScrubLight: return "\u{fc18}"
        case .windowCornerScrubRegular: return "\u{fc19}"
        case .windowRightCornerScrubBold: return "\u{fc1a}"
        case .windowRightCornerScrubLight: return "\u{fc1b}"
        case .windowRightCornerScrubRegular: return "\u{fc1c}"
        case .windowVerticalScrubBold: return "\u{fc1d}"
        case .windowVerticalScrubLight: return "\u{fc1e}"
        case .windowVerticalScrubRegular: return "\u{fc1f}"
        case .workflowDeploymentsBold: return "\u{fc20}"
        case .workflowDeploymentsFilled: return "\u{fc21}"
        case .workflowDeploymentsLight: return "\u{fc22}"
        case .workflowDeploymentsRegular: return "\u{fc23}"
        case .workphoneBold: return "\u{fc24}"
        case .workphoneLight: return "\u{fc25}"
        case .workphoneRegular: return "\u{fc26}"
        case .zoomInBold: return "\u{fc27}"
        case .zoomInLight: return "\u{fc28}"
        case .zoomInRegular: return "\u{fc29}"
        case .zoomOutBold: return "\u{fc2a}"
        case .zoomOutLight: return "\u{fc2b}"
        case .zoomOutRegular: return "\u{fc2c}"
