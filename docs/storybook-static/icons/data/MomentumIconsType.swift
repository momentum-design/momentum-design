...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .arrowTriangleDownFilled: return "\u{f1e1}"
        case .arrowTriangleLeftFilled: return "\u{f1e2}"
        case .arrowTriangleRightFilled: return "\u{f1e3}"
        case .arrowTriangleUpFilled: return "\u{f1e4}"
        case .arrowUpBold: return "\u{f1e5}"
        case .arrowUpFilled: return "\u{f1e6}"
        case .arrowUpLight: return "\u{f1e7}"
        case .arrowUpRegular: return "\u{f1e8}"
        case .askForHelpBold: return "\u{f1e9}"
        case .askForHelpFilled: return "\u{f1ea}"
        case .askForHelpLight: return "\u{f1eb}"
        case .askForHelpRegular: return "\u{f1ec}"
        case .assetsBold: return "\u{f1ed}"
        case .assetsFilled: return "\u{f1ee}"
        case .assetsLight: return "\u{f1ef}"
        case .assetsRegular: return "\u{f1f0}"
        case .assignHostBold: return "\u{f1f1}"
        case .assignHostLight: return "\u{f1f2}"
        case .assignHostRegular: return "\u{f1f3}"
        case .assignPrivilegeBold: return "\u{f1f4}"
        case .assignPrivilegeFilled: return "\u{f1f5}"
        case .assignPrivilegeLight: return "\u{f1f6}"
        case .assignPrivilegeRegular: return "\u{f1f7}"
        case .attachmentBold: return "\u{f1f8}"
        case .attachmentLight: return "\u{f1f9}"
        case .attachmentRegular: return "\u{f1fa}"
        case .attendantConsoleBold: return "\u{f1fb}"
        case .attendantConsoleFilled: return "\u{f1fc}"
        case .attendantConsoleLight: return "\u{f1fd}"
        case .attendantConsoleRegular: return "\u{f1fe}"
        case .audioBroadcastBold: return "\u{f1ff}"
        case .audioBroadcastLight: return "\u{f200}"
        case .audioBroadcastRegular: return "\u{f201}"
        case .audioCallBold: return "\u{f202}"
        case .audioCallFilled: return "\u{f203}"
        case .audioCallLight: return "\u{f204}"
        case .audioCallRegular: return "\u{f205}"
        case .audioEnhancementBold: return "\u{f206}"
        case .audioEnhancementFilled: return "\u{f207}"
        case .audioEnhancementLight: return "\u{f208}"
        case .audioEnhancementRegular: return "\u{f209}"
        case .audioOnlyBold: return "\u{f20a}"
        case .audioOnlyLight: return "\u{f20b}"
        case .audioOnlyRegular: return "\u{f20c}"
        case .audioOptAllBold: return "\u{f20d}"
        case .audioOptAllLight: return "\u{f20e}"
        case .audioOptAllRegular: return "\u{f20f}"
        case .autoAnswerBold: return "\u{f210}"
        case .autoAnswerFilled: return "\u{f211}"
        case .autoAnswerLight: return "\u{f212}"
        case .autoAnswerRegular: return "\u{f213}"
        case .autoDetectionBold: return "\u{f214}"
        case .autoDetectionLight: return "\u{f215}"
        case .autoDetectionRegular: return "\u{f216}"
        case .automationBold: return "\u{f217}"
        case .automationLight: return "\u{f218}"
        case .automationRegular: return "\u{f219}"
        case .awayCallingPresenceBold: return "\u{f21a}"
        case .awayCallingPresenceFilled: return "\u{f21b}"
        case .awayCallingPresenceLight: return "\u{f21c}"
        case .awayCallingPresenceRegular: return "\u{f21d}"
        case .backBold: return "\u{f21e}"
        case .backLight: return "\u{f21f}"
        case .backRegular: return "\u{f220}"
        case .backToFullScreenBold: return "\u{f221}"
        case .backToFullScreenLight: return "\u{f222}"
        case .backToFullScreenRegular: return "\u{f223}"
        case .backToTopBold: return "\u{f224}"
        case .backToTopLight: return "\u{f225}"
        case .backToTopRegular: return "\u{f226}"
        case .backlightBold: return "\u{f227}"
        case .backlightLight: return "\u{f228}"
        case .backlightRegular: return "\u{f229}"
        case .backspaceBold: return "\u{f22a}"
        case .backspaceLight: return "\u{f22b}"
        case .backspaceRegular: return "\u{f22c}"
        case .backupDataBold: return "\u{f22d}"
        case .backupDataLight: return "\u{f22e}"
        case .backupDataRegular: return "\u{f22f}"
        case .barcodeBold: return "\u{f230}"
        case .barcodeLight: return "\u{f231}"
        case .barcodeRegular: return "\u{f232}"
        case .batteryChargingBold: return "\u{f233}"
        case .batteryChargingLight: return "\u{f234}"
        case .batteryChargingRegular: return "\u{f235}"
        case .batteryEmptyBold: return "\u{f236}"
        case .batteryEmptyLight: return "\u{f237}"
        case .batteryEmptyRegular: return "\u{f238}"
        case .batteryHighBold: return "\u{f239}"
        case .batteryHighLight: return "\u{f23a}"
        case .batteryHighRegular: return "\u{f23b}"
        case .batteryLowBold: return "\u{f23c}"
        case .batteryLowLight: return "\u{f23d}"
        case .batteryLowRegular: return "\u{f23e}"
        case .batteryMediumBold: return "\u{f23f}"
        case .batteryMediumLight: return "\u{f240}"
        case .batteryMediumRegular: return "\u{f241}"
        case .bitmojiConnectBold: return "\u{f242}"
        case .bitmojiConnectLight: return "\u{f243}"
        case .bitmojiConnectRegular: return "\u{f244}"
        case .bitmojiConnectedBold: return "\u{f245}"
        case .bitmojiConnectedFilled: return "\u{f246}"
        case .bitmojiConnectedLight: return "\u{f247}"
        case .bitmojiConnectedRegular: return "\u{f248}"
        case .blindTransferBold: return "\u{f249}"
        case .blindTransferLight: return "\u{f24a}"
        case .blindTransferRegular: return "\u{f24b}"
        case .blockQuoteBold: return "\u{f24c}"
        case .blockQuoteLight: return "\u{f24d}"
        case .blockQuoteRegular: return "\u{f24e}"
        case .blockedBold: return "\u{f24f}"
        case .blockedFilled: return "\u{f250}"
        case .blockedLight: return "\u{f251}"
        case .blockedRegular: return "\u{f252}"
        case .bluetoothBold: return "\u{f253}"
        case .bluetoothFilled: return "\u{f254}"
        case .bluetoothLight: return "\u{f255}"
        case .bluetoothMutedBold: return "\u{f256}"
        case .bluetoothMutedLight: return "\u{f257}"
        case .bluetoothMutedRegular: return "\u{f258}"
        case .bluetoothRegular: return "\u{f259}"
        case .boldBold: return "\u{f25a}"
        case .boldFilled: return "\u{f25b}"
        case .boldLight: return "\u{f25c}"
        case .boldRegular: return "\u{f25d}"
        case .bookmarkBold: return "\u{f25e}"
        case .bookmarkLight: return "\u{f25f}"
        case .bookmarkRegular: return "\u{f260}"
        case .booleanBold: return "\u{f261}"
        case .booleanFilled: return "\u{f262}"
        case .booleanLight: return "\u{f263}"
        case .booleanRegular: return "\u{f264}"
        case .botBold: return "\u{f265}"
        case .botCustomerAssistantBold: return "\u{f266}"
        case .botCustomerAssistantFilled: return "\u{f267}"
        case .botCustomerAssistantLight: return "\u{f268}"
        case .botCustomerAssistantRegular: return "\u{f269}"
        case .botExpertAssistantBold: return "\u{f26a}"
        case .botExpertAssistantLight: return "\u{f26b}"
        case .botExpertAssistantRegular: return "\u{f26c}"
        case .botLight: return "\u{f26d}"
        case .botRegular: return "\u{f26e}"
        case .boxBold: return "\u{f26f}"
        case .boxLight: return "\u{f270}"
        case .boxRegular: return "\u{f271}"
        case .breakoutSessionBold: return "\u{f272}"
        case .breakoutSessionFilled: return "\u{f273}"
        case .breakoutSessionLight: return "\u{f274}"
        case .breakoutSessionRegular: return "\u{f275}"
        case .brightnessAutoBold: return "\u{f276}"
        case .brightnessAutoFilled: return "\u{f277}"
        case .brightnessAutoLight: return "\u{f278}"
        case .brightnessAutoRegular: return "\u{f279}"
        case .brightnessBold: return "\u{f27a}"
        case .brightnessFilled: return "\u{f27b}"
        case .brightnessHighBold: return "\u{f27c}"
        case .brightnessHighFilled: return "\u{f27d}"
        case .brightnessHighLight: return "\u{f27e}"
        case .brightnessHighRegular: return "\u{f27f}"
        case .brightnessLight: return "\u{f280}"
        case .brightnessLowBold: return "\u{f281}"
        case .brightnessLowFilled: return "\u{f282}"
        case .brightnessLowLight: return "\u{f283}"
        case .brightnessLowRegular: return "\u{f284}"
        case .brightnessRegular: return "\u{f285}"
        case .brokenFileBold: return "\u{f286}"
        case .brokenFileFilled: return "\u{f287}"
        case .brokenFileLight: return "\u{f288}"
        case .brokenFileRegular: return "\u{f289}"
        case .browserBold: return "\u{f28a}"
        case .browserLight: return "\u{f28b}"
        case .browserRegular: return "\u{f28c}"
        case .busyPresenceBold: return "\u{f28d}"
        case .busyPresenceLight: return "\u{f28e}"
        case .busyPresenceRegular: return "\u{f28f}"
        case .buttonCursorBold: return "\u{f290}"
        case .buttonCursorLight: return "\u{f291}"
        case .buttonCursorRegular: return "\u{f292}"
        case .calendarAddBold: return "\u{f293}"
        case .calendarAddFilled: return "\u{f294}"
        case .calendarAddLight: return "\u{f295}"
        case .calendarAddRegular: return "\u{f296}"
        case .calendarDayBold: return "\u{f297}"
        case .calendarDayFilled: return "\u{f298}"
        case .calendarDayLight: return "\u{f299}"
        case .calendarDayRegular: return "\u{f29a}"
        case .calendarEmptyBold: return "\u{f29b}"
        case .calendarEmptyFilled: return "\u{f29c}"
        case .calendarEmptyLight: return "\u{f29d}"
        case .calendarEmptyRegular: return "\u{f29e}"
        case .calendarExternalBold: return "\u{f29f}"
        case .calendarExternalLight: return "\u{f2a0}"
        case .calendarExternalRegular: return "\u{f2a1}"
        case .calendarFilterBold: return "\u{f2a2}"
        case .calendarFilterLight: return "\u{f2a3}"
        case .calendarFilterRegular: return "\u{f2a4}"
        case .calendarMonthBold: return "\u{f2a5}"
        case .calendarMonthFilled: return "\u{f2a6}"
        case .calendarMonthLight: return "\u{f2a7}"
        case .calendarMonthMoreBold: return "\u{f2a8}"
        case .calendarMonthMoreLight: return "\u{f2a9}"
        case .calendarMonthMoreRegular: return "\u{f2aa}"
        case .calendarMonthRegular: return "\u{f2ab}"
        case .calendarTodayBold: return "\u{f2ac}"
        case .calendarTodayLight: return "\u{f2ad}"
        case .calendarTodayRegular: return "\u{f2ae}"
        case .calendarWeekBold: return "\u{f2af}"
        case .calendarWeekFilled: return "\u{f2b0}"
        case .calendarWeekLight: return "\u{f2b1}"
        case .calendarWeekRegular: return "\u{f2b2}"
        case .calendarWeekViewBold: return "\u{f2b3}"
        case .calendarWeekViewFilled: return "\u{f2b4}"
        case .calendarWeekViewLight: return "\u{f2b5}"
        case .calendarWeekViewRegular: return "\u{f2b6}"
        case .calendarWorkWeekBold: return "\u{f2b7}"
        case .calendarWorkWeekFilled: return "\u{f2b8}"
        case .calendarWorkWeekLight: return "\u{f2b9}"
        case .calendarWorkWeekRegular: return "\u{f2ba}"
        case .callBargeBold: return "\u{f2bb}"
        case .callBargeFilled: return "\u{f2bc}"
        case .callBargeLight: return "\u{f2bd}"
        case .callBargeRegular: return "\u{f2be}"
        case .callBargeSilentBold: return "\u{f2bf}"
        case .callBargeSilentLight: return "\u{f2c0}"
        case .callBargeSilentRegular: return "\u{f2c1}"
        case .callForwardSettingsBold: return "\u{f2c2}"
        case .callForwardSettingsFilled: return "\u{f2c3}"
        case .callForwardSettingsLight: return "\u{f2c4}"
        case .callForwardSettingsRegular: return "\u{f2c5}"
        case .callGroupPickupBold: return "\u{f2c6}"
        case .callGroupPickupFilled: return "\u{f2c7}"
        case .callGroupPickupLight: return "\u{f2c8}"
        case .callGroupPickupRegular: return "\u{f2c9}"
        case .callHandlingBold: return "\u{f2ca}"
        case .callHandlingLight: return "\u{f2cb}"
        case .callHandlingRegular: return "\u{f2cc}"
        case .callHoldBold: return "\u{f2cd}"
        case .callHoldFilled: return "\u{f2ce}"
        case .callHoldLight: return "\u{f2cf}"
        case .callHoldRegular: return "\u{f2d0}"
        case .callIncomingBold: return "\u{f2d1}"
        case .callIncomingLight: return "\u{f2d2}"
        case .callIncomingRegular: return "\u{f2d3}"
        case .callListBold: return "\u{f2d4}"
        case .callListLight: return "\u{f2d5}"
        case .callListRegular: return "\u{f2d6}"
        case .callMergeBold: return "\u{f2d7}"
        case .callMergeFilled: return "\u{f2d8}"
        case .callMergeLight: return "\u{f2d9}"
        case .callMergeRegular: return "\u{f2da}"
        case .callMissedBold: return "\u{f2db}"
        case .callMissedFilled: return "\u{f2dc}"
        case .callMissedLight: return "\u{f2dd}"
        case .callMissedRegular: return "\u{f2de}"
        case .callMoreBold: return "\u{f2df}"
        case .callMoreLight: return "\u{f2e0}"
        case .callMoreRegular: return "\u{f2e1}"
        case .callOutgoingBold: return "\u{f2e2}"
        case .callOutgoingLight: return "\u{f2e3}"
        case .callOutgoingRegular: return "\u{f2e4}"
        case .callPickupBold: return "\u{f2e5}"
        case .callPickupFilled: return "\u{f2e6}"
        case .callPickupLight: return "\u{f2e7}"
        case .callPickupOtherBold: return "\u{f2e8}"
        case .callPickupOtherFilled: return "\u{f2e9}"
        case .callPickupOtherLight: return "\u{f2ea}"
        case .callPickupOtherRegular: return "\u{f2eb}"
        case .callPickupRegular: return "\u{f2ec}"
        case .callPrivateBold: return "\u{f2ed}"
        case .callPrivateFilled: return "\u{f2ee}"
        case .callPrivateLight: return "\u{f2ef}"
        case .callPrivateRegular: return "\u{f2f0}"
        case .callRemoteBold: return "\u{f2f1}"
        case .callRemoteFilled: return "\u{f2f2}"
        case .callRemoteLight: return "\u{f2f3}"
        case .callRemoteRegular: return "\u{f2f4}"
        case .callRequestBold: return "\u{f2f5}"
        case .callRequestFilled: return "\u{f2f6}"
        case .callRequestLight: return "\u{f2f7}"
        case .callRequestRegular: return "\u{f2f8}"
        case .callReturnBold: return "\u{f2f9}"
        case .callReturnFilled: return "\u{f2fa}"
        case .callReturnLight: return "\u{f2fb}"
        case .callReturnRegular: return "\u{f2fc}"
        case .callRoomBold: return "\u{f2fd}"
        case .callRoomLight: return "\u{f2fe}"
        case .callRoomRegular: return "\u{f2ff}"
        case .callSettingsBold: return "\u{f300}"
        case .callSettingsLight: return "\u{f301}"
        case .callSettingsRegular: return "\u{f302}"
        case .callSplitBold: return "\u{f303}"
        case .callSplitLight: return "\u{f304}"
        case .callSplitRegular: return "\u{f305}"
        case .callSwapBold: return "\u{f306}"
        case .callSwapLight: return "\u{f307}"
        case .callSwapRegular: return "\u{f308}"
        case .callVoicemailBold: return "\u{f309}"
        case .callVoicemailLight: return "\u{f30a}"
        case .callVoicemailRegular: return "\u{f30b}"
        case .callrateBold: return "\u{f30c}"
        case .callrateLight: return "\u{f30d}"
        case .callrateRegular: return "\u{f30e}"
        case .cameraAuxBold: return "\u{f30f}"
        case .cameraAuxFilled: return "\u{f310}"
        case .cameraAuxLight: return "\u{f311}"
        case .cameraAuxRegular: return "\u{f312}"
        case .cameraBold: return "\u{f313}"
        case .cameraFilled: return "\u{f314}"
        case .cameraLight: return "\u{f315}"
        case .cameraMutedBold: return "\u{f316}"
        case .cameraMutedCircleFilled: return "\u{f317}"
        case .cameraMutedFilled: return "\u{f318}"
        case .cameraMutedLight: return "\u{f319}"
        case .cameraMutedRegular: return "\u{f31a}"
        case .cameraOnBold: return "\u{f31b}"
        case .cameraOnFilled: return "\u{f31c}"
        case .cameraOnLight: return "\u{f31d}"
        case .cameraOnRegular: return "\u{f31e}"
        case .cameraPhotoBold: return "\u{f31f}"
        case .cameraPhotoFilled: return "\u{f320}"
        case .cameraPhotoLight: return "\u{f321}"
        case .cameraPhotoRegular: return "\u{f322}"
        case .cameraPresenceBold: return "\u{f323}"
        case .cameraPresenceFilled: return "\u{f324}"
        case .cameraPresenceLight: return "\u{f325}"
        case .cameraPresenceRegular: return "\u{f326}"
        case .cameraRegular: return "\u{f327}"
        case .cameraSwapBold: return "\u{f328}"
        case .cameraSwapLight: return "\u{f329}"
        case .cameraSwapRegular: return "\u{f32a}"
        case .campaignManagementBold: return "\u{f32b}"
        case .campaignManagementLight: return "\u{f32c}"
        case .campaignManagementRegular: return "\u{f32d}"
        case .cancelBold: return "\u{f32e}"
        case .cancelFilled: return "\u{f32f}"
        case .cancelLight: return "\u{f330}"
        case .cancelRegular: return "\u{f331}"
        case .capsLockBold: return "\u{f332}"
        case .capsLockLight: return "\u{f333}"
        case .capsLockRegular: return "\u{f334}"
        case .captureRewindBold: return "\u{f335}"
        case .captureRewindLight: return "\u{f336}"
        case .captureRewindRegular: return "\u{f337}"
        case .caroselBold: return "\u{f338}"
        case .caroselLight: return "\u{f339}"
        case .caroselRegular: return "\u{f33a}"
        case .carouselTextBold: return "\u{f33b}"
        case .carouselTextLight: return "\u{f33c}"
        case .carouselTextRegular: return "\u{f33d}"
        case .cellularBold: return "\u{f33e}"
        case .cellularLight: return "\u{f33f}"
        case .cellularRegular: return "\u{f340}"
        case .centerAlignedBold: return "\u{f341}"
        case .centerAlignedLight: return "\u{f342}"
        case .centerAlignedRegular: return "\u{f343}"
        case .centerBold: return "\u{f344}"
        case .centerLight: return "\u{f345}"
        case .centerRegular: return "\u{f346}"
        case .certificateBold: return "\u{f347}"
        case .certificateFilled: return "\u{f348}"
        case .certificateInvalidBold: return "\u{f349}"
        case .certificateInvalidLight: return "\u{f34a}"
        case .certificateInvalidRegular: return "\u{f34b}"
        case .certificateLight: return "\u{f34c}"
        case .certificateRegular: return "\u{f34d}"
        case .certifiedBold: return "\u{f34e}"
        case .certifiedFilled: return "\u{f34f}"
        case .certifiedLight: return "\u{f350}"
        case .certifiedRegular: return "\u{f351}"
        case .chPSearchBold: return "\u{f352}"
        case .chPSearchLight: return "\u{f353}"
        case .chPSearchRegular: return "\u{f354}"
        case .channelUssdBold: return "\u{f355}"
        case .channelUssdFilled: return "\u{f356}"
        case .channelUssdLight: return "\u{f357}"
        case .channelUssdRegular: return "\u{f358}"
        case .chatBold: return "\u{f359}"
        case .chatFilled: return "\u{f35a}"
        case .chatGroupBold: return "\u{f35b}"
        case .chatGroupFilled: return "\u{f35c}"
        case .chatGroupLight: return "\u{f35d}"
        case .chatGroupRegular: return "\u{f35e}"
        case .chatLight: return "\u{f35f}"
        case .chatMuteBold: return "\u{f360}"
        case .chatMuteLight: return "\u{f361}"
        case .chatMuteRegular: return "\u{f362}"
        case .chatOutboundFilled: return "\u{f363}"
        case .chatRegular: return "\u{f364}"
        case .checkBold: return "\u{f365}"
        case .checkCircleBadgeFilled: return "\u{f366}"
        case .checkCircleBold: return "\u{f367}"
        case .checkCircleFilled: return "\u{f368}"
        case .checkCircleLight: return "\u{f369}"
        case .checkCircleRegular: return "\u{f36a}"
        case .checkFilled: return "\u{f36b}"
        case .checkLight: return "\u{f36c}"
        case .checkRegular: return "\u{f36d}"
        case .checkboxGroupBold: return "\u{f36e}"
        case .checkboxGroupFilled: return "\u{f36f}"
        case .checkboxGroupLight: return "\u{f370}"
        case .checkboxGroupRegular: return "\u{f371}"
        case .cleanUpBold: return "\u{f372}"
        case .cleanUpLight: return "\u{f373}"
        case .cleanUpRegular: return "\u{f374}"
        case .clearBadgeFilled: return "\u{f375}"
        case .clearBold: return "\u{f376}"
        case .clearFilled: return "\u{f377}"
        case .clearLight: return "\u{f378}"
        case .clearRegular: return "\u{f379}"
        case .closeSpaceBold: return "\u{f37a}"
        case .closeSpaceLight: return "\u{f37b}"
        case .closeSpaceRegular: return "\u{f37c}"
        case .closedCaptionBadgeBold: return "\u{f37d}"
        case .closedCaptionBadgeFilled: return "\u{f37e}"
        case .closedCaptionBadgeLight: return "\u{f37f}"
        case .closedCaptionBadgeRegular: return "\u{f380}"
        case .closedCaptionsBold: return "\u{f381}"
        case .closedCaptionsFilled: return "\u{f382}"
        case .closedCaptionsLight: return "\u{f383}"
        case .closedCaptionsRegular: return "\u{f384}"
        case .cloudBold: return "\u{f385}"
        case .cloudDownloadBold: return "\u{f386}"
        case .cloudDownloadLight: return "\u{f387}"
        case .cloudDownloadRegular: return "\u{f388}"
        case .cloudFilled: return "\u{f389}"
        case .cloudFrameBold: return "\u{f38a}"
        case .cloudFrameFilled: return "\u{f38b}"
        case .cloudFrameLight: return "\u{f38c}"
        case .cloudFrameRegular: return "\u{f38d}"
        case .cloudLight: return "\u{f38e}"
        case .cloudMutedBold: return "\u{f38f}"
        case .cloudMutedFilled: return "\u{f390}"
        case .cloudMutedLight: return "\u{f391}"
        case .cloudMutedRegular: return "\u{f392}"
        case .cloudRegular: return "\u{f393}"
        case .cloudUploadBold: return "\u{f394}"
        case .cloudUploadLight: return "\u{f395}"
        case .cloudUploadRegular: return "\u{f396}"
        case .codeBlockBold: return "\u{f397}"
        case .codeBlockLight: return "\u{f398}"
        case .codeBlockRegular: return "\u{f399}"
        case .coffeeBold: return "\u{f39a}"
        case .coffeeLight: return "\u{f39b}"
        case .coffeeRegular: return "\u{f39c}"
        case .colorAccessoriesBold: return "\u{f39d}"
        case .colorAccessoriesFilled: return "\u{f39e}"
        case .colorAccessoriesLight: return "\u{f39f}"
        case .colorAccessoriesRegular: return "\u{f3a0}"
        case .colorBold: return "\u{f3a1}"
        case .colorFilled: return "\u{f3a2}"
        case .colorLight: return "\u{f3a3}"
        case .colorMeetingSummaryBold: return "\u{f3a4}"
        case .colorMeetingSummaryFilled: return "\u{f3a5}"
        case .colorMeetingSummaryLight: return "\u{f3a6}"
        case .colorMeetingSummaryRegular: return "\u{f3a7}"
        case .colorPromptsAiBold: return "\u{f3a8}"
        case .colorPromptsAiLight: return "\u{f3a9}"
        case .colorPromptsAiRegular: return "\u{f3aa}"
        case .colorRegular: return "\u{f3ab}"
        case .colorScheduleAiBold: return "\u{f3ac}"
        case .colorScheduleAiLight: return "\u{f3ad}"
        case .colorScheduleAiRegular: return "\u{f3ae}"
        case .colorSearchAiBold: return "\u{f3af}"
        case .colorSearchAiLight: return "\u{f3b0}"
        case .colorSearchAiRegular: return "\u{f3b1}"
        case .colorSendBold: return "\u{f3b2}"
        case .colorSendFilled: return "\u{f3b3}"
        case .colorSendLight: return "\u{f3b4}"
        case .colorSendRegular: return "\u{f3b5}"
        case .colorSparkleBold: return "\u{f3b6}"
        case .colorSparkleFilled: return "\u{f3b7}"
        case .colorSparkleLight: return "\u{f3b8}"
        case .colorSparkleRegular: return "\u{f3b9}"
        case .colorSummarizeAiBold: return "\u{f3ba}"
        case .colorSummarizeAiLight: return "\u{f3bb}"
        case .colorSummarizeAiRegular: return "\u{f3bc}"
        case .colourPaletteBold: return "\u{f3bd}"
        case .colourPaletteFilled: return "\u{f3be}"
        case .colourPaletteLight: return "\u{f3bf}"
        case .colourPaletteRegular: return "\u{f3c0}"
        case .commentingBold: return "\u{f3c1}"
        case .commentingFilled: return "\u{f3c2}"
        case .commentingLight: return "\u{f3c3}"
        case .commentingRegular: return "\u{f3c4}"
        case .companyBold: return "\u{f3c5}"
        case .companyLight: return "\u{f3c6}"
        case .companyRegular: return "\u{f3c7}"
        case .completedByBaseBold: return "\u{f3c8}"
        case .completedByBaseLight: return "\u{f3c9}"
        case .completedByBaseRegular: return "\u{f3ca}"
        case .completedByTimeBold: return "\u{f3cb}"
        case .completedByTimeLight: return "\u{f3cc}"
        case .completedByTimeRegular: return "\u{f3cd}"
        case .completedInteractionBold: return "\u{f3ce}"
        case .completedInteractionFilled: return "\u{f3cf}"
        case .completedInteractionLight: return "\u{f3d0}"
        case .completedInteractionRegular: return "\u{f3d1}"
        case .computerBold: return "\u{f3d2}"
        case .computerLight: return "\u{f3d3}"
        case .computerRegular: return "\u{f3d4}"
        case .conciergeBold: return "\u{f3d5}"
        case .conciergeLight: return "\u{f3d6}"
        case .conciergeRegular: return "\u{f3d7}"
        case .conditionalBlockBold: return "\u{f3d8}"
        case .conditionalBlockLight: return "\u{f3d9}"
        case .conditionalBlockRegular: return "\u{f3da}"
        case .connectBold: return "\u{f3db}"
        case .connectLight: return "\u{f3dc}"
        case .connectRegular: return "\u{f3dd}"
        case .contactCardBold: return "\u{f3de}"
        case .contactCardFilled: return "\u{f3df}"
        case .contactCardLight: return "\u{f3e0}"
        case .contactCardRegular: return "\u{f3e1}"
        case .contactsBold: return "\u{f3e2}"
        case .contactsFilled: return "\u{f3e3}"
        case .contactsLight: return "\u{f3e4}"
        case .contactsRegular: return "\u{f3e5}"
        case .contentDownloadBold: return "\u{f3e6}"
        case .contentDownloadFilled: return "\u{f3e7}"
        case .contentDownloadLight: return "\u{f3e8}"
        case .contentDownloadRegular: return "\u{f3e9}"
        case .contentShareBold: return "\u{f3ea}"
        case .contentShareLight: return "\u{f3eb}"
        case .contentShareRegular: return "\u{f3ec}"
        case .contrastBold: return "\u{f3ed}"
        case .contrastLight: return "\u{f3ee}"
        case .contrastRegular: return "\u{f3ef}"
        case .copyBold: return "\u{f3f0}"
        case .copyLight: return "\u{f3f1}"
        case .copyRegular: return "\u{f3f2}"
        case .cpuBold: return "\u{f3f3}"
        case .cpuLight: return "\u{f3f4}"
        case .cpuRegular: return "\u{f3f5}"
        case .createAGroupBold: return "\u{f3f6}"
        case .createAGroupFilled: return "\u{f3f7}"
        case .createAGroupLight: return "\u{f3f8}"
        case .createAGroupRegular: return "\u{f3f9}"
        case .cropBold: return "\u{f3fa}"
        case .cropLight: return "\u{f3fb}"
        case .cropRegular: return "\u{f3fc}"
        case .cucmConnectionBold: return "\u{f3fd}"
        case .cucmConnectionLight: return "\u{f3fe}"
        case .cucmConnectionRegular: return "\u{f3ff}"
        case .customCodeEditorBold: return "\u{f400}"
        case .customCodeEditorLight: return "\u{f401}"
        case .customCodeEditorRegular: return "\u{f402}"
        case .customTaskBold: return "\u{f403}"
        case .customTaskFilled: return "\u{f404}"
        case .customTaskIndBold: return "\u{f405}"
        case .customTaskIndFilled: return "\u{f406}"
        case .customTaskIndLight: return "\u{f407}"
        case .customTaskIndRegular: return "\u{f408}"
        case .customTaskLight: return "\u{f409}"
        case .customTaskRegular: return "\u{f40a}"
        case .dailyRecurringScheduleBold: return "\u{f40b}"
        case .dailyRecurringScheduleLight: return "\u{f40c}"
        case .dailyRecurringScheduleRegular: return "\u{f40d}"
        case .dashboardBold: return "\u{f40e}"
        case .dashboardFilled: return "\u{f40f}"
        case .dashboardLight: return "\u{f410}"
        case .dashboardRegular: return "\u{f411}"
        case .dataManagementBold: return "\u{f412}"
        case .dataManagementFilled: return "\u{f413}"
        case .dataManagementLight: return "\u{f414}"
        case .dataManagementRegular: return "\u{f415}"
        case .dataRangeSelectionBold: return "\u{f416}"
        case .dataRangeSelectionFilled: return "\u{f417}"
        case .dataRangeSelectionLight: return "\u{f418}"
        case .dataRangeSelectionRegular: return "\u{f419}"
        case .declineBold: return "\u{f41a}"
        case .declineFilled: return "\u{f41b}"
        case .declineLight: return "\u{f41c}"
        case .declineRegular: return "\u{f41d}"
        case .dectHandsetBold: return "\u{f41e}"
        case .dectHandsetFilled: return "\u{f41f}"
        case .dectHandsetLight: return "\u{f420}"
        case .dectHandsetRegular: return "\u{f421}"
        case .deleteBold: return "\u{f422}"
        case .deleteFilled: return "\u{f423}"
        case .deleteLight: return "\u{f424}"
        case .deleteRegular: return "\u{f425}"
        case .deploymentEvaluationProgressBold: return "\u{f426}"
        case .deploymentEvaluationProgressLight: return "\u{f427}"
        case .deploymentEvaluationProgressRegular: return "\u{f428}"
        case .deploymentProgressBold: return "\u{f429}"
        case .deploymentProgressLight: return "\u{f42a}"
        case .deploymentProgressRegular: return "\u{f42b}"
        case .deploymentRecurringBold: return "\u{f42c}"
        case .deploymentRecurringLight: return "\u{f42d}"
        case .deploymentRecurringRegular: return "\u{f42e}"
        case .deploymentWinnerPendingBold: return "\u{f42f}"
        case .deploymentWinnerPendingLight: return "\u{f430}"
        case .deploymentWinnerPendingRegular: return "\u{f431}"
        case .deskPhoneBold: return "\u{f432}"
        case .deskPhoneFilled: return "\u{f433}"
        case .deskPhoneLight: return "\u{f434}"
        case .deskPhoneRegular: return "\u{f435}"
        case .deskPhoneWarningBold: return "\u{f436}"
        case .deskPhoneWarningLight: return "\u{f437}"
        case .deskPhoneWarningRegular: return "\u{f438}"
        case .deviceConnectionBold: return "\u{f439}"
        case .deviceConnectionFilled: return "\u{f43a}"
        case .deviceConnectionLight: return "\u{f43b}"
        case .deviceConnectionRegular: return "\u{f43c}"
        case .deviceInRoomBold: return "\u{f43d}"
        case .deviceInRoomEndBold: return "\u{f43e}"
        case .deviceInRoomEndLight: return "\u{f43f}"
        case .deviceInRoomEndRegular: return "\u{f440}"
        case .deviceInRoomFilled: return "\u{f441}"
        case .deviceInRoomLight: return "\u{f442}"
        case .deviceInRoomRegular: return "\u{f443}"
        case .deviceMutedBold: return "\u{f444}"
        case .deviceMutedLight: return "\u{f445}"
        case .deviceMutedRegular: return "\u{f446}"
        case .devicePolicyControllerBold: return "\u{f447}"
        case .devicePolicyControllerLight: return "\u{f448}"
        case .devicePolicyControllerRegular: return "\u{f449}"
        case .devicesBold: return "\u{f44a}"
        case .devicesFilled: return "\u{f44b}"
        case .devicesLight: return "\u{f44c}"
        case .devicesRegular: return "\u{f44d}"
        case .diagnosticsBold: return "\u{f44e}"
        case .diagnosticsFilled: return "\u{f44f}"
        case .diagnosticsLight: return "\u{f450}"
        case .diagnosticsRegular: return "\u{f451}"
        case .dialpadBold: return "\u{f452}"
        case .dialpadFilled: return "\u{f453}"
        case .dialpadLight: return "\u{f454}"
        case .dialpadRegular: return "\u{f455}"
        case .diamondBold: return "\u{f456}"
        case .diamondFilled: return "\u{f457}"
        case .diamondLight: return "\u{f458}"
        case .diamondRegular: return "\u{f459}"
        case .directionalPadBold: return "\u{f45a}"
        case .directionalPadFilled: return "\u{f45b}"
        case .directionalPadLight: return "\u{f45c}"
        case .directionalPadRegular: return "\u{f45d}"
        case .directoryBold: return "\u{f45e}"
        case .directoryLight: return "\u{f45f}"
        case .directoryRegular: return "\u{f460}"
        case .disappearingPenBold: return "\u{f461}"
        case .disappearingPenLight: return "\u{f462}"
        case .disappearingPenRegular: return "\u{f463}"
        case .discBold: return "\u{f464}"
        case .discConnectedBold: return "\u{f465}"
        case .discConnectedLight: return "\u{f466}"
        case .discConnectedRegular: return "\u{f467}"
        case .discLight: return "\u{f468}"
        case .discRegular: return "\u{f469}"
        case .disconnectBold: return "\u{f46a}"
        case .disconnectFilled: return "\u{f46b}"
        case .disconnectLight: return "\u{f46c}"
        case .disconnectRegular: return "\u{f46d}"
        case .dislikeBold: return "\u{f46e}"
        case .dislikeFilled: return "\u{f46f}"
        case .dislikeLight: return "\u{f470}"
        case .dislikeRegular: return "\u{f471}"
        case .displayBold: return "\u{f472}"
        case .displayInputBold: return "\u{f473}"
        case .displayInputLight: return "\u{f474}"
        case .displayInputRegular: return "\u{f475}"
        case .displayLight: return "\u{f476}"
        case .displayRegular: return "\u{f477}"
        case .displayWarningBold: return "\u{f478}"
        case .displayWarningLight: return "\u{f479}"
        case .displayWarningRegular: return "\u{f47a}"
        case .distributeHorizontalBold: return "\u{f47b}"
        case .distributeHorizontalFilled: return "\u{f47c}"
        case .distributeHorizontalLight: return "\u{f47d}"
        case .distributeHorizontalRegular: return "\u{f47e}"
        case .distributeVerticallyBold: return "\u{f47f}"
        case .distributeVerticallyFilled: return "\u{f480}"
        case .distributeVerticallyLight: return "\u{f481}"
        case .distributeVerticallyRegular: return "\u{f482}"
        case .divideBold: return "\u{f483}"
        case .divideFilled: return "\u{f484}"
        case .divideLight: return "\u{f485}"
        case .divideRegular: return "\u{f486}"
        case .dndPresenceBadgeFilled: return "\u{f487}"
        case .dndPresenceBold: return "\u{f488}"
        case .dndPresenceFilled: return "\u{f489}"
        case .dndPresenceLight: return "\u{f48a}"
        case .dndPresenceRegular: return "\u{f48b}"
        case .dockWindowBold: return "\u{f48c}"
        case .dockWindowLight: return "\u{f48d}"
        case .dockWindowRegular: return "\u{f48e}"
        case .documentBold: return "\u{f48f}"
        case .documentCameraBold: return "\u{f490}"
        case .documentCameraDisconnectedBold: return "\u{f491}"
        case .documentCameraDisconnectedLight: return "\u{f492}"
        case .documentCameraDisconnectedRegular: return "\u{f493}"
        case .documentCameraLight: return "\u{f494}"
        case .documentCameraRegular: return "\u{f495}"
        case .documentCreateBold: return "\u{f496}"
        case .documentCreateFilled: return "\u{f497}"
        case .documentCreateLight: return "\u{f498}"
        case .documentCreateRegular: return "\u{f499}"
        case .documentFilled: return "\u{f49a}"
        case .documentLight: return "\u{f49b}"
        case .documentMoveBold: return "\u{f49c}"
        case .documentMoveFilled: return "\u{f49d}"
        case .documentMoveLight: return "\u{f49e}"
        case .documentMoveRegular: return "\u{f49f}"
        case .documentRegular: return "\u{f4a0}"
        case .documentShareBold: return "\u{f4a1}"
        case .documentShareFilled: return "\u{f4a2}"
        case .documentShareLight: return "\u{f4a3}"
        case .documentShareRegular: return "\u{f4a4}"
        case .doneAllBold: return "\u{f4a5}"
        case .doneAllLight: return "\u{f4a6}"
        case .doneAllRegular: return "\u{f4a7}"
        case .donutChartBold: return "\u{f4a8}"
        case .donutChartFilled: return "\u{f4a9}"
        case .donutChartLight: return "\u{f4aa}"
        case .donutChartRegular: return "\u{f4ab}"
        case .downloadBold: return "\u{f4ac}"
        case .downloadFilled: return "\u{f4ad}"
        case .downloadLight: return "\u{f4ae}"
        case .downloadRegular: return "\u{f4af}"
        case .draftBold: return "\u{f4b0}"
        case .draftFilled: return "\u{f4b1}"
        case .draftIndicatorBold: return "\u{f4b2}"
        case .draftIndicatorSmallFilled: return "\u{f4b3}"
        case .draftLight: return "\u{f4b4}"
        case .draftRegular: return "\u{f4b5}"
        case .dragBold: return "\u{f4b6}"
        case .dragLight: return "\u{f4b7}"
        case .dragRegular: return "\u{f4b8}"
        case .draggerHorizontalBold: return "\u{f4b9}"
        case .draggerHorizontalLight: return "\u{f4ba}"
        case .draggerHorizontalRegular: return "\u{f4bb}"
        case .draggerVerticalBold: return "\u{f4bc}"
        case .draggerVerticalLight: return "\u{f4bd}"
        case .draggerVerticalRegular: return "\u{f4be}"
        case .driveModeBold: return "\u{f4bf}"
        case .driveModeLight: return "\u{f4c0}"
        case .driveModeRegular: return "\u{f4c1}"
        case .dropdownBold: return "\u{f4c2}"
        case .dropdownLight: return "\u{f4c3}"
        case .dropdownRegular: return "\u{f4c4}"
        case .dxEightyBold: return "\u{f4c5}"
        case .dxEightyFilled: return "\u{f4c6}"
        case .dxEightyLight: return "\u{f4c7}"
        case .dxEightyRegular: return "\u{f4c8}"
        case .dxSeventyBold: return "\u{f4c9}"
        case .dxSeventyLight: return "\u{f4ca}"
        case .dxSeventyRegular: return "\u{f4cb}"
        case .editBold: return "\u{f4cc}"
        case .editFilled: return "\u{f4cd}"
        case .editLight: return "\u{f4ce}"
        case .editRegular: return "\u{f4cf}"
        case .editablePartialBold: return "\u{f4d0}"
        case .editablePartialLight: return "\u{f4d1}"
        case .editablePartialRegular: return "\u{f4d2}"
        case .educationBold: return "\u{f4d3}"
        case .educationFilled: return "\u{f4d4}"
        case .educationLight: return "\u{f4d5}"
        case .educationRegular: return "\u{f4d6}"
        case .emailBold: return "\u{f4d7}"
        case .emailDeliveredBold: return "\u{f4d8}"
        case .emailDeliveredLight: return "\u{f4d9}"
        case .emailDeliveredRegular: return "\u{f4da}"
        case .emailFailureBold: return "\u{f4db}"
        case .emailFailureLight: return "\u{f4dc}"
        case .emailFailureRegular: return "\u{f4dd}"
        case .emailFilled: return "\u{f4de}"
        case .emailInviteBold: return "\u{f4df}"
        case .emailInviteLight: return "\u{f4e0}"
        case .emailInviteRegular: return "\u{f4e1}"
        case .emailLight: return "\u{f4e2}"
        case .emailOutgoingBold: return "\u{f4e3}"
        case .emailOutgoingFilled: return "\u{f4e4}"
        case .emailOutgoingLight: return "\u{f4e5}"
        case .emailOutgoingRegular: return "\u{f4e6}"
        case .emailReadBold: return "\u{f4e7}"
        case .emailReadFilled: return "\u{f4e8}"
        case .emailReadLight: return "\u{f4e9}"
        case .emailReadRegular: return "\u{f4ea}"
        case .emailRegular: return "\u{f4eb}"
        case .emergencyCallbackNumberBold: return "\u{f4ec}"
        case .emergencyCallbackNumberFilled: return "\u{f4ed}"
        case .emergencyCallbackNumberLight: return "\u{f4ee}"
        case .emergencyCallbackNumberRegular: return "\u{f4ef}"
        case .emojiExcitedBold: return "\u{f4f0}"
        case .emojiExcitedFilled: return "\u{f4f1}"
        case .emojiExcitedLight: return "\u{f4f2}"
        case .emojiExcitedRegular: return "\u{f4f3}"
        case .emojiHappyBold: return "\u{f4f4}"
        case .emojiHappyFilled: return "\u{f4f5}"
        case .emojiHappyLight: return "\u{f4f6}"
        case .emojiHappyRegular: return "\u{f4f7}"
        case .emojiPassiveBold: return "\u{f4f8}"
        case .emojiPassiveFilled: return "\u{f4f9}"
        case .emojiPassiveLight: return "\u{f4fa}"
        case .emojiPassiveRegular: return "\u{f4fb}"
        case .emojiSadBold: return "\u{f4fc}"
        case .emojiSadFilled: return "\u{f4fd}"
        case .emojiSadLight: return "\u{f4fe}"
        case .emojiSadRegular: return "\u{f4ff}"
        case .emojiUnhappyBold: return "\u{f500}"
        case .emojiUnhappyFilled: return "\u{f501}"
        case .emojiUnhappyLight: return "\u{f502}"
        case .emojiUnhappyRegular: return "\u{f503}"
        case .encryptionCircleFilled: return "\u{f504}"
        case .encryptionFilled: return "\u{f505}"
        case .endRemoteDesktopControlBold: return "\u{f506}"
        case .endRemoteDesktopControlLight: return "\u{f507}"
        case .endRemoteDesktopControlRegular: return "\u{f508}"
        case .endToEndEncryptionCircleFilled: return "\u{f509}"
        case .endToEndEncryptionFilled: return "\u{f50a}"
        case .endpointBlockedBold: return "\u{f50b}"
        case .endpointBlockedLight: return "\u{f50c}"
        case .endpointBlockedRegular: return "\u{f50d}"
        case .endpointBold: return "\u{f50e}"
        case .endpointGTwoBold: return "\u{f50f}"
        case .endpointGTwoLight: return "\u{f510}"
        case .endpointGTwoRegular: return "\u{f511}"
        case .endpointGTwoSeventyBold: return "\u{f512}"
        case .endpointGTwoSeventyDualBold: return "\u{f513}"
        case .endpointGTwoSeventyDualLight: return "\u{f514}"
        case .endpointGTwoSeventyDualRegular: return "\u{f515}"
        case .endpointGTwoSeventyLight: return "\u{f516}"
        case .endpointGTwoSeventyRegular: return "\u{f517}"
        case .endpointGTwoStandBold: return "\u{f518}"
        case .endpointGTwoStandLight: return "\u{f519}"
        case .endpointGTwoStandRegular: return "\u{f51a}"
        case .endpointLight: return "\u{f51b}"
        case .endpointMxEightHundredBold: return "\u{f51c}"
        case .endpointMxEightHundredDualBold: return "\u{f51d}"
        case .endpointMxEightHundredDualLight: return "\u{f51e}"
        case .endpointMxEightHundredDualRegular: return "\u{f51f}"
        case .endpointMxEightHundredLight: return "\u{f520}"
        case .endpointMxEightHundredRegular: return "\u{f521}"
        case .endpointRegular: return "\u{f522}"
        case .endpointStandBold: return "\u{f523}"
        case .endpointStandFilled: return "\u{f524}"
        case .endpointStandLight: return "\u{f525}"
        case .endpointStandRegular: return "\u{f526}"
        case .endpointWarningBold: return "\u{f527}"
        case .endpointWarningLight: return "\u{f528}"
        case .endpointWarningRegular: return "\u{f529}"
        case .enterBold: return "\u{f52a}"
        case .enterLight: return "\u{f52b}"
        case .enterRegular: return "\u{f52c}"
        case .enterRoomBold: return "\u{f52d}"
        case .enterRoomFilled: return "\u{f52e}"
        case .enterRoomLight: return "\u{f52f}"
        case .enterRoomRegular: return "\u{f530}"
        case .eraserBold: return "\u{f531}"
        case .eraserFilled: return "\u{f532}"
        case .eraserLight: return "\u{f533}"
        case .eraserRegular: return "\u{f534}"
        case .errorLegacyBadgeFilled: return "\u{f535}"
        case .errorLegacyBold: return "\u{f536}"
        case .errorLegacyFilled: return "\u{f537}"
        case .errorLegacyLight: return "\u{f538}"
        case .errorLegacyRegular: return "\u{f539}"
        case .ethernetBold: return "\u{f53a}"
        case .ethernetFilled: return "\u{f53b}"
        case .ethernetLight: return "\u{f53c}"
        case .ethernetRegular: return "\u{f53d}"
        case .exchangeBold: return "\u{f53e}"
        case .exchangeLight: return "\u{f53f}"
        case .exchangeRegular: return "\u{f540}"
        case .exclamationBold: return "\u{f541}"
        case .exclamationLight: return "\u{f542}"
        case .exclamationRegular: return "\u{f543}"
        case .excludeBold: return "\u{f544}"
        case .excludeLight: return "\u{f545}"
        case .excludeRegular: return "\u{f546}"
        case .existingTargetGroupBold: return "\u{f547}"
        case .existingTargetGroupLight: return "\u{f548}"
        case .existingTargetGroupRegular: return "\u{f549}"
        case .exitRoomBold: return "\u{f54a}"
        case .exitRoomLight: return "\u{f54b}"
        case .exitRoomRegular: return "\u{f54c}"
        case .exploreBold: return "\u{f54d}"
        case .exploreLight: return "\u{f54e}"
        case .exploreRegular: return "\u{f54f}"
        case .exportBold: return "\u{f550}"
        case .exportLight: return "\u{f551}"
        case .exportRegular: return "\u{f552}"
        case .extensionMobilityBold: return "\u{f553}"
        case .extensionMobilityLight: return "\u{f554}"
        case .extensionMobilityRegular: return "\u{f555}"
        case .externalMessageBold: return "\u{f556}"
        case .externalMessageLight: return "\u{f557}"
        case .externalMessageRegular: return "\u{f558}"
        case .externalUserBold: return "\u{f559}"
        case .externalUserLight: return "\u{f55a}"
        case .externalUserRegular: return "\u{f55b}"
        case .familyFontBold: return "\u{f55c}"
        case .familyFontLight: return "\u{f55d}"
        case .familyFontRegular: return "\u{f55e}"
        case .fastForwardBold: return "\u{f55f}"
        case .fastForwardLight: return "\u{f560}"
        case .fastForwardRegular: return "\u{f561}"
        case .favoriteBold: return "\u{f562}"
        case .favoriteFilled: return "\u{f563}"
        case .favoriteLight: return "\u{f564}"
        case .favoriteRegular: return "\u{f565}"
        case .favoritesBold: return "\u{f566}"
        case .favoritesFilled: return "\u{f567}"
        case .favoritesLight: return "\u{f568}"
        case .favoritesRegular: return "\u{f569}"
        case .fbwBold: return "\u{f56a}"
        case .fbwFilled: return "\u{f56b}"
        case .fbwLight: return "\u{f56c}"
        case .fbwRegular: return "\u{f56d}"
        case .ffwBold: return "\u{f56e}"
        case .ffwFilled: return "\u{f56f}"
        case .ffwLight: return "\u{f570}"
        case .ffwRegular: return "\u{f571}"
        case .fileAnalysisBold: return "\u{f572}"
        case .fileAnalysisFilled: return "\u{f573}"
        case .fileAnalysisLight: return "\u{f574}"
        case .fileAnalysisRegular: return "\u{f575}"
        case .fileAnnotationBold: return "\u{f576}"
        case .fileAnnotationFilled: return "\u{f577}"
        case .fileAnnotationLight: return "\u{f578}"
        case .fileAnnotationRegular: return "\u{f579}"
        case .fileAudioBold: return "\u{f57a}"
        case .fileAudioFilled: return "\u{f57b}"
        case .fileAudioLight: return "\u{f57c}"
        case .fileAudioRegular: return "\u{f57d}"
        case .fileBugBold: return "\u{f57e}"
        case .fileBugFilled: return "\u{f57f}"
        case .fileBugLight: return "\u{f580}"
        case .fileBugRegular: return "\u{f581}"
        case .fileCodeBold: return "\u{f582}"
        case .fileCodeFilled: return "\u{f583}"
        case .fileCodeLight: return "\u{f584}"
        case .fileCodeRegular: return "\u{f585}"
        case .fileDashboardBold: return "\u{f586}"
        case .fileDashboardFilled: return "\u{f587}"
        case .fileDashboardLight: return "\u{f588}"
        case .fileDashboardRegular: return "\u{f589}"
        case .fileExcelBold: return "\u{f58a}"
        case .fileExcelFilled: return "\u{f58b}"
        case .fileExcelLight: return "\u{f58c}"
        case .fileExcelRegular: return "\u{f58d}"
        case .fileGraphBold: return "\u{f58e}"
        case .fileGraphFilled: return "\u{f58f}"
        case .fileGraphLight: return "\u{f590}"
        case .fileGraphRegular: return "\u{f591}"
        case .fileImageBold: return "\u{f592}"
        case .fileImageFilled: return "\u{f593}"
        case .fileImageLight: return "\u{f594}"
        case .fileImageNoneBold: return "\u{f595}"
        case .fileImageNoneLight: return "\u{f596}"
        case .fileImageNoneRegular: return "\u{f597}"
        case .fileImageRegular: return "\u{f598}"
        case .fileJsBold: return "\u{f599}"
        case .fileJsFilled: return "\u{f59a}"
        case .fileJsLight: return "\u{f59b}"
        case .fileJsRegular: return "\u{f59c}"
        case .fileKeynoteBold: return "\u{f59d}"
        case .fileKeynoteFilled: return "\u{f59e}"
        case .fileKeynoteLight: return "\u{f59f}"
        case .fileKeynoteRegular: return "\u{f5a0}"
        case .fileLockedBold: return "\u{f5a1}"
        case .fileLockedFilled: return "\u{f5a2}"
        case .fileLockedLight: return "\u{f5a3}"
        case .fileLockedRegular: return "\u{f5a4}"
        case .fileMissingBold: return "\u{f5a5}"
        case .fileMissingFilled: return "\u{f5a6}"
        case .fileMissingLight: return "\u{f5a7}"
        case .fileMissingRegular: return "\u{f5a8}"
        case .fileMusicBold: return "\u{f5a9}"
        case .fileMusicFilled: return "\u{f5aa}"
        case .fileMusicLight: return "\u{f5ab}"
        case .fileMusicRegular: return "\u{f5ac}"
        case .fileOnenoteBold: return "\u{f5ad}"
        case .fileOnenoteFilled: return "\u{f5ae}"
        case .fileOnenoteLight: return "\u{f5af}"
        case .fileOnenoteRegular: return "\u{f5b0}"
        case .filePdfBold: return "\u{f5b1}"
        case .filePdfFilled: return "\u{f5b2}"
        case .filePdfLight: return "\u{f5b3}"
        case .filePdfRegular: return "\u{f5b4}"
        case .filePowerpointBold: return "\u{f5b5}"
        case .filePowerpointFilled: return "\u{f5b6}"
        case .filePowerpointLight: return "\u{f5b7}"
        case .filePowerpointRegular: return "\u{f5b8}"
        case .fileSpreadsheetBold: return "\u{f5b9}"
        case .fileSpreadsheetFilled: return "\u{f5ba}"
        case .fileSpreadsheetLight: return "\u{f5bb}"
        case .fileSpreadsheetRegular: return "\u{f5bc}"
        case .fileTextBold: return "\u{f5bd}"
        case .fileTextFilled: return "\u{f5be}"
        case .fileTextLight: return "\u{f5bf}"
        case .fileTextRegular: return "\u{f5c0}"
        case .fileThreeDBold: return "\u{f5c1}"
        case .fileThreeDFilled: return "\u{f5c2}"
        case .fileThreeDLight: return "\u{f5c3}"
        case .fileThreeDRegular: return "\u{f5c4}"
        case .fileVectorBold: return "\u{f5c5}"
        case .fileVectorFilled: return "\u{f5c6}"
        case .fileVectorLight: return "\u{f5c7}"
        case .fileVectorRegular: return "\u{f5c8}"
        case .fileVideoBold: return "\u{f5c9}"
        case .fileVideoFilled: return "\u{f5ca}"
        case .fileVideoLight: return "\u{f5cb}"
        case .fileVideoRegular: return "\u{f5cc}"
        case .fileWordBold: return "\u{f5cd}"
        case .fileWordFilled: return "\u{f5ce}"
        case .fileWordLight: return "\u{f5cf}"
        case .fileWordRegular: return "\u{f5d0}"
        case .fileXmlBold: return "\u{f5d1}"
        case .fileXmlFilled: return "\u{f5d2}"
        case .fileXmlLight: return "\u{f5d3}"
        case .fileXmlRegular: return "\u{f5d4}"
        case .fileZipBold: return "\u{f5d5}"
        case .fileZipFilled: return "\u{f5d6}"
        case .fileZipLight: return "\u{f5d7}"
        case .fileZipRegular: return "\u{f5d8}"
        case .filesBold: return "\u{f5d9}"
        case .filesFilled: return "\u{f5da}"
        case .filesLight: return "\u{f5db}"
        case .filesRegular: return "\u{f5dc}"
        case .fillColourBold: return "\u{f5dd}"
        case .fillColourFilled: return "\u{f5de}"
        case .fillColourLight: return "\u{f5df}"
        case .fillColourRegular: return "\u{f5e0}"
        case .filterBold: return "\u{f5e1}"
        case .filterCircleBold: return "\u{f5e2}"
        case .filterCircleFilled: return "\u{f5e3}"
        case .filterCircleLight: return "\u{f5e4}"
        case .filterCircleRegular: return "\u{f5e5}"
        case .filterLight: return "\u{f5e6}"
        case .filterRegular: return "\u{f5e7}"
        case .fitToWidthBold: return "\u{f5e8}"
        case .fitToWidthLight: return "\u{f5e9}"
        case .fitToWidthRegular: return "\u{f5ea}"
        case .fitToWindowExpandBold: return "\u{f5eb}"
        case .fitToWindowExpandLight: return "\u{f5ec}"
        case .fitToWindowExpandRegular: return "\u{f5ed}"
        case .fitToWindowShrinkBold: return "\u{f5ee}"
        case .fitToWindowShrinkLight: return "\u{f5ef}"
        case .fitToWindowShrinkRegular: return "\u{f5f0}"
        case .flagBold: return "\u{f5f1}"
        case .flagCircleBold: return "\u{f5f2}"
        case .flagCircleFilled: return "\u{f5f3}"
        case .flagCircleLight: return "\u{f5f4}"
        case .flagCircleRegular: return "\u{f5f5}"
        case .flagFilled: return "\u{f5f6}"
        case .flagLight: return "\u{f5f7}"
        case .flagRegular: return "\u{f5f8}"
        case .folderBold: return "\u{f5f9}"
        case .folderEditBold: return "\u{f5fa}"
        case .folderEditLight: return "\u{f5fb}"
        case .folderEditRegular: return "\u{f5fc}"
        case .folderFilled: return "\u{f5fd}"
        case .folderLight: return "\u{f5fe}"
        case .folderLockBold: return "\u{f5ff}"
        case .folderLockLight: return "\u{f600}"
        case .folderLockRegular: return "\u{f601}"
        case .folderRegular: return "\u{f602}"
        case .folderViewBold: return "\u{f603}"
        case .folderViewLight: return "\u{f604}"
        case .folderViewRegular: return "\u{f605}"
        case .followUpBold: return "\u{f606}"
        case .followUpLight: return "\u{f607}"
        case .followUpRegular: return "\u{f608}"
        case .foodBold: return "\u{f609}"
        case .foodFilled: return "\u{f60a}"
        case .foodLight: return "\u{f60b}"
        case .foodRegular: return "\u{f60c}"
        case .forecastBold: return "\u{f60d}"
        case .forecastFilled: return "\u{f60e}"
        case .forecastLight: return "\u{f60f}"
        case .forecastRegular: return "\u{f610}"
        case .formatBold: return "\u{f611}"
        case .formatDefaultAppBold: return "\u{f612}"
        case .formatDefaultAppFilled: return "\u{f613}"
        case .formatDefaultAppLight: return "\u{f614}"
        case .formatDefaultAppRegular: return "\u{f615}"
        case .formatLight: return "\u{f616}"
        case .formatPanelControlBarBold: return "\u{f617}"
        case .formatPanelControlBarLight: return "\u{f618}"
        case .formatPanelControlBarRegular: return "\u{f619}"
        case .formatPanelControlDownBold: return "\u{f61a}"
        case .formatPanelControlDownLight: return "\u{f61b}"
        case .formatPanelControlDownRegular: return "\u{f61c}"
        case .formatPanelControlLeftBold: return "\u{f61d}"
        case .formatPanelControlLeftLight: return "\u{f61e}"
        case .formatPanelControlLeftRegular: return "\u{f61f}"
        case .formatPanelControlRightBold: return "\u{f620}"
        case .formatPanelControlRightLight: return "\u{f621}"
        case .formatPanelControlRightRegular: return "\u{f622}"
        case .formatPanelControlUpBold: return "\u{f623}"
        case .formatPanelControlUpDownBold: return "\u{f624}"
        case .formatPanelControlUpDownLight: return "\u{f625}"
        case .formatPanelControlUpDownRegular: return "\u{f626}"
        case .formatPanelControlUpLight: return "\u{f627}"
        case .formatPanelControlUpRegular: return "\u{f628}"
        case .formatRegular: return "\u{f629}"
        case .formatViewMixedBold: return "\u{f62a}"
        case .formatViewMixedLight: return "\u{f62b}"
        case .formatViewMixedRegular: return "\u{f62c}"
        case .formulaBold: return "\u{f62d}"
        case .formulaFilled: return "\u{f62e}"
        case .formulaLight: return "\u{f62f}"
        case .formulaRegular: return "\u{f630}"
        case .forwardMessageBold: return "\u{f631}"
        case .forwardMessageFilled: return "\u{f632}"
        case .forwardMessageLight: return "\u{f633}"
        case .forwardMessageRegular: return "\u{f634}"
        case .forwardTenSecBold: return "\u{f635}"
        case .forwardTenSecLight: return "\u{f636}"
        case .forwardTenSecRegular: return "\u{f637}"
        case .fourColumnBold: return "\u{f638}"
        case .fourColumnLight: return "\u{f639}"
        case .fourColumnRegular: return "\u{f63a}"
        case .fourWayNavigationBold: return "\u{f63b}"
        case .fourWayNavigationLight: return "\u{f63c}"
        case .fourWayNavigationRegular: return "\u{f63d}"
        case .frequencyCappingBold: return "\u{f63e}"
        case .frequencyCappingLight: return "\u{f63f}"
        case .frequencyCappingRegular: return "\u{f640}"
        case .fulfillmentBold: return "\u{f641}"
        case .fulfillmentLight: return "\u{f642}"
        case .fulfillmentRegular: return "\u{f643}"
        case .fullscreenBold: return "\u{f644}"
        case .fullscreenExitBold: return "\u{f645}"
        case .fullscreenExitLight: return "\u{f646}"
        case .fullscreenExitRegular: return "\u{f647}"
        case .fullscreenLight: return "\u{f648}"
        case .fullscreenRegular: return "\u{f649}"
        case .genericDeviceVideoBadgeFilled: return "\u{f64a}"
        case .genericDeviceVideoBold: return "\u{f64b}"
        case .genericDeviceVideoFilled: return "\u{f64c}"
        case .genericDeviceVideoLight: return "\u{f64d}"
        case .genericDeviceVideoRegular: return "\u{f64e}"
        case .gifBold: return "\u{f64f}"
        case .gifFilled: return "\u{f650}"
        case .gifHorizontalBold: return "\u{f651}"
        case .gifHorizontalFilled: return "\u{f652}"
        case .gifHorizontalLight: return "\u{f653}"
        case .gifHorizontalRegular: return "\u{f654}"
        case .gifLight: return "\u{f655}"
        case .gifRegular: return "\u{f656}"
        case .giftBold: return "\u{f657}"
        case .giftFilled: return "\u{f658}"
        case .giftLight: return "\u{f659}"
        case .giftRegular: return "\u{f65a}"
        case .greenLeafBold: return "\u{f65b}"
        case .greenLeafFilled: return "\u{f65c}"
        case .greenLeafLight: return "\u{f65d}"
        case .greenLeafRegular: return "\u{f65e}"
        case .greenRoomBold: return "\u{f65f}"
        case .greenRoomFilled: return "\u{f660}"
        case .greenRoomLight: return "\u{f661}"
        case .greenRoomRegular: return "\u{f662}"
        case .guestIssuerBold: return "\u{f663}"
        case .guestIssuerLight: return "\u{f664}"
        case .guestIssuerRegular: return "\u{f665}"
        case .guideBold: return "\u{f666}"
        case .guideLight: return "\u{f667}"
        case .guideRegular: return "\u{f668}"
        case .handPointerBold: return "\u{f669}"
        case .handPointerLight: return "\u{f66a}"
        case .handPointerRegular: return "\u{f66b}"
        case .handlerBold: return "\u{f66c}"
        case .handlerHorizontalBold: return "\u{f66d}"
        case .handlerHorizontalLight: return "\u{f66e}"
        case .handlerHorizontalRegular: return "\u{f66f}"
        case .handlerLight: return "\u{f670}"
        case .handlerRegular: return "\u{f671}"
        case .handsetAlertBold: return "\u{f672}"
        case .handsetAlertFilled: return "\u{f673}"
        case .handsetAlertLight: return "\u{f674}"
        case .handsetAlertRegular: return "\u{f675}"
        case .handsetBold: return "\u{f676}"
        case .handsetDownSlashBold: return "\u{f677}"
        case .handsetDownSlashFilled: return "\u{f678}"
        case .handsetDownSlashLight: return "\u{f679}"
        case .handsetDownSlashRegular: return "\u{f67a}"
        case .handsetFilled: return "\u{f67b}"
        case .handsetLight: return "\u{f67c}"
        case .handsetMutedBold: return "\u{f67d}"
        case .handsetMutedFilled: return "\u{f67e}"
        case .handsetMutedLight: return "\u{f67f}"
        case .handsetMutedRegular: return "\u{f680}"
        case .handsetRegular: return "\u{f681}"
        case .handsetsArrowLeftBold: return "\u{f682}"
        case .handsetsArrowLeftLight: return "\u{f683}"
        case .handsetsArrowLeftRegular: return "\u{f684}"
        case .handshakeBold: return "\u{f685}"
        case .handshakeLight: return "\u{f686}"
        case .handshakeRegular: return "\u{f687}"
        case .headingOneBold: return "\u{f688}"
        case .headingOneLight: return "\u{f689}"
        case .headingOneRegular: return "\u{f68a}"
        case .headingThreeBold: return "\u{f68b}"
        case .headingThreeLight: return "\u{f68c}"
        case .headingThreeRegular: return "\u{f68d}"
        case .headingTwoBold: return "\u{f68e}"
        case .headingTwoLight: return "\u{f68f}"
        case .headingTwoRegular: return "\u{f690}"
        case .headphonesBold: return "\u{f691}"
        case .headphonesFilled: return "\u{f692}"
        case .headphonesLight: return "\u{f693}"
        case .headphonesMutedBold: return "\u{f694}"
        case .headphonesMutedFilled: return "\u{f695}"
        case .headphonesMutedLight: return "\u{f696}"
        case .headphonesMutedRegular: return "\u{f697}"
        case .headphonesRegular: return "\u{f698}"
        case .headsetAlertBold: return "\u{f699}"
        case .headsetAlertLight: return "\u{f69a}"
        case .headsetAlertRegular: return "\u{f69b}"
        case .headsetArrowDownBold: return "\u{f69c}"
        case .headsetArrowDownFilled: return "\u{f69d}"
        case .headsetArrowDownLight: return "\u{f69e}"
        case .headsetArrowDownRegular: return "\u{f69f}"
        case .headsetBluetoothBold: return "\u{f6a0}"
        case .headsetBluetoothLight: return "\u{f6a1}"
        case .headsetBluetoothRegular: return "\u{f6a2}"
        case .headsetBold: return "\u{f6a3}"
        case .headsetFilled: return "\u{f6a4}"
        case .headsetLight: return "\u{f6a5}"
        case .headsetMutedBold: return "\u{f6a6}"
        case .headsetMutedLight: return "\u{f6a7}"
        case .headsetMutedRegular: return "\u{f6a8}"
        case .headsetPrivateBold: return "\u{f6a9}"
        case .headsetPrivateLight: return "\u{f6aa}"
        case .headsetPrivateRegular: return "\u{f6ab}"
        case .headsetRegular: return "\u{f6ac}"
        case .hearingBold: return "\u{f6ad}"
        case .hearingImpairedBold: return "\u{f6ae}"
        case .hearingImpairedLight: return "\u{f6af}"
        case .hearingImpairedRegular: return "\u{f6b0}"
        case .hearingLight: return "\u{f6b1}"
        case .hearingRegular: return "\u{f6b2}"
        case .helpBold: return "\u{f6b3}"
        case .helpCircleBold: return "\u{f6b4}"
        case .helpCircleFilled: return "\u{f6b5}"
        case .helpCircleLight: return "\u{f6b6}"
        case .helpCircleRegular: return "\u{f6b7}"
        case .helpLight: return "\u{f6b8}"
        case .helpRegular: return "\u{f6b9}"
        case .helpdeskBold: return "\u{f6ba}"
        case .helpdeskFilled: return "\u{f6bb}"
        case .helpdeskLight: return "\u{f6bc}"
        case .helpdeskRegular: return "\u{f6bd}"
        case .hideBold: return "\u{f6be}"
        case .hideFilled: return "\u{f6bf}"
        case .hideLight: return "\u{f6c0}"
        case .hideRegular: return "\u{f6c1}"
        case .homeBold: return "\u{f6c2}"
        case .homeFilled: return "\u{f6c3}"
        case .homeLight: return "\u{f6c4}"
        case .homeRegular: return "\u{f6c5}"
        case .horizontalLineBold: return "\u{f6c6}"
        case .horizontalLineLight: return "\u{f6c7}"
        case .horizontalLineRegular: return "\u{f6c8}"
        case .hotelingBold: return "\u{f6c9}"
        case .hotelingFilled: return "\u{f6ca}"
        case .hotelingLight: return "\u{f6cb}"
        case .hotelingRegular: return "\u{f6cc}"
        case .humidityBold: return "\u{f6cd}"
        case .humidityLight: return "\u{f6ce}"
        case .humidityRegular: return "\u{f6cf}"
        case .huntGroupBold: return "\u{f6d0}"
        case .huntGroupFilled: return "\u{f6d1}"
        case .huntGroupLight: return "\u{f6d2}"
        case .huntGroupRegular: return "\u{f6d3}"
        case .idleBold: return "\u{f6d4}"
        case .idleFilled: return "\u{f6d5}"
        case .idleLight: return "\u{f6d6}"
        case .idleRegular: return "\u{f6d7}"
        case .immediateBold: return "\u{f6d8}"
        case .immediateFilled: return "\u{f6d9}"
        case .immediateLight: return "\u{f6da}"
        case .immediateRegular: return "\u{f6db}"
        case .importBold: return "\u{f6dc}"
        case .importLight: return "\u{f6dd}"
        case .importRegular: return "\u{f6de}"
        case .inCommonBold: return "\u{f6df}"
        case .inCommonLight: return "\u{f6e0}"
        case .inCommonRegular: return "\u{f6e1}"
        case .inboxBold: return "\u{f6e2}"
        case .inboxFilled: return "\u{f6e3}"
        case .inboxLight: return "\u{f6e4}"
        case .inboxRegular: return "\u{f6e5}"
        case .includeBold: return "\u{f6e6}"
        case .includeLight: return "\u{f6e7}"
        case .includeRegular: return "\u{f6e8}"
        case .incognitoBold: return "\u{f6e9}"
        case .incognitoFilled: return "\u{f6ea}"
        case .incognitoLight: return "\u{f6eb}"
        case .incognitoRegular: return "\u{f6ec}"
        case .incomingCallLegacyBold: return "\u{f6ed}"
        case .incomingCallLegacyFilled: return "\u{f6ee}"
        case .incomingCallLegacyLight: return "\u{f6ef}"
        case .incomingCallLegacyRegular: return "\u{f6f0}"
        case .indentDecreaseBold: return "\u{f6f1}"
        case .indentDecreaseLight: return "\u{f6f2}"
        case .indentDecreaseRegular: return "\u{f6f3}"
        case .indentIncreaseBold: return "\u{f6f4}"
        case .indentIncreaseLight: return "\u{f6f5}"
        case .indentIncreaseRegular: return "\u{f6f6}"
        case .infoBadgeFilled: return "\u{f6f7}"
        case .infoCircleBold: return "\u{f6f8}"
        case .infoCircleFilled: return "\u{f6f9}"
        case .infoCircleLight: return "\u{f6fa}"
        case .infoCircleRegular: return "\u{f6fb}"
        case .infoCircleTwoBold: return "\u{f6fc}"
        case .infoCircleTwoFilled: return "\u{f6fd}"
        case .infoCircleTwoLight: return "\u{f6fe}"
        case .infoCircleTwoRegular: return "\u{f6ff}"
        case .inputBold: return "\u{f700}"
        case .inputDisconnectedBold: return "\u{f701}"
        case .inputDisconnectedLight: return "\u{f702}"
        case .inputDisconnectedRegular: return "\u{f703}"
        case .inputLight: return "\u{f704}"
        case .inputRegular: return "\u{f705}"
        case .instantScheduleBold: return "\u{f706}"
        case .instantScheduleFilled: return "\u{f707}"
        case .instantScheduleLight: return "\u{f708}"
        case .instantScheduleRegular: return "\u{f709}"
        case .integerBold: return "\u{f70a}"
        case .integerFilled: return "\u{f70b}"
        case .integerLight: return "\u{f70c}"
        case .integerRegular: return "\u{f70d}"
        case .integrationsBold: return "\u{f70e}"
        case .integrationsFilled: return "\u{f70f}"
        case .integrationsLight: return "\u{f710}"
        case .integrationsRegular: return "\u{f711}"
        case .intelligentRoutingBold: return "\u{f712}"
        case .intelligentRoutingLight: return "\u{f713}"
        case .intelligentRoutingRegular: return "\u{f714}"
        case .interactionBold: return "\u{f715}"
        case .interactionFilled: return "\u{f716}"
        case .interactionLight: return "\u{f717}"
        case .interactionRegular: return "\u{f718}"
        case .invitedUserBold: return "\u{f719}"
        case .invitedUserLight: return "\u{f71a}"
        case .invitedUserRegular: return "\u{f71b}"
        case .italicBold: return "\u{f71c}"
        case .italicFilled: return "\u{f71d}"
        case .italicLight: return "\u{f71e}"
        case .italicRegular: return "\u{f71f}"
        case .joinAudioBold: return "\u{f720}"
        case .joinAudioFilled: return "\u{f721}"
        case .joinAudioLight: return "\u{f722}"
        case .joinAudioRegular: return "\u{f723}"
        case .keepInTouchBold: return "\u{f724}"
        case .keepInTouchFilled: return "\u{f725}"
        case .keepInTouchLight: return "\u{f726}"
        case .keepInTouchRegular: return "\u{f727}"
        case .keyboardBold: return "\u{f728}"
        case .keyboardCloseBold: return "\u{f729}"
        case .keyboardCloseLight: return "\u{f72a}"
        case .keyboardCloseRegular: return "\u{f72b}"
        case .keyboardLight: return "\u{f72c}"
        case .keyboardRegular: return "\u{f72d}"
        case .languageBold: return "\u{f72e}"
        case .languageFilled: return "\u{f72f}"
        case .languageLight: return "\u{f730}"
        case .languageRegular: return "\u{f731}"
        case .laptopBold: return "\u{f732}"
        case .laptopDisconnectedBold: return "\u{f733}"
        case .laptopDisconnectedLight: return "\u{f734}"
        case .laptopDisconnectedRegular: return "\u{f735}"
        case .laptopFilled: return "\u{f736}"
        case .laptopLight: return "\u{f737}"
        case .laptopRegular: return "\u{f738}"
        case .laserPointerBold: return "\u{f739}"
        case .laserPointerCursorBlackLight: return "\u{f73a}"
        case .laserPointerCursorBlueLight: return "\u{f73b}"
        case .laserPointerCursorGreenLight: return "\u{f73c}"
        case .laserPointerCursorPurpleLight: return "\u{f73d}"
        case .laserPointerCursorRedLight: return "\u{f73e}"
        case .laserPointerCursorWhiteLight: return "\u{f73f}"
        case .laserPointerCursorYellowLight: return "\u{f740}"
        case .laserPointerFilled: return "\u{f741}"
        case .laserPointerLight: return "\u{f742}"
        case .laserPointerRegular: return "\u{f743}"
        case .launchBold: return "\u{f744}"
        case .launchFilled: return "\u{f745}"
        case .launchLight: return "\u{f746}"
        case .launchRegular: return "\u{f747}"
        case .layoutSideBySideVerticalBold: return "\u{f748}"
        case .layoutSideBySideVerticalFilled: return "\u{f749}"
        case .layoutSideBySideVerticalLight: return "\u{f74a}"
        case .layoutSideBySideVerticalRegular: return "\u{f74b}"
        case .leaveBreakoutSessionBold: return "\u{f74c}"
        case .leaveBreakoutSessionLight: return "\u{f74d}"
        case .leaveBreakoutSessionRegular: return "\u{f74e}"
        case .leaveDeviceBold: return "\u{f74f}"
        case .leaveDeviceLight: return "\u{f750}"
        case .leaveDeviceRegular: return "\u{f751}"
        case .likeBold: return "\u{f752}"
        case .likeFilled: return "\u{f753}"
        case .likeLight: return "\u{f754}"
        case .likeRegular: return "\u{f755}"
        case .linkBold: return "\u{f756}"
        case .linkLight: return "\u{f757}"
        case .linkRegular: return "\u{f758}"
        case .listBulletedBold: return "\u{f759}"
        case .listBulletedLight: return "\u{f75a}"
        case .listBulletedRegular: return "\u{f75b}"
        case .listMenuBold: return "\u{f75c}"
        case .listMenuLight: return "\u{f75d}"
        case .listMenuRegular: return "\u{f75e}"
        case .listNumberedBold: return "\u{f75f}"
        case .listNumberedLight: return "\u{f760}"
        case .listNumberedRegular: return "\u{f761}"
        case .liveBold: return "\u{f762}"
        case .liveFilled: return "\u{f763}"
        case .liveLight: return "\u{f764}"
        case .liveRegular: return "\u{f765}"
        case .locationBold: return "\u{f766}"
        case .locationFilled: return "\u{f767}"
        case .locationLight: return "\u{f768}"
        case .locationRegular: return "\u{f769}"
        case .longTextBoxBold: return "\u{f76a}"
        case .longTextBoxLight: return "\u{f76b}"
        case .longTextBoxRegular: return "\u{f76c}"
        case .lowerHandBold: return "\u{f76d}"
        case .lowerHandLight: return "\u{f76e}"
        case .lowerHandRegular: return "\u{f76f}"
        case .magicPenBold: return "\u{f770}"
        case .magicPenFilled: return "\u{f771}"
        case .magicPenLight: return "\u{f772}"
        case .magicPenRegular: return "\u{f773}"
        case .markAsUnreadBold: return "\u{f774}"
        case .markAsUnreadFilled: return "\u{f775}"
        case .markAsUnreadLight: return "\u{f776}"
        case .markAsUnreadRegular: return "\u{f777}"
        case .markdownBold: return "\u{f778}"
        case .markdownFilled: return "\u{f779}"
        case .markdownLight: return "\u{f77a}"
        case .markdownRegular: return "\u{f77b}"
        case .markerBold: return "\u{f77c}"
        case .markerFilled: return "\u{f77d}"
        case .markerLight: return "\u{f77e}"
        case .markerRegular: return "\u{f77f}"
        case .maximizeBold: return "\u{f780}"
        case .maximizeLight: return "\u{f781}"
        case .maximizeRegular: return "\u{f782}"
        case .mcpBold: return "\u{f783}"
        case .mcpFilled: return "\u{f784}"
        case .mcpLight: return "\u{f785}"
        case .mcpRegular: return "\u{f786}"
        case .mediaPlayerBold: return "\u{f787}"
        case .mediaPlayerLight: return "\u{f788}"
        case .mediaPlayerRegular: return "\u{f789}"
        case .mediaQualityGoodBold: return "\u{f78a}"
        case .mediaQualityGoodFilled: return "\u{f78b}"
        case .mediaQualityGoodLight: return "\u{f78c}"
        case .mediaQualityGoodRegular: return "\u{f78d}"
        case .mediaQualityPoorBold: return "\u{f78e}"
        case .mediaQualityPoorColoredBold: return "\u{f78f}"
        case .mediaQualityPoorFilled: return "\u{f790}"
        case .mediaQualityPoorLight: return "\u{f791}"
        case .mediaQualityPoorRegular: return "\u{f792}"
        case .mediaQualityUnstableBold: return "\u{f793}"
        case .mediaQualityUnstableColoredBold: return "\u{f794}"
        case .mediaQualityUnstableFilled: return "\u{f795}"
        case .mediaQualityUnstableLight: return "\u{f796}"
        case .mediaQualityUnstableRegular: return "\u{f797}"
        case .meetBold: return "\u{f798}"
        case .meetEndBold: return "\u{f799}"
        case .meetEndLight: return "\u{f79a}"
        case .meetEndRegular: return "\u{f79b}"
        case .meetFilled: return "\u{f79c}"
        case .meetLight: return "\u{f79d}"
        case .meetRegular: return "\u{f79e}"
        case .meetingSummaryBold: return "\u{f79f}"
        case .meetingSummaryFilled: return "\u{f7a0}"
        case .meetingSummaryLight: return "\u{f7a1}"
        case .meetingSummaryRegular: return "\u{f7a2}"
        case .meetingsBold: return "\u{f7a3}"
        case .meetingsFilled: return "\u{f7a4}"
        case .meetingsFocusMonthBold: return "\u{f7a5}"
        case .meetingsFocusMonthLight: return "\u{f7a6}"
        case .meetingsFocusMonthRegular: return "\u{f7a7}"
        case .meetingsFocusOneDayBold: return "\u{f7a8}"
        case .meetingsFocusOneDayLight: return "\u{f7a9}"
        case .meetingsFocusOneDayRegular: return "\u{f7aa}"
        case .meetingsFocusThreeDayBold: return "\u{f7ab}"
        case .meetingsFocusThreeDayLight: return "\u{f7ac}"
        case .meetingsFocusThreeDayRegular: return "\u{f7ad}"
        case .meetingsFocusUpcomingBold: return "\u{f7ae}"
        case .meetingsFocusUpcomingLight: return "\u{f7af}"
        case .meetingsFocusUpcomingRegular: return "\u{f7b0}"
        case .meetingsLight: return "\u{f7b1}"
        case .meetingsPresenceBadgeFilled: return "\u{f7b2}"
        case .meetingsPresenceBold: return "\u{f7b3}"
        case .meetingsPresenceFilled: return "\u{f7b4}"
        case .meetingsPresenceLight: return "\u{f7b5}"
        case .meetingsPresenceRegular: return "\u{f7b6}"
        case .meetingsRegular: return "\u{f7b7}"
        case .meetingsTeamBold: return "\u{f7b8}"
        case .meetingsTeamFilled: return "\u{f7b9}"
        case .meetingsTeamLight: return "\u{f7ba}"
        case .meetingsTeamNewBold: return "\u{f7bb}"
        case .meetingsTeamNewLight: return "\u{f7bc}"
        case .meetingsTeamNewRegular: return "\u{f7bd}"
        case .meetingsTeamRegular: return "\u{f7be}"
        case .mentionBold: return "\u{f7bf}"
        case .mentionFilled: return "\u{f7c0}"
        case .mentionLight: return "\u{f7c1}"
        case .mentionRegular: return "\u{f7c2}"
        case .messageQueingBold: return "\u{f7c3}"
        case .messageQueingLight: return "\u{f7c4}"
        case .messageQueingRegular: return "\u{f7c5}"
        case .microphoneBold: return "\u{f7c6}"
        case .microphoneFilled: return "\u{f7c7}"
        case .microphoneHardMutedBold: return "\u{f7c8}"
        case .microphoneHardMutedCircleFilled: return "\u{f7c9}"
        case .microphoneHardMutedLight: return "\u{f7ca}"
        case .microphoneHardMutedRegular: return "\u{f7cb}"
        case .microphoneLight: return "\u{f7cc}"
        case .microphoneMusicModeBold: return "\u{f7cd}"
        case .microphoneMusicModeLight: return "\u{f7ce}"
        case .microphoneMusicModeOnBold: return "\u{f7cf}"
        case .microphoneMusicModeOnLight: return "\u{f7d0}"
        case .microphoneMusicModeOnRegular: return "\u{f7d1}"
        case .microphoneMusicModeRegular: return "\u{f7d2}"
        case .microphoneMutedBold: return "\u{f7d3}"
        case .microphoneMutedCircleFilled: return "\u{f7d4}"
        case .microphoneMutedFilled: return "\u{f7d5}"
        case .microphoneMutedLight: return "\u{f7d6}"
        case .microphoneMutedRegular: return "\u{f7d7}"
        case .microphoneOnBold: return "\u{f7d8}"
        case .microphoneOnLight: return "\u{f7d9}"
        case .microphoneOnRegular: return "\u{f7da}"
        case .microphoneOptAllBold: return "\u{f7db}"
        case .microphoneOptAllLight: return "\u{f7dc}"
        case .microphoneOptAllMutedBold: return "\u{f7dd}"
        case .microphoneOptAllMutedLight: return "\u{f7de}"
        case .microphoneOptAllMutedRegular: return "\u{f7df}"
        case .microphoneOptAllOnBold: return "\u{f7e0}"
        case .microphoneOptAllOnLight: return "\u{f7e1}"
        case .microphoneOptAllOnRegular: return "\u{f7e2}"
        case .microphoneOptAllRegular: return "\u{f7e3}"
        case .microphoneOptMeBold: return "\u{f7e4}"
        case .microphoneOptMeLight: return "\u{f7e5}"
        case .microphoneOptMeMutedBold: return "\u{f7e6}"
        case .microphoneOptMeMutedLight: return "\u{f7e7}"
        case .microphoneOptMeMutedRegular: return "\u{f7e8}"
        case .microphoneOptMeOnBold: return "\u{f7e9}"
        case .microphoneOptMeOnLight: return "\u{f7ea}"
        case .microphoneOptMeOnRegular: return "\u{f7eb}"
        case .microphoneOptMeRegular: return "\u{f7ec}"
        case .microphoneRegular: return "\u{f7ed}"
        case .mindMapBold: return "\u{f7ee}"
        case .mindMapLight: return "\u{f7ef}"
        case .mindMapRegular: return "\u{f7f0}"
        case .minimizeBold: return "\u{f7f1}"
        case .minimizeLight: return "\u{f7f2}"
        case .minimizeRegular: return "\u{f7f3}"
        case .minusBold: return "\u{f7f4}"
        case .minusFilled: return "\u{f7f5}"
        case .minusLight: return "\u{f7f6}"
        case .minusRegular: return "\u{f7f7}"
        case .mirrorBold: return "\u{f7f8}"
        case .mirrorFilled: return "\u{f7f9}"
        case .mirrorLight: return "\u{f7fa}"
        case .mirrorRegular: return "\u{f7fb}"
        case .mmsFilled: return "\u{f7fc}"
        case .moderatorBold: return "\u{f7fd}"
        case .moderatorLight: return "\u{f7fe}"
        case .moderatorRegular: return "\u{f7ff}"
        case .monitoringBold: return "\u{f800}"
        case .monitoringLight: return "\u{f801}"
        case .monitoringRegular: return "\u{f802}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f803}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f804}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f805}"
        case .moreAdrBold: return "\u{f806}"
        case .moreAdrLight: return "\u{f807}"
        case .moreAdrRegular: return "\u{f808}"
        case .moreBold: return "\u{f809}"
        case .moreCircleBold: return "\u{f80a}"
        case .moreCircleFilled: return "\u{f80b}"
        case .moreCircleLight: return "\u{f80c}"
        case .moreCircleRegular: return "\u{f80d}"
        case .moreLight: return "\u{f80e}"
        case .moreRegular: return "\u{f80f}"
        case .mouseCursorBold: return "\u{f810}"
        case .mouseCursorLight: return "\u{f811}"
        case .mouseCursorRegular: return "\u{f812}"
        case .moveCallInAdrBold: return "\u{f813}"
        case .moveCallInAdrLight: return "\u{f814}"
        case .moveCallInAdrRegular: return "\u{f815}"
        case .moveCallInIphBold: return "\u{f816}"
        case .moveCallInIphLight: return "\u{f817}"
        case .moveCallInIphRegular: return "\u{f818}"
        case .moveCallInLaptopBold: return "\u{f819}"
        case .moveCallInLaptopLight: return "\u{f81a}"
        case .moveCallInLaptopRegular: return "\u{f81b}"
        case .moveCallInOutAdrBold: return "\u{f81c}"
        case .moveCallInOutAdrLight: return "\u{f81d}"
        case .moveCallInOutAdrRegular: return "\u{f81e}"
        case .moveCallInOutIphBold: return "\u{f81f}"
        case .moveCallInOutIphLight: return "\u{f820}"
        case .moveCallInOutIphRegular: return "\u{f821}"
        case .moveCallInTabletBold: return "\u{f822}"
        case .moveCallInTabletLight: return "\u{f823}"
        case .moveCallInTabletRegular: return "\u{f824}"
        case .moveCallOutAdrBold: return "\u{f825}"
        case .moveCallOutAdrLight: return "\u{f826}"
        case .moveCallOutAdrRegular: return "\u{f827}"
        case .moveCallOutIphBold: return "\u{f828}"
        case .moveCallOutIphLight: return "\u{f829}"
        case .moveCallOutIphRegular: return "\u{f82a}"
        case .moveCallOutLaptopBold: return "\u{f82b}"
        case .moveCallOutLaptopLight: return "\u{f82c}"
        case .moveCallOutLaptopRegular: return "\u{f82d}"
        case .moveCallOutTabletBold: return "\u{f82e}"
        case .moveCallOutTabletLight: return "\u{f82f}"
        case .moveCallOutTabletRegular: return "\u{f830}"
        case .moveToBottomBold: return "\u{f831}"
        case .moveToBottomFilled: return "\u{f832}"
        case .moveToBottomLight: return "\u{f833}"
        case .moveToBottomRegular: return "\u{f834}"
        case .moveToScreenBold: return "\u{f835}"
        case .moveToScreenLight: return "\u{f836}"
        case .moveToScreenRegular: return "\u{f837}"
        case .moveToTopBold: return "\u{f838}"
        case .moveToTopFilled: return "\u{f839}"
        case .moveToTopLight: return "\u{f83a}"
        case .moveToTopRegular: return "\u{f83b}"
        case .multilineChartBold: return "\u{f83c}"
        case .multilineChartFilled: return "\u{f83d}"
        case .multilineChartLight: return "\u{f83e}"
        case .multilineChartRegular: return "\u{f83f}"
        case .multimediaBold: return "\u{f840}"
        case .multimediaFilled: return "\u{f841}"
        case .multimediaLight: return "\u{f842}"
        case .multimediaRegular: return "\u{f843}"
        case .multipledDevicesBold: return "\u{f844}"
        case .multipledDevicesFilled: return "\u{f845}"
        case .multipledDevicesLight: return "\u{f846}"
        case .multipledDevicesRegular: return "\u{f847}"
        case .musicModeCircleBold: return "\u{f848}"
        case .musicModeCircleFilled: return "\u{f849}"
        case .musicModeCircleLight: return "\u{f84a}"
        case .musicModeCircleRegular: return "\u{f84b}"
        case .musicNoteBold: return "\u{f84c}"
        case .musicNoteFilled: return "\u{f84d}"
        case .musicNoteLight: return "\u{f84e}"
        case .musicNoteRegular: return "\u{f84f}"
        case .muteOnEntryBold: return "\u{f850}"
        case .muteOnEntryFilled: return "\u{f851}"
        case .muteOnEntryLight: return "\u{f852}"
        case .muteOnEntryRegular: return "\u{f853}"
        case .networkSwitchBold: return "\u{f854}"
        case .networkSwitchFilled: return "\u{f855}"
        case .networkSwitchLight: return "\u{f856}"
        case .networkSwitchRegular: return "\u{f857}"
        case .newManagerBold: return "\u{f858}"
        case .newManagerFilled: return "\u{f859}"
        case .newManagerLight: return "\u{f85a}"
        case .newManagerRegular: return "\u{f85b}"
        case .newTitleBold: return "\u{f85c}"
        case .newTitleLight: return "\u{f85d}"
        case .newTitleRegular: return "\u{f85e}"
        case .newVoicemailBold: return "\u{f85f}"
        case .newVoicemailLight: return "\u{f860}"
        case .newVoicemailRegular: return "\u{f861}"
        case .newWhiteboardBold: return "\u{f862}"
        case .newWhiteboardLight: return "\u{f863}"
        case .newWhiteboardRegular: return "\u{f864}"
        case .nextBold: return "\u{f865}"
        case .nextLight: return "\u{f866}"
        case .nextRegular: return "\u{f867}"
        case .noDevicesBold: return "\u{f868}"
        case .noDevicesLight: return "\u{f869}"
        case .noDevicesRegular: return "\u{f86a}"
        case .noiseDetectedCanceledFilled: return "\u{f86b}"
        case .noiseDetectedFilled: return "\u{f86c}"
        case .noiseNoneCanceledFilled: return "\u{f86d}"
        case .noiseNoneFilled: return "\u{f86e}"
        case .noiseRemovalBold: return "\u{f86f}"
        case .noiseRemovalLight: return "\u{f870}"
        case .noiseRemovalRegular: return "\u{f871}"
        case .noteBold: return "\u{f872}"
        case .noteFilled: return "\u{f873}"
        case .noteLight: return "\u{f874}"
        case .notePptBold: return "\u{f875}"
        case .notePptLight: return "\u{f876}"
        case .notePptRegular: return "\u{f877}"
        case .noteRegular: return "\u{f878}"
        case .notesBold: return "\u{f879}"
        case .notesFilled: return "\u{f87a}"
        case .notesLight: return "\u{f87b}"
        case .notesRegular: return "\u{f87c}"
        case .numberBold: return "\u{f87d}"
        case .numberLight: return "\u{f87e}"
        case .numberRegular: return "\u{f87f}"
        case .oldRemoteBold: return "\u{f880}"
        case .oldRemoteLight: return "\u{f881}"
        case .oldRemoteRegular: return "\u{f882}"
        case .oldTouchBold: return "\u{f883}"
        case .oldTouchLight: return "\u{f884}"
        case .oldTouchRegular: return "\u{f885}"
        case .oneColumnBold: return "\u{f886}"
        case .oneColumnLight: return "\u{f887}"
        case .oneColumnRegular: return "\u{f888}"
        case .oneTimeBold: return "\u{f889}"
        case .oneTimeLight: return "\u{f88a}"
        case .oneTimeRegular: return "\u{f88b}"
        case .openInFolderBold: return "\u{f88c}"
        case .openInFolderFilled: return "\u{f88d}"
        case .openInFolderLight: return "\u{f88e}"
        case .openInFolderRegular: return "\u{f88f}"
        case .openPagesBold: return "\u{f890}"
        case .openPagesLight: return "\u{f891}"
        case .openPagesRegular: return "\u{f892}"
        case .otherNumberBold: return "\u{f893}"
        case .otherNumberFilled: return "\u{f894}"
        case .otherNumberLight: return "\u{f895}"
        case .otherNumberRegular: return "\u{f896}"
        case .otherNumberWarningBold: return "\u{f897}"
        case .otherNumberWarningLight: return "\u{f898}"
        case .otherNumberWarningRegular: return "\u{f899}"
        case .outgoingCallLegacyBold: return "\u{f89a}"
        case .outgoingCallLegacyFilled: return "\u{f89b}"
        case .outgoingCallLegacyLight: return "\u{f89c}"
        case .outgoingCallLegacyRegular: return "\u{f89d}"
        case .overflowLeftBold: return "\u{f89e}"
        case .overflowLeftLight: return "\u{f89f}"
        case .overflowLeftRegular: return "\u{f8a0}"
        case .overflowRightBold: return "\u{f8a1}"
        case .overflowRightLight: return "\u{f8a2}"
        case .overflowRightRegular: return "\u{f8a3}"
        case .pairedCameraBold: return "\u{f8a4}"
        case .pairedCameraLight: return "\u{f8a5}"
        case .pairedCameraRegular: return "\u{f8a6}"
        case .pairedDeviceBold: return "\u{f8a7}"
        case .pairedDeviceLight: return "\u{f8a8}"
        case .pairedDeviceRegular: return "\u{f8a9}"
        case .pairedHandsetBold: return "\u{f8aa}"
        case .pairedHandsetLight: return "\u{f8ab}"
        case .pairedHandsetRegular: return "\u{f8ac}"
        case .pairingBold: return "\u{f8ad}"
        case .pairingLight: return "\u{f8ae}"
        case .pairingRegular: return "\u{f8af}"
        case .parenthesisBold: return "\u{f8b0}"
        case .parenthesisFilled: return "\u{f8b1}"
        case .parenthesisLight: return "\u{f8b2}"
        case .parenthesisRegular: return "\u{f8b3}"
        case .parkedBold: return "\u{f8b4}"
        case .parkedFilled: return "\u{f8b5}"
        case .parkedLight: return "\u{f8b6}"
        case .parkedRegular: return "\u{f8b7}"
        case .parseBold: return "\u{f8b8}"
        case .parseLight: return "\u{f8b9}"
        case .parseRegular: return "\u{f8ba}"
        case .partialBold: return "\u{f8bb}"
        case .partialLight: return "\u{f8bc}"
        case .partialRegular: return "\u{f8bd}"
        case .participantAddBold: return "\u{f8be}"
        case .participantAddLight: return "\u{f8bf}"
        case .participantAddRegular: return "\u{f8c0}"
        case .participantBlockedBold: return "\u{f8c1}"
        case .participantBlockedLight: return "\u{f8c2}"
        case .participantBlockedRegular: return "\u{f8c3}"
        case .participantBold: return "\u{f8c4}"
        case .participantFilled: return "\u{f8c5}"
        case .participantLight: return "\u{f8c6}"
        case .participantListBold: return "\u{f8c7}"
        case .participantListFilled: return "\u{f8c8}"
        case .participantListLight: return "\u{f8c9}"
        case .participantListRegular: return "\u{f8ca}"
        case .participantRegular: return "\u{f8cb}"
        case .participantRemoveBold: return "\u{f8cc}"
        case .participantRemoveLight: return "\u{f8cd}"
        case .participantRemoveRegular: return "\u{f8ce}"
        case .participantSpeakerBold: return "\u{f8cf}"
        case .participantSpeakerFilled: return "\u{f8d0}"
        case .participantSpeakerLight: return "\u{f8d1}"
        case .participantSpeakerRegular: return "\u{f8d2}"
        case .participantUnknownBold: return "\u{f8d3}"
        case .participantUnknownLight: return "\u{f8d4}"
        case .participantUnknownRegular: return "\u{f8d5}"
        case .passMouseBold: return "\u{f8d6}"
        case .passMouseLight: return "\u{f8d7}"
        case .passMouseRegular: return "\u{f8d8}"
        case .pauseBadgeFilled: return "\u{f8d9}"
        case .pauseBold: return "\u{f8da}"
        case .pauseFilled: return "\u{f8db}"
        case .pauseInteractionBold: return "\u{f8dc}"
        case .pauseInteractionFilled: return "\u{f8dd}"
        case .pauseInteractionLight: return "\u{f8de}"
        case .pauseInteractionRegular: return "\u{f8df}"
        case .pauseLight: return "\u{f8e0}"
        case .pauseRegular: return "\u{f8e1}"
        case .peopleAddBold: return "\u{f8e2}"
        case .peopleAddFilled: return "\u{f8e3}"
        case .peopleAddLight: return "\u{f8e4}"
        case .peopleAddRegular: return "\u{f8e5}"
        case .peopleBold: return "\u{f8e6}"
        case .peopleCircleBold: return "\u{f8e7}"
        case .peopleCircleFilled: return "\u{f8e8}"
        case .peopleCircleLight: return "\u{f8e9}"
        case .peopleCircleRegular: return "\u{f8ea}"
        case .peopleFilled: return "\u{f8eb}"
        case .peopleInsightsBold: return "\u{f8ec}"
        case .peopleInsightsFilled: return "\u{f8ed}"
        case .peopleInsightsLight: return "\u{f8ee}"
        case .peopleInsightsRegular: return "\u{f8ef}"
        case .peopleLight: return "\u{f8f0}"
        case .peopleManageBold: return "\u{f8f1}"
        case .peopleManageFilled: return "\u{f8f2}"
        case .peopleManageLight: return "\u{f8f3}"
        case .peopleManageRegular: return "\u{f8f4}"
        case .peopleRegular: return "\u{f8f5}"
        case .phoneAlertBold: return "\u{f8f6}"
        case .phoneAlertLight: return "\u{f8f7}"
        case .phoneAlertRegular: return "\u{f8f8}"
        case .phoneBadgeFilled: return "\u{f8f9}"
        case .phoneBold: return "\u{f8fa}"
        case .phoneFilled: return "\u{f8fb}"
        case .phoneLight: return "\u{f8fc}"
        case .phoneMutedBold: return "\u{f8fd}"
        case .phoneMutedLight: return "\u{f8fe}"
        case .phoneMutedRegular: return "\u{f8ff}"
        case .phonePrivateBold: return "\u{f900}"
        case .phonePrivateLight: return "\u{f901}"
        case .phonePrivateRegular: return "\u{f902}"
        case .phoneRegular: return "\u{f903}"
        case .phoneReplyAllBold: return "\u{f904}"
        case .phoneReplyAllLight: return "\u{f905}"
        case .phoneReplyAllRegular: return "\u{f906}"
        case .phoneReplyBold: return "\u{f907}"
        case .phoneReplyLight: return "\u{f908}"
        case .phoneReplyRegular: return "\u{f909}"
        case .pickerBold: return "\u{f90a}"
        case .pickerLight: return "\u{f90b}"
        case .pickerRegular: return "\u{f90c}"
        case .pieChartBold: return "\u{f90d}"
        case .pieChartFilled: return "\u{f90e}"
        case .pieChartLight: return "\u{f90f}"
        case .pieChartRegular: return "\u{f910}"
        case .pinBold: return "\u{f911}"
        case .pinFilled: return "\u{f912}"
        case .pinLight: return "\u{f913}"
        case .pinListActivityBold: return "\u{f914}"
        case .pinListActivityLight: return "\u{f915}"
        case .pinListActivityRegular: return "\u{f916}"
        case .pinListBold: return "\u{f917}"
        case .pinListLight: return "\u{f918}"
        case .pinListRegular: return "\u{f919}"
        case .pinMutedBold: return "\u{f91a}"
        case .pinMutedFilled: return "\u{f91b}"
        case .pinMutedLight: return "\u{f91c}"
        case .pinMutedRegular: return "\u{f91d}"
        case .pinRegular: return "\u{f91e}"
        case .pipBold: return "\u{f91f}"
        case .pipEnterBold: return "\u{f920}"
        case .pipEnterLight: return "\u{f921}"
        case .pipEnterRegular: return "\u{f922}"
        case .pipExitBold: return "\u{f923}"
        case .pipExitLight: return "\u{f924}"
        case .pipExitRegular: return "\u{f925}"
        case .pipFilled: return "\u{f926}"
        case .pipLight: return "\u{f927}"
        case .pipRegular: return "\u{f928}"
        case .placeholderBold: return "\u{f929}"
        case .placeholderFilled: return "\u{f92a}"
        case .placeholderLight: return "\u{f92b}"
        case .placeholderRegular: return "\u{f92c}"
        case .playBold: return "\u{f92d}"
        case .playCircleBold: return "\u{f92e}"
        case .playCircleFilled: return "\u{f92f}"
        case .playCircleLight: return "\u{f930}"
        case .playCircleRegular: return "\u{f931}"
        case .playFilled: return "\u{f932}"
        case .playLight: return "\u{f933}"
        case .playRegular: return "\u{f934}"
        case .plugAcBold: return "\u{f935}"
        case .plugAcLight: return "\u{f936}"
        case .plugAcRegular: return "\u{f937}"
        case .plusBold: return "\u{f938}"
        case .plusCircleBold: return "\u{f939}"
        case .plusCircleFilled: return "\u{f93a}"
        case .plusCircleLight: return "\u{f93b}"
        case .plusCircleRegular: return "\u{f93c}"
        case .plusLight: return "\u{f93d}"
        case .plusRegular: return "\u{f93e}"
        case .pmrBold: return "\u{f93f}"
        case .pmrFilled: return "\u{f940}"
        case .pmrLight: return "\u{f941}"
        case .pmrRegular: return "\u{f942}"
        case .pollBold: return "\u{f943}"
        case .pollFilled: return "\u{f944}"
        case .pollLight: return "\u{f945}"
        case .pollRegular: return "\u{f946}"
        case .popInBold: return "\u{f947}"
        case .popInLight: return "\u{f948}"
        case .popInRegular: return "\u{f949}"
        case .popOutBold: return "\u{f94a}"
        case .popOutLight: return "\u{f94b}"
        case .popOutRegular: return "\u{f94c}"
        case .popUpBold: return "\u{f94d}"
        case .popUpLight: return "\u{f94e}"
        case .popUpRegular: return "\u{f94f}"
        case .portraitLandscapeBold: return "\u{f950}"
        case .portraitLandscapeLight: return "\u{f951}"
        case .portraitLandscapeRegular: return "\u{f952}"
        case .potentialFraudBold: return "\u{f953}"
        case .potentialFraudFilled: return "\u{f954}"
        case .potentialFraudLight: return "\u{f955}"
        case .potentialFraudRegular: return "\u{f956}"
        case .powerAcBold: return "\u{f957}"
        case .powerAcLight: return "\u{f958}"
        case .powerAcRegular: return "\u{f959}"
        case .powerBold: return "\u{f95a}"
        case .powerLight: return "\u{f95b}"
        case .powerRegular: return "\u{f95c}"
        case .preHeaderBold: return "\u{f95d}"
        case .preHeaderLight: return "\u{f95e}"
        case .preHeaderRegular: return "\u{f95f}"
        case .premiumBold: return "\u{f960}"
        case .premiumLight: return "\u{f961}"
        case .premiumRegular: return "\u{f962}"
        case .presentationBold: return "\u{f963}"
        case .presentationLight: return "\u{f964}"
        case .presentationRegular: return "\u{f965}"
        case .preventDownloadBold: return "\u{f966}"
        case .preventDownloadFilled: return "\u{f967}"
        case .preventDownloadLight: return "\u{f968}"
        case .preventDownloadRegular: return "\u{f969}"
        case .primaryParticipantBold: return "\u{f96a}"
        case .primaryParticipantFilled: return "\u{f96b}"
        case .primaryParticipantLight: return "\u{f96c}"
        case .primaryParticipantRegular: return "\u{f96d}"
        case .printBold: return "\u{f96e}"
        case .printLight: return "\u{f96f}"
        case .printRegular: return "\u{f970}"
        case .priorityBadgeFilled: return "\u{f971}"
        case .priorityCircleBold: return "\u{f972}"
        case .priorityCircleFilled: return "\u{f973}"
        case .priorityCircleLight: return "\u{f974}"
        case .priorityCircleRegular: return "\u{f975}"
        case .priorityCircleTwoBold: return "\u{f976}"
        case .priorityCircleTwoFilled: return "\u{f977}"
        case .priorityCircleTwoLight: return "\u{f978}"
        case .priorityCircleTwoRegular: return "\u{f979}"
        case .priorityWaveBold: return "\u{f97a}"
        case .priorityWaveLight: return "\u{f97b}"
        case .priorityWaveRegular: return "\u{f97c}"
        case .privacyCircleBold: return "\u{f97d}"
        case .privacyCircleFilled: return "\u{f97e}"
        case .privacyCircleLight: return "\u{f97f}"
        case .privacyCircleRegular: return "\u{f980}"
        case .privateBold: return "\u{f981}"
        case .privateCircleBold: return "\u{f982}"
        case .privateCircleFilled: return "\u{f983}"
        case .privateCircleLight: return "\u{f984}"
        case .privateCircleRegular: return "\u{f985}"
        case .privateLight: return "\u{f986}"
        case .privateMeetingBold: return "\u{f987}"
        case .privateMeetingLight: return "\u{f988}"
        case .privateMeetingRegular: return "\u{f989}"
        case .privateRegular: return "\u{f98a}"
        case .productDemoBold: return "\u{f98b}"
        case .productDemoLight: return "\u{f98c}"
        case .productDemoRegular: return "\u{f98d}"
        case .promptsAiBold: return "\u{f98e}"
        case .promptsAiLight: return "\u{f98f}"
        case .promptsAiRegular: return "\u{f990}"
        case .proximityBold: return "\u{f991}"
        case .proximityLight: return "\u{f992}"
        case .proximityMutedBold: return "\u{f993}"
        case .proximityMutedLight: return "\u{f994}"
        case .proximityMutedRegular: return "\u{f995}"
        case .proximityRegular: return "\u{f996}"
        case .proximityVideoBold: return "\u{f997}"
        case .proximityVideoLight: return "\u{f998}"
        case .proximityVideoRegular: return "\u{f999}"
        case .ptoPresenceBold: return "\u{f99a}"
        case .ptoPresenceFilled: return "\u{f99b}"
        case .ptoPresenceLight: return "\u{f99c}"
        case .ptoPresenceRegular: return "\u{f99d}"
        case .pullCallBold: return "\u{f99e}"
        case .pullCallFilled: return "\u{f99f}"
        case .pullCallLight: return "\u{f9a0}"
        case .pullCallRegular: return "\u{f9a1}"
        case .purchaseOrderBold: return "\u{f9a2}"
        case .purchaseOrderFilled: return "\u{f9a3}"
        case .purchaseOrderLight: return "\u{f9a4}"
        case .purchaseOrderRegular: return "\u{f9a5}"
        case .qABold: return "\u{f9a6}"
        case .qAFilled: return "\u{f9a7}"
        case .qALight: return "\u{f9a8}"
        case .qARegular: return "\u{f9a9}"
        case .qrCodeBold: return "\u{f9aa}"
        case .qrCodeLight: return "\u{f9ab}"
        case .qrCodeRegular: return "\u{f9ac}"
        case .qrCodeScanBold: return "\u{f9ad}"
        case .qrCodeScanLight: return "\u{f9ae}"
        case .qrCodeScanRegular: return "\u{f9af}"
        case .qualityBold: return "\u{f9b0}"
        case .qualityLight: return "\u{f9b1}"
        case .qualityRegular: return "\u{f9b2}"
        case .queueContactBold: return "\u{f9b3}"
        case .queueContactFilled: return "\u{f9b4}"
        case .queueContactLight: return "\u{f9b5}"
        case .queueContactRegular: return "\u{f9b6}"
        case .queuedInteractionBold: return "\u{f9b7}"
        case .queuedInteractionFilled: return "\u{f9b8}"
        case .queuedInteractionLight: return "\u{f9b9}"
        case .queuedInteractionRegular: return "\u{f9ba}"
        case .quietBold: return "\u{f9bb}"
        case .quietHoursPresenceBold: return "\u{f9bc}"
        case .quietHoursPresenceFilled: return "\u{f9bd}"
        case .quietHoursPresenceLight: return "\u{f9be}"
        case .quietHoursPresenceRegular: return "\u{f9bf}"
        case .quietLight: return "\u{f9c0}"
        case .quietRegular: return "\u{f9c1}"
        case .radioButtonGroupBold: return "\u{f9c2}"
        case .radioButtonGroupLight: return "\u{f9c3}"
        case .radioButtonGroupRegular: return "\u{f9c4}"
        case .raiseHandBold: return "\u{f9c5}"
        case .raiseHandCircleFilled: return "\u{f9c6}"
        case .raiseHandFilled: return "\u{f9c7}"
        case .raiseHandLight: return "\u{f9c8}"
        case .raiseHandRegular: return "\u{f9c9}"
        case .ramBold: return "\u{f9ca}"
        case .ramLight: return "\u{f9cb}"
        case .ramRegular: return "\u{f9cc}"
        case .reactionsBold: return "\u{f9cd}"
        case .reactionsFilled: return "\u{f9ce}"
        case .reactionsLight: return "\u{f9cf}"
        case .reactionsRegular: return "\u{f9d0}"
        case .reactivateBold: return "\u{f9d1}"
        case .reactivateLight: return "\u{f9d2}"
        case .reactivateRegular: return "\u{f9d3}"
        case .receiveVoiceBold: return "\u{f9d4}"
        case .receiveVoiceFilled: return "\u{f9d5}"
        case .receiveVoiceLight: return "\u{f9d6}"
        case .receiveVoiceRegular: return "\u{f9d7}"
        case .recentsBold: return "\u{f9d8}"
        case .recentsFilled: return "\u{f9d9}"
        case .recentsLight: return "\u{f9da}"
        case .recentsPresenceBadgeFilled: return "\u{f9db}"
        case .recentsPresenceBold: return "\u{f9dc}"
        case .recentsPresenceFilled: return "\u{f9dd}"
        case .recentsPresenceLight: return "\u{f9de}"
        case .recentsPresenceRegular: return "\u{f9df}"
        case .recentsRegular: return "\u{f9e0}"
        case .recordActiveBadgeFilled: return "\u{f9e1}"
        case .recordActiveBold: return "\u{f9e2}"
        case .recordActiveFilled: return "\u{f9e3}"
        case .recordActiveLight: return "\u{f9e4}"
        case .recordActiveRegular: return "\u{f9e5}"
        case .recordBold: return "\u{f9e6}"
        case .recordFilled: return "\u{f9e7}"
        case .recordLight: return "\u{f9e8}"
        case .recordPausedBadgeFilled: return "\u{f9e9}"
        case .recordPausedBold: return "\u{f9ea}"
        case .recordPausedFilled: return "\u{f9eb}"
        case .recordPausedLight: return "\u{f9ec}"
        case .recordPausedRegular: return "\u{f9ed}"
        case .recordRegular: return "\u{f9ee}"
        case .recurringBold: return "\u{f9ef}"
        case .recurringLight: return "\u{f9f0}"
        case .recurringOffBold: return "\u{f9f1}"
        case .recurringOffLight: return "\u{f9f2}"
        case .recurringOffRegular: return "\u{f9f3}"
        case .recurringRegular: return "\u{f9f4}"
        case .redoBold: return "\u{f9f5}"
        case .redoLight: return "\u{f9f6}"
        case .redoRegular: return "\u{f9f7}"
        case .refreshBold: return "\u{f9f8}"
        case .refreshLight: return "\u{f9f9}"
        case .refreshRegular: return "\u{f9fa}"
        case .remoteDesktopControlBold: return "\u{f9fb}"
        case .remoteDesktopControlFilled: return "\u{f9fc}"
        case .remoteDesktopControlLight: return "\u{f9fd}"
        case .remoteDesktopControlRegular: return "\u{f9fe}"
        case .removeBold: return "\u{f9ff}"
        case .removeFilled: return "\u{fa00}"
        case .removeLight: return "\u{fa01}"
        case .removeRegular: return "\u{fa02}"
        case .replyBold: return "\u{fa03}"
        case .replyFilled: return "\u{fa04}"
        case .replyLight: return "\u{fa05}"
        case .replyListBold: return "\u{fa06}"
        case .replyListFilled: return "\u{fa07}"
        case .replyListLight: return "\u{fa08}"
        case .replyListRegular: return "\u{fa09}"
        case .replyPrivatelyBold: return "\u{fa0a}"
        case .replyPrivatelyLight: return "\u{fa0b}"
        case .replyPrivatelyRegular: return "\u{fa0c}"
        case .replyRegular: return "\u{fa0d}"
        case .resetBold: return "\u{fa0e}"
        case .resetLight: return "\u{fa0f}"
        case .resetRegular: return "\u{fa10}"
        case .resizeCornerBold: return "\u{fa11}"
        case .resizeCornerLight: return "\u{fa12}"
        case .resizeCornerRegular: return "\u{fa13}"
        case .responsiveMobileBold: return "\u{fa14}"
        case .responsiveMobileLight: return "\u{fa15}"
        case .responsiveMobileRegular: return "\u{fa16}"
        case .restartBold: return "\u{fa17}"
        case .restartLight: return "\u{fa18}"
        case .restartRegular: return "\u{fa19}"
        case .resumeInteractionBold: return "\u{fa1a}"
        case .resumeInteractionFilled: return "\u{fa1b}"
        case .resumeInteractionLight: return "\u{fa1c}"
        case .resumeInteractionRegular: return "\u{fa1d}"
        case .retrieveCallBold: return "\u{fa1e}"
        case .retrieveCallFilled: return "\u{fa1f}"
        case .retrieveCallLight: return "\u{fa20}"
        case .retrieveCallRegular: return "\u{fa21}"
        case .returnBold: return "\u{fa22}"
        case .returnLight: return "\u{fa23}"
        case .returnRegular: return "\u{fa24}"
        case .rewindTenSecBold: return "\u{fa25}"
        case .rewindTenSecLight: return "\u{fa26}"
        case .rewindTenSecRegular: return "\u{fa27}"
        case .ringtoneBold: return "\u{fa28}"
        case .ringtoneLight: return "\u{fa29}"
        case .ringtoneRegular: return "\u{fa2a}"
        case .roomCalendarBold: return "\u{fa2b}"
        case .roomCalendarLight: return "\u{fa2c}"
        case .roomCalendarRegular: return "\u{fa2d}"
        case .roomLightsBold: return "\u{fa2e}"
        case .roomLightsFilled: return "\u{fa2f}"
        case .roomLightsLight: return "\u{fa30}"
        case .roomLightsRegular: return "\u{fa31}"
        case .rotateContentBold: return "\u{fa32}"
        case .rotateContentFilled: return "\u{fa33}"
        case .rotateContentLight: return "\u{fa34}"
        case .rotateContentRegular: return "\u{fa35}"
        case .rssBold: return "\u{fa36}"
        case .rssFilled: return "\u{fa37}"
        case .rssLight: return "\u{fa38}"
        case .rssRegular: return "\u{fa39}"
        case .ruleBasedBold: return "\u{fa3a}"
        case .ruleBasedLight: return "\u{fa3b}"
        case .ruleBasedRegular: return "\u{fa3c}"
        case .rulerBold: return "\u{fa3d}"
        case .rulerFilled: return "\u{fa3e}"
        case .rulerLight: return "\u{fa3f}"
        case .rulerRegular: return "\u{fa40}"
        case .runningApplicationBold: return "\u{fa41}"
        case .runningApplicationFilled: return "\u{fa42}"
        case .runningApplicationLight: return "\u{fa43}"
        case .runningApplicationRegular: return "\u{fa44}"
        case .saveBold: return "\u{fa45}"
        case .saveLight: return "\u{fa46}"
        case .saveRegular: return "\u{fa47}"
        case .saveTranscriptBold: return "\u{fa48}"
        case .saveTranscriptFilled: return "\u{fa49}"
        case .saveTranscriptLight: return "\u{fa4a}"
        case .saveTranscriptRegular: return "\u{fa4b}"
        case .scanBold: return "\u{fa4c}"
        case .scanLight: return "\u{fa4d}"
        case .scanRegular: return "\u{fa4e}"
        case .scheduleAiBold: return "\u{fa4f}"
        case .scheduleAiLight: return "\u{fa50}"
        case .scheduleAiRegular: return "\u{fa51}"
        case .scheduleSendBold: return "\u{fa52}"
        case .scheduleSendFilled: return "\u{fa53}"
        case .scheduleSendLight: return "\u{fa54}"
        case .scheduleSendRegular: return "\u{fa55}"
        case .scheduleWinnerBold: return "\u{fa56}"
        case .scheduleWinnerFilled: return "\u{fa57}"
        case .scheduleWinnerLight: return "\u{fa58}"
        case .scheduleWinnerRegular: return "\u{fa59}"
        case .schedulerAvailableBold: return "\u{fa5a}"
        case .schedulerAvailableLight: return "\u{fa5b}"
        case .schedulerAvailableRegular: return "\u{fa5c}"
        case .schedulerNotWorkingHoursBold: return "\u{fa5d}"
        case .schedulerNotWorkingHoursLight: return "\u{fa5e}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa5f}"
        case .schedulerUnavailableBold: return "\u{fa60}"
        case .schedulerUnavailableLight: return "\u{fa61}"
        case .schedulerUnavailableRegular: return "\u{fa62}"
        case .schedulerUnknownBold: return "\u{fa63}"
        case .schedulerUnknownLight: return "\u{fa64}"
        case .schedulerUnknownRegular: return "\u{fa65}"
        case .screenshotBold: return "\u{fa66}"
        case .screenshotDocBold: return "\u{fa67}"
        case .screenshotDocFilled: return "\u{fa68}"
        case .screenshotDocLight: return "\u{fa69}"
        case .screenshotDocRegular: return "\u{fa6a}"
        case .screenshotLight: return "\u{fa6b}"
        case .screenshotRegular: return "\u{fa6c}"
        case .searchAiBold: return "\u{fa6d}"
        case .searchAiLight: return "\u{fa6e}"
        case .searchAiRegular: return "\u{fa6f}"
        case .searchBold: return "\u{fa70}"
        case .searchFilled: return "\u{fa71}"
        case .searchLight: return "\u{fa72}"
        case .searchRegular: return "\u{fa73}"
        case .secondaryArrowBold: return "\u{fa74}"
        case .secondaryArrowLight: return "\u{fa75}"
        case .secondaryArrowRegular: return "\u{fa76}"
        case .secureCallLockBold: return "\u{fa77}"
        case .secureCallLockFilled: return "\u{fa78}"
        case .secureCallLockLight: return "\u{fa79}"
        case .secureCallLockRegular: return "\u{fa7a}"
        case .secureCallShieldBold: return "\u{fa7b}"
        case .secureCallShieldFilled: return "\u{fa7c}"
        case .secureCallShieldLight: return "\u{fa7d}"
        case .secureCallShieldRegular: return "\u{fa7e}"
        case .secureCircleBold: return "\u{fa7f}"
        case .secureCircleFilled: return "\u{fa80}"
        case .secureCircleLight: return "\u{fa81}"
        case .secureCircleRegular: return "\u{fa82}"
        case .secureLockBold: return "\u{fa83}"
        case .secureLockFilled: return "\u{fa84}"
        case .secureLockLight: return "\u{fa85}"
        case .secureLockRegular: return "\u{fa86}"
        case .segmentExcludeFilled: return "\u{fa87}"
        case .segmentFilterFilled: return "\u{fa88}"
        case .segmentIncludeFilled: return "\u{fa89}"
        case .selectAllBold: return "\u{fa8a}"
        case .selectAllFilled: return "\u{fa8b}"
        case .selectAllLight: return "\u{fa8c}"
        case .selectAllRegular: return "\u{fa8d}"
        case .selectionBold: return "\u{fa8e}"
        case .selectionFilled: return "\u{fa8f}"
        case .selectionLight: return "\u{fa90}"
        case .selectionRegular: return "\u{fa91}"
        case .sendBold: return "\u{fa92}"
        case .sendDigitsBold: return "\u{fa93}"
        case .sendDigitsFilled: return "\u{fa94}"
        case .sendDigitsLight: return "\u{fa95}"
        case .sendDigitsRegular: return "\u{fa96}"
        case .sendFilled: return "\u{fa97}"
        case .sendLight: return "\u{fa98}"
        case .sendRegular: return "\u{fa99}"
        case .sendVoiceBold: return "\u{fa9a}"
        case .sendVoiceFilled: return "\u{fa9b}"
        case .sendVoiceLight: return "\u{fa9c}"
        case .sendVoiceRegular: return "\u{fa9d}"
        case .serverBold: return "\u{fa9e}"
        case .serverErrorBold: return "\u{fa9f}"
        case .serverErrorLight: return "\u{faa0}"
        case .serverErrorRegular: return "\u{faa1}"
        case .serverLight: return "\u{faa2}"
        case .serverRegular: return "\u{faa3}"
        case .servicesBold: return "\u{faa4}"
        case .servicesLight: return "\u{faa5}"
        case .servicesRegular: return "\u{faa6}"
        case .setVariableBold: return "\u{faa7}"
        case .setVariableLight: return "\u{faa8}"
        case .setVariableRegular: return "\u{faa9}"
        case .settingsBold: return "\u{faaa}"
        case .settingsFilled: return "\u{faab}"
        case .settingsLight: return "\u{faac}"
        case .settingsRegular: return "\u{faad}"
        case .setupAssistantBold: return "\u{faae}"
        case .setupAssistantLight: return "\u{faaf}"
        case .setupAssistantRegular: return "\u{fab0}"
        case .sftpBold: return "\u{fab1}"
        case .sftpLight: return "\u{fab2}"
        case .sftpRegular: return "\u{fab3}"
        case .shapeCircleBold: return "\u{fab4}"
        case .shapeCircleFilled: return "\u{fab5}"
        case .shapeCircleLight: return "\u{fab6}"
        case .shapeCircleMdFilled: return "\u{fab7}"
        case .shapeCircleRegular: return "\u{fab8}"
        case .shapeCircleSmFilled: return "\u{fab9}"
        case .shapeDiagonalLineBold: return "\u{faba}"
        case .shapeDiagonalLineLight: return "\u{fabb}"
        case .shapeDiagonalLineRegular: return "\u{fabc}"
        case .shapeDiamondBold: return "\u{fabd}"
        case .shapeDiamondFilled: return "\u{fabe}"
        case .shapeDiamondLight: return "\u{fabf}"
        case .shapeDiamondRegular: return "\u{fac0}"
        case .shapeOvalBold: return "\u{fac1}"
        case .shapeOvalLight: return "\u{fac2}"
        case .shapeOvalRegular: return "\u{fac3}"
        case .shapeSquareBold: return "\u{fac4}"
        case .shapeSquareFilled: return "\u{fac5}"
        case .shapeSquareLight: return "\u{fac6}"
        case .shapeSquareRegular: return "\u{fac7}"
        case .shapeTriangleBold: return "\u{fac8}"
        case .shapeTriangleFilled: return "\u{fac9}"
        case .shapeTriangleLight: return "\u{faca}"
        case .shapeTriangleRegular: return "\u{facb}"
        case .shapesBold: return "\u{facc}"
        case .shapesFilled: return "\u{facd}"
        case .shapesLight: return "\u{face}"
        case .shapesRegular: return "\u{facf}"
        case .shareCNativeAdrBold: return "\u{fad0}"
        case .shareCNativeAdrFilled: return "\u{fad1}"
        case .shareCNativeAdrLight: return "\u{fad2}"
        case .shareCNativeAdrRegular: return "\u{fad3}"
        case .shareCNativeIphBold: return "\u{fad4}"
        case .shareCNativeIphLight: return "\u{fad5}"
        case .shareCNativeIphRegular: return "\u{fad6}"
        case .shareContentOnDeviceBold: return "\u{fad7}"
        case .shareContentOnDeviceLight: return "\u{fad8}"
        case .shareContentOnDeviceRegular: return "\u{fad9}"
        case .shareScreenAddBold: return "\u{fada}"
        case .shareScreenAddLight: return "\u{fadb}"
        case .shareScreenAddRegular: return "\u{fadc}"
        case .shareScreenBadgeFilled: return "\u{fadd}"
        case .shareScreenBold: return "\u{fade}"
        case .shareScreenFilled: return "\u{fadf}"
        case .shareScreenLight: return "\u{fae0}"
        case .shareScreenRegular: return "\u{fae1}"
        case .shareSpaceBold: return "\u{fae2}"
        case .shareSpaceLight: return "\u{fae3}"
        case .shareSpaceRegular: return "\u{fae4}"
        case .shieldBold: return "\u{fae5}"
        case .shieldLight: return "\u{fae6}"
        case .shieldRegular: return "\u{fae7}"
        case .shoppingCartBold: return "\u{fae8}"
        case .shoppingCartFilled: return "\u{fae9}"
        case .shoppingCartLight: return "\u{faea}"
        case .shoppingCartRegular: return "\u{faeb}"
        case .shortTextBoxBold: return "\u{faec}"
        case .shortTextBoxLight: return "\u{faed}"
        case .shortTextBoxRegular: return "\u{faee}"
        case .showBold: return "\u{faef}"
        case .showFilled: return "\u{faf0}"
        case .showLight: return "\u{faf1}"
        case .showRegular: return "\u{faf2}"
        case .sidePanelBold: return "\u{faf3}"
        case .sidePanelFilled: return "\u{faf4}"
        case .sidePanelLight: return "\u{faf5}"
        case .sidePanelRegular: return "\u{faf6}"
        case .signInBold: return "\u{faf7}"
        case .signInFilled: return "\u{faf8}"
        case .signInForcedBold: return "\u{faf9}"
        case .signInForcedLight: return "\u{fafa}"
        case .signInForcedRegular: return "\u{fafb}"
        case .signInLight: return "\u{fafc}"
        case .signInRegular: return "\u{fafd}"
        case .signLangIntBold: return "\u{fafe}"
        case .signLangIntLight: return "\u{faff}"
        case .signLangIntRegular: return "\u{fb00}"
        case .signOutBold: return "\u{fb01}"
        case .signOutLight: return "\u{fb02}"
        case .signOutRegular: return "\u{fb03}"
        case .signalFourBold: return "\u{fb04}"
        case .signalFourLight: return "\u{fb05}"
        case .signalFourRegular: return "\u{fb06}"
        case .signalOneBold: return "\u{fb07}"
        case .signalOneLight: return "\u{fb08}"
        case .signalOneRegular: return "\u{fb09}"
        case .signalThreeBold: return "\u{fb0a}"
        case .signalThreeLight: return "\u{fb0b}"
        case .signalThreeRegular: return "\u{fb0c}"
        case .signalTwoBold: return "\u{fb0d}"
        case .signalTwoLight: return "\u{fb0e}"
        case .signalTwoRegular: return "\u{fb0f}"
        case .signalZeroBold: return "\u{fb10}"
        case .signalZeroLight: return "\u{fb11}"
        case .signalZeroRegular: return "\u{fb12}"
        case .simplePromotionBold: return "\u{fb13}"
        case .simplePromotionLight: return "\u{fb14}"
        case .simplePromotionRegular: return "\u{fb15}"
        case .singleNumberReachBold: return "\u{fb16}"
        case .singleNumberReachLight: return "\u{fb17}"
        case .singleNumberReachRegular: return "\u{fb18}"
        case .sipRegistrationInProgressBold: return "\u{fb19}"
        case .sipRegistrationInProgressFilled: return "\u{fb1a}"
        case .sipRegistrationInProgressLight: return "\u{fb1b}"
        case .sipRegistrationInProgressRegular: return "\u{fb1c}"
        case .skipBold: return "\u{fb1d}"
        case .skipBwBold: return "\u{fb1e}"
        case .skipBwFilled: return "\u{fb1f}"
        case .skipBwLight: return "\u{fb20}"
        case .skipBwRegular: return "\u{fb21}"
        case .skipFwBold: return "\u{fb22}"
        case .skipFwFilled: return "\u{fb23}"
        case .skipFwLight: return "\u{fb24}"
        case .skipFwRegular: return "\u{fb25}"
        case .skipLight: return "\u{fb26}"
        case .skipRegular: return "\u{fb27}"
        case .smartAudioBold: return "\u{fb28}"
        case .smartAudioLight: return "\u{fb29}"
        case .smartAudioRegular: return "\u{fb2a}"
        case .smartReplyBold: return "\u{fb2b}"
        case .smartReplyLight: return "\u{fb2c}"
        case .smartReplyRegular: return "\u{fb2d}"
        case .smsFilled: return "\u{fb2e}"
        case .smsInboundBold: return "\u{fb2f}"
        case .smsInboundLight: return "\u{fb30}"
        case .smsInboundRegular: return "\u{fb31}"
        case .smsMessageBold: return "\u{fb32}"
        case .smsMessageFilled: return "\u{fb33}"
        case .smsMessageLight: return "\u{fb34}"
        case .smsMessageOutgoingBold: return "\u{fb35}"
        case .smsMessageOutgoingFilled: return "\u{fb36}"
        case .smsMessageOutgoingLight: return "\u{fb37}"
        case .smsMessageOutgoingRegular: return "\u{fb38}"
        case .smsMessageRegular: return "\u{fb39}"
        case .smsMessageStartBold: return "\u{fb3a}"
        case .smsMessageStartFilled: return "\u{fb3b}"
        case .smsMessageStartLight: return "\u{fb3c}"
        case .smsMessageStartRegular: return "\u{fb3d}"
        case .smsOutgoingFilled: return "\u{fb3e}"
        case .smsUnreadBold: return "\u{fb3f}"
        case .smsUnreadLight: return "\u{fb40}"
        case .smsUnreadRegular: return "\u{fb41}"
        case .sortAscendingBold: return "\u{fb42}"
        case .sortAscendingLight: return "\u{fb43}"
        case .sortAscendingRegular: return "\u{fb44}"
        case .sortDescendingBold: return "\u{fb45}"
        case .sortDescendingLight: return "\u{fb46}"
        case .sortDescendingRegular: return "\u{fb47}"
        case .soundDefaultBold: return "\u{fb48}"
        case .soundDefaultLight: return "\u{fb49}"
        case .soundDefaultRegular: return "\u{fb4a}"
        case .sparkleBold: return "\u{fb4b}"
        case .sparkleFilled: return "\u{fb4c}"
        case .sparkleLight: return "\u{fb4d}"
        case .sparkleRegular: return "\u{fb4e}"
        case .speakerBold: return "\u{fb4f}"
        case .speakerDisconnectedBold: return "\u{fb50}"
        case .speakerDisconnectedFilled: return "\u{fb51}"
        case .speakerDisconnectedLight: return "\u{fb52}"
        case .speakerDisconnectedRegular: return "\u{fb53}"
        case .speakerFilled: return "\u{fb54}"
        case .speakerLight: return "\u{fb55}"
        case .speakerMutedBold: return "\u{fb56}"
        case .speakerMutedFilled: return "\u{fb57}"
        case .speakerMutedLight: return "\u{fb58}"
        case .speakerMutedRegular: return "\u{fb59}"
        case .speakerOffBold: return "\u{fb5a}"
        case .speakerOffFilled: return "\u{fb5b}"
        case .speakerOffLight: return "\u{fb5c}"
        case .speakerOffRegular: return "\u{fb5d}"
        case .speakerOnBold: return "\u{fb5e}"
        case .speakerOnLight: return "\u{fb5f}"
        case .speakerOnRegular: return "\u{fb60}"
        case .speakerRegular: return "\u{fb61}"
        case .speakerTurnDownBold: return "\u{fb62}"
        case .speakerTurnDownFilled: return "\u{fb63}"
        case .speakerTurnDownLight: return "\u{fb64}"
        case .speakerTurnDownRegular: return "\u{fb65}"
        case .speakerTurnUpBold: return "\u{fb66}"
        case .speakerTurnUpFilled: return "\u{fb67}"
        case .speakerTurnUpLight: return "\u{fb68}"
        case .speakerTurnUpRegular: return "\u{fb69}"
        case .speedDialBold: return "\u{fb6a}"
        case .speedDialFilled: return "\u{fb6b}"
        case .speedDialLight: return "\u{fb6c}"
        case .speedDialRegular: return "\u{fb6d}"
        case .spellCheckerBold: return "\u{fb6e}"
        case .spellCheckerLight: return "\u{fb6f}"
        case .spellCheckerRegular: return "\u{fb70}"
        case .splitViewBold: return "\u{fb71}"
        case .splitViewLight: return "\u{fb72}"
        case .splitViewRegular: return "\u{fb73}"
        case .stackedAreaChartBold: return "\u{fb74}"
        case .stackedAreaChartFilled: return "\u{fb75}"
        case .stackedAreaChartFullBold: return "\u{fb76}"
        case .stackedAreaChartFullFilled: return "\u{fb77}"
        case .stackedAreaChartFullLight: return "\u{fb78}"
        case .stackedAreaChartFullRegular: return "\u{fb79}"
        case .stackedAreaChartLight: return "\u{fb7a}"
        case .stackedAreaChartRegular: return "\u{fb7b}"
        case .stackedBarChartBold: return "\u{fb7c}"
        case .stackedBarChartFilled: return "\u{fb7d}"
        case .stackedBarChartFullBold: return "\u{fb7e}"
        case .stackedBarChartFullFilled: return "\u{fb7f}"
        case .stackedBarChartFullLight: return "\u{fb80}"
        case .stackedBarChartFullRegular: return "\u{fb81}"
        case .stackedBarChartLight: return "\u{fb82}"
        case .stackedBarChartRegular: return "\u{fb83}"
        case .startChatBold: return "\u{fb84}"
        case .startChatLight: return "\u{fb85}"
        case .startChatRegular: return "\u{fb86}"
        case .stethoscopeBold: return "\u{fb87}"
        case .stethoscopeLight: return "\u{fb88}"
        case .stethoscopeRegular: return "\u{fb89}"
        case .stickersBold: return "\u{fb8a}"
        case .stickersLight: return "\u{fb8b}"
        case .stickersRegular: return "\u{fb8c}"
        case .stickiesBold: return "\u{fb8d}"
        case .stickiesLight: return "\u{fb8e}"
        case .stickiesRegular: return "\u{fb8f}"
        case .stopBold: return "\u{fb90}"
        case .stopCircleBold: return "\u{fb91}"
        case .stopCircleFilled: return "\u{fb92}"
        case .stopCircleLight: return "\u{fb93}"
        case .stopCircleRegular: return "\u{fb94}"
        case .stopContentShareBold: return "\u{fb95}"
        case .stopContentShareLight: return "\u{fb96}"
        case .stopContentShareRegular: return "\u{fb97}"
        case .stopFilled: return "\u{fb98}"
        case .stopLight: return "\u{fb99}"
        case .stopRegular: return "\u{fb9a}"
        case .storedInfoBold: return "\u{fb9b}"
        case .storedInfoFilled: return "\u{fb9c}"
        case .storedInfoLight: return "\u{fb9d}"
        case .storedInfoRegular: return "\u{fb9e}"
        case .streamingBold: return "\u{fb9f}"
        case .streamingLight: return "\u{fba0}"
        case .streamingRegular: return "\u{fba1}"
        case .strikethroughBold: return "\u{fba2}"
        case .strikethroughFilled: return "\u{fba3}"
        case .strikethroughLight: return "\u{fba4}"
        case .strikethroughRegular: return "\u{fba5}"
        case .studioModeBold: return "\u{fba6}"
        case .studioModeLight: return "\u{fba7}"
        case .studioModeRegular: return "\u{fba8}"
        case .subscriptBold: return "\u{fba9}"
        case .subscriptLight: return "\u{fbaa}"
        case .subscriptRegular: return "\u{fbab}"
        case .summarizeAiBold: return "\u{fbac}"
        case .summarizeAiLight: return "\u{fbad}"
        case .summarizeAiRegular: return "\u{fbae}"
        case .superscriptBold: return "\u{fbaf}"
        case .superscriptLight: return "\u{fbb0}"
        case .superscriptRegular: return "\u{fbb1}"
        case .surveyBold: return "\u{fbb2}"
        case .surveyFilled: return "\u{fbb3}"
        case .surveyLight: return "\u{fbb4}"
        case .surveyRegular: return "\u{fbb5}"
        case .sxEightyCodecBold: return "\u{fbb6}"
        case .sxEightyCodecLight: return "\u{fbb7}"
        case .sxEightyCodecRegular: return "\u{fbb8}"
        case .sxTenBold: return "\u{fbb9}"
        case .sxTenLight: return "\u{fbba}"
        case .sxTenRegular: return "\u{fbbb}"
        case .sxTwentyBold: return "\u{fbbc}"
        case .sxTwentyLight: return "\u{fbbd}"
        case .sxTwentyRegular: return "\u{fbbe}"
        case .tableBold: return "\u{fbbf}"
        case .tableExtenderBold: return "\u{fbc0}"
        case .tableExtenderFilled: return "\u{fbc1}"
        case .tableExtenderLight: return "\u{fbc2}"
        case .tableExtenderRegular: return "\u{fbc3}"
        case .tableLight: return "\u{fbc4}"
        case .tableRegular: return "\u{fbc5}"
        case .tabletBold: return "\u{fbc6}"
        case .tabletLight: return "\u{fbc7}"
        case .tabletRegular: return "\u{fbc8}"
        case .tabsBold: return "\u{fbc9}"
        case .tabsLight: return "\u{fbca}"
        case .tabsRegular: return "\u{fbcb}"
        case .tagBold: return "\u{fbcc}"
        case .tagLight: return "\u{fbcd}"
        case .tagRegular: return "\u{fbce}"
        case .tapBold: return "\u{fbcf}"
        case .tapFilled: return "\u{fbd0}"
        case .tapLight: return "\u{fbd1}"
        case .tapRegular: return "\u{fbd2}"
        case .telepresenceAlertBold: return "\u{fbd3}"
        case .telepresenceAlertLight: return "\u{fbd4}"
        case .telepresenceAlertMutedBold: return "\u{fbd5}"
        case .telepresenceAlertMutedLight: return "\u{fbd6}"
        case .telepresenceAlertMutedRegular: return "\u{fbd7}"
        case .telepresenceAlertRegular: return "\u{fbd8}"
        case .telepresenceBold: return "\u{fbd9}"
        case .telepresenceIxFiveThousandBold: return "\u{fbda}"
        case .telepresenceIxFiveThousandLight: return "\u{fbdb}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbdc}"
        case .telepresenceLight: return "\u{fbdd}"
        case .telepresenceMutedBold: return "\u{fbde}"
        case .telepresenceMutedLight: return "\u{fbdf}"
        case .telepresenceMutedRegular: return "\u{fbe0}"
        case .telepresencePrivateBold: return "\u{fbe1}"
        case .telepresencePrivateLight: return "\u{fbe2}"
        case .telepresencePrivateRegular: return "\u{fbe3}"
        case .telepresenceRegular: return "\u{fbe4}"
        case .temperatureBold: return "\u{fbe5}"
        case .temperatureLight: return "\u{fbe6}"
        case .temperatureRegular: return "\u{fbe7}"
        case .testTubeBold: return "\u{fbe8}"
        case .testTubeFilled: return "\u{fbe9}"
        case .testTubeLight: return "\u{fbea}"
        case .testTubeRegular: return "\u{fbeb}"
        case .textAlignCenterBold: return "\u{fbec}"
        case .textAlignCenterFilled: return "\u{fbed}"
        case .textAlignCenterLight: return "\u{fbee}"
        case .textAlignCenterRegular: return "\u{fbef}"
        case .textAlignLeftBold: return "\u{fbf0}"
        case .textAlignLeftFilled: return "\u{fbf1}"
        case .textAlignLeftLight: return "\u{fbf2}"
        case .textAlignLeftRegular: return "\u{fbf3}"
        case .textAlignRightBold: return "\u{fbf4}"
        case .textAlignRightFilled: return "\u{fbf5}"
        case .textAlignRightLight: return "\u{fbf6}"
        case .textAlignRightRegular: return "\u{fbf7}"
        case .textBold: return "\u{fbf8}"
        case .textBoxCursorLight: return "\u{fbf9}"
        case .textCodeBlockBold: return "\u{fbfa}"
        case .textCodeBlockLight: return "\u{fbfb}"
        case .textCodeBlockRegular: return "\u{fbfc}"
        case .textHighlightBold: return "\u{fbfd}"
        case .textHighlightFilled: return "\u{fbfe}"
        case .textHighlightLight: return "\u{fbff}"
        case .textHighlightRegular: return "\u{fc00}"
        case .textLight: return "\u{fc01}"
        case .textRegular: return "\u{fc02}"
        case .threeColumnBold: return "\u{fc03}"
        case .threeColumnLight: return "\u{fc04}"
        case .threeColumnRegular: return "\u{fc05}"
        case .threeDObjectBold: return "\u{fc06}"
        case .threeDObjectLight: return "\u{fc07}"
        case .threeDObjectRegular: return "\u{fc08}"
        case .timeExclusionBold: return "\u{fc09}"
        case .timeExclusionLight: return "\u{fc0a}"
        case .timeExclusionRegular: return "\u{fc0b}"
        case .timezoneBold: return "\u{fc0c}"
        case .timezoneFilled: return "\u{fc0d}"
        case .timezoneLight: return "\u{fc0e}"
        case .timezoneRegular: return "\u{fc0f}"
        case .tooFastBold: return "\u{fc10}"
        case .tooFastLight: return "\u{fc11}"
        case .tooFastRegular: return "\u{fc12}"
        case .tooSlowBold: return "\u{fc13}"
        case .tooSlowLight: return "\u{fc14}"
        case .tooSlowRegular: return "\u{fc15}"
        case .toolsBold: return "\u{fc16}"
        case .toolsFilled: return "\u{fc17}"
        case .toolsLight: return "\u{fc18}"
        case .toolsRegular: return "\u{fc19}"
        case .touchTenBold: return "\u{fc1a}"
        case .touchTenLight: return "\u{fc1b}"
        case .touchTenRegular: return "\u{fc1c}"
        case .transcriptBold: return "\u{fc1d}"
        case .transcriptFilled: return "\u{fc1e}"
        case .transcriptLight: return "\u{fc1f}"
        case .transcriptRegular: return "\u{fc20}"
        case .translateBold: return "\u{fc21}"
        case .translateLight: return "\u{fc22}"
        case .translateRegular: return "\u{fc23}"
        case .translateUndoBold: return "\u{fc24}"
        case .translateUndoLight: return "\u{fc25}"
        case .translateUndoRegular: return "\u{fc26}"
        case .trendingBold: return "\u{fc27}"
        case .trendingDownBold: return "\u{fc28}"
        case .trendingDownFilled: return "\u{fc29}"
        case .trendingDownLight: return "\u{fc2a}"
        case .trendingDownRegular: return "\u{fc2b}"
        case .trendingFilled: return "\u{fc2c}"
        case .trendingLight: return "\u{fc2d}"
        case .trendingRegular: return "\u{fc2e}"
        case .trimBold: return "\u{fc2f}"
        case .trimLight: return "\u{fc30}"
        case .trimRegular: return "\u{fc31}"
        case .twoColumnBold: return "\u{fc32}"
        case .twoColumnLight: return "\u{fc33}"
        case .twoColumnRegular: return "\u{fc34}"
        case .twoWayVoiceStreamBold: return "\u{fc35}"
        case .twoWayVoiceStreamFilled: return "\u{fc36}"
        case .twoWayVoiceStreamLight: return "\u{fc37}"
        case .twoWayVoiceStreamRegular: return "\u{fc38}"
        case .ucmCloudBold: return "\u{fc39}"
        case .ucmCloudLight: return "\u{fc3a}"
        case .ucmCloudRegular: return "\u{fc3b}"
        case .unblockBold: return "\u{fc3c}"
        case .unblockFilled: return "\u{fc3d}"
        case .unblockLight: return "\u{fc3e}"
        case .unblockRegular: return "\u{fc3f}"
        case .underlineBold: return "\u{fc40}"
        case .underlineFilled: return "\u{fc41}"
        case .underlineLight: return "\u{fc42}"
        case .underlineRegular: return "\u{fc43}"
        case .undoBold: return "\u{fc44}"
        case .undoLight: return "\u{fc45}"
        case .undoRegular: return "\u{fc46}"
        case .unlinkBold: return "\u{fc47}"
        case .unlinkLight: return "\u{fc48}"
        case .unlinkRegular: return "\u{fc49}"
        case .unreadBold: return "\u{fc4a}"
        case .unreadFilled: return "\u{fc4b}"
        case .unreadLight: return "\u{fc4c}"
        case .unreadRegular: return "\u{fc4d}"
        case .unsecureUnlockedBold: return "\u{fc4e}"
        case .unsecureUnlockedFilled: return "\u{fc4f}"
        case .unsecureUnlockedLight: return "\u{fc50}"
        case .unsecureUnlockedRegular: return "\u{fc51}"
        case .unsortedBold: return "\u{fc52}"
        case .unsortedLight: return "\u{fc53}"
        case .unsortedRegular: return "\u{fc54}"
        case .updateFileShareBold: return "\u{fc55}"
        case .updateFileShareLight: return "\u{fc56}"
        case .updateFileShareRegular: return "\u{fc57}"
        case .uploadBold: return "\u{fc58}"
        case .uploadImageBold: return "\u{fc59}"
        case .uploadImageLight: return "\u{fc5a}"
        case .uploadImageRegular: return "\u{fc5b}"
        case .uploadLight: return "\u{fc5c}"
        case .uploadRegular: return "\u{fc5d}"
        case .urgentVoicemailBold: return "\u{fc5e}"
        case .urgentVoicemailFilled: return "\u{fc5f}"
        case .usbBold: return "\u{fc60}"
        case .usbHeadsetBold: return "\u{fc61}"
        case .usbHeadsetLight: return "\u{fc62}"
        case .usbHeadsetMutedBold: return "\u{fc63}"
        case .usbHeadsetMutedLight: return "\u{fc64}"
        case .usbHeadsetMutedRegular: return "\u{fc65}"
        case .usbHeadsetRegular: return "\u{fc66}"
        case .usbLight: return "\u{fc67}"
        case .usbRegular: return "\u{fc68}"
        case .userBold: return "\u{fc69}"
        case .userDeactivateBold: return "\u{fc6a}"
        case .userDeactivateLight: return "\u{fc6b}"
        case .userDeactivateRegular: return "\u{fc6c}"
        case .userFilled: return "\u{fc6d}"
        case .userLight: return "\u{fc6e}"
        case .userRegular: return "\u{fc6f}"
        case .videoBlurBold: return "\u{fc70}"
        case .videoBlurFilled: return "\u{fc71}"
        case .videoBlurLight: return "\u{fc72}"
        case .videoBlurRegular: return "\u{fc73}"
        case .videoBold: return "\u{fc74}"
        case .videoEffectBold: return "\u{fc75}"
        case .videoEffectFilled: return "\u{fc76}"
        case .videoEffectLight: return "\u{fc77}"
        case .videoEffectRegular: return "\u{fc78}"
        case .videoFilled: return "\u{fc79}"
        case .videoLayoutBold: return "\u{fc7a}"
        case .videoLayoutCustomBold: return "\u{fc7b}"
        case .videoLayoutCustomFilled: return "\u{fc7c}"
        case .videoLayoutCustomLight: return "\u{fc7d}"
        case .videoLayoutCustomRegular: return "\u{fc7e}"
        case .videoLayoutEqualBold: return "\u{fc7f}"
        case .videoLayoutEqualDualBold: return "\u{fc80}"
        case .videoLayoutEqualDualLight: return "\u{fc81}"
        case .videoLayoutEqualDualRegular: return "\u{fc82}"
        case .videoLayoutEqualFilled: return "\u{fc83}"
        case .videoLayoutEqualLight: return "\u{fc84}"
        case .videoLayoutEqualRegular: return "\u{fc85}"
        case .videoLayoutFilled: return "\u{fc86}"
        case .videoLayoutLight: return "\u{fc87}"
        case .videoLayoutOverlayBold: return "\u{fc88}"
        case .videoLayoutOverlayFilled: return "\u{fc89}"
        case .videoLayoutOverlayLight: return "\u{fc8a}"
        case .videoLayoutOverlayRegular: return "\u{fc8b}"
        case .videoLayoutPresentationBold: return "\u{fc8c}"
        case .videoLayoutPresentationFilled: return "\u{fc8d}"
        case .videoLayoutPresentationLight: return "\u{fc8e}"
        case .videoLayoutPresentationRegular: return "\u{fc8f}"
        case .videoLayoutPresenterDominantBold: return "\u{fc90}"
        case .videoLayoutPresenterDominantLight: return "\u{fc91}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc92}"
        case .videoLayoutProminentBold: return "\u{fc93}"
        case .videoLayoutProminentFilled: return "\u{fc94}"
        case .videoLayoutProminentLight: return "\u{fc95}"
        case .videoLayoutProminentRegular: return "\u{fc96}"
        case .videoLayoutRegular: return "\u{fc97}"
        case .videoLayoutShareDominantBold: return "\u{fc98}"
        case .videoLayoutShareDominantLight: return "\u{fc99}"
        case .videoLayoutShareDominantRegular: return "\u{fc9a}"
        case .videoLayoutSingleBold: return "\u{fc9b}"
        case .videoLayoutSingleFilled: return "\u{fc9c}"
        case .videoLayoutSingleLight: return "\u{fc9d}"
        case .videoLayoutSingleRegular: return "\u{fc9e}"
        case .videoLayoutSpeakerBold: return "\u{fc9f}"
        case .videoLayoutSpeakerFilled: return "\u{fca0}"
        case .videoLayoutSpeakerLight: return "\u{fca1}"
        case .videoLayoutSpeakerRegular: return "\u{fca2}"
        case .videoLayoutStackBold: return "\u{fca3}"
        case .videoLayoutStackFilled: return "\u{fca4}"
        case .videoLayoutStackLight: return "\u{fca5}"
        case .videoLayoutStackRegular: return "\u{fca6}"
        case .videoLayoutVideoDominantBold: return "\u{fca7}"
        case .videoLayoutVideoDominantFilled: return "\u{fca8}"
        case .videoLayoutVideoDominantLight: return "\u{fca9}"
        case .videoLayoutVideoDominantRegular: return "\u{fcaa}"
        case .videoLight: return "\u{fcab}"
        case .videoPlusBold: return "\u{fcac}"
        case .videoPlusFilled: return "\u{fcad}"
        case .videoPlusLight: return "\u{fcae}"
        case .videoPlusRegular: return "\u{fcaf}"
        case .videoRegular: return "\u{fcb0}"
        case .videoSpeakerTrackBold: return "\u{fcb1}"
        case .videoSpeakerTrackFilled: return "\u{fcb2}"
        case .videoSpeakerTrackLight: return "\u{fcb3}"
        case .videoSpeakerTrackRegular: return "\u{fcb4}"
        case .viewAllBold: return "\u{fcb5}"
        case .viewAllLight: return "\u{fcb6}"
        case .viewAllRegular: return "\u{fcb7}"
        case .viewListBold: return "\u{fcb8}"
        case .viewListFilled: return "\u{fcb9}"
        case .viewListLight: return "\u{fcba}"
        case .viewListRegular: return "\u{fcbb}"
        case .viewStackedBold: return "\u{fcbc}"
        case .viewStackedFilled: return "\u{fcbd}"
        case .viewStackedLight: return "\u{fcbe}"
        case .viewStackedRegular: return "\u{fcbf}"
        case .viewThumbnailBold: return "\u{fcc0}"
        case .viewThumbnailFilled: return "\u{fcc1}"
        case .viewThumbnailLight: return "\u{fcc2}"
        case .viewThumbnailRegular: return "\u{fcc3}"
        case .visionproBold: return "\u{fcc4}"
        case .visionproFilled: return "\u{fcc5}"
        case .visionproLight: return "\u{fcc6}"
        case .visionproMoveCallInBold: return "\u{fcc7}"
        case .visionproMoveCallInFilled: return "\u{fcc8}"
        case .visionproMoveCallInLight: return "\u{fcc9}"
        case .visionproMoveCallInOutBold: return "\u{fcca}"
        case .visionproMoveCallInOutFilled: return "\u{fccb}"
        case .visionproMoveCallInOutLight: return "\u{fccc}"
        case .visionproMoveCallInOutRegular: return "\u{fccd}"
        case .visionproMoveCallInRegular: return "\u{fcce}"
        case .visionproMoveCallOutBold: return "\u{fccf}"
        case .visionproMoveCallOutFilled: return "\u{fcd0}"
        case .visionproMoveCallOutLight: return "\u{fcd1}"
        case .visionproMoveCallOutRegular: return "\u{fcd2}"
        case .visionproRegular: return "\u{fcd3}"
        case .voicemailBold: return "\u{fcd4}"
        case .voicemailFilled: return "\u{fcd5}"
        case .voicemailLight: return "\u{fcd6}"
        case .voicemailRegular: return "\u{fcd7}"
        case .vpnBold: return "\u{fcd8}"
        case .vpnFilled: return "\u{fcd9}"
        case .vpnLight: return "\u{fcda}"
        case .vpnRegular: return "\u{fcdb}"
        case .vscBold: return "\u{fcdc}"
        case .vscLight: return "\u{fcdd}"
        case .vscRegular: return "\u{fcde}"
        case .waffleMenuBold: return "\u{fcdf}"
        case .waffleMenuLight: return "\u{fce0}"
        case .waffleMenuRegular: return "\u{fce1}"
        case .waitingRoomBold: return "\u{fce2}"
        case .waitingRoomLight: return "\u{fce3}"
        case .waitingRoomRegular: return "\u{fce4}"
        case .wallpaperBold: return "\u{fce5}"
        case .wallpaperLight: return "\u{fce6}"
        case .wallpaperRegular: return "\u{fce7}"
        case .warningBadgeFilled: return "\u{fce8}"
        case .warningBold: return "\u{fce9}"
        case .warningFilled: return "\u{fcea}"
        case .warningLight: return "\u{fceb}"
        case .warningRegular: return "\u{fcec}"
        case .webexBoardBold: return "\u{fced}"
        case .webexBoardLight: return "\u{fcee}"
        case .webexBoardRegular: return "\u{fcef}"
        case .webexCodecPlusBold: return "\u{fcf0}"
        case .webexCodecPlusLight: return "\u{fcf1}"
        case .webexCodecPlusRegular: return "\u{fcf2}"
        case .webexDeskCameraBold: return "\u{fcf3}"
        case .webexDeskCameraLight: return "\u{fcf4}"
        case .webexDeskCameraRegular: return "\u{fcf5}"
        case .webexHelixBold: return "\u{fcf6}"
        case .webexHelixLight: return "\u{fcf7}"
        case .webexHelixRegular: return "\u{fcf8}"
        case .webexMeetingsBold: return "\u{fcf9}"
        case .webexMeetingsFilled: return "\u{fcfa}"
        case .webexMeetingsLight: return "\u{fcfb}"
        case .webexMeetingsRegular: return "\u{fcfc}"
        case .webexQuadCameraBold: return "\u{fcfd}"
        case .webexQuadCameraLight: return "\u{fcfe}"
        case .webexQuadCameraRegular: return "\u{fcff}"
        case .webexRoomKitBold: return "\u{fd00}"
        case .webexRoomKitLight: return "\u{fd01}"
        case .webexRoomKitPlusBold: return "\u{fd02}"
        case .webexRoomKitPlusLight: return "\u{fd03}"
        case .webexRoomKitPlusRegular: return "\u{fd04}"
        case .webexRoomKitRegular: return "\u{fd05}"
        case .webexShareBold: return "\u{fd06}"
        case .webexShareLight: return "\u{fd07}"
        case .webexShareRegular: return "\u{fd08}"
        case .webexTeamsBold: return "\u{fd09}"
        case .webexTeamsFilled: return "\u{fd0a}"
        case .webexTeamsLight: return "\u{fd0b}"
        case .webexTeamsNewBold: return "\u{fd0c}"
        case .webexTeamsNewFilled: return "\u{fd0d}"
        case .webexTeamsNewLight: return "\u{fd0e}"
        case .webexTeamsNewRegular: return "\u{fd0f}"
        case .webexTeamsRegular: return "\u{fd10}"
        case .webexTeamsRemoveBold: return "\u{fd11}"
        case .webexTeamsRemoveLight: return "\u{fd12}"
        case .webexTeamsRemoveRegular: return "\u{fd13}"
        case .webhookBold: return "\u{fd14}"
        case .webhookLight: return "\u{fd15}"
        case .webhookRegular: return "\u{fd16}"
        case .webinarBold: return "\u{fd17}"
        case .webinarFilled: return "\u{fd18}"
        case .webinarLight: return "\u{fd19}"
        case .webinarRegular: return "\u{fd1a}"
        case .weeklyRecurringScheduleBold: return "\u{fd1b}"
        case .weeklyRecurringScheduleLight: return "\u{fd1c}"
        case .weeklyRecurringScheduleRegular: return "\u{fd1d}"
        case .whisperAnnouncementBold: return "\u{fd1e}"
        case .whisperAnnouncementFilled: return "\u{fd1f}"
        case .whisperAnnouncementLight: return "\u{fd20}"
        case .whisperAnnouncementRegular: return "\u{fd21}"
        case .whisperCoachBold: return "\u{fd22}"
        case .whisperCoachFilled: return "\u{fd23}"
        case .whisperCoachLight: return "\u{fd24}"
        case .whisperCoachRegular: return "\u{fd25}"
        case .whiteboardBold: return "\u{fd26}"
        case .whiteboardContentBold: return "\u{fd27}"
        case .whiteboardContentFilled: return "\u{fd28}"
        case .whiteboardContentLight: return "\u{fd29}"
        case .whiteboardContentRegular: return "\u{fd2a}"
        case .whiteboardFilled: return "\u{fd2b}"
        case .whiteboardLight: return "\u{fd2c}"
        case .whiteboardRegular: return "\u{fd2d}"
        case .widgetBold: return "\u{fd2e}"
        case .widgetFilled: return "\u{fd2f}"
        case .widgetLight: return "\u{fd30}"
        case .widgetRegular: return "\u{fd31}"
        case .wifiBold: return "\u{fd32}"
        case .wifiErrorBold: return "\u{fd33}"
        case .wifiErrorLight: return "\u{fd34}"
        case .wifiErrorRegular: return "\u{fd35}"
        case .wifiLight: return "\u{fd36}"
        case .wifiRegular: return "\u{fd37}"
        case .wifiSignalGoodBold: return "\u{fd38}"
        case .wifiSignalGoodLight: return "\u{fd39}"
        case .wifiSignalGoodRegular: return "\u{fd3a}"
        case .wifiSignalPoorBold: return "\u{fd3b}"
        case .wifiSignalPoorLight: return "\u{fd3c}"
        case .wifiSignalPoorRegular: return "\u{fd3d}"
        case .wifiSignalUnstableBold: return "\u{fd3e}"
        case .wifiSignalUnstableLight: return "\u{fd3f}"
        case .wifiSignalUnstableRegular: return "\u{fd40}"
        case .windowCornerScrubBold: return "\u{fd41}"
        case .windowCornerScrubLight: return "\u{fd42}"
        case .windowCornerScrubRegular: return "\u{fd43}"
        case .windowRightCornerScrubBold: return "\u{fd44}"
        case .windowRightCornerScrubLight: return "\u{fd45}"
        case .windowRightCornerScrubRegular: return "\u{fd46}"
        case .windowVerticalScrubBold: return "\u{fd47}"
        case .windowVerticalScrubLight: return "\u{fd48}"
        case .windowVerticalScrubRegular: return "\u{fd49}"
        case .workflowDeploymentsBold: return "\u{fd4a}"
        case .workflowDeploymentsFilled: return "\u{fd4b}"
        case .workflowDeploymentsLight: return "\u{fd4c}"
        case .workflowDeploymentsRegular: return "\u{fd4d}"
        case .workphoneBold: return "\u{fd4e}"
        case .workphoneLight: return "\u{fd4f}"
        case .workphoneRegular: return "\u{fd50}"
        case .zoomInBold: return "\u{fd51}"
        case .zoomInLight: return "\u{fd52}"
        case .zoomInRegular: return "\u{fd53}"
        case .zoomOutBold: return "\u{fd54}"
        case .zoomOutLight: return "\u{fd55}"
        case .zoomOutRegular: return "\u{fd56}"
