...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .cancelFilled: return "\u{f323}"
        case .cancelLight: return "\u{f324}"
        case .cancelRegular: return "\u{f325}"
        case .capsLockBold: return "\u{f326}"
        case .capsLockLight: return "\u{f327}"
        case .capsLockRegular: return "\u{f328}"
        case .captureRewindBold: return "\u{f329}"
        case .captureRewindLight: return "\u{f32a}"
        case .captureRewindRegular: return "\u{f32b}"
        case .caroselBold: return "\u{f32c}"
        case .caroselLight: return "\u{f32d}"
        case .caroselRegular: return "\u{f32e}"
        case .carouselTextBold: return "\u{f32f}"
        case .carouselTextLight: return "\u{f330}"
        case .carouselTextRegular: return "\u{f331}"
        case .cellularBold: return "\u{f332}"
        case .cellularLight: return "\u{f333}"
        case .cellularRegular: return "\u{f334}"
        case .centerAlignedBold: return "\u{f335}"
        case .centerAlignedLight: return "\u{f336}"
        case .centerAlignedRegular: return "\u{f337}"
        case .centerBold: return "\u{f338}"
        case .centerLight: return "\u{f339}"
        case .centerRegular: return "\u{f33a}"
        case .certificateBold: return "\u{f33b}"
        case .certificateInvalidBold: return "\u{f33c}"
        case .certificateInvalidLight: return "\u{f33d}"
        case .certificateInvalidRegular: return "\u{f33e}"
        case .certificateLight: return "\u{f33f}"
        case .certificateRegular: return "\u{f340}"
        case .certifiedBold: return "\u{f341}"
        case .certifiedFilled: return "\u{f342}"
        case .certifiedLight: return "\u{f343}"
        case .certifiedRegular: return "\u{f344}"
        case .chPSearchBold: return "\u{f345}"
        case .chPSearchLight: return "\u{f346}"
        case .chPSearchRegular: return "\u{f347}"
        case .channelUssdBold: return "\u{f348}"
        case .channelUssdLight: return "\u{f349}"
        case .channelUssdRegular: return "\u{f34a}"
        case .chatBold: return "\u{f34b}"
        case .chatFilled: return "\u{f34c}"
        case .chatGroupBold: return "\u{f34d}"
        case .chatGroupFilled: return "\u{f34e}"
        case .chatGroupLight: return "\u{f34f}"
        case .chatGroupRegular: return "\u{f350}"
        case .chatLight: return "\u{f351}"
        case .chatMuteBold: return "\u{f352}"
        case .chatMuteLight: return "\u{f353}"
        case .chatMuteRegular: return "\u{f354}"
        case .chatOutboundFilled: return "\u{f355}"
        case .chatRegular: return "\u{f356}"
        case .checkBold: return "\u{f357}"
        case .checkCircleBadgeFilled: return "\u{f358}"
        case .checkCircleBold: return "\u{f359}"
        case .checkCircleFilled: return "\u{f35a}"
        case .checkCircleLight: return "\u{f35b}"
        case .checkCircleRegular: return "\u{f35c}"
        case .checkFilled: return "\u{f35d}"
        case .checkLight: return "\u{f35e}"
        case .checkRegular: return "\u{f35f}"
        case .checkboxGroupBold: return "\u{f360}"
        case .checkboxGroupFilled: return "\u{f361}"
        case .checkboxGroupLight: return "\u{f362}"
        case .checkboxGroupRegular: return "\u{f363}"
        case .cleanUpBold: return "\u{f364}"
        case .cleanUpLight: return "\u{f365}"
        case .cleanUpRegular: return "\u{f366}"
        case .clearBadgeFilled: return "\u{f367}"
        case .clearBold: return "\u{f368}"
        case .clearFilled: return "\u{f369}"
        case .clearLight: return "\u{f36a}"
        case .clearRegular: return "\u{f36b}"
        case .closeSpaceBold: return "\u{f36c}"
        case .closeSpaceLight: return "\u{f36d}"
        case .closeSpaceRegular: return "\u{f36e}"
        case .closedCaptionBadgeBold: return "\u{f36f}"
        case .closedCaptionBadgeFilled: return "\u{f370}"
        case .closedCaptionBadgeLight: return "\u{f371}"
        case .closedCaptionBadgeRegular: return "\u{f372}"
        case .closedCaptionsBold: return "\u{f373}"
        case .closedCaptionsFilled: return "\u{f374}"
        case .closedCaptionsLight: return "\u{f375}"
        case .closedCaptionsRegular: return "\u{f376}"
        case .cloudBold: return "\u{f377}"
        case .cloudDownloadBold: return "\u{f378}"
        case .cloudDownloadLight: return "\u{f379}"
        case .cloudDownloadRegular: return "\u{f37a}"
        case .cloudFilled: return "\u{f37b}"
        case .cloudFrameBold: return "\u{f37c}"
        case .cloudFrameFilled: return "\u{f37d}"
        case .cloudFrameLight: return "\u{f37e}"
        case .cloudFrameRegular: return "\u{f37f}"
        case .cloudLight: return "\u{f380}"
        case .cloudMutedBold: return "\u{f381}"
        case .cloudMutedFilled: return "\u{f382}"
        case .cloudMutedLight: return "\u{f383}"
        case .cloudMutedRegular: return "\u{f384}"
        case .cloudRegular: return "\u{f385}"
        case .cloudUploadBold: return "\u{f386}"
        case .cloudUploadLight: return "\u{f387}"
        case .cloudUploadRegular: return "\u{f388}"
        case .codeBlockBold: return "\u{f389}"
        case .codeBlockLight: return "\u{f38a}"
        case .codeBlockRegular: return "\u{f38b}"
        case .coffeeBold: return "\u{f38c}"
        case .coffeeLight: return "\u{f38d}"
        case .coffeeRegular: return "\u{f38e}"
        case .colorBold: return "\u{f38f}"
        case .colorFilled: return "\u{f390}"
        case .colorLight: return "\u{f391}"
        case .colorRegular: return "\u{f392}"
        case .colourPaletteBold: return "\u{f393}"
        case .colourPaletteFilled: return "\u{f394}"
        case .colourPaletteLight: return "\u{f395}"
        case .colourPaletteRegular: return "\u{f396}"
        case .commentingBold: return "\u{f397}"
        case .commentingFilled: return "\u{f398}"
        case .commentingLight: return "\u{f399}"
        case .commentingRegular: return "\u{f39a}"
        case .companyBold: return "\u{f39b}"
        case .companyLight: return "\u{f39c}"
        case .companyRegular: return "\u{f39d}"
        case .completedByBaseBold: return "\u{f39e}"
        case .completedByBaseLight: return "\u{f39f}"
        case .completedByBaseRegular: return "\u{f3a0}"
        case .completedByTimeBold: return "\u{f3a1}"
        case .completedByTimeLight: return "\u{f3a2}"
        case .completedByTimeRegular: return "\u{f3a3}"
        case .completedInteractionBold: return "\u{f3a4}"
        case .completedInteractionFilled: return "\u{f3a5}"
        case .completedInteractionLight: return "\u{f3a6}"
        case .completedInteractionRegular: return "\u{f3a7}"
        case .computerBold: return "\u{f3a8}"
        case .computerLight: return "\u{f3a9}"
        case .computerRegular: return "\u{f3aa}"
        case .conciergeBold: return "\u{f3ab}"
        case .conciergeLight: return "\u{f3ac}"
        case .conciergeRegular: return "\u{f3ad}"
        case .conditionalBlockBold: return "\u{f3ae}"
        case .conditionalBlockLight: return "\u{f3af}"
        case .conditionalBlockRegular: return "\u{f3b0}"
        case .connectBold: return "\u{f3b1}"
        case .connectLight: return "\u{f3b2}"
        case .connectRegular: return "\u{f3b3}"
        case .contactCardBold: return "\u{f3b4}"
        case .contactCardFilled: return "\u{f3b5}"
        case .contactCardLight: return "\u{f3b6}"
        case .contactCardRegular: return "\u{f3b7}"
        case .contactsBold: return "\u{f3b8}"
        case .contactsFilled: return "\u{f3b9}"
        case .contactsLight: return "\u{f3ba}"
        case .contactsRegular: return "\u{f3bb}"
        case .contentDownloadBold: return "\u{f3bc}"
        case .contentDownloadFilled: return "\u{f3bd}"
        case .contentDownloadLight: return "\u{f3be}"
        case .contentDownloadRegular: return "\u{f3bf}"
        case .contentShareBold: return "\u{f3c0}"
        case .contentShareLight: return "\u{f3c1}"
        case .contentShareRegular: return "\u{f3c2}"
        case .contrastBold: return "\u{f3c3}"
        case .contrastLight: return "\u{f3c4}"
        case .contrastRegular: return "\u{f3c5}"
        case .copyBold: return "\u{f3c6}"
        case .copyLight: return "\u{f3c7}"
        case .copyRegular: return "\u{f3c8}"
        case .cpuBold: return "\u{f3c9}"
        case .cpuLight: return "\u{f3ca}"
        case .cpuRegular: return "\u{f3cb}"
        case .createAGroupBold: return "\u{f3cc}"
        case .createAGroupFilled: return "\u{f3cd}"
        case .createAGroupLight: return "\u{f3ce}"
        case .createAGroupRegular: return "\u{f3cf}"
        case .cropBold: return "\u{f3d0}"
        case .cropLight: return "\u{f3d1}"
        case .cropRegular: return "\u{f3d2}"
        case .cucmConnectionBold: return "\u{f3d3}"
        case .cucmConnectionLight: return "\u{f3d4}"
        case .cucmConnectionRegular: return "\u{f3d5}"
        case .customCodeEditorBold: return "\u{f3d6}"
        case .customCodeEditorLight: return "\u{f3d7}"
        case .customCodeEditorRegular: return "\u{f3d8}"
        case .customTaskBold: return "\u{f3d9}"
        case .customTaskFilled: return "\u{f3da}"
        case .customTaskLight: return "\u{f3db}"
        case .customTaskRegular: return "\u{f3dc}"
        case .dailyRecurringScheduleBold: return "\u{f3dd}"
        case .dailyRecurringScheduleLight: return "\u{f3de}"
        case .dailyRecurringScheduleRegular: return "\u{f3df}"
        case .dashboardBold: return "\u{f3e0}"
        case .dashboardFilled: return "\u{f3e1}"
        case .dashboardLight: return "\u{f3e2}"
        case .dashboardRegular: return "\u{f3e3}"
        case .dataManagementBold: return "\u{f3e4}"
        case .dataManagementFilled: return "\u{f3e5}"
        case .dataManagementLight: return "\u{f3e6}"
        case .dataManagementRegular: return "\u{f3e7}"
        case .dataRangeSelectionBold: return "\u{f3e8}"
        case .dataRangeSelectionFilled: return "\u{f3e9}"
        case .dataRangeSelectionLight: return "\u{f3ea}"
        case .dataRangeSelectionRegular: return "\u{f3eb}"
        case .declineBold: return "\u{f3ec}"
        case .declineFilled: return "\u{f3ed}"
        case .declineLight: return "\u{f3ee}"
        case .declineRegular: return "\u{f3ef}"
        case .dectHandsetBold: return "\u{f3f0}"
        case .dectHandsetFilled: return "\u{f3f1}"
        case .dectHandsetLight: return "\u{f3f2}"
        case .dectHandsetRegular: return "\u{f3f3}"
        case .deleteBold: return "\u{f3f4}"
        case .deleteFilled: return "\u{f3f5}"
        case .deleteLight: return "\u{f3f6}"
        case .deleteRegular: return "\u{f3f7}"
        case .deploymentEvaluationProgressBold: return "\u{f3f8}"
        case .deploymentEvaluationProgressLight: return "\u{f3f9}"
        case .deploymentEvaluationProgressRegular: return "\u{f3fa}"
        case .deploymentProgressBold: return "\u{f3fb}"
        case .deploymentProgressLight: return "\u{f3fc}"
        case .deploymentProgressRegular: return "\u{f3fd}"
        case .deploymentRecurringBold: return "\u{f3fe}"
        case .deploymentRecurringLight: return "\u{f3ff}"
        case .deploymentRecurringRegular: return "\u{f400}"
        case .deploymentWinnerPendingBold: return "\u{f401}"
        case .deploymentWinnerPendingLight: return "\u{f402}"
        case .deploymentWinnerPendingRegular: return "\u{f403}"
        case .deskPhoneBold: return "\u{f404}"
        case .deskPhoneFilled: return "\u{f405}"
        case .deskPhoneLight: return "\u{f406}"
        case .deskPhoneRegular: return "\u{f407}"
        case .deskPhoneWarningBold: return "\u{f408}"
        case .deskPhoneWarningLight: return "\u{f409}"
        case .deskPhoneWarningRegular: return "\u{f40a}"
        case .deviceConnectionBold: return "\u{f40b}"
        case .deviceConnectionFilled: return "\u{f40c}"
        case .deviceConnectionLight: return "\u{f40d}"
        case .deviceConnectionRegular: return "\u{f40e}"
        case .deviceInRoomBold: return "\u{f40f}"
        case .deviceInRoomEndBold: return "\u{f410}"
        case .deviceInRoomEndLight: return "\u{f411}"
        case .deviceInRoomEndRegular: return "\u{f412}"
        case .deviceInRoomFilled: return "\u{f413}"
        case .deviceInRoomLight: return "\u{f414}"
        case .deviceInRoomRegular: return "\u{f415}"
        case .deviceMutedBold: return "\u{f416}"
        case .deviceMutedLight: return "\u{f417}"
        case .deviceMutedRegular: return "\u{f418}"
        case .devicePolicyControllerBold: return "\u{f419}"
        case .devicePolicyControllerLight: return "\u{f41a}"
        case .devicePolicyControllerRegular: return "\u{f41b}"
        case .devicesBold: return "\u{f41c}"
        case .devicesFilled: return "\u{f41d}"
        case .devicesLight: return "\u{f41e}"
        case .devicesRegular: return "\u{f41f}"
        case .diagnosticsBold: return "\u{f420}"
        case .diagnosticsLight: return "\u{f421}"
        case .diagnosticsRegular: return "\u{f422}"
        case .dialpadBold: return "\u{f423}"
        case .dialpadLight: return "\u{f424}"
        case .dialpadRegular: return "\u{f425}"
        case .diamondBold: return "\u{f426}"
        case .diamondFilled: return "\u{f427}"
        case .diamondLight: return "\u{f428}"
        case .diamondRegular: return "\u{f429}"
        case .directionalPadBold: return "\u{f42a}"
        case .directionalPadFilled: return "\u{f42b}"
        case .directionalPadLight: return "\u{f42c}"
        case .directionalPadRegular: return "\u{f42d}"
        case .directoryBold: return "\u{f42e}"
        case .directoryLight: return "\u{f42f}"
        case .directoryRegular: return "\u{f430}"
        case .disappearingPenBold: return "\u{f431}"
        case .disappearingPenLight: return "\u{f432}"
        case .disappearingPenRegular: return "\u{f433}"
        case .discBold: return "\u{f434}"
        case .discConnectedBold: return "\u{f435}"
        case .discConnectedLight: return "\u{f436}"
        case .discConnectedRegular: return "\u{f437}"
        case .discLight: return "\u{f438}"
        case .discRegular: return "\u{f439}"
        case .disconnectBold: return "\u{f43a}"
        case .disconnectFilled: return "\u{f43b}"
        case .disconnectLight: return "\u{f43c}"
        case .disconnectRegular: return "\u{f43d}"
        case .dislikeBold: return "\u{f43e}"
        case .dislikeFilled: return "\u{f43f}"
        case .dislikeLight: return "\u{f440}"
        case .dislikeRegular: return "\u{f441}"
        case .displayBold: return "\u{f442}"
        case .displayInputBold: return "\u{f443}"
        case .displayInputLight: return "\u{f444}"
        case .displayInputRegular: return "\u{f445}"
        case .displayLight: return "\u{f446}"
        case .displayRegular: return "\u{f447}"
        case .displayWarningBold: return "\u{f448}"
        case .displayWarningLight: return "\u{f449}"
        case .displayWarningRegular: return "\u{f44a}"
        case .distributeHorizontalBold: return "\u{f44b}"
        case .distributeHorizontalFilled: return "\u{f44c}"
        case .distributeHorizontalLight: return "\u{f44d}"
        case .distributeHorizontalRegular: return "\u{f44e}"
        case .distributeVerticallyBold: return "\u{f44f}"
        case .distributeVerticallyFilled: return "\u{f450}"
        case .distributeVerticallyLight: return "\u{f451}"
        case .distributeVerticallyRegular: return "\u{f452}"
        case .divideBold: return "\u{f453}"
        case .divideFilled: return "\u{f454}"
        case .divideLight: return "\u{f455}"
        case .divideRegular: return "\u{f456}"
        case .dndPresenceBadgeFilled: return "\u{f457}"
        case .dndPresenceBold: return "\u{f458}"
        case .dndPresenceFilled: return "\u{f459}"
        case .dndPresenceLight: return "\u{f45a}"
        case .dndPresenceRegular: return "\u{f45b}"
        case .dockWindowBold: return "\u{f45c}"
        case .dockWindowLight: return "\u{f45d}"
        case .dockWindowRegular: return "\u{f45e}"
        case .documentBold: return "\u{f45f}"
        case .documentCameraBold: return "\u{f460}"
        case .documentCameraDisconnectedBold: return "\u{f461}"
        case .documentCameraDisconnectedLight: return "\u{f462}"
        case .documentCameraDisconnectedRegular: return "\u{f463}"
        case .documentCameraLight: return "\u{f464}"
        case .documentCameraRegular: return "\u{f465}"
        case .documentCreateBold: return "\u{f466}"
        case .documentCreateFilled: return "\u{f467}"
        case .documentCreateLight: return "\u{f468}"
        case .documentCreateRegular: return "\u{f469}"
        case .documentFilled: return "\u{f46a}"
        case .documentLight: return "\u{f46b}"
        case .documentMoveBold: return "\u{f46c}"
        case .documentMoveFilled: return "\u{f46d}"
        case .documentMoveLight: return "\u{f46e}"
        case .documentMoveRegular: return "\u{f46f}"
        case .documentRegular: return "\u{f470}"
        case .documentShareBold: return "\u{f471}"
        case .documentShareFilled: return "\u{f472}"
        case .documentShareLight: return "\u{f473}"
        case .documentShareRegular: return "\u{f474}"
        case .doneAllBold: return "\u{f475}"
        case .doneAllLight: return "\u{f476}"
        case .doneAllRegular: return "\u{f477}"
        case .donutChartBold: return "\u{f478}"
        case .donutChartFilled: return "\u{f479}"
        case .donutChartLight: return "\u{f47a}"
        case .donutChartRegular: return "\u{f47b}"
        case .downloadBold: return "\u{f47c}"
        case .downloadFilled: return "\u{f47d}"
        case .downloadLight: return "\u{f47e}"
        case .downloadRegular: return "\u{f47f}"
        case .draftBold: return "\u{f480}"
        case .draftFilled: return "\u{f481}"
        case .draftIndicatorBold: return "\u{f482}"
        case .draftIndicatorSmallFilled: return "\u{f483}"
        case .draftLight: return "\u{f484}"
        case .draftRegular: return "\u{f485}"
        case .dragBold: return "\u{f486}"
        case .dragLight: return "\u{f487}"
        case .dragRegular: return "\u{f488}"
        case .draggerHorizontalBold: return "\u{f489}"
        case .draggerHorizontalLight: return "\u{f48a}"
        case .draggerHorizontalRegular: return "\u{f48b}"
        case .draggerVerticalBold: return "\u{f48c}"
        case .draggerVerticalLight: return "\u{f48d}"
        case .draggerVerticalRegular: return "\u{f48e}"
        case .driveModeBold: return "\u{f48f}"
        case .driveModeLight: return "\u{f490}"
        case .driveModeRegular: return "\u{f491}"
        case .dropdownBold: return "\u{f492}"
        case .dropdownLight: return "\u{f493}"
        case .dropdownRegular: return "\u{f494}"
        case .dxEightyBold: return "\u{f495}"
        case .dxEightyFilled: return "\u{f496}"
        case .dxEightyLight: return "\u{f497}"
        case .dxEightyRegular: return "\u{f498}"
        case .dxSeventyBold: return "\u{f499}"
        case .dxSeventyLight: return "\u{f49a}"
        case .dxSeventyRegular: return "\u{f49b}"
        case .editBold: return "\u{f49c}"
        case .editFilled: return "\u{f49d}"
        case .editLight: return "\u{f49e}"
        case .editRegular: return "\u{f49f}"
        case .editablePartialBold: return "\u{f4a0}"
        case .editablePartialLight: return "\u{f4a1}"
        case .editablePartialRegular: return "\u{f4a2}"
        case .educationBold: return "\u{f4a3}"
        case .educationFilled: return "\u{f4a4}"
        case .educationLight: return "\u{f4a5}"
        case .educationRegular: return "\u{f4a6}"
        case .emailBold: return "\u{f4a7}"
        case .emailDeliveredBold: return "\u{f4a8}"
        case .emailDeliveredLight: return "\u{f4a9}"
        case .emailDeliveredRegular: return "\u{f4aa}"
        case .emailFailureBold: return "\u{f4ab}"
        case .emailFailureLight: return "\u{f4ac}"
        case .emailFailureRegular: return "\u{f4ad}"
        case .emailFilled: return "\u{f4ae}"
        case .emailInviteBold: return "\u{f4af}"
        case .emailInviteLight: return "\u{f4b0}"
        case .emailInviteRegular: return "\u{f4b1}"
        case .emailLight: return "\u{f4b2}"
        case .emailOutgoingBold: return "\u{f4b3}"
        case .emailOutgoingFilled: return "\u{f4b4}"
        case .emailOutgoingLight: return "\u{f4b5}"
        case .emailOutgoingRegular: return "\u{f4b6}"
        case .emailReadBold: return "\u{f4b7}"
        case .emailReadFilled: return "\u{f4b8}"
        case .emailReadLight: return "\u{f4b9}"
        case .emailReadRegular: return "\u{f4ba}"
        case .emailRegular: return "\u{f4bb}"
        case .emojiExcitedBold: return "\u{f4bc}"
        case .emojiExcitedFilled: return "\u{f4bd}"
        case .emojiExcitedLight: return "\u{f4be}"
        case .emojiExcitedRegular: return "\u{f4bf}"
        case .emojiHappyBold: return "\u{f4c0}"
        case .emojiHappyFilled: return "\u{f4c1}"
        case .emojiHappyLight: return "\u{f4c2}"
        case .emojiHappyRegular: return "\u{f4c3}"
        case .emojiPassiveBold: return "\u{f4c4}"
        case .emojiPassiveFilled: return "\u{f4c5}"
        case .emojiPassiveLight: return "\u{f4c6}"
        case .emojiPassiveRegular: return "\u{f4c7}"
        case .emojiSadBold: return "\u{f4c8}"
        case .emojiSadFilled: return "\u{f4c9}"
        case .emojiSadLight: return "\u{f4ca}"
        case .emojiSadRegular: return "\u{f4cb}"
        case .emojiUnhappyBold: return "\u{f4cc}"
        case .emojiUnhappyFilled: return "\u{f4cd}"
        case .emojiUnhappyLight: return "\u{f4ce}"
        case .emojiUnhappyRegular: return "\u{f4cf}"
        case .encryptionCircleFilled: return "\u{f4d0}"
        case .encryptionFilled: return "\u{f4d1}"
        case .endRemoteDesktopControlBold: return "\u{f4d2}"
        case .endRemoteDesktopControlLight: return "\u{f4d3}"
        case .endRemoteDesktopControlRegular: return "\u{f4d4}"
        case .endToEndEncryptionCircleFilled: return "\u{f4d5}"
        case .endToEndEncryptionFilled: return "\u{f4d6}"
        case .endpointBlockedBold: return "\u{f4d7}"
        case .endpointBlockedLight: return "\u{f4d8}"
        case .endpointBlockedRegular: return "\u{f4d9}"
        case .endpointBold: return "\u{f4da}"
        case .endpointGTwoBold: return "\u{f4db}"
        case .endpointGTwoLight: return "\u{f4dc}"
        case .endpointGTwoRegular: return "\u{f4dd}"
        case .endpointGTwoSeventyBold: return "\u{f4de}"
        case .endpointGTwoSeventyDualBold: return "\u{f4df}"
        case .endpointGTwoSeventyDualLight: return "\u{f4e0}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4e1}"
        case .endpointGTwoSeventyLight: return "\u{f4e2}"
        case .endpointGTwoSeventyRegular: return "\u{f4e3}"
        case .endpointGTwoStandBold: return "\u{f4e4}"
        case .endpointGTwoStandLight: return "\u{f4e5}"
        case .endpointGTwoStandRegular: return "\u{f4e6}"
        case .endpointLight: return "\u{f4e7}"
        case .endpointMxEightHundredBold: return "\u{f4e8}"
        case .endpointMxEightHundredDualBold: return "\u{f4e9}"
        case .endpointMxEightHundredDualLight: return "\u{f4ea}"
        case .endpointMxEightHundredDualRegular: return "\u{f4eb}"
        case .endpointMxEightHundredLight: return "\u{f4ec}"
        case .endpointMxEightHundredRegular: return "\u{f4ed}"
        case .endpointRegular: return "\u{f4ee}"
        case .endpointStandBold: return "\u{f4ef}"
        case .endpointStandFilled: return "\u{f4f0}"
        case .endpointStandLight: return "\u{f4f1}"
        case .endpointStandRegular: return "\u{f4f2}"
        case .endpointWarningBold: return "\u{f4f3}"
        case .endpointWarningLight: return "\u{f4f4}"
        case .endpointWarningRegular: return "\u{f4f5}"
        case .enterBold: return "\u{f4f6}"
        case .enterLight: return "\u{f4f7}"
        case .enterRegular: return "\u{f4f8}"
        case .enterRoomBold: return "\u{f4f9}"
        case .enterRoomFilled: return "\u{f4fa}"
        case .enterRoomLight: return "\u{f4fb}"
        case .enterRoomRegular: return "\u{f4fc}"
        case .eraserBold: return "\u{f4fd}"
        case .eraserFilled: return "\u{f4fe}"
        case .eraserLight: return "\u{f4ff}"
        case .eraserRegular: return "\u{f500}"
        case .errorLegacyBadgeFilled: return "\u{f501}"
        case .errorLegacyBold: return "\u{f502}"
        case .errorLegacyFilled: return "\u{f503}"
        case .errorLegacyLight: return "\u{f504}"
        case .errorLegacyRegular: return "\u{f505}"
        case .ethernetBold: return "\u{f506}"
        case .ethernetFilled: return "\u{f507}"
        case .ethernetLight: return "\u{f508}"
        case .ethernetRegular: return "\u{f509}"
        case .exchangeBold: return "\u{f50a}"
        case .exchangeLight: return "\u{f50b}"
        case .exchangeRegular: return "\u{f50c}"
        case .exclamationBold: return "\u{f50d}"
        case .exclamationLight: return "\u{f50e}"
        case .exclamationRegular: return "\u{f50f}"
        case .excludeBold: return "\u{f510}"
        case .excludeLight: return "\u{f511}"
        case .excludeRegular: return "\u{f512}"
        case .existingTargetGroupBold: return "\u{f513}"
        case .existingTargetGroupLight: return "\u{f514}"
        case .existingTargetGroupRegular: return "\u{f515}"
        case .exitRoomBold: return "\u{f516}"
        case .exitRoomLight: return "\u{f517}"
        case .exitRoomRegular: return "\u{f518}"
        case .exploreBold: return "\u{f519}"
        case .exploreLight: return "\u{f51a}"
        case .exploreRegular: return "\u{f51b}"
        case .exportBold: return "\u{f51c}"
        case .exportLight: return "\u{f51d}"
        case .exportRegular: return "\u{f51e}"
        case .extensionMobilityBold: return "\u{f51f}"
        case .extensionMobilityLight: return "\u{f520}"
        case .extensionMobilityRegular: return "\u{f521}"
        case .externalMessageBold: return "\u{f522}"
        case .externalMessageLight: return "\u{f523}"
        case .externalMessageRegular: return "\u{f524}"
        case .externalUserBold: return "\u{f525}"
        case .externalUserLight: return "\u{f526}"
        case .externalUserRegular: return "\u{f527}"
        case .familyFontBold: return "\u{f528}"
        case .familyFontLight: return "\u{f529}"
        case .familyFontRegular: return "\u{f52a}"
        case .fastForwardBold: return "\u{f52b}"
        case .fastForwardLight: return "\u{f52c}"
        case .fastForwardRegular: return "\u{f52d}"
        case .favoriteBold: return "\u{f52e}"
        case .favoriteFilled: return "\u{f52f}"
        case .favoriteLight: return "\u{f530}"
        case .favoriteRegular: return "\u{f531}"
        case .favoritesBold: return "\u{f532}"
        case .favoritesFilled: return "\u{f533}"
        case .favoritesLight: return "\u{f534}"
        case .favoritesRegular: return "\u{f535}"
        case .fbwBold: return "\u{f536}"
        case .fbwFilled: return "\u{f537}"
        case .fbwLight: return "\u{f538}"
        case .fbwRegular: return "\u{f539}"
        case .ffwBold: return "\u{f53a}"
        case .ffwFilled: return "\u{f53b}"
        case .ffwLight: return "\u{f53c}"
        case .ffwRegular: return "\u{f53d}"
        case .fileAnalysisBold: return "\u{f53e}"
        case .fileAnalysisFilled: return "\u{f53f}"
        case .fileAnalysisLight: return "\u{f540}"
        case .fileAnalysisRegular: return "\u{f541}"
        case .fileAnnotationBold: return "\u{f542}"
        case .fileAnnotationFilled: return "\u{f543}"
        case .fileAnnotationLight: return "\u{f544}"
        case .fileAnnotationRegular: return "\u{f545}"
        case .fileAudioBold: return "\u{f546}"
        case .fileAudioFilled: return "\u{f547}"
        case .fileAudioLight: return "\u{f548}"
        case .fileAudioRegular: return "\u{f549}"
        case .fileBugBold: return "\u{f54a}"
        case .fileBugFilled: return "\u{f54b}"
        case .fileBugLight: return "\u{f54c}"
        case .fileBugRegular: return "\u{f54d}"
        case .fileCodeBold: return "\u{f54e}"
        case .fileCodeFilled: return "\u{f54f}"
        case .fileCodeLight: return "\u{f550}"
        case .fileCodeRegular: return "\u{f551}"
        case .fileDashboardBold: return "\u{f552}"
        case .fileDashboardFilled: return "\u{f553}"
        case .fileDashboardLight: return "\u{f554}"
        case .fileDashboardRegular: return "\u{f555}"
        case .fileExcelBold: return "\u{f556}"
        case .fileExcelFilled: return "\u{f557}"
        case .fileExcelLight: return "\u{f558}"
        case .fileExcelRegular: return "\u{f559}"
        case .fileGraphBold: return "\u{f55a}"
        case .fileGraphFilled: return "\u{f55b}"
        case .fileGraphLight: return "\u{f55c}"
        case .fileGraphRegular: return "\u{f55d}"
        case .fileImageBold: return "\u{f55e}"
        case .fileImageFilled: return "\u{f55f}"
        case .fileImageLight: return "\u{f560}"
        case .fileImageNoneBold: return "\u{f561}"
        case .fileImageNoneLight: return "\u{f562}"
        case .fileImageNoneRegular: return "\u{f563}"
        case .fileImageRegular: return "\u{f564}"
        case .fileJsBold: return "\u{f565}"
        case .fileJsFilled: return "\u{f566}"
        case .fileJsLight: return "\u{f567}"
        case .fileJsRegular: return "\u{f568}"
        case .fileKeynoteBold: return "\u{f569}"
        case .fileKeynoteFilled: return "\u{f56a}"
        case .fileKeynoteLight: return "\u{f56b}"
        case .fileKeynoteRegular: return "\u{f56c}"
        case .fileLockedBold: return "\u{f56d}"
        case .fileLockedFilled: return "\u{f56e}"
        case .fileLockedLight: return "\u{f56f}"
        case .fileLockedRegular: return "\u{f570}"
        case .fileMissingBold: return "\u{f571}"
        case .fileMissingFilled: return "\u{f572}"
        case .fileMissingLight: return "\u{f573}"
        case .fileMissingRegular: return "\u{f574}"
        case .fileMusicBold: return "\u{f575}"
        case .fileMusicFilled: return "\u{f576}"
        case .fileMusicLight: return "\u{f577}"
        case .fileMusicRegular: return "\u{f578}"
        case .fileOnenoteBold: return "\u{f579}"
        case .fileOnenoteFilled: return "\u{f57a}"
        case .fileOnenoteLight: return "\u{f57b}"
        case .fileOnenoteRegular: return "\u{f57c}"
        case .filePdfBold: return "\u{f57d}"
        case .filePdfFilled: return "\u{f57e}"
        case .filePdfLight: return "\u{f57f}"
        case .filePdfRegular: return "\u{f580}"
        case .filePowerpointBold: return "\u{f581}"
        case .filePowerpointFilled: return "\u{f582}"
        case .filePowerpointLight: return "\u{f583}"
        case .filePowerpointRegular: return "\u{f584}"
        case .fileSpreadsheetBold: return "\u{f585}"
        case .fileSpreadsheetFilled: return "\u{f586}"
        case .fileSpreadsheetLight: return "\u{f587}"
        case .fileSpreadsheetRegular: return "\u{f588}"
        case .fileTextBold: return "\u{f589}"
        case .fileTextFilled: return "\u{f58a}"
        case .fileTextLight: return "\u{f58b}"
        case .fileTextRegular: return "\u{f58c}"
        case .fileThreeDBold: return "\u{f58d}"
        case .fileThreeDFilled: return "\u{f58e}"
        case .fileThreeDLight: return "\u{f58f}"
        case .fileThreeDRegular: return "\u{f590}"
        case .fileVectorBold: return "\u{f591}"
        case .fileVectorFilled: return "\u{f592}"
        case .fileVectorLight: return "\u{f593}"
        case .fileVectorRegular: return "\u{f594}"
        case .fileVideoBold: return "\u{f595}"
        case .fileVideoFilled: return "\u{f596}"
        case .fileVideoLight: return "\u{f597}"
        case .fileVideoRegular: return "\u{f598}"
        case .fileWordBold: return "\u{f599}"
        case .fileWordFilled: return "\u{f59a}"
        case .fileWordLight: return "\u{f59b}"
        case .fileWordRegular: return "\u{f59c}"
        case .fileXmlBold: return "\u{f59d}"
        case .fileXmlFilled: return "\u{f59e}"
        case .fileXmlLight: return "\u{f59f}"
        case .fileXmlRegular: return "\u{f5a0}"
        case .fileZipBold: return "\u{f5a1}"
        case .fileZipFilled: return "\u{f5a2}"
        case .fileZipLight: return "\u{f5a3}"
        case .fileZipRegular: return "\u{f5a4}"
        case .filesBold: return "\u{f5a5}"
        case .filesFilled: return "\u{f5a6}"
        case .filesLight: return "\u{f5a7}"
        case .filesRegular: return "\u{f5a8}"
        case .fillColourBold: return "\u{f5a9}"
        case .fillColourFilled: return "\u{f5aa}"
        case .fillColourLight: return "\u{f5ab}"
        case .fillColourRegular: return "\u{f5ac}"
        case .filterBold: return "\u{f5ad}"
        case .filterCircleBold: return "\u{f5ae}"
        case .filterCircleFilled: return "\u{f5af}"
        case .filterCircleLight: return "\u{f5b0}"
        case .filterCircleRegular: return "\u{f5b1}"
        case .filterLight: return "\u{f5b2}"
        case .filterRegular: return "\u{f5b3}"
        case .fitToWidthBold: return "\u{f5b4}"
        case .fitToWidthLight: return "\u{f5b5}"
        case .fitToWidthRegular: return "\u{f5b6}"
        case .fitToWindowExpandBold: return "\u{f5b7}"
        case .fitToWindowExpandLight: return "\u{f5b8}"
        case .fitToWindowExpandRegular: return "\u{f5b9}"
        case .fitToWindowShrinkBold: return "\u{f5ba}"
        case .fitToWindowShrinkLight: return "\u{f5bb}"
        case .fitToWindowShrinkRegular: return "\u{f5bc}"
        case .flagBold: return "\u{f5bd}"
        case .flagCircleBold: return "\u{f5be}"
        case .flagCircleFilled: return "\u{f5bf}"
        case .flagCircleLight: return "\u{f5c0}"
        case .flagCircleRegular: return "\u{f5c1}"
        case .flagFilled: return "\u{f5c2}"
        case .flagLight: return "\u{f5c3}"
        case .flagRegular: return "\u{f5c4}"
        case .folderBold: return "\u{f5c5}"
        case .folderEditBold: return "\u{f5c6}"
        case .folderEditLight: return "\u{f5c7}"
        case .folderEditRegular: return "\u{f5c8}"
        case .folderLight: return "\u{f5c9}"
        case .folderLockBold: return "\u{f5ca}"
        case .folderLockLight: return "\u{f5cb}"
        case .folderLockRegular: return "\u{f5cc}"
        case .folderRegular: return "\u{f5cd}"
        case .folderViewBold: return "\u{f5ce}"
        case .folderViewLight: return "\u{f5cf}"
        case .folderViewRegular: return "\u{f5d0}"
        case .followUpBold: return "\u{f5d1}"
        case .followUpLight: return "\u{f5d2}"
        case .followUpRegular: return "\u{f5d3}"
        case .foodBold: return "\u{f5d4}"
        case .foodFilled: return "\u{f5d5}"
        case .foodLight: return "\u{f5d6}"
        case .foodRegular: return "\u{f5d7}"
        case .formatBold: return "\u{f5d8}"
        case .formatDefaultAppBold: return "\u{f5d9}"
        case .formatDefaultAppFilled: return "\u{f5da}"
        case .formatDefaultAppLight: return "\u{f5db}"
        case .formatDefaultAppRegular: return "\u{f5dc}"
        case .formatLight: return "\u{f5dd}"
        case .formatPanelControlBarBold: return "\u{f5de}"
        case .formatPanelControlBarLight: return "\u{f5df}"
        case .formatPanelControlBarRegular: return "\u{f5e0}"
        case .formatPanelControlDownBold: return "\u{f5e1}"
        case .formatPanelControlDownLight: return "\u{f5e2}"
        case .formatPanelControlDownRegular: return "\u{f5e3}"
        case .formatPanelControlLeftBold: return "\u{f5e4}"
        case .formatPanelControlLeftLight: return "\u{f5e5}"
        case .formatPanelControlLeftRegular: return "\u{f5e6}"
        case .formatPanelControlRightBold: return "\u{f5e7}"
        case .formatPanelControlRightLight: return "\u{f5e8}"
        case .formatPanelControlRightRegular: return "\u{f5e9}"
        case .formatPanelControlUpBold: return "\u{f5ea}"
        case .formatPanelControlUpDownBold: return "\u{f5eb}"
        case .formatPanelControlUpDownLight: return "\u{f5ec}"
        case .formatPanelControlUpDownRegular: return "\u{f5ed}"
        case .formatPanelControlUpLight: return "\u{f5ee}"
        case .formatPanelControlUpRegular: return "\u{f5ef}"
        case .formatRegular: return "\u{f5f0}"
        case .formatViewMixedBold: return "\u{f5f1}"
        case .formatViewMixedLight: return "\u{f5f2}"
        case .formatViewMixedRegular: return "\u{f5f3}"
        case .formulaBold: return "\u{f5f4}"
        case .formulaFilled: return "\u{f5f5}"
        case .formulaLight: return "\u{f5f6}"
        case .formulaRegular: return "\u{f5f7}"
        case .forwardMessageBold: return "\u{f5f8}"
        case .forwardMessageFilled: return "\u{f5f9}"
        case .forwardMessageLight: return "\u{f5fa}"
        case .forwardMessageRegular: return "\u{f5fb}"
        case .forwardTenSecBold: return "\u{f5fc}"
        case .forwardTenSecLight: return "\u{f5fd}"
        case .forwardTenSecRegular: return "\u{f5fe}"
        case .fourColumnBold: return "\u{f5ff}"
        case .fourColumnLight: return "\u{f600}"
        case .fourColumnRegular: return "\u{f601}"
        case .fourWayNavigationBold: return "\u{f602}"
        case .fourWayNavigationLight: return "\u{f603}"
        case .fourWayNavigationRegular: return "\u{f604}"
        case .frequencyCappingBold: return "\u{f605}"
        case .frequencyCappingLight: return "\u{f606}"
        case .frequencyCappingRegular: return "\u{f607}"
        case .fulfillmentBold: return "\u{f608}"
        case .fulfillmentLight: return "\u{f609}"
        case .fulfillmentRegular: return "\u{f60a}"
        case .fullscreenBold: return "\u{f60b}"
        case .fullscreenExitBold: return "\u{f60c}"
        case .fullscreenExitLight: return "\u{f60d}"
        case .fullscreenExitRegular: return "\u{f60e}"
        case .fullscreenLight: return "\u{f60f}"
        case .fullscreenRegular: return "\u{f610}"
        case .genericDeviceVideoBadgeFilled: return "\u{f611}"
        case .genericDeviceVideoBold: return "\u{f612}"
        case .genericDeviceVideoFilled: return "\u{f613}"
        case .genericDeviceVideoLight: return "\u{f614}"
        case .genericDeviceVideoRegular: return "\u{f615}"
        case .gifBold: return "\u{f616}"
        case .gifFilled: return "\u{f617}"
        case .gifHorizontalBold: return "\u{f618}"
        case .gifHorizontalFilled: return "\u{f619}"
        case .gifHorizontalLight: return "\u{f61a}"
        case .gifHorizontalRegular: return "\u{f61b}"
        case .gifLight: return "\u{f61c}"
        case .gifRegular: return "\u{f61d}"
        case .giftBold: return "\u{f61e}"
        case .giftFilled: return "\u{f61f}"
        case .giftLight: return "\u{f620}"
        case .giftRegular: return "\u{f621}"
        case .greenLeafBold: return "\u{f622}"
        case .greenLeafFilled: return "\u{f623}"
        case .greenLeafLight: return "\u{f624}"
        case .greenLeafRegular: return "\u{f625}"
        case .greenRoomBold: return "\u{f626}"
        case .greenRoomFilled: return "\u{f627}"
        case .greenRoomLight: return "\u{f628}"
        case .greenRoomRegular: return "\u{f629}"
        case .guestIssuerBold: return "\u{f62a}"
        case .guestIssuerLight: return "\u{f62b}"
        case .guestIssuerRegular: return "\u{f62c}"
        case .guideBold: return "\u{f62d}"
        case .guideLight: return "\u{f62e}"
        case .guideRegular: return "\u{f62f}"
        case .handPointerBold: return "\u{f630}"
        case .handPointerLight: return "\u{f631}"
        case .handPointerRegular: return "\u{f632}"
        case .handlerBold: return "\u{f633}"
        case .handlerHorizontalBold: return "\u{f634}"
        case .handlerHorizontalLight: return "\u{f635}"
        case .handlerHorizontalRegular: return "\u{f636}"
        case .handlerLight: return "\u{f637}"
        case .handlerRegular: return "\u{f638}"
        case .handsetAlertBold: return "\u{f639}"
        case .handsetAlertFilled: return "\u{f63a}"
        case .handsetAlertLight: return "\u{f63b}"
        case .handsetAlertRegular: return "\u{f63c}"
        case .handsetBold: return "\u{f63d}"
        case .handsetDownSlashBold: return "\u{f63e}"
        case .handsetDownSlashFilled: return "\u{f63f}"
        case .handsetDownSlashLight: return "\u{f640}"
        case .handsetDownSlashRegular: return "\u{f641}"
        case .handsetFilled: return "\u{f642}"
        case .handsetLight: return "\u{f643}"
        case .handsetMutedBold: return "\u{f644}"
        case .handsetMutedFilled: return "\u{f645}"
        case .handsetMutedLight: return "\u{f646}"
        case .handsetMutedRegular: return "\u{f647}"
        case .handsetRegular: return "\u{f648}"
        case .handsetsArrowLeftBold: return "\u{f649}"
        case .handsetsArrowLeftLight: return "\u{f64a}"
        case .handsetsArrowLeftRegular: return "\u{f64b}"
        case .handshakeBold: return "\u{f64c}"
        case .handshakeLight: return "\u{f64d}"
        case .handshakeRegular: return "\u{f64e}"
        case .headingOneBold: return "\u{f64f}"
        case .headingOneLight: return "\u{f650}"
        case .headingOneRegular: return "\u{f651}"
        case .headingThreeBold: return "\u{f652}"
        case .headingThreeLight: return "\u{f653}"
        case .headingThreeRegular: return "\u{f654}"
        case .headingTwoBold: return "\u{f655}"
        case .headingTwoLight: return "\u{f656}"
        case .headingTwoRegular: return "\u{f657}"
        case .headphonesBold: return "\u{f658}"
        case .headphonesFilled: return "\u{f659}"
        case .headphonesLight: return "\u{f65a}"
        case .headphonesMutedBold: return "\u{f65b}"
        case .headphonesMutedFilled: return "\u{f65c}"
        case .headphonesMutedLight: return "\u{f65d}"
        case .headphonesMutedRegular: return "\u{f65e}"
        case .headphonesRegular: return "\u{f65f}"
        case .headsetAlertBold: return "\u{f660}"
        case .headsetAlertLight: return "\u{f661}"
        case .headsetAlertRegular: return "\u{f662}"
        case .headsetArrowDownBold: return "\u{f663}"
        case .headsetArrowDownFilled: return "\u{f664}"
        case .headsetArrowDownLight: return "\u{f665}"
        case .headsetArrowDownRegular: return "\u{f666}"
        case .headsetBluetoothBold: return "\u{f667}"
        case .headsetBluetoothLight: return "\u{f668}"
        case .headsetBluetoothRegular: return "\u{f669}"
        case .headsetBold: return "\u{f66a}"
        case .headsetFilled: return "\u{f66b}"
        case .headsetLight: return "\u{f66c}"
        case .headsetMutedBold: return "\u{f66d}"
        case .headsetMutedLight: return "\u{f66e}"
        case .headsetMutedRegular: return "\u{f66f}"
        case .headsetPrivateBold: return "\u{f670}"
        case .headsetPrivateLight: return "\u{f671}"
        case .headsetPrivateRegular: return "\u{f672}"
        case .headsetRegular: return "\u{f673}"
        case .hearingBold: return "\u{f674}"
        case .hearingImpairedBold: return "\u{f675}"
        case .hearingImpairedLight: return "\u{f676}"
        case .hearingImpairedRegular: return "\u{f677}"
        case .hearingLight: return "\u{f678}"
        case .hearingRegular: return "\u{f679}"
        case .helpBold: return "\u{f67a}"
        case .helpCircleBold: return "\u{f67b}"
        case .helpCircleFilled: return "\u{f67c}"
        case .helpCircleLight: return "\u{f67d}"
        case .helpCircleRegular: return "\u{f67e}"
        case .helpLight: return "\u{f67f}"
        case .helpRegular: return "\u{f680}"
        case .helpdeskBold: return "\u{f681}"
        case .helpdeskFilled: return "\u{f682}"
        case .helpdeskLight: return "\u{f683}"
        case .helpdeskRegular: return "\u{f684}"
        case .hideBold: return "\u{f685}"
        case .hideFilled: return "\u{f686}"
        case .hideLight: return "\u{f687}"
        case .hideRegular: return "\u{f688}"
        case .homeBold: return "\u{f689}"
        case .homeFilled: return "\u{f68a}"
        case .homeLight: return "\u{f68b}"
        case .homeRegular: return "\u{f68c}"
        case .horizontalLineBold: return "\u{f68d}"
        case .horizontalLineLight: return "\u{f68e}"
        case .horizontalLineRegular: return "\u{f68f}"
        case .hotelingBold: return "\u{f690}"
        case .hotelingFilled: return "\u{f691}"
        case .hotelingLight: return "\u{f692}"
        case .hotelingRegular: return "\u{f693}"
        case .humidityBold: return "\u{f694}"
        case .humidityLight: return "\u{f695}"
        case .humidityRegular: return "\u{f696}"
        case .huntGroupBold: return "\u{f697}"
        case .huntGroupFilled: return "\u{f698}"
        case .huntGroupLight: return "\u{f699}"
        case .huntGroupRegular: return "\u{f69a}"
        case .idleBold: return "\u{f69b}"
        case .idleFilled: return "\u{f69c}"
        case .idleLight: return "\u{f69d}"
        case .idleRegular: return "\u{f69e}"
        case .immediateBold: return "\u{f69f}"
        case .immediateFilled: return "\u{f6a0}"
        case .immediateLight: return "\u{f6a1}"
        case .immediateRegular: return "\u{f6a2}"
        case .importBold: return "\u{f6a3}"
        case .importLight: return "\u{f6a4}"
        case .importRegular: return "\u{f6a5}"
        case .inCommonBold: return "\u{f6a6}"
        case .inCommonLight: return "\u{f6a7}"
        case .inCommonRegular: return "\u{f6a8}"
        case .inboxBold: return "\u{f6a9}"
        case .inboxFilled: return "\u{f6aa}"
        case .inboxLight: return "\u{f6ab}"
        case .inboxRegular: return "\u{f6ac}"
        case .includeBold: return "\u{f6ad}"
        case .includeLight: return "\u{f6ae}"
        case .includeRegular: return "\u{f6af}"
        case .incognitoBold: return "\u{f6b0}"
        case .incognitoFilled: return "\u{f6b1}"
        case .incognitoLight: return "\u{f6b2}"
        case .incognitoRegular: return "\u{f6b3}"
        case .incomingCallLegacyBold: return "\u{f6b4}"
        case .incomingCallLegacyFilled: return "\u{f6b5}"
        case .incomingCallLegacyLight: return "\u{f6b6}"
        case .incomingCallLegacyRegular: return "\u{f6b7}"
        case .indentDecreaseBold: return "\u{f6b8}"
        case .indentDecreaseLight: return "\u{f6b9}"
        case .indentDecreaseRegular: return "\u{f6ba}"
        case .indentIncreaseBold: return "\u{f6bb}"
        case .indentIncreaseLight: return "\u{f6bc}"
        case .indentIncreaseRegular: return "\u{f6bd}"
        case .infoBadgeFilled: return "\u{f6be}"
        case .infoCircleBold: return "\u{f6bf}"
        case .infoCircleFilled: return "\u{f6c0}"
        case .infoCircleLight: return "\u{f6c1}"
        case .infoCircleRegular: return "\u{f6c2}"
        case .infoCircleTwoBold: return "\u{f6c3}"
        case .infoCircleTwoFilled: return "\u{f6c4}"
        case .infoCircleTwoLight: return "\u{f6c5}"
        case .infoCircleTwoRegular: return "\u{f6c6}"
        case .inputBold: return "\u{f6c7}"
        case .inputDisconnectedBold: return "\u{f6c8}"
        case .inputDisconnectedLight: return "\u{f6c9}"
        case .inputDisconnectedRegular: return "\u{f6ca}"
        case .inputLight: return "\u{f6cb}"
        case .inputRegular: return "\u{f6cc}"
        case .instantScheduleBold: return "\u{f6cd}"
        case .instantScheduleFilled: return "\u{f6ce}"
        case .instantScheduleLight: return "\u{f6cf}"
        case .instantScheduleRegular: return "\u{f6d0}"
        case .integerBold: return "\u{f6d1}"
        case .integerFilled: return "\u{f6d2}"
        case .integerLight: return "\u{f6d3}"
        case .integerRegular: return "\u{f6d4}"
        case .integrationsBold: return "\u{f6d5}"
        case .integrationsFilled: return "\u{f6d6}"
        case .integrationsLight: return "\u{f6d7}"
        case .integrationsRegular: return "\u{f6d8}"
        case .intelligentRoutingBold: return "\u{f6d9}"
        case .intelligentRoutingLight: return "\u{f6da}"
        case .intelligentRoutingRegular: return "\u{f6db}"
        case .interactionBold: return "\u{f6dc}"
        case .interactionFilled: return "\u{f6dd}"
        case .interactionLight: return "\u{f6de}"
        case .interactionRegular: return "\u{f6df}"
        case .invitedUserBold: return "\u{f6e0}"
        case .invitedUserLight: return "\u{f6e1}"
        case .invitedUserRegular: return "\u{f6e2}"
        case .italicBold: return "\u{f6e3}"
        case .italicFilled: return "\u{f6e4}"
        case .italicLight: return "\u{f6e5}"
        case .italicRegular: return "\u{f6e6}"
        case .joinAudioBold: return "\u{f6e7}"
        case .joinAudioFilled: return "\u{f6e8}"
        case .joinAudioLight: return "\u{f6e9}"
        case .joinAudioRegular: return "\u{f6ea}"
        case .keepInTouchBold: return "\u{f6eb}"
        case .keepInTouchFilled: return "\u{f6ec}"
        case .keepInTouchLight: return "\u{f6ed}"
        case .keepInTouchRegular: return "\u{f6ee}"
        case .keyboardBold: return "\u{f6ef}"
        case .keyboardCloseBold: return "\u{f6f0}"
        case .keyboardCloseLight: return "\u{f6f1}"
        case .keyboardCloseRegular: return "\u{f6f2}"
        case .keyboardLight: return "\u{f6f3}"
        case .keyboardRegular: return "\u{f6f4}"
        case .languageBold: return "\u{f6f5}"
        case .languageFilled: return "\u{f6f6}"
        case .languageLight: return "\u{f6f7}"
        case .languageRegular: return "\u{f6f8}"
        case .laptopBold: return "\u{f6f9}"
        case .laptopDisconnectedBold: return "\u{f6fa}"
        case .laptopDisconnectedLight: return "\u{f6fb}"
        case .laptopDisconnectedRegular: return "\u{f6fc}"
        case .laptopFilled: return "\u{f6fd}"
        case .laptopLight: return "\u{f6fe}"
        case .laptopRegular: return "\u{f6ff}"
        case .laserPointerBold: return "\u{f700}"
        case .laserPointerCursorBlackLight: return "\u{f701}"
        case .laserPointerCursorBlueLight: return "\u{f702}"
        case .laserPointerCursorGreenLight: return "\u{f703}"
        case .laserPointerCursorPurpleLight: return "\u{f704}"
        case .laserPointerCursorRedLight: return "\u{f705}"
        case .laserPointerCursorWhiteLight: return "\u{f706}"
        case .laserPointerCursorYellowLight: return "\u{f707}"
        case .laserPointerFilled: return "\u{f708}"
        case .laserPointerLight: return "\u{f709}"
        case .laserPointerRegular: return "\u{f70a}"
        case .launchBold: return "\u{f70b}"
        case .launchLight: return "\u{f70c}"
        case .launchRegular: return "\u{f70d}"
        case .layoutSideBySideVerticalBold: return "\u{f70e}"
        case .layoutSideBySideVerticalFilled: return "\u{f70f}"
        case .layoutSideBySideVerticalLight: return "\u{f710}"
        case .layoutSideBySideVerticalRegular: return "\u{f711}"
        case .leaveBreakoutSessionBold: return "\u{f712}"
        case .leaveBreakoutSessionLight: return "\u{f713}"
        case .leaveBreakoutSessionRegular: return "\u{f714}"
        case .leaveDeviceBold: return "\u{f715}"
        case .leaveDeviceLight: return "\u{f716}"
        case .leaveDeviceRegular: return "\u{f717}"
        case .likeBold: return "\u{f718}"
        case .likeFilled: return "\u{f719}"
        case .likeLight: return "\u{f71a}"
        case .likeRegular: return "\u{f71b}"
        case .linkBold: return "\u{f71c}"
        case .linkLight: return "\u{f71d}"
        case .linkRegular: return "\u{f71e}"
        case .listBulletedBold: return "\u{f71f}"
        case .listBulletedLight: return "\u{f720}"
        case .listBulletedRegular: return "\u{f721}"
        case .listMenuBold: return "\u{f722}"
        case .listMenuLight: return "\u{f723}"
        case .listMenuRegular: return "\u{f724}"
        case .listNumberedBold: return "\u{f725}"
        case .listNumberedLight: return "\u{f726}"
        case .listNumberedRegular: return "\u{f727}"
        case .liveBold: return "\u{f728}"
        case .liveFilled: return "\u{f729}"
        case .liveLight: return "\u{f72a}"
        case .liveRegular: return "\u{f72b}"
        case .locationBold: return "\u{f72c}"
        case .locationFilled: return "\u{f72d}"
        case .locationLight: return "\u{f72e}"
        case .locationRegular: return "\u{f72f}"
        case .longTextBoxBold: return "\u{f730}"
        case .longTextBoxLight: return "\u{f731}"
        case .longTextBoxRegular: return "\u{f732}"
        case .lowerHandBold: return "\u{f733}"
        case .lowerHandLight: return "\u{f734}"
        case .lowerHandRegular: return "\u{f735}"
        case .magicPenBold: return "\u{f736}"
        case .magicPenFilled: return "\u{f737}"
        case .magicPenLight: return "\u{f738}"
        case .magicPenRegular: return "\u{f739}"
        case .markAsUnreadBold: return "\u{f73a}"
        case .markAsUnreadLight: return "\u{f73b}"
        case .markAsUnreadRegular: return "\u{f73c}"
        case .markdownBold: return "\u{f73d}"
        case .markdownFilled: return "\u{f73e}"
        case .markdownLight: return "\u{f73f}"
        case .markdownRegular: return "\u{f740}"
        case .markerBold: return "\u{f741}"
        case .markerFilled: return "\u{f742}"
        case .markerLight: return "\u{f743}"
        case .markerRegular: return "\u{f744}"
        case .maximizeBold: return "\u{f745}"
        case .maximizeLight: return "\u{f746}"
        case .maximizeRegular: return "\u{f747}"
        case .mediaPlayerBold: return "\u{f748}"
        case .mediaPlayerLight: return "\u{f749}"
        case .mediaPlayerRegular: return "\u{f74a}"
        case .mediaQualityGoodBold: return "\u{f74b}"
        case .mediaQualityGoodFilled: return "\u{f74c}"
        case .mediaQualityGoodLight: return "\u{f74d}"
        case .mediaQualityGoodRegular: return "\u{f74e}"
        case .mediaQualityPoorBold: return "\u{f74f}"
        case .mediaQualityPoorColoredBold: return "\u{f750}"
        case .mediaQualityPoorFilled: return "\u{f751}"
        case .mediaQualityPoorLight: return "\u{f752}"
        case .mediaQualityPoorRegular: return "\u{f753}"
        case .mediaQualityUnstableBold: return "\u{f754}"
        case .mediaQualityUnstableColoredBold: return "\u{f755}"
        case .mediaQualityUnstableFilled: return "\u{f756}"
        case .mediaQualityUnstableLight: return "\u{f757}"
        case .mediaQualityUnstableRegular: return "\u{f758}"
        case .meetBold: return "\u{f759}"
        case .meetEndBold: return "\u{f75a}"
        case .meetEndLight: return "\u{f75b}"
        case .meetEndRegular: return "\u{f75c}"
        case .meetFilled: return "\u{f75d}"
        case .meetLight: return "\u{f75e}"
        case .meetRegular: return "\u{f75f}"
        case .meetingSummaryBold: return "\u{f760}"
        case .meetingSummaryFilled: return "\u{f761}"
        case .meetingSummaryLight: return "\u{f762}"
        case .meetingSummaryRegular: return "\u{f763}"
        case .meetingsBold: return "\u{f764}"
        case .meetingsFilled: return "\u{f765}"
        case .meetingsFocusMonthBold: return "\u{f766}"
        case .meetingsFocusMonthLight: return "\u{f767}"
        case .meetingsFocusMonthRegular: return "\u{f768}"
        case .meetingsFocusOneDayBold: return "\u{f769}"
        case .meetingsFocusOneDayLight: return "\u{f76a}"
        case .meetingsFocusOneDayRegular: return "\u{f76b}"
        case .meetingsFocusThreeDayBold: return "\u{f76c}"
        case .meetingsFocusThreeDayLight: return "\u{f76d}"
        case .meetingsFocusThreeDayRegular: return "\u{f76e}"
        case .meetingsFocusUpcomingBold: return "\u{f76f}"
        case .meetingsFocusUpcomingLight: return "\u{f770}"
        case .meetingsFocusUpcomingRegular: return "\u{f771}"
        case .meetingsLight: return "\u{f772}"
        case .meetingsPresenceBadgeFilled: return "\u{f773}"
        case .meetingsPresenceBold: return "\u{f774}"
        case .meetingsPresenceFilled: return "\u{f775}"
        case .meetingsPresenceLight: return "\u{f776}"
        case .meetingsPresenceRegular: return "\u{f777}"
        case .meetingsRegular: return "\u{f778}"
        case .meetingsTeamBold: return "\u{f779}"
        case .meetingsTeamFilled: return "\u{f77a}"
        case .meetingsTeamLight: return "\u{f77b}"
        case .meetingsTeamNewBold: return "\u{f77c}"
        case .meetingsTeamNewLight: return "\u{f77d}"
        case .meetingsTeamNewRegular: return "\u{f77e}"
        case .meetingsTeamRegular: return "\u{f77f}"
        case .mentionBold: return "\u{f780}"
        case .mentionLight: return "\u{f781}"
        case .mentionRegular: return "\u{f782}"
        case .messageQueingBold: return "\u{f783}"
        case .messageQueingLight: return "\u{f784}"
        case .messageQueingRegular: return "\u{f785}"
        case .microphoneBold: return "\u{f786}"
        case .microphoneFilled: return "\u{f787}"
        case .microphoneHardMutedBold: return "\u{f788}"
        case .microphoneHardMutedCircleFilled: return "\u{f789}"
        case .microphoneHardMutedLight: return "\u{f78a}"
        case .microphoneHardMutedRegular: return "\u{f78b}"
        case .microphoneLight: return "\u{f78c}"
        case .microphoneMusicModeBold: return "\u{f78d}"
        case .microphoneMusicModeLight: return "\u{f78e}"
        case .microphoneMusicModeOnBold: return "\u{f78f}"
        case .microphoneMusicModeOnLight: return "\u{f790}"
        case .microphoneMusicModeOnRegular: return "\u{f791}"
        case .microphoneMusicModeRegular: return "\u{f792}"
        case .microphoneMutedBold: return "\u{f793}"
        case .microphoneMutedCircleFilled: return "\u{f794}"
        case .microphoneMutedFilled: return "\u{f795}"
        case .microphoneMutedLight: return "\u{f796}"
        case .microphoneMutedRegular: return "\u{f797}"
        case .microphoneOnBold: return "\u{f798}"
        case .microphoneOnLight: return "\u{f799}"
        case .microphoneOnRegular: return "\u{f79a}"
        case .microphoneOptAllBold: return "\u{f79b}"
        case .microphoneOptAllLight: return "\u{f79c}"
        case .microphoneOptAllMutedBold: return "\u{f79d}"
        case .microphoneOptAllMutedLight: return "\u{f79e}"
        case .microphoneOptAllMutedRegular: return "\u{f79f}"
        case .microphoneOptAllOnBold: return "\u{f7a0}"
        case .microphoneOptAllOnLight: return "\u{f7a1}"
        case .microphoneOptAllOnRegular: return "\u{f7a2}"
        case .microphoneOptAllRegular: return "\u{f7a3}"
        case .microphoneOptMeBold: return "\u{f7a4}"
        case .microphoneOptMeLight: return "\u{f7a5}"
        case .microphoneOptMeMutedBold: return "\u{f7a6}"
        case .microphoneOptMeMutedLight: return "\u{f7a7}"
        case .microphoneOptMeMutedRegular: return "\u{f7a8}"
        case .microphoneOptMeOnBold: return "\u{f7a9}"
        case .microphoneOptMeOnLight: return "\u{f7aa}"
        case .microphoneOptMeOnRegular: return "\u{f7ab}"
        case .microphoneOptMeRegular: return "\u{f7ac}"
        case .microphoneRegular: return "\u{f7ad}"
        case .mindMapBold: return "\u{f7ae}"
        case .mindMapLight: return "\u{f7af}"
        case .mindMapRegular: return "\u{f7b0}"
        case .minimizeBold: return "\u{f7b1}"
        case .minimizeLight: return "\u{f7b2}"
        case .minimizeRegular: return "\u{f7b3}"
        case .minusBold: return "\u{f7b4}"
        case .minusFilled: return "\u{f7b5}"
        case .minusLight: return "\u{f7b6}"
        case .minusRegular: return "\u{f7b7}"
        case .mirrorBold: return "\u{f7b8}"
        case .mirrorFilled: return "\u{f7b9}"
        case .mirrorLight: return "\u{f7ba}"
        case .mirrorRegular: return "\u{f7bb}"
        case .mmsFilled: return "\u{f7bc}"
        case .moderatorBold: return "\u{f7bd}"
        case .moderatorLight: return "\u{f7be}"
        case .moderatorRegular: return "\u{f7bf}"
        case .monitoringBold: return "\u{f7c0}"
        case .monitoringLight: return "\u{f7c1}"
        case .monitoringRegular: return "\u{f7c2}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7c3}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7c4}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7c5}"
        case .moreAdrBold: return "\u{f7c6}"
        case .moreAdrLight: return "\u{f7c7}"
        case .moreAdrRegular: return "\u{f7c8}"
        case .moreBold: return "\u{f7c9}"
        case .moreCircleBold: return "\u{f7ca}"
        case .moreCircleFilled: return "\u{f7cb}"
        case .moreCircleLight: return "\u{f7cc}"
        case .moreCircleRegular: return "\u{f7cd}"
        case .moreLight: return "\u{f7ce}"
        case .moreRegular: return "\u{f7cf}"
        case .mouseCursorBold: return "\u{f7d0}"
        case .mouseCursorLight: return "\u{f7d1}"
        case .mouseCursorRegular: return "\u{f7d2}"
        case .moveCallInAdrBold: return "\u{f7d3}"
        case .moveCallInAdrLight: return "\u{f7d4}"
        case .moveCallInAdrRegular: return "\u{f7d5}"
        case .moveCallInIphBold: return "\u{f7d6}"
        case .moveCallInIphLight: return "\u{f7d7}"
        case .moveCallInIphRegular: return "\u{f7d8}"
        case .moveCallInLaptopBold: return "\u{f7d9}"
        case .moveCallInLaptopLight: return "\u{f7da}"
        case .moveCallInLaptopRegular: return "\u{f7db}"
        case .moveCallInOutAdrBold: return "\u{f7dc}"
        case .moveCallInOutAdrLight: return "\u{f7dd}"
        case .moveCallInOutAdrRegular: return "\u{f7de}"
        case .moveCallInOutIphBold: return "\u{f7df}"
        case .moveCallInOutIphLight: return "\u{f7e0}"
        case .moveCallInOutIphRegular: return "\u{f7e1}"
        case .moveCallInTabletBold: return "\u{f7e2}"
        case .moveCallInTabletLight: return "\u{f7e3}"
        case .moveCallInTabletRegular: return "\u{f7e4}"
        case .moveCallOutAdrBold: return "\u{f7e5}"
        case .moveCallOutAdrLight: return "\u{f7e6}"
        case .moveCallOutAdrRegular: return "\u{f7e7}"
        case .moveCallOutIphBold: return "\u{f7e8}"
        case .moveCallOutIphLight: return "\u{f7e9}"
        case .moveCallOutIphRegular: return "\u{f7ea}"
        case .moveCallOutLaptopBold: return "\u{f7eb}"
        case .moveCallOutLaptopLight: return "\u{f7ec}"
        case .moveCallOutLaptopRegular: return "\u{f7ed}"
        case .moveCallOutTabletBold: return "\u{f7ee}"
        case .moveCallOutTabletLight: return "\u{f7ef}"
        case .moveCallOutTabletRegular: return "\u{f7f0}"
        case .moveToScreenBold: return "\u{f7f1}"
        case .moveToScreenLight: return "\u{f7f2}"
        case .moveToScreenRegular: return "\u{f7f3}"
        case .multilineChartBold: return "\u{f7f4}"
        case .multilineChartFilled: return "\u{f7f5}"
        case .multilineChartLight: return "\u{f7f6}"
        case .multilineChartRegular: return "\u{f7f7}"
        case .multimediaBold: return "\u{f7f8}"
        case .multimediaFilled: return "\u{f7f9}"
        case .multimediaLight: return "\u{f7fa}"
        case .multimediaRegular: return "\u{f7fb}"
        case .multipledDevicesBold: return "\u{f7fc}"
        case .multipledDevicesLight: return "\u{f7fd}"
        case .multipledDevicesRegular: return "\u{f7fe}"
        case .musicModeCircleBold: return "\u{f7ff}"
        case .musicModeCircleFilled: return "\u{f800}"
        case .musicModeCircleLight: return "\u{f801}"
        case .musicModeCircleRegular: return "\u{f802}"
        case .musicNoteBold: return "\u{f803}"
        case .musicNoteFilled: return "\u{f804}"
        case .musicNoteLight: return "\u{f805}"
        case .musicNoteRegular: return "\u{f806}"
        case .muteOnEntryBold: return "\u{f807}"
        case .muteOnEntryFilled: return "\u{f808}"
        case .muteOnEntryLight: return "\u{f809}"
        case .muteOnEntryRegular: return "\u{f80a}"
        case .networkSwitchBold: return "\u{f80b}"
        case .networkSwitchFilled: return "\u{f80c}"
        case .networkSwitchLight: return "\u{f80d}"
        case .networkSwitchRegular: return "\u{f80e}"
        case .newManagerBold: return "\u{f80f}"
        case .newManagerLight: return "\u{f810}"
        case .newManagerRegular: return "\u{f811}"
        case .newTitleBold: return "\u{f812}"
        case .newTitleLight: return "\u{f813}"
        case .newTitleRegular: return "\u{f814}"
        case .newVoicemailBold: return "\u{f815}"
        case .newVoicemailLight: return "\u{f816}"
        case .newVoicemailRegular: return "\u{f817}"
        case .newWhiteboardBold: return "\u{f818}"
        case .newWhiteboardLight: return "\u{f819}"
        case .newWhiteboardRegular: return "\u{f81a}"
        case .nextBold: return "\u{f81b}"
        case .nextLight: return "\u{f81c}"
        case .nextRegular: return "\u{f81d}"
        case .noDevicesBold: return "\u{f81e}"
        case .noDevicesLight: return "\u{f81f}"
        case .noDevicesRegular: return "\u{f820}"
        case .noiseDetectedCanceledFilled: return "\u{f821}"
        case .noiseDetectedFilled: return "\u{f822}"
        case .noiseNoneCanceledFilled: return "\u{f823}"
        case .noiseNoneFilled: return "\u{f824}"
        case .noiseRemovalBold: return "\u{f825}"
        case .noiseRemovalLight: return "\u{f826}"
        case .noiseRemovalRegular: return "\u{f827}"
        case .noteBold: return "\u{f828}"
        case .noteLight: return "\u{f829}"
        case .notePptBold: return "\u{f82a}"
        case .notePptLight: return "\u{f82b}"
        case .notePptRegular: return "\u{f82c}"
        case .noteRegular: return "\u{f82d}"
        case .notesBold: return "\u{f82e}"
        case .notesFilled: return "\u{f82f}"
        case .notesLight: return "\u{f830}"
        case .notesRegular: return "\u{f831}"
        case .numberBold: return "\u{f832}"
        case .numberLight: return "\u{f833}"
        case .numberRegular: return "\u{f834}"
        case .oldRemoteBold: return "\u{f835}"
        case .oldRemoteLight: return "\u{f836}"
        case .oldRemoteRegular: return "\u{f837}"
        case .oldTouchBold: return "\u{f838}"
        case .oldTouchLight: return "\u{f839}"
        case .oldTouchRegular: return "\u{f83a}"
        case .oneColumnBold: return "\u{f83b}"
        case .oneColumnLight: return "\u{f83c}"
        case .oneColumnRegular: return "\u{f83d}"
        case .oneTimeBold: return "\u{f83e}"
        case .oneTimeLight: return "\u{f83f}"
        case .oneTimeRegular: return "\u{f840}"
        case .openInFolderBold: return "\u{f841}"
        case .openInFolderLight: return "\u{f842}"
        case .openInFolderRegular: return "\u{f843}"
        case .openPagesBold: return "\u{f844}"
        case .openPagesLight: return "\u{f845}"
        case .openPagesRegular: return "\u{f846}"
        case .otherNumberBold: return "\u{f847}"
        case .otherNumberFilled: return "\u{f848}"
        case .otherNumberLight: return "\u{f849}"
        case .otherNumberRegular: return "\u{f84a}"
        case .otherNumberWarningBold: return "\u{f84b}"
        case .otherNumberWarningLight: return "\u{f84c}"
        case .otherNumberWarningRegular: return "\u{f84d}"
        case .outgoingCallLegacyBold: return "\u{f84e}"
        case .outgoingCallLegacyFilled: return "\u{f84f}"
        case .outgoingCallLegacyLight: return "\u{f850}"
        case .outgoingCallLegacyRegular: return "\u{f851}"
        case .overflowLeftBold: return "\u{f852}"
        case .overflowLeftLight: return "\u{f853}"
        case .overflowLeftRegular: return "\u{f854}"
        case .overflowRightBold: return "\u{f855}"
        case .overflowRightLight: return "\u{f856}"
        case .overflowRightRegular: return "\u{f857}"
        case .pairedCameraBold: return "\u{f858}"
        case .pairedCameraLight: return "\u{f859}"
        case .pairedCameraRegular: return "\u{f85a}"
        case .pairedDeviceBold: return "\u{f85b}"
        case .pairedDeviceLight: return "\u{f85c}"
        case .pairedDeviceRegular: return "\u{f85d}"
        case .pairedHandsetBold: return "\u{f85e}"
        case .pairedHandsetLight: return "\u{f85f}"
        case .pairedHandsetRegular: return "\u{f860}"
        case .pairingBold: return "\u{f861}"
        case .pairingLight: return "\u{f862}"
        case .pairingRegular: return "\u{f863}"
        case .parenthesisBold: return "\u{f864}"
        case .parenthesisFilled: return "\u{f865}"
        case .parenthesisLight: return "\u{f866}"
        case .parenthesisRegular: return "\u{f867}"
        case .parkedBold: return "\u{f868}"
        case .parkedFilled: return "\u{f869}"
        case .parkedLight: return "\u{f86a}"
        case .parkedRegular: return "\u{f86b}"
        case .parseBold: return "\u{f86c}"
        case .parseLight: return "\u{f86d}"
        case .parseRegular: return "\u{f86e}"
        case .partialBold: return "\u{f86f}"
        case .partialLight: return "\u{f870}"
        case .partialRegular: return "\u{f871}"
        case .participantAddBold: return "\u{f872}"
        case .participantAddLight: return "\u{f873}"
        case .participantAddRegular: return "\u{f874}"
        case .participantBlockedBold: return "\u{f875}"
        case .participantBlockedLight: return "\u{f876}"
        case .participantBlockedRegular: return "\u{f877}"
        case .participantBold: return "\u{f878}"
        case .participantFilled: return "\u{f879}"
        case .participantLight: return "\u{f87a}"
        case .participantListBold: return "\u{f87b}"
        case .participantListFilled: return "\u{f87c}"
        case .participantListLight: return "\u{f87d}"
        case .participantListRegular: return "\u{f87e}"
        case .participantRegular: return "\u{f87f}"
        case .participantRemoveBold: return "\u{f880}"
        case .participantRemoveLight: return "\u{f881}"
        case .participantRemoveRegular: return "\u{f882}"
        case .participantUnknownBold: return "\u{f883}"
        case .participantUnknownLight: return "\u{f884}"
        case .participantUnknownRegular: return "\u{f885}"
        case .passMouseBold: return "\u{f886}"
        case .passMouseLight: return "\u{f887}"
        case .passMouseRegular: return "\u{f888}"
        case .pauseBadgeFilled: return "\u{f889}"
        case .pauseBold: return "\u{f88a}"
        case .pauseFilled: return "\u{f88b}"
        case .pauseInteractionBold: return "\u{f88c}"
        case .pauseInteractionFilled: return "\u{f88d}"
        case .pauseInteractionLight: return "\u{f88e}"
        case .pauseInteractionRegular: return "\u{f88f}"
        case .pauseLight: return "\u{f890}"
        case .pauseRegular: return "\u{f891}"
        case .peopleAddBold: return "\u{f892}"
        case .peopleAddFilled: return "\u{f893}"
        case .peopleAddLight: return "\u{f894}"
        case .peopleAddRegular: return "\u{f895}"
        case .peopleBold: return "\u{f896}"
        case .peopleCircleBold: return "\u{f897}"
        case .peopleCircleFilled: return "\u{f898}"
        case .peopleCircleLight: return "\u{f899}"
        case .peopleCircleRegular: return "\u{f89a}"
        case .peopleFilled: return "\u{f89b}"
        case .peopleInsightsBold: return "\u{f89c}"
        case .peopleInsightsFilled: return "\u{f89d}"
        case .peopleInsightsLight: return "\u{f89e}"
        case .peopleInsightsRegular: return "\u{f89f}"
        case .peopleLight: return "\u{f8a0}"
        case .peopleManageBold: return "\u{f8a1}"
        case .peopleManageFilled: return "\u{f8a2}"
        case .peopleManageLight: return "\u{f8a3}"
        case .peopleManageRegular: return "\u{f8a4}"
        case .peopleRegular: return "\u{f8a5}"
        case .phoneAlertBold: return "\u{f8a6}"
        case .phoneAlertLight: return "\u{f8a7}"
        case .phoneAlertRegular: return "\u{f8a8}"
        case .phoneBadgeFilled: return "\u{f8a9}"
        case .phoneBold: return "\u{f8aa}"
        case .phoneFilled: return "\u{f8ab}"
        case .phoneLight: return "\u{f8ac}"
        case .phoneMutedBold: return "\u{f8ad}"
        case .phoneMutedLight: return "\u{f8ae}"
        case .phoneMutedRegular: return "\u{f8af}"
        case .phonePrivateBold: return "\u{f8b0}"
        case .phonePrivateLight: return "\u{f8b1}"
        case .phonePrivateRegular: return "\u{f8b2}"
        case .phoneRegular: return "\u{f8b3}"
        case .phoneReplyAllBold: return "\u{f8b4}"
        case .phoneReplyAllLight: return "\u{f8b5}"
        case .phoneReplyAllRegular: return "\u{f8b6}"
        case .phoneReplyBold: return "\u{f8b7}"
        case .phoneReplyLight: return "\u{f8b8}"
        case .phoneReplyRegular: return "\u{f8b9}"
        case .pickerBold: return "\u{f8ba}"
        case .pickerLight: return "\u{f8bb}"
        case .pickerRegular: return "\u{f8bc}"
        case .pieChartBold: return "\u{f8bd}"
        case .pieChartFilled: return "\u{f8be}"
        case .pieChartLight: return "\u{f8bf}"
        case .pieChartRegular: return "\u{f8c0}"
        case .pinBold: return "\u{f8c1}"
        case .pinFilled: return "\u{f8c2}"
        case .pinLight: return "\u{f8c3}"
        case .pinListActivityBold: return "\u{f8c4}"
        case .pinListActivityLight: return "\u{f8c5}"
        case .pinListActivityRegular: return "\u{f8c6}"
        case .pinListBold: return "\u{f8c7}"
        case .pinListLight: return "\u{f8c8}"
        case .pinListRegular: return "\u{f8c9}"
        case .pinMutedBold: return "\u{f8ca}"
        case .pinMutedFilled: return "\u{f8cb}"
        case .pinMutedLight: return "\u{f8cc}"
        case .pinMutedRegular: return "\u{f8cd}"
        case .pinRegular: return "\u{f8ce}"
        case .pipBold: return "\u{f8cf}"
        case .pipEnterBold: return "\u{f8d0}"
        case .pipEnterLight: return "\u{f8d1}"
        case .pipEnterRegular: return "\u{f8d2}"
        case .pipExitBold: return "\u{f8d3}"
        case .pipExitLight: return "\u{f8d4}"
        case .pipExitRegular: return "\u{f8d5}"
        case .pipFilled: return "\u{f8d6}"
        case .pipLight: return "\u{f8d7}"
        case .pipRegular: return "\u{f8d8}"
        case .placeholderBold: return "\u{f8d9}"
        case .placeholderFilled: return "\u{f8da}"
        case .placeholderLight: return "\u{f8db}"
        case .placeholderRegular: return "\u{f8dc}"
        case .playBold: return "\u{f8dd}"
        case .playCircleBold: return "\u{f8de}"
        case .playCircleFilled: return "\u{f8df}"
        case .playCircleLight: return "\u{f8e0}"
        case .playCircleRegular: return "\u{f8e1}"
        case .playFilled: return "\u{f8e2}"
        case .playLight: return "\u{f8e3}"
        case .playRegular: return "\u{f8e4}"
        case .plugAcBold: return "\u{f8e5}"
        case .plugAcLight: return "\u{f8e6}"
        case .plugAcRegular: return "\u{f8e7}"
        case .plusBold: return "\u{f8e8}"
        case .plusCircleBold: return "\u{f8e9}"
        case .plusCircleFilled: return "\u{f8ea}"
        case .plusCircleLight: return "\u{f8eb}"
        case .plusCircleRegular: return "\u{f8ec}"
        case .plusLight: return "\u{f8ed}"
        case .plusRegular: return "\u{f8ee}"
        case .pmrBold: return "\u{f8ef}"
        case .pmrFilled: return "\u{f8f0}"
        case .pmrLight: return "\u{f8f1}"
        case .pmrRegular: return "\u{f8f2}"
        case .pollBold: return "\u{f8f3}"
        case .pollFilled: return "\u{f8f4}"
        case .pollLight: return "\u{f8f5}"
        case .pollRegular: return "\u{f8f6}"
        case .popInBold: return "\u{f8f7}"
        case .popInLight: return "\u{f8f8}"
        case .popInRegular: return "\u{f8f9}"
        case .popOutBold: return "\u{f8fa}"
        case .popOutLight: return "\u{f8fb}"
        case .popOutRegular: return "\u{f8fc}"
        case .popUpBold: return "\u{f8fd}"
        case .popUpLight: return "\u{f8fe}"
        case .popUpRegular: return "\u{f8ff}"
        case .portraitLandscapeBold: return "\u{f900}"
        case .portraitLandscapeLight: return "\u{f901}"
        case .portraitLandscapeRegular: return "\u{f902}"
        case .potentialFraudBold: return "\u{f903}"
        case .potentialFraudFilled: return "\u{f904}"
        case .potentialFraudLight: return "\u{f905}"
        case .potentialFraudRegular: return "\u{f906}"
        case .powerAcBold: return "\u{f907}"
        case .powerAcLight: return "\u{f908}"
        case .powerAcRegular: return "\u{f909}"
        case .powerBold: return "\u{f90a}"
        case .powerLight: return "\u{f90b}"
        case .powerRegular: return "\u{f90c}"
        case .preHeaderBold: return "\u{f90d}"
        case .preHeaderLight: return "\u{f90e}"
        case .preHeaderRegular: return "\u{f90f}"
        case .premiumBold: return "\u{f910}"
        case .premiumLight: return "\u{f911}"
        case .premiumRegular: return "\u{f912}"
        case .presentationBold: return "\u{f913}"
        case .presentationLight: return "\u{f914}"
        case .presentationRegular: return "\u{f915}"
        case .preventDownloadBold: return "\u{f916}"
        case .preventDownloadFilled: return "\u{f917}"
        case .preventDownloadLight: return "\u{f918}"
        case .preventDownloadRegular: return "\u{f919}"
        case .primaryParticipantBold: return "\u{f91a}"
        case .primaryParticipantFilled: return "\u{f91b}"
        case .primaryParticipantLight: return "\u{f91c}"
        case .primaryParticipantRegular: return "\u{f91d}"
        case .printBold: return "\u{f91e}"
        case .printLight: return "\u{f91f}"
        case .printRegular: return "\u{f920}"
        case .priorityBadgeFilled: return "\u{f921}"
        case .priorityCircleBold: return "\u{f922}"
        case .priorityCircleFilled: return "\u{f923}"
        case .priorityCircleLight: return "\u{f924}"
        case .priorityCircleRegular: return "\u{f925}"
        case .priorityCircleTwoBold: return "\u{f926}"
        case .priorityCircleTwoFilled: return "\u{f927}"
        case .priorityCircleTwoLight: return "\u{f928}"
        case .priorityCircleTwoRegular: return "\u{f929}"
        case .priorityWaveBold: return "\u{f92a}"
        case .priorityWaveLight: return "\u{f92b}"
        case .priorityWaveRegular: return "\u{f92c}"
        case .privacyCircleBold: return "\u{f92d}"
        case .privacyCircleFilled: return "\u{f92e}"
        case .privacyCircleLight: return "\u{f92f}"
        case .privacyCircleRegular: return "\u{f930}"
        case .privateBold: return "\u{f931}"
        case .privateCircleBold: return "\u{f932}"
        case .privateCircleFilled: return "\u{f933}"
        case .privateCircleLight: return "\u{f934}"
        case .privateCircleRegular: return "\u{f935}"
        case .privateLight: return "\u{f936}"
        case .privateMeetingBold: return "\u{f937}"
        case .privateMeetingLight: return "\u{f938}"
        case .privateMeetingRegular: return "\u{f939}"
        case .privateRegular: return "\u{f93a}"
        case .productDemoBold: return "\u{f93b}"
        case .productDemoLight: return "\u{f93c}"
        case .productDemoRegular: return "\u{f93d}"
        case .promptsAiBold: return "\u{f93e}"
        case .promptsAiLight: return "\u{f93f}"
        case .promptsAiRegular: return "\u{f940}"
        case .proximityBold: return "\u{f941}"
        case .proximityLight: return "\u{f942}"
        case .proximityMutedBold: return "\u{f943}"
        case .proximityMutedLight: return "\u{f944}"
        case .proximityMutedRegular: return "\u{f945}"
        case .proximityRegular: return "\u{f946}"
        case .proximityVideoBold: return "\u{f947}"
        case .proximityVideoLight: return "\u{f948}"
        case .proximityVideoRegular: return "\u{f949}"
        case .ptoPresenceBold: return "\u{f94a}"
        case .ptoPresenceFilled: return "\u{f94b}"
        case .ptoPresenceLight: return "\u{f94c}"
        case .ptoPresenceRegular: return "\u{f94d}"
        case .pullCallBold: return "\u{f94e}"
        case .pullCallFilled: return "\u{f94f}"
        case .pullCallLight: return "\u{f950}"
        case .pullCallRegular: return "\u{f951}"
        case .qABold: return "\u{f952}"
        case .qAFilled: return "\u{f953}"
        case .qALight: return "\u{f954}"
        case .qARegular: return "\u{f955}"
        case .qrCodeBold: return "\u{f956}"
        case .qrCodeLight: return "\u{f957}"
        case .qrCodeRegular: return "\u{f958}"
        case .qrCodeScanBold: return "\u{f959}"
        case .qrCodeScanLight: return "\u{f95a}"
        case .qrCodeScanRegular: return "\u{f95b}"
        case .qualityBold: return "\u{f95c}"
        case .qualityLight: return "\u{f95d}"
        case .qualityRegular: return "\u{f95e}"
        case .queueContactBold: return "\u{f95f}"
        case .queueContactFilled: return "\u{f960}"
        case .queueContactLight: return "\u{f961}"
        case .queueContactRegular: return "\u{f962}"
        case .queuedInteractionBold: return "\u{f963}"
        case .queuedInteractionFilled: return "\u{f964}"
        case .queuedInteractionLight: return "\u{f965}"
        case .queuedInteractionRegular: return "\u{f966}"
        case .quietBold: return "\u{f967}"
        case .quietHoursPresenceBold: return "\u{f968}"
        case .quietHoursPresenceFilled: return "\u{f969}"
        case .quietHoursPresenceLight: return "\u{f96a}"
        case .quietHoursPresenceRegular: return "\u{f96b}"
        case .quietLight: return "\u{f96c}"
        case .quietRegular: return "\u{f96d}"
        case .radioButtonGroupBold: return "\u{f96e}"
        case .radioButtonGroupLight: return "\u{f96f}"
        case .radioButtonGroupRegular: return "\u{f970}"
        case .raiseHandBold: return "\u{f971}"
        case .raiseHandCircleFilled: return "\u{f972}"
        case .raiseHandFilled: return "\u{f973}"
        case .raiseHandLight: return "\u{f974}"
        case .raiseHandRegular: return "\u{f975}"
        case .ramBold: return "\u{f976}"
        case .ramLight: return "\u{f977}"
        case .ramRegular: return "\u{f978}"
        case .reactionsBold: return "\u{f979}"
        case .reactionsFilled: return "\u{f97a}"
        case .reactionsLight: return "\u{f97b}"
        case .reactionsRegular: return "\u{f97c}"
        case .reactivateBold: return "\u{f97d}"
        case .reactivateLight: return "\u{f97e}"
        case .reactivateRegular: return "\u{f97f}"
        case .receiveVoiceBold: return "\u{f980}"
        case .receiveVoiceFilled: return "\u{f981}"
        case .receiveVoiceLight: return "\u{f982}"
        case .receiveVoiceRegular: return "\u{f983}"
        case .recentsBold: return "\u{f984}"
        case .recentsFilled: return "\u{f985}"
        case .recentsLight: return "\u{f986}"
        case .recentsPresenceBadgeFilled: return "\u{f987}"
        case .recentsPresenceBold: return "\u{f988}"
        case .recentsPresenceFilled: return "\u{f989}"
        case .recentsPresenceLight: return "\u{f98a}"
        case .recentsPresenceRegular: return "\u{f98b}"
        case .recentsRegular: return "\u{f98c}"
        case .recordActiveBadgeFilled: return "\u{f98d}"
        case .recordActiveBold: return "\u{f98e}"
        case .recordActiveFilled: return "\u{f98f}"
        case .recordActiveLight: return "\u{f990}"
        case .recordActiveRegular: return "\u{f991}"
        case .recordBold: return "\u{f992}"
        case .recordFilled: return "\u{f993}"
        case .recordLight: return "\u{f994}"
        case .recordPausedBadgeFilled: return "\u{f995}"
        case .recordPausedBold: return "\u{f996}"
        case .recordPausedFilled: return "\u{f997}"
        case .recordPausedLight: return "\u{f998}"
        case .recordPausedRegular: return "\u{f999}"
        case .recordRegular: return "\u{f99a}"
        case .recurringBold: return "\u{f99b}"
        case .recurringLight: return "\u{f99c}"
        case .recurringOffBold: return "\u{f99d}"
        case .recurringOffLight: return "\u{f99e}"
        case .recurringOffRegular: return "\u{f99f}"
        case .recurringRegular: return "\u{f9a0}"
        case .redoBold: return "\u{f9a1}"
        case .redoLight: return "\u{f9a2}"
        case .redoRegular: return "\u{f9a3}"
        case .refreshBold: return "\u{f9a4}"
        case .refreshLight: return "\u{f9a5}"
        case .refreshRegular: return "\u{f9a6}"
        case .remoteDesktopControlBold: return "\u{f9a7}"
        case .remoteDesktopControlFilled: return "\u{f9a8}"
        case .remoteDesktopControlLight: return "\u{f9a9}"
        case .remoteDesktopControlRegular: return "\u{f9aa}"
        case .removeBold: return "\u{f9ab}"
        case .removeFilled: return "\u{f9ac}"
        case .removeLight: return "\u{f9ad}"
        case .removeRegular: return "\u{f9ae}"
        case .replyBold: return "\u{f9af}"
        case .replyFilled: return "\u{f9b0}"
        case .replyLight: return "\u{f9b1}"
        case .replyListBold: return "\u{f9b2}"
        case .replyListLight: return "\u{f9b3}"
        case .replyListRegular: return "\u{f9b4}"
        case .replyPrivatelyBold: return "\u{f9b5}"
        case .replyPrivatelyLight: return "\u{f9b6}"
        case .replyPrivatelyRegular: return "\u{f9b7}"
        case .replyRegular: return "\u{f9b8}"
        case .resetBold: return "\u{f9b9}"
        case .resetLight: return "\u{f9ba}"
        case .resetRegular: return "\u{f9bb}"
        case .resizeCornerBold: return "\u{f9bc}"
        case .resizeCornerLight: return "\u{f9bd}"
        case .resizeCornerRegular: return "\u{f9be}"
        case .responsiveMobileBold: return "\u{f9bf}"
        case .responsiveMobileLight: return "\u{f9c0}"
        case .responsiveMobileRegular: return "\u{f9c1}"
        case .restartBold: return "\u{f9c2}"
        case .restartLight: return "\u{f9c3}"
        case .restartRegular: return "\u{f9c4}"
        case .resumeInteractionBold: return "\u{f9c5}"
        case .resumeInteractionFilled: return "\u{f9c6}"
        case .resumeInteractionLight: return "\u{f9c7}"
        case .resumeInteractionRegular: return "\u{f9c8}"
        case .retrieveCallBold: return "\u{f9c9}"
        case .retrieveCallFilled: return "\u{f9ca}"
        case .retrieveCallLight: return "\u{f9cb}"
        case .retrieveCallRegular: return "\u{f9cc}"
        case .returnBold: return "\u{f9cd}"
        case .returnLight: return "\u{f9ce}"
        case .returnRegular: return "\u{f9cf}"
        case .rewindTenSecBold: return "\u{f9d0}"
        case .rewindTenSecLight: return "\u{f9d1}"
        case .rewindTenSecRegular: return "\u{f9d2}"
        case .ringtoneBold: return "\u{f9d3}"
        case .ringtoneLight: return "\u{f9d4}"
        case .ringtoneRegular: return "\u{f9d5}"
        case .roomCalendarBold: return "\u{f9d6}"
        case .roomCalendarLight: return "\u{f9d7}"
        case .roomCalendarRegular: return "\u{f9d8}"
        case .roomLightsBold: return "\u{f9d9}"
        case .roomLightsFilled: return "\u{f9da}"
        case .roomLightsLight: return "\u{f9db}"
        case .roomLightsRegular: return "\u{f9dc}"
        case .rotateContentBold: return "\u{f9dd}"
        case .rotateContentFilled: return "\u{f9de}"
        case .rotateContentLight: return "\u{f9df}"
        case .rotateContentRegular: return "\u{f9e0}"
        case .rssBold: return "\u{f9e1}"
        case .rssFilled: return "\u{f9e2}"
        case .rssLight: return "\u{f9e3}"
        case .rssRegular: return "\u{f9e4}"
        case .ruleBasedBold: return "\u{f9e5}"
        case .ruleBasedLight: return "\u{f9e6}"
        case .ruleBasedRegular: return "\u{f9e7}"
        case .rulerBold: return "\u{f9e8}"
        case .rulerFilled: return "\u{f9e9}"
        case .rulerLight: return "\u{f9ea}"
        case .rulerRegular: return "\u{f9eb}"
        case .runningApplicationBold: return "\u{f9ec}"
        case .runningApplicationFilled: return "\u{f9ed}"
        case .runningApplicationLight: return "\u{f9ee}"
        case .runningApplicationRegular: return "\u{f9ef}"
        case .saveBold: return "\u{f9f0}"
        case .saveLight: return "\u{f9f1}"
        case .saveRegular: return "\u{f9f2}"
        case .saveTranscriptBold: return "\u{f9f3}"
        case .saveTranscriptFilled: return "\u{f9f4}"
        case .saveTranscriptLight: return "\u{f9f5}"
        case .saveTranscriptRegular: return "\u{f9f6}"
        case .scanBold: return "\u{f9f7}"
        case .scanLight: return "\u{f9f8}"
        case .scanRegular: return "\u{f9f9}"
        case .scheduleAiBold: return "\u{f9fa}"
        case .scheduleAiLight: return "\u{f9fb}"
        case .scheduleAiRegular: return "\u{f9fc}"
        case .scheduleSendBold: return "\u{f9fd}"
        case .scheduleSendFilled: return "\u{f9fe}"
        case .scheduleSendLight: return "\u{f9ff}"
        case .scheduleSendRegular: return "\u{fa00}"
        case .scheduleWinnerBold: return "\u{fa01}"
        case .scheduleWinnerFilled: return "\u{fa02}"
        case .scheduleWinnerLight: return "\u{fa03}"
        case .scheduleWinnerRegular: return "\u{fa04}"
        case .schedulerAvailableBold: return "\u{fa05}"
        case .schedulerAvailableLight: return "\u{fa06}"
        case .schedulerAvailableRegular: return "\u{fa07}"
        case .schedulerNotWorkingHoursBold: return "\u{fa08}"
        case .schedulerNotWorkingHoursLight: return "\u{fa09}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa0a}"
        case .schedulerUnavailableBold: return "\u{fa0b}"
        case .schedulerUnavailableLight: return "\u{fa0c}"
        case .schedulerUnavailableRegular: return "\u{fa0d}"
        case .schedulerUnknownBold: return "\u{fa0e}"
        case .schedulerUnknownLight: return "\u{fa0f}"
        case .schedulerUnknownRegular: return "\u{fa10}"
        case .screenshotBold: return "\u{fa11}"
        case .screenshotDocBold: return "\u{fa12}"
        case .screenshotDocFilled: return "\u{fa13}"
        case .screenshotDocLight: return "\u{fa14}"
        case .screenshotDocRegular: return "\u{fa15}"
        case .screenshotLight: return "\u{fa16}"
        case .screenshotRegular: return "\u{fa17}"
        case .searchAiBold: return "\u{fa18}"
        case .searchAiLight: return "\u{fa19}"
        case .searchAiRegular: return "\u{fa1a}"
        case .searchBold: return "\u{fa1b}"
        case .searchFilled: return "\u{fa1c}"
        case .searchLight: return "\u{fa1d}"
        case .searchRegular: return "\u{fa1e}"
        case .secondaryArrowBold: return "\u{fa1f}"
        case .secondaryArrowLight: return "\u{fa20}"
        case .secondaryArrowRegular: return "\u{fa21}"
        case .secureCallLockBold: return "\u{fa22}"
        case .secureCallLockFilled: return "\u{fa23}"
        case .secureCallLockLight: return "\u{fa24}"
        case .secureCallLockRegular: return "\u{fa25}"
        case .secureCallShieldBold: return "\u{fa26}"
        case .secureCallShieldFilled: return "\u{fa27}"
        case .secureCallShieldLight: return "\u{fa28}"
        case .secureCallShieldRegular: return "\u{fa29}"
        case .secureCircleBold: return "\u{fa2a}"
        case .secureCircleFilled: return "\u{fa2b}"
        case .secureCircleLight: return "\u{fa2c}"
        case .secureCircleRegular: return "\u{fa2d}"
        case .secureLockBold: return "\u{fa2e}"
        case .secureLockFilled: return "\u{fa2f}"
        case .secureLockLight: return "\u{fa30}"
        case .secureLockRegular: return "\u{fa31}"
        case .segmentExcludeFilled: return "\u{fa32}"
        case .segmentFilterFilled: return "\u{fa33}"
        case .segmentIncludeFilled: return "\u{fa34}"
        case .selectAllBold: return "\u{fa35}"
        case .selectAllFilled: return "\u{fa36}"
        case .selectAllLight: return "\u{fa37}"
        case .selectAllRegular: return "\u{fa38}"
        case .selectionBold: return "\u{fa39}"
        case .selectionFilled: return "\u{fa3a}"
        case .selectionLight: return "\u{fa3b}"
        case .selectionRegular: return "\u{fa3c}"
        case .sendBold: return "\u{fa3d}"
        case .sendDigitsBold: return "\u{fa3e}"
        case .sendDigitsFilled: return "\u{fa3f}"
        case .sendDigitsLight: return "\u{fa40}"
        case .sendDigitsRegular: return "\u{fa41}"
        case .sendFilled: return "\u{fa42}"
        case .sendLight: return "\u{fa43}"
        case .sendRegular: return "\u{fa44}"
        case .sendVoiceBold: return "\u{fa45}"
        case .sendVoiceFilled: return "\u{fa46}"
        case .sendVoiceLight: return "\u{fa47}"
        case .sendVoiceRegular: return "\u{fa48}"
        case .serverBold: return "\u{fa49}"
        case .serverErrorBold: return "\u{fa4a}"
        case .serverErrorLight: return "\u{fa4b}"
        case .serverErrorRegular: return "\u{fa4c}"
        case .serverLight: return "\u{fa4d}"
        case .serverRegular: return "\u{fa4e}"
        case .servicesBold: return "\u{fa4f}"
        case .servicesLight: return "\u{fa50}"
        case .servicesRegular: return "\u{fa51}"
        case .setVariableBold: return "\u{fa52}"
        case .setVariableLight: return "\u{fa53}"
        case .setVariableRegular: return "\u{fa54}"
        case .settingsBold: return "\u{fa55}"
        case .settingsFilled: return "\u{fa56}"
        case .settingsLight: return "\u{fa57}"
        case .settingsRegular: return "\u{fa58}"
        case .setupAssistantBold: return "\u{fa59}"
        case .setupAssistantLight: return "\u{fa5a}"
        case .setupAssistantRegular: return "\u{fa5b}"
        case .sftpBold: return "\u{fa5c}"
        case .sftpLight: return "\u{fa5d}"
        case .sftpRegular: return "\u{fa5e}"
        case .shapeCircleBold: return "\u{fa5f}"
        case .shapeCircleFilled: return "\u{fa60}"
        case .shapeCircleLight: return "\u{fa61}"
        case .shapeCircleMdFilled: return "\u{fa62}"
        case .shapeCircleRegular: return "\u{fa63}"
        case .shapeCircleSmFilled: return "\u{fa64}"
        case .shapeDiagonalLineBold: return "\u{fa65}"
        case .shapeDiagonalLineLight: return "\u{fa66}"
        case .shapeDiagonalLineRegular: return "\u{fa67}"
        case .shapeDiamondBold: return "\u{fa68}"
        case .shapeDiamondFilled: return "\u{fa69}"
        case .shapeDiamondLight: return "\u{fa6a}"
        case .shapeDiamondRegular: return "\u{fa6b}"
        case .shapeOvalBold: return "\u{fa6c}"
        case .shapeOvalLight: return "\u{fa6d}"
        case .shapeOvalRegular: return "\u{fa6e}"
        case .shapeSquareBold: return "\u{fa6f}"
        case .shapeSquareFilled: return "\u{fa70}"
        case .shapeSquareLight: return "\u{fa71}"
        case .shapeSquareRegular: return "\u{fa72}"
        case .shapeTriangleBold: return "\u{fa73}"
        case .shapeTriangleFilled: return "\u{fa74}"
        case .shapeTriangleLight: return "\u{fa75}"
        case .shapeTriangleRegular: return "\u{fa76}"
        case .shapesBold: return "\u{fa77}"
        case .shapesFilled: return "\u{fa78}"
        case .shapesLight: return "\u{fa79}"
        case .shapesRegular: return "\u{fa7a}"
        case .shareCNativeAdrBold: return "\u{fa7b}"
        case .shareCNativeAdrFilled: return "\u{fa7c}"
        case .shareCNativeAdrLight: return "\u{fa7d}"
        case .shareCNativeAdrRegular: return "\u{fa7e}"
        case .shareCNativeIphBold: return "\u{fa7f}"
        case .shareCNativeIphLight: return "\u{fa80}"
        case .shareCNativeIphRegular: return "\u{fa81}"
        case .shareContentOnDeviceBold: return "\u{fa82}"
        case .shareContentOnDeviceLight: return "\u{fa83}"
        case .shareContentOnDeviceRegular: return "\u{fa84}"
        case .shareScreenAddBold: return "\u{fa85}"
        case .shareScreenAddLight: return "\u{fa86}"
        case .shareScreenAddRegular: return "\u{fa87}"
        case .shareScreenBadgeFilled: return "\u{fa88}"
        case .shareScreenBold: return "\u{fa89}"
        case .shareScreenFilled: return "\u{fa8a}"
        case .shareScreenLight: return "\u{fa8b}"
        case .shareScreenRegular: return "\u{fa8c}"
        case .shareSpaceBold: return "\u{fa8d}"
        case .shareSpaceLight: return "\u{fa8e}"
        case .shareSpaceRegular: return "\u{fa8f}"
        case .shieldBold: return "\u{fa90}"
        case .shieldLight: return "\u{fa91}"
        case .shieldRegular: return "\u{fa92}"
        case .shoppingCartBold: return "\u{fa93}"
        case .shoppingCartFilled: return "\u{fa94}"
        case .shoppingCartLight: return "\u{fa95}"
        case .shoppingCartRegular: return "\u{fa96}"
        case .shortTextBoxBold: return "\u{fa97}"
        case .shortTextBoxLight: return "\u{fa98}"
        case .shortTextBoxRegular: return "\u{fa99}"
        case .showBold: return "\u{fa9a}"
        case .showFilled: return "\u{fa9b}"
        case .showLight: return "\u{fa9c}"
        case .showRegular: return "\u{fa9d}"
        case .sidePanelBold: return "\u{fa9e}"
        case .sidePanelFilled: return "\u{fa9f}"
        case .sidePanelLight: return "\u{faa0}"
        case .sidePanelRegular: return "\u{faa1}"
        case .signInBold: return "\u{faa2}"
        case .signInFilled: return "\u{faa3}"
        case .signInForcedBold: return "\u{faa4}"
        case .signInForcedLight: return "\u{faa5}"
        case .signInForcedRegular: return "\u{faa6}"
        case .signInLight: return "\u{faa7}"
        case .signInRegular: return "\u{faa8}"
        case .signLangIntBold: return "\u{faa9}"
        case .signLangIntLight: return "\u{faaa}"
        case .signLangIntRegular: return "\u{faab}"
        case .signOutBold: return "\u{faac}"
        case .signOutLight: return "\u{faad}"
        case .signOutRegular: return "\u{faae}"
        case .signalFourBold: return "\u{faaf}"
        case .signalFourLight: return "\u{fab0}"
        case .signalFourRegular: return "\u{fab1}"
        case .signalOneBold: return "\u{fab2}"
        case .signalOneLight: return "\u{fab3}"
        case .signalOneRegular: return "\u{fab4}"
        case .signalThreeBold: return "\u{fab5}"
        case .signalThreeLight: return "\u{fab6}"
        case .signalThreeRegular: return "\u{fab7}"
        case .signalTwoBold: return "\u{fab8}"
        case .signalTwoLight: return "\u{fab9}"
        case .signalTwoRegular: return "\u{faba}"
        case .signalZeroBold: return "\u{fabb}"
        case .signalZeroLight: return "\u{fabc}"
        case .signalZeroRegular: return "\u{fabd}"
        case .simplePromotionBold: return "\u{fabe}"
        case .simplePromotionLight: return "\u{fabf}"
        case .simplePromotionRegular: return "\u{fac0}"
        case .singleNumberReachBold: return "\u{fac1}"
        case .singleNumberReachLight: return "\u{fac2}"
        case .singleNumberReachRegular: return "\u{fac3}"
        case .sipRegistrationInProgressBold: return "\u{fac4}"
        case .sipRegistrationInProgressFilled: return "\u{fac5}"
        case .sipRegistrationInProgressLight: return "\u{fac6}"
        case .sipRegistrationInProgressRegular: return "\u{fac7}"
        case .skipBold: return "\u{fac8}"
        case .skipBwBold: return "\u{fac9}"
        case .skipBwFilled: return "\u{faca}"
        case .skipBwLight: return "\u{facb}"
        case .skipBwRegular: return "\u{facc}"
        case .skipFwBold: return "\u{facd}"
        case .skipFwFilled: return "\u{face}"
        case .skipFwLight: return "\u{facf}"
        case .skipFwRegular: return "\u{fad0}"
        case .skipLight: return "\u{fad1}"
        case .skipRegular: return "\u{fad2}"
        case .smartAudioBold: return "\u{fad3}"
        case .smartAudioLight: return "\u{fad4}"
        case .smartAudioRegular: return "\u{fad5}"
        case .smsFilled: return "\u{fad6}"
        case .smsInboundBold: return "\u{fad7}"
        case .smsInboundLight: return "\u{fad8}"
        case .smsInboundRegular: return "\u{fad9}"
        case .smsMessageBold: return "\u{fada}"
        case .smsMessageFilled: return "\u{fadb}"
        case .smsMessageLight: return "\u{fadc}"
        case .smsMessageRegular: return "\u{fadd}"
        case .smsOutgoingFilled: return "\u{fade}"
        case .smsUnreadBold: return "\u{fadf}"
        case .smsUnreadLight: return "\u{fae0}"
        case .smsUnreadRegular: return "\u{fae1}"
        case .sortAscendingBold: return "\u{fae2}"
        case .sortAscendingLight: return "\u{fae3}"
        case .sortAscendingRegular: return "\u{fae4}"
        case .sortDescendingBold: return "\u{fae5}"
        case .sortDescendingLight: return "\u{fae6}"
        case .sortDescendingRegular: return "\u{fae7}"
        case .soundDefaultBold: return "\u{fae8}"
        case .soundDefaultLight: return "\u{fae9}"
        case .soundDefaultRegular: return "\u{faea}"
        case .sparkleBold: return "\u{faeb}"
        case .sparkleFilled: return "\u{faec}"
        case .sparkleLight: return "\u{faed}"
        case .sparkleRegular: return "\u{faee}"
        case .speakerBold: return "\u{faef}"
        case .speakerDisconnectedBold: return "\u{faf0}"
        case .speakerDisconnectedFilled: return "\u{faf1}"
        case .speakerDisconnectedLight: return "\u{faf2}"
        case .speakerDisconnectedRegular: return "\u{faf3}"
        case .speakerFilled: return "\u{faf4}"
        case .speakerLight: return "\u{faf5}"
        case .speakerMutedBold: return "\u{faf6}"
        case .speakerMutedFilled: return "\u{faf7}"
        case .speakerMutedLight: return "\u{faf8}"
        case .speakerMutedRegular: return "\u{faf9}"
        case .speakerOffBold: return "\u{fafa}"
        case .speakerOffFilled: return "\u{fafb}"
        case .speakerOffLight: return "\u{fafc}"
        case .speakerOffRegular: return "\u{fafd}"
        case .speakerOnBold: return "\u{fafe}"
        case .speakerOnLight: return "\u{faff}"
        case .speakerOnRegular: return "\u{fb00}"
        case .speakerRegular: return "\u{fb01}"
        case .speakerTurnDownBold: return "\u{fb02}"
        case .speakerTurnDownFilled: return "\u{fb03}"
        case .speakerTurnDownLight: return "\u{fb04}"
        case .speakerTurnDownRegular: return "\u{fb05}"
        case .speakerTurnUpBold: return "\u{fb06}"
        case .speakerTurnUpFilled: return "\u{fb07}"
        case .speakerTurnUpLight: return "\u{fb08}"
        case .speakerTurnUpRegular: return "\u{fb09}"
        case .speedDialBold: return "\u{fb0a}"
        case .speedDialFilled: return "\u{fb0b}"
        case .speedDialLight: return "\u{fb0c}"
        case .speedDialRegular: return "\u{fb0d}"
        case .spellCheckerBold: return "\u{fb0e}"
        case .spellCheckerLight: return "\u{fb0f}"
        case .spellCheckerRegular: return "\u{fb10}"
        case .splitViewBold: return "\u{fb11}"
        case .splitViewLight: return "\u{fb12}"
        case .splitViewRegular: return "\u{fb13}"
        case .stackedAreaChartBold: return "\u{fb14}"
        case .stackedAreaChartFilled: return "\u{fb15}"
        case .stackedAreaChartFullBold: return "\u{fb16}"
        case .stackedAreaChartFullFilled: return "\u{fb17}"
        case .stackedAreaChartFullLight: return "\u{fb18}"
        case .stackedAreaChartFullRegular: return "\u{fb19}"
        case .stackedAreaChartLight: return "\u{fb1a}"
        case .stackedAreaChartRegular: return "\u{fb1b}"
        case .stackedBarChartBold: return "\u{fb1c}"
        case .stackedBarChartFilled: return "\u{fb1d}"
        case .stackedBarChartFullBold: return "\u{fb1e}"
        case .stackedBarChartFullFilled: return "\u{fb1f}"
        case .stackedBarChartFullLight: return "\u{fb20}"
        case .stackedBarChartFullRegular: return "\u{fb21}"
        case .stackedBarChartLight: return "\u{fb22}"
        case .stackedBarChartRegular: return "\u{fb23}"
        case .startChatBold: return "\u{fb24}"
        case .startChatLight: return "\u{fb25}"
        case .startChatRegular: return "\u{fb26}"
        case .stethoscopeBold: return "\u{fb27}"
        case .stethoscopeLight: return "\u{fb28}"
        case .stethoscopeRegular: return "\u{fb29}"
        case .stickersBold: return "\u{fb2a}"
        case .stickersLight: return "\u{fb2b}"
        case .stickersRegular: return "\u{fb2c}"
        case .stickiesBold: return "\u{fb2d}"
        case .stickiesLight: return "\u{fb2e}"
        case .stickiesRegular: return "\u{fb2f}"
        case .stopBold: return "\u{fb30}"
        case .stopCircleBold: return "\u{fb31}"
        case .stopCircleFilled: return "\u{fb32}"
        case .stopCircleLight: return "\u{fb33}"
        case .stopCircleRegular: return "\u{fb34}"
        case .stopContentShareBold: return "\u{fb35}"
        case .stopContentShareLight: return "\u{fb36}"
        case .stopContentShareRegular: return "\u{fb37}"
        case .stopFilled: return "\u{fb38}"
        case .stopLight: return "\u{fb39}"
        case .stopRegular: return "\u{fb3a}"
        case .storedInfoBold: return "\u{fb3b}"
        case .storedInfoFilled: return "\u{fb3c}"
        case .storedInfoLight: return "\u{fb3d}"
        case .storedInfoRegular: return "\u{fb3e}"
        case .streamingBold: return "\u{fb3f}"
        case .streamingLight: return "\u{fb40}"
        case .streamingRegular: return "\u{fb41}"
        case .strikethroughBold: return "\u{fb42}"
        case .strikethroughFilled: return "\u{fb43}"
        case .strikethroughLight: return "\u{fb44}"
        case .strikethroughRegular: return "\u{fb45}"
        case .studioModeBold: return "\u{fb46}"
        case .studioModeLight: return "\u{fb47}"
        case .studioModeRegular: return "\u{fb48}"
        case .subscriptBold: return "\u{fb49}"
        case .subscriptLight: return "\u{fb4a}"
        case .subscriptRegular: return "\u{fb4b}"
        case .summarizeAiBold: return "\u{fb4c}"
        case .summarizeAiLight: return "\u{fb4d}"
        case .summarizeAiRegular: return "\u{fb4e}"
        case .superscriptBold: return "\u{fb4f}"
        case .superscriptLight: return "\u{fb50}"
        case .superscriptRegular: return "\u{fb51}"
        case .surveyBold: return "\u{fb52}"
        case .surveyFilled: return "\u{fb53}"
        case .surveyLight: return "\u{fb54}"
        case .surveyRegular: return "\u{fb55}"
        case .sxEightyCodecBold: return "\u{fb56}"
        case .sxEightyCodecLight: return "\u{fb57}"
        case .sxEightyCodecRegular: return "\u{fb58}"
        case .sxTenBold: return "\u{fb59}"
        case .sxTenLight: return "\u{fb5a}"
        case .sxTenRegular: return "\u{fb5b}"
        case .sxTwentyBold: return "\u{fb5c}"
        case .sxTwentyLight: return "\u{fb5d}"
        case .sxTwentyRegular: return "\u{fb5e}"
        case .tableBold: return "\u{fb5f}"
        case .tableExtenderBold: return "\u{fb60}"
        case .tableExtenderFilled: return "\u{fb61}"
        case .tableExtenderLight: return "\u{fb62}"
        case .tableExtenderRegular: return "\u{fb63}"
        case .tableLight: return "\u{fb64}"
        case .tableRegular: return "\u{fb65}"
        case .tabletBold: return "\u{fb66}"
        case .tabletLight: return "\u{fb67}"
        case .tabletRegular: return "\u{fb68}"
        case .tabsBold: return "\u{fb69}"
        case .tabsLight: return "\u{fb6a}"
        case .tabsRegular: return "\u{fb6b}"
        case .tagBold: return "\u{fb6c}"
        case .tagLight: return "\u{fb6d}"
        case .tagRegular: return "\u{fb6e}"
        case .tapBold: return "\u{fb6f}"
        case .tapFilled: return "\u{fb70}"
        case .tapLight: return "\u{fb71}"
        case .tapRegular: return "\u{fb72}"
        case .telepresenceAlertBold: return "\u{fb73}"
        case .telepresenceAlertLight: return "\u{fb74}"
        case .telepresenceAlertMutedBold: return "\u{fb75}"
        case .telepresenceAlertMutedLight: return "\u{fb76}"
        case .telepresenceAlertMutedRegular: return "\u{fb77}"
        case .telepresenceAlertRegular: return "\u{fb78}"
        case .telepresenceBold: return "\u{fb79}"
        case .telepresenceIxFiveThousandBold: return "\u{fb7a}"
        case .telepresenceIxFiveThousandLight: return "\u{fb7b}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb7c}"
        case .telepresenceLight: return "\u{fb7d}"
        case .telepresenceMutedBold: return "\u{fb7e}"
        case .telepresenceMutedLight: return "\u{fb7f}"
        case .telepresenceMutedRegular: return "\u{fb80}"
        case .telepresencePrivateBold: return "\u{fb81}"
        case .telepresencePrivateLight: return "\u{fb82}"
        case .telepresencePrivateRegular: return "\u{fb83}"
        case .telepresenceRegular: return "\u{fb84}"
        case .temperatureBold: return "\u{fb85}"
        case .temperatureLight: return "\u{fb86}"
        case .temperatureRegular: return "\u{fb87}"
        case .testTubeBold: return "\u{fb88}"
        case .testTubeFilled: return "\u{fb89}"
        case .testTubeLight: return "\u{fb8a}"
        case .testTubeRegular: return "\u{fb8b}"
        case .textAlignCenterBold: return "\u{fb8c}"
        case .textAlignCenterFilled: return "\u{fb8d}"
        case .textAlignCenterLight: return "\u{fb8e}"
        case .textAlignCenterRegular: return "\u{fb8f}"
        case .textAlignLeftBold: return "\u{fb90}"
        case .textAlignLeftFilled: return "\u{fb91}"
        case .textAlignLeftLight: return "\u{fb92}"
        case .textAlignLeftRegular: return "\u{fb93}"
        case .textAlignRightBold: return "\u{fb94}"
        case .textAlignRightFilled: return "\u{fb95}"
        case .textAlignRightLight: return "\u{fb96}"
        case .textAlignRightRegular: return "\u{fb97}"
        case .textBold: return "\u{fb98}"
        case .textBoxCursorLight: return "\u{fb99}"
        case .textCodeBlockBold: return "\u{fb9a}"
        case .textCodeBlockLight: return "\u{fb9b}"
        case .textCodeBlockRegular: return "\u{fb9c}"
        case .textHighlightBold: return "\u{fb9d}"
        case .textHighlightFilled: return "\u{fb9e}"
        case .textHighlightLight: return "\u{fb9f}"
        case .textHighlightRegular: return "\u{fba0}"
        case .textLight: return "\u{fba1}"
        case .textRegular: return "\u{fba2}"
        case .threeColumnBold: return "\u{fba3}"
        case .threeColumnLight: return "\u{fba4}"
        case .threeColumnRegular: return "\u{fba5}"
        case .threeDObjectBold: return "\u{fba6}"
        case .threeDObjectLight: return "\u{fba7}"
        case .threeDObjectRegular: return "\u{fba8}"
        case .timeExclusionBold: return "\u{fba9}"
        case .timeExclusionLight: return "\u{fbaa}"
        case .timeExclusionRegular: return "\u{fbab}"
        case .timezoneBold: return "\u{fbac}"
        case .timezoneFilled: return "\u{fbad}"
        case .timezoneLight: return "\u{fbae}"
        case .timezoneRegular: return "\u{fbaf}"
        case .tooFastBold: return "\u{fbb0}"
        case .tooFastLight: return "\u{fbb1}"
        case .tooFastRegular: return "\u{fbb2}"
        case .tooSlowBold: return "\u{fbb3}"
        case .tooSlowLight: return "\u{fbb4}"
        case .tooSlowRegular: return "\u{fbb5}"
        case .toolsBold: return "\u{fbb6}"
        case .toolsFilled: return "\u{fbb7}"
        case .toolsLight: return "\u{fbb8}"
        case .toolsRegular: return "\u{fbb9}"
        case .touchTenBold: return "\u{fbba}"
        case .touchTenLight: return "\u{fbbb}"
        case .touchTenRegular: return "\u{fbbc}"
        case .transcriptBold: return "\u{fbbd}"
        case .transcriptFilled: return "\u{fbbe}"
        case .transcriptLight: return "\u{fbbf}"
        case .transcriptRegular: return "\u{fbc0}"
        case .translateBold: return "\u{fbc1}"
        case .translateLight: return "\u{fbc2}"
        case .translateRegular: return "\u{fbc3}"
        case .translateUndoBold: return "\u{fbc4}"
        case .translateUndoLight: return "\u{fbc5}"
        case .translateUndoRegular: return "\u{fbc6}"
        case .trendingBold: return "\u{fbc7}"
        case .trendingDownBold: return "\u{fbc8}"
        case .trendingDownFilled: return "\u{fbc9}"
        case .trendingDownLight: return "\u{fbca}"
        case .trendingDownRegular: return "\u{fbcb}"
        case .trendingFilled: return "\u{fbcc}"
        case .trendingLight: return "\u{fbcd}"
        case .trendingRegular: return "\u{fbce}"
        case .trimBold: return "\u{fbcf}"
        case .trimLight: return "\u{fbd0}"
        case .trimRegular: return "\u{fbd1}"
        case .twoColumnBold: return "\u{fbd2}"
        case .twoColumnLight: return "\u{fbd3}"
        case .twoColumnRegular: return "\u{fbd4}"
        case .twoWayVoiceStreamBold: return "\u{fbd5}"
        case .twoWayVoiceStreamFilled: return "\u{fbd6}"
        case .twoWayVoiceStreamLight: return "\u{fbd7}"
        case .twoWayVoiceStreamRegular: return "\u{fbd8}"
        case .ucmCloudBold: return "\u{fbd9}"
        case .ucmCloudLight: return "\u{fbda}"
        case .ucmCloudRegular: return "\u{fbdb}"
        case .unblockBold: return "\u{fbdc}"
        case .unblockFilled: return "\u{fbdd}"
        case .unblockLight: return "\u{fbde}"
        case .unblockRegular: return "\u{fbdf}"
        case .underlineBold: return "\u{fbe0}"
        case .underlineFilled: return "\u{fbe1}"
        case .underlineLight: return "\u{fbe2}"
        case .underlineRegular: return "\u{fbe3}"
        case .undoBold: return "\u{fbe4}"
        case .undoLight: return "\u{fbe5}"
        case .undoRegular: return "\u{fbe6}"
        case .unlinkBold: return "\u{fbe7}"
        case .unlinkLight: return "\u{fbe8}"
        case .unlinkRegular: return "\u{fbe9}"
        case .unreadBold: return "\u{fbea}"
        case .unreadFilled: return "\u{fbeb}"
        case .unreadLight: return "\u{fbec}"
        case .unreadRegular: return "\u{fbed}"
        case .unsecureUnlockedBold: return "\u{fbee}"
        case .unsecureUnlockedFilled: return "\u{fbef}"
        case .unsecureUnlockedLight: return "\u{fbf0}"
        case .unsecureUnlockedRegular: return "\u{fbf1}"
        case .unsortedBold: return "\u{fbf2}"
        case .unsortedLight: return "\u{fbf3}"
        case .unsortedRegular: return "\u{fbf4}"
        case .updateFileShareBold: return "\u{fbf5}"
        case .updateFileShareLight: return "\u{fbf6}"
        case .updateFileShareRegular: return "\u{fbf7}"
        case .uploadBold: return "\u{fbf8}"
        case .uploadImageBold: return "\u{fbf9}"
        case .uploadImageLight: return "\u{fbfa}"
        case .uploadImageRegular: return "\u{fbfb}"
        case .uploadLight: return "\u{fbfc}"
        case .uploadRegular: return "\u{fbfd}"
        case .urgentVoicemailBold: return "\u{fbfe}"
        case .urgentVoicemailFilled: return "\u{fbff}"
        case .usbBold: return "\u{fc00}"
        case .usbHeadsetBold: return "\u{fc01}"
        case .usbHeadsetLight: return "\u{fc02}"
        case .usbHeadsetMutedBold: return "\u{fc03}"
        case .usbHeadsetMutedLight: return "\u{fc04}"
        case .usbHeadsetMutedRegular: return "\u{fc05}"
        case .usbHeadsetRegular: return "\u{fc06}"
        case .usbLight: return "\u{fc07}"
        case .usbRegular: return "\u{fc08}"
        case .userBold: return "\u{fc09}"
        case .userDeactivateBold: return "\u{fc0a}"
        case .userDeactivateLight: return "\u{fc0b}"
        case .userDeactivateRegular: return "\u{fc0c}"
        case .userLight: return "\u{fc0d}"
        case .userRegular: return "\u{fc0e}"
        case .videoBlurBold: return "\u{fc0f}"
        case .videoBlurFilled: return "\u{fc10}"
        case .videoBlurLight: return "\u{fc11}"
        case .videoBlurRegular: return "\u{fc12}"
        case .videoBold: return "\u{fc13}"
        case .videoEffectBold: return "\u{fc14}"
        case .videoEffectFilled: return "\u{fc15}"
        case .videoEffectLight: return "\u{fc16}"
        case .videoEffectRegular: return "\u{fc17}"
        case .videoFilled: return "\u{fc18}"
        case .videoLayoutBold: return "\u{fc19}"
        case .videoLayoutCustomBold: return "\u{fc1a}"
        case .videoLayoutCustomFilled: return "\u{fc1b}"
        case .videoLayoutCustomLight: return "\u{fc1c}"
        case .videoLayoutCustomRegular: return "\u{fc1d}"
        case .videoLayoutEqualBold: return "\u{fc1e}"
        case .videoLayoutEqualDualBold: return "\u{fc1f}"
        case .videoLayoutEqualDualLight: return "\u{fc20}"
        case .videoLayoutEqualDualRegular: return "\u{fc21}"
        case .videoLayoutEqualFilled: return "\u{fc22}"
        case .videoLayoutEqualLight: return "\u{fc23}"
        case .videoLayoutEqualRegular: return "\u{fc24}"
        case .videoLayoutFilled: return "\u{fc25}"
        case .videoLayoutLight: return "\u{fc26}"
        case .videoLayoutOverlayBold: return "\u{fc27}"
        case .videoLayoutOverlayFilled: return "\u{fc28}"
        case .videoLayoutOverlayLight: return "\u{fc29}"
        case .videoLayoutOverlayRegular: return "\u{fc2a}"
        case .videoLayoutPresentationBold: return "\u{fc2b}"
        case .videoLayoutPresentationFilled: return "\u{fc2c}"
        case .videoLayoutPresentationLight: return "\u{fc2d}"
        case .videoLayoutPresentationRegular: return "\u{fc2e}"
        case .videoLayoutPresenterDominantBold: return "\u{fc2f}"
        case .videoLayoutPresenterDominantLight: return "\u{fc30}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc31}"
        case .videoLayoutProminentBold: return "\u{fc32}"
        case .videoLayoutProminentFilled: return "\u{fc33}"
        case .videoLayoutProminentLight: return "\u{fc34}"
        case .videoLayoutProminentRegular: return "\u{fc35}"
        case .videoLayoutRegular: return "\u{fc36}"
        case .videoLayoutShareDominantBold: return "\u{fc37}"
        case .videoLayoutShareDominantLight: return "\u{fc38}"
        case .videoLayoutShareDominantRegular: return "\u{fc39}"
        case .videoLayoutSingleBold: return "\u{fc3a}"
        case .videoLayoutSingleFilled: return "\u{fc3b}"
        case .videoLayoutSingleLight: return "\u{fc3c}"
        case .videoLayoutSingleRegular: return "\u{fc3d}"
        case .videoLayoutSpeakerBold: return "\u{fc3e}"
        case .videoLayoutSpeakerFilled: return "\u{fc3f}"
        case .videoLayoutSpeakerLight: return "\u{fc40}"
        case .videoLayoutSpeakerRegular: return "\u{fc41}"
        case .videoLayoutStackBold: return "\u{fc42}"
        case .videoLayoutStackFilled: return "\u{fc43}"
        case .videoLayoutStackLight: return "\u{fc44}"
        case .videoLayoutStackRegular: return "\u{fc45}"
        case .videoLayoutVideoDominantBold: return "\u{fc46}"
        case .videoLayoutVideoDominantFilled: return "\u{fc47}"
        case .videoLayoutVideoDominantLight: return "\u{fc48}"
        case .videoLayoutVideoDominantRegular: return "\u{fc49}"
        case .videoLight: return "\u{fc4a}"
        case .videoPlusBold: return "\u{fc4b}"
        case .videoPlusFilled: return "\u{fc4c}"
        case .videoPlusLight: return "\u{fc4d}"
        case .videoPlusRegular: return "\u{fc4e}"
        case .videoRegular: return "\u{fc4f}"
        case .videoSpeakerTrackBold: return "\u{fc50}"
        case .videoSpeakerTrackFilled: return "\u{fc51}"
        case .videoSpeakerTrackLight: return "\u{fc52}"
        case .videoSpeakerTrackRegular: return "\u{fc53}"
        case .viewAllBold: return "\u{fc54}"
        case .viewAllLight: return "\u{fc55}"
        case .viewAllRegular: return "\u{fc56}"
        case .viewListBold: return "\u{fc57}"
        case .viewListFilled: return "\u{fc58}"
        case .viewListLight: return "\u{fc59}"
        case .viewListRegular: return "\u{fc5a}"
        case .viewStackedBold: return "\u{fc5b}"
        case .viewStackedFilled: return "\u{fc5c}"
        case .viewStackedLight: return "\u{fc5d}"
        case .viewStackedRegular: return "\u{fc5e}"
        case .viewThumbnailBold: return "\u{fc5f}"
        case .viewThumbnailFilled: return "\u{fc60}"
        case .viewThumbnailLight: return "\u{fc61}"
        case .viewThumbnailRegular: return "\u{fc62}"
        case .visionproBold: return "\u{fc63}"
        case .visionproFilled: return "\u{fc64}"
        case .visionproLight: return "\u{fc65}"
        case .visionproMoveCallInBold: return "\u{fc66}"
        case .visionproMoveCallInFilled: return "\u{fc67}"
        case .visionproMoveCallInLight: return "\u{fc68}"
        case .visionproMoveCallInOutBold: return "\u{fc69}"
        case .visionproMoveCallInOutFilled: return "\u{fc6a}"
        case .visionproMoveCallInOutLight: return "\u{fc6b}"
        case .visionproMoveCallInOutRegular: return "\u{fc6c}"
        case .visionproMoveCallInRegular: return "\u{fc6d}"
        case .visionproMoveCallOutBold: return "\u{fc6e}"
        case .visionproMoveCallOutFilled: return "\u{fc6f}"
        case .visionproMoveCallOutLight: return "\u{fc70}"
        case .visionproMoveCallOutRegular: return "\u{fc71}"
        case .visionproRegular: return "\u{fc72}"
        case .voicemailBold: return "\u{fc73}"
        case .voicemailFilled: return "\u{fc74}"
        case .voicemailLight: return "\u{fc75}"
        case .voicemailRegular: return "\u{fc76}"
        case .vpnBold: return "\u{fc77}"
        case .vpnFilled: return "\u{fc78}"
        case .vpnLight: return "\u{fc79}"
        case .vpnRegular: return "\u{fc7a}"
        case .vscBold: return "\u{fc7b}"
        case .vscLight: return "\u{fc7c}"
        case .vscRegular: return "\u{fc7d}"
        case .waffleMenuBold: return "\u{fc7e}"
        case .waffleMenuLight: return "\u{fc7f}"
        case .waffleMenuRegular: return "\u{fc80}"
        case .waitingRoomBold: return "\u{fc81}"
        case .waitingRoomLight: return "\u{fc82}"
        case .waitingRoomRegular: return "\u{fc83}"
        case .wallpaperBold: return "\u{fc84}"
        case .wallpaperLight: return "\u{fc85}"
        case .wallpaperRegular: return "\u{fc86}"
        case .warningBadgeFilled: return "\u{fc87}"
        case .warningBold: return "\u{fc88}"
        case .warningFilled: return "\u{fc89}"
        case .warningLight: return "\u{fc8a}"
        case .warningRegular: return "\u{fc8b}"
        case .webexBoardBold: return "\u{fc8c}"
        case .webexBoardLight: return "\u{fc8d}"
        case .webexBoardRegular: return "\u{fc8e}"
        case .webexCodecPlusBold: return "\u{fc8f}"
        case .webexCodecPlusLight: return "\u{fc90}"
        case .webexCodecPlusRegular: return "\u{fc91}"
        case .webexDeskCameraBold: return "\u{fc92}"
        case .webexDeskCameraLight: return "\u{fc93}"
        case .webexDeskCameraRegular: return "\u{fc94}"
        case .webexHelixBold: return "\u{fc95}"
        case .webexHelixLight: return "\u{fc96}"
        case .webexHelixRegular: return "\u{fc97}"
        case .webexMeetingsBold: return "\u{fc98}"
        case .webexMeetingsFilled: return "\u{fc99}"
        case .webexMeetingsLight: return "\u{fc9a}"
        case .webexMeetingsRegular: return "\u{fc9b}"
        case .webexQuadCameraBold: return "\u{fc9c}"
        case .webexQuadCameraLight: return "\u{fc9d}"
        case .webexQuadCameraRegular: return "\u{fc9e}"
        case .webexRoomKitBold: return "\u{fc9f}"
        case .webexRoomKitLight: return "\u{fca0}"
        case .webexRoomKitPlusBold: return "\u{fca1}"
        case .webexRoomKitPlusLight: return "\u{fca2}"
        case .webexRoomKitPlusRegular: return "\u{fca3}"
        case .webexRoomKitRegular: return "\u{fca4}"
        case .webexShareBold: return "\u{fca5}"
        case .webexShareLight: return "\u{fca6}"
        case .webexShareRegular: return "\u{fca7}"
        case .webexTeamsBold: return "\u{fca8}"
        case .webexTeamsFilled: return "\u{fca9}"
        case .webexTeamsLight: return "\u{fcaa}"
        case .webexTeamsNewBold: return "\u{fcab}"
        case .webexTeamsNewFilled: return "\u{fcac}"
        case .webexTeamsNewLight: return "\u{fcad}"
        case .webexTeamsNewRegular: return "\u{fcae}"
        case .webexTeamsRegular: return "\u{fcaf}"
        case .webexTeamsRemoveBold: return "\u{fcb0}"
        case .webexTeamsRemoveLight: return "\u{fcb1}"
        case .webexTeamsRemoveRegular: return "\u{fcb2}"
        case .webhookBold: return "\u{fcb3}"
        case .webhookLight: return "\u{fcb4}"
        case .webhookRegular: return "\u{fcb5}"
        case .webinarBold: return "\u{fcb6}"
        case .webinarFilled: return "\u{fcb7}"
        case .webinarLight: return "\u{fcb8}"
        case .webinarRegular: return "\u{fcb9}"
        case .weeklyRecurringScheduleBold: return "\u{fcba}"
        case .weeklyRecurringScheduleLight: return "\u{fcbb}"
        case .weeklyRecurringScheduleRegular: return "\u{fcbc}"
        case .whisperAnnouncementBold: return "\u{fcbd}"
        case .whisperAnnouncementFilled: return "\u{fcbe}"
        case .whisperAnnouncementLight: return "\u{fcbf}"
        case .whisperAnnouncementRegular: return "\u{fcc0}"
        case .whisperCoachBold: return "\u{fcc1}"
        case .whisperCoachFilled: return "\u{fcc2}"
        case .whisperCoachLight: return "\u{fcc3}"
        case .whisperCoachRegular: return "\u{fcc4}"
        case .whiteboardBold: return "\u{fcc5}"
        case .whiteboardContentBold: return "\u{fcc6}"
        case .whiteboardContentFilled: return "\u{fcc7}"
        case .whiteboardContentLight: return "\u{fcc8}"
        case .whiteboardContentRegular: return "\u{fcc9}"
        case .whiteboardFilled: return "\u{fcca}"
        case .whiteboardLight: return "\u{fccb}"
        case .whiteboardRegular: return "\u{fccc}"
        case .widgetBold: return "\u{fccd}"
        case .widgetFilled: return "\u{fcce}"
        case .widgetLight: return "\u{fccf}"
        case .widgetRegular: return "\u{fcd0}"
        case .wifiBold: return "\u{fcd1}"
        case .wifiErrorBold: return "\u{fcd2}"
        case .wifiErrorLight: return "\u{fcd3}"
        case .wifiErrorRegular: return "\u{fcd4}"
        case .wifiLight: return "\u{fcd5}"
        case .wifiRegular: return "\u{fcd6}"
        case .wifiSignalGoodBold: return "\u{fcd7}"
        case .wifiSignalGoodLight: return "\u{fcd8}"
        case .wifiSignalGoodRegular: return "\u{fcd9}"
        case .wifiSignalPoorBold: return "\u{fcda}"
        case .wifiSignalPoorLight: return "\u{fcdb}"
        case .wifiSignalPoorRegular: return "\u{fcdc}"
        case .wifiSignalUnstableBold: return "\u{fcdd}"
        case .wifiSignalUnstableLight: return "\u{fcde}"
        case .wifiSignalUnstableRegular: return "\u{fcdf}"
        case .windowCornerScrubBold: return "\u{fce0}"
        case .windowCornerScrubLight: return "\u{fce1}"
        case .windowCornerScrubRegular: return "\u{fce2}"
        case .windowRightCornerScrubBold: return "\u{fce3}"
        case .windowRightCornerScrubLight: return "\u{fce4}"
        case .windowRightCornerScrubRegular: return "\u{fce5}"
        case .windowVerticalScrubBold: return "\u{fce6}"
        case .windowVerticalScrubLight: return "\u{fce7}"
        case .windowVerticalScrubRegular: return "\u{fce8}"
        case .workflowDeploymentsBold: return "\u{fce9}"
        case .workflowDeploymentsFilled: return "\u{fcea}"
        case .workflowDeploymentsLight: return "\u{fceb}"
        case .workflowDeploymentsRegular: return "\u{fcec}"
        case .workphoneBold: return "\u{fced}"
        case .workphoneLight: return "\u{fcee}"
        case .workphoneRegular: return "\u{fcef}"
        case .zoomInBold: return "\u{fcf0}"
        case .zoomInLight: return "\u{fcf1}"
        case .zoomInRegular: return "\u{fcf2}"
        case .zoomOutBold: return "\u{fcf3}"
        case .zoomOutLight: return "\u{fcf4}"
        case .zoomOutRegular: return "\u{fcf5}"
