...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .dockWindowClosedBold: return "\u{f492}"
        case .dockWindowClosedFilled: return "\u{f493}"
        case .dockWindowClosedLight: return "\u{f494}"
        case .dockWindowClosedRegular: return "\u{f495}"
        case .dockWindowFilled: return "\u{f496}"
        case .dockWindowLight: return "\u{f497}"
        case .dockWindowRegular: return "\u{f498}"
        case .documentBold: return "\u{f499}"
        case .documentCameraBold: return "\u{f49a}"
        case .documentCameraDisconnectedBold: return "\u{f49b}"
        case .documentCameraDisconnectedLight: return "\u{f49c}"
        case .documentCameraDisconnectedRegular: return "\u{f49d}"
        case .documentCameraLight: return "\u{f49e}"
        case .documentCameraRegular: return "\u{f49f}"
        case .documentCreateBold: return "\u{f4a0}"
        case .documentCreateFilled: return "\u{f4a1}"
        case .documentCreateLight: return "\u{f4a2}"
        case .documentCreateRegular: return "\u{f4a3}"
        case .documentFilled: return "\u{f4a4}"
        case .documentLight: return "\u{f4a5}"
        case .documentMoveBold: return "\u{f4a6}"
        case .documentMoveFilled: return "\u{f4a7}"
        case .documentMoveLight: return "\u{f4a8}"
        case .documentMoveRegular: return "\u{f4a9}"
        case .documentRegular: return "\u{f4aa}"
        case .documentShareBold: return "\u{f4ab}"
        case .documentShareFilled: return "\u{f4ac}"
        case .documentShareLight: return "\u{f4ad}"
        case .documentShareRegular: return "\u{f4ae}"
        case .doneAllBold: return "\u{f4af}"
        case .doneAllLight: return "\u{f4b0}"
        case .doneAllRegular: return "\u{f4b1}"
        case .donutChartBold: return "\u{f4b2}"
        case .donutChartFilled: return "\u{f4b3}"
        case .donutChartLight: return "\u{f4b4}"
        case .donutChartRegular: return "\u{f4b5}"
        case .downloadBold: return "\u{f4b6}"
        case .downloadFilled: return "\u{f4b7}"
        case .downloadLight: return "\u{f4b8}"
        case .downloadRegular: return "\u{f4b9}"
        case .draftBold: return "\u{f4ba}"
        case .draftFilled: return "\u{f4bb}"
        case .draftIndicatorBold: return "\u{f4bc}"
        case .draftIndicatorSmallFilled: return "\u{f4bd}"
        case .draftLight: return "\u{f4be}"
        case .draftRegular: return "\u{f4bf}"
        case .dragBold: return "\u{f4c0}"
        case .dragLight: return "\u{f4c1}"
        case .dragRegular: return "\u{f4c2}"
        case .draggerHorizontalBold: return "\u{f4c3}"
        case .draggerHorizontalLight: return "\u{f4c4}"
        case .draggerHorizontalRegular: return "\u{f4c5}"
        case .draggerVerticalBold: return "\u{f4c6}"
        case .draggerVerticalLight: return "\u{f4c7}"
        case .draggerVerticalRegular: return "\u{f4c8}"
        case .driveModeBold: return "\u{f4c9}"
        case .driveModeLight: return "\u{f4ca}"
        case .driveModeRegular: return "\u{f4cb}"
        case .dropdownBold: return "\u{f4cc}"
        case .dropdownLight: return "\u{f4cd}"
        case .dropdownRegular: return "\u{f4ce}"
        case .dxEightyBold: return "\u{f4cf}"
        case .dxEightyFilled: return "\u{f4d0}"
        case .dxEightyLight: return "\u{f4d1}"
        case .dxEightyRegular: return "\u{f4d2}"
        case .dxSeventyBold: return "\u{f4d3}"
        case .dxSeventyLight: return "\u{f4d4}"
        case .dxSeventyRegular: return "\u{f4d5}"
        case .editBold: return "\u{f4d6}"
        case .editFilled: return "\u{f4d7}"
        case .editLight: return "\u{f4d8}"
        case .editNoteBold: return "\u{f4d9}"
        case .editNoteFilled: return "\u{f4da}"
        case .editNoteLight: return "\u{f4db}"
        case .editNoteRegular: return "\u{f4dc}"
        case .editRegular: return "\u{f4dd}"
        case .editablePartialBold: return "\u{f4de}"
        case .editablePartialLight: return "\u{f4df}"
        case .editablePartialRegular: return "\u{f4e0}"
        case .educationBold: return "\u{f4e1}"
        case .educationFilled: return "\u{f4e2}"
        case .educationLight: return "\u{f4e3}"
        case .educationRegular: return "\u{f4e4}"
        case .emailBold: return "\u{f4e5}"
        case .emailDeliveredBold: return "\u{f4e6}"
        case .emailDeliveredLight: return "\u{f4e7}"
        case .emailDeliveredRegular: return "\u{f4e8}"
        case .emailFailureBold: return "\u{f4e9}"
        case .emailFailureLight: return "\u{f4ea}"
        case .emailFailureRegular: return "\u{f4eb}"
        case .emailFilled: return "\u{f4ec}"
        case .emailInviteBold: return "\u{f4ed}"
        case .emailInviteLight: return "\u{f4ee}"
        case .emailInviteRegular: return "\u{f4ef}"
        case .emailLight: return "\u{f4f0}"
        case .emailOutgoingBold: return "\u{f4f1}"
        case .emailOutgoingFilled: return "\u{f4f2}"
        case .emailOutgoingLight: return "\u{f4f3}"
        case .emailOutgoingRegular: return "\u{f4f4}"
        case .emailReadBold: return "\u{f4f5}"
        case .emailReadFilled: return "\u{f4f6}"
        case .emailReadLight: return "\u{f4f7}"
        case .emailReadRegular: return "\u{f4f8}"
        case .emailRegular: return "\u{f4f9}"
        case .emergencyCallbackNumberBold: return "\u{f4fa}"
        case .emergencyCallbackNumberFilled: return "\u{f4fb}"
        case .emergencyCallbackNumberLight: return "\u{f4fc}"
        case .emergencyCallbackNumberRegular: return "\u{f4fd}"
        case .emojiExcitedBold: return "\u{f4fe}"
        case .emojiExcitedFilled: return "\u{f4ff}"
        case .emojiExcitedLight: return "\u{f500}"
        case .emojiExcitedRegular: return "\u{f501}"
        case .emojiHappyBold: return "\u{f502}"
        case .emojiHappyFilled: return "\u{f503}"
        case .emojiHappyLight: return "\u{f504}"
        case .emojiHappyRegular: return "\u{f505}"
        case .emojiPassiveBold: return "\u{f506}"
        case .emojiPassiveFilled: return "\u{f507}"
        case .emojiPassiveLight: return "\u{f508}"
        case .emojiPassiveRegular: return "\u{f509}"
        case .emojiSadBold: return "\u{f50a}"
        case .emojiSadFilled: return "\u{f50b}"
        case .emojiSadLight: return "\u{f50c}"
        case .emojiSadRegular: return "\u{f50d}"
        case .emojiUnhappyBold: return "\u{f50e}"
        case .emojiUnhappyFilled: return "\u{f50f}"
        case .emojiUnhappyLight: return "\u{f510}"
        case .emojiUnhappyRegular: return "\u{f511}"
        case .encryptionAdaptiveBold: return "\u{f512}"
        case .encryptionAdaptiveFilled: return "\u{f513}"
        case .encryptionAdaptiveLight: return "\u{f514}"
        case .encryptionAdaptiveRegular: return "\u{f515}"
        case .encryptionAdaptiveSecureBold: return "\u{f516}"
        case .encryptionAdaptiveSecureFilled: return "\u{f517}"
        case .encryptionAdaptiveSecureLight: return "\u{f518}"
        case .encryptionAdaptiveSecureRegular: return "\u{f519}"
        case .encryptionBold: return "\u{f51a}"
        case .encryptionCircleAdaptiveBold: return "\u{f51b}"
        case .encryptionCircleAdaptiveFilled: return "\u{f51c}"
        case .encryptionCircleAdaptiveLight: return "\u{f51d}"
        case .encryptionCircleAdaptiveRegular: return "\u{f51e}"
        case .encryptionCircleAdaptiveSecureBold: return "\u{f51f}"
        case .encryptionCircleAdaptiveSecureFilled: return "\u{f520}"
        case .encryptionCircleAdaptiveSecureLight: return "\u{f521}"
        case .encryptionCircleAdaptiveSecureRegular: return "\u{f522}"
        case .encryptionCircleBold: return "\u{f523}"
        case .encryptionCircleFilled: return "\u{f524}"
        case .encryptionCircleLight: return "\u{f525}"
        case .encryptionCircleRegular: return "\u{f526}"
        case .encryptionFilled: return "\u{f527}"
        case .encryptionLight: return "\u{f528}"
        case .encryptionRegular: return "\u{f529}"
        case .endRemoteDesktopControlBold: return "\u{f52a}"
        case .endRemoteDesktopControlLight: return "\u{f52b}"
        case .endRemoteDesktopControlRegular: return "\u{f52c}"
        case .endToEndEncryptionBold: return "\u{f52d}"
        case .endToEndEncryptionCircleBold: return "\u{f52e}"
        case .endToEndEncryptionCircleFilled: return "\u{f52f}"
        case .endToEndEncryptionCircleLight: return "\u{f530}"
        case .endToEndEncryptionCircleRegular: return "\u{f531}"
        case .endToEndEncryptionFilled: return "\u{f532}"
        case .endToEndEncryptionLight: return "\u{f533}"
        case .endToEndEncryptionRegular: return "\u{f534}"
        case .endpointBlockedBold: return "\u{f535}"
        case .endpointBlockedLight: return "\u{f536}"
        case .endpointBlockedRegular: return "\u{f537}"
        case .endpointBold: return "\u{f538}"
        case .endpointGTwoBold: return "\u{f539}"
        case .endpointGTwoLight: return "\u{f53a}"
        case .endpointGTwoRegular: return "\u{f53b}"
        case .endpointGTwoSeventyBold: return "\u{f53c}"
        case .endpointGTwoSeventyDualBold: return "\u{f53d}"
        case .endpointGTwoSeventyDualLight: return "\u{f53e}"
        case .endpointGTwoSeventyDualRegular: return "\u{f53f}"
        case .endpointGTwoSeventyLight: return "\u{f540}"
        case .endpointGTwoSeventyRegular: return "\u{f541}"
        case .endpointGTwoStandBold: return "\u{f542}"
        case .endpointGTwoStandLight: return "\u{f543}"
        case .endpointGTwoStandRegular: return "\u{f544}"
        case .endpointLight: return "\u{f545}"
        case .endpointMxEightHundredBold: return "\u{f546}"
        case .endpointMxEightHundredDualBold: return "\u{f547}"
        case .endpointMxEightHundredDualLight: return "\u{f548}"
        case .endpointMxEightHundredDualRegular: return "\u{f549}"
        case .endpointMxEightHundredLight: return "\u{f54a}"
        case .endpointMxEightHundredRegular: return "\u{f54b}"
        case .endpointRegular: return "\u{f54c}"
        case .endpointStandBold: return "\u{f54d}"
        case .endpointStandFilled: return "\u{f54e}"
        case .endpointStandLight: return "\u{f54f}"
        case .endpointStandRegular: return "\u{f550}"
        case .endpointWarningBold: return "\u{f551}"
        case .endpointWarningLight: return "\u{f552}"
        case .endpointWarningRegular: return "\u{f553}"
        case .enterBold: return "\u{f554}"
        case .enterLight: return "\u{f555}"
        case .enterRegular: return "\u{f556}"
        case .enterRoomBold: return "\u{f557}"
        case .enterRoomFilled: return "\u{f558}"
        case .enterRoomLight: return "\u{f559}"
        case .enterRoomRegular: return "\u{f55a}"
        case .eraserBold: return "\u{f55b}"
        case .eraserFilled: return "\u{f55c}"
        case .eraserLight: return "\u{f55d}"
        case .eraserRegular: return "\u{f55e}"
        case .errorLegacyBadgeFilled: return "\u{f55f}"
        case .errorLegacyBold: return "\u{f560}"
        case .errorLegacyFilled: return "\u{f561}"
        case .errorLegacyLight: return "\u{f562}"
        case .errorLegacyRegular: return "\u{f563}"
        case .ethernetBold: return "\u{f564}"
        case .ethernetFilled: return "\u{f565}"
        case .ethernetLight: return "\u{f566}"
        case .ethernetRegular: return "\u{f567}"
        case .exchangeBold: return "\u{f568}"
        case .exchangeLight: return "\u{f569}"
        case .exchangeRegular: return "\u{f56a}"
        case .exclamationBold: return "\u{f56b}"
        case .exclamationLight: return "\u{f56c}"
        case .exclamationRegular: return "\u{f56d}"
        case .excludeBold: return "\u{f56e}"
        case .excludeLight: return "\u{f56f}"
        case .excludeRegular: return "\u{f570}"
        case .existingTargetGroupBold: return "\u{f571}"
        case .existingTargetGroupLight: return "\u{f572}"
        case .existingTargetGroupRegular: return "\u{f573}"
        case .exitRoomBold: return "\u{f574}"
        case .exitRoomLight: return "\u{f575}"
        case .exitRoomRegular: return "\u{f576}"
        case .exploreBold: return "\u{f577}"
        case .exploreLight: return "\u{f578}"
        case .exploreRegular: return "\u{f579}"
        case .exportBold: return "\u{f57a}"
        case .exportLight: return "\u{f57b}"
        case .exportRegular: return "\u{f57c}"
        case .extensionMobilityBold: return "\u{f57d}"
        case .extensionMobilityLight: return "\u{f57e}"
        case .extensionMobilityRegular: return "\u{f57f}"
        case .externalMessageBold: return "\u{f580}"
        case .externalMessageLight: return "\u{f581}"
        case .externalMessageRegular: return "\u{f582}"
        case .externalUserBold: return "\u{f583}"
        case .externalUserLight: return "\u{f584}"
        case .externalUserRegular: return "\u{f585}"
        case .familyFontBold: return "\u{f586}"
        case .familyFontLight: return "\u{f587}"
        case .familyFontRegular: return "\u{f588}"
        case .fastForwardBold: return "\u{f589}"
        case .fastForwardLight: return "\u{f58a}"
        case .fastForwardRegular: return "\u{f58b}"
        case .favoriteBold: return "\u{f58c}"
        case .favoriteFilled: return "\u{f58d}"
        case .favoriteLight: return "\u{f58e}"
        case .favoriteRegular: return "\u{f58f}"
        case .favoritesBold: return "\u{f590}"
        case .favoritesFilled: return "\u{f591}"
        case .favoritesLight: return "\u{f592}"
        case .favoritesRegular: return "\u{f593}"
        case .fbwBold: return "\u{f594}"
        case .fbwFilled: return "\u{f595}"
        case .fbwLight: return "\u{f596}"
        case .fbwRegular: return "\u{f597}"
        case .ffwBold: return "\u{f598}"
        case .ffwFilled: return "\u{f599}"
        case .ffwLight: return "\u{f59a}"
        case .ffwRegular: return "\u{f59b}"
        case .fileAnalysisBold: return "\u{f59c}"
        case .fileAnalysisFilled: return "\u{f59d}"
        case .fileAnalysisLight: return "\u{f59e}"
        case .fileAnalysisRegular: return "\u{f59f}"
        case .fileAnnotationBold: return "\u{f5a0}"
        case .fileAnnotationFilled: return "\u{f5a1}"
        case .fileAnnotationLight: return "\u{f5a2}"
        case .fileAnnotationRegular: return "\u{f5a3}"
        case .fileAudioBold: return "\u{f5a4}"
        case .fileAudioFilled: return "\u{f5a5}"
        case .fileAudioLight: return "\u{f5a6}"
        case .fileAudioRegular: return "\u{f5a7}"
        case .fileBugBold: return "\u{f5a8}"
        case .fileBugFilled: return "\u{f5a9}"
        case .fileBugLight: return "\u{f5aa}"
        case .fileBugRegular: return "\u{f5ab}"
        case .fileCodeBold: return "\u{f5ac}"
        case .fileCodeFilled: return "\u{f5ad}"
        case .fileCodeLight: return "\u{f5ae}"
        case .fileCodeRegular: return "\u{f5af}"
        case .fileDashboardBold: return "\u{f5b0}"
        case .fileDashboardFilled: return "\u{f5b1}"
        case .fileDashboardLight: return "\u{f5b2}"
        case .fileDashboardRegular: return "\u{f5b3}"
        case .fileExcelBold: return "\u{f5b4}"
        case .fileExcelFilled: return "\u{f5b5}"
        case .fileExcelLight: return "\u{f5b6}"
        case .fileExcelRegular: return "\u{f5b7}"
        case .fileGraphBold: return "\u{f5b8}"
        case .fileGraphFilled: return "\u{f5b9}"
        case .fileGraphLight: return "\u{f5ba}"
        case .fileGraphRegular: return "\u{f5bb}"
        case .fileImageBold: return "\u{f5bc}"
        case .fileImageFilled: return "\u{f5bd}"
        case .fileImageLight: return "\u{f5be}"
        case .fileImageNoneBold: return "\u{f5bf}"
        case .fileImageNoneLight: return "\u{f5c0}"
        case .fileImageNoneRegular: return "\u{f5c1}"
        case .fileImageRegular: return "\u{f5c2}"
        case .fileJsBold: return "\u{f5c3}"
        case .fileJsFilled: return "\u{f5c4}"
        case .fileJsLight: return "\u{f5c5}"
        case .fileJsRegular: return "\u{f5c6}"
        case .fileKeynoteBold: return "\u{f5c7}"
        case .fileKeynoteFilled: return "\u{f5c8}"
        case .fileKeynoteLight: return "\u{f5c9}"
        case .fileKeynoteRegular: return "\u{f5ca}"
        case .fileLockedBold: return "\u{f5cb}"
        case .fileLockedFilled: return "\u{f5cc}"
        case .fileLockedLight: return "\u{f5cd}"
        case .fileLockedRegular: return "\u{f5ce}"
        case .fileMissingBold: return "\u{f5cf}"
        case .fileMissingFilled: return "\u{f5d0}"
        case .fileMissingLight: return "\u{f5d1}"
        case .fileMissingRegular: return "\u{f5d2}"
        case .fileMusicBold: return "\u{f5d3}"
        case .fileMusicFilled: return "\u{f5d4}"
        case .fileMusicLight: return "\u{f5d5}"
        case .fileMusicRegular: return "\u{f5d6}"
        case .fileOnenoteBold: return "\u{f5d7}"
        case .fileOnenoteFilled: return "\u{f5d8}"
        case .fileOnenoteLight: return "\u{f5d9}"
        case .fileOnenoteRegular: return "\u{f5da}"
        case .filePdfBold: return "\u{f5db}"
        case .filePdfFilled: return "\u{f5dc}"
        case .filePdfLight: return "\u{f5dd}"
        case .filePdfRegular: return "\u{f5de}"
        case .filePowerpointBold: return "\u{f5df}"
        case .filePowerpointFilled: return "\u{f5e0}"
        case .filePowerpointLight: return "\u{f5e1}"
        case .filePowerpointRegular: return "\u{f5e2}"
        case .fileSpreadsheetBold: return "\u{f5e3}"
        case .fileSpreadsheetFilled: return "\u{f5e4}"
        case .fileSpreadsheetLight: return "\u{f5e5}"
        case .fileSpreadsheetRegular: return "\u{f5e6}"
        case .fileTextBold: return "\u{f5e7}"
        case .fileTextFilled: return "\u{f5e8}"
        case .fileTextLight: return "\u{f5e9}"
        case .fileTextRegular: return "\u{f5ea}"
        case .fileThreeDBold: return "\u{f5eb}"
        case .fileThreeDFilled: return "\u{f5ec}"
        case .fileThreeDLight: return "\u{f5ed}"
        case .fileThreeDRegular: return "\u{f5ee}"
        case .fileVectorBold: return "\u{f5ef}"
        case .fileVectorFilled: return "\u{f5f0}"
        case .fileVectorLight: return "\u{f5f1}"
        case .fileVectorRegular: return "\u{f5f2}"
        case .fileVideoBold: return "\u{f5f3}"
        case .fileVideoFilled: return "\u{f5f4}"
        case .fileVideoLight: return "\u{f5f5}"
        case .fileVideoRegular: return "\u{f5f6}"
        case .fileWordBold: return "\u{f5f7}"
        case .fileWordFilled: return "\u{f5f8}"
        case .fileWordLight: return "\u{f5f9}"
        case .fileWordRegular: return "\u{f5fa}"
        case .fileXmlBold: return "\u{f5fb}"
        case .fileXmlFilled: return "\u{f5fc}"
        case .fileXmlLight: return "\u{f5fd}"
        case .fileXmlRegular: return "\u{f5fe}"
        case .fileZipBold: return "\u{f5ff}"
        case .fileZipFilled: return "\u{f600}"
        case .fileZipLight: return "\u{f601}"
        case .fileZipRegular: return "\u{f602}"
        case .filesBold: return "\u{f603}"
        case .filesFilled: return "\u{f604}"
        case .filesLight: return "\u{f605}"
        case .filesRegular: return "\u{f606}"
        case .fillColourBold: return "\u{f607}"
        case .fillColourFilled: return "\u{f608}"
        case .fillColourLight: return "\u{f609}"
        case .fillColourRegular: return "\u{f60a}"
        case .filterBold: return "\u{f60b}"
        case .filterCircleBold: return "\u{f60c}"
        case .filterCircleFilled: return "\u{f60d}"
        case .filterCircleLight: return "\u{f60e}"
        case .filterCircleRegular: return "\u{f60f}"
        case .filterLight: return "\u{f610}"
        case .filterRegular: return "\u{f611}"
        case .fitToWidthBold: return "\u{f612}"
        case .fitToWidthLight: return "\u{f613}"
        case .fitToWidthRegular: return "\u{f614}"
        case .fitToWindowExpandBold: return "\u{f615}"
        case .fitToWindowExpandLight: return "\u{f616}"
        case .fitToWindowExpandRegular: return "\u{f617}"
        case .fitToWindowShrinkBold: return "\u{f618}"
        case .fitToWindowShrinkLight: return "\u{f619}"
        case .fitToWindowShrinkRegular: return "\u{f61a}"
        case .flagBold: return "\u{f61b}"
        case .flagCircleBold: return "\u{f61c}"
        case .flagCircleFilled: return "\u{f61d}"
        case .flagCircleLight: return "\u{f61e}"
        case .flagCircleRegular: return "\u{f61f}"
        case .flagFilled: return "\u{f620}"
        case .flagLight: return "\u{f621}"
        case .flagRegular: return "\u{f622}"
        case .folderBold: return "\u{f623}"
        case .folderEditBold: return "\u{f624}"
        case .folderEditLight: return "\u{f625}"
        case .folderEditRegular: return "\u{f626}"
        case .folderFilled: return "\u{f627}"
        case .folderLight: return "\u{f628}"
        case .folderLockBold: return "\u{f629}"
        case .folderLockLight: return "\u{f62a}"
        case .folderLockRegular: return "\u{f62b}"
        case .folderRegular: return "\u{f62c}"
        case .folderViewBold: return "\u{f62d}"
        case .folderViewLight: return "\u{f62e}"
        case .folderViewRegular: return "\u{f62f}"
        case .followUpBold: return "\u{f630}"
        case .followUpLight: return "\u{f631}"
        case .followUpRegular: return "\u{f632}"
        case .foodBold: return "\u{f633}"
        case .foodFilled: return "\u{f634}"
        case .foodLight: return "\u{f635}"
        case .foodRegular: return "\u{f636}"
        case .forecastBold: return "\u{f637}"
        case .forecastFilled: return "\u{f638}"
        case .forecastLight: return "\u{f639}"
        case .forecastRegular: return "\u{f63a}"
        case .formatBold: return "\u{f63b}"
        case .formatDefaultAppBold: return "\u{f63c}"
        case .formatDefaultAppFilled: return "\u{f63d}"
        case .formatDefaultAppLight: return "\u{f63e}"
        case .formatDefaultAppRegular: return "\u{f63f}"
        case .formatLight: return "\u{f640}"
        case .formatPanelControlBarBold: return "\u{f641}"
        case .formatPanelControlBarLight: return "\u{f642}"
        case .formatPanelControlBarRegular: return "\u{f643}"
        case .formatPanelControlDownBold: return "\u{f644}"
        case .formatPanelControlDownLight: return "\u{f645}"
        case .formatPanelControlDownRegular: return "\u{f646}"
        case .formatPanelControlLeftBold: return "\u{f647}"
        case .formatPanelControlLeftLight: return "\u{f648}"
        case .formatPanelControlLeftRegular: return "\u{f649}"
        case .formatPanelControlRightBold: return "\u{f64a}"
        case .formatPanelControlRightLight: return "\u{f64b}"
        case .formatPanelControlRightRegular: return "\u{f64c}"
        case .formatPanelControlUpBold: return "\u{f64d}"
        case .formatPanelControlUpDownBold: return "\u{f64e}"
        case .formatPanelControlUpDownLight: return "\u{f64f}"
        case .formatPanelControlUpDownRegular: return "\u{f650}"
        case .formatPanelControlUpLight: return "\u{f651}"
        case .formatPanelControlUpRegular: return "\u{f652}"
        case .formatRegular: return "\u{f653}"
        case .formatViewMixedBold: return "\u{f654}"
        case .formatViewMixedLight: return "\u{f655}"
        case .formatViewMixedRegular: return "\u{f656}"
        case .formulaBold: return "\u{f657}"
        case .formulaFilled: return "\u{f658}"
        case .formulaLight: return "\u{f659}"
        case .formulaRegular: return "\u{f65a}"
        case .forwardMessageBold: return "\u{f65b}"
        case .forwardMessageFilled: return "\u{f65c}"
        case .forwardMessageLight: return "\u{f65d}"
        case .forwardMessageRegular: return "\u{f65e}"
        case .forwardTenSecBold: return "\u{f65f}"
        case .forwardTenSecLight: return "\u{f660}"
        case .forwardTenSecRegular: return "\u{f661}"
        case .fourColumnBold: return "\u{f662}"
        case .fourColumnLight: return "\u{f663}"
        case .fourColumnRegular: return "\u{f664}"
        case .fourWayNavigationBold: return "\u{f665}"
        case .fourWayNavigationLight: return "\u{f666}"
        case .fourWayNavigationRegular: return "\u{f667}"
        case .frequencyCappingBold: return "\u{f668}"
        case .frequencyCappingLight: return "\u{f669}"
        case .frequencyCappingRegular: return "\u{f66a}"
        case .fulfillmentBold: return "\u{f66b}"
        case .fulfillmentLight: return "\u{f66c}"
        case .fulfillmentRegular: return "\u{f66d}"
        case .fullscreenBold: return "\u{f66e}"
        case .fullscreenExitBold: return "\u{f66f}"
        case .fullscreenExitLight: return "\u{f670}"
        case .fullscreenExitRegular: return "\u{f671}"
        case .fullscreenLight: return "\u{f672}"
        case .fullscreenRegular: return "\u{f673}"
        case .genericDeviceVideoBadgeFilled: return "\u{f674}"
        case .genericDeviceVideoBold: return "\u{f675}"
        case .genericDeviceVideoFilled: return "\u{f676}"
        case .genericDeviceVideoLight: return "\u{f677}"
        case .genericDeviceVideoRegular: return "\u{f678}"
        case .gifBold: return "\u{f679}"
        case .gifFilled: return "\u{f67a}"
        case .gifHorizontalBold: return "\u{f67b}"
        case .gifHorizontalFilled: return "\u{f67c}"
        case .gifHorizontalLight: return "\u{f67d}"
        case .gifHorizontalRegular: return "\u{f67e}"
        case .gifLight: return "\u{f67f}"
        case .gifRegular: return "\u{f680}"
        case .giftBold: return "\u{f681}"
        case .giftFilled: return "\u{f682}"
        case .giftLight: return "\u{f683}"
        case .giftRegular: return "\u{f684}"
        case .greenLeafBold: return "\u{f685}"
        case .greenLeafFilled: return "\u{f686}"
        case .greenLeafLight: return "\u{f687}"
        case .greenLeafRegular: return "\u{f688}"
        case .greenRoomBold: return "\u{f689}"
        case .greenRoomFilled: return "\u{f68a}"
        case .greenRoomLight: return "\u{f68b}"
        case .greenRoomRegular: return "\u{f68c}"
        case .guestIssuerBold: return "\u{f68d}"
        case .guestIssuerLight: return "\u{f68e}"
        case .guestIssuerRegular: return "\u{f68f}"
        case .guideBold: return "\u{f690}"
        case .guideLight: return "\u{f691}"
        case .guideRegular: return "\u{f692}"
        case .handPointerBold: return "\u{f693}"
        case .handPointerLight: return "\u{f694}"
        case .handPointerRegular: return "\u{f695}"
        case .handlerBold: return "\u{f696}"
        case .handlerHorizontalBold: return "\u{f697}"
        case .handlerHorizontalLight: return "\u{f698}"
        case .handlerHorizontalRegular: return "\u{f699}"
        case .handlerLight: return "\u{f69a}"
        case .handlerRegular: return "\u{f69b}"
        case .handsetAlertBold: return "\u{f69c}"
        case .handsetAlertFilled: return "\u{f69d}"
        case .handsetAlertLight: return "\u{f69e}"
        case .handsetAlertRegular: return "\u{f69f}"
        case .handsetBold: return "\u{f6a0}"
        case .handsetDownSlashBold: return "\u{f6a1}"
        case .handsetDownSlashFilled: return "\u{f6a2}"
        case .handsetDownSlashLight: return "\u{f6a3}"
        case .handsetDownSlashRegular: return "\u{f6a4}"
        case .handsetFilled: return "\u{f6a5}"
        case .handsetLight: return "\u{f6a6}"
        case .handsetMutedBold: return "\u{f6a7}"
        case .handsetMutedFilled: return "\u{f6a8}"
        case .handsetMutedLight: return "\u{f6a9}"
        case .handsetMutedRegular: return "\u{f6aa}"
        case .handsetRegular: return "\u{f6ab}"
        case .handsetsArrowLeftBold: return "\u{f6ac}"
        case .handsetsArrowLeftLight: return "\u{f6ad}"
        case .handsetsArrowLeftRegular: return "\u{f6ae}"
        case .handshakeBold: return "\u{f6af}"
        case .handshakeLight: return "\u{f6b0}"
        case .handshakeRegular: return "\u{f6b1}"
        case .headingOneBold: return "\u{f6b2}"
        case .headingOneLight: return "\u{f6b3}"
        case .headingOneRegular: return "\u{f6b4}"
        case .headingThreeBold: return "\u{f6b5}"
        case .headingThreeLight: return "\u{f6b6}"
        case .headingThreeRegular: return "\u{f6b7}"
        case .headingTwoBold: return "\u{f6b8}"
        case .headingTwoLight: return "\u{f6b9}"
        case .headingTwoRegular: return "\u{f6ba}"
        case .headphonesBold: return "\u{f6bb}"
        case .headphonesFilled: return "\u{f6bc}"
        case .headphonesLight: return "\u{f6bd}"
        case .headphonesMutedBold: return "\u{f6be}"
        case .headphonesMutedFilled: return "\u{f6bf}"
        case .headphonesMutedLight: return "\u{f6c0}"
        case .headphonesMutedRegular: return "\u{f6c1}"
        case .headphonesRegular: return "\u{f6c2}"
        case .headsetAlertBold: return "\u{f6c3}"
        case .headsetAlertLight: return "\u{f6c4}"
        case .headsetAlertRegular: return "\u{f6c5}"
        case .headsetArrowDownBold: return "\u{f6c6}"
        case .headsetArrowDownFilled: return "\u{f6c7}"
        case .headsetArrowDownLight: return "\u{f6c8}"
        case .headsetArrowDownRegular: return "\u{f6c9}"
        case .headsetBluetoothBold: return "\u{f6ca}"
        case .headsetBluetoothLight: return "\u{f6cb}"
        case .headsetBluetoothRegular: return "\u{f6cc}"
        case .headsetBold: return "\u{f6cd}"
        case .headsetFilled: return "\u{f6ce}"
        case .headsetLight: return "\u{f6cf}"
        case .headsetMutedBold: return "\u{f6d0}"
        case .headsetMutedLight: return "\u{f6d1}"
        case .headsetMutedRegular: return "\u{f6d2}"
        case .headsetPrivateBold: return "\u{f6d3}"
        case .headsetPrivateLight: return "\u{f6d4}"
        case .headsetPrivateRegular: return "\u{f6d5}"
        case .headsetRegular: return "\u{f6d6}"
        case .hearingBold: return "\u{f6d7}"
        case .hearingImpairedBold: return "\u{f6d8}"
        case .hearingImpairedLight: return "\u{f6d9}"
        case .hearingImpairedRegular: return "\u{f6da}"
        case .hearingLight: return "\u{f6db}"
        case .hearingRegular: return "\u{f6dc}"
        case .helpBold: return "\u{f6dd}"
        case .helpCircleBold: return "\u{f6de}"
        case .helpCircleFilled: return "\u{f6df}"
        case .helpCircleLight: return "\u{f6e0}"
        case .helpCircleRegular: return "\u{f6e1}"
        case .helpLight: return "\u{f6e2}"
        case .helpRegular: return "\u{f6e3}"
        case .helpdeskBold: return "\u{f6e4}"
        case .helpdeskFilled: return "\u{f6e5}"
        case .helpdeskLight: return "\u{f6e6}"
        case .helpdeskRegular: return "\u{f6e7}"
        case .hideBold: return "\u{f6e8}"
        case .hideFilled: return "\u{f6e9}"
        case .hideLight: return "\u{f6ea}"
        case .hideRegular: return "\u{f6eb}"
        case .homeBold: return "\u{f6ec}"
        case .homeFilled: return "\u{f6ed}"
        case .homeLight: return "\u{f6ee}"
        case .homeRegular: return "\u{f6ef}"
        case .horizontalLineBold: return "\u{f6f0}"
        case .horizontalLineLight: return "\u{f6f1}"
        case .horizontalLineRegular: return "\u{f6f2}"
        case .hotelingBold: return "\u{f6f3}"
        case .hotelingFilled: return "\u{f6f4}"
        case .hotelingLight: return "\u{f6f5}"
        case .hotelingRegular: return "\u{f6f6}"
        case .humidityBold: return "\u{f6f7}"
        case .humidityLight: return "\u{f6f8}"
        case .humidityRegular: return "\u{f6f9}"
        case .huntGroupBold: return "\u{f6fa}"
        case .huntGroupFilled: return "\u{f6fb}"
        case .huntGroupLight: return "\u{f6fc}"
        case .huntGroupRegular: return "\u{f6fd}"
        case .idleBold: return "\u{f6fe}"
        case .idleFilled: return "\u{f6ff}"
        case .idleLight: return "\u{f700}"
        case .idleRegular: return "\u{f701}"
        case .immediateBold: return "\u{f702}"
        case .immediateFilled: return "\u{f703}"
        case .immediateLight: return "\u{f704}"
        case .immediateRegular: return "\u{f705}"
        case .importBold: return "\u{f706}"
        case .importLight: return "\u{f707}"
        case .importRegular: return "\u{f708}"
        case .inCommonBold: return "\u{f709}"
        case .inCommonLight: return "\u{f70a}"
        case .inCommonRegular: return "\u{f70b}"
        case .inboxBold: return "\u{f70c}"
        case .inboxFilled: return "\u{f70d}"
        case .inboxLight: return "\u{f70e}"
        case .inboxRegular: return "\u{f70f}"
        case .includeBold: return "\u{f710}"
        case .includeLight: return "\u{f711}"
        case .includeRegular: return "\u{f712}"
        case .incognitoBold: return "\u{f713}"
        case .incognitoFilled: return "\u{f714}"
        case .incognitoLight: return "\u{f715}"
        case .incognitoRegular: return "\u{f716}"
        case .incomingCallLegacyBold: return "\u{f717}"
        case .incomingCallLegacyFilled: return "\u{f718}"
        case .incomingCallLegacyLight: return "\u{f719}"
        case .incomingCallLegacyRegular: return "\u{f71a}"
        case .indentDecreaseBold: return "\u{f71b}"
        case .indentDecreaseLight: return "\u{f71c}"
        case .indentDecreaseRegular: return "\u{f71d}"
        case .indentIncreaseBold: return "\u{f71e}"
        case .indentIncreaseLight: return "\u{f71f}"
        case .indentIncreaseRegular: return "\u{f720}"
        case .infoBadgeFilled: return "\u{f721}"
        case .infoCircleBold: return "\u{f722}"
        case .infoCircleFilled: return "\u{f723}"
        case .infoCircleLight: return "\u{f724}"
        case .infoCircleRegular: return "\u{f725}"
        case .infoCircleTwoBold: return "\u{f726}"
        case .infoCircleTwoFilled: return "\u{f727}"
        case .infoCircleTwoLight: return "\u{f728}"
        case .infoCircleTwoRegular: return "\u{f729}"
        case .inputBold: return "\u{f72a}"
        case .inputDisconnectedBold: return "\u{f72b}"
        case .inputDisconnectedLight: return "\u{f72c}"
        case .inputDisconnectedRegular: return "\u{f72d}"
        case .inputLight: return "\u{f72e}"
        case .inputRegular: return "\u{f72f}"
        case .instantScheduleBold: return "\u{f730}"
        case .instantScheduleFilled: return "\u{f731}"
        case .instantScheduleLight: return "\u{f732}"
        case .instantScheduleRegular: return "\u{f733}"
        case .integerBold: return "\u{f734}"
        case .integerFilled: return "\u{f735}"
        case .integerLight: return "\u{f736}"
        case .integerRegular: return "\u{f737}"
        case .integrationsBold: return "\u{f738}"
        case .integrationsFilled: return "\u{f739}"
        case .integrationsLight: return "\u{f73a}"
        case .integrationsRegular: return "\u{f73b}"
        case .intelligentRoutingBold: return "\u{f73c}"
        case .intelligentRoutingLight: return "\u{f73d}"
        case .intelligentRoutingRegular: return "\u{f73e}"
        case .interactionBold: return "\u{f73f}"
        case .interactionFilled: return "\u{f740}"
        case .interactionLight: return "\u{f741}"
        case .interactionRegular: return "\u{f742}"
        case .invitedUserBold: return "\u{f743}"
        case .invitedUserLight: return "\u{f744}"
        case .invitedUserRegular: return "\u{f745}"
        case .italicBold: return "\u{f746}"
        case .italicFilled: return "\u{f747}"
        case .italicLight: return "\u{f748}"
        case .italicRegular: return "\u{f749}"
        case .joinAudioBold: return "\u{f74a}"
        case .joinAudioFilled: return "\u{f74b}"
        case .joinAudioLight: return "\u{f74c}"
        case .joinAudioRegular: return "\u{f74d}"
        case .keepInTouchBold: return "\u{f74e}"
        case .keepInTouchFilled: return "\u{f74f}"
        case .keepInTouchLight: return "\u{f750}"
        case .keepInTouchRegular: return "\u{f751}"
        case .keyboardBold: return "\u{f752}"
        case .keyboardCloseBold: return "\u{f753}"
        case .keyboardCloseLight: return "\u{f754}"
        case .keyboardCloseRegular: return "\u{f755}"
        case .keyboardLight: return "\u{f756}"
        case .keyboardRegular: return "\u{f757}"
        case .languageBold: return "\u{f758}"
        case .languageFilled: return "\u{f759}"
        case .languageLight: return "\u{f75a}"
        case .languageRegular: return "\u{f75b}"
        case .laptopBold: return "\u{f75c}"
        case .laptopDisconnectedBold: return "\u{f75d}"
        case .laptopDisconnectedLight: return "\u{f75e}"
        case .laptopDisconnectedRegular: return "\u{f75f}"
        case .laptopFilled: return "\u{f760}"
        case .laptopLight: return "\u{f761}"
        case .laptopRegular: return "\u{f762}"
        case .laserPointerBold: return "\u{f763}"
        case .laserPointerCursorBlackLight: return "\u{f764}"
        case .laserPointerCursorBlueLight: return "\u{f765}"
        case .laserPointerCursorGreenLight: return "\u{f766}"
        case .laserPointerCursorPurpleLight: return "\u{f767}"
        case .laserPointerCursorRedLight: return "\u{f768}"
        case .laserPointerCursorWhiteLight: return "\u{f769}"
        case .laserPointerCursorYellowLight: return "\u{f76a}"
        case .laserPointerFilled: return "\u{f76b}"
        case .laserPointerLight: return "\u{f76c}"
        case .laserPointerRegular: return "\u{f76d}"
        case .launchBold: return "\u{f76e}"
        case .launchFilled: return "\u{f76f}"
        case .launchLight: return "\u{f770}"
        case .launchRegular: return "\u{f771}"
        case .layoutSideBySideVerticalBold: return "\u{f772}"
        case .layoutSideBySideVerticalFilled: return "\u{f773}"
        case .layoutSideBySideVerticalLight: return "\u{f774}"
        case .layoutSideBySideVerticalRegular: return "\u{f775}"
        case .leaveBreakoutSessionBold: return "\u{f776}"
        case .leaveBreakoutSessionLight: return "\u{f777}"
        case .leaveBreakoutSessionRegular: return "\u{f778}"
        case .leaveDeviceBold: return "\u{f779}"
        case .leaveDeviceLight: return "\u{f77a}"
        case .leaveDeviceRegular: return "\u{f77b}"
        case .likeBold: return "\u{f77c}"
        case .likeFilled: return "\u{f77d}"
        case .likeLight: return "\u{f77e}"
        case .likeRegular: return "\u{f77f}"
        case .linkBold: return "\u{f780}"
        case .linkLight: return "\u{f781}"
        case .linkRegular: return "\u{f782}"
        case .listBulletedBold: return "\u{f783}"
        case .listBulletedLight: return "\u{f784}"
        case .listBulletedRegular: return "\u{f785}"
        case .listMenuBold: return "\u{f786}"
        case .listMenuLight: return "\u{f787}"
        case .listMenuRegular: return "\u{f788}"
        case .listNumberedBold: return "\u{f789}"
        case .listNumberedLight: return "\u{f78a}"
        case .listNumberedRegular: return "\u{f78b}"
        case .liveBold: return "\u{f78c}"
        case .liveFilled: return "\u{f78d}"
        case .liveLight: return "\u{f78e}"
        case .liveRegular: return "\u{f78f}"
        case .locationBold: return "\u{f790}"
        case .locationFilled: return "\u{f791}"
        case .locationLight: return "\u{f792}"
        case .locationRegular: return "\u{f793}"
        case .longTextBoxBold: return "\u{f794}"
        case .longTextBoxLight: return "\u{f795}"
        case .longTextBoxRegular: return "\u{f796}"
        case .lowerHandBold: return "\u{f797}"
        case .lowerHandLight: return "\u{f798}"
        case .lowerHandRegular: return "\u{f799}"
        case .magicPenBold: return "\u{f79a}"
        case .magicPenFilled: return "\u{f79b}"
        case .magicPenLight: return "\u{f79c}"
        case .magicPenRegular: return "\u{f79d}"
        case .markAsUnreadBold: return "\u{f79e}"
        case .markAsUnreadFilled: return "\u{f79f}"
        case .markAsUnreadLight: return "\u{f7a0}"
        case .markAsUnreadRegular: return "\u{f7a1}"
        case .markdownBold: return "\u{f7a2}"
        case .markdownFilled: return "\u{f7a3}"
        case .markdownLight: return "\u{f7a4}"
        case .markdownRegular: return "\u{f7a5}"
        case .markerBold: return "\u{f7a6}"
        case .markerFilled: return "\u{f7a7}"
        case .markerLight: return "\u{f7a8}"
        case .markerRegular: return "\u{f7a9}"
        case .maximizeBold: return "\u{f7aa}"
        case .maximizeLight: return "\u{f7ab}"
        case .maximizeRegular: return "\u{f7ac}"
        case .mcpBold: return "\u{f7ad}"
        case .mcpFilled: return "\u{f7ae}"
        case .mcpLight: return "\u{f7af}"
        case .mcpRegular: return "\u{f7b0}"
        case .mediaPlayerBold: return "\u{f7b1}"
        case .mediaPlayerLight: return "\u{f7b2}"
        case .mediaPlayerRegular: return "\u{f7b3}"
        case .mediaQualityGoodBold: return "\u{f7b4}"
        case .mediaQualityGoodFilled: return "\u{f7b5}"
        case .mediaQualityGoodLight: return "\u{f7b6}"
        case .mediaQualityGoodRegular: return "\u{f7b7}"
        case .mediaQualityPoorBold: return "\u{f7b8}"
        case .mediaQualityPoorColoredBold: return "\u{f7b9}"
        case .mediaQualityPoorFilled: return "\u{f7ba}"
        case .mediaQualityPoorLight: return "\u{f7bb}"
        case .mediaQualityPoorRegular: return "\u{f7bc}"
        case .mediaQualityUnstableBold: return "\u{f7bd}"
        case .mediaQualityUnstableColoredBold: return "\u{f7be}"
        case .mediaQualityUnstableFilled: return "\u{f7bf}"
        case .mediaQualityUnstableLight: return "\u{f7c0}"
        case .mediaQualityUnstableRegular: return "\u{f7c1}"
        case .meetBold: return "\u{f7c2}"
        case .meetEndBold: return "\u{f7c3}"
        case .meetEndLight: return "\u{f7c4}"
        case .meetEndRegular: return "\u{f7c5}"
        case .meetFilled: return "\u{f7c6}"
        case .meetLight: return "\u{f7c7}"
        case .meetRegular: return "\u{f7c8}"
        case .meetingSummaryBold: return "\u{f7c9}"
        case .meetingSummaryFilled: return "\u{f7ca}"
        case .meetingSummaryLight: return "\u{f7cb}"
        case .meetingSummaryRegular: return "\u{f7cc}"
        case .meetingsBold: return "\u{f7cd}"
        case .meetingsFilled: return "\u{f7ce}"
        case .meetingsFocusMonthBold: return "\u{f7cf}"
        case .meetingsFocusMonthLight: return "\u{f7d0}"
        case .meetingsFocusMonthRegular: return "\u{f7d1}"
        case .meetingsFocusOneDayBold: return "\u{f7d2}"
        case .meetingsFocusOneDayLight: return "\u{f7d3}"
        case .meetingsFocusOneDayRegular: return "\u{f7d4}"
        case .meetingsFocusThreeDayBold: return "\u{f7d5}"
        case .meetingsFocusThreeDayLight: return "\u{f7d6}"
        case .meetingsFocusThreeDayRegular: return "\u{f7d7}"
        case .meetingsFocusUpcomingBold: return "\u{f7d8}"
        case .meetingsFocusUpcomingLight: return "\u{f7d9}"
        case .meetingsFocusUpcomingRegular: return "\u{f7da}"
        case .meetingsLight: return "\u{f7db}"
        case .meetingsPresenceBadgeFilled: return "\u{f7dc}"
        case .meetingsPresenceBold: return "\u{f7dd}"
        case .meetingsPresenceFilled: return "\u{f7de}"
        case .meetingsPresenceLight: return "\u{f7df}"
        case .meetingsPresenceRegular: return "\u{f7e0}"
        case .meetingsRegular: return "\u{f7e1}"
        case .meetingsTeamBold: return "\u{f7e2}"
        case .meetingsTeamFilled: return "\u{f7e3}"
        case .meetingsTeamLight: return "\u{f7e4}"
        case .meetingsTeamNewBold: return "\u{f7e5}"
        case .meetingsTeamNewLight: return "\u{f7e6}"
        case .meetingsTeamNewRegular: return "\u{f7e7}"
        case .meetingsTeamRegular: return "\u{f7e8}"
        case .mentionBold: return "\u{f7e9}"
        case .mentionFilled: return "\u{f7ea}"
        case .mentionLight: return "\u{f7eb}"
        case .mentionRegular: return "\u{f7ec}"
        case .messageQueingBold: return "\u{f7ed}"
        case .messageQueingLight: return "\u{f7ee}"
        case .messageQueingRegular: return "\u{f7ef}"
        case .microphoneBold: return "\u{f7f0}"
        case .microphoneFilled: return "\u{f7f1}"
        case .microphoneHardMutedBold: return "\u{f7f2}"
        case .microphoneHardMutedCircleFilled: return "\u{f7f3}"
        case .microphoneHardMutedLight: return "\u{f7f4}"
        case .microphoneHardMutedRegular: return "\u{f7f5}"
        case .microphoneLight: return "\u{f7f6}"
        case .microphoneMusicModeBold: return "\u{f7f7}"
        case .microphoneMusicModeLight: return "\u{f7f8}"
        case .microphoneMusicModeOnBold: return "\u{f7f9}"
        case .microphoneMusicModeOnLight: return "\u{f7fa}"
        case .microphoneMusicModeOnRegular: return "\u{f7fb}"
        case .microphoneMusicModeRegular: return "\u{f7fc}"
        case .microphoneMutedBold: return "\u{f7fd}"
        case .microphoneMutedCircleFilled: return "\u{f7fe}"
        case .microphoneMutedFilled: return "\u{f7ff}"
        case .microphoneMutedLight: return "\u{f800}"
        case .microphoneMutedRegular: return "\u{f801}"
        case .microphoneOnBold: return "\u{f802}"
        case .microphoneOnLight: return "\u{f803}"
        case .microphoneOnRegular: return "\u{f804}"
        case .microphoneOptAllBold: return "\u{f805}"
        case .microphoneOptAllLight: return "\u{f806}"
        case .microphoneOptAllMutedBold: return "\u{f807}"
        case .microphoneOptAllMutedLight: return "\u{f808}"
        case .microphoneOptAllMutedRegular: return "\u{f809}"
        case .microphoneOptAllOnBold: return "\u{f80a}"
        case .microphoneOptAllOnLight: return "\u{f80b}"
        case .microphoneOptAllOnRegular: return "\u{f80c}"
        case .microphoneOptAllRegular: return "\u{f80d}"
        case .microphoneOptMeBold: return "\u{f80e}"
        case .microphoneOptMeLight: return "\u{f80f}"
        case .microphoneOptMeMutedBold: return "\u{f810}"
        case .microphoneOptMeMutedLight: return "\u{f811}"
        case .microphoneOptMeMutedRegular: return "\u{f812}"
        case .microphoneOptMeOnBold: return "\u{f813}"
        case .microphoneOptMeOnLight: return "\u{f814}"
        case .microphoneOptMeOnRegular: return "\u{f815}"
        case .microphoneOptMeRegular: return "\u{f816}"
        case .microphoneRegular: return "\u{f817}"
        case .mindMapBold: return "\u{f818}"
        case .mindMapLight: return "\u{f819}"
        case .mindMapRegular: return "\u{f81a}"
        case .minimizeBold: return "\u{f81b}"
        case .minimizeLight: return "\u{f81c}"
        case .minimizeRegular: return "\u{f81d}"
        case .minusBold: return "\u{f81e}"
        case .minusFilled: return "\u{f81f}"
        case .minusLight: return "\u{f820}"
        case .minusRegular: return "\u{f821}"
        case .mirrorBold: return "\u{f822}"
        case .mirrorFilled: return "\u{f823}"
        case .mirrorLight: return "\u{f824}"
        case .mirrorRegular: return "\u{f825}"
        case .mmsFilled: return "\u{f826}"
        case .moderatorBold: return "\u{f827}"
        case .moderatorLight: return "\u{f828}"
        case .moderatorRegular: return "\u{f829}"
        case .monitoringBold: return "\u{f82a}"
        case .monitoringLight: return "\u{f82b}"
        case .monitoringRegular: return "\u{f82c}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f82d}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f82e}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f82f}"
        case .moreAdrBold: return "\u{f830}"
        case .moreAdrLight: return "\u{f831}"
        case .moreAdrRegular: return "\u{f832}"
        case .moreBold: return "\u{f833}"
        case .moreCircleBold: return "\u{f834}"
        case .moreCircleFilled: return "\u{f835}"
        case .moreCircleLight: return "\u{f836}"
        case .moreCircleRegular: return "\u{f837}"
        case .moreLight: return "\u{f838}"
        case .moreRegular: return "\u{f839}"
        case .mouseCursorBold: return "\u{f83a}"
        case .mouseCursorLight: return "\u{f83b}"
        case .mouseCursorRegular: return "\u{f83c}"
        case .moveCallInAdrBold: return "\u{f83d}"
        case .moveCallInAdrLight: return "\u{f83e}"
        case .moveCallInAdrRegular: return "\u{f83f}"
        case .moveCallInIphBold: return "\u{f840}"
        case .moveCallInIphLight: return "\u{f841}"
        case .moveCallInIphRegular: return "\u{f842}"
        case .moveCallInLaptopBold: return "\u{f843}"
        case .moveCallInLaptopLight: return "\u{f844}"
        case .moveCallInLaptopRegular: return "\u{f845}"
        case .moveCallInOutAdrBold: return "\u{f846}"
        case .moveCallInOutAdrLight: return "\u{f847}"
        case .moveCallInOutAdrRegular: return "\u{f848}"
        case .moveCallInOutIphBold: return "\u{f849}"
        case .moveCallInOutIphLight: return "\u{f84a}"
        case .moveCallInOutIphRegular: return "\u{f84b}"
        case .moveCallInTabletBold: return "\u{f84c}"
        case .moveCallInTabletLight: return "\u{f84d}"
        case .moveCallInTabletRegular: return "\u{f84e}"
        case .moveCallOutAdrBold: return "\u{f84f}"
        case .moveCallOutAdrLight: return "\u{f850}"
        case .moveCallOutAdrRegular: return "\u{f851}"
        case .moveCallOutIphBold: return "\u{f852}"
        case .moveCallOutIphLight: return "\u{f853}"
        case .moveCallOutIphRegular: return "\u{f854}"
        case .moveCallOutLaptopBold: return "\u{f855}"
        case .moveCallOutLaptopLight: return "\u{f856}"
        case .moveCallOutLaptopRegular: return "\u{f857}"
        case .moveCallOutTabletBold: return "\u{f858}"
        case .moveCallOutTabletLight: return "\u{f859}"
        case .moveCallOutTabletRegular: return "\u{f85a}"
        case .moveToBottomBold: return "\u{f85b}"
        case .moveToBottomFilled: return "\u{f85c}"
        case .moveToBottomLight: return "\u{f85d}"
        case .moveToBottomRegular: return "\u{f85e}"
        case .moveToScreenBold: return "\u{f85f}"
        case .moveToScreenLight: return "\u{f860}"
        case .moveToScreenRegular: return "\u{f861}"
        case .moveToTopBold: return "\u{f862}"
        case .moveToTopFilled: return "\u{f863}"
        case .moveToTopLight: return "\u{f864}"
        case .moveToTopRegular: return "\u{f865}"
        case .multilineChartBold: return "\u{f866}"
        case .multilineChartFilled: return "\u{f867}"
        case .multilineChartLight: return "\u{f868}"
        case .multilineChartRegular: return "\u{f869}"
        case .multimediaBold: return "\u{f86a}"
        case .multimediaFilled: return "\u{f86b}"
        case .multimediaLight: return "\u{f86c}"
        case .multimediaRegular: return "\u{f86d}"
        case .multipledDevicesBold: return "\u{f86e}"
        case .multipledDevicesFilled: return "\u{f86f}"
        case .multipledDevicesLight: return "\u{f870}"
        case .multipledDevicesRegular: return "\u{f871}"
        case .musicModeCircleBold: return "\u{f872}"
        case .musicModeCircleFilled: return "\u{f873}"
        case .musicModeCircleLight: return "\u{f874}"
        case .musicModeCircleRegular: return "\u{f875}"
        case .musicNoteBold: return "\u{f876}"
        case .musicNoteFilled: return "\u{f877}"
        case .musicNoteLight: return "\u{f878}"
        case .musicNoteRegular: return "\u{f879}"
        case .muteOnEntryBold: return "\u{f87a}"
        case .muteOnEntryFilled: return "\u{f87b}"
        case .muteOnEntryLight: return "\u{f87c}"
        case .muteOnEntryRegular: return "\u{f87d}"
        case .networkSwitchBold: return "\u{f87e}"
        case .networkSwitchFilled: return "\u{f87f}"
        case .networkSwitchLight: return "\u{f880}"
        case .networkSwitchRegular: return "\u{f881}"
        case .newManagerBold: return "\u{f882}"
        case .newManagerFilled: return "\u{f883}"
        case .newManagerLight: return "\u{f884}"
        case .newManagerRegular: return "\u{f885}"
        case .newTitleBold: return "\u{f886}"
        case .newTitleLight: return "\u{f887}"
        case .newTitleRegular: return "\u{f888}"
        case .newVoicemailBold: return "\u{f889}"
        case .newVoicemailLight: return "\u{f88a}"
        case .newVoicemailRegular: return "\u{f88b}"
        case .newWhiteboardBold: return "\u{f88c}"
        case .newWhiteboardLight: return "\u{f88d}"
        case .newWhiteboardRegular: return "\u{f88e}"
        case .nextBold: return "\u{f88f}"
        case .nextLight: return "\u{f890}"
        case .nextRegular: return "\u{f891}"
        case .noDevicesBold: return "\u{f892}"
        case .noDevicesLight: return "\u{f893}"
        case .noDevicesRegular: return "\u{f894}"
        case .noiseDetectedCanceledFilled: return "\u{f895}"
        case .noiseDetectedFilled: return "\u{f896}"
        case .noiseNoneCanceledFilled: return "\u{f897}"
        case .noiseNoneFilled: return "\u{f898}"
        case .noiseRemovalBold: return "\u{f899}"
        case .noiseRemovalLight: return "\u{f89a}"
        case .noiseRemovalRegular: return "\u{f89b}"
        case .noteBold: return "\u{f89c}"
        case .noteFilled: return "\u{f89d}"
        case .noteLight: return "\u{f89e}"
        case .notePptBold: return "\u{f89f}"
        case .notePptLight: return "\u{f8a0}"
        case .notePptRegular: return "\u{f8a1}"
        case .noteRegular: return "\u{f8a2}"
        case .notesBold: return "\u{f8a3}"
        case .notesFilled: return "\u{f8a4}"
        case .notesLight: return "\u{f8a5}"
        case .notesRegular: return "\u{f8a6}"
        case .numberBold: return "\u{f8a7}"
        case .numberHighlightBold: return "\u{f8a8}"
        case .numberHighlightFilled: return "\u{f8a9}"
        case .numberHighlightLight: return "\u{f8aa}"
        case .numberHighlightRegular: return "\u{f8ab}"
        case .numberLight: return "\u{f8ac}"
        case .numberRegular: return "\u{f8ad}"
        case .oldRemoteBold: return "\u{f8ae}"
        case .oldRemoteLight: return "\u{f8af}"
        case .oldRemoteRegular: return "\u{f8b0}"
        case .oldTouchBold: return "\u{f8b1}"
        case .oldTouchLight: return "\u{f8b2}"
        case .oldTouchRegular: return "\u{f8b3}"
        case .oneColumnBold: return "\u{f8b4}"
        case .oneColumnLight: return "\u{f8b5}"
        case .oneColumnRegular: return "\u{f8b6}"
        case .oneTimeBold: return "\u{f8b7}"
        case .oneTimeLight: return "\u{f8b8}"
        case .oneTimeRegular: return "\u{f8b9}"
        case .openInFolderBold: return "\u{f8ba}"
        case .openInFolderFilled: return "\u{f8bb}"
        case .openInFolderLight: return "\u{f8bc}"
        case .openInFolderRegular: return "\u{f8bd}"
        case .openPagesBold: return "\u{f8be}"
        case .openPagesLight: return "\u{f8bf}"
        case .openPagesRegular: return "\u{f8c0}"
        case .otherNumberBold: return "\u{f8c1}"
        case .otherNumberFilled: return "\u{f8c2}"
        case .otherNumberLight: return "\u{f8c3}"
        case .otherNumberRegular: return "\u{f8c4}"
        case .otherNumberWarningBold: return "\u{f8c5}"
        case .otherNumberWarningLight: return "\u{f8c6}"
        case .otherNumberWarningRegular: return "\u{f8c7}"
        case .outgoingCallLegacyBold: return "\u{f8c8}"
        case .outgoingCallLegacyFilled: return "\u{f8c9}"
        case .outgoingCallLegacyLight: return "\u{f8ca}"
        case .outgoingCallLegacyRegular: return "\u{f8cb}"
        case .overflowLeftBold: return "\u{f8cc}"
        case .overflowLeftLight: return "\u{f8cd}"
        case .overflowLeftRegular: return "\u{f8ce}"
        case .overflowRightBold: return "\u{f8cf}"
        case .overflowRightLight: return "\u{f8d0}"
        case .overflowRightRegular: return "\u{f8d1}"
        case .pairedCameraBold: return "\u{f8d2}"
        case .pairedCameraLight: return "\u{f8d3}"
        case .pairedCameraRegular: return "\u{f8d4}"
        case .pairedDeviceBold: return "\u{f8d5}"
        case .pairedDeviceLight: return "\u{f8d6}"
        case .pairedDeviceRegular: return "\u{f8d7}"
        case .pairedHandsetBold: return "\u{f8d8}"
        case .pairedHandsetLight: return "\u{f8d9}"
        case .pairedHandsetRegular: return "\u{f8da}"
        case .pairingBold: return "\u{f8db}"
        case .pairingLight: return "\u{f8dc}"
        case .pairingRegular: return "\u{f8dd}"
        case .parenthesisBold: return "\u{f8de}"
        case .parenthesisFilled: return "\u{f8df}"
        case .parenthesisLight: return "\u{f8e0}"
        case .parenthesisRegular: return "\u{f8e1}"
        case .parkedBold: return "\u{f8e2}"
        case .parkedFilled: return "\u{f8e3}"
        case .parkedLight: return "\u{f8e4}"
        case .parkedRegular: return "\u{f8e5}"
        case .parseBold: return "\u{f8e6}"
        case .parseLight: return "\u{f8e7}"
        case .parseRegular: return "\u{f8e8}"
        case .partialBold: return "\u{f8e9}"
        case .partialLight: return "\u{f8ea}"
        case .partialRegular: return "\u{f8eb}"
        case .participantAddBold: return "\u{f8ec}"
        case .participantAddLight: return "\u{f8ed}"
        case .participantAddRegular: return "\u{f8ee}"
        case .participantBlockedBold: return "\u{f8ef}"
        case .participantBlockedLight: return "\u{f8f0}"
        case .participantBlockedRegular: return "\u{f8f1}"
        case .participantBold: return "\u{f8f2}"
        case .participantFilled: return "\u{f8f3}"
        case .participantLight: return "\u{f8f4}"
        case .participantListBold: return "\u{f8f5}"
        case .participantListFilled: return "\u{f8f6}"
        case .participantListLight: return "\u{f8f7}"
        case .participantListRegular: return "\u{f8f8}"
        case .participantRegular: return "\u{f8f9}"
        case .participantRemoveBold: return "\u{f8fa}"
        case .participantRemoveLight: return "\u{f8fb}"
        case .participantRemoveRegular: return "\u{f8fc}"
        case .participantSpeakerBold: return "\u{f8fd}"
        case .participantSpeakerFilled: return "\u{f8fe}"
        case .participantSpeakerLight: return "\u{f8ff}"
        case .participantSpeakerRegular: return "\u{f900}"
        case .participantUnknownBold: return "\u{f901}"
        case .participantUnknownLight: return "\u{f902}"
        case .participantUnknownRegular: return "\u{f903}"
        case .passMouseBold: return "\u{f904}"
        case .passMouseLight: return "\u{f905}"
        case .passMouseRegular: return "\u{f906}"
        case .pauseBadgeFilled: return "\u{f907}"
        case .pauseBold: return "\u{f908}"
        case .pauseFilled: return "\u{f909}"
        case .pauseInteractionBold: return "\u{f90a}"
        case .pauseInteractionFilled: return "\u{f90b}"
        case .pauseInteractionLight: return "\u{f90c}"
        case .pauseInteractionRegular: return "\u{f90d}"
        case .pauseLight: return "\u{f90e}"
        case .pauseRegular: return "\u{f90f}"
        case .peopleAddBold: return "\u{f910}"
        case .peopleAddFilled: return "\u{f911}"
        case .peopleAddLight: return "\u{f912}"
        case .peopleAddRegular: return "\u{f913}"
        case .peopleBold: return "\u{f914}"
        case .peopleCircleBold: return "\u{f915}"
        case .peopleCircleFilled: return "\u{f916}"
        case .peopleCircleLight: return "\u{f917}"
        case .peopleCircleRegular: return "\u{f918}"
        case .peopleFilled: return "\u{f919}"
        case .peopleInsightsBold: return "\u{f91a}"
        case .peopleInsightsFilled: return "\u{f91b}"
        case .peopleInsightsLight: return "\u{f91c}"
        case .peopleInsightsRegular: return "\u{f91d}"
        case .peopleLight: return "\u{f91e}"
        case .peopleManageBold: return "\u{f91f}"
        case .peopleManageFilled: return "\u{f920}"
        case .peopleManageLight: return "\u{f921}"
        case .peopleManageRegular: return "\u{f922}"
        case .peopleRegular: return "\u{f923}"
        case .phoneAlertBold: return "\u{f924}"
        case .phoneAlertLight: return "\u{f925}"
        case .phoneAlertRegular: return "\u{f926}"
        case .phoneBadgeFilled: return "\u{f927}"
        case .phoneBold: return "\u{f928}"
        case .phoneFilled: return "\u{f929}"
        case .phoneLight: return "\u{f92a}"
        case .phoneMutedBold: return "\u{f92b}"
        case .phoneMutedLight: return "\u{f92c}"
        case .phoneMutedRegular: return "\u{f92d}"
        case .phonePrivateBold: return "\u{f92e}"
        case .phonePrivateLight: return "\u{f92f}"
        case .phonePrivateRegular: return "\u{f930}"
        case .phoneRegular: return "\u{f931}"
        case .phoneReplyAllBold: return "\u{f932}"
        case .phoneReplyAllLight: return "\u{f933}"
        case .phoneReplyAllRegular: return "\u{f934}"
        case .phoneReplyBold: return "\u{f935}"
        case .phoneReplyLight: return "\u{f936}"
        case .phoneReplyRegular: return "\u{f937}"
        case .pickerBold: return "\u{f938}"
        case .pickerLight: return "\u{f939}"
        case .pickerRegular: return "\u{f93a}"
        case .pieChartBold: return "\u{f93b}"
        case .pieChartFilled: return "\u{f93c}"
        case .pieChartLight: return "\u{f93d}"
        case .pieChartRegular: return "\u{f93e}"
        case .pinBold: return "\u{f93f}"
        case .pinFilled: return "\u{f940}"
        case .pinLight: return "\u{f941}"
        case .pinListActivityBold: return "\u{f942}"
        case .pinListActivityLight: return "\u{f943}"
        case .pinListActivityRegular: return "\u{f944}"
        case .pinListBold: return "\u{f945}"
        case .pinListLight: return "\u{f946}"
        case .pinListRegular: return "\u{f947}"
        case .pinMutedBold: return "\u{f948}"
        case .pinMutedFilled: return "\u{f949}"
        case .pinMutedLight: return "\u{f94a}"
        case .pinMutedRegular: return "\u{f94b}"
        case .pinRegular: return "\u{f94c}"
        case .pipBold: return "\u{f94d}"
        case .pipEnterBold: return "\u{f94e}"
        case .pipEnterLight: return "\u{f94f}"
        case .pipEnterRegular: return "\u{f950}"
        case .pipExitBold: return "\u{f951}"
        case .pipExitLight: return "\u{f952}"
        case .pipExitRegular: return "\u{f953}"
        case .pipFilled: return "\u{f954}"
        case .pipLight: return "\u{f955}"
        case .pipRegular: return "\u{f956}"
        case .placeholderBold: return "\u{f957}"
        case .placeholderFilled: return "\u{f958}"
        case .placeholderLight: return "\u{f959}"
        case .placeholderRegular: return "\u{f95a}"
        case .playBold: return "\u{f95b}"
        case .playCircleBold: return "\u{f95c}"
        case .playCircleFilled: return "\u{f95d}"
        case .playCircleLight: return "\u{f95e}"
        case .playCircleRegular: return "\u{f95f}"
        case .playFilled: return "\u{f960}"
        case .playLight: return "\u{f961}"
        case .playRegular: return "\u{f962}"
        case .plugAcBold: return "\u{f963}"
        case .plugAcLight: return "\u{f964}"
        case .plugAcRegular: return "\u{f965}"
        case .plusBold: return "\u{f966}"
        case .plusCircleBold: return "\u{f967}"
        case .plusCircleFilled: return "\u{f968}"
        case .plusCircleLight: return "\u{f969}"
        case .plusCircleRegular: return "\u{f96a}"
        case .plusLight: return "\u{f96b}"
        case .plusRegular: return "\u{f96c}"
        case .pmrBold: return "\u{f96d}"
        case .pmrFilled: return "\u{f96e}"
        case .pmrLight: return "\u{f96f}"
        case .pmrRegular: return "\u{f970}"
        case .pollBold: return "\u{f971}"
        case .pollFilled: return "\u{f972}"
        case .pollLight: return "\u{f973}"
        case .pollRegular: return "\u{f974}"
        case .popInBold: return "\u{f975}"
        case .popInLight: return "\u{f976}"
        case .popInRegular: return "\u{f977}"
        case .popOutBold: return "\u{f978}"
        case .popOutLight: return "\u{f979}"
        case .popOutRegular: return "\u{f97a}"
        case .popUpBold: return "\u{f97b}"
        case .popUpLight: return "\u{f97c}"
        case .popUpRegular: return "\u{f97d}"
        case .portraitLandscapeBold: return "\u{f97e}"
        case .portraitLandscapeLight: return "\u{f97f}"
        case .portraitLandscapeRegular: return "\u{f980}"
        case .potentialFraudBold: return "\u{f981}"
        case .potentialFraudFilled: return "\u{f982}"
        case .potentialFraudLight: return "\u{f983}"
        case .potentialFraudRegular: return "\u{f984}"
        case .powerAcBold: return "\u{f985}"
        case .powerAcLight: return "\u{f986}"
        case .powerAcRegular: return "\u{f987}"
        case .powerBold: return "\u{f988}"
        case .powerLight: return "\u{f989}"
        case .powerRegular: return "\u{f98a}"
        case .preHeaderBold: return "\u{f98b}"
        case .preHeaderLight: return "\u{f98c}"
        case .preHeaderRegular: return "\u{f98d}"
        case .premiumBold: return "\u{f98e}"
        case .premiumLight: return "\u{f98f}"
        case .premiumRegular: return "\u{f990}"
        case .presentationBold: return "\u{f991}"
        case .presentationLight: return "\u{f992}"
        case .presentationRegular: return "\u{f993}"
        case .preventDownloadBold: return "\u{f994}"
        case .preventDownloadFilled: return "\u{f995}"
        case .preventDownloadLight: return "\u{f996}"
        case .preventDownloadRegular: return "\u{f997}"
        case .primaryParticipantBold: return "\u{f998}"
        case .primaryParticipantFilled: return "\u{f999}"
        case .primaryParticipantLight: return "\u{f99a}"
        case .primaryParticipantRegular: return "\u{f99b}"
        case .printBold: return "\u{f99c}"
        case .printLight: return "\u{f99d}"
        case .printRegular: return "\u{f99e}"
        case .priorityBadgeFilled: return "\u{f99f}"
        case .priorityCircleBold: return "\u{f9a0}"
        case .priorityCircleFilled: return "\u{f9a1}"
        case .priorityCircleLight: return "\u{f9a2}"
        case .priorityCircleRegular: return "\u{f9a3}"
        case .priorityCircleTwoBold: return "\u{f9a4}"
        case .priorityCircleTwoFilled: return "\u{f9a5}"
        case .priorityCircleTwoLight: return "\u{f9a6}"
        case .priorityCircleTwoRegular: return "\u{f9a7}"
        case .priorityWaveBold: return "\u{f9a8}"
        case .priorityWaveLight: return "\u{f9a9}"
        case .priorityWaveRegular: return "\u{f9aa}"
        case .privacyCircleBold: return "\u{f9ab}"
        case .privacyCircleFilled: return "\u{f9ac}"
        case .privacyCircleLight: return "\u{f9ad}"
        case .privacyCircleRegular: return "\u{f9ae}"
        case .privateBold: return "\u{f9af}"
        case .privateCircleBold: return "\u{f9b0}"
        case .privateCircleFilled: return "\u{f9b1}"
        case .privateCircleLight: return "\u{f9b2}"
        case .privateCircleRegular: return "\u{f9b3}"
        case .privateLight: return "\u{f9b4}"
        case .privateMeetingBold: return "\u{f9b5}"
        case .privateMeetingLight: return "\u{f9b6}"
        case .privateMeetingRegular: return "\u{f9b7}"
        case .privateRegular: return "\u{f9b8}"
        case .productDemoBold: return "\u{f9b9}"
        case .productDemoLight: return "\u{f9ba}"
        case .productDemoRegular: return "\u{f9bb}"
        case .promptsAiBold: return "\u{f9bc}"
        case .promptsAiLight: return "\u{f9bd}"
        case .promptsAiRegular: return "\u{f9be}"
        case .proximityBold: return "\u{f9bf}"
        case .proximityLight: return "\u{f9c0}"
        case .proximityMutedBold: return "\u{f9c1}"
        case .proximityMutedLight: return "\u{f9c2}"
        case .proximityMutedRegular: return "\u{f9c3}"
        case .proximityRegular: return "\u{f9c4}"
        case .proximityVideoBold: return "\u{f9c5}"
        case .proximityVideoLight: return "\u{f9c6}"
        case .proximityVideoRegular: return "\u{f9c7}"
        case .ptoPresenceBold: return "\u{f9c8}"
        case .ptoPresenceFilled: return "\u{f9c9}"
        case .ptoPresenceLight: return "\u{f9ca}"
        case .ptoPresenceRegular: return "\u{f9cb}"
        case .pullCallBold: return "\u{f9cc}"
        case .pullCallFilled: return "\u{f9cd}"
        case .pullCallLight: return "\u{f9ce}"
        case .pullCallRegular: return "\u{f9cf}"
        case .purchaseOrderBold: return "\u{f9d0}"
        case .purchaseOrderFilled: return "\u{f9d1}"
        case .purchaseOrderLight: return "\u{f9d2}"
        case .purchaseOrderRegular: return "\u{f9d3}"
        case .qABold: return "\u{f9d4}"
        case .qAFilled: return "\u{f9d5}"
        case .qALight: return "\u{f9d6}"
        case .qARegular: return "\u{f9d7}"
        case .qrCodeBold: return "\u{f9d8}"
        case .qrCodeLight: return "\u{f9d9}"
        case .qrCodeRegular: return "\u{f9da}"
        case .qrCodeScanBold: return "\u{f9db}"
        case .qrCodeScanLight: return "\u{f9dc}"
        case .qrCodeScanRegular: return "\u{f9dd}"
        case .qualityBold: return "\u{f9de}"
        case .qualityLight: return "\u{f9df}"
        case .qualityRegular: return "\u{f9e0}"
        case .queueContactBold: return "\u{f9e1}"
        case .queueContactFilled: return "\u{f9e2}"
        case .queueContactLight: return "\u{f9e3}"
        case .queueContactRegular: return "\u{f9e4}"
        case .queuedInteractionBold: return "\u{f9e5}"
        case .queuedInteractionFilled: return "\u{f9e6}"
        case .queuedInteractionLight: return "\u{f9e7}"
        case .queuedInteractionRegular: return "\u{f9e8}"
        case .quietBold: return "\u{f9e9}"
        case .quietHoursPresenceBold: return "\u{f9ea}"
        case .quietHoursPresenceFilled: return "\u{f9eb}"
        case .quietHoursPresenceLight: return "\u{f9ec}"
        case .quietHoursPresenceRegular: return "\u{f9ed}"
        case .quietLight: return "\u{f9ee}"
        case .quietRegular: return "\u{f9ef}"
        case .radioButtonGroupBold: return "\u{f9f0}"
        case .radioButtonGroupLight: return "\u{f9f1}"
        case .radioButtonGroupRegular: return "\u{f9f2}"
        case .raiseHandBold: return "\u{f9f3}"
        case .raiseHandCircleFilled: return "\u{f9f4}"
        case .raiseHandFilled: return "\u{f9f5}"
        case .raiseHandLight: return "\u{f9f6}"
        case .raiseHandRegular: return "\u{f9f7}"
        case .ramBold: return "\u{f9f8}"
        case .ramLight: return "\u{f9f9}"
        case .ramRegular: return "\u{f9fa}"
        case .reactionsBold: return "\u{f9fb}"
        case .reactionsFilled: return "\u{f9fc}"
        case .reactionsLight: return "\u{f9fd}"
        case .reactionsRegular: return "\u{f9fe}"
        case .reactivateBold: return "\u{f9ff}"
        case .reactivateLight: return "\u{fa00}"
        case .reactivateRegular: return "\u{fa01}"
        case .receiveVoiceBold: return "\u{fa02}"
        case .receiveVoiceFilled: return "\u{fa03}"
        case .receiveVoiceLight: return "\u{fa04}"
        case .receiveVoiceRegular: return "\u{fa05}"
        case .recentsBold: return "\u{fa06}"
        case .recentsFilled: return "\u{fa07}"
        case .recentsLight: return "\u{fa08}"
        case .recentsPresenceBadgeFilled: return "\u{fa09}"
        case .recentsPresenceBold: return "\u{fa0a}"
        case .recentsPresenceFilled: return "\u{fa0b}"
        case .recentsPresenceLight: return "\u{fa0c}"
        case .recentsPresenceRegular: return "\u{fa0d}"
        case .recentsRegular: return "\u{fa0e}"
        case .recordActiveBadgeFilled: return "\u{fa0f}"
        case .recordActiveBold: return "\u{fa10}"
        case .recordActiveFilled: return "\u{fa11}"
        case .recordActiveLight: return "\u{fa12}"
        case .recordActiveRegular: return "\u{fa13}"
        case .recordBold: return "\u{fa14}"
        case .recordFilled: return "\u{fa15}"
        case .recordLight: return "\u{fa16}"
        case .recordPausedBadgeFilled: return "\u{fa17}"
        case .recordPausedBold: return "\u{fa18}"
        case .recordPausedFilled: return "\u{fa19}"
        case .recordPausedLight: return "\u{fa1a}"
        case .recordPausedRegular: return "\u{fa1b}"
        case .recordRegular: return "\u{fa1c}"
        case .recurringBold: return "\u{fa1d}"
        case .recurringLight: return "\u{fa1e}"
        case .recurringOffBold: return "\u{fa1f}"
        case .recurringOffLight: return "\u{fa20}"
        case .recurringOffRegular: return "\u{fa21}"
        case .recurringRegular: return "\u{fa22}"
        case .redoBold: return "\u{fa23}"
        case .redoLight: return "\u{fa24}"
        case .redoRegular: return "\u{fa25}"
        case .refreshBold: return "\u{fa26}"
        case .refreshLight: return "\u{fa27}"
        case .refreshRegular: return "\u{fa28}"
        case .remoteDesktopControlBold: return "\u{fa29}"
        case .remoteDesktopControlFilled: return "\u{fa2a}"
        case .remoteDesktopControlLight: return "\u{fa2b}"
        case .remoteDesktopControlRegular: return "\u{fa2c}"
        case .removeBold: return "\u{fa2d}"
        case .removeFilled: return "\u{fa2e}"
        case .removeLight: return "\u{fa2f}"
        case .removeRegular: return "\u{fa30}"
        case .replyBold: return "\u{fa31}"
        case .replyFilled: return "\u{fa32}"
        case .replyLight: return "\u{fa33}"
        case .replyListBold: return "\u{fa34}"
        case .replyListFilled: return "\u{fa35}"
        case .replyListLight: return "\u{fa36}"
        case .replyListRegular: return "\u{fa37}"
        case .replyPrivatelyBold: return "\u{fa38}"
        case .replyPrivatelyLight: return "\u{fa39}"
        case .replyPrivatelyRegular: return "\u{fa3a}"
        case .replyRegular: return "\u{fa3b}"
        case .resetBold: return "\u{fa3c}"
        case .resetLight: return "\u{fa3d}"
        case .resetRegular: return "\u{fa3e}"
        case .resizeCornerBold: return "\u{fa3f}"
        case .resizeCornerLight: return "\u{fa40}"
        case .resizeCornerRegular: return "\u{fa41}"
        case .responsiveMobileBold: return "\u{fa42}"
        case .responsiveMobileLight: return "\u{fa43}"
        case .responsiveMobileRegular: return "\u{fa44}"
        case .restartBold: return "\u{fa45}"
        case .restartLight: return "\u{fa46}"
        case .restartRegular: return "\u{fa47}"
        case .resumeInteractionBold: return "\u{fa48}"
        case .resumeInteractionFilled: return "\u{fa49}"
        case .resumeInteractionLight: return "\u{fa4a}"
        case .resumeInteractionRegular: return "\u{fa4b}"
        case .retrieveCallBold: return "\u{fa4c}"
        case .retrieveCallFilled: return "\u{fa4d}"
        case .retrieveCallLight: return "\u{fa4e}"
        case .retrieveCallRegular: return "\u{fa4f}"
        case .returnBold: return "\u{fa50}"
        case .returnLight: return "\u{fa51}"
        case .returnRegular: return "\u{fa52}"
        case .rewindTenSecBold: return "\u{fa53}"
        case .rewindTenSecLight: return "\u{fa54}"
        case .rewindTenSecRegular: return "\u{fa55}"
        case .ringtoneBold: return "\u{fa56}"
        case .ringtoneLight: return "\u{fa57}"
        case .ringtoneRegular: return "\u{fa58}"
        case .roomCalendarBold: return "\u{fa59}"
        case .roomCalendarLight: return "\u{fa5a}"
        case .roomCalendarRegular: return "\u{fa5b}"
        case .roomLightsBold: return "\u{fa5c}"
        case .roomLightsFilled: return "\u{fa5d}"
        case .roomLightsLight: return "\u{fa5e}"
        case .roomLightsRegular: return "\u{fa5f}"
        case .rotateContentBold: return "\u{fa60}"
        case .rotateContentFilled: return "\u{fa61}"
        case .rotateContentLight: return "\u{fa62}"
        case .rotateContentRegular: return "\u{fa63}"
        case .rssBold: return "\u{fa64}"
        case .rssFilled: return "\u{fa65}"
        case .rssLight: return "\u{fa66}"
        case .rssRegular: return "\u{fa67}"
        case .ruleBasedBold: return "\u{fa68}"
        case .ruleBasedFilled: return "\u{fa69}"
        case .ruleBasedLight: return "\u{fa6a}"
        case .ruleBasedRegular: return "\u{fa6b}"
        case .rulerBold: return "\u{fa6c}"
        case .rulerFilled: return "\u{fa6d}"
        case .rulerLight: return "\u{fa6e}"
        case .rulerRegular: return "\u{fa6f}"
        case .runningApplicationBold: return "\u{fa70}"
        case .runningApplicationFilled: return "\u{fa71}"
        case .runningApplicationLight: return "\u{fa72}"
        case .runningApplicationRegular: return "\u{fa73}"
        case .saveBold: return "\u{fa74}"
        case .saveLight: return "\u{fa75}"
        case .saveRegular: return "\u{fa76}"
        case .saveTranscriptBold: return "\u{fa77}"
        case .saveTranscriptFilled: return "\u{fa78}"
        case .saveTranscriptLight: return "\u{fa79}"
        case .saveTranscriptRegular: return "\u{fa7a}"
        case .scanBold: return "\u{fa7b}"
        case .scanLight: return "\u{fa7c}"
        case .scanRegular: return "\u{fa7d}"
        case .scheduleAiBold: return "\u{fa7e}"
        case .scheduleAiLight: return "\u{fa7f}"
        case .scheduleAiRegular: return "\u{fa80}"
        case .scheduleSendBold: return "\u{fa81}"
        case .scheduleSendFilled: return "\u{fa82}"
        case .scheduleSendLight: return "\u{fa83}"
        case .scheduleSendRegular: return "\u{fa84}"
        case .scheduleWinnerBold: return "\u{fa85}"
        case .scheduleWinnerFilled: return "\u{fa86}"
        case .scheduleWinnerLight: return "\u{fa87}"
        case .scheduleWinnerRegular: return "\u{fa88}"
        case .schedulerAvailableBold: return "\u{fa89}"
        case .schedulerAvailableLight: return "\u{fa8a}"
        case .schedulerAvailableRegular: return "\u{fa8b}"
        case .schedulerNotWorkingHoursBold: return "\u{fa8c}"
        case .schedulerNotWorkingHoursLight: return "\u{fa8d}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa8e}"
        case .schedulerUnavailableBold: return "\u{fa8f}"
        case .schedulerUnavailableLight: return "\u{fa90}"
        case .schedulerUnavailableRegular: return "\u{fa91}"
        case .schedulerUnknownBold: return "\u{fa92}"
        case .schedulerUnknownLight: return "\u{fa93}"
        case .schedulerUnknownRegular: return "\u{fa94}"
        case .screenshotBold: return "\u{fa95}"
        case .screenshotDocBold: return "\u{fa96}"
        case .screenshotDocFilled: return "\u{fa97}"
        case .screenshotDocLight: return "\u{fa98}"
        case .screenshotDocRegular: return "\u{fa99}"
        case .screenshotLight: return "\u{fa9a}"
        case .screenshotRegular: return "\u{fa9b}"
        case .searchAiBold: return "\u{fa9c}"
        case .searchAiLight: return "\u{fa9d}"
        case .searchAiRegular: return "\u{fa9e}"
        case .searchBold: return "\u{fa9f}"
        case .searchFilled: return "\u{faa0}"
        case .searchLight: return "\u{faa1}"
        case .searchRegular: return "\u{faa2}"
        case .secondaryArrowBold: return "\u{faa3}"
        case .secondaryArrowLight: return "\u{faa4}"
        case .secondaryArrowRegular: return "\u{faa5}"
        case .secureCallLockBold: return "\u{faa6}"
        case .secureCallLockFilled: return "\u{faa7}"
        case .secureCallLockLight: return "\u{faa8}"
        case .secureCallLockRegular: return "\u{faa9}"
        case .secureCallShieldBold: return "\u{faaa}"
        case .secureCallShieldFilled: return "\u{faab}"
        case .secureCallShieldLight: return "\u{faac}"
        case .secureCallShieldRegular: return "\u{faad}"
        case .secureCircleBold: return "\u{faae}"
        case .secureCircleFilled: return "\u{faaf}"
        case .secureCircleLight: return "\u{fab0}"
        case .secureCircleRegular: return "\u{fab1}"
        case .secureLockBold: return "\u{fab2}"
        case .secureLockFilled: return "\u{fab3}"
        case .secureLockLight: return "\u{fab4}"
        case .secureLockRegular: return "\u{fab5}"
        case .segmentExcludeFilled: return "\u{fab6}"
        case .segmentFilterFilled: return "\u{fab7}"
        case .segmentIncludeFilled: return "\u{fab8}"
        case .selectAllBold: return "\u{fab9}"
        case .selectAllFilled: return "\u{faba}"
        case .selectAllLight: return "\u{fabb}"
        case .selectAllRegular: return "\u{fabc}"
        case .selectionBold: return "\u{fabd}"
        case .selectionFilled: return "\u{fabe}"
        case .selectionLight: return "\u{fabf}"
        case .selectionRegular: return "\u{fac0}"
        case .sendBold: return "\u{fac1}"
        case .sendDigitsBold: return "\u{fac2}"
        case .sendDigitsFilled: return "\u{fac3}"
        case .sendDigitsLight: return "\u{fac4}"
        case .sendDigitsRegular: return "\u{fac5}"
        case .sendFilled: return "\u{fac6}"
        case .sendLight: return "\u{fac7}"
        case .sendRegular: return "\u{fac8}"
        case .sendVoiceBold: return "\u{fac9}"
        case .sendVoiceFilled: return "\u{faca}"
        case .sendVoiceLight: return "\u{facb}"
        case .sendVoiceRegular: return "\u{facc}"
        case .serverBold: return "\u{facd}"
        case .serverErrorBold: return "\u{face}"
        case .serverErrorLight: return "\u{facf}"
        case .serverErrorRegular: return "\u{fad0}"
        case .serverLight: return "\u{fad1}"
        case .serverRegular: return "\u{fad2}"
        case .servicesBold: return "\u{fad3}"
        case .servicesLight: return "\u{fad4}"
        case .servicesRegular: return "\u{fad5}"
        case .setVariableBold: return "\u{fad6}"
        case .setVariableLight: return "\u{fad7}"
        case .setVariableRegular: return "\u{fad8}"
        case .settingsBold: return "\u{fad9}"
        case .settingsFilled: return "\u{fada}"
        case .settingsLight: return "\u{fadb}"
        case .settingsRegular: return "\u{fadc}"
        case .setupAssistantBold: return "\u{fadd}"
        case .setupAssistantLight: return "\u{fade}"
        case .setupAssistantRegular: return "\u{fadf}"
        case .sftpBold: return "\u{fae0}"
        case .sftpLight: return "\u{fae1}"
        case .sftpRegular: return "\u{fae2}"
        case .shapeCircleBold: return "\u{fae3}"
        case .shapeCircleFilled: return "\u{fae4}"
        case .shapeCircleLight: return "\u{fae5}"
        case .shapeCircleMdFilled: return "\u{fae6}"
        case .shapeCircleRegular: return "\u{fae7}"
        case .shapeCircleSmFilled: return "\u{fae8}"
        case .shapeDiagonalLineBold: return "\u{fae9}"
        case .shapeDiagonalLineLight: return "\u{faea}"
        case .shapeDiagonalLineRegular: return "\u{faeb}"
        case .shapeDiamondBold: return "\u{faec}"
        case .shapeDiamondFilled: return "\u{faed}"
        case .shapeDiamondLight: return "\u{faee}"
        case .shapeDiamondRegular: return "\u{faef}"
        case .shapeOvalBold: return "\u{faf0}"
        case .shapeOvalLight: return "\u{faf1}"
        case .shapeOvalRegular: return "\u{faf2}"
        case .shapeSquareBold: return "\u{faf3}"
        case .shapeSquareFilled: return "\u{faf4}"
        case .shapeSquareLight: return "\u{faf5}"
        case .shapeSquareRegular: return "\u{faf6}"
        case .shapeTriangleBold: return "\u{faf7}"
        case .shapeTriangleFilled: return "\u{faf8}"
        case .shapeTriangleLight: return "\u{faf9}"
        case .shapeTriangleRegular: return "\u{fafa}"
        case .shapesBold: return "\u{fafb}"
        case .shapesFilled: return "\u{fafc}"
        case .shapesLight: return "\u{fafd}"
        case .shapesRegular: return "\u{fafe}"
        case .shareCNativeAdrBold: return "\u{faff}"
        case .shareCNativeAdrFilled: return "\u{fb00}"
        case .shareCNativeAdrLight: return "\u{fb01}"
        case .shareCNativeAdrRegular: return "\u{fb02}"
        case .shareCNativeIphBold: return "\u{fb03}"
        case .shareCNativeIphLight: return "\u{fb04}"
        case .shareCNativeIphRegular: return "\u{fb05}"
        case .shareContentOnDeviceBold: return "\u{fb06}"
        case .shareContentOnDeviceLight: return "\u{fb07}"
        case .shareContentOnDeviceRegular: return "\u{fb08}"
        case .shareScreenAddBold: return "\u{fb09}"
        case .shareScreenAddLight: return "\u{fb0a}"
        case .shareScreenAddRegular: return "\u{fb0b}"
        case .shareScreenBadgeFilled: return "\u{fb0c}"
        case .shareScreenBold: return "\u{fb0d}"
        case .shareScreenFilled: return "\u{fb0e}"
        case .shareScreenLight: return "\u{fb0f}"
        case .shareScreenRegular: return "\u{fb10}"
        case .shareSpaceBold: return "\u{fb11}"
        case .shareSpaceLight: return "\u{fb12}"
        case .shareSpaceRegular: return "\u{fb13}"
        case .shieldBold: return "\u{fb14}"
        case .shieldLight: return "\u{fb15}"
        case .shieldRegular: return "\u{fb16}"
        case .shoppingCartBold: return "\u{fb17}"
        case .shoppingCartFilled: return "\u{fb18}"
        case .shoppingCartLight: return "\u{fb19}"
        case .shoppingCartRegular: return "\u{fb1a}"
        case .shortTextBoxBold: return "\u{fb1b}"
        case .shortTextBoxLight: return "\u{fb1c}"
        case .shortTextBoxRegular: return "\u{fb1d}"
        case .showBold: return "\u{fb1e}"
        case .showFilled: return "\u{fb1f}"
        case .showLight: return "\u{fb20}"
        case .showRegular: return "\u{fb21}"
        case .sidePanelBold: return "\u{fb22}"
        case .sidePanelFilled: return "\u{fb23}"
        case .sidePanelLight: return "\u{fb24}"
        case .sidePanelRegular: return "\u{fb25}"
        case .signInBold: return "\u{fb26}"
        case .signInFilled: return "\u{fb27}"
        case .signInForcedBold: return "\u{fb28}"
        case .signInForcedLight: return "\u{fb29}"
        case .signInForcedRegular: return "\u{fb2a}"
        case .signInLight: return "\u{fb2b}"
        case .signInRegular: return "\u{fb2c}"
        case .signLangIntBold: return "\u{fb2d}"
        case .signLangIntLight: return "\u{fb2e}"
        case .signLangIntRegular: return "\u{fb2f}"
        case .signOutBold: return "\u{fb30}"
        case .signOutLight: return "\u{fb31}"
        case .signOutRegular: return "\u{fb32}"
        case .signalFourBold: return "\u{fb33}"
        case .signalFourLight: return "\u{fb34}"
        case .signalFourRegular: return "\u{fb35}"
        case .signalOneBold: return "\u{fb36}"
        case .signalOneLight: return "\u{fb37}"
        case .signalOneRegular: return "\u{fb38}"
        case .signalThreeBold: return "\u{fb39}"
        case .signalThreeLight: return "\u{fb3a}"
        case .signalThreeRegular: return "\u{fb3b}"
        case .signalTwoBold: return "\u{fb3c}"
        case .signalTwoLight: return "\u{fb3d}"
        case .signalTwoRegular: return "\u{fb3e}"
        case .signalZeroBold: return "\u{fb3f}"
        case .signalZeroLight: return "\u{fb40}"
        case .signalZeroRegular: return "\u{fb41}"
        case .simplePromotionBold: return "\u{fb42}"
        case .simplePromotionLight: return "\u{fb43}"
        case .simplePromotionRegular: return "\u{fb44}"
        case .singleNumberReachBold: return "\u{fb45}"
        case .singleNumberReachLight: return "\u{fb46}"
        case .singleNumberReachRegular: return "\u{fb47}"
        case .sipRegistrationInProgressBold: return "\u{fb48}"
        case .sipRegistrationInProgressFilled: return "\u{fb49}"
        case .sipRegistrationInProgressLight: return "\u{fb4a}"
        case .sipRegistrationInProgressRegular: return "\u{fb4b}"
        case .skipBold: return "\u{fb4c}"
        case .skipBwBold: return "\u{fb4d}"
        case .skipBwFilled: return "\u{fb4e}"
        case .skipBwLight: return "\u{fb4f}"
        case .skipBwRegular: return "\u{fb50}"
        case .skipFwBold: return "\u{fb51}"
        case .skipFwFilled: return "\u{fb52}"
        case .skipFwLight: return "\u{fb53}"
        case .skipFwRegular: return "\u{fb54}"
        case .skipLight: return "\u{fb55}"
        case .skipRegular: return "\u{fb56}"
        case .smartAudioBold: return "\u{fb57}"
        case .smartAudioLight: return "\u{fb58}"
        case .smartAudioRegular: return "\u{fb59}"
        case .smartReplyBold: return "\u{fb5a}"
        case .smartReplyLight: return "\u{fb5b}"
        case .smartReplyRegular: return "\u{fb5c}"
        case .smsFilled: return "\u{fb5d}"
        case .smsInboundBold: return "\u{fb5e}"
        case .smsInboundLight: return "\u{fb5f}"
        case .smsInboundRegular: return "\u{fb60}"
        case .smsMessageBold: return "\u{fb61}"
        case .smsMessageFilled: return "\u{fb62}"
        case .smsMessageLight: return "\u{fb63}"
        case .smsMessageOutgoingBold: return "\u{fb64}"
        case .smsMessageOutgoingFilled: return "\u{fb65}"
        case .smsMessageOutgoingLight: return "\u{fb66}"
        case .smsMessageOutgoingRegular: return "\u{fb67}"
        case .smsMessageRegular: return "\u{fb68}"
        case .smsMessageStartBold: return "\u{fb69}"
        case .smsMessageStartFilled: return "\u{fb6a}"
        case .smsMessageStartLight: return "\u{fb6b}"
        case .smsMessageStartRegular: return "\u{fb6c}"
        case .smsOutgoingFilled: return "\u{fb6d}"
        case .smsUnreadBold: return "\u{fb6e}"
        case .smsUnreadLight: return "\u{fb6f}"
        case .smsUnreadRegular: return "\u{fb70}"
        case .sortAscendingBold: return "\u{fb71}"
        case .sortAscendingLight: return "\u{fb72}"
        case .sortAscendingRegular: return "\u{fb73}"
        case .sortDescendingBold: return "\u{fb74}"
        case .sortDescendingLight: return "\u{fb75}"
        case .sortDescendingRegular: return "\u{fb76}"
        case .soundDefaultBold: return "\u{fb77}"
        case .soundDefaultLight: return "\u{fb78}"
        case .soundDefaultRegular: return "\u{fb79}"
        case .sparkleBold: return "\u{fb7a}"
        case .sparkleFilled: return "\u{fb7b}"
        case .sparkleLight: return "\u{fb7c}"
        case .sparkleRegular: return "\u{fb7d}"
        case .speakerBold: return "\u{fb7e}"
        case .speakerDisconnectedBold: return "\u{fb7f}"
        case .speakerDisconnectedFilled: return "\u{fb80}"
        case .speakerDisconnectedLight: return "\u{fb81}"
        case .speakerDisconnectedRegular: return "\u{fb82}"
        case .speakerFilled: return "\u{fb83}"
        case .speakerLight: return "\u{fb84}"
        case .speakerMutedBold: return "\u{fb85}"
        case .speakerMutedFilled: return "\u{fb86}"
        case .speakerMutedLight: return "\u{fb87}"
        case .speakerMutedRegular: return "\u{fb88}"
        case .speakerOffBold: return "\u{fb89}"
        case .speakerOffFilled: return "\u{fb8a}"
        case .speakerOffLight: return "\u{fb8b}"
        case .speakerOffRegular: return "\u{fb8c}"
        case .speakerOnBold: return "\u{fb8d}"
        case .speakerOnLight: return "\u{fb8e}"
        case .speakerOnRegular: return "\u{fb8f}"
        case .speakerRegular: return "\u{fb90}"
        case .speakerTurnDownBold: return "\u{fb91}"
        case .speakerTurnDownFilled: return "\u{fb92}"
        case .speakerTurnDownLight: return "\u{fb93}"
        case .speakerTurnDownRegular: return "\u{fb94}"
        case .speakerTurnUpBold: return "\u{fb95}"
        case .speakerTurnUpFilled: return "\u{fb96}"
        case .speakerTurnUpLight: return "\u{fb97}"
        case .speakerTurnUpRegular: return "\u{fb98}"
        case .speechAiBold: return "\u{fb99}"
        case .speechAiFilled: return "\u{fb9a}"
        case .speechAiLight: return "\u{fb9b}"
        case .speechAiRegular: return "\u{fb9c}"
        case .speedDialBold: return "\u{fb9d}"
        case .speedDialFilled: return "\u{fb9e}"
        case .speedDialLight: return "\u{fb9f}"
        case .speedDialRegular: return "\u{fba0}"
        case .spellCheckerBold: return "\u{fba1}"
        case .spellCheckerLight: return "\u{fba2}"
        case .spellCheckerRegular: return "\u{fba3}"
        case .splitViewBold: return "\u{fba4}"
        case .splitViewLight: return "\u{fba5}"
        case .splitViewRegular: return "\u{fba6}"
        case .stackedAreaChartBold: return "\u{fba7}"
        case .stackedAreaChartFilled: return "\u{fba8}"
        case .stackedAreaChartFullBold: return "\u{fba9}"
        case .stackedAreaChartFullFilled: return "\u{fbaa}"
        case .stackedAreaChartFullLight: return "\u{fbab}"
        case .stackedAreaChartFullRegular: return "\u{fbac}"
        case .stackedAreaChartLight: return "\u{fbad}"
        case .stackedAreaChartRegular: return "\u{fbae}"
        case .stackedBarChartBold: return "\u{fbaf}"
        case .stackedBarChartFilled: return "\u{fbb0}"
        case .stackedBarChartFullBold: return "\u{fbb1}"
        case .stackedBarChartFullFilled: return "\u{fbb2}"
        case .stackedBarChartFullLight: return "\u{fbb3}"
        case .stackedBarChartFullRegular: return "\u{fbb4}"
        case .stackedBarChartLight: return "\u{fbb5}"
        case .stackedBarChartRegular: return "\u{fbb6}"
        case .startChatBold: return "\u{fbb7}"
        case .startChatLight: return "\u{fbb8}"
        case .startChatRegular: return "\u{fbb9}"
        case .stethoscopeBold: return "\u{fbba}"
        case .stethoscopeLight: return "\u{fbbb}"
        case .stethoscopeRegular: return "\u{fbbc}"
        case .stickersBold: return "\u{fbbd}"
        case .stickersLight: return "\u{fbbe}"
        case .stickersRegular: return "\u{fbbf}"
        case .stickiesBold: return "\u{fbc0}"
        case .stickiesLight: return "\u{fbc1}"
        case .stickiesRegular: return "\u{fbc2}"
        case .stopBold: return "\u{fbc3}"
        case .stopCircleBold: return "\u{fbc4}"
        case .stopCircleFilled: return "\u{fbc5}"
        case .stopCircleLight: return "\u{fbc6}"
        case .stopCircleRegular: return "\u{fbc7}"
        case .stopContentShareBold: return "\u{fbc8}"
        case .stopContentShareLight: return "\u{fbc9}"
        case .stopContentShareRegular: return "\u{fbca}"
        case .stopFilled: return "\u{fbcb}"
        case .stopLight: return "\u{fbcc}"
        case .stopRegular: return "\u{fbcd}"
        case .storedInfoBold: return "\u{fbce}"
        case .storedInfoFilled: return "\u{fbcf}"
        case .storedInfoLight: return "\u{fbd0}"
        case .storedInfoRegular: return "\u{fbd1}"
        case .streamingBold: return "\u{fbd2}"
        case .streamingLight: return "\u{fbd3}"
        case .streamingRegular: return "\u{fbd4}"
        case .strikethroughBold: return "\u{fbd5}"
        case .strikethroughFilled: return "\u{fbd6}"
        case .strikethroughLight: return "\u{fbd7}"
        case .strikethroughRegular: return "\u{fbd8}"
        case .studioModeBold: return "\u{fbd9}"
        case .studioModeLight: return "\u{fbda}"
        case .studioModeRegular: return "\u{fbdb}"
        case .subscriptBold: return "\u{fbdc}"
        case .subscriptLight: return "\u{fbdd}"
        case .subscriptRegular: return "\u{fbde}"
        case .summarizeAiBold: return "\u{fbdf}"
        case .summarizeAiLight: return "\u{fbe0}"
        case .summarizeAiRegular: return "\u{fbe1}"
        case .superscriptBold: return "\u{fbe2}"
        case .superscriptLight: return "\u{fbe3}"
        case .superscriptRegular: return "\u{fbe4}"
        case .surveyBold: return "\u{fbe5}"
        case .surveyFilled: return "\u{fbe6}"
        case .surveyLight: return "\u{fbe7}"
        case .surveyRegular: return "\u{fbe8}"
        case .sxEightyCodecBold: return "\u{fbe9}"
        case .sxEightyCodecLight: return "\u{fbea}"
        case .sxEightyCodecRegular: return "\u{fbeb}"
        case .sxTenBold: return "\u{fbec}"
        case .sxTenLight: return "\u{fbed}"
        case .sxTenRegular: return "\u{fbee}"
        case .sxTwentyBold: return "\u{fbef}"
        case .sxTwentyLight: return "\u{fbf0}"
        case .sxTwentyRegular: return "\u{fbf1}"
        case .tableBold: return "\u{fbf2}"
        case .tableExtenderBold: return "\u{fbf3}"
        case .tableExtenderFilled: return "\u{fbf4}"
        case .tableExtenderLight: return "\u{fbf5}"
        case .tableExtenderRegular: return "\u{fbf6}"
        case .tableLight: return "\u{fbf7}"
        case .tableRegular: return "\u{fbf8}"
        case .tabletBold: return "\u{fbf9}"
        case .tabletLight: return "\u{fbfa}"
        case .tabletRegular: return "\u{fbfb}"
        case .tabsBold: return "\u{fbfc}"
        case .tabsLight: return "\u{fbfd}"
        case .tabsRegular: return "\u{fbfe}"
        case .tagBold: return "\u{fbff}"
        case .tagLight: return "\u{fc00}"
        case .tagRegular: return "\u{fc01}"
        case .tapBold: return "\u{fc02}"
        case .tapFilled: return "\u{fc03}"
        case .tapLight: return "\u{fc04}"
        case .tapRegular: return "\u{fc05}"
        case .telepresenceAlertBold: return "\u{fc06}"
        case .telepresenceAlertLight: return "\u{fc07}"
        case .telepresenceAlertMutedBold: return "\u{fc08}"
        case .telepresenceAlertMutedLight: return "\u{fc09}"
        case .telepresenceAlertMutedRegular: return "\u{fc0a}"
        case .telepresenceAlertRegular: return "\u{fc0b}"
        case .telepresenceBold: return "\u{fc0c}"
        case .telepresenceIxFiveThousandBold: return "\u{fc0d}"
        case .telepresenceIxFiveThousandLight: return "\u{fc0e}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc0f}"
        case .telepresenceLight: return "\u{fc10}"
        case .telepresenceMutedBold: return "\u{fc11}"
        case .telepresenceMutedLight: return "\u{fc12}"
        case .telepresenceMutedRegular: return "\u{fc13}"
        case .telepresencePrivateBold: return "\u{fc14}"
        case .telepresencePrivateLight: return "\u{fc15}"
        case .telepresencePrivateRegular: return "\u{fc16}"
        case .telepresenceRegular: return "\u{fc17}"
        case .temperatureBold: return "\u{fc18}"
        case .temperatureLight: return "\u{fc19}"
        case .temperatureRegular: return "\u{fc1a}"
        case .tenantBold: return "\u{fc1b}"
        case .tenantFilled: return "\u{fc1c}"
        case .tenantLight: return "\u{fc1d}"
        case .tenantRegular: return "\u{fc1e}"
        case .testTubeBold: return "\u{fc1f}"
        case .testTubeFilled: return "\u{fc20}"
        case .testTubeLight: return "\u{fc21}"
        case .testTubeRegular: return "\u{fc22}"
        case .textAlignCenterBold: return "\u{fc23}"
        case .textAlignCenterFilled: return "\u{fc24}"
        case .textAlignCenterLight: return "\u{fc25}"
        case .textAlignCenterRegular: return "\u{fc26}"
        case .textAlignLeftBold: return "\u{fc27}"
        case .textAlignLeftFilled: return "\u{fc28}"
        case .textAlignLeftLight: return "\u{fc29}"
        case .textAlignLeftRegular: return "\u{fc2a}"
        case .textAlignRightBold: return "\u{fc2b}"
        case .textAlignRightFilled: return "\u{fc2c}"
        case .textAlignRightLight: return "\u{fc2d}"
        case .textAlignRightRegular: return "\u{fc2e}"
        case .textBold: return "\u{fc2f}"
        case .textBoxCursorLight: return "\u{fc30}"
        case .textCodeBlockBold: return "\u{fc31}"
        case .textCodeBlockLight: return "\u{fc32}"
        case .textCodeBlockRegular: return "\u{fc33}"
        case .textHighlightBold: return "\u{fc34}"
        case .textHighlightFilled: return "\u{fc35}"
        case .textHighlightLight: return "\u{fc36}"
        case .textHighlightRegular: return "\u{fc37}"
        case .textLight: return "\u{fc38}"
        case .textRegular: return "\u{fc39}"
        case .textShortBold: return "\u{fc3a}"
        case .textShortLight: return "\u{fc3b}"
        case .textShortRegular: return "\u{fc3c}"
        case .threeColumnBold: return "\u{fc3d}"
        case .threeColumnLight: return "\u{fc3e}"
        case .threeColumnRegular: return "\u{fc3f}"
        case .threeDObjectBold: return "\u{fc40}"
        case .threeDObjectLight: return "\u{fc41}"
        case .threeDObjectRegular: return "\u{fc42}"
        case .timeExclusionBold: return "\u{fc43}"
        case .timeExclusionLight: return "\u{fc44}"
        case .timeExclusionRegular: return "\u{fc45}"
        case .timezoneBold: return "\u{fc46}"
        case .timezoneFilled: return "\u{fc47}"
        case .timezoneLight: return "\u{fc48}"
        case .timezoneRegular: return "\u{fc49}"
        case .tooFastBold: return "\u{fc4a}"
        case .tooFastLight: return "\u{fc4b}"
        case .tooFastRegular: return "\u{fc4c}"
        case .tooSlowBold: return "\u{fc4d}"
        case .tooSlowLight: return "\u{fc4e}"
        case .tooSlowRegular: return "\u{fc4f}"
        case .toolsBold: return "\u{fc50}"
        case .toolsFilled: return "\u{fc51}"
        case .toolsLight: return "\u{fc52}"
        case .toolsRegular: return "\u{fc53}"
        case .touchTenBold: return "\u{fc54}"
        case .touchTenLight: return "\u{fc55}"
        case .touchTenRegular: return "\u{fc56}"
        case .trackingBold: return "\u{fc57}"
        case .trackingFilled: return "\u{fc58}"
        case .trackingLight: return "\u{fc59}"
        case .trackingRegular: return "\u{fc5a}"
        case .transcriptBold: return "\u{fc5b}"
        case .transcriptFilled: return "\u{fc5c}"
        case .transcriptLight: return "\u{fc5d}"
        case .transcriptRegular: return "\u{fc5e}"
        case .translateBold: return "\u{fc5f}"
        case .translateLight: return "\u{fc60}"
        case .translateRegular: return "\u{fc61}"
        case .translateUndoBold: return "\u{fc62}"
        case .translateUndoLight: return "\u{fc63}"
        case .translateUndoRegular: return "\u{fc64}"
        case .trendingBold: return "\u{fc65}"
        case .trendingDownBold: return "\u{fc66}"
        case .trendingDownFilled: return "\u{fc67}"
        case .trendingDownLight: return "\u{fc68}"
        case .trendingDownRegular: return "\u{fc69}"
        case .trendingFilled: return "\u{fc6a}"
        case .trendingLight: return "\u{fc6b}"
        case .trendingRegular: return "\u{fc6c}"
        case .trimBold: return "\u{fc6d}"
        case .trimLight: return "\u{fc6e}"
        case .trimRegular: return "\u{fc6f}"
        case .twoColumnBold: return "\u{fc70}"
        case .twoColumnLight: return "\u{fc71}"
        case .twoColumnRegular: return "\u{fc72}"
        case .twoWayVoiceStreamBold: return "\u{fc73}"
        case .twoWayVoiceStreamFilled: return "\u{fc74}"
        case .twoWayVoiceStreamLight: return "\u{fc75}"
        case .twoWayVoiceStreamRegular: return "\u{fc76}"
        case .ucmCloudBold: return "\u{fc77}"
        case .ucmCloudLight: return "\u{fc78}"
        case .ucmCloudRegular: return "\u{fc79}"
        case .unblockBold: return "\u{fc7a}"
        case .unblockFilled: return "\u{fc7b}"
        case .unblockLight: return "\u{fc7c}"
        case .unblockRegular: return "\u{fc7d}"
        case .underlineBold: return "\u{fc7e}"
        case .underlineFilled: return "\u{fc7f}"
        case .underlineLight: return "\u{fc80}"
        case .underlineRegular: return "\u{fc81}"
        case .undoBold: return "\u{fc82}"
        case .undoLight: return "\u{fc83}"
        case .undoRegular: return "\u{fc84}"
        case .unlinkBold: return "\u{fc85}"
        case .unlinkLight: return "\u{fc86}"
        case .unlinkRegular: return "\u{fc87}"
        case .unreadBold: return "\u{fc88}"
        case .unreadFilled: return "\u{fc89}"
        case .unreadLight: return "\u{fc8a}"
        case .unreadRegular: return "\u{fc8b}"
        case .unsecureUnlockedBold: return "\u{fc8c}"
        case .unsecureUnlockedFilled: return "\u{fc8d}"
        case .unsecureUnlockedLight: return "\u{fc8e}"
        case .unsecureUnlockedRegular: return "\u{fc8f}"
        case .unsortedBold: return "\u{fc90}"
        case .unsortedLight: return "\u{fc91}"
        case .unsortedRegular: return "\u{fc92}"
        case .updateFileShareBold: return "\u{fc93}"
        case .updateFileShareLight: return "\u{fc94}"
        case .updateFileShareRegular: return "\u{fc95}"
        case .uploadBold: return "\u{fc96}"
        case .uploadImageBold: return "\u{fc97}"
        case .uploadImageLight: return "\u{fc98}"
        case .uploadImageRegular: return "\u{fc99}"
        case .uploadLight: return "\u{fc9a}"
        case .uploadRegular: return "\u{fc9b}"
        case .urgentVoicemailBold: return "\u{fc9c}"
        case .urgentVoicemailFilled: return "\u{fc9d}"
        case .usbBold: return "\u{fc9e}"
        case .usbHeadsetBold: return "\u{fc9f}"
        case .usbHeadsetLight: return "\u{fca0}"
        case .usbHeadsetMutedBold: return "\u{fca1}"
        case .usbHeadsetMutedLight: return "\u{fca2}"
        case .usbHeadsetMutedRegular: return "\u{fca3}"
        case .usbHeadsetRegular: return "\u{fca4}"
        case .usbLight: return "\u{fca5}"
        case .usbRegular: return "\u{fca6}"
        case .userBold: return "\u{fca7}"
        case .userDeactivateBold: return "\u{fca8}"
        case .userDeactivateLight: return "\u{fca9}"
        case .userDeactivateRegular: return "\u{fcaa}"
        case .userFilled: return "\u{fcab}"
        case .userLight: return "\u{fcac}"
        case .userRegular: return "\u{fcad}"
        case .userSecurityStatusBold: return "\u{fcae}"
        case .userSecurityStatusFilled: return "\u{fcaf}"
        case .userSecurityStatusLight: return "\u{fcb0}"
        case .userSecurityStatusRegular: return "\u{fcb1}"
        case .videoBlurBold: return "\u{fcb2}"
        case .videoBlurFilled: return "\u{fcb3}"
        case .videoBlurLight: return "\u{fcb4}"
        case .videoBlurRegular: return "\u{fcb5}"
        case .videoBold: return "\u{fcb6}"
        case .videoEffectBold: return "\u{fcb7}"
        case .videoEffectFilled: return "\u{fcb8}"
        case .videoEffectLight: return "\u{fcb9}"
        case .videoEffectRegular: return "\u{fcba}"
        case .videoFilled: return "\u{fcbb}"
        case .videoLayoutBold: return "\u{fcbc}"
        case .videoLayoutCustomBold: return "\u{fcbd}"
        case .videoLayoutCustomFilled: return "\u{fcbe}"
        case .videoLayoutCustomLight: return "\u{fcbf}"
        case .videoLayoutCustomRegular: return "\u{fcc0}"
        case .videoLayoutEqualBold: return "\u{fcc1}"
        case .videoLayoutEqualDualBold: return "\u{fcc2}"
        case .videoLayoutEqualDualLight: return "\u{fcc3}"
        case .videoLayoutEqualDualRegular: return "\u{fcc4}"
        case .videoLayoutEqualFilled: return "\u{fcc5}"
        case .videoLayoutEqualLight: return "\u{fcc6}"
        case .videoLayoutEqualRegular: return "\u{fcc7}"
        case .videoLayoutFilled: return "\u{fcc8}"
        case .videoLayoutLight: return "\u{fcc9}"
        case .videoLayoutOverlayBold: return "\u{fcca}"
        case .videoLayoutOverlayFilled: return "\u{fccb}"
        case .videoLayoutOverlayLight: return "\u{fccc}"
        case .videoLayoutOverlayRegular: return "\u{fccd}"
        case .videoLayoutPresentationBold: return "\u{fcce}"
        case .videoLayoutPresentationFilled: return "\u{fccf}"
        case .videoLayoutPresentationLight: return "\u{fcd0}"
        case .videoLayoutPresentationRegular: return "\u{fcd1}"
        case .videoLayoutPresenterDominantBold: return "\u{fcd2}"
        case .videoLayoutPresenterDominantLight: return "\u{fcd3}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcd4}"
        case .videoLayoutProminentBold: return "\u{fcd5}"
        case .videoLayoutProminentFilled: return "\u{fcd6}"
        case .videoLayoutProminentLight: return "\u{fcd7}"
        case .videoLayoutProminentRegular: return "\u{fcd8}"
        case .videoLayoutRegular: return "\u{fcd9}"
        case .videoLayoutShareDominantBold: return "\u{fcda}"
        case .videoLayoutShareDominantLight: return "\u{fcdb}"
        case .videoLayoutShareDominantRegular: return "\u{fcdc}"
        case .videoLayoutSingleBold: return "\u{fcdd}"
        case .videoLayoutSingleFilled: return "\u{fcde}"
        case .videoLayoutSingleLight: return "\u{fcdf}"
        case .videoLayoutSingleRegular: return "\u{fce0}"
        case .videoLayoutSpeakerBold: return "\u{fce1}"
        case .videoLayoutSpeakerFilled: return "\u{fce2}"
        case .videoLayoutSpeakerLight: return "\u{fce3}"
        case .videoLayoutSpeakerRegular: return "\u{fce4}"
        case .videoLayoutStackBold: return "\u{fce5}"
        case .videoLayoutStackFilled: return "\u{fce6}"
        case .videoLayoutStackLight: return "\u{fce7}"
        case .videoLayoutStackRegular: return "\u{fce8}"
        case .videoLayoutVideoDominantBold: return "\u{fce9}"
        case .videoLayoutVideoDominantFilled: return "\u{fcea}"
        case .videoLayoutVideoDominantLight: return "\u{fceb}"
        case .videoLayoutVideoDominantRegular: return "\u{fcec}"
        case .videoLight: return "\u{fced}"
        case .videoPlusBold: return "\u{fcee}"
        case .videoPlusFilled: return "\u{fcef}"
        case .videoPlusLight: return "\u{fcf0}"
        case .videoPlusRegular: return "\u{fcf1}"
        case .videoRegular: return "\u{fcf2}"
        case .videoSpeakerTrackBold: return "\u{fcf3}"
        case .videoSpeakerTrackFilled: return "\u{fcf4}"
        case .videoSpeakerTrackLight: return "\u{fcf5}"
        case .videoSpeakerTrackRegular: return "\u{fcf6}"
        case .viewAllBold: return "\u{fcf7}"
        case .viewAllLight: return "\u{fcf8}"
        case .viewAllRegular: return "\u{fcf9}"
        case .viewListBold: return "\u{fcfa}"
        case .viewListFilled: return "\u{fcfb}"
        case .viewListLight: return "\u{fcfc}"
        case .viewListRegular: return "\u{fcfd}"
        case .viewStackedBold: return "\u{fcfe}"
        case .viewStackedFilled: return "\u{fcff}"
        case .viewStackedLight: return "\u{fd00}"
        case .viewStackedRegular: return "\u{fd01}"
        case .viewThumbnailBold: return "\u{fd02}"
        case .viewThumbnailFilled: return "\u{fd03}"
        case .viewThumbnailLight: return "\u{fd04}"
        case .viewThumbnailRegular: return "\u{fd05}"
        case .visionproBold: return "\u{fd06}"
        case .visionproFilled: return "\u{fd07}"
        case .visionproLight: return "\u{fd08}"
        case .visionproMoveCallInBold: return "\u{fd09}"
        case .visionproMoveCallInFilled: return "\u{fd0a}"
        case .visionproMoveCallInLight: return "\u{fd0b}"
        case .visionproMoveCallInOutBold: return "\u{fd0c}"
        case .visionproMoveCallInOutFilled: return "\u{fd0d}"
        case .visionproMoveCallInOutLight: return "\u{fd0e}"
        case .visionproMoveCallInOutRegular: return "\u{fd0f}"
        case .visionproMoveCallInRegular: return "\u{fd10}"
        case .visionproMoveCallOutBold: return "\u{fd11}"
        case .visionproMoveCallOutFilled: return "\u{fd12}"
        case .visionproMoveCallOutLight: return "\u{fd13}"
        case .visionproMoveCallOutRegular: return "\u{fd14}"
        case .visionproRegular: return "\u{fd15}"
        case .voiceClipBold: return "\u{fd16}"
        case .voiceClipFilled: return "\u{fd17}"
        case .voiceClipLight: return "\u{fd18}"
        case .voiceClipRegular: return "\u{fd19}"
        case .voicemailBold: return "\u{fd1a}"
        case .voicemailFilled: return "\u{fd1b}"
        case .voicemailLight: return "\u{fd1c}"
        case .voicemailRegular: return "\u{fd1d}"
        case .vpnBold: return "\u{fd1e}"
        case .vpnFilled: return "\u{fd1f}"
        case .vpnLight: return "\u{fd20}"
        case .vpnRegular: return "\u{fd21}"
        case .vscBold: return "\u{fd22}"
        case .vscLight: return "\u{fd23}"
        case .vscRegular: return "\u{fd24}"
        case .waffleMenuBold: return "\u{fd25}"
        case .waffleMenuLight: return "\u{fd26}"
        case .waffleMenuRegular: return "\u{fd27}"
        case .waitingRoomBold: return "\u{fd28}"
        case .waitingRoomFilled: return "\u{fd29}"
        case .waitingRoomLight: return "\u{fd2a}"
        case .waitingRoomRegular: return "\u{fd2b}"
        case .wallpaperBold: return "\u{fd2c}"
        case .wallpaperLight: return "\u{fd2d}"
        case .wallpaperRegular: return "\u{fd2e}"
        case .warningBadgeFilled: return "\u{fd2f}"
        case .warningBold: return "\u{fd30}"
        case .warningFilled: return "\u{fd31}"
        case .warningLight: return "\u{fd32}"
        case .warningRegular: return "\u{fd33}"
        case .webexBoardBold: return "\u{fd34}"
        case .webexBoardLight: return "\u{fd35}"
        case .webexBoardRegular: return "\u{fd36}"
        case .webexCodecPlusBold: return "\u{fd37}"
        case .webexCodecPlusLight: return "\u{fd38}"
        case .webexCodecPlusRegular: return "\u{fd39}"
        case .webexDeskCameraBold: return "\u{fd3a}"
        case .webexDeskCameraLight: return "\u{fd3b}"
        case .webexDeskCameraRegular: return "\u{fd3c}"
        case .webexHelixBold: return "\u{fd3d}"
        case .webexHelixLight: return "\u{fd3e}"
        case .webexHelixRegular: return "\u{fd3f}"
        case .webexMeetingsBold: return "\u{fd40}"
        case .webexMeetingsFilled: return "\u{fd41}"
        case .webexMeetingsLight: return "\u{fd42}"
        case .webexMeetingsRegular: return "\u{fd43}"
        case .webexQuadCameraBold: return "\u{fd44}"
        case .webexQuadCameraLight: return "\u{fd45}"
        case .webexQuadCameraRegular: return "\u{fd46}"
        case .webexRoomKitBold: return "\u{fd47}"
        case .webexRoomKitLight: return "\u{fd48}"
        case .webexRoomKitPlusBold: return "\u{fd49}"
        case .webexRoomKitPlusLight: return "\u{fd4a}"
        case .webexRoomKitPlusRegular: return "\u{fd4b}"
        case .webexRoomKitRegular: return "\u{fd4c}"
        case .webexShareBold: return "\u{fd4d}"
        case .webexShareLight: return "\u{fd4e}"
        case .webexShareRegular: return "\u{fd4f}"
        case .webexTeamsBold: return "\u{fd50}"
        case .webexTeamsFilled: return "\u{fd51}"
        case .webexTeamsLight: return "\u{fd52}"
        case .webexTeamsNewBold: return "\u{fd53}"
        case .webexTeamsNewFilled: return "\u{fd54}"
        case .webexTeamsNewLight: return "\u{fd55}"
        case .webexTeamsNewRegular: return "\u{fd56}"
        case .webexTeamsRegular: return "\u{fd57}"
        case .webexTeamsRemoveBold: return "\u{fd58}"
        case .webexTeamsRemoveLight: return "\u{fd59}"
        case .webexTeamsRemoveRegular: return "\u{fd5a}"
        case .webhookBold: return "\u{fd5b}"
        case .webhookLight: return "\u{fd5c}"
        case .webhookRegular: return "\u{fd5d}"
        case .webinarBold: return "\u{fd5e}"
        case .webinarFilled: return "\u{fd5f}"
        case .webinarLight: return "\u{fd60}"
        case .webinarRegular: return "\u{fd61}"
        case .weeklyRecurringScheduleBold: return "\u{fd62}"
        case .weeklyRecurringScheduleLight: return "\u{fd63}"
        case .weeklyRecurringScheduleRegular: return "\u{fd64}"
        case .whisperAnnouncementBold: return "\u{fd65}"
        case .whisperAnnouncementFilled: return "\u{fd66}"
        case .whisperAnnouncementLight: return "\u{fd67}"
        case .whisperAnnouncementRegular: return "\u{fd68}"
        case .whisperCoachBold: return "\u{fd69}"
        case .whisperCoachFilled: return "\u{fd6a}"
        case .whisperCoachLight: return "\u{fd6b}"
        case .whisperCoachRegular: return "\u{fd6c}"
        case .whiteboardBold: return "\u{fd6d}"
        case .whiteboardContentBold: return "\u{fd6e}"
        case .whiteboardContentFilled: return "\u{fd6f}"
        case .whiteboardContentLight: return "\u{fd70}"
        case .whiteboardContentRegular: return "\u{fd71}"
        case .whiteboardFilled: return "\u{fd72}"
        case .whiteboardLight: return "\u{fd73}"
        case .whiteboardRegular: return "\u{fd74}"
        case .widgetBold: return "\u{fd75}"
        case .widgetFilled: return "\u{fd76}"
        case .widgetLight: return "\u{fd77}"
        case .widgetRegular: return "\u{fd78}"
        case .wifiBold: return "\u{fd79}"
        case .wifiErrorBold: return "\u{fd7a}"
        case .wifiErrorLight: return "\u{fd7b}"
        case .wifiErrorRegular: return "\u{fd7c}"
        case .wifiLight: return "\u{fd7d}"
        case .wifiRegular: return "\u{fd7e}"
        case .wifiSignalGoodBold: return "\u{fd7f}"
        case .wifiSignalGoodLight: return "\u{fd80}"
        case .wifiSignalGoodRegular: return "\u{fd81}"
        case .wifiSignalPoorBold: return "\u{fd82}"
        case .wifiSignalPoorLight: return "\u{fd83}"
        case .wifiSignalPoorRegular: return "\u{fd84}"
        case .wifiSignalUnstableBold: return "\u{fd85}"
        case .wifiSignalUnstableLight: return "\u{fd86}"
        case .wifiSignalUnstableRegular: return "\u{fd87}"
        case .windowCornerScrubBold: return "\u{fd88}"
        case .windowCornerScrubLight: return "\u{fd89}"
        case .windowCornerScrubRegular: return "\u{fd8a}"
        case .windowRightCornerScrubBold: return "\u{fd8b}"
        case .windowRightCornerScrubLight: return "\u{fd8c}"
        case .windowRightCornerScrubRegular: return "\u{fd8d}"
        case .windowVerticalScrubBold: return "\u{fd8e}"
        case .windowVerticalScrubLight: return "\u{fd8f}"
        case .windowVerticalScrubRegular: return "\u{fd90}"
        case .workflowDeploymentsBold: return "\u{fd91}"
        case .workflowDeploymentsFilled: return "\u{fd92}"
        case .workflowDeploymentsLight: return "\u{fd93}"
        case .workflowDeploymentsRegular: return "\u{fd94}"
        case .workphoneBold: return "\u{fd95}"
        case .workphoneLight: return "\u{fd96}"
        case .workphoneRegular: return "\u{fd97}"
        case .zoomInBold: return "\u{fd98}"
        case .zoomInLight: return "\u{fd99}"
        case .zoomInRegular: return "\u{fd9a}"
        case .zoomOutBold: return "\u{fd9b}"
        case .zoomOutLight: return "\u{fd9c}"
        case .zoomOutRegular: return "\u{fd9d}"
