...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .editRegular: return "\u{f4d4}"
        case .editablePartialBold: return "\u{f4d5}"
        case .editablePartialLight: return "\u{f4d6}"
        case .editablePartialRegular: return "\u{f4d7}"
        case .educationBold: return "\u{f4d8}"
        case .educationFilled: return "\u{f4d9}"
        case .educationLight: return "\u{f4da}"
        case .educationRegular: return "\u{f4db}"
        case .emailBold: return "\u{f4dc}"
        case .emailDeliveredBold: return "\u{f4dd}"
        case .emailDeliveredLight: return "\u{f4de}"
        case .emailDeliveredRegular: return "\u{f4df}"
        case .emailFailureBold: return "\u{f4e0}"
        case .emailFailureLight: return "\u{f4e1}"
        case .emailFailureRegular: return "\u{f4e2}"
        case .emailFilled: return "\u{f4e3}"
        case .emailInviteBold: return "\u{f4e4}"
        case .emailInviteLight: return "\u{f4e5}"
        case .emailInviteRegular: return "\u{f4e6}"
        case .emailLight: return "\u{f4e7}"
        case .emailOutgoingBold: return "\u{f4e8}"
        case .emailOutgoingFilled: return "\u{f4e9}"
        case .emailOutgoingLight: return "\u{f4ea}"
        case .emailOutgoingRegular: return "\u{f4eb}"
        case .emailReadBold: return "\u{f4ec}"
        case .emailReadFilled: return "\u{f4ed}"
        case .emailReadLight: return "\u{f4ee}"
        case .emailReadRegular: return "\u{f4ef}"
        case .emailRegular: return "\u{f4f0}"
        case .emergencyCallbackNumberBold: return "\u{f4f1}"
        case .emergencyCallbackNumberFilled: return "\u{f4f2}"
        case .emergencyCallbackNumberLight: return "\u{f4f3}"
        case .emergencyCallbackNumberRegular: return "\u{f4f4}"
        case .emojiExcitedBold: return "\u{f4f5}"
        case .emojiExcitedFilled: return "\u{f4f6}"
        case .emojiExcitedLight: return "\u{f4f7}"
        case .emojiExcitedRegular: return "\u{f4f8}"
        case .emojiHappyBold: return "\u{f4f9}"
        case .emojiHappyFilled: return "\u{f4fa}"
        case .emojiHappyLight: return "\u{f4fb}"
        case .emojiHappyRegular: return "\u{f4fc}"
        case .emojiPassiveBold: return "\u{f4fd}"
        case .emojiPassiveFilled: return "\u{f4fe}"
        case .emojiPassiveLight: return "\u{f4ff}"
        case .emojiPassiveRegular: return "\u{f500}"
        case .emojiSadBold: return "\u{f501}"
        case .emojiSadFilled: return "\u{f502}"
        case .emojiSadLight: return "\u{f503}"
        case .emojiSadRegular: return "\u{f504}"
        case .emojiUnhappyBold: return "\u{f505}"
        case .emojiUnhappyFilled: return "\u{f506}"
        case .emojiUnhappyLight: return "\u{f507}"
        case .emojiUnhappyRegular: return "\u{f508}"
        case .encryptionAdaptiveBold: return "\u{f509}"
        case .encryptionAdaptiveFilled: return "\u{f50a}"
        case .encryptionAdaptiveLight: return "\u{f50b}"
        case .encryptionAdaptiveRegular: return "\u{f50c}"
        case .encryptionAdaptiveSecureBold: return "\u{f50d}"
        case .encryptionAdaptiveSecureFilled: return "\u{f50e}"
        case .encryptionAdaptiveSecureLight: return "\u{f50f}"
        case .encryptionAdaptiveSecureRegular: return "\u{f510}"
        case .encryptionBold: return "\u{f511}"
        case .encryptionCircleAdaptiveBold: return "\u{f512}"
        case .encryptionCircleAdaptiveFilled: return "\u{f513}"
        case .encryptionCircleAdaptiveLight: return "\u{f514}"
        case .encryptionCircleAdaptiveRegular: return "\u{f515}"
        case .encryptionCircleAdaptiveSecureBold: return "\u{f516}"
        case .encryptionCircleAdaptiveSecureFilled: return "\u{f517}"
        case .encryptionCircleAdaptiveSecureLight: return "\u{f518}"
        case .encryptionCircleAdaptiveSecureRegular: return "\u{f519}"
        case .encryptionCircleBold: return "\u{f51a}"
        case .encryptionCircleFilled: return "\u{f51b}"
        case .encryptionCircleLight: return "\u{f51c}"
        case .encryptionCircleRegular: return "\u{f51d}"
        case .encryptionFilled: return "\u{f51e}"
        case .encryptionLight: return "\u{f51f}"
        case .encryptionRegular: return "\u{f520}"
        case .endRemoteDesktopControlBold: return "\u{f521}"
        case .endRemoteDesktopControlLight: return "\u{f522}"
        case .endRemoteDesktopControlRegular: return "\u{f523}"
        case .endToEndEncryptionBold: return "\u{f524}"
        case .endToEndEncryptionCircleBold: return "\u{f525}"
        case .endToEndEncryptionCircleFilled: return "\u{f526}"
        case .endToEndEncryptionCircleLight: return "\u{f527}"
        case .endToEndEncryptionCircleRegular: return "\u{f528}"
        case .endToEndEncryptionFilled: return "\u{f529}"
        case .endToEndEncryptionLight: return "\u{f52a}"
        case .endToEndEncryptionRegular: return "\u{f52b}"
        case .endpointBlockedBold: return "\u{f52c}"
        case .endpointBlockedLight: return "\u{f52d}"
        case .endpointBlockedRegular: return "\u{f52e}"
        case .endpointBold: return "\u{f52f}"
        case .endpointGTwoBold: return "\u{f530}"
        case .endpointGTwoLight: return "\u{f531}"
        case .endpointGTwoRegular: return "\u{f532}"
        case .endpointGTwoSeventyBold: return "\u{f533}"
        case .endpointGTwoSeventyDualBold: return "\u{f534}"
        case .endpointGTwoSeventyDualLight: return "\u{f535}"
        case .endpointGTwoSeventyDualRegular: return "\u{f536}"
        case .endpointGTwoSeventyLight: return "\u{f537}"
        case .endpointGTwoSeventyRegular: return "\u{f538}"
        case .endpointGTwoStandBold: return "\u{f539}"
        case .endpointGTwoStandLight: return "\u{f53a}"
        case .endpointGTwoStandRegular: return "\u{f53b}"
        case .endpointLight: return "\u{f53c}"
        case .endpointMxEightHundredBold: return "\u{f53d}"
        case .endpointMxEightHundredDualBold: return "\u{f53e}"
        case .endpointMxEightHundredDualLight: return "\u{f53f}"
        case .endpointMxEightHundredDualRegular: return "\u{f540}"
        case .endpointMxEightHundredLight: return "\u{f541}"
        case .endpointMxEightHundredRegular: return "\u{f542}"
        case .endpointRegular: return "\u{f543}"
        case .endpointStandBold: return "\u{f544}"
        case .endpointStandFilled: return "\u{f545}"
        case .endpointStandLight: return "\u{f546}"
        case .endpointStandRegular: return "\u{f547}"
        case .endpointWarningBold: return "\u{f548}"
        case .endpointWarningLight: return "\u{f549}"
        case .endpointWarningRegular: return "\u{f54a}"
        case .enterBold: return "\u{f54b}"
        case .enterLight: return "\u{f54c}"
        case .enterRegular: return "\u{f54d}"
        case .enterRoomBold: return "\u{f54e}"
        case .enterRoomFilled: return "\u{f54f}"
        case .enterRoomLight: return "\u{f550}"
        case .enterRoomRegular: return "\u{f551}"
        case .eraserBold: return "\u{f552}"
        case .eraserFilled: return "\u{f553}"
        case .eraserLight: return "\u{f554}"
        case .eraserRegular: return "\u{f555}"
        case .errorLegacyBadgeFilled: return "\u{f556}"
        case .errorLegacyBold: return "\u{f557}"
        case .errorLegacyFilled: return "\u{f558}"
        case .errorLegacyLight: return "\u{f559}"
        case .errorLegacyRegular: return "\u{f55a}"
        case .ethernetBold: return "\u{f55b}"
        case .ethernetFilled: return "\u{f55c}"
        case .ethernetLight: return "\u{f55d}"
        case .ethernetRegular: return "\u{f55e}"
        case .exchangeBold: return "\u{f55f}"
        case .exchangeLight: return "\u{f560}"
        case .exchangeRegular: return "\u{f561}"
        case .exclamationBold: return "\u{f562}"
        case .exclamationLight: return "\u{f563}"
        case .exclamationRegular: return "\u{f564}"
        case .excludeBold: return "\u{f565}"
        case .excludeLight: return "\u{f566}"
        case .excludeRegular: return "\u{f567}"
        case .existingTargetGroupBold: return "\u{f568}"
        case .existingTargetGroupLight: return "\u{f569}"
        case .existingTargetGroupRegular: return "\u{f56a}"
        case .exitRoomBold: return "\u{f56b}"
        case .exitRoomLight: return "\u{f56c}"
        case .exitRoomRegular: return "\u{f56d}"
        case .exploreBold: return "\u{f56e}"
        case .exploreLight: return "\u{f56f}"
        case .exploreRegular: return "\u{f570}"
        case .exportBold: return "\u{f571}"
        case .exportLight: return "\u{f572}"
        case .exportRegular: return "\u{f573}"
        case .extensionMobilityBold: return "\u{f574}"
        case .extensionMobilityLight: return "\u{f575}"
        case .extensionMobilityRegular: return "\u{f576}"
        case .externalMessageBold: return "\u{f577}"
        case .externalMessageLight: return "\u{f578}"
        case .externalMessageRegular: return "\u{f579}"
        case .externalUserBold: return "\u{f57a}"
        case .externalUserLight: return "\u{f57b}"
        case .externalUserRegular: return "\u{f57c}"
        case .familyFontBold: return "\u{f57d}"
        case .familyFontLight: return "\u{f57e}"
        case .familyFontRegular: return "\u{f57f}"
        case .fastForwardBold: return "\u{f580}"
        case .fastForwardLight: return "\u{f581}"
        case .fastForwardRegular: return "\u{f582}"
        case .favoriteBold: return "\u{f583}"
        case .favoriteFilled: return "\u{f584}"
        case .favoriteLight: return "\u{f585}"
        case .favoriteRegular: return "\u{f586}"
        case .favoritesBold: return "\u{f587}"
        case .favoritesFilled: return "\u{f588}"
        case .favoritesLight: return "\u{f589}"
        case .favoritesRegular: return "\u{f58a}"
        case .fbwBold: return "\u{f58b}"
        case .fbwFilled: return "\u{f58c}"
        case .fbwLight: return "\u{f58d}"
        case .fbwRegular: return "\u{f58e}"
        case .ffwBold: return "\u{f58f}"
        case .ffwFilled: return "\u{f590}"
        case .ffwLight: return "\u{f591}"
        case .ffwRegular: return "\u{f592}"
        case .fileAnalysisBold: return "\u{f593}"
        case .fileAnalysisFilled: return "\u{f594}"
        case .fileAnalysisLight: return "\u{f595}"
        case .fileAnalysisRegular: return "\u{f596}"
        case .fileAnnotationBold: return "\u{f597}"
        case .fileAnnotationFilled: return "\u{f598}"
        case .fileAnnotationLight: return "\u{f599}"
        case .fileAnnotationRegular: return "\u{f59a}"
        case .fileAudioBold: return "\u{f59b}"
        case .fileAudioFilled: return "\u{f59c}"
        case .fileAudioLight: return "\u{f59d}"
        case .fileAudioRegular: return "\u{f59e}"
        case .fileBugBold: return "\u{f59f}"
        case .fileBugFilled: return "\u{f5a0}"
        case .fileBugLight: return "\u{f5a1}"
        case .fileBugRegular: return "\u{f5a2}"
        case .fileCodeBold: return "\u{f5a3}"
        case .fileCodeFilled: return "\u{f5a4}"
        case .fileCodeLight: return "\u{f5a5}"
        case .fileCodeRegular: return "\u{f5a6}"
        case .fileDashboardBold: return "\u{f5a7}"
        case .fileDashboardFilled: return "\u{f5a8}"
        case .fileDashboardLight: return "\u{f5a9}"
        case .fileDashboardRegular: return "\u{f5aa}"
        case .fileExcelBold: return "\u{f5ab}"
        case .fileExcelFilled: return "\u{f5ac}"
        case .fileExcelLight: return "\u{f5ad}"
        case .fileExcelRegular: return "\u{f5ae}"
        case .fileGraphBold: return "\u{f5af}"
        case .fileGraphFilled: return "\u{f5b0}"
        case .fileGraphLight: return "\u{f5b1}"
        case .fileGraphRegular: return "\u{f5b2}"
        case .fileImageBold: return "\u{f5b3}"
        case .fileImageFilled: return "\u{f5b4}"
        case .fileImageLight: return "\u{f5b5}"
        case .fileImageNoneBold: return "\u{f5b6}"
        case .fileImageNoneLight: return "\u{f5b7}"
        case .fileImageNoneRegular: return "\u{f5b8}"
        case .fileImageRegular: return "\u{f5b9}"
        case .fileJsBold: return "\u{f5ba}"
        case .fileJsFilled: return "\u{f5bb}"
        case .fileJsLight: return "\u{f5bc}"
        case .fileJsRegular: return "\u{f5bd}"
        case .fileKeynoteBold: return "\u{f5be}"
        case .fileKeynoteFilled: return "\u{f5bf}"
        case .fileKeynoteLight: return "\u{f5c0}"
        case .fileKeynoteRegular: return "\u{f5c1}"
        case .fileLockedBold: return "\u{f5c2}"
        case .fileLockedFilled: return "\u{f5c3}"
        case .fileLockedLight: return "\u{f5c4}"
        case .fileLockedRegular: return "\u{f5c5}"
        case .fileMissingBold: return "\u{f5c6}"
        case .fileMissingFilled: return "\u{f5c7}"
        case .fileMissingLight: return "\u{f5c8}"
        case .fileMissingRegular: return "\u{f5c9}"
        case .fileMusicBold: return "\u{f5ca}"
        case .fileMusicFilled: return "\u{f5cb}"
        case .fileMusicLight: return "\u{f5cc}"
        case .fileMusicRegular: return "\u{f5cd}"
        case .fileOnenoteBold: return "\u{f5ce}"
        case .fileOnenoteFilled: return "\u{f5cf}"
        case .fileOnenoteLight: return "\u{f5d0}"
        case .fileOnenoteRegular: return "\u{f5d1}"
        case .filePdfBold: return "\u{f5d2}"
        case .filePdfFilled: return "\u{f5d3}"
        case .filePdfLight: return "\u{f5d4}"
        case .filePdfRegular: return "\u{f5d5}"
        case .filePowerpointBold: return "\u{f5d6}"
        case .filePowerpointFilled: return "\u{f5d7}"
        case .filePowerpointLight: return "\u{f5d8}"
        case .filePowerpointRegular: return "\u{f5d9}"
        case .fileSpreadsheetBold: return "\u{f5da}"
        case .fileSpreadsheetFilled: return "\u{f5db}"
        case .fileSpreadsheetLight: return "\u{f5dc}"
        case .fileSpreadsheetRegular: return "\u{f5dd}"
        case .fileTextBold: return "\u{f5de}"
        case .fileTextFilled: return "\u{f5df}"
        case .fileTextLight: return "\u{f5e0}"
        case .fileTextRegular: return "\u{f5e1}"
        case .fileThreeDBold: return "\u{f5e2}"
        case .fileThreeDFilled: return "\u{f5e3}"
        case .fileThreeDLight: return "\u{f5e4}"
        case .fileThreeDRegular: return "\u{f5e5}"
        case .fileVectorBold: return "\u{f5e6}"
        case .fileVectorFilled: return "\u{f5e7}"
        case .fileVectorLight: return "\u{f5e8}"
        case .fileVectorRegular: return "\u{f5e9}"
        case .fileVideoBold: return "\u{f5ea}"
        case .fileVideoFilled: return "\u{f5eb}"
        case .fileVideoLight: return "\u{f5ec}"
        case .fileVideoRegular: return "\u{f5ed}"
        case .fileWordBold: return "\u{f5ee}"
        case .fileWordFilled: return "\u{f5ef}"
        case .fileWordLight: return "\u{f5f0}"
        case .fileWordRegular: return "\u{f5f1}"
        case .fileXmlBold: return "\u{f5f2}"
        case .fileXmlFilled: return "\u{f5f3}"
        case .fileXmlLight: return "\u{f5f4}"
        case .fileXmlRegular: return "\u{f5f5}"
        case .fileZipBold: return "\u{f5f6}"
        case .fileZipFilled: return "\u{f5f7}"
        case .fileZipLight: return "\u{f5f8}"
        case .fileZipRegular: return "\u{f5f9}"
        case .filesBold: return "\u{f5fa}"
        case .filesFilled: return "\u{f5fb}"
        case .filesLight: return "\u{f5fc}"
        case .filesRegular: return "\u{f5fd}"
        case .fillColourBold: return "\u{f5fe}"
        case .fillColourFilled: return "\u{f5ff}"
        case .fillColourLight: return "\u{f600}"
        case .fillColourRegular: return "\u{f601}"
        case .filterBold: return "\u{f602}"
        case .filterCircleBold: return "\u{f603}"
        case .filterCircleFilled: return "\u{f604}"
        case .filterCircleLight: return "\u{f605}"
        case .filterCircleRegular: return "\u{f606}"
        case .filterLight: return "\u{f607}"
        case .filterRegular: return "\u{f608}"
        case .fitToWidthBold: return "\u{f609}"
        case .fitToWidthLight: return "\u{f60a}"
        case .fitToWidthRegular: return "\u{f60b}"
        case .fitToWindowExpandBold: return "\u{f60c}"
        case .fitToWindowExpandLight: return "\u{f60d}"
        case .fitToWindowExpandRegular: return "\u{f60e}"
        case .fitToWindowShrinkBold: return "\u{f60f}"
        case .fitToWindowShrinkLight: return "\u{f610}"
        case .fitToWindowShrinkRegular: return "\u{f611}"
        case .flagBold: return "\u{f612}"
        case .flagCircleBold: return "\u{f613}"
        case .flagCircleFilled: return "\u{f614}"
        case .flagCircleLight: return "\u{f615}"
        case .flagCircleRegular: return "\u{f616}"
        case .flagFilled: return "\u{f617}"
        case .flagLight: return "\u{f618}"
        case .flagRegular: return "\u{f619}"
        case .folderBold: return "\u{f61a}"
        case .folderEditBold: return "\u{f61b}"
        case .folderEditLight: return "\u{f61c}"
        case .folderEditRegular: return "\u{f61d}"
        case .folderFilled: return "\u{f61e}"
        case .folderLight: return "\u{f61f}"
        case .folderLockBold: return "\u{f620}"
        case .folderLockLight: return "\u{f621}"
        case .folderLockRegular: return "\u{f622}"
        case .folderRegular: return "\u{f623}"
        case .folderViewBold: return "\u{f624}"
        case .folderViewLight: return "\u{f625}"
        case .folderViewRegular: return "\u{f626}"
        case .followUpBold: return "\u{f627}"
        case .followUpLight: return "\u{f628}"
        case .followUpRegular: return "\u{f629}"
        case .foodBold: return "\u{f62a}"
        case .foodFilled: return "\u{f62b}"
        case .foodLight: return "\u{f62c}"
        case .foodRegular: return "\u{f62d}"
        case .forecastBold: return "\u{f62e}"
        case .forecastFilled: return "\u{f62f}"
        case .forecastLight: return "\u{f630}"
        case .forecastRegular: return "\u{f631}"
        case .formatBold: return "\u{f632}"
        case .formatDefaultAppBold: return "\u{f633}"
        case .formatDefaultAppFilled: return "\u{f634}"
        case .formatDefaultAppLight: return "\u{f635}"
        case .formatDefaultAppRegular: return "\u{f636}"
        case .formatLight: return "\u{f637}"
        case .formatPanelControlBarBold: return "\u{f638}"
        case .formatPanelControlBarLight: return "\u{f639}"
        case .formatPanelControlBarRegular: return "\u{f63a}"
        case .formatPanelControlDownBold: return "\u{f63b}"
        case .formatPanelControlDownLight: return "\u{f63c}"
        case .formatPanelControlDownRegular: return "\u{f63d}"
        case .formatPanelControlLeftBold: return "\u{f63e}"
        case .formatPanelControlLeftLight: return "\u{f63f}"
        case .formatPanelControlLeftRegular: return "\u{f640}"
        case .formatPanelControlRightBold: return "\u{f641}"
        case .formatPanelControlRightLight: return "\u{f642}"
        case .formatPanelControlRightRegular: return "\u{f643}"
        case .formatPanelControlUpBold: return "\u{f644}"
        case .formatPanelControlUpDownBold: return "\u{f645}"
        case .formatPanelControlUpDownLight: return "\u{f646}"
        case .formatPanelControlUpDownRegular: return "\u{f647}"
        case .formatPanelControlUpLight: return "\u{f648}"
        case .formatPanelControlUpRegular: return "\u{f649}"
        case .formatRegular: return "\u{f64a}"
        case .formatViewMixedBold: return "\u{f64b}"
        case .formatViewMixedLight: return "\u{f64c}"
        case .formatViewMixedRegular: return "\u{f64d}"
        case .formulaBold: return "\u{f64e}"
        case .formulaFilled: return "\u{f64f}"
        case .formulaLight: return "\u{f650}"
        case .formulaRegular: return "\u{f651}"
        case .forwardMessageBold: return "\u{f652}"
        case .forwardMessageFilled: return "\u{f653}"
        case .forwardMessageLight: return "\u{f654}"
        case .forwardMessageRegular: return "\u{f655}"
        case .forwardTenSecBold: return "\u{f656}"
        case .forwardTenSecLight: return "\u{f657}"
        case .forwardTenSecRegular: return "\u{f658}"
        case .fourColumnBold: return "\u{f659}"
        case .fourColumnLight: return "\u{f65a}"
        case .fourColumnRegular: return "\u{f65b}"
        case .fourWayNavigationBold: return "\u{f65c}"
        case .fourWayNavigationLight: return "\u{f65d}"
        case .fourWayNavigationRegular: return "\u{f65e}"
        case .frequencyCappingBold: return "\u{f65f}"
        case .frequencyCappingLight: return "\u{f660}"
        case .frequencyCappingRegular: return "\u{f661}"
        case .fulfillmentBold: return "\u{f662}"
        case .fulfillmentLight: return "\u{f663}"
        case .fulfillmentRegular: return "\u{f664}"
        case .fullscreenBold: return "\u{f665}"
        case .fullscreenExitBold: return "\u{f666}"
        case .fullscreenExitLight: return "\u{f667}"
        case .fullscreenExitRegular: return "\u{f668}"
        case .fullscreenLight: return "\u{f669}"
        case .fullscreenRegular: return "\u{f66a}"
        case .genericDeviceVideoBadgeFilled: return "\u{f66b}"
        case .genericDeviceVideoBold: return "\u{f66c}"
        case .genericDeviceVideoFilled: return "\u{f66d}"
        case .genericDeviceVideoLight: return "\u{f66e}"
        case .genericDeviceVideoRegular: return "\u{f66f}"
        case .gifBold: return "\u{f670}"
        case .gifFilled: return "\u{f671}"
        case .gifHorizontalBold: return "\u{f672}"
        case .gifHorizontalFilled: return "\u{f673}"
        case .gifHorizontalLight: return "\u{f674}"
        case .gifHorizontalRegular: return "\u{f675}"
        case .gifLight: return "\u{f676}"
        case .gifRegular: return "\u{f677}"
        case .giftBold: return "\u{f678}"
        case .giftFilled: return "\u{f679}"
        case .giftLight: return "\u{f67a}"
        case .giftRegular: return "\u{f67b}"
        case .greenLeafBold: return "\u{f67c}"
        case .greenLeafFilled: return "\u{f67d}"
        case .greenLeafLight: return "\u{f67e}"
        case .greenLeafRegular: return "\u{f67f}"
        case .greenRoomBold: return "\u{f680}"
        case .greenRoomFilled: return "\u{f681}"
        case .greenRoomLight: return "\u{f682}"
        case .greenRoomRegular: return "\u{f683}"
        case .guestIssuerBold: return "\u{f684}"
        case .guestIssuerLight: return "\u{f685}"
        case .guestIssuerRegular: return "\u{f686}"
        case .guideBold: return "\u{f687}"
        case .guideLight: return "\u{f688}"
        case .guideRegular: return "\u{f689}"
        case .handPointerBold: return "\u{f68a}"
        case .handPointerLight: return "\u{f68b}"
        case .handPointerRegular: return "\u{f68c}"
        case .handlerBold: return "\u{f68d}"
        case .handlerHorizontalBold: return "\u{f68e}"
        case .handlerHorizontalLight: return "\u{f68f}"
        case .handlerHorizontalRegular: return "\u{f690}"
        case .handlerLight: return "\u{f691}"
        case .handlerRegular: return "\u{f692}"
        case .handsetAlertBold: return "\u{f693}"
        case .handsetAlertFilled: return "\u{f694}"
        case .handsetAlertLight: return "\u{f695}"
        case .handsetAlertRegular: return "\u{f696}"
        case .handsetBold: return "\u{f697}"
        case .handsetDownSlashBold: return "\u{f698}"
        case .handsetDownSlashFilled: return "\u{f699}"
        case .handsetDownSlashLight: return "\u{f69a}"
        case .handsetDownSlashRegular: return "\u{f69b}"
        case .handsetFilled: return "\u{f69c}"
        case .handsetLight: return "\u{f69d}"
        case .handsetMutedBold: return "\u{f69e}"
        case .handsetMutedFilled: return "\u{f69f}"
        case .handsetMutedLight: return "\u{f6a0}"
        case .handsetMutedRegular: return "\u{f6a1}"
        case .handsetRegular: return "\u{f6a2}"
        case .handsetsArrowLeftBold: return "\u{f6a3}"
        case .handsetsArrowLeftLight: return "\u{f6a4}"
        case .handsetsArrowLeftRegular: return "\u{f6a5}"
        case .handshakeBold: return "\u{f6a6}"
        case .handshakeLight: return "\u{f6a7}"
        case .handshakeRegular: return "\u{f6a8}"
        case .headingOneBold: return "\u{f6a9}"
        case .headingOneLight: return "\u{f6aa}"
        case .headingOneRegular: return "\u{f6ab}"
        case .headingThreeBold: return "\u{f6ac}"
        case .headingThreeLight: return "\u{f6ad}"
        case .headingThreeRegular: return "\u{f6ae}"
        case .headingTwoBold: return "\u{f6af}"
        case .headingTwoLight: return "\u{f6b0}"
        case .headingTwoRegular: return "\u{f6b1}"
        case .headphonesBold: return "\u{f6b2}"
        case .headphonesFilled: return "\u{f6b3}"
        case .headphonesLight: return "\u{f6b4}"
        case .headphonesMutedBold: return "\u{f6b5}"
        case .headphonesMutedFilled: return "\u{f6b6}"
        case .headphonesMutedLight: return "\u{f6b7}"
        case .headphonesMutedRegular: return "\u{f6b8}"
        case .headphonesRegular: return "\u{f6b9}"
        case .headsetAlertBold: return "\u{f6ba}"
        case .headsetAlertLight: return "\u{f6bb}"
        case .headsetAlertRegular: return "\u{f6bc}"
        case .headsetArrowDownBold: return "\u{f6bd}"
        case .headsetArrowDownFilled: return "\u{f6be}"
        case .headsetArrowDownLight: return "\u{f6bf}"
        case .headsetArrowDownRegular: return "\u{f6c0}"
        case .headsetBluetoothBold: return "\u{f6c1}"
        case .headsetBluetoothLight: return "\u{f6c2}"
        case .headsetBluetoothRegular: return "\u{f6c3}"
        case .headsetBold: return "\u{f6c4}"
        case .headsetFilled: return "\u{f6c5}"
        case .headsetLight: return "\u{f6c6}"
        case .headsetMutedBold: return "\u{f6c7}"
        case .headsetMutedLight: return "\u{f6c8}"
        case .headsetMutedRegular: return "\u{f6c9}"
        case .headsetPrivateBold: return "\u{f6ca}"
        case .headsetPrivateLight: return "\u{f6cb}"
        case .headsetPrivateRegular: return "\u{f6cc}"
        case .headsetRegular: return "\u{f6cd}"
        case .hearingBold: return "\u{f6ce}"
        case .hearingImpairedBold: return "\u{f6cf}"
        case .hearingImpairedLight: return "\u{f6d0}"
        case .hearingImpairedRegular: return "\u{f6d1}"
        case .hearingLight: return "\u{f6d2}"
        case .hearingRegular: return "\u{f6d3}"
        case .helpBold: return "\u{f6d4}"
        case .helpCircleBold: return "\u{f6d5}"
        case .helpCircleFilled: return "\u{f6d6}"
        case .helpCircleLight: return "\u{f6d7}"
        case .helpCircleRegular: return "\u{f6d8}"
        case .helpLight: return "\u{f6d9}"
        case .helpRegular: return "\u{f6da}"
        case .helpdeskBold: return "\u{f6db}"
        case .helpdeskFilled: return "\u{f6dc}"
        case .helpdeskLight: return "\u{f6dd}"
        case .helpdeskRegular: return "\u{f6de}"
        case .hideBold: return "\u{f6df}"
        case .hideFilled: return "\u{f6e0}"
        case .hideLight: return "\u{f6e1}"
        case .hideRegular: return "\u{f6e2}"
        case .homeBold: return "\u{f6e3}"
        case .homeFilled: return "\u{f6e4}"
        case .homeLight: return "\u{f6e5}"
        case .homeRegular: return "\u{f6e6}"
        case .horizontalLineBold: return "\u{f6e7}"
        case .horizontalLineLight: return "\u{f6e8}"
        case .horizontalLineRegular: return "\u{f6e9}"
        case .hotelingBold: return "\u{f6ea}"
        case .hotelingFilled: return "\u{f6eb}"
        case .hotelingLight: return "\u{f6ec}"
        case .hotelingRegular: return "\u{f6ed}"
        case .humidityBold: return "\u{f6ee}"
        case .humidityLight: return "\u{f6ef}"
        case .humidityRegular: return "\u{f6f0}"
        case .huntGroupBold: return "\u{f6f1}"
        case .huntGroupFilled: return "\u{f6f2}"
        case .huntGroupLight: return "\u{f6f3}"
        case .huntGroupRegular: return "\u{f6f4}"
        case .idleBold: return "\u{f6f5}"
        case .idleFilled: return "\u{f6f6}"
        case .idleLight: return "\u{f6f7}"
        case .idleRegular: return "\u{f6f8}"
        case .immediateBold: return "\u{f6f9}"
        case .immediateFilled: return "\u{f6fa}"
        case .immediateLight: return "\u{f6fb}"
        case .immediateRegular: return "\u{f6fc}"
        case .importBold: return "\u{f6fd}"
        case .importLight: return "\u{f6fe}"
        case .importRegular: return "\u{f6ff}"
        case .inCommonBold: return "\u{f700}"
        case .inCommonLight: return "\u{f701}"
        case .inCommonRegular: return "\u{f702}"
        case .inboxBold: return "\u{f703}"
        case .inboxFilled: return "\u{f704}"
        case .inboxLight: return "\u{f705}"
        case .inboxRegular: return "\u{f706}"
        case .includeBold: return "\u{f707}"
        case .includeLight: return "\u{f708}"
        case .includeRegular: return "\u{f709}"
        case .incognitoBold: return "\u{f70a}"
        case .incognitoFilled: return "\u{f70b}"
        case .incognitoLight: return "\u{f70c}"
        case .incognitoRegular: return "\u{f70d}"
        case .incomingCallLegacyBold: return "\u{f70e}"
        case .incomingCallLegacyFilled: return "\u{f70f}"
        case .incomingCallLegacyLight: return "\u{f710}"
        case .incomingCallLegacyRegular: return "\u{f711}"
        case .indentDecreaseBold: return "\u{f712}"
        case .indentDecreaseLight: return "\u{f713}"
        case .indentDecreaseRegular: return "\u{f714}"
        case .indentIncreaseBold: return "\u{f715}"
        case .indentIncreaseLight: return "\u{f716}"
        case .indentIncreaseRegular: return "\u{f717}"
        case .infoBadgeFilled: return "\u{f718}"
        case .infoCircleBold: return "\u{f719}"
        case .infoCircleFilled: return "\u{f71a}"
        case .infoCircleLight: return "\u{f71b}"
        case .infoCircleRegular: return "\u{f71c}"
        case .infoCircleTwoBold: return "\u{f71d}"
        case .infoCircleTwoFilled: return "\u{f71e}"
        case .infoCircleTwoLight: return "\u{f71f}"
        case .infoCircleTwoRegular: return "\u{f720}"
        case .inputBold: return "\u{f721}"
        case .inputDisconnectedBold: return "\u{f722}"
        case .inputDisconnectedLight: return "\u{f723}"
        case .inputDisconnectedRegular: return "\u{f724}"
        case .inputLight: return "\u{f725}"
        case .inputRegular: return "\u{f726}"
        case .instantScheduleBold: return "\u{f727}"
        case .instantScheduleFilled: return "\u{f728}"
        case .instantScheduleLight: return "\u{f729}"
        case .instantScheduleRegular: return "\u{f72a}"
        case .integerBold: return "\u{f72b}"
        case .integerFilled: return "\u{f72c}"
        case .integerLight: return "\u{f72d}"
        case .integerRegular: return "\u{f72e}"
        case .integrationsBold: return "\u{f72f}"
        case .integrationsFilled: return "\u{f730}"
        case .integrationsLight: return "\u{f731}"
        case .integrationsRegular: return "\u{f732}"
        case .intelligentRoutingBold: return "\u{f733}"
        case .intelligentRoutingLight: return "\u{f734}"
        case .intelligentRoutingRegular: return "\u{f735}"
        case .interactionBold: return "\u{f736}"
        case .interactionFilled: return "\u{f737}"
        case .interactionLight: return "\u{f738}"
        case .interactionRegular: return "\u{f739}"
        case .invitedUserBold: return "\u{f73a}"
        case .invitedUserLight: return "\u{f73b}"
        case .invitedUserRegular: return "\u{f73c}"
        case .italicBold: return "\u{f73d}"
        case .italicFilled: return "\u{f73e}"
        case .italicLight: return "\u{f73f}"
        case .italicRegular: return "\u{f740}"
        case .joinAudioBold: return "\u{f741}"
        case .joinAudioFilled: return "\u{f742}"
        case .joinAudioLight: return "\u{f743}"
        case .joinAudioRegular: return "\u{f744}"
        case .keepInTouchBold: return "\u{f745}"
        case .keepInTouchFilled: return "\u{f746}"
        case .keepInTouchLight: return "\u{f747}"
        case .keepInTouchRegular: return "\u{f748}"
        case .keyboardBold: return "\u{f749}"
        case .keyboardCloseBold: return "\u{f74a}"
        case .keyboardCloseLight: return "\u{f74b}"
        case .keyboardCloseRegular: return "\u{f74c}"
        case .keyboardLight: return "\u{f74d}"
        case .keyboardRegular: return "\u{f74e}"
        case .languageBold: return "\u{f74f}"
        case .languageFilled: return "\u{f750}"
        case .languageLight: return "\u{f751}"
        case .languageRegular: return "\u{f752}"
        case .laptopBold: return "\u{f753}"
        case .laptopDisconnectedBold: return "\u{f754}"
        case .laptopDisconnectedLight: return "\u{f755}"
        case .laptopDisconnectedRegular: return "\u{f756}"
        case .laptopFilled: return "\u{f757}"
        case .laptopLight: return "\u{f758}"
        case .laptopRegular: return "\u{f759}"
        case .laserPointerBold: return "\u{f75a}"
        case .laserPointerCursorBlackLight: return "\u{f75b}"
        case .laserPointerCursorBlueLight: return "\u{f75c}"
        case .laserPointerCursorGreenLight: return "\u{f75d}"
        case .laserPointerCursorPurpleLight: return "\u{f75e}"
        case .laserPointerCursorRedLight: return "\u{f75f}"
        case .laserPointerCursorWhiteLight: return "\u{f760}"
        case .laserPointerCursorYellowLight: return "\u{f761}"
        case .laserPointerFilled: return "\u{f762}"
        case .laserPointerLight: return "\u{f763}"
        case .laserPointerRegular: return "\u{f764}"
        case .launchBold: return "\u{f765}"
        case .launchFilled: return "\u{f766}"
        case .launchLight: return "\u{f767}"
        case .launchRegular: return "\u{f768}"
        case .layoutSideBySideVerticalBold: return "\u{f769}"
        case .layoutSideBySideVerticalFilled: return "\u{f76a}"
        case .layoutSideBySideVerticalLight: return "\u{f76b}"
        case .layoutSideBySideVerticalRegular: return "\u{f76c}"
        case .leaveBreakoutSessionBold: return "\u{f76d}"
        case .leaveBreakoutSessionLight: return "\u{f76e}"
        case .leaveBreakoutSessionRegular: return "\u{f76f}"
        case .leaveDeviceBold: return "\u{f770}"
        case .leaveDeviceLight: return "\u{f771}"
        case .leaveDeviceRegular: return "\u{f772}"
        case .likeBold: return "\u{f773}"
        case .likeFilled: return "\u{f774}"
        case .likeLight: return "\u{f775}"
        case .likeRegular: return "\u{f776}"
        case .linkBold: return "\u{f777}"
        case .linkLight: return "\u{f778}"
        case .linkRegular: return "\u{f779}"
        case .listBulletedBold: return "\u{f77a}"
        case .listBulletedLight: return "\u{f77b}"
        case .listBulletedRegular: return "\u{f77c}"
        case .listMenuBold: return "\u{f77d}"
        case .listMenuLight: return "\u{f77e}"
        case .listMenuRegular: return "\u{f77f}"
        case .listNumberedBold: return "\u{f780}"
        case .listNumberedLight: return "\u{f781}"
        case .listNumberedRegular: return "\u{f782}"
        case .liveBold: return "\u{f783}"
        case .liveFilled: return "\u{f784}"
        case .liveLight: return "\u{f785}"
        case .liveRegular: return "\u{f786}"
        case .locationBold: return "\u{f787}"
        case .locationFilled: return "\u{f788}"
        case .locationLight: return "\u{f789}"
        case .locationRegular: return "\u{f78a}"
        case .longTextBoxBold: return "\u{f78b}"
        case .longTextBoxLight: return "\u{f78c}"
        case .longTextBoxRegular: return "\u{f78d}"
        case .lowerHandBold: return "\u{f78e}"
        case .lowerHandLight: return "\u{f78f}"
        case .lowerHandRegular: return "\u{f790}"
        case .magicPenBold: return "\u{f791}"
        case .magicPenFilled: return "\u{f792}"
        case .magicPenLight: return "\u{f793}"
        case .magicPenRegular: return "\u{f794}"
        case .markAsUnreadBold: return "\u{f795}"
        case .markAsUnreadFilled: return "\u{f796}"
        case .markAsUnreadLight: return "\u{f797}"
        case .markAsUnreadRegular: return "\u{f798}"
        case .markdownBold: return "\u{f799}"
        case .markdownFilled: return "\u{f79a}"
        case .markdownLight: return "\u{f79b}"
        case .markdownRegular: return "\u{f79c}"
        case .markerBold: return "\u{f79d}"
        case .markerFilled: return "\u{f79e}"
        case .markerLight: return "\u{f79f}"
        case .markerRegular: return "\u{f7a0}"
        case .maximizeBold: return "\u{f7a1}"
        case .maximizeLight: return "\u{f7a2}"
        case .maximizeRegular: return "\u{f7a3}"
        case .mcpBold: return "\u{f7a4}"
        case .mcpFilled: return "\u{f7a5}"
        case .mcpLight: return "\u{f7a6}"
        case .mcpRegular: return "\u{f7a7}"
        case .mediaPlayerBold: return "\u{f7a8}"
        case .mediaPlayerLight: return "\u{f7a9}"
        case .mediaPlayerRegular: return "\u{f7aa}"
        case .mediaQualityGoodBold: return "\u{f7ab}"
        case .mediaQualityGoodFilled: return "\u{f7ac}"
        case .mediaQualityGoodLight: return "\u{f7ad}"
        case .mediaQualityGoodRegular: return "\u{f7ae}"
        case .mediaQualityPoorBold: return "\u{f7af}"
        case .mediaQualityPoorColoredBold: return "\u{f7b0}"
        case .mediaQualityPoorFilled: return "\u{f7b1}"
        case .mediaQualityPoorLight: return "\u{f7b2}"
        case .mediaQualityPoorRegular: return "\u{f7b3}"
        case .mediaQualityUnstableBold: return "\u{f7b4}"
        case .mediaQualityUnstableColoredBold: return "\u{f7b5}"
        case .mediaQualityUnstableFilled: return "\u{f7b6}"
        case .mediaQualityUnstableLight: return "\u{f7b7}"
        case .mediaQualityUnstableRegular: return "\u{f7b8}"
        case .meetBold: return "\u{f7b9}"
        case .meetEndBold: return "\u{f7ba}"
        case .meetEndLight: return "\u{f7bb}"
        case .meetEndRegular: return "\u{f7bc}"
        case .meetFilled: return "\u{f7bd}"
        case .meetLight: return "\u{f7be}"
        case .meetRegular: return "\u{f7bf}"
        case .meetingSummaryBold: return "\u{f7c0}"
        case .meetingSummaryFilled: return "\u{f7c1}"
        case .meetingSummaryLight: return "\u{f7c2}"
        case .meetingSummaryRegular: return "\u{f7c3}"
        case .meetingsBold: return "\u{f7c4}"
        case .meetingsFilled: return "\u{f7c5}"
        case .meetingsFocusMonthBold: return "\u{f7c6}"
        case .meetingsFocusMonthLight: return "\u{f7c7}"
        case .meetingsFocusMonthRegular: return "\u{f7c8}"
        case .meetingsFocusOneDayBold: return "\u{f7c9}"
        case .meetingsFocusOneDayLight: return "\u{f7ca}"
        case .meetingsFocusOneDayRegular: return "\u{f7cb}"
        case .meetingsFocusThreeDayBold: return "\u{f7cc}"
        case .meetingsFocusThreeDayLight: return "\u{f7cd}"
        case .meetingsFocusThreeDayRegular: return "\u{f7ce}"
        case .meetingsFocusUpcomingBold: return "\u{f7cf}"
        case .meetingsFocusUpcomingLight: return "\u{f7d0}"
        case .meetingsFocusUpcomingRegular: return "\u{f7d1}"
        case .meetingsLight: return "\u{f7d2}"
        case .meetingsPresenceBadgeFilled: return "\u{f7d3}"
        case .meetingsPresenceBold: return "\u{f7d4}"
        case .meetingsPresenceFilled: return "\u{f7d5}"
        case .meetingsPresenceLight: return "\u{f7d6}"
        case .meetingsPresenceRegular: return "\u{f7d7}"
        case .meetingsRegular: return "\u{f7d8}"
        case .meetingsTeamBold: return "\u{f7d9}"
        case .meetingsTeamFilled: return "\u{f7da}"
        case .meetingsTeamLight: return "\u{f7db}"
        case .meetingsTeamNewBold: return "\u{f7dc}"
        case .meetingsTeamNewLight: return "\u{f7dd}"
        case .meetingsTeamNewRegular: return "\u{f7de}"
        case .meetingsTeamRegular: return "\u{f7df}"
        case .mentionBold: return "\u{f7e0}"
        case .mentionFilled: return "\u{f7e1}"
        case .mentionLight: return "\u{f7e2}"
        case .mentionRegular: return "\u{f7e3}"
        case .messageQueingBold: return "\u{f7e4}"
        case .messageQueingLight: return "\u{f7e5}"
        case .messageQueingRegular: return "\u{f7e6}"
        case .microphoneBold: return "\u{f7e7}"
        case .microphoneFilled: return "\u{f7e8}"
        case .microphoneHardMutedBold: return "\u{f7e9}"
        case .microphoneHardMutedCircleFilled: return "\u{f7ea}"
        case .microphoneHardMutedLight: return "\u{f7eb}"
        case .microphoneHardMutedRegular: return "\u{f7ec}"
        case .microphoneLight: return "\u{f7ed}"
        case .microphoneMusicModeBold: return "\u{f7ee}"
        case .microphoneMusicModeLight: return "\u{f7ef}"
        case .microphoneMusicModeOnBold: return "\u{f7f0}"
        case .microphoneMusicModeOnLight: return "\u{f7f1}"
        case .microphoneMusicModeOnRegular: return "\u{f7f2}"
        case .microphoneMusicModeRegular: return "\u{f7f3}"
        case .microphoneMutedBold: return "\u{f7f4}"
        case .microphoneMutedCircleFilled: return "\u{f7f5}"
        case .microphoneMutedFilled: return "\u{f7f6}"
        case .microphoneMutedLight: return "\u{f7f7}"
        case .microphoneMutedRegular: return "\u{f7f8}"
        case .microphoneOnBold: return "\u{f7f9}"
        case .microphoneOnLight: return "\u{f7fa}"
        case .microphoneOnRegular: return "\u{f7fb}"
        case .microphoneOptAllBold: return "\u{f7fc}"
        case .microphoneOptAllLight: return "\u{f7fd}"
        case .microphoneOptAllMutedBold: return "\u{f7fe}"
        case .microphoneOptAllMutedLight: return "\u{f7ff}"
        case .microphoneOptAllMutedRegular: return "\u{f800}"
        case .microphoneOptAllOnBold: return "\u{f801}"
        case .microphoneOptAllOnLight: return "\u{f802}"
        case .microphoneOptAllOnRegular: return "\u{f803}"
        case .microphoneOptAllRegular: return "\u{f804}"
        case .microphoneOptMeBold: return "\u{f805}"
        case .microphoneOptMeLight: return "\u{f806}"
        case .microphoneOptMeMutedBold: return "\u{f807}"
        case .microphoneOptMeMutedLight: return "\u{f808}"
        case .microphoneOptMeMutedRegular: return "\u{f809}"
        case .microphoneOptMeOnBold: return "\u{f80a}"
        case .microphoneOptMeOnLight: return "\u{f80b}"
        case .microphoneOptMeOnRegular: return "\u{f80c}"
        case .microphoneOptMeRegular: return "\u{f80d}"
        case .microphoneRegular: return "\u{f80e}"
        case .mindMapBold: return "\u{f80f}"
        case .mindMapLight: return "\u{f810}"
        case .mindMapRegular: return "\u{f811}"
        case .minimizeBold: return "\u{f812}"
        case .minimizeLight: return "\u{f813}"
        case .minimizeRegular: return "\u{f814}"
        case .minusBold: return "\u{f815}"
        case .minusFilled: return "\u{f816}"
        case .minusLight: return "\u{f817}"
        case .minusRegular: return "\u{f818}"
        case .mirrorBold: return "\u{f819}"
        case .mirrorFilled: return "\u{f81a}"
        case .mirrorLight: return "\u{f81b}"
        case .mirrorRegular: return "\u{f81c}"
        case .mmsFilled: return "\u{f81d}"
        case .moderatorBold: return "\u{f81e}"
        case .moderatorLight: return "\u{f81f}"
        case .moderatorRegular: return "\u{f820}"
        case .monitoringBold: return "\u{f821}"
        case .monitoringLight: return "\u{f822}"
        case .monitoringRegular: return "\u{f823}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f824}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f825}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f826}"
        case .moreAdrBold: return "\u{f827}"
        case .moreAdrLight: return "\u{f828}"
        case .moreAdrRegular: return "\u{f829}"
        case .moreBold: return "\u{f82a}"
        case .moreCircleBold: return "\u{f82b}"
        case .moreCircleFilled: return "\u{f82c}"
        case .moreCircleLight: return "\u{f82d}"
        case .moreCircleRegular: return "\u{f82e}"
        case .moreLight: return "\u{f82f}"
        case .moreRegular: return "\u{f830}"
        case .mouseCursorBold: return "\u{f831}"
        case .mouseCursorLight: return "\u{f832}"
        case .mouseCursorRegular: return "\u{f833}"
        case .moveCallInAdrBold: return "\u{f834}"
        case .moveCallInAdrLight: return "\u{f835}"
        case .moveCallInAdrRegular: return "\u{f836}"
        case .moveCallInIphBold: return "\u{f837}"
        case .moveCallInIphLight: return "\u{f838}"
        case .moveCallInIphRegular: return "\u{f839}"
        case .moveCallInLaptopBold: return "\u{f83a}"
        case .moveCallInLaptopLight: return "\u{f83b}"
        case .moveCallInLaptopRegular: return "\u{f83c}"
        case .moveCallInOutAdrBold: return "\u{f83d}"
        case .moveCallInOutAdrLight: return "\u{f83e}"
        case .moveCallInOutAdrRegular: return "\u{f83f}"
        case .moveCallInOutIphBold: return "\u{f840}"
        case .moveCallInOutIphLight: return "\u{f841}"
        case .moveCallInOutIphRegular: return "\u{f842}"
        case .moveCallInTabletBold: return "\u{f843}"
        case .moveCallInTabletLight: return "\u{f844}"
        case .moveCallInTabletRegular: return "\u{f845}"
        case .moveCallOutAdrBold: return "\u{f846}"
        case .moveCallOutAdrLight: return "\u{f847}"
        case .moveCallOutAdrRegular: return "\u{f848}"
        case .moveCallOutIphBold: return "\u{f849}"
        case .moveCallOutIphLight: return "\u{f84a}"
        case .moveCallOutIphRegular: return "\u{f84b}"
        case .moveCallOutLaptopBold: return "\u{f84c}"
        case .moveCallOutLaptopLight: return "\u{f84d}"
        case .moveCallOutLaptopRegular: return "\u{f84e}"
        case .moveCallOutTabletBold: return "\u{f84f}"
        case .moveCallOutTabletLight: return "\u{f850}"
        case .moveCallOutTabletRegular: return "\u{f851}"
        case .moveToBottomBold: return "\u{f852}"
        case .moveToBottomFilled: return "\u{f853}"
        case .moveToBottomLight: return "\u{f854}"
        case .moveToBottomRegular: return "\u{f855}"
        case .moveToScreenBold: return "\u{f856}"
        case .moveToScreenLight: return "\u{f857}"
        case .moveToScreenRegular: return "\u{f858}"
        case .moveToTopBold: return "\u{f859}"
        case .moveToTopFilled: return "\u{f85a}"
        case .moveToTopLight: return "\u{f85b}"
        case .moveToTopRegular: return "\u{f85c}"
        case .multilineChartBold: return "\u{f85d}"
        case .multilineChartFilled: return "\u{f85e}"
        case .multilineChartLight: return "\u{f85f}"
        case .multilineChartRegular: return "\u{f860}"
        case .multimediaBold: return "\u{f861}"
        case .multimediaFilled: return "\u{f862}"
        case .multimediaLight: return "\u{f863}"
        case .multimediaRegular: return "\u{f864}"
        case .multipledDevicesBold: return "\u{f865}"
        case .multipledDevicesFilled: return "\u{f866}"
        case .multipledDevicesLight: return "\u{f867}"
        case .multipledDevicesRegular: return "\u{f868}"
        case .musicModeCircleBold: return "\u{f869}"
        case .musicModeCircleFilled: return "\u{f86a}"
        case .musicModeCircleLight: return "\u{f86b}"
        case .musicModeCircleRegular: return "\u{f86c}"
        case .musicNoteBold: return "\u{f86d}"
        case .musicNoteFilled: return "\u{f86e}"
        case .musicNoteLight: return "\u{f86f}"
        case .musicNoteRegular: return "\u{f870}"
        case .muteOnEntryBold: return "\u{f871}"
        case .muteOnEntryFilled: return "\u{f872}"
        case .muteOnEntryLight: return "\u{f873}"
        case .muteOnEntryRegular: return "\u{f874}"
        case .networkSwitchBold: return "\u{f875}"
        case .networkSwitchFilled: return "\u{f876}"
        case .networkSwitchLight: return "\u{f877}"
        case .networkSwitchRegular: return "\u{f878}"
        case .newManagerBold: return "\u{f879}"
        case .newManagerFilled: return "\u{f87a}"
        case .newManagerLight: return "\u{f87b}"
        case .newManagerRegular: return "\u{f87c}"
        case .newTitleBold: return "\u{f87d}"
        case .newTitleLight: return "\u{f87e}"
        case .newTitleRegular: return "\u{f87f}"
        case .newVoicemailBold: return "\u{f880}"
        case .newVoicemailLight: return "\u{f881}"
        case .newVoicemailRegular: return "\u{f882}"
        case .newWhiteboardBold: return "\u{f883}"
        case .newWhiteboardLight: return "\u{f884}"
        case .newWhiteboardRegular: return "\u{f885}"
        case .nextBold: return "\u{f886}"
        case .nextLight: return "\u{f887}"
        case .nextRegular: return "\u{f888}"
        case .noDevicesBold: return "\u{f889}"
        case .noDevicesLight: return "\u{f88a}"
        case .noDevicesRegular: return "\u{f88b}"
        case .noiseDetectedCanceledFilled: return "\u{f88c}"
        case .noiseDetectedFilled: return "\u{f88d}"
        case .noiseNoneCanceledFilled: return "\u{f88e}"
        case .noiseNoneFilled: return "\u{f88f}"
        case .noiseRemovalBold: return "\u{f890}"
        case .noiseRemovalLight: return "\u{f891}"
        case .noiseRemovalRegular: return "\u{f892}"
        case .noteBold: return "\u{f893}"
        case .noteFilled: return "\u{f894}"
        case .noteLight: return "\u{f895}"
        case .notePptBold: return "\u{f896}"
        case .notePptLight: return "\u{f897}"
        case .notePptRegular: return "\u{f898}"
        case .noteRegular: return "\u{f899}"
        case .notesBold: return "\u{f89a}"
        case .notesFilled: return "\u{f89b}"
        case .notesLight: return "\u{f89c}"
        case .notesRegular: return "\u{f89d}"
        case .numberBold: return "\u{f89e}"
        case .numberHighlightBold: return "\u{f89f}"
        case .numberHighlightFilled: return "\u{f8a0}"
        case .numberHighlightLight: return "\u{f8a1}"
        case .numberHighlightRegular: return "\u{f8a2}"
        case .numberLight: return "\u{f8a3}"
        case .numberRegular: return "\u{f8a4}"
        case .oldRemoteBold: return "\u{f8a5}"
        case .oldRemoteLight: return "\u{f8a6}"
        case .oldRemoteRegular: return "\u{f8a7}"
        case .oldTouchBold: return "\u{f8a8}"
        case .oldTouchLight: return "\u{f8a9}"
        case .oldTouchRegular: return "\u{f8aa}"
        case .oneColumnBold: return "\u{f8ab}"
        case .oneColumnLight: return "\u{f8ac}"
        case .oneColumnRegular: return "\u{f8ad}"
        case .oneTimeBold: return "\u{f8ae}"
        case .oneTimeLight: return "\u{f8af}"
        case .oneTimeRegular: return "\u{f8b0}"
        case .openInFolderBold: return "\u{f8b1}"
        case .openInFolderFilled: return "\u{f8b2}"
        case .openInFolderLight: return "\u{f8b3}"
        case .openInFolderRegular: return "\u{f8b4}"
        case .openPagesBold: return "\u{f8b5}"
        case .openPagesLight: return "\u{f8b6}"
        case .openPagesRegular: return "\u{f8b7}"
        case .otherNumberBold: return "\u{f8b8}"
        case .otherNumberFilled: return "\u{f8b9}"
        case .otherNumberLight: return "\u{f8ba}"
        case .otherNumberRegular: return "\u{f8bb}"
        case .otherNumberWarningBold: return "\u{f8bc}"
        case .otherNumberWarningLight: return "\u{f8bd}"
        case .otherNumberWarningRegular: return "\u{f8be}"
        case .outgoingCallLegacyBold: return "\u{f8bf}"
        case .outgoingCallLegacyFilled: return "\u{f8c0}"
        case .outgoingCallLegacyLight: return "\u{f8c1}"
        case .outgoingCallLegacyRegular: return "\u{f8c2}"
        case .overflowLeftBold: return "\u{f8c3}"
        case .overflowLeftLight: return "\u{f8c4}"
        case .overflowLeftRegular: return "\u{f8c5}"
        case .overflowRightBold: return "\u{f8c6}"
        case .overflowRightLight: return "\u{f8c7}"
        case .overflowRightRegular: return "\u{f8c8}"
        case .pairedCameraBold: return "\u{f8c9}"
        case .pairedCameraLight: return "\u{f8ca}"
        case .pairedCameraRegular: return "\u{f8cb}"
        case .pairedDeviceBold: return "\u{f8cc}"
        case .pairedDeviceLight: return "\u{f8cd}"
        case .pairedDeviceRegular: return "\u{f8ce}"
        case .pairedHandsetBold: return "\u{f8cf}"
        case .pairedHandsetLight: return "\u{f8d0}"
        case .pairedHandsetRegular: return "\u{f8d1}"
        case .pairingBold: return "\u{f8d2}"
        case .pairingLight: return "\u{f8d3}"
        case .pairingRegular: return "\u{f8d4}"
        case .parenthesisBold: return "\u{f8d5}"
        case .parenthesisFilled: return "\u{f8d6}"
        case .parenthesisLight: return "\u{f8d7}"
        case .parenthesisRegular: return "\u{f8d8}"
        case .parkedBold: return "\u{f8d9}"
        case .parkedFilled: return "\u{f8da}"
        case .parkedLight: return "\u{f8db}"
        case .parkedRegular: return "\u{f8dc}"
        case .parseBold: return "\u{f8dd}"
        case .parseLight: return "\u{f8de}"
        case .parseRegular: return "\u{f8df}"
        case .partialBold: return "\u{f8e0}"
        case .partialLight: return "\u{f8e1}"
        case .partialRegular: return "\u{f8e2}"
        case .participantAddBold: return "\u{f8e3}"
        case .participantAddLight: return "\u{f8e4}"
        case .participantAddRegular: return "\u{f8e5}"
        case .participantBlockedBold: return "\u{f8e6}"
        case .participantBlockedLight: return "\u{f8e7}"
        case .participantBlockedRegular: return "\u{f8e8}"
        case .participantBold: return "\u{f8e9}"
        case .participantFilled: return "\u{f8ea}"
        case .participantLight: return "\u{f8eb}"
        case .participantListBold: return "\u{f8ec}"
        case .participantListFilled: return "\u{f8ed}"
        case .participantListLight: return "\u{f8ee}"
        case .participantListRegular: return "\u{f8ef}"
        case .participantRegular: return "\u{f8f0}"
        case .participantRemoveBold: return "\u{f8f1}"
        case .participantRemoveLight: return "\u{f8f2}"
        case .participantRemoveRegular: return "\u{f8f3}"
        case .participantSpeakerBold: return "\u{f8f4}"
        case .participantSpeakerFilled: return "\u{f8f5}"
        case .participantSpeakerLight: return "\u{f8f6}"
        case .participantSpeakerRegular: return "\u{f8f7}"
        case .participantUnknownBold: return "\u{f8f8}"
        case .participantUnknownLight: return "\u{f8f9}"
        case .participantUnknownRegular: return "\u{f8fa}"
        case .passMouseBold: return "\u{f8fb}"
        case .passMouseLight: return "\u{f8fc}"
        case .passMouseRegular: return "\u{f8fd}"
        case .pauseBadgeFilled: return "\u{f8fe}"
        case .pauseBold: return "\u{f8ff}"
        case .pauseFilled: return "\u{f900}"
        case .pauseInteractionBold: return "\u{f901}"
        case .pauseInteractionFilled: return "\u{f902}"
        case .pauseInteractionLight: return "\u{f903}"
        case .pauseInteractionRegular: return "\u{f904}"
        case .pauseLight: return "\u{f905}"
        case .pauseRegular: return "\u{f906}"
        case .peopleAddBold: return "\u{f907}"
        case .peopleAddFilled: return "\u{f908}"
        case .peopleAddLight: return "\u{f909}"
        case .peopleAddRegular: return "\u{f90a}"
        case .peopleBold: return "\u{f90b}"
        case .peopleCircleBold: return "\u{f90c}"
        case .peopleCircleFilled: return "\u{f90d}"
        case .peopleCircleLight: return "\u{f90e}"
        case .peopleCircleRegular: return "\u{f90f}"
        case .peopleFilled: return "\u{f910}"
        case .peopleInsightsBold: return "\u{f911}"
        case .peopleInsightsFilled: return "\u{f912}"
        case .peopleInsightsLight: return "\u{f913}"
        case .peopleInsightsRegular: return "\u{f914}"
        case .peopleLight: return "\u{f915}"
        case .peopleManageBold: return "\u{f916}"
        case .peopleManageFilled: return "\u{f917}"
        case .peopleManageLight: return "\u{f918}"
        case .peopleManageRegular: return "\u{f919}"
        case .peopleRegular: return "\u{f91a}"
        case .phoneAlertBold: return "\u{f91b}"
        case .phoneAlertLight: return "\u{f91c}"
        case .phoneAlertRegular: return "\u{f91d}"
        case .phoneBadgeFilled: return "\u{f91e}"
        case .phoneBold: return "\u{f91f}"
        case .phoneFilled: return "\u{f920}"
        case .phoneLight: return "\u{f921}"
        case .phoneMutedBold: return "\u{f922}"
        case .phoneMutedLight: return "\u{f923}"
        case .phoneMutedRegular: return "\u{f924}"
        case .phonePrivateBold: return "\u{f925}"
        case .phonePrivateLight: return "\u{f926}"
        case .phonePrivateRegular: return "\u{f927}"
        case .phoneRegular: return "\u{f928}"
        case .phoneReplyAllBold: return "\u{f929}"
        case .phoneReplyAllLight: return "\u{f92a}"
        case .phoneReplyAllRegular: return "\u{f92b}"
        case .phoneReplyBold: return "\u{f92c}"
        case .phoneReplyLight: return "\u{f92d}"
        case .phoneReplyRegular: return "\u{f92e}"
        case .pickerBold: return "\u{f92f}"
        case .pickerLight: return "\u{f930}"
        case .pickerRegular: return "\u{f931}"
        case .pieChartBold: return "\u{f932}"
        case .pieChartFilled: return "\u{f933}"
        case .pieChartLight: return "\u{f934}"
        case .pieChartRegular: return "\u{f935}"
        case .pinBold: return "\u{f936}"
        case .pinFilled: return "\u{f937}"
        case .pinLight: return "\u{f938}"
        case .pinListActivityBold: return "\u{f939}"
        case .pinListActivityLight: return "\u{f93a}"
        case .pinListActivityRegular: return "\u{f93b}"
        case .pinListBold: return "\u{f93c}"
        case .pinListLight: return "\u{f93d}"
        case .pinListRegular: return "\u{f93e}"
        case .pinMutedBold: return "\u{f93f}"
        case .pinMutedFilled: return "\u{f940}"
        case .pinMutedLight: return "\u{f941}"
        case .pinMutedRegular: return "\u{f942}"
        case .pinRegular: return "\u{f943}"
        case .pipBold: return "\u{f944}"
        case .pipEnterBold: return "\u{f945}"
        case .pipEnterLight: return "\u{f946}"
        case .pipEnterRegular: return "\u{f947}"
        case .pipExitBold: return "\u{f948}"
        case .pipExitLight: return "\u{f949}"
        case .pipExitRegular: return "\u{f94a}"
        case .pipFilled: return "\u{f94b}"
        case .pipLight: return "\u{f94c}"
        case .pipRegular: return "\u{f94d}"
        case .placeholderBold: return "\u{f94e}"
        case .placeholderFilled: return "\u{f94f}"
        case .placeholderLight: return "\u{f950}"
        case .placeholderRegular: return "\u{f951}"
        case .playBold: return "\u{f952}"
        case .playCircleBold: return "\u{f953}"
        case .playCircleFilled: return "\u{f954}"
        case .playCircleLight: return "\u{f955}"
        case .playCircleRegular: return "\u{f956}"
        case .playFilled: return "\u{f957}"
        case .playLight: return "\u{f958}"
        case .playRegular: return "\u{f959}"
        case .plugAcBold: return "\u{f95a}"
        case .plugAcLight: return "\u{f95b}"
        case .plugAcRegular: return "\u{f95c}"
        case .plusBold: return "\u{f95d}"
        case .plusCircleBold: return "\u{f95e}"
        case .plusCircleFilled: return "\u{f95f}"
        case .plusCircleLight: return "\u{f960}"
        case .plusCircleRegular: return "\u{f961}"
        case .plusLight: return "\u{f962}"
        case .plusRegular: return "\u{f963}"
        case .pmrBold: return "\u{f964}"
        case .pmrFilled: return "\u{f965}"
        case .pmrLight: return "\u{f966}"
        case .pmrRegular: return "\u{f967}"
        case .pollBold: return "\u{f968}"
        case .pollFilled: return "\u{f969}"
        case .pollLight: return "\u{f96a}"
        case .pollRegular: return "\u{f96b}"
        case .popInBold: return "\u{f96c}"
        case .popInLight: return "\u{f96d}"
        case .popInRegular: return "\u{f96e}"
        case .popOutBold: return "\u{f96f}"
        case .popOutLight: return "\u{f970}"
        case .popOutRegular: return "\u{f971}"
        case .popUpBold: return "\u{f972}"
        case .popUpLight: return "\u{f973}"
        case .popUpRegular: return "\u{f974}"
        case .portraitLandscapeBold: return "\u{f975}"
        case .portraitLandscapeLight: return "\u{f976}"
        case .portraitLandscapeRegular: return "\u{f977}"
        case .potentialFraudBold: return "\u{f978}"
        case .potentialFraudFilled: return "\u{f979}"
        case .potentialFraudLight: return "\u{f97a}"
        case .potentialFraudRegular: return "\u{f97b}"
        case .powerAcBold: return "\u{f97c}"
        case .powerAcLight: return "\u{f97d}"
        case .powerAcRegular: return "\u{f97e}"
        case .powerBold: return "\u{f97f}"
        case .powerLight: return "\u{f980}"
        case .powerRegular: return "\u{f981}"
        case .preHeaderBold: return "\u{f982}"
        case .preHeaderLight: return "\u{f983}"
        case .preHeaderRegular: return "\u{f984}"
        case .premiumBold: return "\u{f985}"
        case .premiumLight: return "\u{f986}"
        case .premiumRegular: return "\u{f987}"
        case .presentationBold: return "\u{f988}"
        case .presentationLight: return "\u{f989}"
        case .presentationRegular: return "\u{f98a}"
        case .preventDownloadBold: return "\u{f98b}"
        case .preventDownloadFilled: return "\u{f98c}"
        case .preventDownloadLight: return "\u{f98d}"
        case .preventDownloadRegular: return "\u{f98e}"
        case .primaryParticipantBold: return "\u{f98f}"
        case .primaryParticipantFilled: return "\u{f990}"
        case .primaryParticipantLight: return "\u{f991}"
        case .primaryParticipantRegular: return "\u{f992}"
        case .printBold: return "\u{f993}"
        case .printLight: return "\u{f994}"
        case .printRegular: return "\u{f995}"
        case .priorityBadgeFilled: return "\u{f996}"
        case .priorityCircleBold: return "\u{f997}"
        case .priorityCircleFilled: return "\u{f998}"
        case .priorityCircleLight: return "\u{f999}"
        case .priorityCircleRegular: return "\u{f99a}"
        case .priorityCircleTwoBold: return "\u{f99b}"
        case .priorityCircleTwoFilled: return "\u{f99c}"
        case .priorityCircleTwoLight: return "\u{f99d}"
        case .priorityCircleTwoRegular: return "\u{f99e}"
        case .priorityWaveBold: return "\u{f99f}"
        case .priorityWaveLight: return "\u{f9a0}"
        case .priorityWaveRegular: return "\u{f9a1}"
        case .privacyCircleBold: return "\u{f9a2}"
        case .privacyCircleFilled: return "\u{f9a3}"
        case .privacyCircleLight: return "\u{f9a4}"
        case .privacyCircleRegular: return "\u{f9a5}"
        case .privateBold: return "\u{f9a6}"
        case .privateCircleBold: return "\u{f9a7}"
        case .privateCircleFilled: return "\u{f9a8}"
        case .privateCircleLight: return "\u{f9a9}"
        case .privateCircleRegular: return "\u{f9aa}"
        case .privateLight: return "\u{f9ab}"
        case .privateMeetingBold: return "\u{f9ac}"
        case .privateMeetingLight: return "\u{f9ad}"
        case .privateMeetingRegular: return "\u{f9ae}"
        case .privateRegular: return "\u{f9af}"
        case .productDemoBold: return "\u{f9b0}"
        case .productDemoLight: return "\u{f9b1}"
        case .productDemoRegular: return "\u{f9b2}"
        case .promptsAiBold: return "\u{f9b3}"
        case .promptsAiLight: return "\u{f9b4}"
        case .promptsAiRegular: return "\u{f9b5}"
        case .proximityBold: return "\u{f9b6}"
        case .proximityLight: return "\u{f9b7}"
        case .proximityMutedBold: return "\u{f9b8}"
        case .proximityMutedLight: return "\u{f9b9}"
        case .proximityMutedRegular: return "\u{f9ba}"
        case .proximityRegular: return "\u{f9bb}"
        case .proximityVideoBold: return "\u{f9bc}"
        case .proximityVideoLight: return "\u{f9bd}"
        case .proximityVideoRegular: return "\u{f9be}"
        case .ptoPresenceBold: return "\u{f9bf}"
        case .ptoPresenceFilled: return "\u{f9c0}"
        case .ptoPresenceLight: return "\u{f9c1}"
        case .ptoPresenceRegular: return "\u{f9c2}"
        case .pullCallBold: return "\u{f9c3}"
        case .pullCallFilled: return "\u{f9c4}"
        case .pullCallLight: return "\u{f9c5}"
        case .pullCallRegular: return "\u{f9c6}"
        case .purchaseOrderBold: return "\u{f9c7}"
        case .purchaseOrderFilled: return "\u{f9c8}"
        case .purchaseOrderLight: return "\u{f9c9}"
        case .purchaseOrderRegular: return "\u{f9ca}"
        case .qABold: return "\u{f9cb}"
        case .qAFilled: return "\u{f9cc}"
        case .qALight: return "\u{f9cd}"
        case .qARegular: return "\u{f9ce}"
        case .qrCodeBold: return "\u{f9cf}"
        case .qrCodeLight: return "\u{f9d0}"
        case .qrCodeRegular: return "\u{f9d1}"
        case .qrCodeScanBold: return "\u{f9d2}"
        case .qrCodeScanLight: return "\u{f9d3}"
        case .qrCodeScanRegular: return "\u{f9d4}"
        case .qualityBold: return "\u{f9d5}"
        case .qualityLight: return "\u{f9d6}"
        case .qualityRegular: return "\u{f9d7}"
        case .queueContactBold: return "\u{f9d8}"
        case .queueContactFilled: return "\u{f9d9}"
        case .queueContactLight: return "\u{f9da}"
        case .queueContactRegular: return "\u{f9db}"
        case .queuedInteractionBold: return "\u{f9dc}"
        case .queuedInteractionFilled: return "\u{f9dd}"
        case .queuedInteractionLight: return "\u{f9de}"
        case .queuedInteractionRegular: return "\u{f9df}"
        case .quietBold: return "\u{f9e0}"
        case .quietHoursPresenceBold: return "\u{f9e1}"
        case .quietHoursPresenceFilled: return "\u{f9e2}"
        case .quietHoursPresenceLight: return "\u{f9e3}"
        case .quietHoursPresenceRegular: return "\u{f9e4}"
        case .quietLight: return "\u{f9e5}"
        case .quietRegular: return "\u{f9e6}"
        case .radioButtonGroupBold: return "\u{f9e7}"
        case .radioButtonGroupLight: return "\u{f9e8}"
        case .radioButtonGroupRegular: return "\u{f9e9}"
        case .raiseHandBold: return "\u{f9ea}"
        case .raiseHandCircleFilled: return "\u{f9eb}"
        case .raiseHandFilled: return "\u{f9ec}"
        case .raiseHandLight: return "\u{f9ed}"
        case .raiseHandRegular: return "\u{f9ee}"
        case .ramBold: return "\u{f9ef}"
        case .ramLight: return "\u{f9f0}"
        case .ramRegular: return "\u{f9f1}"
        case .reactionsBold: return "\u{f9f2}"
        case .reactionsFilled: return "\u{f9f3}"
        case .reactionsLight: return "\u{f9f4}"
        case .reactionsRegular: return "\u{f9f5}"
        case .reactivateBold: return "\u{f9f6}"
        case .reactivateLight: return "\u{f9f7}"
        case .reactivateRegular: return "\u{f9f8}"
        case .receiveVoiceBold: return "\u{f9f9}"
        case .receiveVoiceFilled: return "\u{f9fa}"
        case .receiveVoiceLight: return "\u{f9fb}"
        case .receiveVoiceRegular: return "\u{f9fc}"
        case .recentsBold: return "\u{f9fd}"
        case .recentsFilled: return "\u{f9fe}"
        case .recentsLight: return "\u{f9ff}"
        case .recentsPresenceBadgeFilled: return "\u{fa00}"
        case .recentsPresenceBold: return "\u{fa01}"
        case .recentsPresenceFilled: return "\u{fa02}"
        case .recentsPresenceLight: return "\u{fa03}"
        case .recentsPresenceRegular: return "\u{fa04}"
        case .recentsRegular: return "\u{fa05}"
        case .recordActiveBadgeFilled: return "\u{fa06}"
        case .recordActiveBold: return "\u{fa07}"
        case .recordActiveFilled: return "\u{fa08}"
        case .recordActiveLight: return "\u{fa09}"
        case .recordActiveRegular: return "\u{fa0a}"
        case .recordBold: return "\u{fa0b}"
        case .recordFilled: return "\u{fa0c}"
        case .recordLight: return "\u{fa0d}"
        case .recordPausedBadgeFilled: return "\u{fa0e}"
        case .recordPausedBold: return "\u{fa0f}"
        case .recordPausedFilled: return "\u{fa10}"
        case .recordPausedLight: return "\u{fa11}"
        case .recordPausedRegular: return "\u{fa12}"
        case .recordRegular: return "\u{fa13}"
        case .recurringBold: return "\u{fa14}"
        case .recurringLight: return "\u{fa15}"
        case .recurringOffBold: return "\u{fa16}"
        case .recurringOffLight: return "\u{fa17}"
        case .recurringOffRegular: return "\u{fa18}"
        case .recurringRegular: return "\u{fa19}"
        case .redoBold: return "\u{fa1a}"
        case .redoLight: return "\u{fa1b}"
        case .redoRegular: return "\u{fa1c}"
        case .refreshBold: return "\u{fa1d}"
        case .refreshLight: return "\u{fa1e}"
        case .refreshRegular: return "\u{fa1f}"
        case .remoteDesktopControlBold: return "\u{fa20}"
        case .remoteDesktopControlFilled: return "\u{fa21}"
        case .remoteDesktopControlLight: return "\u{fa22}"
        case .remoteDesktopControlRegular: return "\u{fa23}"
        case .removeBold: return "\u{fa24}"
        case .removeFilled: return "\u{fa25}"
        case .removeLight: return "\u{fa26}"
        case .removeRegular: return "\u{fa27}"
        case .replyBold: return "\u{fa28}"
        case .replyFilled: return "\u{fa29}"
        case .replyLight: return "\u{fa2a}"
        case .replyListBold: return "\u{fa2b}"
        case .replyListFilled: return "\u{fa2c}"
        case .replyListLight: return "\u{fa2d}"
        case .replyListRegular: return "\u{fa2e}"
        case .replyPrivatelyBold: return "\u{fa2f}"
        case .replyPrivatelyLight: return "\u{fa30}"
        case .replyPrivatelyRegular: return "\u{fa31}"
        case .replyRegular: return "\u{fa32}"
        case .resetBold: return "\u{fa33}"
        case .resetLight: return "\u{fa34}"
        case .resetRegular: return "\u{fa35}"
        case .resizeCornerBold: return "\u{fa36}"
        case .resizeCornerLight: return "\u{fa37}"
        case .resizeCornerRegular: return "\u{fa38}"
        case .responsiveMobileBold: return "\u{fa39}"
        case .responsiveMobileLight: return "\u{fa3a}"
        case .responsiveMobileRegular: return "\u{fa3b}"
        case .restartBold: return "\u{fa3c}"
        case .restartLight: return "\u{fa3d}"
        case .restartRegular: return "\u{fa3e}"
        case .resumeInteractionBold: return "\u{fa3f}"
        case .resumeInteractionFilled: return "\u{fa40}"
        case .resumeInteractionLight: return "\u{fa41}"
        case .resumeInteractionRegular: return "\u{fa42}"
        case .retrieveCallBold: return "\u{fa43}"
        case .retrieveCallFilled: return "\u{fa44}"
        case .retrieveCallLight: return "\u{fa45}"
        case .retrieveCallRegular: return "\u{fa46}"
        case .returnBold: return "\u{fa47}"
        case .returnLight: return "\u{fa48}"
        case .returnRegular: return "\u{fa49}"
        case .rewindTenSecBold: return "\u{fa4a}"
        case .rewindTenSecLight: return "\u{fa4b}"
        case .rewindTenSecRegular: return "\u{fa4c}"
        case .ringtoneBold: return "\u{fa4d}"
        case .ringtoneLight: return "\u{fa4e}"
        case .ringtoneRegular: return "\u{fa4f}"
        case .roomCalendarBold: return "\u{fa50}"
        case .roomCalendarLight: return "\u{fa51}"
        case .roomCalendarRegular: return "\u{fa52}"
        case .roomLightsBold: return "\u{fa53}"
        case .roomLightsFilled: return "\u{fa54}"
        case .roomLightsLight: return "\u{fa55}"
        case .roomLightsRegular: return "\u{fa56}"
        case .rotateContentBold: return "\u{fa57}"
        case .rotateContentFilled: return "\u{fa58}"
        case .rotateContentLight: return "\u{fa59}"
        case .rotateContentRegular: return "\u{fa5a}"
        case .rssBold: return "\u{fa5b}"
        case .rssFilled: return "\u{fa5c}"
        case .rssLight: return "\u{fa5d}"
        case .rssRegular: return "\u{fa5e}"
        case .ruleBasedBold: return "\u{fa5f}"
        case .ruleBasedFilled: return "\u{fa60}"
        case .ruleBasedLight: return "\u{fa61}"
        case .ruleBasedRegular: return "\u{fa62}"
        case .rulerBold: return "\u{fa63}"
        case .rulerFilled: return "\u{fa64}"
        case .rulerLight: return "\u{fa65}"
        case .rulerRegular: return "\u{fa66}"
        case .runningApplicationBold: return "\u{fa67}"
        case .runningApplicationFilled: return "\u{fa68}"
        case .runningApplicationLight: return "\u{fa69}"
        case .runningApplicationRegular: return "\u{fa6a}"
        case .saveBold: return "\u{fa6b}"
        case .saveLight: return "\u{fa6c}"
        case .saveRegular: return "\u{fa6d}"
        case .saveTranscriptBold: return "\u{fa6e}"
        case .saveTranscriptFilled: return "\u{fa6f}"
        case .saveTranscriptLight: return "\u{fa70}"
        case .saveTranscriptRegular: return "\u{fa71}"
        case .scanBold: return "\u{fa72}"
        case .scanLight: return "\u{fa73}"
        case .scanRegular: return "\u{fa74}"
        case .scheduleAiBold: return "\u{fa75}"
        case .scheduleAiLight: return "\u{fa76}"
        case .scheduleAiRegular: return "\u{fa77}"
        case .scheduleSendBold: return "\u{fa78}"
        case .scheduleSendFilled: return "\u{fa79}"
        case .scheduleSendLight: return "\u{fa7a}"
        case .scheduleSendRegular: return "\u{fa7b}"
        case .scheduleWinnerBold: return "\u{fa7c}"
        case .scheduleWinnerFilled: return "\u{fa7d}"
        case .scheduleWinnerLight: return "\u{fa7e}"
        case .scheduleWinnerRegular: return "\u{fa7f}"
        case .schedulerAvailableBold: return "\u{fa80}"
        case .schedulerAvailableLight: return "\u{fa81}"
        case .schedulerAvailableRegular: return "\u{fa82}"
        case .schedulerNotWorkingHoursBold: return "\u{fa83}"
        case .schedulerNotWorkingHoursLight: return "\u{fa84}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa85}"
        case .schedulerUnavailableBold: return "\u{fa86}"
        case .schedulerUnavailableLight: return "\u{fa87}"
        case .schedulerUnavailableRegular: return "\u{fa88}"
        case .schedulerUnknownBold: return "\u{fa89}"
        case .schedulerUnknownLight: return "\u{fa8a}"
        case .schedulerUnknownRegular: return "\u{fa8b}"
        case .screenshotBold: return "\u{fa8c}"
        case .screenshotDocBold: return "\u{fa8d}"
        case .screenshotDocFilled: return "\u{fa8e}"
        case .screenshotDocLight: return "\u{fa8f}"
        case .screenshotDocRegular: return "\u{fa90}"
        case .screenshotLight: return "\u{fa91}"
        case .screenshotRegular: return "\u{fa92}"
        case .searchAiBold: return "\u{fa93}"
        case .searchAiLight: return "\u{fa94}"
        case .searchAiRegular: return "\u{fa95}"
        case .searchBold: return "\u{fa96}"
        case .searchFilled: return "\u{fa97}"
        case .searchLight: return "\u{fa98}"
        case .searchRegular: return "\u{fa99}"
        case .secondaryArrowBold: return "\u{fa9a}"
        case .secondaryArrowLight: return "\u{fa9b}"
        case .secondaryArrowRegular: return "\u{fa9c}"
        case .secureCallLockBold: return "\u{fa9d}"
        case .secureCallLockFilled: return "\u{fa9e}"
        case .secureCallLockLight: return "\u{fa9f}"
        case .secureCallLockRegular: return "\u{faa0}"
        case .secureCallShieldBold: return "\u{faa1}"
        case .secureCallShieldFilled: return "\u{faa2}"
        case .secureCallShieldLight: return "\u{faa3}"
        case .secureCallShieldRegular: return "\u{faa4}"
        case .secureCircleBold: return "\u{faa5}"
        case .secureCircleFilled: return "\u{faa6}"
        case .secureCircleLight: return "\u{faa7}"
        case .secureCircleRegular: return "\u{faa8}"
        case .secureLockBold: return "\u{faa9}"
        case .secureLockFilled: return "\u{faaa}"
        case .secureLockLight: return "\u{faab}"
        case .secureLockRegular: return "\u{faac}"
        case .segmentExcludeFilled: return "\u{faad}"
        case .segmentFilterFilled: return "\u{faae}"
        case .segmentIncludeFilled: return "\u{faaf}"
        case .selectAllBold: return "\u{fab0}"
        case .selectAllFilled: return "\u{fab1}"
        case .selectAllLight: return "\u{fab2}"
        case .selectAllRegular: return "\u{fab3}"
        case .selectionBold: return "\u{fab4}"
        case .selectionFilled: return "\u{fab5}"
        case .selectionLight: return "\u{fab6}"
        case .selectionRegular: return "\u{fab7}"
        case .sendBold: return "\u{fab8}"
        case .sendDigitsBold: return "\u{fab9}"
        case .sendDigitsFilled: return "\u{faba}"
        case .sendDigitsLight: return "\u{fabb}"
        case .sendDigitsRegular: return "\u{fabc}"
        case .sendFilled: return "\u{fabd}"
        case .sendLight: return "\u{fabe}"
        case .sendRegular: return "\u{fabf}"
        case .sendVoiceBold: return "\u{fac0}"
        case .sendVoiceFilled: return "\u{fac1}"
        case .sendVoiceLight: return "\u{fac2}"
        case .sendVoiceRegular: return "\u{fac3}"
        case .serverBold: return "\u{fac4}"
        case .serverErrorBold: return "\u{fac5}"
        case .serverErrorLight: return "\u{fac6}"
        case .serverErrorRegular: return "\u{fac7}"
        case .serverLight: return "\u{fac8}"
        case .serverRegular: return "\u{fac9}"
        case .servicesBold: return "\u{faca}"
        case .servicesLight: return "\u{facb}"
        case .servicesRegular: return "\u{facc}"
        case .setVariableBold: return "\u{facd}"
        case .setVariableLight: return "\u{face}"
        case .setVariableRegular: return "\u{facf}"
        case .settingsBold: return "\u{fad0}"
        case .settingsFilled: return "\u{fad1}"
        case .settingsLight: return "\u{fad2}"
        case .settingsRegular: return "\u{fad3}"
        case .setupAssistantBold: return "\u{fad4}"
        case .setupAssistantLight: return "\u{fad5}"
        case .setupAssistantRegular: return "\u{fad6}"
        case .sftpBold: return "\u{fad7}"
        case .sftpLight: return "\u{fad8}"
        case .sftpRegular: return "\u{fad9}"
        case .shapeCircleBold: return "\u{fada}"
        case .shapeCircleFilled: return "\u{fadb}"
        case .shapeCircleLight: return "\u{fadc}"
        case .shapeCircleMdFilled: return "\u{fadd}"
        case .shapeCircleRegular: return "\u{fade}"
        case .shapeCircleSmFilled: return "\u{fadf}"
        case .shapeDiagonalLineBold: return "\u{fae0}"
        case .shapeDiagonalLineLight: return "\u{fae1}"
        case .shapeDiagonalLineRegular: return "\u{fae2}"
        case .shapeDiamondBold: return "\u{fae3}"
        case .shapeDiamondFilled: return "\u{fae4}"
        case .shapeDiamondLight: return "\u{fae5}"
        case .shapeDiamondRegular: return "\u{fae6}"
        case .shapeOvalBold: return "\u{fae7}"
        case .shapeOvalLight: return "\u{fae8}"
        case .shapeOvalRegular: return "\u{fae9}"
        case .shapeSquareBold: return "\u{faea}"
        case .shapeSquareFilled: return "\u{faeb}"
        case .shapeSquareLight: return "\u{faec}"
        case .shapeSquareRegular: return "\u{faed}"
        case .shapeTriangleBold: return "\u{faee}"
        case .shapeTriangleFilled: return "\u{faef}"
        case .shapeTriangleLight: return "\u{faf0}"
        case .shapeTriangleRegular: return "\u{faf1}"
        case .shapesBold: return "\u{faf2}"
        case .shapesFilled: return "\u{faf3}"
        case .shapesLight: return "\u{faf4}"
        case .shapesRegular: return "\u{faf5}"
        case .shareCNativeAdrBold: return "\u{faf6}"
        case .shareCNativeAdrFilled: return "\u{faf7}"
        case .shareCNativeAdrLight: return "\u{faf8}"
        case .shareCNativeAdrRegular: return "\u{faf9}"
        case .shareCNativeIphBold: return "\u{fafa}"
        case .shareCNativeIphLight: return "\u{fafb}"
        case .shareCNativeIphRegular: return "\u{fafc}"
        case .shareContentOnDeviceBold: return "\u{fafd}"
        case .shareContentOnDeviceLight: return "\u{fafe}"
        case .shareContentOnDeviceRegular: return "\u{faff}"
        case .shareScreenAddBold: return "\u{fb00}"
        case .shareScreenAddLight: return "\u{fb01}"
        case .shareScreenAddRegular: return "\u{fb02}"
        case .shareScreenBadgeFilled: return "\u{fb03}"
        case .shareScreenBold: return "\u{fb04}"
        case .shareScreenFilled: return "\u{fb05}"
        case .shareScreenLight: return "\u{fb06}"
        case .shareScreenRegular: return "\u{fb07}"
        case .shareSpaceBold: return "\u{fb08}"
        case .shareSpaceLight: return "\u{fb09}"
        case .shareSpaceRegular: return "\u{fb0a}"
        case .shieldBold: return "\u{fb0b}"
        case .shieldLight: return "\u{fb0c}"
        case .shieldRegular: return "\u{fb0d}"
        case .shoppingCartBold: return "\u{fb0e}"
        case .shoppingCartFilled: return "\u{fb0f}"
        case .shoppingCartLight: return "\u{fb10}"
        case .shoppingCartRegular: return "\u{fb11}"
        case .shortTextBoxBold: return "\u{fb12}"
        case .shortTextBoxLight: return "\u{fb13}"
        case .shortTextBoxRegular: return "\u{fb14}"
        case .showBold: return "\u{fb15}"
        case .showFilled: return "\u{fb16}"
        case .showLight: return "\u{fb17}"
        case .showRegular: return "\u{fb18}"
        case .sidePanelBold: return "\u{fb19}"
        case .sidePanelFilled: return "\u{fb1a}"
        case .sidePanelLight: return "\u{fb1b}"
        case .sidePanelRegular: return "\u{fb1c}"
        case .signInBold: return "\u{fb1d}"
        case .signInFilled: return "\u{fb1e}"
        case .signInForcedBold: return "\u{fb1f}"
        case .signInForcedLight: return "\u{fb20}"
        case .signInForcedRegular: return "\u{fb21}"
        case .signInLight: return "\u{fb22}"
        case .signInRegular: return "\u{fb23}"
        case .signLangIntBold: return "\u{fb24}"
        case .signLangIntLight: return "\u{fb25}"
        case .signLangIntRegular: return "\u{fb26}"
        case .signOutBold: return "\u{fb27}"
        case .signOutLight: return "\u{fb28}"
        case .signOutRegular: return "\u{fb29}"
        case .signalFourBold: return "\u{fb2a}"
        case .signalFourLight: return "\u{fb2b}"
        case .signalFourRegular: return "\u{fb2c}"
        case .signalOneBold: return "\u{fb2d}"
        case .signalOneLight: return "\u{fb2e}"
        case .signalOneRegular: return "\u{fb2f}"
        case .signalThreeBold: return "\u{fb30}"
        case .signalThreeLight: return "\u{fb31}"
        case .signalThreeRegular: return "\u{fb32}"
        case .signalTwoBold: return "\u{fb33}"
        case .signalTwoLight: return "\u{fb34}"
        case .signalTwoRegular: return "\u{fb35}"
        case .signalZeroBold: return "\u{fb36}"
        case .signalZeroLight: return "\u{fb37}"
        case .signalZeroRegular: return "\u{fb38}"
        case .simplePromotionBold: return "\u{fb39}"
        case .simplePromotionLight: return "\u{fb3a}"
        case .simplePromotionRegular: return "\u{fb3b}"
        case .singleNumberReachBold: return "\u{fb3c}"
        case .singleNumberReachLight: return "\u{fb3d}"
        case .singleNumberReachRegular: return "\u{fb3e}"
        case .sipRegistrationInProgressBold: return "\u{fb3f}"
        case .sipRegistrationInProgressFilled: return "\u{fb40}"
        case .sipRegistrationInProgressLight: return "\u{fb41}"
        case .sipRegistrationInProgressRegular: return "\u{fb42}"
        case .skipBold: return "\u{fb43}"
        case .skipBwBold: return "\u{fb44}"
        case .skipBwFilled: return "\u{fb45}"
        case .skipBwLight: return "\u{fb46}"
        case .skipBwRegular: return "\u{fb47}"
        case .skipFwBold: return "\u{fb48}"
        case .skipFwFilled: return "\u{fb49}"
        case .skipFwLight: return "\u{fb4a}"
        case .skipFwRegular: return "\u{fb4b}"
        case .skipLight: return "\u{fb4c}"
        case .skipRegular: return "\u{fb4d}"
        case .smartAudioBold: return "\u{fb4e}"
        case .smartAudioLight: return "\u{fb4f}"
        case .smartAudioRegular: return "\u{fb50}"
        case .smartReplyBold: return "\u{fb51}"
        case .smartReplyLight: return "\u{fb52}"
        case .smartReplyRegular: return "\u{fb53}"
        case .smsFilled: return "\u{fb54}"
        case .smsInboundBold: return "\u{fb55}"
        case .smsInboundLight: return "\u{fb56}"
        case .smsInboundRegular: return "\u{fb57}"
        case .smsMessageBold: return "\u{fb58}"
        case .smsMessageFilled: return "\u{fb59}"
        case .smsMessageLight: return "\u{fb5a}"
        case .smsMessageOutgoingBold: return "\u{fb5b}"
        case .smsMessageOutgoingFilled: return "\u{fb5c}"
        case .smsMessageOutgoingLight: return "\u{fb5d}"
        case .smsMessageOutgoingRegular: return "\u{fb5e}"
        case .smsMessageRegular: return "\u{fb5f}"
        case .smsMessageStartBold: return "\u{fb60}"
        case .smsMessageStartFilled: return "\u{fb61}"
        case .smsMessageStartLight: return "\u{fb62}"
        case .smsMessageStartRegular: return "\u{fb63}"
        case .smsOutgoingFilled: return "\u{fb64}"
        case .smsUnreadBold: return "\u{fb65}"
        case .smsUnreadLight: return "\u{fb66}"
        case .smsUnreadRegular: return "\u{fb67}"
        case .sortAscendingBold: return "\u{fb68}"
        case .sortAscendingLight: return "\u{fb69}"
        case .sortAscendingRegular: return "\u{fb6a}"
        case .sortDescendingBold: return "\u{fb6b}"
        case .sortDescendingLight: return "\u{fb6c}"
        case .sortDescendingRegular: return "\u{fb6d}"
        case .soundDefaultBold: return "\u{fb6e}"
        case .soundDefaultLight: return "\u{fb6f}"
        case .soundDefaultRegular: return "\u{fb70}"
        case .sparkleBold: return "\u{fb71}"
        case .sparkleFilled: return "\u{fb72}"
        case .sparkleLight: return "\u{fb73}"
        case .sparkleRegular: return "\u{fb74}"
        case .speakerBold: return "\u{fb75}"
        case .speakerDisconnectedBold: return "\u{fb76}"
        case .speakerDisconnectedFilled: return "\u{fb77}"
        case .speakerDisconnectedLight: return "\u{fb78}"
        case .speakerDisconnectedRegular: return "\u{fb79}"
        case .speakerFilled: return "\u{fb7a}"
        case .speakerLight: return "\u{fb7b}"
        case .speakerMutedBold: return "\u{fb7c}"
        case .speakerMutedFilled: return "\u{fb7d}"
        case .speakerMutedLight: return "\u{fb7e}"
        case .speakerMutedRegular: return "\u{fb7f}"
        case .speakerOffBold: return "\u{fb80}"
        case .speakerOffFilled: return "\u{fb81}"
        case .speakerOffLight: return "\u{fb82}"
        case .speakerOffRegular: return "\u{fb83}"
        case .speakerOnBold: return "\u{fb84}"
        case .speakerOnLight: return "\u{fb85}"
        case .speakerOnRegular: return "\u{fb86}"
        case .speakerRegular: return "\u{fb87}"
        case .speakerTurnDownBold: return "\u{fb88}"
        case .speakerTurnDownFilled: return "\u{fb89}"
        case .speakerTurnDownLight: return "\u{fb8a}"
        case .speakerTurnDownRegular: return "\u{fb8b}"
        case .speakerTurnUpBold: return "\u{fb8c}"
        case .speakerTurnUpFilled: return "\u{fb8d}"
        case .speakerTurnUpLight: return "\u{fb8e}"
        case .speakerTurnUpRegular: return "\u{fb8f}"
        case .speedDialBold: return "\u{fb90}"
        case .speedDialFilled: return "\u{fb91}"
        case .speedDialLight: return "\u{fb92}"
        case .speedDialRegular: return "\u{fb93}"
        case .spellCheckerBold: return "\u{fb94}"
        case .spellCheckerLight: return "\u{fb95}"
        case .spellCheckerRegular: return "\u{fb96}"
        case .splitViewBold: return "\u{fb97}"
        case .splitViewLight: return "\u{fb98}"
        case .splitViewRegular: return "\u{fb99}"
        case .stackedAreaChartBold: return "\u{fb9a}"
        case .stackedAreaChartFilled: return "\u{fb9b}"
        case .stackedAreaChartFullBold: return "\u{fb9c}"
        case .stackedAreaChartFullFilled: return "\u{fb9d}"
        case .stackedAreaChartFullLight: return "\u{fb9e}"
        case .stackedAreaChartFullRegular: return "\u{fb9f}"
        case .stackedAreaChartLight: return "\u{fba0}"
        case .stackedAreaChartRegular: return "\u{fba1}"
        case .stackedBarChartBold: return "\u{fba2}"
        case .stackedBarChartFilled: return "\u{fba3}"
        case .stackedBarChartFullBold: return "\u{fba4}"
        case .stackedBarChartFullFilled: return "\u{fba5}"
        case .stackedBarChartFullLight: return "\u{fba6}"
        case .stackedBarChartFullRegular: return "\u{fba7}"
        case .stackedBarChartLight: return "\u{fba8}"
        case .stackedBarChartRegular: return "\u{fba9}"
        case .startChatBold: return "\u{fbaa}"
        case .startChatLight: return "\u{fbab}"
        case .startChatRegular: return "\u{fbac}"
        case .stethoscopeBold: return "\u{fbad}"
        case .stethoscopeLight: return "\u{fbae}"
        case .stethoscopeRegular: return "\u{fbaf}"
        case .stickersBold: return "\u{fbb0}"
        case .stickersLight: return "\u{fbb1}"
        case .stickersRegular: return "\u{fbb2}"
        case .stickiesBold: return "\u{fbb3}"
        case .stickiesLight: return "\u{fbb4}"
        case .stickiesRegular: return "\u{fbb5}"
        case .stopBold: return "\u{fbb6}"
        case .stopCircleBold: return "\u{fbb7}"
        case .stopCircleFilled: return "\u{fbb8}"
        case .stopCircleLight: return "\u{fbb9}"
        case .stopCircleRegular: return "\u{fbba}"
        case .stopContentShareBold: return "\u{fbbb}"
        case .stopContentShareLight: return "\u{fbbc}"
        case .stopContentShareRegular: return "\u{fbbd}"
        case .stopFilled: return "\u{fbbe}"
        case .stopLight: return "\u{fbbf}"
        case .stopRegular: return "\u{fbc0}"
        case .storedInfoBold: return "\u{fbc1}"
        case .storedInfoFilled: return "\u{fbc2}"
        case .storedInfoLight: return "\u{fbc3}"
        case .storedInfoRegular: return "\u{fbc4}"
        case .streamingBold: return "\u{fbc5}"
        case .streamingLight: return "\u{fbc6}"
        case .streamingRegular: return "\u{fbc7}"
        case .strikethroughBold: return "\u{fbc8}"
        case .strikethroughFilled: return "\u{fbc9}"
        case .strikethroughLight: return "\u{fbca}"
        case .strikethroughRegular: return "\u{fbcb}"
        case .studioModeBold: return "\u{fbcc}"
        case .studioModeLight: return "\u{fbcd}"
        case .studioModeRegular: return "\u{fbce}"
        case .subscriptBold: return "\u{fbcf}"
        case .subscriptLight: return "\u{fbd0}"
        case .subscriptRegular: return "\u{fbd1}"
        case .summarizeAiBold: return "\u{fbd2}"
        case .summarizeAiLight: return "\u{fbd3}"
        case .summarizeAiRegular: return "\u{fbd4}"
        case .superscriptBold: return "\u{fbd5}"
        case .superscriptLight: return "\u{fbd6}"
        case .superscriptRegular: return "\u{fbd7}"
        case .surveyBold: return "\u{fbd8}"
        case .surveyFilled: return "\u{fbd9}"
        case .surveyLight: return "\u{fbda}"
        case .surveyRegular: return "\u{fbdb}"
        case .sxEightyCodecBold: return "\u{fbdc}"
        case .sxEightyCodecLight: return "\u{fbdd}"
        case .sxEightyCodecRegular: return "\u{fbde}"
        case .sxTenBold: return "\u{fbdf}"
        case .sxTenLight: return "\u{fbe0}"
        case .sxTenRegular: return "\u{fbe1}"
        case .sxTwentyBold: return "\u{fbe2}"
        case .sxTwentyLight: return "\u{fbe3}"
        case .sxTwentyRegular: return "\u{fbe4}"
        case .tableBold: return "\u{fbe5}"
        case .tableExtenderBold: return "\u{fbe6}"
        case .tableExtenderFilled: return "\u{fbe7}"
        case .tableExtenderLight: return "\u{fbe8}"
        case .tableExtenderRegular: return "\u{fbe9}"
        case .tableLight: return "\u{fbea}"
        case .tableRegular: return "\u{fbeb}"
        case .tabletBold: return "\u{fbec}"
        case .tabletLight: return "\u{fbed}"
        case .tabletRegular: return "\u{fbee}"
        case .tabsBold: return "\u{fbef}"
        case .tabsLight: return "\u{fbf0}"
        case .tabsRegular: return "\u{fbf1}"
        case .tagBold: return "\u{fbf2}"
        case .tagLight: return "\u{fbf3}"
        case .tagRegular: return "\u{fbf4}"
        case .tapBold: return "\u{fbf5}"
        case .tapFilled: return "\u{fbf6}"
        case .tapLight: return "\u{fbf7}"
        case .tapRegular: return "\u{fbf8}"
        case .telepresenceAlertBold: return "\u{fbf9}"
        case .telepresenceAlertLight: return "\u{fbfa}"
        case .telepresenceAlertMutedBold: return "\u{fbfb}"
        case .telepresenceAlertMutedLight: return "\u{fbfc}"
        case .telepresenceAlertMutedRegular: return "\u{fbfd}"
        case .telepresenceAlertRegular: return "\u{fbfe}"
        case .telepresenceBold: return "\u{fbff}"
        case .telepresenceIxFiveThousandBold: return "\u{fc00}"
        case .telepresenceIxFiveThousandLight: return "\u{fc01}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc02}"
        case .telepresenceLight: return "\u{fc03}"
        case .telepresenceMutedBold: return "\u{fc04}"
        case .telepresenceMutedLight: return "\u{fc05}"
        case .telepresenceMutedRegular: return "\u{fc06}"
        case .telepresencePrivateBold: return "\u{fc07}"
        case .telepresencePrivateLight: return "\u{fc08}"
        case .telepresencePrivateRegular: return "\u{fc09}"
        case .telepresenceRegular: return "\u{fc0a}"
        case .temperatureBold: return "\u{fc0b}"
        case .temperatureLight: return "\u{fc0c}"
        case .temperatureRegular: return "\u{fc0d}"
        case .testTubeBold: return "\u{fc0e}"
        case .testTubeFilled: return "\u{fc0f}"
        case .testTubeLight: return "\u{fc10}"
        case .testTubeRegular: return "\u{fc11}"
        case .textAlignCenterBold: return "\u{fc12}"
        case .textAlignCenterFilled: return "\u{fc13}"
        case .textAlignCenterLight: return "\u{fc14}"
        case .textAlignCenterRegular: return "\u{fc15}"
        case .textAlignLeftBold: return "\u{fc16}"
        case .textAlignLeftFilled: return "\u{fc17}"
        case .textAlignLeftLight: return "\u{fc18}"
        case .textAlignLeftRegular: return "\u{fc19}"
        case .textAlignRightBold: return "\u{fc1a}"
        case .textAlignRightFilled: return "\u{fc1b}"
        case .textAlignRightLight: return "\u{fc1c}"
        case .textAlignRightRegular: return "\u{fc1d}"
        case .textBold: return "\u{fc1e}"
        case .textBoxCursorLight: return "\u{fc1f}"
        case .textCodeBlockBold: return "\u{fc20}"
        case .textCodeBlockLight: return "\u{fc21}"
        case .textCodeBlockRegular: return "\u{fc22}"
        case .textHighlightBold: return "\u{fc23}"
        case .textHighlightFilled: return "\u{fc24}"
        case .textHighlightLight: return "\u{fc25}"
        case .textHighlightRegular: return "\u{fc26}"
        case .textLight: return "\u{fc27}"
        case .textRegular: return "\u{fc28}"
        case .textShortBold: return "\u{fc29}"
        case .textShortLight: return "\u{fc2a}"
        case .textShortRegular: return "\u{fc2b}"
        case .threeColumnBold: return "\u{fc2c}"
        case .threeColumnLight: return "\u{fc2d}"
        case .threeColumnRegular: return "\u{fc2e}"
        case .threeDObjectBold: return "\u{fc2f}"
        case .threeDObjectLight: return "\u{fc30}"
        case .threeDObjectRegular: return "\u{fc31}"
        case .timeExclusionBold: return "\u{fc32}"
        case .timeExclusionLight: return "\u{fc33}"
        case .timeExclusionRegular: return "\u{fc34}"
        case .timezoneBold: return "\u{fc35}"
        case .timezoneFilled: return "\u{fc36}"
        case .timezoneLight: return "\u{fc37}"
        case .timezoneRegular: return "\u{fc38}"
        case .tooFastBold: return "\u{fc39}"
        case .tooFastLight: return "\u{fc3a}"
        case .tooFastRegular: return "\u{fc3b}"
        case .tooSlowBold: return "\u{fc3c}"
        case .tooSlowLight: return "\u{fc3d}"
        case .tooSlowRegular: return "\u{fc3e}"
        case .toolsBold: return "\u{fc3f}"
        case .toolsFilled: return "\u{fc40}"
        case .toolsLight: return "\u{fc41}"
        case .toolsRegular: return "\u{fc42}"
        case .touchTenBold: return "\u{fc43}"
        case .touchTenLight: return "\u{fc44}"
        case .touchTenRegular: return "\u{fc45}"
        case .transcriptBold: return "\u{fc46}"
        case .transcriptFilled: return "\u{fc47}"
        case .transcriptLight: return "\u{fc48}"
        case .transcriptRegular: return "\u{fc49}"
        case .translateBold: return "\u{fc4a}"
        case .translateLight: return "\u{fc4b}"
        case .translateRegular: return "\u{fc4c}"
        case .translateUndoBold: return "\u{fc4d}"
        case .translateUndoLight: return "\u{fc4e}"
        case .translateUndoRegular: return "\u{fc4f}"
        case .trendingBold: return "\u{fc50}"
        case .trendingDownBold: return "\u{fc51}"
        case .trendingDownFilled: return "\u{fc52}"
        case .trendingDownLight: return "\u{fc53}"
        case .trendingDownRegular: return "\u{fc54}"
        case .trendingFilled: return "\u{fc55}"
        case .trendingLight: return "\u{fc56}"
        case .trendingRegular: return "\u{fc57}"
        case .trimBold: return "\u{fc58}"
        case .trimLight: return "\u{fc59}"
        case .trimRegular: return "\u{fc5a}"
        case .twoColumnBold: return "\u{fc5b}"
        case .twoColumnLight: return "\u{fc5c}"
        case .twoColumnRegular: return "\u{fc5d}"
        case .twoWayVoiceStreamBold: return "\u{fc5e}"
        case .twoWayVoiceStreamFilled: return "\u{fc5f}"
        case .twoWayVoiceStreamLight: return "\u{fc60}"
        case .twoWayVoiceStreamRegular: return "\u{fc61}"
        case .ucmCloudBold: return "\u{fc62}"
        case .ucmCloudLight: return "\u{fc63}"
        case .ucmCloudRegular: return "\u{fc64}"
        case .unblockBold: return "\u{fc65}"
        case .unblockFilled: return "\u{fc66}"
        case .unblockLight: return "\u{fc67}"
        case .unblockRegular: return "\u{fc68}"
        case .underlineBold: return "\u{fc69}"
        case .underlineFilled: return "\u{fc6a}"
        case .underlineLight: return "\u{fc6b}"
        case .underlineRegular: return "\u{fc6c}"
        case .undoBold: return "\u{fc6d}"
        case .undoLight: return "\u{fc6e}"
        case .undoRegular: return "\u{fc6f}"
        case .unlinkBold: return "\u{fc70}"
        case .unlinkLight: return "\u{fc71}"
        case .unlinkRegular: return "\u{fc72}"
        case .unreadBold: return "\u{fc73}"
        case .unreadFilled: return "\u{fc74}"
        case .unreadLight: return "\u{fc75}"
        case .unreadRegular: return "\u{fc76}"
        case .unsecureUnlockedBold: return "\u{fc77}"
        case .unsecureUnlockedFilled: return "\u{fc78}"
        case .unsecureUnlockedLight: return "\u{fc79}"
        case .unsecureUnlockedRegular: return "\u{fc7a}"
        case .unsortedBold: return "\u{fc7b}"
        case .unsortedLight: return "\u{fc7c}"
        case .unsortedRegular: return "\u{fc7d}"
        case .updateFileShareBold: return "\u{fc7e}"
        case .updateFileShareLight: return "\u{fc7f}"
        case .updateFileShareRegular: return "\u{fc80}"
        case .uploadBold: return "\u{fc81}"
        case .uploadImageBold: return "\u{fc82}"
        case .uploadImageLight: return "\u{fc83}"
        case .uploadImageRegular: return "\u{fc84}"
        case .uploadLight: return "\u{fc85}"
        case .uploadRegular: return "\u{fc86}"
        case .urgentVoicemailBold: return "\u{fc87}"
        case .urgentVoicemailFilled: return "\u{fc88}"
        case .usbBold: return "\u{fc89}"
        case .usbHeadsetBold: return "\u{fc8a}"
        case .usbHeadsetLight: return "\u{fc8b}"
        case .usbHeadsetMutedBold: return "\u{fc8c}"
        case .usbHeadsetMutedLight: return "\u{fc8d}"
        case .usbHeadsetMutedRegular: return "\u{fc8e}"
        case .usbHeadsetRegular: return "\u{fc8f}"
        case .usbLight: return "\u{fc90}"
        case .usbRegular: return "\u{fc91}"
        case .userBold: return "\u{fc92}"
        case .userDeactivateBold: return "\u{fc93}"
        case .userDeactivateLight: return "\u{fc94}"
        case .userDeactivateRegular: return "\u{fc95}"
        case .userFilled: return "\u{fc96}"
        case .userLight: return "\u{fc97}"
        case .userRegular: return "\u{fc98}"
        case .userSecurityStatusBold: return "\u{fc99}"
        case .userSecurityStatusFilled: return "\u{fc9a}"
        case .userSecurityStatusLight: return "\u{fc9b}"
        case .userSecurityStatusRegular: return "\u{fc9c}"
        case .videoBlurBold: return "\u{fc9d}"
        case .videoBlurFilled: return "\u{fc9e}"
        case .videoBlurLight: return "\u{fc9f}"
        case .videoBlurRegular: return "\u{fca0}"
        case .videoBold: return "\u{fca1}"
        case .videoEffectBold: return "\u{fca2}"
        case .videoEffectFilled: return "\u{fca3}"
        case .videoEffectLight: return "\u{fca4}"
        case .videoEffectRegular: return "\u{fca5}"
        case .videoFilled: return "\u{fca6}"
        case .videoLayoutBold: return "\u{fca7}"
        case .videoLayoutCustomBold: return "\u{fca8}"
        case .videoLayoutCustomFilled: return "\u{fca9}"
        case .videoLayoutCustomLight: return "\u{fcaa}"
        case .videoLayoutCustomRegular: return "\u{fcab}"
        case .videoLayoutEqualBold: return "\u{fcac}"
        case .videoLayoutEqualDualBold: return "\u{fcad}"
        case .videoLayoutEqualDualLight: return "\u{fcae}"
        case .videoLayoutEqualDualRegular: return "\u{fcaf}"
        case .videoLayoutEqualFilled: return "\u{fcb0}"
        case .videoLayoutEqualLight: return "\u{fcb1}"
        case .videoLayoutEqualRegular: return "\u{fcb2}"
        case .videoLayoutFilled: return "\u{fcb3}"
        case .videoLayoutLight: return "\u{fcb4}"
        case .videoLayoutOverlayBold: return "\u{fcb5}"
        case .videoLayoutOverlayFilled: return "\u{fcb6}"
        case .videoLayoutOverlayLight: return "\u{fcb7}"
        case .videoLayoutOverlayRegular: return "\u{fcb8}"
        case .videoLayoutPresentationBold: return "\u{fcb9}"
        case .videoLayoutPresentationFilled: return "\u{fcba}"
        case .videoLayoutPresentationLight: return "\u{fcbb}"
        case .videoLayoutPresentationRegular: return "\u{fcbc}"
        case .videoLayoutPresenterDominantBold: return "\u{fcbd}"
        case .videoLayoutPresenterDominantLight: return "\u{fcbe}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcbf}"
        case .videoLayoutProminentBold: return "\u{fcc0}"
        case .videoLayoutProminentFilled: return "\u{fcc1}"
        case .videoLayoutProminentLight: return "\u{fcc2}"
        case .videoLayoutProminentRegular: return "\u{fcc3}"
        case .videoLayoutRegular: return "\u{fcc4}"
        case .videoLayoutShareDominantBold: return "\u{fcc5}"
        case .videoLayoutShareDominantLight: return "\u{fcc6}"
        case .videoLayoutShareDominantRegular: return "\u{fcc7}"
        case .videoLayoutSingleBold: return "\u{fcc8}"
        case .videoLayoutSingleFilled: return "\u{fcc9}"
        case .videoLayoutSingleLight: return "\u{fcca}"
        case .videoLayoutSingleRegular: return "\u{fccb}"
        case .videoLayoutSpeakerBold: return "\u{fccc}"
        case .videoLayoutSpeakerFilled: return "\u{fccd}"
        case .videoLayoutSpeakerLight: return "\u{fcce}"
        case .videoLayoutSpeakerRegular: return "\u{fccf}"
        case .videoLayoutStackBold: return "\u{fcd0}"
        case .videoLayoutStackFilled: return "\u{fcd1}"
        case .videoLayoutStackLight: return "\u{fcd2}"
        case .videoLayoutStackRegular: return "\u{fcd3}"
        case .videoLayoutVideoDominantBold: return "\u{fcd4}"
        case .videoLayoutVideoDominantFilled: return "\u{fcd5}"
        case .videoLayoutVideoDominantLight: return "\u{fcd6}"
        case .videoLayoutVideoDominantRegular: return "\u{fcd7}"
        case .videoLight: return "\u{fcd8}"
        case .videoPlusBold: return "\u{fcd9}"
        case .videoPlusFilled: return "\u{fcda}"
        case .videoPlusLight: return "\u{fcdb}"
        case .videoPlusRegular: return "\u{fcdc}"
        case .videoRegular: return "\u{fcdd}"
        case .videoSpeakerTrackBold: return "\u{fcde}"
        case .videoSpeakerTrackFilled: return "\u{fcdf}"
        case .videoSpeakerTrackLight: return "\u{fce0}"
        case .videoSpeakerTrackRegular: return "\u{fce1}"
        case .viewAllBold: return "\u{fce2}"
        case .viewAllLight: return "\u{fce3}"
        case .viewAllRegular: return "\u{fce4}"
        case .viewListBold: return "\u{fce5}"
        case .viewListFilled: return "\u{fce6}"
        case .viewListLight: return "\u{fce7}"
        case .viewListRegular: return "\u{fce8}"
        case .viewStackedBold: return "\u{fce9}"
        case .viewStackedFilled: return "\u{fcea}"
        case .viewStackedLight: return "\u{fceb}"
        case .viewStackedRegular: return "\u{fcec}"
        case .viewThumbnailBold: return "\u{fced}"
        case .viewThumbnailFilled: return "\u{fcee}"
        case .viewThumbnailLight: return "\u{fcef}"
        case .viewThumbnailRegular: return "\u{fcf0}"
        case .visionproBold: return "\u{fcf1}"
        case .visionproFilled: return "\u{fcf2}"
        case .visionproLight: return "\u{fcf3}"
        case .visionproMoveCallInBold: return "\u{fcf4}"
        case .visionproMoveCallInFilled: return "\u{fcf5}"
        case .visionproMoveCallInLight: return "\u{fcf6}"
        case .visionproMoveCallInOutBold: return "\u{fcf7}"
        case .visionproMoveCallInOutFilled: return "\u{fcf8}"
        case .visionproMoveCallInOutLight: return "\u{fcf9}"
        case .visionproMoveCallInOutRegular: return "\u{fcfa}"
        case .visionproMoveCallInRegular: return "\u{fcfb}"
        case .visionproMoveCallOutBold: return "\u{fcfc}"
        case .visionproMoveCallOutFilled: return "\u{fcfd}"
        case .visionproMoveCallOutLight: return "\u{fcfe}"
        case .visionproMoveCallOutRegular: return "\u{fcff}"
        case .visionproRegular: return "\u{fd00}"
        case .voicemailBold: return "\u{fd01}"
        case .voicemailFilled: return "\u{fd02}"
        case .voicemailLight: return "\u{fd03}"
        case .voicemailRegular: return "\u{fd04}"
        case .vpnBold: return "\u{fd05}"
        case .vpnFilled: return "\u{fd06}"
        case .vpnLight: return "\u{fd07}"
        case .vpnRegular: return "\u{fd08}"
        case .vscBold: return "\u{fd09}"
        case .vscLight: return "\u{fd0a}"
        case .vscRegular: return "\u{fd0b}"
        case .waffleMenuBold: return "\u{fd0c}"
        case .waffleMenuLight: return "\u{fd0d}"
        case .waffleMenuRegular: return "\u{fd0e}"
        case .waitingRoomBold: return "\u{fd0f}"
        case .waitingRoomFilled: return "\u{fd10}"
        case .waitingRoomLight: return "\u{fd11}"
        case .waitingRoomRegular: return "\u{fd12}"
        case .wallpaperBold: return "\u{fd13}"
        case .wallpaperLight: return "\u{fd14}"
        case .wallpaperRegular: return "\u{fd15}"
        case .warningBadgeFilled: return "\u{fd16}"
        case .warningBold: return "\u{fd17}"
        case .warningFilled: return "\u{fd18}"
        case .warningLight: return "\u{fd19}"
        case .warningRegular: return "\u{fd1a}"
        case .webexBoardBold: return "\u{fd1b}"
        case .webexBoardLight: return "\u{fd1c}"
        case .webexBoardRegular: return "\u{fd1d}"
        case .webexCodecPlusBold: return "\u{fd1e}"
        case .webexCodecPlusLight: return "\u{fd1f}"
        case .webexCodecPlusRegular: return "\u{fd20}"
        case .webexDeskCameraBold: return "\u{fd21}"
        case .webexDeskCameraLight: return "\u{fd22}"
        case .webexDeskCameraRegular: return "\u{fd23}"
        case .webexHelixBold: return "\u{fd24}"
        case .webexHelixLight: return "\u{fd25}"
        case .webexHelixRegular: return "\u{fd26}"
        case .webexMeetingsBold: return "\u{fd27}"
        case .webexMeetingsFilled: return "\u{fd28}"
        case .webexMeetingsLight: return "\u{fd29}"
        case .webexMeetingsRegular: return "\u{fd2a}"
        case .webexQuadCameraBold: return "\u{fd2b}"
        case .webexQuadCameraLight: return "\u{fd2c}"
        case .webexQuadCameraRegular: return "\u{fd2d}"
        case .webexRoomKitBold: return "\u{fd2e}"
        case .webexRoomKitLight: return "\u{fd2f}"
        case .webexRoomKitPlusBold: return "\u{fd30}"
        case .webexRoomKitPlusLight: return "\u{fd31}"
        case .webexRoomKitPlusRegular: return "\u{fd32}"
        case .webexRoomKitRegular: return "\u{fd33}"
        case .webexShareBold: return "\u{fd34}"
        case .webexShareLight: return "\u{fd35}"
        case .webexShareRegular: return "\u{fd36}"
        case .webexTeamsBold: return "\u{fd37}"
        case .webexTeamsFilled: return "\u{fd38}"
        case .webexTeamsLight: return "\u{fd39}"
        case .webexTeamsNewBold: return "\u{fd3a}"
        case .webexTeamsNewFilled: return "\u{fd3b}"
        case .webexTeamsNewLight: return "\u{fd3c}"
        case .webexTeamsNewRegular: return "\u{fd3d}"
        case .webexTeamsRegular: return "\u{fd3e}"
        case .webexTeamsRemoveBold: return "\u{fd3f}"
        case .webexTeamsRemoveLight: return "\u{fd40}"
        case .webexTeamsRemoveRegular: return "\u{fd41}"
        case .webhookBold: return "\u{fd42}"
        case .webhookLight: return "\u{fd43}"
        case .webhookRegular: return "\u{fd44}"
        case .webinarBold: return "\u{fd45}"
        case .webinarFilled: return "\u{fd46}"
        case .webinarLight: return "\u{fd47}"
        case .webinarRegular: return "\u{fd48}"
        case .weeklyRecurringScheduleBold: return "\u{fd49}"
        case .weeklyRecurringScheduleLight: return "\u{fd4a}"
        case .weeklyRecurringScheduleRegular: return "\u{fd4b}"
        case .whisperAnnouncementBold: return "\u{fd4c}"
        case .whisperAnnouncementFilled: return "\u{fd4d}"
        case .whisperAnnouncementLight: return "\u{fd4e}"
        case .whisperAnnouncementRegular: return "\u{fd4f}"
        case .whisperCoachBold: return "\u{fd50}"
        case .whisperCoachFilled: return "\u{fd51}"
        case .whisperCoachLight: return "\u{fd52}"
        case .whisperCoachRegular: return "\u{fd53}"
        case .whiteboardBold: return "\u{fd54}"
        case .whiteboardContentBold: return "\u{fd55}"
        case .whiteboardContentFilled: return "\u{fd56}"
        case .whiteboardContentLight: return "\u{fd57}"
        case .whiteboardContentRegular: return "\u{fd58}"
        case .whiteboardFilled: return "\u{fd59}"
        case .whiteboardLight: return "\u{fd5a}"
        case .whiteboardRegular: return "\u{fd5b}"
        case .widgetBold: return "\u{fd5c}"
        case .widgetFilled: return "\u{fd5d}"
        case .widgetLight: return "\u{fd5e}"
        case .widgetRegular: return "\u{fd5f}"
        case .wifiBold: return "\u{fd60}"
        case .wifiErrorBold: return "\u{fd61}"
        case .wifiErrorLight: return "\u{fd62}"
        case .wifiErrorRegular: return "\u{fd63}"
        case .wifiLight: return "\u{fd64}"
        case .wifiRegular: return "\u{fd65}"
        case .wifiSignalGoodBold: return "\u{fd66}"
        case .wifiSignalGoodLight: return "\u{fd67}"
        case .wifiSignalGoodRegular: return "\u{fd68}"
        case .wifiSignalPoorBold: return "\u{fd69}"
        case .wifiSignalPoorLight: return "\u{fd6a}"
        case .wifiSignalPoorRegular: return "\u{fd6b}"
        case .wifiSignalUnstableBold: return "\u{fd6c}"
        case .wifiSignalUnstableLight: return "\u{fd6d}"
        case .wifiSignalUnstableRegular: return "\u{fd6e}"
        case .windowCornerScrubBold: return "\u{fd6f}"
        case .windowCornerScrubLight: return "\u{fd70}"
        case .windowCornerScrubRegular: return "\u{fd71}"
        case .windowRightCornerScrubBold: return "\u{fd72}"
        case .windowRightCornerScrubLight: return "\u{fd73}"
        case .windowRightCornerScrubRegular: return "\u{fd74}"
        case .windowVerticalScrubBold: return "\u{fd75}"
        case .windowVerticalScrubLight: return "\u{fd76}"
        case .windowVerticalScrubRegular: return "\u{fd77}"
        case .workflowDeploymentsBold: return "\u{fd78}"
        case .workflowDeploymentsFilled: return "\u{fd79}"
        case .workflowDeploymentsLight: return "\u{fd7a}"
        case .workflowDeploymentsRegular: return "\u{fd7b}"
        case .workphoneBold: return "\u{fd7c}"
        case .workphoneLight: return "\u{fd7d}"
        case .workphoneRegular: return "\u{fd7e}"
        case .zoomInBold: return "\u{fd7f}"
        case .zoomInLight: return "\u{fd80}"
        case .zoomInRegular: return "\u{fd81}"
        case .zoomOutBold: return "\u{fd82}"
        case .zoomOutLight: return "\u{fd83}"
        case .zoomOutRegular: return "\u{fd84}"
