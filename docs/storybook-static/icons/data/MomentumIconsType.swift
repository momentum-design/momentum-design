...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .launchFilled: return "\u{f70e}"
        case .launchLight: return "\u{f70f}"
        case .launchRegular: return "\u{f710}"
        case .layoutSideBySideVerticalBold: return "\u{f711}"
        case .layoutSideBySideVerticalFilled: return "\u{f712}"
        case .layoutSideBySideVerticalLight: return "\u{f713}"
        case .layoutSideBySideVerticalRegular: return "\u{f714}"
        case .leaveBreakoutSessionBold: return "\u{f715}"
        case .leaveBreakoutSessionLight: return "\u{f716}"
        case .leaveBreakoutSessionRegular: return "\u{f717}"
        case .leaveDeviceBold: return "\u{f718}"
        case .leaveDeviceLight: return "\u{f719}"
        case .leaveDeviceRegular: return "\u{f71a}"
        case .likeBold: return "\u{f71b}"
        case .likeFilled: return "\u{f71c}"
        case .likeLight: return "\u{f71d}"
        case .likeRegular: return "\u{f71e}"
        case .linkBold: return "\u{f71f}"
        case .linkLight: return "\u{f720}"
        case .linkRegular: return "\u{f721}"
        case .listBulletedBold: return "\u{f722}"
        case .listBulletedLight: return "\u{f723}"
        case .listBulletedRegular: return "\u{f724}"
        case .listMenuBold: return "\u{f725}"
        case .listMenuLight: return "\u{f726}"
        case .listMenuRegular: return "\u{f727}"
        case .listNumberedBold: return "\u{f728}"
        case .listNumberedLight: return "\u{f729}"
        case .listNumberedRegular: return "\u{f72a}"
        case .liveBold: return "\u{f72b}"
        case .liveFilled: return "\u{f72c}"
        case .liveLight: return "\u{f72d}"
        case .liveRegular: return "\u{f72e}"
        case .locationBold: return "\u{f72f}"
        case .locationFilled: return "\u{f730}"
        case .locationLight: return "\u{f731}"
        case .locationRegular: return "\u{f732}"
        case .longTextBoxBold: return "\u{f733}"
        case .longTextBoxLight: return "\u{f734}"
        case .longTextBoxRegular: return "\u{f735}"
        case .lowerHandBold: return "\u{f736}"
        case .lowerHandLight: return "\u{f737}"
        case .lowerHandRegular: return "\u{f738}"
        case .magicPenBold: return "\u{f739}"
        case .magicPenFilled: return "\u{f73a}"
        case .magicPenLight: return "\u{f73b}"
        case .magicPenRegular: return "\u{f73c}"
        case .markAsUnreadBold: return "\u{f73d}"
        case .markAsUnreadFilled: return "\u{f73e}"
        case .markAsUnreadLight: return "\u{f73f}"
        case .markAsUnreadRegular: return "\u{f740}"
        case .markdownBold: return "\u{f741}"
        case .markdownFilled: return "\u{f742}"
        case .markdownLight: return "\u{f743}"
        case .markdownRegular: return "\u{f744}"
        case .markerBold: return "\u{f745}"
        case .markerFilled: return "\u{f746}"
        case .markerLight: return "\u{f747}"
        case .markerRegular: return "\u{f748}"
        case .maximizeBold: return "\u{f749}"
        case .maximizeLight: return "\u{f74a}"
        case .maximizeRegular: return "\u{f74b}"
        case .mediaPlayerBold: return "\u{f74c}"
        case .mediaPlayerLight: return "\u{f74d}"
        case .mediaPlayerRegular: return "\u{f74e}"
        case .mediaQualityGoodBold: return "\u{f74f}"
        case .mediaQualityGoodFilled: return "\u{f750}"
        case .mediaQualityGoodLight: return "\u{f751}"
        case .mediaQualityGoodRegular: return "\u{f752}"
        case .mediaQualityPoorBold: return "\u{f753}"
        case .mediaQualityPoorColoredBold: return "\u{f754}"
        case .mediaQualityPoorFilled: return "\u{f755}"
        case .mediaQualityPoorLight: return "\u{f756}"
        case .mediaQualityPoorRegular: return "\u{f757}"
        case .mediaQualityUnstableBold: return "\u{f758}"
        case .mediaQualityUnstableColoredBold: return "\u{f759}"
        case .mediaQualityUnstableFilled: return "\u{f75a}"
        case .mediaQualityUnstableLight: return "\u{f75b}"
        case .mediaQualityUnstableRegular: return "\u{f75c}"
        case .meetBold: return "\u{f75d}"
        case .meetEndBold: return "\u{f75e}"
        case .meetEndLight: return "\u{f75f}"
        case .meetEndRegular: return "\u{f760}"
        case .meetFilled: return "\u{f761}"
        case .meetLight: return "\u{f762}"
        case .meetRegular: return "\u{f763}"
        case .meetingSummaryBold: return "\u{f764}"
        case .meetingSummaryFilled: return "\u{f765}"
        case .meetingSummaryLight: return "\u{f766}"
        case .meetingSummaryRegular: return "\u{f767}"
        case .meetingsBold: return "\u{f768}"
        case .meetingsFilled: return "\u{f769}"
        case .meetingsFocusMonthBold: return "\u{f76a}"
        case .meetingsFocusMonthLight: return "\u{f76b}"
        case .meetingsFocusMonthRegular: return "\u{f76c}"
        case .meetingsFocusOneDayBold: return "\u{f76d}"
        case .meetingsFocusOneDayLight: return "\u{f76e}"
        case .meetingsFocusOneDayRegular: return "\u{f76f}"
        case .meetingsFocusThreeDayBold: return "\u{f770}"
        case .meetingsFocusThreeDayLight: return "\u{f771}"
        case .meetingsFocusThreeDayRegular: return "\u{f772}"
        case .meetingsFocusUpcomingBold: return "\u{f773}"
        case .meetingsFocusUpcomingLight: return "\u{f774}"
        case .meetingsFocusUpcomingRegular: return "\u{f775}"
        case .meetingsLight: return "\u{f776}"
        case .meetingsPresenceBadgeFilled: return "\u{f777}"
        case .meetingsPresenceBold: return "\u{f778}"
        case .meetingsPresenceFilled: return "\u{f779}"
        case .meetingsPresenceLight: return "\u{f77a}"
        case .meetingsPresenceRegular: return "\u{f77b}"
        case .meetingsRegular: return "\u{f77c}"
        case .meetingsTeamBold: return "\u{f77d}"
        case .meetingsTeamFilled: return "\u{f77e}"
        case .meetingsTeamLight: return "\u{f77f}"
        case .meetingsTeamNewBold: return "\u{f780}"
        case .meetingsTeamNewLight: return "\u{f781}"
        case .meetingsTeamNewRegular: return "\u{f782}"
        case .meetingsTeamRegular: return "\u{f783}"
        case .mentionBold: return "\u{f784}"
        case .mentionFilled: return "\u{f785}"
        case .mentionLight: return "\u{f786}"
        case .mentionRegular: return "\u{f787}"
        case .messageQueingBold: return "\u{f788}"
        case .messageQueingLight: return "\u{f789}"
        case .messageQueingRegular: return "\u{f78a}"
        case .microphoneBold: return "\u{f78b}"
        case .microphoneFilled: return "\u{f78c}"
        case .microphoneHardMutedBold: return "\u{f78d}"
        case .microphoneHardMutedCircleFilled: return "\u{f78e}"
        case .microphoneHardMutedLight: return "\u{f78f}"
        case .microphoneHardMutedRegular: return "\u{f790}"
        case .microphoneLight: return "\u{f791}"
        case .microphoneMusicModeBold: return "\u{f792}"
        case .microphoneMusicModeLight: return "\u{f793}"
        case .microphoneMusicModeOnBold: return "\u{f794}"
        case .microphoneMusicModeOnLight: return "\u{f795}"
        case .microphoneMusicModeOnRegular: return "\u{f796}"
        case .microphoneMusicModeRegular: return "\u{f797}"
        case .microphoneMutedBold: return "\u{f798}"
        case .microphoneMutedCircleFilled: return "\u{f799}"
        case .microphoneMutedFilled: return "\u{f79a}"
        case .microphoneMutedLight: return "\u{f79b}"
        case .microphoneMutedRegular: return "\u{f79c}"
        case .microphoneOnBold: return "\u{f79d}"
        case .microphoneOnLight: return "\u{f79e}"
        case .microphoneOnRegular: return "\u{f79f}"
        case .microphoneOptAllBold: return "\u{f7a0}"
        case .microphoneOptAllLight: return "\u{f7a1}"
        case .microphoneOptAllMutedBold: return "\u{f7a2}"
        case .microphoneOptAllMutedLight: return "\u{f7a3}"
        case .microphoneOptAllMutedRegular: return "\u{f7a4}"
        case .microphoneOptAllOnBold: return "\u{f7a5}"
        case .microphoneOptAllOnLight: return "\u{f7a6}"
        case .microphoneOptAllOnRegular: return "\u{f7a7}"
        case .microphoneOptAllRegular: return "\u{f7a8}"
        case .microphoneOptMeBold: return "\u{f7a9}"
        case .microphoneOptMeLight: return "\u{f7aa}"
        case .microphoneOptMeMutedBold: return "\u{f7ab}"
        case .microphoneOptMeMutedLight: return "\u{f7ac}"
        case .microphoneOptMeMutedRegular: return "\u{f7ad}"
        case .microphoneOptMeOnBold: return "\u{f7ae}"
        case .microphoneOptMeOnLight: return "\u{f7af}"
        case .microphoneOptMeOnRegular: return "\u{f7b0}"
        case .microphoneOptMeRegular: return "\u{f7b1}"
        case .microphoneRegular: return "\u{f7b2}"
        case .mindMapBold: return "\u{f7b3}"
        case .mindMapLight: return "\u{f7b4}"
        case .mindMapRegular: return "\u{f7b5}"
        case .minimizeBold: return "\u{f7b6}"
        case .minimizeLight: return "\u{f7b7}"
        case .minimizeRegular: return "\u{f7b8}"
        case .minusBold: return "\u{f7b9}"
        case .minusFilled: return "\u{f7ba}"
        case .minusLight: return "\u{f7bb}"
        case .minusRegular: return "\u{f7bc}"
        case .mirrorBold: return "\u{f7bd}"
        case .mirrorFilled: return "\u{f7be}"
        case .mirrorLight: return "\u{f7bf}"
        case .mirrorRegular: return "\u{f7c0}"
        case .mmsFilled: return "\u{f7c1}"
        case .moderatorBold: return "\u{f7c2}"
        case .moderatorLight: return "\u{f7c3}"
        case .moderatorRegular: return "\u{f7c4}"
        case .monitoringBold: return "\u{f7c5}"
        case .monitoringLight: return "\u{f7c6}"
        case .monitoringRegular: return "\u{f7c7}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7c8}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7c9}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7ca}"
        case .moreAdrBold: return "\u{f7cb}"
        case .moreAdrLight: return "\u{f7cc}"
        case .moreAdrRegular: return "\u{f7cd}"
        case .moreBold: return "\u{f7ce}"
        case .moreCircleBold: return "\u{f7cf}"
        case .moreCircleFilled: return "\u{f7d0}"
        case .moreCircleLight: return "\u{f7d1}"
        case .moreCircleRegular: return "\u{f7d2}"
        case .moreLight: return "\u{f7d3}"
        case .moreRegular: return "\u{f7d4}"
        case .mouseCursorBold: return "\u{f7d5}"
        case .mouseCursorLight: return "\u{f7d6}"
        case .mouseCursorRegular: return "\u{f7d7}"
        case .moveCallInAdrBold: return "\u{f7d8}"
        case .moveCallInAdrLight: return "\u{f7d9}"
        case .moveCallInAdrRegular: return "\u{f7da}"
        case .moveCallInIphBold: return "\u{f7db}"
        case .moveCallInIphLight: return "\u{f7dc}"
        case .moveCallInIphRegular: return "\u{f7dd}"
        case .moveCallInLaptopBold: return "\u{f7de}"
        case .moveCallInLaptopLight: return "\u{f7df}"
        case .moveCallInLaptopRegular: return "\u{f7e0}"
        case .moveCallInOutAdrBold: return "\u{f7e1}"
        case .moveCallInOutAdrLight: return "\u{f7e2}"
        case .moveCallInOutAdrRegular: return "\u{f7e3}"
        case .moveCallInOutIphBold: return "\u{f7e4}"
        case .moveCallInOutIphLight: return "\u{f7e5}"
        case .moveCallInOutIphRegular: return "\u{f7e6}"
        case .moveCallInTabletBold: return "\u{f7e7}"
        case .moveCallInTabletLight: return "\u{f7e8}"
        case .moveCallInTabletRegular: return "\u{f7e9}"
        case .moveCallOutAdrBold: return "\u{f7ea}"
        case .moveCallOutAdrLight: return "\u{f7eb}"
        case .moveCallOutAdrRegular: return "\u{f7ec}"
        case .moveCallOutIphBold: return "\u{f7ed}"
        case .moveCallOutIphLight: return "\u{f7ee}"
        case .moveCallOutIphRegular: return "\u{f7ef}"
        case .moveCallOutLaptopBold: return "\u{f7f0}"
        case .moveCallOutLaptopLight: return "\u{f7f1}"
        case .moveCallOutLaptopRegular: return "\u{f7f2}"
        case .moveCallOutTabletBold: return "\u{f7f3}"
        case .moveCallOutTabletLight: return "\u{f7f4}"
        case .moveCallOutTabletRegular: return "\u{f7f5}"
        case .moveToScreenBold: return "\u{f7f6}"
        case .moveToScreenLight: return "\u{f7f7}"
        case .moveToScreenRegular: return "\u{f7f8}"
        case .multilineChartBold: return "\u{f7f9}"
        case .multilineChartFilled: return "\u{f7fa}"
        case .multilineChartLight: return "\u{f7fb}"
        case .multilineChartRegular: return "\u{f7fc}"
        case .multimediaBold: return "\u{f7fd}"
        case .multimediaFilled: return "\u{f7fe}"
        case .multimediaLight: return "\u{f7ff}"
        case .multimediaRegular: return "\u{f800}"
        case .multipledDevicesBold: return "\u{f801}"
        case .multipledDevicesLight: return "\u{f802}"
        case .multipledDevicesRegular: return "\u{f803}"
        case .musicModeCircleBold: return "\u{f804}"
        case .musicModeCircleFilled: return "\u{f805}"
        case .musicModeCircleLight: return "\u{f806}"
        case .musicModeCircleRegular: return "\u{f807}"
        case .musicNoteBold: return "\u{f808}"
        case .musicNoteFilled: return "\u{f809}"
        case .musicNoteLight: return "\u{f80a}"
        case .musicNoteRegular: return "\u{f80b}"
        case .muteOnEntryBold: return "\u{f80c}"
        case .muteOnEntryFilled: return "\u{f80d}"
        case .muteOnEntryLight: return "\u{f80e}"
        case .muteOnEntryRegular: return "\u{f80f}"
        case .networkSwitchBold: return "\u{f810}"
        case .networkSwitchFilled: return "\u{f811}"
        case .networkSwitchLight: return "\u{f812}"
        case .networkSwitchRegular: return "\u{f813}"
        case .newManagerBold: return "\u{f814}"
        case .newManagerFilled: return "\u{f815}"
        case .newManagerLight: return "\u{f816}"
        case .newManagerRegular: return "\u{f817}"
        case .newTitleBold: return "\u{f818}"
        case .newTitleLight: return "\u{f819}"
        case .newTitleRegular: return "\u{f81a}"
        case .newVoicemailBold: return "\u{f81b}"
        case .newVoicemailLight: return "\u{f81c}"
        case .newVoicemailRegular: return "\u{f81d}"
        case .newWhiteboardBold: return "\u{f81e}"
        case .newWhiteboardLight: return "\u{f81f}"
        case .newWhiteboardRegular: return "\u{f820}"
        case .nextBold: return "\u{f821}"
        case .nextLight: return "\u{f822}"
        case .nextRegular: return "\u{f823}"
        case .noDevicesBold: return "\u{f824}"
        case .noDevicesLight: return "\u{f825}"
        case .noDevicesRegular: return "\u{f826}"
        case .noiseDetectedCanceledFilled: return "\u{f827}"
        case .noiseDetectedFilled: return "\u{f828}"
        case .noiseNoneCanceledFilled: return "\u{f829}"
        case .noiseNoneFilled: return "\u{f82a}"
        case .noiseRemovalBold: return "\u{f82b}"
        case .noiseRemovalLight: return "\u{f82c}"
        case .noiseRemovalRegular: return "\u{f82d}"
        case .noteBold: return "\u{f82e}"
        case .noteFilled: return "\u{f82f}"
        case .noteLight: return "\u{f830}"
        case .notePptBold: return "\u{f831}"
        case .notePptLight: return "\u{f832}"
        case .notePptRegular: return "\u{f833}"
        case .noteRegular: return "\u{f834}"
        case .notesBold: return "\u{f835}"
        case .notesFilled: return "\u{f836}"
        case .notesLight: return "\u{f837}"
        case .notesRegular: return "\u{f838}"
        case .numberBold: return "\u{f839}"
        case .numberLight: return "\u{f83a}"
        case .numberRegular: return "\u{f83b}"
        case .oldRemoteBold: return "\u{f83c}"
        case .oldRemoteLight: return "\u{f83d}"
        case .oldRemoteRegular: return "\u{f83e}"
        case .oldTouchBold: return "\u{f83f}"
        case .oldTouchLight: return "\u{f840}"
        case .oldTouchRegular: return "\u{f841}"
        case .oneColumnBold: return "\u{f842}"
        case .oneColumnLight: return "\u{f843}"
        case .oneColumnRegular: return "\u{f844}"
        case .oneTimeBold: return "\u{f845}"
        case .oneTimeLight: return "\u{f846}"
        case .oneTimeRegular: return "\u{f847}"
        case .openInFolderBold: return "\u{f848}"
        case .openInFolderFilled: return "\u{f849}"
        case .openInFolderLight: return "\u{f84a}"
        case .openInFolderRegular: return "\u{f84b}"
        case .openPagesBold: return "\u{f84c}"
        case .openPagesLight: return "\u{f84d}"
        case .openPagesRegular: return "\u{f84e}"
        case .otherNumberBold: return "\u{f84f}"
        case .otherNumberFilled: return "\u{f850}"
        case .otherNumberLight: return "\u{f851}"
        case .otherNumberRegular: return "\u{f852}"
        case .otherNumberWarningBold: return "\u{f853}"
        case .otherNumberWarningLight: return "\u{f854}"
        case .otherNumberWarningRegular: return "\u{f855}"
        case .outgoingCallLegacyBold: return "\u{f856}"
        case .outgoingCallLegacyFilled: return "\u{f857}"
        case .outgoingCallLegacyLight: return "\u{f858}"
        case .outgoingCallLegacyRegular: return "\u{f859}"
        case .overflowLeftBold: return "\u{f85a}"
        case .overflowLeftLight: return "\u{f85b}"
        case .overflowLeftRegular: return "\u{f85c}"
        case .overflowRightBold: return "\u{f85d}"
        case .overflowRightLight: return "\u{f85e}"
        case .overflowRightRegular: return "\u{f85f}"
        case .pairedCameraBold: return "\u{f860}"
        case .pairedCameraLight: return "\u{f861}"
        case .pairedCameraRegular: return "\u{f862}"
        case .pairedDeviceBold: return "\u{f863}"
        case .pairedDeviceLight: return "\u{f864}"
        case .pairedDeviceRegular: return "\u{f865}"
        case .pairedHandsetBold: return "\u{f866}"
        case .pairedHandsetLight: return "\u{f867}"
        case .pairedHandsetRegular: return "\u{f868}"
        case .pairingBold: return "\u{f869}"
        case .pairingLight: return "\u{f86a}"
        case .pairingRegular: return "\u{f86b}"
        case .parenthesisBold: return "\u{f86c}"
        case .parenthesisFilled: return "\u{f86d}"
        case .parenthesisLight: return "\u{f86e}"
        case .parenthesisRegular: return "\u{f86f}"
        case .parkedBold: return "\u{f870}"
        case .parkedFilled: return "\u{f871}"
        case .parkedLight: return "\u{f872}"
        case .parkedRegular: return "\u{f873}"
        case .parseBold: return "\u{f874}"
        case .parseLight: return "\u{f875}"
        case .parseRegular: return "\u{f876}"
        case .partialBold: return "\u{f877}"
        case .partialLight: return "\u{f878}"
        case .partialRegular: return "\u{f879}"
        case .participantAddBold: return "\u{f87a}"
        case .participantAddLight: return "\u{f87b}"
        case .participantAddRegular: return "\u{f87c}"
        case .participantBlockedBold: return "\u{f87d}"
        case .participantBlockedLight: return "\u{f87e}"
        case .participantBlockedRegular: return "\u{f87f}"
        case .participantBold: return "\u{f880}"
        case .participantFilled: return "\u{f881}"
        case .participantLight: return "\u{f882}"
        case .participantListBold: return "\u{f883}"
        case .participantListFilled: return "\u{f884}"
        case .participantListLight: return "\u{f885}"
        case .participantListRegular: return "\u{f886}"
        case .participantRegular: return "\u{f887}"
        case .participantRemoveBold: return "\u{f888}"
        case .participantRemoveLight: return "\u{f889}"
        case .participantRemoveRegular: return "\u{f88a}"
        case .participantUnknownBold: return "\u{f88b}"
        case .participantUnknownLight: return "\u{f88c}"
        case .participantUnknownRegular: return "\u{f88d}"
        case .passMouseBold: return "\u{f88e}"
        case .passMouseLight: return "\u{f88f}"
        case .passMouseRegular: return "\u{f890}"
        case .pauseBadgeFilled: return "\u{f891}"
        case .pauseBold: return "\u{f892}"
        case .pauseFilled: return "\u{f893}"
        case .pauseInteractionBold: return "\u{f894}"
        case .pauseInteractionFilled: return "\u{f895}"
        case .pauseInteractionLight: return "\u{f896}"
        case .pauseInteractionRegular: return "\u{f897}"
        case .pauseLight: return "\u{f898}"
        case .pauseRegular: return "\u{f899}"
        case .peopleAddBold: return "\u{f89a}"
        case .peopleAddFilled: return "\u{f89b}"
        case .peopleAddLight: return "\u{f89c}"
        case .peopleAddRegular: return "\u{f89d}"
        case .peopleBold: return "\u{f89e}"
        case .peopleCircleBold: return "\u{f89f}"
        case .peopleCircleFilled: return "\u{f8a0}"
        case .peopleCircleLight: return "\u{f8a1}"
        case .peopleCircleRegular: return "\u{f8a2}"
        case .peopleFilled: return "\u{f8a3}"
        case .peopleInsightsBold: return "\u{f8a4}"
        case .peopleInsightsFilled: return "\u{f8a5}"
        case .peopleInsightsLight: return "\u{f8a6}"
        case .peopleInsightsRegular: return "\u{f8a7}"
        case .peopleLight: return "\u{f8a8}"
        case .peopleManageBold: return "\u{f8a9}"
        case .peopleManageFilled: return "\u{f8aa}"
        case .peopleManageLight: return "\u{f8ab}"
        case .peopleManageRegular: return "\u{f8ac}"
        case .peopleRegular: return "\u{f8ad}"
        case .phoneAlertBold: return "\u{f8ae}"
        case .phoneAlertLight: return "\u{f8af}"
        case .phoneAlertRegular: return "\u{f8b0}"
        case .phoneBadgeFilled: return "\u{f8b1}"
        case .phoneBold: return "\u{f8b2}"
        case .phoneFilled: return "\u{f8b3}"
        case .phoneLight: return "\u{f8b4}"
        case .phoneMutedBold: return "\u{f8b5}"
        case .phoneMutedLight: return "\u{f8b6}"
        case .phoneMutedRegular: return "\u{f8b7}"
        case .phonePrivateBold: return "\u{f8b8}"
        case .phonePrivateLight: return "\u{f8b9}"
        case .phonePrivateRegular: return "\u{f8ba}"
        case .phoneRegular: return "\u{f8bb}"
        case .phoneReplyAllBold: return "\u{f8bc}"
        case .phoneReplyAllLight: return "\u{f8bd}"
        case .phoneReplyAllRegular: return "\u{f8be}"
        case .phoneReplyBold: return "\u{f8bf}"
        case .phoneReplyLight: return "\u{f8c0}"
        case .phoneReplyRegular: return "\u{f8c1}"
        case .pickerBold: return "\u{f8c2}"
        case .pickerLight: return "\u{f8c3}"
        case .pickerRegular: return "\u{f8c4}"
        case .pieChartBold: return "\u{f8c5}"
        case .pieChartFilled: return "\u{f8c6}"
        case .pieChartLight: return "\u{f8c7}"
        case .pieChartRegular: return "\u{f8c8}"
        case .pinBold: return "\u{f8c9}"
        case .pinFilled: return "\u{f8ca}"
        case .pinLight: return "\u{f8cb}"
        case .pinListActivityBold: return "\u{f8cc}"
        case .pinListActivityLight: return "\u{f8cd}"
        case .pinListActivityRegular: return "\u{f8ce}"
        case .pinListBold: return "\u{f8cf}"
        case .pinListLight: return "\u{f8d0}"
        case .pinListRegular: return "\u{f8d1}"
        case .pinMutedBold: return "\u{f8d2}"
        case .pinMutedFilled: return "\u{f8d3}"
        case .pinMutedLight: return "\u{f8d4}"
        case .pinMutedRegular: return "\u{f8d5}"
        case .pinRegular: return "\u{f8d6}"
        case .pipBold: return "\u{f8d7}"
        case .pipEnterBold: return "\u{f8d8}"
        case .pipEnterLight: return "\u{f8d9}"
        case .pipEnterRegular: return "\u{f8da}"
        case .pipExitBold: return "\u{f8db}"
        case .pipExitLight: return "\u{f8dc}"
        case .pipExitRegular: return "\u{f8dd}"
        case .pipFilled: return "\u{f8de}"
        case .pipLight: return "\u{f8df}"
        case .pipRegular: return "\u{f8e0}"
        case .placeholderBold: return "\u{f8e1}"
        case .placeholderFilled: return "\u{f8e2}"
        case .placeholderLight: return "\u{f8e3}"
        case .placeholderRegular: return "\u{f8e4}"
        case .playBold: return "\u{f8e5}"
        case .playCircleBold: return "\u{f8e6}"
        case .playCircleFilled: return "\u{f8e7}"
        case .playCircleLight: return "\u{f8e8}"
        case .playCircleRegular: return "\u{f8e9}"
        case .playFilled: return "\u{f8ea}"
        case .playLight: return "\u{f8eb}"
        case .playRegular: return "\u{f8ec}"
        case .plugAcBold: return "\u{f8ed}"
        case .plugAcLight: return "\u{f8ee}"
        case .plugAcRegular: return "\u{f8ef}"
        case .plusBold: return "\u{f8f0}"
        case .plusCircleBold: return "\u{f8f1}"
        case .plusCircleFilled: return "\u{f8f2}"
        case .plusCircleLight: return "\u{f8f3}"
        case .plusCircleRegular: return "\u{f8f4}"
        case .plusLight: return "\u{f8f5}"
        case .plusRegular: return "\u{f8f6}"
        case .pmrBold: return "\u{f8f7}"
        case .pmrFilled: return "\u{f8f8}"
        case .pmrLight: return "\u{f8f9}"
        case .pmrRegular: return "\u{f8fa}"
        case .pollBold: return "\u{f8fb}"
        case .pollFilled: return "\u{f8fc}"
        case .pollLight: return "\u{f8fd}"
        case .pollRegular: return "\u{f8fe}"
        case .popInBold: return "\u{f8ff}"
        case .popInLight: return "\u{f900}"
        case .popInRegular: return "\u{f901}"
        case .popOutBold: return "\u{f902}"
        case .popOutLight: return "\u{f903}"
        case .popOutRegular: return "\u{f904}"
        case .popUpBold: return "\u{f905}"
        case .popUpLight: return "\u{f906}"
        case .popUpRegular: return "\u{f907}"
        case .portraitLandscapeBold: return "\u{f908}"
        case .portraitLandscapeLight: return "\u{f909}"
        case .portraitLandscapeRegular: return "\u{f90a}"
        case .potentialFraudBold: return "\u{f90b}"
        case .potentialFraudFilled: return "\u{f90c}"
        case .potentialFraudLight: return "\u{f90d}"
        case .potentialFraudRegular: return "\u{f90e}"
        case .powerAcBold: return "\u{f90f}"
        case .powerAcLight: return "\u{f910}"
        case .powerAcRegular: return "\u{f911}"
        case .powerBold: return "\u{f912}"
        case .powerLight: return "\u{f913}"
        case .powerRegular: return "\u{f914}"
        case .preHeaderBold: return "\u{f915}"
        case .preHeaderLight: return "\u{f916}"
        case .preHeaderRegular: return "\u{f917}"
        case .premiumBold: return "\u{f918}"
        case .premiumLight: return "\u{f919}"
        case .premiumRegular: return "\u{f91a}"
        case .presentationBold: return "\u{f91b}"
        case .presentationLight: return "\u{f91c}"
        case .presentationRegular: return "\u{f91d}"
        case .preventDownloadBold: return "\u{f91e}"
        case .preventDownloadFilled: return "\u{f91f}"
        case .preventDownloadLight: return "\u{f920}"
        case .preventDownloadRegular: return "\u{f921}"
        case .primaryParticipantBold: return "\u{f922}"
        case .primaryParticipantFilled: return "\u{f923}"
        case .primaryParticipantLight: return "\u{f924}"
        case .primaryParticipantRegular: return "\u{f925}"
        case .printBold: return "\u{f926}"
        case .printLight: return "\u{f927}"
        case .printRegular: return "\u{f928}"
        case .priorityBadgeFilled: return "\u{f929}"
        case .priorityCircleBold: return "\u{f92a}"
        case .priorityCircleFilled: return "\u{f92b}"
        case .priorityCircleLight: return "\u{f92c}"
        case .priorityCircleRegular: return "\u{f92d}"
        case .priorityCircleTwoBold: return "\u{f92e}"
        case .priorityCircleTwoFilled: return "\u{f92f}"
        case .priorityCircleTwoLight: return "\u{f930}"
        case .priorityCircleTwoRegular: return "\u{f931}"
        case .priorityWaveBold: return "\u{f932}"
        case .priorityWaveLight: return "\u{f933}"
        case .priorityWaveRegular: return "\u{f934}"
        case .privacyCircleBold: return "\u{f935}"
        case .privacyCircleFilled: return "\u{f936}"
        case .privacyCircleLight: return "\u{f937}"
        case .privacyCircleRegular: return "\u{f938}"
        case .privateBold: return "\u{f939}"
        case .privateCircleBold: return "\u{f93a}"
        case .privateCircleFilled: return "\u{f93b}"
        case .privateCircleLight: return "\u{f93c}"
        case .privateCircleRegular: return "\u{f93d}"
        case .privateLight: return "\u{f93e}"
        case .privateMeetingBold: return "\u{f93f}"
        case .privateMeetingLight: return "\u{f940}"
        case .privateMeetingRegular: return "\u{f941}"
        case .privateRegular: return "\u{f942}"
        case .productDemoBold: return "\u{f943}"
        case .productDemoLight: return "\u{f944}"
        case .productDemoRegular: return "\u{f945}"
        case .promptsAiBold: return "\u{f946}"
        case .promptsAiLight: return "\u{f947}"
        case .promptsAiRegular: return "\u{f948}"
        case .proximityBold: return "\u{f949}"
        case .proximityLight: return "\u{f94a}"
        case .proximityMutedBold: return "\u{f94b}"
        case .proximityMutedLight: return "\u{f94c}"
        case .proximityMutedRegular: return "\u{f94d}"
        case .proximityRegular: return "\u{f94e}"
        case .proximityVideoBold: return "\u{f94f}"
        case .proximityVideoLight: return "\u{f950}"
        case .proximityVideoRegular: return "\u{f951}"
        case .ptoPresenceBold: return "\u{f952}"
        case .ptoPresenceFilled: return "\u{f953}"
        case .ptoPresenceLight: return "\u{f954}"
        case .ptoPresenceRegular: return "\u{f955}"
        case .pullCallBold: return "\u{f956}"
        case .pullCallFilled: return "\u{f957}"
        case .pullCallLight: return "\u{f958}"
        case .pullCallRegular: return "\u{f959}"
        case .qABold: return "\u{f95a}"
        case .qAFilled: return "\u{f95b}"
        case .qALight: return "\u{f95c}"
        case .qARegular: return "\u{f95d}"
        case .qrCodeBold: return "\u{f95e}"
        case .qrCodeLight: return "\u{f95f}"
        case .qrCodeRegular: return "\u{f960}"
        case .qrCodeScanBold: return "\u{f961}"
        case .qrCodeScanLight: return "\u{f962}"
        case .qrCodeScanRegular: return "\u{f963}"
        case .qualityBold: return "\u{f964}"
        case .qualityLight: return "\u{f965}"
        case .qualityRegular: return "\u{f966}"
        case .queueContactBold: return "\u{f967}"
        case .queueContactFilled: return "\u{f968}"
        case .queueContactLight: return "\u{f969}"
        case .queueContactRegular: return "\u{f96a}"
        case .queuedInteractionBold: return "\u{f96b}"
        case .queuedInteractionFilled: return "\u{f96c}"
        case .queuedInteractionLight: return "\u{f96d}"
        case .queuedInteractionRegular: return "\u{f96e}"
        case .quietBold: return "\u{f96f}"
        case .quietHoursPresenceBold: return "\u{f970}"
        case .quietHoursPresenceFilled: return "\u{f971}"
        case .quietHoursPresenceLight: return "\u{f972}"
        case .quietHoursPresenceRegular: return "\u{f973}"
        case .quietLight: return "\u{f974}"
        case .quietRegular: return "\u{f975}"
        case .radioButtonGroupBold: return "\u{f976}"
        case .radioButtonGroupLight: return "\u{f977}"
        case .radioButtonGroupRegular: return "\u{f978}"
        case .raiseHandBold: return "\u{f979}"
        case .raiseHandCircleFilled: return "\u{f97a}"
        case .raiseHandFilled: return "\u{f97b}"
        case .raiseHandLight: return "\u{f97c}"
        case .raiseHandRegular: return "\u{f97d}"
        case .ramBold: return "\u{f97e}"
        case .ramLight: return "\u{f97f}"
        case .ramRegular: return "\u{f980}"
        case .reactionsBold: return "\u{f981}"
        case .reactionsFilled: return "\u{f982}"
        case .reactionsLight: return "\u{f983}"
        case .reactionsRegular: return "\u{f984}"
        case .reactivateBold: return "\u{f985}"
        case .reactivateLight: return "\u{f986}"
        case .reactivateRegular: return "\u{f987}"
        case .receiveVoiceBold: return "\u{f988}"
        case .receiveVoiceFilled: return "\u{f989}"
        case .receiveVoiceLight: return "\u{f98a}"
        case .receiveVoiceRegular: return "\u{f98b}"
        case .recentsBold: return "\u{f98c}"
        case .recentsFilled: return "\u{f98d}"
        case .recentsLight: return "\u{f98e}"
        case .recentsPresenceBadgeFilled: return "\u{f98f}"
        case .recentsPresenceBold: return "\u{f990}"
        case .recentsPresenceFilled: return "\u{f991}"
        case .recentsPresenceLight: return "\u{f992}"
        case .recentsPresenceRegular: return "\u{f993}"
        case .recentsRegular: return "\u{f994}"
        case .recordActiveBadgeFilled: return "\u{f995}"
        case .recordActiveBold: return "\u{f996}"
        case .recordActiveFilled: return "\u{f997}"
        case .recordActiveLight: return "\u{f998}"
        case .recordActiveRegular: return "\u{f999}"
        case .recordBold: return "\u{f99a}"
        case .recordFilled: return "\u{f99b}"
        case .recordLight: return "\u{f99c}"
        case .recordPausedBadgeFilled: return "\u{f99d}"
        case .recordPausedBold: return "\u{f99e}"
        case .recordPausedFilled: return "\u{f99f}"
        case .recordPausedLight: return "\u{f9a0}"
        case .recordPausedRegular: return "\u{f9a1}"
        case .recordRegular: return "\u{f9a2}"
        case .recurringBold: return "\u{f9a3}"
        case .recurringLight: return "\u{f9a4}"
        case .recurringOffBold: return "\u{f9a5}"
        case .recurringOffLight: return "\u{f9a6}"
        case .recurringOffRegular: return "\u{f9a7}"
        case .recurringRegular: return "\u{f9a8}"
        case .redoBold: return "\u{f9a9}"
        case .redoLight: return "\u{f9aa}"
        case .redoRegular: return "\u{f9ab}"
        case .refreshBold: return "\u{f9ac}"
        case .refreshLight: return "\u{f9ad}"
        case .refreshRegular: return "\u{f9ae}"
        case .remoteDesktopControlBold: return "\u{f9af}"
        case .remoteDesktopControlFilled: return "\u{f9b0}"
        case .remoteDesktopControlLight: return "\u{f9b1}"
        case .remoteDesktopControlRegular: return "\u{f9b2}"
        case .removeBold: return "\u{f9b3}"
        case .removeFilled: return "\u{f9b4}"
        case .removeLight: return "\u{f9b5}"
        case .removeRegular: return "\u{f9b6}"
        case .replyBold: return "\u{f9b7}"
        case .replyFilled: return "\u{f9b8}"
        case .replyLight: return "\u{f9b9}"
        case .replyListBold: return "\u{f9ba}"
        case .replyListFilled: return "\u{f9bb}"
        case .replyListLight: return "\u{f9bc}"
        case .replyListRegular: return "\u{f9bd}"
        case .replyPrivatelyBold: return "\u{f9be}"
        case .replyPrivatelyLight: return "\u{f9bf}"
        case .replyPrivatelyRegular: return "\u{f9c0}"
        case .replyRegular: return "\u{f9c1}"
        case .resetBold: return "\u{f9c2}"
        case .resetLight: return "\u{f9c3}"
        case .resetRegular: return "\u{f9c4}"
        case .resizeCornerBold: return "\u{f9c5}"
        case .resizeCornerLight: return "\u{f9c6}"
        case .resizeCornerRegular: return "\u{f9c7}"
        case .responsiveMobileBold: return "\u{f9c8}"
        case .responsiveMobileLight: return "\u{f9c9}"
        case .responsiveMobileRegular: return "\u{f9ca}"
        case .restartBold: return "\u{f9cb}"
        case .restartLight: return "\u{f9cc}"
        case .restartRegular: return "\u{f9cd}"
        case .resumeInteractionBold: return "\u{f9ce}"
        case .resumeInteractionFilled: return "\u{f9cf}"
        case .resumeInteractionLight: return "\u{f9d0}"
        case .resumeInteractionRegular: return "\u{f9d1}"
        case .retrieveCallBold: return "\u{f9d2}"
        case .retrieveCallFilled: return "\u{f9d3}"
        case .retrieveCallLight: return "\u{f9d4}"
        case .retrieveCallRegular: return "\u{f9d5}"
        case .returnBold: return "\u{f9d6}"
        case .returnLight: return "\u{f9d7}"
        case .returnRegular: return "\u{f9d8}"
        case .rewindTenSecBold: return "\u{f9d9}"
        case .rewindTenSecLight: return "\u{f9da}"
        case .rewindTenSecRegular: return "\u{f9db}"
        case .ringtoneBold: return "\u{f9dc}"
        case .ringtoneLight: return "\u{f9dd}"
        case .ringtoneRegular: return "\u{f9de}"
        case .roomCalendarBold: return "\u{f9df}"
        case .roomCalendarLight: return "\u{f9e0}"
        case .roomCalendarRegular: return "\u{f9e1}"
        case .roomLightsBold: return "\u{f9e2}"
        case .roomLightsFilled: return "\u{f9e3}"
        case .roomLightsLight: return "\u{f9e4}"
        case .roomLightsRegular: return "\u{f9e5}"
        case .rotateContentBold: return "\u{f9e6}"
        case .rotateContentFilled: return "\u{f9e7}"
        case .rotateContentLight: return "\u{f9e8}"
        case .rotateContentRegular: return "\u{f9e9}"
        case .rssBold: return "\u{f9ea}"
        case .rssFilled: return "\u{f9eb}"
        case .rssLight: return "\u{f9ec}"
        case .rssRegular: return "\u{f9ed}"
        case .ruleBasedBold: return "\u{f9ee}"
        case .ruleBasedLight: return "\u{f9ef}"
        case .ruleBasedRegular: return "\u{f9f0}"
        case .rulerBold: return "\u{f9f1}"
        case .rulerFilled: return "\u{f9f2}"
        case .rulerLight: return "\u{f9f3}"
        case .rulerRegular: return "\u{f9f4}"
        case .runningApplicationBold: return "\u{f9f5}"
        case .runningApplicationFilled: return "\u{f9f6}"
        case .runningApplicationLight: return "\u{f9f7}"
        case .runningApplicationRegular: return "\u{f9f8}"
        case .saveBold: return "\u{f9f9}"
        case .saveLight: return "\u{f9fa}"
        case .saveRegular: return "\u{f9fb}"
        case .saveTranscriptBold: return "\u{f9fc}"
        case .saveTranscriptFilled: return "\u{f9fd}"
        case .saveTranscriptLight: return "\u{f9fe}"
        case .saveTranscriptRegular: return "\u{f9ff}"
        case .scanBold: return "\u{fa00}"
        case .scanLight: return "\u{fa01}"
        case .scanRegular: return "\u{fa02}"
        case .scheduleAiBold: return "\u{fa03}"
        case .scheduleAiLight: return "\u{fa04}"
        case .scheduleAiRegular: return "\u{fa05}"
        case .scheduleSendBold: return "\u{fa06}"
        case .scheduleSendFilled: return "\u{fa07}"
        case .scheduleSendLight: return "\u{fa08}"
        case .scheduleSendRegular: return "\u{fa09}"
        case .scheduleWinnerBold: return "\u{fa0a}"
        case .scheduleWinnerFilled: return "\u{fa0b}"
        case .scheduleWinnerLight: return "\u{fa0c}"
        case .scheduleWinnerRegular: return "\u{fa0d}"
        case .schedulerAvailableBold: return "\u{fa0e}"
        case .schedulerAvailableLight: return "\u{fa0f}"
        case .schedulerAvailableRegular: return "\u{fa10}"
        case .schedulerNotWorkingHoursBold: return "\u{fa11}"
        case .schedulerNotWorkingHoursLight: return "\u{fa12}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa13}"
        case .schedulerUnavailableBold: return "\u{fa14}"
        case .schedulerUnavailableLight: return "\u{fa15}"
        case .schedulerUnavailableRegular: return "\u{fa16}"
        case .schedulerUnknownBold: return "\u{fa17}"
        case .schedulerUnknownLight: return "\u{fa18}"
        case .schedulerUnknownRegular: return "\u{fa19}"
        case .screenshotBold: return "\u{fa1a}"
        case .screenshotDocBold: return "\u{fa1b}"
        case .screenshotDocFilled: return "\u{fa1c}"
        case .screenshotDocLight: return "\u{fa1d}"
        case .screenshotDocRegular: return "\u{fa1e}"
        case .screenshotLight: return "\u{fa1f}"
        case .screenshotRegular: return "\u{fa20}"
        case .searchAiBold: return "\u{fa21}"
        case .searchAiLight: return "\u{fa22}"
        case .searchAiRegular: return "\u{fa23}"
        case .searchBold: return "\u{fa24}"
        case .searchFilled: return "\u{fa25}"
        case .searchLight: return "\u{fa26}"
        case .searchRegular: return "\u{fa27}"
        case .secondaryArrowBold: return "\u{fa28}"
        case .secondaryArrowLight: return "\u{fa29}"
        case .secondaryArrowRegular: return "\u{fa2a}"
        case .secureCallLockBold: return "\u{fa2b}"
        case .secureCallLockFilled: return "\u{fa2c}"
        case .secureCallLockLight: return "\u{fa2d}"
        case .secureCallLockRegular: return "\u{fa2e}"
        case .secureCallShieldBold: return "\u{fa2f}"
        case .secureCallShieldFilled: return "\u{fa30}"
        case .secureCallShieldLight: return "\u{fa31}"
        case .secureCallShieldRegular: return "\u{fa32}"
        case .secureCircleBold: return "\u{fa33}"
        case .secureCircleFilled: return "\u{fa34}"
        case .secureCircleLight: return "\u{fa35}"
        case .secureCircleRegular: return "\u{fa36}"
        case .secureLockBold: return "\u{fa37}"
        case .secureLockFilled: return "\u{fa38}"
        case .secureLockLight: return "\u{fa39}"
        case .secureLockRegular: return "\u{fa3a}"
        case .segmentExcludeFilled: return "\u{fa3b}"
        case .segmentFilterFilled: return "\u{fa3c}"
        case .segmentIncludeFilled: return "\u{fa3d}"
        case .selectAllBold: return "\u{fa3e}"
        case .selectAllFilled: return "\u{fa3f}"
        case .selectAllLight: return "\u{fa40}"
        case .selectAllRegular: return "\u{fa41}"
        case .selectionBold: return "\u{fa42}"
        case .selectionFilled: return "\u{fa43}"
        case .selectionLight: return "\u{fa44}"
        case .selectionRegular: return "\u{fa45}"
        case .sendBold: return "\u{fa46}"
        case .sendDigitsBold: return "\u{fa47}"
        case .sendDigitsFilled: return "\u{fa48}"
        case .sendDigitsLight: return "\u{fa49}"
        case .sendDigitsRegular: return "\u{fa4a}"
        case .sendFilled: return "\u{fa4b}"
        case .sendLight: return "\u{fa4c}"
        case .sendRegular: return "\u{fa4d}"
        case .sendVoiceBold: return "\u{fa4e}"
        case .sendVoiceFilled: return "\u{fa4f}"
        case .sendVoiceLight: return "\u{fa50}"
        case .sendVoiceRegular: return "\u{fa51}"
        case .serverBold: return "\u{fa52}"
        case .serverErrorBold: return "\u{fa53}"
        case .serverErrorLight: return "\u{fa54}"
        case .serverErrorRegular: return "\u{fa55}"
        case .serverLight: return "\u{fa56}"
        case .serverRegular: return "\u{fa57}"
        case .servicesBold: return "\u{fa58}"
        case .servicesLight: return "\u{fa59}"
        case .servicesRegular: return "\u{fa5a}"
        case .setVariableBold: return "\u{fa5b}"
        case .setVariableLight: return "\u{fa5c}"
        case .setVariableRegular: return "\u{fa5d}"
        case .settingsBold: return "\u{fa5e}"
        case .settingsFilled: return "\u{fa5f}"
        case .settingsLight: return "\u{fa60}"
        case .settingsRegular: return "\u{fa61}"
        case .setupAssistantBold: return "\u{fa62}"
        case .setupAssistantLight: return "\u{fa63}"
        case .setupAssistantRegular: return "\u{fa64}"
        case .sftpBold: return "\u{fa65}"
        case .sftpLight: return "\u{fa66}"
        case .sftpRegular: return "\u{fa67}"
        case .shapeCircleBold: return "\u{fa68}"
        case .shapeCircleFilled: return "\u{fa69}"
        case .shapeCircleLight: return "\u{fa6a}"
        case .shapeCircleMdFilled: return "\u{fa6b}"
        case .shapeCircleRegular: return "\u{fa6c}"
        case .shapeCircleSmFilled: return "\u{fa6d}"
        case .shapeDiagonalLineBold: return "\u{fa6e}"
        case .shapeDiagonalLineLight: return "\u{fa6f}"
        case .shapeDiagonalLineRegular: return "\u{fa70}"
        case .shapeDiamondBold: return "\u{fa71}"
        case .shapeDiamondFilled: return "\u{fa72}"
        case .shapeDiamondLight: return "\u{fa73}"
        case .shapeDiamondRegular: return "\u{fa74}"
        case .shapeOvalBold: return "\u{fa75}"
        case .shapeOvalLight: return "\u{fa76}"
        case .shapeOvalRegular: return "\u{fa77}"
        case .shapeSquareBold: return "\u{fa78}"
        case .shapeSquareFilled: return "\u{fa79}"
        case .shapeSquareLight: return "\u{fa7a}"
        case .shapeSquareRegular: return "\u{fa7b}"
        case .shapeTriangleBold: return "\u{fa7c}"
        case .shapeTriangleFilled: return "\u{fa7d}"
        case .shapeTriangleLight: return "\u{fa7e}"
        case .shapeTriangleRegular: return "\u{fa7f}"
        case .shapesBold: return "\u{fa80}"
        case .shapesFilled: return "\u{fa81}"
        case .shapesLight: return "\u{fa82}"
        case .shapesRegular: return "\u{fa83}"
        case .shareCNativeAdrBold: return "\u{fa84}"
        case .shareCNativeAdrFilled: return "\u{fa85}"
        case .shareCNativeAdrLight: return "\u{fa86}"
        case .shareCNativeAdrRegular: return "\u{fa87}"
        case .shareCNativeIphBold: return "\u{fa88}"
        case .shareCNativeIphLight: return "\u{fa89}"
        case .shareCNativeIphRegular: return "\u{fa8a}"
        case .shareContentOnDeviceBold: return "\u{fa8b}"
        case .shareContentOnDeviceLight: return "\u{fa8c}"
        case .shareContentOnDeviceRegular: return "\u{fa8d}"
        case .shareScreenAddBold: return "\u{fa8e}"
        case .shareScreenAddLight: return "\u{fa8f}"
        case .shareScreenAddRegular: return "\u{fa90}"
        case .shareScreenBadgeFilled: return "\u{fa91}"
        case .shareScreenBold: return "\u{fa92}"
        case .shareScreenFilled: return "\u{fa93}"
        case .shareScreenLight: return "\u{fa94}"
        case .shareScreenRegular: return "\u{fa95}"
        case .shareSpaceBold: return "\u{fa96}"
        case .shareSpaceLight: return "\u{fa97}"
        case .shareSpaceRegular: return "\u{fa98}"
        case .shieldBold: return "\u{fa99}"
        case .shieldLight: return "\u{fa9a}"
        case .shieldRegular: return "\u{fa9b}"
        case .shoppingCartBold: return "\u{fa9c}"
        case .shoppingCartFilled: return "\u{fa9d}"
        case .shoppingCartLight: return "\u{fa9e}"
        case .shoppingCartRegular: return "\u{fa9f}"
        case .shortTextBoxBold: return "\u{faa0}"
        case .shortTextBoxLight: return "\u{faa1}"
        case .shortTextBoxRegular: return "\u{faa2}"
        case .showBold: return "\u{faa3}"
        case .showFilled: return "\u{faa4}"
        case .showLight: return "\u{faa5}"
        case .showRegular: return "\u{faa6}"
        case .sidePanelBold: return "\u{faa7}"
        case .sidePanelFilled: return "\u{faa8}"
        case .sidePanelLight: return "\u{faa9}"
        case .sidePanelRegular: return "\u{faaa}"
        case .signInBold: return "\u{faab}"
        case .signInFilled: return "\u{faac}"
        case .signInForcedBold: return "\u{faad}"
        case .signInForcedLight: return "\u{faae}"
        case .signInForcedRegular: return "\u{faaf}"
        case .signInLight: return "\u{fab0}"
        case .signInRegular: return "\u{fab1}"
        case .signLangIntBold: return "\u{fab2}"
        case .signLangIntLight: return "\u{fab3}"
        case .signLangIntRegular: return "\u{fab4}"
        case .signOutBold: return "\u{fab5}"
        case .signOutLight: return "\u{fab6}"
        case .signOutRegular: return "\u{fab7}"
        case .signalFourBold: return "\u{fab8}"
        case .signalFourLight: return "\u{fab9}"
        case .signalFourRegular: return "\u{faba}"
        case .signalOneBold: return "\u{fabb}"
        case .signalOneLight: return "\u{fabc}"
        case .signalOneRegular: return "\u{fabd}"
        case .signalThreeBold: return "\u{fabe}"
        case .signalThreeLight: return "\u{fabf}"
        case .signalThreeRegular: return "\u{fac0}"
        case .signalTwoBold: return "\u{fac1}"
        case .signalTwoLight: return "\u{fac2}"
        case .signalTwoRegular: return "\u{fac3}"
        case .signalZeroBold: return "\u{fac4}"
        case .signalZeroLight: return "\u{fac5}"
        case .signalZeroRegular: return "\u{fac6}"
        case .simplePromotionBold: return "\u{fac7}"
        case .simplePromotionLight: return "\u{fac8}"
        case .simplePromotionRegular: return "\u{fac9}"
        case .singleNumberReachBold: return "\u{faca}"
        case .singleNumberReachLight: return "\u{facb}"
        case .singleNumberReachRegular: return "\u{facc}"
        case .sipRegistrationInProgressBold: return "\u{facd}"
        case .sipRegistrationInProgressFilled: return "\u{face}"
        case .sipRegistrationInProgressLight: return "\u{facf}"
        case .sipRegistrationInProgressRegular: return "\u{fad0}"
        case .skipBold: return "\u{fad1}"
        case .skipBwBold: return "\u{fad2}"
        case .skipBwFilled: return "\u{fad3}"
        case .skipBwLight: return "\u{fad4}"
        case .skipBwRegular: return "\u{fad5}"
        case .skipFwBold: return "\u{fad6}"
        case .skipFwFilled: return "\u{fad7}"
        case .skipFwLight: return "\u{fad8}"
        case .skipFwRegular: return "\u{fad9}"
        case .skipLight: return "\u{fada}"
        case .skipRegular: return "\u{fadb}"
        case .smartAudioBold: return "\u{fadc}"
        case .smartAudioLight: return "\u{fadd}"
        case .smartAudioRegular: return "\u{fade}"
        case .smsFilled: return "\u{fadf}"
        case .smsInboundBold: return "\u{fae0}"
        case .smsInboundLight: return "\u{fae1}"
        case .smsInboundRegular: return "\u{fae2}"
        case .smsMessageBold: return "\u{fae3}"
        case .smsMessageFilled: return "\u{fae4}"
        case .smsMessageLight: return "\u{fae5}"
        case .smsMessageRegular: return "\u{fae6}"
        case .smsOutgoingFilled: return "\u{fae7}"
        case .smsUnreadBold: return "\u{fae8}"
        case .smsUnreadLight: return "\u{fae9}"
        case .smsUnreadRegular: return "\u{faea}"
        case .sortAscendingBold: return "\u{faeb}"
        case .sortAscendingLight: return "\u{faec}"
        case .sortAscendingRegular: return "\u{faed}"
        case .sortDescendingBold: return "\u{faee}"
        case .sortDescendingLight: return "\u{faef}"
        case .sortDescendingRegular: return "\u{faf0}"
        case .soundDefaultBold: return "\u{faf1}"
        case .soundDefaultLight: return "\u{faf2}"
        case .soundDefaultRegular: return "\u{faf3}"
        case .sparkleBold: return "\u{faf4}"
        case .sparkleFilled: return "\u{faf5}"
        case .sparkleLight: return "\u{faf6}"
        case .sparkleRegular: return "\u{faf7}"
        case .speakerBold: return "\u{faf8}"
        case .speakerDisconnectedBold: return "\u{faf9}"
        case .speakerDisconnectedFilled: return "\u{fafa}"
        case .speakerDisconnectedLight: return "\u{fafb}"
        case .speakerDisconnectedRegular: return "\u{fafc}"
        case .speakerFilled: return "\u{fafd}"
        case .speakerLight: return "\u{fafe}"
        case .speakerMutedBold: return "\u{faff}"
        case .speakerMutedFilled: return "\u{fb00}"
        case .speakerMutedLight: return "\u{fb01}"
        case .speakerMutedRegular: return "\u{fb02}"
        case .speakerOffBold: return "\u{fb03}"
        case .speakerOffFilled: return "\u{fb04}"
        case .speakerOffLight: return "\u{fb05}"
        case .speakerOffRegular: return "\u{fb06}"
        case .speakerOnBold: return "\u{fb07}"
        case .speakerOnLight: return "\u{fb08}"
        case .speakerOnRegular: return "\u{fb09}"
        case .speakerRegular: return "\u{fb0a}"
        case .speakerTurnDownBold: return "\u{fb0b}"
        case .speakerTurnDownFilled: return "\u{fb0c}"
        case .speakerTurnDownLight: return "\u{fb0d}"
        case .speakerTurnDownRegular: return "\u{fb0e}"
        case .speakerTurnUpBold: return "\u{fb0f}"
        case .speakerTurnUpFilled: return "\u{fb10}"
        case .speakerTurnUpLight: return "\u{fb11}"
        case .speakerTurnUpRegular: return "\u{fb12}"
        case .speedDialBold: return "\u{fb13}"
        case .speedDialFilled: return "\u{fb14}"
        case .speedDialLight: return "\u{fb15}"
        case .speedDialRegular: return "\u{fb16}"
        case .spellCheckerBold: return "\u{fb17}"
        case .spellCheckerLight: return "\u{fb18}"
        case .spellCheckerRegular: return "\u{fb19}"
        case .splitViewBold: return "\u{fb1a}"
        case .splitViewLight: return "\u{fb1b}"
        case .splitViewRegular: return "\u{fb1c}"
        case .stackedAreaChartBold: return "\u{fb1d}"
        case .stackedAreaChartFilled: return "\u{fb1e}"
        case .stackedAreaChartFullBold: return "\u{fb1f}"
        case .stackedAreaChartFullFilled: return "\u{fb20}"
        case .stackedAreaChartFullLight: return "\u{fb21}"
        case .stackedAreaChartFullRegular: return "\u{fb22}"
        case .stackedAreaChartLight: return "\u{fb23}"
        case .stackedAreaChartRegular: return "\u{fb24}"
        case .stackedBarChartBold: return "\u{fb25}"
        case .stackedBarChartFilled: return "\u{fb26}"
        case .stackedBarChartFullBold: return "\u{fb27}"
        case .stackedBarChartFullFilled: return "\u{fb28}"
        case .stackedBarChartFullLight: return "\u{fb29}"
        case .stackedBarChartFullRegular: return "\u{fb2a}"
        case .stackedBarChartLight: return "\u{fb2b}"
        case .stackedBarChartRegular: return "\u{fb2c}"
        case .startChatBold: return "\u{fb2d}"
        case .startChatLight: return "\u{fb2e}"
        case .startChatRegular: return "\u{fb2f}"
        case .stethoscopeBold: return "\u{fb30}"
        case .stethoscopeLight: return "\u{fb31}"
        case .stethoscopeRegular: return "\u{fb32}"
        case .stickersBold: return "\u{fb33}"
        case .stickersLight: return "\u{fb34}"
        case .stickersRegular: return "\u{fb35}"
        case .stickiesBold: return "\u{fb36}"
        case .stickiesLight: return "\u{fb37}"
        case .stickiesRegular: return "\u{fb38}"
        case .stopBold: return "\u{fb39}"
        case .stopCircleBold: return "\u{fb3a}"
        case .stopCircleFilled: return "\u{fb3b}"
        case .stopCircleLight: return "\u{fb3c}"
        case .stopCircleRegular: return "\u{fb3d}"
        case .stopContentShareBold: return "\u{fb3e}"
        case .stopContentShareLight: return "\u{fb3f}"
        case .stopContentShareRegular: return "\u{fb40}"
        case .stopFilled: return "\u{fb41}"
        case .stopLight: return "\u{fb42}"
        case .stopRegular: return "\u{fb43}"
        case .storedInfoBold: return "\u{fb44}"
        case .storedInfoFilled: return "\u{fb45}"
        case .storedInfoLight: return "\u{fb46}"
        case .storedInfoRegular: return "\u{fb47}"
        case .streamingBold: return "\u{fb48}"
        case .streamingLight: return "\u{fb49}"
        case .streamingRegular: return "\u{fb4a}"
        case .strikethroughBold: return "\u{fb4b}"
        case .strikethroughFilled: return "\u{fb4c}"
        case .strikethroughLight: return "\u{fb4d}"
        case .strikethroughRegular: return "\u{fb4e}"
        case .studioModeBold: return "\u{fb4f}"
        case .studioModeLight: return "\u{fb50}"
        case .studioModeRegular: return "\u{fb51}"
        case .subscriptBold: return "\u{fb52}"
        case .subscriptLight: return "\u{fb53}"
        case .subscriptRegular: return "\u{fb54}"
        case .summarizeAiBold: return "\u{fb55}"
        case .summarizeAiLight: return "\u{fb56}"
        case .summarizeAiRegular: return "\u{fb57}"
        case .superscriptBold: return "\u{fb58}"
        case .superscriptLight: return "\u{fb59}"
        case .superscriptRegular: return "\u{fb5a}"
        case .surveyBold: return "\u{fb5b}"
        case .surveyFilled: return "\u{fb5c}"
        case .surveyLight: return "\u{fb5d}"
        case .surveyRegular: return "\u{fb5e}"
        case .sxEightyCodecBold: return "\u{fb5f}"
        case .sxEightyCodecLight: return "\u{fb60}"
        case .sxEightyCodecRegular: return "\u{fb61}"
        case .sxTenBold: return "\u{fb62}"
        case .sxTenLight: return "\u{fb63}"
        case .sxTenRegular: return "\u{fb64}"
        case .sxTwentyBold: return "\u{fb65}"
        case .sxTwentyLight: return "\u{fb66}"
        case .sxTwentyRegular: return "\u{fb67}"
        case .tableBold: return "\u{fb68}"
        case .tableExtenderBold: return "\u{fb69}"
        case .tableExtenderFilled: return "\u{fb6a}"
        case .tableExtenderLight: return "\u{fb6b}"
        case .tableExtenderRegular: return "\u{fb6c}"
        case .tableLight: return "\u{fb6d}"
        case .tableRegular: return "\u{fb6e}"
        case .tabletBold: return "\u{fb6f}"
        case .tabletLight: return "\u{fb70}"
        case .tabletRegular: return "\u{fb71}"
        case .tabsBold: return "\u{fb72}"
        case .tabsLight: return "\u{fb73}"
        case .tabsRegular: return "\u{fb74}"
        case .tagBold: return "\u{fb75}"
        case .tagLight: return "\u{fb76}"
        case .tagRegular: return "\u{fb77}"
        case .tapBold: return "\u{fb78}"
        case .tapFilled: return "\u{fb79}"
        case .tapLight: return "\u{fb7a}"
        case .tapRegular: return "\u{fb7b}"
        case .telepresenceAlertBold: return "\u{fb7c}"
        case .telepresenceAlertLight: return "\u{fb7d}"
        case .telepresenceAlertMutedBold: return "\u{fb7e}"
        case .telepresenceAlertMutedLight: return "\u{fb7f}"
        case .telepresenceAlertMutedRegular: return "\u{fb80}"
        case .telepresenceAlertRegular: return "\u{fb81}"
        case .telepresenceBold: return "\u{fb82}"
        case .telepresenceIxFiveThousandBold: return "\u{fb83}"
        case .telepresenceIxFiveThousandLight: return "\u{fb84}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb85}"
        case .telepresenceLight: return "\u{fb86}"
        case .telepresenceMutedBold: return "\u{fb87}"
        case .telepresenceMutedLight: return "\u{fb88}"
        case .telepresenceMutedRegular: return "\u{fb89}"
        case .telepresencePrivateBold: return "\u{fb8a}"
        case .telepresencePrivateLight: return "\u{fb8b}"
        case .telepresencePrivateRegular: return "\u{fb8c}"
        case .telepresenceRegular: return "\u{fb8d}"
        case .temperatureBold: return "\u{fb8e}"
        case .temperatureLight: return "\u{fb8f}"
        case .temperatureRegular: return "\u{fb90}"
        case .testTubeBold: return "\u{fb91}"
        case .testTubeFilled: return "\u{fb92}"
        case .testTubeLight: return "\u{fb93}"
        case .testTubeRegular: return "\u{fb94}"
        case .textAlignCenterBold: return "\u{fb95}"
        case .textAlignCenterFilled: return "\u{fb96}"
        case .textAlignCenterLight: return "\u{fb97}"
        case .textAlignCenterRegular: return "\u{fb98}"
        case .textAlignLeftBold: return "\u{fb99}"
        case .textAlignLeftFilled: return "\u{fb9a}"
        case .textAlignLeftLight: return "\u{fb9b}"
        case .textAlignLeftRegular: return "\u{fb9c}"
        case .textAlignRightBold: return "\u{fb9d}"
        case .textAlignRightFilled: return "\u{fb9e}"
        case .textAlignRightLight: return "\u{fb9f}"
        case .textAlignRightRegular: return "\u{fba0}"
        case .textBold: return "\u{fba1}"
        case .textBoxCursorLight: return "\u{fba2}"
        case .textCodeBlockBold: return "\u{fba3}"
        case .textCodeBlockLight: return "\u{fba4}"
        case .textCodeBlockRegular: return "\u{fba5}"
        case .textHighlightBold: return "\u{fba6}"
        case .textHighlightFilled: return "\u{fba7}"
        case .textHighlightLight: return "\u{fba8}"
        case .textHighlightRegular: return "\u{fba9}"
        case .textLight: return "\u{fbaa}"
        case .textRegular: return "\u{fbab}"
        case .threeColumnBold: return "\u{fbac}"
        case .threeColumnLight: return "\u{fbad}"
        case .threeColumnRegular: return "\u{fbae}"
        case .threeDObjectBold: return "\u{fbaf}"
        case .threeDObjectLight: return "\u{fbb0}"
        case .threeDObjectRegular: return "\u{fbb1}"
        case .timeExclusionBold: return "\u{fbb2}"
        case .timeExclusionLight: return "\u{fbb3}"
        case .timeExclusionRegular: return "\u{fbb4}"
        case .timezoneBold: return "\u{fbb5}"
        case .timezoneFilled: return "\u{fbb6}"
        case .timezoneLight: return "\u{fbb7}"
        case .timezoneRegular: return "\u{fbb8}"
        case .tooFastBold: return "\u{fbb9}"
        case .tooFastLight: return "\u{fbba}"
        case .tooFastRegular: return "\u{fbbb}"
        case .tooSlowBold: return "\u{fbbc}"
        case .tooSlowLight: return "\u{fbbd}"
        case .tooSlowRegular: return "\u{fbbe}"
        case .toolsBold: return "\u{fbbf}"
        case .toolsFilled: return "\u{fbc0}"
        case .toolsLight: return "\u{fbc1}"
        case .toolsRegular: return "\u{fbc2}"
        case .touchTenBold: return "\u{fbc3}"
        case .touchTenLight: return "\u{fbc4}"
        case .touchTenRegular: return "\u{fbc5}"
        case .transcriptBold: return "\u{fbc6}"
        case .transcriptFilled: return "\u{fbc7}"
        case .transcriptLight: return "\u{fbc8}"
        case .transcriptRegular: return "\u{fbc9}"
        case .translateBold: return "\u{fbca}"
        case .translateLight: return "\u{fbcb}"
        case .translateRegular: return "\u{fbcc}"
        case .translateUndoBold: return "\u{fbcd}"
        case .translateUndoLight: return "\u{fbce}"
        case .translateUndoRegular: return "\u{fbcf}"
        case .trendingBold: return "\u{fbd0}"
        case .trendingDownBold: return "\u{fbd1}"
        case .trendingDownFilled: return "\u{fbd2}"
        case .trendingDownLight: return "\u{fbd3}"
        case .trendingDownRegular: return "\u{fbd4}"
        case .trendingFilled: return "\u{fbd5}"
        case .trendingLight: return "\u{fbd6}"
        case .trendingRegular: return "\u{fbd7}"
        case .trimBold: return "\u{fbd8}"
        case .trimLight: return "\u{fbd9}"
        case .trimRegular: return "\u{fbda}"
        case .twoColumnBold: return "\u{fbdb}"
        case .twoColumnLight: return "\u{fbdc}"
        case .twoColumnRegular: return "\u{fbdd}"
        case .twoWayVoiceStreamBold: return "\u{fbde}"
        case .twoWayVoiceStreamFilled: return "\u{fbdf}"
        case .twoWayVoiceStreamLight: return "\u{fbe0}"
        case .twoWayVoiceStreamRegular: return "\u{fbe1}"
        case .ucmCloudBold: return "\u{fbe2}"
        case .ucmCloudLight: return "\u{fbe3}"
        case .ucmCloudRegular: return "\u{fbe4}"
        case .unblockBold: return "\u{fbe5}"
        case .unblockFilled: return "\u{fbe6}"
        case .unblockLight: return "\u{fbe7}"
        case .unblockRegular: return "\u{fbe8}"
        case .underlineBold: return "\u{fbe9}"
        case .underlineFilled: return "\u{fbea}"
        case .underlineLight: return "\u{fbeb}"
        case .underlineRegular: return "\u{fbec}"
        case .undoBold: return "\u{fbed}"
        case .undoLight: return "\u{fbee}"
        case .undoRegular: return "\u{fbef}"
        case .unlinkBold: return "\u{fbf0}"
        case .unlinkLight: return "\u{fbf1}"
        case .unlinkRegular: return "\u{fbf2}"
        case .unreadBold: return "\u{fbf3}"
        case .unreadFilled: return "\u{fbf4}"
        case .unreadLight: return "\u{fbf5}"
        case .unreadRegular: return "\u{fbf6}"
        case .unsecureUnlockedBold: return "\u{fbf7}"
        case .unsecureUnlockedFilled: return "\u{fbf8}"
        case .unsecureUnlockedLight: return "\u{fbf9}"
        case .unsecureUnlockedRegular: return "\u{fbfa}"
        case .unsortedBold: return "\u{fbfb}"
        case .unsortedLight: return "\u{fbfc}"
        case .unsortedRegular: return "\u{fbfd}"
        case .updateFileShareBold: return "\u{fbfe}"
        case .updateFileShareLight: return "\u{fbff}"
        case .updateFileShareRegular: return "\u{fc00}"
        case .uploadBold: return "\u{fc01}"
        case .uploadImageBold: return "\u{fc02}"
        case .uploadImageLight: return "\u{fc03}"
        case .uploadImageRegular: return "\u{fc04}"
        case .uploadLight: return "\u{fc05}"
        case .uploadRegular: return "\u{fc06}"
        case .urgentVoicemailBold: return "\u{fc07}"
        case .urgentVoicemailFilled: return "\u{fc08}"
        case .usbBold: return "\u{fc09}"
        case .usbHeadsetBold: return "\u{fc0a}"
        case .usbHeadsetLight: return "\u{fc0b}"
        case .usbHeadsetMutedBold: return "\u{fc0c}"
        case .usbHeadsetMutedLight: return "\u{fc0d}"
        case .usbHeadsetMutedRegular: return "\u{fc0e}"
        case .usbHeadsetRegular: return "\u{fc0f}"
        case .usbLight: return "\u{fc10}"
        case .usbRegular: return "\u{fc11}"
        case .userBold: return "\u{fc12}"
        case .userDeactivateBold: return "\u{fc13}"
        case .userDeactivateLight: return "\u{fc14}"
        case .userDeactivateRegular: return "\u{fc15}"
        case .userLight: return "\u{fc16}"
        case .userRegular: return "\u{fc17}"
        case .videoBlurBold: return "\u{fc18}"
        case .videoBlurFilled: return "\u{fc19}"
        case .videoBlurLight: return "\u{fc1a}"
        case .videoBlurRegular: return "\u{fc1b}"
        case .videoBold: return "\u{fc1c}"
        case .videoEffectBold: return "\u{fc1d}"
        case .videoEffectFilled: return "\u{fc1e}"
        case .videoEffectLight: return "\u{fc1f}"
        case .videoEffectRegular: return "\u{fc20}"
        case .videoFilled: return "\u{fc21}"
        case .videoLayoutBold: return "\u{fc22}"
        case .videoLayoutCustomBold: return "\u{fc23}"
        case .videoLayoutCustomFilled: return "\u{fc24}"
        case .videoLayoutCustomLight: return "\u{fc25}"
        case .videoLayoutCustomRegular: return "\u{fc26}"
        case .videoLayoutEqualBold: return "\u{fc27}"
        case .videoLayoutEqualDualBold: return "\u{fc28}"
        case .videoLayoutEqualDualLight: return "\u{fc29}"
        case .videoLayoutEqualDualRegular: return "\u{fc2a}"
        case .videoLayoutEqualFilled: return "\u{fc2b}"
        case .videoLayoutEqualLight: return "\u{fc2c}"
        case .videoLayoutEqualRegular: return "\u{fc2d}"
        case .videoLayoutFilled: return "\u{fc2e}"
        case .videoLayoutLight: return "\u{fc2f}"
        case .videoLayoutOverlayBold: return "\u{fc30}"
        case .videoLayoutOverlayFilled: return "\u{fc31}"
        case .videoLayoutOverlayLight: return "\u{fc32}"
        case .videoLayoutOverlayRegular: return "\u{fc33}"
        case .videoLayoutPresentationBold: return "\u{fc34}"
        case .videoLayoutPresentationFilled: return "\u{fc35}"
        case .videoLayoutPresentationLight: return "\u{fc36}"
        case .videoLayoutPresentationRegular: return "\u{fc37}"
        case .videoLayoutPresenterDominantBold: return "\u{fc38}"
        case .videoLayoutPresenterDominantLight: return "\u{fc39}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc3a}"
        case .videoLayoutProminentBold: return "\u{fc3b}"
        case .videoLayoutProminentFilled: return "\u{fc3c}"
        case .videoLayoutProminentLight: return "\u{fc3d}"
        case .videoLayoutProminentRegular: return "\u{fc3e}"
        case .videoLayoutRegular: return "\u{fc3f}"
        case .videoLayoutShareDominantBold: return "\u{fc40}"
        case .videoLayoutShareDominantLight: return "\u{fc41}"
        case .videoLayoutShareDominantRegular: return "\u{fc42}"
        case .videoLayoutSingleBold: return "\u{fc43}"
        case .videoLayoutSingleFilled: return "\u{fc44}"
        case .videoLayoutSingleLight: return "\u{fc45}"
        case .videoLayoutSingleRegular: return "\u{fc46}"
        case .videoLayoutSpeakerBold: return "\u{fc47}"
        case .videoLayoutSpeakerFilled: return "\u{fc48}"
        case .videoLayoutSpeakerLight: return "\u{fc49}"
        case .videoLayoutSpeakerRegular: return "\u{fc4a}"
        case .videoLayoutStackBold: return "\u{fc4b}"
        case .videoLayoutStackFilled: return "\u{fc4c}"
        case .videoLayoutStackLight: return "\u{fc4d}"
        case .videoLayoutStackRegular: return "\u{fc4e}"
        case .videoLayoutVideoDominantBold: return "\u{fc4f}"
        case .videoLayoutVideoDominantFilled: return "\u{fc50}"
        case .videoLayoutVideoDominantLight: return "\u{fc51}"
        case .videoLayoutVideoDominantRegular: return "\u{fc52}"
        case .videoLight: return "\u{fc53}"
        case .videoPlusBold: return "\u{fc54}"
        case .videoPlusFilled: return "\u{fc55}"
        case .videoPlusLight: return "\u{fc56}"
        case .videoPlusRegular: return "\u{fc57}"
        case .videoRegular: return "\u{fc58}"
        case .videoSpeakerTrackBold: return "\u{fc59}"
        case .videoSpeakerTrackFilled: return "\u{fc5a}"
        case .videoSpeakerTrackLight: return "\u{fc5b}"
        case .videoSpeakerTrackRegular: return "\u{fc5c}"
        case .viewAllBold: return "\u{fc5d}"
        case .viewAllLight: return "\u{fc5e}"
        case .viewAllRegular: return "\u{fc5f}"
        case .viewListBold: return "\u{fc60}"
        case .viewListFilled: return "\u{fc61}"
        case .viewListLight: return "\u{fc62}"
        case .viewListRegular: return "\u{fc63}"
        case .viewStackedBold: return "\u{fc64}"
        case .viewStackedFilled: return "\u{fc65}"
        case .viewStackedLight: return "\u{fc66}"
        case .viewStackedRegular: return "\u{fc67}"
        case .viewThumbnailBold: return "\u{fc68}"
        case .viewThumbnailFilled: return "\u{fc69}"
        case .viewThumbnailLight: return "\u{fc6a}"
        case .viewThumbnailRegular: return "\u{fc6b}"
        case .visionproBold: return "\u{fc6c}"
        case .visionproFilled: return "\u{fc6d}"
        case .visionproLight: return "\u{fc6e}"
        case .visionproMoveCallInBold: return "\u{fc6f}"
        case .visionproMoveCallInFilled: return "\u{fc70}"
        case .visionproMoveCallInLight: return "\u{fc71}"
        case .visionproMoveCallInOutBold: return "\u{fc72}"
        case .visionproMoveCallInOutFilled: return "\u{fc73}"
        case .visionproMoveCallInOutLight: return "\u{fc74}"
        case .visionproMoveCallInOutRegular: return "\u{fc75}"
        case .visionproMoveCallInRegular: return "\u{fc76}"
        case .visionproMoveCallOutBold: return "\u{fc77}"
        case .visionproMoveCallOutFilled: return "\u{fc78}"
        case .visionproMoveCallOutLight: return "\u{fc79}"
        case .visionproMoveCallOutRegular: return "\u{fc7a}"
        case .visionproRegular: return "\u{fc7b}"
        case .voicemailBold: return "\u{fc7c}"
        case .voicemailFilled: return "\u{fc7d}"
        case .voicemailLight: return "\u{fc7e}"
        case .voicemailRegular: return "\u{fc7f}"
        case .vpnBold: return "\u{fc80}"
        case .vpnFilled: return "\u{fc81}"
        case .vpnLight: return "\u{fc82}"
        case .vpnRegular: return "\u{fc83}"
        case .vscBold: return "\u{fc84}"
        case .vscLight: return "\u{fc85}"
        case .vscRegular: return "\u{fc86}"
        case .waffleMenuBold: return "\u{fc87}"
        case .waffleMenuLight: return "\u{fc88}"
        case .waffleMenuRegular: return "\u{fc89}"
        case .waitingRoomBold: return "\u{fc8a}"
        case .waitingRoomLight: return "\u{fc8b}"
        case .waitingRoomRegular: return "\u{fc8c}"
        case .wallpaperBold: return "\u{fc8d}"
        case .wallpaperLight: return "\u{fc8e}"
        case .wallpaperRegular: return "\u{fc8f}"
        case .warningBadgeFilled: return "\u{fc90}"
        case .warningBold: return "\u{fc91}"
        case .warningFilled: return "\u{fc92}"
        case .warningLight: return "\u{fc93}"
        case .warningRegular: return "\u{fc94}"
        case .webexBoardBold: return "\u{fc95}"
        case .webexBoardLight: return "\u{fc96}"
        case .webexBoardRegular: return "\u{fc97}"
        case .webexCodecPlusBold: return "\u{fc98}"
        case .webexCodecPlusLight: return "\u{fc99}"
        case .webexCodecPlusRegular: return "\u{fc9a}"
        case .webexDeskCameraBold: return "\u{fc9b}"
        case .webexDeskCameraLight: return "\u{fc9c}"
        case .webexDeskCameraRegular: return "\u{fc9d}"
        case .webexHelixBold: return "\u{fc9e}"
        case .webexHelixLight: return "\u{fc9f}"
        case .webexHelixRegular: return "\u{fca0}"
        case .webexMeetingsBold: return "\u{fca1}"
        case .webexMeetingsFilled: return "\u{fca2}"
        case .webexMeetingsLight: return "\u{fca3}"
        case .webexMeetingsRegular: return "\u{fca4}"
        case .webexQuadCameraBold: return "\u{fca5}"
        case .webexQuadCameraLight: return "\u{fca6}"
        case .webexQuadCameraRegular: return "\u{fca7}"
        case .webexRoomKitBold: return "\u{fca8}"
        case .webexRoomKitLight: return "\u{fca9}"
        case .webexRoomKitPlusBold: return "\u{fcaa}"
        case .webexRoomKitPlusLight: return "\u{fcab}"
        case .webexRoomKitPlusRegular: return "\u{fcac}"
        case .webexRoomKitRegular: return "\u{fcad}"
        case .webexShareBold: return "\u{fcae}"
        case .webexShareLight: return "\u{fcaf}"
        case .webexShareRegular: return "\u{fcb0}"
        case .webexTeamsBold: return "\u{fcb1}"
        case .webexTeamsFilled: return "\u{fcb2}"
        case .webexTeamsLight: return "\u{fcb3}"
        case .webexTeamsNewBold: return "\u{fcb4}"
        case .webexTeamsNewFilled: return "\u{fcb5}"
        case .webexTeamsNewLight: return "\u{fcb6}"
        case .webexTeamsNewRegular: return "\u{fcb7}"
        case .webexTeamsRegular: return "\u{fcb8}"
        case .webexTeamsRemoveBold: return "\u{fcb9}"
        case .webexTeamsRemoveLight: return "\u{fcba}"
        case .webexTeamsRemoveRegular: return "\u{fcbb}"
        case .webhookBold: return "\u{fcbc}"
        case .webhookLight: return "\u{fcbd}"
        case .webhookRegular: return "\u{fcbe}"
        case .webinarBold: return "\u{fcbf}"
        case .webinarFilled: return "\u{fcc0}"
        case .webinarLight: return "\u{fcc1}"
        case .webinarRegular: return "\u{fcc2}"
        case .weeklyRecurringScheduleBold: return "\u{fcc3}"
        case .weeklyRecurringScheduleLight: return "\u{fcc4}"
        case .weeklyRecurringScheduleRegular: return "\u{fcc5}"
        case .whisperAnnouncementBold: return "\u{fcc6}"
        case .whisperAnnouncementFilled: return "\u{fcc7}"
        case .whisperAnnouncementLight: return "\u{fcc8}"
        case .whisperAnnouncementRegular: return "\u{fcc9}"
        case .whisperCoachBold: return "\u{fcca}"
        case .whisperCoachFilled: return "\u{fccb}"
        case .whisperCoachLight: return "\u{fccc}"
        case .whisperCoachRegular: return "\u{fccd}"
        case .whiteboardBold: return "\u{fcce}"
        case .whiteboardContentBold: return "\u{fccf}"
        case .whiteboardContentFilled: return "\u{fcd0}"
        case .whiteboardContentLight: return "\u{fcd1}"
        case .whiteboardContentRegular: return "\u{fcd2}"
        case .whiteboardFilled: return "\u{fcd3}"
        case .whiteboardLight: return "\u{fcd4}"
        case .whiteboardRegular: return "\u{fcd5}"
        case .widgetBold: return "\u{fcd6}"
        case .widgetFilled: return "\u{fcd7}"
        case .widgetLight: return "\u{fcd8}"
        case .widgetRegular: return "\u{fcd9}"
        case .wifiBold: return "\u{fcda}"
        case .wifiErrorBold: return "\u{fcdb}"
        case .wifiErrorLight: return "\u{fcdc}"
        case .wifiErrorRegular: return "\u{fcdd}"
        case .wifiLight: return "\u{fcde}"
        case .wifiRegular: return "\u{fcdf}"
        case .wifiSignalGoodBold: return "\u{fce0}"
        case .wifiSignalGoodLight: return "\u{fce1}"
        case .wifiSignalGoodRegular: return "\u{fce2}"
        case .wifiSignalPoorBold: return "\u{fce3}"
        case .wifiSignalPoorLight: return "\u{fce4}"
        case .wifiSignalPoorRegular: return "\u{fce5}"
        case .wifiSignalUnstableBold: return "\u{fce6}"
        case .wifiSignalUnstableLight: return "\u{fce7}"
        case .wifiSignalUnstableRegular: return "\u{fce8}"
        case .windowCornerScrubBold: return "\u{fce9}"
        case .windowCornerScrubLight: return "\u{fcea}"
        case .windowCornerScrubRegular: return "\u{fceb}"
        case .windowRightCornerScrubBold: return "\u{fcec}"
        case .windowRightCornerScrubLight: return "\u{fced}"
        case .windowRightCornerScrubRegular: return "\u{fcee}"
        case .windowVerticalScrubBold: return "\u{fcef}"
        case .windowVerticalScrubLight: return "\u{fcf0}"
        case .windowVerticalScrubRegular: return "\u{fcf1}"
        case .workflowDeploymentsBold: return "\u{fcf2}"
        case .workflowDeploymentsFilled: return "\u{fcf3}"
        case .workflowDeploymentsLight: return "\u{fcf4}"
        case .workflowDeploymentsRegular: return "\u{fcf5}"
        case .workphoneBold: return "\u{fcf6}"
        case .workphoneLight: return "\u{fcf7}"
        case .workphoneRegular: return "\u{fcf8}"
        case .zoomInBold: return "\u{fcf9}"
        case .zoomInLight: return "\u{fcfa}"
        case .zoomInRegular: return "\u{fcfb}"
        case .zoomOutBold: return "\u{fcfc}"
        case .zoomOutLight: return "\u{fcfd}"
        case .zoomOutRegular: return "\u{fcfe}"
