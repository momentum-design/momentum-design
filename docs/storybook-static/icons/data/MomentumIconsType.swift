...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .emergencyCallbackNumberBold: return "\u{f4e5}"
        case .emergencyCallbackNumberFilled: return "\u{f4e6}"
        case .emergencyCallbackNumberLight: return "\u{f4e7}"
        case .emergencyCallbackNumberRegular: return "\u{f4e8}"
        case .emojiExcitedBold: return "\u{f4e9}"
        case .emojiExcitedFilled: return "\u{f4ea}"
        case .emojiExcitedLight: return "\u{f4eb}"
        case .emojiExcitedRegular: return "\u{f4ec}"
        case .emojiHappyBold: return "\u{f4ed}"
        case .emojiHappyFilled: return "\u{f4ee}"
        case .emojiHappyLight: return "\u{f4ef}"
        case .emojiHappyRegular: return "\u{f4f0}"
        case .emojiPassiveBold: return "\u{f4f1}"
        case .emojiPassiveFilled: return "\u{f4f2}"
        case .emojiPassiveLight: return "\u{f4f3}"
        case .emojiPassiveRegular: return "\u{f4f4}"
        case .emojiSadBold: return "\u{f4f5}"
        case .emojiSadFilled: return "\u{f4f6}"
        case .emojiSadLight: return "\u{f4f7}"
        case .emojiSadRegular: return "\u{f4f8}"
        case .emojiUnhappyBold: return "\u{f4f9}"
        case .emojiUnhappyFilled: return "\u{f4fa}"
        case .emojiUnhappyLight: return "\u{f4fb}"
        case .emojiUnhappyRegular: return "\u{f4fc}"
        case .encryptionCircleFilled: return "\u{f4fd}"
        case .encryptionFilled: return "\u{f4fe}"
        case .endRemoteDesktopControlBold: return "\u{f4ff}"
        case .endRemoteDesktopControlLight: return "\u{f500}"
        case .endRemoteDesktopControlRegular: return "\u{f501}"
        case .endToEndEncryptionCircleFilled: return "\u{f502}"
        case .endToEndEncryptionFilled: return "\u{f503}"
        case .endpointBlockedBold: return "\u{f504}"
        case .endpointBlockedLight: return "\u{f505}"
        case .endpointBlockedRegular: return "\u{f506}"
        case .endpointBold: return "\u{f507}"
        case .endpointGTwoBold: return "\u{f508}"
        case .endpointGTwoLight: return "\u{f509}"
        case .endpointGTwoRegular: return "\u{f50a}"
        case .endpointGTwoSeventyBold: return "\u{f50b}"
        case .endpointGTwoSeventyDualBold: return "\u{f50c}"
        case .endpointGTwoSeventyDualLight: return "\u{f50d}"
        case .endpointGTwoSeventyDualRegular: return "\u{f50e}"
        case .endpointGTwoSeventyLight: return "\u{f50f}"
        case .endpointGTwoSeventyRegular: return "\u{f510}"
        case .endpointGTwoStandBold: return "\u{f511}"
        case .endpointGTwoStandLight: return "\u{f512}"
        case .endpointGTwoStandRegular: return "\u{f513}"
        case .endpointLight: return "\u{f514}"
        case .endpointMxEightHundredBold: return "\u{f515}"
        case .endpointMxEightHundredDualBold: return "\u{f516}"
        case .endpointMxEightHundredDualLight: return "\u{f517}"
        case .endpointMxEightHundredDualRegular: return "\u{f518}"
        case .endpointMxEightHundredLight: return "\u{f519}"
        case .endpointMxEightHundredRegular: return "\u{f51a}"
        case .endpointRegular: return "\u{f51b}"
        case .endpointStandBold: return "\u{f51c}"
        case .endpointStandFilled: return "\u{f51d}"
        case .endpointStandLight: return "\u{f51e}"
        case .endpointStandRegular: return "\u{f51f}"
        case .endpointWarningBold: return "\u{f520}"
        case .endpointWarningLight: return "\u{f521}"
        case .endpointWarningRegular: return "\u{f522}"
        case .enterBold: return "\u{f523}"
        case .enterLight: return "\u{f524}"
        case .enterRegular: return "\u{f525}"
        case .enterRoomBold: return "\u{f526}"
        case .enterRoomFilled: return "\u{f527}"
        case .enterRoomLight: return "\u{f528}"
        case .enterRoomRegular: return "\u{f529}"
        case .eraserBold: return "\u{f52a}"
        case .eraserFilled: return "\u{f52b}"
        case .eraserLight: return "\u{f52c}"
        case .eraserRegular: return "\u{f52d}"
        case .errorLegacyBadgeFilled: return "\u{f52e}"
        case .errorLegacyBold: return "\u{f52f}"
        case .errorLegacyFilled: return "\u{f530}"
        case .errorLegacyLight: return "\u{f531}"
        case .errorLegacyRegular: return "\u{f532}"
        case .ethernetBold: return "\u{f533}"
        case .ethernetFilled: return "\u{f534}"
        case .ethernetLight: return "\u{f535}"
        case .ethernetRegular: return "\u{f536}"
        case .exchangeBold: return "\u{f537}"
        case .exchangeLight: return "\u{f538}"
        case .exchangeRegular: return "\u{f539}"
        case .exclamationBold: return "\u{f53a}"
        case .exclamationLight: return "\u{f53b}"
        case .exclamationRegular: return "\u{f53c}"
        case .excludeBold: return "\u{f53d}"
        case .excludeLight: return "\u{f53e}"
        case .excludeRegular: return "\u{f53f}"
        case .existingTargetGroupBold: return "\u{f540}"
        case .existingTargetGroupLight: return "\u{f541}"
        case .existingTargetGroupRegular: return "\u{f542}"
        case .exitRoomBold: return "\u{f543}"
        case .exitRoomLight: return "\u{f544}"
        case .exitRoomRegular: return "\u{f545}"
        case .exploreBold: return "\u{f546}"
        case .exploreLight: return "\u{f547}"
        case .exploreRegular: return "\u{f548}"
        case .exportBold: return "\u{f549}"
        case .exportLight: return "\u{f54a}"
        case .exportRegular: return "\u{f54b}"
        case .extensionMobilityBold: return "\u{f54c}"
        case .extensionMobilityLight: return "\u{f54d}"
        case .extensionMobilityRegular: return "\u{f54e}"
        case .externalMessageBold: return "\u{f54f}"
        case .externalMessageLight: return "\u{f550}"
        case .externalMessageRegular: return "\u{f551}"
        case .externalUserBold: return "\u{f552}"
        case .externalUserLight: return "\u{f553}"
        case .externalUserRegular: return "\u{f554}"
        case .familyFontBold: return "\u{f555}"
        case .familyFontLight: return "\u{f556}"
        case .familyFontRegular: return "\u{f557}"
        case .fastForwardBold: return "\u{f558}"
        case .fastForwardLight: return "\u{f559}"
        case .fastForwardRegular: return "\u{f55a}"
        case .favoriteBold: return "\u{f55b}"
        case .favoriteFilled: return "\u{f55c}"
        case .favoriteLight: return "\u{f55d}"
        case .favoriteRegular: return "\u{f55e}"
        case .favoritesBold: return "\u{f55f}"
        case .favoritesFilled: return "\u{f560}"
        case .favoritesLight: return "\u{f561}"
        case .favoritesRegular: return "\u{f562}"
        case .fbwBold: return "\u{f563}"
        case .fbwFilled: return "\u{f564}"
        case .fbwLight: return "\u{f565}"
        case .fbwRegular: return "\u{f566}"
        case .ffwBold: return "\u{f567}"
        case .ffwFilled: return "\u{f568}"
        case .ffwLight: return "\u{f569}"
        case .ffwRegular: return "\u{f56a}"
        case .fileAnalysisBold: return "\u{f56b}"
        case .fileAnalysisFilled: return "\u{f56c}"
        case .fileAnalysisLight: return "\u{f56d}"
        case .fileAnalysisRegular: return "\u{f56e}"
        case .fileAnnotationBold: return "\u{f56f}"
        case .fileAnnotationFilled: return "\u{f570}"
        case .fileAnnotationLight: return "\u{f571}"
        case .fileAnnotationRegular: return "\u{f572}"
        case .fileAudioBold: return "\u{f573}"
        case .fileAudioFilled: return "\u{f574}"
        case .fileAudioLight: return "\u{f575}"
        case .fileAudioRegular: return "\u{f576}"
        case .fileBugBold: return "\u{f577}"
        case .fileBugFilled: return "\u{f578}"
        case .fileBugLight: return "\u{f579}"
        case .fileBugRegular: return "\u{f57a}"
        case .fileCodeBold: return "\u{f57b}"
        case .fileCodeFilled: return "\u{f57c}"
        case .fileCodeLight: return "\u{f57d}"
        case .fileCodeRegular: return "\u{f57e}"
        case .fileDashboardBold: return "\u{f57f}"
        case .fileDashboardFilled: return "\u{f580}"
        case .fileDashboardLight: return "\u{f581}"
        case .fileDashboardRegular: return "\u{f582}"
        case .fileExcelBold: return "\u{f583}"
        case .fileExcelFilled: return "\u{f584}"
        case .fileExcelLight: return "\u{f585}"
        case .fileExcelRegular: return "\u{f586}"
        case .fileGraphBold: return "\u{f587}"
        case .fileGraphFilled: return "\u{f588}"
        case .fileGraphLight: return "\u{f589}"
        case .fileGraphRegular: return "\u{f58a}"
        case .fileImageBold: return "\u{f58b}"
        case .fileImageFilled: return "\u{f58c}"
        case .fileImageLight: return "\u{f58d}"
        case .fileImageNoneBold: return "\u{f58e}"
        case .fileImageNoneLight: return "\u{f58f}"
        case .fileImageNoneRegular: return "\u{f590}"
        case .fileImageRegular: return "\u{f591}"
        case .fileJsBold: return "\u{f592}"
        case .fileJsFilled: return "\u{f593}"
        case .fileJsLight: return "\u{f594}"
        case .fileJsRegular: return "\u{f595}"
        case .fileKeynoteBold: return "\u{f596}"
        case .fileKeynoteFilled: return "\u{f597}"
        case .fileKeynoteLight: return "\u{f598}"
        case .fileKeynoteRegular: return "\u{f599}"
        case .fileLockedBold: return "\u{f59a}"
        case .fileLockedFilled: return "\u{f59b}"
        case .fileLockedLight: return "\u{f59c}"
        case .fileLockedRegular: return "\u{f59d}"
        case .fileMissingBold: return "\u{f59e}"
        case .fileMissingFilled: return "\u{f59f}"
        case .fileMissingLight: return "\u{f5a0}"
        case .fileMissingRegular: return "\u{f5a1}"
        case .fileMusicBold: return "\u{f5a2}"
        case .fileMusicFilled: return "\u{f5a3}"
        case .fileMusicLight: return "\u{f5a4}"
        case .fileMusicRegular: return "\u{f5a5}"
        case .fileOnenoteBold: return "\u{f5a6}"
        case .fileOnenoteFilled: return "\u{f5a7}"
        case .fileOnenoteLight: return "\u{f5a8}"
        case .fileOnenoteRegular: return "\u{f5a9}"
        case .filePdfBold: return "\u{f5aa}"
        case .filePdfFilled: return "\u{f5ab}"
        case .filePdfLight: return "\u{f5ac}"
        case .filePdfRegular: return "\u{f5ad}"
        case .filePowerpointBold: return "\u{f5ae}"
        case .filePowerpointFilled: return "\u{f5af}"
        case .filePowerpointLight: return "\u{f5b0}"
        case .filePowerpointRegular: return "\u{f5b1}"
        case .fileSpreadsheetBold: return "\u{f5b2}"
        case .fileSpreadsheetFilled: return "\u{f5b3}"
        case .fileSpreadsheetLight: return "\u{f5b4}"
        case .fileSpreadsheetRegular: return "\u{f5b5}"
        case .fileTextBold: return "\u{f5b6}"
        case .fileTextFilled: return "\u{f5b7}"
        case .fileTextLight: return "\u{f5b8}"
        case .fileTextRegular: return "\u{f5b9}"
        case .fileThreeDBold: return "\u{f5ba}"
        case .fileThreeDFilled: return "\u{f5bb}"
        case .fileThreeDLight: return "\u{f5bc}"
        case .fileThreeDRegular: return "\u{f5bd}"
        case .fileVectorBold: return "\u{f5be}"
        case .fileVectorFilled: return "\u{f5bf}"
        case .fileVectorLight: return "\u{f5c0}"
        case .fileVectorRegular: return "\u{f5c1}"
        case .fileVideoBold: return "\u{f5c2}"
        case .fileVideoFilled: return "\u{f5c3}"
        case .fileVideoLight: return "\u{f5c4}"
        case .fileVideoRegular: return "\u{f5c5}"
        case .fileWordBold: return "\u{f5c6}"
        case .fileWordFilled: return "\u{f5c7}"
        case .fileWordLight: return "\u{f5c8}"
        case .fileWordRegular: return "\u{f5c9}"
        case .fileXmlBold: return "\u{f5ca}"
        case .fileXmlFilled: return "\u{f5cb}"
        case .fileXmlLight: return "\u{f5cc}"
        case .fileXmlRegular: return "\u{f5cd}"
        case .fileZipBold: return "\u{f5ce}"
        case .fileZipFilled: return "\u{f5cf}"
        case .fileZipLight: return "\u{f5d0}"
        case .fileZipRegular: return "\u{f5d1}"
        case .filesBold: return "\u{f5d2}"
        case .filesFilled: return "\u{f5d3}"
        case .filesLight: return "\u{f5d4}"
        case .filesRegular: return "\u{f5d5}"
        case .fillColourBold: return "\u{f5d6}"
        case .fillColourFilled: return "\u{f5d7}"
        case .fillColourLight: return "\u{f5d8}"
        case .fillColourRegular: return "\u{f5d9}"
        case .filterBold: return "\u{f5da}"
        case .filterCircleBold: return "\u{f5db}"
        case .filterCircleFilled: return "\u{f5dc}"
        case .filterCircleLight: return "\u{f5dd}"
        case .filterCircleRegular: return "\u{f5de}"
        case .filterLight: return "\u{f5df}"
        case .filterRegular: return "\u{f5e0}"
        case .fitToWidthBold: return "\u{f5e1}"
        case .fitToWidthLight: return "\u{f5e2}"
        case .fitToWidthRegular: return "\u{f5e3}"
        case .fitToWindowExpandBold: return "\u{f5e4}"
        case .fitToWindowExpandLight: return "\u{f5e5}"
        case .fitToWindowExpandRegular: return "\u{f5e6}"
        case .fitToWindowShrinkBold: return "\u{f5e7}"
        case .fitToWindowShrinkLight: return "\u{f5e8}"
        case .fitToWindowShrinkRegular: return "\u{f5e9}"
        case .flagBold: return "\u{f5ea}"
        case .flagCircleBold: return "\u{f5eb}"
        case .flagCircleFilled: return "\u{f5ec}"
        case .flagCircleLight: return "\u{f5ed}"
        case .flagCircleRegular: return "\u{f5ee}"
        case .flagFilled: return "\u{f5ef}"
        case .flagLight: return "\u{f5f0}"
        case .flagRegular: return "\u{f5f1}"
        case .folderBold: return "\u{f5f2}"
        case .folderEditBold: return "\u{f5f3}"
        case .folderEditLight: return "\u{f5f4}"
        case .folderEditRegular: return "\u{f5f5}"
        case .folderFilled: return "\u{f5f6}"
        case .folderLight: return "\u{f5f7}"
        case .folderLockBold: return "\u{f5f8}"
        case .folderLockLight: return "\u{f5f9}"
        case .folderLockRegular: return "\u{f5fa}"
        case .folderRegular: return "\u{f5fb}"
        case .folderViewBold: return "\u{f5fc}"
        case .folderViewLight: return "\u{f5fd}"
        case .folderViewRegular: return "\u{f5fe}"
        case .followUpBold: return "\u{f5ff}"
        case .followUpLight: return "\u{f600}"
        case .followUpRegular: return "\u{f601}"
        case .foodBold: return "\u{f602}"
        case .foodFilled: return "\u{f603}"
        case .foodLight: return "\u{f604}"
        case .foodRegular: return "\u{f605}"
        case .forecastBold: return "\u{f606}"
        case .forecastFilled: return "\u{f607}"
        case .forecastLight: return "\u{f608}"
        case .forecastRegular: return "\u{f609}"
        case .formatBold: return "\u{f60a}"
        case .formatDefaultAppBold: return "\u{f60b}"
        case .formatDefaultAppFilled: return "\u{f60c}"
        case .formatDefaultAppLight: return "\u{f60d}"
        case .formatDefaultAppRegular: return "\u{f60e}"
        case .formatLight: return "\u{f60f}"
        case .formatPanelControlBarBold: return "\u{f610}"
        case .formatPanelControlBarLight: return "\u{f611}"
        case .formatPanelControlBarRegular: return "\u{f612}"
        case .formatPanelControlDownBold: return "\u{f613}"
        case .formatPanelControlDownLight: return "\u{f614}"
        case .formatPanelControlDownRegular: return "\u{f615}"
        case .formatPanelControlLeftBold: return "\u{f616}"
        case .formatPanelControlLeftLight: return "\u{f617}"
        case .formatPanelControlLeftRegular: return "\u{f618}"
        case .formatPanelControlRightBold: return "\u{f619}"
        case .formatPanelControlRightLight: return "\u{f61a}"
        case .formatPanelControlRightRegular: return "\u{f61b}"
        case .formatPanelControlUpBold: return "\u{f61c}"
        case .formatPanelControlUpDownBold: return "\u{f61d}"
        case .formatPanelControlUpDownLight: return "\u{f61e}"
        case .formatPanelControlUpDownRegular: return "\u{f61f}"
        case .formatPanelControlUpLight: return "\u{f620}"
        case .formatPanelControlUpRegular: return "\u{f621}"
        case .formatRegular: return "\u{f622}"
        case .formatViewMixedBold: return "\u{f623}"
        case .formatViewMixedLight: return "\u{f624}"
        case .formatViewMixedRegular: return "\u{f625}"
        case .formulaBold: return "\u{f626}"
        case .formulaFilled: return "\u{f627}"
        case .formulaLight: return "\u{f628}"
        case .formulaRegular: return "\u{f629}"
        case .forwardMessageBold: return "\u{f62a}"
        case .forwardMessageFilled: return "\u{f62b}"
        case .forwardMessageLight: return "\u{f62c}"
        case .forwardMessageRegular: return "\u{f62d}"
        case .forwardTenSecBold: return "\u{f62e}"
        case .forwardTenSecLight: return "\u{f62f}"
        case .forwardTenSecRegular: return "\u{f630}"
        case .fourColumnBold: return "\u{f631}"
        case .fourColumnLight: return "\u{f632}"
        case .fourColumnRegular: return "\u{f633}"
        case .fourWayNavigationBold: return "\u{f634}"
        case .fourWayNavigationLight: return "\u{f635}"
        case .fourWayNavigationRegular: return "\u{f636}"
        case .frequencyCappingBold: return "\u{f637}"
        case .frequencyCappingLight: return "\u{f638}"
        case .frequencyCappingRegular: return "\u{f639}"
        case .fulfillmentBold: return "\u{f63a}"
        case .fulfillmentLight: return "\u{f63b}"
        case .fulfillmentRegular: return "\u{f63c}"
        case .fullscreenBold: return "\u{f63d}"
        case .fullscreenExitBold: return "\u{f63e}"
        case .fullscreenExitLight: return "\u{f63f}"
        case .fullscreenExitRegular: return "\u{f640}"
        case .fullscreenLight: return "\u{f641}"
        case .fullscreenRegular: return "\u{f642}"
        case .genericDeviceVideoBadgeFilled: return "\u{f643}"
        case .genericDeviceVideoBold: return "\u{f644}"
        case .genericDeviceVideoFilled: return "\u{f645}"
        case .genericDeviceVideoLight: return "\u{f646}"
        case .genericDeviceVideoRegular: return "\u{f647}"
        case .gifBold: return "\u{f648}"
        case .gifFilled: return "\u{f649}"
        case .gifHorizontalBold: return "\u{f64a}"
        case .gifHorizontalFilled: return "\u{f64b}"
        case .gifHorizontalLight: return "\u{f64c}"
        case .gifHorizontalRegular: return "\u{f64d}"
        case .gifLight: return "\u{f64e}"
        case .gifRegular: return "\u{f64f}"
        case .giftBold: return "\u{f650}"
        case .giftFilled: return "\u{f651}"
        case .giftLight: return "\u{f652}"
        case .giftRegular: return "\u{f653}"
        case .greenLeafBold: return "\u{f654}"
        case .greenLeafFilled: return "\u{f655}"
        case .greenLeafLight: return "\u{f656}"
        case .greenLeafRegular: return "\u{f657}"
        case .greenRoomBold: return "\u{f658}"
        case .greenRoomFilled: return "\u{f659}"
        case .greenRoomLight: return "\u{f65a}"
        case .greenRoomRegular: return "\u{f65b}"
        case .guestIssuerBold: return "\u{f65c}"
        case .guestIssuerLight: return "\u{f65d}"
        case .guestIssuerRegular: return "\u{f65e}"
        case .guideBold: return "\u{f65f}"
        case .guideLight: return "\u{f660}"
        case .guideRegular: return "\u{f661}"
        case .handPointerBold: return "\u{f662}"
        case .handPointerLight: return "\u{f663}"
        case .handPointerRegular: return "\u{f664}"
        case .handlerBold: return "\u{f665}"
        case .handlerHorizontalBold: return "\u{f666}"
        case .handlerHorizontalLight: return "\u{f667}"
        case .handlerHorizontalRegular: return "\u{f668}"
        case .handlerLight: return "\u{f669}"
        case .handlerRegular: return "\u{f66a}"
        case .handsetAlertBold: return "\u{f66b}"
        case .handsetAlertFilled: return "\u{f66c}"
        case .handsetAlertLight: return "\u{f66d}"
        case .handsetAlertRegular: return "\u{f66e}"
        case .handsetBold: return "\u{f66f}"
        case .handsetDownSlashBold: return "\u{f670}"
        case .handsetDownSlashFilled: return "\u{f671}"
        case .handsetDownSlashLight: return "\u{f672}"
        case .handsetDownSlashRegular: return "\u{f673}"
        case .handsetFilled: return "\u{f674}"
        case .handsetLight: return "\u{f675}"
        case .handsetMutedBold: return "\u{f676}"
        case .handsetMutedFilled: return "\u{f677}"
        case .handsetMutedLight: return "\u{f678}"
        case .handsetMutedRegular: return "\u{f679}"
        case .handsetRegular: return "\u{f67a}"
        case .handsetsArrowLeftBold: return "\u{f67b}"
        case .handsetsArrowLeftLight: return "\u{f67c}"
        case .handsetsArrowLeftRegular: return "\u{f67d}"
        case .handshakeBold: return "\u{f67e}"
        case .handshakeLight: return "\u{f67f}"
        case .handshakeRegular: return "\u{f680}"
        case .headingOneBold: return "\u{f681}"
        case .headingOneLight: return "\u{f682}"
        case .headingOneRegular: return "\u{f683}"
        case .headingThreeBold: return "\u{f684}"
        case .headingThreeLight: return "\u{f685}"
        case .headingThreeRegular: return "\u{f686}"
        case .headingTwoBold: return "\u{f687}"
        case .headingTwoLight: return "\u{f688}"
        case .headingTwoRegular: return "\u{f689}"
        case .headphonesBold: return "\u{f68a}"
        case .headphonesFilled: return "\u{f68b}"
        case .headphonesLight: return "\u{f68c}"
        case .headphonesMutedBold: return "\u{f68d}"
        case .headphonesMutedFilled: return "\u{f68e}"
        case .headphonesMutedLight: return "\u{f68f}"
        case .headphonesMutedRegular: return "\u{f690}"
        case .headphonesRegular: return "\u{f691}"
        case .headsetAlertBold: return "\u{f692}"
        case .headsetAlertLight: return "\u{f693}"
        case .headsetAlertRegular: return "\u{f694}"
        case .headsetArrowDownBold: return "\u{f695}"
        case .headsetArrowDownFilled: return "\u{f696}"
        case .headsetArrowDownLight: return "\u{f697}"
        case .headsetArrowDownRegular: return "\u{f698}"
        case .headsetBluetoothBold: return "\u{f699}"
        case .headsetBluetoothLight: return "\u{f69a}"
        case .headsetBluetoothRegular: return "\u{f69b}"
        case .headsetBold: return "\u{f69c}"
        case .headsetFilled: return "\u{f69d}"
        case .headsetLight: return "\u{f69e}"
        case .headsetMutedBold: return "\u{f69f}"
        case .headsetMutedLight: return "\u{f6a0}"
        case .headsetMutedRegular: return "\u{f6a1}"
        case .headsetPrivateBold: return "\u{f6a2}"
        case .headsetPrivateLight: return "\u{f6a3}"
        case .headsetPrivateRegular: return "\u{f6a4}"
        case .headsetRegular: return "\u{f6a5}"
        case .hearingBold: return "\u{f6a6}"
        case .hearingImpairedBold: return "\u{f6a7}"
        case .hearingImpairedLight: return "\u{f6a8}"
        case .hearingImpairedRegular: return "\u{f6a9}"
        case .hearingLight: return "\u{f6aa}"
        case .hearingRegular: return "\u{f6ab}"
        case .helpBold: return "\u{f6ac}"
        case .helpCircleBold: return "\u{f6ad}"
        case .helpCircleFilled: return "\u{f6ae}"
        case .helpCircleLight: return "\u{f6af}"
        case .helpCircleRegular: return "\u{f6b0}"
        case .helpLight: return "\u{f6b1}"
        case .helpRegular: return "\u{f6b2}"
        case .helpdeskBold: return "\u{f6b3}"
        case .helpdeskFilled: return "\u{f6b4}"
        case .helpdeskLight: return "\u{f6b5}"
        case .helpdeskRegular: return "\u{f6b6}"
        case .hideBold: return "\u{f6b7}"
        case .hideFilled: return "\u{f6b8}"
        case .hideLight: return "\u{f6b9}"
        case .hideRegular: return "\u{f6ba}"
        case .homeBold: return "\u{f6bb}"
        case .homeFilled: return "\u{f6bc}"
        case .homeLight: return "\u{f6bd}"
        case .homeRegular: return "\u{f6be}"
        case .horizontalLineBold: return "\u{f6bf}"
        case .horizontalLineLight: return "\u{f6c0}"
        case .horizontalLineRegular: return "\u{f6c1}"
        case .hotelingBold: return "\u{f6c2}"
        case .hotelingFilled: return "\u{f6c3}"
        case .hotelingLight: return "\u{f6c4}"
        case .hotelingRegular: return "\u{f6c5}"
        case .humidityBold: return "\u{f6c6}"
        case .humidityLight: return "\u{f6c7}"
        case .humidityRegular: return "\u{f6c8}"
        case .huntGroupBold: return "\u{f6c9}"
        case .huntGroupFilled: return "\u{f6ca}"
        case .huntGroupLight: return "\u{f6cb}"
        case .huntGroupRegular: return "\u{f6cc}"
        case .idleBold: return "\u{f6cd}"
        case .idleFilled: return "\u{f6ce}"
        case .idleLight: return "\u{f6cf}"
        case .idleRegular: return "\u{f6d0}"
        case .immediateBold: return "\u{f6d1}"
        case .immediateFilled: return "\u{f6d2}"
        case .immediateLight: return "\u{f6d3}"
        case .immediateRegular: return "\u{f6d4}"
        case .importBold: return "\u{f6d5}"
        case .importLight: return "\u{f6d6}"
        case .importRegular: return "\u{f6d7}"
        case .inCommonBold: return "\u{f6d8}"
        case .inCommonLight: return "\u{f6d9}"
        case .inCommonRegular: return "\u{f6da}"
        case .inboxBold: return "\u{f6db}"
        case .inboxFilled: return "\u{f6dc}"
        case .inboxLight: return "\u{f6dd}"
        case .inboxRegular: return "\u{f6de}"
        case .includeBold: return "\u{f6df}"
        case .includeLight: return "\u{f6e0}"
        case .includeRegular: return "\u{f6e1}"
        case .incognitoBold: return "\u{f6e2}"
        case .incognitoFilled: return "\u{f6e3}"
        case .incognitoLight: return "\u{f6e4}"
        case .incognitoRegular: return "\u{f6e5}"
        case .incomingCallLegacyBold: return "\u{f6e6}"
        case .incomingCallLegacyFilled: return "\u{f6e7}"
        case .incomingCallLegacyLight: return "\u{f6e8}"
        case .incomingCallLegacyRegular: return "\u{f6e9}"
        case .indentDecreaseBold: return "\u{f6ea}"
        case .indentDecreaseLight: return "\u{f6eb}"
        case .indentDecreaseRegular: return "\u{f6ec}"
        case .indentIncreaseBold: return "\u{f6ed}"
        case .indentIncreaseLight: return "\u{f6ee}"
        case .indentIncreaseRegular: return "\u{f6ef}"
        case .infoBadgeFilled: return "\u{f6f0}"
        case .infoCircleBold: return "\u{f6f1}"
        case .infoCircleFilled: return "\u{f6f2}"
        case .infoCircleLight: return "\u{f6f3}"
        case .infoCircleRegular: return "\u{f6f4}"
        case .infoCircleTwoBold: return "\u{f6f5}"
        case .infoCircleTwoFilled: return "\u{f6f6}"
        case .infoCircleTwoLight: return "\u{f6f7}"
        case .infoCircleTwoRegular: return "\u{f6f8}"
        case .inputBold: return "\u{f6f9}"
        case .inputDisconnectedBold: return "\u{f6fa}"
        case .inputDisconnectedLight: return "\u{f6fb}"
        case .inputDisconnectedRegular: return "\u{f6fc}"
        case .inputLight: return "\u{f6fd}"
        case .inputRegular: return "\u{f6fe}"
        case .instantScheduleBold: return "\u{f6ff}"
        case .instantScheduleFilled: return "\u{f700}"
        case .instantScheduleLight: return "\u{f701}"
        case .instantScheduleRegular: return "\u{f702}"
        case .integerBold: return "\u{f703}"
        case .integerFilled: return "\u{f704}"
        case .integerLight: return "\u{f705}"
        case .integerRegular: return "\u{f706}"
        case .integrationsBold: return "\u{f707}"
        case .integrationsFilled: return "\u{f708}"
        case .integrationsLight: return "\u{f709}"
        case .integrationsRegular: return "\u{f70a}"
        case .intelligentRoutingBold: return "\u{f70b}"
        case .intelligentRoutingLight: return "\u{f70c}"
        case .intelligentRoutingRegular: return "\u{f70d}"
        case .interactionBold: return "\u{f70e}"
        case .interactionFilled: return "\u{f70f}"
        case .interactionLight: return "\u{f710}"
        case .interactionRegular: return "\u{f711}"
        case .invitedUserBold: return "\u{f712}"
        case .invitedUserLight: return "\u{f713}"
        case .invitedUserRegular: return "\u{f714}"
        case .italicBold: return "\u{f715}"
        case .italicFilled: return "\u{f716}"
        case .italicLight: return "\u{f717}"
        case .italicRegular: return "\u{f718}"
        case .joinAudioBold: return "\u{f719}"
        case .joinAudioFilled: return "\u{f71a}"
        case .joinAudioLight: return "\u{f71b}"
        case .joinAudioRegular: return "\u{f71c}"
        case .keepInTouchBold: return "\u{f71d}"
        case .keepInTouchFilled: return "\u{f71e}"
        case .keepInTouchLight: return "\u{f71f}"
        case .keepInTouchRegular: return "\u{f720}"
        case .keyboardBold: return "\u{f721}"
        case .keyboardCloseBold: return "\u{f722}"
        case .keyboardCloseLight: return "\u{f723}"
        case .keyboardCloseRegular: return "\u{f724}"
        case .keyboardLight: return "\u{f725}"
        case .keyboardRegular: return "\u{f726}"
        case .languageBold: return "\u{f727}"
        case .languageFilled: return "\u{f728}"
        case .languageLight: return "\u{f729}"
        case .languageRegular: return "\u{f72a}"
        case .laptopBold: return "\u{f72b}"
        case .laptopDisconnectedBold: return "\u{f72c}"
        case .laptopDisconnectedLight: return "\u{f72d}"
        case .laptopDisconnectedRegular: return "\u{f72e}"
        case .laptopFilled: return "\u{f72f}"
        case .laptopLight: return "\u{f730}"
        case .laptopRegular: return "\u{f731}"
        case .laserPointerBold: return "\u{f732}"
        case .laserPointerCursorBlackLight: return "\u{f733}"
        case .laserPointerCursorBlueLight: return "\u{f734}"
        case .laserPointerCursorGreenLight: return "\u{f735}"
        case .laserPointerCursorPurpleLight: return "\u{f736}"
        case .laserPointerCursorRedLight: return "\u{f737}"
        case .laserPointerCursorWhiteLight: return "\u{f738}"
        case .laserPointerCursorYellowLight: return "\u{f739}"
        case .laserPointerFilled: return "\u{f73a}"
        case .laserPointerLight: return "\u{f73b}"
        case .laserPointerRegular: return "\u{f73c}"
        case .launchBold: return "\u{f73d}"
        case .launchFilled: return "\u{f73e}"
        case .launchLight: return "\u{f73f}"
        case .launchRegular: return "\u{f740}"
        case .layoutSideBySideVerticalBold: return "\u{f741}"
        case .layoutSideBySideVerticalFilled: return "\u{f742}"
        case .layoutSideBySideVerticalLight: return "\u{f743}"
        case .layoutSideBySideVerticalRegular: return "\u{f744}"
        case .leaveBreakoutSessionBold: return "\u{f745}"
        case .leaveBreakoutSessionLight: return "\u{f746}"
        case .leaveBreakoutSessionRegular: return "\u{f747}"
        case .leaveDeviceBold: return "\u{f748}"
        case .leaveDeviceLight: return "\u{f749}"
        case .leaveDeviceRegular: return "\u{f74a}"
        case .likeBold: return "\u{f74b}"
        case .likeFilled: return "\u{f74c}"
        case .likeLight: return "\u{f74d}"
        case .likeRegular: return "\u{f74e}"
        case .linkBold: return "\u{f74f}"
        case .linkLight: return "\u{f750}"
        case .linkRegular: return "\u{f751}"
        case .listBulletedBold: return "\u{f752}"
        case .listBulletedLight: return "\u{f753}"
        case .listBulletedRegular: return "\u{f754}"
        case .listMenuBold: return "\u{f755}"
        case .listMenuLight: return "\u{f756}"
        case .listMenuRegular: return "\u{f757}"
        case .listNumberedBold: return "\u{f758}"
        case .listNumberedLight: return "\u{f759}"
        case .listNumberedRegular: return "\u{f75a}"
        case .liveBold: return "\u{f75b}"
        case .liveFilled: return "\u{f75c}"
        case .liveLight: return "\u{f75d}"
        case .liveRegular: return "\u{f75e}"
        case .locationBold: return "\u{f75f}"
        case .locationFilled: return "\u{f760}"
        case .locationLight: return "\u{f761}"
        case .locationRegular: return "\u{f762}"
        case .longTextBoxBold: return "\u{f763}"
        case .longTextBoxLight: return "\u{f764}"
        case .longTextBoxRegular: return "\u{f765}"
        case .lowerHandBold: return "\u{f766}"
        case .lowerHandLight: return "\u{f767}"
        case .lowerHandRegular: return "\u{f768}"
        case .magicPenBold: return "\u{f769}"
        case .magicPenFilled: return "\u{f76a}"
        case .magicPenLight: return "\u{f76b}"
        case .magicPenRegular: return "\u{f76c}"
        case .markAsUnreadBold: return "\u{f76d}"
        case .markAsUnreadFilled: return "\u{f76e}"
        case .markAsUnreadLight: return "\u{f76f}"
        case .markAsUnreadRegular: return "\u{f770}"
        case .markdownBold: return "\u{f771}"
        case .markdownFilled: return "\u{f772}"
        case .markdownLight: return "\u{f773}"
        case .markdownRegular: return "\u{f774}"
        case .markerBold: return "\u{f775}"
        case .markerFilled: return "\u{f776}"
        case .markerLight: return "\u{f777}"
        case .markerRegular: return "\u{f778}"
        case .maximizeBold: return "\u{f779}"
        case .maximizeLight: return "\u{f77a}"
        case .maximizeRegular: return "\u{f77b}"
        case .mcpBold: return "\u{f77c}"
        case .mcpFilled: return "\u{f77d}"
        case .mcpLight: return "\u{f77e}"
        case .mcpRegular: return "\u{f77f}"
        case .mediaPlayerBold: return "\u{f780}"
        case .mediaPlayerLight: return "\u{f781}"
        case .mediaPlayerRegular: return "\u{f782}"
        case .mediaQualityGoodBold: return "\u{f783}"
        case .mediaQualityGoodFilled: return "\u{f784}"
        case .mediaQualityGoodLight: return "\u{f785}"
        case .mediaQualityGoodRegular: return "\u{f786}"
        case .mediaQualityPoorBold: return "\u{f787}"
        case .mediaQualityPoorColoredBold: return "\u{f788}"
        case .mediaQualityPoorFilled: return "\u{f789}"
        case .mediaQualityPoorLight: return "\u{f78a}"
        case .mediaQualityPoorRegular: return "\u{f78b}"
        case .mediaQualityUnstableBold: return "\u{f78c}"
        case .mediaQualityUnstableColoredBold: return "\u{f78d}"
        case .mediaQualityUnstableFilled: return "\u{f78e}"
        case .mediaQualityUnstableLight: return "\u{f78f}"
        case .mediaQualityUnstableRegular: return "\u{f790}"
        case .meetBold: return "\u{f791}"
        case .meetEndBold: return "\u{f792}"
        case .meetEndLight: return "\u{f793}"
        case .meetEndRegular: return "\u{f794}"
        case .meetFilled: return "\u{f795}"
        case .meetLight: return "\u{f796}"
        case .meetRegular: return "\u{f797}"
        case .meetingSummaryBold: return "\u{f798}"
        case .meetingSummaryFilled: return "\u{f799}"
        case .meetingSummaryLight: return "\u{f79a}"
        case .meetingSummaryRegular: return "\u{f79b}"
        case .meetingsBold: return "\u{f79c}"
        case .meetingsFilled: return "\u{f79d}"
        case .meetingsFocusMonthBold: return "\u{f79e}"
        case .meetingsFocusMonthLight: return "\u{f79f}"
        case .meetingsFocusMonthRegular: return "\u{f7a0}"
        case .meetingsFocusOneDayBold: return "\u{f7a1}"
        case .meetingsFocusOneDayLight: return "\u{f7a2}"
        case .meetingsFocusOneDayRegular: return "\u{f7a3}"
        case .meetingsFocusThreeDayBold: return "\u{f7a4}"
        case .meetingsFocusThreeDayLight: return "\u{f7a5}"
        case .meetingsFocusThreeDayRegular: return "\u{f7a6}"
        case .meetingsFocusUpcomingBold: return "\u{f7a7}"
        case .meetingsFocusUpcomingLight: return "\u{f7a8}"
        case .meetingsFocusUpcomingRegular: return "\u{f7a9}"
        case .meetingsLight: return "\u{f7aa}"
        case .meetingsPresenceBadgeFilled: return "\u{f7ab}"
        case .meetingsPresenceBold: return "\u{f7ac}"
        case .meetingsPresenceFilled: return "\u{f7ad}"
        case .meetingsPresenceLight: return "\u{f7ae}"
        case .meetingsPresenceRegular: return "\u{f7af}"
        case .meetingsRegular: return "\u{f7b0}"
        case .meetingsTeamBold: return "\u{f7b1}"
        case .meetingsTeamFilled: return "\u{f7b2}"
        case .meetingsTeamLight: return "\u{f7b3}"
        case .meetingsTeamNewBold: return "\u{f7b4}"
        case .meetingsTeamNewLight: return "\u{f7b5}"
        case .meetingsTeamNewRegular: return "\u{f7b6}"
        case .meetingsTeamRegular: return "\u{f7b7}"
        case .mentionBold: return "\u{f7b8}"
        case .mentionFilled: return "\u{f7b9}"
        case .mentionLight: return "\u{f7ba}"
        case .mentionRegular: return "\u{f7bb}"
        case .messageQueingBold: return "\u{f7bc}"
        case .messageQueingLight: return "\u{f7bd}"
        case .messageQueingRegular: return "\u{f7be}"
        case .microphoneBold: return "\u{f7bf}"
        case .microphoneFilled: return "\u{f7c0}"
        case .microphoneHardMutedBold: return "\u{f7c1}"
        case .microphoneHardMutedCircleFilled: return "\u{f7c2}"
        case .microphoneHardMutedLight: return "\u{f7c3}"
        case .microphoneHardMutedRegular: return "\u{f7c4}"
        case .microphoneLight: return "\u{f7c5}"
        case .microphoneMusicModeBold: return "\u{f7c6}"
        case .microphoneMusicModeLight: return "\u{f7c7}"
        case .microphoneMusicModeOnBold: return "\u{f7c8}"
        case .microphoneMusicModeOnLight: return "\u{f7c9}"
        case .microphoneMusicModeOnRegular: return "\u{f7ca}"
        case .microphoneMusicModeRegular: return "\u{f7cb}"
        case .microphoneMutedBold: return "\u{f7cc}"
        case .microphoneMutedCircleFilled: return "\u{f7cd}"
        case .microphoneMutedFilled: return "\u{f7ce}"
        case .microphoneMutedLight: return "\u{f7cf}"
        case .microphoneMutedRegular: return "\u{f7d0}"
        case .microphoneOnBold: return "\u{f7d1}"
        case .microphoneOnLight: return "\u{f7d2}"
        case .microphoneOnRegular: return "\u{f7d3}"
        case .microphoneOptAllBold: return "\u{f7d4}"
        case .microphoneOptAllLight: return "\u{f7d5}"
        case .microphoneOptAllMutedBold: return "\u{f7d6}"
        case .microphoneOptAllMutedLight: return "\u{f7d7}"
        case .microphoneOptAllMutedRegular: return "\u{f7d8}"
        case .microphoneOptAllOnBold: return "\u{f7d9}"
        case .microphoneOptAllOnLight: return "\u{f7da}"
        case .microphoneOptAllOnRegular: return "\u{f7db}"
        case .microphoneOptAllRegular: return "\u{f7dc}"
        case .microphoneOptMeBold: return "\u{f7dd}"
        case .microphoneOptMeLight: return "\u{f7de}"
        case .microphoneOptMeMutedBold: return "\u{f7df}"
        case .microphoneOptMeMutedLight: return "\u{f7e0}"
        case .microphoneOptMeMutedRegular: return "\u{f7e1}"
        case .microphoneOptMeOnBold: return "\u{f7e2}"
        case .microphoneOptMeOnLight: return "\u{f7e3}"
        case .microphoneOptMeOnRegular: return "\u{f7e4}"
        case .microphoneOptMeRegular: return "\u{f7e5}"
        case .microphoneRegular: return "\u{f7e6}"
        case .mindMapBold: return "\u{f7e7}"
        case .mindMapLight: return "\u{f7e8}"
        case .mindMapRegular: return "\u{f7e9}"
        case .minimizeBold: return "\u{f7ea}"
        case .minimizeLight: return "\u{f7eb}"
        case .minimizeRegular: return "\u{f7ec}"
        case .minusBold: return "\u{f7ed}"
        case .minusFilled: return "\u{f7ee}"
        case .minusLight: return "\u{f7ef}"
        case .minusRegular: return "\u{f7f0}"
        case .mirrorBold: return "\u{f7f1}"
        case .mirrorFilled: return "\u{f7f2}"
        case .mirrorLight: return "\u{f7f3}"
        case .mirrorRegular: return "\u{f7f4}"
        case .mmsFilled: return "\u{f7f5}"
        case .moderatorBold: return "\u{f7f6}"
        case .moderatorLight: return "\u{f7f7}"
        case .moderatorRegular: return "\u{f7f8}"
        case .monitoringBold: return "\u{f7f9}"
        case .monitoringLight: return "\u{f7fa}"
        case .monitoringRegular: return "\u{f7fb}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7fc}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7fd}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7fe}"
        case .moreAdrBold: return "\u{f7ff}"
        case .moreAdrLight: return "\u{f800}"
        case .moreAdrRegular: return "\u{f801}"
        case .moreBold: return "\u{f802}"
        case .moreCircleBold: return "\u{f803}"
        case .moreCircleFilled: return "\u{f804}"
        case .moreCircleLight: return "\u{f805}"
        case .moreCircleRegular: return "\u{f806}"
        case .moreLight: return "\u{f807}"
        case .moreRegular: return "\u{f808}"
        case .mouseCursorBold: return "\u{f809}"
        case .mouseCursorLight: return "\u{f80a}"
        case .mouseCursorRegular: return "\u{f80b}"
        case .moveCallInAdrBold: return "\u{f80c}"
        case .moveCallInAdrLight: return "\u{f80d}"
        case .moveCallInAdrRegular: return "\u{f80e}"
        case .moveCallInIphBold: return "\u{f80f}"
        case .moveCallInIphLight: return "\u{f810}"
        case .moveCallInIphRegular: return "\u{f811}"
        case .moveCallInLaptopBold: return "\u{f812}"
        case .moveCallInLaptopLight: return "\u{f813}"
        case .moveCallInLaptopRegular: return "\u{f814}"
        case .moveCallInOutAdrBold: return "\u{f815}"
        case .moveCallInOutAdrLight: return "\u{f816}"
        case .moveCallInOutAdrRegular: return "\u{f817}"
        case .moveCallInOutIphBold: return "\u{f818}"
        case .moveCallInOutIphLight: return "\u{f819}"
        case .moveCallInOutIphRegular: return "\u{f81a}"
        case .moveCallInTabletBold: return "\u{f81b}"
        case .moveCallInTabletLight: return "\u{f81c}"
        case .moveCallInTabletRegular: return "\u{f81d}"
        case .moveCallOutAdrBold: return "\u{f81e}"
        case .moveCallOutAdrLight: return "\u{f81f}"
        case .moveCallOutAdrRegular: return "\u{f820}"
        case .moveCallOutIphBold: return "\u{f821}"
        case .moveCallOutIphLight: return "\u{f822}"
        case .moveCallOutIphRegular: return "\u{f823}"
        case .moveCallOutLaptopBold: return "\u{f824}"
        case .moveCallOutLaptopLight: return "\u{f825}"
        case .moveCallOutLaptopRegular: return "\u{f826}"
        case .moveCallOutTabletBold: return "\u{f827}"
        case .moveCallOutTabletLight: return "\u{f828}"
        case .moveCallOutTabletRegular: return "\u{f829}"
        case .moveToBottomBold: return "\u{f82a}"
        case .moveToBottomFilled: return "\u{f82b}"
        case .moveToBottomLight: return "\u{f82c}"
        case .moveToBottomRegular: return "\u{f82d}"
        case .moveToScreenBold: return "\u{f82e}"
        case .moveToScreenLight: return "\u{f82f}"
        case .moveToScreenRegular: return "\u{f830}"
        case .moveToTopBold: return "\u{f831}"
        case .moveToTopFilled: return "\u{f832}"
        case .moveToTopLight: return "\u{f833}"
        case .moveToTopRegular: return "\u{f834}"
        case .multilineChartBold: return "\u{f835}"
        case .multilineChartFilled: return "\u{f836}"
        case .multilineChartLight: return "\u{f837}"
        case .multilineChartRegular: return "\u{f838}"
        case .multimediaBold: return "\u{f839}"
        case .multimediaFilled: return "\u{f83a}"
        case .multimediaLight: return "\u{f83b}"
        case .multimediaRegular: return "\u{f83c}"
        case .multipledDevicesBold: return "\u{f83d}"
        case .multipledDevicesLight: return "\u{f83e}"
        case .multipledDevicesRegular: return "\u{f83f}"
        case .musicModeCircleBold: return "\u{f840}"
        case .musicModeCircleFilled: return "\u{f841}"
        case .musicModeCircleLight: return "\u{f842}"
        case .musicModeCircleRegular: return "\u{f843}"
        case .musicNoteBold: return "\u{f844}"
        case .musicNoteFilled: return "\u{f845}"
        case .musicNoteLight: return "\u{f846}"
        case .musicNoteRegular: return "\u{f847}"
        case .muteOnEntryBold: return "\u{f848}"
        case .muteOnEntryFilled: return "\u{f849}"
        case .muteOnEntryLight: return "\u{f84a}"
        case .muteOnEntryRegular: return "\u{f84b}"
        case .networkSwitchBold: return "\u{f84c}"
        case .networkSwitchFilled: return "\u{f84d}"
        case .networkSwitchLight: return "\u{f84e}"
        case .networkSwitchRegular: return "\u{f84f}"
        case .newManagerBold: return "\u{f850}"
        case .newManagerFilled: return "\u{f851}"
        case .newManagerLight: return "\u{f852}"
        case .newManagerRegular: return "\u{f853}"
        case .newTitleBold: return "\u{f854}"
        case .newTitleLight: return "\u{f855}"
        case .newTitleRegular: return "\u{f856}"
        case .newVoicemailBold: return "\u{f857}"
        case .newVoicemailLight: return "\u{f858}"
        case .newVoicemailRegular: return "\u{f859}"
        case .newWhiteboardBold: return "\u{f85a}"
        case .newWhiteboardLight: return "\u{f85b}"
        case .newWhiteboardRegular: return "\u{f85c}"
        case .nextBold: return "\u{f85d}"
        case .nextLight: return "\u{f85e}"
        case .nextRegular: return "\u{f85f}"
        case .noDevicesBold: return "\u{f860}"
        case .noDevicesLight: return "\u{f861}"
        case .noDevicesRegular: return "\u{f862}"
        case .noiseDetectedCanceledFilled: return "\u{f863}"
        case .noiseDetectedFilled: return "\u{f864}"
        case .noiseNoneCanceledFilled: return "\u{f865}"
        case .noiseNoneFilled: return "\u{f866}"
        case .noiseRemovalBold: return "\u{f867}"
        case .noiseRemovalLight: return "\u{f868}"
        case .noiseRemovalRegular: return "\u{f869}"
        case .noteBold: return "\u{f86a}"
        case .noteFilled: return "\u{f86b}"
        case .noteLight: return "\u{f86c}"
        case .notePptBold: return "\u{f86d}"
        case .notePptLight: return "\u{f86e}"
        case .notePptRegular: return "\u{f86f}"
        case .noteRegular: return "\u{f870}"
        case .notesBold: return "\u{f871}"
        case .notesFilled: return "\u{f872}"
        case .notesLight: return "\u{f873}"
        case .notesRegular: return "\u{f874}"
        case .numberBold: return "\u{f875}"
        case .numberLight: return "\u{f876}"
        case .numberRegular: return "\u{f877}"
        case .oldRemoteBold: return "\u{f878}"
        case .oldRemoteLight: return "\u{f879}"
        case .oldRemoteRegular: return "\u{f87a}"
        case .oldTouchBold: return "\u{f87b}"
        case .oldTouchLight: return "\u{f87c}"
        case .oldTouchRegular: return "\u{f87d}"
        case .oneColumnBold: return "\u{f87e}"
        case .oneColumnLight: return "\u{f87f}"
        case .oneColumnRegular: return "\u{f880}"
        case .oneTimeBold: return "\u{f881}"
        case .oneTimeLight: return "\u{f882}"
        case .oneTimeRegular: return "\u{f883}"
        case .openInFolderBold: return "\u{f884}"
        case .openInFolderFilled: return "\u{f885}"
        case .openInFolderLight: return "\u{f886}"
        case .openInFolderRegular: return "\u{f887}"
        case .openPagesBold: return "\u{f888}"
        case .openPagesLight: return "\u{f889}"
        case .openPagesRegular: return "\u{f88a}"
        case .otherNumberBold: return "\u{f88b}"
        case .otherNumberFilled: return "\u{f88c}"
        case .otherNumberLight: return "\u{f88d}"
        case .otherNumberRegular: return "\u{f88e}"
        case .otherNumberWarningBold: return "\u{f88f}"
        case .otherNumberWarningLight: return "\u{f890}"
        case .otherNumberWarningRegular: return "\u{f891}"
        case .outgoingCallLegacyBold: return "\u{f892}"
        case .outgoingCallLegacyFilled: return "\u{f893}"
        case .outgoingCallLegacyLight: return "\u{f894}"
        case .outgoingCallLegacyRegular: return "\u{f895}"
        case .overflowLeftBold: return "\u{f896}"
        case .overflowLeftLight: return "\u{f897}"
        case .overflowLeftRegular: return "\u{f898}"
        case .overflowRightBold: return "\u{f899}"
        case .overflowRightLight: return "\u{f89a}"
        case .overflowRightRegular: return "\u{f89b}"
        case .pairedCameraBold: return "\u{f89c}"
        case .pairedCameraLight: return "\u{f89d}"
        case .pairedCameraRegular: return "\u{f89e}"
        case .pairedDeviceBold: return "\u{f89f}"
        case .pairedDeviceLight: return "\u{f8a0}"
        case .pairedDeviceRegular: return "\u{f8a1}"
        case .pairedHandsetBold: return "\u{f8a2}"
        case .pairedHandsetLight: return "\u{f8a3}"
        case .pairedHandsetRegular: return "\u{f8a4}"
        case .pairingBold: return "\u{f8a5}"
        case .pairingLight: return "\u{f8a6}"
        case .pairingRegular: return "\u{f8a7}"
        case .parenthesisBold: return "\u{f8a8}"
        case .parenthesisFilled: return "\u{f8a9}"
        case .parenthesisLight: return "\u{f8aa}"
        case .parenthesisRegular: return "\u{f8ab}"
        case .parkedBold: return "\u{f8ac}"
        case .parkedFilled: return "\u{f8ad}"
        case .parkedLight: return "\u{f8ae}"
        case .parkedRegular: return "\u{f8af}"
        case .parseBold: return "\u{f8b0}"
        case .parseLight: return "\u{f8b1}"
        case .parseRegular: return "\u{f8b2}"
        case .partialBold: return "\u{f8b3}"
        case .partialLight: return "\u{f8b4}"
        case .partialRegular: return "\u{f8b5}"
        case .participantAddBold: return "\u{f8b6}"
        case .participantAddLight: return "\u{f8b7}"
        case .participantAddRegular: return "\u{f8b8}"
        case .participantBlockedBold: return "\u{f8b9}"
        case .participantBlockedLight: return "\u{f8ba}"
        case .participantBlockedRegular: return "\u{f8bb}"
        case .participantBold: return "\u{f8bc}"
        case .participantFilled: return "\u{f8bd}"
        case .participantLight: return "\u{f8be}"
        case .participantListBold: return "\u{f8bf}"
        case .participantListFilled: return "\u{f8c0}"
        case .participantListLight: return "\u{f8c1}"
        case .participantListRegular: return "\u{f8c2}"
        case .participantRegular: return "\u{f8c3}"
        case .participantRemoveBold: return "\u{f8c4}"
        case .participantRemoveLight: return "\u{f8c5}"
        case .participantRemoveRegular: return "\u{f8c6}"
        case .participantSpeakerBold: return "\u{f8c7}"
        case .participantSpeakerFilled: return "\u{f8c8}"
        case .participantSpeakerLight: return "\u{f8c9}"
        case .participantSpeakerRegular: return "\u{f8ca}"
        case .participantUnknownBold: return "\u{f8cb}"
        case .participantUnknownLight: return "\u{f8cc}"
        case .participantUnknownRegular: return "\u{f8cd}"
        case .passMouseBold: return "\u{f8ce}"
        case .passMouseLight: return "\u{f8cf}"
        case .passMouseRegular: return "\u{f8d0}"
        case .pauseBadgeFilled: return "\u{f8d1}"
        case .pauseBold: return "\u{f8d2}"
        case .pauseFilled: return "\u{f8d3}"
        case .pauseInteractionBold: return "\u{f8d4}"
        case .pauseInteractionFilled: return "\u{f8d5}"
        case .pauseInteractionLight: return "\u{f8d6}"
        case .pauseInteractionRegular: return "\u{f8d7}"
        case .pauseLight: return "\u{f8d8}"
        case .pauseRegular: return "\u{f8d9}"
        case .peopleAddBold: return "\u{f8da}"
        case .peopleAddFilled: return "\u{f8db}"
        case .peopleAddLight: return "\u{f8dc}"
        case .peopleAddRegular: return "\u{f8dd}"
        case .peopleBold: return "\u{f8de}"
        case .peopleCircleBold: return "\u{f8df}"
        case .peopleCircleFilled: return "\u{f8e0}"
        case .peopleCircleLight: return "\u{f8e1}"
        case .peopleCircleRegular: return "\u{f8e2}"
        case .peopleFilled: return "\u{f8e3}"
        case .peopleInsightsBold: return "\u{f8e4}"
        case .peopleInsightsFilled: return "\u{f8e5}"
        case .peopleInsightsLight: return "\u{f8e6}"
        case .peopleInsightsRegular: return "\u{f8e7}"
        case .peopleLight: return "\u{f8e8}"
        case .peopleManageBold: return "\u{f8e9}"
        case .peopleManageFilled: return "\u{f8ea}"
        case .peopleManageLight: return "\u{f8eb}"
        case .peopleManageRegular: return "\u{f8ec}"
        case .peopleRegular: return "\u{f8ed}"
        case .phoneAlertBold: return "\u{f8ee}"
        case .phoneAlertLight: return "\u{f8ef}"
        case .phoneAlertRegular: return "\u{f8f0}"
        case .phoneBadgeFilled: return "\u{f8f1}"
        case .phoneBold: return "\u{f8f2}"
        case .phoneFilled: return "\u{f8f3}"
        case .phoneLight: return "\u{f8f4}"
        case .phoneMutedBold: return "\u{f8f5}"
        case .phoneMutedLight: return "\u{f8f6}"
        case .phoneMutedRegular: return "\u{f8f7}"
        case .phonePrivateBold: return "\u{f8f8}"
        case .phonePrivateLight: return "\u{f8f9}"
        case .phonePrivateRegular: return "\u{f8fa}"
        case .phoneRegular: return "\u{f8fb}"
        case .phoneReplyAllBold: return "\u{f8fc}"
        case .phoneReplyAllLight: return "\u{f8fd}"
        case .phoneReplyAllRegular: return "\u{f8fe}"
        case .phoneReplyBold: return "\u{f8ff}"
        case .phoneReplyLight: return "\u{f900}"
        case .phoneReplyRegular: return "\u{f901}"
        case .pickerBold: return "\u{f902}"
        case .pickerLight: return "\u{f903}"
        case .pickerRegular: return "\u{f904}"
        case .pieChartBold: return "\u{f905}"
        case .pieChartFilled: return "\u{f906}"
        case .pieChartLight: return "\u{f907}"
        case .pieChartRegular: return "\u{f908}"
        case .pinBold: return "\u{f909}"
        case .pinFilled: return "\u{f90a}"
        case .pinLight: return "\u{f90b}"
        case .pinListActivityBold: return "\u{f90c}"
        case .pinListActivityLight: return "\u{f90d}"
        case .pinListActivityRegular: return "\u{f90e}"
        case .pinListBold: return "\u{f90f}"
        case .pinListLight: return "\u{f910}"
        case .pinListRegular: return "\u{f911}"
        case .pinMutedBold: return "\u{f912}"
        case .pinMutedFilled: return "\u{f913}"
        case .pinMutedLight: return "\u{f914}"
        case .pinMutedRegular: return "\u{f915}"
        case .pinRegular: return "\u{f916}"
        case .pipBold: return "\u{f917}"
        case .pipEnterBold: return "\u{f918}"
        case .pipEnterLight: return "\u{f919}"
        case .pipEnterRegular: return "\u{f91a}"
        case .pipExitBold: return "\u{f91b}"
        case .pipExitLight: return "\u{f91c}"
        case .pipExitRegular: return "\u{f91d}"
        case .pipFilled: return "\u{f91e}"
        case .pipLight: return "\u{f91f}"
        case .pipRegular: return "\u{f920}"
        case .placeholderBold: return "\u{f921}"
        case .placeholderFilled: return "\u{f922}"
        case .placeholderLight: return "\u{f923}"
        case .placeholderRegular: return "\u{f924}"
        case .playBold: return "\u{f925}"
        case .playCircleBold: return "\u{f926}"
        case .playCircleFilled: return "\u{f927}"
        case .playCircleLight: return "\u{f928}"
        case .playCircleRegular: return "\u{f929}"
        case .playFilled: return "\u{f92a}"
        case .playLight: return "\u{f92b}"
        case .playRegular: return "\u{f92c}"
        case .plugAcBold: return "\u{f92d}"
        case .plugAcLight: return "\u{f92e}"
        case .plugAcRegular: return "\u{f92f}"
        case .plusBold: return "\u{f930}"
        case .plusCircleBold: return "\u{f931}"
        case .plusCircleFilled: return "\u{f932}"
        case .plusCircleLight: return "\u{f933}"
        case .plusCircleRegular: return "\u{f934}"
        case .plusLight: return "\u{f935}"
        case .plusRegular: return "\u{f936}"
        case .pmrBold: return "\u{f937}"
        case .pmrFilled: return "\u{f938}"
        case .pmrLight: return "\u{f939}"
        case .pmrRegular: return "\u{f93a}"
        case .pollBold: return "\u{f93b}"
        case .pollFilled: return "\u{f93c}"
        case .pollLight: return "\u{f93d}"
        case .pollRegular: return "\u{f93e}"
        case .popInBold: return "\u{f93f}"
        case .popInLight: return "\u{f940}"
        case .popInRegular: return "\u{f941}"
        case .popOutBold: return "\u{f942}"
        case .popOutLight: return "\u{f943}"
        case .popOutRegular: return "\u{f944}"
        case .popUpBold: return "\u{f945}"
        case .popUpLight: return "\u{f946}"
        case .popUpRegular: return "\u{f947}"
        case .portraitLandscapeBold: return "\u{f948}"
        case .portraitLandscapeLight: return "\u{f949}"
        case .portraitLandscapeRegular: return "\u{f94a}"
        case .potentialFraudBold: return "\u{f94b}"
        case .potentialFraudFilled: return "\u{f94c}"
        case .potentialFraudLight: return "\u{f94d}"
        case .potentialFraudRegular: return "\u{f94e}"
        case .powerAcBold: return "\u{f94f}"
        case .powerAcLight: return "\u{f950}"
        case .powerAcRegular: return "\u{f951}"
        case .powerBold: return "\u{f952}"
        case .powerLight: return "\u{f953}"
        case .powerRegular: return "\u{f954}"
        case .preHeaderBold: return "\u{f955}"
        case .preHeaderLight: return "\u{f956}"
        case .preHeaderRegular: return "\u{f957}"
        case .premiumBold: return "\u{f958}"
        case .premiumLight: return "\u{f959}"
        case .premiumRegular: return "\u{f95a}"
        case .presentationBold: return "\u{f95b}"
        case .presentationLight: return "\u{f95c}"
        case .presentationRegular: return "\u{f95d}"
        case .preventDownloadBold: return "\u{f95e}"
        case .preventDownloadFilled: return "\u{f95f}"
        case .preventDownloadLight: return "\u{f960}"
        case .preventDownloadRegular: return "\u{f961}"
        case .primaryParticipantBold: return "\u{f962}"
        case .primaryParticipantFilled: return "\u{f963}"
        case .primaryParticipantLight: return "\u{f964}"
        case .primaryParticipantRegular: return "\u{f965}"
        case .printBold: return "\u{f966}"
        case .printLight: return "\u{f967}"
        case .printRegular: return "\u{f968}"
        case .priorityBadgeFilled: return "\u{f969}"
        case .priorityCircleBold: return "\u{f96a}"
        case .priorityCircleFilled: return "\u{f96b}"
        case .priorityCircleLight: return "\u{f96c}"
        case .priorityCircleRegular: return "\u{f96d}"
        case .priorityCircleTwoBold: return "\u{f96e}"
        case .priorityCircleTwoFilled: return "\u{f96f}"
        case .priorityCircleTwoLight: return "\u{f970}"
        case .priorityCircleTwoRegular: return "\u{f971}"
        case .priorityWaveBold: return "\u{f972}"
        case .priorityWaveLight: return "\u{f973}"
        case .priorityWaveRegular: return "\u{f974}"
        case .privacyCircleBold: return "\u{f975}"
        case .privacyCircleFilled: return "\u{f976}"
        case .privacyCircleLight: return "\u{f977}"
        case .privacyCircleRegular: return "\u{f978}"
        case .privateBold: return "\u{f979}"
        case .privateCircleBold: return "\u{f97a}"
        case .privateCircleFilled: return "\u{f97b}"
        case .privateCircleLight: return "\u{f97c}"
        case .privateCircleRegular: return "\u{f97d}"
        case .privateLight: return "\u{f97e}"
        case .privateMeetingBold: return "\u{f97f}"
        case .privateMeetingLight: return "\u{f980}"
        case .privateMeetingRegular: return "\u{f981}"
        case .privateRegular: return "\u{f982}"
        case .productDemoBold: return "\u{f983}"
        case .productDemoLight: return "\u{f984}"
        case .productDemoRegular: return "\u{f985}"
        case .promptsAiBold: return "\u{f986}"
        case .promptsAiLight: return "\u{f987}"
        case .promptsAiRegular: return "\u{f988}"
        case .proximityBold: return "\u{f989}"
        case .proximityLight: return "\u{f98a}"
        case .proximityMutedBold: return "\u{f98b}"
        case .proximityMutedLight: return "\u{f98c}"
        case .proximityMutedRegular: return "\u{f98d}"
        case .proximityRegular: return "\u{f98e}"
        case .proximityVideoBold: return "\u{f98f}"
        case .proximityVideoLight: return "\u{f990}"
        case .proximityVideoRegular: return "\u{f991}"
        case .ptoPresenceBold: return "\u{f992}"
        case .ptoPresenceFilled: return "\u{f993}"
        case .ptoPresenceLight: return "\u{f994}"
        case .ptoPresenceRegular: return "\u{f995}"
        case .pullCallBold: return "\u{f996}"
        case .pullCallFilled: return "\u{f997}"
        case .pullCallLight: return "\u{f998}"
        case .pullCallRegular: return "\u{f999}"
        case .purchaseOrderBold: return "\u{f99a}"
        case .purchaseOrderFilled: return "\u{f99b}"
        case .purchaseOrderLight: return "\u{f99c}"
        case .purchaseOrderRegular: return "\u{f99d}"
        case .qABold: return "\u{f99e}"
        case .qAFilled: return "\u{f99f}"
        case .qALight: return "\u{f9a0}"
        case .qARegular: return "\u{f9a1}"
        case .qrCodeBold: return "\u{f9a2}"
        case .qrCodeLight: return "\u{f9a3}"
        case .qrCodeRegular: return "\u{f9a4}"
        case .qrCodeScanBold: return "\u{f9a5}"
        case .qrCodeScanLight: return "\u{f9a6}"
        case .qrCodeScanRegular: return "\u{f9a7}"
        case .qualityBold: return "\u{f9a8}"
        case .qualityLight: return "\u{f9a9}"
        case .qualityRegular: return "\u{f9aa}"
        case .queueContactBold: return "\u{f9ab}"
        case .queueContactFilled: return "\u{f9ac}"
        case .queueContactLight: return "\u{f9ad}"
        case .queueContactRegular: return "\u{f9ae}"
        case .queuedInteractionBold: return "\u{f9af}"
        case .queuedInteractionFilled: return "\u{f9b0}"
        case .queuedInteractionLight: return "\u{f9b1}"
        case .queuedInteractionRegular: return "\u{f9b2}"
        case .quietBold: return "\u{f9b3}"
        case .quietHoursPresenceBold: return "\u{f9b4}"
        case .quietHoursPresenceFilled: return "\u{f9b5}"
        case .quietHoursPresenceLight: return "\u{f9b6}"
        case .quietHoursPresenceRegular: return "\u{f9b7}"
        case .quietLight: return "\u{f9b8}"
        case .quietRegular: return "\u{f9b9}"
        case .radioButtonGroupBold: return "\u{f9ba}"
        case .radioButtonGroupLight: return "\u{f9bb}"
        case .radioButtonGroupRegular: return "\u{f9bc}"
        case .raiseHandBold: return "\u{f9bd}"
        case .raiseHandCircleFilled: return "\u{f9be}"
        case .raiseHandFilled: return "\u{f9bf}"
        case .raiseHandLight: return "\u{f9c0}"
        case .raiseHandRegular: return "\u{f9c1}"
        case .ramBold: return "\u{f9c2}"
        case .ramLight: return "\u{f9c3}"
        case .ramRegular: return "\u{f9c4}"
        case .reactionsBold: return "\u{f9c5}"
        case .reactionsFilled: return "\u{f9c6}"
        case .reactionsLight: return "\u{f9c7}"
        case .reactionsRegular: return "\u{f9c8}"
        case .reactivateBold: return "\u{f9c9}"
        case .reactivateLight: return "\u{f9ca}"
        case .reactivateRegular: return "\u{f9cb}"
        case .receiveVoiceBold: return "\u{f9cc}"
        case .receiveVoiceFilled: return "\u{f9cd}"
        case .receiveVoiceLight: return "\u{f9ce}"
        case .receiveVoiceRegular: return "\u{f9cf}"
        case .recentsBold: return "\u{f9d0}"
        case .recentsFilled: return "\u{f9d1}"
        case .recentsLight: return "\u{f9d2}"
        case .recentsPresenceBadgeFilled: return "\u{f9d3}"
        case .recentsPresenceBold: return "\u{f9d4}"
        case .recentsPresenceFilled: return "\u{f9d5}"
        case .recentsPresenceLight: return "\u{f9d6}"
        case .recentsPresenceRegular: return "\u{f9d7}"
        case .recentsRegular: return "\u{f9d8}"
        case .recordActiveBadgeFilled: return "\u{f9d9}"
        case .recordActiveBold: return "\u{f9da}"
        case .recordActiveFilled: return "\u{f9db}"
        case .recordActiveLight: return "\u{f9dc}"
        case .recordActiveRegular: return "\u{f9dd}"
        case .recordBold: return "\u{f9de}"
        case .recordFilled: return "\u{f9df}"
        case .recordLight: return "\u{f9e0}"
        case .recordPausedBadgeFilled: return "\u{f9e1}"
        case .recordPausedBold: return "\u{f9e2}"
        case .recordPausedFilled: return "\u{f9e3}"
        case .recordPausedLight: return "\u{f9e4}"
        case .recordPausedRegular: return "\u{f9e5}"
        case .recordRegular: return "\u{f9e6}"
        case .recurringBold: return "\u{f9e7}"
        case .recurringLight: return "\u{f9e8}"
        case .recurringOffBold: return "\u{f9e9}"
        case .recurringOffLight: return "\u{f9ea}"
        case .recurringOffRegular: return "\u{f9eb}"
        case .recurringRegular: return "\u{f9ec}"
        case .redoBold: return "\u{f9ed}"
        case .redoLight: return "\u{f9ee}"
        case .redoRegular: return "\u{f9ef}"
        case .refreshBold: return "\u{f9f0}"
        case .refreshLight: return "\u{f9f1}"
        case .refreshRegular: return "\u{f9f2}"
        case .remoteDesktopControlBold: return "\u{f9f3}"
        case .remoteDesktopControlFilled: return "\u{f9f4}"
        case .remoteDesktopControlLight: return "\u{f9f5}"
        case .remoteDesktopControlRegular: return "\u{f9f6}"
        case .removeBold: return "\u{f9f7}"
        case .removeFilled: return "\u{f9f8}"
        case .removeLight: return "\u{f9f9}"
        case .removeRegular: return "\u{f9fa}"
        case .replyBold: return "\u{f9fb}"
        case .replyFilled: return "\u{f9fc}"
        case .replyLight: return "\u{f9fd}"
        case .replyListBold: return "\u{f9fe}"
        case .replyListFilled: return "\u{f9ff}"
        case .replyListLight: return "\u{fa00}"
        case .replyListRegular: return "\u{fa01}"
        case .replyPrivatelyBold: return "\u{fa02}"
        case .replyPrivatelyLight: return "\u{fa03}"
        case .replyPrivatelyRegular: return "\u{fa04}"
        case .replyRegular: return "\u{fa05}"
        case .resetBold: return "\u{fa06}"
        case .resetLight: return "\u{fa07}"
        case .resetRegular: return "\u{fa08}"
        case .resizeCornerBold: return "\u{fa09}"
        case .resizeCornerLight: return "\u{fa0a}"
        case .resizeCornerRegular: return "\u{fa0b}"
        case .responsiveMobileBold: return "\u{fa0c}"
        case .responsiveMobileLight: return "\u{fa0d}"
        case .responsiveMobileRegular: return "\u{fa0e}"
        case .restartBold: return "\u{fa0f}"
        case .restartLight: return "\u{fa10}"
        case .restartRegular: return "\u{fa11}"
        case .resumeInteractionBold: return "\u{fa12}"
        case .resumeInteractionFilled: return "\u{fa13}"
        case .resumeInteractionLight: return "\u{fa14}"
        case .resumeInteractionRegular: return "\u{fa15}"
        case .retrieveCallBold: return "\u{fa16}"
        case .retrieveCallFilled: return "\u{fa17}"
        case .retrieveCallLight: return "\u{fa18}"
        case .retrieveCallRegular: return "\u{fa19}"
        case .returnBold: return "\u{fa1a}"
        case .returnLight: return "\u{fa1b}"
        case .returnRegular: return "\u{fa1c}"
        case .rewindTenSecBold: return "\u{fa1d}"
        case .rewindTenSecLight: return "\u{fa1e}"
        case .rewindTenSecRegular: return "\u{fa1f}"
        case .ringtoneBold: return "\u{fa20}"
        case .ringtoneLight: return "\u{fa21}"
        case .ringtoneRegular: return "\u{fa22}"
        case .roomCalendarBold: return "\u{fa23}"
        case .roomCalendarLight: return "\u{fa24}"
        case .roomCalendarRegular: return "\u{fa25}"
        case .roomLightsBold: return "\u{fa26}"
        case .roomLightsFilled: return "\u{fa27}"
        case .roomLightsLight: return "\u{fa28}"
        case .roomLightsRegular: return "\u{fa29}"
        case .rotateContentBold: return "\u{fa2a}"
        case .rotateContentFilled: return "\u{fa2b}"
        case .rotateContentLight: return "\u{fa2c}"
        case .rotateContentRegular: return "\u{fa2d}"
        case .rssBold: return "\u{fa2e}"
        case .rssFilled: return "\u{fa2f}"
        case .rssLight: return "\u{fa30}"
        case .rssRegular: return "\u{fa31}"
        case .ruleBasedBold: return "\u{fa32}"
        case .ruleBasedLight: return "\u{fa33}"
        case .ruleBasedRegular: return "\u{fa34}"
        case .rulerBold: return "\u{fa35}"
        case .rulerFilled: return "\u{fa36}"
        case .rulerLight: return "\u{fa37}"
        case .rulerRegular: return "\u{fa38}"
        case .runningApplicationBold: return "\u{fa39}"
        case .runningApplicationFilled: return "\u{fa3a}"
        case .runningApplicationLight: return "\u{fa3b}"
        case .runningApplicationRegular: return "\u{fa3c}"
        case .saveBold: return "\u{fa3d}"
        case .saveLight: return "\u{fa3e}"
        case .saveRegular: return "\u{fa3f}"
        case .saveTranscriptBold: return "\u{fa40}"
        case .saveTranscriptFilled: return "\u{fa41}"
        case .saveTranscriptLight: return "\u{fa42}"
        case .saveTranscriptRegular: return "\u{fa43}"
        case .scanBold: return "\u{fa44}"
        case .scanLight: return "\u{fa45}"
        case .scanRegular: return "\u{fa46}"
        case .scheduleAiBold: return "\u{fa47}"
        case .scheduleAiLight: return "\u{fa48}"
        case .scheduleAiRegular: return "\u{fa49}"
        case .scheduleSendBold: return "\u{fa4a}"
        case .scheduleSendFilled: return "\u{fa4b}"
        case .scheduleSendLight: return "\u{fa4c}"
        case .scheduleSendRegular: return "\u{fa4d}"
        case .scheduleWinnerBold: return "\u{fa4e}"
        case .scheduleWinnerFilled: return "\u{fa4f}"
        case .scheduleWinnerLight: return "\u{fa50}"
        case .scheduleWinnerRegular: return "\u{fa51}"
        case .schedulerAvailableBold: return "\u{fa52}"
        case .schedulerAvailableLight: return "\u{fa53}"
        case .schedulerAvailableRegular: return "\u{fa54}"
        case .schedulerNotWorkingHoursBold: return "\u{fa55}"
        case .schedulerNotWorkingHoursLight: return "\u{fa56}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa57}"
        case .schedulerUnavailableBold: return "\u{fa58}"
        case .schedulerUnavailableLight: return "\u{fa59}"
        case .schedulerUnavailableRegular: return "\u{fa5a}"
        case .schedulerUnknownBold: return "\u{fa5b}"
        case .schedulerUnknownLight: return "\u{fa5c}"
        case .schedulerUnknownRegular: return "\u{fa5d}"
        case .screenshotBold: return "\u{fa5e}"
        case .screenshotDocBold: return "\u{fa5f}"
        case .screenshotDocFilled: return "\u{fa60}"
        case .screenshotDocLight: return "\u{fa61}"
        case .screenshotDocRegular: return "\u{fa62}"
        case .screenshotLight: return "\u{fa63}"
        case .screenshotRegular: return "\u{fa64}"
        case .searchAiBold: return "\u{fa65}"
        case .searchAiLight: return "\u{fa66}"
        case .searchAiRegular: return "\u{fa67}"
        case .searchBold: return "\u{fa68}"
        case .searchFilled: return "\u{fa69}"
        case .searchLight: return "\u{fa6a}"
        case .searchRegular: return "\u{fa6b}"
        case .secondaryArrowBold: return "\u{fa6c}"
        case .secondaryArrowLight: return "\u{fa6d}"
        case .secondaryArrowRegular: return "\u{fa6e}"
        case .secureCallLockBold: return "\u{fa6f}"
        case .secureCallLockFilled: return "\u{fa70}"
        case .secureCallLockLight: return "\u{fa71}"
        case .secureCallLockRegular: return "\u{fa72}"
        case .secureCallShieldBold: return "\u{fa73}"
        case .secureCallShieldFilled: return "\u{fa74}"
        case .secureCallShieldLight: return "\u{fa75}"
        case .secureCallShieldRegular: return "\u{fa76}"
        case .secureCircleBold: return "\u{fa77}"
        case .secureCircleFilled: return "\u{fa78}"
        case .secureCircleLight: return "\u{fa79}"
        case .secureCircleRegular: return "\u{fa7a}"
        case .secureLockBold: return "\u{fa7b}"
        case .secureLockFilled: return "\u{fa7c}"
        case .secureLockLight: return "\u{fa7d}"
        case .secureLockRegular: return "\u{fa7e}"
        case .segmentExcludeFilled: return "\u{fa7f}"
        case .segmentFilterFilled: return "\u{fa80}"
        case .segmentIncludeFilled: return "\u{fa81}"
        case .selectAllBold: return "\u{fa82}"
        case .selectAllFilled: return "\u{fa83}"
        case .selectAllLight: return "\u{fa84}"
        case .selectAllRegular: return "\u{fa85}"
        case .selectionBold: return "\u{fa86}"
        case .selectionFilled: return "\u{fa87}"
        case .selectionLight: return "\u{fa88}"
        case .selectionRegular: return "\u{fa89}"
        case .sendBold: return "\u{fa8a}"
        case .sendDigitsBold: return "\u{fa8b}"
        case .sendDigitsFilled: return "\u{fa8c}"
        case .sendDigitsLight: return "\u{fa8d}"
        case .sendDigitsRegular: return "\u{fa8e}"
        case .sendFilled: return "\u{fa8f}"
        case .sendLight: return "\u{fa90}"
        case .sendRegular: return "\u{fa91}"
        case .sendVoiceBold: return "\u{fa92}"
        case .sendVoiceFilled: return "\u{fa93}"
        case .sendVoiceLight: return "\u{fa94}"
        case .sendVoiceRegular: return "\u{fa95}"
        case .serverBold: return "\u{fa96}"
        case .serverErrorBold: return "\u{fa97}"
        case .serverErrorLight: return "\u{fa98}"
        case .serverErrorRegular: return "\u{fa99}"
        case .serverLight: return "\u{fa9a}"
        case .serverRegular: return "\u{fa9b}"
        case .servicesBold: return "\u{fa9c}"
        case .servicesLight: return "\u{fa9d}"
        case .servicesRegular: return "\u{fa9e}"
        case .setVariableBold: return "\u{fa9f}"
        case .setVariableLight: return "\u{faa0}"
        case .setVariableRegular: return "\u{faa1}"
        case .settingsBold: return "\u{faa2}"
        case .settingsFilled: return "\u{faa3}"
        case .settingsLight: return "\u{faa4}"
        case .settingsRegular: return "\u{faa5}"
        case .setupAssistantBold: return "\u{faa6}"
        case .setupAssistantLight: return "\u{faa7}"
        case .setupAssistantRegular: return "\u{faa8}"
        case .sftpBold: return "\u{faa9}"
        case .sftpLight: return "\u{faaa}"
        case .sftpRegular: return "\u{faab}"
        case .shapeCircleBold: return "\u{faac}"
        case .shapeCircleFilled: return "\u{faad}"
        case .shapeCircleLight: return "\u{faae}"
        case .shapeCircleMdFilled: return "\u{faaf}"
        case .shapeCircleRegular: return "\u{fab0}"
        case .shapeCircleSmFilled: return "\u{fab1}"
        case .shapeDiagonalLineBold: return "\u{fab2}"
        case .shapeDiagonalLineLight: return "\u{fab3}"
        case .shapeDiagonalLineRegular: return "\u{fab4}"
        case .shapeDiamondBold: return "\u{fab5}"
        case .shapeDiamondFilled: return "\u{fab6}"
        case .shapeDiamondLight: return "\u{fab7}"
        case .shapeDiamondRegular: return "\u{fab8}"
        case .shapeOvalBold: return "\u{fab9}"
        case .shapeOvalLight: return "\u{faba}"
        case .shapeOvalRegular: return "\u{fabb}"
        case .shapeSquareBold: return "\u{fabc}"
        case .shapeSquareFilled: return "\u{fabd}"
        case .shapeSquareLight: return "\u{fabe}"
        case .shapeSquareRegular: return "\u{fabf}"
        case .shapeTriangleBold: return "\u{fac0}"
        case .shapeTriangleFilled: return "\u{fac1}"
        case .shapeTriangleLight: return "\u{fac2}"
        case .shapeTriangleRegular: return "\u{fac3}"
        case .shapesBold: return "\u{fac4}"
        case .shapesFilled: return "\u{fac5}"
        case .shapesLight: return "\u{fac6}"
        case .shapesRegular: return "\u{fac7}"
        case .shareCNativeAdrBold: return "\u{fac8}"
        case .shareCNativeAdrFilled: return "\u{fac9}"
        case .shareCNativeAdrLight: return "\u{faca}"
        case .shareCNativeAdrRegular: return "\u{facb}"
        case .shareCNativeIphBold: return "\u{facc}"
        case .shareCNativeIphLight: return "\u{facd}"
        case .shareCNativeIphRegular: return "\u{face}"
        case .shareContentOnDeviceBold: return "\u{facf}"
        case .shareContentOnDeviceLight: return "\u{fad0}"
        case .shareContentOnDeviceRegular: return "\u{fad1}"
        case .shareScreenAddBold: return "\u{fad2}"
        case .shareScreenAddLight: return "\u{fad3}"
        case .shareScreenAddRegular: return "\u{fad4}"
        case .shareScreenBadgeFilled: return "\u{fad5}"
        case .shareScreenBold: return "\u{fad6}"
        case .shareScreenFilled: return "\u{fad7}"
        case .shareScreenLight: return "\u{fad8}"
        case .shareScreenRegular: return "\u{fad9}"
        case .shareSpaceBold: return "\u{fada}"
        case .shareSpaceLight: return "\u{fadb}"
        case .shareSpaceRegular: return "\u{fadc}"
        case .shieldBold: return "\u{fadd}"
        case .shieldLight: return "\u{fade}"
        case .shieldRegular: return "\u{fadf}"
        case .shoppingCartBold: return "\u{fae0}"
        case .shoppingCartFilled: return "\u{fae1}"
        case .shoppingCartLight: return "\u{fae2}"
        case .shoppingCartRegular: return "\u{fae3}"
        case .shortTextBoxBold: return "\u{fae4}"
        case .shortTextBoxLight: return "\u{fae5}"
        case .shortTextBoxRegular: return "\u{fae6}"
        case .showBold: return "\u{fae7}"
        case .showFilled: return "\u{fae8}"
        case .showLight: return "\u{fae9}"
        case .showRegular: return "\u{faea}"
        case .sidePanelBold: return "\u{faeb}"
        case .sidePanelFilled: return "\u{faec}"
        case .sidePanelLight: return "\u{faed}"
        case .sidePanelRegular: return "\u{faee}"
        case .signInBold: return "\u{faef}"
        case .signInFilled: return "\u{faf0}"
        case .signInForcedBold: return "\u{faf1}"
        case .signInForcedLight: return "\u{faf2}"
        case .signInForcedRegular: return "\u{faf3}"
        case .signInLight: return "\u{faf4}"
        case .signInRegular: return "\u{faf5}"
        case .signLangIntBold: return "\u{faf6}"
        case .signLangIntLight: return "\u{faf7}"
        case .signLangIntRegular: return "\u{faf8}"
        case .signOutBold: return "\u{faf9}"
        case .signOutLight: return "\u{fafa}"
        case .signOutRegular: return "\u{fafb}"
        case .signalFourBold: return "\u{fafc}"
        case .signalFourLight: return "\u{fafd}"
        case .signalFourRegular: return "\u{fafe}"
        case .signalOneBold: return "\u{faff}"
        case .signalOneLight: return "\u{fb00}"
        case .signalOneRegular: return "\u{fb01}"
        case .signalThreeBold: return "\u{fb02}"
        case .signalThreeLight: return "\u{fb03}"
        case .signalThreeRegular: return "\u{fb04}"
        case .signalTwoBold: return "\u{fb05}"
        case .signalTwoLight: return "\u{fb06}"
        case .signalTwoRegular: return "\u{fb07}"
        case .signalZeroBold: return "\u{fb08}"
        case .signalZeroLight: return "\u{fb09}"
        case .signalZeroRegular: return "\u{fb0a}"
        case .simplePromotionBold: return "\u{fb0b}"
        case .simplePromotionLight: return "\u{fb0c}"
        case .simplePromotionRegular: return "\u{fb0d}"
        case .singleNumberReachBold: return "\u{fb0e}"
        case .singleNumberReachLight: return "\u{fb0f}"
        case .singleNumberReachRegular: return "\u{fb10}"
        case .sipRegistrationInProgressBold: return "\u{fb11}"
        case .sipRegistrationInProgressFilled: return "\u{fb12}"
        case .sipRegistrationInProgressLight: return "\u{fb13}"
        case .sipRegistrationInProgressRegular: return "\u{fb14}"
        case .skipBold: return "\u{fb15}"
        case .skipBwBold: return "\u{fb16}"
        case .skipBwFilled: return "\u{fb17}"
        case .skipBwLight: return "\u{fb18}"
        case .skipBwRegular: return "\u{fb19}"
        case .skipFwBold: return "\u{fb1a}"
        case .skipFwFilled: return "\u{fb1b}"
        case .skipFwLight: return "\u{fb1c}"
        case .skipFwRegular: return "\u{fb1d}"
        case .skipLight: return "\u{fb1e}"
        case .skipRegular: return "\u{fb1f}"
        case .smartAudioBold: return "\u{fb20}"
        case .smartAudioLight: return "\u{fb21}"
        case .smartAudioRegular: return "\u{fb22}"
        case .smsFilled: return "\u{fb23}"
        case .smsInboundBold: return "\u{fb24}"
        case .smsInboundLight: return "\u{fb25}"
        case .smsInboundRegular: return "\u{fb26}"
        case .smsMessageBold: return "\u{fb27}"
        case .smsMessageFilled: return "\u{fb28}"
        case .smsMessageLight: return "\u{fb29}"
        case .smsMessageOutgoingBold: return "\u{fb2a}"
        case .smsMessageOutgoingFilled: return "\u{fb2b}"
        case .smsMessageOutgoingLight: return "\u{fb2c}"
        case .smsMessageOutgoingRegular: return "\u{fb2d}"
        case .smsMessageRegular: return "\u{fb2e}"
        case .smsMessageStartBold: return "\u{fb2f}"
        case .smsMessageStartFilled: return "\u{fb30}"
        case .smsMessageStartLight: return "\u{fb31}"
        case .smsMessageStartRegular: return "\u{fb32}"
        case .smsOutgoingFilled: return "\u{fb33}"
        case .smsUnreadBold: return "\u{fb34}"
        case .smsUnreadLight: return "\u{fb35}"
        case .smsUnreadRegular: return "\u{fb36}"
        case .sortAscendingBold: return "\u{fb37}"
        case .sortAscendingLight: return "\u{fb38}"
        case .sortAscendingRegular: return "\u{fb39}"
        case .sortDescendingBold: return "\u{fb3a}"
        case .sortDescendingLight: return "\u{fb3b}"
        case .sortDescendingRegular: return "\u{fb3c}"
        case .soundDefaultBold: return "\u{fb3d}"
        case .soundDefaultLight: return "\u{fb3e}"
        case .soundDefaultRegular: return "\u{fb3f}"
        case .sparkleBold: return "\u{fb40}"
        case .sparkleFilled: return "\u{fb41}"
        case .sparkleLight: return "\u{fb42}"
        case .sparkleRegular: return "\u{fb43}"
        case .speakerBold: return "\u{fb44}"
        case .speakerDisconnectedBold: return "\u{fb45}"
        case .speakerDisconnectedFilled: return "\u{fb46}"
        case .speakerDisconnectedLight: return "\u{fb47}"
        case .speakerDisconnectedRegular: return "\u{fb48}"
        case .speakerFilled: return "\u{fb49}"
        case .speakerLight: return "\u{fb4a}"
        case .speakerMutedBold: return "\u{fb4b}"
        case .speakerMutedFilled: return "\u{fb4c}"
        case .speakerMutedLight: return "\u{fb4d}"
        case .speakerMutedRegular: return "\u{fb4e}"
        case .speakerOffBold: return "\u{fb4f}"
        case .speakerOffFilled: return "\u{fb50}"
        case .speakerOffLight: return "\u{fb51}"
        case .speakerOffRegular: return "\u{fb52}"
        case .speakerOnBold: return "\u{fb53}"
        case .speakerOnLight: return "\u{fb54}"
        case .speakerOnRegular: return "\u{fb55}"
        case .speakerRegular: return "\u{fb56}"
        case .speakerTurnDownBold: return "\u{fb57}"
        case .speakerTurnDownFilled: return "\u{fb58}"
        case .speakerTurnDownLight: return "\u{fb59}"
        case .speakerTurnDownRegular: return "\u{fb5a}"
        case .speakerTurnUpBold: return "\u{fb5b}"
        case .speakerTurnUpFilled: return "\u{fb5c}"
        case .speakerTurnUpLight: return "\u{fb5d}"
        case .speakerTurnUpRegular: return "\u{fb5e}"
        case .speedDialBold: return "\u{fb5f}"
        case .speedDialFilled: return "\u{fb60}"
        case .speedDialLight: return "\u{fb61}"
        case .speedDialRegular: return "\u{fb62}"
        case .spellCheckerBold: return "\u{fb63}"
        case .spellCheckerLight: return "\u{fb64}"
        case .spellCheckerRegular: return "\u{fb65}"
        case .splitViewBold: return "\u{fb66}"
        case .splitViewLight: return "\u{fb67}"
        case .splitViewRegular: return "\u{fb68}"
        case .stackedAreaChartBold: return "\u{fb69}"
        case .stackedAreaChartFilled: return "\u{fb6a}"
        case .stackedAreaChartFullBold: return "\u{fb6b}"
        case .stackedAreaChartFullFilled: return "\u{fb6c}"
        case .stackedAreaChartFullLight: return "\u{fb6d}"
        case .stackedAreaChartFullRegular: return "\u{fb6e}"
        case .stackedAreaChartLight: return "\u{fb6f}"
        case .stackedAreaChartRegular: return "\u{fb70}"
        case .stackedBarChartBold: return "\u{fb71}"
        case .stackedBarChartFilled: return "\u{fb72}"
        case .stackedBarChartFullBold: return "\u{fb73}"
        case .stackedBarChartFullFilled: return "\u{fb74}"
        case .stackedBarChartFullLight: return "\u{fb75}"
        case .stackedBarChartFullRegular: return "\u{fb76}"
        case .stackedBarChartLight: return "\u{fb77}"
        case .stackedBarChartRegular: return "\u{fb78}"
        case .startChatBold: return "\u{fb79}"
        case .startChatLight: return "\u{fb7a}"
        case .startChatRegular: return "\u{fb7b}"
        case .stethoscopeBold: return "\u{fb7c}"
        case .stethoscopeLight: return "\u{fb7d}"
        case .stethoscopeRegular: return "\u{fb7e}"
        case .stickersBold: return "\u{fb7f}"
        case .stickersLight: return "\u{fb80}"
        case .stickersRegular: return "\u{fb81}"
        case .stickiesBold: return "\u{fb82}"
        case .stickiesLight: return "\u{fb83}"
        case .stickiesRegular: return "\u{fb84}"
        case .stopBold: return "\u{fb85}"
        case .stopCircleBold: return "\u{fb86}"
        case .stopCircleFilled: return "\u{fb87}"
        case .stopCircleLight: return "\u{fb88}"
        case .stopCircleRegular: return "\u{fb89}"
        case .stopContentShareBold: return "\u{fb8a}"
        case .stopContentShareLight: return "\u{fb8b}"
        case .stopContentShareRegular: return "\u{fb8c}"
        case .stopFilled: return "\u{fb8d}"
        case .stopLight: return "\u{fb8e}"
        case .stopRegular: return "\u{fb8f}"
        case .storedInfoBold: return "\u{fb90}"
        case .storedInfoFilled: return "\u{fb91}"
        case .storedInfoLight: return "\u{fb92}"
        case .storedInfoRegular: return "\u{fb93}"
        case .streamingBold: return "\u{fb94}"
        case .streamingLight: return "\u{fb95}"
        case .streamingRegular: return "\u{fb96}"
        case .strikethroughBold: return "\u{fb97}"
        case .strikethroughFilled: return "\u{fb98}"
        case .strikethroughLight: return "\u{fb99}"
        case .strikethroughRegular: return "\u{fb9a}"
        case .studioModeBold: return "\u{fb9b}"
        case .studioModeLight: return "\u{fb9c}"
        case .studioModeRegular: return "\u{fb9d}"
        case .subscriptBold: return "\u{fb9e}"
        case .subscriptLight: return "\u{fb9f}"
        case .subscriptRegular: return "\u{fba0}"
        case .summarizeAiBold: return "\u{fba1}"
        case .summarizeAiLight: return "\u{fba2}"
        case .summarizeAiRegular: return "\u{fba3}"
        case .superscriptBold: return "\u{fba4}"
        case .superscriptLight: return "\u{fba5}"
        case .superscriptRegular: return "\u{fba6}"
        case .surveyBold: return "\u{fba7}"
        case .surveyFilled: return "\u{fba8}"
        case .surveyLight: return "\u{fba9}"
        case .surveyRegular: return "\u{fbaa}"
        case .sxEightyCodecBold: return "\u{fbab}"
        case .sxEightyCodecLight: return "\u{fbac}"
        case .sxEightyCodecRegular: return "\u{fbad}"
        case .sxTenBold: return "\u{fbae}"
        case .sxTenLight: return "\u{fbaf}"
        case .sxTenRegular: return "\u{fbb0}"
        case .sxTwentyBold: return "\u{fbb1}"
        case .sxTwentyLight: return "\u{fbb2}"
        case .sxTwentyRegular: return "\u{fbb3}"
        case .tableBold: return "\u{fbb4}"
        case .tableExtenderBold: return "\u{fbb5}"
        case .tableExtenderFilled: return "\u{fbb6}"
        case .tableExtenderLight: return "\u{fbb7}"
        case .tableExtenderRegular: return "\u{fbb8}"
        case .tableLight: return "\u{fbb9}"
        case .tableRegular: return "\u{fbba}"
        case .tabletBold: return "\u{fbbb}"
        case .tabletLight: return "\u{fbbc}"
        case .tabletRegular: return "\u{fbbd}"
        case .tabsBold: return "\u{fbbe}"
        case .tabsLight: return "\u{fbbf}"
        case .tabsRegular: return "\u{fbc0}"
        case .tagBold: return "\u{fbc1}"
        case .tagLight: return "\u{fbc2}"
        case .tagRegular: return "\u{fbc3}"
        case .tapBold: return "\u{fbc4}"
        case .tapFilled: return "\u{fbc5}"
        case .tapLight: return "\u{fbc6}"
        case .tapRegular: return "\u{fbc7}"
        case .telepresenceAlertBold: return "\u{fbc8}"
        case .telepresenceAlertLight: return "\u{fbc9}"
        case .telepresenceAlertMutedBold: return "\u{fbca}"
        case .telepresenceAlertMutedLight: return "\u{fbcb}"
        case .telepresenceAlertMutedRegular: return "\u{fbcc}"
        case .telepresenceAlertRegular: return "\u{fbcd}"
        case .telepresenceBold: return "\u{fbce}"
        case .telepresenceIxFiveThousandBold: return "\u{fbcf}"
        case .telepresenceIxFiveThousandLight: return "\u{fbd0}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbd1}"
        case .telepresenceLight: return "\u{fbd2}"
        case .telepresenceMutedBold: return "\u{fbd3}"
        case .telepresenceMutedLight: return "\u{fbd4}"
        case .telepresenceMutedRegular: return "\u{fbd5}"
        case .telepresencePrivateBold: return "\u{fbd6}"
        case .telepresencePrivateLight: return "\u{fbd7}"
        case .telepresencePrivateRegular: return "\u{fbd8}"
        case .telepresenceRegular: return "\u{fbd9}"
        case .temperatureBold: return "\u{fbda}"
        case .temperatureLight: return "\u{fbdb}"
        case .temperatureRegular: return "\u{fbdc}"
        case .testTubeBold: return "\u{fbdd}"
        case .testTubeFilled: return "\u{fbde}"
        case .testTubeLight: return "\u{fbdf}"
        case .testTubeRegular: return "\u{fbe0}"
        case .textAlignCenterBold: return "\u{fbe1}"
        case .textAlignCenterFilled: return "\u{fbe2}"
        case .textAlignCenterLight: return "\u{fbe3}"
        case .textAlignCenterRegular: return "\u{fbe4}"
        case .textAlignLeftBold: return "\u{fbe5}"
        case .textAlignLeftFilled: return "\u{fbe6}"
        case .textAlignLeftLight: return "\u{fbe7}"
        case .textAlignLeftRegular: return "\u{fbe8}"
        case .textAlignRightBold: return "\u{fbe9}"
        case .textAlignRightFilled: return "\u{fbea}"
        case .textAlignRightLight: return "\u{fbeb}"
        case .textAlignRightRegular: return "\u{fbec}"
        case .textBold: return "\u{fbed}"
        case .textBoxCursorLight: return "\u{fbee}"
        case .textCodeBlockBold: return "\u{fbef}"
        case .textCodeBlockLight: return "\u{fbf0}"
        case .textCodeBlockRegular: return "\u{fbf1}"
        case .textHighlightBold: return "\u{fbf2}"
        case .textHighlightFilled: return "\u{fbf3}"
        case .textHighlightLight: return "\u{fbf4}"
        case .textHighlightRegular: return "\u{fbf5}"
        case .textLight: return "\u{fbf6}"
        case .textRegular: return "\u{fbf7}"
        case .threeColumnBold: return "\u{fbf8}"
        case .threeColumnLight: return "\u{fbf9}"
        case .threeColumnRegular: return "\u{fbfa}"
        case .threeDObjectBold: return "\u{fbfb}"
        case .threeDObjectLight: return "\u{fbfc}"
        case .threeDObjectRegular: return "\u{fbfd}"
        case .timeExclusionBold: return "\u{fbfe}"
        case .timeExclusionLight: return "\u{fbff}"
        case .timeExclusionRegular: return "\u{fc00}"
        case .timezoneBold: return "\u{fc01}"
        case .timezoneFilled: return "\u{fc02}"
        case .timezoneLight: return "\u{fc03}"
        case .timezoneRegular: return "\u{fc04}"
        case .tooFastBold: return "\u{fc05}"
        case .tooFastLight: return "\u{fc06}"
        case .tooFastRegular: return "\u{fc07}"
        case .tooSlowBold: return "\u{fc08}"
        case .tooSlowLight: return "\u{fc09}"
        case .tooSlowRegular: return "\u{fc0a}"
        case .toolsBold: return "\u{fc0b}"
        case .toolsFilled: return "\u{fc0c}"
        case .toolsLight: return "\u{fc0d}"
        case .toolsRegular: return "\u{fc0e}"
        case .touchTenBold: return "\u{fc0f}"
        case .touchTenLight: return "\u{fc10}"
        case .touchTenRegular: return "\u{fc11}"
        case .transcriptBold: return "\u{fc12}"
        case .transcriptFilled: return "\u{fc13}"
        case .transcriptLight: return "\u{fc14}"
        case .transcriptRegular: return "\u{fc15}"
        case .translateBold: return "\u{fc16}"
        case .translateLight: return "\u{fc17}"
        case .translateRegular: return "\u{fc18}"
        case .translateUndoBold: return "\u{fc19}"
        case .translateUndoLight: return "\u{fc1a}"
        case .translateUndoRegular: return "\u{fc1b}"
        case .trendingBold: return "\u{fc1c}"
        case .trendingDownBold: return "\u{fc1d}"
        case .trendingDownFilled: return "\u{fc1e}"
        case .trendingDownLight: return "\u{fc1f}"
        case .trendingDownRegular: return "\u{fc20}"
        case .trendingFilled: return "\u{fc21}"
        case .trendingLight: return "\u{fc22}"
        case .trendingRegular: return "\u{fc23}"
        case .trimBold: return "\u{fc24}"
        case .trimLight: return "\u{fc25}"
        case .trimRegular: return "\u{fc26}"
        case .twoColumnBold: return "\u{fc27}"
        case .twoColumnLight: return "\u{fc28}"
        case .twoColumnRegular: return "\u{fc29}"
        case .twoWayVoiceStreamBold: return "\u{fc2a}"
        case .twoWayVoiceStreamFilled: return "\u{fc2b}"
        case .twoWayVoiceStreamLight: return "\u{fc2c}"
        case .twoWayVoiceStreamRegular: return "\u{fc2d}"
        case .ucmCloudBold: return "\u{fc2e}"
        case .ucmCloudLight: return "\u{fc2f}"
        case .ucmCloudRegular: return "\u{fc30}"
        case .unblockBold: return "\u{fc31}"
        case .unblockFilled: return "\u{fc32}"
        case .unblockLight: return "\u{fc33}"
        case .unblockRegular: return "\u{fc34}"
        case .underlineBold: return "\u{fc35}"
        case .underlineFilled: return "\u{fc36}"
        case .underlineLight: return "\u{fc37}"
        case .underlineRegular: return "\u{fc38}"
        case .undoBold: return "\u{fc39}"
        case .undoLight: return "\u{fc3a}"
        case .undoRegular: return "\u{fc3b}"
        case .unlinkBold: return "\u{fc3c}"
        case .unlinkLight: return "\u{fc3d}"
        case .unlinkRegular: return "\u{fc3e}"
        case .unreadBold: return "\u{fc3f}"
        case .unreadFilled: return "\u{fc40}"
        case .unreadLight: return "\u{fc41}"
        case .unreadRegular: return "\u{fc42}"
        case .unsecureUnlockedBold: return "\u{fc43}"
        case .unsecureUnlockedFilled: return "\u{fc44}"
        case .unsecureUnlockedLight: return "\u{fc45}"
        case .unsecureUnlockedRegular: return "\u{fc46}"
        case .unsortedBold: return "\u{fc47}"
        case .unsortedLight: return "\u{fc48}"
        case .unsortedRegular: return "\u{fc49}"
        case .updateFileShareBold: return "\u{fc4a}"
        case .updateFileShareLight: return "\u{fc4b}"
        case .updateFileShareRegular: return "\u{fc4c}"
        case .uploadBold: return "\u{fc4d}"
        case .uploadImageBold: return "\u{fc4e}"
        case .uploadImageLight: return "\u{fc4f}"
        case .uploadImageRegular: return "\u{fc50}"
        case .uploadLight: return "\u{fc51}"
        case .uploadRegular: return "\u{fc52}"
        case .urgentVoicemailBold: return "\u{fc53}"
        case .urgentVoicemailFilled: return "\u{fc54}"
        case .usbBold: return "\u{fc55}"
        case .usbHeadsetBold: return "\u{fc56}"
        case .usbHeadsetLight: return "\u{fc57}"
        case .usbHeadsetMutedBold: return "\u{fc58}"
        case .usbHeadsetMutedLight: return "\u{fc59}"
        case .usbHeadsetMutedRegular: return "\u{fc5a}"
        case .usbHeadsetRegular: return "\u{fc5b}"
        case .usbLight: return "\u{fc5c}"
        case .usbRegular: return "\u{fc5d}"
        case .userBold: return "\u{fc5e}"
        case .userDeactivateBold: return "\u{fc5f}"
        case .userDeactivateLight: return "\u{fc60}"
        case .userDeactivateRegular: return "\u{fc61}"
        case .userFilled: return "\u{fc62}"
        case .userLight: return "\u{fc63}"
        case .userRegular: return "\u{fc64}"
        case .videoBlurBold: return "\u{fc65}"
        case .videoBlurFilled: return "\u{fc66}"
        case .videoBlurLight: return "\u{fc67}"
        case .videoBlurRegular: return "\u{fc68}"
        case .videoBold: return "\u{fc69}"
        case .videoEffectBold: return "\u{fc6a}"
        case .videoEffectFilled: return "\u{fc6b}"
        case .videoEffectLight: return "\u{fc6c}"
        case .videoEffectRegular: return "\u{fc6d}"
        case .videoFilled: return "\u{fc6e}"
        case .videoLayoutBold: return "\u{fc6f}"
        case .videoLayoutCustomBold: return "\u{fc70}"
        case .videoLayoutCustomFilled: return "\u{fc71}"
        case .videoLayoutCustomLight: return "\u{fc72}"
        case .videoLayoutCustomRegular: return "\u{fc73}"
        case .videoLayoutEqualBold: return "\u{fc74}"
        case .videoLayoutEqualDualBold: return "\u{fc75}"
        case .videoLayoutEqualDualLight: return "\u{fc76}"
        case .videoLayoutEqualDualRegular: return "\u{fc77}"
        case .videoLayoutEqualFilled: return "\u{fc78}"
        case .videoLayoutEqualLight: return "\u{fc79}"
        case .videoLayoutEqualRegular: return "\u{fc7a}"
        case .videoLayoutFilled: return "\u{fc7b}"
        case .videoLayoutLight: return "\u{fc7c}"
        case .videoLayoutOverlayBold: return "\u{fc7d}"
        case .videoLayoutOverlayFilled: return "\u{fc7e}"
        case .videoLayoutOverlayLight: return "\u{fc7f}"
        case .videoLayoutOverlayRegular: return "\u{fc80}"
        case .videoLayoutPresentationBold: return "\u{fc81}"
        case .videoLayoutPresentationFilled: return "\u{fc82}"
        case .videoLayoutPresentationLight: return "\u{fc83}"
        case .videoLayoutPresentationRegular: return "\u{fc84}"
        case .videoLayoutPresenterDominantBold: return "\u{fc85}"
        case .videoLayoutPresenterDominantLight: return "\u{fc86}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc87}"
        case .videoLayoutProminentBold: return "\u{fc88}"
        case .videoLayoutProminentFilled: return "\u{fc89}"
        case .videoLayoutProminentLight: return "\u{fc8a}"
        case .videoLayoutProminentRegular: return "\u{fc8b}"
        case .videoLayoutRegular: return "\u{fc8c}"
        case .videoLayoutShareDominantBold: return "\u{fc8d}"
        case .videoLayoutShareDominantLight: return "\u{fc8e}"
        case .videoLayoutShareDominantRegular: return "\u{fc8f}"
        case .videoLayoutSingleBold: return "\u{fc90}"
        case .videoLayoutSingleFilled: return "\u{fc91}"
        case .videoLayoutSingleLight: return "\u{fc92}"
        case .videoLayoutSingleRegular: return "\u{fc93}"
        case .videoLayoutSpeakerBold: return "\u{fc94}"
        case .videoLayoutSpeakerFilled: return "\u{fc95}"
        case .videoLayoutSpeakerLight: return "\u{fc96}"
        case .videoLayoutSpeakerRegular: return "\u{fc97}"
        case .videoLayoutStackBold: return "\u{fc98}"
        case .videoLayoutStackFilled: return "\u{fc99}"
        case .videoLayoutStackLight: return "\u{fc9a}"
        case .videoLayoutStackRegular: return "\u{fc9b}"
        case .videoLayoutVideoDominantBold: return "\u{fc9c}"
        case .videoLayoutVideoDominantFilled: return "\u{fc9d}"
        case .videoLayoutVideoDominantLight: return "\u{fc9e}"
        case .videoLayoutVideoDominantRegular: return "\u{fc9f}"
        case .videoLight: return "\u{fca0}"
        case .videoPlusBold: return "\u{fca1}"
        case .videoPlusFilled: return "\u{fca2}"
        case .videoPlusLight: return "\u{fca3}"
        case .videoPlusRegular: return "\u{fca4}"
        case .videoRegular: return "\u{fca5}"
        case .videoSpeakerTrackBold: return "\u{fca6}"
        case .videoSpeakerTrackFilled: return "\u{fca7}"
        case .videoSpeakerTrackLight: return "\u{fca8}"
        case .videoSpeakerTrackRegular: return "\u{fca9}"
        case .viewAllBold: return "\u{fcaa}"
        case .viewAllLight: return "\u{fcab}"
        case .viewAllRegular: return "\u{fcac}"
        case .viewListBold: return "\u{fcad}"
        case .viewListFilled: return "\u{fcae}"
        case .viewListLight: return "\u{fcaf}"
        case .viewListRegular: return "\u{fcb0}"
        case .viewStackedBold: return "\u{fcb1}"
        case .viewStackedFilled: return "\u{fcb2}"
        case .viewStackedLight: return "\u{fcb3}"
        case .viewStackedRegular: return "\u{fcb4}"
        case .viewThumbnailBold: return "\u{fcb5}"
        case .viewThumbnailFilled: return "\u{fcb6}"
        case .viewThumbnailLight: return "\u{fcb7}"
        case .viewThumbnailRegular: return "\u{fcb8}"
        case .visionproBold: return "\u{fcb9}"
        case .visionproFilled: return "\u{fcba}"
        case .visionproLight: return "\u{fcbb}"
        case .visionproMoveCallInBold: return "\u{fcbc}"
        case .visionproMoveCallInFilled: return "\u{fcbd}"
        case .visionproMoveCallInLight: return "\u{fcbe}"
        case .visionproMoveCallInOutBold: return "\u{fcbf}"
        case .visionproMoveCallInOutFilled: return "\u{fcc0}"
        case .visionproMoveCallInOutLight: return "\u{fcc1}"
        case .visionproMoveCallInOutRegular: return "\u{fcc2}"
        case .visionproMoveCallInRegular: return "\u{fcc3}"
        case .visionproMoveCallOutBold: return "\u{fcc4}"
        case .visionproMoveCallOutFilled: return "\u{fcc5}"
        case .visionproMoveCallOutLight: return "\u{fcc6}"
        case .visionproMoveCallOutRegular: return "\u{fcc7}"
        case .visionproRegular: return "\u{fcc8}"
        case .voicemailBold: return "\u{fcc9}"
        case .voicemailFilled: return "\u{fcca}"
        case .voicemailLight: return "\u{fccb}"
        case .voicemailRegular: return "\u{fccc}"
        case .vpnBold: return "\u{fccd}"
        case .vpnFilled: return "\u{fcce}"
        case .vpnLight: return "\u{fccf}"
        case .vpnRegular: return "\u{fcd0}"
        case .vscBold: return "\u{fcd1}"
        case .vscLight: return "\u{fcd2}"
        case .vscRegular: return "\u{fcd3}"
        case .waffleMenuBold: return "\u{fcd4}"
        case .waffleMenuLight: return "\u{fcd5}"
        case .waffleMenuRegular: return "\u{fcd6}"
        case .waitingRoomBold: return "\u{fcd7}"
        case .waitingRoomLight: return "\u{fcd8}"
        case .waitingRoomRegular: return "\u{fcd9}"
        case .wallpaperBold: return "\u{fcda}"
        case .wallpaperLight: return "\u{fcdb}"
        case .wallpaperRegular: return "\u{fcdc}"
        case .warningBadgeFilled: return "\u{fcdd}"
        case .warningBold: return "\u{fcde}"
        case .warningFilled: return "\u{fcdf}"
        case .warningLight: return "\u{fce0}"
        case .warningRegular: return "\u{fce1}"
        case .webexBoardBold: return "\u{fce2}"
        case .webexBoardLight: return "\u{fce3}"
        case .webexBoardRegular: return "\u{fce4}"
        case .webexCodecPlusBold: return "\u{fce5}"
        case .webexCodecPlusLight: return "\u{fce6}"
        case .webexCodecPlusRegular: return "\u{fce7}"
        case .webexDeskCameraBold: return "\u{fce8}"
        case .webexDeskCameraLight: return "\u{fce9}"
        case .webexDeskCameraRegular: return "\u{fcea}"
        case .webexHelixBold: return "\u{fceb}"
        case .webexHelixLight: return "\u{fcec}"
        case .webexHelixRegular: return "\u{fced}"
        case .webexMeetingsBold: return "\u{fcee}"
        case .webexMeetingsFilled: return "\u{fcef}"
        case .webexMeetingsLight: return "\u{fcf0}"
        case .webexMeetingsRegular: return "\u{fcf1}"
        case .webexQuadCameraBold: return "\u{fcf2}"
        case .webexQuadCameraLight: return "\u{fcf3}"
        case .webexQuadCameraRegular: return "\u{fcf4}"
        case .webexRoomKitBold: return "\u{fcf5}"
        case .webexRoomKitLight: return "\u{fcf6}"
        case .webexRoomKitPlusBold: return "\u{fcf7}"
        case .webexRoomKitPlusLight: return "\u{fcf8}"
        case .webexRoomKitPlusRegular: return "\u{fcf9}"
        case .webexRoomKitRegular: return "\u{fcfa}"
        case .webexShareBold: return "\u{fcfb}"
        case .webexShareLight: return "\u{fcfc}"
        case .webexShareRegular: return "\u{fcfd}"
        case .webexTeamsBold: return "\u{fcfe}"
        case .webexTeamsFilled: return "\u{fcff}"
        case .webexTeamsLight: return "\u{fd00}"
        case .webexTeamsNewBold: return "\u{fd01}"
        case .webexTeamsNewFilled: return "\u{fd02}"
        case .webexTeamsNewLight: return "\u{fd03}"
        case .webexTeamsNewRegular: return "\u{fd04}"
        case .webexTeamsRegular: return "\u{fd05}"
        case .webexTeamsRemoveBold: return "\u{fd06}"
        case .webexTeamsRemoveLight: return "\u{fd07}"
        case .webexTeamsRemoveRegular: return "\u{fd08}"
        case .webhookBold: return "\u{fd09}"
        case .webhookLight: return "\u{fd0a}"
        case .webhookRegular: return "\u{fd0b}"
        case .webinarBold: return "\u{fd0c}"
        case .webinarFilled: return "\u{fd0d}"
        case .webinarLight: return "\u{fd0e}"
        case .webinarRegular: return "\u{fd0f}"
        case .weeklyRecurringScheduleBold: return "\u{fd10}"
        case .weeklyRecurringScheduleLight: return "\u{fd11}"
        case .weeklyRecurringScheduleRegular: return "\u{fd12}"
        case .whisperAnnouncementBold: return "\u{fd13}"
        case .whisperAnnouncementFilled: return "\u{fd14}"
        case .whisperAnnouncementLight: return "\u{fd15}"
        case .whisperAnnouncementRegular: return "\u{fd16}"
        case .whisperCoachBold: return "\u{fd17}"
        case .whisperCoachFilled: return "\u{fd18}"
        case .whisperCoachLight: return "\u{fd19}"
        case .whisperCoachRegular: return "\u{fd1a}"
        case .whiteboardBold: return "\u{fd1b}"
        case .whiteboardContentBold: return "\u{fd1c}"
        case .whiteboardContentFilled: return "\u{fd1d}"
        case .whiteboardContentLight: return "\u{fd1e}"
        case .whiteboardContentRegular: return "\u{fd1f}"
        case .whiteboardFilled: return "\u{fd20}"
        case .whiteboardLight: return "\u{fd21}"
        case .whiteboardRegular: return "\u{fd22}"
        case .widgetBold: return "\u{fd23}"
        case .widgetFilled: return "\u{fd24}"
        case .widgetLight: return "\u{fd25}"
        case .widgetRegular: return "\u{fd26}"
        case .wifiBold: return "\u{fd27}"
        case .wifiErrorBold: return "\u{fd28}"
        case .wifiErrorLight: return "\u{fd29}"
        case .wifiErrorRegular: return "\u{fd2a}"
        case .wifiLight: return "\u{fd2b}"
        case .wifiRegular: return "\u{fd2c}"
        case .wifiSignalGoodBold: return "\u{fd2d}"
        case .wifiSignalGoodLight: return "\u{fd2e}"
        case .wifiSignalGoodRegular: return "\u{fd2f}"
        case .wifiSignalPoorBold: return "\u{fd30}"
        case .wifiSignalPoorLight: return "\u{fd31}"
        case .wifiSignalPoorRegular: return "\u{fd32}"
        case .wifiSignalUnstableBold: return "\u{fd33}"
        case .wifiSignalUnstableLight: return "\u{fd34}"
        case .wifiSignalUnstableRegular: return "\u{fd35}"
        case .windowCornerScrubBold: return "\u{fd36}"
        case .windowCornerScrubLight: return "\u{fd37}"
        case .windowCornerScrubRegular: return "\u{fd38}"
        case .windowRightCornerScrubBold: return "\u{fd39}"
        case .windowRightCornerScrubLight: return "\u{fd3a}"
        case .windowRightCornerScrubRegular: return "\u{fd3b}"
        case .windowVerticalScrubBold: return "\u{fd3c}"
        case .windowVerticalScrubLight: return "\u{fd3d}"
        case .windowVerticalScrubRegular: return "\u{fd3e}"
        case .workflowDeploymentsBold: return "\u{fd3f}"
        case .workflowDeploymentsFilled: return "\u{fd40}"
        case .workflowDeploymentsLight: return "\u{fd41}"
        case .workflowDeploymentsRegular: return "\u{fd42}"
        case .workphoneBold: return "\u{fd43}"
        case .workphoneLight: return "\u{fd44}"
        case .workphoneRegular: return "\u{fd45}"
        case .zoomInBold: return "\u{fd46}"
        case .zoomInLight: return "\u{fd47}"
        case .zoomInRegular: return "\u{fd48}"
        case .zoomOutBold: return "\u{fd49}"
        case .zoomOutLight: return "\u{fd4a}"
        case .zoomOutRegular: return "\u{fd4b}"
