...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .transcriptBold: return "\u{fc4f}"
        case .transcriptFilled: return "\u{fc50}"
        case .transcriptLight: return "\u{fc51}"
        case .transcriptRegular: return "\u{fc52}"
        case .translateBold: return "\u{fc53}"
        case .translateLight: return "\u{fc54}"
        case .translateRegular: return "\u{fc55}"
        case .translateUndoBold: return "\u{fc56}"
        case .translateUndoLight: return "\u{fc57}"
        case .translateUndoRegular: return "\u{fc58}"
        case .trendingBold: return "\u{fc59}"
        case .trendingDownBold: return "\u{fc5a}"
        case .trendingDownFilled: return "\u{fc5b}"
        case .trendingDownLight: return "\u{fc5c}"
        case .trendingDownRegular: return "\u{fc5d}"
        case .trendingFilled: return "\u{fc5e}"
        case .trendingLight: return "\u{fc5f}"
        case .trendingRegular: return "\u{fc60}"
        case .trimBold: return "\u{fc61}"
        case .trimLight: return "\u{fc62}"
        case .trimRegular: return "\u{fc63}"
        case .twoColumnBold: return "\u{fc64}"
        case .twoColumnLight: return "\u{fc65}"
        case .twoColumnRegular: return "\u{fc66}"
        case .twoWayVoiceStreamBold: return "\u{fc67}"
        case .twoWayVoiceStreamFilled: return "\u{fc68}"
        case .twoWayVoiceStreamLight: return "\u{fc69}"
        case .twoWayVoiceStreamRegular: return "\u{fc6a}"
        case .ucmCloudBold: return "\u{fc6b}"
        case .ucmCloudLight: return "\u{fc6c}"
        case .ucmCloudRegular: return "\u{fc6d}"
        case .unblockBold: return "\u{fc6e}"
        case .unblockFilled: return "\u{fc6f}"
        case .unblockLight: return "\u{fc70}"
        case .unblockRegular: return "\u{fc71}"
        case .underlineBold: return "\u{fc72}"
        case .underlineFilled: return "\u{fc73}"
        case .underlineLight: return "\u{fc74}"
        case .underlineRegular: return "\u{fc75}"
        case .undoBold: return "\u{fc76}"
        case .undoLight: return "\u{fc77}"
        case .undoRegular: return "\u{fc78}"
        case .unlinkBold: return "\u{fc79}"
        case .unlinkLight: return "\u{fc7a}"
        case .unlinkRegular: return "\u{fc7b}"
        case .unreadBold: return "\u{fc7c}"
        case .unreadFilled: return "\u{fc7d}"
        case .unreadLight: return "\u{fc7e}"
        case .unreadRegular: return "\u{fc7f}"
        case .unsecureUnlockedBold: return "\u{fc80}"
        case .unsecureUnlockedFilled: return "\u{fc81}"
        case .unsecureUnlockedLight: return "\u{fc82}"
        case .unsecureUnlockedRegular: return "\u{fc83}"
        case .unsortedBold: return "\u{fc84}"
        case .unsortedLight: return "\u{fc85}"
        case .unsortedRegular: return "\u{fc86}"
        case .updateFileShareBold: return "\u{fc87}"
        case .updateFileShareLight: return "\u{fc88}"
        case .updateFileShareRegular: return "\u{fc89}"
        case .uploadBold: return "\u{fc8a}"
        case .uploadImageBold: return "\u{fc8b}"
        case .uploadImageLight: return "\u{fc8c}"
        case .uploadImageRegular: return "\u{fc8d}"
        case .uploadLight: return "\u{fc8e}"
        case .uploadRegular: return "\u{fc8f}"
        case .urgentVoicemailBold: return "\u{fc90}"
        case .urgentVoicemailFilled: return "\u{fc91}"
        case .usbBold: return "\u{fc92}"
        case .usbHeadsetBold: return "\u{fc93}"
        case .usbHeadsetLight: return "\u{fc94}"
        case .usbHeadsetMutedBold: return "\u{fc95}"
        case .usbHeadsetMutedLight: return "\u{fc96}"
        case .usbHeadsetMutedRegular: return "\u{fc97}"
        case .usbHeadsetRegular: return "\u{fc98}"
        case .usbLight: return "\u{fc99}"
        case .usbRegular: return "\u{fc9a}"
        case .userBold: return "\u{fc9b}"
        case .userDeactivateBold: return "\u{fc9c}"
        case .userDeactivateLight: return "\u{fc9d}"
        case .userDeactivateRegular: return "\u{fc9e}"
        case .userFilled: return "\u{fc9f}"
        case .userLight: return "\u{fca0}"
        case .userRegular: return "\u{fca1}"
        case .userSecurityStatusBold: return "\u{fca2}"
        case .userSecurityStatusFilled: return "\u{fca3}"
        case .userSecurityStatusLight: return "\u{fca4}"
        case .userSecurityStatusRegular: return "\u{fca5}"
        case .videoBlurBold: return "\u{fca6}"
        case .videoBlurFilled: return "\u{fca7}"
        case .videoBlurLight: return "\u{fca8}"
        case .videoBlurRegular: return "\u{fca9}"
        case .videoBold: return "\u{fcaa}"
        case .videoEffectBold: return "\u{fcab}"
        case .videoEffectFilled: return "\u{fcac}"
        case .videoEffectLight: return "\u{fcad}"
        case .videoEffectRegular: return "\u{fcae}"
        case .videoFilled: return "\u{fcaf}"
        case .videoLayoutBold: return "\u{fcb0}"
        case .videoLayoutCustomBold: return "\u{fcb1}"
        case .videoLayoutCustomFilled: return "\u{fcb2}"
        case .videoLayoutCustomLight: return "\u{fcb3}"
        case .videoLayoutCustomRegular: return "\u{fcb4}"
        case .videoLayoutEqualBold: return "\u{fcb5}"
        case .videoLayoutEqualDualBold: return "\u{fcb6}"
        case .videoLayoutEqualDualLight: return "\u{fcb7}"
        case .videoLayoutEqualDualRegular: return "\u{fcb8}"
        case .videoLayoutEqualFilled: return "\u{fcb9}"
        case .videoLayoutEqualLight: return "\u{fcba}"
        case .videoLayoutEqualRegular: return "\u{fcbb}"
        case .videoLayoutFilled: return "\u{fcbc}"
        case .videoLayoutLight: return "\u{fcbd}"
        case .videoLayoutOverlayBold: return "\u{fcbe}"
        case .videoLayoutOverlayFilled: return "\u{fcbf}"
        case .videoLayoutOverlayLight: return "\u{fcc0}"
        case .videoLayoutOverlayRegular: return "\u{fcc1}"
        case .videoLayoutPresentationBold: return "\u{fcc2}"
        case .videoLayoutPresentationFilled: return "\u{fcc3}"
        case .videoLayoutPresentationLight: return "\u{fcc4}"
        case .videoLayoutPresentationRegular: return "\u{fcc5}"
        case .videoLayoutPresenterDominantBold: return "\u{fcc6}"
        case .videoLayoutPresenterDominantLight: return "\u{fcc7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcc8}"
        case .videoLayoutProminentBold: return "\u{fcc9}"
        case .videoLayoutProminentFilled: return "\u{fcca}"
        case .videoLayoutProminentLight: return "\u{fccb}"
        case .videoLayoutProminentRegular: return "\u{fccc}"
        case .videoLayoutRegular: return "\u{fccd}"
        case .videoLayoutShareDominantBold: return "\u{fcce}"
        case .videoLayoutShareDominantLight: return "\u{fccf}"
        case .videoLayoutShareDominantRegular: return "\u{fcd0}"
        case .videoLayoutSingleBold: return "\u{fcd1}"
        case .videoLayoutSingleFilled: return "\u{fcd2}"
        case .videoLayoutSingleLight: return "\u{fcd3}"
        case .videoLayoutSingleRegular: return "\u{fcd4}"
        case .videoLayoutSpeakerBold: return "\u{fcd5}"
        case .videoLayoutSpeakerFilled: return "\u{fcd6}"
        case .videoLayoutSpeakerLight: return "\u{fcd7}"
        case .videoLayoutSpeakerRegular: return "\u{fcd8}"
        case .videoLayoutStackBold: return "\u{fcd9}"
        case .videoLayoutStackFilled: return "\u{fcda}"
        case .videoLayoutStackLight: return "\u{fcdb}"
        case .videoLayoutStackRegular: return "\u{fcdc}"
        case .videoLayoutVideoDominantBold: return "\u{fcdd}"
        case .videoLayoutVideoDominantFilled: return "\u{fcde}"
        case .videoLayoutVideoDominantLight: return "\u{fcdf}"
        case .videoLayoutVideoDominantRegular: return "\u{fce0}"
        case .videoLight: return "\u{fce1}"
        case .videoPlusBold: return "\u{fce2}"
        case .videoPlusFilled: return "\u{fce3}"
        case .videoPlusLight: return "\u{fce4}"
        case .videoPlusRegular: return "\u{fce5}"
        case .videoRegular: return "\u{fce6}"
        case .videoSpeakerTrackBold: return "\u{fce7}"
        case .videoSpeakerTrackFilled: return "\u{fce8}"
        case .videoSpeakerTrackLight: return "\u{fce9}"
        case .videoSpeakerTrackRegular: return "\u{fcea}"
        case .viewAllBold: return "\u{fceb}"
        case .viewAllLight: return "\u{fcec}"
        case .viewAllRegular: return "\u{fced}"
        case .viewListBold: return "\u{fcee}"
        case .viewListFilled: return "\u{fcef}"
        case .viewListLight: return "\u{fcf0}"
        case .viewListRegular: return "\u{fcf1}"
        case .viewStackedBold: return "\u{fcf2}"
        case .viewStackedFilled: return "\u{fcf3}"
        case .viewStackedLight: return "\u{fcf4}"
        case .viewStackedRegular: return "\u{fcf5}"
        case .viewThumbnailBold: return "\u{fcf6}"
        case .viewThumbnailFilled: return "\u{fcf7}"
        case .viewThumbnailLight: return "\u{fcf8}"
        case .viewThumbnailRegular: return "\u{fcf9}"
        case .visionproBold: return "\u{fcfa}"
        case .visionproFilled: return "\u{fcfb}"
        case .visionproLight: return "\u{fcfc}"
        case .visionproMoveCallInBold: return "\u{fcfd}"
        case .visionproMoveCallInFilled: return "\u{fcfe}"
        case .visionproMoveCallInLight: return "\u{fcff}"
        case .visionproMoveCallInOutBold: return "\u{fd00}"
        case .visionproMoveCallInOutFilled: return "\u{fd01}"
        case .visionproMoveCallInOutLight: return "\u{fd02}"
        case .visionproMoveCallInOutRegular: return "\u{fd03}"
        case .visionproMoveCallInRegular: return "\u{fd04}"
        case .visionproMoveCallOutBold: return "\u{fd05}"
        case .visionproMoveCallOutFilled: return "\u{fd06}"
        case .visionproMoveCallOutLight: return "\u{fd07}"
        case .visionproMoveCallOutRegular: return "\u{fd08}"
        case .visionproRegular: return "\u{fd09}"
        case .voicemailBold: return "\u{fd0a}"
        case .voicemailFilled: return "\u{fd0b}"
        case .voicemailLight: return "\u{fd0c}"
        case .voicemailRegular: return "\u{fd0d}"
        case .vpnBold: return "\u{fd0e}"
        case .vpnFilled: return "\u{fd0f}"
        case .vpnLight: return "\u{fd10}"
        case .vpnRegular: return "\u{fd11}"
        case .vscBold: return "\u{fd12}"
        case .vscLight: return "\u{fd13}"
        case .vscRegular: return "\u{fd14}"
        case .waffleMenuBold: return "\u{fd15}"
        case .waffleMenuLight: return "\u{fd16}"
        case .waffleMenuRegular: return "\u{fd17}"
        case .waitingRoomBold: return "\u{fd18}"
        case .waitingRoomFilled: return "\u{fd19}"
        case .waitingRoomLight: return "\u{fd1a}"
        case .waitingRoomRegular: return "\u{fd1b}"
        case .wallpaperBold: return "\u{fd1c}"
        case .wallpaperLight: return "\u{fd1d}"
        case .wallpaperRegular: return "\u{fd1e}"
        case .warningBadgeFilled: return "\u{fd1f}"
        case .warningBold: return "\u{fd20}"
        case .warningFilled: return "\u{fd21}"
        case .warningLight: return "\u{fd22}"
        case .warningRegular: return "\u{fd23}"
        case .webexBoardBold: return "\u{fd24}"
        case .webexBoardLight: return "\u{fd25}"
        case .webexBoardRegular: return "\u{fd26}"
        case .webexCodecPlusBold: return "\u{fd27}"
        case .webexCodecPlusLight: return "\u{fd28}"
        case .webexCodecPlusRegular: return "\u{fd29}"
        case .webexDeskCameraBold: return "\u{fd2a}"
        case .webexDeskCameraLight: return "\u{fd2b}"
        case .webexDeskCameraRegular: return "\u{fd2c}"
        case .webexHelixBold: return "\u{fd2d}"
        case .webexHelixLight: return "\u{fd2e}"
        case .webexHelixRegular: return "\u{fd2f}"
        case .webexMeetingsBold: return "\u{fd30}"
        case .webexMeetingsFilled: return "\u{fd31}"
        case .webexMeetingsLight: return "\u{fd32}"
        case .webexMeetingsRegular: return "\u{fd33}"
        case .webexQuadCameraBold: return "\u{fd34}"
        case .webexQuadCameraLight: return "\u{fd35}"
        case .webexQuadCameraRegular: return "\u{fd36}"
        case .webexRoomKitBold: return "\u{fd37}"
        case .webexRoomKitLight: return "\u{fd38}"
        case .webexRoomKitPlusBold: return "\u{fd39}"
        case .webexRoomKitPlusLight: return "\u{fd3a}"
        case .webexRoomKitPlusRegular: return "\u{fd3b}"
        case .webexRoomKitRegular: return "\u{fd3c}"
        case .webexShareBold: return "\u{fd3d}"
        case .webexShareLight: return "\u{fd3e}"
        case .webexShareRegular: return "\u{fd3f}"
        case .webexTeamsBold: return "\u{fd40}"
        case .webexTeamsFilled: return "\u{fd41}"
        case .webexTeamsLight: return "\u{fd42}"
        case .webexTeamsNewBold: return "\u{fd43}"
        case .webexTeamsNewFilled: return "\u{fd44}"
        case .webexTeamsNewLight: return "\u{fd45}"
        case .webexTeamsNewRegular: return "\u{fd46}"
        case .webexTeamsRegular: return "\u{fd47}"
        case .webexTeamsRemoveBold: return "\u{fd48}"
        case .webexTeamsRemoveLight: return "\u{fd49}"
        case .webexTeamsRemoveRegular: return "\u{fd4a}"
        case .webhookBold: return "\u{fd4b}"
        case .webhookLight: return "\u{fd4c}"
        case .webhookRegular: return "\u{fd4d}"
        case .webinarBold: return "\u{fd4e}"
        case .webinarFilled: return "\u{fd4f}"
        case .webinarLight: return "\u{fd50}"
        case .webinarRegular: return "\u{fd51}"
        case .weeklyRecurringScheduleBold: return "\u{fd52}"
        case .weeklyRecurringScheduleLight: return "\u{fd53}"
        case .weeklyRecurringScheduleRegular: return "\u{fd54}"
        case .whisperAnnouncementBold: return "\u{fd55}"
        case .whisperAnnouncementFilled: return "\u{fd56}"
        case .whisperAnnouncementLight: return "\u{fd57}"
        case .whisperAnnouncementRegular: return "\u{fd58}"
        case .whisperCoachBold: return "\u{fd59}"
        case .whisperCoachFilled: return "\u{fd5a}"
        case .whisperCoachLight: return "\u{fd5b}"
        case .whisperCoachRegular: return "\u{fd5c}"
        case .whiteboardBold: return "\u{fd5d}"
        case .whiteboardContentBold: return "\u{fd5e}"
        case .whiteboardContentFilled: return "\u{fd5f}"
        case .whiteboardContentLight: return "\u{fd60}"
        case .whiteboardContentRegular: return "\u{fd61}"
        case .whiteboardFilled: return "\u{fd62}"
        case .whiteboardLight: return "\u{fd63}"
        case .whiteboardRegular: return "\u{fd64}"
        case .widgetBold: return "\u{fd65}"
        case .widgetFilled: return "\u{fd66}"
        case .widgetLight: return "\u{fd67}"
        case .widgetRegular: return "\u{fd68}"
        case .wifiBold: return "\u{fd69}"
        case .wifiErrorBold: return "\u{fd6a}"
        case .wifiErrorLight: return "\u{fd6b}"
        case .wifiErrorRegular: return "\u{fd6c}"
        case .wifiLight: return "\u{fd6d}"
        case .wifiRegular: return "\u{fd6e}"
        case .wifiSignalGoodBold: return "\u{fd6f}"
        case .wifiSignalGoodLight: return "\u{fd70}"
        case .wifiSignalGoodRegular: return "\u{fd71}"
        case .wifiSignalPoorBold: return "\u{fd72}"
        case .wifiSignalPoorLight: return "\u{fd73}"
        case .wifiSignalPoorRegular: return "\u{fd74}"
        case .wifiSignalUnstableBold: return "\u{fd75}"
        case .wifiSignalUnstableLight: return "\u{fd76}"
        case .wifiSignalUnstableRegular: return "\u{fd77}"
        case .windowCornerScrubBold: return "\u{fd78}"
        case .windowCornerScrubLight: return "\u{fd79}"
        case .windowCornerScrubRegular: return "\u{fd7a}"
        case .windowRightCornerScrubBold: return "\u{fd7b}"
        case .windowRightCornerScrubLight: return "\u{fd7c}"
        case .windowRightCornerScrubRegular: return "\u{fd7d}"
        case .windowVerticalScrubBold: return "\u{fd7e}"
        case .windowVerticalScrubLight: return "\u{fd7f}"
        case .windowVerticalScrubRegular: return "\u{fd80}"
        case .workflowDeploymentsBold: return "\u{fd81}"
        case .workflowDeploymentsFilled: return "\u{fd82}"
        case .workflowDeploymentsLight: return "\u{fd83}"
        case .workflowDeploymentsRegular: return "\u{fd84}"
        case .workphoneBold: return "\u{fd85}"
        case .workphoneLight: return "\u{fd86}"
        case .workphoneRegular: return "\u{fd87}"
        case .zoomInBold: return "\u{fd88}"
        case .zoomInLight: return "\u{fd89}"
        case .zoomInRegular: return "\u{fd8a}"
        case .zoomOutBold: return "\u{fd8b}"
        case .zoomOutLight: return "\u{fd8c}"
        case .zoomOutRegular: return "\u{fd8d}"
