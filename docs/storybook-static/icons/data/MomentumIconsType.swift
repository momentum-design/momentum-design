...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .videoBlurBold: return "\u{fc99}"
        case .videoBlurFilled: return "\u{fc9a}"
        case .videoBlurLight: return "\u{fc9b}"
        case .videoBlurRegular: return "\u{fc9c}"
        case .videoBold: return "\u{fc9d}"
        case .videoEffectBold: return "\u{fc9e}"
        case .videoEffectFilled: return "\u{fc9f}"
        case .videoEffectLight: return "\u{fca0}"
        case .videoEffectRegular: return "\u{fca1}"
        case .videoFilled: return "\u{fca2}"
        case .videoLayoutBold: return "\u{fca3}"
        case .videoLayoutCustomBold: return "\u{fca4}"
        case .videoLayoutCustomFilled: return "\u{fca5}"
        case .videoLayoutCustomLight: return "\u{fca6}"
        case .videoLayoutCustomRegular: return "\u{fca7}"
        case .videoLayoutEqualBold: return "\u{fca8}"
        case .videoLayoutEqualDualBold: return "\u{fca9}"
        case .videoLayoutEqualDualLight: return "\u{fcaa}"
        case .videoLayoutEqualDualRegular: return "\u{fcab}"
        case .videoLayoutEqualFilled: return "\u{fcac}"
        case .videoLayoutEqualLight: return "\u{fcad}"
        case .videoLayoutEqualRegular: return "\u{fcae}"
        case .videoLayoutFilled: return "\u{fcaf}"
        case .videoLayoutLight: return "\u{fcb0}"
        case .videoLayoutOverlayBold: return "\u{fcb1}"
        case .videoLayoutOverlayFilled: return "\u{fcb2}"
        case .videoLayoutOverlayLight: return "\u{fcb3}"
        case .videoLayoutOverlayRegular: return "\u{fcb4}"
        case .videoLayoutPresentationBold: return "\u{fcb5}"
        case .videoLayoutPresentationFilled: return "\u{fcb6}"
        case .videoLayoutPresentationLight: return "\u{fcb7}"
        case .videoLayoutPresentationRegular: return "\u{fcb8}"
        case .videoLayoutPresenterDominantBold: return "\u{fcb9}"
        case .videoLayoutPresenterDominantLight: return "\u{fcba}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcbb}"
        case .videoLayoutProminentBold: return "\u{fcbc}"
        case .videoLayoutProminentFilled: return "\u{fcbd}"
        case .videoLayoutProminentLight: return "\u{fcbe}"
        case .videoLayoutProminentRegular: return "\u{fcbf}"
        case .videoLayoutRegular: return "\u{fcc0}"
        case .videoLayoutShareDominantBold: return "\u{fcc1}"
        case .videoLayoutShareDominantLight: return "\u{fcc2}"
        case .videoLayoutShareDominantRegular: return "\u{fcc3}"
        case .videoLayoutSingleBold: return "\u{fcc4}"
        case .videoLayoutSingleFilled: return "\u{fcc5}"
        case .videoLayoutSingleLight: return "\u{fcc6}"
        case .videoLayoutSingleRegular: return "\u{fcc7}"
        case .videoLayoutSpeakerBold: return "\u{fcc8}"
        case .videoLayoutSpeakerFilled: return "\u{fcc9}"
        case .videoLayoutSpeakerLight: return "\u{fcca}"
        case .videoLayoutSpeakerRegular: return "\u{fccb}"
        case .videoLayoutStackBold: return "\u{fccc}"
        case .videoLayoutStackFilled: return "\u{fccd}"
        case .videoLayoutStackLight: return "\u{fcce}"
        case .videoLayoutStackRegular: return "\u{fccf}"
        case .videoLayoutVideoDominantBold: return "\u{fcd0}"
        case .videoLayoutVideoDominantFilled: return "\u{fcd1}"
        case .videoLayoutVideoDominantLight: return "\u{fcd2}"
        case .videoLayoutVideoDominantRegular: return "\u{fcd3}"
        case .videoLight: return "\u{fcd4}"
        case .videoPlusBold: return "\u{fcd5}"
        case .videoPlusFilled: return "\u{fcd6}"
        case .videoPlusLight: return "\u{fcd7}"
        case .videoPlusRegular: return "\u{fcd8}"
        case .videoRegular: return "\u{fcd9}"
        case .videoSpeakerTrackBold: return "\u{fcda}"
        case .videoSpeakerTrackFilled: return "\u{fcdb}"
        case .videoSpeakerTrackLight: return "\u{fcdc}"
        case .videoSpeakerTrackRegular: return "\u{fcdd}"
        case .viewAllBold: return "\u{fcde}"
        case .viewAllLight: return "\u{fcdf}"
        case .viewAllRegular: return "\u{fce0}"
        case .viewListBold: return "\u{fce1}"
        case .viewListFilled: return "\u{fce2}"
        case .viewListLight: return "\u{fce3}"
        case .viewListRegular: return "\u{fce4}"
        case .viewStackedBold: return "\u{fce5}"
        case .viewStackedFilled: return "\u{fce6}"
        case .viewStackedLight: return "\u{fce7}"
        case .viewStackedRegular: return "\u{fce8}"
        case .viewThumbnailBold: return "\u{fce9}"
        case .viewThumbnailFilled: return "\u{fcea}"
        case .viewThumbnailLight: return "\u{fceb}"
        case .viewThumbnailRegular: return "\u{fcec}"
        case .visionproBold: return "\u{fced}"
        case .visionproFilled: return "\u{fcee}"
        case .visionproLight: return "\u{fcef}"
        case .visionproMoveCallInBold: return "\u{fcf0}"
        case .visionproMoveCallInFilled: return "\u{fcf1}"
        case .visionproMoveCallInLight: return "\u{fcf2}"
        case .visionproMoveCallInOutBold: return "\u{fcf3}"
        case .visionproMoveCallInOutFilled: return "\u{fcf4}"
        case .visionproMoveCallInOutLight: return "\u{fcf5}"
        case .visionproMoveCallInOutRegular: return "\u{fcf6}"
        case .visionproMoveCallInRegular: return "\u{fcf7}"
        case .visionproMoveCallOutBold: return "\u{fcf8}"
        case .visionproMoveCallOutFilled: return "\u{fcf9}"
        case .visionproMoveCallOutLight: return "\u{fcfa}"
        case .visionproMoveCallOutRegular: return "\u{fcfb}"
        case .visionproRegular: return "\u{fcfc}"
        case .voicemailBold: return "\u{fcfd}"
        case .voicemailFilled: return "\u{fcfe}"
        case .voicemailLight: return "\u{fcff}"
        case .voicemailRegular: return "\u{fd00}"
        case .vpnBold: return "\u{fd01}"
        case .vpnFilled: return "\u{fd02}"
        case .vpnLight: return "\u{fd03}"
        case .vpnRegular: return "\u{fd04}"
        case .vscBold: return "\u{fd05}"
        case .vscLight: return "\u{fd06}"
        case .vscRegular: return "\u{fd07}"
        case .waffleMenuBold: return "\u{fd08}"
        case .waffleMenuLight: return "\u{fd09}"
        case .waffleMenuRegular: return "\u{fd0a}"
        case .waitingRoomBold: return "\u{fd0b}"
        case .waitingRoomFilled: return "\u{fd0c}"
        case .waitingRoomLight: return "\u{fd0d}"
        case .waitingRoomRegular: return "\u{fd0e}"
        case .wallpaperBold: return "\u{fd0f}"
        case .wallpaperLight: return "\u{fd10}"
        case .wallpaperRegular: return "\u{fd11}"
        case .warningBadgeFilled: return "\u{fd12}"
        case .warningBold: return "\u{fd13}"
        case .warningFilled: return "\u{fd14}"
        case .warningLight: return "\u{fd15}"
        case .warningRegular: return "\u{fd16}"
        case .webexBoardBold: return "\u{fd17}"
        case .webexBoardLight: return "\u{fd18}"
        case .webexBoardRegular: return "\u{fd19}"
        case .webexCodecPlusBold: return "\u{fd1a}"
        case .webexCodecPlusLight: return "\u{fd1b}"
        case .webexCodecPlusRegular: return "\u{fd1c}"
        case .webexDeskCameraBold: return "\u{fd1d}"
        case .webexDeskCameraLight: return "\u{fd1e}"
        case .webexDeskCameraRegular: return "\u{fd1f}"
        case .webexHelixBold: return "\u{fd20}"
        case .webexHelixLight: return "\u{fd21}"
        case .webexHelixRegular: return "\u{fd22}"
        case .webexMeetingsBold: return "\u{fd23}"
        case .webexMeetingsFilled: return "\u{fd24}"
        case .webexMeetingsLight: return "\u{fd25}"
        case .webexMeetingsRegular: return "\u{fd26}"
        case .webexQuadCameraBold: return "\u{fd27}"
        case .webexQuadCameraLight: return "\u{fd28}"
        case .webexQuadCameraRegular: return "\u{fd29}"
        case .webexRoomKitBold: return "\u{fd2a}"
        case .webexRoomKitLight: return "\u{fd2b}"
        case .webexRoomKitPlusBold: return "\u{fd2c}"
        case .webexRoomKitPlusLight: return "\u{fd2d}"
        case .webexRoomKitPlusRegular: return "\u{fd2e}"
        case .webexRoomKitRegular: return "\u{fd2f}"
        case .webexShareBold: return "\u{fd30}"
        case .webexShareLight: return "\u{fd31}"
        case .webexShareRegular: return "\u{fd32}"
        case .webexTeamsBold: return "\u{fd33}"
        case .webexTeamsFilled: return "\u{fd34}"
        case .webexTeamsLight: return "\u{fd35}"
        case .webexTeamsNewBold: return "\u{fd36}"
        case .webexTeamsNewFilled: return "\u{fd37}"
        case .webexTeamsNewLight: return "\u{fd38}"
        case .webexTeamsNewRegular: return "\u{fd39}"
        case .webexTeamsRegular: return "\u{fd3a}"
        case .webexTeamsRemoveBold: return "\u{fd3b}"
        case .webexTeamsRemoveLight: return "\u{fd3c}"
        case .webexTeamsRemoveRegular: return "\u{fd3d}"
        case .webhookBold: return "\u{fd3e}"
        case .webhookLight: return "\u{fd3f}"
        case .webhookRegular: return "\u{fd40}"
        case .webinarBold: return "\u{fd41}"
        case .webinarFilled: return "\u{fd42}"
        case .webinarLight: return "\u{fd43}"
        case .webinarRegular: return "\u{fd44}"
        case .weeklyRecurringScheduleBold: return "\u{fd45}"
        case .weeklyRecurringScheduleLight: return "\u{fd46}"
        case .weeklyRecurringScheduleRegular: return "\u{fd47}"
        case .whisperAnnouncementBold: return "\u{fd48}"
        case .whisperAnnouncementFilled: return "\u{fd49}"
        case .whisperAnnouncementLight: return "\u{fd4a}"
        case .whisperAnnouncementRegular: return "\u{fd4b}"
        case .whisperCoachBold: return "\u{fd4c}"
        case .whisperCoachFilled: return "\u{fd4d}"
        case .whisperCoachLight: return "\u{fd4e}"
        case .whisperCoachRegular: return "\u{fd4f}"
        case .whiteboardBold: return "\u{fd50}"
        case .whiteboardContentBold: return "\u{fd51}"
        case .whiteboardContentFilled: return "\u{fd52}"
        case .whiteboardContentLight: return "\u{fd53}"
        case .whiteboardContentRegular: return "\u{fd54}"
        case .whiteboardFilled: return "\u{fd55}"
        case .whiteboardLight: return "\u{fd56}"
        case .whiteboardRegular: return "\u{fd57}"
        case .widgetBold: return "\u{fd58}"
        case .widgetFilled: return "\u{fd59}"
        case .widgetLight: return "\u{fd5a}"
        case .widgetRegular: return "\u{fd5b}"
        case .wifiBold: return "\u{fd5c}"
        case .wifiErrorBold: return "\u{fd5d}"
        case .wifiErrorLight: return "\u{fd5e}"
        case .wifiErrorRegular: return "\u{fd5f}"
        case .wifiLight: return "\u{fd60}"
        case .wifiRegular: return "\u{fd61}"
        case .wifiSignalGoodBold: return "\u{fd62}"
        case .wifiSignalGoodLight: return "\u{fd63}"
        case .wifiSignalGoodRegular: return "\u{fd64}"
        case .wifiSignalPoorBold: return "\u{fd65}"
        case .wifiSignalPoorLight: return "\u{fd66}"
        case .wifiSignalPoorRegular: return "\u{fd67}"
        case .wifiSignalUnstableBold: return "\u{fd68}"
        case .wifiSignalUnstableLight: return "\u{fd69}"
        case .wifiSignalUnstableRegular: return "\u{fd6a}"
        case .windowCornerScrubBold: return "\u{fd6b}"
        case .windowCornerScrubLight: return "\u{fd6c}"
        case .windowCornerScrubRegular: return "\u{fd6d}"
        case .windowRightCornerScrubBold: return "\u{fd6e}"
        case .windowRightCornerScrubLight: return "\u{fd6f}"
        case .windowRightCornerScrubRegular: return "\u{fd70}"
        case .windowVerticalScrubBold: return "\u{fd71}"
        case .windowVerticalScrubLight: return "\u{fd72}"
        case .windowVerticalScrubRegular: return "\u{fd73}"
        case .workflowDeploymentsBold: return "\u{fd74}"
        case .workflowDeploymentsFilled: return "\u{fd75}"
        case .workflowDeploymentsLight: return "\u{fd76}"
        case .workflowDeploymentsRegular: return "\u{fd77}"
        case .workphoneBold: return "\u{fd78}"
        case .workphoneLight: return "\u{fd79}"
        case .workphoneRegular: return "\u{fd7a}"
        case .zoomInBold: return "\u{fd7b}"
        case .zoomInLight: return "\u{fd7c}"
        case .zoomInRegular: return "\u{fd7d}"
        case .zoomOutBold: return "\u{fd7e}"
        case .zoomOutLight: return "\u{fd7f}"
        case .zoomOutRegular: return "\u{fd80}"
