...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .channelUssdLight: return "\u{f34f}"
        case .channelUssdRegular: return "\u{f350}"
        case .chatBold: return "\u{f351}"
        case .chatFilled: return "\u{f352}"
        case .chatGroupBold: return "\u{f353}"
        case .chatGroupFilled: return "\u{f354}"
        case .chatGroupLight: return "\u{f355}"
        case .chatGroupRegular: return "\u{f356}"
        case .chatLight: return "\u{f357}"
        case .chatMuteBold: return "\u{f358}"
        case .chatMuteLight: return "\u{f359}"
        case .chatMuteRegular: return "\u{f35a}"
        case .chatOutboundFilled: return "\u{f35b}"
        case .chatRegular: return "\u{f35c}"
        case .checkBold: return "\u{f35d}"
        case .checkCircleBadgeFilled: return "\u{f35e}"
        case .checkCircleBold: return "\u{f35f}"
        case .checkCircleFilled: return "\u{f360}"
        case .checkCircleLight: return "\u{f361}"
        case .checkCircleRegular: return "\u{f362}"
        case .checkFilled: return "\u{f363}"
        case .checkLight: return "\u{f364}"
        case .checkRegular: return "\u{f365}"
        case .checkboxGroupBold: return "\u{f366}"
        case .checkboxGroupFilled: return "\u{f367}"
        case .checkboxGroupLight: return "\u{f368}"
        case .checkboxGroupRegular: return "\u{f369}"
        case .cleanUpBold: return "\u{f36a}"
        case .cleanUpLight: return "\u{f36b}"
        case .cleanUpRegular: return "\u{f36c}"
        case .clearBadgeFilled: return "\u{f36d}"
        case .clearBold: return "\u{f36e}"
        case .clearFilled: return "\u{f36f}"
        case .clearLight: return "\u{f370}"
        case .clearRegular: return "\u{f371}"
        case .closeSpaceBold: return "\u{f372}"
        case .closeSpaceLight: return "\u{f373}"
        case .closeSpaceRegular: return "\u{f374}"
        case .closedCaptionBadgeBold: return "\u{f375}"
        case .closedCaptionBadgeFilled: return "\u{f376}"
        case .closedCaptionBadgeLight: return "\u{f377}"
        case .closedCaptionBadgeRegular: return "\u{f378}"
        case .closedCaptionsBold: return "\u{f379}"
        case .closedCaptionsFilled: return "\u{f37a}"
        case .closedCaptionsLight: return "\u{f37b}"
        case .closedCaptionsRegular: return "\u{f37c}"
        case .cloudBold: return "\u{f37d}"
        case .cloudDownloadBold: return "\u{f37e}"
        case .cloudDownloadLight: return "\u{f37f}"
        case .cloudDownloadRegular: return "\u{f380}"
        case .cloudFilled: return "\u{f381}"
        case .cloudFrameBold: return "\u{f382}"
        case .cloudFrameFilled: return "\u{f383}"
        case .cloudFrameLight: return "\u{f384}"
        case .cloudFrameRegular: return "\u{f385}"
        case .cloudLight: return "\u{f386}"
        case .cloudMutedBold: return "\u{f387}"
        case .cloudMutedFilled: return "\u{f388}"
        case .cloudMutedLight: return "\u{f389}"
        case .cloudMutedRegular: return "\u{f38a}"
        case .cloudRegular: return "\u{f38b}"
        case .cloudUploadBold: return "\u{f38c}"
        case .cloudUploadLight: return "\u{f38d}"
        case .cloudUploadRegular: return "\u{f38e}"
        case .codeBlockBold: return "\u{f38f}"
        case .codeBlockLight: return "\u{f390}"
        case .codeBlockRegular: return "\u{f391}"
        case .coffeeBold: return "\u{f392}"
        case .coffeeLight: return "\u{f393}"
        case .coffeeRegular: return "\u{f394}"
        case .colorBold: return "\u{f395}"
        case .colorFilled: return "\u{f396}"
        case .colorLight: return "\u{f397}"
        case .colorPromptsAiBold: return "\u{f398}"
        case .colorPromptsAiLight: return "\u{f399}"
        case .colorPromptsAiRegular: return "\u{f39a}"
        case .colorRegular: return "\u{f39b}"
        case .colorScheduleAiBold: return "\u{f39c}"
        case .colorScheduleAiLight: return "\u{f39d}"
        case .colorScheduleAiRegular: return "\u{f39e}"
        case .colorSearchAiBold: return "\u{f39f}"
        case .colorSearchAiLight: return "\u{f3a0}"
        case .colorSearchAiRegular: return "\u{f3a1}"
        case .colorSummarizeAiBold: return "\u{f3a2}"
        case .colorSummarizeAiLight: return "\u{f3a3}"
        case .colorSummarizeAiRegular: return "\u{f3a4}"
        case .colourPaletteBold: return "\u{f3a5}"
        case .colourPaletteFilled: return "\u{f3a6}"
        case .colourPaletteLight: return "\u{f3a7}"
        case .colourPaletteRegular: return "\u{f3a8}"
        case .commentingBold: return "\u{f3a9}"
        case .commentingFilled: return "\u{f3aa}"
        case .commentingLight: return "\u{f3ab}"
        case .commentingRegular: return "\u{f3ac}"
        case .companyBold: return "\u{f3ad}"
        case .companyLight: return "\u{f3ae}"
        case .companyRegular: return "\u{f3af}"
        case .completedByBaseBold: return "\u{f3b0}"
        case .completedByBaseLight: return "\u{f3b1}"
        case .completedByBaseRegular: return "\u{f3b2}"
        case .completedByTimeBold: return "\u{f3b3}"
        case .completedByTimeLight: return "\u{f3b4}"
        case .completedByTimeRegular: return "\u{f3b5}"
        case .completedInteractionBold: return "\u{f3b6}"
        case .completedInteractionFilled: return "\u{f3b7}"
        case .completedInteractionLight: return "\u{f3b8}"
        case .completedInteractionRegular: return "\u{f3b9}"
        case .computerBold: return "\u{f3ba}"
        case .computerLight: return "\u{f3bb}"
        case .computerRegular: return "\u{f3bc}"
        case .conciergeBold: return "\u{f3bd}"
        case .conciergeLight: return "\u{f3be}"
        case .conciergeRegular: return "\u{f3bf}"
        case .conditionalBlockBold: return "\u{f3c0}"
        case .conditionalBlockLight: return "\u{f3c1}"
        case .conditionalBlockRegular: return "\u{f3c2}"
        case .connectBold: return "\u{f3c3}"
        case .connectLight: return "\u{f3c4}"
        case .connectRegular: return "\u{f3c5}"
        case .contactCardBold: return "\u{f3c6}"
        case .contactCardFilled: return "\u{f3c7}"
        case .contactCardLight: return "\u{f3c8}"
        case .contactCardRegular: return "\u{f3c9}"
        case .contactsBold: return "\u{f3ca}"
        case .contactsFilled: return "\u{f3cb}"
        case .contactsLight: return "\u{f3cc}"
        case .contactsRegular: return "\u{f3cd}"
        case .contentDownloadBold: return "\u{f3ce}"
        case .contentDownloadFilled: return "\u{f3cf}"
        case .contentDownloadLight: return "\u{f3d0}"
        case .contentDownloadRegular: return "\u{f3d1}"
        case .contentShareBold: return "\u{f3d2}"
        case .contentShareLight: return "\u{f3d3}"
        case .contentShareRegular: return "\u{f3d4}"
        case .contrastBold: return "\u{f3d5}"
        case .contrastLight: return "\u{f3d6}"
        case .contrastRegular: return "\u{f3d7}"
        case .copyBold: return "\u{f3d8}"
        case .copyLight: return "\u{f3d9}"
        case .copyRegular: return "\u{f3da}"
        case .cpuBold: return "\u{f3db}"
        case .cpuLight: return "\u{f3dc}"
        case .cpuRegular: return "\u{f3dd}"
        case .createAGroupBold: return "\u{f3de}"
        case .createAGroupFilled: return "\u{f3df}"
        case .createAGroupLight: return "\u{f3e0}"
        case .createAGroupRegular: return "\u{f3e1}"
        case .cropBold: return "\u{f3e2}"
        case .cropLight: return "\u{f3e3}"
        case .cropRegular: return "\u{f3e4}"
        case .cucmConnectionBold: return "\u{f3e5}"
        case .cucmConnectionLight: return "\u{f3e6}"
        case .cucmConnectionRegular: return "\u{f3e7}"
        case .customCodeEditorBold: return "\u{f3e8}"
        case .customCodeEditorLight: return "\u{f3e9}"
        case .customCodeEditorRegular: return "\u{f3ea}"
        case .customTaskBold: return "\u{f3eb}"
        case .customTaskFilled: return "\u{f3ec}"
        case .customTaskIndBold: return "\u{f3ed}"
        case .customTaskIndFilled: return "\u{f3ee}"
        case .customTaskIndLight: return "\u{f3ef}"
        case .customTaskIndRegular: return "\u{f3f0}"
        case .customTaskLight: return "\u{f3f1}"
        case .customTaskRegular: return "\u{f3f2}"
        case .dailyRecurringScheduleBold: return "\u{f3f3}"
        case .dailyRecurringScheduleLight: return "\u{f3f4}"
        case .dailyRecurringScheduleRegular: return "\u{f3f5}"
        case .dashboardBold: return "\u{f3f6}"
        case .dashboardFilled: return "\u{f3f7}"
        case .dashboardLight: return "\u{f3f8}"
        case .dashboardRegular: return "\u{f3f9}"
        case .dataManagementBold: return "\u{f3fa}"
        case .dataManagementFilled: return "\u{f3fb}"
        case .dataManagementLight: return "\u{f3fc}"
        case .dataManagementRegular: return "\u{f3fd}"
        case .dataRangeSelectionBold: return "\u{f3fe}"
        case .dataRangeSelectionFilled: return "\u{f3ff}"
        case .dataRangeSelectionLight: return "\u{f400}"
        case .dataRangeSelectionRegular: return "\u{f401}"
        case .declineBold: return "\u{f402}"
        case .declineFilled: return "\u{f403}"
        case .declineLight: return "\u{f404}"
        case .declineRegular: return "\u{f405}"
        case .dectHandsetBold: return "\u{f406}"
        case .dectHandsetFilled: return "\u{f407}"
        case .dectHandsetLight: return "\u{f408}"
        case .dectHandsetRegular: return "\u{f409}"
        case .deleteBold: return "\u{f40a}"
        case .deleteFilled: return "\u{f40b}"
        case .deleteLight: return "\u{f40c}"
        case .deleteRegular: return "\u{f40d}"
        case .deploymentEvaluationProgressBold: return "\u{f40e}"
        case .deploymentEvaluationProgressLight: return "\u{f40f}"
        case .deploymentEvaluationProgressRegular: return "\u{f410}"
        case .deploymentProgressBold: return "\u{f411}"
        case .deploymentProgressLight: return "\u{f412}"
        case .deploymentProgressRegular: return "\u{f413}"
        case .deploymentRecurringBold: return "\u{f414}"
        case .deploymentRecurringLight: return "\u{f415}"
        case .deploymentRecurringRegular: return "\u{f416}"
        case .deploymentWinnerPendingBold: return "\u{f417}"
        case .deploymentWinnerPendingLight: return "\u{f418}"
        case .deploymentWinnerPendingRegular: return "\u{f419}"
        case .deskPhoneBold: return "\u{f41a}"
        case .deskPhoneFilled: return "\u{f41b}"
        case .deskPhoneLight: return "\u{f41c}"
        case .deskPhoneRegular: return "\u{f41d}"
        case .deskPhoneWarningBold: return "\u{f41e}"
        case .deskPhoneWarningLight: return "\u{f41f}"
        case .deskPhoneWarningRegular: return "\u{f420}"
        case .deviceConnectionBold: return "\u{f421}"
        case .deviceConnectionFilled: return "\u{f422}"
        case .deviceConnectionLight: return "\u{f423}"
        case .deviceConnectionRegular: return "\u{f424}"
        case .deviceInRoomBold: return "\u{f425}"
        case .deviceInRoomEndBold: return "\u{f426}"
        case .deviceInRoomEndLight: return "\u{f427}"
        case .deviceInRoomEndRegular: return "\u{f428}"
        case .deviceInRoomFilled: return "\u{f429}"
        case .deviceInRoomLight: return "\u{f42a}"
        case .deviceInRoomRegular: return "\u{f42b}"
        case .deviceMutedBold: return "\u{f42c}"
        case .deviceMutedLight: return "\u{f42d}"
        case .deviceMutedRegular: return "\u{f42e}"
        case .devicePolicyControllerBold: return "\u{f42f}"
        case .devicePolicyControllerLight: return "\u{f430}"
        case .devicePolicyControllerRegular: return "\u{f431}"
        case .devicesBold: return "\u{f432}"
        case .devicesFilled: return "\u{f433}"
        case .devicesLight: return "\u{f434}"
        case .devicesRegular: return "\u{f435}"
        case .diagnosticsBold: return "\u{f436}"
        case .diagnosticsLight: return "\u{f437}"
        case .diagnosticsRegular: return "\u{f438}"
        case .dialpadBold: return "\u{f439}"
        case .dialpadLight: return "\u{f43a}"
        case .dialpadRegular: return "\u{f43b}"
        case .diamondBold: return "\u{f43c}"
        case .diamondFilled: return "\u{f43d}"
        case .diamondLight: return "\u{f43e}"
        case .diamondRegular: return "\u{f43f}"
        case .directionalPadBold: return "\u{f440}"
        case .directionalPadFilled: return "\u{f441}"
        case .directionalPadLight: return "\u{f442}"
        case .directionalPadRegular: return "\u{f443}"
        case .directoryBold: return "\u{f444}"
        case .directoryLight: return "\u{f445}"
        case .directoryRegular: return "\u{f446}"
        case .disappearingPenBold: return "\u{f447}"
        case .disappearingPenLight: return "\u{f448}"
        case .disappearingPenRegular: return "\u{f449}"
        case .discBold: return "\u{f44a}"
        case .discConnectedBold: return "\u{f44b}"
        case .discConnectedLight: return "\u{f44c}"
        case .discConnectedRegular: return "\u{f44d}"
        case .discLight: return "\u{f44e}"
        case .discRegular: return "\u{f44f}"
        case .disconnectBold: return "\u{f450}"
        case .disconnectFilled: return "\u{f451}"
        case .disconnectLight: return "\u{f452}"
        case .disconnectRegular: return "\u{f453}"
        case .dislikeBold: return "\u{f454}"
        case .dislikeFilled: return "\u{f455}"
        case .dislikeLight: return "\u{f456}"
        case .dislikeRegular: return "\u{f457}"
        case .displayBold: return "\u{f458}"
        case .displayInputBold: return "\u{f459}"
        case .displayInputLight: return "\u{f45a}"
        case .displayInputRegular: return "\u{f45b}"
        case .displayLight: return "\u{f45c}"
        case .displayRegular: return "\u{f45d}"
        case .displayWarningBold: return "\u{f45e}"
        case .displayWarningLight: return "\u{f45f}"
        case .displayWarningRegular: return "\u{f460}"
        case .distributeHorizontalBold: return "\u{f461}"
        case .distributeHorizontalFilled: return "\u{f462}"
        case .distributeHorizontalLight: return "\u{f463}"
        case .distributeHorizontalRegular: return "\u{f464}"
        case .distributeVerticallyBold: return "\u{f465}"
        case .distributeVerticallyFilled: return "\u{f466}"
        case .distributeVerticallyLight: return "\u{f467}"
        case .distributeVerticallyRegular: return "\u{f468}"
        case .divideBold: return "\u{f469}"
        case .divideFilled: return "\u{f46a}"
        case .divideLight: return "\u{f46b}"
        case .divideRegular: return "\u{f46c}"
        case .dndPresenceBadgeFilled: return "\u{f46d}"
        case .dndPresenceBold: return "\u{f46e}"
        case .dndPresenceFilled: return "\u{f46f}"
        case .dndPresenceLight: return "\u{f470}"
        case .dndPresenceRegular: return "\u{f471}"
        case .dockWindowBold: return "\u{f472}"
        case .dockWindowLight: return "\u{f473}"
        case .dockWindowRegular: return "\u{f474}"
        case .documentBold: return "\u{f475}"
        case .documentCameraBold: return "\u{f476}"
        case .documentCameraDisconnectedBold: return "\u{f477}"
        case .documentCameraDisconnectedLight: return "\u{f478}"
        case .documentCameraDisconnectedRegular: return "\u{f479}"
        case .documentCameraLight: return "\u{f47a}"
        case .documentCameraRegular: return "\u{f47b}"
        case .documentCreateBold: return "\u{f47c}"
        case .documentCreateFilled: return "\u{f47d}"
        case .documentCreateLight: return "\u{f47e}"
        case .documentCreateRegular: return "\u{f47f}"
        case .documentFilled: return "\u{f480}"
        case .documentLight: return "\u{f481}"
        case .documentMoveBold: return "\u{f482}"
        case .documentMoveFilled: return "\u{f483}"
        case .documentMoveLight: return "\u{f484}"
        case .documentMoveRegular: return "\u{f485}"
        case .documentRegular: return "\u{f486}"
        case .documentShareBold: return "\u{f487}"
        case .documentShareFilled: return "\u{f488}"
        case .documentShareLight: return "\u{f489}"
        case .documentShareRegular: return "\u{f48a}"
        case .doneAllBold: return "\u{f48b}"
        case .doneAllLight: return "\u{f48c}"
        case .doneAllRegular: return "\u{f48d}"
        case .donutChartBold: return "\u{f48e}"
        case .donutChartFilled: return "\u{f48f}"
        case .donutChartLight: return "\u{f490}"
        case .donutChartRegular: return "\u{f491}"
        case .downloadBold: return "\u{f492}"
        case .downloadFilled: return "\u{f493}"
        case .downloadLight: return "\u{f494}"
        case .downloadRegular: return "\u{f495}"
        case .draftBold: return "\u{f496}"
        case .draftFilled: return "\u{f497}"
        case .draftIndicatorBold: return "\u{f498}"
        case .draftIndicatorSmallFilled: return "\u{f499}"
        case .draftLight: return "\u{f49a}"
        case .draftRegular: return "\u{f49b}"
        case .dragBold: return "\u{f49c}"
        case .dragLight: return "\u{f49d}"
        case .dragRegular: return "\u{f49e}"
        case .draggerHorizontalBold: return "\u{f49f}"
        case .draggerHorizontalLight: return "\u{f4a0}"
        case .draggerHorizontalRegular: return "\u{f4a1}"
        case .draggerVerticalBold: return "\u{f4a2}"
        case .draggerVerticalLight: return "\u{f4a3}"
        case .draggerVerticalRegular: return "\u{f4a4}"
        case .driveModeBold: return "\u{f4a5}"
        case .driveModeLight: return "\u{f4a6}"
        case .driveModeRegular: return "\u{f4a7}"
        case .dropdownBold: return "\u{f4a8}"
        case .dropdownLight: return "\u{f4a9}"
        case .dropdownRegular: return "\u{f4aa}"
        case .dxEightyBold: return "\u{f4ab}"
        case .dxEightyFilled: return "\u{f4ac}"
        case .dxEightyLight: return "\u{f4ad}"
        case .dxEightyRegular: return "\u{f4ae}"
        case .dxSeventyBold: return "\u{f4af}"
        case .dxSeventyLight: return "\u{f4b0}"
        case .dxSeventyRegular: return "\u{f4b1}"
        case .editBold: return "\u{f4b2}"
        case .editFilled: return "\u{f4b3}"
        case .editLight: return "\u{f4b4}"
        case .editRegular: return "\u{f4b5}"
        case .editablePartialBold: return "\u{f4b6}"
        case .editablePartialLight: return "\u{f4b7}"
        case .editablePartialRegular: return "\u{f4b8}"
        case .educationBold: return "\u{f4b9}"
        case .educationFilled: return "\u{f4ba}"
        case .educationLight: return "\u{f4bb}"
        case .educationRegular: return "\u{f4bc}"
        case .emailBold: return "\u{f4bd}"
        case .emailDeliveredBold: return "\u{f4be}"
        case .emailDeliveredLight: return "\u{f4bf}"
        case .emailDeliveredRegular: return "\u{f4c0}"
        case .emailFailureBold: return "\u{f4c1}"
        case .emailFailureLight: return "\u{f4c2}"
        case .emailFailureRegular: return "\u{f4c3}"
        case .emailFilled: return "\u{f4c4}"
        case .emailInviteBold: return "\u{f4c5}"
        case .emailInviteLight: return "\u{f4c6}"
        case .emailInviteRegular: return "\u{f4c7}"
        case .emailLight: return "\u{f4c8}"
        case .emailOutgoingBold: return "\u{f4c9}"
        case .emailOutgoingFilled: return "\u{f4ca}"
        case .emailOutgoingLight: return "\u{f4cb}"
        case .emailOutgoingRegular: return "\u{f4cc}"
        case .emailReadBold: return "\u{f4cd}"
        case .emailReadFilled: return "\u{f4ce}"
        case .emailReadLight: return "\u{f4cf}"
        case .emailReadRegular: return "\u{f4d0}"
        case .emailRegular: return "\u{f4d1}"
        case .emojiExcitedBold: return "\u{f4d2}"
        case .emojiExcitedFilled: return "\u{f4d3}"
        case .emojiExcitedLight: return "\u{f4d4}"
        case .emojiExcitedRegular: return "\u{f4d5}"
        case .emojiHappyBold: return "\u{f4d6}"
        case .emojiHappyFilled: return "\u{f4d7}"
        case .emojiHappyLight: return "\u{f4d8}"
        case .emojiHappyRegular: return "\u{f4d9}"
        case .emojiPassiveBold: return "\u{f4da}"
        case .emojiPassiveFilled: return "\u{f4db}"
        case .emojiPassiveLight: return "\u{f4dc}"
        case .emojiPassiveRegular: return "\u{f4dd}"
        case .emojiSadBold: return "\u{f4de}"
        case .emojiSadFilled: return "\u{f4df}"
        case .emojiSadLight: return "\u{f4e0}"
        case .emojiSadRegular: return "\u{f4e1}"
        case .emojiUnhappyBold: return "\u{f4e2}"
        case .emojiUnhappyFilled: return "\u{f4e3}"
        case .emojiUnhappyLight: return "\u{f4e4}"
        case .emojiUnhappyRegular: return "\u{f4e5}"
        case .encryptionCircleFilled: return "\u{f4e6}"
        case .encryptionFilled: return "\u{f4e7}"
        case .endRemoteDesktopControlBold: return "\u{f4e8}"
        case .endRemoteDesktopControlLight: return "\u{f4e9}"
        case .endRemoteDesktopControlRegular: return "\u{f4ea}"
        case .endToEndEncryptionCircleFilled: return "\u{f4eb}"
        case .endToEndEncryptionFilled: return "\u{f4ec}"
        case .endpointBlockedBold: return "\u{f4ed}"
        case .endpointBlockedLight: return "\u{f4ee}"
        case .endpointBlockedRegular: return "\u{f4ef}"
        case .endpointBold: return "\u{f4f0}"
        case .endpointGTwoBold: return "\u{f4f1}"
        case .endpointGTwoLight: return "\u{f4f2}"
        case .endpointGTwoRegular: return "\u{f4f3}"
        case .endpointGTwoSeventyBold: return "\u{f4f4}"
        case .endpointGTwoSeventyDualBold: return "\u{f4f5}"
        case .endpointGTwoSeventyDualLight: return "\u{f4f6}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4f7}"
        case .endpointGTwoSeventyLight: return "\u{f4f8}"
        case .endpointGTwoSeventyRegular: return "\u{f4f9}"
        case .endpointGTwoStandBold: return "\u{f4fa}"
        case .endpointGTwoStandLight: return "\u{f4fb}"
        case .endpointGTwoStandRegular: return "\u{f4fc}"
        case .endpointLight: return "\u{f4fd}"
        case .endpointMxEightHundredBold: return "\u{f4fe}"
        case .endpointMxEightHundredDualBold: return "\u{f4ff}"
        case .endpointMxEightHundredDualLight: return "\u{f500}"
        case .endpointMxEightHundredDualRegular: return "\u{f501}"
        case .endpointMxEightHundredLight: return "\u{f502}"
        case .endpointMxEightHundredRegular: return "\u{f503}"
        case .endpointRegular: return "\u{f504}"
        case .endpointStandBold: return "\u{f505}"
        case .endpointStandFilled: return "\u{f506}"
        case .endpointStandLight: return "\u{f507}"
        case .endpointStandRegular: return "\u{f508}"
        case .endpointWarningBold: return "\u{f509}"
        case .endpointWarningLight: return "\u{f50a}"
        case .endpointWarningRegular: return "\u{f50b}"
        case .enterBold: return "\u{f50c}"
        case .enterLight: return "\u{f50d}"
        case .enterRegular: return "\u{f50e}"
        case .enterRoomBold: return "\u{f50f}"
        case .enterRoomFilled: return "\u{f510}"
        case .enterRoomLight: return "\u{f511}"
        case .enterRoomRegular: return "\u{f512}"
        case .eraserBold: return "\u{f513}"
        case .eraserFilled: return "\u{f514}"
        case .eraserLight: return "\u{f515}"
        case .eraserRegular: return "\u{f516}"
        case .errorLegacyBadgeFilled: return "\u{f517}"
        case .errorLegacyBold: return "\u{f518}"
        case .errorLegacyFilled: return "\u{f519}"
        case .errorLegacyLight: return "\u{f51a}"
        case .errorLegacyRegular: return "\u{f51b}"
        case .ethernetBold: return "\u{f51c}"
        case .ethernetFilled: return "\u{f51d}"
        case .ethernetLight: return "\u{f51e}"
        case .ethernetRegular: return "\u{f51f}"
        case .exchangeBold: return "\u{f520}"
        case .exchangeLight: return "\u{f521}"
        case .exchangeRegular: return "\u{f522}"
        case .exclamationBold: return "\u{f523}"
        case .exclamationLight: return "\u{f524}"
        case .exclamationRegular: return "\u{f525}"
        case .excludeBold: return "\u{f526}"
        case .excludeLight: return "\u{f527}"
        case .excludeRegular: return "\u{f528}"
        case .existingTargetGroupBold: return "\u{f529}"
        case .existingTargetGroupLight: return "\u{f52a}"
        case .existingTargetGroupRegular: return "\u{f52b}"
        case .exitRoomBold: return "\u{f52c}"
        case .exitRoomLight: return "\u{f52d}"
        case .exitRoomRegular: return "\u{f52e}"
        case .exploreBold: return "\u{f52f}"
        case .exploreLight: return "\u{f530}"
        case .exploreRegular: return "\u{f531}"
        case .exportBold: return "\u{f532}"
        case .exportLight: return "\u{f533}"
        case .exportRegular: return "\u{f534}"
        case .extensionMobilityBold: return "\u{f535}"
        case .extensionMobilityLight: return "\u{f536}"
        case .extensionMobilityRegular: return "\u{f537}"
        case .externalMessageBold: return "\u{f538}"
        case .externalMessageLight: return "\u{f539}"
        case .externalMessageRegular: return "\u{f53a}"
        case .externalUserBold: return "\u{f53b}"
        case .externalUserLight: return "\u{f53c}"
        case .externalUserRegular: return "\u{f53d}"
        case .familyFontBold: return "\u{f53e}"
        case .familyFontLight: return "\u{f53f}"
        case .familyFontRegular: return "\u{f540}"
        case .fastForwardBold: return "\u{f541}"
        case .fastForwardLight: return "\u{f542}"
        case .fastForwardRegular: return "\u{f543}"
        case .favoriteBold: return "\u{f544}"
        case .favoriteFilled: return "\u{f545}"
        case .favoriteLight: return "\u{f546}"
        case .favoriteRegular: return "\u{f547}"
        case .favoritesBold: return "\u{f548}"
        case .favoritesFilled: return "\u{f549}"
        case .favoritesLight: return "\u{f54a}"
        case .favoritesRegular: return "\u{f54b}"
        case .fbwBold: return "\u{f54c}"
        case .fbwFilled: return "\u{f54d}"
        case .fbwLight: return "\u{f54e}"
        case .fbwRegular: return "\u{f54f}"
        case .ffwBold: return "\u{f550}"
        case .ffwFilled: return "\u{f551}"
        case .ffwLight: return "\u{f552}"
        case .ffwRegular: return "\u{f553}"
        case .fileAnalysisBold: return "\u{f554}"
        case .fileAnalysisFilled: return "\u{f555}"
        case .fileAnalysisLight: return "\u{f556}"
        case .fileAnalysisRegular: return "\u{f557}"
        case .fileAnnotationBold: return "\u{f558}"
        case .fileAnnotationFilled: return "\u{f559}"
        case .fileAnnotationLight: return "\u{f55a}"
        case .fileAnnotationRegular: return "\u{f55b}"
        case .fileAudioBold: return "\u{f55c}"
        case .fileAudioFilled: return "\u{f55d}"
        case .fileAudioLight: return "\u{f55e}"
        case .fileAudioRegular: return "\u{f55f}"
        case .fileBugBold: return "\u{f560}"
        case .fileBugFilled: return "\u{f561}"
        case .fileBugLight: return "\u{f562}"
        case .fileBugRegular: return "\u{f563}"
        case .fileCodeBold: return "\u{f564}"
        case .fileCodeFilled: return "\u{f565}"
        case .fileCodeLight: return "\u{f566}"
        case .fileCodeRegular: return "\u{f567}"
        case .fileDashboardBold: return "\u{f568}"
        case .fileDashboardFilled: return "\u{f569}"
        case .fileDashboardLight: return "\u{f56a}"
        case .fileDashboardRegular: return "\u{f56b}"
        case .fileExcelBold: return "\u{f56c}"
        case .fileExcelFilled: return "\u{f56d}"
        case .fileExcelLight: return "\u{f56e}"
        case .fileExcelRegular: return "\u{f56f}"
        case .fileGraphBold: return "\u{f570}"
        case .fileGraphFilled: return "\u{f571}"
        case .fileGraphLight: return "\u{f572}"
        case .fileGraphRegular: return "\u{f573}"
        case .fileImageBold: return "\u{f574}"
        case .fileImageFilled: return "\u{f575}"
        case .fileImageLight: return "\u{f576}"
        case .fileImageNoneBold: return "\u{f577}"
        case .fileImageNoneLight: return "\u{f578}"
        case .fileImageNoneRegular: return "\u{f579}"
        case .fileImageRegular: return "\u{f57a}"
        case .fileJsBold: return "\u{f57b}"
        case .fileJsFilled: return "\u{f57c}"
        case .fileJsLight: return "\u{f57d}"
        case .fileJsRegular: return "\u{f57e}"
        case .fileKeynoteBold: return "\u{f57f}"
        case .fileKeynoteFilled: return "\u{f580}"
        case .fileKeynoteLight: return "\u{f581}"
        case .fileKeynoteRegular: return "\u{f582}"
        case .fileLockedBold: return "\u{f583}"
        case .fileLockedFilled: return "\u{f584}"
        case .fileLockedLight: return "\u{f585}"
        case .fileLockedRegular: return "\u{f586}"
        case .fileMissingBold: return "\u{f587}"
        case .fileMissingFilled: return "\u{f588}"
        case .fileMissingLight: return "\u{f589}"
        case .fileMissingRegular: return "\u{f58a}"
        case .fileMusicBold: return "\u{f58b}"
        case .fileMusicFilled: return "\u{f58c}"
        case .fileMusicLight: return "\u{f58d}"
        case .fileMusicRegular: return "\u{f58e}"
        case .fileOnenoteBold: return "\u{f58f}"
        case .fileOnenoteFilled: return "\u{f590}"
        case .fileOnenoteLight: return "\u{f591}"
        case .fileOnenoteRegular: return "\u{f592}"
        case .filePdfBold: return "\u{f593}"
        case .filePdfFilled: return "\u{f594}"
        case .filePdfLight: return "\u{f595}"
        case .filePdfRegular: return "\u{f596}"
        case .filePowerpointBold: return "\u{f597}"
        case .filePowerpointFilled: return "\u{f598}"
        case .filePowerpointLight: return "\u{f599}"
        case .filePowerpointRegular: return "\u{f59a}"
        case .fileSpreadsheetBold: return "\u{f59b}"
        case .fileSpreadsheetFilled: return "\u{f59c}"
        case .fileSpreadsheetLight: return "\u{f59d}"
        case .fileSpreadsheetRegular: return "\u{f59e}"
        case .fileTextBold: return "\u{f59f}"
        case .fileTextFilled: return "\u{f5a0}"
        case .fileTextLight: return "\u{f5a1}"
        case .fileTextRegular: return "\u{f5a2}"
        case .fileThreeDBold: return "\u{f5a3}"
        case .fileThreeDFilled: return "\u{f5a4}"
        case .fileThreeDLight: return "\u{f5a5}"
        case .fileThreeDRegular: return "\u{f5a6}"
        case .fileVectorBold: return "\u{f5a7}"
        case .fileVectorFilled: return "\u{f5a8}"
        case .fileVectorLight: return "\u{f5a9}"
        case .fileVectorRegular: return "\u{f5aa}"
        case .fileVideoBold: return "\u{f5ab}"
        case .fileVideoFilled: return "\u{f5ac}"
        case .fileVideoLight: return "\u{f5ad}"
        case .fileVideoRegular: return "\u{f5ae}"
        case .fileWordBold: return "\u{f5af}"
        case .fileWordFilled: return "\u{f5b0}"
        case .fileWordLight: return "\u{f5b1}"
        case .fileWordRegular: return "\u{f5b2}"
        case .fileXmlBold: return "\u{f5b3}"
        case .fileXmlFilled: return "\u{f5b4}"
        case .fileXmlLight: return "\u{f5b5}"
        case .fileXmlRegular: return "\u{f5b6}"
        case .fileZipBold: return "\u{f5b7}"
        case .fileZipFilled: return "\u{f5b8}"
        case .fileZipLight: return "\u{f5b9}"
        case .fileZipRegular: return "\u{f5ba}"
        case .filesBold: return "\u{f5bb}"
        case .filesFilled: return "\u{f5bc}"
        case .filesLight: return "\u{f5bd}"
        case .filesRegular: return "\u{f5be}"
        case .fillColourBold: return "\u{f5bf}"
        case .fillColourFilled: return "\u{f5c0}"
        case .fillColourLight: return "\u{f5c1}"
        case .fillColourRegular: return "\u{f5c2}"
        case .filterBold: return "\u{f5c3}"
        case .filterCircleBold: return "\u{f5c4}"
        case .filterCircleFilled: return "\u{f5c5}"
        case .filterCircleLight: return "\u{f5c6}"
        case .filterCircleRegular: return "\u{f5c7}"
        case .filterLight: return "\u{f5c8}"
        case .filterRegular: return "\u{f5c9}"
        case .fitToWidthBold: return "\u{f5ca}"
        case .fitToWidthLight: return "\u{f5cb}"
        case .fitToWidthRegular: return "\u{f5cc}"
        case .fitToWindowExpandBold: return "\u{f5cd}"
        case .fitToWindowExpandLight: return "\u{f5ce}"
        case .fitToWindowExpandRegular: return "\u{f5cf}"
        case .fitToWindowShrinkBold: return "\u{f5d0}"
        case .fitToWindowShrinkLight: return "\u{f5d1}"
        case .fitToWindowShrinkRegular: return "\u{f5d2}"
        case .flagBold: return "\u{f5d3}"
        case .flagCircleBold: return "\u{f5d4}"
        case .flagCircleFilled: return "\u{f5d5}"
        case .flagCircleLight: return "\u{f5d6}"
        case .flagCircleRegular: return "\u{f5d7}"
        case .flagFilled: return "\u{f5d8}"
        case .flagLight: return "\u{f5d9}"
        case .flagRegular: return "\u{f5da}"
        case .folderBold: return "\u{f5db}"
        case .folderEditBold: return "\u{f5dc}"
        case .folderEditLight: return "\u{f5dd}"
        case .folderEditRegular: return "\u{f5de}"
        case .folderFilled: return "\u{f5df}"
        case .folderLight: return "\u{f5e0}"
        case .folderLockBold: return "\u{f5e1}"
        case .folderLockLight: return "\u{f5e2}"
        case .folderLockRegular: return "\u{f5e3}"
        case .folderRegular: return "\u{f5e4}"
        case .folderViewBold: return "\u{f5e5}"
        case .folderViewLight: return "\u{f5e6}"
        case .folderViewRegular: return "\u{f5e7}"
        case .followUpBold: return "\u{f5e8}"
        case .followUpLight: return "\u{f5e9}"
        case .followUpRegular: return "\u{f5ea}"
        case .foodBold: return "\u{f5eb}"
        case .foodFilled: return "\u{f5ec}"
        case .foodLight: return "\u{f5ed}"
        case .foodRegular: return "\u{f5ee}"
        case .formatBold: return "\u{f5ef}"
        case .formatDefaultAppBold: return "\u{f5f0}"
        case .formatDefaultAppFilled: return "\u{f5f1}"
        case .formatDefaultAppLight: return "\u{f5f2}"
        case .formatDefaultAppRegular: return "\u{f5f3}"
        case .formatLight: return "\u{f5f4}"
        case .formatPanelControlBarBold: return "\u{f5f5}"
        case .formatPanelControlBarLight: return "\u{f5f6}"
        case .formatPanelControlBarRegular: return "\u{f5f7}"
        case .formatPanelControlDownBold: return "\u{f5f8}"
        case .formatPanelControlDownLight: return "\u{f5f9}"
        case .formatPanelControlDownRegular: return "\u{f5fa}"
        case .formatPanelControlLeftBold: return "\u{f5fb}"
        case .formatPanelControlLeftLight: return "\u{f5fc}"
        case .formatPanelControlLeftRegular: return "\u{f5fd}"
        case .formatPanelControlRightBold: return "\u{f5fe}"
        case .formatPanelControlRightLight: return "\u{f5ff}"
        case .formatPanelControlRightRegular: return "\u{f600}"
        case .formatPanelControlUpBold: return "\u{f601}"
        case .formatPanelControlUpDownBold: return "\u{f602}"
        case .formatPanelControlUpDownLight: return "\u{f603}"
        case .formatPanelControlUpDownRegular: return "\u{f604}"
        case .formatPanelControlUpLight: return "\u{f605}"
        case .formatPanelControlUpRegular: return "\u{f606}"
        case .formatRegular: return "\u{f607}"
        case .formatViewMixedBold: return "\u{f608}"
        case .formatViewMixedLight: return "\u{f609}"
        case .formatViewMixedRegular: return "\u{f60a}"
        case .formulaBold: return "\u{f60b}"
        case .formulaFilled: return "\u{f60c}"
        case .formulaLight: return "\u{f60d}"
        case .formulaRegular: return "\u{f60e}"
        case .forwardMessageBold: return "\u{f60f}"
        case .forwardMessageFilled: return "\u{f610}"
        case .forwardMessageLight: return "\u{f611}"
        case .forwardMessageRegular: return "\u{f612}"
        case .forwardTenSecBold: return "\u{f613}"
        case .forwardTenSecLight: return "\u{f614}"
        case .forwardTenSecRegular: return "\u{f615}"
        case .fourColumnBold: return "\u{f616}"
        case .fourColumnLight: return "\u{f617}"
        case .fourColumnRegular: return "\u{f618}"
        case .fourWayNavigationBold: return "\u{f619}"
        case .fourWayNavigationLight: return "\u{f61a}"
        case .fourWayNavigationRegular: return "\u{f61b}"
        case .frequencyCappingBold: return "\u{f61c}"
        case .frequencyCappingLight: return "\u{f61d}"
        case .frequencyCappingRegular: return "\u{f61e}"
        case .fulfillmentBold: return "\u{f61f}"
        case .fulfillmentLight: return "\u{f620}"
        case .fulfillmentRegular: return "\u{f621}"
        case .fullscreenBold: return "\u{f622}"
        case .fullscreenExitBold: return "\u{f623}"
        case .fullscreenExitLight: return "\u{f624}"
        case .fullscreenExitRegular: return "\u{f625}"
        case .fullscreenLight: return "\u{f626}"
        case .fullscreenRegular: return "\u{f627}"
        case .genericDeviceVideoBadgeFilled: return "\u{f628}"
        case .genericDeviceVideoBold: return "\u{f629}"
        case .genericDeviceVideoFilled: return "\u{f62a}"
        case .genericDeviceVideoLight: return "\u{f62b}"
        case .genericDeviceVideoRegular: return "\u{f62c}"
        case .gifBold: return "\u{f62d}"
        case .gifFilled: return "\u{f62e}"
        case .gifHorizontalBold: return "\u{f62f}"
        case .gifHorizontalFilled: return "\u{f630}"
        case .gifHorizontalLight: return "\u{f631}"
        case .gifHorizontalRegular: return "\u{f632}"
        case .gifLight: return "\u{f633}"
        case .gifRegular: return "\u{f634}"
        case .giftBold: return "\u{f635}"
        case .giftFilled: return "\u{f636}"
        case .giftLight: return "\u{f637}"
        case .giftRegular: return "\u{f638}"
        case .greenLeafBold: return "\u{f639}"
        case .greenLeafFilled: return "\u{f63a}"
        case .greenLeafLight: return "\u{f63b}"
        case .greenLeafRegular: return "\u{f63c}"
        case .greenRoomBold: return "\u{f63d}"
        case .greenRoomFilled: return "\u{f63e}"
        case .greenRoomLight: return "\u{f63f}"
        case .greenRoomRegular: return "\u{f640}"
        case .guestIssuerBold: return "\u{f641}"
        case .guestIssuerLight: return "\u{f642}"
        case .guestIssuerRegular: return "\u{f643}"
        case .guideBold: return "\u{f644}"
        case .guideLight: return "\u{f645}"
        case .guideRegular: return "\u{f646}"
        case .handPointerBold: return "\u{f647}"
        case .handPointerLight: return "\u{f648}"
        case .handPointerRegular: return "\u{f649}"
        case .handlerBold: return "\u{f64a}"
        case .handlerHorizontalBold: return "\u{f64b}"
        case .handlerHorizontalLight: return "\u{f64c}"
        case .handlerHorizontalRegular: return "\u{f64d}"
        case .handlerLight: return "\u{f64e}"
        case .handlerRegular: return "\u{f64f}"
        case .handsetAlertBold: return "\u{f650}"
        case .handsetAlertFilled: return "\u{f651}"
        case .handsetAlertLight: return "\u{f652}"
        case .handsetAlertRegular: return "\u{f653}"
        case .handsetBold: return "\u{f654}"
        case .handsetDownSlashBold: return "\u{f655}"
        case .handsetDownSlashFilled: return "\u{f656}"
        case .handsetDownSlashLight: return "\u{f657}"
        case .handsetDownSlashRegular: return "\u{f658}"
        case .handsetFilled: return "\u{f659}"
        case .handsetLight: return "\u{f65a}"
        case .handsetMutedBold: return "\u{f65b}"
        case .handsetMutedFilled: return "\u{f65c}"
        case .handsetMutedLight: return "\u{f65d}"
        case .handsetMutedRegular: return "\u{f65e}"
        case .handsetRegular: return "\u{f65f}"
        case .handsetsArrowLeftBold: return "\u{f660}"
        case .handsetsArrowLeftLight: return "\u{f661}"
        case .handsetsArrowLeftRegular: return "\u{f662}"
        case .handshakeBold: return "\u{f663}"
        case .handshakeLight: return "\u{f664}"
        case .handshakeRegular: return "\u{f665}"
        case .headingOneBold: return "\u{f666}"
        case .headingOneLight: return "\u{f667}"
        case .headingOneRegular: return "\u{f668}"
        case .headingThreeBold: return "\u{f669}"
        case .headingThreeLight: return "\u{f66a}"
        case .headingThreeRegular: return "\u{f66b}"
        case .headingTwoBold: return "\u{f66c}"
        case .headingTwoLight: return "\u{f66d}"
        case .headingTwoRegular: return "\u{f66e}"
        case .headphonesBold: return "\u{f66f}"
        case .headphonesFilled: return "\u{f670}"
        case .headphonesLight: return "\u{f671}"
        case .headphonesMutedBold: return "\u{f672}"
        case .headphonesMutedFilled: return "\u{f673}"
        case .headphonesMutedLight: return "\u{f674}"
        case .headphonesMutedRegular: return "\u{f675}"
        case .headphonesRegular: return "\u{f676}"
        case .headsetAlertBold: return "\u{f677}"
        case .headsetAlertLight: return "\u{f678}"
        case .headsetAlertRegular: return "\u{f679}"
        case .headsetArrowDownBold: return "\u{f67a}"
        case .headsetArrowDownFilled: return "\u{f67b}"
        case .headsetArrowDownLight: return "\u{f67c}"
        case .headsetArrowDownRegular: return "\u{f67d}"
        case .headsetBluetoothBold: return "\u{f67e}"
        case .headsetBluetoothLight: return "\u{f67f}"
        case .headsetBluetoothRegular: return "\u{f680}"
        case .headsetBold: return "\u{f681}"
        case .headsetFilled: return "\u{f682}"
        case .headsetLight: return "\u{f683}"
        case .headsetMutedBold: return "\u{f684}"
        case .headsetMutedLight: return "\u{f685}"
        case .headsetMutedRegular: return "\u{f686}"
        case .headsetPrivateBold: return "\u{f687}"
        case .headsetPrivateLight: return "\u{f688}"
        case .headsetPrivateRegular: return "\u{f689}"
        case .headsetRegular: return "\u{f68a}"
        case .hearingBold: return "\u{f68b}"
        case .hearingImpairedBold: return "\u{f68c}"
        case .hearingImpairedLight: return "\u{f68d}"
        case .hearingImpairedRegular: return "\u{f68e}"
        case .hearingLight: return "\u{f68f}"
        case .hearingRegular: return "\u{f690}"
        case .helpBold: return "\u{f691}"
        case .helpCircleBold: return "\u{f692}"
        case .helpCircleFilled: return "\u{f693}"
        case .helpCircleLight: return "\u{f694}"
        case .helpCircleRegular: return "\u{f695}"
        case .helpLight: return "\u{f696}"
        case .helpRegular: return "\u{f697}"
        case .helpdeskBold: return "\u{f698}"
        case .helpdeskFilled: return "\u{f699}"
        case .helpdeskLight: return "\u{f69a}"
        case .helpdeskRegular: return "\u{f69b}"
        case .hideBold: return "\u{f69c}"
        case .hideFilled: return "\u{f69d}"
        case .hideLight: return "\u{f69e}"
        case .hideRegular: return "\u{f69f}"
        case .homeBold: return "\u{f6a0}"
        case .homeFilled: return "\u{f6a1}"
        case .homeLight: return "\u{f6a2}"
        case .homeRegular: return "\u{f6a3}"
        case .horizontalLineBold: return "\u{f6a4}"
        case .horizontalLineLight: return "\u{f6a5}"
        case .horizontalLineRegular: return "\u{f6a6}"
        case .hotelingBold: return "\u{f6a7}"
        case .hotelingFilled: return "\u{f6a8}"
        case .hotelingLight: return "\u{f6a9}"
        case .hotelingRegular: return "\u{f6aa}"
        case .humidityBold: return "\u{f6ab}"
        case .humidityLight: return "\u{f6ac}"
        case .humidityRegular: return "\u{f6ad}"
        case .huntGroupBold: return "\u{f6ae}"
        case .huntGroupFilled: return "\u{f6af}"
        case .huntGroupLight: return "\u{f6b0}"
        case .huntGroupRegular: return "\u{f6b1}"
        case .idleBold: return "\u{f6b2}"
        case .idleFilled: return "\u{f6b3}"
        case .idleLight: return "\u{f6b4}"
        case .idleRegular: return "\u{f6b5}"
        case .immediateBold: return "\u{f6b6}"
        case .immediateFilled: return "\u{f6b7}"
        case .immediateLight: return "\u{f6b8}"
        case .immediateRegular: return "\u{f6b9}"
        case .importBold: return "\u{f6ba}"
        case .importLight: return "\u{f6bb}"
        case .importRegular: return "\u{f6bc}"
        case .inCommonBold: return "\u{f6bd}"
        case .inCommonLight: return "\u{f6be}"
        case .inCommonRegular: return "\u{f6bf}"
        case .inboxBold: return "\u{f6c0}"
        case .inboxFilled: return "\u{f6c1}"
        case .inboxLight: return "\u{f6c2}"
        case .inboxRegular: return "\u{f6c3}"
        case .includeBold: return "\u{f6c4}"
        case .includeLight: return "\u{f6c5}"
        case .includeRegular: return "\u{f6c6}"
        case .incognitoBold: return "\u{f6c7}"
        case .incognitoFilled: return "\u{f6c8}"
        case .incognitoLight: return "\u{f6c9}"
        case .incognitoRegular: return "\u{f6ca}"
        case .incomingCallLegacyBold: return "\u{f6cb}"
        case .incomingCallLegacyFilled: return "\u{f6cc}"
        case .incomingCallLegacyLight: return "\u{f6cd}"
        case .incomingCallLegacyRegular: return "\u{f6ce}"
        case .indentDecreaseBold: return "\u{f6cf}"
        case .indentDecreaseLight: return "\u{f6d0}"
        case .indentDecreaseRegular: return "\u{f6d1}"
        case .indentIncreaseBold: return "\u{f6d2}"
        case .indentIncreaseLight: return "\u{f6d3}"
        case .indentIncreaseRegular: return "\u{f6d4}"
        case .infoBadgeFilled: return "\u{f6d5}"
        case .infoCircleBold: return "\u{f6d6}"
        case .infoCircleFilled: return "\u{f6d7}"
        case .infoCircleLight: return "\u{f6d8}"
        case .infoCircleRegular: return "\u{f6d9}"
        case .infoCircleTwoBold: return "\u{f6da}"
        case .infoCircleTwoFilled: return "\u{f6db}"
        case .infoCircleTwoLight: return "\u{f6dc}"
        case .infoCircleTwoRegular: return "\u{f6dd}"
        case .inputBold: return "\u{f6de}"
        case .inputDisconnectedBold: return "\u{f6df}"
        case .inputDisconnectedLight: return "\u{f6e0}"
        case .inputDisconnectedRegular: return "\u{f6e1}"
        case .inputLight: return "\u{f6e2}"
        case .inputRegular: return "\u{f6e3}"
        case .instantScheduleBold: return "\u{f6e4}"
        case .instantScheduleFilled: return "\u{f6e5}"
        case .instantScheduleLight: return "\u{f6e6}"
        case .instantScheduleRegular: return "\u{f6e7}"
        case .integerBold: return "\u{f6e8}"
        case .integerFilled: return "\u{f6e9}"
        case .integerLight: return "\u{f6ea}"
        case .integerRegular: return "\u{f6eb}"
        case .integrationsBold: return "\u{f6ec}"
        case .integrationsFilled: return "\u{f6ed}"
        case .integrationsLight: return "\u{f6ee}"
        case .integrationsRegular: return "\u{f6ef}"
        case .intelligentRoutingBold: return "\u{f6f0}"
        case .intelligentRoutingLight: return "\u{f6f1}"
        case .intelligentRoutingRegular: return "\u{f6f2}"
        case .interactionBold: return "\u{f6f3}"
        case .interactionFilled: return "\u{f6f4}"
        case .interactionLight: return "\u{f6f5}"
        case .interactionRegular: return "\u{f6f6}"
        case .invitedUserBold: return "\u{f6f7}"
        case .invitedUserLight: return "\u{f6f8}"
        case .invitedUserRegular: return "\u{f6f9}"
        case .italicBold: return "\u{f6fa}"
        case .italicFilled: return "\u{f6fb}"
        case .italicLight: return "\u{f6fc}"
        case .italicRegular: return "\u{f6fd}"
        case .joinAudioBold: return "\u{f6fe}"
        case .joinAudioFilled: return "\u{f6ff}"
        case .joinAudioLight: return "\u{f700}"
        case .joinAudioRegular: return "\u{f701}"
        case .keepInTouchBold: return "\u{f702}"
        case .keepInTouchFilled: return "\u{f703}"
        case .keepInTouchLight: return "\u{f704}"
        case .keepInTouchRegular: return "\u{f705}"
        case .keyboardBold: return "\u{f706}"
        case .keyboardCloseBold: return "\u{f707}"
        case .keyboardCloseLight: return "\u{f708}"
        case .keyboardCloseRegular: return "\u{f709}"
        case .keyboardLight: return "\u{f70a}"
        case .keyboardRegular: return "\u{f70b}"
        case .languageBold: return "\u{f70c}"
        case .languageFilled: return "\u{f70d}"
        case .languageLight: return "\u{f70e}"
        case .languageRegular: return "\u{f70f}"
        case .laptopBold: return "\u{f710}"
        case .laptopDisconnectedBold: return "\u{f711}"
        case .laptopDisconnectedLight: return "\u{f712}"
        case .laptopDisconnectedRegular: return "\u{f713}"
        case .laptopFilled: return "\u{f714}"
        case .laptopLight: return "\u{f715}"
        case .laptopRegular: return "\u{f716}"
        case .laserPointerBold: return "\u{f717}"
        case .laserPointerCursorBlackLight: return "\u{f718}"
        case .laserPointerCursorBlueLight: return "\u{f719}"
        case .laserPointerCursorGreenLight: return "\u{f71a}"
        case .laserPointerCursorPurpleLight: return "\u{f71b}"
        case .laserPointerCursorRedLight: return "\u{f71c}"
        case .laserPointerCursorWhiteLight: return "\u{f71d}"
        case .laserPointerCursorYellowLight: return "\u{f71e}"
        case .laserPointerFilled: return "\u{f71f}"
        case .laserPointerLight: return "\u{f720}"
        case .laserPointerRegular: return "\u{f721}"
        case .launchBold: return "\u{f722}"
        case .launchFilled: return "\u{f723}"
        case .launchLight: return "\u{f724}"
        case .launchRegular: return "\u{f725}"
        case .layoutSideBySideVerticalBold: return "\u{f726}"
        case .layoutSideBySideVerticalFilled: return "\u{f727}"
        case .layoutSideBySideVerticalLight: return "\u{f728}"
        case .layoutSideBySideVerticalRegular: return "\u{f729}"
        case .leaveBreakoutSessionBold: return "\u{f72a}"
        case .leaveBreakoutSessionLight: return "\u{f72b}"
        case .leaveBreakoutSessionRegular: return "\u{f72c}"
        case .leaveDeviceBold: return "\u{f72d}"
        case .leaveDeviceLight: return "\u{f72e}"
        case .leaveDeviceRegular: return "\u{f72f}"
        case .likeBold: return "\u{f730}"
        case .likeFilled: return "\u{f731}"
        case .likeLight: return "\u{f732}"
        case .likeRegular: return "\u{f733}"
        case .linkBold: return "\u{f734}"
        case .linkLight: return "\u{f735}"
        case .linkRegular: return "\u{f736}"
        case .listBulletedBold: return "\u{f737}"
        case .listBulletedLight: return "\u{f738}"
        case .listBulletedRegular: return "\u{f739}"
        case .listMenuBold: return "\u{f73a}"
        case .listMenuLight: return "\u{f73b}"
        case .listMenuRegular: return "\u{f73c}"
        case .listNumberedBold: return "\u{f73d}"
        case .listNumberedLight: return "\u{f73e}"
        case .listNumberedRegular: return "\u{f73f}"
        case .liveBold: return "\u{f740}"
        case .liveFilled: return "\u{f741}"
        case .liveLight: return "\u{f742}"
        case .liveRegular: return "\u{f743}"
        case .locationBold: return "\u{f744}"
        case .locationFilled: return "\u{f745}"
        case .locationLight: return "\u{f746}"
        case .locationRegular: return "\u{f747}"
        case .longTextBoxBold: return "\u{f748}"
        case .longTextBoxLight: return "\u{f749}"
        case .longTextBoxRegular: return "\u{f74a}"
        case .lowerHandBold: return "\u{f74b}"
        case .lowerHandLight: return "\u{f74c}"
        case .lowerHandRegular: return "\u{f74d}"
        case .magicPenBold: return "\u{f74e}"
        case .magicPenFilled: return "\u{f74f}"
        case .magicPenLight: return "\u{f750}"
        case .magicPenRegular: return "\u{f751}"
        case .markAsUnreadBold: return "\u{f752}"
        case .markAsUnreadFilled: return "\u{f753}"
        case .markAsUnreadLight: return "\u{f754}"
        case .markAsUnreadRegular: return "\u{f755}"
        case .markdownBold: return "\u{f756}"
        case .markdownFilled: return "\u{f757}"
        case .markdownLight: return "\u{f758}"
        case .markdownRegular: return "\u{f759}"
        case .markerBold: return "\u{f75a}"
        case .markerFilled: return "\u{f75b}"
        case .markerLight: return "\u{f75c}"
        case .markerRegular: return "\u{f75d}"
        case .maximizeBold: return "\u{f75e}"
        case .maximizeLight: return "\u{f75f}"
        case .maximizeRegular: return "\u{f760}"
        case .mediaPlayerBold: return "\u{f761}"
        case .mediaPlayerLight: return "\u{f762}"
        case .mediaPlayerRegular: return "\u{f763}"
        case .mediaQualityGoodBold: return "\u{f764}"
        case .mediaQualityGoodFilled: return "\u{f765}"
        case .mediaQualityGoodLight: return "\u{f766}"
        case .mediaQualityGoodRegular: return "\u{f767}"
        case .mediaQualityPoorBold: return "\u{f768}"
        case .mediaQualityPoorColoredBold: return "\u{f769}"
        case .mediaQualityPoorFilled: return "\u{f76a}"
        case .mediaQualityPoorLight: return "\u{f76b}"
        case .mediaQualityPoorRegular: return "\u{f76c}"
        case .mediaQualityUnstableBold: return "\u{f76d}"
        case .mediaQualityUnstableColoredBold: return "\u{f76e}"
        case .mediaQualityUnstableFilled: return "\u{f76f}"
        case .mediaQualityUnstableLight: return "\u{f770}"
        case .mediaQualityUnstableRegular: return "\u{f771}"
        case .meetBold: return "\u{f772}"
        case .meetEndBold: return "\u{f773}"
        case .meetEndLight: return "\u{f774}"
        case .meetEndRegular: return "\u{f775}"
        case .meetFilled: return "\u{f776}"
        case .meetLight: return "\u{f777}"
        case .meetRegular: return "\u{f778}"
        case .meetingSummaryBold: return "\u{f779}"
        case .meetingSummaryFilled: return "\u{f77a}"
        case .meetingSummaryLight: return "\u{f77b}"
        case .meetingSummaryRegular: return "\u{f77c}"
        case .meetingsBold: return "\u{f77d}"
        case .meetingsFilled: return "\u{f77e}"
        case .meetingsFocusMonthBold: return "\u{f77f}"
        case .meetingsFocusMonthLight: return "\u{f780}"
        case .meetingsFocusMonthRegular: return "\u{f781}"
        case .meetingsFocusOneDayBold: return "\u{f782}"
        case .meetingsFocusOneDayLight: return "\u{f783}"
        case .meetingsFocusOneDayRegular: return "\u{f784}"
        case .meetingsFocusThreeDayBold: return "\u{f785}"
        case .meetingsFocusThreeDayLight: return "\u{f786}"
        case .meetingsFocusThreeDayRegular: return "\u{f787}"
        case .meetingsFocusUpcomingBold: return "\u{f788}"
        case .meetingsFocusUpcomingLight: return "\u{f789}"
        case .meetingsFocusUpcomingRegular: return "\u{f78a}"
        case .meetingsLight: return "\u{f78b}"
        case .meetingsPresenceBadgeFilled: return "\u{f78c}"
        case .meetingsPresenceBold: return "\u{f78d}"
        case .meetingsPresenceFilled: return "\u{f78e}"
        case .meetingsPresenceLight: return "\u{f78f}"
        case .meetingsPresenceRegular: return "\u{f790}"
        case .meetingsRegular: return "\u{f791}"
        case .meetingsTeamBold: return "\u{f792}"
        case .meetingsTeamFilled: return "\u{f793}"
        case .meetingsTeamLight: return "\u{f794}"
        case .meetingsTeamNewBold: return "\u{f795}"
        case .meetingsTeamNewLight: return "\u{f796}"
        case .meetingsTeamNewRegular: return "\u{f797}"
        case .meetingsTeamRegular: return "\u{f798}"
        case .mentionBold: return "\u{f799}"
        case .mentionFilled: return "\u{f79a}"
        case .mentionLight: return "\u{f79b}"
        case .mentionRegular: return "\u{f79c}"
        case .messageQueingBold: return "\u{f79d}"
        case .messageQueingLight: return "\u{f79e}"
        case .messageQueingRegular: return "\u{f79f}"
        case .microphoneBold: return "\u{f7a0}"
        case .microphoneFilled: return "\u{f7a1}"
        case .microphoneHardMutedBold: return "\u{f7a2}"
        case .microphoneHardMutedCircleFilled: return "\u{f7a3}"
        case .microphoneHardMutedLight: return "\u{f7a4}"
        case .microphoneHardMutedRegular: return "\u{f7a5}"
        case .microphoneLight: return "\u{f7a6}"
        case .microphoneMusicModeBold: return "\u{f7a7}"
        case .microphoneMusicModeLight: return "\u{f7a8}"
        case .microphoneMusicModeOnBold: return "\u{f7a9}"
        case .microphoneMusicModeOnLight: return "\u{f7aa}"
        case .microphoneMusicModeOnRegular: return "\u{f7ab}"
        case .microphoneMusicModeRegular: return "\u{f7ac}"
        case .microphoneMutedBold: return "\u{f7ad}"
        case .microphoneMutedCircleFilled: return "\u{f7ae}"
        case .microphoneMutedFilled: return "\u{f7af}"
        case .microphoneMutedLight: return "\u{f7b0}"
        case .microphoneMutedRegular: return "\u{f7b1}"
        case .microphoneOnBold: return "\u{f7b2}"
        case .microphoneOnLight: return "\u{f7b3}"
        case .microphoneOnRegular: return "\u{f7b4}"
        case .microphoneOptAllBold: return "\u{f7b5}"
        case .microphoneOptAllLight: return "\u{f7b6}"
        case .microphoneOptAllMutedBold: return "\u{f7b7}"
        case .microphoneOptAllMutedLight: return "\u{f7b8}"
        case .microphoneOptAllMutedRegular: return "\u{f7b9}"
        case .microphoneOptAllOnBold: return "\u{f7ba}"
        case .microphoneOptAllOnLight: return "\u{f7bb}"
        case .microphoneOptAllOnRegular: return "\u{f7bc}"
        case .microphoneOptAllRegular: return "\u{f7bd}"
        case .microphoneOptMeBold: return "\u{f7be}"
        case .microphoneOptMeLight: return "\u{f7bf}"
        case .microphoneOptMeMutedBold: return "\u{f7c0}"
        case .microphoneOptMeMutedLight: return "\u{f7c1}"
        case .microphoneOptMeMutedRegular: return "\u{f7c2}"
        case .microphoneOptMeOnBold: return "\u{f7c3}"
        case .microphoneOptMeOnLight: return "\u{f7c4}"
        case .microphoneOptMeOnRegular: return "\u{f7c5}"
        case .microphoneOptMeRegular: return "\u{f7c6}"
        case .microphoneRegular: return "\u{f7c7}"
        case .mindMapBold: return "\u{f7c8}"
        case .mindMapLight: return "\u{f7c9}"
        case .mindMapRegular: return "\u{f7ca}"
        case .minimizeBold: return "\u{f7cb}"
        case .minimizeLight: return "\u{f7cc}"
        case .minimizeRegular: return "\u{f7cd}"
        case .minusBold: return "\u{f7ce}"
        case .minusFilled: return "\u{f7cf}"
        case .minusLight: return "\u{f7d0}"
        case .minusRegular: return "\u{f7d1}"
        case .mirrorBold: return "\u{f7d2}"
        case .mirrorFilled: return "\u{f7d3}"
        case .mirrorLight: return "\u{f7d4}"
        case .mirrorRegular: return "\u{f7d5}"
        case .mmsFilled: return "\u{f7d6}"
        case .moderatorBold: return "\u{f7d7}"
        case .moderatorLight: return "\u{f7d8}"
        case .moderatorRegular: return "\u{f7d9}"
        case .monitoringBold: return "\u{f7da}"
        case .monitoringLight: return "\u{f7db}"
        case .monitoringRegular: return "\u{f7dc}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7dd}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7de}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7df}"
        case .moreAdrBold: return "\u{f7e0}"
        case .moreAdrLight: return "\u{f7e1}"
        case .moreAdrRegular: return "\u{f7e2}"
        case .moreBold: return "\u{f7e3}"
        case .moreCircleBold: return "\u{f7e4}"
        case .moreCircleFilled: return "\u{f7e5}"
        case .moreCircleLight: return "\u{f7e6}"
        case .moreCircleRegular: return "\u{f7e7}"
        case .moreLight: return "\u{f7e8}"
        case .moreRegular: return "\u{f7e9}"
        case .mouseCursorBold: return "\u{f7ea}"
        case .mouseCursorLight: return "\u{f7eb}"
        case .mouseCursorRegular: return "\u{f7ec}"
        case .moveCallInAdrBold: return "\u{f7ed}"
        case .moveCallInAdrLight: return "\u{f7ee}"
        case .moveCallInAdrRegular: return "\u{f7ef}"
        case .moveCallInIphBold: return "\u{f7f0}"
        case .moveCallInIphLight: return "\u{f7f1}"
        case .moveCallInIphRegular: return "\u{f7f2}"
        case .moveCallInLaptopBold: return "\u{f7f3}"
        case .moveCallInLaptopLight: return "\u{f7f4}"
        case .moveCallInLaptopRegular: return "\u{f7f5}"
        case .moveCallInOutAdrBold: return "\u{f7f6}"
        case .moveCallInOutAdrLight: return "\u{f7f7}"
        case .moveCallInOutAdrRegular: return "\u{f7f8}"
        case .moveCallInOutIphBold: return "\u{f7f9}"
        case .moveCallInOutIphLight: return "\u{f7fa}"
        case .moveCallInOutIphRegular: return "\u{f7fb}"
        case .moveCallInTabletBold: return "\u{f7fc}"
        case .moveCallInTabletLight: return "\u{f7fd}"
        case .moveCallInTabletRegular: return "\u{f7fe}"
        case .moveCallOutAdrBold: return "\u{f7ff}"
        case .moveCallOutAdrLight: return "\u{f800}"
        case .moveCallOutAdrRegular: return "\u{f801}"
        case .moveCallOutIphBold: return "\u{f802}"
        case .moveCallOutIphLight: return "\u{f803}"
        case .moveCallOutIphRegular: return "\u{f804}"
        case .moveCallOutLaptopBold: return "\u{f805}"
        case .moveCallOutLaptopLight: return "\u{f806}"
        case .moveCallOutLaptopRegular: return "\u{f807}"
        case .moveCallOutTabletBold: return "\u{f808}"
        case .moveCallOutTabletLight: return "\u{f809}"
        case .moveCallOutTabletRegular: return "\u{f80a}"
        case .moveToScreenBold: return "\u{f80b}"
        case .moveToScreenLight: return "\u{f80c}"
        case .moveToScreenRegular: return "\u{f80d}"
        case .multilineChartBold: return "\u{f80e}"
        case .multilineChartFilled: return "\u{f80f}"
        case .multilineChartLight: return "\u{f810}"
        case .multilineChartRegular: return "\u{f811}"
        case .multimediaBold: return "\u{f812}"
        case .multimediaFilled: return "\u{f813}"
        case .multimediaLight: return "\u{f814}"
        case .multimediaRegular: return "\u{f815}"
        case .multipledDevicesBold: return "\u{f816}"
        case .multipledDevicesLight: return "\u{f817}"
        case .multipledDevicesRegular: return "\u{f818}"
        case .musicModeCircleBold: return "\u{f819}"
        case .musicModeCircleFilled: return "\u{f81a}"
        case .musicModeCircleLight: return "\u{f81b}"
        case .musicModeCircleRegular: return "\u{f81c}"
        case .musicNoteBold: return "\u{f81d}"
        case .musicNoteFilled: return "\u{f81e}"
        case .musicNoteLight: return "\u{f81f}"
        case .musicNoteRegular: return "\u{f820}"
        case .muteOnEntryBold: return "\u{f821}"
        case .muteOnEntryFilled: return "\u{f822}"
        case .muteOnEntryLight: return "\u{f823}"
        case .muteOnEntryRegular: return "\u{f824}"
        case .networkSwitchBold: return "\u{f825}"
        case .networkSwitchFilled: return "\u{f826}"
        case .networkSwitchLight: return "\u{f827}"
        case .networkSwitchRegular: return "\u{f828}"
        case .newManagerBold: return "\u{f829}"
        case .newManagerFilled: return "\u{f82a}"
        case .newManagerLight: return "\u{f82b}"
        case .newManagerRegular: return "\u{f82c}"
        case .newTitleBold: return "\u{f82d}"
        case .newTitleLight: return "\u{f82e}"
        case .newTitleRegular: return "\u{f82f}"
        case .newVoicemailBold: return "\u{f830}"
        case .newVoicemailLight: return "\u{f831}"
        case .newVoicemailRegular: return "\u{f832}"
        case .newWhiteboardBold: return "\u{f833}"
        case .newWhiteboardLight: return "\u{f834}"
        case .newWhiteboardRegular: return "\u{f835}"
        case .nextBold: return "\u{f836}"
        case .nextLight: return "\u{f837}"
        case .nextRegular: return "\u{f838}"
        case .noDevicesBold: return "\u{f839}"
        case .noDevicesLight: return "\u{f83a}"
        case .noDevicesRegular: return "\u{f83b}"
        case .noiseDetectedCanceledFilled: return "\u{f83c}"
        case .noiseDetectedFilled: return "\u{f83d}"
        case .noiseNoneCanceledFilled: return "\u{f83e}"
        case .noiseNoneFilled: return "\u{f83f}"
        case .noiseRemovalBold: return "\u{f840}"
        case .noiseRemovalLight: return "\u{f841}"
        case .noiseRemovalRegular: return "\u{f842}"
        case .noteBold: return "\u{f843}"
        case .noteFilled: return "\u{f844}"
        case .noteLight: return "\u{f845}"
        case .notePptBold: return "\u{f846}"
        case .notePptLight: return "\u{f847}"
        case .notePptRegular: return "\u{f848}"
        case .noteRegular: return "\u{f849}"
        case .notesBold: return "\u{f84a}"
        case .notesFilled: return "\u{f84b}"
        case .notesLight: return "\u{f84c}"
        case .notesRegular: return "\u{f84d}"
        case .numberBold: return "\u{f84e}"
        case .numberLight: return "\u{f84f}"
        case .numberRegular: return "\u{f850}"
        case .oldRemoteBold: return "\u{f851}"
        case .oldRemoteLight: return "\u{f852}"
        case .oldRemoteRegular: return "\u{f853}"
        case .oldTouchBold: return "\u{f854}"
        case .oldTouchLight: return "\u{f855}"
        case .oldTouchRegular: return "\u{f856}"
        case .oneColumnBold: return "\u{f857}"
        case .oneColumnLight: return "\u{f858}"
        case .oneColumnRegular: return "\u{f859}"
        case .oneTimeBold: return "\u{f85a}"
        case .oneTimeLight: return "\u{f85b}"
        case .oneTimeRegular: return "\u{f85c}"
        case .openInFolderBold: return "\u{f85d}"
        case .openInFolderFilled: return "\u{f85e}"
        case .openInFolderLight: return "\u{f85f}"
        case .openInFolderRegular: return "\u{f860}"
        case .openPagesBold: return "\u{f861}"
        case .openPagesLight: return "\u{f862}"
        case .openPagesRegular: return "\u{f863}"
        case .otherNumberBold: return "\u{f864}"
        case .otherNumberFilled: return "\u{f865}"
        case .otherNumberLight: return "\u{f866}"
        case .otherNumberRegular: return "\u{f867}"
        case .otherNumberWarningBold: return "\u{f868}"
        case .otherNumberWarningLight: return "\u{f869}"
        case .otherNumberWarningRegular: return "\u{f86a}"
        case .outgoingCallLegacyBold: return "\u{f86b}"
        case .outgoingCallLegacyFilled: return "\u{f86c}"
        case .outgoingCallLegacyLight: return "\u{f86d}"
        case .outgoingCallLegacyRegular: return "\u{f86e}"
        case .overflowLeftBold: return "\u{f86f}"
        case .overflowLeftLight: return "\u{f870}"
        case .overflowLeftRegular: return "\u{f871}"
        case .overflowRightBold: return "\u{f872}"
        case .overflowRightLight: return "\u{f873}"
        case .overflowRightRegular: return "\u{f874}"
        case .pairedCameraBold: return "\u{f875}"
        case .pairedCameraLight: return "\u{f876}"
        case .pairedCameraRegular: return "\u{f877}"
        case .pairedDeviceBold: return "\u{f878}"
        case .pairedDeviceLight: return "\u{f879}"
        case .pairedDeviceRegular: return "\u{f87a}"
        case .pairedHandsetBold: return "\u{f87b}"
        case .pairedHandsetLight: return "\u{f87c}"
        case .pairedHandsetRegular: return "\u{f87d}"
        case .pairingBold: return "\u{f87e}"
        case .pairingLight: return "\u{f87f}"
        case .pairingRegular: return "\u{f880}"
        case .parenthesisBold: return "\u{f881}"
        case .parenthesisFilled: return "\u{f882}"
        case .parenthesisLight: return "\u{f883}"
        case .parenthesisRegular: return "\u{f884}"
        case .parkedBold: return "\u{f885}"
        case .parkedFilled: return "\u{f886}"
        case .parkedLight: return "\u{f887}"
        case .parkedRegular: return "\u{f888}"
        case .parseBold: return "\u{f889}"
        case .parseLight: return "\u{f88a}"
        case .parseRegular: return "\u{f88b}"
        case .partialBold: return "\u{f88c}"
        case .partialLight: return "\u{f88d}"
        case .partialRegular: return "\u{f88e}"
        case .participantAddBold: return "\u{f88f}"
        case .participantAddLight: return "\u{f890}"
        case .participantAddRegular: return "\u{f891}"
        case .participantBlockedBold: return "\u{f892}"
        case .participantBlockedLight: return "\u{f893}"
        case .participantBlockedRegular: return "\u{f894}"
        case .participantBold: return "\u{f895}"
        case .participantFilled: return "\u{f896}"
        case .participantLight: return "\u{f897}"
        case .participantListBold: return "\u{f898}"
        case .participantListFilled: return "\u{f899}"
        case .participantListLight: return "\u{f89a}"
        case .participantListRegular: return "\u{f89b}"
        case .participantRegular: return "\u{f89c}"
        case .participantRemoveBold: return "\u{f89d}"
        case .participantRemoveLight: return "\u{f89e}"
        case .participantRemoveRegular: return "\u{f89f}"
        case .participantUnknownBold: return "\u{f8a0}"
        case .participantUnknownLight: return "\u{f8a1}"
        case .participantUnknownRegular: return "\u{f8a2}"
        case .passMouseBold: return "\u{f8a3}"
        case .passMouseLight: return "\u{f8a4}"
        case .passMouseRegular: return "\u{f8a5}"
        case .pauseBadgeFilled: return "\u{f8a6}"
        case .pauseBold: return "\u{f8a7}"
        case .pauseFilled: return "\u{f8a8}"
        case .pauseInteractionBold: return "\u{f8a9}"
        case .pauseInteractionFilled: return "\u{f8aa}"
        case .pauseInteractionLight: return "\u{f8ab}"
        case .pauseInteractionRegular: return "\u{f8ac}"
        case .pauseLight: return "\u{f8ad}"
        case .pauseRegular: return "\u{f8ae}"
        case .peopleAddBold: return "\u{f8af}"
        case .peopleAddFilled: return "\u{f8b0}"
        case .peopleAddLight: return "\u{f8b1}"
        case .peopleAddRegular: return "\u{f8b2}"
        case .peopleBold: return "\u{f8b3}"
        case .peopleCircleBold: return "\u{f8b4}"
        case .peopleCircleFilled: return "\u{f8b5}"
        case .peopleCircleLight: return "\u{f8b6}"
        case .peopleCircleRegular: return "\u{f8b7}"
        case .peopleFilled: return "\u{f8b8}"
        case .peopleInsightsBold: return "\u{f8b9}"
        case .peopleInsightsFilled: return "\u{f8ba}"
        case .peopleInsightsLight: return "\u{f8bb}"
        case .peopleInsightsRegular: return "\u{f8bc}"
        case .peopleLight: return "\u{f8bd}"
        case .peopleManageBold: return "\u{f8be}"
        case .peopleManageFilled: return "\u{f8bf}"
        case .peopleManageLight: return "\u{f8c0}"
        case .peopleManageRegular: return "\u{f8c1}"
        case .peopleRegular: return "\u{f8c2}"
        case .phoneAlertBold: return "\u{f8c3}"
        case .phoneAlertLight: return "\u{f8c4}"
        case .phoneAlertRegular: return "\u{f8c5}"
        case .phoneBadgeFilled: return "\u{f8c6}"
        case .phoneBold: return "\u{f8c7}"
        case .phoneFilled: return "\u{f8c8}"
        case .phoneLight: return "\u{f8c9}"
        case .phoneMutedBold: return "\u{f8ca}"
        case .phoneMutedLight: return "\u{f8cb}"
        case .phoneMutedRegular: return "\u{f8cc}"
        case .phonePrivateBold: return "\u{f8cd}"
        case .phonePrivateLight: return "\u{f8ce}"
        case .phonePrivateRegular: return "\u{f8cf}"
        case .phoneRegular: return "\u{f8d0}"
        case .phoneReplyAllBold: return "\u{f8d1}"
        case .phoneReplyAllLight: return "\u{f8d2}"
        case .phoneReplyAllRegular: return "\u{f8d3}"
        case .phoneReplyBold: return "\u{f8d4}"
        case .phoneReplyLight: return "\u{f8d5}"
        case .phoneReplyRegular: return "\u{f8d6}"
        case .pickerBold: return "\u{f8d7}"
        case .pickerLight: return "\u{f8d8}"
        case .pickerRegular: return "\u{f8d9}"
        case .pieChartBold: return "\u{f8da}"
        case .pieChartFilled: return "\u{f8db}"
        case .pieChartLight: return "\u{f8dc}"
        case .pieChartRegular: return "\u{f8dd}"
        case .pinBold: return "\u{f8de}"
        case .pinFilled: return "\u{f8df}"
        case .pinLight: return "\u{f8e0}"
        case .pinListActivityBold: return "\u{f8e1}"
        case .pinListActivityLight: return "\u{f8e2}"
        case .pinListActivityRegular: return "\u{f8e3}"
        case .pinListBold: return "\u{f8e4}"
        case .pinListLight: return "\u{f8e5}"
        case .pinListRegular: return "\u{f8e6}"
        case .pinMutedBold: return "\u{f8e7}"
        case .pinMutedFilled: return "\u{f8e8}"
        case .pinMutedLight: return "\u{f8e9}"
        case .pinMutedRegular: return "\u{f8ea}"
        case .pinRegular: return "\u{f8eb}"
        case .pipBold: return "\u{f8ec}"
        case .pipEnterBold: return "\u{f8ed}"
        case .pipEnterLight: return "\u{f8ee}"
        case .pipEnterRegular: return "\u{f8ef}"
        case .pipExitBold: return "\u{f8f0}"
        case .pipExitLight: return "\u{f8f1}"
        case .pipExitRegular: return "\u{f8f2}"
        case .pipFilled: return "\u{f8f3}"
        case .pipLight: return "\u{f8f4}"
        case .pipRegular: return "\u{f8f5}"
        case .placeholderBold: return "\u{f8f6}"
        case .placeholderFilled: return "\u{f8f7}"
        case .placeholderLight: return "\u{f8f8}"
        case .placeholderRegular: return "\u{f8f9}"
        case .playBold: return "\u{f8fa}"
        case .playCircleBold: return "\u{f8fb}"
        case .playCircleFilled: return "\u{f8fc}"
        case .playCircleLight: return "\u{f8fd}"
        case .playCircleRegular: return "\u{f8fe}"
        case .playFilled: return "\u{f8ff}"
        case .playLight: return "\u{f900}"
        case .playRegular: return "\u{f901}"
        case .plugAcBold: return "\u{f902}"
        case .plugAcLight: return "\u{f903}"
        case .plugAcRegular: return "\u{f904}"
        case .plusBold: return "\u{f905}"
        case .plusCircleBold: return "\u{f906}"
        case .plusCircleFilled: return "\u{f907}"
        case .plusCircleLight: return "\u{f908}"
        case .plusCircleRegular: return "\u{f909}"
        case .plusLight: return "\u{f90a}"
        case .plusRegular: return "\u{f90b}"
        case .pmrBold: return "\u{f90c}"
        case .pmrFilled: return "\u{f90d}"
        case .pmrLight: return "\u{f90e}"
        case .pmrRegular: return "\u{f90f}"
        case .pollBold: return "\u{f910}"
        case .pollFilled: return "\u{f911}"
        case .pollLight: return "\u{f912}"
        case .pollRegular: return "\u{f913}"
        case .popInBold: return "\u{f914}"
        case .popInLight: return "\u{f915}"
        case .popInRegular: return "\u{f916}"
        case .popOutBold: return "\u{f917}"
        case .popOutLight: return "\u{f918}"
        case .popOutRegular: return "\u{f919}"
        case .popUpBold: return "\u{f91a}"
        case .popUpLight: return "\u{f91b}"
        case .popUpRegular: return "\u{f91c}"
        case .portraitLandscapeBold: return "\u{f91d}"
        case .portraitLandscapeLight: return "\u{f91e}"
        case .portraitLandscapeRegular: return "\u{f91f}"
        case .potentialFraudBold: return "\u{f920}"
        case .potentialFraudFilled: return "\u{f921}"
        case .potentialFraudLight: return "\u{f922}"
        case .potentialFraudRegular: return "\u{f923}"
        case .powerAcBold: return "\u{f924}"
        case .powerAcLight: return "\u{f925}"
        case .powerAcRegular: return "\u{f926}"
        case .powerBold: return "\u{f927}"
        case .powerLight: return "\u{f928}"
        case .powerRegular: return "\u{f929}"
        case .preHeaderBold: return "\u{f92a}"
        case .preHeaderLight: return "\u{f92b}"
        case .preHeaderRegular: return "\u{f92c}"
        case .premiumBold: return "\u{f92d}"
        case .premiumLight: return "\u{f92e}"
        case .premiumRegular: return "\u{f92f}"
        case .presentationBold: return "\u{f930}"
        case .presentationLight: return "\u{f931}"
        case .presentationRegular: return "\u{f932}"
        case .preventDownloadBold: return "\u{f933}"
        case .preventDownloadFilled: return "\u{f934}"
        case .preventDownloadLight: return "\u{f935}"
        case .preventDownloadRegular: return "\u{f936}"
        case .primaryParticipantBold: return "\u{f937}"
        case .primaryParticipantFilled: return "\u{f938}"
        case .primaryParticipantLight: return "\u{f939}"
        case .primaryParticipantRegular: return "\u{f93a}"
        case .printBold: return "\u{f93b}"
        case .printLight: return "\u{f93c}"
        case .printRegular: return "\u{f93d}"
        case .priorityBadgeFilled: return "\u{f93e}"
        case .priorityCircleBold: return "\u{f93f}"
        case .priorityCircleFilled: return "\u{f940}"
        case .priorityCircleLight: return "\u{f941}"
        case .priorityCircleRegular: return "\u{f942}"
        case .priorityCircleTwoBold: return "\u{f943}"
        case .priorityCircleTwoFilled: return "\u{f944}"
        case .priorityCircleTwoLight: return "\u{f945}"
        case .priorityCircleTwoRegular: return "\u{f946}"
        case .priorityWaveBold: return "\u{f947}"
        case .priorityWaveLight: return "\u{f948}"
        case .priorityWaveRegular: return "\u{f949}"
        case .privacyCircleBold: return "\u{f94a}"
        case .privacyCircleFilled: return "\u{f94b}"
        case .privacyCircleLight: return "\u{f94c}"
        case .privacyCircleRegular: return "\u{f94d}"
        case .privateBold: return "\u{f94e}"
        case .privateCircleBold: return "\u{f94f}"
        case .privateCircleFilled: return "\u{f950}"
        case .privateCircleLight: return "\u{f951}"
        case .privateCircleRegular: return "\u{f952}"
        case .privateLight: return "\u{f953}"
        case .privateMeetingBold: return "\u{f954}"
        case .privateMeetingLight: return "\u{f955}"
        case .privateMeetingRegular: return "\u{f956}"
        case .privateRegular: return "\u{f957}"
        case .productDemoBold: return "\u{f958}"
        case .productDemoLight: return "\u{f959}"
        case .productDemoRegular: return "\u{f95a}"
        case .promptsAiBold: return "\u{f95b}"
        case .promptsAiLight: return "\u{f95c}"
        case .promptsAiRegular: return "\u{f95d}"
        case .proximityBold: return "\u{f95e}"
        case .proximityLight: return "\u{f95f}"
        case .proximityMutedBold: return "\u{f960}"
        case .proximityMutedLight: return "\u{f961}"
        case .proximityMutedRegular: return "\u{f962}"
        case .proximityRegular: return "\u{f963}"
        case .proximityVideoBold: return "\u{f964}"
        case .proximityVideoLight: return "\u{f965}"
        case .proximityVideoRegular: return "\u{f966}"
        case .ptoPresenceBold: return "\u{f967}"
        case .ptoPresenceFilled: return "\u{f968}"
        case .ptoPresenceLight: return "\u{f969}"
        case .ptoPresenceRegular: return "\u{f96a}"
        case .pullCallBold: return "\u{f96b}"
        case .pullCallFilled: return "\u{f96c}"
        case .pullCallLight: return "\u{f96d}"
        case .pullCallRegular: return "\u{f96e}"
        case .qABold: return "\u{f96f}"
        case .qAFilled: return "\u{f970}"
        case .qALight: return "\u{f971}"
        case .qARegular: return "\u{f972}"
        case .qrCodeBold: return "\u{f973}"
        case .qrCodeLight: return "\u{f974}"
        case .qrCodeRegular: return "\u{f975}"
        case .qrCodeScanBold: return "\u{f976}"
        case .qrCodeScanLight: return "\u{f977}"
        case .qrCodeScanRegular: return "\u{f978}"
        case .qualityBold: return "\u{f979}"
        case .qualityLight: return "\u{f97a}"
        case .qualityRegular: return "\u{f97b}"
        case .queueContactBold: return "\u{f97c}"
        case .queueContactFilled: return "\u{f97d}"
        case .queueContactLight: return "\u{f97e}"
        case .queueContactRegular: return "\u{f97f}"
        case .queuedInteractionBold: return "\u{f980}"
        case .queuedInteractionFilled: return "\u{f981}"
        case .queuedInteractionLight: return "\u{f982}"
        case .queuedInteractionRegular: return "\u{f983}"
        case .quietBold: return "\u{f984}"
        case .quietHoursPresenceBold: return "\u{f985}"
        case .quietHoursPresenceFilled: return "\u{f986}"
        case .quietHoursPresenceLight: return "\u{f987}"
        case .quietHoursPresenceRegular: return "\u{f988}"
        case .quietLight: return "\u{f989}"
        case .quietRegular: return "\u{f98a}"
        case .radioButtonGroupBold: return "\u{f98b}"
        case .radioButtonGroupLight: return "\u{f98c}"
        case .radioButtonGroupRegular: return "\u{f98d}"
        case .raiseHandBold: return "\u{f98e}"
        case .raiseHandCircleFilled: return "\u{f98f}"
        case .raiseHandFilled: return "\u{f990}"
        case .raiseHandLight: return "\u{f991}"
        case .raiseHandRegular: return "\u{f992}"
        case .ramBold: return "\u{f993}"
        case .ramLight: return "\u{f994}"
        case .ramRegular: return "\u{f995}"
        case .reactionsBold: return "\u{f996}"
        case .reactionsFilled: return "\u{f997}"
        case .reactionsLight: return "\u{f998}"
        case .reactionsRegular: return "\u{f999}"
        case .reactivateBold: return "\u{f99a}"
        case .reactivateLight: return "\u{f99b}"
        case .reactivateRegular: return "\u{f99c}"
        case .receiveVoiceBold: return "\u{f99d}"
        case .receiveVoiceFilled: return "\u{f99e}"
        case .receiveVoiceLight: return "\u{f99f}"
        case .receiveVoiceRegular: return "\u{f9a0}"
        case .recentsBold: return "\u{f9a1}"
        case .recentsFilled: return "\u{f9a2}"
        case .recentsLight: return "\u{f9a3}"
        case .recentsPresenceBadgeFilled: return "\u{f9a4}"
        case .recentsPresenceBold: return "\u{f9a5}"
        case .recentsPresenceFilled: return "\u{f9a6}"
        case .recentsPresenceLight: return "\u{f9a7}"
        case .recentsPresenceRegular: return "\u{f9a8}"
        case .recentsRegular: return "\u{f9a9}"
        case .recordActiveBadgeFilled: return "\u{f9aa}"
        case .recordActiveBold: return "\u{f9ab}"
        case .recordActiveFilled: return "\u{f9ac}"
        case .recordActiveLight: return "\u{f9ad}"
        case .recordActiveRegular: return "\u{f9ae}"
        case .recordBold: return "\u{f9af}"
        case .recordFilled: return "\u{f9b0}"
        case .recordLight: return "\u{f9b1}"
        case .recordPausedBadgeFilled: return "\u{f9b2}"
        case .recordPausedBold: return "\u{f9b3}"
        case .recordPausedFilled: return "\u{f9b4}"
        case .recordPausedLight: return "\u{f9b5}"
        case .recordPausedRegular: return "\u{f9b6}"
        case .recordRegular: return "\u{f9b7}"
        case .recurringBold: return "\u{f9b8}"
        case .recurringLight: return "\u{f9b9}"
        case .recurringOffBold: return "\u{f9ba}"
        case .recurringOffLight: return "\u{f9bb}"
        case .recurringOffRegular: return "\u{f9bc}"
        case .recurringRegular: return "\u{f9bd}"
        case .redoBold: return "\u{f9be}"
        case .redoLight: return "\u{f9bf}"
        case .redoRegular: return "\u{f9c0}"
        case .refreshBold: return "\u{f9c1}"
        case .refreshLight: return "\u{f9c2}"
        case .refreshRegular: return "\u{f9c3}"
        case .remoteDesktopControlBold: return "\u{f9c4}"
        case .remoteDesktopControlFilled: return "\u{f9c5}"
        case .remoteDesktopControlLight: return "\u{f9c6}"
        case .remoteDesktopControlRegular: return "\u{f9c7}"
        case .removeBold: return "\u{f9c8}"
        case .removeFilled: return "\u{f9c9}"
        case .removeLight: return "\u{f9ca}"
        case .removeRegular: return "\u{f9cb}"
        case .replyBold: return "\u{f9cc}"
        case .replyFilled: return "\u{f9cd}"
        case .replyLight: return "\u{f9ce}"
        case .replyListBold: return "\u{f9cf}"
        case .replyListFilled: return "\u{f9d0}"
        case .replyListLight: return "\u{f9d1}"
        case .replyListRegular: return "\u{f9d2}"
        case .replyPrivatelyBold: return "\u{f9d3}"
        case .replyPrivatelyLight: return "\u{f9d4}"
        case .replyPrivatelyRegular: return "\u{f9d5}"
        case .replyRegular: return "\u{f9d6}"
        case .resetBold: return "\u{f9d7}"
        case .resetLight: return "\u{f9d8}"
        case .resetRegular: return "\u{f9d9}"
        case .resizeCornerBold: return "\u{f9da}"
        case .resizeCornerLight: return "\u{f9db}"
        case .resizeCornerRegular: return "\u{f9dc}"
        case .responsiveMobileBold: return "\u{f9dd}"
        case .responsiveMobileLight: return "\u{f9de}"
        case .responsiveMobileRegular: return "\u{f9df}"
        case .restartBold: return "\u{f9e0}"
        case .restartLight: return "\u{f9e1}"
        case .restartRegular: return "\u{f9e2}"
        case .resumeInteractionBold: return "\u{f9e3}"
        case .resumeInteractionFilled: return "\u{f9e4}"
        case .resumeInteractionLight: return "\u{f9e5}"
        case .resumeInteractionRegular: return "\u{f9e6}"
        case .retrieveCallBold: return "\u{f9e7}"
        case .retrieveCallFilled: return "\u{f9e8}"
        case .retrieveCallLight: return "\u{f9e9}"
        case .retrieveCallRegular: return "\u{f9ea}"
        case .returnBold: return "\u{f9eb}"
        case .returnLight: return "\u{f9ec}"
        case .returnRegular: return "\u{f9ed}"
        case .rewindTenSecBold: return "\u{f9ee}"
        case .rewindTenSecLight: return "\u{f9ef}"
        case .rewindTenSecRegular: return "\u{f9f0}"
        case .ringtoneBold: return "\u{f9f1}"
        case .ringtoneLight: return "\u{f9f2}"
        case .ringtoneRegular: return "\u{f9f3}"
        case .roomCalendarBold: return "\u{f9f4}"
        case .roomCalendarLight: return "\u{f9f5}"
        case .roomCalendarRegular: return "\u{f9f6}"
        case .roomLightsBold: return "\u{f9f7}"
        case .roomLightsFilled: return "\u{f9f8}"
        case .roomLightsLight: return "\u{f9f9}"
        case .roomLightsRegular: return "\u{f9fa}"
        case .rotateContentBold: return "\u{f9fb}"
        case .rotateContentFilled: return "\u{f9fc}"
        case .rotateContentLight: return "\u{f9fd}"
        case .rotateContentRegular: return "\u{f9fe}"
        case .rssBold: return "\u{f9ff}"
        case .rssFilled: return "\u{fa00}"
        case .rssLight: return "\u{fa01}"
        case .rssRegular: return "\u{fa02}"
        case .ruleBasedBold: return "\u{fa03}"
        case .ruleBasedLight: return "\u{fa04}"
        case .ruleBasedRegular: return "\u{fa05}"
        case .rulerBold: return "\u{fa06}"
        case .rulerFilled: return "\u{fa07}"
        case .rulerLight: return "\u{fa08}"
        case .rulerRegular: return "\u{fa09}"
        case .runningApplicationBold: return "\u{fa0a}"
        case .runningApplicationFilled: return "\u{fa0b}"
        case .runningApplicationLight: return "\u{fa0c}"
        case .runningApplicationRegular: return "\u{fa0d}"
        case .saveBold: return "\u{fa0e}"
        case .saveLight: return "\u{fa0f}"
        case .saveRegular: return "\u{fa10}"
        case .saveTranscriptBold: return "\u{fa11}"
        case .saveTranscriptFilled: return "\u{fa12}"
        case .saveTranscriptLight: return "\u{fa13}"
        case .saveTranscriptRegular: return "\u{fa14}"
        case .scanBold: return "\u{fa15}"
        case .scanLight: return "\u{fa16}"
        case .scanRegular: return "\u{fa17}"
        case .scheduleAiBold: return "\u{fa18}"
        case .scheduleAiLight: return "\u{fa19}"
        case .scheduleAiRegular: return "\u{fa1a}"
        case .scheduleSendBold: return "\u{fa1b}"
        case .scheduleSendFilled: return "\u{fa1c}"
        case .scheduleSendLight: return "\u{fa1d}"
        case .scheduleSendRegular: return "\u{fa1e}"
        case .scheduleWinnerBold: return "\u{fa1f}"
        case .scheduleWinnerFilled: return "\u{fa20}"
        case .scheduleWinnerLight: return "\u{fa21}"
        case .scheduleWinnerRegular: return "\u{fa22}"
        case .schedulerAvailableBold: return "\u{fa23}"
        case .schedulerAvailableLight: return "\u{fa24}"
        case .schedulerAvailableRegular: return "\u{fa25}"
        case .schedulerNotWorkingHoursBold: return "\u{fa26}"
        case .schedulerNotWorkingHoursLight: return "\u{fa27}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa28}"
        case .schedulerUnavailableBold: return "\u{fa29}"
        case .schedulerUnavailableLight: return "\u{fa2a}"
        case .schedulerUnavailableRegular: return "\u{fa2b}"
        case .schedulerUnknownBold: return "\u{fa2c}"
        case .schedulerUnknownLight: return "\u{fa2d}"
        case .schedulerUnknownRegular: return "\u{fa2e}"
        case .screenshotBold: return "\u{fa2f}"
        case .screenshotDocBold: return "\u{fa30}"
        case .screenshotDocFilled: return "\u{fa31}"
        case .screenshotDocLight: return "\u{fa32}"
        case .screenshotDocRegular: return "\u{fa33}"
        case .screenshotLight: return "\u{fa34}"
        case .screenshotRegular: return "\u{fa35}"
        case .searchAiBold: return "\u{fa36}"
        case .searchAiLight: return "\u{fa37}"
        case .searchAiRegular: return "\u{fa38}"
        case .searchBold: return "\u{fa39}"
        case .searchFilled: return "\u{fa3a}"
        case .searchLight: return "\u{fa3b}"
        case .searchRegular: return "\u{fa3c}"
        case .secondaryArrowBold: return "\u{fa3d}"
        case .secondaryArrowLight: return "\u{fa3e}"
        case .secondaryArrowRegular: return "\u{fa3f}"
        case .secureCallLockBold: return "\u{fa40}"
        case .secureCallLockFilled: return "\u{fa41}"
        case .secureCallLockLight: return "\u{fa42}"
        case .secureCallLockRegular: return "\u{fa43}"
        case .secureCallShieldBold: return "\u{fa44}"
        case .secureCallShieldFilled: return "\u{fa45}"
        case .secureCallShieldLight: return "\u{fa46}"
        case .secureCallShieldRegular: return "\u{fa47}"
        case .secureCircleBold: return "\u{fa48}"
        case .secureCircleFilled: return "\u{fa49}"
        case .secureCircleLight: return "\u{fa4a}"
        case .secureCircleRegular: return "\u{fa4b}"
        case .secureLockBold: return "\u{fa4c}"
        case .secureLockFilled: return "\u{fa4d}"
        case .secureLockLight: return "\u{fa4e}"
        case .secureLockRegular: return "\u{fa4f}"
        case .segmentExcludeFilled: return "\u{fa50}"
        case .segmentFilterFilled: return "\u{fa51}"
        case .segmentIncludeFilled: return "\u{fa52}"
        case .selectAllBold: return "\u{fa53}"
        case .selectAllFilled: return "\u{fa54}"
        case .selectAllLight: return "\u{fa55}"
        case .selectAllRegular: return "\u{fa56}"
        case .selectionBold: return "\u{fa57}"
        case .selectionFilled: return "\u{fa58}"
        case .selectionLight: return "\u{fa59}"
        case .selectionRegular: return "\u{fa5a}"
        case .sendBold: return "\u{fa5b}"
        case .sendDigitsBold: return "\u{fa5c}"
        case .sendDigitsFilled: return "\u{fa5d}"
        case .sendDigitsLight: return "\u{fa5e}"
        case .sendDigitsRegular: return "\u{fa5f}"
        case .sendFilled: return "\u{fa60}"
        case .sendLight: return "\u{fa61}"
        case .sendRegular: return "\u{fa62}"
        case .sendVoiceBold: return "\u{fa63}"
        case .sendVoiceFilled: return "\u{fa64}"
        case .sendVoiceLight: return "\u{fa65}"
        case .sendVoiceRegular: return "\u{fa66}"
        case .serverBold: return "\u{fa67}"
        case .serverErrorBold: return "\u{fa68}"
        case .serverErrorLight: return "\u{fa69}"
        case .serverErrorRegular: return "\u{fa6a}"
        case .serverLight: return "\u{fa6b}"
        case .serverRegular: return "\u{fa6c}"
        case .servicesBold: return "\u{fa6d}"
        case .servicesLight: return "\u{fa6e}"
        case .servicesRegular: return "\u{fa6f}"
        case .setVariableBold: return "\u{fa70}"
        case .setVariableLight: return "\u{fa71}"
        case .setVariableRegular: return "\u{fa72}"
        case .settingsBold: return "\u{fa73}"
        case .settingsFilled: return "\u{fa74}"
        case .settingsLight: return "\u{fa75}"
        case .settingsRegular: return "\u{fa76}"
        case .setupAssistantBold: return "\u{fa77}"
        case .setupAssistantLight: return "\u{fa78}"
        case .setupAssistantRegular: return "\u{fa79}"
        case .sftpBold: return "\u{fa7a}"
        case .sftpLight: return "\u{fa7b}"
        case .sftpRegular: return "\u{fa7c}"
        case .shapeCircleBold: return "\u{fa7d}"
        case .shapeCircleFilled: return "\u{fa7e}"
        case .shapeCircleLight: return "\u{fa7f}"
        case .shapeCircleMdFilled: return "\u{fa80}"
        case .shapeCircleRegular: return "\u{fa81}"
        case .shapeCircleSmFilled: return "\u{fa82}"
        case .shapeDiagonalLineBold: return "\u{fa83}"
        case .shapeDiagonalLineLight: return "\u{fa84}"
        case .shapeDiagonalLineRegular: return "\u{fa85}"
        case .shapeDiamondBold: return "\u{fa86}"
        case .shapeDiamondFilled: return "\u{fa87}"
        case .shapeDiamondLight: return "\u{fa88}"
        case .shapeDiamondRegular: return "\u{fa89}"
        case .shapeOvalBold: return "\u{fa8a}"
        case .shapeOvalLight: return "\u{fa8b}"
        case .shapeOvalRegular: return "\u{fa8c}"
        case .shapeSquareBold: return "\u{fa8d}"
        case .shapeSquareFilled: return "\u{fa8e}"
        case .shapeSquareLight: return "\u{fa8f}"
        case .shapeSquareRegular: return "\u{fa90}"
        case .shapeTriangleBold: return "\u{fa91}"
        case .shapeTriangleFilled: return "\u{fa92}"
        case .shapeTriangleLight: return "\u{fa93}"
        case .shapeTriangleRegular: return "\u{fa94}"
        case .shapesBold: return "\u{fa95}"
        case .shapesFilled: return "\u{fa96}"
        case .shapesLight: return "\u{fa97}"
        case .shapesRegular: return "\u{fa98}"
        case .shareCNativeAdrBold: return "\u{fa99}"
        case .shareCNativeAdrFilled: return "\u{fa9a}"
        case .shareCNativeAdrLight: return "\u{fa9b}"
        case .shareCNativeAdrRegular: return "\u{fa9c}"
        case .shareCNativeIphBold: return "\u{fa9d}"
        case .shareCNativeIphLight: return "\u{fa9e}"
        case .shareCNativeIphRegular: return "\u{fa9f}"
        case .shareContentOnDeviceBold: return "\u{faa0}"
        case .shareContentOnDeviceLight: return "\u{faa1}"
        case .shareContentOnDeviceRegular: return "\u{faa2}"
        case .shareScreenAddBold: return "\u{faa3}"
        case .shareScreenAddLight: return "\u{faa4}"
        case .shareScreenAddRegular: return "\u{faa5}"
        case .shareScreenBadgeFilled: return "\u{faa6}"
        case .shareScreenBold: return "\u{faa7}"
        case .shareScreenFilled: return "\u{faa8}"
        case .shareScreenLight: return "\u{faa9}"
        case .shareScreenRegular: return "\u{faaa}"
        case .shareSpaceBold: return "\u{faab}"
        case .shareSpaceLight: return "\u{faac}"
        case .shareSpaceRegular: return "\u{faad}"
        case .shieldBold: return "\u{faae}"
        case .shieldLight: return "\u{faaf}"
        case .shieldRegular: return "\u{fab0}"
        case .shoppingCartBold: return "\u{fab1}"
        case .shoppingCartFilled: return "\u{fab2}"
        case .shoppingCartLight: return "\u{fab3}"
        case .shoppingCartRegular: return "\u{fab4}"
        case .shortTextBoxBold: return "\u{fab5}"
        case .shortTextBoxLight: return "\u{fab6}"
        case .shortTextBoxRegular: return "\u{fab7}"
        case .showBold: return "\u{fab8}"
        case .showFilled: return "\u{fab9}"
        case .showLight: return "\u{faba}"
        case .showRegular: return "\u{fabb}"
        case .sidePanelBold: return "\u{fabc}"
        case .sidePanelFilled: return "\u{fabd}"
        case .sidePanelLight: return "\u{fabe}"
        case .sidePanelRegular: return "\u{fabf}"
        case .signInBold: return "\u{fac0}"
        case .signInFilled: return "\u{fac1}"
        case .signInForcedBold: return "\u{fac2}"
        case .signInForcedLight: return "\u{fac3}"
        case .signInForcedRegular: return "\u{fac4}"
        case .signInLight: return "\u{fac5}"
        case .signInRegular: return "\u{fac6}"
        case .signLangIntBold: return "\u{fac7}"
        case .signLangIntLight: return "\u{fac8}"
        case .signLangIntRegular: return "\u{fac9}"
        case .signOutBold: return "\u{faca}"
        case .signOutLight: return "\u{facb}"
        case .signOutRegular: return "\u{facc}"
        case .signalFourBold: return "\u{facd}"
        case .signalFourLight: return "\u{face}"
        case .signalFourRegular: return "\u{facf}"
        case .signalOneBold: return "\u{fad0}"
        case .signalOneLight: return "\u{fad1}"
        case .signalOneRegular: return "\u{fad2}"
        case .signalThreeBold: return "\u{fad3}"
        case .signalThreeLight: return "\u{fad4}"
        case .signalThreeRegular: return "\u{fad5}"
        case .signalTwoBold: return "\u{fad6}"
        case .signalTwoLight: return "\u{fad7}"
        case .signalTwoRegular: return "\u{fad8}"
        case .signalZeroBold: return "\u{fad9}"
        case .signalZeroLight: return "\u{fada}"
        case .signalZeroRegular: return "\u{fadb}"
        case .simplePromotionBold: return "\u{fadc}"
        case .simplePromotionLight: return "\u{fadd}"
        case .simplePromotionRegular: return "\u{fade}"
        case .singleNumberReachBold: return "\u{fadf}"
        case .singleNumberReachLight: return "\u{fae0}"
        case .singleNumberReachRegular: return "\u{fae1}"
        case .sipRegistrationInProgressBold: return "\u{fae2}"
        case .sipRegistrationInProgressFilled: return "\u{fae3}"
        case .sipRegistrationInProgressLight: return "\u{fae4}"
        case .sipRegistrationInProgressRegular: return "\u{fae5}"
        case .skipBold: return "\u{fae6}"
        case .skipBwBold: return "\u{fae7}"
        case .skipBwFilled: return "\u{fae8}"
        case .skipBwLight: return "\u{fae9}"
        case .skipBwRegular: return "\u{faea}"
        case .skipFwBold: return "\u{faeb}"
        case .skipFwFilled: return "\u{faec}"
        case .skipFwLight: return "\u{faed}"
        case .skipFwRegular: return "\u{faee}"
        case .skipLight: return "\u{faef}"
        case .skipRegular: return "\u{faf0}"
        case .smartAudioBold: return "\u{faf1}"
        case .smartAudioLight: return "\u{faf2}"
        case .smartAudioRegular: return "\u{faf3}"
        case .smsFilled: return "\u{faf4}"
        case .smsInboundBold: return "\u{faf5}"
        case .smsInboundLight: return "\u{faf6}"
        case .smsInboundRegular: return "\u{faf7}"
        case .smsMessageBold: return "\u{faf8}"
        case .smsMessageFilled: return "\u{faf9}"
        case .smsMessageLight: return "\u{fafa}"
        case .smsMessageOutgoingBold: return "\u{fafb}"
        case .smsMessageOutgoingFilled: return "\u{fafc}"
        case .smsMessageOutgoingLight: return "\u{fafd}"
        case .smsMessageOutgoingRegular: return "\u{fafe}"
        case .smsMessageRegular: return "\u{faff}"
        case .smsMessageStartBold: return "\u{fb00}"
        case .smsMessageStartFilled: return "\u{fb01}"
        case .smsMessageStartLight: return "\u{fb02}"
        case .smsMessageStartRegular: return "\u{fb03}"
        case .smsOutgoingFilled: return "\u{fb04}"
        case .smsUnreadBold: return "\u{fb05}"
        case .smsUnreadLight: return "\u{fb06}"
        case .smsUnreadRegular: return "\u{fb07}"
        case .sortAscendingBold: return "\u{fb08}"
        case .sortAscendingLight: return "\u{fb09}"
        case .sortAscendingRegular: return "\u{fb0a}"
        case .sortDescendingBold: return "\u{fb0b}"
        case .sortDescendingLight: return "\u{fb0c}"
        case .sortDescendingRegular: return "\u{fb0d}"
        case .soundDefaultBold: return "\u{fb0e}"
        case .soundDefaultLight: return "\u{fb0f}"
        case .soundDefaultRegular: return "\u{fb10}"
        case .sparkleBold: return "\u{fb11}"
        case .sparkleFilled: return "\u{fb12}"
        case .sparkleLight: return "\u{fb13}"
        case .sparkleRegular: return "\u{fb14}"
        case .speakerBold: return "\u{fb15}"
        case .speakerDisconnectedBold: return "\u{fb16}"
        case .speakerDisconnectedFilled: return "\u{fb17}"
        case .speakerDisconnectedLight: return "\u{fb18}"
        case .speakerDisconnectedRegular: return "\u{fb19}"
        case .speakerFilled: return "\u{fb1a}"
        case .speakerLight: return "\u{fb1b}"
        case .speakerMutedBold: return "\u{fb1c}"
        case .speakerMutedFilled: return "\u{fb1d}"
        case .speakerMutedLight: return "\u{fb1e}"
        case .speakerMutedRegular: return "\u{fb1f}"
        case .speakerOffBold: return "\u{fb20}"
        case .speakerOffFilled: return "\u{fb21}"
        case .speakerOffLight: return "\u{fb22}"
        case .speakerOffRegular: return "\u{fb23}"
        case .speakerOnBold: return "\u{fb24}"
        case .speakerOnLight: return "\u{fb25}"
        case .speakerOnRegular: return "\u{fb26}"
        case .speakerRegular: return "\u{fb27}"
        case .speakerTurnDownBold: return "\u{fb28}"
        case .speakerTurnDownFilled: return "\u{fb29}"
        case .speakerTurnDownLight: return "\u{fb2a}"
        case .speakerTurnDownRegular: return "\u{fb2b}"
        case .speakerTurnUpBold: return "\u{fb2c}"
        case .speakerTurnUpFilled: return "\u{fb2d}"
        case .speakerTurnUpLight: return "\u{fb2e}"
        case .speakerTurnUpRegular: return "\u{fb2f}"
        case .speedDialBold: return "\u{fb30}"
        case .speedDialFilled: return "\u{fb31}"
        case .speedDialLight: return "\u{fb32}"
        case .speedDialRegular: return "\u{fb33}"
        case .spellCheckerBold: return "\u{fb34}"
        case .spellCheckerLight: return "\u{fb35}"
        case .spellCheckerRegular: return "\u{fb36}"
        case .splitViewBold: return "\u{fb37}"
        case .splitViewLight: return "\u{fb38}"
        case .splitViewRegular: return "\u{fb39}"
        case .stackedAreaChartBold: return "\u{fb3a}"
        case .stackedAreaChartFilled: return "\u{fb3b}"
        case .stackedAreaChartFullBold: return "\u{fb3c}"
        case .stackedAreaChartFullFilled: return "\u{fb3d}"
        case .stackedAreaChartFullLight: return "\u{fb3e}"
        case .stackedAreaChartFullRegular: return "\u{fb3f}"
        case .stackedAreaChartLight: return "\u{fb40}"
        case .stackedAreaChartRegular: return "\u{fb41}"
        case .stackedBarChartBold: return "\u{fb42}"
        case .stackedBarChartFilled: return "\u{fb43}"
        case .stackedBarChartFullBold: return "\u{fb44}"
        case .stackedBarChartFullFilled: return "\u{fb45}"
        case .stackedBarChartFullLight: return "\u{fb46}"
        case .stackedBarChartFullRegular: return "\u{fb47}"
        case .stackedBarChartLight: return "\u{fb48}"
        case .stackedBarChartRegular: return "\u{fb49}"
        case .startChatBold: return "\u{fb4a}"
        case .startChatLight: return "\u{fb4b}"
        case .startChatRegular: return "\u{fb4c}"
        case .stethoscopeBold: return "\u{fb4d}"
        case .stethoscopeLight: return "\u{fb4e}"
        case .stethoscopeRegular: return "\u{fb4f}"
        case .stickersBold: return "\u{fb50}"
        case .stickersLight: return "\u{fb51}"
        case .stickersRegular: return "\u{fb52}"
        case .stickiesBold: return "\u{fb53}"
        case .stickiesLight: return "\u{fb54}"
        case .stickiesRegular: return "\u{fb55}"
        case .stopBold: return "\u{fb56}"
        case .stopCircleBold: return "\u{fb57}"
        case .stopCircleFilled: return "\u{fb58}"
        case .stopCircleLight: return "\u{fb59}"
        case .stopCircleRegular: return "\u{fb5a}"
        case .stopContentShareBold: return "\u{fb5b}"
        case .stopContentShareLight: return "\u{fb5c}"
        case .stopContentShareRegular: return "\u{fb5d}"
        case .stopFilled: return "\u{fb5e}"
        case .stopLight: return "\u{fb5f}"
        case .stopRegular: return "\u{fb60}"
        case .storedInfoBold: return "\u{fb61}"
        case .storedInfoFilled: return "\u{fb62}"
        case .storedInfoLight: return "\u{fb63}"
        case .storedInfoRegular: return "\u{fb64}"
        case .streamingBold: return "\u{fb65}"
        case .streamingLight: return "\u{fb66}"
        case .streamingRegular: return "\u{fb67}"
        case .strikethroughBold: return "\u{fb68}"
        case .strikethroughFilled: return "\u{fb69}"
        case .strikethroughLight: return "\u{fb6a}"
        case .strikethroughRegular: return "\u{fb6b}"
        case .studioModeBold: return "\u{fb6c}"
        case .studioModeLight: return "\u{fb6d}"
        case .studioModeRegular: return "\u{fb6e}"
        case .subscriptBold: return "\u{fb6f}"
        case .subscriptLight: return "\u{fb70}"
        case .subscriptRegular: return "\u{fb71}"
        case .summarizeAiBold: return "\u{fb72}"
        case .summarizeAiLight: return "\u{fb73}"
        case .summarizeAiRegular: return "\u{fb74}"
        case .superscriptBold: return "\u{fb75}"
        case .superscriptLight: return "\u{fb76}"
        case .superscriptRegular: return "\u{fb77}"
        case .surveyBold: return "\u{fb78}"
        case .surveyFilled: return "\u{fb79}"
        case .surveyLight: return "\u{fb7a}"
        case .surveyRegular: return "\u{fb7b}"
        case .sxEightyCodecBold: return "\u{fb7c}"
        case .sxEightyCodecLight: return "\u{fb7d}"
        case .sxEightyCodecRegular: return "\u{fb7e}"
        case .sxTenBold: return "\u{fb7f}"
        case .sxTenLight: return "\u{fb80}"
        case .sxTenRegular: return "\u{fb81}"
        case .sxTwentyBold: return "\u{fb82}"
        case .sxTwentyLight: return "\u{fb83}"
        case .sxTwentyRegular: return "\u{fb84}"
        case .tableBold: return "\u{fb85}"
        case .tableExtenderBold: return "\u{fb86}"
        case .tableExtenderFilled: return "\u{fb87}"
        case .tableExtenderLight: return "\u{fb88}"
        case .tableExtenderRegular: return "\u{fb89}"
        case .tableLight: return "\u{fb8a}"
        case .tableRegular: return "\u{fb8b}"
        case .tabletBold: return "\u{fb8c}"
        case .tabletLight: return "\u{fb8d}"
        case .tabletRegular: return "\u{fb8e}"
        case .tabsBold: return "\u{fb8f}"
        case .tabsLight: return "\u{fb90}"
        case .tabsRegular: return "\u{fb91}"
        case .tagBold: return "\u{fb92}"
        case .tagLight: return "\u{fb93}"
        case .tagRegular: return "\u{fb94}"
        case .tapBold: return "\u{fb95}"
        case .tapFilled: return "\u{fb96}"
        case .tapLight: return "\u{fb97}"
        case .tapRegular: return "\u{fb98}"
        case .telepresenceAlertBold: return "\u{fb99}"
        case .telepresenceAlertLight: return "\u{fb9a}"
        case .telepresenceAlertMutedBold: return "\u{fb9b}"
        case .telepresenceAlertMutedLight: return "\u{fb9c}"
        case .telepresenceAlertMutedRegular: return "\u{fb9d}"
        case .telepresenceAlertRegular: return "\u{fb9e}"
        case .telepresenceBold: return "\u{fb9f}"
        case .telepresenceIxFiveThousandBold: return "\u{fba0}"
        case .telepresenceIxFiveThousandLight: return "\u{fba1}"
        case .telepresenceIxFiveThousandRegular: return "\u{fba2}"
        case .telepresenceLight: return "\u{fba3}"
        case .telepresenceMutedBold: return "\u{fba4}"
        case .telepresenceMutedLight: return "\u{fba5}"
        case .telepresenceMutedRegular: return "\u{fba6}"
        case .telepresencePrivateBold: return "\u{fba7}"
        case .telepresencePrivateLight: return "\u{fba8}"
        case .telepresencePrivateRegular: return "\u{fba9}"
        case .telepresenceRegular: return "\u{fbaa}"
        case .temperatureBold: return "\u{fbab}"
        case .temperatureLight: return "\u{fbac}"
        case .temperatureRegular: return "\u{fbad}"
        case .testTubeBold: return "\u{fbae}"
        case .testTubeFilled: return "\u{fbaf}"
        case .testTubeLight: return "\u{fbb0}"
        case .testTubeRegular: return "\u{fbb1}"
        case .textAlignCenterBold: return "\u{fbb2}"
        case .textAlignCenterFilled: return "\u{fbb3}"
        case .textAlignCenterLight: return "\u{fbb4}"
        case .textAlignCenterRegular: return "\u{fbb5}"
        case .textAlignLeftBold: return "\u{fbb6}"
        case .textAlignLeftFilled: return "\u{fbb7}"
        case .textAlignLeftLight: return "\u{fbb8}"
        case .textAlignLeftRegular: return "\u{fbb9}"
        case .textAlignRightBold: return "\u{fbba}"
        case .textAlignRightFilled: return "\u{fbbb}"
        case .textAlignRightLight: return "\u{fbbc}"
        case .textAlignRightRegular: return "\u{fbbd}"
        case .textBold: return "\u{fbbe}"
        case .textBoxCursorLight: return "\u{fbbf}"
        case .textCodeBlockBold: return "\u{fbc0}"
        case .textCodeBlockLight: return "\u{fbc1}"
        case .textCodeBlockRegular: return "\u{fbc2}"
        case .textHighlightBold: return "\u{fbc3}"
        case .textHighlightFilled: return "\u{fbc4}"
        case .textHighlightLight: return "\u{fbc5}"
        case .textHighlightRegular: return "\u{fbc6}"
        case .textLight: return "\u{fbc7}"
        case .textRegular: return "\u{fbc8}"
        case .threeColumnBold: return "\u{fbc9}"
        case .threeColumnLight: return "\u{fbca}"
        case .threeColumnRegular: return "\u{fbcb}"
        case .threeDObjectBold: return "\u{fbcc}"
        case .threeDObjectLight: return "\u{fbcd}"
        case .threeDObjectRegular: return "\u{fbce}"
        case .timeExclusionBold: return "\u{fbcf}"
        case .timeExclusionLight: return "\u{fbd0}"
        case .timeExclusionRegular: return "\u{fbd1}"
        case .timezoneBold: return "\u{fbd2}"
        case .timezoneFilled: return "\u{fbd3}"
        case .timezoneLight: return "\u{fbd4}"
        case .timezoneRegular: return "\u{fbd5}"
        case .tooFastBold: return "\u{fbd6}"
        case .tooFastLight: return "\u{fbd7}"
        case .tooFastRegular: return "\u{fbd8}"
        case .tooSlowBold: return "\u{fbd9}"
        case .tooSlowLight: return "\u{fbda}"
        case .tooSlowRegular: return "\u{fbdb}"
        case .toolsBold: return "\u{fbdc}"
        case .toolsFilled: return "\u{fbdd}"
        case .toolsLight: return "\u{fbde}"
        case .toolsRegular: return "\u{fbdf}"
        case .touchTenBold: return "\u{fbe0}"
        case .touchTenLight: return "\u{fbe1}"
        case .touchTenRegular: return "\u{fbe2}"
        case .transcriptBold: return "\u{fbe3}"
        case .transcriptFilled: return "\u{fbe4}"
        case .transcriptLight: return "\u{fbe5}"
        case .transcriptRegular: return "\u{fbe6}"
        case .translateBold: return "\u{fbe7}"
        case .translateLight: return "\u{fbe8}"
        case .translateRegular: return "\u{fbe9}"
        case .translateUndoBold: return "\u{fbea}"
        case .translateUndoLight: return "\u{fbeb}"
        case .translateUndoRegular: return "\u{fbec}"
        case .trendingBold: return "\u{fbed}"
        case .trendingDownBold: return "\u{fbee}"
        case .trendingDownFilled: return "\u{fbef}"
        case .trendingDownLight: return "\u{fbf0}"
        case .trendingDownRegular: return "\u{fbf1}"
        case .trendingFilled: return "\u{fbf2}"
        case .trendingLight: return "\u{fbf3}"
        case .trendingRegular: return "\u{fbf4}"
        case .trimBold: return "\u{fbf5}"
        case .trimLight: return "\u{fbf6}"
        case .trimRegular: return "\u{fbf7}"
        case .twoColumnBold: return "\u{fbf8}"
        case .twoColumnLight: return "\u{fbf9}"
        case .twoColumnRegular: return "\u{fbfa}"
        case .twoWayVoiceStreamBold: return "\u{fbfb}"
        case .twoWayVoiceStreamFilled: return "\u{fbfc}"
        case .twoWayVoiceStreamLight: return "\u{fbfd}"
        case .twoWayVoiceStreamRegular: return "\u{fbfe}"
        case .ucmCloudBold: return "\u{fbff}"
        case .ucmCloudLight: return "\u{fc00}"
        case .ucmCloudRegular: return "\u{fc01}"
        case .unblockBold: return "\u{fc02}"
        case .unblockFilled: return "\u{fc03}"
        case .unblockLight: return "\u{fc04}"
        case .unblockRegular: return "\u{fc05}"
        case .underlineBold: return "\u{fc06}"
        case .underlineFilled: return "\u{fc07}"
        case .underlineLight: return "\u{fc08}"
        case .underlineRegular: return "\u{fc09}"
        case .undoBold: return "\u{fc0a}"
        case .undoLight: return "\u{fc0b}"
        case .undoRegular: return "\u{fc0c}"
        case .unlinkBold: return "\u{fc0d}"
        case .unlinkLight: return "\u{fc0e}"
        case .unlinkRegular: return "\u{fc0f}"
        case .unreadBold: return "\u{fc10}"
        case .unreadFilled: return "\u{fc11}"
        case .unreadLight: return "\u{fc12}"
        case .unreadRegular: return "\u{fc13}"
        case .unsecureUnlockedBold: return "\u{fc14}"
        case .unsecureUnlockedFilled: return "\u{fc15}"
        case .unsecureUnlockedLight: return "\u{fc16}"
        case .unsecureUnlockedRegular: return "\u{fc17}"
        case .unsortedBold: return "\u{fc18}"
        case .unsortedLight: return "\u{fc19}"
        case .unsortedRegular: return "\u{fc1a}"
        case .updateFileShareBold: return "\u{fc1b}"
        case .updateFileShareLight: return "\u{fc1c}"
        case .updateFileShareRegular: return "\u{fc1d}"
        case .uploadBold: return "\u{fc1e}"
        case .uploadImageBold: return "\u{fc1f}"
        case .uploadImageLight: return "\u{fc20}"
        case .uploadImageRegular: return "\u{fc21}"
        case .uploadLight: return "\u{fc22}"
        case .uploadRegular: return "\u{fc23}"
        case .urgentVoicemailBold: return "\u{fc24}"
        case .urgentVoicemailFilled: return "\u{fc25}"
        case .usbBold: return "\u{fc26}"
        case .usbHeadsetBold: return "\u{fc27}"
        case .usbHeadsetLight: return "\u{fc28}"
        case .usbHeadsetMutedBold: return "\u{fc29}"
        case .usbHeadsetMutedLight: return "\u{fc2a}"
        case .usbHeadsetMutedRegular: return "\u{fc2b}"
        case .usbHeadsetRegular: return "\u{fc2c}"
        case .usbLight: return "\u{fc2d}"
        case .usbRegular: return "\u{fc2e}"
        case .userBold: return "\u{fc2f}"
        case .userDeactivateBold: return "\u{fc30}"
        case .userDeactivateLight: return "\u{fc31}"
        case .userDeactivateRegular: return "\u{fc32}"
        case .userLight: return "\u{fc33}"
        case .userRegular: return "\u{fc34}"
        case .videoBlurBold: return "\u{fc35}"
        case .videoBlurFilled: return "\u{fc36}"
        case .videoBlurLight: return "\u{fc37}"
        case .videoBlurRegular: return "\u{fc38}"
        case .videoBold: return "\u{fc39}"
        case .videoEffectBold: return "\u{fc3a}"
        case .videoEffectFilled: return "\u{fc3b}"
        case .videoEffectLight: return "\u{fc3c}"
        case .videoEffectRegular: return "\u{fc3d}"
        case .videoFilled: return "\u{fc3e}"
        case .videoLayoutBold: return "\u{fc3f}"
        case .videoLayoutCustomBold: return "\u{fc40}"
        case .videoLayoutCustomFilled: return "\u{fc41}"
        case .videoLayoutCustomLight: return "\u{fc42}"
        case .videoLayoutCustomRegular: return "\u{fc43}"
        case .videoLayoutEqualBold: return "\u{fc44}"
        case .videoLayoutEqualDualBold: return "\u{fc45}"
        case .videoLayoutEqualDualLight: return "\u{fc46}"
        case .videoLayoutEqualDualRegular: return "\u{fc47}"
        case .videoLayoutEqualFilled: return "\u{fc48}"
        case .videoLayoutEqualLight: return "\u{fc49}"
        case .videoLayoutEqualRegular: return "\u{fc4a}"
        case .videoLayoutFilled: return "\u{fc4b}"
        case .videoLayoutLight: return "\u{fc4c}"
        case .videoLayoutOverlayBold: return "\u{fc4d}"
        case .videoLayoutOverlayFilled: return "\u{fc4e}"
        case .videoLayoutOverlayLight: return "\u{fc4f}"
        case .videoLayoutOverlayRegular: return "\u{fc50}"
        case .videoLayoutPresentationBold: return "\u{fc51}"
        case .videoLayoutPresentationFilled: return "\u{fc52}"
        case .videoLayoutPresentationLight: return "\u{fc53}"
        case .videoLayoutPresentationRegular: return "\u{fc54}"
        case .videoLayoutPresenterDominantBold: return "\u{fc55}"
        case .videoLayoutPresenterDominantLight: return "\u{fc56}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc57}"
        case .videoLayoutProminentBold: return "\u{fc58}"
        case .videoLayoutProminentFilled: return "\u{fc59}"
        case .videoLayoutProminentLight: return "\u{fc5a}"
        case .videoLayoutProminentRegular: return "\u{fc5b}"
        case .videoLayoutRegular: return "\u{fc5c}"
        case .videoLayoutShareDominantBold: return "\u{fc5d}"
        case .videoLayoutShareDominantLight: return "\u{fc5e}"
        case .videoLayoutShareDominantRegular: return "\u{fc5f}"
        case .videoLayoutSingleBold: return "\u{fc60}"
        case .videoLayoutSingleFilled: return "\u{fc61}"
        case .videoLayoutSingleLight: return "\u{fc62}"
        case .videoLayoutSingleRegular: return "\u{fc63}"
        case .videoLayoutSpeakerBold: return "\u{fc64}"
        case .videoLayoutSpeakerFilled: return "\u{fc65}"
        case .videoLayoutSpeakerLight: return "\u{fc66}"
        case .videoLayoutSpeakerRegular: return "\u{fc67}"
        case .videoLayoutStackBold: return "\u{fc68}"
        case .videoLayoutStackFilled: return "\u{fc69}"
        case .videoLayoutStackLight: return "\u{fc6a}"
        case .videoLayoutStackRegular: return "\u{fc6b}"
        case .videoLayoutVideoDominantBold: return "\u{fc6c}"
        case .videoLayoutVideoDominantFilled: return "\u{fc6d}"
        case .videoLayoutVideoDominantLight: return "\u{fc6e}"
        case .videoLayoutVideoDominantRegular: return "\u{fc6f}"
        case .videoLight: return "\u{fc70}"
        case .videoPlusBold: return "\u{fc71}"
        case .videoPlusFilled: return "\u{fc72}"
        case .videoPlusLight: return "\u{fc73}"
        case .videoPlusRegular: return "\u{fc74}"
        case .videoRegular: return "\u{fc75}"
        case .videoSpeakerTrackBold: return "\u{fc76}"
        case .videoSpeakerTrackFilled: return "\u{fc77}"
        case .videoSpeakerTrackLight: return "\u{fc78}"
        case .videoSpeakerTrackRegular: return "\u{fc79}"
        case .viewAllBold: return "\u{fc7a}"
        case .viewAllLight: return "\u{fc7b}"
        case .viewAllRegular: return "\u{fc7c}"
        case .viewListBold: return "\u{fc7d}"
        case .viewListFilled: return "\u{fc7e}"
        case .viewListLight: return "\u{fc7f}"
        case .viewListRegular: return "\u{fc80}"
        case .viewStackedBold: return "\u{fc81}"
        case .viewStackedFilled: return "\u{fc82}"
        case .viewStackedLight: return "\u{fc83}"
        case .viewStackedRegular: return "\u{fc84}"
        case .viewThumbnailBold: return "\u{fc85}"
        case .viewThumbnailFilled: return "\u{fc86}"
        case .viewThumbnailLight: return "\u{fc87}"
        case .viewThumbnailRegular: return "\u{fc88}"
        case .visionproBold: return "\u{fc89}"
        case .visionproFilled: return "\u{fc8a}"
        case .visionproLight: return "\u{fc8b}"
        case .visionproMoveCallInBold: return "\u{fc8c}"
        case .visionproMoveCallInFilled: return "\u{fc8d}"
        case .visionproMoveCallInLight: return "\u{fc8e}"
        case .visionproMoveCallInOutBold: return "\u{fc8f}"
        case .visionproMoveCallInOutFilled: return "\u{fc90}"
        case .visionproMoveCallInOutLight: return "\u{fc91}"
        case .visionproMoveCallInOutRegular: return "\u{fc92}"
        case .visionproMoveCallInRegular: return "\u{fc93}"
        case .visionproMoveCallOutBold: return "\u{fc94}"
        case .visionproMoveCallOutFilled: return "\u{fc95}"
        case .visionproMoveCallOutLight: return "\u{fc96}"
        case .visionproMoveCallOutRegular: return "\u{fc97}"
        case .visionproRegular: return "\u{fc98}"
        case .voicemailBold: return "\u{fc99}"
        case .voicemailFilled: return "\u{fc9a}"
        case .voicemailLight: return "\u{fc9b}"
        case .voicemailRegular: return "\u{fc9c}"
        case .vpnBold: return "\u{fc9d}"
        case .vpnFilled: return "\u{fc9e}"
        case .vpnLight: return "\u{fc9f}"
        case .vpnRegular: return "\u{fca0}"
        case .vscBold: return "\u{fca1}"
        case .vscLight: return "\u{fca2}"
        case .vscRegular: return "\u{fca3}"
        case .waffleMenuBold: return "\u{fca4}"
        case .waffleMenuLight: return "\u{fca5}"
        case .waffleMenuRegular: return "\u{fca6}"
        case .waitingRoomBold: return "\u{fca7}"
        case .waitingRoomLight: return "\u{fca8}"
        case .waitingRoomRegular: return "\u{fca9}"
        case .wallpaperBold: return "\u{fcaa}"
        case .wallpaperLight: return "\u{fcab}"
        case .wallpaperRegular: return "\u{fcac}"
        case .warningBadgeFilled: return "\u{fcad}"
        case .warningBold: return "\u{fcae}"
        case .warningFilled: return "\u{fcaf}"
        case .warningLight: return "\u{fcb0}"
        case .warningRegular: return "\u{fcb1}"
        case .webexBoardBold: return "\u{fcb2}"
        case .webexBoardLight: return "\u{fcb3}"
        case .webexBoardRegular: return "\u{fcb4}"
        case .webexCodecPlusBold: return "\u{fcb5}"
        case .webexCodecPlusLight: return "\u{fcb6}"
        case .webexCodecPlusRegular: return "\u{fcb7}"
        case .webexDeskCameraBold: return "\u{fcb8}"
        case .webexDeskCameraLight: return "\u{fcb9}"
        case .webexDeskCameraRegular: return "\u{fcba}"
        case .webexHelixBold: return "\u{fcbb}"
        case .webexHelixLight: return "\u{fcbc}"
        case .webexHelixRegular: return "\u{fcbd}"
        case .webexMeetingsBold: return "\u{fcbe}"
        case .webexMeetingsFilled: return "\u{fcbf}"
        case .webexMeetingsLight: return "\u{fcc0}"
        case .webexMeetingsRegular: return "\u{fcc1}"
        case .webexQuadCameraBold: return "\u{fcc2}"
        case .webexQuadCameraLight: return "\u{fcc3}"
        case .webexQuadCameraRegular: return "\u{fcc4}"
        case .webexRoomKitBold: return "\u{fcc5}"
        case .webexRoomKitLight: return "\u{fcc6}"
        case .webexRoomKitPlusBold: return "\u{fcc7}"
        case .webexRoomKitPlusLight: return "\u{fcc8}"
        case .webexRoomKitPlusRegular: return "\u{fcc9}"
        case .webexRoomKitRegular: return "\u{fcca}"
        case .webexShareBold: return "\u{fccb}"
        case .webexShareLight: return "\u{fccc}"
        case .webexShareRegular: return "\u{fccd}"
        case .webexTeamsBold: return "\u{fcce}"
        case .webexTeamsFilled: return "\u{fccf}"
        case .webexTeamsLight: return "\u{fcd0}"
        case .webexTeamsNewBold: return "\u{fcd1}"
        case .webexTeamsNewFilled: return "\u{fcd2}"
        case .webexTeamsNewLight: return "\u{fcd3}"
        case .webexTeamsNewRegular: return "\u{fcd4}"
        case .webexTeamsRegular: return "\u{fcd5}"
        case .webexTeamsRemoveBold: return "\u{fcd6}"
        case .webexTeamsRemoveLight: return "\u{fcd7}"
        case .webexTeamsRemoveRegular: return "\u{fcd8}"
        case .webhookBold: return "\u{fcd9}"
        case .webhookLight: return "\u{fcda}"
        case .webhookRegular: return "\u{fcdb}"
        case .webinarBold: return "\u{fcdc}"
        case .webinarFilled: return "\u{fcdd}"
        case .webinarLight: return "\u{fcde}"
        case .webinarRegular: return "\u{fcdf}"
        case .weeklyRecurringScheduleBold: return "\u{fce0}"
        case .weeklyRecurringScheduleLight: return "\u{fce1}"
        case .weeklyRecurringScheduleRegular: return "\u{fce2}"
        case .whisperAnnouncementBold: return "\u{fce3}"
        case .whisperAnnouncementFilled: return "\u{fce4}"
        case .whisperAnnouncementLight: return "\u{fce5}"
        case .whisperAnnouncementRegular: return "\u{fce6}"
        case .whisperCoachBold: return "\u{fce7}"
        case .whisperCoachFilled: return "\u{fce8}"
        case .whisperCoachLight: return "\u{fce9}"
        case .whisperCoachRegular: return "\u{fcea}"
        case .whiteboardBold: return "\u{fceb}"
        case .whiteboardContentBold: return "\u{fcec}"
        case .whiteboardContentFilled: return "\u{fced}"
        case .whiteboardContentLight: return "\u{fcee}"
        case .whiteboardContentRegular: return "\u{fcef}"
        case .whiteboardFilled: return "\u{fcf0}"
        case .whiteboardLight: return "\u{fcf1}"
        case .whiteboardRegular: return "\u{fcf2}"
        case .widgetBold: return "\u{fcf3}"
        case .widgetFilled: return "\u{fcf4}"
        case .widgetLight: return "\u{fcf5}"
        case .widgetRegular: return "\u{fcf6}"
        case .wifiBold: return "\u{fcf7}"
        case .wifiErrorBold: return "\u{fcf8}"
        case .wifiErrorLight: return "\u{fcf9}"
        case .wifiErrorRegular: return "\u{fcfa}"
        case .wifiLight: return "\u{fcfb}"
        case .wifiRegular: return "\u{fcfc}"
        case .wifiSignalGoodBold: return "\u{fcfd}"
        case .wifiSignalGoodLight: return "\u{fcfe}"
        case .wifiSignalGoodRegular: return "\u{fcff}"
        case .wifiSignalPoorBold: return "\u{fd00}"
        case .wifiSignalPoorLight: return "\u{fd01}"
        case .wifiSignalPoorRegular: return "\u{fd02}"
        case .wifiSignalUnstableBold: return "\u{fd03}"
        case .wifiSignalUnstableLight: return "\u{fd04}"
        case .wifiSignalUnstableRegular: return "\u{fd05}"
        case .windowCornerScrubBold: return "\u{fd06}"
        case .windowCornerScrubLight: return "\u{fd07}"
        case .windowCornerScrubRegular: return "\u{fd08}"
        case .windowRightCornerScrubBold: return "\u{fd09}"
        case .windowRightCornerScrubLight: return "\u{fd0a}"
        case .windowRightCornerScrubRegular: return "\u{fd0b}"
        case .windowVerticalScrubBold: return "\u{fd0c}"
        case .windowVerticalScrubLight: return "\u{fd0d}"
        case .windowVerticalScrubRegular: return "\u{fd0e}"
        case .workflowDeploymentsBold: return "\u{fd0f}"
        case .workflowDeploymentsFilled: return "\u{fd10}"
        case .workflowDeploymentsLight: return "\u{fd11}"
        case .workflowDeploymentsRegular: return "\u{fd12}"
        case .workphoneBold: return "\u{fd13}"
        case .workphoneLight: return "\u{fd14}"
        case .workphoneRegular: return "\u{fd15}"
        case .zoomInBold: return "\u{fd16}"
        case .zoomInLight: return "\u{fd17}"
        case .zoomInRegular: return "\u{fd18}"
        case .zoomOutBold: return "\u{fd19}"
        case .zoomOutLight: return "\u{fd1a}"
        case .zoomOutRegular: return "\u{fd1b}"
