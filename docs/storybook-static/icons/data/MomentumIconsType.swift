...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .mediaQualityPoorFilled: return "\u{f73d}"
        case .mediaQualityPoorLight: return "\u{f73e}"
        case .mediaQualityPoorRegular: return "\u{f73f}"
        case .mediaQualityUnstableBold: return "\u{f740}"
        case .mediaQualityUnstableFilled: return "\u{f741}"
        case .mediaQualityUnstableLight: return "\u{f742}"
        case .mediaQualityUnstableRegular: return "\u{f743}"
        case .meetBold: return "\u{f744}"
        case .meetEndBold: return "\u{f745}"
        case .meetEndLight: return "\u{f746}"
        case .meetEndRegular: return "\u{f747}"
        case .meetFilled: return "\u{f748}"
        case .meetLight: return "\u{f749}"
        case .meetRegular: return "\u{f74a}"
        case .meetingSummaryBold: return "\u{f74b}"
        case .meetingSummaryFilled: return "\u{f74c}"
        case .meetingSummaryLight: return "\u{f74d}"
        case .meetingSummaryRegular: return "\u{f74e}"
        case .meetingsBold: return "\u{f74f}"
        case .meetingsFilled: return "\u{f750}"
        case .meetingsFocusMonthBold: return "\u{f751}"
        case .meetingsFocusMonthLight: return "\u{f752}"
        case .meetingsFocusMonthRegular: return "\u{f753}"
        case .meetingsFocusOneDayBold: return "\u{f754}"
        case .meetingsFocusOneDayLight: return "\u{f755}"
        case .meetingsFocusOneDayRegular: return "\u{f756}"
        case .meetingsFocusThreeDayBold: return "\u{f757}"
        case .meetingsFocusThreeDayLight: return "\u{f758}"
        case .meetingsFocusThreeDayRegular: return "\u{f759}"
        case .meetingsFocusUpcomingBold: return "\u{f75a}"
        case .meetingsFocusUpcomingLight: return "\u{f75b}"
        case .meetingsFocusUpcomingRegular: return "\u{f75c}"
        case .meetingsLight: return "\u{f75d}"
        case .meetingsPresenceBadgeFilled: return "\u{f75e}"
        case .meetingsPresenceBold: return "\u{f75f}"
        case .meetingsPresenceFilled: return "\u{f760}"
        case .meetingsPresenceLight: return "\u{f761}"
        case .meetingsPresenceRegular: return "\u{f762}"
        case .meetingsRegular: return "\u{f763}"
        case .meetingsTeamBold: return "\u{f764}"
        case .meetingsTeamFilled: return "\u{f765}"
        case .meetingsTeamLight: return "\u{f766}"
        case .meetingsTeamNewBold: return "\u{f767}"
        case .meetingsTeamNewLight: return "\u{f768}"
        case .meetingsTeamNewRegular: return "\u{f769}"
        case .meetingsTeamRegular: return "\u{f76a}"
        case .mentionBold: return "\u{f76b}"
        case .mentionLight: return "\u{f76c}"
        case .mentionRegular: return "\u{f76d}"
        case .messageQueingBold: return "\u{f76e}"
        case .messageQueingLight: return "\u{f76f}"
        case .messageQueingRegular: return "\u{f770}"
        case .microphoneBold: return "\u{f771}"
        case .microphoneFilled: return "\u{f772}"
        case .microphoneHardMutedBold: return "\u{f773}"
        case .microphoneHardMutedCircleFilled: return "\u{f774}"
        case .microphoneHardMutedLight: return "\u{f775}"
        case .microphoneHardMutedRegular: return "\u{f776}"
        case .microphoneLight: return "\u{f777}"
        case .microphoneMusicModeBold: return "\u{f778}"
        case .microphoneMusicModeLight: return "\u{f779}"
        case .microphoneMusicModeOnBold: return "\u{f77a}"
        case .microphoneMusicModeOnLight: return "\u{f77b}"
        case .microphoneMusicModeOnRegular: return "\u{f77c}"
        case .microphoneMusicModeRegular: return "\u{f77d}"
        case .microphoneMutedBold: return "\u{f77e}"
        case .microphoneMutedCircleFilled: return "\u{f77f}"
        case .microphoneMutedFilled: return "\u{f780}"
        case .microphoneMutedLight: return "\u{f781}"
        case .microphoneMutedRegular: return "\u{f782}"
        case .microphoneOnBold: return "\u{f783}"
        case .microphoneOnLight: return "\u{f784}"
        case .microphoneOnRegular: return "\u{f785}"
        case .microphoneOptAllBold: return "\u{f786}"
        case .microphoneOptAllLight: return "\u{f787}"
        case .microphoneOptAllMutedBold: return "\u{f788}"
        case .microphoneOptAllMutedLight: return "\u{f789}"
        case .microphoneOptAllMutedRegular: return "\u{f78a}"
        case .microphoneOptAllOnBold: return "\u{f78b}"
        case .microphoneOptAllOnLight: return "\u{f78c}"
        case .microphoneOptAllOnRegular: return "\u{f78d}"
        case .microphoneOptAllRegular: return "\u{f78e}"
        case .microphoneOptMeBold: return "\u{f78f}"
        case .microphoneOptMeLight: return "\u{f790}"
        case .microphoneOptMeMutedBold: return "\u{f791}"
        case .microphoneOptMeMutedLight: return "\u{f792}"
        case .microphoneOptMeMutedRegular: return "\u{f793}"
        case .microphoneOptMeOnBold: return "\u{f794}"
        case .microphoneOptMeOnLight: return "\u{f795}"
        case .microphoneOptMeOnRegular: return "\u{f796}"
        case .microphoneOptMeRegular: return "\u{f797}"
        case .microphoneRegular: return "\u{f798}"
        case .mindMapBold: return "\u{f799}"
        case .mindMapLight: return "\u{f79a}"
        case .mindMapRegular: return "\u{f79b}"
        case .minimizeBold: return "\u{f79c}"
        case .minimizeLight: return "\u{f79d}"
        case .minimizeRegular: return "\u{f79e}"
        case .minusBold: return "\u{f79f}"
        case .minusLight: return "\u{f7a0}"
        case .minusRegular: return "\u{f7a1}"
        case .mirrorBold: return "\u{f7a2}"
        case .mirrorFilled: return "\u{f7a3}"
        case .mirrorLight: return "\u{f7a4}"
        case .mirrorRegular: return "\u{f7a5}"
        case .mmsFilled: return "\u{f7a6}"
        case .moderatorBold: return "\u{f7a7}"
        case .moderatorLight: return "\u{f7a8}"
        case .moderatorRegular: return "\u{f7a9}"
        case .monitoringBold: return "\u{f7aa}"
        case .monitoringLight: return "\u{f7ab}"
        case .monitoringRegular: return "\u{f7ac}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7ad}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7ae}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7af}"
        case .moreAdrBold: return "\u{f7b0}"
        case .moreAdrLight: return "\u{f7b1}"
        case .moreAdrRegular: return "\u{f7b2}"
        case .moreBold: return "\u{f7b3}"
        case .moreCircleBold: return "\u{f7b4}"
        case .moreCircleFilled: return "\u{f7b5}"
        case .moreCircleLight: return "\u{f7b6}"
        case .moreCircleRegular: return "\u{f7b7}"
        case .moreLight: return "\u{f7b8}"
        case .moreRegular: return "\u{f7b9}"
        case .mouseCursorBold: return "\u{f7ba}"
        case .mouseCursorLight: return "\u{f7bb}"
        case .mouseCursorRegular: return "\u{f7bc}"
        case .moveCallInAdrBold: return "\u{f7bd}"
        case .moveCallInAdrLight: return "\u{f7be}"
        case .moveCallInAdrRegular: return "\u{f7bf}"
        case .moveCallInIphBold: return "\u{f7c0}"
        case .moveCallInIphLight: return "\u{f7c1}"
        case .moveCallInIphRegular: return "\u{f7c2}"
        case .moveCallInLaptopBold: return "\u{f7c3}"
        case .moveCallInLaptopLight: return "\u{f7c4}"
        case .moveCallInLaptopRegular: return "\u{f7c5}"
        case .moveCallInOutAdrBold: return "\u{f7c6}"
        case .moveCallInOutAdrLight: return "\u{f7c7}"
        case .moveCallInOutAdrRegular: return "\u{f7c8}"
        case .moveCallInOutIphBold: return "\u{f7c9}"
        case .moveCallInOutIphLight: return "\u{f7ca}"
        case .moveCallInOutIphRegular: return "\u{f7cb}"
        case .moveCallInTabletBold: return "\u{f7cc}"
        case .moveCallInTabletLight: return "\u{f7cd}"
        case .moveCallInTabletRegular: return "\u{f7ce}"
        case .moveCallOutAdrBold: return "\u{f7cf}"
        case .moveCallOutAdrLight: return "\u{f7d0}"
        case .moveCallOutAdrRegular: return "\u{f7d1}"
        case .moveCallOutIphBold: return "\u{f7d2}"
        case .moveCallOutIphLight: return "\u{f7d3}"
        case .moveCallOutIphRegular: return "\u{f7d4}"
        case .moveCallOutLaptopBold: return "\u{f7d5}"
        case .moveCallOutLaptopLight: return "\u{f7d6}"
        case .moveCallOutLaptopRegular: return "\u{f7d7}"
        case .moveCallOutTabletBold: return "\u{f7d8}"
        case .moveCallOutTabletLight: return "\u{f7d9}"
        case .moveCallOutTabletRegular: return "\u{f7da}"
        case .moveToScreenBold: return "\u{f7db}"
        case .moveToScreenLight: return "\u{f7dc}"
        case .moveToScreenRegular: return "\u{f7dd}"
        case .multilineChartBold: return "\u{f7de}"
        case .multilineChartFilled: return "\u{f7df}"
        case .multilineChartLight: return "\u{f7e0}"
        case .multilineChartRegular: return "\u{f7e1}"
        case .multimediaBold: return "\u{f7e2}"
        case .multimediaFilled: return "\u{f7e3}"
        case .multimediaLight: return "\u{f7e4}"
        case .multimediaRegular: return "\u{f7e5}"
        case .multipledDevicesBold: return "\u{f7e6}"
        case .multipledDevicesLight: return "\u{f7e7}"
        case .multipledDevicesRegular: return "\u{f7e8}"
        case .musicModeCircleBold: return "\u{f7e9}"
        case .musicModeCircleFilled: return "\u{f7ea}"
        case .musicModeCircleLight: return "\u{f7eb}"
        case .musicModeCircleRegular: return "\u{f7ec}"
        case .musicNoteBold: return "\u{f7ed}"
        case .musicNoteFilled: return "\u{f7ee}"
        case .musicNoteLight: return "\u{f7ef}"
        case .musicNoteRegular: return "\u{f7f0}"
        case .muteOnEntryBold: return "\u{f7f1}"
        case .muteOnEntryFilled: return "\u{f7f2}"
        case .muteOnEntryLight: return "\u{f7f3}"
        case .muteOnEntryRegular: return "\u{f7f4}"
        case .newManagerBold: return "\u{f7f5}"
        case .newManagerLight: return "\u{f7f6}"
        case .newManagerRegular: return "\u{f7f7}"
        case .newTitleBold: return "\u{f7f8}"
        case .newTitleLight: return "\u{f7f9}"
        case .newTitleRegular: return "\u{f7fa}"
        case .newVoicemailBold: return "\u{f7fb}"
        case .newVoicemailLight: return "\u{f7fc}"
        case .newVoicemailRegular: return "\u{f7fd}"
        case .newWhiteboardBold: return "\u{f7fe}"
        case .newWhiteboardLight: return "\u{f7ff}"
        case .newWhiteboardRegular: return "\u{f800}"
        case .nextBold: return "\u{f801}"
        case .nextLight: return "\u{f802}"
        case .nextRegular: return "\u{f803}"
        case .noDevicesBold: return "\u{f804}"
        case .noDevicesLight: return "\u{f805}"
        case .noDevicesRegular: return "\u{f806}"
        case .noiseDetectedCanceledFilled: return "\u{f807}"
        case .noiseDetectedFilled: return "\u{f808}"
        case .noiseNoneCanceledFilled: return "\u{f809}"
        case .noiseNoneFilled: return "\u{f80a}"
        case .noiseRemovalBold: return "\u{f80b}"
        case .noiseRemovalLight: return "\u{f80c}"
        case .noiseRemovalRegular: return "\u{f80d}"
        case .noteBold: return "\u{f80e}"
        case .noteLight: return "\u{f80f}"
        case .notePptBold: return "\u{f810}"
        case .notePptLight: return "\u{f811}"
        case .notePptRegular: return "\u{f812}"
        case .noteRegular: return "\u{f813}"
        case .notesBold: return "\u{f814}"
        case .notesFilled: return "\u{f815}"
        case .notesLight: return "\u{f816}"
        case .notesRegular: return "\u{f817}"
        case .numberBold: return "\u{f818}"
        case .numberLight: return "\u{f819}"
        case .numberRegular: return "\u{f81a}"
        case .oldRemoteBold: return "\u{f81b}"
        case .oldRemoteLight: return "\u{f81c}"
        case .oldRemoteRegular: return "\u{f81d}"
        case .oldTouchBold: return "\u{f81e}"
        case .oldTouchLight: return "\u{f81f}"
        case .oldTouchRegular: return "\u{f820}"
        case .oneColumnBold: return "\u{f821}"
        case .oneColumnLight: return "\u{f822}"
        case .oneColumnRegular: return "\u{f823}"
        case .oneTimeBold: return "\u{f824}"
        case .oneTimeLight: return "\u{f825}"
        case .oneTimeRegular: return "\u{f826}"
        case .openInFolderBold: return "\u{f827}"
        case .openInFolderLight: return "\u{f828}"
        case .openInFolderRegular: return "\u{f829}"
        case .openPagesBold: return "\u{f82a}"
        case .openPagesLight: return "\u{f82b}"
        case .openPagesRegular: return "\u{f82c}"
        case .otherNumberBold: return "\u{f82d}"
        case .otherNumberFilled: return "\u{f82e}"
        case .otherNumberLight: return "\u{f82f}"
        case .otherNumberRegular: return "\u{f830}"
        case .otherNumberWarningBold: return "\u{f831}"
        case .otherNumberWarningLight: return "\u{f832}"
        case .otherNumberWarningRegular: return "\u{f833}"
        case .outgoingCallLegacyBold: return "\u{f834}"
        case .outgoingCallLegacyFilled: return "\u{f835}"
        case .outgoingCallLegacyLight: return "\u{f836}"
        case .outgoingCallLegacyRegular: return "\u{f837}"
        case .overflowLeftBold: return "\u{f838}"
        case .overflowLeftLight: return "\u{f839}"
        case .overflowLeftRegular: return "\u{f83a}"
        case .overflowRightBold: return "\u{f83b}"
        case .overflowRightLight: return "\u{f83c}"
        case .overflowRightRegular: return "\u{f83d}"
        case .pairedCameraBold: return "\u{f83e}"
        case .pairedCameraLight: return "\u{f83f}"
        case .pairedCameraRegular: return "\u{f840}"
        case .pairedDeviceBold: return "\u{f841}"
        case .pairedDeviceLight: return "\u{f842}"
        case .pairedDeviceRegular: return "\u{f843}"
        case .pairedHandsetBold: return "\u{f844}"
        case .pairedHandsetLight: return "\u{f845}"
        case .pairedHandsetRegular: return "\u{f846}"
        case .pairingBold: return "\u{f847}"
        case .pairingLight: return "\u{f848}"
        case .pairingRegular: return "\u{f849}"
        case .parenthesisBold: return "\u{f84a}"
        case .parenthesisFilled: return "\u{f84b}"
        case .parenthesisLight: return "\u{f84c}"
        case .parenthesisRegular: return "\u{f84d}"
        case .parkedBold: return "\u{f84e}"
        case .parkedFilled: return "\u{f84f}"
        case .parkedLight: return "\u{f850}"
        case .parkedRegular: return "\u{f851}"
        case .parseBold: return "\u{f852}"
        case .parseLight: return "\u{f853}"
        case .parseRegular: return "\u{f854}"
        case .partialBold: return "\u{f855}"
        case .partialLight: return "\u{f856}"
        case .partialRegular: return "\u{f857}"
        case .participantAddBold: return "\u{f858}"
        case .participantAddLight: return "\u{f859}"
        case .participantAddRegular: return "\u{f85a}"
        case .participantBlockedBold: return "\u{f85b}"
        case .participantBlockedLight: return "\u{f85c}"
        case .participantBlockedRegular: return "\u{f85d}"
        case .participantBold: return "\u{f85e}"
        case .participantFilled: return "\u{f85f}"
        case .participantLight: return "\u{f860}"
        case .participantListBold: return "\u{f861}"
        case .participantListFilled: return "\u{f862}"
        case .participantListLight: return "\u{f863}"
        case .participantListRegular: return "\u{f864}"
        case .participantRegular: return "\u{f865}"
        case .participantRemoveBold: return "\u{f866}"
        case .participantRemoveLight: return "\u{f867}"
        case .participantRemoveRegular: return "\u{f868}"
        case .participantUnknownBold: return "\u{f869}"
        case .participantUnknownLight: return "\u{f86a}"
        case .participantUnknownRegular: return "\u{f86b}"
        case .passMouseBold: return "\u{f86c}"
        case .passMouseLight: return "\u{f86d}"
        case .passMouseRegular: return "\u{f86e}"
        case .pauseBadgeFilled: return "\u{f86f}"
        case .pauseBold: return "\u{f870}"
        case .pauseFilled: return "\u{f871}"
        case .pauseLight: return "\u{f872}"
        case .pauseRegular: return "\u{f873}"
        case .peopleAddBold: return "\u{f874}"
        case .peopleAddFilled: return "\u{f875}"
        case .peopleAddLight: return "\u{f876}"
        case .peopleAddRegular: return "\u{f877}"
        case .peopleBold: return "\u{f878}"
        case .peopleCircleBold: return "\u{f879}"
        case .peopleCircleFilled: return "\u{f87a}"
        case .peopleCircleLight: return "\u{f87b}"
        case .peopleCircleRegular: return "\u{f87c}"
        case .peopleFilled: return "\u{f87d}"
        case .peopleInsightsBold: return "\u{f87e}"
        case .peopleInsightsFilled: return "\u{f87f}"
        case .peopleInsightsLight: return "\u{f880}"
        case .peopleInsightsRegular: return "\u{f881}"
        case .peopleLight: return "\u{f882}"
        case .peopleRegular: return "\u{f883}"
        case .phoneAlertBold: return "\u{f884}"
        case .phoneAlertLight: return "\u{f885}"
        case .phoneAlertRegular: return "\u{f886}"
        case .phoneBadgeFilled: return "\u{f887}"
        case .phoneBold: return "\u{f888}"
        case .phoneFilled: return "\u{f889}"
        case .phoneLight: return "\u{f88a}"
        case .phoneMutedBold: return "\u{f88b}"
        case .phoneMutedLight: return "\u{f88c}"
        case .phoneMutedRegular: return "\u{f88d}"
        case .phonePrivateBold: return "\u{f88e}"
        case .phonePrivateLight: return "\u{f88f}"
        case .phonePrivateRegular: return "\u{f890}"
        case .phoneRegular: return "\u{f891}"
        case .phoneReplyAllBold: return "\u{f892}"
        case .phoneReplyAllLight: return "\u{f893}"
        case .phoneReplyAllRegular: return "\u{f894}"
        case .phoneReplyBold: return "\u{f895}"
        case .phoneReplyLight: return "\u{f896}"
        case .phoneReplyRegular: return "\u{f897}"
        case .pickerBold: return "\u{f898}"
        case .pickerLight: return "\u{f899}"
        case .pickerRegular: return "\u{f89a}"
        case .pieChartBold: return "\u{f89b}"
        case .pieChartFilled: return "\u{f89c}"
        case .pieChartLight: return "\u{f89d}"
        case .pieChartRegular: return "\u{f89e}"
        case .pinBold: return "\u{f89f}"
        case .pinFilled: return "\u{f8a0}"
        case .pinLight: return "\u{f8a1}"
        case .pinListActivityBold: return "\u{f8a2}"
        case .pinListActivityLight: return "\u{f8a3}"
        case .pinListActivityRegular: return "\u{f8a4}"
        case .pinListBold: return "\u{f8a5}"
        case .pinListLight: return "\u{f8a6}"
        case .pinListRegular: return "\u{f8a7}"
        case .pinMutedBold: return "\u{f8a8}"
        case .pinMutedFilled: return "\u{f8a9}"
        case .pinMutedLight: return "\u{f8aa}"
        case .pinMutedRegular: return "\u{f8ab}"
        case .pinRegular: return "\u{f8ac}"
        case .pipBold: return "\u{f8ad}"
        case .pipEnterBold: return "\u{f8ae}"
        case .pipEnterLight: return "\u{f8af}"
        case .pipEnterRegular: return "\u{f8b0}"
        case .pipExitBold: return "\u{f8b1}"
        case .pipExitLight: return "\u{f8b2}"
        case .pipExitRegular: return "\u{f8b3}"
        case .pipFilled: return "\u{f8b4}"
        case .pipLight: return "\u{f8b5}"
        case .pipRegular: return "\u{f8b6}"
        case .placeholderBold: return "\u{f8b7}"
        case .placeholderFilled: return "\u{f8b8}"
        case .placeholderLight: return "\u{f8b9}"
        case .placeholderRegular: return "\u{f8ba}"
        case .playBold: return "\u{f8bb}"
        case .playCircleBold: return "\u{f8bc}"
        case .playCircleFilled: return "\u{f8bd}"
        case .playCircleLight: return "\u{f8be}"
        case .playCircleRegular: return "\u{f8bf}"
        case .playFilled: return "\u{f8c0}"
        case .playLight: return "\u{f8c1}"
        case .playRegular: return "\u{f8c2}"
        case .plugAcBold: return "\u{f8c3}"
        case .plugAcLight: return "\u{f8c4}"
        case .plugAcRegular: return "\u{f8c5}"
        case .plusBold: return "\u{f8c6}"
        case .plusCircleBold: return "\u{f8c7}"
        case .plusCircleFilled: return "\u{f8c8}"
        case .plusCircleLight: return "\u{f8c9}"
        case .plusCircleRegular: return "\u{f8ca}"
        case .plusLight: return "\u{f8cb}"
        case .plusRegular: return "\u{f8cc}"
        case .pmrBold: return "\u{f8cd}"
        case .pmrFilled: return "\u{f8ce}"
        case .pmrLight: return "\u{f8cf}"
        case .pmrRegular: return "\u{f8d0}"
        case .pollBold: return "\u{f8d1}"
        case .pollFilled: return "\u{f8d2}"
        case .pollLight: return "\u{f8d3}"
        case .pollRegular: return "\u{f8d4}"
        case .popInBold: return "\u{f8d5}"
        case .popInLight: return "\u{f8d6}"
        case .popInRegular: return "\u{f8d7}"
        case .popOutBold: return "\u{f8d8}"
        case .popOutLight: return "\u{f8d9}"
        case .popOutRegular: return "\u{f8da}"
        case .popUpBold: return "\u{f8db}"
        case .popUpLight: return "\u{f8dc}"
        case .popUpRegular: return "\u{f8dd}"
        case .portraitLandscapeBold: return "\u{f8de}"
        case .portraitLandscapeLight: return "\u{f8df}"
        case .portraitLandscapeRegular: return "\u{f8e0}"
        case .potentialFraudBold: return "\u{f8e1}"
        case .potentialFraudFilled: return "\u{f8e2}"
        case .potentialFraudLight: return "\u{f8e3}"
        case .potentialFraudRegular: return "\u{f8e4}"
        case .powerAcBold: return "\u{f8e5}"
        case .powerAcLight: return "\u{f8e6}"
        case .powerAcRegular: return "\u{f8e7}"
        case .powerBold: return "\u{f8e8}"
        case .powerLight: return "\u{f8e9}"
        case .powerRegular: return "\u{f8ea}"
        case .preHeaderBold: return "\u{f8eb}"
        case .preHeaderLight: return "\u{f8ec}"
        case .preHeaderRegular: return "\u{f8ed}"
        case .premiumBold: return "\u{f8ee}"
        case .premiumLight: return "\u{f8ef}"
        case .premiumRegular: return "\u{f8f0}"
        case .presentationBold: return "\u{f8f1}"
        case .presentationLight: return "\u{f8f2}"
        case .presentationRegular: return "\u{f8f3}"
        case .preventDownloadBold: return "\u{f8f4}"
        case .preventDownloadFilled: return "\u{f8f5}"
        case .preventDownloadLight: return "\u{f8f6}"
        case .preventDownloadRegular: return "\u{f8f7}"
        case .primaryParticipantBold: return "\u{f8f8}"
        case .primaryParticipantFilled: return "\u{f8f9}"
        case .primaryParticipantLight: return "\u{f8fa}"
        case .primaryParticipantRegular: return "\u{f8fb}"
        case .printBold: return "\u{f8fc}"
        case .printLight: return "\u{f8fd}"
        case .printRegular: return "\u{f8fe}"
        case .priorityBadgeFilled: return "\u{f8ff}"
        case .priorityCircleBold: return "\u{f900}"
        case .priorityCircleFilled: return "\u{f901}"
        case .priorityCircleLight: return "\u{f902}"
        case .priorityCircleRegular: return "\u{f903}"
        case .priorityCircleTwoBold: return "\u{f904}"
        case .priorityCircleTwoFilled: return "\u{f905}"
        case .priorityCircleTwoLight: return "\u{f906}"
        case .priorityCircleTwoRegular: return "\u{f907}"
        case .priorityWaveBold: return "\u{f908}"
        case .priorityWaveLight: return "\u{f909}"
        case .priorityWaveRegular: return "\u{f90a}"
        case .privacyCircleBold: return "\u{f90b}"
        case .privacyCircleFilled: return "\u{f90c}"
        case .privacyCircleLight: return "\u{f90d}"
        case .privacyCircleRegular: return "\u{f90e}"
        case .privateBold: return "\u{f90f}"
        case .privateCircleBold: return "\u{f910}"
        case .privateCircleFilled: return "\u{f911}"
        case .privateCircleLight: return "\u{f912}"
        case .privateCircleRegular: return "\u{f913}"
        case .privateLight: return "\u{f914}"
        case .privateMeetingBold: return "\u{f915}"
        case .privateMeetingLight: return "\u{f916}"
        case .privateMeetingRegular: return "\u{f917}"
        case .privateRegular: return "\u{f918}"
        case .productDemoBold: return "\u{f919}"
        case .productDemoLight: return "\u{f91a}"
        case .productDemoRegular: return "\u{f91b}"
        case .promptsAiBold: return "\u{f91c}"
        case .promptsAiLight: return "\u{f91d}"
        case .promptsAiRegular: return "\u{f91e}"
        case .proximityBold: return "\u{f91f}"
        case .proximityLight: return "\u{f920}"
        case .proximityMutedBold: return "\u{f921}"
        case .proximityMutedLight: return "\u{f922}"
        case .proximityMutedRegular: return "\u{f923}"
        case .proximityRegular: return "\u{f924}"
        case .proximityVideoBold: return "\u{f925}"
        case .proximityVideoLight: return "\u{f926}"
        case .proximityVideoRegular: return "\u{f927}"
        case .ptoPresenceBold: return "\u{f928}"
        case .ptoPresenceFilled: return "\u{f929}"
        case .ptoPresenceLight: return "\u{f92a}"
        case .ptoPresenceRegular: return "\u{f92b}"
        case .pullCallBold: return "\u{f92c}"
        case .pullCallFilled: return "\u{f92d}"
        case .pullCallLight: return "\u{f92e}"
        case .pullCallRegular: return "\u{f92f}"
        case .qABold: return "\u{f930}"
        case .qAFilled: return "\u{f931}"
        case .qALight: return "\u{f932}"
        case .qARegular: return "\u{f933}"
        case .qrCodeBold: return "\u{f934}"
        case .qrCodeLight: return "\u{f935}"
        case .qrCodeRegular: return "\u{f936}"
        case .qrCodeScanBold: return "\u{f937}"
        case .qrCodeScanLight: return "\u{f938}"
        case .qrCodeScanRegular: return "\u{f939}"
        case .qualityBold: return "\u{f93a}"
        case .qualityLight: return "\u{f93b}"
        case .qualityRegular: return "\u{f93c}"
        case .queueContactBold: return "\u{f93d}"
        case .queueContactFilled: return "\u{f93e}"
        case .queueContactLight: return "\u{f93f}"
        case .queueContactRegular: return "\u{f940}"
        case .quietBold: return "\u{f941}"
        case .quietHoursPresenceBold: return "\u{f942}"
        case .quietHoursPresenceFilled: return "\u{f943}"
        case .quietHoursPresenceLight: return "\u{f944}"
        case .quietHoursPresenceRegular: return "\u{f945}"
        case .quietLight: return "\u{f946}"
        case .quietRegular: return "\u{f947}"
        case .radioButtonGroupBold: return "\u{f948}"
        case .radioButtonGroupLight: return "\u{f949}"
        case .radioButtonGroupRegular: return "\u{f94a}"
        case .raiseHandBold: return "\u{f94b}"
        case .raiseHandCircleFilled: return "\u{f94c}"
        case .raiseHandFilled: return "\u{f94d}"
        case .raiseHandLight: return "\u{f94e}"
        case .raiseHandRegular: return "\u{f94f}"
        case .ramBold: return "\u{f950}"
        case .ramLight: return "\u{f951}"
        case .ramRegular: return "\u{f952}"
        case .reactionsBold: return "\u{f953}"
        case .reactionsFilled: return "\u{f954}"
        case .reactionsLight: return "\u{f955}"
        case .reactionsRegular: return "\u{f956}"
        case .reactivateBold: return "\u{f957}"
        case .reactivateLight: return "\u{f958}"
        case .reactivateRegular: return "\u{f959}"
        case .receiveVoiceBold: return "\u{f95a}"
        case .receiveVoiceFilled: return "\u{f95b}"
        case .receiveVoiceLight: return "\u{f95c}"
        case .receiveVoiceRegular: return "\u{f95d}"
        case .recentsBold: return "\u{f95e}"
        case .recentsFilled: return "\u{f95f}"
        case .recentsLight: return "\u{f960}"
        case .recentsPresenceBadgeFilled: return "\u{f961}"
        case .recentsPresenceBold: return "\u{f962}"
        case .recentsPresenceFilled: return "\u{f963}"
        case .recentsPresenceLight: return "\u{f964}"
        case .recentsPresenceRegular: return "\u{f965}"
        case .recentsRegular: return "\u{f966}"
        case .recordActiveBadgeFilled: return "\u{f967}"
        case .recordActiveBold: return "\u{f968}"
        case .recordActiveFilled: return "\u{f969}"
        case .recordActiveLight: return "\u{f96a}"
        case .recordActiveRegular: return "\u{f96b}"
        case .recordBold: return "\u{f96c}"
        case .recordFilled: return "\u{f96d}"
        case .recordLight: return "\u{f96e}"
        case .recordPausedBadgeFilled: return "\u{f96f}"
        case .recordPausedBold: return "\u{f970}"
        case .recordPausedFilled: return "\u{f971}"
        case .recordPausedLight: return "\u{f972}"
        case .recordPausedRegular: return "\u{f973}"
        case .recordRegular: return "\u{f974}"
        case .recurringBold: return "\u{f975}"
        case .recurringLight: return "\u{f976}"
        case .recurringOffBold: return "\u{f977}"
        case .recurringOffLight: return "\u{f978}"
        case .recurringOffRegular: return "\u{f979}"
        case .recurringRegular: return "\u{f97a}"
        case .redoBold: return "\u{f97b}"
        case .redoLight: return "\u{f97c}"
        case .redoRegular: return "\u{f97d}"
        case .refreshBold: return "\u{f97e}"
        case .refreshLight: return "\u{f97f}"
        case .refreshRegular: return "\u{f980}"
        case .remoteDesktopControlBold: return "\u{f981}"
        case .remoteDesktopControlFilled: return "\u{f982}"
        case .remoteDesktopControlLight: return "\u{f983}"
        case .remoteDesktopControlRegular: return "\u{f984}"
        case .removeBold: return "\u{f985}"
        case .removeFilled: return "\u{f986}"
        case .removeLight: return "\u{f987}"
        case .removeRegular: return "\u{f988}"
        case .replyBold: return "\u{f989}"
        case .replyFilled: return "\u{f98a}"
        case .replyLight: return "\u{f98b}"
        case .replyListBold: return "\u{f98c}"
        case .replyListLight: return "\u{f98d}"
        case .replyListRegular: return "\u{f98e}"
        case .replyPrivatelyBold: return "\u{f98f}"
        case .replyPrivatelyLight: return "\u{f990}"
        case .replyPrivatelyRegular: return "\u{f991}"
        case .replyRegular: return "\u{f992}"
        case .resetBold: return "\u{f993}"
        case .resetLight: return "\u{f994}"
        case .resetRegular: return "\u{f995}"
        case .resizeCornerBold: return "\u{f996}"
        case .resizeCornerLight: return "\u{f997}"
        case .resizeCornerRegular: return "\u{f998}"
        case .responsiveMobileBold: return "\u{f999}"
        case .responsiveMobileLight: return "\u{f99a}"
        case .responsiveMobileRegular: return "\u{f99b}"
        case .restartBold: return "\u{f99c}"
        case .restartLight: return "\u{f99d}"
        case .restartRegular: return "\u{f99e}"
        case .retrieveCallBold: return "\u{f99f}"
        case .retrieveCallFilled: return "\u{f9a0}"
        case .retrieveCallLight: return "\u{f9a1}"
        case .retrieveCallRegular: return "\u{f9a2}"
        case .returnBold: return "\u{f9a3}"
        case .returnLight: return "\u{f9a4}"
        case .returnRegular: return "\u{f9a5}"
        case .rewindTenSecBold: return "\u{f9a6}"
        case .rewindTenSecLight: return "\u{f9a7}"
        case .rewindTenSecRegular: return "\u{f9a8}"
        case .ringtoneBold: return "\u{f9a9}"
        case .ringtoneLight: return "\u{f9aa}"
        case .ringtoneRegular: return "\u{f9ab}"
        case .roomCalendarBold: return "\u{f9ac}"
        case .roomCalendarLight: return "\u{f9ad}"
        case .roomCalendarRegular: return "\u{f9ae}"
        case .roomLightsBold: return "\u{f9af}"
        case .roomLightsFilled: return "\u{f9b0}"
        case .roomLightsLight: return "\u{f9b1}"
        case .roomLightsRegular: return "\u{f9b2}"
        case .rotateContentBold: return "\u{f9b3}"
        case .rotateContentFilled: return "\u{f9b4}"
        case .rotateContentLight: return "\u{f9b5}"
        case .rotateContentRegular: return "\u{f9b6}"
        case .rssBold: return "\u{f9b7}"
        case .rssFilled: return "\u{f9b8}"
        case .rssLight: return "\u{f9b9}"
        case .rssRegular: return "\u{f9ba}"
        case .ruleBasedBold: return "\u{f9bb}"
        case .ruleBasedLight: return "\u{f9bc}"
        case .ruleBasedRegular: return "\u{f9bd}"
        case .runningApplicationBold: return "\u{f9be}"
        case .runningApplicationFilled: return "\u{f9bf}"
        case .runningApplicationLight: return "\u{f9c0}"
        case .runningApplicationRegular: return "\u{f9c1}"
        case .saveBold: return "\u{f9c2}"
        case .saveLight: return "\u{f9c3}"
        case .saveRegular: return "\u{f9c4}"
        case .saveTranscriptBold: return "\u{f9c5}"
        case .saveTranscriptFilled: return "\u{f9c6}"
        case .saveTranscriptLight: return "\u{f9c7}"
        case .saveTranscriptRegular: return "\u{f9c8}"
        case .scanBold: return "\u{f9c9}"
        case .scanLight: return "\u{f9ca}"
        case .scanRegular: return "\u{f9cb}"
        case .scheduleAiBold: return "\u{f9cc}"
        case .scheduleAiLight: return "\u{f9cd}"
        case .scheduleAiRegular: return "\u{f9ce}"
        case .scheduleSendBold: return "\u{f9cf}"
        case .scheduleSendFilled: return "\u{f9d0}"
        case .scheduleSendLight: return "\u{f9d1}"
        case .scheduleSendRegular: return "\u{f9d2}"
        case .scheduleWinnerBold: return "\u{f9d3}"
        case .scheduleWinnerFilled: return "\u{f9d4}"
        case .scheduleWinnerLight: return "\u{f9d5}"
        case .scheduleWinnerRegular: return "\u{f9d6}"
        case .schedulerAvailableBold: return "\u{f9d7}"
        case .schedulerAvailableLight: return "\u{f9d8}"
        case .schedulerAvailableRegular: return "\u{f9d9}"
        case .schedulerNotWorkingHoursBold: return "\u{f9da}"
        case .schedulerNotWorkingHoursLight: return "\u{f9db}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9dc}"
        case .schedulerUnavailableBold: return "\u{f9dd}"
        case .schedulerUnavailableLight: return "\u{f9de}"
        case .schedulerUnavailableRegular: return "\u{f9df}"
        case .schedulerUnknownBold: return "\u{f9e0}"
        case .schedulerUnknownLight: return "\u{f9e1}"
        case .schedulerUnknownRegular: return "\u{f9e2}"
        case .screenshotBold: return "\u{f9e3}"
        case .screenshotDocBold: return "\u{f9e4}"
        case .screenshotDocFilled: return "\u{f9e5}"
        case .screenshotDocLight: return "\u{f9e6}"
        case .screenshotDocRegular: return "\u{f9e7}"
        case .screenshotLight: return "\u{f9e8}"
        case .screenshotRegular: return "\u{f9e9}"
        case .searchAiBold: return "\u{f9ea}"
        case .searchAiLight: return "\u{f9eb}"
        case .searchAiRegular: return "\u{f9ec}"
        case .searchBold: return "\u{f9ed}"
        case .searchFilled: return "\u{f9ee}"
        case .searchLight: return "\u{f9ef}"
        case .searchRegular: return "\u{f9f0}"
        case .secondaryArrowBold: return "\u{f9f1}"
        case .secondaryArrowLight: return "\u{f9f2}"
        case .secondaryArrowRegular: return "\u{f9f3}"
        case .secureCallLockBold: return "\u{f9f4}"
        case .secureCallLockFilled: return "\u{f9f5}"
        case .secureCallLockLight: return "\u{f9f6}"
        case .secureCallLockRegular: return "\u{f9f7}"
        case .secureCallShieldBold: return "\u{f9f8}"
        case .secureCallShieldFilled: return "\u{f9f9}"
        case .secureCallShieldLight: return "\u{f9fa}"
        case .secureCallShieldRegular: return "\u{f9fb}"
        case .secureCircleBold: return "\u{f9fc}"
        case .secureCircleFilled: return "\u{f9fd}"
        case .secureCircleLight: return "\u{f9fe}"
        case .secureCircleRegular: return "\u{f9ff}"
        case .secureLockBold: return "\u{fa00}"
        case .secureLockFilled: return "\u{fa01}"
        case .secureLockLight: return "\u{fa02}"
        case .secureLockRegular: return "\u{fa03}"
        case .segmentExcludeFilled: return "\u{fa04}"
        case .segmentFilterFilled: return "\u{fa05}"
        case .segmentIncludeFilled: return "\u{fa06}"
        case .selectAllBold: return "\u{fa07}"
        case .selectAllFilled: return "\u{fa08}"
        case .selectAllLight: return "\u{fa09}"
        case .selectAllRegular: return "\u{fa0a}"
        case .selectionBold: return "\u{fa0b}"
        case .selectionFilled: return "\u{fa0c}"
        case .selectionLight: return "\u{fa0d}"
        case .selectionRegular: return "\u{fa0e}"
        case .sendBold: return "\u{fa0f}"
        case .sendDigitsBold: return "\u{fa10}"
        case .sendDigitsFilled: return "\u{fa11}"
        case .sendDigitsLight: return "\u{fa12}"
        case .sendDigitsRegular: return "\u{fa13}"
        case .sendFilled: return "\u{fa14}"
        case .sendLight: return "\u{fa15}"
        case .sendRegular: return "\u{fa16}"
        case .sendVoiceBold: return "\u{fa17}"
        case .sendVoiceFilled: return "\u{fa18}"
        case .sendVoiceLight: return "\u{fa19}"
        case .sendVoiceRegular: return "\u{fa1a}"
        case .serverBold: return "\u{fa1b}"
        case .serverErrorBold: return "\u{fa1c}"
        case .serverErrorLight: return "\u{fa1d}"
        case .serverErrorRegular: return "\u{fa1e}"
        case .serverLight: return "\u{fa1f}"
        case .serverRegular: return "\u{fa20}"
        case .servicesBold: return "\u{fa21}"
        case .servicesLight: return "\u{fa22}"
        case .servicesRegular: return "\u{fa23}"
        case .setVariableBold: return "\u{fa24}"
        case .setVariableLight: return "\u{fa25}"
        case .setVariableRegular: return "\u{fa26}"
        case .settingsBold: return "\u{fa27}"
        case .settingsFilled: return "\u{fa28}"
        case .settingsLight: return "\u{fa29}"
        case .settingsRegular: return "\u{fa2a}"
        case .setupAssistantBold: return "\u{fa2b}"
        case .setupAssistantLight: return "\u{fa2c}"
        case .setupAssistantRegular: return "\u{fa2d}"
        case .sftpBold: return "\u{fa2e}"
        case .sftpLight: return "\u{fa2f}"
        case .sftpRegular: return "\u{fa30}"
        case .shapeCircleBold: return "\u{fa31}"
        case .shapeCircleFilled: return "\u{fa32}"
        case .shapeCircleLight: return "\u{fa33}"
        case .shapeCircleMdFilled: return "\u{fa34}"
        case .shapeCircleRegular: return "\u{fa35}"
        case .shapeCircleSmFilled: return "\u{fa36}"
        case .shapeDiagonalLineBold: return "\u{fa37}"
        case .shapeDiagonalLineLight: return "\u{fa38}"
        case .shapeDiagonalLineRegular: return "\u{fa39}"
        case .shapeDiamondBold: return "\u{fa3a}"
        case .shapeDiamondFilled: return "\u{fa3b}"
        case .shapeDiamondLight: return "\u{fa3c}"
        case .shapeDiamondRegular: return "\u{fa3d}"
        case .shapeOvalBold: return "\u{fa3e}"
        case .shapeOvalLight: return "\u{fa3f}"
        case .shapeOvalRegular: return "\u{fa40}"
        case .shapeSquareBold: return "\u{fa41}"
        case .shapeSquareFilled: return "\u{fa42}"
        case .shapeSquareLight: return "\u{fa43}"
        case .shapeSquareRegular: return "\u{fa44}"
        case .shapeTriangleBold: return "\u{fa45}"
        case .shapeTriangleFilled: return "\u{fa46}"
        case .shapeTriangleLight: return "\u{fa47}"
        case .shapeTriangleRegular: return "\u{fa48}"
        case .shapesBold: return "\u{fa49}"
        case .shapesFilled: return "\u{fa4a}"
        case .shapesLight: return "\u{fa4b}"
        case .shapesRegular: return "\u{fa4c}"
        case .shareCNativeAdrBold: return "\u{fa4d}"
        case .shareCNativeAdrFilled: return "\u{fa4e}"
        case .shareCNativeAdrLight: return "\u{fa4f}"
        case .shareCNativeAdrRegular: return "\u{fa50}"
        case .shareCNativeIphBold: return "\u{fa51}"
        case .shareCNativeIphLight: return "\u{fa52}"
        case .shareCNativeIphRegular: return "\u{fa53}"
        case .shareContentOnDeviceBold: return "\u{fa54}"
        case .shareContentOnDeviceLight: return "\u{fa55}"
        case .shareContentOnDeviceRegular: return "\u{fa56}"
        case .shareScreenAddBold: return "\u{fa57}"
        case .shareScreenAddLight: return "\u{fa58}"
        case .shareScreenAddRegular: return "\u{fa59}"
        case .shareScreenBadgeFilled: return "\u{fa5a}"
        case .shareScreenBold: return "\u{fa5b}"
        case .shareScreenFilled: return "\u{fa5c}"
        case .shareScreenLight: return "\u{fa5d}"
        case .shareScreenRegular: return "\u{fa5e}"
        case .shareSpaceBold: return "\u{fa5f}"
        case .shareSpaceLight: return "\u{fa60}"
        case .shareSpaceRegular: return "\u{fa61}"
        case .shieldBold: return "\u{fa62}"
        case .shieldLight: return "\u{fa63}"
        case .shieldRegular: return "\u{fa64}"
        case .shoppingCartBold: return "\u{fa65}"
        case .shoppingCartFilled: return "\u{fa66}"
        case .shoppingCartLight: return "\u{fa67}"
        case .shoppingCartRegular: return "\u{fa68}"
        case .shortTextBoxBold: return "\u{fa69}"
        case .shortTextBoxLight: return "\u{fa6a}"
        case .shortTextBoxRegular: return "\u{fa6b}"
        case .showBold: return "\u{fa6c}"
        case .showFilled: return "\u{fa6d}"
        case .showLight: return "\u{fa6e}"
        case .showRegular: return "\u{fa6f}"
        case .sidePanelBold: return "\u{fa70}"
        case .sidePanelFilled: return "\u{fa71}"
        case .sidePanelLight: return "\u{fa72}"
        case .sidePanelRegular: return "\u{fa73}"
        case .signInBold: return "\u{fa74}"
        case .signInFilled: return "\u{fa75}"
        case .signInForcedBold: return "\u{fa76}"
        case .signInForcedLight: return "\u{fa77}"
        case .signInForcedRegular: return "\u{fa78}"
        case .signInLight: return "\u{fa79}"
        case .signInRegular: return "\u{fa7a}"
        case .signLangIntBold: return "\u{fa7b}"
        case .signLangIntLight: return "\u{fa7c}"
        case .signLangIntRegular: return "\u{fa7d}"
        case .signOutBold: return "\u{fa7e}"
        case .signOutLight: return "\u{fa7f}"
        case .signOutRegular: return "\u{fa80}"
        case .signalFourBold: return "\u{fa81}"
        case .signalFourLight: return "\u{fa82}"
        case .signalFourRegular: return "\u{fa83}"
        case .signalOneBold: return "\u{fa84}"
        case .signalOneLight: return "\u{fa85}"
        case .signalOneRegular: return "\u{fa86}"
        case .signalThreeBold: return "\u{fa87}"
        case .signalThreeLight: return "\u{fa88}"
        case .signalThreeRegular: return "\u{fa89}"
        case .signalTwoBold: return "\u{fa8a}"
        case .signalTwoLight: return "\u{fa8b}"
        case .signalTwoRegular: return "\u{fa8c}"
        case .signalZeroBold: return "\u{fa8d}"
        case .signalZeroLight: return "\u{fa8e}"
        case .signalZeroRegular: return "\u{fa8f}"
        case .simplePromotionBold: return "\u{fa90}"
        case .simplePromotionLight: return "\u{fa91}"
        case .simplePromotionRegular: return "\u{fa92}"
        case .singleNumberReachBold: return "\u{fa93}"
        case .singleNumberReachLight: return "\u{fa94}"
        case .singleNumberReachRegular: return "\u{fa95}"
        case .sipRegistrationInProgressBold: return "\u{fa96}"
        case .sipRegistrationInProgressFilled: return "\u{fa97}"
        case .sipRegistrationInProgressLight: return "\u{fa98}"
        case .sipRegistrationInProgressRegular: return "\u{fa99}"
        case .skipBold: return "\u{fa9a}"
        case .skipBwBold: return "\u{fa9b}"
        case .skipBwFilled: return "\u{fa9c}"
        case .skipBwLight: return "\u{fa9d}"
        case .skipBwRegular: return "\u{fa9e}"
        case .skipFwBold: return "\u{fa9f}"
        case .skipFwFilled: return "\u{faa0}"
        case .skipFwLight: return "\u{faa1}"
        case .skipFwRegular: return "\u{faa2}"
        case .skipLight: return "\u{faa3}"
        case .skipRegular: return "\u{faa4}"
        case .smartAudioBold: return "\u{faa5}"
        case .smartAudioLight: return "\u{faa6}"
        case .smartAudioRegular: return "\u{faa7}"
        case .smsFilled: return "\u{faa8}"
        case .smsInboundBold: return "\u{faa9}"
        case .smsInboundLight: return "\u{faaa}"
        case .smsInboundRegular: return "\u{faab}"
        case .smsMessageBold: return "\u{faac}"
        case .smsMessageFilled: return "\u{faad}"
        case .smsMessageLight: return "\u{faae}"
        case .smsMessageRegular: return "\u{faaf}"
        case .smsOutgoingFilled: return "\u{fab0}"
        case .smsUnreadBold: return "\u{fab1}"
        case .smsUnreadLight: return "\u{fab2}"
        case .smsUnreadRegular: return "\u{fab3}"
        case .sortAscendingBold: return "\u{fab4}"
        case .sortAscendingLight: return "\u{fab5}"
        case .sortAscendingRegular: return "\u{fab6}"
        case .sortDescendingBold: return "\u{fab7}"
        case .sortDescendingLight: return "\u{fab8}"
        case .sortDescendingRegular: return "\u{fab9}"
        case .soundDefaultBold: return "\u{faba}"
        case .soundDefaultLight: return "\u{fabb}"
        case .soundDefaultRegular: return "\u{fabc}"
        case .sparkleBold: return "\u{fabd}"
        case .sparkleFilled: return "\u{fabe}"
        case .sparkleLight: return "\u{fabf}"
        case .sparkleRegular: return "\u{fac0}"
        case .speakerBold: return "\u{fac1}"
        case .speakerDisconnectedBold: return "\u{fac2}"
        case .speakerDisconnectedFilled: return "\u{fac3}"
        case .speakerDisconnectedLight: return "\u{fac4}"
        case .speakerDisconnectedRegular: return "\u{fac5}"
        case .speakerFilled: return "\u{fac6}"
        case .speakerLight: return "\u{fac7}"
        case .speakerMutedBold: return "\u{fac8}"
        case .speakerMutedFilled: return "\u{fac9}"
        case .speakerMutedLight: return "\u{faca}"
        case .speakerMutedRegular: return "\u{facb}"
        case .speakerOffBold: return "\u{facc}"
        case .speakerOffFilled: return "\u{facd}"
        case .speakerOffLight: return "\u{face}"
        case .speakerOffRegular: return "\u{facf}"
        case .speakerOnBold: return "\u{fad0}"
        case .speakerOnLight: return "\u{fad1}"
        case .speakerOnRegular: return "\u{fad2}"
        case .speakerRegular: return "\u{fad3}"
        case .speakerTurnDownBold: return "\u{fad4}"
        case .speakerTurnDownFilled: return "\u{fad5}"
        case .speakerTurnDownLight: return "\u{fad6}"
        case .speakerTurnDownRegular: return "\u{fad7}"
        case .speakerTurnUpBold: return "\u{fad8}"
        case .speakerTurnUpFilled: return "\u{fad9}"
        case .speakerTurnUpLight: return "\u{fada}"
        case .speakerTurnUpRegular: return "\u{fadb}"
        case .speedDialBold: return "\u{fadc}"
        case .speedDialFilled: return "\u{fadd}"
        case .speedDialLight: return "\u{fade}"
        case .speedDialRegular: return "\u{fadf}"
        case .spellCheckerBold: return "\u{fae0}"
        case .spellCheckerLight: return "\u{fae1}"
        case .spellCheckerRegular: return "\u{fae2}"
        case .splitViewBold: return "\u{fae3}"
        case .splitViewLight: return "\u{fae4}"
        case .splitViewRegular: return "\u{fae5}"
        case .stackedAreaChartBold: return "\u{fae6}"
        case .stackedAreaChartFilled: return "\u{fae7}"
        case .stackedAreaChartFullBold: return "\u{fae8}"
        case .stackedAreaChartFullFilled: return "\u{fae9}"
        case .stackedAreaChartFullLight: return "\u{faea}"
        case .stackedAreaChartFullRegular: return "\u{faeb}"
        case .stackedAreaChartLight: return "\u{faec}"
        case .stackedAreaChartRegular: return "\u{faed}"
        case .stackedBarChartBold: return "\u{faee}"
        case .stackedBarChartFilled: return "\u{faef}"
        case .stackedBarChartFullBold: return "\u{faf0}"
        case .stackedBarChartFullFilled: return "\u{faf1}"
        case .stackedBarChartFullLight: return "\u{faf2}"
        case .stackedBarChartFullRegular: return "\u{faf3}"
        case .stackedBarChartLight: return "\u{faf4}"
        case .stackedBarChartRegular: return "\u{faf5}"
        case .startChatBold: return "\u{faf6}"
        case .startChatLight: return "\u{faf7}"
        case .startChatRegular: return "\u{faf8}"
        case .stethoscopeBold: return "\u{faf9}"
        case .stethoscopeLight: return "\u{fafa}"
        case .stethoscopeRegular: return "\u{fafb}"
        case .stickersBold: return "\u{fafc}"
        case .stickersLight: return "\u{fafd}"
        case .stickersRegular: return "\u{fafe}"
        case .stickiesBold: return "\u{faff}"
        case .stickiesLight: return "\u{fb00}"
        case .stickiesRegular: return "\u{fb01}"
        case .stopBold: return "\u{fb02}"
        case .stopCircleBold: return "\u{fb03}"
        case .stopCircleFilled: return "\u{fb04}"
        case .stopCircleLight: return "\u{fb05}"
        case .stopCircleRegular: return "\u{fb06}"
        case .stopContentShareBold: return "\u{fb07}"
        case .stopContentShareLight: return "\u{fb08}"
        case .stopContentShareRegular: return "\u{fb09}"
        case .stopFilled: return "\u{fb0a}"
        case .stopLight: return "\u{fb0b}"
        case .stopRegular: return "\u{fb0c}"
        case .storedInfoBold: return "\u{fb0d}"
        case .storedInfoFilled: return "\u{fb0e}"
        case .storedInfoLight: return "\u{fb0f}"
        case .storedInfoRegular: return "\u{fb10}"
        case .streamingBold: return "\u{fb11}"
        case .streamingLight: return "\u{fb12}"
        case .streamingRegular: return "\u{fb13}"
        case .strikethroughBold: return "\u{fb14}"
        case .strikethroughFilled: return "\u{fb15}"
        case .strikethroughLight: return "\u{fb16}"
        case .strikethroughRegular: return "\u{fb17}"
        case .studioModeBold: return "\u{fb18}"
        case .studioModeLight: return "\u{fb19}"
        case .studioModeRegular: return "\u{fb1a}"
        case .subscriptBold: return "\u{fb1b}"
        case .subscriptLight: return "\u{fb1c}"
        case .subscriptRegular: return "\u{fb1d}"
        case .summarizeAiBold: return "\u{fb1e}"
        case .summarizeAiLight: return "\u{fb1f}"
        case .summarizeAiRegular: return "\u{fb20}"
        case .superscriptBold: return "\u{fb21}"
        case .superscriptLight: return "\u{fb22}"
        case .superscriptRegular: return "\u{fb23}"
        case .surveyBold: return "\u{fb24}"
        case .surveyFilled: return "\u{fb25}"
        case .surveyLight: return "\u{fb26}"
        case .surveyRegular: return "\u{fb27}"
        case .sxEightyCodecBold: return "\u{fb28}"
        case .sxEightyCodecLight: return "\u{fb29}"
        case .sxEightyCodecRegular: return "\u{fb2a}"
        case .sxTenBold: return "\u{fb2b}"
        case .sxTenLight: return "\u{fb2c}"
        case .sxTenRegular: return "\u{fb2d}"
        case .sxTwentyBold: return "\u{fb2e}"
        case .sxTwentyLight: return "\u{fb2f}"
        case .sxTwentyRegular: return "\u{fb30}"
        case .tableBold: return "\u{fb31}"
        case .tableLight: return "\u{fb32}"
        case .tableRegular: return "\u{fb33}"
        case .tabletBold: return "\u{fb34}"
        case .tabletLight: return "\u{fb35}"
        case .tabletRegular: return "\u{fb36}"
        case .tabsBold: return "\u{fb37}"
        case .tabsLight: return "\u{fb38}"
        case .tabsRegular: return "\u{fb39}"
        case .tagBold: return "\u{fb3a}"
        case .tagLight: return "\u{fb3b}"
        case .tagRegular: return "\u{fb3c}"
        case .tapBold: return "\u{fb3d}"
        case .tapFilled: return "\u{fb3e}"
        case .tapLight: return "\u{fb3f}"
        case .tapRegular: return "\u{fb40}"
        case .telepresenceAlertBold: return "\u{fb41}"
        case .telepresenceAlertLight: return "\u{fb42}"
        case .telepresenceAlertMutedBold: return "\u{fb43}"
        case .telepresenceAlertMutedLight: return "\u{fb44}"
        case .telepresenceAlertMutedRegular: return "\u{fb45}"
        case .telepresenceAlertRegular: return "\u{fb46}"
        case .telepresenceBold: return "\u{fb47}"
        case .telepresenceIxFiveThousandBold: return "\u{fb48}"
        case .telepresenceIxFiveThousandLight: return "\u{fb49}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb4a}"
        case .telepresenceLight: return "\u{fb4b}"
        case .telepresenceMutedBold: return "\u{fb4c}"
        case .telepresenceMutedLight: return "\u{fb4d}"
        case .telepresenceMutedRegular: return "\u{fb4e}"
        case .telepresencePrivateBold: return "\u{fb4f}"
        case .telepresencePrivateLight: return "\u{fb50}"
        case .telepresencePrivateRegular: return "\u{fb51}"
        case .telepresenceRegular: return "\u{fb52}"
        case .temperatureBold: return "\u{fb53}"
        case .temperatureLight: return "\u{fb54}"
        case .temperatureRegular: return "\u{fb55}"
        case .testTubeBold: return "\u{fb56}"
        case .testTubeFilled: return "\u{fb57}"
        case .testTubeLight: return "\u{fb58}"
        case .testTubeRegular: return "\u{fb59}"
        case .textAlignCenterBold: return "\u{fb5a}"
        case .textAlignCenterFilled: return "\u{fb5b}"
        case .textAlignCenterLight: return "\u{fb5c}"
        case .textAlignCenterRegular: return "\u{fb5d}"
        case .textAlignLeftBold: return "\u{fb5e}"
        case .textAlignLeftFilled: return "\u{fb5f}"
        case .textAlignLeftLight: return "\u{fb60}"
        case .textAlignLeftRegular: return "\u{fb61}"
        case .textAlignRightBold: return "\u{fb62}"
        case .textAlignRightFilled: return "\u{fb63}"
        case .textAlignRightLight: return "\u{fb64}"
        case .textAlignRightRegular: return "\u{fb65}"
        case .textBold: return "\u{fb66}"
        case .textBoxCursorLight: return "\u{fb67}"
        case .textCodeBlockBold: return "\u{fb68}"
        case .textCodeBlockLight: return "\u{fb69}"
        case .textCodeBlockRegular: return "\u{fb6a}"
        case .textHighlightBold: return "\u{fb6b}"
        case .textHighlightFilled: return "\u{fb6c}"
        case .textHighlightLight: return "\u{fb6d}"
        case .textHighlightRegular: return "\u{fb6e}"
        case .textLight: return "\u{fb6f}"
        case .textRegular: return "\u{fb70}"
        case .threeColumnBold: return "\u{fb71}"
        case .threeColumnLight: return "\u{fb72}"
        case .threeColumnRegular: return "\u{fb73}"
        case .threeDObjectBold: return "\u{fb74}"
        case .threeDObjectLight: return "\u{fb75}"
        case .threeDObjectRegular: return "\u{fb76}"
        case .timeExclusionBold: return "\u{fb77}"
        case .timeExclusionLight: return "\u{fb78}"
        case .timeExclusionRegular: return "\u{fb79}"
        case .tooFastBold: return "\u{fb7a}"
        case .tooFastLight: return "\u{fb7b}"
        case .tooFastRegular: return "\u{fb7c}"
        case .tooSlowBold: return "\u{fb7d}"
        case .tooSlowLight: return "\u{fb7e}"
        case .tooSlowRegular: return "\u{fb7f}"
        case .toolsBold: return "\u{fb80}"
        case .toolsFilled: return "\u{fb81}"
        case .toolsLight: return "\u{fb82}"
        case .toolsRegular: return "\u{fb83}"
        case .touchTenBold: return "\u{fb84}"
        case .touchTenLight: return "\u{fb85}"
        case .touchTenRegular: return "\u{fb86}"
        case .transcriptBold: return "\u{fb87}"
        case .transcriptFilled: return "\u{fb88}"
        case .transcriptLight: return "\u{fb89}"
        case .transcriptRegular: return "\u{fb8a}"
        case .translateBold: return "\u{fb8b}"
        case .translateLight: return "\u{fb8c}"
        case .translateRegular: return "\u{fb8d}"
        case .translateUndoBold: return "\u{fb8e}"
        case .translateUndoLight: return "\u{fb8f}"
        case .translateUndoRegular: return "\u{fb90}"
        case .trendingBold: return "\u{fb91}"
        case .trendingDownBold: return "\u{fb92}"
        case .trendingDownFilled: return "\u{fb93}"
        case .trendingDownLight: return "\u{fb94}"
        case .trendingDownRegular: return "\u{fb95}"
        case .trendingFilled: return "\u{fb96}"
        case .trendingLight: return "\u{fb97}"
        case .trendingRegular: return "\u{fb98}"
        case .trimBold: return "\u{fb99}"
        case .trimLight: return "\u{fb9a}"
        case .trimRegular: return "\u{fb9b}"
        case .twoColumnBold: return "\u{fb9c}"
        case .twoColumnLight: return "\u{fb9d}"
        case .twoColumnRegular: return "\u{fb9e}"
        case .twoWayVoiceStreamBold: return "\u{fb9f}"
        case .twoWayVoiceStreamFilled: return "\u{fba0}"
        case .twoWayVoiceStreamLight: return "\u{fba1}"
        case .twoWayVoiceStreamRegular: return "\u{fba2}"
        case .ucmCloudBold: return "\u{fba3}"
        case .ucmCloudLight: return "\u{fba4}"
        case .ucmCloudRegular: return "\u{fba5}"
        case .unblockBold: return "\u{fba6}"
        case .unblockFilled: return "\u{fba7}"
        case .unblockLight: return "\u{fba8}"
        case .unblockRegular: return "\u{fba9}"
        case .underlineBold: return "\u{fbaa}"
        case .underlineFilled: return "\u{fbab}"
        case .underlineLight: return "\u{fbac}"
        case .underlineRegular: return "\u{fbad}"
        case .undoBold: return "\u{fbae}"
        case .undoLight: return "\u{fbaf}"
        case .undoRegular: return "\u{fbb0}"
        case .unlinkBold: return "\u{fbb1}"
        case .unlinkLight: return "\u{fbb2}"
        case .unlinkRegular: return "\u{fbb3}"
        case .unreadBold: return "\u{fbb4}"
        case .unreadFilled: return "\u{fbb5}"
        case .unreadLight: return "\u{fbb6}"
        case .unreadRegular: return "\u{fbb7}"
        case .unsecureUnlockedBold: return "\u{fbb8}"
        case .unsecureUnlockedFilled: return "\u{fbb9}"
        case .unsecureUnlockedLight: return "\u{fbba}"
        case .unsecureUnlockedRegular: return "\u{fbbb}"
        case .unsortedBold: return "\u{fbbc}"
        case .unsortedLight: return "\u{fbbd}"
        case .unsortedRegular: return "\u{fbbe}"
        case .updateFileShareBold: return "\u{fbbf}"
        case .updateFileShareLight: return "\u{fbc0}"
        case .updateFileShareRegular: return "\u{fbc1}"
        case .uploadBold: return "\u{fbc2}"
        case .uploadImageBold: return "\u{fbc3}"
        case .uploadImageLight: return "\u{fbc4}"
        case .uploadImageRegular: return "\u{fbc5}"
        case .uploadLight: return "\u{fbc6}"
        case .uploadRegular: return "\u{fbc7}"
        case .urgentVoicemailBold: return "\u{fbc8}"
        case .urgentVoicemailFilled: return "\u{fbc9}"
        case .usbBold: return "\u{fbca}"
        case .usbHeadsetBold: return "\u{fbcb}"
        case .usbHeadsetLight: return "\u{fbcc}"
        case .usbHeadsetMutedBold: return "\u{fbcd}"
        case .usbHeadsetMutedLight: return "\u{fbce}"
        case .usbHeadsetMutedRegular: return "\u{fbcf}"
        case .usbHeadsetRegular: return "\u{fbd0}"
        case .usbLight: return "\u{fbd1}"
        case .usbRegular: return "\u{fbd2}"
        case .userBold: return "\u{fbd3}"
        case .userDeactivateBold: return "\u{fbd4}"
        case .userDeactivateLight: return "\u{fbd5}"
        case .userDeactivateRegular: return "\u{fbd6}"
        case .userLight: return "\u{fbd7}"
        case .userRegular: return "\u{fbd8}"
        case .videoBlurBold: return "\u{fbd9}"
        case .videoBlurFilled: return "\u{fbda}"
        case .videoBlurLight: return "\u{fbdb}"
        case .videoBlurRegular: return "\u{fbdc}"
        case .videoBold: return "\u{fbdd}"
        case .videoEffectBold: return "\u{fbde}"
        case .videoEffectFilled: return "\u{fbdf}"
        case .videoEffectLight: return "\u{fbe0}"
        case .videoEffectRegular: return "\u{fbe1}"
        case .videoFilled: return "\u{fbe2}"
        case .videoLayoutBold: return "\u{fbe3}"
        case .videoLayoutCustomBold: return "\u{fbe4}"
        case .videoLayoutCustomFilled: return "\u{fbe5}"
        case .videoLayoutCustomLight: return "\u{fbe6}"
        case .videoLayoutCustomRegular: return "\u{fbe7}"
        case .videoLayoutEqualBold: return "\u{fbe8}"
        case .videoLayoutEqualDualBold: return "\u{fbe9}"
        case .videoLayoutEqualDualLight: return "\u{fbea}"
        case .videoLayoutEqualDualRegular: return "\u{fbeb}"
        case .videoLayoutEqualFilled: return "\u{fbec}"
        case .videoLayoutEqualLight: return "\u{fbed}"
        case .videoLayoutEqualRegular: return "\u{fbee}"
        case .videoLayoutFilled: return "\u{fbef}"
        case .videoLayoutLight: return "\u{fbf0}"
        case .videoLayoutOverlayBold: return "\u{fbf1}"
        case .videoLayoutOverlayFilled: return "\u{fbf2}"
        case .videoLayoutOverlayLight: return "\u{fbf3}"
        case .videoLayoutOverlayRegular: return "\u{fbf4}"
        case .videoLayoutPresentationBold: return "\u{fbf5}"
        case .videoLayoutPresentationFilled: return "\u{fbf6}"
        case .videoLayoutPresentationLight: return "\u{fbf7}"
        case .videoLayoutPresentationRegular: return "\u{fbf8}"
        case .videoLayoutPresenterDominantBold: return "\u{fbf9}"
        case .videoLayoutPresenterDominantLight: return "\u{fbfa}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbfb}"
        case .videoLayoutProminentBold: return "\u{fbfc}"
        case .videoLayoutProminentFilled: return "\u{fbfd}"
        case .videoLayoutProminentLight: return "\u{fbfe}"
        case .videoLayoutProminentRegular: return "\u{fbff}"
        case .videoLayoutRegular: return "\u{fc00}"
        case .videoLayoutShareDominantBold: return "\u{fc01}"
        case .videoLayoutShareDominantLight: return "\u{fc02}"
        case .videoLayoutShareDominantRegular: return "\u{fc03}"
        case .videoLayoutSingleBold: return "\u{fc04}"
        case .videoLayoutSingleFilled: return "\u{fc05}"
        case .videoLayoutSingleLight: return "\u{fc06}"
        case .videoLayoutSingleRegular: return "\u{fc07}"
        case .videoLayoutSpeakerBold: return "\u{fc08}"
        case .videoLayoutSpeakerFilled: return "\u{fc09}"
        case .videoLayoutSpeakerLight: return "\u{fc0a}"
        case .videoLayoutSpeakerRegular: return "\u{fc0b}"
        case .videoLayoutStackBold: return "\u{fc0c}"
        case .videoLayoutStackFilled: return "\u{fc0d}"
        case .videoLayoutStackLight: return "\u{fc0e}"
        case .videoLayoutStackRegular: return "\u{fc0f}"
        case .videoLayoutVideoDominantBold: return "\u{fc10}"
        case .videoLayoutVideoDominantFilled: return "\u{fc11}"
        case .videoLayoutVideoDominantLight: return "\u{fc12}"
        case .videoLayoutVideoDominantRegular: return "\u{fc13}"
        case .videoLight: return "\u{fc14}"
        case .videoPlusBold: return "\u{fc15}"
        case .videoPlusFilled: return "\u{fc16}"
        case .videoPlusLight: return "\u{fc17}"
        case .videoPlusRegular: return "\u{fc18}"
        case .videoRegular: return "\u{fc19}"
        case .videoSpeakerTrackBold: return "\u{fc1a}"
        case .videoSpeakerTrackFilled: return "\u{fc1b}"
        case .videoSpeakerTrackLight: return "\u{fc1c}"
        case .videoSpeakerTrackRegular: return "\u{fc1d}"
        case .viewAllBold: return "\u{fc1e}"
        case .viewAllLight: return "\u{fc1f}"
        case .viewAllRegular: return "\u{fc20}"
        case .viewListBold: return "\u{fc21}"
        case .viewListFilled: return "\u{fc22}"
        case .viewListLight: return "\u{fc23}"
        case .viewListRegular: return "\u{fc24}"
        case .viewStackedBold: return "\u{fc25}"
        case .viewStackedFilled: return "\u{fc26}"
        case .viewStackedLight: return "\u{fc27}"
        case .viewStackedRegular: return "\u{fc28}"
        case .viewThumbnailBold: return "\u{fc29}"
        case .viewThumbnailFilled: return "\u{fc2a}"
        case .viewThumbnailLight: return "\u{fc2b}"
        case .viewThumbnailRegular: return "\u{fc2c}"
        case .visionproBold: return "\u{fc2d}"
        case .visionproFilled: return "\u{fc2e}"
        case .visionproLight: return "\u{fc2f}"
        case .visionproMoveCallInBold: return "\u{fc30}"
        case .visionproMoveCallInFilled: return "\u{fc31}"
        case .visionproMoveCallInLight: return "\u{fc32}"
        case .visionproMoveCallInOutBold: return "\u{fc33}"
        case .visionproMoveCallInOutFilled: return "\u{fc34}"
        case .visionproMoveCallInOutLight: return "\u{fc35}"
        case .visionproMoveCallInOutRegular: return "\u{fc36}"
        case .visionproMoveCallInRegular: return "\u{fc37}"
        case .visionproMoveCallOutBold: return "\u{fc38}"
        case .visionproMoveCallOutFilled: return "\u{fc39}"
        case .visionproMoveCallOutLight: return "\u{fc3a}"
        case .visionproMoveCallOutRegular: return "\u{fc3b}"
        case .visionproRegular: return "\u{fc3c}"
        case .voicemailBold: return "\u{fc3d}"
        case .voicemailFilled: return "\u{fc3e}"
        case .voicemailLight: return "\u{fc3f}"
        case .voicemailRegular: return "\u{fc40}"
        case .vpnBold: return "\u{fc41}"
        case .vpnFilled: return "\u{fc42}"
        case .vpnLight: return "\u{fc43}"
        case .vpnRegular: return "\u{fc44}"
        case .vscBold: return "\u{fc45}"
        case .vscLight: return "\u{fc46}"
        case .vscRegular: return "\u{fc47}"
        case .waffleMenuBold: return "\u{fc48}"
        case .waffleMenuLight: return "\u{fc49}"
        case .waffleMenuRegular: return "\u{fc4a}"
        case .waitingRoomBold: return "\u{fc4b}"
        case .waitingRoomLight: return "\u{fc4c}"
        case .waitingRoomRegular: return "\u{fc4d}"
        case .wallpaperBold: return "\u{fc4e}"
        case .wallpaperLight: return "\u{fc4f}"
        case .wallpaperRegular: return "\u{fc50}"
        case .warningBadgeFilled: return "\u{fc51}"
        case .warningBold: return "\u{fc52}"
        case .warningFilled: return "\u{fc53}"
        case .warningLight: return "\u{fc54}"
        case .warningRegular: return "\u{fc55}"
        case .webexBoardBold: return "\u{fc56}"
        case .webexBoardLight: return "\u{fc57}"
        case .webexBoardRegular: return "\u{fc58}"
        case .webexCodecPlusBold: return "\u{fc59}"
        case .webexCodecPlusLight: return "\u{fc5a}"
        case .webexCodecPlusRegular: return "\u{fc5b}"
        case .webexDeskCameraBold: return "\u{fc5c}"
        case .webexDeskCameraLight: return "\u{fc5d}"
        case .webexDeskCameraRegular: return "\u{fc5e}"
        case .webexHelixBold: return "\u{fc5f}"
        case .webexHelixLight: return "\u{fc60}"
        case .webexHelixRegular: return "\u{fc61}"
        case .webexMeetingsBold: return "\u{fc62}"
        case .webexMeetingsFilled: return "\u{fc63}"
        case .webexMeetingsLight: return "\u{fc64}"
        case .webexMeetingsRegular: return "\u{fc65}"
        case .webexQuadCameraBold: return "\u{fc66}"
        case .webexQuadCameraLight: return "\u{fc67}"
        case .webexQuadCameraRegular: return "\u{fc68}"
        case .webexRoomKitBold: return "\u{fc69}"
        case .webexRoomKitLight: return "\u{fc6a}"
        case .webexRoomKitPlusBold: return "\u{fc6b}"
        case .webexRoomKitPlusLight: return "\u{fc6c}"
        case .webexRoomKitPlusRegular: return "\u{fc6d}"
        case .webexRoomKitRegular: return "\u{fc6e}"
        case .webexShareBold: return "\u{fc6f}"
        case .webexShareLight: return "\u{fc70}"
        case .webexShareRegular: return "\u{fc71}"
        case .webexTeamsBold: return "\u{fc72}"
        case .webexTeamsFilled: return "\u{fc73}"
        case .webexTeamsLight: return "\u{fc74}"
        case .webexTeamsNewBold: return "\u{fc75}"
        case .webexTeamsNewFilled: return "\u{fc76}"
        case .webexTeamsNewLight: return "\u{fc77}"
        case .webexTeamsNewRegular: return "\u{fc78}"
        case .webexTeamsRegular: return "\u{fc79}"
        case .webexTeamsRemoveBold: return "\u{fc7a}"
        case .webexTeamsRemoveLight: return "\u{fc7b}"
        case .webexTeamsRemoveRegular: return "\u{fc7c}"
        case .webhookBold: return "\u{fc7d}"
        case .webhookLight: return "\u{fc7e}"
        case .webhookRegular: return "\u{fc7f}"
        case .webinarBold: return "\u{fc80}"
        case .webinarFilled: return "\u{fc81}"
        case .webinarLight: return "\u{fc82}"
        case .webinarRegular: return "\u{fc83}"
        case .weeklyRecurringScheduleBold: return "\u{fc84}"
        case .weeklyRecurringScheduleLight: return "\u{fc85}"
        case .weeklyRecurringScheduleRegular: return "\u{fc86}"
        case .whisperAnnouncementBold: return "\u{fc87}"
        case .whisperAnnouncementFilled: return "\u{fc88}"
        case .whisperAnnouncementLight: return "\u{fc89}"
        case .whisperAnnouncementRegular: return "\u{fc8a}"
        case .whisperCoachBold: return "\u{fc8b}"
        case .whisperCoachFilled: return "\u{fc8c}"
        case .whisperCoachLight: return "\u{fc8d}"
        case .whisperCoachRegular: return "\u{fc8e}"
        case .whiteboardBold: return "\u{fc8f}"
        case .whiteboardContentBold: return "\u{fc90}"
        case .whiteboardContentFilled: return "\u{fc91}"
        case .whiteboardContentLight: return "\u{fc92}"
        case .whiteboardContentRegular: return "\u{fc93}"
        case .whiteboardFilled: return "\u{fc94}"
        case .whiteboardLight: return "\u{fc95}"
        case .whiteboardRegular: return "\u{fc96}"
        case .widgetBold: return "\u{fc97}"
        case .widgetFilled: return "\u{fc98}"
        case .widgetLight: return "\u{fc99}"
        case .widgetRegular: return "\u{fc9a}"
        case .wifiBold: return "\u{fc9b}"
        case .wifiErrorBold: return "\u{fc9c}"
        case .wifiErrorLight: return "\u{fc9d}"
        case .wifiErrorRegular: return "\u{fc9e}"
        case .wifiLight: return "\u{fc9f}"
        case .wifiRegular: return "\u{fca0}"
        case .wifiSignalGoodBold: return "\u{fca1}"
        case .wifiSignalGoodLight: return "\u{fca2}"
        case .wifiSignalGoodRegular: return "\u{fca3}"
        case .wifiSignalPoorBold: return "\u{fca4}"
        case .wifiSignalPoorLight: return "\u{fca5}"
        case .wifiSignalPoorRegular: return "\u{fca6}"
        case .wifiSignalUnstableBold: return "\u{fca7}"
        case .wifiSignalUnstableLight: return "\u{fca8}"
        case .wifiSignalUnstableRegular: return "\u{fca9}"
        case .windowCornerScrubBold: return "\u{fcaa}"
        case .windowCornerScrubLight: return "\u{fcab}"
        case .windowCornerScrubRegular: return "\u{fcac}"
        case .windowRightCornerScrubBold: return "\u{fcad}"
        case .windowRightCornerScrubLight: return "\u{fcae}"
        case .windowRightCornerScrubRegular: return "\u{fcaf}"
        case .windowVerticalScrubBold: return "\u{fcb0}"
        case .windowVerticalScrubLight: return "\u{fcb1}"
        case .windowVerticalScrubRegular: return "\u{fcb2}"
        case .workflowDeploymentsBold: return "\u{fcb3}"
        case .workflowDeploymentsFilled: return "\u{fcb4}"
        case .workflowDeploymentsLight: return "\u{fcb5}"
        case .workflowDeploymentsRegular: return "\u{fcb6}"
        case .workphoneBold: return "\u{fcb7}"
        case .workphoneLight: return "\u{fcb8}"
        case .workphoneRegular: return "\u{fcb9}"
        case .zoomInBold: return "\u{fcba}"
        case .zoomInLight: return "\u{fcbb}"
        case .zoomInRegular: return "\u{fcbc}"
        case .zoomOutBold: return "\u{fcbd}"
        case .zoomOutLight: return "\u{fcbe}"
        case .zoomOutRegular: return "\u{fcbf}"
