...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .dndPresenceBadgeFilled: return "\u{f43b}"
        case .dndPresenceBold: return "\u{f43c}"
        case .dndPresenceFilled: return "\u{f43d}"
        case .dndPresenceLight: return "\u{f43e}"
        case .dndPresenceRegular: return "\u{f43f}"
        case .dockWindowBold: return "\u{f440}"
        case .dockWindowLight: return "\u{f441}"
        case .dockWindowRegular: return "\u{f442}"
        case .documentBold: return "\u{f443}"
        case .documentCameraBold: return "\u{f444}"
        case .documentCameraDisconnectedBold: return "\u{f445}"
        case .documentCameraDisconnectedLight: return "\u{f446}"
        case .documentCameraDisconnectedRegular: return "\u{f447}"
        case .documentCameraLight: return "\u{f448}"
        case .documentCameraRegular: return "\u{f449}"
        case .documentCreateBold: return "\u{f44a}"
        case .documentCreateFilled: return "\u{f44b}"
        case .documentCreateLight: return "\u{f44c}"
        case .documentCreateRegular: return "\u{f44d}"
        case .documentFilled: return "\u{f44e}"
        case .documentLight: return "\u{f44f}"
        case .documentMoveBold: return "\u{f450}"
        case .documentMoveFilled: return "\u{f451}"
        case .documentMoveLight: return "\u{f452}"
        case .documentMoveRegular: return "\u{f453}"
        case .documentRegular: return "\u{f454}"
        case .documentShareBold: return "\u{f455}"
        case .documentShareFilled: return "\u{f456}"
        case .documentShareLight: return "\u{f457}"
        case .documentShareRegular: return "\u{f458}"
        case .doneAllBold: return "\u{f459}"
        case .doneAllLight: return "\u{f45a}"
        case .doneAllRegular: return "\u{f45b}"
        case .donutChartBold: return "\u{f45c}"
        case .donutChartFilled: return "\u{f45d}"
        case .donutChartLight: return "\u{f45e}"
        case .donutChartRegular: return "\u{f45f}"
        case .downloadBold: return "\u{f460}"
        case .downloadFilled: return "\u{f461}"
        case .downloadLight: return "\u{f462}"
        case .downloadRegular: return "\u{f463}"
        case .draftBold: return "\u{f464}"
        case .draftFilled: return "\u{f465}"
        case .draftIndicatorBold: return "\u{f466}"
        case .draftIndicatorSmallFilled: return "\u{f467}"
        case .draftLight: return "\u{f468}"
        case .draftRegular: return "\u{f469}"
        case .dragBold: return "\u{f46a}"
        case .dragLight: return "\u{f46b}"
        case .dragRegular: return "\u{f46c}"
        case .draggerHorizontalBold: return "\u{f46d}"
        case .draggerHorizontalLight: return "\u{f46e}"
        case .draggerHorizontalRegular: return "\u{f46f}"
        case .draggerVerticalBold: return "\u{f470}"
        case .draggerVerticalLight: return "\u{f471}"
        case .draggerVerticalRegular: return "\u{f472}"
        case .driveModeBold: return "\u{f473}"
        case .driveModeLight: return "\u{f474}"
        case .driveModeRegular: return "\u{f475}"
        case .dropdownBold: return "\u{f476}"
        case .dropdownLight: return "\u{f477}"
        case .dropdownRegular: return "\u{f478}"
        case .dxEightyBold: return "\u{f479}"
        case .dxEightyFilled: return "\u{f47a}"
        case .dxEightyLight: return "\u{f47b}"
        case .dxEightyRegular: return "\u{f47c}"
        case .dxSeventyBold: return "\u{f47d}"
        case .dxSeventyLight: return "\u{f47e}"
        case .dxSeventyRegular: return "\u{f47f}"
        case .editBold: return "\u{f480}"
        case .editFilled: return "\u{f481}"
        case .editLight: return "\u{f482}"
        case .editRegular: return "\u{f483}"
        case .editablePartialBold: return "\u{f484}"
        case .editablePartialLight: return "\u{f485}"
        case .editablePartialRegular: return "\u{f486}"
        case .educationBold: return "\u{f487}"
        case .educationFilled: return "\u{f488}"
        case .educationLight: return "\u{f489}"
        case .educationRegular: return "\u{f48a}"
        case .emailBold: return "\u{f48b}"
        case .emailDeliveredBold: return "\u{f48c}"
        case .emailDeliveredLight: return "\u{f48d}"
        case .emailDeliveredRegular: return "\u{f48e}"
        case .emailFailureBold: return "\u{f48f}"
        case .emailFailureLight: return "\u{f490}"
        case .emailFailureRegular: return "\u{f491}"
        case .emailFilled: return "\u{f492}"
        case .emailInviteBold: return "\u{f493}"
        case .emailInviteLight: return "\u{f494}"
        case .emailInviteRegular: return "\u{f495}"
        case .emailLight: return "\u{f496}"
        case .emailOutgoingBold: return "\u{f497}"
        case .emailOutgoingFilled: return "\u{f498}"
        case .emailOutgoingLight: return "\u{f499}"
        case .emailOutgoingRegular: return "\u{f49a}"
        case .emailReadBold: return "\u{f49b}"
        case .emailReadFilled: return "\u{f49c}"
        case .emailReadLight: return "\u{f49d}"
        case .emailReadRegular: return "\u{f49e}"
        case .emailRegular: return "\u{f49f}"
        case .emojiExcitedBold: return "\u{f4a0}"
        case .emojiExcitedFilled: return "\u{f4a1}"
        case .emojiExcitedLight: return "\u{f4a2}"
        case .emojiExcitedRegular: return "\u{f4a3}"
        case .emojiHappyBold: return "\u{f4a4}"
        case .emojiHappyFilled: return "\u{f4a5}"
        case .emojiHappyLight: return "\u{f4a6}"
        case .emojiHappyRegular: return "\u{f4a7}"
        case .emojiPassiveBold: return "\u{f4a8}"
        case .emojiPassiveFilled: return "\u{f4a9}"
        case .emojiPassiveLight: return "\u{f4aa}"
        case .emojiPassiveRegular: return "\u{f4ab}"
        case .emojiSadBold: return "\u{f4ac}"
        case .emojiSadFilled: return "\u{f4ad}"
        case .emojiSadLight: return "\u{f4ae}"
        case .emojiSadRegular: return "\u{f4af}"
        case .emojiUnhappyBold: return "\u{f4b0}"
        case .emojiUnhappyFilled: return "\u{f4b1}"
        case .emojiUnhappyLight: return "\u{f4b2}"
        case .emojiUnhappyRegular: return "\u{f4b3}"
        case .encryptionCircleFilled: return "\u{f4b4}"
        case .encryptionFilled: return "\u{f4b5}"
        case .endRemoteDesktopControlBold: return "\u{f4b6}"
        case .endRemoteDesktopControlLight: return "\u{f4b7}"
        case .endRemoteDesktopControlRegular: return "\u{f4b8}"
        case .endToEndEncryptionCircleFilled: return "\u{f4b9}"
        case .endToEndEncryptionFilled: return "\u{f4ba}"
        case .endpointBlockedBold: return "\u{f4bb}"
        case .endpointBlockedLight: return "\u{f4bc}"
        case .endpointBlockedRegular: return "\u{f4bd}"
        case .endpointBold: return "\u{f4be}"
        case .endpointGTwoBold: return "\u{f4bf}"
        case .endpointGTwoLight: return "\u{f4c0}"
        case .endpointGTwoRegular: return "\u{f4c1}"
        case .endpointGTwoSeventyBold: return "\u{f4c2}"
        case .endpointGTwoSeventyDualBold: return "\u{f4c3}"
        case .endpointGTwoSeventyDualLight: return "\u{f4c4}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4c5}"
        case .endpointGTwoSeventyLight: return "\u{f4c6}"
        case .endpointGTwoSeventyRegular: return "\u{f4c7}"
        case .endpointGTwoStandBold: return "\u{f4c8}"
        case .endpointGTwoStandLight: return "\u{f4c9}"
        case .endpointGTwoStandRegular: return "\u{f4ca}"
        case .endpointLight: return "\u{f4cb}"
        case .endpointMxEightHundredBold: return "\u{f4cc}"
        case .endpointMxEightHundredDualBold: return "\u{f4cd}"
        case .endpointMxEightHundredDualLight: return "\u{f4ce}"
        case .endpointMxEightHundredDualRegular: return "\u{f4cf}"
        case .endpointMxEightHundredLight: return "\u{f4d0}"
        case .endpointMxEightHundredRegular: return "\u{f4d1}"
        case .endpointRegular: return "\u{f4d2}"
        case .endpointStandBold: return "\u{f4d3}"
        case .endpointStandFilled: return "\u{f4d4}"
        case .endpointStandLight: return "\u{f4d5}"
        case .endpointStandRegular: return "\u{f4d6}"
        case .endpointWarningBold: return "\u{f4d7}"
        case .endpointWarningLight: return "\u{f4d8}"
        case .endpointWarningRegular: return "\u{f4d9}"
        case .enterBold: return "\u{f4da}"
        case .enterLight: return "\u{f4db}"
        case .enterRegular: return "\u{f4dc}"
        case .enterRoomBold: return "\u{f4dd}"
        case .enterRoomFilled: return "\u{f4de}"
        case .enterRoomLight: return "\u{f4df}"
        case .enterRoomRegular: return "\u{f4e0}"
        case .eraserBold: return "\u{f4e1}"
        case .eraserFilled: return "\u{f4e2}"
        case .eraserLight: return "\u{f4e3}"
        case .eraserRegular: return "\u{f4e4}"
        case .errorLegacyBadgeFilled: return "\u{f4e5}"
        case .errorLegacyBold: return "\u{f4e6}"
        case .errorLegacyFilled: return "\u{f4e7}"
        case .errorLegacyLight: return "\u{f4e8}"
        case .errorLegacyRegular: return "\u{f4e9}"
        case .ethernetBold: return "\u{f4ea}"
        case .ethernetFilled: return "\u{f4eb}"
        case .ethernetLight: return "\u{f4ec}"
        case .ethernetRegular: return "\u{f4ed}"
        case .exchangeBold: return "\u{f4ee}"
        case .exchangeLight: return "\u{f4ef}"
        case .exchangeRegular: return "\u{f4f0}"
        case .exclamationBold: return "\u{f4f1}"
        case .exclamationLight: return "\u{f4f2}"
        case .exclamationRegular: return "\u{f4f3}"
        case .excludeBold: return "\u{f4f4}"
        case .excludeLight: return "\u{f4f5}"
        case .excludeRegular: return "\u{f4f6}"
        case .existingTargetGroupBold: return "\u{f4f7}"
        case .existingTargetGroupLight: return "\u{f4f8}"
        case .existingTargetGroupRegular: return "\u{f4f9}"
        case .exitRoomBold: return "\u{f4fa}"
        case .exitRoomLight: return "\u{f4fb}"
        case .exitRoomRegular: return "\u{f4fc}"
        case .exploreBold: return "\u{f4fd}"
        case .exploreLight: return "\u{f4fe}"
        case .exploreRegular: return "\u{f4ff}"
        case .exportBold: return "\u{f500}"
        case .exportLight: return "\u{f501}"
        case .exportRegular: return "\u{f502}"
        case .extensionMobilityBold: return "\u{f503}"
        case .extensionMobilityLight: return "\u{f504}"
        case .extensionMobilityRegular: return "\u{f505}"
        case .externalMessageBold: return "\u{f506}"
        case .externalMessageLight: return "\u{f507}"
        case .externalMessageRegular: return "\u{f508}"
        case .externalUserBold: return "\u{f509}"
        case .externalUserLight: return "\u{f50a}"
        case .externalUserRegular: return "\u{f50b}"
        case .familyFontBold: return "\u{f50c}"
        case .familyFontLight: return "\u{f50d}"
        case .familyFontRegular: return "\u{f50e}"
        case .fastForwardBold: return "\u{f50f}"
        case .fastForwardLight: return "\u{f510}"
        case .fastForwardRegular: return "\u{f511}"
        case .favoriteBold: return "\u{f512}"
        case .favoriteFilled: return "\u{f513}"
        case .favoriteLight: return "\u{f514}"
        case .favoriteRegular: return "\u{f515}"
        case .favoritesBold: return "\u{f516}"
        case .favoritesFilled: return "\u{f517}"
        case .favoritesLight: return "\u{f518}"
        case .favoritesRegular: return "\u{f519}"
        case .fbwBold: return "\u{f51a}"
        case .fbwFilled: return "\u{f51b}"
        case .fbwLight: return "\u{f51c}"
        case .fbwRegular: return "\u{f51d}"
        case .ffwBold: return "\u{f51e}"
        case .ffwFilled: return "\u{f51f}"
        case .ffwLight: return "\u{f520}"
        case .ffwRegular: return "\u{f521}"
        case .fileAnalysisBold: return "\u{f522}"
        case .fileAnalysisFilled: return "\u{f523}"
        case .fileAnalysisLight: return "\u{f524}"
        case .fileAnalysisRegular: return "\u{f525}"
        case .fileAnnotationBold: return "\u{f526}"
        case .fileAnnotationFilled: return "\u{f527}"
        case .fileAnnotationLight: return "\u{f528}"
        case .fileAnnotationRegular: return "\u{f529}"
        case .fileAudioBold: return "\u{f52a}"
        case .fileAudioFilled: return "\u{f52b}"
        case .fileAudioLight: return "\u{f52c}"
        case .fileAudioRegular: return "\u{f52d}"
        case .fileBugBold: return "\u{f52e}"
        case .fileBugFilled: return "\u{f52f}"
        case .fileBugLight: return "\u{f530}"
        case .fileBugRegular: return "\u{f531}"
        case .fileCodeBold: return "\u{f532}"
        case .fileCodeFilled: return "\u{f533}"
        case .fileCodeLight: return "\u{f534}"
        case .fileCodeRegular: return "\u{f535}"
        case .fileDashboardBold: return "\u{f536}"
        case .fileDashboardFilled: return "\u{f537}"
        case .fileDashboardLight: return "\u{f538}"
        case .fileDashboardRegular: return "\u{f539}"
        case .fileExcelBold: return "\u{f53a}"
        case .fileExcelFilled: return "\u{f53b}"
        case .fileExcelLight: return "\u{f53c}"
        case .fileExcelRegular: return "\u{f53d}"
        case .fileGraphBold: return "\u{f53e}"
        case .fileGraphFilled: return "\u{f53f}"
        case .fileGraphLight: return "\u{f540}"
        case .fileGraphRegular: return "\u{f541}"
        case .fileImageBold: return "\u{f542}"
        case .fileImageFilled: return "\u{f543}"
        case .fileImageLight: return "\u{f544}"
        case .fileImageNoneBold: return "\u{f545}"
        case .fileImageNoneLight: return "\u{f546}"
        case .fileImageNoneRegular: return "\u{f547}"
        case .fileImageRegular: return "\u{f548}"
        case .fileJsBold: return "\u{f549}"
        case .fileJsFilled: return "\u{f54a}"
        case .fileJsLight: return "\u{f54b}"
        case .fileJsRegular: return "\u{f54c}"
        case .fileKeynoteBold: return "\u{f54d}"
        case .fileKeynoteFilled: return "\u{f54e}"
        case .fileKeynoteLight: return "\u{f54f}"
        case .fileKeynoteRegular: return "\u{f550}"
        case .fileLockedBold: return "\u{f551}"
        case .fileLockedFilled: return "\u{f552}"
        case .fileLockedLight: return "\u{f553}"
        case .fileLockedRegular: return "\u{f554}"
        case .fileMissingBold: return "\u{f555}"
        case .fileMissingFilled: return "\u{f556}"
        case .fileMissingLight: return "\u{f557}"
        case .fileMissingRegular: return "\u{f558}"
        case .fileMusicBold: return "\u{f559}"
        case .fileMusicFilled: return "\u{f55a}"
        case .fileMusicLight: return "\u{f55b}"
        case .fileMusicRegular: return "\u{f55c}"
        case .fileOnenoteBold: return "\u{f55d}"
        case .fileOnenoteFilled: return "\u{f55e}"
        case .fileOnenoteLight: return "\u{f55f}"
        case .fileOnenoteRegular: return "\u{f560}"
        case .filePdfBold: return "\u{f561}"
        case .filePdfFilled: return "\u{f562}"
        case .filePdfLight: return "\u{f563}"
        case .filePdfRegular: return "\u{f564}"
        case .filePowerpointBold: return "\u{f565}"
        case .filePowerpointFilled: return "\u{f566}"
        case .filePowerpointLight: return "\u{f567}"
        case .filePowerpointRegular: return "\u{f568}"
        case .fileSpreadsheetBold: return "\u{f569}"
        case .fileSpreadsheetFilled: return "\u{f56a}"
        case .fileSpreadsheetLight: return "\u{f56b}"
        case .fileSpreadsheetRegular: return "\u{f56c}"
        case .fileTextBold: return "\u{f56d}"
        case .fileTextFilled: return "\u{f56e}"
        case .fileTextLight: return "\u{f56f}"
        case .fileTextRegular: return "\u{f570}"
        case .fileThreeDBold: return "\u{f571}"
        case .fileThreeDFilled: return "\u{f572}"
        case .fileThreeDLight: return "\u{f573}"
        case .fileThreeDRegular: return "\u{f574}"
        case .fileVectorBold: return "\u{f575}"
        case .fileVectorFilled: return "\u{f576}"
        case .fileVectorLight: return "\u{f577}"
        case .fileVectorRegular: return "\u{f578}"
        case .fileVideoBold: return "\u{f579}"
        case .fileVideoFilled: return "\u{f57a}"
        case .fileVideoLight: return "\u{f57b}"
        case .fileVideoRegular: return "\u{f57c}"
        case .fileWordBold: return "\u{f57d}"
        case .fileWordFilled: return "\u{f57e}"
        case .fileWordLight: return "\u{f57f}"
        case .fileWordRegular: return "\u{f580}"
        case .fileXmlBold: return "\u{f581}"
        case .fileXmlFilled: return "\u{f582}"
        case .fileXmlLight: return "\u{f583}"
        case .fileXmlRegular: return "\u{f584}"
        case .fileZipBold: return "\u{f585}"
        case .fileZipFilled: return "\u{f586}"
        case .fileZipLight: return "\u{f587}"
        case .fileZipRegular: return "\u{f588}"
        case .filesBold: return "\u{f589}"
        case .filesFilled: return "\u{f58a}"
        case .filesLight: return "\u{f58b}"
        case .filesRegular: return "\u{f58c}"
        case .fillColourBold: return "\u{f58d}"
        case .fillColourFilled: return "\u{f58e}"
        case .fillColourLight: return "\u{f58f}"
        case .fillColourRegular: return "\u{f590}"
        case .filterBold: return "\u{f591}"
        case .filterCircleBold: return "\u{f592}"
        case .filterCircleFilled: return "\u{f593}"
        case .filterCircleLight: return "\u{f594}"
        case .filterCircleRegular: return "\u{f595}"
        case .filterLight: return "\u{f596}"
        case .filterRegular: return "\u{f597}"
        case .fitToWidthBold: return "\u{f598}"
        case .fitToWidthLight: return "\u{f599}"
        case .fitToWidthRegular: return "\u{f59a}"
        case .fitToWindowExpandBold: return "\u{f59b}"
        case .fitToWindowExpandLight: return "\u{f59c}"
        case .fitToWindowExpandRegular: return "\u{f59d}"
        case .fitToWindowShrinkBold: return "\u{f59e}"
        case .fitToWindowShrinkLight: return "\u{f59f}"
        case .fitToWindowShrinkRegular: return "\u{f5a0}"
        case .flagBold: return "\u{f5a1}"
        case .flagCircleBold: return "\u{f5a2}"
        case .flagCircleFilled: return "\u{f5a3}"
        case .flagCircleLight: return "\u{f5a4}"
        case .flagCircleRegular: return "\u{f5a5}"
        case .flagFilled: return "\u{f5a6}"
        case .flagLight: return "\u{f5a7}"
        case .flagRegular: return "\u{f5a8}"
        case .folderBold: return "\u{f5a9}"
        case .folderEditBold: return "\u{f5aa}"
        case .folderEditLight: return "\u{f5ab}"
        case .folderEditRegular: return "\u{f5ac}"
        case .folderLight: return "\u{f5ad}"
        case .folderLockBold: return "\u{f5ae}"
        case .folderLockLight: return "\u{f5af}"
        case .folderLockRegular: return "\u{f5b0}"
        case .folderRegular: return "\u{f5b1}"
        case .folderViewBold: return "\u{f5b2}"
        case .folderViewLight: return "\u{f5b3}"
        case .folderViewRegular: return "\u{f5b4}"
        case .followUpBold: return "\u{f5b5}"
        case .followUpLight: return "\u{f5b6}"
        case .followUpRegular: return "\u{f5b7}"
        case .foodBold: return "\u{f5b8}"
        case .foodFilled: return "\u{f5b9}"
        case .foodLight: return "\u{f5ba}"
        case .foodRegular: return "\u{f5bb}"
        case .formatBold: return "\u{f5bc}"
        case .formatDefaultAppBold: return "\u{f5bd}"
        case .formatDefaultAppFilled: return "\u{f5be}"
        case .formatDefaultAppLight: return "\u{f5bf}"
        case .formatDefaultAppRegular: return "\u{f5c0}"
        case .formatLight: return "\u{f5c1}"
        case .formatPanelControlBarBold: return "\u{f5c2}"
        case .formatPanelControlBarLight: return "\u{f5c3}"
        case .formatPanelControlBarRegular: return "\u{f5c4}"
        case .formatPanelControlDownBold: return "\u{f5c5}"
        case .formatPanelControlDownLight: return "\u{f5c6}"
        case .formatPanelControlDownRegular: return "\u{f5c7}"
        case .formatPanelControlLeftBold: return "\u{f5c8}"
        case .formatPanelControlLeftLight: return "\u{f5c9}"
        case .formatPanelControlLeftRegular: return "\u{f5ca}"
        case .formatPanelControlRightBold: return "\u{f5cb}"
        case .formatPanelControlRightLight: return "\u{f5cc}"
        case .formatPanelControlRightRegular: return "\u{f5cd}"
        case .formatPanelControlUpBold: return "\u{f5ce}"
        case .formatPanelControlUpDownBold: return "\u{f5cf}"
        case .formatPanelControlUpDownLight: return "\u{f5d0}"
        case .formatPanelControlUpDownRegular: return "\u{f5d1}"
        case .formatPanelControlUpLight: return "\u{f5d2}"
        case .formatPanelControlUpRegular: return "\u{f5d3}"
        case .formatRegular: return "\u{f5d4}"
        case .formatViewMixedBold: return "\u{f5d5}"
        case .formatViewMixedLight: return "\u{f5d6}"
        case .formatViewMixedRegular: return "\u{f5d7}"
        case .forwardMessageBold: return "\u{f5d8}"
        case .forwardMessageFilled: return "\u{f5d9}"
        case .forwardMessageLight: return "\u{f5da}"
        case .forwardMessageRegular: return "\u{f5db}"
        case .forwardTenSecBold: return "\u{f5dc}"
        case .forwardTenSecLight: return "\u{f5dd}"
        case .forwardTenSecRegular: return "\u{f5de}"
        case .fourColumnBold: return "\u{f5df}"
        case .fourColumnLight: return "\u{f5e0}"
        case .fourColumnRegular: return "\u{f5e1}"
        case .fourWayNavigationBold: return "\u{f5e2}"
        case .fourWayNavigationLight: return "\u{f5e3}"
        case .fourWayNavigationRegular: return "\u{f5e4}"
        case .frequencyCappingBold: return "\u{f5e5}"
        case .frequencyCappingLight: return "\u{f5e6}"
        case .frequencyCappingRegular: return "\u{f5e7}"
        case .fulfillmentBold: return "\u{f5e8}"
        case .fulfillmentLight: return "\u{f5e9}"
        case .fulfillmentRegular: return "\u{f5ea}"
        case .fullscreenBold: return "\u{f5eb}"
        case .fullscreenExitBold: return "\u{f5ec}"
        case .fullscreenExitLight: return "\u{f5ed}"
        case .fullscreenExitRegular: return "\u{f5ee}"
        case .fullscreenLight: return "\u{f5ef}"
        case .fullscreenRegular: return "\u{f5f0}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5f1}"
        case .genericDeviceVideoBold: return "\u{f5f2}"
        case .genericDeviceVideoFilled: return "\u{f5f3}"
        case .genericDeviceVideoLight: return "\u{f5f4}"
        case .genericDeviceVideoRegular: return "\u{f5f5}"
        case .gifBold: return "\u{f5f6}"
        case .gifFilled: return "\u{f5f7}"
        case .gifHorizontalBold: return "\u{f5f8}"
        case .gifHorizontalFilled: return "\u{f5f9}"
        case .gifHorizontalLight: return "\u{f5fa}"
        case .gifHorizontalRegular: return "\u{f5fb}"
        case .gifLight: return "\u{f5fc}"
        case .gifRegular: return "\u{f5fd}"
        case .giftBold: return "\u{f5fe}"
        case .giftFilled: return "\u{f5ff}"
        case .giftLight: return "\u{f600}"
        case .giftRegular: return "\u{f601}"
        case .greenLeafBold: return "\u{f602}"
        case .greenLeafFilled: return "\u{f603}"
        case .greenLeafLight: return "\u{f604}"
        case .greenLeafRegular: return "\u{f605}"
        case .greenRoomBold: return "\u{f606}"
        case .greenRoomFilled: return "\u{f607}"
        case .greenRoomLight: return "\u{f608}"
        case .greenRoomRegular: return "\u{f609}"
        case .guestIssuerBold: return "\u{f60a}"
        case .guestIssuerLight: return "\u{f60b}"
        case .guestIssuerRegular: return "\u{f60c}"
        case .guideBold: return "\u{f60d}"
        case .guideLight: return "\u{f60e}"
        case .guideRegular: return "\u{f60f}"
        case .handPointerBold: return "\u{f610}"
        case .handPointerLight: return "\u{f611}"
        case .handPointerRegular: return "\u{f612}"
        case .handlerBold: return "\u{f613}"
        case .handlerHorizontalBold: return "\u{f614}"
        case .handlerHorizontalLight: return "\u{f615}"
        case .handlerHorizontalRegular: return "\u{f616}"
        case .handlerLight: return "\u{f617}"
        case .handlerRegular: return "\u{f618}"
        case .handsetAlertBold: return "\u{f619}"
        case .handsetAlertFilled: return "\u{f61a}"
        case .handsetAlertLight: return "\u{f61b}"
        case .handsetAlertRegular: return "\u{f61c}"
        case .handsetBold: return "\u{f61d}"
        case .handsetDownSlashBold: return "\u{f61e}"
        case .handsetDownSlashFilled: return "\u{f61f}"
        case .handsetDownSlashLight: return "\u{f620}"
        case .handsetDownSlashRegular: return "\u{f621}"
        case .handsetFilled: return "\u{f622}"
        case .handsetLight: return "\u{f623}"
        case .handsetMutedBold: return "\u{f624}"
        case .handsetMutedFilled: return "\u{f625}"
        case .handsetMutedLight: return "\u{f626}"
        case .handsetMutedRegular: return "\u{f627}"
        case .handsetRegular: return "\u{f628}"
        case .handsetsArrowLeftBold: return "\u{f629}"
        case .handsetsArrowLeftLight: return "\u{f62a}"
        case .handsetsArrowLeftRegular: return "\u{f62b}"
        case .handshakeBold: return "\u{f62c}"
        case .handshakeLight: return "\u{f62d}"
        case .handshakeRegular: return "\u{f62e}"
        case .headingOneBold: return "\u{f62f}"
        case .headingOneLight: return "\u{f630}"
        case .headingOneRegular: return "\u{f631}"
        case .headingThreeBold: return "\u{f632}"
        case .headingThreeLight: return "\u{f633}"
        case .headingThreeRegular: return "\u{f634}"
        case .headingTwoBold: return "\u{f635}"
        case .headingTwoLight: return "\u{f636}"
        case .headingTwoRegular: return "\u{f637}"
        case .headphonesBold: return "\u{f638}"
        case .headphonesFilled: return "\u{f639}"
        case .headphonesLight: return "\u{f63a}"
        case .headphonesMutedBold: return "\u{f63b}"
        case .headphonesMutedFilled: return "\u{f63c}"
        case .headphonesMutedLight: return "\u{f63d}"
        case .headphonesMutedRegular: return "\u{f63e}"
        case .headphonesRegular: return "\u{f63f}"
        case .headsetAlertBold: return "\u{f640}"
        case .headsetAlertLight: return "\u{f641}"
        case .headsetAlertRegular: return "\u{f642}"
        case .headsetArrowDownBold: return "\u{f643}"
        case .headsetArrowDownFilled: return "\u{f644}"
        case .headsetArrowDownLight: return "\u{f645}"
        case .headsetArrowDownRegular: return "\u{f646}"
        case .headsetBluetoothBold: return "\u{f647}"
        case .headsetBluetoothLight: return "\u{f648}"
        case .headsetBluetoothRegular: return "\u{f649}"
        case .headsetBold: return "\u{f64a}"
        case .headsetFilled: return "\u{f64b}"
        case .headsetLight: return "\u{f64c}"
        case .headsetMutedBold: return "\u{f64d}"
        case .headsetMutedLight: return "\u{f64e}"
        case .headsetMutedRegular: return "\u{f64f}"
        case .headsetPrivateBold: return "\u{f650}"
        case .headsetPrivateLight: return "\u{f651}"
        case .headsetPrivateRegular: return "\u{f652}"
        case .headsetRegular: return "\u{f653}"
        case .hearingBold: return "\u{f654}"
        case .hearingImpairedBold: return "\u{f655}"
        case .hearingImpairedLight: return "\u{f656}"
        case .hearingImpairedRegular: return "\u{f657}"
        case .hearingLight: return "\u{f658}"
        case .hearingRegular: return "\u{f659}"
        case .helpBold: return "\u{f65a}"
        case .helpCircleBold: return "\u{f65b}"
        case .helpCircleFilled: return "\u{f65c}"
        case .helpCircleLight: return "\u{f65d}"
        case .helpCircleRegular: return "\u{f65e}"
        case .helpLight: return "\u{f65f}"
        case .helpRegular: return "\u{f660}"
        case .helpdeskBold: return "\u{f661}"
        case .helpdeskFilled: return "\u{f662}"
        case .helpdeskLight: return "\u{f663}"
        case .helpdeskRegular: return "\u{f664}"
        case .hideBold: return "\u{f665}"
        case .hideFilled: return "\u{f666}"
        case .hideLight: return "\u{f667}"
        case .hideRegular: return "\u{f668}"
        case .homeBold: return "\u{f669}"
        case .homeFilled: return "\u{f66a}"
        case .homeLight: return "\u{f66b}"
        case .homeRegular: return "\u{f66c}"
        case .horizontalLineBold: return "\u{f66d}"
        case .horizontalLineLight: return "\u{f66e}"
        case .horizontalLineRegular: return "\u{f66f}"
        case .hotelingBold: return "\u{f670}"
        case .hotelingFilled: return "\u{f671}"
        case .hotelingLight: return "\u{f672}"
        case .hotelingRegular: return "\u{f673}"
        case .humidityBold: return "\u{f674}"
        case .humidityLight: return "\u{f675}"
        case .humidityRegular: return "\u{f676}"
        case .huntGroupBold: return "\u{f677}"
        case .huntGroupFilled: return "\u{f678}"
        case .huntGroupLight: return "\u{f679}"
        case .huntGroupRegular: return "\u{f67a}"
        case .idleBold: return "\u{f67b}"
        case .idleFilled: return "\u{f67c}"
        case .idleLight: return "\u{f67d}"
        case .idleRegular: return "\u{f67e}"
        case .immediateBold: return "\u{f67f}"
        case .immediateFilled: return "\u{f680}"
        case .immediateLight: return "\u{f681}"
        case .immediateRegular: return "\u{f682}"
        case .importBold: return "\u{f683}"
        case .importLight: return "\u{f684}"
        case .importRegular: return "\u{f685}"
        case .inCommonBold: return "\u{f686}"
        case .inCommonLight: return "\u{f687}"
        case .inCommonRegular: return "\u{f688}"
        case .inboxBold: return "\u{f689}"
        case .inboxFilled: return "\u{f68a}"
        case .inboxLight: return "\u{f68b}"
        case .inboxRegular: return "\u{f68c}"
        case .includeBold: return "\u{f68d}"
        case .includeLight: return "\u{f68e}"
        case .includeRegular: return "\u{f68f}"
        case .incognitoBold: return "\u{f690}"
        case .incognitoFilled: return "\u{f691}"
        case .incognitoLight: return "\u{f692}"
        case .incognitoRegular: return "\u{f693}"
        case .incomingCallLegacyBold: return "\u{f694}"
        case .incomingCallLegacyFilled: return "\u{f695}"
        case .incomingCallLegacyLight: return "\u{f696}"
        case .incomingCallLegacyRegular: return "\u{f697}"
        case .indentDecreaseBold: return "\u{f698}"
        case .indentDecreaseLight: return "\u{f699}"
        case .indentDecreaseRegular: return "\u{f69a}"
        case .indentIncreaseBold: return "\u{f69b}"
        case .indentIncreaseLight: return "\u{f69c}"
        case .indentIncreaseRegular: return "\u{f69d}"
        case .infoBadgeFilled: return "\u{f69e}"
        case .infoCircleBold: return "\u{f69f}"
        case .infoCircleFilled: return "\u{f6a0}"
        case .infoCircleLight: return "\u{f6a1}"
        case .infoCircleRegular: return "\u{f6a2}"
        case .infoCircleTwoBold: return "\u{f6a3}"
        case .infoCircleTwoFilled: return "\u{f6a4}"
        case .infoCircleTwoLight: return "\u{f6a5}"
        case .infoCircleTwoRegular: return "\u{f6a6}"
        case .inputBold: return "\u{f6a7}"
        case .inputDisconnectedBold: return "\u{f6a8}"
        case .inputDisconnectedLight: return "\u{f6a9}"
        case .inputDisconnectedRegular: return "\u{f6aa}"
        case .inputLight: return "\u{f6ab}"
        case .inputRegular: return "\u{f6ac}"
        case .instantScheduleBold: return "\u{f6ad}"
        case .instantScheduleFilled: return "\u{f6ae}"
        case .instantScheduleLight: return "\u{f6af}"
        case .instantScheduleRegular: return "\u{f6b0}"
        case .integerBold: return "\u{f6b1}"
        case .integerFilled: return "\u{f6b2}"
        case .integerLight: return "\u{f6b3}"
        case .integerRegular: return "\u{f6b4}"
        case .integrationsBold: return "\u{f6b5}"
        case .integrationsLight: return "\u{f6b6}"
        case .integrationsRegular: return "\u{f6b7}"
        case .intelligentRoutingBold: return "\u{f6b8}"
        case .intelligentRoutingLight: return "\u{f6b9}"
        case .intelligentRoutingRegular: return "\u{f6ba}"
        case .interactionBold: return "\u{f6bb}"
        case .interactionFilled: return "\u{f6bc}"
        case .interactionLight: return "\u{f6bd}"
        case .interactionRegular: return "\u{f6be}"
        case .invitedUserBold: return "\u{f6bf}"
        case .invitedUserLight: return "\u{f6c0}"
        case .invitedUserRegular: return "\u{f6c1}"
        case .italicBold: return "\u{f6c2}"
        case .italicFilled: return "\u{f6c3}"
        case .italicLight: return "\u{f6c4}"
        case .italicRegular: return "\u{f6c5}"
        case .joinAudioBold: return "\u{f6c6}"
        case .joinAudioFilled: return "\u{f6c7}"
        case .joinAudioLight: return "\u{f6c8}"
        case .joinAudioRegular: return "\u{f6c9}"
        case .keepInTouchBold: return "\u{f6ca}"
        case .keepInTouchFilled: return "\u{f6cb}"
        case .keepInTouchLight: return "\u{f6cc}"
        case .keepInTouchRegular: return "\u{f6cd}"
        case .keyboardBold: return "\u{f6ce}"
        case .keyboardCloseBold: return "\u{f6cf}"
        case .keyboardCloseLight: return "\u{f6d0}"
        case .keyboardCloseRegular: return "\u{f6d1}"
        case .keyboardLight: return "\u{f6d2}"
        case .keyboardRegular: return "\u{f6d3}"
        case .languageBold: return "\u{f6d4}"
        case .languageFilled: return "\u{f6d5}"
        case .languageLight: return "\u{f6d6}"
        case .languageRegular: return "\u{f6d7}"
        case .laptopBold: return "\u{f6d8}"
        case .laptopDisconnectedBold: return "\u{f6d9}"
        case .laptopDisconnectedLight: return "\u{f6da}"
        case .laptopDisconnectedRegular: return "\u{f6db}"
        case .laptopFilled: return "\u{f6dc}"
        case .laptopLight: return "\u{f6dd}"
        case .laptopRegular: return "\u{f6de}"
        case .laserPointerBold: return "\u{f6df}"
        case .laserPointerCursorBlackLight: return "\u{f6e0}"
        case .laserPointerCursorBlueLight: return "\u{f6e1}"
        case .laserPointerCursorGreenLight: return "\u{f6e2}"
        case .laserPointerCursorPurpleLight: return "\u{f6e3}"
        case .laserPointerCursorRedLight: return "\u{f6e4}"
        case .laserPointerCursorWhiteLight: return "\u{f6e5}"
        case .laserPointerCursorYellowLight: return "\u{f6e6}"
        case .laserPointerFilled: return "\u{f6e7}"
        case .laserPointerLight: return "\u{f6e8}"
        case .laserPointerRegular: return "\u{f6e9}"
        case .launchBold: return "\u{f6ea}"
        case .launchLight: return "\u{f6eb}"
        case .launchRegular: return "\u{f6ec}"
        case .layoutSideBySideVerticalBold: return "\u{f6ed}"
        case .layoutSideBySideVerticalFilled: return "\u{f6ee}"
        case .layoutSideBySideVerticalLight: return "\u{f6ef}"
        case .layoutSideBySideVerticalRegular: return "\u{f6f0}"
        case .leaveBreakoutSessionBold: return "\u{f6f1}"
        case .leaveBreakoutSessionLight: return "\u{f6f2}"
        case .leaveBreakoutSessionRegular: return "\u{f6f3}"
        case .leaveDeviceBold: return "\u{f6f4}"
        case .leaveDeviceLight: return "\u{f6f5}"
        case .leaveDeviceRegular: return "\u{f6f6}"
        case .likeBold: return "\u{f6f7}"
        case .likeFilled: return "\u{f6f8}"
        case .likeLight: return "\u{f6f9}"
        case .likeRegular: return "\u{f6fa}"
        case .linkBold: return "\u{f6fb}"
        case .linkLight: return "\u{f6fc}"
        case .linkRegular: return "\u{f6fd}"
        case .listBulletedBold: return "\u{f6fe}"
        case .listBulletedLight: return "\u{f6ff}"
        case .listBulletedRegular: return "\u{f700}"
        case .listMenuBold: return "\u{f701}"
        case .listMenuLight: return "\u{f702}"
        case .listMenuRegular: return "\u{f703}"
        case .listNumberedBold: return "\u{f704}"
        case .listNumberedLight: return "\u{f705}"
        case .listNumberedRegular: return "\u{f706}"
        case .liveBold: return "\u{f707}"
        case .liveFilled: return "\u{f708}"
        case .liveLight: return "\u{f709}"
        case .liveRegular: return "\u{f70a}"
        case .locationBold: return "\u{f70b}"
        case .locationFilled: return "\u{f70c}"
        case .locationLight: return "\u{f70d}"
        case .locationRegular: return "\u{f70e}"
        case .longTextBoxBold: return "\u{f70f}"
        case .longTextBoxLight: return "\u{f710}"
        case .longTextBoxRegular: return "\u{f711}"
        case .lowerHandBold: return "\u{f712}"
        case .lowerHandLight: return "\u{f713}"
        case .lowerHandRegular: return "\u{f714}"
        case .magicPenBold: return "\u{f715}"
        case .magicPenFilled: return "\u{f716}"
        case .magicPenLight: return "\u{f717}"
        case .magicPenRegular: return "\u{f718}"
        case .markAsUnreadBold: return "\u{f719}"
        case .markAsUnreadLight: return "\u{f71a}"
        case .markAsUnreadRegular: return "\u{f71b}"
        case .markdownBold: return "\u{f71c}"
        case .markdownFilled: return "\u{f71d}"
        case .markdownLight: return "\u{f71e}"
        case .markdownRegular: return "\u{f71f}"
        case .markerBold: return "\u{f720}"
        case .markerFilled: return "\u{f721}"
        case .markerLight: return "\u{f722}"
        case .markerRegular: return "\u{f723}"
        case .maximizeBold: return "\u{f724}"
        case .maximizeLight: return "\u{f725}"
        case .maximizeRegular: return "\u{f726}"
        case .mediaPlayerBold: return "\u{f727}"
        case .mediaPlayerLight: return "\u{f728}"
        case .mediaPlayerRegular: return "\u{f729}"
        case .mediaQualityGoodBold: return "\u{f72a}"
        case .mediaQualityGoodFilled: return "\u{f72b}"
        case .mediaQualityGoodLight: return "\u{f72c}"
        case .mediaQualityGoodRegular: return "\u{f72d}"
        case .mediaQualityPoorBold: return "\u{f72e}"
        case .mediaQualityPoorFilled: return "\u{f72f}"
        case .mediaQualityPoorLight: return "\u{f730}"
        case .mediaQualityPoorRegular: return "\u{f731}"
        case .mediaQualityUnstableBold: return "\u{f732}"
        case .mediaQualityUnstableFilled: return "\u{f733}"
        case .mediaQualityUnstableLight: return "\u{f734}"
        case .mediaQualityUnstableRegular: return "\u{f735}"
        case .meetBold: return "\u{f736}"
        case .meetEndBold: return "\u{f737}"
        case .meetEndLight: return "\u{f738}"
        case .meetEndRegular: return "\u{f739}"
        case .meetFilled: return "\u{f73a}"
        case .meetLight: return "\u{f73b}"
        case .meetRegular: return "\u{f73c}"
        case .meetingSummaryBold: return "\u{f73d}"
        case .meetingSummaryFilled: return "\u{f73e}"
        case .meetingSummaryLight: return "\u{f73f}"
        case .meetingSummaryRegular: return "\u{f740}"
        case .meetingsBold: return "\u{f741}"
        case .meetingsFilled: return "\u{f742}"
        case .meetingsFocusMonthBold: return "\u{f743}"
        case .meetingsFocusMonthLight: return "\u{f744}"
        case .meetingsFocusMonthRegular: return "\u{f745}"
        case .meetingsFocusOneDayBold: return "\u{f746}"
        case .meetingsFocusOneDayLight: return "\u{f747}"
        case .meetingsFocusOneDayRegular: return "\u{f748}"
        case .meetingsFocusThreeDayBold: return "\u{f749}"
        case .meetingsFocusThreeDayLight: return "\u{f74a}"
        case .meetingsFocusThreeDayRegular: return "\u{f74b}"
        case .meetingsFocusUpcomingBold: return "\u{f74c}"
        case .meetingsFocusUpcomingLight: return "\u{f74d}"
        case .meetingsFocusUpcomingRegular: return "\u{f74e}"
        case .meetingsLight: return "\u{f74f}"
        case .meetingsPresenceBadgeFilled: return "\u{f750}"
        case .meetingsPresenceBold: return "\u{f751}"
        case .meetingsPresenceFilled: return "\u{f752}"
        case .meetingsPresenceLight: return "\u{f753}"
        case .meetingsPresenceRegular: return "\u{f754}"
        case .meetingsRegular: return "\u{f755}"
        case .meetingsTeamBold: return "\u{f756}"
        case .meetingsTeamFilled: return "\u{f757}"
        case .meetingsTeamLight: return "\u{f758}"
        case .meetingsTeamNewBold: return "\u{f759}"
        case .meetingsTeamNewLight: return "\u{f75a}"
        case .meetingsTeamNewRegular: return "\u{f75b}"
        case .meetingsTeamRegular: return "\u{f75c}"
        case .mentionBold: return "\u{f75d}"
        case .mentionLight: return "\u{f75e}"
        case .mentionRegular: return "\u{f75f}"
        case .messageQueingBold: return "\u{f760}"
        case .messageQueingLight: return "\u{f761}"
        case .messageQueingRegular: return "\u{f762}"
        case .microphoneBold: return "\u{f763}"
        case .microphoneFilled: return "\u{f764}"
        case .microphoneHardMutedBold: return "\u{f765}"
        case .microphoneHardMutedCircleFilled: return "\u{f766}"
        case .microphoneHardMutedLight: return "\u{f767}"
        case .microphoneHardMutedRegular: return "\u{f768}"
        case .microphoneLight: return "\u{f769}"
        case .microphoneMusicModeBold: return "\u{f76a}"
        case .microphoneMusicModeLight: return "\u{f76b}"
        case .microphoneMusicModeOnBold: return "\u{f76c}"
        case .microphoneMusicModeOnLight: return "\u{f76d}"
        case .microphoneMusicModeOnRegular: return "\u{f76e}"
        case .microphoneMusicModeRegular: return "\u{f76f}"
        case .microphoneMutedBold: return "\u{f770}"
        case .microphoneMutedCircleFilled: return "\u{f771}"
        case .microphoneMutedFilled: return "\u{f772}"
        case .microphoneMutedLight: return "\u{f773}"
        case .microphoneMutedRegular: return "\u{f774}"
        case .microphoneOnBold: return "\u{f775}"
        case .microphoneOnLight: return "\u{f776}"
        case .microphoneOnRegular: return "\u{f777}"
        case .microphoneOptAllBold: return "\u{f778}"
        case .microphoneOptAllLight: return "\u{f779}"
        case .microphoneOptAllMutedBold: return "\u{f77a}"
        case .microphoneOptAllMutedLight: return "\u{f77b}"
        case .microphoneOptAllMutedRegular: return "\u{f77c}"
        case .microphoneOptAllOnBold: return "\u{f77d}"
        case .microphoneOptAllOnLight: return "\u{f77e}"
        case .microphoneOptAllOnRegular: return "\u{f77f}"
        case .microphoneOptAllRegular: return "\u{f780}"
        case .microphoneOptMeBold: return "\u{f781}"
        case .microphoneOptMeLight: return "\u{f782}"
        case .microphoneOptMeMutedBold: return "\u{f783}"
        case .microphoneOptMeMutedLight: return "\u{f784}"
        case .microphoneOptMeMutedRegular: return "\u{f785}"
        case .microphoneOptMeOnBold: return "\u{f786}"
        case .microphoneOptMeOnLight: return "\u{f787}"
        case .microphoneOptMeOnRegular: return "\u{f788}"
        case .microphoneOptMeRegular: return "\u{f789}"
        case .microphoneRegular: return "\u{f78a}"
        case .mindMapBold: return "\u{f78b}"
        case .mindMapLight: return "\u{f78c}"
        case .mindMapRegular: return "\u{f78d}"
        case .minimizeBold: return "\u{f78e}"
        case .minimizeLight: return "\u{f78f}"
        case .minimizeRegular: return "\u{f790}"
        case .minusBold: return "\u{f791}"
        case .minusLight: return "\u{f792}"
        case .minusRegular: return "\u{f793}"
        case .mirrorBold: return "\u{f794}"
        case .mirrorFilled: return "\u{f795}"
        case .mirrorLight: return "\u{f796}"
        case .mirrorRegular: return "\u{f797}"
        case .mmsFilled: return "\u{f798}"
        case .moderatorBold: return "\u{f799}"
        case .moderatorLight: return "\u{f79a}"
        case .moderatorRegular: return "\u{f79b}"
        case .monitoringBold: return "\u{f79c}"
        case .monitoringLight: return "\u{f79d}"
        case .monitoringRegular: return "\u{f79e}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f79f}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7a0}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7a1}"
        case .moreAdrBold: return "\u{f7a2}"
        case .moreAdrLight: return "\u{f7a3}"
        case .moreAdrRegular: return "\u{f7a4}"
        case .moreBold: return "\u{f7a5}"
        case .moreCircleBold: return "\u{f7a6}"
        case .moreCircleFilled: return "\u{f7a7}"
        case .moreCircleLight: return "\u{f7a8}"
        case .moreCircleRegular: return "\u{f7a9}"
        case .moreLight: return "\u{f7aa}"
        case .moreRegular: return "\u{f7ab}"
        case .mouseCursorBold: return "\u{f7ac}"
        case .mouseCursorLight: return "\u{f7ad}"
        case .mouseCursorRegular: return "\u{f7ae}"
        case .moveCallInAdrBold: return "\u{f7af}"
        case .moveCallInAdrLight: return "\u{f7b0}"
        case .moveCallInAdrRegular: return "\u{f7b1}"
        case .moveCallInIphBold: return "\u{f7b2}"
        case .moveCallInIphLight: return "\u{f7b3}"
        case .moveCallInIphRegular: return "\u{f7b4}"
        case .moveCallInLaptopBold: return "\u{f7b5}"
        case .moveCallInLaptopLight: return "\u{f7b6}"
        case .moveCallInLaptopRegular: return "\u{f7b7}"
        case .moveCallInOutAdrBold: return "\u{f7b8}"
        case .moveCallInOutAdrLight: return "\u{f7b9}"
        case .moveCallInOutAdrRegular: return "\u{f7ba}"
        case .moveCallInOutIphBold: return "\u{f7bb}"
        case .moveCallInOutIphLight: return "\u{f7bc}"
        case .moveCallInOutIphRegular: return "\u{f7bd}"
        case .moveCallInTabletBold: return "\u{f7be}"
        case .moveCallInTabletLight: return "\u{f7bf}"
        case .moveCallInTabletRegular: return "\u{f7c0}"
        case .moveCallOutAdrBold: return "\u{f7c1}"
        case .moveCallOutAdrLight: return "\u{f7c2}"
        case .moveCallOutAdrRegular: return "\u{f7c3}"
        case .moveCallOutIphBold: return "\u{f7c4}"
        case .moveCallOutIphLight: return "\u{f7c5}"
        case .moveCallOutIphRegular: return "\u{f7c6}"
        case .moveCallOutLaptopBold: return "\u{f7c7}"
        case .moveCallOutLaptopLight: return "\u{f7c8}"
        case .moveCallOutLaptopRegular: return "\u{f7c9}"
        case .moveCallOutTabletBold: return "\u{f7ca}"
        case .moveCallOutTabletLight: return "\u{f7cb}"
        case .moveCallOutTabletRegular: return "\u{f7cc}"
        case .moveToScreenBold: return "\u{f7cd}"
        case .moveToScreenLight: return "\u{f7ce}"
        case .moveToScreenRegular: return "\u{f7cf}"
        case .multilineChartBold: return "\u{f7d0}"
        case .multilineChartFilled: return "\u{f7d1}"
        case .multilineChartLight: return "\u{f7d2}"
        case .multilineChartRegular: return "\u{f7d3}"
        case .multimediaBold: return "\u{f7d4}"
        case .multimediaFilled: return "\u{f7d5}"
        case .multimediaLight: return "\u{f7d6}"
        case .multimediaRegular: return "\u{f7d7}"
        case .multipledDevicesBold: return "\u{f7d8}"
        case .multipledDevicesLight: return "\u{f7d9}"
        case .multipledDevicesRegular: return "\u{f7da}"
        case .musicModeCircleBold: return "\u{f7db}"
        case .musicModeCircleFilled: return "\u{f7dc}"
        case .musicModeCircleLight: return "\u{f7dd}"
        case .musicModeCircleRegular: return "\u{f7de}"
        case .musicNoteBold: return "\u{f7df}"
        case .musicNoteFilled: return "\u{f7e0}"
        case .musicNoteLight: return "\u{f7e1}"
        case .musicNoteRegular: return "\u{f7e2}"
        case .muteOnEntryBold: return "\u{f7e3}"
        case .muteOnEntryFilled: return "\u{f7e4}"
        case .muteOnEntryLight: return "\u{f7e5}"
        case .muteOnEntryRegular: return "\u{f7e6}"
        case .newManagerBold: return "\u{f7e7}"
        case .newManagerLight: return "\u{f7e8}"
        case .newManagerRegular: return "\u{f7e9}"
        case .newTitleBold: return "\u{f7ea}"
        case .newTitleLight: return "\u{f7eb}"
        case .newTitleRegular: return "\u{f7ec}"
        case .newVoicemailBold: return "\u{f7ed}"
        case .newVoicemailLight: return "\u{f7ee}"
        case .newVoicemailRegular: return "\u{f7ef}"
        case .newWhiteboardBold: return "\u{f7f0}"
        case .newWhiteboardLight: return "\u{f7f1}"
        case .newWhiteboardRegular: return "\u{f7f2}"
        case .nextBold: return "\u{f7f3}"
        case .nextLight: return "\u{f7f4}"
        case .nextRegular: return "\u{f7f5}"
        case .noDevicesBold: return "\u{f7f6}"
        case .noDevicesLight: return "\u{f7f7}"
        case .noDevicesRegular: return "\u{f7f8}"
        case .noiseDetectedCanceledFilled: return "\u{f7f9}"
        case .noiseDetectedFilled: return "\u{f7fa}"
        case .noiseNoneCanceledFilled: return "\u{f7fb}"
        case .noiseNoneFilled: return "\u{f7fc}"
        case .noiseRemovalBold: return "\u{f7fd}"
        case .noiseRemovalLight: return "\u{f7fe}"
        case .noiseRemovalRegular: return "\u{f7ff}"
        case .noteBold: return "\u{f800}"
        case .noteLight: return "\u{f801}"
        case .notePptBold: return "\u{f802}"
        case .notePptLight: return "\u{f803}"
        case .notePptRegular: return "\u{f804}"
        case .noteRegular: return "\u{f805}"
        case .notesBold: return "\u{f806}"
        case .notesFilled: return "\u{f807}"
        case .notesLight: return "\u{f808}"
        case .notesRegular: return "\u{f809}"
        case .numberBold: return "\u{f80a}"
        case .numberLight: return "\u{f80b}"
        case .numberRegular: return "\u{f80c}"
        case .oldRemoteBold: return "\u{f80d}"
        case .oldRemoteLight: return "\u{f80e}"
        case .oldRemoteRegular: return "\u{f80f}"
        case .oldTouchBold: return "\u{f810}"
        case .oldTouchLight: return "\u{f811}"
        case .oldTouchRegular: return "\u{f812}"
        case .oneColumnBold: return "\u{f813}"
        case .oneColumnLight: return "\u{f814}"
        case .oneColumnRegular: return "\u{f815}"
        case .oneTimeBold: return "\u{f816}"
        case .oneTimeLight: return "\u{f817}"
        case .oneTimeRegular: return "\u{f818}"
        case .openInFolderBold: return "\u{f819}"
        case .openInFolderLight: return "\u{f81a}"
        case .openInFolderRegular: return "\u{f81b}"
        case .openPagesBold: return "\u{f81c}"
        case .openPagesLight: return "\u{f81d}"
        case .openPagesRegular: return "\u{f81e}"
        case .otherNumberBold: return "\u{f81f}"
        case .otherNumberFilled: return "\u{f820}"
        case .otherNumberLight: return "\u{f821}"
        case .otherNumberRegular: return "\u{f822}"
        case .otherNumberWarningBold: return "\u{f823}"
        case .otherNumberWarningLight: return "\u{f824}"
        case .otherNumberWarningRegular: return "\u{f825}"
        case .outgoingCallLegacyBold: return "\u{f826}"
        case .outgoingCallLegacyFilled: return "\u{f827}"
        case .outgoingCallLegacyLight: return "\u{f828}"
        case .outgoingCallLegacyRegular: return "\u{f829}"
        case .overflowLeftBold: return "\u{f82a}"
        case .overflowLeftLight: return "\u{f82b}"
        case .overflowLeftRegular: return "\u{f82c}"
        case .overflowRightBold: return "\u{f82d}"
        case .overflowRightLight: return "\u{f82e}"
        case .overflowRightRegular: return "\u{f82f}"
        case .pairedCameraBold: return "\u{f830}"
        case .pairedCameraLight: return "\u{f831}"
        case .pairedCameraRegular: return "\u{f832}"
        case .pairedDeviceBold: return "\u{f833}"
        case .pairedDeviceLight: return "\u{f834}"
        case .pairedDeviceRegular: return "\u{f835}"
        case .pairedHandsetBold: return "\u{f836}"
        case .pairedHandsetLight: return "\u{f837}"
        case .pairedHandsetRegular: return "\u{f838}"
        case .pairingBold: return "\u{f839}"
        case .pairingLight: return "\u{f83a}"
        case .pairingRegular: return "\u{f83b}"
        case .parenthesisBold: return "\u{f83c}"
        case .parenthesisFilled: return "\u{f83d}"
        case .parenthesisLight: return "\u{f83e}"
        case .parenthesisRegular: return "\u{f83f}"
        case .parkedBold: return "\u{f840}"
        case .parkedFilled: return "\u{f841}"
        case .parkedLight: return "\u{f842}"
        case .parkedRegular: return "\u{f843}"
        case .parseBold: return "\u{f844}"
        case .parseLight: return "\u{f845}"
        case .parseRegular: return "\u{f846}"
        case .partialBold: return "\u{f847}"
        case .partialLight: return "\u{f848}"
        case .partialRegular: return "\u{f849}"
        case .participantAddBold: return "\u{f84a}"
        case .participantAddLight: return "\u{f84b}"
        case .participantAddRegular: return "\u{f84c}"
        case .participantBlockedBold: return "\u{f84d}"
        case .participantBlockedLight: return "\u{f84e}"
        case .participantBlockedRegular: return "\u{f84f}"
        case .participantBold: return "\u{f850}"
        case .participantFilled: return "\u{f851}"
        case .participantLight: return "\u{f852}"
        case .participantListBold: return "\u{f853}"
        case .participantListFilled: return "\u{f854}"
        case .participantListLight: return "\u{f855}"
        case .participantListRegular: return "\u{f856}"
        case .participantRegular: return "\u{f857}"
        case .participantRemoveBold: return "\u{f858}"
        case .participantRemoveLight: return "\u{f859}"
        case .participantRemoveRegular: return "\u{f85a}"
        case .participantUnknownBold: return "\u{f85b}"
        case .participantUnknownLight: return "\u{f85c}"
        case .participantUnknownRegular: return "\u{f85d}"
        case .passMouseBold: return "\u{f85e}"
        case .passMouseLight: return "\u{f85f}"
        case .passMouseRegular: return "\u{f860}"
        case .pauseBadgeFilled: return "\u{f861}"
        case .pauseBold: return "\u{f862}"
        case .pauseFilled: return "\u{f863}"
        case .pauseLight: return "\u{f864}"
        case .pauseRegular: return "\u{f865}"
        case .peopleAddBold: return "\u{f866}"
        case .peopleAddFilled: return "\u{f867}"
        case .peopleAddLight: return "\u{f868}"
        case .peopleAddRegular: return "\u{f869}"
        case .peopleBold: return "\u{f86a}"
        case .peopleCircleBold: return "\u{f86b}"
        case .peopleCircleFilled: return "\u{f86c}"
        case .peopleCircleLight: return "\u{f86d}"
        case .peopleCircleRegular: return "\u{f86e}"
        case .peopleFilled: return "\u{f86f}"
        case .peopleInsightsBold: return "\u{f870}"
        case .peopleInsightsFilled: return "\u{f871}"
        case .peopleInsightsLight: return "\u{f872}"
        case .peopleInsightsRegular: return "\u{f873}"
        case .peopleLight: return "\u{f874}"
        case .peopleRegular: return "\u{f875}"
        case .phoneAlertBold: return "\u{f876}"
        case .phoneAlertLight: return "\u{f877}"
        case .phoneAlertRegular: return "\u{f878}"
        case .phoneBadgeFilled: return "\u{f879}"
        case .phoneBold: return "\u{f87a}"
        case .phoneFilled: return "\u{f87b}"
        case .phoneLight: return "\u{f87c}"
        case .phoneMutedBold: return "\u{f87d}"
        case .phoneMutedLight: return "\u{f87e}"
        case .phoneMutedRegular: return "\u{f87f}"
        case .phonePrivateBold: return "\u{f880}"
        case .phonePrivateLight: return "\u{f881}"
        case .phonePrivateRegular: return "\u{f882}"
        case .phoneRegular: return "\u{f883}"
        case .phoneReplyAllBold: return "\u{f884}"
        case .phoneReplyAllLight: return "\u{f885}"
        case .phoneReplyAllRegular: return "\u{f886}"
        case .phoneReplyBold: return "\u{f887}"
        case .phoneReplyLight: return "\u{f888}"
        case .phoneReplyRegular: return "\u{f889}"
        case .pickerBold: return "\u{f88a}"
        case .pickerLight: return "\u{f88b}"
        case .pickerRegular: return "\u{f88c}"
        case .pieChartBold: return "\u{f88d}"
        case .pieChartFilled: return "\u{f88e}"
        case .pieChartLight: return "\u{f88f}"
        case .pieChartRegular: return "\u{f890}"
        case .pinBold: return "\u{f891}"
        case .pinFilled: return "\u{f892}"
        case .pinLight: return "\u{f893}"
        case .pinListActivityBold: return "\u{f894}"
        case .pinListActivityLight: return "\u{f895}"
        case .pinListActivityRegular: return "\u{f896}"
        case .pinListBold: return "\u{f897}"
        case .pinListLight: return "\u{f898}"
        case .pinListRegular: return "\u{f899}"
        case .pinMutedBold: return "\u{f89a}"
        case .pinMutedFilled: return "\u{f89b}"
        case .pinMutedLight: return "\u{f89c}"
        case .pinMutedRegular: return "\u{f89d}"
        case .pinRegular: return "\u{f89e}"
        case .pipBold: return "\u{f89f}"
        case .pipEnterBold: return "\u{f8a0}"
        case .pipEnterLight: return "\u{f8a1}"
        case .pipEnterRegular: return "\u{f8a2}"
        case .pipExitBold: return "\u{f8a3}"
        case .pipExitLight: return "\u{f8a4}"
        case .pipExitRegular: return "\u{f8a5}"
        case .pipFilled: return "\u{f8a6}"
        case .pipLight: return "\u{f8a7}"
        case .pipRegular: return "\u{f8a8}"
        case .placeholderBold: return "\u{f8a9}"
        case .placeholderFilled: return "\u{f8aa}"
        case .placeholderLight: return "\u{f8ab}"
        case .placeholderRegular: return "\u{f8ac}"
        case .playBold: return "\u{f8ad}"
        case .playCircleBold: return "\u{f8ae}"
        case .playCircleFilled: return "\u{f8af}"
        case .playCircleLight: return "\u{f8b0}"
        case .playCircleRegular: return "\u{f8b1}"
        case .playFilled: return "\u{f8b2}"
        case .playLight: return "\u{f8b3}"
        case .playRegular: return "\u{f8b4}"
        case .plugAcBold: return "\u{f8b5}"
        case .plugAcLight: return "\u{f8b6}"
        case .plugAcRegular: return "\u{f8b7}"
        case .plusBold: return "\u{f8b8}"
        case .plusCircleBold: return "\u{f8b9}"
        case .plusCircleFilled: return "\u{f8ba}"
        case .plusCircleLight: return "\u{f8bb}"
        case .plusCircleRegular: return "\u{f8bc}"
        case .plusLight: return "\u{f8bd}"
        case .plusRegular: return "\u{f8be}"
        case .pmrBold: return "\u{f8bf}"
        case .pmrFilled: return "\u{f8c0}"
        case .pmrLight: return "\u{f8c1}"
        case .pmrRegular: return "\u{f8c2}"
        case .pollBold: return "\u{f8c3}"
        case .pollFilled: return "\u{f8c4}"
        case .pollLight: return "\u{f8c5}"
        case .pollRegular: return "\u{f8c6}"
        case .popInBold: return "\u{f8c7}"
        case .popInLight: return "\u{f8c8}"
        case .popInRegular: return "\u{f8c9}"
        case .popOutBold: return "\u{f8ca}"
        case .popOutLight: return "\u{f8cb}"
        case .popOutRegular: return "\u{f8cc}"
        case .popUpBold: return "\u{f8cd}"
        case .popUpLight: return "\u{f8ce}"
        case .popUpRegular: return "\u{f8cf}"
        case .portraitLandscapeBold: return "\u{f8d0}"
        case .portraitLandscapeLight: return "\u{f8d1}"
        case .portraitLandscapeRegular: return "\u{f8d2}"
        case .potentialFraudBold: return "\u{f8d3}"
        case .potentialFraudFilled: return "\u{f8d4}"
        case .potentialFraudLight: return "\u{f8d5}"
        case .potentialFraudRegular: return "\u{f8d6}"
        case .powerAcBold: return "\u{f8d7}"
        case .powerAcLight: return "\u{f8d8}"
        case .powerAcRegular: return "\u{f8d9}"
        case .powerBold: return "\u{f8da}"
        case .powerLight: return "\u{f8db}"
        case .powerRegular: return "\u{f8dc}"
        case .preHeaderBold: return "\u{f8dd}"
        case .preHeaderLight: return "\u{f8de}"
        case .preHeaderRegular: return "\u{f8df}"
        case .premiumBold: return "\u{f8e0}"
        case .premiumLight: return "\u{f8e1}"
        case .premiumRegular: return "\u{f8e2}"
        case .presentationBold: return "\u{f8e3}"
        case .presentationLight: return "\u{f8e4}"
        case .presentationRegular: return "\u{f8e5}"
        case .preventDownloadBold: return "\u{f8e6}"
        case .preventDownloadFilled: return "\u{f8e7}"
        case .preventDownloadLight: return "\u{f8e8}"
        case .preventDownloadRegular: return "\u{f8e9}"
        case .primaryParticipantBold: return "\u{f8ea}"
        case .primaryParticipantLight: return "\u{f8eb}"
        case .primaryParticipantRegular: return "\u{f8ec}"
        case .printBold: return "\u{f8ed}"
        case .printLight: return "\u{f8ee}"
        case .printRegular: return "\u{f8ef}"
        case .priorityBadgeFilled: return "\u{f8f0}"
        case .priorityCircleBold: return "\u{f8f1}"
        case .priorityCircleFilled: return "\u{f8f2}"
        case .priorityCircleLight: return "\u{f8f3}"
        case .priorityCircleRegular: return "\u{f8f4}"
        case .priorityCircleTwoBold: return "\u{f8f5}"
        case .priorityCircleTwoFilled: return "\u{f8f6}"
        case .priorityCircleTwoLight: return "\u{f8f7}"
        case .priorityCircleTwoRegular: return "\u{f8f8}"
        case .priorityWaveBold: return "\u{f8f9}"
        case .priorityWaveLight: return "\u{f8fa}"
        case .priorityWaveRegular: return "\u{f8fb}"
        case .privacyCircleBold: return "\u{f8fc}"
        case .privacyCircleFilled: return "\u{f8fd}"
        case .privacyCircleLight: return "\u{f8fe}"
        case .privacyCircleRegular: return "\u{f8ff}"
        case .privateBold: return "\u{f900}"
        case .privateCircleBold: return "\u{f901}"
        case .privateCircleFilled: return "\u{f902}"
        case .privateCircleLight: return "\u{f903}"
        case .privateCircleRegular: return "\u{f904}"
        case .privateLight: return "\u{f905}"
        case .privateMeetingBold: return "\u{f906}"
        case .privateMeetingLight: return "\u{f907}"
        case .privateMeetingRegular: return "\u{f908}"
        case .privateRegular: return "\u{f909}"
        case .productDemoBold: return "\u{f90a}"
        case .productDemoLight: return "\u{f90b}"
        case .productDemoRegular: return "\u{f90c}"
        case .promptsAiBold: return "\u{f90d}"
        case .promptsAiLight: return "\u{f90e}"
        case .promptsAiRegular: return "\u{f90f}"
        case .proximityBold: return "\u{f910}"
        case .proximityLight: return "\u{f911}"
        case .proximityMutedBold: return "\u{f912}"
        case .proximityMutedLight: return "\u{f913}"
        case .proximityMutedRegular: return "\u{f914}"
        case .proximityRegular: return "\u{f915}"
        case .proximityVideoBold: return "\u{f916}"
        case .proximityVideoLight: return "\u{f917}"
        case .proximityVideoRegular: return "\u{f918}"
        case .ptoPresenceBold: return "\u{f919}"
        case .ptoPresenceFilled: return "\u{f91a}"
        case .ptoPresenceLight: return "\u{f91b}"
        case .ptoPresenceRegular: return "\u{f91c}"
        case .pullCallBold: return "\u{f91d}"
        case .pullCallFilled: return "\u{f91e}"
        case .pullCallLight: return "\u{f91f}"
        case .pullCallRegular: return "\u{f920}"
        case .qABold: return "\u{f921}"
        case .qALight: return "\u{f922}"
        case .qARegular: return "\u{f923}"
        case .qrCodeBold: return "\u{f924}"
        case .qrCodeLight: return "\u{f925}"
        case .qrCodeRegular: return "\u{f926}"
        case .qrCodeScanBold: return "\u{f927}"
        case .qrCodeScanLight: return "\u{f928}"
        case .qrCodeScanRegular: return "\u{f929}"
        case .qualityBold: return "\u{f92a}"
        case .qualityLight: return "\u{f92b}"
        case .qualityRegular: return "\u{f92c}"
        case .queueContactBold: return "\u{f92d}"
        case .queueContactFilled: return "\u{f92e}"
        case .queueContactLight: return "\u{f92f}"
        case .queueContactRegular: return "\u{f930}"
        case .quietBold: return "\u{f931}"
        case .quietHoursPresenceBold: return "\u{f932}"
        case .quietHoursPresenceFilled: return "\u{f933}"
        case .quietHoursPresenceLight: return "\u{f934}"
        case .quietHoursPresenceRegular: return "\u{f935}"
        case .quietLight: return "\u{f936}"
        case .quietRegular: return "\u{f937}"
        case .radioButtonGroupBold: return "\u{f938}"
        case .radioButtonGroupLight: return "\u{f939}"
        case .radioButtonGroupRegular: return "\u{f93a}"
        case .raiseHandBold: return "\u{f93b}"
        case .raiseHandCircleFilled: return "\u{f93c}"
        case .raiseHandFilled: return "\u{f93d}"
        case .raiseHandLight: return "\u{f93e}"
        case .raiseHandRegular: return "\u{f93f}"
        case .ramBold: return "\u{f940}"
        case .ramLight: return "\u{f941}"
        case .ramRegular: return "\u{f942}"
        case .reactionsBold: return "\u{f943}"
        case .reactionsFilled: return "\u{f944}"
        case .reactionsLight: return "\u{f945}"
        case .reactionsRegular: return "\u{f946}"
        case .reactivateBold: return "\u{f947}"
        case .reactivateLight: return "\u{f948}"
        case .reactivateRegular: return "\u{f949}"
        case .receiveVoiceBold: return "\u{f94a}"
        case .receiveVoiceFilled: return "\u{f94b}"
        case .receiveVoiceLight: return "\u{f94c}"
        case .receiveVoiceRegular: return "\u{f94d}"
        case .recentsBold: return "\u{f94e}"
        case .recentsFilled: return "\u{f94f}"
        case .recentsLight: return "\u{f950}"
        case .recentsPresenceBadgeFilled: return "\u{f951}"
        case .recentsPresenceBold: return "\u{f952}"
        case .recentsPresenceFilled: return "\u{f953}"
        case .recentsPresenceLight: return "\u{f954}"
        case .recentsPresenceRegular: return "\u{f955}"
        case .recentsRegular: return "\u{f956}"
        case .recordActiveBadgeFilled: return "\u{f957}"
        case .recordActiveBold: return "\u{f958}"
        case .recordActiveFilled: return "\u{f959}"
        case .recordActiveLight: return "\u{f95a}"
        case .recordActiveRegular: return "\u{f95b}"
        case .recordBold: return "\u{f95c}"
        case .recordFilled: return "\u{f95d}"
        case .recordLight: return "\u{f95e}"
        case .recordPausedBadgeFilled: return "\u{f95f}"
        case .recordPausedBold: return "\u{f960}"
        case .recordPausedFilled: return "\u{f961}"
        case .recordPausedLight: return "\u{f962}"
        case .recordPausedRegular: return "\u{f963}"
        case .recordRegular: return "\u{f964}"
        case .recurringBold: return "\u{f965}"
        case .recurringLight: return "\u{f966}"
        case .recurringOffBold: return "\u{f967}"
        case .recurringOffLight: return "\u{f968}"
        case .recurringOffRegular: return "\u{f969}"
        case .recurringRegular: return "\u{f96a}"
        case .redoBold: return "\u{f96b}"
        case .redoLight: return "\u{f96c}"
        case .redoRegular: return "\u{f96d}"
        case .refreshBold: return "\u{f96e}"
        case .refreshLight: return "\u{f96f}"
        case .refreshRegular: return "\u{f970}"
        case .remoteDesktopControlBold: return "\u{f971}"
        case .remoteDesktopControlFilled: return "\u{f972}"
        case .remoteDesktopControlLight: return "\u{f973}"
        case .remoteDesktopControlRegular: return "\u{f974}"
        case .removeBold: return "\u{f975}"
        case .removeFilled: return "\u{f976}"
        case .removeLight: return "\u{f977}"
        case .removeRegular: return "\u{f978}"
        case .replyBold: return "\u{f979}"
        case .replyFilled: return "\u{f97a}"
        case .replyLight: return "\u{f97b}"
        case .replyListBold: return "\u{f97c}"
        case .replyListLight: return "\u{f97d}"
        case .replyListRegular: return "\u{f97e}"
        case .replyPrivatelyBold: return "\u{f97f}"
        case .replyPrivatelyLight: return "\u{f980}"
        case .replyPrivatelyRegular: return "\u{f981}"
        case .replyRegular: return "\u{f982}"
        case .resetBold: return "\u{f983}"
        case .resetLight: return "\u{f984}"
        case .resetRegular: return "\u{f985}"
        case .resizeCornerBold: return "\u{f986}"
        case .resizeCornerLight: return "\u{f987}"
        case .resizeCornerRegular: return "\u{f988}"
        case .responsiveMobileBold: return "\u{f989}"
        case .responsiveMobileLight: return "\u{f98a}"
        case .responsiveMobileRegular: return "\u{f98b}"
        case .restartBold: return "\u{f98c}"
        case .restartLight: return "\u{f98d}"
        case .restartRegular: return "\u{f98e}"
        case .retrieveCallBold: return "\u{f98f}"
        case .retrieveCallFilled: return "\u{f990}"
        case .retrieveCallLight: return "\u{f991}"
        case .retrieveCallRegular: return "\u{f992}"
        case .returnBold: return "\u{f993}"
        case .returnLight: return "\u{f994}"
        case .returnRegular: return "\u{f995}"
        case .rewindTenSecBold: return "\u{f996}"
        case .rewindTenSecLight: return "\u{f997}"
        case .rewindTenSecRegular: return "\u{f998}"
        case .ringtoneBold: return "\u{f999}"
        case .ringtoneLight: return "\u{f99a}"
        case .ringtoneRegular: return "\u{f99b}"
        case .roomCalendarBold: return "\u{f99c}"
        case .roomCalendarLight: return "\u{f99d}"
        case .roomCalendarRegular: return "\u{f99e}"
        case .roomLightsBold: return "\u{f99f}"
        case .roomLightsFilled: return "\u{f9a0}"
        case .roomLightsLight: return "\u{f9a1}"
        case .roomLightsRegular: return "\u{f9a2}"
        case .rotateContentBold: return "\u{f9a3}"
        case .rotateContentFilled: return "\u{f9a4}"
        case .rotateContentLight: return "\u{f9a5}"
        case .rotateContentRegular: return "\u{f9a6}"
        case .rssBold: return "\u{f9a7}"
        case .rssFilled: return "\u{f9a8}"
        case .rssLight: return "\u{f9a9}"
        case .rssRegular: return "\u{f9aa}"
        case .ruleBasedBold: return "\u{f9ab}"
        case .ruleBasedLight: return "\u{f9ac}"
        case .ruleBasedRegular: return "\u{f9ad}"
        case .runningApplicationBold: return "\u{f9ae}"
        case .runningApplicationFilled: return "\u{f9af}"
        case .runningApplicationLight: return "\u{f9b0}"
        case .runningApplicationRegular: return "\u{f9b1}"
        case .saveBold: return "\u{f9b2}"
        case .saveLight: return "\u{f9b3}"
        case .saveRegular: return "\u{f9b4}"
        case .saveTranscriptBold: return "\u{f9b5}"
        case .saveTranscriptFilled: return "\u{f9b6}"
        case .saveTranscriptLight: return "\u{f9b7}"
        case .saveTranscriptRegular: return "\u{f9b8}"
        case .scanBold: return "\u{f9b9}"
        case .scanLight: return "\u{f9ba}"
        case .scanRegular: return "\u{f9bb}"
        case .scheduleAiBold: return "\u{f9bc}"
        case .scheduleAiLight: return "\u{f9bd}"
        case .scheduleAiRegular: return "\u{f9be}"
        case .scheduleSendBold: return "\u{f9bf}"
        case .scheduleSendFilled: return "\u{f9c0}"
        case .scheduleSendLight: return "\u{f9c1}"
        case .scheduleSendRegular: return "\u{f9c2}"
        case .scheduleWinnerBold: return "\u{f9c3}"
        case .scheduleWinnerFilled: return "\u{f9c4}"
        case .scheduleWinnerLight: return "\u{f9c5}"
        case .scheduleWinnerRegular: return "\u{f9c6}"
        case .schedulerAvailableBold: return "\u{f9c7}"
        case .schedulerAvailableLight: return "\u{f9c8}"
        case .schedulerAvailableRegular: return "\u{f9c9}"
        case .schedulerNotWorkingHoursBold: return "\u{f9ca}"
        case .schedulerNotWorkingHoursLight: return "\u{f9cb}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9cc}"
        case .schedulerUnavailableBold: return "\u{f9cd}"
        case .schedulerUnavailableLight: return "\u{f9ce}"
        case .schedulerUnavailableRegular: return "\u{f9cf}"
        case .schedulerUnknownBold: return "\u{f9d0}"
        case .schedulerUnknownLight: return "\u{f9d1}"
        case .schedulerUnknownRegular: return "\u{f9d2}"
        case .screenshotBold: return "\u{f9d3}"
        case .screenshotDocBold: return "\u{f9d4}"
        case .screenshotDocFilled: return "\u{f9d5}"
        case .screenshotDocLight: return "\u{f9d6}"
        case .screenshotDocRegular: return "\u{f9d7}"
        case .screenshotLight: return "\u{f9d8}"
        case .screenshotRegular: return "\u{f9d9}"
        case .searchAiBold: return "\u{f9da}"
        case .searchAiLight: return "\u{f9db}"
        case .searchAiRegular: return "\u{f9dc}"
        case .searchBold: return "\u{f9dd}"
        case .searchFilled: return "\u{f9de}"
        case .searchLight: return "\u{f9df}"
        case .searchRegular: return "\u{f9e0}"
        case .secondaryArrowBold: return "\u{f9e1}"
        case .secondaryArrowLight: return "\u{f9e2}"
        case .secondaryArrowRegular: return "\u{f9e3}"
        case .secureCallLockBold: return "\u{f9e4}"
        case .secureCallLockFilled: return "\u{f9e5}"
        case .secureCallLockLight: return "\u{f9e6}"
        case .secureCallLockRegular: return "\u{f9e7}"
        case .secureCallShieldBold: return "\u{f9e8}"
        case .secureCallShieldFilled: return "\u{f9e9}"
        case .secureCallShieldLight: return "\u{f9ea}"
        case .secureCallShieldRegular: return "\u{f9eb}"
        case .secureCircleBold: return "\u{f9ec}"
        case .secureCircleFilled: return "\u{f9ed}"
        case .secureCircleLight: return "\u{f9ee}"
        case .secureCircleRegular: return "\u{f9ef}"
        case .secureLockBold: return "\u{f9f0}"
        case .secureLockFilled: return "\u{f9f1}"
        case .secureLockLight: return "\u{f9f2}"
        case .secureLockRegular: return "\u{f9f3}"
        case .segmentExcludeFilled: return "\u{f9f4}"
        case .segmentFilterFilled: return "\u{f9f5}"
        case .segmentIncludeFilled: return "\u{f9f6}"
        case .selectAllBold: return "\u{f9f7}"
        case .selectAllFilled: return "\u{f9f8}"
        case .selectAllLight: return "\u{f9f9}"
        case .selectAllRegular: return "\u{f9fa}"
        case .selectionBold: return "\u{f9fb}"
        case .selectionFilled: return "\u{f9fc}"
        case .selectionLight: return "\u{f9fd}"
        case .selectionRegular: return "\u{f9fe}"
        case .sendBold: return "\u{f9ff}"
        case .sendDigitsBold: return "\u{fa00}"
        case .sendDigitsFilled: return "\u{fa01}"
        case .sendDigitsLight: return "\u{fa02}"
        case .sendDigitsRegular: return "\u{fa03}"
        case .sendFilled: return "\u{fa04}"
        case .sendLight: return "\u{fa05}"
        case .sendRegular: return "\u{fa06}"
        case .sendVoiceBold: return "\u{fa07}"
        case .sendVoiceFilled: return "\u{fa08}"
        case .sendVoiceLight: return "\u{fa09}"
        case .sendVoiceRegular: return "\u{fa0a}"
        case .serverBold: return "\u{fa0b}"
        case .serverErrorBold: return "\u{fa0c}"
        case .serverErrorLight: return "\u{fa0d}"
        case .serverErrorRegular: return "\u{fa0e}"
        case .serverLight: return "\u{fa0f}"
        case .serverRegular: return "\u{fa10}"
        case .servicesBold: return "\u{fa11}"
        case .servicesLight: return "\u{fa12}"
        case .servicesRegular: return "\u{fa13}"
        case .setVariableBold: return "\u{fa14}"
        case .setVariableLight: return "\u{fa15}"
        case .setVariableRegular: return "\u{fa16}"
        case .settingsBold: return "\u{fa17}"
        case .settingsFilled: return "\u{fa18}"
        case .settingsLight: return "\u{fa19}"
        case .settingsRegular: return "\u{fa1a}"
        case .setupAssistantBold: return "\u{fa1b}"
        case .setupAssistantLight: return "\u{fa1c}"
        case .setupAssistantRegular: return "\u{fa1d}"
        case .sftpBold: return "\u{fa1e}"
        case .sftpLight: return "\u{fa1f}"
        case .sftpRegular: return "\u{fa20}"
        case .shapeCircleBold: return "\u{fa21}"
        case .shapeCircleFilled: return "\u{fa22}"
        case .shapeCircleLight: return "\u{fa23}"
        case .shapeCircleMdFilled: return "\u{fa24}"
        case .shapeCircleRegular: return "\u{fa25}"
        case .shapeCircleSmFilled: return "\u{fa26}"
        case .shapeDiagonalLineBold: return "\u{fa27}"
        case .shapeDiagonalLineLight: return "\u{fa28}"
        case .shapeDiagonalLineRegular: return "\u{fa29}"
        case .shapeDiamondBold: return "\u{fa2a}"
        case .shapeDiamondFilled: return "\u{fa2b}"
        case .shapeDiamondLight: return "\u{fa2c}"
        case .shapeDiamondRegular: return "\u{fa2d}"
        case .shapeOvalBold: return "\u{fa2e}"
        case .shapeOvalLight: return "\u{fa2f}"
        case .shapeOvalRegular: return "\u{fa30}"
        case .shapeSquareBold: return "\u{fa31}"
        case .shapeSquareFilled: return "\u{fa32}"
        case .shapeSquareLight: return "\u{fa33}"
        case .shapeSquareRegular: return "\u{fa34}"
        case .shapeTriangleBold: return "\u{fa35}"
        case .shapeTriangleFilled: return "\u{fa36}"
        case .shapeTriangleLight: return "\u{fa37}"
        case .shapeTriangleRegular: return "\u{fa38}"
        case .shapesBold: return "\u{fa39}"
        case .shapesFilled: return "\u{fa3a}"
        case .shapesLight: return "\u{fa3b}"
        case .shapesRegular: return "\u{fa3c}"
        case .shareCNativeAdrBold: return "\u{fa3d}"
        case .shareCNativeAdrFilled: return "\u{fa3e}"
        case .shareCNativeAdrLight: return "\u{fa3f}"
        case .shareCNativeAdrRegular: return "\u{fa40}"
        case .shareCNativeIphBold: return "\u{fa41}"
        case .shareCNativeIphLight: return "\u{fa42}"
        case .shareCNativeIphRegular: return "\u{fa43}"
        case .shareContentOnDeviceBold: return "\u{fa44}"
        case .shareContentOnDeviceLight: return "\u{fa45}"
        case .shareContentOnDeviceRegular: return "\u{fa46}"
        case .shareScreenAddBold: return "\u{fa47}"
        case .shareScreenAddLight: return "\u{fa48}"
        case .shareScreenAddRegular: return "\u{fa49}"
        case .shareScreenBadgeFilled: return "\u{fa4a}"
        case .shareScreenBold: return "\u{fa4b}"
        case .shareScreenFilled: return "\u{fa4c}"
        case .shareScreenLight: return "\u{fa4d}"
        case .shareScreenRegular: return "\u{fa4e}"
        case .shareSpaceBold: return "\u{fa4f}"
        case .shareSpaceLight: return "\u{fa50}"
        case .shareSpaceRegular: return "\u{fa51}"
        case .shieldBold: return "\u{fa52}"
        case .shieldLight: return "\u{fa53}"
        case .shieldRegular: return "\u{fa54}"
        case .shoppingCartBold: return "\u{fa55}"
        case .shoppingCartFilled: return "\u{fa56}"
        case .shoppingCartLight: return "\u{fa57}"
        case .shoppingCartRegular: return "\u{fa58}"
        case .shortTextBoxBold: return "\u{fa59}"
        case .shortTextBoxLight: return "\u{fa5a}"
        case .shortTextBoxRegular: return "\u{fa5b}"
        case .showBold: return "\u{fa5c}"
        case .showFilled: return "\u{fa5d}"
        case .showLight: return "\u{fa5e}"
        case .showRegular: return "\u{fa5f}"
        case .signInBold: return "\u{fa60}"
        case .signInFilled: return "\u{fa61}"
        case .signInForcedBold: return "\u{fa62}"
        case .signInForcedLight: return "\u{fa63}"
        case .signInForcedRegular: return "\u{fa64}"
        case .signInLight: return "\u{fa65}"
        case .signInRegular: return "\u{fa66}"
        case .signLangIntBold: return "\u{fa67}"
        case .signLangIntLight: return "\u{fa68}"
        case .signLangIntRegular: return "\u{fa69}"
        case .signOutBold: return "\u{fa6a}"
        case .signOutLight: return "\u{fa6b}"
        case .signOutRegular: return "\u{fa6c}"
        case .signalFourBold: return "\u{fa6d}"
        case .signalFourLight: return "\u{fa6e}"
        case .signalFourRegular: return "\u{fa6f}"
        case .signalOneBold: return "\u{fa70}"
        case .signalOneLight: return "\u{fa71}"
        case .signalOneRegular: return "\u{fa72}"
        case .signalThreeBold: return "\u{fa73}"
        case .signalThreeLight: return "\u{fa74}"
        case .signalThreeRegular: return "\u{fa75}"
        case .signalTwoBold: return "\u{fa76}"
        case .signalTwoLight: return "\u{fa77}"
        case .signalTwoRegular: return "\u{fa78}"
        case .signalZeroBold: return "\u{fa79}"
        case .signalZeroLight: return "\u{fa7a}"
        case .signalZeroRegular: return "\u{fa7b}"
        case .simplePromotionBold: return "\u{fa7c}"
        case .simplePromotionLight: return "\u{fa7d}"
        case .simplePromotionRegular: return "\u{fa7e}"
        case .singleNumberReachBold: return "\u{fa7f}"
        case .singleNumberReachLight: return "\u{fa80}"
        case .singleNumberReachRegular: return "\u{fa81}"
        case .sipRegistrationInProgressBold: return "\u{fa82}"
        case .sipRegistrationInProgressFilled: return "\u{fa83}"
        case .sipRegistrationInProgressLight: return "\u{fa84}"
        case .sipRegistrationInProgressRegular: return "\u{fa85}"
        case .skipBold: return "\u{fa86}"
        case .skipBwBold: return "\u{fa87}"
        case .skipBwFilled: return "\u{fa88}"
        case .skipBwLight: return "\u{fa89}"
        case .skipBwRegular: return "\u{fa8a}"
        case .skipFwBold: return "\u{fa8b}"
        case .skipFwFilled: return "\u{fa8c}"
        case .skipFwLight: return "\u{fa8d}"
        case .skipFwRegular: return "\u{fa8e}"
        case .skipLight: return "\u{fa8f}"
        case .skipRegular: return "\u{fa90}"
        case .smartAudioBold: return "\u{fa91}"
        case .smartAudioLight: return "\u{fa92}"
        case .smartAudioRegular: return "\u{fa93}"
        case .smsFilled: return "\u{fa94}"
        case .smsInboundBold: return "\u{fa95}"
        case .smsInboundLight: return "\u{fa96}"
        case .smsInboundRegular: return "\u{fa97}"
        case .smsMessageBold: return "\u{fa98}"
        case .smsMessageFilled: return "\u{fa99}"
        case .smsMessageLight: return "\u{fa9a}"
        case .smsMessageRegular: return "\u{fa9b}"
        case .smsOutgoingFilled: return "\u{fa9c}"
        case .smsUnreadBold: return "\u{fa9d}"
        case .smsUnreadLight: return "\u{fa9e}"
        case .smsUnreadRegular: return "\u{fa9f}"
        case .sortAscendingBold: return "\u{faa0}"
        case .sortAscendingLight: return "\u{faa1}"
        case .sortAscendingRegular: return "\u{faa2}"
        case .sortDescendingBold: return "\u{faa3}"
        case .sortDescendingLight: return "\u{faa4}"
        case .sortDescendingRegular: return "\u{faa5}"
        case .soundDefaultBold: return "\u{faa6}"
        case .soundDefaultLight: return "\u{faa7}"
        case .soundDefaultRegular: return "\u{faa8}"
        case .sparkleBold: return "\u{faa9}"
        case .sparkleFilled: return "\u{faaa}"
        case .sparkleLight: return "\u{faab}"
        case .sparkleRegular: return "\u{faac}"
        case .speakerBold: return "\u{faad}"
        case .speakerDisconnectedBold: return "\u{faae}"
        case .speakerDisconnectedFilled: return "\u{faaf}"
        case .speakerDisconnectedLight: return "\u{fab0}"
        case .speakerDisconnectedRegular: return "\u{fab1}"
        case .speakerFilled: return "\u{fab2}"
        case .speakerLight: return "\u{fab3}"
        case .speakerMutedBold: return "\u{fab4}"
        case .speakerMutedFilled: return "\u{fab5}"
        case .speakerMutedLight: return "\u{fab6}"
        case .speakerMutedRegular: return "\u{fab7}"
        case .speakerOffBold: return "\u{fab8}"
        case .speakerOffFilled: return "\u{fab9}"
        case .speakerOffLight: return "\u{faba}"
        case .speakerOffRegular: return "\u{fabb}"
        case .speakerOnBold: return "\u{fabc}"
        case .speakerOnLight: return "\u{fabd}"
        case .speakerOnRegular: return "\u{fabe}"
        case .speakerRegular: return "\u{fabf}"
        case .speakerTurnDownBold: return "\u{fac0}"
        case .speakerTurnDownFilled: return "\u{fac1}"
        case .speakerTurnDownLight: return "\u{fac2}"
        case .speakerTurnDownRegular: return "\u{fac3}"
        case .speakerTurnUpBold: return "\u{fac4}"
        case .speakerTurnUpFilled: return "\u{fac5}"
        case .speakerTurnUpLight: return "\u{fac6}"
        case .speakerTurnUpRegular: return "\u{fac7}"
        case .speedDialBold: return "\u{fac8}"
        case .speedDialFilled: return "\u{fac9}"
        case .speedDialLight: return "\u{faca}"
        case .speedDialRegular: return "\u{facb}"
        case .spellCheckerBold: return "\u{facc}"
        case .spellCheckerLight: return "\u{facd}"
        case .spellCheckerRegular: return "\u{face}"
        case .splitViewBold: return "\u{facf}"
        case .splitViewLight: return "\u{fad0}"
        case .splitViewRegular: return "\u{fad1}"
        case .stackedAreaChartBold: return "\u{fad2}"
        case .stackedAreaChartFilled: return "\u{fad3}"
        case .stackedAreaChartFullBold: return "\u{fad4}"
        case .stackedAreaChartFullFilled: return "\u{fad5}"
        case .stackedAreaChartFullLight: return "\u{fad6}"
        case .stackedAreaChartFullRegular: return "\u{fad7}"
        case .stackedAreaChartLight: return "\u{fad8}"
        case .stackedAreaChartRegular: return "\u{fad9}"
        case .stackedBarChartBold: return "\u{fada}"
        case .stackedBarChartFilled: return "\u{fadb}"
        case .stackedBarChartFullBold: return "\u{fadc}"
        case .stackedBarChartFullFilled: return "\u{fadd}"
        case .stackedBarChartFullLight: return "\u{fade}"
        case .stackedBarChartFullRegular: return "\u{fadf}"
        case .stackedBarChartLight: return "\u{fae0}"
        case .stackedBarChartRegular: return "\u{fae1}"
        case .startChatBold: return "\u{fae2}"
        case .startChatLight: return "\u{fae3}"
        case .startChatRegular: return "\u{fae4}"
        case .stethoscopeBold: return "\u{fae5}"
        case .stethoscopeLight: return "\u{fae6}"
        case .stethoscopeRegular: return "\u{fae7}"
        case .stickersBold: return "\u{fae8}"
        case .stickersLight: return "\u{fae9}"
        case .stickersRegular: return "\u{faea}"
        case .stickiesBold: return "\u{faeb}"
        case .stickiesLight: return "\u{faec}"
        case .stickiesRegular: return "\u{faed}"
        case .stopBold: return "\u{faee}"
        case .stopCircleBold: return "\u{faef}"
        case .stopCircleFilled: return "\u{faf0}"
        case .stopCircleLight: return "\u{faf1}"
        case .stopCircleRegular: return "\u{faf2}"
        case .stopContentShareBold: return "\u{faf3}"
        case .stopContentShareLight: return "\u{faf4}"
        case .stopContentShareRegular: return "\u{faf5}"
        case .stopFilled: return "\u{faf6}"
        case .stopLight: return "\u{faf7}"
        case .stopRegular: return "\u{faf8}"
        case .storedInfoBold: return "\u{faf9}"
        case .storedInfoFilled: return "\u{fafa}"
        case .storedInfoLight: return "\u{fafb}"
        case .storedInfoRegular: return "\u{fafc}"
        case .streamingBold: return "\u{fafd}"
        case .streamingLight: return "\u{fafe}"
        case .streamingRegular: return "\u{faff}"
        case .strikethroughBold: return "\u{fb00}"
        case .strikethroughFilled: return "\u{fb01}"
        case .strikethroughLight: return "\u{fb02}"
        case .strikethroughRegular: return "\u{fb03}"
        case .studioModeBold: return "\u{fb04}"
        case .studioModeLight: return "\u{fb05}"
        case .studioModeRegular: return "\u{fb06}"
        case .subscriptBold: return "\u{fb07}"
        case .subscriptLight: return "\u{fb08}"
        case .subscriptRegular: return "\u{fb09}"
        case .summarizeAiBold: return "\u{fb0a}"
        case .summarizeAiLight: return "\u{fb0b}"
        case .summarizeAiRegular: return "\u{fb0c}"
        case .superscriptBold: return "\u{fb0d}"
        case .superscriptLight: return "\u{fb0e}"
        case .superscriptRegular: return "\u{fb0f}"
        case .surveyBold: return "\u{fb10}"
        case .surveyFilled: return "\u{fb11}"
        case .surveyLight: return "\u{fb12}"
        case .surveyRegular: return "\u{fb13}"
        case .sxEightyCodecBold: return "\u{fb14}"
        case .sxEightyCodecLight: return "\u{fb15}"
        case .sxEightyCodecRegular: return "\u{fb16}"
        case .sxTenBold: return "\u{fb17}"
        case .sxTenLight: return "\u{fb18}"
        case .sxTenRegular: return "\u{fb19}"
        case .sxTwentyBold: return "\u{fb1a}"
        case .sxTwentyLight: return "\u{fb1b}"
        case .sxTwentyRegular: return "\u{fb1c}"
        case .tableBold: return "\u{fb1d}"
        case .tableLight: return "\u{fb1e}"
        case .tableRegular: return "\u{fb1f}"
        case .tabletBold: return "\u{fb20}"
        case .tabletLight: return "\u{fb21}"
        case .tabletRegular: return "\u{fb22}"
        case .tabsBold: return "\u{fb23}"
        case .tabsLight: return "\u{fb24}"
        case .tabsRegular: return "\u{fb25}"
        case .tagBold: return "\u{fb26}"
        case .tagLight: return "\u{fb27}"
        case .tagRegular: return "\u{fb28}"
        case .tapBold: return "\u{fb29}"
        case .tapFilled: return "\u{fb2a}"
        case .tapLight: return "\u{fb2b}"
        case .tapRegular: return "\u{fb2c}"
        case .telepresenceAlertBold: return "\u{fb2d}"
        case .telepresenceAlertLight: return "\u{fb2e}"
        case .telepresenceAlertMutedBold: return "\u{fb2f}"
        case .telepresenceAlertMutedLight: return "\u{fb30}"
        case .telepresenceAlertMutedRegular: return "\u{fb31}"
        case .telepresenceAlertRegular: return "\u{fb32}"
        case .telepresenceBold: return "\u{fb33}"
        case .telepresenceIxFiveThousandBold: return "\u{fb34}"
        case .telepresenceIxFiveThousandLight: return "\u{fb35}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb36}"
        case .telepresenceLight: return "\u{fb37}"
        case .telepresenceMutedBold: return "\u{fb38}"
        case .telepresenceMutedLight: return "\u{fb39}"
        case .telepresenceMutedRegular: return "\u{fb3a}"
        case .telepresencePrivateBold: return "\u{fb3b}"
        case .telepresencePrivateLight: return "\u{fb3c}"
        case .telepresencePrivateRegular: return "\u{fb3d}"
        case .telepresenceRegular: return "\u{fb3e}"
        case .temperatureBold: return "\u{fb3f}"
        case .temperatureLight: return "\u{fb40}"
        case .temperatureRegular: return "\u{fb41}"
        case .testTubeBold: return "\u{fb42}"
        case .testTubeFilled: return "\u{fb43}"
        case .testTubeLight: return "\u{fb44}"
        case .testTubeRegular: return "\u{fb45}"
        case .textAlignCenterBold: return "\u{fb46}"
        case .textAlignCenterFilled: return "\u{fb47}"
        case .textAlignCenterLight: return "\u{fb48}"
        case .textAlignCenterRegular: return "\u{fb49}"
        case .textAlignLeftBold: return "\u{fb4a}"
        case .textAlignLeftFilled: return "\u{fb4b}"
        case .textAlignLeftLight: return "\u{fb4c}"
        case .textAlignLeftRegular: return "\u{fb4d}"
        case .textAlignRightBold: return "\u{fb4e}"
        case .textAlignRightFilled: return "\u{fb4f}"
        case .textAlignRightLight: return "\u{fb50}"
        case .textAlignRightRegular: return "\u{fb51}"
        case .textBold: return "\u{fb52}"
        case .textBoxCursorLight: return "\u{fb53}"
        case .textCodeBlockBold: return "\u{fb54}"
        case .textCodeBlockLight: return "\u{fb55}"
        case .textCodeBlockRegular: return "\u{fb56}"
        case .textHighlightBold: return "\u{fb57}"
        case .textHighlightFilled: return "\u{fb58}"
        case .textHighlightLight: return "\u{fb59}"
        case .textHighlightRegular: return "\u{fb5a}"
        case .textLight: return "\u{fb5b}"
        case .textRegular: return "\u{fb5c}"
        case .threeColumnBold: return "\u{fb5d}"
        case .threeColumnLight: return "\u{fb5e}"
        case .threeColumnRegular: return "\u{fb5f}"
        case .threeDObjectBold: return "\u{fb60}"
        case .threeDObjectLight: return "\u{fb61}"
        case .threeDObjectRegular: return "\u{fb62}"
        case .timeExclusionBold: return "\u{fb63}"
        case .timeExclusionLight: return "\u{fb64}"
        case .timeExclusionRegular: return "\u{fb65}"
        case .tooFastBold: return "\u{fb66}"
        case .tooFastLight: return "\u{fb67}"
        case .tooFastRegular: return "\u{fb68}"
        case .tooSlowBold: return "\u{fb69}"
        case .tooSlowLight: return "\u{fb6a}"
        case .tooSlowRegular: return "\u{fb6b}"
        case .toolsBold: return "\u{fb6c}"
        case .toolsFilled: return "\u{fb6d}"
        case .toolsLight: return "\u{fb6e}"
        case .toolsRegular: return "\u{fb6f}"
        case .touchTenBold: return "\u{fb70}"
        case .touchTenLight: return "\u{fb71}"
        case .touchTenRegular: return "\u{fb72}"
        case .transcriptBold: return "\u{fb73}"
        case .transcriptFilled: return "\u{fb74}"
        case .transcriptLight: return "\u{fb75}"
        case .transcriptRegular: return "\u{fb76}"
        case .translateBold: return "\u{fb77}"
        case .translateLight: return "\u{fb78}"
        case .translateRegular: return "\u{fb79}"
        case .translateUndoBold: return "\u{fb7a}"
        case .translateUndoLight: return "\u{fb7b}"
        case .translateUndoRegular: return "\u{fb7c}"
        case .trendingBold: return "\u{fb7d}"
        case .trendingDownBold: return "\u{fb7e}"
        case .trendingDownFilled: return "\u{fb7f}"
        case .trendingDownLight: return "\u{fb80}"
        case .trendingDownRegular: return "\u{fb81}"
        case .trendingFilled: return "\u{fb82}"
        case .trendingLight: return "\u{fb83}"
        case .trendingRegular: return "\u{fb84}"
        case .trimBold: return "\u{fb85}"
        case .trimLight: return "\u{fb86}"
        case .trimRegular: return "\u{fb87}"
        case .twoColumnBold: return "\u{fb88}"
        case .twoColumnLight: return "\u{fb89}"
        case .twoColumnRegular: return "\u{fb8a}"
        case .twoWayVoiceStreamBold: return "\u{fb8b}"
        case .twoWayVoiceStreamFilled: return "\u{fb8c}"
        case .twoWayVoiceStreamLight: return "\u{fb8d}"
        case .twoWayVoiceStreamRegular: return "\u{fb8e}"
        case .ucmCloudBold: return "\u{fb8f}"
        case .ucmCloudLight: return "\u{fb90}"
        case .ucmCloudRegular: return "\u{fb91}"
        case .unblockBold: return "\u{fb92}"
        case .unblockFilled: return "\u{fb93}"
        case .unblockLight: return "\u{fb94}"
        case .unblockRegular: return "\u{fb95}"
        case .underlineBold: return "\u{fb96}"
        case .underlineFilled: return "\u{fb97}"
        case .underlineLight: return "\u{fb98}"
        case .underlineRegular: return "\u{fb99}"
        case .undoBold: return "\u{fb9a}"
        case .undoLight: return "\u{fb9b}"
        case .undoRegular: return "\u{fb9c}"
        case .unlinkBold: return "\u{fb9d}"
        case .unlinkLight: return "\u{fb9e}"
        case .unlinkRegular: return "\u{fb9f}"
        case .unreadBold: return "\u{fba0}"
        case .unreadFilled: return "\u{fba1}"
        case .unreadLight: return "\u{fba2}"
        case .unreadRegular: return "\u{fba3}"
        case .unsecureUnlockedBold: return "\u{fba4}"
        case .unsecureUnlockedFilled: return "\u{fba5}"
        case .unsecureUnlockedLight: return "\u{fba6}"
        case .unsecureUnlockedRegular: return "\u{fba7}"
        case .unsortedBold: return "\u{fba8}"
        case .unsortedLight: return "\u{fba9}"
        case .unsortedRegular: return "\u{fbaa}"
        case .updateFileShareBold: return "\u{fbab}"
        case .updateFileShareLight: return "\u{fbac}"
        case .updateFileShareRegular: return "\u{fbad}"
        case .uploadBold: return "\u{fbae}"
        case .uploadImageBold: return "\u{fbaf}"
        case .uploadImageLight: return "\u{fbb0}"
        case .uploadImageRegular: return "\u{fbb1}"
        case .uploadLight: return "\u{fbb2}"
        case .uploadRegular: return "\u{fbb3}"
        case .urgentVoicemailBold: return "\u{fbb4}"
        case .urgentVoicemailFilled: return "\u{fbb5}"
        case .usbBold: return "\u{fbb6}"
        case .usbHeadsetBold: return "\u{fbb7}"
        case .usbHeadsetLight: return "\u{fbb8}"
        case .usbHeadsetMutedBold: return "\u{fbb9}"
        case .usbHeadsetMutedLight: return "\u{fbba}"
        case .usbHeadsetMutedRegular: return "\u{fbbb}"
        case .usbHeadsetRegular: return "\u{fbbc}"
        case .usbLight: return "\u{fbbd}"
        case .usbRegular: return "\u{fbbe}"
        case .userBold: return "\u{fbbf}"
        case .userDeactivateBold: return "\u{fbc0}"
        case .userDeactivateLight: return "\u{fbc1}"
        case .userDeactivateRegular: return "\u{fbc2}"
        case .userLight: return "\u{fbc3}"
        case .userRegular: return "\u{fbc4}"
        case .videoBlurBold: return "\u{fbc5}"
        case .videoBlurFilled: return "\u{fbc6}"
        case .videoBlurLight: return "\u{fbc7}"
        case .videoBlurRegular: return "\u{fbc8}"
        case .videoBold: return "\u{fbc9}"
        case .videoEffectBold: return "\u{fbca}"
        case .videoEffectFilled: return "\u{fbcb}"
        case .videoEffectLight: return "\u{fbcc}"
        case .videoEffectRegular: return "\u{fbcd}"
        case .videoFilled: return "\u{fbce}"
        case .videoLayoutBold: return "\u{fbcf}"
        case .videoLayoutEqualBold: return "\u{fbd0}"
        case .videoLayoutEqualDualBold: return "\u{fbd1}"
        case .videoLayoutEqualDualLight: return "\u{fbd2}"
        case .videoLayoutEqualDualRegular: return "\u{fbd3}"
        case .videoLayoutEqualFilled: return "\u{fbd4}"
        case .videoLayoutEqualLight: return "\u{fbd5}"
        case .videoLayoutEqualRegular: return "\u{fbd6}"
        case .videoLayoutFilled: return "\u{fbd7}"
        case .videoLayoutLight: return "\u{fbd8}"
        case .videoLayoutOverlayBold: return "\u{fbd9}"
        case .videoLayoutOverlayFilled: return "\u{fbda}"
        case .videoLayoutOverlayLight: return "\u{fbdb}"
        case .videoLayoutOverlayRegular: return "\u{fbdc}"
        case .videoLayoutPresenterDominantBold: return "\u{fbdd}"
        case .videoLayoutPresenterDominantLight: return "\u{fbde}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbdf}"
        case .videoLayoutProminentBold: return "\u{fbe0}"
        case .videoLayoutProminentFilled: return "\u{fbe1}"
        case .videoLayoutProminentLight: return "\u{fbe2}"
        case .videoLayoutProminentRegular: return "\u{fbe3}"
        case .videoLayoutRegular: return "\u{fbe4}"
        case .videoLayoutShareDominantBold: return "\u{fbe5}"
        case .videoLayoutShareDominantLight: return "\u{fbe6}"
        case .videoLayoutShareDominantRegular: return "\u{fbe7}"
        case .videoLayoutSingleBold: return "\u{fbe8}"
        case .videoLayoutSingleFilled: return "\u{fbe9}"
        case .videoLayoutSingleLight: return "\u{fbea}"
        case .videoLayoutSingleRegular: return "\u{fbeb}"
        case .videoLayoutStackBold: return "\u{fbec}"
        case .videoLayoutStackFilled: return "\u{fbed}"
        case .videoLayoutStackLight: return "\u{fbee}"
        case .videoLayoutStackRegular: return "\u{fbef}"
        case .videoLayoutVideoDominantBold: return "\u{fbf0}"
        case .videoLayoutVideoDominantFilled: return "\u{fbf1}"
        case .videoLayoutVideoDominantLight: return "\u{fbf2}"
        case .videoLayoutVideoDominantRegular: return "\u{fbf3}"
        case .videoLight: return "\u{fbf4}"
        case .videoPlusBold: return "\u{fbf5}"
        case .videoPlusFilled: return "\u{fbf6}"
        case .videoPlusLight: return "\u{fbf7}"
        case .videoPlusRegular: return "\u{fbf8}"
        case .videoRegular: return "\u{fbf9}"
        case .videoSpeakerTrackBold: return "\u{fbfa}"
        case .videoSpeakerTrackFilled: return "\u{fbfb}"
        case .videoSpeakerTrackLight: return "\u{fbfc}"
        case .videoSpeakerTrackRegular: return "\u{fbfd}"
        case .viewAllBold: return "\u{fbfe}"
        case .viewAllLight: return "\u{fbff}"
        case .viewAllRegular: return "\u{fc00}"
        case .viewListBold: return "\u{fc01}"
        case .viewListFilled: return "\u{fc02}"
        case .viewListLight: return "\u{fc03}"
        case .viewListRegular: return "\u{fc04}"
        case .viewStackedBold: return "\u{fc05}"
        case .viewStackedFilled: return "\u{fc06}"
        case .viewStackedLight: return "\u{fc07}"
        case .viewStackedRegular: return "\u{fc08}"
        case .viewThumbnailBold: return "\u{fc09}"
        case .viewThumbnailFilled: return "\u{fc0a}"
        case .viewThumbnailLight: return "\u{fc0b}"
        case .viewThumbnailRegular: return "\u{fc0c}"
        case .visionproBold: return "\u{fc0d}"
        case .visionproFilled: return "\u{fc0e}"
        case .visionproLight: return "\u{fc0f}"
        case .visionproMoveCallInBold: return "\u{fc10}"
        case .visionproMoveCallInFilled: return "\u{fc11}"
        case .visionproMoveCallInLight: return "\u{fc12}"
        case .visionproMoveCallInOutBold: return "\u{fc13}"
        case .visionproMoveCallInOutFilled: return "\u{fc14}"
        case .visionproMoveCallInOutLight: return "\u{fc15}"
        case .visionproMoveCallInOutRegular: return "\u{fc16}"
        case .visionproMoveCallInRegular: return "\u{fc17}"
        case .visionproMoveCallOutBold: return "\u{fc18}"
        case .visionproMoveCallOutFilled: return "\u{fc19}"
        case .visionproMoveCallOutLight: return "\u{fc1a}"
        case .visionproMoveCallOutRegular: return "\u{fc1b}"
        case .visionproRegular: return "\u{fc1c}"
        case .voicemailBold: return "\u{fc1d}"
        case .voicemailFilled: return "\u{fc1e}"
        case .voicemailLight: return "\u{fc1f}"
        case .voicemailRegular: return "\u{fc20}"
        case .vpnBold: return "\u{fc21}"
        case .vpnFilled: return "\u{fc22}"
        case .vpnLight: return "\u{fc23}"
        case .vpnRegular: return "\u{fc24}"
        case .vscBold: return "\u{fc25}"
        case .vscLight: return "\u{fc26}"
        case .vscRegular: return "\u{fc27}"
        case .waffleMenuBold: return "\u{fc28}"
        case .waffleMenuLight: return "\u{fc29}"
        case .waffleMenuRegular: return "\u{fc2a}"
        case .waitingRoomBold: return "\u{fc2b}"
        case .waitingRoomLight: return "\u{fc2c}"
        case .waitingRoomRegular: return "\u{fc2d}"
        case .wallpaperBold: return "\u{fc2e}"
        case .wallpaperLight: return "\u{fc2f}"
        case .wallpaperRegular: return "\u{fc30}"
        case .warningBadgeFilled: return "\u{fc31}"
        case .warningBold: return "\u{fc32}"
        case .warningFilled: return "\u{fc33}"
        case .warningLight: return "\u{fc34}"
        case .warningRegular: return "\u{fc35}"
        case .webexBoardBold: return "\u{fc36}"
        case .webexBoardLight: return "\u{fc37}"
        case .webexBoardRegular: return "\u{fc38}"
        case .webexCodecPlusBold: return "\u{fc39}"
        case .webexCodecPlusLight: return "\u{fc3a}"
        case .webexCodecPlusRegular: return "\u{fc3b}"
        case .webexDeskCameraBold: return "\u{fc3c}"
        case .webexDeskCameraLight: return "\u{fc3d}"
        case .webexDeskCameraRegular: return "\u{fc3e}"
        case .webexHelixBold: return "\u{fc3f}"
        case .webexHelixLight: return "\u{fc40}"
        case .webexHelixRegular: return "\u{fc41}"
        case .webexMeetingsBold: return "\u{fc42}"
        case .webexMeetingsFilled: return "\u{fc43}"
        case .webexMeetingsLight: return "\u{fc44}"
        case .webexMeetingsRegular: return "\u{fc45}"
        case .webexQuadCameraBold: return "\u{fc46}"
        case .webexQuadCameraLight: return "\u{fc47}"
        case .webexQuadCameraRegular: return "\u{fc48}"
        case .webexRoomKitBold: return "\u{fc49}"
        case .webexRoomKitLight: return "\u{fc4a}"
        case .webexRoomKitPlusBold: return "\u{fc4b}"
        case .webexRoomKitPlusLight: return "\u{fc4c}"
        case .webexRoomKitPlusRegular: return "\u{fc4d}"
        case .webexRoomKitRegular: return "\u{fc4e}"
        case .webexShareBold: return "\u{fc4f}"
        case .webexShareLight: return "\u{fc50}"
        case .webexShareRegular: return "\u{fc51}"
        case .webexTeamsBold: return "\u{fc52}"
        case .webexTeamsFilled: return "\u{fc53}"
        case .webexTeamsLight: return "\u{fc54}"
        case .webexTeamsNewBold: return "\u{fc55}"
        case .webexTeamsNewFilled: return "\u{fc56}"
        case .webexTeamsNewLight: return "\u{fc57}"
        case .webexTeamsNewRegular: return "\u{fc58}"
        case .webexTeamsRegular: return "\u{fc59}"
        case .webexTeamsRemoveBold: return "\u{fc5a}"
        case .webexTeamsRemoveLight: return "\u{fc5b}"
        case .webexTeamsRemoveRegular: return "\u{fc5c}"
        case .webinarBold: return "\u{fc5d}"
        case .webinarFilled: return "\u{fc5e}"
        case .webinarLight: return "\u{fc5f}"
        case .webinarRegular: return "\u{fc60}"
        case .weeklyRecurringScheduleBold: return "\u{fc61}"
        case .weeklyRecurringScheduleLight: return "\u{fc62}"
        case .weeklyRecurringScheduleRegular: return "\u{fc63}"
        case .whisperAnnouncementBold: return "\u{fc64}"
        case .whisperAnnouncementFilled: return "\u{fc65}"
        case .whisperAnnouncementLight: return "\u{fc66}"
        case .whisperAnnouncementRegular: return "\u{fc67}"
        case .whisperCoachBold: return "\u{fc68}"
        case .whisperCoachFilled: return "\u{fc69}"
        case .whisperCoachLight: return "\u{fc6a}"
        case .whisperCoachRegular: return "\u{fc6b}"
        case .whiteboardBold: return "\u{fc6c}"
        case .whiteboardContentBold: return "\u{fc6d}"
        case .whiteboardContentFilled: return "\u{fc6e}"
        case .whiteboardContentLight: return "\u{fc6f}"
        case .whiteboardContentRegular: return "\u{fc70}"
        case .whiteboardFilled: return "\u{fc71}"
        case .whiteboardLight: return "\u{fc72}"
        case .whiteboardRegular: return "\u{fc73}"
        case .widgetBold: return "\u{fc74}"
        case .widgetFilled: return "\u{fc75}"
        case .widgetLight: return "\u{fc76}"
        case .widgetRegular: return "\u{fc77}"
        case .wifiBold: return "\u{fc78}"
        case .wifiErrorBold: return "\u{fc79}"
        case .wifiErrorLight: return "\u{fc7a}"
        case .wifiErrorRegular: return "\u{fc7b}"
        case .wifiLight: return "\u{fc7c}"
        case .wifiRegular: return "\u{fc7d}"
        case .wifiSignalGoodBold: return "\u{fc7e}"
        case .wifiSignalGoodLight: return "\u{fc7f}"
        case .wifiSignalGoodRegular: return "\u{fc80}"
        case .wifiSignalPoorBold: return "\u{fc81}"
        case .wifiSignalPoorLight: return "\u{fc82}"
        case .wifiSignalPoorRegular: return "\u{fc83}"
        case .wifiSignalUnstableBold: return "\u{fc84}"
        case .wifiSignalUnstableLight: return "\u{fc85}"
        case .wifiSignalUnstableRegular: return "\u{fc86}"
        case .windowCornerScrubBold: return "\u{fc87}"
        case .windowCornerScrubLight: return "\u{fc88}"
        case .windowCornerScrubRegular: return "\u{fc89}"
        case .windowRightCornerScrubBold: return "\u{fc8a}"
        case .windowRightCornerScrubLight: return "\u{fc8b}"
        case .windowRightCornerScrubRegular: return "\u{fc8c}"
        case .windowVerticalScrubBold: return "\u{fc8d}"
        case .windowVerticalScrubLight: return "\u{fc8e}"
        case .windowVerticalScrubRegular: return "\u{fc8f}"
        case .workflowDeploymentsBold: return "\u{fc90}"
        case .workflowDeploymentsFilled: return "\u{fc91}"
        case .workflowDeploymentsLight: return "\u{fc92}"
        case .workflowDeploymentsRegular: return "\u{fc93}"
        case .workphoneBold: return "\u{fc94}"
        case .workphoneLight: return "\u{fc95}"
        case .workphoneRegular: return "\u{fc96}"
        case .zoomInBold: return "\u{fc97}"
        case .zoomInLight: return "\u{fc98}"
        case .zoomInRegular: return "\u{fc99}"
        case .zoomOutBold: return "\u{fc9a}"
        case .zoomOutLight: return "\u{fc9b}"
        case .zoomOutRegular: return "\u{fc9c}"
