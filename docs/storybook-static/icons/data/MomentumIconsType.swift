...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .callMergeLight: return "\u{f2d2}"
        case .callMergeRegular: return "\u{f2d3}"
        case .callMissedBold: return "\u{f2d4}"
        case .callMissedFilled: return "\u{f2d5}"
        case .callMissedLight: return "\u{f2d6}"
        case .callMissedRegular: return "\u{f2d7}"
        case .callMoreBold: return "\u{f2d8}"
        case .callMoreLight: return "\u{f2d9}"
        case .callMoreRegular: return "\u{f2da}"
        case .callOutgoingBold: return "\u{f2db}"
        case .callOutgoingLight: return "\u{f2dc}"
        case .callOutgoingRegular: return "\u{f2dd}"
        case .callPickupBold: return "\u{f2de}"
        case .callPickupFilled: return "\u{f2df}"
        case .callPickupLight: return "\u{f2e0}"
        case .callPickupOtherBold: return "\u{f2e1}"
        case .callPickupOtherFilled: return "\u{f2e2}"
        case .callPickupOtherLight: return "\u{f2e3}"
        case .callPickupOtherRegular: return "\u{f2e4}"
        case .callPickupRegular: return "\u{f2e5}"
        case .callPrivateBold: return "\u{f2e6}"
        case .callPrivateFilled: return "\u{f2e7}"
        case .callPrivateLight: return "\u{f2e8}"
        case .callPrivateRegular: return "\u{f2e9}"
        case .callRemoteBold: return "\u{f2ea}"
        case .callRemoteFilled: return "\u{f2eb}"
        case .callRemoteLight: return "\u{f2ec}"
        case .callRemoteRegular: return "\u{f2ed}"
        case .callRequestBold: return "\u{f2ee}"
        case .callRequestFilled: return "\u{f2ef}"
        case .callRequestLight: return "\u{f2f0}"
        case .callRequestRegular: return "\u{f2f1}"
        case .callReturnBold: return "\u{f2f2}"
        case .callReturnFilled: return "\u{f2f3}"
        case .callReturnLight: return "\u{f2f4}"
        case .callReturnRegular: return "\u{f2f5}"
        case .callRoomBold: return "\u{f2f6}"
        case .callRoomLight: return "\u{f2f7}"
        case .callRoomRegular: return "\u{f2f8}"
        case .callSettingsBold: return "\u{f2f9}"
        case .callSettingsLight: return "\u{f2fa}"
        case .callSettingsRegular: return "\u{f2fb}"
        case .callSplitBold: return "\u{f2fc}"
        case .callSplitLight: return "\u{f2fd}"
        case .callSplitRegular: return "\u{f2fe}"
        case .callSwapBold: return "\u{f2ff}"
        case .callSwapLight: return "\u{f300}"
        case .callSwapRegular: return "\u{f301}"
        case .callVoicemailBold: return "\u{f302}"
        case .callVoicemailLight: return "\u{f303}"
        case .callVoicemailRegular: return "\u{f304}"
        case .callrateBold: return "\u{f305}"
        case .callrateLight: return "\u{f306}"
        case .callrateRegular: return "\u{f307}"
        case .cameraAuxBold: return "\u{f308}"
        case .cameraAuxFilled: return "\u{f309}"
        case .cameraAuxLight: return "\u{f30a}"
        case .cameraAuxRegular: return "\u{f30b}"
        case .cameraBold: return "\u{f30c}"
        case .cameraFilled: return "\u{f30d}"
        case .cameraLight: return "\u{f30e}"
        case .cameraMutedBold: return "\u{f30f}"
        case .cameraMutedCircleFilled: return "\u{f310}"
        case .cameraMutedFilled: return "\u{f311}"
        case .cameraMutedLight: return "\u{f312}"
        case .cameraMutedRegular: return "\u{f313}"
        case .cameraOnBold: return "\u{f314}"
        case .cameraOnFilled: return "\u{f315}"
        case .cameraOnLight: return "\u{f316}"
        case .cameraOnRegular: return "\u{f317}"
        case .cameraPhotoBold: return "\u{f318}"
        case .cameraPhotoFilled: return "\u{f319}"
        case .cameraPhotoLight: return "\u{f31a}"
        case .cameraPhotoRegular: return "\u{f31b}"
        case .cameraPresenceBold: return "\u{f31c}"
        case .cameraPresenceFilled: return "\u{f31d}"
        case .cameraPresenceLight: return "\u{f31e}"
        case .cameraPresenceRegular: return "\u{f31f}"
        case .cameraRegular: return "\u{f320}"
        case .cameraSwapBold: return "\u{f321}"
        case .cameraSwapLight: return "\u{f322}"
        case .cameraSwapRegular: return "\u{f323}"
        case .campaignManagementBold: return "\u{f324}"
        case .campaignManagementLight: return "\u{f325}"
        case .campaignManagementRegular: return "\u{f326}"
        case .cancelBold: return "\u{f327}"
        case .cancelFilled: return "\u{f328}"
        case .cancelLight: return "\u{f329}"
        case .cancelRegular: return "\u{f32a}"
        case .capsLockBold: return "\u{f32b}"
        case .capsLockLight: return "\u{f32c}"
        case .capsLockRegular: return "\u{f32d}"
        case .captureRewindBold: return "\u{f32e}"
        case .captureRewindLight: return "\u{f32f}"
        case .captureRewindRegular: return "\u{f330}"
        case .caroselBold: return "\u{f331}"
        case .caroselLight: return "\u{f332}"
        case .caroselRegular: return "\u{f333}"
        case .carouselTextBold: return "\u{f334}"
        case .carouselTextLight: return "\u{f335}"
        case .carouselTextRegular: return "\u{f336}"
        case .cellularBold: return "\u{f337}"
        case .cellularLight: return "\u{f338}"
        case .cellularRegular: return "\u{f339}"
        case .centerAlignedBold: return "\u{f33a}"
        case .centerAlignedLight: return "\u{f33b}"
        case .centerAlignedRegular: return "\u{f33c}"
        case .centerBold: return "\u{f33d}"
        case .centerLight: return "\u{f33e}"
        case .centerRegular: return "\u{f33f}"
        case .certificateBold: return "\u{f340}"
        case .certificateInvalidBold: return "\u{f341}"
        case .certificateInvalidLight: return "\u{f342}"
        case .certificateInvalidRegular: return "\u{f343}"
        case .certificateLight: return "\u{f344}"
        case .certificateRegular: return "\u{f345}"
        case .certifiedBold: return "\u{f346}"
        case .certifiedFilled: return "\u{f347}"
        case .certifiedLight: return "\u{f348}"
        case .certifiedRegular: return "\u{f349}"
        case .chPSearchBold: return "\u{f34a}"
        case .chPSearchLight: return "\u{f34b}"
        case .chPSearchRegular: return "\u{f34c}"
        case .channelUssdBold: return "\u{f34d}"
        case .channelUssdLight: return "\u{f34e}"
        case .channelUssdRegular: return "\u{f34f}"
        case .chatBold: return "\u{f350}"
        case .chatFilled: return "\u{f351}"
        case .chatGroupBold: return "\u{f352}"
        case .chatGroupFilled: return "\u{f353}"
        case .chatGroupLight: return "\u{f354}"
        case .chatGroupRegular: return "\u{f355}"
        case .chatLight: return "\u{f356}"
        case .chatMuteBold: return "\u{f357}"
        case .chatMuteLight: return "\u{f358}"
        case .chatMuteRegular: return "\u{f359}"
        case .chatOutboundFilled: return "\u{f35a}"
        case .chatRegular: return "\u{f35b}"
        case .checkBold: return "\u{f35c}"
        case .checkCircleBadgeFilled: return "\u{f35d}"
        case .checkCircleBold: return "\u{f35e}"
        case .checkCircleFilled: return "\u{f35f}"
        case .checkCircleLight: return "\u{f360}"
        case .checkCircleRegular: return "\u{f361}"
        case .checkFilled: return "\u{f362}"
        case .checkLight: return "\u{f363}"
        case .checkRegular: return "\u{f364}"
        case .checkboxGroupBold: return "\u{f365}"
        case .checkboxGroupFilled: return "\u{f366}"
        case .checkboxGroupLight: return "\u{f367}"
        case .checkboxGroupRegular: return "\u{f368}"
        case .cleanUpBold: return "\u{f369}"
        case .cleanUpLight: return "\u{f36a}"
        case .cleanUpRegular: return "\u{f36b}"
        case .clearBadgeFilled: return "\u{f36c}"
        case .clearBold: return "\u{f36d}"
        case .clearFilled: return "\u{f36e}"
        case .clearLight: return "\u{f36f}"
        case .clearRegular: return "\u{f370}"
        case .closeSpaceBold: return "\u{f371}"
        case .closeSpaceLight: return "\u{f372}"
        case .closeSpaceRegular: return "\u{f373}"
        case .closedCaptionBadgeBold: return "\u{f374}"
        case .closedCaptionBadgeFilled: return "\u{f375}"
        case .closedCaptionBadgeLight: return "\u{f376}"
        case .closedCaptionBadgeRegular: return "\u{f377}"
        case .closedCaptionsBold: return "\u{f378}"
        case .closedCaptionsFilled: return "\u{f379}"
        case .closedCaptionsLight: return "\u{f37a}"
        case .closedCaptionsRegular: return "\u{f37b}"
        case .cloudBold: return "\u{f37c}"
        case .cloudDownloadBold: return "\u{f37d}"
        case .cloudDownloadLight: return "\u{f37e}"
        case .cloudDownloadRegular: return "\u{f37f}"
        case .cloudFilled: return "\u{f380}"
        case .cloudFrameBold: return "\u{f381}"
        case .cloudFrameFilled: return "\u{f382}"
        case .cloudFrameLight: return "\u{f383}"
        case .cloudFrameRegular: return "\u{f384}"
        case .cloudLight: return "\u{f385}"
        case .cloudMutedBold: return "\u{f386}"
        case .cloudMutedFilled: return "\u{f387}"
        case .cloudMutedLight: return "\u{f388}"
        case .cloudMutedRegular: return "\u{f389}"
        case .cloudRegular: return "\u{f38a}"
        case .cloudUploadBold: return "\u{f38b}"
        case .cloudUploadLight: return "\u{f38c}"
        case .cloudUploadRegular: return "\u{f38d}"
        case .codeBlockBold: return "\u{f38e}"
        case .codeBlockLight: return "\u{f38f}"
        case .codeBlockRegular: return "\u{f390}"
        case .coffeeBold: return "\u{f391}"
        case .coffeeLight: return "\u{f392}"
        case .coffeeRegular: return "\u{f393}"
        case .colorBold: return "\u{f394}"
        case .colorFilled: return "\u{f395}"
        case .colorLight: return "\u{f396}"
        case .colorRegular: return "\u{f397}"
        case .colourPaletteBold: return "\u{f398}"
        case .colourPaletteFilled: return "\u{f399}"
        case .colourPaletteLight: return "\u{f39a}"
        case .colourPaletteRegular: return "\u{f39b}"
        case .commentingBold: return "\u{f39c}"
        case .commentingFilled: return "\u{f39d}"
        case .commentingLight: return "\u{f39e}"
        case .commentingRegular: return "\u{f39f}"
        case .companyBold: return "\u{f3a0}"
        case .companyLight: return "\u{f3a1}"
        case .companyRegular: return "\u{f3a2}"
        case .completedByBaseBold: return "\u{f3a3}"
        case .completedByBaseLight: return "\u{f3a4}"
        case .completedByBaseRegular: return "\u{f3a5}"
        case .completedByTimeBold: return "\u{f3a6}"
        case .completedByTimeLight: return "\u{f3a7}"
        case .completedByTimeRegular: return "\u{f3a8}"
        case .completedInteractionBold: return "\u{f3a9}"
        case .completedInteractionFilled: return "\u{f3aa}"
        case .completedInteractionLight: return "\u{f3ab}"
        case .completedInteractionRegular: return "\u{f3ac}"
        case .computerBold: return "\u{f3ad}"
        case .computerLight: return "\u{f3ae}"
        case .computerRegular: return "\u{f3af}"
        case .conciergeBold: return "\u{f3b0}"
        case .conciergeLight: return "\u{f3b1}"
        case .conciergeRegular: return "\u{f3b2}"
        case .conditionalBlockBold: return "\u{f3b3}"
        case .conditionalBlockLight: return "\u{f3b4}"
        case .conditionalBlockRegular: return "\u{f3b5}"
        case .connectBold: return "\u{f3b6}"
        case .connectLight: return "\u{f3b7}"
        case .connectRegular: return "\u{f3b8}"
        case .contactCardBold: return "\u{f3b9}"
        case .contactCardFilled: return "\u{f3ba}"
        case .contactCardLight: return "\u{f3bb}"
        case .contactCardRegular: return "\u{f3bc}"
        case .contactsBold: return "\u{f3bd}"
        case .contactsFilled: return "\u{f3be}"
        case .contactsLight: return "\u{f3bf}"
        case .contactsRegular: return "\u{f3c0}"
        case .contentDownloadBold: return "\u{f3c1}"
        case .contentDownloadFilled: return "\u{f3c2}"
        case .contentDownloadLight: return "\u{f3c3}"
        case .contentDownloadRegular: return "\u{f3c4}"
        case .contentShareBold: return "\u{f3c5}"
        case .contentShareLight: return "\u{f3c6}"
        case .contentShareRegular: return "\u{f3c7}"
        case .contrastBold: return "\u{f3c8}"
        case .contrastLight: return "\u{f3c9}"
        case .contrastRegular: return "\u{f3ca}"
        case .copyBold: return "\u{f3cb}"
        case .copyLight: return "\u{f3cc}"
        case .copyRegular: return "\u{f3cd}"
        case .cpuBold: return "\u{f3ce}"
        case .cpuLight: return "\u{f3cf}"
        case .cpuRegular: return "\u{f3d0}"
        case .createAGroupBold: return "\u{f3d1}"
        case .createAGroupFilled: return "\u{f3d2}"
        case .createAGroupLight: return "\u{f3d3}"
        case .createAGroupRegular: return "\u{f3d4}"
        case .cropBold: return "\u{f3d5}"
        case .cropLight: return "\u{f3d6}"
        case .cropRegular: return "\u{f3d7}"
        case .cucmConnectionBold: return "\u{f3d8}"
        case .cucmConnectionLight: return "\u{f3d9}"
        case .cucmConnectionRegular: return "\u{f3da}"
        case .customCodeEditorBold: return "\u{f3db}"
        case .customCodeEditorLight: return "\u{f3dc}"
        case .customCodeEditorRegular: return "\u{f3dd}"
        case .customTaskBold: return "\u{f3de}"
        case .customTaskFilled: return "\u{f3df}"
        case .customTaskIndBold: return "\u{f3e0}"
        case .customTaskIndFilled: return "\u{f3e1}"
        case .customTaskIndLight: return "\u{f3e2}"
        case .customTaskIndRegular: return "\u{f3e3}"
        case .customTaskLight: return "\u{f3e4}"
        case .customTaskRegular: return "\u{f3e5}"
        case .dailyRecurringScheduleBold: return "\u{f3e6}"
        case .dailyRecurringScheduleLight: return "\u{f3e7}"
        case .dailyRecurringScheduleRegular: return "\u{f3e8}"
        case .dashboardBold: return "\u{f3e9}"
        case .dashboardFilled: return "\u{f3ea}"
        case .dashboardLight: return "\u{f3eb}"
        case .dashboardRegular: return "\u{f3ec}"
        case .dataManagementBold: return "\u{f3ed}"
        case .dataManagementFilled: return "\u{f3ee}"
        case .dataManagementLight: return "\u{f3ef}"
        case .dataManagementRegular: return "\u{f3f0}"
        case .dataRangeSelectionBold: return "\u{f3f1}"
        case .dataRangeSelectionFilled: return "\u{f3f2}"
        case .dataRangeSelectionLight: return "\u{f3f3}"
        case .dataRangeSelectionRegular: return "\u{f3f4}"
        case .declineBold: return "\u{f3f5}"
        case .declineFilled: return "\u{f3f6}"
        case .declineLight: return "\u{f3f7}"
        case .declineRegular: return "\u{f3f8}"
        case .dectHandsetBold: return "\u{f3f9}"
        case .dectHandsetFilled: return "\u{f3fa}"
        case .dectHandsetLight: return "\u{f3fb}"
        case .dectHandsetRegular: return "\u{f3fc}"
        case .deleteBold: return "\u{f3fd}"
        case .deleteFilled: return "\u{f3fe}"
        case .deleteLight: return "\u{f3ff}"
        case .deleteRegular: return "\u{f400}"
        case .deploymentEvaluationProgressBold: return "\u{f401}"
        case .deploymentEvaluationProgressLight: return "\u{f402}"
        case .deploymentEvaluationProgressRegular: return "\u{f403}"
        case .deploymentProgressBold: return "\u{f404}"
        case .deploymentProgressLight: return "\u{f405}"
        case .deploymentProgressRegular: return "\u{f406}"
        case .deploymentRecurringBold: return "\u{f407}"
        case .deploymentRecurringLight: return "\u{f408}"
        case .deploymentRecurringRegular: return "\u{f409}"
        case .deploymentWinnerPendingBold: return "\u{f40a}"
        case .deploymentWinnerPendingLight: return "\u{f40b}"
        case .deploymentWinnerPendingRegular: return "\u{f40c}"
        case .deskPhoneBold: return "\u{f40d}"
        case .deskPhoneFilled: return "\u{f40e}"
        case .deskPhoneLight: return "\u{f40f}"
        case .deskPhoneRegular: return "\u{f410}"
        case .deskPhoneWarningBold: return "\u{f411}"
        case .deskPhoneWarningLight: return "\u{f412}"
        case .deskPhoneWarningRegular: return "\u{f413}"
        case .deviceConnectionBold: return "\u{f414}"
        case .deviceConnectionFilled: return "\u{f415}"
        case .deviceConnectionLight: return "\u{f416}"
        case .deviceConnectionRegular: return "\u{f417}"
        case .deviceInRoomBold: return "\u{f418}"
        case .deviceInRoomEndBold: return "\u{f419}"
        case .deviceInRoomEndLight: return "\u{f41a}"
        case .deviceInRoomEndRegular: return "\u{f41b}"
        case .deviceInRoomFilled: return "\u{f41c}"
        case .deviceInRoomLight: return "\u{f41d}"
        case .deviceInRoomRegular: return "\u{f41e}"
        case .deviceMutedBold: return "\u{f41f}"
        case .deviceMutedLight: return "\u{f420}"
        case .deviceMutedRegular: return "\u{f421}"
        case .devicePolicyControllerBold: return "\u{f422}"
        case .devicePolicyControllerLight: return "\u{f423}"
        case .devicePolicyControllerRegular: return "\u{f424}"
        case .devicesBold: return "\u{f425}"
        case .devicesFilled: return "\u{f426}"
        case .devicesLight: return "\u{f427}"
        case .devicesRegular: return "\u{f428}"
        case .diagnosticsBold: return "\u{f429}"
        case .diagnosticsLight: return "\u{f42a}"
        case .diagnosticsRegular: return "\u{f42b}"
        case .dialpadBold: return "\u{f42c}"
        case .dialpadLight: return "\u{f42d}"
        case .dialpadRegular: return "\u{f42e}"
        case .diamondBold: return "\u{f42f}"
        case .diamondFilled: return "\u{f430}"
        case .diamondLight: return "\u{f431}"
        case .diamondRegular: return "\u{f432}"
        case .directionalPadBold: return "\u{f433}"
        case .directionalPadFilled: return "\u{f434}"
        case .directionalPadLight: return "\u{f435}"
        case .directionalPadRegular: return "\u{f436}"
        case .directoryBold: return "\u{f437}"
        case .directoryLight: return "\u{f438}"
        case .directoryRegular: return "\u{f439}"
        case .disappearingPenBold: return "\u{f43a}"
        case .disappearingPenLight: return "\u{f43b}"
        case .disappearingPenRegular: return "\u{f43c}"
        case .discBold: return "\u{f43d}"
        case .discConnectedBold: return "\u{f43e}"
        case .discConnectedLight: return "\u{f43f}"
        case .discConnectedRegular: return "\u{f440}"
        case .discLight: return "\u{f441}"
        case .discRegular: return "\u{f442}"
        case .disconnectBold: return "\u{f443}"
        case .disconnectFilled: return "\u{f444}"
        case .disconnectLight: return "\u{f445}"
        case .disconnectRegular: return "\u{f446}"
        case .dislikeBold: return "\u{f447}"
        case .dislikeFilled: return "\u{f448}"
        case .dislikeLight: return "\u{f449}"
        case .dislikeRegular: return "\u{f44a}"
        case .displayBold: return "\u{f44b}"
        case .displayInputBold: return "\u{f44c}"
        case .displayInputLight: return "\u{f44d}"
        case .displayInputRegular: return "\u{f44e}"
        case .displayLight: return "\u{f44f}"
        case .displayRegular: return "\u{f450}"
        case .displayWarningBold: return "\u{f451}"
        case .displayWarningLight: return "\u{f452}"
        case .displayWarningRegular: return "\u{f453}"
        case .distributeHorizontalBold: return "\u{f454}"
        case .distributeHorizontalFilled: return "\u{f455}"
        case .distributeHorizontalLight: return "\u{f456}"
        case .distributeHorizontalRegular: return "\u{f457}"
        case .distributeVerticallyBold: return "\u{f458}"
        case .distributeVerticallyFilled: return "\u{f459}"
        case .distributeVerticallyLight: return "\u{f45a}"
        case .distributeVerticallyRegular: return "\u{f45b}"
        case .divideBold: return "\u{f45c}"
        case .divideFilled: return "\u{f45d}"
        case .divideLight: return "\u{f45e}"
        case .divideRegular: return "\u{f45f}"
        case .dndPresenceBadgeFilled: return "\u{f460}"
        case .dndPresenceBold: return "\u{f461}"
        case .dndPresenceFilled: return "\u{f462}"
        case .dndPresenceLight: return "\u{f463}"
        case .dndPresenceRegular: return "\u{f464}"
        case .dockWindowBold: return "\u{f465}"
        case .dockWindowLight: return "\u{f466}"
        case .dockWindowRegular: return "\u{f467}"
        case .documentBold: return "\u{f468}"
        case .documentCameraBold: return "\u{f469}"
        case .documentCameraDisconnectedBold: return "\u{f46a}"
        case .documentCameraDisconnectedLight: return "\u{f46b}"
        case .documentCameraDisconnectedRegular: return "\u{f46c}"
        case .documentCameraLight: return "\u{f46d}"
        case .documentCameraRegular: return "\u{f46e}"
        case .documentCreateBold: return "\u{f46f}"
        case .documentCreateFilled: return "\u{f470}"
        case .documentCreateLight: return "\u{f471}"
        case .documentCreateRegular: return "\u{f472}"
        case .documentFilled: return "\u{f473}"
        case .documentLight: return "\u{f474}"
        case .documentMoveBold: return "\u{f475}"
        case .documentMoveFilled: return "\u{f476}"
        case .documentMoveLight: return "\u{f477}"
        case .documentMoveRegular: return "\u{f478}"
        case .documentRegular: return "\u{f479}"
        case .documentShareBold: return "\u{f47a}"
        case .documentShareFilled: return "\u{f47b}"
        case .documentShareLight: return "\u{f47c}"
        case .documentShareRegular: return "\u{f47d}"
        case .doneAllBold: return "\u{f47e}"
        case .doneAllLight: return "\u{f47f}"
        case .doneAllRegular: return "\u{f480}"
        case .donutChartBold: return "\u{f481}"
        case .donutChartFilled: return "\u{f482}"
        case .donutChartLight: return "\u{f483}"
        case .donutChartRegular: return "\u{f484}"
        case .downloadBold: return "\u{f485}"
        case .downloadFilled: return "\u{f486}"
        case .downloadLight: return "\u{f487}"
        case .downloadRegular: return "\u{f488}"
        case .draftBold: return "\u{f489}"
        case .draftFilled: return "\u{f48a}"
        case .draftIndicatorBold: return "\u{f48b}"
        case .draftIndicatorSmallFilled: return "\u{f48c}"
        case .draftLight: return "\u{f48d}"
        case .draftRegular: return "\u{f48e}"
        case .dragBold: return "\u{f48f}"
        case .dragLight: return "\u{f490}"
        case .dragRegular: return "\u{f491}"
        case .draggerHorizontalBold: return "\u{f492}"
        case .draggerHorizontalLight: return "\u{f493}"
        case .draggerHorizontalRegular: return "\u{f494}"
        case .draggerVerticalBold: return "\u{f495}"
        case .draggerVerticalLight: return "\u{f496}"
        case .draggerVerticalRegular: return "\u{f497}"
        case .driveModeBold: return "\u{f498}"
        case .driveModeLight: return "\u{f499}"
        case .driveModeRegular: return "\u{f49a}"
        case .dropdownBold: return "\u{f49b}"
        case .dropdownLight: return "\u{f49c}"
        case .dropdownRegular: return "\u{f49d}"
        case .dxEightyBold: return "\u{f49e}"
        case .dxEightyFilled: return "\u{f49f}"
        case .dxEightyLight: return "\u{f4a0}"
        case .dxEightyRegular: return "\u{f4a1}"
        case .dxSeventyBold: return "\u{f4a2}"
        case .dxSeventyLight: return "\u{f4a3}"
        case .dxSeventyRegular: return "\u{f4a4}"
        case .editBold: return "\u{f4a5}"
        case .editFilled: return "\u{f4a6}"
        case .editLight: return "\u{f4a7}"
        case .editRegular: return "\u{f4a8}"
        case .editablePartialBold: return "\u{f4a9}"
        case .editablePartialLight: return "\u{f4aa}"
        case .editablePartialRegular: return "\u{f4ab}"
        case .educationBold: return "\u{f4ac}"
        case .educationFilled: return "\u{f4ad}"
        case .educationLight: return "\u{f4ae}"
        case .educationRegular: return "\u{f4af}"
        case .emailBold: return "\u{f4b0}"
        case .emailDeliveredBold: return "\u{f4b1}"
        case .emailDeliveredLight: return "\u{f4b2}"
        case .emailDeliveredRegular: return "\u{f4b3}"
        case .emailFailureBold: return "\u{f4b4}"
        case .emailFailureLight: return "\u{f4b5}"
        case .emailFailureRegular: return "\u{f4b6}"
        case .emailFilled: return "\u{f4b7}"
        case .emailInviteBold: return "\u{f4b8}"
        case .emailInviteLight: return "\u{f4b9}"
        case .emailInviteRegular: return "\u{f4ba}"
        case .emailLight: return "\u{f4bb}"
        case .emailOutgoingBold: return "\u{f4bc}"
        case .emailOutgoingFilled: return "\u{f4bd}"
        case .emailOutgoingLight: return "\u{f4be}"
        case .emailOutgoingRegular: return "\u{f4bf}"
        case .emailReadBold: return "\u{f4c0}"
        case .emailReadFilled: return "\u{f4c1}"
        case .emailReadLight: return "\u{f4c2}"
        case .emailReadRegular: return "\u{f4c3}"
        case .emailRegular: return "\u{f4c4}"
        case .emojiExcitedBold: return "\u{f4c5}"
        case .emojiExcitedFilled: return "\u{f4c6}"
        case .emojiExcitedLight: return "\u{f4c7}"
        case .emojiExcitedRegular: return "\u{f4c8}"
        case .emojiHappyBold: return "\u{f4c9}"
        case .emojiHappyFilled: return "\u{f4ca}"
        case .emojiHappyLight: return "\u{f4cb}"
        case .emojiHappyRegular: return "\u{f4cc}"
        case .emojiPassiveBold: return "\u{f4cd}"
        case .emojiPassiveFilled: return "\u{f4ce}"
        case .emojiPassiveLight: return "\u{f4cf}"
        case .emojiPassiveRegular: return "\u{f4d0}"
        case .emojiSadBold: return "\u{f4d1}"
        case .emojiSadFilled: return "\u{f4d2}"
        case .emojiSadLight: return "\u{f4d3}"
        case .emojiSadRegular: return "\u{f4d4}"
        case .emojiUnhappyBold: return "\u{f4d5}"
        case .emojiUnhappyFilled: return "\u{f4d6}"
        case .emojiUnhappyLight: return "\u{f4d7}"
        case .emojiUnhappyRegular: return "\u{f4d8}"
        case .encryptionCircleFilled: return "\u{f4d9}"
        case .encryptionFilled: return "\u{f4da}"
        case .endRemoteDesktopControlBold: return "\u{f4db}"
        case .endRemoteDesktopControlLight: return "\u{f4dc}"
        case .endRemoteDesktopControlRegular: return "\u{f4dd}"
        case .endToEndEncryptionCircleFilled: return "\u{f4de}"
        case .endToEndEncryptionFilled: return "\u{f4df}"
        case .endpointBlockedBold: return "\u{f4e0}"
        case .endpointBlockedLight: return "\u{f4e1}"
        case .endpointBlockedRegular: return "\u{f4e2}"
        case .endpointBold: return "\u{f4e3}"
        case .endpointGTwoBold: return "\u{f4e4}"
        case .endpointGTwoLight: return "\u{f4e5}"
        case .endpointGTwoRegular: return "\u{f4e6}"
        case .endpointGTwoSeventyBold: return "\u{f4e7}"
        case .endpointGTwoSeventyDualBold: return "\u{f4e8}"
        case .endpointGTwoSeventyDualLight: return "\u{f4e9}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4ea}"
        case .endpointGTwoSeventyLight: return "\u{f4eb}"
        case .endpointGTwoSeventyRegular: return "\u{f4ec}"
        case .endpointGTwoStandBold: return "\u{f4ed}"
        case .endpointGTwoStandLight: return "\u{f4ee}"
        case .endpointGTwoStandRegular: return "\u{f4ef}"
        case .endpointLight: return "\u{f4f0}"
        case .endpointMxEightHundredBold: return "\u{f4f1}"
        case .endpointMxEightHundredDualBold: return "\u{f4f2}"
        case .endpointMxEightHundredDualLight: return "\u{f4f3}"
        case .endpointMxEightHundredDualRegular: return "\u{f4f4}"
        case .endpointMxEightHundredLight: return "\u{f4f5}"
        case .endpointMxEightHundredRegular: return "\u{f4f6}"
        case .endpointRegular: return "\u{f4f7}"
        case .endpointStandBold: return "\u{f4f8}"
        case .endpointStandFilled: return "\u{f4f9}"
        case .endpointStandLight: return "\u{f4fa}"
        case .endpointStandRegular: return "\u{f4fb}"
        case .endpointWarningBold: return "\u{f4fc}"
        case .endpointWarningLight: return "\u{f4fd}"
        case .endpointWarningRegular: return "\u{f4fe}"
        case .enterBold: return "\u{f4ff}"
        case .enterLight: return "\u{f500}"
        case .enterRegular: return "\u{f501}"
        case .enterRoomBold: return "\u{f502}"
        case .enterRoomFilled: return "\u{f503}"
        case .enterRoomLight: return "\u{f504}"
        case .enterRoomRegular: return "\u{f505}"
        case .eraserBold: return "\u{f506}"
        case .eraserFilled: return "\u{f507}"
        case .eraserLight: return "\u{f508}"
        case .eraserRegular: return "\u{f509}"
        case .errorLegacyBadgeFilled: return "\u{f50a}"
        case .errorLegacyBold: return "\u{f50b}"
        case .errorLegacyFilled: return "\u{f50c}"
        case .errorLegacyLight: return "\u{f50d}"
        case .errorLegacyRegular: return "\u{f50e}"
        case .ethernetBold: return "\u{f50f}"
        case .ethernetFilled: return "\u{f510}"
        case .ethernetLight: return "\u{f511}"
        case .ethernetRegular: return "\u{f512}"
        case .exchangeBold: return "\u{f513}"
        case .exchangeLight: return "\u{f514}"
        case .exchangeRegular: return "\u{f515}"
        case .exclamationBold: return "\u{f516}"
        case .exclamationLight: return "\u{f517}"
        case .exclamationRegular: return "\u{f518}"
        case .excludeBold: return "\u{f519}"
        case .excludeLight: return "\u{f51a}"
        case .excludeRegular: return "\u{f51b}"
        case .existingTargetGroupBold: return "\u{f51c}"
        case .existingTargetGroupLight: return "\u{f51d}"
        case .existingTargetGroupRegular: return "\u{f51e}"
        case .exitRoomBold: return "\u{f51f}"
        case .exitRoomLight: return "\u{f520}"
        case .exitRoomRegular: return "\u{f521}"
        case .exploreBold: return "\u{f522}"
        case .exploreLight: return "\u{f523}"
        case .exploreRegular: return "\u{f524}"
        case .exportBold: return "\u{f525}"
        case .exportLight: return "\u{f526}"
        case .exportRegular: return "\u{f527}"
        case .extensionMobilityBold: return "\u{f528}"
        case .extensionMobilityLight: return "\u{f529}"
        case .extensionMobilityRegular: return "\u{f52a}"
        case .externalMessageBold: return "\u{f52b}"
        case .externalMessageLight: return "\u{f52c}"
        case .externalMessageRegular: return "\u{f52d}"
        case .externalUserBold: return "\u{f52e}"
        case .externalUserLight: return "\u{f52f}"
        case .externalUserRegular: return "\u{f530}"
        case .familyFontBold: return "\u{f531}"
        case .familyFontLight: return "\u{f532}"
        case .familyFontRegular: return "\u{f533}"
        case .fastForwardBold: return "\u{f534}"
        case .fastForwardLight: return "\u{f535}"
        case .fastForwardRegular: return "\u{f536}"
        case .favoriteBold: return "\u{f537}"
        case .favoriteFilled: return "\u{f538}"
        case .favoriteLight: return "\u{f539}"
        case .favoriteRegular: return "\u{f53a}"
        case .favoritesBold: return "\u{f53b}"
        case .favoritesFilled: return "\u{f53c}"
        case .favoritesLight: return "\u{f53d}"
        case .favoritesRegular: return "\u{f53e}"
        case .fbwBold: return "\u{f53f}"
        case .fbwFilled: return "\u{f540}"
        case .fbwLight: return "\u{f541}"
        case .fbwRegular: return "\u{f542}"
        case .ffwBold: return "\u{f543}"
        case .ffwFilled: return "\u{f544}"
        case .ffwLight: return "\u{f545}"
        case .ffwRegular: return "\u{f546}"
        case .fileAnalysisBold: return "\u{f547}"
        case .fileAnalysisFilled: return "\u{f548}"
        case .fileAnalysisLight: return "\u{f549}"
        case .fileAnalysisRegular: return "\u{f54a}"
        case .fileAnnotationBold: return "\u{f54b}"
        case .fileAnnotationFilled: return "\u{f54c}"
        case .fileAnnotationLight: return "\u{f54d}"
        case .fileAnnotationRegular: return "\u{f54e}"
        case .fileAudioBold: return "\u{f54f}"
        case .fileAudioFilled: return "\u{f550}"
        case .fileAudioLight: return "\u{f551}"
        case .fileAudioRegular: return "\u{f552}"
        case .fileBugBold: return "\u{f553}"
        case .fileBugFilled: return "\u{f554}"
        case .fileBugLight: return "\u{f555}"
        case .fileBugRegular: return "\u{f556}"
        case .fileCodeBold: return "\u{f557}"
        case .fileCodeFilled: return "\u{f558}"
        case .fileCodeLight: return "\u{f559}"
        case .fileCodeRegular: return "\u{f55a}"
        case .fileDashboardBold: return "\u{f55b}"
        case .fileDashboardFilled: return "\u{f55c}"
        case .fileDashboardLight: return "\u{f55d}"
        case .fileDashboardRegular: return "\u{f55e}"
        case .fileExcelBold: return "\u{f55f}"
        case .fileExcelFilled: return "\u{f560}"
        case .fileExcelLight: return "\u{f561}"
        case .fileExcelRegular: return "\u{f562}"
        case .fileGraphBold: return "\u{f563}"
        case .fileGraphFilled: return "\u{f564}"
        case .fileGraphLight: return "\u{f565}"
        case .fileGraphRegular: return "\u{f566}"
        case .fileImageBold: return "\u{f567}"
        case .fileImageFilled: return "\u{f568}"
        case .fileImageLight: return "\u{f569}"
        case .fileImageNoneBold: return "\u{f56a}"
        case .fileImageNoneLight: return "\u{f56b}"
        case .fileImageNoneRegular: return "\u{f56c}"
        case .fileImageRegular: return "\u{f56d}"
        case .fileJsBold: return "\u{f56e}"
        case .fileJsFilled: return "\u{f56f}"
        case .fileJsLight: return "\u{f570}"
        case .fileJsRegular: return "\u{f571}"
        case .fileKeynoteBold: return "\u{f572}"
        case .fileKeynoteFilled: return "\u{f573}"
        case .fileKeynoteLight: return "\u{f574}"
        case .fileKeynoteRegular: return "\u{f575}"
        case .fileLockedBold: return "\u{f576}"
        case .fileLockedFilled: return "\u{f577}"
        case .fileLockedLight: return "\u{f578}"
        case .fileLockedRegular: return "\u{f579}"
        case .fileMissingBold: return "\u{f57a}"
        case .fileMissingFilled: return "\u{f57b}"
        case .fileMissingLight: return "\u{f57c}"
        case .fileMissingRegular: return "\u{f57d}"
        case .fileMusicBold: return "\u{f57e}"
        case .fileMusicFilled: return "\u{f57f}"
        case .fileMusicLight: return "\u{f580}"
        case .fileMusicRegular: return "\u{f581}"
        case .fileOnenoteBold: return "\u{f582}"
        case .fileOnenoteFilled: return "\u{f583}"
        case .fileOnenoteLight: return "\u{f584}"
        case .fileOnenoteRegular: return "\u{f585}"
        case .filePdfBold: return "\u{f586}"
        case .filePdfFilled: return "\u{f587}"
        case .filePdfLight: return "\u{f588}"
        case .filePdfRegular: return "\u{f589}"
        case .filePowerpointBold: return "\u{f58a}"
        case .filePowerpointFilled: return "\u{f58b}"
        case .filePowerpointLight: return "\u{f58c}"
        case .filePowerpointRegular: return "\u{f58d}"
        case .fileSpreadsheetBold: return "\u{f58e}"
        case .fileSpreadsheetFilled: return "\u{f58f}"
        case .fileSpreadsheetLight: return "\u{f590}"
        case .fileSpreadsheetRegular: return "\u{f591}"
        case .fileTextBold: return "\u{f592}"
        case .fileTextFilled: return "\u{f593}"
        case .fileTextLight: return "\u{f594}"
        case .fileTextRegular: return "\u{f595}"
        case .fileThreeDBold: return "\u{f596}"
        case .fileThreeDFilled: return "\u{f597}"
        case .fileThreeDLight: return "\u{f598}"
        case .fileThreeDRegular: return "\u{f599}"
        case .fileVectorBold: return "\u{f59a}"
        case .fileVectorFilled: return "\u{f59b}"
        case .fileVectorLight: return "\u{f59c}"
        case .fileVectorRegular: return "\u{f59d}"
        case .fileVideoBold: return "\u{f59e}"
        case .fileVideoFilled: return "\u{f59f}"
        case .fileVideoLight: return "\u{f5a0}"
        case .fileVideoRegular: return "\u{f5a1}"
        case .fileWordBold: return "\u{f5a2}"
        case .fileWordFilled: return "\u{f5a3}"
        case .fileWordLight: return "\u{f5a4}"
        case .fileWordRegular: return "\u{f5a5}"
        case .fileXmlBold: return "\u{f5a6}"
        case .fileXmlFilled: return "\u{f5a7}"
        case .fileXmlLight: return "\u{f5a8}"
        case .fileXmlRegular: return "\u{f5a9}"
        case .fileZipBold: return "\u{f5aa}"
        case .fileZipFilled: return "\u{f5ab}"
        case .fileZipLight: return "\u{f5ac}"
        case .fileZipRegular: return "\u{f5ad}"
        case .filesBold: return "\u{f5ae}"
        case .filesFilled: return "\u{f5af}"
        case .filesLight: return "\u{f5b0}"
        case .filesRegular: return "\u{f5b1}"
        case .fillColourBold: return "\u{f5b2}"
        case .fillColourFilled: return "\u{f5b3}"
        case .fillColourLight: return "\u{f5b4}"
        case .fillColourRegular: return "\u{f5b5}"
        case .filterBold: return "\u{f5b6}"
        case .filterCircleBold: return "\u{f5b7}"
        case .filterCircleFilled: return "\u{f5b8}"
        case .filterCircleLight: return "\u{f5b9}"
        case .filterCircleRegular: return "\u{f5ba}"
        case .filterLight: return "\u{f5bb}"
        case .filterRegular: return "\u{f5bc}"
        case .fitToWidthBold: return "\u{f5bd}"
        case .fitToWidthLight: return "\u{f5be}"
        case .fitToWidthRegular: return "\u{f5bf}"
        case .fitToWindowExpandBold: return "\u{f5c0}"
        case .fitToWindowExpandLight: return "\u{f5c1}"
        case .fitToWindowExpandRegular: return "\u{f5c2}"
        case .fitToWindowShrinkBold: return "\u{f5c3}"
        case .fitToWindowShrinkLight: return "\u{f5c4}"
        case .fitToWindowShrinkRegular: return "\u{f5c5}"
        case .flagBold: return "\u{f5c6}"
        case .flagCircleBold: return "\u{f5c7}"
        case .flagCircleFilled: return "\u{f5c8}"
        case .flagCircleLight: return "\u{f5c9}"
        case .flagCircleRegular: return "\u{f5ca}"
        case .flagFilled: return "\u{f5cb}"
        case .flagLight: return "\u{f5cc}"
        case .flagRegular: return "\u{f5cd}"
        case .folderBold: return "\u{f5ce}"
        case .folderEditBold: return "\u{f5cf}"
        case .folderEditLight: return "\u{f5d0}"
        case .folderEditRegular: return "\u{f5d1}"
        case .folderFilled: return "\u{f5d2}"
        case .folderLight: return "\u{f5d3}"
        case .folderLockBold: return "\u{f5d4}"
        case .folderLockLight: return "\u{f5d5}"
        case .folderLockRegular: return "\u{f5d6}"
        case .folderRegular: return "\u{f5d7}"
        case .folderViewBold: return "\u{f5d8}"
        case .folderViewLight: return "\u{f5d9}"
        case .folderViewRegular: return "\u{f5da}"
        case .followUpBold: return "\u{f5db}"
        case .followUpLight: return "\u{f5dc}"
        case .followUpRegular: return "\u{f5dd}"
        case .foodBold: return "\u{f5de}"
        case .foodFilled: return "\u{f5df}"
        case .foodLight: return "\u{f5e0}"
        case .foodRegular: return "\u{f5e1}"
        case .formatBold: return "\u{f5e2}"
        case .formatDefaultAppBold: return "\u{f5e3}"
        case .formatDefaultAppFilled: return "\u{f5e4}"
        case .formatDefaultAppLight: return "\u{f5e5}"
        case .formatDefaultAppRegular: return "\u{f5e6}"
        case .formatLight: return "\u{f5e7}"
        case .formatPanelControlBarBold: return "\u{f5e8}"
        case .formatPanelControlBarLight: return "\u{f5e9}"
        case .formatPanelControlBarRegular: return "\u{f5ea}"
        case .formatPanelControlDownBold: return "\u{f5eb}"
        case .formatPanelControlDownLight: return "\u{f5ec}"
        case .formatPanelControlDownRegular: return "\u{f5ed}"
        case .formatPanelControlLeftBold: return "\u{f5ee}"
        case .formatPanelControlLeftLight: return "\u{f5ef}"
        case .formatPanelControlLeftRegular: return "\u{f5f0}"
        case .formatPanelControlRightBold: return "\u{f5f1}"
        case .formatPanelControlRightLight: return "\u{f5f2}"
        case .formatPanelControlRightRegular: return "\u{f5f3}"
        case .formatPanelControlUpBold: return "\u{f5f4}"
        case .formatPanelControlUpDownBold: return "\u{f5f5}"
        case .formatPanelControlUpDownLight: return "\u{f5f6}"
        case .formatPanelControlUpDownRegular: return "\u{f5f7}"
        case .formatPanelControlUpLight: return "\u{f5f8}"
        case .formatPanelControlUpRegular: return "\u{f5f9}"
        case .formatRegular: return "\u{f5fa}"
        case .formatViewMixedBold: return "\u{f5fb}"
        case .formatViewMixedLight: return "\u{f5fc}"
        case .formatViewMixedRegular: return "\u{f5fd}"
        case .formulaBold: return "\u{f5fe}"
        case .formulaFilled: return "\u{f5ff}"
        case .formulaLight: return "\u{f600}"
        case .formulaRegular: return "\u{f601}"
        case .forwardMessageBold: return "\u{f602}"
        case .forwardMessageFilled: return "\u{f603}"
        case .forwardMessageLight: return "\u{f604}"
        case .forwardMessageRegular: return "\u{f605}"
        case .forwardTenSecBold: return "\u{f606}"
        case .forwardTenSecLight: return "\u{f607}"
        case .forwardTenSecRegular: return "\u{f608}"
        case .fourColumnBold: return "\u{f609}"
        case .fourColumnLight: return "\u{f60a}"
        case .fourColumnRegular: return "\u{f60b}"
        case .fourWayNavigationBold: return "\u{f60c}"
        case .fourWayNavigationLight: return "\u{f60d}"
        case .fourWayNavigationRegular: return "\u{f60e}"
        case .frequencyCappingBold: return "\u{f60f}"
        case .frequencyCappingLight: return "\u{f610}"
        case .frequencyCappingRegular: return "\u{f611}"
        case .fulfillmentBold: return "\u{f612}"
        case .fulfillmentLight: return "\u{f613}"
        case .fulfillmentRegular: return "\u{f614}"
        case .fullscreenBold: return "\u{f615}"
        case .fullscreenExitBold: return "\u{f616}"
        case .fullscreenExitLight: return "\u{f617}"
        case .fullscreenExitRegular: return "\u{f618}"
        case .fullscreenLight: return "\u{f619}"
        case .fullscreenRegular: return "\u{f61a}"
        case .genericDeviceVideoBadgeFilled: return "\u{f61b}"
        case .genericDeviceVideoBold: return "\u{f61c}"
        case .genericDeviceVideoFilled: return "\u{f61d}"
        case .genericDeviceVideoLight: return "\u{f61e}"
        case .genericDeviceVideoRegular: return "\u{f61f}"
        case .gifBold: return "\u{f620}"
        case .gifFilled: return "\u{f621}"
        case .gifHorizontalBold: return "\u{f622}"
        case .gifHorizontalFilled: return "\u{f623}"
        case .gifHorizontalLight: return "\u{f624}"
        case .gifHorizontalRegular: return "\u{f625}"
        case .gifLight: return "\u{f626}"
        case .gifRegular: return "\u{f627}"
        case .giftBold: return "\u{f628}"
        case .giftFilled: return "\u{f629}"
        case .giftLight: return "\u{f62a}"
        case .giftRegular: return "\u{f62b}"
        case .greenLeafBold: return "\u{f62c}"
        case .greenLeafFilled: return "\u{f62d}"
        case .greenLeafLight: return "\u{f62e}"
        case .greenLeafRegular: return "\u{f62f}"
        case .greenRoomBold: return "\u{f630}"
        case .greenRoomFilled: return "\u{f631}"
        case .greenRoomLight: return "\u{f632}"
        case .greenRoomRegular: return "\u{f633}"
        case .guestIssuerBold: return "\u{f634}"
        case .guestIssuerLight: return "\u{f635}"
        case .guestIssuerRegular: return "\u{f636}"
        case .guideBold: return "\u{f637}"
        case .guideLight: return "\u{f638}"
        case .guideRegular: return "\u{f639}"
        case .handPointerBold: return "\u{f63a}"
        case .handPointerLight: return "\u{f63b}"
        case .handPointerRegular: return "\u{f63c}"
        case .handlerBold: return "\u{f63d}"
        case .handlerHorizontalBold: return "\u{f63e}"
        case .handlerHorizontalLight: return "\u{f63f}"
        case .handlerHorizontalRegular: return "\u{f640}"
        case .handlerLight: return "\u{f641}"
        case .handlerRegular: return "\u{f642}"
        case .handsetAlertBold: return "\u{f643}"
        case .handsetAlertFilled: return "\u{f644}"
        case .handsetAlertLight: return "\u{f645}"
        case .handsetAlertRegular: return "\u{f646}"
        case .handsetBold: return "\u{f647}"
        case .handsetDownSlashBold: return "\u{f648}"
        case .handsetDownSlashFilled: return "\u{f649}"
        case .handsetDownSlashLight: return "\u{f64a}"
        case .handsetDownSlashRegular: return "\u{f64b}"
        case .handsetFilled: return "\u{f64c}"
        case .handsetLight: return "\u{f64d}"
        case .handsetMutedBold: return "\u{f64e}"
        case .handsetMutedFilled: return "\u{f64f}"
        case .handsetMutedLight: return "\u{f650}"
        case .handsetMutedRegular: return "\u{f651}"
        case .handsetRegular: return "\u{f652}"
        case .handsetsArrowLeftBold: return "\u{f653}"
        case .handsetsArrowLeftLight: return "\u{f654}"
        case .handsetsArrowLeftRegular: return "\u{f655}"
        case .handshakeBold: return "\u{f656}"
        case .handshakeLight: return "\u{f657}"
        case .handshakeRegular: return "\u{f658}"
        case .headingOneBold: return "\u{f659}"
        case .headingOneLight: return "\u{f65a}"
        case .headingOneRegular: return "\u{f65b}"
        case .headingThreeBold: return "\u{f65c}"
        case .headingThreeLight: return "\u{f65d}"
        case .headingThreeRegular: return "\u{f65e}"
        case .headingTwoBold: return "\u{f65f}"
        case .headingTwoLight: return "\u{f660}"
        case .headingTwoRegular: return "\u{f661}"
        case .headphonesBold: return "\u{f662}"
        case .headphonesFilled: return "\u{f663}"
        case .headphonesLight: return "\u{f664}"
        case .headphonesMutedBold: return "\u{f665}"
        case .headphonesMutedFilled: return "\u{f666}"
        case .headphonesMutedLight: return "\u{f667}"
        case .headphonesMutedRegular: return "\u{f668}"
        case .headphonesRegular: return "\u{f669}"
        case .headsetAlertBold: return "\u{f66a}"
        case .headsetAlertLight: return "\u{f66b}"
        case .headsetAlertRegular: return "\u{f66c}"
        case .headsetArrowDownBold: return "\u{f66d}"
        case .headsetArrowDownFilled: return "\u{f66e}"
        case .headsetArrowDownLight: return "\u{f66f}"
        case .headsetArrowDownRegular: return "\u{f670}"
        case .headsetBluetoothBold: return "\u{f671}"
        case .headsetBluetoothLight: return "\u{f672}"
        case .headsetBluetoothRegular: return "\u{f673}"
        case .headsetBold: return "\u{f674}"
        case .headsetFilled: return "\u{f675}"
        case .headsetLight: return "\u{f676}"
        case .headsetMutedBold: return "\u{f677}"
        case .headsetMutedLight: return "\u{f678}"
        case .headsetMutedRegular: return "\u{f679}"
        case .headsetPrivateBold: return "\u{f67a}"
        case .headsetPrivateLight: return "\u{f67b}"
        case .headsetPrivateRegular: return "\u{f67c}"
        case .headsetRegular: return "\u{f67d}"
        case .hearingBold: return "\u{f67e}"
        case .hearingImpairedBold: return "\u{f67f}"
        case .hearingImpairedLight: return "\u{f680}"
        case .hearingImpairedRegular: return "\u{f681}"
        case .hearingLight: return "\u{f682}"
        case .hearingRegular: return "\u{f683}"
        case .helpBold: return "\u{f684}"
        case .helpCircleBold: return "\u{f685}"
        case .helpCircleFilled: return "\u{f686}"
        case .helpCircleLight: return "\u{f687}"
        case .helpCircleRegular: return "\u{f688}"
        case .helpLight: return "\u{f689}"
        case .helpRegular: return "\u{f68a}"
        case .helpdeskBold: return "\u{f68b}"
        case .helpdeskFilled: return "\u{f68c}"
        case .helpdeskLight: return "\u{f68d}"
        case .helpdeskRegular: return "\u{f68e}"
        case .hideBold: return "\u{f68f}"
        case .hideFilled: return "\u{f690}"
        case .hideLight: return "\u{f691}"
        case .hideRegular: return "\u{f692}"
        case .homeBold: return "\u{f693}"
        case .homeFilled: return "\u{f694}"
        case .homeLight: return "\u{f695}"
        case .homeRegular: return "\u{f696}"
        case .horizontalLineBold: return "\u{f697}"
        case .horizontalLineLight: return "\u{f698}"
        case .horizontalLineRegular: return "\u{f699}"
        case .hotelingBold: return "\u{f69a}"
        case .hotelingFilled: return "\u{f69b}"
        case .hotelingLight: return "\u{f69c}"
        case .hotelingRegular: return "\u{f69d}"
        case .humidityBold: return "\u{f69e}"
        case .humidityLight: return "\u{f69f}"
        case .humidityRegular: return "\u{f6a0}"
        case .huntGroupBold: return "\u{f6a1}"
        case .huntGroupFilled: return "\u{f6a2}"
        case .huntGroupLight: return "\u{f6a3}"
        case .huntGroupRegular: return "\u{f6a4}"
        case .idleBold: return "\u{f6a5}"
        case .idleFilled: return "\u{f6a6}"
        case .idleLight: return "\u{f6a7}"
        case .idleRegular: return "\u{f6a8}"
        case .immediateBold: return "\u{f6a9}"
        case .immediateFilled: return "\u{f6aa}"
        case .immediateLight: return "\u{f6ab}"
        case .immediateRegular: return "\u{f6ac}"
        case .importBold: return "\u{f6ad}"
        case .importLight: return "\u{f6ae}"
        case .importRegular: return "\u{f6af}"
        case .inCommonBold: return "\u{f6b0}"
        case .inCommonLight: return "\u{f6b1}"
        case .inCommonRegular: return "\u{f6b2}"
        case .inboxBold: return "\u{f6b3}"
        case .inboxFilled: return "\u{f6b4}"
        case .inboxLight: return "\u{f6b5}"
        case .inboxRegular: return "\u{f6b6}"
        case .includeBold: return "\u{f6b7}"
        case .includeLight: return "\u{f6b8}"
        case .includeRegular: return "\u{f6b9}"
        case .incognitoBold: return "\u{f6ba}"
        case .incognitoFilled: return "\u{f6bb}"
        case .incognitoLight: return "\u{f6bc}"
        case .incognitoRegular: return "\u{f6bd}"
        case .incomingCallLegacyBold: return "\u{f6be}"
        case .incomingCallLegacyFilled: return "\u{f6bf}"
        case .incomingCallLegacyLight: return "\u{f6c0}"
        case .incomingCallLegacyRegular: return "\u{f6c1}"
        case .indentDecreaseBold: return "\u{f6c2}"
        case .indentDecreaseLight: return "\u{f6c3}"
        case .indentDecreaseRegular: return "\u{f6c4}"
        case .indentIncreaseBold: return "\u{f6c5}"
        case .indentIncreaseLight: return "\u{f6c6}"
        case .indentIncreaseRegular: return "\u{f6c7}"
        case .infoBadgeFilled: return "\u{f6c8}"
        case .infoCircleBold: return "\u{f6c9}"
        case .infoCircleFilled: return "\u{f6ca}"
        case .infoCircleLight: return "\u{f6cb}"
        case .infoCircleRegular: return "\u{f6cc}"
        case .infoCircleTwoBold: return "\u{f6cd}"
        case .infoCircleTwoFilled: return "\u{f6ce}"
        case .infoCircleTwoLight: return "\u{f6cf}"
        case .infoCircleTwoRegular: return "\u{f6d0}"
        case .inputBold: return "\u{f6d1}"
        case .inputDisconnectedBold: return "\u{f6d2}"
        case .inputDisconnectedLight: return "\u{f6d3}"
        case .inputDisconnectedRegular: return "\u{f6d4}"
        case .inputLight: return "\u{f6d5}"
        case .inputRegular: return "\u{f6d6}"
        case .instantScheduleBold: return "\u{f6d7}"
        case .instantScheduleFilled: return "\u{f6d8}"
        case .instantScheduleLight: return "\u{f6d9}"
        case .instantScheduleRegular: return "\u{f6da}"
        case .integerBold: return "\u{f6db}"
        case .integerFilled: return "\u{f6dc}"
        case .integerLight: return "\u{f6dd}"
        case .integerRegular: return "\u{f6de}"
        case .integrationsBold: return "\u{f6df}"
        case .integrationsFilled: return "\u{f6e0}"
        case .integrationsLight: return "\u{f6e1}"
        case .integrationsRegular: return "\u{f6e2}"
        case .intelligentRoutingBold: return "\u{f6e3}"
        case .intelligentRoutingLight: return "\u{f6e4}"
        case .intelligentRoutingRegular: return "\u{f6e5}"
        case .interactionBold: return "\u{f6e6}"
        case .interactionFilled: return "\u{f6e7}"
        case .interactionLight: return "\u{f6e8}"
        case .interactionRegular: return "\u{f6e9}"
        case .invitedUserBold: return "\u{f6ea}"
        case .invitedUserLight: return "\u{f6eb}"
        case .invitedUserRegular: return "\u{f6ec}"
        case .italicBold: return "\u{f6ed}"
        case .italicFilled: return "\u{f6ee}"
        case .italicLight: return "\u{f6ef}"
        case .italicRegular: return "\u{f6f0}"
        case .joinAudioBold: return "\u{f6f1}"
        case .joinAudioFilled: return "\u{f6f2}"
        case .joinAudioLight: return "\u{f6f3}"
        case .joinAudioRegular: return "\u{f6f4}"
        case .keepInTouchBold: return "\u{f6f5}"
        case .keepInTouchFilled: return "\u{f6f6}"
        case .keepInTouchLight: return "\u{f6f7}"
        case .keepInTouchRegular: return "\u{f6f8}"
        case .keyboardBold: return "\u{f6f9}"
        case .keyboardCloseBold: return "\u{f6fa}"
        case .keyboardCloseLight: return "\u{f6fb}"
        case .keyboardCloseRegular: return "\u{f6fc}"
        case .keyboardLight: return "\u{f6fd}"
        case .keyboardRegular: return "\u{f6fe}"
        case .languageBold: return "\u{f6ff}"
        case .languageFilled: return "\u{f700}"
        case .languageLight: return "\u{f701}"
        case .languageRegular: return "\u{f702}"
        case .laptopBold: return "\u{f703}"
        case .laptopDisconnectedBold: return "\u{f704}"
        case .laptopDisconnectedLight: return "\u{f705}"
        case .laptopDisconnectedRegular: return "\u{f706}"
        case .laptopFilled: return "\u{f707}"
        case .laptopLight: return "\u{f708}"
        case .laptopRegular: return "\u{f709}"
        case .laserPointerBold: return "\u{f70a}"
        case .laserPointerCursorBlackLight: return "\u{f70b}"
        case .laserPointerCursorBlueLight: return "\u{f70c}"
        case .laserPointerCursorGreenLight: return "\u{f70d}"
        case .laserPointerCursorPurpleLight: return "\u{f70e}"
        case .laserPointerCursorRedLight: return "\u{f70f}"
        case .laserPointerCursorWhiteLight: return "\u{f710}"
        case .laserPointerCursorYellowLight: return "\u{f711}"
        case .laserPointerFilled: return "\u{f712}"
        case .laserPointerLight: return "\u{f713}"
        case .laserPointerRegular: return "\u{f714}"
        case .launchBold: return "\u{f715}"
        case .launchFilled: return "\u{f716}"
        case .launchLight: return "\u{f717}"
        case .launchRegular: return "\u{f718}"
        case .layoutSideBySideVerticalBold: return "\u{f719}"
        case .layoutSideBySideVerticalFilled: return "\u{f71a}"
        case .layoutSideBySideVerticalLight: return "\u{f71b}"
        case .layoutSideBySideVerticalRegular: return "\u{f71c}"
        case .leaveBreakoutSessionBold: return "\u{f71d}"
        case .leaveBreakoutSessionLight: return "\u{f71e}"
        case .leaveBreakoutSessionRegular: return "\u{f71f}"
        case .leaveDeviceBold: return "\u{f720}"
        case .leaveDeviceLight: return "\u{f721}"
        case .leaveDeviceRegular: return "\u{f722}"
        case .likeBold: return "\u{f723}"
        case .likeFilled: return "\u{f724}"
        case .likeLight: return "\u{f725}"
        case .likeRegular: return "\u{f726}"
        case .linkBold: return "\u{f727}"
        case .linkLight: return "\u{f728}"
        case .linkRegular: return "\u{f729}"
        case .listBulletedBold: return "\u{f72a}"
        case .listBulletedLight: return "\u{f72b}"
        case .listBulletedRegular: return "\u{f72c}"
        case .listMenuBold: return "\u{f72d}"
        case .listMenuLight: return "\u{f72e}"
        case .listMenuRegular: return "\u{f72f}"
        case .listNumberedBold: return "\u{f730}"
        case .listNumberedLight: return "\u{f731}"
        case .listNumberedRegular: return "\u{f732}"
        case .liveBold: return "\u{f733}"
        case .liveFilled: return "\u{f734}"
        case .liveLight: return "\u{f735}"
        case .liveRegular: return "\u{f736}"
        case .locationBold: return "\u{f737}"
        case .locationFilled: return "\u{f738}"
        case .locationLight: return "\u{f739}"
        case .locationRegular: return "\u{f73a}"
        case .longTextBoxBold: return "\u{f73b}"
        case .longTextBoxLight: return "\u{f73c}"
        case .longTextBoxRegular: return "\u{f73d}"
        case .lowerHandBold: return "\u{f73e}"
        case .lowerHandLight: return "\u{f73f}"
        case .lowerHandRegular: return "\u{f740}"
        case .magicPenBold: return "\u{f741}"
        case .magicPenFilled: return "\u{f742}"
        case .magicPenLight: return "\u{f743}"
        case .magicPenRegular: return "\u{f744}"
        case .markAsUnreadBold: return "\u{f745}"
        case .markAsUnreadFilled: return "\u{f746}"
        case .markAsUnreadLight: return "\u{f747}"
        case .markAsUnreadRegular: return "\u{f748}"
        case .markdownBold: return "\u{f749}"
        case .markdownFilled: return "\u{f74a}"
        case .markdownLight: return "\u{f74b}"
        case .markdownRegular: return "\u{f74c}"
        case .markerBold: return "\u{f74d}"
        case .markerFilled: return "\u{f74e}"
        case .markerLight: return "\u{f74f}"
        case .markerRegular: return "\u{f750}"
        case .maximizeBold: return "\u{f751}"
        case .maximizeLight: return "\u{f752}"
        case .maximizeRegular: return "\u{f753}"
        case .mediaPlayerBold: return "\u{f754}"
        case .mediaPlayerLight: return "\u{f755}"
        case .mediaPlayerRegular: return "\u{f756}"
        case .mediaQualityGoodBold: return "\u{f757}"
        case .mediaQualityGoodFilled: return "\u{f758}"
        case .mediaQualityGoodLight: return "\u{f759}"
        case .mediaQualityGoodRegular: return "\u{f75a}"
        case .mediaQualityPoorBold: return "\u{f75b}"
        case .mediaQualityPoorColoredBold: return "\u{f75c}"
        case .mediaQualityPoorFilled: return "\u{f75d}"
        case .mediaQualityPoorLight: return "\u{f75e}"
        case .mediaQualityPoorRegular: return "\u{f75f}"
        case .mediaQualityUnstableBold: return "\u{f760}"
        case .mediaQualityUnstableColoredBold: return "\u{f761}"
        case .mediaQualityUnstableFilled: return "\u{f762}"
        case .mediaQualityUnstableLight: return "\u{f763}"
        case .mediaQualityUnstableRegular: return "\u{f764}"
        case .meetBold: return "\u{f765}"
        case .meetEndBold: return "\u{f766}"
        case .meetEndLight: return "\u{f767}"
        case .meetEndRegular: return "\u{f768}"
        case .meetFilled: return "\u{f769}"
        case .meetLight: return "\u{f76a}"
        case .meetRegular: return "\u{f76b}"
        case .meetingSummaryBold: return "\u{f76c}"
        case .meetingSummaryFilled: return "\u{f76d}"
        case .meetingSummaryLight: return "\u{f76e}"
        case .meetingSummaryRegular: return "\u{f76f}"
        case .meetingsBold: return "\u{f770}"
        case .meetingsFilled: return "\u{f771}"
        case .meetingsFocusMonthBold: return "\u{f772}"
        case .meetingsFocusMonthLight: return "\u{f773}"
        case .meetingsFocusMonthRegular: return "\u{f774}"
        case .meetingsFocusOneDayBold: return "\u{f775}"
        case .meetingsFocusOneDayLight: return "\u{f776}"
        case .meetingsFocusOneDayRegular: return "\u{f777}"
        case .meetingsFocusThreeDayBold: return "\u{f778}"
        case .meetingsFocusThreeDayLight: return "\u{f779}"
        case .meetingsFocusThreeDayRegular: return "\u{f77a}"
        case .meetingsFocusUpcomingBold: return "\u{f77b}"
        case .meetingsFocusUpcomingLight: return "\u{f77c}"
        case .meetingsFocusUpcomingRegular: return "\u{f77d}"
        case .meetingsLight: return "\u{f77e}"
        case .meetingsPresenceBadgeFilled: return "\u{f77f}"
        case .meetingsPresenceBold: return "\u{f780}"
        case .meetingsPresenceFilled: return "\u{f781}"
        case .meetingsPresenceLight: return "\u{f782}"
        case .meetingsPresenceRegular: return "\u{f783}"
        case .meetingsRegular: return "\u{f784}"
        case .meetingsTeamBold: return "\u{f785}"
        case .meetingsTeamFilled: return "\u{f786}"
        case .meetingsTeamLight: return "\u{f787}"
        case .meetingsTeamNewBold: return "\u{f788}"
        case .meetingsTeamNewLight: return "\u{f789}"
        case .meetingsTeamNewRegular: return "\u{f78a}"
        case .meetingsTeamRegular: return "\u{f78b}"
        case .mentionBold: return "\u{f78c}"
        case .mentionFilled: return "\u{f78d}"
        case .mentionLight: return "\u{f78e}"
        case .mentionRegular: return "\u{f78f}"
        case .messageQueingBold: return "\u{f790}"
        case .messageQueingLight: return "\u{f791}"
        case .messageQueingRegular: return "\u{f792}"
        case .microphoneBold: return "\u{f793}"
        case .microphoneFilled: return "\u{f794}"
        case .microphoneHardMutedBold: return "\u{f795}"
        case .microphoneHardMutedCircleFilled: return "\u{f796}"
        case .microphoneHardMutedLight: return "\u{f797}"
        case .microphoneHardMutedRegular: return "\u{f798}"
        case .microphoneLight: return "\u{f799}"
        case .microphoneMusicModeBold: return "\u{f79a}"
        case .microphoneMusicModeLight: return "\u{f79b}"
        case .microphoneMusicModeOnBold: return "\u{f79c}"
        case .microphoneMusicModeOnLight: return "\u{f79d}"
        case .microphoneMusicModeOnRegular: return "\u{f79e}"
        case .microphoneMusicModeRegular: return "\u{f79f}"
        case .microphoneMutedBold: return "\u{f7a0}"
        case .microphoneMutedCircleFilled: return "\u{f7a1}"
        case .microphoneMutedFilled: return "\u{f7a2}"
        case .microphoneMutedLight: return "\u{f7a3}"
        case .microphoneMutedRegular: return "\u{f7a4}"
        case .microphoneOnBold: return "\u{f7a5}"
        case .microphoneOnLight: return "\u{f7a6}"
        case .microphoneOnRegular: return "\u{f7a7}"
        case .microphoneOptAllBold: return "\u{f7a8}"
        case .microphoneOptAllLight: return "\u{f7a9}"
        case .microphoneOptAllMutedBold: return "\u{f7aa}"
        case .microphoneOptAllMutedLight: return "\u{f7ab}"
        case .microphoneOptAllMutedRegular: return "\u{f7ac}"
        case .microphoneOptAllOnBold: return "\u{f7ad}"
        case .microphoneOptAllOnLight: return "\u{f7ae}"
        case .microphoneOptAllOnRegular: return "\u{f7af}"
        case .microphoneOptAllRegular: return "\u{f7b0}"
        case .microphoneOptMeBold: return "\u{f7b1}"
        case .microphoneOptMeLight: return "\u{f7b2}"
        case .microphoneOptMeMutedBold: return "\u{f7b3}"
        case .microphoneOptMeMutedLight: return "\u{f7b4}"
        case .microphoneOptMeMutedRegular: return "\u{f7b5}"
        case .microphoneOptMeOnBold: return "\u{f7b6}"
        case .microphoneOptMeOnLight: return "\u{f7b7}"
        case .microphoneOptMeOnRegular: return "\u{f7b8}"
        case .microphoneOptMeRegular: return "\u{f7b9}"
        case .microphoneRegular: return "\u{f7ba}"
        case .mindMapBold: return "\u{f7bb}"
        case .mindMapLight: return "\u{f7bc}"
        case .mindMapRegular: return "\u{f7bd}"
        case .minimizeBold: return "\u{f7be}"
        case .minimizeLight: return "\u{f7bf}"
        case .minimizeRegular: return "\u{f7c0}"
        case .minusBold: return "\u{f7c1}"
        case .minusFilled: return "\u{f7c2}"
        case .minusLight: return "\u{f7c3}"
        case .minusRegular: return "\u{f7c4}"
        case .mirrorBold: return "\u{f7c5}"
        case .mirrorFilled: return "\u{f7c6}"
        case .mirrorLight: return "\u{f7c7}"
        case .mirrorRegular: return "\u{f7c8}"
        case .mmsFilled: return "\u{f7c9}"
        case .moderatorBold: return "\u{f7ca}"
        case .moderatorLight: return "\u{f7cb}"
        case .moderatorRegular: return "\u{f7cc}"
        case .monitoringBold: return "\u{f7cd}"
        case .monitoringLight: return "\u{f7ce}"
        case .monitoringRegular: return "\u{f7cf}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7d0}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7d1}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7d2}"
        case .moreAdrBold: return "\u{f7d3}"
        case .moreAdrLight: return "\u{f7d4}"
        case .moreAdrRegular: return "\u{f7d5}"
        case .moreBold: return "\u{f7d6}"
        case .moreCircleBold: return "\u{f7d7}"
        case .moreCircleFilled: return "\u{f7d8}"
        case .moreCircleLight: return "\u{f7d9}"
        case .moreCircleRegular: return "\u{f7da}"
        case .moreLight: return "\u{f7db}"
        case .moreRegular: return "\u{f7dc}"
        case .mouseCursorBold: return "\u{f7dd}"
        case .mouseCursorLight: return "\u{f7de}"
        case .mouseCursorRegular: return "\u{f7df}"
        case .moveCallInAdrBold: return "\u{f7e0}"
        case .moveCallInAdrLight: return "\u{f7e1}"
        case .moveCallInAdrRegular: return "\u{f7e2}"
        case .moveCallInIphBold: return "\u{f7e3}"
        case .moveCallInIphLight: return "\u{f7e4}"
        case .moveCallInIphRegular: return "\u{f7e5}"
        case .moveCallInLaptopBold: return "\u{f7e6}"
        case .moveCallInLaptopLight: return "\u{f7e7}"
        case .moveCallInLaptopRegular: return "\u{f7e8}"
        case .moveCallInOutAdrBold: return "\u{f7e9}"
        case .moveCallInOutAdrLight: return "\u{f7ea}"
        case .moveCallInOutAdrRegular: return "\u{f7eb}"
        case .moveCallInOutIphBold: return "\u{f7ec}"
        case .moveCallInOutIphLight: return "\u{f7ed}"
        case .moveCallInOutIphRegular: return "\u{f7ee}"
        case .moveCallInTabletBold: return "\u{f7ef}"
        case .moveCallInTabletLight: return "\u{f7f0}"
        case .moveCallInTabletRegular: return "\u{f7f1}"
        case .moveCallOutAdrBold: return "\u{f7f2}"
        case .moveCallOutAdrLight: return "\u{f7f3}"
        case .moveCallOutAdrRegular: return "\u{f7f4}"
        case .moveCallOutIphBold: return "\u{f7f5}"
        case .moveCallOutIphLight: return "\u{f7f6}"
        case .moveCallOutIphRegular: return "\u{f7f7}"
        case .moveCallOutLaptopBold: return "\u{f7f8}"
        case .moveCallOutLaptopLight: return "\u{f7f9}"
        case .moveCallOutLaptopRegular: return "\u{f7fa}"
        case .moveCallOutTabletBold: return "\u{f7fb}"
        case .moveCallOutTabletLight: return "\u{f7fc}"
        case .moveCallOutTabletRegular: return "\u{f7fd}"
        case .moveToScreenBold: return "\u{f7fe}"
        case .moveToScreenLight: return "\u{f7ff}"
        case .moveToScreenRegular: return "\u{f800}"
        case .multilineChartBold: return "\u{f801}"
        case .multilineChartFilled: return "\u{f802}"
        case .multilineChartLight: return "\u{f803}"
        case .multilineChartRegular: return "\u{f804}"
        case .multimediaBold: return "\u{f805}"
        case .multimediaFilled: return "\u{f806}"
        case .multimediaLight: return "\u{f807}"
        case .multimediaRegular: return "\u{f808}"
        case .multipledDevicesBold: return "\u{f809}"
        case .multipledDevicesLight: return "\u{f80a}"
        case .multipledDevicesRegular: return "\u{f80b}"
        case .musicModeCircleBold: return "\u{f80c}"
        case .musicModeCircleFilled: return "\u{f80d}"
        case .musicModeCircleLight: return "\u{f80e}"
        case .musicModeCircleRegular: return "\u{f80f}"
        case .musicNoteBold: return "\u{f810}"
        case .musicNoteFilled: return "\u{f811}"
        case .musicNoteLight: return "\u{f812}"
        case .musicNoteRegular: return "\u{f813}"
        case .muteOnEntryBold: return "\u{f814}"
        case .muteOnEntryFilled: return "\u{f815}"
        case .muteOnEntryLight: return "\u{f816}"
        case .muteOnEntryRegular: return "\u{f817}"
        case .networkSwitchBold: return "\u{f818}"
        case .networkSwitchFilled: return "\u{f819}"
        case .networkSwitchLight: return "\u{f81a}"
        case .networkSwitchRegular: return "\u{f81b}"
        case .newManagerBold: return "\u{f81c}"
        case .newManagerFilled: return "\u{f81d}"
        case .newManagerLight: return "\u{f81e}"
        case .newManagerRegular: return "\u{f81f}"
        case .newTitleBold: return "\u{f820}"
        case .newTitleLight: return "\u{f821}"
        case .newTitleRegular: return "\u{f822}"
        case .newVoicemailBold: return "\u{f823}"
        case .newVoicemailLight: return "\u{f824}"
        case .newVoicemailRegular: return "\u{f825}"
        case .newWhiteboardBold: return "\u{f826}"
        case .newWhiteboardLight: return "\u{f827}"
        case .newWhiteboardRegular: return "\u{f828}"
        case .nextBold: return "\u{f829}"
        case .nextLight: return "\u{f82a}"
        case .nextRegular: return "\u{f82b}"
        case .noDevicesBold: return "\u{f82c}"
        case .noDevicesLight: return "\u{f82d}"
        case .noDevicesRegular: return "\u{f82e}"
        case .noiseDetectedCanceledFilled: return "\u{f82f}"
        case .noiseDetectedFilled: return "\u{f830}"
        case .noiseNoneCanceledFilled: return "\u{f831}"
        case .noiseNoneFilled: return "\u{f832}"
        case .noiseRemovalBold: return "\u{f833}"
        case .noiseRemovalLight: return "\u{f834}"
        case .noiseRemovalRegular: return "\u{f835}"
        case .noteBold: return "\u{f836}"
        case .noteFilled: return "\u{f837}"
        case .noteLight: return "\u{f838}"
        case .notePptBold: return "\u{f839}"
        case .notePptLight: return "\u{f83a}"
        case .notePptRegular: return "\u{f83b}"
        case .noteRegular: return "\u{f83c}"
        case .notesBold: return "\u{f83d}"
        case .notesFilled: return "\u{f83e}"
        case .notesLight: return "\u{f83f}"
        case .notesRegular: return "\u{f840}"
        case .numberBold: return "\u{f841}"
        case .numberLight: return "\u{f842}"
        case .numberRegular: return "\u{f843}"
        case .oldRemoteBold: return "\u{f844}"
        case .oldRemoteLight: return "\u{f845}"
        case .oldRemoteRegular: return "\u{f846}"
        case .oldTouchBold: return "\u{f847}"
        case .oldTouchLight: return "\u{f848}"
        case .oldTouchRegular: return "\u{f849}"
        case .oneColumnBold: return "\u{f84a}"
        case .oneColumnLight: return "\u{f84b}"
        case .oneColumnRegular: return "\u{f84c}"
        case .oneTimeBold: return "\u{f84d}"
        case .oneTimeLight: return "\u{f84e}"
        case .oneTimeRegular: return "\u{f84f}"
        case .openInFolderBold: return "\u{f850}"
        case .openInFolderFilled: return "\u{f851}"
        case .openInFolderLight: return "\u{f852}"
        case .openInFolderRegular: return "\u{f853}"
        case .openPagesBold: return "\u{f854}"
        case .openPagesLight: return "\u{f855}"
        case .openPagesRegular: return "\u{f856}"
        case .otherNumberBold: return "\u{f857}"
        case .otherNumberFilled: return "\u{f858}"
        case .otherNumberLight: return "\u{f859}"
        case .otherNumberRegular: return "\u{f85a}"
        case .otherNumberWarningBold: return "\u{f85b}"
        case .otherNumberWarningLight: return "\u{f85c}"
        case .otherNumberWarningRegular: return "\u{f85d}"
        case .outgoingCallLegacyBold: return "\u{f85e}"
        case .outgoingCallLegacyFilled: return "\u{f85f}"
        case .outgoingCallLegacyLight: return "\u{f860}"
        case .outgoingCallLegacyRegular: return "\u{f861}"
        case .overflowLeftBold: return "\u{f862}"
        case .overflowLeftLight: return "\u{f863}"
        case .overflowLeftRegular: return "\u{f864}"
        case .overflowRightBold: return "\u{f865}"
        case .overflowRightLight: return "\u{f866}"
        case .overflowRightRegular: return "\u{f867}"
        case .pairedCameraBold: return "\u{f868}"
        case .pairedCameraLight: return "\u{f869}"
        case .pairedCameraRegular: return "\u{f86a}"
        case .pairedDeviceBold: return "\u{f86b}"
        case .pairedDeviceLight: return "\u{f86c}"
        case .pairedDeviceRegular: return "\u{f86d}"
        case .pairedHandsetBold: return "\u{f86e}"
        case .pairedHandsetLight: return "\u{f86f}"
        case .pairedHandsetRegular: return "\u{f870}"
        case .pairingBold: return "\u{f871}"
        case .pairingLight: return "\u{f872}"
        case .pairingRegular: return "\u{f873}"
        case .parenthesisBold: return "\u{f874}"
        case .parenthesisFilled: return "\u{f875}"
        case .parenthesisLight: return "\u{f876}"
        case .parenthesisRegular: return "\u{f877}"
        case .parkedBold: return "\u{f878}"
        case .parkedFilled: return "\u{f879}"
        case .parkedLight: return "\u{f87a}"
        case .parkedRegular: return "\u{f87b}"
        case .parseBold: return "\u{f87c}"
        case .parseLight: return "\u{f87d}"
        case .parseRegular: return "\u{f87e}"
        case .partialBold: return "\u{f87f}"
        case .partialLight: return "\u{f880}"
        case .partialRegular: return "\u{f881}"
        case .participantAddBold: return "\u{f882}"
        case .participantAddLight: return "\u{f883}"
        case .participantAddRegular: return "\u{f884}"
        case .participantBlockedBold: return "\u{f885}"
        case .participantBlockedLight: return "\u{f886}"
        case .participantBlockedRegular: return "\u{f887}"
        case .participantBold: return "\u{f888}"
        case .participantFilled: return "\u{f889}"
        case .participantLight: return "\u{f88a}"
        case .participantListBold: return "\u{f88b}"
        case .participantListFilled: return "\u{f88c}"
        case .participantListLight: return "\u{f88d}"
        case .participantListRegular: return "\u{f88e}"
        case .participantRegular: return "\u{f88f}"
        case .participantRemoveBold: return "\u{f890}"
        case .participantRemoveLight: return "\u{f891}"
        case .participantRemoveRegular: return "\u{f892}"
        case .participantUnknownBold: return "\u{f893}"
        case .participantUnknownLight: return "\u{f894}"
        case .participantUnknownRegular: return "\u{f895}"
        case .passMouseBold: return "\u{f896}"
        case .passMouseLight: return "\u{f897}"
        case .passMouseRegular: return "\u{f898}"
        case .pauseBadgeFilled: return "\u{f899}"
        case .pauseBold: return "\u{f89a}"
        case .pauseFilled: return "\u{f89b}"
        case .pauseInteractionBold: return "\u{f89c}"
        case .pauseInteractionFilled: return "\u{f89d}"
        case .pauseInteractionLight: return "\u{f89e}"
        case .pauseInteractionRegular: return "\u{f89f}"
        case .pauseLight: return "\u{f8a0}"
        case .pauseRegular: return "\u{f8a1}"
        case .peopleAddBold: return "\u{f8a2}"
        case .peopleAddFilled: return "\u{f8a3}"
        case .peopleAddLight: return "\u{f8a4}"
        case .peopleAddRegular: return "\u{f8a5}"
        case .peopleBold: return "\u{f8a6}"
        case .peopleCircleBold: return "\u{f8a7}"
        case .peopleCircleFilled: return "\u{f8a8}"
        case .peopleCircleLight: return "\u{f8a9}"
        case .peopleCircleRegular: return "\u{f8aa}"
        case .peopleFilled: return "\u{f8ab}"
        case .peopleInsightsBold: return "\u{f8ac}"
        case .peopleInsightsFilled: return "\u{f8ad}"
        case .peopleInsightsLight: return "\u{f8ae}"
        case .peopleInsightsRegular: return "\u{f8af}"
        case .peopleLight: return "\u{f8b0}"
        case .peopleManageBold: return "\u{f8b1}"
        case .peopleManageFilled: return "\u{f8b2}"
        case .peopleManageLight: return "\u{f8b3}"
        case .peopleManageRegular: return "\u{f8b4}"
        case .peopleRegular: return "\u{f8b5}"
        case .phoneAlertBold: return "\u{f8b6}"
        case .phoneAlertLight: return "\u{f8b7}"
        case .phoneAlertRegular: return "\u{f8b8}"
        case .phoneBadgeFilled: return "\u{f8b9}"
        case .phoneBold: return "\u{f8ba}"
        case .phoneFilled: return "\u{f8bb}"
        case .phoneLight: return "\u{f8bc}"
        case .phoneMutedBold: return "\u{f8bd}"
        case .phoneMutedLight: return "\u{f8be}"
        case .phoneMutedRegular: return "\u{f8bf}"
        case .phonePrivateBold: return "\u{f8c0}"
        case .phonePrivateLight: return "\u{f8c1}"
        case .phonePrivateRegular: return "\u{f8c2}"
        case .phoneRegular: return "\u{f8c3}"
        case .phoneReplyAllBold: return "\u{f8c4}"
        case .phoneReplyAllLight: return "\u{f8c5}"
        case .phoneReplyAllRegular: return "\u{f8c6}"
        case .phoneReplyBold: return "\u{f8c7}"
        case .phoneReplyLight: return "\u{f8c8}"
        case .phoneReplyRegular: return "\u{f8c9}"
        case .pickerBold: return "\u{f8ca}"
        case .pickerLight: return "\u{f8cb}"
        case .pickerRegular: return "\u{f8cc}"
        case .pieChartBold: return "\u{f8cd}"
        case .pieChartFilled: return "\u{f8ce}"
        case .pieChartLight: return "\u{f8cf}"
        case .pieChartRegular: return "\u{f8d0}"
        case .pinBold: return "\u{f8d1}"
        case .pinFilled: return "\u{f8d2}"
        case .pinLight: return "\u{f8d3}"
        case .pinListActivityBold: return "\u{f8d4}"
        case .pinListActivityLight: return "\u{f8d5}"
        case .pinListActivityRegular: return "\u{f8d6}"
        case .pinListBold: return "\u{f8d7}"
        case .pinListLight: return "\u{f8d8}"
        case .pinListRegular: return "\u{f8d9}"
        case .pinMutedBold: return "\u{f8da}"
        case .pinMutedFilled: return "\u{f8db}"
        case .pinMutedLight: return "\u{f8dc}"
        case .pinMutedRegular: return "\u{f8dd}"
        case .pinRegular: return "\u{f8de}"
        case .pipBold: return "\u{f8df}"
        case .pipEnterBold: return "\u{f8e0}"
        case .pipEnterLight: return "\u{f8e1}"
        case .pipEnterRegular: return "\u{f8e2}"
        case .pipExitBold: return "\u{f8e3}"
        case .pipExitLight: return "\u{f8e4}"
        case .pipExitRegular: return "\u{f8e5}"
        case .pipFilled: return "\u{f8e6}"
        case .pipLight: return "\u{f8e7}"
        case .pipRegular: return "\u{f8e8}"
        case .placeholderBold: return "\u{f8e9}"
        case .placeholderFilled: return "\u{f8ea}"
        case .placeholderLight: return "\u{f8eb}"
        case .placeholderRegular: return "\u{f8ec}"
        case .playBold: return "\u{f8ed}"
        case .playCircleBold: return "\u{f8ee}"
        case .playCircleFilled: return "\u{f8ef}"
        case .playCircleLight: return "\u{f8f0}"
        case .playCircleRegular: return "\u{f8f1}"
        case .playFilled: return "\u{f8f2}"
        case .playLight: return "\u{f8f3}"
        case .playRegular: return "\u{f8f4}"
        case .plugAcBold: return "\u{f8f5}"
        case .plugAcLight: return "\u{f8f6}"
        case .plugAcRegular: return "\u{f8f7}"
        case .plusBold: return "\u{f8f8}"
        case .plusCircleBold: return "\u{f8f9}"
        case .plusCircleFilled: return "\u{f8fa}"
        case .plusCircleLight: return "\u{f8fb}"
        case .plusCircleRegular: return "\u{f8fc}"
        case .plusLight: return "\u{f8fd}"
        case .plusRegular: return "\u{f8fe}"
        case .pmrBold: return "\u{f8ff}"
        case .pmrFilled: return "\u{f900}"
        case .pmrLight: return "\u{f901}"
        case .pmrRegular: return "\u{f902}"
        case .pollBold: return "\u{f903}"
        case .pollFilled: return "\u{f904}"
        case .pollLight: return "\u{f905}"
        case .pollRegular: return "\u{f906}"
        case .popInBold: return "\u{f907}"
        case .popInLight: return "\u{f908}"
        case .popInRegular: return "\u{f909}"
        case .popOutBold: return "\u{f90a}"
        case .popOutLight: return "\u{f90b}"
        case .popOutRegular: return "\u{f90c}"
        case .popUpBold: return "\u{f90d}"
        case .popUpLight: return "\u{f90e}"
        case .popUpRegular: return "\u{f90f}"
        case .portraitLandscapeBold: return "\u{f910}"
        case .portraitLandscapeLight: return "\u{f911}"
        case .portraitLandscapeRegular: return "\u{f912}"
        case .potentialFraudBold: return "\u{f913}"
        case .potentialFraudFilled: return "\u{f914}"
        case .potentialFraudLight: return "\u{f915}"
        case .potentialFraudRegular: return "\u{f916}"
        case .powerAcBold: return "\u{f917}"
        case .powerAcLight: return "\u{f918}"
        case .powerAcRegular: return "\u{f919}"
        case .powerBold: return "\u{f91a}"
        case .powerLight: return "\u{f91b}"
        case .powerRegular: return "\u{f91c}"
        case .preHeaderBold: return "\u{f91d}"
        case .preHeaderLight: return "\u{f91e}"
        case .preHeaderRegular: return "\u{f91f}"
        case .premiumBold: return "\u{f920}"
        case .premiumLight: return "\u{f921}"
        case .premiumRegular: return "\u{f922}"
        case .presentationBold: return "\u{f923}"
        case .presentationLight: return "\u{f924}"
        case .presentationRegular: return "\u{f925}"
        case .preventDownloadBold: return "\u{f926}"
        case .preventDownloadFilled: return "\u{f927}"
        case .preventDownloadLight: return "\u{f928}"
        case .preventDownloadRegular: return "\u{f929}"
        case .primaryParticipantBold: return "\u{f92a}"
        case .primaryParticipantFilled: return "\u{f92b}"
        case .primaryParticipantLight: return "\u{f92c}"
        case .primaryParticipantRegular: return "\u{f92d}"
        case .printBold: return "\u{f92e}"
        case .printLight: return "\u{f92f}"
        case .printRegular: return "\u{f930}"
        case .priorityBadgeFilled: return "\u{f931}"
        case .priorityCircleBold: return "\u{f932}"
        case .priorityCircleFilled: return "\u{f933}"
        case .priorityCircleLight: return "\u{f934}"
        case .priorityCircleRegular: return "\u{f935}"
        case .priorityCircleTwoBold: return "\u{f936}"
        case .priorityCircleTwoFilled: return "\u{f937}"
        case .priorityCircleTwoLight: return "\u{f938}"
        case .priorityCircleTwoRegular: return "\u{f939}"
        case .priorityWaveBold: return "\u{f93a}"
        case .priorityWaveLight: return "\u{f93b}"
        case .priorityWaveRegular: return "\u{f93c}"
        case .privacyCircleBold: return "\u{f93d}"
        case .privacyCircleFilled: return "\u{f93e}"
        case .privacyCircleLight: return "\u{f93f}"
        case .privacyCircleRegular: return "\u{f940}"
        case .privateBold: return "\u{f941}"
        case .privateCircleBold: return "\u{f942}"
        case .privateCircleFilled: return "\u{f943}"
        case .privateCircleLight: return "\u{f944}"
        case .privateCircleRegular: return "\u{f945}"
        case .privateLight: return "\u{f946}"
        case .privateMeetingBold: return "\u{f947}"
        case .privateMeetingLight: return "\u{f948}"
        case .privateMeetingRegular: return "\u{f949}"
        case .privateRegular: return "\u{f94a}"
        case .productDemoBold: return "\u{f94b}"
        case .productDemoLight: return "\u{f94c}"
        case .productDemoRegular: return "\u{f94d}"
        case .promptsAiBold: return "\u{f94e}"
        case .promptsAiLight: return "\u{f94f}"
        case .promptsAiRegular: return "\u{f950}"
        case .proximityBold: return "\u{f951}"
        case .proximityLight: return "\u{f952}"
        case .proximityMutedBold: return "\u{f953}"
        case .proximityMutedLight: return "\u{f954}"
        case .proximityMutedRegular: return "\u{f955}"
        case .proximityRegular: return "\u{f956}"
        case .proximityVideoBold: return "\u{f957}"
        case .proximityVideoLight: return "\u{f958}"
        case .proximityVideoRegular: return "\u{f959}"
        case .ptoPresenceBold: return "\u{f95a}"
        case .ptoPresenceFilled: return "\u{f95b}"
        case .ptoPresenceLight: return "\u{f95c}"
        case .ptoPresenceRegular: return "\u{f95d}"
        case .pullCallBold: return "\u{f95e}"
        case .pullCallFilled: return "\u{f95f}"
        case .pullCallLight: return "\u{f960}"
        case .pullCallRegular: return "\u{f961}"
        case .qABold: return "\u{f962}"
        case .qAFilled: return "\u{f963}"
        case .qALight: return "\u{f964}"
        case .qARegular: return "\u{f965}"
        case .qrCodeBold: return "\u{f966}"
        case .qrCodeLight: return "\u{f967}"
        case .qrCodeRegular: return "\u{f968}"
        case .qrCodeScanBold: return "\u{f969}"
        case .qrCodeScanLight: return "\u{f96a}"
        case .qrCodeScanRegular: return "\u{f96b}"
        case .qualityBold: return "\u{f96c}"
        case .qualityLight: return "\u{f96d}"
        case .qualityRegular: return "\u{f96e}"
        case .queueContactBold: return "\u{f96f}"
        case .queueContactFilled: return "\u{f970}"
        case .queueContactLight: return "\u{f971}"
        case .queueContactRegular: return "\u{f972}"
        case .queuedInteractionBold: return "\u{f973}"
        case .queuedInteractionFilled: return "\u{f974}"
        case .queuedInteractionLight: return "\u{f975}"
        case .queuedInteractionRegular: return "\u{f976}"
        case .quietBold: return "\u{f977}"
        case .quietHoursPresenceBold: return "\u{f978}"
        case .quietHoursPresenceFilled: return "\u{f979}"
        case .quietHoursPresenceLight: return "\u{f97a}"
        case .quietHoursPresenceRegular: return "\u{f97b}"
        case .quietLight: return "\u{f97c}"
        case .quietRegular: return "\u{f97d}"
        case .radioButtonGroupBold: return "\u{f97e}"
        case .radioButtonGroupLight: return "\u{f97f}"
        case .radioButtonGroupRegular: return "\u{f980}"
        case .raiseHandBold: return "\u{f981}"
        case .raiseHandCircleFilled: return "\u{f982}"
        case .raiseHandFilled: return "\u{f983}"
        case .raiseHandLight: return "\u{f984}"
        case .raiseHandRegular: return "\u{f985}"
        case .ramBold: return "\u{f986}"
        case .ramLight: return "\u{f987}"
        case .ramRegular: return "\u{f988}"
        case .reactionsBold: return "\u{f989}"
        case .reactionsFilled: return "\u{f98a}"
        case .reactionsLight: return "\u{f98b}"
        case .reactionsRegular: return "\u{f98c}"
        case .reactivateBold: return "\u{f98d}"
        case .reactivateLight: return "\u{f98e}"
        case .reactivateRegular: return "\u{f98f}"
        case .receiveVoiceBold: return "\u{f990}"
        case .receiveVoiceFilled: return "\u{f991}"
        case .receiveVoiceLight: return "\u{f992}"
        case .receiveVoiceRegular: return "\u{f993}"
        case .recentsBold: return "\u{f994}"
        case .recentsFilled: return "\u{f995}"
        case .recentsLight: return "\u{f996}"
        case .recentsPresenceBadgeFilled: return "\u{f997}"
        case .recentsPresenceBold: return "\u{f998}"
        case .recentsPresenceFilled: return "\u{f999}"
        case .recentsPresenceLight: return "\u{f99a}"
        case .recentsPresenceRegular: return "\u{f99b}"
        case .recentsRegular: return "\u{f99c}"
        case .recordActiveBadgeFilled: return "\u{f99d}"
        case .recordActiveBold: return "\u{f99e}"
        case .recordActiveFilled: return "\u{f99f}"
        case .recordActiveLight: return "\u{f9a0}"
        case .recordActiveRegular: return "\u{f9a1}"
        case .recordBold: return "\u{f9a2}"
        case .recordFilled: return "\u{f9a3}"
        case .recordLight: return "\u{f9a4}"
        case .recordPausedBadgeFilled: return "\u{f9a5}"
        case .recordPausedBold: return "\u{f9a6}"
        case .recordPausedFilled: return "\u{f9a7}"
        case .recordPausedLight: return "\u{f9a8}"
        case .recordPausedRegular: return "\u{f9a9}"
        case .recordRegular: return "\u{f9aa}"
        case .recurringBold: return "\u{f9ab}"
        case .recurringLight: return "\u{f9ac}"
        case .recurringOffBold: return "\u{f9ad}"
        case .recurringOffLight: return "\u{f9ae}"
        case .recurringOffRegular: return "\u{f9af}"
        case .recurringRegular: return "\u{f9b0}"
        case .redoBold: return "\u{f9b1}"
        case .redoLight: return "\u{f9b2}"
        case .redoRegular: return "\u{f9b3}"
        case .refreshBold: return "\u{f9b4}"
        case .refreshLight: return "\u{f9b5}"
        case .refreshRegular: return "\u{f9b6}"
        case .remoteDesktopControlBold: return "\u{f9b7}"
        case .remoteDesktopControlFilled: return "\u{f9b8}"
        case .remoteDesktopControlLight: return "\u{f9b9}"
        case .remoteDesktopControlRegular: return "\u{f9ba}"
        case .removeBold: return "\u{f9bb}"
        case .removeFilled: return "\u{f9bc}"
        case .removeLight: return "\u{f9bd}"
        case .removeRegular: return "\u{f9be}"
        case .replyBold: return "\u{f9bf}"
        case .replyFilled: return "\u{f9c0}"
        case .replyLight: return "\u{f9c1}"
        case .replyListBold: return "\u{f9c2}"
        case .replyListFilled: return "\u{f9c3}"
        case .replyListLight: return "\u{f9c4}"
        case .replyListRegular: return "\u{f9c5}"
        case .replyPrivatelyBold: return "\u{f9c6}"
        case .replyPrivatelyLight: return "\u{f9c7}"
        case .replyPrivatelyRegular: return "\u{f9c8}"
        case .replyRegular: return "\u{f9c9}"
        case .resetBold: return "\u{f9ca}"
        case .resetLight: return "\u{f9cb}"
        case .resetRegular: return "\u{f9cc}"
        case .resizeCornerBold: return "\u{f9cd}"
        case .resizeCornerLight: return "\u{f9ce}"
        case .resizeCornerRegular: return "\u{f9cf}"
        case .responsiveMobileBold: return "\u{f9d0}"
        case .responsiveMobileLight: return "\u{f9d1}"
        case .responsiveMobileRegular: return "\u{f9d2}"
        case .restartBold: return "\u{f9d3}"
        case .restartLight: return "\u{f9d4}"
        case .restartRegular: return "\u{f9d5}"
        case .resumeInteractionBold: return "\u{f9d6}"
        case .resumeInteractionFilled: return "\u{f9d7}"
        case .resumeInteractionLight: return "\u{f9d8}"
        case .resumeInteractionRegular: return "\u{f9d9}"
        case .retrieveCallBold: return "\u{f9da}"
        case .retrieveCallFilled: return "\u{f9db}"
        case .retrieveCallLight: return "\u{f9dc}"
        case .retrieveCallRegular: return "\u{f9dd}"
        case .returnBold: return "\u{f9de}"
        case .returnLight: return "\u{f9df}"
        case .returnRegular: return "\u{f9e0}"
        case .rewindTenSecBold: return "\u{f9e1}"
        case .rewindTenSecLight: return "\u{f9e2}"
        case .rewindTenSecRegular: return "\u{f9e3}"
        case .ringtoneBold: return "\u{f9e4}"
        case .ringtoneLight: return "\u{f9e5}"
        case .ringtoneRegular: return "\u{f9e6}"
        case .roomCalendarBold: return "\u{f9e7}"
        case .roomCalendarLight: return "\u{f9e8}"
        case .roomCalendarRegular: return "\u{f9e9}"
        case .roomLightsBold: return "\u{f9ea}"
        case .roomLightsFilled: return "\u{f9eb}"
        case .roomLightsLight: return "\u{f9ec}"
        case .roomLightsRegular: return "\u{f9ed}"
        case .rotateContentBold: return "\u{f9ee}"
        case .rotateContentFilled: return "\u{f9ef}"
        case .rotateContentLight: return "\u{f9f0}"
        case .rotateContentRegular: return "\u{f9f1}"
        case .rssBold: return "\u{f9f2}"
        case .rssFilled: return "\u{f9f3}"
        case .rssLight: return "\u{f9f4}"
        case .rssRegular: return "\u{f9f5}"
        case .ruleBasedBold: return "\u{f9f6}"
        case .ruleBasedLight: return "\u{f9f7}"
        case .ruleBasedRegular: return "\u{f9f8}"
        case .rulerBold: return "\u{f9f9}"
        case .rulerFilled: return "\u{f9fa}"
        case .rulerLight: return "\u{f9fb}"
        case .rulerRegular: return "\u{f9fc}"
        case .runningApplicationBold: return "\u{f9fd}"
        case .runningApplicationFilled: return "\u{f9fe}"
        case .runningApplicationLight: return "\u{f9ff}"
        case .runningApplicationRegular: return "\u{fa00}"
        case .saveBold: return "\u{fa01}"
        case .saveLight: return "\u{fa02}"
        case .saveRegular: return "\u{fa03}"
        case .saveTranscriptBold: return "\u{fa04}"
        case .saveTranscriptFilled: return "\u{fa05}"
        case .saveTranscriptLight: return "\u{fa06}"
        case .saveTranscriptRegular: return "\u{fa07}"
        case .scanBold: return "\u{fa08}"
        case .scanLight: return "\u{fa09}"
        case .scanRegular: return "\u{fa0a}"
        case .scheduleAiBold: return "\u{fa0b}"
        case .scheduleAiLight: return "\u{fa0c}"
        case .scheduleAiRegular: return "\u{fa0d}"
        case .scheduleSendBold: return "\u{fa0e}"
        case .scheduleSendFilled: return "\u{fa0f}"
        case .scheduleSendLight: return "\u{fa10}"
        case .scheduleSendRegular: return "\u{fa11}"
        case .scheduleWinnerBold: return "\u{fa12}"
        case .scheduleWinnerFilled: return "\u{fa13}"
        case .scheduleWinnerLight: return "\u{fa14}"
        case .scheduleWinnerRegular: return "\u{fa15}"
        case .schedulerAvailableBold: return "\u{fa16}"
        case .schedulerAvailableLight: return "\u{fa17}"
        case .schedulerAvailableRegular: return "\u{fa18}"
        case .schedulerNotWorkingHoursBold: return "\u{fa19}"
        case .schedulerNotWorkingHoursLight: return "\u{fa1a}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa1b}"
        case .schedulerUnavailableBold: return "\u{fa1c}"
        case .schedulerUnavailableLight: return "\u{fa1d}"
        case .schedulerUnavailableRegular: return "\u{fa1e}"
        case .schedulerUnknownBold: return "\u{fa1f}"
        case .schedulerUnknownLight: return "\u{fa20}"
        case .schedulerUnknownRegular: return "\u{fa21}"
        case .screenshotBold: return "\u{fa22}"
        case .screenshotDocBold: return "\u{fa23}"
        case .screenshotDocFilled: return "\u{fa24}"
        case .screenshotDocLight: return "\u{fa25}"
        case .screenshotDocRegular: return "\u{fa26}"
        case .screenshotLight: return "\u{fa27}"
        case .screenshotRegular: return "\u{fa28}"
        case .searchAiBold: return "\u{fa29}"
        case .searchAiLight: return "\u{fa2a}"
        case .searchAiRegular: return "\u{fa2b}"
        case .searchBold: return "\u{fa2c}"
        case .searchFilled: return "\u{fa2d}"
        case .searchLight: return "\u{fa2e}"
        case .searchRegular: return "\u{fa2f}"
        case .secondaryArrowBold: return "\u{fa30}"
        case .secondaryArrowLight: return "\u{fa31}"
        case .secondaryArrowRegular: return "\u{fa32}"
        case .secureCallLockBold: return "\u{fa33}"
        case .secureCallLockFilled: return "\u{fa34}"
        case .secureCallLockLight: return "\u{fa35}"
        case .secureCallLockRegular: return "\u{fa36}"
        case .secureCallShieldBold: return "\u{fa37}"
        case .secureCallShieldFilled: return "\u{fa38}"
        case .secureCallShieldLight: return "\u{fa39}"
        case .secureCallShieldRegular: return "\u{fa3a}"
        case .secureCircleBold: return "\u{fa3b}"
        case .secureCircleFilled: return "\u{fa3c}"
        case .secureCircleLight: return "\u{fa3d}"
        case .secureCircleRegular: return "\u{fa3e}"
        case .secureLockBold: return "\u{fa3f}"
        case .secureLockFilled: return "\u{fa40}"
        case .secureLockLight: return "\u{fa41}"
        case .secureLockRegular: return "\u{fa42}"
        case .segmentExcludeFilled: return "\u{fa43}"
        case .segmentFilterFilled: return "\u{fa44}"
        case .segmentIncludeFilled: return "\u{fa45}"
        case .selectAllBold: return "\u{fa46}"
        case .selectAllFilled: return "\u{fa47}"
        case .selectAllLight: return "\u{fa48}"
        case .selectAllRegular: return "\u{fa49}"
        case .selectionBold: return "\u{fa4a}"
        case .selectionFilled: return "\u{fa4b}"
        case .selectionLight: return "\u{fa4c}"
        case .selectionRegular: return "\u{fa4d}"
        case .sendBold: return "\u{fa4e}"
        case .sendDigitsBold: return "\u{fa4f}"
        case .sendDigitsFilled: return "\u{fa50}"
        case .sendDigitsLight: return "\u{fa51}"
        case .sendDigitsRegular: return "\u{fa52}"
        case .sendFilled: return "\u{fa53}"
        case .sendLight: return "\u{fa54}"
        case .sendRegular: return "\u{fa55}"
        case .sendVoiceBold: return "\u{fa56}"
        case .sendVoiceFilled: return "\u{fa57}"
        case .sendVoiceLight: return "\u{fa58}"
        case .sendVoiceRegular: return "\u{fa59}"
        case .serverBold: return "\u{fa5a}"
        case .serverErrorBold: return "\u{fa5b}"
        case .serverErrorLight: return "\u{fa5c}"
        case .serverErrorRegular: return "\u{fa5d}"
        case .serverLight: return "\u{fa5e}"
        case .serverRegular: return "\u{fa5f}"
        case .servicesBold: return "\u{fa60}"
        case .servicesLight: return "\u{fa61}"
        case .servicesRegular: return "\u{fa62}"
        case .setVariableBold: return "\u{fa63}"
        case .setVariableLight: return "\u{fa64}"
        case .setVariableRegular: return "\u{fa65}"
        case .settingsBold: return "\u{fa66}"
        case .settingsFilled: return "\u{fa67}"
        case .settingsLight: return "\u{fa68}"
        case .settingsRegular: return "\u{fa69}"
        case .setupAssistantBold: return "\u{fa6a}"
        case .setupAssistantLight: return "\u{fa6b}"
        case .setupAssistantRegular: return "\u{fa6c}"
        case .sftpBold: return "\u{fa6d}"
        case .sftpLight: return "\u{fa6e}"
        case .sftpRegular: return "\u{fa6f}"
        case .shapeCircleBold: return "\u{fa70}"
        case .shapeCircleFilled: return "\u{fa71}"
        case .shapeCircleLight: return "\u{fa72}"
        case .shapeCircleMdFilled: return "\u{fa73}"
        case .shapeCircleRegular: return "\u{fa74}"
        case .shapeCircleSmFilled: return "\u{fa75}"
        case .shapeDiagonalLineBold: return "\u{fa76}"
        case .shapeDiagonalLineLight: return "\u{fa77}"
        case .shapeDiagonalLineRegular: return "\u{fa78}"
        case .shapeDiamondBold: return "\u{fa79}"
        case .shapeDiamondFilled: return "\u{fa7a}"
        case .shapeDiamondLight: return "\u{fa7b}"
        case .shapeDiamondRegular: return "\u{fa7c}"
        case .shapeOvalBold: return "\u{fa7d}"
        case .shapeOvalLight: return "\u{fa7e}"
        case .shapeOvalRegular: return "\u{fa7f}"
        case .shapeSquareBold: return "\u{fa80}"
        case .shapeSquareFilled: return "\u{fa81}"
        case .shapeSquareLight: return "\u{fa82}"
        case .shapeSquareRegular: return "\u{fa83}"
        case .shapeTriangleBold: return "\u{fa84}"
        case .shapeTriangleFilled: return "\u{fa85}"
        case .shapeTriangleLight: return "\u{fa86}"
        case .shapeTriangleRegular: return "\u{fa87}"
        case .shapesBold: return "\u{fa88}"
        case .shapesFilled: return "\u{fa89}"
        case .shapesLight: return "\u{fa8a}"
        case .shapesRegular: return "\u{fa8b}"
        case .shareCNativeAdrBold: return "\u{fa8c}"
        case .shareCNativeAdrFilled: return "\u{fa8d}"
        case .shareCNativeAdrLight: return "\u{fa8e}"
        case .shareCNativeAdrRegular: return "\u{fa8f}"
        case .shareCNativeIphBold: return "\u{fa90}"
        case .shareCNativeIphLight: return "\u{fa91}"
        case .shareCNativeIphRegular: return "\u{fa92}"
        case .shareContentOnDeviceBold: return "\u{fa93}"
        case .shareContentOnDeviceLight: return "\u{fa94}"
        case .shareContentOnDeviceRegular: return "\u{fa95}"
        case .shareScreenAddBold: return "\u{fa96}"
        case .shareScreenAddLight: return "\u{fa97}"
        case .shareScreenAddRegular: return "\u{fa98}"
        case .shareScreenBadgeFilled: return "\u{fa99}"
        case .shareScreenBold: return "\u{fa9a}"
        case .shareScreenFilled: return "\u{fa9b}"
        case .shareScreenLight: return "\u{fa9c}"
        case .shareScreenRegular: return "\u{fa9d}"
        case .shareSpaceBold: return "\u{fa9e}"
        case .shareSpaceLight: return "\u{fa9f}"
        case .shareSpaceRegular: return "\u{faa0}"
        case .shieldBold: return "\u{faa1}"
        case .shieldLight: return "\u{faa2}"
        case .shieldRegular: return "\u{faa3}"
        case .shoppingCartBold: return "\u{faa4}"
        case .shoppingCartFilled: return "\u{faa5}"
        case .shoppingCartLight: return "\u{faa6}"
        case .shoppingCartRegular: return "\u{faa7}"
        case .shortTextBoxBold: return "\u{faa8}"
        case .shortTextBoxLight: return "\u{faa9}"
        case .shortTextBoxRegular: return "\u{faaa}"
        case .showBold: return "\u{faab}"
        case .showFilled: return "\u{faac}"
        case .showLight: return "\u{faad}"
        case .showRegular: return "\u{faae}"
        case .sidePanelBold: return "\u{faaf}"
        case .sidePanelFilled: return "\u{fab0}"
        case .sidePanelLight: return "\u{fab1}"
        case .sidePanelRegular: return "\u{fab2}"
        case .signInBold: return "\u{fab3}"
        case .signInFilled: return "\u{fab4}"
        case .signInForcedBold: return "\u{fab5}"
        case .signInForcedLight: return "\u{fab6}"
        case .signInForcedRegular: return "\u{fab7}"
        case .signInLight: return "\u{fab8}"
        case .signInRegular: return "\u{fab9}"
        case .signLangIntBold: return "\u{faba}"
        case .signLangIntLight: return "\u{fabb}"
        case .signLangIntRegular: return "\u{fabc}"
        case .signOutBold: return "\u{fabd}"
        case .signOutLight: return "\u{fabe}"
        case .signOutRegular: return "\u{fabf}"
        case .signalFourBold: return "\u{fac0}"
        case .signalFourLight: return "\u{fac1}"
        case .signalFourRegular: return "\u{fac2}"
        case .signalOneBold: return "\u{fac3}"
        case .signalOneLight: return "\u{fac4}"
        case .signalOneRegular: return "\u{fac5}"
        case .signalThreeBold: return "\u{fac6}"
        case .signalThreeLight: return "\u{fac7}"
        case .signalThreeRegular: return "\u{fac8}"
        case .signalTwoBold: return "\u{fac9}"
        case .signalTwoLight: return "\u{faca}"
        case .signalTwoRegular: return "\u{facb}"
        case .signalZeroBold: return "\u{facc}"
        case .signalZeroLight: return "\u{facd}"
        case .signalZeroRegular: return "\u{face}"
        case .simplePromotionBold: return "\u{facf}"
        case .simplePromotionLight: return "\u{fad0}"
        case .simplePromotionRegular: return "\u{fad1}"
        case .singleNumberReachBold: return "\u{fad2}"
        case .singleNumberReachLight: return "\u{fad3}"
        case .singleNumberReachRegular: return "\u{fad4}"
        case .sipRegistrationInProgressBold: return "\u{fad5}"
        case .sipRegistrationInProgressFilled: return "\u{fad6}"
        case .sipRegistrationInProgressLight: return "\u{fad7}"
        case .sipRegistrationInProgressRegular: return "\u{fad8}"
        case .skipBold: return "\u{fad9}"
        case .skipBwBold: return "\u{fada}"
        case .skipBwFilled: return "\u{fadb}"
        case .skipBwLight: return "\u{fadc}"
        case .skipBwRegular: return "\u{fadd}"
        case .skipFwBold: return "\u{fade}"
        case .skipFwFilled: return "\u{fadf}"
        case .skipFwLight: return "\u{fae0}"
        case .skipFwRegular: return "\u{fae1}"
        case .skipLight: return "\u{fae2}"
        case .skipRegular: return "\u{fae3}"
        case .smartAudioBold: return "\u{fae4}"
        case .smartAudioLight: return "\u{fae5}"
        case .smartAudioRegular: return "\u{fae6}"
        case .smsFilled: return "\u{fae7}"
        case .smsInboundBold: return "\u{fae8}"
        case .smsInboundLight: return "\u{fae9}"
        case .smsInboundRegular: return "\u{faea}"
        case .smsMessageBold: return "\u{faeb}"
        case .smsMessageFilled: return "\u{faec}"
        case .smsMessageLight: return "\u{faed}"
        case .smsMessageRegular: return "\u{faee}"
        case .smsOutgoingFilled: return "\u{faef}"
        case .smsUnreadBold: return "\u{faf0}"
        case .smsUnreadLight: return "\u{faf1}"
        case .smsUnreadRegular: return "\u{faf2}"
        case .sortAscendingBold: return "\u{faf3}"
        case .sortAscendingLight: return "\u{faf4}"
        case .sortAscendingRegular: return "\u{faf5}"
        case .sortDescendingBold: return "\u{faf6}"
        case .sortDescendingLight: return "\u{faf7}"
        case .sortDescendingRegular: return "\u{faf8}"
        case .soundDefaultBold: return "\u{faf9}"
        case .soundDefaultLight: return "\u{fafa}"
        case .soundDefaultRegular: return "\u{fafb}"
        case .sparkleBold: return "\u{fafc}"
        case .sparkleFilled: return "\u{fafd}"
        case .sparkleLight: return "\u{fafe}"
        case .sparkleRegular: return "\u{faff}"
        case .speakerBold: return "\u{fb00}"
        case .speakerDisconnectedBold: return "\u{fb01}"
        case .speakerDisconnectedFilled: return "\u{fb02}"
        case .speakerDisconnectedLight: return "\u{fb03}"
        case .speakerDisconnectedRegular: return "\u{fb04}"
        case .speakerFilled: return "\u{fb05}"
        case .speakerLight: return "\u{fb06}"
        case .speakerMutedBold: return "\u{fb07}"
        case .speakerMutedFilled: return "\u{fb08}"
        case .speakerMutedLight: return "\u{fb09}"
        case .speakerMutedRegular: return "\u{fb0a}"
        case .speakerOffBold: return "\u{fb0b}"
        case .speakerOffFilled: return "\u{fb0c}"
        case .speakerOffLight: return "\u{fb0d}"
        case .speakerOffRegular: return "\u{fb0e}"
        case .speakerOnBold: return "\u{fb0f}"
        case .speakerOnLight: return "\u{fb10}"
        case .speakerOnRegular: return "\u{fb11}"
        case .speakerRegular: return "\u{fb12}"
        case .speakerTurnDownBold: return "\u{fb13}"
        case .speakerTurnDownFilled: return "\u{fb14}"
        case .speakerTurnDownLight: return "\u{fb15}"
        case .speakerTurnDownRegular: return "\u{fb16}"
        case .speakerTurnUpBold: return "\u{fb17}"
        case .speakerTurnUpFilled: return "\u{fb18}"
        case .speakerTurnUpLight: return "\u{fb19}"
        case .speakerTurnUpRegular: return "\u{fb1a}"
        case .speedDialBold: return "\u{fb1b}"
        case .speedDialFilled: return "\u{fb1c}"
        case .speedDialLight: return "\u{fb1d}"
        case .speedDialRegular: return "\u{fb1e}"
        case .spellCheckerBold: return "\u{fb1f}"
        case .spellCheckerLight: return "\u{fb20}"
        case .spellCheckerRegular: return "\u{fb21}"
        case .splitViewBold: return "\u{fb22}"
        case .splitViewLight: return "\u{fb23}"
        case .splitViewRegular: return "\u{fb24}"
        case .stackedAreaChartBold: return "\u{fb25}"
        case .stackedAreaChartFilled: return "\u{fb26}"
        case .stackedAreaChartFullBold: return "\u{fb27}"
        case .stackedAreaChartFullFilled: return "\u{fb28}"
        case .stackedAreaChartFullLight: return "\u{fb29}"
        case .stackedAreaChartFullRegular: return "\u{fb2a}"
        case .stackedAreaChartLight: return "\u{fb2b}"
        case .stackedAreaChartRegular: return "\u{fb2c}"
        case .stackedBarChartBold: return "\u{fb2d}"
        case .stackedBarChartFilled: return "\u{fb2e}"
        case .stackedBarChartFullBold: return "\u{fb2f}"
        case .stackedBarChartFullFilled: return "\u{fb30}"
        case .stackedBarChartFullLight: return "\u{fb31}"
        case .stackedBarChartFullRegular: return "\u{fb32}"
        case .stackedBarChartLight: return "\u{fb33}"
        case .stackedBarChartRegular: return "\u{fb34}"
        case .startChatBold: return "\u{fb35}"
        case .startChatLight: return "\u{fb36}"
        case .startChatRegular: return "\u{fb37}"
        case .stethoscopeBold: return "\u{fb38}"
        case .stethoscopeLight: return "\u{fb39}"
        case .stethoscopeRegular: return "\u{fb3a}"
        case .stickersBold: return "\u{fb3b}"
        case .stickersLight: return "\u{fb3c}"
        case .stickersRegular: return "\u{fb3d}"
        case .stickiesBold: return "\u{fb3e}"
        case .stickiesLight: return "\u{fb3f}"
        case .stickiesRegular: return "\u{fb40}"
        case .stopBold: return "\u{fb41}"
        case .stopCircleBold: return "\u{fb42}"
        case .stopCircleFilled: return "\u{fb43}"
        case .stopCircleLight: return "\u{fb44}"
        case .stopCircleRegular: return "\u{fb45}"
        case .stopContentShareBold: return "\u{fb46}"
        case .stopContentShareLight: return "\u{fb47}"
        case .stopContentShareRegular: return "\u{fb48}"
        case .stopFilled: return "\u{fb49}"
        case .stopLight: return "\u{fb4a}"
        case .stopRegular: return "\u{fb4b}"
        case .storedInfoBold: return "\u{fb4c}"
        case .storedInfoFilled: return "\u{fb4d}"
        case .storedInfoLight: return "\u{fb4e}"
        case .storedInfoRegular: return "\u{fb4f}"
        case .streamingBold: return "\u{fb50}"
        case .streamingLight: return "\u{fb51}"
        case .streamingRegular: return "\u{fb52}"
        case .strikethroughBold: return "\u{fb53}"
        case .strikethroughFilled: return "\u{fb54}"
        case .strikethroughLight: return "\u{fb55}"
        case .strikethroughRegular: return "\u{fb56}"
        case .studioModeBold: return "\u{fb57}"
        case .studioModeLight: return "\u{fb58}"
        case .studioModeRegular: return "\u{fb59}"
        case .subscriptBold: return "\u{fb5a}"
        case .subscriptLight: return "\u{fb5b}"
        case .subscriptRegular: return "\u{fb5c}"
        case .summarizeAiBold: return "\u{fb5d}"
        case .summarizeAiLight: return "\u{fb5e}"
        case .summarizeAiRegular: return "\u{fb5f}"
        case .superscriptBold: return "\u{fb60}"
        case .superscriptLight: return "\u{fb61}"
        case .superscriptRegular: return "\u{fb62}"
        case .surveyBold: return "\u{fb63}"
        case .surveyFilled: return "\u{fb64}"
        case .surveyLight: return "\u{fb65}"
        case .surveyRegular: return "\u{fb66}"
        case .sxEightyCodecBold: return "\u{fb67}"
        case .sxEightyCodecLight: return "\u{fb68}"
        case .sxEightyCodecRegular: return "\u{fb69}"
        case .sxTenBold: return "\u{fb6a}"
        case .sxTenLight: return "\u{fb6b}"
        case .sxTenRegular: return "\u{fb6c}"
        case .sxTwentyBold: return "\u{fb6d}"
        case .sxTwentyLight: return "\u{fb6e}"
        case .sxTwentyRegular: return "\u{fb6f}"
        case .tableBold: return "\u{fb70}"
        case .tableExtenderBold: return "\u{fb71}"
        case .tableExtenderFilled: return "\u{fb72}"
        case .tableExtenderLight: return "\u{fb73}"
        case .tableExtenderRegular: return "\u{fb74}"
        case .tableLight: return "\u{fb75}"
        case .tableRegular: return "\u{fb76}"
        case .tabletBold: return "\u{fb77}"
        case .tabletLight: return "\u{fb78}"
        case .tabletRegular: return "\u{fb79}"
        case .tabsBold: return "\u{fb7a}"
        case .tabsLight: return "\u{fb7b}"
        case .tabsRegular: return "\u{fb7c}"
        case .tagBold: return "\u{fb7d}"
        case .tagLight: return "\u{fb7e}"
        case .tagRegular: return "\u{fb7f}"
        case .tapBold: return "\u{fb80}"
        case .tapFilled: return "\u{fb81}"
        case .tapLight: return "\u{fb82}"
        case .tapRegular: return "\u{fb83}"
        case .telepresenceAlertBold: return "\u{fb84}"
        case .telepresenceAlertLight: return "\u{fb85}"
        case .telepresenceAlertMutedBold: return "\u{fb86}"
        case .telepresenceAlertMutedLight: return "\u{fb87}"
        case .telepresenceAlertMutedRegular: return "\u{fb88}"
        case .telepresenceAlertRegular: return "\u{fb89}"
        case .telepresenceBold: return "\u{fb8a}"
        case .telepresenceIxFiveThousandBold: return "\u{fb8b}"
        case .telepresenceIxFiveThousandLight: return "\u{fb8c}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb8d}"
        case .telepresenceLight: return "\u{fb8e}"
        case .telepresenceMutedBold: return "\u{fb8f}"
        case .telepresenceMutedLight: return "\u{fb90}"
        case .telepresenceMutedRegular: return "\u{fb91}"
        case .telepresencePrivateBold: return "\u{fb92}"
        case .telepresencePrivateLight: return "\u{fb93}"
        case .telepresencePrivateRegular: return "\u{fb94}"
        case .telepresenceRegular: return "\u{fb95}"
        case .temperatureBold: return "\u{fb96}"
        case .temperatureLight: return "\u{fb97}"
        case .temperatureRegular: return "\u{fb98}"
        case .testTubeBold: return "\u{fb99}"
        case .testTubeFilled: return "\u{fb9a}"
        case .testTubeLight: return "\u{fb9b}"
        case .testTubeRegular: return "\u{fb9c}"
        case .textAlignCenterBold: return "\u{fb9d}"
        case .textAlignCenterFilled: return "\u{fb9e}"
        case .textAlignCenterLight: return "\u{fb9f}"
        case .textAlignCenterRegular: return "\u{fba0}"
        case .textAlignLeftBold: return "\u{fba1}"
        case .textAlignLeftFilled: return "\u{fba2}"
        case .textAlignLeftLight: return "\u{fba3}"
        case .textAlignLeftRegular: return "\u{fba4}"
        case .textAlignRightBold: return "\u{fba5}"
        case .textAlignRightFilled: return "\u{fba6}"
        case .textAlignRightLight: return "\u{fba7}"
        case .textAlignRightRegular: return "\u{fba8}"
        case .textBold: return "\u{fba9}"
        case .textBoxCursorLight: return "\u{fbaa}"
        case .textCodeBlockBold: return "\u{fbab}"
        case .textCodeBlockLight: return "\u{fbac}"
        case .textCodeBlockRegular: return "\u{fbad}"
        case .textHighlightBold: return "\u{fbae}"
        case .textHighlightFilled: return "\u{fbaf}"
        case .textHighlightLight: return "\u{fbb0}"
        case .textHighlightRegular: return "\u{fbb1}"
        case .textLight: return "\u{fbb2}"
        case .textRegular: return "\u{fbb3}"
        case .threeColumnBold: return "\u{fbb4}"
        case .threeColumnLight: return "\u{fbb5}"
        case .threeColumnRegular: return "\u{fbb6}"
        case .threeDObjectBold: return "\u{fbb7}"
        case .threeDObjectLight: return "\u{fbb8}"
        case .threeDObjectRegular: return "\u{fbb9}"
        case .timeExclusionBold: return "\u{fbba}"
        case .timeExclusionLight: return "\u{fbbb}"
        case .timeExclusionRegular: return "\u{fbbc}"
        case .timezoneBold: return "\u{fbbd}"
        case .timezoneFilled: return "\u{fbbe}"
        case .timezoneLight: return "\u{fbbf}"
        case .timezoneRegular: return "\u{fbc0}"
        case .tooFastBold: return "\u{fbc1}"
        case .tooFastLight: return "\u{fbc2}"
        case .tooFastRegular: return "\u{fbc3}"
        case .tooSlowBold: return "\u{fbc4}"
        case .tooSlowLight: return "\u{fbc5}"
        case .tooSlowRegular: return "\u{fbc6}"
        case .toolsBold: return "\u{fbc7}"
        case .toolsFilled: return "\u{fbc8}"
        case .toolsLight: return "\u{fbc9}"
        case .toolsRegular: return "\u{fbca}"
        case .touchTenBold: return "\u{fbcb}"
        case .touchTenLight: return "\u{fbcc}"
        case .touchTenRegular: return "\u{fbcd}"
        case .transcriptBold: return "\u{fbce}"
        case .transcriptFilled: return "\u{fbcf}"
        case .transcriptLight: return "\u{fbd0}"
        case .transcriptRegular: return "\u{fbd1}"
        case .translateBold: return "\u{fbd2}"
        case .translateLight: return "\u{fbd3}"
        case .translateRegular: return "\u{fbd4}"
        case .translateUndoBold: return "\u{fbd5}"
        case .translateUndoLight: return "\u{fbd6}"
        case .translateUndoRegular: return "\u{fbd7}"
        case .trendingBold: return "\u{fbd8}"
        case .trendingDownBold: return "\u{fbd9}"
        case .trendingDownFilled: return "\u{fbda}"
        case .trendingDownLight: return "\u{fbdb}"
        case .trendingDownRegular: return "\u{fbdc}"
        case .trendingFilled: return "\u{fbdd}"
        case .trendingLight: return "\u{fbde}"
        case .trendingRegular: return "\u{fbdf}"
        case .trimBold: return "\u{fbe0}"
        case .trimLight: return "\u{fbe1}"
        case .trimRegular: return "\u{fbe2}"
        case .twoColumnBold: return "\u{fbe3}"
        case .twoColumnLight: return "\u{fbe4}"
        case .twoColumnRegular: return "\u{fbe5}"
        case .twoWayVoiceStreamBold: return "\u{fbe6}"
        case .twoWayVoiceStreamFilled: return "\u{fbe7}"
        case .twoWayVoiceStreamLight: return "\u{fbe8}"
        case .twoWayVoiceStreamRegular: return "\u{fbe9}"
        case .ucmCloudBold: return "\u{fbea}"
        case .ucmCloudLight: return "\u{fbeb}"
        case .ucmCloudRegular: return "\u{fbec}"
        case .unblockBold: return "\u{fbed}"
        case .unblockFilled: return "\u{fbee}"
        case .unblockLight: return "\u{fbef}"
        case .unblockRegular: return "\u{fbf0}"
        case .underlineBold: return "\u{fbf1}"
        case .underlineFilled: return "\u{fbf2}"
        case .underlineLight: return "\u{fbf3}"
        case .underlineRegular: return "\u{fbf4}"
        case .undoBold: return "\u{fbf5}"
        case .undoLight: return "\u{fbf6}"
        case .undoRegular: return "\u{fbf7}"
        case .unlinkBold: return "\u{fbf8}"
        case .unlinkLight: return "\u{fbf9}"
        case .unlinkRegular: return "\u{fbfa}"
        case .unreadBold: return "\u{fbfb}"
        case .unreadFilled: return "\u{fbfc}"
        case .unreadLight: return "\u{fbfd}"
        case .unreadRegular: return "\u{fbfe}"
        case .unsecureUnlockedBold: return "\u{fbff}"
        case .unsecureUnlockedFilled: return "\u{fc00}"
        case .unsecureUnlockedLight: return "\u{fc01}"
        case .unsecureUnlockedRegular: return "\u{fc02}"
        case .unsortedBold: return "\u{fc03}"
        case .unsortedLight: return "\u{fc04}"
        case .unsortedRegular: return "\u{fc05}"
        case .updateFileShareBold: return "\u{fc06}"
        case .updateFileShareLight: return "\u{fc07}"
        case .updateFileShareRegular: return "\u{fc08}"
        case .uploadBold: return "\u{fc09}"
        case .uploadImageBold: return "\u{fc0a}"
        case .uploadImageLight: return "\u{fc0b}"
        case .uploadImageRegular: return "\u{fc0c}"
        case .uploadLight: return "\u{fc0d}"
        case .uploadRegular: return "\u{fc0e}"
        case .urgentVoicemailBold: return "\u{fc0f}"
        case .urgentVoicemailFilled: return "\u{fc10}"
        case .usbBold: return "\u{fc11}"
        case .usbHeadsetBold: return "\u{fc12}"
        case .usbHeadsetLight: return "\u{fc13}"
        case .usbHeadsetMutedBold: return "\u{fc14}"
        case .usbHeadsetMutedLight: return "\u{fc15}"
        case .usbHeadsetMutedRegular: return "\u{fc16}"
        case .usbHeadsetRegular: return "\u{fc17}"
        case .usbLight: return "\u{fc18}"
        case .usbRegular: return "\u{fc19}"
        case .userBold: return "\u{fc1a}"
        case .userDeactivateBold: return "\u{fc1b}"
        case .userDeactivateLight: return "\u{fc1c}"
        case .userDeactivateRegular: return "\u{fc1d}"
        case .userLight: return "\u{fc1e}"
        case .userRegular: return "\u{fc1f}"
        case .videoBlurBold: return "\u{fc20}"
        case .videoBlurFilled: return "\u{fc21}"
        case .videoBlurLight: return "\u{fc22}"
        case .videoBlurRegular: return "\u{fc23}"
        case .videoBold: return "\u{fc24}"
        case .videoEffectBold: return "\u{fc25}"
        case .videoEffectFilled: return "\u{fc26}"
        case .videoEffectLight: return "\u{fc27}"
        case .videoEffectRegular: return "\u{fc28}"
        case .videoFilled: return "\u{fc29}"
        case .videoLayoutBold: return "\u{fc2a}"
        case .videoLayoutCustomBold: return "\u{fc2b}"
        case .videoLayoutCustomFilled: return "\u{fc2c}"
        case .videoLayoutCustomLight: return "\u{fc2d}"
        case .videoLayoutCustomRegular: return "\u{fc2e}"
        case .videoLayoutEqualBold: return "\u{fc2f}"
        case .videoLayoutEqualDualBold: return "\u{fc30}"
        case .videoLayoutEqualDualLight: return "\u{fc31}"
        case .videoLayoutEqualDualRegular: return "\u{fc32}"
        case .videoLayoutEqualFilled: return "\u{fc33}"
        case .videoLayoutEqualLight: return "\u{fc34}"
        case .videoLayoutEqualRegular: return "\u{fc35}"
        case .videoLayoutFilled: return "\u{fc36}"
        case .videoLayoutLight: return "\u{fc37}"
        case .videoLayoutOverlayBold: return "\u{fc38}"
        case .videoLayoutOverlayFilled: return "\u{fc39}"
        case .videoLayoutOverlayLight: return "\u{fc3a}"
        case .videoLayoutOverlayRegular: return "\u{fc3b}"
        case .videoLayoutPresentationBold: return "\u{fc3c}"
        case .videoLayoutPresentationFilled: return "\u{fc3d}"
        case .videoLayoutPresentationLight: return "\u{fc3e}"
        case .videoLayoutPresentationRegular: return "\u{fc3f}"
        case .videoLayoutPresenterDominantBold: return "\u{fc40}"
        case .videoLayoutPresenterDominantLight: return "\u{fc41}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc42}"
        case .videoLayoutProminentBold: return "\u{fc43}"
        case .videoLayoutProminentFilled: return "\u{fc44}"
        case .videoLayoutProminentLight: return "\u{fc45}"
        case .videoLayoutProminentRegular: return "\u{fc46}"
        case .videoLayoutRegular: return "\u{fc47}"
        case .videoLayoutShareDominantBold: return "\u{fc48}"
        case .videoLayoutShareDominantLight: return "\u{fc49}"
        case .videoLayoutShareDominantRegular: return "\u{fc4a}"
        case .videoLayoutSingleBold: return "\u{fc4b}"
        case .videoLayoutSingleFilled: return "\u{fc4c}"
        case .videoLayoutSingleLight: return "\u{fc4d}"
        case .videoLayoutSingleRegular: return "\u{fc4e}"
        case .videoLayoutSpeakerBold: return "\u{fc4f}"
        case .videoLayoutSpeakerFilled: return "\u{fc50}"
        case .videoLayoutSpeakerLight: return "\u{fc51}"
        case .videoLayoutSpeakerRegular: return "\u{fc52}"
        case .videoLayoutStackBold: return "\u{fc53}"
        case .videoLayoutStackFilled: return "\u{fc54}"
        case .videoLayoutStackLight: return "\u{fc55}"
        case .videoLayoutStackRegular: return "\u{fc56}"
        case .videoLayoutVideoDominantBold: return "\u{fc57}"
        case .videoLayoutVideoDominantFilled: return "\u{fc58}"
        case .videoLayoutVideoDominantLight: return "\u{fc59}"
        case .videoLayoutVideoDominantRegular: return "\u{fc5a}"
        case .videoLight: return "\u{fc5b}"
        case .videoPlusBold: return "\u{fc5c}"
        case .videoPlusFilled: return "\u{fc5d}"
        case .videoPlusLight: return "\u{fc5e}"
        case .videoPlusRegular: return "\u{fc5f}"
        case .videoRegular: return "\u{fc60}"
        case .videoSpeakerTrackBold: return "\u{fc61}"
        case .videoSpeakerTrackFilled: return "\u{fc62}"
        case .videoSpeakerTrackLight: return "\u{fc63}"
        case .videoSpeakerTrackRegular: return "\u{fc64}"
        case .viewAllBold: return "\u{fc65}"
        case .viewAllLight: return "\u{fc66}"
        case .viewAllRegular: return "\u{fc67}"
        case .viewListBold: return "\u{fc68}"
        case .viewListFilled: return "\u{fc69}"
        case .viewListLight: return "\u{fc6a}"
        case .viewListRegular: return "\u{fc6b}"
        case .viewStackedBold: return "\u{fc6c}"
        case .viewStackedFilled: return "\u{fc6d}"
        case .viewStackedLight: return "\u{fc6e}"
        case .viewStackedRegular: return "\u{fc6f}"
        case .viewThumbnailBold: return "\u{fc70}"
        case .viewThumbnailFilled: return "\u{fc71}"
        case .viewThumbnailLight: return "\u{fc72}"
        case .viewThumbnailRegular: return "\u{fc73}"
        case .visionproBold: return "\u{fc74}"
        case .visionproFilled: return "\u{fc75}"
        case .visionproLight: return "\u{fc76}"
        case .visionproMoveCallInBold: return "\u{fc77}"
        case .visionproMoveCallInFilled: return "\u{fc78}"
        case .visionproMoveCallInLight: return "\u{fc79}"
        case .visionproMoveCallInOutBold: return "\u{fc7a}"
        case .visionproMoveCallInOutFilled: return "\u{fc7b}"
        case .visionproMoveCallInOutLight: return "\u{fc7c}"
        case .visionproMoveCallInOutRegular: return "\u{fc7d}"
        case .visionproMoveCallInRegular: return "\u{fc7e}"
        case .visionproMoveCallOutBold: return "\u{fc7f}"
        case .visionproMoveCallOutFilled: return "\u{fc80}"
        case .visionproMoveCallOutLight: return "\u{fc81}"
        case .visionproMoveCallOutRegular: return "\u{fc82}"
        case .visionproRegular: return "\u{fc83}"
        case .voicemailBold: return "\u{fc84}"
        case .voicemailFilled: return "\u{fc85}"
        case .voicemailLight: return "\u{fc86}"
        case .voicemailRegular: return "\u{fc87}"
        case .vpnBold: return "\u{fc88}"
        case .vpnFilled: return "\u{fc89}"
        case .vpnLight: return "\u{fc8a}"
        case .vpnRegular: return "\u{fc8b}"
        case .vscBold: return "\u{fc8c}"
        case .vscLight: return "\u{fc8d}"
        case .vscRegular: return "\u{fc8e}"
        case .waffleMenuBold: return "\u{fc8f}"
        case .waffleMenuLight: return "\u{fc90}"
        case .waffleMenuRegular: return "\u{fc91}"
        case .waitingRoomBold: return "\u{fc92}"
        case .waitingRoomLight: return "\u{fc93}"
        case .waitingRoomRegular: return "\u{fc94}"
        case .wallpaperBold: return "\u{fc95}"
        case .wallpaperLight: return "\u{fc96}"
        case .wallpaperRegular: return "\u{fc97}"
        case .warningBadgeFilled: return "\u{fc98}"
        case .warningBold: return "\u{fc99}"
        case .warningFilled: return "\u{fc9a}"
        case .warningLight: return "\u{fc9b}"
        case .warningRegular: return "\u{fc9c}"
        case .webexBoardBold: return "\u{fc9d}"
        case .webexBoardLight: return "\u{fc9e}"
        case .webexBoardRegular: return "\u{fc9f}"
        case .webexCodecPlusBold: return "\u{fca0}"
        case .webexCodecPlusLight: return "\u{fca1}"
        case .webexCodecPlusRegular: return "\u{fca2}"
        case .webexDeskCameraBold: return "\u{fca3}"
        case .webexDeskCameraLight: return "\u{fca4}"
        case .webexDeskCameraRegular: return "\u{fca5}"
        case .webexHelixBold: return "\u{fca6}"
        case .webexHelixLight: return "\u{fca7}"
        case .webexHelixRegular: return "\u{fca8}"
        case .webexMeetingsBold: return "\u{fca9}"
        case .webexMeetingsFilled: return "\u{fcaa}"
        case .webexMeetingsLight: return "\u{fcab}"
        case .webexMeetingsRegular: return "\u{fcac}"
        case .webexQuadCameraBold: return "\u{fcad}"
        case .webexQuadCameraLight: return "\u{fcae}"
        case .webexQuadCameraRegular: return "\u{fcaf}"
        case .webexRoomKitBold: return "\u{fcb0}"
        case .webexRoomKitLight: return "\u{fcb1}"
        case .webexRoomKitPlusBold: return "\u{fcb2}"
        case .webexRoomKitPlusLight: return "\u{fcb3}"
        case .webexRoomKitPlusRegular: return "\u{fcb4}"
        case .webexRoomKitRegular: return "\u{fcb5}"
        case .webexShareBold: return "\u{fcb6}"
        case .webexShareLight: return "\u{fcb7}"
        case .webexShareRegular: return "\u{fcb8}"
        case .webexTeamsBold: return "\u{fcb9}"
        case .webexTeamsFilled: return "\u{fcba}"
        case .webexTeamsLight: return "\u{fcbb}"
        case .webexTeamsNewBold: return "\u{fcbc}"
        case .webexTeamsNewFilled: return "\u{fcbd}"
        case .webexTeamsNewLight: return "\u{fcbe}"
        case .webexTeamsNewRegular: return "\u{fcbf}"
        case .webexTeamsRegular: return "\u{fcc0}"
        case .webexTeamsRemoveBold: return "\u{fcc1}"
        case .webexTeamsRemoveLight: return "\u{fcc2}"
        case .webexTeamsRemoveRegular: return "\u{fcc3}"
        case .webhookBold: return "\u{fcc4}"
        case .webhookLight: return "\u{fcc5}"
        case .webhookRegular: return "\u{fcc6}"
        case .webinarBold: return "\u{fcc7}"
        case .webinarFilled: return "\u{fcc8}"
        case .webinarLight: return "\u{fcc9}"
        case .webinarRegular: return "\u{fcca}"
        case .weeklyRecurringScheduleBold: return "\u{fccb}"
        case .weeklyRecurringScheduleLight: return "\u{fccc}"
        case .weeklyRecurringScheduleRegular: return "\u{fccd}"
        case .whisperAnnouncementBold: return "\u{fcce}"
        case .whisperAnnouncementFilled: return "\u{fccf}"
        case .whisperAnnouncementLight: return "\u{fcd0}"
        case .whisperAnnouncementRegular: return "\u{fcd1}"
        case .whisperCoachBold: return "\u{fcd2}"
        case .whisperCoachFilled: return "\u{fcd3}"
        case .whisperCoachLight: return "\u{fcd4}"
        case .whisperCoachRegular: return "\u{fcd5}"
        case .whiteboardBold: return "\u{fcd6}"
        case .whiteboardContentBold: return "\u{fcd7}"
        case .whiteboardContentFilled: return "\u{fcd8}"
        case .whiteboardContentLight: return "\u{fcd9}"
        case .whiteboardContentRegular: return "\u{fcda}"
        case .whiteboardFilled: return "\u{fcdb}"
        case .whiteboardLight: return "\u{fcdc}"
        case .whiteboardRegular: return "\u{fcdd}"
        case .widgetBold: return "\u{fcde}"
        case .widgetFilled: return "\u{fcdf}"
        case .widgetLight: return "\u{fce0}"
        case .widgetRegular: return "\u{fce1}"
        case .wifiBold: return "\u{fce2}"
        case .wifiErrorBold: return "\u{fce3}"
        case .wifiErrorLight: return "\u{fce4}"
        case .wifiErrorRegular: return "\u{fce5}"
        case .wifiLight: return "\u{fce6}"
        case .wifiRegular: return "\u{fce7}"
        case .wifiSignalGoodBold: return "\u{fce8}"
        case .wifiSignalGoodLight: return "\u{fce9}"
        case .wifiSignalGoodRegular: return "\u{fcea}"
        case .wifiSignalPoorBold: return "\u{fceb}"
        case .wifiSignalPoorLight: return "\u{fcec}"
        case .wifiSignalPoorRegular: return "\u{fced}"
        case .wifiSignalUnstableBold: return "\u{fcee}"
        case .wifiSignalUnstableLight: return "\u{fcef}"
        case .wifiSignalUnstableRegular: return "\u{fcf0}"
        case .windowCornerScrubBold: return "\u{fcf1}"
        case .windowCornerScrubLight: return "\u{fcf2}"
        case .windowCornerScrubRegular: return "\u{fcf3}"
        case .windowRightCornerScrubBold: return "\u{fcf4}"
        case .windowRightCornerScrubLight: return "\u{fcf5}"
        case .windowRightCornerScrubRegular: return "\u{fcf6}"
        case .windowVerticalScrubBold: return "\u{fcf7}"
        case .windowVerticalScrubLight: return "\u{fcf8}"
        case .windowVerticalScrubRegular: return "\u{fcf9}"
        case .workflowDeploymentsBold: return "\u{fcfa}"
        case .workflowDeploymentsFilled: return "\u{fcfb}"
        case .workflowDeploymentsLight: return "\u{fcfc}"
        case .workflowDeploymentsRegular: return "\u{fcfd}"
        case .workphoneBold: return "\u{fcfe}"
        case .workphoneLight: return "\u{fcff}"
        case .workphoneRegular: return "\u{fd00}"
        case .zoomInBold: return "\u{fd01}"
        case .zoomInLight: return "\u{fd02}"
        case .zoomInRegular: return "\u{fd03}"
        case .zoomOutBold: return "\u{fd04}"
        case .zoomOutLight: return "\u{fd05}"
        case .zoomOutRegular: return "\u{fd06}"
