...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .videoLayoutEqualBold: return "\u{fbe1}"
        case .videoLayoutEqualDualBold: return "\u{fbe2}"
        case .videoLayoutEqualDualLight: return "\u{fbe3}"
        case .videoLayoutEqualDualRegular: return "\u{fbe4}"
        case .videoLayoutEqualFilled: return "\u{fbe5}"
        case .videoLayoutEqualLight: return "\u{fbe6}"
        case .videoLayoutEqualRegular: return "\u{fbe7}"
        case .videoLayoutFilled: return "\u{fbe8}"
        case .videoLayoutLight: return "\u{fbe9}"
        case .videoLayoutOverlayBold: return "\u{fbea}"
        case .videoLayoutOverlayFilled: return "\u{fbeb}"
        case .videoLayoutOverlayLight: return "\u{fbec}"
        case .videoLayoutOverlayRegular: return "\u{fbed}"
        case .videoLayoutPresenterDominantBold: return "\u{fbee}"
        case .videoLayoutPresenterDominantLight: return "\u{fbef}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbf0}"
        case .videoLayoutProminentBold: return "\u{fbf1}"
        case .videoLayoutProminentFilled: return "\u{fbf2}"
        case .videoLayoutProminentLight: return "\u{fbf3}"
        case .videoLayoutProminentRegular: return "\u{fbf4}"
        case .videoLayoutRegular: return "\u{fbf5}"
        case .videoLayoutShareDominantBold: return "\u{fbf6}"
        case .videoLayoutShareDominantLight: return "\u{fbf7}"
        case .videoLayoutShareDominantRegular: return "\u{fbf8}"
        case .videoLayoutSingleBold: return "\u{fbf9}"
        case .videoLayoutSingleFilled: return "\u{fbfa}"
        case .videoLayoutSingleLight: return "\u{fbfb}"
        case .videoLayoutSingleRegular: return "\u{fbfc}"
        case .videoLayoutStackBold: return "\u{fbfd}"
        case .videoLayoutStackFilled: return "\u{fbfe}"
        case .videoLayoutStackLight: return "\u{fbff}"
        case .videoLayoutStackRegular: return "\u{fc00}"
        case .videoLayoutVideoDominantBold: return "\u{fc01}"
        case .videoLayoutVideoDominantFilled: return "\u{fc02}"
        case .videoLayoutVideoDominantLight: return "\u{fc03}"
        case .videoLayoutVideoDominantRegular: return "\u{fc04}"
        case .videoLight: return "\u{fc05}"
        case .videoPlusBold: return "\u{fc06}"
        case .videoPlusFilled: return "\u{fc07}"
        case .videoPlusLight: return "\u{fc08}"
        case .videoPlusRegular: return "\u{fc09}"
        case .videoRegular: return "\u{fc0a}"
        case .videoSpeakerTrackBold: return "\u{fc0b}"
        case .videoSpeakerTrackFilled: return "\u{fc0c}"
        case .videoSpeakerTrackLight: return "\u{fc0d}"
        case .videoSpeakerTrackRegular: return "\u{fc0e}"
        case .viewAllBold: return "\u{fc0f}"
        case .viewAllLight: return "\u{fc10}"
        case .viewAllRegular: return "\u{fc11}"
        case .viewListBold: return "\u{fc12}"
        case .viewListFilled: return "\u{fc13}"
        case .viewListLight: return "\u{fc14}"
        case .viewListRegular: return "\u{fc15}"
        case .viewStackedBold: return "\u{fc16}"
        case .viewStackedFilled: return "\u{fc17}"
        case .viewStackedLight: return "\u{fc18}"
        case .viewStackedRegular: return "\u{fc19}"
        case .viewThumbnailBold: return "\u{fc1a}"
        case .viewThumbnailFilled: return "\u{fc1b}"
        case .viewThumbnailLight: return "\u{fc1c}"
        case .viewThumbnailRegular: return "\u{fc1d}"
        case .visionproBold: return "\u{fc1e}"
        case .visionproFilled: return "\u{fc1f}"
        case .visionproLight: return "\u{fc20}"
        case .visionproMoveCallInBold: return "\u{fc21}"
        case .visionproMoveCallInFilled: return "\u{fc22}"
        case .visionproMoveCallInLight: return "\u{fc23}"
        case .visionproMoveCallInOutBold: return "\u{fc24}"
        case .visionproMoveCallInOutFilled: return "\u{fc25}"
        case .visionproMoveCallInOutLight: return "\u{fc26}"
        case .visionproMoveCallInOutRegular: return "\u{fc27}"
        case .visionproMoveCallInRegular: return "\u{fc28}"
        case .visionproMoveCallOutBold: return "\u{fc29}"
        case .visionproMoveCallOutFilled: return "\u{fc2a}"
        case .visionproMoveCallOutLight: return "\u{fc2b}"
        case .visionproMoveCallOutRegular: return "\u{fc2c}"
        case .visionproRegular: return "\u{fc2d}"
        case .voicemailBold: return "\u{fc2e}"
        case .voicemailFilled: return "\u{fc2f}"
        case .voicemailLight: return "\u{fc30}"
        case .voicemailRegular: return "\u{fc31}"
        case .vpnBold: return "\u{fc32}"
        case .vpnFilled: return "\u{fc33}"
        case .vpnLight: return "\u{fc34}"
        case .vpnRegular: return "\u{fc35}"
        case .vscBold: return "\u{fc36}"
        case .vscLight: return "\u{fc37}"
        case .vscRegular: return "\u{fc38}"
        case .waffleMenuBold: return "\u{fc39}"
        case .waffleMenuLight: return "\u{fc3a}"
        case .waffleMenuRegular: return "\u{fc3b}"
        case .waitingRoomBold: return "\u{fc3c}"
        case .waitingRoomLight: return "\u{fc3d}"
        case .waitingRoomRegular: return "\u{fc3e}"
        case .wallpaperBold: return "\u{fc3f}"
        case .wallpaperLight: return "\u{fc40}"
        case .wallpaperRegular: return "\u{fc41}"
        case .warningBadgeFilled: return "\u{fc42}"
        case .warningBold: return "\u{fc43}"
        case .warningFilled: return "\u{fc44}"
        case .warningLight: return "\u{fc45}"
        case .warningRegular: return "\u{fc46}"
        case .webexBoardBold: return "\u{fc47}"
        case .webexBoardLight: return "\u{fc48}"
        case .webexBoardRegular: return "\u{fc49}"
        case .webexCodecPlusBold: return "\u{fc4a}"
        case .webexCodecPlusLight: return "\u{fc4b}"
        case .webexCodecPlusRegular: return "\u{fc4c}"
        case .webexDeskCameraBold: return "\u{fc4d}"
        case .webexDeskCameraLight: return "\u{fc4e}"
        case .webexDeskCameraRegular: return "\u{fc4f}"
        case .webexHelixBold: return "\u{fc50}"
        case .webexHelixLight: return "\u{fc51}"
        case .webexHelixRegular: return "\u{fc52}"
        case .webexMeetingsBold: return "\u{fc53}"
        case .webexMeetingsFilled: return "\u{fc54}"
        case .webexMeetingsLight: return "\u{fc55}"
        case .webexMeetingsRegular: return "\u{fc56}"
        case .webexQuadCameraBold: return "\u{fc57}"
        case .webexQuadCameraLight: return "\u{fc58}"
        case .webexQuadCameraRegular: return "\u{fc59}"
        case .webexRoomKitBold: return "\u{fc5a}"
        case .webexRoomKitLight: return "\u{fc5b}"
        case .webexRoomKitPlusBold: return "\u{fc5c}"
        case .webexRoomKitPlusLight: return "\u{fc5d}"
        case .webexRoomKitPlusRegular: return "\u{fc5e}"
        case .webexRoomKitRegular: return "\u{fc5f}"
        case .webexShareBold: return "\u{fc60}"
        case .webexShareLight: return "\u{fc61}"
        case .webexShareRegular: return "\u{fc62}"
        case .webexTeamsBold: return "\u{fc63}"
        case .webexTeamsFilled: return "\u{fc64}"
        case .webexTeamsLight: return "\u{fc65}"
        case .webexTeamsNewBold: return "\u{fc66}"
        case .webexTeamsNewFilled: return "\u{fc67}"
        case .webexTeamsNewLight: return "\u{fc68}"
        case .webexTeamsNewRegular: return "\u{fc69}"
        case .webexTeamsRegular: return "\u{fc6a}"
        case .webexTeamsRemoveBold: return "\u{fc6b}"
        case .webexTeamsRemoveLight: return "\u{fc6c}"
        case .webexTeamsRemoveRegular: return "\u{fc6d}"
        case .webhookBold: return "\u{fc6e}"
        case .webhookLight: return "\u{fc6f}"
        case .webhookRegular: return "\u{fc70}"
        case .webinarBold: return "\u{fc71}"
        case .webinarFilled: return "\u{fc72}"
        case .webinarLight: return "\u{fc73}"
        case .webinarRegular: return "\u{fc74}"
        case .weeklyRecurringScheduleBold: return "\u{fc75}"
        case .weeklyRecurringScheduleLight: return "\u{fc76}"
        case .weeklyRecurringScheduleRegular: return "\u{fc77}"
        case .whisperAnnouncementBold: return "\u{fc78}"
        case .whisperAnnouncementFilled: return "\u{fc79}"
        case .whisperAnnouncementLight: return "\u{fc7a}"
        case .whisperAnnouncementRegular: return "\u{fc7b}"
        case .whisperCoachBold: return "\u{fc7c}"
        case .whisperCoachFilled: return "\u{fc7d}"
        case .whisperCoachLight: return "\u{fc7e}"
        case .whisperCoachRegular: return "\u{fc7f}"
        case .whiteboardBold: return "\u{fc80}"
        case .whiteboardContentBold: return "\u{fc81}"
        case .whiteboardContentFilled: return "\u{fc82}"
        case .whiteboardContentLight: return "\u{fc83}"
        case .whiteboardContentRegular: return "\u{fc84}"
        case .whiteboardFilled: return "\u{fc85}"
        case .whiteboardLight: return "\u{fc86}"
        case .whiteboardRegular: return "\u{fc87}"
        case .widgetBold: return "\u{fc88}"
        case .widgetFilled: return "\u{fc89}"
        case .widgetLight: return "\u{fc8a}"
        case .widgetRegular: return "\u{fc8b}"
        case .wifiBold: return "\u{fc8c}"
        case .wifiErrorBold: return "\u{fc8d}"
        case .wifiErrorLight: return "\u{fc8e}"
        case .wifiErrorRegular: return "\u{fc8f}"
        case .wifiLight: return "\u{fc90}"
        case .wifiRegular: return "\u{fc91}"
        case .wifiSignalGoodBold: return "\u{fc92}"
        case .wifiSignalGoodLight: return "\u{fc93}"
        case .wifiSignalGoodRegular: return "\u{fc94}"
        case .wifiSignalPoorBold: return "\u{fc95}"
        case .wifiSignalPoorLight: return "\u{fc96}"
        case .wifiSignalPoorRegular: return "\u{fc97}"
        case .wifiSignalUnstableBold: return "\u{fc98}"
        case .wifiSignalUnstableLight: return "\u{fc99}"
        case .wifiSignalUnstableRegular: return "\u{fc9a}"
        case .windowCornerScrubBold: return "\u{fc9b}"
        case .windowCornerScrubLight: return "\u{fc9c}"
        case .windowCornerScrubRegular: return "\u{fc9d}"
        case .windowRightCornerScrubBold: return "\u{fc9e}"
        case .windowRightCornerScrubLight: return "\u{fc9f}"
        case .windowRightCornerScrubRegular: return "\u{fca0}"
        case .windowVerticalScrubBold: return "\u{fca1}"
        case .windowVerticalScrubLight: return "\u{fca2}"
        case .windowVerticalScrubRegular: return "\u{fca3}"
        case .workflowDeploymentsBold: return "\u{fca4}"
        case .workflowDeploymentsFilled: return "\u{fca5}"
        case .workflowDeploymentsLight: return "\u{fca6}"
        case .workflowDeploymentsRegular: return "\u{fca7}"
        case .workphoneBold: return "\u{fca8}"
        case .workphoneLight: return "\u{fca9}"
        case .workphoneRegular: return "\u{fcaa}"
        case .zoomInBold: return "\u{fcab}"
        case .zoomInLight: return "\u{fcac}"
        case .zoomInRegular: return "\u{fcad}"
        case .zoomOutBold: return "\u{fcae}"
        case .zoomOutLight: return "\u{fcaf}"
        case .zoomOutRegular: return "\u{fcb0}"
