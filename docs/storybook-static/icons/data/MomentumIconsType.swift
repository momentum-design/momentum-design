...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    case colorSpeechAiBold
    case colorSpeechAiFilled
    case colorSpeechAiLight
    case colorSpeechAiRegular
    ...
    case dialpadBold
    case dialpadFilled
    case dialpadHideBold
    case dialpadHideFilled
    case dialpadHideLight
    case dialpadHideRegular
    case dialpadLight
    case dialpadRegular
    case diamondBold
    case diamondFilled
    ...
    case dockWindowBold
    case dockWindowClosedBold
    case dockWindowClosedFilled
    case dockWindowClosedLight
    case dockWindowClosedRegular
    case dockWindowFilled
    ...
    case fileEmailBold
    case fileEmailFilled
    case fileEmailLight
    case fileEmailRegular
    case fileExcelBold
    ...
    case microphoneMusicModeOnHighBold
    case microphoneMusicModeOnHighFilled
    case microphoneMusicModeOnHighLight
    case microphoneMusicModeOnHighRegular
    case microphoneMusicModeOnLight
    case microphoneMusicModeOnLowBold
    case microphoneMusicModeOnLowFilled
    case microphoneMusicModeOnLowLight
    case microphoneMusicModeOnLowRegular
    ...
    case microphoneOnHighBold
    case microphoneOnHighFilled
    case microphoneOnHighLight
    case microphoneOnHighRegular
    case microphoneOnLight
    case microphoneOnLowBold
    case microphoneOnLowFilled
    case microphoneOnLowLight
    case microphoneOnLowRegular
    ...
    case microphoneOptAllOnHighBold
    case microphoneOptAllOnHighFilled
    case microphoneOptAllOnHighLight
    case microphoneOptAllOnHighRegular
    case microphoneOptAllOnLight
    case microphoneOptAllOnLowBold
    case microphoneOptAllOnLowFilled
    case microphoneOptAllOnLowLight
    case microphoneOptAllOnLowRegular
    ...
    case microphoneOptMeOnHighBold
    case microphoneOptMeOnHighFilled
    case microphoneOptMeOnHighLight
    case microphoneOptMeOnHighRegular
    case microphoneOptMeOnLight
    case microphoneOptMeOnLowBol
    case microphoneOptMeOnLowFilled
    case microphoneOptMeOnLowLight
    case microphoneOptMeOnLowRegular
    ...
    case realTimeTextBold
    case realTimeTextFilled
    case realTimeTextLight
    case realTimeTextRegular
    ...
    case voiceClipBold
    case voiceClipFilled
    case voiceClipLight
    case voiceClipRegular
    case voicemailBold
    ...
    public var ligature: String {
        ...
        case .colorSpeechAiBold: return "\u{f3bf}"
        case .colorSpeechAiFilled: return "\u{f3c0}"
        case .colorSpeechAiLight: return "\u{f3c1}"
        case .colorSpeechAiRegular: return "\u{f3c2}"
        case .colorSummarizeAiBold: return "\u{f3c3}"
        case .colorSummarizeAiLight: return "\u{f3c4}"
        case .colorSummarizeAiRegular: return "\u{f3c5}"
        case .colourPaletteBold: return "\u{f3c6}"
        case .colourPaletteFilled: return "\u{f3c7}"
        case .colourPaletteLight: return "\u{f3c8}"
        case .colourPaletteRegular: return "\u{f3c9}"
        case .commentingBold: return "\u{f3ca}"
        case .commentingFilled: return "\u{f3cb}"
        case .commentingLight: return "\u{f3cc}"
        case .commentingRegular: return "\u{f3cd}"
        case .companyBold: return "\u{f3ce}"
        case .companyLight: return "\u{f3cf}"
        case .companyRegular: return "\u{f3d0}"
        case .completedByBaseBold: return "\u{f3d1}"
        case .completedByBaseLight: return "\u{f3d2}"
        case .completedByBaseRegular: return "\u{f3d3}"
        case .completedByTimeBold: return "\u{f3d4}"
        case .completedByTimeLight: return "\u{f3d5}"
        case .completedByTimeRegular: return "\u{f3d6}"
        case .completedInteractionBold: return "\u{f3d7}"
        case .completedInteractionFilled: return "\u{f3d8}"
        case .completedInteractionLight: return "\u{f3d9}"
        case .completedInteractionRegular: return "\u{f3da}"
        case .computerBold: return "\u{f3db}"
        case .computerLight: return "\u{f3dc}"
        case .computerRegular: return "\u{f3dd}"
        case .conciergeBold: return "\u{f3de}"
        case .conciergeLight: return "\u{f3df}"
        case .conciergeRegular: return "\u{f3e0}"
        case .conditionalBlockBold: return "\u{f3e1}"
        case .conditionalBlockLight: return "\u{f3e2}"
        case .conditionalBlockRegular: return "\u{f3e3}"
        case .connectBold: return "\u{f3e4}"
        case .connectLight: return "\u{f3e5}"
        case .connectRegular: return "\u{f3e6}"
        case .contactCardBold: return "\u{f3e7}"
        case .contactCardFilled: return "\u{f3e8}"
        case .contactCardLight: return "\u{f3e9}"
        case .contactCardRegular: return "\u{f3ea}"
        case .contactsBold: return "\u{f3eb}"
        case .contactsFilled: return "\u{f3ec}"
        case .contactsLight: return "\u{f3ed}"
        case .contactsRegular: return "\u{f3ee}"
        case .contentDownloadBold: return "\u{f3ef}"
        case .contentDownloadFilled: return "\u{f3f0}"
        case .contentDownloadLight: return "\u{f3f1}"
        case .contentDownloadRegular: return "\u{f3f2}"
        case .contentShareBold: return "\u{f3f3}"
        case .contentShareLight: return "\u{f3f4}"
        case .contentShareRegular: return "\u{f3f5}"
        case .contrastBold: return "\u{f3f6}"
        case .contrastLight: return "\u{f3f7}"
        case .contrastRegular: return "\u{f3f8}"
        case .copyBold: return "\u{f3f9}"
        case .copyLight: return "\u{f3fa}"
        case .copyRegular: return "\u{f3fb}"
        case .cpuBold: return "\u{f3fc}"
        case .cpuLight: return "\u{f3fd}"
        case .cpuRegular: return "\u{f3fe}"
        case .createAGroupBold: return "\u{f3ff}"
        case .createAGroupFilled: return "\u{f400}"
        case .createAGroupLight: return "\u{f401}"
        case .createAGroupRegular: return "\u{f402}"
        case .cropBold: return "\u{f403}"
        case .cropLight: return "\u{f404}"
        case .cropRegular: return "\u{f405}"
        case .cucmConnectionBold: return "\u{f406}"
        case .cucmConnectionLight: return "\u{f407}"
        case .cucmConnectionRegular: return "\u{f408}"
        case .customCodeEditorBold: return "\u{f409}"
        case .customCodeEditorLight: return "\u{f40a}"
        case .customCodeEditorRegular: return "\u{f40b}"
        case .customTaskBold: return "\u{f40c}"
        case .customTaskFilled: return "\u{f40d}"
        case .customTaskIndBold: return "\u{f40e}"
        case .customTaskIndFilled: return "\u{f40f}"
        case .customTaskIndLight: return "\u{f410}"
        case .customTaskIndRegular: return "\u{f411}"
        case .customTaskLight: return "\u{f412}"
        case .customTaskRegular: return "\u{f413}"
        case .dailyRecurringScheduleBold: return "\u{f414}"
        case .dailyRecurringScheduleLight: return "\u{f415}"
        case .dailyRecurringScheduleRegular: return "\u{f416}"
        case .dashboardBold: return "\u{f417}"
        case .dashboardFilled: return "\u{f418}"
        case .dashboardLight: return "\u{f419}"
        case .dashboardRegular: return "\u{f41a}"
        case .dataManagementBold: return "\u{f41b}"
        case .dataManagementFilled: return "\u{f41c}"
        case .dataManagementLight: return "\u{f41d}"
        case .dataManagementRegular: return "\u{f41e}"
        case .dataRangeSelectionBold: return "\u{f41f}"
        case .dataRangeSelectionFilled: return "\u{f420}"
        case .dataRangeSelectionLight: return "\u{f421}"
        case .dataRangeSelectionRegular: return "\u{f422}"
        case .declineBold: return "\u{f423}"
        case .declineFilled: return "\u{f424}"
        case .declineLight: return "\u{f425}"
        case .declineRegular: return "\u{f426}"
        case .dectHandsetBold: return "\u{f427}"
        case .dectHandsetFilled: return "\u{f428}"
        case .dectHandsetLight: return "\u{f429}"
        case .dectHandsetRegular: return "\u{f42a}"
        case .deleteBold: return "\u{f42b}"
        case .deleteFilled: return "\u{f42c}"
        case .deleteLight: return "\u{f42d}"
        case .deleteRegular: return "\u{f42e}"
        case .deploymentEvaluationProgressBold: return "\u{f42f}"
        case .deploymentEvaluationProgressLight: return "\u{f430}"
        case .deploymentEvaluationProgressRegular: return "\u{f431}"
        case .deploymentProgressBold: return "\u{f432}"
        case .deploymentProgressLight: return "\u{f433}"
        case .deploymentProgressRegular: return "\u{f434}"
        case .deploymentRecurringBold: return "\u{f435}"
        case .deploymentRecurringLight: return "\u{f436}"
        case .deploymentRecurringRegular: return "\u{f437}"
        case .deploymentWinnerPendingBold: return "\u{f438}"
        case .deploymentWinnerPendingLight: return "\u{f439}"
        case .deploymentWinnerPendingRegular: return "\u{f43a}"
        case .deskPhoneBold: return "\u{f43b}"
        case .deskPhoneFilled: return "\u{f43c}"
        case .deskPhoneLight: return "\u{f43d}"
        case .deskPhoneRegular: return "\u{f43e}"
        case .deskPhoneWarningBold: return "\u{f43f}"
        case .deskPhoneWarningLight: return "\u{f440}"
        case .deskPhoneWarningRegular: return "\u{f441}"
        case .deviceConnectionBold: return "\u{f442}"
        case .deviceConnectionFilled: return "\u{f443}"
        case .deviceConnectionLight: return "\u{f444}"
        case .deviceConnectionRegular: return "\u{f445}"
        case .deviceInRoomBold: return "\u{f446}"
        case .deviceInRoomEndBold: return "\u{f447}"
        case .deviceInRoomEndLight: return "\u{f448}"
        case .deviceInRoomEndRegular: return "\u{f449}"
        case .deviceInRoomFilled: return "\u{f44a}"
        case .deviceInRoomLight: return "\u{f44b}"
        case .deviceInRoomRegular: return "\u{f44c}"
        case .deviceMutedBold: return "\u{f44d}"
        case .deviceMutedLight: return "\u{f44e}"
        case .deviceMutedRegular: return "\u{f44f}"
        case .devicePolicyControllerBold: return "\u{f450}"
        case .devicePolicyControllerLight: return "\u{f451}"
        case .devicePolicyControllerRegular: return "\u{f452}"
        case .devicesBold: return "\u{f453}"
        case .devicesFilled: return "\u{f454}"
        case .devicesLight: return "\u{f455}"
        case .devicesRegular: return "\u{f456}"
        case .diagnosticsBold: return "\u{f457}"
        case .diagnosticsFilled: return "\u{f458}"
        case .diagnosticsLight: return "\u{f459}"
        case .diagnosticsRegular: return "\u{f45a}"
        case .dialpadBold: return "\u{f45b}"
        case .dialpadFilled: return "\u{f45c}"
        case .dialpadHideBold: return "\u{f45d}"
        case .dialpadHideFilled: return "\u{f45e}"
        case .dialpadHideLight: return "\u{f45f}"
        case .dialpadHideRegular: return "\u{f460}"
        case .dialpadLight: return "\u{f461}"
        case .dialpadRegular: return "\u{f462}"
        case .diamondBold: return "\u{f463}"
        case .diamondFilled: return "\u{f464}"
        case .diamondLight: return "\u{f465}"
        case .diamondRegular: return "\u{f466}"
        case .directionalPadBold: return "\u{f467}"
        case .directionalPadFilled: return "\u{f468}"
        case .directionalPadLight: return "\u{f469}"
        case .directionalPadRegular: return "\u{f46a}"
        case .directoryBold: return "\u{f46b}"
        case .directoryLight: return "\u{f46c}"
        case .directoryRegular: return "\u{f46d}"
        case .disappearingPenBold: return "\u{f46e}"
        case .disappearingPenLight: return "\u{f46f}"
        case .disappearingPenRegular: return "\u{f470}"
        case .discBold: return "\u{f471}"
        case .discConnectedBold: return "\u{f472}"
        case .discConnectedLight: return "\u{f473}"
        case .discConnectedRegular: return "\u{f474}"
        case .discLight: return "\u{f475}"
        case .discRegular: return "\u{f476}"
        case .disconnectBold: return "\u{f477}"
        case .disconnectFilled: return "\u{f478}"
        case .disconnectLight: return "\u{f479}"
        case .disconnectRegular: return "\u{f47a}"
        case .dislikeBold: return "\u{f47b}"
        case .dislikeFilled: return "\u{f47c}"
        case .dislikeLight: return "\u{f47d}"
        case .dislikeRegular: return "\u{f47e}"
        case .displayBold: return "\u{f47f}"
        case .displayInputBold: return "\u{f480}"
        case .displayInputLight: return "\u{f481}"
        case .displayInputRegular: return "\u{f482}"
        case .displayLight: return "\u{f483}"
        case .displayRegular: return "\u{f484}"
        case .displayWarningBold: return "\u{f485}"
        case .displayWarningLight: return "\u{f486}"
        case .displayWarningRegular: return "\u{f487}"
        case .distributeHorizontalBold: return "\u{f488}"
        case .distributeHorizontalFilled: return "\u{f489}"
        case .distributeHorizontalLight: return "\u{f48a}"
        case .distributeHorizontalRegular: return "\u{f48b}"
        case .distributeVerticallyBold: return "\u{f48c}"
        case .distributeVerticallyFilled: return "\u{f48d}"
        case .distributeVerticallyLight: return "\u{f48e}"
        case .distributeVerticallyRegular: return "\u{f48f}"
        case .divideBold: return "\u{f490}"
        case .divideFilled: return "\u{f491}"
        case .divideLight: return "\u{f492}"
        case .divideRegular: return "\u{f493}"
        case .dndPresenceBadgeFilled: return "\u{f494}"
        case .dndPresenceBold: return "\u{f495}"
        case .dndPresenceFilled: return "\u{f496}"
        case .dndPresenceLight: return "\u{f497}"
        case .dndPresenceRegular: return "\u{f498}"
        case .dockWindowBold: return "\u{f499}"
        case .dockWindowClosedBold: return "\u{f49a}"
        case .dockWindowClosedFilled: return "\u{f49b}"
        case .dockWindowClosedLight: return "\u{f49c}"
        case .dockWindowClosedRegular: return "\u{f49d}"
        case .dockWindowFilled: return "\u{f49e}"
        case .dockWindowLight: return "\u{f49f}"
        case .dockWindowRegular: return "\u{f4a0}"
        case .documentBold: return "\u{f4a1}"
        case .documentCameraBold: return "\u{f4a2}"
        case .documentCameraDisconnectedBold: return "\u{f4a3}"
        case .documentCameraDisconnectedLight: return "\u{f4a4}"
        case .documentCameraDisconnectedRegular: return "\u{f4a5}"
        case .documentCameraLight: return "\u{f4a6}"
        case .documentCameraRegular: return "\u{f4a7}"
        case .documentCreateBold: return "\u{f4a8}"
        case .documentCreateFilled: return "\u{f4a9}"
        case .documentCreateLight: return "\u{f4aa}"
        case .documentCreateRegular: return "\u{f4ab}"
        case .documentFilled: return "\u{f4ac}"
        case .documentLight: return "\u{f4ad}"
        case .documentMoveBold: return "\u{f4ae}"
        case .documentMoveFilled: return "\u{f4af}"
        case .documentMoveLight: return "\u{f4b0}"
        case .documentMoveRegular: return "\u{f4b1}"
        case .documentRegular: return "\u{f4b2}"
        case .documentShareBold: return "\u{f4b3}"
        case .documentShareFilled: return "\u{f4b4}"
        case .documentShareLight: return "\u{f4b5}"
        case .documentShareRegular: return "\u{f4b6}"
        case .doneAllBold: return "\u{f4b7}"
        case .doneAllLight: return "\u{f4b8}"
        case .doneAllRegular: return "\u{f4b9}"
        case .donutChartBold: return "\u{f4ba}"
        case .donutChartFilled: return "\u{f4bb}"
        case .donutChartLight: return "\u{f4bc}"
        case .donutChartRegular: return "\u{f4bd}"
        case .downloadBold: return "\u{f4be}"
        case .downloadFilled: return "\u{f4bf}"
        case .downloadLight: return "\u{f4c0}"
        case .downloadRegular: return "\u{f4c1}"
        case .draftBold: return "\u{f4c2}"
        case .draftFilled: return "\u{f4c3}"
        case .draftIndicatorBold: return "\u{f4c4}"
        case .draftIndicatorSmallFilled: return "\u{f4c5}"
        case .draftLight: return "\u{f4c6}"
        case .draftRegular: return "\u{f4c7}"
        case .dragBold: return "\u{f4c8}"
        case .dragLight: return "\u{f4c9}"
        case .dragRegular: return "\u{f4ca}"
        case .draggerHorizontalBold: return "\u{f4cb}"
        case .draggerHorizontalLight: return "\u{f4cc}"
        case .draggerHorizontalRegular: return "\u{f4cd}"
        case .draggerVerticalBold: return "\u{f4ce}"
        case .draggerVerticalLight: return "\u{f4cf}"
        case .draggerVerticalRegular: return "\u{f4d0}"
        case .driveModeBold: return "\u{f4d1}"
        case .driveModeLight: return "\u{f4d2}"
        case .driveModeRegular: return "\u{f4d3}"
        case .dropdownBold: return "\u{f4d4}"
        case .dropdownLight: return "\u{f4d5}"
        case .dropdownRegular: return "\u{f4d6}"
        case .dxEightyBold: return "\u{f4d7}"
        case .dxEightyFilled: return "\u{f4d8}"
        case .dxEightyLight: return "\u{f4d9}"
        case .dxEightyRegular: return "\u{f4da}"
        case .dxSeventyBold: return "\u{f4db}"
        case .dxSeventyLight: return "\u{f4dc}"
        case .dxSeventyRegular: return "\u{f4dd}"
        case .editBold: return "\u{f4de}"
        case .editFilled: return "\u{f4df}"
        case .editLight: return "\u{f4e0}"
        case .editNoteBold: return "\u{f4e1}"
        case .editNoteFilled: return "\u{f4e2}"
        case .editNoteLight: return "\u{f4e3}"
        case .editNoteRegular: return "\u{f4e4}"
        case .editRegular: return "\u{f4e5}"
        case .editablePartialBold: return "\u{f4e6}"
        case .editablePartialLight: return "\u{f4e7}"
        case .editablePartialRegular: return "\u{f4e8}"
        case .educationBold: return "\u{f4e9}"
        case .educationFilled: return "\u{f4ea}"
        case .educationLight: return "\u{f4eb}"
        case .educationRegular: return "\u{f4ec}"
        case .emailBold: return "\u{f4ed}"
        case .emailDeliveredBold: return "\u{f4ee}"
        case .emailDeliveredLight: return "\u{f4ef}"
        case .emailDeliveredRegular: return "\u{f4f0}"
        case .emailFailureBold: return "\u{f4f1}"
        case .emailFailureLight: return "\u{f4f2}"
        case .emailFailureRegular: return "\u{f4f3}"
        case .emailFilled: return "\u{f4f4}"
        case .emailInviteBold: return "\u{f4f5}"
        case .emailInviteLight: return "\u{f4f6}"
        case .emailInviteRegular: return "\u{f4f7}"
        case .emailLight: return "\u{f4f8}"
        case .emailOutgoingBold: return "\u{f4f9}"
        case .emailOutgoingFilled: return "\u{f4fa}"
        case .emailOutgoingLight: return "\u{f4fb}"
        case .emailOutgoingRegular: return "\u{f4fc}"
        case .emailReadBold: return "\u{f4fd}"
        case .emailReadFilled: return "\u{f4fe}"
        case .emailReadLight: return "\u{f4ff}"
        case .emailReadRegular: return "\u{f500}"
        case .emailRegular: return "\u{f501}"
        case .emergencyCallbackNumberBold: return "\u{f502}"
        case .emergencyCallbackNumberFilled: return "\u{f503}"
        case .emergencyCallbackNumberLight: return "\u{f504}"
        case .emergencyCallbackNumberRegular: return "\u{f505}"
        case .emojiExcitedBold: return "\u{f506}"
        case .emojiExcitedFilled: return "\u{f507}"
        case .emojiExcitedLight: return "\u{f508}"
        case .emojiExcitedRegular: return "\u{f509}"
        case .emojiHappyBold: return "\u{f50a}"
        case .emojiHappyFilled: return "\u{f50b}"
        case .emojiHappyLight: return "\u{f50c}"
        case .emojiHappyRegular: return "\u{f50d}"
        case .emojiPassiveBold: return "\u{f50e}"
        case .emojiPassiveFilled: return "\u{f50f}"
        case .emojiPassiveLight: return "\u{f510}"
        case .emojiPassiveRegular: return "\u{f511}"
        case .emojiSadBold: return "\u{f512}"
        case .emojiSadFilled: return "\u{f513}"
        case .emojiSadLight: return "\u{f514}"
        case .emojiSadRegular: return "\u{f515}"
        case .emojiUnhappyBold: return "\u{f516}"
        case .emojiUnhappyFilled: return "\u{f517}"
        case .emojiUnhappyLight: return "\u{f518}"
        case .emojiUnhappyRegular: return "\u{f519}"
        case .encryptionAdaptiveBold: return "\u{f51a}"
        case .encryptionAdaptiveFilled: return "\u{f51b}"
        case .encryptionAdaptiveLight: return "\u{f51c}"
        case .encryptionAdaptiveRegular: return "\u{f51d}"
        case .encryptionAdaptiveSecureBold: return "\u{f51e}"
        case .encryptionAdaptiveSecureFilled: return "\u{f51f}"
        case .encryptionAdaptiveSecureLight: return "\u{f520}"
        case .encryptionAdaptiveSecureRegular: return "\u{f521}"
        case .encryptionBold: return "\u{f522}"
        case .encryptionCircleAdaptiveBold: return "\u{f523}"
        case .encryptionCircleAdaptiveFilled: return "\u{f524}"
        case .encryptionCircleAdaptiveLight: return "\u{f525}"
        case .encryptionCircleAdaptiveRegular: return "\u{f526}"
        case .encryptionCircleAdaptiveSecureBold: return "\u{f527}"
        case .encryptionCircleAdaptiveSecureFilled: return "\u{f528}"
        case .encryptionCircleAdaptiveSecureLight: return "\u{f529}"
        case .encryptionCircleAdaptiveSecureRegular: return "\u{f52a}"
        case .encryptionCircleBold: return "\u{f52b}"
        case .encryptionCircleFilled: return "\u{f52c}"
        case .encryptionCircleLight: return "\u{f52d}"
        case .encryptionCircleRegular: return "\u{f52e}"
        case .encryptionFilled: return "\u{f52f}"
        case .encryptionLight: return "\u{f530}"
        case .encryptionRegular: return "\u{f531}"
        case .endRemoteDesktopControlBold: return "\u{f532}"
        case .endRemoteDesktopControlLight: return "\u{f533}"
        case .endRemoteDesktopControlRegular: return "\u{f534}"
        case .endToEndEncryptionBold: return "\u{f535}"
        case .endToEndEncryptionCircleBold: return "\u{f536}"
        case .endToEndEncryptionCircleFilled: return "\u{f537}"
        case .endToEndEncryptionCircleLight: return "\u{f538}"
        case .endToEndEncryptionCircleRegular: return "\u{f539}"
        case .endToEndEncryptionFilled: return "\u{f53a}"
        case .endToEndEncryptionLight: return "\u{f53b}"
        case .endToEndEncryptionRegular: return "\u{f53c}"
        case .endpointBlockedBold: return "\u{f53d}"
        case .endpointBlockedLight: return "\u{f53e}"
        case .endpointBlockedRegular: return "\u{f53f}"
        case .endpointBold: return "\u{f540}"
        case .endpointGTwoBold: return "\u{f541}"
        case .endpointGTwoLight: return "\u{f542}"
        case .endpointGTwoRegular: return "\u{f543}"
        case .endpointGTwoSeventyBold: return "\u{f544}"
        case .endpointGTwoSeventyDualBold: return "\u{f545}"
        case .endpointGTwoSeventyDualLight: return "\u{f546}"
        case .endpointGTwoSeventyDualRegular: return "\u{f547}"
        case .endpointGTwoSeventyLight: return "\u{f548}"
        case .endpointGTwoSeventyRegular: return "\u{f549}"
        case .endpointGTwoStandBold: return "\u{f54a}"
        case .endpointGTwoStandLight: return "\u{f54b}"
        case .endpointGTwoStandRegular: return "\u{f54c}"
        case .endpointLight: return "\u{f54d}"
        case .endpointMxEightHundredBold: return "\u{f54e}"
        case .endpointMxEightHundredDualBold: return "\u{f54f}"
        case .endpointMxEightHundredDualLight: return "\u{f550}"
        case .endpointMxEightHundredDualRegular: return "\u{f551}"
        case .endpointMxEightHundredLight: return "\u{f552}"
        case .endpointMxEightHundredRegular: return "\u{f553}"
        case .endpointRegular: return "\u{f554}"
        case .endpointStandBold: return "\u{f555}"
        case .endpointStandFilled: return "\u{f556}"
        case .endpointStandLight: return "\u{f557}"
        case .endpointStandRegular: return "\u{f558}"
        case .endpointWarningBold: return "\u{f559}"
        case .endpointWarningLight: return "\u{f55a}"
        case .endpointWarningRegular: return "\u{f55b}"
        case .enterBold: return "\u{f55c}"
        case .enterLight: return "\u{f55d}"
        case .enterRegular: return "\u{f55e}"
        case .enterRoomBold: return "\u{f55f}"
        case .enterRoomFilled: return "\u{f560}"
        case .enterRoomLight: return "\u{f561}"
        case .enterRoomRegular: return "\u{f562}"
        case .eraserBold: return "\u{f563}"
        case .eraserFilled: return "\u{f564}"
        case .eraserLight: return "\u{f565}"
        case .eraserRegular: return "\u{f566}"
        case .errorLegacyBadgeFilled: return "\u{f567}"
        case .errorLegacyBold: return "\u{f568}"
        case .errorLegacyFilled: return "\u{f569}"
        case .errorLegacyLight: return "\u{f56a}"
        case .errorLegacyRegular: return "\u{f56b}"
        case .ethernetBold: return "\u{f56c}"
        case .ethernetFilled: return "\u{f56d}"
        case .ethernetLight: return "\u{f56e}"
        case .ethernetRegular: return "\u{f56f}"
        case .exchangeBold: return "\u{f570}"
        case .exchangeLight: return "\u{f571}"
        case .exchangeRegular: return "\u{f572}"
        case .exclamationBold: return "\u{f573}"
        case .exclamationLight: return "\u{f574}"
        case .exclamationRegular: return "\u{f575}"
        case .excludeBold: return "\u{f576}"
        case .excludeLight: return "\u{f577}"
        case .excludeRegular: return "\u{f578}"
        case .existingTargetGroupBold: return "\u{f579}"
        case .existingTargetGroupLight: return "\u{f57a}"
        case .existingTargetGroupRegular: return "\u{f57b}"
        case .exitRoomBold: return "\u{f57c}"
        case .exitRoomLight: return "\u{f57d}"
        case .exitRoomRegular: return "\u{f57e}"
        case .exploreBold: return "\u{f57f}"
        case .exploreLight: return "\u{f580}"
        case .exploreRegular: return "\u{f581}"
        case .exportBold: return "\u{f582}"
        case .exportLight: return "\u{f583}"
        case .exportRegular: return "\u{f584}"
        case .extensionMobilityBold: return "\u{f585}"
        case .extensionMobilityLight: return "\u{f586}"
        case .extensionMobilityRegular: return "\u{f587}"
        case .externalMessageBold: return "\u{f588}"
        case .externalMessageLight: return "\u{f589}"
        case .externalMessageRegular: return "\u{f58a}"
        case .externalUserBold: return "\u{f58b}"
        case .externalUserLight: return "\u{f58c}"
        case .externalUserRegular: return "\u{f58d}"
        case .familyFontBold: return "\u{f58e}"
        case .familyFontLight: return "\u{f58f}"
        case .familyFontRegular: return "\u{f590}"
        case .fastForwardBold: return "\u{f591}"
        case .fastForwardLight: return "\u{f592}"
        case .fastForwardRegular: return "\u{f593}"
        case .favoriteBold: return "\u{f594}"
        case .favoriteFilled: return "\u{f595}"
        case .favoriteLight: return "\u{f596}"
        case .favoriteRegular: return "\u{f597}"
        case .favoritesBold: return "\u{f598}"
        case .favoritesFilled: return "\u{f599}"
        case .favoritesLight: return "\u{f59a}"
        case .favoritesRegular: return "\u{f59b}"
        case .fbwBold: return "\u{f59c}"
        case .fbwFilled: return "\u{f59d}"
        case .fbwLight: return "\u{f59e}"
        case .fbwRegular: return "\u{f59f}"
        case .ffwBold: return "\u{f5a0}"
        case .ffwFilled: return "\u{f5a1}"
        case .ffwLight: return "\u{f5a2}"
        case .ffwRegular: return "\u{f5a3}"
        case .fileAnalysisBold: return "\u{f5a4}"
        case .fileAnalysisFilled: return "\u{f5a5}"
        case .fileAnalysisLight: return "\u{f5a6}"
        case .fileAnalysisRegular: return "\u{f5a7}"
        case .fileAnnotationBold: return "\u{f5a8}"
        case .fileAnnotationFilled: return "\u{f5a9}"
        case .fileAnnotationLight: return "\u{f5aa}"
        case .fileAnnotationRegular: return "\u{f5ab}"
        case .fileAudioBold: return "\u{f5ac}"
        case .fileAudioFilled: return "\u{f5ad}"
        case .fileAudioLight: return "\u{f5ae}"
        case .fileAudioRegular: return "\u{f5af}"
        case .fileBugBold: return "\u{f5b0}"
        case .fileBugFilled: return "\u{f5b1}"
        case .fileBugLight: return "\u{f5b2}"
        case .fileBugRegular: return "\u{f5b3}"
        case .fileCodeBold: return "\u{f5b4}"
        case .fileCodeFilled: return "\u{f5b5}"
        case .fileCodeLight: return "\u{f5b6}"
        case .fileCodeRegular: return "\u{f5b7}"
        case .fileDashboardBold: return "\u{f5b8}"
        case .fileDashboardFilled: return "\u{f5b9}"
        case .fileDashboardLight: return "\u{f5ba}"
        case .fileDashboardRegular: return "\u{f5bb}"
        case .fileEmailBold: return "\u{f5bc}"
        case .fileEmailFilled: return "\u{f5bd}"
        case .fileEmailLight: return "\u{f5be}"
        case .fileEmailRegular: return "\u{f5bf}"
        case .fileExcelBold: return "\u{f5c0}"
        case .fileExcelFilled: return "\u{f5c1}"
        case .fileExcelLight: return "\u{f5c2}"
        case .fileExcelRegular: return "\u{f5c3}"
        case .fileGraphBold: return "\u{f5c4}"
        case .fileGraphFilled: return "\u{f5c5}"
        case .fileGraphLight: return "\u{f5c6}"
        case .fileGraphRegular: return "\u{f5c7}"
        case .fileImageBold: return "\u{f5c8}"
        case .fileImageFilled: return "\u{f5c9}"
        case .fileImageLight: return "\u{f5ca}"
        case .fileImageNoneBold: return "\u{f5cb}"
        case .fileImageNoneLight: return "\u{f5cc}"
        case .fileImageNoneRegular: return "\u{f5cd}"
        case .fileImageRegular: return "\u{f5ce}"
        case .fileJsBold: return "\u{f5cf}"
        case .fileJsFilled: return "\u{f5d0}"
        case .fileJsLight: return "\u{f5d1}"
        case .fileJsRegular: return "\u{f5d2}"
        case .fileKeynoteBold: return "\u{f5d3}"
        case .fileKeynoteFilled: return "\u{f5d4}"
        case .fileKeynoteLight: return "\u{f5d5}"
        case .fileKeynoteRegular: return "\u{f5d6}"
        case .fileLockedBold: return "\u{f5d7}"
        case .fileLockedFilled: return "\u{f5d8}"
        case .fileLockedLight: return "\u{f5d9}"
        case .fileLockedRegular: return "\u{f5da}"
        case .fileMissingBold: return "\u{f5db}"
        case .fileMissingFilled: return "\u{f5dc}"
        case .fileMissingLight: return "\u{f5dd}"
        case .fileMissingRegular: return "\u{f5de}"
        case .fileMusicBold: return "\u{f5df}"
        case .fileMusicFilled: return "\u{f5e0}"
        case .fileMusicLight: return "\u{f5e1}"
        case .fileMusicRegular: return "\u{f5e2}"
        case .fileOnenoteBold: return "\u{f5e3}"
        case .fileOnenoteFilled: return "\u{f5e4}"
        case .fileOnenoteLight: return "\u{f5e5}"
        case .fileOnenoteRegular: return "\u{f5e6}"
        case .filePdfBold: return "\u{f5e7}"
        case .filePdfFilled: return "\u{f5e8}"
        case .filePdfLight: return "\u{f5e9}"
        case .filePdfRegular: return "\u{f5ea}"
        case .filePowerpointBold: return "\u{f5eb}"
        case .filePowerpointFilled: return "\u{f5ec}"
        case .filePowerpointLight: return "\u{f5ed}"
        case .filePowerpointRegular: return "\u{f5ee}"
        case .fileSpreadsheetBold: return "\u{f5ef}"
        case .fileSpreadsheetFilled: return "\u{f5f0}"
        case .fileSpreadsheetLight: return "\u{f5f1}"
        case .fileSpreadsheetRegular: return "\u{f5f2}"
        case .fileTextBold: return "\u{f5f3}"
        case .fileTextFilled: return "\u{f5f4}"
        case .fileTextLight: return "\u{f5f5}"
        case .fileTextRegular: return "\u{f5f6}"
        case .fileThreeDBold: return "\u{f5f7}"
        case .fileThreeDFilled: return "\u{f5f8}"
        case .fileThreeDLight: return "\u{f5f9}"
        case .fileThreeDRegular: return "\u{f5fa}"
        case .fileVectorBold: return "\u{f5fb}"
        case .fileVectorFilled: return "\u{f5fc}"
        case .fileVectorLight: return "\u{f5fd}"
        case .fileVectorRegular: return "\u{f5fe}"
        case .fileVideoBold: return "\u{f5ff}"
        case .fileVideoFilled: return "\u{f600}"
        case .fileVideoLight: return "\u{f601}"
        case .fileVideoRegular: return "\u{f602}"
        case .fileWordBold: return "\u{f603}"
        case .fileWordFilled: return "\u{f604}"
        case .fileWordLight: return "\u{f605}"
        case .fileWordRegular: return "\u{f606}"
        case .fileXmlBold: return "\u{f607}"
        case .fileXmlFilled: return "\u{f608}"
        case .fileXmlLight: return "\u{f609}"
        case .fileXmlRegular: return "\u{f60a}"
        case .fileZipBold: return "\u{f60b}"
        case .fileZipFilled: return "\u{f60c}"
        case .fileZipLight: return "\u{f60d}"
        case .fileZipRegular: return "\u{f60e}"
        case .filesBold: return "\u{f60f}"
        case .filesFilled: return "\u{f610}"
        case .filesLight: return "\u{f611}"
        case .filesRegular: return "\u{f612}"
        case .fillColourBold: return "\u{f613}"
        case .fillColourFilled: return "\u{f614}"
        case .fillColourLight: return "\u{f615}"
        case .fillColourRegular: return "\u{f616}"
        case .filterBold: return "\u{f617}"
        case .filterCircleBold: return "\u{f618}"
        case .filterCircleFilled: return "\u{f619}"
        case .filterCircleLight: return "\u{f61a}"
        case .filterCircleRegular: return "\u{f61b}"
        case .filterLight: return "\u{f61c}"
        case .filterRegular: return "\u{f61d}"
        case .fitToWidthBold: return "\u{f61e}"
        case .fitToWidthLight: return "\u{f61f}"
        case .fitToWidthRegular: return "\u{f620}"
        case .fitToWindowExpandBold: return "\u{f621}"
        case .fitToWindowExpandLight: return "\u{f622}"
        case .fitToWindowExpandRegular: return "\u{f623}"
        case .fitToWindowShrinkBold: return "\u{f624}"
        case .fitToWindowShrinkLight: return "\u{f625}"
        case .fitToWindowShrinkRegular: return "\u{f626}"
        case .flagBold: return "\u{f627}"
        case .flagCircleBold: return "\u{f628}"
        case .flagCircleFilled: return "\u{f629}"
        case .flagCircleLight: return "\u{f62a}"
        case .flagCircleRegular: return "\u{f62b}"
        case .flagFilled: return "\u{f62c}"
        case .flagLight: return "\u{f62d}"
        case .flagRegular: return "\u{f62e}"
        case .folderBold: return "\u{f62f}"
        case .folderEditBold: return "\u{f630}"
        case .folderEditLight: return "\u{f631}"
        case .folderEditRegular: return "\u{f632}"
        case .folderFilled: return "\u{f633}"
        case .folderLight: return "\u{f634}"
        case .folderLockBold: return "\u{f635}"
        case .folderLockLight: return "\u{f636}"
        case .folderLockRegular: return "\u{f637}"
        case .folderRegular: return "\u{f638}"
        case .folderViewBold: return "\u{f639}"
        case .folderViewLight: return "\u{f63a}"
        case .folderViewRegular: return "\u{f63b}"
        case .followUpBold: return "\u{f63c}"
        case .followUpLight: return "\u{f63d}"
        case .followUpRegular: return "\u{f63e}"
        case .foodBold: return "\u{f63f}"
        case .foodFilled: return "\u{f640}"
        case .foodLight: return "\u{f641}"
        case .foodRegular: return "\u{f642}"
        case .forecastBold: return "\u{f643}"
        case .forecastFilled: return "\u{f644}"
        case .forecastLight: return "\u{f645}"
        case .forecastRegular: return "\u{f646}"
        case .formatBold: return "\u{f647}"
        case .formatDefaultAppBold: return "\u{f648}"
        case .formatDefaultAppFilled: return "\u{f649}"
        case .formatDefaultAppLight: return "\u{f64a}"
        case .formatDefaultAppRegular: return "\u{f64b}"
        case .formatLight: return "\u{f64c}"
        case .formatPanelControlBarBold: return "\u{f64d}"
        case .formatPanelControlBarLight: return "\u{f64e}"
        case .formatPanelControlBarRegular: return "\u{f64f}"
        case .formatPanelControlDownBold: return "\u{f650}"
        case .formatPanelControlDownLight: return "\u{f651}"
        case .formatPanelControlDownRegular: return "\u{f652}"
        case .formatPanelControlLeftBold: return "\u{f653}"
        case .formatPanelControlLeftLight: return "\u{f654}"
        case .formatPanelControlLeftRegular: return "\u{f655}"
        case .formatPanelControlRightBold: return "\u{f656}"
        case .formatPanelControlRightLight: return "\u{f657}"
        case .formatPanelControlRightRegular: return "\u{f658}"
        case .formatPanelControlUpBold: return "\u{f659}"
        case .formatPanelControlUpDownBold: return "\u{f65a}"
        case .formatPanelControlUpDownLight: return "\u{f65b}"
        case .formatPanelControlUpDownRegular: return "\u{f65c}"
        case .formatPanelControlUpLight: return "\u{f65d}"
        case .formatPanelControlUpRegular: return "\u{f65e}"
        case .formatRegular: return "\u{f65f}"
        case .formatViewMixedBold: return "\u{f660}"
        case .formatViewMixedLight: return "\u{f661}"
        case .formatViewMixedRegular: return "\u{f662}"
        case .formulaBold: return "\u{f663}"
        case .formulaFilled: return "\u{f664}"
        case .formulaLight: return "\u{f665}"
        case .formulaRegular: return "\u{f666}"
        case .forwardMessageBold: return "\u{f667}"
        case .forwardMessageFilled: return "\u{f668}"
        case .forwardMessageLight: return "\u{f669}"
        case .forwardMessageRegular: return "\u{f66a}"
        case .forwardTenSecBold: return "\u{f66b}"
        case .forwardTenSecLight: return "\u{f66c}"
        case .forwardTenSecRegular: return "\u{f66d}"
        case .fourColumnBold: return "\u{f66e}"
        case .fourColumnLight: return "\u{f66f}"
        case .fourColumnRegular: return "\u{f670}"
        case .fourWayNavigationBold: return "\u{f671}"
        case .fourWayNavigationLight: return "\u{f672}"
        case .fourWayNavigationRegular: return "\u{f673}"
        case .frequencyCappingBold: return "\u{f674}"
        case .frequencyCappingLight: return "\u{f675}"
        case .frequencyCappingRegular: return "\u{f676}"
        case .fulfillmentBold: return "\u{f677}"
        case .fulfillmentLight: return "\u{f678}"
        case .fulfillmentRegular: return "\u{f679}"
        case .fullscreenBold: return "\u{f67a}"
        case .fullscreenExitBold: return "\u{f67b}"
        case .fullscreenExitLight: return "\u{f67c}"
        case .fullscreenExitRegular: return "\u{f67d}"
        case .fullscreenLight: return "\u{f67e}"
        case .fullscreenRegular: return "\u{f67f}"
        case .genericDeviceVideoBadgeFilled: return "\u{f680}"
        case .genericDeviceVideoBold: return "\u{f681}"
        case .genericDeviceVideoFilled: return "\u{f682}"
        case .genericDeviceVideoLight: return "\u{f683}"
        case .genericDeviceVideoRegular: return "\u{f684}"
        case .gifBold: return "\u{f685}"
        case .gifFilled: return "\u{f686}"
        case .gifHorizontalBold: return "\u{f687}"
        case .gifHorizontalFilled: return "\u{f688}"
        case .gifHorizontalLight: return "\u{f689}"
        case .gifHorizontalRegular: return "\u{f68a}"
        case .gifLight: return "\u{f68b}"
        case .gifRegular: return "\u{f68c}"
        case .giftBold: return "\u{f68d}"
        case .giftFilled: return "\u{f68e}"
        case .giftLight: return "\u{f68f}"
        case .giftRegular: return "\u{f690}"
        case .greenLeafBold: return "\u{f691}"
        case .greenLeafFilled: return "\u{f692}"
        case .greenLeafLight: return "\u{f693}"
        case .greenLeafRegular: return "\u{f694}"
        case .greenRoomBold: return "\u{f695}"
        case .greenRoomFilled: return "\u{f696}"
        case .greenRoomLight: return "\u{f697}"
        case .greenRoomRegular: return "\u{f698}"
        case .guestIssuerBold: return "\u{f699}"
        case .guestIssuerLight: return "\u{f69a}"
        case .guestIssuerRegular: return "\u{f69b}"
        case .guideBold: return "\u{f69c}"
        case .guideLight: return "\u{f69d}"
        case .guideRegular: return "\u{f69e}"
        case .handPointerBold: return "\u{f69f}"
        case .handPointerLight: return "\u{f6a0}"
        case .handPointerRegular: return "\u{f6a1}"
        case .handlerBold: return "\u{f6a2}"
        case .handlerHorizontalBold: return "\u{f6a3}"
        case .handlerHorizontalLight: return "\u{f6a4}"
        case .handlerHorizontalRegular: return "\u{f6a5}"
        case .handlerLight: return "\u{f6a6}"
        case .handlerRegular: return "\u{f6a7}"
        case .handsetAlertBold: return "\u{f6a8}"
        case .handsetAlertFilled: return "\u{f6a9}"
        case .handsetAlertLight: return "\u{f6aa}"
        case .handsetAlertRegular: return "\u{f6ab}"
        case .handsetBold: return "\u{f6ac}"
        case .handsetDownSlashBold: return "\u{f6ad}"
        case .handsetDownSlashFilled: return "\u{f6ae}"
        case .handsetDownSlashLight: return "\u{f6af}"
        case .handsetDownSlashRegular: return "\u{f6b0}"
        case .handsetFilled: return "\u{f6b1}"
        case .handsetLight: return "\u{f6b2}"
        case .handsetMutedBold: return "\u{f6b3}"
        case .handsetMutedFilled: return "\u{f6b4}"
        case .handsetMutedLight: return "\u{f6b5}"
        case .handsetMutedRegular: return "\u{f6b6}"
        case .handsetRegular: return "\u{f6b7}"
        case .handsetsArrowLeftBold: return "\u{f6b8}"
        case .handsetsArrowLeftLight: return "\u{f6b9}"
        case .handsetsArrowLeftRegular: return "\u{f6ba}"
        case .handshakeBold: return "\u{f6bb}"
        case .handshakeLight: return "\u{f6bc}"
        case .handshakeRegular: return "\u{f6bd}"
        case .headingOneBold: return "\u{f6be}"
        case .headingOneLight: return "\u{f6bf}"
        case .headingOneRegular: return "\u{f6c0}"
        case .headingThreeBold: return "\u{f6c1}"
        case .headingThreeLight: return "\u{f6c2}"
        case .headingThreeRegular: return "\u{f6c3}"
        case .headingTwoBold: return "\u{f6c4}"
        case .headingTwoLight: return "\u{f6c5}"
        case .headingTwoRegular: return "\u{f6c6}"
        case .headphonesBold: return "\u{f6c7}"
        case .headphonesFilled: return "\u{f6c8}"
        case .headphonesLight: return "\u{f6c9}"
        case .headphonesMutedBold: return "\u{f6ca}"
        case .headphonesMutedFilled: return "\u{f6cb}"
        case .headphonesMutedLight: return "\u{f6cc}"
        case .headphonesMutedRegular: return "\u{f6cd}"
        case .headphonesRegular: return "\u{f6ce}"
        case .headsetAlertBold: return "\u{f6cf}"
        case .headsetAlertLight: return "\u{f6d0}"
        case .headsetAlertRegular: return "\u{f6d1}"
        case .headsetArrowDownBold: return "\u{f6d2}"
        case .headsetArrowDownFilled: return "\u{f6d3}"
        case .headsetArrowDownLight: return "\u{f6d4}"
        case .headsetArrowDownRegular: return "\u{f6d5}"
        case .headsetBluetoothBold: return "\u{f6d6}"
        case .headsetBluetoothLight: return "\u{f6d7}"
        case .headsetBluetoothRegular: return "\u{f6d8}"
        case .headsetBold: return "\u{f6d9}"
        case .headsetFilled: return "\u{f6da}"
        case .headsetLight: return "\u{f6db}"
        case .headsetMutedBold: return "\u{f6dc}"
        case .headsetMutedLight: return "\u{f6dd}"
        case .headsetMutedRegular: return "\u{f6de}"
        case .headsetPrivateBold: return "\u{f6df}"
        case .headsetPrivateLight: return "\u{f6e0}"
        case .headsetPrivateRegular: return "\u{f6e1}"
        case .headsetRegular: return "\u{f6e2}"
        case .hearingBold: return "\u{f6e3}"
        case .hearingImpairedBold: return "\u{f6e4}"
        case .hearingImpairedLight: return "\u{f6e5}"
        case .hearingImpairedRegular: return "\u{f6e6}"
        case .hearingLight: return "\u{f6e7}"
        case .hearingRegular: return "\u{f6e8}"
        case .helpBold: return "\u{f6e9}"
        case .helpCircleBold: return "\u{f6ea}"
        case .helpCircleFilled: return "\u{f6eb}"
        case .helpCircleLight: return "\u{f6ec}"
        case .helpCircleRegular: return "\u{f6ed}"
        case .helpLight: return "\u{f6ee}"
        case .helpRegular: return "\u{f6ef}"
        case .helpdeskBold: return "\u{f6f0}"
        case .helpdeskFilled: return "\u{f6f1}"
        case .helpdeskLight: return "\u{f6f2}"
        case .helpdeskRegular: return "\u{f6f3}"
        case .hideBold: return "\u{f6f4}"
        case .hideFilled: return "\u{f6f5}"
        case .hideLight: return "\u{f6f6}"
        case .hideRegular: return "\u{f6f7}"
        case .homeBold: return "\u{f6f8}"
        case .homeFilled: return "\u{f6f9}"
        case .homeLight: return "\u{f6fa}"
        case .homeRegular: return "\u{f6fb}"
        case .horizontalLineBold: return "\u{f6fc}"
        case .horizontalLineLight: return "\u{f6fd}"
        case .horizontalLineRegular: return "\u{f6fe}"
        case .hotelingBold: return "\u{f6ff}"
        case .hotelingFilled: return "\u{f700}"
        case .hotelingLight: return "\u{f701}"
        case .hotelingRegular: return "\u{f702}"
        case .humidityBold: return "\u{f703}"
        case .humidityLight: return "\u{f704}"
        case .humidityRegular: return "\u{f705}"
        case .huntGroupBold: return "\u{f706}"
        case .huntGroupFilled: return "\u{f707}"
        case .huntGroupLight: return "\u{f708}"
        case .huntGroupRegular: return "\u{f709}"
        case .idleBold: return "\u{f70a}"
        case .idleFilled: return "\u{f70b}"
        case .idleLight: return "\u{f70c}"
        case .idleRegular: return "\u{f70d}"
        case .immediateBold: return "\u{f70e}"
        case .immediateFilled: return "\u{f70f}"
        case .immediateLight: return "\u{f710}"
        case .immediateRegular: return "\u{f711}"
        case .importBold: return "\u{f712}"
        case .importLight: return "\u{f713}"
        case .importRegular: return "\u{f714}"
        case .inCommonBold: return "\u{f715}"
        case .inCommonLight: return "\u{f716}"
        case .inCommonRegular: return "\u{f717}"
        case .inboxBold: return "\u{f718}"
        case .inboxFilled: return "\u{f719}"
        case .inboxLight: return "\u{f71a}"
        case .inboxRegular: return "\u{f71b}"
        case .includeBold: return "\u{f71c}"
        case .includeLight: return "\u{f71d}"
        case .includeRegular: return "\u{f71e}"
        case .incognitoBold: return "\u{f71f}"
        case .incognitoFilled: return "\u{f720}"
        case .incognitoLight: return "\u{f721}"
        case .incognitoRegular: return "\u{f722}"
        case .incomingCallLegacyBold: return "\u{f723}"
        case .incomingCallLegacyFilled: return "\u{f724}"
        case .incomingCallLegacyLight: return "\u{f725}"
        case .incomingCallLegacyRegular: return "\u{f726}"
        case .indentDecreaseBold: return "\u{f727}"
        case .indentDecreaseLight: return "\u{f728}"
        case .indentDecreaseRegular: return "\u{f729}"
        case .indentIncreaseBold: return "\u{f72a}"
        case .indentIncreaseLight: return "\u{f72b}"
        case .indentIncreaseRegular: return "\u{f72c}"
        case .infoBadgeFilled: return "\u{f72d}"
        case .infoCircleBold: return "\u{f72e}"
        case .infoCircleFilled: return "\u{f72f}"
        case .infoCircleLight: return "\u{f730}"
        case .infoCircleRegular: return "\u{f731}"
        case .infoCircleTwoBold: return "\u{f732}"
        case .infoCircleTwoFilled: return "\u{f733}"
        case .infoCircleTwoLight: return "\u{f734}"
        case .infoCircleTwoRegular: return "\u{f735}"
        case .inputBold: return "\u{f736}"
        case .inputDisconnectedBold: return "\u{f737}"
        case .inputDisconnectedLight: return "\u{f738}"
        case .inputDisconnectedRegular: return "\u{f739}"
        case .inputLight: return "\u{f73a}"
        case .inputRegular: return "\u{f73b}"
        case .instantScheduleBold: return "\u{f73c}"
        case .instantScheduleFilled: return "\u{f73d}"
        case .instantScheduleLight: return "\u{f73e}"
        case .instantScheduleRegular: return "\u{f73f}"
        case .integerBold: return "\u{f740}"
        case .integerFilled: return "\u{f741}"
        case .integerLight: return "\u{f742}"
        case .integerRegular: return "\u{f743}"
        case .integrationsBold: return "\u{f744}"
        case .integrationsFilled: return "\u{f745}"
        case .integrationsLight: return "\u{f746}"
        case .integrationsRegular: return "\u{f747}"
        case .intelligentRoutingBold: return "\u{f748}"
        case .intelligentRoutingLight: return "\u{f749}"
        case .intelligentRoutingRegular: return "\u{f74a}"
        case .interactionBold: return "\u{f74b}"
        case .interactionFilled: return "\u{f74c}"
        case .interactionLight: return "\u{f74d}"
        case .interactionRegular: return "\u{f74e}"
        case .invitedUserBold: return "\u{f74f}"
        case .invitedUserLight: return "\u{f750}"
        case .invitedUserRegular: return "\u{f751}"
        case .italicBold: return "\u{f752}"
        case .italicFilled: return "\u{f753}"
        case .italicLight: return "\u{f754}"
        case .italicRegular: return "\u{f755}"
        case .joinAudioBold: return "\u{f756}"
        case .joinAudioFilled: return "\u{f757}"
        case .joinAudioLight: return "\u{f758}"
        case .joinAudioRegular: return "\u{f759}"
        case .keepInTouchBold: return "\u{f75a}"
        case .keepInTouchFilled: return "\u{f75b}"
        case .keepInTouchLight: return "\u{f75c}"
        case .keepInTouchRegular: return "\u{f75d}"
        case .keyboardBold: return "\u{f75e}"
        case .keyboardCloseBold: return "\u{f75f}"
        case .keyboardCloseLight: return "\u{f760}"
        case .keyboardCloseRegular: return "\u{f761}"
        case .keyboardLight: return "\u{f762}"
        case .keyboardRegular: return "\u{f763}"
        case .languageBold: return "\u{f764}"
        case .languageFilled: return "\u{f765}"
        case .languageLight: return "\u{f766}"
        case .languageRegular: return "\u{f767}"
        case .laptopBold: return "\u{f768}"
        case .laptopDisconnectedBold: return "\u{f769}"
        case .laptopDisconnectedLight: return "\u{f76a}"
        case .laptopDisconnectedRegular: return "\u{f76b}"
        case .laptopFilled: return "\u{f76c}"
        case .laptopLight: return "\u{f76d}"
        case .laptopRegular: return "\u{f76e}"
        case .laserPointerBold: return "\u{f76f}"
        case .laserPointerCursorBlackLight: return "\u{f770}"
        case .laserPointerCursorBlueLight: return "\u{f771}"
        case .laserPointerCursorGreenLight: return "\u{f772}"
        case .laserPointerCursorPurpleLight: return "\u{f773}"
        case .laserPointerCursorRedLight: return "\u{f774}"
        case .laserPointerCursorWhiteLight: return "\u{f775}"
        case .laserPointerCursorYellowLight: return "\u{f776}"
        case .laserPointerFilled: return "\u{f777}"
        case .laserPointerLight: return "\u{f778}"
        case .laserPointerRegular: return "\u{f779}"
        case .launchBold: return "\u{f77a}"
        case .launchFilled: return "\u{f77b}"
        case .launchLight: return "\u{f77c}"
        case .launchRegular: return "\u{f77d}"
        case .layoutSideBySideVerticalBold: return "\u{f77e}"
        case .layoutSideBySideVerticalFilled: return "\u{f77f}"
        case .layoutSideBySideVerticalLight: return "\u{f780}"
        case .layoutSideBySideVerticalRegular: return "\u{f781}"
        case .leaveBreakoutSessionBold: return "\u{f782}"
        case .leaveBreakoutSessionLight: return "\u{f783}"
        case .leaveBreakoutSessionRegular: return "\u{f784}"
        case .leaveDeviceBold: return "\u{f785}"
        case .leaveDeviceLight: return "\u{f786}"
        case .leaveDeviceRegular: return "\u{f787}"
        case .likeBold: return "\u{f788}"
        case .likeFilled: return "\u{f789}"
        case .likeLight: return "\u{f78a}"
        case .likeRegular: return "\u{f78b}"
        case .linkBold: return "\u{f78c}"
        case .linkLight: return "\u{f78d}"
        case .linkRegular: return "\u{f78e}"
        case .listBulletedBold: return "\u{f78f}"
        case .listBulletedLight: return "\u{f790}"
        case .listBulletedRegular: return "\u{f791}"
        case .listMenuBold: return "\u{f792}"
        case .listMenuLight: return "\u{f793}"
        case .listMenuRegular: return "\u{f794}"
        case .listNumberedBold: return "\u{f795}"
        case .listNumberedLight: return "\u{f796}"
        case .listNumberedRegular: return "\u{f797}"
        case .liveBold: return "\u{f798}"
        case .liveFilled: return "\u{f799}"
        case .liveLight: return "\u{f79a}"
        case .liveRegular: return "\u{f79b}"
        case .locationBold: return "\u{f79c}"
        case .locationFilled: return "\u{f79d}"
        case .locationLight: return "\u{f79e}"
        case .locationRegular: return "\u{f79f}"
        case .longTextBoxBold: return "\u{f7a0}"
        case .longTextBoxLight: return "\u{f7a1}"
        case .longTextBoxRegular: return "\u{f7a2}"
        case .lowerHandBold: return "\u{f7a3}"
        case .lowerHandLight: return "\u{f7a4}"
        case .lowerHandRegular: return "\u{f7a5}"
        case .magicPenBold: return "\u{f7a6}"
        case .magicPenFilled: return "\u{f7a7}"
        case .magicPenLight: return "\u{f7a8}"
        case .magicPenRegular: return "\u{f7a9}"
        case .markAsUnreadBold: return "\u{f7aa}"
        case .markAsUnreadFilled: return "\u{f7ab}"
        case .markAsUnreadLight: return "\u{f7ac}"
        case .markAsUnreadRegular: return "\u{f7ad}"
        case .markdownBold: return "\u{f7ae}"
        case .markdownFilled: return "\u{f7af}"
        case .markdownLight: return "\u{f7b0}"
        case .markdownRegular: return "\u{f7b1}"
        case .markerBold: return "\u{f7b2}"
        case .markerFilled: return "\u{f7b3}"
        case .markerLight: return "\u{f7b4}"
        case .markerRegular: return "\u{f7b5}"
        case .maximizeBold: return "\u{f7b6}"
        case .maximizeLight: return "\u{f7b7}"
        case .maximizeRegular: return "\u{f7b8}"
        case .mcpBold: return "\u{f7b9}"
        case .mcpFilled: return "\u{f7ba}"
        case .mcpLight: return "\u{f7bb}"
        case .mcpRegular: return "\u{f7bc}"
        case .mediaPlayerBold: return "\u{f7bd}"
        case .mediaPlayerLight: return "\u{f7be}"
        case .mediaPlayerRegular: return "\u{f7bf}"
        case .mediaQualityGoodBold: return "\u{f7c0}"
        case .mediaQualityGoodFilled: return "\u{f7c1}"
        case .mediaQualityGoodLight: return "\u{f7c2}"
        case .mediaQualityGoodRegular: return "\u{f7c3}"
        case .mediaQualityPoorBold: return "\u{f7c4}"
        case .mediaQualityPoorColoredBold: return "\u{f7c5}"
        case .mediaQualityPoorFilled: return "\u{f7c6}"
        case .mediaQualityPoorLight: return "\u{f7c7}"
        case .mediaQualityPoorRegular: return "\u{f7c8}"
        case .mediaQualityUnstableBold: return "\u{f7c9}"
        case .mediaQualityUnstableColoredBold: return "\u{f7ca}"
        case .mediaQualityUnstableFilled: return "\u{f7cb}"
        case .mediaQualityUnstableLight: return "\u{f7cc}"
        case .mediaQualityUnstableRegular: return "\u{f7cd}"
        case .meetBold: return "\u{f7ce}"
        case .meetEndBold: return "\u{f7cf}"
        case .meetEndLight: return "\u{f7d0}"
        case .meetEndRegular: return "\u{f7d1}"
        case .meetFilled: return "\u{f7d2}"
        case .meetLight: return "\u{f7d3}"
        case .meetRegular: return "\u{f7d4}"
        case .meetingSummaryBold: return "\u{f7d5}"
        case .meetingSummaryFilled: return "\u{f7d6}"
        case .meetingSummaryLight: return "\u{f7d7}"
        case .meetingSummaryRegular: return "\u{f7d8}"
        case .meetingsBold: return "\u{f7d9}"
        case .meetingsFilled: return "\u{f7da}"
        case .meetingsFocusMonthBold: return "\u{f7db}"
        case .meetingsFocusMonthLight: return "\u{f7dc}"
        case .meetingsFocusMonthRegular: return "\u{f7dd}"
        case .meetingsFocusOneDayBold: return "\u{f7de}"
        case .meetingsFocusOneDayLight: return "\u{f7df}"
        case .meetingsFocusOneDayRegular: return "\u{f7e0}"
        case .meetingsFocusThreeDayBold: return "\u{f7e1}"
        case .meetingsFocusThreeDayLight: return "\u{f7e2}"
        case .meetingsFocusThreeDayRegular: return "\u{f7e3}"
        case .meetingsFocusUpcomingBold: return "\u{f7e4}"
        case .meetingsFocusUpcomingLight: return "\u{f7e5}"
        case .meetingsFocusUpcomingRegular: return "\u{f7e6}"
        case .meetingsLight: return "\u{f7e7}"
        case .meetingsPresenceBadgeFilled: return "\u{f7e8}"
        case .meetingsPresenceBold: return "\u{f7e9}"
        case .meetingsPresenceFilled: return "\u{f7ea}"
        case .meetingsPresenceLight: return "\u{f7eb}"
        case .meetingsPresenceRegular: return "\u{f7ec}"
        case .meetingsRegular: return "\u{f7ed}"
        case .meetingsTeamBold: return "\u{f7ee}"
        case .meetingsTeamFilled: return "\u{f7ef}"
        case .meetingsTeamLight: return "\u{f7f0}"
        case .meetingsTeamNewBold: return "\u{f7f1}"
        case .meetingsTeamNewLight: return "\u{f7f2}"
        case .meetingsTeamNewRegular: return "\u{f7f3}"
        case .meetingsTeamRegular: return "\u{f7f4}"
        case .mentionBold: return "\u{f7f5}"
        case .mentionFilled: return "\u{f7f6}"
        case .mentionLight: return "\u{f7f7}"
        case .mentionRegular: return "\u{f7f8}"
        case .messageQueingBold: return "\u{f7f9}"
        case .messageQueingLight: return "\u{f7fa}"
        case .messageQueingRegular: return "\u{f7fb}"
        case .microphoneBold: return "\u{f7fc}"
        case .microphoneFilled: return "\u{f7fd}"
        case .microphoneHardMutedBold: return "\u{f7fe}"
        case .microphoneHardMutedCircleFilled: return "\u{f7ff}"
        case .microphoneHardMutedLight: return "\u{f800}"
        case .microphoneHardMutedRegular: return "\u{f801}"
        case .microphoneLight: return "\u{f802}"
        case .microphoneMusicModeBold: return "\u{f803}"
        case .microphoneMusicModeLight: return "\u{f804}"
        case .microphoneMusicModeOnBold: return "\u{f805}"
        case .microphoneMusicModeOnHighBold: return "\u{f806}"
        case .microphoneMusicModeOnHighFilled: return "\u{f807}"
        case .microphoneMusicModeOnHighLight: return "\u{f808}"
        case .microphoneMusicModeOnHighRegular: return "\u{f809}"
        case .microphoneMusicModeOnLight: return "\u{f80a}"
        case .microphoneMusicModeOnLowBold: return "\u{f80b}"
        case .microphoneMusicModeOnLowFilled: return "\u{f80c}"
        case .microphoneMusicModeOnLowLight: return "\u{f80d}"
        case .microphoneMusicModeOnLowRegular: return "\u{f80e}"
        case .microphoneMusicModeOnRegular: return "\u{f80f}"
        case .microphoneMusicModeRegular: return "\u{f810}"
        case .microphoneMutedBold: return "\u{f811}"
        case .microphoneMutedCircleFilled: return "\u{f812}"
        case .microphoneMutedFilled: return "\u{f813}"
        case .microphoneMutedLight: return "\u{f814}"
        case .microphoneMutedRegular: return "\u{f815}"
        case .microphoneOnBold: return "\u{f816}"
        case .microphoneOnHighBold: return "\u{f817}"
        case .microphoneOnHighFilled: return "\u{f818}"
        case .microphoneOnHighLight: return "\u{f819}"
        case .microphoneOnHighRegular: return "\u{f81a}"
        case .microphoneOnLight: return "\u{f81b}"
        case .microphoneOnLowBold: return "\u{f81c}"
        case .microphoneOnLowFilled: return "\u{f81d}"
        case .microphoneOnLowLight: return "\u{f81e}"
        case .microphoneOnLowRegular: return "\u{f81f}"
        case .microphoneOnRegular: return "\u{f820}"
        case .microphoneOptAllBold: return "\u{f821}"
        case .microphoneOptAllLight: return "\u{f822}"
        case .microphoneOptAllMutedBold: return "\u{f823}"
        case .microphoneOptAllMutedLight: return "\u{f824}"
        case .microphoneOptAllMutedRegular: return "\u{f825}"
        case .microphoneOptAllOnBold: return "\u{f826}"
        case .microphoneOptAllOnHighBold: return "\u{f827}"
        case .microphoneOptAllOnHighFilled: return "\u{f828}"
        case .microphoneOptAllOnHighLight: return "\u{f829}"
        case .microphoneOptAllOnHighRegular: return "\u{f82a}"
        case .microphoneOptAllOnLight: return "\u{f82b}"
        case .microphoneOptAllOnLowBold: return "\u{f82c}"
        case .microphoneOptAllOnLowFilled: return "\u{f82d}"
        case .microphoneOptAllOnLowLight: return "\u{f82e}"
        case .microphoneOptAllOnLowRegular: return "\u{f82f}"
        case .microphoneOptAllOnRegular: return "\u{f830}"
        case .microphoneOptAllRegular: return "\u{f831}"
        case .microphoneOptMeBold: return "\u{f832}"
        case .microphoneOptMeLight: return "\u{f833}"
        case .microphoneOptMeMutedBold: return "\u{f834}"
        case .microphoneOptMeMutedLight: return "\u{f835}"
        case .microphoneOptMeMutedRegular: return "\u{f836}"
        case .microphoneOptMeOnBold: return "\u{f837}"
        case .microphoneOptMeOnHighBold: return "\u{f838}"
        case .microphoneOptMeOnHighFilled: return "\u{f839}"
        case .microphoneOptMeOnHighLight: return "\u{f83a}"
        case .microphoneOptMeOnHighRegular: return "\u{f83b}"
        case .microphoneOptMeOnLight: return "\u{f83c}"
        case .microphoneOptMeOnLowBol: return "\u{f83d}"
        case .microphoneOptMeOnLowFilled: return "\u{f83e}"
        case .microphoneOptMeOnLowLight: return "\u{f83f}"
        case .microphoneOptMeOnLowRegular: return "\u{f840}"
        case .microphoneOptMeOnRegular: return "\u{f841}"
        case .microphoneOptMeRegular: return "\u{f842}"
        case .microphoneRegular: return "\u{f843}"
        case .mindMapBold: return "\u{f844}"
        case .mindMapLight: return "\u{f845}"
        case .mindMapRegular: return "\u{f846}"
        case .minimizeBold: return "\u{f847}"
        case .minimizeLight: return "\u{f848}"
        case .minimizeRegular: return "\u{f849}"
        case .minusBold: return "\u{f84a}"
        case .minusFilled: return "\u{f84b}"
        case .minusLight: return "\u{f84c}"
        case .minusRegular: return "\u{f84d}"
        case .mirrorBold: return "\u{f84e}"
        case .mirrorFilled: return "\u{f84f}"
        case .mirrorLight: return "\u{f850}"
        case .mirrorRegular: return "\u{f851}"
        case .mmsFilled: return "\u{f852}"
        case .moderatorBold: return "\u{f853}"
        case .moderatorLight: return "\u{f854}"
        case .moderatorRegular: return "\u{f855}"
        case .monitoringBold: return "\u{f856}"
        case .monitoringLight: return "\u{f857}"
        case .monitoringRegular: return "\u{f858}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f859}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f85a}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f85b}"
        case .moreAdrBold: return "\u{f85c}"
        case .moreAdrLight: return "\u{f85d}"
        case .moreAdrRegular: return "\u{f85e}"
        case .moreBold: return "\u{f85f}"
        case .moreCircleBold: return "\u{f860}"
        case .moreCircleFilled: return "\u{f861}"
        case .moreCircleLight: return "\u{f862}"
        case .moreCircleRegular: return "\u{f863}"
        case .moreLight: return "\u{f864}"
        case .moreRegular: return "\u{f865}"
        case .mouseCursorBold: return "\u{f866}"
        case .mouseCursorLight: return "\u{f867}"
        case .mouseCursorRegular: return "\u{f868}"
        case .moveCallInAdrBold: return "\u{f869}"
        case .moveCallInAdrLight: return "\u{f86a}"
        case .moveCallInAdrRegular: return "\u{f86b}"
        case .moveCallInIphBold: return "\u{f86c}"
        case .moveCallInIphLight: return "\u{f86d}"
        case .moveCallInIphRegular: return "\u{f86e}"
        case .moveCallInLaptopBold: return "\u{f86f}"
        case .moveCallInLaptopLight: return "\u{f870}"
        case .moveCallInLaptopRegular: return "\u{f871}"
        case .moveCallInOutAdrBold: return "\u{f872}"
        case .moveCallInOutAdrLight: return "\u{f873}"
        case .moveCallInOutAdrRegular: return "\u{f874}"
        case .moveCallInOutIphBold: return "\u{f875}"
        case .moveCallInOutIphLight: return "\u{f876}"
        case .moveCallInOutIphRegular: return "\u{f877}"
        case .moveCallInTabletBold: return "\u{f878}"
        case .moveCallInTabletLight: return "\u{f879}"
        case .moveCallInTabletRegular: return "\u{f87a}"
        case .moveCallOutAdrBold: return "\u{f87b}"
        case .moveCallOutAdrLight: return "\u{f87c}"
        case .moveCallOutAdrRegular: return "\u{f87d}"
        case .moveCallOutIphBold: return "\u{f87e}"
        case .moveCallOutIphLight: return "\u{f87f}"
        case .moveCallOutIphRegular: return "\u{f880}"
        case .moveCallOutLaptopBold: return "\u{f881}"
        case .moveCallOutLaptopLight: return "\u{f882}"
        case .moveCallOutLaptopRegular: return "\u{f883}"
        case .moveCallOutTabletBold: return "\u{f884}"
        case .moveCallOutTabletLight: return "\u{f885}"
        case .moveCallOutTabletRegular: return "\u{f886}"
        case .moveToBottomBold: return "\u{f887}"
        case .moveToBottomFilled: return "\u{f888}"
        case .moveToBottomLight: return "\u{f889}"
        case .moveToBottomRegular: return "\u{f88a}"
        case .moveToScreenBold: return "\u{f88b}"
        case .moveToScreenLight: return "\u{f88c}"
        case .moveToScreenRegular: return "\u{f88d}"
        case .moveToTopBold: return "\u{f88e}"
        case .moveToTopFilled: return "\u{f88f}"
        case .moveToTopLight: return "\u{f890}"
        case .moveToTopRegular: return "\u{f891}"
        case .multilineChartBold: return "\u{f892}"
        case .multilineChartFilled: return "\u{f893}"
        case .multilineChartLight: return "\u{f894}"
        case .multilineChartRegular: return "\u{f895}"
        case .multimediaBold: return "\u{f896}"
        case .multimediaFilled: return "\u{f897}"
        case .multimediaLight: return "\u{f898}"
        case .multimediaRegular: return "\u{f899}"
        case .multipledDevicesBold: return "\u{f89a}"
        case .multipledDevicesFilled: return "\u{f89b}"
        case .multipledDevicesLight: return "\u{f89c}"
        case .multipledDevicesRegular: return "\u{f89d}"
        case .musicModeCircleBold: return "\u{f89e}"
        case .musicModeCircleFilled: return "\u{f89f}"
        case .musicModeCircleLight: return "\u{f8a0}"
        case .musicModeCircleRegular: return "\u{f8a1}"
        case .musicNoteBold: return "\u{f8a2}"
        case .musicNoteFilled: return "\u{f8a3}"
        case .musicNoteLight: return "\u{f8a4}"
        case .musicNoteRegular: return "\u{f8a5}"
        case .muteOnEntryBold: return "\u{f8a6}"
        case .muteOnEntryFilled: return "\u{f8a7}"
        case .muteOnEntryLight: return "\u{f8a8}"
        case .muteOnEntryRegular: return "\u{f8a9}"
        case .networkSwitchBold: return "\u{f8aa}"
        case .networkSwitchFilled: return "\u{f8ab}"
        case .networkSwitchLight: return "\u{f8ac}"
        case .networkSwitchRegular: return "\u{f8ad}"
        case .newManagerBold: return "\u{f8ae}"
        case .newManagerFilled: return "\u{f8af}"
        case .newManagerLight: return "\u{f8b0}"
        case .newManagerRegular: return "\u{f8b1}"
        case .newTitleBold: return "\u{f8b2}"
        case .newTitleLight: return "\u{f8b3}"
        case .newTitleRegular: return "\u{f8b4}"
        case .newVoicemailBold: return "\u{f8b5}"
        case .newVoicemailLight: return "\u{f8b6}"
        case .newVoicemailRegular: return "\u{f8b7}"
        case .newWhiteboardBold: return "\u{f8b8}"
        case .newWhiteboardLight: return "\u{f8b9}"
        case .newWhiteboardRegular: return "\u{f8ba}"
        case .nextBold: return "\u{f8bb}"
        case .nextLight: return "\u{f8bc}"
        case .nextRegular: return "\u{f8bd}"
        case .noDevicesBold: return "\u{f8be}"
        case .noDevicesLight: return "\u{f8bf}"
        case .noDevicesRegular: return "\u{f8c0}"
        case .noiseDetectedCanceledFilled: return "\u{f8c1}"
        case .noiseDetectedFilled: return "\u{f8c2}"
        case .noiseNoneCanceledFilled: return "\u{f8c3}"
        case .noiseNoneFilled: return "\u{f8c4}"
        case .noiseRemovalBold: return "\u{f8c5}"
        case .noiseRemovalLight: return "\u{f8c6}"
        case .noiseRemovalRegular: return "\u{f8c7}"
        case .noteBold: return "\u{f8c8}"
        case .noteFilled: return "\u{f8c9}"
        case .noteLight: return "\u{f8ca}"
        case .notePptBold: return "\u{f8cb}"
        case .notePptLight: return "\u{f8cc}"
        case .notePptRegular: return "\u{f8cd}"
        case .noteRegular: return "\u{f8ce}"
        case .notesBold: return "\u{f8cf}"
        case .notesFilled: return "\u{f8d0}"
        case .notesLight: return "\u{f8d1}"
        case .notesRegular: return "\u{f8d2}"
        case .numberBold: return "\u{f8d3}"
        case .numberHighlightBold: return "\u{f8d4}"
        case .numberHighlightFilled: return "\u{f8d5}"
        case .numberHighlightLight: return "\u{f8d6}"
        case .numberHighlightRegular: return "\u{f8d7}"
        case .numberLight: return "\u{f8d8}"
        case .numberRegular: return "\u{f8d9}"
        case .oldRemoteBold: return "\u{f8da}"
        case .oldRemoteLight: return "\u{f8db}"
        case .oldRemoteRegular: return "\u{f8dc}"
        case .oldTouchBold: return "\u{f8dd}"
        case .oldTouchLight: return "\u{f8de}"
        case .oldTouchRegular: return "\u{f8df}"
        case .oneColumnBold: return "\u{f8e0}"
        case .oneColumnLight: return "\u{f8e1}"
        case .oneColumnRegular: return "\u{f8e2}"
        case .oneTimeBold: return "\u{f8e3}"
        case .oneTimeLight: return "\u{f8e4}"
        case .oneTimeRegular: return "\u{f8e5}"
        case .openInFolderBold: return "\u{f8e6}"
        case .openInFolderFilled: return "\u{f8e7}"
        case .openInFolderLight: return "\u{f8e8}"
        case .openInFolderRegular: return "\u{f8e9}"
        case .openPagesBold: return "\u{f8ea}"
        case .openPagesLight: return "\u{f8eb}"
        case .openPagesRegular: return "\u{f8ec}"
        case .otherNumberBold: return "\u{f8ed}"
        case .otherNumberFilled: return "\u{f8ee}"
        case .otherNumberLight: return "\u{f8ef}"
        case .otherNumberRegular: return "\u{f8f0}"
        case .otherNumberWarningBold: return "\u{f8f1}"
        case .otherNumberWarningLight: return "\u{f8f2}"
        case .otherNumberWarningRegular: return "\u{f8f3}"
        case .outgoingCallLegacyBold: return "\u{f8f4}"
        case .outgoingCallLegacyFilled: return "\u{f8f5}"
        case .outgoingCallLegacyLight: return "\u{f8f6}"
        case .outgoingCallLegacyRegular: return "\u{f8f7}"
        case .overflowLeftBold: return "\u{f8f8}"
        case .overflowLeftLight: return "\u{f8f9}"
        case .overflowLeftRegular: return "\u{f8fa}"
        case .overflowRightBold: return "\u{f8fb}"
        case .overflowRightLight: return "\u{f8fc}"
        case .overflowRightRegular: return "\u{f8fd}"
        case .pairedCameraBold: return "\u{f8fe}"
        case .pairedCameraLight: return "\u{f8ff}"
        case .pairedCameraRegular: return "\u{f900}"
        case .pairedDeviceBold: return "\u{f901}"
        case .pairedDeviceLight: return "\u{f902}"
        case .pairedDeviceRegular: return "\u{f903}"
        case .pairedHandsetBold: return "\u{f904}"
        case .pairedHandsetLight: return "\u{f905}"
        case .pairedHandsetRegular: return "\u{f906}"
        case .pairingBold: return "\u{f907}"
        case .pairingLight: return "\u{f908}"
        case .pairingRegular: return "\u{f909}"
        case .parenthesisBold: return "\u{f90a}"
        case .parenthesisFilled: return "\u{f90b}"
        case .parenthesisLight: return "\u{f90c}"
        case .parenthesisRegular: return "\u{f90d}"
        case .parkedBold: return "\u{f90e}"
        case .parkedFilled: return "\u{f90f}"
        case .parkedLight: return "\u{f910}"
        case .parkedRegular: return "\u{f911}"
        case .parseBold: return "\u{f912}"
        case .parseLight: return "\u{f913}"
        case .parseRegular: return "\u{f914}"
        case .partialBold: return "\u{f915}"
        case .partialLight: return "\u{f916}"
        case .partialRegular: return "\u{f917}"
        case .participantAddBold: return "\u{f918}"
        case .participantAddLight: return "\u{f919}"
        case .participantAddRegular: return "\u{f91a}"
        case .participantBlockedBold: return "\u{f91b}"
        case .participantBlockedLight: return "\u{f91c}"
        case .participantBlockedRegular: return "\u{f91d}"
        case .participantBold: return "\u{f91e}"
        case .participantFilled: return "\u{f91f}"
        case .participantLight: return "\u{f920}"
        case .participantListBold: return "\u{f921}"
        case .participantListFilled: return "\u{f922}"
        case .participantListLight: return "\u{f923}"
        case .participantListRegular: return "\u{f924}"
        case .participantRegular: return "\u{f925}"
        case .participantRemoveBold: return "\u{f926}"
        case .participantRemoveLight: return "\u{f927}"
        case .participantRemoveRegular: return "\u{f928}"
        case .participantSpeakerBold: return "\u{f929}"
        case .participantSpeakerFilled: return "\u{f92a}"
        case .participantSpeakerLight: return "\u{f92b}"
        case .participantSpeakerRegular: return "\u{f92c}"
        case .participantUnknownBold: return "\u{f92d}"
        case .participantUnknownLight: return "\u{f92e}"
        case .participantUnknownRegular: return "\u{f92f}"
        case .passMouseBold: return "\u{f930}"
        case .passMouseLight: return "\u{f931}"
        case .passMouseRegular: return "\u{f932}"
        case .pauseBadgeFilled: return "\u{f933}"
        case .pauseBold: return "\u{f934}"
        case .pauseFilled: return "\u{f935}"
        case .pauseInteractionBold: return "\u{f936}"
        case .pauseInteractionFilled: return "\u{f937}"
        case .pauseInteractionLight: return "\u{f938}"
        case .pauseInteractionRegular: return "\u{f939}"
        case .pauseLight: return "\u{f93a}"
        case .pauseRegular: return "\u{f93b}"
        case .peopleAddBold: return "\u{f93c}"
        case .peopleAddFilled: return "\u{f93d}"
        case .peopleAddLight: return "\u{f93e}"
        case .peopleAddRegular: return "\u{f93f}"
        case .peopleBold: return "\u{f940}"
        case .peopleCircleBold: return "\u{f941}"
        case .peopleCircleFilled: return "\u{f942}"
        case .peopleCircleLight: return "\u{f943}"
        case .peopleCircleRegular: return "\u{f944}"
        case .peopleFilled: return "\u{f945}"
        case .peopleInsightsBold: return "\u{f946}"
        case .peopleInsightsFilled: return "\u{f947}"
        case .peopleInsightsLight: return "\u{f948}"
        case .peopleInsightsRegular: return "\u{f949}"
        case .peopleLight: return "\u{f94a}"
        case .peopleManageBold: return "\u{f94b}"
        case .peopleManageFilled: return "\u{f94c}"
        case .peopleManageLight: return "\u{f94d}"
        case .peopleManageRegular: return "\u{f94e}"
        case .peopleRegular: return "\u{f94f}"
        case .phoneAlertBold: return "\u{f950}"
        case .phoneAlertLight: return "\u{f951}"
        case .phoneAlertRegular: return "\u{f952}"
        case .phoneBadgeFilled: return "\u{f953}"
        case .phoneBold: return "\u{f954}"
        case .phoneFilled: return "\u{f955}"
        case .phoneLight: return "\u{f956}"
        case .phoneMutedBold: return "\u{f957}"
        case .phoneMutedLight: return "\u{f958}"
        case .phoneMutedRegular: return "\u{f959}"
        case .phonePrivateBold: return "\u{f95a}"
        case .phonePrivateLight: return "\u{f95b}"
        case .phonePrivateRegular: return "\u{f95c}"
        case .phoneRegular: return "\u{f95d}"
        case .phoneReplyAllBold: return "\u{f95e}"
        case .phoneReplyAllLight: return "\u{f95f}"
        case .phoneReplyAllRegular: return "\u{f960}"
        case .phoneReplyBold: return "\u{f961}"
        case .phoneReplyLight: return "\u{f962}"
        case .phoneReplyRegular: return "\u{f963}"
        case .pickerBold: return "\u{f964}"
        case .pickerLight: return "\u{f965}"
        case .pickerRegular: return "\u{f966}"
        case .pieChartBold: return "\u{f967}"
        case .pieChartFilled: return "\u{f968}"
        case .pieChartLight: return "\u{f969}"
        case .pieChartRegular: return "\u{f96a}"
        case .pinBold: return "\u{f96b}"
        case .pinFilled: return "\u{f96c}"
        case .pinLight: return "\u{f96d}"
        case .pinListActivityBold: return "\u{f96e}"
        case .pinListActivityLight: return "\u{f96f}"
        case .pinListActivityRegular: return "\u{f970}"
        case .pinListBold: return "\u{f971}"
        case .pinListLight: return "\u{f972}"
        case .pinListRegular: return "\u{f973}"
        case .pinMutedBold: return "\u{f974}"
        case .pinMutedFilled: return "\u{f975}"
        case .pinMutedLight: return "\u{f976}"
        case .pinMutedRegular: return "\u{f977}"
        case .pinRegular: return "\u{f978}"
        case .pipBold: return "\u{f979}"
        case .pipEnterBold: return "\u{f97a}"
        case .pipEnterLight: return "\u{f97b}"
        case .pipEnterRegular: return "\u{f97c}"
        case .pipExitBold: return "\u{f97d}"
        case .pipExitLight: return "\u{f97e}"
        case .pipExitRegular: return "\u{f97f}"
        case .pipFilled: return "\u{f980}"
        case .pipLight: return "\u{f981}"
        case .pipRegular: return "\u{f982}"
        case .placeholderBold: return "\u{f983}"
        case .placeholderFilled: return "\u{f984}"
        case .placeholderLight: return "\u{f985}"
        case .placeholderRegular: return "\u{f986}"
        case .playBold: return "\u{f987}"
        case .playCircleBold: return "\u{f988}"
        case .playCircleFilled: return "\u{f989}"
        case .playCircleLight: return "\u{f98a}"
        case .playCircleRegular: return "\u{f98b}"
        case .playFilled: return "\u{f98c}"
        case .playLight: return "\u{f98d}"
        case .playRegular: return "\u{f98e}"
        case .plugAcBold: return "\u{f98f}"
        case .plugAcLight: return "\u{f990}"
        case .plugAcRegular: return "\u{f991}"
        case .plusBold: return "\u{f992}"
        case .plusCircleBold: return "\u{f993}"
        case .plusCircleFilled: return "\u{f994}"
        case .plusCircleLight: return "\u{f995}"
        case .plusCircleRegular: return "\u{f996}"
        case .plusLight: return "\u{f997}"
        case .plusRegular: return "\u{f998}"
        case .pmrBold: return "\u{f999}"
        case .pmrFilled: return "\u{f99a}"
        case .pmrLight: return "\u{f99b}"
        case .pmrRegular: return "\u{f99c}"
        case .pollBold: return "\u{f99d}"
        case .pollFilled: return "\u{f99e}"
        case .pollLight: return "\u{f99f}"
        case .pollRegular: return "\u{f9a0}"
        case .popInBold: return "\u{f9a1}"
        case .popInLight: return "\u{f9a2}"
        case .popInRegular: return "\u{f9a3}"
        case .popOutBold: return "\u{f9a4}"
        case .popOutLight: return "\u{f9a5}"
        case .popOutRegular: return "\u{f9a6}"
        case .popUpBold: return "\u{f9a7}"
        case .popUpLight: return "\u{f9a8}"
        case .popUpRegular: return "\u{f9a9}"
        case .portraitLandscapeBold: return "\u{f9aa}"
        case .portraitLandscapeLight: return "\u{f9ab}"
        case .portraitLandscapeRegular: return "\u{f9ac}"
        case .potentialFraudBold: return "\u{f9ad}"
        case .potentialFraudFilled: return "\u{f9ae}"
        case .potentialFraudLight: return "\u{f9af}"
        case .potentialFraudRegular: return "\u{f9b0}"
        case .powerAcBold: return "\u{f9b1}"
        case .powerAcLight: return "\u{f9b2}"
        case .powerAcRegular: return "\u{f9b3}"
        case .powerBold: return "\u{f9b4}"
        case .powerLight: return "\u{f9b5}"
        case .powerRegular: return "\u{f9b6}"
        case .preHeaderBold: return "\u{f9b7}"
        case .preHeaderLight: return "\u{f9b8}"
        case .preHeaderRegular: return "\u{f9b9}"
        case .premiumBold: return "\u{f9ba}"
        case .premiumLight: return "\u{f9bb}"
        case .premiumRegular: return "\u{f9bc}"
        case .presentationBold: return "\u{f9bd}"
        case .presentationLight: return "\u{f9be}"
        case .presentationRegular: return "\u{f9bf}"
        case .preventDownloadBold: return "\u{f9c0}"
        case .preventDownloadFilled: return "\u{f9c1}"
        case .preventDownloadLight: return "\u{f9c2}"
        case .preventDownloadRegular: return "\u{f9c3}"
        case .primaryParticipantBold: return "\u{f9c4}"
        case .primaryParticipantFilled: return "\u{f9c5}"
        case .primaryParticipantLight: return "\u{f9c6}"
        case .primaryParticipantRegular: return "\u{f9c7}"
        case .printBold: return "\u{f9c8}"
        case .printLight: return "\u{f9c9}"
        case .printRegular: return "\u{f9ca}"
        case .priorityBadgeFilled: return "\u{f9cb}"
        case .priorityCircleBold: return "\u{f9cc}"
        case .priorityCircleFilled: return "\u{f9cd}"
        case .priorityCircleLight: return "\u{f9ce}"
        case .priorityCircleRegular: return "\u{f9cf}"
        case .priorityCircleTwoBold: return "\u{f9d0}"
        case .priorityCircleTwoFilled: return "\u{f9d1}"
        case .priorityCircleTwoLight: return "\u{f9d2}"
        case .priorityCircleTwoRegular: return "\u{f9d3}"
        case .priorityWaveBold: return "\u{f9d4}"
        case .priorityWaveLight: return "\u{f9d5}"
        case .priorityWaveRegular: return "\u{f9d6}"
        case .privacyCircleBold: return "\u{f9d7}"
        case .privacyCircleFilled: return "\u{f9d8}"
        case .privacyCircleLight: return "\u{f9d9}"
        case .privacyCircleRegular: return "\u{f9da}"
        case .privateBold: return "\u{f9db}"
        case .privateCircleBold: return "\u{f9dc}"
        case .privateCircleFilled: return "\u{f9dd}"
        case .privateCircleLight: return "\u{f9de}"
        case .privateCircleRegular: return "\u{f9df}"
        case .privateLight: return "\u{f9e0}"
        case .privateMeetingBold: return "\u{f9e1}"
        case .privateMeetingLight: return "\u{f9e2}"
        case .privateMeetingRegular: return "\u{f9e3}"
        case .privateRegular: return "\u{f9e4}"
        case .productDemoBold: return "\u{f9e5}"
        case .productDemoLight: return "\u{f9e6}"
        case .productDemoRegular: return "\u{f9e7}"
        case .promptsAiBold: return "\u{f9e8}"
        case .promptsAiLight: return "\u{f9e9}"
        case .promptsAiRegular: return "\u{f9ea}"
        case .proximityBold: return "\u{f9eb}"
        case .proximityLight: return "\u{f9ec}"
        case .proximityMutedBold: return "\u{f9ed}"
        case .proximityMutedLight: return "\u{f9ee}"
        case .proximityMutedRegular: return "\u{f9ef}"
        case .proximityRegular: return "\u{f9f0}"
        case .proximityVideoBold: return "\u{f9f1}"
        case .proximityVideoLight: return "\u{f9f2}"
        case .proximityVideoRegular: return "\u{f9f3}"
        case .ptoPresenceBold: return "\u{f9f4}"
        case .ptoPresenceFilled: return "\u{f9f5}"
        case .ptoPresenceLight: return "\u{f9f6}"
        case .ptoPresenceRegular: return "\u{f9f7}"
        case .pullCallBold: return "\u{f9f8}"
        case .pullCallFilled: return "\u{f9f9}"
        case .pullCallLight: return "\u{f9fa}"
        case .pullCallRegular: return "\u{f9fb}"
        case .purchaseOrderBold: return "\u{f9fc}"
        case .purchaseOrderFilled: return "\u{f9fd}"
        case .purchaseOrderLight: return "\u{f9fe}"
        case .purchaseOrderRegular: return "\u{f9ff}"
        case .qABold: return "\u{fa00}"
        case .qAFilled: return "\u{fa01}"
        case .qALight: return "\u{fa02}"
        case .qARegular: return "\u{fa03}"
        case .qrCodeBold: return "\u{fa04}"
        case .qrCodeLight: return "\u{fa05}"
        case .qrCodeRegular: return "\u{fa06}"
        case .qrCodeScanBold: return "\u{fa07}"
        case .qrCodeScanLight: return "\u{fa08}"
        case .qrCodeScanRegular: return "\u{fa09}"
        case .qualityBold: return "\u{fa0a}"
        case .qualityLight: return "\u{fa0b}"
        case .qualityRegular: return "\u{fa0c}"
        case .queueContactBold: return "\u{fa0d}"
        case .queueContactFilled: return "\u{fa0e}"
        case .queueContactLight: return "\u{fa0f}"
        case .queueContactRegular: return "\u{fa10}"
        case .queuedInteractionBold: return "\u{fa11}"
        case .queuedInteractionFilled: return "\u{fa12}"
        case .queuedInteractionLight: return "\u{fa13}"
        case .queuedInteractionRegular: return "\u{fa14}"
        case .quietBold: return "\u{fa15}"
        case .quietHoursPresenceBold: return "\u{fa16}"
        case .quietHoursPresenceFilled: return "\u{fa17}"
        case .quietHoursPresenceLight: return "\u{fa18}"
        case .quietHoursPresenceRegular: return "\u{fa19}"
        case .quietLight: return "\u{fa1a}"
        case .quietRegular: return "\u{fa1b}"
        case .radioButtonGroupBold: return "\u{fa1c}"
        case .radioButtonGroupLight: return "\u{fa1d}"
        case .radioButtonGroupRegular: return "\u{fa1e}"
        case .raiseHandBold: return "\u{fa1f}"
        case .raiseHandCircleFilled: return "\u{fa20}"
        case .raiseHandFilled: return "\u{fa21}"
        case .raiseHandLight: return "\u{fa22}"
        case .raiseHandRegular: return "\u{fa23}"
        case .ramBold: return "\u{fa24}"
        case .ramLight: return "\u{fa25}"
        case .ramRegular: return "\u{fa26}"
        case .reactionsBold: return "\u{fa27}"
        case .reactionsFilled: return "\u{fa28}"
        case .reactionsLight: return "\u{fa29}"
        case .reactionsRegular: return "\u{fa2a}"
        case .reactivateBold: return "\u{fa2b}"
        case .reactivateLight: return "\u{fa2c}"
        case .reactivateRegular: return "\u{fa2d}"
        case .realTimeTextBold: return "\u{fa2e}"
        case .realTimeTextFilled: return "\u{fa2f}"
        case .realTimeTextLight: return "\u{fa30}"
        case .realTimeTextRegular: return "\u{fa31}"
        case .receiveVoiceBold: return "\u{fa32}"
        case .receiveVoiceFilled: return "\u{fa33}"
        case .receiveVoiceLight: return "\u{fa34}"
        case .receiveVoiceRegular: return "\u{fa35}"
        case .recentsBold: return "\u{fa36}"
        case .recentsFilled: return "\u{fa37}"
        case .recentsLight: return "\u{fa38}"
        case .recentsPresenceBadgeFilled: return "\u{fa39}"
        case .recentsPresenceBold: return "\u{fa3a}"
        case .recentsPresenceFilled: return "\u{fa3b}"
        case .recentsPresenceLight: return "\u{fa3c}"
        case .recentsPresenceRegular: return "\u{fa3d}"
        case .recentsRegular: return "\u{fa3e}"
        case .recordActiveBadgeFilled: return "\u{fa3f}"
        case .recordActiveBold: return "\u{fa40}"
        case .recordActiveFilled: return "\u{fa41}"
        case .recordActiveLight: return "\u{fa42}"
        case .recordActiveRegular: return "\u{fa43}"
        case .recordBold: return "\u{fa44}"
        case .recordFilled: return "\u{fa45}"
        case .recordLight: return "\u{fa46}"
        case .recordPausedBadgeFilled: return "\u{fa47}"
        case .recordPausedBold: return "\u{fa48}"
        case .recordPausedFilled: return "\u{fa49}"
        case .recordPausedLight: return "\u{fa4a}"
        case .recordPausedRegular: return "\u{fa4b}"
        case .recordRegular: return "\u{fa4c}"
        case .recurringBold: return "\u{fa4d}"
        case .recurringLight: return "\u{fa4e}"
        case .recurringOffBold: return "\u{fa4f}"
        case .recurringOffLight: return "\u{fa50}"
        case .recurringOffRegular: return "\u{fa51}"
        case .recurringRegular: return "\u{fa52}"
        case .redoBold: return "\u{fa53}"
        case .redoLight: return "\u{fa54}"
        case .redoRegular: return "\u{fa55}"
        case .refreshBold: return "\u{fa56}"
        case .refreshLight: return "\u{fa57}"
        case .refreshRegular: return "\u{fa58}"
        case .remoteDesktopControlBold: return "\u{fa59}"
        case .remoteDesktopControlFilled: return "\u{fa5a}"
        case .remoteDesktopControlLight: return "\u{fa5b}"
        case .remoteDesktopControlRegular: return "\u{fa5c}"
        case .removeBold: return "\u{fa5d}"
        case .removeFilled: return "\u{fa5e}"
        case .removeLight: return "\u{fa5f}"
        case .removeRegular: return "\u{fa60}"
        case .replyBold: return "\u{fa61}"
        case .replyFilled: return "\u{fa62}"
        case .replyLight: return "\u{fa63}"
        case .replyListBold: return "\u{fa64}"
        case .replyListFilled: return "\u{fa65}"
        case .replyListLight: return "\u{fa66}"
        case .replyListRegular: return "\u{fa67}"
        case .replyPrivatelyBold: return "\u{fa68}"
        case .replyPrivatelyLight: return "\u{fa69}"
        case .replyPrivatelyRegular: return "\u{fa6a}"
        case .replyRegular: return "\u{fa6b}"
        case .resetBold: return "\u{fa6c}"
        case .resetLight: return "\u{fa6d}"
        case .resetRegular: return "\u{fa6e}"
        case .resizeCornerBold: return "\u{fa6f}"
        case .resizeCornerLight: return "\u{fa70}"
        case .resizeCornerRegular: return "\u{fa71}"
        case .responsiveMobileBold: return "\u{fa72}"
        case .responsiveMobileLight: return "\u{fa73}"
        case .responsiveMobileRegular: return "\u{fa74}"
        case .restartBold: return "\u{fa75}"
        case .restartLight: return "\u{fa76}"
        case .restartRegular: return "\u{fa77}"
        case .resumeInteractionBold: return "\u{fa78}"
        case .resumeInteractionFilled: return "\u{fa79}"
        case .resumeInteractionLight: return "\u{fa7a}"
        case .resumeInteractionRegular: return "\u{fa7b}"
        case .retrieveCallBold: return "\u{fa7c}"
        case .retrieveCallFilled: return "\u{fa7d}"
        case .retrieveCallLight: return "\u{fa7e}"
        case .retrieveCallRegular: return "\u{fa7f}"
        case .returnBold: return "\u{fa80}"
        case .returnLight: return "\u{fa81}"
        case .returnRegular: return "\u{fa82}"
        case .rewindTenSecBold: return "\u{fa83}"
        case .rewindTenSecLight: return "\u{fa84}"
        case .rewindTenSecRegular: return "\u{fa85}"
        case .ringtoneBold: return "\u{fa86}"
        case .ringtoneLight: return "\u{fa87}"
        case .ringtoneRegular: return "\u{fa88}"
        case .roomCalendarBold: return "\u{fa89}"
        case .roomCalendarLight: return "\u{fa8a}"
        case .roomCalendarRegular: return "\u{fa8b}"
        case .roomLightsBold: return "\u{fa8c}"
        case .roomLightsFilled: return "\u{fa8d}"
        case .roomLightsLight: return "\u{fa8e}"
        case .roomLightsRegular: return "\u{fa8f}"
        case .rotateContentBold: return "\u{fa90}"
        case .rotateContentFilled: return "\u{fa91}"
        case .rotateContentLight: return "\u{fa92}"
        case .rotateContentRegular: return "\u{fa93}"
        case .rssBold: return "\u{fa94}"
        case .rssFilled: return "\u{fa95}"
        case .rssLight: return "\u{fa96}"
        case .rssRegular: return "\u{fa97}"
        case .ruleBasedBold: return "\u{fa98}"
        case .ruleBasedFilled: return "\u{fa99}"
        case .ruleBasedLight: return "\u{fa9a}"
        case .ruleBasedRegular: return "\u{fa9b}"
        case .rulerBold: return "\u{fa9c}"
        case .rulerFilled: return "\u{fa9d}"
        case .rulerLight: return "\u{fa9e}"
        case .rulerRegular: return "\u{fa9f}"
        case .runningApplicationBold: return "\u{faa0}"
        case .runningApplicationFilled: return "\u{faa1}"
        case .runningApplicationLight: return "\u{faa2}"
        case .runningApplicationRegular: return "\u{faa3}"
        case .saveBold: return "\u{faa4}"
        case .saveLight: return "\u{faa5}"
        case .saveRegular: return "\u{faa6}"
        case .saveTranscriptBold: return "\u{faa7}"
        case .saveTranscriptFilled: return "\u{faa8}"
        case .saveTranscriptLight: return "\u{faa9}"
        case .saveTranscriptRegular: return "\u{faaa}"
        case .scanBold: return "\u{faab}"
        case .scanLight: return "\u{faac}"
        case .scanRegular: return "\u{faad}"
        case .scheduleAiBold: return "\u{faae}"
        case .scheduleAiLight: return "\u{faaf}"
        case .scheduleAiRegular: return "\u{fab0}"
        case .scheduleSendBold: return "\u{fab1}"
        case .scheduleSendFilled: return "\u{fab2}"
        case .scheduleSendLight: return "\u{fab3}"
        case .scheduleSendRegular: return "\u{fab4}"
        case .scheduleWinnerBold: return "\u{fab5}"
        case .scheduleWinnerFilled: return "\u{fab6}"
        case .scheduleWinnerLight: return "\u{fab7}"
        case .scheduleWinnerRegular: return "\u{fab8}"
        case .schedulerAvailableBold: return "\u{fab9}"
        case .schedulerAvailableLight: return "\u{faba}"
        case .schedulerAvailableRegular: return "\u{fabb}"
        case .schedulerNotWorkingHoursBold: return "\u{fabc}"
        case .schedulerNotWorkingHoursLight: return "\u{fabd}"
        case .schedulerNotWorkingHoursRegular: return "\u{fabe}"
        case .schedulerUnavailableBold: return "\u{fabf}"
        case .schedulerUnavailableLight: return "\u{fac0}"
        case .schedulerUnavailableRegular: return "\u{fac1}"
        case .schedulerUnknownBold: return "\u{fac2}"
        case .schedulerUnknownLight: return "\u{fac3}"
        case .schedulerUnknownRegular: return "\u{fac4}"
        case .screenshotBold: return "\u{fac5}"
        case .screenshotDocBold: return "\u{fac6}"
        case .screenshotDocFilled: return "\u{fac7}"
        case .screenshotDocLight: return "\u{fac8}"
        case .screenshotDocRegular: return "\u{fac9}"
        case .screenshotLight: return "\u{faca}"
        case .screenshotRegular: return "\u{facb}"
        case .searchAiBold: return "\u{facc}"
        case .searchAiLight: return "\u{facd}"
        case .searchAiRegular: return "\u{face}"
        case .searchBold: return "\u{facf}"
        case .searchFilled: return "\u{fad0}"
        case .searchLight: return "\u{fad1}"
        case .searchRegular: return "\u{fad2}"
        case .secondaryArrowBold: return "\u{fad3}"
        case .secondaryArrowLight: return "\u{fad4}"
        case .secondaryArrowRegular: return "\u{fad5}"
        case .secureCallLockBold: return "\u{fad6}"
        case .secureCallLockFilled: return "\u{fad7}"
        case .secureCallLockLight: return "\u{fad8}"
        case .secureCallLockRegular: return "\u{fad9}"
        case .secureCallShieldBold: return "\u{fada}"
        case .secureCallShieldFilled: return "\u{fadb}"
        case .secureCallShieldLight: return "\u{fadc}"
        case .secureCallShieldRegular: return "\u{fadd}"
        case .secureCircleBold: return "\u{fade}"
        case .secureCircleFilled: return "\u{fadf}"
        case .secureCircleLight: return "\u{fae0}"
        case .secureCircleRegular: return "\u{fae1}"
        case .secureLockBold: return "\u{fae2}"
        case .secureLockFilled: return "\u{fae3}"
        case .secureLockLight: return "\u{fae4}"
        case .secureLockRegular: return "\u{fae5}"
        case .segmentExcludeFilled: return "\u{fae6}"
        case .segmentFilterFilled: return "\u{fae7}"
        case .segmentIncludeFilled: return "\u{fae8}"
        case .selectAllBold: return "\u{fae9}"
        case .selectAllFilled: return "\u{faea}"
        case .selectAllLight: return "\u{faeb}"
        case .selectAllRegular: return "\u{faec}"
        case .selectionBold: return "\u{faed}"
        case .selectionFilled: return "\u{faee}"
        case .selectionLight: return "\u{faef}"
        case .selectionRegular: return "\u{faf0}"
        case .sendBold: return "\u{faf1}"
        case .sendDigitsBold: return "\u{faf2}"
        case .sendDigitsFilled: return "\u{faf3}"
        case .sendDigitsLight: return "\u{faf4}"
        case .sendDigitsRegular: return "\u{faf5}"
        case .sendFilled: return "\u{faf6}"
        case .sendLight: return "\u{faf7}"
        case .sendRegular: return "\u{faf8}"
        case .sendVoiceBold: return "\u{faf9}"
        case .sendVoiceFilled: return "\u{fafa}"
        case .sendVoiceLight: return "\u{fafb}"
        case .sendVoiceRegular: return "\u{fafc}"
        case .serverBold: return "\u{fafd}"
        case .serverErrorBold: return "\u{fafe}"
        case .serverErrorLight: return "\u{faff}"
        case .serverErrorRegular: return "\u{fb00}"
        case .serverLight: return "\u{fb01}"
        case .serverRegular: return "\u{fb02}"
        case .servicesBold: return "\u{fb03}"
        case .servicesLight: return "\u{fb04}"
        case .servicesRegular: return "\u{fb05}"
        case .setVariableBold: return "\u{fb06}"
        case .setVariableLight: return "\u{fb07}"
        case .setVariableRegular: return "\u{fb08}"
        case .settingsBold: return "\u{fb09}"
        case .settingsFilled: return "\u{fb0a}"
        case .settingsLight: return "\u{fb0b}"
        case .settingsRegular: return "\u{fb0c}"
        case .setupAssistantBold: return "\u{fb0d}"
        case .setupAssistantLight: return "\u{fb0e}"
        case .setupAssistantRegular: return "\u{fb0f}"
        case .sftpBold: return "\u{fb10}"
        case .sftpLight: return "\u{fb11}"
        case .sftpRegular: return "\u{fb12}"
        case .shapeCircleBold: return "\u{fb13}"
        case .shapeCircleFilled: return "\u{fb14}"
        case .shapeCircleLight: return "\u{fb15}"
        case .shapeCircleMdFilled: return "\u{fb16}"
        case .shapeCircleRegular: return "\u{fb17}"
        case .shapeCircleSmFilled: return "\u{fb18}"
        case .shapeDiagonalLineBold: return "\u{fb19}"
        case .shapeDiagonalLineLight: return "\u{fb1a}"
        case .shapeDiagonalLineRegular: return "\u{fb1b}"
        case .shapeDiamondBold: return "\u{fb1c}"
        case .shapeDiamondFilled: return "\u{fb1d}"
        case .shapeDiamondLight: return "\u{fb1e}"
        case .shapeDiamondRegular: return "\u{fb1f}"
        case .shapeOvalBold: return "\u{fb20}"
        case .shapeOvalLight: return "\u{fb21}"
        case .shapeOvalRegular: return "\u{fb22}"
        case .shapeSquareBold: return "\u{fb23}"
        case .shapeSquareFilled: return "\u{fb24}"
        case .shapeSquareLight: return "\u{fb25}"
        case .shapeSquareRegular: return "\u{fb26}"
        case .shapeTriangleBold: return "\u{fb27}"
        case .shapeTriangleFilled: return "\u{fb28}"
        case .shapeTriangleLight: return "\u{fb29}"
        case .shapeTriangleRegular: return "\u{fb2a}"
        case .shapesBold: return "\u{fb2b}"
        case .shapesFilled: return "\u{fb2c}"
        case .shapesLight: return "\u{fb2d}"
        case .shapesRegular: return "\u{fb2e}"
        case .shareCNativeAdrBold: return "\u{fb2f}"
        case .shareCNativeAdrFilled: return "\u{fb30}"
        case .shareCNativeAdrLight: return "\u{fb31}"
        case .shareCNativeAdrRegular: return "\u{fb32}"
        case .shareCNativeIphBold: return "\u{fb33}"
        case .shareCNativeIphLight: return "\u{fb34}"
        case .shareCNativeIphRegular: return "\u{fb35}"
        case .shareContentOnDeviceBold: return "\u{fb36}"
        case .shareContentOnDeviceLight: return "\u{fb37}"
        case .shareContentOnDeviceRegular: return "\u{fb38}"
        case .shareScreenAddBold: return "\u{fb39}"
        case .shareScreenAddLight: return "\u{fb3a}"
        case .shareScreenAddRegular: return "\u{fb3b}"
        case .shareScreenBadgeFilled: return "\u{fb3c}"
        case .shareScreenBold: return "\u{fb3d}"
        case .shareScreenFilled: return "\u{fb3e}"
        case .shareScreenLight: return "\u{fb3f}"
        case .shareScreenRegular: return "\u{fb40}"
        case .shareSpaceBold: return "\u{fb41}"
        case .shareSpaceLight: return "\u{fb42}"
        case .shareSpaceRegular: return "\u{fb43}"
        case .shieldBold: return "\u{fb44}"
        case .shieldLight: return "\u{fb45}"
        case .shieldRegular: return "\u{fb46}"
        case .shoppingCartBold: return "\u{fb47}"
        case .shoppingCartFilled: return "\u{fb48}"
        case .shoppingCartLight: return "\u{fb49}"
        case .shoppingCartRegular: return "\u{fb4a}"
        case .shortTextBoxBold: return "\u{fb4b}"
        case .shortTextBoxLight: return "\u{fb4c}"
        case .shortTextBoxRegular: return "\u{fb4d}"
        case .showBold: return "\u{fb4e}"
        case .showFilled: return "\u{fb4f}"
        case .showLight: return "\u{fb50}"
        case .showRegular: return "\u{fb51}"
        case .sidePanelBold: return "\u{fb52}"
        case .sidePanelFilled: return "\u{fb53}"
        case .sidePanelLight: return "\u{fb54}"
        case .sidePanelRegular: return "\u{fb55}"
        case .signInBold: return "\u{fb56}"
        case .signInFilled: return "\u{fb57}"
        case .signInForcedBold: return "\u{fb58}"
        case .signInForcedLight: return "\u{fb59}"
        case .signInForcedRegular: return "\u{fb5a}"
        case .signInLight: return "\u{fb5b}"
        case .signInRegular: return "\u{fb5c}"
        case .signLangIntBold: return "\u{fb5d}"
        case .signLangIntLight: return "\u{fb5e}"
        case .signLangIntRegular: return "\u{fb5f}"
        case .signOutBold: return "\u{fb60}"
        case .signOutLight: return "\u{fb61}"
        case .signOutRegular: return "\u{fb62}"
        case .signalFourBold: return "\u{fb63}"
        case .signalFourLight: return "\u{fb64}"
        case .signalFourRegular: return "\u{fb65}"
        case .signalOneBold: return "\u{fb66}"
        case .signalOneLight: return "\u{fb67}"
        case .signalOneRegular: return "\u{fb68}"
        case .signalThreeBold: return "\u{fb69}"
        case .signalThreeLight: return "\u{fb6a}"
        case .signalThreeRegular: return "\u{fb6b}"
        case .signalTwoBold: return "\u{fb6c}"
        case .signalTwoLight: return "\u{fb6d}"
        case .signalTwoRegular: return "\u{fb6e}"
        case .signalZeroBold: return "\u{fb6f}"
        case .signalZeroLight: return "\u{fb70}"
        case .signalZeroRegular: return "\u{fb71}"
        case .simplePromotionBold: return "\u{fb72}"
        case .simplePromotionLight: return "\u{fb73}"
        case .simplePromotionRegular: return "\u{fb74}"
        case .singleNumberReachBold: return "\u{fb75}"
        case .singleNumberReachLight: return "\u{fb76}"
        case .singleNumberReachRegular: return "\u{fb77}"
        case .sipRegistrationInProgressBold: return "\u{fb78}"
        case .sipRegistrationInProgressFilled: return "\u{fb79}"
        case .sipRegistrationInProgressLight: return "\u{fb7a}"
        case .sipRegistrationInProgressRegular: return "\u{fb7b}"
        case .skipBold: return "\u{fb7c}"
        case .skipBwBold: return "\u{fb7d}"
        case .skipBwFilled: return "\u{fb7e}"
        case .skipBwLight: return "\u{fb7f}"
        case .skipBwRegular: return "\u{fb80}"
        case .skipFwBold: return "\u{fb81}"
        case .skipFwFilled: return "\u{fb82}"
        case .skipFwLight: return "\u{fb83}"
        case .skipFwRegular: return "\u{fb84}"
        case .skipLight: return "\u{fb85}"
        case .skipRegular: return "\u{fb86}"
        case .smartAudioBold: return "\u{fb87}"
        case .smartAudioLight: return "\u{fb88}"
        case .smartAudioRegular: return "\u{fb89}"
        case .smartReplyBold: return "\u{fb8a}"
        case .smartReplyLight: return "\u{fb8b}"
        case .smartReplyRegular: return "\u{fb8c}"
        case .smsFilled: return "\u{fb8d}"
        case .smsInboundBold: return "\u{fb8e}"
        case .smsInboundLight: return "\u{fb8f}"
        case .smsInboundRegular: return "\u{fb90}"
        case .smsMessageBold: return "\u{fb91}"
        case .smsMessageFilled: return "\u{fb92}"
        case .smsMessageLight: return "\u{fb93}"
        case .smsMessageOutgoingBold: return "\u{fb94}"
        case .smsMessageOutgoingFilled: return "\u{fb95}"
        case .smsMessageOutgoingLight: return "\u{fb96}"
        case .smsMessageOutgoingRegular: return "\u{fb97}"
        case .smsMessageRegular: return "\u{fb98}"
        case .smsMessageStartBold: return "\u{fb99}"
        case .smsMessageStartFilled: return "\u{fb9a}"
        case .smsMessageStartLight: return "\u{fb9b}"
        case .smsMessageStartRegular: return "\u{fb9c}"
        case .smsOutgoingFilled: return "\u{fb9d}"
        case .smsUnreadBold: return "\u{fb9e}"
        case .smsUnreadLight: return "\u{fb9f}"
        case .smsUnreadRegular: return "\u{fba0}"
        case .sortAscendingBold: return "\u{fba1}"
        case .sortAscendingLight: return "\u{fba2}"
        case .sortAscendingRegular: return "\u{fba3}"
        case .sortDescendingBold: return "\u{fba4}"
        case .sortDescendingLight: return "\u{fba5}"
        case .sortDescendingRegular: return "\u{fba6}"
        case .soundDefaultBold: return "\u{fba7}"
        case .soundDefaultLight: return "\u{fba8}"
        case .soundDefaultRegular: return "\u{fba9}"
        case .sparkleBold: return "\u{fbaa}"
        case .sparkleFilled: return "\u{fbab}"
        case .sparkleLight: return "\u{fbac}"
        case .sparkleRegular: return "\u{fbad}"
        case .speakerBold: return "\u{fbae}"
        case .speakerDisconnectedBold: return "\u{fbaf}"
        case .speakerDisconnectedFilled: return "\u{fbb0}"
        case .speakerDisconnectedLight: return "\u{fbb1}"
        case .speakerDisconnectedRegular: return "\u{fbb2}"
        case .speakerFilled: return "\u{fbb3}"
        case .speakerLight: return "\u{fbb4}"
        case .speakerMutedBold: return "\u{fbb5}"
        case .speakerMutedFilled: return "\u{fbb6}"
        case .speakerMutedLight: return "\u{fbb7}"
        case .speakerMutedRegular: return "\u{fbb8}"
        case .speakerOffBold: return "\u{fbb9}"
        case .speakerOffFilled: return "\u{fbba}"
        case .speakerOffLight: return "\u{fbbb}"
        case .speakerOffRegular: return "\u{fbbc}"
        case .speakerOnBold: return "\u{fbbd}"
        case .speakerOnLight: return "\u{fbbe}"
        case .speakerOnRegular: return "\u{fbbf}"
        case .speakerRegular: return "\u{fbc0}"
        case .speakerTurnDownBold: return "\u{fbc1}"
        case .speakerTurnDownFilled: return "\u{fbc2}"
        case .speakerTurnDownLight: return "\u{fbc3}"
        case .speakerTurnDownRegular: return "\u{fbc4}"
        case .speakerTurnUpBold: return "\u{fbc5}"
        case .speakerTurnUpFilled: return "\u{fbc6}"
        case .speakerTurnUpLight: return "\u{fbc7}"
        case .speakerTurnUpRegular: return "\u{fbc8}"
        case .speechAiBold: return "\u{fbc9}"
        case .speechAiFilled: return "\u{fbca}"
        case .speechAiLight: return "\u{fbcb}"
        case .speechAiRegular: return "\u{fbcc}"
        case .speedDialBold: return "\u{fbcd}"
        case .speedDialFilled: return "\u{fbce}"
        case .speedDialLight: return "\u{fbcf}"
        case .speedDialRegular: return "\u{fbd0}"
        case .spellCheckerBold: return "\u{fbd1}"
        case .spellCheckerLight: return "\u{fbd2}"
        case .spellCheckerRegular: return "\u{fbd3}"
        case .splitViewBold: return "\u{fbd4}"
        case .splitViewLight: return "\u{fbd5}"
        case .splitViewRegular: return "\u{fbd6}"
        case .stackedAreaChartBold: return "\u{fbd7}"
        case .stackedAreaChartFilled: return "\u{fbd8}"
        case .stackedAreaChartFullBold: return "\u{fbd9}"
        case .stackedAreaChartFullFilled: return "\u{fbda}"
        case .stackedAreaChartFullLight: return "\u{fbdb}"
        case .stackedAreaChartFullRegular: return "\u{fbdc}"
        case .stackedAreaChartLight: return "\u{fbdd}"
        case .stackedAreaChartRegular: return "\u{fbde}"
        case .stackedBarChartBold: return "\u{fbdf}"
        case .stackedBarChartFilled: return "\u{fbe0}"
        case .stackedBarChartFullBold: return "\u{fbe1}"
        case .stackedBarChartFullFilled: return "\u{fbe2}"
        case .stackedBarChartFullLight: return "\u{fbe3}"
        case .stackedBarChartFullRegular: return "\u{fbe4}"
        case .stackedBarChartLight: return "\u{fbe5}"
        case .stackedBarChartRegular: return "\u{fbe6}"
        case .startChatBold: return "\u{fbe7}"
        case .startChatLight: return "\u{fbe8}"
        case .startChatRegular: return "\u{fbe9}"
        case .stethoscopeBold: return "\u{fbea}"
        case .stethoscopeLight: return "\u{fbeb}"
        case .stethoscopeRegular: return "\u{fbec}"
        case .stickersBold: return "\u{fbed}"
        case .stickersLight: return "\u{fbee}"
        case .stickersRegular: return "\u{fbef}"
        case .stickiesBold: return "\u{fbf0}"
        case .stickiesLight: return "\u{fbf1}"
        case .stickiesRegular: return "\u{fbf2}"
        case .stopBold: return "\u{fbf3}"
        case .stopCircleBold: return "\u{fbf4}"
        case .stopCircleFilled: return "\u{fbf5}"
        case .stopCircleLight: return "\u{fbf6}"
        case .stopCircleRegular: return "\u{fbf7}"
        case .stopContentShareBold: return "\u{fbf8}"
        case .stopContentShareLight: return "\u{fbf9}"
        case .stopContentShareRegular: return "\u{fbfa}"
        case .stopFilled: return "\u{fbfb}"
        case .stopLight: return "\u{fbfc}"
        case .stopRegular: return "\u{fbfd}"
        case .storedInfoBold: return "\u{fbfe}"
        case .storedInfoFilled: return "\u{fbff}"
        case .storedInfoLight: return "\u{fc00}"
        case .storedInfoRegular: return "\u{fc01}"
        case .streamingBold: return "\u{fc02}"
        case .streamingLight: return "\u{fc03}"
        case .streamingRegular: return "\u{fc04}"
        case .strikethroughBold: return "\u{fc05}"
        case .strikethroughFilled: return "\u{fc06}"
        case .strikethroughLight: return "\u{fc07}"
        case .strikethroughRegular: return "\u{fc08}"
        case .studioModeBold: return "\u{fc09}"
        case .studioModeLight: return "\u{fc0a}"
        case .studioModeRegular: return "\u{fc0b}"
        case .subscriptBold: return "\u{fc0c}"
        case .subscriptLight: return "\u{fc0d}"
        case .subscriptRegular: return "\u{fc0e}"
        case .summarizeAiBold: return "\u{fc0f}"
        case .summarizeAiLight: return "\u{fc10}"
        case .summarizeAiRegular: return "\u{fc11}"
        case .superscriptBold: return "\u{fc12}"
        case .superscriptLight: return "\u{fc13}"
        case .superscriptRegular: return "\u{fc14}"
        case .surveyBold: return "\u{fc15}"
        case .surveyFilled: return "\u{fc16}"
        case .surveyLight: return "\u{fc17}"
        case .surveyRegular: return "\u{fc18}"
        case .sxEightyCodecBold: return "\u{fc19}"
        case .sxEightyCodecLight: return "\u{fc1a}"
        case .sxEightyCodecRegular: return "\u{fc1b}"
        case .sxTenBold: return "\u{fc1c}"
        case .sxTenLight: return "\u{fc1d}"
        case .sxTenRegular: return "\u{fc1e}"
        case .sxTwentyBold: return "\u{fc1f}"
        case .sxTwentyLight: return "\u{fc20}"
        case .sxTwentyRegular: return "\u{fc21}"
        case .tableBold: return "\u{fc22}"
        case .tableExtenderBold: return "\u{fc23}"
        case .tableExtenderFilled: return "\u{fc24}"
        case .tableExtenderLight: return "\u{fc25}"
        case .tableExtenderRegular: return "\u{fc26}"
        case .tableLight: return "\u{fc27}"
        case .tableRegular: return "\u{fc28}"
        case .tabletBold: return "\u{fc29}"
        case .tabletLight: return "\u{fc2a}"
        case .tabletRegular: return "\u{fc2b}"
        case .tabsBold: return "\u{fc2c}"
        case .tabsLight: return "\u{fc2d}"
        case .tabsRegular: return "\u{fc2e}"
        case .tagBold: return "\u{fc2f}"
        case .tagLight: return "\u{fc30}"
        case .tagRegular: return "\u{fc31}"
        case .tapBold: return "\u{fc32}"
        case .tapFilled: return "\u{fc33}"
        case .tapLight: return "\u{fc34}"
        case .tapRegular: return "\u{fc35}"
        case .telepresenceAlertBold: return "\u{fc36}"
        case .telepresenceAlertLight: return "\u{fc37}"
        case .telepresenceAlertMutedBold: return "\u{fc38}"
        case .telepresenceAlertMutedLight: return "\u{fc39}"
        case .telepresenceAlertMutedRegular: return "\u{fc3a}"
        case .telepresenceAlertRegular: return "\u{fc3b}"
        case .telepresenceBold: return "\u{fc3c}"
        case .telepresenceIxFiveThousandBold: return "\u{fc3d}"
        case .telepresenceIxFiveThousandLight: return "\u{fc3e}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc3f}"
        case .telepresenceLight: return "\u{fc40}"
        case .telepresenceMutedBold: return "\u{fc41}"
        case .telepresenceMutedLight: return "\u{fc42}"
        case .telepresenceMutedRegular: return "\u{fc43}"
        case .telepresencePrivateBold: return "\u{fc44}"
        case .telepresencePrivateLight: return "\u{fc45}"
        case .telepresencePrivateRegular: return "\u{fc46}"
        case .telepresenceRegular: return "\u{fc47}"
        case .temperatureBold: return "\u{fc48}"
        case .temperatureLight: return "\u{fc49}"
        case .temperatureRegular: return "\u{fc4a}"
        case .tenantBold: return "\u{fc4b}"
        case .tenantFilled: return "\u{fc4c}"
        case .tenantLight: return "\u{fc4d}"
        case .tenantRegular: return "\u{fc4e}"
        case .testTubeBold: return "\u{fc4f}"
        case .testTubeFilled: return "\u{fc50}"
        case .testTubeLight: return "\u{fc51}"
        case .testTubeRegular: return "\u{fc52}"
        case .textAlignCenterBold: return "\u{fc53}"
        case .textAlignCenterFilled: return "\u{fc54}"
        case .textAlignCenterLight: return "\u{fc55}"
        case .textAlignCenterRegular: return "\u{fc56}"
        case .textAlignLeftBold: return "\u{fc57}"
        case .textAlignLeftFilled: return "\u{fc58}"
        case .textAlignLeftLight: return "\u{fc59}"
        case .textAlignLeftRegular: return "\u{fc5a}"
        case .textAlignRightBold: return "\u{fc5b}"
        case .textAlignRightFilled: return "\u{fc5c}"
        case .textAlignRightLight: return "\u{fc5d}"
        case .textAlignRightRegular: return "\u{fc5e}"
        case .textBold: return "\u{fc5f}"
        case .textBoxCursorLight: return "\u{fc60}"
        case .textCodeBlockBold: return "\u{fc61}"
        case .textCodeBlockLight: return "\u{fc62}"
        case .textCodeBlockRegular: return "\u{fc63}"
        case .textHighlightBold: return "\u{fc64}"
        case .textHighlightFilled: return "\u{fc65}"
        case .textHighlightLight: return "\u{fc66}"
        case .textHighlightRegular: return "\u{fc67}"
        case .textLight: return "\u{fc68}"
        case .textRegular: return "\u{fc69}"
        case .textShortBold: return "\u{fc6a}"
        case .textShortLight: return "\u{fc6b}"
        case .textShortRegular: return "\u{fc6c}"
        case .threeColumnBold: return "\u{fc6d}"
        case .threeColumnLight: return "\u{fc6e}"
        case .threeColumnRegular: return "\u{fc6f}"
        case .threeDObjectBold: return "\u{fc70}"
        case .threeDObjectLight: return "\u{fc71}"
        case .threeDObjectRegular: return "\u{fc72}"
        case .timeExclusionBold: return "\u{fc73}"
        case .timeExclusionLight: return "\u{fc74}"
        case .timeExclusionRegular: return "\u{fc75}"
        case .timezoneBold: return "\u{fc76}"
        case .timezoneFilled: return "\u{fc77}"
        case .timezoneLight: return "\u{fc78}"
        case .timezoneRegular: return "\u{fc79}"
        case .tooFastBold: return "\u{fc7a}"
        case .tooFastLight: return "\u{fc7b}"
        case .tooFastRegular: return "\u{fc7c}"
        case .tooSlowBold: return "\u{fc7d}"
        case .tooSlowLight: return "\u{fc7e}"
        case .tooSlowRegular: return "\u{fc7f}"
        case .toolsBold: return "\u{fc80}"
        case .toolsFilled: return "\u{fc81}"
        case .toolsLight: return "\u{fc82}"
        case .toolsRegular: return "\u{fc83}"
        case .touchTenBold: return "\u{fc84}"
        case .touchTenLight: return "\u{fc85}"
        case .touchTenRegular: return "\u{fc86}"
        case .trackingBold: return "\u{fc87}"
        case .trackingFilled: return "\u{fc88}"
        case .trackingLight: return "\u{fc89}"
        case .trackingRegular: return "\u{fc8a}"
        case .transcriptBold: return "\u{fc8b}"
        case .transcriptFilled: return "\u{fc8c}"
        case .transcriptLight: return "\u{fc8d}"
        case .transcriptRegular: return "\u{fc8e}"
        case .translateBold: return "\u{fc8f}"
        case .translateLight: return "\u{fc90}"
        case .translateRegular: return "\u{fc91}"
        case .translateUndoBold: return "\u{fc92}"
        case .translateUndoLight: return "\u{fc93}"
        case .translateUndoRegular: return "\u{fc94}"
        case .trendingBold: return "\u{fc95}"
        case .trendingDownBold: return "\u{fc96}"
        case .trendingDownFilled: return "\u{fc97}"
        case .trendingDownLight: return "\u{fc98}"
        case .trendingDownRegular: return "\u{fc99}"
        case .trendingFilled: return "\u{fc9a}"
        case .trendingLight: return "\u{fc9b}"
        case .trendingRegular: return "\u{fc9c}"
        case .trimBold: return "\u{fc9d}"
        case .trimLight: return "\u{fc9e}"
        case .trimRegular: return "\u{fc9f}"
        case .twoColumnBold: return "\u{fca0}"
        case .twoColumnLight: return "\u{fca1}"
        case .twoColumnRegular: return "\u{fca2}"
        case .twoWayVoiceStreamBold: return "\u{fca3}"
        case .twoWayVoiceStreamFilled: return "\u{fca4}"
        case .twoWayVoiceStreamLight: return "\u{fca5}"
        case .twoWayVoiceStreamRegular: return "\u{fca6}"
        case .ucmCloudBold: return "\u{fca7}"
        case .ucmCloudLight: return "\u{fca8}"
        case .ucmCloudRegular: return "\u{fca9}"
        case .unblockBold: return "\u{fcaa}"
        case .unblockFilled: return "\u{fcab}"
        case .unblockLight: return "\u{fcac}"
        case .unblockRegular: return "\u{fcad}"
        case .underlineBold: return "\u{fcae}"
        case .underlineFilled: return "\u{fcaf}"
        case .underlineLight: return "\u{fcb0}"
        case .underlineRegular: return "\u{fcb1}"
        case .undoBold: return "\u{fcb2}"
        case .undoLight: return "\u{fcb3}"
        case .undoRegular: return "\u{fcb4}"
        case .unlinkBold: return "\u{fcb5}"
        case .unlinkLight: return "\u{fcb6}"
        case .unlinkRegular: return "\u{fcb7}"
        case .unreadBold: return "\u{fcb8}"
        case .unreadFilled: return "\u{fcb9}"
        case .unreadLight: return "\u{fcba}"
        case .unreadRegular: return "\u{fcbb}"
        case .unsecureUnlockedBold: return "\u{fcbc}"
        case .unsecureUnlockedFilled: return "\u{fcbd}"
        case .unsecureUnlockedLight: return "\u{fcbe}"
        case .unsecureUnlockedRegular: return "\u{fcbf}"
        case .unsortedBold: return "\u{fcc0}"
        case .unsortedLight: return "\u{fcc1}"
        case .unsortedRegular: return "\u{fcc2}"
        case .updateFileShareBold: return "\u{fcc3}"
        case .updateFileShareLight: return "\u{fcc4}"
        case .updateFileShareRegular: return "\u{fcc5}"
        case .uploadBold: return "\u{fcc6}"
        case .uploadImageBold: return "\u{fcc7}"
        case .uploadImageLight: return "\u{fcc8}"
        case .uploadImageRegular: return "\u{fcc9}"
        case .uploadLight: return "\u{fcca}"
        case .uploadRegular: return "\u{fccb}"
        case .urgentVoicemailBold: return "\u{fccc}"
        case .urgentVoicemailFilled: return "\u{fccd}"
        case .usbBold: return "\u{fcce}"
        case .usbHeadsetBold: return "\u{fccf}"
        case .usbHeadsetLight: return "\u{fcd0}"
        case .usbHeadsetMutedBold: return "\u{fcd1}"
        case .usbHeadsetMutedLight: return "\u{fcd2}"
        case .usbHeadsetMutedRegular: return "\u{fcd3}"
        case .usbHeadsetRegular: return "\u{fcd4}"
        case .usbLight: return "\u{fcd5}"
        case .usbRegular: return "\u{fcd6}"
        case .userBold: return "\u{fcd7}"
        case .userDeactivateBold: return "\u{fcd8}"
        case .userDeactivateLight: return "\u{fcd9}"
        case .userDeactivateRegular: return "\u{fcda}"
        case .userFilled: return "\u{fcdb}"
        case .userLight: return "\u{fcdc}"
        case .userRegular: return "\u{fcdd}"
        case .userSecurityStatusBold: return "\u{fcde}"
        case .userSecurityStatusFilled: return "\u{fcdf}"
        case .userSecurityStatusLight: return "\u{fce0}"
        case .userSecurityStatusRegular: return "\u{fce1}"
        case .videoBlurBold: return "\u{fce2}"
        case .videoBlurFilled: return "\u{fce3}"
        case .videoBlurLight: return "\u{fce4}"
        case .videoBlurRegular: return "\u{fce5}"
        case .videoBold: return "\u{fce6}"
        case .videoEffectBold: return "\u{fce7}"
        case .videoEffectFilled: return "\u{fce8}"
        case .videoEffectLight: return "\u{fce9}"
        case .videoEffectRegular: return "\u{fcea}"
        case .videoFilled: return "\u{fceb}"
        case .videoLayoutBold: return "\u{fcec}"
        case .videoLayoutCustomBold: return "\u{fced}"
        case .videoLayoutCustomFilled: return "\u{fcee}"
        case .videoLayoutCustomLight: return "\u{fcef}"
        case .videoLayoutCustomRegular: return "\u{fcf0}"
        case .videoLayoutEqualBold: return "\u{fcf1}"
        case .videoLayoutEqualDualBold: return "\u{fcf2}"
        case .videoLayoutEqualDualLight: return "\u{fcf3}"
        case .videoLayoutEqualDualRegular: return "\u{fcf4}"
        case .videoLayoutEqualFilled: return "\u{fcf5}"
        case .videoLayoutEqualLight: return "\u{fcf6}"
        case .videoLayoutEqualRegular: return "\u{fcf7}"
        case .videoLayoutFilled: return "\u{fcf8}"
        case .videoLayoutLight: return "\u{fcf9}"
        case .videoLayoutOverlayBold: return "\u{fcfa}"
        case .videoLayoutOverlayFilled: return "\u{fcfb}"
        case .videoLayoutOverlayLight: return "\u{fcfc}"
        case .videoLayoutOverlayRegular: return "\u{fcfd}"
        case .videoLayoutPresentationBold: return "\u{fcfe}"
        case .videoLayoutPresentationFilled: return "\u{fcff}"
        case .videoLayoutPresentationLight: return "\u{fd00}"
        case .videoLayoutPresentationRegular: return "\u{fd01}"
        case .videoLayoutPresenterDominantBold: return "\u{fd02}"
        case .videoLayoutPresenterDominantLight: return "\u{fd03}"
        case .videoLayoutPresenterDominantRegular: return "\u{fd04}"
        case .videoLayoutProminentBold: return "\u{fd05}"
        case .videoLayoutProminentFilled: return "\u{fd06}"
        case .videoLayoutProminentLight: return "\u{fd07}"
        case .videoLayoutProminentRegular: return "\u{fd08}"
        case .videoLayoutRegular: return "\u{fd09}"
        case .videoLayoutShareDominantBold: return "\u{fd0a}"
        case .videoLayoutShareDominantLight: return "\u{fd0b}"
        case .videoLayoutShareDominantRegular: return "\u{fd0c}"
        case .videoLayoutSingleBold: return "\u{fd0d}"
        case .videoLayoutSingleFilled: return "\u{fd0e}"
        case .videoLayoutSingleLight: return "\u{fd0f}"
        case .videoLayoutSingleRegular: return "\u{fd10}"
        case .videoLayoutSpeakerBold: return "\u{fd11}"
        case .videoLayoutSpeakerFilled: return "\u{fd12}"
        case .videoLayoutSpeakerLight: return "\u{fd13}"
        case .videoLayoutSpeakerRegular: return "\u{fd14}"
        case .videoLayoutStackBold: return "\u{fd15}"
        case .videoLayoutStackFilled: return "\u{fd16}"
        case .videoLayoutStackLight: return "\u{fd17}"
        case .videoLayoutStackRegular: return "\u{fd18}"
        case .videoLayoutVideoDominantBold: return "\u{fd19}"
        case .videoLayoutVideoDominantFilled: return "\u{fd1a}"
        case .videoLayoutVideoDominantLight: return "\u{fd1b}"
        case .videoLayoutVideoDominantRegular: return "\u{fd1c}"
        case .videoLight: return "\u{fd1d}"
        case .videoPlusBold: return "\u{fd1e}"
        case .videoPlusFilled: return "\u{fd1f}"
        case .videoPlusLight: return "\u{fd20}"
        case .videoPlusRegular: return "\u{fd21}"
        case .videoRegular: return "\u{fd22}"
        case .videoSpeakerTrackBold: return "\u{fd23}"
        case .videoSpeakerTrackFilled: return "\u{fd24}"
        case .videoSpeakerTrackLight: return "\u{fd25}"
        case .videoSpeakerTrackRegular: return "\u{fd26}"
        case .viewAllBold: return "\u{fd27}"
        case .viewAllLight: return "\u{fd28}"
        case .viewAllRegular: return "\u{fd29}"
        case .viewListBold: return "\u{fd2a}"
        case .viewListFilled: return "\u{fd2b}"
        case .viewListLight: return "\u{fd2c}"
        case .viewListRegular: return "\u{fd2d}"
        case .viewStackedBold: return "\u{fd2e}"
        case .viewStackedFilled: return "\u{fd2f}"
        case .viewStackedLight: return "\u{fd30}"
        case .viewStackedRegular: return "\u{fd31}"
        case .viewThumbnailBold: return "\u{fd32}"
        case .viewThumbnailFilled: return "\u{fd33}"
        case .viewThumbnailLight: return "\u{fd34}"
        case .viewThumbnailRegular: return "\u{fd35}"
        case .visionproBold: return "\u{fd36}"
        case .visionproFilled: return "\u{fd37}"
        case .visionproLight: return "\u{fd38}"
        case .visionproMoveCallInBold: return "\u{fd39}"
        case .visionproMoveCallInFilled: return "\u{fd3a}"
        case .visionproMoveCallInLight: return "\u{fd3b}"
        case .visionproMoveCallInOutBold: return "\u{fd3c}"
        case .visionproMoveCallInOutFilled: return "\u{fd3d}"
        case .visionproMoveCallInOutLight: return "\u{fd3e}"
        case .visionproMoveCallInOutRegular: return "\u{fd3f}"
        case .visionproMoveCallInRegular: return "\u{fd40}"
        case .visionproMoveCallOutBold: return "\u{fd41}"
        case .visionproMoveCallOutFilled: return "\u{fd42}"
        case .visionproMoveCallOutLight: return "\u{fd43}"
        case .visionproMoveCallOutRegular: return "\u{fd44}"
        case .visionproRegular: return "\u{fd45}"
        case .voiceClipBold: return "\u{fd46}"
        case .voiceClipFilled: return "\u{fd47}"
        case .voiceClipLight: return "\u{fd48}"
        case .voiceClipRegular: return "\u{fd49}"
        case .voicemailBold: return "\u{fd4a}"
        case .voicemailFilled: return "\u{fd4b}"
        case .voicemailLight: return "\u{fd4c}"
        case .voicemailRegular: return "\u{fd4d}"
        case .vpnBold: return "\u{fd4e}"
        case .vpnFilled: return "\u{fd4f}"
        case .vpnLight: return "\u{fd50}"
        case .vpnRegular: return "\u{fd51}"
        case .vscBold: return "\u{fd52}"
        case .vscLight: return "\u{fd53}"
        case .vscRegular: return "\u{fd54}"
        case .waffleMenuBold: return "\u{fd55}"
        case .waffleMenuLight: return "\u{fd56}"
        case .waffleMenuRegular: return "\u{fd57}"
        case .waitingRoomBold: return "\u{fd58}"
        case .waitingRoomFilled: return "\u{fd59}"
        case .waitingRoomLight: return "\u{fd5a}"
        case .waitingRoomRegular: return "\u{fd5b}"
        case .wallpaperBold: return "\u{fd5c}"
        case .wallpaperLight: return "\u{fd5d}"
        case .wallpaperRegular: return "\u{fd5e}"
        case .warningBadgeFilled: return "\u{fd5f}"
        case .warningBold: return "\u{fd60}"
        case .warningFilled: return "\u{fd61}"
        case .warningLight: return "\u{fd62}"
        case .warningRegular: return "\u{fd63}"
        case .webexBoardBold: return "\u{fd64}"
        case .webexBoardLight: return "\u{fd65}"
        case .webexBoardRegular: return "\u{fd66}"
        case .webexCodecPlusBold: return "\u{fd67}"
        case .webexCodecPlusLight: return "\u{fd68}"
        case .webexCodecPlusRegular: return "\u{fd69}"
        case .webexDeskCameraBold: return "\u{fd6a}"
        case .webexDeskCameraLight: return "\u{fd6b}"
        case .webexDeskCameraRegular: return "\u{fd6c}"
        case .webexHelixBold: return "\u{fd6d}"
        case .webexHelixLight: return "\u{fd6e}"
        case .webexHelixRegular: return "\u{fd6f}"
        case .webexMeetingsBold: return "\u{fd70}"
        case .webexMeetingsFilled: return "\u{fd71}"
        case .webexMeetingsLight: return "\u{fd72}"
        case .webexMeetingsRegular: return "\u{fd73}"
        case .webexQuadCameraBold: return "\u{fd74}"
        case .webexQuadCameraLight: return "\u{fd75}"
        case .webexQuadCameraRegular: return "\u{fd76}"
        case .webexRoomKitBold: return "\u{fd77}"
        case .webexRoomKitLight: return "\u{fd78}"
        case .webexRoomKitPlusBold: return "\u{fd79}"
        case .webexRoomKitPlusLight: return "\u{fd7a}"
        case .webexRoomKitPlusRegular: return "\u{fd7b}"
        case .webexRoomKitRegular: return "\u{fd7c}"
        case .webexShareBold: return "\u{fd7d}"
        case .webexShareLight: return "\u{fd7e}"
        case .webexShareRegular: return "\u{fd7f}"
        case .webexTeamsBold: return "\u{fd80}"
        case .webexTeamsFilled: return "\u{fd81}"
        case .webexTeamsLight: return "\u{fd82}"
        case .webexTeamsNewBold: return "\u{fd83}"
        case .webexTeamsNewFilled: return "\u{fd84}"
        case .webexTeamsNewLight: return "\u{fd85}"
        case .webexTeamsNewRegular: return "\u{fd86}"
        case .webexTeamsRegular: return "\u{fd87}"
        case .webexTeamsRemoveBold: return "\u{fd88}"
        case .webexTeamsRemoveLight: return "\u{fd89}"
        case .webexTeamsRemoveRegular: return "\u{fd8a}"
        case .webhookBold: return "\u{fd8b}"
        case .webhookLight: return "\u{fd8c}"
        case .webhookRegular: return "\u{fd8d}"
        case .webinarBold: return "\u{fd8e}"
        case .webinarFilled: return "\u{fd8f}"
        case .webinarLight: return "\u{fd90}"
        case .webinarRegular: return "\u{fd91}"
        case .weeklyRecurringScheduleBold: return "\u{fd92}"
        case .weeklyRecurringScheduleLight: return "\u{fd93}"
        case .weeklyRecurringScheduleRegular: return "\u{fd94}"
        case .whisperAnnouncementBold: return "\u{fd95}"
        case .whisperAnnouncementFilled: return "\u{fd96}"
        case .whisperAnnouncementLight: return "\u{fd97}"
        case .whisperAnnouncementRegular: return "\u{fd98}"
        case .whisperCoachBold: return "\u{fd99}"
        case .whisperCoachFilled: return "\u{fd9a}"
        case .whisperCoachLight: return "\u{fd9b}"
        case .whisperCoachRegular: return "\u{fd9c}"
        case .whiteboardBold: return "\u{fd9d}"
        case .whiteboardContentBold: return "\u{fd9e}"
        case .whiteboardContentFilled: return "\u{fd9f}"
        case .whiteboardContentLight: return "\u{fda0}"
        case .whiteboardContentRegular: return "\u{fda1}"
        case .whiteboardFilled: return "\u{fda2}"
        case .whiteboardLight: return "\u{fda3}"
        case .whiteboardRegular: return "\u{fda4}"
        case .widgetBold: return "\u{fda5}"
        case .widgetFilled: return "\u{fda6}"
        case .widgetLight: return "\u{fda7}"
        case .widgetRegular: return "\u{fda8}"
        case .wifiBold: return "\u{fda9}"
        case .wifiErrorBold: return "\u{fdaa}"
        case .wifiErrorLight: return "\u{fdab}"
        case .wifiErrorRegular: return "\u{fdac}"
        case .wifiLight: return "\u{fdad}"
        case .wifiRegular: return "\u{fdae}"
        case .wifiSignalGoodBold: return "\u{fdaf}"
        case .wifiSignalGoodLight: return "\u{fdb0}"
        case .wifiSignalGoodRegular: return "\u{fdb1}"
        case .wifiSignalPoorBold: return "\u{fdb2}"
        case .wifiSignalPoorLight: return "\u{fdb3}"
        case .wifiSignalPoorRegular: return "\u{fdb4}"
        case .wifiSignalUnstableBold: return "\u{fdb5}"
        case .wifiSignalUnstableLight: return "\u{fdb6}"
        case .wifiSignalUnstableRegular: return "\u{fdb7}"
        case .windowCornerScrubBold: return "\u{fdb8}"
        case .windowCornerScrubLight: return "\u{fdb9}"
        case .windowCornerScrubRegular: return "\u{fdba}"
        case .windowRightCornerScrubBold: return "\u{fdbb}"
        case .windowRightCornerScrubLight: return "\u{fdbc}"
        case .windowRightCornerScrubRegular: return "\u{fdbd}"
        case .windowVerticalScrubBold: return "\u{fdbe}"
        case .windowVerticalScrubLight: return "\u{fdbf}"
        case .windowVerticalScrubRegular: return "\u{fdc0}"
        case .workflowDeploymentsBold: return "\u{fdc1}"
        case .workflowDeploymentsFilled: return "\u{fdc2}"
        case .workflowDeploymentsLight: return "\u{fdc3}"
        case .workflowDeploymentsRegular: return "\u{fdc4}"
        case .workphoneBold: return "\u{fdc5}"
        case .workphoneLight: return "\u{fdc6}"
        case .workphoneRegular: return "\u{fdc7}"
        case .zoomInBold: return "\u{fdc8}"
        case .zoomInLight: return "\u{fdc9}"
        case .zoomInRegular: return "\u{fdca}"
        case .zoomOutBold: return "\u{fdcb}"
        case .zoomOutLight: return "\u{fdcc}"
        case .zoomOutRegular: return "\u{fdcd}"
    ...
    public var filename: String {
        ...
        case .colorSpeechAiBold: return "color-speech-ai-bold"
        case .colorSpeechAiFilled: return "color-speech-ai-filled"
        case .colorSpeechAiLight: return "color-speech-ai-light"
        case .colorSpeechAiRegular: return "color-speech-ai-regular"
        ...
        case .dialpadHideBold: return "dialpad-hide-bold"
        case .dialpadHideFilled: return "dialpad-hide-filled"
        case .dialpadHideLight: return "dialpad-hide-light"
        case .dialpadHideRegular: return "dialpad-hide-regular"
        ...
        case .dockWindowClosedBold: return "dock-window-closed-bold"
        case .dockWindowClosedFilled: return "dock-window-closed-filled"
        case .dockWindowClosedLight: return "dock-window-closed-light"
        case .dockWindowClosedRegular: return "dock-window-closed-regular"
        case .dockWindowFilled: return "dock-window-filled"
        ...
        case .fileEmailBold: return "file-email-bold"
        case .fileEmailFilled: return "file-email-filled"
        case .fileEmailLight: return "file-email-light"
        case .fileEmailRegular: return "file-email-regular"
        ...
        case .microphoneMusicModeOnHighBold: return "microphone-music-mode-on-high-bold"
        case .microphoneMusicModeOnHighFilled: return "microphone-music-mode-on-high-filled"
        case .microphoneMusicModeOnHighLight: return "microphone-music-mode-on-high-light"
        case .microphoneMusicModeOnHighRegular: return "microphone-music-mode-on-high-regular"
        case .microphoneMusicModeOnLight: return "microphone-music-mode-on-light"
        case .microphoneMusicModeOnLowBold: return "microphone-music-mode-on-low-bold"
        case .microphoneMusicModeOnLowFilled: return "microphone-music-mode-on-low-filled"
        case .microphoneMusicModeOnLowLight: return "microphone-music-mode-on-low-light"
        case .microphoneMusicModeOnLowRegular: return "microphone-music-mode-on-low-regular"
        ...
        case .microphoneOnHighBold: return "microphone-on-high-bold"
        case .microphoneOnHighFilled: return "microphone-on-high-filled"
        case .microphoneOnHighLight: return "microphone-on-high-light"
        case .microphoneOnHighRegular: return "microphone-on-high-regular"
        case .microphoneOnLight: return "microphone-on-light"
        case .microphoneOnLowBold: return "microphone-on-low-bold"
        case .microphoneOnLowFilled: return "microphone-on-low-filled"
        case .microphoneOnLowLight: return "microphone-on-low-light"
        case .microphoneOnLowRegular: return "microphone-on-low-regular"
        ...
        case .microphoneOptAllOnHighBold: return "microphone-opt-all-on-high-bold"
        case .microphoneOptAllOnHighFilled: return "microphone-opt-all-on-high-filled"
        case .microphoneOptAllOnHighLight: return "microphone-opt-all-on-high-light"
        case .microphoneOptAllOnHighRegular: return "microphone-opt-all-on-high-regular"
        case .microphoneOptAllOnLight: return "microphone-opt-all-on-light"
        case .microphoneOptAllOnLowBold: return "microphone-opt-all-on-low-bold"
        case .microphoneOptAllOnLowFilled: return "microphone-opt-all-on-low-filled"
        case .microphoneOptAllOnLowLight: return "microphone-opt-all-on-low-light"
        case .microphoneOptAllOnLowRegular: return "microphone-opt-all-on-low-regular"
        ...
        case .microphoneOptMeOnHighBold: return "microphone-opt-me-on-high-bold"
        case .microphoneOptMeOnHighFilled: return "microphone-opt-me-on-high-filled"
        case .microphoneOptMeOnHighLight: return "microphone-opt-me-on-high-light"
        case .microphoneOptMeOnHighRegular: return "microphone-opt-me-on-high-regular"
        case .microphoneOptMeOnLight: return "microphone-opt-me-on-light"
        case .microphoneOptMeOnLowBol: return "microphone-opt-me-on-low-bol"
        case .microphoneOptMeOnLowFilled: return "microphone-opt-me-on-low-filled"
        case .microphoneOptMeOnLowLight: return "microphone-opt-me-on-low-light"
        case .microphoneOptMeOnLowRegular: return "microphone-opt-me-on-low-regular"
        ...
        case .realTimeTextBold: return "real-time-text-bold"
        case .realTimeTextFilled: return "real-time-text-filled"
        case .realTimeTextLight: return "real-time-text-light"
        case .realTimeTextRegular: return "real-time-text-regular"
        ...
        case .speechAiBold: return "speech-ai-bold"
        case .speechAiFilled: return "speech-ai-filled"
        case .speechAiLight: return "speech-ai-light"
        case .speechAiRegular: return "speech-ai-regular"
        ...
        case .tenantBold: return "tenant-bold"
        case .tenantFilled: return "tenant-filled"
        case .tenantLight: return "tenant-light"
        case .tenantRegular: return "tenant-regular"
        ...
        case .trackingBold: return "tracking-bold"
        case .trackingFilled: return "tracking-filled"
        case .trackingLight: return "tracking-light"
        case .trackingRegular: return "tracking-regular"
        ...
        case .voiceClipBold: return "voice-clip-bold"
        case .voiceClipFilled: return "voice-clip-filled"
        case .voiceClipLight: return "voice-clip-light"
        case .voiceClipRegular: return "voice-clip-regular"
