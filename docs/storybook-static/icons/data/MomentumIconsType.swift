...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .colorPromptsAiBold: return "\u{f39d}"
        case .colorPromptsAiLight: return "\u{f39e}"
        case .colorPromptsAiRegular: return "\u{f39f}"
        case .colorRegular: return "\u{f3a0}"
        case .colorScheduleAiBold: return "\u{f3a1}"
        case .colorScheduleAiLight: return "\u{f3a2}"
        case .colorScheduleAiRegular: return "\u{f3a3}"
        case .colorSearchAiBold: return "\u{f3a4}"
        case .colorSearchAiLight: return "\u{f3a5}"
        case .colorSearchAiRegular: return "\u{f3a6}"
        case .colorSummarizeAiBold: return "\u{f3a7}"
        case .colorSummarizeAiLight: return "\u{f3a8}"
        case .colorSummarizeAiRegular: return "\u{f3a9}"
        case .colourPaletteBold: return "\u{f3aa}"
        case .colourPaletteFilled: return "\u{f3ab}"
        case .colourPaletteLight: return "\u{f3ac}"
        case .colourPaletteRegular: return "\u{f3ad}"
        case .commentingBold: return "\u{f3ae}"
        case .commentingFilled: return "\u{f3af}"
        case .commentingLight: return "\u{f3b0}"
        case .commentingRegular: return "\u{f3b1}"
        case .companyBold: return "\u{f3b2}"
        case .companyLight: return "\u{f3b3}"
        case .companyRegular: return "\u{f3b4}"
        case .completedByBaseBold: return "\u{f3b5}"
        case .completedByBaseLight: return "\u{f3b6}"
        case .completedByBaseRegular: return "\u{f3b7}"
        case .completedByTimeBold: return "\u{f3b8}"
        case .completedByTimeLight: return "\u{f3b9}"
        case .completedByTimeRegular: return "\u{f3ba}"
        case .completedInteractionBold: return "\u{f3bb}"
        case .completedInteractionFilled: return "\u{f3bc}"
        case .completedInteractionLight: return "\u{f3bd}"
        case .completedInteractionRegular: return "\u{f3be}"
        case .computerBold: return "\u{f3bf}"
        case .computerLight: return "\u{f3c0}"
        case .computerRegular: return "\u{f3c1}"
        case .conciergeBold: return "\u{f3c2}"
        case .conciergeLight: return "\u{f3c3}"
        case .conciergeRegular: return "\u{f3c4}"
        case .conditionalBlockBold: return "\u{f3c5}"
        case .conditionalBlockLight: return "\u{f3c6}"
        case .conditionalBlockRegular: return "\u{f3c7}"
        case .connectBold: return "\u{f3c8}"
        case .connectLight: return "\u{f3c9}"
        case .connectRegular: return "\u{f3ca}"
        case .contactCardBold: return "\u{f3cb}"
        case .contactCardFilled: return "\u{f3cc}"
        case .contactCardLight: return "\u{f3cd}"
        case .contactCardRegular: return "\u{f3ce}"
        case .contactsBold: return "\u{f3cf}"
        case .contactsFilled: return "\u{f3d0}"
        case .contactsLight: return "\u{f3d1}"
        case .contactsRegular: return "\u{f3d2}"
        case .contentDownloadBold: return "\u{f3d3}"
        case .contentDownloadFilled: return "\u{f3d4}"
        case .contentDownloadLight: return "\u{f3d5}"
        case .contentDownloadRegular: return "\u{f3d6}"
        case .contentShareBold: return "\u{f3d7}"
        case .contentShareLight: return "\u{f3d8}"
        case .contentShareRegular: return "\u{f3d9}"
        case .contrastBold: return "\u{f3da}"
        case .contrastLight: return "\u{f3db}"
        case .contrastRegular: return "\u{f3dc}"
        case .copyBold: return "\u{f3dd}"
        case .copyLight: return "\u{f3de}"
        case .copyRegular: return "\u{f3df}"
        case .cpuBold: return "\u{f3e0}"
        case .cpuLight: return "\u{f3e1}"
        case .cpuRegular: return "\u{f3e2}"
        case .createAGroupBold: return "\u{f3e3}"
        case .createAGroupFilled: return "\u{f3e4}"
        case .createAGroupLight: return "\u{f3e5}"
        case .createAGroupRegular: return "\u{f3e6}"
        case .cropBold: return "\u{f3e7}"
        case .cropLight: return "\u{f3e8}"
        case .cropRegular: return "\u{f3e9}"
        case .cucmConnectionBold: return "\u{f3ea}"
        case .cucmConnectionLight: return "\u{f3eb}"
        case .cucmConnectionRegular: return "\u{f3ec}"
        case .customCodeEditorBold: return "\u{f3ed}"
        case .customCodeEditorLight: return "\u{f3ee}"
        case .customCodeEditorRegular: return "\u{f3ef}"
        case .customTaskBold: return "\u{f3f0}"
        case .customTaskFilled: return "\u{f3f1}"
        case .customTaskIndBold: return "\u{f3f2}"
        case .customTaskIndFilled: return "\u{f3f3}"
        case .customTaskIndLight: return "\u{f3f4}"
        case .customTaskIndRegular: return "\u{f3f5}"
        case .customTaskLight: return "\u{f3f6}"
        case .customTaskRegular: return "\u{f3f7}"
        case .dailyRecurringScheduleBold: return "\u{f3f8}"
        case .dailyRecurringScheduleLight: return "\u{f3f9}"
        case .dailyRecurringScheduleRegular: return "\u{f3fa}"
        case .dashboardBold: return "\u{f3fb}"
        case .dashboardFilled: return "\u{f3fc}"
        case .dashboardLight: return "\u{f3fd}"
        case .dashboardRegular: return "\u{f3fe}"
        case .dataManagementBold: return "\u{f3ff}"
        case .dataManagementFilled: return "\u{f400}"
        case .dataManagementLight: return "\u{f401}"
        case .dataManagementRegular: return "\u{f402}"
        case .dataRangeSelectionBold: return "\u{f403}"
        case .dataRangeSelectionFilled: return "\u{f404}"
        case .dataRangeSelectionLight: return "\u{f405}"
        case .dataRangeSelectionRegular: return "\u{f406}"
        case .declineBold: return "\u{f407}"
        case .declineFilled: return "\u{f408}"
        case .declineLight: return "\u{f409}"
        case .declineRegular: return "\u{f40a}"
        case .dectHandsetBold: return "\u{f40b}"
        case .dectHandsetFilled: return "\u{f40c}"
        case .dectHandsetLight: return "\u{f40d}"
        case .dectHandsetRegular: return "\u{f40e}"
        case .deleteBold: return "\u{f40f}"
        case .deleteFilled: return "\u{f410}"
        case .deleteLight: return "\u{f411}"
        case .deleteRegular: return "\u{f412}"
        case .deploymentEvaluationProgressBold: return "\u{f413}"
        case .deploymentEvaluationProgressLight: return "\u{f414}"
        case .deploymentEvaluationProgressRegular: return "\u{f415}"
        case .deploymentProgressBold: return "\u{f416}"
        case .deploymentProgressLight: return "\u{f417}"
        case .deploymentProgressRegular: return "\u{f418}"
        case .deploymentRecurringBold: return "\u{f419}"
        case .deploymentRecurringLight: return "\u{f41a}"
        case .deploymentRecurringRegular: return "\u{f41b}"
        case .deploymentWinnerPendingBold: return "\u{f41c}"
        case .deploymentWinnerPendingLight: return "\u{f41d}"
        case .deploymentWinnerPendingRegular: return "\u{f41e}"
        case .deskPhoneBold: return "\u{f41f}"
        case .deskPhoneFilled: return "\u{f420}"
        case .deskPhoneLight: return "\u{f421}"
        case .deskPhoneRegular: return "\u{f422}"
        case .deskPhoneWarningBold: return "\u{f423}"
        case .deskPhoneWarningLight: return "\u{f424}"
        case .deskPhoneWarningRegular: return "\u{f425}"
        case .deviceConnectionBold: return "\u{f426}"
        case .deviceConnectionFilled: return "\u{f427}"
        case .deviceConnectionLight: return "\u{f428}"
        case .deviceConnectionRegular: return "\u{f429}"
        case .deviceInRoomBold: return "\u{f42a}"
        case .deviceInRoomEndBold: return "\u{f42b}"
        case .deviceInRoomEndLight: return "\u{f42c}"
        case .deviceInRoomEndRegular: return "\u{f42d}"
        case .deviceInRoomFilled: return "\u{f42e}"
        case .deviceInRoomLight: return "\u{f42f}"
        case .deviceInRoomRegular: return "\u{f430}"
        case .deviceMutedBold: return "\u{f431}"
        case .deviceMutedLight: return "\u{f432}"
        case .deviceMutedRegular: return "\u{f433}"
        case .devicePolicyControllerBold: return "\u{f434}"
        case .devicePolicyControllerLight: return "\u{f435}"
        case .devicePolicyControllerRegular: return "\u{f436}"
        case .devicesBold: return "\u{f437}"
        case .devicesFilled: return "\u{f438}"
        case .devicesLight: return "\u{f439}"
        case .devicesRegular: return "\u{f43a}"
        case .diagnosticsBold: return "\u{f43b}"
        case .diagnosticsLight: return "\u{f43c}"
        case .diagnosticsRegular: return "\u{f43d}"
        case .dialpadBold: return "\u{f43e}"
        case .dialpadLight: return "\u{f43f}"
        case .dialpadRegular: return "\u{f440}"
        case .diamondBold: return "\u{f441}"
        case .diamondFilled: return "\u{f442}"
        case .diamondLight: return "\u{f443}"
        case .diamondRegular: return "\u{f444}"
        case .directionalPadBold: return "\u{f445}"
        case .directionalPadFilled: return "\u{f446}"
        case .directionalPadLight: return "\u{f447}"
        case .directionalPadRegular: return "\u{f448}"
        case .directoryBold: return "\u{f449}"
        case .directoryLight: return "\u{f44a}"
        case .directoryRegular: return "\u{f44b}"
        case .disappearingPenBold: return "\u{f44c}"
        case .disappearingPenLight: return "\u{f44d}"
        case .disappearingPenRegular: return "\u{f44e}"
        case .discBold: return "\u{f44f}"
        case .discConnectedBold: return "\u{f450}"
        case .discConnectedLight: return "\u{f451}"
        case .discConnectedRegular: return "\u{f452}"
        case .discLight: return "\u{f453}"
        case .discRegular: return "\u{f454}"
        case .disconnectBold: return "\u{f455}"
        case .disconnectFilled: return "\u{f456}"
        case .disconnectLight: return "\u{f457}"
        case .disconnectRegular: return "\u{f458}"
        case .dislikeBold: return "\u{f459}"
        case .dislikeFilled: return "\u{f45a}"
        case .dislikeLight: return "\u{f45b}"
        case .dislikeRegular: return "\u{f45c}"
        case .displayBold: return "\u{f45d}"
        case .displayInputBold: return "\u{f45e}"
        case .displayInputLight: return "\u{f45f}"
        case .displayInputRegular: return "\u{f460}"
        case .displayLight: return "\u{f461}"
        case .displayRegular: return "\u{f462}"
        case .displayWarningBold: return "\u{f463}"
        case .displayWarningLight: return "\u{f464}"
        case .displayWarningRegular: return "\u{f465}"
        case .distributeHorizontalBold: return "\u{f466}"
        case .distributeHorizontalFilled: return "\u{f467}"
        case .distributeHorizontalLight: return "\u{f468}"
        case .distributeHorizontalRegular: return "\u{f469}"
        case .distributeVerticallyBold: return "\u{f46a}"
        case .distributeVerticallyFilled: return "\u{f46b}"
        case .distributeVerticallyLight: return "\u{f46c}"
        case .distributeVerticallyRegular: return "\u{f46d}"
        case .divideBold: return "\u{f46e}"
        case .divideFilled: return "\u{f46f}"
        case .divideLight: return "\u{f470}"
        case .divideRegular: return "\u{f471}"
        case .dndPresenceBadgeFilled: return "\u{f472}"
        case .dndPresenceBold: return "\u{f473}"
        case .dndPresenceFilled: return "\u{f474}"
        case .dndPresenceLight: return "\u{f475}"
        case .dndPresenceRegular: return "\u{f476}"
        case .dockWindowBold: return "\u{f477}"
        case .dockWindowLight: return "\u{f478}"
        case .dockWindowRegular: return "\u{f479}"
        case .documentBold: return "\u{f47a}"
        case .documentCameraBold: return "\u{f47b}"
        case .documentCameraDisconnectedBold: return "\u{f47c}"
        case .documentCameraDisconnectedLight: return "\u{f47d}"
        case .documentCameraDisconnectedRegular: return "\u{f47e}"
        case .documentCameraLight: return "\u{f47f}"
        case .documentCameraRegular: return "\u{f480}"
        case .documentCreateBold: return "\u{f481}"
        case .documentCreateFilled: return "\u{f482}"
        case .documentCreateLight: return "\u{f483}"
        case .documentCreateRegular: return "\u{f484}"
        case .documentFilled: return "\u{f485}"
        case .documentLight: return "\u{f486}"
        case .documentMoveBold: return "\u{f487}"
        case .documentMoveFilled: return "\u{f488}"
        case .documentMoveLight: return "\u{f489}"
        case .documentMoveRegular: return "\u{f48a}"
        case .documentRegular: return "\u{f48b}"
        case .documentShareBold: return "\u{f48c}"
        case .documentShareFilled: return "\u{f48d}"
        case .documentShareLight: return "\u{f48e}"
        case .documentShareRegular: return "\u{f48f}"
        case .doneAllBold: return "\u{f490}"
        case .doneAllLight: return "\u{f491}"
        case .doneAllRegular: return "\u{f492}"
        case .donutChartBold: return "\u{f493}"
        case .donutChartFilled: return "\u{f494}"
        case .donutChartLight: return "\u{f495}"
        case .donutChartRegular: return "\u{f496}"
        case .downloadBold: return "\u{f497}"
        case .downloadFilled: return "\u{f498}"
        case .downloadLight: return "\u{f499}"
        case .downloadRegular: return "\u{f49a}"
        case .draftBold: return "\u{f49b}"
        case .draftFilled: return "\u{f49c}"
        case .draftIndicatorBold: return "\u{f49d}"
        case .draftIndicatorSmallFilled: return "\u{f49e}"
        case .draftLight: return "\u{f49f}"
        case .draftRegular: return "\u{f4a0}"
        case .dragBold: return "\u{f4a1}"
        case .dragLight: return "\u{f4a2}"
        case .dragRegular: return "\u{f4a3}"
        case .draggerHorizontalBold: return "\u{f4a4}"
        case .draggerHorizontalLight: return "\u{f4a5}"
        case .draggerHorizontalRegular: return "\u{f4a6}"
        case .draggerVerticalBold: return "\u{f4a7}"
        case .draggerVerticalLight: return "\u{f4a8}"
        case .draggerVerticalRegular: return "\u{f4a9}"
        case .driveModeBold: return "\u{f4aa}"
        case .driveModeLight: return "\u{f4ab}"
        case .driveModeRegular: return "\u{f4ac}"
        case .dropdownBold: return "\u{f4ad}"
        case .dropdownLight: return "\u{f4ae}"
        case .dropdownRegular: return "\u{f4af}"
        case .dxEightyBold: return "\u{f4b0}"
        case .dxEightyFilled: return "\u{f4b1}"
        case .dxEightyLight: return "\u{f4b2}"
        case .dxEightyRegular: return "\u{f4b3}"
        case .dxSeventyBold: return "\u{f4b4}"
        case .dxSeventyLight: return "\u{f4b5}"
        case .dxSeventyRegular: return "\u{f4b6}"
        case .editBold: return "\u{f4b7}"
        case .editFilled: return "\u{f4b8}"
        case .editLight: return "\u{f4b9}"
        case .editRegular: return "\u{f4ba}"
        case .editablePartialBold: return "\u{f4bb}"
        case .editablePartialLight: return "\u{f4bc}"
        case .editablePartialRegular: return "\u{f4bd}"
        case .educationBold: return "\u{f4be}"
        case .educationFilled: return "\u{f4bf}"
        case .educationLight: return "\u{f4c0}"
        case .educationRegular: return "\u{f4c1}"
        case .emailBold: return "\u{f4c2}"
        case .emailDeliveredBold: return "\u{f4c3}"
        case .emailDeliveredLight: return "\u{f4c4}"
        case .emailDeliveredRegular: return "\u{f4c5}"
        case .emailFailureBold: return "\u{f4c6}"
        case .emailFailureLight: return "\u{f4c7}"
        case .emailFailureRegular: return "\u{f4c8}"
        case .emailFilled: return "\u{f4c9}"
        case .emailInviteBold: return "\u{f4ca}"
        case .emailInviteLight: return "\u{f4cb}"
        case .emailInviteRegular: return "\u{f4cc}"
        case .emailLight: return "\u{f4cd}"
        case .emailOutgoingBold: return "\u{f4ce}"
        case .emailOutgoingFilled: return "\u{f4cf}"
        case .emailOutgoingLight: return "\u{f4d0}"
        case .emailOutgoingRegular: return "\u{f4d1}"
        case .emailReadBold: return "\u{f4d2}"
        case .emailReadFilled: return "\u{f4d3}"
        case .emailReadLight: return "\u{f4d4}"
        case .emailReadRegular: return "\u{f4d5}"
        case .emailRegular: return "\u{f4d6}"
        case .emojiExcitedBold: return "\u{f4d7}"
        case .emojiExcitedFilled: return "\u{f4d8}"
        case .emojiExcitedLight: return "\u{f4d9}"
        case .emojiExcitedRegular: return "\u{f4da}"
        case .emojiHappyBold: return "\u{f4db}"
        case .emojiHappyFilled: return "\u{f4dc}"
        case .emojiHappyLight: return "\u{f4dd}"
        case .emojiHappyRegular: return "\u{f4de}"
        case .emojiPassiveBold: return "\u{f4df}"
        case .emojiPassiveFilled: return "\u{f4e0}"
        case .emojiPassiveLight: return "\u{f4e1}"
        case .emojiPassiveRegular: return "\u{f4e2}"
        case .emojiSadBold: return "\u{f4e3}"
        case .emojiSadFilled: return "\u{f4e4}"
        case .emojiSadLight: return "\u{f4e5}"
        case .emojiSadRegular: return "\u{f4e6}"
        case .emojiUnhappyBold: return "\u{f4e7}"
        case .emojiUnhappyFilled: return "\u{f4e8}"
        case .emojiUnhappyLight: return "\u{f4e9}"
        case .emojiUnhappyRegular: return "\u{f4ea}"
        case .encryptionCircleFilled: return "\u{f4eb}"
        case .encryptionFilled: return "\u{f4ec}"
        case .endRemoteDesktopControlBold: return "\u{f4ed}"
        case .endRemoteDesktopControlLight: return "\u{f4ee}"
        case .endRemoteDesktopControlRegular: return "\u{f4ef}"
        case .endToEndEncryptionCircleFilled: return "\u{f4f0}"
        case .endToEndEncryptionFilled: return "\u{f4f1}"
        case .endpointBlockedBold: return "\u{f4f2}"
        case .endpointBlockedLight: return "\u{f4f3}"
        case .endpointBlockedRegular: return "\u{f4f4}"
        case .endpointBold: return "\u{f4f5}"
        case .endpointGTwoBold: return "\u{f4f6}"
        case .endpointGTwoLight: return "\u{f4f7}"
        case .endpointGTwoRegular: return "\u{f4f8}"
        case .endpointGTwoSeventyBold: return "\u{f4f9}"
        case .endpointGTwoSeventyDualBold: return "\u{f4fa}"
        case .endpointGTwoSeventyDualLight: return "\u{f4fb}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4fc}"
        case .endpointGTwoSeventyLight: return "\u{f4fd}"
        case .endpointGTwoSeventyRegular: return "\u{f4fe}"
        case .endpointGTwoStandBold: return "\u{f4ff}"
        case .endpointGTwoStandLight: return "\u{f500}"
        case .endpointGTwoStandRegular: return "\u{f501}"
        case .endpointLight: return "\u{f502}"
        case .endpointMxEightHundredBold: return "\u{f503}"
        case .endpointMxEightHundredDualBold: return "\u{f504}"
        case .endpointMxEightHundredDualLight: return "\u{f505}"
        case .endpointMxEightHundredDualRegular: return "\u{f506}"
        case .endpointMxEightHundredLight: return "\u{f507}"
        case .endpointMxEightHundredRegular: return "\u{f508}"
        case .endpointRegular: return "\u{f509}"
        case .endpointStandBold: return "\u{f50a}"
        case .endpointStandFilled: return "\u{f50b}"
        case .endpointStandLight: return "\u{f50c}"
        case .endpointStandRegular: return "\u{f50d}"
        case .endpointWarningBold: return "\u{f50e}"
        case .endpointWarningLight: return "\u{f50f}"
        case .endpointWarningRegular: return "\u{f510}"
        case .enterBold: return "\u{f511}"
        case .enterLight: return "\u{f512}"
        case .enterRegular: return "\u{f513}"
        case .enterRoomBold: return "\u{f514}"
        case .enterRoomFilled: return "\u{f515}"
        case .enterRoomLight: return "\u{f516}"
        case .enterRoomRegular: return "\u{f517}"
        case .eraserBold: return "\u{f518}"
        case .eraserFilled: return "\u{f519}"
        case .eraserLight: return "\u{f51a}"
        case .eraserRegular: return "\u{f51b}"
        case .errorLegacyBadgeFilled: return "\u{f51c}"
        case .errorLegacyBold: return "\u{f51d}"
        case .errorLegacyFilled: return "\u{f51e}"
        case .errorLegacyLight: return "\u{f51f}"
        case .errorLegacyRegular: return "\u{f520}"
        case .ethernetBold: return "\u{f521}"
        case .ethernetFilled: return "\u{f522}"
        case .ethernetLight: return "\u{f523}"
        case .ethernetRegular: return "\u{f524}"
        case .exchangeBold: return "\u{f525}"
        case .exchangeLight: return "\u{f526}"
        case .exchangeRegular: return "\u{f527}"
        case .exclamationBold: return "\u{f528}"
        case .exclamationLight: return "\u{f529}"
        case .exclamationRegular: return "\u{f52a}"
        case .excludeBold: return "\u{f52b}"
        case .excludeLight: return "\u{f52c}"
        case .excludeRegular: return "\u{f52d}"
        case .existingTargetGroupBold: return "\u{f52e}"
        case .existingTargetGroupLight: return "\u{f52f}"
        case .existingTargetGroupRegular: return "\u{f530}"
        case .exitRoomBold: return "\u{f531}"
        case .exitRoomLight: return "\u{f532}"
        case .exitRoomRegular: return "\u{f533}"
        case .exploreBold: return "\u{f534}"
        case .exploreLight: return "\u{f535}"
        case .exploreRegular: return "\u{f536}"
        case .exportBold: return "\u{f537}"
        case .exportLight: return "\u{f538}"
        case .exportRegular: return "\u{f539}"
        case .extensionMobilityBold: return "\u{f53a}"
        case .extensionMobilityLight: return "\u{f53b}"
        case .extensionMobilityRegular: return "\u{f53c}"
        case .externalMessageBold: return "\u{f53d}"
        case .externalMessageLight: return "\u{f53e}"
        case .externalMessageRegular: return "\u{f53f}"
        case .externalUserBold: return "\u{f540}"
        case .externalUserLight: return "\u{f541}"
        case .externalUserRegular: return "\u{f542}"
        case .familyFontBold: return "\u{f543}"
        case .familyFontLight: return "\u{f544}"
        case .familyFontRegular: return "\u{f545}"
        case .fastForwardBold: return "\u{f546}"
        case .fastForwardLight: return "\u{f547}"
        case .fastForwardRegular: return "\u{f548}"
        case .favoriteBold: return "\u{f549}"
        case .favoriteFilled: return "\u{f54a}"
        case .favoriteLight: return "\u{f54b}"
        case .favoriteRegular: return "\u{f54c}"
        case .favoritesBold: return "\u{f54d}"
        case .favoritesFilled: return "\u{f54e}"
        case .favoritesLight: return "\u{f54f}"
        case .favoritesRegular: return "\u{f550}"
        case .fbwBold: return "\u{f551}"
        case .fbwFilled: return "\u{f552}"
        case .fbwLight: return "\u{f553}"
        case .fbwRegular: return "\u{f554}"
        case .ffwBold: return "\u{f555}"
        case .ffwFilled: return "\u{f556}"
        case .ffwLight: return "\u{f557}"
        case .ffwRegular: return "\u{f558}"
        case .fileAnalysisBold: return "\u{f559}"
        case .fileAnalysisFilled: return "\u{f55a}"
        case .fileAnalysisLight: return "\u{f55b}"
        case .fileAnalysisRegular: return "\u{f55c}"
        case .fileAnnotationBold: return "\u{f55d}"
        case .fileAnnotationFilled: return "\u{f55e}"
        case .fileAnnotationLight: return "\u{f55f}"
        case .fileAnnotationRegular: return "\u{f560}"
        case .fileAudioBold: return "\u{f561}"
        case .fileAudioFilled: return "\u{f562}"
        case .fileAudioLight: return "\u{f563}"
        case .fileAudioRegular: return "\u{f564}"
        case .fileBugBold: return "\u{f565}"
        case .fileBugFilled: return "\u{f566}"
        case .fileBugLight: return "\u{f567}"
        case .fileBugRegular: return "\u{f568}"
        case .fileCodeBold: return "\u{f569}"
        case .fileCodeFilled: return "\u{f56a}"
        case .fileCodeLight: return "\u{f56b}"
        case .fileCodeRegular: return "\u{f56c}"
        case .fileDashboardBold: return "\u{f56d}"
        case .fileDashboardFilled: return "\u{f56e}"
        case .fileDashboardLight: return "\u{f56f}"
        case .fileDashboardRegular: return "\u{f570}"
        case .fileExcelBold: return "\u{f571}"
        case .fileExcelFilled: return "\u{f572}"
        case .fileExcelLight: return "\u{f573}"
        case .fileExcelRegular: return "\u{f574}"
        case .fileGraphBold: return "\u{f575}"
        case .fileGraphFilled: return "\u{f576}"
        case .fileGraphLight: return "\u{f577}"
        case .fileGraphRegular: return "\u{f578}"
        case .fileImageBold: return "\u{f579}"
        case .fileImageFilled: return "\u{f57a}"
        case .fileImageLight: return "\u{f57b}"
        case .fileImageNoneBold: return "\u{f57c}"
        case .fileImageNoneLight: return "\u{f57d}"
        case .fileImageNoneRegular: return "\u{f57e}"
        case .fileImageRegular: return "\u{f57f}"
        case .fileJsBold: return "\u{f580}"
        case .fileJsFilled: return "\u{f581}"
        case .fileJsLight: return "\u{f582}"
        case .fileJsRegular: return "\u{f583}"
        case .fileKeynoteBold: return "\u{f584}"
        case .fileKeynoteFilled: return "\u{f585}"
        case .fileKeynoteLight: return "\u{f586}"
        case .fileKeynoteRegular: return "\u{f587}"
        case .fileLockedBold: return "\u{f588}"
        case .fileLockedFilled: return "\u{f589}"
        case .fileLockedLight: return "\u{f58a}"
        case .fileLockedRegular: return "\u{f58b}"
        case .fileMissingBold: return "\u{f58c}"
        case .fileMissingFilled: return "\u{f58d}"
        case .fileMissingLight: return "\u{f58e}"
        case .fileMissingRegular: return "\u{f58f}"
        case .fileMusicBold: return "\u{f590}"
        case .fileMusicFilled: return "\u{f591}"
        case .fileMusicLight: return "\u{f592}"
        case .fileMusicRegular: return "\u{f593}"
        case .fileOnenoteBold: return "\u{f594}"
        case .fileOnenoteFilled: return "\u{f595}"
        case .fileOnenoteLight: return "\u{f596}"
        case .fileOnenoteRegular: return "\u{f597}"
        case .filePdfBold: return "\u{f598}"
        case .filePdfFilled: return "\u{f599}"
        case .filePdfLight: return "\u{f59a}"
        case .filePdfRegular: return "\u{f59b}"
        case .filePowerpointBold: return "\u{f59c}"
        case .filePowerpointFilled: return "\u{f59d}"
        case .filePowerpointLight: return "\u{f59e}"
        case .filePowerpointRegular: return "\u{f59f}"
        case .fileSpreadsheetBold: return "\u{f5a0}"
        case .fileSpreadsheetFilled: return "\u{f5a1}"
        case .fileSpreadsheetLight: return "\u{f5a2}"
        case .fileSpreadsheetRegular: return "\u{f5a3}"
        case .fileTextBold: return "\u{f5a4}"
        case .fileTextFilled: return "\u{f5a5}"
        case .fileTextLight: return "\u{f5a6}"
        case .fileTextRegular: return "\u{f5a7}"
        case .fileThreeDBold: return "\u{f5a8}"
        case .fileThreeDFilled: return "\u{f5a9}"
        case .fileThreeDLight: return "\u{f5aa}"
        case .fileThreeDRegular: return "\u{f5ab}"
        case .fileVectorBold: return "\u{f5ac}"
        case .fileVectorFilled: return "\u{f5ad}"
        case .fileVectorLight: return "\u{f5ae}"
        case .fileVectorRegular: return "\u{f5af}"
        case .fileVideoBold: return "\u{f5b0}"
        case .fileVideoFilled: return "\u{f5b1}"
        case .fileVideoLight: return "\u{f5b2}"
        case .fileVideoRegular: return "\u{f5b3}"
        case .fileWordBold: return "\u{f5b4}"
        case .fileWordFilled: return "\u{f5b5}"
        case .fileWordLight: return "\u{f5b6}"
        case .fileWordRegular: return "\u{f5b7}"
        case .fileXmlBold: return "\u{f5b8}"
        case .fileXmlFilled: return "\u{f5b9}"
        case .fileXmlLight: return "\u{f5ba}"
        case .fileXmlRegular: return "\u{f5bb}"
        case .fileZipBold: return "\u{f5bc}"
        case .fileZipFilled: return "\u{f5bd}"
        case .fileZipLight: return "\u{f5be}"
        case .fileZipRegular: return "\u{f5bf}"
        case .filesBold: return "\u{f5c0}"
        case .filesFilled: return "\u{f5c1}"
        case .filesLight: return "\u{f5c2}"
        case .filesRegular: return "\u{f5c3}"
        case .fillColourBold: return "\u{f5c4}"
        case .fillColourFilled: return "\u{f5c5}"
        case .fillColourLight: return "\u{f5c6}"
        case .fillColourRegular: return "\u{f5c7}"
        case .filterBold: return "\u{f5c8}"
        case .filterCircleBold: return "\u{f5c9}"
        case .filterCircleFilled: return "\u{f5ca}"
        case .filterCircleLight: return "\u{f5cb}"
        case .filterCircleRegular: return "\u{f5cc}"
        case .filterLight: return "\u{f5cd}"
        case .filterRegular: return "\u{f5ce}"
        case .fitToWidthBold: return "\u{f5cf}"
        case .fitToWidthLight: return "\u{f5d0}"
        case .fitToWidthRegular: return "\u{f5d1}"
        case .fitToWindowExpandBold: return "\u{f5d2}"
        case .fitToWindowExpandLight: return "\u{f5d3}"
        case .fitToWindowExpandRegular: return "\u{f5d4}"
        case .fitToWindowShrinkBold: return "\u{f5d5}"
        case .fitToWindowShrinkLight: return "\u{f5d6}"
        case .fitToWindowShrinkRegular: return "\u{f5d7}"
        case .flagBold: return "\u{f5d8}"
        case .flagCircleBold: return "\u{f5d9}"
        case .flagCircleFilled: return "\u{f5da}"
        case .flagCircleLight: return "\u{f5db}"
        case .flagCircleRegular: return "\u{f5dc}"
        case .flagFilled: return "\u{f5dd}"
        case .flagLight: return "\u{f5de}"
        case .flagRegular: return "\u{f5df}"
        case .folderBold: return "\u{f5e0}"
        case .folderEditBold: return "\u{f5e1}"
        case .folderEditLight: return "\u{f5e2}"
        case .folderEditRegular: return "\u{f5e3}"
        case .folderFilled: return "\u{f5e4}"
        case .folderLight: return "\u{f5e5}"
        case .folderLockBold: return "\u{f5e6}"
        case .folderLockLight: return "\u{f5e7}"
        case .folderLockRegular: return "\u{f5e8}"
        case .folderRegular: return "\u{f5e9}"
        case .folderViewBold: return "\u{f5ea}"
        case .folderViewLight: return "\u{f5eb}"
        case .folderViewRegular: return "\u{f5ec}"
        case .followUpBold: return "\u{f5ed}"
        case .followUpLight: return "\u{f5ee}"
        case .followUpRegular: return "\u{f5ef}"
        case .foodBold: return "\u{f5f0}"
        case .foodFilled: return "\u{f5f1}"
        case .foodLight: return "\u{f5f2}"
        case .foodRegular: return "\u{f5f3}"
        case .formatBold: return "\u{f5f4}"
        case .formatDefaultAppBold: return "\u{f5f5}"
        case .formatDefaultAppFilled: return "\u{f5f6}"
        case .formatDefaultAppLight: return "\u{f5f7}"
        case .formatDefaultAppRegular: return "\u{f5f8}"
        case .formatLight: return "\u{f5f9}"
        case .formatPanelControlBarBold: return "\u{f5fa}"
        case .formatPanelControlBarLight: return "\u{f5fb}"
        case .formatPanelControlBarRegular: return "\u{f5fc}"
        case .formatPanelControlDownBold: return "\u{f5fd}"
        case .formatPanelControlDownLight: return "\u{f5fe}"
        case .formatPanelControlDownRegular: return "\u{f5ff}"
        case .formatPanelControlLeftBold: return "\u{f600}"
        case .formatPanelControlLeftLight: return "\u{f601}"
        case .formatPanelControlLeftRegular: return "\u{f602}"
        case .formatPanelControlRightBold: return "\u{f603}"
        case .formatPanelControlRightLight: return "\u{f604}"
        case .formatPanelControlRightRegular: return "\u{f605}"
        case .formatPanelControlUpBold: return "\u{f606}"
        case .formatPanelControlUpDownBold: return "\u{f607}"
        case .formatPanelControlUpDownLight: return "\u{f608}"
        case .formatPanelControlUpDownRegular: return "\u{f609}"
        case .formatPanelControlUpLight: return "\u{f60a}"
        case .formatPanelControlUpRegular: return "\u{f60b}"
        case .formatRegular: return "\u{f60c}"
        case .formatViewMixedBold: return "\u{f60d}"
        case .formatViewMixedLight: return "\u{f60e}"
        case .formatViewMixedRegular: return "\u{f60f}"
        case .formulaBold: return "\u{f610}"
        case .formulaFilled: return "\u{f611}"
        case .formulaLight: return "\u{f612}"
        case .formulaRegular: return "\u{f613}"
        case .forwardMessageBold: return "\u{f614}"
        case .forwardMessageFilled: return "\u{f615}"
        case .forwardMessageLight: return "\u{f616}"
        case .forwardMessageRegular: return "\u{f617}"
        case .forwardTenSecBold: return "\u{f618}"
        case .forwardTenSecLight: return "\u{f619}"
        case .forwardTenSecRegular: return "\u{f61a}"
        case .fourColumnBold: return "\u{f61b}"
        case .fourColumnLight: return "\u{f61c}"
        case .fourColumnRegular: return "\u{f61d}"
        case .fourWayNavigationBold: return "\u{f61e}"
        case .fourWayNavigationLight: return "\u{f61f}"
        case .fourWayNavigationRegular: return "\u{f620}"
        case .frequencyCappingBold: return "\u{f621}"
        case .frequencyCappingLight: return "\u{f622}"
        case .frequencyCappingRegular: return "\u{f623}"
        case .fulfillmentBold: return "\u{f624}"
        case .fulfillmentLight: return "\u{f625}"
        case .fulfillmentRegular: return "\u{f626}"
        case .fullscreenBold: return "\u{f627}"
        case .fullscreenExitBold: return "\u{f628}"
        case .fullscreenExitLight: return "\u{f629}"
        case .fullscreenExitRegular: return "\u{f62a}"
        case .fullscreenLight: return "\u{f62b}"
        case .fullscreenRegular: return "\u{f62c}"
        case .genericDeviceVideoBadgeFilled: return "\u{f62d}"
        case .genericDeviceVideoBold: return "\u{f62e}"
        case .genericDeviceVideoFilled: return "\u{f62f}"
        case .genericDeviceVideoLight: return "\u{f630}"
        case .genericDeviceVideoRegular: return "\u{f631}"
        case .gifBold: return "\u{f632}"
        case .gifFilled: return "\u{f633}"
        case .gifHorizontalBold: return "\u{f634}"
        case .gifHorizontalFilled: return "\u{f635}"
        case .gifHorizontalLight: return "\u{f636}"
        case .gifHorizontalRegular: return "\u{f637}"
        case .gifLight: return "\u{f638}"
        case .gifRegular: return "\u{f639}"
        case .giftBold: return "\u{f63a}"
        case .giftFilled: return "\u{f63b}"
        case .giftLight: return "\u{f63c}"
        case .giftRegular: return "\u{f63d}"
        case .greenLeafBold: return "\u{f63e}"
        case .greenLeafFilled: return "\u{f63f}"
        case .greenLeafLight: return "\u{f640}"
        case .greenLeafRegular: return "\u{f641}"
        case .greenRoomBold: return "\u{f642}"
        case .greenRoomFilled: return "\u{f643}"
        case .greenRoomLight: return "\u{f644}"
        case .greenRoomRegular: return "\u{f645}"
        case .guestIssuerBold: return "\u{f646}"
        case .guestIssuerLight: return "\u{f647}"
        case .guestIssuerRegular: return "\u{f648}"
        case .guideBold: return "\u{f649}"
        case .guideLight: return "\u{f64a}"
        case .guideRegular: return "\u{f64b}"
        case .handPointerBold: return "\u{f64c}"
        case .handPointerLight: return "\u{f64d}"
        case .handPointerRegular: return "\u{f64e}"
        case .handlerBold: return "\u{f64f}"
        case .handlerHorizontalBold: return "\u{f650}"
        case .handlerHorizontalLight: return "\u{f651}"
        case .handlerHorizontalRegular: return "\u{f652}"
        case .handlerLight: return "\u{f653}"
        case .handlerRegular: return "\u{f654}"
        case .handsetAlertBold: return "\u{f655}"
        case .handsetAlertFilled: return "\u{f656}"
        case .handsetAlertLight: return "\u{f657}"
        case .handsetAlertRegular: return "\u{f658}"
        case .handsetBold: return "\u{f659}"
        case .handsetDownSlashBold: return "\u{f65a}"
        case .handsetDownSlashFilled: return "\u{f65b}"
        case .handsetDownSlashLight: return "\u{f65c}"
        case .handsetDownSlashRegular: return "\u{f65d}"
        case .handsetFilled: return "\u{f65e}"
        case .handsetLight: return "\u{f65f}"
        case .handsetMutedBold: return "\u{f660}"
        case .handsetMutedFilled: return "\u{f661}"
        case .handsetMutedLight: return "\u{f662}"
        case .handsetMutedRegular: return "\u{f663}"
        case .handsetRegular: return "\u{f664}"
        case .handsetsArrowLeftBold: return "\u{f665}"
        case .handsetsArrowLeftLight: return "\u{f666}"
        case .handsetsArrowLeftRegular: return "\u{f667}"
        case .handshakeBold: return "\u{f668}"
        case .handshakeLight: return "\u{f669}"
        case .handshakeRegular: return "\u{f66a}"
        case .headingOneBold: return "\u{f66b}"
        case .headingOneLight: return "\u{f66c}"
        case .headingOneRegular: return "\u{f66d}"
        case .headingThreeBold: return "\u{f66e}"
        case .headingThreeLight: return "\u{f66f}"
        case .headingThreeRegular: return "\u{f670}"
        case .headingTwoBold: return "\u{f671}"
        case .headingTwoLight: return "\u{f672}"
        case .headingTwoRegular: return "\u{f673}"
        case .headphonesBold: return "\u{f674}"
        case .headphonesFilled: return "\u{f675}"
        case .headphonesLight: return "\u{f676}"
        case .headphonesMutedBold: return "\u{f677}"
        case .headphonesMutedFilled: return "\u{f678}"
        case .headphonesMutedLight: return "\u{f679}"
        case .headphonesMutedRegular: return "\u{f67a}"
        case .headphonesRegular: return "\u{f67b}"
        case .headsetAlertBold: return "\u{f67c}"
        case .headsetAlertLight: return "\u{f67d}"
        case .headsetAlertRegular: return "\u{f67e}"
        case .headsetArrowDownBold: return "\u{f67f}"
        case .headsetArrowDownFilled: return "\u{f680}"
        case .headsetArrowDownLight: return "\u{f681}"
        case .headsetArrowDownRegular: return "\u{f682}"
        case .headsetBluetoothBold: return "\u{f683}"
        case .headsetBluetoothLight: return "\u{f684}"
        case .headsetBluetoothRegular: return "\u{f685}"
        case .headsetBold: return "\u{f686}"
        case .headsetFilled: return "\u{f687}"
        case .headsetLight: return "\u{f688}"
        case .headsetMutedBold: return "\u{f689}"
        case .headsetMutedLight: return "\u{f68a}"
        case .headsetMutedRegular: return "\u{f68b}"
        case .headsetPrivateBold: return "\u{f68c}"
        case .headsetPrivateLight: return "\u{f68d}"
        case .headsetPrivateRegular: return "\u{f68e}"
        case .headsetRegular: return "\u{f68f}"
        case .hearingBold: return "\u{f690}"
        case .hearingImpairedBold: return "\u{f691}"
        case .hearingImpairedLight: return "\u{f692}"
        case .hearingImpairedRegular: return "\u{f693}"
        case .hearingLight: return "\u{f694}"
        case .hearingRegular: return "\u{f695}"
        case .helpBold: return "\u{f696}"
        case .helpCircleBold: return "\u{f697}"
        case .helpCircleFilled: return "\u{f698}"
        case .helpCircleLight: return "\u{f699}"
        case .helpCircleRegular: return "\u{f69a}"
        case .helpLight: return "\u{f69b}"
        case .helpRegular: return "\u{f69c}"
        case .helpdeskBold: return "\u{f69d}"
        case .helpdeskFilled: return "\u{f69e}"
        case .helpdeskLight: return "\u{f69f}"
        case .helpdeskRegular: return "\u{f6a0}"
        case .hideBold: return "\u{f6a1}"
        case .hideFilled: return "\u{f6a2}"
        case .hideLight: return "\u{f6a3}"
        case .hideRegular: return "\u{f6a4}"
        case .homeBold: return "\u{f6a5}"
        case .homeFilled: return "\u{f6a6}"
        case .homeLight: return "\u{f6a7}"
        case .homeRegular: return "\u{f6a8}"
        case .horizontalLineBold: return "\u{f6a9}"
        case .horizontalLineLight: return "\u{f6aa}"
        case .horizontalLineRegular: return "\u{f6ab}"
        case .hotelingBold: return "\u{f6ac}"
        case .hotelingFilled: return "\u{f6ad}"
        case .hotelingLight: return "\u{f6ae}"
        case .hotelingRegular: return "\u{f6af}"
        case .humidityBold: return "\u{f6b0}"
        case .humidityLight: return "\u{f6b1}"
        case .humidityRegular: return "\u{f6b2}"
        case .huntGroupBold: return "\u{f6b3}"
        case .huntGroupFilled: return "\u{f6b4}"
        case .huntGroupLight: return "\u{f6b5}"
        case .huntGroupRegular: return "\u{f6b6}"
        case .idleBold: return "\u{f6b7}"
        case .idleFilled: return "\u{f6b8}"
        case .idleLight: return "\u{f6b9}"
        case .idleRegular: return "\u{f6ba}"
        case .immediateBold: return "\u{f6bb}"
        case .immediateFilled: return "\u{f6bc}"
        case .immediateLight: return "\u{f6bd}"
        case .immediateRegular: return "\u{f6be}"
        case .importBold: return "\u{f6bf}"
        case .importLight: return "\u{f6c0}"
        case .importRegular: return "\u{f6c1}"
        case .inCommonBold: return "\u{f6c2}"
        case .inCommonLight: return "\u{f6c3}"
        case .inCommonRegular: return "\u{f6c4}"
        case .inboxBold: return "\u{f6c5}"
        case .inboxFilled: return "\u{f6c6}"
        case .inboxLight: return "\u{f6c7}"
        case .inboxRegular: return "\u{f6c8}"
        case .includeBold: return "\u{f6c9}"
        case .includeLight: return "\u{f6ca}"
        case .includeRegular: return "\u{f6cb}"
        case .incognitoBold: return "\u{f6cc}"
        case .incognitoFilled: return "\u{f6cd}"
        case .incognitoLight: return "\u{f6ce}"
        case .incognitoRegular: return "\u{f6cf}"
        case .incomingCallLegacyBold: return "\u{f6d0}"
        case .incomingCallLegacyFilled: return "\u{f6d1}"
        case .incomingCallLegacyLight: return "\u{f6d2}"
        case .incomingCallLegacyRegular: return "\u{f6d3}"
        case .indentDecreaseBold: return "\u{f6d4}"
        case .indentDecreaseLight: return "\u{f6d5}"
        case .indentDecreaseRegular: return "\u{f6d6}"
        case .indentIncreaseBold: return "\u{f6d7}"
        case .indentIncreaseLight: return "\u{f6d8}"
        case .indentIncreaseRegular: return "\u{f6d9}"
        case .infoBadgeFilled: return "\u{f6da}"
        case .infoCircleBold: return "\u{f6db}"
        case .infoCircleFilled: return "\u{f6dc}"
        case .infoCircleLight: return "\u{f6dd}"
        case .infoCircleRegular: return "\u{f6de}"
        case .infoCircleTwoBold: return "\u{f6df}"
        case .infoCircleTwoFilled: return "\u{f6e0}"
        case .infoCircleTwoLight: return "\u{f6e1}"
        case .infoCircleTwoRegular: return "\u{f6e2}"
        case .inputBold: return "\u{f6e3}"
        case .inputDisconnectedBold: return "\u{f6e4}"
        case .inputDisconnectedLight: return "\u{f6e5}"
        case .inputDisconnectedRegular: return "\u{f6e6}"
        case .inputLight: return "\u{f6e7}"
        case .inputRegular: return "\u{f6e8}"
        case .instantScheduleBold: return "\u{f6e9}"
        case .instantScheduleFilled: return "\u{f6ea}"
        case .instantScheduleLight: return "\u{f6eb}"
        case .instantScheduleRegular: return "\u{f6ec}"
        case .integerBold: return "\u{f6ed}"
        case .integerFilled: return "\u{f6ee}"
        case .integerLight: return "\u{f6ef}"
        case .integerRegular: return "\u{f6f0}"
        case .integrationsBold: return "\u{f6f1}"
        case .integrationsFilled: return "\u{f6f2}"
        case .integrationsLight: return "\u{f6f3}"
        case .integrationsRegular: return "\u{f6f4}"
        case .intelligentRoutingBold: return "\u{f6f5}"
        case .intelligentRoutingLight: return "\u{f6f6}"
        case .intelligentRoutingRegular: return "\u{f6f7}"
        case .interactionBold: return "\u{f6f8}"
        case .interactionFilled: return "\u{f6f9}"
        case .interactionLight: return "\u{f6fa}"
        case .interactionRegular: return "\u{f6fb}"
        case .invitedUserBold: return "\u{f6fc}"
        case .invitedUserLight: return "\u{f6fd}"
        case .invitedUserRegular: return "\u{f6fe}"
        case .italicBold: return "\u{f6ff}"
        case .italicFilled: return "\u{f700}"
        case .italicLight: return "\u{f701}"
        case .italicRegular: return "\u{f702}"
        case .joinAudioBold: return "\u{f703}"
        case .joinAudioFilled: return "\u{f704}"
        case .joinAudioLight: return "\u{f705}"
        case .joinAudioRegular: return "\u{f706}"
        case .keepInTouchBold: return "\u{f707}"
        case .keepInTouchFilled: return "\u{f708}"
        case .keepInTouchLight: return "\u{f709}"
        case .keepInTouchRegular: return "\u{f70a}"
        case .keyboardBold: return "\u{f70b}"
        case .keyboardCloseBold: return "\u{f70c}"
        case .keyboardCloseLight: return "\u{f70d}"
        case .keyboardCloseRegular: return "\u{f70e}"
        case .keyboardLight: return "\u{f70f}"
        case .keyboardRegular: return "\u{f710}"
        case .languageBold: return "\u{f711}"
        case .languageFilled: return "\u{f712}"
        case .languageLight: return "\u{f713}"
        case .languageRegular: return "\u{f714}"
        case .laptopBold: return "\u{f715}"
        case .laptopDisconnectedBold: return "\u{f716}"
        case .laptopDisconnectedLight: return "\u{f717}"
        case .laptopDisconnectedRegular: return "\u{f718}"
        case .laptopFilled: return "\u{f719}"
        case .laptopLight: return "\u{f71a}"
        case .laptopRegular: return "\u{f71b}"
        case .laserPointerBold: return "\u{f71c}"
        case .laserPointerCursorBlackLight: return "\u{f71d}"
        case .laserPointerCursorBlueLight: return "\u{f71e}"
        case .laserPointerCursorGreenLight: return "\u{f71f}"
        case .laserPointerCursorPurpleLight: return "\u{f720}"
        case .laserPointerCursorRedLight: return "\u{f721}"
        case .laserPointerCursorWhiteLight: return "\u{f722}"
        case .laserPointerCursorYellowLight: return "\u{f723}"
        case .laserPointerFilled: return "\u{f724}"
        case .laserPointerLight: return "\u{f725}"
        case .laserPointerRegular: return "\u{f726}"
        case .launchBold: return "\u{f727}"
        case .launchFilled: return "\u{f728}"
        case .launchLight: return "\u{f729}"
        case .launchRegular: return "\u{f72a}"
        case .layoutSideBySideVerticalBold: return "\u{f72b}"
        case .layoutSideBySideVerticalFilled: return "\u{f72c}"
        case .layoutSideBySideVerticalLight: return "\u{f72d}"
        case .layoutSideBySideVerticalRegular: return "\u{f72e}"
        case .leaveBreakoutSessionBold: return "\u{f72f}"
        case .leaveBreakoutSessionLight: return "\u{f730}"
        case .leaveBreakoutSessionRegular: return "\u{f731}"
        case .leaveDeviceBold: return "\u{f732}"
        case .leaveDeviceLight: return "\u{f733}"
        case .leaveDeviceRegular: return "\u{f734}"
        case .likeBold: return "\u{f735}"
        case .likeFilled: return "\u{f736}"
        case .likeLight: return "\u{f737}"
        case .likeRegular: return "\u{f738}"
        case .linkBold: return "\u{f739}"
        case .linkLight: return "\u{f73a}"
        case .linkRegular: return "\u{f73b}"
        case .listBulletedBold: return "\u{f73c}"
        case .listBulletedLight: return "\u{f73d}"
        case .listBulletedRegular: return "\u{f73e}"
        case .listMenuBold: return "\u{f73f}"
        case .listMenuLight: return "\u{f740}"
        case .listMenuRegular: return "\u{f741}"
        case .listNumberedBold: return "\u{f742}"
        case .listNumberedLight: return "\u{f743}"
        case .listNumberedRegular: return "\u{f744}"
        case .liveBold: return "\u{f745}"
        case .liveFilled: return "\u{f746}"
        case .liveLight: return "\u{f747}"
        case .liveRegular: return "\u{f748}"
        case .locationBold: return "\u{f749}"
        case .locationFilled: return "\u{f74a}"
        case .locationLight: return "\u{f74b}"
        case .locationRegular: return "\u{f74c}"
        case .longTextBoxBold: return "\u{f74d}"
        case .longTextBoxLight: return "\u{f74e}"
        case .longTextBoxRegular: return "\u{f74f}"
        case .lowerHandBold: return "\u{f750}"
        case .lowerHandLight: return "\u{f751}"
        case .lowerHandRegular: return "\u{f752}"
        case .magicPenBold: return "\u{f753}"
        case .magicPenFilled: return "\u{f754}"
        case .magicPenLight: return "\u{f755}"
        case .magicPenRegular: return "\u{f756}"
        case .markAsUnreadBold: return "\u{f757}"
        case .markAsUnreadFilled: return "\u{f758}"
        case .markAsUnreadLight: return "\u{f759}"
        case .markAsUnreadRegular: return "\u{f75a}"
        case .markdownBold: return "\u{f75b}"
        case .markdownFilled: return "\u{f75c}"
        case .markdownLight: return "\u{f75d}"
        case .markdownRegular: return "\u{f75e}"
        case .markerBold: return "\u{f75f}"
        case .markerFilled: return "\u{f760}"
        case .markerLight: return "\u{f761}"
        case .markerRegular: return "\u{f762}"
        case .maximizeBold: return "\u{f763}"
        case .maximizeLight: return "\u{f764}"
        case .maximizeRegular: return "\u{f765}"
        case .mcpBold: return "\u{f766}"
        case .mcpFilled: return "\u{f767}"
        case .mcpLight: return "\u{f768}"
        case .mcpRegular: return "\u{f769}"
        case .mediaPlayerBold: return "\u{f76a}"
        case .mediaPlayerLight: return "\u{f76b}"
        case .mediaPlayerRegular: return "\u{f76c}"
        case .mediaQualityGoodBold: return "\u{f76d}"
        case .mediaQualityGoodFilled: return "\u{f76e}"
        case .mediaQualityGoodLight: return "\u{f76f}"
        case .mediaQualityGoodRegular: return "\u{f770}"
        case .mediaQualityPoorBold: return "\u{f771}"
        case .mediaQualityPoorColoredBold: return "\u{f772}"
        case .mediaQualityPoorFilled: return "\u{f773}"
        case .mediaQualityPoorLight: return "\u{f774}"
        case .mediaQualityPoorRegular: return "\u{f775}"
        case .mediaQualityUnstableBold: return "\u{f776}"
        case .mediaQualityUnstableColoredBold: return "\u{f777}"
        case .mediaQualityUnstableFilled: return "\u{f778}"
        case .mediaQualityUnstableLight: return "\u{f779}"
        case .mediaQualityUnstableRegular: return "\u{f77a}"
        case .meetBold: return "\u{f77b}"
        case .meetEndBold: return "\u{f77c}"
        case .meetEndLight: return "\u{f77d}"
        case .meetEndRegular: return "\u{f77e}"
        case .meetFilled: return "\u{f77f}"
        case .meetLight: return "\u{f780}"
        case .meetRegular: return "\u{f781}"
        case .meetingSummaryBold: return "\u{f782}"
        case .meetingSummaryFilled: return "\u{f783}"
        case .meetingSummaryLight: return "\u{f784}"
        case .meetingSummaryRegular: return "\u{f785}"
        case .meetingsBold: return "\u{f786}"
        case .meetingsFilled: return "\u{f787}"
        case .meetingsFocusMonthBold: return "\u{f788}"
        case .meetingsFocusMonthLight: return "\u{f789}"
        case .meetingsFocusMonthRegular: return "\u{f78a}"
        case .meetingsFocusOneDayBold: return "\u{f78b}"
        case .meetingsFocusOneDayLight: return "\u{f78c}"
        case .meetingsFocusOneDayRegular: return "\u{f78d}"
        case .meetingsFocusThreeDayBold: return "\u{f78e}"
        case .meetingsFocusThreeDayLight: return "\u{f78f}"
        case .meetingsFocusThreeDayRegular: return "\u{f790}"
        case .meetingsFocusUpcomingBold: return "\u{f791}"
        case .meetingsFocusUpcomingLight: return "\u{f792}"
        case .meetingsFocusUpcomingRegular: return "\u{f793}"
        case .meetingsLight: return "\u{f794}"
        case .meetingsPresenceBadgeFilled: return "\u{f795}"
        case .meetingsPresenceBold: return "\u{f796}"
        case .meetingsPresenceFilled: return "\u{f797}"
        case .meetingsPresenceLight: return "\u{f798}"
        case .meetingsPresenceRegular: return "\u{f799}"
        case .meetingsRegular: return "\u{f79a}"
        case .meetingsTeamBold: return "\u{f79b}"
        case .meetingsTeamFilled: return "\u{f79c}"
        case .meetingsTeamLight: return "\u{f79d}"
        case .meetingsTeamNewBold: return "\u{f79e}"
        case .meetingsTeamNewLight: return "\u{f79f}"
        case .meetingsTeamNewRegular: return "\u{f7a0}"
        case .meetingsTeamRegular: return "\u{f7a1}"
        case .mentionBold: return "\u{f7a2}"
        case .mentionFilled: return "\u{f7a3}"
        case .mentionLight: return "\u{f7a4}"
        case .mentionRegular: return "\u{f7a5}"
        case .messageQueingBold: return "\u{f7a6}"
        case .messageQueingLight: return "\u{f7a7}"
        case .messageQueingRegular: return "\u{f7a8}"
        case .microphoneBold: return "\u{f7a9}"
        case .microphoneFilled: return "\u{f7aa}"
        case .microphoneHardMutedBold: return "\u{f7ab}"
        case .microphoneHardMutedCircleFilled: return "\u{f7ac}"
        case .microphoneHardMutedLight: return "\u{f7ad}"
        case .microphoneHardMutedRegular: return "\u{f7ae}"
        case .microphoneLight: return "\u{f7af}"
        case .microphoneMusicModeBold: return "\u{f7b0}"
        case .microphoneMusicModeLight: return "\u{f7b1}"
        case .microphoneMusicModeOnBold: return "\u{f7b2}"
        case .microphoneMusicModeOnLight: return "\u{f7b3}"
        case .microphoneMusicModeOnRegular: return "\u{f7b4}"
        case .microphoneMusicModeRegular: return "\u{f7b5}"
        case .microphoneMutedBold: return "\u{f7b6}"
        case .microphoneMutedCircleFilled: return "\u{f7b7}"
        case .microphoneMutedFilled: return "\u{f7b8}"
        case .microphoneMutedLight: return "\u{f7b9}"
        case .microphoneMutedRegular: return "\u{f7ba}"
        case .microphoneOnBold: return "\u{f7bb}"
        case .microphoneOnLight: return "\u{f7bc}"
        case .microphoneOnRegular: return "\u{f7bd}"
        case .microphoneOptAllBold: return "\u{f7be}"
        case .microphoneOptAllLight: return "\u{f7bf}"
        case .microphoneOptAllMutedBold: return "\u{f7c0}"
        case .microphoneOptAllMutedLight: return "\u{f7c1}"
        case .microphoneOptAllMutedRegular: return "\u{f7c2}"
        case .microphoneOptAllOnBold: return "\u{f7c3}"
        case .microphoneOptAllOnLight: return "\u{f7c4}"
        case .microphoneOptAllOnRegular: return "\u{f7c5}"
        case .microphoneOptAllRegular: return "\u{f7c6}"
        case .microphoneOptMeBold: return "\u{f7c7}"
        case .microphoneOptMeLight: return "\u{f7c8}"
        case .microphoneOptMeMutedBold: return "\u{f7c9}"
        case .microphoneOptMeMutedLight: return "\u{f7ca}"
        case .microphoneOptMeMutedRegular: return "\u{f7cb}"
        case .microphoneOptMeOnBold: return "\u{f7cc}"
        case .microphoneOptMeOnLight: return "\u{f7cd}"
        case .microphoneOptMeOnRegular: return "\u{f7ce}"
        case .microphoneOptMeRegular: return "\u{f7cf}"
        case .microphoneRegular: return "\u{f7d0}"
        case .mindMapBold: return "\u{f7d1}"
        case .mindMapLight: return "\u{f7d2}"
        case .mindMapRegular: return "\u{f7d3}"
        case .minimizeBold: return "\u{f7d4}"
        case .minimizeLight: return "\u{f7d5}"
        case .minimizeRegular: return "\u{f7d6}"
        case .minusBold: return "\u{f7d7}"
        case .minusFilled: return "\u{f7d8}"
        case .minusLight: return "\u{f7d9}"
        case .minusRegular: return "\u{f7da}"
        case .mirrorBold: return "\u{f7db}"
        case .mirrorFilled: return "\u{f7dc}"
        case .mirrorLight: return "\u{f7dd}"
        case .mirrorRegular: return "\u{f7de}"
        case .mmsFilled: return "\u{f7df}"
        case .moderatorBold: return "\u{f7e0}"
        case .moderatorLight: return "\u{f7e1}"
        case .moderatorRegular: return "\u{f7e2}"
        case .monitoringBold: return "\u{f7e3}"
        case .monitoringLight: return "\u{f7e4}"
        case .monitoringRegular: return "\u{f7e5}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7e6}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7e7}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7e8}"
        case .moreAdrBold: return "\u{f7e9}"
        case .moreAdrLight: return "\u{f7ea}"
        case .moreAdrRegular: return "\u{f7eb}"
        case .moreBold: return "\u{f7ec}"
        case .moreCircleBold: return "\u{f7ed}"
        case .moreCircleFilled: return "\u{f7ee}"
        case .moreCircleLight: return "\u{f7ef}"
        case .moreCircleRegular: return "\u{f7f0}"
        case .moreLight: return "\u{f7f1}"
        case .moreRegular: return "\u{f7f2}"
        case .mouseCursorBold: return "\u{f7f3}"
        case .mouseCursorLight: return "\u{f7f4}"
        case .mouseCursorRegular: return "\u{f7f5}"
        case .moveCallInAdrBold: return "\u{f7f6}"
        case .moveCallInAdrLight: return "\u{f7f7}"
        case .moveCallInAdrRegular: return "\u{f7f8}"
        case .moveCallInIphBold: return "\u{f7f9}"
        case .moveCallInIphLight: return "\u{f7fa}"
        case .moveCallInIphRegular: return "\u{f7fb}"
        case .moveCallInLaptopBold: return "\u{f7fc}"
        case .moveCallInLaptopLight: return "\u{f7fd}"
        case .moveCallInLaptopRegular: return "\u{f7fe}"
        case .moveCallInOutAdrBold: return "\u{f7ff}"
        case .moveCallInOutAdrLight: return "\u{f800}"
        case .moveCallInOutAdrRegular: return "\u{f801}"
        case .moveCallInOutIphBold: return "\u{f802}"
        case .moveCallInOutIphLight: return "\u{f803}"
        case .moveCallInOutIphRegular: return "\u{f804}"
        case .moveCallInTabletBold: return "\u{f805}"
        case .moveCallInTabletLight: return "\u{f806}"
        case .moveCallInTabletRegular: return "\u{f807}"
        case .moveCallOutAdrBold: return "\u{f808}"
        case .moveCallOutAdrLight: return "\u{f809}"
        case .moveCallOutAdrRegular: return "\u{f80a}"
        case .moveCallOutIphBold: return "\u{f80b}"
        case .moveCallOutIphLight: return "\u{f80c}"
        case .moveCallOutIphRegular: return "\u{f80d}"
        case .moveCallOutLaptopBold: return "\u{f80e}"
        case .moveCallOutLaptopLight: return "\u{f80f}"
        case .moveCallOutLaptopRegular: return "\u{f810}"
        case .moveCallOutTabletBold: return "\u{f811}"
        case .moveCallOutTabletLight: return "\u{f812}"
        case .moveCallOutTabletRegular: return "\u{f813}"
        case .moveToScreenBold: return "\u{f814}"
        case .moveToScreenLight: return "\u{f815}"
        case .moveToScreenRegular: return "\u{f816}"
        case .multilineChartBold: return "\u{f817}"
        case .multilineChartFilled: return "\u{f818}"
        case .multilineChartLight: return "\u{f819}"
        case .multilineChartRegular: return "\u{f81a}"
        case .multimediaBold: return "\u{f81b}"
        case .multimediaFilled: return "\u{f81c}"
        case .multimediaLight: return "\u{f81d}"
        case .multimediaRegular: return "\u{f81e}"
        case .multipledDevicesBold: return "\u{f81f}"
        case .multipledDevicesLight: return "\u{f820}"
        case .multipledDevicesRegular: return "\u{f821}"
        case .musicModeCircleBold: return "\u{f822}"
        case .musicModeCircleFilled: return "\u{f823}"
        case .musicModeCircleLight: return "\u{f824}"
        case .musicModeCircleRegular: return "\u{f825}"
        case .musicNoteBold: return "\u{f826}"
        case .musicNoteFilled: return "\u{f827}"
        case .musicNoteLight: return "\u{f828}"
        case .musicNoteRegular: return "\u{f829}"
        case .muteOnEntryBold: return "\u{f82a}"
        case .muteOnEntryFilled: return "\u{f82b}"
        case .muteOnEntryLight: return "\u{f82c}"
        case .muteOnEntryRegular: return "\u{f82d}"
        case .networkSwitchBold: return "\u{f82e}"
        case .networkSwitchFilled: return "\u{f82f}"
        case .networkSwitchLight: return "\u{f830}"
        case .networkSwitchRegular: return "\u{f831}"
        case .newManagerBold: return "\u{f832}"
        case .newManagerFilled: return "\u{f833}"
        case .newManagerLight: return "\u{f834}"
        case .newManagerRegular: return "\u{f835}"
        case .newTitleBold: return "\u{f836}"
        case .newTitleLight: return "\u{f837}"
        case .newTitleRegular: return "\u{f838}"
        case .newVoicemailBold: return "\u{f839}"
        case .newVoicemailLight: return "\u{f83a}"
        case .newVoicemailRegular: return "\u{f83b}"
        case .newWhiteboardBold: return "\u{f83c}"
        case .newWhiteboardLight: return "\u{f83d}"
        case .newWhiteboardRegular: return "\u{f83e}"
        case .nextBold: return "\u{f83f}"
        case .nextLight: return "\u{f840}"
        case .nextRegular: return "\u{f841}"
        case .noDevicesBold: return "\u{f842}"
        case .noDevicesLight: return "\u{f843}"
        case .noDevicesRegular: return "\u{f844}"
        case .noiseDetectedCanceledFilled: return "\u{f845}"
        case .noiseDetectedFilled: return "\u{f846}"
        case .noiseNoneCanceledFilled: return "\u{f847}"
        case .noiseNoneFilled: return "\u{f848}"
        case .noiseRemovalBold: return "\u{f849}"
        case .noiseRemovalLight: return "\u{f84a}"
        case .noiseRemovalRegular: return "\u{f84b}"
        case .noteBold: return "\u{f84c}"
        case .noteFilled: return "\u{f84d}"
        case .noteLight: return "\u{f84e}"
        case .notePptBold: return "\u{f84f}"
        case .notePptLight: return "\u{f850}"
        case .notePptRegular: return "\u{f851}"
        case .noteRegular: return "\u{f852}"
        case .notesBold: return "\u{f853}"
        case .notesFilled: return "\u{f854}"
        case .notesLight: return "\u{f855}"
        case .notesRegular: return "\u{f856}"
        case .numberBold: return "\u{f857}"
        case .numberLight: return "\u{f858}"
        case .numberRegular: return "\u{f859}"
        case .oldRemoteBold: return "\u{f85a}"
        case .oldRemoteLight: return "\u{f85b}"
        case .oldRemoteRegular: return "\u{f85c}"
        case .oldTouchBold: return "\u{f85d}"
        case .oldTouchLight: return "\u{f85e}"
        case .oldTouchRegular: return "\u{f85f}"
        case .oneColumnBold: return "\u{f860}"
        case .oneColumnLight: return "\u{f861}"
        case .oneColumnRegular: return "\u{f862}"
        case .oneTimeBold: return "\u{f863}"
        case .oneTimeLight: return "\u{f864}"
        case .oneTimeRegular: return "\u{f865}"
        case .openInFolderBold: return "\u{f866}"
        case .openInFolderFilled: return "\u{f867}"
        case .openInFolderLight: return "\u{f868}"
        case .openInFolderRegular: return "\u{f869}"
        case .openPagesBold: return "\u{f86a}"
        case .openPagesLight: return "\u{f86b}"
        case .openPagesRegular: return "\u{f86c}"
        case .otherNumberBold: return "\u{f86d}"
        case .otherNumberFilled: return "\u{f86e}"
        case .otherNumberLight: return "\u{f86f}"
        case .otherNumberRegular: return "\u{f870}"
        case .otherNumberWarningBold: return "\u{f871}"
        case .otherNumberWarningLight: return "\u{f872}"
        case .otherNumberWarningRegular: return "\u{f873}"
        case .outgoingCallLegacyBold: return "\u{f874}"
        case .outgoingCallLegacyFilled: return "\u{f875}"
        case .outgoingCallLegacyLight: return "\u{f876}"
        case .outgoingCallLegacyRegular: return "\u{f877}"
        case .overflowLeftBold: return "\u{f878}"
        case .overflowLeftLight: return "\u{f879}"
        case .overflowLeftRegular: return "\u{f87a}"
        case .overflowRightBold: return "\u{f87b}"
        case .overflowRightLight: return "\u{f87c}"
        case .overflowRightRegular: return "\u{f87d}"
        case .pairedCameraBold: return "\u{f87e}"
        case .pairedCameraLight: return "\u{f87f}"
        case .pairedCameraRegular: return "\u{f880}"
        case .pairedDeviceBold: return "\u{f881}"
        case .pairedDeviceLight: return "\u{f882}"
        case .pairedDeviceRegular: return "\u{f883}"
        case .pairedHandsetBold: return "\u{f884}"
        case .pairedHandsetLight: return "\u{f885}"
        case .pairedHandsetRegular: return "\u{f886}"
        case .pairingBold: return "\u{f887}"
        case .pairingLight: return "\u{f888}"
        case .pairingRegular: return "\u{f889}"
        case .parenthesisBold: return "\u{f88a}"
        case .parenthesisFilled: return "\u{f88b}"
        case .parenthesisLight: return "\u{f88c}"
        case .parenthesisRegular: return "\u{f88d}"
        case .parkedBold: return "\u{f88e}"
        case .parkedFilled: return "\u{f88f}"
        case .parkedLight: return "\u{f890}"
        case .parkedRegular: return "\u{f891}"
        case .parseBold: return "\u{f892}"
        case .parseLight: return "\u{f893}"
        case .parseRegular: return "\u{f894}"
        case .partialBold: return "\u{f895}"
        case .partialLight: return "\u{f896}"
        case .partialRegular: return "\u{f897}"
        case .participantAddBold: return "\u{f898}"
        case .participantAddLight: return "\u{f899}"
        case .participantAddRegular: return "\u{f89a}"
        case .participantBlockedBold: return "\u{f89b}"
        case .participantBlockedLight: return "\u{f89c}"
        case .participantBlockedRegular: return "\u{f89d}"
        case .participantBold: return "\u{f89e}"
        case .participantFilled: return "\u{f89f}"
        case .participantLight: return "\u{f8a0}"
        case .participantListBold: return "\u{f8a1}"
        case .participantListFilled: return "\u{f8a2}"
        case .participantListLight: return "\u{f8a3}"
        case .participantListRegular: return "\u{f8a4}"
        case .participantRegular: return "\u{f8a5}"
        case .participantRemoveBold: return "\u{f8a6}"
        case .participantRemoveLight: return "\u{f8a7}"
        case .participantRemoveRegular: return "\u{f8a8}"
        case .participantSpeakerBold: return "\u{f8a9}"
        case .participantSpeakerFilled: return "\u{f8aa}"
        case .participantSpeakerLight: return "\u{f8ab}"
        case .participantSpeakerRegular: return "\u{f8ac}"
        case .participantUnknownBold: return "\u{f8ad}"
        case .participantUnknownLight: return "\u{f8ae}"
        case .participantUnknownRegular: return "\u{f8af}"
        case .passMouseBold: return "\u{f8b0}"
        case .passMouseLight: return "\u{f8b1}"
        case .passMouseRegular: return "\u{f8b2}"
        case .pauseBadgeFilled: return "\u{f8b3}"
        case .pauseBold: return "\u{f8b4}"
        case .pauseFilled: return "\u{f8b5}"
        case .pauseInteractionBold: return "\u{f8b6}"
        case .pauseInteractionFilled: return "\u{f8b7}"
        case .pauseInteractionLight: return "\u{f8b8}"
        case .pauseInteractionRegular: return "\u{f8b9}"
        case .pauseLight: return "\u{f8ba}"
        case .pauseRegular: return "\u{f8bb}"
        case .peopleAddBold: return "\u{f8bc}"
        case .peopleAddFilled: return "\u{f8bd}"
        case .peopleAddLight: return "\u{f8be}"
        case .peopleAddRegular: return "\u{f8bf}"
        case .peopleBold: return "\u{f8c0}"
        case .peopleCircleBold: return "\u{f8c1}"
        case .peopleCircleFilled: return "\u{f8c2}"
        case .peopleCircleLight: return "\u{f8c3}"
        case .peopleCircleRegular: return "\u{f8c4}"
        case .peopleFilled: return "\u{f8c5}"
        case .peopleInsightsBold: return "\u{f8c6}"
        case .peopleInsightsFilled: return "\u{f8c7}"
        case .peopleInsightsLight: return "\u{f8c8}"
        case .peopleInsightsRegular: return "\u{f8c9}"
        case .peopleLight: return "\u{f8ca}"
        case .peopleManageBold: return "\u{f8cb}"
        case .peopleManageFilled: return "\u{f8cc}"
        case .peopleManageLight: return "\u{f8cd}"
        case .peopleManageRegular: return "\u{f8ce}"
        case .peopleRegular: return "\u{f8cf}"
        case .phoneAlertBold: return "\u{f8d0}"
        case .phoneAlertLight: return "\u{f8d1}"
        case .phoneAlertRegular: return "\u{f8d2}"
        case .phoneBadgeFilled: return "\u{f8d3}"
        case .phoneBold: return "\u{f8d4}"
        case .phoneFilled: return "\u{f8d5}"
        case .phoneLight: return "\u{f8d6}"
        case .phoneMutedBold: return "\u{f8d7}"
        case .phoneMutedLight: return "\u{f8d8}"
        case .phoneMutedRegular: return "\u{f8d9}"
        case .phonePrivateBold: return "\u{f8da}"
        case .phonePrivateLight: return "\u{f8db}"
        case .phonePrivateRegular: return "\u{f8dc}"
        case .phoneRegular: return "\u{f8dd}"
        case .phoneReplyAllBold: return "\u{f8de}"
        case .phoneReplyAllLight: return "\u{f8df}"
        case .phoneReplyAllRegular: return "\u{f8e0}"
        case .phoneReplyBold: return "\u{f8e1}"
        case .phoneReplyLight: return "\u{f8e2}"
        case .phoneReplyRegular: return "\u{f8e3}"
        case .pickerBold: return "\u{f8e4}"
        case .pickerLight: return "\u{f8e5}"
        case .pickerRegular: return "\u{f8e6}"
        case .pieChartBold: return "\u{f8e7}"
        case .pieChartFilled: return "\u{f8e8}"
        case .pieChartLight: return "\u{f8e9}"
        case .pieChartRegular: return "\u{f8ea}"
        case .pinBold: return "\u{f8eb}"
        case .pinFilled: return "\u{f8ec}"
        case .pinLight: return "\u{f8ed}"
        case .pinListActivityBold: return "\u{f8ee}"
        case .pinListActivityLight: return "\u{f8ef}"
        case .pinListActivityRegular: return "\u{f8f0}"
        case .pinListBold: return "\u{f8f1}"
        case .pinListLight: return "\u{f8f2}"
        case .pinListRegular: return "\u{f8f3}"
        case .pinMutedBold: return "\u{f8f4}"
        case .pinMutedFilled: return "\u{f8f5}"
        case .pinMutedLight: return "\u{f8f6}"
        case .pinMutedRegular: return "\u{f8f7}"
        case .pinRegular: return "\u{f8f8}"
        case .pipBold: return "\u{f8f9}"
        case .pipEnterBold: return "\u{f8fa}"
        case .pipEnterLight: return "\u{f8fb}"
        case .pipEnterRegular: return "\u{f8fc}"
        case .pipExitBold: return "\u{f8fd}"
        case .pipExitLight: return "\u{f8fe}"
        case .pipExitRegular: return "\u{f8ff}"
        case .pipFilled: return "\u{f900}"
        case .pipLight: return "\u{f901}"
        case .pipRegular: return "\u{f902}"
        case .placeholderBold: return "\u{f903}"
        case .placeholderFilled: return "\u{f904}"
        case .placeholderLight: return "\u{f905}"
        case .placeholderRegular: return "\u{f906}"
        case .playBold: return "\u{f907}"
        case .playCircleBold: return "\u{f908}"
        case .playCircleFilled: return "\u{f909}"
        case .playCircleLight: return "\u{f90a}"
        case .playCircleRegular: return "\u{f90b}"
        case .playFilled: return "\u{f90c}"
        case .playLight: return "\u{f90d}"
        case .playRegular: return "\u{f90e}"
        case .plugAcBold: return "\u{f90f}"
        case .plugAcLight: return "\u{f910}"
        case .plugAcRegular: return "\u{f911}"
        case .plusBold: return "\u{f912}"
        case .plusCircleBold: return "\u{f913}"
        case .plusCircleFilled: return "\u{f914}"
        case .plusCircleLight: return "\u{f915}"
        case .plusCircleRegular: return "\u{f916}"
        case .plusLight: return "\u{f917}"
        case .plusRegular: return "\u{f918}"
        case .pmrBold: return "\u{f919}"
        case .pmrFilled: return "\u{f91a}"
        case .pmrLight: return "\u{f91b}"
        case .pmrRegular: return "\u{f91c}"
        case .pollBold: return "\u{f91d}"
        case .pollFilled: return "\u{f91e}"
        case .pollLight: return "\u{f91f}"
        case .pollRegular: return "\u{f920}"
        case .popInBold: return "\u{f921}"
        case .popInLight: return "\u{f922}"
        case .popInRegular: return "\u{f923}"
        case .popOutBold: return "\u{f924}"
        case .popOutLight: return "\u{f925}"
        case .popOutRegular: return "\u{f926}"
        case .popUpBold: return "\u{f927}"
        case .popUpLight: return "\u{f928}"
        case .popUpRegular: return "\u{f929}"
        case .portraitLandscapeBold: return "\u{f92a}"
        case .portraitLandscapeLight: return "\u{f92b}"
        case .portraitLandscapeRegular: return "\u{f92c}"
        case .potentialFraudBold: return "\u{f92d}"
        case .potentialFraudFilled: return "\u{f92e}"
        case .potentialFraudLight: return "\u{f92f}"
        case .potentialFraudRegular: return "\u{f930}"
        case .powerAcBold: return "\u{f931}"
        case .powerAcLight: return "\u{f932}"
        case .powerAcRegular: return "\u{f933}"
        case .powerBold: return "\u{f934}"
        case .powerLight: return "\u{f935}"
        case .powerRegular: return "\u{f936}"
        case .preHeaderBold: return "\u{f937}"
        case .preHeaderLight: return "\u{f938}"
        case .preHeaderRegular: return "\u{f939}"
        case .premiumBold: return "\u{f93a}"
        case .premiumLight: return "\u{f93b}"
        case .premiumRegular: return "\u{f93c}"
        case .presentationBold: return "\u{f93d}"
        case .presentationLight: return "\u{f93e}"
        case .presentationRegular: return "\u{f93f}"
        case .preventDownloadBold: return "\u{f940}"
        case .preventDownloadFilled: return "\u{f941}"
        case .preventDownloadLight: return "\u{f942}"
        case .preventDownloadRegular: return "\u{f943}"
        case .primaryParticipantBold: return "\u{f944}"
        case .primaryParticipantFilled: return "\u{f945}"
        case .primaryParticipantLight: return "\u{f946}"
        case .primaryParticipantRegular: return "\u{f947}"
        case .printBold: return "\u{f948}"
        case .printLight: return "\u{f949}"
        case .printRegular: return "\u{f94a}"
        case .priorityBadgeFilled: return "\u{f94b}"
        case .priorityCircleBold: return "\u{f94c}"
        case .priorityCircleFilled: return "\u{f94d}"
        case .priorityCircleLight: return "\u{f94e}"
        case .priorityCircleRegular: return "\u{f94f}"
        case .priorityCircleTwoBold: return "\u{f950}"
        case .priorityCircleTwoFilled: return "\u{f951}"
        case .priorityCircleTwoLight: return "\u{f952}"
        case .priorityCircleTwoRegular: return "\u{f953}"
        case .priorityWaveBold: return "\u{f954}"
        case .priorityWaveLight: return "\u{f955}"
        case .priorityWaveRegular: return "\u{f956}"
        case .privacyCircleBold: return "\u{f957}"
        case .privacyCircleFilled: return "\u{f958}"
        case .privacyCircleLight: return "\u{f959}"
        case .privacyCircleRegular: return "\u{f95a}"
        case .privateBold: return "\u{f95b}"
        case .privateCircleBold: return "\u{f95c}"
        case .privateCircleFilled: return "\u{f95d}"
        case .privateCircleLight: return "\u{f95e}"
        case .privateCircleRegular: return "\u{f95f}"
        case .privateLight: return "\u{f960}"
        case .privateMeetingBold: return "\u{f961}"
        case .privateMeetingLight: return "\u{f962}"
        case .privateMeetingRegular: return "\u{f963}"
        case .privateRegular: return "\u{f964}"
        case .productDemoBold: return "\u{f965}"
        case .productDemoLight: return "\u{f966}"
        case .productDemoRegular: return "\u{f967}"
        case .promptsAiBold: return "\u{f968}"
        case .promptsAiLight: return "\u{f969}"
        case .promptsAiRegular: return "\u{f96a}"
        case .proximityBold: return "\u{f96b}"
        case .proximityLight: return "\u{f96c}"
        case .proximityMutedBold: return "\u{f96d}"
        case .proximityMutedLight: return "\u{f96e}"
        case .proximityMutedRegular: return "\u{f96f}"
        case .proximityRegular: return "\u{f970}"
        case .proximityVideoBold: return "\u{f971}"
        case .proximityVideoLight: return "\u{f972}"
        case .proximityVideoRegular: return "\u{f973}"
        case .ptoPresenceBold: return "\u{f974}"
        case .ptoPresenceFilled: return "\u{f975}"
        case .ptoPresenceLight: return "\u{f976}"
        case .ptoPresenceRegular: return "\u{f977}"
        case .pullCallBold: return "\u{f978}"
        case .pullCallFilled: return "\u{f979}"
        case .pullCallLight: return "\u{f97a}"
        case .pullCallRegular: return "\u{f97b}"
        case .purchaseOrderBold: return "\u{f97c}"
        case .purchaseOrderFilled: return "\u{f97d}"
        case .purchaseOrderLight: return "\u{f97e}"
        case .purchaseOrderRegular: return "\u{f97f}"
        case .qABold: return "\u{f980}"
        case .qAFilled: return "\u{f981}"
        case .qALight: return "\u{f982}"
        case .qARegular: return "\u{f983}"
        case .qrCodeBold: return "\u{f984}"
        case .qrCodeLight: return "\u{f985}"
        case .qrCodeRegular: return "\u{f986}"
        case .qrCodeScanBold: return "\u{f987}"
        case .qrCodeScanLight: return "\u{f988}"
        case .qrCodeScanRegular: return "\u{f989}"
        case .qualityBold: return "\u{f98a}"
        case .qualityLight: return "\u{f98b}"
        case .qualityRegular: return "\u{f98c}"
        case .queueContactBold: return "\u{f98d}"
        case .queueContactFilled: return "\u{f98e}"
        case .queueContactLight: return "\u{f98f}"
        case .queueContactRegular: return "\u{f990}"
        case .queuedInteractionBold: return "\u{f991}"
        case .queuedInteractionFilled: return "\u{f992}"
        case .queuedInteractionLight: return "\u{f993}"
        case .queuedInteractionRegular: return "\u{f994}"
        case .quietBold: return "\u{f995}"
        case .quietHoursPresenceBold: return "\u{f996}"
        case .quietHoursPresenceFilled: return "\u{f997}"
        case .quietHoursPresenceLight: return "\u{f998}"
        case .quietHoursPresenceRegular: return "\u{f999}"
        case .quietLight: return "\u{f99a}"
        case .quietRegular: return "\u{f99b}"
        case .radioButtonGroupBold: return "\u{f99c}"
        case .radioButtonGroupLight: return "\u{f99d}"
        case .radioButtonGroupRegular: return "\u{f99e}"
        case .raiseHandBold: return "\u{f99f}"
        case .raiseHandCircleFilled: return "\u{f9a0}"
        case .raiseHandFilled: return "\u{f9a1}"
        case .raiseHandLight: return "\u{f9a2}"
        case .raiseHandRegular: return "\u{f9a3}"
        case .ramBold: return "\u{f9a4}"
        case .ramLight: return "\u{f9a5}"
        case .ramRegular: return "\u{f9a6}"
        case .reactionsBold: return "\u{f9a7}"
        case .reactionsFilled: return "\u{f9a8}"
        case .reactionsLight: return "\u{f9a9}"
        case .reactionsRegular: return "\u{f9aa}"
        case .reactivateBold: return "\u{f9ab}"
        case .reactivateLight: return "\u{f9ac}"
        case .reactivateRegular: return "\u{f9ad}"
        case .receiveVoiceBold: return "\u{f9ae}"
        case .receiveVoiceFilled: return "\u{f9af}"
        case .receiveVoiceLight: return "\u{f9b0}"
        case .receiveVoiceRegular: return "\u{f9b1}"
        case .recentsBold: return "\u{f9b2}"
        case .recentsFilled: return "\u{f9b3}"
        case .recentsLight: return "\u{f9b4}"
        case .recentsPresenceBadgeFilled: return "\u{f9b5}"
        case .recentsPresenceBold: return "\u{f9b6}"
        case .recentsPresenceFilled: return "\u{f9b7}"
        case .recentsPresenceLight: return "\u{f9b8}"
        case .recentsPresenceRegular: return "\u{f9b9}"
        case .recentsRegular: return "\u{f9ba}"
        case .recordActiveBadgeFilled: return "\u{f9bb}"
        case .recordActiveBold: return "\u{f9bc}"
        case .recordActiveFilled: return "\u{f9bd}"
        case .recordActiveLight: return "\u{f9be}"
        case .recordActiveRegular: return "\u{f9bf}"
        case .recordBold: return "\u{f9c0}"
        case .recordFilled: return "\u{f9c1}"
        case .recordLight: return "\u{f9c2}"
        case .recordPausedBadgeFilled: return "\u{f9c3}"
        case .recordPausedBold: return "\u{f9c4}"
        case .recordPausedFilled: return "\u{f9c5}"
        case .recordPausedLight: return "\u{f9c6}"
        case .recordPausedRegular: return "\u{f9c7}"
        case .recordRegular: return "\u{f9c8}"
        case .recurringBold: return "\u{f9c9}"
        case .recurringLight: return "\u{f9ca}"
        case .recurringOffBold: return "\u{f9cb}"
        case .recurringOffLight: return "\u{f9cc}"
        case .recurringOffRegular: return "\u{f9cd}"
        case .recurringRegular: return "\u{f9ce}"
        case .redoBold: return "\u{f9cf}"
        case .redoLight: return "\u{f9d0}"
        case .redoRegular: return "\u{f9d1}"
        case .refreshBold: return "\u{f9d2}"
        case .refreshLight: return "\u{f9d3}"
        case .refreshRegular: return "\u{f9d4}"
        case .remoteDesktopControlBold: return "\u{f9d5}"
        case .remoteDesktopControlFilled: return "\u{f9d6}"
        case .remoteDesktopControlLight: return "\u{f9d7}"
        case .remoteDesktopControlRegular: return "\u{f9d8}"
        case .removeBold: return "\u{f9d9}"
        case .removeFilled: return "\u{f9da}"
        case .removeLight: return "\u{f9db}"
        case .removeRegular: return "\u{f9dc}"
        case .replyBold: return "\u{f9dd}"
        case .replyFilled: return "\u{f9de}"
        case .replyLight: return "\u{f9df}"
        case .replyListBold: return "\u{f9e0}"
        case .replyListFilled: return "\u{f9e1}"
        case .replyListLight: return "\u{f9e2}"
        case .replyListRegular: return "\u{f9e3}"
        case .replyPrivatelyBold: return "\u{f9e4}"
        case .replyPrivatelyLight: return "\u{f9e5}"
        case .replyPrivatelyRegular: return "\u{f9e6}"
        case .replyRegular: return "\u{f9e7}"
        case .resetBold: return "\u{f9e8}"
        case .resetLight: return "\u{f9e9}"
        case .resetRegular: return "\u{f9ea}"
        case .resizeCornerBold: return "\u{f9eb}"
        case .resizeCornerLight: return "\u{f9ec}"
        case .resizeCornerRegular: return "\u{f9ed}"
        case .responsiveMobileBold: return "\u{f9ee}"
        case .responsiveMobileLight: return "\u{f9ef}"
        case .responsiveMobileRegular: return "\u{f9f0}"
        case .restartBold: return "\u{f9f1}"
        case .restartLight: return "\u{f9f2}"
        case .restartRegular: return "\u{f9f3}"
        case .resumeInteractionBold: return "\u{f9f4}"
        case .resumeInteractionFilled: return "\u{f9f5}"
        case .resumeInteractionLight: return "\u{f9f6}"
        case .resumeInteractionRegular: return "\u{f9f7}"
        case .retrieveCallBold: return "\u{f9f8}"
        case .retrieveCallFilled: return "\u{f9f9}"
        case .retrieveCallLight: return "\u{f9fa}"
        case .retrieveCallRegular: return "\u{f9fb}"
        case .returnBold: return "\u{f9fc}"
        case .returnLight: return "\u{f9fd}"
        case .returnRegular: return "\u{f9fe}"
        case .rewindTenSecBold: return "\u{f9ff}"
        case .rewindTenSecLight: return "\u{fa00}"
        case .rewindTenSecRegular: return "\u{fa01}"
        case .ringtoneBold: return "\u{fa02}"
        case .ringtoneLight: return "\u{fa03}"
        case .ringtoneRegular: return "\u{fa04}"
        case .roomCalendarBold: return "\u{fa05}"
        case .roomCalendarLight: return "\u{fa06}"
        case .roomCalendarRegular: return "\u{fa07}"
        case .roomLightsBold: return "\u{fa08}"
        case .roomLightsFilled: return "\u{fa09}"
        case .roomLightsLight: return "\u{fa0a}"
        case .roomLightsRegular: return "\u{fa0b}"
        case .rotateContentBold: return "\u{fa0c}"
        case .rotateContentFilled: return "\u{fa0d}"
        case .rotateContentLight: return "\u{fa0e}"
        case .rotateContentRegular: return "\u{fa0f}"
        case .rssBold: return "\u{fa10}"
        case .rssFilled: return "\u{fa11}"
        case .rssLight: return "\u{fa12}"
        case .rssRegular: return "\u{fa13}"
        case .ruleBasedBold: return "\u{fa14}"
        case .ruleBasedLight: return "\u{fa15}"
        case .ruleBasedRegular: return "\u{fa16}"
        case .rulerBold: return "\u{fa17}"
        case .rulerFilled: return "\u{fa18}"
        case .rulerLight: return "\u{fa19}"
        case .rulerRegular: return "\u{fa1a}"
        case .runningApplicationBold: return "\u{fa1b}"
        case .runningApplicationFilled: return "\u{fa1c}"
        case .runningApplicationLight: return "\u{fa1d}"
        case .runningApplicationRegular: return "\u{fa1e}"
        case .saveBold: return "\u{fa1f}"
        case .saveLight: return "\u{fa20}"
        case .saveRegular: return "\u{fa21}"
        case .saveTranscriptBold: return "\u{fa22}"
        case .saveTranscriptFilled: return "\u{fa23}"
        case .saveTranscriptLight: return "\u{fa24}"
        case .saveTranscriptRegular: return "\u{fa25}"
        case .scanBold: return "\u{fa26}"
        case .scanLight: return "\u{fa27}"
        case .scanRegular: return "\u{fa28}"
        case .scheduleAiBold: return "\u{fa29}"
        case .scheduleAiLight: return "\u{fa2a}"
        case .scheduleAiRegular: return "\u{fa2b}"
        case .scheduleSendBold: return "\u{fa2c}"
        case .scheduleSendFilled: return "\u{fa2d}"
        case .scheduleSendLight: return "\u{fa2e}"
        case .scheduleSendRegular: return "\u{fa2f}"
        case .scheduleWinnerBold: return "\u{fa30}"
        case .scheduleWinnerFilled: return "\u{fa31}"
        case .scheduleWinnerLight: return "\u{fa32}"
        case .scheduleWinnerRegular: return "\u{fa33}"
        case .schedulerAvailableBold: return "\u{fa34}"
        case .schedulerAvailableLight: return "\u{fa35}"
        case .schedulerAvailableRegular: return "\u{fa36}"
        case .schedulerNotWorkingHoursBold: return "\u{fa37}"
        case .schedulerNotWorkingHoursLight: return "\u{fa38}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa39}"
        case .schedulerUnavailableBold: return "\u{fa3a}"
        case .schedulerUnavailableLight: return "\u{fa3b}"
        case .schedulerUnavailableRegular: return "\u{fa3c}"
        case .schedulerUnknownBold: return "\u{fa3d}"
        case .schedulerUnknownLight: return "\u{fa3e}"
        case .schedulerUnknownRegular: return "\u{fa3f}"
        case .screenshotBold: return "\u{fa40}"
        case .screenshotDocBold: return "\u{fa41}"
        case .screenshotDocFilled: return "\u{fa42}"
        case .screenshotDocLight: return "\u{fa43}"
        case .screenshotDocRegular: return "\u{fa44}"
        case .screenshotLight: return "\u{fa45}"
        case .screenshotRegular: return "\u{fa46}"
        case .searchAiBold: return "\u{fa47}"
        case .searchAiLight: return "\u{fa48}"
        case .searchAiRegular: return "\u{fa49}"
        case .searchBold: return "\u{fa4a}"
        case .searchFilled: return "\u{fa4b}"
        case .searchLight: return "\u{fa4c}"
        case .searchRegular: return "\u{fa4d}"
        case .secondaryArrowBold: return "\u{fa4e}"
        case .secondaryArrowLight: return "\u{fa4f}"
        case .secondaryArrowRegular: return "\u{fa50}"
        case .secureCallLockBold: return "\u{fa51}"
        case .secureCallLockFilled: return "\u{fa52}"
        case .secureCallLockLight: return "\u{fa53}"
        case .secureCallLockRegular: return "\u{fa54}"
        case .secureCallShieldBold: return "\u{fa55}"
        case .secureCallShieldFilled: return "\u{fa56}"
        case .secureCallShieldLight: return "\u{fa57}"
        case .secureCallShieldRegular: return "\u{fa58}"
        case .secureCircleBold: return "\u{fa59}"
        case .secureCircleFilled: return "\u{fa5a}"
        case .secureCircleLight: return "\u{fa5b}"
        case .secureCircleRegular: return "\u{fa5c}"
        case .secureLockBold: return "\u{fa5d}"
        case .secureLockFilled: return "\u{fa5e}"
        case .secureLockLight: return "\u{fa5f}"
        case .secureLockRegular: return "\u{fa60}"
        case .segmentExcludeFilled: return "\u{fa61}"
        case .segmentFilterFilled: return "\u{fa62}"
        case .segmentIncludeFilled: return "\u{fa63}"
        case .selectAllBold: return "\u{fa64}"
        case .selectAllFilled: return "\u{fa65}"
        case .selectAllLight: return "\u{fa66}"
        case .selectAllRegular: return "\u{fa67}"
        case .selectionBold: return "\u{fa68}"
        case .selectionFilled: return "\u{fa69}"
        case .selectionLight: return "\u{fa6a}"
        case .selectionRegular: return "\u{fa6b}"
        case .sendBold: return "\u{fa6c}"
        case .sendDigitsBold: return "\u{fa6d}"
        case .sendDigitsFilled: return "\u{fa6e}"
        case .sendDigitsLight: return "\u{fa6f}"
        case .sendDigitsRegular: return "\u{fa70}"
        case .sendFilled: return "\u{fa71}"
        case .sendLight: return "\u{fa72}"
        case .sendRegular: return "\u{fa73}"
        case .sendVoiceBold: return "\u{fa74}"
        case .sendVoiceFilled: return "\u{fa75}"
        case .sendVoiceLight: return "\u{fa76}"
        case .sendVoiceRegular: return "\u{fa77}"
        case .serverBold: return "\u{fa78}"
        case .serverErrorBold: return "\u{fa79}"
        case .serverErrorLight: return "\u{fa7a}"
        case .serverErrorRegular: return "\u{fa7b}"
        case .serverLight: return "\u{fa7c}"
        case .serverRegular: return "\u{fa7d}"
        case .servicesBold: return "\u{fa7e}"
        case .servicesLight: return "\u{fa7f}"
        case .servicesRegular: return "\u{fa80}"
        case .setVariableBold: return "\u{fa81}"
        case .setVariableLight: return "\u{fa82}"
        case .setVariableRegular: return "\u{fa83}"
        case .settingsBold: return "\u{fa84}"
        case .settingsFilled: return "\u{fa85}"
        case .settingsLight: return "\u{fa86}"
        case .settingsRegular: return "\u{fa87}"
        case .setupAssistantBold: return "\u{fa88}"
        case .setupAssistantLight: return "\u{fa89}"
        case .setupAssistantRegular: return "\u{fa8a}"
        case .sftpBold: return "\u{fa8b}"
        case .sftpLight: return "\u{fa8c}"
        case .sftpRegular: return "\u{fa8d}"
        case .shapeCircleBold: return "\u{fa8e}"
        case .shapeCircleFilled: return "\u{fa8f}"
        case .shapeCircleLight: return "\u{fa90}"
        case .shapeCircleMdFilled: return "\u{fa91}"
        case .shapeCircleRegular: return "\u{fa92}"
        case .shapeCircleSmFilled: return "\u{fa93}"
        case .shapeDiagonalLineBold: return "\u{fa94}"
        case .shapeDiagonalLineLight: return "\u{fa95}"
        case .shapeDiagonalLineRegular: return "\u{fa96}"
        case .shapeDiamondBold: return "\u{fa97}"
        case .shapeDiamondFilled: return "\u{fa98}"
        case .shapeDiamondLight: return "\u{fa99}"
        case .shapeDiamondRegular: return "\u{fa9a}"
        case .shapeOvalBold: return "\u{fa9b}"
        case .shapeOvalLight: return "\u{fa9c}"
        case .shapeOvalRegular: return "\u{fa9d}"
        case .shapeSquareBold: return "\u{fa9e}"
        case .shapeSquareFilled: return "\u{fa9f}"
        case .shapeSquareLight: return "\u{faa0}"
        case .shapeSquareRegular: return "\u{faa1}"
        case .shapeTriangleBold: return "\u{faa2}"
        case .shapeTriangleFilled: return "\u{faa3}"
        case .shapeTriangleLight: return "\u{faa4}"
        case .shapeTriangleRegular: return "\u{faa5}"
        case .shapesBold: return "\u{faa6}"
        case .shapesFilled: return "\u{faa7}"
        case .shapesLight: return "\u{faa8}"
        case .shapesRegular: return "\u{faa9}"
        case .shareCNativeAdrBold: return "\u{faaa}"
        case .shareCNativeAdrFilled: return "\u{faab}"
        case .shareCNativeAdrLight: return "\u{faac}"
        case .shareCNativeAdrRegular: return "\u{faad}"
        case .shareCNativeIphBold: return "\u{faae}"
        case .shareCNativeIphLight: return "\u{faaf}"
        case .shareCNativeIphRegular: return "\u{fab0}"
        case .shareContentOnDeviceBold: return "\u{fab1}"
        case .shareContentOnDeviceLight: return "\u{fab2}"
        case .shareContentOnDeviceRegular: return "\u{fab3}"
        case .shareScreenAddBold: return "\u{fab4}"
        case .shareScreenAddLight: return "\u{fab5}"
        case .shareScreenAddRegular: return "\u{fab6}"
        case .shareScreenBadgeFilled: return "\u{fab7}"
        case .shareScreenBold: return "\u{fab8}"
        case .shareScreenFilled: return "\u{fab9}"
        case .shareScreenLight: return "\u{faba}"
        case .shareScreenRegular: return "\u{fabb}"
        case .shareSpaceBold: return "\u{fabc}"
        case .shareSpaceLight: return "\u{fabd}"
        case .shareSpaceRegular: return "\u{fabe}"
        case .shieldBold: return "\u{fabf}"
        case .shieldLight: return "\u{fac0}"
        case .shieldRegular: return "\u{fac1}"
        case .shoppingCartBold: return "\u{fac2}"
        case .shoppingCartFilled: return "\u{fac3}"
        case .shoppingCartLight: return "\u{fac4}"
        case .shoppingCartRegular: return "\u{fac5}"
        case .shortTextBoxBold: return "\u{fac6}"
        case .shortTextBoxLight: return "\u{fac7}"
        case .shortTextBoxRegular: return "\u{fac8}"
        case .showBold: return "\u{fac9}"
        case .showFilled: return "\u{faca}"
        case .showLight: return "\u{facb}"
        case .showRegular: return "\u{facc}"
        case .sidePanelBold: return "\u{facd}"
        case .sidePanelFilled: return "\u{face}"
        case .sidePanelLight: return "\u{facf}"
        case .sidePanelRegular: return "\u{fad0}"
        case .signInBold: return "\u{fad1}"
        case .signInFilled: return "\u{fad2}"
        case .signInForcedBold: return "\u{fad3}"
        case .signInForcedLight: return "\u{fad4}"
        case .signInForcedRegular: return "\u{fad5}"
        case .signInLight: return "\u{fad6}"
        case .signInRegular: return "\u{fad7}"
        case .signLangIntBold: return "\u{fad8}"
        case .signLangIntLight: return "\u{fad9}"
        case .signLangIntRegular: return "\u{fada}"
        case .signOutBold: return "\u{fadb}"
        case .signOutLight: return "\u{fadc}"
        case .signOutRegular: return "\u{fadd}"
        case .signalFourBold: return "\u{fade}"
        case .signalFourLight: return "\u{fadf}"
        case .signalFourRegular: return "\u{fae0}"
        case .signalOneBold: return "\u{fae1}"
        case .signalOneLight: return "\u{fae2}"
        case .signalOneRegular: return "\u{fae3}"
        case .signalThreeBold: return "\u{fae4}"
        case .signalThreeLight: return "\u{fae5}"
        case .signalThreeRegular: return "\u{fae6}"
        case .signalTwoBold: return "\u{fae7}"
        case .signalTwoLight: return "\u{fae8}"
        case .signalTwoRegular: return "\u{fae9}"
        case .signalZeroBold: return "\u{faea}"
        case .signalZeroLight: return "\u{faeb}"
        case .signalZeroRegular: return "\u{faec}"
        case .simplePromotionBold: return "\u{faed}"
        case .simplePromotionLight: return "\u{faee}"
        case .simplePromotionRegular: return "\u{faef}"
        case .singleNumberReachBold: return "\u{faf0}"
        case .singleNumberReachLight: return "\u{faf1}"
        case .singleNumberReachRegular: return "\u{faf2}"
        case .sipRegistrationInProgressBold: return "\u{faf3}"
        case .sipRegistrationInProgressFilled: return "\u{faf4}"
        case .sipRegistrationInProgressLight: return "\u{faf5}"
        case .sipRegistrationInProgressRegular: return "\u{faf6}"
        case .skipBold: return "\u{faf7}"
        case .skipBwBold: return "\u{faf8}"
        case .skipBwFilled: return "\u{faf9}"
        case .skipBwLight: return "\u{fafa}"
        case .skipBwRegular: return "\u{fafb}"
        case .skipFwBold: return "\u{fafc}"
        case .skipFwFilled: return "\u{fafd}"
        case .skipFwLight: return "\u{fafe}"
        case .skipFwRegular: return "\u{faff}"
        case .skipLight: return "\u{fb00}"
        case .skipRegular: return "\u{fb01}"
        case .smartAudioBold: return "\u{fb02}"
        case .smartAudioLight: return "\u{fb03}"
        case .smartAudioRegular: return "\u{fb04}"
        case .smsFilled: return "\u{fb05}"
        case .smsInboundBold: return "\u{fb06}"
        case .smsInboundLight: return "\u{fb07}"
        case .smsInboundRegular: return "\u{fb08}"
        case .smsMessageBold: return "\u{fb09}"
        case .smsMessageFilled: return "\u{fb0a}"
        case .smsMessageLight: return "\u{fb0b}"
        case .smsMessageOutgoingBold: return "\u{fb0c}"
        case .smsMessageOutgoingFilled: return "\u{fb0d}"
        case .smsMessageOutgoingLight: return "\u{fb0e}"
        case .smsMessageOutgoingRegular: return "\u{fb0f}"
        case .smsMessageRegular: return "\u{fb10}"
        case .smsMessageStartBold: return "\u{fb11}"
        case .smsMessageStartFilled: return "\u{fb12}"
        case .smsMessageStartLight: return "\u{fb13}"
        case .smsMessageStartRegular: return "\u{fb14}"
        case .smsOutgoingFilled: return "\u{fb15}"
        case .smsUnreadBold: return "\u{fb16}"
        case .smsUnreadLight: return "\u{fb17}"
        case .smsUnreadRegular: return "\u{fb18}"
        case .sortAscendingBold: return "\u{fb19}"
        case .sortAscendingLight: return "\u{fb1a}"
        case .sortAscendingRegular: return "\u{fb1b}"
        case .sortDescendingBold: return "\u{fb1c}"
        case .sortDescendingLight: return "\u{fb1d}"
        case .sortDescendingRegular: return "\u{fb1e}"
        case .soundDefaultBold: return "\u{fb1f}"
        case .soundDefaultLight: return "\u{fb20}"
        case .soundDefaultRegular: return "\u{fb21}"
        case .sparkleBold: return "\u{fb22}"
        case .sparkleFilled: return "\u{fb23}"
        case .sparkleLight: return "\u{fb24}"
        case .sparkleRegular: return "\u{fb25}"
        case .speakerBold: return "\u{fb26}"
        case .speakerDisconnectedBold: return "\u{fb27}"
        case .speakerDisconnectedFilled: return "\u{fb28}"
        case .speakerDisconnectedLight: return "\u{fb29}"
        case .speakerDisconnectedRegular: return "\u{fb2a}"
        case .speakerFilled: return "\u{fb2b}"
        case .speakerLight: return "\u{fb2c}"
        case .speakerMutedBold: return "\u{fb2d}"
        case .speakerMutedFilled: return "\u{fb2e}"
        case .speakerMutedLight: return "\u{fb2f}"
        case .speakerMutedRegular: return "\u{fb30}"
        case .speakerOffBold: return "\u{fb31}"
        case .speakerOffFilled: return "\u{fb32}"
        case .speakerOffLight: return "\u{fb33}"
        case .speakerOffRegular: return "\u{fb34}"
        case .speakerOnBold: return "\u{fb35}"
        case .speakerOnLight: return "\u{fb36}"
        case .speakerOnRegular: return "\u{fb37}"
        case .speakerRegular: return "\u{fb38}"
        case .speakerTurnDownBold: return "\u{fb39}"
        case .speakerTurnDownFilled: return "\u{fb3a}"
        case .speakerTurnDownLight: return "\u{fb3b}"
        case .speakerTurnDownRegular: return "\u{fb3c}"
        case .speakerTurnUpBold: return "\u{fb3d}"
        case .speakerTurnUpFilled: return "\u{fb3e}"
        case .speakerTurnUpLight: return "\u{fb3f}"
        case .speakerTurnUpRegular: return "\u{fb40}"
        case .speedDialBold: return "\u{fb41}"
        case .speedDialFilled: return "\u{fb42}"
        case .speedDialLight: return "\u{fb43}"
        case .speedDialRegular: return "\u{fb44}"
        case .spellCheckerBold: return "\u{fb45}"
        case .spellCheckerLight: return "\u{fb46}"
        case .spellCheckerRegular: return "\u{fb47}"
        case .splitViewBold: return "\u{fb48}"
        case .splitViewLight: return "\u{fb49}"
        case .splitViewRegular: return "\u{fb4a}"
        case .stackedAreaChartBold: return "\u{fb4b}"
        case .stackedAreaChartFilled: return "\u{fb4c}"
        case .stackedAreaChartFullBold: return "\u{fb4d}"
        case .stackedAreaChartFullFilled: return "\u{fb4e}"
        case .stackedAreaChartFullLight: return "\u{fb4f}"
        case .stackedAreaChartFullRegular: return "\u{fb50}"
        case .stackedAreaChartLight: return "\u{fb51}"
        case .stackedAreaChartRegular: return "\u{fb52}"
        case .stackedBarChartBold: return "\u{fb53}"
        case .stackedBarChartFilled: return "\u{fb54}"
        case .stackedBarChartFullBold: return "\u{fb55}"
        case .stackedBarChartFullFilled: return "\u{fb56}"
        case .stackedBarChartFullLight: return "\u{fb57}"
        case .stackedBarChartFullRegular: return "\u{fb58}"
        case .stackedBarChartLight: return "\u{fb59}"
        case .stackedBarChartRegular: return "\u{fb5a}"
        case .startChatBold: return "\u{fb5b}"
        case .startChatLight: return "\u{fb5c}"
        case .startChatRegular: return "\u{fb5d}"
        case .stethoscopeBold: return "\u{fb5e}"
        case .stethoscopeLight: return "\u{fb5f}"
        case .stethoscopeRegular: return "\u{fb60}"
        case .stickersBold: return "\u{fb61}"
        case .stickersLight: return "\u{fb62}"
        case .stickersRegular: return "\u{fb63}"
        case .stickiesBold: return "\u{fb64}"
        case .stickiesLight: return "\u{fb65}"
        case .stickiesRegular: return "\u{fb66}"
        case .stopBold: return "\u{fb67}"
        case .stopCircleBold: return "\u{fb68}"
        case .stopCircleFilled: return "\u{fb69}"
        case .stopCircleLight: return "\u{fb6a}"
        case .stopCircleRegular: return "\u{fb6b}"
        case .stopContentShareBold: return "\u{fb6c}"
        case .stopContentShareLight: return "\u{fb6d}"
        case .stopContentShareRegular: return "\u{fb6e}"
        case .stopFilled: return "\u{fb6f}"
        case .stopLight: return "\u{fb70}"
        case .stopRegular: return "\u{fb71}"
        case .storedInfoBold: return "\u{fb72}"
        case .storedInfoFilled: return "\u{fb73}"
        case .storedInfoLight: return "\u{fb74}"
        case .storedInfoRegular: return "\u{fb75}"
        case .streamingBold: return "\u{fb76}"
        case .streamingLight: return "\u{fb77}"
        case .streamingRegular: return "\u{fb78}"
        case .strikethroughBold: return "\u{fb79}"
        case .strikethroughFilled: return "\u{fb7a}"
        case .strikethroughLight: return "\u{fb7b}"
        case .strikethroughRegular: return "\u{fb7c}"
        case .studioModeBold: return "\u{fb7d}"
        case .studioModeLight: return "\u{fb7e}"
        case .studioModeRegular: return "\u{fb7f}"
        case .subscriptBold: return "\u{fb80}"
        case .subscriptLight: return "\u{fb81}"
        case .subscriptRegular: return "\u{fb82}"
        case .summarizeAiBold: return "\u{fb83}"
        case .summarizeAiLight: return "\u{fb84}"
        case .summarizeAiRegular: return "\u{fb85}"
        case .superscriptBold: return "\u{fb86}"
        case .superscriptLight: return "\u{fb87}"
        case .superscriptRegular: return "\u{fb88}"
        case .surveyBold: return "\u{fb89}"
        case .surveyFilled: return "\u{fb8a}"
        case .surveyLight: return "\u{fb8b}"
        case .surveyRegular: return "\u{fb8c}"
        case .sxEightyCodecBold: return "\u{fb8d}"
        case .sxEightyCodecLight: return "\u{fb8e}"
        case .sxEightyCodecRegular: return "\u{fb8f}"
        case .sxTenBold: return "\u{fb90}"
        case .sxTenLight: return "\u{fb91}"
        case .sxTenRegular: return "\u{fb92}"
        case .sxTwentyBold: return "\u{fb93}"
        case .sxTwentyLight: return "\u{fb94}"
        case .sxTwentyRegular: return "\u{fb95}"
        case .tableBold: return "\u{fb96}"
        case .tableExtenderBold: return "\u{fb97}"
        case .tableExtenderFilled: return "\u{fb98}"
        case .tableExtenderLight: return "\u{fb99}"
        case .tableExtenderRegular: return "\u{fb9a}"
        case .tableLight: return "\u{fb9b}"
        case .tableRegular: return "\u{fb9c}"
        case .tabletBold: return "\u{fb9d}"
        case .tabletLight: return "\u{fb9e}"
        case .tabletRegular: return "\u{fb9f}"
        case .tabsBold: return "\u{fba0}"
        case .tabsLight: return "\u{fba1}"
        case .tabsRegular: return "\u{fba2}"
        case .tagBold: return "\u{fba3}"
        case .tagLight: return "\u{fba4}"
        case .tagRegular: return "\u{fba5}"
        case .tapBold: return "\u{fba6}"
        case .tapFilled: return "\u{fba7}"
        case .tapLight: return "\u{fba8}"
        case .tapRegular: return "\u{fba9}"
        case .telepresenceAlertBold: return "\u{fbaa}"
        case .telepresenceAlertLight: return "\u{fbab}"
        case .telepresenceAlertMutedBold: return "\u{fbac}"
        case .telepresenceAlertMutedLight: return "\u{fbad}"
        case .telepresenceAlertMutedRegular: return "\u{fbae}"
        case .telepresenceAlertRegular: return "\u{fbaf}"
        case .telepresenceBold: return "\u{fbb0}"
        case .telepresenceIxFiveThousandBold: return "\u{fbb1}"
        case .telepresenceIxFiveThousandLight: return "\u{fbb2}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbb3}"
        case .telepresenceLight: return "\u{fbb4}"
        case .telepresenceMutedBold: return "\u{fbb5}"
        case .telepresenceMutedLight: return "\u{fbb6}"
        case .telepresenceMutedRegular: return "\u{fbb7}"
        case .telepresencePrivateBold: return "\u{fbb8}"
        case .telepresencePrivateLight: return "\u{fbb9}"
        case .telepresencePrivateRegular: return "\u{fbba}"
        case .telepresenceRegular: return "\u{fbbb}"
        case .temperatureBold: return "\u{fbbc}"
        case .temperatureLight: return "\u{fbbd}"
        case .temperatureRegular: return "\u{fbbe}"
        case .testTubeBold: return "\u{fbbf}"
        case .testTubeFilled: return "\u{fbc0}"
        case .testTubeLight: return "\u{fbc1}"
        case .testTubeRegular: return "\u{fbc2}"
        case .textAlignCenterBold: return "\u{fbc3}"
        case .textAlignCenterFilled: return "\u{fbc4}"
        case .textAlignCenterLight: return "\u{fbc5}"
        case .textAlignCenterRegular: return "\u{fbc6}"
        case .textAlignLeftBold: return "\u{fbc7}"
        case .textAlignLeftFilled: return "\u{fbc8}"
        case .textAlignLeftLight: return "\u{fbc9}"
        case .textAlignLeftRegular: return "\u{fbca}"
        case .textAlignRightBold: return "\u{fbcb}"
        case .textAlignRightFilled: return "\u{fbcc}"
        case .textAlignRightLight: return "\u{fbcd}"
        case .textAlignRightRegular: return "\u{fbce}"
        case .textBold: return "\u{fbcf}"
        case .textBoxCursorLight: return "\u{fbd0}"
        case .textCodeBlockBold: return "\u{fbd1}"
        case .textCodeBlockLight: return "\u{fbd2}"
        case .textCodeBlockRegular: return "\u{fbd3}"
        case .textHighlightBold: return "\u{fbd4}"
        case .textHighlightFilled: return "\u{fbd5}"
        case .textHighlightLight: return "\u{fbd6}"
        case .textHighlightRegular: return "\u{fbd7}"
        case .textLight: return "\u{fbd8}"
        case .textRegular: return "\u{fbd9}"
        case .threeColumnBold: return "\u{fbda}"
        case .threeColumnLight: return "\u{fbdb}"
        case .threeColumnRegular: return "\u{fbdc}"
        case .threeDObjectBold: return "\u{fbdd}"
        case .threeDObjectLight: return "\u{fbde}"
        case .threeDObjectRegular: return "\u{fbdf}"
        case .timeExclusionBold: return "\u{fbe0}"
        case .timeExclusionLight: return "\u{fbe1}"
        case .timeExclusionRegular: return "\u{fbe2}"
        case .timezoneBold: return "\u{fbe3}"
        case .timezoneFilled: return "\u{fbe4}"
        case .timezoneLight: return "\u{fbe5}"
        case .timezoneRegular: return "\u{fbe6}"
        case .tooFastBold: return "\u{fbe7}"
        case .tooFastLight: return "\u{fbe8}"
        case .tooFastRegular: return "\u{fbe9}"
        case .tooSlowBold: return "\u{fbea}"
        case .tooSlowLight: return "\u{fbeb}"
        case .tooSlowRegular: return "\u{fbec}"
        case .toolsBold: return "\u{fbed}"
        case .toolsFilled: return "\u{fbee}"
        case .toolsLight: return "\u{fbef}"
        case .toolsRegular: return "\u{fbf0}"
        case .touchTenBold: return "\u{fbf1}"
        case .touchTenLight: return "\u{fbf2}"
        case .touchTenRegular: return "\u{fbf3}"
        case .transcriptBold: return "\u{fbf4}"
        case .transcriptFilled: return "\u{fbf5}"
        case .transcriptLight: return "\u{fbf6}"
        case .transcriptRegular: return "\u{fbf7}"
        case .translateBold: return "\u{fbf8}"
        case .translateLight: return "\u{fbf9}"
        case .translateRegular: return "\u{fbfa}"
        case .translateUndoBold: return "\u{fbfb}"
        case .translateUndoLight: return "\u{fbfc}"
        case .translateUndoRegular: return "\u{fbfd}"
        case .trendingBold: return "\u{fbfe}"
        case .trendingDownBold: return "\u{fbff}"
        case .trendingDownFilled: return "\u{fc00}"
        case .trendingDownLight: return "\u{fc01}"
        case .trendingDownRegular: return "\u{fc02}"
        case .trendingFilled: return "\u{fc03}"
        case .trendingLight: return "\u{fc04}"
        case .trendingRegular: return "\u{fc05}"
        case .trimBold: return "\u{fc06}"
        case .trimLight: return "\u{fc07}"
        case .trimRegular: return "\u{fc08}"
        case .twoColumnBold: return "\u{fc09}"
        case .twoColumnLight: return "\u{fc0a}"
        case .twoColumnRegular: return "\u{fc0b}"
        case .twoWayVoiceStreamBold: return "\u{fc0c}"
        case .twoWayVoiceStreamFilled: return "\u{fc0d}"
        case .twoWayVoiceStreamLight: return "\u{fc0e}"
        case .twoWayVoiceStreamRegular: return "\u{fc0f}"
        case .ucmCloudBold: return "\u{fc10}"
        case .ucmCloudLight: return "\u{fc11}"
        case .ucmCloudRegular: return "\u{fc12}"
        case .unblockBold: return "\u{fc13}"
        case .unblockFilled: return "\u{fc14}"
        case .unblockLight: return "\u{fc15}"
        case .unblockRegular: return "\u{fc16}"
        case .underlineBold: return "\u{fc17}"
        case .underlineFilled: return "\u{fc18}"
        case .underlineLight: return "\u{fc19}"
        case .underlineRegular: return "\u{fc1a}"
        case .undoBold: return "\u{fc1b}"
        case .undoLight: return "\u{fc1c}"
        case .undoRegular: return "\u{fc1d}"
        case .unlinkBold: return "\u{fc1e}"
        case .unlinkLight: return "\u{fc1f}"
        case .unlinkRegular: return "\u{fc20}"
        case .unreadBold: return "\u{fc21}"
        case .unreadFilled: return "\u{fc22}"
        case .unreadLight: return "\u{fc23}"
        case .unreadRegular: return "\u{fc24}"
        case .unsecureUnlockedBold: return "\u{fc25}"
        case .unsecureUnlockedFilled: return "\u{fc26}"
        case .unsecureUnlockedLight: return "\u{fc27}"
        case .unsecureUnlockedRegular: return "\u{fc28}"
        case .unsortedBold: return "\u{fc29}"
        case .unsortedLight: return "\u{fc2a}"
        case .unsortedRegular: return "\u{fc2b}"
        case .updateFileShareBold: return "\u{fc2c}"
        case .updateFileShareLight: return "\u{fc2d}"
        case .updateFileShareRegular: return "\u{fc2e}"
        case .uploadBold: return "\u{fc2f}"
        case .uploadImageBold: return "\u{fc30}"
        case .uploadImageLight: return "\u{fc31}"
        case .uploadImageRegular: return "\u{fc32}"
        case .uploadLight: return "\u{fc33}"
        case .uploadRegular: return "\u{fc34}"
        case .urgentVoicemailBold: return "\u{fc35}"
        case .urgentVoicemailFilled: return "\u{fc36}"
        case .usbBold: return "\u{fc37}"
        case .usbHeadsetBold: return "\u{fc38}"
        case .usbHeadsetLight: return "\u{fc39}"
        case .usbHeadsetMutedBold: return "\u{fc3a}"
        case .usbHeadsetMutedLight: return "\u{fc3b}"
        case .usbHeadsetMutedRegular: return "\u{fc3c}"
        case .usbHeadsetRegular: return "\u{fc3d}"
        case .usbLight: return "\u{fc3e}"
        case .usbRegular: return "\u{fc3f}"
        case .userBold: return "\u{fc40}"
        case .userDeactivateBold: return "\u{fc41}"
        case .userDeactivateLight: return "\u{fc42}"
        case .userDeactivateRegular: return "\u{fc43}"
        case .userLight: return "\u{fc44}"
        case .userRegular: return "\u{fc45}"
        case .videoBlurBold: return "\u{fc46}"
        case .videoBlurFilled: return "\u{fc47}"
        case .videoBlurLight: return "\u{fc48}"
        case .videoBlurRegular: return "\u{fc49}"
        case .videoBold: return "\u{fc4a}"
        case .videoEffectBold: return "\u{fc4b}"
        case .videoEffectFilled: return "\u{fc4c}"
        case .videoEffectLight: return "\u{fc4d}"
        case .videoEffectRegular: return "\u{fc4e}"
        case .videoFilled: return "\u{fc4f}"
        case .videoLayoutBold: return "\u{fc50}"
        case .videoLayoutCustomBold: return "\u{fc51}"
        case .videoLayoutCustomFilled: return "\u{fc52}"
        case .videoLayoutCustomLight: return "\u{fc53}"
        case .videoLayoutCustomRegular: return "\u{fc54}"
        case .videoLayoutEqualBold: return "\u{fc55}"
        case .videoLayoutEqualDualBold: return "\u{fc56}"
        case .videoLayoutEqualDualLight: return "\u{fc57}"
        case .videoLayoutEqualDualRegular: return "\u{fc58}"
        case .videoLayoutEqualFilled: return "\u{fc59}"
        case .videoLayoutEqualLight: return "\u{fc5a}"
        case .videoLayoutEqualRegular: return "\u{fc5b}"
        case .videoLayoutFilled: return "\u{fc5c}"
        case .videoLayoutLight: return "\u{fc5d}"
        case .videoLayoutOverlayBold: return "\u{fc5e}"
        case .videoLayoutOverlayFilled: return "\u{fc5f}"
        case .videoLayoutOverlayLight: return "\u{fc60}"
        case .videoLayoutOverlayRegular: return "\u{fc61}"
        case .videoLayoutPresentationBold: return "\u{fc62}"
        case .videoLayoutPresentationFilled: return "\u{fc63}"
        case .videoLayoutPresentationLight: return "\u{fc64}"
        case .videoLayoutPresentationRegular: return "\u{fc65}"
        case .videoLayoutPresenterDominantBold: return "\u{fc66}"
        case .videoLayoutPresenterDominantLight: return "\u{fc67}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc68}"
        case .videoLayoutProminentBold: return "\u{fc69}"
        case .videoLayoutProminentFilled: return "\u{fc6a}"
        case .videoLayoutProminentLight: return "\u{fc6b}"
        case .videoLayoutProminentRegular: return "\u{fc6c}"
        case .videoLayoutRegular: return "\u{fc6d}"
        case .videoLayoutShareDominantBold: return "\u{fc6e}"
        case .videoLayoutShareDominantLight: return "\u{fc6f}"
        case .videoLayoutShareDominantRegular: return "\u{fc70}"
        case .videoLayoutSingleBold: return "\u{fc71}"
        case .videoLayoutSingleFilled: return "\u{fc72}"
        case .videoLayoutSingleLight: return "\u{fc73}"
        case .videoLayoutSingleRegular: return "\u{fc74}"
        case .videoLayoutSpeakerBold: return "\u{fc75}"
        case .videoLayoutSpeakerFilled: return "\u{fc76}"
        case .videoLayoutSpeakerLight: return "\u{fc77}"
        case .videoLayoutSpeakerRegular: return "\u{fc78}"
        case .videoLayoutStackBold: return "\u{fc79}"
        case .videoLayoutStackFilled: return "\u{fc7a}"
        case .videoLayoutStackLight: return "\u{fc7b}"
        case .videoLayoutStackRegular: return "\u{fc7c}"
        case .videoLayoutVideoDominantBold: return "\u{fc7d}"
        case .videoLayoutVideoDominantFilled: return "\u{fc7e}"
        case .videoLayoutVideoDominantLight: return "\u{fc7f}"
        case .videoLayoutVideoDominantRegular: return "\u{fc80}"
        case .videoLight: return "\u{fc81}"
        case .videoPlusBold: return "\u{fc82}"
        case .videoPlusFilled: return "\u{fc83}"
        case .videoPlusLight: return "\u{fc84}"
        case .videoPlusRegular: return "\u{fc85}"
        case .videoRegular: return "\u{fc86}"
        case .videoSpeakerTrackBold: return "\u{fc87}"
        case .videoSpeakerTrackFilled: return "\u{fc88}"
        case .videoSpeakerTrackLight: return "\u{fc89}"
        case .videoSpeakerTrackRegular: return "\u{fc8a}"
        case .viewAllBold: return "\u{fc8b}"
        case .viewAllLight: return "\u{fc8c}"
        case .viewAllRegular: return "\u{fc8d}"
        case .viewListBold: return "\u{fc8e}"
        case .viewListFilled: return "\u{fc8f}"
        case .viewListLight: return "\u{fc90}"
        case .viewListRegular: return "\u{fc91}"
        case .viewStackedBold: return "\u{fc92}"
        case .viewStackedFilled: return "\u{fc93}"
        case .viewStackedLight: return "\u{fc94}"
        case .viewStackedRegular: return "\u{fc95}"
        case .viewThumbnailBold: return "\u{fc96}"
        case .viewThumbnailFilled: return "\u{fc97}"
        case .viewThumbnailLight: return "\u{fc98}"
        case .viewThumbnailRegular: return "\u{fc99}"
        case .visionproBold: return "\u{fc9a}"
        case .visionproFilled: return "\u{fc9b}"
        case .visionproLight: return "\u{fc9c}"
        case .visionproMoveCallInBold: return "\u{fc9d}"
        case .visionproMoveCallInFilled: return "\u{fc9e}"
        case .visionproMoveCallInLight: return "\u{fc9f}"
        case .visionproMoveCallInOutBold: return "\u{fca0}"
        case .visionproMoveCallInOutFilled: return "\u{fca1}"
        case .visionproMoveCallInOutLight: return "\u{fca2}"
        case .visionproMoveCallInOutRegular: return "\u{fca3}"
        case .visionproMoveCallInRegular: return "\u{fca4}"
        case .visionproMoveCallOutBold: return "\u{fca5}"
        case .visionproMoveCallOutFilled: return "\u{fca6}"
        case .visionproMoveCallOutLight: return "\u{fca7}"
        case .visionproMoveCallOutRegular: return "\u{fca8}"
        case .visionproRegular: return "\u{fca9}"
        case .voicemailBold: return "\u{fcaa}"
        case .voicemailFilled: return "\u{fcab}"
        case .voicemailLight: return "\u{fcac}"
        case .voicemailRegular: return "\u{fcad}"
        case .vpnBold: return "\u{fcae}"
        case .vpnFilled: return "\u{fcaf}"
        case .vpnLight: return "\u{fcb0}"
        case .vpnRegular: return "\u{fcb1}"
        case .vscBold: return "\u{fcb2}"
        case .vscLight: return "\u{fcb3}"
        case .vscRegular: return "\u{fcb4}"
        case .waffleMenuBold: return "\u{fcb5}"
        case .waffleMenuLight: return "\u{fcb6}"
        case .waffleMenuRegular: return "\u{fcb7}"
        case .waitingRoomBold: return "\u{fcb8}"
        case .waitingRoomLight: return "\u{fcb9}"
        case .waitingRoomRegular: return "\u{fcba}"
        case .wallpaperBold: return "\u{fcbb}"
        case .wallpaperLight: return "\u{fcbc}"
        case .wallpaperRegular: return "\u{fcbd}"
        case .warningBadgeFilled: return "\u{fcbe}"
        case .warningBold: return "\u{fcbf}"
        case .warningFilled: return "\u{fcc0}"
        case .warningLight: return "\u{fcc1}"
        case .warningRegular: return "\u{fcc2}"
        case .webexBoardBold: return "\u{fcc3}"
        case .webexBoardLight: return "\u{fcc4}"
        case .webexBoardRegular: return "\u{fcc5}"
        case .webexCodecPlusBold: return "\u{fcc6}"
        case .webexCodecPlusLight: return "\u{fcc7}"
        case .webexCodecPlusRegular: return "\u{fcc8}"
        case .webexDeskCameraBold: return "\u{fcc9}"
        case .webexDeskCameraLight: return "\u{fcca}"
        case .webexDeskCameraRegular: return "\u{fccb}"
        case .webexHelixBold: return "\u{fccc}"
        case .webexHelixLight: return "\u{fccd}"
        case .webexHelixRegular: return "\u{fcce}"
        case .webexMeetingsBold: return "\u{fccf}"
        case .webexMeetingsFilled: return "\u{fcd0}"
        case .webexMeetingsLight: return "\u{fcd1}"
        case .webexMeetingsRegular: return "\u{fcd2}"
        case .webexQuadCameraBold: return "\u{fcd3}"
        case .webexQuadCameraLight: return "\u{fcd4}"
        case .webexQuadCameraRegular: return "\u{fcd5}"
        case .webexRoomKitBold: return "\u{fcd6}"
        case .webexRoomKitLight: return "\u{fcd7}"
        case .webexRoomKitPlusBold: return "\u{fcd8}"
        case .webexRoomKitPlusLight: return "\u{fcd9}"
        case .webexRoomKitPlusRegular: return "\u{fcda}"
        case .webexRoomKitRegular: return "\u{fcdb}"
        case .webexShareBold: return "\u{fcdc}"
        case .webexShareLight: return "\u{fcdd}"
        case .webexShareRegular: return "\u{fcde}"
        case .webexTeamsBold: return "\u{fcdf}"
        case .webexTeamsFilled: return "\u{fce0}"
        case .webexTeamsLight: return "\u{fce1}"
        case .webexTeamsNewBold: return "\u{fce2}"
        case .webexTeamsNewFilled: return "\u{fce3}"
        case .webexTeamsNewLight: return "\u{fce4}"
        case .webexTeamsNewRegular: return "\u{fce5}"
        case .webexTeamsRegular: return "\u{fce6}"
        case .webexTeamsRemoveBold: return "\u{fce7}"
        case .webexTeamsRemoveLight: return "\u{fce8}"
        case .webexTeamsRemoveRegular: return "\u{fce9}"
        case .webhookBold: return "\u{fcea}"
        case .webhookLight: return "\u{fceb}"
        case .webhookRegular: return "\u{fcec}"
        case .webinarBold: return "\u{fced}"
        case .webinarFilled: return "\u{fcee}"
        case .webinarLight: return "\u{fcef}"
        case .webinarRegular: return "\u{fcf0}"
        case .weeklyRecurringScheduleBold: return "\u{fcf1}"
        case .weeklyRecurringScheduleLight: return "\u{fcf2}"
        case .weeklyRecurringScheduleRegular: return "\u{fcf3}"
        case .whisperAnnouncementBold: return "\u{fcf4}"
        case .whisperAnnouncementFilled: return "\u{fcf5}"
        case .whisperAnnouncementLight: return "\u{fcf6}"
        case .whisperAnnouncementRegular: return "\u{fcf7}"
        case .whisperCoachBold: return "\u{fcf8}"
        case .whisperCoachFilled: return "\u{fcf9}"
        case .whisperCoachLight: return "\u{fcfa}"
        case .whisperCoachRegular: return "\u{fcfb}"
        case .whiteboardBold: return "\u{fcfc}"
        case .whiteboardContentBold: return "\u{fcfd}"
        case .whiteboardContentFilled: return "\u{fcfe}"
        case .whiteboardContentLight: return "\u{fcff}"
        case .whiteboardContentRegular: return "\u{fd00}"
        case .whiteboardFilled: return "\u{fd01}"
        case .whiteboardLight: return "\u{fd02}"
        case .whiteboardRegular: return "\u{fd03}"
        case .widgetBold: return "\u{fd04}"
        case .widgetFilled: return "\u{fd05}"
        case .widgetLight: return "\u{fd06}"
        case .widgetRegular: return "\u{fd07}"
        case .wifiBold: return "\u{fd08}"
        case .wifiErrorBold: return "\u{fd09}"
        case .wifiErrorLight: return "\u{fd0a}"
        case .wifiErrorRegular: return "\u{fd0b}"
        case .wifiLight: return "\u{fd0c}"
        case .wifiRegular: return "\u{fd0d}"
        case .wifiSignalGoodBold: return "\u{fd0e}"
        case .wifiSignalGoodLight: return "\u{fd0f}"
        case .wifiSignalGoodRegular: return "\u{fd10}"
        case .wifiSignalPoorBold: return "\u{fd11}"
        case .wifiSignalPoorLight: return "\u{fd12}"
        case .wifiSignalPoorRegular: return "\u{fd13}"
        case .wifiSignalUnstableBold: return "\u{fd14}"
        case .wifiSignalUnstableLight: return "\u{fd15}"
        case .wifiSignalUnstableRegular: return "\u{fd16}"
        case .windowCornerScrubBold: return "\u{fd17}"
        case .windowCornerScrubLight: return "\u{fd18}"
        case .windowCornerScrubRegular: return "\u{fd19}"
        case .windowRightCornerScrubBold: return "\u{fd1a}"
        case .windowRightCornerScrubLight: return "\u{fd1b}"
        case .windowRightCornerScrubRegular: return "\u{fd1c}"
        case .windowVerticalScrubBold: return "\u{fd1d}"
        case .windowVerticalScrubLight: return "\u{fd1e}"
        case .windowVerticalScrubRegular: return "\u{fd1f}"
        case .workflowDeploymentsBold: return "\u{fd20}"
        case .workflowDeploymentsFilled: return "\u{fd21}"
        case .workflowDeploymentsLight: return "\u{fd22}"
        case .workflowDeploymentsRegular: return "\u{fd23}"
        case .workphoneBold: return "\u{fd24}"
        case .workphoneLight: return "\u{fd25}"
        case .workphoneRegular: return "\u{fd26}"
        case .zoomInBold: return "\u{fd27}"
        case .zoomInLight: return "\u{fd28}"
        case .zoomInRegular: return "\u{fd29}"
        case .zoomOutBold: return "\u{fd2a}"
        case .zoomOutLight: return "\u{fd2b}"
        case .zoomOutRegular: return "\u{fd2c}"
