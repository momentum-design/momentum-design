...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .botCustomerAssistantFilled: return "\u{f253}"
        case .botCustomerAssistantLight: return "\u{f254}"
        case .botCustomerAssistantRegular: return "\u{f255}"
        case .botExpertAssistantBold: return "\u{f256}"
        case .botExpertAssistantLight: return "\u{f257}"
        case .botExpertAssistantRegular: return "\u{f258}"
        case .botLight: return "\u{f259}"
        case .botRegular: return "\u{f25a}"
        case .boxBold: return "\u{f25b}"
        case .boxLight: return "\u{f25c}"
        case .boxRegular: return "\u{f25d}"
        case .breakoutSessionBold: return "\u{f25e}"
        case .breakoutSessionFilled: return "\u{f25f}"
        case .breakoutSessionLight: return "\u{f260}"
        case .breakoutSessionRegular: return "\u{f261}"
        case .brightnessAutoBold: return "\u{f262}"
        case .brightnessAutoLight: return "\u{f263}"
        case .brightnessAutoRegular: return "\u{f264}"
        case .brightnessBold: return "\u{f265}"
        case .brightnessHighBold: return "\u{f266}"
        case .brightnessHighLight: return "\u{f267}"
        case .brightnessHighRegular: return "\u{f268}"
        case .brightnessLight: return "\u{f269}"
        case .brightnessLowBold: return "\u{f26a}"
        case .brightnessLowLight: return "\u{f26b}"
        case .brightnessLowRegular: return "\u{f26c}"
        case .brightnessRegular: return "\u{f26d}"
        case .brokenFileBold: return "\u{f26e}"
        case .brokenFileFilled: return "\u{f26f}"
        case .brokenFileLight: return "\u{f270}"
        case .brokenFileRegular: return "\u{f271}"
        case .browserBold: return "\u{f272}"
        case .browserLight: return "\u{f273}"
        case .browserRegular: return "\u{f274}"
        case .busyPresenceBold: return "\u{f275}"
        case .busyPresenceLight: return "\u{f276}"
        case .busyPresenceRegular: return "\u{f277}"
        case .buttonCursorBold: return "\u{f278}"
        case .buttonCursorLight: return "\u{f279}"
        case .buttonCursorRegular: return "\u{f27a}"
        case .calendarAddBold: return "\u{f27b}"
        case .calendarAddFilled: return "\u{f27c}"
        case .calendarAddLight: return "\u{f27d}"
        case .calendarAddRegular: return "\u{f27e}"
        case .calendarDayBold: return "\u{f27f}"
        case .calendarDayFilled: return "\u{f280}"
        case .calendarDayLight: return "\u{f281}"
        case .calendarDayRegular: return "\u{f282}"
        case .calendarEmptyBold: return "\u{f283}"
        case .calendarEmptyFilled: return "\u{f284}"
        case .calendarEmptyLight: return "\u{f285}"
        case .calendarEmptyRegular: return "\u{f286}"
        case .calendarExternalBold: return "\u{f287}"
        case .calendarExternalLight: return "\u{f288}"
        case .calendarExternalRegular: return "\u{f289}"
        case .calendarFilterBold: return "\u{f28a}"
        case .calendarFilterLight: return "\u{f28b}"
        case .calendarFilterRegular: return "\u{f28c}"
        case .calendarMonthBold: return "\u{f28d}"
        case .calendarMonthFilled: return "\u{f28e}"
        case .calendarMonthLight: return "\u{f28f}"
        case .calendarMonthMoreBold: return "\u{f290}"
        case .calendarMonthMoreLight: return "\u{f291}"
        case .calendarMonthMoreRegular: return "\u{f292}"
        case .calendarMonthRegular: return "\u{f293}"
        case .calendarTodayBold: return "\u{f294}"
        case .calendarTodayLight: return "\u{f295}"
        case .calendarTodayRegular: return "\u{f296}"
        case .calendarWeekBold: return "\u{f297}"
        case .calendarWeekFilled: return "\u{f298}"
        case .calendarWeekLight: return "\u{f299}"
        case .calendarWeekRegular: return "\u{f29a}"
        case .calendarWeekViewBold: return "\u{f29b}"
        case .calendarWeekViewFilled: return "\u{f29c}"
        case .calendarWeekViewLight: return "\u{f29d}"
        case .calendarWeekViewRegular: return "\u{f29e}"
        case .calendarWorkWeekBold: return "\u{f29f}"
        case .calendarWorkWeekFilled: return "\u{f2a0}"
        case .calendarWorkWeekLight: return "\u{f2a1}"
        case .calendarWorkWeekRegular: return "\u{f2a2}"
        case .callBargeBold: return "\u{f2a3}"
        case .callBargeFilled: return "\u{f2a4}"
        case .callBargeLight: return "\u{f2a5}"
        case .callBargeRegular: return "\u{f2a6}"
        case .callBargeSilentBold: return "\u{f2a7}"
        case .callBargeSilentLight: return "\u{f2a8}"
        case .callBargeSilentRegular: return "\u{f2a9}"
        case .callForwardSettingsBold: return "\u{f2aa}"
        case .callForwardSettingsFilled: return "\u{f2ab}"
        case .callForwardSettingsLight: return "\u{f2ac}"
        case .callForwardSettingsRegular: return "\u{f2ad}"
        case .callGroupPickupBold: return "\u{f2ae}"
        case .callGroupPickupFilled: return "\u{f2af}"
        case .callGroupPickupLight: return "\u{f2b0}"
        case .callGroupPickupRegular: return "\u{f2b1}"
        case .callHandlingBold: return "\u{f2b2}"
        case .callHandlingLight: return "\u{f2b3}"
        case .callHandlingRegular: return "\u{f2b4}"
        case .callHoldBold: return "\u{f2b5}"
        case .callHoldFilled: return "\u{f2b6}"
        case .callHoldLight: return "\u{f2b7}"
        case .callHoldRegular: return "\u{f2b8}"
        case .callIncomingBold: return "\u{f2b9}"
        case .callIncomingLight: return "\u{f2ba}"
        case .callIncomingRegular: return "\u{f2bb}"
        case .callListBold: return "\u{f2bc}"
        case .callListLight: return "\u{f2bd}"
        case .callListRegular: return "\u{f2be}"
        case .callMergeBold: return "\u{f2bf}"
        case .callMergeLight: return "\u{f2c0}"
        case .callMergeRegular: return "\u{f2c1}"
        case .callMissedBold: return "\u{f2c2}"
        case .callMissedFilled: return "\u{f2c3}"
        case .callMissedLight: return "\u{f2c4}"
        case .callMissedRegular: return "\u{f2c5}"
        case .callMoreBold: return "\u{f2c6}"
        case .callMoreLight: return "\u{f2c7}"
        case .callMoreRegular: return "\u{f2c8}"
        case .callOutgoingBold: return "\u{f2c9}"
        case .callOutgoingLight: return "\u{f2ca}"
        case .callOutgoingRegular: return "\u{f2cb}"
        case .callPickupBold: return "\u{f2cc}"
        case .callPickupFilled: return "\u{f2cd}"
        case .callPickupLight: return "\u{f2ce}"
        case .callPickupOtherBold: return "\u{f2cf}"
        case .callPickupOtherFilled: return "\u{f2d0}"
        case .callPickupOtherLight: return "\u{f2d1}"
        case .callPickupOtherRegular: return "\u{f2d2}"
        case .callPickupRegular: return "\u{f2d3}"
        case .callPrivateBold: return "\u{f2d4}"
        case .callPrivateFilled: return "\u{f2d5}"
        case .callPrivateLight: return "\u{f2d6}"
        case .callPrivateRegular: return "\u{f2d7}"
        case .callRemoteBold: return "\u{f2d8}"
        case .callRemoteFilled: return "\u{f2d9}"
        case .callRemoteLight: return "\u{f2da}"
        case .callRemoteRegular: return "\u{f2db}"
        case .callRequestBold: return "\u{f2dc}"
        case .callRequestFilled: return "\u{f2dd}"
        case .callRequestLight: return "\u{f2de}"
        case .callRequestRegular: return "\u{f2df}"
        case .callReturnBold: return "\u{f2e0}"
        case .callReturnFilled: return "\u{f2e1}"
        case .callReturnLight: return "\u{f2e2}"
        case .callReturnRegular: return "\u{f2e3}"
        case .callRoomBold: return "\u{f2e4}"
        case .callRoomLight: return "\u{f2e5}"
        case .callRoomRegular: return "\u{f2e6}"
        case .callSettingsBold: return "\u{f2e7}"
        case .callSettingsLight: return "\u{f2e8}"
        case .callSettingsRegular: return "\u{f2e9}"
        case .callSplitBold: return "\u{f2ea}"
        case .callSplitLight: return "\u{f2eb}"
        case .callSplitRegular: return "\u{f2ec}"
        case .callSwapBold: return "\u{f2ed}"
        case .callSwapLight: return "\u{f2ee}"
        case .callSwapRegular: return "\u{f2ef}"
        case .callVoicemailBold: return "\u{f2f0}"
        case .callVoicemailLight: return "\u{f2f1}"
        case .callVoicemailRegular: return "\u{f2f2}"
        case .callrateBold: return "\u{f2f3}"
        case .callrateLight: return "\u{f2f4}"
        case .callrateRegular: return "\u{f2f5}"
        case .cameraAuxBold: return "\u{f2f6}"
        case .cameraAuxFilled: return "\u{f2f7}"
        case .cameraAuxLight: return "\u{f2f8}"
        case .cameraAuxRegular: return "\u{f2f9}"
        case .cameraBold: return "\u{f2fa}"
        case .cameraFilled: return "\u{f2fb}"
        case .cameraLight: return "\u{f2fc}"
        case .cameraMutedBold: return "\u{f2fd}"
        case .cameraMutedCircleFilled: return "\u{f2fe}"
        case .cameraMutedFilled: return "\u{f2ff}"
        case .cameraMutedLight: return "\u{f300}"
        case .cameraMutedRegular: return "\u{f301}"
        case .cameraOnBold: return "\u{f302}"
        case .cameraOnFilled: return "\u{f303}"
        case .cameraOnLight: return "\u{f304}"
        case .cameraOnRegular: return "\u{f305}"
        case .cameraPhotoBold: return "\u{f306}"
        case .cameraPhotoFilled: return "\u{f307}"
        case .cameraPhotoLight: return "\u{f308}"
        case .cameraPhotoRegular: return "\u{f309}"
        case .cameraPresenceBold: return "\u{f30a}"
        case .cameraPresenceFilled: return "\u{f30b}"
        case .cameraPresenceLight: return "\u{f30c}"
        case .cameraPresenceRegular: return "\u{f30d}"
        case .cameraRegular: return "\u{f30e}"
        case .cameraSwapBold: return "\u{f30f}"
        case .cameraSwapLight: return "\u{f310}"
        case .cameraSwapRegular: return "\u{f311}"
        case .campaignManagementBold: return "\u{f312}"
        case .campaignManagementLight: return "\u{f313}"
        case .campaignManagementRegular: return "\u{f314}"
        case .cancelBold: return "\u{f315}"
        case .cancelLight: return "\u{f316}"
        case .cancelRegular: return "\u{f317}"
        case .capsLockBold: return "\u{f318}"
        case .capsLockLight: return "\u{f319}"
        case .capsLockRegular: return "\u{f31a}"
        case .captureRewindBold: return "\u{f31b}"
        case .captureRewindLight: return "\u{f31c}"
        case .captureRewindRegular: return "\u{f31d}"
        case .caroselBold: return "\u{f31e}"
        case .caroselLight: return "\u{f31f}"
        case .caroselRegular: return "\u{f320}"
        case .carouselTextBold: return "\u{f321}"
        case .carouselTextLight: return "\u{f322}"
        case .carouselTextRegular: return "\u{f323}"
        case .cellularBold: return "\u{f324}"
        case .cellularLight: return "\u{f325}"
        case .cellularRegular: return "\u{f326}"
        case .centerAlignedBold: return "\u{f327}"
        case .centerAlignedLight: return "\u{f328}"
        case .centerAlignedRegular: return "\u{f329}"
        case .centerBold: return "\u{f32a}"
        case .centerLight: return "\u{f32b}"
        case .centerRegular: return "\u{f32c}"
        case .certificateBold: return "\u{f32d}"
        case .certificateInvalidBold: return "\u{f32e}"
        case .certificateInvalidLight: return "\u{f32f}"
        case .certificateInvalidRegular: return "\u{f330}"
        case .certificateLight: return "\u{f331}"
        case .certificateRegular: return "\u{f332}"
        case .certifiedBold: return "\u{f333}"
        case .certifiedFilled: return "\u{f334}"
        ...
        case .greenRoomBold: return "\u{f5fe}"
        case .greenRoomFilled: return "\u{f5ff}"
        case .greenRoomLight: return "\u{f600}"
        case .greenRoomRegular: return "\u{f601}"
        case .guestIssuerBold: return "\u{f602}"
        case .guestIssuerLight: return "\u{f603}"
        case .guestIssuerRegular: return "\u{f604}"
        case .guideBold: return "\u{f605}"
        case .guideLight: return "\u{f606}"
        case .guideRegular: return "\u{f607}"
        case .handPointerBold: return "\u{f608}"
        case .handPointerLight: return "\u{f609}"
        case .handPointerRegular: return "\u{f60a}"
        case .handlerBold: return "\u{f60b}"
        case .handlerHorizontalBold: return "\u{f60c}"
        case .handlerHorizontalLight: return "\u{f60d}"
        case .handlerHorizontalRegular: return "\u{f60e}"
        case .handlerLight: return "\u{f60f}"
        case .handlerRegular: return "\u{f610}"
        case .handsetAlertBold: return "\u{f611}"
        case .handsetAlertFilled: return "\u{f612}"
        case .handsetAlertLight: return "\u{f613}"
        case .handsetAlertRegular: return "\u{f614}"
        case .handsetBold: return "\u{f615}"
        case .handsetDownSlashBold: return "\u{f616}"
        case .handsetDownSlashFilled: return "\u{f617}"
        case .handsetDownSlashLight: return "\u{f618}"
        case .handsetDownSlashRegular: return "\u{f619}"
        case .handsetFilled: return "\u{f61a}"
        case .handsetLight: return "\u{f61b}"
        case .handsetMutedBold: return "\u{f61c}"
        case .handsetMutedFilled: return "\u{f61d}"
        case .handsetMutedLight: return "\u{f61e}"
        case .handsetMutedRegular: return "\u{f61f}"
        case .handsetRegular: return "\u{f620}"
        case .handsetsArrowLeftBold: return "\u{f621}"
        case .handsetsArrowLeftLight: return "\u{f622}"
        case .handsetsArrowLeftRegular: return "\u{f623}"
        case .handshakeBold: return "\u{f624}"
        case .handshakeLight: return "\u{f625}"
        case .handshakeRegular: return "\u{f626}"
        case .headingOneBold: return "\u{f627}"
        case .headingOneLight: return "\u{f628}"
        case .headingOneRegular: return "\u{f629}"
        case .headingThreeBold: return "\u{f62a}"
        case .headingThreeLight: return "\u{f62b}"
        case .headingThreeRegular: return "\u{f62c}"
        case .headingTwoBold: return "\u{f62d}"
        case .headingTwoLight: return "\u{f62e}"
        case .headingTwoRegular: return "\u{f62f}"
        case .headphonesBold: return "\u{f630}"
        case .headphonesFilled: return "\u{f631}"
        case .headphonesLight: return "\u{f632}"
        case .headphonesMutedBold: return "\u{f633}"
        case .headphonesMutedFilled: return "\u{f634}"
        case .headphonesMutedLight: return "\u{f635}"
        case .headphonesMutedRegular: return "\u{f636}"
        case .headphonesRegular: return "\u{f637}"
        case .headsetAlertBold: return "\u{f638}"
        case .headsetAlertLight: return "\u{f639}"
        case .headsetAlertRegular: return "\u{f63a}"
        case .headsetArrowDownBold: return "\u{f63b}"
        case .headsetArrowDownFilled: return "\u{f63c}"
        case .headsetArrowDownLight: return "\u{f63d}"
        case .headsetArrowDownRegular: return "\u{f63e}"
        case .headsetBold: return "\u{f63f}"
        case .headsetFilled: return "\u{f640}"
        case .headsetLight: return "\u{f641}"
        case .headsetMutedBold: return "\u{f642}"
        case .headsetMutedLight: return "\u{f643}"
        case .headsetMutedRegular: return "\u{f644}"
        case .headsetPrivateBold: return "\u{f645}"
        case .headsetPrivateLight: return "\u{f646}"
        case .headsetPrivateRegular: return "\u{f647}"
        case .headsetRegular: return "\u{f648}"
        case .hearingBold: return "\u{f649}"
        case .hearingImpairedBold: return "\u{f64a}"
        case .hearingImpairedLight: return "\u{f64b}"
        case .hearingImpairedRegular: return "\u{f64c}"
        case .hearingLight: return "\u{f64d}"
        case .hearingRegular: return "\u{f64e}"
        case .helpBold: return "\u{f64f}"
        case .helpCircleBold: return "\u{f650}"
        case .helpCircleFilled: return "\u{f651}"
        case .helpCircleLight: return "\u{f652}"
        case .helpCircleRegular: return "\u{f653}"
        case .helpLight: return "\u{f654}"
        case .helpRegular: return "\u{f655}"
        case .helpdeskBold: return "\u{f656}"
        case .helpdeskFilled: return "\u{f657}"
        case .helpdeskLight: return "\u{f658}"
        case .helpdeskRegular: return "\u{f659}"
        case .hideBold: return "\u{f65a}"
        case .hideFilled: return "\u{f65b}"
        case .hideLight: return "\u{f65c}"
        case .hideRegular: return "\u{f65d}"
        case .homeBold: return "\u{f65e}"
        case .homeFilled: return "\u{f65f}"
        case .homeLight: return "\u{f660}"
        case .homeRegular: return "\u{f661}"
        case .horizontalLineBold: return "\u{f662}"
        case .horizontalLineLight: return "\u{f663}"
        case .horizontalLineRegular: return "\u{f664}"
        case .hotelingBold: return "\u{f665}"
        case .hotelingFilled: return "\u{f666}"
        case .hotelingLight: return "\u{f667}"
        case .hotelingRegular: return "\u{f668}"
        case .humidityBold: return "\u{f669}"
        case .humidityLight: return "\u{f66a}"
        case .humidityRegular: return "\u{f66b}"
        case .huntGroupBold: return "\u{f66c}"
        case .huntGroupFilled: return "\u{f66d}"
        case .huntGroupLight: return "\u{f66e}"
        case .huntGroupRegular: return "\u{f66f}"
        case .idleBold: return "\u{f670}"
        case .idleFilled: return "\u{f671}"
        case .idleLight: return "\u{f672}"
        case .idleRegular: return "\u{f673}"
        case .immediateBold: return "\u{f674}"
        case .immediateFilled: return "\u{f675}"
        case .immediateLight: return "\u{f676}"
        case .immediateRegular: return "\u{f677}"
        case .importBold: return "\u{f678}"
        case .importLight: return "\u{f679}"
        case .importRegular: return "\u{f67a}"
        case .inCommonBold: return "\u{f67b}"
        case .inCommonLight: return "\u{f67c}"
        case .inCommonRegular: return "\u{f67d}"
        case .inboxBold: return "\u{f67e}"
        case .inboxFilled: return "\u{f67f}"
        case .inboxLight: return "\u{f680}"
        case .inboxRegular: return "\u{f681}"
        case .includeBold: return "\u{f682}"
        case .includeLight: return "\u{f683}"
        case .includeRegular: return "\u{f684}"
        case .incognitoBold: return "\u{f685}"
        case .incognitoFilled: return "\u{f686}"
        case .incognitoLight: return "\u{f687}"
        case .incognitoRegular: return "\u{f688}"
        case .incomingCallLegacyBold: return "\u{f689}"
        case .incomingCallLegacyFilled: return "\u{f68a}"
        case .incomingCallLegacyLight: return "\u{f68b}"
        case .incomingCallLegacyRegular: return "\u{f68c}"
        case .indentDecreaseBold: return "\u{f68d}"
        case .indentDecreaseLight: return "\u{f68e}"
        case .indentDecreaseRegular: return "\u{f68f}"
        case .indentIncreaseBold: return "\u{f690}"
        case .indentIncreaseLight: return "\u{f691}"
        case .indentIncreaseRegular: return "\u{f692}"
        case .infoBadgeFilled: return "\u{f693}"
        case .infoCircleBold: return "\u{f694}"
        case .infoCircleFilled: return "\u{f695}"
        case .infoCircleLight: return "\u{f696}"
        case .infoCircleRegular: return "\u{f697}"
        case .infoCircleTwoBold: return "\u{f698}"
        case .infoCircleTwoFilled: return "\u{f699}"
        case .infoCircleTwoLight: return "\u{f69a}"
        case .infoCircleTwoRegular: return "\u{f69b}"
        case .inputBold: return "\u{f69c}"
        case .inputDisconnectedBold: return "\u{f69d}"
        case .inputDisconnectedLight: return "\u{f69e}"
        case .inputDisconnectedRegular: return "\u{f69f}"
        case .inputLight: return "\u{f6a0}"
        case .inputRegular: return "\u{f6a1}"
        case .instantScheduleBold: return "\u{f6a2}"
        case .instantScheduleFilled: return "\u{f6a3}"
        case .instantScheduleLight: return "\u{f6a4}"
        case .instantScheduleRegular: return "\u{f6a5}"
        case .integrationsBold: return "\u{f6a6}"
        case .integrationsLight: return "\u{f6a7}"
        case .integrationsRegular: return "\u{f6a8}"
        case .intelligentRoutingBold: return "\u{f6a9}"
        case .intelligentRoutingLight: return "\u{f6aa}"
        case .intelligentRoutingRegular: return "\u{f6ab}"
        case .interactionBold: return "\u{f6ac}"
        case .interactionFilled: return "\u{f6ad}"
        case .interactionLight: return "\u{f6ae}"
        case .interactionRegular: return "\u{f6af}"
        case .invitedUserBold: return "\u{f6b0}"
        case .invitedUserLight: return "\u{f6b1}"
        case .invitedUserRegular: return "\u{f6b2}"
        case .italicBold: return "\u{f6b3}"
        case .italicFilled: return "\u{f6b4}"
        case .italicLight: return "\u{f6b5}"
        case .italicRegular: return "\u{f6b6}"
        case .joinAudioBold: return "\u{f6b7}"
        case .joinAudioFilled: return "\u{f6b8}"
        case .joinAudioLight: return "\u{f6b9}"
        case .joinAudioRegular: return "\u{f6ba}"
        case .keepInTouchBold: return "\u{f6bb}"
        case .keepInTouchFilled: return "\u{f6bc}"
        case .keepInTouchLight: return "\u{f6bd}"
        case .keepInTouchRegular: return "\u{f6be}"
        case .keyboardBold: return "\u{f6bf}"
        case .keyboardCloseBold: return "\u{f6c0}"
        case .keyboardCloseLight: return "\u{f6c1}"
        case .keyboardCloseRegular: return "\u{f6c2}"
        case .keyboardLight: return "\u{f6c3}"
        case .keyboardRegular: return "\u{f6c4}"
        case .languageBold: return "\u{f6c5}"
        case .languageFilled: return "\u{f6c6}"
        case .languageLight: return "\u{f6c7}"
        case .languageRegular: return "\u{f6c8}"
        case .laptopBold: return "\u{f6c9}"
        case .laptopDisconnectedBold: return "\u{f6ca}"
        case .laptopDisconnectedLight: return "\u{f6cb}"
        case .laptopDisconnectedRegular: return "\u{f6cc}"
        case .laptopFilled: return "\u{f6cd}"
        case .laptopLight: return "\u{f6ce}"
        case .laptopRegular: return "\u{f6cf}"
        case .laserPointerBold: return "\u{f6d0}"
        case .laserPointerCursorBlackLight: return "\u{f6d1}"
        case .laserPointerCursorBlueLight: return "\u{f6d2}"
        case .laserPointerCursorGreenLight: return "\u{f6d3}"
        case .laserPointerCursorPurpleLight: return "\u{f6d4}"
        case .laserPointerCursorRedLight: return "\u{f6d5}"
        case .laserPointerCursorWhiteLight: return "\u{f6d6}"
        case .laserPointerCursorYellowLight: return "\u{f6d7}"
        case .laserPointerFilled: return "\u{f6d8}"
        case .laserPointerLight: return "\u{f6d9}"
        case .laserPointerRegular: return "\u{f6da}"
        case .launchBold: return "\u{f6db}"
        case .launchLight: return "\u{f6dc}"
        case .launchRegular: return "\u{f6dd}"
        case .layoutSideBySideVerticalBold: return "\u{f6de}"
        case .layoutSideBySideVerticalFilled: return "\u{f6df}"
        case .layoutSideBySideVerticalLight: return "\u{f6e0}"
        case .layoutSideBySideVerticalRegular: return "\u{f6e1}"
        case .leaveBreakoutSessionBold: return "\u{f6e2}"
        case .leaveBreakoutSessionLight: return "\u{f6e3}"
        case .leaveBreakoutSessionRegular: return "\u{f6e4}"
        case .leaveDeviceBold: return "\u{f6e5}"
        case .leaveDeviceLight: return "\u{f6e6}"
        case .leaveDeviceRegular: return "\u{f6e7}"
        case .likeBold: return "\u{f6e8}"
        case .likeFilled: return "\u{f6e9}"
        case .likeLight: return "\u{f6ea}"
        case .likeRegular: return "\u{f6eb}"
        case .linkBold: return "\u{f6ec}"
        case .linkLight: return "\u{f6ed}"
        case .linkRegular: return "\u{f6ee}"
        case .listBulletedBold: return "\u{f6ef}"
        case .listBulletedLight: return "\u{f6f0}"
        case .listBulletedRegular: return "\u{f6f1}"
        case .listMenuBold: return "\u{f6f2}"
        case .listMenuLight: return "\u{f6f3}"
        case .listMenuRegular: return "\u{f6f4}"
        case .listNumberedBold: return "\u{f6f5}"
        case .listNumberedLight: return "\u{f6f6}"
        case .listNumberedRegular: return "\u{f6f7}"
        case .liveBold: return "\u{f6f8}"
        case .liveFilled: return "\u{f6f9}"
        case .liveLight: return "\u{f6fa}"
        case .liveRegular: return "\u{f6fb}"
        case .locationBold: return "\u{f6fc}"
        case .locationFilled: return "\u{f6fd}"
        case .locationLight: return "\u{f6fe}"
        case .locationRegular: return "\u{f6ff}"
        case .longTextBoxBold: return "\u{f700}"
        case .longTextBoxLight: return "\u{f701}"
        case .longTextBoxRegular: return "\u{f702}"
        case .lowerHandBold: return "\u{f703}"
        case .lowerHandLight: return "\u{f704}"
        case .lowerHandRegular: return "\u{f705}"
        case .magicPenBold: return "\u{f706}"
        case .magicPenFilled: return "\u{f707}"
        case .magicPenLight: return "\u{f708}"
        case .magicPenRegular: return "\u{f709}"
        case .markAsUnreadBold: return "\u{f70a}"
        case .markAsUnreadLight: return "\u{f70b}"
        case .markAsUnreadRegular: return "\u{f70c}"
        case .markdownBold: return "\u{f70d}"
        case .markdownFilled: return "\u{f70e}"
        case .markdownLight: return "\u{f70f}"
        case .markdownRegular: return "\u{f710}"
        case .markerBold: return "\u{f711}"
        case .markerFilled: return "\u{f712}"
        case .markerLight: return "\u{f713}"
        case .markerRegular: return "\u{f714}"
        case .maximizeBold: return "\u{f715}"
        case .maximizeLight: return "\u{f716}"
        case .maximizeRegular: return "\u{f717}"
        case .mediaPlayerBold: return "\u{f718}"
        case .mediaPlayerLight: return "\u{f719}"
        case .mediaPlayerRegular: return "\u{f71a}"
        case .mediaQualityGoodBold: return "\u{f71b}"
        case .mediaQualityGoodFilled: return "\u{f71c}"
        case .mediaQualityGoodLight: return "\u{f71d}"
        case .mediaQualityGoodRegular: return "\u{f71e}"
        case .mediaQualityPoorBold: return "\u{f71f}"
        case .mediaQualityPoorFilled: return "\u{f720}"
        case .mediaQualityPoorLight: return "\u{f721}"
        case .mediaQualityPoorRegular: return "\u{f722}"
        case .mediaQualityUnstableBold: return "\u{f723}"
        case .mediaQualityUnstableFilled: return "\u{f724}"
        case .mediaQualityUnstableLight: return "\u{f725}"
        case .mediaQualityUnstableRegular: return "\u{f726}"
        case .meetBold: return "\u{f727}"
        case .meetEndBold: return "\u{f728}"
        case .meetEndLight: return "\u{f729}"
        case .meetEndRegular: return "\u{f72a}"
        case .meetFilled: return "\u{f72b}"
        case .meetLight: return "\u{f72c}"
        case .meetRegular: return "\u{f72d}"
        case .meetingSummaryBold: return "\u{f72e}"
        case .meetingSummaryFilled: return "\u{f72f}"
        case .meetingSummaryLight: return "\u{f730}"
        case .meetingSummaryRegular: return "\u{f731}"
        case .meetingsBold: return "\u{f732}"
        case .meetingsFilled: return "\u{f733}"
        case .meetingsFocusMonthBold: return "\u{f734}"
        case .meetingsFocusMonthLight: return "\u{f735}"
        case .meetingsFocusMonthRegular: return "\u{f736}"
        case .meetingsFocusOneDayBold: return "\u{f737}"
        case .meetingsFocusOneDayLight: return "\u{f738}"
        case .meetingsFocusOneDayRegular: return "\u{f739}"
        case .meetingsFocusThreeDayBold: return "\u{f73a}"
        case .meetingsFocusThreeDayLight: return "\u{f73b}"
        case .meetingsFocusThreeDayRegular: return "\u{f73c}"
        case .meetingsFocusUpcomingBold: return "\u{f73d}"
        case .meetingsFocusUpcomingLight: return "\u{f73e}"
        case .meetingsFocusUpcomingRegular: return "\u{f73f}"
        case .meetingsLight: return "\u{f740}"
        case .meetingsPresenceBadgeFilled: return "\u{f741}"
        case .meetingsPresenceBold: return "\u{f742}"
        case .meetingsPresenceFilled: return "\u{f743}"
        case .meetingsPresenceLight: return "\u{f744}"
        case .meetingsPresenceRegular: return "\u{f745}"
        case .meetingsRegular: return "\u{f746}"
        case .meetingsTeamBold: return "\u{f747}"
        case .meetingsTeamFilled: return "\u{f748}"
        case .meetingsTeamLight: return "\u{f749}"
        case .meetingsTeamNewBold: return "\u{f74a}"
        case .meetingsTeamNewLight: return "\u{f74b}"
        case .meetingsTeamNewRegular: return "\u{f74c}"
        case .meetingsTeamRegular: return "\u{f74d}"
        case .mentionBold: return "\u{f74e}"
        case .mentionLight: return "\u{f74f}"
        case .mentionRegular: return "\u{f750}"
        case .messageQueingBold: return "\u{f751}"
        case .messageQueingLight: return "\u{f752}"
        case .messageQueingRegular: return "\u{f753}"
        case .microphoneBold: return "\u{f754}"
        case .microphoneFilled: return "\u{f755}"
        case .microphoneHardMutedBold: return "\u{f756}"
        case .microphoneHardMutedCircleFilled: return "\u{f757}"
        case .microphoneHardMutedLight: return "\u{f758}"
        case .microphoneHardMutedRegular: return "\u{f759}"
        case .microphoneLight: return "\u{f75a}"
        case .microphoneMusicModeBold: return "\u{f75b}"
        case .microphoneMusicModeLight: return "\u{f75c}"
        case .microphoneMusicModeOnBold: return "\u{f75d}"
        case .microphoneMusicModeOnLight: return "\u{f75e}"
        case .microphoneMusicModeOnRegular: return "\u{f75f}"
        case .microphoneMusicModeRegular: return "\u{f760}"
        case .microphoneMutedBold: return "\u{f761}"
        case .microphoneMutedCircleFilled: return "\u{f762}"
        case .microphoneMutedFilled: return "\u{f763}"
        case .microphoneMutedLight: return "\u{f764}"
        case .microphoneMutedRegular: return "\u{f765}"
        case .microphoneOnBold: return "\u{f766}"
        case .microphoneOnLight: return "\u{f767}"
        case .microphoneOnRegular: return "\u{f768}"
        case .microphoneOptAllBold: return "\u{f769}"
        case .microphoneOptAllLight: return "\u{f76a}"
        case .microphoneOptAllMutedBold: return "\u{f76b}"
        case .microphoneOptAllMutedLight: return "\u{f76c}"
        case .microphoneOptAllMutedRegular: return "\u{f76d}"
        case .microphoneOptAllOnBold: return "\u{f76e}"
        case .microphoneOptAllOnLight: return "\u{f76f}"
        case .microphoneOptAllOnRegular: return "\u{f770}"
        case .microphoneOptAllRegular: return "\u{f771}"
        case .microphoneOptMeBold: return "\u{f772}"
        case .microphoneOptMeLight: return "\u{f773}"
        case .microphoneOptMeMutedBold: return "\u{f774}"
        case .microphoneOptMeMutedLight: return "\u{f775}"
        case .microphoneOptMeMutedRegular: return "\u{f776}"
        case .microphoneOptMeOnBold: return "\u{f777}"
        case .microphoneOptMeOnLight: return "\u{f778}"
        case .microphoneOptMeOnRegular: return "\u{f779}"
        case .microphoneOptMeRegular: return "\u{f77a}"
        case .microphoneRegular: return "\u{f77b}"
        case .mindMapBold: return "\u{f77c}"
        case .mindMapLight: return "\u{f77d}"
        case .mindMapRegular: return "\u{f77e}"
        case .minimizeBold: return "\u{f77f}"
        case .minimizeLight: return "\u{f780}"
        case .minimizeRegular: return "\u{f781}"
        case .minusBold: return "\u{f782}"
        case .minusLight: return "\u{f783}"
        case .minusRegular: return "\u{f784}"
        case .mirrorBold: return "\u{f785}"
        case .mirrorFilled: return "\u{f786}"
        case .mirrorLight: return "\u{f787}"
        case .mirrorRegular: return "\u{f788}"
        case .mmsFilled: return "\u{f789}"
        case .moderatorBold: return "\u{f78a}"
        case .moderatorLight: return "\u{f78b}"
        case .moderatorRegular: return "\u{f78c}"
        case .monitoringBold: return "\u{f78d}"
        case .monitoringLight: return "\u{f78e}"
        case .monitoringRegular: return "\u{f78f}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f790}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f791}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f792}"
        case .moreAdrBold: return "\u{f793}"
        case .moreAdrLight: return "\u{f794}"
        case .moreAdrRegular: return "\u{f795}"
        case .moreBold: return "\u{f796}"
        case .moreCircleBold: return "\u{f797}"
        case .moreCircleFilled: return "\u{f798}"
        case .moreCircleLight: return "\u{f799}"
        case .moreCircleRegular: return "\u{f79a}"
        case .moreLight: return "\u{f79b}"
        case .moreRegular: return "\u{f79c}"
        case .mouseCursorBold: return "\u{f79d}"
        case .mouseCursorLight: return "\u{f79e}"
        case .mouseCursorRegular: return "\u{f79f}"
        case .moveCallInAdrBold: return "\u{f7a0}"
        case .moveCallInAdrLight: return "\u{f7a1}"
        case .moveCallInAdrRegular: return "\u{f7a2}"
        case .moveCallInIphBold: return "\u{f7a3}"
        case .moveCallInIphLight: return "\u{f7a4}"
        case .moveCallInIphRegular: return "\u{f7a5}"
        case .moveCallInLaptopBold: return "\u{f7a6}"
        case .moveCallInLaptopLight: return "\u{f7a7}"
        case .moveCallInLaptopRegular: return "\u{f7a8}"
        case .moveCallInOutAdrBold: return "\u{f7a9}"
        case .moveCallInOutAdrLight: return "\u{f7aa}"
        case .moveCallInOutAdrRegular: return "\u{f7ab}"
        case .moveCallInOutIphBold: return "\u{f7ac}"
        case .moveCallInOutIphLight: return "\u{f7ad}"
        case .moveCallInOutIphRegular: return "\u{f7ae}"
        case .moveCallInTabletBold: return "\u{f7af}"
        case .moveCallInTabletLight: return "\u{f7b0}"
        case .moveCallInTabletRegular: return "\u{f7b1}"
        case .moveCallOutAdrBold: return "\u{f7b2}"
        case .moveCallOutAdrLight: return "\u{f7b3}"
        case .moveCallOutAdrRegular: return "\u{f7b4}"
        case .moveCallOutIphBold: return "\u{f7b5}"
        case .moveCallOutIphLight: return "\u{f7b6}"
        case .moveCallOutIphRegular: return "\u{f7b7}"
        case .moveCallOutLaptopBold: return "\u{f7b8}"
        case .moveCallOutLaptopLight: return "\u{f7b9}"
        case .moveCallOutLaptopRegular: return "\u{f7ba}"
        case .moveCallOutTabletBold: return "\u{f7bb}"
        case .moveCallOutTabletLight: return "\u{f7bc}"
        case .moveCallOutTabletRegular: return "\u{f7bd}"
        case .moveToScreenBold: return "\u{f7be}"
        case .moveToScreenLight: return "\u{f7bf}"
        case .moveToScreenRegular: return "\u{f7c0}"
        case .multilineChartBold: return "\u{f7c1}"
        case .multilineChartFilled: return "\u{f7c2}"
        case .multilineChartLight: return "\u{f7c3}"
        case .multilineChartRegular: return "\u{f7c4}"
        case .multimediaBold: return "\u{f7c5}"
        case .multimediaFilled: return "\u{f7c6}"
        case .multimediaLight: return "\u{f7c7}"
        case .multimediaRegular: return "\u{f7c8}"
        case .multipledDevicesBold: return "\u{f7c9}"
        case .multipledDevicesLight: return "\u{f7ca}"
        case .multipledDevicesRegular: return "\u{f7cb}"
        case .musicModeCircleBold: return "\u{f7cc}"
        case .musicModeCircleFilled: return "\u{f7cd}"
        case .musicModeCircleLight: return "\u{f7ce}"
        case .musicModeCircleRegular: return "\u{f7cf}"
        case .musicNoteBold: return "\u{f7d0}"
        case .musicNoteFilled: return "\u{f7d1}"
        case .musicNoteLight: return "\u{f7d2}"
        case .musicNoteRegular: return "\u{f7d3}"
        case .muteOnEntryBold: return "\u{f7d4}"
        case .muteOnEntryFilled: return "\u{f7d5}"
        case .muteOnEntryLight: return "\u{f7d6}"
        case .muteOnEntryRegular: return "\u{f7d7}"
        case .newManagerBold: return "\u{f7d8}"
        case .newManagerLight: return "\u{f7d9}"
        case .newManagerRegular: return "\u{f7da}"
        case .newTitleBold: return "\u{f7db}"
        case .newTitleLight: return "\u{f7dc}"
        case .newTitleRegular: return "\u{f7dd}"
        case .newVoicemailBold: return "\u{f7de}"
        case .newVoicemailLight: return "\u{f7df}"
        case .newVoicemailRegular: return "\u{f7e0}"
        case .newWhiteboardBold: return "\u{f7e1}"
        case .newWhiteboardLight: return "\u{f7e2}"
        case .newWhiteboardRegular: return "\u{f7e3}"
        case .nextBold: return "\u{f7e4}"
        case .nextLight: return "\u{f7e5}"
        case .nextRegular: return "\u{f7e6}"
        case .noDevicesBold: return "\u{f7e7}"
        case .noDevicesLight: return "\u{f7e8}"
        case .noDevicesRegular: return "\u{f7e9}"
        case .noiseDetectedCanceledFilled: return "\u{f7ea}"
        case .noiseDetectedFilled: return "\u{f7eb}"
        case .noiseNoneCanceledFilled: return "\u{f7ec}"
        case .noiseNoneFilled: return "\u{f7ed}"
        case .noiseRemovalBold: return "\u{f7ee}"
        case .noiseRemovalLight: return "\u{f7ef}"
        case .noiseRemovalRegular: return "\u{f7f0}"
        case .noteBold: return "\u{f7f1}"
        case .noteLight: return "\u{f7f2}"
        case .notePptBold: return "\u{f7f3}"
        case .notePptLight: return "\u{f7f4}"
        case .notePptRegular: return "\u{f7f5}"
        case .noteRegular: return "\u{f7f6}"
        case .notesBold: return "\u{f7f7}"
        case .notesFilled: return "\u{f7f8}"
        case .notesLight: return "\u{f7f9}"
        case .notesRegular: return "\u{f7fa}"
        case .numberBold: return "\u{f7fb}"
        case .numberLight: return "\u{f7fc}"
        case .numberRegular: return "\u{f7fd}"
        case .oldRemoteBold: return "\u{f7fe}"
        case .oldRemoteLight: return "\u{f7ff}"
        case .oldRemoteRegular: return "\u{f800}"
        case .oldTouchBold: return "\u{f801}"
        case .oldTouchLight: return "\u{f802}"
        case .oldTouchRegular: return "\u{f803}"
        case .oneColumnBold: return "\u{f804}"
        case .oneColumnLight: return "\u{f805}"
        case .oneColumnRegular: return "\u{f806}"
        case .oneTimeBold: return "\u{f807}"
        case .oneTimeLight: return "\u{f808}"
        case .oneTimeRegular: return "\u{f809}"
        case .openInFolderBold: return "\u{f80a}"
        case .openInFolderLight: return "\u{f80b}"
        case .openInFolderRegular: return "\u{f80c}"
        case .openPagesBold: return "\u{f80d}"
        case .openPagesLight: return "\u{f80e}"
        case .openPagesRegular: return "\u{f80f}"
        case .otherNumberBold: return "\u{f810}"
        case .otherNumberFilled: return "\u{f811}"
        case .otherNumberLight: return "\u{f812}"
        case .otherNumberRegular: return "\u{f813}"
        case .otherNumberWarningBold: return "\u{f814}"
        case .otherNumberWarningLight: return "\u{f815}"
        case .otherNumberWarningRegular: return "\u{f816}"
        case .outgoingCallLegacyBold: return "\u{f817}"
        case .outgoingCallLegacyFilled: return "\u{f818}"
        case .outgoingCallLegacyLight: return "\u{f819}"
        case .outgoingCallLegacyRegular: return "\u{f81a}"
        case .overflowLeftBold: return "\u{f81b}"
        case .overflowLeftLight: return "\u{f81c}"
        case .overflowLeftRegular: return "\u{f81d}"
        case .overflowRightBold: return "\u{f81e}"
        case .overflowRightLight: return "\u{f81f}"
        case .overflowRightRegular: return "\u{f820}"
        case .pairedCameraBold: return "\u{f821}"
        case .pairedCameraLight: return "\u{f822}"
        case .pairedCameraRegular: return "\u{f823}"
        case .pairedDeviceBold: return "\u{f824}"
        case .pairedDeviceLight: return "\u{f825}"
        case .pairedDeviceRegular: return "\u{f826}"
        case .pairedHandsetBold: return "\u{f827}"
        case .pairedHandsetLight: return "\u{f828}"
        case .pairedHandsetRegular: return "\u{f829}"
        case .pairingBold: return "\u{f82a}"
        case .pairingLight: return "\u{f82b}"
        case .pairingRegular: return "\u{f82c}"
        case .parkedBold: return "\u{f82d}"
        case .parkedFilled: return "\u{f82e}"
        case .parkedLight: return "\u{f82f}"
        case .parkedRegular: return "\u{f830}"
        case .parseBold: return "\u{f831}"
        case .parseLight: return "\u{f832}"
        case .parseRegular: return "\u{f833}"
        case .partialBold: return "\u{f834}"
        case .partialLight: return "\u{f835}"
        case .partialRegular: return "\u{f836}"
        case .participantAddBold: return "\u{f837}"
        case .participantAddLight: return "\u{f838}"
        case .participantAddRegular: return "\u{f839}"
        case .participantBlockedBold: return "\u{f83a}"
        case .participantBlockedLight: return "\u{f83b}"
        case .participantBlockedRegular: return "\u{f83c}"
        case .participantBold: return "\u{f83d}"
        case .participantFilled: return "\u{f83e}"
        case .participantLight: return "\u{f83f}"
        case .participantListBold: return "\u{f840}"
        case .participantListFilled: return "\u{f841}"
        case .participantListLight: return "\u{f842}"
        case .participantListRegular: return "\u{f843}"
        case .participantRegular: return "\u{f844}"
        case .participantRemoveBold: return "\u{f845}"
        case .participantRemoveLight: return "\u{f846}"
        case .participantRemoveRegular: return "\u{f847}"
        case .participantUnknownBold: return "\u{f848}"
        case .participantUnknownLight: return "\u{f849}"
        case .participantUnknownRegular: return "\u{f84a}"
        case .passMouseBold: return "\u{f84b}"
        case .passMouseLight: return "\u{f84c}"
        case .passMouseRegular: return "\u{f84d}"
        case .pauseBadgeFilled: return "\u{f84e}"
        case .pauseBold: return "\u{f84f}"
        case .pauseFilled: return "\u{f850}"
        case .pauseLight: return "\u{f851}"
        case .pauseRegular: return "\u{f852}"
        case .peopleAddBold: return "\u{f853}"
        case .peopleAddFilled: return "\u{f854}"
        case .peopleAddLight: return "\u{f855}"
        case .peopleAddRegular: return "\u{f856}"
        case .peopleBold: return "\u{f857}"
        case .peopleCircleBold: return "\u{f858}"
        case .peopleCircleFilled: return "\u{f859}"
        case .peopleCircleLight: return "\u{f85a}"
        case .peopleCircleRegular: return "\u{f85b}"
        case .peopleFilled: return "\u{f85c}"
        case .peopleInsightsBold: return "\u{f85d}"
        case .peopleInsightsFilled: return "\u{f85e}"
        case .peopleInsightsLight: return "\u{f85f}"
        case .peopleInsightsRegular: return "\u{f860}"
        case .peopleLight: return "\u{f861}"
        case .peopleRegular: return "\u{f862}"
        case .phoneAlertBold: return "\u{f863}"
        case .phoneAlertLight: return "\u{f864}"
        case .phoneAlertRegular: return "\u{f865}"
        case .phoneBadgeFilled: return "\u{f866}"
        case .phoneBold: return "\u{f867}"
        case .phoneFilled: return "\u{f868}"
        case .phoneLight: return "\u{f869}"
        case .phoneMutedBold: return "\u{f86a}"
        case .phoneMutedLight: return "\u{f86b}"
        case .phoneMutedRegular: return "\u{f86c}"
        case .phonePrivateBold: return "\u{f86d}"
        case .phonePrivateLight: return "\u{f86e}"
        case .phonePrivateRegular: return "\u{f86f}"
        case .phoneRegular: return "\u{f870}"
        case .phoneReplyAllBold: return "\u{f871}"
        case .phoneReplyAllLight: return "\u{f872}"
        case .phoneReplyAllRegular: return "\u{f873}"
        case .phoneReplyBold: return "\u{f874}"
        case .phoneReplyLight: return "\u{f875}"
        case .phoneReplyRegular: return "\u{f876}"
        case .pickerBold: return "\u{f877}"
        case .pickerLight: return "\u{f878}"
        case .pickerRegular: return "\u{f879}"
        case .pieChartBold: return "\u{f87a}"
        case .pieChartFilled: return "\u{f87b}"
        case .pieChartLight: return "\u{f87c}"
        case .pieChartRegular: return "\u{f87d}"
        case .pinBold: return "\u{f87e}"
        case .pinFilled: return "\u{f87f}"
        case .pinLight: return "\u{f880}"
        case .pinListActivityBold: return "\u{f881}"
        case .pinListActivityLight: return "\u{f882}"
        case .pinListActivityRegular: return "\u{f883}"
        case .pinListBold: return "\u{f884}"
        case .pinListLight: return "\u{f885}"
        case .pinListRegular: return "\u{f886}"
        case .pinMutedBold: return "\u{f887}"
        case .pinMutedFilled: return "\u{f888}"
        case .pinMutedLight: return "\u{f889}"
        case .pinMutedRegular: return "\u{f88a}"
        case .pinRegular: return "\u{f88b}"
        case .pipBold: return "\u{f88c}"
        case .pipEnterBold: return "\u{f88d}"
        case .pipEnterLight: return "\u{f88e}"
        case .pipEnterRegular: return "\u{f88f}"
        case .pipExitBold: return "\u{f890}"
        case .pipExitLight: return "\u{f891}"
        case .pipExitRegular: return "\u{f892}"
        case .pipFilled: return "\u{f893}"
        case .pipLight: return "\u{f894}"
        case .pipRegular: return "\u{f895}"
        case .placeholderBold: return "\u{f896}"
        case .placeholderFilled: return "\u{f897}"
        case .placeholderLight: return "\u{f898}"
        case .placeholderRegular: return "\u{f899}"
        case .playBold: return "\u{f89a}"
        case .playCircleBold: return "\u{f89b}"
        case .playCircleFilled: return "\u{f89c}"
        case .playCircleLight: return "\u{f89d}"
        case .playCircleRegular: return "\u{f89e}"
        case .playFilled: return "\u{f89f}"
        case .playLight: return "\u{f8a0}"
        case .playRegular: return "\u{f8a1}"
        case .plugAcBold: return "\u{f8a2}"
        case .plugAcLight: return "\u{f8a3}"
        case .plugAcRegular: return "\u{f8a4}"
        case .plusBold: return "\u{f8a5}"
        case .plusCircleBold: return "\u{f8a6}"
        case .plusCircleFilled: return "\u{f8a7}"
        case .plusCircleLight: return "\u{f8a8}"
        case .plusCircleRegular: return "\u{f8a9}"
        case .plusLight: return "\u{f8aa}"
        case .plusRegular: return "\u{f8ab}"
        case .pmrBold: return "\u{f8ac}"
        case .pmrFilled: return "\u{f8ad}"
        case .pmrLight: return "\u{f8ae}"
        case .pmrRegular: return "\u{f8af}"
        case .pollBold: return "\u{f8b0}"
        case .pollFilled: return "\u{f8b1}"
        case .pollLight: return "\u{f8b2}"
        case .pollRegular: return "\u{f8b3}"
        case .popInBold: return "\u{f8b4}"
        case .popInLight: return "\u{f8b5}"
        case .popInRegular: return "\u{f8b6}"
        case .popOutBold: return "\u{f8b7}"
        case .popOutLight: return "\u{f8b8}"
        case .popOutRegular: return "\u{f8b9}"
        case .popUpBold: return "\u{f8ba}"
        case .popUpLight: return "\u{f8bb}"
        case .popUpRegular: return "\u{f8bc}"
        case .portraitLandscapeBold: return "\u{f8bd}"
        case .portraitLandscapeLight: return "\u{f8be}"
        case .portraitLandscapeRegular: return "\u{f8bf}"
        case .potentialFraudBold: return "\u{f8c0}"
        case .potentialFraudFilled: return "\u{f8c1}"
        case .potentialFraudLight: return "\u{f8c2}"
        case .potentialFraudRegular: return "\u{f8c3}"
        case .powerAcBold: return "\u{f8c4}"
        case .powerAcLight: return "\u{f8c5}"
        case .powerAcRegular: return "\u{f8c6}"
        case .powerBold: return "\u{f8c7}"
        case .powerLight: return "\u{f8c8}"
        case .powerRegular: return "\u{f8c9}"
        case .preHeaderBold: return "\u{f8ca}"
        case .preHeaderLight: return "\u{f8cb}"
        case .preHeaderRegular: return "\u{f8cc}"
        case .premiumBold: return "\u{f8cd}"
        case .premiumLight: return "\u{f8ce}"
        case .premiumRegular: return "\u{f8cf}"
        case .presentationBold: return "\u{f8d0}"
        case .presentationLight: return "\u{f8d1}"
        case .presentationRegular: return "\u{f8d2}"
        case .preventDownloadBold: return "\u{f8d3}"
        case .preventDownloadFilled: return "\u{f8d4}"
        case .preventDownloadLight: return "\u{f8d5}"
        case .preventDownloadRegular: return "\u{f8d6}"
        case .primaryParticipantBold: return "\u{f8d7}"
        case .primaryParticipantLight: return "\u{f8d8}"
        case .primaryParticipantRegular: return "\u{f8d9}"
        case .printBold: return "\u{f8da}"
        case .printLight: return "\u{f8db}"
        case .printRegular: return "\u{f8dc}"
        case .priorityBadgeFilled: return "\u{f8dd}"
        case .priorityCircleBold: return "\u{f8de}"
        case .priorityCircleFilled: return "\u{f8df}"
        case .priorityCircleLight: return "\u{f8e0}"
        case .priorityCircleRegular: return "\u{f8e1}"
        case .priorityCircleTwoBold: return "\u{f8e2}"
        case .priorityCircleTwoFilled: return "\u{f8e3}"
        case .priorityCircleTwoLight: return "\u{f8e4}"
        case .priorityCircleTwoRegular: return "\u{f8e5}"
        case .priorityWaveBold: return "\u{f8e6}"
        case .priorityWaveLight: return "\u{f8e7}"
        case .priorityWaveRegular: return "\u{f8e8}"
        case .privacyCircleBold: return "\u{f8e9}"
        case .privacyCircleFilled: return "\u{f8ea}"
        case .privacyCircleLight: return "\u{f8eb}"
        case .privacyCircleRegular: return "\u{f8ec}"
        case .privateBold: return "\u{f8ed}"
        case .privateCircleBold: return "\u{f8ee}"
        case .privateCircleFilled: return "\u{f8ef}"
        case .privateCircleLight: return "\u{f8f0}"
        case .privateCircleRegular: return "\u{f8f1}"
        case .privateLight: return "\u{f8f2}"
        case .privateMeetingBold: return "\u{f8f3}"
        case .privateMeetingLight: return "\u{f8f4}"
        case .privateMeetingRegular: return "\u{f8f5}"
        case .privateRegular: return "\u{f8f6}"
        case .productDemoBold: return "\u{f8f7}"
        case .productDemoLight: return "\u{f8f8}"
        case .productDemoRegular: return "\u{f8f9}"
        case .proximityBold: return "\u{f8fa}"
        case .proximityLight: return "\u{f8fb}"
        case .proximityMutedBold: return "\u{f8fc}"
        case .proximityMutedLight: return "\u{f8fd}"
        case .proximityMutedRegular: return "\u{f8fe}"
        case .proximityRegular: return "\u{f8ff}"
        case .proximityVideoBold: return "\u{f900}"
        case .proximityVideoLight: return "\u{f901}"
        case .proximityVideoRegular: return "\u{f902}"
        case .ptoPresenceBold: return "\u{f903}"
        case .ptoPresenceFilled: return "\u{f904}"
        case .ptoPresenceLight: return "\u{f905}"
        case .ptoPresenceRegular: return "\u{f906}"
        case .pullCallBold: return "\u{f907}"
        case .pullCallFilled: return "\u{f908}"
        case .pullCallLight: return "\u{f909}"
        case .pullCallRegular: return "\u{f90a}"
        case .qABold: return "\u{f90b}"
        case .qALight: return "\u{f90c}"
        case .qARegular: return "\u{f90d}"
        case .qrCodeBold: return "\u{f90e}"
        case .qrCodeLight: return "\u{f90f}"
        case .qrCodeRegular: return "\u{f910}"
        case .qrCodeScanBold: return "\u{f911}"
        case .qrCodeScanLight: return "\u{f912}"
        case .qrCodeScanRegular: return "\u{f913}"
        case .qualityBold: return "\u{f914}"
        case .qualityLight: return "\u{f915}"
        case .qualityRegular: return "\u{f916}"
        case .queueContactBold: return "\u{f917}"
        case .queueContactFilled: return "\u{f918}"
        case .queueContactLight: return "\u{f919}"
        case .queueContactRegular: return "\u{f91a}"
        case .quietBold: return "\u{f91b}"
        case .quietHoursPresenceBold: return "\u{f91c}"
        case .quietHoursPresenceFilled: return "\u{f91d}"
        case .quietHoursPresenceLight: return "\u{f91e}"
        case .quietHoursPresenceRegular: return "\u{f91f}"
        case .quietLight: return "\u{f920}"
        case .quietRegular: return "\u{f921}"
        case .radioButtonGroupBold: return "\u{f922}"
        case .radioButtonGroupLight: return "\u{f923}"
        case .radioButtonGroupRegular: return "\u{f924}"
        case .raiseHandBold: return "\u{f925}"
        case .raiseHandCircleFilled: return "\u{f926}"
        case .raiseHandFilled: return "\u{f927}"
        case .raiseHandLight: return "\u{f928}"
        case .raiseHandRegular: return "\u{f929}"
        case .ramBold: return "\u{f92a}"
        case .ramLight: return "\u{f92b}"
        case .ramRegular: return "\u{f92c}"
        case .reactionsBold: return "\u{f92d}"
        case .reactionsFilled: return "\u{f92e}"
        case .reactionsLight: return "\u{f92f}"
        case .reactionsRegular: return "\u{f930}"
        case .reactivateBold: return "\u{f931}"
        case .reactivateLight: return "\u{f932}"
        case .reactivateRegular: return "\u{f933}"
        case .receiveVoiceBold: return "\u{f934}"
        case .receiveVoiceFilled: return "\u{f935}"
        case .receiveVoiceLight: return "\u{f936}"
        case .receiveVoiceRegular: return "\u{f937}"
        case .recentsBold: return "\u{f938}"
        case .recentsFilled: return "\u{f939}"
        case .recentsLight: return "\u{f93a}"
        case .recentsPresenceBadgeFilled: return "\u{f93b}"
        case .recentsPresenceBold: return "\u{f93c}"
        case .recentsPresenceFilled: return "\u{f93d}"
        case .recentsPresenceLight: return "\u{f93e}"
        case .recentsPresenceRegular: return "\u{f93f}"
        case .recentsRegular: return "\u{f940}"
        case .recordActiveBadgeFilled: return "\u{f941}"
        case .recordActiveBold: return "\u{f942}"
        case .recordActiveFilled: return "\u{f943}"
        case .recordActiveLight: return "\u{f944}"
        case .recordActiveRegular: return "\u{f945}"
        case .recordBold: return "\u{f946}"
        case .recordFilled: return "\u{f947}"
        case .recordLight: return "\u{f948}"
        case .recordPausedBadgeFilled: return "\u{f949}"
        case .recordPausedBold: return "\u{f94a}"
        case .recordPausedFilled: return "\u{f94b}"
        case .recordPausedLight: return "\u{f94c}"
        case .recordPausedRegular: return "\u{f94d}"
        case .recordRegular: return "\u{f94e}"
        case .recurringBold: return "\u{f94f}"
        case .recurringLight: return "\u{f950}"
        case .recurringOffBold: return "\u{f951}"
        case .recurringOffLight: return "\u{f952}"
        case .recurringOffRegular: return "\u{f953}"
        case .recurringRegular: return "\u{f954}"
        case .redoBold: return "\u{f955}"
        case .redoLight: return "\u{f956}"
        case .redoRegular: return "\u{f957}"
        case .refreshBold: return "\u{f958}"
        case .refreshLight: return "\u{f959}"
        case .refreshRegular: return "\u{f95a}"
        case .remoteDesktopControlBold: return "\u{f95b}"
        case .remoteDesktopControlFilled: return "\u{f95c}"
        case .remoteDesktopControlLight: return "\u{f95d}"
        case .remoteDesktopControlRegular: return "\u{f95e}"
        case .removeBold: return "\u{f95f}"
        case .removeFilled: return "\u{f960}"
        case .removeLight: return "\u{f961}"
        case .removeRegular: return "\u{f962}"
        case .replyBold: return "\u{f963}"
        case .replyFilled: return "\u{f964}"
        case .replyLight: return "\u{f965}"
        case .replyListBold: return "\u{f966}"
        case .replyListLight: return "\u{f967}"
        case .replyListRegular: return "\u{f968}"
        case .replyPrivatelyBold: return "\u{f969}"
        case .replyPrivatelyLight: return "\u{f96a}"
        case .replyPrivatelyRegular: return "\u{f96b}"
        case .replyRegular: return "\u{f96c}"
        case .resetBold: return "\u{f96d}"
        case .resetLight: return "\u{f96e}"
        case .resetRegular: return "\u{f96f}"
        case .resizeCornerBold: return "\u{f970}"
        case .resizeCornerLight: return "\u{f971}"
        case .resizeCornerRegular: return "\u{f972}"
        case .responsiveMobileBold: return "\u{f973}"
        case .responsiveMobileLight: return "\u{f974}"
        case .responsiveMobileRegular: return "\u{f975}"
        case .restartBold: return "\u{f976}"
        case .restartLight: return "\u{f977}"
        case .restartRegular: return "\u{f978}"
        case .retrieveCallBold: return "\u{f979}"
        case .retrieveCallFilled: return "\u{f97a}"
        case .retrieveCallLight: return "\u{f97b}"
        case .retrieveCallRegular: return "\u{f97c}"
        case .returnBold: return "\u{f97d}"
        case .returnLight: return "\u{f97e}"
        case .returnRegular: return "\u{f97f}"
        case .rewindTenSecBold: return "\u{f980}"
        case .rewindTenSecLight: return "\u{f981}"
        case .rewindTenSecRegular: return "\u{f982}"
        case .ringtoneBold: return "\u{f983}"
        case .ringtoneLight: return "\u{f984}"
        case .ringtoneRegular: return "\u{f985}"
        case .roomCalendarBold: return "\u{f986}"
        case .roomCalendarLight: return "\u{f987}"
        case .roomCalendarRegular: return "\u{f988}"
        case .roomLightsBold: return "\u{f989}"
        case .roomLightsFilled: return "\u{f98a}"
        case .roomLightsLight: return "\u{f98b}"
        case .roomLightsRegular: return "\u{f98c}"
        case .rotateContentBold: return "\u{f98d}"
        case .rotateContentFilled: return "\u{f98e}"
        case .rotateContentLight: return "\u{f98f}"
        case .rotateContentRegular: return "\u{f990}"
        case .rssBold: return "\u{f991}"
        case .rssFilled: return "\u{f992}"
        case .rssLight: return "\u{f993}"
        case .rssRegular: return "\u{f994}"
        case .ruleBasedBold: return "\u{f995}"
        case .ruleBasedLight: return "\u{f996}"
        case .ruleBasedRegular: return "\u{f997}"
        case .runningApplicationBold: return "\u{f998}"
        case .runningApplicationFilled: return "\u{f999}"
        case .runningApplicationLight: return "\u{f99a}"
        case .runningApplicationRegular: return "\u{f99b}"
        case .saveBold: return "\u{f99c}"
        case .saveLight: return "\u{f99d}"
        case .saveRegular: return "\u{f99e}"
        case .saveTranscriptBold: return "\u{f99f}"
        case .saveTranscriptFilled: return "\u{f9a0}"
        case .saveTranscriptLight: return "\u{f9a1}"
        case .saveTranscriptRegular: return "\u{f9a2}"
        case .scanBold: return "\u{f9a3}"
        case .scanLight: return "\u{f9a4}"
        case .scanRegular: return "\u{f9a5}"
        case .scheduleAiBold: return "\u{f9a6}"
        case .scheduleAiLight: return "\u{f9a7}"
        case .scheduleAiRegular: return "\u{f9a8}"
        case .scheduleSendBold: return "\u{f9a9}"
        case .scheduleSendFilled: return "\u{f9aa}"
        case .scheduleSendLight: return "\u{f9ab}"
        case .scheduleSendRegular: return "\u{f9ac}"
        case .scheduleWinnerBold: return "\u{f9ad}"
        case .scheduleWinnerFilled: return "\u{f9ae}"
        case .scheduleWinnerLight: return "\u{f9af}"
        case .scheduleWinnerRegular: return "\u{f9b0}"
        case .schedulerAvailableBold: return "\u{f9b1}"
        case .schedulerAvailableLight: return "\u{f9b2}"
        case .schedulerAvailableRegular: return "\u{f9b3}"
        case .schedulerNotWorkingHoursBold: return "\u{f9b4}"
        case .schedulerNotWorkingHoursLight: return "\u{f9b5}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9b6}"
        case .schedulerUnavailableBold: return "\u{f9b7}"
        case .schedulerUnavailableLight: return "\u{f9b8}"
        case .schedulerUnavailableRegular: return "\u{f9b9}"
        case .schedulerUnknownBold: return "\u{f9ba}"
        case .schedulerUnknownLight: return "\u{f9bb}"
        case .schedulerUnknownRegular: return "\u{f9bc}"
        case .screenshotBold: return "\u{f9bd}"
        case .screenshotDocBold: return "\u{f9be}"
        case .screenshotDocFilled: return "\u{f9bf}"
        case .screenshotDocLight: return "\u{f9c0}"
        case .screenshotDocRegular: return "\u{f9c1}"
        case .screenshotLight: return "\u{f9c2}"
        case .screenshotRegular: return "\u{f9c3}"
        case .searchBold: return "\u{f9c4}"
        case .searchFilled: return "\u{f9c5}"
        case .searchLight: return "\u{f9c6}"
        case .searchRegular: return "\u{f9c7}"
        case .secondaryArrowBold: return "\u{f9c8}"
        case .secondaryArrowLight: return "\u{f9c9}"
        case .secondaryArrowRegular: return "\u{f9ca}"
        case .secureCallLockBold: return "\u{f9cb}"
        case .secureCallLockFilled: return "\u{f9cc}"
        case .secureCallLockLight: return "\u{f9cd}"
        case .secureCallLockRegular: return "\u{f9ce}"
        case .secureCallShieldBold: return "\u{f9cf}"
        case .secureCallShieldFilled: return "\u{f9d0}"
        case .secureCallShieldLight: return "\u{f9d1}"
        case .secureCallShieldRegular: return "\u{f9d2}"
        case .secureCircleBold: return "\u{f9d3}"
        case .secureCircleFilled: return "\u{f9d4}"
        case .secureCircleLight: return "\u{f9d5}"
        case .secureCircleRegular: return "\u{f9d6}"
        case .secureLockBold: return "\u{f9d7}"
        case .secureLockFilled: return "\u{f9d8}"
        case .secureLockLight: return "\u{f9d9}"
        case .secureLockRegular: return "\u{f9da}"
        case .segmentExcludeFilled: return "\u{f9db}"
        case .segmentFilterFilled: return "\u{f9dc}"
        case .segmentIncludeFilled: return "\u{f9dd}"
        case .selectAllBold: return "\u{f9de}"
        case .selectAllFilled: return "\u{f9df}"
        case .selectAllLight: return "\u{f9e0}"
        case .selectAllRegular: return "\u{f9e1}"
        case .selectionBold: return "\u{f9e2}"
        case .selectionFilled: return "\u{f9e3}"
        case .selectionLight: return "\u{f9e4}"
        case .selectionRegular: return "\u{f9e5}"
        case .sendBold: return "\u{f9e6}"
        case .sendDigitsBold: return "\u{f9e7}"
        case .sendDigitsFilled: return "\u{f9e8}"
        case .sendDigitsLight: return "\u{f9e9}"
        case .sendDigitsRegular: return "\u{f9ea}"
        case .sendFilled: return "\u{f9eb}"
        case .sendLight: return "\u{f9ec}"
        case .sendRegular: return "\u{f9ed}"
        case .sendVoiceBold: return "\u{f9ee}"
        case .sendVoiceFilled: return "\u{f9ef}"
        case .sendVoiceLight: return "\u{f9f0}"
        case .sendVoiceRegular: return "\u{f9f1}"
        case .serverBold: return "\u{f9f2}"
        case .serverErrorBold: return "\u{f9f3}"
        case .serverErrorLight: return "\u{f9f4}"
        case .serverErrorRegular: return "\u{f9f5}"
        case .serverLight: return "\u{f9f6}"
        case .serverRegular: return "\u{f9f7}"
        case .servicesBold: return "\u{f9f8}"
        case .servicesLight: return "\u{f9f9}"
        case .servicesRegular: return "\u{f9fa}"
        case .setVariableBold: return "\u{f9fb}"
        case .setVariableLight: return "\u{f9fc}"
        case .setVariableRegular: return "\u{f9fd}"
        case .settingsBold: return "\u{f9fe}"
        case .settingsFilled: return "\u{f9ff}"
        case .settingsLight: return "\u{fa00}"
        case .settingsRegular: return "\u{fa01}"
        case .setupAssistantBold: return "\u{fa02}"
        case .setupAssistantLight: return "\u{fa03}"
        case .setupAssistantRegular: return "\u{fa04}"
        case .sftpBold: return "\u{fa05}"
        case .sftpLight: return "\u{fa06}"
        case .sftpRegular: return "\u{fa07}"
        case .shapeCircleBold: return "\u{fa08}"
        case .shapeCircleFilled: return "\u{fa09}"
        case .shapeCircleLight: return "\u{fa0a}"
        case .shapeCircleMdFilled: return "\u{fa0b}"
        case .shapeCircleRegular: return "\u{fa0c}"
        case .shapeCircleSmFilled: return "\u{fa0d}"
        case .shapeDiagonalLineBold: return "\u{fa0e}"
        case .shapeDiagonalLineLight: return "\u{fa0f}"
        case .shapeDiagonalLineRegular: return "\u{fa10}"
        case .shapeDiamondBold: return "\u{fa11}"
        case .shapeDiamondFilled: return "\u{fa12}"
        case .shapeDiamondLight: return "\u{fa13}"
        case .shapeDiamondRegular: return "\u{fa14}"
        case .shapeOvalBold: return "\u{fa15}"
        case .shapeOvalLight: return "\u{fa16}"
        case .shapeOvalRegular: return "\u{fa17}"
        case .shapeSquareBold: return "\u{fa18}"
        case .shapeSquareFilled: return "\u{fa19}"
        case .shapeSquareLight: return "\u{fa1a}"
        case .shapeSquareRegular: return "\u{fa1b}"
        case .shapeTriangleBold: return "\u{fa1c}"
        case .shapeTriangleFilled: return "\u{fa1d}"
        case .shapeTriangleLight: return "\u{fa1e}"
        case .shapeTriangleRegular: return "\u{fa1f}"
        case .shapesBold: return "\u{fa20}"
        case .shapesFilled: return "\u{fa21}"
        case .shapesLight: return "\u{fa22}"
        case .shapesRegular: return "\u{fa23}"
        case .shareCNativeAdrBold: return "\u{fa24}"
        case .shareCNativeAdrFilled: return "\u{fa25}"
        case .shareCNativeAdrLight: return "\u{fa26}"
        case .shareCNativeAdrRegular: return "\u{fa27}"
        case .shareCNativeIphBold: return "\u{fa28}"
        case .shareCNativeIphLight: return "\u{fa29}"
        case .shareCNativeIphRegular: return "\u{fa2a}"
        case .shareContentOnDeviceBold: return "\u{fa2b}"
        case .shareContentOnDeviceLight: return "\u{fa2c}"
        case .shareContentOnDeviceRegular: return "\u{fa2d}"
        case .shareScreenAddBold: return "\u{fa2e}"
        case .shareScreenAddLight: return "\u{fa2f}"
        case .shareScreenAddRegular: return "\u{fa30}"
        case .shareScreenBadgeFilled: return "\u{fa31}"
        case .shareScreenBold: return "\u{fa32}"
        case .shareScreenFilled: return "\u{fa33}"
        case .shareScreenLight: return "\u{fa34}"
        case .shareScreenRegular: return "\u{fa35}"
        case .shareSpaceBold: return "\u{fa36}"
        case .shareSpaceLight: return "\u{fa37}"
        case .shareSpaceRegular: return "\u{fa38}"
        case .shieldBold: return "\u{fa39}"
        case .shieldLight: return "\u{fa3a}"
        case .shieldRegular: return "\u{fa3b}"
        case .shoppingCartBold: return "\u{fa3c}"
        case .shoppingCartFilled: return "\u{fa3d}"
        case .shoppingCartLight: return "\u{fa3e}"
        case .shoppingCartRegular: return "\u{fa3f}"
        case .shortTextBoxBold: return "\u{fa40}"
        case .shortTextBoxLight: return "\u{fa41}"
        case .shortTextBoxRegular: return "\u{fa42}"
        case .showBold: return "\u{fa43}"
        case .showFilled: return "\u{fa44}"
        case .showLight: return "\u{fa45}"
        case .showRegular: return "\u{fa46}"
        case .signInBold: return "\u{fa47}"
        case .signInFilled: return "\u{fa48}"
        case .signInForcedBold: return "\u{fa49}"
        case .signInForcedLight: return "\u{fa4a}"
        case .signInForcedRegular: return "\u{fa4b}"
        case .signInLight: return "\u{fa4c}"
        case .signInRegular: return "\u{fa4d}"
        case .signLangIntBold: return "\u{fa4e}"
        case .signLangIntLight: return "\u{fa4f}"
        case .signLangIntRegular: return "\u{fa50}"
        case .signOutBold: return "\u{fa51}"
        case .signOutLight: return "\u{fa52}"
        case .signOutRegular: return "\u{fa53}"
        case .signalFourBold: return "\u{fa54}"
        case .signalFourLight: return "\u{fa55}"
        case .signalFourRegular: return "\u{fa56}"
        case .signalOneBold: return "\u{fa57}"
        case .signalOneLight: return "\u{fa58}"
        case .signalOneRegular: return "\u{fa59}"
        case .signalThreeBold: return "\u{fa5a}"
        case .signalThreeLight: return "\u{fa5b}"
        case .signalThreeRegular: return "\u{fa5c}"
        case .signalTwoBold: return "\u{fa5d}"
        case .signalTwoLight: return "\u{fa5e}"
        case .signalTwoRegular: return "\u{fa5f}"
        case .signalZeroBold: return "\u{fa60}"
        case .signalZeroLight: return "\u{fa61}"
        case .signalZeroRegular: return "\u{fa62}"
        case .simplePromotionBold: return "\u{fa63}"
        case .simplePromotionLight: return "\u{fa64}"
        case .simplePromotionRegular: return "\u{fa65}"
        case .singleNumberReachBold: return "\u{fa66}"
        case .singleNumberReachLight: return "\u{fa67}"
        case .singleNumberReachRegular: return "\u{fa68}"
        case .sipRegistrationInProgressBold: return "\u{fa69}"
        case .sipRegistrationInProgressFilled: return "\u{fa6a}"
        case .sipRegistrationInProgressLight: return "\u{fa6b}"
        case .sipRegistrationInProgressRegular: return "\u{fa6c}"
        case .skipBold: return "\u{fa6d}"
        case .skipBwBold: return "\u{fa6e}"
        case .skipBwFilled: return "\u{fa6f}"
        case .skipBwLight: return "\u{fa70}"
        case .skipBwRegular: return "\u{fa71}"
        case .skipFwBold: return "\u{fa72}"
        case .skipFwFilled: return "\u{fa73}"
        case .skipFwLight: return "\u{fa74}"
        case .skipFwRegular: return "\u{fa75}"
        case .skipLight: return "\u{fa76}"
        case .skipRegular: return "\u{fa77}"
        case .smartAudioBold: return "\u{fa78}"
        case .smartAudioLight: return "\u{fa79}"
        case .smartAudioRegular: return "\u{fa7a}"
        case .smsFilled: return "\u{fa7b}"
        case .smsInboundBold: return "\u{fa7c}"
        case .smsInboundLight: return "\u{fa7d}"
        case .smsInboundRegular: return "\u{fa7e}"
        case .smsMessageBold: return "\u{fa7f}"
        case .smsMessageFilled: return "\u{fa80}"
        case .smsMessageLight: return "\u{fa81}"
        case .smsMessageRegular: return "\u{fa82}"
        case .smsOutgoingFilled: return "\u{fa83}"
        case .smsUnreadBold: return "\u{fa84}"
        case .smsUnreadLight: return "\u{fa85}"
        case .smsUnreadRegular: return "\u{fa86}"
        case .sortAscendingBold: return "\u{fa87}"
        case .sortAscendingLight: return "\u{fa88}"
        case .sortAscendingRegular: return "\u{fa89}"
        case .sortDescendingBold: return "\u{fa8a}"
        case .sortDescendingLight: return "\u{fa8b}"
        case .sortDescendingRegular: return "\u{fa8c}"
        case .soundDefaultBold: return "\u{fa8d}"
        case .soundDefaultLight: return "\u{fa8e}"
        case .soundDefaultRegular: return "\u{fa8f}"
        case .sparkleBold: return "\u{fa90}"
        case .sparkleFilled: return "\u{fa91}"
        case .sparkleLight: return "\u{fa92}"
        case .sparkleRegular: return "\u{fa93}"
        case .speakerBold: return "\u{fa94}"
        case .speakerDisconnectedBold: return "\u{fa95}"
        case .speakerDisconnectedFilled: return "\u{fa96}"
        case .speakerDisconnectedLight: return "\u{fa97}"
        case .speakerDisconnectedRegular: return "\u{fa98}"
        case .speakerFilled: return "\u{fa99}"
        case .speakerLight: return "\u{fa9a}"
        case .speakerMutedBold: return "\u{fa9b}"
        case .speakerMutedFilled: return "\u{fa9c}"
        case .speakerMutedLight: return "\u{fa9d}"
        case .speakerMutedRegular: return "\u{fa9e}"
        case .speakerOffBold: return "\u{fa9f}"
        case .speakerOffFilled: return "\u{faa0}"
        case .speakerOffLight: return "\u{faa1}"
        case .speakerOffRegular: return "\u{faa2}"
        case .speakerOnBold: return "\u{faa3}"
        case .speakerOnLight: return "\u{faa4}"
        case .speakerOnRegular: return "\u{faa5}"
        case .speakerRegular: return "\u{faa6}"
        case .speakerTurnDownBold: return "\u{faa7}"
        case .speakerTurnDownFilled: return "\u{faa8}"
        case .speakerTurnDownLight: return "\u{faa9}"
        case .speakerTurnDownRegular: return "\u{faaa}"
        case .speakerTurnUpBold: return "\u{faab}"
        case .speakerTurnUpFilled: return "\u{faac}"
        case .speakerTurnUpLight: return "\u{faad}"
        case .speakerTurnUpRegular: return "\u{faae}"
        case .speedDialBold: return "\u{faaf}"
        case .speedDialFilled: return "\u{fab0}"
        case .speedDialLight: return "\u{fab1}"
        case .speedDialRegular: return "\u{fab2}"
        case .spellCheckerBold: return "\u{fab3}"
        case .spellCheckerLight: return "\u{fab4}"
        case .spellCheckerRegular: return "\u{fab5}"
        case .splitViewBold: return "\u{fab6}"
        case .splitViewLight: return "\u{fab7}"
        case .splitViewRegular: return "\u{fab8}"
        case .stackedAreaChartBold: return "\u{fab9}"
        case .stackedAreaChartFilled: return "\u{faba}"
        case .stackedAreaChartFullBold: return "\u{fabb}"
        case .stackedAreaChartFullFilled: return "\u{fabc}"
        case .stackedAreaChartFullLight: return "\u{fabd}"
        case .stackedAreaChartFullRegular: return "\u{fabe}"
        case .stackedAreaChartLight: return "\u{fabf}"
        case .stackedAreaChartRegular: return "\u{fac0}"
        case .stackedBarChartBold: return "\u{fac1}"
        case .stackedBarChartFilled: return "\u{fac2}"
        case .stackedBarChartFullBold: return "\u{fac3}"
        case .stackedBarChartFullFilled: return "\u{fac4}"
        case .stackedBarChartFullLight: return "\u{fac5}"
        case .stackedBarChartFullRegular: return "\u{fac6}"
        case .stackedBarChartLight: return "\u{fac7}"
        case .stackedBarChartRegular: return "\u{fac8}"
        case .startChatBold: return "\u{fac9}"
        case .startChatLight: return "\u{faca}"
        case .startChatRegular: return "\u{facb}"
        case .stethoscopeBold: return "\u{facc}"
        case .stethoscopeLight: return "\u{facd}"
        case .stethoscopeRegular: return "\u{face}"
        case .stickersBold: return "\u{facf}"
        case .stickersLight: return "\u{fad0}"
        case .stickersRegular: return "\u{fad1}"
        case .stickiesBold: return "\u{fad2}"
        case .stickiesLight: return "\u{fad3}"
        case .stickiesRegular: return "\u{fad4}"
        case .stopBold: return "\u{fad5}"
        case .stopCircleBold: return "\u{fad6}"
        case .stopCircleFilled: return "\u{fad7}"
        case .stopCircleLight: return "\u{fad8}"
        case .stopCircleRegular: return "\u{fad9}"
        case .stopContentShareBold: return "\u{fada}"
        case .stopContentShareLight: return "\u{fadb}"
        case .stopContentShareRegular: return "\u{fadc}"
        case .stopFilled: return "\u{fadd}"
        case .stopLight: return "\u{fade}"
        case .stopRegular: return "\u{fadf}"
        case .storedInfoBold: return "\u{fae0}"
        case .storedInfoFilled: return "\u{fae1}"
        case .storedInfoLight: return "\u{fae2}"
        case .storedInfoRegular: return "\u{fae3}"
        case .streamingBold: return "\u{fae4}"
        case .streamingLight: return "\u{fae5}"
        case .streamingRegular: return "\u{fae6}"
        case .strikethroughBold: return "\u{fae7}"
        case .strikethroughFilled: return "\u{fae8}"
        case .strikethroughLight: return "\u{fae9}"
        case .strikethroughRegular: return "\u{faea}"
        case .studioModeBold: return "\u{faeb}"
        case .studioModeLight: return "\u{faec}"
        case .studioModeRegular: return "\u{faed}"
        case .subscriptBold: return "\u{faee}"
        case .subscriptLight: return "\u{faef}"
        case .subscriptRegular: return "\u{faf0}"
        case .summarizeAiBold: return "\u{faf1}"
        case .summarizeAiLight: return "\u{faf2}"
        case .summarizeAiRegular: return "\u{faf3}"
        case .superscriptBold: return "\u{faf4}"
        case .superscriptLight: return "\u{faf5}"
        case .superscriptRegular: return "\u{faf6}"
        case .surveyBold: return "\u{faf7}"
        case .surveyFilled: return "\u{faf8}"
        case .surveyLight: return "\u{faf9}"
        case .surveyRegular: return "\u{fafa}"
        case .sxEightyCodecBold: return "\u{fafb}"
        case .sxEightyCodecLight: return "\u{fafc}"
        case .sxEightyCodecRegular: return "\u{fafd}"
        case .sxTenBold: return "\u{fafe}"
        case .sxTenLight: return "\u{faff}"
        case .sxTenRegular: return "\u{fb00}"
        case .sxTwentyBold: return "\u{fb01}"
        case .sxTwentyLight: return "\u{fb02}"
        case .sxTwentyRegular: return "\u{fb03}"
        case .tableBold: return "\u{fb04}"
        case .tableLight: return "\u{fb05}"
        case .tableRegular: return "\u{fb06}"
        case .tabletBold: return "\u{fb07}"
        case .tabletLight: return "\u{fb08}"
        case .tabletRegular: return "\u{fb09}"
        case .tabsBold: return "\u{fb0a}"
        case .tabsLight: return "\u{fb0b}"
        case .tabsRegular: return "\u{fb0c}"
        case .tagBold: return "\u{fb0d}"
        case .tagLight: return "\u{fb0e}"
        case .tagRegular: return "\u{fb0f}"
        case .tapBold: return "\u{fb10}"
        case .tapFilled: return "\u{fb11}"
        case .tapLight: return "\u{fb12}"
        case .tapRegular: return "\u{fb13}"
        case .telepresenceAlertBold: return "\u{fb14}"
        case .telepresenceAlertLight: return "\u{fb15}"
        case .telepresenceAlertMutedBold: return "\u{fb16}"
        case .telepresenceAlertMutedLight: return "\u{fb17}"
        case .telepresenceAlertMutedRegular: return "\u{fb18}"
        case .telepresenceAlertRegular: return "\u{fb19}"
        case .telepresenceBold: return "\u{fb1a}"
        case .telepresenceIxFiveThousandBold: return "\u{fb1b}"
        case .telepresenceIxFiveThousandLight: return "\u{fb1c}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb1d}"
        case .telepresenceLight: return "\u{fb1e}"
        case .telepresenceMutedBold: return "\u{fb1f}"
        case .telepresenceMutedLight: return "\u{fb20}"
        case .telepresenceMutedRegular: return "\u{fb21}"
        case .telepresencePrivateBold: return "\u{fb22}"
        case .telepresencePrivateLight: return "\u{fb23}"
        case .telepresencePrivateRegular: return "\u{fb24}"
        case .telepresenceRegular: return "\u{fb25}"
        case .temperatureBold: return "\u{fb26}"
        case .temperatureLight: return "\u{fb27}"
        case .temperatureRegular: return "\u{fb28}"
        case .testTubeBold: return "\u{fb29}"
        case .testTubeFilled: return "\u{fb2a}"
        case .testTubeLight: return "\u{fb2b}"
        case .testTubeRegular: return "\u{fb2c}"
        case .textAlignCenterBold: return "\u{fb2d}"
        case .textAlignCenterFilled: return "\u{fb2e}"
        case .textAlignCenterLight: return "\u{fb2f}"
        case .textAlignCenterRegular: return "\u{fb30}"
        case .textAlignLeftBold: return "\u{fb31}"
        case .textAlignLeftFilled: return "\u{fb32}"
        case .textAlignLeftLight: return "\u{fb33}"
        case .textAlignLeftRegular: return "\u{fb34}"
        case .textAlignRightBold: return "\u{fb35}"
        case .textAlignRightFilled: return "\u{fb36}"
        case .textAlignRightLight: return "\u{fb37}"
        case .textAlignRightRegular: return "\u{fb38}"
        case .textBold: return "\u{fb39}"
        case .textBoxCursorLight: return "\u{fb3a}"
        case .textCodeBlockBold: return "\u{fb3b}"
        case .textCodeBlockLight: return "\u{fb3c}"
        case .textCodeBlockRegular: return "\u{fb3d}"
        case .textHighlightBold: return "\u{fb3e}"
        case .textHighlightFilled: return "\u{fb3f}"
        case .textHighlightLight: return "\u{fb40}"
        case .textHighlightRegular: return "\u{fb41}"
        case .textLight: return "\u{fb42}"
        case .textRegular: return "\u{fb43}"
        case .threeColumnBold: return "\u{fb44}"
        case .threeColumnLight: return "\u{fb45}"
        case .threeColumnRegular: return "\u{fb46}"
        case .threeDObjectBold: return "\u{fb47}"
        case .threeDObjectLight: return "\u{fb48}"
        case .threeDObjectRegular: return "\u{fb49}"
        case .timeExclusionBold: return "\u{fb4a}"
        case .timeExclusionLight: return "\u{fb4b}"
        case .timeExclusionRegular: return "\u{fb4c}"
        case .tooFastBold: return "\u{fb4d}"
        case .tooFastLight: return "\u{fb4e}"
        case .tooFastRegular: return "\u{fb4f}"
        case .tooSlowBold: return "\u{fb50}"
        case .tooSlowLight: return "\u{fb51}"
        case .tooSlowRegular: return "\u{fb52}"
        case .toolsBold: return "\u{fb53}"
        case .toolsFilled: return "\u{fb54}"
        case .toolsLight: return "\u{fb55}"
        case .toolsRegular: return "\u{fb56}"
        case .touchTenBold: return "\u{fb57}"
        case .touchTenLight: return "\u{fb58}"
        case .touchTenRegular: return "\u{fb59}"
        case .transcriptBold: return "\u{fb5a}"
        case .transcriptFilled: return "\u{fb5b}"
        case .transcriptLight: return "\u{fb5c}"
        case .transcriptRegular: return "\u{fb5d}"
        case .translateBold: return "\u{fb5e}"
        case .translateLight: return "\u{fb5f}"
        case .translateRegular: return "\u{fb60}"
        case .translateUndoBold: return "\u{fb61}"
        case .translateUndoLight: return "\u{fb62}"
        case .translateUndoRegular: return "\u{fb63}"
        case .trendingBold: return "\u{fb64}"
        case .trendingDownBold: return "\u{fb65}"
        case .trendingDownFilled: return "\u{fb66}"
        case .trendingDownLight: return "\u{fb67}"
        case .trendingDownRegular: return "\u{fb68}"
        case .trendingFilled: return "\u{fb69}"
        case .trendingLight: return "\u{fb6a}"
        case .trendingRegular: return "\u{fb6b}"
        case .trimBold: return "\u{fb6c}"
        case .trimLight: return "\u{fb6d}"
        case .trimRegular: return "\u{fb6e}"
        case .twoColumnBold: return "\u{fb6f}"
        case .twoColumnLight: return "\u{fb70}"
        case .twoColumnRegular: return "\u{fb71}"
        case .twoWayVoiceStreamBold: return "\u{fb72}"
        case .twoWayVoiceStreamFilled: return "\u{fb73}"
        case .twoWayVoiceStreamLight: return "\u{fb74}"
        case .twoWayVoiceStreamRegular: return "\u{fb75}"
        case .ucmCloudBold: return "\u{fb76}"
        case .ucmCloudLight: return "\u{fb77}"
        case .ucmCloudRegular: return "\u{fb78}"
        case .unblockBold: return "\u{fb79}"
        case .unblockFilled: return "\u{fb7a}"
        case .unblockLight: return "\u{fb7b}"
        case .unblockRegular: return "\u{fb7c}"
        case .underlineBold: return "\u{fb7d}"
        case .underlineFilled: return "\u{fb7e}"
        case .underlineLight: return "\u{fb7f}"
        case .underlineRegular: return "\u{fb80}"
        case .undoBold: return "\u{fb81}"
        case .undoLight: return "\u{fb82}"
        case .undoRegular: return "\u{fb83}"
        case .unlinkBold: return "\u{fb84}"
        case .unlinkLight: return "\u{fb85}"
        case .unlinkRegular: return "\u{fb86}"
        case .unreadBold: return "\u{fb87}"
        case .unreadFilled: return "\u{fb88}"
        case .unreadLight: return "\u{fb89}"
        case .unreadRegular: return "\u{fb8a}"
        case .unsecureUnlockedBold: return "\u{fb8b}"
        case .unsecureUnlockedFilled: return "\u{fb8c}"
        case .unsecureUnlockedLight: return "\u{fb8d}"
        case .unsecureUnlockedRegular: return "\u{fb8e}"
        case .unsortedBold: return "\u{fb8f}"
        case .unsortedLight: return "\u{fb90}"
        case .unsortedRegular: return "\u{fb91}"
        case .updateFileShareBold: return "\u{fb92}"
        case .updateFileShareLight: return "\u{fb93}"
        case .updateFileShareRegular: return "\u{fb94}"
        case .uploadBold: return "\u{fb95}"
        case .uploadImageBold: return "\u{fb96}"
        case .uploadImageLight: return "\u{fb97}"
        case .uploadImageRegular: return "\u{fb98}"
        case .uploadLight: return "\u{fb99}"
        case .uploadRegular: return "\u{fb9a}"
        case .urgentVoicemailBold: return "\u{fb9b}"
        case .urgentVoicemailFilled: return "\u{fb9c}"
        case .usbBold: return "\u{fb9d}"
        case .usbHeadsetBold: return "\u{fb9e}"
        case .usbHeadsetLight: return "\u{fb9f}"
        case .usbHeadsetMutedBold: return "\u{fba0}"
        case .usbHeadsetMutedLight: return "\u{fba1}"
        case .usbHeadsetMutedRegular: return "\u{fba2}"
        case .usbHeadsetRegular: return "\u{fba3}"
        case .usbLight: return "\u{fba4}"
        case .usbRegular: return "\u{fba5}"
        case .userBold: return "\u{fba6}"
        case .userDeactivateBold: return "\u{fba7}"
        case .userDeactivateLight: return "\u{fba8}"
        case .userDeactivateRegular: return "\u{fba9}"
        case .userLight: return "\u{fbaa}"
        case .userRegular: return "\u{fbab}"
        case .videoBlurBold: return "\u{fbac}"
        case .videoBlurFilled: return "\u{fbad}"
        case .videoBlurLight: return "\u{fbae}"
        case .videoBlurRegular: return "\u{fbaf}"
        case .videoBold: return "\u{fbb0}"
        case .videoEffectBold: return "\u{fbb1}"
        case .videoEffectFilled: return "\u{fbb2}"
        case .videoEffectLight: return "\u{fbb3}"
        case .videoEffectRegular: return "\u{fbb4}"
        case .videoFilled: return "\u{fbb5}"
        case .videoLayoutBold: return "\u{fbb6}"
        case .videoLayoutEqualBold: return "\u{fbb7}"
        case .videoLayoutEqualDualBold: return "\u{fbb8}"
        case .videoLayoutEqualDualLight: return "\u{fbb9}"
        case .videoLayoutEqualDualRegular: return "\u{fbba}"
        case .videoLayoutEqualFilled: return "\u{fbbb}"
        case .videoLayoutEqualLight: return "\u{fbbc}"
        case .videoLayoutEqualRegular: return "\u{fbbd}"
        case .videoLayoutFilled: return "\u{fbbe}"
        case .videoLayoutLight: return "\u{fbbf}"
        case .videoLayoutOverlayBold: return "\u{fbc0}"
        case .videoLayoutOverlayFilled: return "\u{fbc1}"
        case .videoLayoutOverlayLight: return "\u{fbc2}"
        case .videoLayoutOverlayRegular: return "\u{fbc3}"
        case .videoLayoutPresenterDominantBold: return "\u{fbc4}"
        case .videoLayoutPresenterDominantLight: return "\u{fbc5}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbc6}"
        case .videoLayoutProminentBold: return "\u{fbc7}"
        case .videoLayoutProminentFilled: return "\u{fbc8}"
        case .videoLayoutProminentLight: return "\u{fbc9}"
        case .videoLayoutProminentRegular: return "\u{fbca}"
        case .videoLayoutRegular: return "\u{fbcb}"
        case .videoLayoutShareDominantBold: return "\u{fbcc}"
        case .videoLayoutShareDominantLight: return "\u{fbcd}"
        case .videoLayoutShareDominantRegular: return "\u{fbce}"
        case .videoLayoutSingleBold: return "\u{fbcf}"
        case .videoLayoutSingleFilled: return "\u{fbd0}"
        case .videoLayoutSingleLight: return "\u{fbd1}"
        case .videoLayoutSingleRegular: return "\u{fbd2}"
        case .videoLayoutStackBold: return "\u{fbd3}"
        case .videoLayoutStackFilled: return "\u{fbd4}"
        case .videoLayoutStackLight: return "\u{fbd5}"
        case .videoLayoutStackRegular: return "\u{fbd6}"
        case .videoLayoutVideoDominantBold: return "\u{fbd7}"
        case .videoLayoutVideoDominantFilled: return "\u{fbd8}"
        case .videoLayoutVideoDominantLight: return "\u{fbd9}"
        case .videoLayoutVideoDominantRegular: return "\u{fbda}"
        case .videoLight: return "\u{fbdb}"
        case .videoPlusBold: return "\u{fbdc}"
        case .videoPlusFilled: return "\u{fbdd}"
        case .videoPlusLight: return "\u{fbde}"
        case .videoPlusRegular: return "\u{fbdf}"
        case .videoRegular: return "\u{fbe0}"
        case .videoSpeakerTrackBold: return "\u{fbe1}"
        case .videoSpeakerTrackFilled: return "\u{fbe2}"
        case .videoSpeakerTrackLight: return "\u{fbe3}"
        case .videoSpeakerTrackRegular: return "\u{fbe4}"
        case .viewAllBold: return "\u{fbe5}"
        case .viewAllLight: return "\u{fbe6}"
        case .viewAllRegular: return "\u{fbe7}"
        case .viewListBold: return "\u{fbe8}"
        case .viewListFilled: return "\u{fbe9}"
        case .viewListLight: return "\u{fbea}"
        case .viewListRegular: return "\u{fbeb}"
        case .viewStackedBold: return "\u{fbec}"
        case .viewStackedFilled: return "\u{fbed}"
        case .viewStackedLight: return "\u{fbee}"
        case .viewStackedRegular: return "\u{fbef}"
        case .viewThumbnailBold: return "\u{fbf0}"
        case .viewThumbnailFilled: return "\u{fbf1}"
        case .viewThumbnailLight: return "\u{fbf2}"
        case .viewThumbnailRegular: return "\u{fbf3}"
        case .visionproBold: return "\u{fbf4}"
        case .visionproFilled: return "\u{fbf5}"
        case .visionproLight: return "\u{fbf6}"
        case .visionproMoveCallInBold: return "\u{fbf7}"
        case .visionproMoveCallInFilled: return "\u{fbf8}"
        case .visionproMoveCallInLight: return "\u{fbf9}"
        case .visionproMoveCallInOutBold: return "\u{fbfa}"
        case .visionproMoveCallInOutFilled: return "\u{fbfb}"
        case .visionproMoveCallInOutLight: return "\u{fbfc}"
        case .visionproMoveCallInOutRegular: return "\u{fbfd}"
        case .visionproMoveCallInRegular: return "\u{fbfe}"
        case .visionproMoveCallOutBold: return "\u{fbff}"
        case .visionproMoveCallOutFilled: return "\u{fc00}"
        case .visionproMoveCallOutLight: return "\u{fc01}"
        case .visionproMoveCallOutRegular: return "\u{fc02}"
        case .visionproRegular: return "\u{fc03}"
        case .voicemailBold: return "\u{fc04}"
        case .voicemailFilled: return "\u{fc05}"
        case .voicemailLight: return "\u{fc06}"
        case .voicemailRegular: return "\u{fc07}"
        case .vpnBold: return "\u{fc08}"
        case .vpnFilled: return "\u{fc09}"
        case .vpnLight: return "\u{fc0a}"
        case .vpnRegular: return "\u{fc0b}"
        case .vscBold: return "\u{fc0c}"
        case .vscLight: return "\u{fc0d}"
        case .vscRegular: return "\u{fc0e}"
        case .waffleMenuBold: return "\u{fc0f}"
        case .waffleMenuLight: return "\u{fc10}"
        case .waffleMenuRegular: return "\u{fc11}"
        case .waitingRoomBold: return "\u{fc12}"
        case .waitingRoomLight: return "\u{fc13}"
        case .waitingRoomRegular: return "\u{fc14}"
        case .wallpaperBold: return "\u{fc15}"
        case .wallpaperLight: return "\u{fc16}"
        case .wallpaperRegular: return "\u{fc17}"
        case .warningBadgeFilled: return "\u{fc18}"
        case .warningBold: return "\u{fc19}"
        case .warningFilled: return "\u{fc1a}"
        case .warningLight: return "\u{fc1b}"
        case .warningRegular: return "\u{fc1c}"
        case .webexBoardBold: return "\u{fc1d}"
        case .webexBoardLight: return "\u{fc1e}"
        case .webexBoardRegular: return "\u{fc1f}"
        case .webexCodecPlusBold: return "\u{fc20}"
        case .webexCodecPlusLight: return "\u{fc21}"
        case .webexCodecPlusRegular: return "\u{fc22}"
        case .webexDeskCameraBold: return "\u{fc23}"
        case .webexDeskCameraLight: return "\u{fc24}"
        case .webexDeskCameraRegular: return "\u{fc25}"
        case .webexMeetingsBold: return "\u{fc26}"
        case .webexMeetingsFilled: return "\u{fc27}"
        case .webexMeetingsLight: return "\u{fc28}"
        case .webexMeetingsRegular: return "\u{fc29}"
        case .webexQuadCameraBold: return "\u{fc2a}"
        case .webexQuadCameraLight: return "\u{fc2b}"
        case .webexQuadCameraRegular: return "\u{fc2c}"
        case .webexRoomKitBold: return "\u{fc2d}"
        case .webexRoomKitLight: return "\u{fc2e}"
        case .webexRoomKitPlusBold: return "\u{fc2f}"
        case .webexRoomKitPlusLight: return "\u{fc30}"
        case .webexRoomKitPlusRegular: return "\u{fc31}"
        case .webexRoomKitRegular: return "\u{fc32}"
        case .webexShareBold: return "\u{fc33}"
        case .webexShareLight: return "\u{fc34}"
        case .webexShareRegular: return "\u{fc35}"
        case .webexTeamsBold: return "\u{fc36}"
        case .webexTeamsFilled: return "\u{fc37}"
        case .webexTeamsLight: return "\u{fc38}"
        case .webexTeamsNewBold: return "\u{fc39}"
        case .webexTeamsNewFilled: return "\u{fc3a}"
        case .webexTeamsNewLight: return "\u{fc3b}"
        case .webexTeamsNewRegular: return "\u{fc3c}"
        case .webexTeamsRegular: return "\u{fc3d}"
        case .webexTeamsRemoveBold: return "\u{fc3e}"
        case .webexTeamsRemoveLight: return "\u{fc3f}"
        case .webexTeamsRemoveRegular: return "\u{fc40}"
        case .webinarBold: return "\u{fc41}"
        case .webinarFilled: return "\u{fc42}"
        case .webinarLight: return "\u{fc43}"
        case .webinarRegular: return "\u{fc44}"
        case .weeklyRecurringScheduleBold: return "\u{fc45}"
        case .weeklyRecurringScheduleLight: return "\u{fc46}"
        case .weeklyRecurringScheduleRegular: return "\u{fc47}"
        case .whisperAnnouncementBold: return "\u{fc48}"
        case .whisperAnnouncementFilled: return "\u{fc49}"
        case .whisperAnnouncementLight: return "\u{fc4a}"
        case .whisperAnnouncementRegular: return "\u{fc4b}"
        case .whisperCoachBold: return "\u{fc4c}"
        case .whisperCoachFilled: return "\u{fc4d}"
        case .whisperCoachLight: return "\u{fc4e}"
        case .whisperCoachRegular: return "\u{fc4f}"
        case .whiteboardBold: return "\u{fc50}"
        case .whiteboardContentBold: return "\u{fc51}"
        case .whiteboardContentFilled: return "\u{fc52}"
        case .whiteboardContentLight: return "\u{fc53}"
        case .whiteboardContentRegular: return "\u{fc54}"
        case .whiteboardFilled: return "\u{fc55}"
        case .whiteboardLight: return "\u{fc56}"
        case .whiteboardRegular: return "\u{fc57}"
        case .widgetBold: return "\u{fc58}"
        case .widgetFilled: return "\u{fc59}"
        case .widgetLight: return "\u{fc5a}"
        case .widgetRegular: return "\u{fc5b}"
        case .wifiBold: return "\u{fc5c}"
        case .wifiErrorBold: return "\u{fc5d}"
        case .wifiErrorLight: return "\u{fc5e}"
        case .wifiErrorRegular: return "\u{fc5f}"
        case .wifiLight: return "\u{fc60}"
        case .wifiRegular: return "\u{fc61}"
        case .wifiSignalGoodBold: return "\u{fc62}"
        case .wifiSignalGoodLight: return "\u{fc63}"
        case .wifiSignalGoodRegular: return "\u{fc64}"
        case .wifiSignalPoorBold: return "\u{fc65}"
        case .wifiSignalPoorLight: return "\u{fc66}"
        case .wifiSignalPoorRegular: return "\u{fc67}"
        case .wifiSignalUnstableBold: return "\u{fc68}"
        case .wifiSignalUnstableLight: return "\u{fc69}"
        case .wifiSignalUnstableRegular: return "\u{fc6a}"
        case .windowCornerScrubBold: return "\u{fc6b}"
        case .windowCornerScrubLight: return "\u{fc6c}"
        case .windowCornerScrubRegular: return "\u{fc6d}"
        case .windowRightCornerScrubBold: return "\u{fc6e}"
        case .windowRightCornerScrubLight: return "\u{fc6f}"
        case .windowRightCornerScrubRegular: return "\u{fc70}"
        case .windowVerticalScrubBold: return "\u{fc71}"
        case .windowVerticalScrubLight: return "\u{fc72}"
        case .windowVerticalScrubRegular: return "\u{fc73}"
        case .workflowDeploymentsBold: return "\u{fc74}"
        case .workflowDeploymentsFilled: return "\u{fc75}"
        case .workflowDeploymentsLight: return "\u{fc76}"
        case .workflowDeploymentsRegular: return "\u{fc77}"
        case .workphoneBold: return "\u{fc78}"
        case .workphoneLight: return "\u{fc79}"
        case .workphoneRegular: return "\u{fc7a}"
        case .zoomInBold: return "\u{fc7b}"
        case .zoomInLight: return "\u{fc7c}"
        case .zoomInRegular: return "\u{fc7d}"
        case .zoomOutBold: return "\u{fc7e}"
        case .zoomOutLight: return "\u{fc7f}"
        case .zoomOutRegular: return "\u{fc80}"
