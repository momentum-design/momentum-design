...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .fileExcelBold: return "\u{f5bc}"
        case .fileExcelFilled: return "\u{f5bd}"
        case .fileExcelLight: return "\u{f5be}"
        case .fileExcelRegular: return "\u{f5bf}"
        case .fileGraphBold: return "\u{f5c0}"
        case .fileGraphFilled: return "\u{f5c1}"
        case .fileGraphLight: return "\u{f5c2}"
        case .fileGraphRegular: return "\u{f5c3}"
        case .fileImageBold: return "\u{f5c4}"
        case .fileImageFilled: return "\u{f5c5}"
        case .fileImageLight: return "\u{f5c6}"
        case .fileImageNoneBold: return "\u{f5c7}"
        case .fileImageNoneLight: return "\u{f5c8}"
        case .fileImageNoneRegular: return "\u{f5c9}"
        case .fileImageRegular: return "\u{f5ca}"
        case .fileJsBold: return "\u{f5cb}"
        case .fileJsFilled: return "\u{f5cc}"
        case .fileJsLight: return "\u{f5cd}"
        case .fileJsRegular: return "\u{f5ce}"
        case .fileKeynoteBold: return "\u{f5cf}"
        case .fileKeynoteFilled: return "\u{f5d0}"
        case .fileKeynoteLight: return "\u{f5d1}"
        case .fileKeynoteRegular: return "\u{f5d2}"
        case .fileLockedBold: return "\u{f5d3}"
        case .fileLockedFilled: return "\u{f5d4}"
        case .fileLockedLight: return "\u{f5d5}"
        case .fileLockedRegular: return "\u{f5d6}"
        case .fileMissingBold: return "\u{f5d7}"
        case .fileMissingFilled: return "\u{f5d8}"
        case .fileMissingLight: return "\u{f5d9}"
        case .fileMissingRegular: return "\u{f5da}"
        case .fileMusicBold: return "\u{f5db}"
        case .fileMusicFilled: return "\u{f5dc}"
        case .fileMusicLight: return "\u{f5dd}"
        case .fileMusicRegular: return "\u{f5de}"
        case .fileOnenoteBold: return "\u{f5df}"
        case .fileOnenoteFilled: return "\u{f5e0}"
        case .fileOnenoteLight: return "\u{f5e1}"
        case .fileOnenoteRegular: return "\u{f5e2}"
        case .filePdfBold: return "\u{f5e3}"
        case .filePdfFilled: return "\u{f5e4}"
        case .filePdfLight: return "\u{f5e5}"
        case .filePdfRegular: return "\u{f5e6}"
        case .filePowerpointBold: return "\u{f5e7}"
        case .filePowerpointFilled: return "\u{f5e8}"
        case .filePowerpointLight: return "\u{f5e9}"
        case .filePowerpointRegular: return "\u{f5ea}"
        case .fileSpreadsheetBold: return "\u{f5eb}"
        case .fileSpreadsheetFilled: return "\u{f5ec}"
        case .fileSpreadsheetLight: return "\u{f5ed}"
        case .fileSpreadsheetRegular: return "\u{f5ee}"
        case .fileTextBold: return "\u{f5ef}"
        case .fileTextFilled: return "\u{f5f0}"
        case .fileTextLight: return "\u{f5f1}"
        case .fileTextRegular: return "\u{f5f2}"
        case .fileThreeDBold: return "\u{f5f3}"
        case .fileThreeDFilled: return "\u{f5f4}"
        case .fileThreeDLight: return "\u{f5f5}"
        case .fileThreeDRegular: return "\u{f5f6}"
        case .fileVectorBold: return "\u{f5f7}"
        case .fileVectorFilled: return "\u{f5f8}"
        case .fileVectorLight: return "\u{f5f9}"
        case .fileVectorRegular: return "\u{f5fa}"
        case .fileVideoBold: return "\u{f5fb}"
        case .fileVideoFilled: return "\u{f5fc}"
        case .fileVideoLight: return "\u{f5fd}"
        case .fileVideoRegular: return "\u{f5fe}"
        case .fileWordBold: return "\u{f5ff}"
        case .fileWordFilled: return "\u{f600}"
        case .fileWordLight: return "\u{f601}"
        case .fileWordRegular: return "\u{f602}"
        case .fileXmlBold: return "\u{f603}"
        case .fileXmlFilled: return "\u{f604}"
        case .fileXmlLight: return "\u{f605}"
        case .fileXmlRegular: return "\u{f606}"
        case .fileZipBold: return "\u{f607}"
        case .fileZipFilled: return "\u{f608}"
        case .fileZipLight: return "\u{f609}"
        case .fileZipRegular: return "\u{f60a}"
        case .filesBold: return "\u{f60b}"
        case .filesFilled: return "\u{f60c}"
        case .filesLight: return "\u{f60d}"
        case .filesRegular: return "\u{f60e}"
        case .fillColourBold: return "\u{f60f}"
        case .fillColourFilled: return "\u{f610}"
        case .fillColourLight: return "\u{f611}"
        case .fillColourRegular: return "\u{f612}"
        case .filterBold: return "\u{f613}"
        case .filterCircleBold: return "\u{f614}"
        case .filterCircleFilled: return "\u{f615}"
        case .filterCircleLight: return "\u{f616}"
        case .filterCircleRegular: return "\u{f617}"
        case .filterLight: return "\u{f618}"
        case .filterRegular: return "\u{f619}"
        case .fitToWidthBold: return "\u{f61a}"
        case .fitToWidthLight: return "\u{f61b}"
        case .fitToWidthRegular: return "\u{f61c}"
        case .fitToWindowExpandBold: return "\u{f61d}"
        case .fitToWindowExpandLight: return "\u{f61e}"
        case .fitToWindowExpandRegular: return "\u{f61f}"
        case .fitToWindowShrinkBold: return "\u{f620}"
        case .fitToWindowShrinkLight: return "\u{f621}"
        case .fitToWindowShrinkRegular: return "\u{f622}"
        case .flagBold: return "\u{f623}"
        case .flagCircleBold: return "\u{f624}"
        case .flagCircleFilled: return "\u{f625}"
        case .flagCircleLight: return "\u{f626}"
        case .flagCircleRegular: return "\u{f627}"
        case .flagFilled: return "\u{f628}"
        case .flagLight: return "\u{f629}"
        case .flagRegular: return "\u{f62a}"
        case .folderBold: return "\u{f62b}"
        case .folderEditBold: return "\u{f62c}"
        case .folderEditLight: return "\u{f62d}"
        case .folderEditRegular: return "\u{f62e}"
        case .folderFilled: return "\u{f62f}"
        case .folderLight: return "\u{f630}"
        case .folderLockBold: return "\u{f631}"
        case .folderLockLight: return "\u{f632}"
        case .folderLockRegular: return "\u{f633}"
        case .folderRegular: return "\u{f634}"
        case .folderViewBold: return "\u{f635}"
        case .folderViewLight: return "\u{f636}"
        case .folderViewRegular: return "\u{f637}"
        case .followUpBold: return "\u{f638}"
        case .followUpLight: return "\u{f639}"
        case .followUpRegular: return "\u{f63a}"
        case .foodBold: return "\u{f63b}"
        case .foodFilled: return "\u{f63c}"
        case .foodLight: return "\u{f63d}"
        case .foodRegular: return "\u{f63e}"
        case .forecastBold: return "\u{f63f}"
        case .forecastFilled: return "\u{f640}"
        case .forecastLight: return "\u{f641}"
        case .forecastRegular: return "\u{f642}"
        case .formatBold: return "\u{f643}"
        case .formatDefaultAppBold: return "\u{f644}"
        case .formatDefaultAppFilled: return "\u{f645}"
        case .formatDefaultAppLight: return "\u{f646}"
        case .formatDefaultAppRegular: return "\u{f647}"
        case .formatLight: return "\u{f648}"
        case .formatPanelControlBarBold: return "\u{f649}"
        case .formatPanelControlBarLight: return "\u{f64a}"
        case .formatPanelControlBarRegular: return "\u{f64b}"
        case .formatPanelControlDownBold: return "\u{f64c}"
        case .formatPanelControlDownLight: return "\u{f64d}"
        case .formatPanelControlDownRegular: return "\u{f64e}"
        case .formatPanelControlLeftBold: return "\u{f64f}"
        case .formatPanelControlLeftLight: return "\u{f650}"
        case .formatPanelControlLeftRegular: return "\u{f651}"
        case .formatPanelControlRightBold: return "\u{f652}"
        case .formatPanelControlRightLight: return "\u{f653}"
        case .formatPanelControlRightRegular: return "\u{f654}"
        case .formatPanelControlUpBold: return "\u{f655}"
        case .formatPanelControlUpDownBold: return "\u{f656}"
        case .formatPanelControlUpDownLight: return "\u{f657}"
        case .formatPanelControlUpDownRegular: return "\u{f658}"
        case .formatPanelControlUpLight: return "\u{f659}"
        case .formatPanelControlUpRegular: return "\u{f65a}"
        case .formatRegular: return "\u{f65b}"
        case .formatViewMixedBold: return "\u{f65c}"
        case .formatViewMixedLight: return "\u{f65d}"
        case .formatViewMixedRegular: return "\u{f65e}"
        case .formulaBold: return "\u{f65f}"
        case .formulaFilled: return "\u{f660}"
        case .formulaLight: return "\u{f661}"
        case .formulaRegular: return "\u{f662}"
        case .forwardMessageBold: return "\u{f663}"
        case .forwardMessageFilled: return "\u{f664}"
        case .forwardMessageLight: return "\u{f665}"
        case .forwardMessageRegular: return "\u{f666}"
        case .forwardTenSecBold: return "\u{f667}"
        case .forwardTenSecLight: return "\u{f668}"
        case .forwardTenSecRegular: return "\u{f669}"
        case .fourColumnBold: return "\u{f66a}"
        case .fourColumnLight: return "\u{f66b}"
        case .fourColumnRegular: return "\u{f66c}"
        case .fourWayNavigationBold: return "\u{f66d}"
        case .fourWayNavigationLight: return "\u{f66e}"
        case .fourWayNavigationRegular: return "\u{f66f}"
        case .frequencyCappingBold: return "\u{f670}"
        case .frequencyCappingLight: return "\u{f671}"
        case .frequencyCappingRegular: return "\u{f672}"
        case .fulfillmentBold: return "\u{f673}"
        case .fulfillmentLight: return "\u{f674}"
        case .fulfillmentRegular: return "\u{f675}"
        case .fullscreenBold: return "\u{f676}"
        case .fullscreenExitBold: return "\u{f677}"
        case .fullscreenExitLight: return "\u{f678}"
        case .fullscreenExitRegular: return "\u{f679}"
        case .fullscreenLight: return "\u{f67a}"
        case .fullscreenRegular: return "\u{f67b}"
        case .genericDeviceVideoBadgeFilled: return "\u{f67c}"
        case .genericDeviceVideoBold: return "\u{f67d}"
        case .genericDeviceVideoFilled: return "\u{f67e}"
        case .genericDeviceVideoLight: return "\u{f67f}"
        case .genericDeviceVideoRegular: return "\u{f680}"
        case .gifBold: return "\u{f681}"
        case .gifFilled: return "\u{f682}"
        case .gifHorizontalBold: return "\u{f683}"
        case .gifHorizontalFilled: return "\u{f684}"
        case .gifHorizontalLight: return "\u{f685}"
        case .gifHorizontalRegular: return "\u{f686}"
        case .gifLight: return "\u{f687}"
        case .gifRegular: return "\u{f688}"
        case .giftBold: return "\u{f689}"
        case .giftFilled: return "\u{f68a}"
        case .giftLight: return "\u{f68b}"
        case .giftRegular: return "\u{f68c}"
        case .greenLeafBold: return "\u{f68d}"
        case .greenLeafFilled: return "\u{f68e}"
        case .greenLeafLight: return "\u{f68f}"
        case .greenLeafRegular: return "\u{f690}"
        case .greenRoomBold: return "\u{f691}"
        case .greenRoomFilled: return "\u{f692}"
        case .greenRoomLight: return "\u{f693}"
        case .greenRoomRegular: return "\u{f694}"
        case .guestIssuerBold: return "\u{f695}"
        case .guestIssuerLight: return "\u{f696}"
        case .guestIssuerRegular: return "\u{f697}"
        case .guideBold: return "\u{f698}"
        case .guideLight: return "\u{f699}"
        case .guideRegular: return "\u{f69a}"
        case .handPointerBold: return "\u{f69b}"
        case .handPointerLight: return "\u{f69c}"
        case .handPointerRegular: return "\u{f69d}"
        case .handlerBold: return "\u{f69e}"
        case .handlerHorizontalBold: return "\u{f69f}"
        case .handlerHorizontalLight: return "\u{f6a0}"
        case .handlerHorizontalRegular: return "\u{f6a1}"
        case .handlerLight: return "\u{f6a2}"
        case .handlerRegular: return "\u{f6a3}"
        case .handsetAlertBold: return "\u{f6a4}"
        case .handsetAlertFilled: return "\u{f6a5}"
        case .handsetAlertLight: return "\u{f6a6}"
        case .handsetAlertRegular: return "\u{f6a7}"
        case .handsetBold: return "\u{f6a8}"
        case .handsetDownSlashBold: return "\u{f6a9}"
        case .handsetDownSlashFilled: return "\u{f6aa}"
        case .handsetDownSlashLight: return "\u{f6ab}"
        case .handsetDownSlashRegular: return "\u{f6ac}"
        case .handsetFilled: return "\u{f6ad}"
        case .handsetLight: return "\u{f6ae}"
        case .handsetMutedBold: return "\u{f6af}"
        case .handsetMutedFilled: return "\u{f6b0}"
        case .handsetMutedLight: return "\u{f6b1}"
        case .handsetMutedRegular: return "\u{f6b2}"
        case .handsetRegular: return "\u{f6b3}"
        case .handsetsArrowLeftBold: return "\u{f6b4}"
        case .handsetsArrowLeftLight: return "\u{f6b5}"
        case .handsetsArrowLeftRegular: return "\u{f6b6}"
        case .handshakeBold: return "\u{f6b7}"
        case .handshakeLight: return "\u{f6b8}"
        case .handshakeRegular: return "\u{f6b9}"
        case .headingOneBold: return "\u{f6ba}"
        case .headingOneLight: return "\u{f6bb}"
        case .headingOneRegular: return "\u{f6bc}"
        case .headingThreeBold: return "\u{f6bd}"
        case .headingThreeLight: return "\u{f6be}"
        case .headingThreeRegular: return "\u{f6bf}"
        case .headingTwoBold: return "\u{f6c0}"
        case .headingTwoLight: return "\u{f6c1}"
        case .headingTwoRegular: return "\u{f6c2}"
        case .headphonesBold: return "\u{f6c3}"
        case .headphonesFilled: return "\u{f6c4}"
        case .headphonesLight: return "\u{f6c5}"
        case .headphonesMutedBold: return "\u{f6c6}"
        case .headphonesMutedFilled: return "\u{f6c7}"
        case .headphonesMutedLight: return "\u{f6c8}"
        case .headphonesMutedRegular: return "\u{f6c9}"
        case .headphonesRegular: return "\u{f6ca}"
        case .headsetAlertBold: return "\u{f6cb}"
        case .headsetAlertLight: return "\u{f6cc}"
        case .headsetAlertRegular: return "\u{f6cd}"
        case .headsetArrowDownBold: return "\u{f6ce}"
        case .headsetArrowDownFilled: return "\u{f6cf}"
        case .headsetArrowDownLight: return "\u{f6d0}"
        case .headsetArrowDownRegular: return "\u{f6d1}"
        case .headsetBluetoothBold: return "\u{f6d2}"
        case .headsetBluetoothLight: return "\u{f6d3}"
        case .headsetBluetoothRegular: return "\u{f6d4}"
        case .headsetBold: return "\u{f6d5}"
        case .headsetFilled: return "\u{f6d6}"
        case .headsetLight: return "\u{f6d7}"
        case .headsetMutedBold: return "\u{f6d8}"
        case .headsetMutedLight: return "\u{f6d9}"
        case .headsetMutedRegular: return "\u{f6da}"
        case .headsetPrivateBold: return "\u{f6db}"
        case .headsetPrivateLight: return "\u{f6dc}"
        case .headsetPrivateRegular: return "\u{f6dd}"
        case .headsetRegular: return "\u{f6de}"
        case .hearingBold: return "\u{f6df}"
        case .hearingImpairedBold: return "\u{f6e0}"
        case .hearingImpairedLight: return "\u{f6e1}"
        case .hearingImpairedRegular: return "\u{f6e2}"
        case .hearingLight: return "\u{f6e3}"
        case .hearingRegular: return "\u{f6e4}"
        case .helpBold: return "\u{f6e5}"
        case .helpCircleBold: return "\u{f6e6}"
        case .helpCircleFilled: return "\u{f6e7}"
        case .helpCircleLight: return "\u{f6e8}"
        case .helpCircleRegular: return "\u{f6e9}"
        case .helpLight: return "\u{f6ea}"
        case .helpRegular: return "\u{f6eb}"
        case .helpdeskBold: return "\u{f6ec}"
        case .helpdeskFilled: return "\u{f6ed}"
        case .helpdeskLight: return "\u{f6ee}"
        case .helpdeskRegular: return "\u{f6ef}"
        case .hideBold: return "\u{f6f0}"
        case .hideFilled: return "\u{f6f1}"
        case .hideLight: return "\u{f6f2}"
        case .hideRegular: return "\u{f6f3}"
        case .homeBold: return "\u{f6f4}"
        case .homeFilled: return "\u{f6f5}"
        case .homeLight: return "\u{f6f6}"
        case .homeRegular: return "\u{f6f7}"
        case .horizontalLineBold: return "\u{f6f8}"
        case .horizontalLineLight: return "\u{f6f9}"
        case .horizontalLineRegular: return "\u{f6fa}"
        case .hotelingBold: return "\u{f6fb}"
        case .hotelingFilled: return "\u{f6fc}"
        case .hotelingLight: return "\u{f6fd}"
        case .hotelingRegular: return "\u{f6fe}"
        case .humidityBold: return "\u{f6ff}"
        case .humidityLight: return "\u{f700}"
        case .humidityRegular: return "\u{f701}"
        case .huntGroupBold: return "\u{f702}"
        case .huntGroupFilled: return "\u{f703}"
        case .huntGroupLight: return "\u{f704}"
        case .huntGroupRegular: return "\u{f705}"
        case .idleBold: return "\u{f706}"
        case .idleFilled: return "\u{f707}"
        case .idleLight: return "\u{f708}"
        case .idleRegular: return "\u{f709}"
        case .immediateBold: return "\u{f70a}"
        case .immediateFilled: return "\u{f70b}"
        case .immediateLight: return "\u{f70c}"
        case .immediateRegular: return "\u{f70d}"
        case .importBold: return "\u{f70e}"
        case .importLight: return "\u{f70f}"
        case .importRegular: return "\u{f710}"
        case .inCommonBold: return "\u{f711}"
        case .inCommonLight: return "\u{f712}"
        case .inCommonRegular: return "\u{f713}"
        case .inboxBold: return "\u{f714}"
        case .inboxFilled: return "\u{f715}"
        case .inboxLight: return "\u{f716}"
        case .inboxRegular: return "\u{f717}"
        case .includeBold: return "\u{f718}"
        case .includeLight: return "\u{f719}"
        case .includeRegular: return "\u{f71a}"
        case .incognitoBold: return "\u{f71b}"
        case .incognitoFilled: return "\u{f71c}"
        case .incognitoLight: return "\u{f71d}"
        case .incognitoRegular: return "\u{f71e}"
        case .incomingCallLegacyBold: return "\u{f71f}"
        case .incomingCallLegacyFilled: return "\u{f720}"
        case .incomingCallLegacyLight: return "\u{f721}"
        case .incomingCallLegacyRegular: return "\u{f722}"
        case .indentDecreaseBold: return "\u{f723}"
        case .indentDecreaseLight: return "\u{f724}"
        case .indentDecreaseRegular: return "\u{f725}"
        case .indentIncreaseBold: return "\u{f726}"
        case .indentIncreaseLight: return "\u{f727}"
        case .indentIncreaseRegular: return "\u{f728}"
        case .infoBadgeFilled: return "\u{f729}"
        case .infoCircleBold: return "\u{f72a}"
        case .infoCircleFilled: return "\u{f72b}"
        case .infoCircleLight: return "\u{f72c}"
        case .infoCircleRegular: return "\u{f72d}"
        case .infoCircleTwoBold: return "\u{f72e}"
        case .infoCircleTwoFilled: return "\u{f72f}"
        case .infoCircleTwoLight: return "\u{f730}"
        case .infoCircleTwoRegular: return "\u{f731}"
        case .inputBold: return "\u{f732}"
        case .inputDisconnectedBold: return "\u{f733}"
        case .inputDisconnectedLight: return "\u{f734}"
        case .inputDisconnectedRegular: return "\u{f735}"
        case .inputLight: return "\u{f736}"
        case .inputRegular: return "\u{f737}"
        case .instantScheduleBold: return "\u{f738}"
        case .instantScheduleFilled: return "\u{f739}"
        case .instantScheduleLight: return "\u{f73a}"
        case .instantScheduleRegular: return "\u{f73b}"
        case .integerBold: return "\u{f73c}"
        case .integerFilled: return "\u{f73d}"
        case .integerLight: return "\u{f73e}"
        case .integerRegular: return "\u{f73f}"
        case .integrationsBold: return "\u{f740}"
        case .integrationsFilled: return "\u{f741}"
        case .integrationsLight: return "\u{f742}"
        case .integrationsRegular: return "\u{f743}"
        case .intelligentRoutingBold: return "\u{f744}"
        case .intelligentRoutingLight: return "\u{f745}"
        case .intelligentRoutingRegular: return "\u{f746}"
        case .interactionBold: return "\u{f747}"
        case .interactionFilled: return "\u{f748}"
        case .interactionLight: return "\u{f749}"
        case .interactionRegular: return "\u{f74a}"
        case .invitedUserBold: return "\u{f74b}"
        case .invitedUserLight: return "\u{f74c}"
        case .invitedUserRegular: return "\u{f74d}"
        case .italicBold: return "\u{f74e}"
        case .italicFilled: return "\u{f74f}"
        case .italicLight: return "\u{f750}"
        case .italicRegular: return "\u{f751}"
        case .joinAudioBold: return "\u{f752}"
        case .joinAudioFilled: return "\u{f753}"
        case .joinAudioLight: return "\u{f754}"
        case .joinAudioRegular: return "\u{f755}"
        case .keepInTouchBold: return "\u{f756}"
        case .keepInTouchFilled: return "\u{f757}"
        case .keepInTouchLight: return "\u{f758}"
        case .keepInTouchRegular: return "\u{f759}"
        case .keyboardBold: return "\u{f75a}"
        case .keyboardCloseBold: return "\u{f75b}"
        case .keyboardCloseLight: return "\u{f75c}"
        case .keyboardCloseRegular: return "\u{f75d}"
        case .keyboardLight: return "\u{f75e}"
        case .keyboardRegular: return "\u{f75f}"
        case .languageBold: return "\u{f760}"
        case .languageFilled: return "\u{f761}"
        case .languageLight: return "\u{f762}"
        case .languageRegular: return "\u{f763}"
        case .laptopBold: return "\u{f764}"
        case .laptopDisconnectedBold: return "\u{f765}"
        case .laptopDisconnectedLight: return "\u{f766}"
        case .laptopDisconnectedRegular: return "\u{f767}"
        case .laptopFilled: return "\u{f768}"
        case .laptopLight: return "\u{f769}"
        case .laptopRegular: return "\u{f76a}"
        case .laserPointerBold: return "\u{f76b}"
        case .laserPointerCursorBlackLight: return "\u{f76c}"
        case .laserPointerCursorBlueLight: return "\u{f76d}"
        case .laserPointerCursorGreenLight: return "\u{f76e}"
        case .laserPointerCursorPurpleLight: return "\u{f76f}"
        case .laserPointerCursorRedLight: return "\u{f770}"
        case .laserPointerCursorWhiteLight: return "\u{f771}"
        case .laserPointerCursorYellowLight: return "\u{f772}"
        case .laserPointerFilled: return "\u{f773}"
        case .laserPointerLight: return "\u{f774}"
        case .laserPointerRegular: return "\u{f775}"
        case .launchBold: return "\u{f776}"
        case .launchFilled: return "\u{f777}"
        case .launchLight: return "\u{f778}"
        case .launchRegular: return "\u{f779}"
        case .layoutSideBySideVerticalBold: return "\u{f77a}"
        case .layoutSideBySideVerticalFilled: return "\u{f77b}"
        case .layoutSideBySideVerticalLight: return "\u{f77c}"
        case .layoutSideBySideVerticalRegular: return "\u{f77d}"
        case .leaveBreakoutSessionBold: return "\u{f77e}"
        case .leaveBreakoutSessionLight: return "\u{f77f}"
        case .leaveBreakoutSessionRegular: return "\u{f780}"
        case .leaveDeviceBold: return "\u{f781}"
        case .leaveDeviceLight: return "\u{f782}"
        case .leaveDeviceRegular: return "\u{f783}"
        case .likeBold: return "\u{f784}"
        case .likeFilled: return "\u{f785}"
        case .likeLight: return "\u{f786}"
        case .likeRegular: return "\u{f787}"
        case .linkBold: return "\u{f788}"
        case .linkLight: return "\u{f789}"
        case .linkRegular: return "\u{f78a}"
        case .listBulletedBold: return "\u{f78b}"
        case .listBulletedLight: return "\u{f78c}"
        case .listBulletedRegular: return "\u{f78d}"
        case .listMenuBold: return "\u{f78e}"
        case .listMenuLight: return "\u{f78f}"
        case .listMenuRegular: return "\u{f790}"
        case .listNumberedBold: return "\u{f791}"
        case .listNumberedLight: return "\u{f792}"
        case .listNumberedRegular: return "\u{f793}"
        case .liveBold: return "\u{f794}"
        case .liveFilled: return "\u{f795}"
        case .liveLight: return "\u{f796}"
        case .liveRegular: return "\u{f797}"
        case .locationBold: return "\u{f798}"
        case .locationFilled: return "\u{f799}"
        case .locationLight: return "\u{f79a}"
        case .locationRegular: return "\u{f79b}"
        case .longTextBoxBold: return "\u{f79c}"
        case .longTextBoxLight: return "\u{f79d}"
        case .longTextBoxRegular: return "\u{f79e}"
        case .lowerHandBold: return "\u{f79f}"
        case .lowerHandLight: return "\u{f7a0}"
        case .lowerHandRegular: return "\u{f7a1}"
        case .magicPenBold: return "\u{f7a2}"
        case .magicPenFilled: return "\u{f7a3}"
        case .magicPenLight: return "\u{f7a4}"
        case .magicPenRegular: return "\u{f7a5}"
        case .markAsUnreadBold: return "\u{f7a6}"
        case .markAsUnreadFilled: return "\u{f7a7}"
        case .markAsUnreadLight: return "\u{f7a8}"
        case .markAsUnreadRegular: return "\u{f7a9}"
        case .markdownBold: return "\u{f7aa}"
        case .markdownFilled: return "\u{f7ab}"
        case .markdownLight: return "\u{f7ac}"
        case .markdownRegular: return "\u{f7ad}"
        case .markerBold: return "\u{f7ae}"
        case .markerFilled: return "\u{f7af}"
        case .markerLight: return "\u{f7b0}"
        case .markerRegular: return "\u{f7b1}"
        case .maximizeBold: return "\u{f7b2}"
        case .maximizeLight: return "\u{f7b3}"
        case .maximizeRegular: return "\u{f7b4}"
        case .mcpBold: return "\u{f7b5}"
        case .mcpFilled: return "\u{f7b6}"
        case .mcpLight: return "\u{f7b7}"
        case .mcpRegular: return "\u{f7b8}"
        case .mediaPlayerBold: return "\u{f7b9}"
        case .mediaPlayerLight: return "\u{f7ba}"
        case .mediaPlayerRegular: return "\u{f7bb}"
        case .mediaQualityGoodBold: return "\u{f7bc}"
        case .mediaQualityGoodFilled: return "\u{f7bd}"
        case .mediaQualityGoodLight: return "\u{f7be}"
        case .mediaQualityGoodRegular: return "\u{f7bf}"
        case .mediaQualityPoorBold: return "\u{f7c0}"
        case .mediaQualityPoorColoredBold: return "\u{f7c1}"
        case .mediaQualityPoorFilled: return "\u{f7c2}"
        case .mediaQualityPoorLight: return "\u{f7c3}"
        case .mediaQualityPoorRegular: return "\u{f7c4}"
        case .mediaQualityUnstableBold: return "\u{f7c5}"
        case .mediaQualityUnstableColoredBold: return "\u{f7c6}"
        case .mediaQualityUnstableFilled: return "\u{f7c7}"
        case .mediaQualityUnstableLight: return "\u{f7c8}"
        case .mediaQualityUnstableRegular: return "\u{f7c9}"
        case .meetBold: return "\u{f7ca}"
        case .meetEndBold: return "\u{f7cb}"
        case .meetEndLight: return "\u{f7cc}"
        case .meetEndRegular: return "\u{f7cd}"
        case .meetFilled: return "\u{f7ce}"
        case .meetLight: return "\u{f7cf}"
        case .meetRegular: return "\u{f7d0}"
        case .meetingSummaryBold: return "\u{f7d1}"
        case .meetingSummaryFilled: return "\u{f7d2}"
        case .meetingSummaryLight: return "\u{f7d3}"
        case .meetingSummaryRegular: return "\u{f7d4}"
        case .meetingsBold: return "\u{f7d5}"
        case .meetingsFilled: return "\u{f7d6}"
        case .meetingsFocusMonthBold: return "\u{f7d7}"
        case .meetingsFocusMonthLight: return "\u{f7d8}"
        case .meetingsFocusMonthRegular: return "\u{f7d9}"
        case .meetingsFocusOneDayBold: return "\u{f7da}"
        case .meetingsFocusOneDayLight: return "\u{f7db}"
        case .meetingsFocusOneDayRegular: return "\u{f7dc}"
        case .meetingsFocusThreeDayBold: return "\u{f7dd}"
        case .meetingsFocusThreeDayLight: return "\u{f7de}"
        case .meetingsFocusThreeDayRegular: return "\u{f7df}"
        case .meetingsFocusUpcomingBold: return "\u{f7e0}"
        case .meetingsFocusUpcomingLight: return "\u{f7e1}"
        case .meetingsFocusUpcomingRegular: return "\u{f7e2}"
        case .meetingsLight: return "\u{f7e3}"
        case .meetingsPresenceBadgeFilled: return "\u{f7e4}"
        case .meetingsPresenceBold: return "\u{f7e5}"
        case .meetingsPresenceFilled: return "\u{f7e6}"
        case .meetingsPresenceLight: return "\u{f7e7}"
        case .meetingsPresenceRegular: return "\u{f7e8}"
        case .meetingsRegular: return "\u{f7e9}"
        case .meetingsTeamBold: return "\u{f7ea}"
        case .meetingsTeamFilled: return "\u{f7eb}"
        case .meetingsTeamLight: return "\u{f7ec}"
        case .meetingsTeamNewBold: return "\u{f7ed}"
        case .meetingsTeamNewLight: return "\u{f7ee}"
        case .meetingsTeamNewRegular: return "\u{f7ef}"
        case .meetingsTeamRegular: return "\u{f7f0}"
        case .mentionBold: return "\u{f7f1}"
        case .mentionFilled: return "\u{f7f2}"
        case .mentionLight: return "\u{f7f3}"
        case .mentionRegular: return "\u{f7f4}"
        case .messageQueingBold: return "\u{f7f5}"
        case .messageQueingLight: return "\u{f7f6}"
        case .messageQueingRegular: return "\u{f7f7}"
        case .microphoneBold: return "\u{f7f8}"
        case .microphoneFilled: return "\u{f7f9}"
        case .microphoneHardMutedBold: return "\u{f7fa}"
        case .microphoneHardMutedCircleFilled: return "\u{f7fb}"
        case .microphoneHardMutedLight: return "\u{f7fc}"
        case .microphoneHardMutedRegular: return "\u{f7fd}"
        case .microphoneLight: return "\u{f7fe}"
        case .microphoneMusicModeBold: return "\u{f7ff}"
        case .microphoneMusicModeLight: return "\u{f800}"
        case .microphoneMusicModeOnBold: return "\u{f801}"
        case .microphoneMusicModeOnHighBold: return "\u{f802}"
        case .microphoneMusicModeOnHighFilled: return "\u{f803}"
        case .microphoneMusicModeOnHighLight: return "\u{f804}"
        case .microphoneMusicModeOnHighRegular: return "\u{f805}"
        case .microphoneMusicModeOnLight: return "\u{f806}"
        case .microphoneMusicModeOnLowBold: return "\u{f807}"
        case .microphoneMusicModeOnLowFilled: return "\u{f808}"
        case .microphoneMusicModeOnLowLight: return "\u{f809}"
        case .microphoneMusicModeOnLowRegular: return "\u{f80a}"
        case .microphoneMusicModeOnRegular: return "\u{f80b}"
        case .microphoneMusicModeRegular: return "\u{f80c}"
        case .microphoneMutedBold: return "\u{f80d}"
        case .microphoneMutedCircleFilled: return "\u{f80e}"
        case .microphoneMutedFilled: return "\u{f80f}"
        case .microphoneMutedLight: return "\u{f810}"
        case .microphoneMutedRegular: return "\u{f811}"
        case .microphoneOnBold: return "\u{f812}"
        case .microphoneOnHighBold: return "\u{f813}"
        case .microphoneOnHighFilled: return "\u{f814}"
        case .microphoneOnHighLight: return "\u{f815}"
        case .microphoneOnHighRegular: return "\u{f816}"
        case .microphoneOnLight: return "\u{f817}"
        case .microphoneOnLowBold: return "\u{f818}"
        case .microphoneOnLowFilled: return "\u{f819}"
        case .microphoneOnLowLight: return "\u{f81a}"
        case .microphoneOnLowRegular: return "\u{f81b}"
        case .microphoneOnRegular: return "\u{f81c}"
        case .microphoneOptAllBold: return "\u{f81d}"
        case .microphoneOptAllLight: return "\u{f81e}"
        case .microphoneOptAllMutedBold: return "\u{f81f}"
        case .microphoneOptAllMutedLight: return "\u{f820}"
        case .microphoneOptAllMutedRegular: return "\u{f821}"
        case .microphoneOptAllOnBold: return "\u{f822}"
        case .microphoneOptAllOnHighBold: return "\u{f823}"
        case .microphoneOptAllOnHighFilled: return "\u{f824}"
        case .microphoneOptAllOnHighLight: return "\u{f825}"
        case .microphoneOptAllOnHighRegular: return "\u{f826}"
        case .microphoneOptAllOnLight: return "\u{f827}"
        case .microphoneOptAllOnLowBold: return "\u{f828}"
        case .microphoneOptAllOnLowFilled: return "\u{f829}"
        case .microphoneOptAllOnLowLight: return "\u{f82a}"
        case .microphoneOptAllOnLowRegular: return "\u{f82b}"
        case .microphoneOptAllOnRegular: return "\u{f82c}"
        case .microphoneOptAllRegular: return "\u{f82d}"
        case .microphoneOptMeBold: return "\u{f82e}"
        case .microphoneOptMeLight: return "\u{f82f}"
        case .microphoneOptMeMutedBold: return "\u{f830}"
        case .microphoneOptMeMutedLight: return "\u{f831}"
        case .microphoneOptMeMutedRegular: return "\u{f832}"
        case .microphoneOptMeOnBold: return "\u{f833}"
        case .microphoneOptMeOnHighBold: return "\u{f834}"
        case .microphoneOptMeOnHighFilled: return "\u{f835}"
        case .microphoneOptMeOnHighLight: return "\u{f836}"
        case .microphoneOptMeOnHighRegular: return "\u{f837}"
        case .microphoneOptMeOnLight: return "\u{f838}"
        case .microphoneOptMeOnLowBol: return "\u{f839}"
        case .microphoneOptMeOnLowFilled: return "\u{f83a}"
        case .microphoneOptMeOnLowLight: return "\u{f83b}"
        case .microphoneOptMeOnLowRegular: return "\u{f83c}"
        case .microphoneOptMeOnRegular: return "\u{f83d}"
        case .microphoneOptMeRegular: return "\u{f83e}"
        case .microphoneRegular: return "\u{f83f}"
        case .mindMapBold: return "\u{f840}"
        case .mindMapLight: return "\u{f841}"
        case .mindMapRegular: return "\u{f842}"
        case .minimizeBold: return "\u{f843}"
        case .minimizeLight: return "\u{f844}"
        case .minimizeRegular: return "\u{f845}"
        case .minusBold: return "\u{f846}"
        case .minusFilled: return "\u{f847}"
        case .minusLight: return "\u{f848}"
        case .minusRegular: return "\u{f849}"
        case .mirrorBold: return "\u{f84a}"
        case .mirrorFilled: return "\u{f84b}"
        case .mirrorLight: return "\u{f84c}"
        case .mirrorRegular: return "\u{f84d}"
        case .mmsFilled: return "\u{f84e}"
        case .moderatorBold: return "\u{f84f}"
        case .moderatorLight: return "\u{f850}"
        case .moderatorRegular: return "\u{f851}"
        case .monitoringBold: return "\u{f852}"
        case .monitoringLight: return "\u{f853}"
        case .monitoringRegular: return "\u{f854}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f855}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f856}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f857}"
        case .moreAdrBold: return "\u{f858}"
        case .moreAdrLight: return "\u{f859}"
        case .moreAdrRegular: return "\u{f85a}"
        case .moreBold: return "\u{f85b}"
        case .moreCircleBold: return "\u{f85c}"
        case .moreCircleFilled: return "\u{f85d}"
        case .moreCircleLight: return "\u{f85e}"
        case .moreCircleRegular: return "\u{f85f}"
        case .moreLight: return "\u{f860}"
        case .moreRegular: return "\u{f861}"
        case .mouseCursorBold: return "\u{f862}"
        case .mouseCursorLight: return "\u{f863}"
        case .mouseCursorRegular: return "\u{f864}"
        case .moveCallInAdrBold: return "\u{f865}"
        case .moveCallInAdrLight: return "\u{f866}"
        case .moveCallInAdrRegular: return "\u{f867}"
        case .moveCallInIphBold: return "\u{f868}"
        case .moveCallInIphLight: return "\u{f869}"
        case .moveCallInIphRegular: return "\u{f86a}"
        case .moveCallInLaptopBold: return "\u{f86b}"
        case .moveCallInLaptopLight: return "\u{f86c}"
        case .moveCallInLaptopRegular: return "\u{f86d}"
        case .moveCallInOutAdrBold: return "\u{f86e}"
        case .moveCallInOutAdrLight: return "\u{f86f}"
        case .moveCallInOutAdrRegular: return "\u{f870}"
        case .moveCallInOutIphBold: return "\u{f871}"
        case .moveCallInOutIphLight: return "\u{f872}"
        case .moveCallInOutIphRegular: return "\u{f873}"
        case .moveCallInTabletBold: return "\u{f874}"
        case .moveCallInTabletLight: return "\u{f875}"
        case .moveCallInTabletRegular: return "\u{f876}"
        case .moveCallOutAdrBold: return "\u{f877}"
        case .moveCallOutAdrLight: return "\u{f878}"
        case .moveCallOutAdrRegular: return "\u{f879}"
        case .moveCallOutIphBold: return "\u{f87a}"
        case .moveCallOutIphLight: return "\u{f87b}"
        case .moveCallOutIphRegular: return "\u{f87c}"
        case .moveCallOutLaptopBold: return "\u{f87d}"
        case .moveCallOutLaptopLight: return "\u{f87e}"
        case .moveCallOutLaptopRegular: return "\u{f87f}"
        case .moveCallOutTabletBold: return "\u{f880}"
        case .moveCallOutTabletLight: return "\u{f881}"
        case .moveCallOutTabletRegular: return "\u{f882}"
        case .moveToBottomBold: return "\u{f883}"
        case .moveToBottomFilled: return "\u{f884}"
        case .moveToBottomLight: return "\u{f885}"
        case .moveToBottomRegular: return "\u{f886}"
        case .moveToScreenBold: return "\u{f887}"
        case .moveToScreenLight: return "\u{f888}"
        case .moveToScreenRegular: return "\u{f889}"
        case .moveToTopBold: return "\u{f88a}"
        case .moveToTopFilled: return "\u{f88b}"
        case .moveToTopLight: return "\u{f88c}"
        case .moveToTopRegular: return "\u{f88d}"
        case .multilineChartBold: return "\u{f88e}"
        case .multilineChartFilled: return "\u{f88f}"
        case .multilineChartLight: return "\u{f890}"
        case .multilineChartRegular: return "\u{f891}"
        case .multimediaBold: return "\u{f892}"
        case .multimediaFilled: return "\u{f893}"
        case .multimediaLight: return "\u{f894}"
        case .multimediaRegular: return "\u{f895}"
        case .multipledDevicesBold: return "\u{f896}"
        case .multipledDevicesFilled: return "\u{f897}"
        case .multipledDevicesLight: return "\u{f898}"
        case .multipledDevicesRegular: return "\u{f899}"
        case .musicModeCircleBold: return "\u{f89a}"
        case .musicModeCircleFilled: return "\u{f89b}"
        case .musicModeCircleLight: return "\u{f89c}"
        case .musicModeCircleRegular: return "\u{f89d}"
        case .musicNoteBold: return "\u{f89e}"
        case .musicNoteFilled: return "\u{f89f}"
        case .musicNoteLight: return "\u{f8a0}"
        case .musicNoteRegular: return "\u{f8a1}"
        case .muteOnEntryBold: return "\u{f8a2}"
        case .muteOnEntryFilled: return "\u{f8a3}"
        case .muteOnEntryLight: return "\u{f8a4}"
        case .muteOnEntryRegular: return "\u{f8a5}"
        case .networkSwitchBold: return "\u{f8a6}"
        case .networkSwitchFilled: return "\u{f8a7}"
        case .networkSwitchLight: return "\u{f8a8}"
        case .networkSwitchRegular: return "\u{f8a9}"
        case .newManagerBold: return "\u{f8aa}"
        case .newManagerFilled: return "\u{f8ab}"
        case .newManagerLight: return "\u{f8ac}"
        case .newManagerRegular: return "\u{f8ad}"
        case .newTitleBold: return "\u{f8ae}"
        case .newTitleLight: return "\u{f8af}"
        case .newTitleRegular: return "\u{f8b0}"
        case .newVoicemailBold: return "\u{f8b1}"
        case .newVoicemailLight: return "\u{f8b2}"
        case .newVoicemailRegular: return "\u{f8b3}"
        case .newWhiteboardBold: return "\u{f8b4}"
        case .newWhiteboardLight: return "\u{f8b5}"
        case .newWhiteboardRegular: return "\u{f8b6}"
        case .nextBold: return "\u{f8b7}"
        case .nextLight: return "\u{f8b8}"
        case .nextRegular: return "\u{f8b9}"
        case .noDevicesBold: return "\u{f8ba}"
        case .noDevicesLight: return "\u{f8bb}"
        case .noDevicesRegular: return "\u{f8bc}"
        case .noiseDetectedCanceledFilled: return "\u{f8bd}"
        case .noiseDetectedFilled: return "\u{f8be}"
        case .noiseNoneCanceledFilled: return "\u{f8bf}"
        case .noiseNoneFilled: return "\u{f8c0}"
        case .noiseRemovalBold: return "\u{f8c1}"
        case .noiseRemovalLight: return "\u{f8c2}"
        case .noiseRemovalRegular: return "\u{f8c3}"
        case .noteBold: return "\u{f8c4}"
        case .noteFilled: return "\u{f8c5}"
        case .noteLight: return "\u{f8c6}"
        case .notePptBold: return "\u{f8c7}"
        case .notePptLight: return "\u{f8c8}"
        case .notePptRegular: return "\u{f8c9}"
        case .noteRegular: return "\u{f8ca}"
        case .notesBold: return "\u{f8cb}"
        case .notesFilled: return "\u{f8cc}"
        case .notesLight: return "\u{f8cd}"
        case .notesRegular: return "\u{f8ce}"
        case .numberBold: return "\u{f8cf}"
        case .numberHighlightBold: return "\u{f8d0}"
        case .numberHighlightFilled: return "\u{f8d1}"
        case .numberHighlightLight: return "\u{f8d2}"
        case .numberHighlightRegular: return "\u{f8d3}"
        case .numberLight: return "\u{f8d4}"
        case .numberRegular: return "\u{f8d5}"
        case .oldRemoteBold: return "\u{f8d6}"
        case .oldRemoteLight: return "\u{f8d7}"
        case .oldRemoteRegular: return "\u{f8d8}"
        case .oldTouchBold: return "\u{f8d9}"
        case .oldTouchLight: return "\u{f8da}"
        case .oldTouchRegular: return "\u{f8db}"
        case .oneColumnBold: return "\u{f8dc}"
        case .oneColumnLight: return "\u{f8dd}"
        case .oneColumnRegular: return "\u{f8de}"
        case .oneTimeBold: return "\u{f8df}"
        case .oneTimeLight: return "\u{f8e0}"
        case .oneTimeRegular: return "\u{f8e1}"
        case .openInFolderBold: return "\u{f8e2}"
        case .openInFolderFilled: return "\u{f8e3}"
        case .openInFolderLight: return "\u{f8e4}"
        case .openInFolderRegular: return "\u{f8e5}"
        case .openPagesBold: return "\u{f8e6}"
        case .openPagesLight: return "\u{f8e7}"
        case .openPagesRegular: return "\u{f8e8}"
        case .otherNumberBold: return "\u{f8e9}"
        case .otherNumberFilled: return "\u{f8ea}"
        case .otherNumberLight: return "\u{f8eb}"
        case .otherNumberRegular: return "\u{f8ec}"
        case .otherNumberWarningBold: return "\u{f8ed}"
        case .otherNumberWarningLight: return "\u{f8ee}"
        case .otherNumberWarningRegular: return "\u{f8ef}"
        case .outgoingCallLegacyBold: return "\u{f8f0}"
        case .outgoingCallLegacyFilled: return "\u{f8f1}"
        case .outgoingCallLegacyLight: return "\u{f8f2}"
        case .outgoingCallLegacyRegular: return "\u{f8f3}"
        case .overflowLeftBold: return "\u{f8f4}"
        case .overflowLeftLight: return "\u{f8f5}"
        case .overflowLeftRegular: return "\u{f8f6}"
        case .overflowRightBold: return "\u{f8f7}"
        case .overflowRightLight: return "\u{f8f8}"
        case .overflowRightRegular: return "\u{f8f9}"
        case .pairedCameraBold: return "\u{f8fa}"
        case .pairedCameraLight: return "\u{f8fb}"
        case .pairedCameraRegular: return "\u{f8fc}"
        case .pairedDeviceBold: return "\u{f8fd}"
        case .pairedDeviceLight: return "\u{f8fe}"
        case .pairedDeviceRegular: return "\u{f8ff}"
        case .pairedHandsetBold: return "\u{f900}"
        case .pairedHandsetLight: return "\u{f901}"
        case .pairedHandsetRegular: return "\u{f902}"
        case .pairingBold: return "\u{f903}"
        case .pairingLight: return "\u{f904}"
        case .pairingRegular: return "\u{f905}"
        case .parenthesisBold: return "\u{f906}"
        case .parenthesisFilled: return "\u{f907}"
        case .parenthesisLight: return "\u{f908}"
        case .parenthesisRegular: return "\u{f909}"
        case .parkedBold: return "\u{f90a}"
        case .parkedFilled: return "\u{f90b}"
        case .parkedLight: return "\u{f90c}"
        case .parkedRegular: return "\u{f90d}"
        case .parseBold: return "\u{f90e}"
        case .parseLight: return "\u{f90f}"
        case .parseRegular: return "\u{f910}"
        case .partialBold: return "\u{f911}"
        case .partialLight: return "\u{f912}"
        case .partialRegular: return "\u{f913}"
        case .participantAddBold: return "\u{f914}"
        case .participantAddLight: return "\u{f915}"
        case .participantAddRegular: return "\u{f916}"
        case .participantBlockedBold: return "\u{f917}"
        case .participantBlockedLight: return "\u{f918}"
        case .participantBlockedRegular: return "\u{f919}"
        case .participantBold: return "\u{f91a}"
        case .participantFilled: return "\u{f91b}"
        case .participantLight: return "\u{f91c}"
        case .participantListBold: return "\u{f91d}"
        case .participantListFilled: return "\u{f91e}"
        case .participantListLight: return "\u{f91f}"
        case .participantListRegular: return "\u{f920}"
        case .participantRegular: return "\u{f921}"
        case .participantRemoveBold: return "\u{f922}"
        case .participantRemoveLight: return "\u{f923}"
        case .participantRemoveRegular: return "\u{f924}"
        case .participantSpeakerBold: return "\u{f925}"
        case .participantSpeakerFilled: return "\u{f926}"
        case .participantSpeakerLight: return "\u{f927}"
        case .participantSpeakerRegular: return "\u{f928}"
        case .participantUnknownBold: return "\u{f929}"
        case .participantUnknownLight: return "\u{f92a}"
        case .participantUnknownRegular: return "\u{f92b}"
        case .passMouseBold: return "\u{f92c}"
        case .passMouseLight: return "\u{f92d}"
        case .passMouseRegular: return "\u{f92e}"
        case .pauseBadgeFilled: return "\u{f92f}"
        case .pauseBold: return "\u{f930}"
        case .pauseFilled: return "\u{f931}"
        case .pauseInteractionBold: return "\u{f932}"
        case .pauseInteractionFilled: return "\u{f933}"
        case .pauseInteractionLight: return "\u{f934}"
        case .pauseInteractionRegular: return "\u{f935}"
        case .pauseLight: return "\u{f936}"
        case .pauseRegular: return "\u{f937}"
        case .peopleAddBold: return "\u{f938}"
        case .peopleAddFilled: return "\u{f939}"
        case .peopleAddLight: return "\u{f93a}"
        case .peopleAddRegular: return "\u{f93b}"
        case .peopleBold: return "\u{f93c}"
        case .peopleCircleBold: return "\u{f93d}"
        case .peopleCircleFilled: return "\u{f93e}"
        case .peopleCircleLight: return "\u{f93f}"
        case .peopleCircleRegular: return "\u{f940}"
        case .peopleFilled: return "\u{f941}"
        case .peopleInsightsBold: return "\u{f942}"
        case .peopleInsightsFilled: return "\u{f943}"
        case .peopleInsightsLight: return "\u{f944}"
        case .peopleInsightsRegular: return "\u{f945}"
        case .peopleLight: return "\u{f946}"
        case .peopleManageBold: return "\u{f947}"
        case .peopleManageFilled: return "\u{f948}"
        case .peopleManageLight: return "\u{f949}"
        case .peopleManageRegular: return "\u{f94a}"
        case .peopleRegular: return "\u{f94b}"
        case .phoneAlertBold: return "\u{f94c}"
        case .phoneAlertLight: return "\u{f94d}"
        case .phoneAlertRegular: return "\u{f94e}"
        case .phoneBadgeFilled: return "\u{f94f}"
        case .phoneBold: return "\u{f950}"
        case .phoneFilled: return "\u{f951}"
        case .phoneLight: return "\u{f952}"
        case .phoneMutedBold: return "\u{f953}"
        case .phoneMutedLight: return "\u{f954}"
        case .phoneMutedRegular: return "\u{f955}"
        case .phonePrivateBold: return "\u{f956}"
        case .phonePrivateLight: return "\u{f957}"
        case .phonePrivateRegular: return "\u{f958}"
        case .phoneRegular: return "\u{f959}"
        case .phoneReplyAllBold: return "\u{f95a}"
        case .phoneReplyAllLight: return "\u{f95b}"
        case .phoneReplyAllRegular: return "\u{f95c}"
        case .phoneReplyBold: return "\u{f95d}"
        case .phoneReplyLight: return "\u{f95e}"
        case .phoneReplyRegular: return "\u{f95f}"
        case .pickerBold: return "\u{f960}"
        case .pickerLight: return "\u{f961}"
        case .pickerRegular: return "\u{f962}"
        case .pieChartBold: return "\u{f963}"
        case .pieChartFilled: return "\u{f964}"
        case .pieChartLight: return "\u{f965}"
        case .pieChartRegular: return "\u{f966}"
        case .pinBold: return "\u{f967}"
        case .pinFilled: return "\u{f968}"
        case .pinLight: return "\u{f969}"
        case .pinListActivityBold: return "\u{f96a}"
        case .pinListActivityLight: return "\u{f96b}"
        case .pinListActivityRegular: return "\u{f96c}"
        case .pinListBold: return "\u{f96d}"
        case .pinListLight: return "\u{f96e}"
        case .pinListRegular: return "\u{f96f}"
        case .pinMutedBold: return "\u{f970}"
        case .pinMutedFilled: return "\u{f971}"
        case .pinMutedLight: return "\u{f972}"
        case .pinMutedRegular: return "\u{f973}"
        case .pinRegular: return "\u{f974}"
        case .pipBold: return "\u{f975}"
        case .pipEnterBold: return "\u{f976}"
        case .pipEnterLight: return "\u{f977}"
        case .pipEnterRegular: return "\u{f978}"
        case .pipExitBold: return "\u{f979}"
        case .pipExitLight: return "\u{f97a}"
        case .pipExitRegular: return "\u{f97b}"
        case .pipFilled: return "\u{f97c}"
        case .pipLight: return "\u{f97d}"
        case .pipRegular: return "\u{f97e}"
        case .placeholderBold: return "\u{f97f}"
        case .placeholderFilled: return "\u{f980}"
        case .placeholderLight: return "\u{f981}"
        case .placeholderRegular: return "\u{f982}"
        case .playBold: return "\u{f983}"
        case .playCircleBold: return "\u{f984}"
        case .playCircleFilled: return "\u{f985}"
        case .playCircleLight: return "\u{f986}"
        case .playCircleRegular: return "\u{f987}"
        case .playFilled: return "\u{f988}"
        case .playLight: return "\u{f989}"
        case .playRegular: return "\u{f98a}"
        case .plugAcBold: return "\u{f98b}"
        case .plugAcLight: return "\u{f98c}"
        case .plugAcRegular: return "\u{f98d}"
        case .plusBold: return "\u{f98e}"
        case .plusCircleBold: return "\u{f98f}"
        case .plusCircleFilled: return "\u{f990}"
        case .plusCircleLight: return "\u{f991}"
        case .plusCircleRegular: return "\u{f992}"
        case .plusLight: return "\u{f993}"
        case .plusRegular: return "\u{f994}"
        case .pmrBold: return "\u{f995}"
        case .pmrFilled: return "\u{f996}"
        case .pmrLight: return "\u{f997}"
        case .pmrRegular: return "\u{f998}"
        case .pollBold: return "\u{f999}"
        case .pollFilled: return "\u{f99a}"
        case .pollLight: return "\u{f99b}"
        case .pollRegular: return "\u{f99c}"
        case .popInBold: return "\u{f99d}"
        case .popInLight: return "\u{f99e}"
        case .popInRegular: return "\u{f99f}"
        case .popOutBold: return "\u{f9a0}"
        case .popOutLight: return "\u{f9a1}"
        case .popOutRegular: return "\u{f9a2}"
        case .popUpBold: return "\u{f9a3}"
        case .popUpLight: return "\u{f9a4}"
        case .popUpRegular: return "\u{f9a5}"
        case .portraitLandscapeBold: return "\u{f9a6}"
        case .portraitLandscapeLight: return "\u{f9a7}"
        case .portraitLandscapeRegular: return "\u{f9a8}"
        case .potentialFraudBold: return "\u{f9a9}"
        case .potentialFraudFilled: return "\u{f9aa}"
        case .potentialFraudLight: return "\u{f9ab}"
        case .potentialFraudRegular: return "\u{f9ac}"
        case .powerAcBold: return "\u{f9ad}"
        case .powerAcLight: return "\u{f9ae}"
        case .powerAcRegular: return "\u{f9af}"
        case .powerBold: return "\u{f9b0}"
        case .powerLight: return "\u{f9b1}"
        case .powerRegular: return "\u{f9b2}"
        case .preHeaderBold: return "\u{f9b3}"
        case .preHeaderLight: return "\u{f9b4}"
        case .preHeaderRegular: return "\u{f9b5}"
        case .premiumBold: return "\u{f9b6}"
        case .premiumLight: return "\u{f9b7}"
        case .premiumRegular: return "\u{f9b8}"
        case .presentationBold: return "\u{f9b9}"
        case .presentationLight: return "\u{f9ba}"
        case .presentationRegular: return "\u{f9bb}"
        case .preventDownloadBold: return "\u{f9bc}"
        case .preventDownloadFilled: return "\u{f9bd}"
        case .preventDownloadLight: return "\u{f9be}"
        case .preventDownloadRegular: return "\u{f9bf}"
        case .primaryParticipantBold: return "\u{f9c0}"
        case .primaryParticipantFilled: return "\u{f9c1}"
        case .primaryParticipantLight: return "\u{f9c2}"
        case .primaryParticipantRegular: return "\u{f9c3}"
        case .printBold: return "\u{f9c4}"
        case .printLight: return "\u{f9c5}"
        case .printRegular: return "\u{f9c6}"
        case .priorityBadgeFilled: return "\u{f9c7}"
        case .priorityCircleBold: return "\u{f9c8}"
        case .priorityCircleFilled: return "\u{f9c9}"
        case .priorityCircleLight: return "\u{f9ca}"
        case .priorityCircleRegular: return "\u{f9cb}"
        case .priorityCircleTwoBold: return "\u{f9cc}"
        case .priorityCircleTwoFilled: return "\u{f9cd}"
        case .priorityCircleTwoLight: return "\u{f9ce}"
        case .priorityCircleTwoRegular: return "\u{f9cf}"
        case .priorityWaveBold: return "\u{f9d0}"
        case .priorityWaveLight: return "\u{f9d1}"
        case .priorityWaveRegular: return "\u{f9d2}"
        case .privacyCircleBold: return "\u{f9d3}"
        case .privacyCircleFilled: return "\u{f9d4}"
        case .privacyCircleLight: return "\u{f9d5}"
        case .privacyCircleRegular: return "\u{f9d6}"
        case .privateBold: return "\u{f9d7}"
        case .privateCircleBold: return "\u{f9d8}"
        case .privateCircleFilled: return "\u{f9d9}"
        case .privateCircleLight: return "\u{f9da}"
        case .privateCircleRegular: return "\u{f9db}"
        case .privateLight: return "\u{f9dc}"
        case .privateMeetingBold: return "\u{f9dd}"
        case .privateMeetingLight: return "\u{f9de}"
        case .privateMeetingRegular: return "\u{f9df}"
        case .privateRegular: return "\u{f9e0}"
        case .productDemoBold: return "\u{f9e1}"
        case .productDemoLight: return "\u{f9e2}"
        case .productDemoRegular: return "\u{f9e3}"
        case .promptsAiBold: return "\u{f9e4}"
        case .promptsAiLight: return "\u{f9e5}"
        case .promptsAiRegular: return "\u{f9e6}"
        case .proximityBold: return "\u{f9e7}"
        case .proximityLight: return "\u{f9e8}"
        case .proximityMutedBold: return "\u{f9e9}"
        case .proximityMutedLight: return "\u{f9ea}"
        case .proximityMutedRegular: return "\u{f9eb}"
        case .proximityRegular: return "\u{f9ec}"
        case .proximityVideoBold: return "\u{f9ed}"
        case .proximityVideoLight: return "\u{f9ee}"
        case .proximityVideoRegular: return "\u{f9ef}"
        case .ptoPresenceBold: return "\u{f9f0}"
        case .ptoPresenceFilled: return "\u{f9f1}"
        case .ptoPresenceLight: return "\u{f9f2}"
        case .ptoPresenceRegular: return "\u{f9f3}"
        case .pullCallBold: return "\u{f9f4}"
        case .pullCallFilled: return "\u{f9f5}"
        case .pullCallLight: return "\u{f9f6}"
        case .pullCallRegular: return "\u{f9f7}"
        case .purchaseOrderBold: return "\u{f9f8}"
        case .purchaseOrderFilled: return "\u{f9f9}"
        case .purchaseOrderLight: return "\u{f9fa}"
        case .purchaseOrderRegular: return "\u{f9fb}"
        case .qABold: return "\u{f9fc}"
        case .qAFilled: return "\u{f9fd}"
        case .qALight: return "\u{f9fe}"
        case .qARegular: return "\u{f9ff}"
        case .qrCodeBold: return "\u{fa00}"
        case .qrCodeLight: return "\u{fa01}"
        case .qrCodeRegular: return "\u{fa02}"
        case .qrCodeScanBold: return "\u{fa03}"
        case .qrCodeScanLight: return "\u{fa04}"
        case .qrCodeScanRegular: return "\u{fa05}"
        case .qualityBold: return "\u{fa06}"
        case .qualityLight: return "\u{fa07}"
        case .qualityRegular: return "\u{fa08}"
        case .queueContactBold: return "\u{fa09}"
        case .queueContactFilled: return "\u{fa0a}"
        case .queueContactLight: return "\u{fa0b}"
        case .queueContactRegular: return "\u{fa0c}"
        case .queuedInteractionBold: return "\u{fa0d}"
        case .queuedInteractionFilled: return "\u{fa0e}"
        case .queuedInteractionLight: return "\u{fa0f}"
        case .queuedInteractionRegular: return "\u{fa10}"
        case .quietBold: return "\u{fa11}"
        case .quietHoursPresenceBold: return "\u{fa12}"
        case .quietHoursPresenceFilled: return "\u{fa13}"
        case .quietHoursPresenceLight: return "\u{fa14}"
        case .quietHoursPresenceRegular: return "\u{fa15}"
        case .quietLight: return "\u{fa16}"
        case .quietRegular: return "\u{fa17}"
        case .radioButtonGroupBold: return "\u{fa18}"
        case .radioButtonGroupLight: return "\u{fa19}"
        case .radioButtonGroupRegular: return "\u{fa1a}"
        case .raiseHandBold: return "\u{fa1b}"
        case .raiseHandCircleFilled: return "\u{fa1c}"
        case .raiseHandFilled: return "\u{fa1d}"
        case .raiseHandLight: return "\u{fa1e}"
        case .raiseHandRegular: return "\u{fa1f}"
        case .ramBold: return "\u{fa20}"
        case .ramLight: return "\u{fa21}"
        case .ramRegular: return "\u{fa22}"
        case .reactionsBold: return "\u{fa23}"
        case .reactionsFilled: return "\u{fa24}"
        case .reactionsLight: return "\u{fa25}"
        case .reactionsRegular: return "\u{fa26}"
        case .reactivateBold: return "\u{fa27}"
        case .reactivateLight: return "\u{fa28}"
        case .reactivateRegular: return "\u{fa29}"
        case .realTimeTextBold: return "\u{fa2a}"
        case .realTimeTextFilled: return "\u{fa2b}"
        case .realTimeTextLight: return "\u{fa2c}"
        case .realTimeTextRegular: return "\u{fa2d}"
        case .receiveVoiceBold: return "\u{fa2e}"
        case .receiveVoiceFilled: return "\u{fa2f}"
        case .receiveVoiceLight: return "\u{fa30}"
        case .receiveVoiceRegular: return "\u{fa31}"
        case .recentsBold: return "\u{fa32}"
        case .recentsFilled: return "\u{fa33}"
        case .recentsLight: return "\u{fa34}"
        case .recentsPresenceBadgeFilled: return "\u{fa35}"
        case .recentsPresenceBold: return "\u{fa36}"
        case .recentsPresenceFilled: return "\u{fa37}"
        case .recentsPresenceLight: return "\u{fa38}"
        case .recentsPresenceRegular: return "\u{fa39}"
        case .recentsRegular: return "\u{fa3a}"
        case .recordActiveBadgeFilled: return "\u{fa3b}"
        case .recordActiveBold: return "\u{fa3c}"
        case .recordActiveFilled: return "\u{fa3d}"
        case .recordActiveLight: return "\u{fa3e}"
        case .recordActiveRegular: return "\u{fa3f}"
        case .recordBold: return "\u{fa40}"
        case .recordFilled: return "\u{fa41}"
        case .recordLight: return "\u{fa42}"
        case .recordPausedBadgeFilled: return "\u{fa43}"
        case .recordPausedBold: return "\u{fa44}"
        case .recordPausedFilled: return "\u{fa45}"
        case .recordPausedLight: return "\u{fa46}"
        case .recordPausedRegular: return "\u{fa47}"
        case .recordRegular: return "\u{fa48}"
        case .recurringBold: return "\u{fa49}"
        case .recurringLight: return "\u{fa4a}"
        case .recurringOffBold: return "\u{fa4b}"
        case .recurringOffLight: return "\u{fa4c}"
        case .recurringOffRegular: return "\u{fa4d}"
        case .recurringRegular: return "\u{fa4e}"
        case .redoBold: return "\u{fa4f}"
        case .redoLight: return "\u{fa50}"
        case .redoRegular: return "\u{fa51}"
        case .refreshBold: return "\u{fa52}"
        case .refreshLight: return "\u{fa53}"
        case .refreshRegular: return "\u{fa54}"
        case .remoteDesktopControlBold: return "\u{fa55}"
        case .remoteDesktopControlFilled: return "\u{fa56}"
        case .remoteDesktopControlLight: return "\u{fa57}"
        case .remoteDesktopControlRegular: return "\u{fa58}"
        case .removeBold: return "\u{fa59}"
        case .removeFilled: return "\u{fa5a}"
        case .removeLight: return "\u{fa5b}"
        case .removeRegular: return "\u{fa5c}"
        case .replyBold: return "\u{fa5d}"
        case .replyFilled: return "\u{fa5e}"
        case .replyLight: return "\u{fa5f}"
        case .replyListBold: return "\u{fa60}"
        case .replyListFilled: return "\u{fa61}"
        case .replyListLight: return "\u{fa62}"
        case .replyListRegular: return "\u{fa63}"
        case .replyPrivatelyBold: return "\u{fa64}"
        case .replyPrivatelyLight: return "\u{fa65}"
        case .replyPrivatelyRegular: return "\u{fa66}"
        case .replyRegular: return "\u{fa67}"
        case .resetBold: return "\u{fa68}"
        case .resetLight: return "\u{fa69}"
        case .resetRegular: return "\u{fa6a}"
        case .resizeCornerBold: return "\u{fa6b}"
        case .resizeCornerLight: return "\u{fa6c}"
        case .resizeCornerRegular: return "\u{fa6d}"
        case .responsiveMobileBold: return "\u{fa6e}"
        case .responsiveMobileLight: return "\u{fa6f}"
        case .responsiveMobileRegular: return "\u{fa70}"
        case .restartBold: return "\u{fa71}"
        case .restartLight: return "\u{fa72}"
        case .restartRegular: return "\u{fa73}"
        case .resumeInteractionBold: return "\u{fa74}"
        case .resumeInteractionFilled: return "\u{fa75}"
        case .resumeInteractionLight: return "\u{fa76}"
        case .resumeInteractionRegular: return "\u{fa77}"
        case .retrieveCallBold: return "\u{fa78}"
        case .retrieveCallFilled: return "\u{fa79}"
        case .retrieveCallLight: return "\u{fa7a}"
        case .retrieveCallRegular: return "\u{fa7b}"
        case .returnBold: return "\u{fa7c}"
        case .returnLight: return "\u{fa7d}"
        case .returnRegular: return "\u{fa7e}"
        case .rewindTenSecBold: return "\u{fa7f}"
        case .rewindTenSecLight: return "\u{fa80}"
        case .rewindTenSecRegular: return "\u{fa81}"
        case .ringtoneBold: return "\u{fa82}"
        case .ringtoneLight: return "\u{fa83}"
        case .ringtoneRegular: return "\u{fa84}"
        case .roomCalendarBold: return "\u{fa85}"
        case .roomCalendarLight: return "\u{fa86}"
        case .roomCalendarRegular: return "\u{fa87}"
        case .roomLightsBold: return "\u{fa88}"
        case .roomLightsFilled: return "\u{fa89}"
        case .roomLightsLight: return "\u{fa8a}"
        case .roomLightsRegular: return "\u{fa8b}"
        case .rotateContentBold: return "\u{fa8c}"
        case .rotateContentFilled: return "\u{fa8d}"
        case .rotateContentLight: return "\u{fa8e}"
        case .rotateContentRegular: return "\u{fa8f}"
        case .rssBold: return "\u{fa90}"
        case .rssFilled: return "\u{fa91}"
        case .rssLight: return "\u{fa92}"
        case .rssRegular: return "\u{fa93}"
        case .ruleBasedBold: return "\u{fa94}"
        case .ruleBasedFilled: return "\u{fa95}"
        case .ruleBasedLight: return "\u{fa96}"
        case .ruleBasedRegular: return "\u{fa97}"
        case .rulerBold: return "\u{fa98}"
        case .rulerFilled: return "\u{fa99}"
        case .rulerLight: return "\u{fa9a}"
        case .rulerRegular: return "\u{fa9b}"
        case .runningApplicationBold: return "\u{fa9c}"
        case .runningApplicationFilled: return "\u{fa9d}"
        case .runningApplicationLight: return "\u{fa9e}"
        case .runningApplicationRegular: return "\u{fa9f}"
        case .saveBold: return "\u{faa0}"
        case .saveLight: return "\u{faa1}"
        case .saveRegular: return "\u{faa2}"
        case .saveTranscriptBold: return "\u{faa3}"
        case .saveTranscriptFilled: return "\u{faa4}"
        case .saveTranscriptLight: return "\u{faa5}"
        case .saveTranscriptRegular: return "\u{faa6}"
        case .scanBold: return "\u{faa7}"
        case .scanLight: return "\u{faa8}"
        case .scanRegular: return "\u{faa9}"
        case .scheduleAiBold: return "\u{faaa}"
        case .scheduleAiLight: return "\u{faab}"
        case .scheduleAiRegular: return "\u{faac}"
        case .scheduleSendBold: return "\u{faad}"
        case .scheduleSendFilled: return "\u{faae}"
        case .scheduleSendLight: return "\u{faaf}"
        case .scheduleSendRegular: return "\u{fab0}"
        case .scheduleWinnerBold: return "\u{fab1}"
        case .scheduleWinnerFilled: return "\u{fab2}"
        case .scheduleWinnerLight: return "\u{fab3}"
        case .scheduleWinnerRegular: return "\u{fab4}"
        case .schedulerAvailableBold: return "\u{fab5}"
        case .schedulerAvailableLight: return "\u{fab6}"
        case .schedulerAvailableRegular: return "\u{fab7}"
        case .schedulerNotWorkingHoursBold: return "\u{fab8}"
        case .schedulerNotWorkingHoursLight: return "\u{fab9}"
        case .schedulerNotWorkingHoursRegular: return "\u{faba}"
        case .schedulerUnavailableBold: return "\u{fabb}"
        case .schedulerUnavailableLight: return "\u{fabc}"
        case .schedulerUnavailableRegular: return "\u{fabd}"
        case .schedulerUnknownBold: return "\u{fabe}"
        case .schedulerUnknownLight: return "\u{fabf}"
        case .schedulerUnknownRegular: return "\u{fac0}"
        case .screenshotBold: return "\u{fac1}"
        case .screenshotDocBold: return "\u{fac2}"
        case .screenshotDocFilled: return "\u{fac3}"
        case .screenshotDocLight: return "\u{fac4}"
        case .screenshotDocRegular: return "\u{fac5}"
        case .screenshotLight: return "\u{fac6}"
        case .screenshotRegular: return "\u{fac7}"
        case .searchAiBold: return "\u{fac8}"
        case .searchAiLight: return "\u{fac9}"
        case .searchAiRegular: return "\u{faca}"
        case .searchBold: return "\u{facb}"
        case .searchFilled: return "\u{facc}"
        case .searchLight: return "\u{facd}"
        case .searchRegular: return "\u{face}"
        case .secondaryArrowBold: return "\u{facf}"
        case .secondaryArrowLight: return "\u{fad0}"
        case .secondaryArrowRegular: return "\u{fad1}"
        case .secureCallLockBold: return "\u{fad2}"
        case .secureCallLockFilled: return "\u{fad3}"
        case .secureCallLockLight: return "\u{fad4}"
        case .secureCallLockRegular: return "\u{fad5}"
        case .secureCallShieldBold: return "\u{fad6}"
        case .secureCallShieldFilled: return "\u{fad7}"
        case .secureCallShieldLight: return "\u{fad8}"
        case .secureCallShieldRegular: return "\u{fad9}"
        case .secureCircleBold: return "\u{fada}"
        case .secureCircleFilled: return "\u{fadb}"
        case .secureCircleLight: return "\u{fadc}"
        case .secureCircleRegular: return "\u{fadd}"
        case .secureLockBold: return "\u{fade}"
        case .secureLockFilled: return "\u{fadf}"
        case .secureLockLight: return "\u{fae0}"
        case .secureLockRegular: return "\u{fae1}"
        case .segmentExcludeFilled: return "\u{fae2}"
        case .segmentFilterFilled: return "\u{fae3}"
        case .segmentIncludeFilled: return "\u{fae4}"
        case .selectAllBold: return "\u{fae5}"
        case .selectAllFilled: return "\u{fae6}"
        case .selectAllLight: return "\u{fae7}"
        case .selectAllRegular: return "\u{fae8}"
        case .selectionBold: return "\u{fae9}"
        case .selectionFilled: return "\u{faea}"
        case .selectionLight: return "\u{faeb}"
        case .selectionRegular: return "\u{faec}"
        case .sendBold: return "\u{faed}"
        case .sendDigitsBold: return "\u{faee}"
        case .sendDigitsFilled: return "\u{faef}"
        case .sendDigitsLight: return "\u{faf0}"
        case .sendDigitsRegular: return "\u{faf1}"
        case .sendFilled: return "\u{faf2}"
        case .sendLight: return "\u{faf3}"
        case .sendRegular: return "\u{faf4}"
        case .sendVoiceBold: return "\u{faf5}"
        case .sendVoiceFilled: return "\u{faf6}"
        case .sendVoiceLight: return "\u{faf7}"
        case .sendVoiceRegular: return "\u{faf8}"
        case .serverBold: return "\u{faf9}"
        case .serverErrorBold: return "\u{fafa}"
        case .serverErrorLight: return "\u{fafb}"
        case .serverErrorRegular: return "\u{fafc}"
        case .serverLight: return "\u{fafd}"
        case .serverRegular: return "\u{fafe}"
        case .servicesBold: return "\u{faff}"
        case .servicesLight: return "\u{fb00}"
        case .servicesRegular: return "\u{fb01}"
        case .setVariableBold: return "\u{fb02}"
        case .setVariableLight: return "\u{fb03}"
        case .setVariableRegular: return "\u{fb04}"
        case .settingsBold: return "\u{fb05}"
        case .settingsFilled: return "\u{fb06}"
        case .settingsLight: return "\u{fb07}"
        case .settingsRegular: return "\u{fb08}"
        case .setupAssistantBold: return "\u{fb09}"
        case .setupAssistantLight: return "\u{fb0a}"
        case .setupAssistantRegular: return "\u{fb0b}"
        case .sftpBold: return "\u{fb0c}"
        case .sftpLight: return "\u{fb0d}"
        case .sftpRegular: return "\u{fb0e}"
        case .shapeCircleBold: return "\u{fb0f}"
        case .shapeCircleFilled: return "\u{fb10}"
        case .shapeCircleLight: return "\u{fb11}"
        case .shapeCircleMdFilled: return "\u{fb12}"
        case .shapeCircleRegular: return "\u{fb13}"
        case .shapeCircleSmFilled: return "\u{fb14}"
        case .shapeDiagonalLineBold: return "\u{fb15}"
        case .shapeDiagonalLineLight: return "\u{fb16}"
        case .shapeDiagonalLineRegular: return "\u{fb17}"
        case .shapeDiamondBold: return "\u{fb18}"
        case .shapeDiamondFilled: return "\u{fb19}"
        case .shapeDiamondLight: return "\u{fb1a}"
        case .shapeDiamondRegular: return "\u{fb1b}"
        case .shapeOvalBold: return "\u{fb1c}"
        case .shapeOvalLight: return "\u{fb1d}"
        case .shapeOvalRegular: return "\u{fb1e}"
        case .shapeSquareBold: return "\u{fb1f}"
        case .shapeSquareFilled: return "\u{fb20}"
        case .shapeSquareLight: return "\u{fb21}"
        case .shapeSquareRegular: return "\u{fb22}"
        case .shapeTriangleBold: return "\u{fb23}"
        case .shapeTriangleFilled: return "\u{fb24}"
        case .shapeTriangleLight: return "\u{fb25}"
        case .shapeTriangleRegular: return "\u{fb26}"
        case .shapesBold: return "\u{fb27}"
        case .shapesFilled: return "\u{fb28}"
        case .shapesLight: return "\u{fb29}"
        case .shapesRegular: return "\u{fb2a}"
        case .shareCNativeAdrBold: return "\u{fb2b}"
        case .shareCNativeAdrFilled: return "\u{fb2c}"
        case .shareCNativeAdrLight: return "\u{fb2d}"
        case .shareCNativeAdrRegular: return "\u{fb2e}"
        case .shareCNativeIphBold: return "\u{fb2f}"
        case .shareCNativeIphLight: return "\u{fb30}"
        case .shareCNativeIphRegular: return "\u{fb31}"
        case .shareContentOnDeviceBold: return "\u{fb32}"
        case .shareContentOnDeviceLight: return "\u{fb33}"
        case .shareContentOnDeviceRegular: return "\u{fb34}"
        case .shareScreenAddBold: return "\u{fb35}"
        case .shareScreenAddLight: return "\u{fb36}"
        case .shareScreenAddRegular: return "\u{fb37}"
        case .shareScreenBadgeFilled: return "\u{fb38}"
        case .shareScreenBold: return "\u{fb39}"
        case .shareScreenFilled: return "\u{fb3a}"
        case .shareScreenLight: return "\u{fb3b}"
        case .shareScreenRegular: return "\u{fb3c}"
        case .shareSpaceBold: return "\u{fb3d}"
        case .shareSpaceLight: return "\u{fb3e}"
        case .shareSpaceRegular: return "\u{fb3f}"
        case .shieldBold: return "\u{fb40}"
        case .shieldLight: return "\u{fb41}"
        case .shieldRegular: return "\u{fb42}"
        case .shoppingCartBold: return "\u{fb43}"
        case .shoppingCartFilled: return "\u{fb44}"
        case .shoppingCartLight: return "\u{fb45}"
        case .shoppingCartRegular: return "\u{fb46}"
        case .shortTextBoxBold: return "\u{fb47}"
        case .shortTextBoxLight: return "\u{fb48}"
        case .shortTextBoxRegular: return "\u{fb49}"
        case .showBold: return "\u{fb4a}"
        case .showFilled: return "\u{fb4b}"
        case .showLight: return "\u{fb4c}"
        case .showRegular: return "\u{fb4d}"
        case .sidePanelBold: return "\u{fb4e}"
        case .sidePanelFilled: return "\u{fb4f}"
        case .sidePanelLight: return "\u{fb50}"
        case .sidePanelRegular: return "\u{fb51}"
        case .signInBold: return "\u{fb52}"
        case .signInFilled: return "\u{fb53}"
        case .signInForcedBold: return "\u{fb54}"
        case .signInForcedLight: return "\u{fb55}"
        case .signInForcedRegular: return "\u{fb56}"
        case .signInLight: return "\u{fb57}"
        case .signInRegular: return "\u{fb58}"
        case .signLangIntBold: return "\u{fb59}"
        case .signLangIntLight: return "\u{fb5a}"
        case .signLangIntRegular: return "\u{fb5b}"
        case .signOutBold: return "\u{fb5c}"
        case .signOutLight: return "\u{fb5d}"
        case .signOutRegular: return "\u{fb5e}"
        case .signalFourBold: return "\u{fb5f}"
        case .signalFourLight: return "\u{fb60}"
        case .signalFourRegular: return "\u{fb61}"
        case .signalOneBold: return "\u{fb62}"
        case .signalOneLight: return "\u{fb63}"
        case .signalOneRegular: return "\u{fb64}"
        case .signalThreeBold: return "\u{fb65}"
        case .signalThreeLight: return "\u{fb66}"
        case .signalThreeRegular: return "\u{fb67}"
        case .signalTwoBold: return "\u{fb68}"
        case .signalTwoLight: return "\u{fb69}"
        case .signalTwoRegular: return "\u{fb6a}"
        case .signalZeroBold: return "\u{fb6b}"
        case .signalZeroLight: return "\u{fb6c}"
        case .signalZeroRegular: return "\u{fb6d}"
        case .simplePromotionBold: return "\u{fb6e}"
        case .simplePromotionLight: return "\u{fb6f}"
        case .simplePromotionRegular: return "\u{fb70}"
        case .singleNumberReachBold: return "\u{fb71}"
        case .singleNumberReachLight: return "\u{fb72}"
        case .singleNumberReachRegular: return "\u{fb73}"
        case .sipRegistrationInProgressBold: return "\u{fb74}"
        case .sipRegistrationInProgressFilled: return "\u{fb75}"
        case .sipRegistrationInProgressLight: return "\u{fb76}"
        case .sipRegistrationInProgressRegular: return "\u{fb77}"
        case .skipBold: return "\u{fb78}"
        case .skipBwBold: return "\u{fb79}"
        case .skipBwFilled: return "\u{fb7a}"
        case .skipBwLight: return "\u{fb7b}"
        case .skipBwRegular: return "\u{fb7c}"
        case .skipFwBold: return "\u{fb7d}"
        case .skipFwFilled: return "\u{fb7e}"
        case .skipFwLight: return "\u{fb7f}"
        case .skipFwRegular: return "\u{fb80}"
        case .skipLight: return "\u{fb81}"
        case .skipRegular: return "\u{fb82}"
        case .smartAudioBold: return "\u{fb83}"
        case .smartAudioLight: return "\u{fb84}"
        case .smartAudioRegular: return "\u{fb85}"
        case .smartReplyBold: return "\u{fb86}"
        case .smartReplyLight: return "\u{fb87}"
        case .smartReplyRegular: return "\u{fb88}"
        case .smsFilled: return "\u{fb89}"
        case .smsInboundBold: return "\u{fb8a}"
        case .smsInboundLight: return "\u{fb8b}"
        case .smsInboundRegular: return "\u{fb8c}"
        case .smsMessageBold: return "\u{fb8d}"
        case .smsMessageFilled: return "\u{fb8e}"
        case .smsMessageLight: return "\u{fb8f}"
        case .smsMessageOutgoingBold: return "\u{fb90}"
        case .smsMessageOutgoingFilled: return "\u{fb91}"
        case .smsMessageOutgoingLight: return "\u{fb92}"
        case .smsMessageOutgoingRegular: return "\u{fb93}"
        case .smsMessageRegular: return "\u{fb94}"
        case .smsMessageStartBold: return "\u{fb95}"
        case .smsMessageStartFilled: return "\u{fb96}"
        case .smsMessageStartLight: return "\u{fb97}"
        case .smsMessageStartRegular: return "\u{fb98}"
        case .smsOutgoingFilled: return "\u{fb99}"
        case .smsUnreadBold: return "\u{fb9a}"
        case .smsUnreadLight: return "\u{fb9b}"
        case .smsUnreadRegular: return "\u{fb9c}"
        case .sortAscendingBold: return "\u{fb9d}"
        case .sortAscendingLight: return "\u{fb9e}"
        case .sortAscendingRegular: return "\u{fb9f}"
        case .sortDescendingBold: return "\u{fba0}"
        case .sortDescendingLight: return "\u{fba1}"
        case .sortDescendingRegular: return "\u{fba2}"
        case .soundDefaultBold: return "\u{fba3}"
        case .soundDefaultLight: return "\u{fba4}"
        case .soundDefaultRegular: return "\u{fba5}"
        case .sparkleBold: return "\u{fba6}"
        case .sparkleFilled: return "\u{fba7}"
        case .sparkleLight: return "\u{fba8}"
        case .sparkleRegular: return "\u{fba9}"
        case .speakerBold: return "\u{fbaa}"
        case .speakerDisconnectedBold: return "\u{fbab}"
        case .speakerDisconnectedFilled: return "\u{fbac}"
        case .speakerDisconnectedLight: return "\u{fbad}"
        case .speakerDisconnectedRegular: return "\u{fbae}"
        case .speakerFilled: return "\u{fbaf}"
        case .speakerLight: return "\u{fbb0}"
        case .speakerMutedBold: return "\u{fbb1}"
        case .speakerMutedFilled: return "\u{fbb2}"
        case .speakerMutedLight: return "\u{fbb3}"
        case .speakerMutedRegular: return "\u{fbb4}"
        case .speakerOffBold: return "\u{fbb5}"
        case .speakerOffFilled: return "\u{fbb6}"
        case .speakerOffLight: return "\u{fbb7}"
        case .speakerOffRegular: return "\u{fbb8}"
        case .speakerOnBold: return "\u{fbb9}"
        case .speakerOnLight: return "\u{fbba}"
        case .speakerOnRegular: return "\u{fbbb}"
        case .speakerRegular: return "\u{fbbc}"
        case .speakerTurnDownBold: return "\u{fbbd}"
        case .speakerTurnDownFilled: return "\u{fbbe}"
        case .speakerTurnDownLight: return "\u{fbbf}"
        case .speakerTurnDownRegular: return "\u{fbc0}"
        case .speakerTurnUpBold: return "\u{fbc1}"
        case .speakerTurnUpFilled: return "\u{fbc2}"
        case .speakerTurnUpLight: return "\u{fbc3}"
        case .speakerTurnUpRegular: return "\u{fbc4}"
        case .speechAiBold: return "\u{fbc5}"
        case .speechAiFilled: return "\u{fbc6}"
        case .speechAiLight: return "\u{fbc7}"
        case .speechAiRegular: return "\u{fbc8}"
        case .speedDialBold: return "\u{fbc9}"
        case .speedDialFilled: return "\u{fbca}"
        case .speedDialLight: return "\u{fbcb}"
        case .speedDialRegular: return "\u{fbcc}"
        case .spellCheckerBold: return "\u{fbcd}"
        case .spellCheckerLight: return "\u{fbce}"
        case .spellCheckerRegular: return "\u{fbcf}"
        case .splitViewBold: return "\u{fbd0}"
        case .splitViewLight: return "\u{fbd1}"
        case .splitViewRegular: return "\u{fbd2}"
        case .stackedAreaChartBold: return "\u{fbd3}"
        case .stackedAreaChartFilled: return "\u{fbd4}"
        case .stackedAreaChartFullBold: return "\u{fbd5}"
        case .stackedAreaChartFullFilled: return "\u{fbd6}"
        case .stackedAreaChartFullLight: return "\u{fbd7}"
        case .stackedAreaChartFullRegular: return "\u{fbd8}"
        case .stackedAreaChartLight: return "\u{fbd9}"
        case .stackedAreaChartRegular: return "\u{fbda}"
        case .stackedBarChartBold: return "\u{fbdb}"
        case .stackedBarChartFilled: return "\u{fbdc}"
        case .stackedBarChartFullBold: return "\u{fbdd}"
        case .stackedBarChartFullFilled: return "\u{fbde}"
        case .stackedBarChartFullLight: return "\u{fbdf}"
        case .stackedBarChartFullRegular: return "\u{fbe0}"
        case .stackedBarChartLight: return "\u{fbe1}"
        case .stackedBarChartRegular: return "\u{fbe2}"
        case .startChatBold: return "\u{fbe3}"
        case .startChatLight: return "\u{fbe4}"
        case .startChatRegular: return "\u{fbe5}"
        case .stethoscopeBold: return "\u{fbe6}"
        case .stethoscopeLight: return "\u{fbe7}"
        case .stethoscopeRegular: return "\u{fbe8}"
        case .stickersBold: return "\u{fbe9}"
        case .stickersLight: return "\u{fbea}"
        case .stickersRegular: return "\u{fbeb}"
        case .stickiesBold: return "\u{fbec}"
        case .stickiesLight: return "\u{fbed}"
        case .stickiesRegular: return "\u{fbee}"
        case .stopBold: return "\u{fbef}"
        case .stopCircleBold: return "\u{fbf0}"
        case .stopCircleFilled: return "\u{fbf1}"
        case .stopCircleLight: return "\u{fbf2}"
        case .stopCircleRegular: return "\u{fbf3}"
        case .stopContentShareBold: return "\u{fbf4}"
        case .stopContentShareLight: return "\u{fbf5}"
        case .stopContentShareRegular: return "\u{fbf6}"
        case .stopFilled: return "\u{fbf7}"
        case .stopLight: return "\u{fbf8}"
        case .stopRegular: return "\u{fbf9}"
        case .storedInfoBold: return "\u{fbfa}"
        case .storedInfoFilled: return "\u{fbfb}"
        case .storedInfoLight: return "\u{fbfc}"
        case .storedInfoRegular: return "\u{fbfd}"
        case .streamingBold: return "\u{fbfe}"
        case .streamingLight: return "\u{fbff}"
        case .streamingRegular: return "\u{fc00}"
        case .strikethroughBold: return "\u{fc01}"
        case .strikethroughFilled: return "\u{fc02}"
        case .strikethroughLight: return "\u{fc03}"
        case .strikethroughRegular: return "\u{fc04}"
        case .studioModeBold: return "\u{fc05}"
        case .studioModeLight: return "\u{fc06}"
        case .studioModeRegular: return "\u{fc07}"
        case .subscriptBold: return "\u{fc08}"
        case .subscriptLight: return "\u{fc09}"
        case .subscriptRegular: return "\u{fc0a}"
        case .summarizeAiBold: return "\u{fc0b}"
        case .summarizeAiLight: return "\u{fc0c}"
        case .summarizeAiRegular: return "\u{fc0d}"
        case .superscriptBold: return "\u{fc0e}"
        case .superscriptLight: return "\u{fc0f}"
        case .superscriptRegular: return "\u{fc10}"
        case .surveyBold: return "\u{fc11}"
        case .surveyFilled: return "\u{fc12}"
        case .surveyLight: return "\u{fc13}"
        case .surveyRegular: return "\u{fc14}"
        case .sxEightyCodecBold: return "\u{fc15}"
        case .sxEightyCodecLight: return "\u{fc16}"
        case .sxEightyCodecRegular: return "\u{fc17}"
        case .sxTenBold: return "\u{fc18}"
        case .sxTenLight: return "\u{fc19}"
        case .sxTenRegular: return "\u{fc1a}"
        case .sxTwentyBold: return "\u{fc1b}"
        case .sxTwentyLight: return "\u{fc1c}"
        case .sxTwentyRegular: return "\u{fc1d}"
        case .tableBold: return "\u{fc1e}"
        case .tableExtenderBold: return "\u{fc1f}"
        case .tableExtenderFilled: return "\u{fc20}"
        case .tableExtenderLight: return "\u{fc21}"
        case .tableExtenderRegular: return "\u{fc22}"
        case .tableLight: return "\u{fc23}"
        case .tableRegular: return "\u{fc24}"
        case .tabletBold: return "\u{fc25}"
        case .tabletLight: return "\u{fc26}"
        case .tabletRegular: return "\u{fc27}"
        case .tabsBold: return "\u{fc28}"
        case .tabsLight: return "\u{fc29}"
        case .tabsRegular: return "\u{fc2a}"
        case .tagBold: return "\u{fc2b}"
        case .tagLight: return "\u{fc2c}"
        case .tagRegular: return "\u{fc2d}"
        case .tapBold: return "\u{fc2e}"
        case .tapFilled: return "\u{fc2f}"
        case .tapLight: return "\u{fc30}"
        case .tapRegular: return "\u{fc31}"
        case .telepresenceAlertBold: return "\u{fc32}"
        case .telepresenceAlertLight: return "\u{fc33}"
        case .telepresenceAlertMutedBold: return "\u{fc34}"
        case .telepresenceAlertMutedLight: return "\u{fc35}"
        case .telepresenceAlertMutedRegular: return "\u{fc36}"
        case .telepresenceAlertRegular: return "\u{fc37}"
        case .telepresenceBold: return "\u{fc38}"
        case .telepresenceIxFiveThousandBold: return "\u{fc39}"
        case .telepresenceIxFiveThousandLight: return "\u{fc3a}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc3b}"
        case .telepresenceLight: return "\u{fc3c}"
        case .telepresenceMutedBold: return "\u{fc3d}"
        case .telepresenceMutedLight: return "\u{fc3e}"
        case .telepresenceMutedRegular: return "\u{fc3f}"
        case .telepresencePrivateBold: return "\u{fc40}"
        case .telepresencePrivateLight: return "\u{fc41}"
        case .telepresencePrivateRegular: return "\u{fc42}"
        case .telepresenceRegular: return "\u{fc43}"
        case .temperatureBold: return "\u{fc44}"
        case .temperatureLight: return "\u{fc45}"
        case .temperatureRegular: return "\u{fc46}"
        case .tenantBold: return "\u{fc47}"
        case .tenantFilled: return "\u{fc48}"
        case .tenantLight: return "\u{fc49}"
        case .tenantRegular: return "\u{fc4a}"
        case .testTubeBold: return "\u{fc4b}"
        case .testTubeFilled: return "\u{fc4c}"
        case .testTubeLight: return "\u{fc4d}"
        case .testTubeRegular: return "\u{fc4e}"
        case .textAlignCenterBold: return "\u{fc4f}"
        case .textAlignCenterFilled: return "\u{fc50}"
        case .textAlignCenterLight: return "\u{fc51}"
        case .textAlignCenterRegular: return "\u{fc52}"
        case .textAlignLeftBold: return "\u{fc53}"
        case .textAlignLeftFilled: return "\u{fc54}"
        case .textAlignLeftLight: return "\u{fc55}"
        case .textAlignLeftRegular: return "\u{fc56}"
        case .textAlignRightBold: return "\u{fc57}"
        case .textAlignRightFilled: return "\u{fc58}"
        case .textAlignRightLight: return "\u{fc59}"
        case .textAlignRightRegular: return "\u{fc5a}"
        case .textBold: return "\u{fc5b}"
        case .textBoxCursorLight: return "\u{fc5c}"
        case .textCodeBlockBold: return "\u{fc5d}"
        case .textCodeBlockLight: return "\u{fc5e}"
        case .textCodeBlockRegular: return "\u{fc5f}"
        case .textHighlightBold: return "\u{fc60}"
        case .textHighlightFilled: return "\u{fc61}"
        case .textHighlightLight: return "\u{fc62}"
        case .textHighlightRegular: return "\u{fc63}"
        case .textLight: return "\u{fc64}"
        case .textRegular: return "\u{fc65}"
        case .textShortBold: return "\u{fc66}"
        case .textShortLight: return "\u{fc67}"
        case .textShortRegular: return "\u{fc68}"
        case .threeColumnBold: return "\u{fc69}"
        case .threeColumnLight: return "\u{fc6a}"
        case .threeColumnRegular: return "\u{fc6b}"
        case .threeDObjectBold: return "\u{fc6c}"
        case .threeDObjectLight: return "\u{fc6d}"
        case .threeDObjectRegular: return "\u{fc6e}"
        case .timeExclusionBold: return "\u{fc6f}"
        case .timeExclusionLight: return "\u{fc70}"
        case .timeExclusionRegular: return "\u{fc71}"
        case .timezoneBold: return "\u{fc72}"
        case .timezoneFilled: return "\u{fc73}"
        case .timezoneLight: return "\u{fc74}"
        case .timezoneRegular: return "\u{fc75}"
        case .tooFastBold: return "\u{fc76}"
        case .tooFastLight: return "\u{fc77}"
        case .tooFastRegular: return "\u{fc78}"
        case .tooSlowBold: return "\u{fc79}"
        case .tooSlowLight: return "\u{fc7a}"
        case .tooSlowRegular: return "\u{fc7b}"
        case .toolsBold: return "\u{fc7c}"
        case .toolsFilled: return "\u{fc7d}"
        case .toolsLight: return "\u{fc7e}"
        case .toolsRegular: return "\u{fc7f}"
        case .touchTenBold: return "\u{fc80}"
        case .touchTenLight: return "\u{fc81}"
        case .touchTenRegular: return "\u{fc82}"
        case .trackingBold: return "\u{fc83}"
        case .trackingFilled: return "\u{fc84}"
        case .trackingLight: return "\u{fc85}"
        case .trackingRegular: return "\u{fc86}"
        case .transcriptBold: return "\u{fc87}"
        case .transcriptFilled: return "\u{fc88}"
        case .transcriptLight: return "\u{fc89}"
        case .transcriptRegular: return "\u{fc8a}"
        case .translateBold: return "\u{fc8b}"
        case .translateLight: return "\u{fc8c}"
        case .translateRegular: return "\u{fc8d}"
        case .translateUndoBold: return "\u{fc8e}"
        case .translateUndoLight: return "\u{fc8f}"
        case .translateUndoRegular: return "\u{fc90}"
        case .trendingBold: return "\u{fc91}"
        case .trendingDownBold: return "\u{fc92}"
        case .trendingDownFilled: return "\u{fc93}"
        case .trendingDownLight: return "\u{fc94}"
        case .trendingDownRegular: return "\u{fc95}"
        case .trendingFilled: return "\u{fc96}"
        case .trendingLight: return "\u{fc97}"
        case .trendingRegular: return "\u{fc98}"
        case .trimBold: return "\u{fc99}"
        case .trimLight: return "\u{fc9a}"
        case .trimRegular: return "\u{fc9b}"
        case .twoColumnBold: return "\u{fc9c}"
        case .twoColumnLight: return "\u{fc9d}"
        case .twoColumnRegular: return "\u{fc9e}"
        case .twoWayVoiceStreamBold: return "\u{fc9f}"
        case .twoWayVoiceStreamFilled: return "\u{fca0}"
        case .twoWayVoiceStreamLight: return "\u{fca1}"
        case .twoWayVoiceStreamRegular: return "\u{fca2}"
        case .ucmCloudBold: return "\u{fca3}"
        case .ucmCloudLight: return "\u{fca4}"
        case .ucmCloudRegular: return "\u{fca5}"
        case .unblockBold: return "\u{fca6}"
        case .unblockFilled: return "\u{fca7}"
        case .unblockLight: return "\u{fca8}"
        case .unblockRegular: return "\u{fca9}"
        case .underlineBold: return "\u{fcaa}"
        case .underlineFilled: return "\u{fcab}"
        case .underlineLight: return "\u{fcac}"
        case .underlineRegular: return "\u{fcad}"
        case .undoBold: return "\u{fcae}"
        case .undoLight: return "\u{fcaf}"
        case .undoRegular: return "\u{fcb0}"
        case .unlinkBold: return "\u{fcb1}"
        case .unlinkLight: return "\u{fcb2}"
        case .unlinkRegular: return "\u{fcb3}"
        case .unreadBold: return "\u{fcb4}"
        case .unreadFilled: return "\u{fcb5}"
        case .unreadLight: return "\u{fcb6}"
        case .unreadRegular: return "\u{fcb7}"
        case .unsecureUnlockedBold: return "\u{fcb8}"
        case .unsecureUnlockedFilled: return "\u{fcb9}"
        case .unsecureUnlockedLight: return "\u{fcba}"
        case .unsecureUnlockedRegular: return "\u{fcbb}"
        case .unsortedBold: return "\u{fcbc}"
        case .unsortedLight: return "\u{fcbd}"
        case .unsortedRegular: return "\u{fcbe}"
        case .updateFileShareBold: return "\u{fcbf}"
        case .updateFileShareLight: return "\u{fcc0}"
        case .updateFileShareRegular: return "\u{fcc1}"
        case .uploadBold: return "\u{fcc2}"
        case .uploadImageBold: return "\u{fcc3}"
        case .uploadImageLight: return "\u{fcc4}"
        case .uploadImageRegular: return "\u{fcc5}"
        case .uploadLight: return "\u{fcc6}"
        case .uploadRegular: return "\u{fcc7}"
        case .urgentVoicemailBold: return "\u{fcc8}"
        case .urgentVoicemailFilled: return "\u{fcc9}"
        case .usbBold: return "\u{fcca}"
        case .usbHeadsetBold: return "\u{fccb}"
        case .usbHeadsetLight: return "\u{fccc}"
        case .usbHeadsetMutedBold: return "\u{fccd}"
        case .usbHeadsetMutedLight: return "\u{fcce}"
        case .usbHeadsetMutedRegular: return "\u{fccf}"
        case .usbHeadsetRegular: return "\u{fcd0}"
        case .usbLight: return "\u{fcd1}"
        case .usbRegular: return "\u{fcd2}"
        case .userBold: return "\u{fcd3}"
        case .userDeactivateBold: return "\u{fcd4}"
        case .userDeactivateLight: return "\u{fcd5}"
        case .userDeactivateRegular: return "\u{fcd6}"
        case .userFilled: return "\u{fcd7}"
        case .userLight: return "\u{fcd8}"
        case .userRegular: return "\u{fcd9}"
        case .userSecurityStatusBold: return "\u{fcda}"
        case .userSecurityStatusFilled: return "\u{fcdb}"
        case .userSecurityStatusLight: return "\u{fcdc}"
        case .userSecurityStatusRegular: return "\u{fcdd}"
        case .videoBlurBold: return "\u{fcde}"
        case .videoBlurFilled: return "\u{fcdf}"
        case .videoBlurLight: return "\u{fce0}"
        case .videoBlurRegular: return "\u{fce1}"
        case .videoBold: return "\u{fce2}"
        case .videoEffectBold: return "\u{fce3}"
        case .videoEffectFilled: return "\u{fce4}"
        case .videoEffectLight: return "\u{fce5}"
        case .videoEffectRegular: return "\u{fce6}"
        case .videoFilled: return "\u{fce7}"
        case .videoLayoutBold: return "\u{fce8}"
        case .videoLayoutCustomBold: return "\u{fce9}"
        case .videoLayoutCustomFilled: return "\u{fcea}"
        case .videoLayoutCustomLight: return "\u{fceb}"
        case .videoLayoutCustomRegular: return "\u{fcec}"
        case .videoLayoutEqualBold: return "\u{fced}"
        case .videoLayoutEqualDualBold: return "\u{fcee}"
        case .videoLayoutEqualDualLight: return "\u{fcef}"
        case .videoLayoutEqualDualRegular: return "\u{fcf0}"
        case .videoLayoutEqualFilled: return "\u{fcf1}"
        case .videoLayoutEqualLight: return "\u{fcf2}"
        case .videoLayoutEqualRegular: return "\u{fcf3}"
        case .videoLayoutFilled: return "\u{fcf4}"
        case .videoLayoutLight: return "\u{fcf5}"
        case .videoLayoutOverlayBold: return "\u{fcf6}"
        case .videoLayoutOverlayFilled: return "\u{fcf7}"
        case .videoLayoutOverlayLight: return "\u{fcf8}"
        case .videoLayoutOverlayRegular: return "\u{fcf9}"
        case .videoLayoutPresentationBold: return "\u{fcfa}"
        case .videoLayoutPresentationFilled: return "\u{fcfb}"
        case .videoLayoutPresentationLight: return "\u{fcfc}"
        case .videoLayoutPresentationRegular: return "\u{fcfd}"
        case .videoLayoutPresenterDominantBold: return "\u{fcfe}"
        case .videoLayoutPresenterDominantLight: return "\u{fcff}"
        case .videoLayoutPresenterDominantRegular: return "\u{fd00}"
        case .videoLayoutProminentBold: return "\u{fd01}"
        case .videoLayoutProminentFilled: return "\u{fd02}"
        case .videoLayoutProminentLight: return "\u{fd03}"
        case .videoLayoutProminentRegular: return "\u{fd04}"
        case .videoLayoutRegular: return "\u{fd05}"
        case .videoLayoutShareDominantBold: return "\u{fd06}"
        case .videoLayoutShareDominantLight: return "\u{fd07}"
        case .videoLayoutShareDominantRegular: return "\u{fd08}"
        case .videoLayoutSingleBold: return "\u{fd09}"
        case .videoLayoutSingleFilled: return "\u{fd0a}"
        case .videoLayoutSingleLight: return "\u{fd0b}"
        case .videoLayoutSingleRegular: return "\u{fd0c}"
        case .videoLayoutSpeakerBold: return "\u{fd0d}"
        case .videoLayoutSpeakerFilled: return "\u{fd0e}"
        case .videoLayoutSpeakerLight: return "\u{fd0f}"
        case .videoLayoutSpeakerRegular: return "\u{fd10}"
        case .videoLayoutStackBold: return "\u{fd11}"
        case .videoLayoutStackFilled: return "\u{fd12}"
        case .videoLayoutStackLight: return "\u{fd13}"
        case .videoLayoutStackRegular: return "\u{fd14}"
        case .videoLayoutVideoDominantBold: return "\u{fd15}"
        case .videoLayoutVideoDominantFilled: return "\u{fd16}"
        case .videoLayoutVideoDominantLight: return "\u{fd17}"
        case .videoLayoutVideoDominantRegular: return "\u{fd18}"
        case .videoLight: return "\u{fd19}"
        case .videoPlusBold: return "\u{fd1a}"
        case .videoPlusFilled: return "\u{fd1b}"
        case .videoPlusLight: return "\u{fd1c}"
        case .videoPlusRegular: return "\u{fd1d}"
        case .videoRegular: return "\u{fd1e}"
        case .videoSpeakerTrackBold: return "\u{fd1f}"
        case .videoSpeakerTrackFilled: return "\u{fd20}"
        case .videoSpeakerTrackLight: return "\u{fd21}"
        case .videoSpeakerTrackRegular: return "\u{fd22}"
        case .viewAllBold: return "\u{fd23}"
        case .viewAllLight: return "\u{fd24}"
        case .viewAllRegular: return "\u{fd25}"
        case .viewListBold: return "\u{fd26}"
        case .viewListFilled: return "\u{fd27}"
        case .viewListLight: return "\u{fd28}"
        case .viewListRegular: return "\u{fd29}"
        case .viewStackedBold: return "\u{fd2a}"
        case .viewStackedFilled: return "\u{fd2b}"
        case .viewStackedLight: return "\u{fd2c}"
        case .viewStackedRegular: return "\u{fd2d}"
        case .viewThumbnailBold: return "\u{fd2e}"
        case .viewThumbnailFilled: return "\u{fd2f}"
        case .viewThumbnailLight: return "\u{fd30}"
        case .viewThumbnailRegular: return "\u{fd31}"
        case .visionproBold: return "\u{fd32}"
        case .visionproFilled: return "\u{fd33}"
        case .visionproLight: return "\u{fd34}"
        case .visionproMoveCallInBold: return "\u{fd35}"
        case .visionproMoveCallInFilled: return "\u{fd36}"
        case .visionproMoveCallInLight: return "\u{fd37}"
        case .visionproMoveCallInOutBold: return "\u{fd38}"
        case .visionproMoveCallInOutFilled: return "\u{fd39}"
        case .visionproMoveCallInOutLight: return "\u{fd3a}"
        case .visionproMoveCallInOutRegular: return "\u{fd3b}"
        case .visionproMoveCallInRegular: return "\u{fd3c}"
        case .visionproMoveCallOutBold: return "\u{fd3d}"
        case .visionproMoveCallOutFilled: return "\u{fd3e}"
        case .visionproMoveCallOutLight: return "\u{fd3f}"
        case .visionproMoveCallOutRegular: return "\u{fd40}"
        case .visionproRegular: return "\u{fd41}"
        case .voiceClipBold: return "\u{fd42}"
        case .voiceClipFilled: return "\u{fd43}"
        case .voiceClipLight: return "\u{fd44}"
        case .voiceClipRegular: return "\u{fd45}"
        case .voicemailBold: return "\u{fd46}"
        case .voicemailFilled: return "\u{fd47}"
        case .voicemailLight: return "\u{fd48}"
        case .voicemailRegular: return "\u{fd49}"
        case .vpnBold: return "\u{fd4a}"
        case .vpnFilled: return "\u{fd4b}"
        case .vpnLight: return "\u{fd4c}"
        case .vpnRegular: return "\u{fd4d}"
        case .vscBold: return "\u{fd4e}"
        case .vscLight: return "\u{fd4f}"
        case .vscRegular: return "\u{fd50}"
        case .waffleMenuBold: return "\u{fd51}"
        case .waffleMenuLight: return "\u{fd52}"
        case .waffleMenuRegular: return "\u{fd53}"
        case .waitingRoomBold: return "\u{fd54}"
        case .waitingRoomFilled: return "\u{fd55}"
        case .waitingRoomLight: return "\u{fd56}"
        case .waitingRoomRegular: return "\u{fd57}"
        case .wallpaperBold: return "\u{fd58}"
        case .wallpaperLight: return "\u{fd59}"
        case .wallpaperRegular: return "\u{fd5a}"
        case .warningBadgeFilled: return "\u{fd5b}"
        case .warningBold: return "\u{fd5c}"
        case .warningFilled: return "\u{fd5d}"
        case .warningLight: return "\u{fd5e}"
        case .warningRegular: return "\u{fd5f}"
        case .webexBoardBold: return "\u{fd60}"
        case .webexBoardLight: return "\u{fd61}"
        case .webexBoardRegular: return "\u{fd62}"
        case .webexCodecPlusBold: return "\u{fd63}"
        case .webexCodecPlusLight: return "\u{fd64}"
        case .webexCodecPlusRegular: return "\u{fd65}"
        case .webexDeskCameraBold: return "\u{fd66}"
        case .webexDeskCameraLight: return "\u{fd67}"
        case .webexDeskCameraRegular: return "\u{fd68}"
        case .webexHelixBold: return "\u{fd69}"
        case .webexHelixLight: return "\u{fd6a}"
        case .webexHelixRegular: return "\u{fd6b}"
        case .webexMeetingsBold: return "\u{fd6c}"
        case .webexMeetingsFilled: return "\u{fd6d}"
        case .webexMeetingsLight: return "\u{fd6e}"
        case .webexMeetingsRegular: return "\u{fd6f}"
        case .webexQuadCameraBold: return "\u{fd70}"
        case .webexQuadCameraLight: return "\u{fd71}"
        case .webexQuadCameraRegular: return "\u{fd72}"
        case .webexRoomKitBold: return "\u{fd73}"
        case .webexRoomKitLight: return "\u{fd74}"
        case .webexRoomKitPlusBold: return "\u{fd75}"
        case .webexRoomKitPlusLight: return "\u{fd76}"
        case .webexRoomKitPlusRegular: return "\u{fd77}"
        case .webexRoomKitRegular: return "\u{fd78}"
        case .webexShareBold: return "\u{fd79}"
        case .webexShareLight: return "\u{fd7a}"
        case .webexShareRegular: return "\u{fd7b}"
        case .webexTeamsBold: return "\u{fd7c}"
        case .webexTeamsFilled: return "\u{fd7d}"
        case .webexTeamsLight: return "\u{fd7e}"
        case .webexTeamsNewBold: return "\u{fd7f}"
        case .webexTeamsNewFilled: return "\u{fd80}"
        case .webexTeamsNewLight: return "\u{fd81}"
        case .webexTeamsNewRegular: return "\u{fd82}"
        case .webexTeamsRegular: return "\u{fd83}"
        case .webexTeamsRemoveBold: return "\u{fd84}"
        case .webexTeamsRemoveLight: return "\u{fd85}"
        case .webexTeamsRemoveRegular: return "\u{fd86}"
        case .webhookBold: return "\u{fd87}"
        case .webhookLight: return "\u{fd88}"
        case .webhookRegular: return "\u{fd89}"
        case .webinarBold: return "\u{fd8a}"
        case .webinarFilled: return "\u{fd8b}"
        case .webinarLight: return "\u{fd8c}"
        case .webinarRegular: return "\u{fd8d}"
        case .weeklyRecurringScheduleBold: return "\u{fd8e}"
        case .weeklyRecurringScheduleLight: return "\u{fd8f}"
        case .weeklyRecurringScheduleRegular: return "\u{fd90}"
        case .whisperAnnouncementBold: return "\u{fd91}"
        case .whisperAnnouncementFilled: return "\u{fd92}"
        case .whisperAnnouncementLight: return "\u{fd93}"
        case .whisperAnnouncementRegular: return "\u{fd94}"
        case .whisperCoachBold: return "\u{fd95}"
        case .whisperCoachFilled: return "\u{fd96}"
        case .whisperCoachLight: return "\u{fd97}"
        case .whisperCoachRegular: return "\u{fd98}"
        case .whiteboardBold: return "\u{fd99}"
        case .whiteboardContentBold: return "\u{fd9a}"
        case .whiteboardContentFilled: return "\u{fd9b}"
        case .whiteboardContentLight: return "\u{fd9c}"
        case .whiteboardContentRegular: return "\u{fd9d}"
        case .whiteboardFilled: return "\u{fd9e}"
        case .whiteboardLight: return "\u{fd9f}"
        case .whiteboardRegular: return "\u{fda0}"
        case .widgetBold: return "\u{fda1}"
        case .widgetFilled: return "\u{fda2}"
        case .widgetLight: return "\u{fda3}"
        case .widgetRegular: return "\u{fda4}"
        case .wifiBold: return "\u{fda5}"
        case .wifiErrorBold: return "\u{fda6}"
        case .wifiErrorLight: return "\u{fda7}"
        case .wifiErrorRegular: return "\u{fda8}"
        case .wifiLight: return "\u{fda9}"
        case .wifiRegular: return "\u{fdaa}"
        case .wifiSignalGoodBold: return "\u{fdab}"
        case .wifiSignalGoodLight: return "\u{fdac}"
        case .wifiSignalGoodRegular: return "\u{fdad}"
        case .wifiSignalPoorBold: return "\u{fdae}"
        case .wifiSignalPoorLight: return "\u{fdaf}"
        case .wifiSignalPoorRegular: return "\u{fdb0}"
        case .wifiSignalUnstableBold: return "\u{fdb1}"
        case .wifiSignalUnstableLight: return "\u{fdb2}"
        case .wifiSignalUnstableRegular: return "\u{fdb3}"
        case .windowCornerScrubBold: return "\u{fdb4}"
        case .windowCornerScrubLight: return "\u{fdb5}"
        case .windowCornerScrubRegular: return "\u{fdb6}"
        case .windowRightCornerScrubBold: return "\u{fdb7}"
        case .windowRightCornerScrubLight: return "\u{fdb8}"
        case .windowRightCornerScrubRegular: return "\u{fdb9}"
        case .windowVerticalScrubBold: return "\u{fdba}"
        case .windowVerticalScrubLight: return "\u{fdbb}"
        case .windowVerticalScrubRegular: return "\u{fdbc}"
        case .workflowDeploymentsBold: return "\u{fdbd}"
        case .workflowDeploymentsFilled: return "\u{fdbe}"
        case .workflowDeploymentsLight: return "\u{fdbf}"
        case .workflowDeploymentsRegular: return "\u{fdc0}"
        case .workphoneBold: return "\u{fdc1}"
        case .workphoneLight: return "\u{fdc2}"
        case .workphoneRegular: return "\u{fdc3}"
        case .zoomInBold: return "\u{fdc4}"
        case .zoomInLight: return "\u{fdc5}"
        case .zoomInRegular: return "\u{fdc6}"
        case .zoomOutBold: return "\u{fdc7}"
        case .zoomOutLight: return "\u{fdc8}"
        case .zoomOutRegular: return "\u{fdc9}"
