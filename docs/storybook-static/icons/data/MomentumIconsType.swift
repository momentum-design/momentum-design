...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .certifiedFilled: return "\u{f333}"
        case .certifiedLight: return "\u{f334}"
        case .certifiedRegular: return "\u{f335}"
        case .chPSearchBold: return "\u{f336}"
        case .chPSearchLight: return "\u{f337}"
        case .chPSearchRegular: return "\u{f338}"
        case .channelUssdBold: return "\u{f339}"
        case .channelUssdLight: return "\u{f33a}"
        case .channelUssdRegular: return "\u{f33b}"
        case .chatBold: return "\u{f33c}"
        case .chatFilled: return "\u{f33d}"
        case .chatGroupBold: return "\u{f33e}"
        case .chatGroupFilled: return "\u{f33f}"
        case .chatGroupLight: return "\u{f340}"
        case .chatGroupRegular: return "\u{f341}"
        case .chatLight: return "\u{f342}"
        case .chatMuteBold: return "\u{f343}"
        case .chatMuteLight: return "\u{f344}"
        case .chatMuteRegular: return "\u{f345}"
        case .chatOutboundFilled: return "\u{f346}"
        case .chatRegular: return "\u{f347}"
        case .checkBold: return "\u{f348}"
        case .checkCircleBadgeFilled: return "\u{f349}"
        case .checkCircleBold: return "\u{f34a}"
        case .checkCircleFilled: return "\u{f34b}"
        case .checkCircleLight: return "\u{f34c}"
        case .checkCircleRegular: return "\u{f34d}"
        case .checkLight: return "\u{f34e}"
        case .checkRegular: return "\u{f34f}"
        case .checkboxGroupBold: return "\u{f350}"
        case .checkboxGroupLight: return "\u{f351}"
        case .checkboxGroupRegular: return "\u{f352}"
        case .cleanUpBold: return "\u{f353}"
        case .cleanUpLight: return "\u{f354}"
        case .cleanUpRegular: return "\u{f355}"
        case .clearBadgeFilled: return "\u{f356}"
        case .clearBold: return "\u{f357}"
        case .clearFilled: return "\u{f358}"
        case .clearLight: return "\u{f359}"
        case .clearRegular: return "\u{f35a}"
        case .closeSpaceBold: return "\u{f35b}"
        case .closeSpaceLight: return "\u{f35c}"
        case .closeSpaceRegular: return "\u{f35d}"
        case .closedCaptionBadgeBold: return "\u{f35e}"
        case .closedCaptionBadgeFilled: return "\u{f35f}"
        case .closedCaptionBadgeLight: return "\u{f360}"
        case .closedCaptionBadgeRegular: return "\u{f361}"
        case .closedCaptionsBold: return "\u{f362}"
        case .closedCaptionsFilled: return "\u{f363}"
        case .closedCaptionsLight: return "\u{f364}"
        case .closedCaptionsRegular: return "\u{f365}"
        case .cloudBold: return "\u{f366}"
        case .cloudDownloadBold: return "\u{f367}"
        case .cloudDownloadLight: return "\u{f368}"
        case .cloudDownloadRegular: return "\u{f369}"
        case .cloudFilled: return "\u{f36a}"
        case .cloudFrameBold: return "\u{f36b}"
        case .cloudFrameFilled: return "\u{f36c}"
        case .cloudFrameLight: return "\u{f36d}"
        case .cloudFrameRegular: return "\u{f36e}"
        case .cloudLight: return "\u{f36f}"
        case .cloudMutedBold: return "\u{f370}"
        case .cloudMutedFilled: return "\u{f371}"
        case .cloudMutedLight: return "\u{f372}"
        case .cloudMutedRegular: return "\u{f373}"
        case .cloudRegular: return "\u{f374}"
        case .cloudUploadBold: return "\u{f375}"
        case .cloudUploadLight: return "\u{f376}"
        case .cloudUploadRegular: return "\u{f377}"
        case .codeBlockBold: return "\u{f378}"
        case .codeBlockLight: return "\u{f379}"
        case .codeBlockRegular: return "\u{f37a}"
        case .coffeeBold: return "\u{f37b}"
        case .coffeeLight: return "\u{f37c}"
        case .coffeeRegular: return "\u{f37d}"
        case .colorBold: return "\u{f37e}"
        case .colorFilled: return "\u{f37f}"
        case .colorLight: return "\u{f380}"
        case .colorRegular: return "\u{f381}"
        case .colourPaletteBold: return "\u{f382}"
        case .colourPaletteFilled: return "\u{f383}"
        case .colourPaletteLight: return "\u{f384}"
        case .colourPaletteRegular: return "\u{f385}"
        case .commentingBold: return "\u{f386}"
        case .commentingFilled: return "\u{f387}"
        case .commentingLight: return "\u{f388}"
        case .commentingRegular: return "\u{f389}"
        case .companyBold: return "\u{f38a}"
        case .companyLight: return "\u{f38b}"
        case .companyRegular: return "\u{f38c}"
        case .completedByBaseBold: return "\u{f38d}"
        case .completedByBaseLight: return "\u{f38e}"
        case .completedByBaseRegular: return "\u{f38f}"
        case .completedByTimeBold: return "\u{f390}"
        case .completedByTimeLight: return "\u{f391}"
        case .completedByTimeRegular: return "\u{f392}"
        case .computerBold: return "\u{f393}"
        case .computerLight: return "\u{f394}"
        case .computerRegular: return "\u{f395}"
        case .conciergeBold: return "\u{f396}"
        case .conciergeLight: return "\u{f397}"
        case .conciergeRegular: return "\u{f398}"
        case .conditionalBlockBold: return "\u{f399}"
        case .conditionalBlockLight: return "\u{f39a}"
        case .conditionalBlockRegular: return "\u{f39b}"
        case .connectBold: return "\u{f39c}"
        case .connectLight: return "\u{f39d}"
        case .connectRegular: return "\u{f39e}"
        case .contactCardBold: return "\u{f39f}"
        case .contactCardFilled: return "\u{f3a0}"
        case .contactCardLight: return "\u{f3a1}"
        case .contactCardRegular: return "\u{f3a2}"
        case .contactsBold: return "\u{f3a3}"
        case .contactsFilled: return "\u{f3a4}"
        case .contactsLight: return "\u{f3a5}"
        case .contactsRegular: return "\u{f3a6}"
        case .contentDownloadBold: return "\u{f3a7}"
        case .contentDownloadFilled: return "\u{f3a8}"
        case .contentDownloadLight: return "\u{f3a9}"
        case .contentDownloadRegular: return "\u{f3aa}"
        case .contentShareBold: return "\u{f3ab}"
        case .contentShareLight: return "\u{f3ac}"
        case .contentShareRegular: return "\u{f3ad}"
        case .contrastBold: return "\u{f3ae}"
        case .contrastLight: return "\u{f3af}"
        case .contrastRegular: return "\u{f3b0}"
        case .copyBold: return "\u{f3b1}"
        case .copyLight: return "\u{f3b2}"
        case .copyRegular: return "\u{f3b3}"
        case .cpuBold: return "\u{f3b4}"
        case .cpuLight: return "\u{f3b5}"
        case .cpuRegular: return "\u{f3b6}"
        case .createAGroupBold: return "\u{f3b7}"
        case .createAGroupFilled: return "\u{f3b8}"
        case .createAGroupLight: return "\u{f3b9}"
        case .createAGroupRegular: return "\u{f3ba}"
        case .cropBold: return "\u{f3bb}"
        case .cropLight: return "\u{f3bc}"
        case .cropRegular: return "\u{f3bd}"
        case .cucmConnectionBold: return "\u{f3be}"
        case .cucmConnectionLight: return "\u{f3bf}"
        case .cucmConnectionRegular: return "\u{f3c0}"
        case .customCodeEditorBold: return "\u{f3c1}"
        case .customCodeEditorLight: return "\u{f3c2}"
        case .customCodeEditorRegular: return "\u{f3c3}"
        case .dailyRecurringScheduleBold: return "\u{f3c4}"
        case .dailyRecurringScheduleLight: return "\u{f3c5}"
        case .dailyRecurringScheduleRegular: return "\u{f3c6}"
        case .dashboardBold: return "\u{f3c7}"
        case .dashboardFilled: return "\u{f3c8}"
        case .dashboardLight: return "\u{f3c9}"
        case .dashboardRegular: return "\u{f3ca}"
        case .dataManagementBold: return "\u{f3cb}"
        case .dataManagementFilled: return "\u{f3cc}"
        case .dataManagementLight: return "\u{f3cd}"
        case .dataManagementRegular: return "\u{f3ce}"
        case .dataRangeSelectionBold: return "\u{f3cf}"
        case .dataRangeSelectionFilled: return "\u{f3d0}"
        case .dataRangeSelectionLight: return "\u{f3d1}"
        case .dataRangeSelectionRegular: return "\u{f3d2}"
        case .declineBold: return "\u{f3d3}"
        case .declineFilled: return "\u{f3d4}"
        case .declineLight: return "\u{f3d5}"
        case .declineRegular: return "\u{f3d6}"
        case .dectHandsetBold: return "\u{f3d7}"
        case .dectHandsetFilled: return "\u{f3d8}"
        case .dectHandsetLight: return "\u{f3d9}"
        case .dectHandsetRegular: return "\u{f3da}"
        case .deleteBold: return "\u{f3db}"
        case .deleteFilled: return "\u{f3dc}"
        case .deleteLight: return "\u{f3dd}"
        case .deleteRegular: return "\u{f3de}"
        case .deploymentEvaluationProgressBold: return "\u{f3df}"
        case .deploymentEvaluationProgressLight: return "\u{f3e0}"
        case .deploymentEvaluationProgressRegular: return "\u{f3e1}"
        case .deploymentProgressBold: return "\u{f3e2}"
        case .deploymentProgressLight: return "\u{f3e3}"
        case .deploymentProgressRegular: return "\u{f3e4}"
        case .deploymentRecurringBold: return "\u{f3e5}"
        case .deploymentRecurringLight: return "\u{f3e6}"
        case .deploymentRecurringRegular: return "\u{f3e7}"
        case .deploymentWinnerPendingBold: return "\u{f3e8}"
        case .deploymentWinnerPendingLight: return "\u{f3e9}"
        case .deploymentWinnerPendingRegular: return "\u{f3ea}"
        case .deskPhoneBold: return "\u{f3eb}"
        case .deskPhoneFilled: return "\u{f3ec}"
        case .deskPhoneLight: return "\u{f3ed}"
        case .deskPhoneRegular: return "\u{f3ee}"
        case .deskPhoneWarningBold: return "\u{f3ef}"
        case .deskPhoneWarningLight: return "\u{f3f0}"
        case .deskPhoneWarningRegular: return "\u{f3f1}"
        case .deviceConnectionBold: return "\u{f3f2}"
        case .deviceConnectionFilled: return "\u{f3f3}"
        case .deviceConnectionLight: return "\u{f3f4}"
        case .deviceConnectionRegular: return "\u{f3f5}"
        case .deviceInRoomBold: return "\u{f3f6}"
        case .deviceInRoomEndBold: return "\u{f3f7}"
        case .deviceInRoomEndLight: return "\u{f3f8}"
        case .deviceInRoomEndRegular: return "\u{f3f9}"
        case .deviceInRoomFilled: return "\u{f3fa}"
        case .deviceInRoomLight: return "\u{f3fb}"
        case .deviceInRoomRegular: return "\u{f3fc}"
        case .deviceMutedBold: return "\u{f3fd}"
        case .deviceMutedLight: return "\u{f3fe}"
        case .deviceMutedRegular: return "\u{f3ff}"
        case .devicePolicyControllerBold: return "\u{f400}"
        case .devicePolicyControllerLight: return "\u{f401}"
        case .devicePolicyControllerRegular: return "\u{f402}"
        case .diagnosticsBold: return "\u{f403}"
        case .diagnosticsLight: return "\u{f404}"
        case .diagnosticsRegular: return "\u{f405}"
        case .dialpadBold: return "\u{f406}"
        case .dialpadLight: return "\u{f407}"
        case .dialpadRegular: return "\u{f408}"
        case .directionalPadBold: return "\u{f409}"
        case .directionalPadFilled: return "\u{f40a}"
        case .directionalPadLight: return "\u{f40b}"
        case .directionalPadRegular: return "\u{f40c}"
        case .directoryBold: return "\u{f40d}"
        case .directoryLight: return "\u{f40e}"
        case .directoryRegular: return "\u{f40f}"
        case .disappearingPenBold: return "\u{f410}"
        case .disappearingPenLight: return "\u{f411}"
        case .disappearingPenRegular: return "\u{f412}"
        case .discBold: return "\u{f413}"
        case .discConnectedBold: return "\u{f414}"
        case .discConnectedLight: return "\u{f415}"
        case .discConnectedRegular: return "\u{f416}"
        case .discLight: return "\u{f417}"
        case .discRegular: return "\u{f418}"
        case .disconnectBold: return "\u{f419}"
        case .disconnectFilled: return "\u{f41a}"
        case .disconnectLight: return "\u{f41b}"
        case .disconnectRegular: return "\u{f41c}"
        case .dislikeBold: return "\u{f41d}"
        case .dislikeFilled: return "\u{f41e}"
        case .dislikeLight: return "\u{f41f}"
        case .dislikeRegular: return "\u{f420}"
        case .displayBold: return "\u{f421}"
        case .displayInputBold: return "\u{f422}"
        case .displayInputLight: return "\u{f423}"
        case .displayInputRegular: return "\u{f424}"
        case .displayLight: return "\u{f425}"
        case .displayRegular: return "\u{f426}"
        case .displayWarningBold: return "\u{f427}"
        case .displayWarningLight: return "\u{f428}"
        case .displayWarningRegular: return "\u{f429}"
        case .distributeHorizontalBold: return "\u{f42a}"
        case .distributeHorizontalFilled: return "\u{f42b}"
        case .distributeHorizontalLight: return "\u{f42c}"
        case .distributeHorizontalRegular: return "\u{f42d}"
        case .distributeVerticallyBold: return "\u{f42e}"
        case .distributeVerticallyFilled: return "\u{f42f}"
        case .distributeVerticallyLight: return "\u{f430}"
        case .distributeVerticallyRegular: return "\u{f431}"
        case .dndPresenceBadgeFilled: return "\u{f432}"
        case .dndPresenceBold: return "\u{f433}"
        case .dndPresenceFilled: return "\u{f434}"
        case .dndPresenceLight: return "\u{f435}"
        case .dndPresenceRegular: return "\u{f436}"
        case .dockWindowBold: return "\u{f437}"
        case .dockWindowLight: return "\u{f438}"
        case .dockWindowRegular: return "\u{f439}"
        case .documentBold: return "\u{f43a}"
        case .documentCameraBold: return "\u{f43b}"
        case .documentCameraDisconnectedBold: return "\u{f43c}"
        case .documentCameraDisconnectedLight: return "\u{f43d}"
        case .documentCameraDisconnectedRegular: return "\u{f43e}"
        case .documentCameraLight: return "\u{f43f}"
        case .documentCameraRegular: return "\u{f440}"
        case .documentCreateBold: return "\u{f441}"
        case .documentCreateFilled: return "\u{f442}"
        case .documentCreateLight: return "\u{f443}"
        case .documentCreateRegular: return "\u{f444}"
        case .documentFilled: return "\u{f445}"
        case .documentLight: return "\u{f446}"
        case .documentMoveBold: return "\u{f447}"
        case .documentMoveFilled: return "\u{f448}"
        case .documentMoveLight: return "\u{f449}"
        case .documentMoveRegular: return "\u{f44a}"
        case .documentRegular: return "\u{f44b}"
        case .documentShareBold: return "\u{f44c}"
        case .documentShareFilled: return "\u{f44d}"
        case .documentShareLight: return "\u{f44e}"
        case .documentShareRegular: return "\u{f44f}"
        case .doneAllBold: return "\u{f450}"
        case .doneAllLight: return "\u{f451}"
        case .doneAllRegular: return "\u{f452}"
        case .donutChartBold: return "\u{f453}"
        case .donutChartFilled: return "\u{f454}"
        case .donutChartLight: return "\u{f455}"
        case .donutChartRegular: return "\u{f456}"
        case .downloadBold: return "\u{f457}"
        case .downloadFilled: return "\u{f458}"
        case .downloadLight: return "\u{f459}"
        case .downloadRegular: return "\u{f45a}"
        case .draftBold: return "\u{f45b}"
        case .draftFilled: return "\u{f45c}"
        case .draftIndicatorBold: return "\u{f45d}"
        case .draftIndicatorSmallFilled: return "\u{f45e}"
        case .draftLight: return "\u{f45f}"
        case .draftRegular: return "\u{f460}"
        case .dragBold: return "\u{f461}"
        case .dragLight: return "\u{f462}"
        case .dragRegular: return "\u{f463}"
        case .draggerHorizontalBold: return "\u{f464}"
        case .draggerHorizontalLight: return "\u{f465}"
        case .draggerHorizontalRegular: return "\u{f466}"
        case .draggerVerticalBold: return "\u{f467}"
        case .draggerVerticalLight: return "\u{f468}"
        case .draggerVerticalRegular: return "\u{f469}"
        case .driveModeBold: return "\u{f46a}"
        case .driveModeLight: return "\u{f46b}"
        case .driveModeRegular: return "\u{f46c}"
        case .dropdownBold: return "\u{f46d}"
        case .dropdownLight: return "\u{f46e}"
        case .dropdownRegular: return "\u{f46f}"
        case .dxEightyBold: return "\u{f470}"
        case .dxEightyFilled: return "\u{f471}"
        case .dxEightyLight: return "\u{f472}"
        case .dxEightyRegular: return "\u{f473}"
        case .dxSeventyBold: return "\u{f474}"
        case .dxSeventyLight: return "\u{f475}"
        case .dxSeventyRegular: return "\u{f476}"
        case .editBold: return "\u{f477}"
        case .editFilled: return "\u{f478}"
        case .editLight: return "\u{f479}"
        case .editRegular: return "\u{f47a}"
        case .editablePartialBold: return "\u{f47b}"
        case .editablePartialLight: return "\u{f47c}"
        case .editablePartialRegular: return "\u{f47d}"
        case .educationBold: return "\u{f47e}"
        case .educationFilled: return "\u{f47f}"
        case .educationLight: return "\u{f480}"
        case .educationRegular: return "\u{f481}"
        case .emailBold: return "\u{f482}"
        case .emailDeliveredBold: return "\u{f483}"
        case .emailDeliveredLight: return "\u{f484}"
        case .emailDeliveredRegular: return "\u{f485}"
        case .emailFailureBold: return "\u{f486}"
        case .emailFailureLight: return "\u{f487}"
        case .emailFailureRegular: return "\u{f488}"
        case .emailFilled: return "\u{f489}"
        case .emailInviteBold: return "\u{f48a}"
        case .emailInviteLight: return "\u{f48b}"
        case .emailInviteRegular: return "\u{f48c}"
        case .emailLight: return "\u{f48d}"
        case .emailOutgoingBold: return "\u{f48e}"
        case .emailOutgoingFilled: return "\u{f48f}"
        case .emailOutgoingLight: return "\u{f490}"
        case .emailOutgoingRegular: return "\u{f491}"
        case .emailReadBold: return "\u{f492}"
        case .emailReadFilled: return "\u{f493}"
        case .emailReadLight: return "\u{f494}"
        case .emailReadRegular: return "\u{f495}"
        case .emailRegular: return "\u{f496}"
        case .emojiExcitedBold: return "\u{f497}"
        case .emojiExcitedFilled: return "\u{f498}"
        case .emojiExcitedLight: return "\u{f499}"
        case .emojiExcitedRegular: return "\u{f49a}"
        case .emojiHappyBold: return "\u{f49b}"
        case .emojiHappyFilled: return "\u{f49c}"
        case .emojiHappyLight: return "\u{f49d}"
        case .emojiHappyRegular: return "\u{f49e}"
        case .emojiPassiveBold: return "\u{f49f}"
        case .emojiPassiveFilled: return "\u{f4a0}"
        case .emojiPassiveLight: return "\u{f4a1}"
        case .emojiPassiveRegular: return "\u{f4a2}"
        case .emojiSadBold: return "\u{f4a3}"
        case .emojiSadFilled: return "\u{f4a4}"
        case .emojiSadLight: return "\u{f4a5}"
        case .emojiSadRegular: return "\u{f4a6}"
        case .emojiUnhappyBold: return "\u{f4a7}"
        case .emojiUnhappyFilled: return "\u{f4a8}"
        case .emojiUnhappyLight: return "\u{f4a9}"
        case .emojiUnhappyRegular: return "\u{f4aa}"
        case .encryptionCircleFilled: return "\u{f4ab}"
        case .encryptionFilled: return "\u{f4ac}"
        case .endRemoteDesktopControlBold: return "\u{f4ad}"
        case .endRemoteDesktopControlLight: return "\u{f4ae}"
        case .endRemoteDesktopControlRegular: return "\u{f4af}"
        case .endToEndEncryptionCircleFilled: return "\u{f4b0}"
        case .endToEndEncryptionFilled: return "\u{f4b1}"
        case .endpointBlockedBold: return "\u{f4b2}"
        case .endpointBlockedLight: return "\u{f4b3}"
        case .endpointBlockedRegular: return "\u{f4b4}"
        case .endpointBold: return "\u{f4b5}"
        case .endpointGTwoBold: return "\u{f4b6}"
        case .endpointGTwoLight: return "\u{f4b7}"
        case .endpointGTwoRegular: return "\u{f4b8}"
        case .endpointGTwoSeventyBold: return "\u{f4b9}"
        case .endpointGTwoSeventyDualBold: return "\u{f4ba}"
        case .endpointGTwoSeventyDualLight: return "\u{f4bb}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4bc}"
        case .endpointGTwoSeventyLight: return "\u{f4bd}"
        case .endpointGTwoSeventyRegular: return "\u{f4be}"
        case .endpointGTwoStandBold: return "\u{f4bf}"
        case .endpointGTwoStandLight: return "\u{f4c0}"
        case .endpointGTwoStandRegular: return "\u{f4c1}"
        case .endpointLight: return "\u{f4c2}"
        case .endpointMxEightHundredBold: return "\u{f4c3}"
        case .endpointMxEightHundredDualBold: return "\u{f4c4}"
        case .endpointMxEightHundredDualLight: return "\u{f4c5}"
        case .endpointMxEightHundredDualRegular: return "\u{f4c6}"
        case .endpointMxEightHundredLight: return "\u{f4c7}"
        case .endpointMxEightHundredRegular: return "\u{f4c8}"
        case .endpointRegular: return "\u{f4c9}"
        case .endpointStandBold: return "\u{f4ca}"
        case .endpointStandFilled: return "\u{f4cb}"
        case .endpointStandLight: return "\u{f4cc}"
        case .endpointStandRegular: return "\u{f4cd}"
        case .endpointWarningBold: return "\u{f4ce}"
        case .endpointWarningLight: return "\u{f4cf}"
        case .endpointWarningRegular: return "\u{f4d0}"
        case .enterBold: return "\u{f4d1}"
        case .enterLight: return "\u{f4d2}"
        case .enterRegular: return "\u{f4d3}"
        case .enterRoomBold: return "\u{f4d4}"
        case .enterRoomFilled: return "\u{f4d5}"
        case .enterRoomLight: return "\u{f4d6}"
        case .enterRoomRegular: return "\u{f4d7}"
        case .eraserBold: return "\u{f4d8}"
        case .eraserFilled: return "\u{f4d9}"
        case .eraserLight: return "\u{f4da}"
        case .eraserRegular: return "\u{f4db}"
        case .errorLegacyBadgeFilled: return "\u{f4dc}"
        case .errorLegacyBold: return "\u{f4dd}"
        case .errorLegacyFilled: return "\u{f4de}"
        case .errorLegacyLight: return "\u{f4df}"
        case .errorLegacyRegular: return "\u{f4e0}"
        case .ethernetBold: return "\u{f4e1}"
        case .ethernetFilled: return "\u{f4e2}"
        case .ethernetLight: return "\u{f4e3}"
        case .ethernetRegular: return "\u{f4e4}"
        case .exchangeBold: return "\u{f4e5}"
        case .exchangeLight: return "\u{f4e6}"
        case .exchangeRegular: return "\u{f4e7}"
        case .exclamationBold: return "\u{f4e8}"
        case .exclamationLight: return "\u{f4e9}"
        case .exclamationRegular: return "\u{f4ea}"
        case .excludeBold: return "\u{f4eb}"
        case .excludeLight: return "\u{f4ec}"
        case .excludeRegular: return "\u{f4ed}"
        case .existingTargetGroupBold: return "\u{f4ee}"
        case .existingTargetGroupLight: return "\u{f4ef}"
        case .existingTargetGroupRegular: return "\u{f4f0}"
        case .exitRoomBold: return "\u{f4f1}"
        case .exitRoomLight: return "\u{f4f2}"
        case .exitRoomRegular: return "\u{f4f3}"
        case .exploreBold: return "\u{f4f4}"
        case .exploreLight: return "\u{f4f5}"
        case .exploreRegular: return "\u{f4f6}"
        case .exportBold: return "\u{f4f7}"
        case .exportLight: return "\u{f4f8}"
        case .exportRegular: return "\u{f4f9}"
        case .extensionMobilityBold: return "\u{f4fa}"
        case .extensionMobilityLight: return "\u{f4fb}"
        case .extensionMobilityRegular: return "\u{f4fc}"
        case .externalMessageBold: return "\u{f4fd}"
        case .externalMessageLight: return "\u{f4fe}"
        case .externalMessageRegular: return "\u{f4ff}"
        case .externalUserBold: return "\u{f500}"
        case .externalUserLight: return "\u{f501}"
        case .externalUserRegular: return "\u{f502}"
        case .familyFontBold: return "\u{f503}"
        case .familyFontLight: return "\u{f504}"
        case .familyFontRegular: return "\u{f505}"
        case .fastForwardBold: return "\u{f506}"
        case .fastForwardLight: return "\u{f507}"
        case .fastForwardRegular: return "\u{f508}"
        case .favoriteBold: return "\u{f509}"
        case .favoriteFilled: return "\u{f50a}"
        case .favoriteLight: return "\u{f50b}"
        case .favoriteRegular: return "\u{f50c}"
        case .favoritesBold: return "\u{f50d}"
        case .favoritesFilled: return "\u{f50e}"
        case .favoritesLight: return "\u{f50f}"
        case .favoritesRegular: return "\u{f510}"
        case .fbwBold: return "\u{f511}"
        case .fbwFilled: return "\u{f512}"
        case .fbwLight: return "\u{f513}"
        case .fbwRegular: return "\u{f514}"
        case .ffwBold: return "\u{f515}"
        case .ffwFilled: return "\u{f516}"
        case .ffwLight: return "\u{f517}"
        case .ffwRegular: return "\u{f518}"
        case .fileAnalysisBold: return "\u{f519}"
        case .fileAnalysisFilled: return "\u{f51a}"
        case .fileAnalysisLight: return "\u{f51b}"
        case .fileAnalysisRegular: return "\u{f51c}"
        case .fileAnnotationBold: return "\u{f51d}"
        case .fileAnnotationFilled: return "\u{f51e}"
        case .fileAnnotationLight: return "\u{f51f}"
        case .fileAnnotationRegular: return "\u{f520}"
        case .fileAudioBold: return "\u{f521}"
        case .fileAudioFilled: return "\u{f522}"
        case .fileAudioLight: return "\u{f523}"
        case .fileAudioRegular: return "\u{f524}"
        case .fileBugBold: return "\u{f525}"
        case .fileBugFilled: return "\u{f526}"
        case .fileBugLight: return "\u{f527}"
        case .fileBugRegular: return "\u{f528}"
        case .fileCodeBold: return "\u{f529}"
        case .fileCodeFilled: return "\u{f52a}"
        case .fileCodeLight: return "\u{f52b}"
        case .fileCodeRegular: return "\u{f52c}"
        case .fileDashboardBold: return "\u{f52d}"
        case .fileDashboardFilled: return "\u{f52e}"
        case .fileDashboardLight: return "\u{f52f}"
        case .fileDashboardRegular: return "\u{f530}"
        case .fileExcelBold: return "\u{f531}"
        case .fileExcelFilled: return "\u{f532}"
        case .fileExcelLight: return "\u{f533}"
        case .fileExcelRegular: return "\u{f534}"
        case .fileGraphBold: return "\u{f535}"
        case .fileGraphFilled: return "\u{f536}"
        case .fileGraphLight: return "\u{f537}"
        case .fileGraphRegular: return "\u{f538}"
        case .fileImageBold: return "\u{f539}"
        case .fileImageFilled: return "\u{f53a}"
        case .fileImageLight: return "\u{f53b}"
        case .fileImageNoneBold: return "\u{f53c}"
        case .fileImageNoneLight: return "\u{f53d}"
        case .fileImageNoneRegular: return "\u{f53e}"
        case .fileImageRegular: return "\u{f53f}"
        case .fileJsBold: return "\u{f540}"
        case .fileJsFilled: return "\u{f541}"
        case .fileJsLight: return "\u{f542}"
        case .fileJsRegular: return "\u{f543}"
        case .fileKeynoteBold: return "\u{f544}"
        case .fileKeynoteFilled: return "\u{f545}"
        case .fileKeynoteLight: return "\u{f546}"
        case .fileKeynoteRegular: return "\u{f547}"
        case .fileLockedBold: return "\u{f548}"
        case .fileLockedFilled: return "\u{f549}"
        case .fileLockedLight: return "\u{f54a}"
        case .fileLockedRegular: return "\u{f54b}"
        case .fileMissingBold: return "\u{f54c}"
        case .fileMissingFilled: return "\u{f54d}"
        case .fileMissingLight: return "\u{f54e}"
        case .fileMissingRegular: return "\u{f54f}"
        case .fileMusicBold: return "\u{f550}"
        case .fileMusicFilled: return "\u{f551}"
        case .fileMusicLight: return "\u{f552}"
        case .fileMusicRegular: return "\u{f553}"
        case .fileOnenoteBold: return "\u{f554}"
        case .fileOnenoteFilled: return "\u{f555}"
        case .fileOnenoteLight: return "\u{f556}"
        case .fileOnenoteRegular: return "\u{f557}"
        case .filePdfBold: return "\u{f558}"
        case .filePdfFilled: return "\u{f559}"
        case .filePdfLight: return "\u{f55a}"
        case .filePdfRegular: return "\u{f55b}"
        case .filePowerpointBold: return "\u{f55c}"
        case .filePowerpointFilled: return "\u{f55d}"
        case .filePowerpointLight: return "\u{f55e}"
        case .filePowerpointRegular: return "\u{f55f}"
        case .fileSpreadsheetBold: return "\u{f560}"
        case .fileSpreadsheetFilled: return "\u{f561}"
        case .fileSpreadsheetLight: return "\u{f562}"
        case .fileSpreadsheetRegular: return "\u{f563}"
        case .fileTextBold: return "\u{f564}"
        case .fileTextFilled: return "\u{f565}"
        case .fileTextLight: return "\u{f566}"
        case .fileTextRegular: return "\u{f567}"
        case .fileThreeDBold: return "\u{f568}"
        case .fileThreeDFilled: return "\u{f569}"
        case .fileThreeDLight: return "\u{f56a}"
        case .fileThreeDRegular: return "\u{f56b}"
        case .fileVectorBold: return "\u{f56c}"
        case .fileVectorFilled: return "\u{f56d}"
        case .fileVectorLight: return "\u{f56e}"
        case .fileVectorRegular: return "\u{f56f}"
        case .fileVideoBold: return "\u{f570}"
        case .fileVideoFilled: return "\u{f571}"
        case .fileVideoLight: return "\u{f572}"
        case .fileVideoRegular: return "\u{f573}"
        case .fileWordBold: return "\u{f574}"
        case .fileWordFilled: return "\u{f575}"
        case .fileWordLight: return "\u{f576}"
        case .fileWordRegular: return "\u{f577}"
        case .fileXmlBold: return "\u{f578}"
        case .fileXmlFilled: return "\u{f579}"
        case .fileXmlLight: return "\u{f57a}"
        case .fileXmlRegular: return "\u{f57b}"
        case .fileZipBold: return "\u{f57c}"
        case .fileZipFilled: return "\u{f57d}"
        case .fileZipLight: return "\u{f57e}"
        case .fileZipRegular: return "\u{f57f}"
        case .filesBold: return "\u{f580}"
        case .filesFilled: return "\u{f581}"
        case .filesLight: return "\u{f582}"
        case .filesRegular: return "\u{f583}"
        case .fillColourBold: return "\u{f584}"
        case .fillColourFilled: return "\u{f585}"
        case .fillColourLight: return "\u{f586}"
        case .fillColourRegular: return "\u{f587}"
        case .filterBold: return "\u{f588}"
        case .filterCircleBold: return "\u{f589}"
        case .filterCircleFilled: return "\u{f58a}"
        case .filterCircleLight: return "\u{f58b}"
        case .filterCircleRegular: return "\u{f58c}"
        case .filterLight: return "\u{f58d}"
        case .filterRegular: return "\u{f58e}"
        case .fitToWidthBold: return "\u{f58f}"
        case .fitToWidthLight: return "\u{f590}"
        case .fitToWidthRegular: return "\u{f591}"
        case .fitToWindowExpandBold: return "\u{f592}"
        case .fitToWindowExpandLight: return "\u{f593}"
        case .fitToWindowExpandRegular: return "\u{f594}"
        case .fitToWindowShrinkBold: return "\u{f595}"
        case .fitToWindowShrinkLight: return "\u{f596}"
        case .fitToWindowShrinkRegular: return "\u{f597}"
        case .flagBold: return "\u{f598}"
        case .flagCircleBold: return "\u{f599}"
        case .flagCircleFilled: return "\u{f59a}"
        case .flagCircleLight: return "\u{f59b}"
        case .flagCircleRegular: return "\u{f59c}"
        case .flagFilled: return "\u{f59d}"
        case .flagLight: return "\u{f59e}"
        case .flagRegular: return "\u{f59f}"
        case .folderBold: return "\u{f5a0}"
        case .folderEditBold: return "\u{f5a1}"
        case .folderEditLight: return "\u{f5a2}"
        case .folderEditRegular: return "\u{f5a3}"
        case .folderLight: return "\u{f5a4}"
        case .folderLockBold: return "\u{f5a5}"
        case .folderLockLight: return "\u{f5a6}"
        case .folderLockRegular: return "\u{f5a7}"
        case .folderRegular: return "\u{f5a8}"
        case .folderViewBold: return "\u{f5a9}"
        case .folderViewLight: return "\u{f5aa}"
        case .folderViewRegular: return "\u{f5ab}"
        case .followUpBold: return "\u{f5ac}"
        case .followUpLight: return "\u{f5ad}"
        case .followUpRegular: return "\u{f5ae}"
        case .foodBold: return "\u{f5af}"
        case .foodFilled: return "\u{f5b0}"
        case .foodLight: return "\u{f5b1}"
        case .foodRegular: return "\u{f5b2}"
        case .formatBold: return "\u{f5b3}"
        case .formatDefaultAppBold: return "\u{f5b4}"
        case .formatDefaultAppFilled: return "\u{f5b5}"
        case .formatDefaultAppLight: return "\u{f5b6}"
        case .formatDefaultAppRegular: return "\u{f5b7}"
        case .formatLight: return "\u{f5b8}"
        case .formatPanelControlBarBold: return "\u{f5b9}"
        case .formatPanelControlBarLight: return "\u{f5ba}"
        case .formatPanelControlBarRegular: return "\u{f5bb}"
        case .formatPanelControlDownBold: return "\u{f5bc}"
        case .formatPanelControlDownLight: return "\u{f5bd}"
        case .formatPanelControlDownRegular: return "\u{f5be}"
        case .formatPanelControlLeftBold: return "\u{f5bf}"
        case .formatPanelControlLeftLight: return "\u{f5c0}"
        case .formatPanelControlLeftRegular: return "\u{f5c1}"
        case .formatPanelControlRightBold: return "\u{f5c2}"
        case .formatPanelControlRightLight: return "\u{f5c3}"
        case .formatPanelControlRightRegular: return "\u{f5c4}"
        case .formatPanelControlUpBold: return "\u{f5c5}"
        case .formatPanelControlUpDownBold: return "\u{f5c6}"
        case .formatPanelControlUpDownLight: return "\u{f5c7}"
        case .formatPanelControlUpDownRegular: return "\u{f5c8}"
        case .formatPanelControlUpLight: return "\u{f5c9}"
        case .formatPanelControlUpRegular: return "\u{f5ca}"
        case .formatRegular: return "\u{f5cb}"
        case .formatViewMixedBold: return "\u{f5cc}"
        case .formatViewMixedLight: return "\u{f5cd}"
        case .formatViewMixedRegular: return "\u{f5ce}"
        case .forwardMessageBold: return "\u{f5cf}"
        case .forwardMessageFilled: return "\u{f5d0}"
        case .forwardMessageLight: return "\u{f5d1}"
        case .forwardMessageRegular: return "\u{f5d2}"
        case .forwardTenSecBold: return "\u{f5d3}"
        case .forwardTenSecLight: return "\u{f5d4}"
        case .forwardTenSecRegular: return "\u{f5d5}"
        case .fourColumnBold: return "\u{f5d6}"
        case .fourColumnLight: return "\u{f5d7}"
        case .fourColumnRegular: return "\u{f5d8}"
        case .fourWayNavigationBold: return "\u{f5d9}"
        case .fourWayNavigationLight: return "\u{f5da}"
        case .fourWayNavigationRegular: return "\u{f5db}"
        case .frequencyCappingBold: return "\u{f5dc}"
        case .frequencyCappingLight: return "\u{f5dd}"
        case .frequencyCappingRegular: return "\u{f5de}"
        case .fulfillmentBold: return "\u{f5df}"
        case .fulfillmentLight: return "\u{f5e0}"
        case .fulfillmentRegular: return "\u{f5e1}"
        case .fullscreenBold: return "\u{f5e2}"
        case .fullscreenExitBold: return "\u{f5e3}"
        case .fullscreenExitLight: return "\u{f5e4}"
        case .fullscreenExitRegular: return "\u{f5e5}"
        case .fullscreenLight: return "\u{f5e6}"
        case .fullscreenRegular: return "\u{f5e7}"
        case .genericDeviceVideoBadgeFilled: return "\u{f5e8}"
        case .genericDeviceVideoBold: return "\u{f5e9}"
        case .genericDeviceVideoFilled: return "\u{f5ea}"
        case .genericDeviceVideoLight: return "\u{f5eb}"
        case .genericDeviceVideoRegular: return "\u{f5ec}"
        case .gifBold: return "\u{f5ed}"
        case .gifFilled: return "\u{f5ee}"
        case .gifHorizontalBold: return "\u{f5ef}"
        case .gifHorizontalFilled: return "\u{f5f0}"
        case .gifHorizontalLight: return "\u{f5f1}"
        case .gifHorizontalRegular: return "\u{f5f2}"
        case .gifLight: return "\u{f5f3}"
        case .gifRegular: return "\u{f5f4}"
        case .giftBold: return "\u{f5f5}"
        case .giftFilled: return "\u{f5f6}"
        case .giftLight: return "\u{f5f7}"
        case .giftRegular: return "\u{f5f8}"
        case .greenLeafBold: return "\u{f5f9}"
        case .greenLeafFilled: return "\u{f5fa}"
        case .greenLeafLight: return "\u{f5fb}"
        case .greenLeafRegular: return "\u{f5fc}"
        case .greenRoomBold: return "\u{f5fd}"
        case .greenRoomFilled: return "\u{f5fe}"
        case .greenRoomLight: return "\u{f5ff}"
        case .greenRoomRegular: return "\u{f600}"
        case .guestIssuerBold: return "\u{f601}"
        case .guestIssuerLight: return "\u{f602}"
        case .guestIssuerRegular: return "\u{f603}"
        case .guideBold: return "\u{f604}"
        case .guideLight: return "\u{f605}"
        case .guideRegular: return "\u{f606}"
        case .handPointerBold: return "\u{f607}"
        case .handPointerLight: return "\u{f608}"
        case .handPointerRegular: return "\u{f609}"
        case .handlerBold: return "\u{f60a}"
        case .handlerHorizontalBold: return "\u{f60b}"
        case .handlerHorizontalLight: return "\u{f60c}"
        case .handlerHorizontalRegular: return "\u{f60d}"
        case .handlerLight: return "\u{f60e}"
        case .handlerRegular: return "\u{f60f}"
        case .handsetAlertBold: return "\u{f610}"
        case .handsetAlertFilled: return "\u{f611}"
        case .handsetAlertLight: return "\u{f612}"
        case .handsetAlertRegular: return "\u{f613}"
        case .handsetBold: return "\u{f614}"
        case .handsetDownSlashBold: return "\u{f615}"
        case .handsetDownSlashFilled: return "\u{f616}"
        case .handsetDownSlashLight: return "\u{f617}"
        case .handsetDownSlashRegular: return "\u{f618}"
        case .handsetFilled: return "\u{f619}"
        case .handsetLight: return "\u{f61a}"
        case .handsetMutedBold: return "\u{f61b}"
        case .handsetMutedFilled: return "\u{f61c}"
        case .handsetMutedLight: return "\u{f61d}"
        case .handsetMutedRegular: return "\u{f61e}"
        case .handsetRegular: return "\u{f61f}"
        case .handsetsArrowLeftBold: return "\u{f620}"
        case .handsetsArrowLeftLight: return "\u{f621}"
        case .handsetsArrowLeftRegular: return "\u{f622}"
        case .handshakeBold: return "\u{f623}"
        case .handshakeLight: return "\u{f624}"
        case .handshakeRegular: return "\u{f625}"
        case .headingOneBold: return "\u{f626}"
        case .headingOneLight: return "\u{f627}"
        case .headingOneRegular: return "\u{f628}"
        case .headingThreeBold: return "\u{f629}"
        case .headingThreeLight: return "\u{f62a}"
        case .headingThreeRegular: return "\u{f62b}"
        case .headingTwoBold: return "\u{f62c}"
        case .headingTwoLight: return "\u{f62d}"
        case .headingTwoRegular: return "\u{f62e}"
        case .headphonesBold: return "\u{f62f}"
        case .headphonesFilled: return "\u{f630}"
        case .headphonesLight: return "\u{f631}"
        case .headphonesMutedBold: return "\u{f632}"
        case .headphonesMutedFilled: return "\u{f633}"
        case .headphonesMutedLight: return "\u{f634}"
        case .headphonesMutedRegular: return "\u{f635}"
        case .headphonesRegular: return "\u{f636}"
        case .headsetAlertBold: return "\u{f637}"
        case .headsetAlertLight: return "\u{f638}"
        case .headsetAlertRegular: return "\u{f639}"
        case .headsetArrowDownBold: return "\u{f63a}"
        case .headsetArrowDownFilled: return "\u{f63b}"
        case .headsetArrowDownLight: return "\u{f63c}"
        case .headsetArrowDownRegular: return "\u{f63d}"
        case .headsetBold: return "\u{f63e}"
        case .headsetFilled: return "\u{f63f}"
        case .headsetLight: return "\u{f640}"
        case .headsetMutedBold: return "\u{f641}"
        case .headsetMutedLight: return "\u{f642}"
        case .headsetMutedRegular: return "\u{f643}"
        case .headsetPrivateBold: return "\u{f644}"
        case .headsetPrivateLight: return "\u{f645}"
        case .headsetPrivateRegular: return "\u{f646}"
        case .headsetRegular: return "\u{f647}"
        case .hearingBold: return "\u{f648}"
        case .hearingImpairedBold: return "\u{f649}"
        case .hearingImpairedLight: return "\u{f64a}"
        case .hearingImpairedRegular: return "\u{f64b}"
        case .hearingLight: return "\u{f64c}"
        case .hearingRegular: return "\u{f64d}"
        case .helpBold: return "\u{f64e}"
        case .helpCircleBold: return "\u{f64f}"
        case .helpCircleFilled: return "\u{f650}"
        case .helpCircleLight: return "\u{f651}"
        case .helpCircleRegular: return "\u{f652}"
        case .helpLight: return "\u{f653}"
        case .helpRegular: return "\u{f654}"
        case .helpdeskBold: return "\u{f655}"
        case .helpdeskFilled: return "\u{f656}"
        case .helpdeskLight: return "\u{f657}"
        case .helpdeskRegular: return "\u{f658}"
        case .hideBold: return "\u{f659}"
        case .hideFilled: return "\u{f65a}"
        case .hideLight: return "\u{f65b}"
        case .hideRegular: return "\u{f65c}"
        case .homeBold: return "\u{f65d}"
        case .homeFilled: return "\u{f65e}"
        case .homeLight: return "\u{f65f}"
        case .homeRegular: return "\u{f660}"
        case .horizontalLineBold: return "\u{f661}"
        case .horizontalLineLight: return "\u{f662}"
        case .horizontalLineRegular: return "\u{f663}"
        case .hotelingBold: return "\u{f664}"
        case .hotelingFilled: return "\u{f665}"
        case .hotelingLight: return "\u{f666}"
        case .hotelingRegular: return "\u{f667}"
        case .humidityBold: return "\u{f668}"
        case .humidityLight: return "\u{f669}"
        case .humidityRegular: return "\u{f66a}"
        case .huntGroupBold: return "\u{f66b}"
        case .huntGroupFilled: return "\u{f66c}"
        case .huntGroupLight: return "\u{f66d}"
        case .huntGroupRegular: return "\u{f66e}"
        case .idleBold: return "\u{f66f}"
        case .idleFilled: return "\u{f670}"
        case .idleLight: return "\u{f671}"
        case .idleRegular: return "\u{f672}"
        case .immediateBold: return "\u{f673}"
        case .immediateFilled: return "\u{f674}"
        case .immediateLight: return "\u{f675}"
        case .immediateRegular: return "\u{f676}"
        case .importBold: return "\u{f677}"
        case .importLight: return "\u{f678}"
        case .importRegular: return "\u{f679}"
        case .inCommonBold: return "\u{f67a}"
        case .inCommonLight: return "\u{f67b}"
        case .inCommonRegular: return "\u{f67c}"
        case .inboxBold: return "\u{f67d}"
        case .inboxFilled: return "\u{f67e}"
        case .inboxLight: return "\u{f67f}"
        case .inboxRegular: return "\u{f680}"
        case .includeBold: return "\u{f681}"
        case .includeLight: return "\u{f682}"
        case .includeRegular: return "\u{f683}"
        case .incognitoBold: return "\u{f684}"
        case .incognitoFilled: return "\u{f685}"
        case .incognitoLight: return "\u{f686}"
        case .incognitoRegular: return "\u{f687}"
        case .incomingCallLegacyBold: return "\u{f688}"
        case .incomingCallLegacyFilled: return "\u{f689}"
        case .incomingCallLegacyLight: return "\u{f68a}"
        case .incomingCallLegacyRegular: return "\u{f68b}"
        case .indentDecreaseBold: return "\u{f68c}"
        case .indentDecreaseLight: return "\u{f68d}"
        case .indentDecreaseRegular: return "\u{f68e}"
        case .indentIncreaseBold: return "\u{f68f}"
        case .indentIncreaseLight: return "\u{f690}"
        case .indentIncreaseRegular: return "\u{f691}"
        case .infoBadgeFilled: return "\u{f692}"
        case .infoCircleBold: return "\u{f693}"
        case .infoCircleFilled: return "\u{f694}"
        case .infoCircleLight: return "\u{f695}"
        case .infoCircleRegular: return "\u{f696}"
        case .infoCircleTwoBold: return "\u{f697}"
        case .infoCircleTwoFilled: return "\u{f698}"
        case .infoCircleTwoLight: return "\u{f699}"
        case .infoCircleTwoRegular: return "\u{f69a}"
        case .inputBold: return "\u{f69b}"
        case .inputDisconnectedBold: return "\u{f69c}"
        case .inputDisconnectedLight: return "\u{f69d}"
        case .inputDisconnectedRegular: return "\u{f69e}"
        case .inputLight: return "\u{f69f}"
        case .inputRegular: return "\u{f6a0}"
        case .instantScheduleBold: return "\u{f6a1}"
        case .instantScheduleFilled: return "\u{f6a2}"
        case .instantScheduleLight: return "\u{f6a3}"
        case .instantScheduleRegular: return "\u{f6a4}"
        case .integrationsBold: return "\u{f6a5}"
        case .integrationsLight: return "\u{f6a6}"
        case .integrationsRegular: return "\u{f6a7}"
        case .intelligentRoutingBold: return "\u{f6a8}"
        case .intelligentRoutingLight: return "\u{f6a9}"
        case .intelligentRoutingRegular: return "\u{f6aa}"
        case .interactionBold: return "\u{f6ab}"
        case .interactionFilled: return "\u{f6ac}"
        case .interactionLight: return "\u{f6ad}"
        case .interactionRegular: return "\u{f6ae}"
        case .invitedUserBold: return "\u{f6af}"
        case .invitedUserLight: return "\u{f6b0}"
        case .invitedUserRegular: return "\u{f6b1}"
        case .italicBold: return "\u{f6b2}"
        case .italicFilled: return "\u{f6b3}"
        case .italicLight: return "\u{f6b4}"
        case .italicRegular: return "\u{f6b5}"
        case .joinAudioBold: return "\u{f6b6}"
        case .joinAudioFilled: return "\u{f6b7}"
        case .joinAudioLight: return "\u{f6b8}"
        case .joinAudioRegular: return "\u{f6b9}"
        case .keepInTouchBold: return "\u{f6ba}"
        case .keepInTouchFilled: return "\u{f6bb}"
        case .keepInTouchLight: return "\u{f6bc}"
        case .keepInTouchRegular: return "\u{f6bd}"
        case .keyboardBold: return "\u{f6be}"
        case .keyboardCloseBold: return "\u{f6bf}"
        case .keyboardCloseLight: return "\u{f6c0}"
        case .keyboardCloseRegular: return "\u{f6c1}"
        case .keyboardLight: return "\u{f6c2}"
        case .keyboardRegular: return "\u{f6c3}"
        case .languageBold: return "\u{f6c4}"
        case .languageFilled: return "\u{f6c5}"
        case .languageLight: return "\u{f6c6}"
        case .languageRegular: return "\u{f6c7}"
        case .laptopBold: return "\u{f6c8}"
        case .laptopDisconnectedBold: return "\u{f6c9}"
        case .laptopDisconnectedLight: return "\u{f6ca}"
        case .laptopDisconnectedRegular: return "\u{f6cb}"
        case .laptopFilled: return "\u{f6cc}"
        case .laptopLight: return "\u{f6cd}"
        case .laptopRegular: return "\u{f6ce}"
        case .laserPointerBold: return "\u{f6cf}"
        case .laserPointerCursorBlackLight: return "\u{f6d0}"
        case .laserPointerCursorBlueLight: return "\u{f6d1}"
        case .laserPointerCursorGreenLight: return "\u{f6d2}"
        case .laserPointerCursorPurpleLight: return "\u{f6d3}"
        case .laserPointerCursorRedLight: return "\u{f6d4}"
        case .laserPointerCursorWhiteLight: return "\u{f6d5}"
        case .laserPointerCursorYellowLight: return "\u{f6d6}"
        case .laserPointerFilled: return "\u{f6d7}"
        case .laserPointerLight: return "\u{f6d8}"
        case .laserPointerRegular: return "\u{f6d9}"
        case .launchBold: return "\u{f6da}"
        case .launchLight: return "\u{f6db}"
        case .launchRegular: return "\u{f6dc}"
        case .layoutSideBySideVerticalBold: return "\u{f6dd}"
        case .layoutSideBySideVerticalFilled: return "\u{f6de}"
        case .layoutSideBySideVerticalLight: return "\u{f6df}"
        case .layoutSideBySideVerticalRegular: return "\u{f6e0}"
        case .leaveBreakoutSessionBold: return "\u{f6e1}"
        case .leaveBreakoutSessionLight: return "\u{f6e2}"
        case .leaveBreakoutSessionRegular: return "\u{f6e3}"
        case .leaveDeviceBold: return "\u{f6e4}"
        case .leaveDeviceLight: return "\u{f6e5}"
        case .leaveDeviceRegular: return "\u{f6e6}"
        case .likeBold: return "\u{f6e7}"
        case .likeFilled: return "\u{f6e8}"
        case .likeLight: return "\u{f6e9}"
        case .likeRegular: return "\u{f6ea}"
        case .linkBold: return "\u{f6eb}"
        case .linkLight: return "\u{f6ec}"
        case .linkRegular: return "\u{f6ed}"
        case .listBulletedBold: return "\u{f6ee}"
        case .listBulletedLight: return "\u{f6ef}"
        case .listBulletedRegular: return "\u{f6f0}"
        case .listMenuBold: return "\u{f6f1}"
        case .listMenuLight: return "\u{f6f2}"
        case .listMenuRegular: return "\u{f6f3}"
        case .listNumberedBold: return "\u{f6f4}"
        case .listNumberedLight: return "\u{f6f5}"
        case .listNumberedRegular: return "\u{f6f6}"
        case .liveBold: return "\u{f6f7}"
        case .liveFilled: return "\u{f6f8}"
        case .liveLight: return "\u{f6f9}"
        case .liveRegular: return "\u{f6fa}"
        case .locationBold: return "\u{f6fb}"
        case .locationFilled: return "\u{f6fc}"
        case .locationLight: return "\u{f6fd}"
        case .locationRegular: return "\u{f6fe}"
        case .longTextBoxBold: return "\u{f6ff}"
        case .longTextBoxLight: return "\u{f700}"
        case .longTextBoxRegular: return "\u{f701}"
        case .lowerHandBold: return "\u{f702}"
        case .lowerHandLight: return "\u{f703}"
        case .lowerHandRegular: return "\u{f704}"
        case .magicPenBold: return "\u{f705}"
        case .magicPenFilled: return "\u{f706}"
        case .magicPenLight: return "\u{f707}"
        case .magicPenRegular: return "\u{f708}"
        case .markAsUnreadBold: return "\u{f709}"
        case .markAsUnreadLight: return "\u{f70a}"
        case .markAsUnreadRegular: return "\u{f70b}"
        case .markdownBold: return "\u{f70c}"
        case .markdownFilled: return "\u{f70d}"
        case .markdownLight: return "\u{f70e}"
        case .markdownRegular: return "\u{f70f}"
        case .markerBold: return "\u{f710}"
        case .markerFilled: return "\u{f711}"
        case .markerLight: return "\u{f712}"
        case .markerRegular: return "\u{f713}"
        case .maximizeBold: return "\u{f714}"
        case .maximizeLight: return "\u{f715}"
        case .maximizeRegular: return "\u{f716}"
        case .mediaPlayerBold: return "\u{f717}"
        case .mediaPlayerLight: return "\u{f718}"
        case .mediaPlayerRegular: return "\u{f719}"
        case .mediaQualityGoodBold: return "\u{f71a}"
        case .mediaQualityGoodFilled: return "\u{f71b}"
        case .mediaQualityGoodLight: return "\u{f71c}"
        case .mediaQualityGoodRegular: return "\u{f71d}"
        case .mediaQualityPoorBold: return "\u{f71e}"
        case .mediaQualityPoorFilled: return "\u{f71f}"
        case .mediaQualityPoorLight: return "\u{f720}"
        case .mediaQualityPoorRegular: return "\u{f721}"
        case .mediaQualityUnstableBold: return "\u{f722}"
        case .mediaQualityUnstableFilled: return "\u{f723}"
        case .mediaQualityUnstableLight: return "\u{f724}"
        case .mediaQualityUnstableRegular: return "\u{f725}"
        case .meetBold: return "\u{f726}"
        case .meetEndBold: return "\u{f727}"
        case .meetEndLight: return "\u{f728}"
        case .meetEndRegular: return "\u{f729}"
        case .meetFilled: return "\u{f72a}"
        case .meetLight: return "\u{f72b}"
        case .meetRegular: return "\u{f72c}"
        case .meetingSummaryBold: return "\u{f72d}"
        case .meetingSummaryFilled: return "\u{f72e}"
        case .meetingSummaryLight: return "\u{f72f}"
        case .meetingSummaryRegular: return "\u{f730}"
        case .meetingsBold: return "\u{f731}"
        case .meetingsFilled: return "\u{f732}"
        case .meetingsFocusMonthBold: return "\u{f733}"
        case .meetingsFocusMonthLight: return "\u{f734}"
        case .meetingsFocusMonthRegular: return "\u{f735}"
        case .meetingsFocusOneDayBold: return "\u{f736}"
        case .meetingsFocusOneDayLight: return "\u{f737}"
        case .meetingsFocusOneDayRegular: return "\u{f738}"
        case .meetingsFocusThreeDayBold: return "\u{f739}"
        case .meetingsFocusThreeDayLight: return "\u{f73a}"
        case .meetingsFocusThreeDayRegular: return "\u{f73b}"
        case .meetingsFocusUpcomingBold: return "\u{f73c}"
        case .meetingsFocusUpcomingLight: return "\u{f73d}"
        case .meetingsFocusUpcomingRegular: return "\u{f73e}"
        case .meetingsLight: return "\u{f73f}"
        case .meetingsPresenceBadgeFilled: return "\u{f740}"
        case .meetingsPresenceBold: return "\u{f741}"
        case .meetingsPresenceFilled: return "\u{f742}"
        case .meetingsPresenceLight: return "\u{f743}"
        case .meetingsPresenceRegular: return "\u{f744}"
        case .meetingsRegular: return "\u{f745}"
        case .meetingsTeamBold: return "\u{f746}"
        case .meetingsTeamFilled: return "\u{f747}"
        case .meetingsTeamLight: return "\u{f748}"
        case .meetingsTeamNewBold: return "\u{f749}"
        case .meetingsTeamNewLight: return "\u{f74a}"
        case .meetingsTeamNewRegular: return "\u{f74b}"
        case .meetingsTeamRegular: return "\u{f74c}"
        case .mentionBold: return "\u{f74d}"
        case .mentionLight: return "\u{f74e}"
        case .mentionRegular: return "\u{f74f}"
        case .messageQueingBold: return "\u{f750}"
        case .messageQueingLight: return "\u{f751}"
        case .messageQueingRegular: return "\u{f752}"
        case .microphoneBold: return "\u{f753}"
        case .microphoneFilled: return "\u{f754}"
        case .microphoneHardMutedBold: return "\u{f755}"
        case .microphoneHardMutedCircleFilled: return "\u{f756}"
        case .microphoneHardMutedLight: return "\u{f757}"
        case .microphoneHardMutedRegular: return "\u{f758}"
        case .microphoneLight: return "\u{f759}"
        case .microphoneMusicModeBold: return "\u{f75a}"
        case .microphoneMusicModeLight: return "\u{f75b}"
        case .microphoneMusicModeOnBold: return "\u{f75c}"
        case .microphoneMusicModeOnLight: return "\u{f75d}"
        case .microphoneMusicModeOnRegular: return "\u{f75e}"
        case .microphoneMusicModeRegular: return "\u{f75f}"
        case .microphoneMutedBold: return "\u{f760}"
        case .microphoneMutedCircleFilled: return "\u{f761}"
        case .microphoneMutedFilled: return "\u{f762}"
        case .microphoneMutedLight: return "\u{f763}"
        case .microphoneMutedRegular: return "\u{f764}"
        case .microphoneOnBold: return "\u{f765}"
        case .microphoneOnLight: return "\u{f766}"
        case .microphoneOnRegular: return "\u{f767}"
        case .microphoneOptAllBold: return "\u{f768}"
        case .microphoneOptAllLight: return "\u{f769}"
        case .microphoneOptAllMutedBold: return "\u{f76a}"
        case .microphoneOptAllMutedLight: return "\u{f76b}"
        case .microphoneOptAllMutedRegular: return "\u{f76c}"
        case .microphoneOptAllOnBold: return "\u{f76d}"
        case .microphoneOptAllOnLight: return "\u{f76e}"
        case .microphoneOptAllOnRegular: return "\u{f76f}"
        case .microphoneOptAllRegular: return "\u{f770}"
        case .microphoneOptMeBold: return "\u{f771}"
        case .microphoneOptMeLight: return "\u{f772}"
        case .microphoneOptMeMutedBold: return "\u{f773}"
        case .microphoneOptMeMutedLight: return "\u{f774}"
        case .microphoneOptMeMutedRegular: return "\u{f775}"
        case .microphoneOptMeOnBold: return "\u{f776}"
        case .microphoneOptMeOnLight: return "\u{f777}"
        case .microphoneOptMeOnRegular: return "\u{f778}"
        case .microphoneOptMeRegular: return "\u{f779}"
        case .microphoneRegular: return "\u{f77a}"
        case .mindMapBold: return "\u{f77b}"
        case .mindMapLight: return "\u{f77c}"
        case .mindMapRegular: return "\u{f77d}"
        case .minimizeBold: return "\u{f77e}"
        case .minimizeLight: return "\u{f77f}"
        case .minimizeRegular: return "\u{f780}"
        case .minusBold: return "\u{f781}"
        case .minusLight: return "\u{f782}"
        case .minusRegular: return "\u{f783}"
        case .mirrorBold: return "\u{f784}"
        case .mirrorFilled: return "\u{f785}"
        case .mirrorLight: return "\u{f786}"
        case .mirrorRegular: return "\u{f787}"
        case .mmsFilled: return "\u{f788}"
        case .moderatorBold: return "\u{f789}"
        case .moderatorLight: return "\u{f78a}"
        case .moderatorRegular: return "\u{f78b}"
        case .monitoringBold: return "\u{f78c}"
        case .monitoringLight: return "\u{f78d}"
        case .monitoringRegular: return "\u{f78e}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f78f}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f790}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f791}"
        case .moreAdrBold: return "\u{f792}"
        case .moreAdrLight: return "\u{f793}"
        case .moreAdrRegular: return "\u{f794}"
        case .moreBold: return "\u{f795}"
        case .moreCircleBold: return "\u{f796}"
        case .moreCircleFilled: return "\u{f797}"
        case .moreCircleLight: return "\u{f798}"
        case .moreCircleRegular: return "\u{f799}"
        case .moreLight: return "\u{f79a}"
        case .moreRegular: return "\u{f79b}"
        case .mouseCursorBold: return "\u{f79c}"
        case .mouseCursorLight: return "\u{f79d}"
        case .mouseCursorRegular: return "\u{f79e}"
        case .moveCallInAdrBold: return "\u{f79f}"
        case .moveCallInAdrLight: return "\u{f7a0}"
        case .moveCallInAdrRegular: return "\u{f7a1}"
        case .moveCallInIphBold: return "\u{f7a2}"
        case .moveCallInIphLight: return "\u{f7a3}"
        case .moveCallInIphRegular: return "\u{f7a4}"
        case .moveCallInLaptopBold: return "\u{f7a5}"
        case .moveCallInLaptopLight: return "\u{f7a6}"
        case .moveCallInLaptopRegular: return "\u{f7a7}"
        case .moveCallInOutAdrBold: return "\u{f7a8}"
        case .moveCallInOutAdrLight: return "\u{f7a9}"
        case .moveCallInOutAdrRegular: return "\u{f7aa}"
        case .moveCallInOutIphBold: return "\u{f7ab}"
        case .moveCallInOutIphLight: return "\u{f7ac}"
        case .moveCallInOutIphRegular: return "\u{f7ad}"
        case .moveCallInTabletBold: return "\u{f7ae}"
        case .moveCallInTabletLight: return "\u{f7af}"
        case .moveCallInTabletRegular: return "\u{f7b0}"
        case .moveCallOutAdrBold: return "\u{f7b1}"
        case .moveCallOutAdrLight: return "\u{f7b2}"
        case .moveCallOutAdrRegular: return "\u{f7b3}"
        case .moveCallOutIphBold: return "\u{f7b4}"
        case .moveCallOutIphLight: return "\u{f7b5}"
        case .moveCallOutIphRegular: return "\u{f7b6}"
        case .moveCallOutLaptopBold: return "\u{f7b7}"
        case .moveCallOutLaptopLight: return "\u{f7b8}"
        case .moveCallOutLaptopRegular: return "\u{f7b9}"
        case .moveCallOutTabletBold: return "\u{f7ba}"
        case .moveCallOutTabletLight: return "\u{f7bb}"
        case .moveCallOutTabletRegular: return "\u{f7bc}"
        case .moveToScreenBold: return "\u{f7bd}"
        case .moveToScreenLight: return "\u{f7be}"
        case .moveToScreenRegular: return "\u{f7bf}"
        case .multilineChartBold: return "\u{f7c0}"
        case .multilineChartFilled: return "\u{f7c1}"
        case .multilineChartLight: return "\u{f7c2}"
        case .multilineChartRegular: return "\u{f7c3}"
        case .multimediaBold: return "\u{f7c4}"
        case .multimediaFilled: return "\u{f7c5}"
        case .multimediaLight: return "\u{f7c6}"
        case .multimediaRegular: return "\u{f7c7}"
        case .multipledDevicesBold: return "\u{f7c8}"
        case .multipledDevicesLight: return "\u{f7c9}"
        case .multipledDevicesRegular: return "\u{f7ca}"
        case .musicModeCircleBold: return "\u{f7cb}"
        case .musicModeCircleFilled: return "\u{f7cc}"
        case .musicModeCircleLight: return "\u{f7cd}"
        case .musicModeCircleRegular: return "\u{f7ce}"
        case .musicNoteBold: return "\u{f7cf}"
        case .musicNoteFilled: return "\u{f7d0}"
        case .musicNoteLight: return "\u{f7d1}"
        case .musicNoteRegular: return "\u{f7d2}"
        case .muteOnEntryBold: return "\u{f7d3}"
        case .muteOnEntryFilled: return "\u{f7d4}"
        case .muteOnEntryLight: return "\u{f7d5}"
        case .muteOnEntryRegular: return "\u{f7d6}"
        case .newManagerBold: return "\u{f7d7}"
        case .newManagerLight: return "\u{f7d8}"
        case .newManagerRegular: return "\u{f7d9}"
        case .newTitleBold: return "\u{f7da}"
        case .newTitleLight: return "\u{f7db}"
        case .newTitleRegular: return "\u{f7dc}"
        case .newVoicemailBold: return "\u{f7dd}"
        case .newVoicemailLight: return "\u{f7de}"
        case .newVoicemailRegular: return "\u{f7df}"
        case .newWhiteboardBold: return "\u{f7e0}"
        case .newWhiteboardLight: return "\u{f7e1}"
        case .newWhiteboardRegular: return "\u{f7e2}"
        case .nextBold: return "\u{f7e3}"
        case .nextLight: return "\u{f7e4}"
        case .nextRegular: return "\u{f7e5}"
        case .noDevicesBold: return "\u{f7e6}"
        case .noDevicesLight: return "\u{f7e7}"
        case .noDevicesRegular: return "\u{f7e8}"
        case .noiseDetectedCanceledFilled: return "\u{f7e9}"
        case .noiseDetectedFilled: return "\u{f7ea}"
        case .noiseNoneCanceledFilled: return "\u{f7eb}"
        case .noiseNoneFilled: return "\u{f7ec}"
        case .noiseRemovalBold: return "\u{f7ed}"
        case .noiseRemovalLight: return "\u{f7ee}"
        case .noiseRemovalRegular: return "\u{f7ef}"
        case .noteBold: return "\u{f7f0}"
        case .noteLight: return "\u{f7f1}"
        case .notePptBold: return "\u{f7f2}"
        case .notePptLight: return "\u{f7f3}"
        case .notePptRegular: return "\u{f7f4}"
        case .noteRegular: return "\u{f7f5}"
        case .notesBold: return "\u{f7f6}"
        case .notesFilled: return "\u{f7f7}"
        case .notesLight: return "\u{f7f8}"
        case .notesRegular: return "\u{f7f9}"
        case .numberBold: return "\u{f7fa}"
        case .numberLight: return "\u{f7fb}"
        case .numberRegular: return "\u{f7fc}"
        case .oldRemoteBold: return "\u{f7fd}"
        case .oldRemoteLight: return "\u{f7fe}"
        case .oldRemoteRegular: return "\u{f7ff}"
        case .oldTouchBold: return "\u{f800}"
        case .oldTouchLight: return "\u{f801}"
        case .oldTouchRegular: return "\u{f802}"
        case .oneColumnBold: return "\u{f803}"
        case .oneColumnLight: return "\u{f804}"
        case .oneColumnRegular: return "\u{f805}"
        case .oneTimeBold: return "\u{f806}"
        case .oneTimeLight: return "\u{f807}"
        case .oneTimeRegular: return "\u{f808}"
        case .openInFolderBold: return "\u{f809}"
        case .openInFolderLight: return "\u{f80a}"
        case .openInFolderRegular: return "\u{f80b}"
        case .openPagesBold: return "\u{f80c}"
        case .openPagesLight: return "\u{f80d}"
        case .openPagesRegular: return "\u{f80e}"
        case .otherNumberBold: return "\u{f80f}"
        case .otherNumberFilled: return "\u{f810}"
        case .otherNumberLight: return "\u{f811}"
        case .otherNumberRegular: return "\u{f812}"
        case .otherNumberWarningBold: return "\u{f813}"
        case .otherNumberWarningLight: return "\u{f814}"
        case .otherNumberWarningRegular: return "\u{f815}"
        case .outgoingCallLegacyBold: return "\u{f816}"
        case .outgoingCallLegacyFilled: return "\u{f817}"
        case .outgoingCallLegacyLight: return "\u{f818}"
        case .outgoingCallLegacyRegular: return "\u{f819}"
        case .overflowLeftBold: return "\u{f81a}"
        case .overflowLeftLight: return "\u{f81b}"
        case .overflowLeftRegular: return "\u{f81c}"
        case .overflowRightBold: return "\u{f81d}"
        case .overflowRightLight: return "\u{f81e}"
        case .overflowRightRegular: return "\u{f81f}"
        case .pairedCameraBold: return "\u{f820}"
        case .pairedCameraLight: return "\u{f821}"
        case .pairedCameraRegular: return "\u{f822}"
        case .pairedDeviceBold: return "\u{f823}"
        case .pairedDeviceLight: return "\u{f824}"
        case .pairedDeviceRegular: return "\u{f825}"
        case .pairedHandsetBold: return "\u{f826}"
        case .pairedHandsetLight: return "\u{f827}"
        case .pairedHandsetRegular: return "\u{f828}"
        case .pairingBold: return "\u{f829}"
        case .pairingLight: return "\u{f82a}"
        case .pairingRegular: return "\u{f82b}"
        case .parkedBold: return "\u{f82c}"
        case .parkedFilled: return "\u{f82d}"
        case .parkedLight: return "\u{f82e}"
        case .parkedRegular: return "\u{f82f}"
        case .parseBold: return "\u{f830}"
        case .parseLight: return "\u{f831}"
        case .parseRegular: return "\u{f832}"
        case .partialBold: return "\u{f833}"
        case .partialLight: return "\u{f834}"
        case .partialRegular: return "\u{f835}"
        case .participantAddBold: return "\u{f836}"
        case .participantAddLight: return "\u{f837}"
        case .participantAddRegular: return "\u{f838}"
        case .participantBlockedBold: return "\u{f839}"
        case .participantBlockedLight: return "\u{f83a}"
        case .participantBlockedRegular: return "\u{f83b}"
        case .participantBold: return "\u{f83c}"
        case .participantFilled: return "\u{f83d}"
        case .participantLight: return "\u{f83e}"
        case .participantListBold: return "\u{f83f}"
        case .participantListFilled: return "\u{f840}"
        case .participantListLight: return "\u{f841}"
        case .participantListRegular: return "\u{f842}"
        case .participantRegular: return "\u{f843}"
        case .participantRemoveBold: return "\u{f844}"
        case .participantRemoveLight: return "\u{f845}"
        case .participantRemoveRegular: return "\u{f846}"
        case .participantUnknownBold: return "\u{f847}"
        case .participantUnknownLight: return "\u{f848}"
        case .participantUnknownRegular: return "\u{f849}"
        case .passMouseBold: return "\u{f84a}"
        case .passMouseLight: return "\u{f84b}"
        case .passMouseRegular: return "\u{f84c}"
        case .pauseBadgeFilled: return "\u{f84d}"
        case .pauseBold: return "\u{f84e}"
        case .pauseFilled: return "\u{f84f}"
        case .pauseLight: return "\u{f850}"
        case .pauseRegular: return "\u{f851}"
        case .peopleAddBold: return "\u{f852}"
        case .peopleAddFilled: return "\u{f853}"
        case .peopleAddLight: return "\u{f854}"
        case .peopleAddRegular: return "\u{f855}"
        case .peopleBold: return "\u{f856}"
        case .peopleCircleBold: return "\u{f857}"
        case .peopleCircleFilled: return "\u{f858}"
        case .peopleCircleLight: return "\u{f859}"
        case .peopleCircleRegular: return "\u{f85a}"
        case .peopleFilled: return "\u{f85b}"
        case .peopleInsightsBold: return "\u{f85c}"
        case .peopleInsightsFilled: return "\u{f85d}"
        case .peopleInsightsLight: return "\u{f85e}"
        case .peopleInsightsRegular: return "\u{f85f}"
        case .peopleLight: return "\u{f860}"
        case .peopleRegular: return "\u{f861}"
        case .phoneAlertBold: return "\u{f862}"
        case .phoneAlertLight: return "\u{f863}"
        case .phoneAlertRegular: return "\u{f864}"
        case .phoneBadgeFilled: return "\u{f865}"
        case .phoneBold: return "\u{f866}"
        case .phoneFilled: return "\u{f867}"
        case .phoneLight: return "\u{f868}"
        case .phoneMutedBold: return "\u{f869}"
        case .phoneMutedLight: return "\u{f86a}"
        case .phoneMutedRegular: return "\u{f86b}"
        case .phonePrivateBold: return "\u{f86c}"
        case .phonePrivateLight: return "\u{f86d}"
        case .phonePrivateRegular: return "\u{f86e}"
        case .phoneRegular: return "\u{f86f}"
        case .phoneReplyAllBold: return "\u{f870}"
        case .phoneReplyAllLight: return "\u{f871}"
        case .phoneReplyAllRegular: return "\u{f872}"
        case .phoneReplyBold: return "\u{f873}"
        case .phoneReplyLight: return "\u{f874}"
        case .phoneReplyRegular: return "\u{f875}"
        case .pickerBold: return "\u{f876}"
        case .pickerLight: return "\u{f877}"
        case .pickerRegular: return "\u{f878}"
        case .pieChartBold: return "\u{f879}"
        case .pieChartFilled: return "\u{f87a}"
        case .pieChartLight: return "\u{f87b}"
        case .pieChartRegular: return "\u{f87c}"
        case .pinBold: return "\u{f87d}"
        case .pinFilled: return "\u{f87e}"
        case .pinLight: return "\u{f87f}"
        case .pinListActivityBold: return "\u{f880}"
        case .pinListActivityLight: return "\u{f881}"
        case .pinListActivityRegular: return "\u{f882}"
        case .pinListBold: return "\u{f883}"
        case .pinListLight: return "\u{f884}"
        case .pinListRegular: return "\u{f885}"
        case .pinMutedBold: return "\u{f886}"
        case .pinMutedFilled: return "\u{f887}"
        case .pinMutedLight: return "\u{f888}"
        case .pinMutedRegular: return "\u{f889}"
        case .pinRegular: return "\u{f88a}"
        case .pipBold: return "\u{f88b}"
        case .pipEnterBold: return "\u{f88c}"
        case .pipEnterLight: return "\u{f88d}"
        case .pipEnterRegular: return "\u{f88e}"
        case .pipExitBold: return "\u{f88f}"
        case .pipExitLight: return "\u{f890}"
        case .pipExitRegular: return "\u{f891}"
        case .pipFilled: return "\u{f892}"
        case .pipLight: return "\u{f893}"
        case .pipRegular: return "\u{f894}"
        case .placeholderBold: return "\u{f895}"
        case .placeholderFilled: return "\u{f896}"
        case .placeholderLight: return "\u{f897}"
        case .placeholderRegular: return "\u{f898}"
        case .playBold: return "\u{f899}"
        case .playCircleBold: return "\u{f89a}"
        case .playCircleFilled: return "\u{f89b}"
        case .playCircleLight: return "\u{f89c}"
        case .playCircleRegular: return "\u{f89d}"
        case .playFilled: return "\u{f89e}"
        case .playLight: return "\u{f89f}"
        case .playRegular: return "\u{f8a0}"
        case .plugAcBold: return "\u{f8a1}"
        case .plugAcLight: return "\u{f8a2}"
        case .plugAcRegular: return "\u{f8a3}"
        case .plusBold: return "\u{f8a4}"
        case .plusCircleBold: return "\u{f8a5}"
        case .plusCircleFilled: return "\u{f8a6}"
        case .plusCircleLight: return "\u{f8a7}"
        case .plusCircleRegular: return "\u{f8a8}"
        case .plusLight: return "\u{f8a9}"
        case .plusRegular: return "\u{f8aa}"
        case .pmrBold: return "\u{f8ab}"
        case .pmrFilled: return "\u{f8ac}"
        case .pmrLight: return "\u{f8ad}"
        case .pmrRegular: return "\u{f8ae}"
        case .pollBold: return "\u{f8af}"
        case .pollFilled: return "\u{f8b0}"
        case .pollLight: return "\u{f8b1}"
        case .pollRegular: return "\u{f8b2}"
        case .popInBold: return "\u{f8b3}"
        case .popInLight: return "\u{f8b4}"
        case .popInRegular: return "\u{f8b5}"
        case .popOutBold: return "\u{f8b6}"
        case .popOutLight: return "\u{f8b7}"
        case .popOutRegular: return "\u{f8b8}"
        case .popUpBold: return "\u{f8b9}"
        case .popUpLight: return "\u{f8ba}"
        case .popUpRegular: return "\u{f8bb}"
        case .portraitLandscapeBold: return "\u{f8bc}"
        case .portraitLandscapeLight: return "\u{f8bd}"
        case .portraitLandscapeRegular: return "\u{f8be}"
        case .potentialFraudBold: return "\u{f8bf}"
        case .potentialFraudFilled: return "\u{f8c0}"
        case .potentialFraudLight: return "\u{f8c1}"
        case .potentialFraudRegular: return "\u{f8c2}"
        case .powerAcBold: return "\u{f8c3}"
        case .powerAcLight: return "\u{f8c4}"
        case .powerAcRegular: return "\u{f8c5}"
        case .powerBold: return "\u{f8c6}"
        case .powerLight: return "\u{f8c7}"
        case .powerRegular: return "\u{f8c8}"
        case .preHeaderBold: return "\u{f8c9}"
        case .preHeaderLight: return "\u{f8ca}"
        case .preHeaderRegular: return "\u{f8cb}"
        case .premiumBold: return "\u{f8cc}"
        case .premiumLight: return "\u{f8cd}"
        case .premiumRegular: return "\u{f8ce}"
        case .presentationBold: return "\u{f8cf}"
        case .presentationLight: return "\u{f8d0}"
        case .presentationRegular: return "\u{f8d1}"
        case .preventDownloadBold: return "\u{f8d2}"
        case .preventDownloadFilled: return "\u{f8d3}"
        case .preventDownloadLight: return "\u{f8d4}"
        case .preventDownloadRegular: return "\u{f8d5}"
        case .primaryParticipantBold: return "\u{f8d6}"
        case .primaryParticipantLight: return "\u{f8d7}"
        case .primaryParticipantRegular: return "\u{f8d8}"
        case .printBold: return "\u{f8d9}"
        case .printLight: return "\u{f8da}"
        case .printRegular: return "\u{f8db}"
        case .priorityBadgeFilled: return "\u{f8dc}"
        case .priorityCircleBold: return "\u{f8dd}"
        case .priorityCircleFilled: return "\u{f8de}"
        case .priorityCircleLight: return "\u{f8df}"
        case .priorityCircleRegular: return "\u{f8e0}"
        case .priorityCircleTwoBold: return "\u{f8e1}"
        case .priorityCircleTwoFilled: return "\u{f8e2}"
        case .priorityCircleTwoLight: return "\u{f8e3}"
        case .priorityCircleTwoRegular: return "\u{f8e4}"
        case .priorityWaveBold: return "\u{f8e5}"
        case .priorityWaveLight: return "\u{f8e6}"
        case .priorityWaveRegular: return "\u{f8e7}"
        case .privacyCircleBold: return "\u{f8e8}"
        case .privacyCircleFilled: return "\u{f8e9}"
        case .privacyCircleLight: return "\u{f8ea}"
        case .privacyCircleRegular: return "\u{f8eb}"
        case .privateBold: return "\u{f8ec}"
        case .privateCircleBold: return "\u{f8ed}"
        case .privateCircleFilled: return "\u{f8ee}"
        case .privateCircleLight: return "\u{f8ef}"
        case .privateCircleRegular: return "\u{f8f0}"
        case .privateLight: return "\u{f8f1}"
        case .privateMeetingBold: return "\u{f8f2}"
        case .privateMeetingLight: return "\u{f8f3}"
        case .privateMeetingRegular: return "\u{f8f4}"
        case .privateRegular: return "\u{f8f5}"
        case .productDemoBold: return "\u{f8f6}"
        case .productDemoLight: return "\u{f8f7}"
        case .productDemoRegular: return "\u{f8f8}"
        case .proximityBold: return "\u{f8f9}"
        case .proximityLight: return "\u{f8fa}"
        case .proximityMutedBold: return "\u{f8fb}"
        case .proximityMutedLight: return "\u{f8fc}"
        case .proximityMutedRegular: return "\u{f8fd}"
        case .proximityRegular: return "\u{f8fe}"
        case .proximityVideoBold: return "\u{f8ff}"
        case .proximityVideoLight: return "\u{f900}"
        case .proximityVideoRegular: return "\u{f901}"
        case .ptoPresenceBold: return "\u{f902}"
        case .ptoPresenceFilled: return "\u{f903}"
        case .ptoPresenceLight: return "\u{f904}"
        case .ptoPresenceRegular: return "\u{f905}"
        case .pullCallBold: return "\u{f906}"
        case .pullCallFilled: return "\u{f907}"
        case .pullCallLight: return "\u{f908}"
        case .pullCallRegular: return "\u{f909}"
        case .qABold: return "\u{f90a}"
        case .qALight: return "\u{f90b}"
        case .qARegular: return "\u{f90c}"
        case .qrCodeBold: return "\u{f90d}"
        case .qrCodeLight: return "\u{f90e}"
        case .qrCodeRegular: return "\u{f90f}"
        case .qrCodeScanBold: return "\u{f910}"
        case .qrCodeScanLight: return "\u{f911}"
        case .qrCodeScanRegular: return "\u{f912}"
        case .qualityBold: return "\u{f913}"
        case .qualityLight: return "\u{f914}"
        case .qualityRegular: return "\u{f915}"
        case .queueContactBold: return "\u{f916}"
        case .queueContactFilled: return "\u{f917}"
        case .queueContactLight: return "\u{f918}"
        case .queueContactRegular: return "\u{f919}"
        case .quietBold: return "\u{f91a}"
        case .quietHoursPresenceBold: return "\u{f91b}"
        case .quietHoursPresenceFilled: return "\u{f91c}"
        case .quietHoursPresenceLight: return "\u{f91d}"
        case .quietHoursPresenceRegular: return "\u{f91e}"
        case .quietLight: return "\u{f91f}"
        case .quietRegular: return "\u{f920}"
        case .radioButtonGroupBold: return "\u{f921}"
        case .radioButtonGroupLight: return "\u{f922}"
        case .radioButtonGroupRegular: return "\u{f923}"
        case .raiseHandBold: return "\u{f924}"
        case .raiseHandCircleFilled: return "\u{f925}"
        case .raiseHandFilled: return "\u{f926}"
        case .raiseHandLight: return "\u{f927}"
        case .raiseHandRegular: return "\u{f928}"
        case .ramBold: return "\u{f929}"
        case .ramLight: return "\u{f92a}"
        case .ramRegular: return "\u{f92b}"
        case .reactionsBold: return "\u{f92c}"
        case .reactionsFilled: return "\u{f92d}"
        case .reactionsLight: return "\u{f92e}"
        case .reactionsRegular: return "\u{f92f}"
        case .reactivateBold: return "\u{f930}"
        case .reactivateLight: return "\u{f931}"
        case .reactivateRegular: return "\u{f932}"
        case .receiveVoiceBold: return "\u{f933}"
        case .receiveVoiceFilled: return "\u{f934}"
        case .receiveVoiceLight: return "\u{f935}"
        case .receiveVoiceRegular: return "\u{f936}"
        case .recentsBold: return "\u{f937}"
        case .recentsFilled: return "\u{f938}"
        case .recentsLight: return "\u{f939}"
        case .recentsPresenceBadgeFilled: return "\u{f93a}"
        case .recentsPresenceBold: return "\u{f93b}"
        case .recentsPresenceFilled: return "\u{f93c}"
        case .recentsPresenceLight: return "\u{f93d}"
        case .recentsPresenceRegular: return "\u{f93e}"
        case .recentsRegular: return "\u{f93f}"
        case .recordActiveBadgeFilled: return "\u{f940}"
        case .recordActiveBold: return "\u{f941}"
        case .recordActiveFilled: return "\u{f942}"
        case .recordActiveLight: return "\u{f943}"
        case .recordActiveRegular: return "\u{f944}"
        case .recordBold: return "\u{f945}"
        case .recordFilled: return "\u{f946}"
        case .recordLight: return "\u{f947}"
        case .recordPausedBadgeFilled: return "\u{f948}"
        case .recordPausedBold: return "\u{f949}"
        case .recordPausedFilled: return "\u{f94a}"
        case .recordPausedLight: return "\u{f94b}"
        case .recordPausedRegular: return "\u{f94c}"
        case .recordRegular: return "\u{f94d}"
        case .recurringBold: return "\u{f94e}"
        case .recurringLight: return "\u{f94f}"
        case .recurringOffBold: return "\u{f950}"
        case .recurringOffLight: return "\u{f951}"
        case .recurringOffRegular: return "\u{f952}"
        case .recurringRegular: return "\u{f953}"
        case .redoBold: return "\u{f954}"
        case .redoLight: return "\u{f955}"
        case .redoRegular: return "\u{f956}"
        case .refreshBold: return "\u{f957}"
        case .refreshLight: return "\u{f958}"
        case .refreshRegular: return "\u{f959}"
        case .remoteDesktopControlBold: return "\u{f95a}"
        case .remoteDesktopControlFilled: return "\u{f95b}"
        case .remoteDesktopControlLight: return "\u{f95c}"
        case .remoteDesktopControlRegular: return "\u{f95d}"
        case .removeBold: return "\u{f95e}"
        case .removeFilled: return "\u{f95f}"
        case .removeLight: return "\u{f960}"
        case .removeRegular: return "\u{f961}"
        case .replyBold: return "\u{f962}"
        case .replyFilled: return "\u{f963}"
        case .replyLight: return "\u{f964}"
        case .replyListBold: return "\u{f965}"
        case .replyListLight: return "\u{f966}"
        case .replyListRegular: return "\u{f967}"
        case .replyPrivatelyBold: return "\u{f968}"
        case .replyPrivatelyLight: return "\u{f969}"
        case .replyPrivatelyRegular: return "\u{f96a}"
        case .replyRegular: return "\u{f96b}"
        case .resetBold: return "\u{f96c}"
        case .resetLight: return "\u{f96d}"
        case .resetRegular: return "\u{f96e}"
        case .resizeCornerBold: return "\u{f96f}"
        case .resizeCornerLight: return "\u{f970}"
        case .resizeCornerRegular: return "\u{f971}"
        case .responsiveMobileBold: return "\u{f972}"
        case .responsiveMobileLight: return "\u{f973}"
        case .responsiveMobileRegular: return "\u{f974}"
        case .restartBold: return "\u{f975}"
        case .restartLight: return "\u{f976}"
        case .restartRegular: return "\u{f977}"
        case .retrieveCallBold: return "\u{f978}"
        case .retrieveCallFilled: return "\u{f979}"
        case .retrieveCallLight: return "\u{f97a}"
        case .retrieveCallRegular: return "\u{f97b}"
        case .returnBold: return "\u{f97c}"
        case .returnLight: return "\u{f97d}"
        case .returnRegular: return "\u{f97e}"
        case .rewindTenSecBold: return "\u{f97f}"
        case .rewindTenSecLight: return "\u{f980}"
        case .rewindTenSecRegular: return "\u{f981}"
        case .ringtoneBold: return "\u{f982}"
        case .ringtoneLight: return "\u{f983}"
        case .ringtoneRegular: return "\u{f984}"
        case .roomCalendarBold: return "\u{f985}"
        case .roomCalendarLight: return "\u{f986}"
        case .roomCalendarRegular: return "\u{f987}"
        case .roomLightsBold: return "\u{f988}"
        case .roomLightsFilled: return "\u{f989}"
        case .roomLightsLight: return "\u{f98a}"
        case .roomLightsRegular: return "\u{f98b}"
        case .rotateContentBold: return "\u{f98c}"
        case .rotateContentFilled: return "\u{f98d}"
        case .rotateContentLight: return "\u{f98e}"
        case .rotateContentRegular: return "\u{f98f}"
        case .rssBold: return "\u{f990}"
        case .rssFilled: return "\u{f991}"
        case .rssLight: return "\u{f992}"
        case .rssRegular: return "\u{f993}"
        case .ruleBasedBold: return "\u{f994}"
        case .ruleBasedLight: return "\u{f995}"
        case .ruleBasedRegular: return "\u{f996}"
        case .runningApplicationBold: return "\u{f997}"
        case .runningApplicationFilled: return "\u{f998}"
        case .runningApplicationLight: return "\u{f999}"
        case .runningApplicationRegular: return "\u{f99a}"
        case .saveBold: return "\u{f99b}"
        case .saveLight: return "\u{f99c}"
        case .saveRegular: return "\u{f99d}"
        case .saveTranscriptBold: return "\u{f99e}"
        case .saveTranscriptFilled: return "\u{f99f}"
        case .saveTranscriptLight: return "\u{f9a0}"
        case .saveTranscriptRegular: return "\u{f9a1}"
        case .scanBold: return "\u{f9a2}"
        case .scanLight: return "\u{f9a3}"
        case .scanRegular: return "\u{f9a4}"
        case .scheduleSendBold: return "\u{f9a5}"
        case .scheduleSendFilled: return "\u{f9a6}"
        case .scheduleSendLight: return "\u{f9a7}"
        case .scheduleSendRegular: return "\u{f9a8}"
        case .scheduleWinnerBold: return "\u{f9a9}"
        case .scheduleWinnerFilled: return "\u{f9aa}"
        case .scheduleWinnerLight: return "\u{f9ab}"
        case .scheduleWinnerRegular: return "\u{f9ac}"
        case .schedulerAvailableBold: return "\u{f9ad}"
        case .schedulerAvailableLight: return "\u{f9ae}"
        case .schedulerAvailableRegular: return "\u{f9af}"
        case .schedulerNotWorkingHoursBold: return "\u{f9b0}"
        case .schedulerNotWorkingHoursLight: return "\u{f9b1}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9b2}"
        case .schedulerUnavailableBold: return "\u{f9b3}"
        case .schedulerUnavailableLight: return "\u{f9b4}"
        case .schedulerUnavailableRegular: return "\u{f9b5}"
        case .schedulerUnknownBold: return "\u{f9b6}"
        case .schedulerUnknownLight: return "\u{f9b7}"
        case .schedulerUnknownRegular: return "\u{f9b8}"
        case .screenshotBold: return "\u{f9b9}"
        case .screenshotDocBold: return "\u{f9ba}"
        case .screenshotDocFilled: return "\u{f9bb}"
        case .screenshotDocLight: return "\u{f9bc}"
        case .screenshotDocRegular: return "\u{f9bd}"
        case .screenshotLight: return "\u{f9be}"
        case .screenshotRegular: return "\u{f9bf}"
        case .searchBold: return "\u{f9c0}"
        case .searchFilled: return "\u{f9c1}"
        case .searchLight: return "\u{f9c2}"
        case .searchRegular: return "\u{f9c3}"
        case .secondaryArrowBold: return "\u{f9c4}"
        case .secondaryArrowLight: return "\u{f9c5}"
        case .secondaryArrowRegular: return "\u{f9c6}"
        case .secureCallLockBold: return "\u{f9c7}"
        case .secureCallLockFilled: return "\u{f9c8}"
        case .secureCallLockLight: return "\u{f9c9}"
        case .secureCallLockRegular: return "\u{f9ca}"
        case .secureCallShieldBold: return "\u{f9cb}"
        case .secureCallShieldFilled: return "\u{f9cc}"
        case .secureCallShieldLight: return "\u{f9cd}"
        case .secureCallShieldRegular: return "\u{f9ce}"
        case .secureCircleBold: return "\u{f9cf}"
        case .secureCircleFilled: return "\u{f9d0}"
        case .secureCircleLight: return "\u{f9d1}"
        case .secureCircleRegular: return "\u{f9d2}"
        case .secureLockBold: return "\u{f9d3}"
        case .secureLockFilled: return "\u{f9d4}"
        case .secureLockLight: return "\u{f9d5}"
        case .secureLockRegular: return "\u{f9d6}"
        case .segmentExcludeFilled: return "\u{f9d7}"
        case .segmentFilterFilled: return "\u{f9d8}"
        case .segmentIncludeFilled: return "\u{f9d9}"
        case .selectAllBold: return "\u{f9da}"
        case .selectAllFilled: return "\u{f9db}"
        case .selectAllLight: return "\u{f9dc}"
        case .selectAllRegular: return "\u{f9dd}"
        case .selectionBold: return "\u{f9de}"
        case .selectionFilled: return "\u{f9df}"
        case .selectionLight: return "\u{f9e0}"
        case .selectionRegular: return "\u{f9e1}"
        case .sendBold: return "\u{f9e2}"
        case .sendDigitsBold: return "\u{f9e3}"
        case .sendDigitsFilled: return "\u{f9e4}"
        case .sendDigitsLight: return "\u{f9e5}"
        case .sendDigitsRegular: return "\u{f9e6}"
        case .sendFilled: return "\u{f9e7}"
        case .sendLight: return "\u{f9e8}"
        case .sendRegular: return "\u{f9e9}"
        case .sendVoiceBold: return "\u{f9ea}"
        case .sendVoiceFilled: return "\u{f9eb}"
        case .sendVoiceLight: return "\u{f9ec}"
        case .sendVoiceRegular: return "\u{f9ed}"
        case .serverBold: return "\u{f9ee}"
        case .serverErrorBold: return "\u{f9ef}"
        case .serverErrorLight: return "\u{f9f0}"
        case .serverErrorRegular: return "\u{f9f1}"
        case .serverLight: return "\u{f9f2}"
        case .serverRegular: return "\u{f9f3}"
        case .servicesBold: return "\u{f9f4}"
        case .servicesLight: return "\u{f9f5}"
        case .servicesRegular: return "\u{f9f6}"
        case .setVariableBold: return "\u{f9f7}"
        case .setVariableLight: return "\u{f9f8}"
        case .setVariableRegular: return "\u{f9f9}"
        case .settingsBold: return "\u{f9fa}"
        case .settingsFilled: return "\u{f9fb}"
        case .settingsLight: return "\u{f9fc}"
        case .settingsRegular: return "\u{f9fd}"
        case .setupAssistantBold: return "\u{f9fe}"
        case .setupAssistantLight: return "\u{f9ff}"
        case .setupAssistantRegular: return "\u{fa00}"
        case .sftpBold: return "\u{fa01}"
        case .sftpLight: return "\u{fa02}"
        case .sftpRegular: return "\u{fa03}"
        case .shapeCircleBold: return "\u{fa04}"
        case .shapeCircleFilled: return "\u{fa05}"
        case .shapeCircleLight: return "\u{fa06}"
        case .shapeCircleMdFilled: return "\u{fa07}"
        case .shapeCircleRegular: return "\u{fa08}"
        case .shapeCircleSmFilled: return "\u{fa09}"
        case .shapeDiagonalLineBold: return "\u{fa0a}"
        case .shapeDiagonalLineLight: return "\u{fa0b}"
        case .shapeDiagonalLineRegular: return "\u{fa0c}"
        case .shapeDiamondBold: return "\u{fa0d}"
        case .shapeDiamondFilled: return "\u{fa0e}"
        case .shapeDiamondLight: return "\u{fa0f}"
        case .shapeDiamondRegular: return "\u{fa10}"
        case .shapeOvalBold: return "\u{fa11}"
        case .shapeOvalLight: return "\u{fa12}"
        case .shapeOvalRegular: return "\u{fa13}"
        case .shapeSquareBold: return "\u{fa14}"
        case .shapeSquareFilled: return "\u{fa15}"
        case .shapeSquareLight: return "\u{fa16}"
        case .shapeSquareRegular: return "\u{fa17}"
        case .shapeTriangleBold: return "\u{fa18}"
        case .shapeTriangleFilled: return "\u{fa19}"
        case .shapeTriangleLight: return "\u{fa1a}"
        case .shapeTriangleRegular: return "\u{fa1b}"
        case .shapesBold: return "\u{fa1c}"
        case .shapesFilled: return "\u{fa1d}"
        case .shapesLight: return "\u{fa1e}"
        case .shapesRegular: return "\u{fa1f}"
        case .shareCNativeAdrBold: return "\u{fa20}"
        case .shareCNativeAdrFilled: return "\u{fa21}"
        case .shareCNativeAdrLight: return "\u{fa22}"
        case .shareCNativeAdrRegular: return "\u{fa23}"
        case .shareCNativeIphBold: return "\u{fa24}"
        case .shareCNativeIphLight: return "\u{fa25}"
        case .shareCNativeIphRegular: return "\u{fa26}"
        case .shareContentOnDeviceBold: return "\u{fa27}"
        case .shareContentOnDeviceLight: return "\u{fa28}"
        case .shareContentOnDeviceRegular: return "\u{fa29}"
        case .shareScreenAddBold: return "\u{fa2a}"
        case .shareScreenAddLight: return "\u{fa2b}"
        case .shareScreenAddRegular: return "\u{fa2c}"
        case .shareScreenBadgeFilled: return "\u{fa2d}"
        case .shareScreenBold: return "\u{fa2e}"
        case .shareScreenFilled: return "\u{fa2f}"
        case .shareScreenLight: return "\u{fa30}"
        case .shareScreenRegular: return "\u{fa31}"
        case .shareSpaceBold: return "\u{fa32}"
        case .shareSpaceLight: return "\u{fa33}"
        case .shareSpaceRegular: return "\u{fa34}"
        case .shieldBold: return "\u{fa35}"
        case .shieldLight: return "\u{fa36}"
        case .shieldRegular: return "\u{fa37}"
        case .shoppingCartBold: return "\u{fa38}"
        case .shoppingCartFilled: return "\u{fa39}"
        case .shoppingCartLight: return "\u{fa3a}"
        case .shoppingCartRegular: return "\u{fa3b}"
        case .shortTextBoxBold: return "\u{fa3c}"
        case .shortTextBoxLight: return "\u{fa3d}"
        case .shortTextBoxRegular: return "\u{fa3e}"
        case .showBold: return "\u{fa3f}"
        case .showFilled: return "\u{fa40}"
        case .showLight: return "\u{fa41}"
        case .showRegular: return "\u{fa42}"
        case .signInBold: return "\u{fa43}"
        case .signInFilled: return "\u{fa44}"
        case .signInForcedBold: return "\u{fa45}"
        case .signInForcedLight: return "\u{fa46}"
        case .signInForcedRegular: return "\u{fa47}"
        case .signInLight: return "\u{fa48}"
        case .signInRegular: return "\u{fa49}"
        case .signLangIntBold: return "\u{fa4a}"
        case .signLangIntLight: return "\u{fa4b}"
        case .signLangIntRegular: return "\u{fa4c}"
        case .signOutBold: return "\u{fa4d}"
        case .signOutLight: return "\u{fa4e}"
        case .signOutRegular: return "\u{fa4f}"
        case .signalFourBold: return "\u{fa50}"
        case .signalFourLight: return "\u{fa51}"
        case .signalFourRegular: return "\u{fa52}"
        case .signalOneBold: return "\u{fa53}"
        case .signalOneLight: return "\u{fa54}"
        case .signalOneRegular: return "\u{fa55}"
        case .signalThreeBold: return "\u{fa56}"
        case .signalThreeLight: return "\u{fa57}"
        case .signalThreeRegular: return "\u{fa58}"
        case .signalTwoBold: return "\u{fa59}"
        case .signalTwoLight: return "\u{fa5a}"
        case .signalTwoRegular: return "\u{fa5b}"
        case .signalZeroBold: return "\u{fa5c}"
        case .signalZeroLight: return "\u{fa5d}"
        case .signalZeroRegular: return "\u{fa5e}"
        case .simplePromotionBold: return "\u{fa5f}"
        case .simplePromotionLight: return "\u{fa60}"
        case .simplePromotionRegular: return "\u{fa61}"
        case .singleNumberReachBold: return "\u{fa62}"
        case .singleNumberReachLight: return "\u{fa63}"
        case .singleNumberReachRegular: return "\u{fa64}"
        case .sipRegistrationInProgressBold: return "\u{fa65}"
        case .sipRegistrationInProgressFilled: return "\u{fa66}"
        case .sipRegistrationInProgressLight: return "\u{fa67}"
        case .sipRegistrationInProgressRegular: return "\u{fa68}"
        case .skipBold: return "\u{fa69}"
        case .skipBwBold: return "\u{fa6a}"
        case .skipBwFilled: return "\u{fa6b}"
        case .skipBwLight: return "\u{fa6c}"
        case .skipBwRegular: return "\u{fa6d}"
        case .skipFwBold: return "\u{fa6e}"
        case .skipFwFilled: return "\u{fa6f}"
        case .skipFwLight: return "\u{fa70}"
        case .skipFwRegular: return "\u{fa71}"
        case .skipLight: return "\u{fa72}"
        case .skipRegular: return "\u{fa73}"
        case .smartAudioBold: return "\u{fa74}"
        case .smartAudioLight: return "\u{fa75}"
        case .smartAudioRegular: return "\u{fa76}"
        case .smsFilled: return "\u{fa77}"
        case .smsInboundBold: return "\u{fa78}"
        case .smsInboundLight: return "\u{fa79}"
        case .smsInboundRegular: return "\u{fa7a}"
        case .smsMessageBold: return "\u{fa7b}"
        case .smsMessageFilled: return "\u{fa7c}"
        case .smsMessageLight: return "\u{fa7d}"
        case .smsMessageRegular: return "\u{fa7e}"
        case .smsOutgoingFilled: return "\u{fa7f}"
        case .smsUnreadBold: return "\u{fa80}"
        case .smsUnreadLight: return "\u{fa81}"
        case .smsUnreadRegular: return "\u{fa82}"
        case .sortAscendingBold: return "\u{fa83}"
        case .sortAscendingLight: return "\u{fa84}"
        case .sortAscendingRegular: return "\u{fa85}"
        case .sortDescendingBold: return "\u{fa86}"
        case .sortDescendingLight: return "\u{fa87}"
        case .sortDescendingRegular: return "\u{fa88}"
        case .soundDefaultBold: return "\u{fa89}"
        case .soundDefaultLight: return "\u{fa8a}"
        case .soundDefaultRegular: return "\u{fa8b}"
        case .sparkleBold: return "\u{fa8c}"
        case .sparkleFilled: return "\u{fa8d}"
        case .sparkleLight: return "\u{fa8e}"
        case .sparkleRegular: return "\u{fa8f}"
        case .speakerBold: return "\u{fa90}"
        case .speakerDisconnectedBold: return "\u{fa91}"
        case .speakerDisconnectedFilled: return "\u{fa92}"
        case .speakerDisconnectedLight: return "\u{fa93}"
        case .speakerDisconnectedRegular: return "\u{fa94}"
        case .speakerFilled: return "\u{fa95}"
        case .speakerLight: return "\u{fa96}"
        case .speakerMutedBold: return "\u{fa97}"
        case .speakerMutedFilled: return "\u{fa98}"
        case .speakerMutedLight: return "\u{fa99}"
        case .speakerMutedRegular: return "\u{fa9a}"
        case .speakerOffBold: return "\u{fa9b}"
        case .speakerOffFilled: return "\u{fa9c}"
        case .speakerOffLight: return "\u{fa9d}"
        case .speakerOffRegular: return "\u{fa9e}"
        case .speakerOnBold: return "\u{fa9f}"
        case .speakerOnLight: return "\u{faa0}"
        case .speakerOnRegular: return "\u{faa1}"
        case .speakerRegular: return "\u{faa2}"
        case .speakerTurnDownBold: return "\u{faa3}"
        case .speakerTurnDownFilled: return "\u{faa4}"
        case .speakerTurnDownLight: return "\u{faa5}"
        case .speakerTurnDownRegular: return "\u{faa6}"
        case .speakerTurnUpBold: return "\u{faa7}"
        case .speakerTurnUpFilled: return "\u{faa8}"
        case .speakerTurnUpLight: return "\u{faa9}"
        case .speakerTurnUpRegular: return "\u{faaa}"
        case .speedDialBold: return "\u{faab}"
        case .speedDialFilled: return "\u{faac}"
        case .speedDialLight: return "\u{faad}"
        case .speedDialRegular: return "\u{faae}"
        case .spellCheckerBold: return "\u{faaf}"
        case .spellCheckerLight: return "\u{fab0}"
        case .spellCheckerRegular: return "\u{fab1}"
        case .splitViewBold: return "\u{fab2}"
        case .splitViewLight: return "\u{fab3}"
        case .splitViewRegular: return "\u{fab4}"
        case .stackedAreaChartBold: return "\u{fab5}"
        case .stackedAreaChartFilled: return "\u{fab6}"
        case .stackedAreaChartFullBold: return "\u{fab7}"
        case .stackedAreaChartFullFilled: return "\u{fab8}"
        case .stackedAreaChartFullLight: return "\u{fab9}"
        case .stackedAreaChartFullRegular: return "\u{faba}"
        case .stackedAreaChartLight: return "\u{fabb}"
        case .stackedAreaChartRegular: return "\u{fabc}"
        case .stackedBarChartBold: return "\u{fabd}"
        case .stackedBarChartFilled: return "\u{fabe}"
        case .stackedBarChartFullBold: return "\u{fabf}"
        case .stackedBarChartFullFilled: return "\u{fac0}"
        case .stackedBarChartFullLight: return "\u{fac1}"
        case .stackedBarChartFullRegular: return "\u{fac2}"
        case .stackedBarChartLight: return "\u{fac3}"
        case .stackedBarChartRegular: return "\u{fac4}"
        case .startChatBold: return "\u{fac5}"
        case .startChatLight: return "\u{fac6}"
        case .startChatRegular: return "\u{fac7}"
        case .stethoscopeBold: return "\u{fac8}"
        case .stethoscopeLight: return "\u{fac9}"
        case .stethoscopeRegular: return "\u{faca}"
        case .stickersBold: return "\u{facb}"
        case .stickersLight: return "\u{facc}"
        case .stickersRegular: return "\u{facd}"
        case .stickiesBold: return "\u{face}"
        case .stickiesLight: return "\u{facf}"
        case .stickiesRegular: return "\u{fad0}"
        case .stopBold: return "\u{fad1}"
        case .stopCircleBold: return "\u{fad2}"
        case .stopCircleFilled: return "\u{fad3}"
        case .stopCircleLight: return "\u{fad4}"
        case .stopCircleRegular: return "\u{fad5}"
        case .stopContentShareBold: return "\u{fad6}"
        case .stopContentShareLight: return "\u{fad7}"
        case .stopContentShareRegular: return "\u{fad8}"
        case .stopFilled: return "\u{fad9}"
        case .stopLight: return "\u{fada}"
        case .stopRegular: return "\u{fadb}"
        case .storedInfoBold: return "\u{fadc}"
        case .storedInfoFilled: return "\u{fadd}"
        case .storedInfoLight: return "\u{fade}"
        case .storedInfoRegular: return "\u{fadf}"
        case .streamingBold: return "\u{fae0}"
        case .streamingLight: return "\u{fae1}"
        case .streamingRegular: return "\u{fae2}"
        case .strikethroughBold: return "\u{fae3}"
        case .strikethroughFilled: return "\u{fae4}"
        case .strikethroughLight: return "\u{fae5}"
        case .strikethroughRegular: return "\u{fae6}"
        case .studioModeBold: return "\u{fae7}"
        case .studioModeLight: return "\u{fae8}"
        case .studioModeRegular: return "\u{fae9}"
        case .subscriptBold: return "\u{faea}"
        case .subscriptLight: return "\u{faeb}"
        case .subscriptRegular: return "\u{faec}"
        case .superscriptBold: return "\u{faed}"
        case .superscriptLight: return "\u{faee}"
        case .superscriptRegular: return "\u{faef}"
        case .surveyBold: return "\u{faf0}"
        case .surveyFilled: return "\u{faf1}"
        case .surveyLight: return "\u{faf2}"
        case .surveyRegular: return "\u{faf3}"
        case .sxEightyCodecBold: return "\u{faf4}"
        case .sxEightyCodecLight: return "\u{faf5}"
        case .sxEightyCodecRegular: return "\u{faf6}"
        case .sxTenBold: return "\u{faf7}"
        case .sxTenLight: return "\u{faf8}"
        case .sxTenRegular: return "\u{faf9}"
        case .sxTwentyBold: return "\u{fafa}"
        case .sxTwentyLight: return "\u{fafb}"
        case .sxTwentyRegular: return "\u{fafc}"
        case .tableBold: return "\u{fafd}"
        case .tableLight: return "\u{fafe}"
        case .tableRegular: return "\u{faff}"
        case .tabletBold: return "\u{fb00}"
        case .tabletLight: return "\u{fb01}"
        case .tabletRegular: return "\u{fb02}"
        case .tabsBold: return "\u{fb03}"
        case .tabsLight: return "\u{fb04}"
        case .tabsRegular: return "\u{fb05}"
        case .tagBold: return "\u{fb06}"
        case .tagLight: return "\u{fb07}"
        case .tagRegular: return "\u{fb08}"
        case .tapBold: return "\u{fb09}"
        case .tapFilled: return "\u{fb0a}"
        case .tapLight: return "\u{fb0b}"
        case .tapRegular: return "\u{fb0c}"
        case .telepresenceAlertBold: return "\u{fb0d}"
        case .telepresenceAlertLight: return "\u{fb0e}"
        case .telepresenceAlertMutedBold: return "\u{fb0f}"
        case .telepresenceAlertMutedLight: return "\u{fb10}"
        case .telepresenceAlertMutedRegular: return "\u{fb11}"
        case .telepresenceAlertRegular: return "\u{fb12}"
        case .telepresenceBold: return "\u{fb13}"
        case .telepresenceIxFiveThousandBold: return "\u{fb14}"
        case .telepresenceIxFiveThousandLight: return "\u{fb15}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb16}"
        case .telepresenceLight: return "\u{fb17}"
        case .telepresenceMutedBold: return "\u{fb18}"
        case .telepresenceMutedLight: return "\u{fb19}"
        case .telepresenceMutedRegular: return "\u{fb1a}"
        case .telepresencePrivateBold: return "\u{fb1b}"
        case .telepresencePrivateLight: return "\u{fb1c}"
        case .telepresencePrivateRegular: return "\u{fb1d}"
        case .telepresenceRegular: return "\u{fb1e}"
        case .temperatureBold: return "\u{fb1f}"
        case .temperatureLight: return "\u{fb20}"
        case .temperatureRegular: return "\u{fb21}"
        case .testTubeBold: return "\u{fb22}"
        case .testTubeFilled: return "\u{fb23}"
        case .testTubeLight: return "\u{fb24}"
        case .testTubeRegular: return "\u{fb25}"
        case .textAlignCenterBold: return "\u{fb26}"
        case .textAlignCenterFilled: return "\u{fb27}"
        case .textAlignCenterLight: return "\u{fb28}"
        case .textAlignCenterRegular: return "\u{fb29}"
        case .textAlignLeftBold: return "\u{fb2a}"
        case .textAlignLeftFilled: return "\u{fb2b}"
        case .textAlignLeftLight: return "\u{fb2c}"
        case .textAlignLeftRegular: return "\u{fb2d}"
        case .textAlignRightBold: return "\u{fb2e}"
        case .textAlignRightFilled: return "\u{fb2f}"
        case .textAlignRightLight: return "\u{fb30}"
        case .textAlignRightRegular: return "\u{fb31}"
        case .textBold: return "\u{fb32}"
        case .textBoxCursorLight: return "\u{fb33}"
        case .textCodeBlockBold: return "\u{fb34}"
        case .textCodeBlockLight: return "\u{fb35}"
        case .textCodeBlockRegular: return "\u{fb36}"
        case .textHighlightBold: return "\u{fb37}"
        case .textHighlightFilled: return "\u{fb38}"
        case .textHighlightLight: return "\u{fb39}"
        case .textHighlightRegular: return "\u{fb3a}"
        case .textLight: return "\u{fb3b}"
        case .textRegular: return "\u{fb3c}"
        case .threeColumnBold: return "\u{fb3d}"
        case .threeColumnLight: return "\u{fb3e}"
        case .threeColumnRegular: return "\u{fb3f}"
        case .threeDObjectBold: return "\u{fb40}"
        case .threeDObjectLight: return "\u{fb41}"
        case .threeDObjectRegular: return "\u{fb42}"
        case .timeExclusionBold: return "\u{fb43}"
        case .timeExclusionLight: return "\u{fb44}"
        case .timeExclusionRegular: return "\u{fb45}"
        case .tooFastBold: return "\u{fb46}"
        case .tooFastLight: return "\u{fb47}"
        case .tooFastRegular: return "\u{fb48}"
        case .tooSlowBold: return "\u{fb49}"
        case .tooSlowLight: return "\u{fb4a}"
        case .tooSlowRegular: return "\u{fb4b}"
        case .toolsBold: return "\u{fb4c}"
        case .toolsFilled: return "\u{fb4d}"
        case .toolsLight: return "\u{fb4e}"
        case .toolsRegular: return "\u{fb4f}"
        case .touchTenBold: return "\u{fb50}"
        case .touchTenLight: return "\u{fb51}"
        case .touchTenRegular: return "\u{fb52}"
        case .transcriptBold: return "\u{fb53}"
        case .transcriptFilled: return "\u{fb54}"
        case .transcriptLight: return "\u{fb55}"
        case .transcriptRegular: return "\u{fb56}"
        case .translateBold: return "\u{fb57}"
        case .translateLight: return "\u{fb58}"
        case .translateRegular: return "\u{fb59}"
        case .translateUndoBold: return "\u{fb5a}"
        case .translateUndoLight: return "\u{fb5b}"
        case .translateUndoRegular: return "\u{fb5c}"
        case .trendingBold: return "\u{fb5d}"
        case .trendingDownBold: return "\u{fb5e}"
        case .trendingDownFilled: return "\u{fb5f}"
        case .trendingDownLight: return "\u{fb60}"
        case .trendingDownRegular: return "\u{fb61}"
        case .trendingFilled: return "\u{fb62}"
        case .trendingLight: return "\u{fb63}"
        case .trendingRegular: return "\u{fb64}"
        case .trimBold: return "\u{fb65}"
        case .trimLight: return "\u{fb66}"
        case .trimRegular: return "\u{fb67}"
        case .twoColumnBold: return "\u{fb68}"
        case .twoColumnLight: return "\u{fb69}"
        case .twoColumnRegular: return "\u{fb6a}"
        case .twoWayVoiceStreamBold: return "\u{fb6b}"
        case .twoWayVoiceStreamFilled: return "\u{fb6c}"
        case .twoWayVoiceStreamLight: return "\u{fb6d}"
        case .twoWayVoiceStreamRegular: return "\u{fb6e}"
        case .ucmCloudBold: return "\u{fb6f}"
        case .ucmCloudLight: return "\u{fb70}"
        case .ucmCloudRegular: return "\u{fb71}"
        case .unblockBold: return "\u{fb72}"
        case .unblockFilled: return "\u{fb73}"
        case .unblockLight: return "\u{fb74}"
        case .unblockRegular: return "\u{fb75}"
        case .underlineBold: return "\u{fb76}"
        case .underlineFilled: return "\u{fb77}"
        case .underlineLight: return "\u{fb78}"
        case .underlineRegular: return "\u{fb79}"
        case .undoBold: return "\u{fb7a}"
        case .undoLight: return "\u{fb7b}"
        case .undoRegular: return "\u{fb7c}"
        case .unlinkBold: return "\u{fb7d}"
        case .unlinkLight: return "\u{fb7e}"
        case .unlinkRegular: return "\u{fb7f}"
        case .unreadBold: return "\u{fb80}"
        case .unreadFilled: return "\u{fb81}"
        case .unreadLight: return "\u{fb82}"
        case .unreadRegular: return "\u{fb83}"
        case .unsecureUnlockedBold: return "\u{fb84}"
        case .unsecureUnlockedFilled: return "\u{fb85}"
        case .unsecureUnlockedLight: return "\u{fb86}"
        case .unsecureUnlockedRegular: return "\u{fb87}"
        case .unsortedBold: return "\u{fb88}"
        case .unsortedLight: return "\u{fb89}"
        case .unsortedRegular: return "\u{fb8a}"
        case .updateFileShareBold: return "\u{fb8b}"
        case .updateFileShareLight: return "\u{fb8c}"
        case .updateFileShareRegular: return "\u{fb8d}"
        case .uploadBold: return "\u{fb8e}"
        case .uploadImageBold: return "\u{fb8f}"
        case .uploadImageLight: return "\u{fb90}"
        case .uploadImageRegular: return "\u{fb91}"
        case .uploadLight: return "\u{fb92}"
        case .uploadRegular: return "\u{fb93}"
        case .urgentVoicemailBold: return "\u{fb94}"
        case .urgentVoicemailFilled: return "\u{fb95}"
        case .usbBold: return "\u{fb96}"
        case .usbHeadsetBold: return "\u{fb97}"
        case .usbHeadsetLight: return "\u{fb98}"
        case .usbHeadsetMutedBold: return "\u{fb99}"
        case .usbHeadsetMutedLight: return "\u{fb9a}"
        case .usbHeadsetMutedRegular: return "\u{fb9b}"
        case .usbHeadsetRegular: return "\u{fb9c}"
        case .usbLight: return "\u{fb9d}"
        case .usbRegular: return "\u{fb9e}"
        case .userBold: return "\u{fb9f}"
        case .userDeactivateBold: return "\u{fba0}"
        case .userDeactivateLight: return "\u{fba1}"
        case .userDeactivateRegular: return "\u{fba2}"
        case .userLight: return "\u{fba3}"
        case .userRegular: return "\u{fba4}"
        case .videoBlurBold: return "\u{fba5}"
        case .videoBlurFilled: return "\u{fba6}"
        case .videoBlurLight: return "\u{fba7}"
        case .videoBlurRegular: return "\u{fba8}"
        case .videoBold: return "\u{fba9}"
        case .videoEffectBold: return "\u{fbaa}"
        case .videoEffectFilled: return "\u{fbab}"
        case .videoEffectLight: return "\u{fbac}"
        case .videoEffectRegular: return "\u{fbad}"
        case .videoFilled: return "\u{fbae}"
        case .videoLayoutBold: return "\u{fbaf}"
        case .videoLayoutEqualBold: return "\u{fbb0}"
        case .videoLayoutEqualDualBold: return "\u{fbb1}"
        case .videoLayoutEqualDualLight: return "\u{fbb2}"
        case .videoLayoutEqualDualRegular: return "\u{fbb3}"
        case .videoLayoutEqualFilled: return "\u{fbb4}"
        case .videoLayoutEqualLight: return "\u{fbb5}"
        case .videoLayoutEqualRegular: return "\u{fbb6}"
        case .videoLayoutFilled: return "\u{fbb7}"
        case .videoLayoutLight: return "\u{fbb8}"
        case .videoLayoutOverlayBold: return "\u{fbb9}"
        case .videoLayoutOverlayFilled: return "\u{fbba}"
        case .videoLayoutOverlayLight: return "\u{fbbb}"
        case .videoLayoutOverlayRegular: return "\u{fbbc}"
        case .videoLayoutPresenterDominantBold: return "\u{fbbd}"
        case .videoLayoutPresenterDominantLight: return "\u{fbbe}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbbf}"
        case .videoLayoutProminentBold: return "\u{fbc0}"
        case .videoLayoutProminentFilled: return "\u{fbc1}"
        case .videoLayoutProminentLight: return "\u{fbc2}"
        case .videoLayoutProminentRegular: return "\u{fbc3}"
        case .videoLayoutRegular: return "\u{fbc4}"
        case .videoLayoutShareDominantBold: return "\u{fbc5}"
        case .videoLayoutShareDominantLight: return "\u{fbc6}"
        case .videoLayoutShareDominantRegular: return "\u{fbc7}"
        case .videoLayoutSingleBold: return "\u{fbc8}"
        case .videoLayoutSingleFilled: return "\u{fbc9}"
        case .videoLayoutSingleLight: return "\u{fbca}"
        case .videoLayoutSingleRegular: return "\u{fbcb}"
        case .videoLayoutStackBold: return "\u{fbcc}"
        case .videoLayoutStackFilled: return "\u{fbcd}"
        case .videoLayoutStackLight: return "\u{fbce}"
        case .videoLayoutStackRegular: return "\u{fbcf}"
        case .videoLayoutVideoDominantBold: return "\u{fbd0}"
        case .videoLayoutVideoDominantFilled: return "\u{fbd1}"
        case .videoLayoutVideoDominantLight: return "\u{fbd2}"
        case .videoLayoutVideoDominantRegular: return "\u{fbd3}"
        case .videoLight: return "\u{fbd4}"
        case .videoPlusBold: return "\u{fbd5}"
        case .videoPlusFilled: return "\u{fbd6}"
        case .videoPlusLight: return "\u{fbd7}"
        case .videoPlusRegular: return "\u{fbd8}"
        case .videoRegular: return "\u{fbd9}"
        case .videoSpeakerTrackBold: return "\u{fbda}"
        case .videoSpeakerTrackFilled: return "\u{fbdb}"
        case .videoSpeakerTrackLight: return "\u{fbdc}"
        case .videoSpeakerTrackRegular: return "\u{fbdd}"
        case .viewAllBold: return "\u{fbde}"
        case .viewAllLight: return "\u{fbdf}"
        case .viewAllRegular: return "\u{fbe0}"
        case .viewListBold: return "\u{fbe1}"
        case .viewListFilled: return "\u{fbe2}"
        case .viewListLight: return "\u{fbe3}"
        case .viewListRegular: return "\u{fbe4}"
        case .viewStackedBold: return "\u{fbe5}"
        case .viewStackedFilled: return "\u{fbe6}"
        case .viewStackedLight: return "\u{fbe7}"
        case .viewStackedRegular: return "\u{fbe8}"
        case .viewThumbnailBold: return "\u{fbe9}"
        case .viewThumbnailFilled: return "\u{fbea}"
        case .viewThumbnailLight: return "\u{fbeb}"
        case .viewThumbnailRegular: return "\u{fbec}"
        case .visionproBold: return "\u{fbed}"
        case .visionproFilled: return "\u{fbee}"
        case .visionproLight: return "\u{fbef}"
        case .visionproMoveCallInBold: return "\u{fbf0}"
        case .visionproMoveCallInFilled: return "\u{fbf1}"
        case .visionproMoveCallInLight: return "\u{fbf2}"
        case .visionproMoveCallInOutBold: return "\u{fbf3}"
        case .visionproMoveCallInOutFilled: return "\u{fbf4}"
        case .visionproMoveCallInOutLight: return "\u{fbf5}"
        case .visionproMoveCallInOutRegular: return "\u{fbf6}"
        case .visionproMoveCallInRegular: return "\u{fbf7}"
        case .visionproMoveCallOutBold: return "\u{fbf8}"
        case .visionproMoveCallOutFilled: return "\u{fbf9}"
        case .visionproMoveCallOutLight: return "\u{fbfa}"
        case .visionproMoveCallOutRegular: return "\u{fbfb}"
        case .visionproRegular: return "\u{fbfc}"
        case .voicemailBold: return "\u{fbfd}"
        case .voicemailFilled: return "\u{fbfe}"
        case .voicemailLight: return "\u{fbff}"
        case .voicemailRegular: return "\u{fc00}"
        case .vpnBold: return "\u{fc01}"
        case .vpnFilled: return "\u{fc02}"
        case .vpnLight: return "\u{fc03}"
        case .vpnRegular: return "\u{fc04}"
        case .vscBold: return "\u{fc05}"
        case .vscLight: return "\u{fc06}"
        case .vscRegular: return "\u{fc07}"
        case .waffleMenuBold: return "\u{fc08}"
        case .waffleMenuLight: return "\u{fc09}"
        case .waffleMenuRegular: return "\u{fc0a}"
        case .waitingRoomBold: return "\u{fc0b}"
        case .waitingRoomLight: return "\u{fc0c}"
        case .waitingRoomRegular: return "\u{fc0d}"
        case .wallpaperBold: return "\u{fc0e}"
        case .wallpaperLight: return "\u{fc0f}"
        case .wallpaperRegular: return "\u{fc10}"
        case .warningBadgeFilled: return "\u{fc11}"
        case .warningBold: return "\u{fc12}"
        case .warningFilled: return "\u{fc13}"
        case .warningLight: return "\u{fc14}"
        case .warningRegular: return "\u{fc15}"
        case .webexBoardBold: return "\u{fc16}"
        case .webexBoardLight: return "\u{fc17}"
        case .webexBoardRegular: return "\u{fc18}"
        case .webexCodecPlusBold: return "\u{fc19}"
        case .webexCodecPlusLight: return "\u{fc1a}"
        case .webexCodecPlusRegular: return "\u{fc1b}"
        case .webexDeskCameraBold: return "\u{fc1c}"
        case .webexDeskCameraLight: return "\u{fc1d}"
        case .webexDeskCameraRegular: return "\u{fc1e}"
        case .webexMeetingsBold: return "\u{fc1f}"
        case .webexMeetingsFilled: return "\u{fc20}"
        case .webexMeetingsLight: return "\u{fc21}"
        case .webexMeetingsRegular: return "\u{fc22}"
        case .webexQuadCameraBold: return "\u{fc23}"
        case .webexQuadCameraLight: return "\u{fc24}"
        case .webexQuadCameraRegular: return "\u{fc25}"
        case .webexRoomKitBold: return "\u{fc26}"
        case .webexRoomKitLight: return "\u{fc27}"
        case .webexRoomKitPlusBold: return "\u{fc28}"
        case .webexRoomKitPlusLight: return "\u{fc29}"
        case .webexRoomKitPlusRegular: return "\u{fc2a}"
        case .webexRoomKitRegular: return "\u{fc2b}"
        case .webexShareBold: return "\u{fc2c}"
        case .webexShareLight: return "\u{fc2d}"
        case .webexShareRegular: return "\u{fc2e}"
        case .webexTeamsBold: return "\u{fc2f}"
        case .webexTeamsFilled: return "\u{fc30}"
        case .webexTeamsLight: return "\u{fc31}"
        case .webexTeamsNewBold: return "\u{fc32}"
        case .webexTeamsNewFilled: return "\u{fc33}"
        case .webexTeamsNewLight: return "\u{fc34}"
        case .webexTeamsNewRegular: return "\u{fc35}"
        case .webexTeamsRegular: return "\u{fc36}"
        case .webexTeamsRemoveBold: return "\u{fc37}"
        case .webexTeamsRemoveLight: return "\u{fc38}"
        case .webexTeamsRemoveRegular: return "\u{fc39}"
        case .webinarBold: return "\u{fc3a}"
        case .webinarFilled: return "\u{fc3b}"
        case .webinarLight: return "\u{fc3c}"
        case .webinarRegular: return "\u{fc3d}"
        case .weeklyRecurringScheduleBold: return "\u{fc3e}"
        case .weeklyRecurringScheduleLight: return "\u{fc3f}"
        case .weeklyRecurringScheduleRegular: return "\u{fc40}"
        case .whisperAnnouncementBold: return "\u{fc41}"
        case .whisperAnnouncementFilled: return "\u{fc42}"
        case .whisperAnnouncementLight: return "\u{fc43}"
        case .whisperAnnouncementRegular: return "\u{fc44}"
        case .whisperCoachBold: return "\u{fc45}"
        case .whisperCoachFilled: return "\u{fc46}"
        case .whisperCoachLight: return "\u{fc47}"
        case .whisperCoachRegular: return "\u{fc48}"
        case .whiteboardBold: return "\u{fc49}"
        case .whiteboardContentBold: return "\u{fc4a}"
        case .whiteboardContentFilled: return "\u{fc4b}"
        case .whiteboardContentLight: return "\u{fc4c}"
        case .whiteboardContentRegular: return "\u{fc4d}"
        case .whiteboardFilled: return "\u{fc4e}"
        case .whiteboardLight: return "\u{fc4f}"
        case .whiteboardRegular: return "\u{fc50}"
        case .widgetBold: return "\u{fc51}"
        case .widgetFilled: return "\u{fc52}"
        case .widgetLight: return "\u{fc53}"
        case .widgetRegular: return "\u{fc54}"
        case .wifiBold: return "\u{fc55}"
        case .wifiErrorBold: return "\u{fc56}"
        case .wifiErrorLight: return "\u{fc57}"
        case .wifiErrorRegular: return "\u{fc58}"
        case .wifiLight: return "\u{fc59}"
        case .wifiRegular: return "\u{fc5a}"
        case .wifiSignalGoodBold: return "\u{fc5b}"
        case .wifiSignalGoodLight: return "\u{fc5c}"
        case .wifiSignalGoodRegular: return "\u{fc5d}"
        case .wifiSignalPoorBold: return "\u{fc5e}"
        case .wifiSignalPoorLight: return "\u{fc5f}"
        case .wifiSignalPoorRegular: return "\u{fc60}"
        case .wifiSignalUnstableBold: return "\u{fc61}"
        case .wifiSignalUnstableLight: return "\u{fc62}"
        case .wifiSignalUnstableRegular: return "\u{fc63}"
        case .windowCornerScrubBold: return "\u{fc64}"
        case .windowCornerScrubLight: return "\u{fc65}"
        case .windowCornerScrubRegular: return "\u{fc66}"
        case .windowRightCornerScrubBold: return "\u{fc67}"
        case .windowRightCornerScrubLight: return "\u{fc68}"
        case .windowRightCornerScrubRegular: return "\u{fc69}"
        case .windowVerticalScrubBold: return "\u{fc6a}"
        case .windowVerticalScrubLight: return "\u{fc6b}"
        case .windowVerticalScrubRegular: return "\u{fc6c}"
        case .workflowDeploymentsBold: return "\u{fc6d}"
        case .workflowDeploymentsFilled: return "\u{fc6e}"
        case .workflowDeploymentsLight: return "\u{fc6f}"
        case .workflowDeploymentsRegular: return "\u{fc70}"
        case .workphoneBold: return "\u{fc71}"
        case .workphoneLight: return "\u{fc72}"
        case .workphoneRegular: return "\u{fc73}"
        case .zoomInBold: return "\u{fc74}"
        case .zoomInLight: return "\u{fc75}"
        case .zoomInRegular: return "\u{fc76}"
        case .zoomOutBold: return "\u{fc77}"
        case .zoomOutLight: return "\u{fc78}"
        case .zoomOutRegular: return "\u{fc79}"
