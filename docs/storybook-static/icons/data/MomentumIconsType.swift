...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .proximityBold: return "\u{f90d}"
        case .proximityLight: return "\u{f90e}"
        case .proximityMutedBold: return "\u{f90f}"
        case .proximityMutedLight: return "\u{f910}"
        case .proximityMutedRegular: return "\u{f911}"
        case .proximityRegular: return "\u{f912}"
        case .proximityVideoBold: return "\u{f913}"
        case .proximityVideoLight: return "\u{f914}"
        case .proximityVideoRegular: return "\u{f915}"
        case .ptoPresenceBold: return "\u{f916}"
        case .ptoPresenceFilled: return "\u{f917}"
        case .ptoPresenceLight: return "\u{f918}"
        case .ptoPresenceRegular: return "\u{f919}"
        case .pullCallBold: return "\u{f91a}"
        case .pullCallFilled: return "\u{f91b}"
        case .pullCallLight: return "\u{f91c}"
        case .pullCallRegular: return "\u{f91d}"
        case .qABold: return "\u{f91e}"
        case .qALight: return "\u{f91f}"
        case .qARegular: return "\u{f920}"
        case .qrCodeBold: return "\u{f921}"
        case .qrCodeLight: return "\u{f922}"
        case .qrCodeRegular: return "\u{f923}"
        case .qrCodeScanBold: return "\u{f924}"
        case .qrCodeScanLight: return "\u{f925}"
        case .qrCodeScanRegular: return "\u{f926}"
        case .qualityBold: return "\u{f927}"
        case .qualityLight: return "\u{f928}"
        case .qualityRegular: return "\u{f929}"
        case .queueContactBold: return "\u{f92a}"
        case .queueContactFilled: return "\u{f92b}"
        case .queueContactLight: return "\u{f92c}"
        case .queueContactRegular: return "\u{f92d}"
        case .quietBold: return "\u{f92e}"
        case .quietHoursPresenceBold: return "\u{f92f}"
        case .quietHoursPresenceFilled: return "\u{f930}"
        case .quietHoursPresenceLight: return "\u{f931}"
        case .quietHoursPresenceRegular: return "\u{f932}"
        case .quietLight: return "\u{f933}"
        case .quietRegular: return "\u{f934}"
        case .radioButtonGroupBold: return "\u{f935}"
        case .radioButtonGroupLight: return "\u{f936}"
        case .radioButtonGroupRegular: return "\u{f937}"
        case .raiseHandBold: return "\u{f938}"
        case .raiseHandCircleFilled: return "\u{f939}"
        case .raiseHandFilled: return "\u{f93a}"
        case .raiseHandLight: return "\u{f93b}"
        case .raiseHandRegular: return "\u{f93c}"
        case .ramBold: return "\u{f93d}"
        case .ramLight: return "\u{f93e}"
        case .ramRegular: return "\u{f93f}"
        case .reactionsBold: return "\u{f940}"
        case .reactionsFilled: return "\u{f941}"
        case .reactionsLight: return "\u{f942}"
        case .reactionsRegular: return "\u{f943}"
        case .reactivateBold: return "\u{f944}"
        case .reactivateLight: return "\u{f945}"
        case .reactivateRegular: return "\u{f946}"
        case .receiveVoiceBold: return "\u{f947}"
        case .receiveVoiceFilled: return "\u{f948}"
        case .receiveVoiceLight: return "\u{f949}"
        case .receiveVoiceRegular: return "\u{f94a}"
        case .recentsBold: return "\u{f94b}"
        case .recentsFilled: return "\u{f94c}"
        case .recentsLight: return "\u{f94d}"
        case .recentsPresenceBadgeFilled: return "\u{f94e}"
        case .recentsPresenceBold: return "\u{f94f}"
        case .recentsPresenceFilled: return "\u{f950}"
        case .recentsPresenceLight: return "\u{f951}"
        case .recentsPresenceRegular: return "\u{f952}"
        case .recentsRegular: return "\u{f953}"
        case .recordActiveBadgeFilled: return "\u{f954}"
        case .recordActiveBold: return "\u{f955}"
        case .recordActiveFilled: return "\u{f956}"
        case .recordActiveLight: return "\u{f957}"
        case .recordActiveRegular: return "\u{f958}"
        case .recordBold: return "\u{f959}"
        case .recordFilled: return "\u{f95a}"
        case .recordLight: return "\u{f95b}"
        case .recordPausedBadgeFilled: return "\u{f95c}"
        case .recordPausedBold: return "\u{f95d}"
        case .recordPausedFilled: return "\u{f95e}"
        case .recordPausedLight: return "\u{f95f}"
        case .recordPausedRegular: return "\u{f960}"
        case .recordRegular: return "\u{f961}"
        case .recurringBold: return "\u{f962}"
        case .recurringLight: return "\u{f963}"
        case .recurringOffBold: return "\u{f964}"
        case .recurringOffLight: return "\u{f965}"
        case .recurringOffRegular: return "\u{f966}"
        case .recurringRegular: return "\u{f967}"
        case .redoBold: return "\u{f968}"
        case .redoLight: return "\u{f969}"
        case .redoRegular: return "\u{f96a}"
        case .refreshBold: return "\u{f96b}"
        case .refreshLight: return "\u{f96c}"
        case .refreshRegular: return "\u{f96d}"
        case .remoteDesktopControlBold: return "\u{f96e}"
        case .remoteDesktopControlFilled: return "\u{f96f}"
        case .remoteDesktopControlLight: return "\u{f970}"
        case .remoteDesktopControlRegular: return "\u{f971}"
        case .removeBold: return "\u{f972}"
        case .removeFilled: return "\u{f973}"
        case .removeLight: return "\u{f974}"
        case .removeRegular: return "\u{f975}"
        case .replyBold: return "\u{f976}"
        case .replyFilled: return "\u{f977}"
        case .replyLight: return "\u{f978}"
        case .replyListBold: return "\u{f979}"
        case .replyListLight: return "\u{f97a}"
        case .replyListRegular: return "\u{f97b}"
        case .replyPrivatelyBold: return "\u{f97c}"
        case .replyPrivatelyLight: return "\u{f97d}"
        case .replyPrivatelyRegular: return "\u{f97e}"
        case .replyRegular: return "\u{f97f}"
        case .resetBold: return "\u{f980}"
        case .resetLight: return "\u{f981}"
        case .resetRegular: return "\u{f982}"
        case .resizeCornerBold: return "\u{f983}"
        case .resizeCornerLight: return "\u{f984}"
        case .resizeCornerRegular: return "\u{f985}"
        case .responsiveMobileBold: return "\u{f986}"
        case .responsiveMobileLight: return "\u{f987}"
        case .responsiveMobileRegular: return "\u{f988}"
        case .restartBold: return "\u{f989}"
        case .restartLight: return "\u{f98a}"
        case .restartRegular: return "\u{f98b}"
        case .retrieveCallBold: return "\u{f98c}"
        case .retrieveCallFilled: return "\u{f98d}"
        case .retrieveCallLight: return "\u{f98e}"
        case .retrieveCallRegular: return "\u{f98f}"
        case .returnBold: return "\u{f990}"
        case .returnLight: return "\u{f991}"
        case .returnRegular: return "\u{f992}"
        case .rewindTenSecBold: return "\u{f993}"
        case .rewindTenSecLight: return "\u{f994}"
        case .rewindTenSecRegular: return "\u{f995}"
        case .ringtoneBold: return "\u{f996}"
        case .ringtoneLight: return "\u{f997}"
        case .ringtoneRegular: return "\u{f998}"
        case .roomCalendarBold: return "\u{f999}"
        case .roomCalendarLight: return "\u{f99a}"
        case .roomCalendarRegular: return "\u{f99b}"
        case .roomLightsBold: return "\u{f99c}"
        case .roomLightsFilled: return "\u{f99d}"
        case .roomLightsLight: return "\u{f99e}"
        case .roomLightsRegular: return "\u{f99f}"
        case .rotateContentBold: return "\u{f9a0}"
        case .rotateContentFilled: return "\u{f9a1}"
        case .rotateContentLight: return "\u{f9a2}"
        case .rotateContentRegular: return "\u{f9a3}"
        case .rssBold: return "\u{f9a4}"
        case .rssFilled: return "\u{f9a5}"
        case .rssLight: return "\u{f9a6}"
        case .rssRegular: return "\u{f9a7}"
        case .ruleBasedBold: return "\u{f9a8}"
        case .ruleBasedLight: return "\u{f9a9}"
        case .ruleBasedRegular: return "\u{f9aa}"
        case .runningApplicationBold: return "\u{f9ab}"
        case .runningApplicationFilled: return "\u{f9ac}"
        case .runningApplicationLight: return "\u{f9ad}"
        case .runningApplicationRegular: return "\u{f9ae}"
        case .saveBold: return "\u{f9af}"
        case .saveLight: return "\u{f9b0}"
        case .saveRegular: return "\u{f9b1}"
        case .saveTranscriptBold: return "\u{f9b2}"
        case .saveTranscriptFilled: return "\u{f9b3}"
        case .saveTranscriptLight: return "\u{f9b4}"
        case .saveTranscriptRegular: return "\u{f9b5}"
        case .scanBold: return "\u{f9b6}"
        case .scanLight: return "\u{f9b7}"
        case .scanRegular: return "\u{f9b8}"
        case .scheduleAiBold: return "\u{f9b9}"
        case .scheduleAiLight: return "\u{f9ba}"
        case .scheduleAiRegular: return "\u{f9bb}"
        case .scheduleSendBold: return "\u{f9bc}"
        case .scheduleSendFilled: return "\u{f9bd}"
        case .scheduleSendLight: return "\u{f9be}"
        case .scheduleSendRegular: return "\u{f9bf}"
        case .scheduleWinnerBold: return "\u{f9c0}"
        case .scheduleWinnerFilled: return "\u{f9c1}"
        case .scheduleWinnerLight: return "\u{f9c2}"
        case .scheduleWinnerRegular: return "\u{f9c3}"
        case .schedulerAvailableBold: return "\u{f9c4}"
        case .schedulerAvailableLight: return "\u{f9c5}"
        case .schedulerAvailableRegular: return "\u{f9c6}"
        case .schedulerNotWorkingHoursBold: return "\u{f9c7}"
        case .schedulerNotWorkingHoursLight: return "\u{f9c8}"
        case .schedulerNotWorkingHoursRegular: return "\u{f9c9}"
        case .schedulerUnavailableBold: return "\u{f9ca}"
        case .schedulerUnavailableLight: return "\u{f9cb}"
        case .schedulerUnavailableRegular: return "\u{f9cc}"
        case .schedulerUnknownBold: return "\u{f9cd}"
        case .schedulerUnknownLight: return "\u{f9ce}"
        case .schedulerUnknownRegular: return "\u{f9cf}"
        case .screenshotBold: return "\u{f9d0}"
        case .screenshotDocBold: return "\u{f9d1}"
        case .screenshotDocFilled: return "\u{f9d2}"
        case .screenshotDocLight: return "\u{f9d3}"
        case .screenshotDocRegular: return "\u{f9d4}"
        case .screenshotLight: return "\u{f9d5}"
        case .screenshotRegular: return "\u{f9d6}"
        case .searchBold: return "\u{f9d7}"
        case .searchFilled: return "\u{f9d8}"
        case .searchLight: return "\u{f9d9}"
        case .searchRegular: return "\u{f9da}"
        case .secondaryArrowBold: return "\u{f9db}"
        case .secondaryArrowLight: return "\u{f9dc}"
        case .secondaryArrowRegular: return "\u{f9dd}"
        case .secureCallLockBold: return "\u{f9de}"
        case .secureCallLockFilled: return "\u{f9df}"
        case .secureCallLockLight: return "\u{f9e0}"
        case .secureCallLockRegular: return "\u{f9e1}"
        case .secureCallShieldBold: return "\u{f9e2}"
        case .secureCallShieldFilled: return "\u{f9e3}"
        case .secureCallShieldLight: return "\u{f9e4}"
        case .secureCallShieldRegular: return "\u{f9e5}"
        case .secureCircleBold: return "\u{f9e6}"
        case .secureCircleFilled: return "\u{f9e7}"
        case .secureCircleLight: return "\u{f9e8}"
        case .secureCircleRegular: return "\u{f9e9}"
        case .secureLockBold: return "\u{f9ea}"
        case .secureLockFilled: return "\u{f9eb}"
        case .secureLockLight: return "\u{f9ec}"
        case .secureLockRegular: return "\u{f9ed}"
        case .segmentExcludeFilled: return "\u{f9ee}"
        case .segmentFilterFilled: return "\u{f9ef}"
        case .segmentIncludeFilled: return "\u{f9f0}"
        case .selectAllBold: return "\u{f9f1}"
        case .selectAllFilled: return "\u{f9f2}"
        case .selectAllLight: return "\u{f9f3}"
        case .selectAllRegular: return "\u{f9f4}"
        case .selectionBold: return "\u{f9f5}"
        case .selectionFilled: return "\u{f9f6}"
        case .selectionLight: return "\u{f9f7}"
        case .selectionRegular: return "\u{f9f8}"
        case .sendBold: return "\u{f9f9}"
        case .sendDigitsBold: return "\u{f9fa}"
        case .sendDigitsFilled: return "\u{f9fb}"
        case .sendDigitsLight: return "\u{f9fc}"
        case .sendDigitsRegular: return "\u{f9fd}"
        case .sendFilled: return "\u{f9fe}"
        case .sendLight: return "\u{f9ff}"
        case .sendRegular: return "\u{fa00}"
        case .sendVoiceBold: return "\u{fa01}"
        case .sendVoiceFilled: return "\u{fa02}"
        case .sendVoiceLight: return "\u{fa03}"
        case .sendVoiceRegular: return "\u{fa04}"
        case .serverBold: return "\u{fa05}"
        case .serverErrorBold: return "\u{fa06}"
        case .serverErrorLight: return "\u{fa07}"
        case .serverErrorRegular: return "\u{fa08}"
        case .serverLight: return "\u{fa09}"
        case .serverRegular: return "\u{fa0a}"
        case .servicesBold: return "\u{fa0b}"
        case .servicesLight: return "\u{fa0c}"
        case .servicesRegular: return "\u{fa0d}"
        case .setVariableBold: return "\u{fa0e}"
        case .setVariableLight: return "\u{fa0f}"
        case .setVariableRegular: return "\u{fa10}"
        case .settingsBold: return "\u{fa11}"
        case .settingsFilled: return "\u{fa12}"
        case .settingsLight: return "\u{fa13}"
        case .settingsRegular: return "\u{fa14}"
        case .setupAssistantBold: return "\u{fa15}"
        case .setupAssistantLight: return "\u{fa16}"
        case .setupAssistantRegular: return "\u{fa17}"
        case .sftpBold: return "\u{fa18}"
        case .sftpLight: return "\u{fa19}"
        case .sftpRegular: return "\u{fa1a}"
        case .shapeCircleBold: return "\u{fa1b}"
        case .shapeCircleFilled: return "\u{fa1c}"
        case .shapeCircleLight: return "\u{fa1d}"
        case .shapeCircleMdFilled: return "\u{fa1e}"
        case .shapeCircleRegular: return "\u{fa1f}"
        case .shapeCircleSmFilled: return "\u{fa20}"
        case .shapeDiagonalLineBold: return "\u{fa21}"
        case .shapeDiagonalLineLight: return "\u{fa22}"
        case .shapeDiagonalLineRegular: return "\u{fa23}"
        case .shapeDiamondBold: return "\u{fa24}"
        case .shapeDiamondFilled: return "\u{fa25}"
        case .shapeDiamondLight: return "\u{fa26}"
        case .shapeDiamondRegular: return "\u{fa27}"
        case .shapeOvalBold: return "\u{fa28}"
        case .shapeOvalLight: return "\u{fa29}"
        case .shapeOvalRegular: return "\u{fa2a}"
        case .shapeSquareBold: return "\u{fa2b}"
        case .shapeSquareFilled: return "\u{fa2c}"
        case .shapeSquareLight: return "\u{fa2d}"
        case .shapeSquareRegular: return "\u{fa2e}"
        case .shapeTriangleBold: return "\u{fa2f}"
        case .shapeTriangleFilled: return "\u{fa30}"
        case .shapeTriangleLight: return "\u{fa31}"
        case .shapeTriangleRegular: return "\u{fa32}"
        case .shapesBold: return "\u{fa33}"
        case .shapesFilled: return "\u{fa34}"
        case .shapesLight: return "\u{fa35}"
        case .shapesRegular: return "\u{fa36}"
        case .shareCNativeAdrBold: return "\u{fa37}"
        case .shareCNativeAdrFilled: return "\u{fa38}"
        case .shareCNativeAdrLight: return "\u{fa39}"
        case .shareCNativeAdrRegular: return "\u{fa3a}"
        case .shareCNativeIphBold: return "\u{fa3b}"
        case .shareCNativeIphLight: return "\u{fa3c}"
        case .shareCNativeIphRegular: return "\u{fa3d}"
        case .shareContentOnDeviceBold: return "\u{fa3e}"
        case .shareContentOnDeviceLight: return "\u{fa3f}"
        case .shareContentOnDeviceRegular: return "\u{fa40}"
        case .shareScreenAddBold: return "\u{fa41}"
        case .shareScreenAddLight: return "\u{fa42}"
        case .shareScreenAddRegular: return "\u{fa43}"
        case .shareScreenBadgeFilled: return "\u{fa44}"
        case .shareScreenBold: return "\u{fa45}"
        case .shareScreenFilled: return "\u{fa46}"
        case .shareScreenLight: return "\u{fa47}"
        case .shareScreenRegular: return "\u{fa48}"
        case .shareSpaceBold: return "\u{fa49}"
        case .shareSpaceLight: return "\u{fa4a}"
        case .shareSpaceRegular: return "\u{fa4b}"
        case .shieldBold: return "\u{fa4c}"
        case .shieldLight: return "\u{fa4d}"
        case .shieldRegular: return "\u{fa4e}"
        case .shoppingCartBold: return "\u{fa4f}"
        case .shoppingCartFilled: return "\u{fa50}"
        case .shoppingCartLight: return "\u{fa51}"
        case .shoppingCartRegular: return "\u{fa52}"
        case .shortTextBoxBold: return "\u{fa53}"
        case .shortTextBoxLight: return "\u{fa54}"
        case .shortTextBoxRegular: return "\u{fa55}"
        case .showBold: return "\u{fa56}"
        case .showFilled: return "\u{fa57}"
        case .showLight: return "\u{fa58}"
        case .showRegular: return "\u{fa59}"
        case .signInBold: return "\u{fa5a}"
        case .signInFilled: return "\u{fa5b}"
        case .signInForcedBold: return "\u{fa5c}"
        case .signInForcedLight: return "\u{fa5d}"
        case .signInForcedRegular: return "\u{fa5e}"
        case .signInLight: return "\u{fa5f}"
        case .signInRegular: return "\u{fa60}"
        case .signLangIntBold: return "\u{fa61}"
        case .signLangIntLight: return "\u{fa62}"
        case .signLangIntRegular: return "\u{fa63}"
        case .signOutBold: return "\u{fa64}"
        case .signOutLight: return "\u{fa65}"
        case .signOutRegular: return "\u{fa66}"
        case .signalFourBold: return "\u{fa67}"
        case .signalFourLight: return "\u{fa68}"
        case .signalFourRegular: return "\u{fa69}"
        case .signalOneBold: return "\u{fa6a}"
        case .signalOneLight: return "\u{fa6b}"
        case .signalOneRegular: return "\u{fa6c}"
        case .signalThreeBold: return "\u{fa6d}"
        case .signalThreeLight: return "\u{fa6e}"
        case .signalThreeRegular: return "\u{fa6f}"
        case .signalTwoBold: return "\u{fa70}"
        case .signalTwoLight: return "\u{fa71}"
        case .signalTwoRegular: return "\u{fa72}"
        case .signalZeroBold: return "\u{fa73}"
        case .signalZeroLight: return "\u{fa74}"
        case .signalZeroRegular: return "\u{fa75}"
        case .simplePromotionBold: return "\u{fa76}"
        case .simplePromotionLight: return "\u{fa77}"
        case .simplePromotionRegular: return "\u{fa78}"
        case .singleNumberReachBold: return "\u{fa79}"
        case .singleNumberReachLight: return "\u{fa7a}"
        case .singleNumberReachRegular: return "\u{fa7b}"
        case .sipRegistrationInProgressBold: return "\u{fa7c}"
        case .sipRegistrationInProgressFilled: return "\u{fa7d}"
        case .sipRegistrationInProgressLight: return "\u{fa7e}"
        case .sipRegistrationInProgressRegular: return "\u{fa7f}"
        case .skipBold: return "\u{fa80}"
        case .skipBwBold: return "\u{fa81}"
        case .skipBwFilled: return "\u{fa82}"
        case .skipBwLight: return "\u{fa83}"
        case .skipBwRegular: return "\u{fa84}"
        case .skipFwBold: return "\u{fa85}"
        case .skipFwFilled: return "\u{fa86}"
        case .skipFwLight: return "\u{fa87}"
        case .skipFwRegular: return "\u{fa88}"
        case .skipLight: return "\u{fa89}"
        case .skipRegular: return "\u{fa8a}"
        case .smartAudioBold: return "\u{fa8b}"
        case .smartAudioLight: return "\u{fa8c}"
        case .smartAudioRegular: return "\u{fa8d}"
        case .smsFilled: return "\u{fa8e}"
        case .smsInboundBold: return "\u{fa8f}"
        case .smsInboundLight: return "\u{fa90}"
        case .smsInboundRegular: return "\u{fa91}"
        case .smsMessageBold: return "\u{fa92}"
        case .smsMessageFilled: return "\u{fa93}"
        case .smsMessageLight: return "\u{fa94}"
        case .smsMessageRegular: return "\u{fa95}"
        case .smsOutgoingFilled: return "\u{fa96}"
        case .smsUnreadBold: return "\u{fa97}"
        case .smsUnreadLight: return "\u{fa98}"
        case .smsUnreadRegular: return "\u{fa99}"
        case .sortAscendingBold: return "\u{fa9a}"
        case .sortAscendingLight: return "\u{fa9b}"
        case .sortAscendingRegular: return "\u{fa9c}"
        case .sortDescendingBold: return "\u{fa9d}"
        case .sortDescendingLight: return "\u{fa9e}"
        case .sortDescendingRegular: return "\u{fa9f}"
        case .soundDefaultBold: return "\u{faa0}"
        case .soundDefaultLight: return "\u{faa1}"
        case .soundDefaultRegular: return "\u{faa2}"
        case .sparkleBold: return "\u{faa3}"
        case .sparkleFilled: return "\u{faa4}"
        case .sparkleLight: return "\u{faa5}"
        case .sparkleRegular: return "\u{faa6}"
        case .speakerBold: return "\u{faa7}"
        case .speakerDisconnectedBold: return "\u{faa8}"
        case .speakerDisconnectedFilled: return "\u{faa9}"
        case .speakerDisconnectedLight: return "\u{faaa}"
        case .speakerDisconnectedRegular: return "\u{faab}"
        case .speakerFilled: return "\u{faac}"
        case .speakerLight: return "\u{faad}"
        case .speakerMutedBold: return "\u{faae}"
        case .speakerMutedFilled: return "\u{faaf}"
        case .speakerMutedLight: return "\u{fab0}"
        case .speakerMutedRegular: return "\u{fab1}"
        case .speakerOffBold: return "\u{fab2}"
        case .speakerOffFilled: return "\u{fab3}"
        case .speakerOffLight: return "\u{fab4}"
        case .speakerOffRegular: return "\u{fab5}"
        case .speakerOnBold: return "\u{fab6}"
        case .speakerOnLight: return "\u{fab7}"
        case .speakerOnRegular: return "\u{fab8}"
        case .speakerRegular: return "\u{fab9}"
        case .speakerTurnDownBold: return "\u{faba}"
        case .speakerTurnDownFilled: return "\u{fabb}"
        case .speakerTurnDownLight: return "\u{fabc}"
        case .speakerTurnDownRegular: return "\u{fabd}"
        case .speakerTurnUpBold: return "\u{fabe}"
        case .speakerTurnUpFilled: return "\u{fabf}"
        case .speakerTurnUpLight: return "\u{fac0}"
        case .speakerTurnUpRegular: return "\u{fac1}"
        case .speedDialBold: return "\u{fac2}"
        case .speedDialFilled: return "\u{fac3}"
        case .speedDialLight: return "\u{fac4}"
        case .speedDialRegular: return "\u{fac5}"
        case .spellCheckerBold: return "\u{fac6}"
        case .spellCheckerLight: return "\u{fac7}"
        case .spellCheckerRegular: return "\u{fac8}"
        case .splitViewBold: return "\u{fac9}"
        case .splitViewLight: return "\u{faca}"
        case .splitViewRegular: return "\u{facb}"
        case .stackedAreaChartBold: return "\u{facc}"
        case .stackedAreaChartFilled: return "\u{facd}"
        case .stackedAreaChartFullBold: return "\u{face}"
        case .stackedAreaChartFullFilled: return "\u{facf}"
        case .stackedAreaChartFullLight: return "\u{fad0}"
        case .stackedAreaChartFullRegular: return "\u{fad1}"
        case .stackedAreaChartLight: return "\u{fad2}"
        case .stackedAreaChartRegular: return "\u{fad3}"
        case .stackedBarChartBold: return "\u{fad4}"
        case .stackedBarChartFilled: return "\u{fad5}"
        case .stackedBarChartFullBold: return "\u{fad6}"
        case .stackedBarChartFullFilled: return "\u{fad7}"
        case .stackedBarChartFullLight: return "\u{fad8}"
        case .stackedBarChartFullRegular: return "\u{fad9}"
        case .stackedBarChartLight: return "\u{fada}"
        case .stackedBarChartRegular: return "\u{fadb}"
        case .startChatBold: return "\u{fadc}"
        case .startChatLight: return "\u{fadd}"
        case .startChatRegular: return "\u{fade}"
        case .stethoscopeBold: return "\u{fadf}"
        case .stethoscopeLight: return "\u{fae0}"
        case .stethoscopeRegular: return "\u{fae1}"
        case .stickersBold: return "\u{fae2}"
        case .stickersLight: return "\u{fae3}"
        case .stickersRegular: return "\u{fae4}"
        case .stickiesBold: return "\u{fae5}"
        case .stickiesLight: return "\u{fae6}"
        case .stickiesRegular: return "\u{fae7}"
        case .stopBold: return "\u{fae8}"
        case .stopCircleBold: return "\u{fae9}"
        case .stopCircleFilled: return "\u{faea}"
        case .stopCircleLight: return "\u{faeb}"
        case .stopCircleRegular: return "\u{faec}"
        case .stopContentShareBold: return "\u{faed}"
        case .stopContentShareLight: return "\u{faee}"
        case .stopContentShareRegular: return "\u{faef}"
        case .stopFilled: return "\u{faf0}"
        case .stopLight: return "\u{faf1}"
        case .stopRegular: return "\u{faf2}"
        case .storedInfoBold: return "\u{faf3}"
        case .storedInfoFilled: return "\u{faf4}"
        case .storedInfoLight: return "\u{faf5}"
        case .storedInfoRegular: return "\u{faf6}"
        case .streamingBold: return "\u{faf7}"
        case .streamingLight: return "\u{faf8}"
        case .streamingRegular: return "\u{faf9}"
        case .strikethroughBold: return "\u{fafa}"
        case .strikethroughFilled: return "\u{fafb}"
        case .strikethroughLight: return "\u{fafc}"
        case .strikethroughRegular: return "\u{fafd}"
        case .studioModeBold: return "\u{fafe}"
        case .studioModeLight: return "\u{faff}"
        case .studioModeRegular: return "\u{fb00}"
        case .subscriptBold: return "\u{fb01}"
        case .subscriptLight: return "\u{fb02}"
        case .subscriptRegular: return "\u{fb03}"
        case .summarizeAiBold: return "\u{fb04}"
        case .summarizeAiLight: return "\u{fb05}"
        case .summarizeAiRegular: return "\u{fb06}"
        case .superscriptBold: return "\u{fb07}"
        case .superscriptLight: return "\u{fb08}"
        case .superscriptRegular: return "\u{fb09}"
        case .surveyBold: return "\u{fb0a}"
        case .surveyFilled: return "\u{fb0b}"
        case .surveyLight: return "\u{fb0c}"
        case .surveyRegular: return "\u{fb0d}"
        case .sxEightyCodecBold: return "\u{fb0e}"
        case .sxEightyCodecLight: return "\u{fb0f}"
        case .sxEightyCodecRegular: return "\u{fb10}"
        case .sxTenBold: return "\u{fb11}"
        case .sxTenLight: return "\u{fb12}"
        case .sxTenRegular: return "\u{fb13}"
        case .sxTwentyBold: return "\u{fb14}"
        case .sxTwentyLight: return "\u{fb15}"
        case .sxTwentyRegular: return "\u{fb16}"
        case .tableBold: return "\u{fb17}"
        case .tableLight: return "\u{fb18}"
        case .tableRegular: return "\u{fb19}"
        case .tabletBold: return "\u{fb1a}"
        case .tabletLight: return "\u{fb1b}"
        case .tabletRegular: return "\u{fb1c}"
        case .tabsBold: return "\u{fb1d}"
        case .tabsLight: return "\u{fb1e}"
        case .tabsRegular: return "\u{fb1f}"
        case .tagBold: return "\u{fb20}"
        case .tagLight: return "\u{fb21}"
        case .tagRegular: return "\u{fb22}"
        case .tapBold: return "\u{fb23}"
        case .tapFilled: return "\u{fb24}"
        case .tapLight: return "\u{fb25}"
        case .tapRegular: return "\u{fb26}"
        case .telepresenceAlertBold: return "\u{fb27}"
        case .telepresenceAlertLight: return "\u{fb28}"
        case .telepresenceAlertMutedBold: return "\u{fb29}"
        case .telepresenceAlertMutedLight: return "\u{fb2a}"
        case .telepresenceAlertMutedRegular: return "\u{fb2b}"
        case .telepresenceAlertRegular: return "\u{fb2c}"
        case .telepresenceBold: return "\u{fb2d}"
        case .telepresenceIxFiveThousandBold: return "\u{fb2e}"
        case .telepresenceIxFiveThousandLight: return "\u{fb2f}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb30}"
        case .telepresenceLight: return "\u{fb31}"
        case .telepresenceMutedBold: return "\u{fb32}"
        case .telepresenceMutedLight: return "\u{fb33}"
        case .telepresenceMutedRegular: return "\u{fb34}"
        case .telepresencePrivateBold: return "\u{fb35}"
        case .telepresencePrivateLight: return "\u{fb36}"
        case .telepresencePrivateRegular: return "\u{fb37}"
        case .telepresenceRegular: return "\u{fb38}"
        case .temperatureBold: return "\u{fb39}"
        case .temperatureLight: return "\u{fb3a}"
        case .temperatureRegular: return "\u{fb3b}"
        case .testTubeBold: return "\u{fb3c}"
        case .testTubeFilled: return "\u{fb3d}"
        case .testTubeLight: return "\u{fb3e}"
        case .testTubeRegular: return "\u{fb3f}"
        case .textAlignCenterBold: return "\u{fb40}"
        case .textAlignCenterFilled: return "\u{fb41}"
        case .textAlignCenterLight: return "\u{fb42}"
        case .textAlignCenterRegular: return "\u{fb43}"
        case .textAlignLeftBold: return "\u{fb44}"
        case .textAlignLeftFilled: return "\u{fb45}"
        case .textAlignLeftLight: return "\u{fb46}"
        case .textAlignLeftRegular: return "\u{fb47}"
        case .textAlignRightBold: return "\u{fb48}"
        case .textAlignRightFilled: return "\u{fb49}"
        case .textAlignRightLight: return "\u{fb4a}"
        case .textAlignRightRegular: return "\u{fb4b}"
        case .textBold: return "\u{fb4c}"
        case .textBoxCursorLight: return "\u{fb4d}"
        case .textCodeBlockBold: return "\u{fb4e}"
        case .textCodeBlockLight: return "\u{fb4f}"
        case .textCodeBlockRegular: return "\u{fb50}"
        case .textHighlightBold: return "\u{fb51}"
        case .textHighlightFilled: return "\u{fb52}"
        case .textHighlightLight: return "\u{fb53}"
        case .textHighlightRegular: return "\u{fb54}"
        case .textLight: return "\u{fb55}"
        case .textRegular: return "\u{fb56}"
        case .threeColumnBold: return "\u{fb57}"
        case .threeColumnLight: return "\u{fb58}"
        case .threeColumnRegular: return "\u{fb59}"
        case .threeDObjectBold: return "\u{fb5a}"
        case .threeDObjectLight: return "\u{fb5b}"
        case .threeDObjectRegular: return "\u{fb5c}"
        case .timeExclusionBold: return "\u{fb5d}"
        case .timeExclusionLight: return "\u{fb5e}"
        case .timeExclusionRegular: return "\u{fb5f}"
        case .tooFastBold: return "\u{fb60}"
        case .tooFastLight: return "\u{fb61}"
        case .tooFastRegular: return "\u{fb62}"
        case .tooSlowBold: return "\u{fb63}"
        case .tooSlowLight: return "\u{fb64}"
        case .tooSlowRegular: return "\u{fb65}"
        case .toolsBold: return "\u{fb66}"
        case .toolsFilled: return "\u{fb67}"
        case .toolsLight: return "\u{fb68}"
        case .toolsRegular: return "\u{fb69}"
        case .touchTenBold: return "\u{fb6a}"
        case .touchTenLight: return "\u{fb6b}"
        case .touchTenRegular: return "\u{fb6c}"
        case .transcriptBold: return "\u{fb6d}"
        case .transcriptFilled: return "\u{fb6e}"
        case .transcriptLight: return "\u{fb6f}"
        case .transcriptRegular: return "\u{fb70}"
        case .translateBold: return "\u{fb71}"
        case .translateLight: return "\u{fb72}"
        case .translateRegular: return "\u{fb73}"
        case .translateUndoBold: return "\u{fb74}"
        case .translateUndoLight: return "\u{fb75}"
        case .translateUndoRegular: return "\u{fb76}"
        case .trendingBold: return "\u{fb77}"
        case .trendingDownBold: return "\u{fb78}"
        case .trendingDownFilled: return "\u{fb79}"
        case .trendingDownLight: return "\u{fb7a}"
        case .trendingDownRegular: return "\u{fb7b}"
        case .trendingFilled: return "\u{fb7c}"
        case .trendingLight: return "\u{fb7d}"
        case .trendingRegular: return "\u{fb7e}"
        case .trimBold: return "\u{fb7f}"
        case .trimLight: return "\u{fb80}"
        case .trimRegular: return "\u{fb81}"
        case .twoColumnBold: return "\u{fb82}"
        case .twoColumnLight: return "\u{fb83}"
        case .twoColumnRegular: return "\u{fb84}"
        case .twoWayVoiceStreamBold: return "\u{fb85}"
        case .twoWayVoiceStreamFilled: return "\u{fb86}"
        case .twoWayVoiceStreamLight: return "\u{fb87}"
        case .twoWayVoiceStreamRegular: return "\u{fb88}"
        case .ucmCloudBold: return "\u{fb89}"
        case .ucmCloudLight: return "\u{fb8a}"
        case .ucmCloudRegular: return "\u{fb8b}"
        case .unblockBold: return "\u{fb8c}"
        case .unblockFilled: return "\u{fb8d}"
        case .unblockLight: return "\u{fb8e}"
        case .unblockRegular: return "\u{fb8f}"
        case .underlineBold: return "\u{fb90}"
        case .underlineFilled: return "\u{fb91}"
        case .underlineLight: return "\u{fb92}"
        case .underlineRegular: return "\u{fb93}"
        case .undoBold: return "\u{fb94}"
        case .undoLight: return "\u{fb95}"
        case .undoRegular: return "\u{fb96}"
        case .unlinkBold: return "\u{fb97}"
        case .unlinkLight: return "\u{fb98}"
        case .unlinkRegular: return "\u{fb99}"
        case .unreadBold: return "\u{fb9a}"
        case .unreadFilled: return "\u{fb9b}"
        case .unreadLight: return "\u{fb9c}"
        case .unreadRegular: return "\u{fb9d}"
        case .unsecureUnlockedBold: return "\u{fb9e}"
        case .unsecureUnlockedFilled: return "\u{fb9f}"
        case .unsecureUnlockedLight: return "\u{fba0}"
        case .unsecureUnlockedRegular: return "\u{fba1}"
        case .unsortedBold: return "\u{fba2}"
        case .unsortedLight: return "\u{fba3}"
        case .unsortedRegular: return "\u{fba4}"
        case .updateFileShareBold: return "\u{fba5}"
        case .updateFileShareLight: return "\u{fba6}"
        case .updateFileShareRegular: return "\u{fba7}"
        case .uploadBold: return "\u{fba8}"
        case .uploadImageBold: return "\u{fba9}"
        case .uploadImageLight: return "\u{fbaa}"
        case .uploadImageRegular: return "\u{fbab}"
        case .uploadLight: return "\u{fbac}"
        case .uploadRegular: return "\u{fbad}"
        case .urgentVoicemailBold: return "\u{fbae}"
        case .urgentVoicemailFilled: return "\u{fbaf}"
        case .usbBold: return "\u{fbb0}"
        case .usbHeadsetBold: return "\u{fbb1}"
        case .usbHeadsetLight: return "\u{fbb2}"
        case .usbHeadsetMutedBold: return "\u{fbb3}"
        case .usbHeadsetMutedLight: return "\u{fbb4}"
        case .usbHeadsetMutedRegular: return "\u{fbb5}"
        case .usbHeadsetRegular: return "\u{fbb6}"
        case .usbLight: return "\u{fbb7}"
        case .usbRegular: return "\u{fbb8}"
        case .userBold: return "\u{fbb9}"
        case .userDeactivateBold: return "\u{fbba}"
        case .userDeactivateLight: return "\u{fbbb}"
        case .userDeactivateRegular: return "\u{fbbc}"
        case .userLight: return "\u{fbbd}"
        case .userRegular: return "\u{fbbe}"
        case .videoBlurBold: return "\u{fbbf}"
        case .videoBlurFilled: return "\u{fbc0}"
        case .videoBlurLight: return "\u{fbc1}"
        case .videoBlurRegular: return "\u{fbc2}"
        case .videoBold: return "\u{fbc3}"
        case .videoEffectBold: return "\u{fbc4}"
        case .videoEffectFilled: return "\u{fbc5}"
        case .videoEffectLight: return "\u{fbc6}"
        case .videoEffectRegular: return "\u{fbc7}"
        case .videoFilled: return "\u{fbc8}"
        case .videoLayoutBold: return "\u{fbc9}"
        case .videoLayoutEqualBold: return "\u{fbca}"
        case .videoLayoutEqualDualBold: return "\u{fbcb}"
        case .videoLayoutEqualDualLight: return "\u{fbcc}"
        case .videoLayoutEqualDualRegular: return "\u{fbcd}"
        case .videoLayoutEqualFilled: return "\u{fbce}"
        case .videoLayoutEqualLight: return "\u{fbcf}"
        case .videoLayoutEqualRegular: return "\u{fbd0}"
        case .videoLayoutFilled: return "\u{fbd1}"
        case .videoLayoutLight: return "\u{fbd2}"
        case .videoLayoutOverlayBold: return "\u{fbd3}"
        case .videoLayoutOverlayFilled: return "\u{fbd4}"
        case .videoLayoutOverlayLight: return "\u{fbd5}"
        case .videoLayoutOverlayRegular: return "\u{fbd6}"
        case .videoLayoutPresenterDominantBold: return "\u{fbd7}"
        case .videoLayoutPresenterDominantLight: return "\u{fbd8}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbd9}"
        case .videoLayoutProminentBold: return "\u{fbda}"
        case .videoLayoutProminentFilled: return "\u{fbdb}"
        case .videoLayoutProminentLight: return "\u{fbdc}"
        case .videoLayoutProminentRegular: return "\u{fbdd}"
        case .videoLayoutRegular: return "\u{fbde}"
        case .videoLayoutShareDominantBold: return "\u{fbdf}"
        case .videoLayoutShareDominantLight: return "\u{fbe0}"
        case .videoLayoutShareDominantRegular: return "\u{fbe1}"
        case .videoLayoutSingleBold: return "\u{fbe2}"
        case .videoLayoutSingleFilled: return "\u{fbe3}"
        case .videoLayoutSingleLight: return "\u{fbe4}"
        case .videoLayoutSingleRegular: return "\u{fbe5}"
        case .videoLayoutStackBold: return "\u{fbe6}"
        case .videoLayoutStackFilled: return "\u{fbe7}"
        case .videoLayoutStackLight: return "\u{fbe8}"
        case .videoLayoutStackRegular: return "\u{fbe9}"
        case .videoLayoutVideoDominantBold: return "\u{fbea}"
        case .videoLayoutVideoDominantFilled: return "\u{fbeb}"
        case .videoLayoutVideoDominantLight: return "\u{fbec}"
        case .videoLayoutVideoDominantRegular: return "\u{fbed}"
        case .videoLight: return "\u{fbee}"
        case .videoPlusBold: return "\u{fbef}"
        case .videoPlusFilled: return "\u{fbf0}"
        case .videoPlusLight: return "\u{fbf1}"
        case .videoPlusRegular: return "\u{fbf2}"
        case .videoRegular: return "\u{fbf3}"
        case .videoSpeakerTrackBold: return "\u{fbf4}"
        case .videoSpeakerTrackFilled: return "\u{fbf5}"
        case .videoSpeakerTrackLight: return "\u{fbf6}"
        case .videoSpeakerTrackRegular: return "\u{fbf7}"
        case .viewAllBold: return "\u{fbf8}"
        case .viewAllLight: return "\u{fbf9}"
        case .viewAllRegular: return "\u{fbfa}"
        case .viewListBold: return "\u{fbfb}"
        case .viewListFilled: return "\u{fbfc}"
        case .viewListLight: return "\u{fbfd}"
        case .viewListRegular: return "\u{fbfe}"
        case .viewStackedBold: return "\u{fbff}"
        case .viewStackedFilled: return "\u{fc00}"
        case .viewStackedLight: return "\u{fc01}"
        case .viewStackedRegular: return "\u{fc02}"
        case .viewThumbnailBold: return "\u{fc03}"
        case .viewThumbnailFilled: return "\u{fc04}"
        case .viewThumbnailLight: return "\u{fc05}"
        case .viewThumbnailRegular: return "\u{fc06}"
        case .visionproBold: return "\u{fc07}"
        case .visionproFilled: return "\u{fc08}"
        case .visionproLight: return "\u{fc09}"
        case .visionproMoveCallInBold: return "\u{fc0a}"
        case .visionproMoveCallInFilled: return "\u{fc0b}"
        case .visionproMoveCallInLight: return "\u{fc0c}"
        case .visionproMoveCallInOutBold: return "\u{fc0d}"
        case .visionproMoveCallInOutFilled: return "\u{fc0e}"
        case .visionproMoveCallInOutLight: return "\u{fc0f}"
        case .visionproMoveCallInOutRegular: return "\u{fc10}"
        case .visionproMoveCallInRegular: return "\u{fc11}"
        case .visionproMoveCallOutBold: return "\u{fc12}"
        case .visionproMoveCallOutFilled: return "\u{fc13}"
        case .visionproMoveCallOutLight: return "\u{fc14}"
        case .visionproMoveCallOutRegular: return "\u{fc15}"
        case .visionproRegular: return "\u{fc16}"
        case .voicemailBold: return "\u{fc17}"
        case .voicemailFilled: return "\u{fc18}"
        case .voicemailLight: return "\u{fc19}"
        case .voicemailRegular: return "\u{fc1a}"
        case .vpnBold: return "\u{fc1b}"
        case .vpnFilled: return "\u{fc1c}"
        case .vpnLight: return "\u{fc1d}"
        case .vpnRegular: return "\u{fc1e}"
        case .vscBold: return "\u{fc1f}"
        case .vscLight: return "\u{fc20}"
        case .vscRegular: return "\u{fc21}"
        case .waffleMenuBold: return "\u{fc22}"
        case .waffleMenuLight: return "\u{fc23}"
        case .waffleMenuRegular: return "\u{fc24}"
        case .waitingRoomBold: return "\u{fc25}"
        case .waitingRoomLight: return "\u{fc26}"
        case .waitingRoomRegular: return "\u{fc27}"
        case .wallpaperBold: return "\u{fc28}"
        case .wallpaperLight: return "\u{fc29}"
        case .wallpaperRegular: return "\u{fc2a}"
        case .warningBadgeFilled: return "\u{fc2b}"
        case .warningBold: return "\u{fc2c}"
        case .warningFilled: return "\u{fc2d}"
        case .warningLight: return "\u{fc2e}"
        case .warningRegular: return "\u{fc2f}"
        case .webexBoardBold: return "\u{fc30}"
        case .webexBoardLight: return "\u{fc31}"
        case .webexBoardRegular: return "\u{fc32}"
        case .webexCodecPlusBold: return "\u{fc33}"
        case .webexCodecPlusLight: return "\u{fc34}"
        case .webexCodecPlusRegular: return "\u{fc35}"
        case .webexDeskCameraBold: return "\u{fc36}"
        case .webexDeskCameraLight: return "\u{fc37}"
        case .webexDeskCameraRegular: return "\u{fc38}"
        case .webexHelixBold: return "\u{fc39}"
        case .webexHelixLight: return "\u{fc3a}"
        case .webexHelixRegular: return "\u{fc3b}"
        case .webexMeetingsBold: return "\u{fc3c}"
        case .webexMeetingsFilled: return "\u{fc3d}"
        case .webexMeetingsLight: return "\u{fc3e}"
        case .webexMeetingsRegular: return "\u{fc3f}"
        case .webexQuadCameraBold: return "\u{fc40}"
        case .webexQuadCameraLight: return "\u{fc41}"
        case .webexQuadCameraRegular: return "\u{fc42}"
        case .webexRoomKitBold: return "\u{fc43}"
        case .webexRoomKitLight: return "\u{fc44}"
        case .webexRoomKitPlusBold: return "\u{fc45}"
        case .webexRoomKitPlusLight: return "\u{fc46}"
        case .webexRoomKitPlusRegular: return "\u{fc47}"
        case .webexRoomKitRegular: return "\u{fc48}"
        case .webexShareBold: return "\u{fc49}"
        case .webexShareLight: return "\u{fc4a}"
        case .webexShareRegular: return "\u{fc4b}"
        case .webexTeamsBold: return "\u{fc4c}"
        case .webexTeamsFilled: return "\u{fc4d}"
        case .webexTeamsLight: return "\u{fc4e}"
        case .webexTeamsNewBold: return "\u{fc4f}"
        case .webexTeamsNewFilled: return "\u{fc50}"
        case .webexTeamsNewLight: return "\u{fc51}"
        case .webexTeamsNewRegular: return "\u{fc52}"
        case .webexTeamsRegular: return "\u{fc53}"
        case .webexTeamsRemoveBold: return "\u{fc54}"
        case .webexTeamsRemoveLight: return "\u{fc55}"
        case .webexTeamsRemoveRegular: return "\u{fc56}"
        case .webinarBold: return "\u{fc57}"
        case .webinarFilled: return "\u{fc58}"
        case .webinarLight: return "\u{fc59}"
        case .webinarRegular: return "\u{fc5a}"
        case .weeklyRecurringScheduleBold: return "\u{fc5b}"
        case .weeklyRecurringScheduleLight: return "\u{fc5c}"
        case .weeklyRecurringScheduleRegular: return "\u{fc5d}"
        case .whisperAnnouncementBold: return "\u{fc5e}"
        case .whisperAnnouncementFilled: return "\u{fc5f}"
        case .whisperAnnouncementLight: return "\u{fc60}"
        case .whisperAnnouncementRegular: return "\u{fc61}"
        case .whisperCoachBold: return "\u{fc62}"
        case .whisperCoachFilled: return "\u{fc63}"
        case .whisperCoachLight: return "\u{fc64}"
        case .whisperCoachRegular: return "\u{fc65}"
        case .whiteboardBold: return "\u{fc66}"
        case .whiteboardContentBold: return "\u{fc67}"
        case .whiteboardContentFilled: return "\u{fc68}"
        case .whiteboardContentLight: return "\u{fc69}"
        case .whiteboardContentRegular: return "\u{fc6a}"
        case .whiteboardFilled: return "\u{fc6b}"
        case .whiteboardLight: return "\u{fc6c}"
        case .whiteboardRegular: return "\u{fc6d}"
        case .widgetBold: return "\u{fc6e}"
        case .widgetFilled: return "\u{fc6f}"
        case .widgetLight: return "\u{fc70}"
        case .widgetRegular: return "\u{fc71}"
        case .wifiBold: return "\u{fc72}"
        case .wifiErrorBold: return "\u{fc73}"
        case .wifiErrorLight: return "\u{fc74}"
        case .wifiErrorRegular: return "\u{fc75}"
        case .wifiLight: return "\u{fc76}"
        case .wifiRegular: return "\u{fc77}"
        case .wifiSignalGoodBold: return "\u{fc78}"
        case .wifiSignalGoodLight: return "\u{fc79}"
        case .wifiSignalGoodRegular: return "\u{fc7a}"
        case .wifiSignalPoorBold: return "\u{fc7b}"
        case .wifiSignalPoorLight: return "\u{fc7c}"
        case .wifiSignalPoorRegular: return "\u{fc7d}"
        case .wifiSignalUnstableBold: return "\u{fc7e}"
        case .wifiSignalUnstableLight: return "\u{fc7f}"
        case .wifiSignalUnstableRegular: return "\u{fc80}"
        case .windowCornerScrubBold: return "\u{fc81}"
        case .windowCornerScrubLight: return "\u{fc82}"
        case .windowCornerScrubRegular: return "\u{fc83}"
        case .windowRightCornerScrubBold: return "\u{fc84}"
        case .windowRightCornerScrubLight: return "\u{fc85}"
        case .windowRightCornerScrubRegular: return "\u{fc86}"
        case .windowVerticalScrubBold: return "\u{fc87}"
        case .windowVerticalScrubLight: return "\u{fc88}"
        case .windowVerticalScrubRegular: return "\u{fc89}"
        case .workflowDeploymentsBold: return "\u{fc8a}"
        case .workflowDeploymentsFilled: return "\u{fc8b}"
        case .workflowDeploymentsLight: return "\u{fc8c}"
        case .workflowDeploymentsRegular: return "\u{fc8d}"
        case .workphoneBold: return "\u{fc8e}"
        case .workphoneLight: return "\u{fc8f}"
        case .workphoneRegular: return "\u{fc90}"
        case .zoomInBold: return "\u{fc91}"
        case .zoomInLight: return "\u{fc92}"
        case .zoomInRegular: return "\u{fc93}"
        case .zoomOutBold: return "\u{fc94}"
        case .zoomOutLight: return "\u{fc95}"
        case .zoomOutRegular: return "\u{fc96}"
