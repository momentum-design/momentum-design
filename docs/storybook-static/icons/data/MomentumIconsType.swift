...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .callBargeBold: return "\u{f2bc}"
        case .callBargeFilled: return "\u{f2bd}"
        case .callBargeLight: return "\u{f2be}"
        case .callBargeRegular: return "\u{f2bf}"
        case .callBargeSilentBold: return "\u{f2c0}"
        case .callBargeSilentLight: return "\u{f2c1}"
        case .callBargeSilentRegular: return "\u{f2c2}"
        case .callForwardSettingsBold: return "\u{f2c3}"
        case .callForwardSettingsFilled: return "\u{f2c4}"
        case .callForwardSettingsLight: return "\u{f2c5}"
        case .callForwardSettingsRegular: return "\u{f2c6}"
        case .callGroupPickupBold: return "\u{f2c7}"
        case .callGroupPickupFilled: return "\u{f2c8}"
        case .callGroupPickupLight: return "\u{f2c9}"
        case .callGroupPickupRegular: return "\u{f2ca}"
        case .callHandlingBold: return "\u{f2cb}"
        case .callHandlingLight: return "\u{f2cc}"
        case .callHandlingRegular: return "\u{f2cd}"
        case .callHoldBold: return "\u{f2ce}"
        case .callHoldFilled: return "\u{f2cf}"
        case .callHoldLight: return "\u{f2d0}"
        case .callHoldRegular: return "\u{f2d1}"
        case .callIncomingBold: return "\u{f2d2}"
        case .callIncomingLight: return "\u{f2d3}"
        case .callIncomingRegular: return "\u{f2d4}"
        case .callListBold: return "\u{f2d5}"
        case .callListLight: return "\u{f2d6}"
        case .callListRegular: return "\u{f2d7}"
        case .callMergeBold: return "\u{f2d8}"
        case .callMergeFilled: return "\u{f2d9}"
        case .callMergeLight: return "\u{f2da}"
        case .callMergeRegular: return "\u{f2db}"
        case .callMissedBold: return "\u{f2dc}"
        case .callMissedFilled: return "\u{f2dd}"
        case .callMissedLight: return "\u{f2de}"
        case .callMissedRegular: return "\u{f2df}"
        case .callMoreBold: return "\u{f2e0}"
        case .callMoreLight: return "\u{f2e1}"
        case .callMoreRegular: return "\u{f2e2}"
        case .callOutgoingBold: return "\u{f2e3}"
        case .callOutgoingLight: return "\u{f2e4}"
        case .callOutgoingRegular: return "\u{f2e5}"
        case .callPickupBold: return "\u{f2e6}"
        case .callPickupFilled: return "\u{f2e7}"
        case .callPickupLight: return "\u{f2e8}"
        case .callPickupOtherBold: return "\u{f2e9}"
        case .callPickupOtherFilled: return "\u{f2ea}"
        case .callPickupOtherLight: return "\u{f2eb}"
        case .callPickupOtherRegular: return "\u{f2ec}"
        case .callPickupRegular: return "\u{f2ed}"
        case .callPrivateBold: return "\u{f2ee}"
        case .callPrivateFilled: return "\u{f2ef}"
        case .callPrivateLight: return "\u{f2f0}"
        case .callPrivateRegular: return "\u{f2f1}"
        case .callRemoteBold: return "\u{f2f2}"
        case .callRemoteFilled: return "\u{f2f3}"
        case .callRemoteLight: return "\u{f2f4}"
        case .callRemoteRegular: return "\u{f2f5}"
        case .callRequestBold: return "\u{f2f6}"
        case .callRequestFilled: return "\u{f2f7}"
        case .callRequestLight: return "\u{f2f8}"
        case .callRequestRegular: return "\u{f2f9}"
        case .callReturnBold: return "\u{f2fa}"
        case .callReturnFilled: return "\u{f2fb}"
        case .callReturnLight: return "\u{f2fc}"
        case .callReturnRegular: return "\u{f2fd}"
        case .callRoomBold: return "\u{f2fe}"
        case .callRoomLight: return "\u{f2ff}"
        case .callRoomRegular: return "\u{f300}"
        case .callSettingsBold: return "\u{f301}"
        case .callSettingsLight: return "\u{f302}"
        case .callSettingsRegular: return "\u{f303}"
        case .callSplitBold: return "\u{f304}"
        case .callSplitLight: return "\u{f305}"
        case .callSplitRegular: return "\u{f306}"
        case .callSwapBold: return "\u{f307}"
        case .callSwapLight: return "\u{f308}"
        case .callSwapRegular: return "\u{f309}"
        case .callVoicemailBold: return "\u{f30a}"
        case .callVoicemailLight: return "\u{f30b}"
        case .callVoicemailRegular: return "\u{f30c}"
        case .callrateBold: return "\u{f30d}"
        case .callrateLight: return "\u{f30e}"
        case .callrateRegular: return "\u{f30f}"
        case .cameraAuxBold: return "\u{f310}"
        case .cameraAuxFilled: return "\u{f311}"
        case .cameraAuxLight: return "\u{f312}"
        case .cameraAuxRegular: return "\u{f313}"
        case .cameraBold: return "\u{f314}"
        case .cameraFilled: return "\u{f315}"
        case .cameraLight: return "\u{f316}"
        case .cameraMutedBold: return "\u{f317}"
        case .cameraMutedCircleFilled: return "\u{f318}"
        case .cameraMutedFilled: return "\u{f319}"
        case .cameraMutedLight: return "\u{f31a}"
        case .cameraMutedRegular: return "\u{f31b}"
        case .cameraOnBold: return "\u{f31c}"
        case .cameraOnFilled: return "\u{f31d}"
        case .cameraOnLight: return "\u{f31e}"
        case .cameraOnRegular: return "\u{f31f}"
        case .cameraPhotoBold: return "\u{f320}"
        case .cameraPhotoFilled: return "\u{f321}"
        case .cameraPhotoLight: return "\u{f322}"
        case .cameraPhotoRegular: return "\u{f323}"
        case .cameraPresenceBold: return "\u{f324}"
        case .cameraPresenceFilled: return "\u{f325}"
        case .cameraPresenceLight: return "\u{f326}"
        case .cameraPresenceRegular: return "\u{f327}"
        case .cameraRegular: return "\u{f328}"
        case .cameraSwapBold: return "\u{f329}"
        case .cameraSwapLight: return "\u{f32a}"
        case .cameraSwapRegular: return "\u{f32b}"
        case .campaignManagementBold: return "\u{f32c}"
        case .campaignManagementLight: return "\u{f32d}"
        case .campaignManagementRegular: return "\u{f32e}"
        case .cancelBold: return "\u{f32f}"
        case .cancelFilled: return "\u{f330}"
        case .cancelLight: return "\u{f331}"
        case .cancelRegular: return "\u{f332}"
        case .capsLockBold: return "\u{f333}"
        case .capsLockLight: return "\u{f334}"
        case .capsLockRegular: return "\u{f335}"
        case .captureRewindBold: return "\u{f336}"
        case .captureRewindLight: return "\u{f337}"
        case .captureRewindRegular: return "\u{f338}"
        case .caroselBold: return "\u{f339}"
        case .caroselLight: return "\u{f33a}"
        case .caroselRegular: return "\u{f33b}"
        case .carouselTextBold: return "\u{f33c}"
        case .carouselTextLight: return "\u{f33d}"
        case .carouselTextRegular: return "\u{f33e}"
        case .cellularBold: return "\u{f33f}"
        case .cellularLight: return "\u{f340}"
        case .cellularRegular: return "\u{f341}"
        case .centerAlignedBold: return "\u{f342}"
        case .centerAlignedLight: return "\u{f343}"
        case .centerAlignedRegular: return "\u{f344}"
        case .centerBold: return "\u{f345}"
        case .centerLight: return "\u{f346}"
        case .centerRegular: return "\u{f347}"
        case .certificateBold: return "\u{f348}"
        case .certificateFilled: return "\u{f349}"
        case .certificateInvalidBold: return "\u{f34a}"
        case .certificateInvalidLight: return "\u{f34b}"
        case .certificateInvalidRegular: return "\u{f34c}"
        case .certificateLight: return "\u{f34d}"
        case .certificateRegular: return "\u{f34e}"
        case .certifiedBold: return "\u{f34f}"
        case .certifiedFilled: return "\u{f350}"
        case .certifiedLight: return "\u{f351}"
        case .certifiedRegular: return "\u{f352}"
        case .chPSearchBold: return "\u{f353}"
        case .chPSearchLight: return "\u{f354}"
        case .chPSearchRegular: return "\u{f355}"
        case .channelUssdBold: return "\u{f356}"
        case .channelUssdFilled: return "\u{f357}"
        case .channelUssdLight: return "\u{f358}"
        case .channelUssdRegular: return "\u{f359}"
        case .chatBold: return "\u{f35a}"
        case .chatFilled: return "\u{f35b}"
        case .chatGroupBold: return "\u{f35c}"
        case .chatGroupFilled: return "\u{f35d}"
        case .chatGroupLight: return "\u{f35e}"
        case .chatGroupRegular: return "\u{f35f}"
        case .chatLight: return "\u{f360}"
        case .chatMuteBold: return "\u{f361}"
        case .chatMuteLight: return "\u{f362}"
        case .chatMuteRegular: return "\u{f363}"
        case .chatOutboundFilled: return "\u{f364}"
        case .chatRegular: return "\u{f365}"
        case .checkBold: return "\u{f366}"
        case .checkCircleBadgeFilled: return "\u{f367}"
        case .checkCircleBold: return "\u{f368}"
        case .checkCircleFilled: return "\u{f369}"
        case .checkCircleLight: return "\u{f36a}"
        case .checkCircleRegular: return "\u{f36b}"
        case .checkFilled: return "\u{f36c}"
        case .checkLight: return "\u{f36d}"
        case .checkRegular: return "\u{f36e}"
        case .checkboxGroupBold: return "\u{f36f}"
        case .checkboxGroupFilled: return "\u{f370}"
        case .checkboxGroupLight: return "\u{f371}"
        case .checkboxGroupRegular: return "\u{f372}"
        case .cleanUpBold: return "\u{f373}"
        case .cleanUpLight: return "\u{f374}"
        case .cleanUpRegular: return "\u{f375}"
        case .clearBadgeFilled: return "\u{f376}"
        case .clearBold: return "\u{f377}"
        case .clearFilled: return "\u{f378}"
        case .clearLight: return "\u{f379}"
        case .clearRegular: return "\u{f37a}"
        case .closeSpaceBold: return "\u{f37b}"
        case .closeSpaceLight: return "\u{f37c}"
        case .closeSpaceRegular: return "\u{f37d}"
        case .closedCaptionBadgeBold: return "\u{f37e}"
        case .closedCaptionBadgeFilled: return "\u{f37f}"
        case .closedCaptionBadgeLight: return "\u{f380}"
        case .closedCaptionBadgeRegular: return "\u{f381}"
        case .closedCaptionsBold: return "\u{f382}"
        case .closedCaptionsFilled: return "\u{f383}"
        case .closedCaptionsLight: return "\u{f384}"
        case .closedCaptionsRegular: return "\u{f385}"
        case .cloudBold: return "\u{f386}"
        case .cloudDownloadBold: return "\u{f387}"
        case .cloudDownloadLight: return "\u{f388}"
        case .cloudDownloadRegular: return "\u{f389}"
        case .cloudFilled: return "\u{f38a}"
        case .cloudFrameBold: return "\u{f38b}"
        case .cloudFrameFilled: return "\u{f38c}"
        case .cloudFrameLight: return "\u{f38d}"
        case .cloudFrameRegular: return "\u{f38e}"
        case .cloudLight: return "\u{f38f}"
        case .cloudMutedBold: return "\u{f390}"
        case .cloudMutedFilled: return "\u{f391}"
        case .cloudMutedLight: return "\u{f392}"
        case .cloudMutedRegular: return "\u{f393}"
        case .cloudRegular: return "\u{f394}"
        case .cloudUploadBold: return "\u{f395}"
        case .cloudUploadLight: return "\u{f396}"
        case .cloudUploadRegular: return "\u{f397}"
        case .codeBlockBold: return "\u{f398}"
        case .codeBlockLight: return "\u{f399}"
        case .codeBlockRegular: return "\u{f39a}"
        case .coffeeBold: return "\u{f39b}"
        case .coffeeLight: return "\u{f39c}"
        case .coffeeRegular: return "\u{f39d}"
        case .colorAccessoriesBold: return "\u{f39e}"
        case .colorAccessoriesFilled: return "\u{f39f}"
        case .colorAccessoriesLight: return "\u{f3a0}"
        case .colorAccessoriesRegular: return "\u{f3a1}"
        case .colorBold: return "\u{f3a2}"
        case .colorFilled: return "\u{f3a3}"
        case .colorLight: return "\u{f3a4}"
        case .colorMeetingSummaryBold: return "\u{f3a5}"
        case .colorMeetingSummaryFilled: return "\u{f3a6}"
        case .colorMeetingSummaryLight: return "\u{f3a7}"
        case .colorMeetingSummaryRegular: return "\u{f3a8}"
        case .colorPromptsAiBold: return "\u{f3a9}"
        case .colorPromptsAiLight: return "\u{f3aa}"
        case .colorPromptsAiRegular: return "\u{f3ab}"
        case .colorRegular: return "\u{f3ac}"
        case .colorScheduleAiBold: return "\u{f3ad}"
        case .colorScheduleAiLight: return "\u{f3ae}"
        case .colorScheduleAiRegular: return "\u{f3af}"
        case .colorSearchAiBold: return "\u{f3b0}"
        case .colorSearchAiLight: return "\u{f3b1}"
        case .colorSearchAiRegular: return "\u{f3b2}"
        case .colorSendBold: return "\u{f3b3}"
        case .colorSendFilled: return "\u{f3b4}"
        case .colorSendLight: return "\u{f3b5}"
        case .colorSendRegular: return "\u{f3b6}"
        case .colorSparkleBold: return "\u{f3b7}"
        case .colorSparkleFilled: return "\u{f3b8}"
        case .colorSparkleLight: return "\u{f3b9}"
        case .colorSparkleRegular: return "\u{f3ba}"
        case .colorSummarizeAiBold: return "\u{f3bb}"
        case .colorSummarizeAiLight: return "\u{f3bc}"
        case .colorSummarizeAiRegular: return "\u{f3bd}"
        case .colourPaletteBold: return "\u{f3be}"
        case .colourPaletteFilled: return "\u{f3bf}"
        case .colourPaletteLight: return "\u{f3c0}"
        case .colourPaletteRegular: return "\u{f3c1}"
        case .commentingBold: return "\u{f3c2}"
        case .commentingFilled: return "\u{f3c3}"
        case .commentingLight: return "\u{f3c4}"
        case .commentingRegular: return "\u{f3c5}"
        case .companyBold: return "\u{f3c6}"
        case .companyLight: return "\u{f3c7}"
        case .companyRegular: return "\u{f3c8}"
        case .completedByBaseBold: return "\u{f3c9}"
        case .completedByBaseLight: return "\u{f3ca}"
        case .completedByBaseRegular: return "\u{f3cb}"
        case .completedByTimeBold: return "\u{f3cc}"
        case .completedByTimeLight: return "\u{f3cd}"
        case .completedByTimeRegular: return "\u{f3ce}"
        case .completedInteractionBold: return "\u{f3cf}"
        case .completedInteractionFilled: return "\u{f3d0}"
        case .completedInteractionLight: return "\u{f3d1}"
        case .completedInteractionRegular: return "\u{f3d2}"
        case .computerBold: return "\u{f3d3}"
        case .computerLight: return "\u{f3d4}"
        case .computerRegular: return "\u{f3d5}"
        case .conciergeBold: return "\u{f3d6}"
        case .conciergeLight: return "\u{f3d7}"
        case .conciergeRegular: return "\u{f3d8}"
        case .conditionalBlockBold: return "\u{f3d9}"
        case .conditionalBlockLight: return "\u{f3da}"
        case .conditionalBlockRegular: return "\u{f3db}"
        case .connectBold: return "\u{f3dc}"
        case .connectLight: return "\u{f3dd}"
        case .connectRegular: return "\u{f3de}"
        case .contactCardBold: return "\u{f3df}"
        case .contactCardFilled: return "\u{f3e0}"
        case .contactCardLight: return "\u{f3e1}"
        case .contactCardRegular: return "\u{f3e2}"
        case .contactsBold: return "\u{f3e3}"
        case .contactsFilled: return "\u{f3e4}"
        case .contactsLight: return "\u{f3e5}"
        case .contactsRegular: return "\u{f3e6}"
        case .contentDownloadBold: return "\u{f3e7}"
        case .contentDownloadFilled: return "\u{f3e8}"
        case .contentDownloadLight: return "\u{f3e9}"
        case .contentDownloadRegular: return "\u{f3ea}"
        case .contentShareBold: return "\u{f3eb}"
        case .contentShareLight: return "\u{f3ec}"
        case .contentShareRegular: return "\u{f3ed}"
        case .contrastBold: return "\u{f3ee}"
        case .contrastLight: return "\u{f3ef}"
        case .contrastRegular: return "\u{f3f0}"
        case .copyBold: return "\u{f3f1}"
        case .copyLight: return "\u{f3f2}"
        case .copyRegular: return "\u{f3f3}"
        case .cpuBold: return "\u{f3f4}"
        case .cpuLight: return "\u{f3f5}"
        case .cpuRegular: return "\u{f3f6}"
        case .createAGroupBold: return "\u{f3f7}"
        case .createAGroupFilled: return "\u{f3f8}"
        case .createAGroupLight: return "\u{f3f9}"
        case .createAGroupRegular: return "\u{f3fa}"
        case .cropBold: return "\u{f3fb}"
        case .cropLight: return "\u{f3fc}"
        case .cropRegular: return "\u{f3fd}"
        case .cucmConnectionBold: return "\u{f3fe}"
        case .cucmConnectionLight: return "\u{f3ff}"
        case .cucmConnectionRegular: return "\u{f400}"
        case .customCodeEditorBold: return "\u{f401}"
        case .customCodeEditorLight: return "\u{f402}"
        case .customCodeEditorRegular: return "\u{f403}"
        case .customTaskBold: return "\u{f404}"
        case .customTaskFilled: return "\u{f405}"
        case .customTaskIndBold: return "\u{f406}"
        case .customTaskIndFilled: return "\u{f407}"
        case .customTaskIndLight: return "\u{f408}"
        case .customTaskIndRegular: return "\u{f409}"
        case .customTaskLight: return "\u{f40a}"
        case .customTaskRegular: return "\u{f40b}"
        case .dailyRecurringScheduleBold: return "\u{f40c}"
        case .dailyRecurringScheduleLight: return "\u{f40d}"
        case .dailyRecurringScheduleRegular: return "\u{f40e}"
        case .dashboardBold: return "\u{f40f}"
        case .dashboardFilled: return "\u{f410}"
        case .dashboardLight: return "\u{f411}"
        case .dashboardRegular: return "\u{f412}"
        case .dataManagementBold: return "\u{f413}"
        case .dataManagementFilled: return "\u{f414}"
        case .dataManagementLight: return "\u{f415}"
        case .dataManagementRegular: return "\u{f416}"
        case .dataRangeSelectionBold: return "\u{f417}"
        case .dataRangeSelectionFilled: return "\u{f418}"
        case .dataRangeSelectionLight: return "\u{f419}"
        case .dataRangeSelectionRegular: return "\u{f41a}"
        case .declineBold: return "\u{f41b}"
        case .declineFilled: return "\u{f41c}"
        case .declineLight: return "\u{f41d}"
        case .declineRegular: return "\u{f41e}"
        case .dectHandsetBold: return "\u{f41f}"
        case .dectHandsetFilled: return "\u{f420}"
        case .dectHandsetLight: return "\u{f421}"
        case .dectHandsetRegular: return "\u{f422}"
        case .deleteBold: return "\u{f423}"
        case .deleteFilled: return "\u{f424}"
        case .deleteLight: return "\u{f425}"
        case .deleteRegular: return "\u{f426}"
        case .deploymentEvaluationProgressBold: return "\u{f427}"
        case .deploymentEvaluationProgressLight: return "\u{f428}"
        case .deploymentEvaluationProgressRegular: return "\u{f429}"
        case .deploymentProgressBold: return "\u{f42a}"
        case .deploymentProgressLight: return "\u{f42b}"
        case .deploymentProgressRegular: return "\u{f42c}"
        case .deploymentRecurringBold: return "\u{f42d}"
        case .deploymentRecurringLight: return "\u{f42e}"
        case .deploymentRecurringRegular: return "\u{f42f}"
        case .deploymentWinnerPendingBold: return "\u{f430}"
        case .deploymentWinnerPendingLight: return "\u{f431}"
        case .deploymentWinnerPendingRegular: return "\u{f432}"
        case .deskPhoneBold: return "\u{f433}"
        case .deskPhoneFilled: return "\u{f434}"
        case .deskPhoneLight: return "\u{f435}"
        case .deskPhoneRegular: return "\u{f436}"
        case .deskPhoneWarningBold: return "\u{f437}"
        case .deskPhoneWarningLight: return "\u{f438}"
        case .deskPhoneWarningRegular: return "\u{f439}"
        case .deviceConnectionBold: return "\u{f43a}"
        case .deviceConnectionFilled: return "\u{f43b}"
        case .deviceConnectionLight: return "\u{f43c}"
        case .deviceConnectionRegular: return "\u{f43d}"
        case .deviceInRoomBold: return "\u{f43e}"
        case .deviceInRoomEndBold: return "\u{f43f}"
        case .deviceInRoomEndLight: return "\u{f440}"
        case .deviceInRoomEndRegular: return "\u{f441}"
        case .deviceInRoomFilled: return "\u{f442}"
        case .deviceInRoomLight: return "\u{f443}"
        case .deviceInRoomRegular: return "\u{f444}"
        case .deviceMutedBold: return "\u{f445}"
        case .deviceMutedLight: return "\u{f446}"
        case .deviceMutedRegular: return "\u{f447}"
        case .devicePolicyControllerBold: return "\u{f448}"
        case .devicePolicyControllerLight: return "\u{f449}"
        case .devicePolicyControllerRegular: return "\u{f44a}"
        case .devicesBold: return "\u{f44b}"
        case .devicesFilled: return "\u{f44c}"
        case .devicesLight: return "\u{f44d}"
        case .devicesRegular: return "\u{f44e}"
        case .diagnosticsBold: return "\u{f44f}"
        case .diagnosticsFilled: return "\u{f450}"
        case .diagnosticsLight: return "\u{f451}"
        case .diagnosticsRegular: return "\u{f452}"
        case .dialpadBold: return "\u{f453}"
        case .dialpadFilled: return "\u{f454}"
        case .dialpadLight: return "\u{f455}"
        case .dialpadRegular: return "\u{f456}"
        case .diamondBold: return "\u{f457}"
        case .diamondFilled: return "\u{f458}"
        case .diamondLight: return "\u{f459}"
        case .diamondRegular: return "\u{f45a}"
        case .directionalPadBold: return "\u{f45b}"
        case .directionalPadFilled: return "\u{f45c}"
        case .directionalPadLight: return "\u{f45d}"
        case .directionalPadRegular: return "\u{f45e}"
        case .directoryBold: return "\u{f45f}"
        case .directoryLight: return "\u{f460}"
        case .directoryRegular: return "\u{f461}"
        case .disappearingPenBold: return "\u{f462}"
        case .disappearingPenLight: return "\u{f463}"
        case .disappearingPenRegular: return "\u{f464}"
        case .discBold: return "\u{f465}"
        case .discConnectedBold: return "\u{f466}"
        case .discConnectedLight: return "\u{f467}"
        case .discConnectedRegular: return "\u{f468}"
        case .discLight: return "\u{f469}"
        case .discRegular: return "\u{f46a}"
        case .disconnectBold: return "\u{f46b}"
        case .disconnectFilled: return "\u{f46c}"
        case .disconnectLight: return "\u{f46d}"
        case .disconnectRegular: return "\u{f46e}"
        case .dislikeBold: return "\u{f46f}"
        case .dislikeFilled: return "\u{f470}"
        case .dislikeLight: return "\u{f471}"
        case .dislikeRegular: return "\u{f472}"
        case .displayBold: return "\u{f473}"
        case .displayInputBold: return "\u{f474}"
        case .displayInputLight: return "\u{f475}"
        case .displayInputRegular: return "\u{f476}"
        case .displayLight: return "\u{f477}"
        case .displayRegular: return "\u{f478}"
        case .displayWarningBold: return "\u{f479}"
        case .displayWarningLight: return "\u{f47a}"
        case .displayWarningRegular: return "\u{f47b}"
        case .distributeHorizontalBold: return "\u{f47c}"
        case .distributeHorizontalFilled: return "\u{f47d}"
        case .distributeHorizontalLight: return "\u{f47e}"
        case .distributeHorizontalRegular: return "\u{f47f}"
        case .distributeVerticallyBold: return "\u{f480}"
        case .distributeVerticallyFilled: return "\u{f481}"
        case .distributeVerticallyLight: return "\u{f482}"
        case .distributeVerticallyRegular: return "\u{f483}"
        case .divideBold: return "\u{f484}"
        case .divideFilled: return "\u{f485}"
        case .divideLight: return "\u{f486}"
        case .divideRegular: return "\u{f487}"
        case .dndPresenceBadgeFilled: return "\u{f488}"
        case .dndPresenceBold: return "\u{f489}"
        case .dndPresenceFilled: return "\u{f48a}"
        case .dndPresenceLight: return "\u{f48b}"
        case .dndPresenceRegular: return "\u{f48c}"
        case .dockWindowBold: return "\u{f48d}"
        case .dockWindowLight: return "\u{f48e}"
        case .dockWindowRegular: return "\u{f48f}"
        case .documentBold: return "\u{f490}"
        case .documentCameraBold: return "\u{f491}"
        case .documentCameraDisconnectedBold: return "\u{f492}"
        case .documentCameraDisconnectedLight: return "\u{f493}"
        case .documentCameraDisconnectedRegular: return "\u{f494}"
        case .documentCameraLight: return "\u{f495}"
        case .documentCameraRegular: return "\u{f496}"
        case .documentCreateBold: return "\u{f497}"
        case .documentCreateFilled: return "\u{f498}"
        case .documentCreateLight: return "\u{f499}"
        case .documentCreateRegular: return "\u{f49a}"
        case .documentFilled: return "\u{f49b}"
        case .documentLight: return "\u{f49c}"
        case .documentMoveBold: return "\u{f49d}"
        case .documentMoveFilled: return "\u{f49e}"
        case .documentMoveLight: return "\u{f49f}"
        case .documentMoveRegular: return "\u{f4a0}"
        case .documentRegular: return "\u{f4a1}"
        case .documentShareBold: return "\u{f4a2}"
        case .documentShareFilled: return "\u{f4a3}"
        case .documentShareLight: return "\u{f4a4}"
        case .documentShareRegular: return "\u{f4a5}"
        case .doneAllBold: return "\u{f4a6}"
        case .doneAllLight: return "\u{f4a7}"
        case .doneAllRegular: return "\u{f4a8}"
        case .donutChartBold: return "\u{f4a9}"
        case .donutChartFilled: return "\u{f4aa}"
        case .donutChartLight: return "\u{f4ab}"
        case .donutChartRegular: return "\u{f4ac}"
        case .downloadBold: return "\u{f4ad}"
        case .downloadFilled: return "\u{f4ae}"
        case .downloadLight: return "\u{f4af}"
        case .downloadRegular: return "\u{f4b0}"
        case .draftBold: return "\u{f4b1}"
        case .draftFilled: return "\u{f4b2}"
        case .draftIndicatorBold: return "\u{f4b3}"
        case .draftIndicatorSmallFilled: return "\u{f4b4}"
        case .draftLight: return "\u{f4b5}"
        case .draftRegular: return "\u{f4b6}"
        case .dragBold: return "\u{f4b7}"
        case .dragLight: return "\u{f4b8}"
        case .dragRegular: return "\u{f4b9}"
        case .draggerHorizontalBold: return "\u{f4ba}"
        case .draggerHorizontalLight: return "\u{f4bb}"
        case .draggerHorizontalRegular: return "\u{f4bc}"
        case .draggerVerticalBold: return "\u{f4bd}"
        case .draggerVerticalLight: return "\u{f4be}"
        case .draggerVerticalRegular: return "\u{f4bf}"
        case .driveModeBold: return "\u{f4c0}"
        case .driveModeLight: return "\u{f4c1}"
        case .driveModeRegular: return "\u{f4c2}"
        case .dropdownBold: return "\u{f4c3}"
        case .dropdownLight: return "\u{f4c4}"
        case .dropdownRegular: return "\u{f4c5}"
        case .dxEightyBold: return "\u{f4c6}"
        case .dxEightyFilled: return "\u{f4c7}"
        case .dxEightyLight: return "\u{f4c8}"
        case .dxEightyRegular: return "\u{f4c9}"
        case .dxSeventyBold: return "\u{f4ca}"
        case .dxSeventyLight: return "\u{f4cb}"
        case .dxSeventyRegular: return "\u{f4cc}"
        case .editBold: return "\u{f4cd}"
        case .editFilled: return "\u{f4ce}"
        case .editLight: return "\u{f4cf}"
        case .editRegular: return "\u{f4d0}"
        case .editablePartialBold: return "\u{f4d1}"
        case .editablePartialLight: return "\u{f4d2}"
        case .editablePartialRegular: return "\u{f4d3}"
        case .educationBold: return "\u{f4d4}"
        case .educationFilled: return "\u{f4d5}"
        case .educationLight: return "\u{f4d6}"
        case .educationRegular: return "\u{f4d7}"
        case .emailBold: return "\u{f4d8}"
        case .emailDeliveredBold: return "\u{f4d9}"
        case .emailDeliveredLight: return "\u{f4da}"
        case .emailDeliveredRegular: return "\u{f4db}"
        case .emailFailureBold: return "\u{f4dc}"
        case .emailFailureLight: return "\u{f4dd}"
        case .emailFailureRegular: return "\u{f4de}"
        case .emailFilled: return "\u{f4df}"
        case .emailInviteBold: return "\u{f4e0}"
        case .emailInviteLight: return "\u{f4e1}"
        case .emailInviteRegular: return "\u{f4e2}"
        case .emailLight: return "\u{f4e3}"
        case .emailOutgoingBold: return "\u{f4e4}"
        case .emailOutgoingFilled: return "\u{f4e5}"
        case .emailOutgoingLight: return "\u{f4e6}"
        case .emailOutgoingRegular: return "\u{f4e7}"
        case .emailReadBold: return "\u{f4e8}"
        case .emailReadFilled: return "\u{f4e9}"
        case .emailReadLight: return "\u{f4ea}"
        case .emailReadRegular: return "\u{f4eb}"
        case .emailRegular: return "\u{f4ec}"
        case .emergencyCallbackNumberBold: return "\u{f4ed}"
        case .emergencyCallbackNumberFilled: return "\u{f4ee}"
        case .emergencyCallbackNumberLight: return "\u{f4ef}"
        case .emergencyCallbackNumberRegular: return "\u{f4f0}"
        case .emojiExcitedBold: return "\u{f4f1}"
        case .emojiExcitedFilled: return "\u{f4f2}"
        case .emojiExcitedLight: return "\u{f4f3}"
        case .emojiExcitedRegular: return "\u{f4f4}"
        case .emojiHappyBold: return "\u{f4f5}"
        case .emojiHappyFilled: return "\u{f4f6}"
        case .emojiHappyLight: return "\u{f4f7}"
        case .emojiHappyRegular: return "\u{f4f8}"
        case .emojiPassiveBold: return "\u{f4f9}"
        case .emojiPassiveFilled: return "\u{f4fa}"
        case .emojiPassiveLight: return "\u{f4fb}"
        case .emojiPassiveRegular: return "\u{f4fc}"
        case .emojiSadBold: return "\u{f4fd}"
        case .emojiSadFilled: return "\u{f4fe}"
        case .emojiSadLight: return "\u{f4ff}"
        case .emojiSadRegular: return "\u{f500}"
        case .emojiUnhappyBold: return "\u{f501}"
        case .emojiUnhappyFilled: return "\u{f502}"
        case .emojiUnhappyLight: return "\u{f503}"
        case .emojiUnhappyRegular: return "\u{f504}"
        case .encryptionAdaptiveBold: return "\u{f505}"
        case .encryptionAdaptiveFilled: return "\u{f506}"
        case .encryptionAdaptiveLight: return "\u{f507}"
        case .encryptionAdaptiveRegular: return "\u{f508}"
        case .encryptionAdaptiveSecureBold: return "\u{f509}"
        case .encryptionAdaptiveSecureFilled: return "\u{f50a}"
        case .encryptionAdaptiveSecureLight: return "\u{f50b}"
        case .encryptionAdaptiveSecureRegular: return "\u{f50c}"
        case .encryptionBold: return "\u{f50d}"
        case .encryptionCircleAdaptiveBold: return "\u{f50e}"
        case .encryptionCircleAdaptiveFilled: return "\u{f50f}"
        case .encryptionCircleAdaptiveLight: return "\u{f510}"
        case .encryptionCircleAdaptiveRegular: return "\u{f511}"
        case .encryptionCircleAdaptiveSecureBold: return "\u{f512}"
        case .encryptionCircleAdaptiveSecureFilled: return "\u{f513}"
        case .encryptionCircleAdaptiveSecureLight: return "\u{f514}"
        case .encryptionCircleAdaptiveSecureRegular: return "\u{f515}"
        case .encryptionCircleBold: return "\u{f516}"
        case .encryptionCircleFilled: return "\u{f517}"
        case .encryptionCircleLight: return "\u{f518}"
        case .encryptionCircleRegular: return "\u{f519}"
        case .encryptionFilled: return "\u{f51a}"
        case .encryptionLight: return "\u{f51b}"
        case .encryptionRegular: return "\u{f51c}"
        case .endRemoteDesktopControlBold: return "\u{f51d}"
        case .endRemoteDesktopControlLight: return "\u{f51e}"
        case .endRemoteDesktopControlRegular: return "\u{f51f}"
        case .endToEndEncryptionBold: return "\u{f520}"
        case .endToEndEncryptionCircleBold: return "\u{f521}"
        case .endToEndEncryptionCircleFilled: return "\u{f522}"
        case .endToEndEncryptionCircleLight: return "\u{f523}"
        case .endToEndEncryptionCircleRegular: return "\u{f524}"
        case .endToEndEncryptionFilled: return "\u{f525}"
        case .endToEndEncryptionLight: return "\u{f526}"
        case .endToEndEncryptionRegular: return "\u{f527}"
        case .endpointBlockedBold: return "\u{f528}"
        case .endpointBlockedLight: return "\u{f529}"
        case .endpointBlockedRegular: return "\u{f52a}"
        case .endpointBold: return "\u{f52b}"
        case .endpointGTwoBold: return "\u{f52c}"
        case .endpointGTwoLight: return "\u{f52d}"
        case .endpointGTwoRegular: return "\u{f52e}"
        case .endpointGTwoSeventyBold: return "\u{f52f}"
        case .endpointGTwoSeventyDualBold: return "\u{f530}"
        case .endpointGTwoSeventyDualLight: return "\u{f531}"
        case .endpointGTwoSeventyDualRegular: return "\u{f532}"
        case .endpointGTwoSeventyLight: return "\u{f533}"
        case .endpointGTwoSeventyRegular: return "\u{f534}"
        case .endpointGTwoStandBold: return "\u{f535}"
        case .endpointGTwoStandLight: return "\u{f536}"
        case .endpointGTwoStandRegular: return "\u{f537}"
        case .endpointLight: return "\u{f538}"
        case .endpointMxEightHundredBold: return "\u{f539}"
        case .endpointMxEightHundredDualBold: return "\u{f53a}"
        case .endpointMxEightHundredDualLight: return "\u{f53b}"
        case .endpointMxEightHundredDualRegular: return "\u{f53c}"
        case .endpointMxEightHundredLight: return "\u{f53d}"
        case .endpointMxEightHundredRegular: return "\u{f53e}"
        case .endpointRegular: return "\u{f53f}"
        case .endpointStandBold: return "\u{f540}"
        case .endpointStandFilled: return "\u{f541}"
        case .endpointStandLight: return "\u{f542}"
        case .endpointStandRegular: return "\u{f543}"
        case .endpointWarningBold: return "\u{f544}"
        case .endpointWarningLight: return "\u{f545}"
        case .endpointWarningRegular: return "\u{f546}"
        case .enterBold: return "\u{f547}"
        case .enterLight: return "\u{f548}"
        case .enterRegular: return "\u{f549}"
        case .enterRoomBold: return "\u{f54a}"
        case .enterRoomFilled: return "\u{f54b}"
        case .enterRoomLight: return "\u{f54c}"
        case .enterRoomRegular: return "\u{f54d}"
        case .eraserBold: return "\u{f54e}"
        case .eraserFilled: return "\u{f54f}"
        case .eraserLight: return "\u{f550}"
        case .eraserRegular: return "\u{f551}"
        case .errorLegacyBadgeFilled: return "\u{f552}"
        case .errorLegacyBold: return "\u{f553}"
        case .errorLegacyFilled: return "\u{f554}"
        case .errorLegacyLight: return "\u{f555}"
        case .errorLegacyRegular: return "\u{f556}"
        case .ethernetBold: return "\u{f557}"
        case .ethernetFilled: return "\u{f558}"
        case .ethernetLight: return "\u{f559}"
        case .ethernetRegular: return "\u{f55a}"
        case .exchangeBold: return "\u{f55b}"
        case .exchangeLight: return "\u{f55c}"
        case .exchangeRegular: return "\u{f55d}"
        case .exclamationBold: return "\u{f55e}"
        case .exclamationLight: return "\u{f55f}"
        case .exclamationRegular: return "\u{f560}"
        case .excludeBold: return "\u{f561}"
        case .excludeLight: return "\u{f562}"
        case .excludeRegular: return "\u{f563}"
        case .existingTargetGroupBold: return "\u{f564}"
        case .existingTargetGroupLight: return "\u{f565}"
        case .existingTargetGroupRegular: return "\u{f566}"
        case .exitRoomBold: return "\u{f567}"
        case .exitRoomLight: return "\u{f568}"
        case .exitRoomRegular: return "\u{f569}"
        case .exploreBold: return "\u{f56a}"
        case .exploreLight: return "\u{f56b}"
        case .exploreRegular: return "\u{f56c}"
        case .exportBold: return "\u{f56d}"
        case .exportLight: return "\u{f56e}"
        case .exportRegular: return "\u{f56f}"
        case .extensionMobilityBold: return "\u{f570}"
        case .extensionMobilityLight: return "\u{f571}"
        case .extensionMobilityRegular: return "\u{f572}"
        case .externalMessageBold: return "\u{f573}"
        case .externalMessageLight: return "\u{f574}"
        case .externalMessageRegular: return "\u{f575}"
        case .externalUserBold: return "\u{f576}"
        case .externalUserLight: return "\u{f577}"
        case .externalUserRegular: return "\u{f578}"
        case .familyFontBold: return "\u{f579}"
        case .familyFontLight: return "\u{f57a}"
        case .familyFontRegular: return "\u{f57b}"
        case .fastForwardBold: return "\u{f57c}"
        case .fastForwardLight: return "\u{f57d}"
        case .fastForwardRegular: return "\u{f57e}"
        case .favoriteBold: return "\u{f57f}"
        case .favoriteFilled: return "\u{f580}"
        case .favoriteLight: return "\u{f581}"
        case .favoriteRegular: return "\u{f582}"
        case .favoritesBold: return "\u{f583}"
        case .favoritesFilled: return "\u{f584}"
        case .favoritesLight: return "\u{f585}"
        case .favoritesRegular: return "\u{f586}"
        case .fbwBold: return "\u{f587}"
        case .fbwFilled: return "\u{f588}"
        case .fbwLight: return "\u{f589}"
        case .fbwRegular: return "\u{f58a}"
        case .ffwBold: return "\u{f58b}"
        case .ffwFilled: return "\u{f58c}"
        case .ffwLight: return "\u{f58d}"
        case .ffwRegular: return "\u{f58e}"
        case .fileAnalysisBold: return "\u{f58f}"
        case .fileAnalysisFilled: return "\u{f590}"
        case .fileAnalysisLight: return "\u{f591}"
        case .fileAnalysisRegular: return "\u{f592}"
        case .fileAnnotationBold: return "\u{f593}"
        case .fileAnnotationFilled: return "\u{f594}"
        case .fileAnnotationLight: return "\u{f595}"
        case .fileAnnotationRegular: return "\u{f596}"
        case .fileAudioBold: return "\u{f597}"
        case .fileAudioFilled: return "\u{f598}"
        case .fileAudioLight: return "\u{f599}"
        case .fileAudioRegular: return "\u{f59a}"
        case .fileBugBold: return "\u{f59b}"
        case .fileBugFilled: return "\u{f59c}"
        case .fileBugLight: return "\u{f59d}"
        case .fileBugRegular: return "\u{f59e}"
        case .fileCodeBold: return "\u{f59f}"
        case .fileCodeFilled: return "\u{f5a0}"
        case .fileCodeLight: return "\u{f5a1}"
        case .fileCodeRegular: return "\u{f5a2}"
        case .fileDashboardBold: return "\u{f5a3}"
        case .fileDashboardFilled: return "\u{f5a4}"
        case .fileDashboardLight: return "\u{f5a5}"
        case .fileDashboardRegular: return "\u{f5a6}"
        case .fileExcelBold: return "\u{f5a7}"
        case .fileExcelFilled: return "\u{f5a8}"
        case .fileExcelLight: return "\u{f5a9}"
        case .fileExcelRegular: return "\u{f5aa}"
        case .fileGraphBold: return "\u{f5ab}"
        case .fileGraphFilled: return "\u{f5ac}"
        case .fileGraphLight: return "\u{f5ad}"
        case .fileGraphRegular: return "\u{f5ae}"
        case .fileImageBold: return "\u{f5af}"
        case .fileImageFilled: return "\u{f5b0}"
        case .fileImageLight: return "\u{f5b1}"
        case .fileImageNoneBold: return "\u{f5b2}"
        case .fileImageNoneLight: return "\u{f5b3}"
        case .fileImageNoneRegular: return "\u{f5b4}"
        case .fileImageRegular: return "\u{f5b5}"
        case .fileJsBold: return "\u{f5b6}"
        case .fileJsFilled: return "\u{f5b7}"
        case .fileJsLight: return "\u{f5b8}"
        case .fileJsRegular: return "\u{f5b9}"
        case .fileKeynoteBold: return "\u{f5ba}"
        case .fileKeynoteFilled: return "\u{f5bb}"
        case .fileKeynoteLight: return "\u{f5bc}"
        case .fileKeynoteRegular: return "\u{f5bd}"
        case .fileLockedBold: return "\u{f5be}"
        case .fileLockedFilled: return "\u{f5bf}"
        case .fileLockedLight: return "\u{f5c0}"
        case .fileLockedRegular: return "\u{f5c1}"
        case .fileMissingBold: return "\u{f5c2}"
        case .fileMissingFilled: return "\u{f5c3}"
        case .fileMissingLight: return "\u{f5c4}"
        case .fileMissingRegular: return "\u{f5c5}"
        case .fileMusicBold: return "\u{f5c6}"
        case .fileMusicFilled: return "\u{f5c7}"
        case .fileMusicLight: return "\u{f5c8}"
        case .fileMusicRegular: return "\u{f5c9}"
        case .fileOnenoteBold: return "\u{f5ca}"
        case .fileOnenoteFilled: return "\u{f5cb}"
        case .fileOnenoteLight: return "\u{f5cc}"
        case .fileOnenoteRegular: return "\u{f5cd}"
        case .filePdfBold: return "\u{f5ce}"
        case .filePdfFilled: return "\u{f5cf}"
        case .filePdfLight: return "\u{f5d0}"
        case .filePdfRegular: return "\u{f5d1}"
        case .filePowerpointBold: return "\u{f5d2}"
        case .filePowerpointFilled: return "\u{f5d3}"
        case .filePowerpointLight: return "\u{f5d4}"
        case .filePowerpointRegular: return "\u{f5d5}"
        case .fileSpreadsheetBold: return "\u{f5d6}"
        case .fileSpreadsheetFilled: return "\u{f5d7}"
        case .fileSpreadsheetLight: return "\u{f5d8}"
        case .fileSpreadsheetRegular: return "\u{f5d9}"
        case .fileTextBold: return "\u{f5da}"
        case .fileTextFilled: return "\u{f5db}"
        case .fileTextLight: return "\u{f5dc}"
        case .fileTextRegular: return "\u{f5dd}"
        case .fileThreeDBold: return "\u{f5de}"
        case .fileThreeDFilled: return "\u{f5df}"
        case .fileThreeDLight: return "\u{f5e0}"
        case .fileThreeDRegular: return "\u{f5e1}"
        case .fileVectorBold: return "\u{f5e2}"
        case .fileVectorFilled: return "\u{f5e3}"
        case .fileVectorLight: return "\u{f5e4}"
        case .fileVectorRegular: return "\u{f5e5}"
        case .fileVideoBold: return "\u{f5e6}"
        case .fileVideoFilled: return "\u{f5e7}"
        case .fileVideoLight: return "\u{f5e8}"
        case .fileVideoRegular: return "\u{f5e9}"
        case .fileWordBold: return "\u{f5ea}"
        case .fileWordFilled: return "\u{f5eb}"
        case .fileWordLight: return "\u{f5ec}"
        case .fileWordRegular: return "\u{f5ed}"
        case .fileXmlBold: return "\u{f5ee}"
        case .fileXmlFilled: return "\u{f5ef}"
        case .fileXmlLight: return "\u{f5f0}"
        case .fileXmlRegular: return "\u{f5f1}"
        case .fileZipBold: return "\u{f5f2}"
        case .fileZipFilled: return "\u{f5f3}"
        case .fileZipLight: return "\u{f5f4}"
        case .fileZipRegular: return "\u{f5f5}"
        case .filesBold: return "\u{f5f6}"
        case .filesFilled: return "\u{f5f7}"
        case .filesLight: return "\u{f5f8}"
        case .filesRegular: return "\u{f5f9}"
        case .fillColourBold: return "\u{f5fa}"
        case .fillColourFilled: return "\u{f5fb}"
        case .fillColourLight: return "\u{f5fc}"
        case .fillColourRegular: return "\u{f5fd}"
        case .filterBold: return "\u{f5fe}"
        case .filterCircleBold: return "\u{f5ff}"
        case .filterCircleFilled: return "\u{f600}"
        case .filterCircleLight: return "\u{f601}"
        case .filterCircleRegular: return "\u{f602}"
        case .filterLight: return "\u{f603}"
        case .filterRegular: return "\u{f604}"
        case .fitToWidthBold: return "\u{f605}"
        case .fitToWidthLight: return "\u{f606}"
        case .fitToWidthRegular: return "\u{f607}"
        case .fitToWindowExpandBold: return "\u{f608}"
        case .fitToWindowExpandLight: return "\u{f609}"
        case .fitToWindowExpandRegular: return "\u{f60a}"
        case .fitToWindowShrinkBold: return "\u{f60b}"
        case .fitToWindowShrinkLight: return "\u{f60c}"
        case .fitToWindowShrinkRegular: return "\u{f60d}"
        case .flagBold: return "\u{f60e}"
        case .flagCircleBold: return "\u{f60f}"
        case .flagCircleFilled: return "\u{f610}"
        case .flagCircleLight: return "\u{f611}"
        case .flagCircleRegular: return "\u{f612}"
        case .flagFilled: return "\u{f613}"
        case .flagLight: return "\u{f614}"
        case .flagRegular: return "\u{f615}"
        case .folderBold: return "\u{f616}"
        case .folderEditBold: return "\u{f617}"
        case .folderEditLight: return "\u{f618}"
        case .folderEditRegular: return "\u{f619}"
        case .folderFilled: return "\u{f61a}"
        case .folderLight: return "\u{f61b}"
        case .folderLockBold: return "\u{f61c}"
        case .folderLockLight: return "\u{f61d}"
        case .folderLockRegular: return "\u{f61e}"
        case .folderRegular: return "\u{f61f}"
        case .folderViewBold: return "\u{f620}"
        case .folderViewLight: return "\u{f621}"
        case .folderViewRegular: return "\u{f622}"
        case .followUpBold: return "\u{f623}"
        case .followUpLight: return "\u{f624}"
        case .followUpRegular: return "\u{f625}"
        case .foodBold: return "\u{f626}"
        case .foodFilled: return "\u{f627}"
        case .foodLight: return "\u{f628}"
        case .foodRegular: return "\u{f629}"
        case .forecastBold: return "\u{f62a}"
        case .forecastFilled: return "\u{f62b}"
        case .forecastLight: return "\u{f62c}"
        case .forecastRegular: return "\u{f62d}"
        case .formatBold: return "\u{f62e}"
        case .formatDefaultAppBold: return "\u{f62f}"
        case .formatDefaultAppFilled: return "\u{f630}"
        case .formatDefaultAppLight: return "\u{f631}"
        case .formatDefaultAppRegular: return "\u{f632}"
        case .formatLight: return "\u{f633}"
        case .formatPanelControlBarBold: return "\u{f634}"
        case .formatPanelControlBarLight: return "\u{f635}"
        case .formatPanelControlBarRegular: return "\u{f636}"
        case .formatPanelControlDownBold: return "\u{f637}"
        case .formatPanelControlDownLight: return "\u{f638}"
        case .formatPanelControlDownRegular: return "\u{f639}"
        case .formatPanelControlLeftBold: return "\u{f63a}"
        case .formatPanelControlLeftLight: return "\u{f63b}"
        case .formatPanelControlLeftRegular: return "\u{f63c}"
        case .formatPanelControlRightBold: return "\u{f63d}"
        case .formatPanelControlRightLight: return "\u{f63e}"
        case .formatPanelControlRightRegular: return "\u{f63f}"
        case .formatPanelControlUpBold: return "\u{f640}"
        case .formatPanelControlUpDownBold: return "\u{f641}"
        case .formatPanelControlUpDownLight: return "\u{f642}"
        case .formatPanelControlUpDownRegular: return "\u{f643}"
        case .formatPanelControlUpLight: return "\u{f644}"
        case .formatPanelControlUpRegular: return "\u{f645}"
        case .formatRegular: return "\u{f646}"
        case .formatViewMixedBold: return "\u{f647}"
        case .formatViewMixedLight: return "\u{f648}"
        case .formatViewMixedRegular: return "\u{f649}"
        case .formulaBold: return "\u{f64a}"
        case .formulaFilled: return "\u{f64b}"
        case .formulaLight: return "\u{f64c}"
        case .formulaRegular: return "\u{f64d}"
        case .forwardMessageBold: return "\u{f64e}"
        case .forwardMessageFilled: return "\u{f64f}"
        case .forwardMessageLight: return "\u{f650}"
        case .forwardMessageRegular: return "\u{f651}"
        case .forwardTenSecBold: return "\u{f652}"
        case .forwardTenSecLight: return "\u{f653}"
        case .forwardTenSecRegular: return "\u{f654}"
        case .fourColumnBold: return "\u{f655}"
        case .fourColumnLight: return "\u{f656}"
        case .fourColumnRegular: return "\u{f657}"
        case .fourWayNavigationBold: return "\u{f658}"
        case .fourWayNavigationLight: return "\u{f659}"
        case .fourWayNavigationRegular: return "\u{f65a}"
        case .frequencyCappingBold: return "\u{f65b}"
        case .frequencyCappingLight: return "\u{f65c}"
        case .frequencyCappingRegular: return "\u{f65d}"
        case .fulfillmentBold: return "\u{f65e}"
        case .fulfillmentLight: return "\u{f65f}"
        case .fulfillmentRegular: return "\u{f660}"
        case .fullscreenBold: return "\u{f661}"
        case .fullscreenExitBold: return "\u{f662}"
        case .fullscreenExitLight: return "\u{f663}"
        case .fullscreenExitRegular: return "\u{f664}"
        case .fullscreenLight: return "\u{f665}"
        case .fullscreenRegular: return "\u{f666}"
        case .genericDeviceVideoBadgeFilled: return "\u{f667}"
        case .genericDeviceVideoBold: return "\u{f668}"
        case .genericDeviceVideoFilled: return "\u{f669}"
        case .genericDeviceVideoLight: return "\u{f66a}"
        case .genericDeviceVideoRegular: return "\u{f66b}"
        case .gifBold: return "\u{f66c}"
        case .gifFilled: return "\u{f66d}"
        case .gifHorizontalBold: return "\u{f66e}"
        case .gifHorizontalFilled: return "\u{f66f}"
        case .gifHorizontalLight: return "\u{f670}"
        case .gifHorizontalRegular: return "\u{f671}"
        case .gifLight: return "\u{f672}"
        case .gifRegular: return "\u{f673}"
        case .giftBold: return "\u{f674}"
        case .giftFilled: return "\u{f675}"
        case .giftLight: return "\u{f676}"
        case .giftRegular: return "\u{f677}"
        case .greenLeafBold: return "\u{f678}"
        case .greenLeafFilled: return "\u{f679}"
        case .greenLeafLight: return "\u{f67a}"
        case .greenLeafRegular: return "\u{f67b}"
        case .greenRoomBold: return "\u{f67c}"
        case .greenRoomFilled: return "\u{f67d}"
        case .greenRoomLight: return "\u{f67e}"
        case .greenRoomRegular: return "\u{f67f}"
        case .guestIssuerBold: return "\u{f680}"
        case .guestIssuerLight: return "\u{f681}"
        case .guestIssuerRegular: return "\u{f682}"
        case .guideBold: return "\u{f683}"
        case .guideLight: return "\u{f684}"
        case .guideRegular: return "\u{f685}"
        case .handPointerBold: return "\u{f686}"
        case .handPointerLight: return "\u{f687}"
        case .handPointerRegular: return "\u{f688}"
        case .handlerBold: return "\u{f689}"
        case .handlerHorizontalBold: return "\u{f68a}"
        case .handlerHorizontalLight: return "\u{f68b}"
        case .handlerHorizontalRegular: return "\u{f68c}"
        case .handlerLight: return "\u{f68d}"
        case .handlerRegular: return "\u{f68e}"
        case .handsetAlertBold: return "\u{f68f}"
        case .handsetAlertFilled: return "\u{f690}"
        case .handsetAlertLight: return "\u{f691}"
        case .handsetAlertRegular: return "\u{f692}"
        case .handsetBold: return "\u{f693}"
        case .handsetDownSlashBold: return "\u{f694}"
        case .handsetDownSlashFilled: return "\u{f695}"
        case .handsetDownSlashLight: return "\u{f696}"
        case .handsetDownSlashRegular: return "\u{f697}"
        case .handsetFilled: return "\u{f698}"
        case .handsetLight: return "\u{f699}"
        case .handsetMutedBold: return "\u{f69a}"
        case .handsetMutedFilled: return "\u{f69b}"
        case .handsetMutedLight: return "\u{f69c}"
        case .handsetMutedRegular: return "\u{f69d}"
        case .handsetRegular: return "\u{f69e}"
        case .handsetsArrowLeftBold: return "\u{f69f}"
        case .handsetsArrowLeftLight: return "\u{f6a0}"
        case .handsetsArrowLeftRegular: return "\u{f6a1}"
        case .handshakeBold: return "\u{f6a2}"
        case .handshakeLight: return "\u{f6a3}"
        case .handshakeRegular: return "\u{f6a4}"
        case .headingOneBold: return "\u{f6a5}"
        case .headingOneLight: return "\u{f6a6}"
        case .headingOneRegular: return "\u{f6a7}"
        case .headingThreeBold: return "\u{f6a8}"
        case .headingThreeLight: return "\u{f6a9}"
        case .headingThreeRegular: return "\u{f6aa}"
        case .headingTwoBold: return "\u{f6ab}"
        case .headingTwoLight: return "\u{f6ac}"
        case .headingTwoRegular: return "\u{f6ad}"
        case .headphonesBold: return "\u{f6ae}"
        case .headphonesFilled: return "\u{f6af}"
        case .headphonesLight: return "\u{f6b0}"
        case .headphonesMutedBold: return "\u{f6b1}"
        case .headphonesMutedFilled: return "\u{f6b2}"
        case .headphonesMutedLight: return "\u{f6b3}"
        case .headphonesMutedRegular: return "\u{f6b4}"
        case .headphonesRegular: return "\u{f6b5}"
        case .headsetAlertBold: return "\u{f6b6}"
        case .headsetAlertLight: return "\u{f6b7}"
        case .headsetAlertRegular: return "\u{f6b8}"
        case .headsetArrowDownBold: return "\u{f6b9}"
        case .headsetArrowDownFilled: return "\u{f6ba}"
        case .headsetArrowDownLight: return "\u{f6bb}"
        case .headsetArrowDownRegular: return "\u{f6bc}"
        case .headsetBluetoothBold: return "\u{f6bd}"
        case .headsetBluetoothLight: return "\u{f6be}"
        case .headsetBluetoothRegular: return "\u{f6bf}"
        case .headsetBold: return "\u{f6c0}"
        case .headsetFilled: return "\u{f6c1}"
        case .headsetLight: return "\u{f6c2}"
        case .headsetMutedBold: return "\u{f6c3}"
        case .headsetMutedLight: return "\u{f6c4}"
        case .headsetMutedRegular: return "\u{f6c5}"
        case .headsetPrivateBold: return "\u{f6c6}"
        case .headsetPrivateLight: return "\u{f6c7}"
        case .headsetPrivateRegular: return "\u{f6c8}"
        case .headsetRegular: return "\u{f6c9}"
        case .hearingBold: return "\u{f6ca}"
        case .hearingImpairedBold: return "\u{f6cb}"
        case .hearingImpairedLight: return "\u{f6cc}"
        case .hearingImpairedRegular: return "\u{f6cd}"
        case .hearingLight: return "\u{f6ce}"
        case .hearingRegular: return "\u{f6cf}"
        case .helpBold: return "\u{f6d0}"
        case .helpCircleBold: return "\u{f6d1}"
        case .helpCircleFilled: return "\u{f6d2}"
        case .helpCircleLight: return "\u{f6d3}"
        case .helpCircleRegular: return "\u{f6d4}"
        case .helpLight: return "\u{f6d5}"
        case .helpRegular: return "\u{f6d6}"
        case .helpdeskBold: return "\u{f6d7}"
        case .helpdeskFilled: return "\u{f6d8}"
        case .helpdeskLight: return "\u{f6d9}"
        case .helpdeskRegular: return "\u{f6da}"
        case .hideBold: return "\u{f6db}"
        case .hideFilled: return "\u{f6dc}"
        case .hideLight: return "\u{f6dd}"
        case .hideRegular: return "\u{f6de}"
        case .homeBold: return "\u{f6df}"
        case .homeFilled: return "\u{f6e0}"
        case .homeLight: return "\u{f6e1}"
        case .homeRegular: return "\u{f6e2}"
        case .horizontalLineBold: return "\u{f6e3}"
        case .horizontalLineLight: return "\u{f6e4}"
        case .horizontalLineRegular: return "\u{f6e5}"
        case .hotelingBold: return "\u{f6e6}"
        case .hotelingFilled: return "\u{f6e7}"
        case .hotelingLight: return "\u{f6e8}"
        case .hotelingRegular: return "\u{f6e9}"
        case .humidityBold: return "\u{f6ea}"
        case .humidityLight: return "\u{f6eb}"
        case .humidityRegular: return "\u{f6ec}"
        case .huntGroupBold: return "\u{f6ed}"
        case .huntGroupFilled: return "\u{f6ee}"
        case .huntGroupLight: return "\u{f6ef}"
        case .huntGroupRegular: return "\u{f6f0}"
        case .idleBold: return "\u{f6f1}"
        case .idleFilled: return "\u{f6f2}"
        case .idleLight: return "\u{f6f3}"
        case .idleRegular: return "\u{f6f4}"
        case .immediateBold: return "\u{f6f5}"
        case .immediateFilled: return "\u{f6f6}"
        case .immediateLight: return "\u{f6f7}"
        case .immediateRegular: return "\u{f6f8}"
        case .importBold: return "\u{f6f9}"
        case .importLight: return "\u{f6fa}"
        case .importRegular: return "\u{f6fb}"
        case .inCommonBold: return "\u{f6fc}"
        case .inCommonLight: return "\u{f6fd}"
        case .inCommonRegular: return "\u{f6fe}"
        case .inboxBold: return "\u{f6ff}"
        case .inboxFilled: return "\u{f700}"
        case .inboxLight: return "\u{f701}"
        case .inboxRegular: return "\u{f702}"
        case .includeBold: return "\u{f703}"
        case .includeLight: return "\u{f704}"
        case .includeRegular: return "\u{f705}"
        case .incognitoBold: return "\u{f706}"
        case .incognitoFilled: return "\u{f707}"
        case .incognitoLight: return "\u{f708}"
        case .incognitoRegular: return "\u{f709}"
        case .incomingCallLegacyBold: return "\u{f70a}"
        case .incomingCallLegacyFilled: return "\u{f70b}"
        case .incomingCallLegacyLight: return "\u{f70c}"
        case .incomingCallLegacyRegular: return "\u{f70d}"
        case .indentDecreaseBold: return "\u{f70e}"
        case .indentDecreaseLight: return "\u{f70f}"
        case .indentDecreaseRegular: return "\u{f710}"
        case .indentIncreaseBold: return "\u{f711}"
        case .indentIncreaseLight: return "\u{f712}"
        case .indentIncreaseRegular: return "\u{f713}"
        case .infoBadgeFilled: return "\u{f714}"
        case .infoCircleBold: return "\u{f715}"
        case .infoCircleFilled: return "\u{f716}"
        case .infoCircleLight: return "\u{f717}"
        case .infoCircleRegular: return "\u{f718}"
        case .infoCircleTwoBold: return "\u{f719}"
        case .infoCircleTwoFilled: return "\u{f71a}"
        case .infoCircleTwoLight: return "\u{f71b}"
        case .infoCircleTwoRegular: return "\u{f71c}"
        case .inputBold: return "\u{f71d}"
        case .inputDisconnectedBold: return "\u{f71e}"
        case .inputDisconnectedLight: return "\u{f71f}"
        case .inputDisconnectedRegular: return "\u{f720}"
        case .inputLight: return "\u{f721}"
        case .inputRegular: return "\u{f722}"
        case .instantScheduleBold: return "\u{f723}"
        case .instantScheduleFilled: return "\u{f724}"
        case .instantScheduleLight: return "\u{f725}"
        case .instantScheduleRegular: return "\u{f726}"
        case .integerBold: return "\u{f727}"
        case .integerFilled: return "\u{f728}"
        case .integerLight: return "\u{f729}"
        case .integerRegular: return "\u{f72a}"
        case .integrationsBold: return "\u{f72b}"
        case .integrationsFilled: return "\u{f72c}"
        case .integrationsLight: return "\u{f72d}"
        case .integrationsRegular: return "\u{f72e}"
        case .intelligentRoutingBold: return "\u{f72f}"
        case .intelligentRoutingLight: return "\u{f730}"
        case .intelligentRoutingRegular: return "\u{f731}"
        case .interactionBold: return "\u{f732}"
        case .interactionFilled: return "\u{f733}"
        case .interactionLight: return "\u{f734}"
        case .interactionRegular: return "\u{f735}"
        case .invitedUserBold: return "\u{f736}"
        case .invitedUserLight: return "\u{f737}"
        case .invitedUserRegular: return "\u{f738}"
        case .italicBold: return "\u{f739}"
        case .italicFilled: return "\u{f73a}"
        case .italicLight: return "\u{f73b}"
        case .italicRegular: return "\u{f73c}"
        case .joinAudioBold: return "\u{f73d}"
        case .joinAudioFilled: return "\u{f73e}"
        case .joinAudioLight: return "\u{f73f}"
        case .joinAudioRegular: return "\u{f740}"
        case .keepInTouchBold: return "\u{f741}"
        case .keepInTouchFilled: return "\u{f742}"
        case .keepInTouchLight: return "\u{f743}"
        case .keepInTouchRegular: return "\u{f744}"
        case .keyboardBold: return "\u{f745}"
        case .keyboardCloseBold: return "\u{f746}"
        case .keyboardCloseLight: return "\u{f747}"
        case .keyboardCloseRegular: return "\u{f748}"
        case .keyboardLight: return "\u{f749}"
        case .keyboardRegular: return "\u{f74a}"
        case .languageBold: return "\u{f74b}"
        case .languageFilled: return "\u{f74c}"
        case .languageLight: return "\u{f74d}"
        case .languageRegular: return "\u{f74e}"
        case .laptopBold: return "\u{f74f}"
        case .laptopDisconnectedBold: return "\u{f750}"
        case .laptopDisconnectedLight: return "\u{f751}"
        case .laptopDisconnectedRegular: return "\u{f752}"
        case .laptopFilled: return "\u{f753}"
        case .laptopLight: return "\u{f754}"
        case .laptopRegular: return "\u{f755}"
        case .laserPointerBold: return "\u{f756}"
        case .laserPointerCursorBlackLight: return "\u{f757}"
        case .laserPointerCursorBlueLight: return "\u{f758}"
        case .laserPointerCursorGreenLight: return "\u{f759}"
        case .laserPointerCursorPurpleLight: return "\u{f75a}"
        case .laserPointerCursorRedLight: return "\u{f75b}"
        case .laserPointerCursorWhiteLight: return "\u{f75c}"
        case .laserPointerCursorYellowLight: return "\u{f75d}"
        case .laserPointerFilled: return "\u{f75e}"
        case .laserPointerLight: return "\u{f75f}"
        case .laserPointerRegular: return "\u{f760}"
        case .launchBold: return "\u{f761}"
        case .launchFilled: return "\u{f762}"
        case .launchLight: return "\u{f763}"
        case .launchRegular: return "\u{f764}"
        case .layoutSideBySideVerticalBold: return "\u{f765}"
        case .layoutSideBySideVerticalFilled: return "\u{f766}"
        case .layoutSideBySideVerticalLight: return "\u{f767}"
        case .layoutSideBySideVerticalRegular: return "\u{f768}"
        case .leaveBreakoutSessionBold: return "\u{f769}"
        case .leaveBreakoutSessionLight: return "\u{f76a}"
        case .leaveBreakoutSessionRegular: return "\u{f76b}"
        case .leaveDeviceBold: return "\u{f76c}"
        case .leaveDeviceLight: return "\u{f76d}"
        case .leaveDeviceRegular: return "\u{f76e}"
        case .likeBold: return "\u{f76f}"
        case .likeFilled: return "\u{f770}"
        case .likeLight: return "\u{f771}"
        case .likeRegular: return "\u{f772}"
        case .linkBold: return "\u{f773}"
        case .linkLight: return "\u{f774}"
        case .linkRegular: return "\u{f775}"
        case .listBulletedBold: return "\u{f776}"
        case .listBulletedLight: return "\u{f777}"
        case .listBulletedRegular: return "\u{f778}"
        case .listMenuBold: return "\u{f779}"
        case .listMenuLight: return "\u{f77a}"
        case .listMenuRegular: return "\u{f77b}"
        case .listNumberedBold: return "\u{f77c}"
        case .listNumberedLight: return "\u{f77d}"
        case .listNumberedRegular: return "\u{f77e}"
        case .liveBold: return "\u{f77f}"
        case .liveFilled: return "\u{f780}"
        case .liveLight: return "\u{f781}"
        case .liveRegular: return "\u{f782}"
        case .locationBold: return "\u{f783}"
        case .locationFilled: return "\u{f784}"
        case .locationLight: return "\u{f785}"
        case .locationRegular: return "\u{f786}"
        case .longTextBoxBold: return "\u{f787}"
        case .longTextBoxLight: return "\u{f788}"
        case .longTextBoxRegular: return "\u{f789}"
        case .lowerHandBold: return "\u{f78a}"
        case .lowerHandLight: return "\u{f78b}"
        case .lowerHandRegular: return "\u{f78c}"
        case .magicPenBold: return "\u{f78d}"
        case .magicPenFilled: return "\u{f78e}"
        case .magicPenLight: return "\u{f78f}"
        case .magicPenRegular: return "\u{f790}"
        case .markAsUnreadBold: return "\u{f791}"
        case .markAsUnreadFilled: return "\u{f792}"
        case .markAsUnreadLight: return "\u{f793}"
        case .markAsUnreadRegular: return "\u{f794}"
        case .markdownBold: return "\u{f795}"
        case .markdownFilled: return "\u{f796}"
        case .markdownLight: return "\u{f797}"
        case .markdownRegular: return "\u{f798}"
        case .markerBold: return "\u{f799}"
        case .markerFilled: return "\u{f79a}"
        case .markerLight: return "\u{f79b}"
        case .markerRegular: return "\u{f79c}"
        case .maximizeBold: return "\u{f79d}"
        case .maximizeLight: return "\u{f79e}"
        case .maximizeRegular: return "\u{f79f}"
        case .mcpBold: return "\u{f7a0}"
        case .mcpFilled: return "\u{f7a1}"
        case .mcpLight: return "\u{f7a2}"
        case .mcpRegular: return "\u{f7a3}"
        case .mediaPlayerBold: return "\u{f7a4}"
        case .mediaPlayerLight: return "\u{f7a5}"
        case .mediaPlayerRegular: return "\u{f7a6}"
        case .mediaQualityGoodBold: return "\u{f7a7}"
        case .mediaQualityGoodFilled: return "\u{f7a8}"
        case .mediaQualityGoodLight: return "\u{f7a9}"
        case .mediaQualityGoodRegular: return "\u{f7aa}"
        case .mediaQualityPoorBold: return "\u{f7ab}"
        case .mediaQualityPoorColoredBold: return "\u{f7ac}"
        case .mediaQualityPoorFilled: return "\u{f7ad}"
        case .mediaQualityPoorLight: return "\u{f7ae}"
        case .mediaQualityPoorRegular: return "\u{f7af}"
        case .mediaQualityUnstableBold: return "\u{f7b0}"
        case .mediaQualityUnstableColoredBold: return "\u{f7b1}"
        case .mediaQualityUnstableFilled: return "\u{f7b2}"
        case .mediaQualityUnstableLight: return "\u{f7b3}"
        case .mediaQualityUnstableRegular: return "\u{f7b4}"
        case .meetBold: return "\u{f7b5}"
        case .meetEndBold: return "\u{f7b6}"
        case .meetEndLight: return "\u{f7b7}"
        case .meetEndRegular: return "\u{f7b8}"
        case .meetFilled: return "\u{f7b9}"
        case .meetLight: return "\u{f7ba}"
        case .meetRegular: return "\u{f7bb}"
        case .meetingSummaryBold: return "\u{f7bc}"
        case .meetingSummaryFilled: return "\u{f7bd}"
        case .meetingSummaryLight: return "\u{f7be}"
        case .meetingSummaryRegular: return "\u{f7bf}"
        case .meetingsBold: return "\u{f7c0}"
        case .meetingsFilled: return "\u{f7c1}"
        case .meetingsFocusMonthBold: return "\u{f7c2}"
        case .meetingsFocusMonthLight: return "\u{f7c3}"
        case .meetingsFocusMonthRegular: return "\u{f7c4}"
        case .meetingsFocusOneDayBold: return "\u{f7c5}"
        case .meetingsFocusOneDayLight: return "\u{f7c6}"
        case .meetingsFocusOneDayRegular: return "\u{f7c7}"
        case .meetingsFocusThreeDayBold: return "\u{f7c8}"
        case .meetingsFocusThreeDayLight: return "\u{f7c9}"
        case .meetingsFocusThreeDayRegular: return "\u{f7ca}"
        case .meetingsFocusUpcomingBold: return "\u{f7cb}"
        case .meetingsFocusUpcomingLight: return "\u{f7cc}"
        case .meetingsFocusUpcomingRegular: return "\u{f7cd}"
        case .meetingsLight: return "\u{f7ce}"
        case .meetingsPresenceBadgeFilled: return "\u{f7cf}"
        case .meetingsPresenceBold: return "\u{f7d0}"
        case .meetingsPresenceFilled: return "\u{f7d1}"
        case .meetingsPresenceLight: return "\u{f7d2}"
        case .meetingsPresenceRegular: return "\u{f7d3}"
        case .meetingsRegular: return "\u{f7d4}"
        case .meetingsTeamBold: return "\u{f7d5}"
        case .meetingsTeamFilled: return "\u{f7d6}"
        case .meetingsTeamLight: return "\u{f7d7}"
        case .meetingsTeamNewBold: return "\u{f7d8}"
        case .meetingsTeamNewLight: return "\u{f7d9}"
        case .meetingsTeamNewRegular: return "\u{f7da}"
        case .meetingsTeamRegular: return "\u{f7db}"
        case .mentionBold: return "\u{f7dc}"
        case .mentionFilled: return "\u{f7dd}"
        case .mentionLight: return "\u{f7de}"
        case .mentionRegular: return "\u{f7df}"
        case .messageQueingBold: return "\u{f7e0}"
        case .messageQueingLight: return "\u{f7e1}"
        case .messageQueingRegular: return "\u{f7e2}"
        case .microphoneBold: return "\u{f7e3}"
        case .microphoneFilled: return "\u{f7e4}"
        case .microphoneHardMutedBold: return "\u{f7e5}"
        case .microphoneHardMutedCircleFilled: return "\u{f7e6}"
        case .microphoneHardMutedLight: return "\u{f7e7}"
        case .microphoneHardMutedRegular: return "\u{f7e8}"
        case .microphoneLight: return "\u{f7e9}"
        case .microphoneMusicModeBold: return "\u{f7ea}"
        case .microphoneMusicModeLight: return "\u{f7eb}"
        case .microphoneMusicModeOnBold: return "\u{f7ec}"
        case .microphoneMusicModeOnLight: return "\u{f7ed}"
        case .microphoneMusicModeOnRegular: return "\u{f7ee}"
        case .microphoneMusicModeRegular: return "\u{f7ef}"
        case .microphoneMutedBold: return "\u{f7f0}"
        case .microphoneMutedCircleFilled: return "\u{f7f1}"
        case .microphoneMutedFilled: return "\u{f7f2}"
        case .microphoneMutedLight: return "\u{f7f3}"
        case .microphoneMutedRegular: return "\u{f7f4}"
        case .microphoneOnBold: return "\u{f7f5}"
        case .microphoneOnLight: return "\u{f7f6}"
        case .microphoneOnRegular: return "\u{f7f7}"
        case .microphoneOptAllBold: return "\u{f7f8}"
        case .microphoneOptAllLight: return "\u{f7f9}"
        case .microphoneOptAllMutedBold: return "\u{f7fa}"
        case .microphoneOptAllMutedLight: return "\u{f7fb}"
        case .microphoneOptAllMutedRegular: return "\u{f7fc}"
        case .microphoneOptAllOnBold: return "\u{f7fd}"
        case .microphoneOptAllOnLight: return "\u{f7fe}"
        case .microphoneOptAllOnRegular: return "\u{f7ff}"
        case .microphoneOptAllRegular: return "\u{f800}"
        case .microphoneOptMeBold: return "\u{f801}"
        case .microphoneOptMeLight: return "\u{f802}"
        case .microphoneOptMeMutedBold: return "\u{f803}"
        case .microphoneOptMeMutedLight: return "\u{f804}"
        case .microphoneOptMeMutedRegular: return "\u{f805}"
        case .microphoneOptMeOnBold: return "\u{f806}"
        case .microphoneOptMeOnLight: return "\u{f807}"
        case .microphoneOptMeOnRegular: return "\u{f808}"
        case .microphoneOptMeRegular: return "\u{f809}"
        case .microphoneRegular: return "\u{f80a}"
        case .mindMapBold: return "\u{f80b}"
        case .mindMapLight: return "\u{f80c}"
        case .mindMapRegular: return "\u{f80d}"
        case .minimizeBold: return "\u{f80e}"
        case .minimizeLight: return "\u{f80f}"
        case .minimizeRegular: return "\u{f810}"
        case .minusBold: return "\u{f811}"
        case .minusFilled: return "\u{f812}"
        case .minusLight: return "\u{f813}"
        case .minusRegular: return "\u{f814}"
        case .mirrorBold: return "\u{f815}"
        case .mirrorFilled: return "\u{f816}"
        case .mirrorLight: return "\u{f817}"
        case .mirrorRegular: return "\u{f818}"
        case .mmsFilled: return "\u{f819}"
        case .moderatorBold: return "\u{f81a}"
        case .moderatorLight: return "\u{f81b}"
        case .moderatorRegular: return "\u{f81c}"
        case .monitoringBold: return "\u{f81d}"
        case .monitoringLight: return "\u{f81e}"
        case .monitoringRegular: return "\u{f81f}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f820}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f821}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f822}"
        case .moreAdrBold: return "\u{f823}"
        case .moreAdrLight: return "\u{f824}"
        case .moreAdrRegular: return "\u{f825}"
        case .moreBold: return "\u{f826}"
        case .moreCircleBold: return "\u{f827}"
        case .moreCircleFilled: return "\u{f828}"
        case .moreCircleLight: return "\u{f829}"
        case .moreCircleRegular: return "\u{f82a}"
        case .moreLight: return "\u{f82b}"
        case .moreRegular: return "\u{f82c}"
        case .mouseCursorBold: return "\u{f82d}"
        case .mouseCursorLight: return "\u{f82e}"
        case .mouseCursorRegular: return "\u{f82f}"
        case .moveCallInAdrBold: return "\u{f830}"
        case .moveCallInAdrLight: return "\u{f831}"
        case .moveCallInAdrRegular: return "\u{f832}"
        case .moveCallInIphBold: return "\u{f833}"
        case .moveCallInIphLight: return "\u{f834}"
        case .moveCallInIphRegular: return "\u{f835}"
        case .moveCallInLaptopBold: return "\u{f836}"
        case .moveCallInLaptopLight: return "\u{f837}"
        case .moveCallInLaptopRegular: return "\u{f838}"
        case .moveCallInOutAdrBold: return "\u{f839}"
        case .moveCallInOutAdrLight: return "\u{f83a}"
        case .moveCallInOutAdrRegular: return "\u{f83b}"
        case .moveCallInOutIphBold: return "\u{f83c}"
        case .moveCallInOutIphLight: return "\u{f83d}"
        case .moveCallInOutIphRegular: return "\u{f83e}"
        case .moveCallInTabletBold: return "\u{f83f}"
        case .moveCallInTabletLight: return "\u{f840}"
        case .moveCallInTabletRegular: return "\u{f841}"
        case .moveCallOutAdrBold: return "\u{f842}"
        case .moveCallOutAdrLight: return "\u{f843}"
        case .moveCallOutAdrRegular: return "\u{f844}"
        case .moveCallOutIphBold: return "\u{f845}"
        case .moveCallOutIphLight: return "\u{f846}"
        case .moveCallOutIphRegular: return "\u{f847}"
        case .moveCallOutLaptopBold: return "\u{f848}"
        case .moveCallOutLaptopLight: return "\u{f849}"
        case .moveCallOutLaptopRegular: return "\u{f84a}"
        case .moveCallOutTabletBold: return "\u{f84b}"
        case .moveCallOutTabletLight: return "\u{f84c}"
        case .moveCallOutTabletRegular: return "\u{f84d}"
        case .moveToBottomBold: return "\u{f84e}"
        case .moveToBottomFilled: return "\u{f84f}"
        case .moveToBottomLight: return "\u{f850}"
        case .moveToBottomRegular: return "\u{f851}"
        case .moveToScreenBold: return "\u{f852}"
        case .moveToScreenLight: return "\u{f853}"
        case .moveToScreenRegular: return "\u{f854}"
        case .moveToTopBold: return "\u{f855}"
        case .moveToTopFilled: return "\u{f856}"
        case .moveToTopLight: return "\u{f857}"
        case .moveToTopRegular: return "\u{f858}"
        case .multilineChartBold: return "\u{f859}"
        case .multilineChartFilled: return "\u{f85a}"
        case .multilineChartLight: return "\u{f85b}"
        case .multilineChartRegular: return "\u{f85c}"
        case .multimediaBold: return "\u{f85d}"
        case .multimediaFilled: return "\u{f85e}"
        case .multimediaLight: return "\u{f85f}"
        case .multimediaRegular: return "\u{f860}"
        case .multipledDevicesBold: return "\u{f861}"
        case .multipledDevicesFilled: return "\u{f862}"
        case .multipledDevicesLight: return "\u{f863}"
        case .multipledDevicesRegular: return "\u{f864}"
        case .musicModeCircleBold: return "\u{f865}"
        case .musicModeCircleFilled: return "\u{f866}"
        case .musicModeCircleLight: return "\u{f867}"
        case .musicModeCircleRegular: return "\u{f868}"
        case .musicNoteBold: return "\u{f869}"
        case .musicNoteFilled: return "\u{f86a}"
        case .musicNoteLight: return "\u{f86b}"
        case .musicNoteRegular: return "\u{f86c}"
        case .muteOnEntryBold: return "\u{f86d}"
        case .muteOnEntryFilled: return "\u{f86e}"
        case .muteOnEntryLight: return "\u{f86f}"
        case .muteOnEntryRegular: return "\u{f870}"
        case .networkSwitchBold: return "\u{f871}"
        case .networkSwitchFilled: return "\u{f872}"
        case .networkSwitchLight: return "\u{f873}"
        case .networkSwitchRegular: return "\u{f874}"
        case .newManagerBold: return "\u{f875}"
        case .newManagerFilled: return "\u{f876}"
        case .newManagerLight: return "\u{f877}"
        case .newManagerRegular: return "\u{f878}"
        case .newTitleBold: return "\u{f879}"
        case .newTitleLight: return "\u{f87a}"
        case .newTitleRegular: return "\u{f87b}"
        case .newVoicemailBold: return "\u{f87c}"
        case .newVoicemailLight: return "\u{f87d}"
        case .newVoicemailRegular: return "\u{f87e}"
        case .newWhiteboardBold: return "\u{f87f}"
        case .newWhiteboardLight: return "\u{f880}"
        case .newWhiteboardRegular: return "\u{f881}"
        case .nextBold: return "\u{f882}"
        case .nextLight: return "\u{f883}"
        case .nextRegular: return "\u{f884}"
        case .noDevicesBold: return "\u{f885}"
        case .noDevicesLight: return "\u{f886}"
        case .noDevicesRegular: return "\u{f887}"
        case .noiseDetectedCanceledFilled: return "\u{f888}"
        case .noiseDetectedFilled: return "\u{f889}"
        case .noiseNoneCanceledFilled: return "\u{f88a}"
        case .noiseNoneFilled: return "\u{f88b}"
        case .noiseRemovalBold: return "\u{f88c}"
        case .noiseRemovalLight: return "\u{f88d}"
        case .noiseRemovalRegular: return "\u{f88e}"
        case .noteBold: return "\u{f88f}"
        case .noteFilled: return "\u{f890}"
        case .noteLight: return "\u{f891}"
        case .notePptBold: return "\u{f892}"
        case .notePptLight: return "\u{f893}"
        case .notePptRegular: return "\u{f894}"
        case .noteRegular: return "\u{f895}"
        case .notesBold: return "\u{f896}"
        case .notesFilled: return "\u{f897}"
        case .notesLight: return "\u{f898}"
        case .notesRegular: return "\u{f899}"
        case .numberBold: return "\u{f89a}"
        case .numberHighlightBold: return "\u{f89b}"
        case .numberHighlightFilled: return "\u{f89c}"
        case .numberHighlightLight: return "\u{f89d}"
        case .numberHighlightRegular: return "\u{f89e}"
        case .numberLight: return "\u{f89f}"
        case .numberRegular: return "\u{f8a0}"
        case .oldRemoteBold: return "\u{f8a1}"
        case .oldRemoteLight: return "\u{f8a2}"
        case .oldRemoteRegular: return "\u{f8a3}"
        case .oldTouchBold: return "\u{f8a4}"
        case .oldTouchLight: return "\u{f8a5}"
        case .oldTouchRegular: return "\u{f8a6}"
        case .oneColumnBold: return "\u{f8a7}"
        case .oneColumnLight: return "\u{f8a8}"
        case .oneColumnRegular: return "\u{f8a9}"
        case .oneTimeBold: return "\u{f8aa}"
        case .oneTimeLight: return "\u{f8ab}"
        case .oneTimeRegular: return "\u{f8ac}"
        case .openInFolderBold: return "\u{f8ad}"
        case .openInFolderFilled: return "\u{f8ae}"
        case .openInFolderLight: return "\u{f8af}"
        case .openInFolderRegular: return "\u{f8b0}"
        case .openPagesBold: return "\u{f8b1}"
        case .openPagesLight: return "\u{f8b2}"
        case .openPagesRegular: return "\u{f8b3}"
        case .otherNumberBold: return "\u{f8b4}"
        case .otherNumberFilled: return "\u{f8b5}"
        case .otherNumberLight: return "\u{f8b6}"
        case .otherNumberRegular: return "\u{f8b7}"
        case .otherNumberWarningBold: return "\u{f8b8}"
        case .otherNumberWarningLight: return "\u{f8b9}"
        case .otherNumberWarningRegular: return "\u{f8ba}"
        case .outgoingCallLegacyBold: return "\u{f8bb}"
        case .outgoingCallLegacyFilled: return "\u{f8bc}"
        case .outgoingCallLegacyLight: return "\u{f8bd}"
        case .outgoingCallLegacyRegular: return "\u{f8be}"
        case .overflowLeftBold: return "\u{f8bf}"
        case .overflowLeftLight: return "\u{f8c0}"
        case .overflowLeftRegular: return "\u{f8c1}"
        case .overflowRightBold: return "\u{f8c2}"
        case .overflowRightLight: return "\u{f8c3}"
        case .overflowRightRegular: return "\u{f8c4}"
        case .pairedCameraBold: return "\u{f8c5}"
        case .pairedCameraLight: return "\u{f8c6}"
        case .pairedCameraRegular: return "\u{f8c7}"
        case .pairedDeviceBold: return "\u{f8c8}"
        case .pairedDeviceLight: return "\u{f8c9}"
        case .pairedDeviceRegular: return "\u{f8ca}"
        case .pairedHandsetBold: return "\u{f8cb}"
        case .pairedHandsetLight: return "\u{f8cc}"
        case .pairedHandsetRegular: return "\u{f8cd}"
        case .pairingBold: return "\u{f8ce}"
        case .pairingLight: return "\u{f8cf}"
        case .pairingRegular: return "\u{f8d0}"
        case .parenthesisBold: return "\u{f8d1}"
        case .parenthesisFilled: return "\u{f8d2}"
        case .parenthesisLight: return "\u{f8d3}"
        case .parenthesisRegular: return "\u{f8d4}"
        case .parkedBold: return "\u{f8d5}"
        case .parkedFilled: return "\u{f8d6}"
        case .parkedLight: return "\u{f8d7}"
        case .parkedRegular: return "\u{f8d8}"
        case .parseBold: return "\u{f8d9}"
        case .parseLight: return "\u{f8da}"
        case .parseRegular: return "\u{f8db}"
        case .partialBold: return "\u{f8dc}"
        case .partialLight: return "\u{f8dd}"
        case .partialRegular: return "\u{f8de}"
        case .participantAddBold: return "\u{f8df}"
        case .participantAddLight: return "\u{f8e0}"
        case .participantAddRegular: return "\u{f8e1}"
        case .participantBlockedBold: return "\u{f8e2}"
        case .participantBlockedLight: return "\u{f8e3}"
        case .participantBlockedRegular: return "\u{f8e4}"
        case .participantBold: return "\u{f8e5}"
        case .participantFilled: return "\u{f8e6}"
        case .participantLight: return "\u{f8e7}"
        case .participantListBold: return "\u{f8e8}"
        case .participantListFilled: return "\u{f8e9}"
        case .participantListLight: return "\u{f8ea}"
        case .participantListRegular: return "\u{f8eb}"
        case .participantRegular: return "\u{f8ec}"
        case .participantRemoveBold: return "\u{f8ed}"
        case .participantRemoveLight: return "\u{f8ee}"
        case .participantRemoveRegular: return "\u{f8ef}"
        case .participantSpeakerBold: return "\u{f8f0}"
        case .participantSpeakerFilled: return "\u{f8f1}"
        case .participantSpeakerLight: return "\u{f8f2}"
        case .participantSpeakerRegular: return "\u{f8f3}"
        case .participantUnknownBold: return "\u{f8f4}"
        case .participantUnknownLight: return "\u{f8f5}"
        case .participantUnknownRegular: return "\u{f8f6}"
        case .passMouseBold: return "\u{f8f7}"
        case .passMouseLight: return "\u{f8f8}"
        case .passMouseRegular: return "\u{f8f9}"
        case .pauseBadgeFilled: return "\u{f8fa}"
        case .pauseBold: return "\u{f8fb}"
        case .pauseFilled: return "\u{f8fc}"
        case .pauseInteractionBold: return "\u{f8fd}"
        case .pauseInteractionFilled: return "\u{f8fe}"
        case .pauseInteractionLight: return "\u{f8ff}"
        case .pauseInteractionRegular: return "\u{f900}"
        case .pauseLight: return "\u{f901}"
        case .pauseRegular: return "\u{f902}"
        case .peopleAddBold: return "\u{f903}"
        case .peopleAddFilled: return "\u{f904}"
        case .peopleAddLight: return "\u{f905}"
        case .peopleAddRegular: return "\u{f906}"
        case .peopleBold: return "\u{f907}"
        case .peopleCircleBold: return "\u{f908}"
        case .peopleCircleFilled: return "\u{f909}"
        case .peopleCircleLight: return "\u{f90a}"
        case .peopleCircleRegular: return "\u{f90b}"
        case .peopleFilled: return "\u{f90c}"
        case .peopleInsightsBold: return "\u{f90d}"
        case .peopleInsightsFilled: return "\u{f90e}"
        case .peopleInsightsLight: return "\u{f90f}"
        case .peopleInsightsRegular: return "\u{f910}"
        case .peopleLight: return "\u{f911}"
        case .peopleManageBold: return "\u{f912}"
        case .peopleManageFilled: return "\u{f913}"
        case .peopleManageLight: return "\u{f914}"
        case .peopleManageRegular: return "\u{f915}"
        case .peopleRegular: return "\u{f916}"
        case .phoneAlertBold: return "\u{f917}"
        case .phoneAlertLight: return "\u{f918}"
        case .phoneAlertRegular: return "\u{f919}"
        case .phoneBadgeFilled: return "\u{f91a}"
        case .phoneBold: return "\u{f91b}"
        case .phoneFilled: return "\u{f91c}"
        case .phoneLight: return "\u{f91d}"
        case .phoneMutedBold: return "\u{f91e}"
        case .phoneMutedLight: return "\u{f91f}"
        case .phoneMutedRegular: return "\u{f920}"
        case .phonePrivateBold: return "\u{f921}"
        case .phonePrivateLight: return "\u{f922}"
        case .phonePrivateRegular: return "\u{f923}"
        case .phoneRegular: return "\u{f924}"
        case .phoneReplyAllBold: return "\u{f925}"
        case .phoneReplyAllLight: return "\u{f926}"
        case .phoneReplyAllRegular: return "\u{f927}"
        case .phoneReplyBold: return "\u{f928}"
        case .phoneReplyLight: return "\u{f929}"
        case .phoneReplyRegular: return "\u{f92a}"
        case .pickerBold: return "\u{f92b}"
        case .pickerLight: return "\u{f92c}"
        case .pickerRegular: return "\u{f92d}"
        case .pieChartBold: return "\u{f92e}"
        case .pieChartFilled: return "\u{f92f}"
        case .pieChartLight: return "\u{f930}"
        case .pieChartRegular: return "\u{f931}"
        case .pinBold: return "\u{f932}"
        case .pinFilled: return "\u{f933}"
        case .pinLight: return "\u{f934}"
        case .pinListActivityBold: return "\u{f935}"
        case .pinListActivityLight: return "\u{f936}"
        case .pinListActivityRegular: return "\u{f937}"
        case .pinListBold: return "\u{f938}"
        case .pinListLight: return "\u{f939}"
        case .pinListRegular: return "\u{f93a}"
        case .pinMutedBold: return "\u{f93b}"
        case .pinMutedFilled: return "\u{f93c}"
        case .pinMutedLight: return "\u{f93d}"
        case .pinMutedRegular: return "\u{f93e}"
        case .pinRegular: return "\u{f93f}"
        case .pipBold: return "\u{f940}"
        case .pipEnterBold: return "\u{f941}"
        case .pipEnterLight: return "\u{f942}"
        case .pipEnterRegular: return "\u{f943}"
        case .pipExitBold: return "\u{f944}"
        case .pipExitLight: return "\u{f945}"
        case .pipExitRegular: return "\u{f946}"
        case .pipFilled: return "\u{f947}"
        case .pipLight: return "\u{f948}"
        case .pipRegular: return "\u{f949}"
        case .placeholderBold: return "\u{f94a}"
        case .placeholderFilled: return "\u{f94b}"
        case .placeholderLight: return "\u{f94c}"
        case .placeholderRegular: return "\u{f94d}"
        case .playBold: return "\u{f94e}"
        case .playCircleBold: return "\u{f94f}"
        case .playCircleFilled: return "\u{f950}"
        case .playCircleLight: return "\u{f951}"
        case .playCircleRegular: return "\u{f952}"
        case .playFilled: return "\u{f953}"
        case .playLight: return "\u{f954}"
        case .playRegular: return "\u{f955}"
        case .plugAcBold: return "\u{f956}"
        case .plugAcLight: return "\u{f957}"
        case .plugAcRegular: return "\u{f958}"
        case .plusBold: return "\u{f959}"
        case .plusCircleBold: return "\u{f95a}"
        case .plusCircleFilled: return "\u{f95b}"
        case .plusCircleLight: return "\u{f95c}"
        case .plusCircleRegular: return "\u{f95d}"
        case .plusLight: return "\u{f95e}"
        case .plusRegular: return "\u{f95f}"
        case .pmrBold: return "\u{f960}"
        case .pmrFilled: return "\u{f961}"
        case .pmrLight: return "\u{f962}"
        case .pmrRegular: return "\u{f963}"
        case .pollBold: return "\u{f964}"
        case .pollFilled: return "\u{f965}"
        case .pollLight: return "\u{f966}"
        case .pollRegular: return "\u{f967}"
        case .popInBold: return "\u{f968}"
        case .popInLight: return "\u{f969}"
        case .popInRegular: return "\u{f96a}"
        case .popOutBold: return "\u{f96b}"
        case .popOutLight: return "\u{f96c}"
        case .popOutRegular: return "\u{f96d}"
        case .popUpBold: return "\u{f96e}"
        case .popUpLight: return "\u{f96f}"
        case .popUpRegular: return "\u{f970}"
        case .portraitLandscapeBold: return "\u{f971}"
        case .portraitLandscapeLight: return "\u{f972}"
        case .portraitLandscapeRegular: return "\u{f973}"
        case .potentialFraudBold: return "\u{f974}"
        case .potentialFraudFilled: return "\u{f975}"
        case .potentialFraudLight: return "\u{f976}"
        case .potentialFraudRegular: return "\u{f977}"
        case .powerAcBold: return "\u{f978}"
        case .powerAcLight: return "\u{f979}"
        case .powerAcRegular: return "\u{f97a}"
        case .powerBold: return "\u{f97b}"
        case .powerLight: return "\u{f97c}"
        case .powerRegular: return "\u{f97d}"
        case .preHeaderBold: return "\u{f97e}"
        case .preHeaderLight: return "\u{f97f}"
        case .preHeaderRegular: return "\u{f980}"
        case .premiumBold: return "\u{f981}"
        case .premiumLight: return "\u{f982}"
        case .premiumRegular: return "\u{f983}"
        case .presentationBold: return "\u{f984}"
        case .presentationLight: return "\u{f985}"
        case .presentationRegular: return "\u{f986}"
        case .preventDownloadBold: return "\u{f987}"
        case .preventDownloadFilled: return "\u{f988}"
        case .preventDownloadLight: return "\u{f989}"
        case .preventDownloadRegular: return "\u{f98a}"
        case .primaryParticipantBold: return "\u{f98b}"
        case .primaryParticipantFilled: return "\u{f98c}"
        case .primaryParticipantLight: return "\u{f98d}"
        case .primaryParticipantRegular: return "\u{f98e}"
        case .printBold: return "\u{f98f}"
        case .printLight: return "\u{f990}"
        case .printRegular: return "\u{f991}"
        case .priorityBadgeFilled: return "\u{f992}"
        case .priorityCircleBold: return "\u{f993}"
        case .priorityCircleFilled: return "\u{f994}"
        case .priorityCircleLight: return "\u{f995}"
        case .priorityCircleRegular: return "\u{f996}"
        case .priorityCircleTwoBold: return "\u{f997}"
        case .priorityCircleTwoFilled: return "\u{f998}"
        case .priorityCircleTwoLight: return "\u{f999}"
        case .priorityCircleTwoRegular: return "\u{f99a}"
        case .priorityWaveBold: return "\u{f99b}"
        case .priorityWaveLight: return "\u{f99c}"
        case .priorityWaveRegular: return "\u{f99d}"
        case .privacyCircleBold: return "\u{f99e}"
        case .privacyCircleFilled: return "\u{f99f}"
        case .privacyCircleLight: return "\u{f9a0}"
        case .privacyCircleRegular: return "\u{f9a1}"
        case .privateBold: return "\u{f9a2}"
        case .privateCircleBold: return "\u{f9a3}"
        case .privateCircleFilled: return "\u{f9a4}"
        case .privateCircleLight: return "\u{f9a5}"
        case .privateCircleRegular: return "\u{f9a6}"
        case .privateLight: return "\u{f9a7}"
        case .privateMeetingBold: return "\u{f9a8}"
        case .privateMeetingLight: return "\u{f9a9}"
        case .privateMeetingRegular: return "\u{f9aa}"
        case .privateRegular: return "\u{f9ab}"
        case .productDemoBold: return "\u{f9ac}"
        case .productDemoLight: return "\u{f9ad}"
        case .productDemoRegular: return "\u{f9ae}"
        case .promptsAiBold: return "\u{f9af}"
        case .promptsAiLight: return "\u{f9b0}"
        case .promptsAiRegular: return "\u{f9b1}"
        case .proximityBold: return "\u{f9b2}"
        case .proximityLight: return "\u{f9b3}"
        case .proximityMutedBold: return "\u{f9b4}"
        case .proximityMutedLight: return "\u{f9b5}"
        case .proximityMutedRegular: return "\u{f9b6}"
        case .proximityRegular: return "\u{f9b7}"
        case .proximityVideoBold: return "\u{f9b8}"
        case .proximityVideoLight: return "\u{f9b9}"
        case .proximityVideoRegular: return "\u{f9ba}"
        case .ptoPresenceBold: return "\u{f9bb}"
        case .ptoPresenceFilled: return "\u{f9bc}"
        case .ptoPresenceLight: return "\u{f9bd}"
        case .ptoPresenceRegular: return "\u{f9be}"
        case .pullCallBold: return "\u{f9bf}"
        case .pullCallFilled: return "\u{f9c0}"
        case .pullCallLight: return "\u{f9c1}"
        case .pullCallRegular: return "\u{f9c2}"
        case .purchaseOrderBold: return "\u{f9c3}"
        case .purchaseOrderFilled: return "\u{f9c4}"
        case .purchaseOrderLight: return "\u{f9c5}"
        case .purchaseOrderRegular: return "\u{f9c6}"
        case .qABold: return "\u{f9c7}"
        case .qAFilled: return "\u{f9c8}"
        case .qALight: return "\u{f9c9}"
        case .qARegular: return "\u{f9ca}"
        case .qrCodeBold: return "\u{f9cb}"
        case .qrCodeLight: return "\u{f9cc}"
        case .qrCodeRegular: return "\u{f9cd}"
        case .qrCodeScanBold: return "\u{f9ce}"
        case .qrCodeScanLight: return "\u{f9cf}"
        case .qrCodeScanRegular: return "\u{f9d0}"
        case .qualityBold: return "\u{f9d1}"
        case .qualityLight: return "\u{f9d2}"
        case .qualityRegular: return "\u{f9d3}"
        case .queueContactBold: return "\u{f9d4}"
        case .queueContactFilled: return "\u{f9d5}"
        case .queueContactLight: return "\u{f9d6}"
        case .queueContactRegular: return "\u{f9d7}"
        case .queuedInteractionBold: return "\u{f9d8}"
        case .queuedInteractionFilled: return "\u{f9d9}"
        case .queuedInteractionLight: return "\u{f9da}"
        case .queuedInteractionRegular: return "\u{f9db}"
        case .quietBold: return "\u{f9dc}"
        case .quietHoursPresenceBold: return "\u{f9dd}"
        case .quietHoursPresenceFilled: return "\u{f9de}"
        case .quietHoursPresenceLight: return "\u{f9df}"
        case .quietHoursPresenceRegular: return "\u{f9e0}"
        case .quietLight: return "\u{f9e1}"
        case .quietRegular: return "\u{f9e2}"
        case .radioButtonGroupBold: return "\u{f9e3}"
        case .radioButtonGroupLight: return "\u{f9e4}"
        case .radioButtonGroupRegular: return "\u{f9e5}"
        case .raiseHandBold: return "\u{f9e6}"
        case .raiseHandCircleFilled: return "\u{f9e7}"
        case .raiseHandFilled: return "\u{f9e8}"
        case .raiseHandLight: return "\u{f9e9}"
        case .raiseHandRegular: return "\u{f9ea}"
        case .ramBold: return "\u{f9eb}"
        case .ramLight: return "\u{f9ec}"
        case .ramRegular: return "\u{f9ed}"
        case .reactionsBold: return "\u{f9ee}"
        case .reactionsFilled: return "\u{f9ef}"
        case .reactionsLight: return "\u{f9f0}"
        case .reactionsRegular: return "\u{f9f1}"
        case .reactivateBold: return "\u{f9f2}"
        case .reactivateLight: return "\u{f9f3}"
        case .reactivateRegular: return "\u{f9f4}"
        case .receiveVoiceBold: return "\u{f9f5}"
        case .receiveVoiceFilled: return "\u{f9f6}"
        case .receiveVoiceLight: return "\u{f9f7}"
        case .receiveVoiceRegular: return "\u{f9f8}"
        case .recentsBold: return "\u{f9f9}"
        case .recentsFilled: return "\u{f9fa}"
        case .recentsLight: return "\u{f9fb}"
        case .recentsPresenceBadgeFilled: return "\u{f9fc}"
        case .recentsPresenceBold: return "\u{f9fd}"
        case .recentsPresenceFilled: return "\u{f9fe}"
        case .recentsPresenceLight: return "\u{f9ff}"
        case .recentsPresenceRegular: return "\u{fa00}"
        case .recentsRegular: return "\u{fa01}"
        case .recordActiveBadgeFilled: return "\u{fa02}"
        case .recordActiveBold: return "\u{fa03}"
        case .recordActiveFilled: return "\u{fa04}"
        case .recordActiveLight: return "\u{fa05}"
        case .recordActiveRegular: return "\u{fa06}"
        case .recordBold: return "\u{fa07}"
        case .recordFilled: return "\u{fa08}"
        case .recordLight: return "\u{fa09}"
        case .recordPausedBadgeFilled: return "\u{fa0a}"
        case .recordPausedBold: return "\u{fa0b}"
        case .recordPausedFilled: return "\u{fa0c}"
        case .recordPausedLight: return "\u{fa0d}"
        case .recordPausedRegular: return "\u{fa0e}"
        case .recordRegular: return "\u{fa0f}"
        case .recurringBold: return "\u{fa10}"
        case .recurringLight: return "\u{fa11}"
        case .recurringOffBold: return "\u{fa12}"
        case .recurringOffLight: return "\u{fa13}"
        case .recurringOffRegular: return "\u{fa14}"
        case .recurringRegular: return "\u{fa15}"
        case .redoBold: return "\u{fa16}"
        case .redoLight: return "\u{fa17}"
        case .redoRegular: return "\u{fa18}"
        case .refreshBold: return "\u{fa19}"
        case .refreshLight: return "\u{fa1a}"
        case .refreshRegular: return "\u{fa1b}"
        case .remoteDesktopControlBold: return "\u{fa1c}"
        case .remoteDesktopControlFilled: return "\u{fa1d}"
        case .remoteDesktopControlLight: return "\u{fa1e}"
        case .remoteDesktopControlRegular: return "\u{fa1f}"
        case .removeBold: return "\u{fa20}"
        case .removeFilled: return "\u{fa21}"
        case .removeLight: return "\u{fa22}"
        case .removeRegular: return "\u{fa23}"
        case .replyBold: return "\u{fa24}"
        case .replyFilled: return "\u{fa25}"
        case .replyLight: return "\u{fa26}"
        case .replyListBold: return "\u{fa27}"
        case .replyListFilled: return "\u{fa28}"
        case .replyListLight: return "\u{fa29}"
        case .replyListRegular: return "\u{fa2a}"
        case .replyPrivatelyBold: return "\u{fa2b}"
        case .replyPrivatelyLight: return "\u{fa2c}"
        case .replyPrivatelyRegular: return "\u{fa2d}"
        case .replyRegular: return "\u{fa2e}"
        case .resetBold: return "\u{fa2f}"
        case .resetLight: return "\u{fa30}"
        case .resetRegular: return "\u{fa31}"
        case .resizeCornerBold: return "\u{fa32}"
        case .resizeCornerLight: return "\u{fa33}"
        case .resizeCornerRegular: return "\u{fa34}"
        case .responsiveMobileBold: return "\u{fa35}"
        case .responsiveMobileLight: return "\u{fa36}"
        case .responsiveMobileRegular: return "\u{fa37}"
        case .restartBold: return "\u{fa38}"
        case .restartLight: return "\u{fa39}"
        case .restartRegular: return "\u{fa3a}"
        case .resumeInteractionBold: return "\u{fa3b}"
        case .resumeInteractionFilled: return "\u{fa3c}"
        case .resumeInteractionLight: return "\u{fa3d}"
        case .resumeInteractionRegular: return "\u{fa3e}"
        case .retrieveCallBold: return "\u{fa3f}"
        case .retrieveCallFilled: return "\u{fa40}"
        case .retrieveCallLight: return "\u{fa41}"
        case .retrieveCallRegular: return "\u{fa42}"
        case .returnBold: return "\u{fa43}"
        case .returnLight: return "\u{fa44}"
        case .returnRegular: return "\u{fa45}"
        case .rewindTenSecBold: return "\u{fa46}"
        case .rewindTenSecLight: return "\u{fa47}"
        case .rewindTenSecRegular: return "\u{fa48}"
        case .ringtoneBold: return "\u{fa49}"
        case .ringtoneLight: return "\u{fa4a}"
        case .ringtoneRegular: return "\u{fa4b}"
        case .roomCalendarBold: return "\u{fa4c}"
        case .roomCalendarLight: return "\u{fa4d}"
        case .roomCalendarRegular: return "\u{fa4e}"
        case .roomLightsBold: return "\u{fa4f}"
        case .roomLightsFilled: return "\u{fa50}"
        case .roomLightsLight: return "\u{fa51}"
        case .roomLightsRegular: return "\u{fa52}"
        case .rotateContentBold: return "\u{fa53}"
        case .rotateContentFilled: return "\u{fa54}"
        case .rotateContentLight: return "\u{fa55}"
        case .rotateContentRegular: return "\u{fa56}"
        case .rssBold: return "\u{fa57}"
        case .rssFilled: return "\u{fa58}"
        case .rssLight: return "\u{fa59}"
        case .rssRegular: return "\u{fa5a}"
        case .ruleBasedBold: return "\u{fa5b}"
        case .ruleBasedFilled: return "\u{fa5c}"
        case .ruleBasedLight: return "\u{fa5d}"
        case .ruleBasedRegular: return "\u{fa5e}"
        case .rulerBold: return "\u{fa5f}"
        case .rulerFilled: return "\u{fa60}"
        case .rulerLight: return "\u{fa61}"
        case .rulerRegular: return "\u{fa62}"
        case .runningApplicationBold: return "\u{fa63}"
        case .runningApplicationFilled: return "\u{fa64}"
        case .runningApplicationLight: return "\u{fa65}"
        case .runningApplicationRegular: return "\u{fa66}"
        case .saveBold: return "\u{fa67}"
        case .saveLight: return "\u{fa68}"
        case .saveRegular: return "\u{fa69}"
        case .saveTranscriptBold: return "\u{fa6a}"
        case .saveTranscriptFilled: return "\u{fa6b}"
        case .saveTranscriptLight: return "\u{fa6c}"
        case .saveTranscriptRegular: return "\u{fa6d}"
        case .scanBold: return "\u{fa6e}"
        case .scanLight: return "\u{fa6f}"
        case .scanRegular: return "\u{fa70}"
        case .scheduleAiBold: return "\u{fa71}"
        case .scheduleAiLight: return "\u{fa72}"
        case .scheduleAiRegular: return "\u{fa73}"
        case .scheduleSendBold: return "\u{fa74}"
        case .scheduleSendFilled: return "\u{fa75}"
        case .scheduleSendLight: return "\u{fa76}"
        case .scheduleSendRegular: return "\u{fa77}"
        case .scheduleWinnerBold: return "\u{fa78}"
        case .scheduleWinnerFilled: return "\u{fa79}"
        case .scheduleWinnerLight: return "\u{fa7a}"
        case .scheduleWinnerRegular: return "\u{fa7b}"
        case .schedulerAvailableBold: return "\u{fa7c}"
        case .schedulerAvailableLight: return "\u{fa7d}"
        case .schedulerAvailableRegular: return "\u{fa7e}"
        case .schedulerNotWorkingHoursBold: return "\u{fa7f}"
        case .schedulerNotWorkingHoursLight: return "\u{fa80}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa81}"
        case .schedulerUnavailableBold: return "\u{fa82}"
        case .schedulerUnavailableLight: return "\u{fa83}"
        case .schedulerUnavailableRegular: return "\u{fa84}"
        case .schedulerUnknownBold: return "\u{fa85}"
        case .schedulerUnknownLight: return "\u{fa86}"
        case .schedulerUnknownRegular: return "\u{fa87}"
        case .screenshotBold: return "\u{fa88}"
        case .screenshotDocBold: return "\u{fa89}"
        case .screenshotDocFilled: return "\u{fa8a}"
        case .screenshotDocLight: return "\u{fa8b}"
        case .screenshotDocRegular: return "\u{fa8c}"
        case .screenshotLight: return "\u{fa8d}"
        case .screenshotRegular: return "\u{fa8e}"
        case .searchAiBold: return "\u{fa8f}"
        case .searchAiLight: return "\u{fa90}"
        case .searchAiRegular: return "\u{fa91}"
        case .searchBold: return "\u{fa92}"
        case .searchFilled: return "\u{fa93}"
        case .searchLight: return "\u{fa94}"
        case .searchRegular: return "\u{fa95}"
        case .secondaryArrowBold: return "\u{fa96}"
        case .secondaryArrowLight: return "\u{fa97}"
        case .secondaryArrowRegular: return "\u{fa98}"
        case .secureCallLockBold: return "\u{fa99}"
        case .secureCallLockFilled: return "\u{fa9a}"
        case .secureCallLockLight: return "\u{fa9b}"
        case .secureCallLockRegular: return "\u{fa9c}"
        case .secureCallShieldBold: return "\u{fa9d}"
        case .secureCallShieldFilled: return "\u{fa9e}"
        case .secureCallShieldLight: return "\u{fa9f}"
        case .secureCallShieldRegular: return "\u{faa0}"
        case .secureCircleBold: return "\u{faa1}"
        case .secureCircleFilled: return "\u{faa2}"
        case .secureCircleLight: return "\u{faa3}"
        case .secureCircleRegular: return "\u{faa4}"
        case .secureLockBold: return "\u{faa5}"
        case .secureLockFilled: return "\u{faa6}"
        case .secureLockLight: return "\u{faa7}"
        case .secureLockRegular: return "\u{faa8}"
        case .segmentExcludeFilled: return "\u{faa9}"
        case .segmentFilterFilled: return "\u{faaa}"
        case .segmentIncludeFilled: return "\u{faab}"
        case .selectAllBold: return "\u{faac}"
        case .selectAllFilled: return "\u{faad}"
        case .selectAllLight: return "\u{faae}"
        case .selectAllRegular: return "\u{faaf}"
        case .selectionBold: return "\u{fab0}"
        case .selectionFilled: return "\u{fab1}"
        case .selectionLight: return "\u{fab2}"
        case .selectionRegular: return "\u{fab3}"
        case .sendBold: return "\u{fab4}"
        case .sendDigitsBold: return "\u{fab5}"
        case .sendDigitsFilled: return "\u{fab6}"
        case .sendDigitsLight: return "\u{fab7}"
        case .sendDigitsRegular: return "\u{fab8}"
        case .sendFilled: return "\u{fab9}"
        case .sendLight: return "\u{faba}"
        case .sendRegular: return "\u{fabb}"
        case .sendVoiceBold: return "\u{fabc}"
        case .sendVoiceFilled: return "\u{fabd}"
        case .sendVoiceLight: return "\u{fabe}"
        case .sendVoiceRegular: return "\u{fabf}"
        case .serverBold: return "\u{fac0}"
        case .serverErrorBold: return "\u{fac1}"
        case .serverErrorLight: return "\u{fac2}"
        case .serverErrorRegular: return "\u{fac3}"
        case .serverLight: return "\u{fac4}"
        case .serverRegular: return "\u{fac5}"
        case .servicesBold: return "\u{fac6}"
        case .servicesLight: return "\u{fac7}"
        case .servicesRegular: return "\u{fac8}"
        case .setVariableBold: return "\u{fac9}"
        case .setVariableLight: return "\u{faca}"
        case .setVariableRegular: return "\u{facb}"
        case .settingsBold: return "\u{facc}"
        case .settingsFilled: return "\u{facd}"
        case .settingsLight: return "\u{face}"
        case .settingsRegular: return "\u{facf}"
        case .setupAssistantBold: return "\u{fad0}"
        case .setupAssistantLight: return "\u{fad1}"
        case .setupAssistantRegular: return "\u{fad2}"
        case .sftpBold: return "\u{fad3}"
        case .sftpLight: return "\u{fad4}"
        case .sftpRegular: return "\u{fad5}"
        case .shapeCircleBold: return "\u{fad6}"
        case .shapeCircleFilled: return "\u{fad7}"
        case .shapeCircleLight: return "\u{fad8}"
        case .shapeCircleMdFilled: return "\u{fad9}"
        case .shapeCircleRegular: return "\u{fada}"
        case .shapeCircleSmFilled: return "\u{fadb}"
        case .shapeDiagonalLineBold: return "\u{fadc}"
        case .shapeDiagonalLineLight: return "\u{fadd}"
        case .shapeDiagonalLineRegular: return "\u{fade}"
        case .shapeDiamondBold: return "\u{fadf}"
        case .shapeDiamondFilled: return "\u{fae0}"
        case .shapeDiamondLight: return "\u{fae1}"
        case .shapeDiamondRegular: return "\u{fae2}"
        case .shapeOvalBold: return "\u{fae3}"
        case .shapeOvalLight: return "\u{fae4}"
        case .shapeOvalRegular: return "\u{fae5}"
        case .shapeSquareBold: return "\u{fae6}"
        case .shapeSquareFilled: return "\u{fae7}"
        case .shapeSquareLight: return "\u{fae8}"
        case .shapeSquareRegular: return "\u{fae9}"
        case .shapeTriangleBold: return "\u{faea}"
        case .shapeTriangleFilled: return "\u{faeb}"
        case .shapeTriangleLight: return "\u{faec}"
        case .shapeTriangleRegular: return "\u{faed}"
        case .shapesBold: return "\u{faee}"
        case .shapesFilled: return "\u{faef}"
        case .shapesLight: return "\u{faf0}"
        case .shapesRegular: return "\u{faf1}"
        case .shareCNativeAdrBold: return "\u{faf2}"
        case .shareCNativeAdrFilled: return "\u{faf3}"
        case .shareCNativeAdrLight: return "\u{faf4}"
        case .shareCNativeAdrRegular: return "\u{faf5}"
        case .shareCNativeIphBold: return "\u{faf6}"
        case .shareCNativeIphLight: return "\u{faf7}"
        case .shareCNativeIphRegular: return "\u{faf8}"
        case .shareContentOnDeviceBold: return "\u{faf9}"
        case .shareContentOnDeviceLight: return "\u{fafa}"
        case .shareContentOnDeviceRegular: return "\u{fafb}"
        case .shareScreenAddBold: return "\u{fafc}"
        case .shareScreenAddLight: return "\u{fafd}"
        case .shareScreenAddRegular: return "\u{fafe}"
        case .shareScreenBadgeFilled: return "\u{faff}"
        case .shareScreenBold: return "\u{fb00}"
        case .shareScreenFilled: return "\u{fb01}"
        case .shareScreenLight: return "\u{fb02}"
        case .shareScreenRegular: return "\u{fb03}"
        case .shareSpaceBold: return "\u{fb04}"
        case .shareSpaceLight: return "\u{fb05}"
        case .shareSpaceRegular: return "\u{fb06}"
        case .shieldBold: return "\u{fb07}"
        case .shieldLight: return "\u{fb08}"
        case .shieldRegular: return "\u{fb09}"
        case .shoppingCartBold: return "\u{fb0a}"
        case .shoppingCartFilled: return "\u{fb0b}"
        case .shoppingCartLight: return "\u{fb0c}"
        case .shoppingCartRegular: return "\u{fb0d}"
        case .shortTextBoxBold: return "\u{fb0e}"
        case .shortTextBoxLight: return "\u{fb0f}"
        case .shortTextBoxRegular: return "\u{fb10}"
        case .showBold: return "\u{fb11}"
        case .showFilled: return "\u{fb12}"
        case .showLight: return "\u{fb13}"
        case .showRegular: return "\u{fb14}"
        case .sidePanelBold: return "\u{fb15}"
        case .sidePanelFilled: return "\u{fb16}"
        case .sidePanelLight: return "\u{fb17}"
        case .sidePanelRegular: return "\u{fb18}"
        case .signInBold: return "\u{fb19}"
        case .signInFilled: return "\u{fb1a}"
        case .signInForcedBold: return "\u{fb1b}"
        case .signInForcedLight: return "\u{fb1c}"
        case .signInForcedRegular: return "\u{fb1d}"
        case .signInLight: return "\u{fb1e}"
        case .signInRegular: return "\u{fb1f}"
        case .signLangIntBold: return "\u{fb20}"
        case .signLangIntLight: return "\u{fb21}"
        case .signLangIntRegular: return "\u{fb22}"
        case .signOutBold: return "\u{fb23}"
        case .signOutLight: return "\u{fb24}"
        case .signOutRegular: return "\u{fb25}"
        case .signalFourBold: return "\u{fb26}"
        case .signalFourLight: return "\u{fb27}"
        case .signalFourRegular: return "\u{fb28}"
        case .signalOneBold: return "\u{fb29}"
        case .signalOneLight: return "\u{fb2a}"
        case .signalOneRegular: return "\u{fb2b}"
        case .signalThreeBold: return "\u{fb2c}"
        case .signalThreeLight: return "\u{fb2d}"
        case .signalThreeRegular: return "\u{fb2e}"
        case .signalTwoBold: return "\u{fb2f}"
        case .signalTwoLight: return "\u{fb30}"
        case .signalTwoRegular: return "\u{fb31}"
        case .signalZeroBold: return "\u{fb32}"
        case .signalZeroLight: return "\u{fb33}"
        case .signalZeroRegular: return "\u{fb34}"
        case .simplePromotionBold: return "\u{fb35}"
        case .simplePromotionLight: return "\u{fb36}"
        case .simplePromotionRegular: return "\u{fb37}"
        case .singleNumberReachBold: return "\u{fb38}"
        case .singleNumberReachLight: return "\u{fb39}"
        case .singleNumberReachRegular: return "\u{fb3a}"
        case .sipRegistrationInProgressBold: return "\u{fb3b}"
        case .sipRegistrationInProgressFilled: return "\u{fb3c}"
        case .sipRegistrationInProgressLight: return "\u{fb3d}"
        case .sipRegistrationInProgressRegular: return "\u{fb3e}"
        case .skipBold: return "\u{fb3f}"
        case .skipBwBold: return "\u{fb40}"
        case .skipBwFilled: return "\u{fb41}"
        case .skipBwLight: return "\u{fb42}"
        case .skipBwRegular: return "\u{fb43}"
        case .skipFwBold: return "\u{fb44}"
        case .skipFwFilled: return "\u{fb45}"
        case .skipFwLight: return "\u{fb46}"
        case .skipFwRegular: return "\u{fb47}"
        case .skipLight: return "\u{fb48}"
        case .skipRegular: return "\u{fb49}"
        case .smartAudioBold: return "\u{fb4a}"
        case .smartAudioLight: return "\u{fb4b}"
        case .smartAudioRegular: return "\u{fb4c}"
        case .smartReplyBold: return "\u{fb4d}"
        case .smartReplyLight: return "\u{fb4e}"
        case .smartReplyRegular: return "\u{fb4f}"
        case .smsFilled: return "\u{fb50}"
        case .smsInboundBold: return "\u{fb51}"
        case .smsInboundLight: return "\u{fb52}"
        case .smsInboundRegular: return "\u{fb53}"
        case .smsMessageBold: return "\u{fb54}"
        case .smsMessageFilled: return "\u{fb55}"
        case .smsMessageLight: return "\u{fb56}"
        case .smsMessageOutgoingBold: return "\u{fb57}"
        case .smsMessageOutgoingFilled: return "\u{fb58}"
        case .smsMessageOutgoingLight: return "\u{fb59}"
        case .smsMessageOutgoingRegular: return "\u{fb5a}"
        case .smsMessageRegular: return "\u{fb5b}"
        case .smsMessageStartBold: return "\u{fb5c}"
        case .smsMessageStartFilled: return "\u{fb5d}"
        case .smsMessageStartLight: return "\u{fb5e}"
        case .smsMessageStartRegular: return "\u{fb5f}"
        case .smsOutgoingFilled: return "\u{fb60}"
        case .smsUnreadBold: return "\u{fb61}"
        case .smsUnreadLight: return "\u{fb62}"
        case .smsUnreadRegular: return "\u{fb63}"
        case .sortAscendingBold: return "\u{fb64}"
        case .sortAscendingLight: return "\u{fb65}"
        case .sortAscendingRegular: return "\u{fb66}"
        case .sortDescendingBold: return "\u{fb67}"
        case .sortDescendingLight: return "\u{fb68}"
        case .sortDescendingRegular: return "\u{fb69}"
        case .soundDefaultBold: return "\u{fb6a}"
        case .soundDefaultLight: return "\u{fb6b}"
        case .soundDefaultRegular: return "\u{fb6c}"
        case .sparkleBold: return "\u{fb6d}"
        case .sparkleFilled: return "\u{fb6e}"
        case .sparkleLight: return "\u{fb6f}"
        case .sparkleRegular: return "\u{fb70}"
        case .speakerBold: return "\u{fb71}"
        case .speakerDisconnectedBold: return "\u{fb72}"
        case .speakerDisconnectedFilled: return "\u{fb73}"
        case .speakerDisconnectedLight: return "\u{fb74}"
        case .speakerDisconnectedRegular: return "\u{fb75}"
        case .speakerFilled: return "\u{fb76}"
        case .speakerLight: return "\u{fb77}"
        case .speakerMutedBold: return "\u{fb78}"
        case .speakerMutedFilled: return "\u{fb79}"
        case .speakerMutedLight: return "\u{fb7a}"
        case .speakerMutedRegular: return "\u{fb7b}"
        case .speakerOffBold: return "\u{fb7c}"
        case .speakerOffFilled: return "\u{fb7d}"
        case .speakerOffLight: return "\u{fb7e}"
        case .speakerOffRegular: return "\u{fb7f}"
        case .speakerOnBold: return "\u{fb80}"
        case .speakerOnLight: return "\u{fb81}"
        case .speakerOnRegular: return "\u{fb82}"
        case .speakerRegular: return "\u{fb83}"
        case .speakerTurnDownBold: return "\u{fb84}"
        case .speakerTurnDownFilled: return "\u{fb85}"
        case .speakerTurnDownLight: return "\u{fb86}"
        case .speakerTurnDownRegular: return "\u{fb87}"
        case .speakerTurnUpBold: return "\u{fb88}"
        case .speakerTurnUpFilled: return "\u{fb89}"
        case .speakerTurnUpLight: return "\u{fb8a}"
        case .speakerTurnUpRegular: return "\u{fb8b}"
        case .speedDialBold: return "\u{fb8c}"
        case .speedDialFilled: return "\u{fb8d}"
        case .speedDialLight: return "\u{fb8e}"
        case .speedDialRegular: return "\u{fb8f}"
        case .spellCheckerBold: return "\u{fb90}"
        case .spellCheckerLight: return "\u{fb91}"
        case .spellCheckerRegular: return "\u{fb92}"
        case .splitViewBold: return "\u{fb93}"
        case .splitViewLight: return "\u{fb94}"
        case .splitViewRegular: return "\u{fb95}"
        case .stackedAreaChartBold: return "\u{fb96}"
        case .stackedAreaChartFilled: return "\u{fb97}"
        case .stackedAreaChartFullBold: return "\u{fb98}"
        case .stackedAreaChartFullFilled: return "\u{fb99}"
        case .stackedAreaChartFullLight: return "\u{fb9a}"
        case .stackedAreaChartFullRegular: return "\u{fb9b}"
        case .stackedAreaChartLight: return "\u{fb9c}"
        case .stackedAreaChartRegular: return "\u{fb9d}"
        case .stackedBarChartBold: return "\u{fb9e}"
        case .stackedBarChartFilled: return "\u{fb9f}"
        case .stackedBarChartFullBold: return "\u{fba0}"
        case .stackedBarChartFullFilled: return "\u{fba1}"
        case .stackedBarChartFullLight: return "\u{fba2}"
        case .stackedBarChartFullRegular: return "\u{fba3}"
        case .stackedBarChartLight: return "\u{fba4}"
        case .stackedBarChartRegular: return "\u{fba5}"
        case .startChatBold: return "\u{fba6}"
        case .startChatLight: return "\u{fba7}"
        case .startChatRegular: return "\u{fba8}"
        case .stethoscopeBold: return "\u{fba9}"
        case .stethoscopeLight: return "\u{fbaa}"
        case .stethoscopeRegular: return "\u{fbab}"
        case .stickersBold: return "\u{fbac}"
        case .stickersLight: return "\u{fbad}"
        case .stickersRegular: return "\u{fbae}"
        case .stickiesBold: return "\u{fbaf}"
        case .stickiesLight: return "\u{fbb0}"
        case .stickiesRegular: return "\u{fbb1}"
        case .stopBold: return "\u{fbb2}"
        case .stopCircleBold: return "\u{fbb3}"
        case .stopCircleFilled: return "\u{fbb4}"
        case .stopCircleLight: return "\u{fbb5}"
        case .stopCircleRegular: return "\u{fbb6}"
        case .stopContentShareBold: return "\u{fbb7}"
        case .stopContentShareLight: return "\u{fbb8}"
        case .stopContentShareRegular: return "\u{fbb9}"
        case .stopFilled: return "\u{fbba}"
        case .stopLight: return "\u{fbbb}"
        case .stopRegular: return "\u{fbbc}"
        case .storedInfoBold: return "\u{fbbd}"
        case .storedInfoFilled: return "\u{fbbe}"
        case .storedInfoLight: return "\u{fbbf}"
        case .storedInfoRegular: return "\u{fbc0}"
        case .streamingBold: return "\u{fbc1}"
        case .streamingLight: return "\u{fbc2}"
        case .streamingRegular: return "\u{fbc3}"
        case .strikethroughBold: return "\u{fbc4}"
        case .strikethroughFilled: return "\u{fbc5}"
        case .strikethroughLight: return "\u{fbc6}"
        case .strikethroughRegular: return "\u{fbc7}"
        case .studioModeBold: return "\u{fbc8}"
        case .studioModeLight: return "\u{fbc9}"
        case .studioModeRegular: return "\u{fbca}"
        case .subscriptBold: return "\u{fbcb}"
        case .subscriptLight: return "\u{fbcc}"
        case .subscriptRegular: return "\u{fbcd}"
        case .summarizeAiBold: return "\u{fbce}"
        case .summarizeAiLight: return "\u{fbcf}"
        case .summarizeAiRegular: return "\u{fbd0}"
        case .superscriptBold: return "\u{fbd1}"
        case .superscriptLight: return "\u{fbd2}"
        case .superscriptRegular: return "\u{fbd3}"
        case .surveyBold: return "\u{fbd4}"
        case .surveyFilled: return "\u{fbd5}"
        case .surveyLight: return "\u{fbd6}"
        case .surveyRegular: return "\u{fbd7}"
        case .sxEightyCodecBold: return "\u{fbd8}"
        case .sxEightyCodecLight: return "\u{fbd9}"
        case .sxEightyCodecRegular: return "\u{fbda}"
        case .sxTenBold: return "\u{fbdb}"
        case .sxTenLight: return "\u{fbdc}"
        case .sxTenRegular: return "\u{fbdd}"
        case .sxTwentyBold: return "\u{fbde}"
        case .sxTwentyLight: return "\u{fbdf}"
        case .sxTwentyRegular: return "\u{fbe0}"
        case .tableBold: return "\u{fbe1}"
        case .tableExtenderBold: return "\u{fbe2}"
        case .tableExtenderFilled: return "\u{fbe3}"
        case .tableExtenderLight: return "\u{fbe4}"
        case .tableExtenderRegular: return "\u{fbe5}"
        case .tableLight: return "\u{fbe6}"
        case .tableRegular: return "\u{fbe7}"
        case .tabletBold: return "\u{fbe8}"
        case .tabletLight: return "\u{fbe9}"
        case .tabletRegular: return "\u{fbea}"
        case .tabsBold: return "\u{fbeb}"
        case .tabsLight: return "\u{fbec}"
        case .tabsRegular: return "\u{fbed}"
        case .tagBold: return "\u{fbee}"
        case .tagLight: return "\u{fbef}"
        case .tagRegular: return "\u{fbf0}"
        case .tapBold: return "\u{fbf1}"
        case .tapFilled: return "\u{fbf2}"
        case .tapLight: return "\u{fbf3}"
        case .tapRegular: return "\u{fbf4}"
        case .telepresenceAlertBold: return "\u{fbf5}"
        case .telepresenceAlertLight: return "\u{fbf6}"
        case .telepresenceAlertMutedBold: return "\u{fbf7}"
        case .telepresenceAlertMutedLight: return "\u{fbf8}"
        case .telepresenceAlertMutedRegular: return "\u{fbf9}"
        case .telepresenceAlertRegular: return "\u{fbfa}"
        case .telepresenceBold: return "\u{fbfb}"
        case .telepresenceIxFiveThousandBold: return "\u{fbfc}"
        case .telepresenceIxFiveThousandLight: return "\u{fbfd}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbfe}"
        case .telepresenceLight: return "\u{fbff}"
        case .telepresenceMutedBold: return "\u{fc00}"
        case .telepresenceMutedLight: return "\u{fc01}"
        case .telepresenceMutedRegular: return "\u{fc02}"
        case .telepresencePrivateBold: return "\u{fc03}"
        case .telepresencePrivateLight: return "\u{fc04}"
        case .telepresencePrivateRegular: return "\u{fc05}"
        case .telepresenceRegular: return "\u{fc06}"
        case .temperatureBold: return "\u{fc07}"
        case .temperatureLight: return "\u{fc08}"
        case .temperatureRegular: return "\u{fc09}"
        case .testTubeBold: return "\u{fc0a}"
        case .testTubeFilled: return "\u{fc0b}"
        case .testTubeLight: return "\u{fc0c}"
        case .testTubeRegular: return "\u{fc0d}"
        case .textAlignCenterBold: return "\u{fc0e}"
        case .textAlignCenterFilled: return "\u{fc0f}"
        case .textAlignCenterLight: return "\u{fc10}"
        case .textAlignCenterRegular: return "\u{fc11}"
        case .textAlignLeftBold: return "\u{fc12}"
        case .textAlignLeftFilled: return "\u{fc13}"
        case .textAlignLeftLight: return "\u{fc14}"
        case .textAlignLeftRegular: return "\u{fc15}"
        case .textAlignRightBold: return "\u{fc16}"
        case .textAlignRightFilled: return "\u{fc17}"
        case .textAlignRightLight: return "\u{fc18}"
        case .textAlignRightRegular: return "\u{fc19}"
        case .textBold: return "\u{fc1a}"
        case .textBoxCursorLight: return "\u{fc1b}"
        case .textCodeBlockBold: return "\u{fc1c}"
        case .textCodeBlockLight: return "\u{fc1d}"
        case .textCodeBlockRegular: return "\u{fc1e}"
        case .textHighlightBold: return "\u{fc1f}"
        case .textHighlightFilled: return "\u{fc20}"
        case .textHighlightLight: return "\u{fc21}"
        case .textHighlightRegular: return "\u{fc22}"
        case .textLight: return "\u{fc23}"
        case .textRegular: return "\u{fc24}"
        case .threeColumnBold: return "\u{fc25}"
        case .threeColumnLight: return "\u{fc26}"
        case .threeColumnRegular: return "\u{fc27}"
        case .threeDObjectBold: return "\u{fc28}"
        case .threeDObjectLight: return "\u{fc29}"
        case .threeDObjectRegular: return "\u{fc2a}"
        case .timeExclusionBold: return "\u{fc2b}"
        case .timeExclusionLight: return "\u{fc2c}"
        case .timeExclusionRegular: return "\u{fc2d}"
        case .timezoneBold: return "\u{fc2e}"
        case .timezoneFilled: return "\u{fc2f}"
        case .timezoneLight: return "\u{fc30}"
        case .timezoneRegular: return "\u{fc31}"
        case .tooFastBold: return "\u{fc32}"
        case .tooFastLight: return "\u{fc33}"
        case .tooFastRegular: return "\u{fc34}"
        case .tooSlowBold: return "\u{fc35}"
        case .tooSlowLight: return "\u{fc36}"
        case .tooSlowRegular: return "\u{fc37}"
        case .toolsBold: return "\u{fc38}"
        case .toolsFilled: return "\u{fc39}"
        case .toolsLight: return "\u{fc3a}"
        case .toolsRegular: return "\u{fc3b}"
        case .touchTenBold: return "\u{fc3c}"
        case .touchTenLight: return "\u{fc3d}"
        case .touchTenRegular: return "\u{fc3e}"
        case .transcriptBold: return "\u{fc3f}"
        case .transcriptFilled: return "\u{fc40}"
        case .transcriptLight: return "\u{fc41}"
        case .transcriptRegular: return "\u{fc42}"
        case .translateBold: return "\u{fc43}"
        case .translateLight: return "\u{fc44}"
        case .translateRegular: return "\u{fc45}"
        case .translateUndoBold: return "\u{fc46}"
        case .translateUndoLight: return "\u{fc47}"
        case .translateUndoRegular: return "\u{fc48}"
        case .trendingBold: return "\u{fc49}"
        case .trendingDownBold: return "\u{fc4a}"
        case .trendingDownFilled: return "\u{fc4b}"
        case .trendingDownLight: return "\u{fc4c}"
        case .trendingDownRegular: return "\u{fc4d}"
        case .trendingFilled: return "\u{fc4e}"
        case .trendingLight: return "\u{fc4f}"
        case .trendingRegular: return "\u{fc50}"
        case .trimBold: return "\u{fc51}"
        case .trimLight: return "\u{fc52}"
        case .trimRegular: return "\u{fc53}"
        case .twoColumnBold: return "\u{fc54}"
        case .twoColumnLight: return "\u{fc55}"
        case .twoColumnRegular: return "\u{fc56}"
        case .twoWayVoiceStreamBold: return "\u{fc57}"
        case .twoWayVoiceStreamFilled: return "\u{fc58}"
        case .twoWayVoiceStreamLight: return "\u{fc59}"
        case .twoWayVoiceStreamRegular: return "\u{fc5a}"
        case .ucmCloudBold: return "\u{fc5b}"
        case .ucmCloudLight: return "\u{fc5c}"
        case .ucmCloudRegular: return "\u{fc5d}"
        case .unblockBold: return "\u{fc5e}"
        case .unblockFilled: return "\u{fc5f}"
        case .unblockLight: return "\u{fc60}"
        case .unblockRegular: return "\u{fc61}"
        case .underlineBold: return "\u{fc62}"
        case .underlineFilled: return "\u{fc63}"
        case .underlineLight: return "\u{fc64}"
        case .underlineRegular: return "\u{fc65}"
        case .undoBold: return "\u{fc66}"
        case .undoLight: return "\u{fc67}"
        case .undoRegular: return "\u{fc68}"
        case .unlinkBold: return "\u{fc69}"
        case .unlinkLight: return "\u{fc6a}"
        case .unlinkRegular: return "\u{fc6b}"
        case .unreadBold: return "\u{fc6c}"
        case .unreadFilled: return "\u{fc6d}"
        case .unreadLight: return "\u{fc6e}"
        case .unreadRegular: return "\u{fc6f}"
        case .unsecureUnlockedBold: return "\u{fc70}"
        case .unsecureUnlockedFilled: return "\u{fc71}"
        case .unsecureUnlockedLight: return "\u{fc72}"
        case .unsecureUnlockedRegular: return "\u{fc73}"
        case .unsortedBold: return "\u{fc74}"
        case .unsortedLight: return "\u{fc75}"
        case .unsortedRegular: return "\u{fc76}"
        case .updateFileShareBold: return "\u{fc77}"
        case .updateFileShareLight: return "\u{fc78}"
        case .updateFileShareRegular: return "\u{fc79}"
        case .uploadBold: return "\u{fc7a}"
        case .uploadImageBold: return "\u{fc7b}"
        case .uploadImageLight: return "\u{fc7c}"
        case .uploadImageRegular: return "\u{fc7d}"
        case .uploadLight: return "\u{fc7e}"
        case .uploadRegular: return "\u{fc7f}"
        case .urgentVoicemailBold: return "\u{fc80}"
        case .urgentVoicemailFilled: return "\u{fc81}"
        case .usbBold: return "\u{fc82}"
        case .usbHeadsetBold: return "\u{fc83}"
        case .usbHeadsetLight: return "\u{fc84}"
        case .usbHeadsetMutedBold: return "\u{fc85}"
        case .usbHeadsetMutedLight: return "\u{fc86}"
        case .usbHeadsetMutedRegular: return "\u{fc87}"
        case .usbHeadsetRegular: return "\u{fc88}"
        case .usbLight: return "\u{fc89}"
        case .usbRegular: return "\u{fc8a}"
        case .userBold: return "\u{fc8b}"
        case .userDeactivateBold: return "\u{fc8c}"
        case .userDeactivateLight: return "\u{fc8d}"
        case .userDeactivateRegular: return "\u{fc8e}"
        case .userFilled: return "\u{fc8f}"
        case .userLight: return "\u{fc90}"
        case .userRegular: return "\u{fc91}"
        case .videoBlurBold: return "\u{fc92}"
        case .videoBlurFilled: return "\u{fc93}"
        case .videoBlurLight: return "\u{fc94}"
        case .videoBlurRegular: return "\u{fc95}"
        case .videoBold: return "\u{fc96}"
        case .videoEffectBold: return "\u{fc97}"
        case .videoEffectFilled: return "\u{fc98}"
        case .videoEffectLight: return "\u{fc99}"
        case .videoEffectRegular: return "\u{fc9a}"
        case .videoFilled: return "\u{fc9b}"
        case .videoLayoutBold: return "\u{fc9c}"
        case .videoLayoutCustomBold: return "\u{fc9d}"
        case .videoLayoutCustomFilled: return "\u{fc9e}"
        case .videoLayoutCustomLight: return "\u{fc9f}"
        case .videoLayoutCustomRegular: return "\u{fca0}"
        case .videoLayoutEqualBold: return "\u{fca1}"
        case .videoLayoutEqualDualBold: return "\u{fca2}"
        case .videoLayoutEqualDualLight: return "\u{fca3}"
        case .videoLayoutEqualDualRegular: return "\u{fca4}"
        case .videoLayoutEqualFilled: return "\u{fca5}"
        case .videoLayoutEqualLight: return "\u{fca6}"
        case .videoLayoutEqualRegular: return "\u{fca7}"
        case .videoLayoutFilled: return "\u{fca8}"
        case .videoLayoutLight: return "\u{fca9}"
        case .videoLayoutOverlayBold: return "\u{fcaa}"
        case .videoLayoutOverlayFilled: return "\u{fcab}"
        case .videoLayoutOverlayLight: return "\u{fcac}"
        case .videoLayoutOverlayRegular: return "\u{fcad}"
        case .videoLayoutPresentationBold: return "\u{fcae}"
        case .videoLayoutPresentationFilled: return "\u{fcaf}"
        case .videoLayoutPresentationLight: return "\u{fcb0}"
        case .videoLayoutPresentationRegular: return "\u{fcb1}"
        case .videoLayoutPresenterDominantBold: return "\u{fcb2}"
        case .videoLayoutPresenterDominantLight: return "\u{fcb3}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcb4}"
        case .videoLayoutProminentBold: return "\u{fcb5}"
        case .videoLayoutProminentFilled: return "\u{fcb6}"
        case .videoLayoutProminentLight: return "\u{fcb7}"
        case .videoLayoutProminentRegular: return "\u{fcb8}"
        case .videoLayoutRegular: return "\u{fcb9}"
        case .videoLayoutShareDominantBold: return "\u{fcba}"
        case .videoLayoutShareDominantLight: return "\u{fcbb}"
        case .videoLayoutShareDominantRegular: return "\u{fcbc}"
        case .videoLayoutSingleBold: return "\u{fcbd}"
        case .videoLayoutSingleFilled: return "\u{fcbe}"
        case .videoLayoutSingleLight: return "\u{fcbf}"
        case .videoLayoutSingleRegular: return "\u{fcc0}"
        case .videoLayoutSpeakerBold: return "\u{fcc1}"
        case .videoLayoutSpeakerFilled: return "\u{fcc2}"
        case .videoLayoutSpeakerLight: return "\u{fcc3}"
        case .videoLayoutSpeakerRegular: return "\u{fcc4}"
        case .videoLayoutStackBold: return "\u{fcc5}"
        case .videoLayoutStackFilled: return "\u{fcc6}"
        case .videoLayoutStackLight: return "\u{fcc7}"
        case .videoLayoutStackRegular: return "\u{fcc8}"
        case .videoLayoutVideoDominantBold: return "\u{fcc9}"
        case .videoLayoutVideoDominantFilled: return "\u{fcca}"
        case .videoLayoutVideoDominantLight: return "\u{fccb}"
        case .videoLayoutVideoDominantRegular: return "\u{fccc}"
        case .videoLight: return "\u{fccd}"
        case .videoPlusBold: return "\u{fcce}"
        case .videoPlusFilled: return "\u{fccf}"
        case .videoPlusLight: return "\u{fcd0}"
        case .videoPlusRegular: return "\u{fcd1}"
        case .videoRegular: return "\u{fcd2}"
        case .videoSpeakerTrackBold: return "\u{fcd3}"
        case .videoSpeakerTrackFilled: return "\u{fcd4}"
        case .videoSpeakerTrackLight: return "\u{fcd5}"
        case .videoSpeakerTrackRegular: return "\u{fcd6}"
        case .viewAllBold: return "\u{fcd7}"
        case .viewAllLight: return "\u{fcd8}"
        case .viewAllRegular: return "\u{fcd9}"
        case .viewListBold: return "\u{fcda}"
        case .viewListFilled: return "\u{fcdb}"
        case .viewListLight: return "\u{fcdc}"
        case .viewListRegular: return "\u{fcdd}"
        case .viewStackedBold: return "\u{fcde}"
        case .viewStackedFilled: return "\u{fcdf}"
        case .viewStackedLight: return "\u{fce0}"
        case .viewStackedRegular: return "\u{fce1}"
        case .viewThumbnailBold: return "\u{fce2}"
        case .viewThumbnailFilled: return "\u{fce3}"
        case .viewThumbnailLight: return "\u{fce4}"
        case .viewThumbnailRegular: return "\u{fce5}"
        case .visionproBold: return "\u{fce6}"
        case .visionproFilled: return "\u{fce7}"
        case .visionproLight: return "\u{fce8}"
        case .visionproMoveCallInBold: return "\u{fce9}"
        case .visionproMoveCallInFilled: return "\u{fcea}"
        case .visionproMoveCallInLight: return "\u{fceb}"
        case .visionproMoveCallInOutBold: return "\u{fcec}"
        case .visionproMoveCallInOutFilled: return "\u{fced}"
        case .visionproMoveCallInOutLight: return "\u{fcee}"
        case .visionproMoveCallInOutRegular: return "\u{fcef}"
        case .visionproMoveCallInRegular: return "\u{fcf0}"
        case .visionproMoveCallOutBold: return "\u{fcf1}"
        case .visionproMoveCallOutFilled: return "\u{fcf2}"
        case .visionproMoveCallOutLight: return "\u{fcf3}"
        case .visionproMoveCallOutRegular: return "\u{fcf4}"
        case .visionproRegular: return "\u{fcf5}"
        case .voicemailBold: return "\u{fcf6}"
        case .voicemailFilled: return "\u{fcf7}"
        case .voicemailLight: return "\u{fcf8}"
        case .voicemailRegular: return "\u{fcf9}"
        case .vpnBold: return "\u{fcfa}"
        case .vpnFilled: return "\u{fcfb}"
        case .vpnLight: return "\u{fcfc}"
        case .vpnRegular: return "\u{fcfd}"
        case .vscBold: return "\u{fcfe}"
        case .vscLight: return "\u{fcff}"
        case .vscRegular: return "\u{fd00}"
        case .waffleMenuBold: return "\u{fd01}"
        case .waffleMenuLight: return "\u{fd02}"
        case .waffleMenuRegular: return "\u{fd03}"
        case .waitingRoomBold: return "\u{fd04}"
        case .waitingRoomFilled: return "\u{fd05}"
        case .waitingRoomLight: return "\u{fd06}"
        case .waitingRoomRegular: return "\u{fd07}"
        case .wallpaperBold: return "\u{fd08}"
        case .wallpaperLight: return "\u{fd09}"
        case .wallpaperRegular: return "\u{fd0a}"
        case .warningBadgeFilled: return "\u{fd0b}"
        case .warningBold: return "\u{fd0c}"
        case .warningFilled: return "\u{fd0d}"
        case .warningLight: return "\u{fd0e}"
        case .warningRegular: return "\u{fd0f}"
        case .webexBoardBold: return "\u{fd10}"
        case .webexBoardLight: return "\u{fd11}"
        case .webexBoardRegular: return "\u{fd12}"
        case .webexCodecPlusBold: return "\u{fd13}"
        case .webexCodecPlusLight: return "\u{fd14}"
        case .webexCodecPlusRegular: return "\u{fd15}"
        case .webexDeskCameraBold: return "\u{fd16}"
        case .webexDeskCameraLight: return "\u{fd17}"
        case .webexDeskCameraRegular: return "\u{fd18}"
        case .webexHelixBold: return "\u{fd19}"
        case .webexHelixLight: return "\u{fd1a}"
        case .webexHelixRegular: return "\u{fd1b}"
        case .webexMeetingsBold: return "\u{fd1c}"
        case .webexMeetingsFilled: return "\u{fd1d}"
        case .webexMeetingsLight: return "\u{fd1e}"
        case .webexMeetingsRegular: return "\u{fd1f}"
        case .webexQuadCameraBold: return "\u{fd20}"
        case .webexQuadCameraLight: return "\u{fd21}"
        case .webexQuadCameraRegular: return "\u{fd22}"
        case .webexRoomKitBold: return "\u{fd23}"
        case .webexRoomKitLight: return "\u{fd24}"
        case .webexRoomKitPlusBold: return "\u{fd25}"
        case .webexRoomKitPlusLight: return "\u{fd26}"
        case .webexRoomKitPlusRegular: return "\u{fd27}"
        case .webexRoomKitRegular: return "\u{fd28}"
        case .webexShareBold: return "\u{fd29}"
        case .webexShareLight: return "\u{fd2a}"
        case .webexShareRegular: return "\u{fd2b}"
        case .webexTeamsBold: return "\u{fd2c}"
        case .webexTeamsFilled: return "\u{fd2d}"
        case .webexTeamsLight: return "\u{fd2e}"
        case .webexTeamsNewBold: return "\u{fd2f}"
        case .webexTeamsNewFilled: return "\u{fd30}"
        case .webexTeamsNewLight: return "\u{fd31}"
        case .webexTeamsNewRegular: return "\u{fd32}"
        case .webexTeamsRegular: return "\u{fd33}"
        case .webexTeamsRemoveBold: return "\u{fd34}"
        case .webexTeamsRemoveLight: return "\u{fd35}"
        case .webexTeamsRemoveRegular: return "\u{fd36}"
        case .webhookBold: return "\u{fd37}"
        case .webhookLight: return "\u{fd38}"
        case .webhookRegular: return "\u{fd39}"
        case .webinarBold: return "\u{fd3a}"
        case .webinarFilled: return "\u{fd3b}"
        case .webinarLight: return "\u{fd3c}"
        case .webinarRegular: return "\u{fd3d}"
        case .weeklyRecurringScheduleBold: return "\u{fd3e}"
        case .weeklyRecurringScheduleLight: return "\u{fd3f}"
        case .weeklyRecurringScheduleRegular: return "\u{fd40}"
        case .whisperAnnouncementBold: return "\u{fd41}"
        case .whisperAnnouncementFilled: return "\u{fd42}"
        case .whisperAnnouncementLight: return "\u{fd43}"
        case .whisperAnnouncementRegular: return "\u{fd44}"
        case .whisperCoachBold: return "\u{fd45}"
        case .whisperCoachFilled: return "\u{fd46}"
        case .whisperCoachLight: return "\u{fd47}"
        case .whisperCoachRegular: return "\u{fd48}"
        case .whiteboardBold: return "\u{fd49}"
        case .whiteboardContentBold: return "\u{fd4a}"
        case .whiteboardContentFilled: return "\u{fd4b}"
        case .whiteboardContentLight: return "\u{fd4c}"
        case .whiteboardContentRegular: return "\u{fd4d}"
        case .whiteboardFilled: return "\u{fd4e}"
        case .whiteboardLight: return "\u{fd4f}"
        case .whiteboardRegular: return "\u{fd50}"
        case .widgetBold: return "\u{fd51}"
        case .widgetFilled: return "\u{fd52}"
        case .widgetLight: return "\u{fd53}"
        case .widgetRegular: return "\u{fd54}"
        case .wifiBold: return "\u{fd55}"
        case .wifiErrorBold: return "\u{fd56}"
        case .wifiErrorLight: return "\u{fd57}"
        case .wifiErrorRegular: return "\u{fd58}"
        case .wifiLight: return "\u{fd59}"
        case .wifiRegular: return "\u{fd5a}"
        case .wifiSignalGoodBold: return "\u{fd5b}"
        case .wifiSignalGoodLight: return "\u{fd5c}"
        case .wifiSignalGoodRegular: return "\u{fd5d}"
        case .wifiSignalPoorBold: return "\u{fd5e}"
        case .wifiSignalPoorLight: return "\u{fd5f}"
        case .wifiSignalPoorRegular: return "\u{fd60}"
        case .wifiSignalUnstableBold: return "\u{fd61}"
        case .wifiSignalUnstableLight: return "\u{fd62}"
        case .wifiSignalUnstableRegular: return "\u{fd63}"
        case .windowCornerScrubBold: return "\u{fd64}"
        case .windowCornerScrubLight: return "\u{fd65}"
        case .windowCornerScrubRegular: return "\u{fd66}"
        case .windowRightCornerScrubBold: return "\u{fd67}"
        case .windowRightCornerScrubLight: return "\u{fd68}"
        case .windowRightCornerScrubRegular: return "\u{fd69}"
        case .windowVerticalScrubBold: return "\u{fd6a}"
        case .windowVerticalScrubLight: return "\u{fd6b}"
        case .windowVerticalScrubRegular: return "\u{fd6c}"
        case .workflowDeploymentsBold: return "\u{fd6d}"
        case .workflowDeploymentsFilled: return "\u{fd6e}"
        case .workflowDeploymentsLight: return "\u{fd6f}"
        case .workflowDeploymentsRegular: return "\u{fd70}"
        case .workphoneBold: return "\u{fd71}"
        case .workphoneLight: return "\u{fd72}"
        case .workphoneRegular: return "\u{fd73}"
        case .zoomInBold: return "\u{fd74}"
        case .zoomInLight: return "\u{fd75}"
        case .zoomInRegular: return "\u{fd76}"
        case .zoomOutBold: return "\u{fd77}"
        case .zoomOutLight: return "\u{fd78}"
        case .zoomOutRegular: return "\u{fd79}"
