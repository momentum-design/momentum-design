...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .signInBold: return "\u{fa69}"
        case .signInFilled: return "\u{fa6a}"
        case .signInForcedBold: return "\u{fa6b}"
        case .signInForcedLight: return "\u{fa6c}"
        case .signInForcedRegular: return "\u{fa6d}"
        case .signInLight: return "\u{fa6e}"
        case .signInRegular: return "\u{fa6f}"
        case .signLangIntBold: return "\u{fa70}"
        case .signLangIntLight: return "\u{fa71}"
        case .signLangIntRegular: return "\u{fa72}"
        case .signOutBold: return "\u{fa73}"
        case .signOutLight: return "\u{fa74}"
        case .signOutRegular: return "\u{fa75}"
        case .signalFourBold: return "\u{fa76}"
        case .signalFourLight: return "\u{fa77}"
        case .signalFourRegular: return "\u{fa78}"
        case .signalOneBold: return "\u{fa79}"
        case .signalOneLight: return "\u{fa7a}"
        case .signalOneRegular: return "\u{fa7b}"
        case .signalThreeBold: return "\u{fa7c}"
        case .signalThreeLight: return "\u{fa7d}"
        case .signalThreeRegular: return "\u{fa7e}"
        case .signalTwoBold: return "\u{fa7f}"
        case .signalTwoLight: return "\u{fa80}"
        case .signalTwoRegular: return "\u{fa81}"
        case .signalZeroBold: return "\u{fa82}"
        case .signalZeroLight: return "\u{fa83}"
        case .signalZeroRegular: return "\u{fa84}"
        case .simplePromotionBold: return "\u{fa85}"
        case .simplePromotionLight: return "\u{fa86}"
        case .simplePromotionRegular: return "\u{fa87}"
        case .singleNumberReachBold: return "\u{fa88}"
        case .singleNumberReachLight: return "\u{fa89}"
        case .singleNumberReachRegular: return "\u{fa8a}"
        case .sipRegistrationInProgressBold: return "\u{fa8b}"
        case .sipRegistrationInProgressFilled: return "\u{fa8c}"
        case .sipRegistrationInProgressLight: return "\u{fa8d}"
        case .sipRegistrationInProgressRegular: return "\u{fa8e}"
        case .skipBold: return "\u{fa8f}"
        case .skipBwBold: return "\u{fa90}"
        case .skipBwFilled: return "\u{fa91}"
        case .skipBwLight: return "\u{fa92}"
        case .skipBwRegular: return "\u{fa93}"
        case .skipFwBold: return "\u{fa94}"
        case .skipFwFilled: return "\u{fa95}"
        case .skipFwLight: return "\u{fa96}"
        case .skipFwRegular: return "\u{fa97}"
        case .skipLight: return "\u{fa98}"
        case .skipRegular: return "\u{fa99}"
        case .smartAudioBold: return "\u{fa9a}"
        case .smartAudioLight: return "\u{fa9b}"
        case .smartAudioRegular: return "\u{fa9c}"
        case .smsFilled: return "\u{fa9d}"
        case .smsInboundBold: return "\u{fa9e}"
        case .smsInboundLight: return "\u{fa9f}"
        case .smsInboundRegular: return "\u{faa0}"
        case .smsMessageBold: return "\u{faa1}"
        case .smsMessageFilled: return "\u{faa2}"
        case .smsMessageLight: return "\u{faa3}"
        case .smsMessageRegular: return "\u{faa4}"
        case .smsOutgoingFilled: return "\u{faa5}"
        case .smsUnreadBold: return "\u{faa6}"
        case .smsUnreadLight: return "\u{faa7}"
        case .smsUnreadRegular: return "\u{faa8}"
        case .sortAscendingBold: return "\u{faa9}"
        case .sortAscendingLight: return "\u{faaa}"
        case .sortAscendingRegular: return "\u{faab}"
        case .sortDescendingBold: return "\u{faac}"
        case .sortDescendingLight: return "\u{faad}"
        case .sortDescendingRegular: return "\u{faae}"
        case .soundDefaultBold: return "\u{faaf}"
        case .soundDefaultLight: return "\u{fab0}"
        case .soundDefaultRegular: return "\u{fab1}"
        case .sparkleBold: return "\u{fab2}"
        case .sparkleFilled: return "\u{fab3}"
        case .sparkleLight: return "\u{fab4}"
        case .sparkleRegular: return "\u{fab5}"
        case .speakerBold: return "\u{fab6}"
        case .speakerDisconnectedBold: return "\u{fab7}"
        case .speakerDisconnectedFilled: return "\u{fab8}"
        case .speakerDisconnectedLight: return "\u{fab9}"
        case .speakerDisconnectedRegular: return "\u{faba}"
        case .speakerFilled: return "\u{fabb}"
        case .speakerLight: return "\u{fabc}"
        case .speakerMutedBold: return "\u{fabd}"
        case .speakerMutedFilled: return "\u{fabe}"
        case .speakerMutedLight: return "\u{fabf}"
        case .speakerMutedRegular: return "\u{fac0}"
        case .speakerOffBold: return "\u{fac1}"
        case .speakerOffFilled: return "\u{fac2}"
        case .speakerOffLight: return "\u{fac3}"
        case .speakerOffRegular: return "\u{fac4}"
        case .speakerOnBold: return "\u{fac5}"
        case .speakerOnLight: return "\u{fac6}"
        case .speakerOnRegular: return "\u{fac7}"
        case .speakerRegular: return "\u{fac8}"
        case .speakerTurnDownBold: return "\u{fac9}"
        case .speakerTurnDownFilled: return "\u{faca}"
        case .speakerTurnDownLight: return "\u{facb}"
        case .speakerTurnDownRegular: return "\u{facc}"
        case .speakerTurnUpBold: return "\u{facd}"
        case .speakerTurnUpFilled: return "\u{face}"
        case .speakerTurnUpLight: return "\u{facf}"
        case .speakerTurnUpRegular: return "\u{fad0}"
        case .speedDialBold: return "\u{fad1}"
        case .speedDialFilled: return "\u{fad2}"
        case .speedDialLight: return "\u{fad3}"
        case .speedDialRegular: return "\u{fad4}"
        case .spellCheckerBold: return "\u{fad5}"
        case .spellCheckerLight: return "\u{fad6}"
        case .spellCheckerRegular: return "\u{fad7}"
        case .splitViewBold: return "\u{fad8}"
        case .splitViewLight: return "\u{fad9}"
        case .splitViewRegular: return "\u{fada}"
        case .stackedAreaChartBold: return "\u{fadb}"
        case .stackedAreaChartFilled: return "\u{fadc}"
        case .stackedAreaChartFullBold: return "\u{fadd}"
        case .stackedAreaChartFullFilled: return "\u{fade}"
        case .stackedAreaChartFullLight: return "\u{fadf}"
        case .stackedAreaChartFullRegular: return "\u{fae0}"
        case .stackedAreaChartLight: return "\u{fae1}"
        case .stackedAreaChartRegular: return "\u{fae2}"
        case .stackedBarChartBold: return "\u{fae3}"
        case .stackedBarChartFilled: return "\u{fae4}"
        case .stackedBarChartFullBold: return "\u{fae5}"
        case .stackedBarChartFullFilled: return "\u{fae6}"
        case .stackedBarChartFullLight: return "\u{fae7}"
        case .stackedBarChartFullRegular: return "\u{fae8}"
        case .stackedBarChartLight: return "\u{fae9}"
        case .stackedBarChartRegular: return "\u{faea}"
        case .startChatBold: return "\u{faeb}"
        case .startChatLight: return "\u{faec}"
        case .startChatRegular: return "\u{faed}"
        case .stethoscopeBold: return "\u{faee}"
        case .stethoscopeLight: return "\u{faef}"
        case .stethoscopeRegular: return "\u{faf0}"
        case .stickersBold: return "\u{faf1}"
        case .stickersLight: return "\u{faf2}"
        case .stickersRegular: return "\u{faf3}"
        case .stickiesBold: return "\u{faf4}"
        case .stickiesLight: return "\u{faf5}"
        case .stickiesRegular: return "\u{faf6}"
        case .stopBold: return "\u{faf7}"
        case .stopCircleBold: return "\u{faf8}"
        case .stopCircleFilled: return "\u{faf9}"
        case .stopCircleLight: return "\u{fafa}"
        case .stopCircleRegular: return "\u{fafb}"
        case .stopContentShareBold: return "\u{fafc}"
        case .stopContentShareLight: return "\u{fafd}"
        case .stopContentShareRegular: return "\u{fafe}"
        case .stopFilled: return "\u{faff}"
        case .stopLight: return "\u{fb00}"
        case .stopRegular: return "\u{fb01}"
        case .storedInfoBold: return "\u{fb02}"
        case .storedInfoFilled: return "\u{fb03}"
        case .storedInfoLight: return "\u{fb04}"
        case .storedInfoRegular: return "\u{fb05}"
        case .streamingBold: return "\u{fb06}"
        case .streamingLight: return "\u{fb07}"
        case .streamingRegular: return "\u{fb08}"
        case .strikethroughBold: return "\u{fb09}"
        case .strikethroughFilled: return "\u{fb0a}"
        case .strikethroughLight: return "\u{fb0b}"
        case .strikethroughRegular: return "\u{fb0c}"
        case .studioModeBold: return "\u{fb0d}"
        case .studioModeLight: return "\u{fb0e}"
        case .studioModeRegular: return "\u{fb0f}"
        case .subscriptBold: return "\u{fb10}"
        case .subscriptLight: return "\u{fb11}"
        case .subscriptRegular: return "\u{fb12}"
        case .summarizeAiBold: return "\u{fb13}"
        case .summarizeAiLight: return "\u{fb14}"
        case .summarizeAiRegular: return "\u{fb15}"
        case .superscriptBold: return "\u{fb16}"
        case .superscriptLight: return "\u{fb17}"
        case .superscriptRegular: return "\u{fb18}"
        case .surveyBold: return "\u{fb19}"
        case .surveyFilled: return "\u{fb1a}"
        case .surveyLight: return "\u{fb1b}"
        case .surveyRegular: return "\u{fb1c}"
        case .sxEightyCodecBold: return "\u{fb1d}"
        case .sxEightyCodecLight: return "\u{fb1e}"
        case .sxEightyCodecRegular: return "\u{fb1f}"
        case .sxTenBold: return "\u{fb20}"
        case .sxTenLight: return "\u{fb21}"
        case .sxTenRegular: return "\u{fb22}"
        case .sxTwentyBold: return "\u{fb23}"
        case .sxTwentyLight: return "\u{fb24}"
        case .sxTwentyRegular: return "\u{fb25}"
        case .tableBold: return "\u{fb26}"
        case .tableLight: return "\u{fb27}"
        case .tableRegular: return "\u{fb28}"
        case .tabletBold: return "\u{fb29}"
        case .tabletLight: return "\u{fb2a}"
        case .tabletRegular: return "\u{fb2b}"
        case .tabsBold: return "\u{fb2c}"
        case .tabsLight: return "\u{fb2d}"
        case .tabsRegular: return "\u{fb2e}"
        case .tagBold: return "\u{fb2f}"
        case .tagLight: return "\u{fb30}"
        case .tagRegular: return "\u{fb31}"
        case .tapBold: return "\u{fb32}"
        case .tapFilled: return "\u{fb33}"
        case .tapLight: return "\u{fb34}"
        case .tapRegular: return "\u{fb35}"
        case .telepresenceAlertBold: return "\u{fb36}"
        case .telepresenceAlertLight: return "\u{fb37}"
        case .telepresenceAlertMutedBold: return "\u{fb38}"
        case .telepresenceAlertMutedLight: return "\u{fb39}"
        case .telepresenceAlertMutedRegular: return "\u{fb3a}"
        case .telepresenceAlertRegular: return "\u{fb3b}"
        case .telepresenceBold: return "\u{fb3c}"
        case .telepresenceIxFiveThousandBold: return "\u{fb3d}"
        case .telepresenceIxFiveThousandLight: return "\u{fb3e}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb3f}"
        case .telepresenceLight: return "\u{fb40}"
        case .telepresenceMutedBold: return "\u{fb41}"
        case .telepresenceMutedLight: return "\u{fb42}"
        case .telepresenceMutedRegular: return "\u{fb43}"
        case .telepresencePrivateBold: return "\u{fb44}"
        case .telepresencePrivateLight: return "\u{fb45}"
        case .telepresencePrivateRegular: return "\u{fb46}"
        case .telepresenceRegular: return "\u{fb47}"
        case .temperatureBold: return "\u{fb48}"
        case .temperatureLight: return "\u{fb49}"
        case .temperatureRegular: return "\u{fb4a}"
        case .testTubeBold: return "\u{fb4b}"
        case .testTubeFilled: return "\u{fb4c}"
        case .testTubeLight: return "\u{fb4d}"
        case .testTubeRegular: return "\u{fb4e}"
        case .textAlignCenterBold: return "\u{fb4f}"
        case .textAlignCenterFilled: return "\u{fb50}"
        case .textAlignCenterLight: return "\u{fb51}"
        case .textAlignCenterRegular: return "\u{fb52}"
        case .textAlignLeftBold: return "\u{fb53}"
        case .textAlignLeftFilled: return "\u{fb54}"
        case .textAlignLeftLight: return "\u{fb55}"
        case .textAlignLeftRegular: return "\u{fb56}"
        case .textAlignRightBold: return "\u{fb57}"
        case .textAlignRightFilled: return "\u{fb58}"
        case .textAlignRightLight: return "\u{fb59}"
        case .textAlignRightRegular: return "\u{fb5a}"
        case .textBold: return "\u{fb5b}"
        case .textBoxCursorLight: return "\u{fb5c}"
        case .textCodeBlockBold: return "\u{fb5d}"
        case .textCodeBlockLight: return "\u{fb5e}"
        case .textCodeBlockRegular: return "\u{fb5f}"
        case .textHighlightBold: return "\u{fb60}"
        case .textHighlightFilled: return "\u{fb61}"
        case .textHighlightLight: return "\u{fb62}"
        case .textHighlightRegular: return "\u{fb63}"
        case .textLight: return "\u{fb64}"
        case .textRegular: return "\u{fb65}"
        case .threeColumnBold: return "\u{fb66}"
        case .threeColumnLight: return "\u{fb67}"
        case .threeColumnRegular: return "\u{fb68}"
        case .threeDObjectBold: return "\u{fb69}"
        case .threeDObjectLight: return "\u{fb6a}"
        case .threeDObjectRegular: return "\u{fb6b}"
        case .timeExclusionBold: return "\u{fb6c}"
        case .timeExclusionLight: return "\u{fb6d}"
        case .timeExclusionRegular: return "\u{fb6e}"
        case .tooFastBold: return "\u{fb6f}"
        case .tooFastLight: return "\u{fb70}"
        case .tooFastRegular: return "\u{fb71}"
        case .tooSlowBold: return "\u{fb72}"
        case .tooSlowLight: return "\u{fb73}"
        case .tooSlowRegular: return "\u{fb74}"
        case .toolsBold: return "\u{fb75}"
        case .toolsFilled: return "\u{fb76}"
        case .toolsLight: return "\u{fb77}"
        case .toolsRegular: return "\u{fb78}"
        case .touchTenBold: return "\u{fb79}"
        case .touchTenLight: return "\u{fb7a}"
        case .touchTenRegular: return "\u{fb7b}"
        case .transcriptBold: return "\u{fb7c}"
        case .transcriptFilled: return "\u{fb7d}"
        case .transcriptLight: return "\u{fb7e}"
        case .transcriptRegular: return "\u{fb7f}"
        case .translateBold: return "\u{fb80}"
        case .translateLight: return "\u{fb81}"
        case .translateRegular: return "\u{fb82}"
        case .translateUndoBold: return "\u{fb83}"
        case .translateUndoLight: return "\u{fb84}"
        case .translateUndoRegular: return "\u{fb85}"
        case .trendingBold: return "\u{fb86}"
        case .trendingDownBold: return "\u{fb87}"
        case .trendingDownFilled: return "\u{fb88}"
        case .trendingDownLight: return "\u{fb89}"
        case .trendingDownRegular: return "\u{fb8a}"
        case .trendingFilled: return "\u{fb8b}"
        case .trendingLight: return "\u{fb8c}"
        case .trendingRegular: return "\u{fb8d}"
        case .trimBold: return "\u{fb8e}"
        case .trimLight: return "\u{fb8f}"
        case .trimRegular: return "\u{fb90}"
        case .twoColumnBold: return "\u{fb91}"
        case .twoColumnLight: return "\u{fb92}"
        case .twoColumnRegular: return "\u{fb93}"
        case .twoWayVoiceStreamBold: return "\u{fb94}"
        case .twoWayVoiceStreamFilled: return "\u{fb95}"
        case .twoWayVoiceStreamLight: return "\u{fb96}"
        case .twoWayVoiceStreamRegular: return "\u{fb97}"
        case .ucmCloudBold: return "\u{fb98}"
        case .ucmCloudLight: return "\u{fb99}"
        case .ucmCloudRegular: return "\u{fb9a}"
        case .unblockBold: return "\u{fb9b}"
        case .unblockFilled: return "\u{fb9c}"
        case .unblockLight: return "\u{fb9d}"
        case .unblockRegular: return "\u{fb9e}"
        case .underlineBold: return "\u{fb9f}"
        case .underlineFilled: return "\u{fba0}"
        case .underlineLight: return "\u{fba1}"
        case .underlineRegular: return "\u{fba2}"
        case .undoBold: return "\u{fba3}"
        case .undoLight: return "\u{fba4}"
        case .undoRegular: return "\u{fba5}"
        case .unlinkBold: return "\u{fba6}"
        case .unlinkLight: return "\u{fba7}"
        case .unlinkRegular: return "\u{fba8}"
        case .unreadBold: return "\u{fba9}"
        case .unreadFilled: return "\u{fbaa}"
        case .unreadLight: return "\u{fbab}"
        case .unreadRegular: return "\u{fbac}"
        case .unsecureUnlockedBold: return "\u{fbad}"
        case .unsecureUnlockedFilled: return "\u{fbae}"
        case .unsecureUnlockedLight: return "\u{fbaf}"
        case .unsecureUnlockedRegular: return "\u{fbb0}"
        case .unsortedBold: return "\u{fbb1}"
        case .unsortedLight: return "\u{fbb2}"
        case .unsortedRegular: return "\u{fbb3}"
        case .updateFileShareBold: return "\u{fbb4}"
        case .updateFileShareLight: return "\u{fbb5}"
        case .updateFileShareRegular: return "\u{fbb6}"
        case .uploadBold: return "\u{fbb7}"
        case .uploadImageBold: return "\u{fbb8}"
        case .uploadImageLight: return "\u{fbb9}"
        case .uploadImageRegular: return "\u{fbba}"
        case .uploadLight: return "\u{fbbb}"
        case .uploadRegular: return "\u{fbbc}"
        case .urgentVoicemailBold: return "\u{fbbd}"
        case .urgentVoicemailFilled: return "\u{fbbe}"
        case .usbBold: return "\u{fbbf}"
        case .usbHeadsetBold: return "\u{fbc0}"
        case .usbHeadsetLight: return "\u{fbc1}"
        case .usbHeadsetMutedBold: return "\u{fbc2}"
        case .usbHeadsetMutedLight: return "\u{fbc3}"
        case .usbHeadsetMutedRegular: return "\u{fbc4}"
        case .usbHeadsetRegular: return "\u{fbc5}"
        case .usbLight: return "\u{fbc6}"
        case .usbRegular: return "\u{fbc7}"
        case .userBold: return "\u{fbc8}"
        case .userDeactivateBold: return "\u{fbc9}"
        case .userDeactivateLight: return "\u{fbca}"
        case .userDeactivateRegular: return "\u{fbcb}"
        case .userLight: return "\u{fbcc}"
        case .userRegular: return "\u{fbcd}"
        case .videoBlurBold: return "\u{fbce}"
        case .videoBlurFilled: return "\u{fbcf}"
        case .videoBlurLight: return "\u{fbd0}"
        case .videoBlurRegular: return "\u{fbd1}"
        case .videoBold: return "\u{fbd2}"
        case .videoEffectBold: return "\u{fbd3}"
        case .videoEffectFilled: return "\u{fbd4}"
        case .videoEffectLight: return "\u{fbd5}"
        case .videoEffectRegular: return "\u{fbd6}"
        case .videoFilled: return "\u{fbd7}"
        case .videoLayoutBold: return "\u{fbd8}"
        case .videoLayoutEqualBold: return "\u{fbd9}"
        case .videoLayoutEqualDualBold: return "\u{fbda}"
        case .videoLayoutEqualDualLight: return "\u{fbdb}"
        case .videoLayoutEqualDualRegular: return "\u{fbdc}"
        case .videoLayoutEqualFilled: return "\u{fbdd}"
        case .videoLayoutEqualLight: return "\u{fbde}"
        case .videoLayoutEqualRegular: return "\u{fbdf}"
        case .videoLayoutFilled: return "\u{fbe0}"
        case .videoLayoutLight: return "\u{fbe1}"
        case .videoLayoutOverlayBold: return "\u{fbe2}"
        case .videoLayoutOverlayFilled: return "\u{fbe3}"
        case .videoLayoutOverlayLight: return "\u{fbe4}"
        case .videoLayoutOverlayRegular: return "\u{fbe5}"
        case .videoLayoutPresenterDominantBold: return "\u{fbe6}"
        case .videoLayoutPresenterDominantLight: return "\u{fbe7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fbe8}"
        case .videoLayoutProminentBold: return "\u{fbe9}"
        case .videoLayoutProminentFilled: return "\u{fbea}"
        case .videoLayoutProminentLight: return "\u{fbeb}"
        case .videoLayoutProminentRegular: return "\u{fbec}"
        case .videoLayoutRegular: return "\u{fbed}"
        case .videoLayoutShareDominantBold: return "\u{fbee}"
        case .videoLayoutShareDominantLight: return "\u{fbef}"
        case .videoLayoutShareDominantRegular: return "\u{fbf0}"
        case .videoLayoutSingleBold: return "\u{fbf1}"
        case .videoLayoutSingleFilled: return "\u{fbf2}"
        case .videoLayoutSingleLight: return "\u{fbf3}"
        case .videoLayoutSingleRegular: return "\u{fbf4}"
        case .videoLayoutStackBold: return "\u{fbf5}"
        case .videoLayoutStackFilled: return "\u{fbf6}"
        case .videoLayoutStackLight: return "\u{fbf7}"
        case .videoLayoutStackRegular: return "\u{fbf8}"
        case .videoLayoutVideoDominantBold: return "\u{fbf9}"
        case .videoLayoutVideoDominantFilled: return "\u{fbfa}"
        case .videoLayoutVideoDominantLight: return "\u{fbfb}"
        case .videoLayoutVideoDominantRegular: return "\u{fbfc}"
        case .videoLight: return "\u{fbfd}"
        case .videoPlusBold: return "\u{fbfe}"
        case .videoPlusFilled: return "\u{fbff}"
        case .videoPlusLight: return "\u{fc00}"
        case .videoPlusRegular: return "\u{fc01}"
        case .videoRegular: return "\u{fc02}"
        case .videoSpeakerTrackBold: return "\u{fc03}"
        case .videoSpeakerTrackFilled: return "\u{fc04}"
        case .videoSpeakerTrackLight: return "\u{fc05}"
        case .videoSpeakerTrackRegular: return "\u{fc06}"
        case .viewAllBold: return "\u{fc07}"
        case .viewAllLight: return "\u{fc08}"
        case .viewAllRegular: return "\u{fc09}"
        case .viewListBold: return "\u{fc0a}"
        case .viewListFilled: return "\u{fc0b}"
        case .viewListLight: return "\u{fc0c}"
        case .viewListRegular: return "\u{fc0d}"
        case .viewStackedBold: return "\u{fc0e}"
        case .viewStackedFilled: return "\u{fc0f}"
        case .viewStackedLight: return "\u{fc10}"
        case .viewStackedRegular: return "\u{fc11}"
        case .viewThumbnailBold: return "\u{fc12}"
        case .viewThumbnailFilled: return "\u{fc13}"
        case .viewThumbnailLight: return "\u{fc14}"
        case .viewThumbnailRegular: return "\u{fc15}"
        case .visionproBold: return "\u{fc16}"
        case .visionproFilled: return "\u{fc17}"
        case .visionproLight: return "\u{fc18}"
        case .visionproMoveCallInBold: return "\u{fc19}"
        case .visionproMoveCallInFilled: return "\u{fc1a}"
        case .visionproMoveCallInLight: return "\u{fc1b}"
        case .visionproMoveCallInOutBold: return "\u{fc1c}"
        case .visionproMoveCallInOutFilled: return "\u{fc1d}"
        case .visionproMoveCallInOutLight: return "\u{fc1e}"
        case .visionproMoveCallInOutRegular: return "\u{fc1f}"
        case .visionproMoveCallInRegular: return "\u{fc20}"
        case .visionproMoveCallOutBold: return "\u{fc21}"
        case .visionproMoveCallOutFilled: return "\u{fc22}"
        case .visionproMoveCallOutLight: return "\u{fc23}"
        case .visionproMoveCallOutRegular: return "\u{fc24}"
        case .visionproRegular: return "\u{fc25}"
        case .voicemailBold: return "\u{fc26}"
        case .voicemailFilled: return "\u{fc27}"
        case .voicemailLight: return "\u{fc28}"
        case .voicemailRegular: return "\u{fc29}"
        case .vpnBold: return "\u{fc2a}"
        case .vpnFilled: return "\u{fc2b}"
        case .vpnLight: return "\u{fc2c}"
        case .vpnRegular: return "\u{fc2d}"
        case .vscBold: return "\u{fc2e}"
        case .vscLight: return "\u{fc2f}"
        case .vscRegular: return "\u{fc30}"
        case .waffleMenuBold: return "\u{fc31}"
        case .waffleMenuLight: return "\u{fc32}"
        case .waffleMenuRegular: return "\u{fc33}"
        case .waitingRoomBold: return "\u{fc34}"
        case .waitingRoomLight: return "\u{fc35}"
        case .waitingRoomRegular: return "\u{fc36}"
        case .wallpaperBold: return "\u{fc37}"
        case .wallpaperLight: return "\u{fc38}"
        case .wallpaperRegular: return "\u{fc39}"
        case .warningBadgeFilled: return "\u{fc3a}"
        case .warningBold: return "\u{fc3b}"
        case .warningFilled: return "\u{fc3c}"
        case .warningLight: return "\u{fc3d}"
        case .warningRegular: return "\u{fc3e}"
        case .webexBoardBold: return "\u{fc3f}"
        case .webexBoardLight: return "\u{fc40}"
        case .webexBoardRegular: return "\u{fc41}"
        case .webexCodecPlusBold: return "\u{fc42}"
        case .webexCodecPlusLight: return "\u{fc43}"
        case .webexCodecPlusRegular: return "\u{fc44}"
        case .webexDeskCameraBold: return "\u{fc45}"
        case .webexDeskCameraLight: return "\u{fc46}"
        case .webexDeskCameraRegular: return "\u{fc47}"
        case .webexHelixBold: return "\u{fc48}"
        case .webexHelixLight: return "\u{fc49}"
        case .webexHelixRegular: return "\u{fc4a}"
        case .webexMeetingsBold: return "\u{fc4b}"
        case .webexMeetingsFilled: return "\u{fc4c}"
        case .webexMeetingsLight: return "\u{fc4d}"
        case .webexMeetingsRegular: return "\u{fc4e}"
        case .webexQuadCameraBold: return "\u{fc4f}"
        case .webexQuadCameraLight: return "\u{fc50}"
        case .webexQuadCameraRegular: return "\u{fc51}"
        case .webexRoomKitBold: return "\u{fc52}"
        case .webexRoomKitLight: return "\u{fc53}"
        case .webexRoomKitPlusBold: return "\u{fc54}"
        case .webexRoomKitPlusLight: return "\u{fc55}"
        case .webexRoomKitPlusRegular: return "\u{fc56}"
        case .webexRoomKitRegular: return "\u{fc57}"
        case .webexShareBold: return "\u{fc58}"
        case .webexShareLight: return "\u{fc59}"
        case .webexShareRegular: return "\u{fc5a}"
        case .webexTeamsBold: return "\u{fc5b}"
        case .webexTeamsFilled: return "\u{fc5c}"
        case .webexTeamsLight: return "\u{fc5d}"
        case .webexTeamsNewBold: return "\u{fc5e}"
        case .webexTeamsNewFilled: return "\u{fc5f}"
        case .webexTeamsNewLight: return "\u{fc60}"
        case .webexTeamsNewRegular: return "\u{fc61}"
        case .webexTeamsRegular: return "\u{fc62}"
        case .webexTeamsRemoveBold: return "\u{fc63}"
        case .webexTeamsRemoveLight: return "\u{fc64}"
        case .webexTeamsRemoveRegular: return "\u{fc65}"
        case .webhookBold: return "\u{fc66}"
        case .webhookLight: return "\u{fc67}"
        case .webhookRegular: return "\u{fc68}"
        case .webinarBold: return "\u{fc69}"
        case .webinarFilled: return "\u{fc6a}"
        case .webinarLight: return "\u{fc6b}"
        case .webinarRegular: return "\u{fc6c}"
        case .weeklyRecurringScheduleBold: return "\u{fc6d}"
        case .weeklyRecurringScheduleLight: return "\u{fc6e}"
        case .weeklyRecurringScheduleRegular: return "\u{fc6f}"
        case .whisperAnnouncementBold: return "\u{fc70}"
        case .whisperAnnouncementFilled: return "\u{fc71}"
        case .whisperAnnouncementLight: return "\u{fc72}"
        case .whisperAnnouncementRegular: return "\u{fc73}"
        case .whisperCoachBold: return "\u{fc74}"
        case .whisperCoachFilled: return "\u{fc75}"
        case .whisperCoachLight: return "\u{fc76}"
        case .whisperCoachRegular: return "\u{fc77}"
        case .whiteboardBold: return "\u{fc78}"
        case .whiteboardContentBold: return "\u{fc79}"
        case .whiteboardContentFilled: return "\u{fc7a}"
        case .whiteboardContentLight: return "\u{fc7b}"
        case .whiteboardContentRegular: return "\u{fc7c}"
        case .whiteboardFilled: return "\u{fc7d}"
        case .whiteboardLight: return "\u{fc7e}"
        case .whiteboardRegular: return "\u{fc7f}"
        case .widgetBold: return "\u{fc80}"
        case .widgetFilled: return "\u{fc81}"
        case .widgetLight: return "\u{fc82}"
        case .widgetRegular: return "\u{fc83}"
        case .wifiBold: return "\u{fc84}"
        case .wifiErrorBold: return "\u{fc85}"
        case .wifiErrorLight: return "\u{fc86}"
        case .wifiErrorRegular: return "\u{fc87}"
        case .wifiLight: return "\u{fc88}"
        case .wifiRegular: return "\u{fc89}"
        case .wifiSignalGoodBold: return "\u{fc8a}"
        case .wifiSignalGoodLight: return "\u{fc8b}"
        case .wifiSignalGoodRegular: return "\u{fc8c}"
        case .wifiSignalPoorBold: return "\u{fc8d}"
        case .wifiSignalPoorLight: return "\u{fc8e}"
        case .wifiSignalPoorRegular: return "\u{fc8f}"
        case .wifiSignalUnstableBold: return "\u{fc90}"
        case .wifiSignalUnstableLight: return "\u{fc91}"
        case .wifiSignalUnstableRegular: return "\u{fc92}"
        case .windowCornerScrubBold: return "\u{fc93}"
        case .windowCornerScrubLight: return "\u{fc94}"
        case .windowCornerScrubRegular: return "\u{fc95}"
        case .windowRightCornerScrubBold: return "\u{fc96}"
        case .windowRightCornerScrubLight: return "\u{fc97}"
        case .windowRightCornerScrubRegular: return "\u{fc98}"
        case .windowVerticalScrubBold: return "\u{fc99}"
        case .windowVerticalScrubLight: return "\u{fc9a}"
        case .windowVerticalScrubRegular: return "\u{fc9b}"
        case .workflowDeploymentsBold: return "\u{fc9c}"
        case .workflowDeploymentsFilled: return "\u{fc9d}"
        case .workflowDeploymentsLight: return "\u{fc9e}"
        case .workflowDeploymentsRegular: return "\u{fc9f}"
        case .workphoneBold: return "\u{fca0}"
        case .workphoneLight: return "\u{fca1}"
        case .workphoneRegular: return "\u{fca2}"
        case .zoomInBold: return "\u{fca3}"
        case .zoomInLight: return "\u{fca4}"
        case .zoomInRegular: return "\u{fca5}"
        case .zoomOutBold: return "\u{fca6}"
        case .zoomOutLight: return "\u{fca7}"
        case .zoomOutRegular: return "\u{fca8}"
