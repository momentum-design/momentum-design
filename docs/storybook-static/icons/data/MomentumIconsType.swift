...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .customTaskIndBold: return "\u{f3dc}"
        case .customTaskIndFilled: return "\u{f3dd}"
        case .customTaskIndLight: return "\u{f3de}"
        case .customTaskIndRegular: return "\u{f3df}"
        case .customTaskLight: return "\u{f3e0}"
        case .customTaskRegular: return "\u{f3e1}"
        case .dailyRecurringScheduleBold: return "\u{f3e2}"
        case .dailyRecurringScheduleLight: return "\u{f3e3}"
        case .dailyRecurringScheduleRegular: return "\u{f3e4}"
        case .dashboardBold: return "\u{f3e5}"
        case .dashboardFilled: return "\u{f3e6}"
        case .dashboardLight: return "\u{f3e7}"
        case .dashboardRegular: return "\u{f3e8}"
        case .dataManagementBold: return "\u{f3e9}"
        case .dataManagementFilled: return "\u{f3ea}"
        case .dataManagementLight: return "\u{f3eb}"
        case .dataManagementRegular: return "\u{f3ec}"
        case .dataRangeSelectionBold: return "\u{f3ed}"
        case .dataRangeSelectionFilled: return "\u{f3ee}"
        case .dataRangeSelectionLight: return "\u{f3ef}"
        case .dataRangeSelectionRegular: return "\u{f3f0}"
        case .declineBold: return "\u{f3f1}"
        case .declineFilled: return "\u{f3f2}"
        case .declineLight: return "\u{f3f3}"
        case .declineRegular: return "\u{f3f4}"
        case .dectHandsetBold: return "\u{f3f5}"
        case .dectHandsetFilled: return "\u{f3f6}"
        case .dectHandsetLight: return "\u{f3f7}"
        case .dectHandsetRegular: return "\u{f3f8}"
        case .deleteBold: return "\u{f3f9}"
        case .deleteFilled: return "\u{f3fa}"
        case .deleteLight: return "\u{f3fb}"
        case .deleteRegular: return "\u{f3fc}"
        case .deploymentEvaluationProgressBold: return "\u{f3fd}"
        case .deploymentEvaluationProgressLight: return "\u{f3fe}"
        case .deploymentEvaluationProgressRegular: return "\u{f3ff}"
        case .deploymentProgressBold: return "\u{f400}"
        case .deploymentProgressLight: return "\u{f401}"
        case .deploymentProgressRegular: return "\u{f402}"
        case .deploymentRecurringBold: return "\u{f403}"
        case .deploymentRecurringLight: return "\u{f404}"
        case .deploymentRecurringRegular: return "\u{f405}"
        case .deploymentWinnerPendingBold: return "\u{f406}"
        case .deploymentWinnerPendingLight: return "\u{f407}"
        case .deploymentWinnerPendingRegular: return "\u{f408}"
        case .deskPhoneBold: return "\u{f409}"
        case .deskPhoneFilled: return "\u{f40a}"
        case .deskPhoneLight: return "\u{f40b}"
        case .deskPhoneRegular: return "\u{f40c}"
        case .deskPhoneWarningBold: return "\u{f40d}"
        case .deskPhoneWarningLight: return "\u{f40e}"
        case .deskPhoneWarningRegular: return "\u{f40f}"
        case .deviceConnectionBold: return "\u{f410}"
        case .deviceConnectionFilled: return "\u{f411}"
        case .deviceConnectionLight: return "\u{f412}"
        case .deviceConnectionRegular: return "\u{f413}"
        case .deviceInRoomBold: return "\u{f414}"
        case .deviceInRoomEndBold: return "\u{f415}"
        case .deviceInRoomEndLight: return "\u{f416}"
        case .deviceInRoomEndRegular: return "\u{f417}"
        case .deviceInRoomFilled: return "\u{f418}"
        case .deviceInRoomLight: return "\u{f419}"
        case .deviceInRoomRegular: return "\u{f41a}"
        case .deviceMutedBold: return "\u{f41b}"
        case .deviceMutedLight: return "\u{f41c}"
        case .deviceMutedRegular: return "\u{f41d}"
        case .devicePolicyControllerBold: return "\u{f41e}"
        case .devicePolicyControllerLight: return "\u{f41f}"
        case .devicePolicyControllerRegular: return "\u{f420}"
        case .devicesBold: return "\u{f421}"
        case .devicesFilled: return "\u{f422}"
        case .devicesLight: return "\u{f423}"
        case .devicesRegular: return "\u{f424}"
        case .diagnosticsBold: return "\u{f425}"
        case .diagnosticsLight: return "\u{f426}"
        case .diagnosticsRegular: return "\u{f427}"
        case .dialpadBold: return "\u{f428}"
        case .dialpadLight: return "\u{f429}"
        case .dialpadRegular: return "\u{f42a}"
        case .diamondBold: return "\u{f42b}"
        case .diamondFilled: return "\u{f42c}"
        case .diamondLight: return "\u{f42d}"
        case .diamondRegular: return "\u{f42e}"
        case .directionalPadBold: return "\u{f42f}"
        case .directionalPadFilled: return "\u{f430}"
        case .directionalPadLight: return "\u{f431}"
        case .directionalPadRegular: return "\u{f432}"
        case .directoryBold: return "\u{f433}"
        case .directoryLight: return "\u{f434}"
        case .directoryRegular: return "\u{f435}"
        case .disappearingPenBold: return "\u{f436}"
        case .disappearingPenLight: return "\u{f437}"
        case .disappearingPenRegular: return "\u{f438}"
        case .discBold: return "\u{f439}"
        case .discConnectedBold: return "\u{f43a}"
        case .discConnectedLight: return "\u{f43b}"
        case .discConnectedRegular: return "\u{f43c}"
        case .discLight: return "\u{f43d}"
        case .discRegular: return "\u{f43e}"
        case .disconnectBold: return "\u{f43f}"
        case .disconnectFilled: return "\u{f440}"
        case .disconnectLight: return "\u{f441}"
        case .disconnectRegular: return "\u{f442}"
        case .dislikeBold: return "\u{f443}"
        case .dislikeFilled: return "\u{f444}"
        case .dislikeLight: return "\u{f445}"
        case .dislikeRegular: return "\u{f446}"
        case .displayBold: return "\u{f447}"
        case .displayInputBold: return "\u{f448}"
        case .displayInputLight: return "\u{f449}"
        case .displayInputRegular: return "\u{f44a}"
        case .displayLight: return "\u{f44b}"
        case .displayRegular: return "\u{f44c}"
        case .displayWarningBold: return "\u{f44d}"
        case .displayWarningLight: return "\u{f44e}"
        case .displayWarningRegular: return "\u{f44f}"
        case .distributeHorizontalBold: return "\u{f450}"
        case .distributeHorizontalFilled: return "\u{f451}"
        case .distributeHorizontalLight: return "\u{f452}"
        case .distributeHorizontalRegular: return "\u{f453}"
        case .distributeVerticallyBold: return "\u{f454}"
        case .distributeVerticallyFilled: return "\u{f455}"
        case .distributeVerticallyLight: return "\u{f456}"
        case .distributeVerticallyRegular: return "\u{f457}"
        case .divideBold: return "\u{f458}"
        case .divideFilled: return "\u{f459}"
        case .divideLight: return "\u{f45a}"
        case .divideRegular: return "\u{f45b}"
        case .dndPresenceBadgeFilled: return "\u{f45c}"
        case .dndPresenceBold: return "\u{f45d}"
        case .dndPresenceFilled: return "\u{f45e}"
        case .dndPresenceLight: return "\u{f45f}"
        case .dndPresenceRegular: return "\u{f460}"
        case .dockWindowBold: return "\u{f461}"
        case .dockWindowLight: return "\u{f462}"
        case .dockWindowRegular: return "\u{f463}"
        case .documentBold: return "\u{f464}"
        case .documentCameraBold: return "\u{f465}"
        case .documentCameraDisconnectedBold: return "\u{f466}"
        case .documentCameraDisconnectedLight: return "\u{f467}"
        case .documentCameraDisconnectedRegular: return "\u{f468}"
        case .documentCameraLight: return "\u{f469}"
        case .documentCameraRegular: return "\u{f46a}"
        case .documentCreateBold: return "\u{f46b}"
        case .documentCreateFilled: return "\u{f46c}"
        case .documentCreateLight: return "\u{f46d}"
        case .documentCreateRegular: return "\u{f46e}"
        case .documentFilled: return "\u{f46f}"
        case .documentLight: return "\u{f470}"
        case .documentMoveBold: return "\u{f471}"
        case .documentMoveFilled: return "\u{f472}"
        case .documentMoveLight: return "\u{f473}"
        case .documentMoveRegular: return "\u{f474}"
        case .documentRegular: return "\u{f475}"
        case .documentShareBold: return "\u{f476}"
        case .documentShareFilled: return "\u{f477}"
        case .documentShareLight: return "\u{f478}"
        case .documentShareRegular: return "\u{f479}"
        case .doneAllBold: return "\u{f47a}"
        case .doneAllLight: return "\u{f47b}"
        case .doneAllRegular: return "\u{f47c}"
        case .donutChartBold: return "\u{f47d}"
        case .donutChartFilled: return "\u{f47e}"
        case .donutChartLight: return "\u{f47f}"
        case .donutChartRegular: return "\u{f480}"
        case .downloadBold: return "\u{f481}"
        case .downloadFilled: return "\u{f482}"
        case .downloadLight: return "\u{f483}"
        case .downloadRegular: return "\u{f484}"
        case .draftBold: return "\u{f485}"
        case .draftFilled: return "\u{f486}"
        case .draftIndicatorBold: return "\u{f487}"
        case .draftIndicatorSmallFilled: return "\u{f488}"
        case .draftLight: return "\u{f489}"
        case .draftRegular: return "\u{f48a}"
        case .dragBold: return "\u{f48b}"
        case .dragLight: return "\u{f48c}"
        case .dragRegular: return "\u{f48d}"
        case .draggerHorizontalBold: return "\u{f48e}"
        case .draggerHorizontalLight: return "\u{f48f}"
        case .draggerHorizontalRegular: return "\u{f490}"
        case .draggerVerticalBold: return "\u{f491}"
        case .draggerVerticalLight: return "\u{f492}"
        case .draggerVerticalRegular: return "\u{f493}"
        case .driveModeBold: return "\u{f494}"
        case .driveModeLight: return "\u{f495}"
        case .driveModeRegular: return "\u{f496}"
        case .dropdownBold: return "\u{f497}"
        case .dropdownLight: return "\u{f498}"
        case .dropdownRegular: return "\u{f499}"
        case .dxEightyBold: return "\u{f49a}"
        case .dxEightyFilled: return "\u{f49b}"
        case .dxEightyLight: return "\u{f49c}"
        case .dxEightyRegular: return "\u{f49d}"
        case .dxSeventyBold: return "\u{f49e}"
        case .dxSeventyLight: return "\u{f49f}"
        case .dxSeventyRegular: return "\u{f4a0}"
        case .editBold: return "\u{f4a1}"
        case .editFilled: return "\u{f4a2}"
        case .editLight: return "\u{f4a3}"
        case .editRegular: return "\u{f4a4}"
        case .editablePartialBold: return "\u{f4a5}"
        case .editablePartialLight: return "\u{f4a6}"
        case .editablePartialRegular: return "\u{f4a7}"
        case .educationBold: return "\u{f4a8}"
        case .educationFilled: return "\u{f4a9}"
        case .educationLight: return "\u{f4aa}"
        case .educationRegular: return "\u{f4ab}"
        case .emailBold: return "\u{f4ac}"
        case .emailDeliveredBold: return "\u{f4ad}"
        case .emailDeliveredLight: return "\u{f4ae}"
        case .emailDeliveredRegular: return "\u{f4af}"
        case .emailFailureBold: return "\u{f4b0}"
        case .emailFailureLight: return "\u{f4b1}"
        case .emailFailureRegular: return "\u{f4b2}"
        case .emailFilled: return "\u{f4b3}"
        case .emailInviteBold: return "\u{f4b4}"
        case .emailInviteLight: return "\u{f4b5}"
        case .emailInviteRegular: return "\u{f4b6}"
        case .emailLight: return "\u{f4b7}"
        case .emailOutgoingBold: return "\u{f4b8}"
        case .emailOutgoingFilled: return "\u{f4b9}"
        case .emailOutgoingLight: return "\u{f4ba}"
        case .emailOutgoingRegular: return "\u{f4bb}"
        case .emailReadBold: return "\u{f4bc}"
        case .emailReadFilled: return "\u{f4bd}"
        case .emailReadLight: return "\u{f4be}"
        case .emailReadRegular: return "\u{f4bf}"
        case .emailRegular: return "\u{f4c0}"
        case .emojiExcitedBold: return "\u{f4c1}"
        case .emojiExcitedFilled: return "\u{f4c2}"
        case .emojiExcitedLight: return "\u{f4c3}"
        case .emojiExcitedRegular: return "\u{f4c4}"
        case .emojiHappyBold: return "\u{f4c5}"
        case .emojiHappyFilled: return "\u{f4c6}"
        case .emojiHappyLight: return "\u{f4c7}"
        case .emojiHappyRegular: return "\u{f4c8}"
        case .emojiPassiveBold: return "\u{f4c9}"
        case .emojiPassiveFilled: return "\u{f4ca}"
        case .emojiPassiveLight: return "\u{f4cb}"
        case .emojiPassiveRegular: return "\u{f4cc}"
        case .emojiSadBold: return "\u{f4cd}"
        case .emojiSadFilled: return "\u{f4ce}"
        case .emojiSadLight: return "\u{f4cf}"
        case .emojiSadRegular: return "\u{f4d0}"
        case .emojiUnhappyBold: return "\u{f4d1}"
        case .emojiUnhappyFilled: return "\u{f4d2}"
        case .emojiUnhappyLight: return "\u{f4d3}"
        case .emojiUnhappyRegular: return "\u{f4d4}"
        case .encryptionCircleFilled: return "\u{f4d5}"
        case .encryptionFilled: return "\u{f4d6}"
        case .endRemoteDesktopControlBold: return "\u{f4d7}"
        case .endRemoteDesktopControlLight: return "\u{f4d8}"
        case .endRemoteDesktopControlRegular: return "\u{f4d9}"
        case .endToEndEncryptionCircleFilled: return "\u{f4da}"
        case .endToEndEncryptionFilled: return "\u{f4db}"
        case .endpointBlockedBold: return "\u{f4dc}"
        case .endpointBlockedLight: return "\u{f4dd}"
        case .endpointBlockedRegular: return "\u{f4de}"
        case .endpointBold: return "\u{f4df}"
        case .endpointGTwoBold: return "\u{f4e0}"
        case .endpointGTwoLight: return "\u{f4e1}"
        case .endpointGTwoRegular: return "\u{f4e2}"
        case .endpointGTwoSeventyBold: return "\u{f4e3}"
        case .endpointGTwoSeventyDualBold: return "\u{f4e4}"
        case .endpointGTwoSeventyDualLight: return "\u{f4e5}"
        case .endpointGTwoSeventyDualRegular: return "\u{f4e6}"
        case .endpointGTwoSeventyLight: return "\u{f4e7}"
        case .endpointGTwoSeventyRegular: return "\u{f4e8}"
        case .endpointGTwoStandBold: return "\u{f4e9}"
        case .endpointGTwoStandLight: return "\u{f4ea}"
        case .endpointGTwoStandRegular: return "\u{f4eb}"
        case .endpointLight: return "\u{f4ec}"
        case .endpointMxEightHundredBold: return "\u{f4ed}"
        case .endpointMxEightHundredDualBold: return "\u{f4ee}"
        case .endpointMxEightHundredDualLight: return "\u{f4ef}"
        case .endpointMxEightHundredDualRegular: return "\u{f4f0}"
        case .endpointMxEightHundredLight: return "\u{f4f1}"
        case .endpointMxEightHundredRegular: return "\u{f4f2}"
        case .endpointRegular: return "\u{f4f3}"
        case .endpointStandBold: return "\u{f4f4}"
        case .endpointStandFilled: return "\u{f4f5}"
        case .endpointStandLight: return "\u{f4f6}"
        case .endpointStandRegular: return "\u{f4f7}"
        case .endpointWarningBold: return "\u{f4f8}"
        case .endpointWarningLight: return "\u{f4f9}"
        case .endpointWarningRegular: return "\u{f4fa}"
        case .enterBold: return "\u{f4fb}"
        case .enterLight: return "\u{f4fc}"
        case .enterRegular: return "\u{f4fd}"
        case .enterRoomBold: return "\u{f4fe}"
        case .enterRoomFilled: return "\u{f4ff}"
        case .enterRoomLight: return "\u{f500}"
        case .enterRoomRegular: return "\u{f501}"
        case .eraserBold: return "\u{f502}"
        case .eraserFilled: return "\u{f503}"
        case .eraserLight: return "\u{f504}"
        case .eraserRegular: return "\u{f505}"
        case .errorLegacyBadgeFilled: return "\u{f506}"
        case .errorLegacyBold: return "\u{f507}"
        case .errorLegacyFilled: return "\u{f508}"
        case .errorLegacyLight: return "\u{f509}"
        case .errorLegacyRegular: return "\u{f50a}"
        case .ethernetBold: return "\u{f50b}"
        case .ethernetFilled: return "\u{f50c}"
        case .ethernetLight: return "\u{f50d}"
        case .ethernetRegular: return "\u{f50e}"
        case .exchangeBold: return "\u{f50f}"
        case .exchangeLight: return "\u{f510}"
        case .exchangeRegular: return "\u{f511}"
        case .exclamationBold: return "\u{f512}"
        case .exclamationLight: return "\u{f513}"
        case .exclamationRegular: return "\u{f514}"
        case .excludeBold: return "\u{f515}"
        case .excludeLight: return "\u{f516}"
        case .excludeRegular: return "\u{f517}"
        case .existingTargetGroupBold: return "\u{f518}"
        case .existingTargetGroupLight: return "\u{f519}"
        case .existingTargetGroupRegular: return "\u{f51a}"
        case .exitRoomBold: return "\u{f51b}"
        case .exitRoomLight: return "\u{f51c}"
        case .exitRoomRegular: return "\u{f51d}"
        case .exploreBold: return "\u{f51e}"
        case .exploreLight: return "\u{f51f}"
        case .exploreRegular: return "\u{f520}"
        case .exportBold: return "\u{f521}"
        case .exportLight: return "\u{f522}"
        case .exportRegular: return "\u{f523}"
        case .extensionMobilityBold: return "\u{f524}"
        case .extensionMobilityLight: return "\u{f525}"
        case .extensionMobilityRegular: return "\u{f526}"
        case .externalMessageBold: return "\u{f527}"
        case .externalMessageLight: return "\u{f528}"
        case .externalMessageRegular: return "\u{f529}"
        case .externalUserBold: return "\u{f52a}"
        case .externalUserLight: return "\u{f52b}"
        case .externalUserRegular: return "\u{f52c}"
        case .familyFontBold: return "\u{f52d}"
        case .familyFontLight: return "\u{f52e}"
        case .familyFontRegular: return "\u{f52f}"
        case .fastForwardBold: return "\u{f530}"
        case .fastForwardLight: return "\u{f531}"
        case .fastForwardRegular: return "\u{f532}"
        case .favoriteBold: return "\u{f533}"
        case .favoriteFilled: return "\u{f534}"
        case .favoriteLight: return "\u{f535}"
        case .favoriteRegular: return "\u{f536}"
        case .favoritesBold: return "\u{f537}"
        case .favoritesFilled: return "\u{f538}"
        case .favoritesLight: return "\u{f539}"
        case .favoritesRegular: return "\u{f53a}"
        case .fbwBold: return "\u{f53b}"
        case .fbwFilled: return "\u{f53c}"
        case .fbwLight: return "\u{f53d}"
        case .fbwRegular: return "\u{f53e}"
        case .ffwBold: return "\u{f53f}"
        case .ffwFilled: return "\u{f540}"
        case .ffwLight: return "\u{f541}"
        case .ffwRegular: return "\u{f542}"
        case .fileAnalysisBold: return "\u{f543}"
        case .fileAnalysisFilled: return "\u{f544}"
        case .fileAnalysisLight: return "\u{f545}"
        case .fileAnalysisRegular: return "\u{f546}"
        case .fileAnnotationBold: return "\u{f547}"
        case .fileAnnotationFilled: return "\u{f548}"
        case .fileAnnotationLight: return "\u{f549}"
        case .fileAnnotationRegular: return "\u{f54a}"
        case .fileAudioBold: return "\u{f54b}"
        case .fileAudioFilled: return "\u{f54c}"
        case .fileAudioLight: return "\u{f54d}"
        case .fileAudioRegular: return "\u{f54e}"
        case .fileBugBold: return "\u{f54f}"
        case .fileBugFilled: return "\u{f550}"
        case .fileBugLight: return "\u{f551}"
        case .fileBugRegular: return "\u{f552}"
        case .fileCodeBold: return "\u{f553}"
        case .fileCodeFilled: return "\u{f554}"
        case .fileCodeLight: return "\u{f555}"
        case .fileCodeRegular: return "\u{f556}"
        case .fileDashboardBold: return "\u{f557}"
        case .fileDashboardFilled: return "\u{f558}"
        case .fileDashboardLight: return "\u{f559}"
        case .fileDashboardRegular: return "\u{f55a}"
        case .fileExcelBold: return "\u{f55b}"
        case .fileExcelFilled: return "\u{f55c}"
        case .fileExcelLight: return "\u{f55d}"
        case .fileExcelRegular: return "\u{f55e}"
        case .fileGraphBold: return "\u{f55f}"
        case .fileGraphFilled: return "\u{f560}"
        case .fileGraphLight: return "\u{f561}"
        case .fileGraphRegular: return "\u{f562}"
        case .fileImageBold: return "\u{f563}"
        case .fileImageFilled: return "\u{f564}"
        case .fileImageLight: return "\u{f565}"
        case .fileImageNoneBold: return "\u{f566}"
        case .fileImageNoneLight: return "\u{f567}"
        case .fileImageNoneRegular: return "\u{f568}"
        case .fileImageRegular: return "\u{f569}"
        case .fileJsBold: return "\u{f56a}"
        case .fileJsFilled: return "\u{f56b}"
        case .fileJsLight: return "\u{f56c}"
        case .fileJsRegular: return "\u{f56d}"
        case .fileKeynoteBold: return "\u{f56e}"
        case .fileKeynoteFilled: return "\u{f56f}"
        case .fileKeynoteLight: return "\u{f570}"
        case .fileKeynoteRegular: return "\u{f571}"
        case .fileLockedBold: return "\u{f572}"
        case .fileLockedFilled: return "\u{f573}"
        case .fileLockedLight: return "\u{f574}"
        case .fileLockedRegular: return "\u{f575}"
        case .fileMissingBold: return "\u{f576}"
        case .fileMissingFilled: return "\u{f577}"
        case .fileMissingLight: return "\u{f578}"
        case .fileMissingRegular: return "\u{f579}"
        case .fileMusicBold: return "\u{f57a}"
        case .fileMusicFilled: return "\u{f57b}"
        case .fileMusicLight: return "\u{f57c}"
        case .fileMusicRegular: return "\u{f57d}"
        case .fileOnenoteBold: return "\u{f57e}"
        case .fileOnenoteFilled: return "\u{f57f}"
        case .fileOnenoteLight: return "\u{f580}"
        case .fileOnenoteRegular: return "\u{f581}"
        case .filePdfBold: return "\u{f582}"
        case .filePdfFilled: return "\u{f583}"
        case .filePdfLight: return "\u{f584}"
        case .filePdfRegular: return "\u{f585}"
        case .filePowerpointBold: return "\u{f586}"
        case .filePowerpointFilled: return "\u{f587}"
        case .filePowerpointLight: return "\u{f588}"
        case .filePowerpointRegular: return "\u{f589}"
        case .fileSpreadsheetBold: return "\u{f58a}"
        case .fileSpreadsheetFilled: return "\u{f58b}"
        case .fileSpreadsheetLight: return "\u{f58c}"
        case .fileSpreadsheetRegular: return "\u{f58d}"
        case .fileTextBold: return "\u{f58e}"
        case .fileTextFilled: return "\u{f58f}"
        case .fileTextLight: return "\u{f590}"
        case .fileTextRegular: return "\u{f591}"
        case .fileThreeDBold: return "\u{f592}"
        case .fileThreeDFilled: return "\u{f593}"
        case .fileThreeDLight: return "\u{f594}"
        case .fileThreeDRegular: return "\u{f595}"
        case .fileVectorBold: return "\u{f596}"
        case .fileVectorFilled: return "\u{f597}"
        case .fileVectorLight: return "\u{f598}"
        case .fileVectorRegular: return "\u{f599}"
        case .fileVideoBold: return "\u{f59a}"
        case .fileVideoFilled: return "\u{f59b}"
        case .fileVideoLight: return "\u{f59c}"
        case .fileVideoRegular: return "\u{f59d}"
        case .fileWordBold: return "\u{f59e}"
        case .fileWordFilled: return "\u{f59f}"
        case .fileWordLight: return "\u{f5a0}"
        case .fileWordRegular: return "\u{f5a1}"
        case .fileXmlBold: return "\u{f5a2}"
        case .fileXmlFilled: return "\u{f5a3}"
        case .fileXmlLight: return "\u{f5a4}"
        case .fileXmlRegular: return "\u{f5a5}"
        case .fileZipBold: return "\u{f5a6}"
        case .fileZipFilled: return "\u{f5a7}"
        case .fileZipLight: return "\u{f5a8}"
        case .fileZipRegular: return "\u{f5a9}"
        case .filesBold: return "\u{f5aa}"
        case .filesFilled: return "\u{f5ab}"
        case .filesLight: return "\u{f5ac}"
        case .filesRegular: return "\u{f5ad}"
        case .fillColourBold: return "\u{f5ae}"
        case .fillColourFilled: return "\u{f5af}"
        case .fillColourLight: return "\u{f5b0}"
        case .fillColourRegular: return "\u{f5b1}"
        case .filterBold: return "\u{f5b2}"
        case .filterCircleBold: return "\u{f5b3}"
        case .filterCircleFilled: return "\u{f5b4}"
        case .filterCircleLight: return "\u{f5b5}"
        case .filterCircleRegular: return "\u{f5b6}"
        case .filterLight: return "\u{f5b7}"
        case .filterRegular: return "\u{f5b8}"
        case .fitToWidthBold: return "\u{f5b9}"
        case .fitToWidthLight: return "\u{f5ba}"
        case .fitToWidthRegular: return "\u{f5bb}"
        case .fitToWindowExpandBold: return "\u{f5bc}"
        case .fitToWindowExpandLight: return "\u{f5bd}"
        case .fitToWindowExpandRegular: return "\u{f5be}"
        case .fitToWindowShrinkBold: return "\u{f5bf}"
        case .fitToWindowShrinkLight: return "\u{f5c0}"
        case .fitToWindowShrinkRegular: return "\u{f5c1}"
        case .flagBold: return "\u{f5c2}"
        case .flagCircleBold: return "\u{f5c3}"
        case .flagCircleFilled: return "\u{f5c4}"
        case .flagCircleLight: return "\u{f5c5}"
        case .flagCircleRegular: return "\u{f5c6}"
        case .flagFilled: return "\u{f5c7}"
        case .flagLight: return "\u{f5c8}"
        case .flagRegular: return "\u{f5c9}"
        case .folderBold: return "\u{f5ca}"
        case .folderEditBold: return "\u{f5cb}"
        case .folderEditLight: return "\u{f5cc}"
        case .folderEditRegular: return "\u{f5cd}"
        case .folderFilled: return "\u{f5ce}"
        case .folderLight: return "\u{f5cf}"
        case .folderLockBold: return "\u{f5d0}"
        case .folderLockLight: return "\u{f5d1}"
        case .folderLockRegular: return "\u{f5d2}"
        case .folderRegular: return "\u{f5d3}"
        case .folderViewBold: return "\u{f5d4}"
        case .folderViewLight: return "\u{f5d5}"
        case .folderViewRegular: return "\u{f5d6}"
        case .followUpBold: return "\u{f5d7}"
        case .followUpLight: return "\u{f5d8}"
        case .followUpRegular: return "\u{f5d9}"
        case .foodBold: return "\u{f5da}"
        case .foodFilled: return "\u{f5db}"
        case .foodLight: return "\u{f5dc}"
        case .foodRegular: return "\u{f5dd}"
        case .formatBold: return "\u{f5de}"
        case .formatDefaultAppBold: return "\u{f5df}"
        case .formatDefaultAppFilled: return "\u{f5e0}"
        case .formatDefaultAppLight: return "\u{f5e1}"
        case .formatDefaultAppRegular: return "\u{f5e2}"
        case .formatLight: return "\u{f5e3}"
        case .formatPanelControlBarBold: return "\u{f5e4}"
        case .formatPanelControlBarLight: return "\u{f5e5}"
        case .formatPanelControlBarRegular: return "\u{f5e6}"
        case .formatPanelControlDownBold: return "\u{f5e7}"
        case .formatPanelControlDownLight: return "\u{f5e8}"
        case .formatPanelControlDownRegular: return "\u{f5e9}"
        case .formatPanelControlLeftBold: return "\u{f5ea}"
        case .formatPanelControlLeftLight: return "\u{f5eb}"
        case .formatPanelControlLeftRegular: return "\u{f5ec}"
        case .formatPanelControlRightBold: return "\u{f5ed}"
        case .formatPanelControlRightLight: return "\u{f5ee}"
        case .formatPanelControlRightRegular: return "\u{f5ef}"
        case .formatPanelControlUpBold: return "\u{f5f0}"
        case .formatPanelControlUpDownBold: return "\u{f5f1}"
        case .formatPanelControlUpDownLight: return "\u{f5f2}"
        case .formatPanelControlUpDownRegular: return "\u{f5f3}"
        case .formatPanelControlUpLight: return "\u{f5f4}"
        case .formatPanelControlUpRegular: return "\u{f5f5}"
        case .formatRegular: return "\u{f5f6}"
        case .formatViewMixedBold: return "\u{f5f7}"
        case .formatViewMixedLight: return "\u{f5f8}"
        case .formatViewMixedRegular: return "\u{f5f9}"
        case .formulaBold: return "\u{f5fa}"
        case .formulaFilled: return "\u{f5fb}"
        case .formulaLight: return "\u{f5fc}"
        case .formulaRegular: return "\u{f5fd}"
        case .forwardMessageBold: return "\u{f5fe}"
        case .forwardMessageFilled: return "\u{f5ff}"
        case .forwardMessageLight: return "\u{f600}"
        case .forwardMessageRegular: return "\u{f601}"
        case .forwardTenSecBold: return "\u{f602}"
        case .forwardTenSecLight: return "\u{f603}"
        case .forwardTenSecRegular: return "\u{f604}"
        case .fourColumnBold: return "\u{f605}"
        case .fourColumnLight: return "\u{f606}"
        case .fourColumnRegular: return "\u{f607}"
        case .fourWayNavigationBold: return "\u{f608}"
        case .fourWayNavigationLight: return "\u{f609}"
        case .fourWayNavigationRegular: return "\u{f60a}"
        case .frequencyCappingBold: return "\u{f60b}"
        case .frequencyCappingLight: return "\u{f60c}"
        case .frequencyCappingRegular: return "\u{f60d}"
        case .fulfillmentBold: return "\u{f60e}"
        case .fulfillmentLight: return "\u{f60f}"
        case .fulfillmentRegular: return "\u{f610}"
        case .fullscreenBold: return "\u{f611}"
        case .fullscreenExitBold: return "\u{f612}"
        case .fullscreenExitLight: return "\u{f613}"
        case .fullscreenExitRegular: return "\u{f614}"
        case .fullscreenLight: return "\u{f615}"
        case .fullscreenRegular: return "\u{f616}"
        case .genericDeviceVideoBadgeFilled: return "\u{f617}"
        case .genericDeviceVideoBold: return "\u{f618}"
        case .genericDeviceVideoFilled: return "\u{f619}"
        case .genericDeviceVideoLight: return "\u{f61a}"
        case .genericDeviceVideoRegular: return "\u{f61b}"
        case .gifBold: return "\u{f61c}"
        case .gifFilled: return "\u{f61d}"
        case .gifHorizontalBold: return "\u{f61e}"
        case .gifHorizontalFilled: return "\u{f61f}"
        case .gifHorizontalLight: return "\u{f620}"
        case .gifHorizontalRegular: return "\u{f621}"
        case .gifLight: return "\u{f622}"
        case .gifRegular: return "\u{f623}"
        case .giftBold: return "\u{f624}"
        case .giftFilled: return "\u{f625}"
        case .giftLight: return "\u{f626}"
        case .giftRegular: return "\u{f627}"
        case .greenLeafBold: return "\u{f628}"
        case .greenLeafFilled: return "\u{f629}"
        case .greenLeafLight: return "\u{f62a}"
        case .greenLeafRegular: return "\u{f62b}"
        case .greenRoomBold: return "\u{f62c}"
        case .greenRoomFilled: return "\u{f62d}"
        case .greenRoomLight: return "\u{f62e}"
        case .greenRoomRegular: return "\u{f62f}"
        case .guestIssuerBold: return "\u{f630}"
        case .guestIssuerLight: return "\u{f631}"
        case .guestIssuerRegular: return "\u{f632}"
        case .guideBold: return "\u{f633}"
        case .guideLight: return "\u{f634}"
        case .guideRegular: return "\u{f635}"
        case .handPointerBold: return "\u{f636}"
        case .handPointerLight: return "\u{f637}"
        case .handPointerRegular: return "\u{f638}"
        case .handlerBold: return "\u{f639}"
        case .handlerHorizontalBold: return "\u{f63a}"
        case .handlerHorizontalLight: return "\u{f63b}"
        case .handlerHorizontalRegular: return "\u{f63c}"
        case .handlerLight: return "\u{f63d}"
        case .handlerRegular: return "\u{f63e}"
        case .handsetAlertBold: return "\u{f63f}"
        case .handsetAlertFilled: return "\u{f640}"
        case .handsetAlertLight: return "\u{f641}"
        case .handsetAlertRegular: return "\u{f642}"
        case .handsetBold: return "\u{f643}"
        case .handsetDownSlashBold: return "\u{f644}"
        case .handsetDownSlashFilled: return "\u{f645}"
        case .handsetDownSlashLight: return "\u{f646}"
        case .handsetDownSlashRegular: return "\u{f647}"
        case .handsetFilled: return "\u{f648}"
        case .handsetLight: return "\u{f649}"
        case .handsetMutedBold: return "\u{f64a}"
        case .handsetMutedFilled: return "\u{f64b}"
        case .handsetMutedLight: return "\u{f64c}"
        case .handsetMutedRegular: return "\u{f64d}"
        case .handsetRegular: return "\u{f64e}"
        case .handsetsArrowLeftBold: return "\u{f64f}"
        case .handsetsArrowLeftLight: return "\u{f650}"
        case .handsetsArrowLeftRegular: return "\u{f651}"
        case .handshakeBold: return "\u{f652}"
        case .handshakeLight: return "\u{f653}"
        case .handshakeRegular: return "\u{f654}"
        case .headingOneBold: return "\u{f655}"
        case .headingOneLight: return "\u{f656}"
        case .headingOneRegular: return "\u{f657}"
        case .headingThreeBold: return "\u{f658}"
        case .headingThreeLight: return "\u{f659}"
        case .headingThreeRegular: return "\u{f65a}"
        case .headingTwoBold: return "\u{f65b}"
        case .headingTwoLight: return "\u{f65c}"
        case .headingTwoRegular: return "\u{f65d}"
        case .headphonesBold: return "\u{f65e}"
        case .headphonesFilled: return "\u{f65f}"
        case .headphonesLight: return "\u{f660}"
        case .headphonesMutedBold: return "\u{f661}"
        case .headphonesMutedFilled: return "\u{f662}"
        case .headphonesMutedLight: return "\u{f663}"
        case .headphonesMutedRegular: return "\u{f664}"
        case .headphonesRegular: return "\u{f665}"
        case .headsetAlertBold: return "\u{f666}"
        case .headsetAlertLight: return "\u{f667}"
        case .headsetAlertRegular: return "\u{f668}"
        case .headsetArrowDownBold: return "\u{f669}"
        case .headsetArrowDownFilled: return "\u{f66a}"
        case .headsetArrowDownLight: return "\u{f66b}"
        case .headsetArrowDownRegular: return "\u{f66c}"
        case .headsetBluetoothBold: return "\u{f66d}"
        case .headsetBluetoothLight: return "\u{f66e}"
        case .headsetBluetoothRegular: return "\u{f66f}"
        case .headsetBold: return "\u{f670}"
        case .headsetFilled: return "\u{f671}"
        case .headsetLight: return "\u{f672}"
        case .headsetMutedBold: return "\u{f673}"
        case .headsetMutedLight: return "\u{f674}"
        case .headsetMutedRegular: return "\u{f675}"
        case .headsetPrivateBold: return "\u{f676}"
        case .headsetPrivateLight: return "\u{f677}"
        case .headsetPrivateRegular: return "\u{f678}"
        case .headsetRegular: return "\u{f679}"
        case .hearingBold: return "\u{f67a}"
        case .hearingImpairedBold: return "\u{f67b}"
        case .hearingImpairedLight: return "\u{f67c}"
        case .hearingImpairedRegular: return "\u{f67d}"
        case .hearingLight: return "\u{f67e}"
        case .hearingRegular: return "\u{f67f}"
        case .helpBold: return "\u{f680}"
        case .helpCircleBold: return "\u{f681}"
        case .helpCircleFilled: return "\u{f682}"
        case .helpCircleLight: return "\u{f683}"
        case .helpCircleRegular: return "\u{f684}"
        case .helpLight: return "\u{f685}"
        case .helpRegular: return "\u{f686}"
        case .helpdeskBold: return "\u{f687}"
        case .helpdeskFilled: return "\u{f688}"
        case .helpdeskLight: return "\u{f689}"
        case .helpdeskRegular: return "\u{f68a}"
        case .hideBold: return "\u{f68b}"
        case .hideFilled: return "\u{f68c}"
        case .hideLight: return "\u{f68d}"
        case .hideRegular: return "\u{f68e}"
        case .homeBold: return "\u{f68f}"
        case .homeFilled: return "\u{f690}"
        case .homeLight: return "\u{f691}"
        case .homeRegular: return "\u{f692}"
        case .horizontalLineBold: return "\u{f693}"
        case .horizontalLineLight: return "\u{f694}"
        case .horizontalLineRegular: return "\u{f695}"
        case .hotelingBold: return "\u{f696}"
        case .hotelingFilled: return "\u{f697}"
        case .hotelingLight: return "\u{f698}"
        case .hotelingRegular: return "\u{f699}"
        case .humidityBold: return "\u{f69a}"
        case .humidityLight: return "\u{f69b}"
        case .humidityRegular: return "\u{f69c}"
        case .huntGroupBold: return "\u{f69d}"
        case .huntGroupFilled: return "\u{f69e}"
        case .huntGroupLight: return "\u{f69f}"
        case .huntGroupRegular: return "\u{f6a0}"
        case .idleBold: return "\u{f6a1}"
        case .idleFilled: return "\u{f6a2}"
        case .idleLight: return "\u{f6a3}"
        case .idleRegular: return "\u{f6a4}"
        case .immediateBold: return "\u{f6a5}"
        case .immediateFilled: return "\u{f6a6}"
        case .immediateLight: return "\u{f6a7}"
        case .immediateRegular: return "\u{f6a8}"
        case .importBold: return "\u{f6a9}"
        case .importLight: return "\u{f6aa}"
        case .importRegular: return "\u{f6ab}"
        case .inCommonBold: return "\u{f6ac}"
        case .inCommonLight: return "\u{f6ad}"
        case .inCommonRegular: return "\u{f6ae}"
        case .inboxBold: return "\u{f6af}"
        case .inboxFilled: return "\u{f6b0}"
        case .inboxLight: return "\u{f6b1}"
        case .inboxRegular: return "\u{f6b2}"
        case .includeBold: return "\u{f6b3}"
        case .includeLight: return "\u{f6b4}"
        case .includeRegular: return "\u{f6b5}"
        case .incognitoBold: return "\u{f6b6}"
        case .incognitoFilled: return "\u{f6b7}"
        case .incognitoLight: return "\u{f6b8}"
        case .incognitoRegular: return "\u{f6b9}"
        case .incomingCallLegacyBold: return "\u{f6ba}"
        case .incomingCallLegacyFilled: return "\u{f6bb}"
        case .incomingCallLegacyLight: return "\u{f6bc}"
        case .incomingCallLegacyRegular: return "\u{f6bd}"
        case .indentDecreaseBold: return "\u{f6be}"
        case .indentDecreaseLight: return "\u{f6bf}"
        case .indentDecreaseRegular: return "\u{f6c0}"
        case .indentIncreaseBold: return "\u{f6c1}"
        case .indentIncreaseLight: return "\u{f6c2}"
        case .indentIncreaseRegular: return "\u{f6c3}"
        case .infoBadgeFilled: return "\u{f6c4}"
        case .infoCircleBold: return "\u{f6c5}"
        case .infoCircleFilled: return "\u{f6c6}"
        case .infoCircleLight: return "\u{f6c7}"
        case .infoCircleRegular: return "\u{f6c8}"
        case .infoCircleTwoBold: return "\u{f6c9}"
        case .infoCircleTwoFilled: return "\u{f6ca}"
        case .infoCircleTwoLight: return "\u{f6cb}"
        case .infoCircleTwoRegular: return "\u{f6cc}"
        case .inputBold: return "\u{f6cd}"
        case .inputDisconnectedBold: return "\u{f6ce}"
        case .inputDisconnectedLight: return "\u{f6cf}"
        case .inputDisconnectedRegular: return "\u{f6d0}"
        case .inputLight: return "\u{f6d1}"
        case .inputRegular: return "\u{f6d2}"
        case .instantScheduleBold: return "\u{f6d3}"
        case .instantScheduleFilled: return "\u{f6d4}"
        case .instantScheduleLight: return "\u{f6d5}"
        case .instantScheduleRegular: return "\u{f6d6}"
        case .integerBold: return "\u{f6d7}"
        case .integerFilled: return "\u{f6d8}"
        case .integerLight: return "\u{f6d9}"
        case .integerRegular: return "\u{f6da}"
        case .integrationsBold: return "\u{f6db}"
        case .integrationsFilled: return "\u{f6dc}"
        case .integrationsLight: return "\u{f6dd}"
        case .integrationsRegular: return "\u{f6de}"
        case .intelligentRoutingBold: return "\u{f6df}"
        case .intelligentRoutingLight: return "\u{f6e0}"
        case .intelligentRoutingRegular: return "\u{f6e1}"
        case .interactionBold: return "\u{f6e2}"
        case .interactionFilled: return "\u{f6e3}"
        case .interactionLight: return "\u{f6e4}"
        case .interactionRegular: return "\u{f6e5}"
        case .invitedUserBold: return "\u{f6e6}"
        case .invitedUserLight: return "\u{f6e7}"
        case .invitedUserRegular: return "\u{f6e8}"
        case .italicBold: return "\u{f6e9}"
        case .italicFilled: return "\u{f6ea}"
        case .italicLight: return "\u{f6eb}"
        case .italicRegular: return "\u{f6ec}"
        case .joinAudioBold: return "\u{f6ed}"
        case .joinAudioFilled: return "\u{f6ee}"
        case .joinAudioLight: return "\u{f6ef}"
        case .joinAudioRegular: return "\u{f6f0}"
        case .keepInTouchBold: return "\u{f6f1}"
        case .keepInTouchFilled: return "\u{f6f2}"
        case .keepInTouchLight: return "\u{f6f3}"
        case .keepInTouchRegular: return "\u{f6f4}"
        case .keyboardBold: return "\u{f6f5}"
        case .keyboardCloseBold: return "\u{f6f6}"
        case .keyboardCloseLight: return "\u{f6f7}"
        case .keyboardCloseRegular: return "\u{f6f8}"
        case .keyboardLight: return "\u{f6f9}"
        case .keyboardRegular: return "\u{f6fa}"
        case .languageBold: return "\u{f6fb}"
        case .languageFilled: return "\u{f6fc}"
        case .languageLight: return "\u{f6fd}"
        case .languageRegular: return "\u{f6fe}"
        case .laptopBold: return "\u{f6ff}"
        case .laptopDisconnectedBold: return "\u{f700}"
        case .laptopDisconnectedLight: return "\u{f701}"
        case .laptopDisconnectedRegular: return "\u{f702}"
        case .laptopFilled: return "\u{f703}"
        case .laptopLight: return "\u{f704}"
        case .laptopRegular: return "\u{f705}"
        case .laserPointerBold: return "\u{f706}"
        case .laserPointerCursorBlackLight: return "\u{f707}"
        case .laserPointerCursorBlueLight: return "\u{f708}"
        case .laserPointerCursorGreenLight: return "\u{f709}"
        case .laserPointerCursorPurpleLight: return "\u{f70a}"
        case .laserPointerCursorRedLight: return "\u{f70b}"
        case .laserPointerCursorWhiteLight: return "\u{f70c}"
        case .laserPointerCursorYellowLight: return "\u{f70d}"
        case .laserPointerFilled: return "\u{f70e}"
        case .laserPointerLight: return "\u{f70f}"
        case .laserPointerRegular: return "\u{f710}"
        case .launchBold: return "\u{f711}"
        case .launchFilled: return "\u{f712}"
        case .launchLight: return "\u{f713}"
        case .launchRegular: return "\u{f714}"
        case .layoutSideBySideVerticalBold: return "\u{f715}"
        case .layoutSideBySideVerticalFilled: return "\u{f716}"
        case .layoutSideBySideVerticalLight: return "\u{f717}"
        case .layoutSideBySideVerticalRegular: return "\u{f718}"
        case .leaveBreakoutSessionBold: return "\u{f719}"
        case .leaveBreakoutSessionLight: return "\u{f71a}"
        case .leaveBreakoutSessionRegular: return "\u{f71b}"
        case .leaveDeviceBold: return "\u{f71c}"
        case .leaveDeviceLight: return "\u{f71d}"
        case .leaveDeviceRegular: return "\u{f71e}"
        case .likeBold: return "\u{f71f}"
        case .likeFilled: return "\u{f720}"
        case .likeLight: return "\u{f721}"
        case .likeRegular: return "\u{f722}"
        case .linkBold: return "\u{f723}"
        case .linkLight: return "\u{f724}"
        case .linkRegular: return "\u{f725}"
        case .listBulletedBold: return "\u{f726}"
        case .listBulletedLight: return "\u{f727}"
        case .listBulletedRegular: return "\u{f728}"
        case .listMenuBold: return "\u{f729}"
        case .listMenuLight: return "\u{f72a}"
        case .listMenuRegular: return "\u{f72b}"
        case .listNumberedBold: return "\u{f72c}"
        case .listNumberedLight: return "\u{f72d}"
        case .listNumberedRegular: return "\u{f72e}"
        case .liveBold: return "\u{f72f}"
        case .liveFilled: return "\u{f730}"
        case .liveLight: return "\u{f731}"
        case .liveRegular: return "\u{f732}"
        case .locationBold: return "\u{f733}"
        case .locationFilled: return "\u{f734}"
        case .locationLight: return "\u{f735}"
        case .locationRegular: return "\u{f736}"
        case .longTextBoxBold: return "\u{f737}"
        case .longTextBoxLight: return "\u{f738}"
        case .longTextBoxRegular: return "\u{f739}"
        case .lowerHandBold: return "\u{f73a}"
        case .lowerHandLight: return "\u{f73b}"
        case .lowerHandRegular: return "\u{f73c}"
        case .magicPenBold: return "\u{f73d}"
        case .magicPenFilled: return "\u{f73e}"
        case .magicPenLight: return "\u{f73f}"
        case .magicPenRegular: return "\u{f740}"
        case .markAsUnreadBold: return "\u{f741}"
        case .markAsUnreadFilled: return "\u{f742}"
        case .markAsUnreadLight: return "\u{f743}"
        case .markAsUnreadRegular: return "\u{f744}"
        case .markdownBold: return "\u{f745}"
        case .markdownFilled: return "\u{f746}"
        case .markdownLight: return "\u{f747}"
        case .markdownRegular: return "\u{f748}"
        case .markerBold: return "\u{f749}"
        case .markerFilled: return "\u{f74a}"
        case .markerLight: return "\u{f74b}"
        case .markerRegular: return "\u{f74c}"
        case .maximizeBold: return "\u{f74d}"
        case .maximizeLight: return "\u{f74e}"
        case .maximizeRegular: return "\u{f74f}"
        case .mediaPlayerBold: return "\u{f750}"
        case .mediaPlayerLight: return "\u{f751}"
        case .mediaPlayerRegular: return "\u{f752}"
        case .mediaQualityGoodBold: return "\u{f753}"
        case .mediaQualityGoodFilled: return "\u{f754}"
        case .mediaQualityGoodLight: return "\u{f755}"
        case .mediaQualityGoodRegular: return "\u{f756}"
        case .mediaQualityPoorBold: return "\u{f757}"
        case .mediaQualityPoorColoredBold: return "\u{f758}"
        case .mediaQualityPoorFilled: return "\u{f759}"
        case .mediaQualityPoorLight: return "\u{f75a}"
        case .mediaQualityPoorRegular: return "\u{f75b}"
        case .mediaQualityUnstableBold: return "\u{f75c}"
        case .mediaQualityUnstableColoredBold: return "\u{f75d}"
        case .mediaQualityUnstableFilled: return "\u{f75e}"
        case .mediaQualityUnstableLight: return "\u{f75f}"
        case .mediaQualityUnstableRegular: return "\u{f760}"
        case .meetBold: return "\u{f761}"
        case .meetEndBold: return "\u{f762}"
        case .meetEndLight: return "\u{f763}"
        case .meetEndRegular: return "\u{f764}"
        case .meetFilled: return "\u{f765}"
        case .meetLight: return "\u{f766}"
        case .meetRegular: return "\u{f767}"
        case .meetingSummaryBold: return "\u{f768}"
        case .meetingSummaryFilled: return "\u{f769}"
        case .meetingSummaryLight: return "\u{f76a}"
        case .meetingSummaryRegular: return "\u{f76b}"
        case .meetingsBold: return "\u{f76c}"
        case .meetingsFilled: return "\u{f76d}"
        case .meetingsFocusMonthBold: return "\u{f76e}"
        case .meetingsFocusMonthLight: return "\u{f76f}"
        case .meetingsFocusMonthRegular: return "\u{f770}"
        case .meetingsFocusOneDayBold: return "\u{f771}"
        case .meetingsFocusOneDayLight: return "\u{f772}"
        case .meetingsFocusOneDayRegular: return "\u{f773}"
        case .meetingsFocusThreeDayBold: return "\u{f774}"
        case .meetingsFocusThreeDayLight: return "\u{f775}"
        case .meetingsFocusThreeDayRegular: return "\u{f776}"
        case .meetingsFocusUpcomingBold: return "\u{f777}"
        case .meetingsFocusUpcomingLight: return "\u{f778}"
        case .meetingsFocusUpcomingRegular: return "\u{f779}"
        case .meetingsLight: return "\u{f77a}"
        case .meetingsPresenceBadgeFilled: return "\u{f77b}"
        case .meetingsPresenceBold: return "\u{f77c}"
        case .meetingsPresenceFilled: return "\u{f77d}"
        case .meetingsPresenceLight: return "\u{f77e}"
        case .meetingsPresenceRegular: return "\u{f77f}"
        case .meetingsRegular: return "\u{f780}"
        case .meetingsTeamBold: return "\u{f781}"
        case .meetingsTeamFilled: return "\u{f782}"
        case .meetingsTeamLight: return "\u{f783}"
        case .meetingsTeamNewBold: return "\u{f784}"
        case .meetingsTeamNewLight: return "\u{f785}"
        case .meetingsTeamNewRegular: return "\u{f786}"
        case .meetingsTeamRegular: return "\u{f787}"
        case .mentionBold: return "\u{f788}"
        case .mentionFilled: return "\u{f789}"
        case .mentionLight: return "\u{f78a}"
        case .mentionRegular: return "\u{f78b}"
        case .messageQueingBold: return "\u{f78c}"
        case .messageQueingLight: return "\u{f78d}"
        case .messageQueingRegular: return "\u{f78e}"
        case .microphoneBold: return "\u{f78f}"
        case .microphoneFilled: return "\u{f790}"
        case .microphoneHardMutedBold: return "\u{f791}"
        case .microphoneHardMutedCircleFilled: return "\u{f792}"
        case .microphoneHardMutedLight: return "\u{f793}"
        case .microphoneHardMutedRegular: return "\u{f794}"
        case .microphoneLight: return "\u{f795}"
        case .microphoneMusicModeBold: return "\u{f796}"
        case .microphoneMusicModeLight: return "\u{f797}"
        case .microphoneMusicModeOnBold: return "\u{f798}"
        case .microphoneMusicModeOnLight: return "\u{f799}"
        case .microphoneMusicModeOnRegular: return "\u{f79a}"
        case .microphoneMusicModeRegular: return "\u{f79b}"
        case .microphoneMutedBold: return "\u{f79c}"
        case .microphoneMutedCircleFilled: return "\u{f79d}"
        case .microphoneMutedFilled: return "\u{f79e}"
        case .microphoneMutedLight: return "\u{f79f}"
        case .microphoneMutedRegular: return "\u{f7a0}"
        case .microphoneOnBold: return "\u{f7a1}"
        case .microphoneOnLight: return "\u{f7a2}"
        case .microphoneOnRegular: return "\u{f7a3}"
        case .microphoneOptAllBold: return "\u{f7a4}"
        case .microphoneOptAllLight: return "\u{f7a5}"
        case .microphoneOptAllMutedBold: return "\u{f7a6}"
        case .microphoneOptAllMutedLight: return "\u{f7a7}"
        case .microphoneOptAllMutedRegular: return "\u{f7a8}"
        case .microphoneOptAllOnBold: return "\u{f7a9}"
        case .microphoneOptAllOnLight: return "\u{f7aa}"
        case .microphoneOptAllOnRegular: return "\u{f7ab}"
        case .microphoneOptAllRegular: return "\u{f7ac}"
        case .microphoneOptMeBold: return "\u{f7ad}"
        case .microphoneOptMeLight: return "\u{f7ae}"
        case .microphoneOptMeMutedBold: return "\u{f7af}"
        case .microphoneOptMeMutedLight: return "\u{f7b0}"
        case .microphoneOptMeMutedRegular: return "\u{f7b1}"
        case .microphoneOptMeOnBold: return "\u{f7b2}"
        case .microphoneOptMeOnLight: return "\u{f7b3}"
        case .microphoneOptMeOnRegular: return "\u{f7b4}"
        case .microphoneOptMeRegular: return "\u{f7b5}"
        case .microphoneRegular: return "\u{f7b6}"
        case .mindMapBold: return "\u{f7b7}"
        case .mindMapLight: return "\u{f7b8}"
        case .mindMapRegular: return "\u{f7b9}"
        case .minimizeBold: return "\u{f7ba}"
        case .minimizeLight: return "\u{f7bb}"
        case .minimizeRegular: return "\u{f7bc}"
        case .minusBold: return "\u{f7bd}"
        case .minusFilled: return "\u{f7be}"
        case .minusLight: return "\u{f7bf}"
        case .minusRegular: return "\u{f7c0}"
        case .mirrorBold: return "\u{f7c1}"
        case .mirrorFilled: return "\u{f7c2}"
        case .mirrorLight: return "\u{f7c3}"
        case .mirrorRegular: return "\u{f7c4}"
        case .mmsFilled: return "\u{f7c5}"
        case .moderatorBold: return "\u{f7c6}"
        case .moderatorLight: return "\u{f7c7}"
        case .moderatorRegular: return "\u{f7c8}"
        case .monitoringBold: return "\u{f7c9}"
        case .monitoringLight: return "\u{f7ca}"
        case .monitoringRegular: return "\u{f7cb}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7cc}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7cd}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7ce}"
        case .moreAdrBold: return "\u{f7cf}"
        case .moreAdrLight: return "\u{f7d0}"
        case .moreAdrRegular: return "\u{f7d1}"
        case .moreBold: return "\u{f7d2}"
        case .moreCircleBold: return "\u{f7d3}"
        case .moreCircleFilled: return "\u{f7d4}"
        case .moreCircleLight: return "\u{f7d5}"
        case .moreCircleRegular: return "\u{f7d6}"
        case .moreLight: return "\u{f7d7}"
        case .moreRegular: return "\u{f7d8}"
        case .mouseCursorBold: return "\u{f7d9}"
        case .mouseCursorLight: return "\u{f7da}"
        case .mouseCursorRegular: return "\u{f7db}"
        case .moveCallInAdrBold: return "\u{f7dc}"
        case .moveCallInAdrLight: return "\u{f7dd}"
        case .moveCallInAdrRegular: return "\u{f7de}"
        case .moveCallInIphBold: return "\u{f7df}"
        case .moveCallInIphLight: return "\u{f7e0}"
        case .moveCallInIphRegular: return "\u{f7e1}"
        case .moveCallInLaptopBold: return "\u{f7e2}"
        case .moveCallInLaptopLight: return "\u{f7e3}"
        case .moveCallInLaptopRegular: return "\u{f7e4}"
        case .moveCallInOutAdrBold: return "\u{f7e5}"
        case .moveCallInOutAdrLight: return "\u{f7e6}"
        case .moveCallInOutAdrRegular: return "\u{f7e7}"
        case .moveCallInOutIphBold: return "\u{f7e8}"
        case .moveCallInOutIphLight: return "\u{f7e9}"
        case .moveCallInOutIphRegular: return "\u{f7ea}"
        case .moveCallInTabletBold: return "\u{f7eb}"
        case .moveCallInTabletLight: return "\u{f7ec}"
        case .moveCallInTabletRegular: return "\u{f7ed}"
        case .moveCallOutAdrBold: return "\u{f7ee}"
        case .moveCallOutAdrLight: return "\u{f7ef}"
        case .moveCallOutAdrRegular: return "\u{f7f0}"
        case .moveCallOutIphBold: return "\u{f7f1}"
        case .moveCallOutIphLight: return "\u{f7f2}"
        case .moveCallOutIphRegular: return "\u{f7f3}"
        case .moveCallOutLaptopBold: return "\u{f7f4}"
        case .moveCallOutLaptopLight: return "\u{f7f5}"
        case .moveCallOutLaptopRegular: return "\u{f7f6}"
        case .moveCallOutTabletBold: return "\u{f7f7}"
        case .moveCallOutTabletLight: return "\u{f7f8}"
        case .moveCallOutTabletRegular: return "\u{f7f9}"
        case .moveToScreenBold: return "\u{f7fa}"
        case .moveToScreenLight: return "\u{f7fb}"
        case .moveToScreenRegular: return "\u{f7fc}"
        case .multilineChartBold: return "\u{f7fd}"
        case .multilineChartFilled: return "\u{f7fe}"
        case .multilineChartLight: return "\u{f7ff}"
        case .multilineChartRegular: return "\u{f800}"
        case .multimediaBold: return "\u{f801}"
        case .multimediaFilled: return "\u{f802}"
        case .multimediaLight: return "\u{f803}"
        case .multimediaRegular: return "\u{f804}"
        case .multipledDevicesBold: return "\u{f805}"
        case .multipledDevicesLight: return "\u{f806}"
        case .multipledDevicesRegular: return "\u{f807}"
        case .musicModeCircleBold: return "\u{f808}"
        case .musicModeCircleFilled: return "\u{f809}"
        case .musicModeCircleLight: return "\u{f80a}"
        case .musicModeCircleRegular: return "\u{f80b}"
        case .musicNoteBold: return "\u{f80c}"
        case .musicNoteFilled: return "\u{f80d}"
        case .musicNoteLight: return "\u{f80e}"
        case .musicNoteRegular: return "\u{f80f}"
        case .muteOnEntryBold: return "\u{f810}"
        case .muteOnEntryFilled: return "\u{f811}"
        case .muteOnEntryLight: return "\u{f812}"
        case .muteOnEntryRegular: return "\u{f813}"
        case .networkSwitchBold: return "\u{f814}"
        case .networkSwitchFilled: return "\u{f815}"
        case .networkSwitchLight: return "\u{f816}"
        case .networkSwitchRegular: return "\u{f817}"
        case .newManagerBold: return "\u{f818}"
        case .newManagerFilled: return "\u{f819}"
        case .newManagerLight: return "\u{f81a}"
        case .newManagerRegular: return "\u{f81b}"
        case .newTitleBold: return "\u{f81c}"
        case .newTitleLight: return "\u{f81d}"
        case .newTitleRegular: return "\u{f81e}"
        case .newVoicemailBold: return "\u{f81f}"
        case .newVoicemailLight: return "\u{f820}"
        case .newVoicemailRegular: return "\u{f821}"
        case .newWhiteboardBold: return "\u{f822}"
        case .newWhiteboardLight: return "\u{f823}"
        case .newWhiteboardRegular: return "\u{f824}"
        case .nextBold: return "\u{f825}"
        case .nextLight: return "\u{f826}"
        case .nextRegular: return "\u{f827}"
        case .noDevicesBold: return "\u{f828}"
        case .noDevicesLight: return "\u{f829}"
        case .noDevicesRegular: return "\u{f82a}"
        case .noiseDetectedCanceledFilled: return "\u{f82b}"
        case .noiseDetectedFilled: return "\u{f82c}"
        case .noiseNoneCanceledFilled: return "\u{f82d}"
        case .noiseNoneFilled: return "\u{f82e}"
        case .noiseRemovalBold: return "\u{f82f}"
        case .noiseRemovalLight: return "\u{f830}"
        case .noiseRemovalRegular: return "\u{f831}"
        case .noteBold: return "\u{f832}"
        case .noteFilled: return "\u{f833}"
        case .noteLight: return "\u{f834}"
        case .notePptBold: return "\u{f835}"
        case .notePptLight: return "\u{f836}"
        case .notePptRegular: return "\u{f837}"
        case .noteRegular: return "\u{f838}"
        case .notesBold: return "\u{f839}"
        case .notesFilled: return "\u{f83a}"
        case .notesLight: return "\u{f83b}"
        case .notesRegular: return "\u{f83c}"
        case .numberBold: return "\u{f83d}"
        case .numberLight: return "\u{f83e}"
        case .numberRegular: return "\u{f83f}"
        case .oldRemoteBold: return "\u{f840}"
        case .oldRemoteLight: return "\u{f841}"
        case .oldRemoteRegular: return "\u{f842}"
        case .oldTouchBold: return "\u{f843}"
        case .oldTouchLight: return "\u{f844}"
        case .oldTouchRegular: return "\u{f845}"
        case .oneColumnBold: return "\u{f846}"
        case .oneColumnLight: return "\u{f847}"
        case .oneColumnRegular: return "\u{f848}"
        case .oneTimeBold: return "\u{f849}"
        case .oneTimeLight: return "\u{f84a}"
        case .oneTimeRegular: return "\u{f84b}"
        case .openInFolderBold: return "\u{f84c}"
        case .openInFolderFilled: return "\u{f84d}"
        case .openInFolderLight: return "\u{f84e}"
        case .openInFolderRegular: return "\u{f84f}"
        case .openPagesBold: return "\u{f850}"
        case .openPagesLight: return "\u{f851}"
        case .openPagesRegular: return "\u{f852}"
        case .otherNumberBold: return "\u{f853}"
        case .otherNumberFilled: return "\u{f854}"
        case .otherNumberLight: return "\u{f855}"
        case .otherNumberRegular: return "\u{f856}"
        case .otherNumberWarningBold: return "\u{f857}"
        case .otherNumberWarningLight: return "\u{f858}"
        case .otherNumberWarningRegular: return "\u{f859}"
        case .outgoingCallLegacyBold: return "\u{f85a}"
        case .outgoingCallLegacyFilled: return "\u{f85b}"
        case .outgoingCallLegacyLight: return "\u{f85c}"
        case .outgoingCallLegacyRegular: return "\u{f85d}"
        case .overflowLeftBold: return "\u{f85e}"
        case .overflowLeftLight: return "\u{f85f}"
        case .overflowLeftRegular: return "\u{f860}"
        case .overflowRightBold: return "\u{f861}"
        case .overflowRightLight: return "\u{f862}"
        case .overflowRightRegular: return "\u{f863}"
        case .pairedCameraBold: return "\u{f864}"
        case .pairedCameraLight: return "\u{f865}"
        case .pairedCameraRegular: return "\u{f866}"
        case .pairedDeviceBold: return "\u{f867}"
        case .pairedDeviceLight: return "\u{f868}"
        case .pairedDeviceRegular: return "\u{f869}"
        case .pairedHandsetBold: return "\u{f86a}"
        case .pairedHandsetLight: return "\u{f86b}"
        case .pairedHandsetRegular: return "\u{f86c}"
        case .pairingBold: return "\u{f86d}"
        case .pairingLight: return "\u{f86e}"
        case .pairingRegular: return "\u{f86f}"
        case .parenthesisBold: return "\u{f870}"
        case .parenthesisFilled: return "\u{f871}"
        case .parenthesisLight: return "\u{f872}"
        case .parenthesisRegular: return "\u{f873}"
        case .parkedBold: return "\u{f874}"
        case .parkedFilled: return "\u{f875}"
        case .parkedLight: return "\u{f876}"
        case .parkedRegular: return "\u{f877}"
        case .parseBold: return "\u{f878}"
        case .parseLight: return "\u{f879}"
        case .parseRegular: return "\u{f87a}"
        case .partialBold: return "\u{f87b}"
        case .partialLight: return "\u{f87c}"
        case .partialRegular: return "\u{f87d}"
        case .participantAddBold: return "\u{f87e}"
        case .participantAddLight: return "\u{f87f}"
        case .participantAddRegular: return "\u{f880}"
        case .participantBlockedBold: return "\u{f881}"
        case .participantBlockedLight: return "\u{f882}"
        case .participantBlockedRegular: return "\u{f883}"
        case .participantBold: return "\u{f884}"
        case .participantFilled: return "\u{f885}"
        case .participantLight: return "\u{f886}"
        case .participantListBold: return "\u{f887}"
        case .participantListFilled: return "\u{f888}"
        case .participantListLight: return "\u{f889}"
        case .participantListRegular: return "\u{f88a}"
        case .participantRegular: return "\u{f88b}"
        case .participantRemoveBold: return "\u{f88c}"
        case .participantRemoveLight: return "\u{f88d}"
        case .participantRemoveRegular: return "\u{f88e}"
        case .participantUnknownBold: return "\u{f88f}"
        case .participantUnknownLight: return "\u{f890}"
        case .participantUnknownRegular: return "\u{f891}"
        case .passMouseBold: return "\u{f892}"
        case .passMouseLight: return "\u{f893}"
        case .passMouseRegular: return "\u{f894}"
        case .pauseBadgeFilled: return "\u{f895}"
        case .pauseBold: return "\u{f896}"
        case .pauseFilled: return "\u{f897}"
        case .pauseInteractionBold: return "\u{f898}"
        case .pauseInteractionFilled: return "\u{f899}"
        case .pauseInteractionLight: return "\u{f89a}"
        case .pauseInteractionRegular: return "\u{f89b}"
        case .pauseLight: return "\u{f89c}"
        case .pauseRegular: return "\u{f89d}"
        case .peopleAddBold: return "\u{f89e}"
        case .peopleAddFilled: return "\u{f89f}"
        case .peopleAddLight: return "\u{f8a0}"
        case .peopleAddRegular: return "\u{f8a1}"
        case .peopleBold: return "\u{f8a2}"
        case .peopleCircleBold: return "\u{f8a3}"
        case .peopleCircleFilled: return "\u{f8a4}"
        case .peopleCircleLight: return "\u{f8a5}"
        case .peopleCircleRegular: return "\u{f8a6}"
        case .peopleFilled: return "\u{f8a7}"
        case .peopleInsightsBold: return "\u{f8a8}"
        case .peopleInsightsFilled: return "\u{f8a9}"
        case .peopleInsightsLight: return "\u{f8aa}"
        case .peopleInsightsRegular: return "\u{f8ab}"
        case .peopleLight: return "\u{f8ac}"
        case .peopleManageBold: return "\u{f8ad}"
        case .peopleManageFilled: return "\u{f8ae}"
        case .peopleManageLight: return "\u{f8af}"
        case .peopleManageRegular: return "\u{f8b0}"
        case .peopleRegular: return "\u{f8b1}"
        case .phoneAlertBold: return "\u{f8b2}"
        case .phoneAlertLight: return "\u{f8b3}"
        case .phoneAlertRegular: return "\u{f8b4}"
        case .phoneBadgeFilled: return "\u{f8b5}"
        case .phoneBold: return "\u{f8b6}"
        case .phoneFilled: return "\u{f8b7}"
        case .phoneLight: return "\u{f8b8}"
        case .phoneMutedBold: return "\u{f8b9}"
        case .phoneMutedLight: return "\u{f8ba}"
        case .phoneMutedRegular: return "\u{f8bb}"
        case .phonePrivateBold: return "\u{f8bc}"
        case .phonePrivateLight: return "\u{f8bd}"
        case .phonePrivateRegular: return "\u{f8be}"
        case .phoneRegular: return "\u{f8bf}"
        case .phoneReplyAllBold: return "\u{f8c0}"
        case .phoneReplyAllLight: return "\u{f8c1}"
        case .phoneReplyAllRegular: return "\u{f8c2}"
        case .phoneReplyBold: return "\u{f8c3}"
        case .phoneReplyLight: return "\u{f8c4}"
        case .phoneReplyRegular: return "\u{f8c5}"
        case .pickerBold: return "\u{f8c6}"
        case .pickerLight: return "\u{f8c7}"
        case .pickerRegular: return "\u{f8c8}"
        case .pieChartBold: return "\u{f8c9}"
        case .pieChartFilled: return "\u{f8ca}"
        case .pieChartLight: return "\u{f8cb}"
        case .pieChartRegular: return "\u{f8cc}"
        case .pinBold: return "\u{f8cd}"
        case .pinFilled: return "\u{f8ce}"
        case .pinLight: return "\u{f8cf}"
        case .pinListActivityBold: return "\u{f8d0}"
        case .pinListActivityLight: return "\u{f8d1}"
        case .pinListActivityRegular: return "\u{f8d2}"
        case .pinListBold: return "\u{f8d3}"
        case .pinListLight: return "\u{f8d4}"
        case .pinListRegular: return "\u{f8d5}"
        case .pinMutedBold: return "\u{f8d6}"
        case .pinMutedFilled: return "\u{f8d7}"
        case .pinMutedLight: return "\u{f8d8}"
        case .pinMutedRegular: return "\u{f8d9}"
        case .pinRegular: return "\u{f8da}"
        case .pipBold: return "\u{f8db}"
        case .pipEnterBold: return "\u{f8dc}"
        case .pipEnterLight: return "\u{f8dd}"
        case .pipEnterRegular: return "\u{f8de}"
        case .pipExitBold: return "\u{f8df}"
        case .pipExitLight: return "\u{f8e0}"
        case .pipExitRegular: return "\u{f8e1}"
        case .pipFilled: return "\u{f8e2}"
        case .pipLight: return "\u{f8e3}"
        case .pipRegular: return "\u{f8e4}"
        case .placeholderBold: return "\u{f8e5}"
        case .placeholderFilled: return "\u{f8e6}"
        case .placeholderLight: return "\u{f8e7}"
        case .placeholderRegular: return "\u{f8e8}"
        case .playBold: return "\u{f8e9}"
        case .playCircleBold: return "\u{f8ea}"
        case .playCircleFilled: return "\u{f8eb}"
        case .playCircleLight: return "\u{f8ec}"
        case .playCircleRegular: return "\u{f8ed}"
        case .playFilled: return "\u{f8ee}"
        case .playLight: return "\u{f8ef}"
        case .playRegular: return "\u{f8f0}"
        case .plugAcBold: return "\u{f8f1}"
        case .plugAcLight: return "\u{f8f2}"
        case .plugAcRegular: return "\u{f8f3}"
        case .plusBold: return "\u{f8f4}"
        case .plusCircleBold: return "\u{f8f5}"
        case .plusCircleFilled: return "\u{f8f6}"
        case .plusCircleLight: return "\u{f8f7}"
        case .plusCircleRegular: return "\u{f8f8}"
        case .plusLight: return "\u{f8f9}"
        case .plusRegular: return "\u{f8fa}"
        case .pmrBold: return "\u{f8fb}"
        case .pmrFilled: return "\u{f8fc}"
        case .pmrLight: return "\u{f8fd}"
        case .pmrRegular: return "\u{f8fe}"
        case .pollBold: return "\u{f8ff}"
        case .pollFilled: return "\u{f900}"
        case .pollLight: return "\u{f901}"
        case .pollRegular: return "\u{f902}"
        case .popInBold: return "\u{f903}"
        case .popInLight: return "\u{f904}"
        case .popInRegular: return "\u{f905}"
        case .popOutBold: return "\u{f906}"
        case .popOutLight: return "\u{f907}"
        case .popOutRegular: return "\u{f908}"
        case .popUpBold: return "\u{f909}"
        case .popUpLight: return "\u{f90a}"
        case .popUpRegular: return "\u{f90b}"
        case .portraitLandscapeBold: return "\u{f90c}"
        case .portraitLandscapeLight: return "\u{f90d}"
        case .portraitLandscapeRegular: return "\u{f90e}"
        case .potentialFraudBold: return "\u{f90f}"
        case .potentialFraudFilled: return "\u{f910}"
        case .potentialFraudLight: return "\u{f911}"
        case .potentialFraudRegular: return "\u{f912}"
        case .powerAcBold: return "\u{f913}"
        case .powerAcLight: return "\u{f914}"
        case .powerAcRegular: return "\u{f915}"
        case .powerBold: return "\u{f916}"
        case .powerLight: return "\u{f917}"
        case .powerRegular: return "\u{f918}"
        case .preHeaderBold: return "\u{f919}"
        case .preHeaderLight: return "\u{f91a}"
        case .preHeaderRegular: return "\u{f91b}"
        case .premiumBold: return "\u{f91c}"
        case .premiumLight: return "\u{f91d}"
        case .premiumRegular: return "\u{f91e}"
        case .presentationBold: return "\u{f91f}"
        case .presentationLight: return "\u{f920}"
        case .presentationRegular: return "\u{f921}"
        case .preventDownloadBold: return "\u{f922}"
        case .preventDownloadFilled: return "\u{f923}"
        case .preventDownloadLight: return "\u{f924}"
        case .preventDownloadRegular: return "\u{f925}"
        case .primaryParticipantBold: return "\u{f926}"
        case .primaryParticipantFilled: return "\u{f927}"
        case .primaryParticipantLight: return "\u{f928}"
        case .primaryParticipantRegular: return "\u{f929}"
        case .printBold: return "\u{f92a}"
        case .printLight: return "\u{f92b}"
        case .printRegular: return "\u{f92c}"
        case .priorityBadgeFilled: return "\u{f92d}"
        case .priorityCircleBold: return "\u{f92e}"
        case .priorityCircleFilled: return "\u{f92f}"
        case .priorityCircleLight: return "\u{f930}"
        case .priorityCircleRegular: return "\u{f931}"
        case .priorityCircleTwoBold: return "\u{f932}"
        case .priorityCircleTwoFilled: return "\u{f933}"
        case .priorityCircleTwoLight: return "\u{f934}"
        case .priorityCircleTwoRegular: return "\u{f935}"
        case .priorityWaveBold: return "\u{f936}"
        case .priorityWaveLight: return "\u{f937}"
        case .priorityWaveRegular: return "\u{f938}"
        case .privacyCircleBold: return "\u{f939}"
        case .privacyCircleFilled: return "\u{f93a}"
        case .privacyCircleLight: return "\u{f93b}"
        case .privacyCircleRegular: return "\u{f93c}"
        case .privateBold: return "\u{f93d}"
        case .privateCircleBold: return "\u{f93e}"
        case .privateCircleFilled: return "\u{f93f}"
        case .privateCircleLight: return "\u{f940}"
        case .privateCircleRegular: return "\u{f941}"
        case .privateLight: return "\u{f942}"
        case .privateMeetingBold: return "\u{f943}"
        case .privateMeetingLight: return "\u{f944}"
        case .privateMeetingRegular: return "\u{f945}"
        case .privateRegular: return "\u{f946}"
        case .productDemoBold: return "\u{f947}"
        case .productDemoLight: return "\u{f948}"
        case .productDemoRegular: return "\u{f949}"
        case .promptsAiBold: return "\u{f94a}"
        case .promptsAiLight: return "\u{f94b}"
        case .promptsAiRegular: return "\u{f94c}"
        case .proximityBold: return "\u{f94d}"
        case .proximityLight: return "\u{f94e}"
        case .proximityMutedBold: return "\u{f94f}"
        case .proximityMutedLight: return "\u{f950}"
        case .proximityMutedRegular: return "\u{f951}"
        case .proximityRegular: return "\u{f952}"
        case .proximityVideoBold: return "\u{f953}"
        case .proximityVideoLight: return "\u{f954}"
        case .proximityVideoRegular: return "\u{f955}"
        case .ptoPresenceBold: return "\u{f956}"
        case .ptoPresenceFilled: return "\u{f957}"
        case .ptoPresenceLight: return "\u{f958}"
        case .ptoPresenceRegular: return "\u{f959}"
        case .pullCallBold: return "\u{f95a}"
        case .pullCallFilled: return "\u{f95b}"
        case .pullCallLight: return "\u{f95c}"
        case .pullCallRegular: return "\u{f95d}"
        case .qABold: return "\u{f95e}"
        case .qAFilled: return "\u{f95f}"
        case .qALight: return "\u{f960}"
        case .qARegular: return "\u{f961}"
        case .qrCodeBold: return "\u{f962}"
        case .qrCodeLight: return "\u{f963}"
        case .qrCodeRegular: return "\u{f964}"
        case .qrCodeScanBold: return "\u{f965}"
        case .qrCodeScanLight: return "\u{f966}"
        case .qrCodeScanRegular: return "\u{f967}"
        case .qualityBold: return "\u{f968}"
        case .qualityLight: return "\u{f969}"
        case .qualityRegular: return "\u{f96a}"
        case .queueContactBold: return "\u{f96b}"
        case .queueContactFilled: return "\u{f96c}"
        case .queueContactLight: return "\u{f96d}"
        case .queueContactRegular: return "\u{f96e}"
        case .queuedInteractionBold: return "\u{f96f}"
        case .queuedInteractionFilled: return "\u{f970}"
        case .queuedInteractionLight: return "\u{f971}"
        case .queuedInteractionRegular: return "\u{f972}"
        case .quietBold: return "\u{f973}"
        case .quietHoursPresenceBold: return "\u{f974}"
        case .quietHoursPresenceFilled: return "\u{f975}"
        case .quietHoursPresenceLight: return "\u{f976}"
        case .quietHoursPresenceRegular: return "\u{f977}"
        case .quietLight: return "\u{f978}"
        case .quietRegular: return "\u{f979}"
        case .radioButtonGroupBold: return "\u{f97a}"
        case .radioButtonGroupLight: return "\u{f97b}"
        case .radioButtonGroupRegular: return "\u{f97c}"
        case .raiseHandBold: return "\u{f97d}"
        case .raiseHandCircleFilled: return "\u{f97e}"
        case .raiseHandFilled: return "\u{f97f}"
        case .raiseHandLight: return "\u{f980}"
        case .raiseHandRegular: return "\u{f981}"
        case .ramBold: return "\u{f982}"
        case .ramLight: return "\u{f983}"
        case .ramRegular: return "\u{f984}"
        case .reactionsBold: return "\u{f985}"
        case .reactionsFilled: return "\u{f986}"
        case .reactionsLight: return "\u{f987}"
        case .reactionsRegular: return "\u{f988}"
        case .reactivateBold: return "\u{f989}"
        case .reactivateLight: return "\u{f98a}"
        case .reactivateRegular: return "\u{f98b}"
        case .receiveVoiceBold: return "\u{f98c}"
        case .receiveVoiceFilled: return "\u{f98d}"
        case .receiveVoiceLight: return "\u{f98e}"
        case .receiveVoiceRegular: return "\u{f98f}"
        case .recentsBold: return "\u{f990}"
        case .recentsFilled: return "\u{f991}"
        case .recentsLight: return "\u{f992}"
        case .recentsPresenceBadgeFilled: return "\u{f993}"
        case .recentsPresenceBold: return "\u{f994}"
        case .recentsPresenceFilled: return "\u{f995}"
        case .recentsPresenceLight: return "\u{f996}"
        case .recentsPresenceRegular: return "\u{f997}"
        case .recentsRegular: return "\u{f998}"
        case .recordActiveBadgeFilled: return "\u{f999}"
        case .recordActiveBold: return "\u{f99a}"
        case .recordActiveFilled: return "\u{f99b}"
        case .recordActiveLight: return "\u{f99c}"
        case .recordActiveRegular: return "\u{f99d}"
        case .recordBold: return "\u{f99e}"
        case .recordFilled: return "\u{f99f}"
        case .recordLight: return "\u{f9a0}"
        case .recordPausedBadgeFilled: return "\u{f9a1}"
        case .recordPausedBold: return "\u{f9a2}"
        case .recordPausedFilled: return "\u{f9a3}"
        case .recordPausedLight: return "\u{f9a4}"
        case .recordPausedRegular: return "\u{f9a5}"
        case .recordRegular: return "\u{f9a6}"
        case .recurringBold: return "\u{f9a7}"
        case .recurringLight: return "\u{f9a8}"
        case .recurringOffBold: return "\u{f9a9}"
        case .recurringOffLight: return "\u{f9aa}"
        case .recurringOffRegular: return "\u{f9ab}"
        case .recurringRegular: return "\u{f9ac}"
        case .redoBold: return "\u{f9ad}"
        case .redoLight: return "\u{f9ae}"
        case .redoRegular: return "\u{f9af}"
        case .refreshBold: return "\u{f9b0}"
        case .refreshLight: return "\u{f9b1}"
        case .refreshRegular: return "\u{f9b2}"
        case .remoteDesktopControlBold: return "\u{f9b3}"
        case .remoteDesktopControlFilled: return "\u{f9b4}"
        case .remoteDesktopControlLight: return "\u{f9b5}"
        case .remoteDesktopControlRegular: return "\u{f9b6}"
        case .removeBold: return "\u{f9b7}"
        case .removeFilled: return "\u{f9b8}"
        case .removeLight: return "\u{f9b9}"
        case .removeRegular: return "\u{f9ba}"
        case .replyBold: return "\u{f9bb}"
        case .replyFilled: return "\u{f9bc}"
        case .replyLight: return "\u{f9bd}"
        case .replyListBold: return "\u{f9be}"
        case .replyListFilled: return "\u{f9bf}"
        case .replyListLight: return "\u{f9c0}"
        case .replyListRegular: return "\u{f9c1}"
        case .replyPrivatelyBold: return "\u{f9c2}"
        case .replyPrivatelyLight: return "\u{f9c3}"
        case .replyPrivatelyRegular: return "\u{f9c4}"
        case .replyRegular: return "\u{f9c5}"
        case .resetBold: return "\u{f9c6}"
        case .resetLight: return "\u{f9c7}"
        case .resetRegular: return "\u{f9c8}"
        case .resizeCornerBold: return "\u{f9c9}"
        case .resizeCornerLight: return "\u{f9ca}"
        case .resizeCornerRegular: return "\u{f9cb}"
        case .responsiveMobileBold: return "\u{f9cc}"
        case .responsiveMobileLight: return "\u{f9cd}"
        case .responsiveMobileRegular: return "\u{f9ce}"
        case .restartBold: return "\u{f9cf}"
        case .restartLight: return "\u{f9d0}"
        case .restartRegular: return "\u{f9d1}"
        case .resumeInteractionBold: return "\u{f9d2}"
        case .resumeInteractionFilled: return "\u{f9d3}"
        case .resumeInteractionLight: return "\u{f9d4}"
        case .resumeInteractionRegular: return "\u{f9d5}"
        case .retrieveCallBold: return "\u{f9d6}"
        case .retrieveCallFilled: return "\u{f9d7}"
        case .retrieveCallLight: return "\u{f9d8}"
        case .retrieveCallRegular: return "\u{f9d9}"
        case .returnBold: return "\u{f9da}"
        case .returnLight: return "\u{f9db}"
        case .returnRegular: return "\u{f9dc}"
        case .rewindTenSecBold: return "\u{f9dd}"
        case .rewindTenSecLight: return "\u{f9de}"
        case .rewindTenSecRegular: return "\u{f9df}"
        case .ringtoneBold: return "\u{f9e0}"
        case .ringtoneLight: return "\u{f9e1}"
        case .ringtoneRegular: return "\u{f9e2}"
        case .roomCalendarBold: return "\u{f9e3}"
        case .roomCalendarLight: return "\u{f9e4}"
        case .roomCalendarRegular: return "\u{f9e5}"
        case .roomLightsBold: return "\u{f9e6}"
        case .roomLightsFilled: return "\u{f9e7}"
        case .roomLightsLight: return "\u{f9e8}"
        case .roomLightsRegular: return "\u{f9e9}"
        case .rotateContentBold: return "\u{f9ea}"
        case .rotateContentFilled: return "\u{f9eb}"
        case .rotateContentLight: return "\u{f9ec}"
        case .rotateContentRegular: return "\u{f9ed}"
        case .rssBold: return "\u{f9ee}"
        case .rssFilled: return "\u{f9ef}"
        case .rssLight: return "\u{f9f0}"
        case .rssRegular: return "\u{f9f1}"
        case .ruleBasedBold: return "\u{f9f2}"
        case .ruleBasedLight: return "\u{f9f3}"
        case .ruleBasedRegular: return "\u{f9f4}"
        case .rulerBold: return "\u{f9f5}"
        case .rulerFilled: return "\u{f9f6}"
        case .rulerLight: return "\u{f9f7}"
        case .rulerRegular: return "\u{f9f8}"
        case .runningApplicationBold: return "\u{f9f9}"
        case .runningApplicationFilled: return "\u{f9fa}"
        case .runningApplicationLight: return "\u{f9fb}"
        case .runningApplicationRegular: return "\u{f9fc}"
        case .saveBold: return "\u{f9fd}"
        case .saveLight: return "\u{f9fe}"
        case .saveRegular: return "\u{f9ff}"
        case .saveTranscriptBold: return "\u{fa00}"
        case .saveTranscriptFilled: return "\u{fa01}"
        case .saveTranscriptLight: return "\u{fa02}"
        case .saveTranscriptRegular: return "\u{fa03}"
        case .scanBold: return "\u{fa04}"
        case .scanLight: return "\u{fa05}"
        case .scanRegular: return "\u{fa06}"
        case .scheduleAiBold: return "\u{fa07}"
        case .scheduleAiLight: return "\u{fa08}"
        case .scheduleAiRegular: return "\u{fa09}"
        case .scheduleSendBold: return "\u{fa0a}"
        case .scheduleSendFilled: return "\u{fa0b}"
        case .scheduleSendLight: return "\u{fa0c}"
        case .scheduleSendRegular: return "\u{fa0d}"
        case .scheduleWinnerBold: return "\u{fa0e}"
        case .scheduleWinnerFilled: return "\u{fa0f}"
        case .scheduleWinnerLight: return "\u{fa10}"
        case .scheduleWinnerRegular: return "\u{fa11}"
        case .schedulerAvailableBold: return "\u{fa12}"
        case .schedulerAvailableLight: return "\u{fa13}"
        case .schedulerAvailableRegular: return "\u{fa14}"
        case .schedulerNotWorkingHoursBold: return "\u{fa15}"
        case .schedulerNotWorkingHoursLight: return "\u{fa16}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa17}"
        case .schedulerUnavailableBold: return "\u{fa18}"
        case .schedulerUnavailableLight: return "\u{fa19}"
        case .schedulerUnavailableRegular: return "\u{fa1a}"
        case .schedulerUnknownBold: return "\u{fa1b}"
        case .schedulerUnknownLight: return "\u{fa1c}"
        case .schedulerUnknownRegular: return "\u{fa1d}"
        case .screenshotBold: return "\u{fa1e}"
        case .screenshotDocBold: return "\u{fa1f}"
        case .screenshotDocFilled: return "\u{fa20}"
        case .screenshotDocLight: return "\u{fa21}"
        case .screenshotDocRegular: return "\u{fa22}"
        case .screenshotLight: return "\u{fa23}"
        case .screenshotRegular: return "\u{fa24}"
        case .searchAiBold: return "\u{fa25}"
        case .searchAiLight: return "\u{fa26}"
        case .searchAiRegular: return "\u{fa27}"
        case .searchBold: return "\u{fa28}"
        case .searchFilled: return "\u{fa29}"
        case .searchLight: return "\u{fa2a}"
        case .searchRegular: return "\u{fa2b}"
        case .secondaryArrowBold: return "\u{fa2c}"
        case .secondaryArrowLight: return "\u{fa2d}"
        case .secondaryArrowRegular: return "\u{fa2e}"
        case .secureCallLockBold: return "\u{fa2f}"
        case .secureCallLockFilled: return "\u{fa30}"
        case .secureCallLockLight: return "\u{fa31}"
        case .secureCallLockRegular: return "\u{fa32}"
        case .secureCallShieldBold: return "\u{fa33}"
        case .secureCallShieldFilled: return "\u{fa34}"
        case .secureCallShieldLight: return "\u{fa35}"
        case .secureCallShieldRegular: return "\u{fa36}"
        case .secureCircleBold: return "\u{fa37}"
        case .secureCircleFilled: return "\u{fa38}"
        case .secureCircleLight: return "\u{fa39}"
        case .secureCircleRegular: return "\u{fa3a}"
        case .secureLockBold: return "\u{fa3b}"
        case .secureLockFilled: return "\u{fa3c}"
        case .secureLockLight: return "\u{fa3d}"
        case .secureLockRegular: return "\u{fa3e}"
        case .segmentExcludeFilled: return "\u{fa3f}"
        case .segmentFilterFilled: return "\u{fa40}"
        case .segmentIncludeFilled: return "\u{fa41}"
        case .selectAllBold: return "\u{fa42}"
        case .selectAllFilled: return "\u{fa43}"
        case .selectAllLight: return "\u{fa44}"
        case .selectAllRegular: return "\u{fa45}"
        case .selectionBold: return "\u{fa46}"
        case .selectionFilled: return "\u{fa47}"
        case .selectionLight: return "\u{fa48}"
        case .selectionRegular: return "\u{fa49}"
        case .sendBold: return "\u{fa4a}"
        case .sendDigitsBold: return "\u{fa4b}"
        case .sendDigitsFilled: return "\u{fa4c}"
        case .sendDigitsLight: return "\u{fa4d}"
        case .sendDigitsRegular: return "\u{fa4e}"
        case .sendFilled: return "\u{fa4f}"
        case .sendLight: return "\u{fa50}"
        case .sendRegular: return "\u{fa51}"
        case .sendVoiceBold: return "\u{fa52}"
        case .sendVoiceFilled: return "\u{fa53}"
        case .sendVoiceLight: return "\u{fa54}"
        case .sendVoiceRegular: return "\u{fa55}"
        case .serverBold: return "\u{fa56}"
        case .serverErrorBold: return "\u{fa57}"
        case .serverErrorLight: return "\u{fa58}"
        case .serverErrorRegular: return "\u{fa59}"
        case .serverLight: return "\u{fa5a}"
        case .serverRegular: return "\u{fa5b}"
        case .servicesBold: return "\u{fa5c}"
        case .servicesLight: return "\u{fa5d}"
        case .servicesRegular: return "\u{fa5e}"
        case .setVariableBold: return "\u{fa5f}"
        case .setVariableLight: return "\u{fa60}"
        case .setVariableRegular: return "\u{fa61}"
        case .settingsBold: return "\u{fa62}"
        case .settingsFilled: return "\u{fa63}"
        case .settingsLight: return "\u{fa64}"
        case .settingsRegular: return "\u{fa65}"
        case .setupAssistantBold: return "\u{fa66}"
        case .setupAssistantLight: return "\u{fa67}"
        case .setupAssistantRegular: return "\u{fa68}"
        case .sftpBold: return "\u{fa69}"
        case .sftpLight: return "\u{fa6a}"
        case .sftpRegular: return "\u{fa6b}"
        case .shapeCircleBold: return "\u{fa6c}"
        case .shapeCircleFilled: return "\u{fa6d}"
        case .shapeCircleLight: return "\u{fa6e}"
        case .shapeCircleMdFilled: return "\u{fa6f}"
        case .shapeCircleRegular: return "\u{fa70}"
        case .shapeCircleSmFilled: return "\u{fa71}"
        case .shapeDiagonalLineBold: return "\u{fa72}"
        case .shapeDiagonalLineLight: return "\u{fa73}"
        case .shapeDiagonalLineRegular: return "\u{fa74}"
        case .shapeDiamondBold: return "\u{fa75}"
        case .shapeDiamondFilled: return "\u{fa76}"
        case .shapeDiamondLight: return "\u{fa77}"
        case .shapeDiamondRegular: return "\u{fa78}"
        case .shapeOvalBold: return "\u{fa79}"
        case .shapeOvalLight: return "\u{fa7a}"
        case .shapeOvalRegular: return "\u{fa7b}"
        case .shapeSquareBold: return "\u{fa7c}"
        case .shapeSquareFilled: return "\u{fa7d}"
        case .shapeSquareLight: return "\u{fa7e}"
        case .shapeSquareRegular: return "\u{fa7f}"
        case .shapeTriangleBold: return "\u{fa80}"
        case .shapeTriangleFilled: return "\u{fa81}"
        case .shapeTriangleLight: return "\u{fa82}"
        case .shapeTriangleRegular: return "\u{fa83}"
        case .shapesBold: return "\u{fa84}"
        case .shapesFilled: return "\u{fa85}"
        case .shapesLight: return "\u{fa86}"
        case .shapesRegular: return "\u{fa87}"
        case .shareCNativeAdrBold: return "\u{fa88}"
        case .shareCNativeAdrFilled: return "\u{fa89}"
        case .shareCNativeAdrLight: return "\u{fa8a}"
        case .shareCNativeAdrRegular: return "\u{fa8b}"
        case .shareCNativeIphBold: return "\u{fa8c}"
        case .shareCNativeIphLight: return "\u{fa8d}"
        case .shareCNativeIphRegular: return "\u{fa8e}"
        case .shareContentOnDeviceBold: return "\u{fa8f}"
        case .shareContentOnDeviceLight: return "\u{fa90}"
        case .shareContentOnDeviceRegular: return "\u{fa91}"
        case .shareScreenAddBold: return "\u{fa92}"
        case .shareScreenAddLight: return "\u{fa93}"
        case .shareScreenAddRegular: return "\u{fa94}"
        case .shareScreenBadgeFilled: return "\u{fa95}"
        case .shareScreenBold: return "\u{fa96}"
        case .shareScreenFilled: return "\u{fa97}"
        case .shareScreenLight: return "\u{fa98}"
        case .shareScreenRegular: return "\u{fa99}"
        case .shareSpaceBold: return "\u{fa9a}"
        case .shareSpaceLight: return "\u{fa9b}"
        case .shareSpaceRegular: return "\u{fa9c}"
        case .shieldBold: return "\u{fa9d}"
        case .shieldLight: return "\u{fa9e}"
        case .shieldRegular: return "\u{fa9f}"
        case .shoppingCartBold: return "\u{faa0}"
        case .shoppingCartFilled: return "\u{faa1}"
        case .shoppingCartLight: return "\u{faa2}"
        case .shoppingCartRegular: return "\u{faa3}"
        case .shortTextBoxBold: return "\u{faa4}"
        case .shortTextBoxLight: return "\u{faa5}"
        case .shortTextBoxRegular: return "\u{faa6}"
        case .showBold: return "\u{faa7}"
        case .showFilled: return "\u{faa8}"
        case .showLight: return "\u{faa9}"
        case .showRegular: return "\u{faaa}"
        case .sidePanelBold: return "\u{faab}"
        case .sidePanelFilled: return "\u{faac}"
        case .sidePanelLight: return "\u{faad}"
        case .sidePanelRegular: return "\u{faae}"
        case .signInBold: return "\u{faaf}"
        case .signInFilled: return "\u{fab0}"
        case .signInForcedBold: return "\u{fab1}"
        case .signInForcedLight: return "\u{fab2}"
        case .signInForcedRegular: return "\u{fab3}"
        case .signInLight: return "\u{fab4}"
        case .signInRegular: return "\u{fab5}"
        case .signLangIntBold: return "\u{fab6}"
        case .signLangIntLight: return "\u{fab7}"
        case .signLangIntRegular: return "\u{fab8}"
        case .signOutBold: return "\u{fab9}"
        case .signOutLight: return "\u{faba}"
        case .signOutRegular: return "\u{fabb}"
        case .signalFourBold: return "\u{fabc}"
        case .signalFourLight: return "\u{fabd}"
        case .signalFourRegular: return "\u{fabe}"
        case .signalOneBold: return "\u{fabf}"
        case .signalOneLight: return "\u{fac0}"
        case .signalOneRegular: return "\u{fac1}"
        case .signalThreeBold: return "\u{fac2}"
        case .signalThreeLight: return "\u{fac3}"
        case .signalThreeRegular: return "\u{fac4}"
        case .signalTwoBold: return "\u{fac5}"
        case .signalTwoLight: return "\u{fac6}"
        case .signalTwoRegular: return "\u{fac7}"
        case .signalZeroBold: return "\u{fac8}"
        case .signalZeroLight: return "\u{fac9}"
        case .signalZeroRegular: return "\u{faca}"
        case .simplePromotionBold: return "\u{facb}"
        case .simplePromotionLight: return "\u{facc}"
        case .simplePromotionRegular: return "\u{facd}"
        case .singleNumberReachBold: return "\u{face}"
        case .singleNumberReachLight: return "\u{facf}"
        case .singleNumberReachRegular: return "\u{fad0}"
        case .sipRegistrationInProgressBold: return "\u{fad1}"
        case .sipRegistrationInProgressFilled: return "\u{fad2}"
        case .sipRegistrationInProgressLight: return "\u{fad3}"
        case .sipRegistrationInProgressRegular: return "\u{fad4}"
        case .skipBold: return "\u{fad5}"
        case .skipBwBold: return "\u{fad6}"
        case .skipBwFilled: return "\u{fad7}"
        case .skipBwLight: return "\u{fad8}"
        case .skipBwRegular: return "\u{fad9}"
        case .skipFwBold: return "\u{fada}"
        case .skipFwFilled: return "\u{fadb}"
        case .skipFwLight: return "\u{fadc}"
        case .skipFwRegular: return "\u{fadd}"
        case .skipLight: return "\u{fade}"
        case .skipRegular: return "\u{fadf}"
        case .smartAudioBold: return "\u{fae0}"
        case .smartAudioLight: return "\u{fae1}"
        case .smartAudioRegular: return "\u{fae2}"
        case .smsFilled: return "\u{fae3}"
        case .smsInboundBold: return "\u{fae4}"
        case .smsInboundLight: return "\u{fae5}"
        case .smsInboundRegular: return "\u{fae6}"
        case .smsMessageBold: return "\u{fae7}"
        case .smsMessageFilled: return "\u{fae8}"
        case .smsMessageLight: return "\u{fae9}"
        case .smsMessageRegular: return "\u{faea}"
        case .smsOutgoingFilled: return "\u{faeb}"
        case .smsUnreadBold: return "\u{faec}"
        case .smsUnreadLight: return "\u{faed}"
        case .smsUnreadRegular: return "\u{faee}"
        case .sortAscendingBold: return "\u{faef}"
        case .sortAscendingLight: return "\u{faf0}"
        case .sortAscendingRegular: return "\u{faf1}"
        case .sortDescendingBold: return "\u{faf2}"
        case .sortDescendingLight: return "\u{faf3}"
        case .sortDescendingRegular: return "\u{faf4}"
        case .soundDefaultBold: return "\u{faf5}"
        case .soundDefaultLight: return "\u{faf6}"
        case .soundDefaultRegular: return "\u{faf7}"
        case .sparkleBold: return "\u{faf8}"
        case .sparkleFilled: return "\u{faf9}"
        case .sparkleLight: return "\u{fafa}"
        case .sparkleRegular: return "\u{fafb}"
        case .speakerBold: return "\u{fafc}"
        case .speakerDisconnectedBold: return "\u{fafd}"
        case .speakerDisconnectedFilled: return "\u{fafe}"
        case .speakerDisconnectedLight: return "\u{faff}"
        case .speakerDisconnectedRegular: return "\u{fb00}"
        case .speakerFilled: return "\u{fb01}"
        case .speakerLight: return "\u{fb02}"
        case .speakerMutedBold: return "\u{fb03}"
        case .speakerMutedFilled: return "\u{fb04}"
        case .speakerMutedLight: return "\u{fb05}"
        case .speakerMutedRegular: return "\u{fb06}"
        case .speakerOffBold: return "\u{fb07}"
        case .speakerOffFilled: return "\u{fb08}"
        case .speakerOffLight: return "\u{fb09}"
        case .speakerOffRegular: return "\u{fb0a}"
        case .speakerOnBold: return "\u{fb0b}"
        case .speakerOnLight: return "\u{fb0c}"
        case .speakerOnRegular: return "\u{fb0d}"
        case .speakerRegular: return "\u{fb0e}"
        case .speakerTurnDownBold: return "\u{fb0f}"
        case .speakerTurnDownFilled: return "\u{fb10}"
        case .speakerTurnDownLight: return "\u{fb11}"
        case .speakerTurnDownRegular: return "\u{fb12}"
        case .speakerTurnUpBold: return "\u{fb13}"
        case .speakerTurnUpFilled: return "\u{fb14}"
        case .speakerTurnUpLight: return "\u{fb15}"
        case .speakerTurnUpRegular: return "\u{fb16}"
        case .speedDialBold: return "\u{fb17}"
        case .speedDialFilled: return "\u{fb18}"
        case .speedDialLight: return "\u{fb19}"
        case .speedDialRegular: return "\u{fb1a}"
        case .spellCheckerBold: return "\u{fb1b}"
        case .spellCheckerLight: return "\u{fb1c}"
        case .spellCheckerRegular: return "\u{fb1d}"
        case .splitViewBold: return "\u{fb1e}"
        case .splitViewLight: return "\u{fb1f}"
        case .splitViewRegular: return "\u{fb20}"
        case .stackedAreaChartBold: return "\u{fb21}"
        case .stackedAreaChartFilled: return "\u{fb22}"
        case .stackedAreaChartFullBold: return "\u{fb23}"
        case .stackedAreaChartFullFilled: return "\u{fb24}"
        case .stackedAreaChartFullLight: return "\u{fb25}"
        case .stackedAreaChartFullRegular: return "\u{fb26}"
        case .stackedAreaChartLight: return "\u{fb27}"
        case .stackedAreaChartRegular: return "\u{fb28}"
        case .stackedBarChartBold: return "\u{fb29}"
        case .stackedBarChartFilled: return "\u{fb2a}"
        case .stackedBarChartFullBold: return "\u{fb2b}"
        case .stackedBarChartFullFilled: return "\u{fb2c}"
        case .stackedBarChartFullLight: return "\u{fb2d}"
        case .stackedBarChartFullRegular: return "\u{fb2e}"
        case .stackedBarChartLight: return "\u{fb2f}"
        case .stackedBarChartRegular: return "\u{fb30}"
        case .startChatBold: return "\u{fb31}"
        case .startChatLight: return "\u{fb32}"
        case .startChatRegular: return "\u{fb33}"
        case .stethoscopeBold: return "\u{fb34}"
        case .stethoscopeLight: return "\u{fb35}"
        case .stethoscopeRegular: return "\u{fb36}"
        case .stickersBold: return "\u{fb37}"
        case .stickersLight: return "\u{fb38}"
        case .stickersRegular: return "\u{fb39}"
        case .stickiesBold: return "\u{fb3a}"
        case .stickiesLight: return "\u{fb3b}"
        case .stickiesRegular: return "\u{fb3c}"
        case .stopBold: return "\u{fb3d}"
        case .stopCircleBold: return "\u{fb3e}"
        case .stopCircleFilled: return "\u{fb3f}"
        case .stopCircleLight: return "\u{fb40}"
        case .stopCircleRegular: return "\u{fb41}"
        case .stopContentShareBold: return "\u{fb42}"
        case .stopContentShareLight: return "\u{fb43}"
        case .stopContentShareRegular: return "\u{fb44}"
        case .stopFilled: return "\u{fb45}"
        case .stopLight: return "\u{fb46}"
        case .stopRegular: return "\u{fb47}"
        case .storedInfoBold: return "\u{fb48}"
        case .storedInfoFilled: return "\u{fb49}"
        case .storedInfoLight: return "\u{fb4a}"
        case .storedInfoRegular: return "\u{fb4b}"
        case .streamingBold: return "\u{fb4c}"
        case .streamingLight: return "\u{fb4d}"
        case .streamingRegular: return "\u{fb4e}"
        case .strikethroughBold: return "\u{fb4f}"
        case .strikethroughFilled: return "\u{fb50}"
        case .strikethroughLight: return "\u{fb51}"
        case .strikethroughRegular: return "\u{fb52}"
        case .studioModeBold: return "\u{fb53}"
        case .studioModeLight: return "\u{fb54}"
        case .studioModeRegular: return "\u{fb55}"
        case .subscriptBold: return "\u{fb56}"
        case .subscriptLight: return "\u{fb57}"
        case .subscriptRegular: return "\u{fb58}"
        case .summarizeAiBold: return "\u{fb59}"
        case .summarizeAiLight: return "\u{fb5a}"
        case .summarizeAiRegular: return "\u{fb5b}"
        case .superscriptBold: return "\u{fb5c}"
        case .superscriptLight: return "\u{fb5d}"
        case .superscriptRegular: return "\u{fb5e}"
        case .surveyBold: return "\u{fb5f}"
        case .surveyFilled: return "\u{fb60}"
        case .surveyLight: return "\u{fb61}"
        case .surveyRegular: return "\u{fb62}"
        case .sxEightyCodecBold: return "\u{fb63}"
        case .sxEightyCodecLight: return "\u{fb64}"
        case .sxEightyCodecRegular: return "\u{fb65}"
        case .sxTenBold: return "\u{fb66}"
        case .sxTenLight: return "\u{fb67}"
        case .sxTenRegular: return "\u{fb68}"
        case .sxTwentyBold: return "\u{fb69}"
        case .sxTwentyLight: return "\u{fb6a}"
        case .sxTwentyRegular: return "\u{fb6b}"
        case .tableBold: return "\u{fb6c}"
        case .tableExtenderBold: return "\u{fb6d}"
        case .tableExtenderFilled: return "\u{fb6e}"
        case .tableExtenderLight: return "\u{fb6f}"
        case .tableExtenderRegular: return "\u{fb70}"
        case .tableLight: return "\u{fb71}"
        case .tableRegular: return "\u{fb72}"
        case .tabletBold: return "\u{fb73}"
        case .tabletLight: return "\u{fb74}"
        case .tabletRegular: return "\u{fb75}"
        case .tabsBold: return "\u{fb76}"
        case .tabsLight: return "\u{fb77}"
        case .tabsRegular: return "\u{fb78}"
        case .tagBold: return "\u{fb79}"
        case .tagLight: return "\u{fb7a}"
        case .tagRegular: return "\u{fb7b}"
        case .tapBold: return "\u{fb7c}"
        case .tapFilled: return "\u{fb7d}"
        case .tapLight: return "\u{fb7e}"
        case .tapRegular: return "\u{fb7f}"
        case .telepresenceAlertBold: return "\u{fb80}"
        case .telepresenceAlertLight: return "\u{fb81}"
        case .telepresenceAlertMutedBold: return "\u{fb82}"
        case .telepresenceAlertMutedLight: return "\u{fb83}"
        case .telepresenceAlertMutedRegular: return "\u{fb84}"
        case .telepresenceAlertRegular: return "\u{fb85}"
        case .telepresenceBold: return "\u{fb86}"
        case .telepresenceIxFiveThousandBold: return "\u{fb87}"
        case .telepresenceIxFiveThousandLight: return "\u{fb88}"
        case .telepresenceIxFiveThousandRegular: return "\u{fb89}"
        case .telepresenceLight: return "\u{fb8a}"
        case .telepresenceMutedBold: return "\u{fb8b}"
        case .telepresenceMutedLight: return "\u{fb8c}"
        case .telepresenceMutedRegular: return "\u{fb8d}"
        case .telepresencePrivateBold: return "\u{fb8e}"
        case .telepresencePrivateLight: return "\u{fb8f}"
        case .telepresencePrivateRegular: return "\u{fb90}"
        case .telepresenceRegular: return "\u{fb91}"
        case .temperatureBold: return "\u{fb92}"
        case .temperatureLight: return "\u{fb93}"
        case .temperatureRegular: return "\u{fb94}"
        case .testTubeBold: return "\u{fb95}"
        case .testTubeFilled: return "\u{fb96}"
        case .testTubeLight: return "\u{fb97}"
        case .testTubeRegular: return "\u{fb98}"
        case .textAlignCenterBold: return "\u{fb99}"
        case .textAlignCenterFilled: return "\u{fb9a}"
        case .textAlignCenterLight: return "\u{fb9b}"
        case .textAlignCenterRegular: return "\u{fb9c}"
        case .textAlignLeftBold: return "\u{fb9d}"
        case .textAlignLeftFilled: return "\u{fb9e}"
        case .textAlignLeftLight: return "\u{fb9f}"
        case .textAlignLeftRegular: return "\u{fba0}"
        case .textAlignRightBold: return "\u{fba1}"
        case .textAlignRightFilled: return "\u{fba2}"
        case .textAlignRightLight: return "\u{fba3}"
        case .textAlignRightRegular: return "\u{fba4}"
        case .textBold: return "\u{fba5}"
        case .textBoxCursorLight: return "\u{fba6}"
        case .textCodeBlockBold: return "\u{fba7}"
        case .textCodeBlockLight: return "\u{fba8}"
        case .textCodeBlockRegular: return "\u{fba9}"
        case .textHighlightBold: return "\u{fbaa}"
        case .textHighlightFilled: return "\u{fbab}"
        case .textHighlightLight: return "\u{fbac}"
        case .textHighlightRegular: return "\u{fbad}"
        case .textLight: return "\u{fbae}"
        case .textRegular: return "\u{fbaf}"
        case .threeColumnBold: return "\u{fbb0}"
        case .threeColumnLight: return "\u{fbb1}"
        case .threeColumnRegular: return "\u{fbb2}"
        case .threeDObjectBold: return "\u{fbb3}"
        case .threeDObjectLight: return "\u{fbb4}"
        case .threeDObjectRegular: return "\u{fbb5}"
        case .timeExclusionBold: return "\u{fbb6}"
        case .timeExclusionLight: return "\u{fbb7}"
        case .timeExclusionRegular: return "\u{fbb8}"
        case .timezoneBold: return "\u{fbb9}"
        case .timezoneFilled: return "\u{fbba}"
        case .timezoneLight: return "\u{fbbb}"
        case .timezoneRegular: return "\u{fbbc}"
        case .tooFastBold: return "\u{fbbd}"
        case .tooFastLight: return "\u{fbbe}"
        case .tooFastRegular: return "\u{fbbf}"
        case .tooSlowBold: return "\u{fbc0}"
        case .tooSlowLight: return "\u{fbc1}"
        case .tooSlowRegular: return "\u{fbc2}"
        case .toolsBold: return "\u{fbc3}"
        case .toolsFilled: return "\u{fbc4}"
        case .toolsLight: return "\u{fbc5}"
        case .toolsRegular: return "\u{fbc6}"
        case .touchTenBold: return "\u{fbc7}"
        case .touchTenLight: return "\u{fbc8}"
        case .touchTenRegular: return "\u{fbc9}"
        case .transcriptBold: return "\u{fbca}"
        case .transcriptFilled: return "\u{fbcb}"
        case .transcriptLight: return "\u{fbcc}"
        case .transcriptRegular: return "\u{fbcd}"
        case .translateBold: return "\u{fbce}"
        case .translateLight: return "\u{fbcf}"
        case .translateRegular: return "\u{fbd0}"
        case .translateUndoBold: return "\u{fbd1}"
        case .translateUndoLight: return "\u{fbd2}"
        case .translateUndoRegular: return "\u{fbd3}"
        case .trendingBold: return "\u{fbd4}"
        case .trendingDownBold: return "\u{fbd5}"
        case .trendingDownFilled: return "\u{fbd6}"
        case .trendingDownLight: return "\u{fbd7}"
        case .trendingDownRegular: return "\u{fbd8}"
        case .trendingFilled: return "\u{fbd9}"
        case .trendingLight: return "\u{fbda}"
        case .trendingRegular: return "\u{fbdb}"
        case .trimBold: return "\u{fbdc}"
        case .trimLight: return "\u{fbdd}"
        case .trimRegular: return "\u{fbde}"
        case .twoColumnBold: return "\u{fbdf}"
        case .twoColumnLight: return "\u{fbe0}"
        case .twoColumnRegular: return "\u{fbe1}"
        case .twoWayVoiceStreamBold: return "\u{fbe2}"
        case .twoWayVoiceStreamFilled: return "\u{fbe3}"
        case .twoWayVoiceStreamLight: return "\u{fbe4}"
        case .twoWayVoiceStreamRegular: return "\u{fbe5}"
        case .ucmCloudBold: return "\u{fbe6}"
        case .ucmCloudLight: return "\u{fbe7}"
        case .ucmCloudRegular: return "\u{fbe8}"
        case .unblockBold: return "\u{fbe9}"
        case .unblockFilled: return "\u{fbea}"
        case .unblockLight: return "\u{fbeb}"
        case .unblockRegular: return "\u{fbec}"
        case .underlineBold: return "\u{fbed}"
        case .underlineFilled: return "\u{fbee}"
        case .underlineLight: return "\u{fbef}"
        case .underlineRegular: return "\u{fbf0}"
        case .undoBold: return "\u{fbf1}"
        case .undoLight: return "\u{fbf2}"
        case .undoRegular: return "\u{fbf3}"
        case .unlinkBold: return "\u{fbf4}"
        case .unlinkLight: return "\u{fbf5}"
        case .unlinkRegular: return "\u{fbf6}"
        case .unreadBold: return "\u{fbf7}"
        case .unreadFilled: return "\u{fbf8}"
        case .unreadLight: return "\u{fbf9}"
        case .unreadRegular: return "\u{fbfa}"
        case .unsecureUnlockedBold: return "\u{fbfb}"
        case .unsecureUnlockedFilled: return "\u{fbfc}"
        case .unsecureUnlockedLight: return "\u{fbfd}"
        case .unsecureUnlockedRegular: return "\u{fbfe}"
        case .unsortedBold: return "\u{fbff}"
        case .unsortedLight: return "\u{fc00}"
        case .unsortedRegular: return "\u{fc01}"
        case .updateFileShareBold: return "\u{fc02}"
        case .updateFileShareLight: return "\u{fc03}"
        case .updateFileShareRegular: return "\u{fc04}"
        case .uploadBold: return "\u{fc05}"
        case .uploadImageBold: return "\u{fc06}"
        case .uploadImageLight: return "\u{fc07}"
        case .uploadImageRegular: return "\u{fc08}"
        case .uploadLight: return "\u{fc09}"
        case .uploadRegular: return "\u{fc0a}"
        case .urgentVoicemailBold: return "\u{fc0b}"
        case .urgentVoicemailFilled: return "\u{fc0c}"
        case .usbBold: return "\u{fc0d}"
        case .usbHeadsetBold: return "\u{fc0e}"
        case .usbHeadsetLight: return "\u{fc0f}"
        case .usbHeadsetMutedBold: return "\u{fc10}"
        case .usbHeadsetMutedLight: return "\u{fc11}"
        case .usbHeadsetMutedRegular: return "\u{fc12}"
        case .usbHeadsetRegular: return "\u{fc13}"
        case .usbLight: return "\u{fc14}"
        case .usbRegular: return "\u{fc15}"
        case .userBold: return "\u{fc16}"
        case .userDeactivateBold: return "\u{fc17}"
        case .userDeactivateLight: return "\u{fc18}"
        case .userDeactivateRegular: return "\u{fc19}"
        case .userLight: return "\u{fc1a}"
        case .userRegular: return "\u{fc1b}"
        case .videoBlurBold: return "\u{fc1c}"
        case .videoBlurFilled: return "\u{fc1d}"
        case .videoBlurLight: return "\u{fc1e}"
        case .videoBlurRegular: return "\u{fc1f}"
        case .videoBold: return "\u{fc20}"
        case .videoEffectBold: return "\u{fc21}"
        case .videoEffectFilled: return "\u{fc22}"
        case .videoEffectLight: return "\u{fc23}"
        case .videoEffectRegular: return "\u{fc24}"
        case .videoFilled: return "\u{fc25}"
        case .videoLayoutBold: return "\u{fc26}"
        case .videoLayoutCustomBold: return "\u{fc27}"
        case .videoLayoutCustomFilled: return "\u{fc28}"
        case .videoLayoutCustomLight: return "\u{fc29}"
        case .videoLayoutCustomRegular: return "\u{fc2a}"
        case .videoLayoutEqualBold: return "\u{fc2b}"
        case .videoLayoutEqualDualBold: return "\u{fc2c}"
        case .videoLayoutEqualDualLight: return "\u{fc2d}"
        case .videoLayoutEqualDualRegular: return "\u{fc2e}"
        case .videoLayoutEqualFilled: return "\u{fc2f}"
        case .videoLayoutEqualLight: return "\u{fc30}"
        case .videoLayoutEqualRegular: return "\u{fc31}"
        case .videoLayoutFilled: return "\u{fc32}"
        case .videoLayoutLight: return "\u{fc33}"
        case .videoLayoutOverlayBold: return "\u{fc34}"
        case .videoLayoutOverlayFilled: return "\u{fc35}"
        case .videoLayoutOverlayLight: return "\u{fc36}"
        case .videoLayoutOverlayRegular: return "\u{fc37}"
        case .videoLayoutPresentationBold: return "\u{fc38}"
        case .videoLayoutPresentationFilled: return "\u{fc39}"
        case .videoLayoutPresentationLight: return "\u{fc3a}"
        case .videoLayoutPresentationRegular: return "\u{fc3b}"
        case .videoLayoutPresenterDominantBold: return "\u{fc3c}"
        case .videoLayoutPresenterDominantLight: return "\u{fc3d}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc3e}"
        case .videoLayoutProminentBold: return "\u{fc3f}"
        case .videoLayoutProminentFilled: return "\u{fc40}"
        case .videoLayoutProminentLight: return "\u{fc41}"
        case .videoLayoutProminentRegular: return "\u{fc42}"
        case .videoLayoutRegular: return "\u{fc43}"
        case .videoLayoutShareDominantBold: return "\u{fc44}"
        case .videoLayoutShareDominantLight: return "\u{fc45}"
        case .videoLayoutShareDominantRegular: return "\u{fc46}"
        case .videoLayoutSingleBold: return "\u{fc47}"
        case .videoLayoutSingleFilled: return "\u{fc48}"
        case .videoLayoutSingleLight: return "\u{fc49}"
        case .videoLayoutSingleRegular: return "\u{fc4a}"
        case .videoLayoutSpeakerBold: return "\u{fc4b}"
        case .videoLayoutSpeakerFilled: return "\u{fc4c}"
        case .videoLayoutSpeakerLight: return "\u{fc4d}"
        case .videoLayoutSpeakerRegular: return "\u{fc4e}"
        case .videoLayoutStackBold: return "\u{fc4f}"
        case .videoLayoutStackFilled: return "\u{fc50}"
        case .videoLayoutStackLight: return "\u{fc51}"
        case .videoLayoutStackRegular: return "\u{fc52}"
        case .videoLayoutVideoDominantBold: return "\u{fc53}"
        case .videoLayoutVideoDominantFilled: return "\u{fc54}"
        case .videoLayoutVideoDominantLight: return "\u{fc55}"
        case .videoLayoutVideoDominantRegular: return "\u{fc56}"
        case .videoLight: return "\u{fc57}"
        case .videoPlusBold: return "\u{fc58}"
        case .videoPlusFilled: return "\u{fc59}"
        case .videoPlusLight: return "\u{fc5a}"
        case .videoPlusRegular: return "\u{fc5b}"
        case .videoRegular: return "\u{fc5c}"
        case .videoSpeakerTrackBold: return "\u{fc5d}"
        case .videoSpeakerTrackFilled: return "\u{fc5e}"
        case .videoSpeakerTrackLight: return "\u{fc5f}"
        case .videoSpeakerTrackRegular: return "\u{fc60}"
        case .viewAllBold: return "\u{fc61}"
        case .viewAllLight: return "\u{fc62}"
        case .viewAllRegular: return "\u{fc63}"
        case .viewListBold: return "\u{fc64}"
        case .viewListFilled: return "\u{fc65}"
        case .viewListLight: return "\u{fc66}"
        case .viewListRegular: return "\u{fc67}"
        case .viewStackedBold: return "\u{fc68}"
        case .viewStackedFilled: return "\u{fc69}"
        case .viewStackedLight: return "\u{fc6a}"
        case .viewStackedRegular: return "\u{fc6b}"
        case .viewThumbnailBold: return "\u{fc6c}"
        case .viewThumbnailFilled: return "\u{fc6d}"
        case .viewThumbnailLight: return "\u{fc6e}"
        case .viewThumbnailRegular: return "\u{fc6f}"
        case .visionproBold: return "\u{fc70}"
        case .visionproFilled: return "\u{fc71}"
        case .visionproLight: return "\u{fc72}"
        case .visionproMoveCallInBold: return "\u{fc73}"
        case .visionproMoveCallInFilled: return "\u{fc74}"
        case .visionproMoveCallInLight: return "\u{fc75}"
        case .visionproMoveCallInOutBold: return "\u{fc76}"
        case .visionproMoveCallInOutFilled: return "\u{fc77}"
        case .visionproMoveCallInOutLight: return "\u{fc78}"
        case .visionproMoveCallInOutRegular: return "\u{fc79}"
        case .visionproMoveCallInRegular: return "\u{fc7a}"
        case .visionproMoveCallOutBold: return "\u{fc7b}"
        case .visionproMoveCallOutFilled: return "\u{fc7c}"
        case .visionproMoveCallOutLight: return "\u{fc7d}"
        case .visionproMoveCallOutRegular: return "\u{fc7e}"
        case .visionproRegular: return "\u{fc7f}"
        case .voicemailBold: return "\u{fc80}"
        case .voicemailFilled: return "\u{fc81}"
        case .voicemailLight: return "\u{fc82}"
        case .voicemailRegular: return "\u{fc83}"
        case .vpnBold: return "\u{fc84}"
        case .vpnFilled: return "\u{fc85}"
        case .vpnLight: return "\u{fc86}"
        case .vpnRegular: return "\u{fc87}"
        case .vscBold: return "\u{fc88}"
        case .vscLight: return "\u{fc89}"
        case .vscRegular: return "\u{fc8a}"
        case .waffleMenuBold: return "\u{fc8b}"
        case .waffleMenuLight: return "\u{fc8c}"
        case .waffleMenuRegular: return "\u{fc8d}"
        case .waitingRoomBold: return "\u{fc8e}"
        case .waitingRoomLight: return "\u{fc8f}"
        case .waitingRoomRegular: return "\u{fc90}"
        case .wallpaperBold: return "\u{fc91}"
        case .wallpaperLight: return "\u{fc92}"
        case .wallpaperRegular: return "\u{fc93}"
        case .warningBadgeFilled: return "\u{fc94}"
        case .warningBold: return "\u{fc95}"
        case .warningFilled: return "\u{fc96}"
        case .warningLight: return "\u{fc97}"
        case .warningRegular: return "\u{fc98}"
        case .webexBoardBold: return "\u{fc99}"
        case .webexBoardLight: return "\u{fc9a}"
        case .webexBoardRegular: return "\u{fc9b}"
        case .webexCodecPlusBold: return "\u{fc9c}"
        case .webexCodecPlusLight: return "\u{fc9d}"
        case .webexCodecPlusRegular: return "\u{fc9e}"
        case .webexDeskCameraBold: return "\u{fc9f}"
        case .webexDeskCameraLight: return "\u{fca0}"
        case .webexDeskCameraRegular: return "\u{fca1}"
        case .webexHelixBold: return "\u{fca2}"
        case .webexHelixLight: return "\u{fca3}"
        case .webexHelixRegular: return "\u{fca4}"
        case .webexMeetingsBold: return "\u{fca5}"
        case .webexMeetingsFilled: return "\u{fca6}"
        case .webexMeetingsLight: return "\u{fca7}"
        case .webexMeetingsRegular: return "\u{fca8}"
        case .webexQuadCameraBold: return "\u{fca9}"
        case .webexQuadCameraLight: return "\u{fcaa}"
        case .webexQuadCameraRegular: return "\u{fcab}"
        case .webexRoomKitBold: return "\u{fcac}"
        case .webexRoomKitLight: return "\u{fcad}"
        case .webexRoomKitPlusBold: return "\u{fcae}"
        case .webexRoomKitPlusLight: return "\u{fcaf}"
        case .webexRoomKitPlusRegular: return "\u{fcb0}"
        case .webexRoomKitRegular: return "\u{fcb1}"
        case .webexShareBold: return "\u{fcb2}"
        case .webexShareLight: return "\u{fcb3}"
        case .webexShareRegular: return "\u{fcb4}"
        case .webexTeamsBold: return "\u{fcb5}"
        case .webexTeamsFilled: return "\u{fcb6}"
        case .webexTeamsLight: return "\u{fcb7}"
        case .webexTeamsNewBold: return "\u{fcb8}"
        case .webexTeamsNewFilled: return "\u{fcb9}"
        case .webexTeamsNewLight: return "\u{fcba}"
        case .webexTeamsNewRegular: return "\u{fcbb}"
        case .webexTeamsRegular: return "\u{fcbc}"
        case .webexTeamsRemoveBold: return "\u{fcbd}"
        case .webexTeamsRemoveLight: return "\u{fcbe}"
        case .webexTeamsRemoveRegular: return "\u{fcbf}"
        case .webhookBold: return "\u{fcc0}"
        case .webhookLight: return "\u{fcc1}"
        case .webhookRegular: return "\u{fcc2}"
        case .webinarBold: return "\u{fcc3}"
        case .webinarFilled: return "\u{fcc4}"
        case .webinarLight: return "\u{fcc5}"
        case .webinarRegular: return "\u{fcc6}"
        case .weeklyRecurringScheduleBold: return "\u{fcc7}"
        case .weeklyRecurringScheduleLight: return "\u{fcc8}"
        case .weeklyRecurringScheduleRegular: return "\u{fcc9}"
        case .whisperAnnouncementBold: return "\u{fcca}"
        case .whisperAnnouncementFilled: return "\u{fccb}"
        case .whisperAnnouncementLight: return "\u{fccc}"
        case .whisperAnnouncementRegular: return "\u{fccd}"
        case .whisperCoachBold: return "\u{fcce}"
        case .whisperCoachFilled: return "\u{fccf}"
        case .whisperCoachLight: return "\u{fcd0}"
        case .whisperCoachRegular: return "\u{fcd1}"
        case .whiteboardBold: return "\u{fcd2}"
        case .whiteboardContentBold: return "\u{fcd3}"
        case .whiteboardContentFilled: return "\u{fcd4}"
        case .whiteboardContentLight: return "\u{fcd5}"
        case .whiteboardContentRegular: return "\u{fcd6}"
        case .whiteboardFilled: return "\u{fcd7}"
        case .whiteboardLight: return "\u{fcd8}"
        case .whiteboardRegular: return "\u{fcd9}"
        case .widgetBold: return "\u{fcda}"
        case .widgetFilled: return "\u{fcdb}"
        case .widgetLight: return "\u{fcdc}"
        case .widgetRegular: return "\u{fcdd}"
        case .wifiBold: return "\u{fcde}"
        case .wifiErrorBold: return "\u{fcdf}"
        case .wifiErrorLight: return "\u{fce0}"
        case .wifiErrorRegular: return "\u{fce1}"
        case .wifiLight: return "\u{fce2}"
        case .wifiRegular: return "\u{fce3}"
        case .wifiSignalGoodBold: return "\u{fce4}"
        case .wifiSignalGoodLight: return "\u{fce5}"
        case .wifiSignalGoodRegular: return "\u{fce6}"
        case .wifiSignalPoorBold: return "\u{fce7}"
        case .wifiSignalPoorLight: return "\u{fce8}"
        case .wifiSignalPoorRegular: return "\u{fce9}"
        case .wifiSignalUnstableBold: return "\u{fcea}"
        case .wifiSignalUnstableLight: return "\u{fceb}"
        case .wifiSignalUnstableRegular: return "\u{fcec}"
        case .windowCornerScrubBold: return "\u{fced}"
        case .windowCornerScrubLight: return "\u{fcee}"
        case .windowCornerScrubRegular: return "\u{fcef}"
        case .windowRightCornerScrubBold: return "\u{fcf0}"
        case .windowRightCornerScrubLight: return "\u{fcf1}"
        case .windowRightCornerScrubRegular: return "\u{fcf2}"
        case .windowVerticalScrubBold: return "\u{fcf3}"
        case .windowVerticalScrubLight: return "\u{fcf4}"
        case .windowVerticalScrubRegular: return "\u{fcf5}"
        case .workflowDeploymentsBold: return "\u{fcf6}"
        case .workflowDeploymentsFilled: return "\u{fcf7}"
        case .workflowDeploymentsLight: return "\u{fcf8}"
        case .workflowDeploymentsRegular: return "\u{fcf9}"
        case .workphoneBold: return "\u{fcfa}"
        case .workphoneLight: return "\u{fcfb}"
        case .workphoneRegular: return "\u{fcfc}"
        case .zoomInBold: return "\u{fcfd}"
        case .zoomInLight: return "\u{fcfe}"
        case .zoomInRegular: return "\u{fcff}"
        case .zoomOutBold: return "\u{fd00}"
        case .zoomOutLight: return "\u{fd01}"
        case .zoomOutRegular: return "\u{fd02}"
