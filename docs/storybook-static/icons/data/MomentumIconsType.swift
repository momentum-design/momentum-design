...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .dialpadHideBold: return "\u{f459}"
        case .dialpadHideFilled: return "\u{f45a}"
        case .dialpadHideLight: return "\u{f45b}"
        case .dialpadHideRegular: return "\u{f45c}"
        case .dialpadLight: return "\u{f45d}"
        case .dialpadRegular: return "\u{f45e}"
        case .diamondBold: return "\u{f45f}"
        case .diamondFilled: return "\u{f460}"
        case .diamondLight: return "\u{f461}"
        case .diamondRegular: return "\u{f462}"
        case .directionalPadBold: return "\u{f463}"
        case .directionalPadFilled: return "\u{f464}"
        case .directionalPadLight: return "\u{f465}"
        case .directionalPadRegular: return "\u{f466}"
        case .directoryBold: return "\u{f467}"
        case .directoryLight: return "\u{f468}"
        case .directoryRegular: return "\u{f469}"
        case .disappearingPenBold: return "\u{f46a}"
        case .disappearingPenLight: return "\u{f46b}"
        case .disappearingPenRegular: return "\u{f46c}"
        case .discBold: return "\u{f46d}"
        case .discConnectedBold: return "\u{f46e}"
        case .discConnectedLight: return "\u{f46f}"
        case .discConnectedRegular: return "\u{f470}"
        case .discLight: return "\u{f471}"
        case .discRegular: return "\u{f472}"
        case .disconnectBold: return "\u{f473}"
        case .disconnectFilled: return "\u{f474}"
        case .disconnectLight: return "\u{f475}"
        case .disconnectRegular: return "\u{f476}"
        case .dislikeBold: return "\u{f477}"
        case .dislikeFilled: return "\u{f478}"
        case .dislikeLight: return "\u{f479}"
        case .dislikeRegular: return "\u{f47a}"
        case .displayBold: return "\u{f47b}"
        case .displayInputBold: return "\u{f47c}"
        case .displayInputLight: return "\u{f47d}"
        case .displayInputRegular: return "\u{f47e}"
        case .displayLight: return "\u{f47f}"
        case .displayRegular: return "\u{f480}"
        case .displayWarningBold: return "\u{f481}"
        case .displayWarningLight: return "\u{f482}"
        case .displayWarningRegular: return "\u{f483}"
        case .distributeHorizontalBold: return "\u{f484}"
        case .distributeHorizontalFilled: return "\u{f485}"
        case .distributeHorizontalLight: return "\u{f486}"
        case .distributeHorizontalRegular: return "\u{f487}"
        case .distributeVerticallyBold: return "\u{f488}"
        case .distributeVerticallyFilled: return "\u{f489}"
        case .distributeVerticallyLight: return "\u{f48a}"
        case .distributeVerticallyRegular: return "\u{f48b}"
        case .divideBold: return "\u{f48c}"
        case .divideFilled: return "\u{f48d}"
        case .divideLight: return "\u{f48e}"
        case .divideRegular: return "\u{f48f}"
        case .dndPresenceBadgeFilled: return "\u{f490}"
        case .dndPresenceBold: return "\u{f491}"
        case .dndPresenceFilled: return "\u{f492}"
        case .dndPresenceLight: return "\u{f493}"
        case .dndPresenceRegular: return "\u{f494}"
        case .dockWindowBold: return "\u{f495}"
        case .dockWindowClosedBold: return "\u{f496}"
        case .dockWindowClosedFilled: return "\u{f497}"
        case .dockWindowClosedLight: return "\u{f498}"
        case .dockWindowClosedRegular: return "\u{f499}"
        case .dockWindowFilled: return "\u{f49a}"
        case .dockWindowLight: return "\u{f49b}"
        case .dockWindowRegular: return "\u{f49c}"
        case .documentBold: return "\u{f49d}"
        case .documentCameraBold: return "\u{f49e}"
        case .documentCameraDisconnectedBold: return "\u{f49f}"
        case .documentCameraDisconnectedLight: return "\u{f4a0}"
        case .documentCameraDisconnectedRegular: return "\u{f4a1}"
        case .documentCameraLight: return "\u{f4a2}"
        case .documentCameraRegular: return "\u{f4a3}"
        case .documentCreateBold: return "\u{f4a4}"
        case .documentCreateFilled: return "\u{f4a5}"
        case .documentCreateLight: return "\u{f4a6}"
        case .documentCreateRegular: return "\u{f4a7}"
        case .documentFilled: return "\u{f4a8}"
        case .documentLight: return "\u{f4a9}"
        case .documentMoveBold: return "\u{f4aa}"
        case .documentMoveFilled: return "\u{f4ab}"
        case .documentMoveLight: return "\u{f4ac}"
        case .documentMoveRegular: return "\u{f4ad}"
        case .documentRegular: return "\u{f4ae}"
        case .documentShareBold: return "\u{f4af}"
        case .documentShareFilled: return "\u{f4b0}"
        case .documentShareLight: return "\u{f4b1}"
        case .documentShareRegular: return "\u{f4b2}"
        case .doneAllBold: return "\u{f4b3}"
        case .doneAllLight: return "\u{f4b4}"
        case .doneAllRegular: return "\u{f4b5}"
        case .donutChartBold: return "\u{f4b6}"
        case .donutChartFilled: return "\u{f4b7}"
        case .donutChartLight: return "\u{f4b8}"
        case .donutChartRegular: return "\u{f4b9}"
        case .downloadBold: return "\u{f4ba}"
        case .downloadFilled: return "\u{f4bb}"
        case .downloadLight: return "\u{f4bc}"
        case .downloadRegular: return "\u{f4bd}"
        case .draftBold: return "\u{f4be}"
        case .draftFilled: return "\u{f4bf}"
        case .draftIndicatorBold: return "\u{f4c0}"
        case .draftIndicatorSmallFilled: return "\u{f4c1}"
        case .draftLight: return "\u{f4c2}"
        case .draftRegular: return "\u{f4c3}"
        case .dragBold: return "\u{f4c4}"
        case .dragLight: return "\u{f4c5}"
        case .dragRegular: return "\u{f4c6}"
        case .draggerHorizontalBold: return "\u{f4c7}"
        case .draggerHorizontalLight: return "\u{f4c8}"
        case .draggerHorizontalRegular: return "\u{f4c9}"
        case .draggerVerticalBold: return "\u{f4ca}"
        case .draggerVerticalLight: return "\u{f4cb}"
        case .draggerVerticalRegular: return "\u{f4cc}"
        case .driveModeBold: return "\u{f4cd}"
        case .driveModeLight: return "\u{f4ce}"
        case .driveModeRegular: return "\u{f4cf}"
        case .dropdownBold: return "\u{f4d0}"
        case .dropdownLight: return "\u{f4d1}"
        case .dropdownRegular: return "\u{f4d2}"
        case .dxEightyBold: return "\u{f4d3}"
        case .dxEightyFilled: return "\u{f4d4}"
        case .dxEightyLight: return "\u{f4d5}"
        case .dxEightyRegular: return "\u{f4d6}"
        case .dxSeventyBold: return "\u{f4d7}"
        case .dxSeventyLight: return "\u{f4d8}"
        case .dxSeventyRegular: return "\u{f4d9}"
        case .editBold: return "\u{f4da}"
        case .editFilled: return "\u{f4db}"
        case .editLight: return "\u{f4dc}"
        case .editNoteBold: return "\u{f4dd}"
        case .editNoteFilled: return "\u{f4de}"
        case .editNoteLight: return "\u{f4df}"
        case .editNoteRegular: return "\u{f4e0}"
        case .editRegular: return "\u{f4e1}"
        case .editablePartialBold: return "\u{f4e2}"
        case .editablePartialLight: return "\u{f4e3}"
        case .editablePartialRegular: return "\u{f4e4}"
        case .educationBold: return "\u{f4e5}"
        case .educationFilled: return "\u{f4e6}"
        case .educationLight: return "\u{f4e7}"
        case .educationRegular: return "\u{f4e8}"
        case .emailBold: return "\u{f4e9}"
        case .emailDeliveredBold: return "\u{f4ea}"
        case .emailDeliveredLight: return "\u{f4eb}"
        case .emailDeliveredRegular: return "\u{f4ec}"
        case .emailFailureBold: return "\u{f4ed}"
        case .emailFailureLight: return "\u{f4ee}"
        case .emailFailureRegular: return "\u{f4ef}"
        case .emailFilled: return "\u{f4f0}"
        case .emailInviteBold: return "\u{f4f1}"
        case .emailInviteLight: return "\u{f4f2}"
        case .emailInviteRegular: return "\u{f4f3}"
        case .emailLight: return "\u{f4f4}"
        case .emailOutgoingBold: return "\u{f4f5}"
        case .emailOutgoingFilled: return "\u{f4f6}"
        case .emailOutgoingLight: return "\u{f4f7}"
        case .emailOutgoingRegular: return "\u{f4f8}"
        case .emailReadBold: return "\u{f4f9}"
        case .emailReadFilled: return "\u{f4fa}"
        case .emailReadLight: return "\u{f4fb}"
        case .emailReadRegular: return "\u{f4fc}"
        case .emailRegular: return "\u{f4fd}"
        case .emergencyCallbackNumberBold: return "\u{f4fe}"
        case .emergencyCallbackNumberFilled: return "\u{f4ff}"
        case .emergencyCallbackNumberLight: return "\u{f500}"
        case .emergencyCallbackNumberRegular: return "\u{f501}"
        case .emojiExcitedBold: return "\u{f502}"
        case .emojiExcitedFilled: return "\u{f503}"
        case .emojiExcitedLight: return "\u{f504}"
        case .emojiExcitedRegular: return "\u{f505}"
        case .emojiHappyBold: return "\u{f506}"
        case .emojiHappyFilled: return "\u{f507}"
        case .emojiHappyLight: return "\u{f508}"
        case .emojiHappyRegular: return "\u{f509}"
        case .emojiPassiveBold: return "\u{f50a}"
        case .emojiPassiveFilled: return "\u{f50b}"
        case .emojiPassiveLight: return "\u{f50c}"
        case .emojiPassiveRegular: return "\u{f50d}"
        case .emojiSadBold: return "\u{f50e}"
        case .emojiSadFilled: return "\u{f50f}"
        case .emojiSadLight: return "\u{f510}"
        case .emojiSadRegular: return "\u{f511}"
        case .emojiUnhappyBold: return "\u{f512}"
        case .emojiUnhappyFilled: return "\u{f513}"
        case .emojiUnhappyLight: return "\u{f514}"
        case .emojiUnhappyRegular: return "\u{f515}"
        case .encryptionAdaptiveBold: return "\u{f516}"
        case .encryptionAdaptiveFilled: return "\u{f517}"
        case .encryptionAdaptiveLight: return "\u{f518}"
        case .encryptionAdaptiveRegular: return "\u{f519}"
        case .encryptionAdaptiveSecureBold: return "\u{f51a}"
        case .encryptionAdaptiveSecureFilled: return "\u{f51b}"
        case .encryptionAdaptiveSecureLight: return "\u{f51c}"
        case .encryptionAdaptiveSecureRegular: return "\u{f51d}"
        case .encryptionBold: return "\u{f51e}"
        case .encryptionCircleAdaptiveBold: return "\u{f51f}"
        case .encryptionCircleAdaptiveFilled: return "\u{f520}"
        case .encryptionCircleAdaptiveLight: return "\u{f521}"
        case .encryptionCircleAdaptiveRegular: return "\u{f522}"
        case .encryptionCircleAdaptiveSecureBold: return "\u{f523}"
        case .encryptionCircleAdaptiveSecureFilled: return "\u{f524}"
        case .encryptionCircleAdaptiveSecureLight: return "\u{f525}"
        case .encryptionCircleAdaptiveSecureRegular: return "\u{f526}"
        case .encryptionCircleBold: return "\u{f527}"
        case .encryptionCircleFilled: return "\u{f528}"
        case .encryptionCircleLight: return "\u{f529}"
        case .encryptionCircleRegular: return "\u{f52a}"
        case .encryptionFilled: return "\u{f52b}"
        case .encryptionLight: return "\u{f52c}"
        case .encryptionRegular: return "\u{f52d}"
        case .endRemoteDesktopControlBold: return "\u{f52e}"
        case .endRemoteDesktopControlLight: return "\u{f52f}"
        case .endRemoteDesktopControlRegular: return "\u{f530}"
        case .endToEndEncryptionBold: return "\u{f531}"
        case .endToEndEncryptionCircleBold: return "\u{f532}"
        case .endToEndEncryptionCircleFilled: return "\u{f533}"
        case .endToEndEncryptionCircleLight: return "\u{f534}"
        case .endToEndEncryptionCircleRegular: return "\u{f535}"
        case .endToEndEncryptionFilled: return "\u{f536}"
        case .endToEndEncryptionLight: return "\u{f537}"
        case .endToEndEncryptionRegular: return "\u{f538}"
        case .endpointBlockedBold: return "\u{f539}"
        case .endpointBlockedLight: return "\u{f53a}"
        case .endpointBlockedRegular: return "\u{f53b}"
        case .endpointBold: return "\u{f53c}"
        case .endpointGTwoBold: return "\u{f53d}"
        case .endpointGTwoLight: return "\u{f53e}"
        case .endpointGTwoRegular: return "\u{f53f}"
        case .endpointGTwoSeventyBold: return "\u{f540}"
        case .endpointGTwoSeventyDualBold: return "\u{f541}"
        case .endpointGTwoSeventyDualLight: return "\u{f542}"
        case .endpointGTwoSeventyDualRegular: return "\u{f543}"
        case .endpointGTwoSeventyLight: return "\u{f544}"
        case .endpointGTwoSeventyRegular: return "\u{f545}"
        case .endpointGTwoStandBold: return "\u{f546}"
        case .endpointGTwoStandLight: return "\u{f547}"
        case .endpointGTwoStandRegular: return "\u{f548}"
        case .endpointLight: return "\u{f549}"
        case .endpointMxEightHundredBold: return "\u{f54a}"
        case .endpointMxEightHundredDualBold: return "\u{f54b}"
        case .endpointMxEightHundredDualLight: return "\u{f54c}"
        case .endpointMxEightHundredDualRegular: return "\u{f54d}"
        case .endpointMxEightHundredLight: return "\u{f54e}"
        case .endpointMxEightHundredRegular: return "\u{f54f}"
        case .endpointRegular: return "\u{f550}"
        case .endpointStandBold: return "\u{f551}"
        case .endpointStandFilled: return "\u{f552}"
        case .endpointStandLight: return "\u{f553}"
        case .endpointStandRegular: return "\u{f554}"
        case .endpointWarningBold: return "\u{f555}"
        case .endpointWarningLight: return "\u{f556}"
        case .endpointWarningRegular: return "\u{f557}"
        case .enterBold: return "\u{f558}"
        case .enterLight: return "\u{f559}"
        case .enterRegular: return "\u{f55a}"
        case .enterRoomBold: return "\u{f55b}"
        case .enterRoomFilled: return "\u{f55c}"
        case .enterRoomLight: return "\u{f55d}"
        case .enterRoomRegular: return "\u{f55e}"
        case .eraserBold: return "\u{f55f}"
        case .eraserFilled: return "\u{f560}"
        case .eraserLight: return "\u{f561}"
        case .eraserRegular: return "\u{f562}"
        case .errorLegacyBadgeFilled: return "\u{f563}"
        case .errorLegacyBold: return "\u{f564}"
        case .errorLegacyFilled: return "\u{f565}"
        case .errorLegacyLight: return "\u{f566}"
        case .errorLegacyRegular: return "\u{f567}"
        case .ethernetBold: return "\u{f568}"
        case .ethernetFilled: return "\u{f569}"
        case .ethernetLight: return "\u{f56a}"
        case .ethernetRegular: return "\u{f56b}"
        case .exchangeBold: return "\u{f56c}"
        case .exchangeLight: return "\u{f56d}"
        case .exchangeRegular: return "\u{f56e}"
        case .exclamationBold: return "\u{f56f}"
        case .exclamationLight: return "\u{f570}"
        case .exclamationRegular: return "\u{f571}"
        case .excludeBold: return "\u{f572}"
        case .excludeLight: return "\u{f573}"
        case .excludeRegular: return "\u{f574}"
        case .existingTargetGroupBold: return "\u{f575}"
        case .existingTargetGroupLight: return "\u{f576}"
        case .existingTargetGroupRegular: return "\u{f577}"
        case .exitRoomBold: return "\u{f578}"
        case .exitRoomLight: return "\u{f579}"
        case .exitRoomRegular: return "\u{f57a}"
        case .exploreBold: return "\u{f57b}"
        case .exploreLight: return "\u{f57c}"
        case .exploreRegular: return "\u{f57d}"
        case .exportBold: return "\u{f57e}"
        case .exportLight: return "\u{f57f}"
        case .exportRegular: return "\u{f580}"
        case .extensionMobilityBold: return "\u{f581}"
        case .extensionMobilityLight: return "\u{f582}"
        case .extensionMobilityRegular: return "\u{f583}"
        case .externalMessageBold: return "\u{f584}"
        case .externalMessageLight: return "\u{f585}"
        case .externalMessageRegular: return "\u{f586}"
        case .externalUserBold: return "\u{f587}"
        case .externalUserLight: return "\u{f588}"
        case .externalUserRegular: return "\u{f589}"
        case .familyFontBold: return "\u{f58a}"
        case .familyFontLight: return "\u{f58b}"
        case .familyFontRegular: return "\u{f58c}"
        case .fastForwardBold: return "\u{f58d}"
        case .fastForwardLight: return "\u{f58e}"
        case .fastForwardRegular: return "\u{f58f}"
        case .favoriteBold: return "\u{f590}"
        case .favoriteFilled: return "\u{f591}"
        case .favoriteLight: return "\u{f592}"
        case .favoriteRegular: return "\u{f593}"
        case .favoritesBold: return "\u{f594}"
        case .favoritesFilled: return "\u{f595}"
        case .favoritesLight: return "\u{f596}"
        case .favoritesRegular: return "\u{f597}"
        case .fbwBold: return "\u{f598}"
        case .fbwFilled: return "\u{f599}"
        case .fbwLight: return "\u{f59a}"
        case .fbwRegular: return "\u{f59b}"
        case .ffwBold: return "\u{f59c}"
        case .ffwFilled: return "\u{f59d}"
        case .ffwLight: return "\u{f59e}"
        case .ffwRegular: return "\u{f59f}"
        case .fileAnalysisBold: return "\u{f5a0}"
        case .fileAnalysisFilled: return "\u{f5a1}"
        case .fileAnalysisLight: return "\u{f5a2}"
        case .fileAnalysisRegular: return "\u{f5a3}"
        case .fileAnnotationBold: return "\u{f5a4}"
        case .fileAnnotationFilled: return "\u{f5a5}"
        case .fileAnnotationLight: return "\u{f5a6}"
        case .fileAnnotationRegular: return "\u{f5a7}"
        case .fileAudioBold: return "\u{f5a8}"
        case .fileAudioFilled: return "\u{f5a9}"
        case .fileAudioLight: return "\u{f5aa}"
        case .fileAudioRegular: return "\u{f5ab}"
        case .fileBugBold: return "\u{f5ac}"
        case .fileBugFilled: return "\u{f5ad}"
        case .fileBugLight: return "\u{f5ae}"
        case .fileBugRegular: return "\u{f5af}"
        case .fileCodeBold: return "\u{f5b0}"
        case .fileCodeFilled: return "\u{f5b1}"
        case .fileCodeLight: return "\u{f5b2}"
        case .fileCodeRegular: return "\u{f5b3}"
        case .fileDashboardBold: return "\u{f5b4}"
        case .fileDashboardFilled: return "\u{f5b5}"
        case .fileDashboardLight: return "\u{f5b6}"
        case .fileDashboardRegular: return "\u{f5b7}"
        case .fileExcelBold: return "\u{f5b8}"
        case .fileExcelFilled: return "\u{f5b9}"
        case .fileExcelLight: return "\u{f5ba}"
        case .fileExcelRegular: return "\u{f5bb}"
        case .fileGraphBold: return "\u{f5bc}"
        case .fileGraphFilled: return "\u{f5bd}"
        case .fileGraphLight: return "\u{f5be}"
        case .fileGraphRegular: return "\u{f5bf}"
        case .fileImageBold: return "\u{f5c0}"
        case .fileImageFilled: return "\u{f5c1}"
        case .fileImageLight: return "\u{f5c2}"
        case .fileImageNoneBold: return "\u{f5c3}"
        case .fileImageNoneLight: return "\u{f5c4}"
        case .fileImageNoneRegular: return "\u{f5c5}"
        case .fileImageRegular: return "\u{f5c6}"
        case .fileJsBold: return "\u{f5c7}"
        case .fileJsFilled: return "\u{f5c8}"
        case .fileJsLight: return "\u{f5c9}"
        case .fileJsRegular: return "\u{f5ca}"
        case .fileKeynoteBold: return "\u{f5cb}"
        case .fileKeynoteFilled: return "\u{f5cc}"
        case .fileKeynoteLight: return "\u{f5cd}"
        case .fileKeynoteRegular: return "\u{f5ce}"
        case .fileLockedBold: return "\u{f5cf}"
        case .fileLockedFilled: return "\u{f5d0}"
        case .fileLockedLight: return "\u{f5d1}"
        case .fileLockedRegular: return "\u{f5d2}"
        case .fileMissingBold: return "\u{f5d3}"
        case .fileMissingFilled: return "\u{f5d4}"
        case .fileMissingLight: return "\u{f5d5}"
        case .fileMissingRegular: return "\u{f5d6}"
        case .fileMusicBold: return "\u{f5d7}"
        case .fileMusicFilled: return "\u{f5d8}"
        case .fileMusicLight: return "\u{f5d9}"
        case .fileMusicRegular: return "\u{f5da}"
        case .fileOnenoteBold: return "\u{f5db}"
        case .fileOnenoteFilled: return "\u{f5dc}"
        case .fileOnenoteLight: return "\u{f5dd}"
        case .fileOnenoteRegular: return "\u{f5de}"
        case .filePdfBold: return "\u{f5df}"
        case .filePdfFilled: return "\u{f5e0}"
        case .filePdfLight: return "\u{f5e1}"
        case .filePdfRegular: return "\u{f5e2}"
        case .filePowerpointBold: return "\u{f5e3}"
        case .filePowerpointFilled: return "\u{f5e4}"
        case .filePowerpointLight: return "\u{f5e5}"
        case .filePowerpointRegular: return "\u{f5e6}"
        case .fileSpreadsheetBold: return "\u{f5e7}"
        case .fileSpreadsheetFilled: return "\u{f5e8}"
        case .fileSpreadsheetLight: return "\u{f5e9}"
        case .fileSpreadsheetRegular: return "\u{f5ea}"
        case .fileTextBold: return "\u{f5eb}"
        case .fileTextFilled: return "\u{f5ec}"
        case .fileTextLight: return "\u{f5ed}"
        case .fileTextRegular: return "\u{f5ee}"
        case .fileThreeDBold: return "\u{f5ef}"
        case .fileThreeDFilled: return "\u{f5f0}"
        case .fileThreeDLight: return "\u{f5f1}"
        case .fileThreeDRegular: return "\u{f5f2}"
        case .fileVectorBold: return "\u{f5f3}"
        case .fileVectorFilled: return "\u{f5f4}"
        case .fileVectorLight: return "\u{f5f5}"
        case .fileVectorRegular: return "\u{f5f6}"
        case .fileVideoBold: return "\u{f5f7}"
        case .fileVideoFilled: return "\u{f5f8}"
        case .fileVideoLight: return "\u{f5f9}"
        case .fileVideoRegular: return "\u{f5fa}"
        case .fileWordBold: return "\u{f5fb}"
        case .fileWordFilled: return "\u{f5fc}"
        case .fileWordLight: return "\u{f5fd}"
        case .fileWordRegular: return "\u{f5fe}"
        case .fileXmlBold: return "\u{f5ff}"
        case .fileXmlFilled: return "\u{f600}"
        case .fileXmlLight: return "\u{f601}"
        case .fileXmlRegular: return "\u{f602}"
        case .fileZipBold: return "\u{f603}"
        case .fileZipFilled: return "\u{f604}"
        case .fileZipLight: return "\u{f605}"
        case .fileZipRegular: return "\u{f606}"
        case .filesBold: return "\u{f607}"
        case .filesFilled: return "\u{f608}"
        case .filesLight: return "\u{f609}"
        case .filesRegular: return "\u{f60a}"
        case .fillColourBold: return "\u{f60b}"
        case .fillColourFilled: return "\u{f60c}"
        case .fillColourLight: return "\u{f60d}"
        case .fillColourRegular: return "\u{f60e}"
        case .filterBold: return "\u{f60f}"
        case .filterCircleBold: return "\u{f610}"
        case .filterCircleFilled: return "\u{f611}"
        case .filterCircleLight: return "\u{f612}"
        case .filterCircleRegular: return "\u{f613}"
        case .filterLight: return "\u{f614}"
        case .filterRegular: return "\u{f615}"
        case .fitToWidthBold: return "\u{f616}"
        case .fitToWidthLight: return "\u{f617}"
        case .fitToWidthRegular: return "\u{f618}"
        case .fitToWindowExpandBold: return "\u{f619}"
        case .fitToWindowExpandLight: return "\u{f61a}"
        case .fitToWindowExpandRegular: return "\u{f61b}"
        case .fitToWindowShrinkBold: return "\u{f61c}"
        case .fitToWindowShrinkLight: return "\u{f61d}"
        case .fitToWindowShrinkRegular: return "\u{f61e}"
        case .flagBold: return "\u{f61f}"
        case .flagCircleBold: return "\u{f620}"
        case .flagCircleFilled: return "\u{f621}"
        case .flagCircleLight: return "\u{f622}"
        case .flagCircleRegular: return "\u{f623}"
        case .flagFilled: return "\u{f624}"
        case .flagLight: return "\u{f625}"
        case .flagRegular: return "\u{f626}"
        case .folderBold: return "\u{f627}"
        case .folderEditBold: return "\u{f628}"
        case .folderEditLight: return "\u{f629}"
        case .folderEditRegular: return "\u{f62a}"
        case .folderFilled: return "\u{f62b}"
        case .folderLight: return "\u{f62c}"
        case .folderLockBold: return "\u{f62d}"
        case .folderLockLight: return "\u{f62e}"
        case .folderLockRegular: return "\u{f62f}"
        case .folderRegular: return "\u{f630}"
        case .folderViewBold: return "\u{f631}"
        case .folderViewLight: return "\u{f632}"
        case .folderViewRegular: return "\u{f633}"
        case .followUpBold: return "\u{f634}"
        case .followUpLight: return "\u{f635}"
        case .followUpRegular: return "\u{f636}"
        case .foodBold: return "\u{f637}"
        case .foodFilled: return "\u{f638}"
        case .foodLight: return "\u{f639}"
        case .foodRegular: return "\u{f63a}"
        case .forecastBold: return "\u{f63b}"
        case .forecastFilled: return "\u{f63c}"
        case .forecastLight: return "\u{f63d}"
        case .forecastRegular: return "\u{f63e}"
        case .formatBold: return "\u{f63f}"
        case .formatDefaultAppBold: return "\u{f640}"
        case .formatDefaultAppFilled: return "\u{f641}"
        case .formatDefaultAppLight: return "\u{f642}"
        case .formatDefaultAppRegular: return "\u{f643}"
        case .formatLight: return "\u{f644}"
        case .formatPanelControlBarBold: return "\u{f645}"
        case .formatPanelControlBarLight: return "\u{f646}"
        case .formatPanelControlBarRegular: return "\u{f647}"
        case .formatPanelControlDownBold: return "\u{f648}"
        case .formatPanelControlDownLight: return "\u{f649}"
        case .formatPanelControlDownRegular: return "\u{f64a}"
        case .formatPanelControlLeftBold: return "\u{f64b}"
        case .formatPanelControlLeftLight: return "\u{f64c}"
        case .formatPanelControlLeftRegular: return "\u{f64d}"
        case .formatPanelControlRightBold: return "\u{f64e}"
        case .formatPanelControlRightLight: return "\u{f64f}"
        case .formatPanelControlRightRegular: return "\u{f650}"
        case .formatPanelControlUpBold: return "\u{f651}"
        case .formatPanelControlUpDownBold: return "\u{f652}"
        case .formatPanelControlUpDownLight: return "\u{f653}"
        case .formatPanelControlUpDownRegular: return "\u{f654}"
        case .formatPanelControlUpLight: return "\u{f655}"
        case .formatPanelControlUpRegular: return "\u{f656}"
        case .formatRegular: return "\u{f657}"
        case .formatViewMixedBold: return "\u{f658}"
        case .formatViewMixedLight: return "\u{f659}"
        case .formatViewMixedRegular: return "\u{f65a}"
        case .formulaBold: return "\u{f65b}"
        case .formulaFilled: return "\u{f65c}"
        case .formulaLight: return "\u{f65d}"
        case .formulaRegular: return "\u{f65e}"
        case .forwardMessageBold: return "\u{f65f}"
        case .forwardMessageFilled: return "\u{f660}"
        case .forwardMessageLight: return "\u{f661}"
        case .forwardMessageRegular: return "\u{f662}"
        case .forwardTenSecBold: return "\u{f663}"
        case .forwardTenSecLight: return "\u{f664}"
        case .forwardTenSecRegular: return "\u{f665}"
        case .fourColumnBold: return "\u{f666}"
        case .fourColumnLight: return "\u{f667}"
        case .fourColumnRegular: return "\u{f668}"
        case .fourWayNavigationBold: return "\u{f669}"
        case .fourWayNavigationLight: return "\u{f66a}"
        case .fourWayNavigationRegular: return "\u{f66b}"
        case .frequencyCappingBold: return "\u{f66c}"
        case .frequencyCappingLight: return "\u{f66d}"
        case .frequencyCappingRegular: return "\u{f66e}"
        case .fulfillmentBold: return "\u{f66f}"
        case .fulfillmentLight: return "\u{f670}"
        case .fulfillmentRegular: return "\u{f671}"
        case .fullscreenBold: return "\u{f672}"
        case .fullscreenExitBold: return "\u{f673}"
        case .fullscreenExitLight: return "\u{f674}"
        case .fullscreenExitRegular: return "\u{f675}"
        case .fullscreenLight: return "\u{f676}"
        case .fullscreenRegular: return "\u{f677}"
        case .genericDeviceVideoBadgeFilled: return "\u{f678}"
        case .genericDeviceVideoBold: return "\u{f679}"
        case .genericDeviceVideoFilled: return "\u{f67a}"
        case .genericDeviceVideoLight: return "\u{f67b}"
        case .genericDeviceVideoRegular: return "\u{f67c}"
        case .gifBold: return "\u{f67d}"
        case .gifFilled: return "\u{f67e}"
        case .gifHorizontalBold: return "\u{f67f}"
        case .gifHorizontalFilled: return "\u{f680}"
        case .gifHorizontalLight: return "\u{f681}"
        case .gifHorizontalRegular: return "\u{f682}"
        case .gifLight: return "\u{f683}"
        case .gifRegular: return "\u{f684}"
        case .giftBold: return "\u{f685}"
        case .giftFilled: return "\u{f686}"
        case .giftLight: return "\u{f687}"
        case .giftRegular: return "\u{f688}"
        case .greenLeafBold: return "\u{f689}"
        case .greenLeafFilled: return "\u{f68a}"
        case .greenLeafLight: return "\u{f68b}"
        case .greenLeafRegular: return "\u{f68c}"
        case .greenRoomBold: return "\u{f68d}"
        case .greenRoomFilled: return "\u{f68e}"
        case .greenRoomLight: return "\u{f68f}"
        case .greenRoomRegular: return "\u{f690}"
        case .guestIssuerBold: return "\u{f691}"
        case .guestIssuerLight: return "\u{f692}"
        case .guestIssuerRegular: return "\u{f693}"
        case .guideBold: return "\u{f694}"
        case .guideLight: return "\u{f695}"
        case .guideRegular: return "\u{f696}"
        case .handPointerBold: return "\u{f697}"
        case .handPointerLight: return "\u{f698}"
        case .handPointerRegular: return "\u{f699}"
        case .handlerBold: return "\u{f69a}"
        case .handlerHorizontalBold: return "\u{f69b}"
        case .handlerHorizontalLight: return "\u{f69c}"
        case .handlerHorizontalRegular: return "\u{f69d}"
        case .handlerLight: return "\u{f69e}"
        case .handlerRegular: return "\u{f69f}"
        case .handsetAlertBold: return "\u{f6a0}"
        case .handsetAlertFilled: return "\u{f6a1}"
        case .handsetAlertLight: return "\u{f6a2}"
        case .handsetAlertRegular: return "\u{f6a3}"
        case .handsetBold: return "\u{f6a4}"
        case .handsetDownSlashBold: return "\u{f6a5}"
        case .handsetDownSlashFilled: return "\u{f6a6}"
        case .handsetDownSlashLight: return "\u{f6a7}"
        case .handsetDownSlashRegular: return "\u{f6a8}"
        case .handsetFilled: return "\u{f6a9}"
        case .handsetLight: return "\u{f6aa}"
        case .handsetMutedBold: return "\u{f6ab}"
        case .handsetMutedFilled: return "\u{f6ac}"
        case .handsetMutedLight: return "\u{f6ad}"
        case .handsetMutedRegular: return "\u{f6ae}"
        case .handsetRegular: return "\u{f6af}"
        case .handsetsArrowLeftBold: return "\u{f6b0}"
        case .handsetsArrowLeftLight: return "\u{f6b1}"
        case .handsetsArrowLeftRegular: return "\u{f6b2}"
        case .handshakeBold: return "\u{f6b3}"
        case .handshakeLight: return "\u{f6b4}"
        case .handshakeRegular: return "\u{f6b5}"
        case .headingOneBold: return "\u{f6b6}"
        case .headingOneLight: return "\u{f6b7}"
        case .headingOneRegular: return "\u{f6b8}"
        case .headingThreeBold: return "\u{f6b9}"
        case .headingThreeLight: return "\u{f6ba}"
        case .headingThreeRegular: return "\u{f6bb}"
        case .headingTwoBold: return "\u{f6bc}"
        case .headingTwoLight: return "\u{f6bd}"
        case .headingTwoRegular: return "\u{f6be}"
        case .headphonesBold: return "\u{f6bf}"
        case .headphonesFilled: return "\u{f6c0}"
        case .headphonesLight: return "\u{f6c1}"
        case .headphonesMutedBold: return "\u{f6c2}"
        case .headphonesMutedFilled: return "\u{f6c3}"
        case .headphonesMutedLight: return "\u{f6c4}"
        case .headphonesMutedRegular: return "\u{f6c5}"
        case .headphonesRegular: return "\u{f6c6}"
        case .headsetAlertBold: return "\u{f6c7}"
        case .headsetAlertLight: return "\u{f6c8}"
        case .headsetAlertRegular: return "\u{f6c9}"
        case .headsetArrowDownBold: return "\u{f6ca}"
        case .headsetArrowDownFilled: return "\u{f6cb}"
        case .headsetArrowDownLight: return "\u{f6cc}"
        case .headsetArrowDownRegular: return "\u{f6cd}"
        case .headsetBluetoothBold: return "\u{f6ce}"
        case .headsetBluetoothLight: return "\u{f6cf}"
        case .headsetBluetoothRegular: return "\u{f6d0}"
        case .headsetBold: return "\u{f6d1}"
        case .headsetFilled: return "\u{f6d2}"
        case .headsetLight: return "\u{f6d3}"
        case .headsetMutedBold: return "\u{f6d4}"
        case .headsetMutedLight: return "\u{f6d5}"
        case .headsetMutedRegular: return "\u{f6d6}"
        case .headsetPrivateBold: return "\u{f6d7}"
        case .headsetPrivateLight: return "\u{f6d8}"
        case .headsetPrivateRegular: return "\u{f6d9}"
        case .headsetRegular: return "\u{f6da}"
        case .hearingBold: return "\u{f6db}"
        case .hearingImpairedBold: return "\u{f6dc}"
        case .hearingImpairedLight: return "\u{f6dd}"
        case .hearingImpairedRegular: return "\u{f6de}"
        case .hearingLight: return "\u{f6df}"
        case .hearingRegular: return "\u{f6e0}"
        case .helpBold: return "\u{f6e1}"
        case .helpCircleBold: return "\u{f6e2}"
        case .helpCircleFilled: return "\u{f6e3}"
        case .helpCircleLight: return "\u{f6e4}"
        case .helpCircleRegular: return "\u{f6e5}"
        case .helpLight: return "\u{f6e6}"
        case .helpRegular: return "\u{f6e7}"
        case .helpdeskBold: return "\u{f6e8}"
        case .helpdeskFilled: return "\u{f6e9}"
        case .helpdeskLight: return "\u{f6ea}"
        case .helpdeskRegular: return "\u{f6eb}"
        case .hideBold: return "\u{f6ec}"
        case .hideFilled: return "\u{f6ed}"
        case .hideLight: return "\u{f6ee}"
        case .hideRegular: return "\u{f6ef}"
        case .homeBold: return "\u{f6f0}"
        case .homeFilled: return "\u{f6f1}"
        case .homeLight: return "\u{f6f2}"
        case .homeRegular: return "\u{f6f3}"
        case .horizontalLineBold: return "\u{f6f4}"
        case .horizontalLineLight: return "\u{f6f5}"
        case .horizontalLineRegular: return "\u{f6f6}"
        case .hotelingBold: return "\u{f6f7}"
        case .hotelingFilled: return "\u{f6f8}"
        case .hotelingLight: return "\u{f6f9}"
        case .hotelingRegular: return "\u{f6fa}"
        case .humidityBold: return "\u{f6fb}"
        case .humidityLight: return "\u{f6fc}"
        case .humidityRegular: return "\u{f6fd}"
        case .huntGroupBold: return "\u{f6fe}"
        case .huntGroupFilled: return "\u{f6ff}"
        case .huntGroupLight: return "\u{f700}"
        case .huntGroupRegular: return "\u{f701}"
        case .idleBold: return "\u{f702}"
        case .idleFilled: return "\u{f703}"
        case .idleLight: return "\u{f704}"
        case .idleRegular: return "\u{f705}"
        case .immediateBold: return "\u{f706}"
        case .immediateFilled: return "\u{f707}"
        case .immediateLight: return "\u{f708}"
        case .immediateRegular: return "\u{f709}"
        case .importBold: return "\u{f70a}"
        case .importLight: return "\u{f70b}"
        case .importRegular: return "\u{f70c}"
        case .inCommonBold: return "\u{f70d}"
        case .inCommonLight: return "\u{f70e}"
        case .inCommonRegular: return "\u{f70f}"
        case .inboxBold: return "\u{f710}"
        case .inboxFilled: return "\u{f711}"
        case .inboxLight: return "\u{f712}"
        case .inboxRegular: return "\u{f713}"
        case .includeBold: return "\u{f714}"
        case .includeLight: return "\u{f715}"
        case .includeRegular: return "\u{f716}"
        case .incognitoBold: return "\u{f717}"
        case .incognitoFilled: return "\u{f718}"
        case .incognitoLight: return "\u{f719}"
        case .incognitoRegular: return "\u{f71a}"
        case .incomingCallLegacyBold: return "\u{f71b}"
        case .incomingCallLegacyFilled: return "\u{f71c}"
        case .incomingCallLegacyLight: return "\u{f71d}"
        case .incomingCallLegacyRegular: return "\u{f71e}"
        case .indentDecreaseBold: return "\u{f71f}"
        case .indentDecreaseLight: return "\u{f720}"
        case .indentDecreaseRegular: return "\u{f721}"
        case .indentIncreaseBold: return "\u{f722}"
        case .indentIncreaseLight: return "\u{f723}"
        case .indentIncreaseRegular: return "\u{f724}"
        case .infoBadgeFilled: return "\u{f725}"
        case .infoCircleBold: return "\u{f726}"
        case .infoCircleFilled: return "\u{f727}"
        case .infoCircleLight: return "\u{f728}"
        case .infoCircleRegular: return "\u{f729}"
        case .infoCircleTwoBold: return "\u{f72a}"
        case .infoCircleTwoFilled: return "\u{f72b}"
        case .infoCircleTwoLight: return "\u{f72c}"
        case .infoCircleTwoRegular: return "\u{f72d}"
        case .inputBold: return "\u{f72e}"
        case .inputDisconnectedBold: return "\u{f72f}"
        case .inputDisconnectedLight: return "\u{f730}"
        case .inputDisconnectedRegular: return "\u{f731}"
        case .inputLight: return "\u{f732}"
        case .inputRegular: return "\u{f733}"
        case .instantScheduleBold: return "\u{f734}"
        case .instantScheduleFilled: return "\u{f735}"
        case .instantScheduleLight: return "\u{f736}"
        case .instantScheduleRegular: return "\u{f737}"
        case .integerBold: return "\u{f738}"
        case .integerFilled: return "\u{f739}"
        case .integerLight: return "\u{f73a}"
        case .integerRegular: return "\u{f73b}"
        case .integrationsBold: return "\u{f73c}"
        case .integrationsFilled: return "\u{f73d}"
        case .integrationsLight: return "\u{f73e}"
        case .integrationsRegular: return "\u{f73f}"
        case .intelligentRoutingBold: return "\u{f740}"
        case .intelligentRoutingLight: return "\u{f741}"
        case .intelligentRoutingRegular: return "\u{f742}"
        case .interactionBold: return "\u{f743}"
        case .interactionFilled: return "\u{f744}"
        case .interactionLight: return "\u{f745}"
        case .interactionRegular: return "\u{f746}"
        case .invitedUserBold: return "\u{f747}"
        case .invitedUserLight: return "\u{f748}"
        case .invitedUserRegular: return "\u{f749}"
        case .italicBold: return "\u{f74a}"
        case .italicFilled: return "\u{f74b}"
        case .italicLight: return "\u{f74c}"
        case .italicRegular: return "\u{f74d}"
        case .joinAudioBold: return "\u{f74e}"
        case .joinAudioFilled: return "\u{f74f}"
        case .joinAudioLight: return "\u{f750}"
        case .joinAudioRegular: return "\u{f751}"
        case .keepInTouchBold: return "\u{f752}"
        case .keepInTouchFilled: return "\u{f753}"
        case .keepInTouchLight: return "\u{f754}"
        case .keepInTouchRegular: return "\u{f755}"
        case .keyboardBold: return "\u{f756}"
        case .keyboardCloseBold: return "\u{f757}"
        case .keyboardCloseLight: return "\u{f758}"
        case .keyboardCloseRegular: return "\u{f759}"
        case .keyboardLight: return "\u{f75a}"
        case .keyboardRegular: return "\u{f75b}"
        case .languageBold: return "\u{f75c}"
        case .languageFilled: return "\u{f75d}"
        case .languageLight: return "\u{f75e}"
        case .languageRegular: return "\u{f75f}"
        case .laptopBold: return "\u{f760}"
        case .laptopDisconnectedBold: return "\u{f761}"
        case .laptopDisconnectedLight: return "\u{f762}"
        case .laptopDisconnectedRegular: return "\u{f763}"
        case .laptopFilled: return "\u{f764}"
        case .laptopLight: return "\u{f765}"
        case .laptopRegular: return "\u{f766}"
        case .laserPointerBold: return "\u{f767}"
        case .laserPointerCursorBlackLight: return "\u{f768}"
        case .laserPointerCursorBlueLight: return "\u{f769}"
        case .laserPointerCursorGreenLight: return "\u{f76a}"
        case .laserPointerCursorPurpleLight: return "\u{f76b}"
        case .laserPointerCursorRedLight: return "\u{f76c}"
        case .laserPointerCursorWhiteLight: return "\u{f76d}"
        case .laserPointerCursorYellowLight: return "\u{f76e}"
        case .laserPointerFilled: return "\u{f76f}"
        case .laserPointerLight: return "\u{f770}"
        case .laserPointerRegular: return "\u{f771}"
        case .launchBold: return "\u{f772}"
        case .launchFilled: return "\u{f773}"
        case .launchLight: return "\u{f774}"
        case .launchRegular: return "\u{f775}"
        case .layoutSideBySideVerticalBold: return "\u{f776}"
        case .layoutSideBySideVerticalFilled: return "\u{f777}"
        case .layoutSideBySideVerticalLight: return "\u{f778}"
        case .layoutSideBySideVerticalRegular: return "\u{f779}"
        case .leaveBreakoutSessionBold: return "\u{f77a}"
        case .leaveBreakoutSessionLight: return "\u{f77b}"
        case .leaveBreakoutSessionRegular: return "\u{f77c}"
        case .leaveDeviceBold: return "\u{f77d}"
        case .leaveDeviceLight: return "\u{f77e}"
        case .leaveDeviceRegular: return "\u{f77f}"
        case .likeBold: return "\u{f780}"
        case .likeFilled: return "\u{f781}"
        case .likeLight: return "\u{f782}"
        case .likeRegular: return "\u{f783}"
        case .linkBold: return "\u{f784}"
        case .linkLight: return "\u{f785}"
        case .linkRegular: return "\u{f786}"
        case .listBulletedBold: return "\u{f787}"
        case .listBulletedLight: return "\u{f788}"
        case .listBulletedRegular: return "\u{f789}"
        case .listMenuBold: return "\u{f78a}"
        case .listMenuLight: return "\u{f78b}"
        case .listMenuRegular: return "\u{f78c}"
        case .listNumberedBold: return "\u{f78d}"
        case .listNumberedLight: return "\u{f78e}"
        case .listNumberedRegular: return "\u{f78f}"
        case .liveBold: return "\u{f790}"
        case .liveFilled: return "\u{f791}"
        case .liveLight: return "\u{f792}"
        case .liveRegular: return "\u{f793}"
        case .locationBold: return "\u{f794}"
        case .locationFilled: return "\u{f795}"
        case .locationLight: return "\u{f796}"
        case .locationRegular: return "\u{f797}"
        case .longTextBoxBold: return "\u{f798}"
        case .longTextBoxLight: return "\u{f799}"
        case .longTextBoxRegular: return "\u{f79a}"
        case .lowerHandBold: return "\u{f79b}"
        case .lowerHandLight: return "\u{f79c}"
        case .lowerHandRegular: return "\u{f79d}"
        case .magicPenBold: return "\u{f79e}"
        case .magicPenFilled: return "\u{f79f}"
        case .magicPenLight: return "\u{f7a0}"
        case .magicPenRegular: return "\u{f7a1}"
        case .markAsUnreadBold: return "\u{f7a2}"
        case .markAsUnreadFilled: return "\u{f7a3}"
        case .markAsUnreadLight: return "\u{f7a4}"
        case .markAsUnreadRegular: return "\u{f7a5}"
        case .markdownBold: return "\u{f7a6}"
        case .markdownFilled: return "\u{f7a7}"
        case .markdownLight: return "\u{f7a8}"
        case .markdownRegular: return "\u{f7a9}"
        case .markerBold: return "\u{f7aa}"
        case .markerFilled: return "\u{f7ab}"
        case .markerLight: return "\u{f7ac}"
        case .markerRegular: return "\u{f7ad}"
        case .maximizeBold: return "\u{f7ae}"
        case .maximizeLight: return "\u{f7af}"
        case .maximizeRegular: return "\u{f7b0}"
        case .mcpBold: return "\u{f7b1}"
        case .mcpFilled: return "\u{f7b2}"
        case .mcpLight: return "\u{f7b3}"
        case .mcpRegular: return "\u{f7b4}"
        case .mediaPlayerBold: return "\u{f7b5}"
        case .mediaPlayerLight: return "\u{f7b6}"
        case .mediaPlayerRegular: return "\u{f7b7}"
        case .mediaQualityGoodBold: return "\u{f7b8}"
        case .mediaQualityGoodFilled: return "\u{f7b9}"
        case .mediaQualityGoodLight: return "\u{f7ba}"
        case .mediaQualityGoodRegular: return "\u{f7bb}"
        case .mediaQualityPoorBold: return "\u{f7bc}"
        case .mediaQualityPoorColoredBold: return "\u{f7bd}"
        case .mediaQualityPoorFilled: return "\u{f7be}"
        case .mediaQualityPoorLight: return "\u{f7bf}"
        case .mediaQualityPoorRegular: return "\u{f7c0}"
        case .mediaQualityUnstableBold: return "\u{f7c1}"
        case .mediaQualityUnstableColoredBold: return "\u{f7c2}"
        case .mediaQualityUnstableFilled: return "\u{f7c3}"
        case .mediaQualityUnstableLight: return "\u{f7c4}"
        case .mediaQualityUnstableRegular: return "\u{f7c5}"
        case .meetBold: return "\u{f7c6}"
        case .meetEndBold: return "\u{f7c7}"
        case .meetEndLight: return "\u{f7c8}"
        case .meetEndRegular: return "\u{f7c9}"
        case .meetFilled: return "\u{f7ca}"
        case .meetLight: return "\u{f7cb}"
        case .meetRegular: return "\u{f7cc}"
        case .meetingSummaryBold: return "\u{f7cd}"
        case .meetingSummaryFilled: return "\u{f7ce}"
        case .meetingSummaryLight: return "\u{f7cf}"
        case .meetingSummaryRegular: return "\u{f7d0}"
        case .meetingsBold: return "\u{f7d1}"
        case .meetingsFilled: return "\u{f7d2}"
        case .meetingsFocusMonthBold: return "\u{f7d3}"
        case .meetingsFocusMonthLight: return "\u{f7d4}"
        case .meetingsFocusMonthRegular: return "\u{f7d5}"
        case .meetingsFocusOneDayBold: return "\u{f7d6}"
        case .meetingsFocusOneDayLight: return "\u{f7d7}"
        case .meetingsFocusOneDayRegular: return "\u{f7d8}"
        case .meetingsFocusThreeDayBold: return "\u{f7d9}"
        case .meetingsFocusThreeDayLight: return "\u{f7da}"
        case .meetingsFocusThreeDayRegular: return "\u{f7db}"
        case .meetingsFocusUpcomingBold: return "\u{f7dc}"
        case .meetingsFocusUpcomingLight: return "\u{f7dd}"
        case .meetingsFocusUpcomingRegular: return "\u{f7de}"
        case .meetingsLight: return "\u{f7df}"
        case .meetingsPresenceBadgeFilled: return "\u{f7e0}"
        case .meetingsPresenceBold: return "\u{f7e1}"
        case .meetingsPresenceFilled: return "\u{f7e2}"
        case .meetingsPresenceLight: return "\u{f7e3}"
        case .meetingsPresenceRegular: return "\u{f7e4}"
        case .meetingsRegular: return "\u{f7e5}"
        case .meetingsTeamBold: return "\u{f7e6}"
        case .meetingsTeamFilled: return "\u{f7e7}"
        case .meetingsTeamLight: return "\u{f7e8}"
        case .meetingsTeamNewBold: return "\u{f7e9}"
        case .meetingsTeamNewLight: return "\u{f7ea}"
        case .meetingsTeamNewRegular: return "\u{f7eb}"
        case .meetingsTeamRegular: return "\u{f7ec}"
        case .mentionBold: return "\u{f7ed}"
        case .mentionFilled: return "\u{f7ee}"
        case .mentionLight: return "\u{f7ef}"
        case .mentionRegular: return "\u{f7f0}"
        case .messageQueingBold: return "\u{f7f1}"
        case .messageQueingLight: return "\u{f7f2}"
        case .messageQueingRegular: return "\u{f7f3}"
        case .microphoneBold: return "\u{f7f4}"
        case .microphoneFilled: return "\u{f7f5}"
        case .microphoneHardMutedBold: return "\u{f7f6}"
        case .microphoneHardMutedCircleFilled: return "\u{f7f7}"
        case .microphoneHardMutedLight: return "\u{f7f8}"
        case .microphoneHardMutedRegular: return "\u{f7f9}"
        case .microphoneLight: return "\u{f7fa}"
        case .microphoneMusicModeBold: return "\u{f7fb}"
        case .microphoneMusicModeLight: return "\u{f7fc}"
        case .microphoneMusicModeOnBold: return "\u{f7fd}"
        case .microphoneMusicModeOnHighBold: return "\u{f7fe}"
        case .microphoneMusicModeOnHighFilled: return "\u{f7ff}"
        case .microphoneMusicModeOnHighLight: return "\u{f800}"
        case .microphoneMusicModeOnHighRegular: return "\u{f801}"
        case .microphoneMusicModeOnLight: return "\u{f802}"
        case .microphoneMusicModeOnLowBold: return "\u{f803}"
        case .microphoneMusicModeOnLowFilled: return "\u{f804}"
        case .microphoneMusicModeOnLowLight: return "\u{f805}"
        case .microphoneMusicModeOnLowRegular: return "\u{f806}"
        case .microphoneMusicModeOnRegular: return "\u{f807}"
        case .microphoneMusicModeRegular: return "\u{f808}"
        case .microphoneMutedBold: return "\u{f809}"
        case .microphoneMutedCircleFilled: return "\u{f80a}"
        case .microphoneMutedFilled: return "\u{f80b}"
        case .microphoneMutedLight: return "\u{f80c}"
        case .microphoneMutedRegular: return "\u{f80d}"
        case .microphoneOnBold: return "\u{f80e}"
        case .microphoneOnHighBold: return "\u{f80f}"
        case .microphoneOnHighFilled: return "\u{f810}"
        case .microphoneOnHighLight: return "\u{f811}"
        case .microphoneOnHighRegular: return "\u{f812}"
        case .microphoneOnLight: return "\u{f813}"
        case .microphoneOnLowBold: return "\u{f814}"
        case .microphoneOnLowFilled: return "\u{f815}"
        case .microphoneOnLowLight: return "\u{f816}"
        case .microphoneOnLowRegular: return "\u{f817}"
        case .microphoneOnRegular: return "\u{f818}"
        case .microphoneOptAllBold: return "\u{f819}"
        case .microphoneOptAllLight: return "\u{f81a}"
        case .microphoneOptAllMutedBold: return "\u{f81b}"
        case .microphoneOptAllMutedLight: return "\u{f81c}"
        case .microphoneOptAllMutedRegular: return "\u{f81d}"
        case .microphoneOptAllOnBold: return "\u{f81e}"
        case .microphoneOptAllOnHighBold: return "\u{f81f}"
        case .microphoneOptAllOnHighFilled: return "\u{f820}"
        case .microphoneOptAllOnHighLight: return "\u{f821}"
        case .microphoneOptAllOnHighRegular: return "\u{f822}"
        case .microphoneOptAllOnLight: return "\u{f823}"
        case .microphoneOptAllOnLowBold: return "\u{f824}"
        case .microphoneOptAllOnLowFilled: return "\u{f825}"
        case .microphoneOptAllOnLowLight: return "\u{f826}"
        case .microphoneOptAllOnLowRegular: return "\u{f827}"
        case .microphoneOptAllOnRegular: return "\u{f828}"
        case .microphoneOptAllRegular: return "\u{f829}"
        case .microphoneOptMeBold: return "\u{f82a}"
        case .microphoneOptMeLight: return "\u{f82b}"
        case .microphoneOptMeMutedBold: return "\u{f82c}"
        case .microphoneOptMeMutedLight: return "\u{f82d}"
        case .microphoneOptMeMutedRegular: return "\u{f82e}"
        case .microphoneOptMeOnBold: return "\u{f82f}"
        case .microphoneOptMeOnHighBold: return "\u{f830}"
        case .microphoneOptMeOnHighFilled: return "\u{f831}"
        case .microphoneOptMeOnHighLight: return "\u{f832}"
        case .microphoneOptMeOnHighRegular: return "\u{f833}"
        case .microphoneOptMeOnLight: return "\u{f834}"
        case .microphoneOptMeOnLowBol: return "\u{f835}"
        case .microphoneOptMeOnLowFilled: return "\u{f836}"
        case .microphoneOptMeOnLowLight: return "\u{f837}"
        case .microphoneOptMeOnLowRegular: return "\u{f838}"
        case .microphoneOptMeOnRegular: return "\u{f839}"
        case .microphoneOptMeRegular: return "\u{f83a}"
        case .microphoneRegular: return "\u{f83b}"
        case .mindMapBold: return "\u{f83c}"
        case .mindMapLight: return "\u{f83d}"
        case .mindMapRegular: return "\u{f83e}"
        case .minimizeBold: return "\u{f83f}"
        case .minimizeLight: return "\u{f840}"
        case .minimizeRegular: return "\u{f841}"
        case .minusBold: return "\u{f842}"
        case .minusFilled: return "\u{f843}"
        case .minusLight: return "\u{f844}"
        case .minusRegular: return "\u{f845}"
        case .mirrorBold: return "\u{f846}"
        case .mirrorFilled: return "\u{f847}"
        case .mirrorLight: return "\u{f848}"
        case .mirrorRegular: return "\u{f849}"
        case .mmsFilled: return "\u{f84a}"
        case .moderatorBold: return "\u{f84b}"
        case .moderatorLight: return "\u{f84c}"
        case .moderatorRegular: return "\u{f84d}"
        case .monitoringBold: return "\u{f84e}"
        case .monitoringLight: return "\u{f84f}"
        case .monitoringRegular: return "\u{f850}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f851}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f852}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f853}"
        case .moreAdrBold: return "\u{f854}"
        case .moreAdrLight: return "\u{f855}"
        case .moreAdrRegular: return "\u{f856}"
        case .moreBold: return "\u{f857}"
        case .moreCircleBold: return "\u{f858}"
        case .moreCircleFilled: return "\u{f859}"
        case .moreCircleLight: return "\u{f85a}"
        case .moreCircleRegular: return "\u{f85b}"
        case .moreLight: return "\u{f85c}"
        case .moreRegular: return "\u{f85d}"
        case .mouseCursorBold: return "\u{f85e}"
        case .mouseCursorLight: return "\u{f85f}"
        case .mouseCursorRegular: return "\u{f860}"
        case .moveCallInAdrBold: return "\u{f861}"
        case .moveCallInAdrLight: return "\u{f862}"
        case .moveCallInAdrRegular: return "\u{f863}"
        case .moveCallInIphBold: return "\u{f864}"
        case .moveCallInIphLight: return "\u{f865}"
        case .moveCallInIphRegular: return "\u{f866}"
        case .moveCallInLaptopBold: return "\u{f867}"
        case .moveCallInLaptopLight: return "\u{f868}"
        case .moveCallInLaptopRegular: return "\u{f869}"
        case .moveCallInOutAdrBold: return "\u{f86a}"
        case .moveCallInOutAdrLight: return "\u{f86b}"
        case .moveCallInOutAdrRegular: return "\u{f86c}"
        case .moveCallInOutIphBold: return "\u{f86d}"
        case .moveCallInOutIphLight: return "\u{f86e}"
        case .moveCallInOutIphRegular: return "\u{f86f}"
        case .moveCallInTabletBold: return "\u{f870}"
        case .moveCallInTabletLight: return "\u{f871}"
        case .moveCallInTabletRegular: return "\u{f872}"
        case .moveCallOutAdrBold: return "\u{f873}"
        case .moveCallOutAdrLight: return "\u{f874}"
        case .moveCallOutAdrRegular: return "\u{f875}"
        case .moveCallOutIphBold: return "\u{f876}"
        case .moveCallOutIphLight: return "\u{f877}"
        case .moveCallOutIphRegular: return "\u{f878}"
        case .moveCallOutLaptopBold: return "\u{f879}"
        case .moveCallOutLaptopLight: return "\u{f87a}"
        case .moveCallOutLaptopRegular: return "\u{f87b}"
        case .moveCallOutTabletBold: return "\u{f87c}"
        case .moveCallOutTabletLight: return "\u{f87d}"
        case .moveCallOutTabletRegular: return "\u{f87e}"
        case .moveToBottomBold: return "\u{f87f}"
        case .moveToBottomFilled: return "\u{f880}"
        case .moveToBottomLight: return "\u{f881}"
        case .moveToBottomRegular: return "\u{f882}"
        case .moveToScreenBold: return "\u{f883}"
        case .moveToScreenLight: return "\u{f884}"
        case .moveToScreenRegular: return "\u{f885}"
        case .moveToTopBold: return "\u{f886}"
        case .moveToTopFilled: return "\u{f887}"
        case .moveToTopLight: return "\u{f888}"
        case .moveToTopRegular: return "\u{f889}"
        case .multilineChartBold: return "\u{f88a}"
        case .multilineChartFilled: return "\u{f88b}"
        case .multilineChartLight: return "\u{f88c}"
        case .multilineChartRegular: return "\u{f88d}"
        case .multimediaBold: return "\u{f88e}"
        case .multimediaFilled: return "\u{f88f}"
        case .multimediaLight: return "\u{f890}"
        case .multimediaRegular: return "\u{f891}"
        case .multipledDevicesBold: return "\u{f892}"
        case .multipledDevicesFilled: return "\u{f893}"
        case .multipledDevicesLight: return "\u{f894}"
        case .multipledDevicesRegular: return "\u{f895}"
        case .musicModeCircleBold: return "\u{f896}"
        case .musicModeCircleFilled: return "\u{f897}"
        case .musicModeCircleLight: return "\u{f898}"
        case .musicModeCircleRegular: return "\u{f899}"
        case .musicNoteBold: return "\u{f89a}"
        case .musicNoteFilled: return "\u{f89b}"
        case .musicNoteLight: return "\u{f89c}"
        case .musicNoteRegular: return "\u{f89d}"
        case .muteOnEntryBold: return "\u{f89e}"
        case .muteOnEntryFilled: return "\u{f89f}"
        case .muteOnEntryLight: return "\u{f8a0}"
        case .muteOnEntryRegular: return "\u{f8a1}"
        case .networkSwitchBold: return "\u{f8a2}"
        case .networkSwitchFilled: return "\u{f8a3}"
        case .networkSwitchLight: return "\u{f8a4}"
        case .networkSwitchRegular: return "\u{f8a5}"
        case .newManagerBold: return "\u{f8a6}"
        case .newManagerFilled: return "\u{f8a7}"
        case .newManagerLight: return "\u{f8a8}"
        case .newManagerRegular: return "\u{f8a9}"
        case .newTitleBold: return "\u{f8aa}"
        case .newTitleLight: return "\u{f8ab}"
        case .newTitleRegular: return "\u{f8ac}"
        case .newVoicemailBold: return "\u{f8ad}"
        case .newVoicemailLight: return "\u{f8ae}"
        case .newVoicemailRegular: return "\u{f8af}"
        case .newWhiteboardBold: return "\u{f8b0}"
        case .newWhiteboardLight: return "\u{f8b1}"
        case .newWhiteboardRegular: return "\u{f8b2}"
        case .nextBold: return "\u{f8b3}"
        case .nextLight: return "\u{f8b4}"
        case .nextRegular: return "\u{f8b5}"
        case .noDevicesBold: return "\u{f8b6}"
        case .noDevicesLight: return "\u{f8b7}"
        case .noDevicesRegular: return "\u{f8b8}"
        case .noiseDetectedCanceledFilled: return "\u{f8b9}"
        case .noiseDetectedFilled: return "\u{f8ba}"
        case .noiseNoneCanceledFilled: return "\u{f8bb}"
        case .noiseNoneFilled: return "\u{f8bc}"
        case .noiseRemovalBold: return "\u{f8bd}"
        case .noiseRemovalLight: return "\u{f8be}"
        case .noiseRemovalRegular: return "\u{f8bf}"
        case .noteBold: return "\u{f8c0}"
        case .noteFilled: return "\u{f8c1}"
        case .noteLight: return "\u{f8c2}"
        case .notePptBold: return "\u{f8c3}"
        case .notePptLight: return "\u{f8c4}"
        case .notePptRegular: return "\u{f8c5}"
        case .noteRegular: return "\u{f8c6}"
        case .notesBold: return "\u{f8c7}"
        case .notesFilled: return "\u{f8c8}"
        case .notesLight: return "\u{f8c9}"
        case .notesRegular: return "\u{f8ca}"
        case .numberBold: return "\u{f8cb}"
        case .numberHighlightBold: return "\u{f8cc}"
        case .numberHighlightFilled: return "\u{f8cd}"
        case .numberHighlightLight: return "\u{f8ce}"
        case .numberHighlightRegular: return "\u{f8cf}"
        case .numberLight: return "\u{f8d0}"
        case .numberRegular: return "\u{f8d1}"
        case .oldRemoteBold: return "\u{f8d2}"
        case .oldRemoteLight: return "\u{f8d3}"
        case .oldRemoteRegular: return "\u{f8d4}"
        case .oldTouchBold: return "\u{f8d5}"
        case .oldTouchLight: return "\u{f8d6}"
        case .oldTouchRegular: return "\u{f8d7}"
        case .oneColumnBold: return "\u{f8d8}"
        case .oneColumnLight: return "\u{f8d9}"
        case .oneColumnRegular: return "\u{f8da}"
        case .oneTimeBold: return "\u{f8db}"
        case .oneTimeLight: return "\u{f8dc}"
        case .oneTimeRegular: return "\u{f8dd}"
        case .openInFolderBold: return "\u{f8de}"
        case .openInFolderFilled: return "\u{f8df}"
        case .openInFolderLight: return "\u{f8e0}"
        case .openInFolderRegular: return "\u{f8e1}"
        case .openPagesBold: return "\u{f8e2}"
        case .openPagesLight: return "\u{f8e3}"
        case .openPagesRegular: return "\u{f8e4}"
        case .otherNumberBold: return "\u{f8e5}"
        case .otherNumberFilled: return "\u{f8e6}"
        case .otherNumberLight: return "\u{f8e7}"
        case .otherNumberRegular: return "\u{f8e8}"
        case .otherNumberWarningBold: return "\u{f8e9}"
        case .otherNumberWarningLight: return "\u{f8ea}"
        case .otherNumberWarningRegular: return "\u{f8eb}"
        case .outgoingCallLegacyBold: return "\u{f8ec}"
        case .outgoingCallLegacyFilled: return "\u{f8ed}"
        case .outgoingCallLegacyLight: return "\u{f8ee}"
        case .outgoingCallLegacyRegular: return "\u{f8ef}"
        case .overflowLeftBold: return "\u{f8f0}"
        case .overflowLeftLight: return "\u{f8f1}"
        case .overflowLeftRegular: return "\u{f8f2}"
        case .overflowRightBold: return "\u{f8f3}"
        case .overflowRightLight: return "\u{f8f4}"
        case .overflowRightRegular: return "\u{f8f5}"
        case .pairedCameraBold: return "\u{f8f6}"
        case .pairedCameraLight: return "\u{f8f7}"
        case .pairedCameraRegular: return "\u{f8f8}"
        case .pairedDeviceBold: return "\u{f8f9}"
        case .pairedDeviceLight: return "\u{f8fa}"
        case .pairedDeviceRegular: return "\u{f8fb}"
        case .pairedHandsetBold: return "\u{f8fc}"
        case .pairedHandsetLight: return "\u{f8fd}"
        case .pairedHandsetRegular: return "\u{f8fe}"
        case .pairingBold: return "\u{f8ff}"
        case .pairingLight: return "\u{f900}"
        case .pairingRegular: return "\u{f901}"
        case .parenthesisBold: return "\u{f902}"
        case .parenthesisFilled: return "\u{f903}"
        case .parenthesisLight: return "\u{f904}"
        case .parenthesisRegular: return "\u{f905}"
        case .parkedBold: return "\u{f906}"
        case .parkedFilled: return "\u{f907}"
        case .parkedLight: return "\u{f908}"
        case .parkedRegular: return "\u{f909}"
        case .parseBold: return "\u{f90a}"
        case .parseLight: return "\u{f90b}"
        case .parseRegular: return "\u{f90c}"
        case .partialBold: return "\u{f90d}"
        case .partialLight: return "\u{f90e}"
        case .partialRegular: return "\u{f90f}"
        case .participantAddBold: return "\u{f910}"
        case .participantAddLight: return "\u{f911}"
        case .participantAddRegular: return "\u{f912}"
        case .participantBlockedBold: return "\u{f913}"
        case .participantBlockedLight: return "\u{f914}"
        case .participantBlockedRegular: return "\u{f915}"
        case .participantBold: return "\u{f916}"
        case .participantFilled: return "\u{f917}"
        case .participantLight: return "\u{f918}"
        case .participantListBold: return "\u{f919}"
        case .participantListFilled: return "\u{f91a}"
        case .participantListLight: return "\u{f91b}"
        case .participantListRegular: return "\u{f91c}"
        case .participantRegular: return "\u{f91d}"
        case .participantRemoveBold: return "\u{f91e}"
        case .participantRemoveLight: return "\u{f91f}"
        case .participantRemoveRegular: return "\u{f920}"
        case .participantSpeakerBold: return "\u{f921}"
        case .participantSpeakerFilled: return "\u{f922}"
        case .participantSpeakerLight: return "\u{f923}"
        case .participantSpeakerRegular: return "\u{f924}"
        case .participantUnknownBold: return "\u{f925}"
        case .participantUnknownLight: return "\u{f926}"
        case .participantUnknownRegular: return "\u{f927}"
        case .passMouseBold: return "\u{f928}"
        case .passMouseLight: return "\u{f929}"
        case .passMouseRegular: return "\u{f92a}"
        case .pauseBadgeFilled: return "\u{f92b}"
        case .pauseBold: return "\u{f92c}"
        case .pauseFilled: return "\u{f92d}"
        case .pauseInteractionBold: return "\u{f92e}"
        case .pauseInteractionFilled: return "\u{f92f}"
        case .pauseInteractionLight: return "\u{f930}"
        case .pauseInteractionRegular: return "\u{f931}"
        case .pauseLight: return "\u{f932}"
        case .pauseRegular: return "\u{f933}"
        case .peopleAddBold: return "\u{f934}"
        case .peopleAddFilled: return "\u{f935}"
        case .peopleAddLight: return "\u{f936}"
        case .peopleAddRegular: return "\u{f937}"
        case .peopleBold: return "\u{f938}"
        case .peopleCircleBold: return "\u{f939}"
        case .peopleCircleFilled: return "\u{f93a}"
        case .peopleCircleLight: return "\u{f93b}"
        case .peopleCircleRegular: return "\u{f93c}"
        case .peopleFilled: return "\u{f93d}"
        case .peopleInsightsBold: return "\u{f93e}"
        case .peopleInsightsFilled: return "\u{f93f}"
        case .peopleInsightsLight: return "\u{f940}"
        case .peopleInsightsRegular: return "\u{f941}"
        case .peopleLight: return "\u{f942}"
        case .peopleManageBold: return "\u{f943}"
        case .peopleManageFilled: return "\u{f944}"
        case .peopleManageLight: return "\u{f945}"
        case .peopleManageRegular: return "\u{f946}"
        case .peopleRegular: return "\u{f947}"
        case .phoneAlertBold: return "\u{f948}"
        case .phoneAlertLight: return "\u{f949}"
        case .phoneAlertRegular: return "\u{f94a}"
        case .phoneBadgeFilled: return "\u{f94b}"
        case .phoneBold: return "\u{f94c}"
        case .phoneFilled: return "\u{f94d}"
        case .phoneLight: return "\u{f94e}"
        case .phoneMutedBold: return "\u{f94f}"
        case .phoneMutedLight: return "\u{f950}"
        case .phoneMutedRegular: return "\u{f951}"
        case .phonePrivateBold: return "\u{f952}"
        case .phonePrivateLight: return "\u{f953}"
        case .phonePrivateRegular: return "\u{f954}"
        case .phoneRegular: return "\u{f955}"
        case .phoneReplyAllBold: return "\u{f956}"
        case .phoneReplyAllLight: return "\u{f957}"
        case .phoneReplyAllRegular: return "\u{f958}"
        case .phoneReplyBold: return "\u{f959}"
        case .phoneReplyLight: return "\u{f95a}"
        case .phoneReplyRegular: return "\u{f95b}"
        case .pickerBold: return "\u{f95c}"
        case .pickerLight: return "\u{f95d}"
        case .pickerRegular: return "\u{f95e}"
        case .pieChartBold: return "\u{f95f}"
        case .pieChartFilled: return "\u{f960}"
        case .pieChartLight: return "\u{f961}"
        case .pieChartRegular: return "\u{f962}"
        case .pinBold: return "\u{f963}"
        case .pinFilled: return "\u{f964}"
        case .pinLight: return "\u{f965}"
        case .pinListActivityBold: return "\u{f966}"
        case .pinListActivityLight: return "\u{f967}"
        case .pinListActivityRegular: return "\u{f968}"
        case .pinListBold: return "\u{f969}"
        case .pinListLight: return "\u{f96a}"
        case .pinListRegular: return "\u{f96b}"
        case .pinMutedBold: return "\u{f96c}"
        case .pinMutedFilled: return "\u{f96d}"
        case .pinMutedLight: return "\u{f96e}"
        case .pinMutedRegular: return "\u{f96f}"
        case .pinRegular: return "\u{f970}"
        case .pipBold: return "\u{f971}"
        case .pipEnterBold: return "\u{f972}"
        case .pipEnterLight: return "\u{f973}"
        case .pipEnterRegular: return "\u{f974}"
        case .pipExitBold: return "\u{f975}"
        case .pipExitLight: return "\u{f976}"
        case .pipExitRegular: return "\u{f977}"
        case .pipFilled: return "\u{f978}"
        case .pipLight: return "\u{f979}"
        case .pipRegular: return "\u{f97a}"
        case .placeholderBold: return "\u{f97b}"
        case .placeholderFilled: return "\u{f97c}"
        case .placeholderLight: return "\u{f97d}"
        case .placeholderRegular: return "\u{f97e}"
        case .playBold: return "\u{f97f}"
        case .playCircleBold: return "\u{f980}"
        case .playCircleFilled: return "\u{f981}"
        case .playCircleLight: return "\u{f982}"
        case .playCircleRegular: return "\u{f983}"
        case .playFilled: return "\u{f984}"
        case .playLight: return "\u{f985}"
        case .playRegular: return "\u{f986}"
        case .plugAcBold: return "\u{f987}"
        case .plugAcLight: return "\u{f988}"
        case .plugAcRegular: return "\u{f989}"
        case .plusBold: return "\u{f98a}"
        case .plusCircleBold: return "\u{f98b}"
        case .plusCircleFilled: return "\u{f98c}"
        case .plusCircleLight: return "\u{f98d}"
        case .plusCircleRegular: return "\u{f98e}"
        case .plusLight: return "\u{f98f}"
        case .plusRegular: return "\u{f990}"
        case .pmrBold: return "\u{f991}"
        case .pmrFilled: return "\u{f992}"
        case .pmrLight: return "\u{f993}"
        case .pmrRegular: return "\u{f994}"
        case .pollBold: return "\u{f995}"
        case .pollFilled: return "\u{f996}"
        case .pollLight: return "\u{f997}"
        case .pollRegular: return "\u{f998}"
        case .popInBold: return "\u{f999}"
        case .popInLight: return "\u{f99a}"
        case .popInRegular: return "\u{f99b}"
        case .popOutBold: return "\u{f99c}"
        case .popOutLight: return "\u{f99d}"
        case .popOutRegular: return "\u{f99e}"
        case .popUpBold: return "\u{f99f}"
        case .popUpLight: return "\u{f9a0}"
        case .popUpRegular: return "\u{f9a1}"
        case .portraitLandscapeBold: return "\u{f9a2}"
        case .portraitLandscapeLight: return "\u{f9a3}"
        case .portraitLandscapeRegular: return "\u{f9a4}"
        case .potentialFraudBold: return "\u{f9a5}"
        case .potentialFraudFilled: return "\u{f9a6}"
        case .potentialFraudLight: return "\u{f9a7}"
        case .potentialFraudRegular: return "\u{f9a8}"
        case .powerAcBold: return "\u{f9a9}"
        case .powerAcLight: return "\u{f9aa}"
        case .powerAcRegular: return "\u{f9ab}"
        case .powerBold: return "\u{f9ac}"
        case .powerLight: return "\u{f9ad}"
        case .powerRegular: return "\u{f9ae}"
        case .preHeaderBold: return "\u{f9af}"
        case .preHeaderLight: return "\u{f9b0}"
        case .preHeaderRegular: return "\u{f9b1}"
        case .premiumBold: return "\u{f9b2}"
        case .premiumLight: return "\u{f9b3}"
        case .premiumRegular: return "\u{f9b4}"
        case .presentationBold: return "\u{f9b5}"
        case .presentationLight: return "\u{f9b6}"
        case .presentationRegular: return "\u{f9b7}"
        case .preventDownloadBold: return "\u{f9b8}"
        case .preventDownloadFilled: return "\u{f9b9}"
        case .preventDownloadLight: return "\u{f9ba}"
        case .preventDownloadRegular: return "\u{f9bb}"
        case .primaryParticipantBold: return "\u{f9bc}"
        case .primaryParticipantFilled: return "\u{f9bd}"
        case .primaryParticipantLight: return "\u{f9be}"
        case .primaryParticipantRegular: return "\u{f9bf}"
        case .printBold: return "\u{f9c0}"
        case .printLight: return "\u{f9c1}"
        case .printRegular: return "\u{f9c2}"
        case .priorityBadgeFilled: return "\u{f9c3}"
        case .priorityCircleBold: return "\u{f9c4}"
        case .priorityCircleFilled: return "\u{f9c5}"
        case .priorityCircleLight: return "\u{f9c6}"
        case .priorityCircleRegular: return "\u{f9c7}"
        case .priorityCircleTwoBold: return "\u{f9c8}"
        case .priorityCircleTwoFilled: return "\u{f9c9}"
        case .priorityCircleTwoLight: return "\u{f9ca}"
        case .priorityCircleTwoRegular: return "\u{f9cb}"
        case .priorityWaveBold: return "\u{f9cc}"
        case .priorityWaveLight: return "\u{f9cd}"
        case .priorityWaveRegular: return "\u{f9ce}"
        case .privacyCircleBold: return "\u{f9cf}"
        case .privacyCircleFilled: return "\u{f9d0}"
        case .privacyCircleLight: return "\u{f9d1}"
        case .privacyCircleRegular: return "\u{f9d2}"
        case .privateBold: return "\u{f9d3}"
        case .privateCircleBold: return "\u{f9d4}"
        case .privateCircleFilled: return "\u{f9d5}"
        case .privateCircleLight: return "\u{f9d6}"
        case .privateCircleRegular: return "\u{f9d7}"
        case .privateLight: return "\u{f9d8}"
        case .privateMeetingBold: return "\u{f9d9}"
        case .privateMeetingLight: return "\u{f9da}"
        case .privateMeetingRegular: return "\u{f9db}"
        case .privateRegular: return "\u{f9dc}"
        case .productDemoBold: return "\u{f9dd}"
        case .productDemoLight: return "\u{f9de}"
        case .productDemoRegular: return "\u{f9df}"
        case .promptsAiBold: return "\u{f9e0}"
        case .promptsAiLight: return "\u{f9e1}"
        case .promptsAiRegular: return "\u{f9e2}"
        case .proximityBold: return "\u{f9e3}"
        case .proximityLight: return "\u{f9e4}"
        case .proximityMutedBold: return "\u{f9e5}"
        case .proximityMutedLight: return "\u{f9e6}"
        case .proximityMutedRegular: return "\u{f9e7}"
        case .proximityRegular: return "\u{f9e8}"
        case .proximityVideoBold: return "\u{f9e9}"
        case .proximityVideoLight: return "\u{f9ea}"
        case .proximityVideoRegular: return "\u{f9eb}"
        case .ptoPresenceBold: return "\u{f9ec}"
        case .ptoPresenceFilled: return "\u{f9ed}"
        case .ptoPresenceLight: return "\u{f9ee}"
        case .ptoPresenceRegular: return "\u{f9ef}"
        case .pullCallBold: return "\u{f9f0}"
        case .pullCallFilled: return "\u{f9f1}"
        case .pullCallLight: return "\u{f9f2}"
        case .pullCallRegular: return "\u{f9f3}"
        case .purchaseOrderBold: return "\u{f9f4}"
        case .purchaseOrderFilled: return "\u{f9f5}"
        case .purchaseOrderLight: return "\u{f9f6}"
        case .purchaseOrderRegular: return "\u{f9f7}"
        case .qABold: return "\u{f9f8}"
        case .qAFilled: return "\u{f9f9}"
        case .qALight: return "\u{f9fa}"
        case .qARegular: return "\u{f9fb}"
        case .qrCodeBold: return "\u{f9fc}"
        case .qrCodeLight: return "\u{f9fd}"
        case .qrCodeRegular: return "\u{f9fe}"
        case .qrCodeScanBold: return "\u{f9ff}"
        case .qrCodeScanLight: return "\u{fa00}"
        case .qrCodeScanRegular: return "\u{fa01}"
        case .qualityBold: return "\u{fa02}"
        case .qualityLight: return "\u{fa03}"
        case .qualityRegular: return "\u{fa04}"
        case .queueContactBold: return "\u{fa05}"
        case .queueContactFilled: return "\u{fa06}"
        case .queueContactLight: return "\u{fa07}"
        case .queueContactRegular: return "\u{fa08}"
        case .queuedInteractionBold: return "\u{fa09}"
        case .queuedInteractionFilled: return "\u{fa0a}"
        case .queuedInteractionLight: return "\u{fa0b}"
        case .queuedInteractionRegular: return "\u{fa0c}"
        case .quietBold: return "\u{fa0d}"
        case .quietHoursPresenceBold: return "\u{fa0e}"
        case .quietHoursPresenceFilled: return "\u{fa0f}"
        case .quietHoursPresenceLight: return "\u{fa10}"
        case .quietHoursPresenceRegular: return "\u{fa11}"
        case .quietLight: return "\u{fa12}"
        case .quietRegular: return "\u{fa13}"
        case .radioButtonGroupBold: return "\u{fa14}"
        case .radioButtonGroupLight: return "\u{fa15}"
        case .radioButtonGroupRegular: return "\u{fa16}"
        case .raiseHandBold: return "\u{fa17}"
        case .raiseHandCircleFilled: return "\u{fa18}"
        case .raiseHandFilled: return "\u{fa19}"
        case .raiseHandLight: return "\u{fa1a}"
        case .raiseHandRegular: return "\u{fa1b}"
        case .ramBold: return "\u{fa1c}"
        case .ramLight: return "\u{fa1d}"
        case .ramRegular: return "\u{fa1e}"
        case .reactionsBold: return "\u{fa1f}"
        case .reactionsFilled: return "\u{fa20}"
        case .reactionsLight: return "\u{fa21}"
        case .reactionsRegular: return "\u{fa22}"
        case .reactivateBold: return "\u{fa23}"
        case .reactivateLight: return "\u{fa24}"
        case .reactivateRegular: return "\u{fa25}"
        case .receiveVoiceBold: return "\u{fa26}"
        case .receiveVoiceFilled: return "\u{fa27}"
        case .receiveVoiceLight: return "\u{fa28}"
        case .receiveVoiceRegular: return "\u{fa29}"
        case .recentsBold: return "\u{fa2a}"
        case .recentsFilled: return "\u{fa2b}"
        case .recentsLight: return "\u{fa2c}"
        case .recentsPresenceBadgeFilled: return "\u{fa2d}"
        case .recentsPresenceBold: return "\u{fa2e}"
        case .recentsPresenceFilled: return "\u{fa2f}"
        case .recentsPresenceLight: return "\u{fa30}"
        case .recentsPresenceRegular: return "\u{fa31}"
        case .recentsRegular: return "\u{fa32}"
        case .recordActiveBadgeFilled: return "\u{fa33}"
        case .recordActiveBold: return "\u{fa34}"
        case .recordActiveFilled: return "\u{fa35}"
        case .recordActiveLight: return "\u{fa36}"
        case .recordActiveRegular: return "\u{fa37}"
        case .recordBold: return "\u{fa38}"
        case .recordFilled: return "\u{fa39}"
        case .recordLight: return "\u{fa3a}"
        case .recordPausedBadgeFilled: return "\u{fa3b}"
        case .recordPausedBold: return "\u{fa3c}"
        case .recordPausedFilled: return "\u{fa3d}"
        case .recordPausedLight: return "\u{fa3e}"
        case .recordPausedRegular: return "\u{fa3f}"
        case .recordRegular: return "\u{fa40}"
        case .recurringBold: return "\u{fa41}"
        case .recurringLight: return "\u{fa42}"
        case .recurringOffBold: return "\u{fa43}"
        case .recurringOffLight: return "\u{fa44}"
        case .recurringOffRegular: return "\u{fa45}"
        case .recurringRegular: return "\u{fa46}"
        case .redoBold: return "\u{fa47}"
        case .redoLight: return "\u{fa48}"
        case .redoRegular: return "\u{fa49}"
        case .refreshBold: return "\u{fa4a}"
        case .refreshLight: return "\u{fa4b}"
        case .refreshRegular: return "\u{fa4c}"
        case .remoteDesktopControlBold: return "\u{fa4d}"
        case .remoteDesktopControlFilled: return "\u{fa4e}"
        case .remoteDesktopControlLight: return "\u{fa4f}"
        case .remoteDesktopControlRegular: return "\u{fa50}"
        case .removeBold: return "\u{fa51}"
        case .removeFilled: return "\u{fa52}"
        case .removeLight: return "\u{fa53}"
        case .removeRegular: return "\u{fa54}"
        case .replyBold: return "\u{fa55}"
        case .replyFilled: return "\u{fa56}"
        case .replyLight: return "\u{fa57}"
        case .replyListBold: return "\u{fa58}"
        case .replyListFilled: return "\u{fa59}"
        case .replyListLight: return "\u{fa5a}"
        case .replyListRegular: return "\u{fa5b}"
        case .replyPrivatelyBold: return "\u{fa5c}"
        case .replyPrivatelyLight: return "\u{fa5d}"
        case .replyPrivatelyRegular: return "\u{fa5e}"
        case .replyRegular: return "\u{fa5f}"
        case .resetBold: return "\u{fa60}"
        case .resetLight: return "\u{fa61}"
        case .resetRegular: return "\u{fa62}"
        case .resizeCornerBold: return "\u{fa63}"
        case .resizeCornerLight: return "\u{fa64}"
        case .resizeCornerRegular: return "\u{fa65}"
        case .responsiveMobileBold: return "\u{fa66}"
        case .responsiveMobileLight: return "\u{fa67}"
        case .responsiveMobileRegular: return "\u{fa68}"
        case .restartBold: return "\u{fa69}"
        case .restartLight: return "\u{fa6a}"
        case .restartRegular: return "\u{fa6b}"
        case .resumeInteractionBold: return "\u{fa6c}"
        case .resumeInteractionFilled: return "\u{fa6d}"
        case .resumeInteractionLight: return "\u{fa6e}"
        case .resumeInteractionRegular: return "\u{fa6f}"
        case .retrieveCallBold: return "\u{fa70}"
        case .retrieveCallFilled: return "\u{fa71}"
        case .retrieveCallLight: return "\u{fa72}"
        case .retrieveCallRegular: return "\u{fa73}"
        case .returnBold: return "\u{fa74}"
        case .returnLight: return "\u{fa75}"
        case .returnRegular: return "\u{fa76}"
        case .rewindTenSecBold: return "\u{fa77}"
        case .rewindTenSecLight: return "\u{fa78}"
        case .rewindTenSecRegular: return "\u{fa79}"
        case .ringtoneBold: return "\u{fa7a}"
        case .ringtoneLight: return "\u{fa7b}"
        case .ringtoneRegular: return "\u{fa7c}"
        case .roomCalendarBold: return "\u{fa7d}"
        case .roomCalendarLight: return "\u{fa7e}"
        case .roomCalendarRegular: return "\u{fa7f}"
        case .roomLightsBold: return "\u{fa80}"
        case .roomLightsFilled: return "\u{fa81}"
        case .roomLightsLight: return "\u{fa82}"
        case .roomLightsRegular: return "\u{fa83}"
        case .rotateContentBold: return "\u{fa84}"
        case .rotateContentFilled: return "\u{fa85}"
        case .rotateContentLight: return "\u{fa86}"
        case .rotateContentRegular: return "\u{fa87}"
        case .rssBold: return "\u{fa88}"
        case .rssFilled: return "\u{fa89}"
        case .rssLight: return "\u{fa8a}"
        case .rssRegular: return "\u{fa8b}"
        case .ruleBasedBold: return "\u{fa8c}"
        case .ruleBasedFilled: return "\u{fa8d}"
        case .ruleBasedLight: return "\u{fa8e}"
        case .ruleBasedRegular: return "\u{fa8f}"
        case .rulerBold: return "\u{fa90}"
        case .rulerFilled: return "\u{fa91}"
        case .rulerLight: return "\u{fa92}"
        case .rulerRegular: return "\u{fa93}"
        case .runningApplicationBold: return "\u{fa94}"
        case .runningApplicationFilled: return "\u{fa95}"
        case .runningApplicationLight: return "\u{fa96}"
        case .runningApplicationRegular: return "\u{fa97}"
        case .saveBold: return "\u{fa98}"
        case .saveLight: return "\u{fa99}"
        case .saveRegular: return "\u{fa9a}"
        case .saveTranscriptBold: return "\u{fa9b}"
        case .saveTranscriptFilled: return "\u{fa9c}"
        case .saveTranscriptLight: return "\u{fa9d}"
        case .saveTranscriptRegular: return "\u{fa9e}"
        case .scanBold: return "\u{fa9f}"
        case .scanLight: return "\u{faa0}"
        case .scanRegular: return "\u{faa1}"
        case .scheduleAiBold: return "\u{faa2}"
        case .scheduleAiLight: return "\u{faa3}"
        case .scheduleAiRegular: return "\u{faa4}"
        case .scheduleSendBold: return "\u{faa5}"
        case .scheduleSendFilled: return "\u{faa6}"
        case .scheduleSendLight: return "\u{faa7}"
        case .scheduleSendRegular: return "\u{faa8}"
        case .scheduleWinnerBold: return "\u{faa9}"
        case .scheduleWinnerFilled: return "\u{faaa}"
        case .scheduleWinnerLight: return "\u{faab}"
        case .scheduleWinnerRegular: return "\u{faac}"
        case .schedulerAvailableBold: return "\u{faad}"
        case .schedulerAvailableLight: return "\u{faae}"
        case .schedulerAvailableRegular: return "\u{faaf}"
        case .schedulerNotWorkingHoursBold: return "\u{fab0}"
        case .schedulerNotWorkingHoursLight: return "\u{fab1}"
        case .schedulerNotWorkingHoursRegular: return "\u{fab2}"
        case .schedulerUnavailableBold: return "\u{fab3}"
        case .schedulerUnavailableLight: return "\u{fab4}"
        case .schedulerUnavailableRegular: return "\u{fab5}"
        case .schedulerUnknownBold: return "\u{fab6}"
        case .schedulerUnknownLight: return "\u{fab7}"
        case .schedulerUnknownRegular: return "\u{fab8}"
        case .screenshotBold: return "\u{fab9}"
        case .screenshotDocBold: return "\u{faba}"
        case .screenshotDocFilled: return "\u{fabb}"
        case .screenshotDocLight: return "\u{fabc}"
        case .screenshotDocRegular: return "\u{fabd}"
        case .screenshotLight: return "\u{fabe}"
        case .screenshotRegular: return "\u{fabf}"
        case .searchAiBold: return "\u{fac0}"
        case .searchAiLight: return "\u{fac1}"
        case .searchAiRegular: return "\u{fac2}"
        case .searchBold: return "\u{fac3}"
        case .searchFilled: return "\u{fac4}"
        case .searchLight: return "\u{fac5}"
        case .searchRegular: return "\u{fac6}"
        case .secondaryArrowBold: return "\u{fac7}"
        case .secondaryArrowLight: return "\u{fac8}"
        case .secondaryArrowRegular: return "\u{fac9}"
        case .secureCallLockBold: return "\u{faca}"
        case .secureCallLockFilled: return "\u{facb}"
        case .secureCallLockLight: return "\u{facc}"
        case .secureCallLockRegular: return "\u{facd}"
        case .secureCallShieldBold: return "\u{face}"
        case .secureCallShieldFilled: return "\u{facf}"
        case .secureCallShieldLight: return "\u{fad0}"
        case .secureCallShieldRegular: return "\u{fad1}"
        case .secureCircleBold: return "\u{fad2}"
        case .secureCircleFilled: return "\u{fad3}"
        case .secureCircleLight: return "\u{fad4}"
        case .secureCircleRegular: return "\u{fad5}"
        case .secureLockBold: return "\u{fad6}"
        case .secureLockFilled: return "\u{fad7}"
        case .secureLockLight: return "\u{fad8}"
        case .secureLockRegular: return "\u{fad9}"
        case .segmentExcludeFilled: return "\u{fada}"
        case .segmentFilterFilled: return "\u{fadb}"
        case .segmentIncludeFilled: return "\u{fadc}"
        case .selectAllBold: return "\u{fadd}"
        case .selectAllFilled: return "\u{fade}"
        case .selectAllLight: return "\u{fadf}"
        case .selectAllRegular: return "\u{fae0}"
        case .selectionBold: return "\u{fae1}"
        case .selectionFilled: return "\u{fae2}"
        case .selectionLight: return "\u{fae3}"
        case .selectionRegular: return "\u{fae4}"
        case .sendBold: return "\u{fae5}"
        case .sendDigitsBold: return "\u{fae6}"
        case .sendDigitsFilled: return "\u{fae7}"
        case .sendDigitsLight: return "\u{fae8}"
        case .sendDigitsRegular: return "\u{fae9}"
        case .sendFilled: return "\u{faea}"
        case .sendLight: return "\u{faeb}"
        case .sendRegular: return "\u{faec}"
        case .sendVoiceBold: return "\u{faed}"
        case .sendVoiceFilled: return "\u{faee}"
        case .sendVoiceLight: return "\u{faef}"
        case .sendVoiceRegular: return "\u{faf0}"
        case .serverBold: return "\u{faf1}"
        case .serverErrorBold: return "\u{faf2}"
        case .serverErrorLight: return "\u{faf3}"
        case .serverErrorRegular: return "\u{faf4}"
        case .serverLight: return "\u{faf5}"
        case .serverRegular: return "\u{faf6}"
        case .servicesBold: return "\u{faf7}"
        case .servicesLight: return "\u{faf8}"
        case .servicesRegular: return "\u{faf9}"
        case .setVariableBold: return "\u{fafa}"
        case .setVariableLight: return "\u{fafb}"
        case .setVariableRegular: return "\u{fafc}"
        case .settingsBold: return "\u{fafd}"
        case .settingsFilled: return "\u{fafe}"
        case .settingsLight: return "\u{faff}"
        case .settingsRegular: return "\u{fb00}"
        case .setupAssistantBold: return "\u{fb01}"
        case .setupAssistantLight: return "\u{fb02}"
        case .setupAssistantRegular: return "\u{fb03}"
        case .sftpBold: return "\u{fb04}"
        case .sftpLight: return "\u{fb05}"
        case .sftpRegular: return "\u{fb06}"
        case .shapeCircleBold: return "\u{fb07}"
        case .shapeCircleFilled: return "\u{fb08}"
        case .shapeCircleLight: return "\u{fb09}"
        case .shapeCircleMdFilled: return "\u{fb0a}"
        case .shapeCircleRegular: return "\u{fb0b}"
        case .shapeCircleSmFilled: return "\u{fb0c}"
        case .shapeDiagonalLineBold: return "\u{fb0d}"
        case .shapeDiagonalLineLight: return "\u{fb0e}"
        case .shapeDiagonalLineRegular: return "\u{fb0f}"
        case .shapeDiamondBold: return "\u{fb10}"
        case .shapeDiamondFilled: return "\u{fb11}"
        case .shapeDiamondLight: return "\u{fb12}"
        case .shapeDiamondRegular: return "\u{fb13}"
        case .shapeOvalBold: return "\u{fb14}"
        case .shapeOvalLight: return "\u{fb15}"
        case .shapeOvalRegular: return "\u{fb16}"
        case .shapeSquareBold: return "\u{fb17}"
        case .shapeSquareFilled: return "\u{fb18}"
        case .shapeSquareLight: return "\u{fb19}"
        case .shapeSquareRegular: return "\u{fb1a}"
        case .shapeTriangleBold: return "\u{fb1b}"
        case .shapeTriangleFilled: return "\u{fb1c}"
        case .shapeTriangleLight: return "\u{fb1d}"
        case .shapeTriangleRegular: return "\u{fb1e}"
        case .shapesBold: return "\u{fb1f}"
        case .shapesFilled: return "\u{fb20}"
        case .shapesLight: return "\u{fb21}"
        case .shapesRegular: return "\u{fb22}"
        case .shareCNativeAdrBold: return "\u{fb23}"
        case .shareCNativeAdrFilled: return "\u{fb24}"
        case .shareCNativeAdrLight: return "\u{fb25}"
        case .shareCNativeAdrRegular: return "\u{fb26}"
        case .shareCNativeIphBold: return "\u{fb27}"
        case .shareCNativeIphLight: return "\u{fb28}"
        case .shareCNativeIphRegular: return "\u{fb29}"
        case .shareContentOnDeviceBold: return "\u{fb2a}"
        case .shareContentOnDeviceLight: return "\u{fb2b}"
        case .shareContentOnDeviceRegular: return "\u{fb2c}"
        case .shareScreenAddBold: return "\u{fb2d}"
        case .shareScreenAddLight: return "\u{fb2e}"
        case .shareScreenAddRegular: return "\u{fb2f}"
        case .shareScreenBadgeFilled: return "\u{fb30}"
        case .shareScreenBold: return "\u{fb31}"
        case .shareScreenFilled: return "\u{fb32}"
        case .shareScreenLight: return "\u{fb33}"
        case .shareScreenRegular: return "\u{fb34}"
        case .shareSpaceBold: return "\u{fb35}"
        case .shareSpaceLight: return "\u{fb36}"
        case .shareSpaceRegular: return "\u{fb37}"
        case .shieldBold: return "\u{fb38}"
        case .shieldLight: return "\u{fb39}"
        case .shieldRegular: return "\u{fb3a}"
        case .shoppingCartBold: return "\u{fb3b}"
        case .shoppingCartFilled: return "\u{fb3c}"
        case .shoppingCartLight: return "\u{fb3d}"
        case .shoppingCartRegular: return "\u{fb3e}"
        case .shortTextBoxBold: return "\u{fb3f}"
        case .shortTextBoxLight: return "\u{fb40}"
        case .shortTextBoxRegular: return "\u{fb41}"
        case .showBold: return "\u{fb42}"
        case .showFilled: return "\u{fb43}"
        case .showLight: return "\u{fb44}"
        case .showRegular: return "\u{fb45}"
        case .sidePanelBold: return "\u{fb46}"
        case .sidePanelFilled: return "\u{fb47}"
        case .sidePanelLight: return "\u{fb48}"
        case .sidePanelRegular: return "\u{fb49}"
        case .signInBold: return "\u{fb4a}"
        case .signInFilled: return "\u{fb4b}"
        case .signInForcedBold: return "\u{fb4c}"
        case .signInForcedLight: return "\u{fb4d}"
        case .signInForcedRegular: return "\u{fb4e}"
        case .signInLight: return "\u{fb4f}"
        case .signInRegular: return "\u{fb50}"
        case .signLangIntBold: return "\u{fb51}"
        case .signLangIntLight: return "\u{fb52}"
        case .signLangIntRegular: return "\u{fb53}"
        case .signOutBold: return "\u{fb54}"
        case .signOutLight: return "\u{fb55}"
        case .signOutRegular: return "\u{fb56}"
        case .signalFourBold: return "\u{fb57}"
        case .signalFourLight: return "\u{fb58}"
        case .signalFourRegular: return "\u{fb59}"
        case .signalOneBold: return "\u{fb5a}"
        case .signalOneLight: return "\u{fb5b}"
        case .signalOneRegular: return "\u{fb5c}"
        case .signalThreeBold: return "\u{fb5d}"
        case .signalThreeLight: return "\u{fb5e}"
        case .signalThreeRegular: return "\u{fb5f}"
        case .signalTwoBold: return "\u{fb60}"
        case .signalTwoLight: return "\u{fb61}"
        case .signalTwoRegular: return "\u{fb62}"
        case .signalZeroBold: return "\u{fb63}"
        case .signalZeroLight: return "\u{fb64}"
        case .signalZeroRegular: return "\u{fb65}"
        case .simplePromotionBold: return "\u{fb66}"
        case .simplePromotionLight: return "\u{fb67}"
        case .simplePromotionRegular: return "\u{fb68}"
        case .singleNumberReachBold: return "\u{fb69}"
        case .singleNumberReachLight: return "\u{fb6a}"
        case .singleNumberReachRegular: return "\u{fb6b}"
        case .sipRegistrationInProgressBold: return "\u{fb6c}"
        case .sipRegistrationInProgressFilled: return "\u{fb6d}"
        case .sipRegistrationInProgressLight: return "\u{fb6e}"
        case .sipRegistrationInProgressRegular: return "\u{fb6f}"
        case .skipBold: return "\u{fb70}"
        case .skipBwBold: return "\u{fb71}"
        case .skipBwFilled: return "\u{fb72}"
        case .skipBwLight: return "\u{fb73}"
        case .skipBwRegular: return "\u{fb74}"
        case .skipFwBold: return "\u{fb75}"
        case .skipFwFilled: return "\u{fb76}"
        case .skipFwLight: return "\u{fb77}"
        case .skipFwRegular: return "\u{fb78}"
        case .skipLight: return "\u{fb79}"
        case .skipRegular: return "\u{fb7a}"
        case .smartAudioBold: return "\u{fb7b}"
        case .smartAudioLight: return "\u{fb7c}"
        case .smartAudioRegular: return "\u{fb7d}"
        case .smartReplyBold: return "\u{fb7e}"
        case .smartReplyLight: return "\u{fb7f}"
        case .smartReplyRegular: return "\u{fb80}"
        case .smsFilled: return "\u{fb81}"
        case .smsInboundBold: return "\u{fb82}"
        case .smsInboundLight: return "\u{fb83}"
        case .smsInboundRegular: return "\u{fb84}"
        case .smsMessageBold: return "\u{fb85}"
        case .smsMessageFilled: return "\u{fb86}"
        case .smsMessageLight: return "\u{fb87}"
        case .smsMessageOutgoingBold: return "\u{fb88}"
        case .smsMessageOutgoingFilled: return "\u{fb89}"
        case .smsMessageOutgoingLight: return "\u{fb8a}"
        case .smsMessageOutgoingRegular: return "\u{fb8b}"
        case .smsMessageRegular: return "\u{fb8c}"
        case .smsMessageStartBold: return "\u{fb8d}"
        case .smsMessageStartFilled: return "\u{fb8e}"
        case .smsMessageStartLight: return "\u{fb8f}"
        case .smsMessageStartRegular: return "\u{fb90}"
        case .smsOutgoingFilled: return "\u{fb91}"
        case .smsUnreadBold: return "\u{fb92}"
        case .smsUnreadLight: return "\u{fb93}"
        case .smsUnreadRegular: return "\u{fb94}"
        case .sortAscendingBold: return "\u{fb95}"
        case .sortAscendingLight: return "\u{fb96}"
        case .sortAscendingRegular: return "\u{fb97}"
        case .sortDescendingBold: return "\u{fb98}"
        case .sortDescendingLight: return "\u{fb99}"
        case .sortDescendingRegular: return "\u{fb9a}"
        case .soundDefaultBold: return "\u{fb9b}"
        case .soundDefaultLight: return "\u{fb9c}"
        case .soundDefaultRegular: return "\u{fb9d}"
        case .sparkleBold: return "\u{fb9e}"
        case .sparkleFilled: return "\u{fb9f}"
        case .sparkleLight: return "\u{fba0}"
        case .sparkleRegular: return "\u{fba1}"
        case .speakerBold: return "\u{fba2}"
        case .speakerDisconnectedBold: return "\u{fba3}"
        case .speakerDisconnectedFilled: return "\u{fba4}"
        case .speakerDisconnectedLight: return "\u{fba5}"
        case .speakerDisconnectedRegular: return "\u{fba6}"
        case .speakerFilled: return "\u{fba7}"
        case .speakerLight: return "\u{fba8}"
        case .speakerMutedBold: return "\u{fba9}"
        case .speakerMutedFilled: return "\u{fbaa}"
        case .speakerMutedLight: return "\u{fbab}"
        case .speakerMutedRegular: return "\u{fbac}"
        case .speakerOffBold: return "\u{fbad}"
        case .speakerOffFilled: return "\u{fbae}"
        case .speakerOffLight: return "\u{fbaf}"
        case .speakerOffRegular: return "\u{fbb0}"
        case .speakerOnBold: return "\u{fbb1}"
        case .speakerOnLight: return "\u{fbb2}"
        case .speakerOnRegular: return "\u{fbb3}"
        case .speakerRegular: return "\u{fbb4}"
        case .speakerTurnDownBold: return "\u{fbb5}"
        case .speakerTurnDownFilled: return "\u{fbb6}"
        case .speakerTurnDownLight: return "\u{fbb7}"
        case .speakerTurnDownRegular: return "\u{fbb8}"
        case .speakerTurnUpBold: return "\u{fbb9}"
        case .speakerTurnUpFilled: return "\u{fbba}"
        case .speakerTurnUpLight: return "\u{fbbb}"
        case .speakerTurnUpRegular: return "\u{fbbc}"
        case .speechAiBold: return "\u{fbbd}"
        case .speechAiFilled: return "\u{fbbe}"
        case .speechAiLight: return "\u{fbbf}"
        case .speechAiRegular: return "\u{fbc0}"
        case .speedDialBold: return "\u{fbc1}"
        case .speedDialFilled: return "\u{fbc2}"
        case .speedDialLight: return "\u{fbc3}"
        case .speedDialRegular: return "\u{fbc4}"
        case .spellCheckerBold: return "\u{fbc5}"
        case .spellCheckerLight: return "\u{fbc6}"
        case .spellCheckerRegular: return "\u{fbc7}"
        case .splitViewBold: return "\u{fbc8}"
        case .splitViewLight: return "\u{fbc9}"
        case .splitViewRegular: return "\u{fbca}"
        case .stackedAreaChartBold: return "\u{fbcb}"
        case .stackedAreaChartFilled: return "\u{fbcc}"
        case .stackedAreaChartFullBold: return "\u{fbcd}"
        case .stackedAreaChartFullFilled: return "\u{fbce}"
        case .stackedAreaChartFullLight: return "\u{fbcf}"
        case .stackedAreaChartFullRegular: return "\u{fbd0}"
        case .stackedAreaChartLight: return "\u{fbd1}"
        case .stackedAreaChartRegular: return "\u{fbd2}"
        case .stackedBarChartBold: return "\u{fbd3}"
        case .stackedBarChartFilled: return "\u{fbd4}"
        case .stackedBarChartFullBold: return "\u{fbd5}"
        case .stackedBarChartFullFilled: return "\u{fbd6}"
        case .stackedBarChartFullLight: return "\u{fbd7}"
        case .stackedBarChartFullRegular: return "\u{fbd8}"
        case .stackedBarChartLight: return "\u{fbd9}"
        case .stackedBarChartRegular: return "\u{fbda}"
        case .startChatBold: return "\u{fbdb}"
        case .startChatLight: return "\u{fbdc}"
        case .startChatRegular: return "\u{fbdd}"
        case .stethoscopeBold: return "\u{fbde}"
        case .stethoscopeLight: return "\u{fbdf}"
        case .stethoscopeRegular: return "\u{fbe0}"
        case .stickersBold: return "\u{fbe1}"
        case .stickersLight: return "\u{fbe2}"
        case .stickersRegular: return "\u{fbe3}"
        case .stickiesBold: return "\u{fbe4}"
        case .stickiesLight: return "\u{fbe5}"
        case .stickiesRegular: return "\u{fbe6}"
        case .stopBold: return "\u{fbe7}"
        case .stopCircleBold: return "\u{fbe8}"
        case .stopCircleFilled: return "\u{fbe9}"
        case .stopCircleLight: return "\u{fbea}"
        case .stopCircleRegular: return "\u{fbeb}"
        case .stopContentShareBold: return "\u{fbec}"
        case .stopContentShareLight: return "\u{fbed}"
        case .stopContentShareRegular: return "\u{fbee}"
        case .stopFilled: return "\u{fbef}"
        case .stopLight: return "\u{fbf0}"
        case .stopRegular: return "\u{fbf1}"
        case .storedInfoBold: return "\u{fbf2}"
        case .storedInfoFilled: return "\u{fbf3}"
        case .storedInfoLight: return "\u{fbf4}"
        case .storedInfoRegular: return "\u{fbf5}"
        case .streamingBold: return "\u{fbf6}"
        case .streamingLight: return "\u{fbf7}"
        case .streamingRegular: return "\u{fbf8}"
        case .strikethroughBold: return "\u{fbf9}"
        case .strikethroughFilled: return "\u{fbfa}"
        case .strikethroughLight: return "\u{fbfb}"
        case .strikethroughRegular: return "\u{fbfc}"
        case .studioModeBold: return "\u{fbfd}"
        case .studioModeLight: return "\u{fbfe}"
        case .studioModeRegular: return "\u{fbff}"
        case .subscriptBold: return "\u{fc00}"
        case .subscriptLight: return "\u{fc01}"
        case .subscriptRegular: return "\u{fc02}"
        case .summarizeAiBold: return "\u{fc03}"
        case .summarizeAiLight: return "\u{fc04}"
        case .summarizeAiRegular: return "\u{fc05}"
        case .superscriptBold: return "\u{fc06}"
        case .superscriptLight: return "\u{fc07}"
        case .superscriptRegular: return "\u{fc08}"
        case .surveyBold: return "\u{fc09}"
        case .surveyFilled: return "\u{fc0a}"
        case .surveyLight: return "\u{fc0b}"
        case .surveyRegular: return "\u{fc0c}"
        case .sxEightyCodecBold: return "\u{fc0d}"
        case .sxEightyCodecLight: return "\u{fc0e}"
        case .sxEightyCodecRegular: return "\u{fc0f}"
        case .sxTenBold: return "\u{fc10}"
        case .sxTenLight: return "\u{fc11}"
        case .sxTenRegular: return "\u{fc12}"
        case .sxTwentyBold: return "\u{fc13}"
        case .sxTwentyLight: return "\u{fc14}"
        case .sxTwentyRegular: return "\u{fc15}"
        case .tableBold: return "\u{fc16}"
        case .tableExtenderBold: return "\u{fc17}"
        case .tableExtenderFilled: return "\u{fc18}"
        case .tableExtenderLight: return "\u{fc19}"
        case .tableExtenderRegular: return "\u{fc1a}"
        case .tableLight: return "\u{fc1b}"
        case .tableRegular: return "\u{fc1c}"
        case .tabletBold: return "\u{fc1d}"
        case .tabletLight: return "\u{fc1e}"
        case .tabletRegular: return "\u{fc1f}"
        case .tabsBold: return "\u{fc20}"
        case .tabsLight: return "\u{fc21}"
        case .tabsRegular: return "\u{fc22}"
        case .tagBold: return "\u{fc23}"
        case .tagLight: return "\u{fc24}"
        case .tagRegular: return "\u{fc25}"
        case .tapBold: return "\u{fc26}"
        case .tapFilled: return "\u{fc27}"
        case .tapLight: return "\u{fc28}"
        case .tapRegular: return "\u{fc29}"
        case .telepresenceAlertBold: return "\u{fc2a}"
        case .telepresenceAlertLight: return "\u{fc2b}"
        case .telepresenceAlertMutedBold: return "\u{fc2c}"
        case .telepresenceAlertMutedLight: return "\u{fc2d}"
        case .telepresenceAlertMutedRegular: return "\u{fc2e}"
        case .telepresenceAlertRegular: return "\u{fc2f}"
        case .telepresenceBold: return "\u{fc30}"
        case .telepresenceIxFiveThousandBold: return "\u{fc31}"
        case .telepresenceIxFiveThousandLight: return "\u{fc32}"
        case .telepresenceIxFiveThousandRegular: return "\u{fc33}"
        case .telepresenceLight: return "\u{fc34}"
        case .telepresenceMutedBold: return "\u{fc35}"
        case .telepresenceMutedLight: return "\u{fc36}"
        case .telepresenceMutedRegular: return "\u{fc37}"
        case .telepresencePrivateBold: return "\u{fc38}"
        case .telepresencePrivateLight: return "\u{fc39}"
        case .telepresencePrivateRegular: return "\u{fc3a}"
        case .telepresenceRegular: return "\u{fc3b}"
        case .temperatureBold: return "\u{fc3c}"
        case .temperatureLight: return "\u{fc3d}"
        case .temperatureRegular: return "\u{fc3e}"
        case .tenantBold: return "\u{fc3f}"
        case .tenantFilled: return "\u{fc40}"
        case .tenantLight: return "\u{fc41}"
        case .tenantRegular: return "\u{fc42}"
        case .testTubeBold: return "\u{fc43}"
        case .testTubeFilled: return "\u{fc44}"
        case .testTubeLight: return "\u{fc45}"
        case .testTubeRegular: return "\u{fc46}"
        case .textAlignCenterBold: return "\u{fc47}"
        case .textAlignCenterFilled: return "\u{fc48}"
        case .textAlignCenterLight: return "\u{fc49}"
        case .textAlignCenterRegular: return "\u{fc4a}"
        case .textAlignLeftBold: return "\u{fc4b}"
        case .textAlignLeftFilled: return "\u{fc4c}"
        case .textAlignLeftLight: return "\u{fc4d}"
        case .textAlignLeftRegular: return "\u{fc4e}"
        case .textAlignRightBold: return "\u{fc4f}"
        case .textAlignRightFilled: return "\u{fc50}"
        case .textAlignRightLight: return "\u{fc51}"
        case .textAlignRightRegular: return "\u{fc52}"
        case .textBold: return "\u{fc53}"
        case .textBoxCursorLight: return "\u{fc54}"
        case .textCodeBlockBold: return "\u{fc55}"
        case .textCodeBlockLight: return "\u{fc56}"
        case .textCodeBlockRegular: return "\u{fc57}"
        case .textHighlightBold: return "\u{fc58}"
        case .textHighlightFilled: return "\u{fc59}"
        case .textHighlightLight: return "\u{fc5a}"
        case .textHighlightRegular: return "\u{fc5b}"
        case .textLight: return "\u{fc5c}"
        case .textRegular: return "\u{fc5d}"
        case .textShortBold: return "\u{fc5e}"
        case .textShortLight: return "\u{fc5f}"
        case .textShortRegular: return "\u{fc60}"
        case .threeColumnBold: return "\u{fc61}"
        case .threeColumnLight: return "\u{fc62}"
        case .threeColumnRegular: return "\u{fc63}"
        case .threeDObjectBold: return "\u{fc64}"
        case .threeDObjectLight: return "\u{fc65}"
        case .threeDObjectRegular: return "\u{fc66}"
        case .timeExclusionBold: return "\u{fc67}"
        case .timeExclusionLight: return "\u{fc68}"
        case .timeExclusionRegular: return "\u{fc69}"
        case .timezoneBold: return "\u{fc6a}"
        case .timezoneFilled: return "\u{fc6b}"
        case .timezoneLight: return "\u{fc6c}"
        case .timezoneRegular: return "\u{fc6d}"
        case .tooFastBold: return "\u{fc6e}"
        case .tooFastLight: return "\u{fc6f}"
        case .tooFastRegular: return "\u{fc70}"
        case .tooSlowBold: return "\u{fc71}"
        case .tooSlowLight: return "\u{fc72}"
        case .tooSlowRegular: return "\u{fc73}"
        case .toolsBold: return "\u{fc74}"
        case .toolsFilled: return "\u{fc75}"
        case .toolsLight: return "\u{fc76}"
        case .toolsRegular: return "\u{fc77}"
        case .touchTenBold: return "\u{fc78}"
        case .touchTenLight: return "\u{fc79}"
        case .touchTenRegular: return "\u{fc7a}"
        case .trackingBold: return "\u{fc7b}"
        case .trackingFilled: return "\u{fc7c}"
        case .trackingLight: return "\u{fc7d}"
        case .trackingRegular: return "\u{fc7e}"
        case .transcriptBold: return "\u{fc7f}"
        case .transcriptFilled: return "\u{fc80}"
        case .transcriptLight: return "\u{fc81}"
        case .transcriptRegular: return "\u{fc82}"
        case .translateBold: return "\u{fc83}"
        case .translateLight: return "\u{fc84}"
        case .translateRegular: return "\u{fc85}"
        case .translateUndoBold: return "\u{fc86}"
        case .translateUndoLight: return "\u{fc87}"
        case .translateUndoRegular: return "\u{fc88}"
        case .trendingBold: return "\u{fc89}"
        case .trendingDownBold: return "\u{fc8a}"
        case .trendingDownFilled: return "\u{fc8b}"
        case .trendingDownLight: return "\u{fc8c}"
        case .trendingDownRegular: return "\u{fc8d}"
        case .trendingFilled: return "\u{fc8e}"
        case .trendingLight: return "\u{fc8f}"
        case .trendingRegular: return "\u{fc90}"
        case .trimBold: return "\u{fc91}"
        case .trimLight: return "\u{fc92}"
        case .trimRegular: return "\u{fc93}"
        case .twoColumnBold: return "\u{fc94}"
        case .twoColumnLight: return "\u{fc95}"
        case .twoColumnRegular: return "\u{fc96}"
        case .twoWayVoiceStreamBold: return "\u{fc97}"
        case .twoWayVoiceStreamFilled: return "\u{fc98}"
        case .twoWayVoiceStreamLight: return "\u{fc99}"
        case .twoWayVoiceStreamRegular: return "\u{fc9a}"
        case .ucmCloudBold: return "\u{fc9b}"
        case .ucmCloudLight: return "\u{fc9c}"
        case .ucmCloudRegular: return "\u{fc9d}"
        case .unblockBold: return "\u{fc9e}"
        case .unblockFilled: return "\u{fc9f}"
        case .unblockLight: return "\u{fca0}"
        case .unblockRegular: return "\u{fca1}"
        case .underlineBold: return "\u{fca2}"
        case .underlineFilled: return "\u{fca3}"
        case .underlineLight: return "\u{fca4}"
        case .underlineRegular: return "\u{fca5}"
        case .undoBold: return "\u{fca6}"
        case .undoLight: return "\u{fca7}"
        case .undoRegular: return "\u{fca8}"
        case .unlinkBold: return "\u{fca9}"
        case .unlinkLight: return "\u{fcaa}"
        case .unlinkRegular: return "\u{fcab}"
        case .unreadBold: return "\u{fcac}"
        case .unreadFilled: return "\u{fcad}"
        case .unreadLight: return "\u{fcae}"
        case .unreadRegular: return "\u{fcaf}"
        case .unsecureUnlockedBold: return "\u{fcb0}"
        case .unsecureUnlockedFilled: return "\u{fcb1}"
        case .unsecureUnlockedLight: return "\u{fcb2}"
        case .unsecureUnlockedRegular: return "\u{fcb3}"
        case .unsortedBold: return "\u{fcb4}"
        case .unsortedLight: return "\u{fcb5}"
        case .unsortedRegular: return "\u{fcb6}"
        case .updateFileShareBold: return "\u{fcb7}"
        case .updateFileShareLight: return "\u{fcb8}"
        case .updateFileShareRegular: return "\u{fcb9}"
        case .uploadBold: return "\u{fcba}"
        case .uploadImageBold: return "\u{fcbb}"
        case .uploadImageLight: return "\u{fcbc}"
        case .uploadImageRegular: return "\u{fcbd}"
        case .uploadLight: return "\u{fcbe}"
        case .uploadRegular: return "\u{fcbf}"
        case .urgentVoicemailBold: return "\u{fcc0}"
        case .urgentVoicemailFilled: return "\u{fcc1}"
        case .usbBold: return "\u{fcc2}"
        case .usbHeadsetBold: return "\u{fcc3}"
        case .usbHeadsetLight: return "\u{fcc4}"
        case .usbHeadsetMutedBold: return "\u{fcc5}"
        case .usbHeadsetMutedLight: return "\u{fcc6}"
        case .usbHeadsetMutedRegular: return "\u{fcc7}"
        case .usbHeadsetRegular: return "\u{fcc8}"
        case .usbLight: return "\u{fcc9}"
        case .usbRegular: return "\u{fcca}"
        case .userBold: return "\u{fccb}"
        case .userDeactivateBold: return "\u{fccc}"
        case .userDeactivateLight: return "\u{fccd}"
        case .userDeactivateRegular: return "\u{fcce}"
        case .userFilled: return "\u{fccf}"
        case .userLight: return "\u{fcd0}"
        case .userRegular: return "\u{fcd1}"
        case .userSecurityStatusBold: return "\u{fcd2}"
        case .userSecurityStatusFilled: return "\u{fcd3}"
        case .userSecurityStatusLight: return "\u{fcd4}"
        case .userSecurityStatusRegular: return "\u{fcd5}"
        case .videoBlurBold: return "\u{fcd6}"
        case .videoBlurFilled: return "\u{fcd7}"
        case .videoBlurLight: return "\u{fcd8}"
        case .videoBlurRegular: return "\u{fcd9}"
        case .videoBold: return "\u{fcda}"
        case .videoEffectBold: return "\u{fcdb}"
        case .videoEffectFilled: return "\u{fcdc}"
        case .videoEffectLight: return "\u{fcdd}"
        case .videoEffectRegular: return "\u{fcde}"
        case .videoFilled: return "\u{fcdf}"
        case .videoLayoutBold: return "\u{fce0}"
        case .videoLayoutCustomBold: return "\u{fce1}"
        case .videoLayoutCustomFilled: return "\u{fce2}"
        case .videoLayoutCustomLight: return "\u{fce3}"
        case .videoLayoutCustomRegular: return "\u{fce4}"
        case .videoLayoutEqualBold: return "\u{fce5}"
        case .videoLayoutEqualDualBold: return "\u{fce6}"
        case .videoLayoutEqualDualLight: return "\u{fce7}"
        case .videoLayoutEqualDualRegular: return "\u{fce8}"
        case .videoLayoutEqualFilled: return "\u{fce9}"
        case .videoLayoutEqualLight: return "\u{fcea}"
        case .videoLayoutEqualRegular: return "\u{fceb}"
        case .videoLayoutFilled: return "\u{fcec}"
        case .videoLayoutLight: return "\u{fced}"
        case .videoLayoutOverlayBold: return "\u{fcee}"
        case .videoLayoutOverlayFilled: return "\u{fcef}"
        case .videoLayoutOverlayLight: return "\u{fcf0}"
        case .videoLayoutOverlayRegular: return "\u{fcf1}"
        case .videoLayoutPresentationBold: return "\u{fcf2}"
        case .videoLayoutPresentationFilled: return "\u{fcf3}"
        case .videoLayoutPresentationLight: return "\u{fcf4}"
        case .videoLayoutPresentationRegular: return "\u{fcf5}"
        case .videoLayoutPresenterDominantBold: return "\u{fcf6}"
        case .videoLayoutPresenterDominantLight: return "\u{fcf7}"
        case .videoLayoutPresenterDominantRegular: return "\u{fcf8}"
        case .videoLayoutProminentBold: return "\u{fcf9}"
        case .videoLayoutProminentFilled: return "\u{fcfa}"
        case .videoLayoutProminentLight: return "\u{fcfb}"
        case .videoLayoutProminentRegular: return "\u{fcfc}"
        case .videoLayoutRegular: return "\u{fcfd}"
        case .videoLayoutShareDominantBold: return "\u{fcfe}"
        case .videoLayoutShareDominantLight: return "\u{fcff}"
        case .videoLayoutShareDominantRegular: return "\u{fd00}"
        case .videoLayoutSingleBold: return "\u{fd01}"
        case .videoLayoutSingleFilled: return "\u{fd02}"
        case .videoLayoutSingleLight: return "\u{fd03}"
        case .videoLayoutSingleRegular: return "\u{fd04}"
        case .videoLayoutSpeakerBold: return "\u{fd05}"
        case .videoLayoutSpeakerFilled: return "\u{fd06}"
        case .videoLayoutSpeakerLight: return "\u{fd07}"
        case .videoLayoutSpeakerRegular: return "\u{fd08}"
        case .videoLayoutStackBold: return "\u{fd09}"
        case .videoLayoutStackFilled: return "\u{fd0a}"
        case .videoLayoutStackLight: return "\u{fd0b}"
        case .videoLayoutStackRegular: return "\u{fd0c}"
        case .videoLayoutVideoDominantBold: return "\u{fd0d}"
        case .videoLayoutVideoDominantFilled: return "\u{fd0e}"
        case .videoLayoutVideoDominantLight: return "\u{fd0f}"
        case .videoLayoutVideoDominantRegular: return "\u{fd10}"
        case .videoLight: return "\u{fd11}"
        case .videoPlusBold: return "\u{fd12}"
        case .videoPlusFilled: return "\u{fd13}"
        case .videoPlusLight: return "\u{fd14}"
        case .videoPlusRegular: return "\u{fd15}"
        case .videoRegular: return "\u{fd16}"
        case .videoSpeakerTrackBold: return "\u{fd17}"
        case .videoSpeakerTrackFilled: return "\u{fd18}"
        case .videoSpeakerTrackLight: return "\u{fd19}"
        case .videoSpeakerTrackRegular: return "\u{fd1a}"
        case .viewAllBold: return "\u{fd1b}"
        case .viewAllLight: return "\u{fd1c}"
        case .viewAllRegular: return "\u{fd1d}"
        case .viewListBold: return "\u{fd1e}"
        case .viewListFilled: return "\u{fd1f}"
        case .viewListLight: return "\u{fd20}"
        case .viewListRegular: return "\u{fd21}"
        case .viewStackedBold: return "\u{fd22}"
        case .viewStackedFilled: return "\u{fd23}"
        case .viewStackedLight: return "\u{fd24}"
        case .viewStackedRegular: return "\u{fd25}"
        case .viewThumbnailBold: return "\u{fd26}"
        case .viewThumbnailFilled: return "\u{fd27}"
        case .viewThumbnailLight: return "\u{fd28}"
        case .viewThumbnailRegular: return "\u{fd29}"
        case .visionproBold: return "\u{fd2a}"
        case .visionproFilled: return "\u{fd2b}"
        case .visionproLight: return "\u{fd2c}"
        case .visionproMoveCallInBold: return "\u{fd2d}"
        case .visionproMoveCallInFilled: return "\u{fd2e}"
        case .visionproMoveCallInLight: return "\u{fd2f}"
        case .visionproMoveCallInOutBold: return "\u{fd30}"
        case .visionproMoveCallInOutFilled: return "\u{fd31}"
        case .visionproMoveCallInOutLight: return "\u{fd32}"
        case .visionproMoveCallInOutRegular: return "\u{fd33}"
        case .visionproMoveCallInRegular: return "\u{fd34}"
        case .visionproMoveCallOutBold: return "\u{fd35}"
        case .visionproMoveCallOutFilled: return "\u{fd36}"
        case .visionproMoveCallOutLight: return "\u{fd37}"
        case .visionproMoveCallOutRegular: return "\u{fd38}"
        case .visionproRegular: return "\u{fd39}"
        case .voiceClipBold: return "\u{fd3a}"
        case .voiceClipFilled: return "\u{fd3b}"
        case .voiceClipLight: return "\u{fd3c}"
        case .voiceClipRegular: return "\u{fd3d}"
        case .voicemailBold: return "\u{fd3e}"
        case .voicemailFilled: return "\u{fd3f}"
        case .voicemailLight: return "\u{fd40}"
        case .voicemailRegular: return "\u{fd41}"
        case .vpnBold: return "\u{fd42}"
        case .vpnFilled: return "\u{fd43}"
        case .vpnLight: return "\u{fd44}"
        case .vpnRegular: return "\u{fd45}"
        case .vscBold: return "\u{fd46}"
        case .vscLight: return "\u{fd47}"
        case .vscRegular: return "\u{fd48}"
        case .waffleMenuBold: return "\u{fd49}"
        case .waffleMenuLight: return "\u{fd4a}"
        case .waffleMenuRegular: return "\u{fd4b}"
        case .waitingRoomBold: return "\u{fd4c}"
        case .waitingRoomFilled: return "\u{fd4d}"
        case .waitingRoomLight: return "\u{fd4e}"
        case .waitingRoomRegular: return "\u{fd4f}"
        case .wallpaperBold: return "\u{fd50}"
        case .wallpaperLight: return "\u{fd51}"
        case .wallpaperRegular: return "\u{fd52}"
        case .warningBadgeFilled: return "\u{fd53}"
        case .warningBold: return "\u{fd54}"
        case .warningFilled: return "\u{fd55}"
        case .warningLight: return "\u{fd56}"
        case .warningRegular: return "\u{fd57}"
        case .webexBoardBold: return "\u{fd58}"
        case .webexBoardLight: return "\u{fd59}"
        case .webexBoardRegular: return "\u{fd5a}"
        case .webexCodecPlusBold: return "\u{fd5b}"
        case .webexCodecPlusLight: return "\u{fd5c}"
        case .webexCodecPlusRegular: return "\u{fd5d}"
        case .webexDeskCameraBold: return "\u{fd5e}"
        case .webexDeskCameraLight: return "\u{fd5f}"
        case .webexDeskCameraRegular: return "\u{fd60}"
        case .webexHelixBold: return "\u{fd61}"
        case .webexHelixLight: return "\u{fd62}"
        case .webexHelixRegular: return "\u{fd63}"
        case .webexMeetingsBold: return "\u{fd64}"
        case .webexMeetingsFilled: return "\u{fd65}"
        case .webexMeetingsLight: return "\u{fd66}"
        case .webexMeetingsRegular: return "\u{fd67}"
        case .webexQuadCameraBold: return "\u{fd68}"
        case .webexQuadCameraLight: return "\u{fd69}"
        case .webexQuadCameraRegular: return "\u{fd6a}"
        case .webexRoomKitBold: return "\u{fd6b}"
        case .webexRoomKitLight: return "\u{fd6c}"
        case .webexRoomKitPlusBold: return "\u{fd6d}"
        case .webexRoomKitPlusLight: return "\u{fd6e}"
        case .webexRoomKitPlusRegular: return "\u{fd6f}"
        case .webexRoomKitRegular: return "\u{fd70}"
        case .webexShareBold: return "\u{fd71}"
        case .webexShareLight: return "\u{fd72}"
        case .webexShareRegular: return "\u{fd73}"
        case .webexTeamsBold: return "\u{fd74}"
        case .webexTeamsFilled: return "\u{fd75}"
        case .webexTeamsLight: return "\u{fd76}"
        case .webexTeamsNewBold: return "\u{fd77}"
        case .webexTeamsNewFilled: return "\u{fd78}"
        case .webexTeamsNewLight: return "\u{fd79}"
        case .webexTeamsNewRegular: return "\u{fd7a}"
        case .webexTeamsRegular: return "\u{fd7b}"
        case .webexTeamsRemoveBold: return "\u{fd7c}"
        case .webexTeamsRemoveLight: return "\u{fd7d}"
        case .webexTeamsRemoveRegular: return "\u{fd7e}"
        case .webhookBold: return "\u{fd7f}"
        case .webhookLight: return "\u{fd80}"
        case .webhookRegular: return "\u{fd81}"
        case .webinarBold: return "\u{fd82}"
        case .webinarFilled: return "\u{fd83}"
        case .webinarLight: return "\u{fd84}"
        case .webinarRegular: return "\u{fd85}"
        case .weeklyRecurringScheduleBold: return "\u{fd86}"
        case .weeklyRecurringScheduleLight: return "\u{fd87}"
        case .weeklyRecurringScheduleRegular: return "\u{fd88}"
        case .whisperAnnouncementBold: return "\u{fd89}"
        case .whisperAnnouncementFilled: return "\u{fd8a}"
        case .whisperAnnouncementLight: return "\u{fd8b}"
        case .whisperAnnouncementRegular: return "\u{fd8c}"
        case .whisperCoachBold: return "\u{fd8d}"
        case .whisperCoachFilled: return "\u{fd8e}"
        case .whisperCoachLight: return "\u{fd8f}"
        case .whisperCoachRegular: return "\u{fd90}"
        case .whiteboardBold: return "\u{fd91}"
        case .whiteboardContentBold: return "\u{fd92}"
        case .whiteboardContentFilled: return "\u{fd93}"
        case .whiteboardContentLight: return "\u{fd94}"
        case .whiteboardContentRegular: return "\u{fd95}"
        case .whiteboardFilled: return "\u{fd96}"
        case .whiteboardLight: return "\u{fd97}"
        case .whiteboardRegular: return "\u{fd98}"
        case .widgetBold: return "\u{fd99}"
        case .widgetFilled: return "\u{fd9a}"
        case .widgetLight: return "\u{fd9b}"
        case .widgetRegular: return "\u{fd9c}"
        case .wifiBold: return "\u{fd9d}"
        case .wifiErrorBold: return "\u{fd9e}"
        case .wifiErrorLight: return "\u{fd9f}"
        case .wifiErrorRegular: return "\u{fda0}"
        case .wifiLight: return "\u{fda1}"
        case .wifiRegular: return "\u{fda2}"
        case .wifiSignalGoodBold: return "\u{fda3}"
        case .wifiSignalGoodLight: return "\u{fda4}"
        case .wifiSignalGoodRegular: return "\u{fda5}"
        case .wifiSignalPoorBold: return "\u{fda6}"
        case .wifiSignalPoorLight: return "\u{fda7}"
        case .wifiSignalPoorRegular: return "\u{fda8}"
        case .wifiSignalUnstableBold: return "\u{fda9}"
        case .wifiSignalUnstableLight: return "\u{fdaa}"
        case .wifiSignalUnstableRegular: return "\u{fdab}"
        case .windowCornerScrubBold: return "\u{fdac}"
        case .windowCornerScrubLight: return "\u{fdad}"
        case .windowCornerScrubRegular: return "\u{fdae}"
        case .windowRightCornerScrubBold: return "\u{fdaf}"
        case .windowRightCornerScrubLight: return "\u{fdb0}"
        case .windowRightCornerScrubRegular: return "\u{fdb1}"
        case .windowVerticalScrubBold: return "\u{fdb2}"
        case .windowVerticalScrubLight: return "\u{fdb3}"
        case .windowVerticalScrubRegular: return "\u{fdb4}"
        case .workflowDeploymentsBold: return "\u{fdb5}"
        case .workflowDeploymentsFilled: return "\u{fdb6}"
        case .workflowDeploymentsLight: return "\u{fdb7}"
        case .workflowDeploymentsRegular: return "\u{fdb8}"
        case .workphoneBold: return "\u{fdb9}"
        case .workphoneLight: return "\u{fdba}"
        case .workphoneRegular: return "\u{fdbb}"
        case .zoomInBold: return "\u{fdbc}"
        case .zoomInLight: return "\u{fdbd}"
        case .zoomInRegular: return "\u{fdbe}"
        case .zoomOutBold: return "\u{fdbf}"
        case .zoomOutLight: return "\u{fdc0}"
        case .zoomOutRegular: return "\u{fdc1}"
