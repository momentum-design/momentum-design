...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .forecastBold: return "\u{f602}"
        case .forecastFilled: return "\u{f603}"
        case .forecastLight: return "\u{f604}"
        case .forecastRegular: return "\u{f605}"
        case .formatBold: return "\u{f606}"
        case .formatDefaultAppBold: return "\u{f607}"
        case .formatDefaultAppFilled: return "\u{f608}"
        case .formatDefaultAppLight: return "\u{f609}"
        case .formatDefaultAppRegular: return "\u{f60a}"
        case .formatLight: return "\u{f60b}"
        case .formatPanelControlBarBold: return "\u{f60c}"
        case .formatPanelControlBarLight: return "\u{f60d}"
        case .formatPanelControlBarRegular: return "\u{f60e}"
        case .formatPanelControlDownBold: return "\u{f60f}"
        case .formatPanelControlDownLight: return "\u{f610}"
        case .formatPanelControlDownRegular: return "\u{f611}"
        case .formatPanelControlLeftBold: return "\u{f612}"
        case .formatPanelControlLeftLight: return "\u{f613}"
        case .formatPanelControlLeftRegular: return "\u{f614}"
        case .formatPanelControlRightBold: return "\u{f615}"
        case .formatPanelControlRightLight: return "\u{f616}"
        case .formatPanelControlRightRegular: return "\u{f617}"
        case .formatPanelControlUpBold: return "\u{f618}"
        case .formatPanelControlUpDownBold: return "\u{f619}"
        case .formatPanelControlUpDownLight: return "\u{f61a}"
        case .formatPanelControlUpDownRegular: return "\u{f61b}"
        case .formatPanelControlUpLight: return "\u{f61c}"
        case .formatPanelControlUpRegular: return "\u{f61d}"
        case .formatRegular: return "\u{f61e}"
        case .formatViewMixedBold: return "\u{f61f}"
        case .formatViewMixedLight: return "\u{f620}"
        case .formatViewMixedRegular: return "\u{f621}"
        case .formulaBold: return "\u{f622}"
        case .formulaFilled: return "\u{f623}"
        case .formulaLight: return "\u{f624}"
        case .formulaRegular: return "\u{f625}"
        case .forwardMessageBold: return "\u{f626}"
        case .forwardMessageFilled: return "\u{f627}"
        case .forwardMessageLight: return "\u{f628}"
        case .forwardMessageRegular: return "\u{f629}"
        case .forwardTenSecBold: return "\u{f62a}"
        case .forwardTenSecLight: return "\u{f62b}"
        case .forwardTenSecRegular: return "\u{f62c}"
        case .fourColumnBold: return "\u{f62d}"
        case .fourColumnLight: return "\u{f62e}"
        case .fourColumnRegular: return "\u{f62f}"
        case .fourWayNavigationBold: return "\u{f630}"
        case .fourWayNavigationLight: return "\u{f631}"
        case .fourWayNavigationRegular: return "\u{f632}"
        case .frequencyCappingBold: return "\u{f633}"
        case .frequencyCappingLight: return "\u{f634}"
        case .frequencyCappingRegular: return "\u{f635}"
        case .fulfillmentBold: return "\u{f636}"
        case .fulfillmentLight: return "\u{f637}"
        case .fulfillmentRegular: return "\u{f638}"
        case .fullscreenBold: return "\u{f639}"
        case .fullscreenExitBold: return "\u{f63a}"
        case .fullscreenExitLight: return "\u{f63b}"
        case .fullscreenExitRegular: return "\u{f63c}"
        case .fullscreenLight: return "\u{f63d}"
        case .fullscreenRegular: return "\u{f63e}"
        case .genericDeviceVideoBadgeFilled: return "\u{f63f}"
        case .genericDeviceVideoBold: return "\u{f640}"
        case .genericDeviceVideoFilled: return "\u{f641}"
        case .genericDeviceVideoLight: return "\u{f642}"
        case .genericDeviceVideoRegular: return "\u{f643}"
        case .gifBold: return "\u{f644}"
        case .gifFilled: return "\u{f645}"
        case .gifHorizontalBold: return "\u{f646}"
        case .gifHorizontalFilled: return "\u{f647}"
        case .gifHorizontalLight: return "\u{f648}"
        case .gifHorizontalRegular: return "\u{f649}"
        case .gifLight: return "\u{f64a}"
        case .gifRegular: return "\u{f64b}"
        case .giftBold: return "\u{f64c}"
        case .giftFilled: return "\u{f64d}"
        case .giftLight: return "\u{f64e}"
        case .giftRegular: return "\u{f64f}"
        case .greenLeafBold: return "\u{f650}"
        case .greenLeafFilled: return "\u{f651}"
        case .greenLeafLight: return "\u{f652}"
        case .greenLeafRegular: return "\u{f653}"
        case .greenRoomBold: return "\u{f654}"
        case .greenRoomFilled: return "\u{f655}"
        case .greenRoomLight: return "\u{f656}"
        case .greenRoomRegular: return "\u{f657}"
        case .guestIssuerBold: return "\u{f658}"
        case .guestIssuerLight: return "\u{f659}"
        case .guestIssuerRegular: return "\u{f65a}"
        case .guideBold: return "\u{f65b}"
        case .guideLight: return "\u{f65c}"
        case .guideRegular: return "\u{f65d}"
        case .handPointerBold: return "\u{f65e}"
        case .handPointerLight: return "\u{f65f}"
        case .handPointerRegular: return "\u{f660}"
        case .handlerBold: return "\u{f661}"
        case .handlerHorizontalBold: return "\u{f662}"
        case .handlerHorizontalLight: return "\u{f663}"
        case .handlerHorizontalRegular: return "\u{f664}"
        case .handlerLight: return "\u{f665}"
        case .handlerRegular: return "\u{f666}"
        case .handsetAlertBold: return "\u{f667}"
        case .handsetAlertFilled: return "\u{f668}"
        case .handsetAlertLight: return "\u{f669}"
        case .handsetAlertRegular: return "\u{f66a}"
        case .handsetBold: return "\u{f66b}"
        case .handsetDownSlashBold: return "\u{f66c}"
        case .handsetDownSlashFilled: return "\u{f66d}"
        case .handsetDownSlashLight: return "\u{f66e}"
        case .handsetDownSlashRegular: return "\u{f66f}"
        case .handsetFilled: return "\u{f670}"
        case .handsetLight: return "\u{f671}"
        case .handsetMutedBold: return "\u{f672}"
        case .handsetMutedFilled: return "\u{f673}"
        case .handsetMutedLight: return "\u{f674}"
        case .handsetMutedRegular: return "\u{f675}"
        case .handsetRegular: return "\u{f676}"
        case .handsetsArrowLeftBold: return "\u{f677}"
        case .handsetsArrowLeftLight: return "\u{f678}"
        case .handsetsArrowLeftRegular: return "\u{f679}"
        case .handshakeBold: return "\u{f67a}"
        case .handshakeLight: return "\u{f67b}"
        case .handshakeRegular: return "\u{f67c}"
        case .headingOneBold: return "\u{f67d}"
        case .headingOneLight: return "\u{f67e}"
        case .headingOneRegular: return "\u{f67f}"
        case .headingThreeBold: return "\u{f680}"
        case .headingThreeLight: return "\u{f681}"
        case .headingThreeRegular: return "\u{f682}"
        case .headingTwoBold: return "\u{f683}"
        case .headingTwoLight: return "\u{f684}"
        case .headingTwoRegular: return "\u{f685}"
        case .headphonesBold: return "\u{f686}"
        case .headphonesFilled: return "\u{f687}"
        case .headphonesLight: return "\u{f688}"
        case .headphonesMutedBold: return "\u{f689}"
        case .headphonesMutedFilled: return "\u{f68a}"
        case .headphonesMutedLight: return "\u{f68b}"
        case .headphonesMutedRegular: return "\u{f68c}"
        case .headphonesRegular: return "\u{f68d}"
        case .headsetAlertBold: return "\u{f68e}"
        case .headsetAlertLight: return "\u{f68f}"
        case .headsetAlertRegular: return "\u{f690}"
        case .headsetArrowDownBold: return "\u{f691}"
        case .headsetArrowDownFilled: return "\u{f692}"
        case .headsetArrowDownLight: return "\u{f693}"
        case .headsetArrowDownRegular: return "\u{f694}"
        case .headsetBluetoothBold: return "\u{f695}"
        case .headsetBluetoothLight: return "\u{f696}"
        case .headsetBluetoothRegular: return "\u{f697}"
        case .headsetBold: return "\u{f698}"
        case .headsetFilled: return "\u{f699}"
        case .headsetLight: return "\u{f69a}"
        case .headsetMutedBold: return "\u{f69b}"
        case .headsetMutedLight: return "\u{f69c}"
        case .headsetMutedRegular: return "\u{f69d}"
        case .headsetPrivateBold: return "\u{f69e}"
        case .headsetPrivateLight: return "\u{f69f}"
        case .headsetPrivateRegular: return "\u{f6a0}"
        case .headsetRegular: return "\u{f6a1}"
        case .hearingBold: return "\u{f6a2}"
        case .hearingImpairedBold: return "\u{f6a3}"
        case .hearingImpairedLight: return "\u{f6a4}"
        case .hearingImpairedRegular: return "\u{f6a5}"
        case .hearingLight: return "\u{f6a6}"
        case .hearingRegular: return "\u{f6a7}"
        case .helpBold: return "\u{f6a8}"
        case .helpCircleBold: return "\u{f6a9}"
        case .helpCircleFilled: return "\u{f6aa}"
        case .helpCircleLight: return "\u{f6ab}"
        case .helpCircleRegular: return "\u{f6ac}"
        case .helpLight: return "\u{f6ad}"
        case .helpRegular: return "\u{f6ae}"
        case .helpdeskBold: return "\u{f6af}"
        case .helpdeskFilled: return "\u{f6b0}"
        case .helpdeskLight: return "\u{f6b1}"
        case .helpdeskRegular: return "\u{f6b2}"
        case .hideBold: return "\u{f6b3}"
        case .hideFilled: return "\u{f6b4}"
        case .hideLight: return "\u{f6b5}"
        case .hideRegular: return "\u{f6b6}"
        case .homeBold: return "\u{f6b7}"
        case .homeFilled: return "\u{f6b8}"
        case .homeLight: return "\u{f6b9}"
        case .homeRegular: return "\u{f6ba}"
        case .horizontalLineBold: return "\u{f6bb}"
        case .horizontalLineLight: return "\u{f6bc}"
        case .horizontalLineRegular: return "\u{f6bd}"
        case .hotelingBold: return "\u{f6be}"
        case .hotelingFilled: return "\u{f6bf}"
        case .hotelingLight: return "\u{f6c0}"
        case .hotelingRegular: return "\u{f6c1}"
        case .humidityBold: return "\u{f6c2}"
        case .humidityLight: return "\u{f6c3}"
        case .humidityRegular: return "\u{f6c4}"
        case .huntGroupBold: return "\u{f6c5}"
        case .huntGroupFilled: return "\u{f6c6}"
        case .huntGroupLight: return "\u{f6c7}"
        case .huntGroupRegular: return "\u{f6c8}"
        case .idleBold: return "\u{f6c9}"
        case .idleFilled: return "\u{f6ca}"
        case .idleLight: return "\u{f6cb}"
        case .idleRegular: return "\u{f6cc}"
        case .immediateBold: return "\u{f6cd}"
        case .immediateFilled: return "\u{f6ce}"
        case .immediateLight: return "\u{f6cf}"
        case .immediateRegular: return "\u{f6d0}"
        case .importBold: return "\u{f6d1}"
        case .importLight: return "\u{f6d2}"
        case .importRegular: return "\u{f6d3}"
        case .inCommonBold: return "\u{f6d4}"
        case .inCommonLight: return "\u{f6d5}"
        case .inCommonRegular: return "\u{f6d6}"
        case .inboxBold: return "\u{f6d7}"
        case .inboxFilled: return "\u{f6d8}"
        case .inboxLight: return "\u{f6d9}"
        case .inboxRegular: return "\u{f6da}"
        case .includeBold: return "\u{f6db}"
        case .includeLight: return "\u{f6dc}"
        case .includeRegular: return "\u{f6dd}"
        case .incognitoBold: return "\u{f6de}"
        case .incognitoFilled: return "\u{f6df}"
        case .incognitoLight: return "\u{f6e0}"
        case .incognitoRegular: return "\u{f6e1}"
        case .incomingCallLegacyBold: return "\u{f6e2}"
        case .incomingCallLegacyFilled: return "\u{f6e3}"
        case .incomingCallLegacyLight: return "\u{f6e4}"
        case .incomingCallLegacyRegular: return "\u{f6e5}"
        case .indentDecreaseBold: return "\u{f6e6}"
        case .indentDecreaseLight: return "\u{f6e7}"
        case .indentDecreaseRegular: return "\u{f6e8}"
        case .indentIncreaseBold: return "\u{f6e9}"
        case .indentIncreaseLight: return "\u{f6ea}"
        case .indentIncreaseRegular: return "\u{f6eb}"
        case .infoBadgeFilled: return "\u{f6ec}"
        case .infoCircleBold: return "\u{f6ed}"
        case .infoCircleFilled: return "\u{f6ee}"
        case .infoCircleLight: return "\u{f6ef}"
        case .infoCircleRegular: return "\u{f6f0}"
        case .infoCircleTwoBold: return "\u{f6f1}"
        case .infoCircleTwoFilled: return "\u{f6f2}"
        case .infoCircleTwoLight: return "\u{f6f3}"
        case .infoCircleTwoRegular: return "\u{f6f4}"
        case .inputBold: return "\u{f6f5}"
        case .inputDisconnectedBold: return "\u{f6f6}"
        case .inputDisconnectedLight: return "\u{f6f7}"
        case .inputDisconnectedRegular: return "\u{f6f8}"
        case .inputLight: return "\u{f6f9}"
        case .inputRegular: return "\u{f6fa}"
        case .instantScheduleBold: return "\u{f6fb}"
        case .instantScheduleFilled: return "\u{f6fc}"
        case .instantScheduleLight: return "\u{f6fd}"
        case .instantScheduleRegular: return "\u{f6fe}"
        case .integerBold: return "\u{f6ff}"
        case .integerFilled: return "\u{f700}"
        case .integerLight: return "\u{f701}"
        case .integerRegular: return "\u{f702}"
        case .integrationsBold: return "\u{f703}"
        case .integrationsFilled: return "\u{f704}"
        case .integrationsLight: return "\u{f705}"
        case .integrationsRegular: return "\u{f706}"
        case .intelligentRoutingBold: return "\u{f707}"
        case .intelligentRoutingLight: return "\u{f708}"
        case .intelligentRoutingRegular: return "\u{f709}"
        case .interactionBold: return "\u{f70a}"
        case .interactionFilled: return "\u{f70b}"
        case .interactionLight: return "\u{f70c}"
        case .interactionRegular: return "\u{f70d}"
        case .invitedUserBold: return "\u{f70e}"
        case .invitedUserLight: return "\u{f70f}"
        case .invitedUserRegular: return "\u{f710}"
        case .italicBold: return "\u{f711}"
        case .italicFilled: return "\u{f712}"
        case .italicLight: return "\u{f713}"
        case .italicRegular: return "\u{f714}"
        case .joinAudioBold: return "\u{f715}"
        case .joinAudioFilled: return "\u{f716}"
        case .joinAudioLight: return "\u{f717}"
        case .joinAudioRegular: return "\u{f718}"
        case .keepInTouchBold: return "\u{f719}"
        case .keepInTouchFilled: return "\u{f71a}"
        case .keepInTouchLight: return "\u{f71b}"
        case .keepInTouchRegular: return "\u{f71c}"
        case .keyboardBold: return "\u{f71d}"
        case .keyboardCloseBold: return "\u{f71e}"
        case .keyboardCloseLight: return "\u{f71f}"
        case .keyboardCloseRegular: return "\u{f720}"
        case .keyboardLight: return "\u{f721}"
        case .keyboardRegular: return "\u{f722}"
        case .languageBold: return "\u{f723}"
        case .languageFilled: return "\u{f724}"
        case .languageLight: return "\u{f725}"
        case .languageRegular: return "\u{f726}"
        case .laptopBold: return "\u{f727}"
        case .laptopDisconnectedBold: return "\u{f728}"
        case .laptopDisconnectedLight: return "\u{f729}"
        case .laptopDisconnectedRegular: return "\u{f72a}"
        case .laptopFilled: return "\u{f72b}"
        case .laptopLight: return "\u{f72c}"
        case .laptopRegular: return "\u{f72d}"
        case .laserPointerBold: return "\u{f72e}"
        case .laserPointerCursorBlackLight: return "\u{f72f}"
        case .laserPointerCursorBlueLight: return "\u{f730}"
        case .laserPointerCursorGreenLight: return "\u{f731}"
        case .laserPointerCursorPurpleLight: return "\u{f732}"
        case .laserPointerCursorRedLight: return "\u{f733}"
        case .laserPointerCursorWhiteLight: return "\u{f734}"
        case .laserPointerCursorYellowLight: return "\u{f735}"
        case .laserPointerFilled: return "\u{f736}"
        case .laserPointerLight: return "\u{f737}"
        case .laserPointerRegular: return "\u{f738}"
        case .launchBold: return "\u{f739}"
        case .launchFilled: return "\u{f73a}"
        case .launchLight: return "\u{f73b}"
        case .launchRegular: return "\u{f73c}"
        case .layoutSideBySideVerticalBold: return "\u{f73d}"
        case .layoutSideBySideVerticalFilled: return "\u{f73e}"
        case .layoutSideBySideVerticalLight: return "\u{f73f}"
        case .layoutSideBySideVerticalRegular: return "\u{f740}"
        case .leaveBreakoutSessionBold: return "\u{f741}"
        case .leaveBreakoutSessionLight: return "\u{f742}"
        case .leaveBreakoutSessionRegular: return "\u{f743}"
        case .leaveDeviceBold: return "\u{f744}"
        case .leaveDeviceLight: return "\u{f745}"
        case .leaveDeviceRegular: return "\u{f746}"
        case .likeBold: return "\u{f747}"
        case .likeFilled: return "\u{f748}"
        case .likeLight: return "\u{f749}"
        case .likeRegular: return "\u{f74a}"
        case .linkBold: return "\u{f74b}"
        case .linkLight: return "\u{f74c}"
        case .linkRegular: return "\u{f74d}"
        case .listBulletedBold: return "\u{f74e}"
        case .listBulletedLight: return "\u{f74f}"
        case .listBulletedRegular: return "\u{f750}"
        case .listMenuBold: return "\u{f751}"
        case .listMenuLight: return "\u{f752}"
        case .listMenuRegular: return "\u{f753}"
        case .listNumberedBold: return "\u{f754}"
        case .listNumberedLight: return "\u{f755}"
        case .listNumberedRegular: return "\u{f756}"
        case .liveBold: return "\u{f757}"
        case .liveFilled: return "\u{f758}"
        case .liveLight: return "\u{f759}"
        case .liveRegular: return "\u{f75a}"
        case .locationBold: return "\u{f75b}"
        case .locationFilled: return "\u{f75c}"
        case .locationLight: return "\u{f75d}"
        case .locationRegular: return "\u{f75e}"
        case .longTextBoxBold: return "\u{f75f}"
        case .longTextBoxLight: return "\u{f760}"
        case .longTextBoxRegular: return "\u{f761}"
        case .lowerHandBold: return "\u{f762}"
        case .lowerHandLight: return "\u{f763}"
        case .lowerHandRegular: return "\u{f764}"
        case .magicPenBold: return "\u{f765}"
        case .magicPenFilled: return "\u{f766}"
        case .magicPenLight: return "\u{f767}"
        case .magicPenRegular: return "\u{f768}"
        case .markAsUnreadBold: return "\u{f769}"
        case .markAsUnreadFilled: return "\u{f76a}"
        case .markAsUnreadLight: return "\u{f76b}"
        case .markAsUnreadRegular: return "\u{f76c}"
        case .markdownBold: return "\u{f76d}"
        case .markdownFilled: return "\u{f76e}"
        case .markdownLight: return "\u{f76f}"
        case .markdownRegular: return "\u{f770}"
        case .markerBold: return "\u{f771}"
        case .markerFilled: return "\u{f772}"
        case .markerLight: return "\u{f773}"
        case .markerRegular: return "\u{f774}"
        case .maximizeBold: return "\u{f775}"
        case .maximizeLight: return "\u{f776}"
        case .maximizeRegular: return "\u{f777}"
        case .mcpBold: return "\u{f778}"
        case .mcpFilled: return "\u{f779}"
        case .mcpLight: return "\u{f77a}"
        case .mcpRegular: return "\u{f77b}"
        case .mediaPlayerBold: return "\u{f77c}"
        case .mediaPlayerLight: return "\u{f77d}"
        case .mediaPlayerRegular: return "\u{f77e}"
        case .mediaQualityGoodBold: return "\u{f77f}"
        case .mediaQualityGoodFilled: return "\u{f780}"
        case .mediaQualityGoodLight: return "\u{f781}"
        case .mediaQualityGoodRegular: return "\u{f782}"
        case .mediaQualityPoorBold: return "\u{f783}"
        case .mediaQualityPoorColoredBold: return "\u{f784}"
        case .mediaQualityPoorFilled: return "\u{f785}"
        case .mediaQualityPoorLight: return "\u{f786}"
        case .mediaQualityPoorRegular: return "\u{f787}"
        case .mediaQualityUnstableBold: return "\u{f788}"
        case .mediaQualityUnstableColoredBold: return "\u{f789}"
        case .mediaQualityUnstableFilled: return "\u{f78a}"
        case .mediaQualityUnstableLight: return "\u{f78b}"
        case .mediaQualityUnstableRegular: return "\u{f78c}"
        case .meetBold: return "\u{f78d}"
        case .meetEndBold: return "\u{f78e}"
        case .meetEndLight: return "\u{f78f}"
        case .meetEndRegular: return "\u{f790}"
        case .meetFilled: return "\u{f791}"
        case .meetLight: return "\u{f792}"
        case .meetRegular: return "\u{f793}"
        case .meetingSummaryBold: return "\u{f794}"
        case .meetingSummaryFilled: return "\u{f795}"
        case .meetingSummaryLight: return "\u{f796}"
        case .meetingSummaryRegular: return "\u{f797}"
        case .meetingsBold: return "\u{f798}"
        case .meetingsFilled: return "\u{f799}"
        case .meetingsFocusMonthBold: return "\u{f79a}"
        case .meetingsFocusMonthLight: return "\u{f79b}"
        case .meetingsFocusMonthRegular: return "\u{f79c}"
        case .meetingsFocusOneDayBold: return "\u{f79d}"
        case .meetingsFocusOneDayLight: return "\u{f79e}"
        case .meetingsFocusOneDayRegular: return "\u{f79f}"
        case .meetingsFocusThreeDayBold: return "\u{f7a0}"
        case .meetingsFocusThreeDayLight: return "\u{f7a1}"
        case .meetingsFocusThreeDayRegular: return "\u{f7a2}"
        case .meetingsFocusUpcomingBold: return "\u{f7a3}"
        case .meetingsFocusUpcomingLight: return "\u{f7a4}"
        case .meetingsFocusUpcomingRegular: return "\u{f7a5}"
        case .meetingsLight: return "\u{f7a6}"
        case .meetingsPresenceBadgeFilled: return "\u{f7a7}"
        case .meetingsPresenceBold: return "\u{f7a8}"
        case .meetingsPresenceFilled: return "\u{f7a9}"
        case .meetingsPresenceLight: return "\u{f7aa}"
        case .meetingsPresenceRegular: return "\u{f7ab}"
        case .meetingsRegular: return "\u{f7ac}"
        case .meetingsTeamBold: return "\u{f7ad}"
        case .meetingsTeamFilled: return "\u{f7ae}"
        case .meetingsTeamLight: return "\u{f7af}"
        case .meetingsTeamNewBold: return "\u{f7b0}"
        case .meetingsTeamNewLight: return "\u{f7b1}"
        case .meetingsTeamNewRegular: return "\u{f7b2}"
        case .meetingsTeamRegular: return "\u{f7b3}"
        case .mentionBold: return "\u{f7b4}"
        case .mentionFilled: return "\u{f7b5}"
        case .mentionLight: return "\u{f7b6}"
        case .mentionRegular: return "\u{f7b7}"
        case .messageQueingBold: return "\u{f7b8}"
        case .messageQueingLight: return "\u{f7b9}"
        case .messageQueingRegular: return "\u{f7ba}"
        case .microphoneBold: return "\u{f7bb}"
        case .microphoneFilled: return "\u{f7bc}"
        case .microphoneHardMutedBold: return "\u{f7bd}"
        case .microphoneHardMutedCircleFilled: return "\u{f7be}"
        case .microphoneHardMutedLight: return "\u{f7bf}"
        case .microphoneHardMutedRegular: return "\u{f7c0}"
        case .microphoneLight: return "\u{f7c1}"
        case .microphoneMusicModeBold: return "\u{f7c2}"
        case .microphoneMusicModeLight: return "\u{f7c3}"
        case .microphoneMusicModeOnBold: return "\u{f7c4}"
        case .microphoneMusicModeOnLight: return "\u{f7c5}"
        case .microphoneMusicModeOnRegular: return "\u{f7c6}"
        case .microphoneMusicModeRegular: return "\u{f7c7}"
        case .microphoneMutedBold: return "\u{f7c8}"
        case .microphoneMutedCircleFilled: return "\u{f7c9}"
        case .microphoneMutedFilled: return "\u{f7ca}"
        case .microphoneMutedLight: return "\u{f7cb}"
        case .microphoneMutedRegular: return "\u{f7cc}"
        case .microphoneOnBold: return "\u{f7cd}"
        case .microphoneOnLight: return "\u{f7ce}"
        case .microphoneOnRegular: return "\u{f7cf}"
        case .microphoneOptAllBold: return "\u{f7d0}"
        case .microphoneOptAllLight: return "\u{f7d1}"
        case .microphoneOptAllMutedBold: return "\u{f7d2}"
        case .microphoneOptAllMutedLight: return "\u{f7d3}"
        case .microphoneOptAllMutedRegular: return "\u{f7d4}"
        case .microphoneOptAllOnBold: return "\u{f7d5}"
        case .microphoneOptAllOnLight: return "\u{f7d6}"
        case .microphoneOptAllOnRegular: return "\u{f7d7}"
        case .microphoneOptAllRegular: return "\u{f7d8}"
        case .microphoneOptMeBold: return "\u{f7d9}"
        case .microphoneOptMeLight: return "\u{f7da}"
        case .microphoneOptMeMutedBold: return "\u{f7db}"
        case .microphoneOptMeMutedLight: return "\u{f7dc}"
        case .microphoneOptMeMutedRegular: return "\u{f7dd}"
        case .microphoneOptMeOnBold: return "\u{f7de}"
        case .microphoneOptMeOnLight: return "\u{f7df}"
        case .microphoneOptMeOnRegular: return "\u{f7e0}"
        case .microphoneOptMeRegular: return "\u{f7e1}"
        case .microphoneRegular: return "\u{f7e2}"
        case .mindMapBold: return "\u{f7e3}"
        case .mindMapLight: return "\u{f7e4}"
        case .mindMapRegular: return "\u{f7e5}"
        case .minimizeBold: return "\u{f7e6}"
        case .minimizeLight: return "\u{f7e7}"
        case .minimizeRegular: return "\u{f7e8}"
        case .minusBold: return "\u{f7e9}"
        case .minusFilled: return "\u{f7ea}"
        case .minusLight: return "\u{f7eb}"
        case .minusRegular: return "\u{f7ec}"
        case .mirrorBold: return "\u{f7ed}"
        case .mirrorFilled: return "\u{f7ee}"
        case .mirrorLight: return "\u{f7ef}"
        case .mirrorRegular: return "\u{f7f0}"
        case .mmsFilled: return "\u{f7f1}"
        case .moderatorBold: return "\u{f7f2}"
        case .moderatorLight: return "\u{f7f3}"
        case .moderatorRegular: return "\u{f7f4}"
        case .monitoringBold: return "\u{f7f5}"
        case .monitoringLight: return "\u{f7f6}"
        case .monitoringRegular: return "\u{f7f7}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f7f8}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f7f9}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f7fa}"
        case .moreAdrBold: return "\u{f7fb}"
        case .moreAdrLight: return "\u{f7fc}"
        case .moreAdrRegular: return "\u{f7fd}"
        case .moreBold: return "\u{f7fe}"
        case .moreCircleBold: return "\u{f7ff}"
        case .moreCircleFilled: return "\u{f800}"
        case .moreCircleLight: return "\u{f801}"
        case .moreCircleRegular: return "\u{f802}"
        case .moreLight: return "\u{f803}"
        case .moreRegular: return "\u{f804}"
        case .mouseCursorBold: return "\u{f805}"
        case .mouseCursorLight: return "\u{f806}"
        case .mouseCursorRegular: return "\u{f807}"
        case .moveCallInAdrBold: return "\u{f808}"
        case .moveCallInAdrLight: return "\u{f809}"
        case .moveCallInAdrRegular: return "\u{f80a}"
        case .moveCallInIphBold: return "\u{f80b}"
        case .moveCallInIphLight: return "\u{f80c}"
        case .moveCallInIphRegular: return "\u{f80d}"
        case .moveCallInLaptopBold: return "\u{f80e}"
        case .moveCallInLaptopLight: return "\u{f80f}"
        case .moveCallInLaptopRegular: return "\u{f810}"
        case .moveCallInOutAdrBold: return "\u{f811}"
        case .moveCallInOutAdrLight: return "\u{f812}"
        case .moveCallInOutAdrRegular: return "\u{f813}"
        case .moveCallInOutIphBold: return "\u{f814}"
        case .moveCallInOutIphLight: return "\u{f815}"
        case .moveCallInOutIphRegular: return "\u{f816}"
        case .moveCallInTabletBold: return "\u{f817}"
        case .moveCallInTabletLight: return "\u{f818}"
        case .moveCallInTabletRegular: return "\u{f819}"
        case .moveCallOutAdrBold: return "\u{f81a}"
        case .moveCallOutAdrLight: return "\u{f81b}"
        case .moveCallOutAdrRegular: return "\u{f81c}"
        case .moveCallOutIphBold: return "\u{f81d}"
        case .moveCallOutIphLight: return "\u{f81e}"
        case .moveCallOutIphRegular: return "\u{f81f}"
        case .moveCallOutLaptopBold: return "\u{f820}"
        case .moveCallOutLaptopLight: return "\u{f821}"
        case .moveCallOutLaptopRegular: return "\u{f822}"
        case .moveCallOutTabletBold: return "\u{f823}"
        case .moveCallOutTabletLight: return "\u{f824}"
        case .moveCallOutTabletRegular: return "\u{f825}"
        case .moveToBottomBold: return "\u{f826}"
        case .moveToBottomFilled: return "\u{f827}"
        case .moveToBottomLight: return "\u{f828}"
        case .moveToBottomRegular: return "\u{f829}"
        case .moveToScreenBold: return "\u{f82a}"
        case .moveToScreenLight: return "\u{f82b}"
        case .moveToScreenRegular: return "\u{f82c}"
        case .moveToTopBold: return "\u{f82d}"
        case .moveToTopFilled: return "\u{f82e}"
        case .moveToTopLight: return "\u{f82f}"
        case .moveToTopRegular: return "\u{f830}"
        case .multilineChartBold: return "\u{f831}"
        case .multilineChartFilled: return "\u{f832}"
        case .multilineChartLight: return "\u{f833}"
        case .multilineChartRegular: return "\u{f834}"
        case .multimediaBold: return "\u{f835}"
        case .multimediaFilled: return "\u{f836}"
        case .multimediaLight: return "\u{f837}"
        case .multimediaRegular: return "\u{f838}"
        case .multipledDevicesBold: return "\u{f839}"
        case .multipledDevicesLight: return "\u{f83a}"
        case .multipledDevicesRegular: return "\u{f83b}"
        case .musicModeCircleBold: return "\u{f83c}"
        case .musicModeCircleFilled: return "\u{f83d}"
        case .musicModeCircleLight: return "\u{f83e}"
        case .musicModeCircleRegular: return "\u{f83f}"
        case .musicNoteBold: return "\u{f840}"
        case .musicNoteFilled: return "\u{f841}"
        case .musicNoteLight: return "\u{f842}"
        case .musicNoteRegular: return "\u{f843}"
        case .muteOnEntryBold: return "\u{f844}"
        case .muteOnEntryFilled: return "\u{f845}"
        case .muteOnEntryLight: return "\u{f846}"
        case .muteOnEntryRegular: return "\u{f847}"
        case .networkSwitchBold: return "\u{f848}"
        case .networkSwitchFilled: return "\u{f849}"
        case .networkSwitchLight: return "\u{f84a}"
        case .networkSwitchRegular: return "\u{f84b}"
        case .newManagerBold: return "\u{f84c}"
        case .newManagerFilled: return "\u{f84d}"
        case .newManagerLight: return "\u{f84e}"
        case .newManagerRegular: return "\u{f84f}"
        case .newTitleBold: return "\u{f850}"
        case .newTitleLight: return "\u{f851}"
        case .newTitleRegular: return "\u{f852}"
        case .newVoicemailBold: return "\u{f853}"
        case .newVoicemailLight: return "\u{f854}"
        case .newVoicemailRegular: return "\u{f855}"
        case .newWhiteboardBold: return "\u{f856}"
        case .newWhiteboardLight: return "\u{f857}"
        case .newWhiteboardRegular: return "\u{f858}"
        case .nextBold: return "\u{f859}"
        case .nextLight: return "\u{f85a}"
        case .nextRegular: return "\u{f85b}"
        case .noDevicesBold: return "\u{f85c}"
        case .noDevicesLight: return "\u{f85d}"
        case .noDevicesRegular: return "\u{f85e}"
        case .noiseDetectedCanceledFilled: return "\u{f85f}"
        case .noiseDetectedFilled: return "\u{f860}"
        case .noiseNoneCanceledFilled: return "\u{f861}"
        case .noiseNoneFilled: return "\u{f862}"
        case .noiseRemovalBold: return "\u{f863}"
        case .noiseRemovalLight: return "\u{f864}"
        case .noiseRemovalRegular: return "\u{f865}"
        case .noteBold: return "\u{f866}"
        case .noteFilled: return "\u{f867}"
        case .noteLight: return "\u{f868}"
        case .notePptBold: return "\u{f869}"
        case .notePptLight: return "\u{f86a}"
        case .notePptRegular: return "\u{f86b}"
        case .noteRegular: return "\u{f86c}"
        case .notesBold: return "\u{f86d}"
        case .notesFilled: return "\u{f86e}"
        case .notesLight: return "\u{f86f}"
        case .notesRegular: return "\u{f870}"
        case .numberBold: return "\u{f871}"
        case .numberLight: return "\u{f872}"
        case .numberRegular: return "\u{f873}"
        case .oldRemoteBold: return "\u{f874}"
        case .oldRemoteLight: return "\u{f875}"
        case .oldRemoteRegular: return "\u{f876}"
        case .oldTouchBold: return "\u{f877}"
        case .oldTouchLight: return "\u{f878}"
        case .oldTouchRegular: return "\u{f879}"
        case .oneColumnBold: return "\u{f87a}"
        case .oneColumnLight: return "\u{f87b}"
        case .oneColumnRegular: return "\u{f87c}"
        case .oneTimeBold: return "\u{f87d}"
        case .oneTimeLight: return "\u{f87e}"
        case .oneTimeRegular: return "\u{f87f}"
        case .openInFolderBold: return "\u{f880}"
        case .openInFolderFilled: return "\u{f881}"
        case .openInFolderLight: return "\u{f882}"
        case .openInFolderRegular: return "\u{f883}"
        case .openPagesBold: return "\u{f884}"
        case .openPagesLight: return "\u{f885}"
        case .openPagesRegular: return "\u{f886}"
        case .otherNumberBold: return "\u{f887}"
        case .otherNumberFilled: return "\u{f888}"
        case .otherNumberLight: return "\u{f889}"
        case .otherNumberRegular: return "\u{f88a}"
        case .otherNumberWarningBold: return "\u{f88b}"
        case .otherNumberWarningLight: return "\u{f88c}"
        case .otherNumberWarningRegular: return "\u{f88d}"
        case .outgoingCallLegacyBold: return "\u{f88e}"
        case .outgoingCallLegacyFilled: return "\u{f88f}"
        case .outgoingCallLegacyLight: return "\u{f890}"
        case .outgoingCallLegacyRegular: return "\u{f891}"
        case .overflowLeftBold: return "\u{f892}"
        case .overflowLeftLight: return "\u{f893}"
        case .overflowLeftRegular: return "\u{f894}"
        case .overflowRightBold: return "\u{f895}"
        case .overflowRightLight: return "\u{f896}"
        case .overflowRightRegular: return "\u{f897}"
        case .pairedCameraBold: return "\u{f898}"
        case .pairedCameraLight: return "\u{f899}"
        case .pairedCameraRegular: return "\u{f89a}"
        case .pairedDeviceBold: return "\u{f89b}"
        case .pairedDeviceLight: return "\u{f89c}"
        case .pairedDeviceRegular: return "\u{f89d}"
        case .pairedHandsetBold: return "\u{f89e}"
        case .pairedHandsetLight: return "\u{f89f}"
        case .pairedHandsetRegular: return "\u{f8a0}"
        case .pairingBold: return "\u{f8a1}"
        case .pairingLight: return "\u{f8a2}"
        case .pairingRegular: return "\u{f8a3}"
        case .parenthesisBold: return "\u{f8a4}"
        case .parenthesisFilled: return "\u{f8a5}"
        case .parenthesisLight: return "\u{f8a6}"
        case .parenthesisRegular: return "\u{f8a7}"
        case .parkedBold: return "\u{f8a8}"
        case .parkedFilled: return "\u{f8a9}"
        case .parkedLight: return "\u{f8aa}"
        case .parkedRegular: return "\u{f8ab}"
        case .parseBold: return "\u{f8ac}"
        case .parseLight: return "\u{f8ad}"
        case .parseRegular: return "\u{f8ae}"
        case .partialBold: return "\u{f8af}"
        case .partialLight: return "\u{f8b0}"
        case .partialRegular: return "\u{f8b1}"
        case .participantAddBold: return "\u{f8b2}"
        case .participantAddLight: return "\u{f8b3}"
        case .participantAddRegular: return "\u{f8b4}"
        case .participantBlockedBold: return "\u{f8b5}"
        case .participantBlockedLight: return "\u{f8b6}"
        case .participantBlockedRegular: return "\u{f8b7}"
        case .participantBold: return "\u{f8b8}"
        case .participantFilled: return "\u{f8b9}"
        case .participantLight: return "\u{f8ba}"
        case .participantListBold: return "\u{f8bb}"
        case .participantListFilled: return "\u{f8bc}"
        case .participantListLight: return "\u{f8bd}"
        case .participantListRegular: return "\u{f8be}"
        case .participantRegular: return "\u{f8bf}"
        case .participantRemoveBold: return "\u{f8c0}"
        case .participantRemoveLight: return "\u{f8c1}"
        case .participantRemoveRegular: return "\u{f8c2}"
        case .participantSpeakerBold: return "\u{f8c3}"
        case .participantSpeakerFilled: return "\u{f8c4}"
        case .participantSpeakerLight: return "\u{f8c5}"
        case .participantSpeakerRegular: return "\u{f8c6}"
        case .participantUnknownBold: return "\u{f8c7}"
        case .participantUnknownLight: return "\u{f8c8}"
        case .participantUnknownRegular: return "\u{f8c9}"
        case .passMouseBold: return "\u{f8ca}"
        case .passMouseLight: return "\u{f8cb}"
        case .passMouseRegular: return "\u{f8cc}"
        case .pauseBadgeFilled: return "\u{f8cd}"
        case .pauseBold: return "\u{f8ce}"
        case .pauseFilled: return "\u{f8cf}"
        case .pauseInteractionBold: return "\u{f8d0}"
        case .pauseInteractionFilled: return "\u{f8d1}"
        case .pauseInteractionLight: return "\u{f8d2}"
        case .pauseInteractionRegular: return "\u{f8d3}"
        case .pauseLight: return "\u{f8d4}"
        case .pauseRegular: return "\u{f8d5}"
        case .peopleAddBold: return "\u{f8d6}"
        case .peopleAddFilled: return "\u{f8d7}"
        case .peopleAddLight: return "\u{f8d8}"
        case .peopleAddRegular: return "\u{f8d9}"
        case .peopleBold: return "\u{f8da}"
        case .peopleCircleBold: return "\u{f8db}"
        case .peopleCircleFilled: return "\u{f8dc}"
        case .peopleCircleLight: return "\u{f8dd}"
        case .peopleCircleRegular: return "\u{f8de}"
        case .peopleFilled: return "\u{f8df}"
        case .peopleInsightsBold: return "\u{f8e0}"
        case .peopleInsightsFilled: return "\u{f8e1}"
        case .peopleInsightsLight: return "\u{f8e2}"
        case .peopleInsightsRegular: return "\u{f8e3}"
        case .peopleLight: return "\u{f8e4}"
        case .peopleManageBold: return "\u{f8e5}"
        case .peopleManageFilled: return "\u{f8e6}"
        case .peopleManageLight: return "\u{f8e7}"
        case .peopleManageRegular: return "\u{f8e8}"
        case .peopleRegular: return "\u{f8e9}"
        case .phoneAlertBold: return "\u{f8ea}"
        case .phoneAlertLight: return "\u{f8eb}"
        case .phoneAlertRegular: return "\u{f8ec}"
        case .phoneBadgeFilled: return "\u{f8ed}"
        case .phoneBold: return "\u{f8ee}"
        case .phoneFilled: return "\u{f8ef}"
        case .phoneLight: return "\u{f8f0}"
        case .phoneMutedBold: return "\u{f8f1}"
        case .phoneMutedLight: return "\u{f8f2}"
        case .phoneMutedRegular: return "\u{f8f3}"
        case .phonePrivateBold: return "\u{f8f4}"
        case .phonePrivateLight: return "\u{f8f5}"
        case .phonePrivateRegular: return "\u{f8f6}"
        case .phoneRegular: return "\u{f8f7}"
        case .phoneReplyAllBold: return "\u{f8f8}"
        case .phoneReplyAllLight: return "\u{f8f9}"
        case .phoneReplyAllRegular: return "\u{f8fa}"
        case .phoneReplyBold: return "\u{f8fb}"
        case .phoneReplyLight: return "\u{f8fc}"
        case .phoneReplyRegular: return "\u{f8fd}"
        case .pickerBold: return "\u{f8fe}"
        case .pickerLight: return "\u{f8ff}"
        case .pickerRegular: return "\u{f900}"
        case .pieChartBold: return "\u{f901}"
        case .pieChartFilled: return "\u{f902}"
        case .pieChartLight: return "\u{f903}"
        case .pieChartRegular: return "\u{f904}"
        case .pinBold: return "\u{f905}"
        case .pinFilled: return "\u{f906}"
        case .pinLight: return "\u{f907}"
        case .pinListActivityBold: return "\u{f908}"
        case .pinListActivityLight: return "\u{f909}"
        case .pinListActivityRegular: return "\u{f90a}"
        case .pinListBold: return "\u{f90b}"
        case .pinListLight: return "\u{f90c}"
        case .pinListRegular: return "\u{f90d}"
        case .pinMutedBold: return "\u{f90e}"
        case .pinMutedFilled: return "\u{f90f}"
        case .pinMutedLight: return "\u{f910}"
        case .pinMutedRegular: return "\u{f911}"
        case .pinRegular: return "\u{f912}"
        case .pipBold: return "\u{f913}"
        case .pipEnterBold: return "\u{f914}"
        case .pipEnterLight: return "\u{f915}"
        case .pipEnterRegular: return "\u{f916}"
        case .pipExitBold: return "\u{f917}"
        case .pipExitLight: return "\u{f918}"
        case .pipExitRegular: return "\u{f919}"
        case .pipFilled: return "\u{f91a}"
        case .pipLight: return "\u{f91b}"
        case .pipRegular: return "\u{f91c}"
        case .placeholderBold: return "\u{f91d}"
        case .placeholderFilled: return "\u{f91e}"
        case .placeholderLight: return "\u{f91f}"
        case .placeholderRegular: return "\u{f920}"
        case .playBold: return "\u{f921}"
        case .playCircleBold: return "\u{f922}"
        case .playCircleFilled: return "\u{f923}"
        case .playCircleLight: return "\u{f924}"
        case .playCircleRegular: return "\u{f925}"
        case .playFilled: return "\u{f926}"
        case .playLight: return "\u{f927}"
        case .playRegular: return "\u{f928}"
        case .plugAcBold: return "\u{f929}"
        case .plugAcLight: return "\u{f92a}"
        case .plugAcRegular: return "\u{f92b}"
        case .plusBold: return "\u{f92c}"
        case .plusCircleBold: return "\u{f92d}"
        case .plusCircleFilled: return "\u{f92e}"
        case .plusCircleLight: return "\u{f92f}"
        case .plusCircleRegular: return "\u{f930}"
        case .plusLight: return "\u{f931}"
        case .plusRegular: return "\u{f932}"
        case .pmrBold: return "\u{f933}"
        case .pmrFilled: return "\u{f934}"
        case .pmrLight: return "\u{f935}"
        case .pmrRegular: return "\u{f936}"
        case .pollBold: return "\u{f937}"
        case .pollFilled: return "\u{f938}"
        case .pollLight: return "\u{f939}"
        case .pollRegular: return "\u{f93a}"
        case .popInBold: return "\u{f93b}"
        case .popInLight: return "\u{f93c}"
        case .popInRegular: return "\u{f93d}"
        case .popOutBold: return "\u{f93e}"
        case .popOutLight: return "\u{f93f}"
        case .popOutRegular: return "\u{f940}"
        case .popUpBold: return "\u{f941}"
        case .popUpLight: return "\u{f942}"
        case .popUpRegular: return "\u{f943}"
        case .portraitLandscapeBold: return "\u{f944}"
        case .portraitLandscapeLight: return "\u{f945}"
        case .portraitLandscapeRegular: return "\u{f946}"
        case .potentialFraudBold: return "\u{f947}"
        case .potentialFraudFilled: return "\u{f948}"
        case .potentialFraudLight: return "\u{f949}"
        case .potentialFraudRegular: return "\u{f94a}"
        case .powerAcBold: return "\u{f94b}"
        case .powerAcLight: return "\u{f94c}"
        case .powerAcRegular: return "\u{f94d}"
        case .powerBold: return "\u{f94e}"
        case .powerLight: return "\u{f94f}"
        case .powerRegular: return "\u{f950}"
        case .preHeaderBold: return "\u{f951}"
        case .preHeaderLight: return "\u{f952}"
        case .preHeaderRegular: return "\u{f953}"
        case .premiumBold: return "\u{f954}"
        case .premiumLight: return "\u{f955}"
        case .premiumRegular: return "\u{f956}"
        case .presentationBold: return "\u{f957}"
        case .presentationLight: return "\u{f958}"
        case .presentationRegular: return "\u{f959}"
        case .preventDownloadBold: return "\u{f95a}"
        case .preventDownloadFilled: return "\u{f95b}"
        case .preventDownloadLight: return "\u{f95c}"
        case .preventDownloadRegular: return "\u{f95d}"
        case .primaryParticipantBold: return "\u{f95e}"
        case .primaryParticipantFilled: return "\u{f95f}"
        case .primaryParticipantLight: return "\u{f960}"
        case .primaryParticipantRegular: return "\u{f961}"
        case .printBold: return "\u{f962}"
        case .printLight: return "\u{f963}"
        case .printRegular: return "\u{f964}"
        case .priorityBadgeFilled: return "\u{f965}"
        case .priorityCircleBold: return "\u{f966}"
        case .priorityCircleFilled: return "\u{f967}"
        case .priorityCircleLight: return "\u{f968}"
        case .priorityCircleRegular: return "\u{f969}"
        case .priorityCircleTwoBold: return "\u{f96a}"
        case .priorityCircleTwoFilled: return "\u{f96b}"
        case .priorityCircleTwoLight: return "\u{f96c}"
        case .priorityCircleTwoRegular: return "\u{f96d}"
        case .priorityWaveBold: return "\u{f96e}"
        case .priorityWaveLight: return "\u{f96f}"
        case .priorityWaveRegular: return "\u{f970}"
        case .privacyCircleBold: return "\u{f971}"
        case .privacyCircleFilled: return "\u{f972}"
        case .privacyCircleLight: return "\u{f973}"
        case .privacyCircleRegular: return "\u{f974}"
        case .privateBold: return "\u{f975}"
        case .privateCircleBold: return "\u{f976}"
        case .privateCircleFilled: return "\u{f977}"
        case .privateCircleLight: return "\u{f978}"
        case .privateCircleRegular: return "\u{f979}"
        case .privateLight: return "\u{f97a}"
        case .privateMeetingBold: return "\u{f97b}"
        case .privateMeetingLight: return "\u{f97c}"
        case .privateMeetingRegular: return "\u{f97d}"
        case .privateRegular: return "\u{f97e}"
        case .productDemoBold: return "\u{f97f}"
        case .productDemoLight: return "\u{f980}"
        case .productDemoRegular: return "\u{f981}"
        case .promptsAiBold: return "\u{f982}"
        case .promptsAiLight: return "\u{f983}"
        case .promptsAiRegular: return "\u{f984}"
        case .proximityBold: return "\u{f985}"
        case .proximityLight: return "\u{f986}"
        case .proximityMutedBold: return "\u{f987}"
        case .proximityMutedLight: return "\u{f988}"
        case .proximityMutedRegular: return "\u{f989}"
        case .proximityRegular: return "\u{f98a}"
        case .proximityVideoBold: return "\u{f98b}"
        case .proximityVideoLight: return "\u{f98c}"
        case .proximityVideoRegular: return "\u{f98d}"
        case .ptoPresenceBold: return "\u{f98e}"
        case .ptoPresenceFilled: return "\u{f98f}"
        case .ptoPresenceLight: return "\u{f990}"
        case .ptoPresenceRegular: return "\u{f991}"
        case .pullCallBold: return "\u{f992}"
        case .pullCallFilled: return "\u{f993}"
        case .pullCallLight: return "\u{f994}"
        case .pullCallRegular: return "\u{f995}"
        case .purchaseOrderBold: return "\u{f996}"
        case .purchaseOrderFilled: return "\u{f997}"
        case .purchaseOrderLight: return "\u{f998}"
        case .purchaseOrderRegular: return "\u{f999}"
        case .qABold: return "\u{f99a}"
        case .qAFilled: return "\u{f99b}"
        case .qALight: return "\u{f99c}"
        case .qARegular: return "\u{f99d}"
        case .qrCodeBold: return "\u{f99e}"
        case .qrCodeLight: return "\u{f99f}"
        case .qrCodeRegular: return "\u{f9a0}"
        case .qrCodeScanBold: return "\u{f9a1}"
        case .qrCodeScanLight: return "\u{f9a2}"
        case .qrCodeScanRegular: return "\u{f9a3}"
        case .qualityBold: return "\u{f9a4}"
        case .qualityLight: return "\u{f9a5}"
        case .qualityRegular: return "\u{f9a6}"
        case .queueContactBold: return "\u{f9a7}"
        case .queueContactFilled: return "\u{f9a8}"
        case .queueContactLight: return "\u{f9a9}"
        case .queueContactRegular: return "\u{f9aa}"
        case .queuedInteractionBold: return "\u{f9ab}"
        case .queuedInteractionFilled: return "\u{f9ac}"
        case .queuedInteractionLight: return "\u{f9ad}"
        case .queuedInteractionRegular: return "\u{f9ae}"
        case .quietBold: return "\u{f9af}"
        case .quietHoursPresenceBold: return "\u{f9b0}"
        case .quietHoursPresenceFilled: return "\u{f9b1}"
        case .quietHoursPresenceLight: return "\u{f9b2}"
        case .quietHoursPresenceRegular: return "\u{f9b3}"
        case .quietLight: return "\u{f9b4}"
        case .quietRegular: return "\u{f9b5}"
        case .radioButtonGroupBold: return "\u{f9b6}"
        case .radioButtonGroupLight: return "\u{f9b7}"
        case .radioButtonGroupRegular: return "\u{f9b8}"
        case .raiseHandBold: return "\u{f9b9}"
        case .raiseHandCircleFilled: return "\u{f9ba}"
        case .raiseHandFilled: return "\u{f9bb}"
        case .raiseHandLight: return "\u{f9bc}"
        case .raiseHandRegular: return "\u{f9bd}"
        case .ramBold: return "\u{f9be}"
        case .ramLight: return "\u{f9bf}"
        case .ramRegular: return "\u{f9c0}"
        case .reactionsBold: return "\u{f9c1}"
        case .reactionsFilled: return "\u{f9c2}"
        case .reactionsLight: return "\u{f9c3}"
        case .reactionsRegular: return "\u{f9c4}"
        case .reactivateBold: return "\u{f9c5}"
        case .reactivateLight: return "\u{f9c6}"
        case .reactivateRegular: return "\u{f9c7}"
        case .receiveVoiceBold: return "\u{f9c8}"
        case .receiveVoiceFilled: return "\u{f9c9}"
        case .receiveVoiceLight: return "\u{f9ca}"
        case .receiveVoiceRegular: return "\u{f9cb}"
        case .recentsBold: return "\u{f9cc}"
        case .recentsFilled: return "\u{f9cd}"
        case .recentsLight: return "\u{f9ce}"
        case .recentsPresenceBadgeFilled: return "\u{f9cf}"
        case .recentsPresenceBold: return "\u{f9d0}"
        case .recentsPresenceFilled: return "\u{f9d1}"
        case .recentsPresenceLight: return "\u{f9d2}"
        case .recentsPresenceRegular: return "\u{f9d3}"
        case .recentsRegular: return "\u{f9d4}"
        case .recordActiveBadgeFilled: return "\u{f9d5}"
        case .recordActiveBold: return "\u{f9d6}"
        case .recordActiveFilled: return "\u{f9d7}"
        case .recordActiveLight: return "\u{f9d8}"
        case .recordActiveRegular: return "\u{f9d9}"
        case .recordBold: return "\u{f9da}"
        case .recordFilled: return "\u{f9db}"
        case .recordLight: return "\u{f9dc}"
        case .recordPausedBadgeFilled: return "\u{f9dd}"
        case .recordPausedBold: return "\u{f9de}"
        case .recordPausedFilled: return "\u{f9df}"
        case .recordPausedLight: return "\u{f9e0}"
        case .recordPausedRegular: return "\u{f9e1}"
        case .recordRegular: return "\u{f9e2}"
        case .recurringBold: return "\u{f9e3}"
        case .recurringLight: return "\u{f9e4}"
        case .recurringOffBold: return "\u{f9e5}"
        case .recurringOffLight: return "\u{f9e6}"
        case .recurringOffRegular: return "\u{f9e7}"
        case .recurringRegular: return "\u{f9e8}"
        case .redoBold: return "\u{f9e9}"
        case .redoLight: return "\u{f9ea}"
        case .redoRegular: return "\u{f9eb}"
        case .refreshBold: return "\u{f9ec}"
        case .refreshLight: return "\u{f9ed}"
        case .refreshRegular: return "\u{f9ee}"
        case .remoteDesktopControlBold: return "\u{f9ef}"
        case .remoteDesktopControlFilled: return "\u{f9f0}"
        case .remoteDesktopControlLight: return "\u{f9f1}"
        case .remoteDesktopControlRegular: return "\u{f9f2}"
        case .removeBold: return "\u{f9f3}"
        case .removeFilled: return "\u{f9f4}"
        case .removeLight: return "\u{f9f5}"
        case .removeRegular: return "\u{f9f6}"
        case .replyBold: return "\u{f9f7}"
        case .replyFilled: return "\u{f9f8}"
        case .replyLight: return "\u{f9f9}"
        case .replyListBold: return "\u{f9fa}"
        case .replyListFilled: return "\u{f9fb}"
        case .replyListLight: return "\u{f9fc}"
        case .replyListRegular: return "\u{f9fd}"
        case .replyPrivatelyBold: return "\u{f9fe}"
        case .replyPrivatelyLight: return "\u{f9ff}"
        case .replyPrivatelyRegular: return "\u{fa00}"
        case .replyRegular: return "\u{fa01}"
        case .resetBold: return "\u{fa02}"
        case .resetLight: return "\u{fa03}"
        case .resetRegular: return "\u{fa04}"
        case .resizeCornerBold: return "\u{fa05}"
        case .resizeCornerLight: return "\u{fa06}"
        case .resizeCornerRegular: return "\u{fa07}"
        case .responsiveMobileBold: return "\u{fa08}"
        case .responsiveMobileLight: return "\u{fa09}"
        case .responsiveMobileRegular: return "\u{fa0a}"
        case .restartBold: return "\u{fa0b}"
        case .restartLight: return "\u{fa0c}"
        case .restartRegular: return "\u{fa0d}"
        case .resumeInteractionBold: return "\u{fa0e}"
        case .resumeInteractionFilled: return "\u{fa0f}"
        case .resumeInteractionLight: return "\u{fa10}"
        case .resumeInteractionRegular: return "\u{fa11}"
        case .retrieveCallBold: return "\u{fa12}"
        case .retrieveCallFilled: return "\u{fa13}"
        case .retrieveCallLight: return "\u{fa14}"
        case .retrieveCallRegular: return "\u{fa15}"
        case .returnBold: return "\u{fa16}"
        case .returnLight: return "\u{fa17}"
        case .returnRegular: return "\u{fa18}"
        case .rewindTenSecBold: return "\u{fa19}"
        case .rewindTenSecLight: return "\u{fa1a}"
        case .rewindTenSecRegular: return "\u{fa1b}"
        case .ringtoneBold: return "\u{fa1c}"
        case .ringtoneLight: return "\u{fa1d}"
        case .ringtoneRegular: return "\u{fa1e}"
        case .roomCalendarBold: return "\u{fa1f}"
        case .roomCalendarLight: return "\u{fa20}"
        case .roomCalendarRegular: return "\u{fa21}"
        case .roomLightsBold: return "\u{fa22}"
        case .roomLightsFilled: return "\u{fa23}"
        case .roomLightsLight: return "\u{fa24}"
        case .roomLightsRegular: return "\u{fa25}"
        case .rotateContentBold: return "\u{fa26}"
        case .rotateContentFilled: return "\u{fa27}"
        case .rotateContentLight: return "\u{fa28}"
        case .rotateContentRegular: return "\u{fa29}"
        case .rssBold: return "\u{fa2a}"
        case .rssFilled: return "\u{fa2b}"
        case .rssLight: return "\u{fa2c}"
        case .rssRegular: return "\u{fa2d}"
        case .ruleBasedBold: return "\u{fa2e}"
        case .ruleBasedLight: return "\u{fa2f}"
        case .ruleBasedRegular: return "\u{fa30}"
        case .rulerBold: return "\u{fa31}"
        case .rulerFilled: return "\u{fa32}"
        case .rulerLight: return "\u{fa33}"
        case .rulerRegular: return "\u{fa34}"
        case .runningApplicationBold: return "\u{fa35}"
        case .runningApplicationFilled: return "\u{fa36}"
        case .runningApplicationLight: return "\u{fa37}"
        case .runningApplicationRegular: return "\u{fa38}"
        case .saveBold: return "\u{fa39}"
        case .saveLight: return "\u{fa3a}"
        case .saveRegular: return "\u{fa3b}"
        case .saveTranscriptBold: return "\u{fa3c}"
        case .saveTranscriptFilled: return "\u{fa3d}"
        case .saveTranscriptLight: return "\u{fa3e}"
        case .saveTranscriptRegular: return "\u{fa3f}"
        case .scanBold: return "\u{fa40}"
        case .scanLight: return "\u{fa41}"
        case .scanRegular: return "\u{fa42}"
        case .scheduleAiBold: return "\u{fa43}"
        case .scheduleAiLight: return "\u{fa44}"
        case .scheduleAiRegular: return "\u{fa45}"
        case .scheduleSendBold: return "\u{fa46}"
        case .scheduleSendFilled: return "\u{fa47}"
        case .scheduleSendLight: return "\u{fa48}"
        case .scheduleSendRegular: return "\u{fa49}"
        case .scheduleWinnerBold: return "\u{fa4a}"
        case .scheduleWinnerFilled: return "\u{fa4b}"
        case .scheduleWinnerLight: return "\u{fa4c}"
        case .scheduleWinnerRegular: return "\u{fa4d}"
        case .schedulerAvailableBold: return "\u{fa4e}"
        case .schedulerAvailableLight: return "\u{fa4f}"
        case .schedulerAvailableRegular: return "\u{fa50}"
        case .schedulerNotWorkingHoursBold: return "\u{fa51}"
        case .schedulerNotWorkingHoursLight: return "\u{fa52}"
        case .schedulerNotWorkingHoursRegular: return "\u{fa53}"
        case .schedulerUnavailableBold: return "\u{fa54}"
        case .schedulerUnavailableLight: return "\u{fa55}"
        case .schedulerUnavailableRegular: return "\u{fa56}"
        case .schedulerUnknownBold: return "\u{fa57}"
        case .schedulerUnknownLight: return "\u{fa58}"
        case .schedulerUnknownRegular: return "\u{fa59}"
        case .screenshotBold: return "\u{fa5a}"
        case .screenshotDocBold: return "\u{fa5b}"
        case .screenshotDocFilled: return "\u{fa5c}"
        case .screenshotDocLight: return "\u{fa5d}"
        case .screenshotDocRegular: return "\u{fa5e}"
        case .screenshotLight: return "\u{fa5f}"
        case .screenshotRegular: return "\u{fa60}"
        case .searchAiBold: return "\u{fa61}"
        case .searchAiLight: return "\u{fa62}"
        case .searchAiRegular: return "\u{fa63}"
        case .searchBold: return "\u{fa64}"
        case .searchFilled: return "\u{fa65}"
        case .searchLight: return "\u{fa66}"
        case .searchRegular: return "\u{fa67}"
        case .secondaryArrowBold: return "\u{fa68}"
        case .secondaryArrowLight: return "\u{fa69}"
        case .secondaryArrowRegular: return "\u{fa6a}"
        case .secureCallLockBold: return "\u{fa6b}"
        case .secureCallLockFilled: return "\u{fa6c}"
        case .secureCallLockLight: return "\u{fa6d}"
        case .secureCallLockRegular: return "\u{fa6e}"
        case .secureCallShieldBold: return "\u{fa6f}"
        case .secureCallShieldFilled: return "\u{fa70}"
        case .secureCallShieldLight: return "\u{fa71}"
        case .secureCallShieldRegular: return "\u{fa72}"
        case .secureCircleBold: return "\u{fa73}"
        case .secureCircleFilled: return "\u{fa74}"
        case .secureCircleLight: return "\u{fa75}"
        case .secureCircleRegular: return "\u{fa76}"
        case .secureLockBold: return "\u{fa77}"
        case .secureLockFilled: return "\u{fa78}"
        case .secureLockLight: return "\u{fa79}"
        case .secureLockRegular: return "\u{fa7a}"
        case .segmentExcludeFilled: return "\u{fa7b}"
        case .segmentFilterFilled: return "\u{fa7c}"
        case .segmentIncludeFilled: return "\u{fa7d}"
        case .selectAllBold: return "\u{fa7e}"
        case .selectAllFilled: return "\u{fa7f}"
        case .selectAllLight: return "\u{fa80}"
        case .selectAllRegular: return "\u{fa81}"
        case .selectionBold: return "\u{fa82}"
        case .selectionFilled: return "\u{fa83}"
        case .selectionLight: return "\u{fa84}"
        case .selectionRegular: return "\u{fa85}"
        case .sendBold: return "\u{fa86}"
        case .sendDigitsBold: return "\u{fa87}"
        case .sendDigitsFilled: return "\u{fa88}"
        case .sendDigitsLight: return "\u{fa89}"
        case .sendDigitsRegular: return "\u{fa8a}"
        case .sendFilled: return "\u{fa8b}"
        case .sendLight: return "\u{fa8c}"
        case .sendRegular: return "\u{fa8d}"
        case .sendVoiceBold: return "\u{fa8e}"
        case .sendVoiceFilled: return "\u{fa8f}"
        case .sendVoiceLight: return "\u{fa90}"
        case .sendVoiceRegular: return "\u{fa91}"
        case .serverBold: return "\u{fa92}"
        case .serverErrorBold: return "\u{fa93}"
        case .serverErrorLight: return "\u{fa94}"
        case .serverErrorRegular: return "\u{fa95}"
        case .serverLight: return "\u{fa96}"
        case .serverRegular: return "\u{fa97}"
        case .servicesBold: return "\u{fa98}"
        case .servicesLight: return "\u{fa99}"
        case .servicesRegular: return "\u{fa9a}"
        case .setVariableBold: return "\u{fa9b}"
        case .setVariableLight: return "\u{fa9c}"
        case .setVariableRegular: return "\u{fa9d}"
        case .settingsBold: return "\u{fa9e}"
        case .settingsFilled: return "\u{fa9f}"
        case .settingsLight: return "\u{faa0}"
        case .settingsRegular: return "\u{faa1}"
        case .setupAssistantBold: return "\u{faa2}"
        case .setupAssistantLight: return "\u{faa3}"
        case .setupAssistantRegular: return "\u{faa4}"
        case .sftpBold: return "\u{faa5}"
        case .sftpLight: return "\u{faa6}"
        case .sftpRegular: return "\u{faa7}"
        case .shapeCircleBold: return "\u{faa8}"
        case .shapeCircleFilled: return "\u{faa9}"
        case .shapeCircleLight: return "\u{faaa}"
        case .shapeCircleMdFilled: return "\u{faab}"
        case .shapeCircleRegular: return "\u{faac}"
        case .shapeCircleSmFilled: return "\u{faad}"
        case .shapeDiagonalLineBold: return "\u{faae}"
        case .shapeDiagonalLineLight: return "\u{faaf}"
        case .shapeDiagonalLineRegular: return "\u{fab0}"
        case .shapeDiamondBold: return "\u{fab1}"
        case .shapeDiamondFilled: return "\u{fab2}"
        case .shapeDiamondLight: return "\u{fab3}"
        case .shapeDiamondRegular: return "\u{fab4}"
        case .shapeOvalBold: return "\u{fab5}"
        case .shapeOvalLight: return "\u{fab6}"
        case .shapeOvalRegular: return "\u{fab7}"
        case .shapeSquareBold: return "\u{fab8}"
        case .shapeSquareFilled: return "\u{fab9}"
        case .shapeSquareLight: return "\u{faba}"
        case .shapeSquareRegular: return "\u{fabb}"
        case .shapeTriangleBold: return "\u{fabc}"
        case .shapeTriangleFilled: return "\u{fabd}"
        case .shapeTriangleLight: return "\u{fabe}"
        case .shapeTriangleRegular: return "\u{fabf}"
        case .shapesBold: return "\u{fac0}"
        case .shapesFilled: return "\u{fac1}"
        case .shapesLight: return "\u{fac2}"
        case .shapesRegular: return "\u{fac3}"
        case .shareCNativeAdrBold: return "\u{fac4}"
        case .shareCNativeAdrFilled: return "\u{fac5}"
        case .shareCNativeAdrLight: return "\u{fac6}"
        case .shareCNativeAdrRegular: return "\u{fac7}"
        case .shareCNativeIphBold: return "\u{fac8}"
        case .shareCNativeIphLight: return "\u{fac9}"
        case .shareCNativeIphRegular: return "\u{faca}"
        case .shareContentOnDeviceBold: return "\u{facb}"
        case .shareContentOnDeviceLight: return "\u{facc}"
        case .shareContentOnDeviceRegular: return "\u{facd}"
        case .shareScreenAddBold: return "\u{face}"
        case .shareScreenAddLight: return "\u{facf}"
        case .shareScreenAddRegular: return "\u{fad0}"
        case .shareScreenBadgeFilled: return "\u{fad1}"
        case .shareScreenBold: return "\u{fad2}"
        case .shareScreenFilled: return "\u{fad3}"
        case .shareScreenLight: return "\u{fad4}"
        case .shareScreenRegular: return "\u{fad5}"
        case .shareSpaceBold: return "\u{fad6}"
        case .shareSpaceLight: return "\u{fad7}"
        case .shareSpaceRegular: return "\u{fad8}"
        case .shieldBold: return "\u{fad9}"
        case .shieldLight: return "\u{fada}"
        case .shieldRegular: return "\u{fadb}"
        case .shoppingCartBold: return "\u{fadc}"
        case .shoppingCartFilled: return "\u{fadd}"
        case .shoppingCartLight: return "\u{fade}"
        case .shoppingCartRegular: return "\u{fadf}"
        case .shortTextBoxBold: return "\u{fae0}"
        case .shortTextBoxLight: return "\u{fae1}"
        case .shortTextBoxRegular: return "\u{fae2}"
        case .showBold: return "\u{fae3}"
        case .showFilled: return "\u{fae4}"
        case .showLight: return "\u{fae5}"
        case .showRegular: return "\u{fae6}"
        case .sidePanelBold: return "\u{fae7}"
        case .sidePanelFilled: return "\u{fae8}"
        case .sidePanelLight: return "\u{fae9}"
        case .sidePanelRegular: return "\u{faea}"
        case .signInBold: return "\u{faeb}"
        case .signInFilled: return "\u{faec}"
        case .signInForcedBold: return "\u{faed}"
        case .signInForcedLight: return "\u{faee}"
        case .signInForcedRegular: return "\u{faef}"
        case .signInLight: return "\u{faf0}"
        case .signInRegular: return "\u{faf1}"
        case .signLangIntBold: return "\u{faf2}"
        case .signLangIntLight: return "\u{faf3}"
        case .signLangIntRegular: return "\u{faf4}"
        case .signOutBold: return "\u{faf5}"
        case .signOutLight: return "\u{faf6}"
        case .signOutRegular: return "\u{faf7}"
        case .signalFourBold: return "\u{faf8}"
        case .signalFourLight: return "\u{faf9}"
        case .signalFourRegular: return "\u{fafa}"
        case .signalOneBold: return "\u{fafb}"
        case .signalOneLight: return "\u{fafc}"
        case .signalOneRegular: return "\u{fafd}"
        case .signalThreeBold: return "\u{fafe}"
        case .signalThreeLight: return "\u{faff}"
        case .signalThreeRegular: return "\u{fb00}"
        case .signalTwoBold: return "\u{fb01}"
        case .signalTwoLight: return "\u{fb02}"
        case .signalTwoRegular: return "\u{fb03}"
        case .signalZeroBold: return "\u{fb04}"
        case .signalZeroLight: return "\u{fb05}"
        case .signalZeroRegular: return "\u{fb06}"
        case .simplePromotionBold: return "\u{fb07}"
        case .simplePromotionLight: return "\u{fb08}"
        case .simplePromotionRegular: return "\u{fb09}"
        case .singleNumberReachBold: return "\u{fb0a}"
        case .singleNumberReachLight: return "\u{fb0b}"
        case .singleNumberReachRegular: return "\u{fb0c}"
        case .sipRegistrationInProgressBold: return "\u{fb0d}"
        case .sipRegistrationInProgressFilled: return "\u{fb0e}"
        case .sipRegistrationInProgressLight: return "\u{fb0f}"
        case .sipRegistrationInProgressRegular: return "\u{fb10}"
        case .skipBold: return "\u{fb11}"
        case .skipBwBold: return "\u{fb12}"
        case .skipBwFilled: return "\u{fb13}"
        case .skipBwLight: return "\u{fb14}"
        case .skipBwRegular: return "\u{fb15}"
        case .skipFwBold: return "\u{fb16}"
        case .skipFwFilled: return "\u{fb17}"
        case .skipFwLight: return "\u{fb18}"
        case .skipFwRegular: return "\u{fb19}"
        case .skipLight: return "\u{fb1a}"
        case .skipRegular: return "\u{fb1b}"
        case .smartAudioBold: return "\u{fb1c}"
        case .smartAudioLight: return "\u{fb1d}"
        case .smartAudioRegular: return "\u{fb1e}"
        case .smsFilled: return "\u{fb1f}"
        case .smsInboundBold: return "\u{fb20}"
        case .smsInboundLight: return "\u{fb21}"
        case .smsInboundRegular: return "\u{fb22}"
        case .smsMessageBold: return "\u{fb23}"
        case .smsMessageFilled: return "\u{fb24}"
        case .smsMessageLight: return "\u{fb25}"
        case .smsMessageOutgoingBold: return "\u{fb26}"
        case .smsMessageOutgoingFilled: return "\u{fb27}"
        case .smsMessageOutgoingLight: return "\u{fb28}"
        case .smsMessageOutgoingRegular: return "\u{fb29}"
        case .smsMessageRegular: return "\u{fb2a}"
        case .smsMessageStartBold: return "\u{fb2b}"
        case .smsMessageStartFilled: return "\u{fb2c}"
        case .smsMessageStartLight: return "\u{fb2d}"
        case .smsMessageStartRegular: return "\u{fb2e}"
        case .smsOutgoingFilled: return "\u{fb2f}"
        case .smsUnreadBold: return "\u{fb30}"
        case .smsUnreadLight: return "\u{fb31}"
        case .smsUnreadRegular: return "\u{fb32}"
        case .sortAscendingBold: return "\u{fb33}"
        case .sortAscendingLight: return "\u{fb34}"
        case .sortAscendingRegular: return "\u{fb35}"
        case .sortDescendingBold: return "\u{fb36}"
        case .sortDescendingLight: return "\u{fb37}"
        case .sortDescendingRegular: return "\u{fb38}"
        case .soundDefaultBold: return "\u{fb39}"
        case .soundDefaultLight: return "\u{fb3a}"
        case .soundDefaultRegular: return "\u{fb3b}"
        case .sparkleBold: return "\u{fb3c}"
        case .sparkleFilled: return "\u{fb3d}"
        case .sparkleLight: return "\u{fb3e}"
        case .sparkleRegular: return "\u{fb3f}"
        case .speakerBold: return "\u{fb40}"
        case .speakerDisconnectedBold: return "\u{fb41}"
        case .speakerDisconnectedFilled: return "\u{fb42}"
        case .speakerDisconnectedLight: return "\u{fb43}"
        case .speakerDisconnectedRegular: return "\u{fb44}"
        case .speakerFilled: return "\u{fb45}"
        case .speakerLight: return "\u{fb46}"
        case .speakerMutedBold: return "\u{fb47}"
        case .speakerMutedFilled: return "\u{fb48}"
        case .speakerMutedLight: return "\u{fb49}"
        case .speakerMutedRegular: return "\u{fb4a}"
        case .speakerOffBold: return "\u{fb4b}"
        case .speakerOffFilled: return "\u{fb4c}"
        case .speakerOffLight: return "\u{fb4d}"
        case .speakerOffRegular: return "\u{fb4e}"
        case .speakerOnBold: return "\u{fb4f}"
        case .speakerOnLight: return "\u{fb50}"
        case .speakerOnRegular: return "\u{fb51}"
        case .speakerRegular: return "\u{fb52}"
        case .speakerTurnDownBold: return "\u{fb53}"
        case .speakerTurnDownFilled: return "\u{fb54}"
        case .speakerTurnDownLight: return "\u{fb55}"
        case .speakerTurnDownRegular: return "\u{fb56}"
        case .speakerTurnUpBold: return "\u{fb57}"
        case .speakerTurnUpFilled: return "\u{fb58}"
        case .speakerTurnUpLight: return "\u{fb59}"
        case .speakerTurnUpRegular: return "\u{fb5a}"
        case .speedDialBold: return "\u{fb5b}"
        case .speedDialFilled: return "\u{fb5c}"
        case .speedDialLight: return "\u{fb5d}"
        case .speedDialRegular: return "\u{fb5e}"
        case .spellCheckerBold: return "\u{fb5f}"
        case .spellCheckerLight: return "\u{fb60}"
        case .spellCheckerRegular: return "\u{fb61}"
        case .splitViewBold: return "\u{fb62}"
        case .splitViewLight: return "\u{fb63}"
        case .splitViewRegular: return "\u{fb64}"
        case .stackedAreaChartBold: return "\u{fb65}"
        case .stackedAreaChartFilled: return "\u{fb66}"
        case .stackedAreaChartFullBold: return "\u{fb67}"
        case .stackedAreaChartFullFilled: return "\u{fb68}"
        case .stackedAreaChartFullLight: return "\u{fb69}"
        case .stackedAreaChartFullRegular: return "\u{fb6a}"
        case .stackedAreaChartLight: return "\u{fb6b}"
        case .stackedAreaChartRegular: return "\u{fb6c}"
        case .stackedBarChartBold: return "\u{fb6d}"
        case .stackedBarChartFilled: return "\u{fb6e}"
        case .stackedBarChartFullBold: return "\u{fb6f}"
        case .stackedBarChartFullFilled: return "\u{fb70}"
        case .stackedBarChartFullLight: return "\u{fb71}"
        case .stackedBarChartFullRegular: return "\u{fb72}"
        case .stackedBarChartLight: return "\u{fb73}"
        case .stackedBarChartRegular: return "\u{fb74}"
        case .startChatBold: return "\u{fb75}"
        case .startChatLight: return "\u{fb76}"
        case .startChatRegular: return "\u{fb77}"
        case .stethoscopeBold: return "\u{fb78}"
        case .stethoscopeLight: return "\u{fb79}"
        case .stethoscopeRegular: return "\u{fb7a}"
        case .stickersBold: return "\u{fb7b}"
        case .stickersLight: return "\u{fb7c}"
        case .stickersRegular: return "\u{fb7d}"
        case .stickiesBold: return "\u{fb7e}"
        case .stickiesLight: return "\u{fb7f}"
        case .stickiesRegular: return "\u{fb80}"
        case .stopBold: return "\u{fb81}"
        case .stopCircleBold: return "\u{fb82}"
        case .stopCircleFilled: return "\u{fb83}"
        case .stopCircleLight: return "\u{fb84}"
        case .stopCircleRegular: return "\u{fb85}"
        case .stopContentShareBold: return "\u{fb86}"
        case .stopContentShareLight: return "\u{fb87}"
        case .stopContentShareRegular: return "\u{fb88}"
        case .stopFilled: return "\u{fb89}"
        case .stopLight: return "\u{fb8a}"
        case .stopRegular: return "\u{fb8b}"
        case .storedInfoBold: return "\u{fb8c}"
        case .storedInfoFilled: return "\u{fb8d}"
        case .storedInfoLight: return "\u{fb8e}"
        case .storedInfoRegular: return "\u{fb8f}"
        case .streamingBold: return "\u{fb90}"
        case .streamingLight: return "\u{fb91}"
        case .streamingRegular: return "\u{fb92}"
        case .strikethroughBold: return "\u{fb93}"
        case .strikethroughFilled: return "\u{fb94}"
        case .strikethroughLight: return "\u{fb95}"
        case .strikethroughRegular: return "\u{fb96}"
        case .studioModeBold: return "\u{fb97}"
        case .studioModeLight: return "\u{fb98}"
        case .studioModeRegular: return "\u{fb99}"
        case .subscriptBold: return "\u{fb9a}"
        case .subscriptLight: return "\u{fb9b}"
        case .subscriptRegular: return "\u{fb9c}"
        case .summarizeAiBold: return "\u{fb9d}"
        case .summarizeAiLight: return "\u{fb9e}"
        case .summarizeAiRegular: return "\u{fb9f}"
        case .superscriptBold: return "\u{fba0}"
        case .superscriptLight: return "\u{fba1}"
        case .superscriptRegular: return "\u{fba2}"
        case .surveyBold: return "\u{fba3}"
        case .surveyFilled: return "\u{fba4}"
        case .surveyLight: return "\u{fba5}"
        case .surveyRegular: return "\u{fba6}"
        case .sxEightyCodecBold: return "\u{fba7}"
        case .sxEightyCodecLight: return "\u{fba8}"
        case .sxEightyCodecRegular: return "\u{fba9}"
        case .sxTenBold: return "\u{fbaa}"
        case .sxTenLight: return "\u{fbab}"
        case .sxTenRegular: return "\u{fbac}"
        case .sxTwentyBold: return "\u{fbad}"
        case .sxTwentyLight: return "\u{fbae}"
        case .sxTwentyRegular: return "\u{fbaf}"
        case .tableBold: return "\u{fbb0}"
        case .tableExtenderBold: return "\u{fbb1}"
        case .tableExtenderFilled: return "\u{fbb2}"
        case .tableExtenderLight: return "\u{fbb3}"
        case .tableExtenderRegular: return "\u{fbb4}"
        case .tableLight: return "\u{fbb5}"
        case .tableRegular: return "\u{fbb6}"
        case .tabletBold: return "\u{fbb7}"
        case .tabletLight: return "\u{fbb8}"
        case .tabletRegular: return "\u{fbb9}"
        case .tabsBold: return "\u{fbba}"
        case .tabsLight: return "\u{fbbb}"
        case .tabsRegular: return "\u{fbbc}"
        case .tagBold: return "\u{fbbd}"
        case .tagLight: return "\u{fbbe}"
        case .tagRegular: return "\u{fbbf}"
        case .tapBold: return "\u{fbc0}"
        case .tapFilled: return "\u{fbc1}"
        case .tapLight: return "\u{fbc2}"
        case .tapRegular: return "\u{fbc3}"
        case .telepresenceAlertBold: return "\u{fbc4}"
        case .telepresenceAlertLight: return "\u{fbc5}"
        case .telepresenceAlertMutedBold: return "\u{fbc6}"
        case .telepresenceAlertMutedLight: return "\u{fbc7}"
        case .telepresenceAlertMutedRegular: return "\u{fbc8}"
        case .telepresenceAlertRegular: return "\u{fbc9}"
        case .telepresenceBold: return "\u{fbca}"
        case .telepresenceIxFiveThousandBold: return "\u{fbcb}"
        case .telepresenceIxFiveThousandLight: return "\u{fbcc}"
        case .telepresenceIxFiveThousandRegular: return "\u{fbcd}"
        case .telepresenceLight: return "\u{fbce}"
        case .telepresenceMutedBold: return "\u{fbcf}"
        case .telepresenceMutedLight: return "\u{fbd0}"
        case .telepresenceMutedRegular: return "\u{fbd1}"
        case .telepresencePrivateBold: return "\u{fbd2}"
        case .telepresencePrivateLight: return "\u{fbd3}"
        case .telepresencePrivateRegular: return "\u{fbd4}"
        case .telepresenceRegular: return "\u{fbd5}"
        case .temperatureBold: return "\u{fbd6}"
        case .temperatureLight: return "\u{fbd7}"
        case .temperatureRegular: return "\u{fbd8}"
        case .testTubeBold: return "\u{fbd9}"
        case .testTubeFilled: return "\u{fbda}"
        case .testTubeLight: return "\u{fbdb}"
        case .testTubeRegular: return "\u{fbdc}"
        case .textAlignCenterBold: return "\u{fbdd}"
        case .textAlignCenterFilled: return "\u{fbde}"
        case .textAlignCenterLight: return "\u{fbdf}"
        case .textAlignCenterRegular: return "\u{fbe0}"
        case .textAlignLeftBold: return "\u{fbe1}"
        case .textAlignLeftFilled: return "\u{fbe2}"
        case .textAlignLeftLight: return "\u{fbe3}"
        case .textAlignLeftRegular: return "\u{fbe4}"
        case .textAlignRightBold: return "\u{fbe5}"
        case .textAlignRightFilled: return "\u{fbe6}"
        case .textAlignRightLight: return "\u{fbe7}"
        case .textAlignRightRegular: return "\u{fbe8}"
        case .textBold: return "\u{fbe9}"
        case .textBoxCursorLight: return "\u{fbea}"
        case .textCodeBlockBold: return "\u{fbeb}"
        case .textCodeBlockLight: return "\u{fbec}"
        case .textCodeBlockRegular: return "\u{fbed}"
        case .textHighlightBold: return "\u{fbee}"
        case .textHighlightFilled: return "\u{fbef}"
        case .textHighlightLight: return "\u{fbf0}"
        case .textHighlightRegular: return "\u{fbf1}"
        case .textLight: return "\u{fbf2}"
        case .textRegular: return "\u{fbf3}"
        case .threeColumnBold: return "\u{fbf4}"
        case .threeColumnLight: return "\u{fbf5}"
        case .threeColumnRegular: return "\u{fbf6}"
        case .threeDObjectBold: return "\u{fbf7}"
        case .threeDObjectLight: return "\u{fbf8}"
        case .threeDObjectRegular: return "\u{fbf9}"
        case .timeExclusionBold: return "\u{fbfa}"
        case .timeExclusionLight: return "\u{fbfb}"
        case .timeExclusionRegular: return "\u{fbfc}"
        case .timezoneBold: return "\u{fbfd}"
        case .timezoneFilled: return "\u{fbfe}"
        case .timezoneLight: return "\u{fbff}"
        case .timezoneRegular: return "\u{fc00}"
        case .tooFastBold: return "\u{fc01}"
        case .tooFastLight: return "\u{fc02}"
        case .tooFastRegular: return "\u{fc03}"
        case .tooSlowBold: return "\u{fc04}"
        case .tooSlowLight: return "\u{fc05}"
        case .tooSlowRegular: return "\u{fc06}"
        case .toolsBold: return "\u{fc07}"
        case .toolsFilled: return "\u{fc08}"
        case .toolsLight: return "\u{fc09}"
        case .toolsRegular: return "\u{fc0a}"
        case .touchTenBold: return "\u{fc0b}"
        case .touchTenLight: return "\u{fc0c}"
        case .touchTenRegular: return "\u{fc0d}"
        case .transcriptBold: return "\u{fc0e}"
        case .transcriptFilled: return "\u{fc0f}"
        case .transcriptLight: return "\u{fc10}"
        case .transcriptRegular: return "\u{fc11}"
        case .translateBold: return "\u{fc12}"
        case .translateLight: return "\u{fc13}"
        case .translateRegular: return "\u{fc14}"
        case .translateUndoBold: return "\u{fc15}"
        case .translateUndoLight: return "\u{fc16}"
        case .translateUndoRegular: return "\u{fc17}"
        case .trendingBold: return "\u{fc18}"
        case .trendingDownBold: return "\u{fc19}"
        case .trendingDownFilled: return "\u{fc1a}"
        case .trendingDownLight: return "\u{fc1b}"
        case .trendingDownRegular: return "\u{fc1c}"
        case .trendingFilled: return "\u{fc1d}"
        case .trendingLight: return "\u{fc1e}"
        case .trendingRegular: return "\u{fc1f}"
        case .trimBold: return "\u{fc20}"
        case .trimLight: return "\u{fc21}"
        case .trimRegular: return "\u{fc22}"
        case .twoColumnBold: return "\u{fc23}"
        case .twoColumnLight: return "\u{fc24}"
        case .twoColumnRegular: return "\u{fc25}"
        case .twoWayVoiceStreamBold: return "\u{fc26}"
        case .twoWayVoiceStreamFilled: return "\u{fc27}"
        case .twoWayVoiceStreamLight: return "\u{fc28}"
        case .twoWayVoiceStreamRegular: return "\u{fc29}"
        case .ucmCloudBold: return "\u{fc2a}"
        case .ucmCloudLight: return "\u{fc2b}"
        case .ucmCloudRegular: return "\u{fc2c}"
        case .unblockBold: return "\u{fc2d}"
        case .unblockFilled: return "\u{fc2e}"
        case .unblockLight: return "\u{fc2f}"
        case .unblockRegular: return "\u{fc30}"
        case .underlineBold: return "\u{fc31}"
        case .underlineFilled: return "\u{fc32}"
        case .underlineLight: return "\u{fc33}"
        case .underlineRegular: return "\u{fc34}"
        case .undoBold: return "\u{fc35}"
        case .undoLight: return "\u{fc36}"
        case .undoRegular: return "\u{fc37}"
        case .unlinkBold: return "\u{fc38}"
        case .unlinkLight: return "\u{fc39}"
        case .unlinkRegular: return "\u{fc3a}"
        case .unreadBold: return "\u{fc3b}"
        case .unreadFilled: return "\u{fc3c}"
        case .unreadLight: return "\u{fc3d}"
        case .unreadRegular: return "\u{fc3e}"
        case .unsecureUnlockedBold: return "\u{fc3f}"
        case .unsecureUnlockedFilled: return "\u{fc40}"
        case .unsecureUnlockedLight: return "\u{fc41}"
        case .unsecureUnlockedRegular: return "\u{fc42}"
        case .unsortedBold: return "\u{fc43}"
        case .unsortedLight: return "\u{fc44}"
        case .unsortedRegular: return "\u{fc45}"
        case .updateFileShareBold: return "\u{fc46}"
        case .updateFileShareLight: return "\u{fc47}"
        case .updateFileShareRegular: return "\u{fc48}"
        case .uploadBold: return "\u{fc49}"
        case .uploadImageBold: return "\u{fc4a}"
        case .uploadImageLight: return "\u{fc4b}"
        case .uploadImageRegular: return "\u{fc4c}"
        case .uploadLight: return "\u{fc4d}"
        case .uploadRegular: return "\u{fc4e}"
        case .urgentVoicemailBold: return "\u{fc4f}"
        case .urgentVoicemailFilled: return "\u{fc50}"
        case .usbBold: return "\u{fc51}"
        case .usbHeadsetBold: return "\u{fc52}"
        case .usbHeadsetLight: return "\u{fc53}"
        case .usbHeadsetMutedBold: return "\u{fc54}"
        case .usbHeadsetMutedLight: return "\u{fc55}"
        case .usbHeadsetMutedRegular: return "\u{fc56}"
        case .usbHeadsetRegular: return "\u{fc57}"
        case .usbLight: return "\u{fc58}"
        case .usbRegular: return "\u{fc59}"
        case .userBold: return "\u{fc5a}"
        case .userDeactivateBold: return "\u{fc5b}"
        case .userDeactivateLight: return "\u{fc5c}"
        case .userDeactivateRegular: return "\u{fc5d}"
        case .userFilled: return "\u{fc5e}"
        case .userLight: return "\u{fc5f}"
        case .userRegular: return "\u{fc60}"
        case .videoBlurBold: return "\u{fc61}"
        case .videoBlurFilled: return "\u{fc62}"
        case .videoBlurLight: return "\u{fc63}"
        case .videoBlurRegular: return "\u{fc64}"
        case .videoBold: return "\u{fc65}"
        case .videoEffectBold: return "\u{fc66}"
        case .videoEffectFilled: return "\u{fc67}"
        case .videoEffectLight: return "\u{fc68}"
        case .videoEffectRegular: return "\u{fc69}"
        case .videoFilled: return "\u{fc6a}"
        case .videoLayoutBold: return "\u{fc6b}"
        case .videoLayoutCustomBold: return "\u{fc6c}"
        case .videoLayoutCustomFilled: return "\u{fc6d}"
        case .videoLayoutCustomLight: return "\u{fc6e}"
        case .videoLayoutCustomRegular: return "\u{fc6f}"
        case .videoLayoutEqualBold: return "\u{fc70}"
        case .videoLayoutEqualDualBold: return "\u{fc71}"
        case .videoLayoutEqualDualLight: return "\u{fc72}"
        case .videoLayoutEqualDualRegular: return "\u{fc73}"
        case .videoLayoutEqualFilled: return "\u{fc74}"
        case .videoLayoutEqualLight: return "\u{fc75}"
        case .videoLayoutEqualRegular: return "\u{fc76}"
        case .videoLayoutFilled: return "\u{fc77}"
        case .videoLayoutLight: return "\u{fc78}"
        case .videoLayoutOverlayBold: return "\u{fc79}"
        case .videoLayoutOverlayFilled: return "\u{fc7a}"
        case .videoLayoutOverlayLight: return "\u{fc7b}"
        case .videoLayoutOverlayRegular: return "\u{fc7c}"
        case .videoLayoutPresentationBold: return "\u{fc7d}"
        case .videoLayoutPresentationFilled: return "\u{fc7e}"
        case .videoLayoutPresentationLight: return "\u{fc7f}"
        case .videoLayoutPresentationRegular: return "\u{fc80}"
        case .videoLayoutPresenterDominantBold: return "\u{fc81}"
        case .videoLayoutPresenterDominantLight: return "\u{fc82}"
        case .videoLayoutPresenterDominantRegular: return "\u{fc83}"
        case .videoLayoutProminentBold: return "\u{fc84}"
        case .videoLayoutProminentFilled: return "\u{fc85}"
        case .videoLayoutProminentLight: return "\u{fc86}"
        case .videoLayoutProminentRegular: return "\u{fc87}"
        case .videoLayoutRegular: return "\u{fc88}"
        case .videoLayoutShareDominantBold: return "\u{fc89}"
        case .videoLayoutShareDominantLight: return "\u{fc8a}"
        case .videoLayoutShareDominantRegular: return "\u{fc8b}"
        case .videoLayoutSingleBold: return "\u{fc8c}"
        case .videoLayoutSingleFilled: return "\u{fc8d}"
        case .videoLayoutSingleLight: return "\u{fc8e}"
        case .videoLayoutSingleRegular: return "\u{fc8f}"
        case .videoLayoutSpeakerBold: return "\u{fc90}"
        case .videoLayoutSpeakerFilled: return "\u{fc91}"
        case .videoLayoutSpeakerLight: return "\u{fc92}"
        case .videoLayoutSpeakerRegular: return "\u{fc93}"
        case .videoLayoutStackBold: return "\u{fc94}"
        case .videoLayoutStackFilled: return "\u{fc95}"
        case .videoLayoutStackLight: return "\u{fc96}"
        case .videoLayoutStackRegular: return "\u{fc97}"
        case .videoLayoutVideoDominantBold: return "\u{fc98}"
        case .videoLayoutVideoDominantFilled: return "\u{fc99}"
        case .videoLayoutVideoDominantLight: return "\u{fc9a}"
        case .videoLayoutVideoDominantRegular: return "\u{fc9b}"
        case .videoLight: return "\u{fc9c}"
        case .videoPlusBold: return "\u{fc9d}"
        case .videoPlusFilled: return "\u{fc9e}"
        case .videoPlusLight: return "\u{fc9f}"
        case .videoPlusRegular: return "\u{fca0}"
        case .videoRegular: return "\u{fca1}"
        case .videoSpeakerTrackBold: return "\u{fca2}"
        case .videoSpeakerTrackFilled: return "\u{fca3}"
        case .videoSpeakerTrackLight: return "\u{fca4}"
        case .videoSpeakerTrackRegular: return "\u{fca5}"
        case .viewAllBold: return "\u{fca6}"
        case .viewAllLight: return "\u{fca7}"
        case .viewAllRegular: return "\u{fca8}"
        case .viewListBold: return "\u{fca9}"
        case .viewListFilled: return "\u{fcaa}"
        case .viewListLight: return "\u{fcab}"
        case .viewListRegular: return "\u{fcac}"
        case .viewStackedBold: return "\u{fcad}"
        case .viewStackedFilled: return "\u{fcae}"
        case .viewStackedLight: return "\u{fcaf}"
        case .viewStackedRegular: return "\u{fcb0}"
        case .viewThumbnailBold: return "\u{fcb1}"
        case .viewThumbnailFilled: return "\u{fcb2}"
        case .viewThumbnailLight: return "\u{fcb3}"
        case .viewThumbnailRegular: return "\u{fcb4}"
        case .visionproBold: return "\u{fcb5}"
        case .visionproFilled: return "\u{fcb6}"
        case .visionproLight: return "\u{fcb7}"
        case .visionproMoveCallInBold: return "\u{fcb8}"
        case .visionproMoveCallInFilled: return "\u{fcb9}"
        case .visionproMoveCallInLight: return "\u{fcba}"
        case .visionproMoveCallInOutBold: return "\u{fcbb}"
        case .visionproMoveCallInOutFilled: return "\u{fcbc}"
        case .visionproMoveCallInOutLight: return "\u{fcbd}"
        case .visionproMoveCallInOutRegular: return "\u{fcbe}"
        case .visionproMoveCallInRegular: return "\u{fcbf}"
        case .visionproMoveCallOutBold: return "\u{fcc0}"
        case .visionproMoveCallOutFilled: return "\u{fcc1}"
        case .visionproMoveCallOutLight: return "\u{fcc2}"
        case .visionproMoveCallOutRegular: return "\u{fcc3}"
        case .visionproRegular: return "\u{fcc4}"
        case .voicemailBold: return "\u{fcc5}"
        case .voicemailFilled: return "\u{fcc6}"
        case .voicemailLight: return "\u{fcc7}"
        case .voicemailRegular: return "\u{fcc8}"
        case .vpnBold: return "\u{fcc9}"
        case .vpnFilled: return "\u{fcca}"
        case .vpnLight: return "\u{fccb}"
        case .vpnRegular: return "\u{fccc}"
        case .vscBold: return "\u{fccd}"
        case .vscLight: return "\u{fcce}"
        case .vscRegular: return "\u{fccf}"
        case .waffleMenuBold: return "\u{fcd0}"
        case .waffleMenuLight: return "\u{fcd1}"
        case .waffleMenuRegular: return "\u{fcd2}"
        case .waitingRoomBold: return "\u{fcd3}"
        case .waitingRoomLight: return "\u{fcd4}"
        case .waitingRoomRegular: return "\u{fcd5}"
        case .wallpaperBold: return "\u{fcd6}"
        case .wallpaperLight: return "\u{fcd7}"
        case .wallpaperRegular: return "\u{fcd8}"
        case .warningBadgeFilled: return "\u{fcd9}"
        case .warningBold: return "\u{fcda}"
        case .warningFilled: return "\u{fcdb}"
        case .warningLight: return "\u{fcdc}"
        case .warningRegular: return "\u{fcdd}"
        case .webexBoardBold: return "\u{fcde}"
        case .webexBoardLight: return "\u{fcdf}"
        case .webexBoardRegular: return "\u{fce0}"
        case .webexCodecPlusBold: return "\u{fce1}"
        case .webexCodecPlusLight: return "\u{fce2}"
        case .webexCodecPlusRegular: return "\u{fce3}"
        case .webexDeskCameraBold: return "\u{fce4}"
        case .webexDeskCameraLight: return "\u{fce5}"
        case .webexDeskCameraRegular: return "\u{fce6}"
        case .webexHelixBold: return "\u{fce7}"
        case .webexHelixLight: return "\u{fce8}"
        case .webexHelixRegular: return "\u{fce9}"
        case .webexMeetingsBold: return "\u{fcea}"
        case .webexMeetingsFilled: return "\u{fceb}"
        case .webexMeetingsLight: return "\u{fcec}"
        case .webexMeetingsRegular: return "\u{fced}"
        case .webexQuadCameraBold: return "\u{fcee}"
        case .webexQuadCameraLight: return "\u{fcef}"
        case .webexQuadCameraRegular: return "\u{fcf0}"
        case .webexRoomKitBold: return "\u{fcf1}"
        case .webexRoomKitLight: return "\u{fcf2}"
        case .webexRoomKitPlusBold: return "\u{fcf3}"
        case .webexRoomKitPlusLight: return "\u{fcf4}"
        case .webexRoomKitPlusRegular: return "\u{fcf5}"
        case .webexRoomKitRegular: return "\u{fcf6}"
        case .webexShareBold: return "\u{fcf7}"
        case .webexShareLight: return "\u{fcf8}"
        case .webexShareRegular: return "\u{fcf9}"
        case .webexTeamsBold: return "\u{fcfa}"
        case .webexTeamsFilled: return "\u{fcfb}"
        case .webexTeamsLight: return "\u{fcfc}"
        case .webexTeamsNewBold: return "\u{fcfd}"
        case .webexTeamsNewFilled: return "\u{fcfe}"
        case .webexTeamsNewLight: return "\u{fcff}"
        case .webexTeamsNewRegular: return "\u{fd00}"
        case .webexTeamsRegular: return "\u{fd01}"
        case .webexTeamsRemoveBold: return "\u{fd02}"
        case .webexTeamsRemoveLight: return "\u{fd03}"
        case .webexTeamsRemoveRegular: return "\u{fd04}"
        case .webhookBold: return "\u{fd05}"
        case .webhookLight: return "\u{fd06}"
        case .webhookRegular: return "\u{fd07}"
        case .webinarBold: return "\u{fd08}"
        case .webinarFilled: return "\u{fd09}"
        case .webinarLight: return "\u{fd0a}"
        case .webinarRegular: return "\u{fd0b}"
        case .weeklyRecurringScheduleBold: return "\u{fd0c}"
        case .weeklyRecurringScheduleLight: return "\u{fd0d}"
        case .weeklyRecurringScheduleRegular: return "\u{fd0e}"
        case .whisperAnnouncementBold: return "\u{fd0f}"
        case .whisperAnnouncementFilled: return "\u{fd10}"
        case .whisperAnnouncementLight: return "\u{fd11}"
        case .whisperAnnouncementRegular: return "\u{fd12}"
        case .whisperCoachBold: return "\u{fd13}"
        case .whisperCoachFilled: return "\u{fd14}"
        case .whisperCoachLight: return "\u{fd15}"
        case .whisperCoachRegular: return "\u{fd16}"
        case .whiteboardBold: return "\u{fd17}"
        case .whiteboardContentBold: return "\u{fd18}"
        case .whiteboardContentFilled: return "\u{fd19}"
        case .whiteboardContentLight: return "\u{fd1a}"
        case .whiteboardContentRegular: return "\u{fd1b}"
        case .whiteboardFilled: return "\u{fd1c}"
        case .whiteboardLight: return "\u{fd1d}"
        case .whiteboardRegular: return "\u{fd1e}"
        case .widgetBold: return "\u{fd1f}"
        case .widgetFilled: return "\u{fd20}"
        case .widgetLight: return "\u{fd21}"
        case .widgetRegular: return "\u{fd22}"
        case .wifiBold: return "\u{fd23}"
        case .wifiErrorBold: return "\u{fd24}"
        case .wifiErrorLight: return "\u{fd25}"
        case .wifiErrorRegular: return "\u{fd26}"
        case .wifiLight: return "\u{fd27}"
        case .wifiRegular: return "\u{fd28}"
        case .wifiSignalGoodBold: return "\u{fd29}"
        case .wifiSignalGoodLight: return "\u{fd2a}"
        case .wifiSignalGoodRegular: return "\u{fd2b}"
        case .wifiSignalPoorBold: return "\u{fd2c}"
        case .wifiSignalPoorLight: return "\u{fd2d}"
        case .wifiSignalPoorRegular: return "\u{fd2e}"
        case .wifiSignalUnstableBold: return "\u{fd2f}"
        case .wifiSignalUnstableLight: return "\u{fd30}"
        case .wifiSignalUnstableRegular: return "\u{fd31}"
        case .windowCornerScrubBold: return "\u{fd32}"
        case .windowCornerScrubLight: return "\u{fd33}"
        case .windowCornerScrubRegular: return "\u{fd34}"
        case .windowRightCornerScrubBold: return "\u{fd35}"
        case .windowRightCornerScrubLight: return "\u{fd36}"
        case .windowRightCornerScrubRegular: return "\u{fd37}"
        case .windowVerticalScrubBold: return "\u{fd38}"
        case .windowVerticalScrubLight: return "\u{fd39}"
        case .windowVerticalScrubRegular: return "\u{fd3a}"
        case .workflowDeploymentsBold: return "\u{fd3b}"
        case .workflowDeploymentsFilled: return "\u{fd3c}"
        case .workflowDeploymentsLight: return "\u{fd3d}"
        case .workflowDeploymentsRegular: return "\u{fd3e}"
        case .workphoneBold: return "\u{fd3f}"
        case .workphoneLight: return "\u{fd40}"
        case .workphoneRegular: return "\u{fd41}"
        case .zoomInBold: return "\u{fd42}"
        case .zoomInLight: return "\u{fd43}"
        case .zoomInRegular: return "\u{fd44}"
        case .zoomOutBold: return "\u{fd45}"
        case .zoomOutLight: return "\u{fd46}"
        case .zoomOutRegular: return "\u{fd47}"
