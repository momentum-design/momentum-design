...
@objc public enum MomentumIconsType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .webinarBold: return "\u{fc66}"
        case .webinarFilled: return "\u{fc67}"
        case .webinarLight: return "\u{fc68}"
        case .webinarRegular: return "\u{fc69}"
        case .weeklyRecurringScheduleBold: return "\u{fc6a}"
        case .weeklyRecurringScheduleLight: return "\u{fc6b}"
        case .weeklyRecurringScheduleRegular: return "\u{fc6c}"
        case .whisperAnnouncementBold: return "\u{fc6d}"
        case .whisperAnnouncementFilled: return "\u{fc6e}"
        case .whisperAnnouncementLight: return "\u{fc6f}"
        case .whisperAnnouncementRegular: return "\u{fc70}"
        case .whisperCoachBold: return "\u{fc71}"
        case .whisperCoachFilled: return "\u{fc72}"
        case .whisperCoachLight: return "\u{fc73}"
        case .whisperCoachRegular: return "\u{fc74}"
        case .whiteboardBold: return "\u{fc75}"
        case .whiteboardContentBold: return "\u{fc76}"
        case .whiteboardContentFilled: return "\u{fc77}"
        case .whiteboardContentLight: return "\u{fc78}"
        case .whiteboardContentRegular: return "\u{fc79}"
        case .whiteboardFilled: return "\u{fc7a}"
        case .whiteboardLight: return "\u{fc7b}"
        case .whiteboardRegular: return "\u{fc7c}"
        case .widgetBold: return "\u{fc7d}"
        case .widgetFilled: return "\u{fc7e}"
        case .widgetLight: return "\u{fc7f}"
        case .widgetRegular: return "\u{fc80}"
        case .wifiBold: return "\u{fc81}"
        case .wifiErrorBold: return "\u{fc82}"
        case .wifiErrorLight: return "\u{fc83}"
        case .wifiErrorRegular: return "\u{fc84}"
        case .wifiLight: return "\u{fc85}"
        case .wifiRegular: return "\u{fc86}"
        case .wifiSignalGoodBold: return "\u{fc87}"
        case .wifiSignalGoodLight: return "\u{fc88}"
        case .wifiSignalGoodRegular: return "\u{fc89}"
        case .wifiSignalPoorBold: return "\u{fc8a}"
        case .wifiSignalPoorLight: return "\u{fc8b}"
        case .wifiSignalPoorRegular: return "\u{fc8c}"
        case .wifiSignalUnstableBold: return "\u{fc8d}"
        case .wifiSignalUnstableLight: return "\u{fc8e}"
        case .wifiSignalUnstableRegular: return "\u{fc8f}"
        case .windowCornerScrubBold: return "\u{fc90}"
        case .windowCornerScrubLight: return "\u{fc91}"
        case .windowCornerScrubRegular: return "\u{fc92}"
        case .windowRightCornerScrubBold: return "\u{fc93}"
        case .windowRightCornerScrubLight: return "\u{fc94}"
        case .windowRightCornerScrubRegular: return "\u{fc95}"
        case .windowVerticalScrubBold: return "\u{fc96}"
        case .windowVerticalScrubLight: return "\u{fc97}"
        case .windowVerticalScrubRegular: return "\u{fc98}"
        case .workflowDeploymentsBold: return "\u{fc99}"
        case .workflowDeploymentsFilled: return "\u{fc9a}"
        case .workflowDeploymentsLight: return "\u{fc9b}"
        case .workflowDeploymentsRegular: return "\u{fc9c}"
        case .workphoneBold: return "\u{fc9d}"
        case .workphoneLight: return "\u{fc9e}"
        case .workphoneRegular: return "\u{fc9f}"
        case .zoomInBold: return "\u{fca0}"
        case .zoomInLight: return "\u{fca1}"
        case .zoomInRegular: return "\u{fca2}"
        case .zoomOutBold: return "\u{fca3}"
        case .zoomOutLight: return "\u{fca4}"
        case .zoomOutRegular: return "\u{fca5}"
