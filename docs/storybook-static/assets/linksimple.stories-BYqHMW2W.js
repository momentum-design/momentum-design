import{L as O,T as _}from"./linksimple.component-Cvp_cRZU.js";import{k as L}from"./iframe-D_OBz_bG.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B1zBGTv3.js";import"./DataAriaLabelMixin-CrMsxxhA.js";import"./DisabledMixin-DDjLwMnk.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
