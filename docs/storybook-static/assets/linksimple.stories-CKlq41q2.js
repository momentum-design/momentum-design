import{L as O,T as _}from"./linksimple.component-B0QjFRyY.js";import{k as L}from"./iframe-DndUgZyo.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DO6MNPEi.js";import"./DataAriaLabelMixin-cYwlSv6Q.js";import"./DisabledMixin-AhNA0Xer.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
