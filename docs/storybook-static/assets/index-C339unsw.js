import{i as b,D as f,k as m}from"./lit-element-D5KKan5q.js";import{n as c,u as v}from"./index-C9z9WAEj.js";import{t as s}from"./if-defined-D5BV9-c0.js";import{a as y,h as k}from"./index-MA1r3zrt.js";import{D as g,F as p}from"./formfieldwrapper.component-DNKMXI01.js";import{D as x}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as A}from"./FormInternalsMixin-CSixOKbK.js";import"./index-BQHpR8ua.js";const _=[y,b`
  :host{
    display: flex;
    flex-direction: row;
    align-items: start;
...
`,...k(!0)];var E=Object.defineProperty,l=(h,e,t,r)=>{for(var o=void 0,i=h.length-1,a;i>=0;i--)(a=h[i])&&(o=a(e,t,o)||o);return o&&E(e,t,o),o};const n=class n extends A(x(p)){constructor(){super(...arguments),this.checked=!1,this.readonly=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?m`<div class="mdc-radio__label-container">
    ...
    `}};n.styles=[...p.styles,..._];let d=n;l([c({type:Boolean,reflect:!0})],d.prototype,"checked");l([c({type:Boolean,reflect:!0})],d.prototype,"readonly");l([c({type:Boolean,reflect:!0})],d.prototype,"autofocus");const $=v.constructTagName("radio");d.register($);export{$ as T};
