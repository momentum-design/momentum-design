import{L as O,T as _}from"./linksimple.component-B4UUYqHL.js";import{k as L}from"./iframe-Jn7RecH3.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DcDceuTE.js";import"./DataAriaLabelMixin-mdjsGCeI.js";import"./DisabledMixin-CGJfw_7W.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
