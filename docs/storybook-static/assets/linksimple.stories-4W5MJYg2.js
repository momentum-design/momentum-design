import{L as O,T as _}from"./linksimple.component-CcBmn7Ty.js";import{k as L}from"./iframe-CkDSCEjt.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-0j_0xcOz.js";import"./DataAriaLabelMixin-CPm-Jsle.js";import"./DisabledMixin-B2HXIz_U.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
