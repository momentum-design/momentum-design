import{L as O,T as _}from"./linksimple.component-NFlV2CU0.js";import{k as L}from"./iframe-KY1Pl7Qi.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-C_zMbcwl.js";import"./DataAriaLabelMixin-DBaEHTgg.js";import"./DisabledMixin-bUQ9ncpk.js";import"./index-C-R_kWER.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
