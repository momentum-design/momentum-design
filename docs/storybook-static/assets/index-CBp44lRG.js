import{i as p,k as i,C as b,n as c}from"./iframe-5RFEiZ85.js";import{t as h}from"./if-defined-C_QIaKNN.js";import{I as y}from"./IconNameMixin-Cyclroqq.js";import{R as v}from"./roles-CJI3JVG-.js";import{T as f,V as I}from"./index-DmZ0oACR.js";import{D as a,I as k,T as t,a as g,b as T}from"./badge.constants-CmUTF5jE.js";import{h as N}from"./index-BldB1hzz.js";import"./index-BAamgs9z.js";const C=[N,p`
    :host {
  ...
  `];var _=Object.defineProperty,n=(m,r,o,A)=>{for(var d=void 0,s=m.length-1,u;s>=0;s--)(u=m[s])&&(d=u(r,o,d)||d);return d&&_(r,o,d),d};const l=class l extends y(b){constructor(){super(...arguments),this.variant=a.VARIANT,this.maxCounter=a.MAX_COUNTER,this.overlay=!1,this.ariaLabel=null}getCounterText(r,o){return o===void 0||typeof o!="number"||r===0?"":o>r?`${r}+`:r>a.MAX_COUNTER_LIMIT||o>a.MAX_COUNTER_LIMIT?`${a.MAX_COUNTER_LIMIT}+`:o.toString()}getBadgeIcon(r){return i`
    ...
    `}setRoleByAriaLabel(){this.ariaLabel?this.role=v.IMG:this.role=null}getBadgeContentBasedOnType(){this.variant&&!Object.values(k).includes(this.variant)&&(this.variant=a.VARIANT);const{iconName:r,type:o}=this;switch(o){case t.ICON:return this.getBadgeIcon(r||"");case t.COUNTER:return this.getBadgeCounterText();case t.SUCCESS:return this.getBadgeIcon(g.SUCCESS_ICON_NAME);case t.WARNING:return this.getBadgeIcon(g.WARNING_ICON_NAME);case t.ERROR:return this.getBadgeIcon(g.ERROR_ICON_NAME);case t.DOT:default:return this.type=t.DOT,this.getBadgeDot()}}update(r){super.update(r),r.has("ariaLabel")&&this.setRoleByAriaLabel()}render(){return this.getBadgeContentBasedOnType()}};l.styles=[...b.styles,...C];let e=l;n([c({type:String,reflect:!0})],e.prototype,"type");n([c({type:String,reflect:!0})],e.prototype,"variant");n([c({type:Number})],e.prototype,"counter");n([c({type:Number,attribute:"max-counter",reflect:!0})],e.prototype,"maxCounter");n([c({type:Boolean})],e.prototype,"overlay");n([c({type:String,attribute:"aria-label"})],e.prototype,"ariaLabel");e.register(T);
