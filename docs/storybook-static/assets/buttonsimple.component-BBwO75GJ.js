import{i as u,k as m}from"./lit-element-CHllvULs.js";import{u as f,C as c,n as r}from"./index-HW6KrQZO.js";import{D as p}from"./DisabledMixin-DBt9didn.js";import{T as v}from"./TabIndexMixin-DUHuRC5Y.js";import{h as g,a as z}from"./index-BGjwsboe.js";const L=f.constructTagName("buttonsimple"),y={20:20,24:24,28:28,32:32,40:40,48:48,52:52,64:64,72:72,88:88,124:124},d={BUTTON:"button",SUBMIT:"submit",RESET:"reset"},n={SIZE:y[32],TYPE:d.BUTTON,ROLE:"button"},E=[g,u`
  :host {
...
`,...z()];var T=Object.defineProperty,h=(l,t,e,x)=>{for(var i=void 0,a=l.length-1,b;a>=0;a--)(b=l[a])&&(i=b(t,e,i)||i);return i&&T(t,e,i),i};const o=class o extends v(p(c)){constructor(){super(),this.active=!1,this.softDisabled=!1,this.size=n.SIZE,this.role=n.ROLE,this.type=n.TYPE,this.prevTabindex=0,this.internals=this.attachInternals(),this.addEventListener("click",this.executeAction.bind(this)),this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.handleKeyUp.bind(this)),this.addEventListener("blur",this.handleBlur.bind(this))}get form(){return this.internals.form}update(t){super.update(t),t.has("disabled")&&this.setDisabled(this,this.disabled),t.has("softDisabled")&&this.setSoftDisabled(this,this.softDisabled),t.has("active")&&this.setActive(this,this.active)}executeAction(){this.type===d.SUBMIT&&this.form&&this.form.requestSubmit(),this.type===d.RESET&&this.form&&this.form.reset()}setActive(t,e){e?t.setAttribute("aria-pressed","true"):t.removeAttribute("aria-pressed")}setSoftDisabled(t,e){e?t.setAttribute("aria-disabled","true"):t.removeAttribute("aria-disabled")}setDisabled(t,e){e?(t.setAttribute("aria-disabled","true"),this.prevTabindex=this.tabIndex,this.tabIndex=-1):(this.tabIndex===-1&&(this.tabIndex=this.prevTabindex),t.removeAttribute("aria-disabled"))}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}handleBlur(){this.classList.contains("pressed")&&this.classList.remove("pressed")}handleKeyDown(t){["Enter"," "].includes(t.key)&&(this.classList.add("pressed"),t.key==="Enter"&&this.triggerClickEvent())}handleKeyUp(t){["Enter"," "].includes(t.key)&&(this.classList.remove("pressed"),t.key===" "&&this.triggerClickEvent())}render(){return m`
      <slot></slot>
    `}};o.formAssociated=!0,o.styles=[...c.styles,...E];let s=o;h([r({type:Boolean,reflect:!0})],s.prototype,"active");h([r({type:Boolean,attribute:"soft-disabled"})],s.prototype,"softDisabled");h([r({type:Number,reflect:!0})],s.prototype,"size");h([r({type:String,reflect:!0})],s.prototype,"role");h([r({reflect:!0})],s.prototype,"type");export{d as B,n as D,L as T,s as a,y as b};
