import"./index-CXdmaaNx.js";import"./index-90xMIgHT.js";import"./index-ClBQZA0c.js";import{T as A,V as $}from"./index-riA1qVWu.js";import"./index-TMctHvbv.js";import{i as I,k as m,D as k}from"./lit-element-D5KKan5q.js";import{u as w,n}from"./provider.component-BaQC7CJH.js";import{r as O}from"./state-C0WmBOuD.js";import{e as E}from"./query-DXShiZ7f.js";import{o as S}from"./query-assigned-elements-uEuc3rg8.js";import{t as c}from"./if-defined-D5BV9-c0.js";import{K as a}from"./keys-hFXe221I.js";import{D}from"./DataAriaLabelMixin-Cpdy3gUS.js";import{F as P}from"./FormInternalsMixin-BIoSiX4k.js";import{R as f}from"./roles-DU0xbrD4.js";import{D as R,V as T,F as v}from"./formfieldwrapper.component-C-SgLT80.js";import{T as p}from"./index-CyYbC-R9.js";import{a as V,D as y}from"./popover.component-BcWkwQje.js";import{a as C}from"./index-B-GnYs90.js";const L=w.constructTagName("select"),g={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},h="select-base-triggerid",x="select-listbox",_=I`
  :host {
...
`,F=[_,...C(!0)];var N=Object.defineProperty,d=(u,e,t,s)=>{for(var i=void 0,r=u.length-1,l;r>=0;r--)(l=u[r])&&(i=l(e,t,i)||i);return i&&N(e,t,i),i};const b=class b extends P(D(v)){constructor(){super(...arguments),this.readonly=!1,this.placement=V.BOTTOM_START,this.boundary=y.BOUNDARY,this.strategy=y.STRATEGY,this.displayPopover=!1,this.initialSelectedOption=null}getAllValidOptions(){var e;return Array.from(((e=this.slottedListboxes[0])==null?void 0:e.querySelectorAll(`${p}:not([disabled])`))||[])}getFirstValidOption(){var e;return(e=this.slottedListboxes[0])==null?void 0:e.querySelector(`${p}:not([disabled])`)}getLastValidOption(){const e=this.getAllValidOptions();return e.length>0?e[e.length-1]:null}getFirstSelectedOption(){var e;return(e=this.slottedListboxes[0])==null?void 0:e.querySelector(`${p}[selected]:not([disabled])`)}async firstUpdated(){await this.updateComplete,this.modifyListBoxWrapper();const e=this.getFirstSelectedOption();if(e)this.initialSelectedOption=e,this.setSelectedOption(e);else if(this.placeholder)this.placeholder&&this.setInputValidity();else{const t=this.getFirstValidOption();this.setSelectedOption(t),this.fireEvents()}}updated(e){super.updated(e),(e.has("disabled")||e.has("softDisabled")||e.has("readonly"))&&(this.disabled||this.softDisabled||this.readonly)&&(this.displayPopover=!1),e.has("dataAriaLabel")&&this.modifyListBoxWrapper()}modifyListBoxWrapper(){const e=this.slottedListboxes[0];e&&(e.setAttribute("id",x),e.setAttribute("aria-label",this.dataAriaLabel||""),e.setAttribute("aria-labelledby",h))}handleOptionsClick(e){const t=e.target;t&&t.tagName===p.toUpperCase()&&!t.hasAttribute("disabled")&&!t.hasAttribute("soft-disabled")&&(this.setSelectedOption(t),this.displayPopover=!1,this.fireEvents())}setSelectedOption(e){var t,s;this.updateSelectedInChildOptions(e),this.updateTabIndexForAllOptions(e),this.selectedOption=e,this.value=((t=this.selectedOption)==null?void 0:t.value)??"",this.internals.setFormValue(this.value),(s=this.inputElement)==null||s.setAttribute("value",this.value),this.setInputValidity()}updateTabIndexForAllOptions(e){const t=this.getAllValidOptions(),s=e||t[0];t.forEach(i=>{i.setAttribute("tabindex",i===s?"0":"-1")})}updateSelectedInChildOptions(e){e==null||e.setAttribute("selected","true"),this.getAllValidOptions().forEach(s=>{s!==e&&s.removeAttribute("selected")})}fireEvents(){this.dispatchInput(this.selectedOption),this.dispatchChange(this.selectedOption)}setInputValidity(){var e,t;!this.selectedOption&&this.required&&this.validationMessage?(e=this.inputElement)==null||e.setCustomValidity(this.validationMessage):(t=this.inputElement)==null||t.setCustomValidity(""),this.setValidity()}formResetCallback(){var t;const e=this.initialSelectedOption||null;((t=this.selectedOption)==null?void 0:t.value)!==(e==null?void 0:e.value)&&(this.setSelectedOption(e),this.fireEvents())}formStateRestoreCallback(e){var s;const t=this.getAllValidOptions().find(i=>i.value===e||i.label===e);((s=this.selectedOption)==null?void 0:s.value)!==(t==null?void 0:t.value)&&(this.setSelectedOption(t||null),this.fireEvents())}dispatchChange(e){this.dispatchEvent(new CustomEvent("change",{detail:{value:e==null?void 0:e.value,label:e==null?void 0:e.label},composed:!0,bubbles:!0}))}dispatchInput(e){this.dispatchEvent(new CustomEvent("input",{detail:{value:e==null?void 0:e.value,label:e==null?void 0:e.label},composed:!0,bubbles:!0}))}handleClickCombobox(e){this.disabled||this.softDisabled||this.readonly||(this.displayPopover=!this.displayPopover,e.stopPropagation())}handleKeydownCombobox(e){if(!(this.disabled||this.softDisabled||this.readonly))switch(e.key){case a.ARROW_DOWN:case a.ARROW_UP:this.displayPopover=!0,e.preventDefault(),e.stopPropagation();break;case a.ENTER:case a.SPACE:this.displayPopover=!0,e.preventDefault(),e.stopPropagation();break;case a.HOME:{this.displayPopover=!0;const t=this.getFirstValidOption();t&&(t==null||t.focus(),this.updateTabIndexForAllOptions(t)),e.preventDefault();break}case a.END:{this.displayPopover=!0;const t=this.getLastValidOption();t&&(t.focus(),this.updateTabIndexForAllOptions(t)),e.preventDefault();break}}}handlePopoverKeydown(e){let t=null;switch(e.key){case a.HOME:{t=this.getFirstValidOption();break}case a.END:{t=this.getLastValidOption();break}case a.ARROW_DOWN:{const s=this.getAllValidOptions(),i=s.findIndex(l=>l===e.target),r=Math.min(i+1,s.length-1);t=s[r];break}case a.ARROW_UP:{const s=this.getAllValidOptions(),i=s.findIndex(l=>l===e.target),r=Math.max(i-1,0);t=s[r];break}case a.PAGE_DOWN:{const s=this.getAllValidOptions(),i=s.findIndex(l=>l===e.target),r=Math.min(i+10,s.length-1);t=s[r];break}case a.PAGE_UP:{const s=this.getAllValidOptions(),i=s.findIndex(l=>l===e.target),r=Math.max(i-10,0);t=s[r];break}}t&&(this.focusAndUpdateTabIndexes(t),e.preventDefault(),e.stopPropagation())}focusAndUpdateTabIndexes(e){e&&(e.focus(),this.updateTabIndexForAllOptions(e))}handleNativeInputFocus(){this.visualCombobox.focus()}updateState(){var t;const e=this.getFirstSelectedOption();this.inputElement&&(e?((t=this.selectedOption)==null?void 0:t.value)!==e.value&&this.setSelectedOption(e):this.setSelectedOption(this.placeholder?null:this.getFirstValidOption()))}render(){var e,t,s,i;return m`
    ...
    `}};b.styles=[...v.styles,...F];let o=b;d([n({type:String})],o.prototype,"placeholder");d([n({type:Boolean})],o.prototype,"readonly");d([n({type:String,reflect:!0})],o.prototype,"placement");d([n({type:Boolean,attribute:"soft-disabled",reflect:!0})],o.prototype,"softDisabled");d([n({type:String,reflect:!0,attribute:"boundary"})],o.prototype,"boundary");d([n({type:String,reflect:!0,attribute:"strategy"})],o.prototype,"strategy");d([S({selector:"mdc-selectlistbox"})],o.prototype,"slottedListboxes");d([E(`[id="${h}"]`)],o.prototype,"visualCombobox");d([O()],o.prototype,"selectedOption");d([O()],o.prototype,"displayPopover");o.register(L);
