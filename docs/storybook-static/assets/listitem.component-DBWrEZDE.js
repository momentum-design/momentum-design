import{u as E,a2 as y,a8 as f,R as x,k as d,V as I,h as L,T as o,C as g,n as s}from"./iframe-CA49vxKm.js";import{o as v}from"./query-assigned-elements-IV_T3768.js";import{D as T}from"./DisabledMixin-B44Roi7E.js";import{K as k,a as C,T as D,A as c}from"./KeyDownHandledMixin-D048pw3a.js";const h={CREATED:"created",FIRST_UPDATE_COMPLETED:"first-update-completed",DESTROYED:"destroyed",MODIFIED:"modified"},N=E.constructTagName("listitem"),S={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},A={VARIANT:S.FULL_WIDTH},_=l=>{class t extends l{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(h.CREATED,{bubbles:!0,composed:!0,detail:{lifecycle:!0}})),this.updateComplete.then(()=>{this.dispatchEvent(new CustomEvent(h.FIRST_UPDATE_COMPLETED,{bubbles:!0,composed:!0,detail:{lifecycle:!0}}))})}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new CustomEvent(h.DESTROYED,{bubbles:!0,composed:!0,detail:{lifecycle:!0}}))}dispatchModifiedEvent(n){this.dispatchEvent(new CustomEvent(h.MODIFIED,{detail:{change:n,lifecycle:!0},bubbles:!0,composed:!0}))}}return t};class u{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const w=y`
  :host {
...
`,R=[w,...f()];var M=Object.defineProperty,a=(l,t,e,n)=>{for(var r=void 0,p=l.length-1,b;p>=0;p--)(b=l[p])&&(r=b(t,e,r)||r);return r&&M(t,e,r),r};const m=class m extends k(C(T(D(_(g))))){constructor(){super(),this.variant=A.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.handleKeyUp.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||x.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){const e=this.getActionForKeyEvent(t);!t.defaultPrevented&&e===c.ENTER&&(this.isEventFromInsideListItem(t)||(this.keyDownEventHandled(),t.preventDefault(),this.triggerClickEvent(t)))}handleKeyUp(t){const e=this.getActionForKeyEvent(t);!t.defaultPrevented&&e===c.SPACE&&(this.isEventFromInsideListItem(t)||(t.preventDefault(),this.triggerClickEvent(t)))}isEventFromInsideListItem(t){const e=t.target;return e!==this&&document.activeElement===e&&this.contains(e)}triggerClickEvent(t){if(this.isEventFromInsideListItem(t))return;const e=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(e)}getText(t,e,n){return d`
      <slot name="${t}">
        ${n?d`<mdc-text part="${t}" type="${e}" tagname="${I.SPAN}">${n}</mdc-text>`:L}
      </slot>
    ...
    ></slot>`}renderLeadingControls(){return d`<slot
      ...
      @keyup=${this.stopEventPropagation}
      @keydown=${this.stopEventPropagation}
    ></slot>`}stopEventPropagation(t){if(t instanceof KeyboardEvent){const e=this.getActionForKeyEvent(t);(e===c.ENTER||e===c.SPACE)&&t.stopPropagation()}else t instanceof MouseEvent&&t.stopPropagation()}click(){this.triggerClickEvent(new Event("click"))}render(){return d`
      <slot name="content">
        <div part="leading">
