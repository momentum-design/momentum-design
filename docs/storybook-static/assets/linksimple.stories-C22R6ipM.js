import{L as O,T as _}from"./linksimple.component-Bw6U7vot.js";import{k as L}from"./iframe-06xQzbmP.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DwgySn5g.js";import"./DataAriaLabelMixin-B8GUNbxU.js";import"./DisabledMixin-DAkplytX.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
