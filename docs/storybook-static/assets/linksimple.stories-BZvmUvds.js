import{L as O,T as _}from"./linksimple.component-2QxbgFJ4.js";import{k as L}from"./iframe-DMYLoWds.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CgKtHWDr.js";import"./DataAriaLabelMixin-zaDfTZvm.js";import"./DisabledMixin-DD63dPWn.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
