import{L as O,T as _}from"./linksimple.component-BO5Z1H0H.js";import{k as L}from"./iframe-CwHTiZJN.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-cR5VEbI-.js";import"./DataAriaLabelMixin-DZkBLSLT.js";import"./DisabledMixin-DQyYsE82.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
