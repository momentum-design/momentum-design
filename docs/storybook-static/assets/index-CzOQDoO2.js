import{i as _,D as p,k as u}from"./lit-element-D5KKan5q.js";import{n,u as v}from"./index-C9z9WAEj.js";import{t as c}from"./if-defined-D5BV9-c0.js";import{h as f,a as y}from"./index-BX3Tn-Br.js";import{D as k,F as b}from"./formfieldwrapper.component-DKn4fQEK.js";import{F as g,D as x}from"./FormInternalsMixin-BezuNa1f.js";const A=[f,_`
  :host{
...
`,...y(!0)];var E=Object.defineProperty,s=(h,o,r,d)=>{for(var e=void 0,i=h.length-1,a;i>=0;i--)(a=h[i])&&(e=a(o,r,e)||e);return e&&E(o,r,e),e};const l=class l extends g(x(b)){constructor(){super(),this.checked=!1,this.readonly=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?u`<div class="mdc-radio__label-container">
    ...
    `}};l.styles=[...b.styles,...A];let t=l;s([n({type:Boolean,reflect:!0})],t.prototype,"checked");s([n({type:Boolean,reflect:!0})],t.prototype,"readonly");s([n({type:Boolean,reflect:!0})],t.prototype,"autofocus");const R=v.constructTagName("radio");t.register(R);export{R as T};
