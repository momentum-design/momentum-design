import{u as q,S as Q,X as J,W as ee,h as x,k as i,n as Z,V as f}from"./iframe-Bmqk5ncS.js";import{D as te}from"./DisabledMixin-CJC0_YR8.js";import{T as ae}from"./TabIndexMixin-CoFbKfFN.js";import{C as y}from"./card.component-Dif9ETfv.js";import{K as N}from"./keys-hFXe221I.js";import"./index-BMN--PIx.js";import"./index-8oex4yMZ.js";import{Q as ie}from"./repeat-DTm_WKnU.js";import{i as o}from"./imageFixtures-CD4avj2q.js";import{c as re,s as oe}from"./commonArgTypes-BluK8w5L.js";import{a as le,t as ce,d as ne}from"./utils-CFOyPOhY.js";import{V as se,O as E,D as t}from"./FooterMixin-8AjGxESk.js";import"./index-BcKFqpcF.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";import"./link.constants-CRDwEYBm.js";import"./index-9jv0kyio.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./button.utils-rNW36Ji7.js";import"./index-BltIwT_C.js";import"./popover.component-CpCRqOFZ.js";import"./if-defined-CEMHl27f.js";import"./BackdropMixin-DDe36BUy.js";import"./index-CvgpI4tf.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./formfieldwrapper.component-DgTSXZHj.js";const de=q.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},T={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},me=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,be=[me,...J()];var ue=Object.defineProperty,W=(e,a,I,he)=>{for(var l=void 0,A=e.length-1,k;A>=0;A--)(k=e[A])&&(l=k(a,I,l)||l);return l&&ue(a,I,l),l};const C=class C extends te(ae(y)){constructor(){super(),this.checked=!1,this.selectionType=T.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}toggleOnEnter(a){a.key===N.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===N.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case r.CHECK:return i`<mdc-icon
    ...
    `}};C.styles=[...y.styles,...be];let s=C;W([Z({type:Boolean,reflect:!0})],s.prototype,"checked");W([Z({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(de);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,pe=e=>i` <mdc-cardcheckbox
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  >`,je={title:"Components/card/cardcheckbox",tags:["autodocs"],component:"mdc-cardcheckbox",render:pe,argTypes:{variant:{control:"select",options:Object.values(se)},orientation:{control:"select",options:Object.values(E)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"selection-type":{control:"select",options:Object.values(r)},"title-tag-name":{control:"select",options:Object.values(f)},"subtitle-tag-name":{control:"select",options:Object.values(f)},...le(["children"]),...ce(["--mdc-card-width"]),...re,...oe}},c=i`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
}`,...(V=(K=p.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var P,w,X;h.parameters={...h.parameters,docs:{...(P=h.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': imageFixtures.card,
