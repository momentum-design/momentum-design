import{i as E,D as T,k as n}from"./lit-element-D5KKan5q.js";import{u as x,C as u,n as o}from"./index-C9z9WAEj.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{D as f}from"./DisabledMixin-BZruwOeC.js";import{T as L}from"./TabIndexMixin-CsrHswKP.js";import{R as A}from"./roles-DMFGbP5t.js";import{V as k,T as s}from"./text.constants-ZF0jM5wn.js";import{a as S}from"./index-B78vnND0.js";import{a as P}from"./popover.component-CLVcAiaC.js";import{a as _}from"./index-CcXofQbA.js";const d={ARROW_DOWN:"ArrowDown",ARROW_LEFT:"ArrowLeft",ARROW_RIGHT:"ArrowRight",ARROW_UP:"ArrowUp",END:"End",ENTER:"Enter",ESCAPE:"Escape",HOME:"Home",PAGE_DOWN:"PageDown",PAGE_UP:"PageUp",SPACE:" "},Y=x.constructTagName("listitem"),p="dynamic-listitem-tooltip-popover",b="dynamic-listitem-tooltip-triggerid",R={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},y={VARIANT:R.FULL_WIDTH,TOOLTIP_PLACEMENT:P.TOP},w=E`
  :host {
...
`,C=[w,..._()];var O=Object.defineProperty,r=(m,t,e,a)=>{for(var l=void 0,c=m.length-1,g;c>=0;c--)(g=m[c])&&(l=g(t,e,l)||l);return l&&O(t,e,l),l};const h=class h extends f(L(u)){constructor(){super(),this.variant=y.VARIANT,this.tooltipPlacement=y.TOOLTIP_PLACEMENT,this.addEventListener("keydown",this.handleKeyDown),this.addEventListener("focusin",this.displayTooltipForLongText),this.addEventListener("mouseover",this.displayTooltipForLongText),this.addEventListener("focusout",this.hideTooltipOnLeave),this.addEventListener("mouseout",this.hideTooltipOnLeave),this.addEventListener("click",this.handleClick)}connectedCallback(){super.connectedCallback(),this.role=this.role||A.LISTITEM}handleKeyDown(t){(t.key===d.ENTER||t.key===d.SPACE)&&(this.triggerClickEvent(),t.preventDefault())}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}handleClick(){this.hideTooltipOnLeave()}displayTooltipForLongText(){var a;if(!this.tooltipText)return;this.id=this.id||b;const t=document.getElementById(p);t&&t.remove();const e=document.createElement(S);e.id=p,e.textContent=this.tooltipText,e.setAttribute("triggerid",this.id),e.setAttribute("placement",this.tooltipPlacement),e.setAttribute("visible",""),e.setAttribute("show-arrow",""),(a=this.parentElement)==null||a.after(e)}hideTooltipOnLeave(){this.id=this.id===b?"":this.id;const t=document.querySelector(`#${p}`);t==null||t.remove()}getText(t,e,a){return a?n`
      <slot name="${t}">
