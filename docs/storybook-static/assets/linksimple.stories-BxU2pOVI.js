import{L as O,T as _}from"./linksimple.component-jLThnE45.js";import{k as L}from"./iframe-DBAXEeb_.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BvKStZe5.js";import"./DataAriaLabelMixin-BeMM70jK.js";import"./DisabledMixin-CJ5fJ_db.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
