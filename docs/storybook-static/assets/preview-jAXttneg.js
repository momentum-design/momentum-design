 ...
 *
 * @tagname mdc-avatar
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Avatar",module:"components/avatar/avatar.component.js"}}]},{kind:"javascript-module",path:"components/badge/badge.component.js",declarations:[{kind:"class",description:`A badge is a small, visually distinct element that provides additional information
...
types, returning the corresponding template result for each type.`}],attributes:[{name:"type",description:"Type of the badge\nCan be `dot` (notification) , `icon` and `counter`\n\nDefault: `dot`",fieldName:"type"},{name:"icon-name",type:{text:"string | undefined"},description:"If `type` is set to `icon`, attribute `iconName` can\nbe used to choose which icon should be shown\n\nIf no `iconName` is provided, no icon will be rendered.",fieldName:"iconName"},{name:"variant",description:"badge variant",fieldName:"variant"},{name:"counter",type:{text:"number | undefined"},fieldName:"counter"},{name:"max-counter",type:{text:"number"},fieldName:"maxCounter"},{name:"overlay",type:{text:"boolean"},default:"false",fieldName:"overlay"},{name:"aria-label",type:{text:"string | null"},default:"null",description:"Aria-label attribute to be set for accessibility",fieldName:"ariaLabel"}],superclass:{name:"Component",module:"/src/models"},tagName:"mdc-badge",jsDoc:`/**
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"ThemeProvider",module:"components/themeprovider/themeprovider.component.js"}}]}],u={schemaVersion:m,readme:c,modules:h},r=[{themeclass:"mds-theme-stable-darkWebex",displayName:"darkWebex",backgroundColor:"#000000",className:"dark"},{themeclass:"mds-theme-stable-lightWebex",displayName:"lightWebex",backgroundColor:"#ffffff",className:"light"}],p=e=>{for(const t of r)e.classList.remove(t.className)},s=(e,t)=>{e.classList.add(t)},f=e=>{const t=document.querySelectorAll("div.docs-story");for(const i of t)i.style.backgroundColor=e},b=(e,t)=>{const i=t.globals.theme,n=r.find(a=>a.displayName===i),o=document.querySelector("body.sb-show-main");return p(o),s(o,n.className),s(o,"mds-typography"),f(n.backgroundColor),d`<mdc-themeprovider
    id="theme-provider"
