import{a as l}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{k as o}from"./lit-element-D5KKan5q.js";import"./index-a8wHKouo.js";import{c as de,s as re}from"./commonArgTypes-BluK8w5L.js";import{a as se,t as me,h as s,d as pe}from"./utils-CFOyPOhY.js";import"./index-BaUwcf4A.js";import{V as k}from"./formfieldwrapper.component-Bh3Mxn5K.js";import"./index-DXxAvG-Y.js";import"./index-Dw48renH.js";import"./index-DQ1Hv4sq.js";import{a as ue}from"./popover.component-CgG8O1N4.js";import"./v4-CQkTLCs1.js";import"./index-Bygo1iDm.js";import"./button.component-D5eG231X.js";import"./provider.component-BaQC7CJH.js";import"./state-C0WmBOuD.js";import"./button.constants-B6suqA4v.js";import"./buttonsimple.constants-An7St6B1.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-CKyEWPbX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./index-CqVtAZCJ.js";import"./button.utils-rNW36Ji7.js";import"./index-DyTlZ_IO.js";import"./iframe-BUpju6j_.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-DWn5NkGG.js";import"./create-context-89xeped_.js";import"./index-DTrDRi1E.js";import"./index-Bdggxyt0.js";import"./index-DHsMOcdX.js";import"./index-Bit_m4dL.js";import"./if-defined-D5BV9-c0.js";import"./index-Dm_kZN_u.js";import"./v4-CmTdKEVZ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./CaptureDestroyEventForChildElement-qq7X9vNO.js";import"./listitem.component-Cy9hWtov.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DataAriaLabelMixin-Cpdy3gUS.js";import"./FormInternalsMixin-CvUI0OX_.js";import"./ListNavigationMixin-DgCStHq0.js";import"./divider.constants-DBMTjDho.js";const L=Object.values(k).filter(e=>e!=="priority"),$=e=>o`
...
`,O=e=>$(o`
  ...
  `),it={title:"Components/select/select",tags:["autodocs"],component:"mdc-select",render:O,parameters:{badges:["stable"]},argTypes:{name:{control:"text"},label:{control:"text"},required:{control:"boolean"},placeholder:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${L.map(e=>`'${e}'`).join(", ")}.`,options:L},"info-icon-aria-label":{control:"text"},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(ue)},"auto-focus-on-mount":{control:"boolean"},placement:{control:"select",options:["bottom-start","top-start"]},"soft-disabled":{control:"boolean"},...se(["id","value","validity","validation-message","willValidate","default","itemsStore"]),...me(["--mdc-select-background-color","--mdc-select-background-color-hover","--mdc-select-background-color-active","--mdc-select-background-color-disabled","--mdc-select-text-color","--mdc-select-text-color-selected","--mdc-select-text-color-disabled","--mdc-select-border-color","--mdc-select-border-color-disabled","--mdc-select-border-color-success","--mdc-select-border-color-warning","--mdc-select-border-color-error","--mdc-select-width","--mdc-select-listbox-height","--mdc-select-listbox-width"]),...de,...re}},p={args:{label:"Headquarters location",required:!0,placeholder:"Select your headquarters location",disabled:!1,readonly:!1,"help-text":"Select Help Text","help-text-type":"","data-aria-label":"Select label",placement:"bottom-start",children:o`<mdc-selectlistbox>
    ...
    </mdc-selectlistbox>`},render:e=>o` <div style="height: 35rem;">${O(e)}</div> `},h={args:{label:"Options with long text",placeholder:"Select one color",children:o`<mdc-selectlistbox>
  ...
  `,...s()},y={render:()=>o`
    ...
    `,...s()},g={render:e=>{const d=(c,n)=>{const a=c.querySelector('mdc-select[name="avengers-name"]'),i=c.querySelector('mdc-select[name="stone-count"]'),m=a.value,q=i.value;let w=!0;return n.required&&(!m||m==="")?(a.setAttribute("help-text","Please select your favorite Avenger"),a.setAttribute("help-text-type","error"),w=!1):(a.setAttribute("help-text","Looks good!"),a.setAttribute("help-text-type","success")),n.required&&(!q||q==="")?(i.setAttribute("help-text","Please select the Infinity Stone count"),i.setAttribute("help-text-type","error"),w=!1):(i.setAttribute("help-text","Looks good!"),i.setAttribute("help-text-type","success")),w};return o`
...
}`,...(F=(D=u.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var V,H,R;b.parameters={...b.parameters,docs:{...(V=b.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(H=b.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};var E,M,N;h.parameters={...h.parameters,docs:{...(E=h.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
  ...
  render: (args: Args) => html\`
    ...
    <mdc-tooltip triggerid="option-1" show-arrow> White and Black are the biggest colors on the spectrum </mdc-tooltip>
  \`
}`,...(N=(M=h.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};var B,z,Y;v.parameters={...v.parameters,docs:{...(B=v.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
...
}`,...(Y=(z=v.parameters)==null?void 0:z.docs)==null?void 0:Y.source}}};var P,G,_;x.parameters={...x.parameters,docs:{...(P=x.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: grid; grid-template-rows: repeat(3, 1fr);  gap: 2rem;">
      <mdc-select
  ...
  \`,
  ...hideAllControls()
}`,...(_=(G=x.parameters)==null?void 0:G.docs)==null?void 0:_.source}}};var j,U,K;y.parameters={...y.parameters,docs:{...(j=y.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(K=(U=y.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var Z,J,Q;g.parameters={...g.parameters,docs:{...(Z=g.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
  ...
  ...hideAllControls()
}`,...(Q=(J=g.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var X,ee,te;S.parameters={...S.parameters,docs:{...(X=S.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(ie=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};const dt=["Example","SelectWithSecondaryLabel","SelectWithGroups","SelectWithLongOptionText","SelectWithIconOptions","SelectWithStates","SelectWithForm","SelectWithFormHelpTextValidation","SelectWithDynamicOptions","SelectWithChangingSelectedOption","SelectWithChangingValueAttribute"];export{p as Example,f as SelectWithChangingSelectedOption,A as SelectWithChangingValueAttribute,S as SelectWithDynamicOptions,y as SelectWithForm,g as SelectWithFormHelpTextValidation,b as SelectWithGroups,v as SelectWithIconOptions,h as SelectWithLongOptionText,u as SelectWithSecondaryLabel,x as SelectWithStates,dt as __namedExportsOrder,it as default};
