 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Link",module:"components/link/link.component.js"}}]},{kind:"javascript-module",path:"components/listitem/listitem.component.js",declarations:[{kind:"class",description:`mdc-listitem component is used to display a label with different types of controls.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"OptGroup",module:"components/optgroup/optgroup.component.js"}}]},{kind:"javascript-module",path:"components/list/list.component.js",declarations:[{kind:"class",description:"mdc-list component is used to display a group of list items. It is used as a container to wrap other list items.",name:"List",slots:[{description:"This is a default/unnamed slot",name:"default"}],members:[{kind:"field",name:"listItems",type:{text:"Array<HTMLElement>"}},{kind:"field",name:"headerText",type:{text:"string | undefined"},description:"The header text of the list.",attribute:"header-text",reflects:!0},{kind:"method",name:"handleKeyDown",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event."}],description:`Handles the keydown event on the list element.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"List",module:"components/list/list.component.js"}}]},{kind:"javascript-module",path:"components/option/option.component.js",declarations:[{kind:"class",description:`option component, which is used as a list item in a select component.<br/>
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Text",module:"components/text/text.component.js"}}]},{kind:"javascript-module",path:"components/spinner/spinner.component.js",declarations:[{kind:"class",description:`\`mdc-spinner\` is loading spinner which is an indeterminate progress indicator, meaning
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Spinner",module:"components/spinner/spinner.component.js"}}]},{kind:"javascript-module",path:"components/textarea/textarea.component.js",declarations:[{kind:"class",description:`mdc-textarea component, which is used to get the multi-line text input from the user.
It contains:
