import{L as O,T as _}from"./linksimple.component-DRoiFApw.js";import{k as L}from"./iframe-DVF1nujO.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BUEc_hfM.js";import"./DataAriaLabelMixin-C2ztD2tM.js";import"./DisabledMixin-DkCdV4MU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
