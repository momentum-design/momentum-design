import{L as O,T as _}from"./linksimple.component-CrXsJepB.js";import{k as L}from"./iframe-BStS_Y8s.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-D6-9s3Xi.js";import"./DataAriaLabelMixin-D7VBosaA.js";import"./DisabledMixin-CvGoz2-R.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
