import{n as r,a6 as p,S as m,U as y,D as c,d as b,k as v,C as f}from"./iframe-vPjlp732.js";import{D as g}from"./DisabledMixin-1gpg0PKK.js";import{K as E,a as A,T as S,A as h}from"./KeyDownHandledMixin-Cmshr58x.js";var x=Object.defineProperty,T=(a,t,e,d)=>{for(var s=void 0,n=a.length-1,u;n>=0;n--)(u=a[n])&&(s=u(t,e,s)||s);return s&&x(t,e,s),s};const z=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(d){super.firstUpdated(d),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return T([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},K=[p,m`
    :host {
