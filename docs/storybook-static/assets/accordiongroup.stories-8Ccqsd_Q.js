import{S as Y,X as H,G as I,k as A,n as f}from"./iframe-Bmqk5ncS.js";import{t as L}from"./if-defined-CEMHl27f.js";import{o as U}from"./query-assigned-elements-uEuc3rg8.js";import{T as K}from"./index-DX__dYAQ.js";import{D as d,T as X,a as J,S as i,b as n}from"./accordionbutton.component-CxVgA6eY.js";import"./index-C-yNZzP9.js";import"./index-CBBmg3BG.js";import"./index-DvJEFrSG.js";import{c as P,s as Q}from"./commonArgTypes-BluK8w5L.js";import{t as tt}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./index-9jv0kyio.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./button.utils-rNW36Ji7.js";import"./index-BMN--PIx.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./v4-CmTdKEVZ.js";import"./index-Dlc1GpMM.js";import"./IconNameMixin-BxH3CgDw.js";import"./index-Buxhf2Fz.js";import"./chip.component-CyBpZhTU.js";import"./staticchip.component-CbjF9bAm.js";const ot=Y`
  :host {
...
`,at=[ot,...H()];var rt=Object.defineProperty,s=(o,t,a,l)=>{for(var c=void 0,S=o.length-1,E;S>=0;S--)(E=o[S])&&(c=E(t,a,c)||c);return c&&rt(t,a,c),c};const x=class x extends I{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(l=>{l.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(l=>{l.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return A` <slot></slot> `}};x.styles=[...I.styles,...at];let e=x;s([f({type:String,reflect:!0})],e.prototype,"size");s([f({type:String,reflect:!0})],e.prototype,"variant");s([f({type:Boolean,reflect:!0,attribute:"allow-multiple"})],e.prototype,"allowMultiple");s([U({selector:K})],e.prototype,"accordionItems");s([U({selector:X})],e.prototype,"accordionButtonItems");e.register(J);const r=A`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
...
}`,...(j=(_=v.parameters)==null?void 0:_.docs)==null?void 0:j.source}}};var q,W,F;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    size: SIZE.SMALL,
    variant: VARIANT.CONTAINED,
    'allow-multiple': false
  ...
  \`
}`,...(F=(W=g.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};const Dt=["Example","StackedVariant","ContainedVariant","BorderlessVariant","SmallSize","LargeSize","MultiInteractiveAccordion"];export{h as BorderlessVariant,u as ContainedVariant,m as Example,v as LargeSize,g as MultiInteractiveAccordion,b as SmallSize,p as StackedVariant,Dt as __namedExportsOrder,Rt as default};
