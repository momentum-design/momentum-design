import{k as l}from"./lit-element-D5KKan5q.js";import{R as r}from"./class-map-BcCVsMyu.js";import{T as d}from"./index-Bd51EExS.js";import{C as n}from"./provider.component-DrWB4byV.js";import{p as i}from"./index-CwZu4Wnd.js";import{c as v,s as p}from"./commonArgTypes-BluK8w5L.js";import{d as x,t as h}from"./utils-CFOyPOhY.js";import"./directive-Ctav8iJK.js";import"./property-Bj3TGwkg.js";import"./state-CmYk530Z.js";import"./create-context-89xeped_.js";class u extends n{constructor(){super(...arguments),this.themeProviderContext=i.consume({host:this,context:d.Context})}render(){var t;return l`
...
`,w={title:"Components/themeprovider",tags:["autodocs"],component:"mdc-themeprovider",render:g,parameters:{badges:["stable"]},argTypes:{themeclass:{options:c,control:{type:"radio"}},...x(["Context"]),...h(["--mdc-themeprovider-color-default","--mdc-themeprovider-font-family","--mdc-themeprovider-font-weight","--mdc-themeprovider-letter-spacing-adjustment"]),...v,...p}},o={args:{themeclass:c[0],class:"custom-classname",style:"margin-top: 20px;"}};var s,a,m;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    themeclass: THEMES[0],
    class: 'custom-classname',
    style: 'margin-top: 20px;'
  }
}`,...(m=(a=o.parameters)==null?void 0:a.docs)==null?void 0:m.source}}};const W=["Example"];export{o as Example,W as __namedExportsOrder,w as default};
