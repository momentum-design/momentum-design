import{L as O,T as _}from"./linksimple.component-BkRAQs6U.js";import{k as L}from"./iframe-BBVjHSmF.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-DKvggsc9.js";import"./DataAriaLabelMixin-DTlukThN.js";import"./DisabledMixin-gXp6PtL6.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
