import{L as O,T as _}from"./linksimple.component-B7xQUjOV.js";import{k as L}from"./iframe-D6Vt3Vpp.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-BKzwc_Ub.js";import"./DisabledMixin-BJe3KyEd.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
