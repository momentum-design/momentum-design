import{L as O,T as _}from"./linksimple.component-C2eK6vjA.js";import{k as L}from"./iframe-C252fD8g.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-JuF83bhN.js";import"./DataAriaLabelMixin-qqDg6DtS.js";import"./DisabledMixin-DVtDJQvO.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
