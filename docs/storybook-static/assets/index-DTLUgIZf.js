import{i as k,D as m,k as i}from"./lit-element-D5KKan5q.js";import{u as v,n as a}from"./index-C9z9WAEj.js";import{t as n}from"./if-defined-D5BV9-c0.js";import{F as p,D as x}from"./FormInternalsMixin-BezuNa1f.js";import{D as f,F as b}from"./formfieldwrapper.component-DKn4fQEK.js";import{a as g}from"./index-BX3Tn-Br.js";import"./index-BJ0JAAj5.js";const y=v.constructTagName("checkbox"),u={CHECKED:"check-bold",INDETERMINATE:"minus-bold"},E=[k`
  :host {
...
`,...g(!0)];var $=Object.defineProperty,d=(l,e,o,C)=>{for(var c=void 0,r=l.length-1,h;r>=0;r--)(h=l[r])&&(c=h(e,o,c)||c);return c&&$(e,o,c),c};const s=class s extends p(x(b)){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?i`<div class="text-container">
      ${this.renderLabel()}
    ...
    `:m;return i`
      <div class="container mdc-focus-ring">
        <input
          ...
          aria-describedby="${n(this.helpText?f.HELPER_TEXT_ID:"")}"
    ...
    `}};s.styles=[...b.styles,...E];let t=s;d([a({type:Boolean,reflect:!0})],t.prototype,"checked");d([a({type:Boolean,reflect:!0})],t.prototype,"indeterminate");d([a({type:Boolean,reflect:!0})],t.prototype,"autofocus");t.register(y);
