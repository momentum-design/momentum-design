import{L as O,T as _}from"./linksimple.component-C4R3HXYX.js";import{k as L}from"./iframe-BtkPwD7j.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CRPsi96p.js";import"./DataAriaLabelMixin-vKL0c_au.js";import"./DisabledMixin-Dt4Z3yf0.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
