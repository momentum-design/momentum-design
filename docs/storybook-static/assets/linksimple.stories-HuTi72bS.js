import{L as O,T as _}from"./linksimple.component-KIqZb4Bw.js";import{k as L}from"./iframe-Cdt4WgmD.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CTZ3E5Y4.js";import"./DataAriaLabelMixin-TulQhzNo.js";import"./DisabledMixin-CXbaHIym.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
