import{L as O,T as _}from"./linksimple.component-BwFc8Z2S.js";import{k as L}from"./iframe-DyOAHjNf.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BEvGEaEj.js";import"./DataAriaLabelMixin-6CnB7Dxp.js";import"./DisabledMixin-Dqod2-IJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
