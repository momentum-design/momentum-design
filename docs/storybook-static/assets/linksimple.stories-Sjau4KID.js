import{L as O,T as _}from"./linksimple.component-CSow8CRb.js";import{k as L}from"./iframe-J50dDciQ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CcIPL9Pv.js";import"./DataAriaLabelMixin-B-N___Lt.js";import"./DisabledMixin-H98zMGT5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
