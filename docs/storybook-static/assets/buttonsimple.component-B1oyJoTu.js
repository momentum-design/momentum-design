import{n as r,$ as p,X as m,a0 as v,D as c,c as b,k as y,H as f}from"./iframe-CkDSCEjt.js";import{D as E}from"./DisabledMixin-B2HXIz_U.js";import{K as g,T as A,A as h}from"./KeyToActionMixin-D50HlRl3.js";var S=Object.defineProperty,x=(a,t,e,u)=>{for(var s=void 0,n=a.length-1,d;n>=0;n--)(d=a[n])&&(s=d(t,e,s)||s);return s&&S(t,e,s),s};const T=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return x([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},z=[p,m`
    :host {
