import{L as O,T as _}from"./linksimple.component-J2h2vtUD.js";import{k as L}from"./iframe-DD1qd397.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Db4PuEEJ.js";import"./DataAriaLabelMixin-JduQn-GI.js";import"./DisabledMixin-CYN0V68G.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
