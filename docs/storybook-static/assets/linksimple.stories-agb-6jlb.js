import{L as O,T as _}from"./linksimple.component-D6aTxlKT.js";import{k as L}from"./iframe-CwzjigLR.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DG6qR9lA.js";import"./DataAriaLabelMixin-C0KmAD55.js";import"./DisabledMixin-CyJRAUwj.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
