import{L as O,T as _}from"./linksimple.component-4UWR2aa-.js";import{k as L}from"./iframe-D-08lnMy.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DcyjgjZk.js";import"./DataAriaLabelMixin-pmRAtT1w.js";import"./DisabledMixin-DXbj9uc5.js";import"./index-DLkDgkt0.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
