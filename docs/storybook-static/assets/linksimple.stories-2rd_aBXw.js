import{L as O,T as _}from"./linksimple.component-8nK464vI.js";import{k as L}from"./iframe-D0ScXF76.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DrTNBfmd.js";import"./DataAriaLabelMixin-BaksZzLl.js";import"./DisabledMixin-BVGI1sj0.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
