import{L as O,T as _}from"./linksimple.component-B2Sq36jz.js";import{k as L}from"./iframe-C93ychXb.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-CnyXlyTe.js";import"./DataAriaLabelMixin-rJTBAIkI.js";import"./DisabledMixin-BVCCD_zI.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
