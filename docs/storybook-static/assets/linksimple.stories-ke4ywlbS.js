import{L as O,T as _}from"./linksimple.component-Dh9FHOg-.js";import{k as L}from"./iframe-Dy-DGTYu.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DQi-bxBl.js";import"./DataAriaLabelMixin-DYT4CIRM.js";import"./DisabledMixin-BSyc0IfY.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
