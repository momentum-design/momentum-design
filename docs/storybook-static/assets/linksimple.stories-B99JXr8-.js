import{L as O,T as _}from"./linksimple.component-BA4zd2Jo.js";import{k as L}from"./iframe-DJQ9QsE0.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-t5lRFX_k.js";import"./DataAriaLabelMixin-QJ9AxXXt.js";import"./DisabledMixin-BXYpOCIo.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
