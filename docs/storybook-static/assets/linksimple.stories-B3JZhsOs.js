import{L as O,T as _}from"./linksimple.component-CzdOq4OV.js";import{k as L}from"./iframe-B0XJYlue.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CgS7PUg_.js";import"./DataAriaLabelMixin-q8-JYHmv.js";import"./DisabledMixin-CGwTkMmF.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
