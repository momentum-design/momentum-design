import{i as I,D as i,k as d}from"./lit-element-CHllvULs.js";import{u as E,C as T,n as a}from"./index-HW6KrQZO.js";import{D as A}from"./DisabledMixin-DBt9didn.js";import{V as D,T as L}from"./text.constants-DJu2q-6E.js";import{a as f}from"./index-CEbgplXA.js";const r=[];for(let e=0;e<256;++e)r.push((e+256).toString(16).slice(1));function v(e,t=0){return(r[e[t+0]]+r[e[t+1]]+r[e[t+2]]+r[e[t+3]]+"-"+r[e[t+4]]+r[e[t+5]]+"-"+r[e[t+6]]+r[e[t+7]]+"-"+r[e[t+8]]+r[e[t+9]]+"-"+r[e[t+10]]+r[e[t+11]]+r[e[t+12]]+r[e[t+13]]+r[e[t+14]]+r[e[t+15]]).toLowerCase()}let x;const R=new Uint8Array(16);function S(){if(!x){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");x=crypto.getRandomValues.bind(crypto)}return x(R)}const U=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),g={randomUUID:U};function w(e,t,m){var l;if(g.randomUUID&&!t&&!e)return g.randomUUID();e=e||{};const n=e.random??((l=e.rng)==null?void 0:l.call(e))??S();if(n.length<16)throw new Error("Random bytes length must be >= 16");return n[6]=n[6]&15|64,n[8]=n[8]&63|128,v(n)}const M=E.constructTagName("formfieldwrapper"),s={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},c={VALIDATION:s.DEFAULT,HELPER_TEXT_ID:"helper-text-id",LABEL_ID:"label-id"},h={TAGNAME:D.SPAN,TYPE:L.BODY_MIDSIZE_REGULAR},_=[f,I`
    :host {
