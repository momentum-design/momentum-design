import{i as I,k as p}from"./lit-element-CPYlYYac.js";import{u as S,C as y,n as h}from"./index-BLShQaRP.js";import{r as d}from"./state-I_twzcUk.js";import{h as A}from"./index-LGKd4lo9.js";import{p as $,d as U}from"./utils-CNzqJMO0.js";import{I as D}from"./iconprovider.component-DlI5gUhJ.js";import{c as F,s as O}from"./commonArgTypes-BluK8w5L.js";import"./create-context-89xeped_.js";const w=[A,I`
    :host {
  ...
  <mdc-icon
    ...
    size="${e.size}"
  ></mdc-icon>
`,V={title:"Components/icon",tags:["autodocs"],component:"mdc-icon",render:P,parameters:{badges:["stable"]},argTypes:{...U(["--mdc-icon-fill-color"]),...F,...O}},l={args:{name:"accessibility-regular",size:2,class:"custom-classname",style:"margin: 0px;"}},m={render:_,args:{"aria-label":"This is the accessibility icon",name:"accessibility-regular",size:2,class:"custom-classname",style:"margin: 0px;"}};var g,f,v;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
...
}`,...(C=(z=m.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};const q=["Decorative","Informative"];export{l as Decorative,m as Informative,q as __namedExportsOrder,V as default};
