import"./index-K4WMwRF4.js";import"./index-C7H1niR0.js";import"./index-CkpDgFEX.js";import"./index-B37Z1pou.js";import{u as M,D as U,k as w,n as C,z as Y}from"./iframe-Dv4CZTGV.js";import{I as x}from"./input.component-p0hcR-2T.js";import{I as y}from"./input.constants-B6S0os--.js";import{B as j}from"./button.constants-BN8GH3PF.js";import{D as v,V as G}from"./formfieldwrapper.component-BFLWpJbC.js";import{t as s}from"./if-defined-DkpisCg5.js";import{c as K,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as Z,a as J}from"./utils-CFOyPOhY.js";import{P as Q}from"./popover.component-jiBvvB-H.js";import"./button.component-CbJN6n_2.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-ChqJ9fk5.js";import"./keys-hFXe221I.js";import"./DisabledMixin-HUACZ3-D.js";import"./TabIndexMixin-BhCrCd_K.js";import"./buttonsimple.constants-8cRaCd2R.js";import"./index-BATfJeu3.js";import"./button.utils-rNW36Ji7.js";import"./preload-helper-C1FmrZbK.js";import"./index-tqQu3Fsv.js";import"./index-DTrDRi1E.js";import"./index-CWThIL_m.js";import"./v4-CmTdKEVZ.js";import"./directive-Ctav8iJK.js";import"./index-CUZLDRA5.js";import"./DataAriaLabelMixin-B0ZiAR4t.js";import"./FormInternalsMixin-DKPdlmHA.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";const $={HIDE_BOLD:"hide-bold",SHOW_BOLD:"show-bold"},ee=M.constructTagName("password");var te=Object.defineProperty,f=(e,o,a,d)=>{for(var t=void 0,r=e.length-1,l;r>=0;r--)(l=e[r])&&(t=l(o,a,t)||t);return t&&te(o,a,t),t};const g=class g extends x{constructor(){super(...arguments),this.showHideButtonAriaLabel="",this.helpTextType=v.VALIDATION,this.showPassword=!1}connectedCallback(){super.connectedCallback(),this.trailingButton=!0}toggleShowPassword(){this.showPassword=!this.showPassword}renderTrailingButton(o=!1){const a=o||this.value;return a?w`
      <mdc-button
      ...
      ></mdc-button>
    `:U}renderInputElement(o,a){const d=this.showPassword?y.TEXT:y.PASSWORD;return super.renderInputElement(d,a)}};g.styles=[...x.styles];let i=g;f([C({type:String,attribute:"show-hide-button-aria-label"})],i.prototype,"showHideButtonAriaLabel");f([C({type:String,attribute:"help-text-type"})],i.prototype,"helpTextType");f([Y()],i.prototype,"showPassword");i.register(ee);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,N=e=>{const o=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return w` <mdc-password
    @input="${n("oninput")}"
    @change="${n("onchange")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
...
}`,...(V=(F=u.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var L,k,z;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    label: 'Password',
...
}`,...(z=(k=h.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};var R,B,H;b.parameters={...b.parameters,docs:{...(R=b.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    label: 'Password',
