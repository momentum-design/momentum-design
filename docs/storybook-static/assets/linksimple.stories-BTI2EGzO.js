import{L as O,T as _}from"./linksimple.component-BvrNdafU.js";import{k as L}from"./iframe-D_NoT5mJ.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-pLsN-fsc.js";import"./DataAriaLabelMixin-Dh7FS1UQ.js";import"./DisabledMixin-Up-KMQVV.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
