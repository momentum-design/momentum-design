import{u as b,T as v,V as u,a as g,R as p,X as k,$ as T,a0 as E,h,k as a,n as m}from"./iframe-DPiEtQC6.js";import{I as f}from"./IconNameMixin-CToWFxos.js";import{B as y}from"./buttonsimple.component-DsF8ypJf.js";import{C as S,S as O}from"./staticchip.component-C3sLf8dR.js";const D=b.constructTagName("chip"),r={COLOR:S.DEFAULT,TEXT_TYPE:v.BODY_MIDSIZE_REGULAR,TAG_NAME:u.SPAN,SIZE:g[24],ROLE:p.BUTTON},_=k`
  :host {
    cursor: pointer;
    height: 1.5rem;
  }
...
`,A=[T,_,...E()];var I=Object.defineProperty,n=(t,d,s,L)=>{for(var o=void 0,e=t.length-1,i;e>=0;e--)(i=t[e])&&(o=i(d,s,o)||o);return o&&I(d,s,o),o};const l=class l extends f(y){constructor(){super(...arguments),this.color=r.COLOR}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?a` <mdc-icon part="icon" name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:h}render(){return a`
      ...
      ${this.label?a`<mdc-text part="label" type="${r.TEXT_TYPE}" tagname="${r.TAG_NAME}"
            >${this.label}</mdc-text
          >`:h}
    `}};l.styles=[...O.styles,...A];let c=l;n([m({type:String,reflect:!0})],c.prototype,"color");n([m({type:String})],c.prototype,"label");export{c as C,D as T};
