import{L as O,T as _}from"./linksimple.component-C2tmAfin.js";import{k as L}from"./iframe-CEKo-JXY.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-D_LYpS0s.js";import"./DataAriaLabelMixin-BrraWAhi.js";import"./DisabledMixin-BaIDnvgN.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
