import{L as O,T as _}from"./linksimple.component-BCGh9lGQ.js";import{k as L}from"./iframe-DCndRm4c.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-C7LBiDOf.js";import"./DataAriaLabelMixin-BEz8zMjn.js";import"./DisabledMixin-DGZKeuiK.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
