import{S as K,X as P,W as Q,h as X,k as l,n as q,V as E}from"./iframe-Bmqk5ncS.js";import{D as Y}from"./DisabledMixin-CJC0_YR8.js";import{T as J}from"./TabIndexMixin-CoFbKfFN.js";import{C as x}from"./card.component-Dif9ETfv.js";import{K as y}from"./keys-hFXe221I.js";import{T as ee}from"./index-UsF_9idN.js";import"./index-BMN--PIx.js";import"./index-CRnfDU32.js";import{Q as te}from"./repeat-DTm_WKnU.js";import{i as d}from"./imageFixtures-CD4avj2q.js";import{c as ae,s as re}from"./commonArgTypes-BluK8w5L.js";import{a as ie,t as oe,d as le}from"./utils-CFOyPOhY.js";import{V as de,O as f,D as t}from"./FooterMixin-8AjGxESk.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./index-BcKFqpcF.js";import"./index-9jv0kyio.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./button.utils-rNW36Ji7.js";import"./index-BltIwT_C.js";import"./popover.component-CpCRqOFZ.js";import"./if-defined-CEMHl27f.js";import"./BackdropMixin-DDe36BUy.js";import"./index-CvgpI4tf.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./formfieldwrapper.component-DgTSXZHj.js";import"./radio.constants-BafNvAFI.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";import"./link.constants-CRDwEYBm.js";const ne=K`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,se=[ne,...P()];var ce=Object.defineProperty,Z=(e,a,o,n)=>{for(var r=void 0,i=e.length-1,v;i>=0;i--)(v=e[i])&&(r=v(a,o,r)||r);return r&&ce(a,o,r),r};const I=class I extends Y(J(x)){constructor(){super(),this.checked=!1,this.name="",this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=Q.RADIO}getAllCardsWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-cardradio[name="${this.name}"]`))}toggleChecked(){if(this.disabled||this.checked)return;this.getAllCardsWithinSameGroup().forEach(o=>{o.checked=!1}),this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}setDisabled(a){this.setAttribute("aria-disabled",`${a}`),this.tabIndex=a?-1:0}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&this.setDisabled(this.disabled)}updateCardRadio(a,o){a[o].focus(),a[o].toggleChecked()}toggleOnEnter(a){if(this.disabled)return;const n=this.getAllCardsWithinSameGroup().filter(i=>!i.disabled),r=n.indexOf(this);if(["ArrowDown","ArrowRight"].includes(a.key)){const i=(r+1)%n.length;this.updateCardRadio(n,i)}else if(["ArrowUp","ArrowLeft"].includes(a.key)){const i=(r-1+n.length)%n.length;this.updateCardRadio(n,i)}a.key===y.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===y.SPACE&&this.toggleChecked()}renderHeader(){return this.cardTitle?l`<div part="header">
    ...
    `}};I.styles=[...x.styles,...se];let m=I;Z([q({type:Boolean,reflect:!0})],m.prototype,"checked");Z([q({type:String})],m.prototype,"name");m.register(ee);const{action:c}=__STORYBOOK_MODULE_ACTIONS__,me=e=>l` <mdc-cardradio
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
  ...
  >`,qe={title:"Components/card/cardradio",tags:["autodocs"],component:"mdc-cardradio",render:me,argTypes:{variant:{control:"select",options:Object.values(de)},orientation:{control:"select",options:Object.values(f)},name:{control:"text"},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"title-tag-name":{control:"select",options:Object.values(E)},"subtitle-tag-name":{control:"select",options:Object.values(E)},...ie(["children"]),...oe(["--mdc-card-width"]),...ae,...re}},s=l`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
