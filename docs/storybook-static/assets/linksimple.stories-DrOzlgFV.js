import{L as O,T as _}from"./linksimple.component-DqW2ExP4.js";import{k as L}from"./iframe-C8xpa8IM.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BMORz9nb.js";import"./DataAriaLabelMixin-DBhZ5xrG.js";import"./DisabledMixin-D1XMYTMj.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
