import{L as O,T as _}from"./linksimple.component-DbqW1nSL.js";import{k as L}from"./iframe-DfARtXqP.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-B3MOebGJ.js";import"./DataAriaLabelMixin-Cdc12wDK.js";import"./DisabledMixin-LBG16ZV1.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
