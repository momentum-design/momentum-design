import{L as O,T as _}from"./linksimple.component-D5dSz51_.js";import{k as L}from"./iframe-CXCCK7zk.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BuZDkRkv.js";import"./DataAriaLabelMixin-CygDLXN_.js";import"./DisabledMixin-BsjtdTnc.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
