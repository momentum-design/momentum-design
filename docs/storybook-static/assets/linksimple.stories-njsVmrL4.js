import{L as O,T as _}from"./linksimple.component-DCh__OTl.js";import{k as L}from"./iframe-D1ZM_2ni.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-RtC1QEw6.js";import"./DataAriaLabelMixin-DEEzL0NK.js";import"./DisabledMixin-B0ewxrZ6.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
