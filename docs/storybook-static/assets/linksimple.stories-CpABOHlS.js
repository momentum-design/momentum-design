import{L as O,T as _}from"./linksimple.component-D4H-2Iwz.js";import{k as L}from"./iframe-VWNazD7V.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CrJY9-Ak.js";import"./DataAriaLabelMixin-6cL_Ks7Z.js";import"./DisabledMixin-C7fQxQrJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
