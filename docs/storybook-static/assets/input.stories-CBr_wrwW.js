import{i as q,D as h,k as n}from"./lit-element-CHllvULs.js";import{u as D,n as i}from"./index-HW6KrQZO.js";import{t as a}from"./if-defined-C4tJgJ33.js";import{a as H}from"./index-MYSkQ1zX.js";import"./index-DW7_XIyx.js";import{D as w,V as z,N as B}from"./ValueMixin-DFWGhyGn.js";import{B as U,I as X}from"./button.constants-CjxsrM-Y.js";import{V as v,D as M,F as $}from"./formfieldwrapper.component-BUtu4LPi.js";import{T as Z,V as j}from"./text.constants-DJu2q-6E.js";import"./index-CEJJ7ODp.js";import"./index-BnIP7Wfy.js";import"./index-BGkqZMsC.js";import{a as u}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as G,s as Y}from"./commonArgTypes-BluK8w5L.js";import{d as R}from"./utils-D1SE5bce.js";import"./buttonsimple.constants-Biy6Bznc.js";import"./DisabledMixin-DBt9didn.js";import"./state-CWckTc1X.js";import"./buttonsimple.component-DVyOksUm.js";import"./button.utils-DSouLKFM.js";import"./index-BYMLCX4c.js";import"./iconprovider.component-BFc9mT2k.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const K=(e,t,l)=>(l.configurable=!0,l.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,l),l);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function W(e,t){return(l,s,d)=>{const c=m=>{var T;return((T=m.renderRoot)==null?void 0:T.querySelector(e))??null};return K(l,s,{get(){return c(this)}})}}const J=[q`
  :host{
  ...
  `,...H(!0)],Q=D.constructTagName("input"),P={OFF:"off",NONE:"none",ON:"on",SENTENCES:"sentences",WORDS:"words",CHARACTERS:"characters"},ee={MAX_LENGTH:10,HELPERTEXT:"Prefix text should not exceed 10 characters",VALIDATION:v.ERROR},p={VALIDATION:v.DEFAULT,ICON_SIZE_VALUE:1,ICON_SIZE_UNIT:"rem",CLEAR_BUTTON_ICON:"cancel-bold",CLEAR_BUTTON_VARIANT:U.TERTIARY,CLEAR_BUTTON_SIZE:X[20],PREFIX_TEXT_TYPE:Z.BODY_MIDSIZE_REGULAR,PREFIX_TEXT_TAG:j.SPAN};var te=Object.defineProperty,o=(e,t,l,s)=>{for(var d=void 0,c=e.length-1,m;c>=0;c--)(m=e[c])&&(d=m(t,l,d)||d);return d&&te(t,l,d),d};const g=class g extends w(z(B($))){constructor(){super(),this.placeholder="",this.readonly=!1,this.trailingButton=!1,this.autocapitalize=P.OFF,this.autocomplete="off",this.autofocus=!1,this.clearAriaLabel="",this.internals=this.attachInternals()}checkValidity(){return this.setValidityFromInput(),this.internals.checkValidity()}reportValidity(){return this.setValidityFromInput(),this.internals.reportValidity()}get form(){return this.internals.form}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.inputElement.checkValidity(),this.setValidityFromInput(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&this.handleValueChange()}handleValueChange(){this.internals.setFormValue(this.value),this.updateComplete.then(()=>{this.setValidityFromInput()}).catch(t=>{this.onerror&&this.onerror(t)})}attributeChangedCallback(t,l,s){super.attributeChangedCallback(t,l,s),["maxlength","minlength","pattern","required"].includes(t)&&this.updateComplete.then(()=>{this.setValidityFromInput()}).catch(c=>{this.onerror&&this.onerror(c)})}setValidityFromInput(){this.inputElement&&this.internals.setValidity(this.inputElement.validity,this.inputElement.validationMessage,this.inputElement)}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setValidityFromInput()}onChange(t){this.updateValue(),this.setValidityFromInput();const l=t.constructor;this.dispatchEvent(new l(t.type,t))}handleKeyDown(t){var l;t.key==="Enter"&&((l=this.internals.form)==null||l.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?n`
    ...
    `}};g.formAssociated=!0,g.styles=[...$.styles,...J];let r=g;o([i({type:String})],r.prototype,"placeholder");o([i({type:Boolean})],r.prototype,"readonly");o([i({type:String,attribute:"prefix-text"})],r.prototype,"prefixText");o([i({type:String,attribute:"leading-icon"})],r.prototype,"leadingIcon");o([i({type:Boolean,attribute:"trailing-button"})],r.prototype,"trailingButton");o([i({type:Number})],r.prototype,"maxlength");o([i({type:Number})],r.prototype,"minlength");o([i({type:String})],r.prototype,"autocapitalize");o([i({type:String})],r.prototype,"autocomplete");o([i({type:Boolean})],r.prototype,"autofocus");o([i({type:String})],r.prototype,"dirname");o([i({type:String})],r.prototype,"pattern");o([i({type:String})],r.prototype,"list");o([i({type:Number})],r.prototype,"size");o([i({type:String,attribute:"clear-aria-label"})],r.prototype,"clearAriaLabel");o([W("input")],r.prototype,"inputElement");r.register(Q);const re=e=>{const t=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return n` <mdc-input
    @input="${u("oninput")}"
    @change="${u("onchange")}"
    @focus="${u("onfocus")}"
    @blur="${u("onblur")}"
...
}`,...(O=(F=f.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};const Se=["Example","InputInSmallContainer","AllVariants","FormFieldInput"];export{y as AllVariants,b as Example,f as FormFieldInput,x as InputInSmallContainer,Se as __namedExportsOrder,Le as default};
