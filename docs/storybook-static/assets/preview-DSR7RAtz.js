 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"ThemeProvider",module:"components/themeprovider/themeprovider.component.js"}}]}],p={schemaVersion:c,readme:m,modules:u},r=[{themeclass:"mds-theme-stable-darkWebex",displayName:"darkWebex",backgroundColor:"#000000",className:"dark"},{themeclass:"mds-theme-stable-lightWebex",displayName:"lightWebex",backgroundColor:"#ffffff",className:"light"}],h=e=>{for(const t of r)e.classList.remove(t.className)},s=(e,t)=>{e.classList.add(t)},f=e=>{const t=document.querySelectorAll("div.docs-story");for(const i of t)i.style.backgroundColor=e},b=(e,t)=>{const i=t.globals.theme,n=r.find(o=>o.displayName===i),a=document.querySelector("body.sb-show-main");return h(a),s(a,n.className),s(a,"mds-typography"),f(n.backgroundColor),d` <mdc-themeprovider id="theme-provider" themeclass="${n.themeclass}">
    ${e()}
  </mdc-themeprovider>`},g=e=>d` <mdc-iconprovider url="./icons/svg"> ${e()} </mdc-iconprovider>`;function y(e){const t=i=>i.replace(/-([a-z])/g,n=>n[1].toUpperCase());return e.modules.forEach(i=>{i.declarations.forEach(n=>{const a=new Set(n.attributes.map(o=>t(o.name)));n.members=n.members.filter(o=>!a.has(o.name))})}),e}const v=y(p);l(v);const F={parameters:{a11y:{options:{runOnly:{type:"tag",values:["best-practice","wcag2a","wcag2aa","wcag21aa","wcag22aa"]}}},docs:{source:{excludeDecorators:!0}},actions:{argTypesRegex:"^on[A-Z].*"},backgrounds:{disable:!0,grid:{disable:!0}},badgesConfig:{wip:{styles:{backgroundColor:"#30240D",borderColor:"#D6B220",color:"#FFFFFFF2"},title:"Work In Progress",tooltip:{title:"This Component is Work In Progress",desc:"Keep an eye on the Release history for updates or provide feedback.",links:[{title:"Release history",href:"https://github.com/momentum-design/momentum-design/releases"},{title:"Leave feedback",href:"https://github.com/momentum-design/momentum-design/issues"}]}},stable:{styles:{backgroundColor:"#416116",borderColor:"#93C437",color:"#FFFFFFF2"},title:"Stable",tooltip:{title:"This Component is Stable",desc:"Ready for use.",links:[{title:"Consumption guide",href:"https://momentum-design.github.io/momentum-design/en/components/"},{title:"Release history",href:"https://github.com/momentum-design/momentum-design/releases"},{title:"Leave feedback",href:"https://github.com/momentum-design/momentum-design/issues"}]}},deprecated:{styles:{backgroundColor:"#4F0E10",borderColor:"#FC8B98",color:"#FFFFFFF2"},title:"Deprecated",tooltip:{title:"This Component is Deprecated",desc:"Check the Release history for more information about deprecation or provide feedback.",links:[{title:"Release history",href:"https://github.com/momentum-design/momentum-design/releases"},{title:"Leave feedback",href:"https://github.com/momentum-design/momentum-design/issues"}]}}},controls:{disableSaveFromUI:!0,expanded:!0,matchers:{color:/(background|color)$/i,date:/Date$/}},options:{storySort:{order:["Consumption","Styling","Components","Work In Progress"]}},direction:"ltr"},decorators:[b,g],globalTypes:{theme:{description:"Global theme for components",defaultValue:r[0].displayName,toolbar:{title:"Theme",icon:"globe",items:r.map(e=>e.displayName),dynamicTitle:!0}}}};export{F as default};
