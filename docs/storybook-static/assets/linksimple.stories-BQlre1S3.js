import{L as O,T as _}from"./linksimple.component-BFopq4mk.js";import{k as L}from"./iframe-BZjKjG2c.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CfVvwyf2.js";import"./DataAriaLabelMixin-BzAohLoh.js";import"./DisabledMixin-CqOXMscq.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
