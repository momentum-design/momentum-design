import{L as O,T as _}from"./linksimple.component-D0k1BPvd.js";import{k as L}from"./iframe-BRqcXwoo.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BJKCYMNO.js";import"./DataAriaLabelMixin-CKrPoW62.js";import"./DisabledMixin-MRxWtlyu.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
