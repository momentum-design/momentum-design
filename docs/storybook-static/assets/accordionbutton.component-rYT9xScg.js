import{u as E,U as y,X as f,k as s,h as n,T,V as g,R as h,F as v,n as o}from"./iframe-DD1qd397.js";import{D as I}from"./DisabledMixin-CYN0V68G.js";import{K as R,A}from"./KeyToActionMixin-D7mKMv1X.js";import{v as m}from"./v4-CmTdKEVZ.js";const V=E.constructTagName("accordiongroup"),x={SMALL:"small",LARGE:"large"},S={BORDERLESS:"borderless",CONTAINED:"contained",STACKED:"stacked"},z={SIZE:x.SMALL,VARIANT:S.STACKED},H=E.constructTagName("accordionbutton"),c={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},L={DEFAULT:"default",BORDERLESS:"borderless"},r={EXPANDED:!1,SIZE:x.SMALL,DATA_ARIA_LEVEL:3,VARIANT:L.DEFAULT,ICON_NAME:c.ARROW_UP},N=y`
  :host {
