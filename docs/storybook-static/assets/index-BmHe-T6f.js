import{i as g,k as p}from"./lit-element-D5KKan5q.js";import{C as h,n as c}from"./index-C9z9WAEj.js";import{c as a,a as y,D as m,b as n,A as s,T as f}from"./divider.constants-DyEGqhgz.js";import{a as T}from"./index-Cx7wvr8C.js";import{a as A}from"./index-BrLJ_9IK.js";import{T as w}from"./button.constants-D0QAbDxL.js";const I=[T,g`
    :host {
  ...
  `];var k=Object.defineProperty,v=(u,t,r,b)=>{for(var i=void 0,e=u.length-1,d;e>=0;e--)(d=u[e])&&(i=d(t,r,i)||i);return i&&k(t,r,i),i};const l=class l extends h{constructor(){super(...arguments),this.orientation=a.ORIENTATION,this.variant=a.VARIANT,this.arrowDirection=a.ARROW_DIRECTION,this.buttonPosition=a.BUTTON_DIRECTION}setVariant(t){this.setAttribute("variant",Object.values(y).includes(t)?t:a.VARIANT)}setOrientation(t){this.setAttribute("orientation",Object.values(m).includes(t)?t:a.ORIENTATION)}ensureValidDirections(){const t=this.orientation===m.HORIZONTAL?n.NEGATIVE:n.POSITIVE;Object.values(n).includes(this.buttonPosition)||(this.buttonPosition=t),Object.values(n).includes(this.arrowDirection)||(this.arrowDirection=t)}setGrabberButton(){this.ensureValidDirections();const t=this.querySelector("mdc-button");if(t){const r=this.getArrowIcon();t.setAttribute("variant","secondary"),t.setAttribute("prefix-icon",r)}}getArrowIcon(){const t=this.orientation===m.HORIZONTAL,r=this.arrowDirection===n.POSITIVE;return t?r?s.UP:s.DOWN:r?s.RIGHT:s.LEFT}update(t){super.update(t),t.has("orientation")&&this.setOrientation(this.orientation),t.has("variant")&&this.setVariant(this.variant),(t.has("orientation")||t.has("arrowDirection")||t.has("buttonPosition"))&&this.setGrabberButton()}inferDividerType(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("slot"),r=(t==null?void 0:t.assignedElements({flatten:!0}))||[];if(r.length>1)return;const b=r.some(d=>d.tagName===A.toUpperCase()),i=r.some(d=>d.tagName===w.toUpperCase());b&&!i?this.setAttribute("data-type","mdc-text-divider"):!b&&i&&(this.setAttribute("data-type","mdc-grabber-divider"),this.setGrabberButton())}connectedCallback(){super.connectedCallback(),this.setAttribute("data-type","mdc-primary-divider")}render(){return p`
      <div></div>
      <slot @slotchange=${this.inferDividerType}></slot>
      <div></div>
    `}};l.styles=[...h.styles,...I];let o=l;v([c({type:String,reflect:!0})],o.prototype,"orientation");v([c({type:String,reflect:!0})],o.prototype,"variant");v([c({type:String,attribute:"arrow-direction",reflect:!0})],o.prototype,"arrowDirection");v([c({type:String,attribute:"button-position",reflect:!0})],o.prototype,"buttonPosition");o.register(f);
