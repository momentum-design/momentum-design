import{L as O,T as _}from"./linksimple.component-MPQxZasF.js";import{k as L}from"./iframe-B7bS_Rc1.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-i8aYRTth.js";import"./DataAriaLabelMixin-_c_CvxgU.js";import"./DisabledMixin-fEKYSTzR.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
