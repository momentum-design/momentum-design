import{L as O,T as _}from"./linksimple.component-Dt1et6ym.js";import{k as L}from"./iframe-Cgnjs7Wo.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-f131Qllb.js";import"./DataAriaLabelMixin-CH4HEyMV.js";import"./DisabledMixin-BLgOOnKX.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
