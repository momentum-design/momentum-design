import{u as y,n as O}from"./index-C9z9WAEj.js";import{e as g,v as P}from"./v4-BnQ50LvX.js";import{a as m,P as u,C as A,D as L}from"./popover.component-BJBaaoho.js";import{i as x,k as S}from"./lit-element-D5KKan5q.js";import{a as p}from"./chunk-D5ZWXAHU-CGElDDNX.js";import"./index-8z3X4-DK.js";import{d as I,h as w}from"./utils-D1SE5bce.js";import"./if-defined-D5BV9-c0.js";import"./v4-CQkTLCs1.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-CcsHbiGJ.js";import"./DisabledMixin-CizxPH9K.js";import"./TabIndexMixin-CsrHswKP.js";import"./index-BX3Tn-Br.js";import"./button.constants-D3lNAbe_.js";import"./button.utils-idYASaaz.js";import"./index-BJ0JAAj5.js";import"./iframe-wvwb0ltC.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function D(e){return(t,r)=>{const{slot:o}={},l="slot"+(o?`[name=${o}]`:":not([name])");return g(t,r,{get(){var n;const a=(n=this.renderRoot)==null?void 0:n.querySelector(l);return(a==null?void 0:a.assignedNodes(e))??[]}})}}const C=y.constructTagName("tooltip"),i={DESCRIPTION:"description",LABEL:"label",NONE:"none"},s={BACKDROP:!1,DELAY:"0,0",OFFSET:4,PLACEMENT:m.TOP,SHOW_ARROW:!0,TOOLTIP_TYPE:i.DESCRIPTION},N=x`
...
`,it={title:"Components/tooltip",tags:["autodocs"],component:"mdc-tooltip",render:E,parameters:{badges:["stable"]},argTypes:{children:{control:"text"},color:{control:"select",options:Object.values(A)},delay:{control:"text"},id:{description:"The id of the tooltip(optional, if not set, a random id will be generated)",control:"text"},offset:{control:"number"},placement:{control:"select",options:Object.values(m)},"show-arrow":{control:"boolean"},"tooltip-type":{control:"select",options:Object.values(i)},triggerID:{control:"text"},...I(["--mdc-tooltip-max-width","--mdc-tooltip-padding","--mdc-tooltip-text-color","--mdc-tooltip-text-color-contrast","--mdc-popover-arrow-border-radius","--mdc-popover-arrow-border","--mdc-popover-primary-background-color","--mdc-popover-border-color","--mdc-popover-inverted-background-color","--mdc-popover-inverted-border-color","--mdc-popover-inverted-text-color","--mdc-popover-elevation-3"]),...w(["trigger","z-index","flip","role","focus-trap","prevent-scroll","close-button","interactive","hide-on-escape","hide-on-blur","hide-on-outside-click","focus-back-to-trigger","backdrop","size","append-to","close-button-aria-label","aria-labelledby","aria-describedby","showPopover","hidePopover","togglePopoverVisible","arrowElement","onOutsidePopoverClick","onEscapeKeydown","onPopoverFocusOut","startCloseDelay","cancelCloseDelay","enabledPreventScroll","enabledFocusTrap","shouldWrapFocus","utils","defaultSlotNodes"])}},c={render:E,args:{children:"This is a tooltip",color:L.COLOR,delay:s.DELAY,id:"tooltip",offset:s.OFFSET,placement:s.PLACEMENT,"show-arrow":s.SHOW_ARROW,triggerID:"tooltip-trigger","tooltip-type":s.TOOLTIP_TYPE,visible:!1}};var b,T,f;c.parameters={...c.parameters,docs:{...(b=c.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render,
  args: {
...
}`,...(f=(T=c.parameters)==null?void 0:T.docs)==null?void 0:f.source}}};const rt=["Example"];export{c as Example,rt as __namedExportsOrder,it as default};
