import{u as re,U as se,ac as O,k as s,R as $,h as de,n as m,$ as le}from"./iframe-LsDyd5eA.js";import"./index-3xk8iSFd.js";import"./index-ig4UHez8.js";import"./index-DltLovGx.js";import"./index-FSXJbskw.js";import"./index-0xJcrgjs.js";import{e as ie}from"./query-BPxBhMfF.js";import{o as ce}from"./query-assigned-elements-uEuc3rg8.js";import{t as u}from"./if-defined-qZQu8y_k.js";import{F as C,I as me}from"./input.component-CV7P8uaw.js";import{C as pe,E as be}from"./CaptureDestroyEventForChildElement-ak9C-mM7.js";import{A as ue}from"./buttonsimple.component-D9fAeCTo.js";import{D as he}from"./DataAriaLabelMixin-DVgns88g.js";import{F as xe}from"./FormInternalsMixin-v0XfLjg5.js";import{b as ve}from"./listitem.component-DZQu-qJw.js";import{F as E}from"./formfieldwrapper.component-CKCFNdND.js";import{V as r,D as w}from"./formfieldwrapper.constants-BT2UGxVP.js";import{a as V}from"./input.constants-dZnF5TRN.js";import{T as k}from"./index-E4MXPUD-.js";import{T as D}from"./index-o-wsYrLc.js";import{P as h,D as T,a as ye,S as R}from"./popover.constants-B0afLGWX.js";import{T as ge}from"./index-BfiSUAXG.js";import{K as fe,A as p}from"./KeyToActionMixin-CoSo1tIm.js";import"./index-tiR4ATg5.js";import"./index-CKOMEwfd.js";import{c as Se,s as Ae}from"./commonArgTypes-BG7EqI50.js";import{h as Te,a as $e}from"./utils-D6nie9pS.js";import"./preload-helper-C1FmrZbK.js";import"./index-vEOUe4_P.js";import"./index-DTrDRi1E.js";import"./index-BFp4i9sT.js";import"./base-DIkkzJ-c.js";import"./popover.component-Ckj_5iiF.js";import"./BackdropMixin-BOgv5Gp9.js";import"./index-BQOaAEXD.js";import"./v4-CmTdKEVZ.js";import"./directive-Ctav8iJK.js";import"./index-CG7iubc7.js";import"./DisabledMixin-D4fKto6W.js";import"./button.component-B163hAjh.js";import"./button.utils-rNW36Ji7.js";const Ie=re.constructTagName("combobox"),_={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},Oe="list",F="combobox-trigger-id";class L{static dispatchComboboxEvent(e,t,o,l=!0){e.dispatchEvent(new CustomEvent(t,{detail:{value:o==null?void 0:o.value,label:o==null?void 0:o.label},composed:!0,bubbles:l}))}static onInputCombobox(e,t){this.dispatchComboboxEvent(e,"input",t)}static onChangeCombobox(e,t){this.dispatchComboboxEvent(e,"change",t)}}const Ce=se`
  :host {
...
`,Ee=[Ce];var we=Object.defineProperty,d=(a,e,t,o)=>{for(var l=void 0,i=a.length-1,b;i>=0;i--)(b=a[i])&&(l=b(e,t,l)||l);return l&&we(e,t,l),l};const I=class I extends fe(pe(ue(xe(he(E))))){constructor(){super(),this.placement=h.BOTTOM_START,this.boundary=T.BOUNDARY,this.strategy=T.STRATEGY,this.popoverZIndex=T.Z_INDEX,this.isOpen=!1,this.filteredValue="",this.initialSelectedOption=null,this.handleUpdateError=e=>{this.onerror&&this.onerror(e)},this.handleDestroyEvent=e=>{const t=e.detail.originalTarget;if(t&&(!this.isValidItem(t)||t.tabIndex!==0))return;const o=this.navItems.findIndex(i=>i===t);if(o===-1)return;let l=o+1;l>=this.navItems.length&&(l=o-1)},this.addEventListener(ve.DESTROYED,this.handleDestroyEvent),this.itemsStore=new be(this,{isValidItem:this.isValidItem})}get navItems(){return this.itemsStore.items}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.setInputValidity(),this.internals.setFormValue(this.inputElement.value))}).catch(this.handleUpdateError)}isValidItem(e){return e.matches(`${D}:not([disabled])`)}openPopover(){this.isOpen=!0}closePopover(){this.isOpen=!1}toggleDropdown(){this.isOpen=!this.isOpen}compareOptionWithValue(e,t){return(e.getAttribute("label")||"").toLowerCase().startsWith(t==null?void 0:t.toLowerCase())}getFirstSelectedOption(){return this.navItems.find(e=>e.hasAttribute("selected"))}getVisibleOptions(e){return this.navItems.filter(t=>this.compareOptionWithValue(t,e))}setSelectedValue(e){this.value=(e==null?void 0:e.getAttribute("value"))||"",this.filteredValue=(e==null?void 0:e.getAttribute("label"))||"",this.internals.setFormValue(this.value),this.updateHiddenOptions(),this.updateSelectedOption(e),this.setInputValidity(),this.resetHelpText(),L.onInputCombobox(this,e),L.onChangeCombobox(this,e)}resetSelectedValue(){this.value="",this.internals.setFormValue(this.value),this.resetHelpText()}resetHelpText(){this.invalidCustomValueText&&this.helpText===this.invalidCustomValueText&&(this.helpText="",this.helpTextType=r.DEFAULT)}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),e==="validation-message"&&this.updateComplete.then(()=>{this.setInputValidity()}).catch(this.handleUpdateError)}async firstUpdated(e){await this.updateComplete,this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(e);const t=this.getFirstSelectedOption();if(t)this.initialSelectedOption=t,this.setSelectedValue(t);else if(this.value){const o=this.navItems.find(l=>l.value===this.value);this.setSelectedValue(o)}else this.placeholder&&this.setInputValidity();this.navItems.forEach(o=>{o.setAttribute("tabindex","-1")})}updated(e){super.updated(e),(e.has("slottedListboxes")||e.has("isOpen"))&&(this.visualCombobox&&"ariaControlsElements"in this.visualCombobox&&(this.visualCombobox.ariaControlsElements=this.slottedListboxes),this.dropDownButton&&"ariaControlsElements"in this.dropDownButton&&(this.dropDownButton.ariaControlsElements=this.slottedListboxes)),(e.has("disabled")||e.has("readonly"))&&(this.disabled||this.readonly)&&this.closePopover()}setInputValidity(){var e,t;!this.value&&this.required?(this.validationMessage?(e=this.inputElement)==null||e.setCustomValidity(this.validationMessage):(t=this.inputElement)==null||t.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){const e=this.initialSelectedOption||null;this.setSelectedValue(e),this.filteredValue=(e==null?void 0:e.label)??"",this.setInputValidity()}formStateRestoreCallback(e){const t=this.navItems.find(o=>o.value===e||o.label===e);this.setSelectedValue(t||null)}handleNativeInputFocus(){this.visualCombobox.focus()}resetFocusedOption(){this.navItems.filter(e=>e.hasAttribute("data-focused")).forEach(e=>this.updateOptionAttributes(e,!1))}updateSelectedOption(e){this.navItems.forEach(t=>{t.removeAttribute("selected")}),e==null||e.setAttribute("selected","")}updateOptionAttributes(e,t){e!==void 0&&(t?e.setAttribute("data-focused",""):e.removeAttribute("data-focused"),e.setAttribute("aria-selected",t.toString()))}handleBlurChange(){const e=this.getVisibleOptions(this.filteredValue),t=e.findIndex(o=>o.hasAttribute("data-focused"));if(t!==-1){this.setSelectedValue(e[t]),this.closePopover();return}t===-1&&this.filteredValue!==""&&this.invalidCustomValueText&&!this.getFirstSelectedOption()&&(this.helpText=this.invalidCustomValueText,this.helpTextType=r.ERROR),this.setInputValidity()}updateFocusAndScrollIntoView(e,t,o){var l;this.updateOptionAttributes(e[t],!1),this.updateOptionAttributes(e[o],!0),(l=e[o])==null||l.scrollIntoView({block:"nearest"})}handleInputKeydown(e){const t=this.getVisibleOptions(this.filteredValue),o=t.findIndex(l=>l.hasAttribute("data-focused"));switch(this.getActionForKeyEvent(e)){case p.DOWN:{this.openPopover();const l=t.length-1===o?0:o+1;this.updateFocusAndScrollIntoView(t,o,l),e.preventDefault();break}case p.UP:{this.openPopover();const l=o===-1||o===0?t.length-1:o-1;this.updateFocusAndScrollIntoView(t,o,l),e.preventDefault();break}case p.ENTER:{if(o===-1)return;this.setSelectedValue(t[o]),this.isOpen&&this.closePopover();break}case p.ESCAPE:{o!==-1&&this.updateOptionAttributes(t[o],!1),t.length&&this.shouldDisplayPopover(t.length)?this.closePopover():(this.resetSelectedValue(),this.filteredValue="");break}case p.TAB:{this.closePopover();break}case p.HOME:case p.END:{this.resetFocusedOption();break}}}updateHiddenOptions(){this.navItems.forEach(e=>{this.compareOptionWithValue(e,this.filteredValue)?(e.removeAttribute("data-hidden"),this.showOptionGroupAndDivider(e)):(e.setAttribute("data-hidden",""),this.hideOptionGroupAndDivider(e))})}hideOptionGroupAndDivider(e){var t,o,l;(t=e.parentElement)!=null&&t.matches(k)&&((o=Array.from(e.parentElement.children))==null?void 0:o.filter(b=>!b.hasAttribute("data-hidden"))).length===0&&(e.parentElement.setAttribute("data-hidden",""),(l=e.parentElement.nextElementSibling)!=null&&l.matches(O)&&e.parentElement.nextElementSibling.setAttribute("data-hidden",""))}showOptionGroupAndDivider(e){var t,o,l;(t=e.parentElement)!=null&&t.matches(k)&&((o=Array.from(e.parentElement.children))==null?void 0:o.filter(b=>!b.hasAttribute("data-hidden"))).length>0&&(e.parentElement.removeAttribute("data-hidden"),(l=e.parentElement.nextElementSibling)!=null&&l.matches(O)&&e.parentElement.nextElementSibling.removeAttribute("data-hidden"))}handleInputChange(e){var t;this.filteredValue=e.target.value,this.resetSelectedValue(),this.resetFocusedOption(),this.updateHiddenOptions(),(t=this.getFirstSelectedOption())==null||t.removeAttribute("selected"),this.isOpen===!1&&this.openPopover()}handleOptionsClick(e){const t=e.target.closest(D)??null;t&&!t.hasAttribute("disabled")&&(this.setSelectedValue(t),this.closePopover(),this.updateComplete.then(()=>this.handleNativeInputFocus()).catch(this.handleUpdateError))}shouldDisplayPopover(e){return this.disabled||this.readonly?!1:e?this.isOpen:!!this.noResultText}renderNativeInput(){return s`
  ...
  >
    ${a.children}
  </mdc-combobox>`,yt={title:"Components/combobox",tags:["autodocs"],component:"mdc-combobox",render:ne,parameters:{badges:["stable"]},argTypes:{"auto-focus-on-mount":{control:"boolean"},"backdrop-append-to":{control:"text"},boundary:{control:"text"},"data-aria-label":{control:"text"},disabled:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",options:Object.values(r)},"info-icon-aria-label":{control:"text"},label:{control:"text"},name:{control:"text"},"no-result-text":{control:"text"},placeholder:{control:"text"},placement:{control:"select",options:[h.BOTTOM_START,h.TOP_START]},"popover-z-index":{control:"number"},readonly:{control:"boolean"},required:{control:"boolean"},strategy:{control:"select",options:Object.values(R)},value:{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(h)},"toggletip-strategy":{control:"select",options:Object.values(R)},"validation-message":{control:"text"},"invalid-custom-value-text":{control:"text"},...Te(["id","value","validity","willValidate","default","itemsStore","handleUpdateError"]),...Se,...Ae}},x={args:{value:"",label:"Top Countries",name:"country","help-text":"Select a country","help-text-type":r.DEFAULT,disabled:!1,readonly:!1,"no-result-text":"",placeholder:"Start typing","data-aria-label":"Select a country","info-icon-aria-label":"Required icon label",placement:h.BOTTOM_START,"invalid-custom-value-text":"Custom values are not allowed",children:s`
      <mdc-selectlistbox>
...
}`,...(B=(W=x.parameters)==null?void 0:W.docs)==null?void 0:B.source}}};var M,q,H;v.parameters={...v.parameters,docs:{...(M=v.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => html\`
      <mdc-combobox
        name="country"
        label="Top Countries"
  ...
  \`
}`,...(H=(q=v.parameters)==null?void 0:q.docs)==null?void 0:H.source}}};var P,U,G;y.parameters={...y.parameters,docs:{...(P=y.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
...
}`,...(G=(U=y.parameters)==null?void 0:U.docs)==null?void 0:G.source}}};var z,Y,K;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    name: 'avengers-name',
...
}`,...(K=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:K.source}}};var j,X,Z;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-combobox
      placeholder="Type a color"
      label="Select one color"
...
}`,...(ae=(oe=A.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};const gt=["Example","AllVariants","ComboboxWithOptionGroups","ComboboxWithSelectedValue","ComboboxWithLongOptionText","ComboboxWithForm","ComboboxWithHelpTextValidation"];export{v as AllVariants,S as ComboboxWithForm,A as ComboboxWithHelpTextValidation,f as ComboboxWithLongOptionText,y as ComboboxWithOptionGroups,g as ComboboxWithSelectedValue,x as Example,gt as __namedExportsOrder,yt as default};
