import{L as O,T as _}from"./linksimple.component-CBBqExpu.js";import{k as L}from"./iframe-CM5v7A9W.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DgC6xmGR.js";import"./DataAriaLabelMixin-Bksih1qV.js";import"./DisabledMixin-CLyN7JwY.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
