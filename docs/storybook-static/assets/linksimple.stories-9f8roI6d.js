import{L as O,T as _}from"./linksimple.component-BDjIBsbI.js";import{k as L}from"./iframe-CJ86bTna.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CPZ8iztr.js";import"./DataAriaLabelMixin-BvcoNyzy.js";import"./DisabledMixin-DrN7r3Wp.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
