import{N as y,a4 as k,O as T,R as f,k as o,V as p,T as d,r as u,C as x,n as c}from"./iframe-BrN8x_Z0.js";import{K as R,a as C,T as S,A as n}from"./KeyDownHandledMixin-lEQrVlT7.js";import{p as A}from"./index-CuaFIEeJ.js";import{D as E,b as N,a as s,c as h,d as D}from"./stepper.component-DuJiN-LS.js";import"./index-D5lPBL37.js";const O=y`
  :host {
    gap: 0.5rem;
    ...
    >`;return this.status===s.ERROR_INCOMPLETE||this.status===s.ERROR_CURRENT?o`<div part="help-text-container">
      ...
      <div part="label-container">
        ${this.label?o`<mdc-text part="label" tagname=${p.SPAN} type=${d.BODY_MIDSIZE_REGULAR}
            ...
            >`:u}
        ${this.renderHelpText()}
      </div>`}};v.styles=[...x.styles,..._];let r=v;i([c({type:String,reflect:!0})],r.prototype,"variant");i([c({type:String,reflect:!0})],r.prototype,"status");i([c({type:String,reflect:!0})],r.prototype,"label");i([c({type:String,reflect:!0,attribute:"help-text"})],r.prototype,"helpText");i([c({type:Number,reflect:!0,attribute:"step-number"})],r.prototype,"stepNumber");r.register(D);
