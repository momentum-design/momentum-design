import{i as T,k as p,D as f}from"./lit-element-D5KKan5q.js";import{n as l}from"./property-Bj3TGwkg.js";import{P as N,C as E}from"./provider.component-DrWB4byV.js";import{T as I,V as y}from"./index-D2VIkDCb.js";import{b as g,c as A,T as S,a as v,V as n}from"./menupopover.constants-BF9ktXe6.js";import{D as w,a as D,b as u}from"./divider.constants-DXWnBz1m.js";import{R as C}from"./roles-CJI3JVG-.js";import{K as V}from"./keys-hFXe221I.js";import{n as O}from"./create-context-89xeped_.js";import{a as P}from"./popover.component-C-Xszb39.js";const m=class m{constructor(t,e,i){this.variant=t,this.expanded=e,this.parentNavTooltipText=i}hasSiblingWithTriggerId(t){var r;const e=t==null?void 0:t.getAttribute("id");return e?Array.from(((r=t==null?void 0:t.parentElement)==null?void 0:r.children)??[]).some(a=>a!==t&&a.tagName.toLowerCase()===g&&a.getAttribute("triggerid")===e):!1}getParentNavMenuItems(t){if(!t)return[];const e=[];let i=t;for(;i;){const r=i==null?void 0:i.closest(g);if(!r)break;const a=r.getAttribute("triggerid");if(!a)break;const s=document.getElementById(a);if(s&&s.tagName.toLowerCase()===A)e.push(s),i=s;else break}return e}setCurrentActiveNavMenuItem(t){var a;const e=((a=this.currentActiveNavMenuItem)==null?void 0:a.navId)===(t==null?void 0:t.navId),i=(t==null?void 0:t.disableAriaCurrent)||this.hasSiblingWithTriggerId(t)||(t==null?void 0:t.softDisabled);if(e||i||(this.currentActiveNavMenuItem&&(this.currentActiveNavMenuItem.removeAttribute("aria-current"),this.currentActiveNavMenuItem.removeAttribute("active"),this.getParentNavMenuItems(this.currentActiveNavMenuItem).forEach(h=>{h.removeAttribute("tooltip-text"),h.removeAttribute("tooltip-placement"),h.removeAttribute("active")})),!t))return;this.currentActiveNavMenuItem=t,t.setAttribute("aria-current","page"),t.setAttribute("active",""),this.getParentNavMenuItems(t).forEach(s=>{s.setAttribute("tooltip-text",this.parentNavTooltipText||""),s.setAttribute("tooltip-placement",P.BOTTOM),s.setAttribute("active","")})}};m.context=O(S);let d=m;const $=T`
  :host {
...
`,L=[$];var k=Object.defineProperty,c=(b,t,e,i)=>{for(var r=void 0,a=b.length-1,s;a>=0;a--)(s=b[a])&&(r=s(t,e,r)||r);return r&&k(t,e,r),r};const x=class x extends N{constructor(){super({context:d.context,initialValue:new d(v.VARIANT,!0)}),this.variant=v.VARIANT,this.footerText="",this.handleNestedNavMenuItemActiveChange=t=>{var e;if((e=this.context)!=null&&e.value){const i=this.findNav(this.navMenuItems,t.detail.navId);this.context.value.setCurrentActiveNavMenuItem(i)}},this.findNav=(t,e)=>t.find(i=>i.navId===e),this.addEventListener("activechange",this.handleNestedNavMenuItemActiveChange.bind(this))}connectedCallback(){super.connectedCallback(),this.role=C.NAVIGATION}static get Context(){return d.context}updated(t){if(super.updated(t),t.has("variant"))switch(this.setVariant(this.variant),this.variant){case n.FIXED_EXPANDED:this.expanded=!0;break;case n.FIXED_COLLAPSED:this.expanded=!1;break}(t.has("variant")||t.has("expanded"))&&this.updateContext()}firstUpdated(t){super.firstUpdated(t),this.variant===n.FLEXIBLE&&this.expanded===void 0&&(this.expanded=!0,this.updateContext())}updateContext(){(this.context.value.variant!==this.variant||this.context.value.expanded!==this.expanded||this.context.value.parentNavTooltipText!==this.parentNavTooltipText)&&(this.context.value.variant=this.variant,this.context.value.expanded=this.expanded,this.context.value.parentNavTooltipText=this.parentNavTooltipText,this.context.updateObservers())}get navMenuItems(){return Array.from(this.querySelectorAll(`${A}:not([disabled])`))}setVariant(t){this.setAttribute("variant",Object.values(n).includes(t)?t:v.VARIANT)}toggleSideNavigation(){this.expanded=!this.expanded,this.dispatchEvent(new CustomEvent("toggle",{detail:{expanded:this.expanded}}))}preventScrollOnSpace(t){t.key===V.SPACE&&t.preventDefault()}render(){return this.variant===n.HIDDEN?p``:p`
      <div part="side-navigation-container" id="side-nav-container">
        ...
        <div part="fixed-section">
          ...
          <div part="brand-logo-container">
            ...
            ${this.expanded?p`<mdc-text type=${I.BODY_MIDSIZE_MEDIUM} tagname=${y.SPAN} part="footer-text"
    ...
    `}};x.styles=[...E.styles,...L];let o=x;c([l({type:String,reflect:!0})],o.prototype,"variant");c([l({type:String,reflect:!0,attribute:"footer-text"})],o.prototype,"footerText");c([l({type:Boolean,reflect:!0})],o.prototype,"expanded");c([l({type:String,reflect:!0,attribute:"grabber-btn-aria-label"})],o.prototype,"grabberBtnAriaLabel");c([l({type:String,reflect:!0,attribute:"parent-nav-tooltip-text"})],o.prototype,"parentNavTooltipText");export{o as S};
