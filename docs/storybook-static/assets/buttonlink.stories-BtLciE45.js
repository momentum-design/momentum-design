import{i as U,k as p}from"./lit-element-D5KKan5q.js";import{n as B}from"./property-Bj3TGwkg.js";import{a as R,B as P}from"./button.component-C0ZL9yys.js";import{D,P as N,a as E,B as w,I as f}from"./button.constants-BBlkZKjZ.js";import{L as j}from"./linksimple.component-CAbwAHDU.js";import{a as Z}from"./index-CqVtAZCJ.js";import{u as V}from"./provider.component-DrWB4byV.js";import"./index-APTaIYMp.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as F,s as M}from"./commonArgTypes-BluK8w5L.js";import{a as W,d as q}from"./utils-CFOyPOhY.js";import"./state-CmYk530Z.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-Dydm3dt1.js";import"./keys-hFXe221I.js";import"./DisabledMixin-B-Cnza7-.js";import"./TabIndexMixin-DEwGeIeI.js";import"./buttonsimple.constants-CVV9o_W6.js";import"./button.utils-rNW36Ji7.js";import"./if-defined-D5BV9-c0.js";import"./DataAriaLabelMixin-DVpSBUFD.js";import"./iframe-DC2qJtBf.js";import"../sb-preview/runtime.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";const Y=U`
  :host {
    border: unset;
  }
...
`,G=[Y,...Z(!0)];var H=Object.defineProperty,C=(t,o,a,Q)=>{for(var r=void 0,m=t.length-1,h;m>=0;m--)(h=t[m])&&(r=h(o,a,r)||r);return r&&H(o,a,r),r};const b=class b extends R(j){constructor(){super(...arguments),this.size=D.SIZE}setSoftDisabled(o,a){a?o.setAttribute("aria-disabled","true"):o.removeAttribute("aria-disabled")}update(o){super.update(o),o.has("softDisabled")&&this.setSoftDisabled(this,this.softDisabled),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&this.inferButtonType()}renderAnchorContent(){return p`
    ...
    `}};b.styles=[...P.styles,...G];let i=b;C([B({type:Number,reflect:!0})],i.prototype,"size");C([B({type:Boolean,attribute:"soft-disabled",reflect:!0})],i.prototype,"softDisabled");const J=V.constructTagName("buttonlink");i.register(J);const K=t=>p` <mdc-buttonlink
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
