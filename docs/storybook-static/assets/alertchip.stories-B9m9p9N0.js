import{X as S,$ as O,a0 as x,u as _,T as $,V as w,a as L,R as C,k as t,h as M,H as U,n as R}from"./iframe-CM5v7A9W.js";import{B as V}from"./buttonsimple.component-Brk_p-op.js";import{I as B}from"./IconNameMixin-7TaejW4I.js";import"./index-8eILrhn8.js";import{i as D}from"./manifest-FrmGbvs6.js";import{t as h}from"./if-defined-DgC6xmGR.js";import{c as F,s as G}from"./commonArgTypes-BG7EqI50.js";import{h as j,a as P}from"./utils-D6nie9pS.js";import"./preload-helper-C1FmrZbK.js";import"./DisabledMixin-CLyN7JwY.js";import"./KeyToActionMixin-eZa7VV6_.js";import"./index-7nPJAxAt.js";import"./index-DTrDRi1E.js";const Y=S`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,W=[O,Y,...x()],X=_.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},a={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:w.SPAN,SIZE:L[24],ROLE:C.BUTTON},Z=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.WARNING]:"warning-badge-filled"})[r];var z=Object.defineProperty,y=(r,m,u,K)=>{for(var e=void 0,d=r.length-1,v;d>=0;d--)(v=r[d])&&(e=v(m,u,e)||e);return e&&z(m,u,e),e};const p=class p extends B(V){constructor(){super(...arguments),this.variant=a.VARIANT}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=a.SIZE,this.role=a.ROLE}render(){return t`
      ...
      ${this.label?t`<mdc-text part="label" type="${a.TEXT_TYPE}" tagname="${a.TAG_NAME}"
            >${this.label}</mdc-text
          >`:M}
    `}};p.styles=[...U.styles,...W];let c=p;y([R({type:String,reflect:!0})],c.prototype,"variant");y([R({type:String})],c.prototype,"label");c.register(X);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,H=r=>t` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
