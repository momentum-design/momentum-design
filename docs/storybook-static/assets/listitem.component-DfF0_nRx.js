import{S as v,U as y,R as f,k as l,V as x,v as E,T as o,C as b,L as u,n as s}from"./iframe-1qtKO-Lg.js";import{D as L}from"./DisabledMixin-EZ3FaG-P.js";import{K as k,a as I,T as S,A as d}from"./KeyDownHandledMixin-PeN-ExeF.js";import{a as D}from"./LifeCycleMixin-CkFTW4AQ.js";import{D as w}from"./listitem.constants-bhC2Mmq0.js";class g{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const C=v`
  :host {
