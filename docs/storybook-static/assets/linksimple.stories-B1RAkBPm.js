import{L as O,T as _}from"./linksimple.component-tBLMHYw6.js";import{k as L}from"./iframe-DMX3WSm5.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-hRGbxhii.js";import"./DataAriaLabelMixin-JSVsfkf5.js";import"./DisabledMixin-kEnOH2ur.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
