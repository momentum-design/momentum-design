import{i as F,k as c}from"./lit-element-D5KKan5q.js";import{n as q}from"./property-Bj3TGwkg.js";import{u as J,C}from"./provider.component-DrWB4byV.js";import{c as Q,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as Y}from"./utils-CFOyPOhY.js";const Z=J.constructTagName("skeleton"),a={BUTTON:"button",CIRCULAR:"circular",RECTANGULAR:"rectangular",ROUNDED:"rounded"},P={VARIANT:a.RECTANGULAR},ee=F`
  :host {
...
`;var te=Object.defineProperty,ne=(e,t,o,n)=>{for(var r=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(r=i(t,o,r)||r);return r&&te(t,o,r),r};const k=class k extends C{constructor(){super(...arguments),this.variant=P.VARIANT}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}firstUpdated(t){super.firstUpdated(t),this.checkSlotContent()}checkSlotContent(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");t&&(t.assignedNodes().length>0?this.setAttribute("has-content",""):this.removeAttribute("has-content"))}render(){return c`<slot @slotchange=${this.checkSlotContent}></slot>`}};k.styles=[...C.styles,ee];let v=k;ne([q({type:String,reflect:!0})],v.prototype,"variant");v.register(Z);let d=0;const l=e=>{d+=1;const t=document.getElementById("normal-content-dynamic"),o=document.getElementById("skeleton-content-dynamic");if(!t||!o)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",o.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${d}`,n.style.cssText=`
...
}`,...(j=(H=y.parameters)==null?void 0:H.docs)==null?void 0:j.source}}};const ue=["Example","Rectangular","Rounded","Circular","Button","WithContent","DynamicContent","ResponsiveContainer"];export{g as Button,x as Circular,h as DynamicContent,p as Example,m as Rectangular,y as ResponsiveContainer,u as Rounded,b as WithContent,ue as __namedExportsOrder,me as default};
