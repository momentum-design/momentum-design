import{L as O,T as _}from"./linksimple.component-I7QHqhX7.js";import{k as L}from"./iframe-0lXzRINF.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-D28hcRQK.js";import"./DataAriaLabelMixin-Cb16sLph.js";import"./DisabledMixin-B5XUkeWw.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
