import{W as N,a5 as _,J as R,K as W,k as i,t as a}from"./iframe-_aMQt5aw.js";import{c as j,s as k}from"./commonArgTypes-BG7EqI50.js";import{b as K}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__,U=e=>{const o=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return i`<mdc-input
    @input="${r("oninput")}"
    @change="${r("onchange")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
