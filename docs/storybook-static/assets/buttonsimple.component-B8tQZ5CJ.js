import{n as r,i as f,k as p,C as m}from"./iframe-DSSNydaC.js";import{K as n}from"./keys-hFXe221I.js";import{D as v}from"./DisabledMixin-CVvLVeWc.js";import{T as y}from"./TabIndexMixin-Crv4vJKj.js";import{D as l,B as b}from"./buttonsimple.constants-xC2Epio7.js";import{h as g,a as z}from"./index-CrzoWpsH.js";var E=Object.defineProperty,S=(a,t,i,u)=>{for(var e=void 0,h=a.length-1,d;h>=0;h--)(d=a[h])&&(e=d(t,i,e)||e);return e&&E(t,i,e),e};const A=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=this,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,this.elementToAutoFocus.focus())}}return S([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},x=[g,f`
    :host {
