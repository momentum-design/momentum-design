import"./index-Dp3CykGT.js";import{k as r}from"./lit-element-D5KKan5q.js";import{a as s}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as V}from"./if-defined-D5BV9-c0.js";import{B as t,P as a,a as n,I as O}from"./button.constants-D0QAbDxL.js";import{c as j,s as q}from"./commonArgTypes-BluK8w5L.js";import{B as o}from"./buttonsimple.constants-CGc1uJX6.js";import"./button.component-DP9lGkCN.js";import"./index-C9z9WAEj.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-C1CVlJGY.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./index-CcXofQbA.js";import"./button.utils-rNW36Ji7.js";import"./index-BIrdrtKU.js";import"./iframe-Dy4GVOuD.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";const i=e=>r` <mdc-button
    @click="${s("onclick")}"
    @keydown="${s("onkeydown")}"
    @keyup="${s("onkeyup")}"
    @focus="${s("onfocus")}"
  ...
  >`,ue={title:"Components/button",tags:["autodocs"],component:"mdc-button",render:i,parameters:{badges:["stable"]},argTypes:{children:{description:"Text label for the button.",control:"text"},"prefix-icon":{control:"text"},"postfix-icon":{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},variant:{control:"select",options:Object.values(t)},size:{control:"select",options:Object.values(a)},color:{control:"select",options:Object.values(n)},type:{control:"select",options:Object.values(o)},ariaStateKey:{control:"text"},inverted:{control:"boolean"},...j,...q}},l={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:t.PRIMARY,size:a[32],color:n.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,inverted:!1}},d={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:t.PRIMARY,size:a[32],color:n.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},c={render:e=>r` <div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
      ${i(e)}
...
}`,...(E=(L=p.parameters)==null?void 0:L.docs)==null?void 0:E.source}}};var g,C,Y;b.parameters={...b.parameters,docs:{...(g=b.parameters)==null?void 0:g.docs,source:{originalSource:`{
  argTypes: {
    size: {
...
}`,...(Y=(C=b.parameters)==null?void 0:C.docs)==null?void 0:Y.source}}};var $,z,M;f.parameters={...f.parameters,docs:{...($=f.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => html\` <div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
      \${render(args)}
    </div>\`,
  argTypes: {
...
}`,...(M=(z=f.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};var k,D,F;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => render({
    ...args,
...
}`,...(F=(D=m.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var W,Z,w;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => render({
    ...args,
    children: html\`<mdc-text>\${args.textWithinChildren}</mdc-text>\`,
    style: 'width: 150px;'
...
}`,...(w=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:w.source}}};const Oe=["Example","PillButton","PillButtonInverted","PillWithPrefixIcon","PillWithPostfixIcon","IconButton","IconButtonInverted","PillButtonEllipsis","PillWithPrefixIconEllipsis"];export{l as Example,b as IconButton,f as IconButtonInverted,d as PillButton,m as PillButtonEllipsis,c as PillButtonInverted,p as PillWithPostfixIcon,T as PillWithPrefixIcon,u as PillWithPrefixIconEllipsis,Oe as __namedExportsOrder,ue as default};
