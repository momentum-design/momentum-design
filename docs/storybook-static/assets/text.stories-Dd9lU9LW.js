...
`,z=[p`
  ...
  `,b],d=e=>{const t=e.split("-");return{firstPart:t[0],secondPart:t[1]}},c=e=>{const{firstPart:t,secondPart:r}=d(e);return t==="heading"&&+r>0&&+r<7},w=e=>e?c(e)?"heading":"paragraph":null,P=e=>{if(e&&c(e)){const{secondPart:t}=d(e);return t}return null};var v=Object.defineProperty,T=(e,t,r,E)=>{for(var n=void 0,a=e.length-1,l;a>=0;a--)(l=e[a])&&(n=l(t,r,n)||n);return n&&v(t,r,n),n};const s=class s extends y{handleTypeChanged(){this.role=w(this.type),this.ariaLevel=P(this.type)}updated(t){super.updated(t),t.has("type")&&this.handleTypeChanged()}render(){return f`<slot></slot>`}};s.styles=z;let i=s;T([u({attribute:"type",reflect:!0,type:String})],i.prototype,"type");const k=x.constructTagName("text"),_={TYPE:["heading-1","heading-2","heading-3","heading-4","heading-5","heading-6","heading-7","body-large","body-regular","body-small","image-title","label"]};i.register(k);const C=e=>f`
<mdc-text type="${e.type}">${e.children}</mdc-text>
`,L={title:"Work In Progress/text",tags:["autodocs"],component:"mdc-text",render:C,argTypes:{type:{control:"radio",options:_.TYPE}}},o={args:{type:"heading-1",children:"This is a test text"}};var h,m,g;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    type: 'heading-1',
    children: 'This is a test text'
  }
}`,...(g=(m=o.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};const N=["Primary"];export{o as Primary,N as __namedExportsOrder,L as default};
