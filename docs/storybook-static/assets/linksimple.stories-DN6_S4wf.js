import{L as O,T as _}from"./linksimple.component-D98XSIo0.js";import{k as L}from"./iframe-C-ScMBWt.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BNUT9LZm.js";import"./DataAriaLabelMixin-Osgj21t6.js";import"./DisabledMixin-Bd0Kod_E.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
