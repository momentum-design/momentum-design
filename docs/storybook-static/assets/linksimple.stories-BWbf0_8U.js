import{L as O,T as _}from"./linksimple.component-BIV2VmdL.js";import{k as L}from"./iframe-D1RGJO9g.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-CEt-h5rX.js";import"./DataAriaLabelMixin-DzXGOr4J.js";import"./DisabledMixin-CFnJTGkD.js";import"./index-CQUTSyim.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
