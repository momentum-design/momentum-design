import{L as O,T as _}from"./linksimple.component-QAB_DZzO.js";import{k as L}from"./iframe-CAPDL6NR.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-CZl5EkiP.js";import"./DataAriaLabelMixin-DKyP6cE4.js";import"./DisabledMixin-CMR8O10r.js";import"./index-D0E8q322.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
