import{L as O,T as _}from"./linksimple.component-TzbuMsHh.js";import{k as L}from"./iframe-C10VdK12.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CWVcm-XG.js";import"./DataAriaLabelMixin-C5nwRFWb.js";import"./DisabledMixin-CO3LfEsk.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
