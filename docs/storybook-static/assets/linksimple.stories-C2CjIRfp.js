import{L as O,T as _}from"./linksimple.component-DsnI0X5i.js";import{k as L}from"./iframe-xgMm-O8k.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-dadJY7mK.js";import"./DataAriaLabelMixin-BUB7xkD6.js";import"./DisabledMixin-s5mvDnUI.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
