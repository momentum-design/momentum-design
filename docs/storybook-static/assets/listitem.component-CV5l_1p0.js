...
`,w=[A,...I()];var R=Object.defineProperty,a=(o,t,i,l)=>{for(var r=void 0,h=o.length-1,b;h>=0;h--)(b=o[h])&&(r=b(t,i,r)||r);return r&&R(t,i,r),r};const m=class m extends x(L(C(g))){constructor(){super(),this.variant=S.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||T.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){(t.key===c.ENTER||t.key===c.SPACE)&&(this.triggerClickEvent(),t.preventDefault())}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}getText(t,i,l){return d`
    ...
    `}};m.styles=[...g.styles,...w];let e=m;a([v({slot:"leading-controls"})],e.prototype,"leadingControlsSlot");a([v({slot:"trailing-controls"})],e.prototype,"trailingControlsSlot");a([s({type:String,reflect:!0})],e.prototype,"variant");a([s({type:String,reflect:!0})],e.prototype,"label");a([s({type:String,reflect:!0,attribute:"secondary-label"})],e.prototype,"secondaryLabel");a([s({type:String,reflect:!0,attribute:"tertiary-label"})],e.prototype,"tertiaryLabel");a([s({type:String,reflect:!0,attribute:"side-header-text"})],e.prototype,"sideHeaderText");a([s({type:String,reflect:!0,attribute:"subline-text"})],e.prototype,"sublineText");a([s({type:Boolean,reflect:!0,attribute:"soft-disabled"})],e.prototype,"softDisabled");export{e as L,B as T,D as a,p as b};
