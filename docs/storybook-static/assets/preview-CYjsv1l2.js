 ...
 *
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}}]},{kind:"javascript-module",path:"components/checkbox/checkbox.component.js",declarations:[{kind:"class",description:`Checkboxes allow users to select multiple options from a list or turn an item/feature on or off.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Link",module:"components/link/link.component.js"}}]},{kind:"javascript-module",path:"components/icon/icon.component.js",declarations:[{kind:"class",description:`Icon component that dynamically displays SVG icons based on a valid name.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Icon",module:"components/icon/icon.component.js"}}]},{kind:"javascript-module",path:"components/list/list.component.js",declarations:[{kind:"class",description:"mdc-list component is used to display a group of list items. It is used as a container to wrap other list items.",name:"List",slots:[{description:"This is a default/unnamed slot",name:"default"}],members:[{kind:"field",name:"listItems",type:{text:"Array<HTMLElement>"}},{kind:"field",name:"headerText",type:{text:"string | undefined"},description:"The header text of the list.",attribute:"header-text",reflects:!0},{kind:"method",name:"handleKeyDown",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event."}],description:`Handles the keydown event on the list element.
