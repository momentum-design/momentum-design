import{L as O,T as _}from"./linksimple.component-CYFLQ8Ca.js";import{k as L}from"./iframe-CeK4lsRG.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BRN9yNKl.js";import"./DataAriaLabelMixin-Bt2S7oaW.js";import"./DisabledMixin-S32os9Wv.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
