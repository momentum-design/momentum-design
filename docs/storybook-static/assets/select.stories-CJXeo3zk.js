import{a as t}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{k as o}from"./lit-element-D5KKan5q.js";import"./index-BprmGlyF.js";import{c as ee,s as te}from"./commonArgTypes-BluK8w5L.js";import{a as oe,t as le,h as n,d as X}from"./utils-CFOyPOhY.js";import"./index-BWIpxT1l.js";import{V as g}from"./formfieldwrapper.component-C-SgLT80.js";import"./index-oD85tVyW.js";import"./index-Z_2yJG1_.js";import{a as ce}from"./popover.component-BcWkwQje.js";import"./v4-CQkTLCs1.js";import"./index-9Z2SQRnZ.js";import"./button.component-CMTraJwt.js";import"./provider.component-BaQC7CJH.js";import"./state-C0WmBOuD.js";import"./button.constants-BpS-4nLb.js";import"./buttonsimple.constants-CNAgWCp2.js";import"./roles-DU0xbrD4.js";import"./buttonsimple.component-I-gcvU8_.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./index-B-GnYs90.js";import"./button.utils-rNW36Ji7.js";import"./index-BmvJiRbj.js";import"./iframe-D02km18B.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-ChWiF_5p.js";import"./create-context-89xeped_.js";import"./index-Dl6-Osbw.js";import"./index-riA1qVWu.js";import"./index-SlYuHEDe.js";import"./if-defined-D5BV9-c0.js";import"./index-Dm_kZN_u.js";import"./v4-CmTdKEVZ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DataAriaLabelMixin-Cpdy3gUS.js";import"./FormInternalsMixin-BIoSiX4k.js";import"./divider.constants-DBMTjDho.js";import"./index-ChH4-Or7.js";import"./listitem.component-BeuoLqO-.js";const $=Object.values(g).filter(e=>e!=="priority"),i=e=>o`
...
`,ne=e=>i(o`
  ...
  `),Ze={title:"Components/select/select",tags:["autodocs"],component:"mdc-select",render:ne,parameters:{badges:["stable"]},argTypes:{name:{control:"text"},label:{control:"text"},required:{control:"boolean"},placeholder:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${$.map(e=>`'${e}'`).join(", ")}.`,options:$},"info-icon-aria-label":{control:"text"},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(ce)},height:{control:"text"},placement:{control:"select",options:["bottom-start","top-start"]},"soft-disabled":{control:"boolean"},...oe(["id","value","validity","validation-message","willValidate","default"]),...le(["--mdc-select-background-color","--mdc-select-background-color-hover","--mdc-select-background-color-active","--mdc-select-background-color-disabled","--mdc-select-text-color","--mdc-select-text-color-selected","--mdc-select-text-color-disabled","--mdc-select-border-color","--mdc-select-border-color-disabled","--mdc-select-border-color-success","--mdc-select-border-color-warning","--mdc-select-border-color-error","--mdc-select-width"]),...ee,...te}},r={args:{label:"Headquarters location",required:!0,placeholder:"Select your headquarters location",disabled:!1,readonly:!1,"help-text":"Select Help Text","help-text-type":"","data-aria-label":"Select label",height:"auto",placement:"bottom-start"}},s={render:()=>i(o`
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(C=(L=s.parameters)==null?void 0:L.docs)==null?void 0:C.source}}};var q,T,W;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => html\`
    <div style="height: 35rem;">
      <mdc-select label="Select an option from the list of groups" data-aria-label="Select an option">
        <mdc-selectlistbox>
  ...
  \`,
  ...hideAllControls()
}`,...(W=(T=m.parameters)==null?void 0:T.docs)==null?void 0:W.source}}};var D,I,R;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
      <mdc-select placeholder="Select a color" label="Select one color">
        <mdc-selectlistbox>
          <mdc-option label="Red"></mdc-option>
    ...
    \`),
  ...hideAllControls()
}`,...(R=(I=p.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};var E,F,H;b.parameters={...b.parameters,docs:{...(E=b.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
      <mdc-select placeholder="Select an option" label="You are in a meeting">
        <mdc-selectlistbox>
          <mdc-option prefix-icon="alert-bold" label="Mute notifications"></mdc-option>
  ...
  ...hideAllControls()
}`,...(Q=(J=S.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};const Je=["Example","SelectWithSecondaryLabel","SelectWithGroups","SelectWithLongOptionText","SelectWithIconOptions","SelectWithStates","SelectWithFixedHeight","SelectWithForm","SelectWithDynamicOptions","SelectWithChangingSelectedAfterMount"];export{r as Example,S as SelectWithChangingSelectedAfterMount,y as SelectWithDynamicOptions,h as SelectWithFixedHeight,x as SelectWithForm,m as SelectWithGroups,b as SelectWithIconOptions,p as SelectWithLongOptionText,s as SelectWithSecondaryLabel,u as SelectWithStates,Je as __namedExportsOrder,Ze as default};
