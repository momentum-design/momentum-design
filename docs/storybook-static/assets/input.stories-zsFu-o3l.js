import{i as q,D as h,k as n}from"./lit-element-CHllvULs.js";import{u as D,n as i}from"./index-HW6KrQZO.js";import{t as a}from"./if-defined-C4tJgJ33.js";import{h as H}from"./index-CEbgplXA.js";import"./index-qW1fZ2mR.js";import{V as w,N as z,v as B}from"./ValueMixin-B2saez_i.js";import{B as U,I as X}from"./button.constants-DopO3xW8.js";import{V as v,D as M,F as $}from"./formfieldwrapper.component-CWIPqk6J.js";import{T as Z,V as j}from"./text.constants-DJu2q-6E.js";import{D as G}from"./DataAriaLabelMixin-vs_lw9aw.js";import"./index-ew1MvfAJ.js";import"./index-3ZoWJRR8.js";import"./index-BGkqZMsC.js";import{a as u}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as Y,s as K}from"./commonArgTypes-BluK8w5L.js";import{d as R}from"./utils-D1SE5bce.js";import"./buttonsimple.component-BZ9r9wPy.js";import"./DisabledMixin-DBt9didn.js";import"./state-CWckTc1X.js";import"./button.utils-F1-WjXoW.js";import"./iframe-DL_rnTrt.js";import"../sb-preview/runtime.js";import"./index-BYMLCX4c.js";import"./iconprovider.component-BsPZ_dvP.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const W=(e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,o),o);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function J(e,t){return(o,s,d)=>{const c=m=>{var T;return((T=m.renderRoot)==null?void 0:T.querySelector(e))??null};return W(o,s,{get(){return c(this)}})}}const Q=[q`
  :host{
  ...
  `,...H(!0)],ee=D.constructTagName("input"),P={OFF:"off",NONE:"none",ON:"on",SENTENCES:"sentences",WORDS:"words",CHARACTERS:"characters"},te={MAX_LENGTH:10,HELPERTEXT:"Prefix text should not exceed 10 characters",VALIDATION:v.ERROR},p={VALIDATION:v.DEFAULT,ICON_SIZE_VALUE:1,ICON_SIZE_UNIT:"rem",CLEAR_BUTTON_ICON:"cancel-bold",CLEAR_BUTTON_VARIANT:U.TERTIARY,CLEAR_BUTTON_SIZE:X[20],PREFIX_TEXT_TYPE:Z.BODY_MIDSIZE_REGULAR,PREFIX_TEXT_TAG:j.SPAN};var re=Object.defineProperty,l=(e,t,o,s)=>{for(var d=void 0,c=e.length-1,m;c>=0;c--)(m=e[c])&&(d=m(t,o,d)||d);return d&&re(t,o,d),d};const g=class g extends G(w(z($))){constructor(){super(),this.placeholder="",this.readonly=!1,this.trailingButton=!1,this.autocapitalize=P.OFF,this.autocomplete="off",this.autofocus=!1,this.clearAriaLabel="",this.internals=this.attachInternals(),this.id=`mdc-input-${B()}`}checkValidity(){return this.setValidityFromInput(),this.internals.checkValidity()}reportValidity(){return this.setValidityFromInput(),this.internals.reportValidity()}get form(){return this.internals.form}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.inputElement.checkValidity(),this.setValidityFromInput(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&this.handleValueChange()}handleValueChange(){this.internals.setFormValue(this.value),this.updateComplete.then(()=>{this.setValidityFromInput()}).catch(t=>{this.onerror&&this.onerror(t)})}attributeChangedCallback(t,o,s){super.attributeChangedCallback(t,o,s),["maxlength","minlength","pattern","required"].includes(t)&&this.updateComplete.then(()=>{this.setValidityFromInput()}).catch(c=>{this.onerror&&this.onerror(c)})}setValidityFromInput(){this.inputElement&&this.internals.setValidity(this.inputElement.validity,this.inputElement.validationMessage,this.inputElement)}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setValidityFromInput()}onChange(t){this.updateValue(),this.setValidityFromInput();const o=t.constructor;this.dispatchEvent(new o(t.type,t))}handleKeyDown(t){var o;t.key==="Enter"&&((o=this.internals.form)==null||o.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?n`
      <mdc-icon 
        class="leading-icon" 
        part="leading-icon"
    ...
    `:h}renderPrefixText(){return this.prefixText?n`
      <mdc-text 
        ...
        aria-hidden="true"
      >
        ${this.prefixText.slice(0,te.MAX_LENGTH)}
      </mdc-text>
       ...
       <slot name="input-prefix-text">${this.renderPrefixText()}</slot>
        <slot name="input">
          <input 
            ...
            type="text"
            aria-describedby="${M.HELPER_TEXT_ID}"
    ...
    `}};g.formAssociated=!0,g.styles=[...$.styles,...Q];let r=g;l([i({type:String})],r.prototype,"placeholder");l([i({type:Boolean})],r.prototype,"readonly");l([i({type:String,attribute:"prefix-text"})],r.prototype,"prefixText");l([i({type:String,attribute:"leading-icon"})],r.prototype,"leadingIcon");l([i({type:Boolean,attribute:"trailing-button"})],r.prototype,"trailingButton");l([i({type:Number})],r.prototype,"maxlength");l([i({type:Number})],r.prototype,"minlength");l([i({type:String})],r.prototype,"autocapitalize");l([i({type:String})],r.prototype,"autocomplete");l([i({type:Boolean})],r.prototype,"autofocus");l([i({type:String})],r.prototype,"dirname");l([i({type:String})],r.prototype,"pattern");l([i({type:String})],r.prototype,"list");l([i({type:Number})],r.prototype,"size");l([i({type:String,attribute:"clear-aria-label"})],r.prototype,"clearAriaLabel");l([J("input")],r.prototype,"inputElement");r.register(ee);const oe=e=>{const t=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return n` <mdc-input
    @input="${u("oninput")}"
    @change="${u("onchange")}"
    @focus="${u("onfocus")}"
    @blur="${u("onblur")}"
...
}`,...(O=(F=f.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};const ke=["Example","InputInSmallContainer","AllVariants","FormFieldInput"];export{y as AllVariants,b as Example,f as FormFieldInput,x as InputInSmallContainer,ke as __namedExportsOrder,Ve as default};
