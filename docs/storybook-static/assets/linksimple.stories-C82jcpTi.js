import{L as O,T as _}from"./linksimple.component-DSFEvDkb.js";import{k as L}from"./iframe-BceO9xBA.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DJvvsfJY.js";import"./DataAriaLabelMixin-BnTYbWc3.js";import"./DisabledMixin-CJ7Qsp83.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
