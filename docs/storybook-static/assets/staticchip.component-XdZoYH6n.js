import{i as p,D as i,k as l}from"./lit-element-D5KKan5q.js";import{u,C as s,n as h}from"./provider.component-BaQC7CJH.js";import{I as g}from"./IconNameMixin-CRlZlTtq.js";import{T as v,V as k}from"./index-DHsMOcdX.js";import{h as T}from"./index-CqVtAZCJ.js";const D=u.constructTagName("staticchip"),E={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},c={COLOR:E.DEFAULT,TEXT_TYPE:v.BODY_MIDSIZE_REGULAR,TAG_NAME:k.SPAN},A=p`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,f=[T,A];var L=Object.defineProperty,b=(t,m,d,O)=>{for(var o=void 0,e=t.length-1,n;e>=0;e--)(n=t[e])&&(o=n(m,d,o)||o);return o&&L(m,d,o),o};const a=class a extends g(s){constructor(){super(...arguments),this.color=c.COLOR,this.label=""}renderIcon(){return this.iconName?l` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:i}render(){return l`
      ${this.renderIcon()}
      ${this.label?l`<mdc-text part="label" type="${c.TEXT_TYPE}" tagname="${c.TAG_NAME}"
            >${this.label}</mdc-text
          >`:i}
    `}};a.styles=[...s.styles,...f];let r=a;b([h({type:String,reflect:!0})],r.prototype,"color");b([h({type:String})],r.prototype,"label");export{E as C,r as S,D as T};
