import{u,V as f,q as T,U as y,S as I,h as i,k as l,B as E,G as x,n as o}from"./iframe-BuPhkxnS.js";import{t as A}from"./if-defined-BgceRQth.js";import{D as S}from"./DisabledMixin-C1arkXyT.js";import{v as b}from"./v4-CmTdKEVZ.js";const G=u.constructTagName("formfieldwrapper"),n={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},r={VALIDATION:n.DEFAULT,HELPER_TEXT_ID:"helper-text-id",HEADING_ID:"heading-id",ICON_SIZE:20,INFO_ICON:"info-badge-filled",TOGGLETIP_PLACEMENT:"top",TOGGLETIP_STRATEGY:"absolute"},d={TAGNAME:f.SPAN,TYPE:T.BODY_MIDSIZE_REGULAR,HEADER_TYPE:T.BODY_MIDSIZE_BOLD},_=[y,I`
    :host {
