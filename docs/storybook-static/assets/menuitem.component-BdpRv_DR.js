import{i as T,k as e,D as E}from"./lit-element-D5KKan5q.js";import{u,n}from"./index-C9z9WAEj.js";import{R as y}from"./roles-BH_hBfTz.js";import{a as g,L as v}from"./listitem.component-BsXDfNEd.js";import{K as h}from"./keys-Hz01Ianf.js";const C=u.constructTagName("menuitem"),i={LEFT:"arrow-left-bold",RIGHT:"arrow-right-bold"},m={POSITIVE:"positive",NEGATIVE:"negative"},I={LEADING:"leading",TRAILING:"trailing"},w=T`
...
`,f=[w];var R=Object.defineProperty,a=(p,t,c,A)=>{for(var r=void 0,s=p.length-1,d;s>=0;s--)(d=p[s])&&(r=d(t,c,r)||r);return r&&R(t,c,r),r};const l=class l extends g{constructor(){super(),this.name=void 0,this.value=void 0,this.addEventListener("keyup",this.handleKeyUp)}handleKeyDown(t){t.key===h.ENTER&&(this.triggerClickEvent(),t.preventDefault())}handleKeyUp(t){t.key===h.SPACE&&(this.triggerClickEvent(),t.preventDefault())}connectedCallback(){super.connectedCallback(),this.role=y.MENUITEM,this.variant=v.INSET_RECTANGLE}renderTrailingControls(){const t=this.arrowDirection===m.NEGATIVE?i.LEFT:i.RIGHT;return e`
      <slot
