import{i as v,k as m}from"./lit-element-D5KKan5q.js";import{u as p,C as c,n as i}from"./index-C9z9WAEj.js";import{D as f}from"./DisabledMixin-BZruwOeC.js";import{T as b}from"./TabIndexMixin-CsrHswKP.js";import{h as u,a as g}from"./index-B-GnYs90.js";const D=p.constructTagName("linksimple"),h={INLINE:!1,INVERTED:!1},k=[u,v`
    :host {
  ...
  `,...g()];var y=Object.defineProperty,o=(l,e,s,x)=>{for(var r=void 0,n=l.length-1,d;n>=0;n--)(d=l[n])&&(r=d(e,s,r)||r);return r&&y(e,s,r),r};const a=class a extends f(b(c)){constructor(){super(...arguments),this.inline=h.INLINE,this.inverted=h.INVERTED,this.href="#",this.target="_self",this.prevTabindex=0,this.handleNavigation=e=>{if((e.type==="click"||e instanceof KeyboardEvent&&e.key==="Enter")&&this.href){if(this.disabled)return;window.open(this.href,this.target,this.rel)}}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","link"),this.addEventListener("click",this.handleNavigation),this.addEventListener("keydown",this.handleNavigation)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleNavigation),this.removeEventListener("keydown",this.handleNavigation)}setDisabled(e){e?(this.setAttribute("aria-disabled","true"),this.prevTabindex=this.tabIndex,this.tabIndex=-1):(this.tabIndex===-1&&(this.tabIndex=this.prevTabindex),this.removeAttribute("aria-disabled"))}update(e){super.update(e),e.has("disabled")&&this.setDisabled(this.disabled)}render(){return m` <slot></slot> `}};a.styles=[...c.styles,...k];let t=a;o([i({type:Boolean,reflect:!0})],t.prototype,"inline");o([i({type:Boolean,reflect:!0})],t.prototype,"inverted");o([i({type:String,reflect:!0})],t.prototype,"href");o([i({type:String,reflect:!0})],t.prototype,"target");o([i({type:String,reflect:!0})],t.prototype,"rel");export{h as D,t as L,D as T};
