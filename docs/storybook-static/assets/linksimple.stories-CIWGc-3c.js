import{L as O,T as _}from"./linksimple.component-VntYwBT8.js";import{k as L}from"./iframe-Bi1VXFcK.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-KwKmEakk.js";import"./DataAriaLabelMixin-C-H14b3P.js";import"./DisabledMixin-BppKOdkM.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
