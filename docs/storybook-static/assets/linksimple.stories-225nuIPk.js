import{L as O,T as _}from"./linksimple.component-Ckr6KvFr.js";import{k as L}from"./iframe-c_i7I41_.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cz0DV4mo.js";import"./DataAriaLabelMixin-CY7MM2gf.js";import"./DisabledMixin-BZSiUR0v.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
