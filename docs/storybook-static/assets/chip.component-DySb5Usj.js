import{i as b,D as m,k as a}from"./lit-element-D5KKan5q.js";import{n as h}from"./property-Bj3TGwkg.js";import{I as v}from"./IconNameMixin-Bk-Z_FTS.js";import{B as u}from"./buttonsimple.component-Dydm3dt1.js";import{C as p,S as g}from"./staticchip.component-B6T76d3x.js";import{R as k}from"./roles-CJI3JVG-.js";import{u as f}from"./provider.component-DrWB4byV.js";import{a as T}from"./buttonsimple.constants-CVV9o_W6.js";import{T as E,V as y}from"./index-D2VIkDCb.js";import{h as S,a as O}from"./index-CqVtAZCJ.js";const U=f.constructTagName("chip"),r={COLOR:p.DEFAULT,TEXT_TYPE:E.BODY_MIDSIZE_REGULAR,TAG_NAME:y.SPAN,SIZE:T[24],ROLE:k.BUTTON},_=b`
  :host {
    cursor: pointer;
    height: 1.5rem;
  }
...
`,A=[S,_,...O()];var I=Object.defineProperty,n=(t,d,i,L)=>{for(var o=void 0,e=t.length-1,s;e>=0;e--)(s=t[e])&&(o=s(d,i,o)||o);return o&&I(d,i,o),o};const l=class l extends v(u){constructor(){super(...arguments),this.color=r.COLOR,this.label=""}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?a` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:m}render(){return a`
      ${this.renderIcon()}
      ${this.label?a`<mdc-text part="label" type="${r.TEXT_TYPE}" tagname="${r.TAG_NAME}"
            >${this.label}</mdc-text
          >`:m}
    `}};l.styles=[...g.styles,...A];let c=l;n([h({type:String,reflect:!0})],c.prototype,"color");n([h({type:String})],c.prototype,"label");export{c as C,U as T};
