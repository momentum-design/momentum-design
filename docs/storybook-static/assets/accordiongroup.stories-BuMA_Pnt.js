import{N as H,O as K,C as x,k as g,n as E,H as F,R as U,t as L}from"./iframe-BrN8x_Z0.js";import{T as J}from"./index-2ZaIGBdN.js";import{D as d,a as P,b as Q,S as n,c as s}from"./accordionbutton.component-0Mkfbvae.js";import"./index-izCMH9VL.js";import"./index-G5az_3xQ.js";import"./index-B6PHG5Mc.js";import{c as X,s as tt}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";import"./index-BDHBrWNs.js";import"./button.component-Duy2Fx_8.js";import"./buttonsimple.component-C085WkLc.js";import"./DisabledMixin-DjI3Wyw_.js";import"./KeyDownHandledMixin-lEQrVlT7.js";import"./index-CuaFIEeJ.js";import"./button.utils-rNW36Ji7.js";import"./index-D5lPBL37.js";import"./index-DTrDRi1E.js";import"./index-BfoiQtT4.js";import"./IconNameMixin-CbFovggv.js";import"./index-8qX6WQk2.js";import"./chip.component-Jk-b33iC.js";import"./staticchip.component-vhqfRbGP.js";const ot=H`
  :host {
...
`,at=[ot,...K()];var et=Object.defineProperty,l=(o,t,a,m)=>{for(var c=void 0,S=o.length-1,f;S>=0;S--)(f=o[S])&&(c=f(t,a,c)||c);return c&&et(t,a,c),c};const I=class I extends x{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(m=>{m.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(m=>{m.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return g` <slot></slot> `}};I.styles=[...x.styles,...at];let i=I;l([E({type:String,reflect:!0})],i.prototype,"size");l([E({type:String,reflect:!0})],i.prototype,"variant");l([E({type:Boolean,reflect:!0,attribute:"allow-multiple"})],i.prototype,"allowMultiple");l([F({selector:J})],i.prototype,"accordionItems");l([F({selector:P})],i.prototype,"accordionButtonItems");i.register(Q);const e=g`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
  ...
  laborum.<mdc-button style="margin-top:0.75rem">Continue</mdc-button>`,rt=o=>g`<div role="${U.MAIN}">
    <mdc-accordiongroup
      size="${L(o.size)}"
      variant="${L(o.variant)}"
...
}`,...(T=(y=r.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};var z,C,O;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    variant: VARIANT.STACKED,
    size: SIZE.SMALL
  }
}`,...(O=(C=p.parameters)==null?void 0:C.docs)==null?void 0:O.source}}};var M,R,$;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    ...Example.args,
