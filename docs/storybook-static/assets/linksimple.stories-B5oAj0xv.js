import{L as O,T as _}from"./linksimple.component-HSJBDH_V.js";import{k as L}from"./iframe-BZP6WX1W.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-5PTGeIjh.js";import"./DataAriaLabelMixin-Dn_vQb5h.js";import"./DisabledMixin-BJwARYIU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
