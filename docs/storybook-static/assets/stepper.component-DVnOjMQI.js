import{u as r,B as p,i as O,P as I,k as R,C as v,n as N}from"./iframe-BG4I9E_r.js";import{R as u}from"./roles-CJI3JVG-.js";import{h as m}from"./index-B1GIzs4g.js";const f={COMPLETE:"complete",INCOMPLETE:"incomplete"},h={VERTICAL:"vertical",HORIZONTAL:"horizontal"},_={STATUS:f.INCOMPLETE,ORIENTATION:h.HORIZONTAL},D=r.constructTagName("stepperconnector"),M=r.constructTagName("stepperitem"),E={INLINE:"inline",STACKED:"stacked"},C={COMPLETED:"completed",CURRENT:"current",ERROR_CURRENT:"error-current",ERROR_INCOMPLETE:"error-incomplete",NOT_STARTED:"not-started"},b={COMPLETED:"check-bold",ERROR:"error-legacy-badge-filled",PENCIL:"edit-bold"},V={VARIANT:E.INLINE,STATUS:C.NOT_STARTED},L=r.constructTagName("stepper"),a={ORIENTATION:h.HORIZONTAL,VARIANT:E.INLINE},c=class c{constructor(t,o){this.orientation=t,this.variant=o}};c.context=p(L);let n=c;const x=O`
  :host {
    gap: 0.5rem;
  }
