import{i as _,k as p}from"./lit-element-CHllvULs.js";import{u as H,C as E,n as g}from"./index-HW6KrQZO.js";import{h as k}from"./index-CcvxQn6k.js";import{a as Z}from"./text.constants-DJu2q-6E.js";import{T as B}from"./button.constants-C9hyZ9Xb.js";import{c as j,s as P}from"./commonArgTypes-BluK8w5L.js";import{d as W,h as O}from"./utils-C8za8dl6.js";const $=[k,_`
  ...
  `],U=H.constructTagName("divider"),o={HORIZONTAL:"horizontal",VERTICAL:"vertical"},v={SOLID:"solid",GRADIENT:"gradient"},r={POSITIVE:"positive",NEGATIVE:"negative"},b={UP:"arrow-up-regular",DOWN:"arrow-down-regular",LEFT:"arrow-left-regular",RIGHT:"arrow-right-regular"},c={ORIENTATION:o.HORIZONTAL,VARIANT:v.SOLID,ARROW_DIRECTION:r.NEGATIVE,BUTTON_DIRECTION:r.NEGATIVE};var F=Object.defineProperty,I=(e,t,i,y)=>{for(var n=void 0,d=e.length-1,s;d>=0;d--)(s=e[d])&&(n=s(t,i,n)||n);return n&&F(t,i,n),n};const f=class f extends E{constructor(){super(...arguments),this.orientation=c.ORIENTATION,this.variant=c.VARIANT,this.arrowDirection=c.ARROW_DIRECTION,this.buttonPosition=c.BUTTON_DIRECTION}setVariant(t){this.setAttribute("variant",Object.values(v).includes(t)?t:c.VARIANT)}setOrientation(t){this.setAttribute("orientation",Object.values(o).includes(t)?t:c.ORIENTATION)}ensureValidDirections(){const t=this.orientation===o.HORIZONTAL?r.NEGATIVE:r.POSITIVE;Object.values(r).includes(this.buttonPosition)||(this.buttonPosition=t),Object.values(r).includes(this.arrowDirection)||(this.arrowDirection=t)}setGrabberButton(){const t=this.querySelector("mdc-button");if(!t)return;this.ensureValidDirections();const i=this.getArrowIcon();t.setAttribute("variant","secondary"),t.setAttribute("prefix-icon",i)}getArrowIcon(){const t=this.orientation===o.HORIZONTAL,i=this.arrowDirection===r.POSITIVE;return t?i?b.UP:b.DOWN:i?b.RIGHT:b.LEFT}update(t){super.update(t),t.has("orientation")&&this.setOrientation(this.orientation),t.has("variant")&&this.setVariant(this.variant),(t.has("orientation")||t.has("arrowDirection")||t.has("buttonPosition"))&&this.setGrabberButton()}inferDividerType(){var d;this.setAttribute("data-type","mdc-primary-divider");const t=(d=this.shadowRoot)==null?void 0:d.querySelector("slot"),i=(t==null?void 0:t.assignedElements({flatten:!0}))||[];if(i.length>1)return;const y=i.some(s=>s.tagName===Z.toUpperCase()),n=i.some(s=>s.tagName===B.toUpperCase());y&&!n?this.setAttribute("data-type","mdc-text-divider"):!y&&n&&(this.setAttribute("data-type","mdc-grabber-divider"),this.setGrabberButton())}render(){return p`
      <div></div>
      <slot @slotchange=${this.inferDividerType}></slot>
      <div></div>
    `}};f.styles=[...E.styles,...$];let a=f;I([g({type:String,reflect:!0})],a.prototype,"orientation");I([g({type:String,reflect:!0})],a.prototype,"variant");I([g({type:String,attribute:"arrow-direction",reflect:!0})],a.prototype,"arrowDirection");I([g({type:String,attribute:"button-position",reflect:!0})],a.prototype,"buttonPosition");a.register(U);const M={text:p`<mdc-text tagname="h1">Label</mdc-text>`,grabber:p`<mdc-button role="button" aria-label="divider label" aria-expanded="false"></mdc-button>`,noChildren:p``},q=e=>{const t=M[e.typeOfChildren]||p``;return p`
