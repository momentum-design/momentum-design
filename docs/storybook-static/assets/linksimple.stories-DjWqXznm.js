import{L as O,T as _}from"./linksimple.component-oPh3aFQk.js";import{k as L}from"./iframe-C7yclCw2.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-LpKwmKE_.js";import"./DataAriaLabelMixin-B1ETzapN.js";import"./DisabledMixin-BZSjqt26.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
