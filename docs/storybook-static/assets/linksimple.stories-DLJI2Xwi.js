import{L as O,T as _}from"./linksimple.component-daCBe3iT.js";import{k as L}from"./iframe-BPwLWgIo.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-oxJKdKKV.js";import"./DataAriaLabelMixin-C-v1Fw1q.js";import"./DisabledMixin--pSk0K2n.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
