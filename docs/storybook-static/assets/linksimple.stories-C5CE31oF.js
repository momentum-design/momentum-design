import{L as O,T as _}from"./linksimple.component-D0KEdZCk.js";import{k as L}from"./iframe-DBGUNv4F.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-ByroiDkB.js";import"./DataAriaLabelMixin-1_uyFcu6.js";import"./DisabledMixin-toBsO7Rw.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
