import{L as O,T as _}from"./linksimple.component-C1qVVT3M.js";import{k as L}from"./iframe-vAJUMk4U.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CrQmv4c0.js";import"./DataAriaLabelMixin-DtkShBFO.js";import"./DisabledMixin-BESLbD74.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
