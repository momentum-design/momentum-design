import{L as O,T as _}from"./linksimple.component-BIMqhX4f.js";import{k as L}from"./iframe-DbAt1rJM.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DsNDmE3q.js";import"./DataAriaLabelMixin-BG-M6m7U.js";import"./DisabledMixin-Bysad3Ja.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
