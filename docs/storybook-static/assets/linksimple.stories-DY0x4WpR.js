import{L as O,T as _}from"./linksimple.component-DtylQ_dm.js";import{k as L}from"./iframe-qMFey-4N.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Dt3SjqsG.js";import"./DataAriaLabelMixin-Be1-okds.js";import"./DisabledMixin-DFNWVipU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
