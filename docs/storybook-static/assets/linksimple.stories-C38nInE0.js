import{L as O,T as _}from"./linksimple.component-BE7M0iNW.js";import{k as L}from"./iframe-Bxc2R5W_.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DVfQj5LO.js";import"./DataAriaLabelMixin-BeqK3QPG.js";import"./DisabledMixin-EWLkxMJG.js";import"./index-D1dgoSI_.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
