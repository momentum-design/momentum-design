import{L as O,T as _}from"./linksimple.component-psmjpEui.js";import{k as L}from"./iframe-5H9qcZJ2.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B-PVuCb_.js";import"./DataAriaLabelMixin-9ouzFIjs.js";import"./DisabledMixin-C3uKy2QQ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
