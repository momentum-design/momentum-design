import{n as r,$ as m,X as p,a0 as y,D as c,c as b,k as v,H as f}from"./iframe-Bay37rkC.js";import{D as g}from"./DisabledMixin-DGD1GTFB.js";import{K as A,T as E,A as h}from"./KeyToActionMixin-C8CPt1j6.js";var S=Object.defineProperty,x=(a,t,e,u)=>{for(var s=void 0,n=a.length-1,d;n>=0;n--)(d=a[n])&&(s=d(t,e,s)||s);return s&&S(t,e,s),s};const T=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return x([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},z=[m,p`
    :host {
