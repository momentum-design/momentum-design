import{L as O,T as _}from"./linksimple.component-DtZ088Q8.js";import{k as L}from"./iframe-CWfhylcR.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-CtiHmB4N.js";import"./DataAriaLabelMixin-Cr9xs3ah.js";import"./DisabledMixin-lt5dcxac.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
