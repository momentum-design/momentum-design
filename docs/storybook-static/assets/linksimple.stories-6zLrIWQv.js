import{L as O,T as _}from"./linksimple.component-0aJrM028.js";import{k as L}from"./iframe-D1GWnnRD.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-aIZVvHMc.js";import"./DataAriaLabelMixin-CKlcWvK4.js";import"./DisabledMixin-BeF7ANP5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
