import{i as m,k as b}from"./lit-element-D5KKan5q.js";import{n as s}from"./property-Bj3TGwkg.js";import{C as l,u as v}from"./provider.component-DrWB4byV.js";import{D as h}from"./DisabledMixin-B-Cnza7-.js";const u=[m`
    :host {
      display: block;
      position: relative;
      width: 1rem;
  ...
  `];var k=Object.defineProperty,n=(e,t,i,g)=>{for(var r=void 0,c=e.length-1,d;c>=0;c--)(d=e[c])&&(r=d(t,i,r)||r);return r&&k(t,i,r),r};const a=class a extends h(l){constructor(){super(...arguments),this.checked=!1,this.readonly=!1}render(){return b` <slot></slot>
