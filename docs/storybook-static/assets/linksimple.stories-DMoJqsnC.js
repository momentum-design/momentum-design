import{L as O,T as _}from"./linksimple.component-DsYrC5qQ.js";import{k as L}from"./iframe-1qtKO-Lg.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-DdX1l2k6.js";import"./DisabledMixin-EZ3FaG-P.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
