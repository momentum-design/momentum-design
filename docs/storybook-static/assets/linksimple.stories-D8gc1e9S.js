import{L as O,T as _}from"./linksimple.component-jS0P7kNT.js";import{k as L}from"./iframe-Dqi1znBL.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DBaEJSn3.js";import"./DataAriaLabelMixin-BY65oQD9.js";import"./DisabledMixin-BBBcOPXh.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
