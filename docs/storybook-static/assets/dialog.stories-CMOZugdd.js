...
}`,...(_e=(Be=B.parameters)==null?void 0:Be.docs)==null?void 0:_e.source}}};const Ut=["Example","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe"];export{B as DialogWithIframe,k as DialogWithinDialog,v as Example,C as MountUnmount,L as WithPopover,z as WithoutTriggerElement,Ut as __namedExportsOrder,Gt as default,A as fullscreen,I as large,E as medium,f as small,$ as withCustomHeader,T as withSaveCancelButtons,D as withoutHeader,S as withoutHeaderOrFooter,x as xlarge};
