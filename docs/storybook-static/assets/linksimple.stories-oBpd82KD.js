import{L as O,T as _}from"./linksimple.component-Gwhq6y72.js";import{k as L}from"./iframe-BZzdMAZp.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DZZrGFtM.js";import"./DataAriaLabelMixin-Con2Dv41.js";import"./DisabledMixin-FFwZPyaL.js";import"./index-CWcLttKP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
