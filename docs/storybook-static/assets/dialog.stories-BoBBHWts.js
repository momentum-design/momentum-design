import"./index-BdqU8QxK.js";import{k as o}from"./iframe-C_HbRYVK.js";import{t as w}from"./if-defined-CJwtqgn3.js";import{c as Be,s as We}from"./commonArgTypes-BG7EqI50.js";import{b as Oe,D as _e,c as a,a as s}from"./dialog.component-CW2DejNC.js";import"./index-C7wDVGXf.js";import"./index-DXCglqwv.js";import"./index-CylxX-aW.js";import"./index-DVZnLJm-.js";import"./index-Cu0GudqY.js";import"./index-DeHOfnCs.js";import"./index-CG2vOqMM.js";import"./index-BOiu9SN9.js";import"./preload-helper-C1FmrZbK.js";import"./BackdropMixin-DcAnIb1V.js";import"./FooterMixin-KksTwCSK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./link.constants-deT6fVbf.js";import"./index-Gp1MG_Yr.js";import"./IconNameMixin-9mj_CL2a.js";import"./linksimple.component-B9E9cQP-.js";import"./DataAriaLabelMixin-BMxDflFO.js";import"./DisabledMixin-BVUoG_L5.js";import"./index-aLQ3cro_.js";import"./index-DTrDRi1E.js";import"./button.component-ReLfwGko.js";import"./buttonsimple.component-C0fNamps.js";import"./TabIndexMixin-J3NjxR3v.js";import"./button.utils-rNW36Ji7.js";import"./popover.component-CI9WLYq4.js";import"./popover.constants-DYu0R6PJ.js";import"./v4-CmTdKEVZ.js";import"./ListNavigationMixin-CiUuH04B.js";import"./listitem.component-B9_TTRL3.js";import"./CaptureDestroyEventForChildElement-BHA3zm2o.js";import"./query-BPxBhMfF.js";import"./index-D1J-BfXO.js";import"./index-1i_5q6iO.js";import"./index-BEW2SKqr.js";import"./formfieldwrapper.component-_OKycZy5.js";import"./formfieldwrapper.constants-Can8FmAa.js";import"./input.constants-DnzpDwae.js";import"./FormInternalsMixin-ZEnbLOgC.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d=(e,t,i)=>o`<mdc-dialog
    class="${e.class}"
    style="${e.style}"
    id="${e.id}"
    z-index="${e["z-index"]}"
...
`,Nt={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:Ne,argTypes:{...Be,...We,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(Oe)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},"hide-backdrop":{control:"boolean"},role:{control:"select",options:Object.values(_e)},size:{control:"select",options:Object.values(a)},visible:{control:"boolean"}}},r={id:"dialog","z-index":s.Z_INDEX,role:s.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:s.VARIANT},l={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":s.HEADER_TAG_NAME,"description-tag-name":s.DESCRIPTION_TAG_NAME},g={args:{size:s.SIZE,...r,...l}},p={args:{size:s.SIZE,...r,...l,"hide-backdrop":!0},parameters:{docs:{description:{story:"This example shows a dialog without a backdrop. The backdrop can be disabled by setting the `hide-backdrop` attribute to `true`. When disabled, users can interact with elements behind the dialog."}}}},u={name:"Size: Small",args:{size:a[0],...r,...l}},b={name:"Size: Medium",args:{size:a[1],...r,...l}},h={name:"Size: Large",args:{size:a[2],...r,...l}},v={name:"Size: XLarge",args:{size:a[3],...r,...l}},y={name:"Size: Fullscreen",args:{size:a[4],...r,...l}},I={args:{...r,size:a[0]}},f={render:Me,args:{...r,size:a[0]}},D={render:Ue,args:{...r,...l,size:s.SIZE}},$={render:Ve,args:{...r,...l,size:s.SIZE}},S={render:e=>o`
  ...
  `},x={render:e=>{const t=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ...
    `},args:{...r,...l,size:s.SIZE,mountDialog:!0,visible:!0}},E={render:Re,args:{...r,size:a[0]}},k={render:je,args:{...r,size:a[0]}},T={render:Ke,args:{...r,size:a[0]}},A={render:qe,args:{...r,size:a[1]}},z={render:Xe,args:{...r,size:a[1]}};var B,W,O;g.parameters={...g.parameters,docs:{...(B=g.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
...
}`,...(ie=(oe=I.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var re,ne,ae;f.parameters={...f.parameters,docs:{...(re=f.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
}`,...(le=(de=D.parameters)==null?void 0:de.docs)==null?void 0:le.source}}};var ce,me,ge;$.parameters={...$.parameters,docs:{...(ce=$.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  ...
  \`
}`,...(be=(ue=S.parameters)==null?void 0:ue.docs)==null?void 0:be.source}}};var he,ve,ye;x.parameters={...x.parameters,docs:{...(he=x.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: (args: Args) => {
    const onClose = () => {
...
}`,...(ye=(ve=x.parameters)==null?void 0:ve.docs)==null?void 0:ye.source}}};var Ie,fe,De;E.parameters={...E.parameters,docs:{...(Ie=E.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  render: renderWithPopover,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(De=(fe=E.parameters)==null?void 0:fe.docs)==null?void 0:De.source}}};var $e,Se,xe;k.parameters={...k.parameters,docs:{...($e=k.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  render: renderDialogWithinDialog,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(xe=(Se=k.parameters)==null?void 0:Se.docs)==null?void 0:xe.source}}};var Ee,ke,Te;T.parameters={...T.parameters,docs:{...(Ee=T.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  render: renderDialogWithIframe,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(Te=(ke=T.parameters)==null?void 0:ke.docs)==null?void 0:Te.source}}};var Ae,ze,Ce;A.parameters={...A.parameters,docs:{...(Ae=A.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
...
}`,...(we=(Pe=z.parameters)==null?void 0:Pe.docs)==null?void 0:we.source}}};const Vt=["Example","WithoutBackdrop","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe","DialogWithList","DialogWithTextarea"];export{T as DialogWithIframe,A as DialogWithList,z as DialogWithTextarea,k as DialogWithinDialog,g as Example,x as MountUnmount,E as WithPopover,p as WithoutBackdrop,S as WithoutTriggerElement,Vt as __namedExportsOrder,Nt as default,y as fullscreen,h as large,b as medium,u as small,$ as withCustomHeader,D as withSaveCancelButtons,I as withoutHeader,f as withoutHeaderOrFooter,v as xlarge};
