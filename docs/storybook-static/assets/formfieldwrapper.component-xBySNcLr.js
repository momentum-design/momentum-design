import{u as x,V as u,q as f,S as y,U as I,h as o,k as a,B as E,E as b,n as t}from"./iframe-rajhHZ71.js";import{t as A}from"./if-defined-K0CnrSqb.js";import{D as v}from"./DisabledMixin-CnlDdMU_.js";import{v as T}from"./v4-CmTdKEVZ.js";const G=x.constructTagName("formfieldwrapper"),n={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},i={VALIDATION:n.DEFAULT,HELPER_TEXT_ID:"helper-text-id",HEADING_ID:"heading-id",ICON_SIZE:20,INFO_ICON:"info-badge-filled",TOGGLETIP_PLACEMENT:"top",TOGGLETIP_STRATEGY:"absolute"},h={TAGNAME:u.SPAN,TYPE:f.BODY_MIDSIZE_REGULAR,HEADER_TYPE:f.BODY_MIDSIZE_BOLD},D=y`
  :host {
