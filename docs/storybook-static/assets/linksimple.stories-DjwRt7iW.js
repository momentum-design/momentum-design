import{L as O,T as _}from"./linksimple.component-psO9eOqd.js";import{k as L}from"./iframe-DJ5UPLED.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CyaRW62x.js";import"./DataAriaLabelMixin-B0ZyC_9E.js";import"./DisabledMixin-CfNlg7hc.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
