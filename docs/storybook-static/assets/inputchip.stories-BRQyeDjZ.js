import{i as O,D as M,k as p}from"./lit-element-D5KKan5q.js";import{u as G,C,n as u}from"./index-C9z9WAEj.js";import{h as w}from"./index-BX3Tn-Br.js";import{D as V}from"./DisabledMixin-CizxPH9K.js";import{I as Y}from"./IconNameMixin-CujGSn0t.js";import{T as W,V as X}from"./text.constants-ZF0jM5wn.js";import"./index-D3DhXfcW.js";import"./index-CKCcJ2Aq.js";import"./index-R1WaGuVM.js";import{a}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as z,s as B}from"./commonArgTypes-BluK8w5L.js";import"./iframe-CnBAXCIA.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./buttonsimple.component-CcsHbiGJ.js";import"./TabIndexMixin-CsrHswKP.js";import"./button.constants-D3lNAbe_.js";import"./button.utils-idYASaaz.js";import"./v4-CQkTLCs1.js";const F=O`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
...
`,R=[w,F],U=G.constructTagName("inputchip"),b={TEXT_TYPE:W.BODY_MIDSIZE_REGULAR,TAG_NAME:X.SPAN,CLOSE_ICON:"cancel-bold"};var j=Object.defineProperty,h=(r,e,c,q)=>{for(var o=void 0,m=r.length-1,f;m>=0;m--)(f=r[m])&&(o=f(e,c,o)||o);return o&&j(e,c,o),o};const g=class g extends Y(V(C)){constructor(){super(...arguments),this.label="",this.error=!1,this.clearAriaLabel=""}renderIcon(){return this.iconName?p`
    <mdc-icon 
      name="${this.iconName}" 
      length-unit="rem" 
      size="1"></mdc-icon>
  `:M}handleClose(e){e.stopPropagation();const c=e.constructor;this.dispatchEvent(new c(e.type,e))}render(){return p`
        ...
        ></mdc-button>
      `}};g.styles=[...C.styles,...R];let l=g;h([u({type:String})],l.prototype,"label");h([u({type:Boolean})],l.prototype,"error");h([u({type:String,attribute:"clear-aria-label"})],l.prototype,"clearAriaLabel");l.register(U);const Z=r=>p`
<mdc-inputchip
  @click="${a("onclick")}"
  @keydown="${a("onkeydown")}"
  @keyup="${a("onkeyup")}"
...
></mdc-inputchip>`,Cr={title:"Work In Progress/chip/input",tags:["autodocs"],component:"mdc-inputchip",render:Z,parameters:{badges:["wip"]},argTypes:{label:{control:"text"},"icon-name":{control:"text"},error:{control:"boolean"},disabled:{control:"boolean"},"clear-aria-label":{control:"text"},...z,...B}},i={args:{label:"Input Chip","clear-aria-label":"Clear",error:!1,disabled:!1}},t={args:{label:"Input Chip","icon-name":"placeholder-bold","clear-aria-label":"Clear",error:!1,disabled:!1}},s={args:{label:"Input Chip","clear-aria-label":"Clear",error:!0,disabled:!1}},n={args:{label:"Input Chip","clear-aria-label":"Clear",error:!1,disabled:!0}},d={render:()=>p`
  <div style="display: flex; gap: 0.5rem;">
    ...
    <mdc-inputchip 
      ...
      @click="${a("click")}"
    ></mdc-inputchip>
  </div>`};var k,y,$;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    label: 'Input Chip',
    'clear-aria-label': 'Clear',
    error: false,
...
}`,...($=(y=i.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};var E,v,I;t.parameters={...t.parameters,docs:{...(E=t.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    label: 'Input Chip',
    'icon-name': 'placeholder-bold',
    'clear-aria-label': 'Clear',
...
}`,...(P=(L=d.parameters)==null?void 0:L.docs)==null?void 0:P.source}}};const kr=["Example","WithIcon","Error","Disabled","StatesAndVariants"];export{n as Disabled,s as Error,i as Example,d as StatesAndVariants,t as WithIcon,kr as __namedExportsOrder,Cr as default};
