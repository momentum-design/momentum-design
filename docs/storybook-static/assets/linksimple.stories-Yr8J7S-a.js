import{L as O,T as _}from"./linksimple.component-YeIQbv1V.js";import{k as L}from"./iframe-DopKAP5L.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DqsAC6OU.js";import"./DataAriaLabelMixin-DMnUhncW.js";import"./DisabledMixin-DZzfc1Nn.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
