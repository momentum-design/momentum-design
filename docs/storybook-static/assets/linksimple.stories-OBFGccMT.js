import{L as O,T as _}from"./linksimple.component-C8SDqHsV.js";import{k as L}from"./iframe-C1wx72SK.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BHGuOObc.js";import"./DataAriaLabelMixin-Dw-lNvo5.js";import"./DisabledMixin-C2MvVlDo.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
