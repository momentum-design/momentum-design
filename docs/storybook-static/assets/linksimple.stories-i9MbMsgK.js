import{L as O,T as _}from"./linksimple.component-C61F0xXv.js";import{k as L}from"./iframe-8tieyzIg.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-PlGgwzOZ.js";import"./DataAriaLabelMixin-C8OIRJOz.js";import"./DisabledMixin-B_AM2ryx.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
