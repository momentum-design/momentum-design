import{L as O,T as _}from"./linksimple.component-BF1KX1gj.js";import{k as L}from"./iframe-DgAYNH_H.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BTodBEDH.js";import"./DataAriaLabelMixin-B234y6ay.js";import"./DisabledMixin-BD5X2mNA.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
