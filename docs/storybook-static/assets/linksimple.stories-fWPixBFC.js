import{L as O,T as _}from"./linksimple.component-LFEyuWUY.js";import{k as L}from"./iframe-CBhtCltk.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-D9uZU33L.js";import"./DataAriaLabelMixin-CEHNes8k.js";import"./DisabledMixin-CwbipW_f.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
