import{L as O,T as _}from"./linksimple.component-BiCyKuTN.js";import{k as L}from"./iframe-5GhuLSNT.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Brvanskx.js";import"./DataAriaLabelMixin-BMsKWw_k.js";import"./DisabledMixin-b5vgUwe2.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
