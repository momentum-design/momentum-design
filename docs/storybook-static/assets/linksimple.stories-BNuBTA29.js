import{L as O,T as _}from"./linksimple.component-bmRcTCnU.js";import{k as L}from"./iframe-Cbrh-sUn.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-C8uxVHlc.js";import"./DataAriaLabelMixin-Bc6AbCT6.js";import"./DisabledMixin-DKrq-z8B.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
