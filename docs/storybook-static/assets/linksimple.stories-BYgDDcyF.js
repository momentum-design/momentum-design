import{L as O,T as _}from"./linksimple.component-xxrChRp4.js";import{k as L}from"./iframe-CwldXf1M.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-DcvmIhko.js";import"./DisabledMixin-CwzXJxHS.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
