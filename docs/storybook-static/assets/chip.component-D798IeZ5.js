import{i as n,D as b,k as i}from"./lit-element-D5KKan5q.js";import{u,C as p,n as h}from"./index-C9z9WAEj.js";import{h as v,a as g}from"./index-CcXofQbA.js";import{I as k}from"./IconNameMixin-CujGSn0t.js";import{a as T}from"./buttonsimple.constants-CGc1uJX6.js";import{T as E,V as f}from"./text.constants-ZF0jM5wn.js";import{B as L}from"./buttonsimple.component-C1CVlJGY.js";const y=n`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,A=[v,y,...g()],M=u.constructTagName("chip"),I={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},r={COLOR:I.DEFAULT,TEXT_TYPE:E.BODY_MIDSIZE_REGULAR,TAG_NAME:f.SPAN,SIZE:T[24],ROLE:"button"};var O=Object.defineProperty,s=(a,t,d,S)=>{for(var o=void 0,e=a.length-1,m;e>=0;e--)(m=a[e])&&(o=m(t,d,o)||o);return o&&O(t,d,o),o};const l=class l extends k(L){constructor(){super(...arguments),this.color=r.COLOR,this.label=""}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?i`
      <mdc-icon 
        name="${this.iconName}" 
        length-unit="rem" 
        size="1"></mdc-icon>
    `:b}render(){return i`
      ...
      `}};l.styles=[...p.styles,...A];let c=l;s([h({type:String,reflect:!0})],c.prototype,"color");s([h({type:String})],c.prototype,"label");export{c as C,M as T,I as a};
