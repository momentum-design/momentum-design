import{L as O,T as _}from"./linksimple.component-Ct7eJND0.js";import{k as L}from"./iframe-BCMIj5Hm.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-laA4nR5u.js";import"./DataAriaLabelMixin-DVWx9CSx.js";import"./DisabledMixin-B4Oykn5Q.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
