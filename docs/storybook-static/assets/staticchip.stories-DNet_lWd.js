import"./index-BfQ36j_Y.js";import{k as l,R as O}from"./iframe-CWZHLpSW.js";import{i as u}from"./manifest-B9CvakwT.js";import{c as L,s as A}from"./commonArgTypes-BG7EqI50.js";import{a as g}from"./utils-B5QUENNQ.js";import{C as c}from"./staticchip.component-BVBTqeAe.js";import"./index-gcvzhn-G.js";import"./preload-helper-C1FmrZbK.js";import"./index-BTHDyICb.js";import"./index-DTrDRi1E.js";import"./IconNameMixin-nWlrx_gZ.js";const $=o=>l` <mdc-staticchip color="${o.color}" label="${o.label}" icon-name="${o["icon-name"]}"></mdc-staticchip>`,I={title:"Components/chip/staticchip",tags:["autodocs"],component:"mdc-staticchip",render:$,argTypes:{color:{control:"select",options:Object.values(c)},label:{control:"text"},"icon-name":{control:"select",options:Object.keys(u)},...L,...A}},e={args:{color:c.DEFAULT,label:"Label"}},r={args:{color:c.DEFAULT,label:"Label","icon-name":"placeholder-bold"}},a={render:()=>l` <div style="display: flex; gap: 0.5rem;" role="${O.MAIN}">
