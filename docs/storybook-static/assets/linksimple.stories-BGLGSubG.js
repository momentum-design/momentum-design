import{L as O,T as _}from"./linksimple.component-SQunwQiC.js";import{k as L}from"./iframe-CAHFTIFZ.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-C24tLpCC.js";import"./DataAriaLabelMixin-CC31jWEx.js";import"./DisabledMixin-ewgcLnDl.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
