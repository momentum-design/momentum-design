import{u as g,a5 as y,a4 as f,aa as x,R as k,k as c,t as I,z as b,T as h,V as A,n as i}from"./iframe-CYZ064vw.js";import{g as S}from"./button.utils-rNW36Ji7.js";import{B as v}from"./buttonsimple.component-DfTyNmtt.js";import{I as N}from"./IconNameMixin-DeWqQ5kO.js";import{a as z}from"./LifeCycleMixin-CkFTW4AQ.js";import"./index-C-a6jsM_.js";const T=g.constructTagName("tab"),u={GLASS:"glass",LINE:"line",PILL:"pill"},p={32:32,28:28},r={VARIANT:u.PILL,ACTIVE:!1,SIZE:p[32]},E=[y,f`
    :host {
  ...
  `,...x()];var _=Object.defineProperty,d=(l,t,o,L)=>{for(var e=void 0,s=l.length-1,m;s>=0;s--)(m=l[s])&&(e=m(t,o,e)||e);return e&&_(t,o,e),e};const n=class n extends N(z(v)){constructor(){super(...arguments),this.active=r.ACTIVE,this.variant=r.VARIANT,this.size=r.SIZE,this.handleTabActiveChange=t=>{const o=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:t},bubbles:!0});this.dispatchEvent(o)}}connectedCallback(){super.connectedCallback(),this.role=k.TAB,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}setVariant(t){this.setAttribute("variant",Object.values(u).includes(t)?t:r.VARIANT)}setSize(t){this.setAttribute("size",Object.values(p).includes(t)?`${t}`:r.SIZE.toString())}getFilledIconName(){return this.iconName?this.iconName.endsWith("-filled")?this.iconName:`${S(this.iconName)}-filled`:void 0}executeAction(){this.handleTabActiveChange(this.active)}update(t){super.update(t),t.has("size")&&this.setSize(this.size),t.has("variant")&&this.setVariant(this.variant)}render(){return c`
    ...
    `}};n.styles=[...v.styles,...E];let a=n;d([i({type:Boolean,reflect:!0})],a.prototype,"active");d([i({type:String,reflect:!0})],a.prototype,"text");d([i({type:String,reflect:!0})],a.prototype,"variant");d([i({type:Number,reflect:!0})],a.prototype,"size");d([i({type:String,reflect:!0,attribute:"tab-id"})],a.prototype,"tabId");a.register(T);export{p as T,u as a,a as b,T as c};
