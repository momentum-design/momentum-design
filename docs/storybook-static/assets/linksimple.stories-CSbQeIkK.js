import{L as O,T as _}from"./linksimple.component-DfHK89mj.js";import{k as L}from"./iframe-9aXjflsK.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Bys9X_mk.js";import"./DataAriaLabelMixin-DY8XA1qn.js";import"./DisabledMixin-DQy_gDXo.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
