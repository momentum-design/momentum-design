...
`,...y(!0)];var E=Object.defineProperty,s=(h,o,r,d)=>{for(var e=void 0,i=h.length-1,a;i>=0;i--)(a=h[i])&&(e=a(o,r,e)||e);return e&&E(o,r,e),e};const l=class l extends x(g(b)){constructor(){super(),this.checked=!1,this.readonly=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?u`<div class="mdc-radio__label-container">
      ${this.renderLabel()}
