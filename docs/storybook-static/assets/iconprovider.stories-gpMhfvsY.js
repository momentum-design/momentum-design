import{C as h,S as v,k as d,n as x,U as g,W as f}from"./iframe-DoNkonBK.js";import{t as y}from"./if-defined-B36DAkUP.js";import{p as C}from"./index-BOEpt90i.js";import{h as $}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";var P=Object.defineProperty,E=(e,t,i,s)=>{for(var n=void 0,o=e.length-1,c;o>=0;o--)(c=e[o])&&(n=c(t,i,n)||n);return n&&P(t,i,n),n};class u extends h{constructor(){super(...arguments),this.iconProviderContext=C.consume({host:this,context:v.Context})}render(){var t,i,s,n,o,c,a;return d`
    ...
    `}}E([x({type:String,attribute:"icon-name"})],u.prototype,"iconName");u.register("mdc-subcomponent-icon");const S=e=>d`
  <mdc-iconprovider
    url=${e.url}
    icon-set=${e["icon-set"]}
...
}`,...(l=(p=r.parameters)==null?void 0:p.docs)==null?void 0:l.source}}};const U=["Example"];export{r as Example,U as __namedExportsOrder,z as default};
