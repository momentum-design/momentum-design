import{L as O,T as _}from"./linksimple.component-utq0zqjj.js";import{k as L}from"./iframe-Bs8uddEG.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CMSkq6NC.js";import"./DataAriaLabelMixin-DEZCOtT5.js";import"./DisabledMixin-CzSD-kW5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
