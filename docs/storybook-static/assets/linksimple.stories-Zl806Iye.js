import{L as O,T as _}from"./linksimple.component-CQ2xjpBV.js";import{k as L}from"./iframe-BKJ51hQM.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-D70R_B9V.js";import"./DataAriaLabelMixin-DXaALHd5.js";import"./DisabledMixin-CnnibooD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
