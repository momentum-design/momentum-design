import{L as O,T as _}from"./linksimple.component-AK3Zodiy.js";import{k as L}from"./iframe-Ce3flZ0s.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-JThcPmUN.js";import"./DataAriaLabelMixin-9aUIRlmB.js";import"./DisabledMixin-Db1GaAks.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
