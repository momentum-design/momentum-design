import{L as O,T as _}from"./linksimple.component-O917qZMR.js";import{k as L}from"./iframe-CjQ7Po3D.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-nrQrlDVv.js";import"./DataAriaLabelMixin-ClVLmbfi.js";import"./DisabledMixin-C9Z8HYNo.js";import"./index-DD4vGOEX.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
