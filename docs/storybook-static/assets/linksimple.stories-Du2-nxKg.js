import{L as O,T as _}from"./linksimple.component-DVEvO12u.js";import{k as L}from"./iframe-BnQbELBG.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BOzP4gKk.js";import"./DataAriaLabelMixin-C1_Akd7G.js";import"./DisabledMixin-D4z0PzfI.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
