import{L as O,T as _}from"./linksimple.component-Cc1SJZ_Y.js";import{k as L}from"./iframe-ojQsro1_.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CVMw9D_D.js";import"./DataAriaLabelMixin-BDsf-JHW.js";import"./DisabledMixin-DFNBhceF.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
