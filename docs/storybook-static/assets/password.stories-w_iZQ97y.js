import"./index-9jv0kyio.js";import"./index-BMN--PIx.js";import{u as M,h as Y,k as w,B as j,n as C,$ as U}from"./iframe-Bmqk5ncS.js";import"./index-BltIwT_C.js";import{I as x}from"./input.component-B6uz-9kz.js";import{I as y}from"./input.constants-BWFnE7gJ.js";import{D as v,V as G}from"./formfieldwrapper.component-DgTSXZHj.js";import{t as s}from"./if-defined-CEMHl27f.js";import{c as K,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as Z,a as J}from"./utils-CFOyPOhY.js";import{P as Q,S as ee}from"./popover.component-CpCRqOFZ.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./button.utils-rNW36Ji7.js";import"./preload-helper-C1FmrZbK.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./index-CvgpI4tf.js";import"./v4-CmTdKEVZ.js";import"./directive-Ctav8iJK.js";import"./index-Cp423qIv.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./FormInternalsMixin-GQemRFrQ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./BackdropMixin-DDe36BUy.js";const $={HIDE_BOLD:"hide-bold",SHOW_BOLD:"show-bold"},te=M.constructTagName("password");var ae=Object.defineProperty,f=(e,o,r,d)=>{for(var t=void 0,a=e.length-1,l;a>=0;a--)(l=e[a])&&(t=l(o,r,t)||t);return t&&ae(o,r,t),t};const g=class g extends x{constructor(){super(...arguments),this.showHideButtonAriaLabel="",this.helpTextType=v.VALIDATION,this.showPassword=!1}connectedCallback(){super.connectedCallback(),this.trailingButton=!0}toggleShowPassword(){this.showPassword=!this.showPassword}renderTrailingButton(o=!1){const r=o||this.value;return r?w`
      <mdc-button
      ...
      ></mdc-button>
    `:Y}renderInputElement(o,r){const d=this.showPassword?y.TEXT:y.PASSWORD;return super.renderInputElement(d,r)}};g.styles=[...x.styles];let i=g;f([C({type:String,attribute:"show-hide-button-aria-label"})],i.prototype,"showHideButtonAriaLabel");f([C({type:String,attribute:"help-text-type"})],i.prototype,"helpTextType");f([U()],i.prototype,"showPassword");i.register(te);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,N=e=>{const o=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return w` <mdc-password
    @input="${n("oninput")}"
    @change="${n("onchange")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
  ...
  ></mdc-password>`},Fe={title:"Components/password",tags:["autodocs"],component:"mdc-password",render:N,args:{name:"password"},argTypes:{id:{control:"text",description:"The unique id of the password field. It is used to link the password field with the label."},placeholder:{control:"text",description:"The placeholder text that is displayed when the password field is empty."},name:{control:"text",description:"The name of the password field. It is used to identify the password field in a form."},"show-hide-button-aria-label":{control:"text"},label:{control:"text",description:"The label of the password field. It is linked to the password field using the for attribute."},"help-text":{control:"text",description:"Helper text for the password"},"help-text-type":{control:"select",options:Object.values(G)},"validation-message":{control:"text",description:"Custom validation message that will override the default message and displayed when the password is invalid."},readonly:{control:"boolean",description:"readonly attribute of the password field. If true, the password field is read-only."},disabled:{control:"boolean"},minlength:{control:"number",description:"The minimum number of characters that the password field can accept."},maxlength:{control:"number",description:"The maximum number of characters that the password field can accept."},"auto-focus-on-mount":{control:"boolean"},dirname:{control:"text"},pattern:{control:"text",description:"The pattern attribute of the password field. Specifies a regular expression that the password value must match for validation purposes."},required:{control:"boolean",description:"The required attribute to indicate that the password field is required. It is used to append a required indicator (*) to the label."},size:{control:"number",description:"The size attribute of the password field. Specifies the width of the password field."},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(Q)},"toggletip-strategy":{control:"select",options:Object.values(ee)},"info-icon-aria-label":{control:"text"},...Z(["--mdc-input-disabled-border-color","--mdc-input-disabled-text-color","--mdc-input-disabled-background-color","--mdc-input-border-color","--mdc-input-text-color","--mdc-input-background-color","--mdc-input-selection-background-color","--mdc-input-selection-text-color","--mdc-input-support-text-color","--mdc-input-hover-background-color","--mdc-input-focused-background-color","--mdc-input-focused-border-color","--mdc-input-error-border-color","--mdc-input-warning-border-color","--mdc-input-success-border-color","--mdc-input-primary-border-color"]),...J(["autocapitalize","clear-aria-label","showPassword","trailing-button","prefix-text","leading-icon"]),...K,...X}},p={args:{class:"custom-classname",label:"Password",name:"password",placeholder:"Placeholder",readonly:!1,disabled:!1,required:!0,"show-hide-button-aria-label":"Show or hide password","validation-message":""}},c={render:e=>w`
      <form @submit=${r=>{r.preventDefault();const d=r.target,a=new FormData(d).get("password");n("Form Submitted")({value:a})}}>
        <fieldset>
    ...
    `},args:{label:"Password",name:"password",placeholder:"Enter your password",required:!0,minlength:5,maxlength:10,"help-text":"Please provide a valid password","help-text-type":"default","show-hide-button-aria-label":"Show or hide password"}},m={args:{label:"Password","help-text":"Enter a strong password","help-text-type":"default",placeholder:"Enter password",value:"default_password123","show-hide-button-aria-label":"Toggle password visibility"}},h={args:{label:"Password","help-text":"Password is too weak","help-text-type":"error",placeholder:"Enter password",value:"error_password123","show-hide-button-aria-label":"Toggle password visibility"}},b={args:{label:"Password","help-text":"Strong password!","help-text-type":"success",placeholder:"Enter password",value:"success_password123","show-hide-button-aria-label":"Toggle password visibility"}};var S,P,E;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
...
}`,...(D=(A=c.parameters)==null?void 0:A.docs)==null?void 0:D.source}}};var _,I,O;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(O=(I=u.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};var q,F,V;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Password',
    'help-text': 'Enter a strong password',
    'help-text-type': 'default',
...
}`,...(V=(F=m.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var L,k,R;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    label: 'Password',
...
}`,...(H=(B=b.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};const Ve=["Example","FormFieldPassword","FormFieldPasswordWithHelpTextValidation","DefaultValidation","ErrorValidation","SuccessValidation"];export{m as DefaultValidation,h as ErrorValidation,p as Example,c as FormFieldPassword,u as FormFieldPasswordWithHelpTextValidation,b as SuccessValidation,Ve as __namedExportsOrder,Fe as default};
