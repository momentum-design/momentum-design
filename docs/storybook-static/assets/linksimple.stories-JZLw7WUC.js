import{L as O,T as _}from"./linksimple.component-DaKhB9Eg.js";import{k as L}from"./iframe-n_pPM-AH.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Ci9G1PLj.js";import"./DataAriaLabelMixin-Dt_BbD17.js";import"./DisabledMixin-CSX0_rm2.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
