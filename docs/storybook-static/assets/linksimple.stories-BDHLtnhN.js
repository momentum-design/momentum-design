import{L as O,T as _}from"./linksimple.component-CL8gEmP7.js";import{k as L}from"./iframe-BWUGX0Bu.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DYeAHZdU.js";import"./DataAriaLabelMixin-B579ZDqQ.js";import"./DisabledMixin-DroOoHnv.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
