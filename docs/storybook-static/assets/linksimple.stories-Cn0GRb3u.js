import{L as O,T as _}from"./linksimple.component-sYJ2eWq8.js";import{k as L}from"./iframe-Bqf88308.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-C0m_AGun.js";import"./DataAriaLabelMixin-Dcj_NjFP.js";import"./DisabledMixin-BwGISW2n.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
