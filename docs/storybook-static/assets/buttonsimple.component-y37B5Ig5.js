import{n as r,a5 as p,a4 as m,aa as y,D as c,c as b,k as v,C as f}from"./iframe-BDHu_yvJ.js";import{D as g}from"./DisabledMixin-DBitIXox.js";import{K as E,a as A,T as S,A as d}from"./KeyDownHandledMixin-lfim3BWe.js";var x=Object.defineProperty,T=(a,t,e,h)=>{for(var s=void 0,n=a.length-1,u;n>=0;n--)(u=a[n])&&(s=u(t,e,s)||s);return s&&x(t,e,s),s};const z=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(h){super.firstUpdated(h),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return T([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},K=[p,m`
    :host {
