import{L as O,T as _}from"./linksimple.component-DxXN88yX.js";import{k as L}from"./iframe-poZqDqjY.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Bk6xV7nx.js";import"./DataAriaLabelMixin-DwBGuTyS.js";import"./DisabledMixin-CHAoifzE.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
