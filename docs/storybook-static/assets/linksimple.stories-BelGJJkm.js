import{L as O,T as _}from"./linksimple.component-D5R19Zap.js";import{k as L}from"./iframe-DBnofx6S.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DIWQzTrD.js";import"./DataAriaLabelMixin-CGD-VR2L.js";import"./DisabledMixin-Badnsvf5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
