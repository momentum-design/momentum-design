import{L as O,T as _}from"./linksimple.component-D_0oosHi.js";import{k as L}from"./iframe-CaqXL4mA.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CmgCdheS.js";import"./DataAriaLabelMixin-DyYO3D42.js";import"./DisabledMixin-Dps9fnDj.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
