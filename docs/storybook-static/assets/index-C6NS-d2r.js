import"./index-D8NVkVuJ.js";import"./index-DiXljgf2.js";import{T as b}from"./index-9Xd0qcv5.js";import{S as u,X as f,h as k,k as h,n as r}from"./iframe-CZp7GZ56.js";import"./index-C58vfr5L.js";import{t as a}from"./if-defined-lk-75_Ux.js";import{K as m}from"./keys-hFXe221I.js";import{A as v}from"./buttonsimple.component-C_yE73pe.js";import{D as x}from"./DataAriaLabelMixin-igi6CYL9.js";import{F as y}from"./FormInternalsMixin-Bxt6RlE0.js";import{D as g,F as p}from"./formfieldwrapper.component-BzqVINj4.js";const $=[u`
  ...
  `,...f(!0)];var E=Object.defineProperty,c=(l,e,t,D)=>{for(var o=void 0,s=l.length-1,n;s>=0;s--)(n=l[s])&&(o=n(e,t,o)||o);return o&&E(e,t,o),o};const d=class d extends v(y(x(p))){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?h`<div part="text-container">${this.renderLabel()} ${this.renderHelperText()}</div>`:k}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}firstUpdated(e){this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(e)}setFormValue(){let e=null;this.checked?e=this.value?this.value:"on":e=null,this.manageRequired(),this.internals.setFormValue(e)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.checked=!1,this.indeterminate=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}toggleState(){!this.disabled&&!this.softDisabled&&!this.readonly&&(this.checked=!this.checked,this.indeterminate=!1)}handleKeyDown(e){var t;(this.readonly||this.softDisabled)&&e.key===m.SPACE&&e.preventDefault(),e.key===m.ENTER&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}update(e){super.update(e),e.has("checked")&&this.setFormValue()}render(){return h`
      <mdc-staticcheckbox
    ...
    `}};d.styles=[...p.styles,...$];let i=d;c([r({type:Boolean,reflect:!0})],i.prototype,"checked");c([r({type:Boolean,reflect:!0})],i.prototype,"indeterminate");c([r({type:Boolean,reflect:!0})],i.prototype,"autofocus");i.register(b);
