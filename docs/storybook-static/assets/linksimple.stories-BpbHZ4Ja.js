import{L as O,T as _}from"./linksimple.component-Bq10n5WY.js";import{k as L}from"./iframe-DlYFcFkv.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Ck0VLQTE.js";import"./DataAriaLabelMixin-BzMN2hf5.js";import"./DisabledMixin-CDRkWdxM.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
