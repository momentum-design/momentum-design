import{i as h,D as u,k as p}from"./lit-element-D5KKan5q.js";import{u as x,C as g,n as l}from"./index-C9z9WAEj.js";import{o as b}from"./query-assigned-elements-uEuc3rg8.js";import{D as y}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{D as v}from"./DisabledMixin-BZruwOeC.js";import{T as f}from"./TabIndexMixin-CsrHswKP.js";import{V as T,T as o}from"./text.constants-ZF0jM5wn.js";import{h as L}from"./index-MA1r3zrt.js";const U=x.constructTagName("listitem"),S={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},A={VARIANT:S.FULL_WIDTH},_=h`
  :host {
...
`,k=[_,...L()];var E=Object.defineProperty,r=(c,t,i,s)=>{for(var a=void 0,d=c.length-1,m;d>=0;d--)(m=c[d])&&(a=m(t,i,a)||a);return a&&E(t,i,a),a};const n=class n extends y(v(f(g))){constructor(){super(...arguments),this.variant=A.VARIANT}connectedCallback(){super.connectedCallback(),this.role=this.role||"listitem"}getText(t,i,s){return s?p`
      <slot name="${t}">
        <mdc-text part="${t}" type="${i}" tagname="${T.SPAN}">${s}</mdc-text>
      </slot>
    `:u}disableSlottedChildren(t){[...this.leadingControlsSlot,...this.trailingControlsSlot].forEach(i=>{t?i.setAttribute("disabled",""):i.removeAttribute("disabled")})}update(t){super.update(t),t.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.disableSlottedChildren(this.disabled))}render(){return p`
      <div part="leading">
    ...
    `}};n.styles=[...g.styles,...k];let e=n;r([b({slot:"leading-controls"})],e.prototype,"leadingControlsSlot");r([b({slot:"trailing-controls"})],e.prototype,"trailingControlsSlot");r([l({type:String,reflect:!0})],e.prototype,"variant");r([l({type:String,reflect:!0})],e.prototype,"label");r([l({type:String,reflect:!0,attribute:"secondary-label"})],e.prototype,"secondaryLabel");r([l({type:String,reflect:!0,attribute:"tertiary-label"})],e.prototype,"tertiaryLabel");r([l({type:String,reflect:!0,attribute:"side-header-text"})],e.prototype,"sideHeaderText");r([l({type:String,reflect:!0,attribute:"subline-text"})],e.prototype,"sublineText");export{S as L,U as T,e as a};
