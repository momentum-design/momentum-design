import{L as O,T as _}from"./linksimple.component-eQFCtYww.js";import{k as L}from"./iframe-5RFEiZ85.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-C_QIaKNN.js";import"./DataAriaLabelMixin-CR2z_L0N.js";import"./DisabledMixin-BzeozoI6.js";import"./index-BldB1hzz.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
