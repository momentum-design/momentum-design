import{L as O,T as _}from"./linksimple.component-CugL-NHA.js";import{k as L}from"./iframe-BXXRt26c.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DZNWkkOE.js";import"./DataAriaLabelMixin-4XZGIabN.js";import"./DisabledMixin-DmQBdKn0.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
