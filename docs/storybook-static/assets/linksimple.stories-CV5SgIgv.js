import{L as O,T as _}from"./linksimple.component-Cun-PqXK.js";import{k as L}from"./iframe-K3793TQ_.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-D-9eRdag.js";import"./DataAriaLabelMixin-CYmi6L3f.js";import"./DisabledMixin-BC25uM5G.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
