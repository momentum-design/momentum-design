import{L as O,T as _}from"./linksimple.component-BtrnGdjg.js";import{k as L}from"./iframe-CeDQ4RI4.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Cl8xk6N7.js";import"./DataAriaLabelMixin-BI4bZWqY.js";import"./DisabledMixin-DHC8T_R7.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
