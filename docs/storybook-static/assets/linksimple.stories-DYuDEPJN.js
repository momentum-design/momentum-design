import{L as O,T as _}from"./linksimple.component-BP8ZZzU6.js";import{k as L}from"./iframe-D5qwq8cl.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-4A7j5SiP.js";import"./DisabledMixin-D03aknaA.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
