import{i as j,k as R}from"./lit-element-CPYlYYac.js";import{R as E}from"./class-map-CXre9d5K.js";import{u as F,C as A,n as l}from"./index-BLShQaRP.js";import{t as q}from"./if-defined-4GS2c12S.js";import{F as H,V as Z}from"./index-DUhjq5I_.js";import{h as z}from"./index-yOpQnEvF.js";import"./index-DkGCxfPr.js";import{c as J,s as K}from"./commonArgTypes-BluK8w5L.js";import"./state-I_twzcUk.js";import"./index-BGH6lGYG.js";import"./iconprovider.component-DlI5gUhJ.js";import"./create-context-89xeped_.js";const Q=F.constructTagName("badge"),e={DOT:"dot",ICON:"icon",COUNTER:"counter",SUCCESS:"success",WARNING:"warning",ERROR:"error"},I={SUCCESS_ICON_NAME:"check-circle-filled",WARNING_ICON_NAME:"warning-filled",ERROR_ICON_NAME:"error-legacy-filled"},m={PRIMARY:"primary",SECONDARY:"secondary"},u={SUCCESS:"success",WARNING:"warning",ERROR:"error"},t={TYPE:e.DOT,LENGTH_UNIT:"rem",MAX_COUNTER:99,MAX_COUNTER_LIMIT:999,VARIANT:m.PRIMARY,ICON_SIZE:1},rr=[z,j`
  ...
  `];var er=Object.defineProperty,i=(c,r,o,s)=>{for(var a=void 0,d=c.length-1,g;d>=0;d--)(g=c[d])&&(a=g(r,o,a)||a);return a&&er(r,o,a),a};const _=class _ extends A{constructor(){super(...arguments),this.variant=t.VARIANT,this.maxCounter=t.MAX_COUNTER,this.overlay=!1,this.ariaLabel=null}getCounterText(r,o){return o===void 0||typeof o!="number"||r===0?"":o>r?`${r}+`:r>t.MAX_COUNTER_LIMIT||o>t.MAX_COUNTER_LIMIT?`${t.MAX_COUNTER_LIMIT}+`:o.toString()}getBadgeIcon(r,o,s,a){return R`
    ...
    `}setRoleByAriaLabel(){this.ariaLabel?this.role="img":this.role=null}getBadgeContentBasedOnType(){this.variant&&!Object.values(m).includes(this.variant)&&(this.variant=m.PRIMARY);const{counter:r,iconName:o,maxCounter:s,overlay:a,type:d,variant:g}=this;switch(d){case e.ICON:return this.getBadgeIcon(o||"",a,g,d);case e.COUNTER:return this.getBadgeCounterText(s,a,r);case e.SUCCESS:return this.getBadgeIcon(I.SUCCESS_ICON_NAME,a,u.SUCCESS);case e.WARNING:return this.getBadgeIcon(I.WARNING_ICON_NAME,a,u.WARNING);case e.ERROR:return this.getBadgeIcon(I.ERROR_ICON_NAME,a,u.ERROR);case e.DOT:default:return this.type=e.DOT,this.getBadgeDot(a)}}update(r){super.update(r),r.has("ariaLabel")&&this.setRoleByAriaLabel()}render(){return this.getBadgeContentBasedOnType()}};_.styles=[...A.styles,...rr];let n=_;i([l({type:String,reflect:!0})],n.prototype,"type");i([l({type:String,attribute:"icon-name"})],n.prototype,"iconName");i([l({type:String,reflect:!0})],n.prototype,"variant");i([l({type:Number})],n.prototype,"counter");i([l({type:Number,attribute:"max-counter",reflect:!0})],n.prototype,"maxCounter");i([l({type:Boolean})],n.prototype,"overlay");i([l({type:String,attribute:"aria-label"})],n.prototype,"ariaLabel");n.register(Q);const C=[9,99,999],or=c=>R`
  <mdc-badge
    type="${c.type}"
  ...
  ></mdc-badge>
`,br={title:"Work In Progress/badge",tags:["autodocs"],component:"mdc-badge",render:or,parameters:{badges:["wip"]},argTypes:{type:{control:"select",options:Object.values(e)},overlay:{control:"boolean"},counter:{if:{arg:"type",eq:e.COUNTER},control:"number"},"max-counter":{if:{arg:"type",eq:e.COUNTER},control:"select",options:C},"icon-name":{if:{arg:"type",eq:e.ICON},control:"text"},variant:{if:{arg:"type",eq:e.ICON},control:"select",options:Object.values(m),table:{defaultValue:{summary:t.VARIANT}}},"aria-label":{control:"text"},...J,...K}},p={args:{type:t.TYPE,"icon-name":"error-legacy-filled",variant:t.VARIANT,counter:1,"max-counter":C[1],overlay:!1}},b={args:{type:e.ICON,"icon-name":"accessibility-regular",variant:m.PRIMARY,overlay:!1}},y={args:{type:e.COUNTER,counter:10,"max-counter":C[1],overlay:!1}},N={args:{type:e.SUCCESS,overlay:!1}},v={args:{type:e.WARNING,overlay:!1}},T={args:{type:e.ERROR,overlay:!1}};var f,O,S;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
...
}`,...($=(B=N.parameters)==null?void 0:B.docs)==null?void 0:$.source}}};var G,P,Y;v.parameters={...v.parameters,docs:{...(G=v.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
