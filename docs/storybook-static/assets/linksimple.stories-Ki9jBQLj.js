import{L as O,T as _}from"./linksimple.component-Bm4Rk7Z-.js";import{k as L}from"./iframe-Bmqk5ncS.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-CEMHl27f.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./DisabledMixin-CJC0_YR8.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
...
}`,...(I=(T=l.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};const K=["Example","StandaloneLink","StandaloneLinkInverted","InlineLink","InlineLinkInverted"];export{o as Example,a as InlineLink,l as InlineLinkInverted,t as StandaloneLink,i as StandaloneLinkInverted,K as __namedExportsOrder,G as default};
