import{L as O,T as _}from"./linksimple.component-9FbFPuFp.js";import{k as L}from"./iframe-j9ayNzzO.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DtMHkK-C.js";import"./DataAriaLabelMixin-D24x2P4h.js";import"./DisabledMixin-DtX-h40v.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
