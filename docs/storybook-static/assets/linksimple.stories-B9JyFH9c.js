import{L as O,T as _}from"./linksimple.component-CQH0_ONJ.js";import{k as L}from"./iframe-Bf6-IwAq.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DdJfs53F.js";import"./DataAriaLabelMixin-nR37qCN2.js";import"./DisabledMixin-VQPUxNBU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
