import{L as O,T as _}from"./linksimple.component-QNDd3Y_-.js";import{k as L}from"./iframe-q5YgjDld.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CcLsQsCq.js";import"./DataAriaLabelMixin-F_qF3igS.js";import"./DisabledMixin-fbiLTt1z.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
