import{L as O,T as _}from"./linksimple.component-KUjFPax9.js";import{k as L}from"./iframe-C0RekVwL.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CyiP2Wt1.js";import"./DataAriaLabelMixin-DVCstGLW.js";import"./DisabledMixin-Cb-9pm1f.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
