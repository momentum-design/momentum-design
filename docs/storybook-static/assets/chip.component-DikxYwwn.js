import{i as s,D as b,k as i}from"./lit-element-D5KKan5q.js";import{u,C as v,n as h}from"./index-C9z9WAEj.js";import{a as p,h as g}from"./index-MA1r3zrt.js";import{I as k}from"./IconNameMixin-CujGSn0t.js";import{a as T}from"./buttonsimple.constants-CGc1uJX6.js";import{T as E,V as f}from"./text.constants-ZF0jM5wn.js";import{B as A}from"./buttonsimple.component-UuTVCePh.js";const L=s`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,y=[p,L,...g()],G=u.constructTagName("chip"),O={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},r={COLOR:O.DEFAULT,TEXT_TYPE:E.BODY_MIDSIZE_REGULAR,TAG_NAME:f.SPAN,SIZE:T[24],ROLE:"button"};var I=Object.defineProperty,n=(a,t,d,S)=>{for(var o=void 0,e=a.length-1,m;e>=0;e--)(m=a[e])&&(o=m(t,d,o)||o);return o&&I(t,d,o),o};const l=class l extends k(A){constructor(){super(...arguments),this.color=r.COLOR,this.label=""}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?i`
      <mdc-icon 
        name="${this.iconName}" 
        length-unit="rem" 
        size="1"></mdc-icon>
    `:b}render(){return i`
      ...
      `}};l.styles=[...v.styles,...y];let c=l;n([h({type:String,reflect:!0})],c.prototype,"color");n([h({type:String})],c.prototype,"label");export{c as C,G as T,O as a};
