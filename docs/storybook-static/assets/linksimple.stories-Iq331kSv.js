import{L as O,T as _}from"./linksimple.component-CnPHkoKi.js";import{k as L}from"./iframe-C4SnPZjK.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CZ4_WdhT.js";import"./DataAriaLabelMixin-C8a8VDBW.js";import"./DisabledMixin-Bn91i_Uu.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
