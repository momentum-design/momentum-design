import{L as O,T as _}from"./linksimple.component-Te6CcN-H.js";import{k as L}from"./iframe-DHOQtyml.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DClzWNv2.js";import"./DataAriaLabelMixin-B6s508Zp.js";import"./DisabledMixin-DvdaRsAD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
