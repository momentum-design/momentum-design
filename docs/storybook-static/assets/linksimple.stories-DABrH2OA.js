import{L as O,T as _}from"./linksimple.component-C7qkiVF_.js";import{k as L}from"./iframe-lqtK641B.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B9Bf-iG8.js";import"./DataAriaLabelMixin-BhR_JgjZ.js";import"./DisabledMixin-X-8L2ccJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
