import{L as O,T as _}from"./linksimple.component-C37yG4SS.js";import{k as L}from"./iframe-BCanoCRe.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BKKfBTgX.js";import"./DataAriaLabelMixin-BX3YsaxT.js";import"./DisabledMixin-BApzXNWy.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
