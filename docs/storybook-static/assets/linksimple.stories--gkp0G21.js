import{L as O,T as _}from"./linksimple.component-CIhiu3yS.js";import{k as L}from"./iframe-TwM3RJg9.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-i7u2DWOz.js";import"./DataAriaLabelMixin-QFGS1hIH.js";import"./DisabledMixin-AWCBmPqx.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
