import{u as p,U as g,S as y,X as f,W as x,k as s,g as b,q as v,V as k,n as r}from"./iframe-C_acqUys.js";import{g as I}from"./button.utils-rNW36Ji7.js";import{B as h}from"./buttonsimple.component-GKQH0xTW.js";import{I as A}from"./IconNameMixin-DsVkfwyA.js";import"./index-QTNPF7LG.js";const N=p.constructTagName("tab"),u={GLASS:"glass",LINE:"line",PILL:"pill"},c={VARIANT:u.PILL,ACTIVE:!1},S=[g,y`
    :host {
  ...
  `,...f()];var T=Object.defineProperty,i=(l,t,a,E)=>{for(var e=void 0,d=l.length-1,m;d>=0;d--)(m=l[d])&&(e=m(t,a,e)||e);return e&&T(t,a,e),e};const n=class n extends A(h){constructor(){super(...arguments),this.active=c.ACTIVE,this.variant=c.VARIANT,this.handleTabActiveChange=t=>{const a=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:t},bubbles:!0});this.dispatchEvent(a)}}connectedCallback(){super.connectedCallback(),this.role=x.TAB,this.size=void 0,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}modifyIconName(t){this.iconName&&(t?(this.prevIconName=this.iconName,this.iconName=`${I(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(t){this.setAttribute("variant",Object.values(u).includes(t)?t:c.VARIANT)}setActive(t,a){super.setActive(t,a),this.modifyIconName(a)}executeAction(){this.handleTabActiveChange(this.active)}update(t){super.update(t),t.has("variant")&&this.setVariant(this.variant)}render(){return s`
    ...
    `}};n.styles=[...h.styles,...S];let o=n;i([r({type:Boolean,reflect:!0})],o.prototype,"active");i([r({type:String,reflect:!0})],o.prototype,"text");i([r({type:String,reflect:!0})],o.prototype,"variant");i([r({type:String,reflect:!0,attribute:"tab-id"})],o.prototype,"tabId");o.register(N);export{u as T,o as a};
