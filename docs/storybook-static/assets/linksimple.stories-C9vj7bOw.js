import{L as O,T as _}from"./linksimple.component-138GGNN2.js";import{k as L}from"./iframe-BfLztatZ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-D9kF3aOg.js";import"./DataAriaLabelMixin-CrrpWauq.js";import"./DisabledMixin-nYMYrGUf.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
