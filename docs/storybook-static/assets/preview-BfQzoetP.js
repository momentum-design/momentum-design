 ...
 *
 * @slot - children
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"IconProvider",module:"components/iconprovider/iconprovider.component.js"}}]},{kind:"javascript-module",path:"components/labelandhelper/labelandhelper.component.js",declarations:[{kind:"class",description:`labelandhelper is a component that contains the label and helper/validation text
 that can be configured in various ways to suit different use cases (most of the input related components).
It is used as an internal component and is not intended to be used directly by consumers.`,name:"LabelAndHelper",members:[{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0},{kind:"field",name:"id",default:"`mdc-input-${uuidv4()}`",description:"The unique id of the input field. It is used to link the input field with the label.",attribute:"id"},{kind:"field",name:"helpTextType",type:{text:"ValidationType"},description:"The type of help text. It can be 'default', 'error', 'warning', 'success', 'priority'.",attribute:"help-text-type",reflects:!0},{kind:"field",name:"helpText",type:{text:"string | undefined"},description:"The help text that is displayed below the input field.",attribute:"help-text",reflects:!0},{kind:"field",name:"labelInfoText",type:{text:"string | undefined"},attribute:"label-info-text"},{kind:"method",name:"renderLabelElement",privacy:"protected",description:`creates the label element when the label property is set.
id is used to link the label with the input field.`,return:{type:{text:""}}},{kind:"method",name:"renderLabelInfoToggleTip",privacy:"protected",description:`displays a info icon, which when hovered over, displays the labelInfoText.
This is in beta and is subject to change once the toggletip component is ready.`,return:{type:{text:""}}},{kind:"method",name:"renderHelpTextIcon",privacy:"protected",description:`creates the helpertext icon based on the helpTextType for validation.
