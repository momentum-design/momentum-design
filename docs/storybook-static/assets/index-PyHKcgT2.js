import"./index-Y5IzVPwc.js";import"./index-BV0k_Sbu.js";import{T as u}from"./index-D4kcgFoY.js";import"./index-BrLJ_9IK.js";import"./index-BXAhUFPM.js";import{i as p,D as b,k as l}from"./lit-element-D5KKan5q.js";import{n as a}from"./index-C9z9WAEj.js";import{t as r}from"./if-defined-D5BV9-c0.js";import{D as k}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as f}from"./FormInternalsMixin-CqDKsEWP.js";import{D as v,F as m}from"./formfieldwrapper.component-D6q8AeiS.js";import{a as x}from"./index-B-GnYs90.js";const g=[p`
    :host {
  ...
  `,...x(!0)];var y=Object.defineProperty,s=(n,e,t,$)=>{for(var i=void 0,o=n.length-1,h;o>=0;o--)(h=n[o])&&(i=h(e,t,i)||i);return i&&y(e,t,i),i};const d=class d extends f(k(m)){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?l`<div class="text-container">${this.renderLabel()} ${this.renderHelperText()}</div>`:b}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}setFormValue(){let e=null;this.checked?e=this.value?this.value:"on":e=null,this.manageRequired(),this.internals.setFormValue(e)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.checked=!1,this.indeterminate=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}toggleState(){this.disabled||(this.checked=!this.checked,this.indeterminate=!1)}handleKeyDown(e){var t;e.key==="Enter"&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}update(e){super.update(e),e.has("checked")&&this.setFormValue()}render(){return l`
      ...
      >
        <input
          ...
          aria-describedby="${r(this.helpText?v.HELPER_TEXT_ID:"")}"
