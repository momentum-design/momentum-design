import{aa as P,S as V,u as W,G as y,k as h,W as H,n as D,$ as O,h as q}from"./iframe-Bmqk5ncS.js";import{e as L}from"./query-DXShiZ7f.js";import{o as K}from"./query-assigned-elements-uEuc3rg8.js";import{t as z}from"./if-defined-CEMHl27f.js";import{a as d,T as G}from"./index-SwjAfTIZ.js";import{B as U}from"./button.component-DOKkPvZM.js";import"./index-9jv0kyio.js";import{d as j,t as Y}from"./utils-CFOyPOhY.js";import"./index-B6-svA1Y.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./button.utils-rNW36Ji7.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./IconNameMixin-BxH3CgDw.js";import"./index-BMN--PIx.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./badge.constants-Dzi09ZT-.js";const J=[P,V`
    :host {
...
This markup is not part of the component and is only provided for context. -->
    ...
    <!-- End of example markup for the tab panels -->`,Ct={title:"Components/tablist",tags:["autodocs"],component:"mdc-tablist",render:nt,argTypes:{"active-tab-id":{control:"text"},"data-aria-label":{control:"text"},tabvariant:{control:"select",description:"Set the variant of tab inside the tablist",options:Object.values(G)},...j(["Default"]),...Y(["--mdc-tablist-gap","--mdc-tablist-width","--mdc-tablist-arrow-button-margin"])}},m={args:{tabvariant:"line"}},u={args:{tabvariant:"glass","active-tab-id":"documents-tab","data-aria-label":"Media types"}},v={render:e=>h` <mdc-tablist
...
}`,...(k=($=u.parameters)==null?void 0:$.docs)==null?void 0:k.source}}};var F,S,M;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
...
}`,...(M=(S=v.parameters)==null?void 0:S.docs)==null?void 0:M.source}}};const Rt=["Example","ActiveTabAttributeSet","TablistWithPanels"];export{u as ActiveTabAttributeSet,m as Example,v as TablistWithPanels,Rt as __namedExportsOrder,Ct as default};
