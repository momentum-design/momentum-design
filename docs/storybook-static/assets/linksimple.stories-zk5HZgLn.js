import{L as O,T as _}from"./linksimple.component-CC5CaJmy.js";import{k as L}from"./iframe-RgXKid-6.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-s8sYxEiT.js";import"./DataAriaLabelMixin-6BwteFsj.js";import"./DisabledMixin-pDeD_hZP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
