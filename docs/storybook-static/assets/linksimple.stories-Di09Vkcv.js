import{L as O,T as _}from"./linksimple.component-BxHSaBNL.js";import{k as L}from"./iframe-C75P9SA2.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CZ8A3pCa.js";import"./DataAriaLabelMixin-COnrBi_l.js";import"./DisabledMixin-BOa0uV5G.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
