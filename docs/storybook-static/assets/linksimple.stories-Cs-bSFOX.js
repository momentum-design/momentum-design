import{L as O,T as _}from"./linksimple.component-DqBZtV1i.js";import{k as L}from"./iframe-BgXhOCYx.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-mvpmADf_.js";import"./DataAriaLabelMixin-A4QadQyW.js";import"./DisabledMixin-BDXdUxg1.js";import"./index-uHxtwAkA.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
