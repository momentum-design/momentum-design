import{k as o}from"./iframe-Bmqk5ncS.js";import"./index-CXK2KkIO.js";import{c as de,s as se}from"./commonArgTypes-BluK8w5L.js";import{a as re,t as me,h as r,d as pe}from"./utils-CFOyPOhY.js";import{V as k}from"./formfieldwrapper.component-DgTSXZHj.js";import"./index-TqcEfO5W.js";import"./index-C2EDQdkM.js";import"./index-CZK9p1cf.js";import{P as ue,S as be}from"./popover.component-CpCRqOFZ.js";import"./preload-helper-C1FmrZbK.js";import"./index-9jv0kyio.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./button.utils-rNW36Ji7.js";import"./index-BMN--PIx.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./index-B8kEZnhl.js";import"./index-BltIwT_C.js";import"./if-defined-CEMHl27f.js";import"./index-CvgpI4tf.js";import"./v4-CmTdKEVZ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./CaptureDestroyEventForChildElement-Bb4b8sZC.js";import"./listitem.component-DLCTQFGX.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./FormInternalsMixin-GQemRFrQ.js";import"./ListNavigationMixin-DgCStHq0.js";import"./BackdropMixin-DDe36BUy.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,L=Object.values(k).filter(e=>e!=="priority"),$=e=>o`
...
`,w=e=>$(o`
  ...
  `,...r()},g={render:()=>o`
    ...
    `,...r()},y={render:e=>{const d=(c,n)=>{const a=c.querySelector('mdc-select[name="avengers-name"]'),i=c.querySelector('mdc-select[name="stone-count"]'),m=a.value,q=i.value;let O=!0;return n.required&&(!m||m==="")?(a.setAttribute("help-text","Please select your favorite Avenger"),a.setAttribute("help-text-type","error"),O=!1):(a.setAttribute("help-text","Looks good!"),a.setAttribute("help-text-type","success")),n.required&&(!q||q==="")?(i.setAttribute("help-text","Please select the Infinity Stone count"),i.setAttribute("help-text-type","error"),O=!1):(i.setAttribute("help-text","Looks good!"),i.setAttribute("help-text-type","success")),O};return o`
    ...
    `},args:{required:!0,"help-text":"","help-text-type":"default"},...r()},S={render:()=>{const e=Array.from({length:10},(t,s)=>o`<mdc-option label="Option ${s+1}"></mdc-option>`);let d=null;return setTimeout(()=>{d=o`<mdc-option label="Delayed Option"></mdc-option>`;const t=document.querySelector('mdc-select[label="Select option"] mdc-selectlistbox');if(t){const s=document.createElement("mdc-option");s.setAttribute("label","Delayed Option"),t.appendChild(s)}},2e3),$(o`
      <mdc-select placeholder="Select an option" label="Select option">
        <mdc-selectlistbox> ${e} ${d} </mdc-selectlistbox>
      </mdc-select>
    `)},argTypes:{...pe(["readonly","name","data-aria-label","disabled","required","help-text-type","help-text"])},...r()},f={render:()=>$(o`
