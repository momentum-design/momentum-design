import{L as O,T as _}from"./linksimple.component-C70mrLv_.js";import{k as L}from"./iframe-CKcPYDX0.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-9V2JNne-.js";import"./DataAriaLabelMixin-DfO0a9Je.js";import"./DisabledMixin-rQYJ1hZD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
