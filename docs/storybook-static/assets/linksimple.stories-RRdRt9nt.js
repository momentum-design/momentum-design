import{L as O,T as _}from"./linksimple.component-Bl5CwU9Y.js";import{k as L}from"./iframe-DDdyYKcM.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BbSBl4wr.js";import"./DataAriaLabelMixin-B3sLV5oj.js";import"./DisabledMixin-xgzT86Kg.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
