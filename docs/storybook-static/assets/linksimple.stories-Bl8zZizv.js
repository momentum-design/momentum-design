import{L as O,T as _}from"./linksimple.component-CLoWQxrF.js";import{k as L}from"./iframe-CbA3RTA5.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DQqZroQk.js";import"./DataAriaLabelMixin-Fqf2DCZG.js";import"./DisabledMixin-CskIXyhy.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
