import{L as O,T as _}from"./linksimple.component-B8G33e4v.js";import{k as L}from"./iframe-DpdbTchC.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-C59PxhCj.js";import"./DataAriaLabelMixin-DyzknH4g.js";import"./DisabledMixin-CrZP289j.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
