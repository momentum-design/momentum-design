import{L as O,T as _}from"./linksimple.component-DRipvKtB.js";import{k as L}from"./iframe-WcBvx9Gg.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CyyiHE6v.js";import"./DataAriaLabelMixin-DJNMyOaP.js";import"./DisabledMixin--b7yAl55.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
