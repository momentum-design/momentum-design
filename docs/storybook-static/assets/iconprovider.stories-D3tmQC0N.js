import{C as h,U as v,k as l,n as x,W as g,X as f}from"./iframe-D0yPktIr.js";import{t as y}from"./if-defined-BQWKbkiE.js";import{p as C}from"./index-BHN0bjuT.js";import{h as P}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";var $=Object.defineProperty,E=(e,t,i,s)=>{for(var n=void 0,o=e.length-1,c;o>=0;o--)(c=e[o])&&(n=c(t,i,n)||n);return n&&$(t,i,n),n};class u extends h{constructor(){super(...arguments),this.iconProviderContext=C.consume({host:this,context:v.Context})}render(){var t,i,s,n,o,c,a;return l`
    ...
    `}}E([x({type:String,attribute:"icon-name"})],u.prototype,"iconName");u.register("mdc-subcomponent-icon");const b=e=>l`
  <mdc-iconprovider
    url=${e.url}
    icon-set=${e["icon-set"]}
