import{i as g,k as t}from"./lit-element-D5KKan5q.js";import{C as p,n as h}from"./index-C9z9WAEj.js";import{D as e,V as a,a as u}from"./text.constants-ZF0jM5wn.js";const v=g`
  :host::part(text) {
    font-size: unset;
    font-weight: unset;
    line-height: unset;
...
`,x=[g`
  ...
  `,v];var b=Object.defineProperty,f=(d,r,l,y)=>{for(var o=void 0,n=d.length-1,m;n>=0;n--)(m=d[n])&&(o=m(r,l,o)||o);return o&&b(r,l,o),o};const i=class i extends p{constructor(){super(...arguments),this.type=e.TYPE,this.tagname=e.TEXT_ELEMENT_TAGNAME}render(){switch(this.tagname){case a.H1:return t`<h1 part=${e.CSS_PART_TEXT}><slot></slot></h1>`;case a.H2:return t`<h2 part=${e.CSS_PART_TEXT}><slot></slot></h2>`;case a.H3:return t`<h3 part=${e.CSS_PART_TEXT}><slot></slot></h3>`;case a.H4:return t`<h4 part=${e.CSS_PART_TEXT}><slot></slot></h4>`;case a.H5:return t`<h5 part=${e.CSS_PART_TEXT}><slot></slot></h5>`;case a.H6:return t`<h6 part=${e.CSS_PART_TEXT}><slot></slot></h6>`;case a.DIV:return t`<div part=${e.CSS_PART_TEXT}><slot></slot></div>`;case a.SPAN:return t`<span part=${e.CSS_PART_TEXT}><slot></slot></span>`;case a.SMALL:return t`<small part=${e.CSS_PART_TEXT}><slot></slot></small>`;case a.P:default:return t`<p part=${e.CSS_PART_TEXT}><slot></slot></p>`}}};i.styles=[...p.styles,...x];let s=i;f([h({attribute:"type",reflect:!0,type:String})],s.prototype,"type");f([h({attribute:"tagname",reflect:!0,type:String})],s.prototype,"tagname");s.register(u);
