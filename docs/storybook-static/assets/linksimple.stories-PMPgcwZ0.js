import{L as O,T as _}from"./linksimple.component-BwJSvIk0.js";import{k as L}from"./iframe-CX_N20D9.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CnFoVNYt.js";import"./DataAriaLabelMixin-CEcG5dbY.js";import"./DisabledMixin-OAT_oDGS.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
