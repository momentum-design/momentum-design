import{a4 as A,R as I,k as i,u as E}from"./iframe-BDHu_yvJ.js";import{Q as M}from"./repeat-DvalsNQ5.js";import{L as p}from"./list.component-C6sGDoSK.js";import{T as w}from"./TabListComponentMixin-BPPyMRhs.js";import{c as O}from"./index-BwohK4si.js";import{c as _,s as L}from"./commonArgTypes-BG7EqI50.js";import{h as N}from"./utils-B5QUENNQ.js";import"./index-uvgfi3Jp.js";import"./index-Cwkd-8UH.js";import"./preload-helper-C1FmrZbK.js";import"./directive-Ctav8iJK.js";import"./ListNavigationMixin-Dnkm9yJR.js";import"./KeyDownHandledMixin-lfim3BWe.js";import"./index-D-HwGd98.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-IZ3ajzmD.js";import"./CaptureDestroyEventForChildElement-NDCpQRUZ.js";import"./button.utils-rNW36Ji7.js";import"./buttonsimple.component-y37B5Ig5.js";import"./DisabledMixin-DBitIXox.js";import"./IconNameMixin-BT8yayou.js";import"./index-DTrDRi1E.js";import"./badge.constants-BpKWsqXS.js";const G=A`
  :host {
...
`,P=[G],m=class m extends w(p){constructor(){super(...arguments),this.orientation="vertical"}isValidItem(e){return e.matches(`${O}:not([disabled])`)}onElementStoreUpdate(e,l,o){super.onElementStoreUpdate(e,l,o),l==="added"&&e.setAttribute("variant","line")}connectedCallback(){super.connectedCallback(),this.role=I.TABLIST,this.setAttribute("aria-orientation","vertical")}render(){return i`
  ...
  >
    ${M(z,e=>e.tabId,e=>i`<mdc-tab
          ...
          @click="${a("onclick")}"
        ></mdc-tab>`)}
  </mdc-verticaltablist>`,oa={title:"Components/verticaltablist",tags:["autodocs"],component:"mdc-verticaltablist",render:B,argTypes:{"aria-label":{control:"text",description:"Label for the tab list used for accessibility. This is required for the component to be accessible."},"active-tab-id":{control:"select",description:"ID of the active tab. Defaults to the first tab if not provided.",options:z.map(t=>t.tabId)},...N(["itemsStore","orientation","loop","initial-focus"]),..._,...L}},c={args:{"aria-label":"Navigation tabs","active-tab-id":"messages"}},r={render:t=>i`
    <mdc-verticaltablist
      data-aria-label="${t["data-aria-label"]}"
      active-tab-id="${t["active-tab-id"]||""}"
      @change="${a("change")}"
...
}`,...(C=(S=n.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};const sa=["Example","TabsWithBadges","TextOnlyTabs","TabsWithPanels"];export{c as Example,r as TabsWithBadges,n as TabsWithPanels,d as TextOnlyTabs,sa as __namedExportsOrder,oa as default};
