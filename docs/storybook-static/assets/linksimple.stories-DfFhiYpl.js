import{L as O,T as _}from"./linksimple.component-Bx6DAYTg.js";import{k as L}from"./iframe-B_1iNO5L.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CEYFYNWi.js";import"./DataAriaLabelMixin-B4zEqVdi.js";import"./DisabledMixin-Y2ty_K_n.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
