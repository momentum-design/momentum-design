import{L as O,T as _}from"./linksimple.component-BAV0ZpoD.js";import{k as L}from"./iframe-D-ciOeUr.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Vfrg044X.js";import"./DataAriaLabelMixin-CcQpfuVQ.js";import"./DisabledMixin-B71E26tS.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
