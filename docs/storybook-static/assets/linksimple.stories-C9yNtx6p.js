import{L as O,T as _}from"./linksimple.component-rsbis8yY.js";import{k as L}from"./iframe-BNuhQAvW.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Bt1okdpN.js";import"./DataAriaLabelMixin-DwsiJRfS.js";import"./DisabledMixin-Cz75y2XI.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
