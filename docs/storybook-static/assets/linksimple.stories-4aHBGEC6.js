import{L as O,T as _}from"./linksimple.component-BK_0dx0D.js";import{k as L}from"./iframe-h-8-pYpG.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BFv5gqaQ.js";import"./DataAriaLabelMixin-DFoYBU-S.js";import"./DisabledMixin-DNaExcQz.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
