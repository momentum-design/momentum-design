import{L as O,T as _}from"./linksimple.component-BZVtJ3PN.js";import{k as L}from"./iframe-CFjFFVnQ.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CoqXY0pa.js";import"./DataAriaLabelMixin-DTDEFTLN.js";import"./DisabledMixin-DiYMPzxP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
