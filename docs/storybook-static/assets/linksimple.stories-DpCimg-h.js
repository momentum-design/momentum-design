import{L as O,T as _}from"./linksimple.component-BXUW0s24.js";import{k as L}from"./iframe-CUGe0MVU.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BA0pvBbp.js";import"./DataAriaLabelMixin-Bv66yN0M.js";import"./DisabledMixin-BAsAWpL6.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
