import{i as F,k as c}from"./lit-element-D5KKan5q.js";import{u as q,C,n as J}from"./index-C9z9WAEj.js";import{c as Q,s as X}from"./commonArgTypes-BluK8w5L.js";import{d as Y}from"./utils-CO8B6ZcN.js";const Z=q.constructTagName("skeleton"),a={BUTTON:"button",CIRCULAR:"circular",RECTANGULAR:"rectangular",ROUNDED:"rounded"},P={VARIANT:a.RECTANGULAR},ee=F`
  :host {
...
`,pe={title:"Components/skeleton",tags:["autodocs"],component:"mdc-skeleton",render:oe,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(a)},...Y([]),...Q,...X}},p={args:{variant:P.VARIANT}},m={args:{variant:a.RECTANGULAR}},u={args:{variant:a.ROUNDED}},x={args:{variant:a.CIRCULAR}},g={args:{variant:a.BUTTON}},b={render:ae,args:{variant:a.RECTANGULAR}},h={render:e=>c`
