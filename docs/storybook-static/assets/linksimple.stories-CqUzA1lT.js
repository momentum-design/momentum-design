import{L as O,T as _}from"./linksimple.component-CjkpZDiU.js";import{k as L}from"./iframe-sRPgz7Dy.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DrlexgLD.js";import"./DataAriaLabelMixin-CVdG5Iu9.js";import"./DisabledMixin-BHVblWhw.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
