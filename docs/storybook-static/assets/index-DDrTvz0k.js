import{i as p,D as _,k as u}from"./lit-element-CHllvULs.js";import{n,u as v}from"./index-HW6KrQZO.js";import{t as c}from"./if-defined-C4tJgJ33.js";import{h as f,a as y}from"./index-BGjwsboe.js";import{D as k,F as b}from"./formfieldwrapper.component-63e8oEkZ.js";import{D as g}from"./DataAriaLabelMixin-vs_lw9aw.js";import{F as x}from"./FormInternalsMixin-DnHjpz6p.js";import{v as A}from"./v4-CmTdKEVZ.js";const E=[f,p`
  :host{
...
`,...y(!0)];var R=Object.defineProperty,s=(h,o,r,i)=>{for(var e=void 0,d=h.length-1,a;d>=0;d--)(a=h[d])&&(e=a(o,r,e)||e);return e&&R(o,r,e),e};const l=class l extends x(g(b)){constructor(){super(),this.checked=!1,this.readonly=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?u`<div class="mdc-radio__label-container">
      ${this.renderLabel()}
      ${this.renderHelperText()}
    </div>`:_,this.helpTextType=void 0,this.id=`mdc-radio-${A()}`}firstUpdated(){this.updateTabIndex()}getAllRadiosWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-radio[name="${this.name}"]`))}dispatchChangeEvent(o){const r=o.constructor;this.dispatchEvent(new r(o.type,o))}formResetCallback(){this.getAllRadiosWithinSameGroup().forEach(r=>{r.checked=!1}),this.updateComplete.then(()=>{this.setActualFormValue()}).catch(r=>{this.onerror&&this.onerror(r)})}formStateRestoreCallback(o){this.value===o&&o!==""&&(this.checked=!0)}setComponentValidity(o){o?this.internals.setValidity({}):this.requiredLabel&&!this.checked&&(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()),this.updateTabIndex()}setGroupValidity(o,r){this.updateComplete.then(()=>{o.forEach(i=>{i.setComponentValidity(r)})}).catch(i=>{this.onerror&&this.onerror(i)})}setActualFormValue(){let o="";this.checked?o=this.value?this.value:"on":o=null;const r=this.getAllRadiosWithinSameGroup();if(this.checked)this.setGroupValidity(r,!0);else{const i=r.some(a=>a.requiredLabel),e=!!r.find(a=>a.checked),d=i&&!e;this.setGroupValidity(r,!d)}this.internals.setFormValue(o)}handleChange(o){var e;if(this.disabled||this.readonly)return;this.getAllRadiosWithinSameGroup().forEach(d=>{var m;const a=(m=d.shadowRoot)==null?void 0:m.querySelector("input");a&&(d.checked=!1,a.checked=!1)}),this.checked=!0;const i=(e=this.shadowRoot)==null?void 0:e.querySelector("input");i&&(i.checked=!0),this.dispatchChangeEvent(o)}updateRadio(o,r,i){var e,d;(d=(e=o[r].shadowRoot)==null?void 0:e.querySelector("input"))==null||d.focus(),o[r].handleChange(i)}handleKeyDown(o){var d;if(this.disabled)return;const i=this.getAllRadiosWithinSameGroup().filter(a=>!a.disabled),e=i.indexOf(this);if(["ArrowDown","ArrowRight"].includes(o.key)){const a=(e+1)%i.length;this.updateRadio(i,a,o)}else if(["ArrowUp","ArrowLeft"].includes(o.key)){const a=(e-1+i.length)%i.length;this.updateRadio(i,a,o)}else o.key===" "&&this.updateRadio(i,e,o);this.updateTabIndex(),o.key==="Enter"&&((d=this.form)==null||d.requestSubmit())}updateTabIndex(){const o=this.getAllRadiosWithinSameGroup(),r=o.find(e=>e.checked),i=o.find(e=>!e.disabled);o.forEach(e=>{var a;const d=(a=e.shadowRoot)==null?void 0:a.querySelector("input");d&&(d.tabIndex=-1,(e===r||!r&&e===i)&&(d.tabIndex=0))})}update(o){super.update(o),o.has("checked")&&this.setActualFormValue()}render(){return u`
      <div class="mdc-radio__container">
        <div class="mdc-radio__icon-container mdc-focus-ring">
          <input
            ...
            aria-describedby="${c(this.helpText?k.HELPER_TEXT_ID:"")}"
    ...
    `}};l.styles=[...b.styles,...E];let t=l;s([n({type:Boolean,reflect:!0})],t.prototype,"checked");s([n({type:Boolean,reflect:!0})],t.prototype,"readonly");s([n({type:Boolean,reflect:!0})],t.prototype,"autofocus");const $=v.constructTagName("radio");t.register($);export{$ as T};
