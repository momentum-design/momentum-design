import{i as x,k as u}from"./lit-element-D5KKan5q.js";import{n as i}from"./provider.component-BaQC7CJH.js";import{r as p}from"./state-C0WmBOuD.js";import{D as n,B as h,a as I,b,I as f,P as z}from"./button.constants-BpS-4nLb.js";import{R as N}from"./roles-DU0xbrD4.js";import{B as g}from"./buttonsimple.component-I-gcvU8_.js";import{g as k}from"./button.utils-rNW36Ji7.js";var T=Object.defineProperty,m=(c,o,d,r)=>{for(var t=void 0,e=c.length-1,a;e>=0;e--)(a=c[e])&&(t=a(o,d,t)||t);return t&&T(o,d,t),t};const O=c=>{class o extends c{constructor(){super(...arguments),this.variant=n.VARIANT,this.color=n.COLOR,this.typeInternal=n.TYPE_INTERNAL}setVariant(r){this.setAttribute("variant",Object.values(h).includes(r)?r:n.VARIANT)}setColor(r){!Object.values(I).includes(r)||this.variant===h.TERTIARY?this.setAttribute("color",`${n.COLOR}`):this.setAttribute("color",r)}setSize(r){const e=this.typeInternal===b.ICON?Object.values(f).includes(r)&&!(r===f[20]&&this.variant!==h.TERTIARY):Object.values(z).includes(r);this.setAttribute("size",e?`${r}`:`${n.SIZE}`)}inferButtonType(){var t,e;const r=(e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot"))==null?void 0:e.assignedNodes().filter(a=>{var y;return a.nodeType!==Node.TEXT_NODE||((y=a.textContent)==null?void 0:y.trim())}).length;r&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=b.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!r&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=b.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=b.PILL,this.setAttribute("data-btn-type","pill"))}}return m([i({type:String,attribute:"prefix-icon",reflect:!0})],o.prototype,"prefixIcon"),m([i({type:String,attribute:"postfix-icon",reflect:!0})],o.prototype,"postfixIcon"),m([i({type:String})],o.prototype,"variant"),m([i({type:String})],o.prototype,"color"),m([p()],o.prototype,"typeInternal"),o},S=x`
  :host {
...
`,w=[S];var A=Object.defineProperty,l=(c,o,d,r)=>{for(var t=void 0,e=c.length-1,a;e>=0;e--)(a=c[e])&&(t=a(o,d,t)||t);return t&&A(o,d,t),t};const v=class v extends O(g){constructor(){super(...arguments),this.size=n.SIZE,this.inverted=n.INVERTED,this.role=N.BUTTON}update(o){super.update(o),o.has("active")&&this.inferFilledIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(o){o?(this.prefixIcon&&(this.prefixFilledIconName=`${k(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${k(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return u`
      ...
      ${this.postfixFilledIconName?u` <mdc-icon
            ...
            length-unit="rem"
          ></mdc-icon>`:""}
    `}};v.styles=[...g.styles,...w];let s=v;l([i({type:Number})],s.prototype,"size");l([i({type:Boolean,reflect:!0})],s.prototype,"inverted");l([i({type:String,reflect:!0})],s.prototype,"role");l([p()],s.prototype,"prefixFilledIconName");l([p()],s.prototype,"postfixFilledIconName");export{s as B,O as a};
