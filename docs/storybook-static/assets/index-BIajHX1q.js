import{u,a3 as g,a2 as y,a8 as f,R as x,k as s,h as b,T as v,V as k,n as r}from"./iframe-BNuhQAvW.js";import{g as I}from"./button.utils-rNW36Ji7.js";import{B as h}from"./buttonsimple.component-DrbHQSP4.js";import{I as A}from"./IconNameMixin-BDegxZ0o.js";import{a as N}from"./LifeCycleMixin-CkFTW4AQ.js";import"./index-iIqfqlkl.js";const T=u.constructTagName("tab"),p={GLASS:"glass",LINE:"line",PILL:"pill"},c={VARIANT:p.PILL,ACTIVE:!1},S=[g,y`
    :host {
  ...
  `,...f()];var E=Object.defineProperty,i=(l,t,a,L)=>{for(var e=void 0,d=l.length-1,m;d>=0;d--)(m=l[d])&&(e=m(t,a,e)||e);return e&&E(t,a,e),e};const n=class n extends A(N(h)){constructor(){super(...arguments),this.active=c.ACTIVE,this.variant=c.VARIANT,this.handleTabActiveChange=t=>{const a=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:t},bubbles:!0});this.dispatchEvent(a)}}connectedCallback(){super.connectedCallback(),this.role=x.TAB,this.size=void 0,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}modifyIconName(t){this.iconName&&(t?(this.prevIconName=this.iconName,this.iconName=`${I(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(t){this.setAttribute("variant",Object.values(p).includes(t)?t:c.VARIANT)}setActive(t,a){super.setActive(t,a),this.modifyIconName(a)}executeAction(){this.handleTabActiveChange(this.active)}update(t){super.update(t),t.has("variant")&&this.setVariant(this.variant)}render(){return s`
      <div part="container">
        <div part="leading">
          <slot name="prefix">
    ...
    `}};n.styles=[...h.styles,...S];let o=n;i([r({type:Boolean,reflect:!0})],o.prototype,"active");i([r({type:String,reflect:!0})],o.prototype,"text");i([r({type:String,reflect:!0})],o.prototype,"variant");i([r({type:String,reflect:!0,attribute:"tab-id"})],o.prototype,"tabId");o.register(T);export{p as T,o as a,T as b};
