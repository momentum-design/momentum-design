import{L as O,T as _}from"./linksimple.component-CPrEAezE.js";import{k as L}from"./iframe-BkJ5kS8N.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-KNVCfepo.js";import"./DataAriaLabelMixin-D7KW1UC7.js";import"./DisabledMixin-rtnkKzcf.js";import"./index-CF79w7L3.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
