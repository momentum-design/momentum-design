import{u as r,a2 as p,U as O,W as I,a3 as R,R as v,k as u,F as m,n as N}from"./iframe-C9zBfpfZ.js";const f={COMPLETE:"complete",INCOMPLETE:"incomplete"},h={VERTICAL:"vertical",HORIZONTAL:"horizontal"},k={STATUS:f.INCOMPLETE,ORIENTATION:h.HORIZONTAL},_=r.constructTagName("stepperconnector"),D=r.constructTagName("stepperitem"),E={INLINE:"inline",STACKED:"stacked"},L={COMPLETED:"completed",CURRENT:"current",ERROR_CURRENT:"error-current",ERROR_INCOMPLETE:"error-incomplete",NOT_STARTED:"not-started"},M={COMPLETED:"check-bold",ERROR:"error-legacy-badge-filled",PENCIL:"edit-bold"},P={VARIANT:E.INLINE,STATUS:L.NOT_STARTED},C=r.constructTagName("stepper"),a={ORIENTATION:h.HORIZONTAL,VARIANT:E.INLINE},c=class c{constructor(t,o){this.orientation=t,this.variant=o}};c.context=p(C);let n=c;const x=O`
  :host {
    gap: 0.5rem;
  }
