import{t as s}from"./if-defined-olcxDW8P.js";import{u as J,q as Q,S as ee,X as te,h as F,k as h,n as d}from"./iframe-D59qSDLK.js";import{e as ae}from"./query-DXShiZ7f.js";import"./index-DJQ6rmK0.js";import{V as u,D as re,F as S}from"./formfieldwrapper.component-CGA_i2Rj.js";import{A}from"./input.constants-CCG55Suf.js";import{D as oe}from"./DataAriaLabelMixin-B-q0EJoW.js";import{F as ie}from"./FormInternalsMixin-DNHt4erd.js";import{A as le}from"./buttonsimple.component-Ccjreym8.js";import"./index-CMQPxFTJ.js";import"./index-CwGSQ9Yn.js";import"./index-B_bHtNwH.js";import{c as se,s as ne}from"./commonArgTypes-BluK8w5L.js";import{a as ce,d as de}from"./utils-Dd_sfl9-.js";import{P as me,S as he}from"./popover.component-DgpXvbs2.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./DisabledMixin-MuPyaYa1.js";import"./v4-CmTdKEVZ.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-B1WUQql5.js";import"./button.component-CEygHlAT.js";import"./button.utils-rNW36Ji7.js";import"./index-xT-JkSuE.js";import"./index-DTrDRi1E.js";import"./index-EMiAHnq6.js";import"./BackdropMixin-COtaol9r.js";const pe=J.constructTagName("textarea"),E={HARD:"hard",SOFT:"soft"},$={OFF:"off",ON:"on"},p={CHARACTER_COUNTER_TYPE:Q.BODY_MIDSIZE_REGULAR,ROWS:5,COLS:40,WRAP:E.SOFT},ue=[ee`
    :host {
  ...
  `,...te(!0)];var xe=Object.defineProperty,c=(e,t,n,x)=>{for(var r=void 0,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=l(t,n,r)||r);return r&&xe(t,n,r),r};const L=class L extends le(ie(oe(S))){constructor(){super(...arguments),this.rows=p.ROWS,this.cols=p.COLS,this.wrap=E.SOFT,this.autocapitalize=A.OFF,this.autocomplete=$.OFF,this.characterLimitExceedingFired=!1}get textarea(){return this.inputElement}connectedCallback(){var t;super.connectedCallback(),this.value=((t=this.textContent)==null?void 0:t.trim())||this.value,this.updateComplete.then(()=>{this.textarea&&(this.textarea.checkValidity(),this.setTextareaValidity(),this.internals.setFormValue(this.textarea.value))}).catch(n=>{this.onerror&&this.onerror(n)})}firstUpdated(t){this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(t)}setTextareaValidity(){this.required&&this.validationMessage&&this.value===""?this.textarea.setCustomValidity(this.validationMessage):this.maxCharacterLimit&&this.value.length>this.maxCharacterLimit&&this.helpTextType===u.ERROR&&this.helpText?this.textarea.setCustomValidity(this.helpText):this.textarea.setCustomValidity(""),this.setValidity()}formResetCallback(){this.value="",this.requestUpdate()}formStateRestoreCallback(t){this.value=t}handleValueChange(){this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&(this.handleValueChange(),this.handleCharacterOverflowStateChange())}attributeChangedCallback(t,n,x){super.attributeChangedCallback(t,n,x),["maxlength","minlength","required"].includes(t)&&this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(a=>{this.onerror&&this.onerror(a)})}dispatchCharacterOverflowStateChangeEvent(){this.dispatchEvent(new CustomEvent("limitexceeded",{detail:{currentCharacterCount:this.value.length,maxCharacterLimit:this.maxCharacterLimit,value:this.value},bubbles:!0,composed:!0}))}handleCharacterOverflowStateChange(){this.maxCharacterLimit&&(this.value.length>this.maxCharacterLimit&&!this.characterLimitExceedingFired?(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!0):this.value.length<=this.maxCharacterLimit&&this.characterLimitExceedingFired&&(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!1))}updateValue(){this.value=this.textarea.value,this.internals.setFormValue(this.textarea.value)}onChange(t){this.updateValue();const n=t.constructor;this.dispatchEvent(new n(t.type,t))}renderCharacterCounter(){return this.maxCharacterLimit?h`
    ...
    `}};L.styles=[...S.styles,...ue];let i=L;c([d({type:String})],i.prototype,"placeholder");c([d({type:Number})],i.prototype,"rows");c([d({type:Number})],i.prototype,"cols");c([d({type:String})],i.prototype,"wrap");c([d({type:String})],i.prototype,"autocapitalize");c([d({type:String})],i.prototype,"autocomplete");c([d({type:String})],i.prototype,"dirname");c([d({type:Number})],i.prototype,"maxlength");c([d({type:Number})],i.prototype,"minlength");c([d({type:Number,attribute:"max-character-limit"})],i.prototype,"maxCharacterLimit");c([ae("textarea")],i.prototype,"inputElement");i.register(pe);const{action:m}=__STORYBOOK_MODULE_ACTIONS__,be=e=>h`<mdc-textarea
    @input="${m("oninput")}"
    @change="${m("onchange")}"
    @focus="${m("onfocus")}"
    @blur="${m("onblur")}"
  ...
  ></mdc-textarea>`,Ne={title:"Components/textarea",tags:["autodocs"],component:"mdc-textarea",render:be,argTypes:{...se,...ne,name:{control:"text"},value:{control:"text"},placeholder:{control:"text"},label:{control:"text"},required:{control:"boolean"},"help-text":{control:"text"},readonly:{control:"boolean"},disabled:{control:"boolean"},rows:{control:"number"},cols:{control:"number"},wrap:{control:"select",options:Object.values(E)},minlength:{control:"number"},maxlength:{control:"number"},"max-character-limit":{control:"number"},autocapitalize:{control:"select",options:Object.values(A)},"auto-focus-on-mount":{control:"boolean"},autocomplete:{control:"select",options:Object.values($)},dirname:{control:"text"},"data-aria-label":{control:"text"},"help-text-type":{control:"select",options:Object.values(u)},"validation-message":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(me)},"toggletip-strategy":{control:"select",options:Object.values(he)},"info-icon-aria-label":{control:"text"},...ce(["characterLimitExceedingFired","textarea","validity","willValidate"])}},y={args:{name:"textarea",label:"Label",rows:p.ROWS,cols:p.COLS,wrap:p.WRAP,required:!0,placeholder:"Placeholder",value:"","help-text":"Help text","help-text-type":u.DEFAULT,readonly:!1,disabled:!1,autocapitalize:A.OFF,autocomplete:$.OFF,"data-aria-label":""}},K={name:"textarea",label:"Label",rows:p.ROWS,cols:p.COLS,wrap:p.WRAP},g={args:{...K,value:"Disabled & typed textarea",disabled:!0},parameters:{docs:{description:{story:"This story displays a disabled textarea component. The textarea will be displayed as disabledwhen the `disabled` attribute is set to true. The user will not be able to interact with the textarea."}}}},v={args:{...K,readonly:!0,value:"Readonly textarea"},parameters:{docs:{description:{story:"This story displays a readonly textarea component. The textarea will be displayed as readonlywhen the `readonly` attribute is set to true. The user will not be able to edit the content of the textarea."}}}},f={argTypes:{...de(["label","help-text","required","placeholder","value","help-text-type"])},render:()=>h` <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
      ...
      <form @submit=${r=>{r.preventDefault();const l=new FormData(r.target).get("tweet");m("Form Submitted")({value:l})}}>
        <fieldset>
          ...
          <mdc-textarea
            ...
            name="tweet"
            label="Tweet"
            @limitexceeded=${r=>{var l,o;m("limitexceeded")(r);const{detail:a}=r;a.currentCharacterCount>a.maxCharacterLimit?(e=`Input must not exceed ${a.maxCharacterLimit} characters.`,t=u.ERROR):(e="",t=u.DEFAULT),(l=document.getElementById("textarea"))==null||l.setAttribute("help-text",e),(o=document.getElementById("textarea"))==null||o.setAttribute("help-text-type",t)}}
            help-text="${e}"
            help-text-type="${t}"
            required
            max-character-limit="75"
    ...
    `},C={render:e=>{const t=e["max-character-limit"],n=(a,l)=>{const o=a.querySelector('mdc-textarea[name="tweet"]'),{value:b}=o;return l.required&&(!b||b.trim()==="")?(o.setAttribute("help-text","Please enter your tweet"),o.setAttribute("help-text-type","error"),!1):b&&b.length>t?(o.setAttribute("help-text",`Input must not exceed ${t} characters.`),o.setAttribute("help-text-type","error"),!1):(o.setAttribute("help-text","Looks good!"),o.setAttribute("help-text-type","success"),!0)};return h`
      <form @submit=${a=>{a.preventDefault();const l=a.target;if(!n(l,e))return;const b=new FormData(l).get("tweet");m("Form Submitted")({value:b})}} @reset=${a=>{const o=a.target.querySelector('mdc-textarea[name="tweet"]');o.setAttribute("help-text",e["help-text"]||""),o.setAttribute("help-text-type",e["help-text-type"]||"default")}} novalidate>
        <fieldset>
...
}`,...(Z=(G=C.parameters)==null?void 0:G.docs)==null?void 0:Z.source}}};const je=["Example","DisabledTextarea","ReadonlyTextarea","AllVariants","TextareaWithCharacterCounter","TextareaInsideForm","TextareaInsideFormWithHelpTextValidation"];export{f as AllVariants,g as DisabledTextarea,y as Example,v as ReadonlyTextarea,w as TextareaInsideForm,C as TextareaInsideFormWithHelpTextValidation,T as TextareaWithCharacterCounter,je as __namedExportsOrder,Ne as default};
