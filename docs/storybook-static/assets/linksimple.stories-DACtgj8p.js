import{L as O,T as _}from"./linksimple.component-BoeegLVd.js";import{k as L}from"./iframe-CYZ064vw.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-BjIJ89BI.js";import"./DisabledMixin-CjuLaMSD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
