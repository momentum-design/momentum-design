import{L as O,T as _}from"./linksimple.component-vobliICS.js";import{k as L}from"./iframe-kINOlZoc.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BnQECZFN.js";import"./DataAriaLabelMixin-DfE2O-74.js";import"./DisabledMixin-Cszf8wsN.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
