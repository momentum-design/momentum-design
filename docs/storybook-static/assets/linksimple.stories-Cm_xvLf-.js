import{L as O,T as _}from"./linksimple.component-DRe9DoEG.js";import{k as L}from"./iframe-Cavcl6dQ.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-s8LTUgFN.js";import"./DataAriaLabelMixin-DxZRFp0e.js";import"./DisabledMixin-CGNQC1UC.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
