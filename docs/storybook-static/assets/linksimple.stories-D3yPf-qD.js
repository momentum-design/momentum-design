import{L as O,T as _}from"./linksimple.component-BFz_EvdY.js";import{k as L}from"./iframe-CSEbSeLd.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DGbgoXGT.js";import"./DataAriaLabelMixin-CAp7N-Gi.js";import"./DisabledMixin-BYOr4kmy.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
