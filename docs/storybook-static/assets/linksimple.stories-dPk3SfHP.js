import{L as O,T as _}from"./linksimple.component-eg48Ui1m.js";import{k as L}from"./iframe-CCrWkKwY.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-pVzLBalz.js";import"./DataAriaLabelMixin-DhWLLEZn.js";import"./DisabledMixin-DS6t65lW.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
