import{L as O,T as _}from"./linksimple.component-CawQKaUP.js";import{k as L}from"./iframe-DN1k4W8X.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-azXttZBh.js";import"./DataAriaLabelMixin-Btv6KE-u.js";import"./DisabledMixin-Bs8Qw-yl.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
