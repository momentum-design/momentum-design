import{L as O,T as _}from"./linksimple.component-DpaRLaNu.js";import{k as L}from"./iframe-M3ijzwy0.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-D0L9-6S-.js";import"./DataAriaLabelMixin-By13sHn4.js";import"./DisabledMixin-7EXHhexm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
