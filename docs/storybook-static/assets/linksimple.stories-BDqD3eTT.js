import{L as O,T as _}from"./linksimple.component-CaDumODV.js";import{k as L}from"./iframe-DlamQL43.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-BgQfPAFA.js";import"./DisabledMixin-CwSPwUg9.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
