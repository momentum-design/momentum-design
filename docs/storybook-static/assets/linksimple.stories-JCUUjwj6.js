import{L as O,T as _}from"./linksimple.component-B22-4XzH.js";import{k as L}from"./iframe-5_Zofx-s.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-COqBqGKO.js";import"./DataAriaLabelMixin-Doxi_5D_.js";import"./DisabledMixin-ix_5w-H5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
