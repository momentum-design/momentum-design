import{L as O,T as _}from"./linksimple.component-ByZeq9X0.js";import{k as L}from"./iframe-94edI9Bn.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-DWyWhGEy.js";import"./DataAriaLabelMixin-eUOhPIZy.js";import"./DisabledMixin-4QzHCmn4.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
