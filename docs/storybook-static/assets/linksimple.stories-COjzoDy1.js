import{L as O,T as _}from"./linksimple.component-BY5f_o7n.js";import{k as L}from"./iframe-E1lunX_E.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-CeOZCovI.js";import"./DataAriaLabelMixin-Sr3iQzQE.js";import"./DisabledMixin-DutBLYdm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
