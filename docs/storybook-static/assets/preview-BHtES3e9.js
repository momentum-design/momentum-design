import{s as p}from"./chunk-L4EGOTBX-DZdh6BXL.js";import"./entry-preview-WYIabKHs.js";import{k as c}from"./lit-element-CHllvULs.js";import"./index-CuTxblA2.js";import"./index-0VnUZb1H.js";import"./directive-helpers-D8kir-nK.js";import"./index-DrFu-skq.js";import"./index-HW6KrQZO.js";import"./state-CWckTc1X.js";import"./create-context-89xeped_.js";import"./iconprovider.component-XZChMYdq.js";const m="1.0.0",u="",h=[{kind:"javascript-module",path:"components/avatar/avatar.component.js",declarations:[{kind:"class",description:`The \`mdc-avatar\` component is used to represent a person or a space.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"AvatarButton",module:"components/avatarbutton/avatarbutton.component.js"}}]},{kind:"javascript-module",path:"components/bullet/bullet.component.js",declarations:[{kind:"class",description:`Bullet component, which is a visual marker
...
When an appropriate string value is set,
the input field is marked as required and the label is appended with this text.`,fieldName:"requiredLabel"},{name:"id",default:"`mdc-input-${uuidv4()}`",description:"The unique id of the input field. It is used to link the input field with the label.",fieldName:"id"},{name:"help-text-type",type:{text:"ValidationType"},description:"The type of help text. It can be 'default', 'error', 'warning', 'success', 'priority'.",fieldName:"helpTextType"},{name:"help-text",type:{text:"string | undefined"},description:"The help text that is displayed below the input field.",fieldName:"helpText"},{name:"disabled",type:{text:"boolean"},default:"false",description:`Indicates whether the component is disabled.
...
If not set, it falls back to the size defined by the length unit.`,default:"1",attribute:"size",reflects:!0},{kind:"field",name:"cacheStrategy",type:{text:"'in-memory-cache' | 'web-cache-api' | undefined"},description:"Icons Cache Strategy to use\n\nChoose `in-memory-cache` to cache icons in a JS cache (in-memory cache).\nChoose `web-cache-api` to cache icons using the Web Cache API.\n\nNOTE: `cache-name` must be provided if `cache-strategy` is provided.\n\nIf not provided or invalid value provided, the icons will not be cached.",default:"undefined",attribute:"cache-strategy"},{kind:"field",name:"cacheName",type:{text:"string | undefined"},description:`Icons Cache Name to use
...
If not provided, the icons will not be cached.`,default:"undefined",attribute:"cache-name"},{kind:"method",name:"updateValuesInContext",privacy:"private"},{kind:"method",name:"updateContext",privacy:"protected",return:{type:{text:"void"}}}],attributes:[{name:"url",type:{text:"string | undefined"},description:"Url of where icons will be fetched from",fieldName:"url"},{name:"file-extension",type:{text:"string | undefined"},description:"File extension of icons",default:"svg",fieldName:"fileExtension"},{name:"length-unit",type:{text:"string"},description:"Length unit used for sizing of icons",default:"em",fieldName:"lengthUnit"},{name:"size",type:{text:"number | undefined"},description:`The default size of the icon.
If not set, it falls back to the size defined by the length unit.`,default:"1",fieldName:"size"},{name:"cache-strategy",type:{text:"'in-memory-cache' | 'web-cache-api' | undefined"},description:"Icons Cache Strategy to use\n\nChoose `in-memory-cache` to cache icons in a JS cache (in-memory cache).\nChoose `web-cache-api` to cache icons using the Web Cache API.\n\nNOTE: `cache-name` must be provided if `cache-strategy` is provided.\n\nIf not provided or invalid value provided, the icons will not be cached.",default:"undefined",fieldName:"cacheStrategy"},{name:"cache-name",type:{text:"string | undefined"},description:`Icons Cache Name to use
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Link",module:"components/link/link.component.js"}}]},{kind:"javascript-module",path:"components/input/input.component.js",declarations:[{kind:"class",description:`mdc-input is a component that allows users to input text.
 It contains:
 ...
 *
 */`,customElement:!0,slots:[{description:"slot to add the label info icon",name:"label-info",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"Input",module:"components/input/input.component.js"}}]},{kind:"javascript-module",path:"components/marker/marker.component.js",declarations:[{kind:"class",description:`\`mdc-marker\`, which is a vertical line and
...
If no radio group is checked, the first enabled radio will have a tab index of 0`},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group (ex: checkbox, radio group).
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"NameMixin",module:"utils/mixins/NameMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"ValueMixin",module:"utils/mixins/ValueMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean"},default:"false",description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,attribute:"disabled",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"requiredLabel",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
...
id is used to link the label with the input field.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderRequiredLabel",privacy:"protected",inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpTextIcon",privacy:"protected",description:`creates the helpertext icon based on the helpTextType for validation.
If the helpTextType is not set, it defaults to 'default' and it doesn't display any icon.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpText",privacy:"protected",description:`creates the helper text component when the helpertext value is set.
It is also used to display the validation message based on the helpTextType.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderLabel",privacy:"protected",description:"renders the mdc-label-text container that contains the label and labelInfoToggleTip.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelperText",privacy:"protected",description:"renders the mdc-help-text container that contains the helpertext icon and helpertext.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}}],events:[{type:{text:"EventConstructor"}}],attributes:[{name:"checked",type:{text:"boolean"},default:"false",description:"Determines whether the radio is selected or unselected.",fieldName:"checked"},{name:"readonly",type:{text:"boolean"},default:"false",description:"Determines whether the radio is read-only.",fieldName:"readonly"},{name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group (ex: checkbox, radio group).
They are used to group elements in a form together.`,fieldName:"name",inheritedFrom:{name:"NameMixin",module:"src/utils/mixins/NameMixin.ts"}},{name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",fieldName:"value",inheritedFrom:{name:"ValueMixin",module:"src/utils/mixins/ValueMixin.ts"}},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel",inheritedFrom:{name:"DataAriaLabelMixin",module:"src/utils/mixins/DataAriaLabelMixin.ts"}},{name:"disabled",type:{text:"boolean"},default:"false",description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,fieldName:"disabled",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",fieldName:"label",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"required-label",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
 ...
 *
 */`,customElement:!0,slots:[{description:"slot to add the label info icon",name:"label-info",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"Radio",module:"components/radio/radio.component.js"}}]},{kind:"javascript-module",path:"components/spinner/spinner.component.js",declarations:[{kind:"class",description:`\`mdc-spinner\` is loading spinner which is an indeterminate progress indicator, meaning
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"VirtualizedList",module:"components/virtualizedlist/virtualizedlist.component.js"}}]},{kind:"javascript-module",path:"components/virtualizedlist/virtualizedlist.test.component.js",declarations:[{kind:"class",description:"",name:"VirtualizedWrapper",members:[{kind:"field",name:"onscroll",type:{text:"((this: GlobalEventHandlers, ev: Event) => any) | null"},default:"null",attribute:"onscroll"},{kind:"field",name:"virtualizerprops",type:{text:"VirtualizerProps"},default:"{ count: 100, estimateSize: () => 100 }",attribute:"virtualizerprops"},{kind:"field",name:"list",type:{text:"TemplateResult<1>"},default:"html``"},{kind:"field",name:"listItemTexts"},{kind:"method",name:"updateListItemTextArray",privacy:"private"},{kind:"method",name:"setListData",privacy:"private",parameters:[{name:"{ virtualItems, measureElement, listStyle }",type:{text:"SetListDataProps"}}]}],attributes:[{name:"onscroll",type:{text:"((this: GlobalEventHandlers, ev: Event) => any) | null"},default:"null",fieldName:"onscroll"},{name:"virtualizerprops",type:{text:"VirtualizerProps"},default:"{ count: 100, estimateSize: () => 100 }",fieldName:"virtualizerprops"}],superclass:{name:"Component",module:"/src/models"}}],exports:[{kind:"js",name:"default",declaration:{name:"VirtualizedWrapper",module:"components/virtualizedlist/virtualizedlist.test.component.js"}}]},{kind:"javascript-module",path:"utils/mixins/AvatarComponentMixin.js",declarations:[{kind:"mixin",description:"",name:"AvatarComponentMixin",members:[{kind:"field",name:"src",type:{text:"string | undefined"},description:`The src is the url which will be used to display the avatar.
