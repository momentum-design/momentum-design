import"./index-DTicpPWm.js";import{u as N,S as I,E as h,h as o,k as l,q as u,V as v,n as i}from"./iframe-CbEfFyyc.js";const A=N.constructTagName("banner"),n={CUSTOM:"custom",INFORMATIONAL:"informational",WARNING:"warning",ERROR:"error",SUCCESS:"success"},c={INFORMATIONAL_ICON_NAME:"info-circle-bold",SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},s={VARIANT:n.CUSTOM,PREFIX_ICON_SIZE:1.25},_=I`
  :host {
...
`,f=[_],E=t=>{switch(t){case n.INFORMATIONAL:return c.INFORMATIONAL_ICON_NAME;case n.SUCCESS:return c.SUCCESS_ICON_NAME;case n.WARNING:return c.WARNING_ICON_NAME;case n.ERROR:return c.ERROR_ICON_NAME;default:return null}};var R=Object.defineProperty,m=(t,a,g,x)=>{for(var r=void 0,d=t.length-1,p;d>=0;d--)(p=t[d])&&(r=p(a,g,r)||r);return r&&R(a,g,r),r};const b=class b extends h{constructor(){super(...arguments),this.variant=s.VARIANT,this.label=""}renderIcon(a){return a?l`
      <mdc-icon
        name="${a}"
        size="${s.PREFIX_ICON_SIZE}"
        part="leading-icon"
        length-unit="rem"
      ></mdc-icon>
    `:o}getTextLabel(){return this.label?l`
      <mdc-text part="leading-label" type="${u.BODY_MIDSIZE_MEDIUM}" tagname="${v.SPAN}"
        >${this.label}</mdc-text
      >
      ...
      <slot name="content">
        <div part="leading">
          <slot name="leading-icon">
            ${this.variant!==s.VARIANT?this.renderIcon(E(this.variant)??""):o}
          </slot>
    ...
    `}};b.styles=[...h.styles,...f];let e=b;m([i({type:String,reflect:!0})],e.prototype,"variant");m([i({type:String,reflect:!0})],e.prototype,"label");m([i({type:String,reflect:!0,attribute:"secondary-label"})],e.prototype,"secondaryLabel");e.register(A);export{n as B};
