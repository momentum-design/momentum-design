import{i as m,k as b}from"./lit-element-D5KKan5q.js";import{C as l,n as s,u as v}from"./index-C9z9WAEj.js";import{D as h}from"./DisabledMixin-BZruwOeC.js";const u=[m`
:host{
    display: block;
    position: relative;
    width: 1rem;
...
`];var k=Object.defineProperty,n=(e,t,d,g)=>{for(var r=void 0,c=e.length-1,i;c>=0;c--)(i=e[c])&&(r=i(t,d,r)||r);return r&&k(t,d,r),r};const a=class a extends h(l){constructor(){super(...arguments),this.checked=!1,this.readonly=!1}render(){return b`
      <slot></slot>
