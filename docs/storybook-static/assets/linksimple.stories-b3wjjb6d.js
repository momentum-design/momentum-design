import{L as O,T as _}from"./linksimple.component-B8o6mcUY.js";import{k as L}from"./iframe-Dihsx-NL.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-D-bzpMf3.js";import"./DataAriaLabelMixin-FB18SW9h.js";import"./DisabledMixin-BvD2odSx.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
