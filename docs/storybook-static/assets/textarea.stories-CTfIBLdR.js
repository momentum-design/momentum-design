import{a as d}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as o}from"./if-defined-D5BV9-c0.js";import{i as Z,D as L,k as h}from"./lit-element-D5KKan5q.js";import{u as G,n as i}from"./index-C9z9WAEj.js";import{e as X}from"./query-DXShiZ7f.js";import{a as J}from"./index-CcXofQbA.js";import"./index-D_Us_19R.js";import{V as p,D as K,F as A}from"./formfieldwrapper.component-DGQBm8Ze.js";import{A as T}from"./input.constants-BL3qgFPw.js";import{T as Q}from"./text.constants-ZF0jM5wn.js";import{D as ee}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as te}from"./FormInternalsMixin-CSixOKbK.js";import"./index-oxECh_PL.js";import"./index-DsWpJOK1.js";import"./index-D3DhXfcW.js";import{c as ae,s as re}from"./commonArgTypes-BluK8w5L.js";import{h as oe,d as j}from"./utils-CO8B6ZcN.js";import"./v4-CQkTLCs1.js";import"./base-DIkkzJ-c.js";import"./DisabledMixin-BZruwOeC.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./v4-CmTdKEVZ.js";import"./button.component-DP9lGkCN.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-C1CVlJGY.js";import"./TabIndexMixin-CsrHswKP.js";import"./button.utils-rNW36Ji7.js";import"./iframe-CMsK3GsR.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";const le=[Z`
  :host {
...
`,...J(!0)],ie=G.constructTagName("textarea"),w={HARD:"hard",SOFT:"soft"},C={OFF:"off",ON:"on"},n={CHARACTER_COUNTER_TYPE:Q.BODY_MIDSIZE_REGULAR,ROWS:5,COLS:40,WRAP:w.SOFT};var se=Object.defineProperty,l=(e,t,s,u)=>{for(var r=void 0,c=e.length-1,m;c>=0;c--)(m=e[c])&&(r=m(t,s,r)||r);return r&&se(t,s,r),r};const $=class $ extends te(ee(A)){constructor(){super(...arguments),this.readonly=!1,this.rows=n.ROWS,this.cols=n.COLS,this.wrap=w.SOFT,this.autocapitalize=T.OFF,this.autocomplete=C.OFF,this.autofocus=!1,this.characterLimitExceedingFired=!1}get textarea(){return this.inputElement}connectedCallback(){var t;super.connectedCallback(),this.value=((t=this.textContent)==null?void 0:t.trim())||this.value,this.updateComplete.then(()=>{this.textarea&&(this.textarea.checkValidity(),this.setTextareaValidity(),this.internals.setFormValue(this.textarea.value))}).catch(s=>{this.onerror&&this.onerror(s)})}setTextareaValidity(){this.required&&this.validationMessage&&this.value===""?this.textarea.setCustomValidity(this.validationMessage):this.maxCharacterLimit&&this.value.length>this.maxCharacterLimit&&this.helpTextType===p.ERROR&&this.helpText?this.textarea.setCustomValidity(this.helpText):this.textarea.setCustomValidity(""),this.setValidity()}formResetCallback(){this.value="",this.requestUpdate()}formStateRestoreCallback(t){this.value=t}handleValueChange(){this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&(this.handleValueChange(),this.handleCharacterOverflowStateChange())}attributeChangedCallback(t,s,u){super.attributeChangedCallback(t,s,u),["maxlength","minlength","required"].includes(t)&&this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(c=>{this.onerror&&this.onerror(c)})}dispatchCharacterOverflowStateChangeEvent(){this.dispatchEvent(new CustomEvent("limitexceeded",{detail:{currentCharacterCount:this.value.length,maxCharacterLimit:this.maxCharacterLimit,value:this.value},bubbles:!0,composed:!0}))}handleCharacterOverflowStateChange(){this.maxCharacterLimit&&(this.value.length>this.maxCharacterLimit&&!this.characterLimitExceedingFired?(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!0):this.value.length<=this.maxCharacterLimit&&this.characterLimitExceedingFired&&(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!1))}updateValue(){this.value=this.textarea.value,this.internals.setFormValue(this.textarea.value)}onChange(t){this.updateValue();const s=t.constructor;this.dispatchEvent(new s(t.type,t))}renderCharacterCounter(){return this.maxCharacterLimit?h`
    ...
    `:L}renderTextareaFooter(){return!this.helpText&&!this.maxCharacterLimit?L:h`
    ...
    ${Object.values(p).map(e=>h`<mdc-textarea
      ...
      <fieldset>
        ...
        <mdc-textarea
          ...
          name="tweet"
          label="Tweet"
          @limitexceeded=${r=>{var m,E;d("limitexceeded")(r);const{detail:c}=r;c.currentCharacterCount>c.maxCharacterLimit?(e=`Input must not exceed ${c.maxCharacterLimit} characters.`,t=p.ERROR):(e="",t=p.DEFAULT),(m=document.getElementById("textarea"))==null||m.setAttribute("help-text",e),(E=document.getElementById("textarea"))==null||E.setAttribute("help-text-type",t)}}
          help-text="${e}"
          help-text-type="${t}"
          required
          max-character-limit="75"
