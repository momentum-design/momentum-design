import{L as O,T as _}from"./linksimple.component-D4gyDenZ.js";import{k as L}from"./iframe-BP3AX2ct.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DcFDK1LV.js";import"./DataAriaLabelMixin-Cv2DWa48.js";import"./DisabledMixin-3kafPYYR.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
