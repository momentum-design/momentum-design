import{k as i,t as f}from"./iframe-BhffW2JT.js";import"./index-CLk7tOH7.js";import"./index-0G_NhWFj.js";import{c as D,s as v}from"./commonArgTypes-BG7EqI50.js";import{h as U,a as W}from"./utils-B5QUENNQ.js";import{V as L}from"./ControlTypeMixin-mHh8G7JD.js";import{I as c}from"./menuitemcheckbox.constants-BRe2JkeZ.js";import"./preload-helper-C1FmrZbK.js";import"./index-BGBZ2JQF.js";import"./DisabledMixin-B82ZiNpk.js";import"./formfieldwrapper.constants-BF0g0vFy.js";import"./popover.constants-DYTHd7Dq.js";import"./statusmessage.constants-S3WH8vn9.js";import"./toggle.constants-Cs8e1d41.js";import"./index-B4_BNy4Q.js";import"./popover.component-D34niYn3.js";import"./BackdropMixin-B2dNgU18.js";import"./KeyDownHandledMixin-Cqv8dAEz.js";import"./index-BLrXt48w.js";import"./menuitem.component-DP06mdPk.js";import"./listitem.component-BcyuifAA.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-mzRvPFT3.js";import"./index-DTrDRi1E.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,M=e=>i`<div role="menu" style="width: 25rem;">${e}</div>`,O=e=>M(i` <mdc-menuitemcheckbox
      @change="${l("onchange")}"
      @click="${l("onclick")}"
      @focus="${l("onfocus")}"
      ?disabled="${e.disabled}"
    ...
    >
      ${e.children}
    </mdc-menuitemcheckbox>`),oe={title:"Components/menupopover/menuitemcheckbox",tags:["autodocs"],component:"mdc-menuitemcheckbox",render:O,argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(c)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},"control-type":{control:"select",options:[void 0,...L]},"soft-disabled":{control:"boolean"},...U(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...D,...v}},o={args:{indicator:c.CHECKBOX,checked:!1,label:"Menu Item",disabled:!1,"secondary-label":"",children:i`<mdc-icon length-unit="rem" name="alert-muted-bold" slot="leading-controls"></mdc-icon>`}},t={args:{checked:!0,indicator:c.TOGGLE,label:"Menu Item With Toggle",disabled:!1,"secondary-label":""}},m={args:{checked:!0,indicator:c.CHECKBOX,label:"Menu Item With Checkbox",disabled:!1,"secondary-label":""}},n={args:{checked:!0,indicator:c.CHECKMARK,label:"Menu Item With Checkmark",disabled:!1,"secondary-label":""}},d={render:()=>M(i`
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};const te=["Example","ToggleWithMenuItem","CheckboxWithMenuItem","CheckmarkWithMenuItem","AllVariants"];export{d as AllVariants,m as CheckboxWithMenuItem,n as CheckmarkWithMenuItem,o as Example,t as ToggleWithMenuItem,te as __namedExportsOrder,oe as default};
