import{L as O,T as _}from"./linksimple.component-Dqr8oP5_.js";import{k as L}from"./iframe-DvKTogpS.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-wAsZU8hK.js";import"./DataAriaLabelMixin-DUmrKq_t.js";import"./DisabledMixin-BcJ9Lxra.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
