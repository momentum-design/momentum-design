import{L as O,T as _}from"./linksimple.component--l-Uszvl.js";import{k as L}from"./iframe-BgYPXA4a.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BUbG2hnJ.js";import"./DataAriaLabelMixin-8AIEbDMd.js";import"./DisabledMixin-ypDYNgI1.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
