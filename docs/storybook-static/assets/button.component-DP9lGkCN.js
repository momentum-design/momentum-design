...
`,S=[O];var w=Object.defineProperty,l=(c,o,d,r)=>{for(var t=void 0,e=c.length-1,a;e>=0;e--)(a=c[e])&&(t=a(o,d,t)||t);return t&&w(o,d,t),t};const v=class v extends T(g){constructor(){super(...arguments),this.size=n.SIZE,this.inverted=n.INVERTED,this.role="button"}update(o){super.update(o),o.has("active")&&this.inferFilledIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(o){o?(this.prefixIcon&&(this.prefixFilledIconName=`${x(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${x(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return u`
