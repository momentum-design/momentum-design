import{L as O,T as _}from"./linksimple.component-B3rHev88.js";import{k as L}from"./iframe-BhffW2JT.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-13UxOtCY.js";import"./DisabledMixin-B82ZiNpk.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
