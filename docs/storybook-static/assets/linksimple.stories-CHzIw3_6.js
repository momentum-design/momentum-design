import{L as O,T as _}from"./linksimple.component-DleR1nEu.js";import{k as L}from"./iframe-C2GM4z_-.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-zqg5dXF4.js";import"./DataAriaLabelMixin-Dzuwkg0N.js";import"./DisabledMixin-CaMNUysA.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
