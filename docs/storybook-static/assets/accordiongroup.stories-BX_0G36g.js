import{i as Y,k as A}from"./lit-element-D5KKan5q.js";import{t as I}from"./if-defined-D5BV9-c0.js";import{C as L,n as f}from"./provider.component-BaQC7CJH.js";import{o as U}from"./query-assigned-elements-uEuc3rg8.js";import{T as H}from"./index-BBH3nJs-.js";import{D as d,T as K,a as P,S as i,b as n}from"./accordionbutton.component-C84zuoJP.js";import{a as J}from"./index-B-GnYs90.js";import"./index-B3_0s7BI.js";import"./index-DIc0Z4aM.js";import"./index-bz_Ux85s.js";import{c as Q,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as tt}from"./utils-CFOyPOhY.js";import"./base-DIkkzJ-c.js";import"./index-2d2fYNP7.js";import"./button.component-DvOKP7op.js";import"./state-C0WmBOuD.js";import"./button.constants-BpS-4nLb.js";import"./buttonsimple.constants-CNAgWCp2.js";import"./roles-DU0xbrD4.js";import"./buttonsimple.component-I-gcvU8_.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./button.utils-rNW36Ji7.js";import"./index-D1FKYa9S.js";import"./iframe-BmZlODKF.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-ChWiF_5p.js";import"./create-context-89xeped_.js";import"./index-riA1qVWu.js";import"./v4-CmTdKEVZ.js";import"./index-CZ5sSS0l.js";import"./IconNameMixin-CRlZlTtq.js";import"./index-D4LmmYr0.js";import"./chip.component-B7zhKsHK.js";const ot=Y`
  :host {
...
`,at=[ot,...J()];var rt=Object.defineProperty,s=(o,t,a,l)=>{for(var c=void 0,S=o.length-1,E;S>=0;S--)(E=o[S])&&(c=E(t,a,c)||c);return c&&rt(t,a,c),c};const x=class x extends L{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(l=>{l.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(l=>{l.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return A` <slot></slot> `}};x.styles=[...L.styles,...at];let e=x;s([f({type:String,reflect:!0})],e.prototype,"size");s([f({type:String,reflect:!0})],e.prototype,"variant");s([f({type:Boolean,reflect:!0,attribute:"allow-multiple"})],e.prototype,"allowMultiple");s([U({selector:H})],e.prototype,"accordionItems");s([U({selector:K})],e.prototype,"accordionButtonItems");e.register(P);const r=A`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
...
}`,...(V=(O=h.parameters)==null?void 0:O.docs)==null?void 0:V.source}}};var k,Z,B;b.parameters={...b.parameters,docs:{...(k=b.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    size: SIZE.SMALL,
    variant: VARIANT.CONTAINED
  }
}`,...(B=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:B.source}}};var _,G,W;v.parameters={...v.parameters,docs:{...(_=v.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    size: SIZE.LARGE,
    variant: VARIANT.CONTAINED
  }
}`,...(W=(G=v.parameters)==null?void 0:G.docs)==null?void 0:W.source}}};var j,q,F;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    size: SIZE.SMALL,
    variant: VARIANT.CONTAINED,
    'allow-multiple': false
  ...
  \`
}`,...(F=(q=g.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};const Wt=["Example","StackedVariant","ContainedVariant","BorderlessVariant","SmallSize","LargeSize","MultiInteractiveAccordion"];export{h as BorderlessVariant,u as ContainedVariant,m as Example,v as LargeSize,g as MultiInteractiveAccordion,b as SmallSize,p as StackedVariant,Wt as __namedExportsOrder,Gt as default};
