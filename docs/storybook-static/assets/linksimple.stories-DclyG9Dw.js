import{L as O,T as _}from"./linksimple.component-CiEzE-mk.js";import{k as L}from"./iframe-Dv4CZTGV.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DkpisCg5.js";import"./DataAriaLabelMixin-B0ZiAR4t.js";import"./DisabledMixin-HUACZ3-D.js";import"./index-BATfJeu3.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
