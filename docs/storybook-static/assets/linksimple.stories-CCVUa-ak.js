import{L as O,T as _}from"./linksimple.component-DTYuPmgq.js";import{k as L}from"./iframe-CMtBaVB4.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-xNyft-gm.js";import"./DataAriaLabelMixin-CBb43sBf.js";import"./DisabledMixin-DFHiMMgY.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
