import{L as O,T as _}from"./linksimple.component-Dxo6UqI0.js";import{k as L}from"./iframe-BW4UmAgY.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BjnxAPOE.js";import"./DataAriaLabelMixin-DTF8YUvz.js";import"./DisabledMixin-XtsmlmBf.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
