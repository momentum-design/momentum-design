import{u as te,U as ae,ab as E,aa as re,k as d,h,F as T,$ as ee,n as l}from"./iframe-LsDyd5eA.js";import"./index-ig4UHez8.js";import{e as ie}from"./base-DIkkzJ-c.js";import{Q as le}from"./repeat-B5ehvvLh.js";import{K as se,A as ne}from"./KeyToActionMixin-CoSo1tIm.js";import"./index-0xJcrgjs.js";import{c as oe,s as de}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";import"./index-vEOUe4_P.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";import"./popover.component-Ckj_5iiF.js";import"./if-defined-qZQu8y_k.js";import"./BackdropMixin-BOgv5Gp9.js";import"./popover.constants-B0afLGWX.js";import"./index-tiR4ATg5.js";import"./button.component-B163hAjh.js";import"./buttonsimple.component-D9fAeCTo.js";import"./DisabledMixin-D4fKto6W.js";import"./button.utils-rNW36Ji7.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ue;function me(a){return(e,t)=>ie(e,t,{get(){return(this.renderRoot??ue??(ue=document.createDocumentFragment())).querySelectorAll(a)}})}const he=te.constructTagName("slider"),ce={START:"start",END:"end",UNDEFINED:void 0},m={MIN:0,MAX:100,STEP:1,STATE:ce.UNDEFINED,ICON_SIZE:1.25,ICON_LENGTH_UNIT:"rem"},be=ae`
  :host {
    width: 100%;
...
`,pe=[re,be];var ve=Object.defineProperty,i=(a,e,t,s)=>{for(var o=void 0,n=a.length-1,u;n>=0;n--)(u=a[n])&&(o=u(e,t,o)||o);return o&&ve(e,t,o),o};const k=class k extends se(T){constructor(){super(),this.thumbFocused=m.STATE,this.thumbHovered=m.STATE,this.range=!1,this.min=m.MIN,this.max=m.MAX,this.step=m.STEP,this.addEventListener("keydown",this.preventChange.bind(this)),this.addEventListener("mousedown",this.preventChange.bind(this))}updated(e){super.updated(e),(e.has("value")||e.has("step")||e.has("min")||e.has("max")||e.has("disabled")||e.has("softDisabled")||e.has("range")||e.has("valueStart")||e.has("valueEnd"))&&this.updateTrackStyling(),e.has("softDisabled")&&this.setSoftDisabled(),(e.has("range")||e.has("valueStart")||e.has("valueEnd"))&&this.initializeRangeSlider()}preventChange(e){this.softDisabled&&(e instanceof KeyboardEvent&&this.getActionForKeyEvent(e)!==ne.TAB||!(e instanceof KeyboardEvent))&&(e.preventDefault(),e.stopPropagation())}setSoftDisabled(){this.inputElements.forEach(e=>{const t=e;this.softDisabled?t.setAttribute("aria-disabled","true"):t.removeAttribute("aria-disabled")})}initializeRangeSlider(){this.valueStart===void 0&&(this.valueStart=this.min),this.valueEnd===void 0&&(this.valueEnd=this.max),this.handleInput(0),this.handleInput(1)}handleInput(e){const t=this.inputElements[e];if(t)if(e===0){if(!this.valueEnd)return;const s=Number(t.value);s>this.valueEnd?(t.value=String(this.valueEnd),this.valueStart=this.valueEnd):s>=this.min&&s<this.valueEnd?this.valueStart=s:s<this.min&&(t.value=String(this.min),this.valueStart=this.min)}else{if(!this.valueStart)return;const s=Number(t.value);s<this.valueStart?(t.value=String(this.valueStart),this.valueEnd=this.valueStart):s<=this.max&&s>this.valueStart?this.valueEnd=s:s>this.max&&(t.value=String(this.max),this.valueEnd=this.max)}}iconTemplate(e,t){return typeof e=="string"&&e.length>0?d`<mdc-icon
          name="${e}"
          part="${t}"
...
}`,...(L=(R=v.parameters)==null?void 0:R.docs)==null?void 0:L.source}}};var F,_,V;g.parameters={...g.parameters,docs:{...(F=g.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    value: 50,
...
}`,...(V=(_=g.parameters)==null?void 0:_.docs)==null?void 0:V.source}}};var H,q,O;f.parameters={...f.parameters,docs:{...(H=f.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    value: 30,
...
}`,...(O=(q=f.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var B,U,K;x.parameters={...x.parameters,docs:{...(B=x.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    step: 1,
...
}`,...(K=(U=x.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var W,X,j;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    step: 12,
...
}`,...(P=(J=S.parameters)==null?void 0:J.docs)==null?void 0:P.source}}};const He=["Example","SliderWithTicks","DisabledSlider","SliderWithIcons","SoftDisabledSlider","RangeSlider","RangeSliderWithTicks","DisabledRangeSlider","SoftDisabledRangeSlider"];export{$ as DisabledRangeSlider,v as DisabledSlider,b as Example,x as RangeSlider,y as RangeSliderWithTicks,g as SliderWithIcons,p as SliderWithTicks,S as SoftDisabledRangeSlider,f as SoftDisabledSlider,He as __namedExportsOrder,Ve as default};
