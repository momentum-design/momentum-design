import{n as r,a3 as m,a2 as p,a4 as y,D as c,c as b,k as v,C as f}from"./iframe-D_OBz_bG.js";import{D as g}from"./DisabledMixin-DDjLwMnk.js";import{K as E,a as A,T as S,A as h}from"./KeyDownHandledMixin-Bf7ScF39.js";var x=Object.defineProperty,T=(a,t,e,u)=>{for(var s=void 0,n=a.length-1,d;n>=0;n--)(d=a[n])&&(s=d(t,e,s)||s);return s&&x(t,e,s),s};const z=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return T([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},K=[m,p`
    :host {
