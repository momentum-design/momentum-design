import{L as O,T as _}from"./linksimple.component-1vJFCQq1.js";import{k as L}from"./iframe-D1RECH4Q.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BP-5MEqs.js";import"./DataAriaLabelMixin-Dp4xT994.js";import"./DisabledMixin-RRbrXdWt.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
