import{i as E,k as d,D as y}from"./lit-element-D5KKan5q.js";import{u as x,C as g,n as r}from"./provider.component-BaQC7CJH.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{K as c}from"./keys-hFXe221I.js";import{D as f}from"./DisabledMixin-DcYwkKYf.js";import{T as L}from"./TabIndexMixin-TvgH_pmh.js";import{R as T}from"./roles-CJI3JVG-.js";import{V as k,T as n}from"./index-DHsMOcdX.js";import{a as I}from"./index-CqVtAZCJ.js";const p={CREATED:"created",DESTROYED:"destroyed",MODIFIED:"modified"},C=l=>{class t extends l{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(p.CREATED,{bubbles:!0,composed:!0}))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(p.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(o){this.dispatchEvent(new CustomEvent(p.MODIFIED,{detail:{change:o},bubbles:!0,composed:!0}))}}return t},F=x.constructTagName("listitem"),D={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},S={VARIANT:D.FULL_WIDTH};class u{static dispatchListItemEvent(t,i){i.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const A=E`
  :host {
