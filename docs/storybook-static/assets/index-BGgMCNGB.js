import{i as p,D as b,k as n}from"./lit-element-D5KKan5q.js";import{u,C as h,n as a}from"./index-C9z9WAEj.js";import{D as v}from"./DisabledMixin-BZruwOeC.js";import{I as g}from"./IconNameMixin-CujGSn0t.js";import{h as y}from"./index-B-GnYs90.js";import{T,V as E}from"./index-BrLJ_9IK.js";import"./index-CcH9QAPT.js";import"./index-BchtaGxG.js";const f=p`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
...
`,A=[y,f],_=u.constructTagName("inputchip"),t={TEXT_TYPE:T.BODY_MIDSIZE_REGULAR,TAG_NAME:E.SPAN,CLOSE_ICON:"cancel-bold"};var k=Object.defineProperty,c=(l,s,m,x)=>{for(var r=void 0,e=l.length-1,d;e>=0;e--)(d=l[e])&&(r=d(s,m,r)||r);return r&&k(s,m,r),r};const i=class i extends g(v(h)){constructor(){super(...arguments),this.label="",this.error=!1,this.clearAriaLabel=""}renderIcon(){return this.iconName?n` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:b}handleClose(){this.dispatchEvent(new CustomEvent("remove",{bubbles:!0,composed:!0}))}render(){return n`
      ...
      ></mdc-button>
    `}};i.styles=[...h.styles,...A];let o=i;c([a({type:String})],o.prototype,"label");c([a({type:Boolean})],o.prototype,"error");c([a({type:String,attribute:"clear-aria-label"})],o.prototype,"clearAriaLabel");o.register(_);export{_ as T};
