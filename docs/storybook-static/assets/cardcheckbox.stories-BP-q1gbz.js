import{u as W,U as Q,X as J,R as ee,h as x,k as i,n as Z,V as y}from"./iframe-C3odBbWY.js";import{D as te}from"./DisabledMixin-Cr88gAxL.js";import{T as ae,K as f}from"./TabIndexMixin-C9vb4D7c.js";import{C as N}from"./card.component-CDSO2rSs.js";import"./index-BfpvsA11.js";import"./index-Dzotrh0k.js";import{Q as ie}from"./repeat-B69aJKRr.js";import{i as o}from"./imageFixtures-CD4avj2q.js";import{c as re,s as oe}from"./commonArgTypes-BG7EqI50.js";import{h as le,d as ce}from"./utils-D6nie9pS.js";import{V as ne,O as E,D as t}from"./FooterMixin-DmSRbmJm.js";import"./index-COc_-Y6-.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./index-CaIliKjP.js";import"./index-DTrDRi1E.js";import"./formfieldwrapper.constants-MnkqbtyM.js";import"./popover.constants-Dtn7iWzj.js";import"./directive-Ctav8iJK.js";import"./link.constants-BdK-dVpY.js";import"./index-BRcvsfed.js";import"./button.component-DBnUyp3_.js";import"./buttonsimple.component-DeVVZUTu.js";import"./button.utils-rNW36Ji7.js";import"./index-BDS9_AzG.js";import"./if-defined-Dl1lZBmV.js";import"./popover.component-D5RF1dky.js";import"./BackdropMixin-CsWx8ZlU.js";import"./index-CAH0gnRi.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-D1TIsjRl.js";import"./formfieldwrapper.component-CAJ93LVb.js";const se=W.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},T={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},de=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,me=[de,...J()];var be=Object.defineProperty,q=(e,a,I,pe)=>{for(var l=void 0,A=e.length-1,k;A>=0;A--)(k=e[A])&&(l=k(a,I,l)||l);return l&&be(a,I,l),l};const C=class C extends te(ae(N)){constructor(){super(),this.checked=!1,this.selectionType=T.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}toggleOnEnter(a){a.key===f.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===f.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case r.CHECK:return i`<mdc-icon
    ...
    `}};C.styles=[...N.styles,...me];let s=C;q([Z({type:Boolean,reflect:!0})],s.prototype,"checked");q([Z({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(se);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,ue=e=>i` <mdc-cardcheckbox
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
