import{L as O,T as _}from"./linksimple.component-BlwoI0Kp.js";import{k as L}from"./iframe-DsWoryHe.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CG4Y3qK1.js";import"./DataAriaLabelMixin-9WnyDwQy.js";import"./DisabledMixin-B9yKoiUn.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
