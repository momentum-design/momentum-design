import{L as O,T as _}from"./linksimple.component-C3NHo8RZ.js";import{k as L}from"./iframe-BWgm79et.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-IxSQ8409.js";import"./DataAriaLabelMixin-DJNx2b8O.js";import"./DisabledMixin-C9Xpu-Ne.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
