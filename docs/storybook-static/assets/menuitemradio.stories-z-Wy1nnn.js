import{k as m}from"./iframe-DlUA9Lme.js";import"./index-DuUwrSS9.js";import{c as b,s as h}from"./commonArgTypes-BluK8w5L.js";import{a as p,t as k,h as g}from"./utils-CFOyPOhY.js";import"./index-DAlb8KIf.js";import{I as s}from"./menuitemradio.constants-BRiS5n9-.js";import"./preload-helper-C1FmrZbK.js";import"./index-DWTl0clH.js";import"./index-BLWS0bNq.js";import"./index-DTrDRi1E.js";import"./index-DteJdtLE.js";import"./DisabledMixin-CAO-9s6U.js";import"./index-n4BNhymp.js";import"./popover.component-BBliWbI3.js";import"./base-DIkkzJ-c.js";import"./if-defined-sRFM4mFi.js";import"./BackdropMixin-B37S2fZg.js";import"./v4-CmTdKEVZ.js";import"./class-map-B5PQqyOF.js";import"./directive-Ctav8iJK.js";import"./menuitem.component-1y5xRwPh.js";import"./listitem.component-DNNNHeko.js";import"./query-assigned-elements-uEuc3rg8.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-D2-rjBj7.js";import"./menupopover.constants-VV5YAfb8.js";import"./badge.constants-9IRrQcki.js";import"./sidenavigation.component-BfzCID8D.js";import"./index-D3QP49Ui.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,u=e=>m`<div role="menu" style="width: 25rem;">${e}</div>`,y=e=>u(m` <mdc-menuitemradio
      @change="${a("onchange")}"
      @click="${a("onclick")}"
      @focus="${a("onfocus")}"
      ?checked="${e.checked}"
    ...
    ></mdc-menuitemradio>`),H={title:"Components/menupopover/menuitemradio",tags:["autodocs"],component:"mdc-menuitemradio",render:y,argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(s)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},...p(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...k(["--mdc-listitem-default-background-color","--mdc-listitem-background-color-hover","--mdc-listitem-background-color-active","--mdc-listitem-primary-label-color","--mdc-listitem-secondary-label-color","--mdc-listitem-disabled-color","--mdc-listitem-column-gap","--mdc-listitem-padding-left-and-right"]),...b,...h}},d={args:{checked:!1,disabled:!1,label:"Menu Item",indicator:s.RADIO,"secondary-label":""}},i={render:()=>u(m`
    ...
    `),...g()};var c,o,n;d.parameters={...d.parameters,docs:{...(c=d.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    checked: false,
    disabled: false,
    label: 'Menu Item',
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(l=(t=i.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};const J=["Example","AllVariants"];export{i as AllVariants,d as Example,J as __namedExportsOrder,H as default};
