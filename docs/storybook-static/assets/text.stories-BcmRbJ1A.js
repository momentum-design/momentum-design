import{i as u,k as t}from"./lit-element-CPYlYYac.js";import{u as b,C as p,n as x}from"./index-BLShQaRP.js";import{d as v}from"./utils-DCJ3yZC1.js";import{c,s as z}from"./commonArgTypes-BluK8w5L.js";const w=u`
...
`,T=[u`
  ...
  `,w],_=b.constructTagName("text"),E={TYPE:["body-small-regular","body-small-medium","body-small-bold","body-midsize-regular","body-midsize-medium","body-midsize-bold","body-large-regular","body-large-medium","body-large-bold","body-small-regular-underline","body-small-medium-underline","body-midsize-regular-underline","body-midsize-medium-underline","body-large-regular-underline","body-large-medium-underline","heading-small-regular","heading-small-medium","heading-small-bold","heading-midsize-regular","heading-midsize-medium","heading-midsize-bold","heading-large-regular","heading-large-medium","heading-large-bold","heading-xlarge-regular","heading-xlarge-medium","heading-xlarge-bold","headline-small-light","headline-small-regular"],TAGNAME:["h1","h2","h3","h4","h5","h6","p","small","span","div","section"]},e={TYPE:"body-midsize-regular",TEXT_ELEMENT_TAGNAME:"p",CSS_PART_TEXT:"text"};var S=Object.defineProperty,y=(a,n,l,P)=>{for(var r=void 0,i=a.length-1,m;i>=0;i--)(m=a[i])&&(r=m(n,l,r)||r);return r&&S(n,l,r),r};const d=class d extends p{constructor(){super(...arguments),this.type=e.TYPE,this.tagname=e.TEXT_ELEMENT_TAGNAME}render(){switch(this.tagname){case"h1":return t`<h1 part=${e.CSS_PART_TEXT}><slot></slot></h1>`;case"h2":return t`<h2 part=${e.CSS_PART_TEXT}><slot></slot></h2>`;case"h3":return t`<h3 part=${e.CSS_PART_TEXT}><slot></slot></h3>`;case"h4":return t`<h4 part=${e.CSS_PART_TEXT}><slot></slot></h4>`;case"h5":return t`<h5 part=${e.CSS_PART_TEXT}><slot></slot></h5>`;case"h6":return t`<h6 part=${e.CSS_PART_TEXT}><slot></slot></h6>`;case"div":return t`<div part=${e.CSS_PART_TEXT}><slot></slot></div>`;case"span":return t`<span part=${e.CSS_PART_TEXT}><slot></slot></span>`;case"small":return t`<small part=${e.CSS_PART_TEXT}><slot></slot></small>`;case"p":default:return t`<p part=${e.CSS_PART_TEXT}><slot></slot></p>`}}};d.styles=[...p.styles,...T];let s=d;y([x({attribute:"type",reflect:!0,type:String})],s.prototype,"type");y([x({attribute:"tagname",reflect:!0,type:String})],s.prototype,"tagname");s.register(_);const A=a=>t`
<mdc-text type="${a.type}" tagname="${a.tagname}">${a.children}</mdc-text>
`,N={title:"Work In Progress/text",tags:["autodocs"],component:"mdc-text",render:A,parameters:{badges:["wip"]},argTypes:{children:{control:"text",description:'Children (passed into "default" slot)'},type:{control:"radio",options:[null,...E.TYPE]},tagname:{control:"text"},...c,...z,...v(["text"])}},o={args:{type:"body-large-regular",tagname:"",children:"This is a test text"}};var g,h,f;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    type: 'body-large-regular',
    tagname: '',
    children: 'This is a test text'
  }
}`,...(f=(h=o.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};const M=["Primary"];export{o as Primary,M as __namedExportsOrder,N as default};
