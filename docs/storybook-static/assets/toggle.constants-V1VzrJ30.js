import"./index-D5lPBL37.js";import{u as g,N as h,k as p,C as m,n as e}from"./iframe-BrN8x_Z0.js";import{D as b}from"./DisabledMixin-DjI3Wyw_.js";const u=g.constructTagName("statictoggle"),v={DEFAULT:"default",COMPACT:"compact"},n={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},f={compact:.75,default:1.25},y={SIZE:v.DEFAULT},E=[h`
    :host {
  ...
  `];var k=Object.defineProperty,r=(d,s,l,C)=>{for(var o=void 0,c=d.length-1,i;c>=0;c--)(i=d[c])&&(o=i(s,l,o)||o);return o&&k(s,l,o),o};const a=class a extends b(m){constructor(){super(...arguments),this.checked=!1,this.size=y.SIZE,this.readonly=!1,this.softDisabled=!1}render(){return p`
    ...
    `}};a.styles=[...m.styles,...E];let t=a;r([e({type:Boolean,reflect:!0})],t.prototype,"checked");r([e({type:String,reflect:!0})],t.prototype,"size");r([e({type:Boolean,reflect:!0})],t.prototype,"readonly");r([e({type:Boolean,attribute:"soft-disabled",reflect:!0})],t.prototype,"softDisabled");t.register(u);const I=g.constructTagName("toggle"),x={DEFAULT:"default",COMPACT:"compact"},N={SIZE:x.DEFAULT,VALIDATION_MESSAGE:"Please toggle this switch if you want to proceed."};export{N as D,x as T,I as a};
