import{L as O,T as _}from"./linksimple.component-D4Sk8x7H.js";import{k as L}from"./iframe-LsDyd5eA.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-qZQu8y_k.js";import"./DataAriaLabelMixin-DVgns88g.js";import"./DisabledMixin-D4fKto6W.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
