import{u as E,a2 as y,a4 as x,R as f,k as d,V as I,h as L,T as o,C as g,n as s}from"./iframe-Dhby1e8T.js";import{o as v}from"./query-assigned-elements-CP9ZK6vw.js";import{D as T}from"./DisabledMixin-BBW84rBN.js";import{K as k,a as D,T as C,A as c}from"./KeyDownHandledMixin-DWH9e7-q.js";const h={CREATED:"created",FIRST_UPDATE_COMPLETED:"first-update-completed",DESTROYED:"destroyed",MODIFIED:"modified"},N=E.constructTagName("listitem"),S={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},A={VARIANT:S.FULL_WIDTH},_=l=>{class t extends l{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(h.CREATED,{bubbles:!0,composed:!0})),this.updateComplete.then(()=>{this.dispatchEvent(new Event(h.FIRST_UPDATE_COMPLETED,{bubbles:!0,composed:!0}))})}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(h.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(n){this.dispatchEvent(new CustomEvent(h.MODIFIED,{detail:{change:n},bubbles:!0,composed:!0}))}}return t};class u{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const w=y`
  :host {
