import{L as O,T as _}from"./linksimple.component-Ck2gsaUz.js";import{k as L}from"./iframe-Dz4a6dNK.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BIfV3Rdr.js";import"./DataAriaLabelMixin-D3FahrV3.js";import"./DisabledMixin-BAirPdsU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
