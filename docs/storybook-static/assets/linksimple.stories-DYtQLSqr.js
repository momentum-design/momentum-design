import{L as O,T as _}from"./linksimple.component-Cb6aLMVO.js";import{k as L}from"./iframe-Dhby1e8T.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-7wnCbGQ7.js";import"./DataAriaLabelMixin-Ddpk06En.js";import"./DisabledMixin-BBW84rBN.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
