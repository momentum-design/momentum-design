import"./index-BmJqNwpa.js";import{g as R,p as N,d as L,t as ke,c as $e,S as b,i as Me,a as Ie,b as Ve,f as Y,e as Ae}from"./index-Bp2H2pr3.js";import"./index-C658QqKz.js";import"./index-DRummlaJ.js";import{u as Ee,a4 as Fe,aa as Ne,k as u,t as s,z as q,n as d,v as C,U as w}from"./iframe-CeAfCu9I.js";import"./index-DKS_YT9q.js";import{D as we}from"./DataAriaLabelMixin-DqufIhzm.js";import{F as Pe}from"./FormInternalsMixin-BHsXOWGg.js";import{b as g}from"./KeyDownHandledMixin-IrqsYuLy.js";import{F as _}from"./formfieldwrapper.component-D5DoqXtM.js";import{P as Le,D as Re,a as Ce}from"./popover.constants-CeDjW5CU.js";import{c as Ue,s as Oe}from"./commonArgTypes-BG7EqI50.js";import{h as Ye,a as U}from"./utils-B5QUENNQ.js";import{V as qe}from"./formfieldwrapper.constants-BVx_dnpY.js";import"./button.component-Cx1eLVgq.js";import"./buttonsimple.component-BpjxPwbi.js";import"./DisabledMixin-lSaSZRkD.js";import"./button.utils-rNW36Ji7.js";import"./class-map-DTbyS6Kl.js";import"./directive-Ctav8iJK.js";import"./preload-helper-C1FmrZbK.js";import"./index-o88J_soZ.js";import"./index-DTrDRi1E.js";import"./popover.component-BIG7Ms6U.js";import"./BackdropMixin-TW48eNpU.js";import"./index-BlbjQ_67.js";import"./v4-CmTdKEVZ.js";import"./statusmessage.constants-DfVAETh_.js";const _e=Ee.constructTagName("datepicker"),m={DEFAULT:"default",INPUT:"input"},z="calendar-empty-bold",v="datepicker-triggerid",P={VARIANT:m.INPUT,LOCALE:"en-US",DISABLE_FLIP:!1},ze=Fe`
  :host {
...
`,It={title:"Components/datepicker",tags:["autodocs"],component:"mdc-datepicker",render:Xe,argTypes:{label:{control:"text"},value:{control:"text",description:"Selected date as ISO string (yyyy-mm-dd)"},variant:{control:"select",options:Object.values(m),description:"Variant: input (spinbuttons) or default (select trigger)"},"selection-mode":{control:"select",options:Object.values(b)},locale:{control:"text",description:"BCP 47 locale string"},required:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${W.map(r=>`'${r}'`).join(", ")}.`,options:W},min:{control:"text",description:"Minimum selectable date (ISO string)"},max:{control:"text",description:"Maximum selectable date (ISO string)"},"locale-month-label":{control:"text"},"locale-day-label":{control:"text"},"locale-year-label":{control:"text"},"locale-calendar-label":{control:"text"},"locale-today-label":{control:"text"},"locale-spinbutton-description":{control:"text"},"locale-prev-month-label":{control:"text"},"locale-next-month-label":{control:"text"},"append-to":{control:"text"},"backdrop-append-to":{control:"text"},...Ye(["validation-message","validity","willValidate","dayInput","monthInput","yearInput","displayPopover","internalMonth","internalDay","internalYear","effectiveSelectionMode","pendingDigits","pendingDigitTimeout"]),...Ue,...Oe}},S={args:{label:"Start date",variant:m.INPUT,locale:"en-US",required:!0,"help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year","locale-calendar-label":"Open calendar","locale-today-label":"Today","locale-spinbutton-description":"Use arrow keys to change the value or type a number"}},T={args:{label:"Start date",value:"2025-07-15",variant:m.INPUT,locale:"en-US",required:!0,"help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year","locale-calendar-label":"Open calendar","locale-today-label":"Today"}},D={args:{label:"Date range",variant:m.DEFAULT,locale:"en-US",required:!0,"help-text":"Select a start and end date","locale-today-label":"Today"}},k={args:{label:"Date range",value:"2025-07-13",variant:m.DEFAULT,locale:"en-US",required:!0,"help-text":"Helper text","locale-today-label":"Today"}},$={args:{label:"Select week",variant:m.DEFAULT,"selection-mode":b.WEEK,locale:"en-US","help-text":"Click a date to select its week","locale-today-label":"Today","locale-prev-month-label":"Go to previous month","locale-next-month-label":"Go to next month"}},M={args:{label:"Start date",value:"2025-07-15",variant:m.INPUT,disabled:!0,locale:"en-US","help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},I={args:{label:"Start date",value:"2025-07-15",variant:m.INPUT,readonly:!0,locale:"en-US","help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},V={args:{label:"End date",value:"2025-07-14",variant:m.INPUT,locale:"en-US",required:!0,"help-text":"End date must occur after start date","help-text-type":"error","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},A={render:()=>u`
...
}`,...(ae=(te=k.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var le,re,ne;$.parameters={...$.parameters,docs:{...(le=$.parameters)==null?void 0:le.docs,source:{originalSource:`{
  args: {
    label: 'Select week',
    variant: VARIANT.DEFAULT,
...
}`,...(ne=(re=$.parameters)==null?void 0:re.docs)==null?void 0:ne.source}}};var oe,ie,se;M.parameters={...M.parameters,docs:{...(oe=M.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    label: 'Start date',
    value: '2025-07-15',
    variant: VARIANT.INPUT,
  ...
  \`,
  ...hideAllControls()
}`,...(De=(Te=F.parameters)==null?void 0:Te.docs)==null?void 0:De.source}}};const Vt=["Example","InputWithValue","DefaultVariant","DefaultWithValue","WeekSelection","Disabled","ReadOnly","ErrorState","DateRange","LocalizedGerman","LocalizedJapanese"];export{A as DateRange,D as DefaultVariant,k as DefaultWithValue,M as Disabled,V as ErrorState,S as Example,T as InputWithValue,E as LocalizedGerman,F as LocalizedJapanese,I as ReadOnly,$ as WeekSelection,Vt as __namedExportsOrder,It as default};
