import"./index-Bh2a1Rfu.js";import{k as t,Q as y}from"./iframe-JA1YSOwM.js";import{c as T,s as v}from"./commonArgTypes-BG7EqI50.js";import{b as w}from"./utils-B5QUENNQ.js";import{P as C,S as $}from"./popover.constants-ob2f6-37.js";import{V as h}from"./formfieldwrapper.constants-CHNcNMN3.js";import{F as L}from"./formfieldwrapper.component-CNzvF0xy.js";import"./index-BB8FVGFT.js";import"./button.component-BWBvG0lZ.js";import"./buttonsimple.component-BPSy_mcn.js";import"./DisabledMixin-FIsRwQNV.js";import"./KeyDownHandledMixin-zdCFlya9.js";import"./index-Jqvz7ibo.js";import"./button.utils-rNW36Ji7.js";import"./index-BtNw0XcG.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTrDRi1E.js";import"./index-DGbDXS9f.js";import"./statusmessage.constants-CLqfjLFC.js";import"./index-BsfQracr.js";import"./popover.component-BsRmE7FT.js";import"./BackdropMixin-BBcRIEHq.js";import"./index-BbMnBqvq.js";class q extends L{render(){return t`
      ${this.renderLabel()}
      <slot></slot>
  ...
  >
    ${e.children}
  </mdc-subcomponent-formfieldwrapper>`,U={title:"Internal/formfieldwrapper",tags:["autodocs"],component:"mdc-formfieldwrapper",render:H,argTypes:{...T,...v,"help-text-type":{control:"select",options:Object.values(h)},id:{control:"text"},label:{control:"text"},required:{control:"boolean"},"help-text":{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"soft-disabled":{control:"boolean"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(C)},"toggletip-strategy":{control:"select",options:Object.values($)},"info-icon-aria-label":{control:"text"}}},o={args:{label:"Label","help-text":"Helper text","help-text-type":"default",children:"[Child Component]",required:!0,disabled:!1,"toggletip-text":"toggletip text","info-icon-aria-label":"Info icon aria label"}},l={render:()=>t`
  ...
  \`
}`,...(u=(x=i.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};const X=["Example","LongLabelText","HelperTextTypes","WithSlottedToggletip"];export{o as Example,r as HelperTextTypes,l as LongLabelText,i as WithSlottedToggletip,X as __namedExportsOrder,U as default};
