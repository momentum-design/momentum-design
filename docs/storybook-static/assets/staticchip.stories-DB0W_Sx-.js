import{S as u,T as g,C as a}from"./staticchip.component-CbjF9bAm.js";import{k as t}from"./iframe-Bmqk5ncS.js";import"./index-BMN--PIx.js";import{c as L,s as O}from"./commonArgTypes-BluK8w5L.js";import{t as A}from"./utils-CFOyPOhY.js";import"./IconNameMixin-BxH3CgDw.js";import"./preload-helper-C1FmrZbK.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";u.register(g);const C=o=>t` <mdc-staticchip color="${o.color}" label="${o.label}" icon-name="${o["icon-name"]}"></mdc-staticchip>`,F={title:"Components/chip/staticchip",tags:["autodocs"],component:"mdc-staticchip",render:C,argTypes:{color:{control:"select",options:Object.values(a)},label:{control:"text"},"icon-name":{control:"text"},...L,...O,...A(["--mdc-chip-color","--mdc-chip-border-color","--mdc-chip-background-color"])}},e={args:{color:a.DEFAULT,label:"Label"}},r={args:{color:a.DEFAULT,label:"Label","icon-name":"placeholder-bold"}},c={render:()=>t` <div style="display: flex; gap: 0.5rem;">
