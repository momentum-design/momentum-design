import{L as O,T as _}from"./linksimple.component-cJjBPf6z.js";import{k as L}from"./iframe-CDUGfpod.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-4tR0mpEg.js";import"./DataAriaLabelMixin-DDDlamya.js";import"./DisabledMixin-BD7V_ocS.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
