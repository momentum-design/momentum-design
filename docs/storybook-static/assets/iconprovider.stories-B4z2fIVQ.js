import"./index-CymK7bIw.js";import{k as l}from"./lit-element-D5KKan5q.js";import{C as h,n as v}from"./index-C9z9WAEj.js";import{t as x}from"./if-defined-D5BV9-c0.js";import{I as f,A as g,a as y}from"./iconprovider.component-Bvm-70EG.js";import{p as C}from"./index-2PiEGcHV.js";import{h as $}from"./utils-CO8B6ZcN.js";import"./create-context-89xeped_.js";var P=Object.defineProperty,b=(e,t,i,s)=>{for(var n=void 0,o=e.length-1,c;o>=0;o--)(c=e[o])&&(n=c(t,i,n)||n);return n&&P(t,i,n),n};class u extends h{constructor(){super(...arguments),this.iconProviderContext=C.consume({host:this,context:f.Context})}render(){var t,i,s,n,o,c,a;return l`
      ...
      <mdc-icon name="${x(this.iconName)}"></mdc-icon>
    `}}b([v({type:String,attribute:"icon-name"})],u.prototype,"iconName");u.register("mdc-subcomponent-icon");const E=e=>l`
<mdc-iconprovider 
  url=${e.url}
  icon-set=${e["icon-set"]}
...
}`,...(d=(p=r.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};const A=["Example"];export{r as Example,A as __namedExportsOrder,T as default};
