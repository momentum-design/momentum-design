import{L as O,T as _}from"./linksimple.component-CcxmydFs.js";import{k as L}from"./iframe-CuUJoUXQ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DatWz75s.js";import"./DataAriaLabelMixin-KLjmldJo.js";import"./DisabledMixin-YOIh_EIm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
