import{L as O,T as _}from"./linksimple.component-DBXb3ps3.js";import{k as L}from"./iframe-Dxl5JR04.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-C0_rihGE.js";import"./DataAriaLabelMixin-DbDPbvRw.js";import"./DisabledMixin-CidSUaWv.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
