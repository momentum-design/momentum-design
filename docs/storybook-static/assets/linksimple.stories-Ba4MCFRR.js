import{L as O,T as _}from"./linksimple.component-CO4-wzNO.js";import{k as L}from"./iframe-XWsxOvFK.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DU1Fw2i1.js";import"./DataAriaLabelMixin-BPSk4IJ7.js";import"./DisabledMixin-ChexUNpd.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
