import{i as n,D as b,k as i}from"./lit-element-D5KKan5q.js";import{u,C as v,n as h}from"./index-C9z9WAEj.js";import{h as p,a as g}from"./index-BX3Tn-Br.js";import{I as k}from"./IconNameMixin-CujGSn0t.js";import{b as T,a as E}from"./buttonsimple.component-CcsHbiGJ.js";import{T as f,V as L}from"./text.constants-ZF0jM5wn.js";const y=n`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,A=[p,y,...g()],C=u.constructTagName("chip"),I={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},r={COLOR:I.DEFAULT,TEXT_TYPE:f.BODY_MIDSIZE_REGULAR,TAG_NAME:L.SPAN,SIZE:T[24],ROLE:"button"};var O=Object.defineProperty,s=(a,t,d,S)=>{for(var o=void 0,l=a.length-1,m;l>=0;l--)(m=a[l])&&(o=m(t,d,o)||o);return o&&O(t,d,o),o};const e=class e extends k(E){constructor(){super(),this.color=r.COLOR,this.label="",this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?i`
      <mdc-icon 
        name="${this.iconName}" 
        length-unit="rem" 
        size="1"></mdc-icon>
    `:b}render(){return i`
      ...
      `}};e.styles=[...v.styles,...A];let c=e;s([h({type:String,reflect:!0})],c.prototype,"color");s([h({type:String})],c.prototype,"label");export{c as C,C as T,I as a};
