import{L as O,T as _}from"./linksimple.component-C8I36CEW.js";import{k as L}from"./iframe-Dz6bdCHw.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-BX_n7AzT.js";import"./DataAriaLabelMixin-D0nlW83P.js";import"./DisabledMixin-DY4t-H77.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
