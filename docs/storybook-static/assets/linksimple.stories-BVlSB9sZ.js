import{L as O,T as _}from"./linksimple.component-ZtYECAcW.js";import{k as L}from"./iframe-C9ATrnz3.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B-BKLdpQ.js";import"./DataAriaLabelMixin-DLtQFpZy.js";import"./DisabledMixin-BoW9hNfQ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
