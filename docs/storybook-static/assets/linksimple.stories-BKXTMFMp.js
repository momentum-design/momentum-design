import{L as O,T as _}from"./linksimple.component-DyAKhscJ.js";import{k as L}from"./iframe-BsSOvdiI.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cv7J1nAi.js";import"./DataAriaLabelMixin-Bdk731Yz.js";import"./DisabledMixin-fjLCGnVB.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
