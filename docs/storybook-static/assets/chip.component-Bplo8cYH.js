import{i as s,D as b,k as i}from"./lit-element-D5KKan5q.js";import{u,C as v,n as h}from"./index-C9z9WAEj.js";import{I as p}from"./IconNameMixin-CujGSn0t.js";import{B as g}from"./buttonsimple.component-DTw2LNsX.js";import{a as k}from"./buttonsimple.constants-CGc1uJX6.js";import{T,V as E}from"./index-BrLJ_9IK.js";import{a as f,h as A}from"./index-Cx7wvr8C.js";const G=u.constructTagName("chip"),L={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},r={COLOR:L.DEFAULT,TEXT_TYPE:T.BODY_MIDSIZE_REGULAR,TAG_NAME:E.SPAN,SIZE:k[24],ROLE:"button"},y=s`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,O=[f,y,...A()];var I=Object.defineProperty,n=(a,t,d,S)=>{for(var o=void 0,e=a.length-1,m;e>=0;e--)(m=a[e])&&(o=m(t,d,o)||o);return o&&I(t,d,o),o};const l=class l extends p(g){constructor(){super(...arguments),this.color=r.COLOR,this.label=""}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?i` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:b}render(){return i`
      ${this.renderIcon()}
      <mdc-text type="${r.TEXT_TYPE}" tagname="${r.TAG_NAME}">${this.label}</mdc-text>
    `}};l.styles=[...v.styles,...O];let c=l;n([h({type:String,reflect:!0})],c.prototype,"color");n([h({type:String})],c.prototype,"label");export{c as C,G as T,L as a};
