import{L as O,T as _}from"./linksimple.component-B7EnXYTi.js";import{k as L}from"./iframe-DLfB9FYH.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CdnasZhd.js";import"./DataAriaLabelMixin-C6AhHgC4.js";import"./DisabledMixin-B8bLtRzX.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
