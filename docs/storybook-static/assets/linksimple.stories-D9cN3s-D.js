import{L as O,T as _}from"./linksimple.component-CTZs0ai_.js";import{k as L}from"./iframe-Dd7Pl-vs.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CewUqBwT.js";import"./DataAriaLabelMixin-F3oAhsnT.js";import"./DisabledMixin-DTdjHbys.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
