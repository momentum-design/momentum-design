import{L as O,T as _}from"./linksimple.component-DNu3dkRr.js";import{k as L}from"./iframe-D7ojHcDY.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BS4u7X0m.js";import"./DataAriaLabelMixin-D_naP_x4.js";import"./DisabledMixin-CRYIZU9q.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
