import{i as u,k as b}from"./lit-element-CHllvULs.js";import{u as p,n as i}from"./index-HW6KrQZO.js";import{t as l}from"./if-defined-C4tJgJ33.js";import{h as _,a as f}from"./index-BGjwsboe.js";import"./index-D8Kh0DgI.js";import{D as k,F as m}from"./formfieldwrapper.component-DRjDJF0i.js";import{D as y}from"./DataAriaLabelMixin-vs_lw9aw.js";import{F as E}from"./FormInternalsMixin-D4P2zbkO.js";import"./index-DsHcZxtY.js";const x=[_,u`
  :host {
...
`,...f(!0)],C=p.constructTagName("toggle"),v={DEFAULT:"default",COMPACT:"compact"},n={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},w={compact:.75,default:1.25},h={SIZE:v.DEFAULT,VALIDATION_MESSAGE:"Please toggle this switch if you want to proceed."};var S=Object.defineProperty,d=(s,e,t,$)=>{for(var o=void 0,c=s.length-1,g;c>=0;c--)(g=s[c])&&(o=g(e,t,o)||o);return o&&S(e,t,o),o};const a=class a extends E(y(m)){constructor(){super(),this.checked=!1,this.size=h.SIZE,this.autofocus=!1,this.helpTextType=void 0}formResetCallback(){this.checked=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}manageRequired(){!this.checked&&this.requiredLabel?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}setFormValue(){let e=null;this.checked?e=this.value?this.value:"isActive":e=null,this.manageRequired(),this.internals.setFormValue(e)}toggleState(){this.disabled||(this.checked=!this.checked)}handleKeyDown(e){var t;e.key==="Enter"&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}setToggleSize(e){this.setAttribute("size",Object.values(v).includes(e)?e:h.SIZE)}update(e){super.update(e),e.has("checked")&&this.setFormValue(),e.has("size")&&this.setToggleSize(this.size)}render(){return b`
    ...
    `}};a.styles=[...m.styles,...x];let r=a;d([i({type:Boolean,reflect:!0})],r.prototype,"checked");d([i({type:String,reflect:!0})],r.prototype,"size");d([i({type:Boolean,reflect:!0})],r.prototype,"autofocus");r.register(C);export{h as D,v as T};
