...
`,V=[N,U,...S()],C=y.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:O.SPAN,SIZE:I[24],ROLE:"button"},G=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var M=Object.defineProperty,T=(r,s,h,j)=>{for(var a=void 0,m=r.length-1,p;m>=0;m--)(p=r[m])&&(a=p(s,h,a)||a);return a&&M(s,h,a),a};const d=class d extends x{constructor(){super(),this.variant=e.VARIANT,this.label="",this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return i`
    ...
    `}};d.styles=[...R.styles,...V];let t=d;T([f({type:String})],t.prototype,"variant");T([f({type:String})],t.prototype,"label");t.register(C);const P=r=>i`
  <mdc-alertchip 
  @click="${c("onclick")}"
  @keydown="${c("onkeydown")}"
  @keyup="${c("onkeyup")}"
