import{i as x,k as l,D as E}from"./lit-element-D5KKan5q.js";import{u as T,C as g,n as r}from"./provider.component-BaQC7CJH.js";import{o as y}from"./query-assigned-elements-uEuc3rg8.js";import{K as d}from"./keys-hFXe221I.js";import{D as L}from"./DisabledMixin-DcYwkKYf.js";import{T as A}from"./TabIndexMixin-TvgH_pmh.js";import{R as k}from"./roles-DU0xbrD4.js";import{V as I,T as n}from"./index-riA1qVWu.js";import{a as u}from"./index-DYRxW7oy.js";import{a as S}from"./popover.component-BeJYT0F1.js";import{a as C}from"./index-B-GnYs90.js";import{v as f}from"./v4-CmTdKEVZ.js";const W=T.constructTagName("listitem"),$={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},v={VARIANT:$.FULL_WIDTH,TOOLTIP_PLACEMENT:S.TOP},w=x`
  :host {
...
`,_=[w,...C()],D=()=>`listitem-tooltip-popover-${f()}`,P=()=>`listitem-tooltip-triggerid-${f()}`;class c{static dispatchListItemEvent(t,i){i.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}var R=Object.defineProperty,o=(p,t,i,s)=>{for(var a=void 0,h=p.length-1,b;h>=0;h--)(b=p[h])&&(a=b(t,i,a)||a);return a&&R(t,i,a),a};const m=class m extends L(A(g)){constructor(){super(),this.variant=v.VARIANT,this.tooltipPlacement=v.TOOLTIP_PLACEMENT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("focusin",this.displayTooltipForLongText.bind(this)),this.addEventListener("mouseenter",this.displayTooltipForLongText.bind(this)),this.addEventListener("focusout",this.hideTooltipOnLeave.bind(this)),this.addEventListener("mouseout",this.hideTooltipOnLeave.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||k.LISTITEM,this.id=this.id||P(),c.onCreatedListItem(this)}disconnectedCallback(){super.disconnectedCallback(),c.onDestroyedListItem(this)}handleKeyDown(t){(t.key===d.ENTER||t.key===d.SPACE)&&(this.triggerClickEvent(),t.preventDefault())}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}handleClick(){this.hideTooltipOnLeave()}displayTooltipForLongText(){var i,s;if(!this.tooltipText)return;this.hideTooltipOnLeave();const t=document.createElement(u);t.id=D(),t.textContent=this.tooltipText,t.setAttribute("triggerid",this.id),t.setAttribute("placement",this.tooltipPlacement),t.setAttribute("visible",""),t.setAttribute("show-arrow",""),(i=this.parentElement)!=null&&i.hasAttribute("slot")&&t.setAttribute("slot",this.parentElement.getAttribute("slot")||""),(s=this.parentElement)==null||s.after(t)}hideTooltipOnLeave(){const t=document.querySelector(`${u}[triggerid="${this.id}"]`);t&&t.remove()}getText(t,i,s){return l`
      <slot name="${t}">
