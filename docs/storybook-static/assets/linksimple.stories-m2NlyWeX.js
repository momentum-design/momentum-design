import{L as O,T as _}from"./linksimple.component-DyxaXDKa.js";import{k as L}from"./iframe-C_acqUys.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-5ZqpHmyY.js";import"./DataAriaLabelMixin-SpDE5BNL.js";import"./DisabledMixin-CXWNIArP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
