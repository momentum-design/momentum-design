import{k as i}from"./iframe-Bmqk5ncS.js";import"./index-ozIOI7pU.js";import{K as U,i as D}from"./ref-BfC6xfoP.js";import{Q as d}from"./repeat-DTm_WKnU.js";import{c as B,s as F}from"./commonArgTypes-BluK8w5L.js";import{d as K,a as q}from"./utils-CFOyPOhY.js";import{a as s}from"./listitem.component-DLCTQFGX.js";import"./index-Dlc1GpMM.js";import"./index-CBBmg3BG.js";import"./index-B6-svA1Y.js";import"./index-9jv0kyio.js";import"./index-C2-ENav3.js";import"./index-BMN--PIx.js";import"./index-BfOrLVk6.js";import"./index-yANYzjmF.js";import"./index-CiAdaCEH.js";import"./index-CXK2KkIO.js";import"./index-DXkubibn.js";import"./index-C2EDQdkM.js";import"./preload-helper-C1FmrZbK.js";import"./ListNavigationMixin-DgCStHq0.js";import"./keys-hFXe221I.js";import"./CaptureDestroyEventForChildElement-Bb4b8sZC.js";import"./directive-Ctav8iJK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./if-defined-CEMHl27f.js";import"./IconNameMixin-BxH3CgDw.js";import"./index-Buxhf2Fz.js";import"./buttonsimple.component-DJ5naDiX.js";import"./badge.constants-Dzi09ZT-.js";import"./button.component-DOKkPvZM.js";import"./button.utils-rNW36Ji7.js";import"./index-8oex4yMZ.js";import"./index-BltIwT_C.js";import"./popover.component-CpCRqOFZ.js";import"./BackdropMixin-DDe36BUy.js";import"./index-CvgpI4tf.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./FormInternalsMixin-GQemRFrQ.js";import"./query-DXShiZ7f.js";import"./formfieldwrapper.component-DgTSXZHj.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./toggle.constants-BxCXKLBX.js";import"./index-Cp423qIv.js";import"./index-B8kEZnhl.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,r=["Maria Simpson","Diana Rees","Fiona Wallace","Abigail Reid","Theresa Miller","Andrea Wright","Natalie Hunter","Bernadette Carr","Samantha Robertson","Deirdre Clark"],Q=t=>i` <mdc-list aria-label="${t["aria-label"]}" loop="${t.loop}" initial-focus="${t["initial-focus"]}">
    ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
    ${d(r,e=>i`<mdc-listitem @click="${l("onclick")}" label="${e}" variant="${s.INSET_PILL}">
  ...
  </mdc-list>`,Ft={title:"Components/list",tags:["autodocs"],component:"mdc-list",render:Q,argTypes:{textPassedToListHeader:{control:"text",description:"Text to be rendered in the list header component. This is a control in storybook only."},"aria-label":{control:"text"},...K(["default","list-header"]),...q(["itemsStore"]),loop:{control:"select",options:["true","false"],table:{defaultValue:{summary:"true"}}},...B,...F}},m={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants"}},p={render:t=>i`
  ...
  `,args:{textPassedToListHeader:"Scrollable Participants List","aria-label":"View all participants"}},u={render:t=>{const e=a=>{const o=a.target.closest("mdc-listitem");o&&o.remove()},g=a=>{var n;const o=[...a.target.closest("mdc-list").querySelectorAll("mdc-listitem")];(n=o[o.length-1])==null||n.remove()};return i`
      <mdc-list aria-label="${t["aria-label"]}">
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${d(r,a=>i`<mdc-listitem @click="${l("onclick")}" label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
    ...
    `}},L={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants","initial-focus":r.length-1}},$={render:t=>{const e=D(),g=()=>{var n,v;const a=document.createElement("mdc-listitem");a.setAttribute("variant",s.INSET_PILL),a.setAttribute("label",`List Item ${(((n=e.value)==null?void 0:n.children.length)||0)+1}`);const c=document.createElement("mdc-button");c.setAttribute("slot","trailing-controls"),c.textContent="Action";const o=document.createElement("mdc-button");o.setAttribute("slot","trailing-controls"),o.textContent="Action 2",a.append(c,o),(v=e.value)==null||v.append(a)};return i`
      <mdc-list aria-label="${t["aria-label"]}" ${U(e)}>
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${d(r.slice(0,4),a=>i`<mdc-listitem label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
                initials="${[a.split(" ")[0][0],a.split(" ")[1][0]].join("")}"
              ></mdc-avatar>
    ...
    >
      ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
      ${d(new Array(5).fill(0).map(()=>[...r]).flat(),e=>e,e=>i`<mdc-listitem @click="${l("onclick")}" label="${e}" variant="${s.INSET_PILL}">
            <mdc-checkbox slot="leading-controls" data-aria-label="mock label"></mdc-checkbox>
            <mdc-avatar
              slot="leading-controls"
              initials="${[e.split(" ")[0][0],e.split(" ")[1][0]].join("")}"
    ...
    </mdc-list>`};var x,I,T;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    textPassedToListHeader: 'Participants List',
    'aria-label': 'View all participants'
  }
}`,...(T=(I=m.parameters)==null?void 0:I.docs)==null?void 0:T.source}}};var k,P,f;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => html\`
...
}`,...(W=(j=h.parameters)==null?void 0:j.docs)==null?void 0:W.source}}};const Kt=["Example","ListWithDivider","ScrollableListWithSelect","ListWithRemovalElements","InitialFocusAtBottom","ExpandingList","ScrollingList"];export{m as Example,$ as ExpandingList,L as InitialFocusAtBottom,p as ListWithDivider,u as ListWithRemovalElements,b as ScrollableListWithSelect,h as ScrollingList,Kt as __namedExportsOrder,Ft as default};
