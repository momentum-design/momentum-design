import{i as b,D as h,k as l}from"./lit-element-D5KKan5q.js";import{u,C as v,n}from"./index-C9z9WAEj.js";import{I as p}from"./IconNameMixin-CujGSn0t.js";import{B as g}from"./buttonsimple.component-VcDu9Hac.js";import{R as k}from"./roles-BH_hBfTz.js";import{a as T}from"./buttonsimple.constants-BcidWKgH.js";import{T as E,V as f}from"./index-BrLJ_9IK.js";import{h as L,a as O}from"./index-B-GnYs90.js";const U=u.constructTagName("chip"),A={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},r={COLOR:A.DEFAULT,TEXT_TYPE:E.BODY_MIDSIZE_REGULAR,TAG_NAME:f.SPAN,SIZE:T[24],ROLE:k.BUTTON},y=b`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,I=[L,y,...O()];var N=Object.defineProperty,s=(t,d,m,S)=>{for(var o=void 0,e=t.length-1,i;e>=0;e--)(i=t[e])&&(o=i(d,m,o)||o);return o&&N(d,m,o),o};const a=class a extends p(g){constructor(){super(...arguments),this.color=r.COLOR,this.label=""}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?l` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:h}render(){return l`
      ...
      ${this.label?l`<mdc-text part="label" type="${r.TEXT_TYPE}" tagname="${r.TAG_NAME}"
            >${this.label}</mdc-text
          >`:h}
    `}};a.styles=[...v.styles,...I];let c=a;s([n({type:String,reflect:!0})],c.prototype,"color");s([n({type:String})],c.prototype,"label");export{A as C,U as T,c as a};
