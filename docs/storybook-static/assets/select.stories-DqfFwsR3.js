import{k as o}from"./iframe-D1RGJO9g.js";import"./index-Bar4EKEd.js";import{c as de,s as re}from"./commonArgTypes-BluK8w5L.js";import{a as se,t as me,h as s,d as pe}from"./utils-CFOyPOhY.js";import"./index-Cbl24PfU.js";import{V as k}from"./formfieldwrapper.component-CvP6ABv6.js";import"./index-DZI-Wp7z.js";import"./index-BFbUzBX5.js";import"./index-Cc6Q5g1v.js";import{P as ue}from"./popover.component-DYjVfDou.js";import"./preload-helper-C1FmrZbK.js";import"./index-B4ra579S.js";import"./button.component-DqAqkrM0.js";import"./button.constants-ctBMf0Nr.js";import"./buttonsimple.constants-DiW5GZvm.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-bVzR6LPV.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CFnJTGkD.js";import"./TabIndexMixin-Bl7-LDRA.js";import"./index-CQUTSyim.js";import"./button.utils-rNW36Ji7.js";import"./index-DGuVKFIz.js";import"./index-0dAn93WX.js";import"./index-DTrDRi1E.js";import"./index-Dxe5zRPe.js";import"./index-DcbpN_bp.js";import"./index-BUahXgHb.js";import"./if-defined-CEt-h5rX.js";import"./index-AkGujtMl.js";import"./v4-CmTdKEVZ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./CaptureDestroyEventForChildElement-B9960-RZ.js";import"./listitem.component-D9_vqDtz.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DataAriaLabelMixin-DzXGOr4J.js";import"./FormInternalsMixin-C5tL3ljo.js";import"./ListNavigationMixin-DgCStHq0.js";import"./divider.constants-BlTYmWKe.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,L=Object.values(k).filter(e=>e!=="priority"),O=e=>o`
...
`,$=e=>O(o`
  ...
  `),et={title:"Components/select/select",tags:["autodocs"],component:"mdc-select",render:$,argTypes:{name:{control:"text"},label:{control:"text"},required:{control:"boolean"},placeholder:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${L.map(e=>`'${e}'`).join(", ")}.`,options:L},"info-icon-aria-label":{control:"text"},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(ue)},"auto-focus-on-mount":{control:"boolean"},placement:{control:"select",options:["bottom-start","top-start"]},"soft-disabled":{control:"boolean"},...se(["id","value","validity","validation-message","willValidate","default","itemsStore"]),...me(["--mdc-select-background-color","--mdc-select-background-color-hover","--mdc-select-background-color-active","--mdc-select-background-color-disabled","--mdc-select-text-color","--mdc-select-text-color-selected","--mdc-select-text-color-disabled","--mdc-select-border-color","--mdc-select-border-color-disabled","--mdc-select-border-color-success","--mdc-select-border-color-warning","--mdc-select-border-color-error","--mdc-select-width","--mdc-select-listbox-height","--mdc-select-listbox-width"]),...de,...re}},p={args:{label:"Headquarters location",required:!0,placeholder:"Select your headquarters location",disabled:!1,readonly:!1,"help-text":"Select Help Text","help-text-type":"","data-aria-label":"Select label",placement:"bottom-start",children:o`<mdc-selectlistbox>
    ...
    </mdc-selectlistbox>`},render:e=>o` <div style="height: 35rem;">${$(e)}</div> `},h={args:{label:"Options with long text",placeholder:"Select one color",children:o`<mdc-selectlistbox>
  ...
  `,...s()},y={render:()=>o`
    ...
    `,...s()},S={render:e=>{const d=(c,n)=>{const a=c.querySelector('mdc-select[name="avengers-name"]'),i=c.querySelector('mdc-select[name="stone-count"]'),m=a.value,q=i.value;let w=!0;return n.required&&(!m||m==="")?(a.setAttribute("help-text","Please select your favorite Avenger"),a.setAttribute("help-text-type","error"),w=!1):(a.setAttribute("help-text","Looks good!"),a.setAttribute("help-text-type","success")),n.required&&(!q||q==="")?(i.setAttribute("help-text","Please select the Infinity Stone count"),i.setAttribute("help-text-type","error"),w=!1):(i.setAttribute("help-text","Looks good!"),i.setAttribute("help-text-type","success")),w};return o`
    ...
    `},args:{required:!0,"help-text":"","help-text-type":"default"},...s()},g={render:()=>{const e=Array.from({length:10},(t,r)=>o`<mdc-option label="Option ${r+1}"></mdc-option>`);let d=null;return setTimeout(()=>{d=o`<mdc-option label="Delayed Option"></mdc-option>`;const t=document.querySelector('mdc-select[label="Select option"] mdc-selectlistbox');if(t){const r=document.createElement("mdc-option");r.setAttribute("label","Delayed Option"),t.appendChild(r)}},2e3),O(o`
      <mdc-select placeholder="Select an option" label="Select option">
        <mdc-selectlistbox> ${e} ${d} </mdc-selectlistbox>
      </mdc-select>
    `)},argTypes:{...pe(["readonly","name","data-aria-label","disabled","required","help-text-type","help-text"])},...s()},f={render:()=>O(o`
  ...
  \`,
  ...hideAllControls()
}`,...(G=(P=x.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var U,j,K;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(K=(j=y.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};var Z,J,Q;S.parameters={...S.parameters,docs:{...(Z=S.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
  ...
  ...hideAllControls()
}`,...(ie=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};const tt=["Example","SelectWithSecondaryLabel","SelectWithGroups","SelectWithLongOptionText","SelectWithIconOptions","SelectWithStates","SelectWithForm","SelectWithFormHelpTextValidation","SelectWithDynamicOptions","SelectWithChangingSelectedOption","SelectWithChangingValueAttribute"];export{p as Example,f as SelectWithChangingSelectedOption,A as SelectWithChangingValueAttribute,g as SelectWithDynamicOptions,y as SelectWithForm,S as SelectWithFormHelpTextValidation,b as SelectWithGroups,v as SelectWithIconOptions,h as SelectWithLongOptionText,u as SelectWithSecondaryLabel,x as SelectWithStates,tt as __namedExportsOrder,et as default};
