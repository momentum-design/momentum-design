import{L as O,T as _}from"./linksimple.component-BnmsExx0.js";import{k as L}from"./iframe-C6gz75uu.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-C_NTEn5h.js";import"./DataAriaLabelMixin-7hoqcNwQ.js";import"./DisabledMixin-B_w9ZmxY.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
