import{L as O,T as _}from"./linksimple.component-CnEZ0Sk5.js";import{k as L}from"./iframe-C9ziMOfg.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Ci9mZRDF.js";import"./DataAriaLabelMixin-tN7xFgo0.js";import"./DisabledMixin-jcMExzk_.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
