import{L as O,T as _}from"./linksimple.component-DWdfVAy0.js";import{k as L}from"./iframe-s8ycpuW1.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-Bv4EqpMB.js";import"./DisabledMixin-0HlGAHwB.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
