import{L as O,T as _}from"./linksimple.component-BupeQZ9s.js";import{k as L}from"./iframe-CehLMjCz.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B2NB1HuU.js";import"./DataAriaLabelMixin-Lg3RGxy7.js";import"./DisabledMixin-CwKLT7nn.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
