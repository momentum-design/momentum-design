import{L as O,T as _}from"./linksimple.component-oDW3PVKy.js";import{k as L}from"./iframe-nms-y5_X.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CrGxwZ5x.js";import"./DataAriaLabelMixin-DT3bTF7E.js";import"./DisabledMixin-DCQQyJqL.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
