import{L as O,T as _}from"./linksimple.component-DnKjr6ht.js";import{k as L}from"./iframe-B6w-V3Sx.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DPK0yoMj.js";import"./DataAriaLabelMixin-CApNHlFf.js";import"./DisabledMixin-DS8PUL0z.js";import"./index-BX-rDzfl.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
