import{L as O,T as _}from"./linksimple.component-jQcI1TT6.js";import{k as L}from"./iframe-DMKvmg4g.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CuJZRpWJ.js";import"./DataAriaLabelMixin-DFVTcKVb.js";import"./DisabledMixin-CDwnfp-E.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
