import{L as O,T as _}from"./linksimple.component-CwE6euPC.js";import{k as L}from"./iframe-CNG6VSxf.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-6PfwViV8.js";import"./DisabledMixin-CfRJujOM.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
