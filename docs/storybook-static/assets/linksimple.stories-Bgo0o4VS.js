import{L as O,T as _}from"./linksimple.component-Csgai3Wk.js";import{k as L}from"./iframe-K492KDtv.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BPfPqs2E.js";import"./DataAriaLabelMixin--WwBLDqM.js";import"./DisabledMixin-DwlOflt-.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
