import{L as O,T as _}from"./linksimple.component-B9E9cQP-.js";import{k as L}from"./iframe-C_HbRYVK.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-CJwtqgn3.js";import"./DataAriaLabelMixin-BMxDflFO.js";import"./DisabledMixin-BVUoG_L5.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
