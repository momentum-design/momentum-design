import{i as k,D as m,k as i}from"./lit-element-CHllvULs.js";import{u as v,n}from"./index-HW6KrQZO.js";import{t as a}from"./if-defined-C4tJgJ33.js";import{D as p}from"./DataAriaLabelMixin-vs_lw9aw.js";import{F as f}from"./FormInternalsMixin-DnHjpz6p.js";import{D as x,F as b}from"./formfieldwrapper.component-63e8oEkZ.js";import{a as g}from"./index-BGjwsboe.js";import{v as y}from"./v4-CmTdKEVZ.js";import"./index-CQMdz21n.js";const E=v.constructTagName("checkbox"),u={CHECKED:"check-bold",INDETERMINATE:"minus-bold"},$=[k`
  :host {
...
`,...g(!0)];var T=Object.defineProperty,d=(l,e,o,C)=>{for(var c=void 0,t=l.length-1,h;t>=0;t--)(h=l[t])&&(c=h(e,o,c)||c);return c&&T(e,o,c),c};const s=class s extends f(p(b)){constructor(){super(),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?i`<div class="text-container">
      ${this.renderLabel()}
      ${this.renderHelperText()}
    </div>`:m,this.helpTextType=void 0,this.id=`mdc-input-${y()}`}setFormValue(){let e=null;this.checked?e=this.value?this.value:"on":e=null,this.manageRequired(),this.internals.setFormValue(e)}manageRequired(){!this.checked&&this.requiredLabel?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.checked=!1,this.indeterminate=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}toggleState(){this.disabled||(this.checked=!this.checked,this.indeterminate=!1)}handleKeyDown(e){var o;e.key==="Enter"&&((o=this.form)==null||o.requestSubmit())}handleChange(e){this.toggleState();const o=e.constructor;this.dispatchEvent(new o(e.type,e))}update(e){super.update(e),e.has("checked")&&this.setFormValue()}render(){const e=this.checked||this.indeterminate?i`
      <mdc-icon
        class="icon"
    ...
    `}};s.styles=[...b.styles,...$];let r=s;d([n({type:Boolean,reflect:!0})],r.prototype,"checked");d([n({type:Boolean,reflect:!0})],r.prototype,"indeterminate");d([n({type:Boolean,reflect:!0})],r.prototype,"autofocus");r.register(E);
