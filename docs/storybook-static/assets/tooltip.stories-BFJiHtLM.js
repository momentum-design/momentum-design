import{k as d}from"./iframe-0HVjsxx2.js";import{T as O,D as e}from"./index-aznniXHb.js";import{h as k}from"./utils-B5QUENNQ.js";import"./index-D1spIdNP.js";import"./index-DiXZIrON.js";import"./index-CWCg-LFy.js";import"./index-7MHGvywL.js";import"./index-TuTViokp.js";import{C as S,P as A,D}from"./popover.constants-C0Zq9_Tm.js";import"./preload-helper-C1FmrZbK.js";import"./popover.component-HD8-GG2P.js";import"./BackdropMixin-CJCU5qMH.js";import"./KeyDownHandledMixin-TMs2ITqw.js";import"./index-DEZAMiau.js";import"./button.component-m_Ls23Rv.js";import"./buttonsimple.component-D5Ep8JpP.js";import"./DisabledMixin-DmXZKRQb.js";import"./button.utils-rNW36Ji7.js";import"./index-BjAK6fzr.js";import"./index-DTrDRi1E.js";import"./IconNameMixin-kP1OG2_2.js";import"./linksimple.component-Dx5PTkBZ.js";import"./DataAriaLabelMixin-B7Mf4XDy.js";import"./link.constants-NYLEh7aH.js";import"./list.component-DDC6bJOu.js";import"./ListNavigationMixin-CxUJAe1V.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-B5DQR4fS.js";import"./CaptureDestroyEventForChildElement-BJheqEAw.js";import"./listitem.component-Cbz2eJ27.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,E=t=>d`
...
`,st={title:"Components/tooltip",tags:["autodocs"],component:"mdc-tooltip",render:E,argTypes:{children:{control:"text"},color:{control:"select",options:Object.values(S)},delay:{control:"text"},id:{description:"The id of the tooltip(optional, if not set, a random id will be generated)",control:"text"},offset:{control:"number"},placement:{control:"select",options:Object.values(A)},"show-arrow":{control:"boolean"},"tooltip-type":{control:"select",options:Object.values(O)},triggerID:{control:"text"},...k(["trigger","z-index","disable-flip","role","focus-trap","prevent-scroll","close-button","interactive","hide-on-escape","hide-on-blur","hide-on-outside-click","focus-back-to-trigger","backdrop","size","append-to","close-button-aria-label","aria-labelledby","aria-describedby","show","hide","togglePopoverVisible","arrowElement","onOutsidePopoverClick","onEscapeKeydown","onPopoverFocusOut","startCloseDelay","cancelCloseDelay","enabledPreventScroll","enabledFocusTrap","shouldWrapFocus","utils","defaultSlotNodes"])}},l={render:E,args:{children:"This is a tooltip",color:D.COLOR,delay:e.DELAY,id:"tooltip",offset:e.OFFSET,placement:e.PLACEMENT,"show-arrow":e.SHOW_ARROW,triggerID:"tooltip-trigger","tooltip-type":e.TOOLTIP_TYPE,visible:!1}},r={render:()=>{let t=!1;const a="width: 100px;";return d`
      ...
      <hr />
      <mdc-button @click=${()=>{t=!t;const m=document.getElementById("text"),c=document.getElementById("button"),o="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;";t?(m.setAttribute("style",o),c.setAttribute("style",o)):(m.setAttribute("style",a+o),c.setAttribute("style",a+o))}}>Toggle Width</mdc-button>
    `}},n={render:()=>d`
  ...
  \`
}`,...(L=(T=s.parameters)==null?void 0:T.docs)==null?void 0:L.source}}};const dt=["Example","TooltipOnTextOverflow","TooltipInsidePopover","TooltipOnInlineLink"];export{l as Example,n as TooltipInsidePopover,s as TooltipOnInlineLink,r as TooltipOnTextOverflow,dt as __namedExportsOrder,st as default};
