import{L as O,T as _}from"./linksimple.component-BTfdvCpo.js";import{k as L}from"./iframe-C4M76I6Z.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CeXXTm78.js";import"./DataAriaLabelMixin-BIotAzNj.js";import"./DisabledMixin-CA14EO2k.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
