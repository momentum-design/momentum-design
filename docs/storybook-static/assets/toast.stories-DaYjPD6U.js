import{u as P,I as k,g as Y,B as f,S as W,h as y,k as e,q as z,G as _,n as l,$ as A,V as G}from"./iframe-Bmqk5ncS.js";import{t as V}from"./if-defined-CEMHl27f.js";import{o as j}from"./query-assigned-elements-uEuc3rg8.js";import{F as Z}from"./FooterMixin-8AjGxESk.js";import"./index-BMN--PIx.js";import"./index-9jv0kyio.js";import"./index-Dlc1GpMM.js";import"./index-trWPIAvI.js";import{c as H,s as J}from"./commonArgTypes-BluK8w5L.js";import{d as X,a as q,t as K,h as v}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./link.constants-CRDwEYBm.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-BxH3CgDw.js";import"./index-Buxhf2Fz.js";const Q=P.constructTagName("toast"),m={CUSTOM:"custom",SUCCESS:"success",WARNING:"warning",ERROR:"error"},T={SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},a={HEADER_TAG_NAME:"h2",CANCEL_ICON:"cancel-bold",ARROW_UP_BOLD:"arrow-up-bold",ARROW_DOWN_BOLD:"arrow-down-bold",PREFIX_ICON_SIZE:1.5,CLOSE_ICON_SIZE:k[20],BUTTON:Y,PRIMARY_BUTTON:f.PRIMARY,SECONDARY_BUTTON:f.SECONDARY,TERTIARY_BUTTON:f.TERTIARY,VARIANT:m.CUSTOM},tt=t=>{switch(t){case m.SUCCESS:return T.SUCCESS_ICON_NAME;case m.WARNING:return T.WARNING_ICON_NAME;case m.ERROR:return T.ERROR_ICON_NAME;default:return null}},et=W`
  :host {
...
`,h={args:{...i,"header-text":"Toast Title","show-more-text":"Show more","show-less-text":"Show less","prefix-icon":"placeholder-bold","normal-body":"This is a toast message.","detailed-body":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",children:e`${c}`}},p={name:"All Variants",render:()=>e`
...
}`,...(C=(E=h.parameters)==null?void 0:E.docs)==null?void 0:C.source}}};var w,R,$;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'All Variants',
  render: () => html\`
    <div style="display: grid; grid-template-columns: repeat(2, 0fr); gap: 2rem;">
      \${[{
  ...
  ...hideAllControls()
}`,...(M=(F=x.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};const wt=["Example","AllVariants","UserJoined","Connecting"];export{p as AllVariants,x as Connecting,h as Example,u as UserJoined,wt as __namedExportsOrder,Ct as default};
