import{L as O,T as _}from"./linksimple.component-DYoU4u2M.js";import{k as L}from"./iframe-Hv7IoejM.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DHscNqNO.js";import"./DataAriaLabelMixin-CVlRlWZI.js";import"./DisabledMixin-CqYnabgB.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
