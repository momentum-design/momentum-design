import{L as O,T as _}from"./linksimple.component-BGFXo8o5.js";import{k as L}from"./iframe-UyXdqIeP.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BXPbalLm.js";import"./DataAriaLabelMixin-DgJUyJrd.js";import"./DisabledMixin-DsCse2Ad.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
