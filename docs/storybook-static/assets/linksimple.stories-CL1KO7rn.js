import{L as O,T as _}from"./linksimple.component-BAk3yoMs.js";import{k as L}from"./iframe-CZp7GZ56.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-lk-75_Ux.js";import"./DataAriaLabelMixin-igi6CYL9.js";import"./DisabledMixin-DHpM1y9t.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
