import{L as O,T as _}from"./linksimple.component-CLZZYHd2.js";import{k as L}from"./iframe-DHn6Ee_A.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CS8lg2EF.js";import"./DataAriaLabelMixin-BGnkVoDG.js";import"./DisabledMixin-Jski02El.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
