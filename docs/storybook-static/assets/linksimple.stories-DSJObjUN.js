import{L as O,T as _}from"./linksimple.component-B8mACxp7.js";import{k as L}from"./iframe-BpeRZ387.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Vjdh4VZl.js";import"./DataAriaLabelMixin-CEFjQrVY.js";import"./DisabledMixin-BCMfh-jl.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
