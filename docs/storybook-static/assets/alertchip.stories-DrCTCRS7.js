import{S,U as y,X as O,u as x,q as _,V as $,c as w,k as t,g as L,E as U,n as I}from"./iframe-C_acqUys.js";import{B as C}from"./buttonsimple.component-GKQH0xTW.js";import{I as M}from"./IconNameMixin-DsVkfwyA.js";import"./index-QTNPF7LG.js";import{c as V,s as D}from"./commonArgTypes-BluK8w5L.js";import{h as F}from"./utils-CO8B6ZcN.js";import"./preload-helper-C1FmrZbK.js";import"./TabIndexMixin-CJ4BfYJM.js";import"./DisabledMixin-CXWNIArP.js";import"./index-CrQpdXBI.js";import"./index-DTrDRi1E.js";const G=S`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,B=[y,G,...O()],P=x.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},a={VARIANT:o.NEUTRAL,TEXT_TYPE:_.BODY_MIDSIZE_REGULAR,TAG_NAME:$.SPAN,SIZE:w[24],ROLE:"button"},j=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var Y=Object.defineProperty,R=(r,m,p,X)=>{for(var e=void 0,d=r.length-1,u;d>=0;d--)(u=r[d])&&(e=u(m,p,e)||e);return e&&Y(m,p,e),e};const h=class h extends M(C){constructor(){super(...arguments),this.variant=a.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=a.SIZE,this.role=a.ROLE}render(){return t`
  ...
  ></mdc-alertchip>`,tr={title:"Components/chip/alertchip",tags:["autodocs"],component:"mdc-alertchip",render:W,argTypes:{variant:{control:"select",options:Object.values(o)},label:{control:"text"},"icon-name":{control:"text"},"auto-focus-on-mount":{control:"boolean"},...V,...D,...F(["soft-disabled","size","role","type","active","disabled"])}},l={args:{variant:o.NEUTRAL,label:"Alert"}},i={args:{variant:o.INFORMATIONAL,label:"Announcement","icon-name":"announcement-regular"}},s={render:()=>t` <div style="display: flex; gap: 0.5rem;">
    ...
    </div>`};var v,g,b;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    variant: VARIANTS.NEUTRAL,
    label: 'Alert'
  }
}`,...(b=(g=l.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var A,k,f;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
