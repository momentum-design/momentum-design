import{u as E,U as y,X as x,R as f,k as n,V as T,h as L,T as o,F as g,n as r}from"./iframe-Bc3u0Dmm.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{T as I,K as c}from"./TabIndexMixin-BshATDlN.js";import{D as k}from"./DisabledMixin-Dp3-nAOW.js";const O=E.constructTagName("listitem"),D={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},C={VARIANT:D.FULL_WIDTH},h={CREATED:"created",FIRST_UPDATE_COMPLETED:"first-update-completed",DESTROYED:"destroyed",MODIFIED:"modified"},S=d=>{class t extends d{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(h.CREATED,{bubbles:!0,composed:!0})),this.updateComplete.then(()=>{this.dispatchEvent(new Event(h.FIRST_UPDATE_COMPLETED,{bubbles:!0,composed:!0}))})}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(h.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(s){this.dispatchEvent(new CustomEvent(h.MODIFIED,{detail:{change:s},bubbles:!0,composed:!0}))}}return t};class u{static dispatchListItemEvent(t,i){i.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const A=y`
  :host {
