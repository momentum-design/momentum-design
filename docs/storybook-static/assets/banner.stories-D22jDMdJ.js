import{u as W,S as Y,G as C,h as s,k as a,q as N,V as I,n as y}from"./iframe-Bmqk5ncS.js";import{t as v}from"./if-defined-CEMHl27f.js";import"./index-BMN--PIx.js";import"./index-9jv0kyio.js";import"./index-CuS5ovLg.js";import{i as _}from"./imageFixtures-CD4avj2q.js";import{c as j,s as X}from"./commonArgTypes-BluK8w5L.js";import{d as Z,t as q,h as G}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./index-Bo7GamiG.js";import"./index-DTrDRi1E.js";import"./button.component-DOKkPvZM.js";import"./buttonsimple.component-DJ5naDiX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CJC0_YR8.js";import"./TabIndexMixin-CoFbKfFN.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-BxH3CgDw.js";import"./linksimple.component-Bm4Rk7Z-.js";import"./DataAriaLabelMixin-C9ZcLuvp.js";import"./link.constants-CRDwEYBm.js";const K=W.constructTagName("banner"),n={CUSTOM:"custom",INFORMATIONAL:"informational",WARNING:"warning",ERROR:"error",SUCCESS:"success"},c={INFORMATIONAL_ICON_NAME:"info-circle-bold",SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},h={VARIANT:n.CUSTOM,PREFIX_ICON_SIZE:1.5},H=Y`
  :host {
...
`,J=[H],Q=e=>{switch(e){case n.INFORMATIONAL:return c.INFORMATIONAL_ICON_NAME;case n.SUCCESS:return c.SUCCESS_ICON_NAME;case n.WARNING:return c.WARNING_ICON_NAME;case n.ERROR:return c.ERROR_ICON_NAME;default:return null}};var ee=Object.defineProperty,f=(e,l,x,te)=>{for(var r=void 0,g=e.length-1,S;g>=0;g--)(S=e[g])&&(r=S(l,x,r)||r);return r&&ee(l,x,r),r};const A=class A extends C{constructor(){super(...arguments),this.variant=h.VARIANT,this.label=""}renderIcon(l){return l?a`
      <mdc-icon
        name="${l}"
      ...
      <slot name="content">
        <div part="leading">
          <slot name="leading-icon">
            ${this.variant!==h.VARIANT?this.renderIcon(Q(this.variant)??""):s}
          </slot>
    ...
    `}};A.styles=[...C.styles,...J];let o=A;f([y({type:String,reflect:!0})],o.prototype,"variant");f([y({type:String,reflect:!0})],o.prototype,"label");f([y({type:String,reflect:!0,attribute:"secondary-label"})],o.prototype,"secondaryLabel");o.register(K);const{action:i}=__STORYBOOK_MODULE_ACTIONS__,z=e=>a`
  <mdc-banner
    variant="${v(e.variant)}"
    label="${v(e.label)}"
...
`,Ne={title:"Components/banner",tags:["autodocs"],component:"mdc-banner",render:z,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(n)},label:{control:"text"},"secondary-label":{control:"text"},...j,...X,...Z(["children","content","leading-icon","leading-text","trailing-actions"]),...q(["--mdc-banner-background-color","--mdc-banner-border-color","--mdc-banner-icon-color","--mdc-banner-elevation","--mdc-banner-padding","--mdc-banner-gap"])}},ae={variant:"custom",label:"Banner Label","secondary-label":"This is the secondary label of the banner."},t=a`
...
`,d={args:{...ae,variant:"informational",label:"System Update Available","secondary-label":"A new version is ready to install. Please save your work before proceeding.",children:t}},m={name:"All Variants",render:()=>a`
  ...
  \`,
  ...hideAllControls()
}`,...(V=(F=p.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};const Ie=["Example","AllVariants","LabelOnly","WithoutActions","PromotionalBanner"];export{m as AllVariants,d as Example,b as LabelOnly,p as PromotionalBanner,u as WithoutActions,Ie as __namedExportsOrder,Ne as default};
