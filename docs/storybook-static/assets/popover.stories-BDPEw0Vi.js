import{k as o,V as r}from"./iframe-Dhby1e8T.js";import{h as xe,a as Te,d as Ee}from"./utils-B5QUENNQ.js";import"./index-5BLyIvtb.js";import"./index-Pz14tyX3.js";import"./index-BdeJJg7E.js";import"./index-Bb7255-P.js";import"./index-CLiqVxg9.js";import"./index-BmVHBhri.js";import"./index-9_noJEe1.js";import"./index-CKMb_zPR.js";import"./index-B7CUCMEv.js";import"./index-wIC2cilQ.js";import{P as p,C as Ie,B as ke,S as De,D as t}from"./popover.constants-ctRpQKVZ.js";import{t as u}from"./if-defined-7wnCbGQ7.js";import"./preload-helper-C1FmrZbK.js";import"./button.component-CxlMBKz9.js";import"./buttonsimple.component-DsVrbozW.js";import"./DisabledMixin-BBW84rBN.js";import"./KeyDownHandledMixin-DWH9e7-q.js";import"./index-ctlFp6vW.js";import"./button.utils-rNW36Ji7.js";import"./index-BmwK3B1Q.js";import"./index-DTrDRi1E.js";import"./query-assigned-elements-CP9ZK6vw.js";import"./FormInternalsMixin-C32eBX0F.js";import"./listitem.component-1X9rPhx3.js";import"./index-DIgNc7LM.js";import"./popover.component-DhkfVx6V.js";import"./BackdropMixin-Da79r85B.js";import"./index-2XnFT0GL.js";import"./index-CsuHbnko.js";import"./v4-CmTdKEVZ.js";import"./CaptureDestroyEventForChildElement-BoExPDB6.js";import"./DataAriaLabelMixin-Ddpk06En.js";import"./ListNavigationMixin-A6EhprZR.js";import"./formfieldwrapper.component-pD2H6PsZ.js";import"./formfieldwrapper.constants-ZCQaIZZ_.js";import"./menuitemradio.constants-CVmaoHFA.js";import"./menupopover.constants-_-5jyATN.js";import"./badge.constants-DrHwQwXY.js";import"./menuitem.component-ACe0sMIJ.js";import"./menuitemcheckbox.constants-Bjoo2ILv.js";import"./dialog.component-D9YMVMFp.js";import"./FooterMixin-D8UrXiKe.js";import"./link.constants-DeuUozuN.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,m=(e,n)=>o`
  <mdc-popover
    id="${e.id}"
...
`,Ae=e=>o`
  ...
  ${m(e,o`
    ...
    `)}
`,Se=e=>o`
  ${a("popover-trigger-interactive-hover","Hover me!")}
  ${m(e,o`
      <mdc-button>Button 1</mdc-button>
      <mdc-button>Button 2</mdc-button>
      <mdc-button>Button 3</mdc-button>
    ...
    `)}
`,Le=e=>o`
  ${a("popover-trigger-hide-on-blur","Click me!")}
  ${m(e,o`
      <mdc-button>Button 1</mdc-button>
      <mdc-button>Button 2</mdc-button>
      <mdc-button>Button 3</mdc-button>
  ...
  <mdc-button>Button 1</mdc-button>
`,we=e=>o`
  ${a("popover-trigger-multiple","Click/ Hover me!")}
...
`,Oe=e=>o`
  ${a("popover-trigger-nested","Click me!")}
...
`,$e=e=>o`
  ${a("popover-trigger-backdrop","Click me!")}
  ${m(e,o`
      <mdc-button>Button 1</mdc-button>
      <mdc-button>Button 2</mdc-button>
      <mdc-button>Button 3</mdc-button>
...
`,kt={title:"Components/popover",tags:["autodocs"],component:"mdc-popover",render:fe,argTypes:{id:{control:"text"},triggerID:{control:"text"},trigger:{control:"text"},placement:{control:"select",options:Object.values(p)},offset:{if:{arg:"offset"},control:"number"},visible:{control:"boolean"},delay:{control:"text"},color:{control:"select",options:Object.values(Ie)},"disable-flip":{control:"boolean"},size:{control:"boolean"},backdrop:{control:"boolean"},"z-index":{if:{arg:"z-index"},control:"number"},"show-arrow":{control:"boolean"},"close-button":{control:"boolean"},interactive:{control:"boolean"},"focus-trap":{control:"boolean"},"should-focus-trap-wrap":{control:"boolean"},"prevent-scroll":{control:"boolean"},"hide-on-blur":{control:"boolean"},"hide-on-escape":{control:"boolean"},"hide-on-outside-click":{control:"boolean"},"focus-back-to-trigger":{control:"boolean"},"append-to":{control:"text"},"close-button-aria-label":{control:"text"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},"aria-describedby":{control:"text"},role:{control:"text"},"disable-aria-expanded":{control:"boolean"},"backdrop-append-to":{control:"text"},"is-backdrop-invisible":{control:"boolean"},boundary:{control:"text"},"boundary-padding":{control:"number"},"boundary-root":{control:"select",options:Object.values(ke)},strategy:{control:"select",options:Object.values(De)},...xe(["aria-label","arrowElement","hide","show","togglePopoverVisible","triggerElement","utils"])}},l={args:{id:"popover",triggerID:"popover-trigger",trigger:"click",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"show-arrow":!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!0,interactive:t.INTERACTIVE}},v={render:Ae,args:{id:"popover-interactive",triggerID:"popover-trigger-interactive",trigger:"click",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"focus-trap":!0,interactive:!0,"show-arrow":!0,"disable-flip":t.DISABLE_FLIP,size:!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!1}},b={render:Se,args:{id:"popover-interactive-hover",triggerID:"popover-trigger-interactive-hover",trigger:"mouseenter",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,"focus-back-to-trigger":!0,role:t.ROLE,color:t.COLOR}},h={render:we,args:{id:"popover-multiple",triggerID:"popover-trigger-multiple",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"focus-back-to-trigger":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"show-arrow":!0,"close-button":!0,role:t.ROLE,color:t.COLOR,"keep-connected-tooltip-open":!1}},E={render:Oe,args:{id:"popover-nested",triggerID:"popover-trigger-nested",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":10,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,role:t.ROLE,color:t.COLOR,"focus-back-to-trigger":!0,"hide-on-outside-click":!0}},x={render:Le,args:{id:"popover-hide-on-blur",triggerID:"popover-trigger-hide-on-blur",trigger:"click",placement:p.RIGHT,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,"hide-on-blur":!0,role:t.ROLE,color:t.COLOR}},T={render:$e,args:{id:"popover-backdrop",triggerID:"popover-trigger-backdrop",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,backdrop:!0,"hide-on-outside-click":!0,"focus-trap":!0,role:t.ROLE,color:t.COLOR},parameters:{docs:{description:{story:o`This example shows how to use the \`backdrop\` property to create a modal popover.<br />
  ...
  `},D={parameters:{...Ee(o`
    ...
    `}},f={args:{...l.args,placement:p.RIGHT_START,triggerID:"trigger-btn"},render:()=>o`
    ${a("popover-trigger-interactive","Click me!")}
    <mdc-popover
      id="popover"
  ...
  `},A={args:{...l.args,id:"popover",placement:p.RIGHT_START,triggerID:"trigger-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"keep-connected-tooltip-open":!0},render:e=>o`
    ${a(e.triggerID,"Click me!")}
    ${m(e,o`
        <mdc-button
  ...
  `},S={args:{...l.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},render:e=>o`
  ...
  `},L={args:{...l.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},parameters:{...Ee(o` <mdc-text>
    ...
    `}};var $,y,P;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    id: 'popover',
...
}`,...(P=(y=l.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};var F,_,B;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(de=f.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var me,ae,le;A.parameters={...A.parameters,docs:{...(me=A.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover',
    placement: POPOVER_PLACEMENT.RIGHT_START,
  ...
  \`
}`,...(le=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var se,ue,ge;S.parameters={...S.parameters,docs:{...(se=S.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    ...Example.args,
...
}`,...(he=(be=L.parameters)==null?void 0:be.docs)==null?void 0:he.source}}};const Dt=["Example","interactiveContent","interactiveHover","interactiveMultiple","nestedPopover","hideOnBlur","popoverWithBackdrop","popoverWithSelect","MultipleSingleLevelPopovers","AppendTo","NestedMenu","PopoverWithTooltipAndDialog","PopoverScrollOverflow","PopoverInChangingList"];export{D as AppendTo,l as Example,k as MultipleSingleLevelPopovers,f as NestedMenu,L as PopoverInChangingList,S as PopoverScrollOverflow,A as PopoverWithTooltipAndDialog,Dt as __namedExportsOrder,kt as default,x as hideOnBlur,v as interactiveContent,b as interactiveHover,h as interactiveMultiple,E as nestedPopover,T as popoverWithBackdrop,I as popoverWithSelect};
