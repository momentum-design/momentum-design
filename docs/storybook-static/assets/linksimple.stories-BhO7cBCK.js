import{L as O,T as _}from"./linksimple.component-BVjxzDRS.js";import{k as L}from"./iframe-Bwqyin4n.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-Bw0IvBU4.js";import"./DataAriaLabelMixin-Cp-fgq4Y.js";import"./DisabledMixin-DIXyFXKx.js";import"./index-B9nS4jim.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
