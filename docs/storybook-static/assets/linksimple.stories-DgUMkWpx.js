import{L as O,T as _}from"./linksimple.component-DY_7nU_X.js";import{k as L}from"./iframe-DtQcyENP.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CsW2lzyU.js";import"./DataAriaLabelMixin-B7w5lDOY.js";import"./DisabledMixin-DvULDkzi.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
