...
Used in nested cases where the triggerComponent isn't the actual button.`,fieldName:"ariaLabelledby"},{name:"aria-describedby",type:{text:"string | null"},default:"null",description:"aria-describedby of the popover.",fieldName:"ariaDescribedby"},{name:"enabledFocusTrap",type:{text:"boolean"},description:`Determines whether the focus trap is enabled.
