import{L as O,T as _}from"./linksimple.component-BkgwQMjz.js";import{k as L}from"./iframe-gl2AV23u.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-D_Raxwq5.js";import"./DataAriaLabelMixin-Cp1kK3jb.js";import"./DisabledMixin-Da9HdG9U.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
