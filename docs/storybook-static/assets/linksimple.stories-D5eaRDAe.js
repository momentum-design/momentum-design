import{L as O,T as _}from"./linksimple.component-l3FnsRqu.js";import{k as L}from"./iframe-DlUA9Lme.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-sRFM4mFi.js";import"./DataAriaLabelMixin-zzpBu2FW.js";import"./DisabledMixin-CAO-9s6U.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
