import{L as O,T as _}from"./linksimple.component-vBpWaVQ4.js";import{k as L}from"./iframe-x5Cmm7xc.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DskKR71u.js";import"./DataAriaLabelMixin-AZXnQ5wO.js";import"./DisabledMixin-DKKVvzhX.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
