import{i as x,k as t}from"./lit-element-CPYlYYac.js";import{u as v,C as p,n as y}from"./index-BLShQaRP.js";import{d as c}from"./utils-DCJ3yZC1.js";import{c as z,s as w}from"./commonArgTypes-BluK8w5L.js";const T=x`
...
`,_=[x`
  ...
  `,T],E=v.constructTagName("text"),g={TYPE:["body-small-regular","body-small-medium","body-small-bold","body-midsize-regular","body-midsize-medium","body-midsize-bold","body-large-regular","body-large-medium","body-large-bold","body-small-regular-underline","body-small-medium-underline","body-midsize-regular-underline","body-midsize-medium-underline","body-large-regular-underline","body-large-medium-underline","heading-small-regular","heading-small-medium","heading-small-bold","heading-midsize-regular","heading-midsize-medium","heading-midsize-bold","heading-large-regular","heading-large-medium","heading-large-bold","heading-xlarge-regular","heading-xlarge-medium","heading-xlarge-bold","headline-small-light","headline-small-regular"],TAGNAME:["h1","h2","h3","h4","h5","h6","p","small","span","div"]},e={TYPE:"body-midsize-regular",TEXT_ELEMENT_TAGNAME:"p",CSS_PART_TEXT:"text"};var S=Object.defineProperty,b=(a,n,l,P)=>{for(var o=void 0,i=a.length-1,m;i>=0;i--)(m=a[i])&&(o=m(n,l,o)||o);return o&&S(n,l,o),o};const d=class d extends p{constructor(){super(...arguments),this.type=e.TYPE,this.tagname=e.TEXT_ELEMENT_TAGNAME}render(){switch(this.tagname){case"h1":return t`<h1 part=${e.CSS_PART_TEXT}><slot></slot></h1>`;case"h2":return t`<h2 part=${e.CSS_PART_TEXT}><slot></slot></h2>`;case"h3":return t`<h3 part=${e.CSS_PART_TEXT}><slot></slot></h3>`;case"h4":return t`<h4 part=${e.CSS_PART_TEXT}><slot></slot></h4>`;case"h5":return t`<h5 part=${e.CSS_PART_TEXT}><slot></slot></h5>`;case"h6":return t`<h6 part=${e.CSS_PART_TEXT}><slot></slot></h6>`;case"div":return t`<div part=${e.CSS_PART_TEXT}><slot></slot></div>`;case"span":return t`<span part=${e.CSS_PART_TEXT}><slot></slot></span>`;case"small":return t`<small part=${e.CSS_PART_TEXT}><slot></slot></small>`;case"p":default:return t`<p part=${e.CSS_PART_TEXT}><slot></slot></p>`}}};d.styles=[...p.styles,..._];let r=d;b([y({attribute:"type",reflect:!0,type:String})],r.prototype,"type");b([y({attribute:"tagname",reflect:!0,type:String})],r.prototype,"tagname");r.register(E);const A=a=>t`
<mdc-text type="${a.type}" tagname="${a.tagname}">${a.children}</mdc-text>
`,N={title:"Work In Progress/text",tags:["autodocs"],component:"mdc-text",render:A,parameters:{badges:["wip"]},argTypes:{children:{control:"text",description:'Children (passed into "default" slot)'},type:{options:g.TYPE},tagname:{options:g.TAGNAME},...z,...w,...c(["text"])}},s={args:{type:"body-large-regular",tagname:"",children:"The quick brown fox jumps over the lazy dog"}};var h,f,u;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    type: 'body-large-regular',
    tagname: '',
    children: 'The quick brown fox jumps over the lazy dog'
  }
}`,...(u=(f=s.parameters)==null?void 0:f.docs)==null?void 0:u.source}}};const M=["Primary"];export{s as Primary,M as __namedExportsOrder,N as default};
