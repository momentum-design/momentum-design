import{L as O,T as _}from"./linksimple.component-DaiiL01Q.js";import{k as L}from"./iframe-BPbifbZ6.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BPb3-yOa.js";import"./DataAriaLabelMixin-DTM8lXIn.js";import"./DisabledMixin-DXVt4omm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
