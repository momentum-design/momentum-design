import{L as O,T as _}from"./linksimple.component-BKqCtBVN.js";import{k as L}from"./iframe-DYVUUaGe.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DcQgh6B7.js";import"./DataAriaLabelMixin-BGCIwFaC.js";import"./DisabledMixin-DEYjLYud.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
