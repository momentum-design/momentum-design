import{u as x,V as T,q as f,S as y,U as I,h as i,k as a,B as E,E as b,n as t}from"./iframe-8kqUpADA.js";import{t as v}from"./if-defined-BsU8Vqar.js";import{D as A}from"./DisabledMixin-CF3InGaq.js";import{v as u}from"./v4-CmTdKEVZ.js";const G=x.constructTagName("formfieldwrapper"),n={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},o={VALIDATION:n.DEFAULT,HELPER_TEXT_ID:"helper-text-id",HEADING_ID:"heading-id",ICON_SIZE:20,INFO_ICON:"info-badge-filled",TOGGLETIP_PLACEMENT:"top",TOGGLETIP_STRATEGY:"absolute"},c={TAGNAME:T.SPAN,TYPE:f.BODY_MIDSIZE_REGULAR,HEADER_TYPE:f.BODY_MIDSIZE_BOLD},D=y`
  :host {
