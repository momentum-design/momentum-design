import{L as O,T as _}from"./linksimple.component-BEYlek1_.js";import{k as L}from"./iframe-CWZHLpSW.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BHKaK788.js";import"./DataAriaLabelMixin-I5Wy54UX.js";import"./DisabledMixin-C-G1XPVm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
