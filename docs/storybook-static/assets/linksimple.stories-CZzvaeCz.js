import{L as O,T as _}from"./linksimple.component-BOGiiIpL.js";import{k as L}from"./iframe-D59qSDLK.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-olcxDW8P.js";import"./DataAriaLabelMixin-B-q0EJoW.js";import"./DisabledMixin-MuPyaYa1.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
