import{L as O,T as _}from"./linksimple.component-CTsY7UMn.js";import{k as L}from"./iframe-CqwCe3Q0.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B0TSLC8I.js";import"./DataAriaLabelMixin-hRansJtn.js";import"./DisabledMixin-BRuycW9g.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
