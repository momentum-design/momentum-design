import{L as O,T as _}from"./linksimple.component-COnMJPGI.js";import{k as L}from"./iframe-DSSNydaC.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-Zwr4HrLo.js";import"./DataAriaLabelMixin-WXnwXJEb.js";import"./DisabledMixin-CVvLVeWc.js";import"./index-CrzoWpsH.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
