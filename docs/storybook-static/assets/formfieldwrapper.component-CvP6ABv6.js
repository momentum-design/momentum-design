import{u as b,i as u,D as t,k as r,C as T,n as i}from"./iframe-D1RGJO9g.js";import{t as f}from"./if-defined-CEt-h5rX.js";import{D as I}from"./DisabledMixin-CFnJTGkD.js";import{B as E}from"./button.constants-ctBMf0Nr.js";import{V as y,T as g}from"./index-DcbpN_bp.js";import{h as A}from"./index-CQUTSyim.js";import{v as D}from"./v4-CmTdKEVZ.js";const G=b.constructTagName("formfieldwrapper"),p={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},l={VALIDATION:p.DEFAULT,HELPER_TEXT_ID:"helper-text-id",HEADING_ID:"heading-id",ICON_SIZE:20,INFO_ICON:"info-badge-filled",TOGGLETIP_PLACEMENT:"top"},d={TAGNAME:y.SPAN,TYPE:g.BODY_MIDSIZE_REGULAR,HEADER_TYPE:g.BODY_MIDSIZE_BOLD},N=[A,u`
    :host {
  ...
  `],_=n=>({[p.ERROR]:"error-legacy-badge-filled",[p.WARNING]:"warning-badge-filled",[p.SUCCESS]:"check-circle-badge-filled",[p.PRIORITY]:"priority-badge-filled",[p.DEFAULT]:""})[n]||"";var v=Object.defineProperty,o=(n,a,m,$)=>{for(var s=void 0,c=n.length-1,x;c>=0;c--)(x=n[c])&&(s=x(a,m,s)||s);return s&&v(a,m,s),s};const h=class h extends I(T){constructor(){super(...arguments),this.inputId=`mdc-el-${D()}`,this.required=!1,this.helpTextType=l.VALIDATION,this.toggletipPlacement=l.TOGGLETIP_PLACEMENT,this.shouldRenderLabel=!0}renderLabelElement(){return this.label?this.shouldRenderLabel?r`<label for="${this.inputId}" id="${l.HEADING_ID}" class="mdc-label" part="label">${this.label}</label>`:r` <mdc-text
          id="${l.HEADING_ID}"
          tagname="${d.TAGNAME}"
          type="${d.HEADER_TYPE}"
          part="label"
