import{S as E,U as y,X as R,u as S,q as N,V as I,c as _,k as c,h as O,G as $,n as T}from"./iframe-DlUA9Lme.js";import{B as x}from"./buttonsimple.component-DbCI_knu.js";import"./index-DWTl0clH.js";import{c as w,s as L}from"./commonArgTypes-BluK8w5L.js";import{a as U,t as C}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./keys-hFXe221I.js";import"./DisabledMixin-CAO-9s6U.js";import"./TabIndexMixin-D2-rjBj7.js";import"./index-BLWS0bNq.js";import"./index-DTrDRi1E.js";const V=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,G=[y,V,...R()],D=S.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:N.BODY_MIDSIZE_REGULAR,TAG_NAME:I.SPAN,SIZE:_[24],ROLE:"button"},M=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var P=Object.defineProperty,f=(r,s,h,B)=>{for(var a=void 0,d=r.length-1,p;d>=0;d--)(p=r[d])&&(a=p(s,h,a)||a);return a&&P(s,h,a),a};const m=class m extends x{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return c`
      ...
      ${this.label?c`<mdc-text part="label" type="${e.TEXT_TYPE}" tagname="${e.TAG_NAME}"
            >${this.label}</mdc-text
          >`:O}
    `}};m.styles=[...$.styles,...G];let t=m;f([T({type:String})],t.prototype,"variant");f([T({type:String})],t.prototype,"label");t.register(D);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,j=r=>c` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  ></mdc-alertchip>`,rr={title:"Components/chip/alert",tags:["autodocs"],component:"mdc-alertchip",render:j,argTypes:{variant:{control:"select",options:Object.values(o)},label:{control:"text"},"auto-focus-on-mount":{control:"boolean"},...w,...L,...U(["soft-disabled","size","role","type","active","disabled"]),...C(["--mdc-chip-color","--mdc-chip-icon-color","--mdc-chip-border-color","--mdc-chip-background-color"])}},l={args:{variant:o.NEUTRAL,label:"Alert"}},i={render:()=>c` <div style="display: flex; gap: 0.5rem;">
