import{L as O,T as _}from"./linksimple.component-BJOH6mey.js";import{k as L}from"./iframe-C8zHd0pv.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DlXdJuXq.js";import"./DataAriaLabelMixin-jvYrxui3.js";import"./DisabledMixin-DvV44Swy.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
