import{a6 as E,k as c,a7 as z}from"./iframe-0jBMpi1v.js";import{h as s,r as p}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,C=e=>c`<mdc-link
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
