import{u as E,X as x,a0 as y,k as s,h as n,T,V as g,R as h,H as v,n as o}from"./iframe-CDUGfpod.js";import{D as I}from"./DisabledMixin-BD7V_ocS.js";import{K as R,A}from"./KeyToActionMixin-Bw1bZoEt.js";import{v as m}from"./v4-CmTdKEVZ.js";const H=E.constructTagName("accordiongroup"),f={SMALL:"small",LARGE:"large"},S={BORDERLESS:"borderless",CONTAINED:"contained",STACKED:"stacked"},V={SIZE:f.SMALL,VARIANT:S.STACKED},z=E.constructTagName("accordionbutton"),c={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},L={DEFAULT:"default",BORDERLESS:"borderless"},r={EXPANDED:!1,SIZE:f.SMALL,DATA_ARIA_LEVEL:3,VARIANT:L.DEFAULT,ICON_NAME:c.ARROW_UP},N=x`
  :host {
