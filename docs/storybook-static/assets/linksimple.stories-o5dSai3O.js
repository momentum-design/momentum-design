import{L as O,T as _}from"./linksimple.component-BAXKhTlY.js";import{k as L}from"./iframe-Bh94Y8e_.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CQwAQ_Nn.js";import"./DataAriaLabelMixin-DClF4MYX.js";import"./DisabledMixin-B3aljkDD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
