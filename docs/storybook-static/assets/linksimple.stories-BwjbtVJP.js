import{L as O,T as _}from"./linksimple.component-BU2ZfELN.js";import{k as L}from"./iframe-d_zaQfcU.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-CJ88QP4X.js";import"./DataAriaLabelMixin-VucT6ICS.js";import"./DisabledMixin-ChCzWmbj.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
