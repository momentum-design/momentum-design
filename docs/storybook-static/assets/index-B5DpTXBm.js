import{i as l,k as m}from"./lit-element-D5KKan5q.js";import{n as d}from"./property-Bj3TGwkg.js";import{o as p}from"./query-assigned-elements-uEuc3rg8.js";import{u as h,C as b}from"./provider.component-DrWB4byV.js";import{h as v}from"./index-CqVtAZCJ.js";const g=h.constructTagName("buttongroup"),y={40:40,32:32,28:28,24:24},f={HORIZONTAL:"horizontal",VERTICAL:"vertical"},z={PRIMARY:"primary",SECONDARY:"secondary"},i={SIZE:y[28],VARIANT:z.PRIMARY,ORIENTATION:f.HORIZONTAL},T=l`
  :host {
...
`,A=[v,T];var w=Object.defineProperty,e=(s,t,c,N)=>{for(var r=void 0,n=s.length-1,u;n>=0;n--)(u=s[n])&&(r=u(t,c,r)||r);return r&&w(t,c,r),r};const a=class a extends b{constructor(){super(...arguments),this.orientation=i.ORIENTATION,this.variant=i.VARIANT,this.size=i.SIZE,this.compact=!1}handleSlotChange(){this.buttons.forEach(t=>{t.setAttribute("size",this.size.toString()),t.setAttribute("variant",this.variant)})}updated(t){super.updated(t),(t.has("size")||t.has("variant"))&&this.handleSlotChange()}render(){return m`<div part="container"><slot @slotchange=${this.handleSlotChange}></slot></div>`}};a.styles=[...b.styles,...A];let o=a;e([d({type:String,reflect:!0})],o.prototype,"orientation");e([d({type:String,reflect:!0})],o.prototype,"variant");e([d({type:Number,reflect:!0})],o.prototype,"size");e([d({type:Boolean,reflect:!0})],o.prototype,"compact");e([p({selector:"mdc-button"})],o.prototype,"buttons");o.register(g);export{z as B,f as a,y as b};
