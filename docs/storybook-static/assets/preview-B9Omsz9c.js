 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"ThemeProvider",module:"components/themeprovider/themeprovider.component.js"}}]},{kind:"javascript-module",path:"components/tooltip/tooltip.component.js",declarations:[{kind:"class",description:`A tooltip is triggered by mouse hover or by keyboard focus
 ...
 *
 */`,customElement:!0,slots:[{description:"Default slot for the popover content",name:"",inheritedFrom:{name:"Popover",module:"src/components/popover/popover.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"Tooltip",module:"components/tooltip/tooltip.component.js"}}]},{kind:"javascript-module",path:"components/toggle/toggle.component.js",declarations:[{kind:"class",description:`Toggle Component is an interactive control used to switch between two mutually exclusive options,
