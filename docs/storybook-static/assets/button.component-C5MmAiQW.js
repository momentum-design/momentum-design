import{i as x,k as u}from"./lit-element-D5KKan5q.js";import{n as s}from"./index-C9z9WAEj.js";import{r as p}from"./state-CSSggq2n.js";import{D as c,B as h,a as I,b as l,I as f,P as z}from"./button.constants-Bfip8hYE.js";import{a as g}from"./buttonsimple.component-9hW3yvQZ.js";import{g as k}from"./button.utils-rNW36Ji7.js";var N=Object.defineProperty,m=(n,o,i,r)=>{for(var t=void 0,e=n.length-1,a;e>=0;e--)(a=n[e])&&(t=a(o,i,t)||t);return t&&N(o,i,t),t};const T=n=>{class o extends n{constructor(){super(...arguments),this.variant=c.VARIANT,this.color=c.COLOR,this.typeInternal=c.TYPE_INTERNAL}setVariant(r){this.setAttribute("variant",Object.values(h).includes(r)?r:c.VARIANT)}setColor(r){!Object.values(I).includes(r)||this.variant===h.TERTIARY?this.setAttribute("color",`${c.COLOR}`):this.setAttribute("color",r)}setSize(r){const e=this.typeInternal===l.ICON?Object.values(f).includes(r)&&!(r===f[20]&&this.variant!==h.TERTIARY):Object.values(z).includes(r);this.setAttribute("size",e?`${r}`:`${c.SIZE}`)}inferButtonType(){var t,e;const r=(e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot"))==null?void 0:e.assignedNodes().filter(a=>{var y;return a.nodeType!==Node.TEXT_NODE||((y=a.textContent)==null?void 0:y.trim())}).length;r&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=l.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!r&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=l.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=l.PILL,this.setAttribute("data-btn-type","pill"))}}return m([s({type:String,attribute:"prefix-icon",reflect:!0})],o.prototype,"prefixIcon"),m([s({type:String,attribute:"postfix-icon",reflect:!0})],o.prototype,"postfixIcon"),m([s({type:String})],o.prototype,"variant"),m([s({type:String})],o.prototype,"color"),m([p()],o.prototype,"typeInternal"),o},O=x`
  :host {
...
`,S=[O];var A=Object.defineProperty,b=(n,o,i,r)=>{for(var t=void 0,e=n.length-1,a;e>=0;e--)(a=n[e])&&(t=a(o,i,t)||t);return t&&A(o,i,t),t};const v=class v extends T(g){constructor(){super(...arguments),this.size=c.SIZE,this.role="button"}update(o){super.update(o),o.has("active")&&this.inferFilledIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(o){o?(this.prefixIcon&&(this.prefixFilledIconName=`${k(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${k(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return u`
      ${this.prefixFilledIconName?u` <mdc-icon name="${this.prefixFilledIconName}" part="prefix-icon"></mdc-icon>`:""}
      <slot @slotchange=${this.inferButtonType}></slot>
      ${this.postfixFilledIconName?u` <mdc-icon name="${this.postfixFilledIconName}" part="postfix-icon"></mdc-icon>`:""}
    `}};v.styles=[...g.styles,...S];let d=v;b([s({type:Number})],d.prototype,"size");b([s({type:String,reflect:!0})],d.prototype,"role");b([p()],d.prototype,"prefixFilledIconName");b([p()],d.prototype,"postfixFilledIconName");export{d as B,T as a};
