import{L as O,T as _}from"./linksimple.component-DWfMLvLE.js";import{k as L}from"./iframe-DPiEtQC6.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BBKKqPaV.js";import"./DataAriaLabelMixin-q02ETwny.js";import"./DisabledMixin-DcbfFkR8.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
