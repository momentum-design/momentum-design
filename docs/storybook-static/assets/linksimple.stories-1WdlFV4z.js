import{L as O,T as _}from"./linksimple.component-CpufjmN0.js";import{k as L}from"./iframe-DdxUAY1B.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Dx73VnWw.js";import"./DataAriaLabelMixin-B6s65u7G.js";import"./DisabledMixin-6xG8HQLy.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
