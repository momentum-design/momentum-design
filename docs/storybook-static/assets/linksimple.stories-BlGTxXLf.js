import{L as O,T as _}from"./linksimple.component-CwurwLkZ.js";import{k as L}from"./iframe-DmLJKHqi.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-_tidrUDI.js";import"./DataAriaLabelMixin-C2j_RhRF.js";import"./DisabledMixin-HMwAwQ4p.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
