import{i as h,k as i}from"./lit-element-D5KKan5q.js";import{R as g}from"./class-map-BcCVsMyu.js";import{u as I,C as v,n as d}from"./index-C9z9WAEj.js";import{t as _}from"./if-defined-D5BV9-c0.js";import{I as R}from"./IconNameMixin-CujGSn0t.js";import{R as C}from"./roles-BH_hBfTz.js";import{T as f,V as T}from"./index-BrLJ_9IK.js";import{h as A}from"./index-B-GnYs90.js";import"./index-CvI8uLgO.js";const E=I.constructTagName("badge"),a={DOT:"dot",ICON:"icon",COUNTER:"counter",SUCCESS:"success",WARNING:"warning",ERROR:"error"},m={SUCCESS_ICON_NAME:"check-circle-badge-filled",WARNING_ICON_NAME:"warning-badge-filled",ERROR_ICON_NAME:"error-legacy-badge-filled"},N={PRIMARY:"primary",SECONDARY:"secondary"},l={SUCCESS:"success",WARNING:"warning",ERROR:"error"},t={TYPE:a.DOT,MAX_COUNTER:99,MAX_COUNTER_LIMIT:999,VARIANT:N.PRIMARY,ICON_SIZE:1},O=[A,h`
  ...
  `];var S=Object.defineProperty,n=(b,r,e,y)=>{for(var c=void 0,s=b.length-1,p;s>=0;s--)(p=b[s])&&(c=p(r,e,c)||c);return c&&S(r,e,c),c};const u=class u extends R(v){constructor(){super(...arguments),this.variant=t.VARIANT,this.maxCounter=t.MAX_COUNTER,this.overlay=!1,this.ariaLabel=null}getCounterText(r,e){return e===void 0||typeof e!="number"||r===0?"":e>r?`${r}+`:r>t.MAX_COUNTER_LIMIT||e>t.MAX_COUNTER_LIMIT?`${t.MAX_COUNTER_LIMIT}+`:e.toString()}getBadgeIcon(r,e){return i`
    ...
    `}setRoleByAriaLabel(){this.ariaLabel?this.role=C.IMG:this.role=null}getBadgeContentBasedOnType(){this.variant&&!Object.values(N).includes(this.variant)&&(this.variant=t.VARIANT);const{iconName:r,type:e,variant:y}=this;switch(e){case a.ICON:return this.getBadgeIcon(r||"",y);case a.COUNTER:return this.getBadgeCounterText();case a.SUCCESS:return this.getBadgeIcon(m.SUCCESS_ICON_NAME,l.SUCCESS);case a.WARNING:return this.getBadgeIcon(m.WARNING_ICON_NAME,l.WARNING);case a.ERROR:return this.getBadgeIcon(m.ERROR_ICON_NAME,l.ERROR);case a.DOT:default:return this.type=a.DOT,this.getBadgeDot()}}update(r){super.update(r),r.has("ariaLabel")&&this.setRoleByAriaLabel()}render(){return this.getBadgeContentBasedOnType()}};u.styles=[...v.styles,...O];let o=u;n([d({type:String,reflect:!0})],o.prototype,"type");n([d({type:String,reflect:!0})],o.prototype,"variant");n([d({type:Number})],o.prototype,"counter");n([d({type:Number,attribute:"max-counter",reflect:!0})],o.prototype,"maxCounter");n([d({type:Boolean})],o.prototype,"overlay");n([d({type:String,attribute:"aria-label"})],o.prototype,"ariaLabel");o.register(E);export{t as D,N as I,a as T};
