...
`,Xe=[je];var Ye=Object.defineProperty,d=(t,e,o,i)=>{for(var c=void 0,p=t.length-1,b;p>=0;p--)(b=t[p])&&(c=b(e,o,c)||c);return c&&Ye(e,o,c),c};const O=class O extends Ne(Fe(Ze(G))){constructor(){super(...arguments),this.id="",this.visible=s.VISIBLE,this.zIndex=s.Z_INDEX,this.size=s.SIZE,this.variant=s.VARIANT,this.closeButtonAriaLabel=null,this.ariaLabel=null,this.ariaLabelledby=null,this.ariaDescribedBy=null,this.ariaDescription=null,this.headerTagName=s.HEADER_TAG_NAME,this.descriptionTagName=s.DESCRIPTION_TAG_NAME,this.role=s.ROLE,this.disableAriaHasPopup=s.DISABLE_ARIA_HAS_POPUP,this.focusTrap=s.FOCUS_TRAP,this.preventScroll=!0,this.triggerElement=null,this.backdropElement=null,this.lastActiveElement=null,this.onEscapeKeydown=e=>{!this.visible||e.code!=="Escape"||(e.preventDefault(),e.stopPropagation(),this.closeDialog())}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onEscapeKeydown.bind(this))}disconnectedCallback(){var e,o,i;super.disconnectedCallback(),this.removeEventListener("keydown",this.onEscapeKeydown),(e=this.backdropElement)==null||e.remove(),this.backdropElement=null,(o=this.triggerElement)==null||o.setAttribute("aria-expanded","false"),this.deactivatePreventScroll(),(i=this.deactivateFocusTrap)==null||i.call(this),this.focusBackToTrigger(),v.onDestroyedDialog(this)}async firstUpdated(e){super.firstUpdated(e),this.setAttribute("aria-modal","true"),this.setupAriaLabelledDescribedBy(),this.style.zIndex=`${this.zIndex}`,v.onCreatedDialog(this)}async updated(e){if(super.updated(e),e.has("triggerId")&&(this.triggerElement=this.getRootNode().querySelector(`[id="${this.triggerId}"]`),this.setupAriaHasPopup()),e.has("visible")){const o=e.get("visible");await this.isOpenUpdated(o,this.visible)}e.has("zIndex")&&this.setAttribute("z-index",`${this.zIndex}`),e.has("variant")&&this.updateFooterButtonColors(this.variant),(e.has("ariaLabel")||e.has("ariaLabelledBy")||e.has("ariaDescribedBy")||e.has("ariaDescription")||e.has("headerText")||e.has("descriptionText"))&&this.setupAriaLabelledDescribedBy(),e.has("focusTrap")&&!this.focusTrap&&this.visible&&this.deactivateFocusTrap()}setupAriaHasPopup(){var e,o;this.disableAriaHasPopup||(o=this.triggerElement)==null||o.setAttribute("aria-haspopup",((e=this.triggerElement)==null?void 0:e.getAttribute("aria-haspopup"))||"dialog")}setupAriaLabelledDescribedBy(){!this.ariaLabelledby&&!this.ariaLabel&&(this.headerText?this.setAttribute("aria-label",this.headerText):this.triggerId&&this.setAttribute("aria-labelledby",this.triggerId)),!this.ariaDescribedBy&&!this.ariaDescription&&(this.descriptionText?this.setAttribute("aria-description",this.descriptionText):this.triggerId&&this.setAttribute("aria-describedby",this.triggerId))}createBackdrop(){var i;const e=document.createElement("div");e.classList.add("dialog-backdrop");const o=document.createElement("style");o.textContent=`
    ...
    `,e.appendChild(o),(i=this.parentElement)==null||i.appendChild(e),this.backdropElement=e}closeDialog(){v.onCloseDialog(this,!1)}async isOpenUpdated(e,o){var i,c,p,b,N,F;e!==o&&(o&&!e?(this.lastActiveElement=document.activeElement,this.createBackdrop(),this.activatePreventScroll(),await this.updateComplete,this.focusTrap&&((i=this.activateFocusTrap)==null||i.call(this)),(c=this.setInitialFocus)==null||c.call(this),(p=this.triggerElement)==null||p.setAttribute("aria-expanded","true"),v.onShowDialog(this)):!o&&e&&((b=this.backdropElement)==null||b.remove(),this.backdropElement=null,(N=this.triggerElement)==null||N.setAttribute("aria-expanded","false"),this.deactivatePreventScroll(),(F=this.deactivateFocusTrap)==null||F.call(this),this.focusBackToTrigger(),v.onHideDialog(this)))}focusBackToTrigger(){this.triggerElement?this.triggerElement.focus():this.lastActiveElement&&this.lastActiveElement.focus&&this.lastActiveElement.focus()}render(){return r`
      ${this.headerText?r` <div part="header-section">
            <div part="header">
              <slot name="header-prefix"></slot>
              <mdc-text
                part="header-text"
                tagname="${H[this.headerTagName.toUpperCase()]}"
                type="${R.BODY_LARGE_BOLD}"
              >
                ${this.headerText}
              </mdc-text>
            </div>
            ${this.descriptionText?r`<mdc-text
                  ...
                  tagname="${H[this.descriptionTagName.toUpperCase()]}"
                  type="${R.BODY_MIDSIZE_REGULAR}"
                >
...
`,Je=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
  ...
  `},rt=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${u(t,qe(),o)}
  `},Zt={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:Je,parameters:{badges:["stable"]},argTypes:{...Ge,...Ue,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(we)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},role:{control:"select",options:Object.values(Ve)},size:{control:"select",options:Object.values(m)},visible:{control:"boolean"},...Me(["--mdc-dialog-primary-background-color","--mdc-dialog-border-color","--mdc-dialog-header-text-color","--mdc-dialog-description-text-color","--mdc-dialog-elevation-3","--mdc-dialog-width"])}},l={id:"dialog","z-index":s.Z_INDEX,role:s.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:s.VARIANT},g={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":s.HEADER_TAG_NAME,"description-tag-name":s.DESCRIPTION_TAG_NAME},y={args:{size:s.SIZE,...l,...g}},f={name:"Size: Small",args:{size:m[0],...l,...g}},E={name:"Size: Medium",args:{size:m[1],...l,...g}},I={name:"Size: Large",args:{size:m[2],...l,...g}},A={name:"Size: XLarge",args:{size:m[3],...l,...g}},x={name:"Size: Fullscreen",args:{size:m[4],...l,...g}},D={args:{...l,size:m[0]}},S={render:tt,args:{...l,size:m[0]}},T={render:et,args:{...l,...g,size:s.SIZE}},$={render:Qe,args:{...l,...g,size:s.SIZE}},C={render:t=>r`
  ...
  `},z={render:t=>{const e=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ...
    `},args:{...l,...g,size:s.SIZE,mountDialog:!0,visible:!0}},L={render:ot,args:{...l,size:m[0]}},B={render:it,args:{...l,size:m[0]}},k={render:rt,args:{...l,size:m[0]}};var U,M,W;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
    ...headerDescriptionProperties
  }
}`,...(W=(M=y.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var V,j,X;f.parameters={...f.parameters,docs:{...(V=f.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Size: Small',
  args: {
    size: DIALOG_SIZE[0],
    ...commonProperties,
...
}`,...(ee=(Q=I.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var te,oe,ie;A.parameters={...A.parameters,docs:{...(te=A.parameters)==null?void 0:te.docs,source:{originalSource:`{
  name: 'Size: XLarge',
  args: {
    size: DIALOG_SIZE[3],
    ...commonProperties,
...
}`,...(ie=(oe=A.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var re,ae,se;x.parameters={...x.parameters,docs:{...(re=x.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
}`,...(se=(ae=x.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var ne,de,le;D.parameters={...D.parameters,docs:{...(ne=D.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
...
}`,...(he=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:he.source}}};var be,ve,ye;$.parameters={...$.parameters,docs:{...(be=$.parameters)==null?void 0:be.docs,source:{originalSource:`{
...
}`,...(ye=(ve=$.parameters)==null?void 0:ve.docs)==null?void 0:ye.source}}};var fe,Ee,Ie;C.parameters={...C.parameters,docs:{...(fe=C.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  ...
  \`
}`,...(Ie=(Ee=C.parameters)==null?void 0:Ee.docs)==null?void 0:Ie.source}}};var Ae,xe,De;z.parameters={...z.parameters,docs:{...(Ae=z.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  render: (args: Args) => {
    const onClose = () => {
...
}`,...(De=(xe=z.parameters)==null?void 0:xe.docs)==null?void 0:De.source}}};var Se,Te,$e;L.parameters={...L.parameters,docs:{...(Se=L.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  render: renderWithPopover,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...($e=(Te=L.parameters)==null?void 0:Te.docs)==null?void 0:$e.source}}};var Ce,ze,Le;B.parameters={...B.parameters,docs:{...(Ce=B.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  render: renderDialogWithinDialog,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(Le=(ze=B.parameters)==null?void 0:ze.docs)==null?void 0:Le.source}}};var Be,ke,_e;k.parameters={...k.parameters,docs:{...(Be=k.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  render: renderDialogWithIframe,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(_e=(ke=k.parameters)==null?void 0:ke.docs)==null?void 0:_e.source}}};const Gt=["Example","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe"];export{k as DialogWithIframe,B as DialogWithinDialog,y as Example,z as MountUnmount,L as WithPopover,C as WithoutTriggerElement,Gt as __namedExportsOrder,Zt as default,x as fullscreen,I as large,E as medium,f as small,$ as withCustomHeader,T as withSaveCancelButtons,D as withoutHeader,S as withoutHeaderOrFooter,A as xlarge};
