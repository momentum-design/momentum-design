import{u as E,S as y,X as x,W as f,k as d,V as L,h as T,q as n,G as g,n as s}from"./iframe-Bmqk5ncS.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{K as c}from"./keys-hFXe221I.js";import{D as k}from"./DisabledMixin-CJC0_YR8.js";import{T as I}from"./TabIndexMixin-CoFbKfFN.js";const p={CREATED:"created",DESTROYED:"destroyed",MODIFIED:"modified"},C=l=>{class t extends l{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(p.CREATED,{bubbles:!0,composed:!0}))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(p.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(o){this.dispatchEvent(new CustomEvent(p.MODIFIED,{detail:{change:o},bubbles:!0,composed:!0}))}}return t},O=E.constructTagName("listitem"),D={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},S={VARIANT:D.FULL_WIDTH};class u{static dispatchListItemEvent(t,i){i.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const A=y`
  :host {
...
`,w=[A,...x()];var _=Object.defineProperty,a=(l,t,i,o)=>{for(var r=void 0,h=l.length-1,b;h>=0;h--)(b=l[h])&&(r=b(t,i,r)||r);return r&&_(t,i,r),r};const m=class m extends k(I(C(g))){constructor(){super(),this.variant=S.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||f.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){(t.key===c.ENTER||t.key===c.SPACE)&&(this.triggerClickEvent(),t.preventDefault())}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}getText(t,i,o){return d`
      <slot name="${t}">
        ${o?d`<mdc-text part="${t}" type="${i}" tagname="${L.SPAN}">${o}</mdc-text>`:T}
      </slot>
    ...
    `}};m.styles=[...g.styles,...w];let e=m;a([v({slot:"leading-controls"})],e.prototype,"leadingControlsSlot");a([v({slot:"trailing-controls"})],e.prototype,"trailingControlsSlot");a([s({type:String,reflect:!0})],e.prototype,"variant");a([s({type:String,reflect:!0})],e.prototype,"label");a([s({type:String,reflect:!0,attribute:"secondary-label"})],e.prototype,"secondaryLabel");a([s({type:String,reflect:!0,attribute:"tertiary-label"})],e.prototype,"tertiaryLabel");a([s({type:String,reflect:!0,attribute:"side-header-text"})],e.prototype,"sideHeaderText");a([s({type:String,reflect:!0,attribute:"subline-text"})],e.prototype,"sublineText");a([s({type:Boolean,reflect:!0,attribute:"soft-disabled"})],e.prototype,"softDisabled");export{e as L,O as T,D as a,p as b};
