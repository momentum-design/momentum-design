import{i as E,k as i}from"./lit-element-D5KKan5q.js";import{u as y,C as R,n as f}from"./index-C9z9WAEj.js";import{B as N}from"./buttonsimple.component-DTw2LNsX.js";import{a as S,h as I}from"./index-Cx7wvr8C.js";import{a as x}from"./buttonsimple.constants-CGc1uJX6.js";import{T as $,V as w}from"./index-BrLJ_9IK.js";import"./index-_oWPhii4.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as O,s as _}from"./commonArgTypes-BluK8w5L.js";import{h as L}from"./utils-CO8B6ZcN.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./iframe-BDZCeU0J.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";const C=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,U=[S,C,...I()],V=y.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:w.SPAN,SIZE:x[24],ROLE:"button"},G=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var M=Object.defineProperty,T=(r,s,h,j)=>{for(var a=void 0,m=r.length-1,p;m>=0;m--)(p=r[m])&&(a=p(s,h,a)||a);return a&&M(s,h,a),a};const d=class d extends N{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return i`
    ...
    `}};d.styles=[...R.styles,...U];let t=d;T([f({type:String})],t.prototype,"variant");T([f({type:String})],t.prototype,"label");t.register(V);const P=r=>i` <mdc-alertchip
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
    variant="${r.variant}"
    label="${r.label}"
  ></mdc-alertchip>`,nr={title:"Components/chip/alert",tags:["autodocs"],component:"mdc-alertchip",render:P,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(o)},label:{control:"text"},...O,..._,...L(["soft-disabled","size","role","type","active","disabled"])}},n={args:{variant:o.NEUTRAL,label:"Alert"}},l={render:()=>i` <div style="display: flex; gap: 0.5rem;">
