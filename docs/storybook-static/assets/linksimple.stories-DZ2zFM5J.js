import{L as O,T as _}from"./linksimple.component-cwFkaFLh.js";import{k as L}from"./iframe-D-wtYgP4.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CgebNzyn.js";import"./DataAriaLabelMixin-008vVYaB.js";import"./DisabledMixin-DZ9F4VFG.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
