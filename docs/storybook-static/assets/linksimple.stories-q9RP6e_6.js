import{L as O,T as _}from"./linksimple.component-BAlr1Cf4.js";import{k as L}from"./iframe-CUghFjdA.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-eyDUxJLO.js";import"./DataAriaLabelMixin-C98iEc92.js";import"./DisabledMixin-HSK_t65h.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
