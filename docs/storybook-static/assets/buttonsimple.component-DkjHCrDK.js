import{n as r,U as p,S as m,X as y,D as l,b,k as v,E as f}from"./iframe-C8zHd0pv.js";import{T as E,K as d}from"./TabIndexMixin-BvPyw8u7.js";import{D as g}from"./DisabledMixin-DvV44Swy.js";var S=Object.defineProperty,A=(a,t,s,u)=>{for(var e=void 0,n=a.length-1,h;n>=0;n--)(h=a[n])&&(e=h(t,s,e)||e);return e&&S(t,s,e),e};const x=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=null,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,(this.elementToAutoFocus||this).focus())}}return A([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},T=[p,m`
    :host {
