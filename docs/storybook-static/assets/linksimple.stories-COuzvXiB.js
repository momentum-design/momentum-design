import{L as O,T as _}from"./linksimple.component-CY7be5qA.js";import{k as L}from"./iframe-Dey1eEIV.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-CBLcy0O0.js";import"./DataAriaLabelMixin-DR9c21NF.js";import"./DisabledMixin-Cz2kmvXB.js";import"./index-Tyfr8zZA.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
