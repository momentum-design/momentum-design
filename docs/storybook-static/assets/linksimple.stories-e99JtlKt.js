import{L as O,T as _}from"./linksimple.component-CieCOYlw.js";import{k as L}from"./iframe-vPjlp732.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-Dee02IIX.js";import"./DisabledMixin-1gpg0PKK.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
