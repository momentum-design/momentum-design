import{L as O,T as _}from"./linksimple.component-CP-Nkaqv.js";import{k as L}from"./iframe-CqrI13U9.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cxn4X8l_.js";import"./DataAriaLabelMixin-Deqp14ZC.js";import"./DisabledMixin-DlWJY35l.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
