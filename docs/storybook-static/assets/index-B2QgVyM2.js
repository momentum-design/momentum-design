import{i as b,k as u}from"./lit-element-CHllvULs.js";import{u as p,n}from"./index-HW6KrQZO.js";import{t as a}from"./if-defined-C4tJgJ33.js";import{a as _,h as f}from"./index-CEbgplXA.js";import"./index-BM8hXZXP.js";import{N as k,V as x,D as y,v as E}from"./ValueMixin-BtwaDIvZ.js";import{D as C,F as s}from"./formfieldwrapper.component-CWIPqk6J.js";import"./index-ChCfgxW1.js";const w=[_,b`
  :host {
...
`,...f(!0)],z=p.constructTagName("toggle"),h={DEFAULT:"default",COMPACT:"compact"},g={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},$={compact:.75,default:1.25},m={SIZE:h.DEFAULT};var S=Object.defineProperty,v=(d,e,r,A)=>{for(var o=void 0,l=d.length-1,i;l>=0;l--)(i=d[l])&&(o=i(e,r,o)||o);return o&&S(e,r,o),o};const c=class c extends k(x(y(s))){constructor(){super(),this.checked=!1,this.size=m.SIZE,this.internals=this.attachInternals(),this.helpTextType=void 0,this.id=`mdc-input-${E()}`}get form(){return this.internals.form}setFormValue(){let e=null;this.checked&&(e=this.value?this.value:"isActive"),this.internals.setFormValue(e)}toggleState(){this.disabled||(this.checked=!this.checked)}handleChange(e){this.toggleState();const r=e.constructor;this.dispatchEvent(new r(e.type,e))}setToggleSize(e){this.setAttribute("size",Object.values(h).includes(e)?e:m.SIZE)}update(e){super.update(e),e.has("checked")&&this.setFormValue(),e.has("size")&&this.setToggleSize(this.size)}render(){return u`
        <div class="mdc-toggle__container mdc-focus-ring">
          <input
            ...
            aria-describedby="${C.HELPER_TEXT_ID}"
