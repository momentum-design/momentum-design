import{L as O,T as _}from"./linksimple.component-BgQscXHR.js";import{k as L}from"./iframe-CrBatVCQ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BeA6fpdh.js";import"./DataAriaLabelMixin-BIfSlCgc.js";import"./DisabledMixin-DnkG3zmJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
