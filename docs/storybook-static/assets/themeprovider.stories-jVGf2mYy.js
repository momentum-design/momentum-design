import{R as h,k as v}from"./lit-element-CPYlYYac.js";import{e as u,i as x,t as g}from"./directive-Ctav8iJK.js";import{T as y}from"./index-WBD6358J.js";import{C as b}from"./index-fQJcZKNb.js";import{p as k}from"./index-CQ1swJS0.js";import{d as f,c as B,s as C}from"./utils-D9Sovq17.js";import"./state-GClRgdp0.js";import"./create-context-89xeped_.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const c=u(class extends x{constructor(t){var o;if(super(t),t.type!==g.ATTRIBUTE||t.name!=="class"||((o=t.strings)==null?void 0:o.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(o=>t[o]).join(" ")+" "}update(t,[o]){var a,l;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(e=>e!=="")));for(const e in o)o[e]&&!((a=this.nt)!=null&&a.has(e))&&this.st.add(e);return this.render(o)}const s=t.element.classList;for(const e of this.st)e in o||(s.remove(e),this.st.delete(e));for(const e in o){const m=!!o[e];m===this.st.has(e)||(l=this.nt)!=null&&l.has(e)||(m?(s.add(e),this.st.add(e)):(s.remove(e),this.st.delete(e)))}return h}});class T extends b{constructor(){super(...arguments),this.themeProviderContext=k.consume({host:this,context:y.Context})}render(){var o;return v`
...
`,W={title:"Components/themeprovider",tags:["autodocs"],component:"mdc-themeprovider",render:E,parameters:{badges:["stable"]},argTypes:{themeclass:{options:p,control:{type:"radio"}},...f(["Context","default","--mdc-themeprovider-font-family","--mdc-themeprovider-color-default"]),...B,...C}},r={args:{themeclass:p[0],class:"custom-classname",style:"margin-top: 20px;"}};var n,d,i;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    themeclass: THEMES[0],
    class: 'custom-classname',
    style: 'margin-top: 20px;'
  }
}`,...(i=(d=r.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};const H=["Primary"];export{r as Primary,H as __namedExportsOrder,W as default};
