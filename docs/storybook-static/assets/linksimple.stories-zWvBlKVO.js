import{L as O,T as _}from"./linksimple.component--bn4Ee1B.js";import{k as L}from"./iframe-BfXYEz0b.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DZxbqxdG.js";import"./DataAriaLabelMixin-4Iurz-x0.js";import"./DisabledMixin-DWEdz6jx.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
