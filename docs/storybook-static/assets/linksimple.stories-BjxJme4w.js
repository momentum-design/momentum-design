import{L as O,T as _}from"./linksimple.component-CDA2plDq.js";import{k as L}from"./iframe-CUMIo5cM.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BaB_VRQ0.js";import"./DataAriaLabelMixin-BPQxKJHd.js";import"./DisabledMixin-B8BxQdXB.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
