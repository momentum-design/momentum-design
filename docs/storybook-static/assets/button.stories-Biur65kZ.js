import{q as y,v as ae,w as x,x as g,k as a,y as v,t as o}from"./iframe-_aMQt5aw.js";import{i as h}from"./manifest-CiSp1Z3c.js";import{c as ie,s as re}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,r=e=>a`<mdc-button
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
