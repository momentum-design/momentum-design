import{L as O,T as _}from"./linksimple.component-BoTzm0s0.js";import{k as L}from"./iframe-Cw3hWe9-.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-_ax9bU8M.js";import"./DataAriaLabelMixin-BCyppPyO.js";import"./DisabledMixin-CLuiJxRs.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
