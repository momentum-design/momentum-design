import{L as O,T as _}from"./linksimple.component-5XrnGz5O.js";import{k as L}from"./iframe-C3hfbzB2.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-xbn7Vu_G.js";import"./DataAriaLabelMixin-CnGGodbL.js";import"./DisabledMixin-DlPI71mV.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
