import{u as Z,W as j,S as M,X as W,k as f,h as F,n as g}from"./iframe-CEKo-JXY.js";import{I as K}from"./IconNameMixin-D-f4BQyq.js";import{B as V}from"./buttonsimple.component-Cy86Wmzd.js";import{D as x,L as G}from"./linksimple.component-C2tmAfin.js";import"./index-6vUjwAdH.js";import{i as P}from"./manifest-BmzYojFK.js";import{t as o}from"./if-defined-D_LYpS0s.js";import{c as X,s as Y}from"./commonArgTypes-BluK8w5L.js";import{h as q}from"./utils-CO8B6ZcN.js";import"./preload-helper-C1FmrZbK.js";import"./TabIndexMixin-CdhXJLRg.js";import"./DisabledMixin-BaIDnvgN.js";import"./DataAriaLabelMixin-BrraWAhi.js";import"./index-CFCvY7gN.js";import"./index-DTrDRi1E.js";const H=Z.constructTagName("linkbutton"),s={12:12,14:14,16:16},r={SIZE:s[16],ROLE:j.BUTTON,INLINE:x.INLINE,INVERTED:x.INVERTED},J=e=>{switch(e){case s[12]:return .75;case s[14]:return .875;default:return 1}},Q=M`
  :host {
    gap: 0.25rem;
    cursor: pointer;
...
`,ee=[Q,...W()];var te=Object.defineProperty,h=(e,t,y,ne)=>{for(var n=void 0,v=e.length-1,z;v>=0;v--)(z=e[v])&&(n=z(t,y,n)||n);return n&&te(t,y,n),n};const b=class b extends K(V){constructor(){super(...arguments),this.size=r.SIZE,this.inline=r.INLINE,this.inverted=r.INVERTED}connectedCallback(){super.connectedCallback(),this.active=void 0,this.role=r.ROLE}update(t){super.update(t),t.has("size")&&this.setSize(this.size)}setSize(t){this.setAttribute("size",Object.values(s).includes(t)?`${t}`:r.SIZE.toString())}render(){return f`
      <slot></slot>
      ${this.iconName?f` <mdc-icon name=${this.iconName} size=${J(this.size)} length-unit="rem"></mdc-icon> `:F}
