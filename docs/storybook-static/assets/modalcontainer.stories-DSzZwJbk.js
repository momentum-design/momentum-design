import{i as h,k as E}from"./lit-element-CHllvULs.js";import{u as f,C as u,n as l}from"./index-HW6KrQZO.js";import{t as y}from"./if-defined-C4tJgJ33.js";import{h as T}from"./index-BW6Y21yA.js";import{c as A,s as R}from"./commonArgTypes-BluK8w5L.js";import{d as C}from"./utils-C8za8dl6.js";const N=[T,h`
    :host {
  ...
  `],k=f.constructTagName("modalcontainer"),c={TONAL:"tonal",CONTRAST:"contrast"},d={0:0,1:1,2:2,3:3,4:4},g={DIALOG:"dialog",ALERT_DIALOG:"alertdialog"},a={COLOR:c.TONAL,ELEVATION:d[0],ROLE:g.DIALOG,CHILDREN:"Lorem ipsum dolor sit amet"};var x=Object.defineProperty,i=(o,s,v,S)=>{for(var r=void 0,n=o.length-1,p;n>=0;n--)(p=o[n])&&(r=p(s,v,r)||r);return r&&x(s,v,r),r};const m=class m extends u{constructor(){super(...arguments),this.color=a.COLOR,this.elevation=a.ELEVATION,this.role=a.ROLE}render(){return E`
      <div 
      ...
      `}};m.styles=[...u.styles,...N];let e=m;i([l({type:String,reflect:!0})],e.prototype,"color");i([l({type:Number,reflect:!0})],e.prototype,"elevation");i([l({type:String})],e.prototype,"role");e.register(k);const I=o=>E`
<mdc-modalcontainer
  color="${o.color}"
