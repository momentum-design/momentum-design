import{U as y,W as k,X as T,R as f,k as o,V as p,T as d,h as u,F as x,n as c}from"./iframe-DD1qd397.js";import{K as R,T as S,A as n}from"./KeyToActionMixin-D7mKMv1X.js";import{p as A}from"./index-DhKlRied.js";import{D as E,b as C,a as s,c as h,d as N}from"./stepper.component-BIuArOv3.js";import"./index-DTSLqutf.js";const _=y`
  :host {
    gap: 0.5rem;
    ...
    >`;return this.status===s.ERROR_INCOMPLETE||this.status===s.ERROR_CURRENT?o`<div part="help-text-container">
      ...
      <div part="label-container">
        ${this.label?o`<mdc-text part="label" tagname=${p.SPAN} type=${d.BODY_MIDSIZE_REGULAR}
            ...
            >`:u}
        ${this.renderHelpText()}
      </div>`}};v.styles=[...x.styles,...O];let r=v;i([c({type:String,reflect:!0})],r.prototype,"variant");i([c({type:String,reflect:!0})],r.prototype,"status");i([c({type:String,reflect:!0})],r.prototype,"label");i([c({type:String,reflect:!0,attribute:"help-text"})],r.prototype,"helpText");i([c({type:Number,reflect:!0,attribute:"step-number"})],r.prototype,"stepNumber");r.register(N);
