import{L as O,T as _}from"./linksimple.component-D1l6pyKD.js";import{k as L}from"./iframe-JA1YSOwM.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-Dwys_5eh.js";import"./DisabledMixin-FIsRwQNV.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
