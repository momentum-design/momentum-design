import{L as O,T as _}from"./linksimple.component-CPz4LgiH.js";import{k as L}from"./iframe-g0r6a1kN.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-9wIIfuKU.js";import"./DataAriaLabelMixin-CF3K278-.js";import"./DisabledMixin-jst5IV03.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
