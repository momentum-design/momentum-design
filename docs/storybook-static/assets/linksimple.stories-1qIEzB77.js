import{L as O,T as _}from"./linksimple.component-zJBOzPz9.js";import{k as L}from"./iframe-CYySQeiU.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B3Si03Tk.js";import"./DataAriaLabelMixin-9u5KtbR3.js";import"./DisabledMixin-CYuDVwJu.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
