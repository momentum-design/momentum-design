import{L as O,T as _}from"./linksimple.component-Bkg0rb4T.js";import{k as L}from"./iframe-BBG3qcb4.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Chk36-OD.js";import"./DataAriaLabelMixin-BvEmhVUX.js";import"./DisabledMixin-ehcp4VZr.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
