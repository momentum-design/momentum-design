import{L as R,J as k,K as I,k as h,t as s}from"./iframe-DBPSo1pq.js";import{c as L,s as C}from"./commonArgTypes-BG7EqI50.js";import{h as M}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,z=e=>{const l=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return h` <mdc-password
    @input="${o("oninput")}"
    @change="${o("onchange")}"
    @focus="${o("onfocus")}"
    @blur="${o("onblur")}"
