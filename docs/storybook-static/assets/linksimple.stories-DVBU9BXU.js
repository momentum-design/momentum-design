import{L as O,T as _}from"./linksimple.component-B7BT5jVm.js";import{k as L}from"./iframe-CntZQSOW.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BtXjAhE-.js";import"./DataAriaLabelMixin-BprRbycK.js";import"./DisabledMixin-C-eXDs22.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
