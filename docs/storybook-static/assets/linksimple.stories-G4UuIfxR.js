import{L as O,T as _}from"./linksimple.component-Da9H2qCP.js";import{k as L}from"./iframe-CJFE3lob.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-EpdG_Ezf.js";import"./DataAriaLabelMixin-B7rQZzGy.js";import"./DisabledMixin-Be3N1NAS.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
