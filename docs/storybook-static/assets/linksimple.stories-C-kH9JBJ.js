import{L as O,T as _}from"./linksimple.component-BZu5yR2M.js";import{k as L}from"./iframe-C9zBfpfZ.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cp73i_az.js";import"./DataAriaLabelMixin-Dy-wPdti.js";import"./DisabledMixin-5uIk7xY-.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
