import{L as O,T as _}from"./linksimple.component-D4pxj5Xv.js";import{k as L}from"./iframe-CxOLRwjE.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CL9DC8XJ.js";import"./DataAriaLabelMixin-DGiX42q2.js";import"./DisabledMixin-CTujsFFo.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
