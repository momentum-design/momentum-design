import{L as O,T as _}from"./linksimple.component-Wa33mAF4.js";import{k as L}from"./iframe-BMQAO-1d.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DjrVqlJq.js";import"./DataAriaLabelMixin-DapGYaYX.js";import"./DisabledMixin-B6ArWvcr.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
