import{i as K,k as l}from"./lit-element-CHllvULs.js";import{R as E}from"./class-map-DVSk4OQh.js";import{u as Q,C as _,n as d}from"./index-HW6KrQZO.js";import{t as rr}from"./if-defined-C4tJgJ33.js";import{I as er}from"./IconNameMixin-DXlfdGtk.js";import{T as or,V as ar}from"./text.constants-DJu2q-6E.js";import{h as cr}from"./index-MYSkQ1zX.js";import"./index-BUvIMixM.js";import"./index-BGkqZMsC.js";import{c as tr,s as nr}from"./commonArgTypes-BluK8w5L.js";import{d as dr}from"./utils-D1SE5bce.js";import"./directive-Ctav8iJK.js";import"./state-CWckTc1X.js";import"./index-BYMLCX4c.js";import"./iconprovider.component-CvArfi6w.js";import"./create-context-89xeped_.js";const sr=Q.constructTagName("badge"),r={DOT:"dot",ICON:"icon",COUNTER:"counter",SUCCESS:"success",WARNING:"warning",ERROR:"error"},C={SUCCESS_ICON_NAME:"check-circle-badge-filled",WARNING_ICON_NAME:"warning-badge-filled",ERROR_ICON_NAME:"error-legacy-badge-filled"},N={PRIMARY:"primary",SECONDARY:"secondary"},f={SUCCESS:"success",WARNING:"warning",ERROR:"error"},c={TYPE:r.DOT,MAX_COUNTER:99,MAX_COUNTER_LIMIT:999,VARIANT:N.PRIMARY,ICON_SIZE:1},lr=[cr,K`
    :host {
  ...
  `];var mr=Object.defineProperty,s=(e,o,a,A)=>{for(var n=void 0,R=e.length-1,O;R>=0;R--)(O=e[R])&&(n=O(o,a,n)||n);return n&&mr(o,a,n),n};const I=class I extends er(_){constructor(){super(...arguments),this.variant=c.VARIANT,this.maxCounter=c.MAX_COUNTER,this.overlay=!1,this.ariaLabel=null}getCounterText(o,a){return a===void 0||typeof a!="number"||o===0?"":a>o?`${o}+`:o>c.MAX_COUNTER_LIMIT||a>c.MAX_COUNTER_LIMIT?`${c.MAX_COUNTER_LIMIT}+`:a.toString()}getBadgeIcon(o,a){return l`
      <mdc-icon
...
`,hr={title:"Components/badge",tags:["autodocs"],component:"mdc-badge",render:ir,parameters:{badges:["stable"]},argTypes:{type:{control:"select",options:Object.values(r)},overlay:{control:"boolean"},counter:{if:{arg:"type",eq:r.COUNTER},control:"number"},"max-counter":{if:{arg:"type",eq:r.COUNTER},control:"select",options:m},"icon-name":{if:{arg:"type",eq:r.ICON},control:"text"},variant:{if:{arg:"type",eq:r.ICON},control:"select",options:Object.values(N)},"aria-label":{control:"text"},...dr(["--mdc-badge-primary-foreground-color","--mdc-badge-primary-background-color","--mdc-badge-secondary-foreground-color","--mdc-badge-secondary-background-color","--mdc-badge-success-foreground-color","--mdc-badge-success-background-color","--mdc-badge-warning-foreground-color","--mdc-badge-warning-background-color","--mdc-badge-error-foreground-color","--mdc-badge-error-background-color","--mdc-badge-overlay-background-color"]),...tr,...nr}},i={args:{type:c.TYPE,"icon-name":"placeholder-bold",variant:c.VARIANT,counter:1,"max-counter":m[1],overlay:!1}},g={args:{type:c.TYPE,"icon-name":"placeholder-bold",variant:c.VARIANT,counter:1,"max-counter":m[1],overlay:!1}},u={args:{type:r.ICON,"icon-name":"placeholder-bold",variant:N.PRIMARY,overlay:!1}},p={args:{type:r.COUNTER,counter:10,"max-counter":m[1],overlay:!1}},b={args:{type:r.SUCCESS,overlay:!1}},y={args:{type:r.WARNING,overlay:!1}},v={args:{type:r.ERROR,overlay:!1}},T={render:gr,args:{type:r.COUNTER,counter:1e3,"max-counter":m[2],overlay:!0}};var S,h,x;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
...
}`,...(x=(h=i.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var k,U,M;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
    'icon-name': 'placeholder-bold',
    variant: DEFAULTS.VARIANT,
...
}`,...(J=(H=T.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};const xr=["Example","Dot","Icon","Counter","Success","Warning","Error","Overlay"];export{p as Counter,g as Dot,v as Error,i as Example,u as Icon,T as Overlay,b as Success,y as Warning,xr as __namedExportsOrder,hr as default};
