import{L as O,T as _}from"./linksimple.component-DKC-VzfF.js";import{k as L}from"./iframe-R3L7UhRQ.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-Cp5jgcRU.js";import"./DataAriaLabelMixin-DSN93tx2.js";import"./DisabledMixin-8iYeFgf6.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
