import{L as O,T as _}from"./linksimple.component-DG0WQLQr.js";import{k as L}from"./iframe-CuwwjEPU.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B4bOhVoh.js";import"./DataAriaLabelMixin-B3WjsRvz.js";import"./DisabledMixin-JRvZtrzz.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
