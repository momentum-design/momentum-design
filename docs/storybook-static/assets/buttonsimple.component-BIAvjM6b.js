import{n as r,U as f,S as p,X as v,D as l,b,k as y,G as m}from"./iframe-BuPhkxnS.js";import{K as n}from"./keys-hFXe221I.js";import{D as g}from"./DisabledMixin-C1arkXyT.js";import{T as z}from"./TabIndexMixin-BmouFCHF.js";var E=Object.defineProperty,S=(a,t,i,u)=>{for(var e=void 0,h=a.length-1,d;h>=0;h--)(d=a[h])&&(e=d(t,i,e)||e);return e&&E(t,i,e),e};const A=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=this,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,this.elementToAutoFocus.focus())}}return S([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},x=[f,p`
    :host {
