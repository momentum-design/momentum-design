import{N as f,a4 as u,a9 as g,r as i,k as a,B as b,t as y,C as x,n as r}from"./iframe-BrN8x_Z0.js";import{D as T}from"./DisabledMixin-DjI3Wyw_.js";import{D as e,M as d}from"./formfieldwrapper.constants-OU-UvGf4.js";import{a as v}from"./statusmessage.constants-DjH5p_-2.js";const $=f`
  :host {
...
`,I=[u,$],E=n=>v[n]||"";var A=Object.defineProperty,l=(n,o,p,w)=>{for(var s=void 0,h=n.length-1,m;h>=0;h--)(m=n[h])&&(s=m(o,p,s)||s);return s&&A(o,p,s),s};const c=class c extends T(x){constructor(){super(...arguments),this.inputId=`mdc-el-${g()}`,this.required=!1,this.helpTextType=e.VALIDATION,this.toggletipPlacement=e.TOGGLETIP_PLACEMENT,this.toggletipStrategy=e.TOGGLETIP_STRATEGY,this.readonly=!1,this.softDisabled=!1,this.shouldRenderLabel=!0}renderLabelElement(){return this.label?this.shouldRenderLabel?a`<label for="${this.inputId}" id="${e.HEADING_ID}" part="label">${this.label}</label>`:a` <mdc-text
          id="${e.HEADING_ID}"
          tagname="${d.TAGNAME}"
          type="${d.HEADER_TYPE}"
          part="label"
