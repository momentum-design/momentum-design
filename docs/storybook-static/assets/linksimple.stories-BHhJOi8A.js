import{L as O,T as _}from"./linksimple.component-Dd4I-gVV.js";import{k as L}from"./iframe-B0GLZx71.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CLQPwvwC.js";import"./DataAriaLabelMixin-DrW1rpFN.js";import"./DisabledMixin-DDkP--Xd.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
