import{L as O,T as _}from"./linksimple.component-gG5xl98n.js";import{k as L}from"./iframe-CIeKDA7e.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CPfNo01X.js";import"./DataAriaLabelMixin-BdRvJzuz.js";import"./DisabledMixin-CbT3ZRUJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
