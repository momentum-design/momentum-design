import"./index-CvgOT0Ao.js";import"./index-DblcVKBa.js";import"./index-R2pGWK3o.js";import{$ as m,X as f,a0 as b,h as y,k as u,R as v,n as k}from"./iframe-8tieyzIg.js";import"./index-C10VHij3.js";import{t as c}from"./if-defined-PlGgwzOZ.js";import{F as p}from"./formfieldwrapper.component-D8G_2JYv.js";import{D as g}from"./DataAriaLabelMixin-C8OIRJOz.js";import{F as x}from"./FormInternalsMixin-wrTfCCd2.js";import{D as A}from"./formfieldwrapper.constants-7kWDrmiy.js";import{A as E}from"./buttonsimple.component-BFNsYIkl.js";import{K as R,A as r}from"./KeyToActionMixin-l8VQhGET.js";import{T as $}from"./radio.constants-DT7fG8IL.js";const T=[m,f`
    :host {
  ...
  `,...b(!0)];var C=Object.defineProperty,S=(h,e,t,o)=>{for(var i=void 0,s=h.length-1,a;s>=0;s--)(a=h[s])&&(i=a(e,t,i)||i);return i&&C(e,t,i),i};const l=class l extends R(E(x(g(p)))){constructor(){super(...arguments),this.checked=!1,this.renderLabelAndHelperText=()=>this.label?u`<div part="text-container">${this.renderLabel()} ${this.renderHelperText()}</div>`:y}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}firstUpdated(e){this.updateTabIndex(),this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(e)}getAllRadiosWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-radio[name="${this.name}"]`))}formResetCallback(){this.getAllRadiosWithinSameGroup().forEach(t=>{t.checked=!1}),this.updateComplete.then(()=>{this.setActualFormValue()}).catch(t=>{this.onerror&&this.onerror(t)})}formStateRestoreCallback(e){this.value===e&&e!==""&&(this.checked=!0)}setComponentValidity(e){e?this.internals.setValidity({}):this.required&&!this.checked&&(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()),this.updateTabIndex()}setGroupValidity(e,t){this.updateComplete.then(()=>{e.forEach(o=>{o.setComponentValidity(t)})}).catch(o=>{this.onerror&&this.onerror(o)})}setActualFormValue(){let e="";this.checked?e=this.value?this.value:"on":e=null;const t=this.getAllRadiosWithinSameGroup();if(this.checked)this.setGroupValidity(t,!0);else{const o=t.some(a=>a.required),i=!!t.find(a=>a.checked),s=o&&!i;this.setGroupValidity(t,!s)}this.internals.setFormValue(e)}handleChange(){var o;if(this.disabled||this.readonly||this.softDisabled)return;this.getAllRadiosWithinSameGroup().forEach(i=>{var a;const s=(a=i.shadowRoot)==null?void 0:a.querySelector("input");s&&(i.checked=!1,s.checked=!1)}),this.checked=!0;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("input");t&&(t.checked=!0),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}click(){super.click(),this.handleChange()}updateRadio(e,t){var o,i;(i=(o=e[t].shadowRoot)==null?void 0:o.querySelector("input"))==null||i.focus(),e[t].handleChange()}handleKeyDown(e){var a;if(this.disabled)return;const t=this.getActionForKeyEvent(e);(this.readonly||this.softDisabled)&&t===r.SPACE&&e.preventDefault();const i=this.getAllRadiosWithinSameGroup().filter(d=>!d.disabled),s=i.indexOf(this);if(t===r.DOWN||t===r.RIGHT){const d=(s+1)%i.length;this.updateRadio(i,d)}else if(t===r.UP||t===r.LEFT){const d=(s-1+i.length)%i.length;this.updateRadio(i,d)}else t===r.SPACE&&this.updateRadio(i,s);this.updateTabIndex(),t===r.ENTER&&((a=this.form)==null||a.requestSubmit())}updateTabIndex(){const e=this.getAllRadiosWithinSameGroup(),t=e.find(i=>i.checked),o=e.find(i=>!i.disabled);e.forEach(i=>{var a;const s=(a=i.shadowRoot)==null?void 0:a.querySelector("input");s&&(s.tabIndex=-1,(i===t||!t&&i===o)&&(s.tabIndex=0))})}update(e){super.update(e),e.has("checked")&&this.setActualFormValue()}render(){return u`
      <mdc-staticradio
