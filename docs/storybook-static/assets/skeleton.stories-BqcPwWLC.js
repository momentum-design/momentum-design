import{u as F,X as q,H as C,k as c,n as X}from"./iframe-DBGUNv4F.js";import{c as J,s as Q}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const Y=F.constructTagName("skeleton"),a={BUTTON:"button",CIRCULAR:"circular",RECTANGULAR:"rectangular",ROUNDED:"rounded"},P={VARIANT:a.RECTANGULAR},Z=q`
  :host {
...
`;var ee=Object.defineProperty,te=(e,t,o,n)=>{for(var r=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(r=i(t,o,r)||r);return r&&ee(t,o,r),r};const k=class k extends C{constructor(){super(...arguments),this.variant=P.VARIANT}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}firstUpdated(t){super.firstUpdated(t),this.checkSlotContent()}checkSlotContent(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");t&&(t.assignedNodes().length>0?this.setAttribute("has-content",""):this.removeAttribute("has-content"))}render(){return c`<slot @slotchange=${this.checkSlotContent}></slot>`}};k.styles=[...C.styles,Z];let v=k;te([X({type:String,reflect:!0})],v.prototype,"variant");v.register(Y);let d=0;const l=e=>{d+=1;const t=document.getElementById("normal-content-dynamic"),o=document.getElementById("skeleton-content-dynamic");if(!t||!o)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",o.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${d}`,n.style.cssText=`
...
`,ce={title:"Components/skeleton",tags:["autodocs"],component:"mdc-skeleton",render:re,argTypes:{variant:{control:"select",options:Object.values(a)},...J,...Q}},p={args:{variant:P.VARIANT}},u={args:{variant:a.RECTANGULAR}},m={args:{variant:a.ROUNDED}},x={args:{variant:a.CIRCULAR}},g={args:{variant:a.BUTTON}},b={render:oe,args:{variant:a.RECTANGULAR}},h={render:e=>c`
...
}`,...(G=(V=b.parameters)==null?void 0:V.docs)==null?void 0:G.source}}};var K,W,H;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(H=(W=h.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};var M,z,j;y.parameters={...y.parameters,docs:{...(M=y.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: renderResponsive,
  args: {
    variant: SKELETON_VARIANTS.RECTANGULAR
  }
}`,...(j=(z=y.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const le=["Example","Rectangular","Rounded","Circular","Button","WithContent","DynamicContent","ResponsiveContainer"];export{g as Button,x as Circular,h as DynamicContent,p as Example,u as Rectangular,y as ResponsiveContainer,m as Rounded,b as WithContent,le as __namedExportsOrder,ce as default};
