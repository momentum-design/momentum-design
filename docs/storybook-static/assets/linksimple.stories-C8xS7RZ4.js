import{L as O,T as _}from"./linksimple.component-BYnopXNW.js";import{k as L}from"./iframe-CbqKEQKG.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DdfCTP6H.js";import"./DataAriaLabelMixin-CV9OUUhl.js";import"./DisabledMixin-D1J5BuaC.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
