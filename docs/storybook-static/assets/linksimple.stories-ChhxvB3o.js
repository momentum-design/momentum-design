import{L as O,T as _}from"./linksimple.component-BE9ues43.js";import{k as L}from"./iframe-BuPhkxnS.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BgceRQth.js";import"./DataAriaLabelMixin-D-GayhQ9.js";import"./DisabledMixin-C1arkXyT.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
