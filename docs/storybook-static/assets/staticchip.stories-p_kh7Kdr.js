import"./index-BBF13YOx.js";import"./index-C-SRMMEn.js";import{k as o,R as C}from"./iframe-Ckh9e4At.js";import{i as L}from"./manifest-CiSp1Z3c.js";import{c as y,s as O}from"./commonArgTypes-BG7EqI50.js";import{i}from"./imageFixtures-CD4avj2q.js";import{a as g}from"./utils-B5QUENNQ.js";import{C as s}from"./staticchip.component-CV7t6yhW.js";import"./index-CjtIbAH_.js";import"./preload-helper-C1FmrZbK.js";import"./index-CsitbVGN.js";import"./index-DTrDRi1E.js";import"./IconNameMixin-BhKPZr7y.js";import"./index-ZyDXCzHK.js";const $=a=>o` <mdc-staticchip color="${a.color}" label="${a.label}" icon-name="${a["icon-name"]}"></mdc-staticchip>`,N={title:"Components/chip/staticchip",tags:["autodocs"],component:"mdc-staticchip",render:$,argTypes:{color:{control:"select",options:Object.values(s)},label:{control:"text"},"icon-name":{control:"select",options:Object.keys(L)},...y,...O}},t={args:{color:s.DEFAULT,label:"Label"}},r={args:{color:s.DEFAULT,label:"Label","icon-name":"placeholder-bold"}},e={render:()=>o` <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
