import{L as O,T as _}from"./linksimple.component-DF0oBa9m.js";import{k as L}from"./iframe-CoZufWyv.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B0318-pP.js";import"./DataAriaLabelMixin-CZeKGBaN.js";import"./DisabledMixin-oyOWrvDE.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
