import{L as O,T as _}from"./linksimple.component-BTbZZtyi.js";import{k as L}from"./iframe-Ci39ks_7.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cx4K7iaJ.js";import"./DataAriaLabelMixin-C4a3RZbM.js";import"./DisabledMixin-BnT5U332.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
