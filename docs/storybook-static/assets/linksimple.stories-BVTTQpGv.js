import{L as O,T as _}from"./linksimple.component-CvjA7LyC.js";import{k as L}from"./iframe-Cb3u3nyl.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-j43Q-Ntx.js";import"./DataAriaLabelMixin-DQqulGiN.js";import"./DisabledMixin-DfpaWmCs.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
