import{q as y,v as ee,w as v,x as g,k as r,y as $,t as n}from"./iframe-CVFDchpT.js";import{i as x}from"./manifest-CiSp1Z3c.js";import{c as ne,s as oe}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,i=e=>r`<mdc-button
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @keyup="${o("onkeyup")}"
    @focus="${o("onfocus")}"
