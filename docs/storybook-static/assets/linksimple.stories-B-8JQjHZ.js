import{L as O,T as _}from"./linksimple.component-ZS_QYP7h.js";import{k as L}from"./iframe-76amofum.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-7jQsw5t8.js";import"./DataAriaLabelMixin-CHCnKcIp.js";import"./DisabledMixin-C1ZVI1WF.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
