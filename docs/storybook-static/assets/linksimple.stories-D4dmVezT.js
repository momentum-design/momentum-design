import{L as O,T as _}from"./linksimple.component-CQcnggdX.js";import{k as L}from"./iframe-bzVLHCLd.js";import{h as s,r as d}from"./utils-CO8B6ZcN.js";import"./if-defined-N96FXNFV.js";import"./DataAriaLabelMixin-CZgyIvjm.js";import"./DisabledMixin-D3qipKRq.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
