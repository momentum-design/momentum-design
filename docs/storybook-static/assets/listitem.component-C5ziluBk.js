...
`,w=[_,...x()];var R=Object.defineProperty,a=(d,t,e,r)=>{for(var o=void 0,p=d.length-1,b;p>=0;p--)(b=d[p])&&(o=b(t,e,o)||o);return o&&R(t,e,o),o};const m=class m extends k(I(D(A(g)))){constructor(){super(),this.variant=S.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||f.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){const e=this.getActionForKeyEvent(t);(e===c.ENTER||e===c.SPACE)&&this.triggerClickEvent(t)&&t.preventDefault()}triggerClickEvent(t){const e=t.target;if(e!==this&&document.activeElement===e)return!1;const r=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});return this.dispatchEvent(r),!0}getText(t,e,r){return n`
      <slot name="${t}">
