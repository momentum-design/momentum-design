import{L as O,T as _}from"./linksimple.component-Cy_kj96v.js";import{k as L}from"./iframe-FsJupGEy.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-DVUNjen0.js";import"./DataAriaLabelMixin-Bep5TxVc.js";import"./DisabledMixin-BNs-mtYk.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
