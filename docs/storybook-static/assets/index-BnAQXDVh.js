import{u as y,n as c,a5 as z,a4 as I,T as s,z as p,k as h,t as v,C as f,U as O}from"./iframe-CYZ064vw.js";import{I as M}from"./IconNameMixin-DeWqQ5kO.js";import{a as n}from"./index-CrTG-VGM.js";import"./index-C-a6jsM_.js";const C=y.constructTagName("avatar"),r={COUNTER:"counter",ICON:"icon",PHOTO:"photo",TEXT:"text"},T=99,x="user-regular",t={24:24,32:32,48:48,64:64,72:72,88:88,124:124},b={TYPE:r.PHOTO,SIZE:t[32],ICON_NAME:x};var _=Object.defineProperty,l=(a,e,i,E)=>{for(var o=void 0,d=a.length-1,m;d>=0;d--)(m=a[d])&&(o=m(e,i,o)||o);return o&&_(e,i,o),o};const P=a=>{class e extends a{constructor(){super(...arguments),this.size=b.SIZE,this.isTyping=!1}}return l([c({type:String})],e.prototype,"src"),l([c({type:String})],e.prototype,"initials"),l([c({type:String})],e.prototype,"presence"),l([c({type:Number,reflect:!0,attribute:"size"})],e.prototype,"size"),l([c({type:Number})],e.prototype,"counter"),l([c({type:Boolean,attribute:"is-typing"})],e.prototype,"isTyping"),e},N=[z,I`
    :host {
  ...
  `],k=a=>({[t[124]]:n[124],[t[88]]:n[88],[t[72]]:n[72],[t[64]]:n[64],[t[48]]:n[48],[t[32]]:n[32],[t[24]]:n[24]})[a]||n[32],A=a=>({[t[124]]:4.75,[t[88]]:3,[t[72]]:2.5,[t[64]]:2.25,[t[48]]:1.75,[t[32]]:1.25,[t[24]]:1})[a]||1.25,S=a=>({[t[124]]:s.HEADING_XLARGE_MEDIUM,[t[88]]:s.HEADING_LARGE_MEDIUM,[t[72]]:s.HEADING_MIDSIZE_MEDIUM,[t[64]]:s.HEADING_SMALL_MEDIUM,[t[48]]:s.HEADING_SMALL_MEDIUM,[t[32]]:s.BODY_MIDSIZE_MEDIUM,[t[24]]:s.BODY_SMALL_MEDIUM})[a]||s.BODY_MIDSIZE_MEDIUM;var D=Object.defineProperty,w=(a,e,i,E)=>{for(var o=void 0,d=a.length-1,m;d>=0;d--)(m=a[d])&&(o=m(e,i,o)||o);return o&&D(e,i,o),o};const g=class g extends P(M(f)){constructor(){super(...arguments),this.isPhotoLoaded=!1}connectedCallback(){super.connectedCallback(),this.hasAttribute("aria-hidden")||this.setAttribute("aria-hidden","true")}getPresenceTemplateBasedOnType(e){return e===r.COUNTER&&(this.counter||this.counter===0)||this.isTyping?p:this.presence?h`
    ...
    `}iconTemplate(){const e=this.iconName||b.ICON_NAME;return h`
      <mdc-icon name="${v(e)}" length-unit="rem" size="${A(this.size)}"></mdc-icon>
