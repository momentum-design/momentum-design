import{L as O,T as _}from"./linksimple.component-5w6_GCix.js";import{k as L}from"./iframe-DoNkonBK.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-B36DAkUP.js";import"./DataAriaLabelMixin-BGH72T46.js";import"./DisabledMixin-CrQfIA6t.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
