import{u as W,i as Q,D as k,k as i,n as Z}from"./iframe-D1RGJO9g.js";import{D as J}from"./DisabledMixin-CFnJTGkD.js";import{T as ee}from"./TabIndexMixin-Bl7-LDRA.js";import{C as x}from"./card.component-sQMz3z2M.js";import{R as te}from"./roles-CJI3JVG-.js";import{K as y}from"./keys-hFXe221I.js";import{a as ae}from"./index-CQUTSyim.js";import"./index-DGuVKFIz.js";import{V as N}from"./index-DcbpN_bp.js";import"./index-B5LdQlA2.js";import{Q as ie}from"./repeat-CE2VsrkU.js";import{i as o}from"./imageFixtures-CD4avj2q.js";import{c as re,s as oe}from"./commonArgTypes-BluK8w5L.js";import{a as le,t as ce,d as ne}from"./utils-CFOyPOhY.js";import{V as se,O as E,D as t}from"./FooterMixin-DLbXtUD_.js";import"./index-C4egtCmy.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-ctBMf0Nr.js";import"./buttonsimple.constants-DiW5GZvm.js";import"./index-0dAn93WX.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";import"./link.constants-BgTVyZl7.js";import"./index-B4ra579S.js";import"./button.component-DqAqkrM0.js";import"./buttonsimple.component-bVzR6LPV.js";import"./button.utils-rNW36Ji7.js";import"./index-BUahXgHb.js";import"./popover.component-DYjVfDou.js";import"./if-defined-CEt-h5rX.js";import"./index-AkGujtMl.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-DzXGOr4J.js";import"./formfieldwrapper.component-CvP6ABv6.js";const de=W.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},T={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},me=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,be=[me,...ae()];var ue=Object.defineProperty,q=(e,a,I,he)=>{for(var l=void 0,A=e.length-1,f;A>=0;A--)(f=e[A])&&(l=f(a,I,l)||l);return l&&ue(a,I,l),l};const C=class C extends J(ee(x)){constructor(){super(),this.checked=!1,this.selectionType=T.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=te.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}toggleOnEnter(a){a.key===y.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===y.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case r.CHECK:return i`<mdc-icon
    ...
    `}};C.styles=[...x.styles,...be];let s=C;q([Z({type:Boolean,reflect:!0})],s.prototype,"checked");q([Z({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(de);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,pe=e=>i` <mdc-cardcheckbox
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
...
}`,...(U=(H=b.parameters)==null?void 0:H.docs)==null?void 0:U.source}}};var _,G,M;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    'image-src': imageFixtures.card,
    'image-alt': 'Image Alt',
    'card-title': 'Title',
...
}`,...(V=(K=p.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var P,w,Y;h.parameters={...h.parameters,docs:{...(P=h.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': imageFixtures.card,
