import{L as O,T as _}from"./linksimple.component-DVRd5Ntu.js";import{k as L}from"./iframe-B0KTrzx9.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DNHI_5dY.js";import"./DataAriaLabelMixin-D8WkMzZs.js";import"./DisabledMixin-mZwCl_Iz.js";import"./index-fannbufq.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
