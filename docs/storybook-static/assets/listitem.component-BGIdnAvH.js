import{i as h,D as u,k as p}from"./lit-element-D5KKan5q.js";import{u as x,C as g,n as l}from"./index-C9z9WAEj.js";import{o as b}from"./query-assigned-elements-uEuc3rg8.js";import{D as y}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{D as v}from"./DisabledMixin-BZruwOeC.js";import{T as f}from"./TabIndexMixin-CsrHswKP.js";import{V as T,T as o}from"./text.constants-ZF0jM5wn.js";import{h as L}from"./index-DoSuNddn.js";const U=x.constructTagName("listitem"),S={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},A={VARIANT:S.FULL_WIDTH},_=h`
  :host {
...
`,k=[_,...L()];var E=Object.defineProperty,r=(c,t,a,s)=>{for(var i=void 0,d=c.length-1,m;d>=0;d--)(m=c[d])&&(i=m(t,a,i)||i);return i&&E(t,a,i),i};const n=class n extends y(v(f(g))){constructor(){super(...arguments),this.variant=A.VARIANT}connectedCallback(){super.connectedCallback(),this.role=this.role||"listitem"}getText(t,a,s){return s?p`
      <slot name="${t}">
        <mdc-text part="${t}" type="${a}" tagname="${T.SPAN}">${s}</mdc-text>
      </slot>
    `:u}disableSlottedChildren(t){[...this.leadingControlsSlot,...this.trailingControlsSlot].forEach(a=>{t?a.setAttribute("disabled",""):a.removeAttribute("disabled")})}update(t){super.update(t),t.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.disableSlottedChildren(this.disabled))}render(){return p`
      <div part="leading">
