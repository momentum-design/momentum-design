import{L as O,T as _}from"./linksimple.component-n1OKjKkA.js";import{k as L}from"./iframe-C3odBbWY.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Dl1lZBmV.js";import"./DataAriaLabelMixin-D1TIsjRl.js";import"./DisabledMixin-Cr88gAxL.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
