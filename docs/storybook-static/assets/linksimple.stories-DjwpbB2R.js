import{L as O,T as _}from"./linksimple.component-BxJSV21z.js";import{k as L}from"./iframe-BV7DidLN.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-CldWBRdg.js";import"./DataAriaLabelMixin-BHvhAZgM.js";import"./DisabledMixin-CFB-Ad_A.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
