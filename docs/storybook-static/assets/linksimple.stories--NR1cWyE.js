import{L as O,T as _}from"./linksimple.component-B-srRzoq.js";import{k as L}from"./iframe-CJlGbpLK.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-gIJDNoJr.js";import"./DataAriaLabelMixin-Bf3ruTzO.js";import"./DisabledMixin-mP4mLypm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
