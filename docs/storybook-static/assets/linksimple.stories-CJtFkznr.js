import{L as O,T as _}from"./linksimple.component-BZAPnEIm.js";import{k as L}from"./iframe-DpwhjFqY.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DNNAtBik.js";import"./DataAriaLabelMixin-BSw8NNrL.js";import"./DisabledMixin-C-fL9D7b.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
