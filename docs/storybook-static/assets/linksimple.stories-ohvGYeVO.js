import{L as O,T as _}from"./linksimple.component-BJA-7LFv.js";import{k as L}from"./iframe-D5_nhDxE.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-DPoTFAdO.js";import"./DataAriaLabelMixin-HyXe-YiN.js";import"./DisabledMixin-BAU8JVJU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
