import{L as O,T as _}from"./linksimple.component-Dt8s8gKg.js";import{k as L}from"./iframe-B2YnbzSa.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-P6qiCRpl.js";import"./DataAriaLabelMixin-147MVFPi.js";import"./DisabledMixin-D4sdQ94t.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
