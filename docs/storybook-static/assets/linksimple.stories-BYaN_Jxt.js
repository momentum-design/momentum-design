import{L as O,T as _}from"./linksimple.component-WSq_0P7q.js";import{k as L}from"./iframe-CN8BX08X.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-ELOi9WTw.js";import"./DataAriaLabelMixin-2Zo7EJP9.js";import"./DisabledMixin-DwuxRxno.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
