import{L as O,T as _}from"./linksimple.component-Dy8aryhP.js";import{k as L}from"./iframe-DbFhe1C8.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-D0TzS11l.js";import"./DataAriaLabelMixin-DtwoeGMi.js";import"./DisabledMixin--7NqFN-A.js";import"./index-CO0us3Ia.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
