import{L as O,T as _}from"./linksimple.component-ChZbzv4Q.js";import{k as L}from"./iframe-Ckh9e4At.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-CSpCeYtV.js";import"./DisabledMixin-iesT_1WC.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
