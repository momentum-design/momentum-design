import{i as g,k as a}from"./lit-element-CPYlYYac.js";import{u,C as p,n as h}from"./index-BLShQaRP.js";const x=u.constructTagName("text"),b={BODY_SMALL_REGULAR:"body-small-regular",BODY_SMALL_MEDIUM:"body-small-medium",BODY_SMALL_BOLD:"body-small-bold",BODY_MIDSIZE_REGULAR:"body-midsize-regular",BODY_MIDSIZE_MEDIUM:"body-midsize-medium",BODY_MIDSIZE_BOLD:"body-midsize-bold",BODY_LARGE_REGULAR:"body-large-regular",BODY_LARGE_MEDIUM:"body-large-medium",BODY_LARGE_BOLD:"body-large-bold",BODY_SMALL_REGULAR_UNDERLINE:"body-small-regular-underline",BODY_SMALL_MEDIUM_UNDERLINE:"body-small-medium-underline",BODY_MIDSIZE_REGULAR_UNDERLINE:"body-midsize-regular-underline",BODY_MIDSIZE_MEDIUM_UNDERLINE:"body-midsize-medium-underline",BODY_LARGE_REGULAR_UNDERLINE:"body-large-regular-underline",BODY_LARGE_MEDIUM_UNDERLINE:"body-large-medium-underline",HEADING_SMALL_REGULAR:"heading-small-regular",HEADING_SMALL_MEDIUM:"heading-small-medium",HEADING_SMALL_BOLD:"heading-small-bold",HEADING_MIDSIZE_REGULAR:"heading-midsize-regular",HEADING_MIDSIZE_MEDIUM:"heading-midsize-medium",HEADING_MIDSIZE_BOLD:"heading-midsize-bold",HEADING_LARGE_REGULAR:"heading-large-regular",HEADING_LARGE_MEDIUM:"heading-large-medium",HEADING_LARGE_BOLD:"heading-large-bold",HEADING_XLARGE_REGULAR:"heading-xlarge-regular",HEADING_XLARGE_MEDIUM:"heading-xlarge-medium",HEADING_XLARGE_BOLD:"heading-xlarge-bold",HEADLINE_SMALL_LIGHT:"headline-small-light",HEADLINE_SMALL_REGULAR:"headline-small-regular"},t={H1:"h1",H2:"h2",H3:"h3",H4:"h4",H5:"h5",H6:"h6",P:"p",SMALL:"small",SPAN:"span",DIV:"div"},e={TYPE:b.BODY_LARGE_REGULAR,TEXT_ELEMENT_TAGNAME:t.P,CSS_PART_TEXT:"text",CHILDREN:"The quick brown fox jumps over the lazy dog"},v=g`
...
`,y=[g`
  ...
  `,v];var c=Object.defineProperty,f=(n,r,l,z)=>{for(var i=void 0,d=n.length-1,m;d>=0;d--)(m=n[d])&&(i=m(r,l,i)||i);return i&&c(r,l,i),i};const s=class s extends p{constructor(){super(...arguments),this.type=e.TYPE,this.tagname=e.TEXT_ELEMENT_TAGNAME}render(){switch(this.tagname){case t.H1:return a`<h1 part=${e.CSS_PART_TEXT}><slot></slot></h1>`;case t.H2:return a`<h2 part=${e.CSS_PART_TEXT}><slot></slot></h2>`;case t.H3:return a`<h3 part=${e.CSS_PART_TEXT}><slot></slot></h3>`;case t.H4:return a`<h4 part=${e.CSS_PART_TEXT}><slot></slot></h4>`;case t.H5:return a`<h5 part=${e.CSS_PART_TEXT}><slot></slot></h5>`;case t.H6:return a`<h6 part=${e.CSS_PART_TEXT}><slot></slot></h6>`;case t.DIV:return a`<div part=${e.CSS_PART_TEXT}><slot></slot></div>`;case t.SPAN:return a`<span part=${e.CSS_PART_TEXT}><slot></slot></span>`;case t.SMALL:return a`<small part=${e.CSS_PART_TEXT}><slot></slot></small>`;case t.P:default:return a`<p part=${e.CSS_PART_TEXT}><slot></slot></p>`}}};s.styles=[...p.styles,...y];let o=s;f([h({attribute:"type",reflect:!0,type:String})],o.prototype,"type");f([h({attribute:"tagname",reflect:!0,type:String})],o.prototype,"tagname");o.register(x);export{e as D,b as F,t as V};
