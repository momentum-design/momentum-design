import{i as m,k as f}from"./lit-element-CHllvULs.js";import{n as o,C as b}from"./index-HW6KrQZO.js";import{h as p,a as v}from"./index-CcvxQn6k.js";import{D as l,a as u,T as g}from"./buttonsimple.constants-5FOanXlE.js";const z=[p,m`
  :host {
...
`,v];var y=Object.defineProperty,x=(i,t,s,c)=>{for(var e=void 0,r=i.length-1,a;r>=0;r--)(a=i[r])&&(e=a(t,s,e)||e);return e&&y(t,s,e),e};const E=i=>{class t extends i{constructor(){super(...arguments),this.disabled=!1}}return x([o({reflect:!0,type:Boolean})],t.prototype,"disabled"),t};var k=Object.defineProperty,A=(i,t,s,c)=>{for(var e=void 0,r=i.length-1,a;r>=0;r--)(a=i[r])&&(e=a(t,s,e)||e);return e&&k(t,s,e),e};const D=i=>{class t extends i{constructor(){super(...arguments),this.tabIndex=0}}return A([o({reflect:!0,type:Number})],t.prototype,"tabIndex"),t};var T=Object.defineProperty,n=(i,t,s,c)=>{for(var e=void 0,r=i.length-1,a;r>=0;r--)(a=i[r])&&(e=a(t,s,e)||e);return e&&T(t,s,e),e};const d=class d extends D(E(b)){constructor(){super(),this.active=!1,this.softDisabled=!1,this.size=l.SIZE,this.role=l.ROLE,this.type=l.TYPE,this.prevTabindex=0,this.addEventListener("click",this.executeAction.bind(this)),this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.handleKeyUp.bind(this)),this.internals=this.attachInternals()}get form(){return this.internals.form}update(t){super.update(t),t.has("disabled")&&this.setDisabled(this,this.disabled),t.has("softDisabled")&&this.setSoftDisabled(this,this.softDisabled),t.has("active")&&this.setAriaPressed(this,this.active)}executeAction(){this.type===u.SUBMIT&&this.internals.form&&this.internals.form.requestSubmit(),this.type===u.RESET&&this.internals.form&&this.internals.form.reset()}setAriaPressed(t,s){s?t.setAttribute("aria-pressed","true"):t.setAttribute("aria-pressed","false")}setSoftDisabled(t,s){s?t.setAttribute("aria-disabled","true"):t.setAttribute("aria-disabled","false")}setDisabled(t,s){s?(t.setAttribute("aria-disabled","true"),this.prevTabindex=this.tabIndex,this.tabIndex=-1):(this.tabIndex=this.prevTabindex,t.removeAttribute("aria-disabled"))}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t),this.executeAction()}handleKeyDown(t){["Enter"," "].includes(t.key)&&(this.classList.add("pressed"),t.key==="Enter"&&this.triggerClickEvent())}handleKeyUp(t){["Enter"," "].includes(t.key)&&(this.classList.remove("pressed"),t.key===" "&&this.triggerClickEvent())}render(){return f`
      <slot></slot>
    `}};d.formAssociated=!0,d.styles=[...b.styles,...z];let h=d;n([o({type:Boolean})],h.prototype,"active");n([o({type:Boolean,attribute:"soft-disabled"})],h.prototype,"softDisabled");n([o({type:Number,reflect:!0})],h.prototype,"size");n([o({type:String,reflect:!0})],h.prototype,"role");n([o({reflect:!0})],h.prototype,"type");h.register(g);export{h as B};
