import{L as O,T as _}from"./linksimple.component-ClLjrYh5.js";import{k as L}from"./iframe-Bay37rkC.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-D3HSOGID.js";import"./DataAriaLabelMixin-CGUBvNd2.js";import"./DisabledMixin-DGD1GTFB.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
