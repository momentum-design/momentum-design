import{i as f,k as o}from"./lit-element-D5KKan5q.js";import{n as a}from"./property-Bj3TGwkg.js";import{t as m}from"./if-defined-D5BV9-c0.js";import{C as u}from"./provider.component-DrWB4byV.js";import{p as x}from"./index-CwZu4Wnd.js";import{R as c}from"./roles-CJI3JVG-.js";import{S as v}from"./sidenavigation.component-C3IZAf9m.js";import{b,T as y}from"./menuitemradio.constants-CB6EqhSm.js";import"./index-BIjOS-EW.js";const g=f`
  :host {
    display: flex;
...
`,T=[g];var C=Object.defineProperty,d=(l,e,i,h)=>{for(var t=void 0,s=l.length-1,p;s>=0;s--)(p=l[s])&&(t=p(e,i,t)||t);return t&&C(e,i,t),t};const n=class n extends u{constructor(){super(...arguments),this.ariaLabel=null,this.headerText=null,this.showDivider=!1,this.dividerVariant=b.DIVIDER_VARIANT,this.hideHeaderText=!1,this.sideNavigationContext=x.consume({host:this,context:v.Context})}connectedCallback(){super.connectedCallback(),this.setAttribute("role",c.GROUP)}update(e){var t;super.update(e),(e.has("ariaLabel")||e.has("headerText"))&&(!this.ariaLabel||this.ariaLabel===e.get("headerText"))&&(this.ariaLabel=this.headerText||"");const i=(t=this.sideNavigationContext)==null?void 0:t.value;if(!i)return;const{expanded:h}=i;this.hideHeaderText=!h}renderHeader(){var e,i;return this.headerText?o` <mdc-listheader
        part="header ${(i=(e=this.sideNavigationContext)==null?void 0:e.value)!=null&&i.expanded?"align-header":""}"
        header-text="${this.headerText}"
        prefix-icon="${m(this.prefixIcon)}"
      >
