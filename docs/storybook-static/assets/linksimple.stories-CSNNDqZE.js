import{L as O,T as _}from"./linksimple.component-CLC_fT3r.js";import{k as L}from"./iframe-D0yPktIr.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BQWKbkiE.js";import"./DataAriaLabelMixin-D5V9c7RW.js";import"./DisabledMixin-BQzZeYPM.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
