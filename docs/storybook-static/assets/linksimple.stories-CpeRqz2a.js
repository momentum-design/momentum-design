import{L as O,T as _}from"./linksimple.component-BazoQ6hO.js";import{k as L}from"./iframe-8kqUpADA.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BsU8Vqar.js";import"./DataAriaLabelMixin-D1hWArok.js";import"./DisabledMixin-CF3InGaq.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
