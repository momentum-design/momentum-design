import{L as O,T as _}from"./linksimple.component-OjCr7bCm.js";import{k as L}from"./iframe-Dc28Xrb1.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DBtV9pXV.js";import"./DataAriaLabelMixin-BnqvoANb.js";import"./DisabledMixin-CgpNJ15w.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
