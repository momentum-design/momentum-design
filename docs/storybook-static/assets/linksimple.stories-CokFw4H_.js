import{L as O,T as _}from"./linksimple.component-DArL5Sng.js";import{k as L}from"./iframe-CB9sX04z.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DiX5XKya.js";import"./DataAriaLabelMixin-CiRSeEtg.js";import"./DisabledMixin-CiPsgT_4.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
