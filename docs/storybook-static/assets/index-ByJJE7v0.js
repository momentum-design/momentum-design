import"./index-6vUjwAdH.js";import"./index-Ddlkrx38.js";import{S as u,W as f,k as c,h as l,T as s,n as k}from"./iframe-CEKo-JXY.js";import"./index-B9IRq2YG.js";import{R as b}from"./class-map-B_67JOfd.js";import{M as h}from"./menuitem.component-Dl-D_3Bv.js";import{D as A,T as g,I as m,a as R}from"./menuitemradio.constants-CoYfXNer.js";import{b as E}from"./menupopover.constants-DXcZIuJ2.js";import{a as T}from"./ControlTypeMixin-BZ0oKTlg.js";const $=u`
...
`,v=[$];var y=Object.defineProperty,p=(d,t,i,C)=>{for(var e=void 0,a=d.length-1,n;a>=0;a--)(n=d[a])&&(e=n(t,i,e)||e);return e&&y(t,i,e),e};const o=class o extends T(h){constructor(){super(),this.checked=!1,this.indicator=A.INDICATOR,this.addEventListener("click",this.handleMouseClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=f.MENUITEMRADIO}getAllRadiosWithinSameGroup(){const t=this.closest(`${g}, ${E}`);return!t||!this.name?[]:Array.from(t.querySelectorAll(`${this.tagName}[name="${this.name}"]`))}updateOtherRadiosCheckedState(){this.getAllRadiosWithinSameGroup().forEach(i=>{i!==this&&i.removeAttribute("checked")})}handleMouseClick(){this.disabled||this.softDisabled||this.checked||(this.controlType!=="controlled"&&(this.updateOtherRadiosCheckedState(),this.checked=!0),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}update(t){super.update(t),t.has("checked")&&(this.ariaChecked=`${this.checked}`,t.get("checked")===!1&&this.checked&&this.updateOtherRadiosCheckedState())}renderStaticRadio(){return this.indicator===m.RADIO?c`
    ...
    `}};o.styles=[...h.styles,...v];let r=o;p([k({type:Boolean,reflect:!0})],r.prototype,"checked");p([k({type:String,reflect:!0})],r.prototype,"indicator");r.register(R);
