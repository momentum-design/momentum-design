import{i as u,D as p,k as l}from"./lit-element-D5KKan5q.js";import{n as a}from"./index-C9z9WAEj.js";import{t as o}from"./if-defined-D5BV9-c0.js";import{D as b}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as k}from"./FormInternalsMixin-CSixOKbK.js";import{D as f,F as m}from"./formfieldwrapper.component-DGQBm8Ze.js";import{a as v}from"./index-CcXofQbA.js";import{T as x}from"./index-fyAnohE1.js";import"./index-Jm4-9aFY.js";const g=[u`
  :host {
...
`,...v(!0)];var y=Object.defineProperty,s=(n,e,t,$)=>{for(var i=void 0,r=n.length-1,h;r>=0;r--)(h=n[r])&&(i=h(e,t,i)||i);return i&&y(e,t,i),i};const d=class d extends k(b(m)){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?l`<div class="text-container">
      ${this.renderLabel()}
      ${this.renderHelperText()}
    </div>`:p}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}setFormValue(){let e=null;this.checked?e=this.value?this.value:"on":e=null,this.manageRequired(),this.internals.setFormValue(e)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.checked=!1,this.indeterminate=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}toggleState(){this.disabled||(this.checked=!this.checked,this.indeterminate=!1)}handleKeyDown(e){var t;e.key==="Enter"&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}update(e){super.update(e),e.has("checked")&&this.setFormValue()}render(){return l`
      <mdc-staticcheckbox 
