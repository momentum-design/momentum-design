import{L as O,T as _}from"./linksimple.component-bEzbTVgf.js";import{k as L}from"./iframe-CfitjWUE.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-B92OEDYj.js";import"./DataAriaLabelMixin-C0eirZqS.js";import"./DisabledMixin-W25vj83_.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
