import"./index-DblcVKBa.js";import"./index-B5UpHdtH.js";import{T as b}from"./toggle.constants-Q_xbiVha.js";import{X as g,R as f,k as r,h as a,T as i,n as m}from"./iframe-8tieyzIg.js";import"./index-C10VHij3.js";import{R as u}from"./class-map-BS5gRPpY.js";import{M as k}from"./menuitem.component-DJKLRaFC.js";import{a as T}from"./ControlTypeMixin-CPkpn-mU.js";import{D as E,I as l,T as C}from"./menuitemcheckbox.constants-s7wAXpw5.js";const x=g`
...
`,L=[x];var $=Object.defineProperty,p=(d,e,n,v)=>{for(var t=void 0,c=d.length-1,h;c>=0;c--)(h=d[c])&&(t=h(e,n,t)||t);return t&&$(e,n,t),t};const o=class o extends T(k){constructor(){super(),this.checked=!1,this.indicator=E.INDICATOR,this.addEventListener("click",this.handleMouseClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=f.MENUITEMCHECKBOX}handleMouseClick(){this.disabled||this.softDisabled||(this.controlType!=="controlled"&&(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}click(){this.disabled||this.softDisabled||super.click()}update(e){super.update(e),e.has("checked")&&(this.ariaChecked=`${this.checked}`)}staticCheckbox(){return this.indicator===l.CHECKBOX?r`
        ...
        ></mdc-staticcheckbox>
      `:a}staticToggle(){return this.indicator===l.TOGGLE?r`
        <mdc-statictoggle
          ...
          size="${b.COMPACT}"
        ></mdc-statictoggle>
      `:a}getCheckmarkIcon(){return this.indicator===l.CHECKMARK?r`
        <mdc-icon
          slot="trailing-controls"
          name="check-bold"
          part="checkmark-icon"
