import{L as O,T as _}from"./linksimple.component-gL5jlA3Q.js";import{k as L}from"./iframe-CWop6vmJ.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-z4oxgOfa.js";import"./DataAriaLabelMixin-aAonhGVb.js";import"./DisabledMixin-DHRFWeSP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
