import{L as O,T as _}from"./linksimple.component-BDBsfhpq.js";import{k as L}from"./iframe-DCPKk3oI.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-Cxi43hJh.js";import"./DataAriaLabelMixin-PZ7EHVNe.js";import"./DisabledMixin-DzqxSWAY.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
