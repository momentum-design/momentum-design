import{L as O,T as _}from"./linksimple.component-Dr9NXAD_.js";import{k as L}from"./iframe-DZY0Eneb.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-BZtiOCUR.js";import"./DataAriaLabelMixin-DG8G3EPU.js";import"./DisabledMixin-De6kEZSq.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
