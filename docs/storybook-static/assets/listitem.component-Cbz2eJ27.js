import{N as v,O as y,R as f,k as l,V as x,r as E,T as o,C as b,H as u,n as s}from"./iframe-0HVjsxx2.js";import{D as k}from"./DisabledMixin-DmXZKRQb.js";import{K as L,a as I,T as S,A as d}from"./KeyDownHandledMixin-TMs2ITqw.js";import{a as D}from"./LifeCycleMixin-CkFTW4AQ.js";import{D as w}from"./listitem.constants-B5DQR4fS.js";class g{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const C=v`
  :host {
