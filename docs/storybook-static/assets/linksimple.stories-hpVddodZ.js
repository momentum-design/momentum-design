import{L as O,T as _}from"./linksimple.component-DgTNUrMN.js";import{k as L}from"./iframe-C04-hoFI.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DpBddC9E.js";import"./DataAriaLabelMixin-B0LNkVX4.js";import"./DisabledMixin-CDu4-Y_U.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
