import{L as O,T as _}from"./linksimple.component-C_hbsNbL.js";import{k as L}from"./iframe-BK-lkp6o.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-CaiTIpCp.js";import"./DataAriaLabelMixin-c9B3pN33.js";import"./DisabledMixin-D7IzNGni.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
