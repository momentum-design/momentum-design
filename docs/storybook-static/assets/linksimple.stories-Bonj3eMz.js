import{L as O,T as _}from"./linksimple.component-CMAzLbf3.js";import{k as L}from"./iframe-KnaVjCuf.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Bt26HpWq.js";import"./DataAriaLabelMixin-_mhuURbJ.js";import"./DisabledMixin-BP8YdHVe.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
