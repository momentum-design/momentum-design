import{L as O,T as _}from"./linksimple.component-UYH-I8pB.js";import{k as L}from"./iframe-Zf8S4XXr.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-BQWJj0RV.js";import"./DataAriaLabelMixin-DveGvTLx.js";import"./DisabledMixin-DSsu06eJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
