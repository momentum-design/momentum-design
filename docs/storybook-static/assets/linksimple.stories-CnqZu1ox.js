import{L as O,T as _}from"./linksimple.component-BAu_cKp2.js";import{k as L}from"./iframe-Ddh3nIQX.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-D0nwkf-h.js";import"./DataAriaLabelMixin-DXw-LjTR.js";import"./DisabledMixin-CYblr_Y4.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
