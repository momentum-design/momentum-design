import{L as O,T as _}from"./linksimple.component-Cfe8jAh8.js";import{k as L}from"./iframe-D0jeH_1V.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CfnkxC3R.js";import"./DataAriaLabelMixin-DV5KNmKs.js";import"./DisabledMixin-CgF8PS8f.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
