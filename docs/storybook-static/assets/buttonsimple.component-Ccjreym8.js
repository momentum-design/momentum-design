import{n as r,U as m,S as p,X as y,D as l,b,k as v,E as f}from"./iframe-D59qSDLK.js";import{K as d}from"./keys-hFXe221I.js";import{D as E}from"./DisabledMixin-MuPyaYa1.js";import{T as g}from"./TabIndexMixin-B1WUQql5.js";var S=Object.defineProperty,A=(a,t,s,u)=>{for(var e=void 0,n=a.length-1,h;n>=0;n--)(h=a[n])&&(e=h(t,s,e)||e);return e&&S(t,s,e),e};const x=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=this,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,this.elementToAutoFocus.focus())}}return A([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},T=[m,p`
    :host {
