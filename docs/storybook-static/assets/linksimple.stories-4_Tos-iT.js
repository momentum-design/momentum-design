import{L as O,T as _}from"./linksimple.component-DrrVN2qu.js";import{k as L}from"./iframe-D6lHhKC3.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-BPDtHRBw.js";import"./DataAriaLabelMixin-DW9o9iLu.js";import"./DisabledMixin-CJlycYIb.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
