import{L as O,T as _}from"./linksimple.component-C7W098Fm.js";import{k as L}from"./iframe-z54V7R-I.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-tLTANQnt.js";import"./DataAriaLabelMixin-CPRxXCJY.js";import"./DisabledMixin-BPk196UL.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
