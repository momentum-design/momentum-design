import{u as A,n as l,C as f}from"./index-C9z9WAEj.js";import{P as b,a as y,n as _}from"./popover.component-DCc9qDH7.js";import{R as O}from"./roles-DMFGbP5t.js";import{i as P,D as R,k as u}from"./lit-element-D5KKan5q.js";import{v as k}from"./v4-CmTdKEVZ.js";import{o as S}from"./query-assigned-elements-uEuc3rg8.js";import{D}from"./DisabledMixin-BZruwOeC.js";import{T as w}from"./TabIndexMixin-CsrHswKP.js";import{V as N,T as h}from"./text.constants-ZF0jM5wn.js";import{a as $}from"./index-CcXofQbA.js";const I=A.constructTagName("tooltip"),o={DESCRIPTION:"description",LABEL:"label",NONE:"none"},n={BACKDROP:!1,DELAY:"0,0",OFFSET:4,PLACEMENT:b.TOP,SHOW_ARROW:!0,TOOLTIP_TYPE:o.DESCRIPTION},M=P`
...
`,U=[M];var B=Object.defineProperty,C=(c,t,e,r)=>{for(var i=void 0,d=c.length-1,p;d>=0;d--)(p=c[d])&&(i=p(t,e,i)||i);return i&&B(t,e,i),i};const g=class g extends y{constructor(){super(...arguments),this.tooltipType=n.TOOLTIP_TYPE}connectedCallback(){super.connectedCallback(),this.backdrop=!1,this.delay=this.delay||n.DELAY,this.focusTrap=!1,this.hideOnBlur=!0,this.hideOnEscape=!0,this.interactive=!1,this.offset=this.offset||n.OFFSET,this.placement=this.placement||n.PLACEMENT,this.role=O.TOOLTIP,this.trigger="mouseenter focusin",this.enabledFocusTrap=!1,this.enabledPreventScroll=!1,this.flip=!0,this.focusTrap=!1,this.preventScroll=!1,this.closeButton=!1,this.hideOnOutsideClick=!1,this.focusBackToTrigger=!1,this.size=!1,this.disableAriaExpanded=!0}getTooltipText(){var t,e;return((e=(t=this.defaultSlotNodes)==null?void 0:t.map(r=>r.textContent).join(" "))==null?void 0:e.trim())||""}setTooltipType(t){this.setAttribute("tooltip-type",Object.values(o).includes(t)?t:n.TOOLTIP_TYPE)}onIdUpdated(){this.id.length===0&&(this.id=`mdc-tooltip-${k()}`);const t=document.getElementById(this.triggerID);if(t)switch(this.tooltipType){case o.DESCRIPTION:t.setAttribute("aria-describedby",this.id);break;case o.LABEL:t.setAttribute("aria-labelledby",this.id);break}}onPlacementUpdated(){Object.values(b).includes(this.placement)||(this.placement=n.PLACEMENT)}onTooltipTypeUpdated(t){const e=t.get("tooltipType");Object.values(o).includes(this.tooltipType)||this.setTooltipType(n.TOOLTIP_TYPE);const r=document.getElementById(this.triggerID);if(r){const i=this.getTooltipText();switch(this.tooltipType){case o.DESCRIPTION:e===o.LABEL&&r.removeAttribute("aria-labelledby"),r.setAttribute("aria-describedby",this.id);break;case o.LABEL:e===o.DESCRIPTION&&r.removeAttribute("aria-describedby"),r.setAttribute("aria-labelledby",this.id);break;default:e===o.DESCRIPTION?r.removeAttribute("aria-describedby"):e===o.LABEL&&r.removeAttribute("aria-labelledby");break}i.length>0&&this.tooltipType!==o.NONE&&!this.ariaLabel&&(this.ariaLabel=i)}}update(t){super.update(t),t.has("id")&&this.onIdUpdated(),t.has("placement")&&this.onPlacementUpdated(),t.has("tooltipType")&&this.onTooltipTypeUpdated(t)}};g.styles=[...y.styles,...U];let m=g;C([l({type:String,attribute:"tooltip-type",reflect:!0})],m.prototype,"tooltipType");C([_()],m.prototype,"defaultSlotNodes");m.register(I);const v={ARROW_DOWN:"ArrowDown",ARROW_LEFT:"ArrowLeft",ARROW_RIGHT:"ArrowRight",ARROW_UP:"ArrowUp",END:"End",ENTER:"Enter",ESCAPE:"Escape",HOME:"Home",PAGE_DOWN:"PageDown",PAGE_UP:"PageUp",SPACE:" "},tt=A.constructTagName("listitem"),E="dynamic-listitem-tooltip-popover",x="dynamic-listitem-tooltip-triggerid",F={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},L={VARIANT:F.FULL_WIDTH,TOOLTIP_PLACEMENT:b.TOP},Y=P`
  :host {
...
`,G=[Y,...$()];var W=Object.defineProperty,s=(c,t,e,r)=>{for(var i=void 0,d=c.length-1,p;d>=0;d--)(p=c[d])&&(i=p(t,e,i)||i);return i&&W(t,e,i),i};const T=class T extends D(w(f)){constructor(){super(),this.variant=L.VARIANT,this.tooltipPlacement=L.TOOLTIP_PLACEMENT,this.addEventListener("keydown",this.handleKeyDown),this.addEventListener("focusin",this.displayTooltipForLongText),this.addEventListener("mouseover",this.displayTooltipForLongText),this.addEventListener("focusout",this.hideTooltipOnLeave),this.addEventListener("mouseout",this.hideTooltipOnLeave),this.addEventListener("click",this.handleClick)}connectedCallback(){super.connectedCallback(),this.role=this.role||O.LISTITEM}handleKeyDown(t){(t.key===v.ENTER||t.key===v.SPACE)&&(this.triggerClickEvent(),t.preventDefault())}triggerClickEvent(){const t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(t)}handleClick(){this.hideTooltipOnLeave()}displayTooltipForLongText(){var e;if(!this.tooltipText)return;this.id=this.id||x;const t=document.createElement(I);t.id=E,t.textContent=this.tooltipText,t.setAttribute("triggerid",this.id),t.setAttribute("placement",this.tooltipPlacement),t.setAttribute("visible",""),t.setAttribute("show-arrow",""),(e=this.parentElement)==null||e.after(t)}hideTooltipOnLeave(){this.id=this.id===x?"":this.id;const t=document.querySelector(`#${E}`);t==null||t.remove()}getText(t,e,r){return r?u`
      <slot name="${t}">
        <mdc-text part="${t}" type="${e}" tagname="${N.SPAN}">${r}</mdc-text>
      </slot>
    `:R}disableSlottedChildren(t){[...this.leadingControlsSlot,...this.trailingControlsSlot].forEach(e=>{t?e.setAttribute("disabled",""):e.removeAttribute("disabled")})}update(t){super.update(t),t.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.disableSlottedChildren(this.disabled),this.setAttribute("aria-disabled",`${this.disabled}`))}renderTrailingControls(){return u`<slot name="trailing-controls"></slot>`}renderLeadingControls(){return u`<slot name="leading-controls"></slot>`}render(){return u`
      <div part="leading">
