import{L as O,T as _}from"./linksimple.component-C4EMympY.js";import{k as L}from"./iframe-CQNghGpx.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-DXCUPrE0.js";import"./DataAriaLabelMixin-xMU4tAR7.js";import"./DisabledMixin-DftxrpjF.js";import"./index-DSn8hw9k.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
