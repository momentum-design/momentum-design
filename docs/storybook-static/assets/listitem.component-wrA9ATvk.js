import{a2 as v,a8 as y,R as f,k as l,V as x,h as E,T as o,C as b,n as s}from"./iframe-C9ATrnz3.js";import{o as u}from"./query-assigned-elements-B6KxVBiY.js";import{D as k}from"./DisabledMixin-BoW9hNfQ.js";import{K as L,a as I,T as S,A as d}from"./KeyDownHandledMixin-CRIKOp1z.js";import{a as D}from"./LifeCycleMixin-CkFTW4AQ.js";import{D as w}from"./listitem.constants-BdPQwbWj.js";class g{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const C=v`
  :host {
