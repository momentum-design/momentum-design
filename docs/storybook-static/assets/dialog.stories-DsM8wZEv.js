import"./index-DGptXNXf.js";import{V as O,T as H}from"./index-D1yLszQ-.js";import{i as $e,k as r,D as R}from"./lit-element-D5KKan5q.js";import{t as z}from"./if-defined-D5BV9-c0.js";import{u as Ce,C as Z,n}from"./index-C9z9WAEj.js";import{c as ke,F as Be}from"./popover.component-DXroYsJG.js";import{B as Le,I as ze}from"./button.constants-D0QAbDxL.js";import{C as _e}from"./CardAndDialogFooterMixin-ChoLGxVa.js";import{a as L}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as we,s as Ne}from"./commonArgTypes-BluK8w5L.js";import{d as Pe,h as Oe}from"./utils-CO8B6ZcN.js";import"./index-B-i2l-7z.js";import"./index-Dn0G2h6D.js";import"./index-8Y0638qe.js";import"./button.component-CETyLHgp.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-UuTVCePh.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./index-MA1r3zrt.js";import"./button.utils-rNW36Ji7.js";import"./index-BsaNkJek.js";import"./iframe-DPQgxLwM.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./base-DIkkzJ-c.js";import"./roles-BH_hBfTz.js";import"./query-assigned-elements-uEuc3rg8.js";import"./link.constants-CqyNsepP.js";import"./v4-CQkTLCs1.js";import"./IconNameMixin-CujGSn0t.js";import"./linksimple.component-CZN2acD1.js";import"./v4-CmTdKEVZ.js";const He=$e`
  :host {
    ...
    `,e.appendChild(o),(i=this.parentElement)==null||i.appendChild(e),this.backdropElement=e}closeDialog(){v.onCloseDialog(this,!1)}async isOpenUpdated(e,o){var i,l,m,b,N,P;e!==o&&(o&&!e?(this.lastActiveElement=document.activeElement,this.createBackdrop(),this.activatePreventScroll(),await this.updateComplete,(i=this.activateFocusTrap)==null||i.call(this),(l=this.setInitialFocus)==null||l.call(this),(m=this.triggerElement)==null||m.setAttribute("aria-expanded","true"),v.onShowDialog(this)):!o&&e&&((b=this.backdropElement)==null||b.remove(),this.backdropElement=null,(N=this.triggerElement)==null||N.setAttribute("aria-expanded","false"),this.deactivatePreventScroll(),(P=this.deactivateFocusTrap)==null||P.call(this),this.focusBackToTrigger(),v.onHideDialog(this)))}focusBackToTrigger(){this.triggerElement?this.triggerElement.focus():this.lastActiveElement&&this.lastActiveElement.focus&&this.lastActiveElement.focus()}render(){return r`
      ...
      <div part="header-section">
        <div part="header">
          ...
          <mdc-text
            part="header-text"
            tagname="${O[this.headerTagName.toUpperCase()]}"
        ...
        ${this.descriptionText?r`<mdc-text
          ...
          tagname="${O[this.descriptionTagName.toUpperCase()]}"
      ...
      ${this.renderFooter()}
    `}};w.styles=[...Z.styles,...Re];let a=w;d([n({type:String,reflect:!0})],a.prototype,"id");d([n({type:String,reflect:!0})],a.prototype,"triggerId");d([n({type:Boolean,reflect:!0})],a.prototype,"visible");d([n({type:Number,reflect:!0,attribute:"z-index"})],a.prototype,"zIndex");d([n({type:String,reflect:!0})],a.prototype,"size");d([n({type:String,reflect:!0})],a.prototype,"variant");d([n({type:String,attribute:"close-button-aria-label"})],a.prototype,"closeButtonAriaLabel");d([n({type:String,reflect:!0,attribute:"aria-label"})],a.prototype,"ariaLabel");d([n({type:String,reflect:!0,attribute:"aria-labelledby"})],a.prototype,"ariaLabelledby");d([n({type:String,reflect:!0,attribute:"aria-describedby"})],a.prototype,"ariaDescribedBy");d([n({type:String,reflect:!0,attribute:"aria-description"})],a.prototype,"ariaDescription");d([n({type:String,reflect:!0,attribute:"header-text"})],a.prototype,"headerText");d([n({type:String,reflect:!0,attribute:"description-text"})],a.prototype,"descriptionText");d([n({type:String,reflect:!0,attribute:"header-tag-name"})],a.prototype,"headerTagName");d([n({type:String,reflect:!0,attribute:"description-tag-name"})],a.prototype,"descriptionTagName");d([n({type:String,reflect:!0})],a.prototype,"role");d([n({type:Boolean,reflect:!0,attribute:"disable-aria-haspopup"})],a.prototype,"disableAriaHasPopup");a.register(Ze);const g=(t,e,o)=>r`<mdc-dialog
  class="${t.class}"
  style="${t.style}"
  id="${t.id}"
  z-index="${t["z-index"]}"
...
`,Me=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ...
    ${g(t,_(e),o)}
  `},Ve=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${g(t,_(e,!0),o)}
  `},je=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")},i=()=>{window.confirm("Are you sure you want to cancel?")&&e()};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${g(t,r`
      <div slot="dialog-body">
        <p>This is the body content of the dialog.</p>
  ...
  `},Ye=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${g(t,Ue(e),o)}
  `},Ke=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById("nested-dialog").toggleAttribute("visible")},i=()=>{document.getElementById(t.id).removeAttribute("visible")},l=()=>{document.getElementById("nested-dialog").removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${g(t,r`
      <div slot="dialog-body">
        <p>This is the body content of the dialog.</p>
  ...
  `},qe=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${g(t,We(),o)}
  `},wt={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:Me,parameters:{badges:["stable"]},argTypes:{...we,...Ne,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(Se)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},role:{control:"select",options:Object.values(Fe)},size:{control:"select",options:Object.values(p)},visible:{control:"boolean"},...Pe(["--mdc-dialog-primary-background-color","--mdc-dialog-border-color","--mdc-dialog-header-text-color","--mdc-dialog-description-text-color","--mdc-dialog-elevation-3","--mdc-dialog-width"]),...Oe(["focusTrap"])}},c={id:"dialog","z-index":s.Z_INDEX,role:s.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:s.VARIANT},u={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":s.HEADER_TAG_NAME,"description-tag-name":s.DESCRIPTION_TAG_NAME},y={args:{size:s.SIZE,...c,...u}},f={args:{size:p[0],...c,...u}},E={args:{size:p[1],...c,...u}},I={args:{size:p[2],...c,...u}},A={args:{...c,size:p[0]}},D={render:Xe,args:{...c,size:p[0]}},x={render:je,args:{...c,...u,size:s.SIZE}},T={render:Ve,args:{...c,...u,size:s.SIZE}},S={render:t=>r`
  ...
  `},$={render:t=>{const e=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ...
    `},args:{...c,...u,size:s.SIZE,mountDialog:!0,visible:!0}},C={render:Ye,args:{...c,size:p[0]}},k={render:Ke,args:{...c,size:p[0]}},B={render:qe,args:{...c,size:p[0]}};var F,G,U;y.parameters={...y.parameters,docs:{...(F=y.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
    ...headerDescriptionProperties
  }
}`,...(U=(G=y.parameters)==null?void 0:G.docs)==null?void 0:U.source}}};var W,M,V;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    size: DIALOG_SIZE[0],
    ...commonProperties,
    ...headerDescriptionProperties
  ...
  \`
}`,...(ge=(pe=S.parameters)==null?void 0:pe.docs)==null?void 0:ge.source}}};var he,ue,be;$.parameters={...$.parameters,docs:{...(he=$.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: (args: Args) => {
    const onClose = () => {
...
}`,...(be=(ue=$.parameters)==null?void 0:ue.docs)==null?void 0:be.source}}};var ve,ye,fe;C.parameters={...C.parameters,docs:{...(ve=C.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  render: renderWithPopover,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(fe=(ye=C.parameters)==null?void 0:ye.docs)==null?void 0:fe.source}}};var Ee,Ie,Ae;k.parameters={...k.parameters,docs:{...(Ee=k.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  render: renderDialogWithinDialog,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(Ae=(Ie=k.parameters)==null?void 0:Ie.docs)==null?void 0:Ae.source}}};var De,xe,Te;B.parameters={...B.parameters,docs:{...(De=B.parameters)==null?void 0:De.docs,source:{originalSource:`{
  render: renderDialogWithIframe,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(Te=(xe=B.parameters)==null?void 0:xe.docs)==null?void 0:Te.source}}};const Nt=["Example","small","medium","large","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe"];export{B as DialogWithIframe,k as DialogWithinDialog,y as Example,$ as MountUnmount,C as WithPopover,S as WithoutTriggerElement,Nt as __namedExportsOrder,wt as default,I as large,E as medium,f as small,T as withCustomHeader,x as withSaveCancelButtons,A as withoutHeader,D as withoutHeaderOrFooter};
