import{u as z,I as G,i as H,B as T,N as j,al as Z,r as v,k as e,T as J,t as Y,C as O,l as X,n as l,U as b,H as K,V as q}from"./iframe-BrN8x_Z0.js";import{F as Q}from"./FooterMixin-eMHhR2ng.js";import"./index-D5lPBL37.js";import"./index-BDHBrWNs.js";import"./index-BfoiQtT4.js";import"./index-B4ObmBSi.js";import{c as tt,s as et}from"./commonArgTypes-BG7EqI50.js";import{b as ot,h as rt,a as w}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./link.constants-Dp3tY8uh.js";import"./index-CuaFIEeJ.js";import"./index-DTrDRi1E.js";import"./button.component-Duy2Fx_8.js";import"./buttonsimple.component-C085WkLc.js";import"./DisabledMixin-DjI3Wyw_.js";import"./KeyDownHandledMixin-lEQrVlT7.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-CbFovggv.js";import"./index-8qX6WQk2.js";const at=z.constructTagName("toast"),m={CUSTOM:"custom",SUCCESS:"success",WARNING:"warning",ERROR:"error"},A={SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},a={HEADER_TAG_NAME:"h2",CANCEL_ICON:"cancel-bold",ARROW_UP_BOLD:"arrow-up-bold",ARROW_DOWN_BOLD:"arrow-down-bold",PREFIX_ICON_SIZE:1.5,CLOSE_ICON_SIZE:G[20],BUTTON:H,PRIMARY_BUTTON:T.PRIMARY,SECONDARY_BUTTON:T.SECONDARY,TERTIARY_BUTTON:T.TERTIARY,VARIANT:m.CUSTOM},st=t=>{switch(t){case m.SUCCESS:return A.SUCCESS_ICON_NAME;case m.WARNING:return A.WARNING_ICON_NAME;case m.ERROR:return A.ERROR_ICON_NAME;default:return null}},nt=j`
  :host {
...
`,it=[nt];var lt=Object.defineProperty,s=(t,o,n,f)=>{for(var d=void 0,y=t.length-1,N;y>=0;y--)(N=t[y])&&(d=N(o,n,d)||d);return d&&lt(o,n,d),d};const S=class S extends Q(O){constructor(){super(...arguments),this.variant=a.VARIANT,this.headerTagName=a.HEADER_TAG_NAME,this.ariaLabel=null,this.isDetailVisible=!1,this.hasDetailedSlot=!1,this.hasOverflowingHeaderText=!1,this.hasFooterButtons=""}closeToast(){const o=new CustomEvent("close",{bubbles:!0,composed:!0,detail:{id:this.id}});this.dispatchEvent(o)}toggleDetailVisibility(){this.isDetailVisible=!this.isDetailVisible,this.isDetailVisible?this.setAttribute("data-expanded","true"):this.removeAttribute("data-expanded")}updateDetailedSlotPresence(){var o;this.hasDetailedSlot=((o=this.detailedElements)==null?void 0:o.some(n=>{var f;return(f=n.textContent)==null?void 0:f.trim()}))??!1}updateFooterButtonsPresence(){var o,n;this.hasFooterButtons=(((o=this.footerButtonPrimary)==null?void 0:o.length)??0)>0||(((n=this.footerButtonSecondary)==null?void 0:n.length)??0)>0||this.shouldRenderToggleButton()?"has-footer-buttons":""}async firstUpdated(o){super.firstUpdated(o),this.updateDetailedSlotPresence(),await this.updateComplete,Z(this.headerTextElement)&&(this.hasOverflowingHeaderText=this.headerTextElement.isHeightOverflowing())}renderIcon(o){return o?e`
    ...
    `:v}renderHeader(){return this.headerText?e`
      ...
      ${this.renderFooter()}
    `}};S.styles=[...O.styles,...it];let r=S;s([X("[part='toast-header']")],r.prototype,"headerTextElement");s([l({type:String,reflect:!0})],r.prototype,"variant");s([l({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel");s([l({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");s([l({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName");s([l({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");s([l({type:String,reflect:!0,attribute:"show-more-text"})],r.prototype,"showMoreText");s([l({type:String,reflect:!0,attribute:"show-less-text"})],r.prototype,"showLessText");s([b()],r.prototype,"isDetailVisible");s([b()],r.prototype,"hasDetailedSlot");s([b()],r.prototype,"hasOverflowingHeaderText");s([K({slot:"toast-body-detailed",flatten:!0})],r.prototype,"detailedElements");s([b()],r.prototype,"hasFooterButtons");r.register(at);const{action:dt}=__STORYBOOK_MODULE_ACTIONS__,W=t=>e`
  <mdc-toast
    variant="${Y(t.variant)}"
...
`,Ct={title:"Components/toast",tags:["autodocs"],component:"mdc-toast",render:W,argTypes:{variant:{control:"select",options:Object.values(m)},"header-text":{control:"text"},"header-tag-name":{control:"select",options:Object.values(q)},"close-button-aria-label":{control:"text"},"show-more-text":{control:"text"},"show-less-text":{control:"text"},"prefix-icon":{control:"text",description:"Icon name for the content prefix (slot: content-prefix). Only for custom variant."},"normal-body":{control:"text",description:"Content for the main body of the toast (slot: toast-body-normal)"},"detailed-body":{control:"text",description:"Content for the detailed body of the toast, shown when expanded (slot: toast-body-detailed)"},...tt,...et,...ot(["content-prefix","toast-body-normal","toast-body-detailed","footer-button-primary","footer-button-secondary","footer"]),...rt(["children","isDetailVisible","hasDetailedSlot","detailedElements","hasFooterButtons"])}},i={variant:"custom","header-tag-name":"span","close-button-aria-label":"Close toast"},c=e`
...
`,h={args:{...i,"header-text":"Toast Title","show-more-text":"Show more","show-less-text":"Show less","prefix-icon":"placeholder-bold","normal-body":"This is a toast message.","detailed-body":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",children:e`${c}`}},p={args:{variant:"success","header-tag-name":"span","header-text":"This is a very long toast title that should overflow and trigger the show more/less functionality","show-more-text":"Show more","show-less-text":"Show less","close-button-aria-label":"Close toast"}},u={name:"All Variants",render:()=>e`
  ...
  ...hideAllControls()
}`,...(M=(L=x.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};var V,P,k;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Connecting',
  args: {
    ...DefaultArgs,
  ...
  ...hideAllControls()
}`,...(k=(P=g.parameters)==null?void 0:P.docs)==null?void 0:k.source}}};const Rt=["Example","LongTitle","AllVariants","UserJoined","Connecting"];export{u as AllVariants,g as Connecting,h as Example,p as LongTitle,x as UserJoined,Rt as __namedExportsOrder,Ct as default};
