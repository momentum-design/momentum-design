import{L as O,T as _}from"./linksimple.component-CoN-Dv_J.js";import{k as L}from"./iframe-DepJTrFF.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DYFDEgLm.js";import"./DataAriaLabelMixin-BsKCq-En.js";import"./DisabledMixin-HPiC1yiU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
