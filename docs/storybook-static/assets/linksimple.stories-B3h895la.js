import{L as O,T as _}from"./linksimple.component-C4JBcJXG.js";import{k as L}from"./iframe-CrnImR4G.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DCu-IhVE.js";import"./DataAriaLabelMixin-DsK-d1g_.js";import"./DisabledMixin-BmiKlCWv.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
