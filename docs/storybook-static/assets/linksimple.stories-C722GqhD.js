import{L as O,T as _}from"./linksimple.component-J8x7gHq7.js";import{k as L}from"./iframe-DzqYamvY.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-B9rnUTwp.js";import"./DataAriaLabelMixin-07IRiZHm.js";import"./DisabledMixin-CpkDI-ME.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
