import{L as O,T as _}from"./linksimple.component-ZOSJWGI8.js";import{k as L}from"./iframe-I75E1rZE.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DV4q595_.js";import"./DataAriaLabelMixin-C0qIKM1e.js";import"./DisabledMixin-FUMWD2el.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
