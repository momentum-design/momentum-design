import{L as O,T as _}from"./linksimple.component-BHCAvBbG.js";import{k as L}from"./iframe-DqtxrZLf.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Beh_89Us.js";import"./DataAriaLabelMixin-CmQgvSlN.js";import"./DisabledMixin-DvVY9L_2.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
