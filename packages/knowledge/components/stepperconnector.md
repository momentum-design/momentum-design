# StepperConnector (`mdc-stepperconnector`)
...
- Component folder: [`packages/components/src/components/stepperconnector/`](../../components/src/components/stepperconnector/)
- Built metadata references: `components/stepperconnector/stepperconnector.component.js` (from Custom Elements Manifest)
...
```javascript
import { StepperConnector } from '@momentum-design/components/react';
```
...
Project Storybook enables the **Accessibility** addon with axe rules for **WCAG 2.x / 2.2 AA** and **best-practice** (see [`preview.jsx`](../../components/config/storybook/preview.jsx), `parameters.a11y`). Run checks from the [Docs](https://momentum.design/storybook-static/index.html?path=/docs/components-stepper-stepperconnector--docs) or Canvas view.
