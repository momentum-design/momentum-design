...
- Component folder: [`packages/components/src/components/bullet/`](../../components/src/components/bullet/)
- Built metadata references: `components/bullet/bullet.component.js` (from Custom Elements Manifest)
...
```javascript
import '@momentum-design/components/components/bullet';
```

```html
<mdc-bullet></mdc-bullet>
```
...
Project Storybook enables the **Accessibility** addon with axe rules for **WCAG 2.x / 2.2 AA** and **best-practice** (see [`preview.jsx`](../../components/config/storybook/preview.jsx), `parameters.a11y`). Run checks from the [Docs](https://momentum.design/storybook-static/index.html?path=/docs/components-decorator-bullet--docs) or Canvas view.
