...
- Component folder: [`packages/components/src/components/brandvisual/`](../../components/src/components/brandvisual/)
- Built metadata references: `components/brandvisual/brandvisual.component.js` (from Custom Elements Manifest)
...
```javascript
import '@momentum-design/components/components/brandvisual';
```

```html
<mdc-brandvisual></mdc-brandvisual>
```
...
Project Storybook enables the **Accessibility** addon with axe rules for **WCAG 2.x / 2.2 AA** and **best-practice** (see [`preview.jsx`](../../components/config/storybook/preview.jsx), `parameters.a11y`). Run checks from the [Docs](https://momentum.design/storybook-static/index.html?path=/docs/components-brandvisual--docs) or Canvas view.
