...
- Component folder: [`packages/components/src/components/navmenuitem/`](../../components/src/components/navmenuitem/)
- Built metadata references: `components/navmenuitem/navmenuitem.component.js` (from Custom Elements Manifest)
...
```javascript
import '@momentum-design/components/components/navmenuitem';
```

```html
<mdc-navmenuitem></mdc-navmenuitem>
```
