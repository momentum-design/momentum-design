...
- Component folder: [`packages/components/src/components/buttonsimple/`](../../components/src/components/buttonsimple/)
- Built metadata references: `components/buttonsimple/buttonsimple.component.js` (from Custom Elements Manifest)
...
```javascript
import '@momentum-design/components/components/buttonsimple';
```

```html
<mdc-buttonsimple></mdc-buttonsimple>
```
...
Project Storybook enables the **Accessibility** addon with axe rules for **WCAG 2.x / 2.2 AA** and **best-practice** (see [`preview.jsx`](../../components/config/storybook/preview.jsx), `parameters.a11y`). Run checks from the [Docs](https://momentum.design/storybook-static/index.html?path=/docs/internal-buttonsimple--docs) or Canvas view.
