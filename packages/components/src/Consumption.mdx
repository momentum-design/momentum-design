...
For all the details regarding the release, please visit: [**release history**](https://github.com/momentum-design/momentum-design/releases).

If you would like to provide any feedback, please raise an [**issue**](https://github.com/momentum-design/momentum-design/issues).
...
The **ThemeProvider** component will switch themes based on the Momentum Tokens defined in:
...
* Providers allow configuration for all the Momentum Design Components contained within the provider.
  <br/>1. IconProvider sets the icon source and icons configuration. (refer to [**Icon Provider**](https://momentum-design.github.io/momentum-design/storybook-static/index.html?path=/docs/components-iconprovider--docs)).
  <br/>2. ThemeProvider sets the theme class. (refer to [**Theme Provider**](https://momentum-design.github.io/momentum-design/storybook-static/index.html?path=/docs/components-themeprovider--docs)).
