Feature: Combobox component
  ...
  Rule: ✅ Mouse Interactions
    ...
    Scenario: User closes the combobox dropdown using the mouse
      Given I have opened the combobox dropdown with the placeholder "Start typing to search"
      When I click on the combobox dropdown again using the mouse
  ...
  Rule: ✅ Keyboard Interactions
    ...
    Scenario: User types text on input while navigating in between options of the dropdown using the keyboard
      Given I have opened the combobox dropdown with the placeholder "Start typing to search"
      ...
      And I press the character "a" key on the input text
