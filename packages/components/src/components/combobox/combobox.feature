Feature: Combobox component
  ...
  Rule: ✅ Filter
    ...
    Scenario: All options remain visible when filter is "none" and user types text
      Given the combobox component has the attribute filter set to "none"
    ...
    Scenario: User can still select an option when filter is "none"
      Given the combobox component has the attribute filter set to "none"
    ...
    Scenario: Keyboard navigation works across all options when filter is "none"
      Given the combobox component has the attribute filter set to "none"
      And I see the combobox component with the placeholder "Start typing to search"
      When I type the character "b"
