...
export const Testing: StoryObj = {
  render: () =>
    html` <mdc-button id="trigger">Click me!</mdc-button>
      <mdc-popover
        triggerID="trigger"
        interactive
        hide-on-escape
      ...
      >
        <mdc-list>
          <mdc-listitem label="label" aria-label="main reading" variant="inset-pill">
            <div slot="leading-controls">
              <mdc-avatar initials="JD"></mdc-avatar>
            </div>
            <div slot="trailing-controls">
              <mdc-button color="positive" size="28"> join </mdc-button>
            </div>
          </mdc-listitem>
          <mdc-listitem label="label" aria-label="main reading" variant="inset-pill">
            <div slot="leading-controls">
