...
const styles = [
  ...
  css`
    :host {
      ...
      --mdc-badge-default-background-color: var(--mds-color-theme-background-accent-normal);
      ...
      color: var(--mdc-badge-default-foreground-color);
    }
    .mdc-badge-overlay {
    ...
    .mdc-badge-text {
      ...
      background-color: var(--mdc-badge-default-background-color);
    }
    .mdc-badge-dot {
      width: 0.75rem;
      height: 0.75rem;
