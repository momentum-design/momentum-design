...
import { TAG_NAME as STATIC_CHIP_TAG } from '../staticchip/staticchip.constants';
...
// AI-Assisted
export const SUPPORTED_CHIP_TAGS = [CHIP_TAG, INPUT_CHIP_TAG, STATIC_CHIP_TAG, ALERT_CHIP_TAG];
