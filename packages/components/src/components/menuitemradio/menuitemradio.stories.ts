      ...
      <div role="menu">
        ...
        <mdc-menusection label="Menu Item Radios with checkmark indicator">
          ...
          <mdc-menuitemradio
            ...
            checked="true"
            indicator="checkmark"
            label="Disabled Selected Checkmark"
          >
          </mdc-menuitemradio>
        ...
        <mdc-menusection label="Menu Item Radios with custom indicator">
          <style>
            ...
            mdc-menuitemradio[indicator='none'][checked] mdc-icon {
              background: var(--mdc-listitem-background-color-active);
            }
          </style>
          <mdc-menuitemradio name="group3" checked="true" indicator="none" label="Selected No indicator">
