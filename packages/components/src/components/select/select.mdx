...
<Title>User Stories - Select Component</Title>
...
**Scenario: Display select on page load**  
> Given I am on the page with the select component  
> Then I should see the select component with the label "Headquarters Location"  
> And I should see the placeholder "Select your headquarters"  


---

### ✅ Dropdown Interactions (Mouse)

**Scenario: Open select dropdown using mouse**  
> Given I see the select component with the label "Headquarters Location"  
...
**Scenario: Close select dropdown using mouse**  
...
**Scenario: Close select dropdown by clicking outside**  
> Given I have opened the select dropdown with the placeholder "Select your headquarters"  
...
### ✅ Dropdown Interactions (Keyboard)

**Scenario: Open select dropdown using keyboard**  
...
**Scenario: Close select dropdown using keyboard**  
...
**Scenario: Navigate through options using keyboard**  
> Given I have opened the select dropdown and the focus is on the first option "London UK"  
...
**Scenario: Select an option using keyboard**  
> Given I have opened the select dropdown with the placeholder "Select your headquarters"  
...
**Scenario: Select component marked as required**  
...
**Scenario: Select component with toggletip information**  
...
**Scenario: Keyboard navigation with toggletip**  
> Given the select component has a toggletip with the text "you can choose your headquarters location"  
...
**Scenario: Select component is disabled**  
...
**Scenario: Select dropdown closes on pressing Escape key (screen reader)**  
> Given I have opened the select dropdown using the screen reader  
> When I press the Escape key  
> Then the select dropdown should be closed  
...
**Scenario: Accessibility roles for select**  
...
> And this container should have aria-required attribute set to "true" if the select is required
> And this container should have aria-invalid attribute set to "true" if there is an error
