Feature: LinkButton Accessibility and User Interaction
  ...
  Background:
    ...
    And the linkbutton contains:
      ...
      | auto-focus-on-mount | true/false           | Optional |
  ...
  Rule: ✅ Rendering and Visual States
    ...
    Scenario: Render linkbutton with auto-focus-on-mount
      Given the linkbutton has auto-focus-on-mount attribute set to true
      When the linkbutton is rendered
