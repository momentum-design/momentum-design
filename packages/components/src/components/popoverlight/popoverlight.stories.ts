...
const meta: Meta = {
  title: 'Internal/popoverlight',
  tags: ['autodocs'],
  component: 'mdc-popoverlight',
  render,
  parameters: {
    badges: ['stable'],
  },
...
export const popoverWithSelect: StoryObj = {
  render: () => html`
    <div style="width: 10rem; height: 8rem; margin: 5rem;">
      ...
      <mdc-popoverlight triggerID="select-button" interactive hide-on-escape hide-on-outside-click>
  ...
  render: () => html`
    ...
    <div class="container">
      <div class="child">
        ...
        <mdc-popoverlight triggerID="popover-trigger-1" hide-on-outside-click>
          <mdc-text>Popover Level 1 Trigger 1</mdc-text>
        </mdc-popoverlight>
      </div>
      <div class="child">
        <mdc-button id="popover-trigger-2">Click me!</mdc-button>
        <mdc-popoverlight triggerID="popover-trigger-2" hide-on-outside-click>
          <mdc-text>Popover Level 1 Trigger 2</mdc-text>
        </mdc-popoverlight>
      </div>
      <div class="child">
        <mdc-button id="popover-trigger-3">Click me!</mdc-button>
        <mdc-popoverlight triggerID="popover-trigger-3" hide-on-outside-click>
