...
:host {
  ...
  .modal-container[data-elevation='1'] {
    box-shadow: var(--mdc-modalcontainer-elevation-1);
  }
  .modal-container[data-elevation='2'] {
    box-shadow: var(--mdc-modalcontainer-elevation-2);
  }
  .modal-container[data-elevation='3'] {
    box-shadow: var(--mdc-modalcontainer-elevation-3);
  }
  .modal-container[data-elevation='4'] {
    box-shadow: var(--mdc-modalcontainer-elevation-4);
  }
`;
