...
test('mdc-accordiongroup', async ({ componentsPage }) => {
  ...
  // initial check for the accordiongroup be visible on the screen:
  ...
  await test.step('visual-regression', async () => {
    await test.step('matches screenshot of element', async () => {
      await componentsPage.visualRegression.takeScreenshot('mdc-accordiongroup', { element: accordiongroup });
    });
  });
