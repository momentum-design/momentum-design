...
const iife = async () => {
  const ctx = await esbuild.context({
    ...
    entryPoints: [
      ...
      `${join(process.cwd(), 'src/components/virtualizedlist/helpers/chatExample.stories.utils.ts')}`,
      `${join(process.cwd(), 'src/components/virtualizedlist/helpers/virtualizedDynamicList.stories.utils.ts')}`,
      `${join(process.cwd(), 'src/components/virtualizedlist/helpers/virtualizedDynamicListContent.stories.utils.ts')}`,
      `${join(process.cwd(), 'src/components/virtualizedlist/helpers/virtualizedWrapper.stories.utils.ts')}`,
