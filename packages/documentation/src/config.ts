...
export const GITHUB_EDIT_URL =
  'https://github.com/momentum-design/momentum-design/tree/main/packages/documentation/src/pages';
...
// Defines the display order of header menu items by slug (the last path segment
// of each entry's index). Applies to both static and autogenerated entries.
// Slugs not listed here fall to the end in their natural order.
export const HEADER_MENU_ORDER: string[] = ['foundations', 'guidelines', 'tokens', 'assets', 'components'];
